...
pub struct UpdateResolverOutput  {
    ...
    #[doc(hidden)]pub resolver: std::option::Option<crate::model::Resolver>,
}
...
pub struct UpdateGraphqlApiOutput  {
    ...
    #[doc(hidden)]pub graphql_api: std::option::Option<crate::model::GraphqlApi>,
}
...
pub struct UpdateFunctionOutput  {
    ...
    #[doc(hidden)]pub function_configuration: std::option::Option<crate::model::FunctionConfiguration>,
}
...
pub struct UpdateDomainNameOutput  {
    ...
    #[doc(hidden)]pub domain_name_config: std::option::Option<crate::model::DomainNameConfig>,
}
...
pub struct UpdateApiKeyOutput  {
    /// <p>The API key.</p>
    #[doc(hidden)]pub api_key: std::option::Option<crate::model::ApiKey>,
}
...
pub struct UpdateApiCacheOutput  {
    ...
    #[doc(hidden)]pub api_cache: std::option::Option<crate::model::ApiCache>,
}
...
pub struct StartSchemaCreationOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::SchemaStatus>,
}
...
pub struct ListTypesOutput  {
    ...
    #[doc(hidden)]pub types: std::option::Option<std::vec::Vec<crate::model::Type>>,
...
pub struct ListResolversByFunctionOutput  {
    ...
    #[doc(hidden)]pub resolvers: std::option::Option<std::vec::Vec<crate::model::Resolver>>,
...
pub struct ListGraphqlApisOutput  {
    ...
    #[doc(hidden)]pub graphql_apis: std::option::Option<std::vec::Vec<crate::model::GraphqlApi>>,
    /// <p>An identifier to pass in the next request to this operation to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDomainNamesOutput  {
    ...
    #[doc(hidden)]pub domain_name_configs: std::option::Option<std::vec::Vec<crate::model::DomainNameConfig>>,
    /// <p>The API token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApiKeysOutput  {
    ...
    #[doc(hidden)]pub api_keys: std::option::Option<std::vec::Vec<crate::model::ApiKey>>,
    /// <p>An identifier to pass in the next request to this operation to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetIntrospectionSchemaOutput  {
    ...
    #[doc(hidden)]pub schema: std::option::Option<aws_smithy_types::Blob>,
}
...
pub struct GetApiAssociationOutput  {
    ...
    #[doc(hidden)]pub api_association: std::option::Option<crate::model::ApiAssociation>,
}
...
pub struct EvaluateMappingTemplateOutput  {
    ...
    #[doc(hidden)]pub evaluation_result: std::option::Option<std::string::String>,
    /// <p>The <code>ErrorDetail</code> object.</p>
    #[doc(hidden)]pub error: std::option::Option<crate::model::ErrorDetail>,
}
