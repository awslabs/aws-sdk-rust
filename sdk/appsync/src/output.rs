...
pub struct GetIntrospectionSchemaOutput {
    ...
    /// documentation</a>.</p>
    pub schema: std::option::Option<smithy_types::Blob>,
}
...
pub mod get_introspection_schema_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
    pub struct Builder {
        pub(crate) schema: std::option::Option<smithy_types::Blob>,
    }
    impl Builder {
        /// <p>The schema, in GraphQL Schema Definition Language (SDL) format.</p>
        /// <p>For more information, see the <a href="http://graphql.org/learn/schema/">GraphQL SDL
        /// documentation</a>.</p>
        pub fn schema(mut self, input: smithy_types::Blob) -> Self {
            self.schema = Some(input);
            self
        }
        pub fn set_schema(mut self, input: std::option::Option<smithy_types::Blob>) -> Self {
            self.schema = input;
            self
        }
