...
pub fn ser_create_graphql_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGraphqlApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
