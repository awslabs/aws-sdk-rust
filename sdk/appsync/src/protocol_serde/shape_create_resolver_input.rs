...
pub fn ser_create_resolver_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateResolverInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
