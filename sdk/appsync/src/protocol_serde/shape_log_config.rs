...
pub fn ser_log_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_log_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LogConfig>, aws_smithy_json::deserialize::error::DeserializeError>
