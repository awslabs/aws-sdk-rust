...
) -> Result<Option<crate::types::LogConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "fieldLogLevel" => {
                            builder = builder.set_field_log_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::FieldLogLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
