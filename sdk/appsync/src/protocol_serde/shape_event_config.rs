            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "authProviders" => {
                            builder = builder.set_auth_providers(crate::protocol_serde::shape_auth_providers::de_auth_providers(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "connectionAuthModes" => {
                            builder =
                                builder.set_connection_auth_modes(crate::protocol_serde::shape_auth_modes::de_auth_modes(tokens, _value, depth + 1)?);
                        }
                        "defaultPublishAuthModes" => {
                            builder = builder.set_default_publish_auth_modes(crate::protocol_serde::shape_auth_modes::de_auth_modes(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "defaultSubscribeAuthModes" => {
                            builder = builder.set_default_subscribe_auth_modes(crate::protocol_serde::shape_auth_modes::de_auth_modes(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "logConfig" => {
                            builder = builder.set_log_config(crate::protocol_serde::shape_event_log_config::de_event_log_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
