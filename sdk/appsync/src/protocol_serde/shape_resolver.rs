                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "kind" => {
                                builder = builder.set_kind(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::ResolverKind::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "syncConfig" => {
                                builder = builder.set_sync_config(
                                    crate::protocol_serde::shape_sync_config::de_sync_config(
                                        tokens,
                                    )?,
                                );
                            }
                            "cachingConfig" => {
                                builder = builder.set_caching_config(
                                    crate::protocol_serde::shape_caching_config::de_caching_config(
                                        tokens,
                                    )?,
                                );
                            }
