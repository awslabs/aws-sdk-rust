...
pub fn ser_update_graphql_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_graphql_api::UpdateGraphqlApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_13) = &input.user_pool_config {
        ...
        crate::protocol_serde::shape_user_pool_config::ser_user_pool_config(&mut object_14, var_13)?;
        object_14.finish();
    }
