...
pub fn ser_update_graphql_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGraphqlApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
