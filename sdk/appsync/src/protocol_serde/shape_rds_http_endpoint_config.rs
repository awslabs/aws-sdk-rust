...
pub(crate) fn de_rds_http_endpoint_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::RdsHttpEndpointConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
