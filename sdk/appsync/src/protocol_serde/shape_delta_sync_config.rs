...
pub fn ser_delta_sync_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeltaSyncConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_delta_sync_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeltaSyncConfig>, aws_smithy_json::deserialize::error::DeserializeError>
