...
pub fn ser_user_pool_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserPoolConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_user_pool_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UserPoolConfig>, aws_smithy_json::deserialize::error::DeserializeError>
