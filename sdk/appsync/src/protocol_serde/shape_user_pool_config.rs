...
pub fn ser_user_pool_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UserPoolConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_user_pool_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::UserPoolConfig>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "defaultAction" => {
                                builder = builder.set_default_action(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::DefaultAction::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
