...
pub fn ser_lambda_authorizer_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaAuthorizerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_lambda_authorizer_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LambdaAuthorizerConfig>, aws_smithy_json::deserialize::error::DeserializeError>
