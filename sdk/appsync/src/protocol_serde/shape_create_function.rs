...
pub fn de_create_function_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_function::de_create_function(_response_body, output)
            .map_err(crate::operation::create_function::CreateFunctionError::unhandled)?;
...
) -> Result<crate::operation::create_function::builders::CreateFunctionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "functionConfiguration" => {
                    builder =
                        builder.set_function_configuration(crate::protocol_serde::shape_function_configuration::de_function_configuration(tokens)?);
                }
