...
pub fn ser_open_id_connect_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpenIdConnectConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_open_id_connect_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OpenIdConnectConfig>, aws_smithy_json::deserialize::error::DeserializeError>
