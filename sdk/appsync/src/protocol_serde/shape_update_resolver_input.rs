...
pub fn ser_update_resolver_input_input(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::operation::update_resolver::UpdateResolverInput,
    ...
    if let Some(var_6) = &input.max_batch_size {
        object.key("maxBatchSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.metrics_config {
        object.key("metricsConfig").string(var_7.as_str());
    }
