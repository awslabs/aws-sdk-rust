...
pub fn ser_update_resolver_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateResolverInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
