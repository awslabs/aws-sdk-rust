...
pub(crate) fn de_graphql_api<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GraphqlApi>, aws_smithy_json::deserialize::error::DeserializeError>
