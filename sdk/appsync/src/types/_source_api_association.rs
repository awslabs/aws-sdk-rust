...
impl SourceApiAssociation {
    ...
    /// <p>The datetime value of the last successful merge of the source API association. The result will be in UTC format and your local time zone.</p>
    pub fn last_successful_merge_date(
        &self,
...
impl SourceApiAssociationBuilder {
    ...
    /// <p>The detailed message related to the current state of the source API association.</p>
    pub fn source_api_association_status_detail(
        mut self,
        input: impl ::std::convert::Into<::std::string::String>,
    ) -> Self {
    ...
    /// <p>The detailed message related to the current state of the source API association.</p>
    pub fn set_source_api_association_status_detail(
        mut self,
        input: ::std::option::Option<::std::string::String>,
    ) -> Self {
    ...
    /// <p>The detailed message related to the current state of the source API association.</p>
    pub fn get_source_api_association_status_detail(
        &self,
    ...
    /// <p>The datetime value of the last successful merge of the source API association. The result will be in UTC format and your local time zone.</p>
    pub fn set_last_successful_merge_date(
        mut self,
    ...
    /// <p>The datetime value of the last successful merge of the source API association. The result will be in UTC format and your local time zone.</p>
    pub fn get_last_successful_merge_date(
        &self,
    ) -> &::std::option::Option<::aws_smithy_types::DateTime> {
