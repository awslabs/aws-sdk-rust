...
impl ::std::convert::From<&str> for ResolverKind {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResolverKind::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResolverKind {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResolverKind::from(s))
    }
}
impl ResolverKind {
...
impl ::std::convert::AsRef<str> for ResolverKind {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
