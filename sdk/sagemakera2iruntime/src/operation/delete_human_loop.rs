...
impl DeleteHumanLoop {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_human_loop::DeleteHumanLoopInput,
                    ) -> ::std::result::Result<crate::operation::delete_human_loop::DeleteHumanLoopOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_human_loop::DeleteHumanLoopError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_human_loop::DeleteHumanLoopError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_human_loop::DeleteHumanLoopOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteHumanLoop {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteHumanLoop");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteHumanLoopRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteHumanLoopResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteHumanLoop")
...
.with_interceptor(DeleteHumanLoopEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_human_loop::DeleteHumanLoopError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_human_loop::DeleteHumanLoopError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_human_loop::DeleteHumanLoopError>::new());
...
#[derive(Debug)]
            struct DeleteHumanLoopResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteHumanLoopResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_human_loop::de_delete_human_loop_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteHumanLoopRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteHumanLoopRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_human_loop::DeleteHumanLoopInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_human_loop::DeleteHumanLoopInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.human_loop_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("human_loop_name", "cannot be empty or unset"))?;
    ...
    if human_loop_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("human_loop_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/human-loops/{HumanLoopName}", HumanLoopName = human_loop_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteHumanLoopEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteHumanLoopEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteHumanLoopEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteHumanLoopInput>()
                        .ok_or("failed to downcast to DeleteHumanLoopInput")?;
...
pub enum DeleteHumanLoopError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteHumanLoopError) for what information is available for the error.")]
...
impl DeleteHumanLoopError {
    /// Creates the `DeleteHumanLoopError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteHumanLoopError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteHumanLoopError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_human_loop::DeleteHumanLoopError {
