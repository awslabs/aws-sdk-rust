...
impl StartHumanLoopInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_human_loop::StartHumanLoop::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StartHumanLoop {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_human_loop::de_start_human_loop_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_human_loop::de_start_human_loop_http_response(
                status, headers, body,
            )
        }
    }
