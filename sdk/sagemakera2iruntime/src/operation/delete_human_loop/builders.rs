...
impl DeleteHumanLoopFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_human_loop::DeleteHumanLoopOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_human_loop::DeleteHumanLoopError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_human_loop::DeleteHumanLoopOutput, crate::operation::delete_human_loop::DeleteHumanLoopError, Self> {
