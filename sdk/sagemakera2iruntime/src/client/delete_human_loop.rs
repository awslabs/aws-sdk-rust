...
impl super::Client {
    ...
    ///   - [`human_loop_name(impl Into<String>)`](crate::operation::delete_human_loop::builders::DeleteHumanLoopFluentBuilder::human_loop_name) / [`set_human_loop_name(Option<String>)`](crate::operation::delete_human_loop::builders::DeleteHumanLoopFluentBuilder::set_human_loop_name):<br>required: **true**<br><p>The name of the human loop that you want to delete.</p><br>
