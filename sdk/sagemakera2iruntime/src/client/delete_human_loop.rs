...
impl super::Client {
    ...
    pub fn delete_human_loop(
        &self,
    ) -> crate::operation::delete_human_loop::builders::DeleteHumanLoopFluentBuilder {
        crate::operation::delete_human_loop::builders::DeleteHumanLoopFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
