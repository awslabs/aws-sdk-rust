...
pub fn ser_start_human_loop_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartHumanLoopInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
