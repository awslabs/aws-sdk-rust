...
pub struct InstanceMetadataOptions  {
    ...
    #[doc(hidden)]pub http_tokens: std::option::Option<std::string::String>,
...
pub struct Logging  {
    ...
    #[doc(hidden)]pub s3_logs: std::option::Option<crate::model::S3Logs>,
}
impl Logging {
    /// <p>The Amazon S3 logging configuration.</p>
...
pub struct Schedule  {
    ...
    #[doc(hidden)]pub pipeline_execution_start_condition: std::option::Option<crate::model::PipelineExecutionStartCondition>,
}
impl Schedule {
    /// <p>The cron expression determines how often EC2 Image Builder evaluates your <code>pipelineExecutionStartCondition</code>.</p> 
    /// <p>For information on how to format a cron expression in Image Builder, see <a href="https://docs.aws.amazon.com/imagebuilder/latest/userguide/image-builder-cron.html">Use cron expressions in EC2 Image Builder</a>.</p>
...
impl  std::fmt::Debug for Schedule  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("pipeline_execution_start_condition", &self.pipeline_execution_start_condition);
        formatter.finish()
    }
}
...
pub struct ImageTestsConfiguration  {
    ...
    #[doc(hidden)]pub image_tests_enabled: std::option::Option<bool>,
    /// <p>The maximum time in minutes that tests are permitted to run.</p>
    #[doc(hidden)]pub timeout_minutes: std::option::Option<i32>,
}
...
pub struct Distribution  {
    ...
    #[doc(hidden)]pub ami_distribution_configuration: std::option::Option<crate::model::AmiDistributionConfiguration>,
    /// <p>Container distribution settings for encryption, licensing, and sharing in a specific Region.</p>
    #[doc(hidden)]pub container_distribution_configuration: std::option::Option<crate::model::ContainerDistributionConfiguration>,
    ...
    #[doc(hidden)]pub launch_template_configurations: std::option::Option<std::vec::Vec<crate::model::LaunchTemplateConfiguration>>,
    ...
    #[doc(hidden)]pub fast_launch_configurations: std::option::Option<std::vec::Vec<crate::model::FastLaunchConfiguration>>,
}
impl Distribution {
    /// <p>The target Region.</p>
...
impl  std::fmt::Debug for Distribution  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("ami_distribution_configuration", &self.ami_distribution_configuration);
        formatter.field("container_distribution_configuration", &self.container_distribution_configuration);
        formatter.field("license_configuration_arns", &self.license_configuration_arns);
        formatter.field("launch_template_configurations", &self.launch_template_configurations);
        formatter.field("s3_export_configuration", &self.s3_export_configuration);
        formatter.field("fast_launch_configurations", &self.fast_launch_configurations);
        formatter.finish()
    }
}
...
pub struct FastLaunchConfiguration  {
    ...
    #[doc(hidden)]pub snapshot_configuration: std::option::Option<crate::model::FastLaunchSnapshotConfiguration>,
    /// <p>The maximum number of parallel instances that are launched for creating resources.</p>
    #[doc(hidden)]pub max_parallel_launches: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub launch_template: std::option::Option<crate::model::FastLaunchLaunchTemplateSpecification>,
...
pub struct FastLaunchLaunchTemplateSpecification  {
    ...
    #[doc(hidden)]pub launch_template_version: std::option::Option<std::string::String>,
}
...
pub struct FastLaunchSnapshotConfiguration  {
    ...
    #[doc(hidden)]pub target_resource_count: std::option::Option<i32>,
}
...
pub struct S3ExportConfiguration  {
    ...
    /// </ul>
    #[doc(hidden)]pub disk_image_format: std::option::Option<crate::model::DiskImageFormat>,
...
pub struct LaunchTemplateConfiguration  {
    ...
    #[doc(hidden)]pub set_default_version: bool,
}
...
pub struct ContainerDistributionConfiguration  {
    ...
    #[doc(hidden)]pub container_tags: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct TargetContainerRepository  {
    ...
    #[doc(hidden)]pub service: std::option::Option<crate::model::ContainerRepositoryService>,
...
pub struct AmiDistributionConfiguration  {
    ...
    #[doc(hidden)]pub target_account_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The tags to apply to AMIs distributed to this Region.</p>
    #[doc(hidden)]pub ami_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub launch_permission: std::option::Option<crate::model::LaunchPermissionConfiguration>,
}
...
pub struct LaunchPermissionConfiguration  {
    ...
    #[doc(hidden)]pub user_groups: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub organization_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub organizational_unit_arns: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct InfrastructureConfigurationSummary  {
    ...
    #[doc(hidden)]pub date_created: std::option::Option<std::string::String>,
    /// <p>The date on which the infrastructure configuration was last updated.</p>
    #[doc(hidden)]pub date_updated: std::option::Option<std::string::String>,
...
pub struct ImageVersion  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ImageType>,
    ...
    /// </ul>
    #[doc(hidden)]pub build_type: std::option::Option<crate::model::BuildType>,
}
impl ImageVersion {
    /// <p>The Amazon Resource Name (ARN) of a specific version of an Image Builder image.</p> <note> 
    /// <p>Semantic versioning is included in each object's Amazon Resource Name (ARN), at the level that applies to that object as follows:</p> 
...
pub struct ImagePipeline  {
    ...
    #[doc(hidden)]pub date_last_run: std::option::Option<std::string::String>,
    /// <p>The date on which this image pipeline will next be run.</p>
    #[doc(hidden)]pub date_next_run: std::option::Option<std::string::String>,
...
pub struct ImageSummary  {
    ...
    #[doc(hidden)]pub output_resources: std::option::Option<crate::model::OutputResources>,
...
pub struct OutputResources  {
    ...
    #[doc(hidden)]pub amis: std::option::Option<std::vec::Vec<crate::model::Ami>>,
...
pub struct Container  {
    ...
    #[doc(hidden)]pub image_uris: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Container {
    /// <p>Containers and container images are Region-specific. This is the Region context for the container.</p>
    pub fn region(&self) -> std::option::Option<& str> {
...
pub struct ImageState  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ImageStatus>,
...
pub struct ComponentSummary  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::ComponentState>,
    /// <p>The type of the component denotes whether the component is used to build the image or only to test it.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ComponentType>,
    /// <p>The owner of the component.</p>
    #[doc(hidden)]pub owner: std::option::Option<std::string::String>,
...
pub struct ComponentState  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ComponentStatus>,
...
pub struct AdditionalInstanceConfiguration  {
    ...
    #[doc(hidden)]pub systems_manager_agent: std::option::Option<crate::model::SystemsManagerAgent>,
    ...
    /// <p>touch /var</p> 
    /// </note>
    #[doc(hidden)]pub user_data_override: std::option::Option<std::string::String>,
}
...
pub struct SystemsManagerAgent  {
    ...
    #[doc(hidden)]pub uninstall_after_build: std::option::Option<bool>,
}
...
pub struct InstanceBlockDeviceMapping  {
    ...
    #[doc(hidden)]pub ebs: std::option::Option<crate::model::EbsInstanceBlockDeviceSpecification>,
...
pub struct EbsInstanceBlockDeviceSpecification  {
    ...
    #[doc(hidden)]pub volume_type: std::option::Option<crate::model::EbsVolumeType>,
...
pub struct ComponentConfiguration  {
    ...
    #[doc(hidden)]pub parameters: std::option::Option<std::vec::Vec<crate::model::ComponentParameter>>,
}
...
pub struct Image  {
    ...
    #[doc(hidden)]pub source_pipeline_name: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the image pipeline that created this image.</p>
    #[doc(hidden)]pub source_pipeline_arn: std::option::Option<std::string::String>,
...
pub struct Component  {
    ...
    #[doc(hidden)]pub parameters: std::option::Option<std::vec::Vec<crate::model::ComponentParameterDetail>>,
    /// <p>The owner of the component.</p>
    #[doc(hidden)]pub owner: std::option::Option<std::string::String>,
...
pub struct ComponentParameterDetail  {
    ...
    #[doc(hidden)]pub default_value: std::option::Option<std::vec::Vec<std::string::String>>,
