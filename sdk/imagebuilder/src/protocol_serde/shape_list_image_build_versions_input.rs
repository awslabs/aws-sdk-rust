...
pub fn ser_list_image_build_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListImageBuildVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
