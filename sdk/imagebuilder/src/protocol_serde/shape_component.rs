            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "supportedOsVersions" => {
                            builder = builder.set_supported_os_versions(crate::protocol_serde::shape_os_version_list::de_os_version_list(tokens)?);
                        }
                        "state" => {
                            builder = builder.set_state(crate::protocol_serde::shape_component_state::de_component_state(tokens)?);
                        }
                        "parameters" => {
                            builder = builder.set_parameters(
                                crate::protocol_serde::shape_component_parameter_detail_list::de_component_parameter_detail_list(tokens)?,
                            );
                        }
                        "owner" => {
