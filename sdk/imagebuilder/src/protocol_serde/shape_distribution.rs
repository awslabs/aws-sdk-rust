...
pub fn ser_distribution(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Distribution) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_distribution<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Distribution>, aws_smithy_json::deserialize::error::DeserializeError>
