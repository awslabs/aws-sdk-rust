...
pub fn ser_import_vm_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportVmImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
