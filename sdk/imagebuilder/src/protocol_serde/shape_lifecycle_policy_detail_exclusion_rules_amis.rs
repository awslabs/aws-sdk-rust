...
pub(crate) fn de_lifecycle_policy_detail_exclusion_rules_amis<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LifecyclePolicyDetailExclusionRulesAmis>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "sharedAccounts" => {
                                builder = builder.set_shared_accounts(
