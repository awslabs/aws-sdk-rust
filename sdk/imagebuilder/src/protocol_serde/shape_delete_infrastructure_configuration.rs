...
pub fn de_delete_infrastructure_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteInfrastructureConfigurationOutput, crate::error::DeleteInfrastructureConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteInfrastructureConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_infrastructure_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteInfrastructureConfigurationOutput, crate::error::DeleteInfrastructureConfigurationError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_delete_infrastructure_configuration(value: &[u8], mut builder: crate::output::delete_infrastructure_configuration_output::Builder) -> Result<crate::output::delete_infrastructure_configuration_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
