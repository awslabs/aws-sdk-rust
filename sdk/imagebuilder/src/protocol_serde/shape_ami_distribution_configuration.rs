...
pub fn ser_ami_distribution_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AmiDistributionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ami_distribution_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AmiDistributionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
