            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "targetAccountIds" => {
                            builder = builder.set_target_account_ids(crate::protocol_serde::shape_account_list::de_account_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "launchPermission" => {
                            builder = builder.set_launch_permission(
                                crate::protocol_serde::shape_launch_permission_configuration::de_launch_permission_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
