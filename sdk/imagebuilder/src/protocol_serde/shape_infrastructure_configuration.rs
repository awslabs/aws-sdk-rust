...
pub(crate) fn de_infrastructure_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InfrastructureConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
