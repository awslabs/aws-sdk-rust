...
pub(crate) fn de_ebs_instance_block_device_specification<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::EbsInstanceBlockDeviceSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
