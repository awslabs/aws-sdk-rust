...
pub fn de_list_image_pipeline_images_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_image_pipeline_images::ListImagePipelineImagesOutput, crate::operation::list_image_pipeline_images::ListImagePipelineImagesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_image_pipeline_images::ListImagePipelineImagesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_image_pipeline_images_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_image_pipeline_images::ListImagePipelineImagesOutput, crate::operation::list_image_pipeline_images::ListImagePipelineImagesError> {
    Ok({
        #[allow(unused_mut)]
