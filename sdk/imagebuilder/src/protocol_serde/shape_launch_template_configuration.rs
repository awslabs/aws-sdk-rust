...
pub(crate) fn de_launch_template_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::LaunchTemplateConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "setDefaultVersion" => {
                            builder = builder.set_set_default_version(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
