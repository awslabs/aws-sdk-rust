...
pub fn ser_list_image_pipelines_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_image_pipelines::ListImagePipelinesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
