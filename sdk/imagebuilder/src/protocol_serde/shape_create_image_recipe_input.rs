...
pub fn ser_create_image_recipe_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateImageRecipeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
