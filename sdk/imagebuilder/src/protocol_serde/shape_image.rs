            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "imageRecipe" => {
                            builder =
                                builder.set_image_recipe(crate::protocol_serde::shape_image_recipe::de_image_recipe(tokens, _value, depth + 1)?);
                        }
                        "containerRecipe" => {
                        ...
                        "infrastructureConfiguration" => {
                            builder = builder.set_infrastructure_configuration(
                                crate::protocol_serde::shape_infrastructure_configuration::de_infrastructure_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "scanState" => {
                            builder = builder.set_scan_state(crate::protocol_serde::shape_image_scan_state::de_image_scan_state(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
