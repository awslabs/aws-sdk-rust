            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "outputResources" => {
                            builder = builder.set_output_resources(crate::protocol_serde::shape_output_resources::de_output_resources(tokens)?);
                        }
                        "tags" => {
                        ...
                        "scanState" => {
                            builder = builder.set_scan_state(crate::protocol_serde::shape_image_scan_state::de_image_scan_state(tokens)?);
                        }
