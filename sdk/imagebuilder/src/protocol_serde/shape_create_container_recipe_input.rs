...
pub fn ser_create_container_recipe_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateContainerRecipeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
