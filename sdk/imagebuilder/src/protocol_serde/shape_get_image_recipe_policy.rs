...
pub fn de_get_image_recipe_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_image_recipe_policy::GetImageRecipePolicyOutput, crate::operation::get_image_recipe_policy::GetImageRecipePolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_image_recipe_policy::GetImageRecipePolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_image_recipe_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_image_recipe_policy::GetImageRecipePolicyOutput, crate::operation::get_image_recipe_policy::GetImageRecipePolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_image_recipe_policy::builders::GetImageRecipePolicyOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_image_recipe_policy::de_get_image_recipe_policy(response.body().as_ref(), output).map_err(crate::operation::get_image_recipe_policy::GetImageRecipePolicyError::unhandled)?;
