...
pub fn ser_update_image_pipeline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateImagePipelineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
