...
pub fn de_get_image_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_image::GetImageOutput, crate::operation::get_image::GetImageError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_image_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_image::GetImageOutput, crate::operation::get_image::GetImageError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_image::de_get_image(_response_body, output)
            .map_err(crate::operation::get_image::GetImageError::unhandled)?;
...
) -> Result<crate::operation::get_image::builders::GetImageOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
