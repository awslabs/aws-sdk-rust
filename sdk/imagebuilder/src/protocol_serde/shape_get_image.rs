...
pub fn de_get_image_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_image::GetImageOutput, crate::operation::get_image::GetImageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_image::GetImageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_image_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_image::GetImageOutput, crate::operation::get_image::GetImageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_image::builders::GetImageOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_image::de_get_image(response.body().as_ref(), output).map_err(crate::operation::get_image::GetImageError::unhandled)?;
