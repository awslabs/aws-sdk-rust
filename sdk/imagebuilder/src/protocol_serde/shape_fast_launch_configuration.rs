...
pub fn ser_fast_launch_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FastLaunchConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
...
pub(crate) fn de_fast_launch_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FastLaunchConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
