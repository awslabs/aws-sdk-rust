...
pub fn ser_create_image_pipeline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateImagePipelineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
