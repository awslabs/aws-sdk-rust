...
) -> ::std::result::Result<Option<crate::types::S3ExportConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "diskImageFormat" => {
                            builder = builder.set_disk_image_format(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::DiskImageFormat::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "s3Bucket" => {
