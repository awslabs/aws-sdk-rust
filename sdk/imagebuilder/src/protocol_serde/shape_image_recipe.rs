...
pub(crate) fn de_image_recipe<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ImageRecipe>, aws_smithy_json::deserialize::error::DeserializeError>
