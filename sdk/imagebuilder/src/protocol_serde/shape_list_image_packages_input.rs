...
pub fn ser_list_image_packages_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListImagePackagesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
