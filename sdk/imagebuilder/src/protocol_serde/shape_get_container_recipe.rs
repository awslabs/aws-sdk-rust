...
pub fn de_get_container_recipe_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_container_recipe::GetContainerRecipeOutput, crate::operation::get_container_recipe::GetContainerRecipeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_container_recipe::GetContainerRecipeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_container_recipe_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_container_recipe::GetContainerRecipeOutput, crate::operation::get_container_recipe::GetContainerRecipeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_container_recipe::builders::GetContainerRecipeOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_container_recipe::de_get_container_recipe(response.body().as_ref(), output).map_err(crate::operation::get_container_recipe::GetContainerRecipeError::unhandled)?;
