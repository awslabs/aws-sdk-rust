...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_container_recipe::de_get_container_recipe(_response_body, output)
            .map_err(crate::operation::get_container_recipe::GetContainerRecipeError::unhandled)?;
...
) -> Result<crate::operation::get_container_recipe::builders::GetContainerRecipeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "containerRecipe" => {
                    builder = builder.set_container_recipe(crate::protocol_serde::shape_container_recipe::de_container_recipe(tokens)?);
                }
                "requestId" => {
