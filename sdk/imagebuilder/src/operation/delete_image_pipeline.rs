...
impl DeleteImagePipelineInput {
    /// Consumes the builder and constructs an Operation<[`DeleteImagePipeline`](crate::operation::delete_image_pipeline::DeleteImagePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_image_pipeline::DeleteImagePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_image_pipeline::DeleteImagePipelineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/DeleteImagePipeline").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_image_pipeline::DeleteImagePipelineInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.image_pipeline_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("image_pipeline_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_image_pipeline::DeleteImagePipeline::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteImagePipeline {
                type Output = std::result::Result<crate::operation::delete_image_pipeline::DeleteImagePipelineOutput, crate::operation::delete_image_pipeline::DeleteImagePipelineError>;
