    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_infrastructure_configuration::DeleteInfrastructureConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/DeleteInfrastructureConfiguration")
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInfrastructureConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_infrastructure_configuration::de_delete_infrastructure_configuration_http_response_with_props(status, headers, body)
        }
    }
}
