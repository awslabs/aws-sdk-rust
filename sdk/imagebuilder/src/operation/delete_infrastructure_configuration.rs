...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeleteInfrastructureConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteInfrastructureConfigurationRequestSerializer {
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_1 = inner_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("infrastructure_configuration_arn", "cannot be empty or unset")
                })?;
                if inner_1.is_empty() {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteInfrastructureConfigurationEndpointParamsInterceptor {
