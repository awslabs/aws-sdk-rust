...
impl GetImageRecipeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_image_recipe::GetImageRecipe, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImageRecipe {
    type Output =
        ::std::result::Result<crate::operation::get_image_recipe::GetImageRecipeOutput, crate::operation::get_image_recipe::GetImageRecipeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_image_recipe::de_get_image_recipe_http_response_with_props(status, headers, body)
        }
    }
}
