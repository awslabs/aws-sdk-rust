...
impl GetImageRecipeInput {
    /// Consumes the builder and constructs an Operation<[`GetImageRecipe`](crate::operation::get_image_recipe::GetImageRecipe)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_image_recipe::GetImageRecipe, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_image_recipe::GetImageRecipeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/GetImageRecipe").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_image_recipe::GetImageRecipeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.image_recipe_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("image_recipe_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_image_recipe::GetImageRecipe::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetImageRecipe {
                type Output = std::result::Result<crate::operation::get_image_recipe::GetImageRecipeOutput, crate::operation::get_image_recipe::GetImageRecipeError>;
