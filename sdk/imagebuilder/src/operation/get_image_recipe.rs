...
impl GetImageRecipeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_image_recipe::GetImageRecipe,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_image_recipe::GetImageRecipe::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImageRecipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_image_recipe::de_get_image_recipe_http_error(
                status, headers, body,
            )
        } else {
