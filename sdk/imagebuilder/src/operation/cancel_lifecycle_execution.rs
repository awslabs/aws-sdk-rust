...
/// Orchestration and serialization glue logic for `CancelLifecycleExecution`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CancelLifecycleExecution;
impl CancelLifecycleExecution {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelLifecycleExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelLifecycleExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelLifecycleExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelLifecycleExecutionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelLifecycleExecution")
...
.with_interceptor(CancelLifecycleExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError>::new());
...
#[derive(Debug)]
            struct CancelLifecycleExecutionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelLifecycleExecutionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_lifecycle_execution::de_cancel_lifecycle_execution_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_cancel_lifecycle_execution::de_cancel_lifecycle_execution_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelLifecycleExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelLifecycleExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/CancelLifecycleExecution").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_lifecycle_execution::ser_cancel_lifecycle_execution_input(&input)?);
...
#[derive(Debug)]
            struct CancelLifecycleExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelLifecycleExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelLifecycleExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelLifecycleExecutionInput>()
                        .ok_or("failed to downcast to CancelLifecycleExecutionInput")?;
...
/// Error type for the `CancelLifecycleExecutionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CancelLifecycleExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelLifecycleExecutionError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CancelLifecycleExecutionError {
    /// Creates the `CancelLifecycleExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelLifecycleExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::CallRateLimitExceededException`.
    pub fn is_call_rate_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::CallRateLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `CancelLifecycleExecutionError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
}
impl ::std::error::Error for CancelLifecycleExecutionError {
...
impl ::std::fmt::Display for CancelLifecycleExecutionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CancelLifecycleExecutionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelLifecycleExecutionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelLifecycleExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_lifecycle_execution::CancelLifecycleExecutionError {
...
mod _cancel_lifecycle_execution_output;
