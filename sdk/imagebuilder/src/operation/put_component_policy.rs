...
impl PutComponentPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutComponentPolicy`](crate::operation::put_component_policy::PutComponentPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_component_policy::PutComponentPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_component_policy::PutComponentPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_component_policy::PutComponentPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutComponentPolicy {
                type Output = std::result::Result<crate::operation::put_component_policy::PutComponentPolicyOutput, crate::operation::put_component_policy::PutComponentPolicyError>;
