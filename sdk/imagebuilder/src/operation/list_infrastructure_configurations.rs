    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/ListInfrastructureConfigurations")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInfrastructureConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_infrastructure_configurations::de_list_infrastructure_configurations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_infrastructure_configurations::ListInfrastructureConfigurationsError
{
