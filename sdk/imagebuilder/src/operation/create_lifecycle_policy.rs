    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_lifecycle_policy::CreateLifecyclePolicyInput = input.downcast_mut().expect("correct type");
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/CreateLifecyclePolicy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateLifecyclePolicyError {
    ...
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::CallRateLimitExceededException`.
    pub fn is_call_rate_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::CallRateLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::DryRunOperationException`.
    pub fn is_dry_run_operation_exception(&self) -> bool {
        matches!(self, Self::DryRunOperationException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::IdempotentParameterMismatchException`.
    ...
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ResourceAlreadyExistsException`.
    pub fn is_resource_already_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateLifecyclePolicyError::ServiceUnavailableException`.
