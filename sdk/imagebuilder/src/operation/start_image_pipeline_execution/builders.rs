...
impl StartImagePipelineExecutionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionOutput, crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionError, Self> {
