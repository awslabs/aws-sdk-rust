...
impl PutImageRecipePolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutImageRecipePolicy`](crate::operation::put_image_recipe_policy::PutImageRecipePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_image_recipe_policy::PutImageRecipePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_image_recipe_policy::PutImageRecipePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_image_recipe_policy::PutImageRecipePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutImageRecipePolicy {
                type Output = std::result::Result<crate::operation::put_image_recipe_policy::PutImageRecipePolicyOutput, crate::operation::put_image_recipe_policy::PutImageRecipePolicyError>;
