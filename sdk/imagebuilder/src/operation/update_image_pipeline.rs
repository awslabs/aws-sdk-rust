...
impl UpdateImagePipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_image_pipeline::UpdateImagePipeline,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateImagePipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_image_pipeline::de_update_image_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
