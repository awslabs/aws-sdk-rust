...
impl ListImagePipelineImagesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_image_pipeline_images::ListImagePipelineImagesInput, ::aws_smithy_types::error::operation::BuildError> {
