...
impl ListImageRecipesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_image_recipes::ListImageRecipesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_image_recipes::ListImageRecipesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_image_recipes::ListImageRecipesOutput, crate::operation::list_image_recipes::ListImageRecipesError, Self> {
