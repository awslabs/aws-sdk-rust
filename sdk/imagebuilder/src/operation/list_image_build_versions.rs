...
impl ListImageBuildVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListImageBuildVersions`](crate::operation::list_image_build_versions::ListImageBuildVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_image_build_versions::ListImageBuildVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_image_build_versions::ListImageBuildVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_image_build_versions::ListImageBuildVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListImageBuildVersions {
                type Output = std::result::Result<crate::operation::list_image_build_versions::ListImageBuildVersionsOutput, crate::operation::list_image_build_versions::ListImageBuildVersionsError>;
