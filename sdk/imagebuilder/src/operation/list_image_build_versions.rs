...
/// Orchestration and serialization glue logic for `ListImageBuildVersions`.
...
impl ListImageBuildVersions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_image_build_versions::ListImageBuildVersionsInput,
                    ) -> ::std::result::Result<crate::operation::list_image_build_versions::ListImageBuildVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_image_build_versions::ListImageBuildVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_image_build_versions::ListImageBuildVersionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_image_build_versions::ListImageBuildVersionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListImageBuildVersions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListImageBuildVersions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListImageBuildVersionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListImageBuildVersionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListImageBuildVersions")
...
.with_interceptor(ListImageBuildVersionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_image_build_versions::ListImageBuildVersionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_image_build_versions::ListImageBuildVersionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_image_build_versions::ListImageBuildVersionsError>::new());
...
#[derive(Debug)]
            struct ListImageBuildVersionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListImageBuildVersionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_image_build_versions::de_list_image_build_versions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_image_build_versions::de_list_image_build_versions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListImageBuildVersionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListImageBuildVersionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_image_build_versions::ListImageBuildVersionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_image_build_versions::ListImageBuildVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/ListImageBuildVersions").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_image_build_versions::ser_list_image_build_versions_input(&input)?);
...
#[derive(Debug)]
            struct ListImageBuildVersionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListImageBuildVersionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListImageBuildVersionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListImageBuildVersionsInput>()
                        .ok_or("failed to downcast to ListImageBuildVersionsInput")?;
...
pub enum ListImageBuildVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListImageBuildVersionsError) for what information is available for the error.")]
...
impl ListImageBuildVersionsError {
    /// Creates the `ListImageBuildVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListImageBuildVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListImageBuildVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_image_build_versions::ListImageBuildVersionsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_image_build_versions::_list_image_build_versions_output::ListImageBuildVersionsOutput;

pub use crate::operation::list_image_build_versions::_list_image_build_versions_input::ListImageBuildVersionsInput;

mod _list_image_build_versions_input;

mod _list_image_build_versions_output;
