...
impl ImportVmImageInput {
    /// Consumes the builder and constructs an Operation<[`ImportVmImage`](crate::operation::import_vm_image::ImportVmImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_vm_image::ImportVmImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_vm_image::ImportVmImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_vm_image::ser_import_vm_image_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::import_vm_image::ImportVmImage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ImportVmImage {
                type Output = std::result::Result<crate::operation::import_vm_image::ImportVmImageOutput, crate::operation::import_vm_image::ImportVmImageError>;
