...
impl ImportVmImageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::import_vm_image::ImportVmImage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_vm_image::ser_import_vm_image_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportVmImage {
    type Output =
        ::std::result::Result<crate::operation::import_vm_image::ImportVmImageOutput, crate::operation::import_vm_image::ImportVmImageError>;
