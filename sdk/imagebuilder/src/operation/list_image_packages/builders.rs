...
impl ListImagePackagesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_image_packages::ListImagePackagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_image_packages::ListImagePackagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_image_packages::ListImagePackagesOutput, crate::operation::list_image_packages::ListImagePackagesError, Self> {
