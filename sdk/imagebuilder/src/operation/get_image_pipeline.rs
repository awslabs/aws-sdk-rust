...
impl GetImagePipelineInput {
    /// Consumes the builder and constructs an Operation<[`GetImagePipeline`](crate::operation::get_image_pipeline::GetImagePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_image_pipeline::GetImagePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_image_pipeline::GetImagePipelineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/GetImagePipeline").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_image_pipeline::GetImagePipelineInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_image_pipeline::GetImagePipeline::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetImagePipeline {
                type Output = std::result::Result<crate::operation::get_image_pipeline::GetImagePipelineOutput, crate::operation::get_image_pipeline::GetImagePipelineError>;
