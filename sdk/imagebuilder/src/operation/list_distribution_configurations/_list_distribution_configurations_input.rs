...
impl ListDistributionConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_distribution_configurations::ListDistributionConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
