...
#[derive(Debug)]
    ...
    ::std::write!(output, "/DeleteWorkflow").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_workflow::DeleteWorkflowInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.workflow_build_version_arn;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("workflow_build_version_arn", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("workflow_build_version_arn", "cannot be empty or unset"));
    }
    query.push_kv("workflowBuildVersionArn", &::aws_smithy_http::query::fmt_string(inner_1));
    ::std::result::Result::Ok(())
}
...
impl DeleteWorkflowError {
    ...
    /// Returns `true` if the error kind is `DeleteWorkflowError::CallRateLimitExceededException`.
    pub fn is_call_rate_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::CallRateLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteWorkflowError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `DeleteWorkflowError::ForbiddenException`.
    ...
    /// Returns `true` if the error kind is `DeleteWorkflowError::ResourceDependencyException`.
    pub fn is_resource_dependency_exception(&self) -> bool {
        matches!(self, Self::ResourceDependencyException(_))
    }
    /// Returns `true` if the error kind is `DeleteWorkflowError::ServiceException`.
