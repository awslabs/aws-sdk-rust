...
impl CreateInfrastructureConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_infrastructure_configuration::CreateInfrastructureConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInfrastructureConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_infrastructure_configuration::de_create_infrastructure_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
