...
impl GetContainerRecipePolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerRecipePolicy`](crate::operation::get_container_recipe_policy::GetContainerRecipePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_container_recipe_policy::GetContainerRecipePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_recipe_policy::GetContainerRecipePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/GetContainerRecipePolicy").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_container_recipe_policy::GetContainerRecipePolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.container_recipe_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("container_recipe_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_recipe_policy::GetContainerRecipePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetContainerRecipePolicy {
                type Output = std::result::Result<crate::operation::get_container_recipe_policy::GetContainerRecipePolicyOutput, crate::operation::get_container_recipe_policy::GetContainerRecipePolicyError>;
