...
impl GetContainerRecipePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_container_recipe_policy::GetContainerRecipePolicy,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_recipe_policy::GetContainerRecipePolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerRecipePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_container_recipe_policy::de_get_container_recipe_policy_http_response_with_props(status, headers, body)
        }
    }
}
