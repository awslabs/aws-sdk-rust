...
impl SendWorkflowStepActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_workflow_step_action::SendWorkflowStepActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_workflow_step_action::SendWorkflowStepActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_workflow_step_action::SendWorkflowStepActionOutput, crate::operation::send_workflow_step_action::SendWorkflowStepActionError, Self> {
