...
impl ListWorkflowExecutionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_workflow_executions::ListWorkflowExecutions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkflowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_workflow_executions::de_list_workflow_executions_http_response_with_props(status, headers, body)
        }
    }
}
