    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_workflow_executions::ListWorkflowExecutionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_workflow_executions::ListWorkflowExecutionsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWorkflowExecutions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListWorkflowExecutions", "imagebuilder"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWorkflowExecutions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListWorkflowExecutionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListWorkflowExecutionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_workflow_executions::ListWorkflowExecutionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_workflow_executions::ser_list_workflow_executions_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListWorkflowExecutionsEndpointParamsInterceptor {
...
pub type ListWorkflowExecutionsErrorKind = ListWorkflowExecutionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListWorkflowExecutionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_workflow_executions::ListWorkflowExecutionsError {
...
impl ListWorkflowExecutionsError {
    ...
    /// Creates the `ListWorkflowExecutionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
