...
impl ListImagePipelinesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_image_pipelines::ListImagePipelines,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_image_pipelines::ser_list_image_pipelines_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImagePipelines {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_image_pipelines::de_list_image_pipelines_http_response_with_props(status, headers, body)
        }
    }
}
