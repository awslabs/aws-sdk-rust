...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DistributeImageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_distribute_image::de_distribute_image_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_distribute_image::de_distribute_image_http_response(status, headers, body)
        };
