...
impl CreateWorkflow {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("imagebuilder", "CreateWorkflow", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateWorkflow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateWorkflow", "imagebuilder"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/CreateWorkflow").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateWorkflowError {
    ...
    /// Returns `true` if the error kind is `CreateWorkflowError::CallRateLimitExceededException`.
    pub fn is_call_rate_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::CallRateLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::InvalidParameterCombinationException`.
    ...
    /// Returns `true` if the error kind is `CreateWorkflowError::InvalidVersionNumberException`.
    pub fn is_invalid_version_number_exception(&self) -> bool {
        matches!(self, Self::InvalidVersionNumberException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkflowError::ServiceException`.
