...
impl CreateWorkflow {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("imagebuilder", "CreateWorkflow", input, runtime_plugins, stop_point)
...
impl CreateWorkflowError {
    ...
    /// Returns `true` if the error kind is `CreateWorkflowError::DryRunOperationException`.
