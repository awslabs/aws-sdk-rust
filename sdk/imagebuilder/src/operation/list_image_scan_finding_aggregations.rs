...
impl ListImageScanFindingAggregationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_image_scan_finding_aggregations::ListImageScanFindingAggregations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_image_scan_finding_aggregations::ListImageScanFindingAggregations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImageScanFindingAggregations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_image_scan_finding_aggregations::de_list_image_scan_finding_aggregations_http_response_with_props(
                status, headers, body,
            )
        }
    }
