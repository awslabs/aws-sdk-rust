    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/GetDistributionConfiguration")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_distribution_configuration::de_get_distribution_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetDistributionConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_distribution_configuration::GetDistributionConfigurationError
{
