...
impl GetDistributionConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_distribution_configuration::GetDistributionConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_distribution_configuration::de_get_distribution_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
