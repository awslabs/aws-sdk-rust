...
impl GetDistributionConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetDistributionConfiguration`](crate::operation::get_distribution_configuration::GetDistributionConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_distribution_configuration::GetDistributionConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_distribution_configuration::GetDistributionConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/GetDistributionConfiguration").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_distribution_configuration::GetDistributionConfigurationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.distribution_configuration_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("distribution_configuration_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_distribution_configuration::GetDistributionConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDistributionConfiguration {
                type Output = std::result::Result<crate::operation::get_distribution_configuration::GetDistributionConfigurationOutput, crate::operation::get_distribution_configuration::GetDistributionConfigurationError>;
