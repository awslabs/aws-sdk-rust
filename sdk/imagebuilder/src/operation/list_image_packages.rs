...
impl ListImagePackagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_image_packages::ListImagePackages,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_image_packages::ser_list_image_packages_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImagePackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_image_packages::de_list_image_packages_http_response_with_props(status, headers, body)
        }
    }
}
