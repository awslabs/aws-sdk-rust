...
impl ListImagePackagesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_image_packages::ListImagePackages::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImagePackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_image_packages::de_list_image_packages_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_image_packages::ListImagePackagesError
{
