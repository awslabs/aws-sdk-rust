...
impl ListImagePipelineImagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_image_pipeline_images::ListImagePipelineImages,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImagePipelineImages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_image_pipeline_images::de_list_image_pipeline_images_http_response_with_props(status, headers, body)
        }
    }
}
