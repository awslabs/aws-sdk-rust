...
impl DeleteContainerRecipeFluentBuilder  {
    /// Creates a new `DeleteContainerRecipe`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_container_recipe::DeleteContainerRecipeOutput, aws_smithy_http::result::SdkError<crate::operation::delete_container_recipe::DeleteContainerRecipeError>>
                     {
