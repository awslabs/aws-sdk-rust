...
impl DeleteComponentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteComponent`](crate::operation::delete_component::DeleteComponent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_component::DeleteComponent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_component::DeleteComponentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/DeleteComponent").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_component::DeleteComponentInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.component_build_version_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("component_build_version_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("component_build_version_arn", "cannot be empty or unset"));
                }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_component::DeleteComponent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteComponent", "imagebuilder"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteComponent {
                type Output = std::result::Result<crate::operation::delete_component::DeleteComponentOutput, crate::operation::delete_component::DeleteComponentError>;
