...
impl DeleteComponentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_component::DeleteComponent, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteComponent {
    type Output =
        ::std::result::Result<crate::operation::delete_component::DeleteComponentOutput, crate::operation::delete_component::DeleteComponentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_component::de_delete_component_http_response_with_props(status, headers, body)
        }
    }
}
