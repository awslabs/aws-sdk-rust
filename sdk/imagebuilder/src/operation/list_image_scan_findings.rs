    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_image_scan_findings::ListImageScanFindingsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_image_scan_findings::ListImageScanFindingsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListImageScanFindings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListImageScanFindings", "imagebuilder"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListImageScanFindings")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListImageScanFindingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListImageScanFindingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_image_scan_findings::ListImageScanFindingsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_image_scan_findings::ser_list_image_scan_findings_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListImageScanFindingsEndpointParamsInterceptor {
...
pub type ListImageScanFindingsErrorKind = ListImageScanFindingsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListImageScanFindingsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_image_scan_findings::ListImageScanFindingsError {
...
impl ListImageScanFindingsError {
    ...
    /// Creates the `ListImageScanFindingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
