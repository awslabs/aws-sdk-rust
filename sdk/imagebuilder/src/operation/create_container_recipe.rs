...
/// Orchestration and serialization glue logic for `CreateContainerRecipe`.
...
impl CreateContainerRecipe {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_container_recipe::CreateContainerRecipeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_container_recipe::CreateContainerRecipeOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateContainerRecipe",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_container_recipe::CreateContainerRecipeInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContainerRecipe {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateContainerRecipe");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateContainerRecipeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateContainerRecipeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateContainerRecipe")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateContainerRecipe")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateContainerRecipeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateContainerRecipeEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateContainerRecipeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContainerRecipeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateContainerRecipeInput>() else {
        ...
        if requested.should_capture("dockerfileTemplateData") {
            if let ::std::option::Option::Some(value) = input.dockerfile_template_data.as_deref() {
                captured.insert("dockerfileTemplateData", value);
            }
        }
        if requested.should_capture("dockerfileTemplateUri") {
            if let ::std::option::Option::Some(value) = input.dockerfile_template_uri.as_deref() {
                captured.insert("dockerfileTemplateUri", value);
            }
        }
        if requested.should_capture("imageOsVersionOverride") {
            if let ::std::option::Option::Some(value) = input.image_os_version_override.as_deref() {
                captured.insert("imageOsVersionOverride", value);
            }
        }
        if requested.should_capture("parentImage") {
            if let ::std::option::Option::Some(value) = input.parent_image.as_deref() {
                captured.insert("parentImage", value);
            }
        }
        if requested.should_capture("workingDirectory") {
            if let ::std::option::Option::Some(value) = input.working_directory.as_deref() {
                captured.insert("workingDirectory", value);
            }
        }
...
#[derive(Debug)]
struct CreateContainerRecipeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContainerRecipeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_container_recipe::de_create_container_recipe_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_container_recipe::de_create_container_recipe_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateContainerRecipeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContainerRecipeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_container_recipe::CreateContainerRecipeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_container_recipe::CreateContainerRecipeInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CreateContainerRecipe").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_container_recipe::ser_create_container_recipe_input(
            &input,
        )?);
...
#[derive(Debug)]
struct CreateContainerRecipeEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContainerRecipeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateContainerRecipeEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateContainerRecipeInput>()
            .ok_or("failed to downcast to CreateContainerRecipeInput")?;
...
pub enum CreateContainerRecipeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateContainerRecipeError) for what information is available for the error.")]
...
impl CreateContainerRecipeError {
    ...
    /// Creates the `CreateContainerRecipeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidVersionNumberException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `CreateContainerRecipeError::DryRunOperationException`.
...
impl ::std::error::Error for CreateContainerRecipeError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidVersionNumberException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateContainerRecipeError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidVersionNumberException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateContainerRecipeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_container_recipe::CreateContainerRecipeError {
...
mod _create_container_recipe_output;
