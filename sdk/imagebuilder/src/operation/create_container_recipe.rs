...
impl CreateContainerRecipeInput {
    /// Consumes the builder and constructs an Operation<[`CreateContainerRecipe`](crate::operation::create_container_recipe::CreateContainerRecipe)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_container_recipe::CreateContainerRecipe, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_container_recipe::CreateContainerRecipeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_container_recipe::ser_create_container_recipe_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_container_recipe::CreateContainerRecipe::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateContainerRecipe {
                type Output = std::result::Result<crate::operation::create_container_recipe::CreateContainerRecipeOutput, crate::operation::create_container_recipe::CreateContainerRecipeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_container_recipe::de_create_container_recipe_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_container_recipe::de_create_container_recipe_http_response(response)
                     }
                }
            }
