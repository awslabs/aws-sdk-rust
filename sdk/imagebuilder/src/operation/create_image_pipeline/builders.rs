...
impl CreateImagePipelineFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_image_pipeline::CreateImagePipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_image_pipeline::CreateImagePipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_image_pipeline::CreateImagePipelineOutput, crate::operation::create_image_pipeline::CreateImagePipelineError, Self> {
