...
impl DeleteDistributionConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_distribution_configuration::DeleteDistributionConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_distribution_configuration::DeleteDistributionConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDistributionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_distribution_configuration::de_delete_distribution_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
