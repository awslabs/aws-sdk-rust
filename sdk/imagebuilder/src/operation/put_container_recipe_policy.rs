...
impl PutContainerRecipePolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutContainerRecipePolicy`](crate::operation::put_container_recipe_policy::PutContainerRecipePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_container_recipe_policy::PutContainerRecipePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_container_recipe_policy::PutContainerRecipePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_container_recipe_policy::ser_put_container_recipe_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_container_recipe_policy::PutContainerRecipePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutContainerRecipePolicy {
                type Output = std::result::Result<crate::operation::put_container_recipe_policy::PutContainerRecipePolicyOutput, crate::operation::put_container_recipe_policy::PutContainerRecipePolicyError>;
