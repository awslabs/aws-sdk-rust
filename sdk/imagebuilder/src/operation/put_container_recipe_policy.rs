...
impl PutContainerRecipePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_container_recipe_policy::PutContainerRecipePolicy,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_container_recipe_policy::PutContainerRecipePolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutContainerRecipePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_container_recipe_policy::de_put_container_recipe_policy_http_response_with_props(status, headers, body)
        }
    }
}
