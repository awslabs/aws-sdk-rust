...
impl GetImageInput {
    /// Consumes the builder and constructs an Operation<[`GetImage`](crate::operation::get_image::GetImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_image::GetImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_image::GetImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/GetImage").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_image::GetImageInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.image_build_version_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("image_build_version_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("image_build_version_arn", "cannot be empty or unset"));
                }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_image::GetImage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetImage", "imagebuilder"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetImage {
                type Output = std::result::Result<crate::operation::get_image::GetImageOutput, crate::operation::get_image::GetImageError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_image::de_get_image_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_image::de_get_image_http_response(response)
                     }
                }
            }
