...
impl CreateImageRecipeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_image_recipe::ser_create_image_recipe_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateImageRecipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_image_recipe::de_create_image_recipe_http_response_with_props(status, headers, body)
        }
    }
}
