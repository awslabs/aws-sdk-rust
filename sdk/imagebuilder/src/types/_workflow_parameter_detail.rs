...
impl WorkflowParameterDetailBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::WorkflowParameterDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::WorkflowParameterDetail {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building WorkflowParameterDetail")
                    )?
                ,
                r#type: self.r#type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "r#type was not specified but it is required when building WorkflowParameterDetail")
                    )?
                ,
