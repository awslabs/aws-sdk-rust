...
/// <p>Contains details about a vulnerability scan finding that Amazon Inspector generated for an image.</p>
#[non_exhaustive]
...
pub struct ImageScanFinding {
    ...
    /// <p>Details about whether a fix is available for any of the packages that are identified in the finding through a version update. Valid values include:</p>
    /// <ul>
    /// <li>
    /// <p><code>YES</code> – A fix is available for all of the packages identified in the finding.</p></li>
    /// <li>
    /// <p><code>NO</code> – No fix is available.</p></li>
    /// <li>
    /// <p><code>PARTIAL</code> – A fix is available for some, but not all, of the packages identified in the finding.</p></li>
    /// </ul>
