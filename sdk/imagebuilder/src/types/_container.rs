...
/// <p>Details of the container images that are output resources of an image build in a given Amazon Web Services Region: the Region, and the URIs of the container images.</p>
#[non_exhaustive]
