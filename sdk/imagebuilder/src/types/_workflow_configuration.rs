...
impl WorkflowConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::WorkflowConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::WorkflowConfiguration {
                workflow_arn: self.workflow_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workflow_arn", "workflow_arn was not specified but it is required when building WorkflowConfiguration")
                    )?
                ,
