...
/// <p>Defines how Image Builder distributes the output of an image build. You can configure:</p>
/// <ul>
/// <li>
/// <p>The Regions to distribute the image to.</p></li>
/// <li>
/// <p>The Region-specific settings to apply, such as output AMI names, launch permissions for other Amazon Web Services accounts, and target container repositories.</p></li>
/// </ul>
#[non_exhaustive]
