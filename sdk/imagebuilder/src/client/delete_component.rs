...
impl super::Client {
    ...
    ///   - [`component_build_version_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::component_build_version_arn) / [`set_component_build_version_arn(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_component_build_version_arn): <p>The Amazon Resource Name (ARN) of the component build version to delete.</p>
