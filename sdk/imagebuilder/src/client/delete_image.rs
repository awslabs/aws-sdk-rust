...
impl super::Client {
    ...
    ///   - [`image_build_version_arn(Option<String>)`](crate::operation::delete_image::DeleteImageOutput::image_build_version_arn): <p>The Amazon Resource Name (ARN) of the Image Builder image resource that this request deleted.</p>
