...
impl super::Client {
    ...
    ///   - [`distributions(Distribution)`](crate::operation::create_distribution_configuration::builders::CreateDistributionConfigurationFluentBuilder::distributions) / [`set_distributions(Option<Vec<Distribution>>)`](crate::operation::create_distribution_configuration::builders::CreateDistributionConfigurationFluentBuilder::set_distributions): <p>The distributions of the distribution configuration.</p>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_distribution_configuration::builders::CreateDistributionConfigurationFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_distribution_configuration::builders::CreateDistributionConfigurationFluentBuilder::set_tags): <p>The tags of the distribution configuration.</p>
