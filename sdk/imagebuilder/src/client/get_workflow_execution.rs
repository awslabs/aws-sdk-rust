...
impl super::Client {
    ...
    ///   - [`image_build_version_arn(Option<String>)`](crate::operation::get_workflow_execution::GetWorkflowExecutionOutput::image_build_version_arn): <p>The Amazon Resource Name (ARN) of the image build version that owns the specified runtime instance of the workflow.</p>
    ...
    ///   - [`status(Option<WorkflowExecutionStatus>)`](crate::operation::get_workflow_execution::GetWorkflowExecutionOutput::status): <p>The current runtime status for the specified runtime instance of the workflow. <code>COMPLETED</code>, <code>FAILED</code>, <code>ROLLBACK_COMPLETED</code>, <code>CANCELLED</code>, and <code>SKIPPED</code> are terminal states.</p>
    ...
    ///   - [`total_step_count(i32)`](crate::operation::get_workflow_execution::GetWorkflowExecutionOutput::total_step_count): <p>The total number of steps that the workflow document defines for this runtime instance of the workflow. Image Builder sets this count before any steps run. The sum of succeeded, skipped, and failed steps only reaches this total if every step finishes in one of those states.</p>
    ...
    ///   - [`parallel_group(Option<String>)`](crate::operation::get_workflow_execution::GetWorkflowExecutionOutput::parallel_group): <p>The name of the parallel group that this runtime instance of the workflow ran in, if configured. Parallel groups apply only to test workflows.</p>
