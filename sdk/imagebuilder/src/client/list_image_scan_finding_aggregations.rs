...
impl super::Client {
    ...
    ///   - [`filter(Filter)`](crate::operation::list_image_scan_finding_aggregations::builders::ListImageScanFindingAggregationsFluentBuilder::filter) / [`set_filter(Option<Filter>)`](crate::operation::list_image_scan_finding_aggregations::builders::ListImageScanFindingAggregationsFluentBuilder::set_filter): <p>A filter name and value pair that is used to return a more specific list of results from a list operation. Filters can be used to match a set of resources by specific criteria, such as tags, attributes, or IDs.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_image_scan_finding_aggregations::builders::ListImageScanFindingAggregationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_image_scan_finding_aggregations::builders::ListImageScanFindingAggregationsFluentBuilder::set_next_token): <p>A token to specify where to start paginating. This is the NextToken from a previously truncated response.</p>
