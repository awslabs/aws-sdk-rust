...
impl super::Client {
    ...
    ///   - [`image_pipeline_arn(impl Into<String>)`](crate::operation::get_image_pipeline::builders::GetImagePipelineFluentBuilder::image_pipeline_arn) / [`set_image_pipeline_arn(Option<String>)`](crate::operation::get_image_pipeline::builders::GetImagePipelineFluentBuilder::set_image_pipeline_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the image pipeline that you want to retrieve.</p><br>
