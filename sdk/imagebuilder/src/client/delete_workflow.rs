...
impl super::Client {
    ...
    ///   - [`workflow_build_version_arn(Option<String>)`](crate::operation::delete_workflow::DeleteWorkflowOutput::workflow_build_version_arn): <p>The Amazon Resource Name (ARN) of the workflow resource that this request deleted.</p>
