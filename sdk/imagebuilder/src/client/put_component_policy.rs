...
impl super::Client {
    ...
    ///   - [`policy(impl Into<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::policy) / [`set_policy(Option<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::set_policy):<br>required: **true**<br><p>The policy to apply.</p><br>
