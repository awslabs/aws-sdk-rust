...
impl super::Client {
    ...
    pub fn put_component_policy(
        &self,
    ) -> crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder {
        crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
