...
impl super::Client {
    ...
    ///   - [`workflow_build_version_arn(Option<String>)`](crate::operation::list_workflow_step_executions::ListWorkflowStepExecutionsOutput::workflow_build_version_arn): <p>The build version Amazon Resource Name (ARN) for the Image Builder workflow resource that defines the steps for this runtime instance of the workflow.</p>
    ...
    ///   - [`image_build_version_arn(Option<String>)`](crate::operation::list_workflow_step_executions::ListWorkflowStepExecutionsOutput::image_build_version_arn): <p>The image build version resource Amazon Resource Name (ARN) that's associated with the specified runtime instance of the workflow.</p>
