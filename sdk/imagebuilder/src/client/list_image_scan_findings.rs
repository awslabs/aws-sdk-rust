...
impl super::Client {
    ...
    ///   - [`filters(Vec<ImageScanFindingsFilter>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::filters) / [`set_filters(Option<Vec<ImageScanFindingsFilter>>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::set_filters): <p>An array of name value pairs that you can use to filter your results. You can use the following filters to streamline results:</p>  <ul>   <li> <p> <code>imageBuildVersionArn</code> </p> </li>   <li> <p> <code>imagePipelineArn</code> </p> </li>   <li> <p> <code>vulnerabilityId</code> </p> </li>   <li> <p> <code>severity</code> </p> </li>  </ul>  <p>If you don't request a filter, then all findings in your account are listed.</p>
    ///   - [`max_results(i32)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::set_max_results): <p>The maximum items to return in a request.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::set_next_token): <p>A token to specify where to start paginating. This is the NextToken from a previously truncated response.</p>
