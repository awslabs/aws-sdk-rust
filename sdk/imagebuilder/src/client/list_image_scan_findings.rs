...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return in a single request.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_image_scan_findings::builders::ListImageScanFindingsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token to specify where to start paginating. Use the <code>nextToken</code> value from a previously truncated response.</p><br>
