...
impl super::Client {
    ...
    ///   - [`owner(Ownership)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::owner) / [`set_owner(Option<Ownership>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::set_owner):<br>required: **false**<br><p>Returns container recipes belonging to the specified owner, that have been shared with you. You can omit this field to return container recipes belonging to your account. For container recipes, the valid owner values are <code>Self</code>, <code>Shared</code>, and <code>Amazon</code>.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return in a single request.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::set_next_token):<br>required: **false**<br><p>A token to specify where to start paginating. Use the <code>nextToken</code> value from a previously truncated response.</p><br>
