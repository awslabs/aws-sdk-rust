...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::set_filters): <p>Use the following filters to streamline results:</p>  <ul>   <li> <p> <code>containerType</code> </p> </li>   <li> <p> <code>name</code> </p> </li>   <li> <p> <code>parentImage</code> </p> </li>   <li> <p> <code>platform</code> </p> </li>  </ul>
