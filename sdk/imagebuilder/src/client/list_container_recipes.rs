...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_container_recipes::builders::ListContainerRecipesFluentBuilder::set_max_results):<br>required: **false**<br><p>Specify the maximum number of items to return in a request.</p><br>
