...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_waiting_workflow_steps::builders::ListWaitingWorkflowStepsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_waiting_workflow_steps::builders::ListWaitingWorkflowStepsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return in a single request.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_waiting_workflow_steps::builders::ListWaitingWorkflowStepsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_waiting_workflow_steps::builders::ListWaitingWorkflowStepsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token to specify where to start paginating. Use the <code>nextToken</code> value from a previously truncated response.</p><br>
    ...
    ///   - [`steps(Option<Vec::<WorkflowStepExecution>>)`](crate::operation::list_waiting_workflow_steps::ListWaitingWorkflowStepsOutput::steps): <p>An array of the workflow steps that are waiting for action in your Amazon Web Services account. Each step is paused at a <code>WaitForAction</code> step, and remains in the list until you respond with <code>SendWorkflowStepAction</code> or the wait times out.</p>
