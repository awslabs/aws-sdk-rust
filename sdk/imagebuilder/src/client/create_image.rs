...
impl super::Client {
    ...
    ///   - [`image_build_version_arn(Option<String>)`](crate::operation::create_image::CreateImageOutput::image_build_version_arn): <p> The Amazon Resource Name (ARN) of the image that was created by this request.</p>
