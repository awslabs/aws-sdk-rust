...
impl super::Client {
    ...
    ///   - [`image_recipe_arn(impl ::std::convert::Into<String>)`](crate::operation::put_image_recipe_policy::builders::PutImageRecipePolicyFluentBuilder::image_recipe_arn) / [`set_image_recipe_arn(Option<String>)`](crate::operation::put_image_recipe_policy::builders::PutImageRecipePolicyFluentBuilder::set_image_recipe_arn): <p>The Amazon Resource Name (ARN) of the image recipe that this policy should be applied to.</p>
    ///   - [`policy(impl ::std::convert::Into<String>)`](crate::operation::put_image_recipe_policy::builders::PutImageRecipePolicyFluentBuilder::policy) / [`set_policy(Option<String>)`](crate::operation::put_image_recipe_policy::builders::PutImageRecipePolicyFluentBuilder::set_policy): <p>The policy to apply.</p>
