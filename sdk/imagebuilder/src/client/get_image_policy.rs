...
impl super::Client {
    ...
    pub fn get_image_policy(
        &self,
    ) -> crate::operation::get_image_policy::builders::GetImagePolicyFluentBuilder {
        crate::operation::get_image_policy::builders::GetImagePolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
