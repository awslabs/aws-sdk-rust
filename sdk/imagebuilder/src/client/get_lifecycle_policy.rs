...
impl super::Client {
    ...
    ///   - [`lifecycle_policy(Option<LifecyclePolicy>)`](crate::operation::get_lifecycle_policy::GetLifecyclePolicyOutput::lifecycle_policy): <p>The details of the lifecycle policy that the request retrieved.</p>
