...
impl SendHeartbeatInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_heartbeat::SendHeartbeat, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_heartbeat::ser_send_heartbeat_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendHeartbeat {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_heartbeat::de_send_heartbeat_http_response_with_props(status, headers, body)
        }
    }
}
