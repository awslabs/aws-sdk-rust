...
impl SendHeartbeatInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_heartbeat::SendHeartbeat::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendHeartbeat {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_send_heartbeat::de_send_heartbeat_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_send_heartbeat::de_send_heartbeat_http_response_with_props(
                status, headers, body,
            )
        }
    }
