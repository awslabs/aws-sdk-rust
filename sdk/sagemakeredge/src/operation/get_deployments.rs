...
impl GetDeploymentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_deployments::GetDeployments, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_deployments::ser_get_deployments_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeployments {
    type Output =
        ::std::result::Result<crate::operation::get_deployments::GetDeploymentsOutput, crate::operation::get_deployments::GetDeploymentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_deployments::de_get_deployments_http_response_with_props(status, headers, body)
        }
    }
}
