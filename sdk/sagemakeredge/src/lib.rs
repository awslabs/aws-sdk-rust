...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("sagemakeredge", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Sagemaker Edge Manager.
pub mod client;
