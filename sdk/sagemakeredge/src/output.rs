...
pub struct GetDeviceRegistrationOutput  {
    ...
    #[doc(hidden)]pub device_registration: std::option::Option<std::string::String>,
    /// <p>The amount of time, in seconds, that the registration status is stored on the device’s cache before it is refreshed.</p>
    #[doc(hidden)]pub cache_ttl: std::option::Option<std::string::String>,
}
...
pub struct GetDeploymentsOutput  {
    ...
    #[doc(hidden)]pub deployments: std::option::Option<std::vec::Vec<crate::model::EdgeDeployment>>,
}
