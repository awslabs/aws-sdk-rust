...
impl super::Client {
    ...
    ///   - [`device_name(impl ::std::convert::Into<String>)`](crate::operation::get_device_registration::builders::GetDeviceRegistrationFluentBuilder::device_name) / [`set_device_name(Option<String>)`](crate::operation::get_device_registration::builders::GetDeviceRegistrationFluentBuilder::set_device_name): <p>The unique name of the device you want to get the registration status from.</p>
    ///   - [`device_fleet_name(impl ::std::convert::Into<String>)`](crate::operation::get_device_registration::builders::GetDeviceRegistrationFluentBuilder::device_fleet_name) / [`set_device_fleet_name(Option<String>)`](crate::operation::get_device_registration::builders::GetDeviceRegistrationFluentBuilder::set_device_fleet_name): <p>The name of the fleet that the device belongs to.</p>
