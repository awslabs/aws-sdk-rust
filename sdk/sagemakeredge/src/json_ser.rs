...
pub fn serialize_structure_get_device_registration_input(
...
pub fn serialize_structure_send_heartbeat_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_5 in var_3 {
            {
                ...
                crate::json_ser::serialize_structure_edge_metric(&mut object_6, item_5);
                object_6.finish();
            }
        }
        array_4.finish();
        ...
        for item_12 in var_10 {
            {
                ...
                crate::json_ser::serialize_structure_model(&mut object_13, item_12);
                object_13.finish();
            }
        }
        array_11.finish();
...
pub fn serialize_structure_edge_metric(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_model(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_edge_metric(&mut object_24, item_23);
                object_24.finish();
            }
        }
        array_22.finish();
