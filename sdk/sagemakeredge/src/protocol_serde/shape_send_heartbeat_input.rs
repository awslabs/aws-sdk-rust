...
pub fn ser_send_heartbeat_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendHeartbeatInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
