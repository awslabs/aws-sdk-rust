...
pub fn ser_deployment_result(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeploymentResult) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
