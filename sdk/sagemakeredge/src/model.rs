...
pub struct DeploymentResult  {
    ...
    #[doc(hidden)]pub deployment_end_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns a list of models deployed on the agent.</p>
    #[doc(hidden)]pub deployment_models: std::option::Option<std::vec::Vec<crate::model::DeploymentModel>>,
}
...
pub struct DeploymentModel  {
    ...
    #[doc(hidden)]pub model_handle: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub desired_state: std::option::Option<crate::model::ModelState>,
    /// <p>Returns the current state of the model.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ModelState>,
    ...
    #[doc(hidden)]pub rollback_failure_reason: std::option::Option<std::string::String>,
}
...
pub struct Model  {
    ...
    #[doc(hidden)]pub latest_sample_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The timestamp of the last inference that was made.</p>
    #[doc(hidden)]pub latest_inference: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Information required for model metrics.</p>
    #[doc(hidden)]pub model_metrics: std::option::Option<std::vec::Vec<crate::model::EdgeMetric>>,
}
impl Model {
    /// <p>The name of the model.</p>
    pub fn model_name(&self) -> std::option::Option<& str> {
...
pub struct EdgeDeployment  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DeploymentType>,
    /// <p>Determines whether to rollback to previous configuration if deployment fails.</p>
    #[doc(hidden)]pub failure_handling_policy: std::option::Option<crate::model::FailureHandlingPolicy>,
    /// <p>Returns a list of Definition objects.</p>
    #[doc(hidden)]pub definitions: std::option::Option<std::vec::Vec<crate::model::Definition>>,
}
impl EdgeDeployment {
    /// <p>The name and unique ID of the deployment.</p>
    pub fn deployment_name(&self) -> std::option::Option<& str> {
...
pub struct Checksum  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ChecksumType>,
    /// <p>The checksum of the model.</p>
    #[doc(hidden)]pub sum: std::option::Option<std::string::String>,
}
impl Checksum {
    /// <p>The type of the checksum.</p>
...
impl std::convert::From<&str> for ChecksumType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChecksumType::Unknown(other.to_owned())
        }
    }
}
...
impl ChecksumType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ChecksumType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
