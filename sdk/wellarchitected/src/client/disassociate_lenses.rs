...
impl super::Client {
    ...
    ///   - [`lens_aliases(impl Into<String>)`](crate::operation::disassociate_lenses::builders::DisassociateLensesFluentBuilder::lens_aliases) / [`set_lens_aliases(Option<Vec<String>>)`](crate::operation::disassociate_lenses::builders::DisassociateLensesFluentBuilder::set_lens_aliases): <p>List of lens aliases to associate or disassociate with a workload. Up to 10 lenses can be specified.</p>  <p>Identify a lens using its <code>LensSummary$LensAlias</code>.</p>
