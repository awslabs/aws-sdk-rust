...
impl super::Client {
    ...
    ///   - [`template_arn(impl Into<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::template_arn) / [`set_template_arn(Option<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::set_template_arn): <p>The review template ARN.</p>
    ///   - [`shared_with(impl Into<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::shared_with) / [`set_shared_with(Option<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::set_shared_with): <p>The Amazon Web Services account ID, organization ID, or organizational unit (OU) ID with which the workload, lens, profile, or review template is shared.</p>
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_template_share::builders::CreateTemplateShareFluentBuilder::set_client_request_token): <p>A unique case-sensitive string used to ensure that this request is idempotent (executes only once).</p>  <p>You should not reuse the same token for other requests. If you retry a request with the same client request token and the same parameters after the original request has completed successfully, the result of the original request is returned.</p> <important>   <p>This token is listed as required, however, if you do not specify it, the Amazon Web Services SDKs automatically generate one for you. If you are not using the Amazon Web Services SDK or the CLI, you must provide this token or the request will fail.</p>  </important>
