...
impl super::Client {
    ...
    ///   - [`lens_alias(impl ::std::convert::Into<String>)`](crate::operation::export_lens::builders::ExportLensFluentBuilder::lens_alias) / [`set_lens_alias(Option<String>)`](crate::operation::export_lens::builders::ExportLensFluentBuilder::set_lens_alias): <p>The alias of the lens.</p>  <p>For Amazon Web Services official lenses, this is either the lens alias, such as <code>serverless</code>, or the lens ARN, such as <code>arn:aws:wellarchitected:us-east-1::lens/serverless</code>. Note that some operations (such as ExportLens and CreateLensShare) are not permitted on Amazon Web Services official lenses.</p>  <p>For custom lenses, this is the lens ARN, such as <code>arn:aws:wellarchitected:us-west-2:123456789012:lens/0123456789abcdef01234567890abcdef</code>. </p>  <p>Each lens is identified by its <code>LensSummary$LensAlias</code>.</p>
    ///   - [`lens_version(impl ::std::convert::Into<String>)`](crate::operation::export_lens::builders::ExportLensFluentBuilder::lens_version) / [`set_lens_version(Option<String>)`](crate::operation::export_lens::builders::ExportLensFluentBuilder::set_lens_version): <p>The lens version to be exported.</p>
