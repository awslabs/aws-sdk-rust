...
impl super::Client {
    ...
    ///   - [`workload_id(impl ::std::convert::Into<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::workload_id) / [`set_workload_id(Option<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::set_workload_id): <p>The ID assigned to the workload. This ID is unique within an Amazon Web Services Region.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::set_next_token): <p>The token to use to retrieve the next set of results.</p>
