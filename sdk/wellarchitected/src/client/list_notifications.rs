...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::set_max_results): <p>The maximum number of results to return for this request.</p>
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_notifications::builders::ListNotificationsFluentBuilder::set_resource_arn): <p>The ARN for the related resource for the notification.</p> <note>   <p>Only one of <code>WorkloadID</code> or <code>ResourceARN</code> should be specified.</p>  </note>
