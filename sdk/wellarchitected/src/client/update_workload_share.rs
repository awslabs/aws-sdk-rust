...
impl super::Client {
    ...
    ///   - [`share_id(impl ::std::convert::Into<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::set_share_id): <p>The ID associated with the workload share.</p>
    ///   - [`workload_id(impl ::std::convert::Into<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::workload_id) / [`set_workload_id(Option<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::set_workload_id): <p>The ID assigned to the workload. This ID is unique within an Amazon Web Services Region.</p>
