...
impl super::Client {
    ...
    ///   - [`share_id(impl Into<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::update_workload_share::builders::UpdateWorkloadShareFluentBuilder::set_share_id): <p>The ID associated with the share.</p>
