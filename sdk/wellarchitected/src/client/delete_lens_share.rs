...
impl super::Client {
    ...
    ///   - [`share_id(impl ::std::convert::Into<String>)`](crate::operation::delete_lens_share::builders::DeleteLensShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::delete_lens_share::builders::DeleteLensShareFluentBuilder::set_share_id): <p>The ID associated with the share.</p>
