...
impl super::Client {
    ...
    pub fn delete_lens_share(
        &self,
    ) -> crate::operation::delete_lens_share::builders::DeleteLensShareFluentBuilder {
        crate::operation::delete_lens_share::builders::DeleteLensShareFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
