...
impl super::Client {
    ...
    ///   - [`shared_with_prefix(impl Into<String>)`](crate::operation::list_lens_shares::builders::ListLensSharesFluentBuilder::shared_with_prefix) / [`set_shared_with_prefix(Option<String>)`](crate::operation::list_lens_shares::builders::ListLensSharesFluentBuilder::set_shared_with_prefix): <p>The Amazon Web Services account ID, organization ID, or organizational unit (OU) ID with which the lens is shared.</p>
