...
impl super::Client {
    ...
    ///   - [`template_arn(impl Into<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::template_arn) / [`set_template_arn(Option<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::set_template_arn): <p>The review template ARN.</p>
    ///   - [`shared_with_prefix(impl Into<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::shared_with_prefix) / [`set_shared_with_prefix(Option<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::set_shared_with_prefix): <p>The Amazon Web Services account ID, organization ID, or organizational unit (OU) ID with which the profile is shared.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::set_next_token): <p>The token to use to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::set_max_results): <p>The maximum number of results to return for this request.</p>
    ///   - [`status(ShareStatus)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::status) / [`set_status(Option<ShareStatus>)`](crate::operation::list_template_shares::builders::ListTemplateSharesFluentBuilder::set_status): <p>The status of the share request.</p>
