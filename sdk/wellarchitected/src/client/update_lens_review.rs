...
impl super::Client {
    ...
    ///   - [`lens_notes(impl Into<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::lens_notes) / [`set_lens_notes(Option<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::set_lens_notes): <p>The notes associated with the workload.</p>  <p>For a review template, these are the notes that will be associated with the workload when the template is applied.</p>
