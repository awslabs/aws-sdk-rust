...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_workload_shares::builders::ListWorkloadSharesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_workload_shares::builders::ListWorkloadSharesFluentBuilder::set_max_results): <p>The maximum number of results to return for this request.</p>
    ///   - [`status(ShareStatus)`](crate::operation::list_workload_shares::builders::ListWorkloadSharesFluentBuilder::status) / [`set_status(Option<ShareStatus>)`](crate::operation::list_workload_shares::builders::ListWorkloadSharesFluentBuilder::set_status): <p>The status of the share request.</p>
