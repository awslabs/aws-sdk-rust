...
impl super::Client {
    ...
    ///   - [`lens_arn(impl Into<String>)`](crate::operation::list_check_details::builders::ListCheckDetailsFluentBuilder::lens_arn) / [`set_lens_arn(Option<String>)`](crate::operation::list_check_details::builders::ListCheckDetailsFluentBuilder::set_lens_arn):<br>required: **true**<br><p>Well-Architected Lens ARN.</p><br>
