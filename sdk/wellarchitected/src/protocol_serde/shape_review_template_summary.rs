...
pub(crate) fn de_review_template_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ReviewTemplateSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
