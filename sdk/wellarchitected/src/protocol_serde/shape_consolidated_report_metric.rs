...
) -> Result<Option<crate::types::ConsolidatedReportMetric>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Lenses" => {
                            builder = builder.set_lenses(crate::protocol_serde::shape_lens_metrics::de_lens_metrics(tokens)?);
                        }
                        "LensesAppliedCount" => {
