...
pub fn ser_choice_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChoiceUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
