...
pub fn ser_update_workload_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkloadInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
