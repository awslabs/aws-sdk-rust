...
) -> ::std::result::Result<Option<crate::types::AnswerSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "QuestionType" => {
                            builder = builder.set_question_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::QuestionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "JiraConfiguration" => {
