...
pub fn ser_create_workload_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkloadInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
