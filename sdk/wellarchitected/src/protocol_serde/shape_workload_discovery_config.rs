...
pub(crate) fn de_workload_discovery_config<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::WorkloadDiscoveryConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "WorkloadResourceDefinition" => {
                            builder = builder.set_workload_resource_definition(
                                crate::protocol_serde::shape_workload_resource_definition::de_workload_resource_definition(tokens, _value)?,
                            );
                        }
