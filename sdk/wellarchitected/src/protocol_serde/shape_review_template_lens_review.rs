...
pub(crate) fn de_review_template_lens_review<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ReviewTemplateLensReview>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PillarReviewSummaries" => {
                            builder = builder.set_pillar_review_summaries(
                                crate::protocol_serde::shape_review_template_pillar_review_summaries::de_review_template_pillar_review_summaries(
                                    tokens, _value,
                                )?,
                            );
                        }
