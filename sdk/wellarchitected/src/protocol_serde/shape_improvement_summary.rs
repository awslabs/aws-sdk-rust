...
pub(crate) fn de_improvement_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ImprovementSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ImprovementPlans" => {
                            builder = builder.set_improvement_plans(
                                crate::protocol_serde::shape_choice_improvement_plans::de_choice_improvement_plans(tokens, _value, depth + 1)?,
                            );
                        }
                        "JiraConfiguration" => {
