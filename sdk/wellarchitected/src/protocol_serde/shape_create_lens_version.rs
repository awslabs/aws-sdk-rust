...
pub fn de_create_lens_version_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_lens_version::CreateLensVersionOutput, crate::operation::create_lens_version::CreateLensVersionError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::create_lens_version::CreateLensVersionOutput, crate::operation::create_lens_version::CreateLensVersionError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_create_lens_version::de_create_lens_version(_response_body, output)
            .map_err(crate::operation::create_lens_version::CreateLensVersionError::unhandled)?;
...
) -> Result<crate::operation::create_lens_version::builders::CreateLensVersionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
