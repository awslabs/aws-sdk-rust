...
pub(crate) fn de_workload_share_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkloadShareSummary>, aws_smithy_json::deserialize::error::DeserializeError>
