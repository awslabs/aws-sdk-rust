...
pub fn de_upgrade_lens_review_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::upgrade_lens_review::UpgradeLensReviewOutput, crate::operation::upgrade_lens_review::UpgradeLensReviewError>
{
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => crate::operation::upgrade_lens_review::UpgradeLensReviewError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
