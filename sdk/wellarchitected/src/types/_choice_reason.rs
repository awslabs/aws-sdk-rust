...
impl ::std::convert::From<&str> for ChoiceReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChoiceReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChoiceReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChoiceReason::from(s))
    }
}
impl ChoiceReason {
...
impl ::std::convert::AsRef<str> for ChoiceReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
