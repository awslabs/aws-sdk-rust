...
impl ::std::convert::From<&str> for WorkloadEnvironment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkloadEnvironment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkloadEnvironment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkloadEnvironment::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkloadEnvironment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
