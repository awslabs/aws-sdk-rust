...
///     ApplicationType::DesktopApplication => { /* ... */ },
...
impl ::std::convert::From<&str> for ApplicationType {
    fn from(s: &str) -> Self {
        match s {
            "DESKTOP_APPLICATION" => ApplicationType::DesktopApplication,
            "OTHER" => ApplicationType::Other,
            "SAS" => ApplicationType::Sas,
...
impl ApplicationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ApplicationType::DesktopApplication => "DESKTOP_APPLICATION",
            ApplicationType::Other => "OTHER",
            ApplicationType::Sas => "SAS",
            ApplicationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DESKTOP_APPLICATION", "OTHER", "SAS"]
    }
}
...
impl ::std::fmt::Display for ApplicationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ApplicationType::DesktopApplication => write!(f, "DESKTOP_APPLICATION"),
            ApplicationType::Other => write!(f, "OTHER"),
            ApplicationType::Sas => write!(f, "SAS"),
