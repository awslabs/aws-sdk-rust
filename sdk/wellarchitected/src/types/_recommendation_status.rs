...
impl ::std::convert::From<&str> for RecommendationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SUPPRESSED" => RecommendationStatus::Suppressed,
...
impl RecommendationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RecommendationStatus::Suppressed => "SUPPRESSED",
...
impl ::std::fmt::Display for RecommendationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RecommendationStatus::Active => write!(f, "ACTIVE"),
            RecommendationStatus::Completed => write!(f, "COMPLETED"),
            RecommendationStatus::Suppressed => write!(f, "SUPPRESSED"),
