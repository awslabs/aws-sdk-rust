...
impl ::std::convert::From<&str> for RecommendationType {
    fn from(s: &str) -> Self {
        match s {
            "APPLICATION" => RecommendationType::Application,
...
impl RecommendationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RecommendationType::Application => "APPLICATION",
            RecommendationType::Architecture => "ARCHITECTURE",
            RecommendationType::Resource => "RESOURCE",
            RecommendationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["APPLICATION", "ARCHITECTURE", "RESOURCE"]
    }
}
...
impl ::std::fmt::Display for RecommendationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RecommendationType::Application => write!(f, "APPLICATION"),
            RecommendationType::Architecture => write!(f, "ARCHITECTURE"),
            RecommendationType::Resource => write!(f, "RESOURCE"),
