...
impl ::std::convert::From<&str> for Criticality {
    fn from(s: &str) -> Self {
        match s {
            "BUSINESS_CRITICAL" => Criticality::BusinessCritical,
            "MISSION_CRITICAL" => Criticality::MissionCritical,
            "NON_CRITICAL" => Criticality::NonCritical,
            "TEST_DEVELOPMENT" => Criticality::TestDevelopment,
...
impl Criticality {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Criticality::BusinessCritical => "BUSINESS_CRITICAL",
            Criticality::MissionCritical => "MISSION_CRITICAL",
            Criticality::NonCritical => "NON_CRITICAL",
            Criticality::TestDevelopment => "TEST_DEVELOPMENT",
...
impl ::std::fmt::Display for Criticality {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Criticality::BusinessCritical => write!(f, "BUSINESS_CRITICAL"),
            Criticality::MissionCritical => write!(f, "MISSION_CRITICAL"),
            Criticality::NonCritical => write!(f, "NON_CRITICAL"),
            Criticality::TestDevelopment => write!(f, "TEST_DEVELOPMENT"),
