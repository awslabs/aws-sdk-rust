...
impl ::std::convert::From<&str> for Risk {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Risk::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Risk {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Risk::from(s))
    }
}
impl Risk {
...
impl ::std::convert::AsRef<str> for Risk {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
