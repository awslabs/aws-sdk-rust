...
impl Builder {
    ...
    /// use aws_sdk_wellarchitected::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_wellarchitected::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
