...
impl UpdateWorkloadInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workload::UpdateWorkload::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateWorkload {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_workload::de_update_workload_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_workload::de_update_workload_http_response(
                status, headers, body,
            )
        }
    }
