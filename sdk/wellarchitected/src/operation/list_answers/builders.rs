...
impl ListAnswersInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::list_answers::ListAnswersError, ::aws_smithy_http::operation::Response>,
    > {
...
impl ListAnswersFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<crate::operation::list_answers::ListAnswers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_answers::paginator::ListAnswersPaginator::send) which returns a `Stream`.
