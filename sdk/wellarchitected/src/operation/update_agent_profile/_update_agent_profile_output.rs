...
pub struct UpdateAgentProfileOutput {
...
impl ::std::fmt::Debug for UpdateAgentProfileOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateAgentProfileOutput");
...
impl ::aws_types::request_id::RequestId for UpdateAgentProfileOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateAgentProfileOutput {
    /// Creates a new builder-style object to manufacture [`UpdateAgentProfileOutput`](crate::operation::update_agent_profile::UpdateAgentProfileOutput).
    pub fn builder() -> crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder {
        crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::default()
    }
}

/// A builder for [`UpdateAgentProfileOutput`](crate::operation::update_agent_profile::UpdateAgentProfileOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct UpdateAgentProfileOutputBuilder {
...
impl UpdateAgentProfileOutputBuilder {
    /// <p>The system name of the updated profile.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateAgentProfileOutput`](crate::operation::update_agent_profile::UpdateAgentProfileOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::name)
    /// - [`pillars`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::pillars)
    /// - [`execution_role_arn`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::execution_role_arn)
    /// - [`aggregation_configuration`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::aggregation_configuration)
    /// - [`arn`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::arn)
    /// - [`created_by`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::created_by)
    /// - [`created_at`](crate::operation::update_agent_profile::builders::UpdateAgentProfileOutputBuilder::created_at)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_agent_profile::UpdateAgentProfileOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::update_agent_profile::UpdateAgentProfileOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            ...
            pillars: self.pillars.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "pillars",
                    "pillars was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            ...
            execution_role_arn: self.execution_role_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "execution_role_arn",
                    "execution_role_arn was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            aggregation_configuration: self.aggregation_configuration.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "aggregation_configuration",
                    "aggregation_configuration was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            ...
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building UpdateAgentProfileOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdateAgentProfileOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateAgentProfileOutputBuilder");
        formatter.field("name", &self.name);
        formatter.field("display_name", &"*** Sensitive Data Redacted ***");
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("business_overview", &"*** Sensitive Data Redacted ***");
