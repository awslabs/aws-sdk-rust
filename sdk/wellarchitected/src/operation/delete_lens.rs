...
impl DeleteLensInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_lens::DeleteLens::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLens {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_lens::de_delete_lens_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_lens::de_delete_lens_http_response_with_props(
                status, headers, body,
            )
        }
    }
