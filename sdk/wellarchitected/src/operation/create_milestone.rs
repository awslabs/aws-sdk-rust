...
impl CreateMilestoneInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_milestone::CreateMilestone, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_milestone::ser_create_milestone_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMilestone {
    type Output =
        ::std::result::Result<crate::operation::create_milestone::CreateMilestoneOutput, crate::operation::create_milestone::CreateMilestoneError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_milestone::de_create_milestone_http_response_with_props(status, headers, body)
        }
    }
}
