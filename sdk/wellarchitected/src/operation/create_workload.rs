...
impl CreateWorkloadInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_workload::CreateWorkload, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_workload::ser_create_workload_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkload {
    type Output =
        ::std::result::Result<crate::operation::create_workload::CreateWorkloadOutput, crate::operation::create_workload::CreateWorkloadError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_workload::de_create_workload_http_response_with_props(status, headers, body)
        }
    }
}
