...
impl GetConsolidatedReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_consolidated_report::GetConsolidatedReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_consolidated_report::GetConsolidatedReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_consolidated_report::GetConsolidatedReportOutput, crate::operation::get_consolidated_report::GetConsolidatedReportError, Self> {
