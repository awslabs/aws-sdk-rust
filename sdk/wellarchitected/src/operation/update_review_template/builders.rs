...
impl UpdateReviewTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_review_template::UpdateReviewTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_review_template::UpdateReviewTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_review_template::UpdateReviewTemplateOutput, crate::operation::update_review_template::UpdateReviewTemplateError, Self> {
