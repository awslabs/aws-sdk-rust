...
impl ListAnswersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_answers::ListAnswers::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListAnswers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_answers::de_list_answers_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_answers::de_list_answers_http_response_with_props(
                status, headers, body,
            )
        }
    }
