...
impl UpdateWorkloadShareInput {
    /// Consumes the builder and constructs an Operation<[`UpdateWorkloadShare`](crate::operation::update_workload_share::UpdateWorkloadShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_workload_share::UpdateWorkloadShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_workload_share::UpdateWorkloadShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_workload_share::ser_update_workload_share_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_workload_share::UpdateWorkloadShare::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateWorkloadShare {
                type Output = std::result::Result<crate::operation::update_workload_share::UpdateWorkloadShareOutput, crate::operation::update_workload_share::UpdateWorkloadShareError>;
