...
impl CreateReviewTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_review_template::CreateReviewTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_review_template::CreateReviewTemplateInput {
