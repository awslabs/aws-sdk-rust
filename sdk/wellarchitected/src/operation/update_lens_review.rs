...
impl UpdateLensReviewInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_lens_review::ser_update_lens_review_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLensReview {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_lens_review::de_update_lens_review_http_response_with_props(status, headers, body)
        }
    }
}
