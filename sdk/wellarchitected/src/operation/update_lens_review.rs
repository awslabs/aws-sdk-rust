...
impl UpdateLensReviewInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLensReview`](crate::operation::update_lens_review::UpdateLensReview)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_lens_review::UpdateLensReview, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_lens_review::UpdateLensReviewInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_lens_review::ser_update_lens_review_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_lens_review::UpdateLensReview::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLensReview {
                type Output = std::result::Result<crate::operation::update_lens_review::UpdateLensReviewOutput, crate::operation::update_lens_review::UpdateLensReviewError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_lens_review::de_update_lens_review_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_lens_review::de_update_lens_review_http_response(response)
                     }
                }
            }
