    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/lenses/{LensAlias}/shares", LensAlias = lens_alias)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_lens_shares::ListLensShares::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLensShares {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_lens_shares::de_list_lens_shares_http_error(
                status, headers, body,
            )
        } else {
