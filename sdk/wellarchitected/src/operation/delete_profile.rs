    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/profiles/{ProfileArn}", ProfileArn = profile_arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_profile::DeleteProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_profile::de_delete_profile_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_profile::de_delete_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
