...
impl ImportLensInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::import_lens::ImportLens,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_lens::ImportLens::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportLens {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_lens::de_import_lens_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_import_lens::de_import_lens_http_response_with_props(
                status, headers, body,
            )
        }
    }
