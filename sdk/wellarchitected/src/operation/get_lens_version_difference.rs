...
/// Orchestration and serialization glue logic for `GetLensVersionDifference`.
...
impl GetLensVersionDifference {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_lens_version_difference::GetLensVersionDifferenceInput,
                    ) -> ::std::result::Result<crate::operation::get_lens_version_difference::GetLensVersionDifferenceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLensVersionDifference {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLensVersionDifference");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLensVersionDifferenceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLensVersionDifferenceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLensVersionDifference")
...
.with_interceptor(GetLensVersionDifferenceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_lens_version_difference::de_get_lens_version_difference_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_lens_version_difference::de_get_lens_version_difference_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLensVersionDifferenceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_lens_version_difference::GetLensVersionDifferenceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_lens_version_difference::GetLensVersionDifferenceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/lenses/{LensAlias}/versionDifference", LensAlias = lens_alias).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_lens_version_difference::GetLensVersionDifferenceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLensVersionDifferenceEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLensVersionDifferenceInput>()
                        .ok_or("failed to downcast to GetLensVersionDifferenceInput")?;
...
pub enum GetLensVersionDifferenceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLensVersionDifferenceError) for what information is available for the error.")]
...
impl GetLensVersionDifferenceError {
    /// Creates the `GetLensVersionDifferenceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLensVersionDifferenceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLensVersionDifferenceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_lens_version_difference::GetLensVersionDifferenceError {
...
mod _get_lens_version_difference_output;
