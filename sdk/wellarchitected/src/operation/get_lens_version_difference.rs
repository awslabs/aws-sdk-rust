...
impl GetLensVersionDifferenceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_lens_version_difference::GetLensVersionDifference::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLensVersionDifference {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lens_version_difference::de_get_lens_version_difference_http_response_with_props(status, headers, body)
        }
    }
}
