    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/workloads/{WorkloadId}", WorkloadId = workload_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_workload::DeleteWorkload::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWorkload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_workload::de_delete_workload_http_error(
                status, headers, body,
            )
        } else {
