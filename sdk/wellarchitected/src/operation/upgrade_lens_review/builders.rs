...
impl UpgradeLensReviewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::upgrade_lens_review::UpgradeLensReviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upgrade_lens_review::UpgradeLensReviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::upgrade_lens_review::UpgradeLensReviewOutput, crate::operation::upgrade_lens_review::UpgradeLensReviewError, Self> {
