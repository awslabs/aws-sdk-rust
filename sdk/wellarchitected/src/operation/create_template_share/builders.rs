...
impl CreateTemplateShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_template_share::CreateTemplateShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_template_share::CreateTemplateShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_template_share::CreateTemplateShareOutput, crate::operation::create_template_share::CreateTemplateShareError, Self> {
