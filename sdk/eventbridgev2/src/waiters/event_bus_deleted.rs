...
///
/// Fluent builder for the `event_bus_deleted` waiter.
///
...
pub struct EventBusDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_event_bus::builders::DescribeEventBusInputBuilder,
}
impl EventBusDeletedFluentBuilder {
    /// Creates a new `EventBusDeletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::event_bus_deleted::EventBusDeletedFinalPoll,
        crate::waiters::event_bus_deleted::WaitUntilEventBusDeletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_event_bus_1cce2c05524fb92d4(result) {
...
/// Successful return type for the `event_bus_deleted` waiter.
pub type EventBusDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_event_bus::DescribeEventBusOutput,
...
/// Error type for the `event_bus_deleted` waiter.
pub type WaitUntilEventBusDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_event_bus::DescribeEventBusOutput,
    crate::operation::describe_event_bus::DescribeEventBusError,
>;
