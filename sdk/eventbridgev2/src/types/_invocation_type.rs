...
///
/// How a compute target is invoked: EVENT invokes asynchronously and returns once the target has
/// accepted the request; REQUEST_RESPONSE waits for the target to finish and surfaces its result.
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for InvocationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "REQUEST_RESPONSE" => InvocationType::RequestResponse,
...
impl InvocationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            InvocationType::RequestResponse => "REQUEST_RESPONSE",
...
impl ::std::fmt::Display for InvocationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            InvocationType::RequestResponse => write!(f, "REQUEST_RESPONSE"),
