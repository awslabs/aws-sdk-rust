...
impl ::std::convert::From<&str> for StartingPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            "POINT_IN_TIME" => StartingPosition::PointInTime,
...
impl StartingPosition {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            StartingPosition::PointInTime => "POINT_IN_TIME",
            StartingPosition::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["LATEST", "POINT_IN_TIME"]
    }
}
...
impl ::std::fmt::Display for StartingPosition {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            StartingPosition::PointInTime => write!(f, "POINT_IN_TIME"),
