...
pub(crate) fn de_invalid_state_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidStateExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidStateExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
