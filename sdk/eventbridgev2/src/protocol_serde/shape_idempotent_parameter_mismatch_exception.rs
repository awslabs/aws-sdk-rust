...
pub(crate) fn de_idempotent_parameter_mismatch_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::IdempotentParameterMismatchExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::IdempotentParameterMismatchExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
