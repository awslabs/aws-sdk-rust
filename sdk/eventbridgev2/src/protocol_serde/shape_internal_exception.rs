...
pub(crate) fn de_internal_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InternalExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InternalExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
