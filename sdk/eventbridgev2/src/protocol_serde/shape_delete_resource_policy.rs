...
> {
    ...
    Err(match error_code {
        ...
        "InternalException" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::InternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_resource_policy_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_delete_resource_policy_input::ser_delete_resource_policy_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "RevisionId" => {
                ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| Ok(builder.set_revision_id(Some(decoder.string()?))))?
            }
            _ => {
                decoder.skip()?;
                builder
