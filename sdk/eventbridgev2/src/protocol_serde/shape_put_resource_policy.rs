    ...
    Err(match error_code {
        ...
        "PolicyLengthExceededException" => crate::operation::put_resource_policy::PutResourcePolicyError::PolicyLengthExceededException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_policy_length_exceeded_exception::de_policy_length_exceeded_exception_cbor_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
        ...
        "PublicPolicyException" => crate::operation::put_resource_policy::PutResourcePolicyError::PublicPolicyException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_public_policy_exception::de_public_policy_exception_cbor_err(_response_body, output)
                    .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
pub fn ser_put_resource_policy_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_put_resource_policy_input::ser_put_resource_policy_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::put_resource_policy::builders::PutResourcePolicyOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
{
