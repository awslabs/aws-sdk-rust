...
pub(crate) fn de_invalid_input_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidInputExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidInputExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
