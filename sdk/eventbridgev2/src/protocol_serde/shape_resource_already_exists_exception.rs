...
pub(crate) fn de_resource_already_exists_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ResourceAlreadyExistsExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ResourceAlreadyExistsExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
