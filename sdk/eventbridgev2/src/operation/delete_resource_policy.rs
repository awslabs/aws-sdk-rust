...
impl DeleteResourcePolicy {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "EventBridgeV2.DeleteResourcePolicy",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/AWSEventsV2/operation/DeleteResourcePolicy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::InternalException`.
