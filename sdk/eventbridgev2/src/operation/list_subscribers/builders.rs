...
pub use crate::operation::list_subscribers::_list_subscribers_output::ListSubscribersOutputBuilder;

impl crate::operation::list_subscribers::builders::ListSubscribersInputBuilder {
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_subscribers::ListSubscribersOutput,
        crate::operation::list_subscribers::ListSubscribersError,
    > for ListSubscribersFluentBuilder
{
    fn send(
        self,
...
impl ListSubscribersFluentBuilder {
    /// Creates a new `ListSubscribersFluentBuilder`.
    ...
    /// Access the ListSubscribers as a reference.
    pub fn as_input(&self) -> &crate::operation::list_subscribers::builders::ListSubscribersInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_subscribers::ListSubscribers::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_subscribers::ListSubscribers::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_subscribers::paginator::ListSubscribersPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_subscribers::paginator::ListSubscribersPaginator {
        crate::operation::list_subscribers::paginator::ListSubscribersPaginator::new(self.handle, self.inner)
    }
