...
/// Paginator for [`ListSubscribers`](crate::operation::list_subscribers::ListSubscribers)
pub struct ListSubscribersPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_subscribers::builders::ListSubscribersInputBuilder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_subscribers::ListSubscribers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_subscribers_output_output_next_token(resp);
...
impl ListSubscribersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_subscribers_output_output_subscribers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
