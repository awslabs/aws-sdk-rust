...
pub struct UpdateEventSourceOutput {
...
impl ::aws_types::request_id::RequestId for UpdateEventSourceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateEventSourceOutput {
    /// Creates a new builder-style object to manufacture [`UpdateEventSourceOutput`](crate::operation::update_event_source::UpdateEventSourceOutput).
    pub fn builder() -> crate::operation::update_event_source::builders::UpdateEventSourceOutputBuilder {
        crate::operation::update_event_source::builders::UpdateEventSourceOutputBuilder::default()
    }
}

/// A builder for [`UpdateEventSourceOutput`](crate::operation::update_event_source::UpdateEventSourceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateEventSourceOutputBuilder {
...
impl UpdateEventSourceOutputBuilder {
    /// EventSource ARN: event-sourcev2/<type>
    /// /
    /// <name>
    /// /
    ...
    /// Consumes the builder and constructs a [`UpdateEventSourceOutput`](crate::operation::update_event_source::UpdateEventSourceOutput).
    pub fn build(self) -> crate::operation::update_event_source::UpdateEventSourceOutput {
