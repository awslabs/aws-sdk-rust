...
/// Orchestration and serialization glue logic for `UpdateSubscriber`.
...
impl UpdateSubscriber {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_subscriber::UpdateSubscriberError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_subscriber::UpdateSubscriberOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EventBridgeV2", "UpdateSubscriber", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EventBridgeV2.UpdateSubscriber",
                "rpc.service" = "EventBridgeV2",
                "rpc.method" = "UpdateSubscriber",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSubscriber {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSubscriber");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateSubscriberRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateSubscriberResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSubscriber")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateSubscriberTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateSubscriberEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateSubscriberTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSubscriberTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateSubscriberInput>() else {
...
#[derive(Debug)]
struct UpdateSubscriberResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSubscriberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_subscriber::de_update_subscriber_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_subscriber::de_update_subscriber_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct UpdateSubscriberRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSubscriberRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_subscriber::UpdateSubscriberInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_subscriber::UpdateSubscriberInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/AWSEventsV2/operation/UpdateSubscriber").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_subscriber::ser_update_subscriber_input(&input)?);
...
#[derive(Debug)]
struct UpdateSubscriberEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSubscriberEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateSubscriberEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateSubscriberInput>()
            .ok_or("failed to downcast to UpdateSubscriberInput")?;
...
pub enum UpdateSubscriberError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSubscriberError) for what information is available for the error.")]
...
impl UpdateSubscriberError {
    ...
    /// Creates the `UpdateSubscriberError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateSubscriberError::InvalidStateException`.
    pub fn is_invalid_state_exception(&self) -> bool {
        matches!(self, Self::InvalidStateException(_))
    }
    /// Returns `true` if the error kind is `UpdateSubscriberError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateSubscriberError::ResourceNotFoundException`.
    ...
    /// Returns `true` if the error kind is `UpdateSubscriberError::InternalException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSubscriberError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_subscriber::UpdateSubscriberError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::update_subscriber::_update_subscriber_input::UpdateSubscriberInput;

pub use crate::operation::update_subscriber::_update_subscriber_output::UpdateSubscriberOutput;

mod _update_subscriber_input;

mod _update_subscriber_output;
