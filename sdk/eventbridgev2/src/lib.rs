...
//! offered by Amazon EventBridgeV2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon EventBridgeV2.
...
/// Configuration for Amazon EventBridgeV2.
pub mod config;
