...
impl ScanSbomFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::scan_sbom::ScanSbomOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::scan_sbom::ScanSbomError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
