...
pub struct UpdateSystemTemplateOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::SystemTemplateSummary>,
}
...
pub struct UpdateFlowTemplateOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::FlowTemplateSummary>,
}
...
pub struct UndeploySystemInstanceOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::SystemInstanceSummary>,
}
...
pub struct SearchThingsOutput  {
    ...
    #[doc(hidden)]pub things: std::option::Option<std::vec::Vec<crate::model::Thing>>,
...
pub mod search_things_output {
    ...
    impl Builder {
        ...
        /// <p>An array of things in the result set.</p>
        pub fn set_things(mut self, input: std::option::Option<std::vec::Vec<crate::model::Thing>>) -> Self {
...
pub struct SearchSystemTemplatesOutput  {
    ...
    #[doc(hidden)]pub summaries: std::option::Option<std::vec::Vec<crate::model::SystemTemplateSummary>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod search_system_templates_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) summaries: std::option::Option<std::vec::Vec<crate::model::SystemTemplateSummary>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>An array of objects that contain summary information about each system deployment in the result set.</p>
        pub fn set_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::SystemTemplateSummary>>) -> Self {
...
pub struct SearchSystemInstancesOutput  {
    ...
    #[doc(hidden)]pub summaries: std::option::Option<std::vec::Vec<crate::model::SystemInstanceSummary>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod search_system_instances_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) summaries: std::option::Option<std::vec::Vec<crate::model::SystemInstanceSummary>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// Appends an item to `summaries`.
        ...
        /// <p>An array of objects that contain summary data abour the system instances in the result set.</p>
        pub fn set_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::SystemInstanceSummary>>) -> Self {
            self.summaries = input; self
        }
        /// <p>The string to specify as <code>nextToken</code> when you request the next page of results. </p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct SearchFlowTemplatesOutput  {
    ...
    #[doc(hidden)]pub summaries: std::option::Option<std::vec::Vec<crate::model::FlowTemplateSummary>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod search_flow_templates_output {
    ...
    impl Builder {
        ...
        /// <p>An array of objects that contain summary information about each workflow in the result set.</p>
        pub fn set_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::FlowTemplateSummary>>) -> Self {
            self.summaries = input; self
        }
        /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct SearchFlowExecutionsOutput  {
    ...
    #[doc(hidden)]pub summaries: std::option::Option<std::vec::Vec<crate::model::FlowExecutionSummary>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod search_flow_executions_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) summaries: std::option::Option<std::vec::Vec<crate::model::FlowExecutionSummary>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// Appends an item to `summaries`.
        ...
        /// <p>An array of objects that contain summary information about each workflow execution in the result set.</p>
        pub fn set_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::FlowExecutionSummary>>) -> Self {
            self.summaries = input; self
        }
        /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct SearchEntitiesOutput  {
    ...
    #[doc(hidden)]pub descriptions: std::option::Option<std::vec::Vec<crate::model::EntityDescription>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod search_entities_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) descriptions: std::option::Option<std::vec::Vec<crate::model::EntityDescription>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>An array of descriptions for each entity returned in the search result.</p>
        pub fn set_descriptions(mut self, input: std::option::Option<std::vec::Vec<crate::model::EntityDescription>>) -> Self {
...
pub struct ListFlowExecutionMessagesOutput  {
    ...
    #[doc(hidden)]pub messages: std::option::Option<std::vec::Vec<crate::model::FlowExecutionMessage>>,
    /// <p>The string to specify as <code>nextToken</code> when you request the next page of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_flow_execution_messages_output {
    ...
    impl Builder {
        ...
        /// <p>A list of objects that contain information about events in the specified flow execution.</p>
        pub fn set_messages(mut self, input: std::option::Option<std::vec::Vec<crate::model::FlowExecutionMessage>>) -> Self {
...
pub struct GetUploadStatusOutput  {
    ...
    #[doc(hidden)]pub upload_status: std::option::Option<crate::model::UploadStatus>,
    /// <p>The ARN of the upload.</p>
    #[doc(hidden)]pub namespace_arn: std::option::Option<std::string::String>,
    /// <p>The name of the upload's namespace.</p>
    #[doc(hidden)]pub namespace_name: std::option::Option<std::string::String>,
    /// <p>The version of the user's namespace. Defaults to the latest version of the user's namespace.</p>
    #[doc(hidden)]pub namespace_version: std::option::Option<i64>,
    /// <p>The reason for an upload failure.</p>
    #[doc(hidden)]pub failure_reason: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub mod get_upload_status_output {
    ...
    impl Builder {
        ...
        /// <p>The status of the upload. The initial status is <code>IN_PROGRESS</code>. The response show all validation failures if the upload fails.</p>
        pub fn set_upload_status(mut self, input: std::option::Option<crate::model::UploadStatus>) -> Self {
...
pub struct GetSystemTemplateOutput  {
    ...
    #[doc(hidden)]pub description: std::option::Option<crate::model::SystemTemplateDescription>,
}
...
pub mod get_system_template_output {
    ...
    impl Builder {
        ...
        /// <p>An object that contains summary data about the system.</p>
        pub fn set_description(mut self, input: std::option::Option<crate::model::SystemTemplateDescription>) -> Self {
...
pub struct GetSystemInstanceOutput  {
    ...
    #[doc(hidden)]pub description: std::option::Option<crate::model::SystemInstanceDescription>,
}
...
pub mod get_system_instance_output {
    ...
    impl Builder {
        ...
        /// <p>An object that describes the system instance.</p>
        pub fn set_description(mut self, input: std::option::Option<crate::model::SystemInstanceDescription>) -> Self {
            self.description = input; self
        }
...
pub struct GetNamespaceDeletionStatusOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::NamespaceDeletionStatus>,
    /// <p>An error code returned by the namespace deletion task.</p>
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::NamespaceDeletionStatusErrorCodes>,
    /// <p>An error code returned by the namespace deletion task.</p>
...
impl GetNamespaceDeletionStatusOutput {
    ...
    /// <p>An error code returned by the namespace deletion task.</p>
    pub fn error_code(&self) -> std::option::Option<& crate::model::NamespaceDeletionStatusErrorCodes> {
...
pub mod get_namespace_deletion_status_output {
    ...
    impl Builder {
        ...
        /// <p>The status of the deletion request.</p>
        pub fn set_status(mut self, input: std::option::Option<crate::model::NamespaceDeletionStatus>) -> Self {
            self.status = input; self
        }
        /// <p>An error code returned by the namespace deletion task.</p>
        pub fn error_code(mut self, input: crate::model::NamespaceDeletionStatusErrorCodes) -> Self {
            self.error_code = Some(input);
            self
        }
        /// <p>An error code returned by the namespace deletion task.</p>
        pub fn set_error_code(mut self, input: std::option::Option<crate::model::NamespaceDeletionStatusErrorCodes>) -> Self {
...
pub struct GetFlowTemplateOutput  {
    ...
    #[doc(hidden)]pub description: std::option::Option<crate::model::FlowTemplateDescription>,
}
...
pub mod get_flow_template_output {
    ...
    impl Builder {
        ...
        /// <p>The object that describes the specified workflow.</p>
        pub fn set_description(mut self, input: std::option::Option<crate::model::FlowTemplateDescription>) -> Self {
            self.description = input; self
        }
...
pub struct DescribeNamespaceOutput  {
    ...
    #[doc(hidden)]pub tracking_namespace_name: std::option::Option<std::string::String>,
    /// <p>The version of the public namespace that the latest version is tracking.</p>
    #[doc(hidden)]pub tracking_namespace_version: std::option::Option<i64>,
...
impl  std::fmt::Debug for DescribeNamespaceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("tracking_namespace_version", &self.tracking_namespace_version);
        formatter.field("namespace_version", &self.namespace_version);
        formatter.finish()
    }
}
...
pub struct DeploySystemInstanceOutput  {
    ...
    #[doc(hidden)]pub greengrass_deployment_id: std::option::Option<std::string::String>,
}
