...
pub fn serialize_structure_associate_entity_to_thing_input(
...
pub fn serialize_structure_create_flow_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_4) = &input.definition {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_5, var_4);
        object_5.finish();
    }
...
pub fn serialize_structure_create_system_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_11) = &input.definition {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_12, var_11);
        object_12.finish();
    }
    ...
    if let Some(var_16) = &input.metrics_configuration {
        ...
        crate::json_ser::serialize_structure_metrics_configuration(&mut object_17, var_16);
        object_17.finish();
    }
...
pub fn serialize_structure_create_system_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_19) = &input.definition {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_20, var_19);
        object_20.finish();
    }
...
pub fn serialize_structure_delete_flow_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_system_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_system_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deploy_system_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deprecate_flow_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deprecate_system_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_dissociate_entity_from_thing_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_entities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_flow_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_flow_template_revisions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_system_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_system_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_system_template_revisions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_upload_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_flow_execution_messages_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_search_entities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_58 in var_56 {
            {
                ...
                crate::json_ser::serialize_structure_entity_filter(&mut object_59, item_58);
                object_59.finish();
            }
        }
        array_57.finish();
...
pub fn serialize_structure_search_flow_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_search_flow_templates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_71 in var_69 {
            {
                ...
                crate::json_ser::serialize_structure_flow_template_filter(&mut object_72, item_71);
                object_72.finish();
            }
        }
        array_70.finish();
...
pub fn serialize_structure_search_system_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_77 in var_75 {
            {
                ...
                crate::json_ser::serialize_structure_system_instance_filter(
                    &mut object_78,
                    item_77,
                );
                object_78.finish();
...
pub fn serialize_structure_search_system_templates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_83 in var_81 {
            {
                ...
                crate::json_ser::serialize_structure_system_template_filter(
                    &mut object_84,
                    item_83,
                );
                object_84.finish();
...
pub fn serialize_structure_search_things_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_undeploy_system_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_flow_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_102) = &input.definition {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_103, var_102);
        object_103.finish();
    }
...
pub fn serialize_structure_update_system_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_106) = &input.definition {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_107, var_106);
        object_107.finish();
    }
...
pub fn serialize_structure_upload_entity_definitions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_109) = &input.document {
        ...
        crate::json_ser::serialize_structure_definition_document(&mut object_110, var_109);
        object_110.finish();
    }
...
pub fn serialize_structure_definition_document(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_flow_template_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_system_instance_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_system_template_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
