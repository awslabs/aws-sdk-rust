...
pub fn ser_create_system_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSystemInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
