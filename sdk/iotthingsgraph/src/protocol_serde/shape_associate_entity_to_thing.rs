...
pub fn de_associate_entity_to_thing_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::associate_entity_to_thing::AssociateEntityToThingOutput, crate::operation::associate_entity_to_thing::AssociateEntityToThingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::associate_entity_to_thing::AssociateEntityToThingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_entity_to_thing_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::associate_entity_to_thing::AssociateEntityToThingOutput, crate::operation::associate_entity_to_thing::AssociateEntityToThingError> {
    Ok({
        #[allow(unused_mut)]
