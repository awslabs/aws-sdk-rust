...
pub fn serialize_operation_crate_operation_create_flow_template(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_create_flow_template_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn serialize_operation_crate_operation_delete_flow_template(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_delete_flow_template_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn serialize_operation_crate_operation_update_flow_template(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_update_flow_template_input(
        &mut object,
        input,
    )?;
    object.finish();
