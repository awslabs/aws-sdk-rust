...
impl UpdateSystemTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_system_template::UpdateSystemTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_system_template::UpdateSystemTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_system_template::UpdateSystemTemplateOutput, crate::operation::update_system_template::UpdateSystemTemplateError, Self> {
