...
impl GetSystemTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_system_template::GetSystemTemplate,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_system_template::ser_get_system_template_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSystemTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_system_template::de_get_system_template_http_response_with_props(status, headers, body)
        }
    }
}
