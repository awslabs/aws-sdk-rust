...
impl UndeploySystemInstance {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::undeploy_system_instance::UndeploySystemInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::undeploy_system_instance::UndeploySystemInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::undeploy_system_instance::UndeploySystemInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::undeploy_system_instance::UndeploySystemInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UndeploySystemInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UndeploySystemInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UndeploySystemInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UndeploySystemInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UndeploySystemInstance")
...
.with_interceptor(UndeploySystemInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::undeploy_system_instance::UndeploySystemInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::undeploy_system_instance::UndeploySystemInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::undeploy_system_instance::UndeploySystemInstanceError>::new());
...
#[derive(Debug)]
            struct UndeploySystemInstanceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UndeploySystemInstanceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_undeploy_system_instance::de_undeploy_system_instance_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UndeploySystemInstanceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UndeploySystemInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::undeploy_system_instance::UndeploySystemInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::undeploy_system_instance::UndeploySystemInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_undeploy_system_instance::ser_undeploy_system_instance_input(&input)?);
...
#[derive(Debug)]
            struct UndeploySystemInstanceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UndeploySystemInstanceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UndeploySystemInstanceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UndeploySystemInstanceInput>()
                        .ok_or("failed to downcast to UndeploySystemInstanceInput")?;
...
pub enum UndeploySystemInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UndeploySystemInstanceError) for what information is available for the error.")]
...
impl UndeploySystemInstanceError {
    /// Creates the `UndeploySystemInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UndeploySystemInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UndeploySystemInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::undeploy_system_instance::UndeploySystemInstanceError {
