...
impl GetSystemTemplateRevisionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_system_template_revisions::GetSystemTemplateRevisionsInput, ::aws_smithy_types::error::operation::BuildError> {
