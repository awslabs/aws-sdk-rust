...
impl GetNamespaceDeletionStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNamespaceDeletionStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_namespace_deletion_status::de_get_namespace_deletion_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
