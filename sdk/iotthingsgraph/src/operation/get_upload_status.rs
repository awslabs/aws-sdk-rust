...
impl GetUploadStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_upload_status::GetUploadStatus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_upload_status::ser_get_upload_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUploadStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_upload_status::de_get_upload_status_http_response_with_props(status, headers, body)
        }
    }
}
