...
impl AssociateEntityToThingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_entity_to_thing::AssociateEntityToThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_entity_to_thing::AssociateEntityToThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_entity_to_thing::AssociateEntityToThingOutput, crate::operation::associate_entity_to_thing::AssociateEntityToThingError, Self> {
