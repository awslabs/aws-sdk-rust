...
impl DescribeNamespaceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_namespace::ser_describe_namespace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNamespace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_namespace::de_describe_namespace_http_response_with_props(status, headers, body)
        }
    }
}
