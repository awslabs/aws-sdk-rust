...
impl GetSystemTemplateRevisionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_system_template_revisions::GetSystemTemplateRevisions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSystemTemplateRevisions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_system_template_revisions::de_get_system_template_revisions_http_response_with_props(
                status, headers, body,
            )
        }
    }
