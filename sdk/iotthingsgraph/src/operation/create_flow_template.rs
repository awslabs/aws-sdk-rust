...
impl CreateFlowTemplateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_flow_template::ser_create_flow_template_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFlowTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_flow_template::de_create_flow_template_http_response_with_props(status, headers, body)
        }
    }
}
