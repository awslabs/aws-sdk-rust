...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_system_template_revisions::builders::GetSystemTemplateRevisionsFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_system_template_revisions::builders::GetSystemTemplateRevisionsFluentBuilder::set_id): <p>The ID of the system template.</p>  <p>The ID should be in the following format.</p>  <p> <code>urn:tdm:REGION/ACCOUNT ID/default:system:SYSTEMNAME</code> </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_system_template_revisions::builders::GetSystemTemplateRevisionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_system_template_revisions::builders::GetSystemTemplateRevisionsFluentBuilder::set_next_token): <p>The string that specifies the next page of results. Use this when you're paginating results.</p>
