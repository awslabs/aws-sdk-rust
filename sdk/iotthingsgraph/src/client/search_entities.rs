...
impl super::Client {
    ...
    ///   - [`entity_types(EntityType)`](crate::operation::search_entities::builders::SearchEntitiesFluentBuilder::entity_types) / [`set_entity_types(Option<Vec<EntityType>>)`](crate::operation::search_entities::builders::SearchEntitiesFluentBuilder::set_entity_types): <p>The entity types for which to search.</p>
