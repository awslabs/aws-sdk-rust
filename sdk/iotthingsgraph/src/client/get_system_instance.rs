...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_system_instance::builders::GetSystemInstanceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_system_instance::builders::GetSystemInstanceFluentBuilder::set_id): <p>The ID of the system deployment instance. This value is returned by <code>CreateSystemInstance</code>.</p>  <p>The ID should be in the following format.</p>  <p> <code>urn:tdm:REGION/ACCOUNT ID/default:deployment:DEPLOYMENTNAME</code> </p>
