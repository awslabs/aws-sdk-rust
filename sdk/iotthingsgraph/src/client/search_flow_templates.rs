...
impl super::Client {
    ...
    ///   - [`filters(FlowTemplateFilter)`](crate::operation::search_flow_templates::builders::SearchFlowTemplatesFluentBuilder::filters) / [`set_filters(Option<Vec<FlowTemplateFilter>>)`](crate::operation::search_flow_templates::builders::SearchFlowTemplatesFluentBuilder::set_filters): <p>An array of objects that limit the result set. The only valid filter is <code>DEVICE_MODEL_ID</code>.</p>
