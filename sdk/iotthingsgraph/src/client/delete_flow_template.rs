...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_flow_template::builders::DeleteFlowTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_flow_template::builders::DeleteFlowTemplateFluentBuilder::set_id): <p>The ID of the workflow to be deleted.</p>  <p>The ID should be in the following format.</p>  <p> <code>urn:tdm:REGION/ACCOUNT ID/default:workflow:WORKFLOWNAME</code> </p>
