...
pub struct DefinitionDocument  {
    ...
    #[doc(hidden)]pub language: std::option::Option<crate::model::DefinitionLanguage>,
...
pub struct SystemInstanceSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::SystemInstanceDeploymentStatus>,
    ...
    #[doc(hidden)]pub greengrass_group_version_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SystemInstanceSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("greengrass_group_version_id", &self.greengrass_group_version_id);
        formatter.finish()
    }
}
...
pub struct SystemTemplateFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::SystemTemplateFilterName>,
...
pub struct SystemInstanceFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::SystemInstanceFilterName>,
    /// <p>An array of string values for the search filter field. Multiple values function as AND criteria in the search. </p>
    #[doc(hidden)]pub value: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct FlowTemplateFilter  {
    /// <p>The name of the search filter field.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::FlowTemplateFilterName>,
    /// <p>An array of string values for the search filter field. Multiple values function as AND criteria in the search.</p>
    #[doc(hidden)]pub value: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct FlowExecutionSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::FlowExecutionStatus>,
    /// <p>The ID of the system instance that contains the flow.</p>
    #[doc(hidden)]pub system_instance_id: std::option::Option<std::string::String>,
    /// <p>The ID of the flow.</p>
    #[doc(hidden)]pub flow_template_id: std::option::Option<std::string::String>,
...
pub struct EntityFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::EntityFilterName>,
    /// <p>An array of string values for the search filter field. Multiple values function as AND criteria in the search.</p>
    #[doc(hidden)]pub value: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl EntityFilter {
...
pub struct FlowExecutionMessage  {
    ...
    #[doc(hidden)]pub event_type: std::option::Option<crate::model::FlowExecutionEventType>,
...
pub struct SystemTemplateDescription  {
    ...
    #[doc(hidden)]pub validated_namespace_version: std::option::Option<i64>,
}
...
impl  std::fmt::Debug for SystemTemplateDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("definition", &self.definition);
        formatter.field("validated_namespace_version", &self.validated_namespace_version);
        formatter.finish()
    }
}
...
pub struct SystemInstanceDescription  {
    ...
    #[doc(hidden)]pub validated_dependency_revisions: std::option::Option<std::vec::Vec<crate::model::DependencyRevision>>,
...
impl  std::fmt::Debug for SystemInstanceDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("validated_namespace_version", &self.validated_namespace_version);
        formatter.field("validated_dependency_revisions", &self.validated_dependency_revisions);
...
pub struct MetricsConfiguration  {
    ...
    #[doc(hidden)]pub cloud_metric_enabled: bool,
    /// <p>The ARN of the role that is used to collect cloud metrics.</p>
    #[doc(hidden)]pub metric_rule_role_arn: std::option::Option<std::string::String>,
}
