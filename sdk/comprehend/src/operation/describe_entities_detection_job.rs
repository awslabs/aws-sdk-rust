...
impl DescribeEntitiesDetectionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEntitiesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_entities_detection_job::de_describe_entities_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
