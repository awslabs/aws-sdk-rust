...
/// Orchestration and serialization glue logic for `DescribeEntitiesDetectionJob`.
...
impl DescribeEntitiesDetectionJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobInput,
                    ) -> ::std::result::Result<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEntitiesDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeEntitiesDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeEntitiesDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeEntitiesDetectionJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeEntitiesDetectionJob")
...
.with_interceptor(DescribeEntitiesDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError>::new());
...
#[derive(Debug)]
            struct DescribeEntitiesDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEntitiesDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_entities_detection_job::de_describe_entities_detection_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_entities_detection_job::de_describe_entities_detection_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeEntitiesDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeEntitiesDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_entities_detection_job::ser_describe_entities_detection_job_input(&input)?);
...
#[derive(Debug)]
            struct DescribeEntitiesDetectionJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeEntitiesDetectionJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeEntitiesDetectionJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeEntitiesDetectionJobInput>()
                        .ok_or("failed to downcast to DescribeEntitiesDetectionJobInput")?;
...
pub enum DescribeEntitiesDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeEntitiesDetectionJobError) for what information is available for the error.")]
...
impl DescribeEntitiesDetectionJobError {
    /// Creates the `DescribeEntitiesDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeEntitiesDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::JobNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeEntitiesDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_entities_detection_job::DescribeEntitiesDetectionJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_entities_detection_job::_describe_entities_detection_job_output::DescribeEntitiesDetectionJobOutput;

pub use crate::operation::describe_entities_detection_job::_describe_entities_detection_job_input::DescribeEntitiesDetectionJobInput;

mod _describe_entities_detection_job_input;

mod _describe_entities_detection_job_output;
