...
impl StopKeyPhrasesDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobOutput, crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobError, Self> {
