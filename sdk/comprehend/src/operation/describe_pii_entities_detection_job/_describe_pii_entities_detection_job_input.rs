...
impl DescribePiiEntitiesDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
