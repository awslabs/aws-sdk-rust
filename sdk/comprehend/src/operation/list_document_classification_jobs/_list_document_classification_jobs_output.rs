...
impl ListDocumentClassificationJobsOutputBuilder {
    ...
    /// <p>A list containing the properties of each job returned.</p>
    pub fn set_document_classification_job_properties_list(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::DocumentClassificationJobProperties>>) -> Self {
        self.document_classification_job_properties_list = input; self
    }
    /// <p>A list containing the properties of each job returned.</p>
    pub fn get_document_classification_job_properties_list(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::DocumentClassificationJobProperties>> {
