...
impl ListDocumentClassificationJobsFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::list_document_classification_jobs::ListDocumentClassificationJobsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_document_classification_jobs::ListDocumentClassificationJobsError>>
                         {
        let op = self
            .inner
            .build()
