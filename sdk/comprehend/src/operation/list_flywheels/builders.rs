...
pub use crate::operation::list_flywheels::_list_flywheels_output::ListFlywheelsOutputBuilder;
...
pub struct ListFlywheelsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_flywheels::builders::ListFlywheelsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_flywheels::ListFlywheelsOutput,
                    crate::operation::list_flywheels::ListFlywheelsError,
                > for ListFlywheelsFluentBuilder
            {
                fn send(
                    self,
...
impl ListFlywheelsFluentBuilder {
    /// Creates a new `ListFlywheels`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_flywheels::ListFlywheelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_flywheels::ListFlywheelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_flywheels::ListFlywheels::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_flywheels::ListFlywheels::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_flywheels::ListFlywheelsOutput, crate::operation::list_flywheels::ListFlywheelsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_flywheels::paginator::ListFlywheelsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
