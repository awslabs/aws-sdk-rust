...
impl DetectTargetedSentimentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::detect_targeted_sentiment::DetectTargetedSentiment,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectTargetedSentiment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_targeted_sentiment::de_detect_targeted_sentiment_http_response_with_props(status, headers, body)
        }
    }
}
