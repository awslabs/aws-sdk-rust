...
impl DetectTargetedSentimentInput {
    /// Consumes the builder and constructs an Operation<[`DetectTargetedSentiment`](crate::operation::detect_targeted_sentiment::DetectTargetedSentiment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detect_targeted_sentiment::DetectTargetedSentiment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_targeted_sentiment::DetectTargetedSentimentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detect_targeted_sentiment::ser_detect_targeted_sentiment_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detect_targeted_sentiment::DetectTargetedSentiment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DetectTargetedSentiment {
                type Output = std::result::Result<crate::operation::detect_targeted_sentiment::DetectTargetedSentimentOutput, crate::operation::detect_targeted_sentiment::DetectTargetedSentimentError>;
