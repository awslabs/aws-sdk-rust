...
/// Orchestration and serialization glue logic for `StopEntitiesDetectionJob`.
...
impl StopEntitiesDetectionJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobInput,
                    ) -> ::std::result::Result<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopEntitiesDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopEntitiesDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopEntitiesDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopEntitiesDetectionJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopEntitiesDetectionJob")
...
.with_interceptor(StopEntitiesDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError>::new());
...
#[derive(Debug)]
            struct StopEntitiesDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopEntitiesDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_entities_detection_job::de_stop_entities_detection_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_entities_detection_job::de_stop_entities_detection_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopEntitiesDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopEntitiesDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_entities_detection_job::ser_stop_entities_detection_job_input(&input)?);
...
#[derive(Debug)]
            struct StopEntitiesDetectionJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopEntitiesDetectionJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopEntitiesDetectionJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopEntitiesDetectionJobInput>()
                        .ok_or("failed to downcast to StopEntitiesDetectionJobInput")?;
...
pub enum StopEntitiesDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopEntitiesDetectionJobError) for what information is available for the error.")]
...
impl StopEntitiesDetectionJobError {
    /// Creates the `StopEntitiesDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopEntitiesDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopEntitiesDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::stop_entities_detection_job::_stop_entities_detection_job_output::StopEntitiesDetectionJobOutput;

pub use crate::operation::stop_entities_detection_job::_stop_entities_detection_job_input::StopEntitiesDetectionJobInput;

mod _stop_entities_detection_job_input;

mod _stop_entities_detection_job_output;
