...
impl StopTrainingEntityRecognizerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerOutput, crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError, Self> {
