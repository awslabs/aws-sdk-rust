...
impl StopTrainingEntityRecognizerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerInput, ::aws_smithy_types::error::operation::BuildError> {
