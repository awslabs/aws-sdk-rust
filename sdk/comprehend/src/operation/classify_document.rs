...
impl ClassifyDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::classify_document::ClassifyDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_classify_document::ser_classify_document_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClassifyDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_classify_document::de_classify_document_http_response_with_props(status, headers, body)
        }
    }
}
