...
impl ClassifyDocumentInput {
    /// Consumes the builder and constructs an Operation<[`ClassifyDocument`](crate::operation::classify_document::ClassifyDocument)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::classify_document::ClassifyDocument, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::classify_document::ClassifyDocumentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_classify_document::ser_classify_document_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::classify_document::ClassifyDocument::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ClassifyDocument {
                type Output = std::result::Result<crate::operation::classify_document::ClassifyDocumentOutput, crate::operation::classify_document::ClassifyDocumentError>;
