...
impl DetectPiiEntitiesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_pii_entities::ser_detect_pii_entities_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectPiiEntities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_pii_entities::de_detect_pii_entities_http_response_with_props(status, headers, body)
        }
    }
}
