...
impl DetectTargetedSentimentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::detect_targeted_sentiment::DetectTargetedSentimentInput, ::aws_smithy_types::error::operation::BuildError> {
