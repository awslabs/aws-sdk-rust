...
impl BatchDetectSentimentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_detect_sentiment::BatchDetectSentimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_detect_sentiment::BatchDetectSentimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_detect_sentiment::BatchDetectSentimentOutput, crate::operation::batch_detect_sentiment::BatchDetectSentimentError, Self> {
