...
impl ListPiiEntitiesDetectionJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_pii_entities_detection_jobs::ListPiiEntitiesDetectionJobs,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_pii_entities_detection_jobs::ListPiiEntitiesDetectionJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPiiEntitiesDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pii_entities_detection_jobs::de_list_pii_entities_detection_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
