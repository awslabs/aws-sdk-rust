...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPiiEntitiesDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pii_entities_detection_jobs::de_list_pii_entities_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListPiiEntitiesDetectionJobsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_pii_entities_detection_jobs::ListPiiEntitiesDetectionJobsError
{
