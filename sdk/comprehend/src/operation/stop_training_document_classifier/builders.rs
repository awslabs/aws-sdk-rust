...
impl StopTrainingDocumentClassifierFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierOutput, ::aws_smithy_http::result::SdkError<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError>>
                         {
        let op = self
            .inner
            .build()
