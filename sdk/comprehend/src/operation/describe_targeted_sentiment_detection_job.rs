...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTargetedSentimentDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_targeted_sentiment_detection_job::de_describe_targeted_sentiment_detection_job_http_response_with_props(status, headers, body)
        }
    }
}
