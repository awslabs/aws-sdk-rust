...
impl DescribeTargetedSentimentDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTargetedSentimentDetectionJob`](crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_targeted_sentiment_detection_job::ser_describe_targeted_sentiment_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTargetedSentimentDetectionJob {
                type Output = std::result::Result<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobOutput, crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError>;
