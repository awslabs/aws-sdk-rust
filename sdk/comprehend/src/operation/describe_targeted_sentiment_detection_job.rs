...
/// Orchestration and serialization glue logic for `DescribeTargetedSentimentDetectionJob`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTargetedSentimentDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeTargetedSentimentDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeTargetedSentimentDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeTargetedSentimentDetectionJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTargetedSentimentDetectionJob")
...
.with_interceptor(DescribeTargetedSentimentDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError>::new());
...
#[derive(Debug)]
            struct DescribeTargetedSentimentDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTargetedSentimentDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_targeted_sentiment_detection_job::de_describe_targeted_sentiment_detection_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_targeted_sentiment_detection_job::de_describe_targeted_sentiment_detection_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeTargetedSentimentDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTargetedSentimentDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_targeted_sentiment_detection_job::ser_describe_targeted_sentiment_detection_job_input(&input)?);
...
#[derive(Debug)]
            struct DescribeTargetedSentimentDetectionJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeTargetedSentimentDetectionJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeTargetedSentimentDetectionJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeTargetedSentimentDetectionJobInput>()
                        .ok_or("failed to downcast to DescribeTargetedSentimentDetectionJobInput")?;
...
pub enum DescribeTargetedSentimentDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeTargetedSentimentDetectionJobError) for what information is available for the error.")]
...
impl DescribeTargetedSentimentDetectionJobError {
    /// Creates the `DescribeTargetedSentimentDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeTargetedSentimentDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeTargetedSentimentDetectionJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeTargetedSentimentDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_targeted_sentiment_detection_job::DescribeTargetedSentimentDetectionJobError {
...
mod _describe_targeted_sentiment_detection_job_output;
