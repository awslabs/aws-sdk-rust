...
impl StopEventsDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StopEventsDetectionJob`](crate::operation::stop_events_detection_job::StopEventsDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_events_detection_job::StopEventsDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_events_detection_job::StopEventsDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_events_detection_job::ser_stop_events_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_events_detection_job::StopEventsDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopEventsDetectionJob {
                type Output = std::result::Result<crate::operation::stop_events_detection_job::StopEventsDetectionJobOutput, crate::operation::stop_events_detection_job::StopEventsDetectionJobError>;
