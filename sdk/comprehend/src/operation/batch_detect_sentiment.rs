...
impl BatchDetectSentimentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_detect_sentiment::ser_batch_detect_sentiment_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_detect_sentiment::BatchDetectSentiment::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_detect_sentiment::BatchDetectSentimentError
{
