...
impl BatchDetectTargetedSentimentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentInput, ::aws_smithy_types::error::operation::BuildError> {
