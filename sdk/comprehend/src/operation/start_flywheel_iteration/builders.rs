...
impl StartFlywheelIterationFluentBuilder  {
    /// Creates a new `StartFlywheelIteration`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::start_flywheel_iteration::StartFlywheelIteration, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::start_flywheel_iteration::StartFlywheelIterationError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::start_flywheel_iteration::StartFlywheelIterationOutput, aws_smithy_http::result::SdkError<crate::operation::start_flywheel_iteration::StartFlywheelIterationError>>
                     {
