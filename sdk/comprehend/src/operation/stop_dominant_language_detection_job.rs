...
impl StopDominantLanguageDetectionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_dominant_language_detection_job::StopDominantLanguageDetectionJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_dominant_language_detection_job::StopDominantLanguageDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDominantLanguageDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_dominant_language_detection_job::de_stop_dominant_language_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
