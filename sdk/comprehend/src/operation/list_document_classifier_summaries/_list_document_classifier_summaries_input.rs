...
impl ListDocumentClassifierSummariesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummariesInput, ::aws_smithy_types::error::operation::BuildError> {
