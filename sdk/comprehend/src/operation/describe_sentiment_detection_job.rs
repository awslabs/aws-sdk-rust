...
impl DescribeSentimentDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_sentiment_detection_job::DescribeSentimentDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSentimentDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_sentiment_detection_job::de_describe_sentiment_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
