...
impl ListEventsDetectionJobsInputBuilder {
    /// <p>Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.</p>
    pub fn filter(mut self, input: crate::types::EventsDetectionJobFilter) -> Self {
    ...
    pub fn build(self) -> Result<crate::operation::list_events_detection_jobs::ListEventsDetectionJobsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
