...
/// Orchestration and serialization glue logic for `StopTrainingEntityRecognizer`.
...
impl StopTrainingEntityRecognizer {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopTrainingEntityRecognizer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopTrainingEntityRecognizer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopTrainingEntityRecognizerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopTrainingEntityRecognizerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopTrainingEntityRecognizer")
...
.with_interceptor(StopTrainingEntityRecognizerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError>::new());
...
#[derive(Debug)]
            struct StopTrainingEntityRecognizerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopTrainingEntityRecognizerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_training_entity_recognizer::de_stop_training_entity_recognizer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_training_entity_recognizer::de_stop_training_entity_recognizer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopTrainingEntityRecognizerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopTrainingEntityRecognizerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_training_entity_recognizer::ser_stop_training_entity_recognizer_input(&input)?);
...
#[derive(Debug)]
            struct StopTrainingEntityRecognizerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopTrainingEntityRecognizerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopTrainingEntityRecognizerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopTrainingEntityRecognizerInput>()
                        .ok_or("failed to downcast to StopTrainingEntityRecognizerInput")?;
...
pub enum StopTrainingEntityRecognizerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopTrainingEntityRecognizerError) for what information is available for the error.")]
...
impl StopTrainingEntityRecognizerError {
    /// Creates the `StopTrainingEntityRecognizerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopTrainingEntityRecognizerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopTrainingEntityRecognizerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError {
...
mod _stop_training_entity_recognizer_output;
