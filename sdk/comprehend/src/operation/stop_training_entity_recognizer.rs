...
impl StopTrainingEntityRecognizerInput {
    /// Consumes the builder and constructs an Operation<[`StopTrainingEntityRecognizer`](crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopTrainingEntityRecognizer {
                type Output = std::result::Result<crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerOutput, crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError>;
