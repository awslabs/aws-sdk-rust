...
impl StopTrainingEntityRecognizerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrainingEntityRecognizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_training_entity_recognizer::de_stop_training_entity_recognizer_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StopTrainingEntityRecognizerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_training_entity_recognizer::StopTrainingEntityRecognizerError
{
