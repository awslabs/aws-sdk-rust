...
impl ListSentimentDetectionJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobs,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSentimentDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sentiment_detection_jobs::de_list_sentiment_detection_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
