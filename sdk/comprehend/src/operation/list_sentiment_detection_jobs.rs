...
impl ListSentimentDetectionJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListSentimentDetectionJobs`](crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_sentiment_detection_jobs::ser_list_sentiment_detection_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSentimentDetectionJobs {
                type Output = std::result::Result<crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobsOutput, crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobsError>;
