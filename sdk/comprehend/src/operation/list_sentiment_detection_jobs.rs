...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSentimentDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sentiment_detection_jobs::de_list_sentiment_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_sentiment_detection_jobs::ListSentimentDetectionJobsError
{
