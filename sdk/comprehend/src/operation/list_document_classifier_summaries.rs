...
impl ListDocumentClassifierSummariesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummaries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocumentClassifierSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_document_classifier_summaries::de_list_document_classifier_summaries_http_response_with_props(
                status, headers, body,
            )
        }
    }
