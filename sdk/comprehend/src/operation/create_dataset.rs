...
impl CreateDataset {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("comprehend", "CreateDataset", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataset {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateDataset", "comprehend"));
...
impl CreateDatasetError {
    ...
    /// Returns `true` if the error kind is `CreateDatasetError::ResourceLimitExceededException`.
    ...
    /// Returns `true` if the error kind is `CreateDatasetError::TooManyRequestsException`.
