...
impl DeleteDocumentClassifierInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDocumentClassifier`](crate::operation::delete_document_classifier::DeleteDocumentClassifier)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_document_classifier::DeleteDocumentClassifier, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_document_classifier::DeleteDocumentClassifierInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_document_classifier::ser_delete_document_classifier_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_document_classifier::DeleteDocumentClassifier::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDocumentClassifier {
                type Output = std::result::Result<crate::operation::delete_document_classifier::DeleteDocumentClassifierOutput, crate::operation::delete_document_classifier::DeleteDocumentClassifierError>;
