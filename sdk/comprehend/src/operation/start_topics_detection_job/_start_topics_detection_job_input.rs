...
impl StartTopicsDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_topics_detection_job::StartTopicsDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
