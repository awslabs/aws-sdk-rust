...
impl StartPiiEntitiesDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobOutput, crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError, Self> {
