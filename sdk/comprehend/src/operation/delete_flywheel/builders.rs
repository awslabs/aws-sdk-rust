...
pub use crate::operation::delete_flywheel::_delete_flywheel_output::DeleteFlywheelOutputBuilder;
...
pub struct DeleteFlywheelFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_flywheel::builders::DeleteFlywheelInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_flywheel::DeleteFlywheelOutput,
                    crate::operation::delete_flywheel::DeleteFlywheelError,
                > for DeleteFlywheelFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteFlywheelFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_flywheel::builders::DeleteFlywheelInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_flywheel::DeleteFlywheelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_flywheel::DeleteFlywheelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_flywheel::DeleteFlywheel::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_flywheel::DeleteFlywheel::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_flywheel::DeleteFlywheelOutput, crate::operation::delete_flywheel::DeleteFlywheelError, Self> {
