...
impl DeleteFlywheelFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_flywheel::DeleteFlywheel, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_flywheel::DeleteFlywheelError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_flywheel::DeleteFlywheelOutput, aws_smithy_http::result::SdkError<crate::operation::delete_flywheel::DeleteFlywheelError>>
                     {
