...
impl BatchDetectEntitiesInput {
    /// Consumes the builder and constructs an Operation<[`BatchDetectEntities`](crate::operation::batch_detect_entities::BatchDetectEntities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_detect_entities::BatchDetectEntities, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_detect_entities::BatchDetectEntitiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_detect_entities::ser_batch_detect_entities_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_detect_entities::BatchDetectEntities::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDetectEntities {
                type Output = std::result::Result<crate::operation::batch_detect_entities::BatchDetectEntitiesOutput, crate::operation::batch_detect_entities::BatchDetectEntitiesError>;
