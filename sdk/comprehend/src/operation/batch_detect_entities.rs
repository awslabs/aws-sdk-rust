...
impl BatchDetectEntitiesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_detect_entities::ser_batch_detect_entities_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_detect_entities::BatchDetectEntities::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_detect_entities::BatchDetectEntitiesError
{
