...
impl StartDocumentClassificationJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_document_classification_job::StartDocumentClassificationJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_document_classification_job::StartDocumentClassificationJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDocumentClassificationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_document_classification_job::de_start_document_classification_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
