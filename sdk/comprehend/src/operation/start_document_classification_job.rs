...
impl StartDocumentClassificationJobInput {
    /// Consumes the builder and constructs an Operation<[`StartDocumentClassificationJob`](crate::operation::start_document_classification_job::StartDocumentClassificationJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_document_classification_job::StartDocumentClassificationJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_document_classification_job::StartDocumentClassificationJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_document_classification_job::ser_start_document_classification_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_document_classification_job::StartDocumentClassificationJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartDocumentClassificationJob {
                type Output = std::result::Result<crate::operation::start_document_classification_job::StartDocumentClassificationJobOutput, crate::operation::start_document_classification_job::StartDocumentClassificationJobError>;
