...
impl BatchDetectDominantLanguageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguage::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchDetectDominantLanguageError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError
{
