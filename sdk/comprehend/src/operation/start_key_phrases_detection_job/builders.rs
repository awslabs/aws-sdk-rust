...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobOutput,
                    crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobError,
                > for StartKeyPhrasesDetectionJobFluentBuilder
            {
                fn send(
                    self,
...
impl StartKeyPhrasesDetectionJobFluentBuilder {
    ...
    /// Access the StartKeyPhrasesDetectionJob as a reference.
    pub fn as_input(&self) -> &crate::operation::start_key_phrases_detection_job::builders::StartKeyPhrasesDetectionJobInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobOutput, crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobError, Self> {
