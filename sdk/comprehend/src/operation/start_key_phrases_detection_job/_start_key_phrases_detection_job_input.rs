...
impl StartKeyPhrasesDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
