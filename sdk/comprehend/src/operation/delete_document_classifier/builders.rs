...
impl DeleteDocumentClassifierFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_document_classifier::DeleteDocumentClassifierOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_document_classifier::DeleteDocumentClassifierError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_document_classifier::DeleteDocumentClassifierOutput, crate::operation::delete_document_classifier::DeleteDocumentClassifierError, Self> {
