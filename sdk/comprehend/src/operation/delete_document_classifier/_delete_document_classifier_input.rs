...
impl DeleteDocumentClassifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_document_classifier::DeleteDocumentClassifierInput, ::aws_smithy_types::error::operation::BuildError> {
