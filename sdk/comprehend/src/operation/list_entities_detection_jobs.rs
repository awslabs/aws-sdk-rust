...
impl ListEntitiesDetectionJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobs,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEntitiesDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_entities_detection_jobs::de_list_entities_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
