...
/// Orchestration and serialization glue logic for `ListEntitiesDetectionJobs`.
...
impl ListEntitiesDetectionJobs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsInput,
                    ) -> ::std::result::Result<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEntitiesDetectionJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEntitiesDetectionJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEntitiesDetectionJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEntitiesDetectionJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEntitiesDetectionJobs")
...
.with_interceptor(ListEntitiesDetectionJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError>::new());
...
#[derive(Debug)]
            struct ListEntitiesDetectionJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntitiesDetectionJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_entities_detection_jobs::de_list_entities_detection_jobs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_entities_detection_jobs::de_list_entities_detection_jobs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEntitiesDetectionJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntitiesDetectionJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_entities_detection_jobs::ser_list_entities_detection_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListEntitiesDetectionJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntitiesDetectionJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEntitiesDetectionJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEntitiesDetectionJobsInput>()
                        .ok_or("failed to downcast to ListEntitiesDetectionJobsInput")?;
...
pub enum ListEntitiesDetectionJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEntitiesDetectionJobsError) for what information is available for the error.")]
...
impl ListEntitiesDetectionJobsError {
    /// Creates the `ListEntitiesDetectionJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEntitiesDetectionJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidFilterException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEntitiesDetectionJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_entities_detection_jobs::_list_entities_detection_jobs_output::ListEntitiesDetectionJobsOutput;

pub use crate::operation::list_entities_detection_jobs::_list_entities_detection_jobs_input::ListEntitiesDetectionJobsInput;

mod _list_entities_detection_jobs_input;

mod _list_entities_detection_jobs_output;
