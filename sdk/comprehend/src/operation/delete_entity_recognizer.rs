...
impl DeleteEntityRecognizerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_entity_recognizer::DeleteEntityRecognizer,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEntityRecognizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_entity_recognizer::de_delete_entity_recognizer_http_response_with_props(status, headers, body)
        }
    }
}
