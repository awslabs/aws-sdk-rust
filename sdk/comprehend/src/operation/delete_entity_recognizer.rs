...
/// Orchestration and serialization glue logic for `DeleteEntityRecognizer`.
...
impl DeleteEntityRecognizer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_entity_recognizer::DeleteEntityRecognizerInput,
                    ) -> ::std::result::Result<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteEntityRecognizer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteEntityRecognizer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteEntityRecognizerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteEntityRecognizerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteEntityRecognizer")
...
.with_interceptor(DeleteEntityRecognizerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError>::new());
...
#[derive(Debug)]
            struct DeleteEntityRecognizerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteEntityRecognizerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_entity_recognizer::de_delete_entity_recognizer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_entity_recognizer::de_delete_entity_recognizer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteEntityRecognizerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteEntityRecognizerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_entity_recognizer::DeleteEntityRecognizerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_entity_recognizer::ser_delete_entity_recognizer_input(&input)?);
...
#[derive(Debug)]
            struct DeleteEntityRecognizerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteEntityRecognizerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteEntityRecognizerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteEntityRecognizerInput>()
                        .ok_or("failed to downcast to DeleteEntityRecognizerInput")?;
...
pub enum DeleteEntityRecognizerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteEntityRecognizerError) for what information is available for the error.")]
...
impl DeleteEntityRecognizerError {
    /// Creates the `DeleteEntityRecognizerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteEntityRecognizerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteEntityRecognizerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError {
...
mod _delete_entity_recognizer_output;
