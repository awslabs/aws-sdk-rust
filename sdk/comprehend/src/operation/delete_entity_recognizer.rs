...
impl DeleteEntityRecognizerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteEntityRecognizer`](crate::operation::delete_entity_recognizer::DeleteEntityRecognizer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_entity_recognizer::DeleteEntityRecognizer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_entity_recognizer::DeleteEntityRecognizerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_entity_recognizer::ser_delete_entity_recognizer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_entity_recognizer::DeleteEntityRecognizer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEntityRecognizer {
                type Output = std::result::Result<crate::operation::delete_entity_recognizer::DeleteEntityRecognizerOutput, crate::operation::delete_entity_recognizer::DeleteEntityRecognizerError>;
