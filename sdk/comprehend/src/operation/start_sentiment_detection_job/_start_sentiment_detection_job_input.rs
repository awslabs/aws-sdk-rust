...
impl StartSentimentDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_sentiment_detection_job::StartSentimentDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
