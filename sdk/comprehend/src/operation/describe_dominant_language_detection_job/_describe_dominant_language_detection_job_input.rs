...
impl DescribeDominantLanguageDetectionJobInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
