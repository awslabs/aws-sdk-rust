...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDominantLanguageDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_dominant_language_detection_jobs::de_list_dominant_language_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
