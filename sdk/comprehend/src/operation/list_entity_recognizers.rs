...
impl ListEntityRecognizersInput {
    /// Consumes the builder and constructs an Operation<[`ListEntityRecognizers`](crate::operation::list_entity_recognizers::ListEntityRecognizers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_entity_recognizers::ListEntityRecognizers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_entity_recognizers::ListEntityRecognizersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_entity_recognizers::ser_list_entity_recognizers_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_entity_recognizers::ListEntityRecognizers::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListEntityRecognizers {
                type Output = std::result::Result<crate::operation::list_entity_recognizers::ListEntityRecognizersOutput, crate::operation::list_entity_recognizers::ListEntityRecognizersError>;
