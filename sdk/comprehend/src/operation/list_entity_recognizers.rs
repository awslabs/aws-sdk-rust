...
/// Orchestration and serialization glue logic for `ListEntityRecognizers`.
...
impl ListEntityRecognizers {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_entity_recognizers::ListEntityRecognizersInput,
                    ) -> ::std::result::Result<crate::operation::list_entity_recognizers::ListEntityRecognizersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_entity_recognizers::ListEntityRecognizersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_entity_recognizers::ListEntityRecognizersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_entity_recognizers::ListEntityRecognizersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEntityRecognizers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEntityRecognizers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEntityRecognizersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEntityRecognizersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEntityRecognizers")
...
.with_interceptor(ListEntityRecognizersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_entity_recognizers::ListEntityRecognizersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_entity_recognizers::ListEntityRecognizersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_entity_recognizers::ListEntityRecognizersError>::new());
...
#[derive(Debug)]
            struct ListEntityRecognizersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntityRecognizersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_entity_recognizers::de_list_entity_recognizers_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListEntityRecognizersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntityRecognizersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_entity_recognizers::ListEntityRecognizersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_entity_recognizers::ListEntityRecognizersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_entity_recognizers::ser_list_entity_recognizers_input(&input)?);
...
#[derive(Debug)]
            struct ListEntityRecognizersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntityRecognizersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEntityRecognizersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEntityRecognizersInput>()
                        .ok_or("failed to downcast to ListEntityRecognizersInput")?;
...
pub enum ListEntityRecognizersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEntityRecognizersError) for what information is available for the error.")]
...
impl ListEntityRecognizersError {
    /// Creates the `ListEntityRecognizersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEntityRecognizersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEntityRecognizersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_entity_recognizers::ListEntityRecognizersError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_entity_recognizers::_list_entity_recognizers_output::ListEntityRecognizersOutput;

pub use crate::operation::list_entity_recognizers::_list_entity_recognizers_input::ListEntityRecognizersInput;

mod _list_entity_recognizers_input;

mod _list_entity_recognizers_output;
