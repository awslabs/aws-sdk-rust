...
/// Orchestration and serialization glue logic for `BatchDetectTargetedSentiment`.
...
impl BatchDetectTargetedSentiment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentInput,
                    ) -> ::std::result::Result<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDetectTargetedSentiment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDetectTargetedSentiment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDetectTargetedSentimentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDetectTargetedSentimentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDetectTargetedSentiment")
...
.with_interceptor(BatchDetectTargetedSentimentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError>::new());
...
#[derive(Debug)]
            struct BatchDetectTargetedSentimentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDetectTargetedSentimentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_detect_targeted_sentiment::de_batch_detect_targeted_sentiment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_detect_targeted_sentiment::de_batch_detect_targeted_sentiment_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchDetectTargetedSentimentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDetectTargetedSentimentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_detect_targeted_sentiment::ser_batch_detect_targeted_sentiment_input(&input)?);
...
#[derive(Debug)]
            struct BatchDetectTargetedSentimentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDetectTargetedSentimentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDetectTargetedSentimentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDetectTargetedSentimentInput>()
                        .ok_or("failed to downcast to BatchDetectTargetedSentimentInput")?;
...
pub enum BatchDetectTargetedSentimentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDetectTargetedSentimentError) for what information is available for the error.")]
...
impl BatchDetectTargetedSentimentError {
    /// Creates the `BatchDetectTargetedSentimentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDetectTargetedSentimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BatchSizeLimitExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDetectTargetedSentimentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentimentError {
...
mod _batch_detect_targeted_sentiment_output;
