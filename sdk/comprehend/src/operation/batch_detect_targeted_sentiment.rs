...
impl BatchDetectTargetedSentimentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_detect_targeted_sentiment::BatchDetectTargetedSentiment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDetectTargetedSentiment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_detect_targeted_sentiment::de_batch_detect_targeted_sentiment_http_response_with_props(
                status, headers, body,
            )
        }
    }
