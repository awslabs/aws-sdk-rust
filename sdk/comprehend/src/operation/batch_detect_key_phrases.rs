...
impl BatchDetectKeyPhrasesInput {
    /// Consumes the builder and constructs an Operation<[`BatchDetectKeyPhrases`](crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrases, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrasesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrases::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDetectKeyPhrases {
                type Output = std::result::Result<crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrasesOutput, crate::operation::batch_detect_key_phrases::BatchDetectKeyPhrasesError>;
