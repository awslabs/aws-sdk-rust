...
impl DetectSyntaxInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detect_syntax::DetectSyntax, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_syntax::ser_detect_syntax_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectSyntax {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_syntax::de_detect_syntax_http_response_with_props(status, headers, body)
        }
    }
}
