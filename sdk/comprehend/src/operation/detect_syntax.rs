...
impl DetectSyntaxInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detect_syntax::DetectSyntax::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectSyntax {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detect_syntax::de_detect_syntax_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_detect_syntax::de_detect_syntax_http_response_with_props(
                status, headers, body,
            )
        }
    }
