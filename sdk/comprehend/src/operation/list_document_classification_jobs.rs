...
impl ListDocumentClassificationJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_document_classification_jobs::ListDocumentClassificationJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocumentClassificationJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_document_classification_jobs::de_list_document_classification_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
