...
impl StopPiiEntitiesDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StopPiiEntitiesDetectionJob`](crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_pii_entities_detection_job::ser_stop_pii_entities_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopPiiEntitiesDetectionJob {
                type Output = std::result::Result<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobOutput, crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError>;
