...
impl StopPiiEntitiesDetectionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopPiiEntitiesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_pii_entities_detection_job::de_stop_pii_entities_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
