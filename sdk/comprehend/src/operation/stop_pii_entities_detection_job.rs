...
/// Orchestration and serialization glue logic for `StopPiiEntitiesDetectionJob`.
...
impl StopPiiEntitiesDetectionJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobInput,
                    ) -> ::std::result::Result<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopPiiEntitiesDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopPiiEntitiesDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopPiiEntitiesDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopPiiEntitiesDetectionJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopPiiEntitiesDetectionJob")
...
.with_interceptor(StopPiiEntitiesDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError>::new());
...
#[derive(Debug)]
            struct StopPiiEntitiesDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopPiiEntitiesDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_pii_entities_detection_job::de_stop_pii_entities_detection_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StopPiiEntitiesDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopPiiEntitiesDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_pii_entities_detection_job::ser_stop_pii_entities_detection_job_input(&input)?);
...
#[derive(Debug)]
            struct StopPiiEntitiesDetectionJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopPiiEntitiesDetectionJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopPiiEntitiesDetectionJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopPiiEntitiesDetectionJobInput>()
                        .ok_or("failed to downcast to StopPiiEntitiesDetectionJobInput")?;
...
pub enum StopPiiEntitiesDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopPiiEntitiesDetectionJobError) for what information is available for the error.")]
...
impl StopPiiEntitiesDetectionJobError {
    /// Creates the `StopPiiEntitiesDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopPiiEntitiesDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopPiiEntitiesDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_pii_entities_detection_job::StopPiiEntitiesDetectionJobError {
...
mod _stop_pii_entities_detection_job_output;
