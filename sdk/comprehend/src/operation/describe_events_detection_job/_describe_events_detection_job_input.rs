...
impl DescribeEventsDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_events_detection_job::DescribeEventsDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
