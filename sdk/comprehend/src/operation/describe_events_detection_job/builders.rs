...
pub use crate::operation::describe_events_detection_job::_describe_events_detection_job_output::DescribeEventsDetectionJobOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_events_detection_job::DescribeEventsDetectionJobOutput,
                    crate::operation::describe_events_detection_job::DescribeEventsDetectionJobError,
                > for DescribeEventsDetectionJobFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeEventsDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_events_detection_job::DescribeEventsDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_events_detection_job::DescribeEventsDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_events_detection_job::DescribeEventsDetectionJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_events_detection_job::DescribeEventsDetectionJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_events_detection_job::DescribeEventsDetectionJobOutput, crate::operation::describe_events_detection_job::DescribeEventsDetectionJobError, Self> {
