...
impl crate::operation::describe_events_detection_job::builders::DescribeEventsDetectionJobInputBuilder {
...
impl DescribeEventsDetectionJobFluentBuilder {
    /// Creates a new `DescribeEventsDetectionJobFluentBuilder`.
