...
impl BatchDetectSyntaxFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_detect_syntax::BatchDetectSyntaxOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_detect_syntax::BatchDetectSyntaxError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_detect_syntax::BatchDetectSyntaxOutput, crate::operation::batch_detect_syntax::BatchDetectSyntaxError, Self> {
