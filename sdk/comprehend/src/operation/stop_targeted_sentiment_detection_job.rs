...
impl StopTargetedSentimentDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_targeted_sentiment_detection_job::StopTargetedSentimentDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTargetedSentimentDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_targeted_sentiment_detection_job::de_stop_targeted_sentiment_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
