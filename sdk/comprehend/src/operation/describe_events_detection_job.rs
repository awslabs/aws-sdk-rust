...
impl DescribeEventsDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_events_detection_job::DescribeEventsDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEventsDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_events_detection_job::de_describe_events_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
