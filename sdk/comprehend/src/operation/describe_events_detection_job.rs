...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEventsDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_events_detection_job::de_describe_events_detection_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_events_detection_job::DescribeEventsDetectionJobError
{
