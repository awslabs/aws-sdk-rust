...
impl DescribeEventsDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEventsDetectionJob`](crate::operation::describe_events_detection_job::DescribeEventsDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_events_detection_job::DescribeEventsDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_events_detection_job::DescribeEventsDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_events_detection_job::ser_describe_events_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_events_detection_job::DescribeEventsDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventsDetectionJob {
                type Output = std::result::Result<crate::operation::describe_events_detection_job::DescribeEventsDetectionJobOutput, crate::operation::describe_events_detection_job::DescribeEventsDetectionJobError>;
