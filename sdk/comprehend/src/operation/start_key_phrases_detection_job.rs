...
impl StartKeyPhrasesDetectionJob {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartKeyPhrasesDetectionJob",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartKeyPhrasesDetectionJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartKeyPhrasesDetectionJobRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartKeyPhrasesDetectionJobResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartKeyPhrasesDetectionJob")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartKeyPhrasesDetectionJob")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartKeyPhrasesDetectionJobTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartKeyPhrasesDetectionJobTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartKeyPhrasesDetectionJobTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartKeyPhrasesDetectionJobInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartKeyPhrasesDetectionJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_key_phrases_detection_job::ser_start_key_phrases_detection_job_input(&input)?,
        );
