...
impl StartKeyPhrasesDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartKeyPhrasesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_key_phrases_detection_job::de_start_key_phrases_detection_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StartKeyPhrasesDetectionJobError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobError
{
