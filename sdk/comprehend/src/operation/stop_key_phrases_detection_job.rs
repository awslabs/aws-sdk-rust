...
impl ::aws_smithy_http::response::ParseStrictResponse for StopKeyPhrasesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_key_phrases_detection_job::de_stop_key_phrases_detection_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobError
{
