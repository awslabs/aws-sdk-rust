...
impl DeleteFlywheelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_flywheel::DeleteFlywheel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_flywheel::ser_delete_flywheel_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFlywheel {
    type Output =
        ::std::result::Result<crate::operation::delete_flywheel::DeleteFlywheelOutput, crate::operation::delete_flywheel::DeleteFlywheelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_flywheel::de_delete_flywheel_http_response_with_props(status, headers, body)
        }
    }
}
