...
impl ContainsPiiEntitiesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_contains_pii_entities::ser_contains_pii_entities_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::contains_pii_entities::ContainsPiiEntities::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::contains_pii_entities::ContainsPiiEntitiesError
{
