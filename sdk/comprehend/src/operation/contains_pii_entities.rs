...
impl ContainsPiiEntitiesInput {
    /// Consumes the builder and constructs an Operation<[`ContainsPiiEntities`](crate::operation::contains_pii_entities::ContainsPiiEntities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::contains_pii_entities::ContainsPiiEntities, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::contains_pii_entities::ContainsPiiEntitiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_contains_pii_entities::ser_contains_pii_entities_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::contains_pii_entities::ContainsPiiEntities::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ContainsPiiEntities {
                type Output = std::result::Result<crate::operation::contains_pii_entities::ContainsPiiEntitiesOutput, crate::operation::contains_pii_entities::ContainsPiiEntitiesError>;
