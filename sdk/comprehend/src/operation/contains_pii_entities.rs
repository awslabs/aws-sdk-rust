...
/// Orchestration and serialization glue logic for `ContainsPiiEntities`.
...
impl ContainsPiiEntities {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::contains_pii_entities::ContainsPiiEntitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::contains_pii_entities::ContainsPiiEntitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::contains_pii_entities::ContainsPiiEntitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::contains_pii_entities::ContainsPiiEntitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ContainsPiiEntities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ContainsPiiEntities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ContainsPiiEntitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ContainsPiiEntitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ContainsPiiEntities")
...
.with_interceptor(ContainsPiiEntitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::contains_pii_entities::ContainsPiiEntitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::contains_pii_entities::ContainsPiiEntitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::contains_pii_entities::ContainsPiiEntitiesError>::new());
...
#[derive(Debug)]
            struct ContainsPiiEntitiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ContainsPiiEntitiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_contains_pii_entities::de_contains_pii_entities_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_contains_pii_entities::de_contains_pii_entities_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ContainsPiiEntitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ContainsPiiEntitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::contains_pii_entities::ContainsPiiEntitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::contains_pii_entities::ContainsPiiEntitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_contains_pii_entities::ser_contains_pii_entities_input(&input)?);
...
#[derive(Debug)]
            struct ContainsPiiEntitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ContainsPiiEntitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ContainsPiiEntitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ContainsPiiEntitiesInput>()
                        .ok_or("failed to downcast to ContainsPiiEntitiesInput")?;
...
pub enum ContainsPiiEntitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ContainsPiiEntitiesError) for what information is available for the error.")]
...
impl ContainsPiiEntitiesError {
    /// Creates the `ContainsPiiEntitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ContainsPiiEntitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ContainsPiiEntitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::contains_pii_entities::ContainsPiiEntitiesError {
...
mod _contains_pii_entities_output;
