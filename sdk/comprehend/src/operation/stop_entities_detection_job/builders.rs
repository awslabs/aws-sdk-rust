...
pub use crate::operation::stop_entities_detection_job::_stop_entities_detection_job_output::StopEntitiesDetectionJobOutputBuilder;

pub use crate::operation::stop_entities_detection_job::_stop_entities_detection_job_input::StopEntitiesDetectionJobInputBuilder;
...
impl StopEntitiesDetectionJobInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.stop_entities_detection_job();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobOutput,
                    crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError,
                > for StopEntitiesDetectionJobFluentBuilder
            {
                fn send(
                    self,
...
impl StopEntitiesDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::stop_entities_detection_job::StopEntitiesDetectionJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::stop_entities_detection_job::StopEntitiesDetectionJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobOutput, crate::operation::stop_entities_detection_job::StopEntitiesDetectionJobError, Self> {
