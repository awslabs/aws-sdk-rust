...
impl StartEventsDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_events_detection_job::StartEventsDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
