...
impl BatchDetectSyntaxInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_detect_syntax::ser_batch_detect_syntax_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDetectSyntax {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_detect_syntax::de_batch_detect_syntax_http_response_with_props(status, headers, body)
        }
    }
}
