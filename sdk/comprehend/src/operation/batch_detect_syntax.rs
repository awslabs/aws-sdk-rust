...
impl BatchDetectSyntaxInput {
    /// Consumes the builder and constructs an Operation<[`BatchDetectSyntax`](crate::operation::batch_detect_syntax::BatchDetectSyntax)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_detect_syntax::BatchDetectSyntax, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_detect_syntax::BatchDetectSyntaxInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_detect_syntax::ser_batch_detect_syntax_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_detect_syntax::BatchDetectSyntax::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDetectSyntax {
                type Output = std::result::Result<crate::operation::batch_detect_syntax::BatchDetectSyntaxOutput, crate::operation::batch_detect_syntax::BatchDetectSyntaxError>;
