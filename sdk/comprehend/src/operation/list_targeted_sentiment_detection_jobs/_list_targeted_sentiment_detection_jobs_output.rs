...
pub struct ListTargetedSentimentDetectionJobsOutput  {
    ...
    #[doc(hidden)]
    pub targeted_sentiment_detection_job_properties_list: std::option::Option<std::vec::Vec<crate::types::TargetedSentimentDetectionJobProperties>>,
...
impl ListTargetedSentimentDetectionJobsOutput {
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn targeted_sentiment_detection_job_properties_list(&self) -> std::option::Option<& [crate::types::TargetedSentimentDetectionJobProperties]> {
...
impl aws_http::request_id::RequestId for ListTargetedSentimentDetectionJobsOutput {
...
pub struct ListTargetedSentimentDetectionJobsOutputBuilder {
    pub(crate) targeted_sentiment_detection_job_properties_list: std::option::Option<std::vec::Vec<crate::types::TargetedSentimentDetectionJobProperties>>,
...
impl ListTargetedSentimentDetectionJobsOutputBuilder {
    ...
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn set_targeted_sentiment_detection_job_properties_list(mut self, input: std::option::Option<std::vec::Vec<crate::types::TargetedSentimentDetectionJobProperties>>) -> Self {
