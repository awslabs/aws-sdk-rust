...
impl ListTargetedSentimentDetectionJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_targeted_sentiment_detection_jobs::ListTargetedSentimentDetectionJobsInput, ::aws_smithy_types::error::operation::BuildError> {
