...
impl ListTopicsDetectionJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobs,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTopicsDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_topics_detection_jobs::de_list_topics_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
