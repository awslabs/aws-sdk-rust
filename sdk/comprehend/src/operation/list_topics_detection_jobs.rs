...
/// Orchestration and serialization glue logic for `ListTopicsDetectionJobs`.
...
impl ListTopicsDetectionJobs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsInput,
                    ) -> ::std::result::Result<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTopicsDetectionJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListTopicsDetectionJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListTopicsDetectionJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTopicsDetectionJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTopicsDetectionJobs")
...
.with_interceptor(ListTopicsDetectionJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>::new());
...
#[derive(Debug)]
            struct ListTopicsDetectionJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTopicsDetectionJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_topics_detection_jobs::de_list_topics_detection_jobs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_topics_detection_jobs::de_list_topics_detection_jobs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListTopicsDetectionJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTopicsDetectionJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_topics_detection_jobs::ser_list_topics_detection_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListTopicsDetectionJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTopicsDetectionJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListTopicsDetectionJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListTopicsDetectionJobsInput>()
                        .ok_or("failed to downcast to ListTopicsDetectionJobsInput")?;
...
pub enum ListTopicsDetectionJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListTopicsDetectionJobsError) for what information is available for the error.")]
...
impl ListTopicsDetectionJobsError {
    /// Creates the `ListTopicsDetectionJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListTopicsDetectionJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListTopicsDetectionJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError {
...
mod _list_topics_detection_jobs_output;
