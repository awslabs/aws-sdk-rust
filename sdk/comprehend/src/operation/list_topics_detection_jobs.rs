...
impl ListTopicsDetectionJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListTopicsDetectionJobs`](crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_topics_detection_jobs::ser_list_topics_detection_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTopicsDetectionJobs {
                type Output = std::result::Result<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsOutput, crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>;
