...
impl ListKeyPhrasesDetectionJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKeyPhrasesDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_key_phrases_detection_jobs::de_list_key_phrases_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListKeyPhrasesDetectionJobsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError
{
