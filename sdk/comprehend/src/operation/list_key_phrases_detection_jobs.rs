...
/// Orchestration and serialization glue logic for `ListKeyPhrasesDetectionJobs`.
...
impl ListKeyPhrasesDetectionJobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListKeyPhrasesDetectionJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListKeyPhrasesDetectionJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListKeyPhrasesDetectionJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListKeyPhrasesDetectionJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListKeyPhrasesDetectionJobs")
...
.with_interceptor(ListKeyPhrasesDetectionJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError>::new());
...
#[derive(Debug)]
            struct ListKeyPhrasesDetectionJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListKeyPhrasesDetectionJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_key_phrases_detection_jobs::de_list_key_phrases_detection_jobs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_key_phrases_detection_jobs::de_list_key_phrases_detection_jobs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListKeyPhrasesDetectionJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListKeyPhrasesDetectionJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_key_phrases_detection_jobs::ser_list_key_phrases_detection_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListKeyPhrasesDetectionJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListKeyPhrasesDetectionJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListKeyPhrasesDetectionJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListKeyPhrasesDetectionJobsInput>()
                        .ok_or("failed to downcast to ListKeyPhrasesDetectionJobsInput")?;
...
pub enum ListKeyPhrasesDetectionJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListKeyPhrasesDetectionJobsError) for what information is available for the error.")]
...
impl ListKeyPhrasesDetectionJobsError {
    /// Creates the `ListKeyPhrasesDetectionJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListKeyPhrasesDetectionJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListKeyPhrasesDetectionJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_key_phrases_detection_jobs::ListKeyPhrasesDetectionJobsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_key_phrases_detection_jobs::_list_key_phrases_detection_jobs_output::ListKeyPhrasesDetectionJobsOutput;

pub use crate::operation::list_key_phrases_detection_jobs::_list_key_phrases_detection_jobs_input::ListKeyPhrasesDetectionJobsInput;

mod _list_key_phrases_detection_jobs_input;

mod _list_key_phrases_detection_jobs_output;
