...
impl DescribeDocumentClassificationJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_document_classification_job::DescribeDocumentClassificationJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDocumentClassificationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_document_classification_job::de_describe_document_classification_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
