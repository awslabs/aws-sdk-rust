...
/// Orchestration and serialization glue logic for `DescribeDocumentClassificationJob`.
...
impl DescribeDocumentClassificationJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobInput,
                    ) -> ::std::result::Result<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDocumentClassificationJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDocumentClassificationJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDocumentClassificationJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDocumentClassificationJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDocumentClassificationJob")
...
.with_interceptor(DescribeDocumentClassificationJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError>::new());
...
#[derive(Debug)]
            struct DescribeDocumentClassificationJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDocumentClassificationJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_document_classification_job::de_describe_document_classification_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_document_classification_job::de_describe_document_classification_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDocumentClassificationJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDocumentClassificationJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_document_classification_job::ser_describe_document_classification_job_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDocumentClassificationJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDocumentClassificationJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDocumentClassificationJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDocumentClassificationJobInput>()
                        .ok_or("failed to downcast to DescribeDocumentClassificationJobInput")?;
...
pub enum DescribeDocumentClassificationJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDocumentClassificationJobError) for what information is available for the error.")]
...
impl DescribeDocumentClassificationJobError {
    /// Creates the `DescribeDocumentClassificationJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDocumentClassificationJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDocumentClassificationJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDocumentClassificationJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_document_classification_job::DescribeDocumentClassificationJobError {
...
mod _describe_document_classification_job_output;
