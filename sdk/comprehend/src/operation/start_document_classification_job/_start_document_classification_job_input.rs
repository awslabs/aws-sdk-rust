...
impl StartDocumentClassificationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_document_classification_job::StartDocumentClassificationJobInput, ::aws_smithy_types::error::operation::BuildError> {
