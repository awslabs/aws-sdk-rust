...
impl DescribePiiEntitiesDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePiiEntitiesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_pii_entities_detection_job::de_describe_pii_entities_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
