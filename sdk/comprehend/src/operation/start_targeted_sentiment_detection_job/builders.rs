...
impl StartTargetedSentimentDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_targeted_sentiment_detection_job::StartTargetedSentimentDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_targeted_sentiment_detection_job::StartTargetedSentimentDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_targeted_sentiment_detection_job::StartTargetedSentimentDetectionJobOutput, crate::operation::start_targeted_sentiment_detection_job::StartTargetedSentimentDetectionJobError, Self> {
