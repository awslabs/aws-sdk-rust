...
/// Orchestration and serialization glue logic for `StartPiiEntitiesDetectionJob`.
...
impl StartPiiEntitiesDetectionJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartPiiEntitiesDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartPiiEntitiesDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartPiiEntitiesDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartPiiEntitiesDetectionJobResponseDeserializer));
...
.with_interceptor(StartPiiEntitiesDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError>::new());
...
#[derive(Debug)]
            struct StartPiiEntitiesDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartPiiEntitiesDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_pii_entities_detection_job::de_start_pii_entities_detection_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_pii_entities_detection_job::de_start_pii_entities_detection_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartPiiEntitiesDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartPiiEntitiesDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_pii_entities_detection_job::ser_start_pii_entities_detection_job_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartPiiEntitiesDetectionJobEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartPiiEntitiesDetectionJobInput>()
                        .ok_or("failed to downcast to StartPiiEntitiesDetectionJobInput")?;
...
pub enum StartPiiEntitiesDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartPiiEntitiesDetectionJobError) for what information is available for the error.")]
...
impl StartPiiEntitiesDetectionJobError {
    /// Creates the `StartPiiEntitiesDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartPiiEntitiesDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartPiiEntitiesDetectionJobError::ResourceInUseException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartPiiEntitiesDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobError {
...
mod _start_pii_entities_detection_job_output;
