...
/// Orchestration and serialization glue logic for `ListDocumentClassifiers`.
...
impl ListDocumentClassifiers {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_document_classifiers::ListDocumentClassifiersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_document_classifiers::ListDocumentClassifiersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_document_classifiers::ListDocumentClassifiersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_document_classifiers::ListDocumentClassifiersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDocumentClassifiers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDocumentClassifiers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDocumentClassifiersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDocumentClassifiersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDocumentClassifiers")
...
.with_interceptor(ListDocumentClassifiersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_document_classifiers::ListDocumentClassifiersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_document_classifiers::ListDocumentClassifiersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_document_classifiers::ListDocumentClassifiersError>::new());
...
#[derive(Debug)]
            struct ListDocumentClassifiersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDocumentClassifiersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_document_classifiers::de_list_document_classifiers_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_document_classifiers::de_list_document_classifiers_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDocumentClassifiersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDocumentClassifiersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_document_classifiers::ListDocumentClassifiersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_document_classifiers::ListDocumentClassifiersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_document_classifiers::ser_list_document_classifiers_input(&input)?);
...
#[derive(Debug)]
            struct ListDocumentClassifiersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDocumentClassifiersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDocumentClassifiersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDocumentClassifiersInput>()
                        .ok_or("failed to downcast to ListDocumentClassifiersInput")?;
...
pub enum ListDocumentClassifiersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDocumentClassifiersError) for what information is available for the error.")]
...
impl ListDocumentClassifiersError {
    /// Creates the `ListDocumentClassifiersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDocumentClassifiersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDocumentClassifiersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_document_classifiers::ListDocumentClassifiersError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_document_classifiers::_list_document_classifiers_output::ListDocumentClassifiersOutput;

pub use crate::operation::list_document_classifiers::_list_document_classifiers_input::ListDocumentClassifiersInput;

mod _list_document_classifiers_input;

mod _list_document_classifiers_output;
