...
impl CreateEntityRecognizerInput {
    /// Consumes the builder and constructs an Operation<[`CreateEntityRecognizer`](crate::operation::create_entity_recognizer::CreateEntityRecognizer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_entity_recognizer::CreateEntityRecognizer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_entity_recognizer::CreateEntityRecognizerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_entity_recognizer::ser_create_entity_recognizer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_entity_recognizer::CreateEntityRecognizer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEntityRecognizer {
                type Output = std::result::Result<crate::operation::create_entity_recognizer::CreateEntityRecognizerOutput, crate::operation::create_entity_recognizer::CreateEntityRecognizerError>;
