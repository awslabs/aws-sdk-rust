...
impl ListPiiEntitiesDetectionJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_pii_entities_detection_jobs::ListPiiEntitiesDetectionJobsInput, ::aws_smithy_types::error::operation::BuildError> {
