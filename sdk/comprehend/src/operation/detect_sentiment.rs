...
impl DetectSentimentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detect_sentiment::DetectSentiment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectSentiment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detect_sentiment::de_detect_sentiment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::detect_sentiment::DetectSentimentError
{
