...
/// Orchestration and serialization glue logic for `StopTrainingDocumentClassifier`.
...
impl StopTrainingDocumentClassifier {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopTrainingDocumentClassifier {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopTrainingDocumentClassifier");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopTrainingDocumentClassifierRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopTrainingDocumentClassifierResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopTrainingDocumentClassifier")
...
.with_interceptor(StopTrainingDocumentClassifierEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError>::new());
...
#[derive(Debug)]
            struct StopTrainingDocumentClassifierResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopTrainingDocumentClassifierResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_training_document_classifier::de_stop_training_document_classifier_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_training_document_classifier::de_stop_training_document_classifier_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopTrainingDocumentClassifierRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopTrainingDocumentClassifierRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_training_document_classifier::ser_stop_training_document_classifier_input(&input)?);
...
#[derive(Debug)]
            struct StopTrainingDocumentClassifierEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopTrainingDocumentClassifierEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopTrainingDocumentClassifierEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopTrainingDocumentClassifierInput>()
                        .ok_or("failed to downcast to StopTrainingDocumentClassifierInput")?;
...
pub enum StopTrainingDocumentClassifierError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopTrainingDocumentClassifierError) for what information is available for the error.")]
...
impl StopTrainingDocumentClassifierError {
    /// Creates the `StopTrainingDocumentClassifierError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopTrainingDocumentClassifierError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopTrainingDocumentClassifierError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopTrainingDocumentClassifierError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError {
...
mod _stop_training_document_classifier_output;
