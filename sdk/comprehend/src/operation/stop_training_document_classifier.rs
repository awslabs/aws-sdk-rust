...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrainingDocumentClassifier {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_training_document_classifier::de_stop_training_document_classifier_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifierError
{
