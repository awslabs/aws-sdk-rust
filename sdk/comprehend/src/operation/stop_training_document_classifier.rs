...
impl StopTrainingDocumentClassifierInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifier,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_training_document_classifier::StopTrainingDocumentClassifier::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrainingDocumentClassifier {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_training_document_classifier::de_stop_training_document_classifier_http_response_with_props(
                status, headers, body,
            )
        }
    }
