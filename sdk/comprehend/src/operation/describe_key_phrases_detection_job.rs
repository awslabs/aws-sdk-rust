    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_key_phrases_detection_job::DescribeKeyPhrasesDetectionJobError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_key_phrases_detection_job::DescribeKeyPhrasesDetectionJobOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeKeyPhrasesDetectionJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeKeyPhrasesDetectionJobRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeKeyPhrasesDetectionJobEndpointParamsInterceptor {
