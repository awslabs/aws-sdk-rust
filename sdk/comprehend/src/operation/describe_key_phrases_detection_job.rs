...
impl DescribeKeyPhrasesDetectionJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_key_phrases_detection_job::DescribeKeyPhrasesDetectionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeKeyPhrasesDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_key_phrases_detection_job::de_describe_key_phrases_detection_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
