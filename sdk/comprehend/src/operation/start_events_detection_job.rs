...
/// Orchestration and serialization glue logic for `StartEventsDetectionJob`.
...
impl StartEventsDetectionJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_events_detection_job::StartEventsDetectionJobInput,
                    ) -> ::std::result::Result<crate::operation::start_events_detection_job::StartEventsDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_events_detection_job::StartEventsDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_events_detection_job::StartEventsDetectionJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_events_detection_job::StartEventsDetectionJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::start_events_detection_job::StartEventsDetectionJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartEventsDetectionJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartEventsDetectionJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartEventsDetectionJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartEventsDetectionJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartEventsDetectionJob")
...
.with_interceptor(StartEventsDetectionJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_events_detection_job::StartEventsDetectionJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_events_detection_job::StartEventsDetectionJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_events_detection_job::StartEventsDetectionJobError>::new());
...
#[derive(Debug)]
            struct StartEventsDetectionJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartEventsDetectionJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_events_detection_job::de_start_events_detection_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_events_detection_job::de_start_events_detection_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartEventsDetectionJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartEventsDetectionJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_events_detection_job::StartEventsDetectionJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_events_detection_job::StartEventsDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_events_detection_job::ser_start_events_detection_job_input(&input)?);
...
#[derive(Debug)]
            struct StartEventsDetectionJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartEventsDetectionJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartEventsDetectionJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartEventsDetectionJobInput>()
                        .ok_or("failed to downcast to StartEventsDetectionJobInput")?;
...
pub enum StartEventsDetectionJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartEventsDetectionJobError) for what information is available for the error.")]
...
impl StartEventsDetectionJobError {
    /// Creates the `StartEventsDetectionJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartEventsDetectionJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::KmsKeyValidationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `StartEventsDetectionJobError::ResourceInUseException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartEventsDetectionJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_events_detection_job::StartEventsDetectionJobError {
...
mod _start_events_detection_job_output;
