...
impl StartEventsDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartEventsDetectionJob`](crate::operation::start_events_detection_job::StartEventsDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_events_detection_job::StartEventsDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_events_detection_job::StartEventsDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_events_detection_job::ser_start_events_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_events_detection_job::StartEventsDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartEventsDetectionJob {
                type Output = std::result::Result<crate::operation::start_events_detection_job::StartEventsDetectionJobOutput, crate::operation::start_events_detection_job::StartEventsDetectionJobError>;
