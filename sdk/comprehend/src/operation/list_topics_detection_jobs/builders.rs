...
impl ListTopicsDetectionJobsFluentBuilder  {
    /// Creates a new `ListTopicsDetectionJobs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsOutput, aws_smithy_http::result::SdkError<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError>>
                     {
