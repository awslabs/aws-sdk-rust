...
impl UpdateEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_endpoint::UpdateEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_endpoint::UpdateEndpointOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Comprehend", "UpdateEndpoint", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Comprehend.UpdateEndpoint",
                "rpc.service" = "Comprehend",
                "rpc.method" = "UpdateEndpoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateEndpointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateEndpointResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateEndpoint")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateEndpoint")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateEndpointTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateEndpointTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateEndpointInput>() else {
        ...
        if requested.should_capture("DesiredModelArn") {
            if let ::std::option::Option::Some(value) = input.desired_model_arn.as_deref() {
                captured.insert("DesiredModelArn", value);
            }
        }
        if requested.should_capture("DesiredDataAccessRoleArn") {
            if let ::std::option::Option::Some(value) = input.desired_data_access_role_arn.as_deref() {
                captured.insert("DesiredDataAccessRoleArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_endpoint::de_update_endpoint_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_endpoint::de_update_endpoint_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_endpoint::UpdateEndpointInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_endpoint::UpdateEndpointInput,
