...
impl UpdateEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_endpoint::UpdateEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_endpoint::ser_update_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEndpoint {
    type Output =
        ::std::result::Result<crate::operation::update_endpoint::UpdateEndpointOutput, crate::operation::update_endpoint::UpdateEndpointError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_endpoint::de_update_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
