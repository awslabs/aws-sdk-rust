...
impl StartTopicsDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartTopicsDetectionJob`](crate::operation::start_topics_detection_job::StartTopicsDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_topics_detection_job::StartTopicsDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_topics_detection_job::StartTopicsDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_topics_detection_job::ser_start_topics_detection_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_topics_detection_job::StartTopicsDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartTopicsDetectionJob {
                type Output = std::result::Result<crate::operation::start_topics_detection_job::StartTopicsDetectionJobOutput, crate::operation::start_topics_detection_job::StartTopicsDetectionJobError>;
