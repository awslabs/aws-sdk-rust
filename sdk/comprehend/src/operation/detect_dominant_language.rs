...
impl DetectDominantLanguageInput {
    /// Consumes the builder and constructs an Operation<[`DetectDominantLanguage`](crate::operation::detect_dominant_language::DetectDominantLanguage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detect_dominant_language::DetectDominantLanguage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_dominant_language::DetectDominantLanguageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detect_dominant_language::ser_detect_dominant_language_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detect_dominant_language::DetectDominantLanguage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DetectDominantLanguage {
                type Output = std::result::Result<crate::operation::detect_dominant_language::DetectDominantLanguageOutput, crate::operation::detect_dominant_language::DetectDominantLanguageError>;
