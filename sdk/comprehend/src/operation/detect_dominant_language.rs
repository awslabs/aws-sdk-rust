...
/// Orchestration and serialization glue logic for `DetectDominantLanguage`.
...
impl DetectDominantLanguage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::detect_dominant_language::DetectDominantLanguageInput,
                    ) -> ::std::result::Result<crate::operation::detect_dominant_language::DetectDominantLanguageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_dominant_language::DetectDominantLanguageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detect_dominant_language::DetectDominantLanguageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detect_dominant_language::DetectDominantLanguageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectDominantLanguage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetectDominantLanguage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetectDominantLanguageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetectDominantLanguageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectDominantLanguage")
...
.with_interceptor(DetectDominantLanguageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detect_dominant_language::DetectDominantLanguageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detect_dominant_language::DetectDominantLanguageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detect_dominant_language::DetectDominantLanguageError>::new());
...
#[derive(Debug)]
            struct DetectDominantLanguageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectDominantLanguageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detect_dominant_language::de_detect_dominant_language_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detect_dominant_language::de_detect_dominant_language_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DetectDominantLanguageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectDominantLanguageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detect_dominant_language::DetectDominantLanguageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detect_dominant_language::DetectDominantLanguageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_dominant_language::ser_detect_dominant_language_input(&input)?);
...
#[derive(Debug)]
            struct DetectDominantLanguageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectDominantLanguageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetectDominantLanguageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetectDominantLanguageInput>()
                        .ok_or("failed to downcast to DetectDominantLanguageInput")?;
...
pub enum DetectDominantLanguageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetectDominantLanguageError) for what information is available for the error.")]
...
impl DetectDominantLanguageError {
    /// Creates the `DetectDominantLanguageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetectDominantLanguageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetectDominantLanguageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detect_dominant_language::DetectDominantLanguageError {
...
mod _detect_dominant_language_output;
