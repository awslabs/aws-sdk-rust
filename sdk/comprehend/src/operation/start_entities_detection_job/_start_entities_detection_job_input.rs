...
impl StartEntitiesDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_entities_detection_job::StartEntitiesDetectionJobInput, ::aws_smithy_types::error::operation::BuildError> {
