...
impl ListEntitiesDetectionJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsInput, ::aws_smithy_types::error::operation::BuildError> {
