...
impl ListEntitiesDetectionJobsOutputBuilder {
    ...
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn set_entities_detection_job_properties_list(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::EntitiesDetectionJobProperties>>) -> Self {
        self.entities_detection_job_properties_list = input; self
    }
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn get_entities_detection_job_properties_list(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::EntitiesDetectionJobProperties>> {
