...
impl ListEntityRecognizerSummariesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_entity_recognizer_summaries::ListEntityRecognizerSummaries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEntityRecognizerSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_entity_recognizer_summaries::de_list_entity_recognizer_summaries_http_response_with_props(
                status, headers, body,
            )
        }
    }
