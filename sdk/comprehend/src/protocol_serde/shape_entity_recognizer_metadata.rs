...
pub(crate) fn de_entity_recognizer_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EntityRecognizerMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
