...
pub fn ser_dataset_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DatasetFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
