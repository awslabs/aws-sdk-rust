...
pub(crate) fn de_targeted_sentiment_detection_job_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::TargetedSentimentDetectionJobProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
