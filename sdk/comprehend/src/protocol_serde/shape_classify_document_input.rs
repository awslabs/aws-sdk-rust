...
pub fn ser_classify_document_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ClassifyDocumentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
