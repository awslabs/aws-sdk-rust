...
pub(crate) fn de_document_classifier_output_data_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DocumentClassifierOutputDataConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
