...
pub(crate) fn de_entities_detection_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EntitiesDetectionJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
