...
pub(crate) fn de_events_detection_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::EventsDetectionJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TargetEventTypes" => {
                                builder = builder.set_target_event_types(
                                    crate::protocol_serde::shape_target_event_types::de_target_event_types(tokens)?
                                );
                            }
