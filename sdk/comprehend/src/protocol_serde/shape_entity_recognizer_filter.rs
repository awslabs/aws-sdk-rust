...
pub fn ser_entity_recognizer_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EntityRecognizerFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
