...
pub fn ser_create_entity_recognizer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEntityRecognizerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
