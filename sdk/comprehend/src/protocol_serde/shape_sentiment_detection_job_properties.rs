...
pub(crate) fn de_sentiment_detection_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SentimentDetectionJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
