...
pub(crate) fn de_document_classification_job_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DocumentClassificationJobProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
