...
pub(crate) fn de_document_classification_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DocumentClassificationJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
