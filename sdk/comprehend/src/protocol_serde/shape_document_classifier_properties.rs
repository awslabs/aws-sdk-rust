...
pub(crate) fn de_document_classifier_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DocumentClassifierProperties>, aws_smithy_json::deserialize::error::DeserializeError>
