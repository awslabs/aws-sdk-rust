...
pub fn ser_augmented_manifests_list_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AugmentedManifestsListItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_augmented_manifests_list_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AugmentedManifestsListItem>, aws_smithy_json::deserialize::error::DeserializeError>
