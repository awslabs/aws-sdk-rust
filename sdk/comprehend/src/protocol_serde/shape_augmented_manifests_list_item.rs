...
pub(crate) fn de_augmented_manifests_list_item<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AugmentedManifestsListItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::augmented_manifests_list_item_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
