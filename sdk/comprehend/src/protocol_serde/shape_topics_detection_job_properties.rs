...
pub(crate) fn de_topics_detection_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TopicsDetectionJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
