...
pub(crate) fn de_sentiment_score<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SentimentScore>, aws_smithy_json::deserialize::error::DeserializeError>
