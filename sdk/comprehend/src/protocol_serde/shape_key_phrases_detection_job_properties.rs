...
pub(crate) fn de_key_phrases_detection_job_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::KeyPhrasesDetectionJobProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
