...
pub(crate) fn de_key_phrases_detection_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KeyPhrasesDetectionJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
