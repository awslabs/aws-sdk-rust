...
pub(crate) fn de_entity_recognizer_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EntityRecognizerSummary>, aws_smithy_json::deserialize::error::DeserializeError>
