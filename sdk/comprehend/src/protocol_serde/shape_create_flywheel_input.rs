...
pub fn ser_create_flywheel_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_flywheel::CreateFlywheelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
