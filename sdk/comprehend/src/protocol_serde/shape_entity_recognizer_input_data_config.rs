...
pub fn ser_entity_recognizer_input_data_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EntityRecognizerInputDataConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_entity_recognizer_input_data_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EntityRecognizerInputDataConfig>, aws_smithy_json::deserialize::error::DeserializeError>
