...
pub(crate) fn de_endpoint_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EndpointProperties>, aws_smithy_json::deserialize::error::DeserializeError>
