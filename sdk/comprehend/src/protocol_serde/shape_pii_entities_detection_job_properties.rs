            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "OutputDataConfig" => {
                            builder = builder
                                .set_output_data_config(crate::protocol_serde::shape_pii_output_data_config::de_pii_output_data_config(tokens)?);
                        }
                        "RedactionConfig" => {
                            builder = builder.set_redaction_config(crate::protocol_serde::shape_redaction_config::de_redaction_config(tokens)?);
                        }
                        "LanguageCode" => {
