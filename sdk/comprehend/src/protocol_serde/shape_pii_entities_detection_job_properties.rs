                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "OutputDataConfig" => {
                                builder = builder.set_output_data_config(
                                    crate::protocol_serde::shape_pii_output_data_config::de_pii_output_data_config(tokens, _value, depth + 1)?,
                                );
                            }
                            "RedactionConfig" => {
                                builder = builder.set_redaction_config(crate::protocol_serde::shape_redaction_config::de_redaction_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
