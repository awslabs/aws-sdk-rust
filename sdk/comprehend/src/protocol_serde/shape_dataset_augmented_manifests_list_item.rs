...
pub fn ser_dataset_augmented_manifests_list_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DatasetAugmentedManifestsListItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
