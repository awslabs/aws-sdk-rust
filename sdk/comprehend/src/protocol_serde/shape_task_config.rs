                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DocumentClassificationConfig" => {
                            builder = builder.set_document_classification_config(
                                crate::protocol_serde::shape_document_classification_config::de_document_classification_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "EntityRecognitionConfig" => {
                            builder = builder.set_entity_recognition_config(
                                crate::protocol_serde::shape_entity_recognition_config::de_entity_recognition_config(tokens, _value, depth + 1)?,
                            );
                        }
