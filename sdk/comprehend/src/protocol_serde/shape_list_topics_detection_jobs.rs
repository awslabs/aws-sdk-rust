...
pub fn ser_list_topics_detection_jobs_input(input: &crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
