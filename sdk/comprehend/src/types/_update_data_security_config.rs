...
impl UpdateDataSecurityConfig {
    /// Creates a new builder-style object to manufacture [`UpdateDataSecurityConfig`](crate::types::UpdateDataSecurityConfig).
    pub fn builder() -> crate::types::builders::UpdateDataSecurityConfigBuilder {
        crate::types::builders::UpdateDataSecurityConfigBuilder::default()
    }
}

/// A builder for [`UpdateDataSecurityConfig`](crate::types::UpdateDataSecurityConfig).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct UpdateDataSecurityConfigBuilder {
...
impl UpdateDataSecurityConfigBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateDataSecurityConfig`](crate::types::UpdateDataSecurityConfig).
    pub fn build(self) -> crate::types::UpdateDataSecurityConfig {
        crate::types::UpdateDataSecurityConfig {
