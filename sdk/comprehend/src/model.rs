...
pub struct InputDataConfig  {
    ...
    #[doc(hidden)]pub document_reader_config: std::option::Option<crate::model::DocumentReaderConfig>,
}
...
pub struct DocumentReaderConfig  {
    ...
    /// </ul>
    #[doc(hidden)]pub document_read_action: std::option::Option<crate::model::DocumentReadAction>,
    ...
    /// </ul>
    #[doc(hidden)]pub document_read_mode: std::option::Option<crate::model::DocumentReadMode>,
    /// <p>Specifies how the text in an input file should be processed:</p>
    #[doc(hidden)]pub feature_types: std::option::Option<std::vec::Vec<crate::model::DocumentReadFeatureTypes>>,
}
...
pub struct RedactionConfig  {
    ...
    #[doc(hidden)]pub mask_mode: std::option::Option<crate::model::PiiEntitiesDetectionMaskMode>,
    /// <p>A character that replaces each character in the redacted PII entity.</p>
    #[doc(hidden)]pub mask_character: std::option::Option<std::string::String>,
}
...
pub struct PiiEntitiesDetectionJobProperties  {
    ...
    #[doc(hidden)]pub output_data_config: std::option::Option<crate::model::PiiOutputDataConfig>,
    /// <p>Provides configuration parameters for PII entity redaction.</p> 
...
pub struct EntityRecognizerSummary  {
    ...
    #[doc(hidden)]pub number_of_versions: std::option::Option<i32>,
    /// <p> The time that the latest entity recognizer version was submitted for processing.</p>
    #[doc(hidden)]pub latest_version_created_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p> The version name you assigned to the latest entity recognizer version.</p>
    #[doc(hidden)]pub latest_version_name: std::option::Option<std::string::String>,
    /// <p> Provides the status of the latest entity recognizer version.</p>
    #[doc(hidden)]pub latest_version_status: std::option::Option<crate::model::ModelStatus>,
}
...
pub struct EntityRecognizerProperties  {
    ...
    #[doc(hidden)]pub training_start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time that training of the entity recognizer was completed.</p>
    #[doc(hidden)]pub training_end_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub recognizer_metadata: std::option::Option<crate::model::EntityRecognizerMetadata>,
...
pub struct EntityRecognizerMetadata  {
    ...
    #[doc(hidden)]pub number_of_trained_documents: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub number_of_test_documents: std::option::Option<i32>,
    /// <p>Detailed information about the accuracy of an entity recognizer.</p>
    #[doc(hidden)]pub evaluation_metrics: std::option::Option<crate::model::EntityRecognizerEvaluationMetrics>,
    /// <p>Entity types from the metadata of an entity recognizer.</p>
    #[doc(hidden)]pub entity_types: std::option::Option<std::vec::Vec<crate::model::EntityRecognizerMetadataEntityTypesListItem>>,
}
...
impl  std::fmt::Debug for EntityRecognizerMetadata  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("number_of_trained_documents", &self.number_of_trained_documents);
...
pub struct EntityRecognizerMetadataEntityTypesListItem  {
    ...
    #[doc(hidden)]pub evaluation_metrics: std::option::Option<crate::model::EntityTypesEvaluationMetrics>,
    /// <p>Indicates the number of times the given entity type was seen in the training data. </p>
    #[doc(hidden)]pub number_of_train_mentions: std::option::Option<i32>,
}
...
pub struct EntityTypesEvaluationMetrics  {
    ...
    #[doc(hidden)]pub precision: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub recall: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub f1_score: std::option::Option<f64>,
}
...
pub struct EntityRecognizerInputDataConfig  {
    ...
    #[doc(hidden)]pub data_format: std::option::Option<crate::model::EntityRecognizerDataFormat>,
    ...
    #[doc(hidden)]pub entity_types: std::option::Option<std::vec::Vec<crate::model::EntityTypesListItem>>,
    ...
    #[doc(hidden)]pub documents: std::option::Option<crate::model::EntityRecognizerDocuments>,
    /// <p>The S3 location of the CSV file that annotates your training documents.</p>
    #[doc(hidden)]pub annotations: std::option::Option<crate::model::EntityRecognizerAnnotations>,
    /// <p>The S3 location of the CSV file that has the entity list for your custom entity recognizer.</p>
    #[doc(hidden)]pub entity_list: std::option::Option<crate::model::EntityRecognizerEntityList>,
    ...
    #[doc(hidden)]pub augmented_manifests: std::option::Option<std::vec::Vec<crate::model::AugmentedManifestsListItem>>,
}
...
pub struct AugmentedManifestsListItem  {
    ...
    #[doc(hidden)]pub split: std::option::Option<crate::model::Split>,
    ...
    #[doc(hidden)]pub annotation_data_s3_uri: std::option::Option<std::string::String>,
    /// <p>The S3 prefix to the source files (PDFs) that are referred to in the augmented manifest file.</p>
    #[doc(hidden)]pub source_documents_s3_uri: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub document_type: std::option::Option<crate::model::AugmentedManifestsDocumentTypeFormat>,
}
...
pub struct EntityRecognizerAnnotations  {
    ...
    #[doc(hidden)]pub test_s3_uri: std::option::Option<std::string::String>,
}
...
pub struct EndpointProperties  {
    ...
    #[doc(hidden)]pub current_inference_units: std::option::Option<i32>,
...
pub struct DocumentClassifierProperties  {
    ...
    #[doc(hidden)]pub classifier_metadata: std::option::Option<crate::model::ClassifierMetadata>,
    /// <p>The Amazon Resource Name (ARN) of the AWS Identity and Management (IAM) role that grants Amazon Comprehend read access to your input data.</p>
    #[doc(hidden)]pub data_access_role_arn: std::option::Option<std::string::String>,
    /// <p>ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt data on the storage volume attached to the ML compute instance(s) that process the analysis job. The VolumeKmsKeyId can be either of the following formats:</p> 
    /// <ul> 
...
pub struct ClassifierMetadata  {
    ...
    #[doc(hidden)]pub number_of_labels: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub evaluation_metrics: std::option::Option<crate::model::ClassifierEvaluationMetrics>,
}
...
pub struct ClassifierEvaluationMetrics  {
    ...
    #[doc(hidden)]pub accuracy: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub micro_precision: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub micro_recall: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub micro_f1_score: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub hamming_loss: std::option::Option<f64>,
}
...
pub struct DocumentClassifierInputDataConfig  {
    ...
    /// </ul> 
    /// <p>If you don't specify a value, Amazon Comprehend uses <code>COMPREHEND_CSV</code> as the default.</p>
    #[doc(hidden)]pub data_format: std::option::Option<crate::model::DocumentClassifierDataFormat>,
    ...
    #[doc(hidden)]pub label_delimiter: std::option::Option<std::string::String>,
    /// <p>A list of augmented manifest files that provide training data for your custom model. An augmented manifest file is a labeled dataset that is produced by Amazon SageMaker Ground Truth.</p> 
    /// <p>This parameter is required if you set <code>DataFormat</code> to <code>AUGMENTED_MANIFEST</code>.</p>
    #[doc(hidden)]pub augmented_manifests: std::option::Option<std::vec::Vec<crate::model::AugmentedManifestsListItem>>,
}
...
pub struct TargetedSentimentEntity  {
    ...
    #[doc(hidden)]pub descriptive_mention_index: std::option::Option<std::vec::Vec<i32>>,
    ...
    #[doc(hidden)]pub mentions: std::option::Option<std::vec::Vec<crate::model::TargetedSentimentMention>>,
}
...
pub struct TargetedSentimentMention  {
    ...
    #[doc(hidden)]pub group_score: std::option::Option<f32>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::TargetedSentimentEntityType>,
    /// <p>Contains the sentiment and sentiment score for the mention.</p>
    #[doc(hidden)]pub mention_sentiment: std::option::Option<crate::model::MentionSentiment>,
...
pub struct SentimentScore  {
    ...
    #[doc(hidden)]pub positive: std::option::Option<f32>,
    ...
    #[doc(hidden)]pub negative: std::option::Option<f32>,
...
pub struct SyntaxToken  {
    ...
    #[doc(hidden)]pub token_id: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub part_of_speech: std::option::Option<crate::model::PartOfSpeechTag>,
}
impl SyntaxToken {
    /// <p>A unique identifier for a token.</p>
...
pub struct PartOfSpeechTag  {
    ...
    #[doc(hidden)]pub tag: std::option::Option<crate::model::PartOfSpeechTagType>,
...
pub struct PiiEntity  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::PiiEntityType>,
...
pub struct EntityLabel  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::PiiEntityType>,
    /// <p>The level of confidence that Amazon Comprehend has in the accuracy of the detection.</p>
    #[doc(hidden)]pub score: std::option::Option<f32>,
}
impl EntityLabel {
...
pub struct BatchItemError  {
    ...
    #[doc(hidden)]pub index: std::option::Option<i32>,
