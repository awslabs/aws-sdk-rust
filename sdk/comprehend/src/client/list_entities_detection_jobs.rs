...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_entities_detection_jobs::builders::ListEntitiesDetectionJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_entities_detection_jobs::builders::ListEntitiesDetectionJobsFluentBuilder::set_next_token): <p>Identifies the next page of results to return.</p>
