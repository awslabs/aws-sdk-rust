...
impl super::Client {
    ...
    ///   - [`text(impl Into<String>)`](crate::operation::detect_sentiment::builders::DetectSentimentFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::detect_sentiment::builders::DetectSentimentFluentBuilder::set_text):<br>required: **true**<br><p>A UTF-8 text string. The maximum string size is 5 KB.</p><br>
