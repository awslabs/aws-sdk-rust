...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_entities_detection_job::builders::DescribeEntitiesDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_entities_detection_job::builders::DescribeEntitiesDetectionJobFluentBuilder::set_job_id): <p>The identifier that Amazon Comprehend generated for the job. The <code>StartEntitiesDetectionJob</code> operation returns this identifier in its response.</p>
