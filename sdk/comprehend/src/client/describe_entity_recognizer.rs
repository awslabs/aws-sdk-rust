...
impl super::Client {
    ...
    ///   - [`entity_recognizer_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_entity_recognizer::builders::DescribeEntityRecognizerFluentBuilder::entity_recognizer_arn) / [`set_entity_recognizer_arn(Option<String>)`](crate::operation::describe_entity_recognizer::builders::DescribeEntityRecognizerFluentBuilder::set_entity_recognizer_arn): <p>The Amazon Resource Name (ARN) that identifies the entity recognizer.</p>
