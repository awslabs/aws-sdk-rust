...
impl super::Client {
    ...
    ///   - [`dataset_name(impl Into<String>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::dataset_name) / [`set_dataset_name(Option<String>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::set_dataset_name): <p>Name of the dataset.</p>
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::set_description): <p>Description of the dataset.</p>
    ...
    ///   - [`tags(Tag)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::set_tags): <p>Tags for the dataset.</p>
