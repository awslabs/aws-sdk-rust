...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_sentiment_detection_job::builders::StopSentimentDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_sentiment_detection_job::builders::StopSentimentDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the sentiment detection job to stop.</p><br>
