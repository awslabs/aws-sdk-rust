...
impl super::Client {
    ...
    ///   - [`text(impl Into<String>)`](crate::operation::detect_targeted_sentiment::builders::DetectTargetedSentimentFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::detect_targeted_sentiment::builders::DetectTargetedSentimentFluentBuilder::set_text):<br>required: **true**<br><p>A UTF-8 text string. The maximum string length is 5 KB.</p><br>
    ///   - [`language_code(LanguageCode)`](crate::operation::detect_targeted_sentiment::builders::DetectTargetedSentimentFluentBuilder::language_code) / [`set_language_code(Option<LanguageCode>)`](crate::operation::detect_targeted_sentiment::builders::DetectTargetedSentimentFluentBuilder::set_language_code):<br>required: **true**<br><p>The language of the input documents. Currently, English is the only supported language.</p><br>
