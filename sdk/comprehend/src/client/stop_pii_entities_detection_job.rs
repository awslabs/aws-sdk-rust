...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_pii_entities_detection_job::builders::StopPiiEntitiesDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_pii_entities_detection_job::builders::StopPiiEntitiesDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the PII entities detection job to stop.</p><br>
