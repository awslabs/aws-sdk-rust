...
impl super::Client {
    ...
    ///   - [`endpoint_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::endpoint_arn) / [`set_endpoint_arn(Option<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::set_endpoint_arn): <p>The Amazon Resource Number (ARN) of the endpoint being described.</p>
