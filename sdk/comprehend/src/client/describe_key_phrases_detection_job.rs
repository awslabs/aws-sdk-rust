...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_key_phrases_detection_job::builders::DescribeKeyPhrasesDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_key_phrases_detection_job::builders::DescribeKeyPhrasesDetectionJobFluentBuilder::set_job_id): <p>The identifier that Amazon Comprehend generated for the job. The <code>StartKeyPhrasesDetectionJob</code> operation returns this identifier in its response.</p>
