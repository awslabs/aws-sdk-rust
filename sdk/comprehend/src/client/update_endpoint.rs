...
impl super::Client {
    ...
    ///   - [`endpoint_arn(impl Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::endpoint_arn) / [`set_endpoint_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_endpoint_arn):<br>required: **true**<br><p>The Amazon Resource Number (ARN) of the endpoint being updated.</p><br>
    ...
    ///   - [`desired_inference_units(i32)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::desired_inference_units) / [`set_desired_inference_units(Option<i32>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_desired_inference_units):<br>required: **false**<br><p>The desired number of inference units to be used by the model using this endpoint. Each inference unit represents of a throughput of 100 characters per second.</p><br>
    ...
    ///   - [`flywheel_arn(impl Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::flywheel_arn) / [`set_flywheel_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_flywheel_arn):<br>required: **false**<br><p>The Amazon Resource Number (ARN) of the flywheel</p><br>
