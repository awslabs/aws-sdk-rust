...
impl super::Client {
    ...
    ///   - [`endpoint_arn(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::endpoint_arn) / [`set_endpoint_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_endpoint_arn): <p>The Amazon Resource Number (ARN) of the endpoint being updated.</p>
    ///   - [`desired_model_arn(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::desired_model_arn) / [`set_desired_model_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_desired_model_arn): <p>The ARN of the new model to use when updating an existing endpoint.</p>
    ...
    ///   - [`desired_data_access_role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::desired_data_access_role_arn) / [`set_desired_data_access_role_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_desired_data_access_role_arn): <p>Data access role ARN to use in case the new model is encrypted with a customer CMK.</p>
    ///   - [`flywheel_arn(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::flywheel_arn) / [`set_flywheel_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_flywheel_arn): <p>The Amazon Resource Number (ARN) of the flywheel</p>
