...
impl super::Client {
    ...
    ///   - [`flywheel_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_flywheel_iteration::builders::DescribeFlywheelIterationFluentBuilder::flywheel_arn) / [`set_flywheel_arn(Option<String>)`](crate::operation::describe_flywheel_iteration::builders::DescribeFlywheelIterationFluentBuilder::set_flywheel_arn): <p></p>
    ///   - [`flywheel_iteration_id(impl ::std::convert::Into<String>)`](crate::operation::describe_flywheel_iteration::builders::DescribeFlywheelIterationFluentBuilder::flywheel_iteration_id) / [`set_flywheel_iteration_id(Option<String>)`](crate::operation::describe_flywheel_iteration::builders::DescribeFlywheelIterationFluentBuilder::set_flywheel_iteration_id): <p></p>
