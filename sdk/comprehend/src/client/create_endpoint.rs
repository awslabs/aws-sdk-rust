...
impl super::Client {
    ...
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_tags): <p>Tags associated with the endpoint being created. A tag is a key-value pair that adds metadata to the endpoint. For example, a tag with "Sales" as the key might be added to an endpoint to indicate its use by the sales department. </p>
    ///   - [`data_access_role_arn(impl Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::data_access_role_arn) / [`set_data_access_role_arn(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_data_access_role_arn): <p>The Amazon Resource Name (ARN) of the AWS identity and Access Management (IAM) role that grants Amazon Comprehend read access to trained custom models encrypted with a customer managed key (ModelKmsKeyId).</p>
