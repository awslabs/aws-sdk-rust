...
impl super::Client {
    ...
    ///   - [`endpoint_name(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::endpoint_name) / [`set_endpoint_name(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_endpoint_name): <p>This is the descriptive suffix that becomes part of the <code>EndpointArn</code> used for all subsequent requests to this resource. </p>
    ///   - [`model_arn(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::model_arn) / [`set_model_arn(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_model_arn): <p>The Amazon Resource Number (ARN) of the model to which the endpoint will be attached.</p>
    ...
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_client_request_token): <p>An idempotency token provided by the customer. If this token matches a previous endpoint creation request, Amazon Comprehend will not return a <code>ResourceInUseException</code>. </p>
    ...
    ///   - [`data_access_role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::data_access_role_arn) / [`set_data_access_role_arn(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_data_access_role_arn): <p>The Amazon Resource Name (ARN) of the IAM role that grants Amazon Comprehend read access to trained custom models encrypted with a customer managed key (ModelKmsKeyId).</p>
    ///   - [`flywheel_arn(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::flywheel_arn) / [`set_flywheel_arn(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_flywheel_arn): <p>The Amazon Resource Number (ARN) of the flywheel to which the endpoint will be attached.</p>
