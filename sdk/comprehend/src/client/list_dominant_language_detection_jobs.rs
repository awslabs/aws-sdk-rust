...
impl super::Client {
    ...
    ///   - [`filter(DominantLanguageDetectionJobFilter)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::filter) / [`set_filter(Option<DominantLanguageDetectionJobFilter>)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::set_filter):<br>required: **false**<br><p>Filters that jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::set_next_token):<br>required: **false**<br><p>Identifies the next page of results to return.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_dominant_language_detection_jobs::builders::ListDominantLanguageDetectionJobsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in each page. The default is 100.</p><br>
