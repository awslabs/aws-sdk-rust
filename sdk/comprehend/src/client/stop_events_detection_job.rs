...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_events_detection_job::builders::StopEventsDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_events_detection_job::builders::StopEventsDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the events detection job to stop.</p><br>
