...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_dominant_language_detection_job::builders::DescribeDominantLanguageDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_dominant_language_detection_job::builders::DescribeDominantLanguageDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier that Amazon Comprehend generated for the job. The <code>StartDominantLanguageDetectionJob</code> operation returns this identifier in its response.</p><br>
