...
impl super::Client {
    ...
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::detect_syntax::builders::DetectSyntaxFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::detect_syntax::builders::DetectSyntaxFluentBuilder::set_text): <p>A UTF-8 string. The maximum string size is 5 KB.</p>
