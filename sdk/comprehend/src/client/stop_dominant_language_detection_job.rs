...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_dominant_language_detection_job::builders::StopDominantLanguageDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_dominant_language_detection_job::builders::StopDominantLanguageDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the dominant language detection job to stop.</p><br>
