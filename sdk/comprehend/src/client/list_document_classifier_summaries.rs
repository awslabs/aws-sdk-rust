...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_document_classifier_summaries::builders::ListDocumentClassifierSummariesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_document_classifier_summaries::builders::ListDocumentClassifierSummariesFluentBuilder::set_next_token): <p>Identifies the next page of results to return.</p>
