...
impl super::Client {
    ...
    ///   - [`flywheel_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::flywheel_arn) / [`set_flywheel_arn(Option<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::set_flywheel_arn): <p>The Amazon Resource Number (ARN) of the flywheel to update.</p>
    ///   - [`active_model_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::active_model_arn) / [`set_active_model_arn(Option<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::set_active_model_arn): <p>The Amazon Resource Number (ARN) of the active model version.</p>
    ///   - [`data_access_role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::data_access_role_arn) / [`set_data_access_role_arn(Option<String>)`](crate::operation::update_flywheel::builders::UpdateFlywheelFluentBuilder::set_data_access_role_arn): <p>The Amazon Resource Name (ARN) of the IAM role that grants Amazon Comprehend permission to access the flywheel data.</p>
