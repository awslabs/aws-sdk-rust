...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_entities_detection_job::builders::StopEntitiesDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_entities_detection_job::builders::StopEntitiesDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the entities detection job to stop.</p><br>
