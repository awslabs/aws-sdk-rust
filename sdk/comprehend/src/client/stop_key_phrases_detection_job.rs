...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_key_phrases_detection_job::builders::StopKeyPhrasesDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_key_phrases_detection_job::builders::StopKeyPhrasesDetectionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the key phrases detection job to stop.</p><br>
