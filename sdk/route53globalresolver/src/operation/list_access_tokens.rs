    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/tokens/dns-view/{dnsViewId}", dnsViewId = dns_view_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_access_tokens::ListAccessTokensInput,
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.filters {
                    {
                        for (k, v) in inner_2 {
                            for inner_3 in v {
                                if !protected_params.contains(&k.as_str()) {
                                    query.push_kv(&::aws_smithy_http::query::fmt_string(k), &::aws_smithy_http::query::fmt_string(inner_3));
                                }
                            }
                        }
                    }
...
impl ListAccessTokensError {
    ...
    /// Returns `true` if the error kind is `ListAccessTokensError::InternalServerException`.
