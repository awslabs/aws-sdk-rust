    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_access_token::CreateAccessTokenInput = input.downcast_mut().expect("correct type");
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/tokens/{dnsViewId}", dnsViewId = dns_view_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateAccessTokenError {
    ...
    /// Returns `true` if the error kind is `CreateAccessTokenError::InternalServerException`.
