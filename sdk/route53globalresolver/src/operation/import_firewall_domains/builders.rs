...
impl crate::operation::import_firewall_domains::builders::ImportFirewallDomainsInputBuilder {
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::import_firewall_domains::ImportFirewallDomainsOutput,
        crate::operation::import_firewall_domains::ImportFirewallDomainsError,
    > for ImportFirewallDomainsFluentBuilder
{
    fn send(
        self,
...
impl ImportFirewallDomainsFluentBuilder {
    /// Creates a new `ImportFirewallDomainsFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::import_firewall_domains::ImportFirewallDomains::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::import_firewall_domains::ImportFirewallDomains::orchestrate(&runtime_plugins, input).await
    }
