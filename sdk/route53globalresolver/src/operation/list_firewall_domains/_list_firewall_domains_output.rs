...
impl ListFirewallDomainsOutputBuilder {
    ...
    /// - [`domains`](crate::operation::list_firewall_domains::builders::ListFirewallDomainsOutputBuilder::domains)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_firewall_domains::ListFirewallDomainsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_firewall_domains::ListFirewallDomainsOutput {
            next_token: self.next_token,
            domains: self.domains.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domains",
                    "domains was not specified but it is required when building ListFirewallDomainsOutput",
                )
            })?,
