                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::delete_access_token::DeleteAccessTokenError::unhandled(
...
) -> std::result::Result<crate::operation::delete_access_token::DeleteAccessTokenOutput, crate::operation::delete_access_token::DeleteAccessTokenError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_access_token::de_delete_access_token(_response_body, output)
            .map_err(crate::operation::delete_access_token::DeleteAccessTokenError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::delete_access_token_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::delete_access_token::DeleteAccessTokenError::unhandled)?
    })
}

pub(crate) fn de_delete_access_token(
    _value: &[u8],
