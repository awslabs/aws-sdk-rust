...
) -> std::result::Result<crate::operation::create_access_token::CreateAccessTokenOutput, crate::operation::create_access_token::CreateAccessTokenError>
{
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::create_access_token::CreateAccessTokenError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::create_access_token::CreateAccessTokenError::unhandled(
