...
pub fn ser_update_firewall_rule_input_input(
    ...
    if let Some(var_7) = &input.confidence_threshold {
        object.key("confidenceThreshold").string(var_7.as_str());
    }
    if let Some(var_8) = &input.description {
        object.key("description").string(var_8.as_str());
    }
    if let Some(var_9) = &input.dns_advanced_protection {
        object.key("dnsAdvancedProtection").string(var_9.as_str());
    }
