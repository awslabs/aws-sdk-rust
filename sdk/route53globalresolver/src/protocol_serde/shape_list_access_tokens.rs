...
pub fn de_list_access_tokens_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
) -> std::result::Result<crate::operation::list_access_tokens::ListAccessTokensOutput, crate::operation::list_access_tokens::ListAccessTokensError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_access_tokens::ListAccessTokensError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_access_tokens::ListAccessTokensError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::list_access_tokens::ListAccessTokensError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_access_tokens::ListAccessTokensError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_access_tokens_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_access_tokens::builders::ListAccessTokensOutputBuilder::default();
        output = crate::protocol_serde::shape_list_access_tokens::de_list_access_tokens(_response_body, output)
            .map_err(crate::operation::list_access_tokens::ListAccessTokensError::unhandled)?;
...
pub(crate) fn de_list_access_tokens(
    _value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "accessTokens" => {
                    builder = builder.set_access_tokens(crate::protocol_serde::shape_access_tokens::de_access_tokens(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
