...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::import_firewall_domains::ImportFirewallDomainsError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::import_firewall_domains::ImportFirewallDomainsError::unhandled(
        ...
        "ServiceQuotaExceededException" => crate::operation::import_firewall_domains::ImportFirewallDomainsError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::import_firewall_domains_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::import_firewall_domains::ImportFirewallDomainsError::unhandled)?
    })
}
