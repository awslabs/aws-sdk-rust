...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_tag_option::builders::DeleteTagOptionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_tag_option::builders::DeleteTagOptionFluentBuilder::set_id):<br>required: **true**<br><p>The TagOption identifier.</p><br>
