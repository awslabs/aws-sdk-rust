...
impl super::Client {
    ...
    ///   - [`accept_language(impl Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
