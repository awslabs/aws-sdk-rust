...
impl super::Client {
    ...
    ///   - [`accept_language(impl ::std::convert::Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
    ///   - [`portfolio_id(impl ::std::convert::Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::portfolio_id) / [`set_portfolio_id(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_portfolio_id): <p>The unique identifier of the portfolio for which the share will be updated.</p>
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_account_id): <p>The Amazon Web Services account Id of the recipient account. This field is required when updating an external account to account type share.</p>
