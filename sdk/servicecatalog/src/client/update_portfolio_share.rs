...
impl super::Client {
    ...
    ///   - [`accept_language(impl Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>en</code> - English (default)</p> </li>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
    ///   - [`portfolio_id(impl Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::portfolio_id) / [`set_portfolio_id(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_portfolio_id): <p>The unique identifier of the portfolio for which the share will be updated.</p>
    ///   - [`account_id(impl Into<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_account_id): <p>The Amazon Web Services account Id of the recipient account. This field is required when updating an external account to account type share.</p>
    ///   - [`organization_node(OrganizationNode)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::organization_node) / [`set_organization_node(Option<OrganizationNode>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_organization_node): <p>Information about the organization node.</p>
    ///   - [`share_tag_options(bool)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::share_tag_options) / [`set_share_tag_options(Option<bool>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_share_tag_options): <p>Enables or disables <code>TagOptions</code> sharing for the portfolio share. If this field is not provided, the current state of TagOptions sharing on the portfolio share will not be modified.</p>
    ///   - [`share_principals(bool)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::share_principals) / [`set_share_principals(Option<bool>)`](crate::operation::update_portfolio_share::builders::UpdatePortfolioShareFluentBuilder::set_share_principals): <p>A flag to enables or disables <code>Principals</code> sharing in the portfolio. If this field is not provided, the current state of the <code>Principals</code> sharing on the portfolio share will not be modified. </p>
