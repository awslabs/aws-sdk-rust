...
impl super::Client  {
    ...
    pub fn batch_disassociate_service_action_from_provisioning_artifact(&self) -> crate::client::fluent_builders::BatchDisassociateServiceActionFromProvisioningArtifact {
                                crate::client::fluent_builders::BatchDisassociateServiceActionFromProvisioningArtifact::new(self.handle.clone())
                            }
}
