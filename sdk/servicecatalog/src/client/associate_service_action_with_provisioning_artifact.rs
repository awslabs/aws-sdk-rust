...
impl super::Client  {
    ...
    pub fn associate_service_action_with_provisioning_artifact(&self) -> crate::client::fluent_builders::AssociateServiceActionWithProvisioningArtifact {
                                crate::client::fluent_builders::AssociateServiceActionWithProvisioningArtifact::new(self.handle.clone())
                            }
}
