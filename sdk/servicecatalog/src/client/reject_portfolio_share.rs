...
impl super::Client {
    ...
    ///   - [`accept_language(impl ::std::convert::Into<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
    ///   - [`portfolio_id(impl ::std::convert::Into<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::portfolio_id) / [`set_portfolio_id(Option<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::set_portfolio_id): <p>The portfolio identifier.</p>
