...
impl super::Client {
    ...
    ///   - [`accept_language(impl Into<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::reject_portfolio_share::builders::RejectPortfolioShareFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
