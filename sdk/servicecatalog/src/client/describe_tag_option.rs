...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_tag_option::builders::DescribeTagOptionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_tag_option::builders::DescribeTagOptionFluentBuilder::set_id):<br>required: **true**<br><p>The TagOption identifier.</p><br>
