...
impl super::Client  {
    ...
    pub fn list_service_actions_for_provisioning_artifact(&self) -> crate::client::fluent_builders::ListServiceActionsForProvisioningArtifact {
                                crate::client::fluent_builders::ListServiceActionsForProvisioningArtifact::new(self.handle.clone())
                            }
}
