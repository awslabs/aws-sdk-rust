...
impl TerminateProvisionedProductInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::terminate_provisioned_product::TerminateProvisionedProductInput, ::aws_smithy_types::error::operation::BuildError> {
