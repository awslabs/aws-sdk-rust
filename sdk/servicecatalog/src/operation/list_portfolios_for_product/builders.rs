...
pub use crate::operation::list_portfolios_for_product::_list_portfolios_for_product_output::ListPortfoliosForProductOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_portfolios_for_product::ListPortfoliosForProductOutput,
                    crate::operation::list_portfolios_for_product::ListPortfoliosForProductError,
                > for ListPortfoliosForProductFluentBuilder
            {
                fn send(
                    self,
...
impl ListPortfoliosForProductFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_portfolios_for_product::ListPortfoliosForProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_portfolios_for_product::ListPortfoliosForProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_portfolios_for_product::ListPortfoliosForProduct::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_portfolios_for_product::ListPortfoliosForProductOutput, crate::operation::list_portfolios_for_product::ListPortfoliosForProductError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_portfolios_for_product::paginator::ListPortfoliosForProductPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
