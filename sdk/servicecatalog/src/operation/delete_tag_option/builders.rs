...
impl DeleteTagOptionFluentBuilder  {
    /// Creates a new `DeleteTagOption`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_tag_option::DeleteTagOptionOutput, aws_smithy_http::result::SdkError<crate::operation::delete_tag_option::DeleteTagOptionError>>
                     {
