...
impl GetAWSOrganizationsAccessStatus {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_aws_organizations_access_status::GetAwsOrganizationsAccessStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_aws_organizations_access_status::GetAwsOrganizationsAccessStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAWSOrganizationsAccessStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAWSOrganizationsAccessStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAWSOrganizationsAccessStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAWSOrganizationsAccessStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAWSOrganizationsAccessStatus")
...
.with_interceptor(GetAWSOrganizationsAccessStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError>::new());
...
#[derive(Debug)]
            struct GetAWSOrganizationsAccessStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAWSOrganizationsAccessStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_aws_organizations_access_status::de_get_aws_organizations_access_status_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetAWSOrganizationsAccessStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAWSOrganizationsAccessStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_aws_organizations_access_status::GetAwsOrganizationsAccessStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_aws_organizations_access_status::GetAwsOrganizationsAccessStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_aws_organizations_access_status::ser_get_aws_organizations_access_status_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct GetAWSOrganizationsAccessStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAWSOrganizationsAccessStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAWSOrganizationsAccessStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAwsOrganizationsAccessStatusInput>()
                        .ok_or("failed to downcast to GetAwsOrganizationsAccessStatusInput")?;
...
pub enum GetAWSOrganizationsAccessStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAWSOrganizationsAccessStatusError) for what information is available for the error.")]
...
impl GetAWSOrganizationsAccessStatusError {
    /// Creates the `GetAWSOrganizationsAccessStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAWSOrganizationsAccessStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetAWSOrganizationsAccessStatusError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAWSOrganizationsAccessStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError {
...
mod _get_aws_organizations_access_status_output;
