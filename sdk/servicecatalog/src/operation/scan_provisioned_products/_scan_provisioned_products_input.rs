...
impl ScanProvisionedProductsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::scan_provisioned_products::ScanProvisionedProductsInput, ::aws_smithy_types::error::operation::BuildError> {
