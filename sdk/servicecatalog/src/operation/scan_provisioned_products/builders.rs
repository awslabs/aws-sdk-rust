...
impl ScanProvisionedProductsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::scan_provisioned_products::ScanProvisionedProductsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::scan_provisioned_products::ScanProvisionedProductsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::scan_provisioned_products::ScanProvisionedProductsOutput, crate::operation::scan_provisioned_products::ScanProvisionedProductsError, Self> {
