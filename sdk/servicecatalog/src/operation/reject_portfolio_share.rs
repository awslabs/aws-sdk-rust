...
impl RejectPortfolioShareInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reject_portfolio_share::RejectPortfolioShare,
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectPortfolioShare {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_portfolio_share::de_reject_portfolio_share_http_response_with_props(status, headers, body)
        }
    }
}
