...
/// Orchestration and serialization glue logic for `RejectPortfolioShare`.
...
impl RejectPortfolioShare {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reject_portfolio_share::RejectPortfolioShareInput,
                    ) -> ::std::result::Result<crate::operation::reject_portfolio_share::RejectPortfolioShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_portfolio_share::RejectPortfolioShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reject_portfolio_share::RejectPortfolioShareError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reject_portfolio_share::RejectPortfolioShareOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectPortfolioShare {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RejectPortfolioShare");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RejectPortfolioShareRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RejectPortfolioShareResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectPortfolioShare")
...
.with_interceptor(RejectPortfolioShareEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reject_portfolio_share::RejectPortfolioShareError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reject_portfolio_share::RejectPortfolioShareError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reject_portfolio_share::RejectPortfolioShareError>::new());
...
#[derive(Debug)]
            struct RejectPortfolioShareResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectPortfolioShareResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reject_portfolio_share::de_reject_portfolio_share_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RejectPortfolioShareRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectPortfolioShareRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reject_portfolio_share::RejectPortfolioShareInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reject_portfolio_share::RejectPortfolioShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reject_portfolio_share::ser_reject_portfolio_share_input(&input)?);
...
#[derive(Debug)]
            struct RejectPortfolioShareEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectPortfolioShareEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RejectPortfolioShareEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RejectPortfolioShareInput>()
                        .ok_or("failed to downcast to RejectPortfolioShareInput")?;
...
pub enum RejectPortfolioShareError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RejectPortfolioShareError) for what information is available for the error.")]
...
impl RejectPortfolioShareError {
    /// Creates the `RejectPortfolioShareError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RejectPortfolioShareError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RejectPortfolioShareError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reject_portfolio_share::RejectPortfolioShareError {
...
mod _reject_portfolio_share_output;
