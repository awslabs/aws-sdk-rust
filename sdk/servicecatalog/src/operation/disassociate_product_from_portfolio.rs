...
impl DisassociateProductFromPortfolio {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateProductFromPortfolio {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateProductFromPortfolio");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateProductFromPortfolioRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateProductFromPortfolioResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateProductFromPortfolio")
...
.with_interceptor(DisassociateProductFromPortfolioEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError>::new());
...
#[derive(Debug)]
            struct DisassociateProductFromPortfolioResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateProductFromPortfolioResponseDeserializer {
...
#[derive(Debug)]
            struct DisassociateProductFromPortfolioRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateProductFromPortfolioRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_product_from_portfolio::ser_disassociate_product_from_portfolio_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateProductFromPortfolioEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateProductFromPortfolioEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateProductFromPortfolioEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateProductFromPortfolioInput>()
                        .ok_or("failed to downcast to DisassociateProductFromPortfolioInput")?;
...
pub enum DisassociateProductFromPortfolioError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateProductFromPortfolioError) for what information is available for the error.")]
...
impl DisassociateProductFromPortfolioError {
    /// Creates the `DisassociateProductFromPortfolioError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateProductFromPortfolioError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateProductFromPortfolioError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateProductFromPortfolioError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_product_from_portfolio::DisassociateProductFromPortfolioError {
...
mod _disassociate_product_from_portfolio_output;
