...
impl DescribeProvisioningParametersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_provisioning_parameters::DescribeProvisioningParameters::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProvisioningParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_provisioning_parameters::de_describe_provisioning_parameters_http_response_with_props(
                status, headers, body,
            )
        }
    }
