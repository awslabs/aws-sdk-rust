...
impl DescribeCopyProductStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_copy_product_status::DescribeCopyProductStatusInput, ::aws_smithy_types::error::operation::BuildError> {
