...
impl DescribeCopyProductStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_copy_product_status::DescribeCopyProductStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_copy_product_status::DescribeCopyProductStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_copy_product_status::DescribeCopyProductStatusOutput, crate::operation::describe_copy_product_status::DescribeCopyProductStatusError, Self> {
