...
impl crate::operation::describe_portfolio_share_status::builders::DescribePortfolioShareStatusInputBuilder {
...
impl DescribePortfolioShareStatusFluentBuilder {
    /// Creates a new `DescribePortfolioShareStatusFluentBuilder`.
