...
impl DescribeConstraintInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_constraint::ser_describe_constraint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConstraint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_constraint::de_describe_constraint_http_response_with_props(status, headers, body)
        }
    }
}
