...
impl GetProvisionedProductOutputsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_provisioned_product_outputs::GetProvisionedProductOutputs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProvisionedProductOutputs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_provisioned_product_outputs::de_get_provisioned_product_outputs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetProvisionedProductOutputsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_provisioned_product_outputs::GetProvisionedProductOutputsError
{
