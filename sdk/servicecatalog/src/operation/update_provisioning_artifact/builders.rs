...
impl UpdateProvisioningArtifactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_provisioning_artifact::UpdateProvisioningArtifactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_provisioning_artifact::UpdateProvisioningArtifactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_provisioning_artifact::UpdateProvisioningArtifactOutput, crate::operation::update_provisioning_artifact::UpdateProvisioningArtifactError, Self> {
