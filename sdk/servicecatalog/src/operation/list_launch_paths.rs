...
impl ListLaunchPathsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_launch_paths::ListLaunchPaths, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_launch_paths::ser_list_launch_paths_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLaunchPaths {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_launch_paths::de_list_launch_paths_http_response_with_props(status, headers, body)
        }
    }
}
