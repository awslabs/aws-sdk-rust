...
impl DisassociatePrincipalFromPortfolioInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolioOutput, ::aws_smithy_http::result::SdkError<crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolioError, ::aws_smithy_http::operation::Response>>
...
impl DisassociatePrincipalFromPortfolioFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolioOutput, ::aws_smithy_http::result::SdkError<crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolioError>>
                         {
        let op = self
            .inner
            .build()
