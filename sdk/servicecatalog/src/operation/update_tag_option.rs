...
impl UpdateTagOptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_tag_option::UpdateTagOption, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_tag_option::ser_update_tag_option_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTagOption {
    type Output =
        ::std::result::Result<crate::operation::update_tag_option::UpdateTagOptionOutput, crate::operation::update_tag_option::UpdateTagOptionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_tag_option::de_update_tag_option_http_response_with_props(status, headers, body)
        }
    }
}
