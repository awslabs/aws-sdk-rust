...
impl UpdateTagOptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_tag_option::UpdateTagOption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTagOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_tag_option::de_update_tag_option_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_tag_option::UpdateTagOptionError
{
