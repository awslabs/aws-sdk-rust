...
impl UpdateProvisionedProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_provisioned_product::UpdateProvisionedProduct,
    ...
    > {
        ...
        if self.update_token.is_none() {
            self.update_token = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProvisionedProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_provisioned_product::de_update_provisioned_product_http_response_with_props(status, headers, body)
        }
    }
}
