...
impl UpdateProvisionedProduct {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_provisioned_product::UpdateProvisionedProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_provisioned_product::UpdateProvisionedProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_provisioned_product::UpdateProvisionedProductError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_provisioned_product::UpdateProvisionedProductOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_provisioned_product::UpdateProvisionedProductInput = input.downcast_mut().expect("correct type");
                                    if input.update_token.is_none() {
                                        input.update_token = ::std::option::Option::Some(token_provider.make_idempotency_token());
                                    }
                                }))
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateProvisionedProduct {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateProvisionedProduct");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateProvisionedProductRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateProvisionedProductResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateProvisionedProduct")
...
.with_interceptor(UpdateProvisionedProductEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_provisioned_product::UpdateProvisionedProductError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_provisioned_product::UpdateProvisionedProductError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_provisioned_product::UpdateProvisionedProductError>::new());
...
#[derive(Debug)]
            struct UpdateProvisionedProductResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateProvisionedProductResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_provisioned_product::de_update_provisioned_product_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_provisioned_product::de_update_provisioned_product_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateProvisionedProductRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateProvisionedProductRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_provisioned_product::UpdateProvisionedProductInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_provisioned_product::UpdateProvisionedProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_provisioned_product::ser_update_provisioned_product_input(&input)?);
...
#[derive(Debug)]
            struct UpdateProvisionedProductEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateProvisionedProductEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateProvisionedProductEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateProvisionedProductInput>()
                        .ok_or("failed to downcast to UpdateProvisionedProductInput")?;
...
pub enum UpdateProvisionedProductError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateProvisionedProductError) for what information is available for the error.")]
...
impl UpdateProvisionedProductError {
    /// Creates the `UpdateProvisionedProductError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateProvisionedProductError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateProvisionedProductError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_provisioned_product::UpdateProvisionedProductError {
...
mod _update_provisioned_product_output;
