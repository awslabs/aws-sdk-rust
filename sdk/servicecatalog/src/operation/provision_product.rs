...
impl ProvisionProduct {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::provision_product::ProvisionProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::provision_product::ProvisionProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::provision_product::ProvisionProductError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::provision_product::ProvisionProductOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::provision_product::ProvisionProductInput = input.downcast_mut().expect("correct type");
                                    if input.provision_token.is_none() {
                                        input.provision_token = ::std::option::Option::Some(token_provider.make_idempotency_token());
                                    }
                                }))
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ProvisionProduct {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ProvisionProduct");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ProvisionProductRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ProvisionProductResponseDeserializer));
...
.with_interceptor(ProvisionProductEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::provision_product::ProvisionProductError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::provision_product::ProvisionProductError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::provision_product::ProvisionProductError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_provision_product::de_provision_product_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_provision_product::de_provision_product_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ProvisionProductRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ProvisionProductRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::provision_product::ProvisionProductInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::provision_product::ProvisionProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_provision_product::ser_provision_product_input(&input)?);
...
#[derive(Debug)]
            struct ProvisionProductEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ProvisionProductEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ProvisionProductEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ProvisionProductInput>()
                        .ok_or("failed to downcast to ProvisionProductInput")?;
...
pub enum ProvisionProductError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ProvisionProductError) for what information is available for the error.")]
...
impl ProvisionProductError {
    /// Creates the `ProvisionProductError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ProvisionProductError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ProvisionProductError {
...
impl ::aws_types::request_id::RequestId for crate::operation::provision_product::ProvisionProductError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::provision_product::_provision_product_output::ProvisionProductOutput;

pub use crate::operation::provision_product::_provision_product_input::ProvisionProductInput;

mod _provision_product_input;

mod _provision_product_output;
