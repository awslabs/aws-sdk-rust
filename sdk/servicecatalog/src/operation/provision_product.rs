...
impl ProvisionProductInput {
    ...
    > {
        ...
        if self.provision_token.is_none() {
            self.provision_token = ::std::option::Option::Some(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::provision_product::ProvisionProduct::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ProvisionProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_provision_product::de_provision_product_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::provision_product::ProvisionProductError
{
