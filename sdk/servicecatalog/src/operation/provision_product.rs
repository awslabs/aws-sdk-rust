...
impl ProvisionProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::provision_product::ProvisionProduct, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        if self.provision_token.is_none() {
            self.provision_token = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_provision_product::ser_provision_product_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ProvisionProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_provision_product::de_provision_product_http_response_with_props(status, headers, body)
        }
    }
}
