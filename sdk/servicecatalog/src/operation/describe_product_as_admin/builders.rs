...
impl DescribeProductAsAdminFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_product_as_admin::DescribeProductAsAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_product_as_admin::DescribeProductAsAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_product_as_admin::DescribeProductAsAdminOutput, crate::operation::describe_product_as_admin::DescribeProductAsAdminError, Self> {
