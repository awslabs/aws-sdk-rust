...
impl crate::operation::list_accepted_portfolio_shares::builders::ListAcceptedPortfolioSharesInputBuilder {
...
impl ListAcceptedPortfolioSharesFluentBuilder {
    /// Creates a new `ListAcceptedPortfolioSharesFluentBuilder`.
