...
impl UpdateConstraintInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_constraint::UpdateConstraint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_constraint::ser_update_constraint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConstraint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_constraint::de_update_constraint_http_response_with_props(status, headers, body)
        }
    }
}
