...
impl AssociateTagOptionWithResource {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceInput,
                    ) -> ::std::result::Result<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateTagOptionWithResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateTagOptionWithResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateTagOptionWithResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateTagOptionWithResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateTagOptionWithResource")
...
.with_interceptor(AssociateTagOptionWithResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError>::new());
...
#[derive(Debug)]
            struct AssociateTagOptionWithResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateTagOptionWithResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_tag_option_with_resource::de_associate_tag_option_with_resource_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_tag_option_with_resource::de_associate_tag_option_with_resource_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateTagOptionWithResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateTagOptionWithResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_tag_option_with_resource::ser_associate_tag_option_with_resource_input(&input)?);
...
#[derive(Debug)]
            struct AssociateTagOptionWithResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateTagOptionWithResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateTagOptionWithResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateTagOptionWithResourceInput>()
                        .ok_or("failed to downcast to AssociateTagOptionWithResourceInput")?;
...
pub enum AssociateTagOptionWithResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateTagOptionWithResourceError) for what information is available for the error.")]
...
impl AssociateTagOptionWithResourceError {
    /// Creates the `AssociateTagOptionWithResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateTagOptionWithResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateTagOptionWithResourceError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateTagOptionWithResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResourceError {
...
mod _associate_tag_option_with_resource_output;
