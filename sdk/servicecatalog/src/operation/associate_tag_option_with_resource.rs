...
impl AssociateTagOptionWithResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_tag_option_with_resource::AssociateTagOptionWithResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateTagOptionWithResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_tag_option_with_resource::de_associate_tag_option_with_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
