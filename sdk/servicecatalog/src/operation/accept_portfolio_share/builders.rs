...
impl AcceptPortfolioShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::accept_portfolio_share::AcceptPortfolioShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_portfolio_share::AcceptPortfolioShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::accept_portfolio_share::AcceptPortfolioShareOutput, crate::operation::accept_portfolio_share::AcceptPortfolioShareError, Self> {
