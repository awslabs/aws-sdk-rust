...
impl ListPortfoliosInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_portfolios::ListPortfolios, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_portfolios::ser_list_portfolios_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPortfolios {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_portfolios::de_list_portfolios_http_response_with_props(status, headers, body)
        }
    }
}
