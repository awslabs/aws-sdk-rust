    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateTagOptionFromResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateTagOptionFromResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateTagOptionFromResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateTagOptionFromResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateTagOptionFromResource")
...
.with_interceptor(DisassociateTagOptionFromResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceError>::new());
...
#[derive(Debug)]
            struct DisassociateTagOptionFromResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateTagOptionFromResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_tag_option_from_resource::de_disassociate_tag_option_from_resource_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_tag_option_from_resource::de_disassociate_tag_option_from_resource_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateTagOptionFromResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateTagOptionFromResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_tag_option_from_resource::ser_disassociate_tag_option_from_resource_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateTagOptionFromResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateTagOptionFromResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateTagOptionFromResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateTagOptionFromResourceInput>()
                        .ok_or("failed to downcast to DisassociateTagOptionFromResourceInput")?;
...
pub enum DisassociateTagOptionFromResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateTagOptionFromResourceError) for what information is available for the error.")]
...
impl DisassociateTagOptionFromResourceError {
    /// Creates the `DisassociateTagOptionFromResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateTagOptionFromResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateTagOptionFromResourceError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateTagOptionFromResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_tag_option_from_resource::DisassociateTagOptionFromResourceError {
...
mod _disassociate_tag_option_from_resource_output;
