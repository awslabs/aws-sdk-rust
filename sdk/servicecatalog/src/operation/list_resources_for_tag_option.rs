...
impl ListResourcesForTagOptionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resources_for_tag_option::ListResourcesForTagOption::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourcesForTagOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resources_for_tag_option::de_list_resources_for_tag_option_http_response_with_props(
                status, headers, body,
            )
        }
    }
