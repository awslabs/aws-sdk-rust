...
impl ListOrganizationPortfolioAccessInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOrganizationPortfolioAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_organization_portfolio_access::de_list_organization_portfolio_access_http_response_with_props(
                status, headers, body,
            )
        }
    }
