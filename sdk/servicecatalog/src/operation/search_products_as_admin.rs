...
/// Orchestration and serialization glue logic for `SearchProductsAsAdmin`.
...
impl SearchProductsAsAdmin {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::search_products_as_admin::SearchProductsAsAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_products_as_admin::SearchProductsAsAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_products_as_admin::SearchProductsAsAdminError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_products_as_admin::SearchProductsAsAdminOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchProductsAsAdmin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchProductsAsAdmin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchProductsAsAdminRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchProductsAsAdminResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchProductsAsAdmin")
...
.with_interceptor(SearchProductsAsAdminEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_products_as_admin::SearchProductsAsAdminError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_products_as_admin::SearchProductsAsAdminError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_products_as_admin::SearchProductsAsAdminError>::new());
...
#[derive(Debug)]
            struct SearchProductsAsAdminResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchProductsAsAdminResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_products_as_admin::de_search_products_as_admin_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SearchProductsAsAdminRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchProductsAsAdminRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_products_as_admin::SearchProductsAsAdminInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_products_as_admin::SearchProductsAsAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_products_as_admin::ser_search_products_as_admin_input(&input)?);
...
#[derive(Debug)]
            struct SearchProductsAsAdminEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchProductsAsAdminEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchProductsAsAdminEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchProductsAsAdminInput>()
                        .ok_or("failed to downcast to SearchProductsAsAdminInput")?;
...
pub enum SearchProductsAsAdminError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchProductsAsAdminError) for what information is available for the error.")]
...
impl SearchProductsAsAdminError {
    /// Creates the `SearchProductsAsAdminError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchProductsAsAdminError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchProductsAsAdminError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_products_as_admin::SearchProductsAsAdminError {
...
mod _search_products_as_admin_output;
