...
impl DescribeProvisionedProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_provisioned_product::DescribeProvisionedProduct,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_provisioned_product::DescribeProvisionedProduct::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProvisionedProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_provisioned_product::de_describe_provisioned_product_http_response_with_props(status, headers, body)
        }
    }
}
