...
/// Orchestration and serialization glue logic for `DescribeProvisionedProduct`.
...
impl DescribeProvisionedProduct {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_provisioned_product::DescribeProvisionedProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_provisioned_product::DescribeProvisionedProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_provisioned_product::DescribeProvisionedProductError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_provisioned_product::DescribeProvisionedProductOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeProvisionedProduct {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeProvisionedProduct");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeProvisionedProductRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeProvisionedProductResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeProvisionedProduct")
...
.with_interceptor(DescribeProvisionedProductEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_provisioned_product::DescribeProvisionedProductError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_provisioned_product::DescribeProvisionedProductError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_provisioned_product::DescribeProvisionedProductError>::new());
...
#[derive(Debug)]
            struct DescribeProvisionedProductResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeProvisionedProductResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_provisioned_product::de_describe_provisioned_product_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeProvisionedProductRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeProvisionedProductRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_provisioned_product::DescribeProvisionedProductInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_provisioned_product::DescribeProvisionedProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_provisioned_product::ser_describe_provisioned_product_input(&input)?);
...
#[derive(Debug)]
            struct DescribeProvisionedProductEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeProvisionedProductEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeProvisionedProductEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeProvisionedProductInput>()
                        .ok_or("failed to downcast to DescribeProvisionedProductInput")?;
...
pub enum DescribeProvisionedProductError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeProvisionedProductError) for what information is available for the error.")]
...
impl DescribeProvisionedProductError {
    /// Creates the `DescribeProvisionedProductError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeProvisionedProductError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeProvisionedProductError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_provisioned_product::DescribeProvisionedProductError {
...
mod _describe_provisioned_product_output;
