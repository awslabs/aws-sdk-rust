...
impl DeleteProvisioningArtifactInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifact::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProvisioningArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_provisioning_artifact::de_delete_provisioning_artifact_http_response_with_props(status, headers, body)
        }
    }
}
