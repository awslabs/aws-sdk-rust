...
impl AssociateProductWithPortfolioInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_product_with_portfolio::AssociateProductWithPortfolio::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateProductWithPortfolio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_product_with_portfolio::de_associate_product_with_portfolio_http_response_with_props(
                status, headers, body,
            )
        }
    }
