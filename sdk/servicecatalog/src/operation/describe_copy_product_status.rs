...
impl DescribeCopyProductStatusInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_copy_product_status::DescribeCopyProductStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCopyProductStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_copy_product_status::de_describe_copy_product_status_http_response_with_props(status, headers, body)
        }
    }
}
