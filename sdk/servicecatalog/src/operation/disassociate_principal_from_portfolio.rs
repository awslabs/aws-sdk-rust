...
impl DisassociatePrincipalFromPortfolioInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolio::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociatePrincipalFromPortfolio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_principal_from_portfolio::de_disassociate_principal_from_portfolio_http_response_with_props(
                status, headers, body,
            )
        }
    }
