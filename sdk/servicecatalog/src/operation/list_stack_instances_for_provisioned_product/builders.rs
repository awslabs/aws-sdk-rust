...
impl ListStackInstancesForProvisionedProductFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProduct::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProduct::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProductOutput, crate::operation::list_stack_instances_for_provisioned_product::ListStackInstancesForProvisionedProductError, Self> {
