...
/// Orchestration and serialization glue logic for `SearchProvisionedProducts`.
...
impl SearchProvisionedProducts {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::search_provisioned_products::SearchProvisionedProductsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_provisioned_products::SearchProvisionedProductsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_provisioned_products::SearchProvisionedProductsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_provisioned_products::SearchProvisionedProductsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchProvisionedProducts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchProvisionedProducts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchProvisionedProductsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchProvisionedProductsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchProvisionedProducts")
...
.with_interceptor(SearchProvisionedProductsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_provisioned_products::SearchProvisionedProductsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_provisioned_products::SearchProvisionedProductsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_provisioned_products::SearchProvisionedProductsError>::new());
...
#[derive(Debug)]
            struct SearchProvisionedProductsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchProvisionedProductsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_provisioned_products::de_search_provisioned_products_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SearchProvisionedProductsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchProvisionedProductsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_provisioned_products::SearchProvisionedProductsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_provisioned_products::SearchProvisionedProductsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_provisioned_products::ser_search_provisioned_products_input(&input)?);
...
#[derive(Debug)]
            struct SearchProvisionedProductsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchProvisionedProductsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchProvisionedProductsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchProvisionedProductsInput>()
                        .ok_or("failed to downcast to SearchProvisionedProductsInput")?;
...
pub enum SearchProvisionedProductsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchProvisionedProductsError) for what information is available for the error.")]
...
impl SearchProvisionedProductsError {
    /// Creates the `SearchProvisionedProductsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchProvisionedProductsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchProvisionedProductsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_provisioned_products::SearchProvisionedProductsError {
...
mod _search_provisioned_products_output;
