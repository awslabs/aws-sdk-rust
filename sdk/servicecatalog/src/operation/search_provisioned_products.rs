...
impl SearchProvisionedProductsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_provisioned_products::SearchProvisionedProducts::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchProvisionedProducts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_provisioned_products::de_search_provisioned_products_http_response_with_props(status, headers, body)
        }
    }
}
