...
impl ListTagOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_tag_options::ListTagOptions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tag_options::ser_list_tag_options_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTagOptions {
    type Output =
        ::std::result::Result<crate::operation::list_tag_options::ListTagOptionsOutput, crate::operation::list_tag_options::ListTagOptionsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tag_options::de_list_tag_options_http_response_with_props(status, headers, body)
        }
    }
}
