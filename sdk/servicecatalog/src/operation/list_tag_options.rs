...
impl ListTagOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_tag_options::ListTagOptions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tag_options::ListTagOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTagOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_tag_options::de_list_tag_options_http_error(
                status, headers, body,
            )
        } else {
