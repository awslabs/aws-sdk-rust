...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for BatchAssociateServiceActionWithProvisioningArtifactResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for BatchAssociateServiceActionWithProvisioningArtifactRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_associate_service_action_with_provisioning_artifact::ser_batch_associate_service_action_with_provisioning_artifact_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchAssociateServiceActionWithProvisioningArtifactEndpointParamsInterceptor {
