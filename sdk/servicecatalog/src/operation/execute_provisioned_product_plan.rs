...
impl ExecuteProvisionedProductPlan {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ExecuteProvisionedProductPlan",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExecuteProvisionedProductPlan {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ExecuteProvisionedProductPlanRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ExecuteProvisionedProductPlanResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ExecuteProvisionedProductPlan")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteProvisionedProductPlan")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ExecuteProvisionedProductPlanTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ExecuteProvisionedProductPlanTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExecuteProvisionedProductPlanTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ExecuteProvisionedProductPlanInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteProvisionedProductPlanResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_execute_provisioned_product_plan::de_execute_provisioned_product_plan_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_execute_provisioned_product_plan::de_execute_provisioned_product_plan_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExecuteProvisionedProductPlanRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_execute_provisioned_product_plan::ser_execute_provisioned_product_plan_input(&input)?,
        );
