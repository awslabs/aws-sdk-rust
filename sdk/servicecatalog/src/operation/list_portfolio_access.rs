...
impl ListPortfolioAccessInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_portfolio_access::ser_list_portfolio_access_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_portfolio_access::ListPortfolioAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPortfolioAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_portfolio_access::de_list_portfolio_access_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_portfolio_access::ListPortfolioAccessError
{
