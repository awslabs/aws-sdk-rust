...
impl UpdatePortfolioShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_portfolio_share::UpdatePortfolioShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_portfolio_share::UpdatePortfolioShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_portfolio_share::UpdatePortfolioShareOutput, crate::operation::update_portfolio_share::UpdatePortfolioShareError, Self> {
