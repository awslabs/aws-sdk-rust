...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportAsProvisionedProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_as_provisioned_product::de_import_as_provisioned_product_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError
{
