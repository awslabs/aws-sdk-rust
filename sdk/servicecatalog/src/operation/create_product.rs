...
impl CreateProductInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_product::CreateProduct::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_product::de_create_product_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_product::de_create_product_http_response_with_props(
                status, headers, body,
            )
        }
    }
