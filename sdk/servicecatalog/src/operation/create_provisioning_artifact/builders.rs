...
impl CreateProvisioningArtifactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_provisioning_artifact::CreateProvisioningArtifactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_provisioning_artifact::CreateProvisioningArtifactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_provisioning_artifact::CreateProvisioningArtifactOutput, crate::operation::create_provisioning_artifact::CreateProvisioningArtifactError, Self> {
