...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableAWSOrganizationsAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_aws_organizations_access::de_enable_aws_organizations_access_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for EnableAWSOrganizationsAccessError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::enable_aws_organizations_access::EnableAWSOrganizationsAccessError
{
