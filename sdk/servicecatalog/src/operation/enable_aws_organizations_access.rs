...
impl EnableAWSOrganizationsAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::enable_aws_organizations_access::EnableAWSOrganizationsAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::enable_aws_organizations_access::EnableAwsOrganizationsAccessOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Catalog.EnableAWSOrganizationsAccess",
            "rpc.service" = "Service Catalog",
            "rpc.method" = "EnableAWSOrganizationsAccess",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnableAWSOrganizationsAccess")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableAWSOrganizationsAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::enable_aws_organizations_access::EnableAwsOrganizationsAccessInput>()
            .expect("correct type");
