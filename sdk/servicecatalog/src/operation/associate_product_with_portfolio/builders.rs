...
impl AssociateProductWithPortfolioFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_product_with_portfolio::AssociateProductWithPortfolioOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_product_with_portfolio::AssociateProductWithPortfolioError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_product_with_portfolio::AssociateProductWithPortfolioOutput, crate::operation::associate_product_with_portfolio::AssociateProductWithPortfolioError, Self> {
