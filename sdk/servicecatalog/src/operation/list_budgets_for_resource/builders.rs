...
impl ListBudgetsForResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_budgets_for_resource::ListBudgetsForResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_budgets_for_resource::ListBudgetsForResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_budgets_for_resource::ListBudgetsForResourceOutput, crate::operation::list_budgets_for_resource::ListBudgetsForResourceError, Self> {
