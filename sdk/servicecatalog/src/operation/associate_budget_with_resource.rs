...
impl AssociateBudgetWithResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_budget_with_resource::AssociateBudgetWithResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateBudgetWithResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_budget_with_resource::de_associate_budget_with_resource_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AssociateBudgetWithResourceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_budget_with_resource::AssociateBudgetWithResourceError
{
