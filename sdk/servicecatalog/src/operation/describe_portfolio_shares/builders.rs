...
impl DescribePortfolioSharesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_portfolio_shares::DescribePortfolioSharesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_portfolio_shares::DescribePortfolioSharesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_portfolio_shares::DescribePortfolioSharesOutput, crate::operation::describe_portfolio_shares::DescribePortfolioSharesError, Self> {
