...
impl DescribePortfolioInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_portfolio::ser_describe_portfolio_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePortfolio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_portfolio::de_describe_portfolio_http_response_with_props(status, headers, body)
        }
    }
}
