...
impl CreateTagOptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_tag_option::CreateTagOption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTagOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_tag_option::de_create_tag_option_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_tag_option::CreateTagOptionError
{
