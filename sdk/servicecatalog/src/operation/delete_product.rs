...
impl DeleteProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_product::DeleteProduct, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_product::ser_delete_product_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_product::de_delete_product_http_response_with_props(status, headers, body)
        }
    }
}
