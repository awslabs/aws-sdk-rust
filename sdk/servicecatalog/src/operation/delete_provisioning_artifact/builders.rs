...
impl DeleteProvisioningArtifactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifactOutput, crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifactError, Self> {
