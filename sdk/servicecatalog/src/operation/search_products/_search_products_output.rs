...
impl SearchProductsOutputBuilder {
    ...
    ///
    /// <p>The product view aggregations.</p>
    pub fn product_view_aggregations(mut self, k: impl ::std::convert::Into<::std::string::String>, v: ::std::vec::Vec::<crate::types::ProductViewAggregationValue>) -> Self {
    ...
    /// <p>The product view aggregations.</p>
    pub fn get_product_view_aggregations(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::vec::Vec::<crate::types::ProductViewAggregationValue>>> {
