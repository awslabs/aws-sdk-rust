...
impl crate::operation::associate_budget_with_resource::builders::AssociateBudgetWithResourceInputBuilder {
...
impl AssociateBudgetWithResourceFluentBuilder {
    /// Creates a new `AssociateBudgetWithResourceFluentBuilder`.
