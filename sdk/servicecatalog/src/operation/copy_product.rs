...
impl CopyProductInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_product::CopyProduct::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_product::de_copy_product_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_copy_product::de_copy_product_http_response_with_props(
                status, headers, body,
            )
        }
    }
