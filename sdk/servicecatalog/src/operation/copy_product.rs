...
impl CopyProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_product::CopyProduct, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_copy_product::ser_copy_product_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_product::de_copy_product_http_response_with_props(status, headers, body)
        }
    }
}
