...
impl CreatePortfolioInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_portfolio::CreatePortfolio::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePortfolio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_portfolio::de_create_portfolio_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_portfolio::CreatePortfolioError
{
