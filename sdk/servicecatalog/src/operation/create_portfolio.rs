...
impl CreatePortfolioInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_portfolio::CreatePortfolio, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_portfolio::ser_create_portfolio_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePortfolio {
    type Output =
        ::std::result::Result<crate::operation::create_portfolio::CreatePortfolioOutput, crate::operation::create_portfolio::CreatePortfolioError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_portfolio::de_create_portfolio_http_response_with_props(status, headers, body)
        }
    }
}
