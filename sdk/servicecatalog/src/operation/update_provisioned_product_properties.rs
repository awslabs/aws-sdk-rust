...
impl UpdateProvisionedProductPropertiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_provisioned_product_properties::UpdateProvisionedProductProperties::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProvisionedProductProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_provisioned_product_properties::de_update_provisioned_product_properties_http_response_with_props(
                status, headers, body,
            )
        }
    }
