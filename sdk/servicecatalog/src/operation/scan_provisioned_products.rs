...
impl ScanProvisionedProducts {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::scan_provisioned_products::ScanProvisionedProductsInput,
                    ) -> ::std::result::Result<crate::operation::scan_provisioned_products::ScanProvisionedProductsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::scan_provisioned_products::ScanProvisionedProductsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::scan_provisioned_products::ScanProvisionedProductsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::scan_provisioned_products::ScanProvisionedProductsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ScanProvisionedProducts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ScanProvisionedProducts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ScanProvisionedProductsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ScanProvisionedProductsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ScanProvisionedProducts")
...
.with_interceptor(ScanProvisionedProductsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::scan_provisioned_products::ScanProvisionedProductsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::scan_provisioned_products::ScanProvisionedProductsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::scan_provisioned_products::ScanProvisionedProductsError>::new());
...
#[derive(Debug)]
            struct ScanProvisionedProductsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ScanProvisionedProductsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_scan_provisioned_products::de_scan_provisioned_products_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_scan_provisioned_products::de_scan_provisioned_products_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ScanProvisionedProductsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ScanProvisionedProductsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::scan_provisioned_products::ScanProvisionedProductsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::scan_provisioned_products::ScanProvisionedProductsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_scan_provisioned_products::ser_scan_provisioned_products_input(&input)?);
...
#[derive(Debug)]
            struct ScanProvisionedProductsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ScanProvisionedProductsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ScanProvisionedProductsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ScanProvisionedProductsInput>()
                        .ok_or("failed to downcast to ScanProvisionedProductsInput")?;
...
pub enum ScanProvisionedProductsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ScanProvisionedProductsError) for what information is available for the error.")]
...
impl ScanProvisionedProductsError {
    /// Creates the `ScanProvisionedProductsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ScanProvisionedProductsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ScanProvisionedProductsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::scan_provisioned_products::ScanProvisionedProductsError {
...
mod _scan_provisioned_products_output;
