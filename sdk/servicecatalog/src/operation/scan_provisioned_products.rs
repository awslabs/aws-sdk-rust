...
impl ScanProvisionedProductsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::scan_provisioned_products::ScanProvisionedProducts,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ScanProvisionedProducts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_scan_provisioned_products::de_scan_provisioned_products_http_response_with_props(status, headers, body)
        }
    }
}
