...
impl UpdateProvisioningArtifactInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_provisioning_artifact::UpdateProvisioningArtifact::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProvisioningArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_provisioning_artifact::de_update_provisioning_artifact_http_response_with_props(status, headers, body)
        }
    }
}
