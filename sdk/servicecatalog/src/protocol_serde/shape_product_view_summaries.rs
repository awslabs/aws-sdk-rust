...
pub(crate) fn de_product_view_summaries<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::ProductViewSummary>>, aws_smithy_json::deserialize::error::DeserializeError>
