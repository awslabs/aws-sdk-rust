...
pub fn ser_create_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
