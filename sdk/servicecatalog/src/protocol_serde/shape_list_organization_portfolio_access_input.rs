...
pub fn ser_list_organization_portfolio_access_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListOrganizationPortfolioAccessInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
