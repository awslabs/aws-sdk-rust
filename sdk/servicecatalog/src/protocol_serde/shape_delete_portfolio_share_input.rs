...
pub fn ser_delete_portfolio_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeletePortfolioShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
