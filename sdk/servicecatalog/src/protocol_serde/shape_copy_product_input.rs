...
pub fn ser_copy_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CopyProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
