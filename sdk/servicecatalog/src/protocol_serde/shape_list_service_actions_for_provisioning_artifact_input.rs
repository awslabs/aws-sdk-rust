...
pub fn ser_list_service_actions_for_provisioning_artifact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListServiceActionsForProvisioningArtifactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
