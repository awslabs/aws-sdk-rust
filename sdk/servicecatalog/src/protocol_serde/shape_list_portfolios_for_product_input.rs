...
pub fn ser_list_portfolios_for_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPortfoliosForProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
