...
pub fn ser_list_portfolios_for_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_portfolios_for_product::ListPortfoliosForProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
