...
pub fn ser_delete_provisioned_product_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteProvisionedProductPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
