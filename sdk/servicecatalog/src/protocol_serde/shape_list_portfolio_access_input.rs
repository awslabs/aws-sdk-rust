...
pub fn ser_list_portfolio_access_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPortfolioAccessInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
