...
pub fn ser_list_launch_paths_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_launch_paths::ListLaunchPathsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
