...
pub fn ser_create_provisioned_product_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProvisionedProductPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
