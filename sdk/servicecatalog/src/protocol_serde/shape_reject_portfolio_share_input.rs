...
pub fn ser_reject_portfolio_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::reject_portfolio_share::RejectPortfolioShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
