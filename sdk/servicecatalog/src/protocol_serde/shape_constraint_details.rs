...
pub(crate) fn de_constraint_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::ConstraintDetail>>, aws_smithy_json::deserialize::error::DeserializeError>
