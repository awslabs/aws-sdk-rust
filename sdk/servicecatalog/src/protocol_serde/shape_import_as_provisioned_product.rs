...
pub fn de_import_as_provisioned_product_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::import_as_provisioned_product::ImportAsProvisionedProductOutput, crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "DuplicateResourceException" => crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::DuplicateResourceException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParametersException" => crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::InvalidParametersException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidStateException" => crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::InvalidStateException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_import_as_provisioned_product_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::import_as_provisioned_product::ImportAsProvisionedProductOutput, crate::operation::import_as_provisioned_product::ImportAsProvisionedProductError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_import_as_provisioned_product_input(input: &crate::operation::import_as_provisioned_product::ImportAsProvisionedProductInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_import_as_provisioned_product(value: &[u8], mut builder: crate::operation::import_as_provisioned_product::builders::ImportAsProvisionedProductOutputBuilder) -> Result<crate::operation::import_as_provisioned_product::builders::ImportAsProvisionedProductOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
