...
pub fn ser_import_as_provisioned_product_input(input: &crate::operation::import_as_provisioned_product::ImportAsProvisionedProductInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
