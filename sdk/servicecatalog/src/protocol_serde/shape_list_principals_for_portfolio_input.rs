...
pub fn ser_list_principals_for_portfolio_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPrincipalsForPortfolioInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
