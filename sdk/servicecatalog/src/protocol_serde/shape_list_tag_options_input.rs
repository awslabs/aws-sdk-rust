...
pub fn ser_list_tag_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTagOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
