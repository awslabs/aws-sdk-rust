...
pub fn ser_update_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
