...
pub fn ser_list_accepted_portfolio_shares_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAcceptedPortfolioSharesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
