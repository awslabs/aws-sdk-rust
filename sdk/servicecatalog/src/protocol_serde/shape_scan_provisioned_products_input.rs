...
pub fn ser_scan_provisioned_products_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::scan_provisioned_products::ScanProvisionedProductsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
