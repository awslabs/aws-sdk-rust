...
pub fn ser_search_products_as_admin_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchProductsAsAdminInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
