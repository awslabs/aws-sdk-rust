...
pub fn ser_create_provisioning_artifact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProvisioningArtifactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
