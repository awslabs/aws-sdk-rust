...
pub fn ser_service_action_association(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ServiceActionAssociation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
