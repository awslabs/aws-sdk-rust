...
pub fn ser_service_action_association(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServiceActionAssociation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
