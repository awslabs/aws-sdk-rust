...
pub fn ser_disassociate_principal_from_portfolio_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::disassociate_principal_from_portfolio::DisassociatePrincipalFromPortfolioInput,
