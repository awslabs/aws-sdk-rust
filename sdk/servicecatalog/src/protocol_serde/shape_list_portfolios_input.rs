...
pub fn ser_list_portfolios_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPortfoliosInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
