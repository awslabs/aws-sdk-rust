...
pub fn ser_create_portfolio_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePortfolioShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
