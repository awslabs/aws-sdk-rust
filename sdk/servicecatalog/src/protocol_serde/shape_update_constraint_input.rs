...
pub fn ser_update_constraint_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_constraint::UpdateConstraintInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
