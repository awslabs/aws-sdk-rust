...
pub fn ser_list_resources_for_tag_option_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListResourcesForTagOptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
