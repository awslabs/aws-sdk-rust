...
pub fn ser_list_record_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRecordHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
