...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError::unhandled)?;
    ...
    Err(match error_code {
        "OperationNotSupportedException" => {
            crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError::OperationNotSupportedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_aws_organizations_access_status::de_get_aws_organizations_access_status(_response_body, output)
            .map_err(crate::operation::get_aws_organizations_access_status::GetAWSOrganizationsAccessStatusError::unhandled)?;
