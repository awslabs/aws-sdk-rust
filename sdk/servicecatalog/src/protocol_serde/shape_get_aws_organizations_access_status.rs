...
pub fn de_get_aws_organizations_access_status_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_aws_organizations_access_status_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
                ...
                match key.to_unescaped()?.as_ref() {
                    "AccessStatus" => {
                        builder = builder.set_access_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::AccessStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
