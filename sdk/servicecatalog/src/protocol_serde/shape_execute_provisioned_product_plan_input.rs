...
pub fn ser_execute_provisioned_product_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteProvisionedProductPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
