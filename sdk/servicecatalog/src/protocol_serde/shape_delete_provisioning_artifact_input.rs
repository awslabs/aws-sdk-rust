...
pub fn ser_delete_provisioning_artifact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteProvisioningArtifactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
