...
pub fn ser_delete_provisioning_artifact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_provisioning_artifact::DeleteProvisioningArtifactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
