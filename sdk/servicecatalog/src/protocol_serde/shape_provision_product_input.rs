...
pub fn ser_provision_product_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ProvisionProductInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
