...
pub(crate) fn de_product_view_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ProductViewDetail>>, aws_smithy_json::deserialize::error::DeserializeError>
