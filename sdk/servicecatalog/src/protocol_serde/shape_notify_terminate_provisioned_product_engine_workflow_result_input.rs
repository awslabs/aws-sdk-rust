...
pub fn ser_notify_terminate_provisioned_product_engine_workflow_result_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::notify_terminate_provisioned_product_engine_workflow_result::NotifyTerminateProvisionedProductEngineWorkflowResultInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
