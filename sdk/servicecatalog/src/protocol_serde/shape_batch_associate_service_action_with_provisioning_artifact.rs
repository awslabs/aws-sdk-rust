...
pub fn de_batch_associate_service_action_with_provisioning_artifact_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_associate_service_action_with_provisioning_artifact_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::BatchAssociateServiceActionWithProvisioningArtifactOutput,
    crate::error::BatchAssociateServiceActionWithProvisioningArtifactError,
...
pub(crate) fn de_batch_associate_service_action_with_provisioning_artifact(
    value: &[u8],
