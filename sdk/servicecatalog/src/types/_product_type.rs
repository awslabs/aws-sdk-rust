...
other => ProductType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ProductType {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ProductType::from(s))
                    }
                }
impl ProductType {
    ...
    ProductType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["CLOUD_FORMATION_TEMPLATE", "EXTERNAL", "MARKETPLACE", "TERRAFORM_CLOUD", "TERRAFORM_OPEN_SOURCE"]
                }
            }
