...
impl ::std::convert::From<&str> for ProvisioningArtifactPropertyName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisioningArtifactPropertyName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisioningArtifactPropertyName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisioningArtifactPropertyName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisioningArtifactPropertyName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ProvisioningArtifactPropertyName {
