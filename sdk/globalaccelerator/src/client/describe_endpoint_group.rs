...
impl super::Client {
    ...
    ///   - [`endpoint_group_arn(impl Into<String>)`](crate::operation::describe_endpoint_group::builders::DescribeEndpointGroupFluentBuilder::endpoint_group_arn) / [`set_endpoint_group_arn(Option<String>)`](crate::operation::describe_endpoint_group::builders::DescribeEndpointGroupFluentBuilder::set_endpoint_group_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the endpoint group to describe.</p><br>
