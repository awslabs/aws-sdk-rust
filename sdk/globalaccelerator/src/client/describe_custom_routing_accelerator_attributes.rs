...
impl super::Client {
    ...
    ///   - [`accelerator_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_custom_routing_accelerator_attributes::builders::DescribeCustomRoutingAcceleratorAttributesFluentBuilder::accelerator_arn) / [`set_accelerator_arn(Option<String>)`](crate::operation::describe_custom_routing_accelerator_attributes::builders::DescribeCustomRoutingAcceleratorAttributesFluentBuilder::set_accelerator_arn): <p>The Amazon Resource Name (ARN) of the custom routing accelerator to describe the attributes for.</p>
