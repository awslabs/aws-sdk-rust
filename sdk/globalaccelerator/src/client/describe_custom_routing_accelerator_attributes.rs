...
impl super::Client  {
    ...
    pub fn describe_custom_routing_accelerator_attributes(&self) -> crate::client::fluent_builders::DescribeCustomRoutingAcceleratorAttributes {
                                crate::client::fluent_builders::DescribeCustomRoutingAcceleratorAttributes::new(self.handle.clone())
                            }
}
