...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_accelerators::builders::ListAcceleratorsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_accelerators::builders::ListAcceleratorsFluentBuilder::set_max_results):<br>required: **false**<br><p>The number of Global Accelerator objects that you want to return with this call. The default value is 10.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_accelerators::builders::ListAcceleratorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_accelerators::builders::ListAcceleratorsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of results. You receive this token from a previous call.</p><br>
