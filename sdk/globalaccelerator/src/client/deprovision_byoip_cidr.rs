...
impl super::Client {
    ...
    ///   - [`cidr(impl Into<String>)`](crate::operation::deprovision_byoip_cidr::builders::DeprovisionByoipCidrFluentBuilder::cidr) / [`set_cidr(Option<String>)`](crate::operation::deprovision_byoip_cidr::builders::DeprovisionByoipCidrFluentBuilder::set_cidr):<br>required: **true**<br><p>The address range, in CIDR notation. The prefix must be the same prefix that you specified when you provisioned the address range.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/using-byoip.html">Bring your own IP addresses (BYOIP)</a> in the Global Accelerator Developer Guide.</p><br>
