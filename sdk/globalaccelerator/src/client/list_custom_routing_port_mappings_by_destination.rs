...
impl super::Client {
    ...
    ///   - [`endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::list_custom_routing_port_mappings_by_destination::builders::ListCustomRoutingPortMappingsByDestinationFluentBuilder::endpoint_id) / [`set_endpoint_id(Option<String>)`](crate::operation::list_custom_routing_port_mappings_by_destination::builders::ListCustomRoutingPortMappingsByDestinationFluentBuilder::set_endpoint_id): <p>The ID for the virtual private cloud (VPC) subnet.</p>
    ///   - [`destination_address(impl ::std::convert::Into<String>)`](crate::operation::list_custom_routing_port_mappings_by_destination::builders::ListCustomRoutingPortMappingsByDestinationFluentBuilder::destination_address) / [`set_destination_address(Option<String>)`](crate::operation::list_custom_routing_port_mappings_by_destination::builders::ListCustomRoutingPortMappingsByDestinationFluentBuilder::set_destination_address): <p>The endpoint IP address in a virtual private cloud (VPC) subnet for which you want to receive back port mappings.</p>
