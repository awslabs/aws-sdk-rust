...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_cross_account_resources::builders::ListCrossAccountResourcesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_cross_account_resources::builders::ListCrossAccountResourcesFluentBuilder::set_max_results):<br>required: **false**<br><p>The number of cross-account resource objects that you want to return with this call. The default value is 10.</p><br>
    ...
    ///   - [`cross_account_resources(Option<Vec::<CrossAccountResource>>)`](crate::operation::list_cross_account_resources::ListCrossAccountResourcesOutput::cross_account_resources): <p>The cross-account resources used with an accelerator.</p>
