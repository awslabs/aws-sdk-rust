...
impl super::Client {
    ...
    ///   - [`ip_addresses(impl Into<String>)`](crate::operation::update_accelerator::builders::UpdateAcceleratorFluentBuilder::ip_addresses) / [`set_ip_addresses(Option<Vec::<String>>)`](crate::operation::update_accelerator::builders::UpdateAcceleratorFluentBuilder::set_ip_addresses):<br>required: **false**<br><p>The IP addresses for an accelerator.</p><br>
