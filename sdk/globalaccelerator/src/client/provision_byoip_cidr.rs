...
impl super::Client {
    ...
    pub fn provision_byoip_cidr(
        &self,
    ) -> crate::operation::provision_byoip_cidr::builders::ProvisionByoipCidrFluentBuilder {
        crate::operation::provision_byoip_cidr::builders::ProvisionByoipCidrFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
