...
impl std::convert::From<&str> for CustomRoutingAcceleratorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomRoutingAcceleratorStatus::Unknown(crate::types::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
pub mod ip_set {
    ...
    impl Builder {
        ...
        pub fn set_ip_address_family(
            mut self,
            input: std::option::Option<crate::model::IpAddressFamily>,
        ) -> Self {
...
pub mod accelerator {
    ...
    impl Builder {
        ...
        /// <p>Note: Global Accelerator also assigns a default DNS name, <code>DnsName</code>, to your accelerator that points just to the static IPv4 addresses. </p>
        /// <p>For more information, see <a href="https://docs.aws.amazon.com/global-accelerator/latest/dg/about-accelerators.html#about-accelerators.dns-addressing"> Support for DNS addressing in Global Accelerator</a> in the <i>Global Accelerator Developer Guide</i>.</p>
        pub fn set_dual_stack_dns_name(
            mut self,
            input: std::option::Option<std::string::String>,
        ) -> Self {
        ...
        pub fn set_events(
            mut self,
            input: std::option::Option<std::vec::Vec<crate::model::AcceleratorEvent>>,
        ) -> Self {
            self.events = input;
            self
        }
...
impl std::convert::From<&str> for AcceleratorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                AcceleratorStatus::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
...
impl std::convert::From<&str> for CustomRoutingDestinationTrafficState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomRoutingDestinationTrafficState::Unknown(
...
impl std::convert::From<&str> for CustomRoutingProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                CustomRoutingProtocol::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
