...
impl std::convert::From<&str> for ClientAffinity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientAffinity::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for HealthState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HealthState::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for CustomRoutingAcceleratorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomRoutingAcceleratorStatus::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for IpAddressFamily {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpAddressFamily::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for AcceleratorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AcceleratorStatus::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub mod endpoint_identifier {
    ...
    /// A builder for [`EndpointIdentifier`](crate::model::EndpointIdentifier).
    #[derive(std::clone::Clone, std::cmp::PartialEq, std::default::Default, std::fmt::Debug)]
    pub struct Builder {
        pub(crate) endpoint_id: std::option::Option<std::string::String>,
        pub(crate) client_ip_preservation_enabled: std::option::Option<bool>,
    ...
    impl Builder {
        ...
        /// Consumes the builder and constructs a [`EndpointIdentifier`](crate::model::EndpointIdentifier).
        pub fn build(self) -> crate::model::EndpointIdentifier {
            crate::model::EndpointIdentifier {
                endpoint_id: self.endpoint_id
                ,
                client_ip_preservation_enabled: self.client_ip_preservation_enabled
                ,
...
pub struct DestinationPortMapping  {
    ...
    #[doc(hidden)]
    pub accelerator_socket_addresses: std::option::Option<std::vec::Vec<crate::model::SocketAddress>>,
    /// <p>The Amazon Resource Name (ARN) of the endpoint group.</p>
    #[doc(hidden)]
    pub endpoint_group_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]
    pub destination_traffic_state: std::option::Option<crate::model::CustomRoutingDestinationTrafficState>,
}
...
impl std::convert::From<&str> for CustomRoutingDestinationTrafficState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomRoutingDestinationTrafficState::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for CustomRoutingProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomRoutingProtocol::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct CustomRoutingEndpointGroup  {
    ...
    #[doc(hidden)]
    pub destination_descriptions: std::option::Option<std::vec::Vec<crate::model::CustomRoutingDestinationDescription>>,
