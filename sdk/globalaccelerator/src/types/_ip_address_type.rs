...
impl ::std::convert::From<&str> for IpAddressType {
    fn from(s: &str) -> Self {
        match s {
            "DUAL_STACK" => IpAddressType::DualStack,
...
impl ::std::str::FromStr for IpAddressType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpAddressType::from(s))
    }
}
impl IpAddressType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            IpAddressType::DualStack => "DUAL_STACK",
...
impl ::std::fmt::Display for IpAddressType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            IpAddressType::DualStack => write!(f, "DUAL_STACK"),
