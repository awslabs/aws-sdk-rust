...
impl UpdateCustomRoutingAcceleratorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_custom_routing_accelerator::UpdateCustomRoutingAccelerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomRoutingAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_custom_routing_accelerator::de_update_custom_routing_accelerator_http_response_with_props(
                status, headers, body,
            )
        }
    }
