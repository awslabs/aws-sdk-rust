...
impl UpdateCustomRoutingAcceleratorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_custom_routing_accelerator::UpdateCustomRoutingAccelerator,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomRoutingAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_custom_routing_accelerator::de_update_custom_routing_accelerator_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_custom_routing_accelerator::UpdateCustomRoutingAcceleratorError
{
