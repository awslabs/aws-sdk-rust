...
impl DescribeCustomRoutingListener {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCustomRoutingListener {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCustomRoutingListener");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCustomRoutingListenerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCustomRoutingListenerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCustomRoutingListener")
...
.with_interceptor(DescribeCustomRoutingListenerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError>::new());
...
#[derive(Debug)]
            struct DescribeCustomRoutingListenerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCustomRoutingListenerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_custom_routing_listener::de_describe_custom_routing_listener_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_custom_routing_listener::de_describe_custom_routing_listener_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeCustomRoutingListenerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCustomRoutingListenerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_custom_routing_listener::ser_describe_custom_routing_listener_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCustomRoutingListenerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCustomRoutingListenerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCustomRoutingListenerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCustomRoutingListenerInput>()
                        .ok_or("failed to downcast to DescribeCustomRoutingListenerInput")?;
...
pub enum DescribeCustomRoutingListenerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCustomRoutingListenerError) for what information is available for the error.")]
...
impl DescribeCustomRoutingListenerError {
    /// Creates the `DescribeCustomRoutingListenerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCustomRoutingListenerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCustomRoutingListenerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_custom_routing_listener::_describe_custom_routing_listener_output::DescribeCustomRoutingListenerOutput;

pub use crate::operation::describe_custom_routing_listener::_describe_custom_routing_listener_input::DescribeCustomRoutingListenerInput;

mod _describe_custom_routing_listener_input;

mod _describe_custom_routing_listener_output;
