...
impl DescribeCustomRoutingListenerInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCustomRoutingListener`](crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListener)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListener, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListener::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCustomRoutingListener {
                type Output = std::result::Result<crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerOutput, crate::operation::describe_custom_routing_listener::DescribeCustomRoutingListenerError>;
