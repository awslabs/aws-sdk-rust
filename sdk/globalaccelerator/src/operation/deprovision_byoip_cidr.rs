...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeprovisionByoipCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeprovisionByoipCidr", "globalaccelerator"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeprovisionByoipCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deprovision_byoip_cidr::ser_deprovision_byoip_cidr_input(
            &input,
        )?);
