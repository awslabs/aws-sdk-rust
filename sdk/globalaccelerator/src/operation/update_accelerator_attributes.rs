...
impl UpdateAcceleratorAttributesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAcceleratorAttributes`](crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_accelerator_attributes::ser_update_accelerator_attributes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateAcceleratorAttributes", "globalaccelerator"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAcceleratorAttributes {
                type Output = std::result::Result<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesOutput, crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError>;
