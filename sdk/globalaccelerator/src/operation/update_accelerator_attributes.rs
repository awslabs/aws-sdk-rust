...
impl UpdateAcceleratorAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAcceleratorAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_accelerator_attributes::de_update_accelerator_attributes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateAcceleratorAttributesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError
{
