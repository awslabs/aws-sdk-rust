...
impl UpdateAcceleratorAttributes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesInput,
                    ) -> ::std::result::Result<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAcceleratorAttributes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateAcceleratorAttributes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateAcceleratorAttributesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateAcceleratorAttributesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAcceleratorAttributes")
...
.with_interceptor(UpdateAcceleratorAttributesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError>::new());
...
#[derive(Debug)]
            struct UpdateAcceleratorAttributesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAcceleratorAttributesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_accelerator_attributes::de_update_accelerator_attributes_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_accelerator_attributes::de_update_accelerator_attributes_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateAcceleratorAttributesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAcceleratorAttributesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_accelerator_attributes::ser_update_accelerator_attributes_input(&input)?);
...
#[derive(Debug)]
            struct UpdateAcceleratorAttributesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAcceleratorAttributesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateAcceleratorAttributesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateAcceleratorAttributesInput>()
                        .ok_or("failed to downcast to UpdateAcceleratorAttributesInput")?;
...
pub enum UpdateAcceleratorAttributesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateAcceleratorAttributesError) for what information is available for the error.")]
...
impl UpdateAcceleratorAttributesError {
    /// Creates the `UpdateAcceleratorAttributesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateAcceleratorAttributesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateAcceleratorAttributesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_accelerator_attributes::_update_accelerator_attributes_output::UpdateAcceleratorAttributesOutput;

pub use crate::operation::update_accelerator_attributes::_update_accelerator_attributes_input::UpdateAcceleratorAttributesInput;

mod _update_accelerator_attributes_input;

mod _update_accelerator_attributes_output;
