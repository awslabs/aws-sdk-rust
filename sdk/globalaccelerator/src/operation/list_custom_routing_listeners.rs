...
impl ListCustomRoutingListenersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_custom_routing_listeners::ListCustomRoutingListeners,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_custom_routing_listeners::ListCustomRoutingListeners::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingListeners {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_routing_listeners::de_list_custom_routing_listeners_http_response_with_props(
                status, headers, body,
            )
        }
    }
