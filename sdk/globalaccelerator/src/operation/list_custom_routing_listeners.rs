...
impl ListCustomRoutingListeners {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersInput,
                    ) -> ::std::result::Result<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomRoutingListeners {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCustomRoutingListeners");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCustomRoutingListenersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCustomRoutingListenersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomRoutingListeners")
...
.with_interceptor(ListCustomRoutingListenersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError>::new());
...
#[derive(Debug)]
            struct ListCustomRoutingListenersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomRoutingListenersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_custom_routing_listeners::de_list_custom_routing_listeners_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_custom_routing_listeners::de_list_custom_routing_listeners_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListCustomRoutingListenersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomRoutingListenersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_custom_routing_listeners::ser_list_custom_routing_listeners_input(&input)?);
...
#[derive(Debug)]
            struct ListCustomRoutingListenersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomRoutingListenersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCustomRoutingListenersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCustomRoutingListenersInput>()
                        .ok_or("failed to downcast to ListCustomRoutingListenersInput")?;
...
pub enum ListCustomRoutingListenersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCustomRoutingListenersError) for what information is available for the error.")]
...
impl ListCustomRoutingListenersError {
    /// Creates the `ListCustomRoutingListenersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCustomRoutingListenersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCustomRoutingListenersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_custom_routing_listeners::_list_custom_routing_listeners_output::ListCustomRoutingListenersOutput;

pub use crate::operation::list_custom_routing_listeners::_list_custom_routing_listeners_input::ListCustomRoutingListenersInput;

mod _list_custom_routing_listeners_input;

mod _list_custom_routing_listeners_output;
