...
impl ListCustomRoutingListenersInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomRoutingListeners`](crate::operation::list_custom_routing_listeners::ListCustomRoutingListeners)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_custom_routing_listeners::ListCustomRoutingListeners, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_routing_listeners::ListCustomRoutingListeners::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingListeners {
                type Output = std::result::Result<crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersOutput, crate::operation::list_custom_routing_listeners::ListCustomRoutingListenersError>;
