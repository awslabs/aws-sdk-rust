...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListCustomRoutingPortMappingsByDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListCustomRoutingPortMappingsByDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_custom_routing_port_mappings_by_destination::ser_list_custom_routing_port_mappings_by_destination_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListCustomRoutingPortMappingsByDestinationEndpointParamsInterceptor {
