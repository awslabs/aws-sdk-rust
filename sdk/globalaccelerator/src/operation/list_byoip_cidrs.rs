...
impl ListByoipCidrsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_byoip_cidrs::ListByoipCidrs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_byoip_cidrs::ser_list_byoip_cidrs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListByoipCidrs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_byoip_cidrs::de_list_byoip_cidrs_http_response_with_props(status, headers, body)
        }
    }
}
