...
impl ListByoipCidrsInput {
    /// Consumes the builder and constructs an Operation<[`ListByoipCidrs`](crate::operation::list_byoip_cidrs::ListByoipCidrs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_byoip_cidrs::ListByoipCidrs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_byoip_cidrs::ListByoipCidrsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_byoip_cidrs::ser_list_byoip_cidrs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_byoip_cidrs::ListByoipCidrs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListByoipCidrs", "globalaccelerator"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListByoipCidrs {
                type Output = std::result::Result<crate::operation::list_byoip_cidrs::ListByoipCidrsOutput, crate::operation::list_byoip_cidrs::ListByoipCidrsError>;
