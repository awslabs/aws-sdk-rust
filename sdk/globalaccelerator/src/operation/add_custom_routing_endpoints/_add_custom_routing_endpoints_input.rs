...
impl AddCustomRoutingEndpointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsInput, ::aws_smithy_types::error::operation::BuildError> {
