...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingEndpointGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_routing_endpoint_groups::de_list_custom_routing_endpoint_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsError
{
