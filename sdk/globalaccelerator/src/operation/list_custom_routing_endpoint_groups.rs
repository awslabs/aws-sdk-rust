...
impl ListCustomRoutingEndpointGroups {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListCustomRoutingEndpointGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListCustomRoutingEndpointGroupsRequestSerializer {
