...
impl ListCustomRoutingEndpointGroups {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListCustomRoutingEndpointGroups",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomRoutingEndpointGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListCustomRoutingEndpointGroupsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListCustomRoutingEndpointGroupsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListCustomRoutingEndpointGroups")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomRoutingEndpointGroups")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListCustomRoutingEndpointGroupsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListCustomRoutingEndpointGroupsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomRoutingEndpointGroupsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListCustomRoutingEndpointGroupsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomRoutingEndpointGroupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_list_custom_routing_endpoint_groups::de_list_custom_routing_endpoint_groups_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomRoutingEndpointGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_custom_routing_endpoint_groups::ser_list_custom_routing_endpoint_groups_input(&input)?,
        );
