...
impl ListCustomRoutingEndpointGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomRoutingEndpointGroups`](crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingEndpointGroups {
                type Output = std::result::Result<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsOutput, crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsError>;
