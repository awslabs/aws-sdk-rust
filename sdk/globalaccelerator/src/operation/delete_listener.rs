...
impl DeleteListenerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteListener`](crate::operation::delete_listener::DeleteListener)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_listener::DeleteListener, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_listener::DeleteListenerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_listener::ser_delete_listener_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_listener::DeleteListener::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteListener", "globalaccelerator"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteListener {
                type Output = std::result::Result<crate::operation::delete_listener::DeleteListenerOutput, crate::operation::delete_listener::DeleteListenerError>;
