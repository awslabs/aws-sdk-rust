...
/// Orchestration and serialization glue logic for `DeleteCustomRoutingListener`.
...
impl DeleteCustomRoutingListener {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomRoutingListener {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomRoutingListener");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCustomRoutingListenerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCustomRoutingListenerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCustomRoutingListener")
...
.with_interceptor(DeleteCustomRoutingListenerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError>::new());
...
#[derive(Debug)]
            struct DeleteCustomRoutingListenerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomRoutingListenerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_custom_routing_listener::de_delete_custom_routing_listener_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_custom_routing_listener::de_delete_custom_routing_listener_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteCustomRoutingListenerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomRoutingListenerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_custom_routing_listener::ser_delete_custom_routing_listener_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCustomRoutingListenerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCustomRoutingListenerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCustomRoutingListenerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCustomRoutingListenerInput>()
                        .ok_or("failed to downcast to DeleteCustomRoutingListenerInput")?;
...
pub enum DeleteCustomRoutingListenerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomRoutingListenerError) for what information is available for the error.")]
...
impl DeleteCustomRoutingListenerError {
    /// Creates the `DeleteCustomRoutingListenerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCustomRoutingListenerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomRoutingListenerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError {
...
mod _delete_custom_routing_listener_output;
