...
impl DeleteCustomRoutingListenerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListener,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListener::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomRoutingListener {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_routing_listener::de_delete_custom_routing_listener_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteCustomRoutingListenerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_custom_routing_listener::DeleteCustomRoutingListenerError
{
