...
impl UpdateAcceleratorAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesOutput, crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesError, Self> {
