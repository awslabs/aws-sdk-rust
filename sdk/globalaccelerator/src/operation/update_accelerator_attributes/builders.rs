...
impl crate::operation::update_accelerator_attributes::builders::UpdateAcceleratorAttributesInputBuilder {
...
impl UpdateAcceleratorAttributesFluentBuilder {
    /// Creates a new `UpdateAcceleratorAttributesFluentBuilder`.
