...
impl UpdateCustomRoutingAcceleratorAttributesInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
