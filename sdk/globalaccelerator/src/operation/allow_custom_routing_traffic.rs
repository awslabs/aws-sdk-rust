...
impl AllowCustomRoutingTraffic {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Global Accelerator.AllowCustomRoutingTraffic",
            "rpc.service" = "Global Accelerator",
            "rpc.method" = "AllowCustomRoutingTraffic",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllowCustomRoutingTraffic {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllowCustomRoutingTrafficRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllowCustomRoutingTrafficResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllowCustomRoutingTraffic")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllowCustomRoutingTraffic")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllowCustomRoutingTrafficTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllowCustomRoutingTrafficTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllowCustomRoutingTrafficTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllowCustomRoutingTrafficInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllowCustomRoutingTrafficResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_allow_custom_routing_traffic::de_allow_custom_routing_traffic_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_allow_custom_routing_traffic::de_allow_custom_routing_traffic_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllowCustomRoutingTrafficRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_allow_custom_routing_traffic::ser_allow_custom_routing_traffic_input(&input)?,
        );
