...
impl AllowCustomRoutingTrafficInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTraffic::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AllowCustomRoutingTraffic {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allow_custom_routing_traffic::de_allow_custom_routing_traffic_http_response_with_props(status, headers, body)
        }
    }
}
