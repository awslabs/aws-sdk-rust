...
/// Orchestration and serialization glue logic for `AllowCustomRoutingTraffic`.
...
impl AllowCustomRoutingTraffic {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllowCustomRoutingTraffic {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AllowCustomRoutingTraffic");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AllowCustomRoutingTrafficRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AllowCustomRoutingTrafficResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllowCustomRoutingTraffic")
...
.with_interceptor(AllowCustomRoutingTrafficEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>::new());
...
#[derive(Debug)]
            struct AllowCustomRoutingTrafficResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllowCustomRoutingTrafficResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_allow_custom_routing_traffic::de_allow_custom_routing_traffic_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AllowCustomRoutingTrafficRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllowCustomRoutingTrafficRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_allow_custom_routing_traffic::ser_allow_custom_routing_traffic_input(&input)?);
...
#[derive(Debug)]
            struct AllowCustomRoutingTrafficEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllowCustomRoutingTrafficEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AllowCustomRoutingTrafficEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AllowCustomRoutingTrafficInput>()
                        .ok_or("failed to downcast to AllowCustomRoutingTrafficInput")?;
...
pub enum AllowCustomRoutingTrafficError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AllowCustomRoutingTrafficError) for what information is available for the error.")]
...
impl AllowCustomRoutingTrafficError {
    /// Creates the `AllowCustomRoutingTrafficError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AllowCustomRoutingTrafficError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AllowCustomRoutingTrafficError {
...
impl ::aws_types::request_id::RequestId for crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError {
...
mod _allow_custom_routing_traffic_output;
