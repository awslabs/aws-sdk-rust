...
impl AllowCustomRoutingTrafficInput {
    /// Consumes the builder and constructs an Operation<[`AllowCustomRoutingTraffic`](crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTraffic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTraffic, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTraffic::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AllowCustomRoutingTraffic {
                type Output = std::result::Result<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficOutput, crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficError>;
