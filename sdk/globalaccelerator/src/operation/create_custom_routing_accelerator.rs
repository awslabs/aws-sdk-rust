...
impl CreateCustomRoutingAcceleratorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_custom_routing_accelerator::CreateCustomRoutingAccelerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomRoutingAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_custom_routing_accelerator::de_create_custom_routing_accelerator_http_response_with_props(
                status, headers, body,
            )
        }
    }
