...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomRoutingAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_custom_routing_accelerator::de_create_custom_routing_accelerator_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_custom_routing_accelerator::CreateCustomRoutingAcceleratorError
{
