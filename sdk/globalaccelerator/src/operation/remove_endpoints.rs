...
impl RemoveEndpointsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::remove_endpoints::RemoveEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_endpoints::ser_remove_endpoints_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveEndpoints {
    type Output =
        ::std::result::Result<crate::operation::remove_endpoints::RemoveEndpointsOutput, crate::operation::remove_endpoints::RemoveEndpointsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_endpoints::de_remove_endpoints_http_response_with_props(status, headers, body)
        }
    }
}
