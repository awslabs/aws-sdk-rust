...
impl RemoveEndpoints {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::remove_endpoints::RemoveEndpointsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::remove_endpoints::RemoveEndpointsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Global Accelerator.RemoveEndpoints",
            "rpc.service" = "Global Accelerator",
            "rpc.method" = "RemoveEndpoints",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveEndpoints {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RemoveEndpointsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RemoveEndpointsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RemoveEndpoints")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveEndpoints")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RemoveEndpointsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RemoveEndpointsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveEndpointsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveEndpointsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveEndpointsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_remove_endpoints::de_remove_endpoints_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_remove_endpoints::de_remove_endpoints_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveEndpointsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::remove_endpoints::RemoveEndpointsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::remove_endpoints::RemoveEndpointsInput,
