...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for WithdrawByoipCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("WithdrawByoipCidr", "globalaccelerator"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for WithdrawByoipCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_withdraw_byoip_cidr::ser_withdraw_byoip_cidr_input(&input)?);
