...
impl DeprovisionByoipCidrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrOutput, crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrError, Self> {
