...
impl ListCustomRoutingAccelerators {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomRoutingAccelerators {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCustomRoutingAccelerators");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCustomRoutingAcceleratorsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCustomRoutingAcceleratorsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomRoutingAccelerators")
...
.with_interceptor(ListCustomRoutingAcceleratorsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError>::new());
...
#[derive(Debug)]
            struct ListCustomRoutingAcceleratorsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomRoutingAcceleratorsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_custom_routing_accelerators::de_list_custom_routing_accelerators_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_custom_routing_accelerators::de_list_custom_routing_accelerators_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListCustomRoutingAcceleratorsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomRoutingAcceleratorsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_custom_routing_accelerators::ser_list_custom_routing_accelerators_input(&input)?);
...
#[derive(Debug)]
            struct ListCustomRoutingAcceleratorsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomRoutingAcceleratorsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCustomRoutingAcceleratorsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCustomRoutingAcceleratorsInput>()
                        .ok_or("failed to downcast to ListCustomRoutingAcceleratorsInput")?;
...
pub enum ListCustomRoutingAcceleratorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCustomRoutingAcceleratorsError) for what information is available for the error.")]
...
impl ListCustomRoutingAcceleratorsError {
    /// Creates the `ListCustomRoutingAcceleratorsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCustomRoutingAcceleratorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCustomRoutingAcceleratorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError {
...
mod _list_custom_routing_accelerators_output;
