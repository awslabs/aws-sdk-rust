...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingAccelerators {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_routing_accelerators::de_list_custom_routing_accelerators_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError
{
