...
impl CreateEndpointGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateEndpointGroup`](crate::operation::create_endpoint_group::CreateEndpointGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_endpoint_group::CreateEndpointGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_endpoint_group::CreateEndpointGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_endpoint_group::CreateEndpointGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEndpointGroup {
                type Output = std::result::Result<crate::operation::create_endpoint_group::CreateEndpointGroupOutput, crate::operation::create_endpoint_group::CreateEndpointGroupError>;
