...
impl WithdrawByoipCidrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrOutput, crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError, Self> {
