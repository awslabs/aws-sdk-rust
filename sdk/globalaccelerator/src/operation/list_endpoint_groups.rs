...
impl ListEndpointGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListEndpointGroups`](crate::operation::list_endpoint_groups::ListEndpointGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_endpoint_groups::ListEndpointGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_endpoint_groups::ListEndpointGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_endpoint_groups::ListEndpointGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListEndpointGroups {
                type Output = std::result::Result<crate::operation::list_endpoint_groups::ListEndpointGroupsOutput, crate::operation::list_endpoint_groups::ListEndpointGroupsError>;
