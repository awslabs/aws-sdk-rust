...
impl ListEndpointGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_endpoint_groups::ListEndpointGroups,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_endpoint_groups::ser_list_endpoint_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEndpointGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_endpoint_groups::de_list_endpoint_groups_http_response_with_props(status, headers, body)
        }
    }
}
