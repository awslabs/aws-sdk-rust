...
impl ListCustomRoutingEndpointGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_custom_routing_endpoint_groups::ListCustomRoutingEndpointGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
