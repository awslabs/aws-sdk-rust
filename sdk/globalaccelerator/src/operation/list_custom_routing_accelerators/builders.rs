...
impl ListCustomRoutingAcceleratorsFluentBuilder  {
    /// Creates a new `ListCustomRoutingAccelerators`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput, aws_smithy_http::result::SdkError<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError>>
                     {
