...
pub use crate::operation::list_custom_routing_accelerators::_list_custom_routing_accelerators_output::ListCustomRoutingAcceleratorsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput,
                    crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError,
                > for ListCustomRoutingAcceleratorsFluentBuilder
            {
                fn send(
                    self,
...
impl ListCustomRoutingAcceleratorsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_custom_routing_accelerators::ListCustomRoutingAccelerators::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsOutput, crate::operation::list_custom_routing_accelerators::ListCustomRoutingAcceleratorsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_custom_routing_accelerators::paginator::ListCustomRoutingAcceleratorsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
