...
impl ListCustomRoutingPortMappingsInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomRoutingPortMappings`](crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingPortMappings {
                type Output = std::result::Result<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsOutput, crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError>;
