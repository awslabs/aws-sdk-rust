...
impl ListCustomRoutingPortMappingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomRoutingPortMappings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_routing_port_mappings::de_list_custom_routing_port_mappings_http_response_with_props(
                status, headers, body,
            )
        }
    }
