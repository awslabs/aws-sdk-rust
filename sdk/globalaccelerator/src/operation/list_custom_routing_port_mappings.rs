...
/// Orchestration and serialization glue logic for `ListCustomRoutingPortMappings`.
...
impl ListCustomRoutingPortMappings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsInput,
                    ) -> ::std::result::Result<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomRoutingPortMappings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCustomRoutingPortMappings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCustomRoutingPortMappingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCustomRoutingPortMappingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomRoutingPortMappings")
...
.with_interceptor(ListCustomRoutingPortMappingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError>::new());
...
#[derive(Debug)]
            struct ListCustomRoutingPortMappingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomRoutingPortMappingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_custom_routing_port_mappings::de_list_custom_routing_port_mappings_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListCustomRoutingPortMappingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomRoutingPortMappingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_custom_routing_port_mappings::ser_list_custom_routing_port_mappings_input(&input)?);
...
#[derive(Debug)]
            struct ListCustomRoutingPortMappingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomRoutingPortMappingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCustomRoutingPortMappingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCustomRoutingPortMappingsInput>()
                        .ok_or("failed to downcast to ListCustomRoutingPortMappingsInput")?;
...
pub enum ListCustomRoutingPortMappingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCustomRoutingPortMappingsError) for what information is available for the error.")]
...
impl ListCustomRoutingPortMappingsError {
    /// Creates the `ListCustomRoutingPortMappingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCustomRoutingPortMappingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCustomRoutingPortMappingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_custom_routing_port_mappings::ListCustomRoutingPortMappingsError {
...
mod _list_custom_routing_port_mappings_output;
