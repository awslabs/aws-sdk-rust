...
/// Orchestration and serialization glue logic for `CreateCustomRoutingListener`.
...
impl CreateCustomRoutingListener {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCustomRoutingListener {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCustomRoutingListener");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCustomRoutingListenerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCustomRoutingListenerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCustomRoutingListener")
...
.with_interceptor(CreateCustomRoutingListenerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError>::new());
...
#[derive(Debug)]
            struct CreateCustomRoutingListenerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCustomRoutingListenerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_custom_routing_listener::de_create_custom_routing_listener_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_custom_routing_listener::de_create_custom_routing_listener_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateCustomRoutingListenerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCustomRoutingListenerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_custom_routing_listener::ser_create_custom_routing_listener_input(&input)?);
...
#[derive(Debug)]
            struct CreateCustomRoutingListenerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCustomRoutingListenerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCustomRoutingListenerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCustomRoutingListenerInput>()
                        .ok_or("failed to downcast to CreateCustomRoutingListenerInput")?;
...
pub enum CreateCustomRoutingListenerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCustomRoutingListenerError) for what information is available for the error.")]
...
impl CreateCustomRoutingListenerError {
    /// Creates the `CreateCustomRoutingListenerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCustomRoutingListenerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCustomRoutingListenerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError {
...
mod _create_custom_routing_listener_output;
