...
impl CreateCustomRoutingListenerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_custom_routing_listener::CreateCustomRoutingListener::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomRoutingListener {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_custom_routing_listener::de_create_custom_routing_listener_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateCustomRoutingListenerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_custom_routing_listener::CreateCustomRoutingListenerError
{
