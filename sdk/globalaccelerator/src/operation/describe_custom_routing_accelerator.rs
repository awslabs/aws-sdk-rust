...
impl DescribeCustomRoutingAccelerator {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeCustomRoutingAcceleratorResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeCustomRoutingAcceleratorRequestSerializer {
