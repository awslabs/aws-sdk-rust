...
/// Orchestration and serialization glue logic for `DescribeCustomRoutingAccelerator`.
...
impl DescribeCustomRoutingAccelerator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCustomRoutingAccelerator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCustomRoutingAccelerator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCustomRoutingAcceleratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCustomRoutingAcceleratorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCustomRoutingAccelerator")
...
.with_interceptor(DescribeCustomRoutingAcceleratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError>::new());
...
#[derive(Debug)]
            struct DescribeCustomRoutingAcceleratorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCustomRoutingAcceleratorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_custom_routing_accelerator::de_describe_custom_routing_accelerator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_custom_routing_accelerator::de_describe_custom_routing_accelerator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeCustomRoutingAcceleratorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCustomRoutingAcceleratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_custom_routing_accelerator::ser_describe_custom_routing_accelerator_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCustomRoutingAcceleratorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCustomRoutingAcceleratorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCustomRoutingAcceleratorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCustomRoutingAcceleratorInput>()
                        .ok_or("failed to downcast to DescribeCustomRoutingAcceleratorInput")?;
...
pub enum DescribeCustomRoutingAcceleratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCustomRoutingAcceleratorError) for what information is available for the error.")]
...
impl DescribeCustomRoutingAcceleratorError {
    /// Creates the `DescribeCustomRoutingAcceleratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCustomRoutingAcceleratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCustomRoutingAcceleratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAcceleratorError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_custom_routing_accelerator::_describe_custom_routing_accelerator_output::DescribeCustomRoutingAcceleratorOutput;

pub use crate::operation::describe_custom_routing_accelerator::_describe_custom_routing_accelerator_input::DescribeCustomRoutingAcceleratorInput;

mod _describe_custom_routing_accelerator_input;

mod _describe_custom_routing_accelerator_output;
