...
impl DescribeCustomRoutingAcceleratorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_custom_routing_accelerator::DescribeCustomRoutingAccelerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCustomRoutingAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_custom_routing_accelerator::de_describe_custom_routing_accelerator_http_response_with_props(
                status, headers, body,
            )
        }
    }
