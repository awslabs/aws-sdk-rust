...
impl CreateEndpointGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_endpoint_group::CreateEndpointGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_endpoint_group::CreateEndpointGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_endpoint_group::CreateEndpointGroupOutput, crate::operation::create_endpoint_group::CreateEndpointGroupError, Self> {
