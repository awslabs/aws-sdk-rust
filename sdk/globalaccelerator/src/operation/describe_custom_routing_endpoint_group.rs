...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCustomRoutingEndpointGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_custom_routing_endpoint_group::de_describe_custom_routing_endpoint_group_http_response_with_props(status, headers, body)
        }
    }
}
