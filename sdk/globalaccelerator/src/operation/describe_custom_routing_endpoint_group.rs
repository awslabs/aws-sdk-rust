...
/// Orchestration and serialization glue logic for `DescribeCustomRoutingEndpointGroup`.
...
impl DescribeCustomRoutingEndpointGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupInput,
                    ) -> ::std::result::Result<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCustomRoutingEndpointGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCustomRoutingEndpointGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCustomRoutingEndpointGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCustomRoutingEndpointGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCustomRoutingEndpointGroup")
...
.with_interceptor(DescribeCustomRoutingEndpointGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError>::new());
...
#[derive(Debug)]
            struct DescribeCustomRoutingEndpointGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCustomRoutingEndpointGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_custom_routing_endpoint_group::de_describe_custom_routing_endpoint_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_custom_routing_endpoint_group::de_describe_custom_routing_endpoint_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeCustomRoutingEndpointGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCustomRoutingEndpointGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_custom_routing_endpoint_group::ser_describe_custom_routing_endpoint_group_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCustomRoutingEndpointGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCustomRoutingEndpointGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCustomRoutingEndpointGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCustomRoutingEndpointGroupInput>()
                        .ok_or("failed to downcast to DescribeCustomRoutingEndpointGroupInput")?;
...
pub enum DescribeCustomRoutingEndpointGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCustomRoutingEndpointGroupError) for what information is available for the error.")]
...
impl DescribeCustomRoutingEndpointGroupError {
    /// Creates the `DescribeCustomRoutingEndpointGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCustomRoutingEndpointGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCustomRoutingEndpointGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_custom_routing_endpoint_group::DescribeCustomRoutingEndpointGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_custom_routing_endpoint_group::_describe_custom_routing_endpoint_group_output::DescribeCustomRoutingEndpointGroupOutput;

pub use crate::operation::describe_custom_routing_endpoint_group::_describe_custom_routing_endpoint_group_input::DescribeCustomRoutingEndpointGroupInput;

mod _describe_custom_routing_endpoint_group_input;

mod _describe_custom_routing_endpoint_group_output;
