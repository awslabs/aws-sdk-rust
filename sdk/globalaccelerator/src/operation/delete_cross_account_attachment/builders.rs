...
impl DeleteCrossAccountAttachmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_cross_account_attachment::DeleteCrossAccountAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cross_account_attachment::DeleteCrossAccountAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_cross_account_attachment::DeleteCrossAccountAttachmentOutput, crate::operation::delete_cross_account_attachment::DeleteCrossAccountAttachmentError, Self> {
