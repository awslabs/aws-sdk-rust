...
impl DescribeListenerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_listener::DescribeListener, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_listener::ser_describe_listener_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeListener {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_listener::de_describe_listener_http_response_with_props(status, headers, body)
        }
    }
}
