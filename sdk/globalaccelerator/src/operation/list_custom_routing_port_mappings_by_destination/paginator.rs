...
impl ListCustomRoutingPortMappingsByDestinationPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_custom_routing_port_mappings_by_destination::paginator::ListCustomRoutingPortMappingsByDestinationPaginatorItems {
...
impl ListCustomRoutingPortMappingsByDestinationPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_custom_routing_port_mappings_by_destination_output_output_destination_port_mappings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
