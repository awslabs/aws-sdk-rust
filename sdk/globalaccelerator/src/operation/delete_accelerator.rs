...
impl DeleteAcceleratorInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_accelerator::DeleteAccelerator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_accelerator::DeleteAcceleratorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAccelerator {
                type Output = std::result::Result<crate::operation::delete_accelerator::DeleteAcceleratorOutput, crate::operation::delete_accelerator::DeleteAcceleratorError>;
