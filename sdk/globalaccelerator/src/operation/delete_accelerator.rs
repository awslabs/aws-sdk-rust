...
impl DeleteAcceleratorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccelerator`](crate::operation::delete_accelerator::DeleteAccelerator)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_accelerator::ser_delete_accelerator_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_accelerator::DeleteAccelerator::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_accelerator::de_delete_accelerator_http_response_with_props(status, headers, body)
        }
    }
}
