...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ProvisionByoipCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ProvisionByoipCidr", "globalaccelerator"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ProvisionByoipCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_provision_byoip_cidr::ser_provision_byoip_cidr_input(&input)?);
