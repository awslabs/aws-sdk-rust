...
impl ::aws_types::request_id::RequestId for DeleteEndpointGroupOutput {
...
impl DeleteEndpointGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteEndpointGroupOutput`](crate::operation::delete_endpoint_group::DeleteEndpointGroupOutput).
    pub fn build(self) -> crate::operation::delete_endpoint_group::DeleteEndpointGroupOutput {
