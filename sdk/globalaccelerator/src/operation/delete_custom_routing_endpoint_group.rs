...
impl DeleteCustomRoutingEndpointGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_custom_routing_endpoint_group::DeleteCustomRoutingEndpointGroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_custom_routing_endpoint_group::DeleteCustomRoutingEndpointGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomRoutingEndpointGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_routing_endpoint_group::de_delete_custom_routing_endpoint_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
