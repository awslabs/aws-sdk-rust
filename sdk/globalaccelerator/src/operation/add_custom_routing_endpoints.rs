...
impl AddCustomRoutingEndpoints {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Global Accelerator.AddCustomRoutingEndpoints",
            "rpc.service" = "Global Accelerator",
            "rpc.method" = "AddCustomRoutingEndpoints",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddCustomRoutingEndpoints {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddCustomRoutingEndpointsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddCustomRoutingEndpointsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddCustomRoutingEndpoints")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddCustomRoutingEndpoints")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AddCustomRoutingEndpointsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AddCustomRoutingEndpointsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddCustomRoutingEndpointsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AddCustomRoutingEndpointsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddCustomRoutingEndpointsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_add_custom_routing_endpoints::de_add_custom_routing_endpoints_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_custom_routing_endpoints::de_add_custom_routing_endpoints_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddCustomRoutingEndpointsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_add_custom_routing_endpoints::ser_add_custom_routing_endpoints_input(&input)?,
        );
...
impl ::std::error::Error for AddCustomRoutingEndpointsError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::EndpointAlreadyExistsException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AddCustomRoutingEndpointsError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::EndpointAlreadyExistsException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
