...
impl DescribeAcceleratorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_accelerator::ser_describe_accelerator_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_accelerator::de_describe_accelerator_http_response_with_props(status, headers, body)
        }
    }
}
