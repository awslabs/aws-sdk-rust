...
impl UpdateListenerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_listener::UpdateListener, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_listener::ser_update_listener_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateListener {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_listener::de_update_listener_http_response_with_props(status, headers, body)
        }
    }
}
