...
impl CreateCustomRoutingAcceleratorInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::create_custom_routing_accelerator::CreateCustomRoutingAcceleratorInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
