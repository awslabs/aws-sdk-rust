...
impl AdvertiseByoipCidrInput {
    /// Consumes the builder and constructs an Operation<[`AdvertiseByoipCidr`](crate::operation::advertise_byoip_cidr::AdvertiseByoipCidr)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_advertise_byoip_cidr::ser_advertise_byoip_cidr_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::advertise_byoip_cidr::AdvertiseByoipCidr::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdvertiseByoipCidr {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_advertise_byoip_cidr::de_advertise_byoip_cidr_http_response_with_props(status, headers, body)
        }
    }
}
