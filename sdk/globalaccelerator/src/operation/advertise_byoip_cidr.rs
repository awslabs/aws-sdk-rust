...
impl AdvertiseByoipCidrInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidr, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for AdvertiseByoipCidr {
                type Output = std::result::Result<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrOutput, crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrError>;
