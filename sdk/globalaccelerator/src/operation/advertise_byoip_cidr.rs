...
impl AdvertiseByoipCidr {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Global Accelerator.AdvertiseByoipCidr",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdvertiseByoipCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AdvertiseByoipCidrRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AdvertiseByoipCidrResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AdvertiseByoipCidr")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdvertiseByoipCidr")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AdvertiseByoipCidrTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AdvertiseByoipCidrTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdvertiseByoipCidrTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AdvertiseByoipCidrInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdvertiseByoipCidrResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_advertise_byoip_cidr::de_advertise_byoip_cidr_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_advertise_byoip_cidr::de_advertise_byoip_cidr_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdvertiseByoipCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_advertise_byoip_cidr::ser_advertise_byoip_cidr_input(&input)?);
...
impl ::std::error::Error for AdvertiseByoipCidrError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::ByoipCidrNotFoundException(_inner) => ::std::option::Option::Some(_inner),
            Self::IncorrectCidrStateException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AdvertiseByoipCidrError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ByoipCidrNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::IncorrectCidrStateException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
