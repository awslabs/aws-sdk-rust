...
impl UpdateAcceleratorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_accelerator::ser_update_accelerator_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccelerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_accelerator::de_update_accelerator_http_response_with_props(status, headers, body)
        }
    }
}
