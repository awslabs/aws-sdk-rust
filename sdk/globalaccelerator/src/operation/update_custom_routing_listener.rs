...
impl UpdateCustomRoutingListener {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_custom_routing_listener::UpdateCustomRoutingListenerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_custom_routing_listener::UpdateCustomRoutingListenerOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Global Accelerator.UpdateCustomRoutingListener",
            "rpc.service" = "Global Accelerator",
            "rpc.method" = "UpdateCustomRoutingListener",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCustomRoutingListener {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateCustomRoutingListenerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateCustomRoutingListenerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateCustomRoutingListener")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateCustomRoutingListener")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateCustomRoutingListenerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateCustomRoutingListenerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateCustomRoutingListenerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateCustomRoutingListenerInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCustomRoutingListenerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_custom_routing_listener::de_update_custom_routing_listener_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_custom_routing_listener::de_update_custom_routing_listener_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCustomRoutingListenerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_custom_routing_listener::UpdateCustomRoutingListenerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_custom_routing_listener::UpdateCustomRoutingListenerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_custom_routing_listener::ser_update_custom_routing_listener_input(&input)?,
        );
