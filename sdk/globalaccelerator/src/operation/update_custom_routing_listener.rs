...
impl UpdateCustomRoutingListenerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_custom_routing_listener::UpdateCustomRoutingListener::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomRoutingListener {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_custom_routing_listener::de_update_custom_routing_listener_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateCustomRoutingListenerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_custom_routing_listener::UpdateCustomRoutingListenerError
{
