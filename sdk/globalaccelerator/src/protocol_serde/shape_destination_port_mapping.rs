...
) -> Result<Option<crate::types::DestinationPortMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AcceleratorSocketAddresses" => {
                            builder =
                                builder.set_accelerator_socket_addresses(crate::protocol_serde::shape_socket_addresses::de_socket_addresses(tokens)?);
                        }
                        "EndpointGroupArn" => {
                        ...
                        "DestinationSocketAddress" => {
                            builder = builder.set_destination_socket_address(crate::protocol_serde::shape_socket_address::de_socket_address(tokens)?);
                        }
                        "IpAddressType" => {
