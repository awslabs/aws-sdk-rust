...
pub fn ser_endpoint_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EndpointIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
