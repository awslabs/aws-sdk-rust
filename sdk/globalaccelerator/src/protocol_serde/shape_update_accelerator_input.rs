...
pub fn ser_update_accelerator_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_accelerator::UpdateAcceleratorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
