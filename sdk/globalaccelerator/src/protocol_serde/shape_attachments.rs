...
pub(crate) fn de_attachments<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Attachment>>, ::aws_smithy_json::deserialize::error::DeserializeError>
