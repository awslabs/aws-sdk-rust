...
pub fn ser_provision_byoip_cidr_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ProvisionByoipCidrInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
