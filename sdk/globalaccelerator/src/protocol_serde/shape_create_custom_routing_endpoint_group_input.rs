...
pub fn ser_create_custom_routing_endpoint_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCustomRoutingEndpointGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
