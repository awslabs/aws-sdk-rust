...
pub fn de_delete_accelerator_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_accelerator::DeleteAcceleratorOutput, crate::operation::delete_accelerator::DeleteAcceleratorError>
{
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "AcceleratorNotDisabledException" => crate::operation::delete_accelerator::DeleteAcceleratorError::AcceleratorNotDisabledException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_accelerator_not_disabled_exception::de_accelerator_not_disabled_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::delete_accelerator::DeleteAcceleratorError::unhandled)?;
        ...
        "AssociatedListenerFoundException" => crate::operation::delete_accelerator::DeleteAcceleratorError::AssociatedListenerFoundException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_associated_listener_found_exception::de_associated_listener_found_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::delete_accelerator::DeleteAcceleratorError::unhandled)?;
