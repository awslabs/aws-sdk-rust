...
impl StartCompositionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_composition::StartCompositionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_composition::StartCompositionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_composition::StartCompositionOutput, crate::operation::start_composition::StartCompositionError, Self> {
