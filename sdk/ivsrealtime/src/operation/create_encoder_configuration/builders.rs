...
impl CreateEncoderConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_encoder_configuration::CreateEncoderConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_encoder_configuration::CreateEncoderConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_encoder_configuration::CreateEncoderConfigurationOutput, crate::operation::create_encoder_configuration::CreateEncoderConfigurationError, Self> {
