...
impl crate::operation::create_encoder_configuration::builders::CreateEncoderConfigurationInputBuilder {
...
impl CreateEncoderConfigurationFluentBuilder {
    /// Creates a new `CreateEncoderConfigurationFluentBuilder`.
