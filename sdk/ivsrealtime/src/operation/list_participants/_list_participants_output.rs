...
impl  ListParticipantsOutput  {
    ...
    pub fn participants(&self) -> & [crate::types::ParticipantSummary] {
        use std::ops::Deref; self.participants.deref()
    }
    /// <p>If there are more participants than <code>maxResults</code>, use <code>nextToken</code> in the request to get the next set.</p>
...
impl ListParticipantsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_participants::ListParticipantsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_participants::ListParticipantsOutput {
                participants: self.participants
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("participants", "participants was not specified but it is required when building ListParticipantsOutput")
                    )?
                ,
