...
impl  ListStorageConfigurationsOutput  {
    ...
    pub fn storage_configurations(&self) -> & [crate::types::StorageConfigurationSummary] {
        use std::ops::Deref; self.storage_configurations.deref()
    }
    /// <p>If there are more storage configurations than <code>maxResults</code>, use <code>nextToken</code> in the request to get the next set.</p>
...
impl ListStorageConfigurationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_storage_configurations::ListStorageConfigurationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_storage_configurations::ListStorageConfigurationsOutput {
                storage_configurations: self.storage_configurations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("storage_configurations", "storage_configurations was not specified but it is required when building ListStorageConfigurationsOutput")
                    )?
                ,
