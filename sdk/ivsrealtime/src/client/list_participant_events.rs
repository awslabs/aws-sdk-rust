...
impl super::Client {
    ...
    ///   - [`stage_arn(impl Into<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::stage_arn) / [`set_stage_arn(Option<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::set_stage_arn): <p>Stage ARN.</p>
    ///   - [`session_id(impl Into<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::set_session_id): <p>ID of a session within the stage.</p>
    ///   - [`participant_id(impl Into<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::participant_id) / [`set_participant_id(Option<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::set_participant_id): <p>Unique identifier for this participant. This is assigned by IVS and returned by <code>CreateParticipantToken</code>.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_participant_events::builders::ListParticipantEventsFluentBuilder::set_next_token): <p>The first participant to retrieve. This is used for pagination; see the <code>nextToken</code> response field.</p>
