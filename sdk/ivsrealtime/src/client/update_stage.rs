...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::update_stage::builders::UpdateStageFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_stage::builders::UpdateStageFluentBuilder::set_arn): <p>ARN of the stage to be updated.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_stage::builders::UpdateStageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_stage::builders::UpdateStageFluentBuilder::set_name): <p>Name of the stage to be updated.</p>
