...
impl super::Client {
    ...
    ///   - [`auto_participant_recording_configuration(AutoParticipantRecordingConfiguration)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::auto_participant_recording_configuration) / [`set_auto_participant_recording_configuration(Option<AutoParticipantRecordingConfiguration>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_auto_participant_recording_configuration):<br>required: **false**<br><p>Configuration object for individual participant recording, to attach to the new stage.</p><br>
