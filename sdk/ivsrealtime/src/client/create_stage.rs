...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_name): <p>Optional name that can be specified for the stage being created.</p>
