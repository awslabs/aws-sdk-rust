...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the stage to be deleted.</p><br>
