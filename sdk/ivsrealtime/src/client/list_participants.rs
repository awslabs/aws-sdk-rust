...
impl super::Client {
    ...
    ///   - [`stage_arn(impl Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::stage_arn) / [`set_stage_arn(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_stage_arn): <p>Stage ARN.</p>
    ///   - [`session_id(impl Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_session_id): <p>ID of the session within the stage.</p>
