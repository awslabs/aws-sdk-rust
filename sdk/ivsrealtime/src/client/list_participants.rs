...
impl super::Client {
    ...
    ///   - [`stage_arn(impl ::std::convert::Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::stage_arn) / [`set_stage_arn(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_stage_arn): <p>Stage ARN.</p>
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_session_id): <p>ID of the session within the stage.</p>
    ///   - [`filter_by_user_id(impl ::std::convert::Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::filter_by_user_id) / [`set_filter_by_user_id(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_filter_by_user_id): <p>Filters the response list to match the specified user ID. Only one of <code>filterByUserId</code>, <code>filterByPublished</code>, or <code>filterByState</code> can be provided per request. A <code>userId</code> is a customer-assigned name to help identify the token; this can be used to link a participant to a user in the customer’s own systems.</p>
    ///   - [`filter_by_published(bool)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::filter_by_published) / [`set_filter_by_published(Option<bool>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_filter_by_published): <p>Filters the response list to only show participants who published during the stage session. Only one of <code>filterByUserId</code>, <code>filterByPublished</code>, or <code>filterByState</code> can be provided per request.</p>
    ///   - [`filter_by_state(ParticipantState)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::filter_by_state) / [`set_filter_by_state(Option<ParticipantState>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_filter_by_state): <p>Filters the response list to only show participants in the specified state. Only one of <code>filterByUserId</code>, <code>filterByPublished</code>, or <code>filterByState</code> can be provided per request.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_next_token): <p>The first participant to retrieve. This is used for pagination; see the <code>nextToken</code> response field.</p>
    ///   - [`max_results(i32)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_participants::builders::ListParticipantsFluentBuilder::set_max_results): <p>Maximum number of results to return. Default: 50.</p>
