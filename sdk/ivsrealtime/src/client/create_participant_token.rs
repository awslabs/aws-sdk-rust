...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::create_participant_token::builders::CreateParticipantTokenFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::create_participant_token::builders::CreateParticipantTokenFluentBuilder::set_user_id): <p>Name that can be specified to help identify the token. This can be any UTF-8 encoded text. <i>This field is exposed to all stage participants and should not be used for personally identifying, confidential, or sensitive information.</i> </p>
