...
impl super::Client  {
    ...
    ///   - [`duration(i32)`](crate::operation::create_participant_token::builders::CreateParticipantTokenFluentBuilder::duration) / [`set_duration(i32)`](crate::operation::create_participant_token::builders::CreateParticipantTokenFluentBuilder::set_duration): <p>Duration (in minutes), after which the token expires. Default: 60 (1 hour).</p>
