...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_stage::builders::GetStageFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::get_stage::builders::GetStageFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the stage for which the information is to be retrieved.</p><br>
