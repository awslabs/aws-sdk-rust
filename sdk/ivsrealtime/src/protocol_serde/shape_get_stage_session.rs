...
pub fn de_get_stage_session_http_error(
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_stage_session::GetStageSessionError::unhandled)?;
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_stage_session::GetStageSessionError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_stage_session_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_stage_session::de_get_stage_session(_response_body, output)
            .map_err(crate::operation::get_stage_session::GetStageSessionError::unhandled)?;
...
pub(crate) fn de_get_stage_session(
    _value: &[u8],
    mut builder: crate::operation::get_stage_session::builders::GetStageSessionOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_stage_session::builders::GetStageSessionOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "stageSession" => {
                    builder = builder.set_stage_session(crate::protocol_serde::shape_stage_session::de_stage_session(tokens, _value, depth + 1)?);
                }
