            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::list_stage_sessions::ListStageSessionsError::unhandled(
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "stageSessions" => {
                    builder = builder.set_stage_sessions(crate::protocol_serde::shape_stage_session_list::de_stage_session_list(tokens, _value)?);
                }
