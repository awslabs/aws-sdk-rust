                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "autoParticipantRecordingConfiguration" => {
                                builder = builder.set_auto_participant_recording_configuration(
                                    crate::protocol_serde::shape_auto_participant_recording_configuration::de_auto_participant_recording_configuration(tokens, _value, depth + 1)?
                                );
                            }
                            "endpoints" => {
                                builder = builder.set_endpoints(crate::protocol_serde::shape_stage_endpoints::de_stage_endpoints(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
