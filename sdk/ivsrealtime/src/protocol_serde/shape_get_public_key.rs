...
pub fn de_get_public_key_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_public_key::GetPublicKeyError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::get_public_key::GetPublicKeyError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
                ...
                output = output.set_x_amzn_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_x_amzn_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::get_public_key::GetPublicKeyError::unhandled("Failed to parse xAmznErrorType from header `x-amzn-ErrorType")
                    })?,
                );
                ...
                output = output.set_x_frame_options(
                    crate::protocol_serde::shape_access_denied_exception::de_x_frame_options_header(_response_headers).map_err(|_| {
                        crate::operation::get_public_key::GetPublicKeyError::unhandled("Failed to parse xFrameOptions from header `X-Frame-Options")
                    })?,
                );
        ...
        "ResourceNotFoundException" => crate::operation::get_public_key::GetPublicKeyError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_public_key::GetPublicKeyError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
