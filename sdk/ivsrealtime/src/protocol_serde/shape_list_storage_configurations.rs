...
pub fn de_list_storage_configurations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_storage_configurations::ListStorageConfigurationsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_storage_configurations::ListStorageConfigurationsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::list_storage_configurations::ListStorageConfigurationsError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::list_storage_configurations::ListStorageConfigurationsError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_storage_configurations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_storage_configurations::de_list_storage_configurations(_response_body, output)
            .map_err(crate::operation::list_storage_configurations::ListStorageConfigurationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_storage_configurations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_storage_configurations::ListStorageConfigurationsError::unhandled)?
    })
}

pub fn ser_list_storage_configurations_input(
...
pub(crate) fn de_list_storage_configurations(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "storageConfigurations" => {
                    builder = builder.set_storage_configurations(
                        crate::protocol_serde::shape_storage_configuration_summary_list::de_storage_configuration_summary_list(tokens, _value)?,
                    );
                }
