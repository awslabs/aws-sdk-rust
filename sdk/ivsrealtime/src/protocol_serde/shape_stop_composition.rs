...
pub fn de_stop_composition_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::stop_composition::StopCompositionOutput, crate::operation::stop_composition::StopCompositionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::stop_composition::StopCompositionError::unhandled)?;
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::stop_composition::StopCompositionError::unhandled(
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::stop_composition::StopCompositionError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_composition_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::stop_composition::StopCompositionOutput, crate::operation::stop_composition::StopCompositionError> {
...
pub fn ser_stop_composition_input(
    input: &crate::operation::stop_composition::StopCompositionInput,
