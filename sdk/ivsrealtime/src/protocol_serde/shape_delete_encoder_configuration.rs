...
pub fn de_delete_encoder_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_encoder_configuration::DeleteEncoderConfigurationError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::delete_encoder_configuration::DeleteEncoderConfigurationError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::delete_encoder_configuration::DeleteEncoderConfigurationError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_encoder_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_delete_encoder_configuration_input(
    input: &crate::operation::delete_encoder_configuration::DeleteEncoderConfigurationInput,
