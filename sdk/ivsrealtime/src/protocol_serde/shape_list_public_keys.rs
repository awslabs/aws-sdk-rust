...
pub fn de_list_public_keys_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_public_keys::ListPublicKeysError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::list_public_keys::ListPublicKeysError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
        ...
        "ValidationException" => crate::operation::list_public_keys::ListPublicKeysError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_public_keys_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_public_keys_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_public_keys::ListPublicKeysError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "publicKeys" => {
                    builder = builder.set_public_keys(crate::protocol_serde::shape_public_key_list::de_public_key_list(tokens, _value)?);
                }
