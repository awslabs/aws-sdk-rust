...
> {
    Ok({
        ...
        output = output.set_access_control_allow_origin(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_access_control_allow_origin_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_access_control_expose_headers(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_access_control_expose_headers_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_cache_control(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_cache_control_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_security_policy(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_content_security_policy_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_strict_transport_security(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_strict_transport_security_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_x_content_type_options(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_x_content_type_options_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_x_frame_options(
            match crate::protocol_serde::shape_stop_participant_replication_output::de_x_frame_options_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
