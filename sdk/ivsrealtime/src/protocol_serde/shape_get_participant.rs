...
pub fn de_get_participant_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_participant::GetParticipantOutput, crate::operation::get_participant::GetParticipantError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::get_participant::GetParticipantError::unhandled(
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::get_participant::GetParticipantError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
...
pub fn de_get_participant_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_participant::de_get_participant(_response_body, output)
            .map_err(crate::operation::get_participant::GetParticipantError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "participant" => {
                    builder = builder.set_participant(crate::protocol_serde::shape_participant::de_participant(tokens, _value, depth + 1)?);
                }
