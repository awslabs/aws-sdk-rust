...
pub fn de_get_encoder_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_encoder_configuration::GetEncoderConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_encoder_configuration::GetEncoderConfigurationError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::get_encoder_configuration::GetEncoderConfigurationError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::get_encoder_configuration::GetEncoderConfigurationError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_encoder_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_encoder_configuration::de_get_encoder_configuration(_response_body, output)
            .map_err(crate::operation::get_encoder_configuration::GetEncoderConfigurationError::unhandled)?;
...
pub fn ser_get_encoder_configuration_input(
...
pub(crate) fn de_get_encoder_configuration(
    value: &[u8],
    mut builder: crate::operation::get_encoder_configuration::builders::GetEncoderConfigurationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_encoder_configuration::builders::GetEncoderConfigurationOutputBuilder,
