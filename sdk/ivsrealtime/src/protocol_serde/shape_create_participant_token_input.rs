...
pub fn ser_create_participant_token_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_participant_token::CreateParticipantTokenInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
