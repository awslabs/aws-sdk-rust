                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "encoderConfigurationArns" => {
                                builder = builder.set_encoder_configuration_arns(
                                    crate::protocol_serde::shape_encoder_configuration_arn_list::de_encoder_configuration_arn_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "thumbnailConfigurations" => {
                                builder = builder.set_thumbnail_configurations(
                                    crate::protocol_serde::shape_composition_thumbnail_configuration_list::de_composition_thumbnail_configuration_list(tokens, _value, depth + 1)?
                                );
                            }
