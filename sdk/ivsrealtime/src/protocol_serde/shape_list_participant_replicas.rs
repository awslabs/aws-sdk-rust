...
pub fn de_list_participant_replicas_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_participant_replicas::ListParticipantReplicasError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_participant_replicas::ListParticipantReplicasError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_participant_replicas::ListParticipantReplicasError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::list_participant_replicas::ListParticipantReplicasError::unhandled(
        ...
        "ValidationException" => crate::operation::list_participant_replicas::ListParticipantReplicasError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::list_participant_replicas::ListParticipantReplicasError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_participant_replicas_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_participant_replicas::builders::ListParticipantReplicasOutputBuilder::default();
        output = crate::protocol_serde::shape_list_participant_replicas::de_list_participant_replicas(_response_body, output)
            .map_err(crate::operation::list_participant_replicas::ListParticipantReplicasError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_participant_replicas_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_participant_replicas::ListParticipantReplicasError::unhandled)?
    })
}

pub fn ser_list_participant_replicas_input(
    input: &crate::operation::list_participant_replicas::ListParticipantReplicasInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_list_participant_replicas_input::ser_list_participant_replicas_input_input(&mut object, input)?;
    object.finish();
