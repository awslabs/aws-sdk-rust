...
pub fn de_get_ingest_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_ingest_configuration::GetIngestConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_ingest_configuration::GetIngestConfigurationError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_ingest_configuration::GetIngestConfigurationError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::get_ingest_configuration::GetIngestConfigurationError::unhandled(
        ...
        "ResourceNotFoundException" => crate::operation::get_ingest_configuration::GetIngestConfigurationError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_ingest_configuration::GetIngestConfigurationError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_ingest_configuration::GetIngestConfigurationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ingest_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_ingest_configuration::builders::GetIngestConfigurationOutputBuilder::default();
        output = crate::protocol_serde::shape_get_ingest_configuration::de_get_ingest_configuration(_response_body, output)
            .map_err(crate::operation::get_ingest_configuration::GetIngestConfigurationError::unhandled)?;
...
pub fn ser_get_ingest_configuration_input(
    input: &crate::operation::get_ingest_configuration::GetIngestConfigurationInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_get_ingest_configuration_input::ser_get_ingest_configuration_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_get_ingest_configuration(
    value: &[u8],
    mut builder: crate::operation::get_ingest_configuration::builders::GetIngestConfigurationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_ingest_configuration::builders::GetIngestConfigurationOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ingestConfiguration" => {
                    builder = builder.set_ingest_configuration(crate::protocol_serde::shape_ingest_configuration::de_ingest_configuration(tokens)?);
                }
