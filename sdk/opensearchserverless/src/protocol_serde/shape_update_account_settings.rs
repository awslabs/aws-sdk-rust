...
> {
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => crate::operation::update_account_settings::UpdateAccountSettingsError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                match key.to_unescaped()?.as_ref() {
                    "accountSettingsDetail" => {
                        builder = builder.set_account_settings_detail(
                            crate::protocol_serde::shape_account_settings_detail::de_account_settings_detail(tokens, _value, depth + 1)?,
                        );
                    }
