...
> {
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::get_account_settings::GetAccountSettingsError::InternalServerException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::get_account_settings::GetAccountSettingsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
