...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::batch_get_collection::builders::BatchGetCollectionFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::batch_get_collection::builders::BatchGetCollectionFluentBuilder::set_ids): <p>A list of collection IDs. You can't provide names and IDs in the same request. The ID is part of the collection endpoint. You can also retrieve it using the <a href="https://docs.aws.amazon.com/opensearch-service/latest/ServerlessAPIReference/API_ListCollections.html">ListCollections</a> API.</p>
    ///   - [`names(impl Into<String>)`](crate::operation::batch_get_collection::builders::BatchGetCollectionFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::batch_get_collection::builders::BatchGetCollectionFluentBuilder::set_names): <p>A list of collection names. You can't provide names and IDs in the same request.</p>
