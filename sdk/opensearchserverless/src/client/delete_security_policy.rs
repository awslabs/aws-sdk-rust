...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_security_policy::builders::DeleteSecurityPolicyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_security_policy::builders::DeleteSecurityPolicyFluentBuilder::set_name): <p>The name of the policy to delete.</p>
