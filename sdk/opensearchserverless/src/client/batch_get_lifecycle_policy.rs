...
impl super::Client {
    ...
    ///   - [`identifiers(LifecyclePolicyIdentifier)`](crate::operation::batch_get_lifecycle_policy::builders::BatchGetLifecyclePolicyFluentBuilder::identifiers) / [`set_identifiers(Option<Vec<LifecyclePolicyIdentifier>>)`](crate::operation::batch_get_lifecycle_policy::builders::BatchGetLifecyclePolicyFluentBuilder::set_identifiers): <p>The unique identifiers of policy types and policy names.</p>
