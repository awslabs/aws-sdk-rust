...
impl super::Client {
    ...
    ///   - [`resource(Vec<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::resource) / [`set_resource(Option<Vec<String>>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_resource): <p>Resource filters (can be collections or indexes) that policies can apply to.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_next_token): <p>If your initial <code>ListAccessPolicies</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>ListAccessPolicies</code> operations, which returns results in the next page. </p>
