...
impl super::Client {
    ...
    ///   - [`r#type(AccessPolicyType)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::type) / [`set_type(AccessPolicyType)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_type):<br>required: **true**<br><p>The type of access policy.</p><br>
