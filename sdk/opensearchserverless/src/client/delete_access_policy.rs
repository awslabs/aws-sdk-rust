...
impl super::Client {
    ...
    ///   - [`r#type(AccessPolicyType)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::type) / [`set_type(Option<AccessPolicyType>)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::set_type):<br>required: **true**<br><p>The type of policy.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::set_name):<br>required: **true**<br><p>The name of the policy to delete.</p><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_access_policy::builders::DeleteAccessPolicyFluentBuilder::set_client_token):<br>required: **false**<br><p>Unique, case-sensitive identifier to ensure idempotency of the request.</p><br>
