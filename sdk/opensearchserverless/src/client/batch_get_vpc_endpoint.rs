...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::batch_get_vpc_endpoint::builders::BatchGetVpcEndpointFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::batch_get_vpc_endpoint::builders::BatchGetVpcEndpointFluentBuilder::set_ids): <p>A list of VPC endpoint identifiers.</p>
