...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_vpc_endpoint::builders::UpdateVpcEndpointFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_vpc_endpoint::builders::UpdateVpcEndpointFluentBuilder::set_id): <p>The unique identifier of the interface endpoint to update.</p>
