...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_vpc_endpoint::builders::UpdateVpcEndpointFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::update_vpc_endpoint::builders::UpdateVpcEndpointFluentBuilder::set_id):<br>required: **true**<br><p>The unique identifier of the interface endpoint to update.</p><br>
