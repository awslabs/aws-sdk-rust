...
impl super::Client {
    ...
    ///   - [`r#type(LifecyclePolicyType)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::type) / [`set_type(Option<LifecyclePolicyType>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::set_type): <p>The type of lifecycle policy.</p>
    ///   - [`resources(impl Into<String>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::resources) / [`set_resources(Option<Vec<String>>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::set_resources): <p>Resource filters that policies can apply to. Currently, the only supported resource type is <code>index</code>.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::set_next_token): <p>If your initial <code>ListLifecyclePolicies</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>ListLifecyclePolicies</code> operations, which returns results in the next page.</p>
    ///   - [`max_results(i32)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_lifecycle_policies::builders::ListLifecyclePoliciesFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use use <code>nextToken</code> to get the next page of results. The default is 10.</p>
