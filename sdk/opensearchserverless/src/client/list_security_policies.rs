...
impl super::Client {
    ...
    ///   - [`r#type(SecurityPolicyType)`](crate::operation::list_security_policies::builders::ListSecurityPoliciesFluentBuilder::type) / [`set_type(SecurityPolicyType)`](crate::operation::list_security_policies::builders::ListSecurityPoliciesFluentBuilder::set_type):<br>required: **true**<br><p>The type of policy.</p><br>
