...
impl CreateVpcEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_vpc_endpoint::ser_create_vpc_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_endpoint::de_create_vpc_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
