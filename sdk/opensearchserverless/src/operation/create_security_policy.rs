...
impl CreateSecurityPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_security_policy::ser_create_security_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_security_policy::CreateSecurityPolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_security_policy::CreateSecurityPolicyError
{
