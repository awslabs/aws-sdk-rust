...
impl DeleteAccessPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_access_policy::ser_delete_access_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_access_policy::de_delete_access_policy_http_response_with_props(status, headers, body)
        }
    }
}
