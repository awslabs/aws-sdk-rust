...
impl GetPoliciesStatsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_policies_stats::GetPoliciesStats,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_policies_stats::ser_get_policies_stats_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPoliciesStats {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_policies_stats::de_get_policies_stats_http_response_with_props(status, headers, body)
        }
    }
}
