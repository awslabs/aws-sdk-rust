...
impl ListLifecyclePoliciesFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_lifecycle_policies::ListLifecyclePoliciesError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_lifecycle_policies::paginator::ListLifecyclePoliciesPaginator::send) which returns a `Stream`.
