...
impl ListAccessPoliciesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_access_policies::ser_list_access_policies_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccessPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_access_policies::de_list_access_policies_http_response_with_props(status, headers, body)
        }
    }
}
