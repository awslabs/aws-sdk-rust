...
impl DeleteSecurityConfigFluentBuilder  {
    /// Creates a new `DeleteSecurityConfig`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_security_config::DeleteSecurityConfigOutput, aws_smithy_http::result::SdkError<crate::operation::delete_security_config::DeleteSecurityConfigError>>
                     {
