...
impl UpdateSecurityConfigInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_security_config::ser_update_security_config_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_security_config::UpdateSecurityConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_security_config::UpdateSecurityConfigError
{
