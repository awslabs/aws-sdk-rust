...
impl DeleteVpcEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_vpc_endpoint::ser_delete_vpc_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_endpoint::de_delete_vpc_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
