...
impl DeleteVpcEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVpcEndpoint`](crate::operation::delete_vpc_endpoint::DeleteVpcEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_vpc_endpoint::DeleteVpcEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vpc_endpoint::DeleteVpcEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vpc_endpoint::ser_delete_vpc_endpoint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vpc_endpoint::DeleteVpcEndpoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVpcEndpoint {
                type Output = std::result::Result<crate::operation::delete_vpc_endpoint::DeleteVpcEndpointOutput, crate::operation::delete_vpc_endpoint::DeleteVpcEndpointError>;
