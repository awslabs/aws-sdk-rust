...
impl ListSecurityConfigsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_security_configs::ser_list_security_configs_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_security_configs::ListSecurityConfigs::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_security_configs::ListSecurityConfigsError
{
