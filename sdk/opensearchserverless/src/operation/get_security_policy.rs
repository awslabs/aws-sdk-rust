...
impl GetSecurityPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_security_policy::GetSecurityPolicy,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_security_policy::ser_get_security_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSecurityPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_security_policy::de_get_security_policy_http_response_with_props(status, headers, body)
        }
    }
}
