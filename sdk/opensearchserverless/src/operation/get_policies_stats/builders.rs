...
impl GetPoliciesStatsFluentBuilder  {
    /// Creates a new `GetPoliciesStats`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_policies_stats::GetPoliciesStats, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_policies_stats::GetPoliciesStatsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_policies_stats::GetPoliciesStatsOutput, aws_smithy_http::result::SdkError<crate::operation::get_policies_stats::GetPoliciesStatsError>>
                     {
