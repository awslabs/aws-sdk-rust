...
impl UpdateSecurityPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_security_policy::UpdateSecurityPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSecurityPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_security_policy::de_update_security_policy_http_response_with_props(status, headers, body)
        }
    }
}
