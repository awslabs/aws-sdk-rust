...
impl UpdateSecurityPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_security_policy::ser_update_security_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_security_policy::UpdateSecurityPolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_security_policy::UpdateSecurityPolicyError
{
