...
impl CreateSecurityConfigInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_security_config::ser_create_security_config_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_security_config::CreateSecurityConfig::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_security_config::CreateSecurityConfigError
{
