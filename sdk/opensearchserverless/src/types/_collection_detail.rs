...
pub struct CollectionDetail {
    ...
    pub fips_endpoints: ::std::option::Option<crate::types::FipsEndpoints>,
...
impl CollectionDetail {
    ...
    /// <p>FIPS-compliant endpoints for the collection. These endpoints use FIPS 140-3 validated cryptographic modules and are required for federal government workloads that must comply with FedRAMP security standards.</p>
    pub fn fips_endpoints(&self) -> ::std::option::Option<&crate::types::FipsEndpoints> {
        self.fips_endpoints.as_ref()
    }
    /// <p>A failure code associated with the request.</p>
...
impl CollectionDetailBuilder {
    ...
    /// <p>FIPS-compliant endpoints for the collection. These endpoints use FIPS 140-3 validated cryptographic modules and are required for federal government workloads that must comply with FedRAMP security standards.</p>
    pub fn fips_endpoints(mut self, input: crate::types::FipsEndpoints) -> Self {
        self.fips_endpoints = ::std::option::Option::Some(input);
        self
    }
    /// <p>FIPS-compliant endpoints for the collection. These endpoints use FIPS 140-3 validated cryptographic modules and are required for federal government workloads that must comply with FedRAMP security standards.</p>
    pub fn set_fips_endpoints(mut self, input: ::std::option::Option<crate::types::FipsEndpoints>) -> Self {
        self.fips_endpoints = input;
        self
    }
    /// <p>FIPS-compliant endpoints for the collection. These endpoints use FIPS 140-3 validated cryptographic modules and are required for federal government workloads that must comply with FedRAMP security standards.</p>
    pub fn get_fips_endpoints(&self) -> &::std::option::Option<crate::types::FipsEndpoints> {
        &self.fips_endpoints
    }
    /// <p>A failure code associated with the request.</p>
