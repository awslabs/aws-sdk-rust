...
impl Builder {
    ...
    /// use aws_sdk_robomaker::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_robomaker::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
