...
pub struct RenderingEngine  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::RenderingEngineType>,
...
pub struct RobotSoftwareSuite  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::RobotSoftwareSuiteType>,
    /// <p>The version of the robot software suite (ROS distribution).</p>
    #[doc(hidden)]pub version: std::option::Option<crate::model::RobotSoftwareSuiteVersionType>,
}
...
pub struct SimulationSoftwareSuite  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::SimulationSoftwareSuiteType>,
...
pub struct DeploymentApplicationConfig  {
    ...
    #[doc(hidden)]pub launch_config: std::option::Option<crate::model::DeploymentLaunchConfig>,
}
...
pub struct DeploymentLaunchConfig  {
    ...
    #[doc(hidden)]pub pre_launch_file: std::option::Option<std::string::String>,
    /// <p>The launch file name.</p>
    #[doc(hidden)]pub launch_file: std::option::Option<std::string::String>,
    /// <p>The deployment post-launch file. This file will be executed after the launch file.</p>
    #[doc(hidden)]pub post_launch_file: std::option::Option<std::string::String>,
...
pub struct DeploymentConfig  {
    ...
    #[doc(hidden)]pub concurrent_deployment_percentage: std::option::Option<i32>,
    /// <p>The percentage of deployments that need to fail before stopping deployment.</p>
    #[doc(hidden)]pub failure_threshold_percentage: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub robot_deployment_timeout_in_seconds: std::option::Option<i64>,
    /// <p>The download condition file.</p>
    #[doc(hidden)]pub download_condition_file: std::option::Option<crate::model::S3Object>,
}
...
impl  std::fmt::Debug for DeploymentConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("concurrent_deployment_percentage", &self.concurrent_deployment_percentage);
        formatter.field("failure_threshold_percentage", &self.failure_threshold_percentage);
        formatter.field("robot_deployment_timeout_in_seconds", &self.robot_deployment_timeout_in_seconds);
...
pub struct SimulationJobSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::SimulationJobStatus>,
    /// <p>A list of simulation job simulation application names.</p>
    #[doc(hidden)]pub simulation_application_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of simulation job robot application names.</p>
    #[doc(hidden)]pub robot_application_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The names of the data sources.</p>
    #[doc(hidden)]pub data_source_names: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for SimulationJobSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("simulation_application_names", &self.simulation_application_names);
...
pub struct SimulationJobRequest  {
    ...
    #[doc(hidden)]pub use_default_applications: std::option::Option<bool>,
...
pub struct Compute  {
    ...
    #[doc(hidden)]pub simulation_unit_limit: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub gpu_unit_limit: std::option::Option<i32>,
}
impl Compute {
    /// <p>The simulation unit limit. Your simulation is allocated CPU and memory proportional to the supplied simulation unit limit. A simulation unit is 1 vcpu and 2GB of memory. You are only billed for the SU utilization you consume up to the maximum value provided. The default is 15. </p>
...
pub struct VpcConfig  {
    ...
    #[doc(hidden)]pub assign_public_ip: bool,
}
impl VpcConfig {
    /// <p>A list of one or more subnet IDs in your VPC.</p>
...
pub struct SimulationApplicationConfig  {
    ...
    #[doc(hidden)]pub launch_config: std::option::Option<crate::model::LaunchConfig>,
    /// <p>Information about upload configurations for the simulation application.</p>
    #[doc(hidden)]pub upload_configurations: std::option::Option<std::vec::Vec<crate::model::UploadConfiguration>>,
    /// <p>A list of world configurations.</p>
    #[doc(hidden)]pub world_configs: std::option::Option<std::vec::Vec<crate::model::WorldConfig>>,
    ...
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]#[doc(hidden)]pub use_default_upload_configurations: std::option::Option<bool>,
    /// <p>Information about tools configured for the simulation application.</p>
    #[doc(hidden)]pub tools: std::option::Option<std::vec::Vec<crate::model::Tool>>,
    ...
    /// <p>This API is no longer supported and will throw an error if used.</p> 
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]#[doc(hidden)]pub use_default_tools: std::option::Option<bool>,
}
impl SimulationApplicationConfig {
    ...
    /// <p>This API is no longer supported and will throw an error if used.</p> 
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn use_default_upload_configurations(&self) -> std::option::Option<bool> {
    ...
    /// <p>This API is no longer supported and will throw an error if used.</p> 
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn use_default_tools(&self) -> std::option::Option<bool> {
...
impl  std::fmt::Debug for SimulationApplicationConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("use_default_upload_configurations", &self.use_default_upload_configurations);
...
pub mod simulation_application_config {
    ...
    impl Builder {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn use_default_upload_configurations(mut self, input: bool) -> Self {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn set_use_default_upload_configurations(mut self, input: std::option::Option<bool>) -> Self {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn use_default_tools(mut self, input: bool) -> Self {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn set_use_default_tools(mut self, input: std::option::Option<bool>) -> Self {
...
pub struct Tool  {
    ...
    #[doc(hidden)]pub stream_ui: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub stream_output_to_cloud_watch: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub exit_behavior: std::option::Option<crate::model::ExitBehavior>,
}
impl Tool {
    /// <p>Boolean indicating whether a streaming session will be configured for the tool. If <code>True</code>, AWS RoboMaker will configure a connection so you can interact with the tool as it is running in the simulation. It must have a graphical user interface. The default is <code>False</code>. </p>
...
impl  std::fmt::Debug for Tool  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("stream_output_to_cloud_watch", &self.stream_output_to_cloud_watch);
...
pub struct UploadConfiguration  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub upload_behavior: std::option::Option<crate::model::UploadBehavior>,
}
...
pub struct LaunchConfig  {
    ...
    #[doc(hidden)]pub port_forwarding_config: std::option::Option<crate::model::PortForwardingConfig>,
    ...
    #[doc(hidden)]pub command: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl LaunchConfig {
    /// <p>The package name.</p>
    pub fn package_name(&self) -> std::option::Option<& str> {
...
pub struct LoggingConfig  {
    ...
    /// <p>This API is no longer supported and will throw an error if used.</p> 
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]#[doc(hidden)]pub record_all_ros_topics: std::option::Option<bool>,
}
impl LoggingConfig {
    /// <p>A boolean indicating whether to record all ROS topics.</p> <important> 
    /// <p>This API is no longer supported and will throw an error if used.</p> 
    /// </important>
    #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn record_all_ros_topics(&self) -> std::option::Option<bool> {
...
pub mod logging_config {
    ...
    impl Builder {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn record_all_ros_topics(mut self, input: bool) -> Self {
        ...
        /// <p>This API is no longer supported and will throw an error if used.</p> 
        /// </important>
        #[deprecated(note = "AWS RoboMaker is ending support for ROS software suite. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/software-support-policy.html.")]pub fn set_record_all_ros_topics(mut self, input: std::option::Option<bool>) -> Self {
...
pub struct FailedCreateSimulationJobRequest  {
    ...
    #[doc(hidden)]pub request: std::option::Option<crate::model::SimulationJobRequest>,
    ...
    #[doc(hidden)]pub failure_code: std::option::Option<crate::model::SimulationJobErrorCode>,
    /// <p>The time, in milliseconds since the epoch, when the simulation job batch failed.</p>
    #[doc(hidden)]pub failed_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct WorldCount  {
    ...
    #[doc(hidden)]pub floorplan_count: std::option::Option<i32>,
    /// <p>The number of unique interiors per floorplan.</p>
    #[doc(hidden)]pub interior_count_per_floorplan: std::option::Option<i32>,
}
impl WorldCount {
    /// <p>The number of unique floorplans.</p>
...
impl  std::fmt::Debug for WorldCount  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("interior_count_per_floorplan", &self.interior_count_per_floorplan);
        formatter.finish()
    }
}
...
pub struct WorldExportJobSummary  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub status: std::option::Option<crate::model::WorldExportJobStatus>,
...
pub struct SimulationJobBatchSummary  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub status: std::option::Option<crate::model::SimulationJobBatchStatus>,
    /// <p>The number of failed simulation job requests.</p>
    #[doc(hidden)]pub failed_request_count: i32,
    /// <p>The number of pending simulation job requests.</p>
    #[doc(hidden)]pub pending_request_count: i32,
    /// <p>The number of created simulation job requests.</p>
    #[doc(hidden)]pub created_request_count: i32,
}
...
pub struct Robot  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::RobotStatus>,
    /// <p>The Greengrass group associated with the robot.</p>
    #[doc(hidden)]pub green_grass_group_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_deployment_job: std::option::Option<std::string::String>,
    /// <p>The time of the last deployment.</p>
    #[doc(hidden)]pub last_deployment_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl Robot {
    /// <p>The Amazon Resource Name (ARN) of the robot.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct Fleet  {
    ...
    #[doc(hidden)]pub last_deployment_status: std::option::Option<crate::model::DeploymentStatus>,
    /// <p>The Amazon Resource Name (ARN) of the last deployment job.</p>
    #[doc(hidden)]pub last_deployment_job: std::option::Option<std::string::String>,
    /// <p>The time of the last deployment.</p>
    #[doc(hidden)]pub last_deployment_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct DeploymentJob  {
    ...
    #[doc(hidden)]pub failure_code: std::option::Option<crate::model::DeploymentJobErrorCode>,
...
pub struct FinishedWorldsSummary  {
    ...
    #[doc(hidden)]pub finished_count: i32,
    /// <p>A list of worlds that succeeded.</p>
    #[doc(hidden)]pub succeeded_worlds: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Information about worlds that failed.</p>
    #[doc(hidden)]pub failure_summary: std::option::Option<crate::model::FailureSummary>,
}
...
pub struct FailureSummary  {
    ...
    #[doc(hidden)]pub total_failure_count: i32,
    /// <p>The worlds that failed.</p>
    #[doc(hidden)]pub failures: std::option::Option<std::vec::Vec<crate::model::WorldFailure>>,
}
impl FailureSummary {
    /// <p>The total number of failures.</p>
...
pub struct WorldFailure  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub failure_code: std::option::Option<crate::model::WorldGenerationJobErrorCode>,
    ...
    #[doc(hidden)]pub sample_failure_reason: std::option::Option<std::string::String>,
...
pub struct DataSource  {
    ...
    #[doc(hidden)]pub s3_bucket: std::option::Option<std::string::String>,
    /// <p>The list of S3 keys identifying the data source files.</p>
    #[doc(hidden)]pub s3_keys: std::option::Option<std::vec::Vec<crate::model::S3KeyOutput>>,
    /// <p>The data type for the data source that you're using for your container image or simulation job. You can use this field to specify whether your data source is an Archive, an Amazon S3 prefix, or a file.</p> 
    /// <p>If you don't specify a field, the default value is <code>File</code>.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DataSourceType>,
    /// <p>The location where your files are mounted in the container image.</p> 
...
pub struct RobotDeployment  {
    ...
    #[doc(hidden)]pub deployment_start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time, in milliseconds since the epoch, when the deployment finished.</p>
    #[doc(hidden)]pub deployment_finish_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The status of the robot deployment.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::RobotStatus>,
    /// <p>Information about how the deployment is progressing.</p>
    #[doc(hidden)]pub progress_detail: std::option::Option<crate::model::ProgressDetail>,
...
pub struct ProgressDetail  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub current_progress: std::option::Option<crate::model::RobotDeploymentStep>,
    ...
    #[doc(hidden)]pub percent_done: std::option::Option<f32>,
    ...
    #[doc(hidden)]pub estimated_time_remaining_seconds: std::option::Option<i32>,
    /// <p>The Amazon Resource Name (ARN) of the deployment job.</p>
...
impl  std::fmt::Debug for ProgressDetail  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("estimated_time_remaining_seconds", &self.estimated_time_remaining_seconds);
...
pub struct SimulationJob  {
    ...
    #[doc(hidden)]pub last_started_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time, in milliseconds since the epoch, when the simulation job was last updated.</p>
    #[doc(hidden)]pub last_updated_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The failure behavior the simulation job.</p> 
    /// <dl> 
    ...
    #[doc(hidden)]pub simulation_time_millis: i64,
    ...
    #[doc(hidden)]pub network_interface: std::option::Option<crate::model::NetworkInterface>,
    /// <p>Compute information for the simulation job</p>
    #[doc(hidden)]pub compute: std::option::Option<crate::model::ComputeResponse>,
}
impl SimulationJob {
    /// <p>The Amazon Resource Name (ARN) of the simulation job.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
