...
pub fn ser_create_simulation_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSimulationApplicationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
