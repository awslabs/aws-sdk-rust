...
pub fn ser_update_robot_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRobotApplicationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
