...
pub fn ser_describe_simulation_job_input(
    ...
    crate::protocol_serde::shape_describe_simulation_job_input::ser_describe_simulation_job_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::describe_simulation_job::DescribeSimulationJobError::unhandled(
                    generic,
                ),
            ),
        };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_simulation_job_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_simulation_job::de_describe_simulation_job(
            _response_body,
            output,
        )
        .map_err(
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "compute" => {
                        builder = builder.set_compute(
                            crate::protocol_serde::shape_compute_response::de_compute_response(
                                tokens,
                            )?,
                        );
                    }
                    ...
                    "failureBehavior" => {
                        builder = builder.set_failure_behavior(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::FailureBehavior::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    "failureCode" => {
                        builder = builder.set_failure_code(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::SimulationJobErrorCode::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "status" => {
                        builder = builder.set_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::SimulationJobStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
