...
pub fn ser_list_robots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_robots::ListRobotsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
