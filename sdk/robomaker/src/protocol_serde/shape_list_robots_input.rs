...
pub fn ser_list_robots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRobotsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
