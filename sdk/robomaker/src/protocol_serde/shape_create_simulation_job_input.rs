...
pub fn ser_create_simulation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSimulationJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
