...
pub fn ser_update_simulation_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSimulationApplicationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
