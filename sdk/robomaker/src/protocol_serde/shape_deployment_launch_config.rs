...
pub fn ser_deployment_launch_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeploymentLaunchConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_deployment_launch_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeploymentLaunchConfig>, aws_smithy_json::deserialize::error::DeserializeError>
