...
pub fn ser_list_fleets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFleetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
