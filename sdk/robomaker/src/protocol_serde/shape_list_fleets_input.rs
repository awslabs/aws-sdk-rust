...
pub fn ser_list_fleets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_fleets::ListFleetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
