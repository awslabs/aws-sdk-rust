...
pub fn ser_create_robot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_robot::CreateRobotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
