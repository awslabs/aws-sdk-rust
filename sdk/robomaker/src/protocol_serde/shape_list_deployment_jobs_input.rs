...
pub fn ser_list_deployment_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_deployment_jobs::ListDeploymentJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
