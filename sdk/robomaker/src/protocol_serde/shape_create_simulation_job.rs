...
> {
    ...
    Err(match error_code {
        "IdempotentParameterMismatchException" => {
            crate::operation::create_simulation_job::CreateSimulationJobError::IdempotentParameterMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_simulation_job::de_create_simulation_job(_response_body, output)
            .map_err(crate::operation::create_simulation_job::CreateSimulationJobError::unhandled)?;
