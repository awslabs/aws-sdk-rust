...
pub fn ser_list_simulation_applications_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSimulationApplicationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
