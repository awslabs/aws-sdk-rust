...
pub(crate) fn de_simulation_job<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SimulationJob>, aws_smithy_json::deserialize::error::DeserializeError>
