...
) -> ::std::result::Result<Option<crate::types::RenderingEngine>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "name" => {
                            builder = builder.set_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RenderingEngineType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "version" => {
