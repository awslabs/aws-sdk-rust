...
pub fn ser_launch_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LaunchConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_launch_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LaunchConfig>, aws_smithy_json::deserialize::error::DeserializeError>
