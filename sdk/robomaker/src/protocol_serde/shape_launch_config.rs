...
pub fn ser_launch_config(
    ...
    if let Some(var_7) = &input.port_forwarding_config {
        ...
        crate::protocol_serde::shape_port_forwarding_config::ser_port_forwarding_config(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
...
) -> Result<Option<crate::model::LaunchConfig>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "command" => {
                                builder = builder.set_command(
                                    crate::protocol_serde::shape_command_list::de_command_list(
                                        tokens,
                                    )?,
                                );
                            }
