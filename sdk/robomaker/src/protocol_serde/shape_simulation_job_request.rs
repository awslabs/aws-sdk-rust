...
pub fn ser_simulation_job_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SimulationJobRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_simulation_job_request<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SimulationJobRequest>, aws_smithy_json::deserialize::error::DeserializeError>
