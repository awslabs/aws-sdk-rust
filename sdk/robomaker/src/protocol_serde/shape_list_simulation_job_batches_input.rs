...
pub fn ser_list_simulation_job_batches_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_simulation_job_batches::ListSimulationJobBatchesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
