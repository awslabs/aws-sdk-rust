...
pub fn ser_robot_application_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RobotApplicationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_robot_application_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RobotApplicationConfig>, aws_smithy_json::deserialize::error::DeserializeError>
