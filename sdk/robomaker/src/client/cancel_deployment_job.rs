...
impl super::Client {
    ...
    pub fn cancel_deployment_job(
        &self,
    ) -> crate::operation::cancel_deployment_job::builders::CancelDeploymentJobFluentBuilder {
        crate::operation::cancel_deployment_job::builders::CancelDeploymentJobFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
