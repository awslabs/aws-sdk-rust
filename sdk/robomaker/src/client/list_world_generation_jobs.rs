...
impl super::Client  {
    ...
    pub fn list_world_generation_jobs(&self) -> crate::client::fluent_builders::ListWorldGenerationJobs {
                                crate::client::fluent_builders::ListWorldGenerationJobs::new(self.handle.clone())
                            }
}
