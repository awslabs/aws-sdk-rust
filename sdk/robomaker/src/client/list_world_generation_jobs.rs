...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_world_generation_jobs::builders::ListWorldGenerationJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_world_generation_jobs::builders::ListWorldGenerationJobsFluentBuilder::set_next_token): <p>If the previous paginated request did not return all of the remaining results, the response object's <code>nextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListWorldGenerationJobsRequest</code> again and assign that token to the request object's <code>nextToken</code> parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null. </p>
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::list_world_generation_jobs::builders::ListWorldGenerationJobsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_world_generation_jobs::builders::ListWorldGenerationJobsFluentBuilder::set_filters): <p>Optional filters to limit results. You can use <code>status</code> and <code>templateId</code>.</p>
