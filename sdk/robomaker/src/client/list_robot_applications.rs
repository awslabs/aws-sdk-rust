...
impl super::Client {
    ...
    ///   - [`version_qualifier(impl ::std::convert::Into<String>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::version_qualifier) / [`set_version_qualifier(Option<String>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::set_version_qualifier): <p>The version qualifier of the robot application.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::set_next_token): <p>If the previous paginated request did not return all of the remaining results, the response object's <code>nextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListRobotApplications</code> again and assign that token to the request object's <code>nextToken</code> parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null. </p>
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_robot_applications::builders::ListRobotApplicationsFluentBuilder::set_filters): <p>Optional filters to limit results.</p>  <p>The filter name <code>name</code> is supported. When filtering, you must use the complete value of the filtered item. You can use up to three filters.</p>
