...
impl super::Client {
    ...
    ///   - [`batch(impl Into<String>)`](crate::operation::cancel_simulation_job_batch::builders::CancelSimulationJobBatchFluentBuilder::batch) / [`set_batch(Option<String>)`](crate::operation::cancel_simulation_job_batch::builders::CancelSimulationJobBatchFluentBuilder::set_batch):<br>required: **true**<br><p>The id of the batch to cancel.</p><br>
