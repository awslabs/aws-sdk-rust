...
impl super::Client {
    ...
    ///   - [`fleet(impl ::std::convert::Into<String>)`](crate::operation::describe_fleet::builders::DescribeFleetFluentBuilder::fleet) / [`set_fleet(Option<String>)`](crate::operation::describe_fleet::builders::DescribeFleetFluentBuilder::set_fleet): <p>The Amazon Resource Name (ARN) of the fleet.</p>
