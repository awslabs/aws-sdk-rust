...
impl super::Client {
    ...
    ///   - [`job(impl Into<String>)`](crate::operation::cancel_simulation_job::builders::CancelSimulationJobFluentBuilder::job) / [`set_job(Option<String>)`](crate::operation::cancel_simulation_job::builders::CancelSimulationJobFluentBuilder::set_job):<br>required: **true**<br><p>The simulation job ARN to cancel.</p><br>
