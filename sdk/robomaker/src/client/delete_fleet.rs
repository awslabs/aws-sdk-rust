...
impl super::Client {
    ...
    ///   - [`fleet(impl ::std::convert::Into<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::fleet) / [`set_fleet(Option<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::set_fleet): <p>The Amazon Resource Name (ARN) of the fleet.</p>
