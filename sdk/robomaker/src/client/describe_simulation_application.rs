...
impl super::Client {
    ...
    ///   - [`robot_software_suite(Option<RobotSoftwareSuite>)`](crate::operation::describe_simulation_application::DescribeSimulationApplicationOutput::robot_software_suite): <p>Information about the robot software suite.</p>
