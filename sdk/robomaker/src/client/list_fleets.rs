...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::list_fleets::builders::ListFleetsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_fleets::builders::ListFleetsFluentBuilder::set_filters): <p>Optional filters to limit results.</p>  <p>The filter name <code>name</code> is supported. When filtering, you must use the complete value of the filtered item. You can use up to three filters.</p>
