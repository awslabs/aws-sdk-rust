...
impl super::Client {
    ...
    ///   - [`worlds(impl Into<String>)`](crate::operation::batch_delete_worlds::builders::BatchDeleteWorldsFluentBuilder::worlds) / [`set_worlds(Option<Vec::<String>>)`](crate::operation::batch_delete_worlds::builders::BatchDeleteWorldsFluentBuilder::set_worlds):<br>required: **true**<br><p>A list of Amazon Resource Names (arns) that correspond to worlds to delete.</p><br>
