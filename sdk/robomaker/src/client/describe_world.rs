...
impl super::Client {
    ...
    ///   - [`world(impl Into<String>)`](crate::operation::describe_world::builders::DescribeWorldFluentBuilder::world) / [`set_world(Option<String>)`](crate::operation::describe_world::builders::DescribeWorldFluentBuilder::set_world):<br>required: **true**<br><p>The Amazon Resource Name (arn) of the world you want to describe.</p><br>
