...
impl DeleteSimulationApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_simulation_application::DeleteSimulationApplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSimulationApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_simulation_application::de_delete_simulation_application_http_response_with_props(
                status, headers, body,
            )
        }
    }
