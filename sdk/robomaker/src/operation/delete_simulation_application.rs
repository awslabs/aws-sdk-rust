    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/deleteSimulationApplication")
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteSimulationApplicationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_simulation_application::DeleteSimulationApplicationError
{
