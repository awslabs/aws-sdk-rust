...
impl DescribeWorldGenerationJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_world_generation_job::DescribeWorldGenerationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_world_generation_job::DescribeWorldGenerationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_world_generation_job::DescribeWorldGenerationJobOutput, crate::operation::describe_world_generation_job::DescribeWorldGenerationJobError, Self> {
