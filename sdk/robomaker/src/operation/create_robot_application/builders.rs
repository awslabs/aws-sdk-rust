...
impl CreateRobotApplicationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_robot_application::CreateRobotApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_robot_application::CreateRobotApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_robot_application::CreateRobotApplicationOutput, crate::operation::create_robot_application::CreateRobotApplicationError, Self> {
