    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/createSimulationApplication")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSimulationApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_simulation_application::de_create_simulation_application_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateSimulationApplicationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_simulation_application::CreateSimulationApplicationError
{
