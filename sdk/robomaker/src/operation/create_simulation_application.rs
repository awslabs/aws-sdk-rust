...
impl CreateSimulationApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_simulation_application::CreateSimulationApplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSimulationApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_simulation_application::de_create_simulation_application_http_response_with_props(
                status, headers, body,
            )
        }
    }
