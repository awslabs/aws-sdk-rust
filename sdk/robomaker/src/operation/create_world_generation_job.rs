...
impl CreateWorldGenerationJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_world_generation_job::CreateWorldGenerationJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorldGenerationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_world_generation_job::de_create_world_generation_job_http_response_with_props(status, headers, body)
        }
    }
}
