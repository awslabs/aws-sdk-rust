...
pub use crate::operation::list_world_generation_jobs::_list_world_generation_jobs_output::ListWorldGenerationJobsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_world_generation_jobs::ListWorldGenerationJobsOutput,
                    crate::operation::list_world_generation_jobs::ListWorldGenerationJobsError,
                > for ListWorldGenerationJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListWorldGenerationJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_world_generation_jobs::ListWorldGenerationJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_world_generation_jobs::ListWorldGenerationJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_world_generation_jobs::ListWorldGenerationJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_world_generation_jobs::ListWorldGenerationJobsOutput, crate::operation::list_world_generation_jobs::ListWorldGenerationJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_world_generation_jobs::paginator::ListWorldGenerationJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
