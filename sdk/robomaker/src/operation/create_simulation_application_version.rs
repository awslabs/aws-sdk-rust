...
impl CreateSimulationApplicationVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_simulation_application_version::CreateSimulationApplicationVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSimulationApplicationVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_simulation_application_version::de_create_simulation_application_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
