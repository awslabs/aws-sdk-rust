...
impl ListSimulationJobBatchesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_simulation_job_batches::ListSimulationJobBatches::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSimulationJobBatches {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_simulation_job_batches::de_list_simulation_job_batches_http_response_with_props(status, headers, body)
        }
    }
}
