...
impl CreateSimulationApplicationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_simulation_application_version::CreateSimulationApplicationVersionInput, ::aws_smithy_types::error::operation::BuildError> {
