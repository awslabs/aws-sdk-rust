...
impl ListRobotApplicationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_robot_applications::ListRobotApplicationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_robot_applications::ListRobotApplicationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_robot_applications::ListRobotApplicationsOutput, crate::operation::list_robot_applications::ListRobotApplicationsError, Self> {
