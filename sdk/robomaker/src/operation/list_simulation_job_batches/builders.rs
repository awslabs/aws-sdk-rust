...
pub use crate::operation::list_simulation_job_batches::_list_simulation_job_batches_output::ListSimulationJobBatchesOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_simulation_job_batches::ListSimulationJobBatchesOutput,
                    crate::operation::list_simulation_job_batches::ListSimulationJobBatchesError,
                > for ListSimulationJobBatchesFluentBuilder
            {
                fn send(
                    self,
...
impl ListSimulationJobBatchesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_simulation_job_batches::ListSimulationJobBatchesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_simulation_job_batches::ListSimulationJobBatchesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_simulation_job_batches::ListSimulationJobBatches::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_simulation_job_batches::ListSimulationJobBatches::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_simulation_job_batches::ListSimulationJobBatchesOutput, crate::operation::list_simulation_job_batches::ListSimulationJobBatchesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_simulation_job_batches::paginator::ListSimulationJobBatchesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
