...
impl ListSimulationJobBatchesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_simulation_job_batches::ListSimulationJobBatchesInput, ::aws_smithy_types::error::operation::BuildError> {
