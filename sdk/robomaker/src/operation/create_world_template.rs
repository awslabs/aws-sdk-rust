...
impl CreateWorldTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_world_template::CreateWorldTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorldTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_world_template::de_create_world_template_http_response_with_props(status, headers, body)
        }
    }
}
