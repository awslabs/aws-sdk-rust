...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::batch_delete_worlds::BatchDeleteWorldsOutput,
                    crate::operation::batch_delete_worlds::BatchDeleteWorldsError,
                > for BatchDeleteWorldsFluentBuilder
            {
                fn send(
                    self,
...
impl BatchDeleteWorldsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_delete_worlds::BatchDeleteWorldsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_worlds::BatchDeleteWorldsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::batch_delete_worlds::BatchDeleteWorlds::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::batch_delete_worlds::BatchDeleteWorlds::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_delete_worlds::BatchDeleteWorldsOutput, crate::operation::batch_delete_worlds::BatchDeleteWorldsError, Self> {
