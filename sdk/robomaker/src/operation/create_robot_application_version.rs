...
impl CreateRobotApplicationVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_robot_application_version::CreateRobotApplicationVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRobotApplicationVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_robot_application_version::de_create_robot_application_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
