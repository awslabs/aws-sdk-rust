...
impl SyncDeploymentJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_sync_deployment_job::ser_sync_deployment_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SyncDeploymentJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_sync_deployment_job::de_sync_deployment_job_http_response_with_props(status, headers, body)
        }
    }
}
