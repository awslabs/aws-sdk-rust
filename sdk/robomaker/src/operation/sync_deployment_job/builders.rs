...
impl SyncDeploymentJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::sync_deployment_job::SyncDeploymentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::sync_deployment_job::SyncDeploymentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::sync_deployment_job::SyncDeploymentJobOutput, crate::operation::sync_deployment_job::SyncDeploymentJobError, Self> {
