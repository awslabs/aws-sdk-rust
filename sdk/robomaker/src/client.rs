...
impl Client  {
    ...
    pub fn create_robot_application_version(&self) -> fluent_builders::CreateRobotApplicationVersion {
    ...
    pub fn create_simulation_application_version(&self) -> fluent_builders::CreateSimulationApplicationVersion {
    ...
    pub fn describe_simulation_application(&self) -> fluent_builders::DescribeSimulationApplication {
...
pub mod fluent_builders {
    ...
    /// </important>
    #[deprecated(note = "Support for the AWS RoboMaker application deployment feature has ended. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/fleets.html.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
    ...
    /// </note>
    #[deprecated(note = "AWS RoboMaker is unable to process this request as the support for the AWS RoboMaker application deployment feature has ended. For additional information, see https://docs.aws.amazon.com/robomaker/latest/dg/fleets.html.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
