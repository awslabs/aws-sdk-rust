...
impl  DataSourceConfig  {
    ...
    pub fn s3_keys(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.s3_keys.deref()
    }
    /// <p>The data type for the data source that you're using for your container image or simulation job. You can use this field to specify whether your data source is an Archive, an Amazon S3 prefix, or a file.</p>
    /// <p>If you don't specify a field, the default value is <code>File</code>.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DataSourceConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::DataSourceConfig {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building DataSourceConfig")
                    )?
                ,
                s3_bucket: self.s3_bucket
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("s3_bucket", "s3_bucket was not specified but it is required when building DataSourceConfig")
                    )?
                ,
                s3_keys: self.s3_keys
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("s3_keys", "s3_keys was not specified but it is required when building DataSourceConfig")
                    )?
                ,
                r#type: self.r#type
                ,
