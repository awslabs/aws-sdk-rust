...
impl Client  {
    ...
    pub fn describe_anomaly_detection_executions(&self) -> fluent_builders::DescribeAnomalyDetectionExecutions {
    ...
    pub fn list_anomaly_group_related_metrics(&self) -> fluent_builders::ListAnomalyGroupRelatedMetrics {
