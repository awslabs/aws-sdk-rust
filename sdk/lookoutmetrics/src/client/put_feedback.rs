...
impl super::Client {
    ...
    ///   - [`anomaly_detector_arn(impl Into<String>)`](crate::operation::put_feedback::builders::PutFeedbackFluentBuilder::anomaly_detector_arn) / [`set_anomaly_detector_arn(Option<String>)`](crate::operation::put_feedback::builders::PutFeedbackFluentBuilder::set_anomaly_detector_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the anomaly detector.</p><br>
    ///   - [`anomaly_group_time_series_feedback(AnomalyGroupTimeSeriesFeedback)`](crate::operation::put_feedback::builders::PutFeedbackFluentBuilder::anomaly_group_time_series_feedback) / [`set_anomaly_group_time_series_feedback(Option<AnomalyGroupTimeSeriesFeedback>)`](crate::operation::put_feedback::builders::PutFeedbackFluentBuilder::set_anomaly_group_time_series_feedback):<br>required: **true**<br><p>Feedback for an anomalous metric.</p><br>
