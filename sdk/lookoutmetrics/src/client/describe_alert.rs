...
impl super::Client {
    ...
    ///   - [`alert_arn(impl Into<String>)`](crate::operation::describe_alert::builders::DescribeAlertFluentBuilder::alert_arn) / [`set_alert_arn(Option<String>)`](crate::operation::describe_alert::builders::DescribeAlertFluentBuilder::set_alert_arn):<br>required: **true**<br><p>The ARN of the alert to describe.</p><br>
