...
impl super::Client {
    ...
    ///   - [`anomaly_detector_arn(impl ::std::convert::Into<String>)`](crate::operation::list_anomaly_group_related_metrics::builders::ListAnomalyGroupRelatedMetricsFluentBuilder::anomaly_detector_arn) / [`set_anomaly_detector_arn(Option<String>)`](crate::operation::list_anomaly_group_related_metrics::builders::ListAnomalyGroupRelatedMetricsFluentBuilder::set_anomaly_detector_arn): <p>The Amazon Resource Name (ARN) of the anomaly detector.</p>
    ///   - [`anomaly_group_id(impl ::std::convert::Into<String>)`](crate::operation::list_anomaly_group_related_metrics::builders::ListAnomalyGroupRelatedMetricsFluentBuilder::anomaly_group_id) / [`set_anomaly_group_id(Option<String>)`](crate::operation::list_anomaly_group_related_metrics::builders::ListAnomalyGroupRelatedMetricsFluentBuilder::set_anomaly_group_id): <p>The ID of the anomaly group.</p>
