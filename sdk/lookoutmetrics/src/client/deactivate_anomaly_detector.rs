...
impl super::Client {
    ...
    ///   - [`anomaly_detector_arn(impl Into<String>)`](crate::operation::deactivate_anomaly_detector::builders::DeactivateAnomalyDetectorFluentBuilder::anomaly_detector_arn) / [`set_anomaly_detector_arn(Option<String>)`](crate::operation::deactivate_anomaly_detector::builders::DeactivateAnomalyDetectorFluentBuilder::set_anomaly_detector_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the anomaly detector.</p><br>
