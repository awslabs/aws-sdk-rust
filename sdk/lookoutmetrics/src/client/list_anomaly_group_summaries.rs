...
impl super::Client {
    ...
    ///   - [`sensitivity_threshold(i32)`](crate::operation::list_anomaly_group_summaries::builders::ListAnomalyGroupSummariesFluentBuilder::sensitivity_threshold) / [`set_sensitivity_threshold(Option<i32>)`](crate::operation::list_anomaly_group_summaries::builders::ListAnomalyGroupSummariesFluentBuilder::set_sensitivity_threshold): <p>The minimum severity score for inclusion in the output.</p>
