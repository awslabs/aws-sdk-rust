...
pub fn ser_metric(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Metric) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
