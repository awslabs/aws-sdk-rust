...
) -> ::std::result::Result<Option<crate::types::Alert>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AlertFilters" => {
                            builder = builder.set_alert_filters(crate::protocol_serde::shape_alert_filters::de_alert_filters(tokens)?);
                        }
