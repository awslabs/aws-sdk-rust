...
pub fn ser_metric_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_metric_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MetricSource>, aws_smithy_json::deserialize::error::DeserializeError>
