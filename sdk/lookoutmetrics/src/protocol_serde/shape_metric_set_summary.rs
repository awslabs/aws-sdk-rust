...
pub(crate) fn de_metric_set_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MetricSetSummary>, aws_smithy_json::deserialize::error::DeserializeError>
