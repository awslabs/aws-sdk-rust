...
pub fn ser_update_metric_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateMetricSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
