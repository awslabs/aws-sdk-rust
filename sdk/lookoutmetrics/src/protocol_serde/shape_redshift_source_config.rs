...
pub(crate) fn de_redshift_source_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::RedshiftSourceConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
