...
pub fn ser_get_sample_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSampleDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
