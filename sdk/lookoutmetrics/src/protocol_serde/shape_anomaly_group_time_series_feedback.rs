...
pub fn ser_anomaly_group_time_series_feedback(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnomalyGroupTimeSeriesFeedback) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
