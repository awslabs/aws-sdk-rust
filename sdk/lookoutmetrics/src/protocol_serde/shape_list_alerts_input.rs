...
pub fn ser_list_alerts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_alerts::ListAlertsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
