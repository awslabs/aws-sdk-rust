...
pub fn ser_list_metric_sets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListMetricSetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
