...
pub fn ser_create_anomaly_detector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAnomalyDetectorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
