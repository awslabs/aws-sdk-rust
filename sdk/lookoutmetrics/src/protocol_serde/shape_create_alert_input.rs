...
pub fn ser_create_alert_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAlertInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
