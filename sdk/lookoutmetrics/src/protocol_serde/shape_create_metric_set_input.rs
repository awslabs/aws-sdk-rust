...
pub fn ser_create_metric_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMetricSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
