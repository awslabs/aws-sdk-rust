...
pub fn ser_list_anomaly_group_time_series_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAnomalyGroupTimeSeriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
