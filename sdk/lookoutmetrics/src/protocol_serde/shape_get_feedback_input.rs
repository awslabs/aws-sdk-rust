...
pub fn ser_get_feedback_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFeedbackInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
