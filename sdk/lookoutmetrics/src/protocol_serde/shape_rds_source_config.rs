...
pub fn ser_rds_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RdsSourceConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rds_source_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RdsSourceConfig>, aws_smithy_json::deserialize::error::DeserializeError>
