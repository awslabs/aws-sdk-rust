...
pub fn ser_rds_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RdsSourceConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
