...
pub fn ser_sample_data_s3_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SampleDataS3SourceConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
