...
pub(crate) fn de_alert_summary<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<crate::types::AlertSummary>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AlertType" => {
                                builder = builder.set_alert_type(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AlertType::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            "AlertStatus" => {
                                builder = builder.set_alert_status(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AlertStatus::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
