...
) -> ::std::result::Result<Option<crate::types::AlertSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AlertStatus" => {
                            builder = builder.set_alert_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AlertStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
