...
pub(crate) fn de_alert_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AlertSummary>, aws_smithy_json::deserialize::error::DeserializeError>
