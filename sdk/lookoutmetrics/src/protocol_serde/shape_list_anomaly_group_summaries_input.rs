...
pub fn ser_list_anomaly_group_summaries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_anomaly_group_summaries::ListAnomalyGroupSummariesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
