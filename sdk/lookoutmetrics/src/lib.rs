...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("lookoutmetrics", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Lookout for Metrics.
pub mod client;
