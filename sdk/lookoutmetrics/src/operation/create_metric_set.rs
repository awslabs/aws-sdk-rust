...
impl CreateMetricSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_metric_set::CreateMetricSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMetricSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_metric_set::de_create_metric_set_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_metric_set::CreateMetricSetError
{
