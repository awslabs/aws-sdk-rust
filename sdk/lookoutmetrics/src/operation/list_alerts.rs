...
impl ListAlertsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_alerts::ListAlerts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_alerts::ser_list_alerts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAlerts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_alerts::de_list_alerts_http_response_with_props(status, headers, body)
        }
    }
}
