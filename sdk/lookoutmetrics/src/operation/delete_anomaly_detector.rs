...
impl DeleteAnomalyDetectorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAnomalyDetector`](crate::operation::delete_anomaly_detector::DeleteAnomalyDetector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_anomaly_detector::DeleteAnomalyDetector, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_anomaly_detector::DeleteAnomalyDetectorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_anomaly_detector::ser_delete_anomaly_detector_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_anomaly_detector::DeleteAnomalyDetector::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAnomalyDetector {
                type Output = std::result::Result<crate::operation::delete_anomaly_detector::DeleteAnomalyDetectorOutput, crate::operation::delete_anomaly_detector::DeleteAnomalyDetectorError>;
