...
impl UpdateMetricSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_metric_set::UpdateMetricSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMetricSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_metric_set::de_update_metric_set_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_metric_set::UpdateMetricSetError
{
