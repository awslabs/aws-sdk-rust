...
as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-agentregistrycontrol` to
your project, add the following to your **Cargo.toml** file:

```toml
[dependencies]
aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
aws-sdk-agentregistrycontrol = "1.5.0"
...
```rust,no_run
use aws_sdk_agentregistrycontrol as agentregistrycontrol;

#[::tokio::main]
async fn main() -> Result<(), agentregistrycontrol::Error> {
    let config = aws_config::load_from_env().await;
    let client = aws_sdk_agentregistrycontrol::Client::new(&config);
...
See the [client documentation](https://docs.rs/aws-sdk-agentregistrycontrol/latest/aws_sdk_agentregistrycontrol/client/struct.Client.html)
