...
///     RegistryStatus::CreateFailed => { /* ... */ },
///     RegistryStatus::Creating => { /* ... */ },
///     RegistryStatus::DeleteFailed => { /* ... */ },
///     RegistryStatus::Deleting => { /* ... */ },
///     RegistryStatus::Ready => { /* ... */ },
///     RegistryStatus::UpdateFailed => { /* ... */ },
...
impl ::std::convert::From<&str> for RegistryStatus {
    fn from(s: &str) -> Self {
        match s {
            "CREATE_FAILED" => RegistryStatus::CreateFailed,
            "CREATING" => RegistryStatus::Creating,
            "DELETE_FAILED" => RegistryStatus::DeleteFailed,
            "DELETING" => RegistryStatus::Deleting,
            "READY" => RegistryStatus::Ready,
            "UPDATE_FAILED" => RegistryStatus::UpdateFailed,
            "UPDATING" => RegistryStatus::Updating,
...
impl RegistryStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RegistryStatus::CreateFailed => "CREATE_FAILED",
            RegistryStatus::Creating => "CREATING",
            RegistryStatus::DeleteFailed => "DELETE_FAILED",
            RegistryStatus::Deleting => "DELETING",
            RegistryStatus::Ready => "READY",
            RegistryStatus::UpdateFailed => "UPDATE_FAILED",
            RegistryStatus::Updating => "UPDATING",
...
impl ::std::fmt::Display for RegistryStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RegistryStatus::CreateFailed => write!(f, "CREATE_FAILED"),
            RegistryStatus::Creating => write!(f, "CREATING"),
            RegistryStatus::DeleteFailed => write!(f, "DELETE_FAILED"),
            RegistryStatus::Deleting => write!(f, "DELETING"),
            RegistryStatus::Ready => write!(f, "READY"),
            RegistryStatus::UpdateFailed => write!(f, "UPDATE_FAILED"),
            RegistryStatus::Updating => write!(f, "UPDATING"),
