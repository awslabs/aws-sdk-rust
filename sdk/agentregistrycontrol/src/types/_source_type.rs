...
/// match sourcetype {
///     SourceType::AwsBedrockAgentcoreGateway => { /* ... */ },
///     SourceType::AwsBedrockAgentcoreRuntime => { /* ... */ },
...
impl ::std::convert::From<&str> for SourceType {
    fn from(s: &str) -> Self {
        match s {
            "AWS::BedrockAgentCore::Gateway" => SourceType::AwsBedrockAgentcoreGateway,
            "AWS::BedrockAgentCore::Runtime" => SourceType::AwsBedrockAgentcoreRuntime,
...
impl SourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SourceType::AwsBedrockAgentcoreGateway => "AWS::BedrockAgentCore::Gateway",
            SourceType::AwsBedrockAgentcoreRuntime => "AWS::BedrockAgentCore::Runtime",
            SourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AWS::BedrockAgentCore::Gateway", "AWS::BedrockAgentCore::Runtime"]
    }
}
...
impl ::std::fmt::Display for SourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SourceType::AwsBedrockAgentcoreGateway => write!(f, "AWS::BedrockAgentCore::Gateway"),
            SourceType::AwsBedrockAgentcoreRuntime => write!(f, "AWS::BedrockAgentCore::Runtime"),
