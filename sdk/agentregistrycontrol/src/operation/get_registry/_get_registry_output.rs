...
impl GetRegistryOutputBuilder {
    ...
    /// - [`name`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::name)
    /// - [`registry_id`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::registry_id)
    /// - [`registry_arn`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::registry_arn)
    /// - [`status`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::status)
    /// - [`created_at`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::get_registry::builders::GetRegistryOutputBuilder::updated_at)
    pub fn build(self) -> ::std::result::Result<crate::operation::get_registry::GetRegistryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_registry::GetRegistryOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building GetRegistryOutput",
                )
            })?,
            ...
            registry_id: self.registry_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registry_id",
                    "registry_id was not specified but it is required when building GetRegistryOutput",
                )
            })?,
            registry_arn: self.registry_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registry_arn",
                    "registry_arn was not specified but it is required when building GetRegistryOutput",
                )
            })?,
            ...
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building GetRegistryOutput",
                )
            })?,
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building GetRegistryOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building GetRegistryOutput",
                )
            })?,
...
impl ::std::fmt::Debug for GetRegistryOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetRegistryOutputBuilder");
        formatter.field("name", &self.name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("registry_id", &self.registry_id);
        formatter.field("registry_arn", &self.registry_arn);
