...
pub struct ListRegistriesInput {
    ...
    pub filters: ::std::option::Option<::std::vec::Vec<crate::types::RegistryFilter>>,
}
impl ListRegistriesInput {
    ...
    pub fn filters(&self) -> &[crate::types::RegistryFilter] {
...
pub struct ListRegistriesInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::RegistryFilter>>,
}
impl ListRegistriesInputBuilder {
    ...
    ///
    /// <p>Filters to apply to the registry list</p>
    pub fn filters(mut self, input: crate::types::RegistryFilter) -> Self {
    ...
    /// <p>Filters to apply to the registry list</p>
    pub fn set_filters(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::RegistryFilter>>) -> Self {
        self.filters = input;
        self
    }
    /// <p>Filters to apply to the registry list</p>
    pub fn get_filters(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::RegistryFilter>> {
        &self.filters
    }
