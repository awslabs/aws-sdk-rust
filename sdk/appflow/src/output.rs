...
pub struct ListFlowsOutput  {
    ...
    #[doc(hidden)]pub flows: std::option::Option<std::vec::Vec<crate::model::FlowDefinition>>,
...
pub struct ListConnectorsOutput  {
    ...
    #[doc(hidden)]pub connectors: std::option::Option<std::vec::Vec<crate::model::ConnectorDetail>>,
...
pub struct ListConnectorEntitiesOutput  {
    ...
    #[doc(hidden)]pub connector_entity_map: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<crate::model::ConnectorEntity>>>,
}
...
pub struct DescribeFlowExecutionRecordsOutput  {
    ...
    #[doc(hidden)]pub flow_executions: std::option::Option<std::vec::Vec<crate::model::ExecutionRecord>>,
...
pub struct DescribeFlowOutput  {
    ...
    #[doc(hidden)]pub flow_status_message: std::option::Option<std::string::String>,
...
pub struct DescribeConnectorsOutput  {
    ...
    #[doc(hidden)]pub connector_configurations: std::option::Option<std::collections::HashMap<crate::model::ConnectorType, crate::model::ConnectorConfiguration>>,
...
pub struct DescribeConnectorProfilesOutput  {
    ...
    #[doc(hidden)]pub connector_profile_details: std::option::Option<std::vec::Vec<crate::model::ConnectorProfile>>,
...
pub struct DescribeConnectorEntityOutput  {
    ...
    #[doc(hidden)]pub connector_entity_fields: std::option::Option<std::vec::Vec<crate::model::ConnectorEntityField>>,
}
...
pub struct DescribeConnectorOutput  {
    ...
    #[doc(hidden)]pub connector_configuration: std::option::Option<crate::model::ConnectorConfiguration>,
}
