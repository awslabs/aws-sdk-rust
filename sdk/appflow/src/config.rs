...
impl Builder {
    ...
    /// use aws_sdk_appflow::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_appflow::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
