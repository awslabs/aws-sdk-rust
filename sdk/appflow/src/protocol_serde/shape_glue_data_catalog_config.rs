...
pub fn ser_glue_data_catalog_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GlueDataCatalogConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
