...
pub(crate) fn de_execution_record<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ExecutionRecord>, aws_smithy_json::deserialize::error::DeserializeError>
