...
pub(crate) fn de_execution_record<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ExecutionRecord>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "executionResult" => {
                                builder = builder.set_execution_result(
                                    crate::protocol_serde::shape_execution_result::de_execution_result(tokens)?
                                );
                            }
                            "startedAt" => {
