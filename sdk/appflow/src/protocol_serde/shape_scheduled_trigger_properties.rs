...
pub fn ser_scheduled_trigger_properties(
    ...
    if let Some(var_7) = &input.flow_error_deactivation_threshold {
        object.key("flowErrorDeactivationThreshold").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    Ok(())
}
...
pub(crate) fn de_scheduled_trigger_properties<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ScheduledTriggerProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::scheduled_trigger_properties_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
