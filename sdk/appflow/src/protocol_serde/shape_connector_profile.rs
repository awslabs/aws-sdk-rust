                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "connectorProfileProperties" => {
                            builder = builder.set_connector_profile_properties(
                                crate::protocol_serde::shape_connector_profile_properties::de_connector_profile_properties(tokens, _value)?,
                            );
                        }
                        "createdAt" => {
                        ...
                        "privateConnectionProvisioningState" => {
                            builder = builder.set_private_connection_provisioning_state(
                                crate::protocol_serde::shape_private_connection_provisioning_state::de_private_connection_provisioning_state(
                                    tokens, _value,
                                )?,
                            );
                        }
