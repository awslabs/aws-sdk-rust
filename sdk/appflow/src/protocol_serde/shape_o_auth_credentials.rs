...
pub fn ser_o_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
