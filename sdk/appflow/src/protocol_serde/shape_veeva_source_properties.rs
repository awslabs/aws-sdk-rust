...
pub(crate) fn de_veeva_source_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::VeevaSourceProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "includeSourceFiles" => {
                            builder = builder.set_include_source_files(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "includeRenditions" => {
                            builder = builder.set_include_renditions(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "includeAllVersions" => {
                            builder = builder.set_include_all_versions(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
