...
pub fn ser_veeva_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VeevaSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_veeva_source_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VeevaSourceProperties>, aws_smithy_json::deserialize::error::DeserializeError>
