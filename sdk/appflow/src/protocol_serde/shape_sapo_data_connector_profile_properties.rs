...
pub fn ser_sapo_data_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_sapo_data_connector_profile_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SapoDataConnectorProfileProperties>, aws_smithy_json::deserialize::error::DeserializeError>
