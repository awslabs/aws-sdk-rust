...
pub(crate) fn de_connector_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConnectorMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
