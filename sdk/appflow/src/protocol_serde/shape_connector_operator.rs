...
pub(crate) fn de_connector_operator<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConnectorOperator>, aws_smithy_json::deserialize::error::DeserializeError>
