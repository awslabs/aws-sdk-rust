                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_amplitude(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::AmplitudeConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "Dynatrace" => {
                                builder = builder.set_dynatrace(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DynatraceConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "InforNexus" => {
                                builder = builder.set_infor_nexus(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::InforNexusConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "Salesforce" => {
                                builder = builder.set_salesforce(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::SalesforceConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "ServiceNow" => {
                                builder = builder.set_service_now(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::ServiceNowConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "Singular" => {
                                builder = builder.set_singular(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::SingularConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "Trendmicro" => {
                                builder = builder.set_trendmicro(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::TrendmicroConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "SAPOData" => {
                                builder = builder.set_sapo_data(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::SapoDataConnectorOperator::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
