...
pub(crate) fn de_supported_data_transfer_apis<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::DataTransferApi>>, ::aws_smithy_json::deserialize::error::DeserializeError>
