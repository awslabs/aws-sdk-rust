...
pub(crate) fn de_connector_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConnectorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
