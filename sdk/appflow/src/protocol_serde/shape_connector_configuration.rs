...
) -> Result<Option<crate::types::ConnectorConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "canUseAsSource" => {
                            builder = builder.set_can_use_as_source(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "canUseAsDestination" => {
                            builder = builder.set_can_use_as_destination(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        ...
                        "isPrivateLinkEnabled" => {
                            builder = builder.set_is_private_link_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "isPrivateLinkEndpointUrlRequired" => {
                            builder = builder.set_is_private_link_endpoint_url_required(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                                tokens.next(),
                            )?);
                        }
                        "supportedTriggerTypes" => {
                            builder =
                                builder.set_supported_trigger_types(crate::protocol_serde::shape_trigger_type_list::de_trigger_type_list(tokens)?);
                        }
                        "connectorMetadata" => {
                            builder = builder.set_connector_metadata(crate::protocol_serde::shape_connector_metadata::de_connector_metadata(tokens)?);
                        }
                        "connectorType" => {
                        ...
                        "authenticationConfig" => {
                            builder = builder
                                .set_authentication_config(crate::protocol_serde::shape_authentication_config::de_authentication_config(tokens)?);
                        }
                        ...
                        "supportedOperators" => {
                            builder = builder
                                .set_supported_operators(crate::protocol_serde::shape_supported_operator_list::de_supported_operator_list(tokens)?);
                        }
                        ...
                        "supportedDataTransferApis" => {
                            builder = builder.set_supported_data_transfer_apis(
                                crate::protocol_serde::shape_supported_data_transfer_apis::de_supported_data_transfer_apis(tokens)?,
                            );
                        }
