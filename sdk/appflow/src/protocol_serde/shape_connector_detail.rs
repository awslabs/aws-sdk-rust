...
pub(crate) fn de_connector_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConnectorDetail>, aws_smithy_json::deserialize::error::DeserializeError>
