...
) -> ::std::result::Result<Option<crate::types::ConnectorDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "connectorProvisioningType" => {
                            builder = builder.set_connector_provisioning_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ConnectorProvisioningType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "connectorModes" => {
                            builder = builder.set_connector_modes(crate::protocol_serde::shape_connector_mode_list::de_connector_mode_list(tokens)?);
                        }
