...
pub fn ser_redshift_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedshiftDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_redshift_destination_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RedshiftDestinationProperties>, aws_smithy_json::deserialize::error::DeserializeError>
