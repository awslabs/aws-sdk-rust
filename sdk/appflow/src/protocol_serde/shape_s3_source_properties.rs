...
pub(crate) fn de_s3_source_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3SourceProperties>, aws_smithy_json::deserialize::error::DeserializeError>
