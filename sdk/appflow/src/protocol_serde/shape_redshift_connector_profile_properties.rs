...
pub fn ser_redshift_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedshiftConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_redshift_connector_profile_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RedshiftConnectorProfileProperties>, aws_smithy_json::deserialize::error::DeserializeError>
