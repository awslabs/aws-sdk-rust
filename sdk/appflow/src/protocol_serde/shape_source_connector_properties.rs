...
pub fn ser_source_connector_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceConnectorProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_source_connector_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SourceConnectorProperties>, aws_smithy_json::deserialize::error::DeserializeError>
