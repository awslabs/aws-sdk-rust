...
pub fn ser_o_auth2_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuth2Credentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
