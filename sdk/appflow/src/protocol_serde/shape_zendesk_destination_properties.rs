...
pub fn ser_zendesk_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZendeskDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_zendesk_destination_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ZendeskDestinationProperties>, aws_smithy_json::deserialize::error::DeserializeError>
