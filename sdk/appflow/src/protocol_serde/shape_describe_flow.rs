...
pub fn de_describe_flow_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_flow::DescribeFlowOutput, crate::operation::describe_flow::DescribeFlowError> {
    #[allow(unused_mut)]
...
pub fn de_describe_flow_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_flow::de_describe_flow(_response_body, output)
            .map_err(crate::operation::describe_flow::DescribeFlowError::unhandled)?;
...
) -> Result<crate::operation::describe_flow::builders::DescribeFlowOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
