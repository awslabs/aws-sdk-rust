...
pub fn ser_custom_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
