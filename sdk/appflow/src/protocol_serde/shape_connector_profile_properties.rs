...
pub fn ser_connector_profile_properties(
    ...
    if let Some(var_7) = &input.google_analytics {
        ...
        crate::protocol_serde::shape_google_analytics_connector_profile_properties::ser_google_analytics_connector_profile_properties(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "GoogleAnalytics" => {
                                builder = builder.set_google_analytics(
                                    crate::protocol_serde::shape_google_analytics_connector_profile_properties::de_google_analytics_connector_profile_properties(tokens, _value, depth + 1)?
                                );
                            }
                            "Honeycode" => {
                            ...
                            "InforNexus" => {
                                builder = builder.set_infor_nexus(
                                    crate::protocol_serde::shape_infor_nexus_connector_profile_properties::de_infor_nexus_connector_profile_properties(tokens, _value, depth + 1)?
                                );
                            }
                            "Marketo" => {
                            ...
                            "ServiceNow" => {
                                builder = builder.set_service_now(
                                    crate::protocol_serde::shape_service_now_connector_profile_properties::de_service_now_connector_profile_properties(tokens, _value, depth + 1)?
                                );
                            }
                            "Singular" => {
