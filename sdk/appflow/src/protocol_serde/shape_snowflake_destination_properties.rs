...
pub fn ser_snowflake_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnowflakeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_snowflake_destination_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SnowflakeDestinationProperties>, aws_smithy_json::deserialize::error::DeserializeError>
