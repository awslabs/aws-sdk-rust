...
pub fn de_update_connector_profile_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_connector_profile::UpdateConnectorProfileOutput, crate::operation::update_connector_profile::UpdateConnectorProfileError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_connector_profile::UpdateConnectorProfileError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_connector_profile_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_connector_profile::UpdateConnectorProfileOutput, crate::operation::update_connector_profile::UpdateConnectorProfileError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_connector_profile::builders::UpdateConnectorProfileOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile(response.body().as_ref(), output).map_err(crate::operation::update_connector_profile::UpdateConnectorProfileError::unhandled)?;
