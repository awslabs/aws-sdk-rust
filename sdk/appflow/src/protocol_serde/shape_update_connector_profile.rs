...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_connector_profile::UpdateConnectorProfileError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ConnectorAuthenticationException" => {
            crate::operation::update_connector_profile::UpdateConnectorProfileError::ConnectorAuthenticationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ConnectorAuthenticationExceptionBuilder::default();
                    output = crate::protocol_serde::shape_connector_authentication_exception::de_connector_authentication_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::update_connector_profile::UpdateConnectorProfileError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile(_response_body, output)
            .map_err(crate::operation::update_connector_profile::UpdateConnectorProfileError::unhandled)?;
