...
pub fn ser_s3_output_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3OutputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_s3_output_format_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3OutputFormatConfig>, aws_smithy_json::deserialize::error::DeserializeError>
