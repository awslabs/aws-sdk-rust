...
pub fn ser_create_flow_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFlowInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
