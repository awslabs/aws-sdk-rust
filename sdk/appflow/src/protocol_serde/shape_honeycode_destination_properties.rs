...
pub(crate) fn de_honeycode_destination_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::HoneycodeDestinationProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "errorHandlingConfig" => {
                            builder = builder.set_error_handling_config(
                                crate::protocol_serde::shape_error_handling_config::de_error_handling_config(tokens, _value, depth + 1)?,
                            );
                        }
