...
/// Operation shape for `CreateConnectorProfile`.
            ...
            /// [`create_connector_profile`](crate::client::fluent_builders::CreateConnectorProfile).
            ///
            /// `ParseStrictResponse` impl for `CreateConnectorProfile`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateConnectorProfile {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_connector_profile::de_create_connector_profile_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_connector_profile::de_create_connector_profile_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DeleteConnectorProfile`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`delete_connector_profile`](crate::client::fluent_builders::DeleteConnectorProfile).
            ///
            /// `ParseStrictResponse` impl for `DeleteConnectorProfile`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteConnectorProfile {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_connector_profile::de_delete_connector_profile_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_connector_profile::de_delete_connector_profile_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeConnectorEntity`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_connector_entity`](crate::client::fluent_builders::DescribeConnectorEntity).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConnectorEntity {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_connector_entity::de_describe_connector_entity_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_connector_entity::de_describe_connector_entity_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeConnectorProfiles`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_connector_profiles`](crate::client::fluent_builders::DescribeConnectorProfiles).
            ///
            /// `ParseStrictResponse` impl for `DescribeConnectorProfiles`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConnectorProfiles {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_connector_profiles::de_describe_connector_profiles_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_connector_profiles::de_describe_connector_profiles_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeConnectors`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_connectors`](crate::client::fluent_builders::DescribeConnectors).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConnectors {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_connectors::de_describe_connectors_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_connectors::de_describe_connectors_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeFlowExecutionRecords`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_flow_execution_records`](crate::client::fluent_builders::DescribeFlowExecutionRecords).
            ///
            /// `ParseStrictResponse` impl for `DescribeFlowExecutionRecords`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFlowExecutionRecords {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_flow_execution_records::de_describe_flow_execution_records_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_flow_execution_records::de_describe_flow_execution_records_http_response(response)
                     }
                }
            }
...
/// Operation shape for `ListConnectorEntities`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`list_connector_entities`](crate::client::fluent_builders::ListConnectorEntities).
            ///
...
/// Operation shape for `RegisterConnector`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`register_connector`](crate::client::fluent_builders::RegisterConnector).
            ///
...
/// Operation shape for `UnregisterConnector`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`unregister_connector`](crate::client::fluent_builders::UnregisterConnector).
            ///
...
/// Operation shape for `UpdateConnectorProfile`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_connector_profile`](crate::client::fluent_builders::UpdateConnectorProfile).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateConnectorProfile {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdateConnectorRegistration`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_connector_registration`](crate::client::fluent_builders::UpdateConnectorRegistration).
            ///
            /// `ParseStrictResponse` impl for `UpdateConnectorRegistration`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateConnectorRegistration {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_connector_registration::de_update_connector_registration_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_connector_registration::de_update_connector_registration_http_response(response)
                     }
                }
            }
