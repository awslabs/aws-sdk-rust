...
pub fn serialize_structure_crate_model_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_169) = &input.pardot {
        ...
        crate::json_ser::serialize_structure_crate_model_pardot_connector_profile_properties(&mut object_170, var_169)?;
        object_170.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_171) = &input.amplitude {
        ...
        crate::json_ser::serialize_structure_crate_model_amplitude_connector_profile_credentials(&mut object_172, var_171)?;
        object_172.finish();
    }
    if let Some(var_173) = &input.datadog {
        #[allow(unused_mut)]
        let mut object_174 = object.key("Datadog").start_object();
        crate::json_ser::serialize_structure_crate_model_datadog_connector_profile_credentials(&mut object_174, var_173)?;
        object_174.finish();
    }
    if let Some(var_175) = &input.dynatrace {
        #[allow(unused_mut)]
        let mut object_176 = object.key("Dynatrace").start_object();
        crate::json_ser::serialize_structure_crate_model_dynatrace_connector_profile_credentials(&mut object_176, var_175)?;
        object_176.finish();
    }
    ...
    if let Some(var_179) = &input.honeycode {
        ...
        crate::json_ser::serialize_structure_crate_model_honeycode_connector_profile_credentials(&mut object_180, var_179)?;
        object_180.finish();
    }
    if let Some(var_181) = &input.infor_nexus {
        #[allow(unused_mut)]
        let mut object_182 = object.key("InforNexus").start_object();
        crate::json_ser::serialize_structure_crate_model_infor_nexus_connector_profile_credentials(&mut object_182, var_181)?;
        object_182.finish();
    }
    if let Some(var_183) = &input.marketo {
        #[allow(unused_mut)]
        let mut object_184 = object.key("Marketo").start_object();
        crate::json_ser::serialize_structure_crate_model_marketo_connector_profile_credentials(&mut object_184, var_183)?;
        object_184.finish();
    }
    if let Some(var_185) = &input.redshift {
        #[allow(unused_mut)]
        let mut object_186 = object.key("Redshift").start_object();
        crate::json_ser::serialize_structure_crate_model_redshift_connector_profile_credentials(&mut object_186, var_185)?;
        object_186.finish();
    }
    if let Some(var_187) = &input.salesforce {
        #[allow(unused_mut)]
        let mut object_188 = object.key("Salesforce").start_object();
        crate::json_ser::serialize_structure_crate_model_salesforce_connector_profile_credentials(&mut object_188, var_187)?;
        object_188.finish();
    }
    if let Some(var_189) = &input.service_now {
        #[allow(unused_mut)]
        let mut object_190 = object.key("ServiceNow").start_object();
        crate::json_ser::serialize_structure_crate_model_service_now_connector_profile_credentials(&mut object_190, var_189)?;
        object_190.finish();
    }
    if let Some(var_191) = &input.singular {
        #[allow(unused_mut)]
        let mut object_192 = object.key("Singular").start_object();
        crate::json_ser::serialize_structure_crate_model_singular_connector_profile_credentials(&mut object_192, var_191)?;
        object_192.finish();
    }
    if let Some(var_193) = &input.slack {
        #[allow(unused_mut)]
        let mut object_194 = object.key("Slack").start_object();
        crate::json_ser::serialize_structure_crate_model_slack_connector_profile_credentials(&mut object_194, var_193)?;
        object_194.finish();
    }
    if let Some(var_195) = &input.snowflake {
        #[allow(unused_mut)]
        let mut object_196 = object.key("Snowflake").start_object();
        crate::json_ser::serialize_structure_crate_model_snowflake_connector_profile_credentials(&mut object_196, var_195)?;
        object_196.finish();
    }
    if let Some(var_197) = &input.trendmicro {
        #[allow(unused_mut)]
        let mut object_198 = object.key("Trendmicro").start_object();
        crate::json_ser::serialize_structure_crate_model_trendmicro_connector_profile_credentials(&mut object_198, var_197)?;
        object_198.finish();
    }
    if let Some(var_199) = &input.veeva {
        #[allow(unused_mut)]
        let mut object_200 = object.key("Veeva").start_object();
        crate::json_ser::serialize_structure_crate_model_veeva_connector_profile_credentials(&mut object_200, var_199)?;
        object_200.finish();
    }
    if let Some(var_201) = &input.zendesk {
        #[allow(unused_mut)]
        let mut object_202 = object.key("Zendesk").start_object();
        crate::json_ser::serialize_structure_crate_model_zendesk_connector_profile_credentials(&mut object_202, var_201)?;
        object_202.finish();
    }
    if let Some(var_203) = &input.sapo_data {
        #[allow(unused_mut)]
        let mut object_204 = object.key("SAPOData").start_object();
        crate::json_ser::serialize_structure_crate_model_sapo_data_connector_profile_credentials(&mut object_204, var_203)?;
        object_204.finish();
    }
    if let Some(var_205) = &input.custom_connector {
        #[allow(unused_mut)]
        let mut object_206 = object.key("CustomConnector").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_connector_profile_credentials(&mut object_206, var_205)?;
        object_206.finish();
    }
    if let Some(var_207) = &input.pardot {
        #[allow(unused_mut)]
        let mut object_208 = object.key("Pardot").start_object();
        crate::json_ser::serialize_structure_crate_model_pardot_connector_profile_credentials(&mut object_208, var_207)?;
        object_208.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_destination_connector_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DestinationConnectorProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_209) = &input.redshift {
        ...
        crate::json_ser::serialize_structure_crate_model_redshift_destination_properties(&mut object_210, var_209)?;
        object_210.finish();
    }
    if let Some(var_211) = &input.s3 {
        #[allow(unused_mut)]
        let mut object_212 = object.key("S3").start_object();
        crate::json_ser::serialize_structure_crate_model_s3_destination_properties(&mut object_212, var_211)?;
        object_212.finish();
    }
    if let Some(var_213) = &input.salesforce {
        #[allow(unused_mut)]
        let mut object_214 = object.key("Salesforce").start_object();
        crate::json_ser::serialize_structure_crate_model_salesforce_destination_properties(&mut object_214, var_213)?;
        object_214.finish();
    }
    if let Some(var_215) = &input.snowflake {
        #[allow(unused_mut)]
        let mut object_216 = object.key("Snowflake").start_object();
        crate::json_ser::serialize_structure_crate_model_snowflake_destination_properties(&mut object_216, var_215)?;
        object_216.finish();
    }
    if let Some(var_217) = &input.event_bridge {
        #[allow(unused_mut)]
        let mut object_218 = object.key("EventBridge").start_object();
        crate::json_ser::serialize_structure_crate_model_event_bridge_destination_properties(&mut object_218, var_217)?;
        object_218.finish();
    }
    if let Some(var_219) = &input.lookout_metrics {
        #[allow(unused_mut)]
        let mut object_220 = object.key("LookoutMetrics").start_object();
        crate::json_ser::serialize_structure_crate_model_lookout_metrics_destination_properties(&mut object_220, var_219)?;
        object_220.finish();
    }
    if let Some(var_221) = &input.upsolver {
        #[allow(unused_mut)]
        let mut object_222 = object.key("Upsolver").start_object();
        crate::json_ser::serialize_structure_crate_model_upsolver_destination_properties(&mut object_222, var_221)?;
        object_222.finish();
    }
    if let Some(var_223) = &input.honeycode {
        #[allow(unused_mut)]
        let mut object_224 = object.key("Honeycode").start_object();
        crate::json_ser::serialize_structure_crate_model_honeycode_destination_properties(&mut object_224, var_223)?;
        object_224.finish();
    }
    if let Some(var_225) = &input.customer_profiles {
        #[allow(unused_mut)]
        let mut object_226 = object.key("CustomerProfiles").start_object();
        crate::json_ser::serialize_structure_crate_model_customer_profiles_destination_properties(&mut object_226, var_225)?;
        object_226.finish();
    }
    if let Some(var_227) = &input.zendesk {
        #[allow(unused_mut)]
        let mut object_228 = object.key("Zendesk").start_object();
        crate::json_ser::serialize_structure_crate_model_zendesk_destination_properties(&mut object_228, var_227)?;
        object_228.finish();
    }
    if let Some(var_229) = &input.marketo {
        #[allow(unused_mut)]
        let mut object_230 = object.key("Marketo").start_object();
        crate::json_ser::serialize_structure_crate_model_marketo_destination_properties(&mut object_230, var_229)?;
        object_230.finish();
    }
    if let Some(var_231) = &input.custom_connector {
        #[allow(unused_mut)]
        let mut object_232 = object.key("CustomConnector").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_connector_destination_properties(&mut object_232, var_231)?;
        object_232.finish();
    }
    if let Some(var_233) = &input.sapo_data {
        #[allow(unused_mut)]
        let mut object_234 = object.key("SAPOData").start_object();
        crate::json_ser::serialize_structure_crate_model_sapo_data_destination_properties(&mut object_234, var_233)?;
        object_234.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_source_connector_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceConnectorProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_238) = &input.amplitude {
        ...
        crate::json_ser::serialize_structure_crate_model_amplitude_source_properties(&mut object_239, var_238)?;
        object_239.finish();
    }
    if let Some(var_240) = &input.datadog {
        #[allow(unused_mut)]
        let mut object_241 = object.key("Datadog").start_object();
        crate::json_ser::serialize_structure_crate_model_datadog_source_properties(&mut object_241, var_240)?;
        object_241.finish();
    }
    if let Some(var_242) = &input.dynatrace {
        #[allow(unused_mut)]
        let mut object_243 = object.key("Dynatrace").start_object();
        crate::json_ser::serialize_structure_crate_model_dynatrace_source_properties(&mut object_243, var_242)?;
        object_243.finish();
    }
    if let Some(var_244) = &input.google_analytics {
        #[allow(unused_mut)]
        let mut object_245 = object.key("GoogleAnalytics").start_object();
        crate::json_ser::serialize_structure_crate_model_google_analytics_source_properties(&mut object_245, var_244)?;
        object_245.finish();
    }
    if let Some(var_246) = &input.infor_nexus {
        #[allow(unused_mut)]
        let mut object_247 = object.key("InforNexus").start_object();
        crate::json_ser::serialize_structure_crate_model_infor_nexus_source_properties(&mut object_247, var_246)?;
        object_247.finish();
    }
    if let Some(var_248) = &input.marketo {
        #[allow(unused_mut)]
        let mut object_249 = object.key("Marketo").start_object();
        crate::json_ser::serialize_structure_crate_model_marketo_source_properties(&mut object_249, var_248)?;
        object_249.finish();
    }
    if let Some(var_250) = &input.s3 {
        #[allow(unused_mut)]
        let mut object_251 = object.key("S3").start_object();
        crate::json_ser::serialize_structure_crate_model_s3_source_properties(&mut object_251, var_250)?;
        object_251.finish();
    }
    if let Some(var_252) = &input.salesforce {
        #[allow(unused_mut)]
        let mut object_253 = object.key("Salesforce").start_object();
        crate::json_ser::serialize_structure_crate_model_salesforce_source_properties(&mut object_253, var_252)?;
        object_253.finish();
    }
    if let Some(var_254) = &input.service_now {
        #[allow(unused_mut)]
        let mut object_255 = object.key("ServiceNow").start_object();
        crate::json_ser::serialize_structure_crate_model_service_now_source_properties(&mut object_255, var_254)?;
        object_255.finish();
    }
    if let Some(var_256) = &input.singular {
        #[allow(unused_mut)]
        let mut object_257 = object.key("Singular").start_object();
        crate::json_ser::serialize_structure_crate_model_singular_source_properties(&mut object_257, var_256)?;
        object_257.finish();
    }
    if let Some(var_258) = &input.slack {
        #[allow(unused_mut)]
        let mut object_259 = object.key("Slack").start_object();
        crate::json_ser::serialize_structure_crate_model_slack_source_properties(&mut object_259, var_258)?;
        object_259.finish();
    }
    if let Some(var_260) = &input.trendmicro {
        #[allow(unused_mut)]
        let mut object_261 = object.key("Trendmicro").start_object();
        crate::json_ser::serialize_structure_crate_model_trendmicro_source_properties(&mut object_261, var_260)?;
        object_261.finish();
    }
    if let Some(var_262) = &input.veeva {
        #[allow(unused_mut)]
        let mut object_263 = object.key("Veeva").start_object();
        crate::json_ser::serialize_structure_crate_model_veeva_source_properties(&mut object_263, var_262)?;
        object_263.finish();
    }
    if let Some(var_264) = &input.zendesk {
        #[allow(unused_mut)]
        let mut object_265 = object.key("Zendesk").start_object();
        crate::json_ser::serialize_structure_crate_model_zendesk_source_properties(&mut object_265, var_264)?;
        object_265.finish();
    }
    if let Some(var_266) = &input.sapo_data {
        #[allow(unused_mut)]
        let mut object_267 = object.key("SAPOData").start_object();
        crate::json_ser::serialize_structure_crate_model_sapo_data_source_properties(&mut object_267, var_266)?;
        object_267.finish();
    }
    if let Some(var_268) = &input.custom_connector {
        #[allow(unused_mut)]
        let mut object_269 = object.key("CustomConnector").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_connector_source_properties(&mut object_269, var_268)?;
        object_269.finish();
    }
    if let Some(var_270) = &input.pardot {
        #[allow(unused_mut)]
        let mut object_271 = object.key("Pardot").start_object();
        crate::json_ser::serialize_structure_crate_model_pardot_source_properties(&mut object_271, var_270)?;
        object_271.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_trigger_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TriggerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_290) = &input.scheduled {
        ...
        crate::json_ser::serialize_structure_crate_model_scheduled_trigger_properties(&mut object_291, var_290)?;
        object_291.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_snowflake_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnowflakeConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_312) = &input.private_link_service_name {
        object.key("privateLinkServiceName").string(var_312.as_str());
    }
...
pub fn serialize_structure_crate_model_sapo_data_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_318) = &input.application_service_path {
        object.key("applicationServicePath").string(var_318.as_str());
    }
    if let Some(var_319) = &input.port_number {
        object.key("portNumber").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_319).into()));
    }
    ...
    if let Some(var_322) = &input.private_link_service_name {
        object.key("privateLinkServiceName").string(var_322.as_str());
    }
    if let Some(var_323) = &input.o_auth_properties {
        #[allow(unused_mut)]
        let mut object_324 = object.key("oAuthProperties").start_object();
        crate::json_ser::serialize_structure_crate_model_o_auth_properties(&mut object_324, var_323)?;
        object_324.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_329) = &input.o_auth2_properties {
        ...
        crate::json_ser::serialize_structure_crate_model_o_auth2_properties(&mut object_330, var_329)?;
        object_330.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_pardot_connector_profile_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PardotConnectorProfileProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_marketo_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MarketoConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_355) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_356, var_355)?;
        object_356.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_slack_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SlackConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_370) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_371, var_370)?;
        object_371.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_zendesk_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZendeskConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_380) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_381, var_380)?;
        object_381.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_sapo_data_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_382) = &input.basic_auth_credentials {
        ...
        crate::json_ser::serialize_structure_crate_model_basic_auth_credentials(&mut object_383, var_382)?;
        object_383.finish();
    }
    if let Some(var_384) = &input.o_auth_credentials {
        #[allow(unused_mut)]
        let mut object_385 = object.key("oAuthCredentials").start_object();
        crate::json_ser::serialize_structure_crate_model_o_auth_credentials(&mut object_385, var_384)?;
        object_385.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_387) = &input.basic {
        ...
        crate::json_ser::serialize_structure_crate_model_basic_auth_credentials(&mut object_388, var_387)?;
        object_388.finish();
    }
    if let Some(var_389) = &input.oauth2 {
        #[allow(unused_mut)]
        let mut object_390 = object.key("oauth2").start_object();
        crate::json_ser::serialize_structure_crate_model_o_auth2_credentials(&mut object_390, var_389)?;
        object_390.finish();
    }
    if let Some(var_391) = &input.api_key {
        #[allow(unused_mut)]
        let mut object_392 = object.key("apiKey").start_object();
        crate::json_ser::serialize_structure_crate_model_api_key_credentials(&mut object_392, var_391)?;
        object_392.finish();
    }
    if let Some(var_393) = &input.custom {
        #[allow(unused_mut)]
        let mut object_394 = object.key("custom").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_auth_credentials(&mut object_394, var_393)?;
        object_394.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_pardot_connector_profile_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PardotConnectorProfileCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_397) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_398, var_397)?;
        object_398.finish();
    }
...
pub fn serialize_structure_crate_model_redshift_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedshiftDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_401) = &input.intermediate_bucket_name {
        object.key("intermediateBucketName").string(var_401.as_str());
    }
    ...
    if let Some(var_403) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_404, var_403)?;
        object_404.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_s3_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3DestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_407) = &input.s3_output_format_config {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_output_format_config(&mut object_408, var_407)?;
        object_408.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_salesforce_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_413) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_414, var_413)?;
        object_414.finish();
    }
...
pub fn serialize_structure_crate_model_snowflake_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnowflakeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_418) = &input.intermediate_bucket_name {
        object.key("intermediateBucketName").string(var_418.as_str());
    }
    ...
    if let Some(var_420) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_421, var_420)?;
        object_421.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_event_bridge_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventBridgeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_423) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_424, var_423)?;
        object_424.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_upsolver_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpsolverDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_427) = &input.s3_output_format_config {
        ...
        crate::json_ser::serialize_structure_crate_model_upsolver_s3_output_format_config(&mut object_428, var_427)?;
        object_428.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_honeycode_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HoneycodeDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_430) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_431, var_430)?;
        object_431.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_zendesk_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZendeskDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_438) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_439, var_438)?;
        object_439.finish();
    }
...
pub fn serialize_structure_crate_model_marketo_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MarketoDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_442) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_443, var_442)?;
        object_443.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_connector_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomConnectorDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_445) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_446, var_445)?;
        object_446.finish();
    }
...
pub fn serialize_structure_crate_model_sapo_data_destination_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SapoDataDestinationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_456) = &input.success_response_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_success_response_handling_config(&mut object_457, var_456)?;
        object_457.finish();
    }
    ...
    if let Some(var_461) = &input.error_handling_config {
        ...
        crate::json_ser::serialize_structure_crate_model_error_handling_config(&mut object_462, var_461)?;
        object_462.finish();
    }
...
pub fn serialize_structure_crate_model_s3_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3SourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_472) = &input.s3_input_format_config {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_input_format_config(&mut object_473, var_472)?;
        object_473.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pardot_source_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PardotSourceProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_scheduled_trigger_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduledTriggerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_492) = &input.schedule_start_time {
        object.key("scheduleStartTime").date_time(var_492, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_493) = &input.schedule_end_time {
        object.key("scheduleEndTime").date_time(var_493, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_494) = &input.timezone {
        object.key("timezone").string(var_494.as_str());
    }
    if let Some(var_495) = &input.schedule_offset {
        object.key("scheduleOffset").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_495).into()));
    }
    if let Some(var_496) = &input.first_execution_from {
        object.key("firstExecutionFrom").date_time(var_496, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_497) = &input.flow_error_deactivation_threshold {
        object.key("flowErrorDeactivationThreshold").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_497).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_o_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_517) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_518, var_517)?;
        object_518.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_o_auth2_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OAuth2Credentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_523) = &input.o_auth_request {
        ...
        crate::json_ser::serialize_structure_crate_model_connector_o_auth_request(&mut object_524, var_523)?;
        object_524.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_auth_credentials(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomAuthCredentials) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_527) = &input.custom_authentication_type {
        object.key("customAuthenticationType").string(var_527.as_str());
    }
...
pub fn serialize_structure_crate_model_s3_output_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3OutputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_537) = &input.aggregation_config {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_config(&mut object_538, var_537)?;
        object_538.finish();
    }
...
pub fn serialize_structure_crate_model_upsolver_s3_output_format_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpsolverS3OutputFormatConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_543) = &input.aggregation_config {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_config(&mut object_544, var_543)?;
        object_544.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_aggregation_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AggregationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_554) = &input.target_file_size {
        object.key("targetFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_554).into()));
    }
    Ok(())
}
