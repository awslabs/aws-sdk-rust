...
impl StartFlowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_flow::StartFlow,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_flow::StartFlow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_flow::de_start_flow_http_response_with_props(
                status, headers, body,
            )
        }
    }
