...
pub use crate::operation::delete_connector_profile::_delete_connector_profile_output::DeleteConnectorProfileOutputBuilder;

pub use crate::operation::delete_connector_profile::_delete_connector_profile_input::DeleteConnectorProfileInputBuilder;
...
impl DeleteConnectorProfileInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_connector_profile();
...
pub struct DeleteConnectorProfileFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_connector_profile::builders::DeleteConnectorProfileInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_connector_profile::DeleteConnectorProfileOutput,
                    crate::operation::delete_connector_profile::DeleteConnectorProfileError,
                > for DeleteConnectorProfileFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteConnectorProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_connector_profile::DeleteConnectorProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_connector_profile::DeleteConnectorProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_connector_profile::DeleteConnectorProfile::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_connector_profile::DeleteConnectorProfile::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_connector_profile::DeleteConnectorProfileOutput, crate::operation::delete_connector_profile::DeleteConnectorProfileError, Self> {
