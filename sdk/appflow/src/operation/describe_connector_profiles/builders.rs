...
impl DescribeConnectorProfilesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_connector_profiles::DescribeConnectorProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_connector_profiles::DescribeConnectorProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_connector_profiles::DescribeConnectorProfilesOutput, crate::operation::describe_connector_profiles::DescribeConnectorProfilesError, Self> {
