...
impl DescribeConnectorProfilesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_connector_profiles::DescribeConnectorProfilesInput, ::aws_smithy_types::error::operation::BuildError> {
