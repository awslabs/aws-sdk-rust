...
impl StopFlowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_flow::StopFlow, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_flow::ser_stop_flow_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_flow::de_stop_flow_http_response_with_props(status, headers, body)
        }
    }
}
