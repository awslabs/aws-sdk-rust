...
impl DescribeFlowExecutionRecordsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_flow_execution_records::DescribeFlowExecutionRecords::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFlowExecutionRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_flow_execution_records::de_describe_flow_execution_records_http_response_with_props(
                status, headers, body,
            )
        }
    }
