...
impl DescribeFlowExecutionRecordsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_flow_execution_records::DescribeFlowExecutionRecordsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_flow_execution_records::DescribeFlowExecutionRecordsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_flow_execution_records::DescribeFlowExecutionRecordsOutput, crate::operation::describe_flow_execution_records::DescribeFlowExecutionRecordsError, Self> {
