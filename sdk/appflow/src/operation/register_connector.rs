...
impl RegisterConnectorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_connector::ser_register_connector_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterConnector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_connector::de_register_connector_http_response_with_props(status, headers, body)
        }
    }
}
