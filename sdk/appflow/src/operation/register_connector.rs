...
impl RegisterConnectorInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_connector::RegisterConnector::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterConnector {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_connector::de_register_connector_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::register_connector::RegisterConnectorError
{
...
impl std::error::Error for RegisterConnectorError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::ConnectorAuthenticationException(_inner) => Some(_inner),
            Self::ConnectorServerException(_inner) => Some(_inner),
