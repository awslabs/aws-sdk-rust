...
impl DeleteFlowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_flow::DeleteFlow, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_flow::ser_delete_flow_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_flow::de_delete_flow_http_response_with_props(status, headers, body)
        }
    }
}
