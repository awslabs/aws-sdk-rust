    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/update-connector-registration")
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectorRegistration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connector_registration::de_update_connector_registration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateConnectorRegistrationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_connector_registration::UpdateConnectorRegistrationError
{
