...
impl ListConnectorEntitiesOutputBuilder {
    ...
    ///
    /// <p>The response of <code>ListConnectorEntities</code> lists entities grouped by category. This map's key represents the group name, and its value contains the list of entities belonging to that group.</p>
    pub fn connector_entity_map(mut self, k: impl ::std::convert::Into<::std::string::String>, v: ::std::vec::Vec::<crate::types::ConnectorEntity>) -> Self {
    ...
    /// <p>The response of <code>ListConnectorEntities</code> lists entities grouped by category. This map's key represents the group name, and its value contains the list of entities belonging to that group.</p>
    pub fn get_connector_entity_map(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::vec::Vec::<crate::types::ConnectorEntity>>> {
        &self.connector_entity_map
    }
    /// <p>A token that you specify in your next <code>ListConnectorEntities</code> operation to get the next page of results in paginated response. The <code>ListConnectorEntities</code> operation provides this token if the response is too big for the page size.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_connector_entities::ListConnectorEntitiesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_connector_entities::ListConnectorEntitiesOutput {
                connector_entity_map: self.connector_entity_map
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("connector_entity_map", "connector_entity_map was not specified but it is required when building ListConnectorEntitiesOutput")
                    )?
                ,
