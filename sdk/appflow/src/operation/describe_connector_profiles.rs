...
impl DescribeConnectorProfilesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_connector_profiles::DescribeConnectorProfiles::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConnectorProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_connector_profiles::de_describe_connector_profiles_http_response_with_props(status, headers, body)
        }
    }
}
