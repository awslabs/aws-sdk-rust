...
impl crate::operation::update_connector_registration::builders::UpdateConnectorRegistrationInputBuilder {
...
impl UpdateConnectorRegistrationFluentBuilder {
    /// Creates a new `UpdateConnectorRegistrationFluentBuilder`.
