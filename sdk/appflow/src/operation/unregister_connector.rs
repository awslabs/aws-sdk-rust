...
impl UnregisterConnectorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::unregister_connector::UnregisterConnector,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_unregister_connector::ser_unregister_connector_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnregisterConnector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_unregister_connector::de_unregister_connector_http_response_with_props(status, headers, body)
        }
    }
}
