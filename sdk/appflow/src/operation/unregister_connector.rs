...
impl UnregisterConnectorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_unregister_connector::ser_unregister_connector_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unregister_connector::UnregisterConnector::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnregisterConnector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_unregister_connector::de_unregister_connector_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::unregister_connector::UnregisterConnectorError
{
