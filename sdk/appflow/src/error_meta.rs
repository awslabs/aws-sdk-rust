...
impl From<crate::operation::reset_connector_metadata_cache::ResetConnectorMetadataCacheError>
    for Error
{
    fn from(
        err: crate::operation::reset_connector_metadata_cache::ResetConnectorMetadataCacheError,
    ) -> Self {
        match err {
