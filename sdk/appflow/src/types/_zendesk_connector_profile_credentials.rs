        ...
        ::std::result::Result::Ok(
            crate::types::ZendeskConnectorProfileCredentials {
                client_id: self.client_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("client_id", "client_id was not specified but it is required when building ZendeskConnectorProfileCredentials")
                    )?
                ,
                client_secret: self.client_secret
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("client_secret", "client_secret was not specified but it is required when building ZendeskConnectorProfileCredentials")
                    )?
                ,
