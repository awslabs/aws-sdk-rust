    ...
    pub fn build(self) -> ::std::result::Result<crate::types::MarketoDestinationProperties, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::MarketoDestinationProperties {
                object: self.object
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("object", "object was not specified but it is required when building MarketoDestinationProperties")
                    )?
                ,
