...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::set_workspace_id): <p>The ID of the workspace to associate the license with.</p>
