...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace to associate the license with.</p><br>
    ///   - [`license_type(LicenseType)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::license_type) / [`set_license_type(LicenseType)`](crate::operation::associate_license::builders::AssociateLicenseFluentBuilder::set_license_type):<br>required: **true**<br><p>The type of license to associate with the workspace.</p><br>
