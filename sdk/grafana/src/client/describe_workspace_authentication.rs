...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::describe_workspace_authentication::builders::DescribeWorkspaceAuthenticationFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::describe_workspace_authentication::builders::DescribeWorkspaceAuthenticationFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace to return authentication information about.</p><br>
