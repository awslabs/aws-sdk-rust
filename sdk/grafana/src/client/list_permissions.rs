...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::list_permissions::builders::ListPermissionsFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::list_permissions::builders::ListPermissionsFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace to list permissions for. This parameter is required.</p><br>
