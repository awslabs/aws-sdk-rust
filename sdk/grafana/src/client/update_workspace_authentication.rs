...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::update_workspace_authentication::builders::UpdateWorkspaceAuthenticationFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::update_workspace_authentication::builders::UpdateWorkspaceAuthenticationFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace to update the authentication for.</p><br>
    ///   - [`authentication_providers(AuthenticationProviderTypes)`](crate::operation::update_workspace_authentication::builders::UpdateWorkspaceAuthenticationFluentBuilder::authentication_providers) / [`set_authentication_providers(Vec<AuthenticationProviderTypes>)`](crate::operation::update_workspace_authentication::builders::UpdateWorkspaceAuthenticationFluentBuilder::set_authentication_providers):<br>required: **true**<br><p>Specifies whether this workspace uses SAML 2.0, IAM Identity Center (successor to Single Sign-On), or both to authenticate users for using the Grafana console within a workspace. For more information, see <a href="https://docs.aws.amazon.com/grafana/latest/userguide/authentication-in-AMG.html">User authentication in Amazon Managed Grafana</a>.</p><br>
