...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::set_max_results): <p>The maximum number of results to include in the response.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::set_next_token): <p>The token to use when requesting the next set of results. You receive this token from a previous <code>ListVersions</code> operation.</p>
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::list_versions::builders::ListVersionsFluentBuilder::set_workspace_id): <p>The ID of the workspace to list the available upgrade versions. If not included, lists all versions of Grafana that are supported for <code>CreateWorkspace</code>.</p>
