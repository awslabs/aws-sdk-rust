...
impl super::Client {
    ...
    ///   - [`configuration(impl Into<String>)`](crate::operation::update_workspace_configuration::builders::UpdateWorkspaceConfigurationFluentBuilder::configuration) / [`set_configuration(impl Into<String>)`](crate::operation::update_workspace_configuration::builders::UpdateWorkspaceConfigurationFluentBuilder::set_configuration):<br>required: **true**<br><p>The new configuration string for the workspace. For more information about the format and configuration options available, see <a href="https://docs.aws.amazon.com/grafana/latest/userguide/AMG-configure-workspace.html">Working in your Grafana workspace</a>.</p><br>
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::update_workspace_configuration::builders::UpdateWorkspaceConfigurationFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::update_workspace_configuration::builders::UpdateWorkspaceConfigurationFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace to update.</p><br>
