...
pub fn serialize_structure_crate_input_create_workspace_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkspaceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_18) = &input.workspace_notification_destinations {
        let mut array_19 = object.key("workspaceNotificationDestinations").start_array();
...
pub fn serialize_structure_crate_input_create_workspace_api_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkspaceApiKeyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_27) = &input.seconds_to_live {
        object.key("secondsToLive").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_permissions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePermissionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_34 in var_32 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_update_instruction(&mut object_35, item_34)?;
                object_35.finish();
            }
        }
        array_33.finish();
...
pub fn serialize_structure_crate_input_update_workspace_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkspaceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_45) = &input.workspace_notification_destinations {
        let mut array_46 = object.key("workspaceNotificationDestinations").start_array();
...
pub fn serialize_structure_crate_input_update_workspace_authentication_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkspaceAuthenticationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_55) = &input.saml_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_saml_configuration(&mut object_56, var_55)?;
        object_56.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_update_instruction(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateInstruction) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_saml_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamlConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_65) = &input.assertion_attributes {
        ...
        crate::json_ser::serialize_structure_crate_model_assertion_attributes(&mut object_66, var_65)?;
        object_66.finish();
    }
...
pub fn serialize_union_crate_model_idp_metadata(object_64: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IdpMetadata) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::IdpMetadata::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("IdpMetadata"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_assertion_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AssertionAttributes) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_role_values(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RoleValues) -> Result<(), aws_smithy_http::operation::SerializationError> {
