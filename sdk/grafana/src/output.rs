...
pub struct ListWorkspacesOutput  {
    ...
    #[doc(hidden)]pub workspaces: std::option::Option<std::vec::Vec<crate::model::WorkspaceSummary>>,
...
pub struct CreateWorkspaceOutput  {
    ...
    #[doc(hidden)]pub workspace: std::option::Option<crate::model::WorkspaceDescription>,
}
...
pub struct UpdatePermissionsOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::UpdateError>>,
}
...
pub struct ListPermissionsOutput  {
    ...
    #[doc(hidden)]pub permissions: std::option::Option<std::vec::Vec<crate::model::PermissionEntry>>,
}
...
pub struct UpdateWorkspaceAuthenticationOutput  {
    ...
    #[doc(hidden)]pub authentication: std::option::Option<crate::model::AuthenticationDescription>,
}
