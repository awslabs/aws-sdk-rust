...
pub fn ser_idp_metadata(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IdpMetadata) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_idp_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IdpMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
