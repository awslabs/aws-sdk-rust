            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_permissions::ListPermissionsError::unhandled(
...
pub fn de_list_permissions_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_permissions_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_permissions::ListPermissionsError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "permissions" => {
                    builder = builder.set_permissions(crate::protocol_serde::shape_permission_entry_list::de_permission_entry_list(tokens)?);
                }
