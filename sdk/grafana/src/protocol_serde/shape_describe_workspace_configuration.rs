...
pub fn de_describe_workspace_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeWorkspaceConfigurationOutput, crate::error::DescribeWorkspaceConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeWorkspaceConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_workspace_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeWorkspaceConfigurationOutput, crate::error::DescribeWorkspaceConfigurationError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_workspace_configuration(value: &[u8], mut builder: crate::output::describe_workspace_configuration_output::Builder) -> Result<crate::output::describe_workspace_configuration_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
