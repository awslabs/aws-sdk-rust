...
pub(crate) fn de_workspace_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkspaceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
