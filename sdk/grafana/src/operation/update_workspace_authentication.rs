...
impl UpdateWorkspaceAuthenticationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workspace_authentication::UpdateWorkspaceAuthentication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkspaceAuthentication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_workspace_authentication::de_update_workspace_authentication_http_response_with_props(
                status, headers, body,
            )
        }
    }
