...
impl CreateWorkspaceApiKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_workspace_api_key::CreateWorkspaceApiKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_workspace_api_key::CreateWorkspaceApiKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_workspace_api_key::CreateWorkspaceApiKeyOutput, crate::operation::create_workspace_api_key::CreateWorkspaceApiKeyError, Self> {
