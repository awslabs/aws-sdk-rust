...
impl DescribeWorkspaceAuthenticationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_workspace_authentication::DescribeWorkspaceAuthentication,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_workspace_authentication::DescribeWorkspaceAuthentication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaceAuthentication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_workspace_authentication::de_describe_workspace_authentication_http_response_with_props(
                status, headers, body,
            )
        }
    }
