...
impl UpdateWorkspaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workspace::UpdateWorkspace::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkspace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_update_workspace::de_update_workspace_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_workspace::UpdateWorkspaceError
{
