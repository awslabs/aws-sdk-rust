...
impl UpdateWorkspaceConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_workspace_configuration::UpdateWorkspaceConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_workspace_configuration::UpdateWorkspaceConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_workspace_configuration::UpdateWorkspaceConfigurationOutput, crate::operation::update_workspace_configuration::UpdateWorkspaceConfigurationError, Self> {
