...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_license::AssociateLicenseOutput,
                    crate::operation::associate_license::AssociateLicenseError,
                > for AssociateLicenseFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateLicenseFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::associate_license::builders::AssociateLicenseInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_license::AssociateLicenseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_license::AssociateLicenseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_license::AssociateLicense::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_license::AssociateLicense::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_license::AssociateLicenseOutput, crate::operation::associate_license::AssociateLicenseError, Self> {
