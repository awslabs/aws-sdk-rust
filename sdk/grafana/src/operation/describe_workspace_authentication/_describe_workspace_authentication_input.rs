...
impl DescribeWorkspaceAuthenticationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_workspace_authentication::DescribeWorkspaceAuthenticationInput, ::aws_smithy_types::error::operation::BuildError> {
