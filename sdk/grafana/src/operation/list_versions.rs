...
impl ListVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_versions::ListVersions::new(),
        )
...
/// `ParseStrictResponse` impl for `ListVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_versions::de_list_versions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_versions::de_list_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
