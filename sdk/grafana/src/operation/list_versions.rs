...
impl ListVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListVersions`](crate::operation::list_versions::ListVersions)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_versions::ListVersions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_versions::ListVersions::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVersions", "grafana"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVersions {
    type Output = ::std::result::Result<crate::operation::list_versions::ListVersionsOutput, crate::operation::list_versions::ListVersionsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_versions::de_list_versions_http_response_with_props(status, headers, body)
        }
    }
}
