...
if (region) == ("ap-northeast-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.ap-northeast-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("ap-northeast-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.ap-northeast-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("ap-southeast-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.ap-southeast-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("ap-southeast-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.ap-southeast-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("eu-central-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.eu-central-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("eu-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.eu-west-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("eu-west-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.eu-west-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.us-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-east-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.us-east-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-west-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://grafana.us-west-2.amazonaws.com"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
