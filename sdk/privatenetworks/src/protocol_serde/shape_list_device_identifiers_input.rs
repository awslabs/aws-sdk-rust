...
pub fn ser_list_device_identifiers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_device_identifiers::ListDeviceIdentifiersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
