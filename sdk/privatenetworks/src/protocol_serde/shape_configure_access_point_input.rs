...
pub fn ser_configure_access_point_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConfigureAccessPointInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
