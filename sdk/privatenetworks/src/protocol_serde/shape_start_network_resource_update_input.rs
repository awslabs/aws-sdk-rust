...
pub fn ser_start_network_resource_update_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_network_resource_update::StartNetworkResourceUpdateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
