...
pub fn ser_site_plan(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SitePlan) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_site_plan<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SitePlan>, aws_smithy_json::deserialize::error::DeserializeError>
