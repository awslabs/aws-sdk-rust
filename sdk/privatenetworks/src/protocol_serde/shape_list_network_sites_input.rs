...
pub fn ser_list_network_sites_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListNetworkSitesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
