...
pub fn ser_list_networks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_networks::ListNetworksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
