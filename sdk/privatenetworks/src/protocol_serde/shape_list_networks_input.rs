...
pub fn ser_list_networks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListNetworksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
