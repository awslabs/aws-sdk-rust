...
pub fn ser_create_network_site_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNetworkSiteInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
