...
pub fn ser_list_network_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListNetworkResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
