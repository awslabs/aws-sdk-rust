...
pub fn ser_list_orders_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_orders::ListOrdersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
