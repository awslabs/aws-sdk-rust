...
pub fn de_delete_network_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteNetworkOutput, crate::error::DeleteNetworkError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteNetworkError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_network_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteNetworkOutput, crate::error::DeleteNetworkError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_network_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_network::de_delete_network(response.body().as_ref(), output).map_err(crate::error::DeleteNetworkError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_network(value: &[u8], mut builder: crate::output::delete_network_output::Builder) -> Result<crate::output::delete_network_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
