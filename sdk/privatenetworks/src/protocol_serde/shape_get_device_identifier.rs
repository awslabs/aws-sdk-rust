...
pub fn de_get_device_identifier_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_device_identifier::GetDeviceIdentifierOutput, crate::operation::get_device_identifier::GetDeviceIdentifierError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_device_identifier::GetDeviceIdentifierError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_device_identifier_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_device_identifier::GetDeviceIdentifierOutput, crate::operation::get_device_identifier::GetDeviceIdentifierError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_device_identifier::builders::GetDeviceIdentifierOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_device_identifier::de_get_device_identifier(response.body().as_ref(), output).map_err(crate::operation::get_device_identifier::GetDeviceIdentifierError::unhandled)?;
