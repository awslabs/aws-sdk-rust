...
impl GetNetworkResourceFluentBuilder  {
    /// Creates a new `GetNetworkResource`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_network_resource::GetNetworkResourceOutput, aws_smithy_http::result::SdkError<crate::operation::get_network_resource::GetNetworkResourceError>>
                     {
