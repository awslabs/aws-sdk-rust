...
impl DeleteNetworkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_network::DeleteNetwork,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_network::DeleteNetwork::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNetwork {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_network::de_delete_network_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_network::de_delete_network_http_response_with_props(
                status, headers, body,
            )
        }
    }
