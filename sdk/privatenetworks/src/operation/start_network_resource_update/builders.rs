...
impl crate::operation::start_network_resource_update::builders::StartNetworkResourceUpdateInputBuilder {
...
impl StartNetworkResourceUpdateFluentBuilder {
    /// Creates a new `StartNetworkResourceUpdateFluentBuilder`.
