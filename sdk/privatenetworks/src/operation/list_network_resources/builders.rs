...
impl ListNetworkResourcesFluentBuilder  {
    /// Creates a new `ListNetworkResources`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_network_resources::ListNetworkResourcesOutput, aws_smithy_http::result::SdkError<crate::operation::list_network_resources::ListNetworkResourcesError>>
                     {
