...
impl DeleteNetworkSiteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_network_site::DeleteNetworkSiteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_network_site::DeleteNetworkSiteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_network_site::DeleteNetworkSiteOutput, crate::operation::delete_network_site::DeleteNetworkSiteError, Self> {
