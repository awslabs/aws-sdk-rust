...
impl DeactivateDeviceIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deactivate_device_identifier::DeactivateDeviceIdentifierInput, ::aws_smithy_types::error::operation::BuildError> {
