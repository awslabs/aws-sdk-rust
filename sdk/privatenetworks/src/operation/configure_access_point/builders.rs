...
impl ConfigureAccessPointInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.configure_access_point();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::configure_access_point::ConfigureAccessPointOutput,
                    crate::operation::configure_access_point::ConfigureAccessPointError,
                > for ConfigureAccessPointFluentBuilder
            {
                fn send(
                    self,
...
impl ConfigureAccessPointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::configure_access_point::ConfigureAccessPointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::configure_access_point::ConfigureAccessPointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::configure_access_point::ConfigureAccessPoint::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::configure_access_point::ConfigureAccessPoint::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::configure_access_point::ConfigureAccessPointOutput, crate::operation::configure_access_point::ConfigureAccessPointError, Self> {
