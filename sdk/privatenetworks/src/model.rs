...
pub struct NetworkSite  {
    ...
    #[doc(hidden)]pub network_site_arn: std::option::Option<std::string::String>,
    /// <p>The name of the network site.</p>
    #[doc(hidden)]pub network_site_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::NetworkSiteStatus>,
    ...
    #[doc(hidden)]pub network_arn: std::option::Option<std::string::String>,
    /// <p>The pending plan of the network site.</p>
    #[doc(hidden)]pub pending_plan: std::option::Option<crate::model::SitePlan>,
    /// <p>The current plan of the network site.</p>
    #[doc(hidden)]pub current_plan: std::option::Option<crate::model::SitePlan>,
...
pub struct SitePlan  {
    ...
    #[doc(hidden)]pub resource_definitions: std::option::Option<std::vec::Vec<crate::model::NetworkResourceDefinition>>,
    /// <p>The options of the plan.</p>
    #[doc(hidden)]pub options: std::option::Option<std::vec::Vec<crate::model::NameValuePair>>,
}
impl SitePlan {
    /// <p>The resource definitions of the plan.</p>
...
pub struct NetworkResourceDefinition  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::NetworkResourceDefinitionType>,
...
impl std::convert::From<&str> for NetworkResourceDefinitionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceDefinitionType::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkResourceDefinitionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkResourceDefinitionType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for NetworkSiteStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkSiteStatus::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkSiteStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkSiteStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct Order  {
    ...
    #[doc(hidden)]pub order_arn: std::option::Option<std::string::String>,
    /// <p>The shipping address of the order.</p>
    #[doc(hidden)]pub shipping_address: std::option::Option<crate::model::Address>,
    ...
    #[doc(hidden)]pub tracking_information: std::option::Option<std::vec::Vec<crate::model::TrackingInformation>>,
    /// <p>The acknowledgement status of the order.</p>
    #[doc(hidden)]pub acknowledgment_status: std::option::Option<crate::model::AcknowledgmentStatus>,
...
impl std::convert::From<&str> for AcknowledgmentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AcknowledgmentStatus::Unknown(other.to_owned())
        }
    }
}
...
impl AcknowledgmentStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AcknowledgmentStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct TrackingInformation  {
    ...
    #[doc(hidden)]pub tracking_number: std::option::Option<std::string::String>,
}
...
pub struct Address  {
    ...
    #[doc(hidden)]pub company: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub state_or_province: std::option::Option<std::string::String>,
    /// <p>The first line of the street address.</p>
    #[doc(hidden)]pub street1: std::option::Option<std::string::String>,
    /// <p>The second line of the street address.</p>
    #[doc(hidden)]pub street2: std::option::Option<std::string::String>,
    /// <p>The third line of the street address.</p>
    #[doc(hidden)]pub street3: std::option::Option<std::string::String>,
}
impl Address {
    /// <p>The city for this address.</p>
...
impl std::convert::From<&str> for OrderFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderFilterKeys::Unknown(other.to_owned())
        }
    }
}
...
impl OrderFilterKeys {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OrderFilterKeys::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for NetworkSiteFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkSiteFilterKeys::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkSiteFilterKeys {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkSiteFilterKeys::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct Network  {
    ...
    #[doc(hidden)]pub network_name: std::option::Option<std::string::String>,
...
impl std::convert::From<&str> for NetworkFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkFilterKeys::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkFilterKeys {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkFilterKeys::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct NetworkResource  {
    ...
    #[doc(hidden)]pub network_resource_arn: std::option::Option<std::string::String>,
    /// <p>The description of the network resource.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>The type of the network resource.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::NetworkResourceType>,
    /// <p>The status of the network resource.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::NetworkResourceStatus>,
    ...
    #[doc(hidden)]pub model: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub health: std::option::Option<crate::model::HealthStatus>,
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::vec::Vec<crate::model::NameValuePair>>,
    /// <p>The position of the network resource.</p>
    #[doc(hidden)]pub position: std::option::Option<crate::model::Position>,
...
pub struct Position  {
    ...
    #[doc(hidden)]pub latitude: std::option::Option<f64>,
    /// <p>The longitude of the position.</p>
    #[doc(hidden)]pub longitude: std::option::Option<f64>,
    /// <p>The elevation of the equipment at this position.</p>
    #[doc(hidden)]pub elevation: std::option::Option<f64>,
    /// <p>The units used to measure the elevation of the position.</p>
    #[doc(hidden)]pub elevation_unit: std::option::Option<crate::model::ElevationUnit>,
    /// <p>The reference point from which elevation is reported.</p>
    #[doc(hidden)]pub elevation_reference: std::option::Option<crate::model::ElevationReference>,
}
impl Position {
    /// <p>The latitude of the position.</p>
...
impl std::convert::From<&str> for ElevationReference {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElevationReference::Unknown(other.to_owned())
        }
    }
}
...
impl ElevationReference {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ElevationReference::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for ElevationUnit {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElevationUnit::Unknown(other.to_owned())
        }
    }
}
...
impl ElevationUnit {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ElevationUnit::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for NetworkResourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceStatus::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkResourceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkResourceStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for NetworkResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceType::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkResourceType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for NetworkResourceFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceFilterKeys::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkResourceFilterKeys {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkResourceFilterKeys::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct DeviceIdentifier  {
    ...
    #[doc(hidden)]pub device_identifier_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the traffic group to which the device identifier belongs.</p>
    #[doc(hidden)]pub traffic_group_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub imsi: std::option::Option<std::string::String>,
    /// <p>The Integrated Circuit Card Identifier of the device identifier.</p>
    #[doc(hidden)]pub iccid: std::option::Option<std::string::String>,
    /// <p>The vendor of the device identifier.</p>
    #[doc(hidden)]pub vendor: std::option::Option<std::string::String>,
    /// <p>The status of the device identifier.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::DeviceIdentifierStatus>,
...
impl std::convert::From<&str> for DeviceIdentifierStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceIdentifierStatus::Unknown(other.to_owned())
        }
    }
}
...
impl DeviceIdentifierStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeviceIdentifierStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for DeviceIdentifierFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceIdentifierFilterKeys::Unknown(other.to_owned())
        }
    }
}
...
impl DeviceIdentifierFilterKeys {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeviceIdentifierFilterKeys::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
