...
pub struct UpdateNetworkSitePlanOutput  {
    ...
    #[doc(hidden)]pub network_site: std::option::Option<crate::model::NetworkSite>,
...
pub struct ListOrdersOutput  {
    ...
    #[doc(hidden)]pub orders: std::option::Option<std::vec::Vec<crate::model::Order>>,
...
pub struct ListNetworkSitesOutput  {
    ...
    #[doc(hidden)]pub network_sites: std::option::Option<std::vec::Vec<crate::model::NetworkSite>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListNetworksOutput  {
    /// <p>The networks.</p>
    #[doc(hidden)]pub networks: std::option::Option<std::vec::Vec<crate::model::Network>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDeviceIdentifiersOutput  {
    ...
    #[doc(hidden)]pub device_identifiers: std::option::Option<std::vec::Vec<crate::model::DeviceIdentifier>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetNetworkResourceOutput  {
    ...
    #[doc(hidden)]pub network_resource: std::option::Option<crate::model::NetworkResource>,
...
pub struct GetNetworkOutput  {
    ...
    #[doc(hidden)]pub network: std::option::Option<crate::model::Network>,
...
pub struct GetDeviceIdentifierOutput  {
    ...
    #[doc(hidden)]pub device_identifier: std::option::Option<crate::model::DeviceIdentifier>,
...
pub struct ConfigureAccessPointOutput  {
    /// <p>Information about the network resource.</p>
    #[doc(hidden)]pub access_point: std::option::Option<crate::model::NetworkResource>,
}
