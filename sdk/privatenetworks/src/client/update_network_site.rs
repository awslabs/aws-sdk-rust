...
impl super::Client {
    ...
    ///   - [`network_site_arn(impl Into<String>)`](crate::operation::update_network_site::builders::UpdateNetworkSiteFluentBuilder::network_site_arn) / [`set_network_site_arn(impl Into<String>)`](crate::operation::update_network_site::builders::UpdateNetworkSiteFluentBuilder::set_network_site_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the network site.</p><br>
