...
impl super::Client {
    ...
    ///   - [`filters(NetworkFilterKeys, Vec::<String>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::filters) / [`set_filters(Option<HashMap::<NetworkFilterKeys, Vec::<String>>>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_filters):<br>required: **false**<br><p>The filters.</p> <ul>  <li>   <p><code>STATUS</code> - The status (<code>AVAILABLE</code> | <code>CREATED</code> | <code>DELETED</code> | <code>DEPROVISIONING</code> | <code>PROVISIONING</code>).</p></li> </ul> <p>Filter values are case sensitive. If you specify multiple values for a filter, the values are joined with an <code>OR</code>, and the request returns all results that match any of the specified values.</p><br>
    ///   - [`start_token(impl Into<String>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::start_token) / [`set_start_token(Option<String>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_start_token):<br>required: **false**<br><p>The token for the next page of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return.</p><br>
