...
impl super::Client {
    ...
    ///   - [`order_arn(impl Into<String>)`](crate::operation::get_order::builders::GetOrderFluentBuilder::order_arn) / [`set_order_arn(impl Into<String>)`](crate::operation::get_order::builders::GetOrderFluentBuilder::set_order_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the order.</p><br>
