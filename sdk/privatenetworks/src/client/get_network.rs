...
impl super::Client {
    ...
    ///   - [`network_arn(impl ::std::convert::Into<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::network_arn) / [`set_network_arn(Option<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::set_network_arn): <p>The Amazon Resource Name (ARN) of the network.</p>
