...
impl super::Client {
    ...
    ///   - [`network_arn(impl Into<String>)`](crate::operation::delete_network::builders::DeleteNetworkFluentBuilder::network_arn) / [`set_network_arn(impl Into<String>)`](crate::operation::delete_network::builders::DeleteNetworkFluentBuilder::set_network_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the network.</p><br>
