...
impl super::Client {
    ...
    ///   - [`network_site_arn(impl Into<String>)`](crate::operation::update_network_site_plan::builders::UpdateNetworkSitePlanFluentBuilder::network_site_arn) / [`set_network_site_arn(impl Into<String>)`](crate::operation::update_network_site_plan::builders::UpdateNetworkSitePlanFluentBuilder::set_network_site_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the network site.</p><br>
    ///   - [`pending_plan(SitePlan)`](crate::operation::update_network_site_plan::builders::UpdateNetworkSitePlanFluentBuilder::pending_plan) / [`set_pending_plan(Option<SitePlan>)`](crate::operation::update_network_site_plan::builders::UpdateNetworkSitePlanFluentBuilder::set_pending_plan):<br>required: **true**<br><p>The pending plan.</p><br>
