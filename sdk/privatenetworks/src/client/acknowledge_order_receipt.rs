...
impl super::Client {
    ...
    ///   - [`order_arn(impl Into<String>)`](crate::operation::acknowledge_order_receipt::builders::AcknowledgeOrderReceiptFluentBuilder::order_arn) / [`set_order_arn(impl Into<String>)`](crate::operation::acknowledge_order_receipt::builders::AcknowledgeOrderReceiptFluentBuilder::set_order_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the order.</p><br>
