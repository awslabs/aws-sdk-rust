...
impl aws_smithy_http::response::ParseStrictResponse for GetNetworkResource {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_network_resource::de_get_network_resource_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_network_resource::de_get_network_resource_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNetworkSite {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_network_site::de_update_network_site_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_network_site::de_update_network_site_http_response(response)
                     }
                }
            }
