...
pub fn serialize_structure_list_change_sets_input(
        ...
        for item_4 in var_2 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_5, item_4);
                object_5.finish();
            }
        }
        array_3.finish();
    ...
    if let Some(var_8) = &input.sort {
        ...
        crate::json_ser::serialize_structure_sort(&mut object_9, var_8);
        object_9.finish();
    }
}

pub fn serialize_structure_list_entities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_14 in var_12 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_15, item_14);
                object_15.finish();
            }
        }
        array_13.finish();
    ...
    if let Some(var_18) = &input.sort {
        ...
        crate::json_ser::serialize_structure_sort(&mut object_19, var_18);
        object_19.finish();
    }
}

pub fn serialize_structure_start_change_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_change(&mut object_24, item_23);
                object_24.finish();
            }
        }
        array_22.finish();
...
pub fn serialize_structure_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_34) = &input.entity {
        ...
        crate::json_ser::serialize_structure_entity(&mut object_35, var_34);
        object_35.finish();
    }
...
pub fn serialize_structure_entity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
