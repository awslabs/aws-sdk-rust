...
pub(crate) fn reflens_describe_assessment_output_output_next_token(
    input: &crate::operation::describe_assessment::DescribeAssessmentOutput,
...
pub(crate) fn reflens_list_assessments_output_output_next_token(
...
pub(crate) fn lens_describe_assessment_output_output_control_assessments(
    input: crate::operation::describe_assessment::DescribeAssessmentOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ControlAssessment>> {
    let input = input.control_assessments?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_assessments_output_output_assessment_summary_list(
    input: crate::operation::list_assessments::ListAssessmentsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AssessmentSummary>> {
    let input = input.assessment_summary_list?;
    ::std::option::Option::Some(input)
}
