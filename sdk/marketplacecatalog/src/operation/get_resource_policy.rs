    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_resource_policy::GetResourcePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_policy::GetResourcePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/GetResourcePolicy").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_resource_policy::GetResourcePolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_policy::GetResourcePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetResourcePolicy", "marketplacecatalog"));
...
impl GetResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `GetResourcePolicyError::InternalServiceException`.
