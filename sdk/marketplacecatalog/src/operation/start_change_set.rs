...
impl StartChangeSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_change_set::StartChangeSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_change_set::ser_start_change_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartChangeSet {
    type Output =
        ::std::result::Result<crate::operation::start_change_set::StartChangeSetOutput, crate::operation::start_change_set::StartChangeSetError>;
