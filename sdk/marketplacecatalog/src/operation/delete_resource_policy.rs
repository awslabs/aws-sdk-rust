...
#[derive(Debug)]
    ...
    ::std::write!(output, "/DeleteResourcePolicy").expect("formatting should succeed");
...
fn uri_query(_input: &crate::operation::delete_resource_policy::DeleteResourcePolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("resource_arn", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::InternalServiceException`.
