...
impl BatchDescribeEntitiesOutputBuilder {
    ...
    /// <p>Details about each entity.</p>
    pub fn set_entity_details(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::EntityDetail>>) -> Self {
        self.entity_details = input; self
    }
    /// <p>Details about each entity.</p>
    ...
    /// <p>A map of errors returned, with <code>EntityId</code> as the key and <code>errorDetail</code> as the value.</p>
    pub fn set_errors(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::BatchDescribeErrorDetail>>) -> Self {
