...
pub struct Change  {
    ...
    #[doc(hidden)]pub change_type: std::option::Option<std::string::String>,
    /// <p>The entity to be changed.</p>
    #[doc(hidden)]pub entity: std::option::Option<crate::model::Entity>,
    ...
    #[doc(hidden)]pub change_name: std::option::Option<std::string::String>,
}
impl Change {
    /// <p>Change types are single string values that describe your intention for the change. Each change type is unique for each <code>EntityType</code> provided in the change's scope.</p>
...
pub struct EntitySummary  {
    ...
    #[doc(hidden)]pub visibility: std::option::Option<std::string::String>,
}
impl EntitySummary {
    /// <p>The name for the entity. This value is not unique. It is defined by the seller.</p>
...
pub struct Sort  {
    ...
    #[doc(hidden)]pub sort_by: std::option::Option<std::string::String>,
...
pub struct Filter  {
    ...
    /// </ul>
    #[doc(hidden)]pub value_list: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Filter {
    /// <p>For <code>ListEntities</code>, the supported value for this is an <code>EntityId</code>.</p> 
    /// <p>For <code>ListChangeSets</code>, the supported values are as follows:</p>
...
pub struct ChangeSetSummaryListItem  {
    ...
    #[doc(hidden)]pub entity_id_list: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ChangeSummary  {
    ...
    #[doc(hidden)]pub error_detail_list: std::option::Option<std::vec::Vec<crate::model::ErrorDetail>>,
    /// <p>Optional name for the change.</p>
    #[doc(hidden)]pub change_name: std::option::Option<std::string::String>,
}
impl ChangeSummary {
