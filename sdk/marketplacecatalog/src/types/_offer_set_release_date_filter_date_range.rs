...
pub struct OfferSetReleaseDateFilterDateRange {
...
impl OfferSetReleaseDateFilterDateRange {
    /// <p>Allows filtering on the <code>ReleaseDate</code> of offer set after a date.</p>
...
impl OfferSetReleaseDateFilterDateRange {
    /// Creates a new builder-style object to manufacture [`OfferSetReleaseDateFilterDateRange`](crate::types::OfferSetReleaseDateFilterDateRange).
    pub fn builder() -> crate::types::builders::OfferSetReleaseDateFilterDateRangeBuilder {
        crate::types::builders::OfferSetReleaseDateFilterDateRangeBuilder::default()
    }
}

/// A builder for [`OfferSetReleaseDateFilterDateRange`](crate::types::OfferSetReleaseDateFilterDateRange).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OfferSetReleaseDateFilterDateRangeBuilder {
    pub(crate) after_value: ::std::option::Option<::std::string::String>,
    pub(crate) before_value: ::std::option::Option<::std::string::String>,
}
impl OfferSetReleaseDateFilterDateRangeBuilder {
    /// <p>Allows filtering on the <code>ReleaseDate</code> of offer set after a date.</p>
    ...
    /// Consumes the builder and constructs a [`OfferSetReleaseDateFilterDateRange`](crate::types::OfferSetReleaseDateFilterDateRange).
    pub fn build(self) -> crate::types::OfferSetReleaseDateFilterDateRange {
        crate::types::OfferSetReleaseDateFilterDateRange {
