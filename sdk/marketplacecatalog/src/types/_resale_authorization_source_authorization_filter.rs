...
pub struct ResaleAuthorizationSourceAuthorizationFilter {
...
impl ResaleAuthorizationSourceAuthorizationFilter {
    /// <p>Allows filtering on the <code>SourceAuthorization</code> of a ResaleAuthorization with list input.</p>
    ///
...
impl ResaleAuthorizationSourceAuthorizationFilter {
    /// Creates a new builder-style object to manufacture [`ResaleAuthorizationSourceAuthorizationFilter`](crate::types::ResaleAuthorizationSourceAuthorizationFilter).
    pub fn builder() -> crate::types::builders::ResaleAuthorizationSourceAuthorizationFilterBuilder {
        crate::types::builders::ResaleAuthorizationSourceAuthorizationFilterBuilder::default()
    }
}

/// A builder for [`ResaleAuthorizationSourceAuthorizationFilter`](crate::types::ResaleAuthorizationSourceAuthorizationFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResaleAuthorizationSourceAuthorizationFilterBuilder {
    pub(crate) value_list: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl ResaleAuthorizationSourceAuthorizationFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`ResaleAuthorizationSourceAuthorizationFilter`](crate::types::ResaleAuthorizationSourceAuthorizationFilter).
    pub fn build(self) -> crate::types::ResaleAuthorizationSourceAuthorizationFilter {
        crate::types::ResaleAuthorizationSourceAuthorizationFilter { value_list: self.value_list }
    }
}
