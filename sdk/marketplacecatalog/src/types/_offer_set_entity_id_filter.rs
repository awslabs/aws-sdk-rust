...
pub struct OfferSetEntityIdFilter {
...
impl OfferSetEntityIdFilter {
    /// Creates a new builder-style object to manufacture [`OfferSetEntityIdFilter`](crate::types::OfferSetEntityIdFilter).
    pub fn builder() -> crate::types::builders::OfferSetEntityIdFilterBuilder {
        crate::types::builders::OfferSetEntityIdFilterBuilder::default()
    }
}

/// A builder for [`OfferSetEntityIdFilter`](crate::types::OfferSetEntityIdFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OfferSetEntityIdFilterBuilder {
    pub(crate) value_list: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl OfferSetEntityIdFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`OfferSetEntityIdFilter`](crate::types::OfferSetEntityIdFilter).
    pub fn build(self) -> crate::types::OfferSetEntityIdFilter {
        crate::types::OfferSetEntityIdFilter { value_list: self.value_list }
    }
}
