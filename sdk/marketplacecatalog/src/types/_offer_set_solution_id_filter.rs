...
pub struct OfferSetSolutionIdFilter {
...
impl OfferSetSolutionIdFilter {
    /// Creates a new builder-style object to manufacture [`OfferSetSolutionIdFilter`](crate::types::OfferSetSolutionIdFilter).
    pub fn builder() -> crate::types::builders::OfferSetSolutionIdFilterBuilder {
        crate::types::builders::OfferSetSolutionIdFilterBuilder::default()
    }
}

/// A builder for [`OfferSetSolutionIdFilter`](crate::types::OfferSetSolutionIdFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OfferSetSolutionIdFilterBuilder {
    pub(crate) value_list: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl OfferSetSolutionIdFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`OfferSetSolutionIdFilter`](crate::types::OfferSetSolutionIdFilter).
    pub fn build(self) -> crate::types::OfferSetSolutionIdFilter {
        crate::types::OfferSetSolutionIdFilter { value_list: self.value_list }
    }
}
