...
pub struct OfferSetLastModifiedDateFilterDateRange {
...
impl OfferSetLastModifiedDateFilterDateRange {
    /// <p>Allows filtering on the <code>LastModifiedDate</code> of an offer set after a date.</p>
...
impl OfferSetLastModifiedDateFilterDateRange {
    /// Creates a new builder-style object to manufacture [`OfferSetLastModifiedDateFilterDateRange`](crate::types::OfferSetLastModifiedDateFilterDateRange).
    pub fn builder() -> crate::types::builders::OfferSetLastModifiedDateFilterDateRangeBuilder {
        crate::types::builders::OfferSetLastModifiedDateFilterDateRangeBuilder::default()
    }
}

/// A builder for [`OfferSetLastModifiedDateFilterDateRange`](crate::types::OfferSetLastModifiedDateFilterDateRange).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OfferSetLastModifiedDateFilterDateRangeBuilder {
    pub(crate) after_value: ::std::option::Option<::std::string::String>,
    pub(crate) before_value: ::std::option::Option<::std::string::String>,
}
impl OfferSetLastModifiedDateFilterDateRangeBuilder {
    /// <p>Allows filtering on the <code>LastModifiedDate</code> of an offer set after a date.</p>
    ...
    /// Consumes the builder and constructs a [`OfferSetLastModifiedDateFilterDateRange`](crate::types::OfferSetLastModifiedDateFilterDateRange).
    pub fn build(self) -> crate::types::OfferSetLastModifiedDateFilterDateRange {
        crate::types::OfferSetLastModifiedDateFilterDateRange {
