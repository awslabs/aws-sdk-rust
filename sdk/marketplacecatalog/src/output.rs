...
pub struct StartChangeSetOutput  {
    ...
    #[doc(hidden)]pub change_set_arn: std::option::Option<std::string::String>,
}
...
pub struct ListEntitiesOutput  {
    ...
    #[doc(hidden)]pub entity_summary_list: std::option::Option<std::vec::Vec<crate::model::EntitySummary>>,
...
pub struct ListChangeSetsOutput  {
    ...
    #[doc(hidden)]pub change_set_summary_list: std::option::Option<std::vec::Vec<crate::model::ChangeSetSummaryListItem>>,
...
pub struct DescribeEntityOutput  {
    ...
    #[doc(hidden)]pub entity_identifier: std::option::Option<std::string::String>,
    /// <p>The ARN associated to the unique identifier for the entity referenced in this request.</p>
    #[doc(hidden)]pub entity_arn: std::option::Option<std::string::String>,
    /// <p>The last modified date of the entity, in ISO 8601 format (2018-02-27T13:45:22Z).</p>
    #[doc(hidden)]pub last_modified_date: std::option::Option<std::string::String>,
...
pub struct DescribeChangeSetOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ChangeStatus>,
    ...
    #[doc(hidden)]pub failure_code: std::option::Option<crate::model::FailureCode>,
    ...
    #[doc(hidden)]pub failure_description: std::option::Option<std::string::String>,
    /// <p>An array of <code>ChangeSummary</code> objects.</p>
    #[doc(hidden)]pub change_set: std::option::Option<std::vec::Vec<crate::model::ChangeSummary>>,
}
