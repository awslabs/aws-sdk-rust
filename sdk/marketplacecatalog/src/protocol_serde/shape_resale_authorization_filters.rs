...
pub fn ser_resale_authorization_filters(
    ...
    if let Some(var_9) = &input.availability_end_date {
        ...
        crate::protocol_serde::shape_resale_authorization_availability_end_date_filter::ser_resale_authorization_availability_end_date_filter(&mut object_10, var_9)?;
        object_10.finish();
    }
    if let Some(var_11) = &input.manufacturer_account_id {
        #[allow(unused_mut)]
        let mut object_12 = object.key("ManufacturerAccountId").start_object();
        crate::protocol_serde::shape_resale_authorization_manufacturer_account_id_filter::ser_resale_authorization_manufacturer_account_id_filter(&mut object_12, var_11)?;
        object_12.finish();
    }
    ...
    if let Some(var_15) = &input.manufacturer_legal_name {
        ...
        crate::protocol_serde::shape_resale_authorization_manufacturer_legal_name_filter::ser_resale_authorization_manufacturer_legal_name_filter(&mut object_16, var_15)?;
        object_16.finish();
    }
    if let Some(var_17) = &input.reseller_account_id {
        #[allow(unused_mut)]
        let mut object_18 = object.key("ResellerAccountID").start_object();
        crate::protocol_serde::shape_resale_authorization_reseller_account_id_filter::ser_resale_authorization_reseller_account_id_filter(&mut object_18, var_17)?;
        object_18.finish();
    }
    if let Some(var_19) = &input.reseller_legal_name {
        #[allow(unused_mut)]
        let mut object_20 = object.key("ResellerLegalName").start_object();
        crate::protocol_serde::shape_resale_authorization_reseller_legal_name_filter::ser_resale_authorization_reseller_legal_name_filter(&mut object_20, var_19)?;
        object_20.finish();
    }
    ...
    if let Some(var_23) = &input.offer_extended_status {
        ...
        crate::protocol_serde::shape_resale_authorization_offer_extended_status_filter::ser_resale_authorization_offer_extended_status_filter(&mut object_24, var_23)?;
        object_24.finish();
    }
    if let Some(var_25) = &input.last_modified_date {
        #[allow(unused_mut)]
        let mut object_26 = object.key("LastModifiedDate").start_object();
        crate::protocol_serde::shape_resale_authorization_last_modified_date_filter::ser_resale_authorization_last_modified_date_filter(&mut object_26, var_25)?;
        object_26.finish();
    }
    Ok(())
}
