...
pub(crate) fn de_change_set_summary_list_item<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ChangeSetSummaryListItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "EntityIdList" => {
                            builder = builder.set_entity_id_list(crate::protocol_serde::shape_resource_id_list::de_resource_id_list(tokens, _value)?);
                        }
                        "FailureCode" => {
