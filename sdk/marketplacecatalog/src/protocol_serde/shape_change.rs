...
pub fn ser_change(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Change) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
