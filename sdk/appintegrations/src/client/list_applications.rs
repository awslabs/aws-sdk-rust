...
impl super::Client {
    ...
    ///   - [`application_type(ApplicationType)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::application_type) / [`set_application_type(Option<ApplicationType>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::set_application_type):<br>required: **false**<br><p>The type of application.</p><br>
