...
impl super::Client {
    ...
    ///   - [`auth_config(Option<AuthConfig>)`](crate::operation::get_application::GetApplicationOutput::auth_config): <p>The authentication settings that Connect Customer uses when calling the external application.</p>
