...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_event_integration::builders::DeleteEventIntegrationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_event_integration::builders::DeleteEventIntegrationFluentBuilder::set_name):<br>required: **true**<br><p>The name of the event integration.</p><br>
