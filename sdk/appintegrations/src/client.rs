...
/// For example, the [`CreateDataIntegration`](crate::operation) operation has
...
mod list_data_integrations;

mod list_event_integration_associations;

mod list_event_integrations;
