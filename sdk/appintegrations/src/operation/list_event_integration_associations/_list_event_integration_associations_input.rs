...
impl ListEventIntegrationAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_event_integration_associations::ListEventIntegrationAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
