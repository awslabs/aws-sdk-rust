...
impl ListDataIntegrationsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_data_integrations();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_data_integrations::ListDataIntegrationsOutput,
                    crate::operation::list_data_integrations::ListDataIntegrationsError,
                > for ListDataIntegrationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListDataIntegrationsFluentBuilder {
    ...
    /// Access the ListDataIntegrations as a reference.
    pub fn as_input(&self) -> &crate::operation::list_data_integrations::builders::ListDataIntegrationsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_data_integrations::ListDataIntegrationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_data_integrations::ListDataIntegrationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_data_integrations::ListDataIntegrations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_data_integrations::ListDataIntegrationsOutput, crate::operation::list_data_integrations::ListDataIntegrationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_data_integrations::paginator::ListDataIntegrationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
