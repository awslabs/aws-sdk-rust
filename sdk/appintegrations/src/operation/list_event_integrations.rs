...
impl ListEventIntegrationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_event_integrations::ListEventIntegrations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventIntegrations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_event_integrations::de_list_event_integrations_http_response_with_props(status, headers, body)
        }
    }
}
