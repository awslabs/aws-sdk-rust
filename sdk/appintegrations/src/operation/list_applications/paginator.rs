...
/// Paginator for [`ListApplications`](crate::operation::list_applications::ListApplications)
pub struct ListApplicationsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_applications::builders::ListApplicationsInputBuilder,
...
impl ListApplicationsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_applications::paginator::ListApplicationsPaginatorItems {
        crate::operation::list_applications::paginator::ListApplicationsPaginatorItems(self)
    }
    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::list_applications::ListApplications::orchestrate(&runtime_plugins, input.clone()).await;
