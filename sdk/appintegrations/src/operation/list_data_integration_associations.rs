    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_data_integration_associations::ListDataIntegrationAssociationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_data_integration_associations::ListDataIntegrationAssociationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListDataIntegrationAssociationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListDataIntegrationAssociationsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListDataIntegrationAssociationsEndpointParamsInterceptor {
