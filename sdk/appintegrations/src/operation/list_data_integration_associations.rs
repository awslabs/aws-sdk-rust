...
impl ListDataIntegrationAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_data_integration_associations::ListDataIntegrationAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDataIntegrationAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_data_integration_associations::de_list_data_integration_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
