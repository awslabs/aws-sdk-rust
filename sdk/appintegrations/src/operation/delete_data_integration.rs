    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                ...
                let data_integration_identifier = aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_data_integration::DeleteDataIntegration::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDataIntegration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_data_integration::de_delete_data_integration_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_data_integration::de_delete_data_integration_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_data_integration::DeleteDataIntegrationError
{
