...
/// Orchestration and serialization glue logic for `GetEventIntegration`.
...
impl GetEventIntegration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_event_integration::GetEventIntegrationInput,
                    ) -> ::std::result::Result<crate::operation::get_event_integration::GetEventIntegrationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_event_integration::GetEventIntegrationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_event_integration::GetEventIntegrationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_event_integration::GetEventIntegrationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetEventIntegration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetEventIntegration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetEventIntegrationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetEventIntegrationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEventIntegration")
...
.with_interceptor(GetEventIntegrationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_event_integration::GetEventIntegrationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_event_integration::GetEventIntegrationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_event_integration::GetEventIntegrationError>::new());
...
#[derive(Debug)]
            struct GetEventIntegrationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetEventIntegrationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_event_integration::de_get_event_integration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_event_integration::de_get_event_integration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetEventIntegrationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetEventIntegrationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_event_integration::GetEventIntegrationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_event_integration::GetEventIntegrationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/eventIntegrations/{Name}", Name = name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetEventIntegrationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetEventIntegrationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetEventIntegrationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetEventIntegrationInput>()
                        .ok_or("failed to downcast to GetEventIntegrationInput")?;
...
pub enum GetEventIntegrationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetEventIntegrationError) for what information is available for the error.")]
...
impl GetEventIntegrationError {
    /// Creates the `GetEventIntegrationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetEventIntegrationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEventIntegrationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_event_integration::GetEventIntegrationError {
...
mod _get_event_integration_output;
