...
pub fn de_get_event_integration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEventIntegrationOutput, crate::error::GetEventIntegrationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetEventIntegrationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_event_integration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEventIntegrationOutput, crate::error::GetEventIntegrationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_event_integration_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_event_integration::de_get_event_integration(response.body().as_ref(), output).map_err(crate::error::GetEventIntegrationError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_event_integration(value: &[u8], mut builder: crate::output::get_event_integration_output::Builder) -> Result<crate::output::get_event_integration_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
