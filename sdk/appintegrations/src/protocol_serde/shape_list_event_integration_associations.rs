...
pub fn de_list_event_integration_associations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_event_integration_associations::ListEventIntegrationAssociationsOutput, crate::operation::list_event_integration_associations::ListEventIntegrationAssociationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_event_integration_associations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_event_integration_associations::ListEventIntegrationAssociationsOutput, crate::operation::list_event_integration_associations::ListEventIntegrationAssociationsError> {
    Ok({
        #[allow(unused_mut)]
