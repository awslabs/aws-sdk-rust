...
pub struct ListEventIntegrationsOutput  {
    ...
    #[doc(hidden)]pub event_integrations: std::option::Option<std::vec::Vec<crate::model::EventIntegration>>,
...
pub struct ListEventIntegrationAssociationsOutput  {
    ...
    #[doc(hidden)]pub event_integration_associations: std::option::Option<std::vec::Vec<crate::model::EventIntegrationAssociation>>,
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListEventIntegrationAssociationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("event_integration_associations", &self.event_integration_associations);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListDataIntegrationsOutput  {
    ...
    #[doc(hidden)]pub data_integrations: std::option::Option<std::vec::Vec<crate::model::DataIntegrationSummary>>,
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDataIntegrationAssociationsOutput  {
    ...
    #[doc(hidden)]pub data_integration_associations: std::option::Option<std::vec::Vec<crate::model::DataIntegrationAssociationSummary>>,
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListDataIntegrationAssociationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("data_integration_associations", &self.data_integration_associations);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
