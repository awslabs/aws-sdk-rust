...
pub(crate) fn reflens_list_application_associations_output_output_next_token(input: &crate::operation::list_application_associations::ListApplicationAssociationsOutput) -> ::std::option::Option<& ::std::string::String> {
...
pub(crate) fn lens_list_application_associations_output_output_application_associations(input: crate::operation::list_application_associations::ListApplicationAssociationsOutput) -> ::std::option::Option<::std::vec::Vec::<crate::types::ApplicationAssociationSummary>> {
