...
impl Builder {
    ...
    /// use aws_sdk_appintegrations::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_appintegrations::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
