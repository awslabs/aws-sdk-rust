...
pub(crate) fn de_ec2_reserved_instances_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::Ec2ReservedInstancesConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
