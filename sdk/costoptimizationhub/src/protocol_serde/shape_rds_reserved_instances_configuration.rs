...
pub(crate) fn de_rds_reserved_instances_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RdsReservedInstancesConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
