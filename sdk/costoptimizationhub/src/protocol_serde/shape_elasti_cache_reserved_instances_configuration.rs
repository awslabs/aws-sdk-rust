...
pub(crate) fn de_elasti_cache_reserved_instances_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ElastiCacheReservedInstancesConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
