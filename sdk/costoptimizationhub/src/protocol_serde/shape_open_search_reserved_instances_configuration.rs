...
pub(crate) fn de_open_search_reserved_instances_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::OpenSearchReservedInstancesConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
