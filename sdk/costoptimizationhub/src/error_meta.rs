...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_preferences::GetPreferencesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_recommendation::GetRecommendationError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl From<crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError> for Error {
    fn from(err: crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError) -> Self {
        match err {
            crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::list_enrollment_statuses::ListEnrollmentStatusesError::InternalServerException(inner) => Error::InternalServerException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recommendations::ListRecommendationsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recommendation_summaries::ListRecommendationSummariesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recommendation_summaries::ListRecommendationSummariesError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl From<crate::operation::list_recommendation_summaries::ListRecommendationSummariesError> for Error {
    fn from(err: crate::operation::list_recommendation_summaries::ListRecommendationSummariesError) -> Self {
        match err {
            crate::operation::list_recommendation_summaries::ListRecommendationSummariesError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::list_recommendation_summaries::ListRecommendationSummariesError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::list_recommendation_summaries::ListRecommendationSummariesError::ThrottlingException(inner) => Error::ThrottlingException(inner),
            crate::operation::list_recommendation_summaries::ListRecommendationSummariesError::ValidationException(inner) => Error::ValidationException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_preferences::UpdatePreferencesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
