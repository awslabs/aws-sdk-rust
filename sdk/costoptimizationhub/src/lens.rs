...
pub(crate) fn reflens_list_efficiency_metrics_output_output_next_token(
    input: &crate::operation::list_efficiency_metrics::ListEfficiencyMetricsOutput,
...
pub(crate) fn lens_list_efficiency_metrics_output_output_efficiency_metrics_by_group(
    input: crate::operation::list_efficiency_metrics::ListEfficiencyMetricsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::EfficiencyMetricsByGroup>> {
    let input = input.efficiency_metrics_by_group?;
    ::std::option::Option::Some(input)
}
