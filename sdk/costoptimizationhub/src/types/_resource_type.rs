...
impl ResourceType {
    ...
    ResourceType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ComputeSavingsPlans", "EbsVolume", "Ec2AutoScalingGroup", "Ec2Instance", "Ec2InstanceSavingsPlans", "Ec2ReservedInstances", "EcsService", "ElastiCacheReservedInstances", "LambdaFunction", "OpenSearchReservedInstances", "RdsReservedInstances", "RedshiftReservedInstances", "SageMakerSavingsPlans"]
                }
            }
