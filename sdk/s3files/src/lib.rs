...
//! as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-s3files` to
//! your project, add the following to your **Cargo.toml** file:
//!
//! ```toml
//! [dependencies]
//! aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
//! aws-sdk-s3files = "1.13.0"
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-s3files/latest/aws_sdk_s3files/client/struct.Client.html)
...
//! offered by Amazon S3 Files. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon S3 Files.
...
/// let config = aws_sdk_s3files::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for Amazon S3 Files.
pub mod config;
