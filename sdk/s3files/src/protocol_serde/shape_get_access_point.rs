...
pub fn de_get_access_point_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_access_point::GetAccessPointError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerException" => crate::operation::get_access_point::GetAccessPointError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::get_access_point::GetAccessPointError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_access_point::GetAccessPointError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_access_point::GetAccessPointError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_access_point::GetAccessPointError::generic(generic),
    })
}
...
pub fn de_get_access_point_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_access_point_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_access_point::GetAccessPointError::unhandled)?
    })
}

pub(crate) fn de_get_access_point(
    _value: &[u8],
