...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfRetentionConfigurationsExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::OrganizationConformancePackTemplateValidationException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfOrganizationConformancePacksExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfOrganizationConfigRulesExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfDeliveryChannelsExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfConformancePacksExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::MaxNumberOfConfigurationRecordersExceededException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type GetOrganizationConformancePackDetailedStatusErrorKind = GetOrganizationConformancePackDetailedStatusError;
...
impl aws_http::request_id::RequestId for crate::error::GetOrganizationConformancePackDetailedStatusError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_http::request_id::RequestId for crate::error::GetOrganizationConfigRuleDetailedStatusError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type GetAggregateConformancePackComplianceSummaryErrorKind = GetAggregateConformancePackComplianceSummaryError;
...
impl aws_http::request_id::RequestId for crate::error::GetAggregateConformancePackComplianceSummaryError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type GetAggregateConfigRuleComplianceSummaryErrorKind = GetAggregateConfigRuleComplianceSummaryError;
...
impl aws_http::request_id::RequestId for crate::error::GetAggregateConfigRuleComplianceSummaryError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_http::request_id::RequestId for crate::error::GetAggregateComplianceDetailsByConfigRuleError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeOrganizationConformancePackStatusesErrorKind = DescribeOrganizationConformancePackStatusesError;
...
impl aws_http::request_id::RequestId for crate::error::DescribeOrganizationConformancePackStatusesError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeOrganizationConfigRuleStatusesErrorKind = DescribeOrganizationConfigRuleStatusesError;
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeConfigurationAggregatorSourcesStatusErrorKind = DescribeConfigurationAggregatorSourcesStatusError;
...
impl aws_http::request_id::RequestId for crate::error::DescribeConfigurationAggregatorSourcesStatusError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeAggregateComplianceByConformancePacksErrorKind = DescribeAggregateComplianceByConformancePacksError;
...
impl aws_http::request_id::RequestId for crate::error::DescribeAggregateComplianceByConformancePacksError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeAggregateComplianceByConfigRulesErrorKind = DescribeAggregateComplianceByConfigRulesError;
...
impl aws_http::request_id::RequestId for crate::error::DescribeAggregateComplianceByConfigRulesError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
