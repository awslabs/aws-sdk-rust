...
impl DeleteRemediationExceptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_remediation_exceptions::DeleteRemediationExceptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRemediationExceptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_remediation_exceptions::de_delete_remediation_exceptions_http_response_with_props(
                status, headers, body,
            )
        }
    }
