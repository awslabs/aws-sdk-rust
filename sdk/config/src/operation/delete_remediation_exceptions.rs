...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRemediationExceptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_remediation_exceptions::de_delete_remediation_exceptions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteRemediationExceptionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_remediation_exceptions::DeleteRemediationExceptionsError
{
