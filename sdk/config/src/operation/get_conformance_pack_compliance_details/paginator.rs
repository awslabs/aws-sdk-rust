...
impl GetConformancePackComplianceDetailsPaginator {
    ...
    /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsError>>> + ::std::marker::Unpin
                 {
