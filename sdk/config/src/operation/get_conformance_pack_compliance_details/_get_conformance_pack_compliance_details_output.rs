...
impl GetConformancePackComplianceDetailsOutputBuilder {
    ...
    /// <p>Returns a list of <code>ConformancePackEvaluationResult</code> objects.</p>
    pub fn get_conformance_pack_rule_evaluation_results(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::ConformancePackEvaluationResult>> {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_conformance_pack_compliance_details::GetConformancePackComplianceDetailsOutput {
                conformance_pack_name: self.conformance_pack_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("conformance_pack_name", "conformance_pack_name was not specified but it is required when building GetConformancePackComplianceDetailsOutput")
                    )?
                ,
