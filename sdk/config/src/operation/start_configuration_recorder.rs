...
impl StartConfigurationRecorderInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_configuration_recorder::StartConfigurationRecorder::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartConfigurationRecorder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_configuration_recorder::de_start_configuration_recorder_http_response_with_props(status, headers, body)
        }
    }
}
