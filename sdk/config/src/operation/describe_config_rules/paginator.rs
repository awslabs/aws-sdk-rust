...
/// Paginator for [`DescribeConfigRules`](crate::operation::describe_config_rules::DescribeConfigRules)
            ...
            impl DescribeConfigRulesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_config_rules::DescribeConfigRulesOutput, aws_smithy_http::result::SdkError<crate::operation::describe_config_rules::DescribeConfigRulesError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeConfigRulesPaginator`
                ...
                impl  DescribeConfigRulesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ConfigRule, aws_smithy_http::result::SdkError<crate::operation::describe_config_rules::DescribeConfigRulesError>>> + Unpin
                     {
