...
impl PutOrganizationConfigRuleInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_organization_config_rule::PutOrganizationConfigRule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutOrganizationConfigRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_organization_config_rule::de_put_organization_config_rule_http_response_with_props(status, headers, body)
        }
    }
}
