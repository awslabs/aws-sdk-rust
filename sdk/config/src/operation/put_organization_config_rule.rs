...
impl PutOrganizationConfigRuleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_organization_config_rule::PutOrganizationConfigRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_organization_config_rule::PutOrganizationConfigRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_organization_config_rule::PutOrganizationConfigRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutOrganizationConfigRule {
                type Output = std::result::Result<crate::operation::put_organization_config_rule::PutOrganizationConfigRuleOutput, crate::operation::put_organization_config_rule::PutOrganizationConfigRuleError>;
