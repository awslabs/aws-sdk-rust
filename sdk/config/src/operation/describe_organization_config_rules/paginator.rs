...
/// Paginator for [`DescribeOrganizationConfigRules`](crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRules)
            ...
            impl DescribeOrganizationConfigRulesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesOutput, aws_smithy_http::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeOrganizationConfigRulesPaginator`
                ...
                impl  DescribeOrganizationConfigRulesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::OrganizationConfigRule, aws_smithy_http::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_organization_config_rules_output_organization_config_rules(page).unwrap_or_default().into_iter())
                    }
                }
