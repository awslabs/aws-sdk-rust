...
/// Paginator for [`DescribeOrganizationConfigRules`](crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRules)
                ...
                impl DescribeOrganizationConfigRulesPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::describe_organization_config_rules::builders::DescribeOrganizationConfigRulesInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRules::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `DescribeOrganizationConfigRulesPaginator`
                    ...
                    impl DescribeOrganizationConfigRulesPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::OrganizationConfigRule, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_organization_config_rules_output_output_organization_config_rules(page).unwrap_or_default().into_iter())
                        }
                    }
