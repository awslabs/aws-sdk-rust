...
impl DescribeOrganizationConfigRulesPaginator {
    ...
    /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError>>> + ::std::marker::Unpin
                 {
...
impl DescribeOrganizationConfigRulesPaginatorItems {
    ...
    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::OrganizationConfigRule, ::aws_smithy_http::result::SdkError<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesError>>> + ::std::marker::Unpin
                     {
