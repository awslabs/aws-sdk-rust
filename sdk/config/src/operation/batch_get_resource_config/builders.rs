...
impl BatchGetResourceConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_resource_config::BatchGetResourceConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_resource_config::BatchGetResourceConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_resource_config::BatchGetResourceConfigOutput, crate::operation::batch_get_resource_config::BatchGetResourceConfigError, Self> {
