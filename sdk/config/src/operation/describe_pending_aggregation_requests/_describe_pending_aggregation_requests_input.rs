...
impl DescribePendingAggregationRequestsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequestsInput, ::aws_smithy_types::error::operation::BuildError> {
