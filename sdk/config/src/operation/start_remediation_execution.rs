...
impl StartRemediationExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartRemediationExecution`](crate::operation::start_remediation_execution::StartRemediationExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_remediation_execution::StartRemediationExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_remediation_execution::StartRemediationExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_remediation_execution::ser_start_remediation_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_remediation_execution::StartRemediationExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartRemediationExecution {
                type Output = std::result::Result<crate::operation::start_remediation_execution::StartRemediationExecutionOutput, crate::operation::start_remediation_execution::StartRemediationExecutionError>;
