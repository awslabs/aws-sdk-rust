...
impl StartRemediationExecutionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_remediation_execution::StartRemediationExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRemediationExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_remediation_execution::de_start_remediation_execution_http_response_with_props(status, headers, body)
        }
    }
}
