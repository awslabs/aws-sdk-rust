...
impl PutAggregationAuthorizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_aggregation_authorization::PutAggregationAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAggregationAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_aggregation_authorization::de_put_aggregation_authorization_http_response_with_props(
                status, headers, body,
            )
        }
    }
