...
impl GetConformancePackComplianceSummaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConformancePackComplianceSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_conformance_pack_compliance_summary::de_get_conformance_pack_compliance_summary_http_response_with_props(
                status, headers, body,
            )
        }
    }
