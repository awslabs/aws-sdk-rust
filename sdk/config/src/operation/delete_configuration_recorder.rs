...
impl DeleteConfigurationRecorderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_configuration_recorder::DeleteConfigurationRecorder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConfigurationRecorder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_configuration_recorder::de_delete_configuration_recorder_http_response_with_props(
                status, headers, body,
            )
        }
    }
