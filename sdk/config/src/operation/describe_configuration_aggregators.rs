...
impl DescribeConfigurationAggregatorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_configuration_aggregators::DescribeConfigurationAggregators,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationAggregators {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_aggregators::de_describe_configuration_aggregators_http_response_with_props(status, headers, body)
        }
    }
}
