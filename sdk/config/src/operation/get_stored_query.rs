...
impl GetStoredQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_stored_query::GetStoredQuery, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_stored_query::ser_get_stored_query_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStoredQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_stored_query::de_get_stored_query_http_response_with_props(status, headers, body)
        }
    }
}
