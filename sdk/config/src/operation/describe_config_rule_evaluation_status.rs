...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigRuleEvaluationStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_config_rule_evaluation_status::de_describe_config_rule_evaluation_status_http_response_with_props(status, headers, body)
        }
    }
}
