...
impl DeliverConfigSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`DeliverConfigSnapshot`](crate::operation::deliver_config_snapshot::DeliverConfigSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deliver_config_snapshot::DeliverConfigSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deliver_config_snapshot::DeliverConfigSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deliver_config_snapshot::ser_deliver_config_snapshot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deliver_config_snapshot::DeliverConfigSnapshot::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeliverConfigSnapshot {
                type Output = std::result::Result<crate::operation::deliver_config_snapshot::DeliverConfigSnapshotOutput, crate::operation::deliver_config_snapshot::DeliverConfigSnapshotError>;
...
impl aws_http::request_id::RequestId for crate::operation::deliver_config_snapshot::DeliverConfigSnapshotError {
