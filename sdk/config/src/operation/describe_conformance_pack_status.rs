...
impl DescribeConformancePackStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_conformance_pack_status::DescribeConformancePackStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConformancePackStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_conformance_pack_status::de_describe_conformance_pack_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
