...
impl DescribeDeliveryChannelStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDeliveryChannelStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_delivery_channel_status::de_describe_delivery_channel_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
