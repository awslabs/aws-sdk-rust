...
impl DescribeDeliveryChannelStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDeliveryChannelStatus`](crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_delivery_channel_status::ser_describe_delivery_channel_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatus::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDeliveryChannelStatus {
                type Output = std::result::Result<crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusOutput, crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_delivery_channel_status::DescribeDeliveryChannelStatusError {
