...
impl ListAggregateDiscoveredResourcesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_aggregate_discovered_resources::ListAggregateDiscoveredResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAggregateDiscoveredResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_aggregate_discovered_resources::de_list_aggregate_discovered_resources_http_response_with_props(
                status, headers, body,
            )
        }
    }
