...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput,
                    crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationError,
                > for DeleteRemediationConfigurationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteRemediationConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_remediation_configuration::DeleteRemediationConfiguration::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput, crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationError, Self> {
