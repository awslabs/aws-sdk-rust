...
impl ListStoredQueriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_stored_queries::ser_list_stored_queries_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStoredQueries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stored_queries::de_list_stored_queries_http_response_with_props(status, headers, body)
        }
    }
}
