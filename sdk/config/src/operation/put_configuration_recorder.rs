...
impl PutConfigurationRecorderInput {
    /// Consumes the builder and constructs an Operation<[`PutConfigurationRecorder`](crate::operation::put_configuration_recorder::PutConfigurationRecorder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_configuration_recorder::PutConfigurationRecorder, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_configuration_recorder::PutConfigurationRecorderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_configuration_recorder::ser_put_configuration_recorder_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_configuration_recorder::PutConfigurationRecorder::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutConfigurationRecorder {
                type Output = std::result::Result<crate::operation::put_configuration_recorder::PutConfigurationRecorderOutput, crate::operation::put_configuration_recorder::PutConfigurationRecorderError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_configuration_recorder::PutConfigurationRecorderError {
