...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComplianceSummaryByResourceType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_compliance_summary_by_resource_type::de_get_compliance_summary_by_resource_type_http_response_with_props(status, headers, body)
        }
    }
}
