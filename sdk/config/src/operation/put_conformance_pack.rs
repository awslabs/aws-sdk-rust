...
impl PutConformancePackInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_conformance_pack::ser_put_conformance_pack_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutConformancePack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_conformance_pack::de_put_conformance_pack_http_response_with_props(status, headers, body)
        }
    }
}
