...
impl PutConformancePackInput {
    /// Consumes the builder and constructs an Operation<[`PutConformancePack`](crate::operation::put_conformance_pack::PutConformancePack)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_conformance_pack::PutConformancePack, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_conformance_pack::PutConformancePackInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_conformance_pack::ser_put_conformance_pack_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_conformance_pack::PutConformancePack::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutConformancePack {
                type Output = std::result::Result<crate::operation::put_conformance_pack::PutConformancePackOutput, crate::operation::put_conformance_pack::PutConformancePackError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_conformance_pack::de_put_conformance_pack_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_conformance_pack::de_put_conformance_pack_http_response(response)
                     }
                }
            }
