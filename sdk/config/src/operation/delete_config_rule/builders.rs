...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_config_rule::DeleteConfigRuleOutput,
                    crate::operation::delete_config_rule::DeleteConfigRuleError,
                > for DeleteConfigRuleFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteConfigRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_config_rule::DeleteConfigRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_config_rule::DeleteConfigRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_config_rule::DeleteConfigRuleOutput, crate::operation::delete_config_rule::DeleteConfigRuleError, Self> {
