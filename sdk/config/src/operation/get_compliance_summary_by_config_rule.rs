...
impl GetComplianceSummaryByConfigRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRule,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_compliance_summary_by_config_rule::GetComplianceSummaryByConfigRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComplianceSummaryByConfigRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_compliance_summary_by_config_rule::de_get_compliance_summary_by_config_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
