...
/// Paginator for [`DescribeAggregateComplianceByConformancePacks`](crate::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacks)
            ...
            impl DescribeAggregateComplianceByConformancePacksPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksOutput, aws_smithy_http::result::SdkError<crate::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeAggregateComplianceByConformancePacksPaginator`
                ...
                impl  DescribeAggregateComplianceByConformancePacksPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::AggregateComplianceByConformancePack, aws_smithy_http::result::SdkError<crate::operation::describe_aggregate_compliance_by_conformance_packs::DescribeAggregateComplianceByConformancePacksError>>> + Unpin
                     {
