...
impl DeleteConfigurationAggregatorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConfigurationAggregator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_configuration_aggregator::de_delete_configuration_aggregator_http_response_with_props(
                status, headers, body,
            )
        }
    }
