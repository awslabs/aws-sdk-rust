...
impl DeleteConfigurationAggregatorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteConfigurationAggregator`](crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_configuration_aggregator::ser_delete_configuration_aggregator_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregator::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteConfigurationAggregator {
                type Output = std::result::Result<crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorOutput, crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorError>;
