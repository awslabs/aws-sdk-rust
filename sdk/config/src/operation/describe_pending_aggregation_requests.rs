...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePendingAggregationRequests {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePendingAggregationRequests")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribePendingAggregationRequestsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribePendingAggregationRequestsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribePendingAggregationRequestsEndpointParamsInterceptor {
