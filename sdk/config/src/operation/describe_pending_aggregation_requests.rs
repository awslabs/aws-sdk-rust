...
impl DescribePendingAggregationRequestsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequests,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pending_aggregation_requests::DescribePendingAggregationRequests::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePendingAggregationRequests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_pending_aggregation_requests::de_describe_pending_aggregation_requests_http_response_with_props(
                status, headers, body,
            )
        }
    }
