...
impl DescribeConfigurationRecorderStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_configuration_recorder_status::DescribeConfigurationRecorderStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationRecorderStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_recorder_status::de_describe_configuration_recorder_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
