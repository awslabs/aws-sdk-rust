...
impl StartConfigRulesEvaluationInput {
    /// Consumes the builder and constructs an Operation<[`StartConfigRulesEvaluation`](crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_config_rules_evaluation::ser_start_config_rules_evaluation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartConfigRulesEvaluation {
                type Output = std::result::Result<crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluationOutput, crate::operation::start_config_rules_evaluation::StartConfigRulesEvaluationError>;
