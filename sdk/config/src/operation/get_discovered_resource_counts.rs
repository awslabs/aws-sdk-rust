...
impl GetDiscoveredResourceCountsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_discovered_resource_counts::GetDiscoveredResourceCounts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDiscoveredResourceCounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_discovered_resource_counts::de_get_discovered_resource_counts_http_response_with_props(
                status, headers, body,
            )
        }
    }
