...
impl GetOrganizationCustomRulePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_organization_custom_rule_policy::GetOrganizationCustomRulePolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOrganizationCustomRulePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_organization_custom_rule_policy::de_get_organization_custom_rule_policy_http_response_with_props(status, headers, body)
        }
    }
}
