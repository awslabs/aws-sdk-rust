...
impl ListConformancePackComplianceScoresInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_conformance_pack_compliance_scores::ListConformancePackComplianceScores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConformancePackComplianceScores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_conformance_pack_compliance_scores::de_list_conformance_pack_compliance_scores_http_response_with_props(
                status, headers, body,
            )
        }
    }
