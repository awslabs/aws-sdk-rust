...
impl DescribeComplianceByResourceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeComplianceByResource`](crate::operation::describe_compliance_by_resource::DescribeComplianceByResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_compliance_by_resource::DescribeComplianceByResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_compliance_by_resource::ser_describe_compliance_by_resource_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_compliance_by_resource::DescribeComplianceByResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeComplianceByResource {
                type Output = std::result::Result<crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceOutput, crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError>;
