...
impl DescribeComplianceByResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_compliance_by_resource::DescribeComplianceByResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeComplianceByResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_compliance_by_resource::de_describe_compliance_by_resource_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeComplianceByResourceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError
{
