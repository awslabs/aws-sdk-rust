...
impl PutOrganizationConfigRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_organization_config_rule::PutOrganizationConfigRuleInput, ::aws_smithy_types::error::operation::BuildError> {
