...
impl GetConformancePackComplianceSummaryPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummary::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_conformance_pack_compliance_summary::GetConformancePackComplianceSummary::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl GetConformancePackComplianceSummaryPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_conformance_pack_compliance_summary_output_conformance_pack_compliance_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
