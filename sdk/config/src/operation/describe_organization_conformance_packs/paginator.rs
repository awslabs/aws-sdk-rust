...
impl DescribeOrganizationConformancePacksPaginatorItems {
    ...
    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::OrganizationConformancePack, ::aws_smithy_http::result::SdkError<crate::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacksError>>> + ::std::marker::Unpin
                     {
