...
impl DescribeOrganizationConformancePacksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_organization_conformance_packs::DescribeOrganizationConformancePacks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOrganizationConformancePacks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_organization_conformance_packs::de_describe_organization_conformance_packs_http_response_with_props(
                status, headers, body,
            )
        }
    }
