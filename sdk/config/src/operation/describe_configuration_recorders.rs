...
impl DescribeConfigurationRecordersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeConfigurationRecorders`](crate::operation::describe_configuration_recorders::DescribeConfigurationRecorders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_configuration_recorders::DescribeConfigurationRecorders, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_configuration_recorders::ser_describe_configuration_recorders_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_configuration_recorders::DescribeConfigurationRecorders::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationRecorders {
                type Output = std::result::Result<crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersOutput, crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_configuration_recorders::DescribeConfigurationRecordersError {
