...
impl DescribeConfigurationRecordersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_configuration_recorders::DescribeConfigurationRecorders,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_configuration_recorders::DescribeConfigurationRecorders::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationRecorders {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_recorders::de_describe_configuration_recorders_http_response_with_props(
                status, headers, body,
            )
        }
    }
