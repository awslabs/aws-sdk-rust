...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SelectAggregateResourceConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_select_aggregate_resource_config::de_select_aggregate_resource_config_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_select_aggregate_resource_config::de_select_aggregate_resource_config_http_response(
