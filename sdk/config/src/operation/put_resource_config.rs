...
impl PutResourceConfigInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_resource_config::ser_put_resource_config_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutResourceConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_resource_config::de_put_resource_config_http_response_with_props(status, headers, body)
        }
    }
}
