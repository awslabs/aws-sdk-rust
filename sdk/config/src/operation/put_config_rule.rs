...
impl PutConfigRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_config_rule::PutConfigRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_config_rule::ser_put_config_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutConfigRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_config_rule::de_put_config_rule_http_response_with_props(status, headers, body)
        }
    }
}
