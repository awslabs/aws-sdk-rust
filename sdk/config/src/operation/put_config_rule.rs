...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConfigRuleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_config_rule::de_put_config_rule_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_config_rule::de_put_config_rule_http_response(status, headers, body, _cfg)
        };
