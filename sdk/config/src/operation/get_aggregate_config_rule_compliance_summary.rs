...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAggregateConfigRuleComplianceSummary {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAggregateConfigRuleComplianceSummary")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetAggregateConfigRuleComplianceSummaryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetAggregateConfigRuleComplianceSummaryRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetAggregateConfigRuleComplianceSummaryEndpointParamsInterceptor {
