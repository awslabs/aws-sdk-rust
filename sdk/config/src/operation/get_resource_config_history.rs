...
impl GetResourceConfigHistoryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_config_history::GetResourceConfigHistory::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceConfigHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_config_history::de_get_resource_config_history_http_response_with_props(status, headers, body)
        }
    }
}
