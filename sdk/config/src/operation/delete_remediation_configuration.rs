...
impl DeleteRemediationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_remediation_configuration::DeleteRemediationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRemediationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_remediation_configuration::de_delete_remediation_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
