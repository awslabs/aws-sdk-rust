...
impl DeleteRemediationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRemediationConfiguration`](crate::operation::delete_remediation_configuration::DeleteRemediationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_remediation_configuration::DeleteRemediationConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_remediation_configuration::ser_delete_remediation_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_remediation_configuration::DeleteRemediationConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRemediationConfiguration {
                type Output = std::result::Result<crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationOutput, crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_remediation_configuration::DeleteRemediationConfigurationError {
