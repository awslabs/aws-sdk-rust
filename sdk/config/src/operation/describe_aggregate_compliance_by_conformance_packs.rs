...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeAggregateComplianceByConformancePacksResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeAggregateComplianceByConformancePacksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_aggregate_compliance_by_conformance_packs::ser_describe_aggregate_compliance_by_conformance_packs_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAggregateComplianceByConformancePacksEndpointParamsInterceptor {
