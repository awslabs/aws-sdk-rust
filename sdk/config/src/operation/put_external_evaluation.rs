...
impl PutExternalEvaluationInput {
    /// Consumes the builder and constructs an Operation<[`PutExternalEvaluation`](crate::operation::put_external_evaluation::PutExternalEvaluation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_external_evaluation::PutExternalEvaluation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_external_evaluation::PutExternalEvaluationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_external_evaluation::ser_put_external_evaluation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_external_evaluation::PutExternalEvaluation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutExternalEvaluation {
                type Output = std::result::Result<crate::operation::put_external_evaluation::PutExternalEvaluationOutput, crate::operation::put_external_evaluation::PutExternalEvaluationError>;
