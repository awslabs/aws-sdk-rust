...
/// Paginator for [`DescribeConfigurationAggregatorSourcesStatus`](crate::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatus)
            ...
            impl DescribeConfigurationAggregatorSourcesStatusPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusOutput, aws_smithy_http::result::SdkError<crate::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeConfigurationAggregatorSourcesStatusPaginator`
                ...
                impl  DescribeConfigurationAggregatorSourcesStatusPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::AggregatedSourceStatus, aws_smithy_http::result::SdkError<crate::operation::describe_configuration_aggregator_sources_status::DescribeConfigurationAggregatorSourcesStatusError>>> + Unpin
                     {
