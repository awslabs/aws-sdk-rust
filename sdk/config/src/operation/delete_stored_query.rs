...
impl DeleteStoredQueryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_stored_query::ser_delete_stored_query_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStoredQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_stored_query::de_delete_stored_query_http_response_with_props(status, headers, body)
        }
    }
}
