...
impl DeleteStoredQueryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteStoredQuery`](crate::operation::delete_stored_query::DeleteStoredQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_stored_query::DeleteStoredQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_stored_query::DeleteStoredQueryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_stored_query::ser_delete_stored_query_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_stored_query::DeleteStoredQuery::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteStoredQuery {
                type Output = std::result::Result<crate::operation::delete_stored_query::DeleteStoredQueryOutput, crate::operation::delete_stored_query::DeleteStoredQueryError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_stored_query::de_delete_stored_query_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_stored_query::de_delete_stored_query_http_response(response)
                     }
                }
            }
