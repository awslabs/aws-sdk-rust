...
impl DeleteRetentionConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_retention_configuration::DeleteRetentionConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRetentionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_retention_configuration::de_delete_retention_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
