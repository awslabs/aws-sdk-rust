...
impl PutRetentionConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_retention_configuration::PutRetentionConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_retention_configuration::PutRetentionConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_retention_configuration::PutRetentionConfigurationOutput, crate::operation::put_retention_configuration::PutRetentionConfigurationError, Self> {
