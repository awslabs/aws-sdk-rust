...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeConfigurationAggregatorSourcesStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeConfigurationAggregatorSourcesStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_configuration_aggregator_sources_status::ser_describe_configuration_aggregator_sources_status_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeConfigurationAggregatorSourcesStatusEndpointParamsInterceptor {
