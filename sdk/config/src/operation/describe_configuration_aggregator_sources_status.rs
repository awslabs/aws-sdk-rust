...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConfigurationAggregatorSourcesStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_configuration_aggregator_sources_status::de_describe_configuration_aggregator_sources_status_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_configuration_aggregator_sources_status::de_describe_configuration_aggregator_sources_status_http_response(status, headers, body, _cfg)
        };
