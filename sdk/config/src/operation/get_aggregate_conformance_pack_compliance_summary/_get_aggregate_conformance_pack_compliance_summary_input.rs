...
impl GetAggregateConformancePackComplianceSummaryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_aggregate_conformance_pack_compliance_summary::GetAggregateConformancePackComplianceSummaryInput, ::aws_smithy_types::error::operation::BuildError> {
