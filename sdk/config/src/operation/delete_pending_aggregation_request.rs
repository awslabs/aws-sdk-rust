...
impl DeletePendingAggregationRequestInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_pending_aggregation_request::DeletePendingAggregationRequest::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePendingAggregationRequest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_pending_aggregation_request::de_delete_pending_aggregation_request_http_response_with_props(
                status, headers, body,
            )
        }
    }
