...
impl GetComplianceDetailsByConfigRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_compliance_details_by_config_rule::GetComplianceDetailsByConfigRuleInput, ::aws_smithy_types::error::operation::BuildError> {
