...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetAggregateConformancePackComplianceSummaryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetAggregateConformancePackComplianceSummaryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_aggregate_conformance_pack_compliance_summary::ser_get_aggregate_conformance_pack_compliance_summary_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetAggregateConformancePackComplianceSummaryEndpointParamsInterceptor {
