...
impl DescribeConformancePacksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_conformance_packs::DescribeConformancePacksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_conformance_packs::DescribeConformancePacksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_conformance_packs::DescribeConformancePacksOutput, crate::operation::describe_conformance_packs::DescribeConformancePacksError, Self> {
