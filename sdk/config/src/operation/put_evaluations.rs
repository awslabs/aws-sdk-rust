...
impl PutEvaluationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_evaluations::PutEvaluations, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_evaluations::ser_put_evaluations_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEvaluations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_evaluations::de_put_evaluations_http_response_with_props(status, headers, body)
        }
    }
}
