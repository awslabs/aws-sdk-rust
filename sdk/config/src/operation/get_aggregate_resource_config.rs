...
impl GetAggregateResourceConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetAggregateResourceConfig`](crate::operation::get_aggregate_resource_config::GetAggregateResourceConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_aggregate_resource_config::GetAggregateResourceConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_aggregate_resource_config::GetAggregateResourceConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_aggregate_resource_config::ser_get_aggregate_resource_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_aggregate_resource_config::GetAggregateResourceConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAggregateResourceConfig {
                type Output = std::result::Result<crate::operation::get_aggregate_resource_config::GetAggregateResourceConfigOutput, crate::operation::get_aggregate_resource_config::GetAggregateResourceConfigError>;
