...
impl GetAggregateResourceConfigInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_aggregate_resource_config::GetAggregateResourceConfig::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetAggregateResourceConfig {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_aggregate_resource_config::de_get_aggregate_resource_config_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::get_aggregate_resource_config::GetAggregateResourceConfigError
{
