...
impl DescribeRemediationExceptionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRemediationExceptions`](crate::operation::describe_remediation_exceptions::DescribeRemediationExceptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_remediation_exceptions::DescribeRemediationExceptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_remediation_exceptions::ser_describe_remediation_exceptions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_remediation_exceptions::DescribeRemediationExceptions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRemediationExceptions {
                type Output = std::result::Result<crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsOutput, crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsError {
