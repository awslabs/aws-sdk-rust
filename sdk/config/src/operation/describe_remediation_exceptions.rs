...
impl DescribeRemediationExceptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_remediation_exceptions::DescribeRemediationExceptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRemediationExceptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_remediation_exceptions::de_describe_remediation_exceptions_http_response_with_props(
                status, headers, body,
            )
        }
    }
