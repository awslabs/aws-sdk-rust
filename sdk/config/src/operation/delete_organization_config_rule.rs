...
impl DeleteOrganizationConfigRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOrganizationConfigRule`](crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_organization_config_rule::ser_delete_organization_config_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteOrganizationConfigRule {
                type Output = std::result::Result<crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleOutput, crate::operation::delete_organization_config_rule::DeleteOrganizationConfigRuleError>;
