...
impl DeleteResourceConfigFluentBuilder  {
    /// Creates a new `DeleteResourceConfig`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        ...
                        aws_smithy_http::result::SdkError<crate::operation::delete_resource_config::DeleteResourceConfigError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_resource_config::DeleteResourceConfigOutput, aws_smithy_http::result::SdkError<crate::operation::delete_resource_config::DeleteResourceConfigError>>
                     {
