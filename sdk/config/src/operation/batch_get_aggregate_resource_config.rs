...
impl BatchGetAggregateResourceConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_aggregate_resource_config::BatchGetAggregateResourceConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetAggregateResourceConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_aggregate_resource_config::de_batch_get_aggregate_resource_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
