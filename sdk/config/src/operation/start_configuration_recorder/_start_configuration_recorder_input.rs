...
impl StartConfigurationRecorderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_configuration_recorder::StartConfigurationRecorderInput, ::aws_smithy_types::error::operation::BuildError> {
