...
impl StartConfigurationRecorderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_configuration_recorder::StartConfigurationRecorderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_configuration_recorder::StartConfigurationRecorderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_configuration_recorder::StartConfigurationRecorderOutput, crate::operation::start_configuration_recorder::StartConfigurationRecorderError, Self> {
