...
impl DescribeRemediationExecutionStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_remediation_execution_status::DescribeRemediationExecutionStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRemediationExecutionStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_remediation_execution_status::de_describe_remediation_execution_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
