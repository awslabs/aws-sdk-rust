...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAggregateComplianceByConfigRules {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAggregateComplianceByConfigRules")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeAggregateComplianceByConfigRulesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeAggregateComplianceByConfigRulesRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAggregateComplianceByConfigRulesEndpointParamsInterceptor {
