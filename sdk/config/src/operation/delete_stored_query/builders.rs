...
impl DeleteStoredQueryFluentBuilder  {
    /// Creates a new `DeleteStoredQuery`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_stored_query::DeleteStoredQueryOutput, aws_smithy_http::result::SdkError<crate::operation::delete_stored_query::DeleteStoredQueryError>>
                     {
