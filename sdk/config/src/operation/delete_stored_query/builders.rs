...
impl DeleteStoredQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_stored_query::DeleteStoredQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_stored_query::DeleteStoredQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_stored_query::DeleteStoredQueryOutput, crate::operation::delete_stored_query::DeleteStoredQueryError, Self> {
