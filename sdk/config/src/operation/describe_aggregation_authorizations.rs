...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAggregationAuthorizations {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAggregationAuthorizations")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeAggregationAuthorizationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeAggregationAuthorizationsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAggregationAuthorizationsEndpointParamsInterceptor {
