...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetResourceEvaluationSummaryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_resource_evaluation_summary::de_get_resource_evaluation_summary_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_resource_evaluation_summary::de_get_resource_evaluation_summary_http_response(
