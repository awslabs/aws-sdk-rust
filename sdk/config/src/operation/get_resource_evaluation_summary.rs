...
impl GetResourceEvaluationSummaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceEvaluationSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_evaluation_summary::de_get_resource_evaluation_summary_http_response_with_props(
                status, headers, body,
            )
        }
    }
