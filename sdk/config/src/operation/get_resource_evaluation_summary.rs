...
impl GetResourceEvaluationSummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetResourceEvaluationSummary`](crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_resource_evaluation_summary::ser_get_resource_evaluation_summary_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummary::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourceEvaluationSummary {
                type Output = std::result::Result<crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryOutput, crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_resource_evaluation_summary::GetResourceEvaluationSummaryError {
