...
impl PutDeliveryChannelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_delivery_channel::ser_put_delivery_channel_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDeliveryChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_delivery_channel::de_put_delivery_channel_http_response_with_props(status, headers, body)
        }
    }
}
