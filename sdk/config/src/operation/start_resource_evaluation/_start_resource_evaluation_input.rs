...
impl StartResourceEvaluationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_resource_evaluation::StartResourceEvaluationInput, ::aws_smithy_types::error::operation::BuildError> {
