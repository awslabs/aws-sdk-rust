...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutThirdPartyServiceLinkedConfigurationRecorderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_third_party_service_linked_configuration_recorder::de_put_third_party_service_linked_configuration_recorder_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_third_party_service_linked_configuration_recorder::de_put_third_party_service_linked_configuration_recorder_http_response(status, headers, body, _cfg)
        };
