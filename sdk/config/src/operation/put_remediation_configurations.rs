...
impl PutRemediationConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`PutRemediationConfigurations`](crate::operation::put_remediation_configurations::PutRemediationConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_remediation_configurations::PutRemediationConfigurations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_remediation_configurations::PutRemediationConfigurationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_remediation_configurations::ser_put_remediation_configurations_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_remediation_configurations::PutRemediationConfigurations::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutRemediationConfigurations {
                type Output = std::result::Result<crate::operation::put_remediation_configurations::PutRemediationConfigurationsOutput, crate::operation::put_remediation_configurations::PutRemediationConfigurationsError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_remediation_configurations::PutRemediationConfigurationsError {
