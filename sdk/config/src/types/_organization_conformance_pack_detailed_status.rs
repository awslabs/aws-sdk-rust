...
impl OrganizationConformancePackDetailedStatusBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::OrganizationConformancePackDetailedStatus, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::OrganizationConformancePackDetailedStatus {
                account_id: self.account_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("account_id", "account_id was not specified but it is required when building OrganizationConformancePackDetailedStatus")
                    )?
                ,
                conformance_pack_name: self.conformance_pack_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("conformance_pack_name", "conformance_pack_name was not specified but it is required when building OrganizationConformancePackDetailedStatus")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building OrganizationConformancePackDetailedStatus")
                    )?
                ,
