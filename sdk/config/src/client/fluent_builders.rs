...
impl DeleteRemediationExceptions {
    ...
    pub fn set_resource_keys(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::RemediationExceptionResourceKey>>,
    ) -> Self {
        self.inner = self.inner.set_resource_keys(input);
        self
    }
...
impl GetAggregateConformancePackComplianceSummary {
    ...
    pub fn set_filters(
        mut self,
        input: std::option::Option<crate::model::AggregateConformancePackComplianceSummaryFilters>,
    ) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
    ...
    pub fn set_group_by_key(
        mut self,
        input: std::option::Option<crate::model::AggregateConformancePackComplianceSummaryGroupKey>,
    ) -> Self {
        self.inner = self.inner.set_group_by_key(input);
        self
    }
