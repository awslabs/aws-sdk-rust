...
impl super::Client {
    ...
    ///   - [`name(Option<String>)`](crate::operation::put_service_linked_configuration_recorder::PutServiceLinkedConfigurationRecorderOutput::name): <p>The name of the specified configuration recorder.</p> <p>For service-linked configuration recorders, Config automatically assigns a name that has the prefix "<code>AWS</code>" to the new service-linked configuration recorder.</p>
