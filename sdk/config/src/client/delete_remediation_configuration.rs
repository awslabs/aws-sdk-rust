...
impl super::Client {
    ...
    ///   - [`config_rule_name(impl ::std::convert::Into<String>)`](crate::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationFluentBuilder::config_rule_name) / [`set_config_rule_name(Option<String>)`](crate::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationFluentBuilder::set_config_rule_name): <p>The name of the Config rule for which you want to delete remediation configuration.</p>
