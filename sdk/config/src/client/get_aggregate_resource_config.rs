...
impl super::Client {
    ...
    ///   - [`configuration_aggregator_name(impl ::std::convert::Into<String>)`](crate::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigFluentBuilder::configuration_aggregator_name) / [`set_configuration_aggregator_name(Option<String>)`](crate::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigFluentBuilder::set_configuration_aggregator_name): <p>The name of the configuration aggregator.</p>
