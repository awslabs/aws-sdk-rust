...
impl super::Client {
    ...
    ///   - [`evaluation_mode(EvaluationMode)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_mode) / [`set_evaluation_mode(Option<EvaluationMode>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_mode): <p>The mode of an evaluation. The valid value for this API is <code>Proactive</code>.</p>
    ///   - [`evaluation_timeout(i32)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_timeout) / [`set_evaluation_timeout(i32)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_timeout): <p>The timeout for an evaluation. The default is 900 seconds. You cannot specify a number greater than 3600. If you specify 0, Config uses the default.</p>
