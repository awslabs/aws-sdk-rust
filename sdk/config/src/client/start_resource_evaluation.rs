...
impl super::Client {
    ...
    ///   - [`resource_details(ResourceDetails)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::resource_details) / [`set_resource_details(Option<ResourceDetails>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_resource_details): <p>Returns a <code>ResourceDetails</code> object.</p>
    ///   - [`evaluation_context(EvaluationContext)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_context) / [`set_evaluation_context(Option<EvaluationContext>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_context): <p>Returns an <code>EvaluationContext</code> object.</p>
    ///   - [`evaluation_mode(EvaluationMode)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_mode) / [`set_evaluation_mode(Option<EvaluationMode>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_mode): <p>The mode of an evaluation. The valid values for this API are <code>DETECTIVE</code> and <code>PROACTIVE</code>.</p>
    ///   - [`evaluation_timeout(i32)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::evaluation_timeout) / [`set_evaluation_timeout(Option<i32>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_evaluation_timeout): <p>The timeout for an evaluation. The default is 900 seconds. You cannot specify a number greater than 3600. If you specify 0, Config uses the default.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::start_resource_evaluation::builders::StartResourceEvaluationFluentBuilder::set_client_token): <p>A client token is a unique, case-sensitive string of up to 64 ASCII characters. To make an idempotent API request using one of these actions, specify a client token in the request.</p> <note>   <p>Avoid reusing the same client token for other API requests. If you retry a request that completed successfully using the same client token and the same parameters, the retry succeeds without performing any further actions. If you retry a successful request using the same client token, but one or more of the parameters are different, other than the Region or Availability Zone, the retry fails with an IdempotentParameterMismatch error.</p>  </note>
