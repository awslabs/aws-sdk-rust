...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::put_stored_query::builders::PutStoredQueryFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::put_stored_query::builders::PutStoredQueryFluentBuilder::set_tags): <p>A list of <code>Tags</code> object.</p>
