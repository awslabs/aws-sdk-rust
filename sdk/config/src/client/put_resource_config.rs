...
impl super::Client {
    ...
    ///   - [`resource_type(impl ::std::convert::Into<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::resource_type) / [`set_resource_type(Option<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::set_resource_type): <p>The type of the resource. The custom resource type must be registered with CloudFormation. </p> <note>   <p>You cannot use the organization names “amzn”, “amazon”, “alexa”, “custom” with custom resource types. It is the first part of the ResourceType up to the first ::.</p>  </note>
    ///   - [`schema_version_id(impl ::std::convert::Into<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::schema_version_id) / [`set_schema_version_id(Option<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::set_schema_version_id): <p>Version of the schema registered for the ResourceType in CloudFormation.</p>
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::set_resource_id): <p>Unique identifier of the resource.</p>
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::set_resource_name): <p>Name of the resource.</p>
    ///   - [`configuration(impl ::std::convert::Into<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::configuration) / [`set_configuration(Option<String>)`](crate::operation::put_resource_config::builders::PutResourceConfigFluentBuilder::set_configuration): <p>The configuration object of the resource in valid JSON format. It must match the schema registered with CloudFormation.</p> <note>   <p>The configuration JSON must not exceed 64 KB.</p>  </note>
