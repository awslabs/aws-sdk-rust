...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationFluentBuilder::set_tags): <p>An array of tag object.</p>
