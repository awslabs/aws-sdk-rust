...
impl super::Client {
    ...
    ///   - [`config_rule_name(impl ::std::convert::Into<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::config_rule_name) / [`set_config_rule_name(Option<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_config_rule_name): <p>A list of Config rule names.</p>
    ///   - [`resource_keys(Vec<ResourceKey>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::resource_keys) / [`set_resource_keys(Option<Vec<ResourceKey>>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_resource_keys): <p>A list of resource keys to be processed with the current request. Each element in the list consists of the resource type and resource ID. </p>
    ///   - [`limit(i32)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_limit): <p>The maximum number of RemediationExecutionStatuses returned on each page. The default is maximum. If you specify 0, Config uses the default. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_next_token): <p>The <code>nextToken</code> string returned on a previous page that you use to get the next page of results in a paginated response.</p>
