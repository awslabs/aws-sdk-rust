...
impl super::Client {
    ...
    ///   - [`config_rule_name(impl Into<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::config_rule_name) / [`set_config_rule_name(Option<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_config_rule_name): <p>A list of Config rule names.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_remediation_execution_status::builders::DescribeRemediationExecutionStatusFluentBuilder::set_next_token): <p>The <code>nextToken</code> string returned on a previous page that you use to get the next page of results in a paginated response.</p>
