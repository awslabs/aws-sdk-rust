...
impl super::Client  {
    ...
    ///   - [`retention_period_in_days(i32)`](crate::operation::put_retention_configuration::builders::PutRetentionConfigurationFluentBuilder::retention_period_in_days) / [`set_retention_period_in_days(Option<i32>)`](crate::operation::put_retention_configuration::builders::PutRetentionConfigurationFluentBuilder::set_retention_period_in_days): <p>Number of days Config stores your historical information.</p> <note>   <p>Currently, only applicable to the configuration item history.</p>  </note>
