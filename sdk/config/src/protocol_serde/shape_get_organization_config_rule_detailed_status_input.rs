...
pub fn ser_get_organization_config_rule_detailed_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetOrganizationConfigRuleDetailedStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
