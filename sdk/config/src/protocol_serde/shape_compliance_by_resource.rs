...
pub(crate) fn de_compliance_by_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ComplianceByResource>, aws_smithy_json::deserialize::error::DeserializeError>
