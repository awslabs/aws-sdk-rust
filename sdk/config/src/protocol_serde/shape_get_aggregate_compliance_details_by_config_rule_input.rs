...
pub fn ser_get_aggregate_compliance_details_by_config_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAggregateComplianceDetailsByConfigRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
