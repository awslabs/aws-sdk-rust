...
pub fn ser_evaluation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Evaluation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
