...
pub(crate) fn de_exclusion_by_resource_types<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ExclusionByResourceTypes>, ::aws_smithy_json::deserialize::error::DeserializeError>
