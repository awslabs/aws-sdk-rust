...
pub fn ser_aggregate_resource_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AggregateResourceIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aggregate_resource_identifier<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AggregateResourceIdentifier>, aws_smithy_json::deserialize::error::DeserializeError>
