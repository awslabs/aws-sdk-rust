...
) -> Result<Option<crate::types::ConfigurationItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "relatedEvents" => {
                            builder = builder.set_related_events(crate::protocol_serde::shape_related_event_list::de_related_event_list(tokens)?);
                        }
                        "relationships" => {
