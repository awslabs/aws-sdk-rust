...
pub(crate) fn de_configuration_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigurationItem>, aws_smithy_json::deserialize::error::DeserializeError>
