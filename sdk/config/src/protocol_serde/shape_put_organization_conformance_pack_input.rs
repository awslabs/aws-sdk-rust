...
pub fn ser_put_organization_conformance_pack_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutOrganizationConformancePackInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
