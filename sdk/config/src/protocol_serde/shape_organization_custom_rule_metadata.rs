...
pub fn ser_organization_custom_rule_metadata(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OrganizationCustomRuleMetadata) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_organization_custom_rule_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OrganizationCustomRuleMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
