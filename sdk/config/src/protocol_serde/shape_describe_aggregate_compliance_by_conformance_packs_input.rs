...
pub fn ser_describe_aggregate_compliance_by_conformance_packs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAggregateComplianceByConformancePacksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
