...
pub fn ser_put_conformance_pack_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutConformancePackInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
