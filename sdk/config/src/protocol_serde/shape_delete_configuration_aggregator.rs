...
pub fn de_delete_configuration_aggregator_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorOutput, crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_configuration_aggregator_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorOutput, crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_configuration_aggregator_input(input: &crate::operation::delete_configuration_aggregator::DeleteConfigurationAggregatorInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
