...
pub(crate) fn de_conformance_pack_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConformancePackDetail>, aws_smithy_json::deserialize::error::DeserializeError>
