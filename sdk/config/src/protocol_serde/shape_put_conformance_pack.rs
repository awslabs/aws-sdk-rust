...
pub fn de_put_conformance_pack_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_conformance_pack::PutConformancePackOutput, crate::operation::put_conformance_pack::PutConformancePackError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "ConformancePackTemplateValidationException" => crate::operation::put_conformance_pack::PutConformancePackError::ConformancePackTemplateValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "MaxNumberOfConformancePacksExceededException" => crate::operation::put_conformance_pack::PutConformancePackError::MaxNumberOfConformancePacksExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_conformance_pack_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_conformance_pack::PutConformancePackOutput, crate::operation::put_conformance_pack::PutConformancePackError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_put_conformance_pack_input(input: &crate::operation::put_conformance_pack::PutConformancePackInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_put_conformance_pack(value: &[u8], mut builder: crate::operation::put_conformance_pack::builders::PutConformancePackOutputBuilder) -> Result<crate::operation::put_conformance_pack::builders::PutConformancePackOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
