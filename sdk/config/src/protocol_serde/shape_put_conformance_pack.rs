...
pub fn ser_put_conformance_pack_input(input: &crate::operation::put_conformance_pack::PutConformancePackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
