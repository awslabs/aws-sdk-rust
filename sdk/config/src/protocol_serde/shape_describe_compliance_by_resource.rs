...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => {
            crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_compliance_by_resource::de_describe_compliance_by_resource(_response_body, output)
            .map_err(crate::operation::describe_compliance_by_resource::DescribeComplianceByResourceError::unhandled)?;
...
pub(crate) fn de_describe_compliance_by_resource(
    _value: &[u8],
    mut builder: crate::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceOutputBuilder,
) -> ::std::result::Result<
    crate::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceOutputBuilder,
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ComplianceByResources" => {
                    builder = builder.set_compliance_by_resources(crate::protocol_serde::shape_compliance_by_resources::de_compliance_by_resources(
                        tokens, _value,
                    )?);
                }
                "NextToken" => {
