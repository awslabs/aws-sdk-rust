...
pub fn ser_describe_conformance_packs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeConformancePacksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
