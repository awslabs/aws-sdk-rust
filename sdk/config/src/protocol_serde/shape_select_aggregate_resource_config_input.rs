...
pub fn ser_select_aggregate_resource_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SelectAggregateResourceConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
