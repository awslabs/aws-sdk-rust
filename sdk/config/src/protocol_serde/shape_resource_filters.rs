...
pub fn ser_resource_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
