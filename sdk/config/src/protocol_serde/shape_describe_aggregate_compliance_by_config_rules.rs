...
pub fn ser_describe_aggregate_compliance_by_config_rules_input(input: &crate::operation::describe_aggregate_compliance_by_config_rules::DescribeAggregateComplianceByConfigRulesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_describe_aggregate_compliance_by_config_rules_input::ser_describe_aggregate_compliance_by_config_rules_input_input(&mut object, input)?;
    object.finish();
