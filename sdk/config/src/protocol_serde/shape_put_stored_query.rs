...
pub fn de_put_stored_query_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_stored_query::PutStoredQueryOutput, crate::operation::put_stored_query::PutStoredQueryError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::put_stored_query::builders::PutStoredQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
