...
pub(crate) fn de_base_configuration_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BaseConfigurationItem>, aws_smithy_json::deserialize::error::DeserializeError>
