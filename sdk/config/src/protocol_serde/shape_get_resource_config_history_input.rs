...
pub fn ser_get_resource_config_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetResourceConfigHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
