...
pub fn ser_config_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfigRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_config_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigRule>, aws_smithy_json::deserialize::error::DeserializeError>
