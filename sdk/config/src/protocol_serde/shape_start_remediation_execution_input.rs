...
pub fn ser_start_remediation_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_remediation_execution::StartRemediationExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
