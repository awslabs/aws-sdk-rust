...
pub fn de_start_remediation_execution_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_remediation_execution::StartRemediationExecutionOutput, crate::operation::start_remediation_execution::StartRemediationExecutionError> {
    #[allow(unused_mut)]
...
pub fn ser_start_remediation_execution_input(input: &crate::operation::start_remediation_execution::StartRemediationExecutionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
