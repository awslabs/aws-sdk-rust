...
pub fn ser_batch_get_aggregate_resource_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetAggregateResourceConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
