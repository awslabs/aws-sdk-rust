...
pub(crate) fn de_stored_query<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StoredQuery>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_stored_query(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StoredQuery) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
