...
pub(crate) fn de_retention_configuration_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::RetentionConfiguration>>, aws_smithy_json::deserialize::error::DeserializeError>
