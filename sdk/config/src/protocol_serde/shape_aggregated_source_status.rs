...
pub(crate) fn de_aggregated_source_status<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AggregatedSourceStatus>, aws_smithy_json::deserialize::error::DeserializeError>
