...
pub fn de_put_remediation_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_remediation_configurations::PutRemediationConfigurationsOutput, crate::operation::put_remediation_configurations::PutRemediationConfigurationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_remediation_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_remediation_configurations::PutRemediationConfigurationsOutput, crate::operation::put_remediation_configurations::PutRemediationConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
