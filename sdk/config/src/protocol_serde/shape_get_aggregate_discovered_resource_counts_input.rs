...
pub fn ser_get_aggregate_discovered_resource_counts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAggregateDiscoveredResourceCountsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
