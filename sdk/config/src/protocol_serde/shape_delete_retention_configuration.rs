...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_retention_configuration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_retention_configuration::DeleteRetentionConfigurationOutput, crate::operation::delete_retention_configuration::DeleteRetentionConfigurationError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_retention_configuration_input(input: &crate::operation::delete_retention_configuration::DeleteRetentionConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
