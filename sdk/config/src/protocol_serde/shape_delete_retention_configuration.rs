...
pub fn de_delete_retention_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_retention_configuration::DeleteRetentionConfigurationOutput, crate::operation::delete_retention_configuration::DeleteRetentionConfigurationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_retention_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_retention_configuration::DeleteRetentionConfigurationOutput, crate::operation::delete_retention_configuration::DeleteRetentionConfigurationError> {
    Ok({
        #[allow(unused_mut)]
