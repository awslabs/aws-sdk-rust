...
pub fn ser_describe_configuration_aggregator_sources_status_input(
    ...
    crate::protocol_serde::shape_describe_configuration_aggregator_sources_status_input::ser_describe_configuration_aggregator_sources_status_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_configuration_aggregator_sources_status_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
