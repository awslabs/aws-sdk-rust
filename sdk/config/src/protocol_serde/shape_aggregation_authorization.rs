...
pub(crate) fn de_aggregation_authorization<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AggregationAuthorization>, aws_smithy_json::deserialize::error::DeserializeError>
