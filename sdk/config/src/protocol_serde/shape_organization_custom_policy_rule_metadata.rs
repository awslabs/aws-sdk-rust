...
pub fn ser_organization_custom_policy_rule_metadata(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OrganizationCustomPolicyRuleMetadata) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
