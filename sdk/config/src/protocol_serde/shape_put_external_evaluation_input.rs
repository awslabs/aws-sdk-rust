...
pub fn ser_put_external_evaluation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutExternalEvaluationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
