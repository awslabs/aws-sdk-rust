...
pub fn ser_config_rule_compliance_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfigRuleComplianceFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
