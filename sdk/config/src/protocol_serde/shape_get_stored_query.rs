...
) -> Result<crate::operation::get_stored_query::builders::GetStoredQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "StoredQuery" => {
                    builder = builder.set_stored_query(crate::protocol_serde::shape_stored_query::de_stored_query(tokens)?);
                }
