...
pub fn ser_get_conformance_pack_compliance_summary_input(
    ...
    crate::protocol_serde::shape_get_conformance_pack_compliance_summary_input::ser_get_conformance_pack_compliance_summary_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_conformance_pack_compliance_summary_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
