...
pub fn ser_start_resource_evaluation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartResourceEvaluationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
