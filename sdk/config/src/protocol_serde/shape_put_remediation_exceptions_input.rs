...
pub fn ser_put_remediation_exceptions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::put_remediation_exceptions::PutRemediationExceptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_7) = &input.expiration_time {
        object.key("ExpirationTime").date_time(var_7, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
