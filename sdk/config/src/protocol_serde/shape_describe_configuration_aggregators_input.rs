...
pub fn ser_describe_configuration_aggregators_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeConfigurationAggregatorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
