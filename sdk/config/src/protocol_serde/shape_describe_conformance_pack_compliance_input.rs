...
pub fn ser_describe_conformance_pack_compliance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeConformancePackComplianceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
