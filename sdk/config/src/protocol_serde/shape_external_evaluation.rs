...
pub fn ser_external_evaluation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExternalEvaluation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
