...
pub fn ser_put_config_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutConfigRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
