...
pub fn parse_get_ice_server_config_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetIceServerConfigOutput, crate::error::GetIceServerConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetIceServerConfigError::unhandled)?;
...
pub fn parse_send_alexa_offer_to_master_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendAlexaOfferToMasterOutput, crate::error::SendAlexaOfferToMasterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::SendAlexaOfferToMasterError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                            ...
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ClientLimitExceededException" => crate::error::SendAlexaOfferToMasterError::ClientLimitExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidArgumentException" => crate::error::SendAlexaOfferToMasterError::InvalidArgumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NotAuthorizedException" => crate::error::SendAlexaOfferToMasterError::NotAuthorizedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::SendAlexaOfferToMasterError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
