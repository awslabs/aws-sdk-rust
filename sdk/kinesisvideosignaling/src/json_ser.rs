...
pub fn serialize_structure_crate_input_get_ice_server_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetIceServerConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_send_alexa_offer_to_master_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendAlexaOfferToMasterInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
