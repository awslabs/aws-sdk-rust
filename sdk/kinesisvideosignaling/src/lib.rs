...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
                    aws_http::user_agent::ApiMetadata::new("kinesisvideosignaling", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Kinesis Video Signaling Channels.
pub mod client;
