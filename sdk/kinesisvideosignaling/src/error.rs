...
impl aws_smithy_http::result::CreateUnhandledError for SendAlexaOfferToMasterError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: SendAlexaOfferToMasterErrorKind::Unhandled(crate::error::Unhandled::new(source)),
...
impl std::fmt::Display for SendAlexaOfferToMasterError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SendAlexaOfferToMasterErrorKind::ClientLimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            SendAlexaOfferToMasterErrorKind::InvalidArgumentException(_inner) =>
            _inner.fmt(f)
            ,
            SendAlexaOfferToMasterErrorKind::NotAuthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            SendAlexaOfferToMasterErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SendAlexaOfferToMasterErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SendAlexaOfferToMasterError {
    /// Creates a new `SendAlexaOfferToMasterError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: SendAlexaOfferToMasterErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_client_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, SendAlexaOfferToMasterErrorKind::ClientLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `SendAlexaOfferToMasterErrorKind::InvalidArgumentException`.
    pub fn is_invalid_argument_exception(&self) -> bool {
        matches!(&self.kind, SendAlexaOfferToMasterErrorKind::InvalidArgumentException(_))
    }
    ...
    pub fn is_not_authorized_exception(&self) -> bool {
        matches!(&self.kind, SendAlexaOfferToMasterErrorKind::NotAuthorizedException(_))
    }
    /// Returns `true` if the error kind is `SendAlexaOfferToMasterErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, SendAlexaOfferToMasterErrorKind::ResourceNotFoundException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for GetIceServerConfigError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: GetIceServerConfigErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for GetIceServerConfigError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetIceServerConfigErrorKind::ClientLimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::InvalidArgumentException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::InvalidClientException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::NotAuthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::SessionExpiredException(_inner) =>
            _inner.fmt(f)
            ,
            GetIceServerConfigErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetIceServerConfigError {
    ...
    pub fn is_client_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::ClientLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `GetIceServerConfigErrorKind::InvalidArgumentException`.
    pub fn is_invalid_argument_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::InvalidArgumentException(_))
    }
    ...
    pub fn is_invalid_client_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::InvalidClientException(_))
    }
    /// Returns `true` if the error kind is `GetIceServerConfigErrorKind::NotAuthorizedException`.
    pub fn is_not_authorized_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::NotAuthorizedException(_))
    }
    /// Returns `true` if the error kind is `GetIceServerConfigErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::ResourceNotFoundException(_))
    }
    ...
    pub fn is_session_expired_exception(&self) -> bool {
        matches!(&self.kind, GetIceServerConfigErrorKind::SessionExpiredException(_))
    }
}
