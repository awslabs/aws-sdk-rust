    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/send-alexa-offer-to-master")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMaster::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError
{
