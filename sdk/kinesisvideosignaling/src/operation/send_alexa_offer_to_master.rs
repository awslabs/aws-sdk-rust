...
/// Orchestration and serialization glue logic for `SendAlexaOfferToMaster`.
...
impl SendAlexaOfferToMaster {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendAlexaOfferToMaster {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SendAlexaOfferToMaster");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SendAlexaOfferToMasterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SendAlexaOfferToMasterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendAlexaOfferToMaster")
...
.with_interceptor(SendAlexaOfferToMasterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError>::new());
...
#[derive(Debug)]
            struct SendAlexaOfferToMasterResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendAlexaOfferToMasterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_send_alexa_offer_to_master::de_send_alexa_offer_to_master_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_send_alexa_offer_to_master::de_send_alexa_offer_to_master_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SendAlexaOfferToMasterRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendAlexaOfferToMasterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/send-alexa-offer-to-master").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_send_alexa_offer_to_master::ser_send_alexa_offer_to_master_input(&input)?);
...
#[derive(Debug)]
            struct SendAlexaOfferToMasterEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendAlexaOfferToMasterEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SendAlexaOfferToMasterEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SendAlexaOfferToMasterInput>()
                        .ok_or("failed to downcast to SendAlexaOfferToMasterInput")?;
...
pub enum SendAlexaOfferToMasterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SendAlexaOfferToMasterError) for what information is available for the error.")]
...
impl SendAlexaOfferToMasterError {
    /// Creates the `SendAlexaOfferToMasterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendAlexaOfferToMasterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SendAlexaOfferToMasterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError {
...
mod _send_alexa_offer_to_master_output;
