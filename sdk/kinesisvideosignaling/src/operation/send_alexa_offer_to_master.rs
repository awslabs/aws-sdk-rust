...
impl SendAlexaOfferToMasterInput {
    /// Consumes the builder and constructs an Operation<[`SendAlexaOfferToMaster`](crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMaster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMaster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMaster::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SendAlexaOfferToMaster {
                type Output = std::result::Result<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterOutput, crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError>;
