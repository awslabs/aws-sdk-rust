...
impl GetIceServerConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_ice_server_config::GetIceServerConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_ice_server_config::GetIceServerConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_ice_server_config::GetIceServerConfigOutput, crate::operation::get_ice_server_config::GetIceServerConfigError, Self> {
