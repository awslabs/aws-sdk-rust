    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/get-ice-server-config")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_ice_server_config::GetIceServerConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_ice_server_config::GetIceServerConfigError
{
