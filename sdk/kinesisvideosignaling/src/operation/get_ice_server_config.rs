...
impl GetIceServerConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_ice_server_config::GetIceServerConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIceServerConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ice_server_config::de_get_ice_server_config_http_response_with_props(status, headers, body)
        }
    }
}
