...
impl SendAlexaOfferToMasterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterOutput, crate::operation::send_alexa_offer_to_master::SendAlexaOfferToMasterError, Self> {
