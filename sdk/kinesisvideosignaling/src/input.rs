...
impl GetIceServerConfigInput {
    ...
    > {
        Ok({
            ...
            let body =
                crate::operation_ser::serialize_operation_crate_operation_get_ice_server_config(
                    &self,
                )
                .map_err(|err| {
...
impl SendAlexaOfferToMasterInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_send_alexa_offer_to_master(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
