...
pub fn ser_asn1_subject(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Asn1Subject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_asn1_subject<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Asn1Subject>, aws_smithy_json::deserialize::error::DeserializeError>
