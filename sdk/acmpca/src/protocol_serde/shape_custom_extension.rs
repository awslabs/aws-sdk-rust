...
pub fn ser_custom_extension(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomExtension) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
