...
pub fn ser_create_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
