...
pub fn ser_list_certificate_authorities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_certificate_authorities::ListCertificateAuthoritiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
