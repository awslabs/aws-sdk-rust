...
pub fn ser_create_certificate_authority_audit_report_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCertificateAuthorityAuditReportInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
