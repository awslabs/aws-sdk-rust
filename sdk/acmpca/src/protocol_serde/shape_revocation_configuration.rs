            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "CrlConfiguration" => {
                            builder = builder.set_crl_configuration(crate::protocol_serde::shape_crl_configuration::de_crl_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "OcspConfiguration" => {
                            builder = builder.set_ocsp_configuration(crate::protocol_serde::shape_ocsp_configuration::de_ocsp_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
