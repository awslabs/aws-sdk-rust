...
pub fn ser_extended_key_usage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExtendedKeyUsage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
