...
pub fn ser_key_usage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KeyUsage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_key_usage<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KeyUsage>, aws_smithy_json::deserialize::error::DeserializeError>
