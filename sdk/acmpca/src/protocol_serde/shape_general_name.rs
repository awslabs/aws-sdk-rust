...
pub fn ser_general_name(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeneralName) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_general_name<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GeneralName>, aws_smithy_json::deserialize::error::DeserializeError>
