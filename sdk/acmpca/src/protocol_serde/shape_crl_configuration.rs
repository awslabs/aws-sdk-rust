...
pub fn ser_crl_configuration(
    ...
    if let Some(var_1) = &input.expiration_in_days {
        object.key("ExpirationInDays").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_5) = &input.crl_distribution_point_extension_configuration {
        ...
        crate::protocol_serde::shape_crl_distribution_point_extension_configuration::ser_crl_distribution_point_extension_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}
...
pub(crate) fn de_crl_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CrlConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::crl_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
