...
pub fn ser_tag_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TagCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
