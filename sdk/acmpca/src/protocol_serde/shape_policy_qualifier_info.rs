...
pub fn ser_policy_qualifier_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PolicyQualifierInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
