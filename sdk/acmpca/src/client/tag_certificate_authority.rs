...
impl super::Client {
    ...
    ///   - [`certificate_authority_arn(impl Into<String>)`](crate::operation::tag_certificate_authority::builders::TagCertificateAuthorityFluentBuilder::certificate_authority_arn) / [`set_certificate_authority_arn(Option<String>)`](crate::operation::tag_certificate_authority::builders::TagCertificateAuthorityFluentBuilder::set_certificate_authority_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that was returned when you called <a href="https://docs.aws.amazon.com/privateca/latest/APIReference/API_CreateCertificateAuthority.html">CreateCertificateAuthority</a>. This must be of the form:</p> <p><code>arn:aws:acm-pca:<i>region</i>:<i>account</i>:certificate-authority/<i>12345678-1234-1234-1234-123456789012</i> </code></p><br>
    ///   - [`tags(Tag)`](crate::operation::tag_certificate_authority::builders::TagCertificateAuthorityFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::tag_certificate_authority::builders::TagCertificateAuthorityFluentBuilder::set_tags):<br>required: **true**<br><p>List of tags to be associated with the CA.</p><br>
