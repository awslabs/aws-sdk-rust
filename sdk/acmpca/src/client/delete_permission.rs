...
impl super::Client {
    ...
    ///   - [`certificate_authority_arn(impl Into<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::certificate_authority_arn) / [`set_certificate_authority_arn(Option<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::set_certificate_authority_arn):<br>required: **true**<br><p>The Amazon Resource Number (ARN) of the private CA that issued the permissions. You can find the CA's ARN by calling the <a href="https://docs.aws.amazon.com/privateca/latest/APIReference/API_ListCertificateAuthorities.html">ListCertificateAuthorities</a> action. This must have the following form:</p> <p><code>arn:aws:acm-pca:<i>region</i>:<i>account</i>:certificate-authority/<i>12345678-1234-1234-1234-123456789012</i> </code>.</p><br>
    ///   - [`principal(impl Into<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::principal) / [`set_principal(Option<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::set_principal):<br>required: **true**<br><p>The Amazon Web Services service or identity that will have its CA permissions revoked. At this time, the only valid service principal is <code>acm.amazonaws.com</code></p><br>
    ///   - [`source_account(impl Into<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::source_account) / [`set_source_account(Option<String>)`](crate::operation::delete_permission::builders::DeletePermissionFluentBuilder::set_source_account):<br>required: **false**<br><p>The Amazon Web Services account that calls this action.</p><br>
