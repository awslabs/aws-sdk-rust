...
pub struct RevocationConfiguration  {
    ...
    #[doc(hidden)]pub crl_configuration: std::option::Option<crate::model::CrlConfiguration>,
    ...
    #[doc(hidden)]pub ocsp_configuration: std::option::Option<crate::model::OcspConfiguration>,
}
...
pub struct OcspConfiguration  {
    ...
    #[doc(hidden)]pub ocsp_custom_cname: std::option::Option<std::string::String>,
}
...
pub struct CrlConfiguration  {
    ...
    #[doc(hidden)]pub custom_cname: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub s3_object_acl: std::option::Option<crate::model::S3ObjectAcl>,
}
...
pub struct Permission  {
    ...
    #[doc(hidden)]pub actions: std::option::Option<std::vec::Vec<crate::model::ActionType>>,
...
pub struct CertificateAuthority  {
    ...
    #[doc(hidden)]pub last_state_change_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Type of your private CA.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::CertificateAuthorityType>,
    /// <p>Serial number of your private CA.</p>
    #[doc(hidden)]pub serial: std::option::Option<std::string::String>,
    /// <p>Status of your private CA.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::CertificateAuthorityStatus>,
    ...
    #[doc(hidden)]pub certificate_authority_configuration: std::option::Option<crate::model::CertificateAuthorityConfiguration>,
    ...
    #[doc(hidden)]pub revocation_configuration: std::option::Option<crate::model::RevocationConfiguration>,
    ...
    #[doc(hidden)]pub restorable_until: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub key_storage_security_standard: std::option::Option<crate::model::KeyStorageSecurityStandard>,
}
...
impl  std::fmt::Debug for CertificateAuthority  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("certificate_authority_configuration", &self.certificate_authority_configuration);
        ...
        formatter.field("key_storage_security_standard", &self.key_storage_security_standard);
        formatter.finish()
    }
}
...
pub struct CertificateAuthorityConfiguration  {
    ...
    #[doc(hidden)]pub key_algorithm: std::option::Option<crate::model::KeyAlgorithm>,
    ...
    #[doc(hidden)]pub signing_algorithm: std::option::Option<crate::model::SigningAlgorithm>,
    /// <p>Structure that contains X.500 distinguished name information for your private CA.</p>
    #[doc(hidden)]pub subject: std::option::Option<crate::model::Asn1Subject>,
    /// <p>Specifies information to be added to the extension section of the certificate signing request (CSR).</p>
    #[doc(hidden)]pub csr_extensions: std::option::Option<crate::model::CsrExtensions>,
}
...
pub struct CsrExtensions  {
    ...
    #[doc(hidden)]pub key_usage: std::option::Option<crate::model::KeyUsage>,
    ...
    #[doc(hidden)]pub subject_information_access: std::option::Option<std::vec::Vec<crate::model::AccessDescription>>,
}
impl CsrExtensions {
    /// <p>Indicates the purpose of the certificate and of the key contained in the certificate.</p>
...
impl  std::fmt::Debug for CsrExtensions  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("subject_information_access", &self.subject_information_access);
        formatter.finish()
    }
}
...
pub struct AccessDescription  {
    ...
    #[doc(hidden)]pub access_method: std::option::Option<crate::model::AccessMethod>,
    /// <p>The location of <code>AccessDescription</code> information.</p>
    #[doc(hidden)]pub access_location: std::option::Option<crate::model::GeneralName>,
}
...
pub struct GeneralName  {
    ...
    #[doc(hidden)]pub other_name: std::option::Option<crate::model::OtherName>,
    /// <p>Represents <code>GeneralName</code> as an <a href="https://datatracker.ietf.org/doc/html/rfc822">RFC 822</a> email address.</p>
    #[doc(hidden)]pub rfc822_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub directory_name: std::option::Option<crate::model::Asn1Subject>,
    /// <p>Represents <code>GeneralName</code> as an <code>EdiPartyName</code> object.</p>
    #[doc(hidden)]pub edi_party_name: std::option::Option<crate::model::EdiPartyName>,
    /// <p>Represents <code>GeneralName</code> as a URI.</p>
    #[doc(hidden)]pub uniform_resource_identifier: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub registered_id: std::option::Option<std::string::String>,
}
impl GeneralName {
    /// <p>Represents <code>GeneralName</code> using an <code>OtherName</code> object.</p>
...
impl  std::fmt::Debug for GeneralName  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("uniform_resource_identifier", &self.uniform_resource_identifier);
...
pub struct EdiPartyName  {
    ...
    #[doc(hidden)]pub party_name: std::option::Option<std::string::String>,
    /// <p>Specifies the name assigner.</p>
    #[doc(hidden)]pub name_assigner: std::option::Option<std::string::String>,
}
impl EdiPartyName {
    /// <p>Specifies the party name.</p>
...
pub struct Asn1Subject  {
    ...
    #[doc(hidden)]pub organization: std::option::Option<std::string::String>,
    /// <p>A subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated.</p>
    #[doc(hidden)]pub organizational_unit: std::option::Option<std::string::String>,
    /// <p>Disambiguating information for the certificate subject.</p>
    #[doc(hidden)]pub distinguished_name_qualifier: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub common_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub locality: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub initials: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub pseudonym: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub generation_qualifier: std::option::Option<std::string::String>,
    /// <p></p> 
    ...
    /// </note>
    #[doc(hidden)]pub custom_attributes: std::option::Option<std::vec::Vec<crate::model::CustomAttribute>>,
}
impl Asn1Subject {
    /// <p>Two-digit code that specifies the country in which the certificate subject located.</p>
...
impl  std::fmt::Debug for Asn1Subject  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("distinguished_name_qualifier", &self.distinguished_name_qualifier);
...
pub struct OtherName  {
    ...
    #[doc(hidden)]pub type_id: std::option::Option<std::string::String>,
...
pub struct AccessMethod  {
    ...
    #[doc(hidden)]pub custom_object_identifier: std::option::Option<std::string::String>,
    /// <p>Specifies the <code>AccessMethod</code>.</p>
    #[doc(hidden)]pub access_method_type: std::option::Option<crate::model::AccessMethodType>,
}
impl AccessMethod {
    /// <p>An object identifier (OID) specifying the <code>AccessMethod</code>. The OID must satisfy the regular expression shown below. For more information, see NIST's definition of <a href="https://csrc.nist.gov/glossary/term/Object_Identifier">Object Identifier (OID)</a>.</p>
...
pub struct Validity  {
    ...
    #[doc(hidden)]pub value: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ValidityPeriodType>,
}
impl Validity {
    /// <p>A long integer interpreted according to the value of <code>Type</code>, below.</p>
...
pub struct ApiPassthrough  {
    ...
    #[doc(hidden)]pub extensions: std::option::Option<crate::model::Extensions>,
    /// <p>Contains information about the certificate subject. The <code>Subject</code> field in the certificate identifies the entity that owns or controls the public key in the certificate. The entity can be a user, computer, device, or service. The <code>Subject </code>must contain an X.500 distinguished name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by commas in the certificate.</p>
    #[doc(hidden)]pub subject: std::option::Option<crate::model::Asn1Subject>,
}
impl ApiPassthrough {
...
pub struct Extensions  {
    ...
    #[doc(hidden)]pub certificate_policies: std::option::Option<std::vec::Vec<crate::model::PolicyInformation>>,
    ...
    #[doc(hidden)]pub extended_key_usage: std::option::Option<std::vec::Vec<crate::model::ExtendedKeyUsage>>,
    /// <p>Defines one or more purposes for which the key contained in the certificate can be used. Default value for each option is false.</p>
    #[doc(hidden)]pub key_usage: std::option::Option<crate::model::KeyUsage>,
    ...
    #[doc(hidden)]pub subject_alternative_names: std::option::Option<std::vec::Vec<crate::model::GeneralName>>,
    /// <p></p> 
    ...
    #[doc(hidden)]pub custom_extensions: std::option::Option<std::vec::Vec<crate::model::CustomExtension>>,
}
impl Extensions {
    /// <p>Contains a sequence of one or more policy information terms, each of which consists of an object identifier (OID) and optional qualifiers. For more information, see NIST's definition of <a href="https://csrc.nist.gov/glossary/term/Object_Identifier">Object Identifier (OID)</a>.</p> 
    /// <p>In an end-entity certificate, these terms indicate the policy under which the certificate was issued and the purposes for which it may be used. In a CA certificate, these terms limit the set of policies for certification paths that include this certificate.</p>
...
pub struct CustomExtension  {
    ...
    #[doc(hidden)]pub critical: std::option::Option<bool>,
}
...
pub struct ExtendedKeyUsage  {
    ...
    #[doc(hidden)]pub extended_key_usage_type: std::option::Option<crate::model::ExtendedKeyUsageType>,
    /// <p>Specifies a custom <code>ExtendedKeyUsage</code> with an object identifier (OID).</p>
    #[doc(hidden)]pub extended_key_usage_object_identifier: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ExtendedKeyUsage  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("extended_key_usage_object_identifier", &self.extended_key_usage_object_identifier);
        formatter.finish()
    }
}
...
pub struct PolicyInformation  {
    ...
    #[doc(hidden)]pub cert_policy_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub policy_qualifiers: std::option::Option<std::vec::Vec<crate::model::PolicyQualifierInfo>>,
}
...
pub struct PolicyQualifierInfo  {
    ...
    #[doc(hidden)]pub policy_qualifier_id: std::option::Option<crate::model::PolicyQualifierId>,
    /// <p>Defines the qualifier type. ACM Private CA supports the use of a URI for a CPS qualifier in this field.</p>
    #[doc(hidden)]pub qualifier: std::option::Option<crate::model::Qualifier>,
}
...
pub struct Qualifier  {
    ...
    #[doc(hidden)]pub cps_uri: std::option::Option<std::string::String>,
}
impl Qualifier {
    /// <p>Contains a pointer to a certification practice statement (CPS) published by the CA.</p>
