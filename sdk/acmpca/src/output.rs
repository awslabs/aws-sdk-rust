...
pub struct ListPermissionsOutput  {
    ...
    #[doc(hidden)]pub permissions: std::option::Option<std::vec::Vec<crate::model::Permission>>,
    /// <p>When the list is truncated, this value is present and should be used for the <b>NextToken</b> parameter in a subsequent pagination request. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCertificateAuthoritiesOutput  {
    ...
    #[doc(hidden)]pub certificate_authorities: std::option::Option<std::vec::Vec<crate::model::CertificateAuthority>>,
...
pub struct IssueCertificateOutput  {
    ...
    #[doc(hidden)]pub certificate_arn: std::option::Option<std::string::String>,
}
...
pub struct GetCertificateAuthorityCsrOutput  {
    ...
    #[doc(hidden)]pub csr: std::option::Option<std::string::String>,
}
...
pub struct GetCertificateAuthorityCertificateOutput  {
    ...
    #[doc(hidden)]pub certificate: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub certificate_chain: std::option::Option<std::string::String>,
}
...
pub struct DescribeCertificateAuthorityAuditReportOutput  {
    ...
    #[doc(hidden)]pub audit_report_status: std::option::Option<crate::model::AuditReportStatus>,
    ...
    #[doc(hidden)]pub s3_key: std::option::Option<std::string::String>,
...
pub struct DescribeCertificateAuthorityOutput  {
    ...
    #[doc(hidden)]pub certificate_authority: std::option::Option<crate::model::CertificateAuthority>,
}
...
pub struct CreateCertificateAuthorityAuditReportOutput  {
    ...
    #[doc(hidden)]pub audit_report_id: std::option::Option<std::string::String>,
...
pub struct CreateCertificateAuthorityOutput  {
    ...
    #[doc(hidden)]pub certificate_authority_arn: std::option::Option<std::string::String>,
}
