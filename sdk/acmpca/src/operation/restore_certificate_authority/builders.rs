...
impl RestoreCertificateAuthorityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_certificate_authority::RestoreCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_certificate_authority::RestoreCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_certificate_authority::RestoreCertificateAuthorityOutput, crate::operation::restore_certificate_authority::RestoreCertificateAuthorityError, Self> {
