...
impl ListCertificateAuthoritiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_certificate_authorities::ListCertificateAuthorities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCertificateAuthorities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_certificate_authorities::de_list_certificate_authorities_http_response_with_props(status, headers, body)
        }
    }
}
