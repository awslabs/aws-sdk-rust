...
impl GetCertificateAuthorityCertificateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_certificate_authority_certificate::GetCertificateAuthorityCertificate,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_certificate_authority_certificate::GetCertificateAuthorityCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCertificateAuthorityCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_certificate_authority_certificate::de_get_certificate_authority_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
