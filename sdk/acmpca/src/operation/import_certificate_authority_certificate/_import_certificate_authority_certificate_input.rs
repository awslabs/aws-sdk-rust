...
impl ImportCertificateAuthorityCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::import_certificate_authority_certificate::ImportCertificateAuthorityCertificateInput, ::aws_smithy_http::operation::error::BuildError>{
