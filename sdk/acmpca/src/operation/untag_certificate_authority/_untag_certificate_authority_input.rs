...
impl UntagCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::untag_certificate_authority::UntagCertificateAuthorityInput, ::aws_smithy_types::error::operation::BuildError> {
