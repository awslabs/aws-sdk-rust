...
impl UntagCertificateAuthorityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::untag_certificate_authority::UntagCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::untag_certificate_authority::UntagCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::untag_certificate_authority::UntagCertificateAuthorityOutput, crate::operation::untag_certificate_authority::UntagCertificateAuthorityError, Self> {
