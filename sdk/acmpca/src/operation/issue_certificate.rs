...
impl IssueCertificateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::issue_certificate::IssueCertificate, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_issue_certificate::ser_issue_certificate_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for IssueCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_issue_certificate::de_issue_certificate_http_response_with_props(status, headers, body)
        }
    }
}
