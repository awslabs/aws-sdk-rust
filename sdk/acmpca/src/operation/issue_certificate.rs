...
impl IssueCertificateInput {
    /// Consumes the builder and constructs an Operation<[`IssueCertificate`](crate::operation::issue_certificate::IssueCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::issue_certificate::IssueCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::issue_certificate::IssueCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_issue_certificate::ser_issue_certificate_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::issue_certificate::IssueCertificate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for IssueCertificate {
                type Output = std::result::Result<crate::operation::issue_certificate::IssueCertificateOutput, crate::operation::issue_certificate::IssueCertificateError>;
