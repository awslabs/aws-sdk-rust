...
impl CreateCertificateAuthorityInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_certificate_authority::CreateCertificateAuthority::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_certificate_authority::de_create_certificate_authority_http_response_with_props(status, headers, body)
        }
    }
}
