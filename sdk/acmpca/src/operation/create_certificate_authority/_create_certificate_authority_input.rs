...
impl CreateCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_certificate_authority::CreateCertificateAuthorityInput, ::aws_smithy_types::error::operation::BuildError> {
