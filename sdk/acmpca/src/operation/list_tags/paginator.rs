...
/// Paginator for [`ListTags`](crate::operation::list_tags::ListTags)
                ...
                impl ListTagsPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_tags::ListTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_tags::ListTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
...
/// Flattened paginator for `ListTagsPaginator`
                    ...
                    impl ListTagsPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::Tag, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_tags::ListTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_tags_output_output_tags(page).unwrap_or_default().into_iter())
                        }
                    }
