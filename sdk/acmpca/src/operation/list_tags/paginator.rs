...
/// Paginator for [`ListTags`](crate::operation::list_tags::ListTags)
            ...
            impl ListTagsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_tags::ListTagsOutput, aws_smithy_http::result::SdkError<crate::operation::list_tags::ListTagsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListTagsPaginator`
                ...
                impl  ListTagsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::Tag, aws_smithy_http::result::SdkError<crate::operation::list_tags::ListTagsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_tags_output_tags(page).unwrap_or_default().into_iter())
                    }
                }
