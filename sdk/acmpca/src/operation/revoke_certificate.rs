...
impl RevokeCertificate {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ACM PCA", "RevokeCertificate", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeCertificateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("CertificateSerial") {
            if let ::std::option::Option::Some(value) = input.certificate_serial.as_deref() {
                captured.insert("CertificateSerial", value);
            }
        }
