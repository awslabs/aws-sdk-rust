...
impl TagCertificateAuthority {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ACM PCA", "TagCertificateAuthority", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ACM PCA.TagCertificateAuthority",
                "rpc.service" = "ACM PCA",
                "rpc.method" = "TagCertificateAuthority",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TagCertificateAuthority {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            TagCertificateAuthorityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            TagCertificateAuthorityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("TagCertificateAuthority")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TagCertificateAuthority")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                TagCertificateAuthorityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct TagCertificateAuthorityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TagCertificateAuthorityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<TagCertificateAuthorityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagCertificateAuthorityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_tag_certificate_authority::de_tag_certificate_authority_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_tag_certificate_authority::de_tag_certificate_authority_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagCertificateAuthorityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::tag_certificate_authority::TagCertificateAuthorityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_tag_certificate_authority::ser_tag_certificate_authority_input(&input)?,
        );
