...
/// Orchestration and serialization glue logic for `TagCertificateAuthority`.
...
impl TagCertificateAuthority {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::tag_certificate_authority::TagCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_certificate_authority::TagCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TagCertificateAuthority {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TagCertificateAuthority");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TagCertificateAuthorityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TagCertificateAuthorityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TagCertificateAuthority")
...
.with_interceptor(TagCertificateAuthorityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::tag_certificate_authority::TagCertificateAuthorityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::tag_certificate_authority::TagCertificateAuthorityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::tag_certificate_authority::TagCertificateAuthorityError>::new());
...
#[derive(Debug)]
            struct TagCertificateAuthorityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagCertificateAuthorityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_tag_certificate_authority::de_tag_certificate_authority_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_tag_certificate_authority::de_tag_certificate_authority_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct TagCertificateAuthorityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagCertificateAuthorityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::tag_certificate_authority::TagCertificateAuthorityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::tag_certificate_authority::TagCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_tag_certificate_authority::ser_tag_certificate_authority_input(&input)?);
...
#[derive(Debug)]
            struct TagCertificateAuthorityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TagCertificateAuthorityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TagCertificateAuthorityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TagCertificateAuthorityInput>()
                        .ok_or("failed to downcast to TagCertificateAuthorityInput")?;
...
pub enum TagCertificateAuthorityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TagCertificateAuthorityError) for what information is available for the error.")]
...
impl TagCertificateAuthorityError {
    /// Creates the `TagCertificateAuthorityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TagCertificateAuthorityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TagCertificateAuthorityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::tag_certificate_authority::TagCertificateAuthorityError {
