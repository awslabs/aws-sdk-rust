...
impl GetCertificateAuthorityCsrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrOutput, crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrError, Self> {
