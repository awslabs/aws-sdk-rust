...
impl CreateCertificateAuthorityAuditReport {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "ACM PCA",
            "rpc.method" = "CreateCertificateAuthorityAuditReport",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCertificateAuthorityAuditReport {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateCertificateAuthorityAuditReportRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateCertificateAuthorityAuditReportResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateCertificateAuthorityAuditReport")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCertificateAuthorityAuditReport")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateCertificateAuthorityAuditReportTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateCertificateAuthorityAuditReportTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCertificateAuthorityAuditReportTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateCertificateAuthorityAuditReportInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCertificateAuthorityAuditReportResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_certificate_authority_audit_report::de_create_certificate_authority_audit_report_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_certificate_authority_audit_report::de_create_certificate_authority_audit_report_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCertificateAuthorityAuditReportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_certificate_authority_audit_report::ser_create_certificate_authority_audit_report_input(&input)?,
        );
