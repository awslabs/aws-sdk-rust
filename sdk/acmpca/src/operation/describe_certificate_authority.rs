...
impl DescribeCertificateAuthorityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_certificate_authority::DescribeCertificateAuthority::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_certificate_authority::de_describe_certificate_authority_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeCertificateAuthorityError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_certificate_authority::DescribeCertificateAuthorityError
{
