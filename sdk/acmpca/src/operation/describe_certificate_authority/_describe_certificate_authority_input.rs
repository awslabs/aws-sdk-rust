...
impl DescribeCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_certificate_authority::DescribeCertificateAuthorityInput, ::aws_smithy_types::error::operation::BuildError> {
