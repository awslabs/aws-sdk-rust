...
impl GetCertificateAuthorityCsr {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "ACM PCA",
            "rpc.method" = "GetCertificateAuthorityCsr",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCertificateAuthorityCsr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCertificateAuthorityCsrRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetCertificateAuthorityCsrResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetCertificateAuthorityCsr")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCertificateAuthorityCsr")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCertificateAuthorityCsrTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetCertificateAuthorityCsrTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCertificateAuthorityCsrTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetCertificateAuthorityCsrInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCertificateAuthorityCsrResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_certificate_authority_csr::de_get_certificate_authority_csr_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_certificate_authority_csr::de_get_certificate_authority_csr_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCertificateAuthorityCsrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_certificate_authority_csr::ser_get_certificate_authority_csr_input(&input)?,
        );
