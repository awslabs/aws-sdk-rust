...
impl RevokeCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::revoke_certificate::RevokeCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_certificate::RevokeCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::revoke_certificate::RevokeCertificateOutput, crate::operation::revoke_certificate::RevokeCertificateError, Self> {
