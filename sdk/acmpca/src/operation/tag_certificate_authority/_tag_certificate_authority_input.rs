...
impl TagCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::tag_certificate_authority::TagCertificateAuthorityInput, ::aws_smithy_types::error::operation::BuildError> {
