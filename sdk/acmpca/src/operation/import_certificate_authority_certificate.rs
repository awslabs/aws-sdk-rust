...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportCertificateAuthorityCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_certificate_authority_certificate::de_import_certificate_authority_certificate_http_response_with_props(status, headers, body)
        }
    }
}
