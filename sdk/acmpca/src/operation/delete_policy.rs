...
impl DeletePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_policy::DeletePolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_policy::DeletePolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_policy::de_delete_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_policy::de_delete_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
