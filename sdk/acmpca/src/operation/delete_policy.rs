...
impl DeletePolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeletePolicy`](crate::operation::delete_policy::DeletePolicy)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_policy::DeletePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_policy::ser_delete_policy_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_policy::DeletePolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePolicy {
    type Output = ::std::result::Result<crate::operation::delete_policy::DeletePolicyOutput, crate::operation::delete_policy::DeletePolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_policy::de_delete_policy_http_response_with_props(status, headers, body)
        }
    }
}
