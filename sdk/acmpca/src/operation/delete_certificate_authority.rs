...
impl DeleteCertificateAuthorityInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_certificate_authority::DeleteCertificateAuthority::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_certificate_authority::de_delete_certificate_authority_http_response_with_props(status, headers, body)
        }
    }
}
