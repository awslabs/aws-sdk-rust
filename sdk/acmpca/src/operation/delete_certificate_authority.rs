...
impl DeleteCertificateAuthority {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_certificate_authority::DeleteCertificateAuthorityInput,
                    ) -> ::std::result::Result<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCertificateAuthority {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCertificateAuthority");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCertificateAuthorityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCertificateAuthorityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCertificateAuthority")
...
.with_interceptor(DeleteCertificateAuthorityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError>::new());
...
#[derive(Debug)]
            struct DeleteCertificateAuthorityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCertificateAuthorityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_certificate_authority::de_delete_certificate_authority_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_certificate_authority::de_delete_certificate_authority_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteCertificateAuthorityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCertificateAuthorityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_certificate_authority::DeleteCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_certificate_authority::ser_delete_certificate_authority_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCertificateAuthorityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCertificateAuthorityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCertificateAuthorityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCertificateAuthorityInput>()
                        .ok_or("failed to downcast to DeleteCertificateAuthorityInput")?;
...
pub enum DeleteCertificateAuthorityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCertificateAuthorityError) for what information is available for the error.")]
...
impl DeleteCertificateAuthorityError {
    /// Creates the `DeleteCertificateAuthorityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCertificateAuthorityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCertificateAuthorityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_certificate_authority::_delete_certificate_authority_output::DeleteCertificateAuthorityOutput;

pub use crate::operation::delete_certificate_authority::_delete_certificate_authority_input::DeleteCertificateAuthorityInput;

mod _delete_certificate_authority_input;

mod _delete_certificate_authority_output;
