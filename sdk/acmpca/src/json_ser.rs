...
pub fn serialize_structure_crate_input_create_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_certificate_authority_audit_report_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCertificateAuthorityAuditReportInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_12) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_12.as_str());
    }
    ...
    if let Some(var_14) = &input.audit_report_response_format {
        object.key("AuditReportResponseFormat").string(var_14.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_create_permission_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePermissionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_15) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_15.as_str());
    }
...
pub fn serialize_structure_crate_input_delete_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_21) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_21.as_str());
    }
    if let Some(var_22) = &input.permanent_deletion_time_in_days {
        object.key("PermanentDeletionTimeInDays").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_22).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_input_delete_permission_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeletePermissionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_23) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_23.as_str());
    }
...
pub fn serialize_structure_crate_input_describe_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_27) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_27.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_describe_certificate_authority_audit_report_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeCertificateAuthorityAuditReportInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_30) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_30.as_str());
    }
...
pub fn serialize_structure_crate_input_get_certificate_authority_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCertificateAuthorityCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_32) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_32.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_get_certificate_authority_csr_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCertificateAuthorityCsrInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_import_certificate_authority_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportCertificateAuthorityCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_35) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_35.as_str());
    }
    if let Some(var_36) = &input.certificate {
        object.key("Certificate").string_unchecked(&aws_smithy_types::base64::encode(var_36));
    }
    if let Some(var_37) = &input.certificate_chain {
        object.key("CertificateChain").string_unchecked(&aws_smithy_types::base64::encode(var_37));
    }
    Ok(())
}

pub fn serialize_structure_crate_input_issue_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::IssueCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_40) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_40.as_str());
    }
    if let Some(var_41) = &input.csr {
        object.key("Csr").string_unchecked(&aws_smithy_types::base64::encode(var_41));
    }
...
pub fn serialize_structure_crate_input_list_certificate_authorities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCertificateAuthoritiesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_permissions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPermissionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_52) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_52.as_str());
    }
...
pub fn serialize_structure_crate_input_list_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTagsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_55) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_55.as_str());
    }
...
pub fn serialize_structure_crate_input_restore_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RestoreCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_60) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_60.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_revoke_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RevokeCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_tag_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TagCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_64) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_64.as_str());
    }
...
pub fn serialize_structure_crate_input_untag_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UntagCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_69) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_69.as_str());
    }
...
pub fn serialize_structure_crate_input_update_certificate_authority_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCertificateAuthorityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_74) = &input.certificate_authority_arn {
        object.key("CertificateAuthorityArn").string(var_74.as_str());
    }
    if let Some(var_75) = &input.revocation_configuration {
        let mut object_76 = object.key("RevocationConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_revocation_configuration(&mut object_76, var_75)?;
        object_76.finish();
    }
...
pub fn serialize_structure_crate_model_certificate_authority_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CertificateAuthorityConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_revocation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RevocationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_api_passthrough(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ApiPassthrough) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_validity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Validity) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_94) = &input.value {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_94).into()));
    }
...
pub fn serialize_structure_crate_model_asn1_subject(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Asn1Subject) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_99) = &input.distinguished_name_qualifier {
        object.key("DistinguishedNameQualifier").string(var_99.as_str());
    }
        ...
        for item_112 in var_110 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_custom_attribute(&mut object_113, item_112)?;
                object_113.finish();
            }
        }
        array_111.finish();
...
pub fn serialize_structure_crate_model_csr_extensions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CsrExtensions) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_118 in var_116 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_access_description(&mut object_119, item_118)?;
                object_119.finish();
            }
        }
        array_117.finish();
...
pub fn serialize_structure_crate_model_crl_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CrlConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_120) = &input.enabled {
        object.key("Enabled").boolean(*var_120);
    }
    if let Some(var_121) = &input.expiration_in_days {
        object.key("ExpirationInDays").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_121).into()));
    }
...
pub fn serialize_structure_crate_model_ocsp_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OcspConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_extensions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Extensions) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_129 in var_127 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_policy_information(&mut object_130, item_129)?;
                object_130.finish();
            }
        }
        array_128.finish();
        ...
        for item_133 in var_131 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_extended_key_usage(&mut object_134, item_133)?;
                object_134.finish();
            }
        }
        array_132.finish();
        ...
        for item_139 in var_137 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_general_name(&mut object_140, item_139)?;
                object_140.finish();
            }
        }
        array_138.finish();
        ...
        for item_143 in var_141 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_custom_extension(&mut object_144, item_143)?;
                object_144.finish();
            }
        }
        array_142.finish();
...
pub fn serialize_structure_crate_model_custom_attribute(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomAttribute) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_key_usage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KeyUsage) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_access_description(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AccessDescription) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_policy_information(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PolicyInformation) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_154 in var_152 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_policy_qualifier_info(&mut object_155, item_154)?;
                object_155.finish();
            }
        }
        array_153.finish();
...
pub fn serialize_structure_crate_model_extended_key_usage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExtendedKeyUsage) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_157) = &input.extended_key_usage_object_identifier {
        object.key("ExtendedKeyUsageObjectIdentifier").string(var_157.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_general_name(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeneralName) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_166) = &input.uniform_resource_identifier {
        object.key("UniformResourceIdentifier").string(var_166.as_str());
    }
...
pub fn serialize_structure_crate_model_custom_extension(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomExtension) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_access_method(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AccessMethod) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_172) = &input.custom_object_identifier {
        object.key("CustomObjectIdentifier").string(var_172.as_str());
    }
...
pub fn serialize_structure_crate_model_policy_qualifier_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PolicyQualifierInfo) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_other_name(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OtherName) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_edi_party_name(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EdiPartyName) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_qualifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Qualifier) -> Result<(), aws_smithy_http::operation::SerializationError> {
