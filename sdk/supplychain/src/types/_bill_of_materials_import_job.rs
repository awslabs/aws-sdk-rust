...
impl BillOfMaterialsImportJobBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::BillOfMaterialsImportJob, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::BillOfMaterialsImportJob {
                instance_id: self.instance_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("instance_id", "instance_id was not specified but it is required when building BillOfMaterialsImportJob")
                    )?
                ,
                job_id: self.job_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("job_id", "job_id was not specified but it is required when building BillOfMaterialsImportJob")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building BillOfMaterialsImportJob")
                    )?
                ,
                s3_uri: self.s3_uri
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("s3_uri", "s3_uri was not specified but it is required when building BillOfMaterialsImportJob")
                    )?
                ,
