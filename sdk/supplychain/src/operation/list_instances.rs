...
impl ListInstances {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SupplyChain", "ListInstances", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.instance_name_filter {
                    {
                        for inner_4 in inner_3 {
                            query.push_kv("instanceNameFilter", &::aws_smithy_http::query::fmt_string(inner_4));
                        }
                    }
                }
