...
impl CreateBillOfMaterialsImportJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_bill_of_materials_import_job::CreateBillOfMaterialsImportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_bill_of_materials_import_job::CreateBillOfMaterialsImportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_bill_of_materials_import_job::CreateBillOfMaterialsImportJobOutput, crate::operation::create_bill_of_materials_import_job::CreateBillOfMaterialsImportJobError, Self> {
