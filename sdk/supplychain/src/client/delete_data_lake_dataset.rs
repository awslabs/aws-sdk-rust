...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::delete_data_lake_dataset::builders::DeleteDataLakeDatasetFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::delete_data_lake_dataset::builders::DeleteDataLakeDatasetFluentBuilder::set_namespace):<br>required: **true**<br><p>The name space of the dataset. The available values are:</p> <ul>  <li>   <p><b>asc</b> - For information on the Amazon Web Services Supply Chain supported datasets see <a href="https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html">https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html</a>.</p></li>  <li>   <p><b>default</b> - For datasets with custom user-defined schemas.</p></li> </ul><br>
    ///   - [`name(impl Into<String>)`](crate::operation::delete_data_lake_dataset::builders::DeleteDataLakeDatasetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_data_lake_dataset::builders::DeleteDataLakeDatasetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the dataset. For <b>asc</b> name space, the name must be one of the supported data entities under <a href="https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html">https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html</a>.</p><br>
    ...
    ///   - [`namespace(String)`](crate::operation::delete_data_lake_dataset::DeleteDataLakeDatasetOutput::namespace): <p>The name space of deleted dataset.</p>
