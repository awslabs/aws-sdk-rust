...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::delete_instance::builders::DeleteInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::delete_instance::builders::DeleteInstanceFluentBuilder::set_instance_id):<br>required: **true**<br><p>The AWS Supply Chain instance identifier.</p><br>
    /// - On success, responds with [`DeleteInstanceOutput`](crate::operation::delete_instance::DeleteInstanceOutput) with field(s):
    ///   - [`instance(Option<Instance>)`](crate::operation::delete_instance::DeleteInstanceOutput::instance): <p>The AWS Supply Chain instance resource data details.</p>
