...
pub(crate) fn de_activity_type_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ActivityTypeConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
