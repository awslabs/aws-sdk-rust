...
pub(crate) fn de_workflow_execution_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowExecutionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
