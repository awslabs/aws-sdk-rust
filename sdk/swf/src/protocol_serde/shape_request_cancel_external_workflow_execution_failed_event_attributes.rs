...
pub(crate) fn de_request_cancel_external_workflow_execution_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RequestCancelExternalWorkflowExecutionFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
