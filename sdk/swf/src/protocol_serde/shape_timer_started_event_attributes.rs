...
pub(crate) fn de_timer_started_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimerStartedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
