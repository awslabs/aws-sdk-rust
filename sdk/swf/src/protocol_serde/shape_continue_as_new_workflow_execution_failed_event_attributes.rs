...
pub(crate) fn de_continue_as_new_workflow_execution_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContinueAsNewWorkflowExecutionFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
