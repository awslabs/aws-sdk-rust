...
) -> Result<Option<crate::types::WorkflowExecutionStartedEventAttributes>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "parentWorkflowExecution" => {
                            builder = builder
                                .set_parent_workflow_execution(crate::protocol_serde::shape_workflow_execution::de_workflow_execution(tokens)?);
                        }
