...
pub(crate) fn de_start_child_workflow_execution_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StartChildWorkflowExecutionFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
