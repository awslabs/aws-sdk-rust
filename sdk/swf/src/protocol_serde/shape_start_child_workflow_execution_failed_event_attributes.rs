...
) -> Result<Option<crate::types::StartChildWorkflowExecutionFailedEventAttributes>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        "cause" => {
                            builder = builder.set_cause(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::StartChildWorkflowExecutionFailedCause::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
            ...
            Ok(Some(
                crate::serde_util::start_child_workflow_execution_failed_event_attributes_correct_errors(builder)
                    .build()
