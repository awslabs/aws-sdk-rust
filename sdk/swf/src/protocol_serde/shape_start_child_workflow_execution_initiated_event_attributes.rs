...
pub(crate) fn de_start_child_workflow_execution_initiated_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StartChildWorkflowExecutionInitiatedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
