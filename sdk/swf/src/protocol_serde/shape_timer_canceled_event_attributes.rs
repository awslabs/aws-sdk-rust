...
pub(crate) fn de_timer_canceled_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimerCanceledEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
