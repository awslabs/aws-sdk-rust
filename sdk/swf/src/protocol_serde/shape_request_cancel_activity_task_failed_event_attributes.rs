...
pub(crate) fn de_request_cancel_activity_task_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RequestCancelActivityTaskFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
