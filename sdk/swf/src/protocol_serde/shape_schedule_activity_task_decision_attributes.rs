...
pub fn ser_schedule_activity_task_decision_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduleActivityTaskDecisionAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
