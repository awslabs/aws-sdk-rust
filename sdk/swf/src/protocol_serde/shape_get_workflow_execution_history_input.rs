...
pub fn ser_get_workflow_execution_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetWorkflowExecutionHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
