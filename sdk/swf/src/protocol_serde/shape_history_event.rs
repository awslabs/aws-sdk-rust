...
pub(crate) fn de_history_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HistoryEvent>, aws_smithy_json::deserialize::error::DeserializeError>
