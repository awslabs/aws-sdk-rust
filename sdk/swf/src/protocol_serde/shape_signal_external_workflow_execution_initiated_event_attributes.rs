...
pub(crate) fn de_signal_external_workflow_execution_initiated_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SignalExternalWorkflowExecutionInitiatedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
