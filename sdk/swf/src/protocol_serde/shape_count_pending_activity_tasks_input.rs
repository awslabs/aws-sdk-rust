...
pub fn ser_count_pending_activity_tasks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CountPendingActivityTasksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
