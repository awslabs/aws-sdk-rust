...
pub fn ser_signal_external_workflow_execution_decision_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SignalExternalWorkflowExecutionDecisionAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
