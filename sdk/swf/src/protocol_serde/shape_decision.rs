...
pub fn ser_decision(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Decision) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
