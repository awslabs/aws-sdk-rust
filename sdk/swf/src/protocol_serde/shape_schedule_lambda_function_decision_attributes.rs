...
pub fn ser_schedule_lambda_function_decision_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduleLambdaFunctionDecisionAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
