...
pub(crate) fn de_start_timer_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StartTimerFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
