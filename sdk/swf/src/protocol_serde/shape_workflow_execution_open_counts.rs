...
pub(crate) fn de_workflow_execution_open_counts<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowExecutionOpenCounts>, aws_smithy_json::deserialize::error::DeserializeError>
