...
pub fn ser_register_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
