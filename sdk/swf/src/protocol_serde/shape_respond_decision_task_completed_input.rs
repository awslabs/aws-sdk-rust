...
pub fn ser_respond_decision_task_completed_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RespondDecisionTaskCompletedInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
