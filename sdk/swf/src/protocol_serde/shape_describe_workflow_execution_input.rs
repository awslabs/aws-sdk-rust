...
pub fn ser_describe_workflow_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeWorkflowExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
