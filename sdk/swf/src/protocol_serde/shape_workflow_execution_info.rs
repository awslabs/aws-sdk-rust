            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "execution" => {
                            builder = builder.set_execution(crate::protocol_serde::shape_workflow_execution::de_workflow_execution(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "parent" => {
                            builder = builder.set_parent(crate::protocol_serde::shape_workflow_execution::de_workflow_execution(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
