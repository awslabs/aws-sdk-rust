...
pub(crate) fn de_workflow_execution_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowExecutionInfo>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "closeStatus" => {
                                builder = builder.set_close_status(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::CloseStatus::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
