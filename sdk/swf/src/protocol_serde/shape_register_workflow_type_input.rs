...
pub fn ser_register_workflow_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterWorkflowTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
