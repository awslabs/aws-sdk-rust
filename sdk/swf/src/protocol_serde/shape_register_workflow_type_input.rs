...
pub fn ser_register_workflow_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::register_workflow_type::RegisterWorkflowTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
