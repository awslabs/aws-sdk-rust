...
pub(crate) fn de_workflow_type_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowTypeConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
