        ...
        "OperationNotPermittedFault" => {
            crate::error::ListDomainsError::OperationNotPermittedFault({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_operation_not_permitted_fault::de_operation_not_permitted_fault_json_err(response.body().as_ref(), output).map_err(crate::error::ListDomainsError::unhandled)?;
