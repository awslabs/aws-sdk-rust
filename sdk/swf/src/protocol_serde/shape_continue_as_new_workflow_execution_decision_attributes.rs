...
pub fn ser_continue_as_new_workflow_execution_decision_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContinueAsNewWorkflowExecutionDecisionAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
