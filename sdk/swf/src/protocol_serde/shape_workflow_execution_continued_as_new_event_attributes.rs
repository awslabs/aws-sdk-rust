...
pub(crate) fn de_workflow_execution_continued_as_new_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowExecutionContinuedAsNewEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
