...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_workflow_execution::DescribeWorkflowExecutionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_workflow_execution::DescribeWorkflowExecutionError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_workflow_execution::de_describe_workflow_execution(_response_body, output)
            .map_err(crate::operation::describe_workflow_execution::DescribeWorkflowExecutionError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "executionConfiguration" => {
                    builder = builder.set_execution_configuration(
                        crate::protocol_serde::shape_workflow_execution_configuration::de_workflow_execution_configuration(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "openCounts" => {
                    builder = builder.set_open_counts(
                        crate::protocol_serde::shape_workflow_execution_open_counts::de_workflow_execution_open_counts(tokens, _value, depth + 1)?,
                    );
                }
