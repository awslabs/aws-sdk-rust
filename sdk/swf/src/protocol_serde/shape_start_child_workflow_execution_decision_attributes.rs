...
pub fn ser_start_child_workflow_execution_decision_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StartChildWorkflowExecutionDecisionAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
