...
pub(crate) fn de_signal_external_workflow_execution_failed_event_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SignalExternalWorkflowExecutionFailedEventAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
