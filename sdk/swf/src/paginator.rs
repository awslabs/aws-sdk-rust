        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_get_workflow_execution_history_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_list_activity_types_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_list_closed_workflow_executions_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_list_domains_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_list_open_workflow_executions_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_list_workflow_types_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_page_token = crate::lens::reflens_structure_crate_output_poll_for_decision_task_output_next_page_token(resp).cloned();
                            input.next_page_token.is_none()
                        }
                        Err(_) => true,
                    };
