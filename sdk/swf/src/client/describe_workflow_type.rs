...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::set_domain):<br>required: **true**<br><p>The name of the domain in which this workflow type is registered.</p><br>
    ///   - [`workflow_type(WorkflowType)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::workflow_type) / [`set_workflow_type(Option<WorkflowType>)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::set_workflow_type):<br>required: **true**<br><p>The workflow type to describe.</p><br>
