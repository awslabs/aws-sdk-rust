...
impl super::Client {
    ...
    ///   - [`maximum_page_size(i32)`](crate::operation::list_domains::builders::ListDomainsFluentBuilder::maximum_page_size) / [`set_maximum_page_size(Option<i32>)`](crate::operation::list_domains::builders::ListDomainsFluentBuilder::set_maximum_page_size): <p>The maximum number of results that are returned per call. Use <code>nextPageToken</code> to obtain further pages of results. </p>
    ///   - [`reverse_order(bool)`](crate::operation::list_domains::builders::ListDomainsFluentBuilder::reverse_order) / [`set_reverse_order(Option<bool>)`](crate::operation::list_domains::builders::ListDomainsFluentBuilder::set_reverse_order): <p>When set to <code>true</code>, returns the results in reverse order. By default, the results are returned in ascending alphabetical order by <code>name</code> of the domains.</p>
