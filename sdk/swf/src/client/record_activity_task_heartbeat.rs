...
impl super::Client {
    ...
    ///   - [`task_token(impl Into<String>)`](crate::operation::record_activity_task_heartbeat::builders::RecordActivityTaskHeartbeatFluentBuilder::task_token) / [`set_task_token(Option<String>)`](crate::operation::record_activity_task_heartbeat::builders::RecordActivityTaskHeartbeatFluentBuilder::set_task_token):<br>required: **true**<br><p>The <code>taskToken</code> of the <code>ActivityTask</code>.</p><important>  <p><code>taskToken</code> is generated by the service and should be treated as an opaque value. If the task is passed to another process, its <code>taskToken</code> must also be passed. This enables it to provide its progress and respond with results.</p> </important><br>
    ///   - [`details(impl Into<String>)`](crate::operation::record_activity_task_heartbeat::builders::RecordActivityTaskHeartbeatFluentBuilder::details) / [`set_details(Option<String>)`](crate::operation::record_activity_task_heartbeat::builders::RecordActivityTaskHeartbeatFluentBuilder::set_details):<br>required: **false**<br><p>If specified, contains details about the progress of the task.</p><br>
