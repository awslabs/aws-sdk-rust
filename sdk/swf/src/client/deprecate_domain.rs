...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::deprecate_domain::builders::DeprecateDomainFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::deprecate_domain::builders::DeprecateDomainFluentBuilder::set_name):<br>required: **true**<br><p>The name of the domain to deprecate.</p><br>
