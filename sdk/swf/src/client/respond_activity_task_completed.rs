...
impl super::Client {
    ...
    ///   - [`task_token(impl Into<String>)`](crate::operation::respond_activity_task_completed::builders::RespondActivityTaskCompletedFluentBuilder::task_token) / [`set_task_token(Option<String>)`](crate::operation::respond_activity_task_completed::builders::RespondActivityTaskCompletedFluentBuilder::set_task_token):<br>required: **true**<br><p>The <code>taskToken</code> of the <code>ActivityTask</code>.</p><important>  <p><code>taskToken</code> is generated by the service and should be treated as an opaque value. If the task is passed to another process, its <code>taskToken</code> must also be passed. This enables it to provide its progress and respond with results.</p> </important><br>
    ///   - [`result(impl Into<String>)`](crate::operation::respond_activity_task_completed::builders::RespondActivityTaskCompletedFluentBuilder::result) / [`set_result(Option<String>)`](crate::operation::respond_activity_task_completed::builders::RespondActivityTaskCompletedFluentBuilder::set_result):<br>required: **false**<br><p>The result of the activity task. It is a free form string that is implementation specific.</p><br>
