...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::poll_for_activity_task::builders::PollForActivityTaskFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::poll_for_activity_task::builders::PollForActivityTaskFluentBuilder::set_domain): <p>The name of the domain that contains the task lists being polled.</p>
    ...
    ///   - [`identity(impl ::std::convert::Into<String>)`](crate::operation::poll_for_activity_task::builders::PollForActivityTaskFluentBuilder::identity) / [`set_identity(Option<String>)`](crate::operation::poll_for_activity_task::builders::PollForActivityTaskFluentBuilder::set_identity): <p>Identity of the worker making the request, recorded in the <code>ActivityTaskStarted</code> event in the workflow history. This enables diagnostic tracing when problems arise. The form of this identity is user defined.</p>
