...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::request_cancel_workflow_execution::builders::RequestCancelWorkflowExecutionFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::request_cancel_workflow_execution::builders::RequestCancelWorkflowExecutionFluentBuilder::set_domain): <p>The name of the domain containing the workflow execution to cancel.</p>
    ///   - [`workflow_id(impl ::std::convert::Into<String>)`](crate::operation::request_cancel_workflow_execution::builders::RequestCancelWorkflowExecutionFluentBuilder::workflow_id) / [`set_workflow_id(Option<String>)`](crate::operation::request_cancel_workflow_execution::builders::RequestCancelWorkflowExecutionFluentBuilder::set_workflow_id): <p>The workflowId of the workflow execution to cancel.</p>
