...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::set_domain): <p>The name of the domain in which the activity type is registered.</p>
