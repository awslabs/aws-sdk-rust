...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::set_domain):<br>required: **true**<br><p>The name of the domain in which the activity type is registered.</p><br>
    ///   - [`activity_type(ActivityType)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::activity_type) / [`set_activity_type(Option<ActivityType>)`](crate::operation::describe_activity_type::builders::DescribeActivityTypeFluentBuilder::set_activity_type):<br>required: **true**<br><p>The activity type to get information about. Activity types are identified by the <code>name</code> and <code>version</code> that were supplied when the activity was registered.</p><br>
