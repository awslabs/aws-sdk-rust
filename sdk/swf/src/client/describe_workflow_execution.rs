...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::describe_workflow_execution::builders::DescribeWorkflowExecutionFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_workflow_execution::builders::DescribeWorkflowExecutionFluentBuilder::set_domain):<br>required: **true**<br><p>The name of the domain containing the workflow execution.</p><br>
    ///   - [`execution(WorkflowExecution)`](crate::operation::describe_workflow_execution::builders::DescribeWorkflowExecutionFluentBuilder::execution) / [`set_execution(Option<WorkflowExecution>)`](crate::operation::describe_workflow_execution::builders::DescribeWorkflowExecutionFluentBuilder::set_execution):<br>required: **true**<br><p>The workflow execution to describe.</p><br>
