        ...
        ::std::result::Result::Ok(
            crate::types::StartTimerFailedEventAttributes {
                timer_id: self.timer_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("timer_id", "timer_id was not specified but it is required when building StartTimerFailedEventAttributes")
                    )?
                ,
                cause: self.cause
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("cause", "cause was not specified but it is required when building StartTimerFailedEventAttributes")
                    )?
                ,
