...
impl CancelWorkflowExecutionFailedEventAttributesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CancelWorkflowExecutionFailedEventAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CancelWorkflowExecutionFailedEventAttributes {
                cause: self.cause
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("cause", "cause was not specified but it is required when building CancelWorkflowExecutionFailedEventAttributes")
                    )?
                ,
