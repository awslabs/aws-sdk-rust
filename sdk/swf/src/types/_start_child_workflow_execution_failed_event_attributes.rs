...
impl StartChildWorkflowExecutionFailedEventAttributesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::StartChildWorkflowExecutionFailedEventAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::StartChildWorkflowExecutionFailedEventAttributes {
                ...
                cause: self.cause
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("cause", "cause was not specified but it is required when building StartChildWorkflowExecutionFailedEventAttributes")
                    )?
                ,
                workflow_id: self.workflow_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workflow_id", "workflow_id was not specified but it is required when building StartChildWorkflowExecutionFailedEventAttributes")
                    )?
                ,
