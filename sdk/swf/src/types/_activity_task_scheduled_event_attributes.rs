...
impl ActivityTaskScheduledEventAttributesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ActivityTaskScheduledEventAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ActivityTaskScheduledEventAttributes {
                ...
                activity_id: self.activity_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("activity_id", "activity_id was not specified but it is required when building ActivityTaskScheduledEventAttributes")
                    )?
                ,
                input: self.input
                ,
