        ...
        ::std::result::Result::Ok(
            crate::types::RecordMarkerFailedEventAttributes {
                marker_name: self.marker_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("marker_name", "marker_name was not specified but it is required when building RecordMarkerFailedEventAttributes")
                    )?
                ,
                cause: self.cause
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("cause", "cause was not specified but it is required when building RecordMarkerFailedEventAttributes")
                    )?
                ,
