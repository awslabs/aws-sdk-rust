...
other => SignalExternalWorkflowExecutionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
...
SignalExternalWorkflowExecutionFailedCause::SignalExternalWorkflowExecutionRateExceeded => write!(f, "SIGNAL_EXTERNAL_WORKFLOW_EXECUTION_RATE_EXCEEDED"),
