...
impl RequestCancelExternalWorkflowExecutionFailedEventAttributes {
    ...
    pub fn cause(
        &self,
    ) -> std::option::Option<&crate::types::RequestCancelExternalWorkflowExecutionFailedCause> {
        self.cause.as_ref()
    }
    /// <p>The ID of the <code>RequestCancelExternalWorkflowExecutionInitiated</code> event corresponding to the <code>RequestCancelExternalWorkflowExecution</code> decision to cancel this external workflow execution. This information can be useful for diagnosing problems by tracing back the chain of events leading up to this event.</p>
...
impl RequestCancelExternalWorkflowExecutionFailedEventAttributesBuilder {
    ...
    pub fn cause(
        mut self,
        input: crate::types::RequestCancelExternalWorkflowExecutionFailedCause,
    ) -> Self {
    ...
    pub fn set_cause(
        mut self,
        input: std::option::Option<crate::types::RequestCancelExternalWorkflowExecutionFailedCause>,
    ) -> Self {
        self.cause = input;
        self
    }
