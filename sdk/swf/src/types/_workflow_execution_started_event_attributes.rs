...
impl WorkflowExecutionStartedEventAttributesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::WorkflowExecutionStartedEventAttributes, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::WorkflowExecutionStartedEventAttributes {
                ...
                child_policy: self.child_policy
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("child_policy", "child_policy was not specified but it is required when building WorkflowExecutionStartedEventAttributes")
                    )?
                ,
