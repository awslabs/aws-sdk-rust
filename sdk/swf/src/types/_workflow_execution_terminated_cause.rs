...
impl ::std::convert::From<&str> for WorkflowExecutionTerminatedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkflowExecutionTerminatedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkflowExecutionTerminatedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkflowExecutionTerminatedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkflowExecutionTerminatedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
