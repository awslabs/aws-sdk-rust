...
impl SignalExternalWorkflowExecutionFailedEventAttributes {
    ...
    pub fn cause(
        &self,
    ) -> std::option::Option<&crate::types::SignalExternalWorkflowExecutionFailedCause> {
        self.cause.as_ref()
    }
    /// <p>The ID of the <code>SignalExternalWorkflowExecutionInitiated</code> event corresponding to the <code>SignalExternalWorkflowExecution</code> decision to request this signal. This information can be useful for diagnosing problems by tracing back the chain of events leading up to this event.</p>
...
impl SignalExternalWorkflowExecutionFailedEventAttributesBuilder {
    ...
    pub fn cause(
        mut self,
        input: crate::types::SignalExternalWorkflowExecutionFailedCause,
    ) -> Self {
    ...
    pub fn set_cause(
        mut self,
        input: std::option::Option<crate::types::SignalExternalWorkflowExecutionFailedCause>,
    ) -> Self {
        self.cause = input;
        self
    }
