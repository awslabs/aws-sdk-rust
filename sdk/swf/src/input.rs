...
impl RegisterActivityTypeInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_activity_type::ser_register_activity_type_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
pub mod deprecate_domain_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::DeprecateDomainInput, aws_smithy_http::operation::error::BuildError>
        {
