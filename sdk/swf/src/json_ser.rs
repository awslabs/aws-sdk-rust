...
pub fn serialize_structure_count_closed_workflow_executions_input(
    ...
    if let Some(var_2) = &input.start_time_filter {
        ...
        crate::json_ser::serialize_structure_execution_time_filter(&mut object_3, var_2);
        object_3.finish();
    }
    if let Some(var_4) = &input.close_time_filter {
        let mut object_5 = object.key("closeTimeFilter").start_object();
        crate::json_ser::serialize_structure_execution_time_filter(&mut object_5, var_4);
        object_5.finish();
    }
    if let Some(var_6) = &input.execution_filter {
        let mut object_7 = object.key("executionFilter").start_object();
        crate::json_ser::serialize_structure_workflow_execution_filter(&mut object_7, var_6);
        object_7.finish();
    }
    if let Some(var_8) = &input.type_filter {
        let mut object_9 = object.key("typeFilter").start_object();
        crate::json_ser::serialize_structure_workflow_type_filter(&mut object_9, var_8);
        object_9.finish();
    }
    if let Some(var_10) = &input.tag_filter {
        let mut object_11 = object.key("tagFilter").start_object();
        crate::json_ser::serialize_structure_tag_filter(&mut object_11, var_10);
        object_11.finish();
    }
    if let Some(var_12) = &input.close_status_filter {
        let mut object_13 = object.key("closeStatusFilter").start_object();
        crate::json_ser::serialize_structure_close_status_filter(&mut object_13, var_12);
        object_13.finish();
    }
}

pub fn serialize_structure_count_open_workflow_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_15) = &input.start_time_filter {
        ...
        crate::json_ser::serialize_structure_execution_time_filter(&mut object_16, var_15);
        object_16.finish();
    }
    if let Some(var_17) = &input.type_filter {
        let mut object_18 = object.key("typeFilter").start_object();
        crate::json_ser::serialize_structure_workflow_type_filter(&mut object_18, var_17);
        object_18.finish();
    }
    if let Some(var_19) = &input.tag_filter {
        let mut object_20 = object.key("tagFilter").start_object();
        crate::json_ser::serialize_structure_tag_filter(&mut object_20, var_19);
        object_20.finish();
    }
    if let Some(var_21) = &input.execution_filter {
        let mut object_22 = object.key("executionFilter").start_object();
        crate::json_ser::serialize_structure_workflow_execution_filter(&mut object_22, var_21);
        object_22.finish();
    }
}

pub fn serialize_structure_count_pending_activity_tasks_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_24) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_25, var_24);
        object_25.finish();
    }
}

pub fn serialize_structure_count_pending_decision_tasks_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_27) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_28, var_27);
        object_28.finish();
    }
}

pub fn serialize_structure_deprecate_activity_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_30) = &input.activity_type {
        ...
        crate::json_ser::serialize_structure_activity_type(&mut object_31, var_30);
        object_31.finish();
    }
}

pub fn serialize_structure_deprecate_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deprecate_workflow_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_34) = &input.workflow_type {
        ...
        crate::json_ser::serialize_structure_workflow_type(&mut object_35, var_34);
        object_35.finish();
    }
}

pub fn serialize_structure_describe_activity_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_37) = &input.activity_type {
        ...
        crate::json_ser::serialize_structure_activity_type(&mut object_38, var_37);
        object_38.finish();
    }
}
...
pub fn serialize_structure_describe_workflow_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_41) = &input.execution {
        ...
        crate::json_ser::serialize_structure_workflow_execution(&mut object_42, var_41);
        object_42.finish();
    }
}

pub fn serialize_structure_describe_workflow_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_44) = &input.workflow_type {
        ...
        crate::json_ser::serialize_structure_workflow_type(&mut object_45, var_44);
        object_45.finish();
    }
}

pub fn serialize_structure_get_workflow_execution_history_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_47) = &input.execution {
        ...
        crate::json_ser::serialize_structure_workflow_execution(&mut object_48, var_47);
        object_48.finish();
    }
    ...
    if input.maximum_page_size != 0 {
        object.key("maximumPageSize").number(
            ...
            smithy_types::Number::NegInt((input.maximum_page_size).into()),
        );
    }
...
pub fn serialize_structure_list_activity_types_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_closed_workflow_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_open_workflow_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_71) = &input.start_time_filter {
        ...
        crate::json_ser::serialize_structure_execution_time_filter(&mut object_72, var_71);
        object_72.finish();
    }
    if let Some(var_73) = &input.type_filter {
        let mut object_74 = object.key("typeFilter").start_object();
        crate::json_ser::serialize_structure_workflow_type_filter(&mut object_74, var_73);
        object_74.finish();
    }
    if let Some(var_75) = &input.tag_filter {
        let mut object_76 = object.key("tagFilter").start_object();
        crate::json_ser::serialize_structure_tag_filter(&mut object_76, var_75);
        object_76.finish();
    }
    ...
    if let Some(var_78) = &input.execution_filter {
        ...
        crate::json_ser::serialize_structure_workflow_execution_filter(&mut object_79, var_78);
        object_79.finish();
    }
}
...
pub fn serialize_structure_list_workflow_types_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_poll_for_activity_task_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_86) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_87, var_86);
        object_87.finish();
    }
...
pub fn serialize_structure_poll_for_decision_task_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_90) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_91, var_90);
        object_91.finish();
    }
...
pub fn serialize_structure_record_activity_task_heartbeat_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_register_activity_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_102) = &input.default_task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_103, var_102);
        object_103.finish();
    }
...
pub fn serialize_structure_register_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_112 in var_110 {
            {
                ...
                crate::json_ser::serialize_structure_resource_tag(&mut object_113, item_112);
                object_113.finish();
            }
        }
        array_111.finish();
...
pub fn serialize_structure_register_workflow_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_120) = &input.default_task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_121, var_120);
        object_121.finish();
    }
...
pub fn serialize_structure_request_cancel_workflow_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_respond_activity_task_canceled_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_respond_activity_task_completed_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_respond_activity_task_failed_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_respond_decision_task_completed_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_138 in var_136 {
            {
                ...
                crate::json_ser::serialize_structure_decision(&mut object_139, item_138);
                object_139.finish();
            }
        }
        array_137.finish();
...
pub fn serialize_structure_signal_workflow_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_workflow_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_148) = &input.workflow_type {
        ...
        crate::json_ser::serialize_structure_workflow_type(&mut object_149, var_148);
        object_149.finish();
    }
    if let Some(var_150) = &input.task_list {
        let mut object_151 = object.key("taskList").start_object();
        crate::json_ser::serialize_structure_task_list(&mut object_151, var_150);
        object_151.finish();
    }
        ...
        for item_164 in var_162 {
            {
                ...
                crate::json_ser::serialize_structure_resource_tag(&mut object_165, item_164);
                object_165.finish();
            }
        }
        array_163.finish();
...
pub fn serialize_structure_terminate_workflow_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_undeprecate_activity_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_173) = &input.activity_type {
        ...
        crate::json_ser::serialize_structure_activity_type(&mut object_174, var_173);
        object_174.finish();
    }
}

pub fn serialize_structure_undeprecate_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_undeprecate_workflow_type_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_177) = &input.workflow_type {
        ...
        crate::json_ser::serialize_structure_workflow_type(&mut object_178, var_177);
        object_178.finish();
    }
}
...
pub fn serialize_structure_execution_time_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_183) = &input.oldest_date {
        object
            .key("oldestDate")
            .instant(var_183, smithy_types::instant::Format::EpochSeconds);
    }
...
pub fn serialize_structure_workflow_execution_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_workflow_type_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_close_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_task_list(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_activity_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_workflow_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_workflow_execution(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_decision(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_200) = &input.schedule_activity_task_decision_attributes {
        let mut object_201 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_schedule_activity_task_decision_attributes(
            &mut object_201,
            var_200,
        );
        object_201.finish();
    ...
    if let Some(var_202) = &input.request_cancel_activity_task_decision_attributes {
        let mut object_203 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_request_cancel_activity_task_decision_attributes(
            &mut object_203,
            var_202,
        );
        object_203.finish();
    ...
    if let Some(var_204) = &input.complete_workflow_execution_decision_attributes {
        let mut object_205 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_complete_workflow_execution_decision_attributes(
            &mut object_205,
            var_204,
        );
        object_205.finish();
    ...
    if let Some(var_206) = &input.fail_workflow_execution_decision_attributes {
        let mut object_207 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_fail_workflow_execution_decision_attributes(
            &mut object_207,
            var_206,
        );
        object_207.finish();
    ...
    if let Some(var_208) = &input.cancel_workflow_execution_decision_attributes {
        let mut object_209 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_cancel_workflow_execution_decision_attributes(
            &mut object_209,
            var_208,
        );
        object_209.finish();
    ...
    if let Some(var_210) = &input.continue_as_new_workflow_execution_decision_attributes {
        let mut object_211 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_continue_as_new_workflow_execution_decision_attributes(
            &mut object_211,
            var_210,
        );
        object_211.finish();
    ...
    if let Some(var_212) = &input.record_marker_decision_attributes {
        ...
        crate::json_ser::serialize_structure_record_marker_decision_attributes(
            &mut object_213,
            var_212,
        );
        object_213.finish();
    ...
    if let Some(var_214) = &input.start_timer_decision_attributes {
        ...
        crate::json_ser::serialize_structure_start_timer_decision_attributes(
            &mut object_215,
            var_214,
        );
        object_215.finish();
    ...
    if let Some(var_216) = &input.cancel_timer_decision_attributes {
        ...
        crate::json_ser::serialize_structure_cancel_timer_decision_attributes(
            &mut object_217,
            var_216,
        );
        object_217.finish();
    ...
    if let Some(var_218) = &input.signal_external_workflow_execution_decision_attributes {
        let mut object_219 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_signal_external_workflow_execution_decision_attributes(
            &mut object_219,
            var_218,
        );
        object_219.finish();
    ...
    if let Some(var_220) = &input.request_cancel_external_workflow_execution_decision_attributes {
        let mut object_221 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_request_cancel_external_workflow_execution_decision_attributes(&mut object_221, var_220);
        object_221.finish();
    }
    if let Some(var_222) = &input.start_child_workflow_execution_decision_attributes {
        let mut object_223 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_start_child_workflow_execution_decision_attributes(
            &mut object_223,
            var_222,
        );
        object_223.finish();
    ...
    if let Some(var_224) = &input.schedule_lambda_function_decision_attributes {
        let mut object_225 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_schedule_lambda_function_decision_attributes(
            &mut object_225,
            var_224,
        );
        object_225.finish();
...
pub fn serialize_structure_schedule_activity_task_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_226) = &input.activity_type {
        ...
        crate::json_ser::serialize_structure_activity_type(&mut object_227, var_226);
        object_227.finish();
    }
    ...
    if let Some(var_232) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_233, var_232);
        object_233.finish();
    }
...
pub fn serialize_structure_request_cancel_activity_task_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_complete_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_fail_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cancel_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_continue_as_new_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_245) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_246, var_245);
        object_246.finish();
    }
...
pub fn serialize_structure_record_marker_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_timer_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cancel_timer_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_signal_external_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_request_cancel_external_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_child_workflow_execution_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_269) = &input.workflow_type {
        ...
        crate::json_ser::serialize_structure_workflow_type(&mut object_270, var_269);
        object_270.finish();
    }
    ...
    if let Some(var_275) = &input.task_list {
        ...
        crate::json_ser::serialize_structure_task_list(&mut object_276, var_275);
        object_276.finish();
    }
...
pub fn serialize_structure_schedule_lambda_function_decision_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
