...
impl RespondActivityTaskCanceledInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledInput, ::aws_smithy_types::error::operation::BuildError> {
