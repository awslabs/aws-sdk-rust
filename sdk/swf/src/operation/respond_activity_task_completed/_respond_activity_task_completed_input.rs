...
impl RespondActivityTaskCompletedInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedInput, ::aws_smithy_types::error::operation::BuildError> {
