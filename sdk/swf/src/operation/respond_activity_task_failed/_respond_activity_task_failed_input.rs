...
impl RespondActivityTaskFailedInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::respond_activity_task_failed::RespondActivityTaskFailedInput, ::aws_smithy_types::error::operation::BuildError> {
