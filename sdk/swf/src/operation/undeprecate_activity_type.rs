...
impl UndeprecateActivityTypeInput {
    /// Consumes the builder and constructs an Operation<[`UndeprecateActivityType`](crate::operation::undeprecate_activity_type::UndeprecateActivityType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::undeprecate_activity_type::UndeprecateActivityType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::undeprecate_activity_type::UndeprecateActivityTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_undeprecate_activity_type::ser_undeprecate_activity_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::undeprecate_activity_type::UndeprecateActivityType::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UndeprecateActivityType {
                type Output = std::result::Result<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeOutput, crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_undeprecate_activity_type::de_undeprecate_activity_type_http_error(response)
                     } else {
                        crate::protocol_serde::shape_undeprecate_activity_type::de_undeprecate_activity_type_http_response(response)
                     }
                }
            }
