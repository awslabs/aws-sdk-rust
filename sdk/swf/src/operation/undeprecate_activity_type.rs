...
impl UndeprecateActivityType {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::undeprecate_activity_type::UndeprecateActivityTypeInput,
                    ) -> ::std::result::Result<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UndeprecateActivityType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UndeprecateActivityType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UndeprecateActivityTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UndeprecateActivityTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UndeprecateActivityType")
...
.with_interceptor(UndeprecateActivityTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError>::new());
...
#[derive(Debug)]
            struct UndeprecateActivityTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UndeprecateActivityTypeResponseDeserializer {
...
#[derive(Debug)]
            struct UndeprecateActivityTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UndeprecateActivityTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::undeprecate_activity_type::UndeprecateActivityTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::undeprecate_activity_type::UndeprecateActivityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_undeprecate_activity_type::ser_undeprecate_activity_type_input(&input)?);
...
#[derive(Debug)]
            struct UndeprecateActivityTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UndeprecateActivityTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UndeprecateActivityTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UndeprecateActivityTypeInput>()
                        .ok_or("failed to downcast to UndeprecateActivityTypeInput")?;
...
pub enum UndeprecateActivityTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UndeprecateActivityTypeError) for what information is available for the error.")]
...
impl UndeprecateActivityTypeError {
    /// Creates the `UndeprecateActivityTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UndeprecateActivityTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UndeprecateActivityTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::undeprecate_activity_type::UndeprecateActivityTypeError {
...
mod _undeprecate_activity_type_output;
