...
impl GetWorkflowExecutionHistoryInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistory::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetWorkflowExecutionHistory {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_workflow_execution_history::de_get_workflow_execution_history_http_error(response)
        } else {
            crate::protocol_serde::shape_get_workflow_execution_history::de_get_workflow_execution_history_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryError
{
