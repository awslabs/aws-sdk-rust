...
impl CountPendingDecisionTasksInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::count_pending_decision_tasks::CountPendingDecisionTasks::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CountPendingDecisionTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_count_pending_decision_tasks::de_count_pending_decision_tasks_http_response_with_props(status, headers, body)
        }
    }
}
