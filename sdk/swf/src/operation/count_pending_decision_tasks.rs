...
impl CountPendingDecisionTasksInput {
    /// Consumes the builder and constructs an Operation<[`CountPendingDecisionTasks`](crate::operation::count_pending_decision_tasks::CountPendingDecisionTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::count_pending_decision_tasks::CountPendingDecisionTasks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::count_pending_decision_tasks::CountPendingDecisionTasksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_count_pending_decision_tasks::ser_count_pending_decision_tasks_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::count_pending_decision_tasks::CountPendingDecisionTasks::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CountPendingDecisionTasks {
                type Output = std::result::Result<crate::operation::count_pending_decision_tasks::CountPendingDecisionTasksOutput, crate::operation::count_pending_decision_tasks::CountPendingDecisionTasksError>;
