...
impl CountPendingDecisionTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::count_pending_decision_tasks::CountPendingDecisionTasks::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::count_pending_decision_tasks::CountPendingDecisionTasksError
{
