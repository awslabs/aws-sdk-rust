...
impl RegisterWorkflowTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_workflow_type::RegisterWorkflowTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_workflow_type::RegisterWorkflowTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_workflow_type::RegisterWorkflowTypeOutput, crate::operation::register_workflow_type::RegisterWorkflowTypeError, Self> {
