...
impl CountOpenWorkflowExecutionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CountOpenWorkflowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_count_open_workflow_executions::de_count_open_workflow_executions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CountOpenWorkflowExecutionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError
{
