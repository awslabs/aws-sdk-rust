...
/// Orchestration and serialization glue logic for `CountOpenWorkflowExecutions`.
...
impl CountOpenWorkflowExecutions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CountOpenWorkflowExecutions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CountOpenWorkflowExecutions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CountOpenWorkflowExecutionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CountOpenWorkflowExecutionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CountOpenWorkflowExecutions")
...
.with_interceptor(CountOpenWorkflowExecutionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError>::new());
...
#[derive(Debug)]
            struct CountOpenWorkflowExecutionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CountOpenWorkflowExecutionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_count_open_workflow_executions::de_count_open_workflow_executions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_count_open_workflow_executions::de_count_open_workflow_executions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CountOpenWorkflowExecutionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CountOpenWorkflowExecutionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_count_open_workflow_executions::ser_count_open_workflow_executions_input(&input)?);
...
#[derive(Debug)]
            struct CountOpenWorkflowExecutionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CountOpenWorkflowExecutionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CountOpenWorkflowExecutionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CountOpenWorkflowExecutionsInput>()
                        .ok_or("failed to downcast to CountOpenWorkflowExecutionsInput")?;
...
pub enum CountOpenWorkflowExecutionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CountOpenWorkflowExecutionsError) for what information is available for the error.")]
...
impl CountOpenWorkflowExecutionsError {
    /// Creates the `CountOpenWorkflowExecutionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CountOpenWorkflowExecutionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CountOpenWorkflowExecutionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError {
...
mod _count_open_workflow_executions_output;
