...
impl ListWorkflowTypesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_workflow_types::ser_list_workflow_types_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkflowTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_workflow_types::de_list_workflow_types_http_response_with_props(status, headers, body)
        }
    }
}
