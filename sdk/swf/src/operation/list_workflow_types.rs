...
impl ListWorkflowTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_workflow_types::ListWorkflowTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkflowTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_workflow_types::de_list_workflow_types_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_workflow_types::ListWorkflowTypesError
{
