...
impl ListWorkflowTypes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_workflow_types::ListWorkflowTypesInput,
                    ) -> ::std::result::Result<crate::operation::list_workflow_types::ListWorkflowTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_workflow_types::ListWorkflowTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_workflow_types::ListWorkflowTypesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_workflow_types::ListWorkflowTypesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWorkflowTypes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListWorkflowTypes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListWorkflowTypesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListWorkflowTypesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWorkflowTypes")
...
.with_interceptor(ListWorkflowTypesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_workflow_types::ListWorkflowTypesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_workflow_types::ListWorkflowTypesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_workflow_types::ListWorkflowTypesError>::new());
...
#[derive(Debug)]
            struct ListWorkflowTypesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListWorkflowTypesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_workflow_types::de_list_workflow_types_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_workflow_types::de_list_workflow_types_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListWorkflowTypesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListWorkflowTypesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_workflow_types::ListWorkflowTypesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_workflow_types::ListWorkflowTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_workflow_types::ser_list_workflow_types_input(&input)?);
...
#[derive(Debug)]
            struct ListWorkflowTypesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWorkflowTypesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListWorkflowTypesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListWorkflowTypesInput>()
                        .ok_or("failed to downcast to ListWorkflowTypesInput")?;
...
pub enum ListWorkflowTypesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListWorkflowTypesError) for what information is available for the error.")]
...
impl ListWorkflowTypesError {
    /// Creates the `ListWorkflowTypesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListWorkflowTypesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListWorkflowTypesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_workflow_types::ListWorkflowTypesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_workflow_types::_list_workflow_types_output::ListWorkflowTypesOutput;

pub use crate::operation::list_workflow_types::_list_workflow_types_input::ListWorkflowTypesInput;

mod _list_workflow_types_input;

mod _list_workflow_types_output;
