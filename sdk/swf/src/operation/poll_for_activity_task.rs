...
impl PollForActivityTaskInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_poll_for_activity_task::ser_poll_for_activity_task_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::poll_for_activity_task::PollForActivityTask::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for PollForActivityTask {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_poll_for_activity_task::de_poll_for_activity_task_http_error(response)
        } else {
            crate::protocol_serde::shape_poll_for_activity_task::de_poll_for_activity_task_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::poll_for_activity_task::PollForActivityTaskError
{
