...
impl UndeprecateWorkflowType {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SWF", "UndeprecateWorkflowType", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SWF.UndeprecateWorkflowType",
                "rpc.service" = "SWF",
                "rpc.method" = "UndeprecateWorkflowType",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UndeprecateWorkflowType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UndeprecateWorkflowTypeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UndeprecateWorkflowTypeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UndeprecateWorkflowType")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UndeprecateWorkflowType")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UndeprecateWorkflowTypeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UndeprecateWorkflowTypeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UndeprecateWorkflowTypeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UndeprecateWorkflowTypeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UndeprecateWorkflowTypeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_undeprecate_workflow_type::de_undeprecate_workflow_type_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_undeprecate_workflow_type::de_undeprecate_workflow_type_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UndeprecateWorkflowTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_undeprecate_workflow_type::ser_undeprecate_workflow_type_input(&input)?,
        );
...
impl ::std::error::Error for UndeprecateWorkflowTypeError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::TypeAlreadyExistsFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UndeprecateWorkflowTypeError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TypeAlreadyExistsFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
