...
impl UndeprecateWorkflowTypeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::undeprecate_workflow_type::UndeprecateWorkflowType::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UndeprecateWorkflowType {
                type Output = std::result::Result<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput, crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>;
