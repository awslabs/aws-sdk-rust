...
/// Orchestration and serialization glue logic for `UndeprecateWorkflowType`.
...
impl UndeprecateWorkflowType {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UndeprecateWorkflowType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UndeprecateWorkflowType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UndeprecateWorkflowTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UndeprecateWorkflowTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UndeprecateWorkflowType")
...
.with_interceptor(UndeprecateWorkflowTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError>::new());
...
#[derive(Debug)]
            struct UndeprecateWorkflowTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UndeprecateWorkflowTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_undeprecate_workflow_type::de_undeprecate_workflow_type_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_undeprecate_workflow_type::de_undeprecate_workflow_type_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UndeprecateWorkflowTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UndeprecateWorkflowTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_undeprecate_workflow_type::ser_undeprecate_workflow_type_input(&input)?);
...
#[derive(Debug)]
            struct UndeprecateWorkflowTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UndeprecateWorkflowTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UndeprecateWorkflowTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UndeprecateWorkflowTypeInput>()
                        .ok_or("failed to downcast to UndeprecateWorkflowTypeInput")?;
...
pub enum UndeprecateWorkflowTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UndeprecateWorkflowTypeError) for what information is available for the error.")]
...
impl UndeprecateWorkflowTypeError {
    /// Creates the `UndeprecateWorkflowTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UndeprecateWorkflowTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TypeAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UndeprecateWorkflowTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError {
