...
/// Orchestration and serialization glue logic for `RequestCancelWorkflowExecution`.
...
impl RequestCancelWorkflowExecution {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionInput,
                    ) -> ::std::result::Result<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RequestCancelWorkflowExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RequestCancelWorkflowExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RequestCancelWorkflowExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RequestCancelWorkflowExecutionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RequestCancelWorkflowExecution")
...
.with_interceptor(RequestCancelWorkflowExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError>::new());
...
#[derive(Debug)]
            struct RequestCancelWorkflowExecutionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RequestCancelWorkflowExecutionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_request_cancel_workflow_execution::de_request_cancel_workflow_execution_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_request_cancel_workflow_execution::de_request_cancel_workflow_execution_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RequestCancelWorkflowExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RequestCancelWorkflowExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_request_cancel_workflow_execution::ser_request_cancel_workflow_execution_input(&input)?);
...
#[derive(Debug)]
            struct RequestCancelWorkflowExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RequestCancelWorkflowExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RequestCancelWorkflowExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RequestCancelWorkflowExecutionInput>()
                        .ok_or("failed to downcast to RequestCancelWorkflowExecutionInput")?;
...
pub enum RequestCancelWorkflowExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RequestCancelWorkflowExecutionError) for what information is available for the error.")]
...
impl RequestCancelWorkflowExecutionError {
    /// Creates the `RequestCancelWorkflowExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RequestCancelWorkflowExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RequestCancelWorkflowExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError {
...
mod _request_cancel_workflow_execution_output;
