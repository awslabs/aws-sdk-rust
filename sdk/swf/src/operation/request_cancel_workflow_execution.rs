...
impl RequestCancelWorkflowExecutionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestCancelWorkflowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_request_cancel_workflow_execution::de_request_cancel_workflow_execution_http_response_with_props(
                status, headers, body,
            )
        }
    }
