...
impl CountOpenWorkflowExecutionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsOutput, crate::operation::count_open_workflow_executions::CountOpenWorkflowExecutionsError, Self> {
