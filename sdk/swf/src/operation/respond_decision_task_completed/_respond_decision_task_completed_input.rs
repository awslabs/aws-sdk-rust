...
impl RespondDecisionTaskCompletedInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedInput, ::aws_smithy_types::error::operation::BuildError> {
