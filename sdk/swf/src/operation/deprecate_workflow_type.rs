...
/// Orchestration and serialization glue logic for `DeprecateWorkflowType`.
...
impl DeprecateWorkflowType {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeInput,
                    ) -> ::std::result::Result<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeprecateWorkflowType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeprecateWorkflowType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeprecateWorkflowTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeprecateWorkflowTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeprecateWorkflowType")
...
.with_interceptor(DeprecateWorkflowTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError>::new());
...
#[derive(Debug)]
            struct DeprecateWorkflowTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeprecateWorkflowTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_deprecate_workflow_type::de_deprecate_workflow_type_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_deprecate_workflow_type::de_deprecate_workflow_type_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeprecateWorkflowTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeprecateWorkflowTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deprecate_workflow_type::ser_deprecate_workflow_type_input(&input)?);
...
#[derive(Debug)]
            struct DeprecateWorkflowTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeprecateWorkflowTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeprecateWorkflowTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeprecateWorkflowTypeInput>()
                        .ok_or("failed to downcast to DeprecateWorkflowTypeInput")?;
...
pub enum DeprecateWorkflowTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeprecateWorkflowTypeError) for what information is available for the error.")]
...
impl DeprecateWorkflowTypeError {
    /// Creates the `DeprecateWorkflowTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeprecateWorkflowTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeprecateWorkflowTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError {
...
mod _deprecate_workflow_type_output;
