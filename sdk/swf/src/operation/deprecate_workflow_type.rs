...
impl DeprecateWorkflowTypeInput {
    /// Consumes the builder and constructs an Operation<[`DeprecateWorkflowType`](crate::operation::deprecate_workflow_type::DeprecateWorkflowType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deprecate_workflow_type::DeprecateWorkflowType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deprecate_workflow_type::ser_deprecate_workflow_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deprecate_workflow_type::DeprecateWorkflowType::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeprecateWorkflowType {
                type Output = std::result::Result<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput, crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError>;
