...
impl ListClosedWorkflowExecutionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListClosedWorkflowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_closed_workflow_executions::de_list_closed_workflow_executions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListClosedWorkflowExecutionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError
{
