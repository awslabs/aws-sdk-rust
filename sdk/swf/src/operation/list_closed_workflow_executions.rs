...
/// Orchestration and serialization glue logic for `ListClosedWorkflowExecutions`.
...
impl ListClosedWorkflowExecutions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListClosedWorkflowExecutions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListClosedWorkflowExecutions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListClosedWorkflowExecutionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListClosedWorkflowExecutionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListClosedWorkflowExecutions")
...
.with_interceptor(ListClosedWorkflowExecutionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>::new());
...
#[derive(Debug)]
            struct ListClosedWorkflowExecutionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListClosedWorkflowExecutionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_closed_workflow_executions::de_list_closed_workflow_executions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_closed_workflow_executions::de_list_closed_workflow_executions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListClosedWorkflowExecutionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListClosedWorkflowExecutionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_closed_workflow_executions::ser_list_closed_workflow_executions_input(&input)?);
...
#[derive(Debug)]
            struct ListClosedWorkflowExecutionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListClosedWorkflowExecutionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListClosedWorkflowExecutionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListClosedWorkflowExecutionsInput>()
                        .ok_or("failed to downcast to ListClosedWorkflowExecutionsInput")?;
...
pub enum ListClosedWorkflowExecutionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListClosedWorkflowExecutionsError) for what information is available for the error.")]
...
impl ListClosedWorkflowExecutionsError {
    /// Creates the `ListClosedWorkflowExecutionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListClosedWorkflowExecutionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListClosedWorkflowExecutionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError {
...
mod _list_closed_workflow_executions_output;
