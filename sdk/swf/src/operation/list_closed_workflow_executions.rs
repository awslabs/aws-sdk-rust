...
impl ListClosedWorkflowExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListClosedWorkflowExecutions`](crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_closed_workflow_executions::ser_list_closed_workflow_executions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListClosedWorkflowExecutions {
                type Output = std::result::Result<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsOutput, crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>;
