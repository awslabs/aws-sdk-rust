...
impl RegisterWorkflowTypeInput {
    /// Consumes the builder and constructs an Operation<[`RegisterWorkflowType`](crate::operation::register_workflow_type::RegisterWorkflowType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_workflow_type::RegisterWorkflowType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_workflow_type::RegisterWorkflowTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_workflow_type::ser_register_workflow_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_workflow_type::RegisterWorkflowType::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterWorkflowType {
                type Output = std::result::Result<crate::operation::register_workflow_type::RegisterWorkflowTypeOutput, crate::operation::register_workflow_type::RegisterWorkflowTypeError>;
