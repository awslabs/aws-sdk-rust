...
impl RegisterWorkflowType {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_workflow_type::RegisterWorkflowTypeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_workflow_type::RegisterWorkflowTypeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SWF", "RegisterWorkflowType", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SWF.RegisterWorkflowType",
                "rpc.service" = "SWF",
                "rpc.method" = "RegisterWorkflowType",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterWorkflowType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterWorkflowType");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterWorkflowTypeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterWorkflowTypeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterWorkflowType")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterWorkflowType")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterWorkflowTypeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterWorkflowTypeEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct RegisterWorkflowTypeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterWorkflowTypeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterWorkflowTypeInput>() else {
        ...
        if requested.should_capture("defaultTaskStartToCloseTimeout") {
            if let ::std::option::Option::Some(value) = input.default_task_start_to_close_timeout.as_deref() {
                captured.insert("defaultTaskStartToCloseTimeout", value);
            }
        }
        if requested.should_capture("defaultExecutionStartToCloseTimeout") {
            if let ::std::option::Option::Some(value) = input.default_execution_start_to_close_timeout.as_deref() {
                captured.insert("defaultExecutionStartToCloseTimeout", value);
            }
        }
        if requested.should_capture("defaultTaskPriority") {
            if let ::std::option::Option::Some(value) = input.default_task_priority.as_deref() {
                captured.insert("defaultTaskPriority", value);
            }
        }
        if requested.should_capture("defaultLambdaRole") {
            if let ::std::option::Option::Some(value) = input.default_lambda_role.as_deref() {
                captured.insert("defaultLambdaRole", value);
            }
        }
...
#[derive(Debug)]
struct RegisterWorkflowTypeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterWorkflowTypeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_workflow_type::de_register_workflow_type_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_register_workflow_type::de_register_workflow_type_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct RegisterWorkflowTypeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterWorkflowTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_workflow_type::RegisterWorkflowTypeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::register_workflow_type::RegisterWorkflowTypeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_workflow_type::ser_register_workflow_type_input(
            &input,
        )?);
...
#[derive(Debug)]
struct RegisterWorkflowTypeEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterWorkflowTypeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "RegisterWorkflowTypeEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<RegisterWorkflowTypeInput>()
            .ok_or("failed to downcast to RegisterWorkflowTypeInput")?;
...
pub enum RegisterWorkflowTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterWorkflowTypeError) for what information is available for the error.")]
...
impl RegisterWorkflowTypeError {
    ...
    /// Creates the `RegisterWorkflowTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterWorkflowTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_workflow_type::RegisterWorkflowTypeError {
...
mod _register_workflow_type_output;
