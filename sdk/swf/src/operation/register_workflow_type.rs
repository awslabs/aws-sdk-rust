...
impl RegisterWorkflowTypeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_workflow_type::ser_register_workflow_type_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_workflow_type::RegisterWorkflowType::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_workflow_type::RegisterWorkflowTypeError
{
