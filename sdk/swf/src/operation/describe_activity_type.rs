...
/// Orchestration and serialization glue logic for `DescribeActivityType`.
...
impl DescribeActivityType {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_activity_type::DescribeActivityTypeInput,
                    ) -> ::std::result::Result<crate::operation::describe_activity_type::DescribeActivityTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_activity_type::DescribeActivityTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_activity_type::DescribeActivityTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_activity_type::DescribeActivityTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeActivityType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeActivityType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeActivityTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeActivityTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeActivityType")
...
.with_interceptor(DescribeActivityTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_activity_type::DescribeActivityTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_activity_type::DescribeActivityTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_activity_type::DescribeActivityTypeError>::new());
...
#[derive(Debug)]
            struct DescribeActivityTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeActivityTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_activity_type::de_describe_activity_type_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeActivityTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeActivityTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_activity_type::DescribeActivityTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_activity_type::DescribeActivityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_activity_type::ser_describe_activity_type_input(&input)?);
...
#[derive(Debug)]
            struct DescribeActivityTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeActivityTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeActivityTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeActivityTypeInput>()
                        .ok_or("failed to downcast to DescribeActivityTypeInput")?;
...
pub enum DescribeActivityTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeActivityTypeError) for what information is available for the error.")]
...
impl DescribeActivityTypeError {
    /// Creates the `DescribeActivityTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeActivityTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeActivityTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_activity_type::DescribeActivityTypeError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_activity_type::_describe_activity_type_output::DescribeActivityTypeOutput;

pub use crate::operation::describe_activity_type::_describe_activity_type_input::DescribeActivityTypeInput;

mod _describe_activity_type_input;

mod _describe_activity_type_output;
