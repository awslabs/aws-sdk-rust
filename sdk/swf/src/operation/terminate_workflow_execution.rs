...
/// Orchestration and serialization glue logic for `TerminateWorkflowExecution`.
...
impl TerminateWorkflowExecution {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionInput,
                    ) -> ::std::result::Result<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TerminateWorkflowExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TerminateWorkflowExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TerminateWorkflowExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TerminateWorkflowExecutionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TerminateWorkflowExecution")
...
.with_interceptor(TerminateWorkflowExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError>::new());
...
#[derive(Debug)]
            struct TerminateWorkflowExecutionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TerminateWorkflowExecutionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_terminate_workflow_execution::de_terminate_workflow_execution_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct TerminateWorkflowExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TerminateWorkflowExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_terminate_workflow_execution::ser_terminate_workflow_execution_input(&input)?);
...
#[derive(Debug)]
            struct TerminateWorkflowExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TerminateWorkflowExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TerminateWorkflowExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TerminateWorkflowExecutionInput>()
                        .ok_or("failed to downcast to TerminateWorkflowExecutionInput")?;
...
pub enum TerminateWorkflowExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TerminateWorkflowExecutionError) for what information is available for the error.")]
...
impl TerminateWorkflowExecutionError {
    /// Creates the `TerminateWorkflowExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TerminateWorkflowExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TerminateWorkflowExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError {
...
mod _terminate_workflow_execution_output;
