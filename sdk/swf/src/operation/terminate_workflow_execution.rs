...
impl TerminateWorkflowExecutionInput {
    /// Consumes the builder and constructs an Operation<[`TerminateWorkflowExecution`](crate::operation::terminate_workflow_execution::TerminateWorkflowExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::terminate_workflow_execution::TerminateWorkflowExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_terminate_workflow_execution::ser_terminate_workflow_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_workflow_execution::TerminateWorkflowExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for TerminateWorkflowExecution {
                type Output = std::result::Result<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionOutput, crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_terminate_workflow_execution::de_terminate_workflow_execution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_terminate_workflow_execution::de_terminate_workflow_execution_http_response(response)
                     }
                }
            }
