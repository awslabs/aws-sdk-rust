...
impl TerminateWorkflowExecutionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_workflow_execution::TerminateWorkflowExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateWorkflowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_terminate_workflow_execution::de_terminate_workflow_execution_http_response_with_props(status, headers, body)
        }
    }
}
