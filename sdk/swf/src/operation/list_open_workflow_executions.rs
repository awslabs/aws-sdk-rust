...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOpenWorkflowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_open_workflow_executions::de_list_open_workflow_executions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsError
{
