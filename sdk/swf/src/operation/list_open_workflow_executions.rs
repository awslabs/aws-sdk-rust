...
impl ListOpenWorkflowExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListOpenWorkflowExecutions`](crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_open_workflow_executions::ser_list_open_workflow_executions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListOpenWorkflowExecutions {
                type Output = std::result::Result<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsOutput, crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsError>;
