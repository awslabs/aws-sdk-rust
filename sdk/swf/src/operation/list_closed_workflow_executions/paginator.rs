...
/// Paginator for [`ListClosedWorkflowExecutions`](crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutions)
            ...
            impl ListClosedWorkflowExecutionsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsOutput, aws_smithy_http::result::SdkError<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListClosedWorkflowExecutionsPaginator`
                ...
                impl  ListClosedWorkflowExecutionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::WorkflowExecutionInfo, aws_smithy_http::result::SdkError<crate::operation::list_closed_workflow_executions::ListClosedWorkflowExecutionsError>>> + Unpin
                     {
