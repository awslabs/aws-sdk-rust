...
impl CountPendingActivityTasksInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::count_pending_activity_tasks::CountPendingActivityTasks::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CountPendingActivityTasks {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_count_pending_activity_tasks::de_count_pending_activity_tasks_http_error(response)
        } else {
            crate::protocol_serde::shape_count_pending_activity_tasks::de_count_pending_activity_tasks_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError
{
