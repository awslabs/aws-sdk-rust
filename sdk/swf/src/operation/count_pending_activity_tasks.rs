...
impl CountPendingActivityTasks {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CountPendingActivityTasks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CountPendingActivityTasks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CountPendingActivityTasksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CountPendingActivityTasksResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CountPendingActivityTasks")
...
.with_interceptor(CountPendingActivityTasksEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError>::new());
...
#[derive(Debug)]
            struct CountPendingActivityTasksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CountPendingActivityTasksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_count_pending_activity_tasks::de_count_pending_activity_tasks_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CountPendingActivityTasksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CountPendingActivityTasksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::count_pending_activity_tasks::CountPendingActivityTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_count_pending_activity_tasks::ser_count_pending_activity_tasks_input(&input)?);
...
#[derive(Debug)]
            struct CountPendingActivityTasksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CountPendingActivityTasksEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CountPendingActivityTasksEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CountPendingActivityTasksInput>()
                        .ok_or("failed to downcast to CountPendingActivityTasksInput")?;
...
pub enum CountPendingActivityTasksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CountPendingActivityTasksError) for what information is available for the error.")]
...
impl CountPendingActivityTasksError {
    /// Creates the `CountPendingActivityTasksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CountPendingActivityTasksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CountPendingActivityTasksError {
...
impl ::aws_types::request_id::RequestId for crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError {
