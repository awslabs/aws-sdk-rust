...
impl UndeprecateDomainFluentBuilder  {
    /// Creates a new `UndeprecateDomain`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::undeprecate_domain::UndeprecateDomain, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::undeprecate_domain::UndeprecateDomainError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::undeprecate_domain::UndeprecateDomainOutput, aws_smithy_http::result::SdkError<crate::operation::undeprecate_domain::UndeprecateDomainError>>
                     {
