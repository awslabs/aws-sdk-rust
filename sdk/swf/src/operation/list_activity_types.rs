...
impl ListActivityTypesInput {
    /// Consumes the builder and constructs an Operation<[`ListActivityTypes`](crate::operation::list_activity_types::ListActivityTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_activity_types::ListActivityTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_activity_types::ListActivityTypesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_activity_types::ser_list_activity_types_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_activity_types::ListActivityTypes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListActivityTypes {
                type Output = std::result::Result<crate::operation::list_activity_types::ListActivityTypesOutput, crate::operation::list_activity_types::ListActivityTypesError>;
