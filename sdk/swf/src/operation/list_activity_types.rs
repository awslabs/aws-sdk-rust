...
impl ListActivityTypesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_activity_types::ListActivityTypes,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_activity_types::ser_list_activity_types_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListActivityTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_activity_types::de_list_activity_types_http_response_with_props(status, headers, body)
        }
    }
}
