...
impl RespondActivityTaskCanceled {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RespondActivityTaskCanceled {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RespondActivityTaskCanceled");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RespondActivityTaskCanceledRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RespondActivityTaskCanceledResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RespondActivityTaskCanceled")
...
.with_interceptor(RespondActivityTaskCanceledEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError>::new());
...
#[derive(Debug)]
            struct RespondActivityTaskCanceledResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RespondActivityTaskCanceledResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_respond_activity_task_canceled::de_respond_activity_task_canceled_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RespondActivityTaskCanceledRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RespondActivityTaskCanceledRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_respond_activity_task_canceled::ser_respond_activity_task_canceled_input(&input)?);
...
#[derive(Debug)]
            struct RespondActivityTaskCanceledEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RespondActivityTaskCanceledEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RespondActivityTaskCanceledEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RespondActivityTaskCanceledInput>()
                        .ok_or("failed to downcast to RespondActivityTaskCanceledInput")?;
...
pub enum RespondActivityTaskCanceledError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RespondActivityTaskCanceledError) for what information is available for the error.")]
...
impl RespondActivityTaskCanceledError {
    /// Creates the `RespondActivityTaskCanceledError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RespondActivityTaskCanceledError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RespondActivityTaskCanceledError {
...
impl ::aws_types::request_id::RequestId for crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError {
