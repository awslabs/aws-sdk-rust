...
impl RespondActivityTaskCanceledInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceled::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskCanceled {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_respond_activity_task_canceled::de_respond_activity_task_canceled_http_error(response)
        } else {
            crate::protocol_serde::shape_respond_activity_task_canceled::de_respond_activity_task_canceled_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError
{
