...
/// Orchestration and serialization glue logic for `RecordActivityTaskHeartbeat`.
...
impl RecordActivityTaskHeartbeat {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RecordActivityTaskHeartbeat {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RecordActivityTaskHeartbeat");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RecordActivityTaskHeartbeatRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RecordActivityTaskHeartbeatResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RecordActivityTaskHeartbeat")
...
.with_interceptor(RecordActivityTaskHeartbeatEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>::new());
...
#[derive(Debug)]
            struct RecordActivityTaskHeartbeatResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RecordActivityTaskHeartbeatResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_record_activity_task_heartbeat::de_record_activity_task_heartbeat_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_record_activity_task_heartbeat::de_record_activity_task_heartbeat_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RecordActivityTaskHeartbeatRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RecordActivityTaskHeartbeatRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_record_activity_task_heartbeat::ser_record_activity_task_heartbeat_input(&input)?);
...
#[derive(Debug)]
            struct RecordActivityTaskHeartbeatEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RecordActivityTaskHeartbeatEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RecordActivityTaskHeartbeatEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RecordActivityTaskHeartbeatInput>()
                        .ok_or("failed to downcast to RecordActivityTaskHeartbeatInput")?;
...
pub enum RecordActivityTaskHeartbeatError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RecordActivityTaskHeartbeatError) for what information is available for the error.")]
...
impl RecordActivityTaskHeartbeatError {
    /// Creates the `RecordActivityTaskHeartbeatError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RecordActivityTaskHeartbeatError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RecordActivityTaskHeartbeatError {
...
impl ::aws_types::request_id::RequestId for crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError {
...
mod _record_activity_task_heartbeat_output;
