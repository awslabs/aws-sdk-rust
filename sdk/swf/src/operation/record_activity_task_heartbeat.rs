...
impl RecordActivityTaskHeartbeatInput {
    /// Consumes the builder and constructs an Operation<[`RecordActivityTaskHeartbeat`](crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeat)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeat, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_record_activity_task_heartbeat::ser_record_activity_task_heartbeat_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeat::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RecordActivityTaskHeartbeat {
                type Output = std::result::Result<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatOutput, crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>;
