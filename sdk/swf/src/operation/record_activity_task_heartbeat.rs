    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RecordActivityTaskHeartbeatResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RecordActivityTaskHeartbeatRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RecordActivityTaskHeartbeatEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError {
