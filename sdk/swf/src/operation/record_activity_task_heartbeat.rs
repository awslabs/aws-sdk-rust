...
impl RecordActivityTaskHeartbeatInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeat::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RecordActivityTaskHeartbeat {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_record_activity_task_heartbeat::de_record_activity_task_heartbeat_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RecordActivityTaskHeartbeatError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatError
{
