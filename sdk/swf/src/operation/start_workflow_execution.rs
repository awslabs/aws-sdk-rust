...
impl StartWorkflowExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartWorkflowExecution`](crate::operation::start_workflow_execution::StartWorkflowExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_workflow_execution::StartWorkflowExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_workflow_execution::StartWorkflowExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_workflow_execution::ser_start_workflow_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_workflow_execution::StartWorkflowExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartWorkflowExecution {
                type Output = std::result::Result<crate::operation::start_workflow_execution::StartWorkflowExecutionOutput, crate::operation::start_workflow_execution::StartWorkflowExecutionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_workflow_execution::de_start_workflow_execution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_workflow_execution::de_start_workflow_execution_http_response(response)
                     }
                }
            }
