...
impl SignalWorkflowExecutionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::signal_workflow_execution::SignalWorkflowExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::signal_workflow_execution::SignalWorkflowExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::signal_workflow_execution::SignalWorkflowExecutionOutput, crate::operation::signal_workflow_execution::SignalWorkflowExecutionError, Self> {
