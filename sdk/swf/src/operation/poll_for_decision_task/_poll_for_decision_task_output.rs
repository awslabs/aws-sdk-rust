...
impl  PollForDecisionTaskOutput  {
    ...
    pub fn task_token(&self) -> & str {
        use std::ops::Deref; self.task_token.deref()
    }
    /// <p>The ID of the <code>DecisionTaskStarted</code> event recorded in the history.</p>
...
impl PollForDecisionTaskOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::poll_for_decision_task::PollForDecisionTaskOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::poll_for_decision_task::PollForDecisionTaskOutput {
                task_token: self.task_token
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("task_token", "task_token was not specified but it is required when building PollForDecisionTaskOutput")
                    )?
                ,
                ...
                events: self.events
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("events", "events was not specified but it is required when building PollForDecisionTaskOutput")
                    )?
                ,
