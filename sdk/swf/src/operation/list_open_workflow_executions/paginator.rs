...
/// Paginator for [`ListOpenWorkflowExecutions`](crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutions)
            ...
            impl ListOpenWorkflowExecutionsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsOutput, aws_smithy_http::result::SdkError<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListOpenWorkflowExecutionsPaginator`
                ...
                impl  ListOpenWorkflowExecutionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::WorkflowExecutionInfo, aws_smithy_http::result::SdkError<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsError>>> + Unpin
                     {
