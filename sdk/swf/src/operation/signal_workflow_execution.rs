...
impl SignalWorkflowExecutionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::signal_workflow_execution::SignalWorkflowExecution::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SignalWorkflowExecution {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_signal_workflow_execution::de_signal_workflow_execution_http_error(response)
        } else {
            crate::protocol_serde::shape_signal_workflow_execution::de_signal_workflow_execution_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::signal_workflow_execution::SignalWorkflowExecutionError
{
