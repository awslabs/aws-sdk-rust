...
impl CountClosedWorkflowExecutionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CountClosedWorkflowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_count_closed_workflow_executions::de_count_closed_workflow_executions_http_response_with_props(
                status, headers, body,
            )
        }
    }
