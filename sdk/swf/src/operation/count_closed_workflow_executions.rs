...
impl CountClosedWorkflowExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`CountClosedWorkflowExecutions`](crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_count_closed_workflow_executions::ser_count_closed_workflow_executions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CountClosedWorkflowExecutions {
                type Output = std::result::Result<crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutionsOutput, crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutionsError>;
