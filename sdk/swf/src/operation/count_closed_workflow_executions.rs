    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::count_closed_workflow_executions::CountClosedWorkflowExecutionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CountClosedWorkflowExecutionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CountClosedWorkflowExecutionsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CountClosedWorkflowExecutionsEndpointParamsInterceptor {
