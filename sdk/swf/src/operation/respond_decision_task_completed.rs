...
/// Orchestration and serialization glue logic for `RespondDecisionTaskCompleted`.
...
impl RespondDecisionTaskCompleted {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RespondDecisionTaskCompleted {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RespondDecisionTaskCompleted");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RespondDecisionTaskCompletedRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RespondDecisionTaskCompletedResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RespondDecisionTaskCompleted")
...
.with_interceptor(RespondDecisionTaskCompletedEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError>::new());
...
#[derive(Debug)]
            struct RespondDecisionTaskCompletedResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RespondDecisionTaskCompletedResponseDeserializer {
...
#[derive(Debug)]
            struct RespondDecisionTaskCompletedRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RespondDecisionTaskCompletedRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_respond_decision_task_completed::ser_respond_decision_task_completed_input(&input)?);
...
#[derive(Debug)]
            struct RespondDecisionTaskCompletedEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RespondDecisionTaskCompletedEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RespondDecisionTaskCompletedEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RespondDecisionTaskCompletedInput>()
                        .ok_or("failed to downcast to RespondDecisionTaskCompletedInput")?;
...
pub enum RespondDecisionTaskCompletedError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RespondDecisionTaskCompletedError) for what information is available for the error.")]
...
impl RespondDecisionTaskCompletedError {
    /// Creates the `RespondDecisionTaskCompletedError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RespondDecisionTaskCompletedError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RespondDecisionTaskCompletedError {
...
impl ::aws_types::request_id::RequestId for crate::operation::respond_decision_task_completed::RespondDecisionTaskCompletedError {
...
mod _respond_decision_task_completed_output;
