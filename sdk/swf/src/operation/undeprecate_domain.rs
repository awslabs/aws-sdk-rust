...
impl UndeprecateDomainInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::undeprecate_domain::UndeprecateDomain::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UndeprecateDomain {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_undeprecate_domain::de_undeprecate_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_undeprecate_domain::de_undeprecate_domain_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::undeprecate_domain::UndeprecateDomainError
{
