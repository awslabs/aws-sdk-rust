...
impl DeprecateActivityType {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::deprecate_activity_type::DeprecateActivityTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprecate_activity_type::DeprecateActivityTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deprecate_activity_type::DeprecateActivityTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deprecate_activity_type::DeprecateActivityTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeprecateActivityType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeprecateActivityType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeprecateActivityTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeprecateActivityTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeprecateActivityType")
...
.with_interceptor(DeprecateActivityTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deprecate_activity_type::DeprecateActivityTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deprecate_activity_type::DeprecateActivityTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deprecate_activity_type::DeprecateActivityTypeError>::new());
...
#[derive(Debug)]
            struct DeprecateActivityTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeprecateActivityTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_deprecate_activity_type::de_deprecate_activity_type_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeprecateActivityTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeprecateActivityTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deprecate_activity_type::DeprecateActivityTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deprecate_activity_type::DeprecateActivityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deprecate_activity_type::ser_deprecate_activity_type_input(&input)?);
...
#[derive(Debug)]
            struct DeprecateActivityTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeprecateActivityTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeprecateActivityTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeprecateActivityTypeInput>()
                        .ok_or("failed to downcast to DeprecateActivityTypeInput")?;
...
pub enum DeprecateActivityTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeprecateActivityTypeError) for what information is available for the error.")]
...
impl DeprecateActivityTypeError {
    /// Creates the `DeprecateActivityTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeprecateActivityTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeprecateActivityTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deprecate_activity_type::DeprecateActivityTypeError {
