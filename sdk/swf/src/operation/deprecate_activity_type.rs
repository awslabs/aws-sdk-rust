...
impl DeprecateActivityTypeInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deprecate_activity_type::DeprecateActivityType::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeprecateActivityType {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_deprecate_activity_type::de_deprecate_activity_type_http_error(response)
        } else {
            crate::protocol_serde::shape_deprecate_activity_type::de_deprecate_activity_type_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::deprecate_activity_type::DeprecateActivityTypeError
{
