...
impl RecordActivityTaskHeartbeatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::record_activity_task_heartbeat::RecordActivityTaskHeartbeatInput, ::aws_smithy_types::error::operation::BuildError> {
