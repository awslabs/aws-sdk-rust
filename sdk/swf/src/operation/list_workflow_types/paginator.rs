...
/// Paginator for [`ListWorkflowTypes`](crate::operation::list_workflow_types::ListWorkflowTypes)
            ...
            impl ListWorkflowTypesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_workflow_types::ListWorkflowTypesOutput, aws_smithy_http::result::SdkError<crate::operation::list_workflow_types::ListWorkflowTypesError>>> + Unpin
                 {
...
/// Flattened paginator for `ListWorkflowTypesPaginator`
                ...
                impl  ListWorkflowTypesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::WorkflowTypeInfo, aws_smithy_http::result::SdkError<crate::operation::list_workflow_types::ListWorkflowTypesError>>> + Unpin
                     {
