...
impl GetWorkflowExecutionHistoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryOutput, crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryError, Self> {
