...
impl crate::operation::get_workflow_execution_history::builders::GetWorkflowExecutionHistoryInputBuilder {
...
impl GetWorkflowExecutionHistoryFluentBuilder {
    /// Creates a new `GetWorkflowExecutionHistoryFluentBuilder`.
