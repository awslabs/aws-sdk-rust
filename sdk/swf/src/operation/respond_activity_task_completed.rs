...
impl RespondActivityTaskCompletedInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::respond_activity_task_completed::RespondActivityTaskCompleted,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::respond_activity_task_completed::RespondActivityTaskCompleted::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskCompleted {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_respond_activity_task_completed::de_respond_activity_task_completed_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RespondActivityTaskCompletedError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError
{
