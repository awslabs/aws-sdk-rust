...
impl RespondActivityTaskCompletedInput {
    /// Consumes the builder and constructs an Operation<[`RespondActivityTaskCompleted`](crate::operation::respond_activity_task_completed::RespondActivityTaskCompleted)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::respond_activity_task_completed::RespondActivityTaskCompleted, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_respond_activity_task_completed::ser_respond_activity_task_completed_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::respond_activity_task_completed::RespondActivityTaskCompleted::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskCompleted {
                type Output = std::result::Result<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedOutput, crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_respond_activity_task_completed::de_respond_activity_task_completed_http_error(response)
                     } else {
                        crate::protocol_serde::shape_respond_activity_task_completed::de_respond_activity_task_completed_http_response(response)
                     }
                }
            }
