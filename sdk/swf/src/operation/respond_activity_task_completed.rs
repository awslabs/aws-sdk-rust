...
/// Orchestration and serialization glue logic for `RespondActivityTaskCompleted`.
...
impl RespondActivityTaskCompleted {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RespondActivityTaskCompleted {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RespondActivityTaskCompleted");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RespondActivityTaskCompletedRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RespondActivityTaskCompletedResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RespondActivityTaskCompleted")
...
.with_interceptor(RespondActivityTaskCompletedEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>::new());
...
#[derive(Debug)]
            struct RespondActivityTaskCompletedResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RespondActivityTaskCompletedResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_respond_activity_task_completed::de_respond_activity_task_completed_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RespondActivityTaskCompletedRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RespondActivityTaskCompletedRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_respond_activity_task_completed::ser_respond_activity_task_completed_input(&input)?);
...
#[derive(Debug)]
            struct RespondActivityTaskCompletedEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RespondActivityTaskCompletedEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RespondActivityTaskCompletedEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RespondActivityTaskCompletedInput>()
                        .ok_or("failed to downcast to RespondActivityTaskCompletedInput")?;
...
pub enum RespondActivityTaskCompletedError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RespondActivityTaskCompletedError) for what information is available for the error.")]
...
impl RespondActivityTaskCompletedError {
    /// Creates the `RespondActivityTaskCompletedError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RespondActivityTaskCompletedError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RespondActivityTaskCompletedError {
...
impl ::aws_types::request_id::RequestId for crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::respond_activity_task_completed::_respond_activity_task_completed_output::RespondActivityTaskCompletedOutput;

pub use crate::operation::respond_activity_task_completed::_respond_activity_task_completed_input::RespondActivityTaskCompletedInput;

mod _respond_activity_task_completed_input;

mod _respond_activity_task_completed_output;
