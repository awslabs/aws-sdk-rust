    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RespondActivityTaskCompletedResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RespondActivityTaskCompletedRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RespondActivityTaskCompletedEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::respond_activity_task_completed::RespondActivityTaskCompletedError {
