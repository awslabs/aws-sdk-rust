...
impl DeprecateDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deprecate_domain::DeprecateDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeprecateDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_deprecate_domain::de_deprecate_domain_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deprecate_domain::DeprecateDomainError
{
