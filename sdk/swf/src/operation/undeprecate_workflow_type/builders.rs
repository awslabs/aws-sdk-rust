...
impl UndeprecateWorkflowTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeOutput, crate::operation::undeprecate_workflow_type::UndeprecateWorkflowTypeError, Self> {
