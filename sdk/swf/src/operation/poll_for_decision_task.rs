...
impl PollForDecisionTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_poll_for_decision_task::ser_poll_for_decision_task_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::poll_for_decision_task::PollForDecisionTask::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::poll_for_decision_task::PollForDecisionTaskError
{
