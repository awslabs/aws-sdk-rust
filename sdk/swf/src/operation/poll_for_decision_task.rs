...
impl PollForDecisionTaskInput {
    /// Consumes the builder and constructs an Operation<[`PollForDecisionTask`](crate::operation::poll_for_decision_task::PollForDecisionTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::poll_for_decision_task::PollForDecisionTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::poll_for_decision_task::PollForDecisionTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_poll_for_decision_task::ser_poll_for_decision_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::poll_for_decision_task::PollForDecisionTask::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PollForDecisionTask {
                type Output = std::result::Result<crate::operation::poll_for_decision_task::PollForDecisionTaskOutput, crate::operation::poll_for_decision_task::PollForDecisionTaskError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_poll_for_decision_task::de_poll_for_decision_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_poll_for_decision_task::de_poll_for_decision_task_http_response(response)
                     }
                }
            }
