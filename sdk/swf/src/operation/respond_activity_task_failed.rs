...
impl RespondActivityTaskFailedInput {
    /// Consumes the builder and constructs an Operation<[`RespondActivityTaskFailed`](crate::operation::respond_activity_task_failed::RespondActivityTaskFailed)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::respond_activity_task_failed::RespondActivityTaskFailed, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::respond_activity_task_failed::RespondActivityTaskFailedInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_respond_activity_task_failed::ser_respond_activity_task_failed_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::respond_activity_task_failed::RespondActivityTaskFailed::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskFailed {
                type Output = std::result::Result<crate::operation::respond_activity_task_failed::RespondActivityTaskFailedOutput, crate::operation::respond_activity_task_failed::RespondActivityTaskFailedError>;
