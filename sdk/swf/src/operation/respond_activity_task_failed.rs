...
impl RespondActivityTaskFailedInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::respond_activity_task_failed::RespondActivityTaskFailed::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::respond_activity_task_failed::RespondActivityTaskFailedError
{
