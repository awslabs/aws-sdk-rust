...
impl RespondActivityTaskFailedInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::respond_activity_task_failed::RespondActivityTaskFailed::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskFailed {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_respond_activity_task_failed::de_respond_activity_task_failed_http_response_with_props(status, headers, body)
        }
    }
}
