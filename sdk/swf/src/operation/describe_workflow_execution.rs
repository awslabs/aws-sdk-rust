...
impl DescribeWorkflowExecutionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkflowExecution`](crate::operation::describe_workflow_execution::DescribeWorkflowExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_workflow_execution::DescribeWorkflowExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_workflow_execution::DescribeWorkflowExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_workflow_execution::ser_describe_workflow_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_workflow_execution::DescribeWorkflowExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeWorkflowExecution {
                type Output = std::result::Result<crate::operation::describe_workflow_execution::DescribeWorkflowExecutionOutput, crate::operation::describe_workflow_execution::DescribeWorkflowExecutionError>;
