...
impl DescribeWorkflowExecutionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_workflow_execution::DescribeWorkflowExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkflowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_workflow_execution::de_describe_workflow_execution_http_response_with_props(status, headers, body)
        }
    }
}
