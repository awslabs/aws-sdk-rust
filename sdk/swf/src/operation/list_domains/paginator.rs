...
/// Flattened paginator for `ListDomainsPaginator`
                ...
                impl  ListDomainsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::DomainInfo, aws_smithy_http::result::SdkError<crate::operation::list_domains::ListDomainsError>>> + Unpin
                     {
