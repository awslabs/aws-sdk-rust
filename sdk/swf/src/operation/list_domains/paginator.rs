...
impl ListDomainsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::DomainInfo, ::aws_smithy_http::result::SdkError<crate::operation::list_domains::ListDomainsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_domains_output_domain_infos(page).unwrap_or_default().into_iter())
    }
}
