...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput,
                    crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError,
                > for DeprecateWorkflowTypeFluentBuilder
            {
                fn send(
                    self,
...
impl DeprecateWorkflowTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::deprecate_workflow_type::DeprecateWorkflowType::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::deprecate_workflow_type::DeprecateWorkflowType::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeOutput, crate::operation::deprecate_workflow_type::DeprecateWorkflowTypeError, Self> {
