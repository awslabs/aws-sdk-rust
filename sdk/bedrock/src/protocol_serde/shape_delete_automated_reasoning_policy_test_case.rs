...
pub fn de_delete_automated_reasoning_policy_test_case_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::unhandled,
                        )?;
        ...
        "ConflictException" => {
            crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::delete_automated_reasoning_policy_test_case::DeleteAutomatedReasoningPolicyTestCaseError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_automated_reasoning_policy_test_case_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
