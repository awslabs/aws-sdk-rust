                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "planning" => Some(crate::types::AutomatedReasoningPolicyBuildStepContext::Planning(
                            crate::protocol_serde::shape_automated_reasoning_policy_planning::de_automated_reasoning_policy_planning(tokens)?
                                .ok_or_else(|| {
                        ...
                        "mutation" => Some(crate::types::AutomatedReasoningPolicyBuildStepContext::Mutation(
                            crate::protocol_serde::shape_automated_reasoning_policy_mutation::de_automated_reasoning_policy_mutation(tokens)?
                                .ok_or_else(|| {
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::AutomatedReasoningPolicyBuildStepContext::Unknown)
                        }
                    };
                }
                other => {
