...
pub fn ser_rag_config(
    object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::RagConfig,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::RagConfig::KnowledgeBaseConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_6.key("knowledgeBaseConfig").start_object();
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "knowledgeBaseConfig" => Some(crate::types::RagConfig::KnowledgeBaseConfig(
                            crate::protocol_serde::shape_knowledge_base_config::de_knowledge_base_config(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::RagConfig::Unknown)
                        }
                    };
                }
                other => {
