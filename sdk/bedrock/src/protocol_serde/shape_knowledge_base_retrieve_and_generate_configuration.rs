                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "generationConfiguration" => {
                            builder = builder.set_generation_configuration(
                                crate::protocol_serde::shape_generation_configuration::de_generation_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "orchestrationConfiguration" => {
                            builder = builder.set_orchestration_configuration(
                                crate::protocol_serde::shape_orchestration_configuration::de_orchestration_configuration(tokens, _value, depth + 1)?,
                            );
                        }
