...
impl super::Client {
    ...
    pub fn delete_provisioned_model_throughput(
        &self,
    ) -> crate::operation::delete_provisioned_model_throughput::builders::DeleteProvisionedModelThroughputFluentBuilder {
