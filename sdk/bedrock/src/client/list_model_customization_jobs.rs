...
impl super::Client {
    ...
    ///   - [`status_equals(FineTuningJobStatus)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::status_equals) / [`set_status_equals(Option<FineTuningJobStatus>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::set_status_equals): <p>Return customization jobs with the specified status. </p>
    ///   - [`name_contains(impl Into<String>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::set_name_contains): <p>Return customization jobs only if the job name contains these characters.</p>
    ///   - [`max_results(i32)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::set_max_results): <p>Maximum number of results to return in the response.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::set_next_token): <p>Continuation token from the previous response, for Bedrock to list the next set of results.</p>
    ///   - [`sort_by(SortJobsBy)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::sort_by) / [`set_sort_by(Option<SortJobsBy>)`](crate::operation::list_model_customization_jobs::builders::ListModelCustomizationJobsFluentBuilder::set_sort_by): <p>The field to sort by in the returned list of jobs.</p>
