...
impl super::Client {
    ...
    ///   - [`hyper_parameters(HashMap::<String, String>)`](crate::operation::get_model_customization_job::GetModelCustomizationJobOutput::hyper_parameters): <p>The hyperparameter values for the job. For details on the format for different models, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models-hp.html">Custom model hyperparameters</a>.</p>
