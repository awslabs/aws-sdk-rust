...
impl super::Client {
    ...
    ///   - [`creation_time_before(DateTime)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::creation_time_before) / [`set_creation_time_before(Option<DateTime>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_creation_time_before): <p>Return custom models created before the specified time. </p>
    ///   - [`creation_time_after(DateTime)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::creation_time_after) / [`set_creation_time_after(Option<DateTime>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_creation_time_after): <p>Return custom models created after the specified time. </p>
    ///   - [`name_contains(impl Into<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_name_contains): <p>Return custom models only if the job name contains these characters.</p>
    ///   - [`base_model_arn_equals(impl Into<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::base_model_arn_equals) / [`set_base_model_arn_equals(Option<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_base_model_arn_equals): <p>Return custom models only if the base model ARN matches this parameter.</p>
    ///   - [`foundation_model_arn_equals(impl Into<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::foundation_model_arn_equals) / [`set_foundation_model_arn_equals(Option<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_foundation_model_arn_equals): <p>Return custom models only if the foundation model ARN matches this parameter.</p>
    ///   - [`max_results(i32)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_max_results): <p>Maximum number of results to return in the response.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_next_token): <p>Continuation token from the previous response, for Bedrock to list the next set of results.</p>
    ///   - [`sort_by(SortModelsBy)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::sort_by) / [`set_sort_by(Option<SortModelsBy>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_sort_by): <p>The field to sort by in the returned list of models.</p>
    ///   - [`sort_order(SortOrder)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::sort_order) / [`set_sort_order(Option<SortOrder>)`](crate::operation::list_custom_models::builders::ListCustomModelsFluentBuilder::set_sort_order): <p>The sort order of the results.</p>
