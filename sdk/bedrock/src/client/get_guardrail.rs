...
impl super::Client {
    ...
    ///   - [`guardrail_arn(String)`](crate::operation::get_guardrail::GetGuardrailOutput::guardrail_arn): <p>The ARN of the guardrail.</p>
    ...
    ///   - [`contextual_grounding_policy(Option<GuardrailContextualGroundingPolicy>)`](crate::operation::get_guardrail::GetGuardrailOutput::contextual_grounding_policy): <p>The contextual grounding policy used in the guardrail.</p>
    ///   - [`automated_reasoning_policy(Option<GuardrailAutomatedReasoningPolicy>)`](crate::operation::get_guardrail::GetGuardrailOutput::automated_reasoning_policy): <p>The current Automated Reasoning policy configuration for the guardrail, if any is configured.</p>
    ///   - [`cross_region_details(Option<GuardrailCrossRegionDetails>)`](crate::operation::get_guardrail::GetGuardrailOutput::cross_region_details): <p>Details about the system-defined guardrail profile that you're using with your guardrail, including the guardrail profile ID and Amazon Resource Name (ARN).</p>
