...
impl super::Client {
    ...
    pub fn put_model_invocation_logging_configuration(
        &self,
    ) -> crate::operation::put_model_invocation_logging_configuration::builders::PutModelInvocationLoggingConfigurationFluentBuilder {
        crate::operation::put_model_invocation_logging_configuration::builders::PutModelInvocationLoggingConfigurationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
