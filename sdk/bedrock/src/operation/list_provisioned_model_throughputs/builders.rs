...
impl ListProvisionedModelThroughputsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_provisioned_model_throughputs::paginator::ListProvisionedModelThroughputsPaginator::send) which returns a `Stream`.
