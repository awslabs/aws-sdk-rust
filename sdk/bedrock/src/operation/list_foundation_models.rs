...
/// Orchestration and serialization glue logic for `ListFoundationModels`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListFoundationModels;
impl ListFoundationModels {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_foundation_models::ListFoundationModelsInput,
                    ) -> ::std::result::Result<crate::operation::list_foundation_models::ListFoundationModelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_foundation_models::ListFoundationModelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_foundation_models::ListFoundationModelsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_foundation_models::ListFoundationModelsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFoundationModels {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListFoundationModels");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListFoundationModelsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListFoundationModelsResponseDeserializer));
...
.with_interceptor(ListFoundationModelsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_foundation_models::ListFoundationModelsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_foundation_models::ListFoundationModelsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_foundation_models::ListFoundationModelsError>::new());
...
#[derive(Debug)]
            struct ListFoundationModelsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFoundationModelsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_foundation_models::de_list_foundation_models_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_foundation_models::de_list_foundation_models_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListFoundationModelsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFoundationModelsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_foundation_models::ListFoundationModelsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_foundation_models::ListFoundationModelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/foundation-models").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_foundation_models::ListFoundationModelsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFoundationModelsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListFoundationModelsInput>()
                        .ok_or("failed to downcast to ListFoundationModelsInput")?;
...
/// Error type for the `ListFoundationModelsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListFoundationModelsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListFoundationModelsError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListFoundationModelsError {
    /// Creates the `ListFoundationModelsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListFoundationModelsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListFoundationModelsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListFoundationModelsError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `ListFoundationModelsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ListFoundationModelsError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for ListFoundationModelsError {
...
impl ::std::fmt::Display for ListFoundationModelsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListFoundationModelsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListFoundationModelsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListFoundationModelsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_foundation_models::ListFoundationModelsError {
...
mod _list_foundation_models_output;
