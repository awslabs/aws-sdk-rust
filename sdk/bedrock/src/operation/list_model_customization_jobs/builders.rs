...
impl ListModelCustomizationJobsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_model_customization_jobs::paginator::ListModelCustomizationJobsPaginator::send) which returns a `Stream`.
