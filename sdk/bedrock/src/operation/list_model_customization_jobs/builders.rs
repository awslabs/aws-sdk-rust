...
impl ListModelCustomizationJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_model_customization_jobs::ListModelCustomizationJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_model_customization_jobs::ListModelCustomizationJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_model_customization_jobs::ListModelCustomizationJobsOutput, crate::operation::list_model_customization_jobs::ListModelCustomizationJobsError, Self> {
