...
pub use crate::operation::list_custom_models::_list_custom_models_output::ListCustomModelsOutputBuilder;

pub use crate::operation::list_custom_models::_list_custom_models_input::ListCustomModelsInputBuilder;
...
impl ListCustomModelsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_custom_models();
...
pub struct ListCustomModelsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_custom_models::builders::ListCustomModelsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_custom_models::ListCustomModelsOutput,
                    crate::operation::list_custom_models::ListCustomModelsError,
                > for ListCustomModelsFluentBuilder
            {
                fn send(
                    self,
...
impl ListCustomModelsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_custom_models::builders::ListCustomModelsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_custom_models::ListCustomModelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_custom_models::ListCustomModelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_custom_models::ListCustomModels::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_custom_models::ListCustomModelsOutput, crate::operation::list_custom_models::ListCustomModelsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_custom_models::paginator::ListCustomModelsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
