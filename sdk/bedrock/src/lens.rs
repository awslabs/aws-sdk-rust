...
pub(crate) fn reflens_list_custom_models_output_next_token(
...
pub(crate) fn reflens_list_model_customization_jobs_output_next_token(
...
pub(crate) fn reflens_list_provisioned_model_throughputs_output_next_token(
...
pub(crate) fn lens_list_custom_models_output_model_summaries(
    input: crate::operation::list_custom_models::ListCustomModelsOutput,
...
pub(crate) fn lens_list_model_customization_jobs_output_model_customization_job_summaries(
    input: crate::operation::list_model_customization_jobs::ListModelCustomizationJobsOutput,
...
pub(crate) fn lens_list_provisioned_model_throughputs_output_provisioned_model_summaries(
    input: crate::operation::list_provisioned_model_throughputs::ListProvisionedModelThroughputsOutput,
