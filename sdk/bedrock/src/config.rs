...
impl Builder {
    ...
    /// use aws_sdk_bedrock::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_bedrock::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
