...
impl aws_http::request_id::RequestId for crate::error::TooManyUniqueTargetGroupsPerLoadBalancerException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeTargetGroupAttributesError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::TargetGroupNotFoundException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeLoadBalancerAttributesError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::LoadBalancerNotFoundException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
