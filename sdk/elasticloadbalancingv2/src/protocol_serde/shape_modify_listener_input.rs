...
pub fn ser_modify_listener_input_input(input: &crate::operation::modify_listener::ModifyListenerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
