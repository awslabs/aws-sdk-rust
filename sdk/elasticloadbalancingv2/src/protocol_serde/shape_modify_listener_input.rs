...
pub fn ser_modify_listener_input_input_input(input: &crate::operation::modify_listener::ModifyListenerInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_24 = writer.prefix("MutualAuthentication");
    if let Some(var_25) = &input.mutual_authentication {
        crate::protocol_serde::shape_mutual_authentication_attributes::ser_mutual_authentication_attributes(scope_24, var_25)?;
    }
    writer.finish();
