...
pub fn ser_modify_target_group_input_input(input: &crate::input::ModifyTargetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
