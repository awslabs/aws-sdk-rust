...
pub fn ser_modify_target_group_input_input_input(input: &crate::operation::modify_target_group::ModifyTargetGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
