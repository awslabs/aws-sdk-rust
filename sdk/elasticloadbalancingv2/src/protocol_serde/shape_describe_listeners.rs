...
pub fn de_describe_listeners_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_listeners::DescribeListenersOutput, crate::operation::describe_listeners::DescribeListenersError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_listeners::DescribeListenersError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_listeners_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_listeners::DescribeListenersOutput, crate::operation::describe_listeners::DescribeListenersError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_listeners::builders::DescribeListenersOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_listeners::de_describe_listeners(response.body().as_ref(), output).map_err(crate::operation::describe_listeners::DescribeListenersError::unhandled)?;
