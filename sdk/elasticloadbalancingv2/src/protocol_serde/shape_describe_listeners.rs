...
pub fn de_describe_listeners_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_listeners::DescribeListenersOutput, crate::operation::describe_listeners::DescribeListenersError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::describe_listeners::DescribeListenersOutput, crate::operation::describe_listeners::DescribeListenersError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_listeners::de_describe_listeners(_response_body, output)
            .map_err(crate::operation::describe_listeners::DescribeListenersError::unhandled)?;
...
pub fn de_describe_listeners(
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeListenersResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeListenersResult got {start_el:?}"
            )));
        }
