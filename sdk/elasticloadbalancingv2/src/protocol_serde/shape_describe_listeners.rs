...
pub fn de_describe_listeners_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeListenersOutput, crate::error::DescribeListenersError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeListenersError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_listeners_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeListenersOutput, crate::error::DescribeListenersError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_listeners_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_listeners::de_describe_listeners(response.body().as_ref(), output).map_err(crate::error::DescribeListenersError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_listeners(inp: &[u8], mut builder: crate::output::describe_listeners_output::Builder) -> Result<crate::output::describe_listeners_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
