...
pub fn ser_describe_listener_certificates_input_input(input: &crate::input::DescribeListenerCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
