...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidConfigurationRequest" => {
            crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesError::InvalidConfigurationRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_target_group_attributes::de_modify_target_group_attributes(_response_body, output)
            .map_err(crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyTargetGroupAttributesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyTargetGroupAttributesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyTargetGroupAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyTargetGroupAttributesResult got {start_el:?}"
            )));
        }
