...
pub fn de_set_rule_priorities_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, crate::operation::set_rule_priorities::SetRulePrioritiesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::set_rule_priorities::SetRulePrioritiesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_rule_priorities_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, crate::operation::set_rule_priorities::SetRulePrioritiesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::set_rule_priorities::builders::SetRulePrioritiesOutputBuilder::default();
        output = crate::protocol_serde::shape_set_rule_priorities::de_set_rule_priorities(_response_body, output).map_err(crate::operation::set_rule_priorities::SetRulePrioritiesError::unhandled)?;
