...
pub fn de_modify_listener_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyListenerOutput, crate::error::ModifyListenerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyListenerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_listener_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyListenerOutput, crate::error::ModifyListenerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_listener_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_listener::de_modify_listener(response.body().as_ref(), output).map_err(crate::error::ModifyListenerError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_listener(inp: &[u8], mut builder: crate::output::modify_listener_output::Builder) -> Result<crate::output::modify_listener_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
