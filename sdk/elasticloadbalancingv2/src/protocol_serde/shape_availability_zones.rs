...
pub fn de_availability_zones(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::AvailabilityZone>, aws_smithy_xml::decode::XmlDecodeError> {
