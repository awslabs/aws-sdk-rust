...
pub fn ser_describe_rules_input_input_input(input: &crate::operation::describe_rules::DescribeRulesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
