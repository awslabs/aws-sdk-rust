...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_rule_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_rule::ModifyRuleOutput, crate::operation::modify_rule::ModifyRuleError> {
    Ok({
        #[allow(unused_mut)]
