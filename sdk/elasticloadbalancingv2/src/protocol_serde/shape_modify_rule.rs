...
pub fn de_modify_rule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyRuleOutput, crate::error::ModifyRuleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyRuleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_rule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyRuleOutput, crate::error::ModifyRuleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_rule_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_rule::de_modify_rule(response.body().as_ref(), output).map_err(crate::error::ModifyRuleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_rule(inp: &[u8], mut builder: crate::output::modify_rule_output::Builder) -> Result<crate::output::modify_rule_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
