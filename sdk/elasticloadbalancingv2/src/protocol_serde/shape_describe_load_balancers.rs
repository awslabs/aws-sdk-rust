...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_load_balancers_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_load_balancers::DescribeLoadBalancersOutput, crate::operation::describe_load_balancers::DescribeLoadBalancersError> {
    Ok({
        #[allow(unused_mut)]
