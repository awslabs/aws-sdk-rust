...
pub fn de_add_listener_certificates_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::add_listener_certificates::AddListenerCertificatesOutput, crate::operation::add_listener_certificates::AddListenerCertificatesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::add_listener_certificates::AddListenerCertificatesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_listener_certificates_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::add_listener_certificates::AddListenerCertificatesOutput, crate::operation::add_listener_certificates::AddListenerCertificatesError> {
    Ok({
        #[allow(unused_mut)]
