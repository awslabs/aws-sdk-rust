...
pub fn de_add_listener_certificates_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::add_listener_certificates::AddListenerCertificatesOutput, crate::operation::add_listener_certificates::AddListenerCertificatesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_listener_certificates_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::add_listener_certificates::AddListenerCertificatesOutput, crate::operation::add_listener_certificates::AddListenerCertificatesError> {
    Ok({
        #[allow(unused_mut)]
