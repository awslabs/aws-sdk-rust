...
#[allow(unused_mut)]
pub fn ser_target_group_tuple(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetGroupTuple) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_group_tuple(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetGroupTuple, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
