...
#[allow(unused_mut)]
pub fn ser_target_group_stickiness_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetGroupStickinessConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
