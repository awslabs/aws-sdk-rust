...
#[allow(unused_mut)]
pub fn ser_target_group_stickiness_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetGroupStickinessConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_group_stickiness_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetGroupStickinessConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
