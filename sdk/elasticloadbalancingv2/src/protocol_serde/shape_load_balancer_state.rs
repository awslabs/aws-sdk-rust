...
pub fn de_load_balancer_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
