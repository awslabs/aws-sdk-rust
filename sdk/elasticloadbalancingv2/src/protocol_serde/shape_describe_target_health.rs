...
pub fn de_describe_target_health_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_health::DescribeTargetHealthOutput, crate::operation::describe_target_health::DescribeTargetHealthError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_target_health_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_health::DescribeTargetHealthOutput, crate::operation::describe_target_health::DescribeTargetHealthError> {
    Ok({
        #[allow(unused_mut)]
