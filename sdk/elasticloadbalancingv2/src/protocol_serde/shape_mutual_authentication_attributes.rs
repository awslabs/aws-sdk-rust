...
#[allow(unused_mut)]
pub fn ser_mutual_authentication_attributes(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MutualAuthenticationAttributes) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_mutual_authentication_attributes(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MutualAuthenticationAttributes, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
