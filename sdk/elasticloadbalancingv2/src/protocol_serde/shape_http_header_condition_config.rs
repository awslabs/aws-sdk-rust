...
#[allow(unused_mut)]
pub fn ser_http_header_condition_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::HttpHeaderConditionConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
