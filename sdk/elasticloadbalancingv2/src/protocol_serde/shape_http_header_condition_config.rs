...
#[allow(unused_mut)]
pub fn ser_http_header_condition_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::HttpHeaderConditionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_http_header_condition_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HttpHeaderConditionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
