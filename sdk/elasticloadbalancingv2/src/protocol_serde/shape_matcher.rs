...
#[allow(unused_mut)]
pub fn ser_matcher(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Matcher) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_matcher(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Matcher, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
