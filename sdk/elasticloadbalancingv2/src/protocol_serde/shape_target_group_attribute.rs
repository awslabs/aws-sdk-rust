...
#[allow(unused_mut)]
pub fn ser_target_group_attribute(
    mut writer: ::aws_smithy_query::QueryValueWriter,
    input: &crate::types::TargetGroupAttribute,
...
) -> ::std::result::Result<crate::types::TargetGroupAttribute, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
