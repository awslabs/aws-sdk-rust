...
#[allow(unused_mut)]
pub fn ser_target_group_attribute(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetGroupAttribute) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_group_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetGroupAttribute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
