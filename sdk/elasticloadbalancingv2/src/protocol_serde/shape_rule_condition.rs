...
#[allow(unused_mut)]
pub fn ser_rule_condition(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RuleCondition) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
