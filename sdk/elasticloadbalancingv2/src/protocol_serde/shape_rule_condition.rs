...
#[allow(unused_mut)]
pub fn ser_rule_condition(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::RuleCondition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_rule_condition(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RuleCondition, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
