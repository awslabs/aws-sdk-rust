...
pub fn ser_set_subnets_input_input_input(input: &crate::operation::set_subnets::SetSubnetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
