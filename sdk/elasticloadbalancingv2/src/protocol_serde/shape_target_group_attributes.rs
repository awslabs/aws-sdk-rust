...
pub fn de_target_group_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TargetGroupAttribute>, aws_smithy_xml::decode::XmlDecodeError> {
