...
#[allow(unused_mut)]
pub fn ser_query_string_key_value_pair(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::QueryStringKeyValuePair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_query_string_key_value_pair(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::QueryStringKeyValuePair, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
