...
pub fn ser_modify_rule_input_input_input(input: &crate::operation::modify_rule::ModifyRuleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
