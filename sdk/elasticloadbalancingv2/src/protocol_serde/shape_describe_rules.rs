...
pub fn de_describe_rules_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeRulesOutput, crate::error::DescribeRulesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeRulesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_rules_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeRulesOutput, crate::error::DescribeRulesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_rules_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_rules::de_describe_rules(response.body().as_ref(), output).map_err(crate::error::DescribeRulesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_rules(inp: &[u8], mut builder: crate::output::describe_rules_output::Builder) -> Result<crate::output::describe_rules_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
