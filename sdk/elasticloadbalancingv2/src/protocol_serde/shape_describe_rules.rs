...
pub fn de_describe_rules_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_rules::DescribeRulesOutput, crate::operation::describe_rules::DescribeRulesError> {
    #[allow(unused_mut)]
...
pub fn de_describe_rules_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_rules::de_describe_rules(_response_body, output)
            .map_err(crate::operation::describe_rules::DescribeRulesError::unhandled)?;
...
pub fn de_describe_rules(
...
) -> std::result::Result<crate::operation::describe_rules::builders::DescribeRulesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeRulesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeRulesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeRulesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeRulesResult got {start_el:?}"
            )));
        }
