...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_rules_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_rules::DescribeRulesOutput, crate::operation::describe_rules::DescribeRulesError> {
...
) -> Result<crate::operation::describe_rules::builders::DescribeRulesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
