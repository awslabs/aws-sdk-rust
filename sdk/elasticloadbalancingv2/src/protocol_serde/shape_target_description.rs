...
#[allow(unused_mut)]
pub fn ser_target_description(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetDescription) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
