...
#[allow(unused_mut)]
pub fn ser_target_description(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetDescription) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
