...
pub fn ser_create_listener_input_input(input: &crate::input::CreateListenerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
