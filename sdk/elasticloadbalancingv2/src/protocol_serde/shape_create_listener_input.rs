...
pub fn ser_create_listener_input_input_input(input: &crate::operation::create_listener::CreateListenerInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
