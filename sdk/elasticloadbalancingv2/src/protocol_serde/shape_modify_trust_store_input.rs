...
pub fn ser_modify_trust_store_input_input_input(input: &crate::operation::modify_trust_store::ModifyTrustStoreInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
