...
pub fn ser_add_tags_input_input_input(input: &crate::operation::add_tags::AddTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
