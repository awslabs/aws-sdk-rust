...
pub fn de_set_subnets_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::set_subnets::SetSubnetsOutput, crate::operation::set_subnets::SetSubnetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::set_subnets::SetSubnetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_subnets_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::set_subnets::SetSubnetsOutput, crate::operation::set_subnets::SetSubnetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::set_subnets::builders::SetSubnetsOutputBuilder::default();
        output = crate::protocol_serde::shape_set_subnets::de_set_subnets(_response_body, output).map_err(crate::operation::set_subnets::SetSubnetsError::unhandled)?;
