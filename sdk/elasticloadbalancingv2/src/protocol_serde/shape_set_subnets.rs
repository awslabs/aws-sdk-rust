...
pub fn de_set_subnets_http_error(
    ...
    Err(match error_code {
        ...
        "CapacityReservationPending" => crate::operation::set_subnets::SetSubnetsError::CapacityReservationPendingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_set_subnets(
...
) -> std::result::Result<crate::operation::set_subnets::builders::SetSubnetsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("SetSubnetsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected SetSubnetsResult got {start_el:?}"
            )));
        }
