...
pub fn de_set_subnets_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::set_subnets::SetSubnetsOutput, crate::operation::set_subnets::SetSubnetsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_subnets_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::set_subnets::SetSubnetsOutput, crate::operation::set_subnets::SetSubnetsError> {
    Ok({
        #[allow(unused_mut)]
