...
pub fn ser_create_rule_input_input_input(input: &crate::operation::create_rule::CreateRuleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
