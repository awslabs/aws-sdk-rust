...
pub fn de_describe_target_groups_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_groups::DescribeTargetGroupsOutput, crate::operation::describe_target_groups::DescribeTargetGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_target_groups::DescribeTargetGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_target_groups_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_groups::DescribeTargetGroupsOutput, crate::operation::describe_target_groups::DescribeTargetGroupsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_target_groups::builders::DescribeTargetGroupsOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_target_groups::de_describe_target_groups(_response_body, output).map_err(crate::operation::describe_target_groups::DescribeTargetGroupsError::unhandled)?;
