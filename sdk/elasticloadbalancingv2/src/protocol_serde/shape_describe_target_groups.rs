...
pub fn de_describe_target_groups_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_groups::DescribeTargetGroupsOutput, crate::operation::describe_target_groups::DescribeTargetGroupsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_target_groups_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_target_groups::DescribeTargetGroupsOutput, crate::operation::describe_target_groups::DescribeTargetGroupsError> {
    Ok({
        #[allow(unused_mut)]
