...
pub fn ser_create_trust_store_input_input_input(input: &crate::operation::create_trust_store::CreateTrustStoreInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
