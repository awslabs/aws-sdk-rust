...
pub fn de_remove_tags_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_tags::RemoveTagsOutput, crate::operation::remove_tags::RemoveTagsError> {
    ...
    Err(match error_code {
        ...
        "TrustStoreNotFound" => crate::operation::remove_tags::RemoveTagsError::TrustStoreNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::TrustStoreNotFoundExceptionBuilder::default();
                    output = crate::protocol_serde::shape_trust_store_not_found_exception::de_trust_store_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::remove_tags::RemoveTagsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
