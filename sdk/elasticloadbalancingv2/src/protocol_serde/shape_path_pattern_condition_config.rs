...
#[allow(unused_mut)]
pub fn ser_path_pattern_condition_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PathPatternConditionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_path_pattern_condition_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PathPatternConditionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
