...
#[allow(unused_mut)]
pub fn ser_path_pattern_condition_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PathPatternConditionConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
