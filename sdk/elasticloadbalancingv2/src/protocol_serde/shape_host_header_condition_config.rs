...
#[allow(unused_mut)]
pub fn ser_host_header_condition_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::HostHeaderConditionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_host_header_condition_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HostHeaderConditionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
