...
pub fn ser_set_security_groups_input_input(input: &crate::input::SetSecurityGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
