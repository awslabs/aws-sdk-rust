...
#[allow(unused_mut)]
pub fn ser_query_string_condition_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::QueryStringConditionConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
