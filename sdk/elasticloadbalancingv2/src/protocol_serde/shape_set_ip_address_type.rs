...
pub fn de_set_ip_address_type_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SetIpAddressTypeOutput, crate::error::SetIpAddressTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::SetIpAddressTypeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_ip_address_type_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SetIpAddressTypeOutput, crate::error::SetIpAddressTypeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::set_ip_address_type_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_set_ip_address_type::de_set_ip_address_type(response.body().as_ref(), output).map_err(crate::error::SetIpAddressTypeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_set_ip_address_type(inp: &[u8], mut builder: crate::output::set_ip_address_type_output::Builder) -> Result<crate::output::set_ip_address_type_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
