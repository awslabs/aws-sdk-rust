...
pub fn de_set_ip_address_type_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::set_ip_address_type::SetIpAddressTypeOutput, crate::operation::set_ip_address_type::SetIpAddressTypeError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::set_ip_address_type::SetIpAddressTypeOutput, crate::operation::set_ip_address_type::SetIpAddressTypeError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_set_ip_address_type::de_set_ip_address_type(_response_body, output)
            .map_err(crate::operation::set_ip_address_type::SetIpAddressTypeError::unhandled)?;
...
pub fn de_set_ip_address_type(
...
) -> std::result::Result<crate::operation::set_ip_address_type::builders::SetIpAddressTypeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("SetIpAddressTypeResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected SetIpAddressTypeResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("SetIpAddressTypeResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected SetIpAddressTypeResult got {start_el:?}"
            )));
        }
