...
pub fn de_load_balancer_address(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerAddress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
