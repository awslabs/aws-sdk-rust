...
#[allow(unused_mut)]
pub fn de_operation_not_permitted_exception_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::OperationNotPermittedExceptionBuilder,
) -> std::result::Result<crate::types::error::builders::OperationNotPermittedExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
