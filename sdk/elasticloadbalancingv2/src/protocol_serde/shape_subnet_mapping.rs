...
#[allow(unused_mut)]
pub fn ser_subnet_mapping(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SubnetMapping) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
