...
#[allow(unused_mut)]
pub fn ser_subnet_mapping(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SubnetMapping) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
