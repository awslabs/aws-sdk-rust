...
#[allow(unused_mut)]
pub fn ser_authenticate_cognito_action_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AuthenticateCognitoActionConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
