...
#[allow(unused_mut)]
pub fn ser_authenticate_cognito_action_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AuthenticateCognitoActionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_authenticate_cognito_action_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AuthenticateCognitoActionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
