...
#[allow(unused_mut)]
pub fn ser_source_ip_condition_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SourceIpConditionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_source_ip_condition_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SourceIpConditionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
