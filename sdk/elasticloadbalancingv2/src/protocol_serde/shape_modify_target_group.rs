...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_target_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_target_group::ModifyTargetGroupOutput, crate::operation::modify_target_group::ModifyTargetGroupError> {
    Ok({
        #[allow(unused_mut)]
