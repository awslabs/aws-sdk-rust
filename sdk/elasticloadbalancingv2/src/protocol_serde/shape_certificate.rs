...
#[allow(unused_mut)]
pub fn ser_certificate(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Certificate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_certificate(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Certificate, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
