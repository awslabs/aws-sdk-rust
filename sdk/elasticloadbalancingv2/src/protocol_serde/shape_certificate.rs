...
#[allow(unused_mut)]
pub fn ser_certificate(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::Certificate) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
