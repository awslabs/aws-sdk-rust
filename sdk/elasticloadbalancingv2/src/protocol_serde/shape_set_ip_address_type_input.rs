...
pub fn ser_set_ip_address_type_input_input(input: &crate::input::SetIpAddressTypeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
