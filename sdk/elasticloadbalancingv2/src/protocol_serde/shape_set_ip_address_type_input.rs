...
pub fn ser_set_ip_address_type_input_input_input(input: &crate::operation::set_ip_address_type::SetIpAddressTypeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
