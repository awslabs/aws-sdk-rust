...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesError::unhandled)?;
    ...
    Err(match error_code {
        "TargetGroupNotFound" => {
            crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesError::TargetGroupNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_target_group_attributes::de_describe_target_group_attributes(_response_body, output)
            .map_err(crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeTargetGroupAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeTargetGroupAttributesResult got {start_el:?}"
            )));
        }
