...
#[allow(unused_mut)]
pub fn ser_load_balancer_attribute(
    mut writer: ::aws_smithy_query::QueryValueWriter,
    input: &crate::types::LoadBalancerAttribute,
...
) -> ::std::result::Result<crate::types::LoadBalancerAttribute, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
