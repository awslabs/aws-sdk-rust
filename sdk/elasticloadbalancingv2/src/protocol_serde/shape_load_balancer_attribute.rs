...
#[allow(unused_mut)]
pub fn ser_load_balancer_attribute(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LoadBalancerAttribute) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_load_balancer_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerAttribute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
