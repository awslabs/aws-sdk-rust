...
impl super::Client {
    ...
    ///   - [`conditions(RuleCondition)`](crate::operation::modify_rule::builders::ModifyRuleFluentBuilder::conditions) / [`set_conditions(Option<Vec<RuleCondition>>)`](crate::operation::modify_rule::builders::ModifyRuleFluentBuilder::set_conditions): <p>The conditions.</p>
    ///   - [`actions(Action)`](crate::operation::modify_rule::builders::ModifyRuleFluentBuilder::actions) / [`set_actions(Option<Vec<Action>>)`](crate::operation::modify_rule::builders::ModifyRuleFluentBuilder::set_actions): <p>The actions.</p>
