...
impl super::Client {
    ...
    ///   - [`transforms(RuleTransform)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::transforms) / [`set_transforms(Option<Vec::<RuleTransform>>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_transforms):<br>required: **false**<br><p>The transforms to apply to requests that match this rule. You can add one host header rewrite transform and one URL rewrite transform.</p><br>
