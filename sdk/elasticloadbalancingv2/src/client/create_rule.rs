...
impl super::Client {
    ...
    ///   - [`conditions(RuleCondition)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::conditions) / [`set_conditions(Option<Vec<RuleCondition>>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_conditions): <p>The conditions.</p>
    ...
    ///   - [`actions(Action)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::actions) / [`set_actions(Option<Vec<Action>>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_actions): <p>The actions.</p>
    ///   - [`tags(Tag)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_tags): <p>The tags to assign to the rule.</p>
