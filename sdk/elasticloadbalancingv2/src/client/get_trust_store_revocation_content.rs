...
impl super::Client {
    ...
    pub fn get_trust_store_revocation_content(&self) -> crate::operation::get_trust_store_revocation_content::builders::GetTrustStoreRevocationContentFluentBuilder {
