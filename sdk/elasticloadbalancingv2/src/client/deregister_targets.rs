...
impl super::Client {
    ...
    ///   - [`targets(TargetDescription)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::targets) / [`set_targets(Option<Vec<TargetDescription>>)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::set_targets): <p>The targets. If you specified a port override when you registered a target, you must specify both the target ID and the port when you deregister it.</p>
