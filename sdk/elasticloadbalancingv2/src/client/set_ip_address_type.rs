...
impl super::Client {
    ...
    ///   - [`load_balancer_arn(impl ::std::convert::Into<String>)`](crate::operation::set_ip_address_type::builders::SetIpAddressTypeFluentBuilder::load_balancer_arn) / [`set_load_balancer_arn(Option<String>)`](crate::operation::set_ip_address_type::builders::SetIpAddressTypeFluentBuilder::set_load_balancer_arn): <p>The Amazon Resource Name (ARN) of the load balancer.</p>
