...
impl ModifyRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_rule::ModifyRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_rule::de_modify_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_modify_rule::de_modify_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
