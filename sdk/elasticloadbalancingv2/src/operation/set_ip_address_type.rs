...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIpAddressType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("SetIpAddressType", "elasticloadbalancingv2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetIpAddressTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_set_ip_address_type_input::ser_set_ip_address_type_input_input_input(&input)?,
        );
