...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_trust_store_input::ser_create_trust_store_input_input_input(&input)?);
...
impl ::std::error::Error for CreateTrustStoreError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::DuplicateTrustStoreNameException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::TooManyTrustStoresException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
