...
impl AddListenerCertificates {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_listener_certificates::AddListenerCertificatesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_listener_certificates::AddListenerCertificatesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing v2.AddListenerCertificates",
            "rpc.service" = "Elastic Load Balancing v2",
            "rpc.method" = "AddListenerCertificates",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddListenerCertificates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddListenerCertificatesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddListenerCertificatesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddListenerCertificates")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddListenerCertificates")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AddListenerCertificatesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AddListenerCertificatesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddListenerCertificatesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AddListenerCertificatesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddListenerCertificatesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_add_listener_certificates::de_add_listener_certificates_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_listener_certificates::de_add_listener_certificates_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddListenerCertificatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::add_listener_certificates::AddListenerCertificatesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::add_listener_certificates::AddListenerCertificatesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_add_listener_certificates_input::ser_add_listener_certificates_input_input_input(&input)?,
        );
