...
impl AddListenerCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`AddListenerCertificates`](crate::operation::add_listener_certificates::AddListenerCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_listener_certificates::AddListenerCertificates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_listener_certificates::AddListenerCertificatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_listener_certificates::AddListenerCertificates::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddListenerCertificates {
                type Output = std::result::Result<crate::operation::add_listener_certificates::AddListenerCertificatesOutput, crate::operation::add_listener_certificates::AddListenerCertificatesError>;
