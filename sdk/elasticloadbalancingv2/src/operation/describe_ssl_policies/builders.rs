...
impl DescribeSSLPoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_ssl_policies::DescribeSslPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_ssl_policies::DescribeSSLPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_ssl_policies::DescribeSslPoliciesOutput, crate::operation::describe_ssl_policies::DescribeSSLPoliciesError, Self> {
