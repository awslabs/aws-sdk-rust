...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateListener {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateListener", "elasticloadbalancingv2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateListenerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_listener_input::ser_create_listener_input_input_input(&input)?,
        );
...
impl CreateListenerError {
    ...
    /// Returns `true` if the error kind is `CreateListenerError::TrustStoreNotFoundException`.
    pub fn is_trust_store_not_found_exception(&self) -> bool {
        matches!(self, Self::TrustStoreNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateListenerError::TrustStoreNotReadyException`.
