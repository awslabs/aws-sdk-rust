...
impl RemoveTrustStoreRevocationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_trust_store_revocations::RemoveTrustStoreRevocationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_trust_store_revocations::RemoveTrustStoreRevocationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_trust_store_revocations::RemoveTrustStoreRevocationsOutput, crate::operation::remove_trust_store_revocations::RemoveTrustStoreRevocationsError, Self> {
