...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterTargets {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RegisterTargets", "elasticloadbalancingv2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterTargetsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_targets_input::ser_register_targets_input_input(
            &input,
        )?);
