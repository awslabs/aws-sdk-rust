...
impl DeregisterTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterTargets`](crate::operation::deregister_targets::DeregisterTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_targets::DeregisterTargets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_targets::DeregisterTargetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_targets::DeregisterTargets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterTargets {
                type Output = std::result::Result<crate::operation::deregister_targets::DeregisterTargetsOutput, crate::operation::deregister_targets::DeregisterTargetsError>;
