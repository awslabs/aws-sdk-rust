...
impl RemoveTags {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("elasticloadbalancingv2", "RemoveTags", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveTags {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RemoveTags", "elasticloadbalancingv2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_tags_input::ser_remove_tags_input_input(&input)?);
