...
impl RemoveListenerCertificatesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_listener_certificates::RemoveListenerCertificates::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveListenerCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_listener_certificates::de_remove_listener_certificates_http_response_with_props(status, headers, body)
        }
    }
}
