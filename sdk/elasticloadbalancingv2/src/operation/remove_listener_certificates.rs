...
impl RemoveListenerCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`RemoveListenerCertificates`](crate::operation::remove_listener_certificates::RemoveListenerCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_listener_certificates::RemoveListenerCertificates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_listener_certificates::RemoveListenerCertificatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_listener_certificates::RemoveListenerCertificates::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveListenerCertificates {
                type Output = std::result::Result<crate::operation::remove_listener_certificates::RemoveListenerCertificatesOutput, crate::operation::remove_listener_certificates::RemoveListenerCertificatesError>;
