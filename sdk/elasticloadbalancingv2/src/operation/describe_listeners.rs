...
impl DescribeListenersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_listeners::DescribeListeners::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeListeners {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_listeners::de_describe_listeners_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_listeners::DescribeListenersError
{
