...
impl SetSecurityGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_security_groups::SetSecurityGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSecurityGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_security_groups::de_set_security_groups_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_security_groups::SetSecurityGroupsError
{
