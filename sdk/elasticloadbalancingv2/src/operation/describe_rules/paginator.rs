...
/// Paginator for [`DescribeRules`](crate::operation::describe_rules::DescribeRules)
pub struct DescribeRulesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::describe_rules::builders::DescribeRulesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl DescribeRulesPaginator {
    ...
    pub fn items(self) -> crate::operation::describe_rules::paginator::DescribeRulesPaginatorItems {
        crate::operation::describe_rules::paginator::DescribeRulesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_rules::DescribeRules::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_rules_output_output_next_marker(resp);
...
/// Flattened paginator for `DescribeRulesPaginator`
///
/// This is created with [`.items()`](DescribeRulesPaginator::items)
pub struct DescribeRulesPaginatorItems(DescribeRulesPaginator);

impl DescribeRulesPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_describe_rules_output_output_rules(page).unwrap_or_default().into_iter())
    }
}
