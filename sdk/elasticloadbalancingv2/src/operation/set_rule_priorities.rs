...
impl SetRulePriorities {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing v2.SetRulePriorities",
            "rpc.service" = "Elastic Load Balancing v2",
            "rpc.method" = "SetRulePriorities",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetRulePriorities {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetRulePrioritiesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetRulePrioritiesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetRulePriorities")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetRulePrioritiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::set_rule_priorities::SetRulePrioritiesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_set_rule_priorities_input::ser_set_rule_priorities_input_input_input(&input)?,
        );
