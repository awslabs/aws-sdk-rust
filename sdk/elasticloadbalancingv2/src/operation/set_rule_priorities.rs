...
impl SetRulePrioritiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_rule_priorities::SetRulePriorities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetRulePriorities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_rule_priorities::de_set_rule_priorities_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_rule_priorities::SetRulePrioritiesError
{
