...
/// Orchestration and serialization glue logic for `SetRulePriorities`.
...
impl SetRulePriorities {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_rule_priorities::SetRulePrioritiesInput,
                    ) -> ::std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_rule_priorities::SetRulePrioritiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetRulePriorities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetRulePriorities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetRulePrioritiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetRulePrioritiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetRulePriorities")
...
.with_interceptor(SetRulePrioritiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_rule_priorities::SetRulePrioritiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_rule_priorities::SetRulePrioritiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_rule_priorities::SetRulePrioritiesError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetRulePrioritiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_rule_priorities::de_set_rule_priorities_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_rule_priorities::de_set_rule_priorities_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetRulePrioritiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_rule_priorities::SetRulePrioritiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_rule_priorities::SetRulePrioritiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_rule_priorities_input::ser_set_rule_priorities_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SetRulePrioritiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetRulePrioritiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetRulePrioritiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetRulePrioritiesInput>()
                        .ok_or("failed to downcast to SetRulePrioritiesInput")?;
...
pub enum SetRulePrioritiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetRulePrioritiesError) for what information is available for the error.")]
...
impl SetRulePrioritiesError {
    /// Creates the `SetRulePrioritiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetRulePrioritiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetRulePrioritiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_rule_priorities::SetRulePrioritiesError {
...
mod _set_rule_priorities_output;
