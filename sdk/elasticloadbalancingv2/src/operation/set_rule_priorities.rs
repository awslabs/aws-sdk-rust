...
impl SetRulePrioritiesInput {
    /// Consumes the builder and constructs an Operation<[`SetRulePriorities`](crate::operation::set_rule_priorities::SetRulePriorities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_rule_priorities::SetRulePriorities, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_rule_priorities::SetRulePrioritiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_rule_priorities::SetRulePriorities::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetRulePriorities {
                type Output = std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, crate::operation::set_rule_priorities::SetRulePrioritiesError>;
