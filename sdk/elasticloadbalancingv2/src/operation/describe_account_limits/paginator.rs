                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_account_limits_output_output_next_marker(resp);
...
impl DescribeAccountLimitsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_account_limits_output_output_limits(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
