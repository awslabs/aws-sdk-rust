...
impl DescribeSslPoliciesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ssl_policies::DescribeSSLPolicies::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("DescribeSSLPolicies", "elasticloadbalancingv2"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSSLPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_ssl_policies::de_describe_ssl_policies_http_response_with_props(status, headers, body)
        }
    }
}
