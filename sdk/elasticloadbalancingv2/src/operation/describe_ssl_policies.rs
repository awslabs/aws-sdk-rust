...
impl DescribeSslPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSSLPolicies`](crate::operation::describe_ssl_policies::DescribeSSLPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_ssl_policies::DescribeSSLPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_ssl_policies::DescribeSslPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_ssl_policies_input::ser_describe_ssl_policies_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ssl_policies::DescribeSSLPolicies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSSLPolicies {
                type Output = std::result::Result<crate::operation::describe_ssl_policies::DescribeSslPoliciesOutput, crate::operation::describe_ssl_policies::DescribeSSLPoliciesError>;
