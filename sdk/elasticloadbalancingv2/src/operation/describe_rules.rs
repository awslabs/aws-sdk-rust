...
impl DescribeRulesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_rules::DescribeRules::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRules {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_rules::de_describe_rules_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_rules::de_describe_rules_http_response_with_props(
                status, headers, body,
            )
        }
    }
