...
impl AddTrustStoreRevocationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_trust_store_revocations::AddTrustStoreRevocationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_trust_store_revocations::AddTrustStoreRevocationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_trust_store_revocations::AddTrustStoreRevocationsOutput, crate::operation::add_trust_store_revocations::AddTrustStoreRevocationsError, Self> {
