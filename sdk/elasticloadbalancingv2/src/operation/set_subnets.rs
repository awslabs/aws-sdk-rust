...
impl SetSubnets {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_subnets::SetSubnetsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_subnets::SetSubnetsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing v2.SetSubnets",
            "rpc.service" = "Elastic Load Balancing v2",
            "rpc.method" = "SetSubnets",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetSubnets {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetSubnets")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetSubnetsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetSubnetsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetSubnetsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetSubnetsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetSubnetsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_subnets::de_set_subnets_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_subnets::de_set_subnets_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetSubnetsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_subnets_input::ser_set_subnets_input_input_input(&input)?);
