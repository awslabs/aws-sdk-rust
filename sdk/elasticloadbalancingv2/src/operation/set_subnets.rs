...
impl SetSubnetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_subnets::SetSubnets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSubnets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_subnets::de_set_subnets_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_set_subnets::de_set_subnets_http_response_with_props(
                status, headers, body,
            )
        }
    }
