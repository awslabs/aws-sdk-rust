...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_trust_store_input::ser_delete_trust_store_input_input_input(&input)?);
...
impl ::std::error::Error for DeleteTrustStoreError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::TrustStoreInUseException(_inner) =>
