...
impl  DescribeTrustStoresInput  {
    ...
    pub fn trust_store_arns(&self) -> & [::std::string::String] {
        self.trust_store_arns.as_deref()
        .unwrap_or_default()
    }
    /// <p>The names of the trust stores.</p>
    /// 
...
impl DescribeTrustStoresInputBuilder {
    ...
    pub fn set_trust_store_arns(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.trust_store_arns = input; self
    }
    /// <p>The Amazon Resource Name (ARN) of the trust store.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_trust_stores::DescribeTrustStoresInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_trust_stores::DescribeTrustStoresInput {
