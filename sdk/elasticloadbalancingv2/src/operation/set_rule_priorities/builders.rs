...
impl SetRulePrioritiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_rule_priorities::SetRulePrioritiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, crate::operation::set_rule_priorities::SetRulePrioritiesError, Self> {
