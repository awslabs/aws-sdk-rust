...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTargetGroupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ProtocolVersion") {
            if let ::std::option::Option::Some(value) = input.protocol_version.as_deref() {
                captured.insert("ProtocolVersion", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTargetGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_target_group_input::ser_create_target_group_input_input_input(&input)?,
        );
