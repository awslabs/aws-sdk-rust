...
impl AddTags {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("elasticloadbalancingv2", "AddTags", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddTags {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AddTags", "elasticloadbalancingv2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_tags_input::ser_add_tags_input_input_input(&input)?);
...
impl AddTagsError {
    ...
    /// Returns `true` if the error kind is `AddTagsError::TrustStoreNotFoundException`.
