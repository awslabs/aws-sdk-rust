...
/// Orchestration and serialization glue logic for `DescribeLoadBalancers`.
...
impl DescribeLoadBalancers {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_load_balancers::DescribeLoadBalancersInput,
                    ) -> ::std::result::Result<crate::operation::describe_load_balancers::DescribeLoadBalancersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_load_balancers::DescribeLoadBalancersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_load_balancers::DescribeLoadBalancersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_load_balancers::DescribeLoadBalancersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLoadBalancers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeLoadBalancers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeLoadBalancersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeLoadBalancersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLoadBalancers")
...
.with_interceptor(DescribeLoadBalancersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_load_balancers::DescribeLoadBalancersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_load_balancers::DescribeLoadBalancersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_load_balancers::DescribeLoadBalancersError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLoadBalancersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_load_balancers::de_describe_load_balancers_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_load_balancers::de_describe_load_balancers_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLoadBalancersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_load_balancers::DescribeLoadBalancersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_load_balancers::DescribeLoadBalancersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_load_balancers_input::ser_describe_load_balancers_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeLoadBalancersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeLoadBalancersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeLoadBalancersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeLoadBalancersInput>()
                        .ok_or("failed to downcast to DescribeLoadBalancersInput")?;
...
pub enum DescribeLoadBalancersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeLoadBalancersError) for what information is available for the error.")]
...
impl DescribeLoadBalancersError {
    /// Creates the `DescribeLoadBalancersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLoadBalancersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeLoadBalancersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_load_balancers::DescribeLoadBalancersError {
...
mod _describe_load_balancers_output;
