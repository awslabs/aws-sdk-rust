...
///
/// Fluent builder for the `load_balancer_exists` waiter.
///
...
pub struct LoadBalancerExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_load_balancers::builders::DescribeLoadBalancersInputBuilder,
}
impl LoadBalancerExistsFluentBuilder {
    /// Creates a new `LoadBalancerExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::load_balancer_exists::LoadBalancerExistsFinalPoll,
        crate::waiters::load_balancer_exists::WaitUntilLoadBalancerExistsError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_load_balancers_c955e57777ec0d736(result) {
...
/// Successful return type for the `load_balancer_exists` waiter.
pub type LoadBalancerExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_load_balancers::DescribeLoadBalancersOutput,
...
/// Error type for the `load_balancer_exists` waiter.
pub type WaitUntilLoadBalancerExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_load_balancers::DescribeLoadBalancersOutput,
    crate::operation::describe_load_balancers::DescribeLoadBalancersError,
>;
