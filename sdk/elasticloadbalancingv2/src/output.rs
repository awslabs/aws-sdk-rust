...
pub struct ModifyTargetGroupOutput  {
    ...
    #[doc(hidden)]pub target_groups: std::option::Option<std::vec::Vec<crate::model::TargetGroup>>,
}
...
pub struct DescribeTargetHealthOutput  {
    ...
    #[doc(hidden)]pub target_health_descriptions: std::option::Option<std::vec::Vec<crate::model::TargetHealthDescription>>,
}
...
impl  std::fmt::Debug for DescribeTargetHealthOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("target_health_descriptions", &self.target_health_descriptions);
        formatter.finish()
    }
}
...
pub struct DescribeSslPoliciesOutput  {
    ...
    #[doc(hidden)]pub ssl_policies: std::option::Option<std::vec::Vec<crate::model::SslPolicy>>,
    /// <p>If there are additional results, this is the marker for the next set of results. Otherwise, this is null.</p>
    #[doc(hidden)]pub next_marker: std::option::Option<std::string::String>,
}
