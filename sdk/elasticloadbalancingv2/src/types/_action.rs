...
/// <p>Each rule must include exactly one of the following routing actions: <code>forward</code>, <code>fixed-response</code>, or <code>redirect</code>, and it must be the last action to be performed.</p>
/// <p>Optionally, a rule for an HTTPS listener can also include one of the following user authentication actions: <code>authenticate-oidc</code>, <code>authenticate-cognito</code>, or <code>jwt-validation</code>.</p>
#[non_exhaustive]
...
pub struct Action {
    ...
    /// <p>Information for creating an action that distributes requests among multiple target groups. Specify only when <code>Type</code> is <code>forward</code>.</p>
    /// <p>If you specify both <code>ForwardConfig</code> and <code>TargetGroupArn</code>, you can specify only one target group using <code>ForwardConfig</code> and it must be the same target group specified in <code>TargetGroupArn</code>.</p>
    pub forward_config: ::std::option::Option<crate::types::ForwardActionConfig>,
    /// <p>\[HTTPS listeners\] Information for validating JWT access tokens in client requests. Specify only when Type is jwt-validation.</p>
    pub jwt_validation_config: ::std::option::Option<crate::types::JwtValidationActionConfig>,
}
impl Action {
    /// <p>The type of action.</p>
    ...
    /// <p>\[HTTPS listeners\] Information for validating JWT access tokens in client requests. Specify only when Type is jwt-validation.</p>
    pub fn jwt_validation_config(&self) -> ::std::option::Option<&crate::types::JwtValidationActionConfig> {
        self.jwt_validation_config.as_ref()
    }
}
impl Action {
...
pub struct ActionBuilder {
    ...
    pub(crate) jwt_validation_config: ::std::option::Option<crate::types::JwtValidationActionConfig>,
}
impl ActionBuilder {
    /// <p>The type of action.</p>
    ...
    /// <p>\[HTTPS listeners\] Information for validating JWT access tokens in client requests. Specify only when Type is jwt-validation.</p>
    pub fn jwt_validation_config(mut self, input: crate::types::JwtValidationActionConfig) -> Self {
        self.jwt_validation_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>\[HTTPS listeners\] Information for validating JWT access tokens in client requests. Specify only when Type is jwt-validation.</p>
    pub fn set_jwt_validation_config(mut self, input: ::std::option::Option<crate::types::JwtValidationActionConfig>) -> Self {
        self.jwt_validation_config = input;
        self
    }
    /// <p>\[HTTPS listeners\] Information for validating JWT access tokens in client requests. Specify only when Type is jwt-validation.</p>
    pub fn get_jwt_validation_config(&self) -> &::std::option::Option<crate::types::JwtValidationActionConfig> {
        &self.jwt_validation_config
    }
    ...
    pub fn build(self) -> crate::types::Action {
        crate::types::Action {
            ...
            jwt_validation_config: self.jwt_validation_config,
        }
    }
}
