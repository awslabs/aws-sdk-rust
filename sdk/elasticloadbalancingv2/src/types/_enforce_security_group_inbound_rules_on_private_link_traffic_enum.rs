...
pub enum EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum {
    #[allow(missing_docs)] // documentation missing in model
    Off,
    #[allow(missing_docs)] // documentation missing in model
    On,
...
impl ::std::convert::From<&str> for EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum {
                    fn from(s: &str) -> Self {
                        match s {
...
other => EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum {
                    type Err = ::std::convert::Infallible;

                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum::from(s))
                    }
                }
impl EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum {
                ...
                pub fn as_str(&self) -> &str {
                    match self {
    EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum::Off => "off",
    EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum::On => "on",
    EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum::Unknown(value) => value.as_str()
}
                }
...
impl ::std::convert::AsRef<str> for EnforceSecurityGroupInboundRulesOnPrivateLinkTrafficEnum {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
