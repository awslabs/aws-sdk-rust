...
impl ::std::convert::From<&str> for LoadBalancerTypeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoadBalancerTypeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoadBalancerTypeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoadBalancerTypeEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LoadBalancerTypeEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LoadBalancerTypeEnum {
