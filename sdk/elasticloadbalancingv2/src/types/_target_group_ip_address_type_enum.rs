...
impl ::std::convert::From<&str> for TargetGroupIpAddressTypeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetGroupIpAddressTypeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetGroupIpAddressTypeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetGroupIpAddressTypeEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TargetGroupIpAddressTypeEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
