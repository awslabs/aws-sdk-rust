...
#[allow(unused_mut)]
pub fn serialize_structure_certificate(
...
pub fn serialize_structure_action(
    ...
    if let Some(var_14) = &input.authenticate_oidc_config {
        crate::query_ser::serialize_structure_authenticate_oidc_action_config(scope_13, var_14);
    }
    #[allow(unused_mut)]
    let mut scope_15 = writer.prefix("AuthenticateCognitoConfig");
    if let Some(var_16) = &input.authenticate_cognito_config {
        crate::query_ser::serialize_structure_authenticate_cognito_action_config(scope_15, var_16);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_20) = &input.redirect_config {
        crate::query_ser::serialize_structure_redirect_action_config(scope_19, var_20);
    }
    #[allow(unused_mut)]
    let mut scope_21 = writer.prefix("FixedResponseConfig");
    if let Some(var_22) = &input.fixed_response_config {
        crate::query_ser::serialize_structure_fixed_response_action_config(scope_21, var_22);
    }
    #[allow(unused_mut)]
    let mut scope_23 = writer.prefix("ForwardConfig");
    if let Some(var_24) = &input.forward_config {
        crate::query_ser::serialize_structure_forward_action_config(scope_23, var_24);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_rule_condition(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_41) = &input.host_header_config {
        crate::query_ser::serialize_structure_host_header_condition_config(scope_40, var_41);
    }
    #[allow(unused_mut)]
    let mut scope_42 = writer.prefix("PathPatternConfig");
    if let Some(var_43) = &input.path_pattern_config {
        crate::query_ser::serialize_structure_path_pattern_condition_config(scope_42, var_43);
    }
    #[allow(unused_mut)]
    let mut scope_44 = writer.prefix("HttpHeaderConfig");
    if let Some(var_45) = &input.http_header_config {
        crate::query_ser::serialize_structure_http_header_condition_config(scope_44, var_45);
    }
    #[allow(unused_mut)]
    let mut scope_46 = writer.prefix("QueryStringConfig");
    if let Some(var_47) = &input.query_string_config {
        crate::query_ser::serialize_structure_query_string_condition_config(scope_46, var_47);
    }
    #[allow(unused_mut)]
    let mut scope_48 = writer.prefix("HttpRequestMethodConfig");
    if let Some(var_49) = &input.http_request_method_config {
        crate::query_ser::serialize_structure_http_request_method_condition_config(
            scope_48, var_49,
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_51) = &input.source_ip_config {
        crate::query_ser::serialize_structure_source_ip_condition_config(scope_50, var_51);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_matcher(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_target_description(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_load_balancer_attribute(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_target_group_attribute(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_rule_priority_pair(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_authenticate_oidc_action_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_authenticate_cognito_action_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_redirect_action_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_fixed_response_action_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_forward_action_config(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_141) = &input.target_groups {
        ...
        for item_142 in var_141 {
            ...
            crate::query_ser::serialize_structure_target_group_tuple(entry_144, item_142);
        }
        list_143.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_146) = &input.target_group_stickiness_config {
        crate::query_ser::serialize_structure_target_group_stickiness_config(scope_145, var_146);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_host_header_condition_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_path_pattern_condition_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_http_header_condition_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_query_string_condition_config(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_165) = &input.values {
        ...
        for item_166 in var_165 {
            ...
            crate::query_ser::serialize_structure_query_string_key_value_pair(entry_168, item_166);
        }
        list_167.finish();
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_http_request_method_condition_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_source_ip_condition_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_target_group_tuple(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_target_group_stickiness_config(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_query_string_key_value_pair(
    mut writer: smithy_query::QueryValueWriter,
