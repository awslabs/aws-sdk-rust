...
pub struct MonitorLocalResource {
    ...
    /// <p>The identifier of the local resource. The values you can specify are the following:</p>
    /// <ul>
    /// <li>
    /// <p>For a VPC, subnet or EKS cluster, this identifier is the VPC Amazon Resource Name (ARN), subnet ARN or cluster ARN.</p></li>
    /// <li>
