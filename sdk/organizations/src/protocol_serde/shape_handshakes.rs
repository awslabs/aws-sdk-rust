...
pub(crate) fn de_handshakes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Handshake>>, aws_smithy_json::deserialize::error::DeserializeError>
