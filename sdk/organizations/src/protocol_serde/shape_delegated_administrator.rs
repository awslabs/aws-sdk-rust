...
pub(crate) fn de_delegated_administrator<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DelegatedAdministrator>, aws_smithy_json::deserialize::error::DeserializeError>
