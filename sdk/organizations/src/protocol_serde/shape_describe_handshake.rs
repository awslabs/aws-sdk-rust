...
pub fn ser_describe_handshake_input(input: &crate::operation::describe_handshake::DescribeHandshakeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
