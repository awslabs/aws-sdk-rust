...
pub(crate) fn de_effective_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EffectivePolicy>, aws_smithy_json::deserialize::error::DeserializeError>
