...
pub fn ser_list_roots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRootsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
