...
impl DescribeAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_account::DescribeAccount, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_account::ser_describe_account_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_account::de_describe_account_http_response_with_props(status, headers, body)
        }
    }
