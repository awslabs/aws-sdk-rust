...
impl ListDelegatedAdministrators {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput,
                    ) -> ::std::result::Result<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDelegatedAdministrators {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDelegatedAdministrators");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDelegatedAdministratorsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDelegatedAdministratorsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDelegatedAdministrators")
...
.with_interceptor(ListDelegatedAdministratorsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>::new());
...
#[derive(Debug)]
            struct ListDelegatedAdministratorsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDelegatedAdministratorsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_delegated_administrators::de_list_delegated_administrators_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_delegated_administrators::de_list_delegated_administrators_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDelegatedAdministratorsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDelegatedAdministratorsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_delegated_administrators::ser_list_delegated_administrators_input(&input)?);
...
#[derive(Debug)]
            struct ListDelegatedAdministratorsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDelegatedAdministratorsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDelegatedAdministratorsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDelegatedAdministratorsInput>()
                        .ok_or("failed to downcast to ListDelegatedAdministratorsInput")?;
...
/// Error type for the `ListDelegatedAdministratorsError` operation.
#[non_exhaustive]
...
pub enum ListDelegatedAdministratorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDelegatedAdministratorsError) for what information is available for the error.")]
...
impl ListDelegatedAdministratorsError {
    /// Creates the `ListDelegatedAdministratorsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDelegatedAdministratorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedAdministratorsError::UnsupportedApiEndpointException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDelegatedAdministratorsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDelegatedAdministratorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_delegated_administrators::_list_delegated_administrators_output::ListDelegatedAdministratorsOutput;

pub use crate::operation::list_delegated_administrators::_list_delegated_administrators_input::ListDelegatedAdministratorsInput;

mod _list_delegated_administrators_input;

mod _list_delegated_administrators_output;
