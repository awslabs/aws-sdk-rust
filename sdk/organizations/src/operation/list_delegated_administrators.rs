...
impl ListDelegatedAdministrators {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListDelegatedAdministrators",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDelegatedAdministrators {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListDelegatedAdministratorsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListDelegatedAdministratorsResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDelegatedAdministrators")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListDelegatedAdministratorsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListDelegatedAdministratorsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDelegatedAdministratorsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListDelegatedAdministratorsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDelegatedAdministratorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_delegated_administrators::de_list_delegated_administrators_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_delegated_administrators::de_list_delegated_administrators_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDelegatedAdministratorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_delegated_administrators::ser_list_delegated_administrators_input(&input)?,
        );
...
pub enum ListDelegatedAdministratorsError {
    ...
    /// <li>
    /// <p>ACCOUNT_CREATION_RATE_LIMIT_EXCEEDED: You attempted to exceed the number of accounts that can be in progress at a time.</p></li>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p>You attempted to register a delegated administrator before you enabled service access. Call the <code>EnableAWSServiceAccess</code> API first.</p></li>
    /// <li>
    /// <p>You attempted to enable a policy type before you enabled service access. Call the <code>EnableAWSServiceAccess</code> API first.</p></li>
    /// </ul></li>
    /// <li>
    ...
    /// <li>
    /// <p>INVALID_PATTERN: You provided a value that doesn't match the required pattern. The service also validates your free-text field values against common cross-site scripting (XSS) patterns and rejects requests that contain matching values.</p></li>
    /// <li>
