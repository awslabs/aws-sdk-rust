...
impl ListDelegatedAdministratorsInput {
    /// Consumes the builder and constructs an Operation<[`ListDelegatedAdministrators`](crate::operation::list_delegated_administrators::ListDelegatedAdministrators)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_delegated_administrators::ListDelegatedAdministrators, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_delegated_administrators::ser_list_delegated_administrators_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_delegated_administrators::ListDelegatedAdministrators::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDelegatedAdministrators", "organizations"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListDelegatedAdministrators {
                type Output = std::result::Result<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsOutput, crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>;
