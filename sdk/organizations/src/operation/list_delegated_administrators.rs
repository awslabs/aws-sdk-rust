    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDelegatedAdministrators {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDelegatedAdministrators")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListDelegatedAdministratorsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListDelegatedAdministratorsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_delegated_administrators::ListDelegatedAdministratorsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListDelegatedAdministratorsEndpointParamsInterceptor {
...
pub type ListDelegatedAdministratorsErrorKind = ListDelegatedAdministratorsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_delegated_administrators::ListDelegatedAdministratorsError {
...
impl ListDelegatedAdministratorsError {
    ...
    /// Creates the `ListDelegatedAdministratorsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
