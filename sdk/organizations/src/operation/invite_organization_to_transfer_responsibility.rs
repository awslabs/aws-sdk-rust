...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InviteOrganizationToTransferResponsibilityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_invite_organization_to_transfer_responsibility::de_invite_organization_to_transfer_responsibility_http_response(status, headers, body, _cfg)
        };
