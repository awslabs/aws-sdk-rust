...
impl DescribePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_policy::DescribePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_policy::ser_describe_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_policy::de_describe_policy_http_response_with_props(status, headers, body)
        }
    }
}
