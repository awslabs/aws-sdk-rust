...
impl DeleteOrganizationalUnit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteOrganizationalUnit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteOrganizationalUnit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteOrganizationalUnitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteOrganizationalUnitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteOrganizationalUnit")
...
.with_interceptor(DeleteOrganizationalUnitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError>::new());
...
#[derive(Debug)]
            struct DeleteOrganizationalUnitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteOrganizationalUnitResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteOrganizationalUnitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteOrganizationalUnitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_organizational_unit::DeleteOrganizationalUnitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_organizational_unit::ser_delete_organizational_unit_input(&input)?);
...
#[derive(Debug)]
            struct DeleteOrganizationalUnitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteOrganizationalUnitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteOrganizationalUnitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteOrganizationalUnitInput>()
                        .ok_or("failed to downcast to DeleteOrganizationalUnitInput")?;
...
/// Error type for the `DeleteOrganizationalUnitError` operation.
#[non_exhaustive]
...
pub enum DeleteOrganizationalUnitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteOrganizationalUnitError) for what information is available for the error.")]
...
impl DeleteOrganizationalUnitError {
    /// Creates the `DeleteOrganizationalUnitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteOrganizationalUnitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OrganizationalUnitNotEmptyException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::OrganizationalUnitNotEmptyException`.
    pub fn is_organizational_unit_not_empty_exception(&self) -> bool {
        matches!(self, Self::OrganizationalUnitNotEmptyException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::OrganizationalUnitNotFoundException`.
    pub fn is_organizational_unit_not_found_exception(&self) -> bool {
        matches!(self, Self::OrganizationalUnitNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteOrganizationalUnitError::TooManyRequestsException`.
...
impl ::std::error::Error for DeleteOrganizationalUnitError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::OrganizationalUnitNotEmptyException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteOrganizationalUnitError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteOrganizationalUnitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_organizational_unit::_delete_organizational_unit_output::DeleteOrganizationalUnitOutput;

pub use crate::operation::delete_organizational_unit::_delete_organizational_unit_input::DeleteOrganizationalUnitInput;

mod _delete_organizational_unit_input;

mod _delete_organizational_unit_output;
