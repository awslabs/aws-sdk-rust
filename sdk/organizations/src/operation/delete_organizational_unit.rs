...
impl DeleteOrganizationalUnitInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_organizational_unit::DeleteOrganizationalUnit::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError
{
...
impl std::error::Error for DeleteOrganizationalUnitError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::OrganizationalUnitNotEmptyException(_inner) => Some(_inner),
