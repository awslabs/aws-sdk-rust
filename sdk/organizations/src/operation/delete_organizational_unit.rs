...
impl DeleteOrganizationalUnitInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOrganizationalUnit`](crate::operation::delete_organizational_unit::DeleteOrganizationalUnit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_organizational_unit::DeleteOrganizationalUnit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_organizational_unit::DeleteOrganizationalUnitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_organizational_unit::ser_delete_organizational_unit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_organizational_unit::DeleteOrganizationalUnit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteOrganizationalUnit", "organizations"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteOrganizationalUnit {
                type Output = std::result::Result<crate::operation::delete_organizational_unit::DeleteOrganizationalUnitOutput, crate::operation::delete_organizational_unit::DeleteOrganizationalUnitError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_organizational_unit::de_delete_organizational_unit_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_organizational_unit::de_delete_organizational_unit_http_response(response)
                     }
                }
            }
