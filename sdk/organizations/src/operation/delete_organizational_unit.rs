...
pub type DeleteOrganizationalUnitErrorKind = DeleteOrganizationalUnitError;
...
impl DeleteOrganizationalUnitError {
    ...
    /// Creates the `DeleteOrganizationalUnitError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::OrganizationalUnitNotEmptyException(e) => e.meta(),
