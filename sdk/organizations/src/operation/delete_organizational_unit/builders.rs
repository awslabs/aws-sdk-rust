...
impl crate::operation::delete_organizational_unit::builders::DeleteOrganizationalUnitInputBuilder {
...
impl DeleteOrganizationalUnitFluentBuilder {
    /// Creates a new `DeleteOrganizationalUnitFluentBuilder`.
    ...
    /// <p>ID for the organizational unit that you want to delete. You can get the ID from the <code>ListOrganizationalUnitsForParent</code> operation.</p>
