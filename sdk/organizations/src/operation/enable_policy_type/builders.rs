...
impl EnablePolicyTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_policy_type::EnablePolicyTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_policy_type::EnablePolicyTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_policy_type::EnablePolicyTypeOutput, crate::operation::enable_policy_type::EnablePolicyTypeError, Self> {
