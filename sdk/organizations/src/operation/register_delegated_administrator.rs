...
impl RegisterDelegatedAdministratorInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_delegated_administrator::RegisterDelegatedAdministrator::new(
            ),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterDelegatedAdministrator {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_register_delegated_administrator::de_register_delegated_administrator_http_error(response)
        } else {
            crate::protocol_serde::shape_register_delegated_administrator::de_register_delegated_administrator_http_response(response)
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RegisterDelegatedAdministratorError
{
...
impl aws_http::request_id::RequestId
    for crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError
{
...
impl std::error::Error for RegisterDelegatedAdministratorError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::AccountAlreadyRegisteredException(_inner) => Some(_inner),
