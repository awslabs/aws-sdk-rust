...
impl RegisterDelegatedAdministrator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterDelegatedAdministrator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterDelegatedAdministrator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterDelegatedAdministratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterDelegatedAdministratorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterDelegatedAdministrator")
...
.with_interceptor(RegisterDelegatedAdministratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_register_delegated_administrator::de_register_delegated_administrator_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterDelegatedAdministratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_delegated_administrator::ser_register_delegated_administrator_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterDelegatedAdministratorEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterDelegatedAdministratorInput>()
                        .ok_or("failed to downcast to RegisterDelegatedAdministratorInput")?;
...
pub enum RegisterDelegatedAdministratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterDelegatedAdministratorError) for what information is available for the error.")]
...
impl RegisterDelegatedAdministratorError {
    /// Creates the `RegisterDelegatedAdministratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterDelegatedAdministratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountAlreadyRegisteredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterDelegatedAdministratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError {
