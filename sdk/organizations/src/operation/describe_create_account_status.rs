...
impl DescribeCreateAccountStatusInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_create_account_status::DescribeCreateAccountStatus::new(),
        )
...
/// `ParseStrictResponse` impl for `DescribeCreateAccountStatus`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCreateAccountStatus {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_create_account_status::de_describe_create_account_status_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_create_account_status::de_describe_create_account_status_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_create_account_status::DescribeCreateAccountStatusError
{
...
impl std::error::Error for DescribeCreateAccountStatusError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::CreateAccountStatusNotFoundException(_inner) => Some(_inner),
