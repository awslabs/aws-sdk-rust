...
pub type EnableAWSServiceAccessErrorKind = EnableAWSServiceAccessError;
...
impl EnableAWSServiceAccessError {
    ...
    /// Creates the `EnableAWSServiceAccessError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
