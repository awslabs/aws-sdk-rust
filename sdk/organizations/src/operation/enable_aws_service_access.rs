...
impl EnableAwsServiceAccessInput {
    /// Consumes the builder and constructs an Operation<[`EnableAWSServiceAccess`](crate::operation::enable_aws_service_access::EnableAWSServiceAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_aws_service_access::EnableAWSServiceAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_aws_service_access::EnableAwsServiceAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_aws_service_access::ser_enable_aws_service_access_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_aws_service_access::EnableAWSServiceAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnableAWSServiceAccess", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `EnableAWSServiceAccess`.
...
impl aws_smithy_http::response::ParseStrictResponse for EnableAWSServiceAccess {
                type Output = std::result::Result<crate::operation::enable_aws_service_access::EnableAwsServiceAccessOutput, crate::operation::enable_aws_service_access::EnableAWSServiceAccessError>;
