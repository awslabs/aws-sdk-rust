...
impl EnablePolicyTypeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_policy_type::EnablePolicyType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_policy_type::EnablePolicyTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for EnablePolicyType {
                type Output = std::result::Result<crate::operation::enable_policy_type::EnablePolicyTypeOutput, crate::operation::enable_policy_type::EnablePolicyTypeError>;
