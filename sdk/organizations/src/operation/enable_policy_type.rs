    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_policy_type::EnablePolicyTypeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_policy_type::EnablePolicyTypeOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnablePolicyType")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(EnablePolicyTypeEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnablePolicyTypeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnablePolicyTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_policy_type::EnablePolicyTypeInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_policy_type::ser_enable_policy_type_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnablePolicyTypeEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_policy_type::EnablePolicyTypeError {
...
impl EnablePolicyTypeError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::PolicyChangesInProgressException(e) => e.meta(),
            Self::PolicyTypeAlreadyEnabledException(e) => e.meta(),
            Self::PolicyTypeNotAvailableForOrganizationException(e) => e.meta(),
            Self::RootNotFoundException(e) => e.meta(),
