...
/// Orchestration and serialization glue logic for `EnablePolicyType`.
...
impl EnablePolicyType {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::enable_policy_type::EnablePolicyTypeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::enable_policy_type::EnablePolicyTypeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Organizations", "EnablePolicyType", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Organizations.EnablePolicyType",
                "rpc.service" = "Organizations",
                "rpc.method" = "EnablePolicyType",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnablePolicyType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnablePolicyType");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            EnablePolicyTypeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            EnablePolicyTypeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnablePolicyType")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnablePolicyType")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnablePolicyTypeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnablePolicyTypeEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct EnablePolicyTypeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnablePolicyTypeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnablePolicyTypeInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("RootId") {
            if let ::std::option::Option::Some(value) = input.root_id.as_deref() {
                captured.insert("RootId", value);
            }
        }
...
#[derive(Debug)]
struct EnablePolicyTypeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnablePolicyTypeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_policy_type::de_enable_policy_type_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_enable_policy_type::de_enable_policy_type_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct EnablePolicyTypeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnablePolicyTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::enable_policy_type::EnablePolicyTypeInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_policy_type::ser_enable_policy_type_input(&input)?);
...
#[derive(Debug)]
struct EnablePolicyTypeEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnablePolicyTypeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "EnablePolicyTypeEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<EnablePolicyTypeInput>()
            .ok_or("failed to downcast to EnablePolicyTypeInput")?;
...
pub enum EnablePolicyTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnablePolicyTypeError) for what information is available for the error.")]
...
impl EnablePolicyTypeError {
    ...
    /// Creates the `EnablePolicyTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PolicyChangesInProgressException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::PolicyTypeAlreadyEnabledException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::PolicyTypeNotAvailableForOrganizationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::RootNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `EnablePolicyTypeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::PolicyChangesInProgressException`.
    pub fn is_policy_changes_in_progress_exception(&self) -> bool {
        matches!(self, Self::PolicyChangesInProgressException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::PolicyTypeAlreadyEnabledException`.
    pub fn is_policy_type_already_enabled_exception(&self) -> bool {
        matches!(self, Self::PolicyTypeAlreadyEnabledException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::PolicyTypeNotAvailableForOrganizationException`.
    pub fn is_policy_type_not_available_for_organization_exception(&self) -> bool {
        matches!(self, Self::PolicyTypeNotAvailableForOrganizationException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::RootNotFoundException`.
    pub fn is_root_not_found_exception(&self) -> bool {
        matches!(self, Self::RootNotFoundException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `EnablePolicyTypeError::UnsupportedApiEndpointException`.
...
impl ::std::error::Error for EnablePolicyTypeError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::PolicyTypeNotAvailableForOrganizationException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for EnablePolicyTypeError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::PolicyChangesInProgressException(_inner) => _inner.fmt(f),
            Self::PolicyTypeAlreadyEnabledException(_inner) => _inner.fmt(f),
            Self::PolicyTypeNotAvailableForOrganizationException(_inner) => _inner.fmt(f),
            Self::RootNotFoundException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnablePolicyTypeError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PolicyChangesInProgressException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::PolicyTypeAlreadyEnabledException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::PolicyTypeNotAvailableForOrganizationException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::RootNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnablePolicyTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_policy_type::EnablePolicyTypeError {
...
mod _enable_policy_type_output;
