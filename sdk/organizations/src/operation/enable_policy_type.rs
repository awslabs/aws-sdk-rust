...
impl EnablePolicyTypeInput {
    /// Consumes the builder and constructs an Operation<[`EnablePolicyType`](crate::operation::enable_policy_type::EnablePolicyType)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_policy_type::ser_enable_policy_type_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_policy_type::EnablePolicyType::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnablePolicyType", "organizations"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnablePolicyType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_policy_type::de_enable_policy_type_http_response_with_props(status, headers, body)
        }
    }
}
