...
/// Orchestration and serialization glue logic for `RemoveAccountFromOrganization`.
...
impl RemoveAccountFromOrganization {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationInput,
                    ) -> ::std::result::Result<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveAccountFromOrganization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveAccountFromOrganization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveAccountFromOrganizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveAccountFromOrganizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveAccountFromOrganization")
...
.with_interceptor(RemoveAccountFromOrganizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError>::new());
...
#[derive(Debug)]
            struct RemoveAccountFromOrganizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveAccountFromOrganizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_account_from_organization::de_remove_account_from_organization_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_account_from_organization::de_remove_account_from_organization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RemoveAccountFromOrganizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveAccountFromOrganizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_account_from_organization::ser_remove_account_from_organization_input(&input)?);
...
#[derive(Debug)]
            struct RemoveAccountFromOrganizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveAccountFromOrganizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveAccountFromOrganizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveAccountFromOrganizationInput>()
                        .ok_or("failed to downcast to RemoveAccountFromOrganizationInput")?;
...
/// Error type for the `RemoveAccountFromOrganizationError` operation.
#[non_exhaustive]
...
pub enum RemoveAccountFromOrganizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveAccountFromOrganizationError) for what information is available for the error.")]
...
impl RemoveAccountFromOrganizationError {
    /// Creates the `RemoveAccountFromOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveAccountFromOrganizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::MasterCannotLeaveOrganizationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::AccountNotFoundException`.
    pub fn is_account_not_found_exception(&self) -> bool {
        matches!(self, Self::AccountNotFoundException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::MasterCannotLeaveOrganizationException`.
    pub fn is_master_cannot_leave_organization_exception(&self) -> bool {
        matches!(self, Self::MasterCannotLeaveOrganizationException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `RemoveAccountFromOrganizationError::TooManyRequestsException`.
...
impl ::std::error::Error for RemoveAccountFromOrganizationError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::MasterCannotLeaveOrganizationException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RemoveAccountFromOrganizationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveAccountFromOrganizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError {
...
mod _remove_account_from_organization_output;
