...
impl aws_smithy_http::response::ParseStrictResponse for RemoveAccountFromOrganization {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_account_from_organization::de_remove_account_from_organization_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RemoveAccountFromOrganizationError
{
...
impl aws_http::request_id::RequestId
    for crate::operation::remove_account_from_organization::RemoveAccountFromOrganizationError
{
...
impl std::error::Error for RemoveAccountFromOrganizationError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::MasterCannotLeaveOrganizationException(_inner) => Some(_inner),
