...
pub type RemoveAccountFromOrganizationErrorKind = RemoveAccountFromOrganizationError;
...
impl RemoveAccountFromOrganizationError {
    ...
    /// Creates the `RemoveAccountFromOrganizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::MasterCannotLeaveOrganizationException(e) => e.meta(),
