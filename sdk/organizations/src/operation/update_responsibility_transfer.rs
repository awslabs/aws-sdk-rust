...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateResponsibilityTransferResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_responsibility_transfer::de_update_responsibility_transfer_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_update_responsibility_transfer::de_update_responsibility_transfer_http_response(status, headers, body)
        };
