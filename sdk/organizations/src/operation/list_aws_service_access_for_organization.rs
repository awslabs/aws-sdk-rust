...
impl ListAWSServiceAccessForOrganization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAWSServiceAccessForOrganization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAWSServiceAccessForOrganization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAWSServiceAccessForOrganizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAWSServiceAccessForOrganizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAWSServiceAccessForOrganization")
...
.with_interceptor(ListAWSServiceAccessForOrganizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>::new());
...
#[derive(Debug)]
            struct ListAWSServiceAccessForOrganizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAWSServiceAccessForOrganizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_aws_service_access_for_organization::de_list_aws_service_access_for_organization_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_aws_service_access_for_organization::de_list_aws_service_access_for_organization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAWSServiceAccessForOrganizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAWSServiceAccessForOrganizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_aws_service_access_for_organization::ser_list_aws_service_access_for_organization_input(&input)?);
...
#[derive(Debug)]
            struct ListAWSServiceAccessForOrganizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAWSServiceAccessForOrganizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAWSServiceAccessForOrganizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAwsServiceAccessForOrganizationInput>()
                        .ok_or("failed to downcast to ListAwsServiceAccessForOrganizationInput")?;
...
/// Error type for the `ListAWSServiceAccessForOrganizationError` operation.
#[non_exhaustive]
...
pub enum ListAWSServiceAccessForOrganizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAWSServiceAccessForOrganizationError) for what information is available for the error.")]
...
impl ListAWSServiceAccessForOrganizationError {
    /// Creates the `ListAWSServiceAccessForOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAWSServiceAccessForOrganizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `ListAWSServiceAccessForOrganizationError::UnsupportedApiEndpointException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAWSServiceAccessForOrganizationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAWSServiceAccessForOrganizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError {
...
mod _list_aws_service_access_for_organization_output;
