...
pub type ListAWSServiceAccessForOrganizationErrorKind = ListAWSServiceAccessForOrganizationError;
...
impl ListAWSServiceAccessForOrganizationError {
    ...
    /// Creates the `ListAWSServiceAccessForOrganizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
