...
impl ListAwsServiceAccessForOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`ListAWSServiceAccessForOrganization`](crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_aws_service_access_for_organization::ser_list_aws_service_access_for_organization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAWSServiceAccessForOrganization", "organizations"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAWSServiceAccessForOrganization {
                type Output = std::result::Result<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationOutput, crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>;
