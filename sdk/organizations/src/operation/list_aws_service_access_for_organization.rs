...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAWSServiceAccessForOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_aws_service_access_for_organization::de_list_aws_service_access_for_organization_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListAWSServiceAccessForOrganizationError
{
