...
impl ListAWSServiceAccessForOrganization {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_aws_service_access_for_organization::ListAWSServiceAccessForOrganizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListAWSServiceAccessForOrganization",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAWSServiceAccessForOrganization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAWSServiceAccessForOrganizationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAWSServiceAccessForOrganizationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAWSServiceAccessForOrganization")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAWSServiceAccessForOrganization")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListAWSServiceAccessForOrganizationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListAWSServiceAccessForOrganizationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAWSServiceAccessForOrganizationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAwsServiceAccessForOrganizationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAWSServiceAccessForOrganizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_aws_service_access_for_organization::de_list_aws_service_access_for_organization_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_aws_service_access_for_organization::de_list_aws_service_access_for_organization_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAWSServiceAccessForOrganizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_aws_service_access_for_organization::ListAwsServiceAccessForOrganizationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_aws_service_access_for_organization::ser_list_aws_service_access_for_organization_input(&input)?,
        );
