...
/// Orchestration and serialization glue logic for `DescribeOrganizationalUnit`.
...
impl DescribeOrganizationalUnit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeOrganizationalUnit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeOrganizationalUnit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeOrganizationalUnitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeOrganizationalUnitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeOrganizationalUnit")
...
.with_interceptor(DescribeOrganizationalUnitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>::new());
...
#[derive(Debug)]
            struct DescribeOrganizationalUnitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeOrganizationalUnitResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_organizational_unit::de_describe_organizational_unit_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_organizational_unit::de_describe_organizational_unit_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeOrganizationalUnitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeOrganizationalUnitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_organizational_unit::ser_describe_organizational_unit_input(&input)?);
...
#[derive(Debug)]
            struct DescribeOrganizationalUnitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeOrganizationalUnitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeOrganizationalUnitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeOrganizationalUnitInput>()
                        .ok_or("failed to downcast to DescribeOrganizationalUnitInput")?;
...
/// Error type for the `DescribeOrganizationalUnitError` operation.
#[non_exhaustive]
...
pub enum DescribeOrganizationalUnitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeOrganizationalUnitError) for what information is available for the error.")]
...
impl DescribeOrganizationalUnitError {
    /// Creates the `DescribeOrganizationalUnitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeOrganizationalUnitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::OrganizationalUnitNotFoundException`.
    pub fn is_organizational_unit_not_found_exception(&self) -> bool {
        matches!(self, Self::OrganizationalUnitNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeOrganizationalUnitError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeOrganizationalUnitError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeOrganizationalUnitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_organizational_unit::_describe_organizational_unit_output::DescribeOrganizationalUnitOutput;

pub use crate::operation::describe_organizational_unit::_describe_organizational_unit_input::DescribeOrganizationalUnitInput;

mod _describe_organizational_unit_input;

mod _describe_organizational_unit_output;
