...
impl DescribeOrganizationalUnitInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_organizational_unit::DescribeOrganizationalUnit::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOrganizationalUnit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_organizational_unit::de_describe_organizational_unit_http_response_with_props(status, headers, body)
        }
    }
}
