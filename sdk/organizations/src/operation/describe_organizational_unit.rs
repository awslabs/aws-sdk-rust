    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeOrganizationalUnit {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeOrganizationalUnit")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeOrganizationalUnitResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeOrganizationalUnitRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeOrganizationalUnitEndpointParamsInterceptor {
...
pub type DescribeOrganizationalUnitErrorKind = DescribeOrganizationalUnitError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError {
...
impl DescribeOrganizationalUnitError {
    ...
    /// Creates the `DescribeOrganizationalUnitError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
