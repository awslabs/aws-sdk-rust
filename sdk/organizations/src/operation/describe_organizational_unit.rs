...
impl DescribeOrganizationalUnitInput {
    /// Consumes the builder and constructs an Operation<[`DescribeOrganizationalUnit`](crate::operation::describe_organizational_unit::DescribeOrganizationalUnit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_organizational_unit::DescribeOrganizationalUnit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_organizational_unit::ser_describe_organizational_unit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_organizational_unit::DescribeOrganizationalUnit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeOrganizationalUnit", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeOrganizationalUnit`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeOrganizationalUnit {
                type Output = std::result::Result<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput, crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError>;
