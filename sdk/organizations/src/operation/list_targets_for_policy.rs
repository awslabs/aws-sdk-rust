...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTargetsForPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListTargetsForPolicy", "organizations"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTargetsForPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_targets_for_policy::ser_list_targets_for_policy_input(
            &input,
        )?);
