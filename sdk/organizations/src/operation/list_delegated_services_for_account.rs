...
/// `ParseStrictResponse` impl for `ListDelegatedServicesForAccount`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListDelegatedServicesForAccount {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_delegated_services_for_account::de_list_delegated_services_for_account_http_error(response)
        } else {
            crate::protocol_serde::shape_list_delegated_services_for_account::de_list_delegated_services_for_account_http_response(response)
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListDelegatedServicesForAccountError
{
...
impl aws_http::request_id::RequestId
    for crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccountError
{
