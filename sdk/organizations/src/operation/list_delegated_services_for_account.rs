...
impl ListDelegatedServicesForAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDelegatedServicesForAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_delegated_services_for_account::de_list_delegated_services_for_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
