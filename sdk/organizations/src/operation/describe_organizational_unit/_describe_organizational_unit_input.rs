...
impl DescribeOrganizationalUnitInput {
    /// Creates a new builder-style object to manufacture [`DescribeOrganizationalUnitInput`](crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput).
    pub fn builder() -> crate::operation::describe_organizational_unit::builders::DescribeOrganizationalUnitInputBuilder {
        crate::operation::describe_organizational_unit::builders::DescribeOrganizationalUnitInputBuilder::default()
    }
}

/// A builder for [`DescribeOrganizationalUnitInput`](crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct DescribeOrganizationalUnitInputBuilder {
...
impl DescribeOrganizationalUnitInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeOrganizationalUnitInput`](crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput).
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput, ::aws_smithy_types::error::operation::BuildError> {
