...
impl DescribeOrganizationalUnitFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitOutput, crate::operation::describe_organizational_unit::DescribeOrganizationalUnitError, Self> {
