...
impl DescribeEffectivePolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_effective_policy::DescribeEffectivePolicyInput, ::aws_smithy_types::error::operation::BuildError> {
