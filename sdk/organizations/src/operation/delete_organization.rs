...
impl DeleteOrganizationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_organization::ser_delete_organization_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_organization::de_delete_organization_http_response_with_props(status, headers, body)
        }
    }
}
