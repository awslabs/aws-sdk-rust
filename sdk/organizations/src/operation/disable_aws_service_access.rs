...
pub type DisableAWSServiceAccessErrorKind = DisableAWSServiceAccessError;
...
impl DisableAWSServiceAccessError {
    ...
    /// Creates the `DisableAWSServiceAccessError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
