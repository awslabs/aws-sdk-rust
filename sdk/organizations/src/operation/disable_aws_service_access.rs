...
impl DisableAwsServiceAccessInput {
    /// Consumes the builder and constructs an Operation<[`DisableAWSServiceAccess`](crate::operation::disable_aws_service_access::DisableAWSServiceAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_aws_service_access::DisableAWSServiceAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_aws_service_access::DisableAwsServiceAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_aws_service_access::ser_disable_aws_service_access_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_aws_service_access::DisableAWSServiceAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableAWSServiceAccess", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DisableAWSServiceAccess`.
...
impl aws_smithy_http::response::ParseStrictResponse for DisableAWSServiceAccess {
                type Output = std::result::Result<crate::operation::disable_aws_service_access::DisableAwsServiceAccessOutput, crate::operation::disable_aws_service_access::DisableAWSServiceAccessError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_disable_aws_service_access::de_disable_aws_service_access_http_error(response)
                     } else {
                        crate::protocol_serde::shape_disable_aws_service_access::de_disable_aws_service_access_http_response(response)
                     }
                }
            }
