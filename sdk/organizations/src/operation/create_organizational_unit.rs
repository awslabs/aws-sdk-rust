...
pub type CreateOrganizationalUnitErrorKind = CreateOrganizationalUnitError;
...
impl CreateOrganizationalUnitError {
    ...
    /// Creates the `CreateOrganizationalUnitError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
