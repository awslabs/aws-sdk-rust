...
/// Orchestration and serialization glue logic for `CreateOrganizationalUnit`.
...
impl CreateOrganizationalUnit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_organizational_unit::CreateOrganizationalUnitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_organizational_unit::CreateOrganizationalUnitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_organizational_unit::CreateOrganizationalUnitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_organizational_unit::CreateOrganizationalUnitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateOrganizationalUnit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateOrganizationalUnit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateOrganizationalUnitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateOrganizationalUnitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateOrganizationalUnit")
...
.with_interceptor(CreateOrganizationalUnitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_organizational_unit::CreateOrganizationalUnitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_organizational_unit::CreateOrganizationalUnitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_organizational_unit::CreateOrganizationalUnitError>::new());
...
#[derive(Debug)]
            struct CreateOrganizationalUnitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOrganizationalUnitResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_organizational_unit::de_create_organizational_unit_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_organizational_unit::de_create_organizational_unit_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateOrganizationalUnitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateOrganizationalUnitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_organizational_unit::CreateOrganizationalUnitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_organizational_unit::CreateOrganizationalUnitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_organizational_unit::ser_create_organizational_unit_input(&input)?);
...
#[derive(Debug)]
            struct CreateOrganizationalUnitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOrganizationalUnitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateOrganizationalUnitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateOrganizationalUnitInput>()
                        .ok_or("failed to downcast to CreateOrganizationalUnitInput")?;
...
/// Error type for the `CreateOrganizationalUnitError` operation.
#[non_exhaustive]
...
pub enum CreateOrganizationalUnitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateOrganizationalUnitError) for what information is available for the error.")]
...
impl CreateOrganizationalUnitError {
    /// Creates the `CreateOrganizationalUnitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateOrganizationalUnitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ParentNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::DuplicateOrganizationalUnitException`.
    pub fn is_duplicate_organizational_unit_exception(&self) -> bool {
        matches!(self, Self::DuplicateOrganizationalUnitException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::ParentNotFoundException`.
    pub fn is_parent_not_found_exception(&self) -> bool {
        matches!(self, Self::ParentNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateOrganizationalUnitError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateOrganizationalUnitError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateOrganizationalUnitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_organizational_unit::CreateOrganizationalUnitError {
...
mod _create_organizational_unit_output;
