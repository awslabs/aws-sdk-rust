...
impl CreateOrganizationalUnitInput {
    /// Consumes the builder and constructs an Operation<[`CreateOrganizationalUnit`](crate::operation::create_organizational_unit::CreateOrganizationalUnit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_organizational_unit::CreateOrganizationalUnit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_organizational_unit::CreateOrganizationalUnitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_organizational_unit::ser_create_organizational_unit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_organizational_unit::CreateOrganizationalUnit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateOrganizationalUnit", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateOrganizationalUnit`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateOrganizationalUnit {
                type Output = std::result::Result<crate::operation::create_organizational_unit::CreateOrganizationalUnitOutput, crate::operation::create_organizational_unit::CreateOrganizationalUnitError>;
