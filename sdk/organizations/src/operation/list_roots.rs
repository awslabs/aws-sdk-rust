...
impl ListRootsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_roots::ListRoots,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_roots::ListRoots::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_roots::de_list_roots_http_response_with_props(
                status, headers, body,
            )
        }
    }
