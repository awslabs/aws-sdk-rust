...
impl ListRootsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_roots::ListRoots, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_roots::ser_list_roots_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_roots::de_list_roots_http_response_with_props(status, headers, body)
        }
    }
}
