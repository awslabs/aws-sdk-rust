...
impl ListRootsInput {
    /// Consumes the builder and constructs an Operation<[`ListRoots`](crate::operation::list_roots::ListRoots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_roots::ListRoots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_roots::ListRootsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_roots::ser_list_roots_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_roots::ListRoots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListRoots", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListRoots`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListRoots {
                type Output = std::result::Result<crate::operation::list_roots::ListRootsOutput, crate::operation::list_roots::ListRootsError>;
