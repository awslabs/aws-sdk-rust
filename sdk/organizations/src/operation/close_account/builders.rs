...
impl CloseAccountFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::close_account::CloseAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::close_account::CloseAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::close_account::CloseAccountOutput, crate::operation::close_account::CloseAccountError, Self> {
