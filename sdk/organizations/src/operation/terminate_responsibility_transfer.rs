...
/// Orchestration and serialization glue logic for `TerminateResponsibilityTransfer`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TerminateResponsibilityTransfer;
impl TerminateResponsibilityTransfer {
    /// Creates a new `TerminateResponsibilityTransfer`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::terminate_responsibility_transfer::TerminateResponsibilityTransferError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::terminate_responsibility_transfer::TerminateResponsibilityTransferOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "TerminateResponsibilityTransfer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TerminateResponsibilityTransfer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TerminateResponsibilityTransfer");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            TerminateResponsibilityTransferRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            TerminateResponsibilityTransferResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("TerminateResponsibilityTransfer")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TerminateResponsibilityTransfer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                TerminateResponsibilityTransferTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                TerminateResponsibilityTransferEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct TerminateResponsibilityTransferTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TerminateResponsibilityTransferTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<TerminateResponsibilityTransferInput>() else {
...
#[derive(Debug)]
struct TerminateResponsibilityTransferResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TerminateResponsibilityTransferResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_terminate_responsibility_transfer::de_terminate_responsibility_transfer_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_terminate_responsibility_transfer::de_terminate_responsibility_transfer_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct TerminateResponsibilityTransferRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TerminateResponsibilityTransferRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::terminate_responsibility_transfer::TerminateResponsibilityTransferInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::terminate_responsibility_transfer::TerminateResponsibilityTransferInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_terminate_responsibility_transfer::ser_terminate_responsibility_transfer_input(&input)?,
        );
...
#[derive(Debug)]
struct TerminateResponsibilityTransferEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TerminateResponsibilityTransferEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "TerminateResponsibilityTransferEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<TerminateResponsibilityTransferInput>()
            .ok_or("failed to downcast to TerminateResponsibilityTransferInput")?;
...
/// Error type for the `TerminateResponsibilityTransferError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum TerminateResponsibilityTransferError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TerminateResponsibilityTransferError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl TerminateResponsibilityTransferError {
    /// Creates the `TerminateResponsibilityTransferError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `TerminateResponsibilityTransferError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidResponsibilityTransferTransitionException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::ResponsibilityTransferAlreadyInStatusException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::InvalidResponsibilityTransferTransitionException`.
    pub fn is_invalid_responsibility_transfer_transition_exception(&self) -> bool {
        matches!(self, Self::InvalidResponsibilityTransferTransitionException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::ResponsibilityTransferAlreadyInStatusException`.
    pub fn is_responsibility_transfer_already_in_status_exception(&self) -> bool {
        matches!(self, Self::ResponsibilityTransferAlreadyInStatusException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::ResponsibilityTransferNotFoundException`.
    ...
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `TerminateResponsibilityTransferError::UnsupportedApiEndpointException`.
    pub fn is_unsupported_api_endpoint_exception(&self) -> bool {
        matches!(self, Self::UnsupportedApiEndpointException(_))
    }
}
impl ::std::error::Error for TerminateResponsibilityTransferError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidResponsibilityTransferTransitionException(_inner) => ::std::option::Option::Some(_inner),
            Self::ResponsibilityTransferAlreadyInStatusException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for TerminateResponsibilityTransferError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::InvalidResponsibilityTransferTransitionException(_inner) => _inner.fmt(f),
            Self::ResponsibilityTransferAlreadyInStatusException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::retry::ProvideErrorKind for TerminateResponsibilityTransferError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for TerminateResponsibilityTransferError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidResponsibilityTransferTransitionException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::ResponsibilityTransferAlreadyInStatusException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TerminateResponsibilityTransferError {
...
impl ::aws_types::request_id::RequestId for crate::operation::terminate_responsibility_transfer::TerminateResponsibilityTransferError {
...
mod _terminate_responsibility_transfer_output;
