...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::cancel_handshake::CancelHandshakeOutput,
                    crate::operation::cancel_handshake::CancelHandshakeError,
                > for CancelHandshakeFluentBuilder
            {
                fn send(
                    self,
...
impl CancelHandshakeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_handshake::CancelHandshakeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_handshake::CancelHandshakeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::cancel_handshake::CancelHandshake::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::cancel_handshake::CancelHandshake::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_handshake::CancelHandshakeOutput, crate::operation::cancel_handshake::CancelHandshakeError, Self> {
