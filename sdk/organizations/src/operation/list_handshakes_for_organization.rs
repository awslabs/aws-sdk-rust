...
pub type ListHandshakesForOrganizationErrorKind = ListHandshakesForOrganizationError;
...
impl ListHandshakesForOrganizationError {
    ...
    /// Creates the `ListHandshakesForOrganizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
