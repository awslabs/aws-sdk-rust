...
impl ListHandshakesForOrganizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_handshakes_for_organization::ListHandshakesForOrganization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHandshakesForOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_handshakes_for_organization::de_list_handshakes_for_organization_http_response_with_props(
                status, headers, body,
            )
        }
    }
