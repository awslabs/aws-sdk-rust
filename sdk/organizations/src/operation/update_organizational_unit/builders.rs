...
impl crate::operation::update_organizational_unit::builders::UpdateOrganizationalUnitInputBuilder {
...
impl UpdateOrganizationalUnitFluentBuilder {
    /// Creates a new `UpdateOrganizationalUnitFluentBuilder`.
    ...
    /// <p>ID for the OU that you want to rename. You can get the ID from the <code>ListOrganizationalUnitsForParent</code> operation.</p>
