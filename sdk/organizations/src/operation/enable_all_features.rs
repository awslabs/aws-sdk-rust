...
impl EnableAllFeaturesInput {
    /// Consumes the builder and constructs an Operation<[`EnableAllFeatures`](crate::operation::enable_all_features::EnableAllFeatures)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_all_features::EnableAllFeatures, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_all_features::EnableAllFeaturesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_all_features::ser_enable_all_features_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_all_features::EnableAllFeatures::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnableAllFeatures", "organizations"));
