...
impl EnableAllFeaturesInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::enable_all_features::EnableAllFeatures,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_all_features::EnableAllFeatures::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for EnableAllFeatures {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_all_features::de_enable_all_features_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_all_features::de_enable_all_features_http_response_with_props(status, headers, body)
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::enable_all_features::EnableAllFeaturesError
{
...
impl std::error::Error for EnableAllFeaturesError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::HandshakeConstraintViolationException(_inner) => Some(_inner),
