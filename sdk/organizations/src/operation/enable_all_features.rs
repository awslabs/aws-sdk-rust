    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnableAllFeatures")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableAllFeaturesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_all_features::de_enable_all_features_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_enable_all_features::de_enable_all_features_http_response(status, headers, body, _cfg)
        };
...
impl EnableAllFeaturesError {
    ...
    /// Returns `true` if the error kind is `EnableAllFeaturesError::ConstraintViolationException`.
