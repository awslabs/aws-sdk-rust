...
impl DetachPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DetachPolicy`](crate::operation::detach_policy::DetachPolicy)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_policy::DetachPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_policy::ser_detach_policy_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_policy::DetachPolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachPolicy", "organizations"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachPolicy {
    type Output = ::std::result::Result<crate::operation::detach_policy::DetachPolicyOutput, crate::operation::detach_policy::DetachPolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_policy::de_detach_policy_http_response_with_props(status, headers, body)
        }
    }
}
