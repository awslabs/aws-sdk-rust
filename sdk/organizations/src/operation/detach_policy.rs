...
impl DetachPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_policy::DetachPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detach_policy::de_detach_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_detach_policy::de_detach_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
