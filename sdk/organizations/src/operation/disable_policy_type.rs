...
/// Orchestration and serialization glue logic for `DisablePolicyType`.
...
impl DisablePolicyType {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_policy_type::DisablePolicyTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_policy_type::DisablePolicyTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_policy_type::DisablePolicyTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_policy_type::DisablePolicyTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisablePolicyType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisablePolicyType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisablePolicyTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisablePolicyTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisablePolicyType")
...
.with_interceptor(DisablePolicyTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_policy_type::DisablePolicyTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_policy_type::DisablePolicyTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_policy_type::DisablePolicyTypeError>::new());
...
#[derive(Debug)]
            struct DisablePolicyTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisablePolicyTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_policy_type::de_disable_policy_type_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DisablePolicyTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisablePolicyTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_policy_type::DisablePolicyTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_policy_type::DisablePolicyTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_policy_type::ser_disable_policy_type_input(&input)?);
...
#[derive(Debug)]
            struct DisablePolicyTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisablePolicyTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisablePolicyTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisablePolicyTypeInput>()
                        .ok_or("failed to downcast to DisablePolicyTypeInput")?;
...
/// Error type for the `DisablePolicyTypeError` operation.
#[non_exhaustive]
...
pub enum DisablePolicyTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisablePolicyTypeError) for what information is available for the error.")]
...
impl DisablePolicyTypeError {
    /// Creates the `DisablePolicyTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisablePolicyTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DisablePolicyTypeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::PolicyChangesInProgressException`.
    pub fn is_policy_changes_in_progress_exception(&self) -> bool {
        matches!(self, Self::PolicyChangesInProgressException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::PolicyTypeNotEnabledException`.
    pub fn is_policy_type_not_enabled_exception(&self) -> bool {
        matches!(self, Self::PolicyTypeNotEnabledException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::RootNotFoundException`.
    pub fn is_root_not_found_exception(&self) -> bool {
        matches!(self, Self::RootNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `DisablePolicyTypeError::UnsupportedApiEndpointException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisablePolicyTypeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisablePolicyTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_policy_type::DisablePolicyTypeError {
...
mod _disable_policy_type_output;
