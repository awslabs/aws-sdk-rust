...
impl DisablePolicyTypeInput {
    /// Consumes the builder and constructs an Operation<[`DisablePolicyType`](crate::operation::disable_policy_type::DisablePolicyType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_policy_type::DisablePolicyType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_policy_type::DisablePolicyTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_policy_type::ser_disable_policy_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_policy_type::DisablePolicyType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisablePolicyType", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DisablePolicyType`.
...
impl aws_smithy_http::response::ParseStrictResponse for DisablePolicyType {
                type Output = std::result::Result<crate::operation::disable_policy_type::DisablePolicyTypeOutput, crate::operation::disable_policy_type::DisablePolicyTypeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_disable_policy_type::de_disable_policy_type_http_error(response)
                     } else {
                        crate::protocol_serde::shape_disable_policy_type::de_disable_policy_type_http_response(response)
                     }
                }
            }
