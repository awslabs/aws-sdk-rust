...
impl DisablePolicyTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_policy_type::DisablePolicyType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisablePolicyType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disable_policy_type::de_disable_policy_type_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_policy_type::DisablePolicyTypeError
{
