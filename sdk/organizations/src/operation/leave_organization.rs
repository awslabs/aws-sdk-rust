...
impl LeaveOrganizationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::leave_organization::LeaveOrganization::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for LeaveOrganization {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_leave_organization::de_leave_organization_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::leave_organization::LeaveOrganizationError
{
