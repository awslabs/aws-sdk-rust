    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::leave_organization::LeaveOrganizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::leave_organization::LeaveOrganizationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for LeaveOrganizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::leave_organization::LeaveOrganizationInput>()
            .expect("correct type");
