...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LeaveOrganization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("LeaveOrganization")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("LeaveOrganization")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LeaveOrganizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_leave_organization::de_leave_organization_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_leave_organization::de_leave_organization_http_response(status, headers, body, _cfg)
        };
