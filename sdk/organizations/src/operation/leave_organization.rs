...
impl LeaveOrganizationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::leave_organization::LeaveOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::leave_organization::LeaveOrganizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
/// `ParseStrictResponse` impl for `LeaveOrganization`.
...
impl aws_smithy_http::response::ParseStrictResponse for LeaveOrganization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_leave_organization::de_leave_organization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_leave_organization::de_leave_organization_http_response(response)
                     }
                }
            }
