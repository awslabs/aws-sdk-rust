...
impl CloseAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::close_account::CloseAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CloseAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_close_account::de_close_account_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_close_account::de_close_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
