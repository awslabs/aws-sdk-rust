...
impl CloseAccount {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::close_account::CloseAccountError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::close_account::CloseAccountOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Organizations", "CloseAccount", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Organizations.CloseAccount",
                "rpc.service" = "Organizations",
                "rpc.method" = "CloseAccount",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CloseAccount {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CloseAccountRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CloseAccountResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CloseAccount")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CloseAccountTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CloseAccountTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CloseAccountTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CloseAccountInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CloseAccountResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_close_account::de_close_account_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_close_account::de_close_account_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CloseAccountRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::close_account::CloseAccountInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::close_account::CloseAccountInput,
...
impl ::std::error::Error for CloseAccountError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::AccountAlreadyClosedException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for CloseAccountError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::AccountAlreadyClosedException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CloseAccountError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountAlreadyClosedException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
