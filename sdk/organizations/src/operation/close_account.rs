...
impl CloseAccountInput {
    /// Consumes the builder and constructs an Operation<[`CloseAccount`](crate::operation::close_account::CloseAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::close_account::CloseAccount, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::close_account::CloseAccountInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_close_account::ser_close_account_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::close_account::CloseAccount::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CloseAccount", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CloseAccount`.
...
impl aws_smithy_http::response::ParseStrictResponse for CloseAccount {
                type Output = std::result::Result<crate::operation::close_account::CloseAccountOutput, crate::operation::close_account::CloseAccountError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_close_account::de_close_account_http_error(response)
                     } else {
                        crate::protocol_serde::shape_close_account::de_close_account_http_response(response)
                     }
                }
            }
