...
impl CloseAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::close_account::CloseAccount, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_close_account::ser_close_account_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CloseAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_close_account::de_close_account_http_response_with_props(status, headers, body)
        }
    }
}
