...
/// Orchestration and serialization glue logic for `DeclineHandshake`.
...
impl DeclineHandshake {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::decline_handshake::DeclineHandshakeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::decline_handshake::DeclineHandshakeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::decline_handshake::DeclineHandshakeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::decline_handshake::DeclineHandshakeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeclineHandshake {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeclineHandshake");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeclineHandshakeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeclineHandshakeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeclineHandshake")
...
.with_interceptor(DeclineHandshakeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::decline_handshake::DeclineHandshakeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::decline_handshake::DeclineHandshakeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::decline_handshake::DeclineHandshakeError>::new());
...
#[derive(Debug)]
            struct DeclineHandshakeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeclineHandshakeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_decline_handshake::de_decline_handshake_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_decline_handshake::de_decline_handshake_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeclineHandshakeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeclineHandshakeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::decline_handshake::DeclineHandshakeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::decline_handshake::DeclineHandshakeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_decline_handshake::ser_decline_handshake_input(&input)?);
...
#[derive(Debug)]
            struct DeclineHandshakeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeclineHandshakeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeclineHandshakeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeclineHandshakeInput>()
                        .ok_or("failed to downcast to DeclineHandshakeInput")?;
...
/// Error type for the `DeclineHandshakeError` operation.
#[non_exhaustive]
...
pub enum DeclineHandshakeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeclineHandshakeError) for what information is available for the error.")]
...
impl DeclineHandshakeError {
    /// Creates the `DeclineHandshakeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeclineHandshakeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeclineHandshakeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::HandshakeAlreadyInStateException`.
    pub fn is_handshake_already_in_state_exception(&self) -> bool {
        matches!(self, Self::HandshakeAlreadyInStateException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::HandshakeNotFoundException`.
    pub fn is_handshake_not_found_exception(&self) -> bool {
        matches!(self, Self::HandshakeNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::InvalidHandshakeTransitionException`.
    pub fn is_invalid_handshake_transition_exception(&self) -> bool {
        matches!(self, Self::InvalidHandshakeTransitionException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DeclineHandshakeError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeclineHandshakeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeclineHandshakeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::decline_handshake::DeclineHandshakeError {
