    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::decline_handshake::DeclineHandshakeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::decline_handshake::DeclineHandshakeOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeclineHandshake {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeclineHandshake")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DeclineHandshakeEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeclineHandshakeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeclineHandshakeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::decline_handshake::DeclineHandshakeInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_decline_handshake::ser_decline_handshake_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeclineHandshakeEndpointParamsInterceptor {
...
pub type DeclineHandshakeErrorKind = DeclineHandshakeError;
...
impl ::aws_http::request_id::RequestId for crate::operation::decline_handshake::DeclineHandshakeError {
...
impl DeclineHandshakeError {
    ...
    /// Creates the `DeclineHandshakeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
