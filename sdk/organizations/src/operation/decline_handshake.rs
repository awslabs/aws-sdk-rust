...
impl DeclineHandshakeInput {
    /// Consumes the builder and constructs an Operation<[`DeclineHandshake`](crate::operation::decline_handshake::DeclineHandshake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::decline_handshake::DeclineHandshake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::decline_handshake::DeclineHandshakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_decline_handshake::ser_decline_handshake_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::decline_handshake::DeclineHandshake::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeclineHandshake", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeclineHandshake`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeclineHandshake {
                type Output = std::result::Result<crate::operation::decline_handshake::DeclineHandshakeOutput, crate::operation::decline_handshake::DeclineHandshakeError>;
