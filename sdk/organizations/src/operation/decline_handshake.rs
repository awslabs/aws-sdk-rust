...
impl DeclineHandshakeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::decline_handshake::DeclineHandshake, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_decline_handshake::ser_decline_handshake_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeclineHandshake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decline_handshake::de_decline_handshake_http_response_with_props(status, headers, body)
        }
    }
