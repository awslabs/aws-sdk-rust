...
impl DeclineHandshakeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::decline_handshake::DeclineHandshake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeclineHandshake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_decline_handshake::de_decline_handshake_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::decline_handshake::DeclineHandshakeError
{
