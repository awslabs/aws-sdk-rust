...
impl InviteAccountToOrganization {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "InviteAccountToOrganization",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InviteAccountToOrganization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("InviteAccountToOrganization")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InviteAccountToOrganization")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InviteAccountToOrganizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_invite_account_to_organization::de_invite_account_to_organization_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_invite_account_to_organization::de_invite_account_to_organization_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InviteAccountToOrganizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationInput>()
            .expect("correct type");
