...
impl InviteAccountToOrganizationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::invite_account_to_organization::InviteAccountToOrganization::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::invite_account_to_organization::InviteAccountToOrganizationError
{
...
impl std::error::Error for InviteAccountToOrganizationError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::AccountOwnerNotVerifiedException(_inner) => Some(_inner),
            ...
            Self::DuplicateHandshakeException(_inner) => Some(_inner),
