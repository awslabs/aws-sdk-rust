...
impl ListChildrenInput {
    /// Consumes the builder and constructs an Operation<[`ListChildren`](crate::operation::list_children::ListChildren)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_children::ListChildren, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_children::ListChildrenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_children::ser_list_children_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_children::ListChildren::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListChildren", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListChildren`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListChildren {
                type Output = std::result::Result<crate::operation::list_children::ListChildrenOutput, crate::operation::list_children::ListChildrenError>;
