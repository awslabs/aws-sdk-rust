...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeregisterDelegatedAdministratorResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeregisterDelegatedAdministratorRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeregisterDelegatedAdministratorEndpointParamsInterceptor {
...
pub type DeregisterDelegatedAdministratorErrorKind = DeregisterDelegatedAdministratorError;
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError {
...
impl DeregisterDelegatedAdministratorError {
    ...
    /// Creates the `DeregisterDelegatedAdministratorError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
