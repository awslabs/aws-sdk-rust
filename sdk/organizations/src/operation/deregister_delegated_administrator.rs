...
impl DeregisterDelegatedAdministratorInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterDelegatedAdministrator`](crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministrator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministrator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_delegated_administrator::ser_deregister_delegated_administrator_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministrator::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterDelegatedAdministrator", "organizations"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterDelegatedAdministrator {
                type Output = std::result::Result<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorOutput, crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError>;
