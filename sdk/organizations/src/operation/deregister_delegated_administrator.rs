...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterDelegatedAdministrator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_delegated_administrator::de_deregister_delegated_administrator_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeregisterDelegatedAdministratorError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError
{
