...
impl DeregisterDelegatedAdministrator {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorInput,
                    ) -> ::std::result::Result<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterDelegatedAdministrator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeregisterDelegatedAdministrator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeregisterDelegatedAdministratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeregisterDelegatedAdministratorResponseDeserializer));
...
.with_interceptor(DeregisterDelegatedAdministratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_deregister_delegated_administrator::de_deregister_delegated_administrator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_deregister_delegated_administrator::de_deregister_delegated_administrator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeregisterDelegatedAdministratorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterDelegatedAdministratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deregister_delegated_administrator::ser_deregister_delegated_administrator_input(&input)?);
...
#[derive(Debug)]
            struct DeregisterDelegatedAdministratorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterDelegatedAdministratorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeregisterDelegatedAdministratorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeregisterDelegatedAdministratorInput>()
                        .ok_or("failed to downcast to DeregisterDelegatedAdministratorInput")?;
...
/// Error type for the `DeregisterDelegatedAdministratorError` operation.
#[non_exhaustive]
...
pub enum DeregisterDelegatedAdministratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeregisterDelegatedAdministratorError) for what information is available for the error.")]
...
impl DeregisterDelegatedAdministratorError {
    /// Creates the `DeregisterDelegatedAdministratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeregisterDelegatedAdministratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::AccountNotRegisteredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::AccountNotFoundException`.
    pub fn is_account_not_found_exception(&self) -> bool {
        matches!(self, Self::AccountNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::AccountNotRegisteredException`.
    pub fn is_account_not_registered_exception(&self) -> bool {
        matches!(self, Self::AccountNotRegisteredException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `DeregisterDelegatedAdministratorError::UnsupportedApiEndpointException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeregisterDelegatedAdministratorError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeregisterDelegatedAdministratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deregister_delegated_administrator::DeregisterDelegatedAdministratorError {
...
mod _deregister_delegated_administrator_output;
