...
impl AcceptHandshakeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::accept_handshake::AcceptHandshake,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_handshake::AcceptHandshake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptHandshake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_accept_handshake::de_accept_handshake_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::accept_handshake::AcceptHandshakeError
{
