...
/// Orchestration and serialization glue logic for `AcceptHandshake`.
...
impl AcceptHandshake {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::accept_handshake::AcceptHandshakeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::accept_handshake::AcceptHandshakeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Organizations", "AcceptHandshake", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Organizations.AcceptHandshake",
                "rpc.service" = "Organizations",
                "rpc.method" = "AcceptHandshake",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptHandshake {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptHandshake");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AcceptHandshakeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AcceptHandshakeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AcceptHandshake")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptHandshake")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AcceptHandshakeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AcceptHandshakeEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct AcceptHandshakeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptHandshakeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AcceptHandshakeInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("HandshakeId") {
            if let ::std::option::Option::Some(value) = input.handshake_id.as_deref() {
                captured.insert("HandshakeId", value);
            }
        }
...
#[derive(Debug)]
struct AcceptHandshakeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptHandshakeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_accept_handshake::de_accept_handshake_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_accept_handshake::de_accept_handshake_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct AcceptHandshakeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptHandshakeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::accept_handshake::AcceptHandshakeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::accept_handshake::AcceptHandshakeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_handshake::ser_accept_handshake_input(&input)?);
...
#[derive(Debug)]
struct AcceptHandshakeEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptHandshakeEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "AcceptHandshakeEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<AcceptHandshakeInput>()
            .ok_or("failed to downcast to AcceptHandshakeInput")?;
...
pub enum AcceptHandshakeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptHandshakeError) for what information is available for the error.")]
...
impl AcceptHandshakeError {
    ...
    /// Creates the `AcceptHandshakeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::HandshakeAlreadyInStateException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::HandshakeConstraintViolationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::HandshakeNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidHandshakeTransitionException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `AcceptHandshakeError::ConstraintViolationException`.
    ...
    /// Returns `true` if the error kind is `AcceptHandshakeError::MasterCannotLeaveOrganizationException`.
...
impl ::std::error::Error for AcceptHandshakeError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::HandshakeAlreadyInStateException(_inner) => ::std::option::Option::Some(_inner),
            Self::HandshakeConstraintViolationException(_inner) => ::std::option::Option::Some(_inner),
            Self::HandshakeNotFoundException(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidHandshakeTransitionException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for AcceptHandshakeError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::HandshakeAlreadyInStateException(_inner) => _inner.fmt(f),
            Self::HandshakeConstraintViolationException(_inner) => _inner.fmt(f),
            Self::HandshakeNotFoundException(_inner) => _inner.fmt(f),
            Self::InvalidHandshakeTransitionException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AcceptHandshakeError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::HandshakeAlreadyInStateException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::HandshakeConstraintViolationException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::HandshakeNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidHandshakeTransitionException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptHandshakeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_handshake::AcceptHandshakeError {
