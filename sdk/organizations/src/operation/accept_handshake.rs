...
impl std::error::Error for AcceptHandshakeError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::HandshakeAlreadyInStateException(_inner) => Some(_inner),
            Self::HandshakeConstraintViolationException(_inner) => Some(_inner),
            Self::HandshakeNotFoundException(_inner) => Some(_inner),
            Self::InvalidHandshakeTransitionException(_inner) => Some(_inner),
