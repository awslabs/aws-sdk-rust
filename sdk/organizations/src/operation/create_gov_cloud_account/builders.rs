...
impl crate::operation::create_gov_cloud_account::builders::CreateGovCloudAccountInputBuilder {
...
/// </ul>
/// <p>Additionally, the <code>AccountJoinedOrganization</code> event is logged in CloudTrail and is available only in the management account's event history only for the linked commercial account. This event includes <code>joinedMethod:Created</code> and <code>joinedTime</code> fields to provide context on how and when the account joined the organization.</p>
/// <p></p>
