...
impl CreateGovCloudAccountInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_gov_cloud_account();
...
/// <ul>
/// <li>
/// <p>You're authorized to create accounts in the Amazon Web Services GovCloud (US) Region. For more information on the Amazon Web Services GovCloud (US) Region, see the <a href="https://docs.aws.amazon.com/govcloud-us/latest/UserGuide/welcome.html"> <i>Amazon Web Services GovCloud User Guide</i>.</a></p></li>
/// <li>
/// <p>You already have an account in the Amazon Web Services GovCloud (US) Region that is paired with a management account of an organization in the commercial Region.</p></li>
/// <li>
/// <p>You call this action from the management account of your organization in the commercial Region.</p></li>
/// <li>
/// <p>You have the <code>organizations:CreateGovCloudAccount</code> permission.</p></li>
/// </ul>
...
/// <ul>
/// <li>
/// <p>Verify that CloudTrail is enabled to store logs.</p></li>
/// <li>
/// <p>Create an Amazon S3 bucket for CloudTrail log storage.</p>
/// <p>For more information, see <a href="https://docs.aws.amazon.com/govcloud-us/latest/UserGuide/verifying-cloudtrail.html">Verifying CloudTrail Is Enabled</a> in the <i>Amazon Web Services GovCloud User Guide</i>.</p></li>
/// </ul>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_gov_cloud_account::CreateGovCloudAccountOutput,
                    crate::operation::create_gov_cloud_account::CreateGovCloudAccountError,
                > for CreateGovCloudAccountFluentBuilder
            {
                fn send(
                    self,
...
impl CreateGovCloudAccountFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_gov_cloud_account::CreateGovCloudAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_gov_cloud_account::CreateGovCloudAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_gov_cloud_account::CreateGovCloudAccountOutput, crate::operation::create_gov_cloud_account::CreateGovCloudAccountError, Self> {
