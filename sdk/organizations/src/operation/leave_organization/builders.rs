...
impl LeaveOrganizationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::leave_organization::LeaveOrganizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::leave_organization::LeaveOrganizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::leave_organization::LeaveOrganizationOutput, crate::operation::leave_organization::LeaveOrganizationError, Self> {
