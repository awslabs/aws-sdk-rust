...
impl ListHandshakesForOrganizationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
