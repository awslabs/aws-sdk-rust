...
impl UpdateOrganizationalUnitInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_organizational_unit::UpdateOrganizationalUnit::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_organizational_unit::UpdateOrganizationalUnitError
{
...
impl std::error::Error for UpdateOrganizationalUnitError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::DuplicateOrganizationalUnitException(_inner) => Some(_inner),
            Self::InvalidInputException(_inner) => Some(_inner),
            Self::OrganizationalUnitNotFoundException(_inner) => Some(_inner),
