...
impl CancelHandshakeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_handshake::CancelHandshake, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_handshake::ser_cancel_handshake_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelHandshake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_handshake::de_cancel_handshake_http_response_with_props(status, headers, body)
        }
    }
