...
impl CancelHandshakeInput {
    /// Consumes the builder and constructs an Operation<[`CancelHandshake`](crate::operation::cancel_handshake::CancelHandshake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_handshake::CancelHandshake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_handshake::CancelHandshakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_handshake::ser_cancel_handshake_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_handshake::CancelHandshake::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelHandshake", "organizations"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CancelHandshake`.
...
impl aws_smithy_http::response::ParseStrictResponse for CancelHandshake {
                type Output = std::result::Result<crate::operation::cancel_handshake::CancelHandshakeOutput, crate::operation::cancel_handshake::CancelHandshakeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_handshake::de_cancel_handshake_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_handshake::de_cancel_handshake_http_response(response)
                     }
                }
            }
