...
/// Orchestration and serialization glue logic for `CancelHandshake`.
...
impl CancelHandshake {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_handshake::CancelHandshakeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_handshake::CancelHandshakeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_handshake::CancelHandshakeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_handshake::CancelHandshakeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelHandshake {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelHandshake");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelHandshakeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelHandshakeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelHandshake")
...
.with_interceptor(CancelHandshakeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_handshake::CancelHandshakeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_handshake::CancelHandshakeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_handshake::CancelHandshakeError>::new());
...
#[derive(Debug)]
            struct CancelHandshakeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelHandshakeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_handshake::de_cancel_handshake_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CancelHandshakeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelHandshakeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_handshake::CancelHandshakeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_handshake::CancelHandshakeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_handshake::ser_cancel_handshake_input(&input)?);
...
#[derive(Debug)]
            struct CancelHandshakeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelHandshakeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelHandshakeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelHandshakeInput>()
                        .ok_or("failed to downcast to CancelHandshakeInput")?;
...
/// Error type for the `CancelHandshakeError` operation.
#[non_exhaustive]
...
pub enum CancelHandshakeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelHandshakeError) for what information is available for the error.")]
...
impl CancelHandshakeError {
    /// Creates the `CancelHandshakeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelHandshakeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CancelHandshakeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::HandshakeAlreadyInStateException`.
    pub fn is_handshake_already_in_state_exception(&self) -> bool {
        matches!(self, Self::HandshakeAlreadyInStateException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::HandshakeNotFoundException`.
    pub fn is_handshake_not_found_exception(&self) -> bool {
        matches!(self, Self::HandshakeNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::InvalidHandshakeTransitionException`.
    pub fn is_invalid_handshake_transition_exception(&self) -> bool {
        matches!(self, Self::InvalidHandshakeTransitionException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `CancelHandshakeError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelHandshakeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelHandshakeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_handshake::CancelHandshakeError {
