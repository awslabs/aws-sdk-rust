...
impl ListHandshakesForAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_handshakes_for_account::ListHandshakesForAccountInput, ::aws_smithy_types::error::operation::BuildError> {
