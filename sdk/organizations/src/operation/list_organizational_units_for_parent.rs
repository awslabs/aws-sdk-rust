...
impl ListOrganizationalUnitsForParentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_organizational_units_for_parent::ListOrganizationalUnitsForParent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOrganizationalUnitsForParent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_organizational_units_for_parent::de_list_organizational_units_for_parent_http_response_with_props(
                status, headers, body,
            )
        }
    }
