...
impl CreateGovCloudAccountInput {
    /// Consumes the builder and constructs an Operation<[`CreateGovCloudAccount`](crate::operation::create_gov_cloud_account::CreateGovCloudAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_gov_cloud_account::CreateGovCloudAccount, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_gov_cloud_account::CreateGovCloudAccountInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_gov_cloud_account::ser_create_gov_cloud_account_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_gov_cloud_account::CreateGovCloudAccount::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateGovCloudAccount", "organizations"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGovCloudAccount {
                type Output = std::result::Result<crate::operation::create_gov_cloud_account::CreateGovCloudAccountOutput, crate::operation::create_gov_cloud_account::CreateGovCloudAccountError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_gov_cloud_account::de_create_gov_cloud_account_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_gov_cloud_account::de_create_gov_cloud_account_http_response(response)
                     }
                }
            }
