    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_gov_cloud_account::CreateGovCloudAccountError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_gov_cloud_account::CreateGovCloudAccountOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateGovCloudAccountResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateGovCloudAccountRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_gov_cloud_account::CreateGovCloudAccountInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_gov_cloud_account::ser_create_gov_cloud_account_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateGovCloudAccountEndpointParamsInterceptor {
...
pub type CreateGovCloudAccountErrorKind = CreateGovCloudAccountError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_gov_cloud_account::CreateGovCloudAccountError {
...
impl CreateGovCloudAccountError {
    ...
    /// Creates the `CreateGovCloudAccountError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::FinalizingOrganizationException(e) => e.meta(),
