...
impl ListAccountsForParentInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_accounts_for_parent::ListAccountsForParent::new(),
        )
...
/// `ParseStrictResponse` impl for `ListAccountsForParent`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccountsForParent {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_accounts_for_parent::de_list_accounts_for_parent_http_error(response)
        } else {
            crate::protocol_serde::shape_list_accounts_for_parent::de_list_accounts_for_parent_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::list_accounts_for_parent::ListAccountsForParentError
{
