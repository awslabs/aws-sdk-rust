...
impl ListParentsInput {
    /// Consumes the builder and constructs an Operation<[`ListParents`](crate::operation::list_parents::ListParents)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_parents::ListParents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_parents::ser_list_parents_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_parents::ListParents::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListParents {
    type Output = ::std::result::Result<crate::operation::list_parents::ListParentsOutput, crate::operation::list_parents::ListParentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_parents::de_list_parents_http_response_with_props(status, headers, body)
        }
    }
}
