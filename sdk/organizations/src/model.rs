...
pub struct Handshake {
    ...
    pub requested_timestamp: std::option::Option<smithy_types::Instant>,
    ...
    pub expiration_timestamp: std::option::Option<smithy_types::Instant>,
...
pub mod handshake {
    ...
    pub struct Builder {
        ...
        pub(crate) requested_timestamp: std::option::Option<smithy_types::Instant>,
        pub(crate) expiration_timestamp: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time that the handshake request was made.</p>
        pub fn requested_timestamp(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// request fails to respond before the specified date and time, the handshake becomes
        /// inactive and is no longer valid.</p>
        pub fn expiration_timestamp(mut self, input: smithy_types::Instant) -> Self {
...
pub struct DelegatedService {
    ...
    pub delegation_enabled_date: std::option::Option<smithy_types::Instant>,
}
...
pub mod delegated_service {
    ...
    pub struct Builder {
        ...
        pub(crate) delegation_enabled_date: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The name of an AWS service that can request an operation for the specified service.
        /// This is typically in the form of a URL, such as:
        ...
        /// <p>The date that the account became a delegated administrator for this service. </p>
        pub fn delegation_enabled_date(mut self, input: smithy_types::Instant) -> Self {
...
pub struct DelegatedAdministrator {
    ...
    /// organization.</p>
    pub joined_timestamp: std::option::Option<smithy_types::Instant>,
...
pub mod delegated_administrator {
    ...
    pub struct Builder {
        ...
        pub(crate) joined_timestamp: std::option::Option<smithy_types::Instant>,
        pub(crate) delegation_enabled_date: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The unique identifier (ID) of the delegated administrator's account.</p>
        ...
        /// <p>The date when the delegated administrator's account became a part of the
        /// organization.</p>
        pub fn joined_timestamp(mut self, input: smithy_types::Instant) -> Self {
...
pub struct EnabledServicePrincipal {
    ...
    pub date_enabled: std::option::Option<smithy_types::Instant>,
}
...
pub mod enabled_service_principal {
    ...
    pub struct Builder {
        pub(crate) service_principal: std::option::Option<std::string::String>,
        pub(crate) date_enabled: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The name of the service principal. This is typically in the form of a URL, such as:
        /// <code>
        ...
        /// <p>The date that the service principal was enabled for integration with AWS Organizations.</p>
        pub fn date_enabled(mut self, input: smithy_types::Instant) -> Self {
