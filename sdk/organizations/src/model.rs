...
impl InvalidInputExceptionReason {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "DUPLICATE_TAG_KEY", "IMMUTABLE_POLICY", "INPUT_REQUIRED", "INVALID_EMAIL_ADDRESS_TARGET", "INVALID_ENUM", "INVALID_ENUM_POLICY_TYPE", "INVALID_FULL_NAME_TARGET", "INVALID_LIST_MEMBER", "INVALID_NEXT_TOKEN", "INVALID_PARTY_TYPE_TARGET", "INVALID_PATTERN", "INVALID_PATTERN_TARGET_ID", "INVALID_ROLE_NAME", "INVALID_SYNTAX_ORGANIZATION_ARN", "INVALID_SYNTAX_POLICY_ID", "INVALID_SYSTEM_TAGS_PARAMETER", "MAX_LENGTH_EXCEEDED", "MAX_LIMIT_EXCEEDED_FILTER", "MAX_VALUE_EXCEEDED", "MIN_LENGTH_EXCEEDED", "MIN_VALUE_EXCEEDED", "MOVING_ACCOUNT_BETWEEN_DIFFERENT_ROOTS", "TARGET_NOT_SUPPORTED", "UNRECOGNIZED_SERVICE_PRINCIPAL"
        ]
    }
}
...
pub struct Policy  {
    ...
    #[doc(hidden)]pub policy_summary: std::option::Option<crate::model::PolicySummary>,
...
pub struct PolicySummary  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::PolicyType>,
    ...
    #[doc(hidden)]pub aws_managed: bool,
}
impl PolicySummary {
    /// <p>The unique identifier (ID) of the policy.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a policy ID string requires "p-" followed by from 8 to 128 lowercase or uppercase letters, digits, or the underscore character (_).</p>
...
pub struct PolicyTargetSummary  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::TargetType>,
}
...
pub struct Root  {
    ...
    /// </note>
    #[doc(hidden)]pub policy_types: std::option::Option<std::vec::Vec<crate::model::PolicyTypeSummary>>,
}
impl Root {
    /// <p>The unique identifier (ID) for the root.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a root ID string requires "r-" followed by from 4 to 32 lowercase letters or digits.</p>
...
pub struct PolicyTypeSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::PolicyTypeStatus>,
}
...
pub struct Parent  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ParentType>,
}
impl Parent {
    /// <p>The unique identifier (ID) of the parent entity.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a parent ID string requires one of the following:</p> 
...
pub struct Handshake  {
    ...
    #[doc(hidden)]pub parties: std::option::Option<std::vec::Vec<crate::model::HandshakeParty>>,
    ...
    /// </ul>
    #[doc(hidden)]pub state: std::option::Option<crate::model::HandshakeState>,
    /// <p>The date and time that the handshake request was made.</p>
    #[doc(hidden)]pub requested_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub expiration_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </ul>
    #[doc(hidden)]pub action: std::option::Option<crate::model::ActionType>,
    /// <p>Additional information that is needed to process the handshake.</p>
    #[doc(hidden)]pub resources: std::option::Option<std::vec::Vec<crate::model::HandshakeResource>>,
}
impl Handshake {
    /// <p>The unique identifier (ID) of a handshake. The originating account creates the ID when it initiates the handshake.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-" followed by from 8 to 32 lowercase letters or digits.</p>
...
pub struct HandshakeResource  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::HandshakeResourceType>,
...
pub struct HandshakeParty  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::HandshakePartyType>,
}
impl HandshakeParty {
    /// <p>The unique identifier (ID) for the party.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-" followed by from 8 to 32 lowercase letters or digits.</p>
...
pub struct HandshakeFilter  {
    ...
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-" followed by from 8 to 32 lowercase letters or digits.</p>
    #[doc(hidden)]pub parent_handshake_id: std::option::Option<std::string::String>,
}
...
pub struct DelegatedService  {
    ...
    #[doc(hidden)]pub service_principal: std::option::Option<std::string::String>,
    /// <p>The date that the account became a delegated administrator for this service. </p>
    #[doc(hidden)]pub delegation_enabled_date: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DelegatedAdministrator  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AccountStatus>,
    /// <p>The method by which the delegated administrator's account joined the organization.</p>
    #[doc(hidden)]pub joined_method: std::option::Option<crate::model::AccountJoinedMethod>,
    /// <p>The date when the delegated administrator's account became a part of the organization.</p>
    #[doc(hidden)]pub joined_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct CreateAccountStatus  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::CreateAccountState>,
    ...
    #[doc(hidden)]pub gov_cloud_account_id: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub failure_reason: std::option::Option<crate::model::CreateAccountFailureReason>,
}
...
impl CreateAccountFailureReason {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "ACCOUNT_LIMIT_EXCEEDED", "CONCURRENT_ACCOUNT_MODIFICATION", "EMAIL_ALREADY_EXISTS", "FAILED_BUSINESS_VALIDATION", "GOVCLOUD_ACCOUNT_ALREADY_EXISTS", "INTERNAL_FAILURE", "INVALID_ADDRESS", "INVALID_EMAIL", "INVALID_IDENTITY_FOR_BUSINESS_VALIDATION", "INVALID_PAYMENT_INSTRUMENT", "MISSING_BUSINESS_VALIDATION", "MISSING_PAYMENT_INSTRUMENT", "PENDING_BUSINESS_VALIDATION", "UNKNOWN_BUSINESS_VALIDATION"
        ]
    }
}
...
pub struct Child  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ChildType>,
}
impl Child {
    /// <p>The unique identifier (ID) of this child entity.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a child ID string requires one of the following:</p> 
...
pub struct EnabledServicePrincipal  {
    ...
    #[doc(hidden)]pub date_enabled: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct Organization  {
    ...
    #[doc(hidden)]pub feature_set: std::option::Option<crate::model::OrganizationFeatureSet>,
    /// <p>The Amazon Resource Name (ARN) of the account that is designated as the management account for the organization.</p> 
    /// <p>For more information about ARNs in Organizations, see <a href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsorganizations.html#awsorganizations-resources-for-iam-policies">ARN Formats Supported by Organizations</a> in the <i>Amazon Web Services Service Authorization Reference</i>.</p>
    #[doc(hidden)]pub master_account_arn: std::option::Option<std::string::String>,
    /// <p>The unique identifier (ID) of the management account of an organization.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for an account ID string requires exactly 12 digits.</p>
    #[doc(hidden)]pub master_account_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub master_account_email: std::option::Option<std::string::String>,
    /// <important> 
    ...
    #[doc(hidden)]pub available_policy_types: std::option::Option<std::vec::Vec<crate::model::PolicyTypeSummary>>,
}
impl Organization {
    /// <p>The unique identifier (ID) of an organization.</p> 
    /// <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for an organization ID string requires "o-" followed by from 10 to 32 lowercase letters or digits.</p>
...
pub struct EffectivePolicy  {
    /// <p>The text content of the policy.</p>
    #[doc(hidden)]pub policy_content: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub target_id: std::option::Option<std::string::String>,
    /// <p>The policy type.</p>
    #[doc(hidden)]pub policy_type: std::option::Option<crate::model::EffectivePolicyType>,
}
