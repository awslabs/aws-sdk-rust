...
impl super::Client {
    ...
    ///   - [`policy_type(EffectivePolicyType)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::policy_type) / [`set_policy_type(Option<EffectivePolicyType>)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::set_policy_type):<br>required: **true**<br><p>The type of policy that you want information about. You can specify one of the following values:</p> <ul>  <li>   <p><a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_ai-opt-out.html">AISERVICES_OPT_OUT_POLICY</a></p></li>  <li>   <p><a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_backup.html">BACKUP_POLICY</a></p></li>  <li>   <p><a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html">TAG_POLICY</a></p></li> </ul><br>
    ///   - [`target_id(impl Into<String>)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::target_id) / [`set_target_id(Option<String>)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::set_target_id):<br>required: **false**<br><p>When you're signed in as the management account, specify the ID of the account that you want details about. Specifying an organization root or organizational unit (OU) as the target is not supported.</p><br>
