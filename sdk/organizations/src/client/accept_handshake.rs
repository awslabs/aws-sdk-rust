...
impl super::Client {
    ...
    ///   - [`handshake_id(impl ::std::convert::Into<String>)`](crate::operation::accept_handshake::builders::AcceptHandshakeFluentBuilder::handshake_id) / [`set_handshake_id(Option<String>)`](crate::operation::accept_handshake::builders::AcceptHandshakeFluentBuilder::set_handshake_id): <p>The unique identifier (ID) of the handshake that you want to accept.</p>  <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-" followed by from 8 to 32 lowercase letters or digits.</p>
    ...
    pub fn accept_handshake(
        &self,
    ) -> crate::operation::accept_handshake::builders::AcceptHandshakeFluentBuilder {
        crate::operation::accept_handshake::builders::AcceptHandshakeFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
