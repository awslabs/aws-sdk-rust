...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_delegated_administrator::builders::DeregisterDelegatedAdministratorFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::deregister_delegated_administrator::builders::DeregisterDelegatedAdministratorFluentBuilder::set_account_id): <p>The account ID number of the member account in the organization that you want to deregister as a delegated administrator.</p>
