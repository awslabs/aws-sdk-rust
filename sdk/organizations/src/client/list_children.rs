...
impl super::Client {
    ...
    ///   - [`parent_id(impl ::std::convert::Into<String>)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::parent_id) / [`set_parent_id(Option<String>)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::set_parent_id): <p>The unique identifier (ID) for the parent root or OU whose children you want to list.</p>  <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for a parent ID string requires one of the following:</p>  <ul>   <li> <p> <b>Root</b> - A string that begins with "r-" followed by from 4 to 32 lowercase letters or digits.</p> </li>   <li> <p> <b>Organizational unit (OU)</b> - A string that begins with "ou-" followed by from 4 to 32 lowercase letters or digits (the ID of the root that the OU is in). This string is followed by a second "-" dash and from 8 to 32 additional lowercase letters or digits.</p> </li>  </ul>
    ///   - [`child_type(ChildType)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::child_type) / [`set_child_type(Option<ChildType>)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::set_child_type): <p>Filters the output to include only the specified child type.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_children::builders::ListChildrenFluentBuilder::set_next_token): <p>The parameter for receiving additional results if you receive a <code>NextToken</code> response in a previous request. A <code>NextToken</code> response indicates that more output is available. Set this parameter to the value of the previous call's <code>NextToken</code> response to indicate where the output should continue from.</p>
