...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::register_delegated_administrator::builders::RegisterDelegatedAdministratorFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::register_delegated_administrator::builders::RegisterDelegatedAdministratorFluentBuilder::set_account_id): <p>The account ID number of the member account in the organization to register as a delegated administrator.</p>
