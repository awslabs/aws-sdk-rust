...
impl super::Client {
    ...
    ///   - [`handshake_id(impl Into<String>)`](crate::operation::describe_handshake::builders::DescribeHandshakeFluentBuilder::handshake_id) / [`set_handshake_id(Option<String>)`](crate::operation::describe_handshake::builders::DescribeHandshakeFluentBuilder::set_handshake_id):<br>required: **true**<br><p>The unique identifier (ID) of the handshake that you want information about. You can get the ID from the original call to <code>InviteAccountToOrganization</code>, or from a call to <code>ListHandshakesForAccount</code> or <code>ListHandshakesForOrganization</code>.</p> <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-" followed by from 8 to 32 lowercase letters or digits.</p><br>
