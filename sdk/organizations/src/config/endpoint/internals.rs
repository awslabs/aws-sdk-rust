        ...
        if let Some(partition_result) = partition_resolver.resolve_partition(region.as_ref() as &str, _diagnostic_collector) {
                ...
                if (*use_fips) == (false) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations.us-east-1.amazonaws.com".to_string())
                            .property(
                                "authSchemes",
            ...
            if (partition_result.name()) == ("aws") {
                if (*use_fips) == (true) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations-fips.us-east-1.amazonaws.com".to_string())
                            .property(
                                "authSchemes",
                                vec![::aws_smithy_types::Document::from({
                                    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
            ...
            if (partition_result.name()) == ("aws-us-gov") {
                if (*use_fips) == (false) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations.us-gov-west-1.amazonaws.com".to_string())
                            .property(
                                "authSchemes",
                                vec![::aws_smithy_types::Document::from({
                                    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
            ...
            if (partition_result.name()) == ("aws-iso") {
                if (*use_fips) == (false) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations.us-iso-east-1.c2s.ic.gov".to_string())
                            .property(
                                "authSchemes",
                                vec![::aws_smithy_types::Document::from({
                                    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
            ...
            if (partition_result.name()) == ("aws-iso-b") {
                if (*use_fips) == (false) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations.us-isob-east-1.sc2s.sgov.gov".to_string())
                            .property(
                                "authSchemes",
                                vec![::aws_smithy_types::Document::from({
                                    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
            ...
            if (partition_result.name()) == ("aws-iso-f") {
                if (*use_fips) == (false) {
                    if (*use_dual_stack) == (false) {
                        return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                            .url("https://organizations.us-isof-south-1.csp.hci.ic.gov".to_string())
                            .property(
                                "authSchemes",
                                vec![::aws_smithy_types::Document::from({
                                    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
