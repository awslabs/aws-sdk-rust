...
pub(crate) fn de_session_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SessionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
