...
pub fn ser_list_table_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTableMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
