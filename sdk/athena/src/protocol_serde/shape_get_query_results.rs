        ...
        "InternalServerException" => {
            crate::operation::get_query_results::GetQueryResultsError::InternalServerException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_server_exception::de_internal_server_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_query_results::GetQueryResultsError::unhandled)?;
        ...
        "InvalidRequestException" => {
            crate::operation::get_query_results::GetQueryResultsError::InvalidRequestException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_request_exception::de_invalid_request_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_query_results::GetQueryResultsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "TooManyRequestsException" => {
            crate::operation::get_query_results::GetQueryResultsError::TooManyRequestsException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_query_results::GetQueryResultsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
