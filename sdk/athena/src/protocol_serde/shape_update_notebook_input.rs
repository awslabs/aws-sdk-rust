...
pub fn ser_update_notebook_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNotebookInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
