...
pub fn ser_work_group_configuration_updates(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkGroupConfigurationUpdates) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
