...
pub fn ser_create_work_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
