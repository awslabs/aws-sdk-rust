...
pub fn ser_create_named_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNamedQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
