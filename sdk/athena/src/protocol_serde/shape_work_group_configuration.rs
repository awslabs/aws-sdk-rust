...
pub fn ser_work_group_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkGroupConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_work_group_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkGroupConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
