...
pub fn ser_start_query_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartQueryExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
