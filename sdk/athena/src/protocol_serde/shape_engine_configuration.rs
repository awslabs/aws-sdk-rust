            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AdditionalConfigs" => {
                            builder = builder.set_additional_configs(crate::protocol_serde::shape_parameters_map::de_parameters_map(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "SparkProperties" => {
                            builder = builder.set_spark_properties(crate::protocol_serde::shape_parameters_map::de_parameters_map(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "Classifications" => {
                            builder = builder.set_classifications(crate::protocol_serde::shape_classification_list::de_classification_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
