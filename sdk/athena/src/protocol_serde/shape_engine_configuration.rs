...
pub(crate) fn de_engine_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EngineConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_engine_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EngineConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
