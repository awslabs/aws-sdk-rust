...
pub fn ser_list_named_queries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListNamedQueriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
