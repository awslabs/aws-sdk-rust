...
pub fn ser_list_named_queries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_named_queries::ListNamedQueriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
