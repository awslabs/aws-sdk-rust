...
pub fn de_get_capacity_assignment_configuration_http_error(
...
> {
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::get_capacity_assignment_configuration::GetCapacityAssignmentConfigurationError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::get_capacity_assignment_configuration::GetCapacityAssignmentConfigurationError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_capacity_assignment_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CapacityAssignmentConfiguration" => {
                    builder = builder.set_capacity_assignment_configuration(
                        crate::protocol_serde::shape_capacity_assignment_configuration::de_capacity_assignment_configuration(tokens, _value)?,
                    );
                }
