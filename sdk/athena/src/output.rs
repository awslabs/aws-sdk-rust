...
pub struct ListWorkGroupsOutput  {
    ...
    #[doc(hidden)]pub work_groups: std::option::Option<std::vec::Vec<crate::model::WorkGroupSummary>>,
...
pub struct ListTableMetadataOutput  {
    ...
    #[doc(hidden)]pub table_metadata_list: std::option::Option<std::vec::Vec<crate::model::TableMetadata>>,
...
pub struct ListPreparedStatementsOutput  {
    ...
    #[doc(hidden)]pub prepared_statements: std::option::Option<std::vec::Vec<crate::model::PreparedStatementSummary>>,
    /// <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the <code>NextToken</code> from the response object of the previous page call.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDataCatalogsOutput  {
    ...
    #[doc(hidden)]pub data_catalogs_summary: std::option::Option<std::vec::Vec<crate::model::DataCatalogSummary>>,
    /// <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetWorkGroupOutput  {
    ...
    #[doc(hidden)]pub work_group: std::option::Option<crate::model::WorkGroup>,
}
...
pub struct GetTableMetadataOutput  {
    ...
    #[doc(hidden)]pub table_metadata: std::option::Option<crate::model::TableMetadata>,
}
...
pub struct GetQueryRuntimeStatisticsOutput  {
    ...
    #[doc(hidden)]pub query_runtime_statistics: std::option::Option<crate::model::QueryRuntimeStatistics>,
}
...
pub struct GetQueryResultsOutput  {
    ...
    #[doc(hidden)]pub update_count: std::option::Option<i64>,
    /// <p>The results of the query execution.</p>
    #[doc(hidden)]pub result_set: std::option::Option<crate::model::ResultSet>,
    /// <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the <code>NextToken</code> from the response object of the previous page call.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetQueryExecutionOutput  {
    ...
    #[doc(hidden)]pub query_execution: std::option::Option<crate::model::QueryExecution>,
}
...
pub struct GetPreparedStatementOutput  {
    ...
    #[doc(hidden)]pub prepared_statement: std::option::Option<crate::model::PreparedStatement>,
}
...
pub struct GetNamedQueryOutput  {
    ...
    #[doc(hidden)]pub named_query: std::option::Option<crate::model::NamedQuery>,
}
...
pub struct GetDataCatalogOutput  {
    ...
    #[doc(hidden)]pub data_catalog: std::option::Option<crate::model::DataCatalog>,
}
...
pub struct BatchGetQueryExecutionOutput  {
    ...
    #[doc(hidden)]pub query_executions: std::option::Option<std::vec::Vec<crate::model::QueryExecution>>,
    /// <p>Information about the query executions that failed to run.</p>
    #[doc(hidden)]pub unprocessed_query_execution_ids: std::option::Option<std::vec::Vec<crate::model::UnprocessedQueryExecutionId>>,
}
...
impl  std::fmt::Debug for BatchGetQueryExecutionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("unprocessed_query_execution_ids", &self.unprocessed_query_execution_ids);
        formatter.finish()
    }
}
...
pub struct BatchGetPreparedStatementOutput  {
    ...
    #[doc(hidden)]pub prepared_statements: std::option::Option<std::vec::Vec<crate::model::PreparedStatement>>,
    /// <p>A list of one or more prepared statements that were requested but could not be returned.</p>
    #[doc(hidden)]pub unprocessed_prepared_statement_names: std::option::Option<std::vec::Vec<crate::model::UnprocessedPreparedStatementName>>,
}
...
impl  std::fmt::Debug for BatchGetPreparedStatementOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("prepared_statements", &self.prepared_statements);
        formatter.field("unprocessed_prepared_statement_names", &self.unprocessed_prepared_statement_names);
        formatter.finish()
    }
}
...
pub struct BatchGetNamedQueryOutput  {
    ...
    #[doc(hidden)]pub named_queries: std::option::Option<std::vec::Vec<crate::model::NamedQuery>>,
    /// <p>Information about provided query IDs.</p>
    #[doc(hidden)]pub unprocessed_named_query_ids: std::option::Option<std::vec::Vec<crate::model::UnprocessedNamedQueryId>>,
}
...
impl  std::fmt::Debug for BatchGetNamedQueryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("unprocessed_named_query_ids", &self.unprocessed_named_query_ids);
        formatter.finish()
    }
}
