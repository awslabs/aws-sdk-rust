...
pub fn serialize_structure_batch_get_named_query_input(
...
pub fn serialize_structure_batch_get_query_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_data_catalog_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_named_query_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_prepared_statement_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_work_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_29) = &input.configuration {
        ...
        crate::json_ser::serialize_structure_work_group_configuration(&mut object_30, var_29);
        object_30.finish();
    }
...
pub fn serialize_structure_delete_data_catalog_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_named_query_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_prepared_statement_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_work_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_data_catalog_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_named_query_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_prepared_statement_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_query_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_table_metadata_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_work_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_data_catalogs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_engine_versions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_named_queries_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_prepared_statements_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_query_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_table_metadata_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_work_groups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_query_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_84) = &input.query_execution_context {
        ...
        crate::json_ser::serialize_structure_query_execution_context(&mut object_85, var_84);
        object_85.finish();
    }
    if let Some(var_86) = &input.result_configuration {
        let mut object_87 = object.key("ResultConfiguration").start_object();
        crate::json_ser::serialize_structure_result_configuration(&mut object_87, var_86);
        object_87.finish();
    }
...
pub fn serialize_structure_stop_query_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_data_catalog_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_prepared_statement_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_work_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_112) = &input.configuration_updates {
        ...
        crate::json_ser::serialize_structure_work_group_configuration_updates(
            &mut object_113,
            var_112,
        );
        object_113.finish();
...
pub fn serialize_structure_work_group_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_117) = &input.result_configuration {
        ...
        crate::json_ser::serialize_structure_result_configuration(&mut object_118, var_117);
        object_118.finish();
    }
    ...
    if let Some(var_123) = &input.engine_version {
        ...
        crate::json_ser::serialize_structure_engine_version(&mut object_124, var_123);
        object_124.finish();
    }
}

pub fn serialize_structure_query_execution_context(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_result_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_128) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_129, var_128);
        object_129.finish();
    }
}

pub fn serialize_structure_work_group_configuration_updates(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_131) = &input.result_configuration_updates {
        ...
        crate::json_ser::serialize_structure_result_configuration_updates(&mut object_132, var_131);
        object_132.finish();
    }
    ...
    if let Some(var_137) = &input.engine_version {
        ...
        crate::json_ser::serialize_structure_engine_version(&mut object_138, var_137);
        object_138.finish();
    }
}

pub fn serialize_structure_engine_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_result_configuration_updates(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_145) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_146, var_145);
        object_146.finish();
    }
