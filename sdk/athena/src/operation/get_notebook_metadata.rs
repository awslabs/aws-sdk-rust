...
impl GetNotebookMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_notebook_metadata::GetNotebookMetadata,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNotebookMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_notebook_metadata::de_get_notebook_metadata_http_response_with_props(status, headers, body)
        }
    }
}
