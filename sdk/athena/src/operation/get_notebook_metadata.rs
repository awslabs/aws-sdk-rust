...
impl GetNotebookMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetNotebookMetadata`](crate::operation::get_notebook_metadata::GetNotebookMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_notebook_metadata::GetNotebookMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_notebook_metadata::GetNotebookMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_notebook_metadata::ser_get_notebook_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_notebook_metadata::GetNotebookMetadata::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetNotebookMetadata {
                type Output = std::result::Result<crate::operation::get_notebook_metadata::GetNotebookMetadataOutput, crate::operation::get_notebook_metadata::GetNotebookMetadataError>;
