...
impl GetNotebookMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_notebook_metadata::GetNotebookMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNotebookMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_notebook_metadata::de_get_notebook_metadata_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_notebook_metadata::GetNotebookMetadataError
{
