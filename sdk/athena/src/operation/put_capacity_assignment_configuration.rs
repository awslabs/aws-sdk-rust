...
impl PutCapacityAssignmentConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_capacity_assignment_configuration::PutCapacityAssignmentConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_capacity_assignment_configuration::PutCapacityAssignmentConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutCapacityAssignmentConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_capacity_assignment_configuration::de_put_capacity_assignment_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
