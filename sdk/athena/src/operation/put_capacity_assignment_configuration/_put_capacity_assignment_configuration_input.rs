...
impl PutCapacityAssignmentConfigurationInputBuilder {
    ...
    pub fn capacity_reservation_name(mut self, input: impl Into<std::string::String>) -> Self {
        self.capacity_reservation_name = Some(input.into());
        self
    }
    /// <p>The name of the capacity reservation to put a capacity assignment configuration for.</p>
    ...
    pub fn capacity_assignments(mut self, input: crate::types::CapacityAssignment) -> Self {
        ...
        v.push(input);
        self.capacity_assignments = Some(v);
        self
    }
    /// <p>The list of assignments for the capacity assignment configuration.</p>
    ...
    pub fn build(self) -> Result<crate::operation::put_capacity_assignment_configuration::PutCapacityAssignmentConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
