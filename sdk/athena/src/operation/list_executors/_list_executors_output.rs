...
impl ListExecutorsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_executors::ListExecutorsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_executors::ListExecutorsOutput {
                session_id: self.session_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("session_id", "session_id was not specified but it is required when building ListExecutorsOutput")
                    )?
                ,
