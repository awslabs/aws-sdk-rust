...
impl ListQueryExecutionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_query_executions::paginator::ListQueryExecutionsPaginator {
        crate::operation::list_query_executions::paginator::ListQueryExecutionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
