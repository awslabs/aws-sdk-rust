...
impl UpdateNamedQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_named_query::UpdateNamedQuery,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_named_query::ser_update_named_query_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNamedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_named_query::de_update_named_query_http_response_with_props(status, headers, body)
        }
    }
}
