...
impl UpdateNamedQueryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNamedQuery`](crate::operation::update_named_query::UpdateNamedQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_named_query::UpdateNamedQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_named_query::UpdateNamedQueryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_named_query::UpdateNamedQuery::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNamedQuery {
                type Output = std::result::Result<crate::operation::update_named_query::UpdateNamedQueryOutput, crate::operation::update_named_query::UpdateNamedQueryError>;
