...
impl GetQueryResultsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_query_results::GetQueryResults::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_query_results::de_get_query_results_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_query_results::GetQueryResultsError
{
