...
impl GetQueryResultsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_query_results::GetQueryResults, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_query_results::ser_get_query_results_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_query_results::de_get_query_results_http_response_with_props(status, headers, body)
        }
    }
}
