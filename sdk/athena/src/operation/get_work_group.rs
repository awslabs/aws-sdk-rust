...
impl GetWorkGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_work_group::GetWorkGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_work_group::ser_get_work_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_work_group::de_get_work_group_http_response_with_props(status, headers, body)
        }
    }
}
