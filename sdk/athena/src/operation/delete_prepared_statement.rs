...
impl DeletePreparedStatementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_prepared_statement::DeletePreparedStatement,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePreparedStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_prepared_statement::de_delete_prepared_statement_http_response_with_props(status, headers, body)
        }
    }
}
