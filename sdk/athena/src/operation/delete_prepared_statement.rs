...
/// Orchestration and serialization glue logic for `DeletePreparedStatement`.
...
impl DeletePreparedStatement {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_prepared_statement::DeletePreparedStatementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_prepared_statement::DeletePreparedStatementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_prepared_statement::DeletePreparedStatementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_prepared_statement::DeletePreparedStatementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeletePreparedStatement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeletePreparedStatement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeletePreparedStatementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeletePreparedStatementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeletePreparedStatement")
...
.with_interceptor(DeletePreparedStatementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_prepared_statement::DeletePreparedStatementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_prepared_statement::DeletePreparedStatementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_prepared_statement::DeletePreparedStatementError>::new());
...
#[derive(Debug)]
            struct DeletePreparedStatementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePreparedStatementResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_prepared_statement::de_delete_prepared_statement_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_prepared_statement::de_delete_prepared_statement_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeletePreparedStatementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePreparedStatementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_prepared_statement::DeletePreparedStatementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_prepared_statement::DeletePreparedStatementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_prepared_statement::ser_delete_prepared_statement_input(&input)?);
...
#[derive(Debug)]
            struct DeletePreparedStatementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeletePreparedStatementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeletePreparedStatementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeletePreparedStatementInput>()
                        .ok_or("failed to downcast to DeletePreparedStatementInput")?;
...
pub enum DeletePreparedStatementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeletePreparedStatementError) for what information is available for the error.")]
...
impl DeletePreparedStatementError {
    /// Creates the `DeletePreparedStatementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeletePreparedStatementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeletePreparedStatementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_prepared_statement::DeletePreparedStatementError {
...
mod _delete_prepared_statement_output;
