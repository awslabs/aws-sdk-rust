...
impl ImportNotebookFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::import_notebook::ImportNotebookOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_notebook::ImportNotebookError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::import_notebook::ImportNotebookOutput, crate::operation::import_notebook::ImportNotebookError, Self> {
