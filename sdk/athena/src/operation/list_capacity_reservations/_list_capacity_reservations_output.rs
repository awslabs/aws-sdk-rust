...
impl  ListCapacityReservationsOutput  {
    ...
    pub fn capacity_reservations(&self) -> & [crate::types::CapacityReservation] {
        use std::ops::Deref; self.capacity_reservations.deref()
    }
}
...
impl ListCapacityReservationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_capacity_reservations::ListCapacityReservationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_capacity_reservations::ListCapacityReservationsOutput {
                ...
                capacity_reservations: self.capacity_reservations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("capacity_reservations", "capacity_reservations was not specified but it is required when building ListCapacityReservationsOutput")
                    )?
                ,
