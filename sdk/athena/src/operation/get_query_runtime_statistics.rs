...
/// Orchestration and serialization glue logic for `GetQueryRuntimeStatistics`.
...
impl GetQueryRuntimeStatistics {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsInput,
                    ) -> ::std::result::Result<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetQueryRuntimeStatistics {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetQueryRuntimeStatistics");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetQueryRuntimeStatisticsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetQueryRuntimeStatisticsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetQueryRuntimeStatistics")
...
.with_interceptor(GetQueryRuntimeStatisticsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError>::new());
...
#[derive(Debug)]
            struct GetQueryRuntimeStatisticsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetQueryRuntimeStatisticsResponseDeserializer {
...
#[derive(Debug)]
            struct GetQueryRuntimeStatisticsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetQueryRuntimeStatisticsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_query_runtime_statistics::ser_get_query_runtime_statistics_input(&input)?);
...
#[derive(Debug)]
            struct GetQueryRuntimeStatisticsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetQueryRuntimeStatisticsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetQueryRuntimeStatisticsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetQueryRuntimeStatisticsInput>()
                        .ok_or("failed to downcast to GetQueryRuntimeStatisticsInput")?;
...
pub enum GetQueryRuntimeStatisticsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetQueryRuntimeStatisticsError) for what information is available for the error.")]
...
impl GetQueryRuntimeStatisticsError {
    /// Creates the `GetQueryRuntimeStatisticsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetQueryRuntimeStatisticsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetQueryRuntimeStatisticsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_query_runtime_statistics::GetQueryRuntimeStatisticsError {
...
mod _get_query_runtime_statistics_output;
