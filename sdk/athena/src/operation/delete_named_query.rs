...
impl DeleteNamedQueryInput {
    ...
    > {
        ...
        if self.named_query_id.is_none() {
            self.named_query_id = ::std::option::Option::Some(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_named_query::DeleteNamedQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNamedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_named_query::de_delete_named_query_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_named_query::DeleteNamedQueryError
{
