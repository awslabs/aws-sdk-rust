...
impl DeleteNamedQueryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNamedQuery`](crate::operation::delete_named_query::DeleteNamedQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_named_query::DeleteNamedQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_named_query::DeleteNamedQuery::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteNamedQuery {
                type Output = std::result::Result<crate::operation::delete_named_query::DeleteNamedQueryOutput, crate::operation::delete_named_query::DeleteNamedQueryError>;
