...
impl DeleteNamedQueryInput {
    ...
    > {
        ...
        if self.named_query_id.is_none() {
            self.named_query_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_named_query::ser_delete_named_query_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNamedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_named_query::de_delete_named_query_http_response_with_props(status, headers, body)
        }
    }
}
