...
impl aws_smithy_http::response::ParseStrictResponse for DeleteNamedQuery {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_named_query::de_delete_named_query_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_named_query::de_delete_named_query_http_response(response)
                     }
                }
            }
