...
impl UpdateNotebookInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_notebook::UpdateNotebook::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNotebook {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_notebook::de_update_notebook_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_notebook::de_update_notebook_http_response(
                status, headers, body,
            )
        }
    }
