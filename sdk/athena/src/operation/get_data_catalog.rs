...
impl GetDataCatalogInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_data_catalog::GetDataCatalog, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_data_catalog::ser_get_data_catalog_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataCatalog {
    type Output =
        ::std::result::Result<crate::operation::get_data_catalog::GetDataCatalogOutput, crate::operation::get_data_catalog::GetDataCatalogError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_data_catalog::de_get_data_catalog_http_response_with_props(status, headers, body)
        }
    }
}
