...
impl GetDataCatalogInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_data_catalog::GetDataCatalog,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_data_catalog::GetDataCatalog::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataCatalog {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_data_catalog::de_get_data_catalog_http_error(
                status, headers, body,
            )
        } else {
