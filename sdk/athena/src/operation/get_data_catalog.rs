...
impl aws_smithy_http::response::ParseStrictResponse for GetDataCatalog {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_data_catalog::de_get_data_catalog_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_data_catalog::de_get_data_catalog_http_response(response)
                     }
                }
            }
