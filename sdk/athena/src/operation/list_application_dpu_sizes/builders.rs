...
impl ListApplicationDPUSizesFluentBuilder  {
    /// Creates a new `ListApplicationDPUSizes`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_application_dpu_sizes::ListApplicationDpuSizesOutput, aws_smithy_http::result::SdkError<crate::operation::list_application_dpu_sizes::ListApplicationDPUSizesError>>
                     {
