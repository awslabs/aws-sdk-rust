...
impl ListApplicationDpuSizesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_dpu_sizes::ListApplicationDpuSizesInput, ::aws_smithy_types::error::operation::BuildError> {
