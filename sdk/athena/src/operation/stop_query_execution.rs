...
impl StopQueryExecutionInput {
    ...
    > {
        ...
        if self.query_execution_id.is_none() {
            self.query_execution_id = ::std::option::Option::Some(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_query_execution::StopQueryExecution::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_query_execution::StopQueryExecutionError
{
