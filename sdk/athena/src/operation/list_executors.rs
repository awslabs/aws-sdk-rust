...
impl ListExecutorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_executors::ListExecutors, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_executors::ser_list_executors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListExecutors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_executors::de_list_executors_http_response_with_props(status, headers, body)
        }
    }
}
