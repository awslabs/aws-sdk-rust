...
impl ListWorkGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_work_groups::ListWorkGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_work_groups::ser_list_work_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkGroups {
    type Output =
        ::std::result::Result<crate::operation::list_work_groups::ListWorkGroupsOutput, crate::operation::list_work_groups::ListWorkGroupsError>;
