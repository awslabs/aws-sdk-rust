...
impl CancelCapacityReservationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_capacity_reservation::CancelCapacityReservationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_capacity_reservation::CancelCapacityReservationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_capacity_reservation::CancelCapacityReservationOutput, crate::operation::cancel_capacity_reservation::CancelCapacityReservationError, Self> {
