...
impl DeleteDataCatalogInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_data_catalog::DeleteDataCatalog,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_data_catalog::ser_delete_data_catalog_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDataCatalog {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_data_catalog::de_delete_data_catalog_http_response_with_props(status, headers, body)
        }
    }
}
