...
impl DeleteNotebookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_notebook::DeleteNotebook,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_notebook::DeleteNotebook::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotebook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_notebook::de_delete_notebook_http_error(
                status, headers, body,
            )
        } else {
