...
impl DeleteNotebookInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNotebook`](crate::operation::delete_notebook::DeleteNotebook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_notebook::DeleteNotebook, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_notebook::DeleteNotebookInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_notebook::DeleteNotebook::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteNotebook {
                type Output = std::result::Result<crate::operation::delete_notebook::DeleteNotebookOutput, crate::operation::delete_notebook::DeleteNotebookError>;
