...
impl DeleteNotebookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_notebook::DeleteNotebook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_notebook::ser_delete_notebook_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotebook {
    type Output =
        ::std::result::Result<crate::operation::delete_notebook::DeleteNotebookOutput, crate::operation::delete_notebook::DeleteNotebookError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_notebook::de_delete_notebook_http_response_with_props(status, headers, body)
        }
    }
}
