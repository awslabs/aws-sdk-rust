...
impl GetCapacityAssignmentConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_capacity_assignment_configuration::GetCapacityAssignmentConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
