...
impl BatchGetPreparedStatementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_prepared_statement::BatchGetPreparedStatementInput, ::aws_smithy_types::error::operation::BuildError> {
