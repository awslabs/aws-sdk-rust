...
/// Orchestration and serialization glue logic for `CreateDataCatalog`.
...
impl CreateDataCatalog {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_data_catalog::CreateDataCatalogInput,
                    ) -> ::std::result::Result<crate::operation::create_data_catalog::CreateDataCatalogOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_data_catalog::CreateDataCatalogError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_data_catalog::CreateDataCatalogError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_data_catalog::CreateDataCatalogOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataCatalog {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDataCatalog");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDataCatalogRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDataCatalogResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDataCatalog")
...
.with_interceptor(CreateDataCatalogEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_data_catalog::CreateDataCatalogError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_data_catalog::CreateDataCatalogError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_data_catalog::CreateDataCatalogError>::new());
...
#[derive(Debug)]
            struct CreateDataCatalogResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataCatalogResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_data_catalog::de_create_data_catalog_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_data_catalog::de_create_data_catalog_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateDataCatalogRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataCatalogRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_data_catalog::CreateDataCatalogInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_data_catalog::CreateDataCatalogInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_data_catalog::ser_create_data_catalog_input(&input)?);
...
#[derive(Debug)]
            struct CreateDataCatalogEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDataCatalogEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDataCatalogEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDataCatalogInput>()
                        .ok_or("failed to downcast to CreateDataCatalogInput")?;
...
pub enum CreateDataCatalogError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDataCatalogError) for what information is available for the error.")]
...
impl CreateDataCatalogError {
    /// Creates the `CreateDataCatalogError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDataCatalogError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDataCatalogError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_data_catalog::CreateDataCatalogError {
...
mod _create_data_catalog_output;
