...
impl CreateDataCatalogInput {
    /// Consumes the builder and constructs an Operation<[`CreateDataCatalog`](crate::operation::create_data_catalog::CreateDataCatalog)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_data_catalog::CreateDataCatalog, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_data_catalog::CreateDataCatalogInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_catalog::CreateDataCatalog::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDataCatalog {
                type Output = std::result::Result<crate::operation::create_data_catalog::CreateDataCatalogOutput, crate::operation::create_data_catalog::CreateDataCatalogError>;
