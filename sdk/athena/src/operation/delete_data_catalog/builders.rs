...
impl DeleteDataCatalogFluentBuilder  {
    /// Creates a new `DeleteDataCatalog`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_data_catalog::DeleteDataCatalogOutput, aws_smithy_http::result::SdkError<crate::operation::delete_data_catalog::DeleteDataCatalogError>>
                     {
