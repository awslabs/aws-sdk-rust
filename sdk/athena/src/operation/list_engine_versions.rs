...
impl ListEngineVersionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_engine_versions::ser_list_engine_versions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEngineVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_engine_versions::de_list_engine_versions_http_response_with_props(status, headers, body)
        }
    }
}
