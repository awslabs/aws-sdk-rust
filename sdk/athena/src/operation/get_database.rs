...
impl GetDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`GetDatabase`](crate::operation::get_database::GetDatabase)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_database::GetDatabase, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_database::ser_get_database_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_database::GetDatabase::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatabase {
    type Output = ::std::result::Result<crate::operation::get_database::GetDatabaseOutput, crate::operation::get_database::GetDatabaseError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_database::de_get_database_http_response_with_props(status, headers, body)
        }
    }
}
