...
/// Orchestration and serialization glue logic for `GetPreparedStatement`.
...
impl GetPreparedStatement {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_prepared_statement::GetPreparedStatementInput,
                    ) -> ::std::result::Result<crate::operation::get_prepared_statement::GetPreparedStatementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_prepared_statement::GetPreparedStatementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_prepared_statement::GetPreparedStatementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_prepared_statement::GetPreparedStatementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPreparedStatement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPreparedStatement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPreparedStatementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPreparedStatementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPreparedStatement")
...
.with_interceptor(GetPreparedStatementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_prepared_statement::GetPreparedStatementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_prepared_statement::GetPreparedStatementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_prepared_statement::GetPreparedStatementError>::new());
...
#[derive(Debug)]
            struct GetPreparedStatementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPreparedStatementResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_prepared_statement::de_get_prepared_statement_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_prepared_statement::de_get_prepared_statement_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetPreparedStatementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPreparedStatementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_prepared_statement::GetPreparedStatementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_prepared_statement::GetPreparedStatementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_prepared_statement::ser_get_prepared_statement_input(&input)?);
...
#[derive(Debug)]
            struct GetPreparedStatementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPreparedStatementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPreparedStatementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPreparedStatementInput>()
                        .ok_or("failed to downcast to GetPreparedStatementInput")?;
...
pub enum GetPreparedStatementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPreparedStatementError) for what information is available for the error.")]
...
impl GetPreparedStatementError {
    /// Creates the `GetPreparedStatementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPreparedStatementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPreparedStatementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_prepared_statement::GetPreparedStatementError {
...
mod _get_prepared_statement_output;
