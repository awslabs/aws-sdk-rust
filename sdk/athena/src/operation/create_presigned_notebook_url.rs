...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePresignedNotebookUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_presigned_notebook_url::de_create_presigned_notebook_url_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_presigned_notebook_url::CreatePresignedNotebookUrlError
{
