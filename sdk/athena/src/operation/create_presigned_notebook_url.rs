...
impl CreatePresignedNotebookUrlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_presigned_notebook_url::CreatePresignedNotebookUrl::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePresignedNotebookUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_presigned_notebook_url::de_create_presigned_notebook_url_http_response_with_props(
                status, headers, body,
            )
        }
    }
