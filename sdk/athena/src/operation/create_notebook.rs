...
impl CreateNotebookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_notebook::CreateNotebook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_notebook::ser_create_notebook_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNotebook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_notebook::de_create_notebook_http_response_with_props(status, headers, body)
        }
    }
}
