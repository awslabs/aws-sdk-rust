...
impl GetQueryExecutionFluentBuilder  {
    /// Creates a new `GetQueryExecution`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_query_execution::GetQueryExecutionOutput, aws_smithy_http::result::SdkError<crate::operation::get_query_execution::GetQueryExecutionError>>
                     {
