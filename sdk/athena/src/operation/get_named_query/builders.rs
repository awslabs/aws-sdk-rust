...
impl GetNamedQueryFluentBuilder  {
    /// Creates a new `GetNamedQuery`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_named_query::GetNamedQuery, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_named_query::GetNamedQueryOutput, aws_smithy_http::result::SdkError<crate::operation::get_named_query::GetNamedQueryError>>
                     {
