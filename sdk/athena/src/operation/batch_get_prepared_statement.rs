...
impl BatchGetPreparedStatementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_prepared_statement::BatchGetPreparedStatement::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_get_prepared_statement::BatchGetPreparedStatementError
{
