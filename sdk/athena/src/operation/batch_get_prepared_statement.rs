...
impl BatchGetPreparedStatementInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetPreparedStatement`](crate::operation::batch_get_prepared_statement::BatchGetPreparedStatement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_prepared_statement::BatchGetPreparedStatement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_prepared_statement::BatchGetPreparedStatementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_prepared_statement::BatchGetPreparedStatement::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetPreparedStatement {
                type Output = std::result::Result<crate::operation::batch_get_prepared_statement::BatchGetPreparedStatementOutput, crate::operation::batch_get_prepared_statement::BatchGetPreparedStatementError>;
