...
impl BatchGetPreparedStatementInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_prepared_statement::BatchGetPreparedStatement::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetPreparedStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_prepared_statement::de_batch_get_prepared_statement_http_response_with_props(status, headers, body)
        }
    }
}
