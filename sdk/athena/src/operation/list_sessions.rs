...
impl ListSessionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_sessions::ListSessions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_sessions::ser_list_sessions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSessions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sessions::de_list_sessions_http_response_with_props(status, headers, body)
        }
    }
}
