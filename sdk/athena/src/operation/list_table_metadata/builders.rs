...
impl ListTableMetadataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_table_metadata::ListTableMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_table_metadata::ListTableMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_table_metadata::ListTableMetadataOutput, crate::operation::list_table_metadata::ListTableMetadataError, Self> {
