...
impl CancelCapacityReservationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_capacity_reservation::ser_cancel_capacity_reservation_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_capacity_reservation::CancelCapacityReservation::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelCapacityReservation", "athena"));
