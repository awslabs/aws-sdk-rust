...
pub struct ListNotebookSessionsOutput {
    ...
    pub notebook_sessions_list:
        ::std::option::Option<::std::vec::Vec<crate::types::NotebookSessionSummary>>,
...
impl ListNotebookSessionsOutput {
    ...
    pub fn notebook_sessions_list(
        &self,
    ) -> ::std::option::Option<&[crate::types::NotebookSessionSummary]> {
...
impl ListNotebookSessionsOutputBuilder {
    ...
    pub fn set_notebook_sessions_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::NotebookSessionSummary>>,
    ) -> Self {
        self.notebook_sessions_list = input;
        self
    }
    /// <p>A list of the sessions belonging to the notebook.</p>
    pub fn get_notebook_sessions_list(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<crate::types::NotebookSessionSummary>> {
