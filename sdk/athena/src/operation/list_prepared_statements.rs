...
impl ListPreparedStatementsInput {
    /// Consumes the builder and constructs an Operation<[`ListPreparedStatements`](crate::operation::list_prepared_statements::ListPreparedStatements)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_prepared_statements::ListPreparedStatements, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_prepared_statements::ListPreparedStatementsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_prepared_statements::ListPreparedStatements::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListPreparedStatements {
                type Output = std::result::Result<crate::operation::list_prepared_statements::ListPreparedStatementsOutput, crate::operation::list_prepared_statements::ListPreparedStatementsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_prepared_statements::de_list_prepared_statements_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_prepared_statements::de_list_prepared_statements_http_response(response)
                     }
                }
            }
