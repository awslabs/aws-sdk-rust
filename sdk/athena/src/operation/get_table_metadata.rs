...
impl GetTableMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_table_metadata::GetTableMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTableMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_table_metadata::de_get_table_metadata_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_table_metadata::GetTableMetadataError
{
