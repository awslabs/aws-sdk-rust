...
impl GetTableMetadataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_table_metadata::ser_get_table_metadata_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTableMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_table_metadata::de_get_table_metadata_http_response_with_props(status, headers, body)
        }
    }
}
