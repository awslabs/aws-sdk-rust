...
impl CreateCapacityReservation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_capacity_reservation::CreateCapacityReservationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_capacity_reservation::CreateCapacityReservationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("athena", "CreateCapacityReservation", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCapacityReservation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            CreateCapacityReservationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            CreateCapacityReservationResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateCapacityReservation", "athena"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCapacityReservation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateCapacityReservationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateCapacityReservationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_capacity_reservation::CreateCapacityReservationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_capacity_reservation::CreateCapacityReservationInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_capacity_reservation::ser_create_capacity_reservation_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateCapacityReservationEndpointParamsInterceptor {
...
pub type CreateCapacityReservationErrorKind = CreateCapacityReservationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateCapacityReservationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_capacity_reservation::CreateCapacityReservationError {
...
impl CreateCapacityReservationError {
    ...
    /// Creates the `CreateCapacityReservationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
