...
impl CreateCapacityReservation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_capacity_reservation::CreateCapacityReservationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_capacity_reservation::CreateCapacityReservationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_capacity_reservation::CreateCapacityReservationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_capacity_reservation::CreateCapacityReservationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCapacityReservation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCapacityReservation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCapacityReservationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCapacityReservationResponseDeserializer));
...
.with_interceptor(CreateCapacityReservationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_capacity_reservation::CreateCapacityReservationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_capacity_reservation::CreateCapacityReservationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_capacity_reservation::CreateCapacityReservationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_capacity_reservation::de_create_capacity_reservation_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCapacityReservationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_capacity_reservation::CreateCapacityReservationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_capacity_reservation::CreateCapacityReservationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "AmazonAthena.CreateCapacityReservation"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_capacity_reservation::ser_create_capacity_reservation_input(&input)?);
...
#[derive(Debug)]
            struct CreateCapacityReservationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCapacityReservationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCapacityReservationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCapacityReservationInput>()
                        .ok_or("failed to downcast to CreateCapacityReservationInput")?;
...
/// Error type for the `CreateCapacityReservationError` operation.
#[non_exhaustive]
...
pub enum CreateCapacityReservationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCapacityReservationError) for what information is available for the error.")]
...
impl CreateCapacityReservationError {
    /// Creates the `CreateCapacityReservationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCapacityReservationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateCapacityReservationError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreateCapacityReservationError::InvalidRequestException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateCapacityReservationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCapacityReservationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_capacity_reservation::CreateCapacityReservationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_capacity_reservation::_create_capacity_reservation_output::CreateCapacityReservationOutput;

pub use crate::operation::create_capacity_reservation::_create_capacity_reservation_input::CreateCapacityReservationInput;

mod _create_capacity_reservation_input;

mod _create_capacity_reservation_output;
