...
impl CreateCapacityReservationInput {
    /// Consumes the builder and constructs an Operation<[`CreateCapacityReservation`](crate::operation::create_capacity_reservation::CreateCapacityReservation)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_capacity_reservation::ser_create_capacity_reservation_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_capacity_reservation::CreateCapacityReservation::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateCapacityReservation", "athena"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCapacityReservation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_capacity_reservation::de_create_capacity_reservation_http_response_with_props(status, headers, body)
        }
    }
}
