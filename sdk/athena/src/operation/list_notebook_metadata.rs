...
impl ListNotebookMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_notebook_metadata::ListNotebookMetadata,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNotebookMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_notebook_metadata::de_list_notebook_metadata_http_response_with_props(status, headers, body)
        }
    }
}
