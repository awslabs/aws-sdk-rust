...
impl aws_smithy_http::response::ParseStrictResponse for StartQueryExecution {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_query_execution::de_start_query_execution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_query_execution::de_start_query_execution_http_response(response)
                     }
                }
            }
