...
impl StartQueryExecutionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_query_execution::StartQueryExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartQueryExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_query_execution::de_start_query_execution_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_query_execution::StartQueryExecutionError
{
