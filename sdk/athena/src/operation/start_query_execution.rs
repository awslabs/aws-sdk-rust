...
impl StartQueryExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartQueryExecution`](crate::operation::start_query_execution::StartQueryExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_query_execution::StartQueryExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_query_execution::StartQueryExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_query_execution::ser_start_query_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_query_execution::StartQueryExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartQueryExecution {
                type Output = std::result::Result<crate::operation::start_query_execution::StartQueryExecutionOutput, crate::operation::start_query_execution::StartQueryExecutionError>;
