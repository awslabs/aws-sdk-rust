...
impl CreateNamedQueryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_named_query::ser_create_named_query_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNamedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_named_query::de_create_named_query_http_response_with_props(status, headers, body)
        }
    }
}
