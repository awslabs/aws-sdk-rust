...
impl CreateNamedQueryInput {
    /// Consumes the builder and constructs an Operation<[`CreateNamedQuery`](crate::operation::create_named_query::CreateNamedQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_named_query::CreateNamedQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_named_query::CreateNamedQueryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_named_query::CreateNamedQuery::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNamedQuery {
                type Output = std::result::Result<crate::operation::create_named_query::CreateNamedQueryOutput, crate::operation::create_named_query::CreateNamedQueryError>;
