...
impl CreateNamedQueryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_named_query::CreateNamedQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNamedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_named_query::de_create_named_query_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_named_query::CreateNamedQueryError
{
