...
impl StartSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_session::StartSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_session::de_start_session_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_session::de_start_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
