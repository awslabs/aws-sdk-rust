...
impl StartSessionInput {
    /// Consumes the builder and constructs an Operation<[`StartSession`](crate::operation::start_session::StartSession)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_session::StartSession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_session::ser_start_session_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_session::StartSession::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSession {
    type Output = ::std::result::Result<crate::operation::start_session::StartSessionOutput, crate::operation::start_session::StartSessionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_session::de_start_session_http_response_with_props(status, headers, body)
        }
    }
}
