...
impl ImportNotebookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::import_notebook::ImportNotebook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_notebook::ser_import_notebook_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportNotebook {
    type Output =
        ::std::result::Result<crate::operation::import_notebook::ImportNotebookOutput, crate::operation::import_notebook::ImportNotebookError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_notebook::de_import_notebook_http_response_with_props(status, headers, body)
        }
    }
}
