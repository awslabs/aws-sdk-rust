...
impl UpdateWorkGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateWorkGroup`](crate::operation::update_work_group::UpdateWorkGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_work_group::UpdateWorkGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_work_group::UpdateWorkGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_work_group::UpdateWorkGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateWorkGroup {
                type Output = std::result::Result<crate::operation::update_work_group::UpdateWorkGroupOutput, crate::operation::update_work_group::UpdateWorkGroupError>;
...
impl aws_http::request_id::RequestId for crate::operation::update_work_group::UpdateWorkGroupError {
