...
impl UpdateWorkGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_work_group::UpdateWorkGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_work_group::ser_update_work_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkGroup {
    type Output =
        ::std::result::Result<crate::operation::update_work_group::UpdateWorkGroupOutput, crate::operation::update_work_group::UpdateWorkGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_work_group::de_update_work_group_http_response_with_props(status, headers, body)
        }
    }
}
