...
impl<R>
    From<
        aws_smithy_http::result::SdkError<crate::operation::get_named_query::GetNamedQueryError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<aws_smithy_http::result::SdkError<crate::operation::get_work_group::GetWorkGroupError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<aws_smithy_http::result::SdkError<crate::operation::list_executors::ListExecutorsError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
