...
/// **NOTE:** `ColumnNullable::Unknown` has been renamed to `::UnknownValue`.
#[non_exhaustive]
#[derive(
    std::clone::Clone,
    std::cmp::Eq,
...
pub struct QueryExecutionStatus {
    ...
    pub submission_date_time: std::option::Option<smithy_types::Instant>,
    /// <p>The date and time that the query completed.</p>
    pub completion_date_time: std::option::Option<smithy_types::Instant>,
}
...
pub mod query_execution_status {
    ...
    pub struct Builder {
        ...
        pub(crate) submission_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) completion_date_time: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The state of query execution. <code>QUEUED</code> indicates that the query has been
        /// submitted to the service, and Athena will execute the query as soon as resources are
        ...
        /// <p>The date and time that the query was submitted.</p>
        pub fn submission_date_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>The date and time that the query completed.</p>
        pub fn completion_date_time(mut self, input: smithy_types::Instant) -> Self {
