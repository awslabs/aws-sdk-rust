...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_description): <p>The session description.</p>
    ///   - [`work_group(impl Into<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::work_group) / [`set_work_group(Option<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_work_group): <p>The workgroup to which the session belongs.</p>
    ///   - [`engine_configuration(EngineConfiguration)`](crate::operation::start_session::builders::StartSessionFluentBuilder::engine_configuration) / [`set_engine_configuration(Option<EngineConfiguration>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_engine_configuration): <p>Contains engine data processing unit (DPU) configuration settings and parameter mappings.</p>
    ///   - [`notebook_version(impl Into<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::notebook_version) / [`set_notebook_version(Option<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_notebook_version): <p>The notebook version. This value is required only when requesting that a notebook server be started for the session. The only valid notebook version is <code>Jupyter1.0</code>.</p>
    ///   - [`session_idle_timeout_in_minutes(i32)`](crate::operation::start_session::builders::StartSessionFluentBuilder::session_idle_timeout_in_minutes) / [`set_session_idle_timeout_in_minutes(Option<i32>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_session_idle_timeout_in_minutes): <p>The idle timeout in minutes for the session.</p>
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::start_session::builders::StartSessionFluentBuilder::set_client_request_token): <p>A unique case-sensitive string used to ensure the request to create the session is idempotent (executes only once). If another <code>StartSessionRequest</code> is received, the same response is returned and another session is not created. If a parameter has changed, an error is returned.</p> <important>   <p>This token is listed as not required because Amazon Web Services SDKs (for example the Amazon Web Services SDK for Java) auto-generate the token for users. If you are not using the Amazon Web Services SDK or the Amazon Web Services CLI, you must provide this token or the action will fail.</p>  </important>
