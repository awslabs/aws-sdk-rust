...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_capacity_reservation::builders::GetCapacityReservationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_capacity_reservation::builders::GetCapacityReservationFluentBuilder::set_name): <p>The name of the capacity reservation.</p>
