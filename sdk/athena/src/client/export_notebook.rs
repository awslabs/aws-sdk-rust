...
impl super::Client {
    ...
    ///   - [`notebook_id(impl ::std::convert::Into<String>)`](crate::operation::export_notebook::builders::ExportNotebookFluentBuilder::notebook_id) / [`set_notebook_id(Option<String>)`](crate::operation::export_notebook::builders::ExportNotebookFluentBuilder::set_notebook_id): <p>The ID of the notebook to export.</p>
