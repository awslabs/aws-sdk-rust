...
impl super::Client {
    ...
    ///   - [`named_query_id(impl Into<String>)`](crate::operation::get_named_query::builders::GetNamedQueryFluentBuilder::named_query_id) / [`set_named_query_id(Option<String>)`](crate::operation::get_named_query::builders::GetNamedQueryFluentBuilder::set_named_query_id):<br>required: **true**<br><p>The unique ID of the query. Use <code>ListNamedQueries</code> to get query IDs.</p><br>
