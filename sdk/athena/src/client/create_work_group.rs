...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::set_name): <p>The workgroup name.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::set_description): <p>The workgroup description.</p>
