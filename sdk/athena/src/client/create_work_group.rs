...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_work_group::builders::CreateWorkGroupFluentBuilder::set_tags): <p>A list of comma separated tags to add to the workgroup that is created.</p>
