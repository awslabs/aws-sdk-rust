...
impl super::Client {
    ...
    ///   - [`capacity_reservation_name(impl ::std::convert::Into<String>)`](crate::operation::get_capacity_assignment_configuration::builders::GetCapacityAssignmentConfigurationFluentBuilder::capacity_reservation_name) / [`set_capacity_reservation_name(Option<String>)`](crate::operation::get_capacity_assignment_configuration::builders::GetCapacityAssignmentConfigurationFluentBuilder::set_capacity_reservation_name): <p>The name of the capacity reservation to retrieve the capacity assignment configuration for.</p>
