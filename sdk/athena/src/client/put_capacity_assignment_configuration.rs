...
impl super::Client {
    ...
    ///   - [`capacity_assignments(CapacityAssignment)`](crate::operation::put_capacity_assignment_configuration::builders::PutCapacityAssignmentConfigurationFluentBuilder::capacity_assignments) / [`set_capacity_assignments(Option<Vec<CapacityAssignment>>)`](crate::operation::put_capacity_assignment_configuration::builders::PutCapacityAssignmentConfigurationFluentBuilder::set_capacity_assignments): <p>The list of assignments for the capacity assignment configuration.</p>
