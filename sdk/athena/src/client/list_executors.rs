...
impl super::Client {
    ...
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::list_executors::builders::ListExecutorsFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::list_executors::builders::ListExecutorsFluentBuilder::set_session_id): <p>The session ID.</p>
    ...
    pub fn list_executors(
        &self,
    ) -> crate::operation::list_executors::builders::ListExecutorsFluentBuilder {
        crate::operation::list_executors::builders::ListExecutorsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
