...
impl super::Client {
    ...
    ///   - [`statement_name(impl Into<String>)`](crate::operation::get_prepared_statement::builders::GetPreparedStatementFluentBuilder::statement_name) / [`set_statement_name(Option<String>)`](crate::operation::get_prepared_statement::builders::GetPreparedStatementFluentBuilder::set_statement_name):<br>required: **true**<br><p>The name of the prepared statement to retrieve.</p><br>
    ///   - [`work_group(impl Into<String>)`](crate::operation::get_prepared_statement::builders::GetPreparedStatementFluentBuilder::work_group) / [`set_work_group(Option<String>)`](crate::operation::get_prepared_statement::builders::GetPreparedStatementFluentBuilder::set_work_group):<br>required: **true**<br><p>The workgroup to which the statement to be retrieved belongs.</p><br>
