...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_capacity_reservation::builders::CreateCapacityReservationFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_capacity_reservation::builders::CreateCapacityReservationFluentBuilder::set_tags): <p>The tags for the capacity reservation.</p>
