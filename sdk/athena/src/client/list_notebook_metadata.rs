...
impl super::Client {
    ...
    pub fn list_notebook_metadata(
        &self,
    ) -> crate::operation::list_notebook_metadata::builders::ListNotebookMetadataFluentBuilder {
        crate::operation::list_notebook_metadata::builders::ListNotebookMetadataFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
