...
impl super::Client {
    ...
    ///   - [`query_execution_ids(impl Into<String>)`](crate::operation::batch_get_query_execution::builders::BatchGetQueryExecutionFluentBuilder::query_execution_ids) / [`set_query_execution_ids(Option<Vec::<String>>)`](crate::operation::batch_get_query_execution::builders::BatchGetQueryExecutionFluentBuilder::set_query_execution_ids):<br>required: **true**<br><p>An array of query execution IDs.</p><br>
