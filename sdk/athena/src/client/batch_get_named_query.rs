...
impl super::Client {
    ...
    ///   - [`named_query_ids(impl Into<String>)`](crate::operation::batch_get_named_query::builders::BatchGetNamedQueryFluentBuilder::named_query_ids) / [`set_named_query_ids(Option<Vec::<String>>)`](crate::operation::batch_get_named_query::builders::BatchGetNamedQueryFluentBuilder::set_named_query_ids):<br>required: **true**<br><p>An array of query IDs.</p><br>
