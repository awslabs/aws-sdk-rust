...
impl super::Client {
    ...
    ///   - [`session_id(impl Into<String>)`](crate::operation::get_session_status::builders::GetSessionStatusFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::get_session_status::builders::GetSessionStatusFluentBuilder::set_session_id):<br>required: **true**<br><p>The session ID.</p><br>
