...
impl super::Client {
    ...
    pub fn list_table_metadata(
        &self,
    ) -> crate::operation::list_table_metadata::builders::ListTableMetadataFluentBuilder {
        crate::operation::list_table_metadata::builders::ListTableMetadataFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
