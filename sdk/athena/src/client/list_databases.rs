...
impl super::Client {
    ...
    ///   - [`catalog_name(impl ::std::convert::Into<String>)`](crate::operation::list_databases::builders::ListDatabasesFluentBuilder::catalog_name) / [`set_catalog_name(Option<String>)`](crate::operation::list_databases::builders::ListDatabasesFluentBuilder::set_catalog_name): <p>The name of the data catalog that contains the databases to return.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_databases::builders::ListDatabasesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_databases::builders::ListDatabasesFluentBuilder::set_next_token): <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the <code>NextToken</code> from the response object of the previous page call.</p>
