...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_capacity_reservations::builders::ListCapacityReservationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_capacity_reservations::builders::ListCapacityReservationsFluentBuilder::set_next_token): <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated.</p>
    ///   - [`max_results(i32)`](crate::operation::list_capacity_reservations::builders::ListCapacityReservationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_capacity_reservations::builders::ListCapacityReservationsFluentBuilder::set_max_results): <p>Specifies the maximum number of results to return.</p>
    ...
    ///   - [`capacity_reservations(Option<Vec<CapacityReservation>>)`](crate::operation::list_capacity_reservations::ListCapacityReservationsOutput::capacity_reservations): <p>The capacity reservations for the current account.</p>
    ...
    pub fn list_capacity_reservations(
        &self,
    ) -> crate::operation::list_capacity_reservations::builders::ListCapacityReservationsFluentBuilder
    {
