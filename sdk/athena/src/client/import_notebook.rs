...
impl super::Client {
    ...
    ///   - [`work_group(impl ::std::convert::Into<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::work_group) / [`set_work_group(Option<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::set_work_group): <p>The name of the Spark enabled workgroup to import the notebook to.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::set_name): <p>The name of the notebook to import.</p>
    ///   - [`payload(impl ::std::convert::Into<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::payload) / [`set_payload(Option<String>)`](crate::operation::import_notebook::builders::ImportNotebookFluentBuilder::set_payload): <p>The notebook content to be imported.</p>
