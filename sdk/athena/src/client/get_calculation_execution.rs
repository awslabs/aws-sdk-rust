...
impl super::Client {
    ...
    ///   - [`calculation_execution_id(impl ::std::convert::Into<String>)`](crate::operation::get_calculation_execution::builders::GetCalculationExecutionFluentBuilder::calculation_execution_id) / [`set_calculation_execution_id(Option<String>)`](crate::operation::get_calculation_execution::builders::GetCalculationExecutionFluentBuilder::set_calculation_execution_id): <p>The calculation execution UUID.</p>
