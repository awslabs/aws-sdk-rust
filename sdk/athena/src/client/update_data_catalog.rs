...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::set_name): <p>The name of the data catalog to update. The catalog name must be unique for the Amazon Web Services account and can use a maximum of 127 alphanumeric, underscore, at sign, or hyphen characters. The remainder of the length constraint of 256 is reserved for use by Athena.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::set_description): <p>New or modified text that describes the data catalog.</p>
