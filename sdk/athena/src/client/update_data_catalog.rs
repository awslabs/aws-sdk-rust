...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::set_name): <p>The name of the data catalog to update. The catalog name must be unique for the Amazon Web Services account and can use a maximum of 127 alphanumeric, underscore, at sign, or hyphen characters. The remainder of the length constraint of 256 is reserved for use by Athena.</p>
    ///   - [`r#type(DataCatalogType)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::type) / [`set_type(Option<DataCatalogType>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::set_type): <p>Specifies the type of data catalog to update. Specify <code>LAMBDA</code> for a federated catalog, <code>HIVE</code> for an external hive metastore, or <code>GLUE</code> for an Glue Data Catalog.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_data_catalog::builders::UpdateDataCatalogFluentBuilder::set_description): <p>New or modified text that describes the data catalog.</p>
