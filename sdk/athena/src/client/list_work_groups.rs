...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_work_groups::builders::ListWorkGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_work_groups::builders::ListWorkGroupsFluentBuilder::set_next_token): <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the <code>NextToken</code> from the response object of the previous page call.</p>
    ...
    pub fn list_work_groups(
        &self,
    ) -> crate::operation::list_work_groups::builders::ListWorkGroupsFluentBuilder {
        crate::operation::list_work_groups::builders::ListWorkGroupsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
