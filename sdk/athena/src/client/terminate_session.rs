...
impl super::Client {
    ...
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::terminate_session::builders::TerminateSessionFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::terminate_session::builders::TerminateSessionFluentBuilder::set_session_id): <p>The session ID.</p>
