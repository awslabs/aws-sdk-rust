...
impl ::std::convert::From<&str> for KeyType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_OWNED_KEY" => KeyType::AwsOwnedKey,
            "CUSTOMER_MANAGED_KEY" => KeyType::CustomerManagedKey,
...
impl KeyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            KeyType::AwsOwnedKey => "AWS_OWNED_KEY",
            KeyType::CustomerManagedKey => "CUSTOMER_MANAGED_KEY",
