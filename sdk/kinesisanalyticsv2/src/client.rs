...
mod add_application_vpc_configuration;

mod create_application;

mod create_application_presigned_url;

mod create_application_snapshot;
...
/// 
/// ```no_run
/// # async fn wrapper() -> Result<(), aws_sdk_kinesisanalyticsv2::Error> {
...
mod delete_application_snapshot;

mod delete_application_vpc_configuration;
...
mod update_application_maintenance_configuration;
