...
impl ::aws_smithy_http::response::ParseStrictResponse
    for UpdateApplicationMaintenanceConfiguration
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_application_maintenance_configuration::de_update_application_maintenance_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type UpdateApplicationMaintenanceConfigurationErrorKind =
