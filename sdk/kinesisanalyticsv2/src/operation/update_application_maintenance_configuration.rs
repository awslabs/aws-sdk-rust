    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApplicationMaintenanceConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateApplicationMaintenanceConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateApplicationMaintenanceConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateApplicationMaintenanceConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApplicationMaintenanceConfiguration")
...
.with_interceptor(UpdateApplicationMaintenanceConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationError>::new());
...
#[derive(Debug)]
            struct UpdateApplicationMaintenanceConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApplicationMaintenanceConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_application_maintenance_configuration::de_update_application_maintenance_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_application_maintenance_configuration::de_update_application_maintenance_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateApplicationMaintenanceConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApplicationMaintenanceConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_application_maintenance_configuration::ser_update_application_maintenance_configuration_input(&input)?);
...
#[derive(Debug)]
            struct UpdateApplicationMaintenanceConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApplicationMaintenanceConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateApplicationMaintenanceConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateApplicationMaintenanceConfigurationInput>()
                        .ok_or("failed to downcast to UpdateApplicationMaintenanceConfigurationInput")?;
...
/// Error type for the `UpdateApplicationMaintenanceConfigurationError` operation.
#[non_exhaustive]
...
pub enum UpdateApplicationMaintenanceConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateApplicationMaintenanceConfigurationError) for what information is available for the error.")]
...
impl UpdateApplicationMaintenanceConfigurationError {
    /// Creates the `UpdateApplicationMaintenanceConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateApplicationMaintenanceConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateApplicationMaintenanceConfigurationError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UpdateApplicationMaintenanceConfigurationError::InvalidArgumentException`.
    pub fn is_invalid_argument_exception(&self) -> bool {
        matches!(self, Self::InvalidArgumentException(_))
    }
    /// Returns `true` if the error kind is `UpdateApplicationMaintenanceConfigurationError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `UpdateApplicationMaintenanceConfigurationError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateApplicationMaintenanceConfigurationError::UnsupportedOperationException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApplicationMaintenanceConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateApplicationMaintenanceConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_application_maintenance_configuration::UpdateApplicationMaintenanceConfigurationError {
...
mod _update_application_maintenance_configuration_output;
