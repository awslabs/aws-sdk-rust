    ...
    for DeleteApplicationInputProcessingConfiguration
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application_input_processing_configuration::de_delete_application_input_processing_configuration_http_response_with_props(status, headers, body)
        }
    }
}
