...
impl DeleteApplicationInputProcessingConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteApplicationInputProcessingConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteApplicationInputProcessingConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteApplicationInputProcessingConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteApplicationInputProcessingConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteApplicationInputProcessingConfiguration")
...
.with_interceptor(DeleteApplicationInputProcessingConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError>::new());
...
#[derive(Debug)]
            struct DeleteApplicationInputProcessingConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteApplicationInputProcessingConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_application_input_processing_configuration::de_delete_application_input_processing_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_application_input_processing_configuration::de_delete_application_input_processing_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteApplicationInputProcessingConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteApplicationInputProcessingConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_application_input_processing_configuration::ser_delete_application_input_processing_configuration_input(&input)?);
...
#[derive(Debug)]
            struct DeleteApplicationInputProcessingConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteApplicationInputProcessingConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteApplicationInputProcessingConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteApplicationInputProcessingConfigurationInput>()
                        .ok_or("failed to downcast to DeleteApplicationInputProcessingConfigurationInput")?;
...
pub enum DeleteApplicationInputProcessingConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteApplicationInputProcessingConfigurationError) for what information is available for the error.")]
...
impl DeleteApplicationInputProcessingConfigurationError {
    /// Creates the `DeleteApplicationInputProcessingConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteApplicationInputProcessingConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteApplicationInputProcessingConfigurationError::InvalidRequestException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteApplicationInputProcessingConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_application_input_processing_configuration::DeleteApplicationInputProcessingConfigurationError {
...
mod _delete_application_input_processing_configuration_output;
