...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationOutput,
                    crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationError,
                > for DeleteApplicationVpcConfigurationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteApplicationVpcConfigurationFluentBuilder {
    ...
    /// Access the DeleteApplicationVpcConfiguration as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_application_vpc_configuration::builders::DeleteApplicationVpcConfigurationInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfiguration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfiguration::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationOutput, crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfigurationError, Self> {
