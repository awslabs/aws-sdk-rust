...
impl DeleteApplicationCloudWatchLoggingOptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_application_cloud_watch_logging_option::DeleteApplicationCloudWatchLoggingOption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplicationCloudWatchLoggingOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application_cloud_watch_logging_option::de_delete_application_cloud_watch_logging_option_http_response_with_props(status, headers, body)
        }
    }
}
