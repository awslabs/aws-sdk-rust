...
impl DiscoverInputSchemaInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_discover_input_schema::ser_discover_input_schema_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::discover_input_schema::DiscoverInputSchema::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::discover_input_schema::DiscoverInputSchemaError
{
...
impl DiscoverInputSchemaError {
    ...
    pub fn is_resource_provisioned_throughput_exceeded_exception(&self) -> bool {
        matches!(
            self,
            Self::ResourceProvisionedThroughputExceededException(_)
        )
    }
