    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_application_snapshot::DeleteApplicationSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_application_snapshot::DeleteApplicationSnapshotOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteApplicationSnapshotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteApplicationSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_application_snapshot::DeleteApplicationSnapshotInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteApplicationSnapshotEndpointParamsInterceptor {
...
pub type DeleteApplicationSnapshotErrorKind = DeleteApplicationSnapshotError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_application_snapshot::DeleteApplicationSnapshotError {
...
impl DeleteApplicationSnapshotError {
    ...
    /// Creates the `DeleteApplicationSnapshotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
