...
impl DeleteApplicationSnapshotInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_application_snapshot::DeleteApplicationSnapshot::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplicationSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application_snapshot::de_delete_application_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
