...
impl StopApplicationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_application::StopApplication::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StopApplication {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_application::de_stop_application_http_error(
                status, headers, body,
            )
        } else {
...
impl std::error::Error for StopApplicationError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidApplicationConfigurationException(_inner) => Some(_inner),
