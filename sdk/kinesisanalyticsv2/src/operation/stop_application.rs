...
impl StopApplicationInput {
    /// Consumes the builder and constructs an Operation<[`StopApplication`](crate::operation::stop_application::StopApplication)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_application::StopApplication, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_application::ser_stop_application_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_application::StopApplication::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopApplication", "kinesisanalyticsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopApplication {
    type Output =
        ::std::result::Result<crate::operation::stop_application::StopApplicationOutput, crate::operation::stop_application::StopApplicationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_application::de_stop_application_http_response_with_props(status, headers, body)
        }
    }
}
