...
impl CreateApplicationPresignedUrlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_application_presigned_url::CreateApplicationPresignedUrl::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApplicationPresignedUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_application_presigned_url::de_create_application_presigned_url_http_response_with_props(
                status, headers, body,
            )
        }
    }
