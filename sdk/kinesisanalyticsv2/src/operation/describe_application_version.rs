    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_version::DescribeApplicationVersionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_version::DescribeApplicationVersionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeApplicationVersion {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeApplicationVersion")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeApplicationVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeApplicationVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_version::DescribeApplicationVersionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeApplicationVersionEndpointParamsInterceptor {
...
pub type DescribeApplicationVersionErrorKind = DescribeApplicationVersionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_application_version::DescribeApplicationVersionError {
...
impl DescribeApplicationVersionError {
    ...
    /// Creates the `DescribeApplicationVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
