...
impl CreateApplication {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_application::CreateApplicationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_application::CreateApplicationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Kinesis Analytics V2.CreateApplication",
            "rpc.service" = "Kinesis Analytics V2",
            "rpc.method" = "CreateApplication",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateApplication {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateApplicationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateApplicationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateApplication")
                .build()
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateApplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ApplicationDescription") {
            if let ::std::option::Option::Some(value) = input.application_description.as_deref() {
                captured.insert("ApplicationDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateApplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_application::de_create_application_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_application::de_create_application_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateApplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_application::CreateApplicationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_application::CreateApplicationInput,
