    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_snapshot::DescribeApplicationSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_snapshot::DescribeApplicationSnapshotOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeApplicationSnapshot {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeApplicationSnapshot")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeApplicationSnapshotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeApplicationSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_application_snapshot::DescribeApplicationSnapshotInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeApplicationSnapshotEndpointParamsInterceptor {
...
pub type DescribeApplicationSnapshotErrorKind = DescribeApplicationSnapshotError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_application_snapshot::DescribeApplicationSnapshotError {
...
impl DescribeApplicationSnapshotError {
    ...
    /// Creates the `DescribeApplicationSnapshotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
