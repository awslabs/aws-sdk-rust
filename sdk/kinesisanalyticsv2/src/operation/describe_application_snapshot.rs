...
impl DescribeApplicationSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_application_snapshot::DescribeApplicationSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplicationSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_application_snapshot::de_describe_application_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
