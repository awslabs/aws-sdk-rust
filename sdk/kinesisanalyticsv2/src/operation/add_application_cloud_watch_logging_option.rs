...
impl AddApplicationCloudWatchLoggingOption {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionInput,
                    ) -> ::std::result::Result<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddApplicationCloudWatchLoggingOption {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddApplicationCloudWatchLoggingOption");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddApplicationCloudWatchLoggingOptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddApplicationCloudWatchLoggingOptionResponseDeserializer));
...
.with_interceptor(AddApplicationCloudWatchLoggingOptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError>::new());
...
#[derive(Debug)]
            struct AddApplicationCloudWatchLoggingOptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddApplicationCloudWatchLoggingOptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_application_cloud_watch_logging_option::de_add_application_cloud_watch_logging_option_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AddApplicationCloudWatchLoggingOptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddApplicationCloudWatchLoggingOptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_application_cloud_watch_logging_option::ser_add_application_cloud_watch_logging_option_input(&input)?);
...
#[derive(Debug)]
            struct AddApplicationCloudWatchLoggingOptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddApplicationCloudWatchLoggingOptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddApplicationCloudWatchLoggingOptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddApplicationCloudWatchLoggingOptionInput>()
                        .ok_or("failed to downcast to AddApplicationCloudWatchLoggingOptionInput")?;
...
pub enum AddApplicationCloudWatchLoggingOptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddApplicationCloudWatchLoggingOptionError) for what information is available for the error.")]
...
impl AddApplicationCloudWatchLoggingOptionError {
    /// Creates the `AddApplicationCloudWatchLoggingOptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddApplicationCloudWatchLoggingOptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `AddApplicationCloudWatchLoggingOptionError::InvalidApplicationConfigurationException`.
    ...
    /// Returns `true` if the error kind is `AddApplicationCloudWatchLoggingOptionError::InvalidRequestException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddApplicationCloudWatchLoggingOptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_application_cloud_watch_logging_option::AddApplicationCloudWatchLoggingOptionError {
...
mod _add_application_cloud_watch_logging_option_output;
