...
impl DeleteApplicationVpcConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_application_vpc_configuration::DeleteApplicationVpcConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplicationVpcConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application_vpc_configuration::de_delete_application_vpc_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
