...
impl ListApplicationSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_snapshots::ListApplicationSnapshotsInput, ::aws_smithy_types::error::operation::BuildError> {
