...
impl AddApplicationVpcConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_application_vpc_configuration::AddApplicationVpcConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddApplicationVpcConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_application_vpc_configuration::de_add_application_vpc_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
