...
impl AddApplicationVpcConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddApplicationVpcConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddApplicationVpcConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddApplicationVpcConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddApplicationVpcConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddApplicationVpcConfiguration")
...
.with_interceptor(AddApplicationVpcConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError>::new());
...
#[derive(Debug)]
            struct AddApplicationVpcConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddApplicationVpcConfigurationResponseDeserializer {
...
#[derive(Debug)]
            struct AddApplicationVpcConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddApplicationVpcConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_application_vpc_configuration::ser_add_application_vpc_configuration_input(&input)?);
...
#[derive(Debug)]
            struct AddApplicationVpcConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddApplicationVpcConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddApplicationVpcConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddApplicationVpcConfigurationInput>()
                        .ok_or("failed to downcast to AddApplicationVpcConfigurationInput")?;
...
pub enum AddApplicationVpcConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddApplicationVpcConfigurationError) for what information is available for the error.")]
...
impl AddApplicationVpcConfigurationError {
    /// Creates the `AddApplicationVpcConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddApplicationVpcConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddApplicationVpcConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_application_vpc_configuration::AddApplicationVpcConfigurationError {
