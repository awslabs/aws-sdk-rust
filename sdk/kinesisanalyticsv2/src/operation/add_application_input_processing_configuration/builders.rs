...
impl crate::operation::add_application_input_processing_configuration::builders::AddApplicationInputProcessingConfigurationInputBuilder {
...
impl AddApplicationInputProcessingConfigurationFluentBuilder {
    /// Creates a new `AddApplicationInputProcessingConfigurationFluentBuilder`.
    ...
    > {
        ...
        crate::operation::add_application_input_processing_configuration::AddApplicationInputProcessingConfiguration::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
