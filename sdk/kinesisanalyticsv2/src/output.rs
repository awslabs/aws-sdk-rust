...
pub struct ListApplicationVersionsOutput  {
    ...
    #[doc(hidden)]pub application_version_summaries: std::option::Option<std::vec::Vec<crate::model::ApplicationVersionSummary>>,
...
impl  std::fmt::Debug for ListApplicationVersionsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_version_summaries", &self.application_version_summaries);
...
pub struct ListApplicationSnapshotsOutput  {
    ...
    #[doc(hidden)]pub snapshot_summaries: std::option::Option<std::vec::Vec<crate::model::SnapshotDetails>>,
...
pub struct DescribeApplicationVersionOutput  {
    /// <p>Describes the application, including the application Amazon Resource Name (ARN), status, latest version, and input and output configurations.</p>
    #[doc(hidden)]pub application_version_detail: std::option::Option<crate::model::ApplicationDetail>,
}
...
impl  std::fmt::Debug for DescribeApplicationVersionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_version_detail", &self.application_version_detail);
        formatter.finish()
    }
}
...
pub struct DescribeApplicationSnapshotOutput  {
    ...
    #[doc(hidden)]pub snapshot_details: std::option::Option<crate::model::SnapshotDetails>,
}
...
pub struct CreateApplicationPresignedUrlOutput  {
    ...
    #[doc(hidden)]pub authorized_url: std::option::Option<std::string::String>,
}
