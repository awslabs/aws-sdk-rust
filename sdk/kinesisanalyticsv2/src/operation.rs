...
impl smithy_http::response::ParseStrictResponse for AddApplicationVpcConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_add_application_vpc_configuration_error(response)
        } else {
            crate::operation_ser::parse_add_application_vpc_configuration_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for CreateApplicationPresignedUrl {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_create_application_presigned_url_error(response)
        } else {
            crate::operation_ser::parse_create_application_presigned_url_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for CreateApplicationSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_create_application_snapshot_error(response)
        } else {
            crate::operation_ser::parse_create_application_snapshot_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DeleteApplicationSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_delete_application_snapshot_error(response)
        } else {
            crate::operation_ser::parse_delete_application_snapshot_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DeleteApplicationVpcConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_delete_application_vpc_configuration_error(response)
        } else {
            crate::operation_ser::parse_delete_application_vpc_configuration_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DescribeApplicationSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_application_snapshot_error(response)
        } else {
            crate::operation_ser::parse_describe_application_snapshot_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DescribeApplicationVersion {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_application_version_error(response)
        } else {
            crate::operation_ser::parse_describe_application_version_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for ListApplicationSnapshots {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_list_application_snapshots_error(response)
        } else {
            crate::operation_ser::parse_list_application_snapshots_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RollbackApplication {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_rollback_application_error(response)
        } else {
            crate::operation_ser::parse_rollback_application_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateApplicationMaintenanceConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_update_application_maintenance_configuration_error(response)
        } else {
            crate::operation_ser::parse_update_application_maintenance_configuration_response(
                response,
            )
        }
    }
