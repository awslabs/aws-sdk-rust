...
pub fn ser_input_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
