            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_request_exception::de_invalid_request_exception_json_err(response.body().as_ref(), output).map_err(crate::error::AddApplicationReferenceDataSourceError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_add_application_reference_data_source_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AddApplicationReferenceDataSourceOutput, crate::error::AddApplicationReferenceDataSourceError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_add_application_reference_data_source::de_add_application_reference_data_source(response.body().as_ref(), output).map_err(crate::error::AddApplicationReferenceDataSourceError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_add_application_reference_data_source(value: &[u8], mut builder: crate::output::add_application_reference_data_source_output::Builder) -> Result<crate::output::add_application_reference_data_source_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
