...
pub fn ser_code_content(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CodeContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
