...
pub fn ser_input_schema_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputSchemaUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
