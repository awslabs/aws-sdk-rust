...
pub fn ser_reference_data_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceDataSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
