...
pub(crate) fn de_vpc_configuration_descriptions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::VpcConfigurationDescription>>, aws_smithy_json::deserialize::error::DeserializeError>
