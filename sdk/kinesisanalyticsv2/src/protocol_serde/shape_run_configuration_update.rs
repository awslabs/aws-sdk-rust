...
pub fn ser_run_configuration_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RunConfigurationUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
