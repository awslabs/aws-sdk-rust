...
pub(crate) fn de_mapping_parameters<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::MappingParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CSVMappingParameters" => {
                            builder = builder
                                .set_csv_mapping_parameters(crate::protocol_serde::shape_csv_mapping_parameters::de_csv_mapping_parameters(tokens)?);
                        }
...
pub fn ser_mapping_parameters(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::MappingParameters,
