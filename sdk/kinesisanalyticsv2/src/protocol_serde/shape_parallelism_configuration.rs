...
pub fn ser_parallelism_configuration(
    ...
    if let Some(var_1) = &input.parallelism {
        object.key("Parallelism").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    if let Some(var_2) = &input.parallelism_per_kpu {
        object.key("ParallelismPerKPU").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
