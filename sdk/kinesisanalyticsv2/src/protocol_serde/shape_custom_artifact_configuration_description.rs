                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "S3ContentLocationDescription" => {
                            builder = builder.set_s3_content_location_description(
                                crate::protocol_serde::shape_s3_content_location::de_s3_content_location(tokens, _value, depth + 1)?,
                            );
                        }
                        "MavenReferenceDescription" => {
                            builder = builder.set_maven_reference_description(crate::protocol_serde::shape_maven_reference::de_maven_reference(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
