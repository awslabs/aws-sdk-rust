            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "RecordFormat" => {
                            builder =
                                builder.set_record_format(crate::protocol_serde::shape_record_format::de_record_format(tokens, _value, depth + 1)?);
                        }
                        "RecordEncoding" => {
                        ...
                        "RecordColumns" => {
                            builder = builder.set_record_columns(crate::protocol_serde::shape_record_columns::de_record_columns(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
