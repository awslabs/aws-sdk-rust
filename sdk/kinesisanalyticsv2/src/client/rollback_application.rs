...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::rollback_application::builders::RollbackApplicationFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::rollback_application::builders::RollbackApplicationFluentBuilder::set_application_name):<br>required: **true**<br><p>The name of the application.</p><br>
    ...
    ///   - [`operation_id(Option<String>)`](crate::operation::rollback_application::RollbackApplicationOutput::operation_id): <p>The operation ID that can be used to track the request.</p>
