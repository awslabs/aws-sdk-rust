...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::rollback_application::builders::RollbackApplicationFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::rollback_application::builders::RollbackApplicationFluentBuilder::set_application_name): <p>The name of the application.</p>
