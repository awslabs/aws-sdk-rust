...
impl super::Client {
    ...
    ///   - [`operation_id(Option<String>)`](crate::operation::stop_application::StopApplicationOutput::operation_id): <p>The operation ID that can be used to track the request.</p>
