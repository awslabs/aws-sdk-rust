...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::set_application_name): <p>The name of the application for which you want to list all versions.</p>
