...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::set_application_name): <p>The name of the application for which you want to list all versions.</p>
    ///   - [`limit(i32)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::set_limit): <p>The maximum number of versions to list in this invocation of the operation.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_application_versions::builders::ListApplicationVersionsFluentBuilder::set_next_token): <p>If a previous invocation of this operation returned a pagination token, pass it into this value to retrieve the next set of results. For more information about pagination, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/pagination.html">Using the Amazon Command Line Interface's Pagination Options</a>.</p>
