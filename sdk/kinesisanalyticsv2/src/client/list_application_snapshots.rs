...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::list_application_snapshots::builders::ListApplicationSnapshotsFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::list_application_snapshots::builders::ListApplicationSnapshotsFluentBuilder::set_application_name): <p>The name of an existing application.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_application_snapshots::builders::ListApplicationSnapshotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_application_snapshots::builders::ListApplicationSnapshotsFluentBuilder::set_next_token): <p>Use this parameter if you receive a <code>NextToken</code> response in a previous request that indicates that there is more output available. Set it to the value of the previous call's <code>NextToken</code> response to indicate where the output should continue from. </p>
