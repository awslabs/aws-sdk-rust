...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::delete_application_snapshot::builders::DeleteApplicationSnapshotFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::delete_application_snapshot::builders::DeleteApplicationSnapshotFluentBuilder::set_application_name): <p>The name of an existing application.</p>
    ///   - [`snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_application_snapshot::builders::DeleteApplicationSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::delete_application_snapshot::builders::DeleteApplicationSnapshotFluentBuilder::set_snapshot_name): <p>The identifier for the snapshot delete.</p>
