...
impl ::std::convert::From<&str> for SourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                SourceStatus::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for SourceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SourceStatus::from(s))
    }
}
impl SourceStatus {
...
impl ::std::convert::AsRef<str> for SourceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
