...
impl ::std::convert::From<&str> for HttpsMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PUT" => HttpsMethod::Put,
            other => HttpsMethod::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HttpsMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HttpsMethod::from(s))
    }
}
impl HttpsMethod {
...
impl ::std::convert::AsRef<str> for HttpsMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
