...
impl super::Client {
    ...
    ///   - [`source_version(impl Into<String>)`](crate::operation::delete_custom_log_source::builders::DeleteCustomLogSourceFluentBuilder::source_version) / [`set_source_version(Option<String>)`](crate::operation::delete_custom_log_source::builders::DeleteCustomLogSourceFluentBuilder::set_source_version): <p>The source version for the third-party custom source. You can limit the custom source removal to the specified source version.</p>
