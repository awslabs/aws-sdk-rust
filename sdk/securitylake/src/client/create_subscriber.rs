...
impl super::Client {
    ...
    ///   - [`external_id(impl ::std::convert::Into<String>)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::external_id) / [`set_external_id(Option<String>)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::set_external_id): <p>The external ID of the subscriber. This lets the user that is assuming the role assert the circumstances in which they are operating. It also provides a way for the account owner to permit the role to be assumed only under specific circumstances.</p>
    ...
    ///   - [`resource_share_arn(Option<String>)`](crate::operation::create_subscriber::CreateSubscriberOutput::resource_share_arn): <p>The Amazon Resource Name (ARN) which uniquely defines the AWS RAM resource share. Before accepting the RAM resource share invitation, you can view details related to the RAM resource share.</p>
    ///   - [`resource_share_name(Option<String>)`](crate::operation::create_subscriber::CreateSubscriberOutput::resource_share_name): <p>The name of the resource share.</p>
