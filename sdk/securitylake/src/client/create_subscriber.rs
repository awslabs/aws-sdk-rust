...
impl super::Client {
    ...
    ///   - [`sources(LogSourceResource)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::sources) / [`set_sources(Option<Vec<LogSourceResource>>)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::set_sources): <p>The supported Amazon Web Services from which logs and events are collected. Security Lake supports log and event collection for natively supported Amazon Web Services.</p>
    ///   - [`access_types(AccessType)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::access_types) / [`set_access_types(Option<Vec<AccessType>>)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::set_access_types): <p>The Amazon S3 or Lake Formation access type.</p>
    ///   - [`tags(Tag)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_subscriber::builders::CreateSubscriberFluentBuilder::set_tags): <p>An array of objects, one for each tag to associate with the subscriber. For each tag, you must specify both a tag key and a tag value. A tag value cannot be null, but it can be an empty string.</p>
