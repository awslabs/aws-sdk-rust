...
impl super::Client {
    ...
    ///   - [`configurations(Vec<DataLakeConfiguration>)`](crate::operation::update_data_lake::builders::UpdateDataLakeFluentBuilder::configurations) / [`set_configurations(Option<Vec<DataLakeConfiguration>>)`](crate::operation::update_data_lake::builders::UpdateDataLakeFluentBuilder::set_configurations): <p>Specify the Region or Regions that will contribute data to the rollup region.</p>
    ...
    pub fn update_data_lake(
        &self,
    ) -> crate::operation::update_data_lake::builders::UpdateDataLakeFluentBuilder {
        crate::operation::update_data_lake::builders::UpdateDataLakeFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
