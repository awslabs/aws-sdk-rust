...
impl super::Client {
    ...
    ///   - [`exceptions(Option<Vec::<DataLakeException>>)`](crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsOutput::exceptions): <p>Lists the failures that cannot be retried.</p>
