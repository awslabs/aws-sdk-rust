...
impl super::Client {
    ...
    ///   - [`accounts(impl Into<String>)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::accounts) / [`set_accounts(Option<Vec<String>>)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::set_accounts): <p>The list of Amazon Web Services accounts for which log sources are displayed.</p>
    ///   - [`regions(impl Into<String>)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::regions) / [`set_regions(Option<Vec<String>>)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::set_regions): <p>The list of regions for which log sources are displayed.</p>
    ///   - [`sources(LogSourceResource)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::sources) / [`set_sources(Option<Vec<LogSourceResource>>)`](crate::operation::list_log_sources::builders::ListLogSourcesFluentBuilder::set_sources): <p>The list of sources for which log sources are displayed.</p>
