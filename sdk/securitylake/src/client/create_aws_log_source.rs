...
impl super::Client {
    ...
    ///   - [`failed(Option<Vec::<String>>)`](crate::operation::create_aws_log_source::CreateAwsLogSourceOutput::failed): <p>Lists all accounts in which enabling a natively supported Amazon Web Services service as a Security Lake source failed. The failure occurred as these accounts are not part of an organization.</p>
