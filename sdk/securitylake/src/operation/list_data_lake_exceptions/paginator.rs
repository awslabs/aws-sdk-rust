...
impl ListDataLakeExceptionsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_data_lake_exceptions::paginator::ListDataLakeExceptionsPaginatorItems
    {
        crate::operation::list_data_lake_exceptions::paginator::ListDataLakeExceptionsPaginatorItems(
            self,
        )
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_data_lake_exceptions_output_next_token(
                                    resp,
                                );
