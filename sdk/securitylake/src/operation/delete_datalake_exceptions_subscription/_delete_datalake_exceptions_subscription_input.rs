...
impl DeleteDatalakeExceptionsSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionInput, ::aws_smithy_http::operation::error::BuildError>{
