...
impl CreateDataLakeInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::create_data_lake::CreateDataLakeError, ::aws_smithy_http::operation::Response>,
    > {
...
impl CreateDataLakeFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::create_data_lake::CreateDataLakeError>,
    > {
