...
/// Orchestration and serialization glue logic for `ListDataLakeExceptions`.
...
impl ListDataLakeExceptions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDataLakeExceptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDataLakeExceptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDataLakeExceptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDataLakeExceptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDataLakeExceptions")
...
.with_interceptor(ListDataLakeExceptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError>::new());
...
#[derive(Debug)]
            struct ListDataLakeExceptionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDataLakeExceptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_data_lake_exceptions::de_list_data_lake_exceptions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_data_lake_exceptions::de_list_data_lake_exceptions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDataLakeExceptionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDataLakeExceptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/datalake/exceptions").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_data_lake_exceptions::ser_list_data_lake_exceptions_input(&input)?);
...
#[derive(Debug)]
            struct ListDataLakeExceptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDataLakeExceptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDataLakeExceptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDataLakeExceptionsInput>()
                        .ok_or("failed to downcast to ListDataLakeExceptionsInput")?;
...
pub enum ListDataLakeExceptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDataLakeExceptionsError) for what information is available for the error.")]
...
impl ListDataLakeExceptionsError {
    /// Creates the `ListDataLakeExceptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDataLakeExceptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListDataLakeExceptionsError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `ListDataLakeExceptionsError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `ListDataLakeExceptionsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListDataLakeExceptionsError::ThrottlingException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDataLakeExceptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_data_lake_exceptions::ListDataLakeExceptionsError {
...
mod _list_data_lake_exceptions_output;
