...
impl ListDataLakeExceptionsInput {
    /// Consumes the builder and constructs an Operation<[`ListDataLakeExceptions`](crate::operation::list_data_lake_exceptions::ListDataLakeExceptions)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_data_lake_exceptions::ser_list_data_lake_exceptions_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_data_lake_exceptions::ListDataLakeExceptions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDataLakeExceptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_data_lake_exceptions::de_list_data_lake_exceptions_http_response_with_props(status, headers, body)
        }
    }
}
