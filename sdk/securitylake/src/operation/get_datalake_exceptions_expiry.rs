...
impl GetDatalakeExceptionsExpiryInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiry::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatalakeExceptionsExpiry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_datalake_exceptions_expiry::de_get_datalake_exceptions_expiry_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetDatalakeExceptionsExpiryError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryError
{
