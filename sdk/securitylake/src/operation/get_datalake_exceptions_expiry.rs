...
impl GetDatalakeExceptionsExpiryInput {
    /// Consumes the builder and constructs an Operation<[`GetDatalakeExceptionsExpiry`](crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiry)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiry, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiry::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDatalakeExceptionsExpiry {
                type Output = std::result::Result<crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryOutput, crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_datalake_exceptions_expiry::de_get_datalake_exceptions_expiry_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_datalake_exceptions_expiry::de_get_datalake_exceptions_expiry_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryError {
...
pub use crate::operation::get_datalake_exceptions_expiry::_get_datalake_exceptions_expiry_output::GetDatalakeExceptionsExpiryOutput;

pub use crate::operation::get_datalake_exceptions_expiry::_get_datalake_exceptions_expiry_input::GetDatalakeExceptionsExpiryInput;

mod _get_datalake_exceptions_expiry_input;

mod _get_datalake_exceptions_expiry_output;
