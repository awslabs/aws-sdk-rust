...
impl CreateDatalakeExceptionsSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatalakeExceptionsSubscription`](crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDatalakeExceptionsSubscription {
                type Output = std::result::Result<crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionOutput, crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_datalake_exceptions_subscription::de_create_datalake_exceptions_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_datalake_exceptions_subscription::de_create_datalake_exceptions_subscription_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionError {
...
pub use crate::operation::create_datalake_exceptions_subscription::_create_datalake_exceptions_subscription_output::CreateDatalakeExceptionsSubscriptionOutput;

pub use crate::operation::create_datalake_exceptions_subscription::_create_datalake_exceptions_subscription_input::CreateDatalakeExceptionsSubscriptionInput;

mod _create_datalake_exceptions_subscription_input;

mod _create_datalake_exceptions_subscription_output;
