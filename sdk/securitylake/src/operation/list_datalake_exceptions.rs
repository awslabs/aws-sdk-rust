...
impl ListDatalakeExceptionsInput {
    /// Consumes the builder and constructs an Operation<[`ListDatalakeExceptions`](crate::operation::list_datalake_exceptions::ListDatalakeExceptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_datalake_exceptions::ListDatalakeExceptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_datalake_exceptions::ListDatalakeExceptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_datalake_exceptions::ListDatalakeExceptions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListDatalakeExceptions {
                type Output = std::result::Result<crate::operation::list_datalake_exceptions::ListDatalakeExceptionsOutput, crate::operation::list_datalake_exceptions::ListDatalakeExceptionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_datalake_exceptions::de_list_datalake_exceptions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_datalake_exceptions::de_list_datalake_exceptions_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::list_datalake_exceptions::ListDatalakeExceptionsError {
...
pub use crate::operation::list_datalake_exceptions::_list_datalake_exceptions_output::ListDatalakeExceptionsOutput;

pub use crate::operation::list_datalake_exceptions::_list_datalake_exceptions_input::ListDatalakeExceptionsInput;

mod _list_datalake_exceptions_input;

mod _list_datalake_exceptions_output;
