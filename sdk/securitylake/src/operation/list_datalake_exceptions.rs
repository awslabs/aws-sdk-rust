...
impl ListDatalakeExceptionsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_datalake_exceptions::ListDatalakeExceptions,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::list_datalake_exceptions::ListDatalakeExceptionsInput,
                output: &mut String,
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_datalake_exceptions::ListDatalakeExceptions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDatalakeExceptions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_datalake_exceptions::de_list_datalake_exceptions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::list_datalake_exceptions::ListDatalakeExceptionsError
{
