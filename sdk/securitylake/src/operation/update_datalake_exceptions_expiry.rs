...
impl UpdateDatalakeExceptionsExpiryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiry,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/datalake/exceptions/expiry")
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDatalakeExceptionsExpiry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_datalake_exceptions_expiry::de_update_datalake_exceptions_expiry_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryError
{
