...
impl UpdateDatalakeExceptionsExpiryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDatalakeExceptionsExpiry`](crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiry)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiry, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiry::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDatalakeExceptionsExpiry {
                type Output = std::result::Result<crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryOutput, crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_datalake_exceptions_expiry::de_update_datalake_exceptions_expiry_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_datalake_exceptions_expiry::de_update_datalake_exceptions_expiry_http_response(status, headers, body)
                     }
                }
...
impl aws_http::request_id::RequestId for crate::operation::update_datalake_exceptions_expiry::UpdateDatalakeExceptionsExpiryError {
...
pub use crate::operation::update_datalake_exceptions_expiry::_update_datalake_exceptions_expiry_output::UpdateDatalakeExceptionsExpiryOutput;

pub use crate::operation::update_datalake_exceptions_expiry::_update_datalake_exceptions_expiry_input::UpdateDatalakeExceptionsExpiryInput;

mod _update_datalake_exceptions_expiry_input;

mod _update_datalake_exceptions_expiry_output;
