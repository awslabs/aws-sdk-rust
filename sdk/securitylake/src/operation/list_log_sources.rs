    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/logsources/list").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_log_sources::ListLogSources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLogSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_log_sources::de_list_log_sources_http_error(
                status, headers, body,
            )
        } else {
