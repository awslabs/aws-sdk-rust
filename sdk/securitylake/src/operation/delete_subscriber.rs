...
impl DeleteSubscriberInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSubscriber`](crate::operation::delete_subscriber::DeleteSubscriber)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_subscriber::DeleteSubscriber, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_subscriber::DeleteSubscriber::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSubscriber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_subscriber::de_delete_subscriber_http_response_with_props(status, headers, body)
        }
    }
}
