    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let subscriber_id = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_subscriber::DeleteSubscriber::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_subscriber::DeleteSubscriberError
{
