...
impl DeleteSubscriberInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_subscriber::DeleteSubscriber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_subscriber::DeleteSubscriberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/subscribers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_subscriber::DeleteSubscriberInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSubscriber {
                type Output = std::result::Result<crate::operation::delete_subscriber::DeleteSubscriberOutput, crate::operation::delete_subscriber::DeleteSubscriberError>;
