...
/// A builder for [`CreateDatalakeAutoEnableOutput`](crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableOutput).
#[non_exhaustive]
#[derive(std::clone::Clone, std::cmp::PartialEq, std::default::Default, std::fmt::Debug)]
pub struct CreateDatalakeAutoEnableOutputBuilder {
    _request_id: Option<String>,
}
