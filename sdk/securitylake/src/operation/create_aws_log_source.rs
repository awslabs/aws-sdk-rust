...
impl CreateAwsLogSourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_aws_log_source::CreateAwsLogSource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_aws_log_source::CreateAwsLogSourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_aws_log_source::ser_create_aws_log_source_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_aws_log_source::CreateAwsLogSource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAwsLogSource {
                type Output = std::result::Result<crate::operation::create_aws_log_source::CreateAwsLogSourceOutput, crate::operation::create_aws_log_source::CreateAwsLogSourceError>;
