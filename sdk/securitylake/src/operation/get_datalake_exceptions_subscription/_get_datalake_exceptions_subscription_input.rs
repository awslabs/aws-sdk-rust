...
impl GetDatalakeExceptionsSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionInput, ::aws_smithy_http::operation::error::BuildError>{
