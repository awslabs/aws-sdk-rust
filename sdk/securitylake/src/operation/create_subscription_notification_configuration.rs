...
impl CreateSubscriptionNotificationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`CreateSubscriptionNotificationConfiguration`](crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfiguration::new())
...
{
    type Output = ::std::result::Result<crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationOutput, crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_subscription_notification_configuration::de_create_subscription_notification_configuration_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_subscription_notification_configuration::de_create_subscription_notification_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationError {
...
pub use crate::operation::create_subscription_notification_configuration::_create_subscription_notification_configuration_output::CreateSubscriptionNotificationConfigurationOutput;

pub use crate::operation::create_subscription_notification_configuration::_create_subscription_notification_configuration_input::CreateSubscriptionNotificationConfigurationInput;

mod _create_subscription_notification_configuration_input;

mod _create_subscription_notification_configuration_output;
