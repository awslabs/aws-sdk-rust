...
impl DeleteDatalakeExceptionsSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDatalakeExceptionsSubscription`](crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeExceptionsSubscription {
                type Output = std::result::Result<crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionOutput, crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_datalake_exceptions_subscription::de_delete_datalake_exceptions_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_datalake_exceptions_subscription::de_delete_datalake_exceptions_subscription_http_response(status, headers, body)
                     }
                }
...
impl aws_http::request_id::RequestId for crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionError {
...
pub use crate::operation::delete_datalake_exceptions_subscription::_delete_datalake_exceptions_subscription_output::DeleteDatalakeExceptionsSubscriptionOutput;

pub use crate::operation::delete_datalake_exceptions_subscription::_delete_datalake_exceptions_subscription_input::DeleteDatalakeExceptionsSubscriptionInput;

mod _delete_datalake_exceptions_subscription_input;

mod _delete_datalake_exceptions_subscription_output;
