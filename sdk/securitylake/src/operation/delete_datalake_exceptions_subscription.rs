...
impl DeleteDatalakeExceptionsSubscriptionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::delete_datalake_exceptions_subscription::DeleteDatalakeExceptionsSubscriptionInput,
                output: &mut String,
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeExceptionsSubscription {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_datalake_exceptions_subscription::de_delete_datalake_exceptions_subscription_http_response_with_props(status, headers, body)
        }
    }
}
