...
impl CreateDatalakeDelegatedAdminInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdmin,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdminInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdmin::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatalakeDelegatedAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_datalake_delegated_admin::de_create_datalake_delegated_admin_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateDatalakeDelegatedAdminError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdminError
{
