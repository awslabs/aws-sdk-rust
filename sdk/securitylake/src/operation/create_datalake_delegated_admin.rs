...
impl CreateDatalakeDelegatedAdminInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdmin, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_datalake_delegated_admin::CreateDatalakeDelegatedAdminInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDatalakeDelegatedAdmin {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_datalake_delegated_admin::de_create_datalake_delegated_admin_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_datalake_delegated_admin::de_create_datalake_delegated_admin_http_response(status, headers, body)
                     }
                }
            }
