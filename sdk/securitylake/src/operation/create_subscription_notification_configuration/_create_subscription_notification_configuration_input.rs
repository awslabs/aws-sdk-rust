...
impl CreateSubscriptionNotificationConfigurationInputBuilder {
    ...
    pub fn https_api_key_name(
        ...
        self.https_api_key_name = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The key name for the notification subscription.</p>
    ...
    pub fn https_api_key_value(
        ...
        self.https_api_key_value = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The key value for the notification subscription.</p>
    ...
    pub fn https_method(mut self, input: crate::types::HttpsMethod) -> Self {
        self.https_method = ::std::option::Option::Some(input);
        self
    }
    /// <p>The HTTPS method used for the notification subscription. </p>
    ...
    pub fn create_sqs(mut self, input: bool) -> Self {
        self.create_sqs = ::std::option::Option::Some(input);
        self
    }
    /// <p>Create an Amazon Simple Queue Service queue.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationInput, ::aws_smithy_http::operation::error::BuildError>{
