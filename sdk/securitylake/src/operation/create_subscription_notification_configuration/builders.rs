...
impl CreateSubscriptionNotificationConfigurationFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_subscription_notification_configuration::CreateSubscriptionNotificationConfigurationError>>
                     {
        let op = self
            .inner
            .build()
