...
impl GetDatalakeInput {
    /// Consumes the builder and constructs an Operation<[`GetDatalake`](crate::operation::get_datalake::GetDatalake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_datalake::GetDatalake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_datalake::GetDatalakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_datalake::GetDatalakeInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_datalake::GetDatalake::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDatalake {
                type Output = std::result::Result<crate::operation::get_datalake::GetDatalakeOutput, crate::operation::get_datalake::GetDatalakeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_datalake::de_get_datalake_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_datalake::de_get_datalake_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_datalake::GetDatalakeError {
...
pub use crate::operation::get_datalake::_get_datalake_output::GetDatalakeOutput;

pub use crate::operation::get_datalake::_get_datalake_input::GetDatalakeInput;

mod _get_datalake_input;

mod _get_datalake_output;
