...
impl GetDatalakeInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::get_datalake::GetDatalakeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_datalake::GetDatalake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatalake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_datalake::de_get_datalake_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_datalake::de_get_datalake_http_response_with_props(
                status, headers, body,
            )
        }
    }
