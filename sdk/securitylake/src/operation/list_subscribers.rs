...
impl ListSubscribersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_subscribers::ListSubscribers,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_subscribers::ListSubscribers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscribers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_subscribers::de_list_subscribers_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_subscribers::ListSubscribersError
{
