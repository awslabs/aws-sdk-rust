...
impl UpdateDatalakeExceptionsSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDatalakeExceptionsSubscription`](crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDatalakeExceptionsSubscription {
                type Output = std::result::Result<crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionOutput, crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_datalake_exceptions_subscription::de_update_datalake_exceptions_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_datalake_exceptions_subscription::de_update_datalake_exceptions_subscription_http_response(status, headers, body)
                     }
                }
...
impl aws_http::request_id::RequestId for crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionError {
...
pub use crate::operation::update_datalake_exceptions_subscription::_update_datalake_exceptions_subscription_output::UpdateDatalakeExceptionsSubscriptionOutput;

pub use crate::operation::update_datalake_exceptions_subscription::_update_datalake_exceptions_subscription_input::UpdateDatalakeExceptionsSubscriptionInput;

mod _update_datalake_exceptions_subscription_input;

mod _update_datalake_exceptions_subscription_output;
