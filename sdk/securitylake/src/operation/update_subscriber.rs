...
impl UpdateSubscriberInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSubscriber`](crate::operation::update_subscriber::UpdateSubscriber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_subscriber::UpdateSubscriber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_subscriber::UpdateSubscriberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_subscriber::UpdateSubscriber::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSubscriber {
                type Output = std::result::Result<crate::operation::update_subscriber::UpdateSubscriberOutput, crate::operation::update_subscriber::UpdateSubscriberError>;
