...
impl DeleteDatalakeDelegatedAdminInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_datalake_delegated_admin::DeleteDatalakeDelegatedAdmin, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_datalake_delegated_admin::DeleteDatalakeDelegatedAdminInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeDelegatedAdmin {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_datalake_delegated_admin::de_delete_datalake_delegated_admin_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_datalake_delegated_admin::de_delete_datalake_delegated_admin_http_response(status, headers, body)
                     }
                }
            }
