...
impl DeleteDatalakeDelegatedAdminInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::delete_datalake_delegated_admin::DeleteDatalakeDelegatedAdminInput,
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/datalake/delegate/{account}", account = account)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_datalake_delegated_admin::DeleteDatalakeDelegatedAdmin::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeDelegatedAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_datalake_delegated_admin::de_delete_datalake_delegated_admin_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteDatalakeDelegatedAdminError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_datalake_delegated_admin::DeleteDatalakeDelegatedAdminError
{
