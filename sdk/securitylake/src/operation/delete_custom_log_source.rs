...
/// Orchestration and serialization glue logic for `DeleteCustomLogSource`.
...
impl DeleteCustomLogSource {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput,
                    ) -> ::std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_custom_log_source::DeleteCustomLogSourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomLogSource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomLogSource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCustomLogSourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCustomLogSourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCustomLogSource")
...
.with_interceptor(DeleteCustomLogSourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceError>::new());
...
#[derive(Debug)]
            struct DeleteCustomLogSourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomLogSourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_custom_log_source::de_delete_custom_log_source_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_custom_log_source::de_delete_custom_log_source_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteCustomLogSourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomLogSourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.source_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("source_name", "cannot be empty or unset"))?;
    let source_name = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    ...
    ::std::write!(output, "/v1/datalake/logsources/custom/{sourceName}", sourceName = source_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.source_version {
         {
            query.push_kv("sourceVersion", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct DeleteCustomLogSourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCustomLogSourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCustomLogSourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCustomLogSourceInput>()
                        .ok_or("failed to downcast to DeleteCustomLogSourceInput")?;
...
pub enum DeleteCustomLogSourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomLogSourceError) for what information is available for the error.")]
...
impl DeleteCustomLogSourceError {
    /// Creates the `DeleteCustomLogSourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCustomLogSourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteCustomLogSourceError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomLogSourceError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `DeleteCustomLogSourceError::ThrottlingException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomLogSourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_custom_log_source::DeleteCustomLogSourceError {
...
mod _delete_custom_log_source_output;
