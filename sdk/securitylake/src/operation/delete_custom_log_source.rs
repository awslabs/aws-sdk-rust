...
impl DeleteCustomLogSourceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCustomLogSource`](crate::operation::delete_custom_log_source::DeleteCustomLogSource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_custom_log_source::DeleteCustomLogSource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/logsources/custom").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_custom_log_source::DeleteCustomLogSourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.custom_source_name;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("custom_source_name", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("custom_source_name", "cannot be empty or unset"));
                }
                query.push_kv("customSourceName", &aws_smithy_http::query::fmt_string(&inner_1));
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_custom_log_source::DeleteCustomLogSource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCustomLogSource {
                type Output = std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError>;
