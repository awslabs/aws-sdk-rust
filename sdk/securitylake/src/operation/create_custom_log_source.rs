    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/datalake/logsources/custom")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_custom_log_source::CreateCustomLogSource::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_custom_log_source::CreateCustomLogSourceError
{
