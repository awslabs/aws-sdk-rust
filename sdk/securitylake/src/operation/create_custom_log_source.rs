...
impl CreateCustomLogSourceInput {
    /// Consumes the builder and constructs an Operation<[`CreateCustomLogSource`](crate::operation::create_custom_log_source::CreateCustomLogSource)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_custom_log_source::CreateCustomLogSource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomLogSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_custom_log_source::de_create_custom_log_source_http_response_with_props(status, headers, body)
        }
    }
}
