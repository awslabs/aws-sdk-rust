...
impl UpdateSubscriptionNotificationConfigurationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationInput,
    ...
    for UpdateSubscriptionNotificationConfiguration
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_subscription_notification_configuration::de_update_subscription_notification_configuration_http_response_with_props(status, headers, body)
        }
    }
}
    ...
    for UpdateSubscriptionNotificationConfigurationError
{
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            Self::ConcurrentModificationException(inner) => {
