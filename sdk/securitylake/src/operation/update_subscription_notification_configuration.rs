...
impl UpdateSubscriptionNotificationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSubscriptionNotificationConfiguration`](crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSubscriptionNotificationConfiguration {
                type Output = std::result::Result<crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationOutput, crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_subscription_notification_configuration::de_update_subscription_notification_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_subscription_notification_configuration::de_update_subscription_notification_configuration_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::update_subscription_notification_configuration::UpdateSubscriptionNotificationConfigurationError {
...
pub use crate::operation::update_subscription_notification_configuration::_update_subscription_notification_configuration_output::UpdateSubscriptionNotificationConfigurationOutput;

pub use crate::operation::update_subscription_notification_configuration::_update_subscription_notification_configuration_input::UpdateSubscriptionNotificationConfigurationInput;

mod _update_subscription_notification_configuration_input;

mod _update_subscription_notification_configuration_output;
