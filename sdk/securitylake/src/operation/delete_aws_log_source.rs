    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/datalake/logsources/aws/delete")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_aws_log_source::DeleteAwsLogSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAwsLogSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_aws_log_source::de_delete_aws_log_source_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_aws_log_source::DeleteAwsLogSourceError
{
