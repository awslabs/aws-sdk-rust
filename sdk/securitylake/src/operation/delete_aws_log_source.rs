...
impl DeleteAwsLogSourceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAwsLogSource`](crate::operation::delete_aws_log_source::DeleteAwsLogSource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_aws_log_source::DeleteAwsLogSource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_aws_log_source::DeleteAwsLogSourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_aws_log_source::ser_delete_aws_log_source_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_aws_log_source::DeleteAwsLogSource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAwsLogSource {
                type Output = std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError>;
