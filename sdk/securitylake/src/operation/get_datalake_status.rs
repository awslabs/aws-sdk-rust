...
impl GetDatalakeStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetDatalakeStatus`](crate::operation::get_datalake_status::GetDatalakeStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_datalake_status::GetDatalakeStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_datalake_status::GetDatalakeStatus::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDatalakeStatus {
                type Output = std::result::Result<crate::operation::get_datalake_status::GetDatalakeStatusOutput, crate::operation::get_datalake_status::GetDatalakeStatusError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_datalake_status::de_get_datalake_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_datalake_status::de_get_datalake_status_http_response(status, headers, body)
                     }
                }
...
impl aws_http::request_id::RequestId for crate::operation::get_datalake_status::GetDatalakeStatusError {
...
pub use crate::operation::get_datalake_status::_get_datalake_status_output::GetDatalakeStatusOutput;

pub use crate::operation::get_datalake_status::_get_datalake_status_input::GetDatalakeStatusInput;

mod _get_datalake_status_input;

mod _get_datalake_status_output;
