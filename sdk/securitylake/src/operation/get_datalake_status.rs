...
impl GetDatalakeStatusInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::get_datalake_status::GetDatalakeStatusInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/datalake/status").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_datalake_status::GetDatalakeStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatalakeStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_datalake_status::de_get_datalake_status_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_datalake_status::GetDatalakeStatusError
{
