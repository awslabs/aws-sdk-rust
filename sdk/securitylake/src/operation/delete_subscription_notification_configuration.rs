...
impl DeleteSubscriptionNotificationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSubscriptionNotificationConfiguration`](crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfigurationInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSubscriptionNotificationConfiguration {
                type Output = std::result::Result<crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfigurationOutput, crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfigurationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_subscription_notification_configuration::de_delete_subscription_notification_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_subscription_notification_configuration::de_delete_subscription_notification_configuration_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::delete_subscription_notification_configuration::DeleteSubscriptionNotificationConfigurationError {
...
pub use crate::operation::delete_subscription_notification_configuration::_delete_subscription_notification_configuration_output::DeleteSubscriptionNotificationConfigurationOutput;

pub use crate::operation::delete_subscription_notification_configuration::_delete_subscription_notification_configuration_input::DeleteSubscriptionNotificationConfigurationInput;

mod _delete_subscription_notification_configuration_input;

mod _delete_subscription_notification_configuration_output;
