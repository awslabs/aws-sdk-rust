...
impl DeleteDatalakeAutoEnableInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/datalake/autoenable/delete")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeAutoEnable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_datalake_auto_enable::de_delete_datalake_auto_enable_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableError
{
