...
impl DeleteDatalakeAutoEnableInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDatalakeAutoEnable`](crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatalakeAutoEnable {
                type Output = std::result::Result<crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableOutput, crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_datalake_auto_enable::de_delete_datalake_auto_enable_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_datalake_auto_enable::de_delete_datalake_auto_enable_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::delete_datalake_auto_enable::DeleteDatalakeAutoEnableError {
...
pub use crate::operation::delete_datalake_auto_enable::_delete_datalake_auto_enable_output::DeleteDatalakeAutoEnableOutput;

pub use crate::operation::delete_datalake_auto_enable::_delete_datalake_auto_enable_input::DeleteDatalakeAutoEnableInput;

mod _delete_datalake_auto_enable_input;

mod _delete_datalake_auto_enable_output;
