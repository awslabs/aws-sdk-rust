...
impl GetDatalakeAutoEnableInput {
    /// Consumes the builder and constructs an Operation<[`GetDatalakeAutoEnable`](crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDatalakeAutoEnable {
                type Output = std::result::Result<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableOutput, crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_datalake_auto_enable::de_get_datalake_auto_enable_http_error(status, headers, body)
                     } else {
...
impl aws_http::request_id::RequestId for crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError {
...
pub use crate::operation::get_datalake_auto_enable::_get_datalake_auto_enable_output::GetDatalakeAutoEnableOutput;

pub use crate::operation::get_datalake_auto_enable::_get_datalake_auto_enable_input::GetDatalakeAutoEnableInput;

mod _get_datalake_auto_enable_input;

mod _get_datalake_auto_enable_output;
