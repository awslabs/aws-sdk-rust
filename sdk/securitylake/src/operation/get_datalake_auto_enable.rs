...
impl GetDatalakeAutoEnableInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatalakeAutoEnable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_datalake_auto_enable::de_get_datalake_auto_enable_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError
{
