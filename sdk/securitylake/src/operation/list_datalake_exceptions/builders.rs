...
impl ListDatalakeExceptionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_datalake_exceptions::paginator::ListDatalakeExceptionsPaginator
    {
        crate::operation::list_datalake_exceptions::paginator::ListDatalakeExceptionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
