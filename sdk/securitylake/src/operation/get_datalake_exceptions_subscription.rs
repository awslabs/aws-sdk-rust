...
impl GetDatalakeExceptionsSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`GetDatalakeExceptionsSubscription`](crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/datalake/exceptions/subscription").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDatalakeExceptionsSubscription {
                type Output = std::result::Result<crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionOutput, crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_datalake_exceptions_subscription::de_get_datalake_exceptions_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_datalake_exceptions_subscription::de_get_datalake_exceptions_subscription_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_datalake_exceptions_subscription::GetDatalakeExceptionsSubscriptionError {
...
pub use crate::operation::get_datalake_exceptions_subscription::_get_datalake_exceptions_subscription_output::GetDatalakeExceptionsSubscriptionOutput;

pub use crate::operation::get_datalake_exceptions_subscription::_get_datalake_exceptions_subscription_input::GetDatalakeExceptionsSubscriptionInput;

mod _get_datalake_exceptions_subscription_input;

mod _get_datalake_exceptions_subscription_output;
