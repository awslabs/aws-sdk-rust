...
impl DeleteDataLakeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_data_lake::DeleteDataLake,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_data_lake::ser_delete_data_lake_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_data_lake::DeleteDataLake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDataLake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_data_lake::de_delete_data_lake_http_error(
                status, headers, body,
            )
        } else {
