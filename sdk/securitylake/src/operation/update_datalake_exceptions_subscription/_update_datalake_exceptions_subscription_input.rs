...
impl UpdateDatalakeExceptionsSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_datalake_exceptions_subscription::UpdateDatalakeExceptionsSubscriptionInput, ::aws_smithy_http::operation::error::BuildError>{
