...
impl UpdateDataLakeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_data_lake::ser_update_data_lake_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_lake::UpdateDataLake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataLake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_data_lake::de_update_data_lake_http_error(
                status, headers, body,
            )
        } else {
