...
impl UpdateDataLakeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDataLake`](crate::operation::update_data_lake::UpdateDataLake)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_data_lake::UpdateDataLake, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_data_lake::ser_update_data_lake_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_data_lake::UpdateDataLake::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataLake {
    type Output =
        ::std::result::Result<crate::operation::update_data_lake::UpdateDataLakeOutput, crate::operation::update_data_lake::UpdateDataLakeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_data_lake::de_update_data_lake_http_response_with_props(status, headers, body)
        }
    }
}
