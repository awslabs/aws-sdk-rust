...
impl CreateDatalakeExceptionsSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionInput, ::aws_smithy_http::operation::error::BuildError>{
