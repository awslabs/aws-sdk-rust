...
/// A builder for [`CreateDatalakeExceptionsSubscriptionOutput`](crate::operation::create_datalake_exceptions_subscription::CreateDatalakeExceptionsSubscriptionOutput).
#[non_exhaustive]
#[derive(std::clone::Clone, std::cmp::PartialEq, std::default::Default, std::fmt::Debug)]
pub struct CreateDatalakeExceptionsSubscriptionOutputBuilder {
    _request_id: Option<String>,
}
