...
impl CreateDataLakeInput {
    /// Consumes the builder and constructs an Operation<[`CreateDataLake`](crate::operation::create_data_lake::CreateDataLake)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_data_lake::CreateDataLake, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_data_lake::ser_create_data_lake_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_lake::CreateDataLake::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataLake {
    type Output =
        ::std::result::Result<crate::operation::create_data_lake::CreateDataLakeOutput, crate::operation::create_data_lake::CreateDataLakeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_lake::de_create_data_lake_http_response_with_props(status, headers, body)
        }
    }
}
