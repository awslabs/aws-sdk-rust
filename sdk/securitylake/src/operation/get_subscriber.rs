...
impl GetSubscriberInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_subscriber::GetSubscriber::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetSubscriber {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_subscriber::de_get_subscriber_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_subscriber::de_get_subscriber_http_response_with_props(
                status, headers, body,
            )
        }
    }
