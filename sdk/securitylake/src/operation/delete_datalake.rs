...
impl DeleteDatalakeInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::delete_datalake::DeleteDatalakeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_datalake::DeleteDatalake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDatalake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_datalake::de_delete_datalake_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_datalake::de_delete_datalake_http_response_with_props(status, headers, body)
        }
    }
}
