...
impl DeleteDatalakeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDatalake`](crate::operation::delete_datalake::DeleteDatalake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_datalake::DeleteDatalake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_datalake::DeleteDatalakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/datalake").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::delete_datalake::DeleteDatalakeInput,
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_datalake::DeleteDatalake::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatalake {
                type Output = std::result::Result<crate::operation::delete_datalake::DeleteDatalakeOutput, crate::operation::delete_datalake::DeleteDatalakeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_datalake::de_delete_datalake_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_datalake::de_delete_datalake_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::delete_datalake::DeleteDatalakeError {
...
pub use crate::operation::delete_datalake::_delete_datalake_output::DeleteDatalakeOutput;

pub use crate::operation::delete_datalake::_delete_datalake_input::DeleteDatalakeInput;

mod _delete_datalake_input;

mod _delete_datalake_output;
