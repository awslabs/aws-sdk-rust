...
impl UpdateDatalakeInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::update_datalake::UpdateDatalakeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_datalake::UpdateDatalake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDatalake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_datalake::de_update_datalake_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_datalake::de_update_datalake_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::std::error::Error for UpdateDatalakeError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::EventBridgeException(_inner) => ::std::option::Option::Some(_inner),
