...
impl UpdateDatalakeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDatalake`](crate::operation::update_datalake::UpdateDatalake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_datalake::UpdateDatalake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_datalake::UpdateDatalakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_datalake::UpdateDatalake::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDatalake {
                type Output = std::result::Result<crate::operation::update_datalake::UpdateDatalakeOutput, crate::operation::update_datalake::UpdateDatalakeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_datalake::de_update_datalake_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_datalake::de_update_datalake_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::update_datalake::UpdateDatalakeError {
...
pub use crate::operation::update_datalake::_update_datalake_output::UpdateDatalakeOutput;

pub use crate::operation::update_datalake::_update_datalake_input::UpdateDatalakeInput;

mod _update_datalake_input;

mod _update_datalake_output;
