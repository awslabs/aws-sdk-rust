...
pub use crate::operation::get_datalake_auto_enable::_get_datalake_auto_enable_output::GetDatalakeAutoEnableOutputBuilder;

pub use crate::operation::get_datalake_auto_enable::_get_datalake_auto_enable_input::GetDatalakeAutoEnableInputBuilder;
...
impl GetDatalakeAutoEnableFluentBuilder  {
    /// Creates a new `GetDatalakeAutoEnable`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        ...
                        aws_smithy_http::result::SdkError<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableOutput, aws_smithy_http::result::SdkError<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError>>
                     {
