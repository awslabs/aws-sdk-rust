...
impl crate::operation::create_aws_log_source::builders::CreateAwsLogSourceInputBuilder {
...
/// <p>You can use this API only to enable natively supported Amazon Web Services services as a source. Use <code>CreateCustomLogSource</code> to enable data collection from a custom source.</p>
...
impl CreateAwsLogSourceFluentBuilder {
    /// Creates a new `CreateAwsLogSourceFluentBuilder`.
