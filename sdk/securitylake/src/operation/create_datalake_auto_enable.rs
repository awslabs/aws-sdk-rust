...
impl CreateDatalakeAutoEnableInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatalakeAutoEnable`](crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDatalakeAutoEnable {
                type Output = std::result::Result<crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableOutput, crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_datalake_auto_enable::de_create_datalake_auto_enable_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_datalake_auto_enable::de_create_datalake_auto_enable_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableError {
...
pub use crate::operation::create_datalake_auto_enable::_create_datalake_auto_enable_output::CreateDatalakeAutoEnableOutput;

pub use crate::operation::create_datalake_auto_enable::_create_datalake_auto_enable_input::CreateDatalakeAutoEnableInput;

mod _create_datalake_auto_enable_input;

mod _create_datalake_auto_enable_output;
