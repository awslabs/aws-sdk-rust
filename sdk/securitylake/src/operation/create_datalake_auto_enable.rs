...
impl CreateDatalakeAutoEnableInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnable,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/datalake/autoenable")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatalakeAutoEnable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_datalake_auto_enable::de_create_datalake_auto_enable_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_datalake_auto_enable::CreateDatalakeAutoEnableError
{
