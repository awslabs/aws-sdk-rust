...
impl CreateDatalakeInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatalake`](crate::operation::create_datalake::CreateDatalake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_datalake::CreateDatalake, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_datalake::CreateDatalakeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_datalake::CreateDatalake::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDatalake {
                type Output = std::result::Result<crate::operation::create_datalake::CreateDatalakeOutput, crate::operation::create_datalake::CreateDatalakeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_datalake::de_create_datalake_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_datalake::de_create_datalake_http_response(status, headers, body)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_datalake::CreateDatalakeError {
...
pub use crate::operation::create_datalake::_create_datalake_output::CreateDatalakeOutput;

pub use crate::operation::create_datalake::_create_datalake_input::CreateDatalakeInput;

mod _create_datalake_input;

mod _create_datalake_output;
