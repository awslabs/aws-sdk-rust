...
impl CreateDatalakeInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::create_datalake::CreateDatalakeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_datalake::CreateDatalake::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatalake {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_datalake::de_create_datalake_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_datalake::de_create_datalake_http_response_with_props(status, headers, body)
        }
    }
}
