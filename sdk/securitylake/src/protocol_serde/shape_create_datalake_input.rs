...
pub fn ser_create_datalake_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDatalakeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
