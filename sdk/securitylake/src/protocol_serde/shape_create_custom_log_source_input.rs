...
pub fn ser_create_custom_log_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCustomLogSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
