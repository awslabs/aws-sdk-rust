...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_aws_log_source_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_aws_log_source::de_delete_aws_log_source(_response_body, output)
            .map_err(crate::operation::delete_aws_log_source::DeleteAwsLogSourceError::unhandled)?;
...
) -> Result<crate::operation::delete_aws_log_source::builders::DeleteAwsLogSourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
