...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_aws_log_source_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError> {
    Ok({
        #[allow(unused_mut)]
