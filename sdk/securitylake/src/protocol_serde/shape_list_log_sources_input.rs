...
pub fn ser_list_log_sources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLogSourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
