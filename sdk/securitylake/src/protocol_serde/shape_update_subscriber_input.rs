...
pub fn ser_update_subscriber_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSubscriberInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
