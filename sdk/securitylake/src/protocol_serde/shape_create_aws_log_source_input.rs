...
pub fn ser_create_aws_log_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAwsLogSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
