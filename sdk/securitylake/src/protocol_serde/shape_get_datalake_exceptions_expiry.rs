...
pub fn de_get_datalake_exceptions_expiry_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetDatalakeExceptionsExpiryOutput, crate::error::GetDatalakeExceptionsExpiryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetDatalakeExceptionsExpiryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_datalake_exceptions_expiry_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetDatalakeExceptionsExpiryOutput, crate::error::GetDatalakeExceptionsExpiryError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_datalake_exceptions_expiry(value: &[u8], mut builder: crate::output::get_datalake_exceptions_expiry_output::Builder) -> Result<crate::output::get_datalake_exceptions_expiry_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
