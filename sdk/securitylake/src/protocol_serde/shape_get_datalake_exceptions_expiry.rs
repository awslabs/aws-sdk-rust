...
pub fn de_get_datalake_exceptions_expiry_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryOutput, crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_datalake_exceptions_expiry_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryOutput, crate::operation::get_datalake_exceptions_expiry::GetDatalakeExceptionsExpiryError> {
    Ok({
        #[allow(unused_mut)]
