...
pub fn de_get_datalake_auto_enable_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableOutput, crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_datalake_auto_enable_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableOutput, crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_datalake_auto_enable::builders::GetDatalakeAutoEnableOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_datalake_auto_enable::de_get_datalake_auto_enable(response.body().as_ref(), output).map_err(crate::operation::get_datalake_auto_enable::GetDatalakeAutoEnableError::unhandled)?;
