...
pub fn ser_update_datalake_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDatalakeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
