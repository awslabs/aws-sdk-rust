...
pub fn ser_delete_aws_log_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAwsLogSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
