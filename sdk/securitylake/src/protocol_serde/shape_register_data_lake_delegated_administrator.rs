...
pub fn ser_register_data_lake_delegated_administrator_input(
    ...
    crate::protocol_serde::shape_register_data_lake_delegated_administrator_input::ser_register_data_lake_delegated_administrator_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_data_lake_delegated_administrator_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
