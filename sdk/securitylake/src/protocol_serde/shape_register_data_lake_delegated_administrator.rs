...
pub fn de_register_data_lake_delegated_administrator_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::unhandled,
                        )?;
        ...
        "BadRequestException" => {
            crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => {
            crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::register_data_lake_delegated_administrator::RegisterDataLakeDelegatedAdministratorError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_data_lake_delegated_administrator_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
