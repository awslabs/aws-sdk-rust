...
pub fn de_delete_custom_log_source_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_custom_log_source_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError> {
    Ok({
        #[allow(unused_mut)]
