...
pub fn de_delete_custom_log_source_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_custom_log_source::DeleteCustomLogSourceError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output).map_err(crate::operation::delete_custom_log_source::DeleteCustomLogSourceError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(_response_body, output).map_err(crate::operation::delete_custom_log_source::DeleteCustomLogSourceError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_custom_log_source_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_custom_log_source::builders::DeleteCustomLogSourceOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_custom_log_source::de_delete_custom_log_source(_response_body, output).map_err(crate::operation::delete_custom_log_source::DeleteCustomLogSourceError::unhandled)?;
