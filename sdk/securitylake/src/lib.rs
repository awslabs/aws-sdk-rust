...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("securitylake", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Security Lake.
pub mod client;
