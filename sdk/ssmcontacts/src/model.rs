...
pub struct ContactChannelAddress  {
    ...
    /// </ul>
    #[doc(hidden)]pub simple_address: std::option::Option<std::string::String>,
}
...
pub struct Plan  {
    ...
    #[doc(hidden)]pub stages: std::option::Option<std::vec::Vec<crate::model::Stage>>,
}
impl Plan {
    /// <p>A list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods.</p>
...
pub mod plan {
    ...
    impl Builder {
        ...
        /// <p>A list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods.</p>
        pub fn set_stages(mut self, input: std::option::Option<std::vec::Vec<crate::model::Stage>>) -> Self {
...
pub struct Stage  {
    ...
    #[doc(hidden)]pub duration_in_minutes: std::option::Option<i32>,
...
pub struct Target  {
    ...
    #[doc(hidden)]pub channel_target_info: std::option::Option<crate::model::ChannelTargetInfo>,
    /// <p>Information about the contact that Incident Manager is engaging.</p>
    #[doc(hidden)]pub contact_target_info: std::option::Option<crate::model::ContactTargetInfo>,
}
impl Target {
    /// <p>Information about the contact channel Incident Manager is engaging.</p>
...
pub mod target {
    ...
    impl Builder {
        ...
        /// <p>Information about the contact channel Incident Manager is engaging.</p>
        pub fn set_channel_target_info(mut self, input: std::option::Option<crate::model::ChannelTargetInfo>) -> Self {
        ...
        /// <p>Information about the contact that Incident Manager is engaging.</p>
        pub fn set_contact_target_info(mut self, input: std::option::Option<crate::model::ContactTargetInfo>) -> Self {
...
pub struct ContactTargetInfo  {
    ...
    #[doc(hidden)]pub is_essential: std::option::Option<bool>,
}
...
pub struct ChannelTargetInfo  {
    ...
    #[doc(hidden)]pub contact_channel_id: std::option::Option<std::string::String>,
    /// <p>The number of minutes to wait to retry sending engagement in the case the engagement initially fails.</p>
    #[doc(hidden)]pub retry_interval_in_minutes: std::option::Option<i32>,
}
...
pub struct Page  {
    ...
    #[doc(hidden)]pub page_arn: std::option::Option<std::string::String>,
    /// <p>The ARN of the engagement that this page is part of.</p>
    #[doc(hidden)]pub engagement_arn: std::option::Option<std::string::String>,
    /// <p>The ARN of the contact that Incident Manager is engaging.</p>
    #[doc(hidden)]pub contact_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub incident_id: std::option::Option<std::string::String>,
    /// <p>The time that Incident Manager engaged the contact channel.</p>
    #[doc(hidden)]pub sent_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time the message was delivered to the contact channel.</p>
    #[doc(hidden)]pub delivery_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time that the contact channel acknowledged engagement.</p>
    #[doc(hidden)]pub read_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl Page {
    /// <p>The Amazon Resource Name (ARN) of the page to the contact channel.</p>
...
pub struct Receipt  {
    ...
    #[doc(hidden)]pub contact_channel_arn: std::option::Option<std::string::String>,
    /// <p>The type follows the engagement cycle, <code>SENT</code>, <code>DELIVERED</code>, and <code>READ</code>.</p>
    #[doc(hidden)]pub receipt_type: std::option::Option<crate::model::ReceiptType>,
    /// <p>Information provided during the page acknowledgement.</p>
    #[doc(hidden)]pub receipt_info: std::option::Option<std::string::String>,
    /// <p>The time receipt was <code>SENT</code>, <code>DELIVERED</code>, or <code>READ</code>.</p>
    #[doc(hidden)]pub receipt_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl Receipt {
    /// <p>The Amazon Resource Name (ARN) of the contact channel Incident Manager engaged.</p>
...
pub mod receipt {
    ...
    impl Builder {
        ...
        /// <p>The type follows the engagement cycle, <code>SENT</code>, <code>DELIVERED</code>, and <code>READ</code>.</p>
        pub fn set_receipt_type(mut self, input: std::option::Option<crate::model::ReceiptType>) -> Self {
...
pub struct Contact  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ContactType>,
}
impl Contact {
    /// <p>The Amazon Resource Name (ARN) of the contact or escalation plan.</p>
    pub fn contact_arn(&self) -> std::option::Option<& str> {
...
pub struct ContactChannel  {
    ...
    /// <p>The details that Incident Manager uses when trying to engage the contact channel.</p>
    #[doc(hidden)]pub delivery_address: std::option::Option<crate::model::ContactChannelAddress>,
    ...
    #[doc(hidden)]pub activation_status: std::option::Option<crate::model::ActivationStatus>,
}
impl ContactChannel {
    /// <p>The Amazon Resource Name (ARN) of the contact channel.</p>
    pub fn contact_channel_arn(&self) -> std::option::Option<& str> {
