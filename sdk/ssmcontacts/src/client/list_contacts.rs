...
impl super::Client {
    ...
    ///   - [`r#type(ContactType)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::type) / [`set_type(Option<ContactType>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_type):<br>required: **false**<br><p>The type of contact.</p><br>
