...
impl super::Client {
    ...
    ///   - [`contact_arn(String)`](crate::operation::get_contact_channel::GetContactChannelOutput::contact_arn): <p>The ARN of the contact that the channel belongs to.</p>
    ///   - [`contact_channel_arn(String)`](crate::operation::get_contact_channel::GetContactChannelOutput::contact_channel_arn): <p>The ARN of the contact channel.</p>
    ///   - [`name(String)`](crate::operation::get_contact_channel::GetContactChannelOutput::name): <p>The name of the contact channel</p>
    ///   - [`r#type(ChannelType)`](crate::operation::get_contact_channel::GetContactChannelOutput::type): <p>The type of contact channel. The type is <code>SMS</code>, <code>VOICE</code>, or <code>EMAIL</code>.</p>
