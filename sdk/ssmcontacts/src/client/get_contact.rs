...
impl super::Client {
    ...
    ///   - [`contact_id(impl Into<String>)`](crate::operation::get_contact::builders::GetContactFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::get_contact::builders::GetContactFluentBuilder::set_contact_id):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the contact or escalation plan.</p><br>
