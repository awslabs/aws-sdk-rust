...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_engagements::builders::ListEngagementsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_engagements::builders::ListEngagementsFluentBuilder::set_next_token): <p>The pagination token to continue to the next page of results.</p>
    ...
    ///   - [`incident_id(impl ::std::convert::Into<String>)`](crate::operation::list_engagements::builders::ListEngagementsFluentBuilder::incident_id) / [`set_incident_id(Option<String>)`](crate::operation::list_engagements::builders::ListEngagementsFluentBuilder::set_incident_id): <p>The Amazon Resource Name (ARN) of the incident you're listing engagements for.</p>
