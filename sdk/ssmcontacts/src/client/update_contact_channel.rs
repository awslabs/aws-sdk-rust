...
impl super::Client {
    ...
    ///   - [`contact_channel_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact_channel::builders::UpdateContactChannelFluentBuilder::contact_channel_id) / [`set_contact_channel_id(Option<String>)`](crate::operation::update_contact_channel::builders::UpdateContactChannelFluentBuilder::set_contact_channel_id): <p>The Amazon Resource Name (ARN) of the contact channel you want to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_contact_channel::builders::UpdateContactChannelFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_contact_channel::builders::UpdateContactChannelFluentBuilder::set_name): <p>The name of the contact channel.</p>
