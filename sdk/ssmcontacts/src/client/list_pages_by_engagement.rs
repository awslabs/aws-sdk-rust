...
impl super::Client {
    ...
    pub fn list_pages_by_engagement(
        &self,
    ) -> crate::operation::list_pages_by_engagement::builders::ListPagesByEngagementFluentBuilder
    {
