...
impl super::Client {
    ...
    ///   - [`rotation_id(impl ::std::convert::Into<String>)`](crate::operation::get_rotation_override::builders::GetRotationOverrideFluentBuilder::rotation_id) / [`set_rotation_id(Option<String>)`](crate::operation::get_rotation_override::builders::GetRotationOverrideFluentBuilder::set_rotation_id): <p>The Amazon Resource Name (ARN) of the overridden rotation to retrieve information about.</p>
    ///   - [`rotation_override_id(impl ::std::convert::Into<String>)`](crate::operation::get_rotation_override::builders::GetRotationOverrideFluentBuilder::rotation_override_id) / [`set_rotation_override_id(Option<String>)`](crate::operation::get_rotation_override::builders::GetRotationOverrideFluentBuilder::set_rotation_override_id): <p>The Amazon Resource Name (ARN) of the on-call rotation override to retrieve information about.</p>
