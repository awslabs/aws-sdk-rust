...
impl super::Client {
    ...
    ///   - [`page_id(impl ::std::convert::Into<String>)`](crate::operation::list_page_receipts::builders::ListPageReceiptsFluentBuilder::page_id) / [`set_page_id(Option<String>)`](crate::operation::list_page_receipts::builders::ListPageReceiptsFluentBuilder::set_page_id): <p>The Amazon Resource Name (ARN) of the engagement to a specific contact channel.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_page_receipts::builders::ListPageReceiptsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_page_receipts::builders::ListPageReceiptsFluentBuilder::set_next_token): <p>The pagination token to continue to the next page of results.</p>
