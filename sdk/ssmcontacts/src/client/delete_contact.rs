...
impl super::Client {
    ...
    ///   - [`contact_id(impl Into<String>)`](crate::operation::delete_contact::builders::DeleteContactFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::delete_contact::builders::DeleteContactFluentBuilder::set_contact_id):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the contact that you're deleting.</p><br>
