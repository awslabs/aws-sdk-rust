...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results.</p>
