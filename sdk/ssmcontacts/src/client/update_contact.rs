...
impl super::Client {
    ...
    ///   - [`contact_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact::builders::UpdateContactFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::update_contact::builders::UpdateContactFluentBuilder::set_contact_id): <p>The Amazon Resource Name (ARN) of the contact or escalation plan you're updating.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::update_contact::builders::UpdateContactFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_contact::builders::UpdateContactFluentBuilder::set_display_name): <p>The full name of the contact or escalation plan.</p>
