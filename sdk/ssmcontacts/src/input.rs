...
pub mod accept_page_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::AcceptPageInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl AcceptPageInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::AcceptPage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::AcceptPageInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod activate_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ActivateContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ActivateContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ActivateContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ActivateContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod create_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::CreateContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod deactivate_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeactivateContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeactivateContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeactivateContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeactivateContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod delete_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeleteContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_engagement_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeEngagementInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeEngagementInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeEngagementInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_page_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribePageInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribePageInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribePage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribePageInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_contact_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetContactPolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetContactPolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetContactPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetContactPolicyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_contact_channels_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListContactChannelsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListContactChannelsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListContactChannels, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListContactChannelsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_engagements_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListEngagementsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListEngagementsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListEngagements, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListEngagementsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_page_receipts_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListPageReceiptsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListPageReceiptsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListPageReceipts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListPageReceiptsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_pages_by_contact_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListPagesByContactInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListPagesByContactInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListPagesByContact, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListPagesByContactInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_pages_by_engagement_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListPagesByEngagementInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListPagesByEngagementInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListPagesByEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListPagesByEngagementInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod put_contact_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutContactPolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutContactPolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutContactPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::PutContactPolicyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod send_activation_code_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::SendActivationCodeInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl SendActivationCodeInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::SendActivationCode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::SendActivationCodeInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod start_engagement_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartEngagementInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartEngagementInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::StartEngagementInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod stop_engagement_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StopEngagementInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StopEngagementInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StopEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StopEngagementInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_contact_channel_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateContactChannelInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateContactChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateContactChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateContactChannelInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub struct UpdateContactInput  {
    ...
    /// <p>A list of stages. A contact has an engagement plan with stages for specified contact channels. An escalation plan uses these stages to contact specified contacts. </p>
    #[doc(hidden)]pub plan: std::option::Option<crate::model::Plan>,
}
impl UpdateContactInput {
    /// <p>The Amazon Resource Name (ARN) of the contact or escalation plan you're updating.</p>
...
pub struct StopEngagementInput  {
    /// <p>The Amazon Resource Name (ARN) of the engagement.</p>
    #[doc(hidden)]pub engagement_id: std::option::Option<std::string::String>,
    /// <p>The reason that you're stopping the engagement. </p>
...
pub struct StartEngagementInput  {
    ...
    /// <p>The insecure subject of the message that was sent to the contact. Use this field for engagements to <code>SMS</code>.</p>
    #[doc(hidden)]pub public_subject: std::option::Option<std::string::String>,
    /// <p>The insecure content of the message that was sent to the contact. Use this field for engagements to <code>SMS</code>.</p>
    #[doc(hidden)]pub public_content: std::option::Option<std::string::String>,
    /// <p>The ARN of the incident that the engagement is part of.</p>
...
pub struct ListPageReceiptsInput  {
    /// <p>The Amazon Resource Name (ARN) of the engagement to a specific contact channel.</p>
    #[doc(hidden)]pub page_id: std::option::Option<std::string::String>,
    /// <p>The pagination token to continue to the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>The maximum number of acknowledgements per page of results.</p>
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
...
pub struct ListEngagementsInput  {
    ...
    #[doc(hidden)]pub incident_id: std::option::Option<std::string::String>,
    /// <p>The time range to lists engagements for an incident.</p>
    #[doc(hidden)]pub time_range_value: std::option::Option<crate::model::TimeRange>,
}
impl ListEngagementsInput {
    /// <p>The pagination token to continue to the next page of results.</p>
    pub fn next_token(&self) -> std::option::Option<& str> {
...
pub struct CreateContactChannelInput  {
    ...
    #[doc(hidden)]pub delivery_address: std::option::Option<crate::model::ContactChannelAddress>,
    /// <p>If you want to activate the channel at a later time, you can choose to defer activation. Incident Manager can't engage your contact channel until it has been activated.</p>
    #[doc(hidden)]pub defer_activation: std::option::Option<bool>,
    /// <p>A token ensuring that the operation is called only once with the specified details.</p>
    #[doc(hidden)]pub idempotency_token: std::option::Option<std::string::String>,
}
impl CreateContactChannelInput {
...
pub struct ActivateContactChannelInput  {
    ...
    #[doc(hidden)]pub contact_channel_id: std::option::Option<std::string::String>,
    /// <p>The code sent to the contact channel when it was created in the contact. </p>
    #[doc(hidden)]pub activation_code: std::option::Option<std::string::String>,
}
impl ActivateContactChannelInput {
    /// <p>The Amazon Resource Name (ARN) of the contact channel.</p>
    pub fn contact_channel_id(&self) -> std::option::Option<& str> {
...
pub struct AcceptPageInput  {
    ...
    #[doc(hidden)]pub contact_channel_id: std::option::Option<std::string::String>,
    /// <p>The type indicates if the page was <code>DELIVERED</code> or <code>READ</code>.</p>
    #[doc(hidden)]pub accept_type: std::option::Option<crate::model::AcceptType>,
    /// <p>Information provided by the user when the user acknowledges the page.</p>
    #[doc(hidden)]pub note: std::option::Option<std::string::String>,
    /// <p>The accept code is a 6-digit code used to acknowledge the page.</p>
    #[doc(hidden)]pub accept_code: std::option::Option<std::string::String>,
    /// <p>An optional field that Incident Manager uses to <code>ENFORCE</code> <code>AcceptCode</code> validation when acknowledging an page. Acknowledgement can occur by replying to a page, or when entering the AcceptCode in the console. Enforcing AcceptCode validation causes Incident Manager to verify that the code entered by the user matches the code sent by Incident Manager with the page.</p> 
    /// <p>Incident Manager can also <code>IGNORE</code> <code>AcceptCode</code> validation. Ignoring <code>AcceptCode</code> validation causes Incident Manager to accept any value entered for the <code>AcceptCode</code>.</p>
    #[doc(hidden)]pub accept_code_validation: std::option::Option<crate::model::AcceptCodeValidation>,
}
impl AcceptPageInput {
    /// <p>The Amazon Resource Name (ARN) of the engagement to a contact channel.</p>
    pub fn page_id(&self) -> std::option::Option<& str> {
