...
pub struct ListPageReceiptsOutput  {
    ...
    #[doc(hidden)]pub receipts: std::option::Option<std::vec::Vec<crate::model::Receipt>>,
}
...
pub struct ListEngagementsOutput  {
    ...
    #[doc(hidden)]pub engagements: std::option::Option<std::vec::Vec<crate::model::Engagement>>,
}
...
pub struct ListContactChannelsOutput  {
    ...
    #[doc(hidden)]pub contact_channels: std::option::Option<std::vec::Vec<crate::model::ContactChannel>>,
}
