...
impl ListPagesByContactOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_pages_by_contact::ListPagesByContactOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_pages_by_contact::ListPagesByContactOutput {
                ...
                pages: self.pages
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pages", "pages was not specified but it is required when building ListPagesByContactOutput")
                    )?
                ,
