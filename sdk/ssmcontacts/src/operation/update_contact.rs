...
impl UpdateContactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_contact::UpdateContact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_contact::ser_update_contact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_contact::de_update_contact_http_response_with_props(status, headers, body)
        }
    }
}
