...
impl ListContactsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Contact, ::aws_smithy_http::result::SdkError<crate::operation::list_contacts::ListContactsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_contacts_output_contacts(page).unwrap_or_default().into_iter())
    }
}
