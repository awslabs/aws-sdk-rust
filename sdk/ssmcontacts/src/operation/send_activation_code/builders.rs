...
impl SendActivationCodeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_activation_code::SendActivationCodeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_activation_code::SendActivationCodeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_activation_code::SendActivationCodeOutput, crate::operation::send_activation_code::SendActivationCodeError, Self> {
