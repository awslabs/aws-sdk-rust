...
impl DeactivateContactChannelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deactivate_contact_channel::DeactivateContactChannelInput, ::aws_smithy_types::error::operation::BuildError> {
