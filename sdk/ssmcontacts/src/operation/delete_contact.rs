...
impl DeleteContactInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_contact::ser_delete_contact_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_contact::DeleteContact::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteContact", "ssmcontacts"));
