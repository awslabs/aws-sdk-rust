...
impl DeleteRotationOverrideFluentBuilder  {
    /// Creates a new `DeleteRotationOverride`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_rotation_override::DeleteRotationOverride, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_rotation_override::DeleteRotationOverrideError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_rotation_override::DeleteRotationOverrideOutput, aws_smithy_http::result::SdkError<crate::operation::delete_rotation_override::DeleteRotationOverrideError>>
                     {
