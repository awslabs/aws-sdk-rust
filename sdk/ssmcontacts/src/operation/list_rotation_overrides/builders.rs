...
pub use crate::operation::list_rotation_overrides::_list_rotation_overrides_output::ListRotationOverridesOutputBuilder;
...
pub struct ListRotationOverridesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_rotation_overrides::builders::ListRotationOverridesInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_rotation_overrides::ListRotationOverridesOutput,
                    crate::operation::list_rotation_overrides::ListRotationOverridesError,
                > for ListRotationOverridesFluentBuilder
            {
                fn send(
                    self,
...
impl ListRotationOverridesFluentBuilder {
    /// Creates a new `ListRotationOverrides`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_rotation_overrides::ListRotationOverridesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_rotation_overrides::ListRotationOverridesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_rotation_overrides::ListRotationOverrides::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_rotation_overrides::ListRotationOverridesOutput, crate::operation::list_rotation_overrides::ListRotationOverridesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_rotation_overrides::paginator::ListRotationOverridesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
