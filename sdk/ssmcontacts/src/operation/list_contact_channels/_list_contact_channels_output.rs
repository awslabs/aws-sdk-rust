...
impl  ListContactChannelsOutput  {
    ...
    pub fn contact_channels(&self) -> & [crate::types::ContactChannel] {
        use std::ops::Deref; self.contact_channels.deref()
    }
}
...
impl ListContactChannelsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_contact_channels::ListContactChannelsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_contact_channels::ListContactChannelsOutput {
                ...
                contact_channels: self.contact_channels
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("contact_channels", "contact_channels was not specified but it is required when building ListContactChannelsOutput")
                    )?
                ,
