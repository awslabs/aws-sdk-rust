...
impl GetRotationFluentBuilder  {
    /// Creates a new `GetRotation`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_rotation::GetRotationOutput, aws_smithy_http::result::SdkError<crate::operation::get_rotation::GetRotationError>>
                     {
