...
impl CreateRotationOverrideInputBuilder {
    ...
    pub fn rotation_id(mut self, input: impl Into<std::string::String>) -> Self {
        self.rotation_id = Some(input.into());
        self
    }
    /// <p>The Amazon Resource Name (ARN) of the rotation to create an override for.</p>
    ...
    pub fn build(self) -> Result<crate::operation::create_rotation_override::CreateRotationOverrideInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
