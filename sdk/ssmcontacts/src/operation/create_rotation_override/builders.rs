...
impl CreateRotationOverrideFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_rotation_override::CreateRotationOverrideOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_rotation_override::CreateRotationOverrideError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_rotation_override::CreateRotationOverrideOutput, crate::operation::create_rotation_override::CreateRotationOverrideError, Self> {
