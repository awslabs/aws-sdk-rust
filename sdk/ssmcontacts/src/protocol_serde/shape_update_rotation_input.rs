...
pub fn ser_update_rotation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_rotation::UpdateRotationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
