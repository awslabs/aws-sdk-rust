...
pub fn ser_create_rotation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_rotation::CreateRotationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
