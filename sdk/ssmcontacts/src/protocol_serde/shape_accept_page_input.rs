...
pub fn ser_accept_page_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AcceptPageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
