...
pub fn ser_recurrence_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RecurrenceSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
