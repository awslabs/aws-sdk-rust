...
pub fn ser_create_rotation_override_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_rotation_override::CreateRotationOverrideInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
