...
pub fn ser_coverage_time(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CoverageTime) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
