...
pub fn ser_list_rotation_shifts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_rotation_shifts::ListRotationShiftsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
