...
impl Client  {
    ...
    pub fn associate_configuration_items_to_application(&self) -> crate::client::fluent_builders::AssociateConfigurationItemsToApplication {
                            crate::client::fluent_builders::AssociateConfigurationItemsToApplication::new(self.handle.clone())
                        }
    ...
    pub fn describe_configurations(&self) -> crate::client::fluent_builders::DescribeConfigurations {
    ...
    pub fn stop_data_collection_by_agent_ids(&self) -> crate::client::fluent_builders::StopDataCollectionByAgentIds {
