...
impl ExportConfigurationsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_export_configurations::ser_export_configurations_input(
                &self,
            )?,
        );
        let request = request.body(body).expect("should be valid request");
...
impl ListServerNeighborsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_server_neighbors::ser_list_server_neighbors_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl StopContinuousExportInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_continuous_export::ser_stop_continuous_export_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
