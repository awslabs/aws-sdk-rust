...
pub struct AgentConfigurationStatus  {
    ...
    #[doc(hidden)]pub agent_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub operation_succeeded: bool,
...
pub struct ImportTask  {
    ...
    #[doc(hidden)]pub import_task_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub errors_and_failed_entries_zip: std::option::Option<std::string::String>,
}
impl ImportTask {
    /// <p>The unique ID for a specific import task. These IDs aren't globally unique, but they are unique within an Amazon Web Services account.</p>
...
impl  std::fmt::Debug for ImportTask  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_import_success", &self.application_import_success);
        formatter.field("application_import_failure", &self.application_import_failure);
        formatter.field("errors_and_failed_entries_zip", &self.errors_and_failed_entries_zip);
        formatter.finish()
    }
}
...
pub mod import_task {
    ...
    impl Builder {
        ...
        /// <p>The status of the import task. An import can have the status of <code>IMPORT_COMPLETE</code> and still have some records fail to import from the overall request. More information can be found in the downloadable archive defined in the <code>errorsAndFailedEntriesZip</code> field, or in the Migration Hub management console.</p>
        pub fn set_status(mut self, input: std::option::Option<crate::model::ImportStatus>) -> Self {
...
pub struct ExportFilter  {
    ...
    #[doc(hidden)]pub condition: std::option::Option<std::string::String>,
}
impl ExportFilter {
    /// <p>A single <code>ExportFilter</code> name. Supported filters: <code>agentIds</code>.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct NeighborConnectionDetail  {
    ...
    #[doc(hidden)]pub destination_server_id: std::option::Option<std::string::String>,
    /// <p>The destination network port for the connection.</p>
    #[doc(hidden)]pub destination_port: std::option::Option<i32>,
    /// <p>The network protocol used for the connection.</p>
    #[doc(hidden)]pub transport_protocol: std::option::Option<std::string::String>,
    /// <p>The number of open network connections with the neighboring server.</p>
    #[doc(hidden)]pub connections_count: i64,
}
...
pub struct OrderByElement  {
    ...
    #[doc(hidden)]pub sort_order: std::option::Option<crate::model::OrderString>,
}
impl OrderByElement {
    /// <p>The field on which to order.</p>
...
pub mod order_by_element {
    ...
    impl Builder {
        ...
        /// <p>Ordering direction.</p>
        pub fn set_sort_order(mut self, input: std::option::Option<crate::model::OrderString>) -> Self {
...
pub struct CustomerAgentlessCollectorInfo  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub active_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub healthy_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub deny_listed_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub shutdown_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub unhealthy_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub total_agentless_collectors: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub unknown_agentless_collectors: i32,
}
...
impl  std::fmt::Debug for CustomerAgentlessCollectorInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("active_agentless_collectors", &self.active_agentless_collectors);
        formatter.field("healthy_agentless_collectors", &self.healthy_agentless_collectors);
        formatter.field("deny_listed_agentless_collectors", &self.deny_listed_agentless_collectors);
        formatter.field("shutdown_agentless_collectors", &self.shutdown_agentless_collectors);
        formatter.field("unhealthy_agentless_collectors", &self.unhealthy_agentless_collectors);
        formatter.field("total_agentless_collectors", &self.total_agentless_collectors);
        formatter.field("unknown_agentless_collectors", &self.unknown_agentless_collectors);
        formatter.finish()
    }
}
...
pub struct ConfigurationTag  {
    ...
    #[doc(hidden)]pub time_of_creation: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct ImportTaskFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::ImportTaskFilterName>,
...
pub mod import_task_filter {
    ...
    impl Builder {
        ...
        /// <p>The name, status, or import task ID for a specific import task.</p>
        pub fn set_name(mut self, input: std::option::Option<crate::model::ImportTaskFilterName>) -> Self {
            self.name = input; self
        }
        /// Appends an item to `values`.
        ///
...
pub struct ExportInfo  {
    ...
    #[doc(hidden)]pub configurations_download_url: std::option::Option<std::string::String>,
    /// <p>The time that the data export was initiated.</p>
    #[doc(hidden)]pub export_request_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub requested_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub requested_end_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl ExportInfo {
    /// <p>A unique identifier used to query an export.</p>
...
impl  std::fmt::Debug for ExportInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("configurations_download_url", &self.configurations_download_url);
...
pub struct ContinuousExportDescription  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ContinuousExportStatus>,
    ...
    /// </ul>
    #[doc(hidden)]pub schema_storage_config: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub mod continuous_export_description {
    ...
    impl Builder {
        ...
        /// <li> <p>INACTIVE - the continuous export has been stopped. Data is no longer being exported to the customer bucket.</p> </li> 
        /// </ul>
        pub fn set_status(mut self, input: std::option::Option<crate::model::ContinuousExportStatus>) -> Self {
            self.status = input; self
        }
        /// <p>Contains information about any errors that have occurred. This data type can have the following values:</p> 
        /// <ul> 
...
pub struct AgentInfo  {
    ...
    #[doc(hidden)]pub agent_network_info_list: std::option::Option<std::vec::Vec<crate::model::AgentNetworkInfo>>,
    ...
    #[doc(hidden)]pub health: std::option::Option<crate::model::AgentStatus>,
    /// <p>Time since agent or connector health was reported.</p>
    #[doc(hidden)]pub last_health_ping_time: std::option::Option<std::string::String>,
    /// <p>Status of the collection process for an agent or connector.</p>
    #[doc(hidden)]pub collection_status: std::option::Option<std::string::String>,
    /// <p>Type of agent.</p>
    #[doc(hidden)]pub agent_type: std::option::Option<std::string::String>,
...
impl AgentInfo {
    ...
    /// <p>Network details about the host where the agent or connector resides.</p>
    pub fn agent_network_info_list(&self) -> std::option::Option<& [crate::model::AgentNetworkInfo]> {
...
pub mod agent_info {
    ...
    pub struct Builder {
        ...
        pub(crate) agent_network_info_list: std::option::Option<std::vec::Vec<crate::model::AgentNetworkInfo>>,
    ...
    impl Builder {
        ...
        /// <p>Network details about the host where the agent or connector resides.</p>
        pub fn set_agent_network_info_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::AgentNetworkInfo>>) -> Self {
...
pub struct BatchDeleteImportDataError  {
    ...
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::BatchDeleteImportDataErrorCode>,
    /// <p>The description of the error that occurred for a specific import task.</p>
    #[doc(hidden)]pub error_description: std::option::Option<std::string::String>,
}
...
pub mod batch_delete_import_data_error {
    ...
    impl Builder {
        ...
        /// <p>The type of error that occurred for a specific import task.</p>
        pub fn set_error_code(mut self, input: std::option::Option<crate::model::BatchDeleteImportDataErrorCode>) -> Self {
