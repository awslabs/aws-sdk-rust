...
impl StartDataCollectionByAgentIds {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIdsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIdsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.StartDataCollectionByAgentIds",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "StartDataCollectionByAgentIds",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDataCollectionByAgentIds {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartDataCollectionByAgentIdsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartDataCollectionByAgentIdsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartDataCollectionByAgentIds")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDataCollectionByAgentIdsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_data_collection_by_agent_ids::de_start_data_collection_by_agent_ids_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_start_data_collection_by_agent_ids::de_start_data_collection_by_agent_ids_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDataCollectionByAgentIdsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIdsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIdsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_data_collection_by_agent_ids::ser_start_data_collection_by_agent_ids_input(&input)?,
        );
