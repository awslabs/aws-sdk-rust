...
impl StartDataCollectionByAgentIdsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIds::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDataCollectionByAgentIds {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_data_collection_by_agent_ids::de_start_data_collection_by_agent_ids_http_response_with_props(
                status, headers, body,
            )
        }
    }
