...
impl DeleteApplicationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_applications::ser_delete_applications_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_applications::DeleteApplications::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("DeleteApplications", "applicationdiscoveryservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_applications::de_delete_applications_http_response_with_props(status, headers, body)
        }
    }
}
