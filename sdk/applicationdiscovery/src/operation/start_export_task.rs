...
impl StartExportTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_export_task::ser_start_export_task_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_export_task::StartExportTask::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("StartExportTask", "applicationdiscoveryservice"),
        );
