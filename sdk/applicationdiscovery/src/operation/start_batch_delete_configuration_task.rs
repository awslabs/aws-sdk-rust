...
/// Orchestration and serialization glue logic for `StartBatchDeleteConfigurationTask`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartBatchDeleteConfigurationTask;
impl StartBatchDeleteConfigurationTask {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartBatchDeleteConfigurationTask {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartBatchDeleteConfigurationTask");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartBatchDeleteConfigurationTaskRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartBatchDeleteConfigurationTaskResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartBatchDeleteConfigurationTask")
...
.with_interceptor(StartBatchDeleteConfigurationTaskEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError>::new());
...
#[derive(Debug)]
            struct StartBatchDeleteConfigurationTaskResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartBatchDeleteConfigurationTaskResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_batch_delete_configuration_task::de_start_batch_delete_configuration_task_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_batch_delete_configuration_task::de_start_batch_delete_configuration_task_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartBatchDeleteConfigurationTaskRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartBatchDeleteConfigurationTaskRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_batch_delete_configuration_task::ser_start_batch_delete_configuration_task_input(&input)?);
...
#[derive(Debug)]
            struct StartBatchDeleteConfigurationTaskEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartBatchDeleteConfigurationTaskEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartBatchDeleteConfigurationTaskEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartBatchDeleteConfigurationTaskInput>()
                        .ok_or("failed to downcast to StartBatchDeleteConfigurationTaskInput")?;
...
/// Error type for the `StartBatchDeleteConfigurationTaskError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartBatchDeleteConfigurationTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartBatchDeleteConfigurationTaskError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartBatchDeleteConfigurationTaskError {
    /// Creates the `StartBatchDeleteConfigurationTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartBatchDeleteConfigurationTaskError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartBatchDeleteConfigurationTaskError::AuthorizationErrorException`.
    ...
    /// Returns `true` if the error kind is `StartBatchDeleteConfigurationTaskError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `StartBatchDeleteConfigurationTaskError::OperationNotPermittedException`.
    pub fn is_operation_not_permitted_exception(&self) -> bool {
        matches!(self, Self::OperationNotPermittedException(_))
    }
    /// Returns `true` if the error kind is `StartBatchDeleteConfigurationTaskError::ServerInternalErrorException`.
    pub fn is_server_internal_error_exception(&self) -> bool {
        matches!(self, Self::ServerInternalErrorException(_))
    }
}
impl ::std::error::Error for StartBatchDeleteConfigurationTaskError {
...
impl ::std::fmt::Display for StartBatchDeleteConfigurationTaskError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartBatchDeleteConfigurationTaskError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartBatchDeleteConfigurationTaskError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartBatchDeleteConfigurationTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError {
...
mod _start_batch_delete_configuration_task_output;
