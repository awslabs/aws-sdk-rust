...
impl ListServerNeighborsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_server_neighbors::ListServerNeighbors::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListServerNeighbors", "applicationdiscoveryservice"),
            );
