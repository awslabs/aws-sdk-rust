...
impl ExportConfigurations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::export_configurations::ExportConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::export_configurations::ExportConfigurationsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.ExportConfigurations",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "ExportConfigurations",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportConfigurations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ExportConfigurationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ExportConfigurationsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ExportConfigurations")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::export_configurations::ExportConfigurationsInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_export_configurations::ser_export_configurations_input(
            &input,
        )?);
