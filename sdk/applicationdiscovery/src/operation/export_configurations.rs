...
impl ExportConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`ExportConfigurations`](crate::operation::export_configurations::ExportConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::export_configurations::ExportConfigurations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::export_configurations::ExportConfigurations::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExportConfigurations {
                type Output = std::result::Result<crate::operation::export_configurations::ExportConfigurationsOutput, crate::operation::export_configurations::ExportConfigurationsError>;
