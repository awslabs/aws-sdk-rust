...
impl GetDiscoverySummary {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.GetDiscoverySummary",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "GetDiscoverySummary",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDiscoverySummary {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDiscoverySummaryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDiscoverySummaryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDiscoverySummary")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDiscoverySummaryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_discovery_summary::de_get_discovery_summary_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_discovery_summary::de_get_discovery_summary_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDiscoverySummaryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_discovery_summary::GetDiscoverySummaryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_discovery_summary::ser_get_discovery_summary_input(
            &input,
        )?);
