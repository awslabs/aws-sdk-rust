...
impl GetDiscoverySummaryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_discovery_summary::ser_get_discovery_summary_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_discovery_summary::GetDiscoverySummary::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_discovery_summary::GetDiscoverySummaryError
{
