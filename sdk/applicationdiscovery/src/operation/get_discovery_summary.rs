...
/// Orchestration and serialization glue logic for `GetDiscoverySummary`.
...
impl GetDiscoverySummary {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_discovery_summary::GetDiscoverySummaryInput,
                    ) -> ::std::result::Result<crate::operation::get_discovery_summary::GetDiscoverySummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_discovery_summary::GetDiscoverySummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDiscoverySummary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDiscoverySummary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDiscoverySummaryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDiscoverySummaryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDiscoverySummary")
...
.with_interceptor(GetDiscoverySummaryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_discovery_summary::GetDiscoverySummaryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_discovery_summary::GetDiscoverySummaryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_discovery_summary::GetDiscoverySummaryError>::new());
...
#[derive(Debug)]
            struct GetDiscoverySummaryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDiscoverySummaryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_discovery_summary::de_get_discovery_summary_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDiscoverySummaryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDiscoverySummaryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_discovery_summary::GetDiscoverySummaryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_discovery_summary::GetDiscoverySummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_discovery_summary::ser_get_discovery_summary_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct GetDiscoverySummaryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDiscoverySummaryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDiscoverySummaryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDiscoverySummaryInput>()
                        .ok_or("failed to downcast to GetDiscoverySummaryInput")?;
...
pub enum GetDiscoverySummaryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDiscoverySummaryError) for what information is available for the error.")]
...
impl GetDiscoverySummaryError {
    /// Creates the `GetDiscoverySummaryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDiscoverySummaryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDiscoverySummaryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_discovery_summary::GetDiscoverySummaryError {
...
mod _get_discovery_summary_output;
