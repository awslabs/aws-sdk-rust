...
impl GetDiscoverySummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetDiscoverySummary`](crate::operation::get_discovery_summary::GetDiscoverySummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_discovery_summary::GetDiscoverySummary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_discovery_summary::GetDiscoverySummaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_discovery_summary::ser_get_discovery_summary_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_discovery_summary::GetDiscoverySummary::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDiscoverySummary {
                type Output = std::result::Result<crate::operation::get_discovery_summary::GetDiscoverySummaryOutput, crate::operation::get_discovery_summary::GetDiscoverySummaryError>;
