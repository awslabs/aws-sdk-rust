...
impl GetDiscoverySummaryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_discovery_summary::GetDiscoverySummary::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetDiscoverySummary", "applicationdiscoveryservice"),
            );
