...
impl StopDataCollectionByAgentIds {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.StopDataCollectionByAgentIds",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "StopDataCollectionByAgentIds",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopDataCollectionByAgentIds {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopDataCollectionByAgentIdsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopDataCollectionByAgentIdsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopDataCollectionByAgentIds")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopDataCollectionByAgentIdsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_data_collection_by_agent_ids::de_stop_data_collection_by_agent_ids_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_stop_data_collection_by_agent_ids::de_stop_data_collection_by_agent_ids_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopDataCollectionByAgentIdsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_stop_data_collection_by_agent_ids::ser_stop_data_collection_by_agent_ids_input(&input)?,
        );
