...
impl DescribeAgentsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_agents::DescribeAgents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_agents::DescribeAgentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_agents::DescribeAgents::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAgents {
                type Output = std::result::Result<crate::operation::describe_agents::DescribeAgentsOutput, crate::operation::describe_agents::DescribeAgentsError>;
