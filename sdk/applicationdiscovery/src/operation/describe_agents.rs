...
impl DescribeAgentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAgents`](crate::operation::describe_agents::DescribeAgents)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_agents::DescribeAgents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_agents::ser_describe_agents_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_agents::DescribeAgents::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DescribeAgents", "applicationdiscoveryservice"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgents {
    type Output =
        ::std::result::Result<crate::operation::describe_agents::DescribeAgentsOutput, crate::operation::describe_agents::DescribeAgentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_agents::de_describe_agents_http_response_with_props(status, headers, body)
        }
    }
}
