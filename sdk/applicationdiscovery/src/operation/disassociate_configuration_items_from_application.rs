    ...
    for DisassociateConfigurationItemsFromApplication
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_configuration_items_from_application::de_disassociate_configuration_items_from_application_http_response_with_props(status, headers, body)
        }
    }
}
