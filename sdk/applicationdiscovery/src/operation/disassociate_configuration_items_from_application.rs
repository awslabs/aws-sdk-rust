...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DisassociateConfigurationItemsFromApplicationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DisassociateConfigurationItemsFromApplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_configuration_items_from_application::ser_disassociate_configuration_items_from_application_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociateConfigurationItemsFromApplicationEndpointParamsInterceptor {
