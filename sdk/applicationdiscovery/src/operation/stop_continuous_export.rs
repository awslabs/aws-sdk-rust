...
impl StopContinuousExportInput {
    /// Consumes the builder and constructs an Operation<[`StopContinuousExport`](crate::operation::stop_continuous_export::StopContinuousExport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_continuous_export::StopContinuousExport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_continuous_export::StopContinuousExportInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_continuous_export::StopContinuousExport::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopContinuousExport {
                type Output = std::result::Result<crate::operation::stop_continuous_export::StopContinuousExportOutput, crate::operation::stop_continuous_export::StopContinuousExportError>;
