...
impl StopContinuousExportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_continuous_export::StopContinuousExport,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopContinuousExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_continuous_export::de_stop_continuous_export_http_response_with_props(status, headers, body)
        }
    }
}
