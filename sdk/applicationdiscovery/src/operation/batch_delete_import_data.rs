...
impl BatchDeleteImportDataInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteImportData`](crate::operation::batch_delete_import_data::BatchDeleteImportData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_delete_import_data::BatchDeleteImportData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_import_data::BatchDeleteImportDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_import_data::BatchDeleteImportData::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeleteImportData {
                type Output = std::result::Result<crate::operation::batch_delete_import_data::BatchDeleteImportDataOutput, crate::operation::batch_delete_import_data::BatchDeleteImportDataError>;
