...
/// Orchestration and serialization glue logic for `BatchDeleteImportData`.
...
impl BatchDeleteImportData {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_delete_import_data::BatchDeleteImportDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_import_data::BatchDeleteImportDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDeleteImportData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDeleteImportData");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDeleteImportDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDeleteImportDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDeleteImportData")
...
.with_interceptor(BatchDeleteImportDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_delete_import_data::BatchDeleteImportDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_delete_import_data::BatchDeleteImportDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_delete_import_data::BatchDeleteImportDataError>::new());
...
#[derive(Debug)]
            struct BatchDeleteImportDataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDeleteImportDataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_delete_import_data::de_batch_delete_import_data_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct BatchDeleteImportDataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDeleteImportDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_delete_import_data::BatchDeleteImportDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_delete_import_data::ser_batch_delete_import_data_input(&input)?);
...
#[derive(Debug)]
            struct BatchDeleteImportDataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDeleteImportDataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDeleteImportDataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDeleteImportDataInput>()
                        .ok_or("failed to downcast to BatchDeleteImportDataInput")?;
...
pub enum BatchDeleteImportDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDeleteImportDataError) for what information is available for the error.")]
...
impl BatchDeleteImportDataError {
    /// Creates the `BatchDeleteImportDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDeleteImportDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDeleteImportDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_delete_import_data::BatchDeleteImportDataError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::batch_delete_import_data::_batch_delete_import_data_output::BatchDeleteImportDataOutput;

pub use crate::operation::batch_delete_import_data::_batch_delete_import_data_input::BatchDeleteImportDataInput;

mod _batch_delete_import_data_input;

mod _batch_delete_import_data_output;
