...
impl BatchDeleteImportData {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.BatchDeleteImportData",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "BatchDeleteImportData",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDeleteImportData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchDeleteImportDataRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchDeleteImportDataResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchDeleteImportData")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDeleteImportDataResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_delete_import_data::de_batch_delete_import_data_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_delete_import_data::de_batch_delete_import_data_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDeleteImportDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_delete_import_data::BatchDeleteImportDataInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_delete_import_data::BatchDeleteImportDataInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_import_data::ser_batch_delete_import_data_input(&input)?,
        );
