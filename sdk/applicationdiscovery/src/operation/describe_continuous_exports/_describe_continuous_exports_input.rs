...
impl DescribeContinuousExportsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_continuous_exports::DescribeContinuousExportsInput, ::aws_smithy_types::error::operation::BuildError> {
