...
impl ListConfigurationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_configurations::ser_list_configurations_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_configurations::ListConfigurations::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListConfigurations", "applicationdiscoveryservice"),
            );
