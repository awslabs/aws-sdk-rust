...
impl StartImportTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_import_task::StartImportTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_import_task::ser_start_import_task_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_import_task::StartImportTask::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("StartImportTask", "applicationdiscoveryservice"),
        );
