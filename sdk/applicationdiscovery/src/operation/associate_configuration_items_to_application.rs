...
impl AssociateConfigurationItemsToApplication {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.AssociateConfigurationItemsToApplication",
            "rpc.service" = "Application Discovery Service",
            "rpc.method" = "AssociateConfigurationItemsToApplication",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConfigurationItemsToApplication {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateConfigurationItemsToApplicationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateConfigurationItemsToApplicationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociateConfigurationItemsToApplication")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateConfigurationItemsToApplication")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AssociateConfigurationItemsToApplicationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AssociateConfigurationItemsToApplicationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConfigurationItemsToApplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssociateConfigurationItemsToApplicationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateConfigurationItemsToApplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_configuration_items_to_application::de_associate_configuration_items_to_application_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_configuration_items_to_application::de_associate_configuration_items_to_application_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConfigurationItemsToApplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_configuration_items_to_application::ser_associate_configuration_items_to_application_input(
                &input,
            )?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError
{
