...
impl CreateApplication {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Application Discovery Service.CreateApplication",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateApplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("wave") {
            if let ::std::option::Option::Some(value) = input.wave.as_deref() {
                captured.insert("wave", value);
            }
        }
