...
pub fn ser_list_server_neighbors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListServerNeighborsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
