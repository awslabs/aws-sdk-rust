...
pub fn de_start_continuous_export_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_continuous_export::StartContinuousExportOutput, crate::operation::start_continuous_export::StartContinuousExportError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_continuous_export_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_continuous_export::StartContinuousExportOutput, crate::operation::start_continuous_export::StartContinuousExportError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_start_continuous_export_input(_input: &crate::operation::start_continuous_export::StartContinuousExportInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
