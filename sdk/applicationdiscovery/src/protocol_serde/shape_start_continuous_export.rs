...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_continuous_export::StartContinuousExportError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ConflictErrorException" => crate::operation::start_continuous_export::StartContinuousExportError::ConflictErrorException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_conflict_error_exception::de_conflict_error_exception_json_err(_response_body, output)
                    .map_err(crate::operation::start_continuous_export::StartContinuousExportError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_continuous_export_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_continuous_export::de_start_continuous_export(_response_body, output)
            .map_err(crate::operation::start_continuous_export::StartContinuousExportError::unhandled)?;
