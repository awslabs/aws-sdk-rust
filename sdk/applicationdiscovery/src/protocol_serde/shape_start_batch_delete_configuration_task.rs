...
pub fn de_start_batch_delete_configuration_task_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::unhandled)?;
    ...
    Err(match error_code {
        "AuthorizationErrorException" => {
            crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::AuthorizationErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "HomeRegionNotSetException" => {
            crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::HomeRegionNotSetException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerInternalErrorException" => {
            crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::ServerInternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_batch_delete_configuration_task_http_response(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_batch_delete_configuration_task::de_start_batch_delete_configuration_task(_response_body, output)
            .map_err(crate::operation::start_batch_delete_configuration_task::StartBatchDeleteConfigurationTaskError::unhandled)?;
...
pub fn ser_start_batch_delete_configuration_task_input(
    ...
    crate::protocol_serde::shape_start_batch_delete_configuration_task_input::ser_start_batch_delete_configuration_task_input(&mut object, input)?;
    object.finish();
