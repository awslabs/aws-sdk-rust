...
pub fn ser_disassociate_configuration_items_from_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::disassociate_configuration_items_from_application::DisassociateConfigurationItemsFromApplicationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
