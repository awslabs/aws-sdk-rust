...
pub(crate) fn de_describe_configurations_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<std::collections::HashMap<std::string::String, std::string::String>>>, aws_smithy_json::deserialize::error::DeserializeError>
