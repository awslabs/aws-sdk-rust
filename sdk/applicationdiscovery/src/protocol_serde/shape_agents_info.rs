...
pub(crate) fn de_agents_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::AgentInfo>>, aws_smithy_json::deserialize::error::DeserializeError>
