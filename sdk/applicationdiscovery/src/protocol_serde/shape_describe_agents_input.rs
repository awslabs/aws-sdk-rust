...
pub fn ser_describe_agents_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_agents::DescribeAgentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
