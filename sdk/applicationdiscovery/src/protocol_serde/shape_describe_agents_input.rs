...
pub fn ser_describe_agents_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAgentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
