...
impl super::Client {
    ...
    ///   - [`export_ids(impl Into<String>)`](crate::operation::describe_continuous_exports::builders::DescribeContinuousExportsFluentBuilder::export_ids) / [`set_export_ids(Option<Vec<String>>)`](crate::operation::describe_continuous_exports::builders::DescribeContinuousExportsFluentBuilder::set_export_ids): <p>The unique IDs assigned to the exports.</p>
