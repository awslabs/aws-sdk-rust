...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_continuous_exports::builders::DescribeContinuousExportsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_continuous_exports::builders::DescribeContinuousExportsFluentBuilder::set_next_token): <p>The token from the previous call to <code>DescribeExportTasks</code>.</p>
