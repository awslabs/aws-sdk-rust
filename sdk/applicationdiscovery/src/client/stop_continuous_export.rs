...
impl super::Client {
    ...
    ///   - [`export_id(impl Into<String>)`](crate::operation::stop_continuous_export::builders::StopContinuousExportFluentBuilder::export_id) / [`set_export_id(Option<String>)`](crate::operation::stop_continuous_export::builders::StopContinuousExportFluentBuilder::set_export_id):<br>required: **true**<br><p>The unique ID assigned to this export.</p><br>
