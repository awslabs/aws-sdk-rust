...
impl super::Client {
    ...
    pub fn describe_batch_delete_configuration_task(&self) -> crate::operation::describe_batch_delete_configuration_task::builders::DescribeBatchDeleteConfigurationTaskFluentBuilder {
                                crate::operation::describe_batch_delete_configuration_task::builders::DescribeBatchDeleteConfigurationTaskFluentBuilder::new(self.handle.clone())
                            }
}
