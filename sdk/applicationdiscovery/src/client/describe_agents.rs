...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_agents::builders::DescribeAgentsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::describe_agents::builders::DescribeAgentsFluentBuilder::set_max_results): <p>The total number of agents/Connectors to return in a single page of output. The maximum value is 100.</p>
