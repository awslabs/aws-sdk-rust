...
impl super::Client {
    ...
    ///   - [`agent_ids(impl Into<String>)`](crate::operation::stop_data_collection_by_agent_ids::builders::StopDataCollectionByAgentIdsFluentBuilder::agent_ids) / [`set_agent_ids(Option<Vec<String>>)`](crate::operation::stop_data_collection_by_agent_ids::builders::StopDataCollectionByAgentIdsFluentBuilder::set_agent_ids): <p>The IDs of the agents from which to stop collecting data.</p>
