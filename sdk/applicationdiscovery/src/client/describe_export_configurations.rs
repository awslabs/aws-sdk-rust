...
impl super::Client {
    ...
    ///   - [`export_ids(impl Into<String>)`](crate::operation::describe_export_configurations::builders::DescribeExportConfigurationsFluentBuilder::export_ids) / [`set_export_ids(Option<Vec<String>>)`](crate::operation::describe_export_configurations::builders::DescribeExportConfigurationsFluentBuilder::set_export_ids): <p>A list of continuous export IDs to search for.</p>
