...
impl super::Client {
    ...
    ///   - [`delete_agents(DeleteAgent)`](crate::operation::batch_delete_agents::builders::BatchDeleteAgentsFluentBuilder::delete_agents) / [`set_delete_agents(Option<Vec<DeleteAgent>>)`](crate::operation::batch_delete_agents::builders::BatchDeleteAgentsFluentBuilder::set_delete_agents): <p> The list of agents to delete. </p>
