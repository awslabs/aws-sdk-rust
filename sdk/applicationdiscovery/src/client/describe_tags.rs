...
impl super::Client {
    ...
    ///   - [`filters(TagFilter)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::filters) / [`set_filters(Option<Vec<TagFilter>>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_filters): <p>You can filter the list using a <i>key</i>-<i>value</i> format. You can separate these items by using logical operators. Allowed filters include <code>tagKey</code>, <code>tagValue</code>, and <code>configurationId</code>. </p>
