...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_max_results): <p>The total number of items to return in a single page of output. The maximum value is 100.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results.</p>
