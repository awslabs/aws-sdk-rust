...
impl super::Client {
    ...
    ///   - [`configuration_ids(impl Into<String>)`](crate::operation::describe_configurations::builders::DescribeConfigurationsFluentBuilder::configuration_ids) / [`set_configuration_ids(Option<Vec::<String>>)`](crate::operation::describe_configurations::builders::DescribeConfigurationsFluentBuilder::set_configuration_ids):<br>required: **true**<br><p>One or more configuration IDs.</p><br>
