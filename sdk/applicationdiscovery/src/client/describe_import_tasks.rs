...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_import_tasks::builders::DescribeImportTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_import_tasks::builders::DescribeImportTasksFluentBuilder::set_next_token): <p>The token to request a specific page of results.</p>
