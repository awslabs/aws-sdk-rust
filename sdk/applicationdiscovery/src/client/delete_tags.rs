...
impl super::Client {
    ...
    ///   - [`configuration_ids(impl Into<String>)`](crate::operation::delete_tags::builders::DeleteTagsFluentBuilder::configuration_ids) / [`set_configuration_ids(Option<Vec<String>>)`](crate::operation::delete_tags::builders::DeleteTagsFluentBuilder::set_configuration_ids): <p>A list of configuration items with tags that you want to delete.</p>
    ///   - [`tags(Tag)`](crate::operation::delete_tags::builders::DeleteTagsFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::delete_tags::builders::DeleteTagsFluentBuilder::set_tags): <p>Tags that you want to delete from one or more configuration items. Specify the tags that you want to delete in a <i>key</i>-<i>value</i> format. For example:</p>  <p> <code>{"key": "serverType", "value": "webServer"}</code> </p>
