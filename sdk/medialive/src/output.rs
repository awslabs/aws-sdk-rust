...
pub struct UpdateMultiplexProgramOutput  {
    ...
    #[doc(hidden)]pub multiplex_program: std::option::Option<crate::model::MultiplexProgram>,
}
...
pub struct UpdateMultiplexOutput  {
    ...
    #[doc(hidden)]pub multiplex: std::option::Option<crate::model::Multiplex>,
}
...
pub struct UpdateInputSecurityGroupOutput  {
    ...
    #[doc(hidden)]pub security_group: std::option::Option<crate::model::InputSecurityGroup>,
}
...
pub struct UpdateInputDeviceOutput  {
    ...
    #[doc(hidden)]pub connection_state: std::option::Option<crate::model::InputDeviceConnectionState>,
    /// The status of the action to synchronize the device configuration. If you change the configuration of the input device (for example, the maximum bitrate), MediaLive sends the new data to the device. The device might not update itself immediately. SYNCED means the device has updated its configuration. SYNCING means that it has not updated its configuration.
    #[doc(hidden)]pub device_settings_sync_state: std::option::Option<crate::model::DeviceSettingsSyncState>,
    /// The status of software on the input device.
    #[doc(hidden)]pub device_update_status: std::option::Option<crate::model::DeviceUpdateStatus>,
    /// Settings that describe an input device that is type HD.
    #[doc(hidden)]pub hd_device_settings: std::option::Option<crate::model::InputDeviceHdSettings>,
    ...
    #[doc(hidden)]pub network_settings: std::option::Option<crate::model::InputDeviceNetworkSettings>,
    /// The unique serial number of the input device.
    #[doc(hidden)]pub serial_number: std::option::Option<std::string::String>,
    /// The type of the input device.
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::InputDeviceType>,
    /// Settings that describe an input device that is type UHD.
    #[doc(hidden)]pub uhd_device_settings: std::option::Option<crate::model::InputDeviceUhdSettings>,
}
...
impl  std::fmt::Debug for UpdateInputDeviceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("device_settings_sync_state", &self.device_settings_sync_state);
...
pub struct StopMultiplexOutput  {
    ...
    #[doc(hidden)]pub destinations: std::option::Option<std::vec::Vec<crate::model::MultiplexOutputDestination>>,
    /// The unique id of the multiplex.
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// Configuration for a multiplex event.
    #[doc(hidden)]pub multiplex_settings: std::option::Option<crate::model::MultiplexSettings>,
    /// The name of the multiplex.
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// The number of currently healthy pipelines.
    #[doc(hidden)]pub pipelines_running_count: i32,
    /// The number of programs in the multiplex.
    #[doc(hidden)]pub program_count: i32,
    /// The current state of the multiplex.
    #[doc(hidden)]pub state: std::option::Option<crate::model::MultiplexState>,
...
pub struct StopChannelOutput  {
    ...
    #[doc(hidden)]pub cdi_input_specification: std::option::Option<crate::model::CdiInputSpecification>,
    /// The class for this channel. STANDARD for a channel with two pipelines or SINGLE_PIPELINE for a channel with one pipeline.
    #[doc(hidden)]pub channel_class: std::option::Option<crate::model::ChannelClass>,
    /// A list of destinations of the channel. For UDP outputs, there is one destination per output. For other types (HLS, for example), there is one destination per packager.
    #[doc(hidden)]pub destinations: std::option::Option<std::vec::Vec<crate::model::OutputDestination>>,
    /// The endpoints where outgoing connections initiate from
    #[doc(hidden)]pub egress_endpoints: std::option::Option<std::vec::Vec<crate::model::ChannelEgressEndpoint>>,
    /// Encoder Settings
    #[doc(hidden)]pub encoder_settings: std::option::Option<crate::model::EncoderSettings>,
    /// The unique id of the channel.
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// List of input attachments for channel.
    #[doc(hidden)]pub input_attachments: std::option::Option<std::vec::Vec<crate::model::InputAttachment>>,
    /// Specification of network and file inputs for this channel
    #[doc(hidden)]pub input_specification: std::option::Option<crate::model::InputSpecification>,
    /// The log level being written to CloudWatch Logs.
    #[doc(hidden)]pub log_level: std::option::Option<crate::model::LogLevel>,
    /// Maintenance settings for this channel.
    #[doc(hidden)]pub maintenance: std::option::Option<crate::model::MaintenanceStatus>,
    /// The name of the channel. (user-mutable)
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// Runtime details for the pipelines of a running channel.
    #[doc(hidden)]pub pipeline_details: std::option::Option<std::vec::Vec<crate::model::PipelineDetail>>,
    /// The number of currently healthy pipelines.
    #[doc(hidden)]pub pipelines_running_count: i32,
    /// The Amazon Resource Name (ARN) of the role assumed when running the Channel.
    #[doc(hidden)]pub role_arn: std::option::Option<std::string::String>,
    /// Placeholder documentation for ChannelState
    #[doc(hidden)]pub state: std::option::Option<crate::model::ChannelState>,
    /// A collection of key-value pairs.
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// Settings for VPC output
    #[doc(hidden)]pub vpc: std::option::Option<crate::model::VpcOutputSettingsDescription>,
}
...
pub struct ListMultiplexProgramsOutput  {
    ...
    #[doc(hidden)]pub multiplex_programs: std::option::Option<std::vec::Vec<crate::model::MultiplexProgramSummary>>,
...
pub struct ListMultiplexesOutput  {
    /// List of multiplexes.
    #[doc(hidden)]pub multiplexes: std::option::Option<std::vec::Vec<crate::model::MultiplexSummary>>,
...
pub struct ListInputSecurityGroupsOutput  {
    ...
    #[doc(hidden)]pub input_security_groups: std::option::Option<std::vec::Vec<crate::model::InputSecurityGroup>>,
...
pub struct ListInputDeviceTransfersOutput  {
    ...
    #[doc(hidden)]pub input_device_transfers: std::option::Option<std::vec::Vec<crate::model::TransferringInputDeviceSummary>>,
...
pub struct ListInputDevicesOutput  {
    ...
    #[doc(hidden)]pub input_devices: std::option::Option<std::vec::Vec<crate::model::InputDeviceSummary>>,
    /// A token to get additional list results.
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeScheduleOutput  {
    ...
    #[doc(hidden)]pub schedule_actions: std::option::Option<std::vec::Vec<crate::model::ScheduleAction>>,
}
...
pub struct DescribeReservationOutput  {
    ...
    #[doc(hidden)]pub duration_units: std::option::Option<crate::model::OfferingDurationUnits>,
    /// Reservation UTC end date and time in ISO-8601 format, e.g. '2019-03-01T00:00:00'
    #[doc(hidden)]pub end: std::option::Option<std::string::String>,
    /// One-time charge for each reserved resource, e.g. '0.0' for a NO_UPFRONT offering
    #[doc(hidden)]pub fixed_price: f64,
    /// User specified reservation name
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// Offering description, e.g. 'HD AVC output at 10-20 Mbps, 30 fps, and standard VQ in US West (Oregon)'
    #[doc(hidden)]pub offering_description: std::option::Option<std::string::String>,
    /// Unique offering ID, e.g. '87654321'
    #[doc(hidden)]pub offering_id: std::option::Option<std::string::String>,
    /// Offering type, e.g. 'NO_UPFRONT'
    #[doc(hidden)]pub offering_type: std::option::Option<crate::model::OfferingType>,
    /// AWS region, e.g. 'us-west-2'
    #[doc(hidden)]pub region: std::option::Option<std::string::String>,
    /// Renewal settings for the reservation
    #[doc(hidden)]pub renewal_settings: std::option::Option<crate::model::RenewalSettings>,
    /// Unique reservation ID, e.g. '1234567'
    #[doc(hidden)]pub reservation_id: std::option::Option<std::string::String>,
    /// Resource configuration details
    #[doc(hidden)]pub resource_specification: std::option::Option<crate::model::ReservationResourceSpecification>,
    /// Reservation UTC start date and time in ISO-8601 format, e.g. '2018-03-01T00:00:00'
    #[doc(hidden)]pub start: std::option::Option<std::string::String>,
    /// Current state of reservation, e.g. 'ACTIVE'
    #[doc(hidden)]pub state: std::option::Option<crate::model::ReservationState>,
    /// A collection of key-value pairs
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// Recurring usage charge for each reserved resource, e.g. '157.0'
    #[doc(hidden)]pub usage_price: f64,
}
...
pub struct DescribeMultiplexProgramOutput  {
    ...
    #[doc(hidden)]pub multiplex_program_settings: std::option::Option<crate::model::MultiplexProgramSettings>,
    /// The packet identifier map for this multiplex program.
    #[doc(hidden)]pub packet_identifiers_map: std::option::Option<crate::model::MultiplexProgramPacketIdentifiersMap>,
    /// Contains information about the current sources for the specified program in the specified multiplex. Keep in mind that each multiplex pipeline connects to both pipelines in a given source channel (the channel identified by the program). But only one of those channel pipelines is ever active at one time.
    #[doc(hidden)]pub pipeline_details: std::option::Option<std::vec::Vec<crate::model::MultiplexProgramPipelineDetail>>,
...
impl  std::fmt::Debug for DescribeMultiplexProgramOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("multiplex_program_settings", &self.multiplex_program_settings);
...
pub struct DescribeInputSecurityGroupOutput  {
    ...
    #[doc(hidden)]pub inputs: std::option::Option<std::vec::Vec<std::string::String>>,
    /// The current state of the Input Security Group.
    #[doc(hidden)]pub state: std::option::Option<crate::model::InputSecurityGroupState>,
    /// A collection of key-value pairs.
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// Whitelist rules and their sync status
    #[doc(hidden)]pub whitelist_rules: std::option::Option<std::vec::Vec<crate::model::InputWhitelistRule>>,
}
...
#[non_exhaustive]pub struct DescribeInputDeviceThumbnailOutput  {
...
pub struct DescribeInputOutput  {
    ...
    #[doc(hidden)]pub attached_channels: std::option::Option<std::vec::Vec<std::string::String>>,
    /// A list of the destinations of the input (PUSH-type).
    #[doc(hidden)]pub destinations: std::option::Option<std::vec::Vec<crate::model::InputDestination>>,
    /// The generated ID of the input (unique for user account, immutable).
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// STANDARD - MediaLive expects two sources to be connected to this input. If the channel is also STANDARD, both sources will be ingested. If the channel is SINGLE_PIPELINE, only the first source will be ingested; the second source will always be ignored, even if the first source fails. SINGLE_PIPELINE - You can connect only one source to this input. If the ChannelClass is also SINGLE_PIPELINE, this value is valid. If the ChannelClass is STANDARD, this value is not valid because the channel requires two sources in the input.
    #[doc(hidden)]pub input_class: std::option::Option<crate::model::InputClass>,
    /// Settings for the input devices.
    #[doc(hidden)]pub input_devices: std::option::Option<std::vec::Vec<crate::model::InputDeviceSettings>>,
    /// A list of IDs for all Inputs which are partners of this one.
    #[doc(hidden)]pub input_partner_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub input_source_type: std::option::Option<crate::model::InputSourceType>,
    /// A list of MediaConnect Flows for this input.
    #[doc(hidden)]pub media_connect_flows: std::option::Option<std::vec::Vec<crate::model::MediaConnectFlow>>,
    ...
    #[doc(hidden)]pub sources: std::option::Option<std::vec::Vec<crate::model::InputSource>>,
    /// Placeholder documentation for InputState
    #[doc(hidden)]pub state: std::option::Option<crate::model::InputState>,
    /// A collection of key-value pairs.
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// The different types of inputs that AWS Elemental MediaLive supports.
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::InputType>,
}
...
pub struct BatchUpdateScheduleOutput  {
    ...
    #[doc(hidden)]pub creates: std::option::Option<crate::model::BatchScheduleActionCreateResult>,
    /// Schedule actions deleted from the schedule.
    #[doc(hidden)]pub deletes: std::option::Option<crate::model::BatchScheduleActionDeleteResult>,
}
...
pub struct BatchStopOutput  {
    ...
    #[doc(hidden)]pub failed: std::option::Option<std::vec::Vec<crate::model::BatchFailedResultModel>>,
    /// List of successful operations
    #[doc(hidden)]pub successful: std::option::Option<std::vec::Vec<crate::model::BatchSuccessfulResultModel>>,
}
