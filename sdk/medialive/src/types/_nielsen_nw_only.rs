...
impl NielsenNwOnly {
    /// Creates a new builder-style object to manufacture [`NielsenNwOnly`](crate::types::NielsenNwOnly).
    pub fn builder() -> crate::types::builders::NielsenNwOnlyBuilder {
        crate::types::builders::NielsenNwOnlyBuilder::default()
    }
}

/// A builder for [`NielsenNwOnly`](crate::types::NielsenNwOnly).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct NielsenNwOnlyBuilder {
...
impl NielsenNwOnlyBuilder {
    ...
    /// Consumes the builder and constructs a [`NielsenNwOnly`](crate::types::NielsenNwOnly).
    pub fn build(self) -> crate::types::NielsenNwOnly {
        crate::types::NielsenNwOnly {
