...
pub struct MultiplexAlert {
    ...
    pub state: ::std::option::Option<crate::types::MultiplexAlertState>,
}
impl MultiplexAlert {
    /// The type of the alert
    ...
    /// The state of the alert
    pub fn state(&self) -> ::std::option::Option<&crate::types::MultiplexAlertState> {
        self.state.as_ref()
    }
}
impl MultiplexAlert {
    /// Creates a new builder-style object to manufacture [`MultiplexAlert`](crate::types::MultiplexAlert).
    pub fn builder() -> crate::types::builders::MultiplexAlertBuilder {
        crate::types::builders::MultiplexAlertBuilder::default()
    }
}

/// A builder for [`MultiplexAlert`](crate::types::MultiplexAlert).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct MultiplexAlertBuilder {
    ...
    pub(crate) state: ::std::option::Option<crate::types::MultiplexAlertState>,
}
impl MultiplexAlertBuilder {
    /// The type of the alert
    ...
    /// The state of the alert
    pub fn state(mut self, input: crate::types::MultiplexAlertState) -> Self {
        self.state = ::std::option::Option::Some(input);
        self
    }
    /// The state of the alert
    pub fn set_state(mut self, input: ::std::option::Option<crate::types::MultiplexAlertState>) -> Self {
        self.state = input;
        self
    }
    /// The state of the alert
    pub fn get_state(&self) -> &::std::option::Option<crate::types::MultiplexAlertState> {
        &self.state
    }
    /// Consumes the builder and constructs a [`MultiplexAlert`](crate::types::MultiplexAlert).
    pub fn build(self) -> crate::types::MultiplexAlert {
