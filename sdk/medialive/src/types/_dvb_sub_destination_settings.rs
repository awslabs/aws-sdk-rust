...
pub struct DvbSubDestinationSettings {
    ...
    pub subtitle_rows: ::std::option::Option<crate::types::DvbSubDestinationSubtitleRows>,
}
impl DvbSubDestinationSettings {
    ...
    /// Applies only when the input captions are Teletext and the output captions are DVB-Sub or Burn-In. Choose the number of lines for the captions bitmap. The captions bitmap is 700 wide × 576 high and will be laid over the video. For example, a value of 16 divides the bitmap into 16 lines, with each line 36 pixels high (16 × 36 = 576). The default is 24 (24 pixels high). Enter the same number in every encode in every output that converts the same Teletext source to DVB-Sub or Burn-in.
    pub fn subtitle_rows(&self) -> ::std::option::Option<&crate::types::DvbSubDestinationSubtitleRows> {
...
pub struct DvbSubDestinationSettingsBuilder {
    ...
    pub(crate) subtitle_rows: ::std::option::Option<crate::types::DvbSubDestinationSubtitleRows>,
}
impl DvbSubDestinationSettingsBuilder {
    ...
    /// Applies only when the input captions are Teletext and the output captions are DVB-Sub or Burn-In. Choose the number of lines for the captions bitmap. The captions bitmap is 700 wide × 576 high and will be laid over the video. For example, a value of 16 divides the bitmap into 16 lines, with each line 36 pixels high (16 × 36 = 576). The default is 24 (24 pixels high). Enter the same number in every encode in every output that converts the same Teletext source to DVB-Sub or Burn-in.
    pub fn subtitle_rows(mut self, input: crate::types::DvbSubDestinationSubtitleRows) -> Self {
        self.subtitle_rows = ::std::option::Option::Some(input);
        self
    }
    /// Applies only when the input captions are Teletext and the output captions are DVB-Sub or Burn-In. Choose the number of lines for the captions bitmap. The captions bitmap is 700 wide × 576 high and will be laid over the video. For example, a value of 16 divides the bitmap into 16 lines, with each line 36 pixels high (16 × 36 = 576). The default is 24 (24 pixels high). Enter the same number in every encode in every output that converts the same Teletext source to DVB-Sub or Burn-in.
    pub fn set_subtitle_rows(mut self, input: ::std::option::Option<crate::types::DvbSubDestinationSubtitleRows>) -> Self {
        self.subtitle_rows = input;
        self
    }
    /// Applies only when the input captions are Teletext and the output captions are DVB-Sub or Burn-In. Choose the number of lines for the captions bitmap. The captions bitmap is 700 wide × 576 high and will be laid over the video. For example, a value of 16 divides the bitmap into 16 lines, with each line 36 pixels high (16 × 36 = 576). The default is 24 (24 pixels high). Enter the same number in every encode in every output that converts the same Teletext source to DVB-Sub or Burn-in.
    pub fn get_subtitle_rows(&self) -> &::std::option::Option<crate::types::DvbSubDestinationSubtitleRows> {
        &self.subtitle_rows
    }
