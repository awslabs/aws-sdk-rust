...
impl ::std::convert::From<&str> for ConnectionMode {
    fn from(s: &str) -> Self {
        match s {
            "CALLER" => ConnectionMode::Caller,
            "LISTENER" => ConnectionMode::Listener,
...
impl ConnectionMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectionMode::Caller => "CALLER",
            ConnectionMode::Listener => "LISTENER",
...
impl ::std::fmt::Display for ConnectionMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConnectionMode::Caller => write!(f, "CALLER"),
            ConnectionMode::Listener => write!(f, "LISTENER"),
