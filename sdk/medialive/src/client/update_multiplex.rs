...
impl super::Client {
    ...
    ///   - [`multiplex_id(impl ::std::convert::Into<String>)`](crate::operation::update_multiplex::builders::UpdateMultiplexFluentBuilder::multiplex_id) / [`set_multiplex_id(Option<String>)`](crate::operation::update_multiplex::builders::UpdateMultiplexFluentBuilder::set_multiplex_id): ID of the multiplex to update.
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_multiplex::builders::UpdateMultiplexFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_multiplex::builders::UpdateMultiplexFluentBuilder::set_name): Name of the multiplex.
