...
impl super::Client {
    ...
    ///   - [`channel_class(ChannelClass)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::channel_class) / [`set_channel_class(Option<ChannelClass>)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::set_channel_class):<br>required: **true**<br>The channel class that you wish to update this channel to use.<br>
    ///   - [`channel_id(impl Into<String>)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::channel_id) / [`set_channel_id(Option<String>)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::set_channel_id):<br>required: **true**<br>Channel Id of the channel whose class should be updated.<br>
    ///   - [`destinations(OutputDestination)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::destinations) / [`set_destinations(Option<Vec::<OutputDestination>>)`](crate::operation::update_channel_class::builders::UpdateChannelClassFluentBuilder::set_destinations):<br>required: **false**<br>A list of output destinations for this channel.<br>
