...
impl super::Client {
    ...
    ///   - [`channel_ids(impl Into<String>)`](crate::operation::batch_stop::builders::BatchStopFluentBuilder::channel_ids) / [`set_channel_ids(Option<Vec<String>>)`](crate::operation::batch_stop::builders::BatchStopFluentBuilder::set_channel_ids): List of channel IDs
    ///   - [`multiplex_ids(impl Into<String>)`](crate::operation::batch_stop::builders::BatchStopFluentBuilder::multiplex_ids) / [`set_multiplex_ids(Option<Vec<String>>)`](crate::operation::batch_stop::builders::BatchStopFluentBuilder::set_multiplex_ids): List of multiplex IDs
