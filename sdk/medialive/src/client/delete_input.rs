...
impl super::Client {
    ...
    ///   - [`input_id(impl Into<String>)`](crate::operation::delete_input::builders::DeleteInputFluentBuilder::input_id) / [`set_input_id(Option<String>)`](crate::operation::delete_input::builders::DeleteInputFluentBuilder::set_input_id):<br>required: **true**<br>Unique ID of the input<br>
