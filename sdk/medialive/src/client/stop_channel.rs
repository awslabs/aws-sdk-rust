...
impl super::Client {
    ...
    ///   - [`channel_id(impl ::std::convert::Into<String>)`](crate::operation::stop_channel::builders::StopChannelFluentBuilder::channel_id) / [`set_channel_id(Option<String>)`](crate::operation::stop_channel::builders::StopChannelFluentBuilder::set_channel_id): A request to stop a running channel
    ...
    ///   - [`pipelines_running_count(Option<i32>)`](crate::operation::stop_channel::StopChannelOutput::pipelines_running_count): The number of currently healthy pipelines.
