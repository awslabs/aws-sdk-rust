...
impl super::Client {
    ...
    ///   - [`channel_id(impl Into<String>)`](crate::operation::start_channel::builders::StartChannelFluentBuilder::channel_id) / [`set_channel_id(Option<String>)`](crate::operation::start_channel::builders::StartChannelFluentBuilder::set_channel_id):<br>required: **true**<br>A request to start a channel<br>
    ...
    ///   - [`inference_settings(Option<DescribeInferenceSettings>)`](crate::operation::start_channel::StartChannelOutput::inference_settings): Include this setting to include Elemental Inference features in this channel.
