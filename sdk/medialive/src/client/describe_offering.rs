...
impl super::Client {
    ...
    ///   - [`offering_id(impl Into<String>)`](crate::operation::describe_offering::builders::DescribeOfferingFluentBuilder::offering_id) / [`set_offering_id(Option<String>)`](crate::operation::describe_offering::builders::DescribeOfferingFluentBuilder::set_offering_id):<br>required: **true**<br>Unique offering ID, e.g. '87654321'<br>
