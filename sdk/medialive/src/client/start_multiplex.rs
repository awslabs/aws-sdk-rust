...
impl super::Client {
    ...
    ///   - [`multiplex_id(impl ::std::convert::Into<String>)`](crate::operation::start_multiplex::builders::StartMultiplexFluentBuilder::multiplex_id) / [`set_multiplex_id(Option<String>)`](crate::operation::start_multiplex::builders::StartMultiplexFluentBuilder::set_multiplex_id): The ID of the multiplex.
    ...
    pub fn start_multiplex(
        &self,
    ) -> crate::operation::start_multiplex::builders::StartMultiplexFluentBuilder {
        crate::operation::start_multiplex::builders::StartMultiplexFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
