...
impl super::Client {
    ...
    ///   - [`input_device_id(impl Into<String>)`](crate::operation::stop_input_device::builders::StopInputDeviceFluentBuilder::input_device_id) / [`set_input_device_id(Option<String>)`](crate::operation::stop_input_device::builders::StopInputDeviceFluentBuilder::set_input_device_id): The unique ID of the input device to reboot. For example, hd-123456789abcdef.
