...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_input_security_groups::builders::ListInputSecurityGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_input_security_groups::builders::ListInputSecurityGroupsFluentBuilder::set_max_results): Placeholder documentation for MaxResults
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_input_security_groups::builders::ListInputSecurityGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_input_security_groups::builders::ListInputSecurityGroupsFluentBuilder::set_next_token): Placeholder documentation for __string
