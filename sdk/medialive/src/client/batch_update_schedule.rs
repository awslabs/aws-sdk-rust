...
impl super::Client {
    ...
    ///   - [`channel_id(impl Into<String>)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::channel_id) / [`set_channel_id(Option<String>)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::set_channel_id):<br>required: **true**<br>Id of the channel whose schedule is being updated.<br>
    ///   - [`creates(BatchScheduleActionCreateRequest)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::creates) / [`set_creates(Option<BatchScheduleActionCreateRequest>)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::set_creates):<br>required: **false**<br>Schedule actions to create in the schedule.<br>
    ///   - [`deletes(BatchScheduleActionDeleteRequest)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::deletes) / [`set_deletes(Option<BatchScheduleActionDeleteRequest>)`](crate::operation::batch_update_schedule::builders::BatchUpdateScheduleFluentBuilder::set_deletes):<br>required: **false**<br>Schedule actions to delete from the schedule.<br>
