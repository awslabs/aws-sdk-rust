...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::claim_device::builders::ClaimDeviceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::claim_device::builders::ClaimDeviceFluentBuilder::set_id):<br>required: **false**<br>The id of the device you want to claim.<br>
