...
impl super::Client {
    ...
    ///   - [`program_name(impl ::std::convert::Into<String>)`](crate::operation::update_multiplex_program::builders::UpdateMultiplexProgramFluentBuilder::program_name) / [`set_program_name(Option<String>)`](crate::operation::update_multiplex_program::builders::UpdateMultiplexProgramFluentBuilder::set_program_name): The name of the program to update.
