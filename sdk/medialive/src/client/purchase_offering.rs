...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::set_tags): A collection of key-value pairs
