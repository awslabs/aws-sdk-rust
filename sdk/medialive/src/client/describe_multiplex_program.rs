...
impl super::Client {
    ...
    ///   - [`multiplex_id(impl ::std::convert::Into<String>)`](crate::operation::describe_multiplex_program::builders::DescribeMultiplexProgramFluentBuilder::multiplex_id) / [`set_multiplex_id(Option<String>)`](crate::operation::describe_multiplex_program::builders::DescribeMultiplexProgramFluentBuilder::set_multiplex_id): The ID of the multiplex that the program belongs to.
    ///   - [`program_name(impl ::std::convert::Into<String>)`](crate::operation::describe_multiplex_program::builders::DescribeMultiplexProgramFluentBuilder::program_name) / [`set_program_name(Option<String>)`](crate::operation::describe_multiplex_program::builders::DescribeMultiplexProgramFluentBuilder::set_program_name): The name of the program.
