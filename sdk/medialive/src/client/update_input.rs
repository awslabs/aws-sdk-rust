...
impl super::Client {
    ...
    ///   - [`destinations(InputDestinationRequest)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::destinations) / [`set_destinations(Option<Vec<InputDestinationRequest>>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_destinations): Destination settings for PUSH type inputs.
    ///   - [`input_devices(InputDeviceRequest)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::input_devices) / [`set_input_devices(Option<Vec<InputDeviceRequest>>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_input_devices): Settings for the devices.
    ...
    ///   - [`media_connect_flows(MediaConnectFlowRequest)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::media_connect_flows) / [`set_media_connect_flows(Option<Vec<MediaConnectFlowRequest>>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_media_connect_flows): A list of the MediaConnect Flow ARNs that you want to use as the source of the input. You can specify as few as one Flow and presently, as many as two. The only requirement is when you have more than one is that each Flow is in a separate Availability Zone as this ensures your EML input is redundant to AZ issues.
