...
impl Client  {
    ...
    pub fn start_input_device_maintenance_window(&self) -> fluent_builders::StartInputDeviceMaintenanceWindow {
...
pub mod fluent_builders {
    ...
    impl CreateChannel  {
        ...
        #[deprecated]pub fn reserved(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.reserved(input.into());
            self
        }
        /// Deprecated field that's only usable by whitelisted customers.
        #[deprecated]pub fn set_reserved(mut self, input: std::option::Option<std::string::String>) -> Self {
