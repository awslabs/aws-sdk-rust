...
impl StopInputDeviceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_input_device::StopInputDeviceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::stop_input_device::StopInputDeviceInput {
