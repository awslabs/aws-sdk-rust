...
impl CreateInputSecurityGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_input_security_group::CreateInputSecurityGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInputSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_input_security_group::de_create_input_security_group_http_response_with_props(status, headers, body)
        }
    }
}
