...
impl RebootInputDeviceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reboot_input_device::ser_reboot_input_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootInputDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_input_device::de_reboot_input_device_http_response_with_props(status, headers, body)
        }
    }
}
