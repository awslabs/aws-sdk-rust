...
/// Orchestration and serialization glue logic for `RebootInputDevice`.
...
impl RebootInputDevice {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::reboot_input_device::RebootInputDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_input_device::RebootInputDeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reboot_input_device::RebootInputDeviceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reboot_input_device::RebootInputDeviceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RebootInputDevice {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RebootInputDevice");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RebootInputDeviceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RebootInputDeviceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RebootInputDevice")
...
.with_interceptor(RebootInputDeviceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reboot_input_device::RebootInputDeviceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reboot_input_device::RebootInputDeviceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reboot_input_device::RebootInputDeviceError>::new());
...
#[derive(Debug)]
            struct RebootInputDeviceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RebootInputDeviceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reboot_input_device::de_reboot_input_device_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reboot_input_device::de_reboot_input_device_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RebootInputDeviceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RebootInputDeviceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reboot_input_device::RebootInputDeviceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reboot_input_device::RebootInputDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/prod/inputDevices/{InputDeviceId}/reboot", InputDeviceId = input_device_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reboot_input_device::ser_reboot_input_device_input(&input)?);
...
#[derive(Debug)]
            struct RebootInputDeviceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RebootInputDeviceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RebootInputDeviceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RebootInputDeviceInput>()
                        .ok_or("failed to downcast to RebootInputDeviceInput")?;
...
pub enum RebootInputDeviceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RebootInputDeviceError) for what information is available for the error.")]
...
impl RebootInputDeviceError {
    /// Creates the `RebootInputDeviceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RebootInputDeviceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RebootInputDeviceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reboot_input_device::RebootInputDeviceError {
...
mod _reboot_input_device_output;
