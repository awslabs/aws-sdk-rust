...
impl StartInputDeviceMaintenanceWindowInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_input_device_maintenance_window::StartInputDeviceMaintenanceWindow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartInputDeviceMaintenanceWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_input_device_maintenance_window::de_start_input_device_maintenance_window_http_response_with_props(
                status, headers, body,
            )
        }
    }
