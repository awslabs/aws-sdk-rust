...
impl DeleteInputSecurityGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_input_security_group::DeleteInputSecurityGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInputSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_input_security_group::de_delete_input_security_group_http_response_with_props(status, headers, body)
        }
    }
}
