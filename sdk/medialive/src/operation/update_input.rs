...
impl UpdateInputInput {
    /// Consumes the builder and constructs an Operation<[`UpdateInput`](crate::operation::update_input::UpdateInput)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_input::UpdateInput, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_input::UpdateInputInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.input_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("input_id", "cannot be empty or unset"))?;
                let input_id = aws_smithy_http::label::fmt_string(input_1, aws_smithy_http::label::EncodingStrategy::Default);
                if input_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("input_id", "cannot be empty or unset"))
                            }
                write!(output, "/prod/inputs/{InputId}", InputId = input_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_input::ser_update_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_input::UpdateInput::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateInput", "medialive"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateInput {
                type Output = std::result::Result<crate::operation::update_input::UpdateInputOutput, crate::operation::update_input::UpdateInputError>;
