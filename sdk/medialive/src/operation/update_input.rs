    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/prod/inputs/{InputId}", InputId = input_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_input::UpdateInput::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInput {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_input::de_update_input_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_input::de_update_input_http_response_with_props(
                status, headers, body,
            )
        }
    }
