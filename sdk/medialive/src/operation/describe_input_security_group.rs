...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInputSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_input_security_group::de_describe_input_security_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_input_security_group::DescribeInputSecurityGroupError
{
