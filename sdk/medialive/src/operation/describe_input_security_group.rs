...
impl DescribeInputSecurityGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_input_security_group::DescribeInputSecurityGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInputSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_input_security_group::de_describe_input_security_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
