...
impl ListInputSecurityGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_input_security_groups::ListInputSecurityGroupsInput,
                    ) -> ::std::result::Result<crate::operation::list_input_security_groups::ListInputSecurityGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_input_security_groups::ListInputSecurityGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_input_security_groups::ListInputSecurityGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_input_security_groups::ListInputSecurityGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListInputSecurityGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListInputSecurityGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListInputSecurityGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListInputSecurityGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListInputSecurityGroups")
...
.with_interceptor(ListInputSecurityGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_input_security_groups::ListInputSecurityGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_input_security_groups::ListInputSecurityGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_input_security_groups::ListInputSecurityGroupsError>::new());
...
#[derive(Debug)]
            struct ListInputSecurityGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListInputSecurityGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_input_security_groups::de_list_input_security_groups_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListInputSecurityGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListInputSecurityGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_input_security_groups::ListInputSecurityGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_input_security_groups::ListInputSecurityGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/prod/inputSecurityGroups").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_input_security_groups::ListInputSecurityGroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListInputSecurityGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListInputSecurityGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListInputSecurityGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListInputSecurityGroupsInput>()
                        .ok_or("failed to downcast to ListInputSecurityGroupsInput")?;
...
pub enum ListInputSecurityGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListInputSecurityGroupsError) for what information is available for the error.")]
...
impl ListInputSecurityGroupsError {
    /// Creates the `ListInputSecurityGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListInputSecurityGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListInputSecurityGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_input_security_groups::ListInputSecurityGroupsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_input_security_groups::_list_input_security_groups_output::ListInputSecurityGroupsOutput;

pub use crate::operation::list_input_security_groups::_list_input_security_groups_input::ListInputSecurityGroupsInput;

mod _list_input_security_groups_input;

mod _list_input_security_groups_output;
