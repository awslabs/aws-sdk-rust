...
impl crate::operation::describe_input_device_thumbnail::builders::DescribeInputDeviceThumbnailInputBuilder {
...
impl DescribeInputDeviceThumbnailFluentBuilder {
    /// Creates a new `DescribeInputDeviceThumbnailFluentBuilder`.
