...
impl DeleteScheduleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_schedule::DeleteSchedule,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_schedule::DeleteSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_schedule::de_delete_schedule_http_error(
                status, headers, body,
            )
        } else {
