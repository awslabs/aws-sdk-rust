...
impl CreateMultiplexInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_multiplex::CreateMultiplex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_multiplex::de_create_multiplex_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_multiplex::CreateMultiplexError
{
