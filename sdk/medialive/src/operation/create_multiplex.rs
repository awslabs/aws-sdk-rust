...
impl CreateMultiplexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_multiplex::CreateMultiplex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_multiplex::ser_create_multiplex_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_multiplex::de_create_multiplex_http_response_with_props(status, headers, body)
        }
    }
}
