...
impl StopChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_channel::StopChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_channel::de_stop_channel_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_channel::de_stop_channel_http_response_with_props(
                status, headers, body,
            )
        }
    }
