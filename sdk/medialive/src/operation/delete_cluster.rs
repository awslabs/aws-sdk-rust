...
impl DeleteCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("medialive", "DeleteCluster", input, runtime_plugins, stop_point).await
    }
...
impl DeleteClusterError {
    ...
    /// Returns `true` if the error kind is `DeleteClusterError::BadGatewayException`.
    ...
    /// Returns `true` if the error kind is `DeleteClusterError::GatewayTimeoutException`.
    ...
    /// Returns `true` if the error kind is `DeleteClusterError::TooManyRequestsException`.
