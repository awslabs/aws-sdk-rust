...
impl ClaimDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::claim_device::ClaimDevice,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::claim_device::ClaimDevice::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClaimDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_claim_device::de_claim_device_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_claim_device::de_claim_device_http_response_with_props(
                status, headers, body,
            )
        }
    }
