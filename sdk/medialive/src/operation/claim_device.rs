...
impl ClaimDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::claim_device::ClaimDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_claim_device::ser_claim_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClaimDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_claim_device::de_claim_device_http_response_with_props(status, headers, body)
        }
    }
}
