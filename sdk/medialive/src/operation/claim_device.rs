...
impl ClaimDeviceInput {
    /// Consumes the builder and constructs an Operation<[`ClaimDevice`](crate::operation::claim_device::ClaimDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::claim_device::ClaimDevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::claim_device::ClaimDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_claim_device::ser_claim_device_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::claim_device::ClaimDevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ClaimDevice", "medialive"));
...
impl aws_smithy_http::response::ParseStrictResponse for ClaimDevice {
                type Output = std::result::Result<crate::operation::claim_device::ClaimDeviceOutput, crate::operation::claim_device::ClaimDeviceError>;
