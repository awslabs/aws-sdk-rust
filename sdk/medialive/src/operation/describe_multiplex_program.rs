...
impl DescribeMultiplexProgramInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_multiplex_program::DescribeMultiplexProgram,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMultiplexProgram {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_multiplex_program::de_describe_multiplex_program_http_response_with_props(status, headers, body)
        }
    }
}
