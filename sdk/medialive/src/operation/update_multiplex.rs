...
impl UpdateMultiplexInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_multiplex::UpdateMultiplex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_multiplex::de_update_multiplex_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_multiplex::UpdateMultiplexError
{
