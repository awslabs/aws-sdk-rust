...
impl UpdateMultiplexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_multiplex::UpdateMultiplex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_multiplex::ser_update_multiplex_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMultiplex {
    type Output =
        ::std::result::Result<crate::operation::update_multiplex::UpdateMultiplexOutput, crate::operation::update_multiplex::UpdateMultiplexError>;
