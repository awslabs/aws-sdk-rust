...
impl CancelInputDeviceTransferInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.cancel_input_device_transfer();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferOutput,
                    crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError,
                > for CancelInputDeviceTransferFluentBuilder
            {
                fn send(
                    self,
...
impl CancelInputDeviceTransferFluentBuilder {
    ...
    /// Access the CancelInputDeviceTransfer as a reference.
    pub fn as_input(&self) -> &crate::operation::cancel_input_device_transfer::builders::CancelInputDeviceTransferInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::cancel_input_device_transfer::CancelInputDeviceTransfer::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::cancel_input_device_transfer::CancelInputDeviceTransfer::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferOutput, crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError, Self> {
