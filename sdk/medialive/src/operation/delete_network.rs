...
impl DeleteNetwork {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaLive", "DeleteNetwork", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/prod/networks/{NetworkId}", NetworkId = network_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl DeleteNetworkError {
    ...
    /// Returns `true` if the error kind is `DeleteNetworkError::BadGatewayException`.
    pub fn is_bad_gateway_exception(&self) -> bool {
        matches!(self, Self::BadGatewayException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::GatewayTimeoutException`.
    pub fn is_gateway_timeout_exception(&self) -> bool {
        matches!(self, Self::GatewayTimeoutException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteNetworkError::TooManyRequestsException`.
