...
impl CreateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaLive", "CreateCluster", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_cluster::CreateClusterInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("InstanceRoleArn") {
            if let ::std::option::Option::Some(value) = input.instance_role_arn.as_deref() {
                captured.insert("InstanceRoleArn", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/prod/clusters").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateClusterError {
    ...
    /// Returns `true` if the error kind is `CreateClusterError::BadGatewayException`.
    ...
    /// Returns `true` if the error kind is `CreateClusterError::GatewayTimeoutException`.
