...
impl BatchStopFluentBuilder  {
    /// Creates a new `BatchStop`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::batch_stop::BatchStopOutput, aws_smithy_http::result::SdkError<crate::operation::batch_stop::BatchStopError>>
                     {
