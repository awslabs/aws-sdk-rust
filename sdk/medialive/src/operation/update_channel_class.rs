...
impl UpdateChannelClassInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_channel_class::ser_update_channel_class_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_channel_class::UpdateChannelClass::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_channel_class::UpdateChannelClassError
{
