...
impl RejectInputDeviceTransferInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferInput, ::aws_smithy_types::error::operation::BuildError> {
