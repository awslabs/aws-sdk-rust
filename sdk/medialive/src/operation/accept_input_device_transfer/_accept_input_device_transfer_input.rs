...
impl AcceptInputDeviceTransferInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput, ::aws_smithy_types::error::operation::BuildError> {
