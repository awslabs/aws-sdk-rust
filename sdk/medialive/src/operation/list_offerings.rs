...
impl ListOfferingsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_offerings::ListOfferings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_offerings::ListOfferingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_offerings::ListOfferingsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_5) = &_input.maximum_bitrate {
                     {
                        query.push_kv("maximumBitrate", &aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                if let Some(inner_6) = &_input.maximum_framerate {
                     {
                        query.push_kv("maximumFramerate", &aws_smithy_http::query::fmt_string(&inner_6));
                    }
                }
                ...
                if let Some(inner_9) = &_input.resource_type {
                     {
                        query.push_kv("resourceType", &aws_smithy_http::query::fmt_string(&inner_9));
                    }
                }
                if let Some(inner_10) = &_input.special_feature {
                     {
                        query.push_kv("specialFeature", &aws_smithy_http::query::fmt_string(&inner_10));
                    }
                }
                if let Some(inner_11) = &_input.video_quality {
                     {
                        query.push_kv("videoQuality", &aws_smithy_http::query::fmt_string(&inner_11));
                    }
                }
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_offerings::ListOfferings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOfferings", "medialive"));
