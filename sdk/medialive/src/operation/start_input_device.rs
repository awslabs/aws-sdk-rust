    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartInputDevice")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(StartInputDeviceEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for StartInputDeviceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StartInputDeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("input_device_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartInputDeviceEndpointParamsInterceptor {
...
pub type StartInputDeviceErrorKind = StartInputDeviceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartInputDeviceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_input_device::StartInputDeviceError {
...
impl StartInputDeviceError {
    ...
    /// Creates the `StartInputDeviceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
