...
impl DescribeMultiplexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_multiplex::DescribeMultiplex,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_multiplex::de_describe_multiplex_http_response_with_props(status, headers, body)
        }
    }
}
