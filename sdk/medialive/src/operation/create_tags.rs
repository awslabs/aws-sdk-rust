...
impl CreateTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_tags::CreateTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_tags::ser_create_tags_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_create_tags::de_create_tags_http_response_with_props(status, headers, body)
        }
    }
}
