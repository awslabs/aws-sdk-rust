...
impl DescribeThumbnailsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeThumbnails`](crate::operation::describe_thumbnails::DescribeThumbnails)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_thumbnails::DescribeThumbnails::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeThumbnails", "medialive"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeThumbnails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_thumbnails::de_describe_thumbnails_http_response_with_props(status, headers, body)
        }
    }
}
