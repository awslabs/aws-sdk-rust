...
impl AcceptInputDeviceTransfer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AcceptInputDeviceTransfer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptInputDeviceTransfer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AcceptInputDeviceTransferRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AcceptInputDeviceTransferResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AcceptInputDeviceTransfer")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptInputDeviceTransfer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AcceptInputDeviceTransferTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AcceptInputDeviceTransferTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptInputDeviceTransferTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AcceptInputDeviceTransferInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptInputDeviceTransferResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_accept_input_device_transfer::de_accept_input_device_transfer_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_accept_input_device_transfer::de_accept_input_device_transfer_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptInputDeviceTransferRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput,
                ...
                ::std::write!(output, "/prod/inputDevices/{InputDeviceId}/accept", InputDeviceId = input_device_id)
