...
impl AcceptInputDeviceTransfer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput,
                    ) -> ::std::result::Result<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptInputDeviceTransfer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptInputDeviceTransfer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptInputDeviceTransferRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptInputDeviceTransferResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptInputDeviceTransfer")
...
.with_interceptor(AcceptInputDeviceTransferEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_input_device_transfer::de_accept_input_device_transfer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_input_device_transfer::de_accept_input_device_transfer_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptInputDeviceTransferRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/prod/inputDevices/{InputDeviceId}/accept", InputDeviceId = input_device_id).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptInputDeviceTransferEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptInputDeviceTransferInput>()
                        .ok_or("failed to downcast to AcceptInputDeviceTransferInput")?;
...
pub enum AcceptInputDeviceTransferError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptInputDeviceTransferError) for what information is available for the error.")]
...
impl AcceptInputDeviceTransferError {
    /// Creates the `AcceptInputDeviceTransferError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptInputDeviceTransferError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptInputDeviceTransferError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::accept_input_device_transfer::_accept_input_device_transfer_output::AcceptInputDeviceTransferOutput;

pub use crate::operation::accept_input_device_transfer::_accept_input_device_transfer_input::AcceptInputDeviceTransferInput;

mod _accept_input_device_transfer_input;

mod _accept_input_device_transfer_output;
