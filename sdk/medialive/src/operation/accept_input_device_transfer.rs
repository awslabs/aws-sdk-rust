...
impl AcceptInputDeviceTransferInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::accept_input_device_transfer::AcceptInputDeviceTransfer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptInputDeviceTransfer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_input_device_transfer::de_accept_input_device_transfer_http_response_with_props(status, headers, body)
        }
    }
}
