...
impl UpdateReservationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_reservation::ser_update_reservation_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateReservation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_reservation::de_update_reservation_http_response_with_props(status, headers, body)
        }
    }
}
