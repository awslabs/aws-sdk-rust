...
impl BatchStartInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_start::BatchStart,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_start::BatchStart::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchStart {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_start::de_batch_start_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_start::de_batch_start_http_response_with_props(
                status, headers, body,
            )
        }
    }
