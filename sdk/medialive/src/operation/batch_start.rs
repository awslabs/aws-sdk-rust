...
impl BatchStartInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_start::BatchStart, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_start::ser_batch_start_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchStart {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_start::de_batch_start_http_response_with_props(status, headers, body)
        }
    }
}
