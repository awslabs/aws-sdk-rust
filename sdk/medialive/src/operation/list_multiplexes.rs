...
impl ListMultiplexesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_multiplexes::ListMultiplexes, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMultiplexes {
    type Output =
        ::std::result::Result<crate::operation::list_multiplexes::ListMultiplexesOutput, crate::operation::list_multiplexes::ListMultiplexesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_multiplexes::de_list_multiplexes_http_response_with_props(status, headers, body)
        }
    }
}
