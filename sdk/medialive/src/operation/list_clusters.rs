...
impl ListClusters {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("medialive", "ListClusters", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListClusters {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListClusters", "medialive"));
...
impl ListClustersError {
    ...
    /// Returns `true` if the error kind is `ListClustersError::BadGatewayException`.
    ...
    /// Returns `true` if the error kind is `ListClustersError::GatewayTimeoutException`.
    ...
    /// Returns `true` if the error kind is `ListClustersError::TooManyRequestsException`.
