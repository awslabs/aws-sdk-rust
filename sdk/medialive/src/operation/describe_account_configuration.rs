...
impl DescribeAccountConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccountConfiguration`](crate::operation::describe_account_configuration::DescribeAccountConfiguration)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_account_configuration::DescribeAccountConfiguration::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAccountConfiguration", "medialive"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_account_configuration::de_describe_account_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
