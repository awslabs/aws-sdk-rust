...
impl CreateInputInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_input::CreateInput::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInput {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_input::de_create_input_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_input::de_create_input_http_response_with_props(
                status, headers, body,
            )
        }
    }
