...
impl BatchDeleteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_delete::BatchDelete, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_delete::ser_batch_delete_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDelete {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete::de_batch_delete_http_response_with_props(status, headers, body)
        }
    }
}
