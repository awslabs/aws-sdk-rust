...
impl BatchDelete {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_delete::BatchDeleteError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_delete::BatchDeleteOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaLive", "BatchDelete", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "MediaLive.BatchDelete",
                "rpc.service" = "MediaLive",
                "rpc.method" = "BatchDelete",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDelete {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchDeleteResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchDelete")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("BatchDelete", "MediaLive"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDeleteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_delete::BatchDeleteInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::batch_delete::BatchDeleteInput,
