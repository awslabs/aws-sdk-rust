...
impl BatchDeleteInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_delete::BatchDelete::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDelete {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_delete::de_batch_delete_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_delete::de_batch_delete_http_response_with_props(
                status, headers, body,
            )
        }
    }
