...
impl RestartChannelPipelinesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restart_channel_pipelines::RestartChannelPipelinesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restart_channel_pipelines::RestartChannelPipelinesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restart_channel_pipelines::RestartChannelPipelinesOutput, crate::operation::restart_channel_pipelines::RestartChannelPipelinesError, Self> {
