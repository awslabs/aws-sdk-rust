...
impl RejectInputDeviceTransferInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::reject_input_device_transfer::RejectInputDeviceTransfer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectInputDeviceTransfer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_input_device_transfer::de_reject_input_device_transfer_http_response_with_props(status, headers, body)
        }
    }
}
