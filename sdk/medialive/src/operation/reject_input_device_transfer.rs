...
/// Orchestration and serialization glue logic for `RejectInputDeviceTransfer`.
...
impl RejectInputDeviceTransfer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reject_input_device_transfer::RejectInputDeviceTransferInput,
                    ) -> ::std::result::Result<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectInputDeviceTransfer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RejectInputDeviceTransfer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RejectInputDeviceTransferRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RejectInputDeviceTransferResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectInputDeviceTransfer")
...
.with_interceptor(RejectInputDeviceTransferEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError>::new());
...
#[derive(Debug)]
            struct RejectInputDeviceTransferResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectInputDeviceTransferResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reject_input_device_transfer::de_reject_input_device_transfer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reject_input_device_transfer::de_reject_input_device_transfer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RejectInputDeviceTransferRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectInputDeviceTransferRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reject_input_device_transfer::RejectInputDeviceTransferInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/prod/inputDevices/{InputDeviceId}/reject", InputDeviceId = input_device_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct RejectInputDeviceTransferEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectInputDeviceTransferEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RejectInputDeviceTransferEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RejectInputDeviceTransferInput>()
                        .ok_or("failed to downcast to RejectInputDeviceTransferInput")?;
...
pub enum RejectInputDeviceTransferError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RejectInputDeviceTransferError) for what information is available for the error.")]
...
impl RejectInputDeviceTransferError {
    /// Creates the `RejectInputDeviceTransferError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RejectInputDeviceTransferError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RejectInputDeviceTransferError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError {
...
mod _reject_input_device_transfer_output;
