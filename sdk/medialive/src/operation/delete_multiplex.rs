...
impl DeleteMultiplexInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_multiplex::DeleteMultiplex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_multiplex::de_delete_multiplex_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_multiplex::DeleteMultiplexError
{
