...
impl CreatePartnerInputInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_partner_input::ser_create_partner_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_partner_input::CreatePartnerInput::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_partner_input::CreatePartnerInputError
{
