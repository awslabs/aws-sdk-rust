...
impl CreatePartnerInputInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_partner_input::ser_create_partner_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePartnerInput {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_partner_input::de_create_partner_input_http_response_with_props(status, headers, body)
        }
    }
}
