...
impl DeleteTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_tags::DeleteTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_tags::DeleteTags::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteTags", "medialive"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_tags::de_delete_tags_http_response_with_props(status, headers, body)
        }
    }
}
