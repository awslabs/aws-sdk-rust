...
/// Orchestration and serialization glue logic for `StartMultiplex`.
...
impl StartMultiplex {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_multiplex::StartMultiplexInput,
                    ) -> ::std::result::Result<crate::operation::start_multiplex::StartMultiplexOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_multiplex::StartMultiplexError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_multiplex::StartMultiplexError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_multiplex::StartMultiplexOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMultiplex {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartMultiplex");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartMultiplexRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartMultiplexResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMultiplex")
...
.with_interceptor(StartMultiplexEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_multiplex::StartMultiplexError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_multiplex::StartMultiplexError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_multiplex::StartMultiplexError>::new());
...
#[derive(Debug)]
            struct StartMultiplexResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMultiplexResponseDeserializer {
            ...
            let parse_result = if !success && status != 202 || force_error {
                crate::protocol_serde::shape_start_multiplex::de_start_multiplex_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StartMultiplexRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartMultiplexRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_multiplex::StartMultiplexInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_multiplex::StartMultiplexInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/prod/multiplexes/{MultiplexId}/start", MultiplexId = multiplex_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct StartMultiplexEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMultiplexEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartMultiplexEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartMultiplexInput>()
                        .ok_or("failed to downcast to StartMultiplexInput")?;
...
pub enum StartMultiplexError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartMultiplexError) for what information is available for the error.")]
...
impl StartMultiplexError {
    /// Creates the `StartMultiplexError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartMultiplexError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartMultiplexError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_multiplex::StartMultiplexError {
