...
impl StartMultiplexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_multiplex::StartMultiplex, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMultiplex {
    type Output =
        ::std::result::Result<crate::operation::start_multiplex::StartMultiplexOutput, crate::operation::start_multiplex::StartMultiplexError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_start_multiplex::de_start_multiplex_http_response_with_props(status, headers, body)
        }
    }
}
