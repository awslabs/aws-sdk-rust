...
/// Orchestration and serialization glue logic for `ListInputDeviceTransfers`.
...
impl ListInputDeviceTransfers {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_input_device_transfers::ListInputDeviceTransfersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListInputDeviceTransfers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListInputDeviceTransfers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListInputDeviceTransfersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListInputDeviceTransfersResponseDeserializer));
...
.with_interceptor(ListInputDeviceTransfersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>::new());
...
#[derive(Debug)]
            struct ListInputDeviceTransfersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListInputDeviceTransfersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_input_device_transfers::de_list_input_device_transfers_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListInputDeviceTransfersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListInputDeviceTransfersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/prod/inputDeviceTransfers").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_3 = inner_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("transfer_type", "cannot be empty or unset"))?;
    if inner_3.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("transfer_type", "cannot be empty or unset"));
    }
    query.push_kv("transferType", &::aws_smithy_http::query::fmt_string(inner_3));
    ::std::result::Result::Ok(())
}
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListInputDeviceTransfersEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListInputDeviceTransfersInput>()
                        .ok_or("failed to downcast to ListInputDeviceTransfersInput")?;
...
pub enum ListInputDeviceTransfersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListInputDeviceTransfersError) for what information is available for the error.")]
...
impl ListInputDeviceTransfersError {
    /// Creates the `ListInputDeviceTransfersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListInputDeviceTransfersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListInputDeviceTransfersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_input_device_transfers::ListInputDeviceTransfersError {
...
mod _list_input_device_transfers_output;
