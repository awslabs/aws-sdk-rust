...
impl ListInputDeviceTransfersInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_input_device_transfers::ListInputDeviceTransfers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInputDeviceTransfers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_input_device_transfers::de_list_input_device_transfers_http_response_with_props(status, headers, body)
        }
    }
}
