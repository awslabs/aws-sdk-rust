...
impl ListInputDeviceTransfersInput {
    /// Consumes the builder and constructs an Operation<[`ListInputDeviceTransfers`](crate::operation::list_input_device_transfers::ListInputDeviceTransfers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_input_device_transfers::ListInputDeviceTransfers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/prod/inputDeviceTransfers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let inner_3 = inner_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("transfer_type", "cannot be empty or unset"))?;
                if inner_3.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("transfer_type", "cannot be empty or unset"));
                }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_input_device_transfers::ListInputDeviceTransfers::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListInputDeviceTransfers", "medialive"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListInputDeviceTransfers {
                type Output = std::result::Result<crate::operation::list_input_device_transfers::ListInputDeviceTransfersOutput, crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>;
