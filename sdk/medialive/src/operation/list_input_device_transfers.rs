...
impl ListInputDeviceTransfers {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListInputDeviceTransfers",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListInputDeviceTransfers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListInputDeviceTransfersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListInputDeviceTransfersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListInputDeviceTransfers")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListInputDeviceTransfers")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListInputDeviceTransfersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListInputDeviceTransfersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListInputDeviceTransfersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListInputDeviceTransfersInput>() else {
        ...
        if requested.should_capture("TransferType") {
            if let ::std::option::Option::Some(value) = input.transfer_type.as_deref() {
                captured.insert("TransferType", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListInputDeviceTransfersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_input_device_transfers::de_list_input_device_transfers_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_input_device_transfers::de_list_input_device_transfers_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListInputDeviceTransfersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_input_device_transfers::ListInputDeviceTransfersInput>()
            .expect("correct type");
