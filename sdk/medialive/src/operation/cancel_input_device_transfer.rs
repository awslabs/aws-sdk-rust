...
/// Orchestration and serialization glue logic for `CancelInputDeviceTransfer`.
...
impl CancelInputDeviceTransfer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferInput,
                    ) -> ::std::result::Result<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelInputDeviceTransfer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelInputDeviceTransfer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelInputDeviceTransferRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelInputDeviceTransferResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelInputDeviceTransfer")
...
.with_interceptor(CancelInputDeviceTransferEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError>::new());
...
#[derive(Debug)]
            struct CancelInputDeviceTransferResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelInputDeviceTransferResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_input_device_transfer::de_cancel_input_device_transfer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_cancel_input_device_transfer::de_cancel_input_device_transfer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelInputDeviceTransferRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelInputDeviceTransferRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/prod/inputDevices/{InputDeviceId}/cancel", InputDeviceId = input_device_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct CancelInputDeviceTransferEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelInputDeviceTransferEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelInputDeviceTransferEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelInputDeviceTransferInput>()
                        .ok_or("failed to downcast to CancelInputDeviceTransferInput")?;
...
pub enum CancelInputDeviceTransferError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelInputDeviceTransferError) for what information is available for the error.")]
...
impl CancelInputDeviceTransferError {
    /// Creates the `CancelInputDeviceTransferError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelInputDeviceTransferError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelInputDeviceTransferError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferError {
...
mod _cancel_input_device_transfer_output;
