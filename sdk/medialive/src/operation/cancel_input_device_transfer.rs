...
impl CancelInputDeviceTransferInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_input_device_transfer::CancelInputDeviceTransfer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelInputDeviceTransfer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_input_device_transfer::de_cancel_input_device_transfer_http_response_with_props(status, headers, body)
        }
    }
}
