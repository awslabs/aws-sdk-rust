...
impl CreateChannel {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaLive", "CreateChannel", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_channel::CreateChannelInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateChannelTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("Reserved") {
            if let ::std::option::Option::Some(value) = input.reserved.as_deref() {
                captured.insert("Reserved", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/prod/channels").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
