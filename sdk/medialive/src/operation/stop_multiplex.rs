...
impl StopMultiplexInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_multiplex::StopMultiplex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopMultiplex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_stop_multiplex::de_stop_multiplex_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_multiplex::de_stop_multiplex_http_response_with_props(
                status, headers, body,
            )
        }
    }
