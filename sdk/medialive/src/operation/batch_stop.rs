...
impl BatchStopInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_stop::BatchStop, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_stop::ser_batch_stop_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchStop {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_stop::de_batch_stop_http_response_with_props(status, headers, body)
        }
    }
}
