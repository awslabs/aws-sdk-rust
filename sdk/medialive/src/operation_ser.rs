...
pub fn serialize_operation_crate_operation_create_partner_input(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_create_partner_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn serialize_operation_crate_operation_reboot_input_device(
...
pub fn serialize_operation_crate_operation_update_channel_class(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_update_channel_class_input(
        &mut object,
        input,
    )?;
    object.finish();
