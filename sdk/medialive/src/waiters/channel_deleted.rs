...
///
/// Fluent builder for the `channel_deleted` waiter.
///
...
pub struct ChannelDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_channel::builders::DescribeChannelInputBuilder,
}
impl ChannelDeletedFluentBuilder {
    /// Creates a new `ChannelDeletedFluentBuilder`.
    ...
    ) -> ::std::result::Result<crate::waiters::channel_deleted::ChannelDeletedFinalPoll, crate::waiters::channel_deleted::WaitUntilChannelDeletedError>
    {
        let input = self
            .inner
            .build()
...
/// Successful return type for the `channel_deleted` waiter.
pub type ChannelDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_channel::DescribeChannelOutput,
...
/// Error type for the `channel_deleted` waiter.
pub type WaitUntilChannelDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_channel::DescribeChannelOutput,
    crate::operation::describe_channel::DescribeChannelError,
>;
