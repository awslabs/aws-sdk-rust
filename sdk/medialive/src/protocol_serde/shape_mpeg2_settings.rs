...
pub fn ser_mpeg2_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Mpeg2Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mpeg2_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Mpeg2Settings>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "fixedAfd" => {
                                builder = builder.set_fixed_afd(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::FixedAfd::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "scanType" => {
                                builder = builder.set_scan_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::Mpeg2ScanType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "timecodeInsertion" => {
                                builder = builder.set_timecode_insertion(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::Mpeg2TimecodeInsertionBehavior::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
