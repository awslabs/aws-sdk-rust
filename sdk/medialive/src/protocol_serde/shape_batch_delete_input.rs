...
pub fn ser_batch_delete_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchDeleteInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
