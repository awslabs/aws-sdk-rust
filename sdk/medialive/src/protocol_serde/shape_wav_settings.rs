...
pub(crate) fn de_wav_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::WavSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "codingMode" => {
                            builder = builder.set_coding_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::WavCodingMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "sampleRate" => {
