...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_input_device_thumbnail_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_input_device_thumbnail::DescribeInputDeviceThumbnailOutput, crate::operation::describe_input_device_thumbnail::DescribeInputDeviceThumbnailError> {
    #[allow(unused_mut)]
