...
pub fn de_list_versions_http_error(
    ...
    Err(match error_code {
        "BadGatewayException" => crate::operation::list_versions::ListVersionsError::BadGatewayException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "GatewayTimeoutException" => crate::operation::list_versions::ListVersionsError::GatewayTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "versions" => {
                    builder = builder.set_versions(
                        crate::protocol_serde::shape_list_of_channel_engine_version_response::de_list_of_channel_engine_version_response(tokens)?,
                    );
                }
