...
pub(crate) fn de_motion_graphics_activate_schedule_action_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::MotionGraphicsActivateScheduleActionSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
