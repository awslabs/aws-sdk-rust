...
pub fn ser_router_settings(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::RouterSettings,
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_router_destination_settings::ser_router_destination_settings(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
