...
pub(crate) fn de_hls_akamai_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::HlsAkamaiSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "httpTransferMode" => {
                            builder = builder.set_http_transfer_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsAkamaiHttpTransferMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "numRetries" => {
