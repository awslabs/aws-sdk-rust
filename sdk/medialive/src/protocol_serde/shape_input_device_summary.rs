...
pub(crate) fn de_input_device_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InputDeviceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
