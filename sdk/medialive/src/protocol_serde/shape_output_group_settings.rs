...
pub fn ser_output_group_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutputGroupSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_output_group_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OutputGroupSettings>, aws_smithy_json::deserialize::error::DeserializeError>
