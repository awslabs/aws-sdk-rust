...
> {
    ...
    Err(match error_code {
        "BadGatewayException" => {
            crate::operation::describe_channel::DescribeChannelError::BadGatewayException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "GatewayTimeoutException" => {
            crate::operation::describe_channel::DescribeChannelError::GatewayTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
