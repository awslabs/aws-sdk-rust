...
pub fn ser_input_device_configurable_settings(
    ...
    if let Some(var_2) = &input.max_bitrate {
        object.key("maxBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.latency_ms {
        object.key("latencyMs").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_5) = &input.mediaconnect_settings {
        ...
        crate::protocol_serde::shape_input_device_media_connect_configurable_settings::ser_input_device_media_connect_configurable_settings(&mut object_6, var_5)?;
        object_6.finish();
    }
