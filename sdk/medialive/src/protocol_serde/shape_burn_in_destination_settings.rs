                        ...
                        .as_ref()
                    {
                        "alignment" => {
                            builder = builder.set_alignment(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::BurnInAlignment::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "fontColor" => {
                            builder = builder.set_font_color(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::BurnInFontColor::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "outlineColor" => {
                            builder = builder.set_outline_color(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::BurnInOutlineColor::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "shadowColor" => {
                            builder = builder.set_shadow_color(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::BurnInShadowColor::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
