...
pub fn ser_burn_in_destination_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BurnInDestinationSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
