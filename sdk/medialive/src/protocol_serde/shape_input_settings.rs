...
pub fn ser_input_settings(
    ...
    if let Some(var_11) = &input.filter_strength {
        object.key("filterStrength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    ...
    if let Some(var_15) = &input.scte35_pid {
        object.key("scte35Pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "audioSelectors" => {
                                builder = builder.set_audio_selectors(
                                    crate::protocol_serde::shape_list_of_audio_selector::de_list_of_audio_selector(tokens)?
                                );
                            }
                            "captionSelectors" => {
