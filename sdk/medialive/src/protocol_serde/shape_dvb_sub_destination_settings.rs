...
pub fn ser_dvb_sub_destination_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DvbSubDestinationSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_dvb_sub_destination_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DvbSubDestinationSettings>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_alignment(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::DvbSubDestinationAlignment::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "backgroundColor" => {
                                builder = builder.set_background_color(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::DvbSubDestinationBackgroundColor::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "fontColor" => {
                                builder = builder.set_font_color(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::DvbSubDestinationFontColor::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "outlineColor" => {
                                builder = builder.set_outline_color(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::DvbSubDestinationOutlineColor::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "shadowColor" => {
                                builder = builder.set_shadow_color(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::DvbSubDestinationShadowColor::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
