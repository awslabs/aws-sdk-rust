...
pub(crate) fn de_dvb_sub_destination_settings<'a, I>(
    ...
    Option<crate::types::DvbSubDestinationSettings>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_alignment(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubDestinationAlignment::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "backgroundColor" => {
                                builder = builder.set_background_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubDestinationBackgroundColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "fontColor" => {
                                builder = builder.set_font_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubDestinationFontColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "outlineColor" => {
                                builder = builder.set_outline_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubDestinationOutlineColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "shadowColor" => {
                                builder = builder.set_shadow_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubDestinationShadowColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
