...
pub fn ser_frame_capture_group_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FrameCaptureGroupSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_frame_capture_group_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::FrameCaptureGroupSettings>, aws_smithy_json::deserialize::error::DeserializeError>
