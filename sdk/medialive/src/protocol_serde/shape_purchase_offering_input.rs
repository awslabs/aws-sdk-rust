...
pub fn ser_purchase_offering_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PurchaseOfferingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
