                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "durationUnits" => {
                            builder = builder.set_duration_units(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::OfferingDurationUnits::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "end" => {
                        ...
                        "renewalSettings" => {
                            builder =
                                builder.set_renewal_settings(crate::protocol_serde::shape_renewal_settings::de_renewal_settings(tokens, _value)?);
                        }
                        "reservationId" => {
                        ...
                        "state" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ReservationState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "tags" => {
