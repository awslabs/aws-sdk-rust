...
pub fn ser_embedded_source_settings(
    ...
    if let Some(var_3) = &input.source608_channel_number {
        object.key("source608ChannelNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    if let Some(var_4) = &input.source608_track_number {
        object.key("source608TrackNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    Ok(())
}
