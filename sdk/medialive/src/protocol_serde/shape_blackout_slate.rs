            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "blackoutSlateImage" => {
                            builder = builder.set_blackout_slate_image(crate::protocol_serde::shape_input_location::de_input_location(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "networkEndBlackoutImage" => {
                            builder = builder.set_network_end_blackout_image(crate::protocol_serde::shape_input_location::de_input_location(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
