...
pub fn ser_blackout_slate(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BlackoutSlate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_blackout_slate<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BlackoutSlate>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::blackout_slate::Builder::default();
            loop {
                match tokens.next().transpose()? {
                                ...
                                builder = builder.set_network_end_blackout(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::BlackoutSlateNetworkEndBlackout::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
