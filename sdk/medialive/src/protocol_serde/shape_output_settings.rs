...
pub fn ser_output_settings(
    ...
    if let Some(var_1) = &input.archive_output_settings {
        ...
        crate::protocol_serde::shape_archive_output_settings::ser_archive_output_settings(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_5) = &input.hls_output_settings {
        ...
        crate::protocol_serde::shape_hls_output_settings::ser_hls_output_settings(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
    ...
    if let Some(var_9) = &input.ms_smooth_output_settings {
        ...
        crate::protocol_serde::shape_ms_smooth_output_settings::ser_ms_smooth_output_settings(
            &mut object_10,
            var_9,
        )?;
        object_10.finish();
    ...
    if let Some(var_11) = &input.multiplex_output_settings {
        ...
        crate::protocol_serde::shape_multiplex_output_settings::ser_multiplex_output_settings(
            &mut object_12,
            var_11,
        )?;
        object_12.finish();
    ...
    if let Some(var_13) = &input.rtmp_output_settings {
        ...
        crate::protocol_serde::shape_rtmp_output_settings::ser_rtmp_output_settings(
            &mut object_14,
            var_13,
        )?;
        object_14.finish();
    ...
    if let Some(var_15) = &input.udp_output_settings {
        ...
        crate::protocol_serde::shape_udp_output_settings::ser_udp_output_settings(
            &mut object_16,
            var_15,
        )?;
        object_16.finish();
...
pub(crate) fn de_output_settings<'a, I>(
    ...
    Option<crate::types::OutputSettings>,
