...
pub fn ser_avail_settings(
    ...
    if let Some(var_3) = &input.scte35_splice_insert {
        ...
        crate::protocol_serde::shape_scte35_splice_insert::ser_scte35_splice_insert(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.scte35_time_signal_apos {
        ...
        crate::protocol_serde::shape_scte35_time_signal_apos::ser_scte35_time_signal_apos(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
...
pub(crate) fn de_avail_settings<'a, I>(
    ...
    Option<crate::model::AvailSettings>,
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "esam" => {
                                builder = builder
                                    .set_esam(crate::protocol_serde::shape_esam::de_esam(tokens)?);
                            }
                            "scte35SpliceInsert" => {
