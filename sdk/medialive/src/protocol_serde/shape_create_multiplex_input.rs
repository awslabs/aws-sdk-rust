...
pub fn ser_create_multiplex_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMultiplexInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
