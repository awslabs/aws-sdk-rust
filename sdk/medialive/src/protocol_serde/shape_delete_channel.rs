            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_gateway_exception::de_bad_gateway_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_channel::DeleteChannelError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_gateway_timeout_exception::de_gateway_timeout_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_channel::DeleteChannelError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_delete_channel_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_channel::DeleteChannelOutput, crate::operation::delete_channel::DeleteChannelError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_channel::de_delete_channel(response.body().as_ref(), output).map_err(crate::operation::delete_channel::DeleteChannelError::unhandled)?;
