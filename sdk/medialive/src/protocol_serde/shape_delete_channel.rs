            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_gateway_exception::de_bad_gateway_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteChannelError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_gateway_timeout_exception::de_gateway_timeout_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteChannelError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_delete_channel_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteChannelOutput, crate::error::DeleteChannelError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_channel::de_delete_channel(response.body().as_ref(), output).map_err(crate::error::DeleteChannelError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_channel(value: &[u8], mut builder: crate::output::delete_channel_output::Builder) -> Result<crate::output::delete_channel_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
