...
pub fn de_update_cluster_http_error(
    ...
    Err(match error_code {
        "BadGatewayException" => crate::operation::update_cluster::UpdateClusterError::BadGatewayException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => crate::operation::update_cluster::UpdateClusterError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ForbiddenException" => crate::operation::update_cluster::UpdateClusterError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "GatewayTimeoutException" => crate::operation::update_cluster::UpdateClusterError::GatewayTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::update_cluster::UpdateClusterError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::update_cluster::UpdateClusterError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "channelIds" => {
                    builder = builder.set_channel_ids(crate::protocol_serde::shape_list_of_string::de_list_of_string(tokens, _value, depth + 1)?);
                }
                "clusterType" => {
