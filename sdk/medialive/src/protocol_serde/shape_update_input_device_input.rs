...
pub fn ser_update_input_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateInputDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
