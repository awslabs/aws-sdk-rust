...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnprocessableEntityException" => {
            crate::operation::accept_input_device_transfer::AcceptInputDeviceTransferError::UnprocessableEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
