...
pub(crate) fn de_hls_webdav_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::HlsWebdavSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "httpTransferMode" => {
                            builder = builder.set_http_transfer_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsWebdavHttpTransferMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "numRetries" => {
