...
pub(crate) fn de_caption_language_mapping<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::CaptionLanguageMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
