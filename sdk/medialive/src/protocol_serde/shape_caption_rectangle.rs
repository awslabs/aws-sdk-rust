...
pub fn ser_caption_rectangle(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CaptionRectangle) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
