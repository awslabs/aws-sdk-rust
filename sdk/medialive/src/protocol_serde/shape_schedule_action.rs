                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "scheduleActionSettings" => {
                            builder = builder.set_schedule_action_settings(
                                crate::protocol_serde::shape_schedule_action_settings::de_schedule_action_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        "scheduleActionStartSettings" => {
                            builder = builder.set_schedule_action_start_settings(
                                crate::protocol_serde::shape_schedule_action_start_settings::de_schedule_action_start_settings(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
