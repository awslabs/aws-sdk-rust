...
pub(crate) fn de_schedule_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ScheduleAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
