...
pub(crate) fn de_input_device_hd_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InputDeviceHdSettings>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "configuredInput" => {
                                builder = builder.set_configured_input(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::InputDeviceConfiguredInput::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
