...
pub(crate) fn de_input_device_hd_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::InputDeviceHdSettings>, aws_smithy_json::deserialize::error::DeserializeError>
