...
pub fn de_update_input_device_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_input_device::UpdateInputDeviceOutput, crate::operation::update_input_device::UpdateInputDeviceError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::update_input_device::UpdateInputDeviceOutput, crate::operation::update_input_device::UpdateInputDeviceError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_update_input_device::de_update_input_device(_response_body, output)
            .map_err(crate::operation::update_input_device::UpdateInputDeviceError::unhandled)?;
