...
pub(crate) fn de_multiplex_program_packet_identifiers_map<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MultiplexProgramPacketIdentifiersMap>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::multiplex_program_packet_identifiers_map::Builder::default();
            loop {
                match tokens.next().transpose()? {
