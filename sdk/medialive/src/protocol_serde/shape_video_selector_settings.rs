...
) -> Result<Option<crate::types::VideoSelectorSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "videoSelectorPid" => {
                            builder = builder.set_video_selector_pid(crate::protocol_serde::shape_video_selector_pid::de_video_selector_pid(tokens)?);
                        }
