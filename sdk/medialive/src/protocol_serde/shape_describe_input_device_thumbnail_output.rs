...
pub fn de_body_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, crate::operation::describe_input_device_thumbnail::DescribeInputDeviceThumbnailError> {
...
pub(crate) fn de_content_type_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::ContentType>, ::aws_smithy_http::header::ParseError> {
