...
pub fn de_body_payload(body: &mut aws_smithy_http::body::SdkBody) -> std::result::Result<aws_smithy_http::byte_stream::ByteStream, crate::error::DescribeInputDeviceThumbnailError> {
...
pub(crate) fn de_content_type_header(header_map: &http::HeaderMap) -> std::result::Result<std::option::Option<crate::model::ContentType>, aws_smithy_http::header::ParseError> {
