...
pub(crate) fn de_hls_input_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::HlsInputSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "scte35Source" => {
                            builder = builder.set_scte35_source(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsScte35SourceType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
