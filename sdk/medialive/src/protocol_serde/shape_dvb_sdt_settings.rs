...
pub(crate) fn de_dvb_sdt_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DvbSdtSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "outputSdt" => {
                            builder = builder.set_output_sdt(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::DvbSdtOutputSdt::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "repInterval" => {
