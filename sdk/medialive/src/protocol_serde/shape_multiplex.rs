...
) -> Result<Option<crate::types::Multiplex>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "destinations" => {
                            builder = builder.set_destinations(
                                crate::protocol_serde::shape___list_of_multiplex_output_destination::de___list_of_multiplex_output_destination(
                                    tokens,
                                )?,
                            );
                        }
