...
pub fn de_start_channel_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_start_channel::de_start_channel(_response_body, output)
            .map_err(crate::operation::start_channel::StartChannelError::unhandled)?;
...
) -> Result<crate::operation::start_channel::builders::StartChannelOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
