...
pub(crate) fn de_motion_graphics_deactivate_schedule_action_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::MotionGraphicsDeactivateScheduleActionSettings>, aws_smithy_json::deserialize::error::DeserializeError>
