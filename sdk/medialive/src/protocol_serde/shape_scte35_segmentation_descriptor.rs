...
pub fn ser_scte35_segmentation_descriptor(
    ...
    if let Some(var_3) = &input.segment_num {
        object.key("segmentNum").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_5) = &input.segmentation_duration {
        object.key("segmentationDuration").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.segmentation_event_id {
        object.key("segmentationEventId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.segmentation_type_id {
        object.key("segmentationTypeId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    ...
    if let Some(var_9) = &input.segmentation_upid_type {
        object.key("segmentationUpidType").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.segments_expected {
        object.key("segmentsExpected").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    if let Some(var_11) = &input.sub_segment_num {
        object.key("subSegmentNum").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.sub_segments_expected {
        object.key("subSegmentsExpected").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    Ok(())
}
