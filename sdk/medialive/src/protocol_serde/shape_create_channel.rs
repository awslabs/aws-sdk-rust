...
> {
    ...
    Err(match error_code {
        "BadGatewayException" => {
            crate::operation::create_channel::CreateChannelError::BadGatewayException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_gateway_exception::de_bad_gateway_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::create_channel::CreateChannelError::unhandled)?;
        ...
        "GatewayTimeoutException" => {
            crate::operation::create_channel::CreateChannelError::GatewayTimeoutException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_gateway_timeout_exception::de_gateway_timeout_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::create_channel::CreateChannelError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
