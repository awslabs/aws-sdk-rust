...
pub fn de_reject_input_device_transfer_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferOutput, crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError> {
    #[allow(unused_mut)]
