...
pub fn de_reject_input_device_transfer_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferOutput, crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reject_input_device_transfer_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reject_input_device_transfer::RejectInputDeviceTransferOutput, crate::operation::reject_input_device_transfer::RejectInputDeviceTransferError> {
    Ok({
        #[allow(unused_mut)]
