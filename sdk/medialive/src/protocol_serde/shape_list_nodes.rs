...
pub fn de_list_nodes_http_error(
    ...
    Err(match error_code {
        "BadGatewayException" => crate::operation::list_nodes::ListNodesError::BadGatewayException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "GatewayTimeoutException" => crate::operation::list_nodes::ListNodesError::GatewayTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::list_nodes::ListNodesError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "nodes" => {
                    builder =
                        builder.set_nodes(crate::protocol_serde::shape_list_of_describe_node_summary::de_list_of_describe_node_summary(tokens)?);
                }
