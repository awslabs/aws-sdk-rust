...
pub fn ser_esam(
    ...
    if let Some(var_2) = &input.ad_avail_offset {
        object.key("adAvailOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
...
pub(crate) fn de_esam<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Esam>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::esam_correct_errors(builder).build()))
        }
        _ => {
