...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_input_device::DescribeInputDeviceError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_input_device_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "deviceUpdateStatus" => {
                        builder = builder.set_device_update_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::DeviceUpdateStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "type" => {
                        builder = builder.set_type(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::InputDeviceType::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
