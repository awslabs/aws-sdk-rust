...
pub(crate) fn de_vpc_output_settings_description<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::VpcOutputSettingsDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
