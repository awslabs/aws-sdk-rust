...
pub fn ser_maintenance_update_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MaintenanceUpdateSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
