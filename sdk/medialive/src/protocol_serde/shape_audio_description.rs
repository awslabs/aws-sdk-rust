...
pub fn ser_audio_description(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AudioDescription) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_audio_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AudioDescription>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "audioType" => {
                                builder = builder.set_audio_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::AudioType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "audioTypeControl" => {
                                builder = builder.set_audio_type_control(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::AudioDescriptionAudioTypeControl::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "languageCodeControl" => {
                                builder = builder.set_language_code_control(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::AudioDescriptionLanguageCodeControl::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
