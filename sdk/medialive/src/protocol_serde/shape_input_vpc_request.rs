...
pub fn ser_input_vpc_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputVpcRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
