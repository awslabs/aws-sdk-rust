...
pub fn de_list_clusters_http_error(
    ...
    Err(match error_code {
        "BadGatewayException" => crate::operation::list_clusters::ListClustersError::BadGatewayException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "BadRequestException" => crate::operation::list_clusters::ListClustersError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ForbiddenException" => crate::operation::list_clusters::ListClustersError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "GatewayTimeoutException" => crate::operation::list_clusters::ListClustersError::GatewayTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::list_clusters::ListClustersError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::list_clusters::ListClustersError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "clusters" => {
                    builder = builder
                        .set_clusters(crate::protocol_serde::shape_list_of_describe_cluster_summary::de_list_of_describe_cluster_summary(tokens)?);
                }
                "nextToken" => {
