...
) -> Result<Option<crate::types::Scte35TimeSignalApos>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "noRegionalBlackoutFlag" => {
                            builder = builder.set_no_regional_blackout_flag(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::Scte35AposNoRegionalBlackoutBehavior::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
                        "webDeliveryAllowedFlag" => {
                            builder = builder.set_web_delivery_allowed_flag(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::Scte35AposWebDeliveryAllowedBehavior::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
