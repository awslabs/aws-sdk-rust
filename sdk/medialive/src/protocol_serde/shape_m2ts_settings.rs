...
pub fn ser_m2ts_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::M2tsSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_m2ts_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::M2tsSettings>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_absent_input_audio_behavior(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::M2tsAbsentInputAudioBehavior::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "arib" => {
                                builder = builder.set_arib(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::M2tsArib::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "aribCaptionsPidControl" => {
                                builder = builder.set_arib_captions_pid_control(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::M2tsAribCaptionsPidControl::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "klv" => {
                                builder = builder.set_klv(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::M2tsKlv::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "timedMetadataBehavior" => {
                                builder = builder.set_timed_metadata_behavior(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::M2tsTimedMetadataBehavior::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
