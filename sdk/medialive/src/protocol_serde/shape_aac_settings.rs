                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "inputType" => {
                            builder = builder.set_input_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AacInputType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "profile" => {
                            builder = builder.set_profile(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AacProfile::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "rateControlMode" => {
                        ...
                        "spec" => {
                            builder = builder.set_spec(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AacSpec::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "vbrQuality" => {
