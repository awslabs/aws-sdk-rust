...
pub fn ser_archive_group_settings(
    ...
    if let Some(var_5) = &input.rollover_interval {
        object.key("rolloverInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    Ok(())
}
...
pub(crate) fn de_archive_group_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ArchiveGroupSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::archive_group_settings_correct_errors(builder).build()))
        }
        _ => {
