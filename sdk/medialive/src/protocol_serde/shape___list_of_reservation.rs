...
pub(crate) fn de___list_of_reservation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Reservation>>, aws_smithy_json::deserialize::error::DeserializeError>
