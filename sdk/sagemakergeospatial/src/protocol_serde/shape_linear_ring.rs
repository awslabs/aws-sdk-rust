...
pub(crate) fn de_linear_ring<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<std::vec::Vec<f64>>>, aws_smithy_json::deserialize::error::DeserializeError>
