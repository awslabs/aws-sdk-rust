...
pub fn ser_search_raster_data_collection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchRasterDataCollectionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
