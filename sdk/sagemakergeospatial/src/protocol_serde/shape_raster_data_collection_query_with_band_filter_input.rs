...
pub fn ser_raster_data_collection_query_with_band_filter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RasterDataCollectionQueryWithBandFilterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
