...
pub fn ser_raster_data_collection_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RasterDataCollectionQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
