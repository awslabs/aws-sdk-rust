                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "PolygonGeometry" => Some(crate::types::AreaOfInterestGeometry::PolygonGeometry(
                            crate::protocol_serde::shape_polygon_geometry_input::de_polygon_geometry_input(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "MultiPolygonGeometry" => Some(crate::types::AreaOfInterestGeometry::MultiPolygonGeometry(
                            crate::protocol_serde::shape_multi_polygon_geometry_input::de_multi_polygon_geometry_input(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
