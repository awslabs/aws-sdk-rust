...
pub(crate) fn de_vector_enrichment_job_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VectorEnrichmentJobConfig>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_vector_enrichment_job_config(object_6: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VectorEnrichmentJobConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
