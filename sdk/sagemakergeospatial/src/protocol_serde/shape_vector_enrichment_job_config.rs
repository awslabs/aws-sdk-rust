...
) -> Result<Option<crate::types::VectorEnrichmentJobConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "ReverseGeocodingConfig" => Some(crate::types::VectorEnrichmentJobConfig::ReverseGeocodingConfig(
                            crate::protocol_serde::shape_reverse_geocoding_config::de_reverse_geocoding_config(tokens)?.ok_or_else(|| {
                        ...
                        "MapMatchingConfig" => Some(crate::types::VectorEnrichmentJobConfig::MapMatchingConfig(
                            crate::protocol_serde::shape_map_matching_config::de_map_matching_config(tokens)?.ok_or_else(|| {
