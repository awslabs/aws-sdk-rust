...
) -> ::std::result::Result<Option<crate::types::GeoMosaicConfigInput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "AlgorithmName" => {
                            builder = builder.set_algorithm_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AlgorithmNameGeoMosaic::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "TargetBands" => {
