...
pub fn de_get_vector_enrichment_job_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_vector_enrichment_job::GetVectorEnrichmentJobOutput, crate::operation::get_vector_enrichment_job::GetVectorEnrichmentJobError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_vector_enrichment_job_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_vector_enrichment_job::GetVectorEnrichmentJobOutput, crate::operation::get_vector_enrichment_job::GetVectorEnrichmentJobError> {
    Ok({
        #[allow(unused_mut)]
