...
pub fn ser_export_vector_enrichment_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExportVectorEnrichmentJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
