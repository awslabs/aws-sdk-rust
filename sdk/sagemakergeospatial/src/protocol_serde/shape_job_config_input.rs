...
) -> Result<Option<crate::types::JobConfigInput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        "ResamplingConfig" => Some(crate::types::JobConfigInput::ResamplingConfig(
                            crate::protocol_serde::shape_resampling_config_input::de_resampling_config_input(tokens)?.ok_or_else(|| {
                        ...
                        "TemporalStatisticsConfig" => Some(crate::types::JobConfigInput::TemporalStatisticsConfig(
                            crate::protocol_serde::shape_temporal_statistics_config_input::de_temporal_statistics_config_input(tokens)?.ok_or_else(
                                || {
                        ...
                        "CloudRemovalConfig" => Some(crate::types::JobConfigInput::CloudRemovalConfig(
                            crate::protocol_serde::shape_cloud_removal_config_input::de_cloud_removal_config_input(tokens)?.ok_or_else(|| {
                        ...
                        "ZonalStatisticsConfig" => Some(crate::types::JobConfigInput::ZonalStatisticsConfig(
                            crate::protocol_serde::shape_zonal_statistics_config_input::de_zonal_statistics_config_input(tokens)?.ok_or_else(
                                || {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
                        ...
                        "GeoMosaicConfig" => Some(crate::types::JobConfigInput::GeoMosaicConfig(
                            crate::protocol_serde::shape_geo_mosaic_config_input::de_geo_mosaic_config_input(tokens)?.ok_or_else(|| {
                        ...
                        "StackConfig" => Some(crate::types::JobConfigInput::StackConfig(
                            crate::protocol_serde::shape_stack_config_input::de_stack_config_input(tokens)?.ok_or_else(|| {
                        ...
                        "CloudMaskingConfig" => Some(crate::types::JobConfigInput::CloudMaskingConfig(
                            crate::protocol_serde::shape_cloud_masking_config_input::de_cloud_masking_config_input(tokens)?.ok_or_else(|| {
                        ...
                        "LandCoverSegmentationConfig" => Some(crate::types::JobConfigInput::LandCoverSegmentationConfig(
                            crate::protocol_serde::shape_land_cover_segmentation_config_input::de_land_cover_segmentation_config_input(tokens)?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
                                        "value for 'LandCoverSegmentationConfig' cannot be null",
                                    )
                                })?,
                        )),
                        _ => {
