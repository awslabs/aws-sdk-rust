...
pub fn ser_job_config_input(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::JobConfigInput) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::JobConfigInput::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("JobConfigInput"))
    }
    Ok(())
}
