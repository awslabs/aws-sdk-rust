...
pub(crate) fn de_vector_enrichment_job_data_source_config_input<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VectorEnrichmentJobDataSourceConfigInput>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_vector_enrichment_job_data_source_config_input(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VectorEnrichmentJobDataSourceConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
