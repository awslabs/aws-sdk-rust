...
pub(crate) fn de_vector_enrichment_job_data_source_config_input<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::VectorEnrichmentJobDataSourceConfigInput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "S3Data" => Some(crate::types::VectorEnrichmentJobDataSourceConfigInput::S3Data(
                            crate::protocol_serde::shape_vector_enrichment_job_s3_data::de_vector_enrichment_job_s3_data(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
