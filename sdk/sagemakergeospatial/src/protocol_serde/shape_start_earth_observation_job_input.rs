...
pub fn ser_start_earth_observation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartEarthObservationJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
