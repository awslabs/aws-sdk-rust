...
pub(crate) fn de_input_config_output<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::InputConfigOutput>, aws_smithy_json::deserialize::error::DeserializeError>
