...
pub fn ser_start_vector_enrichment_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_vector_enrichment_job::StartVectorEnrichmentJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
