...
pub fn ser_list_vector_enrichment_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_vector_enrichment_jobs::ListVectorEnrichmentJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
