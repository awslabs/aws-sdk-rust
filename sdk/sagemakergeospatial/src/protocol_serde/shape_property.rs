...
pub fn ser_property(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Property) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
