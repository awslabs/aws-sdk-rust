                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "EoCloudCover" => Some(crate::types::Property::EoCloudCover(
                            crate::protocol_serde::shape_eo_cloud_cover_input::de_eo_cloud_cover_input(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "ViewOffNadir" => Some(crate::types::Property::ViewOffNadir(
                            crate::protocol_serde::shape_view_off_nadir_input::de_view_off_nadir_input(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "ViewSunAzimuth" => Some(crate::types::Property::ViewSunAzimuth(
                            crate::protocol_serde::shape_view_sun_azimuth_input::de_view_sun_azimuth_input(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "ViewSunElevation" => Some(crate::types::Property::ViewSunElevation(
                            crate::protocol_serde::shape_view_sun_elevation_input::de_view_sun_elevation_input(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "Platform" => Some(crate::types::Property::Platform(
                            crate::protocol_serde::shape_platform_input::de_platform_input(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "LandsatCloudCoverLand" => Some(crate::types::Property::LandsatCloudCoverLand(
                            crate::protocol_serde::shape_landsat_cloud_cover_land_input::de_landsat_cloud_cover_land_input(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| {
                                ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'LandsatCloudCoverLand' cannot be null")
                            })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
