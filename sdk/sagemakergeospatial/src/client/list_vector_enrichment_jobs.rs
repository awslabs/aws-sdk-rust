...
impl super::Client {
    ...
    ///   - [`status_equals(impl ::std::convert::Into<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::status_equals) / [`set_status_equals(Option<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::set_status_equals): <p>A filter that retrieves only jobs with a specific status.</p>
    ...
    ///   - [`sort_by(impl ::std::convert::Into<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::sort_by) / [`set_sort_by(Option<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::set_sort_by): <p>The parameter by which to sort the results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_vector_enrichment_jobs::builders::ListVectorEnrichmentJobsFluentBuilder::set_next_token): <p>If the previous response was truncated, you receive this token. Use it in your next request to receive the next set of results.</p>
