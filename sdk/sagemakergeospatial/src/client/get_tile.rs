...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the tile operation.</p>
    ...
    ///   - [`output_format(impl ::std::convert::Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::output_format) / [`set_output_format(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_output_format): <p>The data format of the output tile. The formats include .npy, .png and .jpg.</p>
    ///   - [`time_range_filter(impl ::std::convert::Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::time_range_filter) / [`set_time_range_filter(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_time_range_filter): <p>Time range filter applied to imagery to find the images to tile.</p>
    ///   - [`property_filters(impl ::std::convert::Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::property_filters) / [`set_property_filters(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_property_filters): <p>Property filters for the imagery to tile.</p>
