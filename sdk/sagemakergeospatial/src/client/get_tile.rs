...
impl super::Client {
    ...
    ///   - [`image_assets(impl Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::image_assets) / [`set_image_assets(Option<Vec<String>>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_image_assets): <p>The particular assets or bands to tile.</p>
    ...
    ///   - [`execution_role_arn(impl Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::execution_role_arn) / [`set_execution_role_arn(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_execution_role_arn): <p>The Amazon Resource Name (ARN) of the IAM role that you specify.</p>
