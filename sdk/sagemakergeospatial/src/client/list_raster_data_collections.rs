...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_raster_data_collections::builders::ListRasterDataCollectionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_raster_data_collections::builders::ListRasterDataCollectionsFluentBuilder::set_next_token): <p>If the previous response was truncated, you receive this token. Use it in your next request to receive the next set of results.</p>
