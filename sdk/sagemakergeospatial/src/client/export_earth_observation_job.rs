...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::export_earth_observation_job::builders::ExportEarthObservationJobFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::export_earth_observation_job::builders::ExportEarthObservationJobFluentBuilder::set_arn):<br>required: **true**<br><p>The input Amazon Resource Name (ARN) of the Earth Observation job being exported.</p><br>
    ...
    ///   - [`execution_role_arn(impl Into<String>)`](crate::operation::export_earth_observation_job::builders::ExportEarthObservationJobFluentBuilder::execution_role_arn) / [`set_execution_role_arn(impl Into<String>)`](crate::operation::export_earth_observation_job::builders::ExportEarthObservationJobFluentBuilder::set_execution_role_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the IAM role that you specified for the job.</p><br>
