...
impl Builder {
    ...
    /// use aws_sdk_sagemakergeospatial::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_sagemakergeospatial::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
