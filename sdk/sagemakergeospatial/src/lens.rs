...
pub(crate) fn reflens_list_earth_observation_jobs_output_output_next_token(
...
pub(crate) fn reflens_list_raster_data_collections_output_output_next_token(
...
pub(crate) fn reflens_list_vector_enrichment_jobs_output_output_next_token(
...
pub(crate) fn reflens_search_raster_data_collection_output_output_next_token(
...
pub(crate) fn lens_list_earth_observation_jobs_output_output_earth_observation_job_summaries(
    input: crate::operation::list_earth_observation_jobs::ListEarthObservationJobsOutput,
...
pub(crate) fn lens_list_raster_data_collections_output_output_raster_data_collection_summaries(
    input: crate::operation::list_raster_data_collections::ListRasterDataCollectionsOutput,
...
pub(crate) fn lens_list_vector_enrichment_jobs_output_output_vector_enrichment_job_summaries(
    input: crate::operation::list_vector_enrichment_jobs::ListVectorEnrichmentJobsOutput,
