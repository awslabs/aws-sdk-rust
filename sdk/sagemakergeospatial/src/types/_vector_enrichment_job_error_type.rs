...
impl ::std::convert::From<&str> for VectorEnrichmentJobErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VectorEnrichmentJobErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VectorEnrichmentJobErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VectorEnrichmentJobErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VectorEnrichmentJobErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
