...
/// <p>Union representing different data sources to be used as input for an Earth Observation job.</p>
#[non_exhaustive]
#[derive(std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
pub enum EojDataSourceConfigInput {
    /// <p>The input structure for S3Data; representing the Amazon S3 location of the input data objects.</p>
