...
impl DeleteEarthObservationJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_earth_observation_job::DeleteEarthObservationJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEarthObservationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_earth_observation_job::de_delete_earth_observation_job_http_response_with_props(status, headers, body)
        }
    }
}
