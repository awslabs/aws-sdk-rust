...
impl GetRasterDataCollectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_raster_data_collection::GetRasterDataCollection,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRasterDataCollection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_raster_data_collection::de_get_raster_data_collection_http_response_with_props(status, headers, body)
        }
    }
}
