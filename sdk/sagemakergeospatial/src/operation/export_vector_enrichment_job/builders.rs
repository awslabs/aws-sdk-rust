...
impl ExportVectorEnrichmentJobInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.export_vector_enrichment_job();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobOutput,
                    crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError,
                > for ExportVectorEnrichmentJobFluentBuilder
            {
                fn send(
                    self,
...
impl ExportVectorEnrichmentJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobOutput, crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError, Self> {
