...
impl ExportVectorEnrichmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobInput, ::aws_smithy_types::error::operation::BuildError> {
