...
impl StartVectorEnrichmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_vector_enrichment_job::StartVectorEnrichmentJobInput, ::aws_smithy_types::error::operation::BuildError> {
