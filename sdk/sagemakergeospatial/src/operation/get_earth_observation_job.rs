...
impl GetEarthObservationJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_earth_observation_job::GetEarthObservationJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEarthObservationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_earth_observation_job::de_get_earth_observation_job_http_response_with_props(status, headers, body)
        }
    }
