...
impl ListRasterDataCollectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_raster_data_collections::ListRasterDataCollections,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_raster_data_collections::ListRasterDataCollections::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRasterDataCollections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_raster_data_collections::de_list_raster_data_collections_http_response_with_props(status, headers, body)
        }
    }
