...
impl StartVectorEnrichmentJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_vector_enrichment_job::StartVectorEnrichmentJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartVectorEnrichmentJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_vector_enrichment_job::de_start_vector_enrichment_job_http_response_with_props(status, headers, body)
        }
    }
}
