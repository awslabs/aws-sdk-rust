...
impl ListEarthObservationJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_earth_observation_jobs::ListEarthObservationJobsInput, ::aws_smithy_types::error::operation::BuildError> {
