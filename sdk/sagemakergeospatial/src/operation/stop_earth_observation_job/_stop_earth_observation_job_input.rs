...
impl StopEarthObservationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_earth_observation_job::StopEarthObservationJobInput, ::aws_smithy_types::error::operation::BuildError> {
