...
impl StartEarthObservationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_earth_observation_job::StartEarthObservationJobInput, ::aws_smithy_types::error::operation::BuildError> {
