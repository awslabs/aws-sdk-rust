...
impl GetTile {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SageMaker Geospatial", "GetTile", input, runtime_plugins, stop_point)
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTile")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetTileTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetTileTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTileTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetTileInput>() else {
        ...
        if requested.should_capture("TimeRangeFilter") {
            if let ::std::option::Option::Some(value) = input.time_range_filter.as_deref() {
                captured.insert("TimeRangeFilter", value);
            }
        }
        if requested.should_capture("PropertyFilters") {
            if let ::std::option::Option::Some(value) = input.property_filters.as_deref() {
                captured.insert("PropertyFilters", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTileResponseDeserializer {
    fn deserialize_streaming_with_config(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_get_tile::de_get_tile_http_response(response, _cfg),
        ))
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                query.push_kv("Target", &::aws_smithy_http::query::fmt_string(inner_6.as_str()));
                ...
                if let ::std::option::Option::Some(inner_12) = &_input.output_data_type {
                    {
                        query.push_kv("OutputDataType", &::aws_smithy_http::query::fmt_string(inner_12.as_str()));
                    }
                }
