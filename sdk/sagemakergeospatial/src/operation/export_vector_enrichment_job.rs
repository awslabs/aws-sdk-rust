...
impl ExportVectorEnrichmentJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportVectorEnrichmentJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportVectorEnrichmentJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExportVectorEnrichmentJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExportVectorEnrichmentJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportVectorEnrichmentJob")
...
.with_interceptor(ExportVectorEnrichmentJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError>::new());
...
#[derive(Debug)]
            struct ExportVectorEnrichmentJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportVectorEnrichmentJobResponseDeserializer {
...
#[derive(Debug)]
            struct ExportVectorEnrichmentJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportVectorEnrichmentJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_export_vector_enrichment_job::ser_export_vector_enrichment_job_input(&input)?);
...
#[derive(Debug)]
            struct ExportVectorEnrichmentJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportVectorEnrichmentJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExportVectorEnrichmentJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExportVectorEnrichmentJobInput>()
                        .ok_or("failed to downcast to ExportVectorEnrichmentJobInput")?;
...
pub enum ExportVectorEnrichmentJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportVectorEnrichmentJobError) for what information is available for the error.")]
...
impl ExportVectorEnrichmentJobError {
    /// Creates the `ExportVectorEnrichmentJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExportVectorEnrichmentJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportVectorEnrichmentJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError {
