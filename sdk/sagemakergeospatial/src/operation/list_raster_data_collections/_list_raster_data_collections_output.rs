...
impl  ListRasterDataCollectionsOutput  {
    ...
    pub fn raster_data_collection_summaries(&self) -> & [crate::types::RasterDataCollectionMetadata] {
        use std::ops::Deref; self.raster_data_collection_summaries.deref()
    }
    /// <p>If the previous response was truncated, you receive this token. Use it in your next request to receive the next set of results.</p>
...
impl ListRasterDataCollectionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_raster_data_collections::ListRasterDataCollectionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_raster_data_collections::ListRasterDataCollectionsOutput {
                raster_data_collection_summaries: self.raster_data_collection_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("raster_data_collection_summaries", "raster_data_collection_summaries was not specified but it is required when building ListRasterDataCollectionsOutput")
                    )?
                ,
