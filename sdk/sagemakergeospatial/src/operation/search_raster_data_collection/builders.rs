...
impl crate::operation::search_raster_data_collection::builders::SearchRasterDataCollectionInputBuilder {
...
impl SearchRasterDataCollectionFluentBuilder {
    /// Creates a new `SearchRasterDataCollectionFluentBuilder`.
