...
pub fn serialize_structure_crate_input_create_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBudgetActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNotificationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_subscriber_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSubscriberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteBudgetActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteNotificationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_subscriber_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteSubscriberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_action_histories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetActionHistoriesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_actions_for_account_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetActionsForAccountInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_actions_for_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetActionsForBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_notifications_for_account_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetNotificationsForAccountInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budget_performance_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetPerformanceHistoryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_budgets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_notifications_for_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeNotificationsForBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_subscribers_for_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSubscribersForNotificationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_execute_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteBudgetActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateBudgetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateBudgetActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNotificationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_subscriber_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSubscriberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_budget(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Budget) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_notification_with_subscribers(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NotificationWithSubscribers) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_action_threshold(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionThreshold) -> Result<(), aws_smithy_http::operation::SerializationError> {
     {
...
pub fn serialize_structure_crate_model_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Definition) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_time_period(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimePeriod) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_spend(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Spend) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_cost_types(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CostTypes) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_calculated_spend(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CalculatedSpend) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_auto_adjust_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoAdjustData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_iam_action_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IamActionDefinition) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_scp_action_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScpActionDefinition) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_ssm_action_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SsmActionDefinition) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_historical_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HistoricalOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
