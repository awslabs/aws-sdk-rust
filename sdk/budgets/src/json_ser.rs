...
pub fn serialize_structure_create_budget_input(
    ...
    if let Some(var_2) = &input.budget {
        ...
        crate::json_ser::serialize_structure_budget(&mut object_3, var_2);
        object_3.finish();
    }
        ...
        for item_6 in var_4 {
            {
                ...
                crate::json_ser::serialize_structure_notification_with_subscribers(
                    &mut object_7,
                    item_6,
                );
                object_7.finish();
...
pub fn serialize_structure_create_budget_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_12) = &input.action_threshold {
        ...
        crate::json_ser::serialize_structure_action_threshold(&mut object_13, var_12);
        object_13.finish();
    }
    if let Some(var_14) = &input.definition {
        let mut object_15 = object.key("Definition").start_object();
        crate::json_ser::serialize_structure_definition(&mut object_15, var_14);
        object_15.finish();
    }
        ...
        for item_20 in var_18 {
            {
                ...
                crate::json_ser::serialize_structure_subscriber(&mut object_21, item_20);
                object_21.finish();
            }
        }
        array_19.finish();
...
pub fn serialize_structure_create_notification_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_24) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_25, var_24);
        object_25.finish();
    }
        ...
        for item_28 in var_26 {
            {
                ...
                crate::json_ser::serialize_structure_subscriber(&mut object_29, item_28);
                object_29.finish();
            }
        }
        array_27.finish();
...
pub fn serialize_structure_create_subscriber_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_32) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_33, var_32);
        object_33.finish();
    }
    if let Some(var_34) = &input.subscriber {
        let mut object_35 = object.key("Subscriber").start_object();
        crate::json_ser::serialize_structure_subscriber(&mut object_35, var_34);
        object_35.finish();
    }
}

pub fn serialize_structure_delete_budget_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_budget_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_notification_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_43) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_44, var_43);
        object_44.finish();
    }
}

pub fn serialize_structure_delete_subscriber_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_47) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_48, var_47);
        object_48.finish();
    }
    if let Some(var_49) = &input.subscriber {
        let mut object_50 = object.key("Subscriber").start_object();
        crate::json_ser::serialize_structure_subscriber(&mut object_50, var_49);
        object_50.finish();
    }
}

pub fn serialize_structure_describe_budget_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_budget_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_budget_action_histories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_59) = &input.time_period {
        ...
        crate::json_ser::serialize_structure_time_period(&mut object_60, var_59);
        object_60.finish();
    }
...
pub fn serialize_structure_describe_budget_actions_for_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_budget_actions_for_budget_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_budget_performance_history_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_72) = &input.time_period {
        ...
        crate::json_ser::serialize_structure_time_period(&mut object_73, var_72);
        object_73.finish();
    }
...
pub fn serialize_structure_describe_budgets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_notifications_for_budget_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_subscribers_for_notification_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_85) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_86, var_85);
        object_86.finish();
    }
...
pub fn serialize_structure_execute_budget_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_budget_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_94) = &input.new_budget {
        ...
        crate::json_ser::serialize_structure_budget(&mut object_95, var_94);
        object_95.finish();
    }
}

pub fn serialize_structure_update_budget_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_100) = &input.action_threshold {
        ...
        crate::json_ser::serialize_structure_action_threshold(&mut object_101, var_100);
        object_101.finish();
    }
    if let Some(var_102) = &input.definition {
        let mut object_103 = object.key("Definition").start_object();
        crate::json_ser::serialize_structure_definition(&mut object_103, var_102);
        object_103.finish();
    }
        ...
        for item_108 in var_106 {
            {
                ...
                crate::json_ser::serialize_structure_subscriber(&mut object_109, item_108);
                object_109.finish();
            }
        }
        array_107.finish();
...
pub fn serialize_structure_update_notification_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_112) = &input.old_notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_113, var_112);
        object_113.finish();
    }
    if let Some(var_114) = &input.new_notification {
        let mut object_115 = object.key("NewNotification").start_object();
        crate::json_ser::serialize_structure_notification(&mut object_115, var_114);
        object_115.finish();
    }
}

pub fn serialize_structure_update_subscriber_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_118) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_119, var_118);
        object_119.finish();
    }
    if let Some(var_120) = &input.old_subscriber {
        let mut object_121 = object.key("OldSubscriber").start_object();
        crate::json_ser::serialize_structure_subscriber(&mut object_121, var_120);
        object_121.finish();
    }
    if let Some(var_122) = &input.new_subscriber {
        let mut object_123 = object.key("NewSubscriber").start_object();
        crate::json_ser::serialize_structure_subscriber(&mut object_123, var_122);
        object_123.finish();
    }
}

pub fn serialize_structure_budget(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_125) = &input.budget_limit {
        ...
        crate::json_ser::serialize_structure_spend(&mut object_126, var_125);
        object_126.finish();
    }
        ...
        for (key_129, value_130) in var_127 {
            {
                ...
                crate::json_ser::serialize_structure_spend(&mut object_131, value_130);
                object_131.finish();
            }
        }
        object_128.finish();
    ...
    if let Some(var_138) = &input.cost_types {
        ...
        crate::json_ser::serialize_structure_cost_types(&mut object_139, var_138);
        object_139.finish();
    }
    ...
    if let Some(var_141) = &input.time_period {
        ...
        crate::json_ser::serialize_structure_time_period(&mut object_142, var_141);
        object_142.finish();
    }
    if let Some(var_143) = &input.calculated_spend {
        let mut object_144 = object.key("CalculatedSpend").start_object();
        crate::json_ser::serialize_structure_calculated_spend(&mut object_144, var_143);
        object_144.finish();
    }
    ...
    if let Some(var_146) = &input.last_updated_time {
        object
            .key("LastUpdatedTime")
            .instant(var_146, smithy_types::instant::Format::EpochSeconds);
    }
}

pub fn serialize_structure_notification_with_subscribers(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_147) = &input.notification {
        ...
        crate::json_ser::serialize_structure_notification(&mut object_148, var_147);
        object_148.finish();
    }
        ...
        for item_151 in var_149 {
            {
                ...
                crate::json_ser::serialize_structure_subscriber(&mut object_152, item_151);
                object_152.finish();
            }
        }
        array_150.finish();
...
pub fn serialize_structure_action_threshold(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
) {
    {
        object.key("ActionThresholdValue").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((input.action_threshold_value).into()),
        );
    }
...
pub fn serialize_structure_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_154) = &input.iam_action_definition {
        ...
        crate::json_ser::serialize_structure_iam_action_definition(&mut object_155, var_154);
        object_155.finish();
    }
    if let Some(var_156) = &input.scp_action_definition {
        let mut object_157 = object.key("ScpActionDefinition").start_object();
        crate::json_ser::serialize_structure_scp_action_definition(&mut object_157, var_156);
        object_157.finish();
    }
    if let Some(var_158) = &input.ssm_action_definition {
        let mut object_159 = object.key("SsmActionDefinition").start_object();
        crate::json_ser::serialize_structure_ssm_action_definition(&mut object_159, var_158);
        object_159.finish();
    }
}
...
pub fn serialize_structure_time_period(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_166) = &input.start {
        object
            .key("Start")
            .instant(var_166, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_167) = &input.end {
        object
            .key("End")
            .instant(var_167, smithy_types::instant::Format::EpochSeconds);
    }
}

pub fn serialize_structure_spend(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cost_types(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_calculated_spend(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_181) = &input.actual_spend {
        ...
        crate::json_ser::serialize_structure_spend(&mut object_182, var_181);
        object_182.finish();
    }
    if let Some(var_183) = &input.forecasted_spend {
        let mut object_184 = object.key("ForecastedSpend").start_object();
        crate::json_ser::serialize_structure_spend(&mut object_184, var_183);
        object_184.finish();
    }
}

pub fn serialize_structure_iam_action_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_scp_action_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_ssm_action_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
