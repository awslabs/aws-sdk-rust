...
if let Some(partition_result) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if (partition_result.name()) == ("aws") {
                                if (*use_fips) == (false) {
                                if (*use_dual_stack) == (false) {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://budgets.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
    .to_string().into());
    out.insert("signingName".to_string(), "budgets"
    .to_string().into());
...
if (partition_result.name()) == ("aws-cn") {
                                if (*use_fips) == (false) {
                                if (*use_dual_stack) == (false) {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://budgets.amazonaws.com.cn"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
