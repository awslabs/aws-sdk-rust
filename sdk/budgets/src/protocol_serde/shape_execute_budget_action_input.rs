...
pub fn ser_execute_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::execute_budget_action::ExecuteBudgetActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
