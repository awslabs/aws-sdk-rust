...
pub fn ser_describe_subscribers_for_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSubscribersForNotificationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
