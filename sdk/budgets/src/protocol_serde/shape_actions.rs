...
pub(crate) fn de_actions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Action>>, aws_smithy_json::deserialize::error::DeserializeError>
