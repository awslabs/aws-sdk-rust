...
pub fn ser_delete_subscriber_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteSubscriberInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
