...
pub fn ser_describe_budget_actions_for_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBudgetActionsForBudgetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
