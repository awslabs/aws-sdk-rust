...
pub(crate) fn de_budget_notifications_for_account<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BudgetNotificationsForAccount>, aws_smithy_json::deserialize::error::DeserializeError>
