...
pub fn ser_expression(
    ...
    if let Some(var_11) = &input.dimensions {
        ...
        crate::protocol_serde::shape_expression_dimension_values::ser_expression_dimension_values(&mut object_12, var_11)?;
        object_12.finish();
    }
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Dimensions" => {
                            builder = builder.set_dimensions(
                                crate::protocol_serde::shape_expression_dimension_values::de_expression_dimension_values(tokens, _value, depth + 1)?,
                            );
                        }
                        "Tags" => {
