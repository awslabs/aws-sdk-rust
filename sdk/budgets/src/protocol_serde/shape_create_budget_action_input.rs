...
pub fn ser_create_budget_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBudgetActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
