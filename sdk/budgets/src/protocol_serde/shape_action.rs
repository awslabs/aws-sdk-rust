            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ActionThreshold" => {
                            builder = builder.set_action_threshold(crate::protocol_serde::shape_action_threshold::de_action_threshold(tokens)?);
                        }
                        "Definition" => {
                            builder = builder.set_definition(crate::protocol_serde::shape_definition::de_definition(tokens)?);
                        }
                        "ExecutionRoleArn" => {
