...
pub fn ser_create_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNotificationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
