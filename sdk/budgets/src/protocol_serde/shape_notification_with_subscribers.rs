...
pub fn ser_notification_with_subscribers(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NotificationWithSubscribers) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
