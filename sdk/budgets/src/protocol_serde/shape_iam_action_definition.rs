...
pub(crate) fn de_iam_action_definition<'a, I>(
    ...
    Option<crate::types::IamActionDefinition>,
            ...
            loop {
                match tokens.next().transpose()? {
                        ...
                        .as_ref()
                    {
                        ...
                        "Roles" => {
                            builder = builder
                                .set_roles(crate::protocol_serde::shape_roles::de_roles(tokens)?);
                        }
                        "Groups" => {
                        ...
                        "Users" => {
                            builder = builder
                                .set_users(crate::protocol_serde::shape_users::de_users(tokens)?);
                        }
