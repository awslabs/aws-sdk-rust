...
pub fn ser_delete_notification_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_notification::DeleteNotificationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
