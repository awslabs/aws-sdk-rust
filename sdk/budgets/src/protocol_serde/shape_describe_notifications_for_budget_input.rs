...
pub fn ser_describe_notifications_for_budget_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeNotificationsForBudgetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
