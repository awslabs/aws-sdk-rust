...
pub struct Subscriber  {
    ...
    #[doc(hidden)]pub subscription_type: std::option::Option<crate::model::SubscriptionType>,
...
pub struct Notification  {
    ...
    #[doc(hidden)]pub threshold_type: std::option::Option<crate::model::ThresholdType>,
    ...
    #[doc(hidden)]pub notification_state: std::option::Option<crate::model::NotificationState>,
}
impl Notification {
    /// <p>Specifies whether the notification is for how much you have spent (<code>ACTUAL</code>) or for how much that you're forecasted to spend (<code>FORECASTED</code>).</p>
...
pub struct Definition  {
    ...
    #[doc(hidden)]pub iam_action_definition: std::option::Option<crate::model::IamActionDefinition>,
    /// <p>The service control policies (SCPs) action definition details. </p>
    #[doc(hidden)]pub scp_action_definition: std::option::Option<crate::model::ScpActionDefinition>,
    /// <p>The Amazon Web Services Systems Manager (SSM) action definition details. </p>
    #[doc(hidden)]pub ssm_action_definition: std::option::Option<crate::model::SsmActionDefinition>,
}
impl Definition {
    /// <p>The Identity and Access Management (IAM) action definition details. </p>
...
pub struct SsmActionDefinition  {
    ...
    #[doc(hidden)]pub action_sub_type: std::option::Option<crate::model::ActionSubType>,
...
pub struct ScpActionDefinition  {
    ...
    #[doc(hidden)]pub target_ids: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct IamActionDefinition  {
    ...
    #[doc(hidden)]pub roles: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub users: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct ActionThreshold  {
    ...
    #[doc(hidden)]pub action_threshold_value: f64,
    /// <p> The type of threshold for a notification.</p>
    #[doc(hidden)]pub action_threshold_type: std::option::Option<crate::model::ThresholdType>,
}
...
pub struct Budget  {
    ...
    #[doc(hidden)]pub budget_limit: std::option::Option<crate::model::Spend>,
    ...
    #[doc(hidden)]pub planned_budget_limits: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Spend>>,
    ...
    /// </ul>
    #[doc(hidden)]pub cost_filters: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>>,
    ...
    #[doc(hidden)]pub cost_types: std::option::Option<crate::model::CostTypes>,
    /// <p>The length of time until a budget resets the actual and forecasted spend.</p>
    #[doc(hidden)]pub time_unit: std::option::Option<crate::model::TimeUnit>,
    ...
    #[doc(hidden)]pub calculated_spend: std::option::Option<crate::model::CalculatedSpend>,
    ...
    #[doc(hidden)]pub budget_type: std::option::Option<crate::model::BudgetType>,
    ...
    #[doc(hidden)]pub auto_adjust_data: std::option::Option<crate::model::AutoAdjustData>,
}
impl Budget {
    /// <p>The name of a budget. The name must be unique within an account. The <code>:</code> and <code>\</code> characters aren't allowed in <code>BudgetName</code>.</p>
    pub fn budget_name(&self) -> std::option::Option<& str> {
...
pub struct AutoAdjustData  {
    ...
    #[doc(hidden)]pub auto_adjust_type: std::option::Option<crate::model::AutoAdjustType>,
    /// <p>The parameters that define or describe the historical data that your auto-adjusting budget is based on.</p>
    #[doc(hidden)]pub historical_options: std::option::Option<crate::model::HistoricalOptions>,
    /// <p>The last time that your budget was auto-adjusted.</p>
    #[doc(hidden)]pub last_auto_adjust_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl AutoAdjustData {
    /// <p>The string that defines whether your budget auto-adjusts based on historical or forecasted data.</p>
...
pub struct HistoricalOptions  {
    ...
    /// </ul>
    #[doc(hidden)]pub budget_adjustment_period: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub look_back_available_periods: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for HistoricalOptions  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("look_back_available_periods", &self.look_back_available_periods);
        formatter.finish()
    }
}
...
pub struct CalculatedSpend  {
    ...
    #[doc(hidden)]pub actual_spend: std::option::Option<crate::model::Spend>,
    /// <p>The amount of cost, usage, RI units, or Savings Plans units that you're forecasted to use.</p>
    #[doc(hidden)]pub forecasted_spend: std::option::Option<crate::model::Spend>,
}
...
pub struct Spend  {
    ...
    #[doc(hidden)]pub amount: std::option::Option<std::string::String>,
...
pub struct CostTypes  {
    ...
    #[doc(hidden)]pub include_tax: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes subscriptions.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_subscription: std::option::Option<bool>,
    /// <p>Specifies whether a budget uses a blended rate.</p> 
    /// <p>The default value is <code>false</code>.</p>
    #[doc(hidden)]pub use_blended: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes refunds.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_refund: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes credits.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_credit: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes upfront RI costs.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_upfront: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes recurring fees such as monthly RI fees.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_recurring: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes non-RI subscription costs.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_other_subscription: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes support subscription fees.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_support: std::option::Option<bool>,
    /// <p>Specifies whether a budget includes discounts.</p> 
    /// <p>The default value is <code>true</code>.</p>
    #[doc(hidden)]pub include_discount: std::option::Option<bool>,
    /// <p>Specifies whether a budget uses the amortized rate.</p> 
    /// <p>The default value is <code>false</code>.</p>
    #[doc(hidden)]pub use_amortized: std::option::Option<bool>,
}
impl CostTypes {
    /// <p>Specifies whether a budget includes taxes.</p> 
    /// <p>The default value is <code>true</code>.</p>
...
impl  std::fmt::Debug for CostTypes  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("include_other_subscription", &self.include_other_subscription);
...
pub struct BudgetPerformanceHistory  {
    ...
    #[doc(hidden)]pub budgeted_and_actual_amounts_list: std::option::Option<std::vec::Vec<crate::model::BudgetedAndActualAmounts>>,
}
...
impl  std::fmt::Debug for BudgetPerformanceHistory  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cost_types", &self.cost_types);
        formatter.field("time_unit", &self.time_unit);
        formatter.field("budgeted_and_actual_amounts_list", &self.budgeted_and_actual_amounts_list);
        formatter.finish()
    }
}
...
pub struct BudgetedAndActualAmounts  {
    ...
    #[doc(hidden)]pub budgeted_amount: std::option::Option<crate::model::Spend>,
    /// <p>Your actual costs or usage for a budget period.</p>
    #[doc(hidden)]pub actual_amount: std::option::Option<crate::model::Spend>,
...
pub struct BudgetNotificationsForAccount  {
    ...
    #[doc(hidden)]pub notifications: std::option::Option<std::vec::Vec<crate::model::Notification>>,
    /// <p> A string that represents the budget name. The ":" and "\" characters aren't allowed.</p>
    #[doc(hidden)]pub budget_name: std::option::Option<std::string::String>,
}
...
pub struct ActionHistory  {
    ...
    #[doc(hidden)]pub event_type: std::option::Option<crate::model::EventType>,
    /// <p>The description of the details for the event. </p>
    #[doc(hidden)]pub action_history_details: std::option::Option<crate::model::ActionHistoryDetails>,
}
impl ActionHistory {
    /// <p> A generic time stamp. In Java, it's transformed to a <code>Date</code> object.</p>
