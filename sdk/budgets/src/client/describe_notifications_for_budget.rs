...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_notifications_for_budget::builders::DescribeNotificationsForBudgetFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_notifications_for_budget::builders::DescribeNotificationsForBudgetFluentBuilder::set_max_results): <p>An optional integer that represents how many entries a paginated response contains.</p>
