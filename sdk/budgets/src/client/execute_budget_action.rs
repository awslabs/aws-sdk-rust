...
impl super::Client {
    ...
    ///   - [`budget_name(impl Into<String>)`](crate::operation::execute_budget_action::builders::ExecuteBudgetActionFluentBuilder::budget_name) / [`set_budget_name(Option<String>)`](crate::operation::execute_budget_action::builders::ExecuteBudgetActionFluentBuilder::set_budget_name): <p> A string that represents the budget name. The ":" and "\" characters, and the "/action/" substring, aren't allowed.</p>
    ...
    ///   - [`budget_name(Option<String>)`](crate::operation::execute_budget_action::ExecuteBudgetActionOutput::budget_name): <p> A string that represents the budget name. The ":" and "\" characters, and the "/action/" substring, aren't allowed.</p>
