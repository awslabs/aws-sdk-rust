...
impl super::Client {
    ...
    ///   - [`budget_name(impl Into<String>)`](crate::operation::describe_budget_performance_history::builders::DescribeBudgetPerformanceHistoryFluentBuilder::budget_name) / [`set_budget_name(Option<String>)`](crate::operation::describe_budget_performance_history::builders::DescribeBudgetPerformanceHistoryFluentBuilder::set_budget_name): <p> A string that represents the budget name. The ":" and "\" characters, and the "/action/" substring, aren't allowed.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_budget_performance_history::builders::DescribeBudgetPerformanceHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_budget_performance_history::builders::DescribeBudgetPerformanceHistoryFluentBuilder::set_next_token): <p> A generic string.</p>
