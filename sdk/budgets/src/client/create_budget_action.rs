...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::set_account_id): <p>The account ID of the user. It's a 12-digit number.</p>
    ///   - [`budget_name(impl Into<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::budget_name) / [`set_budget_name(Option<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::set_budget_name): <p> A string that represents the budget name. The ":" and "\" characters aren't allowed.</p>
    ...
    ///   - [`execution_role_arn(impl Into<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::execution_role_arn) / [`set_execution_role_arn(Option<String>)`](crate::operation::create_budget_action::builders::CreateBudgetActionFluentBuilder::set_execution_role_arn): <p> The role passed for action execution and reversion. Roles and actions must be in the same account. </p>
