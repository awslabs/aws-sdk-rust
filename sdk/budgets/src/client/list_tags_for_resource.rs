...
impl super::Client {
    ...
    ///   - [`resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::resource_tags): <p>The tags associated with the resource.</p>
