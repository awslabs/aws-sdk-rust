...
impl super::Client {
    ...
    ///   - [`budget_name(impl Into<String>)`](crate::operation::describe_subscribers_for_notification::builders::DescribeSubscribersForNotificationFluentBuilder::budget_name) / [`set_budget_name(Option<String>)`](crate::operation::describe_subscribers_for_notification::builders::DescribeSubscribersForNotificationFluentBuilder::set_budget_name): <p>The name of the budget whose subscribers you want descriptions of.</p>
