...
pub struct UpdateBudgetActionOutput  {
    ...
    #[doc(hidden)]pub old_action: std::option::Option<crate::model::Action>,
    /// <p> The updated action resource information. </p>
    #[doc(hidden)]pub new_action: std::option::Option<crate::model::Action>,
}
...
pub struct DescribeBudgetsOutput  {
    ...
    #[doc(hidden)]pub budgets: std::option::Option<std::vec::Vec<crate::model::Budget>>,
    /// <p>The pagination token in the service response that indicates the next set of results that you can retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeBudgetPerformanceHistoryOutput  {
    ...
    #[doc(hidden)]pub budget_performance_history: std::option::Option<crate::model::BudgetPerformanceHistory>,
...
impl  std::fmt::Debug for DescribeBudgetPerformanceHistoryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("budget_performance_history", &self.budget_performance_history);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct DescribeBudgetNotificationsForAccountOutput  {
    ...
    #[doc(hidden)]pub budget_notifications_for_account: std::option::Option<std::vec::Vec<crate::model::BudgetNotificationsForAccount>>,
    /// <p> A generic string.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeBudgetNotificationsForAccountOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("budget_notifications_for_account", &self.budget_notifications_for_account);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct DescribeBudgetActionHistoriesOutput  {
    ...
    #[doc(hidden)]pub action_histories: std::option::Option<std::vec::Vec<crate::model::ActionHistory>>,
    /// <p> A generic string.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
