...
/// When writing a match expression against `HealthStatusReason`, it is important to ensure
...
///
/// ```text
/// # let healthstatusreason = unimplemented!();
/// match healthstatusreason {
...
/// }
/// ```
/// The above code demonstrates that when `healthstatusreason` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `HealthStatusReason::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `HealthStatusReason::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `HealthStatusReason::NewFeature` is defined.
/// Specifically, when `healthstatusreason` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `HealthStatusReason::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for HealthStatusReason {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for HealthStatusReason {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HealthStatusReason::from(s))
    }
}
impl HealthStatusReason {
...
impl ::std::fmt::Display for HealthStatusReason {
