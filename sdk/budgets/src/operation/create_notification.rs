...
impl CreateNotificationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_notification::ser_create_notification_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNotification {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_notification::de_create_notification_http_response_with_props(status, headers, body)
        }
    }
}
