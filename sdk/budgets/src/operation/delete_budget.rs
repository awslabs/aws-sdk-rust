...
impl DeleteBudgetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_budget::DeleteBudget, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_budget::ser_delete_budget_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBudget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_budget::de_delete_budget_http_response_with_props(status, headers, body)
        }
    }
}
