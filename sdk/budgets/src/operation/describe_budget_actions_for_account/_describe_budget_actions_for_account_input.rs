...
impl DescribeBudgetActionsForAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_budget_actions_for_account::DescribeBudgetActionsForAccountInput, ::aws_smithy_types::error::operation::BuildError> {
