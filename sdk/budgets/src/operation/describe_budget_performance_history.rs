...
impl DescribeBudgetPerformanceHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_budget_performance_history::DescribeBudgetPerformanceHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudgetPerformanceHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_budget_performance_history::de_describe_budget_performance_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
