...
impl CreateBudgetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_budget::CreateBudget, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_budget::ser_create_budget_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBudget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_budget::de_create_budget_http_response_with_props(status, headers, body)
        }
    }
}
