...
impl DescribeSubscribersForNotificationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_subscribers_for_notification::DescribeSubscribersForNotification,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_subscribers_for_notification::DescribeSubscribersForNotification::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSubscribersForNotification {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_subscribers_for_notification::de_describe_subscribers_for_notification_http_response_with_props(
                status, headers, body,
            )
        }
    }
