...
impl DeleteBudgetActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_budget_action::ser_delete_budget_action_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBudgetAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_budget_action::de_delete_budget_action_http_response_with_props(status, headers, body)
        }
    }
