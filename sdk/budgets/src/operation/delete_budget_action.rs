...
impl DeleteBudgetActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_budget_action::ser_delete_budget_action_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_budget_action::DeleteBudgetAction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_budget_action::DeleteBudgetActionError
{
