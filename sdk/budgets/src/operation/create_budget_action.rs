...
impl CreateBudgetActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_budget_action::ser_create_budget_action_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_budget_action::CreateBudgetAction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_budget_action::CreateBudgetActionError
{
