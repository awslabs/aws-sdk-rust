...
impl DescribeBudgetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_budgets::DescribeBudgets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudgets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_budgets::de_describe_budgets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_budgets::DescribeBudgetsError
{
