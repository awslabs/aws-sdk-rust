...
impl DescribeBudgetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_budgets::DescribeBudgets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_budgets::ser_describe_budgets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudgets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_budgets::de_describe_budgets_http_response_with_props(status, headers, body)
        }
    }
}
