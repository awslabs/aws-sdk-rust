...
impl DescribeBudgetActionsForBudgetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_budget_actions_for_budget::DescribeBudgetActionsForBudget,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_budget_actions_for_budget::DescribeBudgetActionsForBudget::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudgetActionsForBudget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_budget_actions_for_budget::de_describe_budget_actions_for_budget_http_response_with_props(
                status, headers, body,
            )
        }
    }
