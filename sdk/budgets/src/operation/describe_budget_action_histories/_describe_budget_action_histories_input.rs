...
impl DescribeBudgetActionHistoriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_budget_action_histories::DescribeBudgetActionHistoriesInput, ::aws_smithy_types::error::operation::BuildError> {
