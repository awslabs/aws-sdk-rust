...
impl DescribeNotificationsForBudgetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudget::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationsForBudget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_notifications_for_budget::de_describe_notifications_for_budget_http_response_with_props(
                status, headers, body,
            )
        }
    }
