...
impl DeleteBudgetFluentBuilder  {
    /// Creates a new `DeleteBudget`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_budget::DeleteBudgetOutput, aws_smithy_http::result::SdkError<crate::operation::delete_budget::DeleteBudgetError>>
                     {
