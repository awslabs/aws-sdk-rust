...
impl DescribeBudgetNotificationsForAccountPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_budget_notifications_for_account::paginator::DescribeBudgetNotificationsForAccountPaginatorItems {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_budget_notifications_for_account::DescribeBudgetNotificationsForAccount::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl DescribeBudgetNotificationsForAccountPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_budget_notifications_for_account_output_output_budget_notifications_for_account(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
