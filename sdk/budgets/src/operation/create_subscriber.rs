...
impl CreateSubscriberInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_subscriber::CreateSubscriber, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_subscriber::ser_create_subscriber_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubscriber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_subscriber::de_create_subscriber_http_response_with_props(status, headers, body)
        }
    }
}
