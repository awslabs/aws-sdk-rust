...
impl UpdateBudgetActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_budget_action::ser_update_budget_action_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBudgetAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_budget_action::de_update_budget_action_http_response_with_props(status, headers, body)
        }
    }
