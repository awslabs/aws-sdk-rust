...
impl DescribeBudgetPerformanceHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_budget_performance_history::DescribeBudgetPerformanceHistoryInput, ::aws_smithy_types::error::operation::BuildError> {
