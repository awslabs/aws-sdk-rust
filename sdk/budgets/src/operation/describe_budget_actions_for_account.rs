...
impl DescribeBudgetActionsForAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_budget_actions_for_account::DescribeBudgetActionsForAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudgetActionsForAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_budget_actions_for_account::de_describe_budget_actions_for_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
