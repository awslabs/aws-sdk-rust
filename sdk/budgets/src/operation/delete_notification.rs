...
impl DeleteNotificationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_notification::ser_delete_notification_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotification {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_notification::de_delete_notification_http_response_with_props(status, headers, body)
        }
    }
}
