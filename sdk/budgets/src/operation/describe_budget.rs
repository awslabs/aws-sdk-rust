...
impl DescribeBudgetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_budget::DescribeBudget, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_budget::ser_describe_budget_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBudget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_budget::de_describe_budget_http_response_with_props(status, headers, body)
        }
    }
}
