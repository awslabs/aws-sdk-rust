...
impl ExecuteBudgetActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_execute_budget_action::ser_execute_budget_action_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::execute_budget_action::ExecuteBudgetAction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::execute_budget_action::ExecuteBudgetActionError
{
