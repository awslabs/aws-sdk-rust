...
impl StartImportFileTaskInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_import_file_task::ser_start_import_file_task_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateServerConfigInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_server_config::ser_update_server_config_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
pub mod stop_assessment_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::StopAssessmentInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod start_assessment_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::StartAssessmentInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod list_collectors_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::ListCollectorsInput, aws_smithy_http::operation::error::BuildError>
        {
