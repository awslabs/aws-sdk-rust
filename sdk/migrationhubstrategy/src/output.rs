...
pub struct StartAssessmentOutput  {
    ...
    #[doc(hidden)]pub assessment_id: std::option::Option<std::string::String>,
}
...
pub struct ListServersOutput  {
    ...
    #[doc(hidden)]pub server_infos: std::option::Option<std::vec::Vec<crate::model::ServerDetail>>,
...
pub struct ListImportFileTaskOutput  {
    ...
    #[doc(hidden)]pub task_infos: std::option::Option<std::vec::Vec<crate::model::ImportFileTaskInformation>>,
    /// <p> The token you use to retrieve the next set of results, or null if there are no more results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCollectorsOutput  {
    ...
    #[doc(hidden)]pub collectors: std::option::Option<std::vec::Vec<crate::model::Collector>>,
    /// <p> The token you use to retrieve the next set of results, or null if there are no more results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApplicationComponentsOutput  {
    ...
    #[doc(hidden)]pub application_component_infos: std::option::Option<std::vec::Vec<crate::model::ApplicationComponentDetail>>,
    /// <p> The token you use to retrieve the next set of results, or null if there are no more results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListApplicationComponentsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_component_infos", &self.application_component_infos);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetServerStrategiesOutput  {
    ...
    #[doc(hidden)]pub server_strategies: std::option::Option<std::vec::Vec<crate::model::ServerStrategy>>,
}
...
pub struct GetServerDetailsOutput  {
    ...
    #[doc(hidden)]pub server_detail: std::option::Option<crate::model::ServerDetail>,
    /// <p> The associated application group the server belongs to, as defined in AWS Application Discovery Service. </p>
    #[doc(hidden)]pub associated_applications: std::option::Option<std::vec::Vec<crate::model::AssociatedApplication>>,
}
...
pub struct GetRecommendationReportDetailsOutput  {
    ...
    #[doc(hidden)]pub recommendation_report_details: std::option::Option<crate::model::RecommendationReportDetails>,
}
...
impl  std::fmt::Debug for GetRecommendationReportDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("id", &self.id);
        formatter.field("recommendation_report_details", &self.recommendation_report_details);
        formatter.finish()
    }
}
...
pub struct GetPortfolioSummaryOutput  {
    ...
    #[doc(hidden)]pub assessment_summary: std::option::Option<crate::model::AssessmentSummary>,
}
...
pub struct GetPortfolioPreferencesOutput  {
    ...
    #[doc(hidden)]pub prioritize_business_goals: std::option::Option<crate::model::PrioritizeBusinessGoals>,
    /// <p> The transformation preferences for non-database applications. </p>
    #[doc(hidden)]pub application_preferences: std::option::Option<crate::model::ApplicationPreferences>,
    /// <p> The transformation preferences for database applications. </p>
    #[doc(hidden)]pub database_preferences: std::option::Option<crate::model::DatabasePreferences>,
}
...
pub struct GetAssessmentOutput  {
    ...
    #[doc(hidden)]pub data_collection_details: std::option::Option<crate::model::DataCollectionDetails>,
}
...
pub struct GetApplicationComponentStrategiesOutput  {
    ...
    #[doc(hidden)]pub application_component_strategies: std::option::Option<std::vec::Vec<crate::model::ApplicationComponentStrategy>>,
}
...
impl  std::fmt::Debug for GetApplicationComponentStrategiesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_component_strategies", &self.application_component_strategies);
        formatter.finish()
    }
}
...
pub struct GetApplicationComponentDetailsOutput  {
    ...
    #[doc(hidden)]pub application_component_detail: std::option::Option<crate::model::ApplicationComponentDetail>,
    ...
    #[doc(hidden)]pub more_application_resource: std::option::Option<bool>,
    /// <p> A list of the IDs of the servers on which the application component is running. </p>
    #[doc(hidden)]pub associated_server_ids: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for GetApplicationComponentDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_component_detail", &self.application_component_detail);
        formatter.field("associated_applications", &self.associated_applications);
