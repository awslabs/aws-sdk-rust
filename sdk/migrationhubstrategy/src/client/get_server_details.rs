...
impl super::Client {
    ...
    ///   - [`server_id(impl Into<String>)`](crate::operation::get_server_details::builders::GetServerDetailsFluentBuilder::server_id) / [`set_server_id(impl Into<String>)`](crate::operation::get_server_details::builders::GetServerDetailsFluentBuilder::set_server_id):<br>required: **true**<br><p> The ID of the server. </p><br>
