...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_import_file_task::builders::GetImportFileTaskFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_import_file_task::builders::GetImportFileTaskFluentBuilder::set_id): <p> The ID of the import file task. This ID is returned in the response of <code>StartImportFileTask</code>. </p>
