...
impl super::Client {
    ...
    ///   - [`assessment_data_source_type(AssessmentDataSourceType)`](crate::operation::start_assessment::builders::StartAssessmentFluentBuilder::assessment_data_source_type) / [`set_assessment_data_source_type(Option<AssessmentDataSourceType>)`](crate::operation::start_assessment::builders::StartAssessmentFluentBuilder::set_assessment_data_source_type): The data source type of an assessment to be started.
