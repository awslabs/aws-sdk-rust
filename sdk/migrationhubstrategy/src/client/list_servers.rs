...
impl super::Client {
    ...
    ///   - [`group_id_filter(Group)`](crate::operation::list_servers::builders::ListServersFluentBuilder::group_id_filter) / [`set_group_id_filter(Option<Vec<Group>>)`](crate::operation::list_servers::builders::ListServersFluentBuilder::set_group_id_filter): <p> Specifies the group ID to filter on. </p>
