...
impl super::Client {
    ...
    ///   - [`application_component_id(impl ::std::convert::Into<String>)`](crate::operation::get_application_component_details::builders::GetApplicationComponentDetailsFluentBuilder::application_component_id) / [`set_application_component_id(Option<String>)`](crate::operation::get_application_component_details::builders::GetApplicationComponentDetailsFluentBuilder::set_application_component_id): <p> The ID of the application component. The ID is unique within an AWS account.</p>
