...
impl super::Client {
    ...
    ///   - [`server_id(impl Into<String>)`](crate::operation::get_server_strategies::builders::GetServerStrategiesFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::get_server_strategies::builders::GetServerStrategiesFluentBuilder::set_server_id):<br>required: **true**<br><p>The ID of the server.</p><br>
