...
impl Client  {
    ...
    pub fn start_recommendation_report_generation(&self) -> crate::client::fluent_builders::StartRecommendationReportGeneration {
                            crate::client::fluent_builders::StartRecommendationReportGeneration::new(self.handle.clone())
                        }
