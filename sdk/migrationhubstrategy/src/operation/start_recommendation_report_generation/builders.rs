...
impl StartRecommendationReportGenerationFluentBuilder {
    /// Creates a new `StartRecommendationReportGenerationFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::start_recommendation_report_generation::StartRecommendationReportGeneration::operation_runtime_plugins(
