...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationOutput,
                    crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationError,
                > for StartRecommendationReportGenerationFluentBuilder
            {
                fn send(
                    self,
...
impl StartRecommendationReportGenerationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_recommendation_report_generation::StartRecommendationReportGeneration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_recommendation_report_generation::StartRecommendationReportGeneration::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationOutput, crate::operation::start_recommendation_report_generation::StartRecommendationReportGenerationError, Self> {
