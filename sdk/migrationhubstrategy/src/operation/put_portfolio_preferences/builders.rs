...
impl PutPortfolioPreferencesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_portfolio_preferences::PutPortfolioPreferencesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_portfolio_preferences::PutPortfolioPreferencesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_portfolio_preferences::PutPortfolioPreferencesOutput, crate::operation::put_portfolio_preferences::PutPortfolioPreferencesError, Self> {
