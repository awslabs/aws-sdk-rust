...
impl ListAnalyzableServersOutput {
    /// The list of analyzable servers with summary information about each server.
    pub fn analyzable_servers(&self) -> ::std::option::Option<&[crate::types::AnalyzableServerSummary]> {
        self.analyzable_servers.as_deref()
    }
    /// The token you use to retrieve the next set of results, or null if there are no more results.
...
impl ::aws_http::request_id::RequestId for ListAnalyzableServersOutput {
