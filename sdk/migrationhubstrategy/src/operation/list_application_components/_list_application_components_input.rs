...
impl ListApplicationComponentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_components::ListApplicationComponentsInput, ::aws_smithy_types::error::operation::BuildError> {
