...
pub use crate::operation::get_server_details::_get_server_details_output::GetServerDetailsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_server_details::GetServerDetailsOutput,
                    crate::operation::get_server_details::GetServerDetailsError,
                > for GetServerDetailsFluentBuilder
            {
                fn send(
                    self,
...
impl GetServerDetailsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_server_details::GetServerDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_server_details::GetServerDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::get_server_details::GetServerDetails::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_server_details::GetServerDetailsOutput, crate::operation::get_server_details::GetServerDetailsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::get_server_details::paginator::GetServerDetailsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
