    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/get-assessment/{id}", id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_assessment::GetAssessment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAssessment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_assessment::de_get_assessment_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_assessment::de_get_assessment_http_response_with_props(
                status, headers, body,
            )
        }
    }
