...
impl UpdateApplicationComponentConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_application_component_config::UpdateApplicationComponentConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApplicationComponentConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_application_component_config::de_update_application_component_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
