...
impl GetPortfolioSummaryFluentBuilder  {
    /// Creates a new `GetPortfolioSummary`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_portfolio_summary::GetPortfolioSummaryOutput, aws_smithy_http::result::SdkError<crate::operation::get_portfolio_summary::GetPortfolioSummaryError>>
                     {
