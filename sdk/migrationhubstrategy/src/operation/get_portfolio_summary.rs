...
/// Orchestration and serialization glue logic for `GetPortfolioSummary`.
...
impl GetPortfolioSummary {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_portfolio_summary::GetPortfolioSummaryInput,
                    ) -> ::std::result::Result<crate::operation::get_portfolio_summary::GetPortfolioSummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_portfolio_summary::GetPortfolioSummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_portfolio_summary::GetPortfolioSummaryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_portfolio_summary::GetPortfolioSummaryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPortfolioSummary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPortfolioSummary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPortfolioSummaryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPortfolioSummaryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPortfolioSummary")
...
.with_interceptor(GetPortfolioSummaryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_portfolio_summary::GetPortfolioSummaryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_portfolio_summary::GetPortfolioSummaryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_portfolio_summary::GetPortfolioSummaryError>::new());
...
#[derive(Debug)]
            struct GetPortfolioSummaryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPortfolioSummaryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_portfolio_summary::de_get_portfolio_summary_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetPortfolioSummaryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPortfolioSummaryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_portfolio_summary::GetPortfolioSummaryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_portfolio_summary::GetPortfolioSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/get-portfolio-summary").expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetPortfolioSummaryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPortfolioSummaryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPortfolioSummaryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPortfolioSummaryInput>()
                        .ok_or("failed to downcast to GetPortfolioSummaryInput")?;
...
pub enum GetPortfolioSummaryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPortfolioSummaryError) for what information is available for the error.")]
...
impl GetPortfolioSummaryError {
    /// Creates the `GetPortfolioSummaryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPortfolioSummaryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPortfolioSummaryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_portfolio_summary::GetPortfolioSummaryError {
...
mod _get_portfolio_summary_output;
