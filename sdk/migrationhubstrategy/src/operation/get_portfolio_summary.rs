...
impl GetPortfolioSummaryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_portfolio_summary::GetPortfolioSummary,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPortfolioSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_portfolio_summary::de_get_portfolio_summary_http_response_with_props(status, headers, body)
        }
    }
}
