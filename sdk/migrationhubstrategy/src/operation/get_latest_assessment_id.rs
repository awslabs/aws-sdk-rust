    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/get-latest-assessment-id")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_latest_assessment_id::GetLatestAssessmentId::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_latest_assessment_id::GetLatestAssessmentIdError
{
