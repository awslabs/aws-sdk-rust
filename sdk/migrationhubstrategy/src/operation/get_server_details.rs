...
impl GetServerDetailsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_server_details::GetServerDetails::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetServerDetails {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_server_details::de_get_server_details_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_server_details::de_get_server_details_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::get_server_details::GetServerDetailsError
{
