...
impl ListCollectorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_collectors::ListCollectors,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_collectors::ListCollectors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCollectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_collectors::de_list_collectors_http_error(
                status, headers, body,
            )
        } else {
