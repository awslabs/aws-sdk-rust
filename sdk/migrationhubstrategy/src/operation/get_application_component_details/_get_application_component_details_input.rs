...
impl GetApplicationComponentDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_application_component_details::GetApplicationComponentDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
