...
impl crate::operation::get_recommendation_report_details::builders::GetRecommendationReportDetailsInputBuilder {
...
impl GetRecommendationReportDetailsFluentBuilder {
    /// Creates a new `GetRecommendationReportDetailsFluentBuilder`.
