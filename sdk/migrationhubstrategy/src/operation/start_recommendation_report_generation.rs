...
impl StartRecommendationReportGenerationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_recommendation_report_generation::StartRecommendationReportGeneration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRecommendationReportGeneration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_recommendation_report_generation::de_start_recommendation_report_generation_http_response_with_props(
                status, headers, body,
            )
        }
    }
