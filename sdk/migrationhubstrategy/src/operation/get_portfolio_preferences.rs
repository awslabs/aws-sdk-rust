...
impl GetPortfolioPreferences {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_portfolio_preferences::GetPortfolioPreferencesInput,
                    ) -> ::std::result::Result<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPortfolioPreferences {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPortfolioPreferences");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPortfolioPreferencesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPortfolioPreferencesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPortfolioPreferences")
...
.with_interceptor(GetPortfolioPreferencesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_portfolio_preferences::de_get_portfolio_preferences_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_portfolio_preferences::de_get_portfolio_preferences_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPortfolioPreferencesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_portfolio_preferences::GetPortfolioPreferencesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/get-portfolio-preferences").expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPortfolioPreferencesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPortfolioPreferencesInput>()
                        .ok_or("failed to downcast to GetPortfolioPreferencesInput")?;
...
pub enum GetPortfolioPreferencesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPortfolioPreferencesError) for what information is available for the error.")]
...
impl GetPortfolioPreferencesError {
    /// Creates the `GetPortfolioPreferencesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPortfolioPreferencesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPortfolioPreferencesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError {
...
mod _get_portfolio_preferences_output;
