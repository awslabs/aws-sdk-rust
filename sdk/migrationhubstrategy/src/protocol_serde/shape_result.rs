            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "analysisStatus" => {
                            builder =
                                builder.set_analysis_status(crate::protocol_serde::shape_analysis_status_union::de_analysis_status_union(tokens)?);
                        }
                        "statusMessage" => {
                        ...
                        "antipatternReportResultList" => {
                            builder = builder.set_antipattern_report_result_list(
                                crate::protocol_serde::shape_antipattern_report_result_list::de_antipattern_report_result_list(tokens)?,
                            );
                        }
