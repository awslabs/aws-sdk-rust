...
pub fn ser_source_code(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceCode) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
