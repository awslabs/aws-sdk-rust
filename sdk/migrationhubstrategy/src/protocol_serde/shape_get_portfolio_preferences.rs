...
pub fn de_get_portfolio_preferences_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesOutput, crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_portfolio_preferences_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_portfolio_preferences::GetPortfolioPreferencesOutput, crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError> {
    Ok({
        #[allow(unused_mut)]
