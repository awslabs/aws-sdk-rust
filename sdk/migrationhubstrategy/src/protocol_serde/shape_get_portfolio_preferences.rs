...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_portfolio_preferences::de_get_portfolio_preferences(_response_body, output)
            .map_err(crate::operation::get_portfolio_preferences::GetPortfolioPreferencesError::unhandled)?;
