...
pub(crate) fn de_data_collection_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DataCollectionDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
