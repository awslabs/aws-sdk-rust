...
pub(crate) fn de_database_preferences<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::DatabasePreferences>, aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_database_management_preference(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::DatabaseManagementPreference::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
