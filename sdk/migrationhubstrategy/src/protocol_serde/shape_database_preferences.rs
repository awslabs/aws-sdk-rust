...
pub(crate) fn de_database_preferences<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DatabasePreferences>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "databaseManagementPreference" => {
                            builder = builder.set_database_management_preference(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::DatabaseManagementPreference::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "databaseMigrationPreference" => {
                            builder = builder.set_database_migration_preference(
                                crate::protocol_serde::shape_database_migration_preference::de_database_migration_preference(tokens, _value)?,
                            );
                        }
