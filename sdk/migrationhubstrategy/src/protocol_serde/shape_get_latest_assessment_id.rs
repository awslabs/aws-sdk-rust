...
pub fn de_get_latest_assessment_id_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_latest_assessment_id::GetLatestAssessmentIdOutput, crate::operation::get_latest_assessment_id::GetLatestAssessmentIdError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_latest_assessment_id::GetLatestAssessmentIdError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_latest_assessment_id_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_latest_assessment_id::GetLatestAssessmentIdOutput, crate::operation::get_latest_assessment_id::GetLatestAssessmentIdError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_latest_assessment_id::builders::GetLatestAssessmentIdOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_latest_assessment_id::de_get_latest_assessment_id(response.body().as_ref(), output).map_err(crate::operation::get_latest_assessment_id::GetLatestAssessmentIdError::unhandled)?;
