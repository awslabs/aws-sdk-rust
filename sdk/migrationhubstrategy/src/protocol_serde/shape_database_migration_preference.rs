...
pub(crate) fn de_database_migration_preference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DatabaseMigrationPreference>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_database_migration_preference(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatabaseMigrationPreference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
