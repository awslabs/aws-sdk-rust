...
pub fn ser_database_migration_preference(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DatabaseMigrationPreference) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::DatabaseMigrationPreference::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("DatabaseMigrationPreference"))
    }
    Ok(())
}
