                        ...
                        .as_ref()
                    {
                        ...
                        "resourceSubType" => {
                            builder = builder.set_resource_sub_type(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::ResourceSubType::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "inclusionStatus" => {
                            builder = builder.set_inclusion_status(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::InclusionStatus::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "appUnitError" => {
                            builder = builder.set_app_unit_error(
                                crate::protocol_serde::shape_app_unit_error::de_app_unit_error(
                                    tokens,
                                )?,
                            );
                        }
