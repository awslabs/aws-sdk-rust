...
pub(crate) fn de_self_manage_resources<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SelfManageResources>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "targetDestination" => {
                            builder = builder.set_target_destination(
                                crate::protocol_serde::shape_self_manage_target_destinations::de_self_manage_target_destinations(tokens, _value)?,
                            );
                        }
