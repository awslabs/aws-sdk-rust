...
pub(crate) fn de_aws_managed_resources<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsManagedResources>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "targetDestination" => {
                            builder = builder.set_target_destination(
                                crate::protocol_serde::shape_aws_managed_target_destinations::de_aws_managed_target_destinations(tokens, _value)?,
                            );
                        }
            ...
            Ok(Some(crate::serde_util::aws_managed_resources_correct_errors(builder).build().map_err(
