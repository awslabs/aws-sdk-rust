...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_recommendation_report_details::de_get_recommendation_report_details(_response_body, output)
            .map_err(crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "recommendationReportDetails" => {
                    builder = builder.set_recommendation_report_details(
                        crate::protocol_serde::shape_recommendation_report_details::de_recommendation_report_details(tokens, _value, depth + 1)?,
                    );
                }
