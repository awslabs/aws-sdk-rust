...
pub fn de_get_recommendation_report_details_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRecommendationReportDetailsOutput, crate::error::GetRecommendationReportDetailsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetRecommendationReportDetailsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_recommendation_report_details_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRecommendationReportDetailsOutput, crate::error::GetRecommendationReportDetailsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_recommendation_report_details(value: &[u8], mut builder: crate::output::get_recommendation_report_details_output::Builder) -> Result<crate::output::get_recommendation_report_details_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
