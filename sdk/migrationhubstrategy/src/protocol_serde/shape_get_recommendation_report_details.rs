...
pub fn de_get_recommendation_report_details_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsOutput, crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_recommendation_report_details_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsOutput, crate::operation::get_recommendation_report_details::GetRecommendationReportDetailsError> {
    Ok({
        #[allow(unused_mut)]
