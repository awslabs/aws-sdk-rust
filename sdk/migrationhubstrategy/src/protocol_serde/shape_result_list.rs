...
pub(crate) fn de_result_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Result>>, aws_smithy_json::deserialize::error::DeserializeError>
