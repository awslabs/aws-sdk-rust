...
pub(crate) fn de_server_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServerDetail>, aws_smithy_json::deserialize::error::DeserializeError>
