...
pub fn de_list_import_file_task_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListImportFileTaskOutput, crate::error::ListImportFileTaskError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListImportFileTaskError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_import_file_task_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListImportFileTaskOutput, crate::error::ListImportFileTaskError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_import_file_task_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_import_file_task::de_list_import_file_task(response.body().as_ref(), output).map_err(crate::error::ListImportFileTaskError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_import_file_task(value: &[u8], mut builder: crate::output::list_import_file_task_output::Builder) -> Result<crate::output::list_import_file_task_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
