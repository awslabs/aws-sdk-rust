...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_import_file_task_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_import_file_task::de_list_import_file_task(_response_body, output)
            .map_err(crate::operation::list_import_file_task::ListImportFileTaskError::unhandled)?;
...
) -> Result<crate::operation::list_import_file_task::builders::ListImportFileTaskOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
