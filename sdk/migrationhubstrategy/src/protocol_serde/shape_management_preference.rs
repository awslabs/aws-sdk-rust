...
pub(crate) fn de_management_preference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ManagementPreference>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_management_preference(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagementPreference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
