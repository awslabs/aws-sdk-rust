...
) -> Result<Option<crate::types::ManagementPreference>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "awsManagedResources" => Some(crate::types::ManagementPreference::AwsManagedResources(
                            crate::protocol_serde::shape_aws_managed_resources::de_aws_managed_resources(tokens)?.ok_or_else(|| {
                        ...
                        "selfManageResources" => Some(crate::types::ManagementPreference::SelfManageResources(
                            crate::protocol_serde::shape_self_manage_resources::de_self_manage_resources(tokens)?.ok_or_else(|| {
                        ...
                        "noPreference" => Some(crate::types::ManagementPreference::NoPreference(
                            crate::protocol_serde::shape_no_management_preference::de_no_management_preference(tokens)?.ok_or_else(|| {
