...
pub(crate) fn de_server_strategy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServerStrategy>, aws_smithy_json::deserialize::error::DeserializeError>
