...
pub(crate) fn de_assessment_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AssessmentSummary>, aws_smithy_json::deserialize::error::DeserializeError>
