...
pub(crate) fn de_business_goals<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::BusinessGoals>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
...
pub fn ser_business_goals(
    ...
    if let Some(var_2) = &input.reduce_operational_overhead_with_managed_services {
        object.key("reduceOperationalOverheadWithManagedServices").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::NegInt((*var_2).into()),
        );
    }
    if let Some(var_3) = &input.modernize_infrastructure_with_cloud_native_technologies {
        object.key("modernizeInfrastructureWithCloudNativeTechnologies").number(
            #[allow(clippy::useless_conversion)]
