...
pub(crate) fn reflens_get_server_details_output_next_token(
...
pub(crate) fn reflens_list_collectors_output_next_token(
...
pub(crate) fn reflens_list_import_file_task_output_next_token(
...
pub(crate) fn lens_get_server_details_output_associated_applications(
    input: crate::operation::get_server_details::GetServerDetailsOutput,
...
pub(crate) fn lens_list_application_components_output_application_component_infos(
    input: crate::operation::list_application_components::ListApplicationComponentsOutput,
...
pub(crate) fn lens_list_collectors_output_collectors(
    input: crate::operation::list_collectors::ListCollectorsOutput,
...
pub(crate) fn lens_list_import_file_task_output_task_infos(
    input: crate::operation::list_import_file_task::ListImportFileTaskOutput,
...
pub(crate) fn lens_list_servers_output_server_infos(
    input: crate::operation::list_servers::ListServersOutput,
