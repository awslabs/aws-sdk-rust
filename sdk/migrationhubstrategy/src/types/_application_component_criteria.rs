...
other => ApplicationComponentCriteria::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ApplicationComponentCriteria {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ApplicationComponentCriteria::from(s))
                    }
                }
...
impl ::std::convert::AsRef<str> for ApplicationComponentCriteria {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
