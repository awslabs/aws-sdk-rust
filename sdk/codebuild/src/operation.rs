...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeleteBuilds {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_batch_delete_builds::de_batch_delete_builds_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_batch_delete_builds::de_batch_delete_builds_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetBuilds {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            ...
            crate::protocol_serde::shape_batch_get_builds::de_batch_get_builds_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetProjects {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_batch_get_projects::de_batch_get_projects_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_batch_get_projects::de_batch_get_projects_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetReports {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_batch_get_reports::de_batch_get_reports_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_batch_get_reports::de_batch_get_reports_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReportGroup {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_report_group::de_create_report_group_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_create_report_group::de_create_report_group_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBuildBatch {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_build_batch::de_delete_build_batch_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_delete_build_batch::de_delete_build_batch_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteReportGroup {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_report_group::de_delete_report_group_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_delete_report_group::de_delete_report_group_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTestCases {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_test_cases::de_describe_test_cases_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_describe_test_cases::de_describe_test_cases_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListBuildBatches {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_build_batches::de_list_build_batches_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_build_batches::de_list_build_batches_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListReportGroups {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_report_groups::de_list_report_groups_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_report_groups::de_list_report_groups_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListSharedProjects {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_shared_projects::de_list_shared_projects_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_shared_projects::de_list_shared_projects_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for RetryBuildBatch {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_retry_build_batch::de_retry_build_batch_http_error(
                response,
            )
        } else {
...
impl aws_smithy_http::response::ParseStrictResponse for StartBuildBatch {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_start_build_batch::de_start_build_batch_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_start_build_batch::de_start_build_batch_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for StopBuildBatch {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            ...
            crate::protocol_serde::shape_stop_build_batch::de_stop_build_batch_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateReportGroup {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_report_group::de_update_report_group_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_update_report_group::de_update_report_group_http_response(
                response,
            )
        }
    }
