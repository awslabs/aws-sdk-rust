...
impl ListSharedProjectsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_shared_projects::ser_list_shared_projects_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSharedProjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_shared_projects::de_list_shared_projects_http_response_with_props(status, headers, body)
        }
    }
}
