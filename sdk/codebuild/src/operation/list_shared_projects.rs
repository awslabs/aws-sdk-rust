...
impl ListSharedProjectsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_shared_projects::ser_list_shared_projects_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_shared_projects::ListSharedProjects::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_shared_projects::ListSharedProjectsError
{
