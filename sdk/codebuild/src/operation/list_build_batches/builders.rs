...
impl ListBuildBatchesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_build_batches::ListBuildBatchesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_build_batches::ListBuildBatchesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_build_batches::ListBuildBatchesOutput, crate::operation::list_build_batches::ListBuildBatchesError, Self> {
