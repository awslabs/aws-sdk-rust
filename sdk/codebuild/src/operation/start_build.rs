...
impl StartBuildInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_build::StartBuild, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_build::ser_start_build_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartBuild {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_build::de_start_build_http_response_with_props(status, headers, body)
        }
    }
}
