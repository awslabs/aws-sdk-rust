...
impl BatchGetFleetsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_fleets::BatchGetFleetsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::batch_get_fleets::BatchGetFleetsInput {
                names: self.names
                ,
            }
        )
