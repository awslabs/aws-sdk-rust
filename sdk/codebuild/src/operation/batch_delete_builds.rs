...
impl BatchDeleteBuildsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_delete_builds::BatchDeleteBuilds,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_delete_builds::ser_batch_delete_builds_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteBuilds {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_builds::de_batch_delete_builds_http_response_with_props(status, headers, body)
        }
    }
}
