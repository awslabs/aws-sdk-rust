...
impl CreateWebhookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_webhook::CreateWebhook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_webhook::ser_create_webhook_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWebhook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_webhook::de_create_webhook_http_response_with_props(status, headers, body)
        }
    }
}
