...
impl CreateProjectInput {
    /// Consumes the builder and constructs an Operation<[`CreateProject`](crate::operation::create_project::CreateProject)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_project::CreateProject, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_project::ser_create_project_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_project::CreateProject::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProject {
    type Output = ::std::result::Result<crate::operation::create_project::CreateProjectOutput, crate::operation::create_project::CreateProjectError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_project::de_create_project_http_response_with_props(status, headers, body)
        }
    }
}
