...
impl StartBuildBatchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_build_batch::StartBuildBatch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_build_batch::ser_start_build_batch_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartBuildBatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_build_batch::de_start_build_batch_http_response_with_props(status, headers, body)
        }
    }
}
