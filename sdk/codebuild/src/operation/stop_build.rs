...
impl StopBuildInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_build::StopBuild, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_build::ser_stop_build_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopBuild {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_build::de_stop_build_http_response_with_props(status, headers, body)
        }
    }
}
