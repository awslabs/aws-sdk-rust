...
impl DeleteWebhookInput {
    /// Consumes the builder and constructs an Operation<[`DeleteWebhook`](crate::operation::delete_webhook::DeleteWebhook)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_webhook::DeleteWebhook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_webhook::ser_delete_webhook_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_webhook::DeleteWebhook::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWebhook {
    type Output = ::std::result::Result<crate::operation::delete_webhook::DeleteWebhookOutput, crate::operation::delete_webhook::DeleteWebhookError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_webhook::de_delete_webhook_http_response_with_props(status, headers, body)
        }
    }
}
