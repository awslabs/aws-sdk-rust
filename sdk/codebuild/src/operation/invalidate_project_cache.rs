...
/// Orchestration and serialization glue logic for `InvalidateProjectCache`.
...
impl InvalidateProjectCache {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::invalidate_project_cache::InvalidateProjectCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invalidate_project_cache::InvalidateProjectCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::invalidate_project_cache::InvalidateProjectCacheError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::invalidate_project_cache::InvalidateProjectCacheOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvalidateProjectCache {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvalidateProjectCache");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InvalidateProjectCacheRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InvalidateProjectCacheResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvalidateProjectCache")
...
.with_interceptor(InvalidateProjectCacheEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::invalidate_project_cache::InvalidateProjectCacheError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::invalidate_project_cache::InvalidateProjectCacheError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::invalidate_project_cache::InvalidateProjectCacheError>::new());
...
#[derive(Debug)]
            struct InvalidateProjectCacheResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvalidateProjectCacheResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_invalidate_project_cache::de_invalidate_project_cache_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct InvalidateProjectCacheRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvalidateProjectCacheRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::invalidate_project_cache::InvalidateProjectCacheInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::invalidate_project_cache::InvalidateProjectCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_invalidate_project_cache::ser_invalidate_project_cache_input(&input)?);
...
#[derive(Debug)]
            struct InvalidateProjectCacheEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvalidateProjectCacheEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "InvalidateProjectCacheEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InvalidateProjectCacheInput>()
                        .ok_or("failed to downcast to InvalidateProjectCacheInput")?;
...
pub enum InvalidateProjectCacheError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvalidateProjectCacheError) for what information is available for the error.")]
...
impl InvalidateProjectCacheError {
    /// Creates the `InvalidateProjectCacheError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InvalidateProjectCacheError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvalidateProjectCacheError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invalidate_project_cache::InvalidateProjectCacheError {
...
mod _invalidate_project_cache_output;
