...
/// Orchestration and serialization glue logic for `DescribeCodeCoverages`.
...
impl DescribeCodeCoverages {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_code_coverages::DescribeCodeCoveragesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_code_coverages::DescribeCodeCoveragesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_code_coverages::DescribeCodeCoveragesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_code_coverages::DescribeCodeCoveragesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCodeCoverages {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCodeCoverages");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCodeCoveragesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCodeCoveragesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCodeCoverages")
...
.with_interceptor(DescribeCodeCoveragesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_code_coverages::DescribeCodeCoveragesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_code_coverages::DescribeCodeCoveragesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_code_coverages::DescribeCodeCoveragesError>::new());
...
#[derive(Debug)]
            struct DescribeCodeCoveragesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCodeCoveragesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_code_coverages::de_describe_code_coverages_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeCodeCoveragesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCodeCoveragesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_code_coverages::DescribeCodeCoveragesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_code_coverages::DescribeCodeCoveragesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_code_coverages::ser_describe_code_coverages_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCodeCoveragesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCodeCoveragesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCodeCoveragesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCodeCoveragesInput>()
                        .ok_or("failed to downcast to DescribeCodeCoveragesInput")?;
...
pub enum DescribeCodeCoveragesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCodeCoveragesError) for what information is available for the error.")]
...
impl DescribeCodeCoveragesError {
    /// Creates the `DescribeCodeCoveragesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCodeCoveragesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCodeCoveragesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_code_coverages::DescribeCodeCoveragesError {
...
mod _describe_code_coverages_output;
