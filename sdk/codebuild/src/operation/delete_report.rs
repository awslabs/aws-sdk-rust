...
impl DeleteReportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_report::DeleteReport, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_report::ser_delete_report_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_report::de_delete_report_http_response_with_props(status, headers, body)
        }
    }
}
