...
impl StopBuildBatchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_build_batch::StopBuildBatch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_build_batch::ser_stop_build_batch_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopBuildBatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_build_batch::de_stop_build_batch_http_response_with_props(status, headers, body)
        }
    }
}
