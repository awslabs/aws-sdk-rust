...
impl DescribeTestCasesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_test_cases::ser_describe_test_cases_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTestCases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_test_cases::de_describe_test_cases_http_response_with_props(status, headers, body)
        }
    }
}
