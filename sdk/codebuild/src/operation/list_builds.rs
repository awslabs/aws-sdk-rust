...
impl ListBuildsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_builds::ListBuilds, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_builds::ser_list_builds_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBuilds {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_builds::de_list_builds_http_response_with_props(status, headers, body)
        }
    }
}
