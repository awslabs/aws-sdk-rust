...
impl ListReportsForReportGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_reports_for_report_group::ListReportsForReportGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReportsForReportGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_reports_for_report_group::de_list_reports_for_report_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
