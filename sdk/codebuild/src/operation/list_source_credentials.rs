...
impl ListSourceCredentialsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_source_credentials::ListSourceCredentials,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSourceCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_source_credentials::de_list_source_credentials_http_response_with_props(status, headers, body)
        }
    }
}
