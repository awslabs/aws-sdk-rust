...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::batch_get_reports::BatchGetReportsOutput,
                    crate::operation::batch_get_reports::BatchGetReportsError,
                > for BatchGetReportsFluentBuilder
            {
                fn send(
                    self,
...
impl BatchGetReportsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_reports::BatchGetReportsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_reports::BatchGetReportsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_reports::BatchGetReportsOutput, crate::operation::batch_get_reports::BatchGetReportsError, Self> {
