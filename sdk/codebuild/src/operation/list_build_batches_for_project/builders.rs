...
impl ListBuildBatchesForProjectFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_build_batches_for_project::ListBuildBatchesForProjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_build_batches_for_project::ListBuildBatchesForProjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_build_batches_for_project::ListBuildBatchesForProjectOutput, crate::operation::list_build_batches_for_project::ListBuildBatchesForProjectError, Self> {
