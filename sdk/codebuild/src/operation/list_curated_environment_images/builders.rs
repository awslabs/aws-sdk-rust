...
impl crate::operation::list_curated_environment_images::builders::ListCuratedEnvironmentImagesInputBuilder {
...
impl ListCuratedEnvironmentImagesFluentBuilder {
    /// Creates a new `ListCuratedEnvironmentImagesFluentBuilder`.
