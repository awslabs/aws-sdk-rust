...
impl CreateFleet {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeBuild", "CreateFleet", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFleet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateFleet", "CodeBuild"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFleetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("fleetServiceRole") {
            if let ::std::option::Option::Some(value) = input.fleet_service_role.as_deref() {
                captured.insert("fleetServiceRole", value);
            }
        }
...
impl CreateFleetError {
    ...
    /// Returns `true` if the error kind is `CreateFleetError::AccountLimitExceededException`.
    pub fn is_account_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::AccountLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateFleetError::InvalidInputException`.
