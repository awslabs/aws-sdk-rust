...
impl ListReportGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_report_groups::ser_list_report_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReportGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_report_groups::de_list_report_groups_http_response_with_props(status, headers, body)
        }
    }
}
