...
impl BatchGetProjectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_get_projects::BatchGetProjects,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_projects::ser_batch_get_projects_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetProjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_projects::de_batch_get_projects_http_response_with_props(status, headers, body)
        }
    }
}
