...
impl ListReportsForReportGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_reports_for_report_group::ListReportsForReportGroupInput, ::aws_smithy_types::error::operation::BuildError> {
