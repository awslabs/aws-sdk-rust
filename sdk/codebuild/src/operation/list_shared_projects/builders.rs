...
impl ListSharedProjectsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_shared_projects::ListSharedProjectsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_shared_projects::ListSharedProjectsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_shared_projects::ListSharedProjectsOutput, crate::operation::list_shared_projects::ListSharedProjectsError, Self> {
