...
impl UpdateReportGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_report_group::ser_update_report_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateReportGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_report_group::de_update_report_group_http_response_with_props(status, headers, body)
        }
    }
}
