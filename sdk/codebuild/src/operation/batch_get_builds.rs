...
impl BatchGetBuildsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_get_builds::BatchGetBuilds, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_builds::ser_batch_get_builds_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetBuilds {
    type Output =
        ::std::result::Result<crate::operation::batch_get_builds::BatchGetBuildsOutput, crate::operation::batch_get_builds::BatchGetBuildsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_builds::de_batch_get_builds_http_response_with_props(status, headers, body)
        }
    }
}
