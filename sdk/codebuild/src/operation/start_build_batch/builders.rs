...
impl StartBuildBatchFluentBuilder  {
    /// Creates a new `StartBuildBatch`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::start_build_batch::StartBuildBatch, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::start_build_batch::StartBuildBatchError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::start_build_batch::StartBuildBatchOutput, aws_smithy_http::result::SdkError<crate::operation::start_build_batch::StartBuildBatchError>>
                     {
