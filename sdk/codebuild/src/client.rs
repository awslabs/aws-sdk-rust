...
/// For example, the [`CreateProject`](crate::operation) operation has
...
mod batch_delete_builds;

mod batch_get_build_batches;
...
mod delete_report_group;

mod delete_resource_policy;

mod delete_source_credentials;

mod delete_webhook;

mod describe_code_coverages;

mod describe_test_cases;
...
mod get_report_group_trend;

mod get_resource_policy;

mod import_source_credentials;

mod invalidate_project_cache;

mod list_build_batches;

mod list_build_batches_for_project;
...
mod list_shared_report_groups;

mod list_source_credentials;

mod put_resource_policy;

mod retry_build;

mod retry_build_batch;
...
mod update_project_visibility;

mod update_report_group;
