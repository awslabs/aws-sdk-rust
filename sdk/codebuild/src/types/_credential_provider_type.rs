...
/// }
/// ```
/// The above code demonstrates that when `credentialprovidertype` represents
...
/// version of SDK where the variant `CredentialProviderType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for CredentialProviderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CredentialProviderType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CredentialProviderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CredentialProviderType::from(s))
    }
}
