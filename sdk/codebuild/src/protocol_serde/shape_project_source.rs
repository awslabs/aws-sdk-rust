...
pub fn ser_project_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProjectSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_project_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProjectSource>, aws_smithy_json::deserialize::error::DeserializeError>
