...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::import_source_credentials::ImportSourceCredentialsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::import_source_credentials::ImportSourceCredentialsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccountLimitExceededException" => {
            crate::operation::import_source_credentials::ImportSourceCredentialsError::AccountLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceAlreadyExistsException" => {
            crate::operation::import_source_credentials::ImportSourceCredentialsError::ResourceAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_import_source_credentials::de_import_source_credentials(_response_body, output)
            .map_err(crate::operation::import_source_credentials::ImportSourceCredentialsError::unhandled)?;
