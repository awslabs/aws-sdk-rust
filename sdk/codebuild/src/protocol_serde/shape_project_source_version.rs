...
pub(crate) fn de_project_source_version<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ProjectSourceVersion>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
