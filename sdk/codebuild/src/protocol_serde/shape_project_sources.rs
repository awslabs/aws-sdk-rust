...
pub(crate) fn de_project_sources<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ProjectSource>>, aws_smithy_json::deserialize::error::DeserializeError>
