            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "phases" => {
                            builder = builder.set_phases(crate::protocol_serde::shape_build_batch_phases::de_build_batch_phases(tokens)?);
                        }
                        "source" => {
                        ...
                        "buildGroups" => {
                            builder = builder.set_build_groups(crate::protocol_serde::shape_build_groups::de_build_groups(tokens)?);
                        }
                        "debugSessionEnabled" => {
