...
pub(crate) fn de_projects<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Project>>, aws_smithy_json::deserialize::error::DeserializeError>
