...
pub(crate) fn de_project_environment<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ProjectEnvironment>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "fleet" => {
                                builder = builder.set_fleet(
                                    crate::protocol_serde::shape_project_fleet::de_project_fleet(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::project_environment_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
