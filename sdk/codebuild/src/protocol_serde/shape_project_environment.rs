...
pub fn ser_project_environment(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProjectEnvironment) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_project_environment<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProjectEnvironment>, aws_smithy_json::deserialize::error::DeserializeError>
