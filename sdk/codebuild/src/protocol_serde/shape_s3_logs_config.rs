...
pub(crate) fn de_s3_logs_config<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::S3LogsConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LogsConfigStatusType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "location" => {
