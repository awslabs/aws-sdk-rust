...
pub fn ser_delete_project_input(
    ...
    crate::protocol_serde::shape_delete_project_input::ser_delete_project_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        "InvalidInputException" => {
            crate::operation::delete_project::DeleteProjectError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input_exception::de_invalid_input_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_project::DeleteProjectError::unhandled)?;
