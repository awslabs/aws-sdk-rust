...
pub fn ser_create_report_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReportGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
