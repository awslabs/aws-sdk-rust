...
pub fn ser_list_shared_projects_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSharedProjectsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
