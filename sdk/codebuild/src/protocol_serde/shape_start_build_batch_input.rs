...
pub fn ser_start_build_batch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartBuildBatchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
