    ...
    Err(match error_code {
        "InvalidInputException" => crate::error::ListProjectsError::InvalidInputException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_invalid_input_exception::de_invalid_input_exception_json_err(response.body().as_ref(), output).map_err(crate::error::ListProjectsError::unhandled)?;
