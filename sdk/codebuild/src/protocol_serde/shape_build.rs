                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "phases" => {
                                builder = builder.set_phases(
                                    crate::protocol_serde::shape_build_phases::de_build_phases(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "logs" => {
                                builder = builder.set_logs(
                                    crate::protocol_serde::shape_logs_location::de_logs_location(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "debugSession" => {
                                builder = builder.set_debug_session(
                                    crate::protocol_serde::shape_debug_session::de_debug_session(
                                        tokens,
                                    )?,
                                );
                            }
