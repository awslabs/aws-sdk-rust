            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "phases" => {
                            builder = builder.set_phases(crate::protocol_serde::shape_build_phases::de_build_phases(tokens)?);
                        }
                        "source" => {
                        ...
                        "artifacts" => {
                            builder = builder.set_artifacts(crate::protocol_serde::shape_build_artifacts::de_build_artifacts(tokens)?);
                        }
                        "secondaryArtifacts" => {
                            builder =
                                builder.set_secondary_artifacts(crate::protocol_serde::shape_build_artifacts_list::de_build_artifacts_list(tokens)?);
                        }
                        "cache" => {
                        ...
                        "debugSession" => {
                            builder = builder.set_debug_session(crate::protocol_serde::shape_debug_session::de_debug_session(tokens)?);
                        }
                        "buildBatchArn" => {
