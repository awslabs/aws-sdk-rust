...
pub fn ser_create_webhook_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_webhook::CreateWebhookInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
