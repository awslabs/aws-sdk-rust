...
pub fn ser_list_reports_for_report_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_reports_for_report_group::ListReportsForReportGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
