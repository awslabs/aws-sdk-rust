...
pub fn ser_project_artifacts(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProjectArtifacts) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_project_artifacts<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProjectArtifacts>, aws_smithy_json::deserialize::error::DeserializeError>
