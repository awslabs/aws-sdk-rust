...
pub fn ser_list_build_batches_for_project_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListBuildBatchesForProjectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
