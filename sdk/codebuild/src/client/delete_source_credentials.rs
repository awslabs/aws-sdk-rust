...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_source_credentials::builders::DeleteSourceCredentialsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_source_credentials::builders::DeleteSourceCredentialsFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the token.</p><br>
