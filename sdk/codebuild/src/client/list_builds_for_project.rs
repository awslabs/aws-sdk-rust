...
impl super::Client {
    ...
    ///   - [`project_name(impl Into<String>)`](crate::operation::list_builds_for_project::builders::ListBuildsForProjectFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::list_builds_for_project::builders::ListBuildsForProjectFluentBuilder::set_project_name): <p>The name of the CodeBuild project.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_builds_for_project::builders::ListBuildsForProjectFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_builds_for_project::builders::ListBuildsForProjectFluentBuilder::set_next_token): <p>During a previous call, if there are more than 100 items in the list, only the first 100 items are returned, along with a unique string called a <i>nextToken</i>. To get the next batch of items in the list, call this operation again, adding the next token to the call. To get all of the items in the list, keep calling this operation with each subsequent next token that is returned, until no more next tokens are returned.</p>
