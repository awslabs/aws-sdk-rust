...
impl super::Client {
    ...
    ///   - [`sort_by(SharedResourceSortByType)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::sort_by) / [`set_sort_by(Option<SharedResourceSortByType>)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::set_sort_by): <p> The criterion to be used to list build projects shared with the current Amazon Web Services account or user. Valid values include: </p>  <ul>   <li> <p> <code>ARN</code>: List based on the ARN. </p> </li>   <li> <p> <code>MODIFIED_TIME</code>: List based on when information about the shared project was last changed. </p> </li>  </ul>
    ///   - [`sort_order(SortOrderType)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::sort_order) / [`set_sort_order(Option<SortOrderType>)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::set_sort_order): <p>The order in which to list shared build projects. Valid values include:</p>  <ul>   <li> <p> <code>ASCENDING</code>: List in ascending order.</p> </li>   <li> <p> <code>DESCENDING</code>: List in descending order.</p> </li>  </ul>
    ///   - [`max_results(i32)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::set_max_results): <p> The maximum number of paginated shared build projects returned per response. Use <code>nextToken</code> to iterate pages in the list of returned <code>Project</code> objects. The default value is 100. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::set_next_token): <p> During a previous call, the maximum number of items that can be returned is the value specified in <code>maxResults</code>. If there more items in the list, then a unique string called a <i>nextToken</i> is returned. To get the next batch of items in the list, call this operation again, adding the next token to the call. To get all of the items in the list, keep calling this operation with each subsequent next token that is returned, until no more next tokens are returned. </p>
    ...
    pub fn list_shared_projects(
        &self,
    ) -> crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder {
        crate::operation::list_shared_projects::builders::ListSharedProjectsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
