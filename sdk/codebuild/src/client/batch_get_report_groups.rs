...
impl super::Client {
    ...
    ///   - [`report_group_arns(impl Into<String>)`](crate::operation::batch_get_report_groups::builders::BatchGetReportGroupsFluentBuilder::report_group_arns) / [`set_report_group_arns(Option<Vec<String>>)`](crate::operation::batch_get_report_groups::builders::BatchGetReportGroupsFluentBuilder::set_report_group_arns): <p> An array of report group ARNs that identify the report groups to return. </p>
