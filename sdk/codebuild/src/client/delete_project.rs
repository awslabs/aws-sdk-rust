...
impl super::Client  {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_name): <p>The name of the build project.</p>
