...
impl super::Client {
    ...
    ///   - [`report_group_arn(impl ::std::convert::Into<String>)`](crate::operation::get_report_group_trend::builders::GetReportGroupTrendFluentBuilder::report_group_arn) / [`set_report_group_arn(Option<String>)`](crate::operation::get_report_group_trend::builders::GetReportGroupTrendFluentBuilder::set_report_group_arn): <p>The ARN of the report group that contains the reports to analyze.</p>
