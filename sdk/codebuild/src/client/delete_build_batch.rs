...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_build_batch::builders::DeleteBuildBatchFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_build_batch::builders::DeleteBuildBatchFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the batch build to delete.</p><br>
