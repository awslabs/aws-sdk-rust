...
impl super::Client {
    ...
    ///   - [`username(impl ::std::convert::Into<String>)`](crate::operation::import_source_credentials::builders::ImportSourceCredentialsFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::import_source_credentials::builders::ImportSourceCredentialsFluentBuilder::set_username): <p> The Bitbucket username when the <code>authType</code> is BASIC_AUTH. This parameter is not valid for other types of source providers or connections. </p>
    ///   - [`token(impl ::std::convert::Into<String>)`](crate::operation::import_source_credentials::builders::ImportSourceCredentialsFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::import_source_credentials::builders::ImportSourceCredentialsFluentBuilder::set_token): <p> For GitHub or GitHub Enterprise, this is the personal access token. For Bitbucket, this is the app password. </p>
