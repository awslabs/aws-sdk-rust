...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::update_report_group::builders::UpdateReportGroupFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::update_report_group::builders::UpdateReportGroupFluentBuilder::set_tags): <p> An updated list of tag key and value pairs associated with this report group. </p>  <p>These tags are available for use by Amazon Web Services services that support CodeBuild report group tags.</p>
