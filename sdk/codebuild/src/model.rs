...
pub struct Webhook  {
    ...
    #[doc(hidden)]pub payload_url: std::option::Option<std::string::String>,
    /// <p>The secret token of the associated repository. </p> <note> 
    /// <p>A Bitbucket webhook does not support <code>secret</code>. </p> 
    /// </note>
    #[doc(hidden)]pub secret: std::option::Option<std::string::String>,
    ...
    /// </note>
    #[doc(hidden)]pub branch_filter: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub filter_groups: std::option::Option<std::vec::Vec<std::vec::Vec<crate::model::WebhookFilter>>>,
    /// <p>Specifies the type of build this webhook will trigger.</p>
    #[doc(hidden)]pub build_type: std::option::Option<crate::model::WebhookBuildType>,
    /// <p>A timestamp that indicates the last time a repository's secret token was modified. </p>
    #[doc(hidden)]pub last_modified_secret: std::option::Option<aws_smithy_types::DateTime>,
}
impl Webhook {
    /// <p>The URL to the webhook.</p>
...
pub struct WebhookFilter  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::WebhookFilterType>,
    ...
    #[doc(hidden)]pub exclude_matched_pattern: std::option::Option<bool>,
}
impl WebhookFilter {
    /// <p> The type of webhook filter. There are six webhook filter types: <code>EVENT</code>, <code>ACTOR_ACCOUNT_ID</code>, <code>HEAD_REF</code>, <code>BASE_REF</code>, <code>FILE_PATH</code>, and <code>COMMIT_MESSAGE</code>. </p> 
    /// <dl> 
...
pub struct ReportGroup  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ReportType>,
    /// <p>Information about the destination where the raw data of this <code>ReportGroup</code> is exported. </p>
    #[doc(hidden)]pub export_config: std::option::Option<crate::model::ReportExportConfig>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ReportGroupStatusType>,
}
impl ReportGroup {
    /// <p>The ARN of the <code>ReportGroup</code>. </p>
...
pub struct ReportExportConfig  {
    ...
    /// </ul>
    #[doc(hidden)]pub export_config_type: std::option::Option<crate::model::ReportExportConfigType>,
    ...
    #[doc(hidden)]pub s3_destination: std::option::Option<crate::model::S3ReportExportConfig>,
}
...
pub struct S3ReportExportConfig  {
    ...
    #[doc(hidden)]pub bucket_owner: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub packaging: std::option::Option<crate::model::ReportPackagingType>,
    ...
    #[doc(hidden)]pub encryption_disabled: std::option::Option<bool>,
}
...
pub struct Project  {
    ...
    #[doc(hidden)]pub source: std::option::Option<crate::model::ProjectSource>,
    /// <p>An array of <code>ProjectSource</code> objects. </p>
    #[doc(hidden)]pub secondary_sources: std::option::Option<std::vec::Vec<crate::model::ProjectSource>>,
    ...
    #[doc(hidden)]pub secondary_source_versions: std::option::Option<std::vec::Vec<crate::model::ProjectSourceVersion>>,
    /// <p>Information about the build output artifacts for the build project.</p>
    #[doc(hidden)]pub artifacts: std::option::Option<crate::model::ProjectArtifacts>,
    /// <p>An array of <code>ProjectArtifacts</code> objects. </p>
    #[doc(hidden)]pub secondary_artifacts: std::option::Option<std::vec::Vec<crate::model::ProjectArtifacts>>,
    /// <p>Information about the cache for the build project.</p>
    #[doc(hidden)]pub cache: std::option::Option<crate::model::ProjectCache>,
    /// <p>Information about the build environment for this build project.</p>
    #[doc(hidden)]pub environment: std::option::Option<crate::model::ProjectEnvironment>,
    ...
    #[doc(hidden)]pub queued_timeout_in_minutes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub badge: std::option::Option<crate::model::ProjectBadge>,
    /// <p>Information about logs for the build project. A project can create logs in CloudWatch Logs, an S3 bucket, or both. </p>
    #[doc(hidden)]pub logs_config: std::option::Option<crate::model::LogsConfig>,
    /// <p> An array of <code>ProjectFileSystemLocation</code> objects for a CodeBuild build project. A <code>ProjectFileSystemLocation</code> object specifies the <code>identifier</code>, <code>location</code>, <code>mountOptions</code>, <code>mountPoint</code>, and <code>type</code> of a file system created using Amazon Elastic File System. </p>
    #[doc(hidden)]pub file_system_locations: std::option::Option<std::vec::Vec<crate::model::ProjectFileSystemLocation>>,
    /// <p>A <code>ProjectBuildBatchConfig</code> object that defines the batch build options for the project.</p>
    #[doc(hidden)]pub build_batch_config: std::option::Option<crate::model::ProjectBuildBatchConfig>,
    ...
    #[doc(hidden)]pub concurrent_build_limit: std::option::Option<i32>,
    /// <p>Specifies the visibility of the project's builds. Possible values are:</p> 
    /// <dl> 
    /// <dt>
    /// PUBLIC_READ
    ...
    #[doc(hidden)]pub resource_access_role: std::option::Option<std::string::String>,
}
impl Project {
    /// <p>The name of the build project.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ProjectBuildBatchConfig  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub batch_report_mode: std::option::Option<crate::model::BatchReportModeType>,
}
...
pub struct BatchRestrictions  {
    ...
    #[doc(hidden)]pub maximum_builds_allowed: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub compute_types_allowed: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct ProjectFileSystemLocation  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::FileSystemType>,
    ...
    #[doc(hidden)]pub mount_options: std::option::Option<std::string::String>,
}
...
pub struct LogsConfig  {
    ...
    #[doc(hidden)]pub cloud_watch_logs: std::option::Option<crate::model::CloudWatchLogsConfig>,
    /// <p> Information about logs built to an S3 bucket for a build project. S3 logs are not enabled by default. </p>
    #[doc(hidden)]pub s3_logs: std::option::Option<crate::model::S3LogsConfig>,
}
impl LogsConfig {
    /// <p> Information about CloudWatch Logs for a build project. CloudWatch Logs are enabled by default. </p>
...
pub struct S3LogsConfig  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::LogsConfigStatusType>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub bucket_owner_access: std::option::Option<crate::model::BucketOwnerAccess>,
}
impl S3LogsConfig {
    /// <p>The current status of the S3 build logs. Valid values are:</p> 
    /// <ul> 
...
pub struct ProjectBadge  {
    ...
    #[doc(hidden)]pub badge_enabled: bool,
    /// <p>The publicly-accessible URL through which you can access the build badge for your project. </p>
    #[doc(hidden)]pub badge_request_url: std::option::Option<std::string::String>,
}
impl ProjectBadge {
    /// <p>Set this to true to generate a publicly accessible URL for your project's build badge.</p>
...
pub struct ProjectEnvironment  {
    ...
    #[doc(hidden)]pub environment_variables: std::option::Option<std::vec::Vec<crate::model::EnvironmentVariable>>,
    ...
    #[doc(hidden)]pub privileged_mode: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub registry_credential: std::option::Option<crate::model::RegistryCredential>,
    ...
    #[doc(hidden)]pub image_pull_credentials_type: std::option::Option<crate::model::ImagePullCredentialsType>,
}
...
impl  std::fmt::Debug for ProjectEnvironment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("image_pull_credentials_type", &self.image_pull_credentials_type);
        formatter.finish()
    }
}
...
pub struct RegistryCredential  {
    ...
    /// </note>
    #[doc(hidden)]pub credential: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub credential_provider: std::option::Option<crate::model::CredentialProviderType>,
}
...
pub struct EnvironmentVariable  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::EnvironmentVariableType>,
}
...
pub struct ProjectCache  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::CacheType>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub modes: std::option::Option<std::vec::Vec<crate::model::CacheMode>>,
}
impl ProjectCache {
    /// <p>The type of cache used by the build project. Valid values include:</p> 
    /// <ul> 
...
pub struct ProjectArtifacts  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ArtifactsType>,
    ...
    /// /MyArtifact.zip
    /// </build-id></code>.</p>
    #[doc(hidden)]pub namespace_type: std::option::Option<crate::model::ArtifactNamespace>,
    ...
    /// </ul> </li> 
    /// </ul>
    #[doc(hidden)]pub packaging: std::option::Option<crate::model::ArtifactPackaging>,
    ...
    #[doc(hidden)]pub override_artifact_name: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub artifact_identifier: std::option::Option<std::string::String>,
    /// <p>Specifies the bucket owner's access for objects that another account uploads to their Amazon S3 bucket. By default, only the account that uploads the objects to the bucket has access to these objects. This property allows you to give the bucket owner access to these objects.</p> <note> 
    /// <p>To use this property, your CodeBuild service role must have the <code>s3:PutBucketAcl</code> permission. This permission allows CodeBuild to modify the access control list for the bucket.</p> 
    /// </note> 
    /// <p>This property can be one of the following values:</p> 
...
pub struct ProjectSource  {
    ...
    #[doc(hidden)]pub git_clone_depth: std::option::Option<i32>,
    /// <p> Information about the Git submodules configuration for the build project. </p>
    #[doc(hidden)]pub git_submodules_config: std::option::Option<crate::model::GitSubmodulesConfig>,
    ...
    #[doc(hidden)]pub buildspec: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub auth: std::option::Option<crate::model::SourceAuth>,
    ...
    #[doc(hidden)]pub report_build_status: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub build_status_config: std::option::Option<crate::model::BuildStatusConfig>,
    /// <p>Enable this flag to ignore SSL warnings while connecting to the project source code.</p>
    #[doc(hidden)]pub insecure_ssl: std::option::Option<bool>,
...
pub struct BuildStatusConfig  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub target_url: std::option::Option<std::string::String>,
}
...
pub struct SourceAuth  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::SourceAuthType>,
...
pub struct GitSubmodulesConfig  {
    ...
    #[doc(hidden)]pub fetch_submodules: std::option::Option<bool>,
}
...
pub struct BuildBatch  {
    ...
    #[doc(hidden)]pub current_phase: std::option::Option<std::string::String>,
    /// <p>The status of the batch build.</p>
    #[doc(hidden)]pub build_batch_status: std::option::Option<crate::model::StatusType>,
    ...
    /// </ul>
    #[doc(hidden)]pub resolved_source_version: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub phases: std::option::Option<std::vec::Vec<crate::model::BuildBatchPhase>>,
    /// <p>Information about the build input source code for the build project.</p>
    #[doc(hidden)]pub source: std::option::Option<crate::model::ProjectSource>,
    ...
    #[doc(hidden)]pub artifacts: std::option::Option<crate::model::BuildArtifacts>,
    /// <p>An array of <code>BuildArtifacts</code> objects the define the build artifacts for this batch build.</p>
    #[doc(hidden)]pub secondary_artifacts: std::option::Option<std::vec::Vec<crate::model::BuildArtifacts>>,
    /// <p>Information about the cache for the build project.</p>
    #[doc(hidden)]pub cache: std::option::Option<crate::model::ProjectCache>,
    /// <p>Information about the build environment of the build project.</p>
    #[doc(hidden)]pub environment: std::option::Option<crate::model::ProjectEnvironment>,
    ...
    #[doc(hidden)]pub service_role: std::option::Option<std::string::String>,
    /// <p> Information about logs for a build project. These can be logs in CloudWatch Logs, built in a specified S3 bucket, or both. </p>
    #[doc(hidden)]pub log_config: std::option::Option<crate::model::LogsConfig>,
    /// <p>Specifies the maximum amount of time, in minutes, that the build in a batch must be completed in.</p>
    #[doc(hidden)]pub build_timeout_in_minutes: std::option::Option<i32>,
    ...
    /// </ul>
    #[doc(hidden)]pub initiator: std::option::Option<std::string::String>,
    /// <p>Information about the VPC configuration that CodeBuild accesses.</p>
    #[doc(hidden)]pub vpc_config: std::option::Option<crate::model::VpcConfig>,
    ...
    #[doc(hidden)]pub build_batch_number: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub build_groups: std::option::Option<std::vec::Vec<crate::model::BuildGroup>>,
    ...
    #[doc(hidden)]pub debug_session_enabled: std::option::Option<bool>,
}
impl BuildBatch {
    /// <p>The identifier of the batch build.</p>
...
pub struct BuildGroup  {
    ...
    #[doc(hidden)]pub depends_on: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Specifies if failures in this build group can be ignored.</p>
    #[doc(hidden)]pub ignore_failure: bool,
    /// <p>A <code>BuildSummary</code> object that contains a summary of the current build group.</p>
    #[doc(hidden)]pub current_build_summary: std::option::Option<crate::model::BuildSummary>,
    /// <p>An array of <code>BuildSummary</code> objects that contain summaries of previous build groups.</p>
    #[doc(hidden)]pub prior_build_summary_list: std::option::Option<std::vec::Vec<crate::model::BuildSummary>>,
}
impl BuildGroup {
    /// <p>Contains the identifier of the build group.</p>
    pub fn identifier(&self) -> std::option::Option<& str> {
...
pub struct BuildSummary  {
    ...
    #[doc(hidden)]pub requested_on: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub build_status: std::option::Option<crate::model::StatusType>,
    /// <p>A <code>ResolvedArtifact</code> object that represents the primary build artifacts for the build group.</p>
    #[doc(hidden)]pub primary_artifact: std::option::Option<crate::model::ResolvedArtifact>,
    /// <p>An array of <code>ResolvedArtifact</code> objects that represents the secondary build artifacts for the build group.</p>
    #[doc(hidden)]pub secondary_artifacts: std::option::Option<std::vec::Vec<crate::model::ResolvedArtifact>>,
}
impl BuildSummary {
    /// <p>The batch build ARN.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct BuildArtifacts  {
    ...
    /// </note>
    #[doc(hidden)]pub sha256sum: std::option::Option<std::string::String>,
    /// <p>The MD5 hash of the build artifact.</p> 
    /// <p>You can use this hash along with a checksum tool to confirm file integrity and authenticity.</p> <note> 
    /// <p>This value is available only if the build project's <code>packaging</code> value is set to <code>ZIP</code>.</p> 
    /// </note>
    #[doc(hidden)]pub md5sum: std::option::Option<std::string::String>,
    /// <p> If this flag is set, a name specified in the buildspec file overrides the artifact name. The name specified in a buildspec file is calculated at build time and uses the Shell Command Language. For example, you can append a date and time to your artifact name so that it is always unique. </p>
    #[doc(hidden)]pub override_artifact_name: std::option::Option<bool>,
...
pub struct BuildBatchPhase  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub phase_type: std::option::Option<crate::model::BuildBatchPhaseType>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub phase_status: std::option::Option<crate::model::StatusType>,
    ...
    #[doc(hidden)]pub duration_in_seconds: std::option::Option<i64>,
    /// <p>Additional information about the batch build phase. Especially to help troubleshoot a failed batch build.</p>
    #[doc(hidden)]pub contexts: std::option::Option<std::vec::Vec<crate::model::PhaseContext>>,
}
...
pub struct Build  {
    ...
    #[doc(hidden)]pub build_number: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub phases: std::option::Option<std::vec::Vec<crate::model::BuildPhase>>,
    ...
    #[doc(hidden)]pub logs: std::option::Option<crate::model::LogsLocation>,
    ...
    #[doc(hidden)]pub build_complete: bool,
    ...
    #[doc(hidden)]pub exported_environment_variables: std::option::Option<std::vec::Vec<crate::model::ExportedEnvironmentVariable>>,
    /// <p> An array of the ARNs associated with this build's reports. </p>
    #[doc(hidden)]pub report_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p> An array of <code>ProjectFileSystemLocation</code> objects for a CodeBuild build project. A <code>ProjectFileSystemLocation</code> object specifies the <code>identifier</code>, <code>location</code>, <code>mountOptions</code>, <code>mountPoint</code>, and <code>type</code> of a file system created using Amazon Elastic File System. </p>
    #[doc(hidden)]pub file_system_locations: std::option::Option<std::vec::Vec<crate::model::ProjectFileSystemLocation>>,
    /// <p>Contains information about the debug session for this build.</p>
    #[doc(hidden)]pub debug_session: std::option::Option<crate::model::DebugSession>,
    /// <p>The ARN of the batch build that this build is a member of, if applicable.</p>
    #[doc(hidden)]pub build_batch_arn: std::option::Option<std::string::String>,
}
impl Build {
    /// <p>The unique ID for the build.</p>
    pub fn id(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for Build  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("encryption_key", &self.encryption_key);
        formatter.field("exported_environment_variables", &self.exported_environment_variables);
...
pub struct DebugSession  {
    ...
    #[doc(hidden)]pub session_enabled: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub session_target: std::option::Option<std::string::String>,
}
impl DebugSession {
    /// <p>Specifies if session debugging is enabled for this build.</p>
...
pub struct LogsLocation  {
    ...
    #[doc(hidden)]pub deep_link: std::option::Option<std::string::String>,
    /// <p> The URL to a build log in an S3 bucket. </p>
    #[doc(hidden)]pub s3_deep_link: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cloud_watch_logs_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub s3_logs_arn: std::option::Option<std::string::String>,
    /// <p> Information about CloudWatch Logs for a build project. </p>
    #[doc(hidden)]pub cloud_watch_logs: std::option::Option<crate::model::CloudWatchLogsConfig>,
    /// <p> Information about S3 logs for a build project. </p>
    #[doc(hidden)]pub s3_logs: std::option::Option<crate::model::S3LogsConfig>,
...
pub struct BuildPhase  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub phase_type: std::option::Option<crate::model::BuildPhaseType>,
...
pub struct SourceCredentialsInfo  {
    ...
    #[doc(hidden)]pub server_type: std::option::Option<crate::model::ServerType>,
    /// <p> The type of authentication used by the credentials. Valid options are OAUTH, BASIC_AUTH, or PERSONAL_ACCESS_TOKEN. </p>
    #[doc(hidden)]pub auth_type: std::option::Option<crate::model::AuthType>,
}
...
pub struct ReportFilter  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ReportStatusType>,
}
impl ReportFilter {
    /// <p> The status used to filter reports. You can filter using one status only. </p>
...
pub struct EnvironmentPlatform  {
    ...
    #[doc(hidden)]pub platform: std::option::Option<crate::model::PlatformType>,
    /// <p>The list of programming languages that are available for the specified platform.</p>
    #[doc(hidden)]pub languages: std::option::Option<std::vec::Vec<crate::model::EnvironmentLanguage>>,
}
...
pub struct EnvironmentLanguage  {
    ...
    #[doc(hidden)]pub language: std::option::Option<crate::model::LanguageType>,
    /// <p>The list of Docker images that are related by the specified programming language.</p>
    #[doc(hidden)]pub images: std::option::Option<std::vec::Vec<crate::model::EnvironmentImage>>,
}
...
pub struct ReportWithRawData  {
    ...
    #[doc(hidden)]pub report_arn: std::option::Option<std::string::String>,
...
pub struct ReportGroupTrendStats  {
    ...
    #[doc(hidden)]pub average: std::option::Option<std::string::String>,
...
pub struct TestCase  {
    ...
    #[doc(hidden)]pub test_raw_data_path: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub duration_in_nano_seconds: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub expired: std::option::Option<aws_smithy_types::DateTime>,
}
impl TestCase {
    /// <p> The ARN of the report to which the test case belongs. </p>
    pub fn report_arn(&self) -> std::option::Option<& str> {
...
pub struct CodeCoverage  {
    ...
    #[doc(hidden)]pub line_coverage_percentage: std::option::Option<f64>,
    /// <p>The number of lines that are covered by your tests.</p>
    #[doc(hidden)]pub lines_covered: std::option::Option<i32>,
    /// <p>The number of lines that are not covered by your tests.</p>
    #[doc(hidden)]pub lines_missed: std::option::Option<i32>,
    /// <p>The percentage of branches that are covered by your tests.</p>
    #[doc(hidden)]pub branch_coverage_percentage: std::option::Option<f64>,
    /// <p>The number of conditional branches that are covered by your tests.</p>
    #[doc(hidden)]pub branches_covered: std::option::Option<i32>,
    /// <p>The number of conditional branches that are not covered by your tests.</p>
    #[doc(hidden)]pub branches_missed: std::option::Option<i32>,
...
impl  std::fmt::Debug for CodeCoverage  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("branch_coverage_percentage", &self.branch_coverage_percentage);
...
pub struct Report  {
    ...
    #[doc(hidden)]pub report_group_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub truncated: std::option::Option<bool>,
    /// <p> A <code>TestReportSummary</code> object that contains information about this test report. </p>
    #[doc(hidden)]pub test_summary: std::option::Option<crate::model::TestReportSummary>,
    /// <p>A <code>CodeCoverageReportSummary</code> object that contains a code coverage summary for this report.</p>
    #[doc(hidden)]pub code_coverage_summary: std::option::Option<crate::model::CodeCoverageReportSummary>,
}
impl Report {
    /// <p> The ARN of the report run. </p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct TestReportSummary  {
    ...
    #[doc(hidden)]pub status_counts: std::option::Option<std::collections::HashMap<std::string::String, i32>>,
