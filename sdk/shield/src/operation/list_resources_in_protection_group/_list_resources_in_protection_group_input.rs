...
impl ListResourcesInProtectionGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resources_in_protection_group::ListResourcesInProtectionGroupInput, ::aws_smithy_types::error::operation::BuildError> {
