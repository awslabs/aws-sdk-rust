...
impl DescribeEmergencyContactSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsOutput, crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError, Self> {
