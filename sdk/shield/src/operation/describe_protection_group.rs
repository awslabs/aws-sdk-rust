...
impl DescribeProtectionGroupInput {
    /// Consumes the builder and constructs an Operation<[`DescribeProtectionGroup`](crate::operation::describe_protection_group::DescribeProtectionGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_protection_group::DescribeProtectionGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_protection_group::DescribeProtectionGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_protection_group::DescribeProtectionGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeProtectionGroup {
                type Output = std::result::Result<crate::operation::describe_protection_group::DescribeProtectionGroupOutput, crate::operation::describe_protection_group::DescribeProtectionGroupError>;
