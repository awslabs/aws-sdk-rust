...
impl UpdateEmergencyContactSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEmergencyContactSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_emergency_contact_settings::de_update_emergency_contact_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
