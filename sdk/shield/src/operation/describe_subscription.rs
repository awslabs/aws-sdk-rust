...
/// Orchestration and serialization glue logic for `DescribeSubscription`.
...
impl DescribeSubscription {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_subscription::DescribeSubscriptionInput,
                    ) -> ::std::result::Result<crate::operation::describe_subscription::DescribeSubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_subscription::DescribeSubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_subscription::DescribeSubscriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_subscription::DescribeSubscriptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSubscription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeSubscription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeSubscriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeSubscriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSubscription")
...
.with_interceptor(DescribeSubscriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_subscription::DescribeSubscriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_subscription::DescribeSubscriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_subscription::DescribeSubscriptionError>::new());
...
#[derive(Debug)]
            struct DescribeSubscriptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeSubscriptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_subscription::de_describe_subscription_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeSubscriptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeSubscriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_subscription::DescribeSubscriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_subscription::DescribeSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_subscription::ser_describe_subscription_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct DescribeSubscriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSubscriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeSubscriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeSubscriptionInput>()
                        .ok_or("failed to downcast to DescribeSubscriptionInput")?;
...
pub enum DescribeSubscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeSubscriptionError) for what information is available for the error.")]
...
impl DescribeSubscriptionError {
    /// Creates the `DescribeSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSubscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeSubscriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_subscription::DescribeSubscriptionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_subscription::_describe_subscription_output::DescribeSubscriptionOutput;

pub use crate::operation::describe_subscription::_describe_subscription_input::DescribeSubscriptionInput;

mod _describe_subscription_input;

mod _describe_subscription_output;
