...
impl DescribeSubscriptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_subscription::DescribeSubscription,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_subscription::de_describe_subscription_http_response_with_props(status, headers, body)
        }
    }
}
