...
impl DisassociateDrtRoleInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDRTRole`](crate::operation::disassociate_drt_role::DisassociateDRTRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_drt_role::DisassociateDRTRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_drt_role::DisassociateDrtRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_drt_role::DisassociateDRTRole::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateDRTRole {
                type Output = std::result::Result<crate::operation::disassociate_drt_role::DisassociateDrtRoleOutput, crate::operation::disassociate_drt_role::DisassociateDRTRoleError>;
