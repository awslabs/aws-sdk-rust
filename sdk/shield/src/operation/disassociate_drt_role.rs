...
impl DisassociateDRTRole {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_drt_role::DisassociateDRTRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_drt_role::DisassociateDrtRoleOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Shield", "DisassociateDRTRole", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Shield.DisassociateDRTRole",
                "rpc.service" = "Shield",
                "rpc.method" = "DisassociateDRTRole",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateDRTRole {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateDRTRoleRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateDRTRoleResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateDRTRole")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateDRTRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_drt_role::de_disassociate_drt_role_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disassociate_drt_role::de_disassociate_drt_role_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateDRTRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_drt_role::DisassociateDrtRoleInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_drt_role::ser_disassociate_drt_role_input(
            &input,
        )?);
