...
impl ListResourcesInProtectionGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resources_in_protection_group::ListResourcesInProtectionGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourcesInProtectionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resources_in_protection_group::de_list_resources_in_protection_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
