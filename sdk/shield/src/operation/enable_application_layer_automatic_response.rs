...
impl aws_smithy_http::response::ParseStrictResponse for EnableApplicationLayerAutomaticResponse {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_application_layer_automatic_response::de_enable_application_layer_automatic_response_http_response_with_props(status, headers, body)
        }
    }
}
