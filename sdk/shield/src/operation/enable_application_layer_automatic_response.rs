...
impl EnableApplicationLayerAutomaticResponse {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Shield",
            "rpc.method" = "EnableApplicationLayerAutomaticResponse",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableApplicationLayerAutomaticResponse {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            EnableApplicationLayerAutomaticResponseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            EnableApplicationLayerAutomaticResponseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnableApplicationLayerAutomaticResponse")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableApplicationLayerAutomaticResponse")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnableApplicationLayerAutomaticResponseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct EnableApplicationLayerAutomaticResponseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableApplicationLayerAutomaticResponseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnableApplicationLayerAutomaticResponseInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableApplicationLayerAutomaticResponseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_application_layer_automatic_response::de_enable_application_layer_automatic_response_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_application_layer_automatic_response::de_enable_application_layer_automatic_response_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableApplicationLayerAutomaticResponseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_enable_application_layer_automatic_response::ser_enable_application_layer_automatic_response_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError
{
