...
impl EnableApplicationLayerAutomaticResponse {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableApplicationLayerAutomaticResponse {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableApplicationLayerAutomaticResponse");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableApplicationLayerAutomaticResponseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableApplicationLayerAutomaticResponseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableApplicationLayerAutomaticResponse")
...
.with_interceptor(EnableApplicationLayerAutomaticResponseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError>::new());
...
#[derive(Debug)]
            struct EnableApplicationLayerAutomaticResponseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableApplicationLayerAutomaticResponseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_application_layer_automatic_response::de_enable_application_layer_automatic_response_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_application_layer_automatic_response::de_enable_application_layer_automatic_response_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableApplicationLayerAutomaticResponseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableApplicationLayerAutomaticResponseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_application_layer_automatic_response::ser_enable_application_layer_automatic_response_input(&input)?);
...
#[derive(Debug)]
            struct EnableApplicationLayerAutomaticResponseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableApplicationLayerAutomaticResponseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableApplicationLayerAutomaticResponseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableApplicationLayerAutomaticResponseInput>()
                        .ok_or("failed to downcast to EnableApplicationLayerAutomaticResponseInput")?;
...
pub enum EnableApplicationLayerAutomaticResponseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableApplicationLayerAutomaticResponseError) for what information is available for the error.")]
...
impl EnableApplicationLayerAutomaticResponseError {
    /// Creates the `EnableApplicationLayerAutomaticResponseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableApplicationLayerAutomaticResponseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableApplicationLayerAutomaticResponseError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableApplicationLayerAutomaticResponseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_application_layer_automatic_response::EnableApplicationLayerAutomaticResponseError {
...
mod _enable_application_layer_automatic_response_output;
