...
impl DisableApplicationLayerAutomaticResponse {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseInput,
                    ) -> ::std::result::Result<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableApplicationLayerAutomaticResponse {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableApplicationLayerAutomaticResponse");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableApplicationLayerAutomaticResponseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableApplicationLayerAutomaticResponseResponseDeserializer));
...
.with_interceptor(DisableApplicationLayerAutomaticResponseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>::new());
...
#[derive(Debug)]
            struct DisableApplicationLayerAutomaticResponseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableApplicationLayerAutomaticResponseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_application_layer_automatic_response::de_disable_application_layer_automatic_response_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DisableApplicationLayerAutomaticResponseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableApplicationLayerAutomaticResponseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_application_layer_automatic_response::ser_disable_application_layer_automatic_response_input(&input)?);
...
#[derive(Debug)]
            struct DisableApplicationLayerAutomaticResponseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableApplicationLayerAutomaticResponseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableApplicationLayerAutomaticResponseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableApplicationLayerAutomaticResponseInput>()
                        .ok_or("failed to downcast to DisableApplicationLayerAutomaticResponseInput")?;
...
pub enum DisableApplicationLayerAutomaticResponseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableApplicationLayerAutomaticResponseError) for what information is available for the error.")]
...
impl DisableApplicationLayerAutomaticResponseError {
    /// Creates the `DisableApplicationLayerAutomaticResponseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableApplicationLayerAutomaticResponseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableApplicationLayerAutomaticResponseError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableApplicationLayerAutomaticResponseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError {
...
mod _disable_application_layer_automatic_response_output;
