...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableApplicationLayerAutomaticResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_application_layer_automatic_response::de_disable_application_layer_automatic_response_http_response_with_props(status, headers, body)
        }
    }
}
