...
impl DisableApplicationLayerAutomaticResponseInput {
    /// Consumes the builder and constructs an Operation<[`DisableApplicationLayerAutomaticResponse`](crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponse)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponse, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponse::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisableApplicationLayerAutomaticResponse {
                type Output = std::result::Result<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseOutput, crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>;
...
impl aws_http::request_id::RequestId for crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError {
