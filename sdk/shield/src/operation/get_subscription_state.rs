...
impl GetSubscriptionStateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_subscription_state::GetSubscriptionState,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSubscriptionState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_subscription_state::de_get_subscription_state_http_response_with_props(status, headers, body)
        }
    }
}
