...
impl EnableProactiveEngagement {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::enable_proactive_engagement::EnableProactiveEngagementInput,
                    ) -> ::std::result::Result<crate::operation::enable_proactive_engagement::EnableProactiveEngagementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_proactive_engagement::EnableProactiveEngagementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableProactiveEngagement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableProactiveEngagement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableProactiveEngagementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableProactiveEngagementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableProactiveEngagement")
...
.with_interceptor(EnableProactiveEngagementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementError>::new());
...
#[derive(Debug)]
            struct EnableProactiveEngagementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableProactiveEngagementResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_proactive_engagement::de_enable_proactive_engagement_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_proactive_engagement::de_enable_proactive_engagement_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableProactiveEngagementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableProactiveEngagementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_proactive_engagement::EnableProactiveEngagementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_proactive_engagement::EnableProactiveEngagementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_proactive_engagement::ser_enable_proactive_engagement_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct EnableProactiveEngagementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableProactiveEngagementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableProactiveEngagementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableProactiveEngagementInput>()
                        .ok_or("failed to downcast to EnableProactiveEngagementInput")?;
...
pub enum EnableProactiveEngagementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableProactiveEngagementError) for what information is available for the error.")]
...
impl EnableProactiveEngagementError {
    /// Creates the `EnableProactiveEngagementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableProactiveEngagementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OptimisticLockException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableProactiveEngagementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_proactive_engagement::EnableProactiveEngagementError {
...
mod _enable_proactive_engagement_output;
