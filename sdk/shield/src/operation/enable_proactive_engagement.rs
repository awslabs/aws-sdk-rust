...
impl EnableProactiveEngagementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::enable_proactive_engagement::EnableProactiveEngagement,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_proactive_engagement::EnableProactiveEngagement::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableProactiveEngagement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_proactive_engagement::de_enable_proactive_engagement_http_response_with_props(status, headers, body)
        }
    }
}
