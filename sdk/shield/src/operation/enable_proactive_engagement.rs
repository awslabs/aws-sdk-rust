...
impl EnableProactiveEngagementInput {
    /// Consumes the builder and constructs an Operation<[`EnableProactiveEngagement`](crate::operation::enable_proactive_engagement::EnableProactiveEngagement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_proactive_engagement::EnableProactiveEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_proactive_engagement::EnableProactiveEngagementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_proactive_engagement::ser_enable_proactive_engagement_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_proactive_engagement::EnableProactiveEngagement::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableProactiveEngagement {
                type Output = std::result::Result<crate::operation::enable_proactive_engagement::EnableProactiveEngagementOutput, crate::operation::enable_proactive_engagement::EnableProactiveEngagementError>;
