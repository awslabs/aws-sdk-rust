...
pub use crate::operation::associate_health_check::_associate_health_check_output::AssociateHealthCheckOutputBuilder;
...
pub struct AssociateHealthCheckFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::associate_health_check::builders::AssociateHealthCheckInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_health_check::AssociateHealthCheckOutput,
                    crate::operation::associate_health_check::AssociateHealthCheckError,
                > for AssociateHealthCheckFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateHealthCheckFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::associate_health_check::builders::AssociateHealthCheckInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_health_check::AssociateHealthCheckOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_health_check::AssociateHealthCheckError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_health_check::AssociateHealthCheck::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_health_check::AssociateHealthCheck::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_health_check::AssociateHealthCheckOutput, crate::operation::associate_health_check::AssociateHealthCheckError, Self> {
