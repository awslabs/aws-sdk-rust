...
impl DescribeProtectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_protection::ser_describe_protection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_protection::de_describe_protection_http_response_with_props(status, headers, body)
        }
    }
}
