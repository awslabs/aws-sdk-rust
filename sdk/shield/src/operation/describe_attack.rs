...
impl DescribeAttackInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_attack::DescribeAttack,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_attack::DescribeAttack::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAttack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_attack::de_describe_attack_http_error(
                status, headers, body,
            )
        } else {
