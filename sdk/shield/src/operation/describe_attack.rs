...
impl DescribeAttackInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_attack::DescribeAttack, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_attack::ser_describe_attack_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAttack {
    type Output =
        ::std::result::Result<crate::operation::describe_attack::DescribeAttackOutput, crate::operation::describe_attack::DescribeAttackError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_attack::de_describe_attack_http_response_with_props(status, headers, body)
        }
    }
}
