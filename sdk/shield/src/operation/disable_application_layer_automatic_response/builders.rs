...
impl DisableApplicationLayerAutomaticResponseFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> std::result::Result<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseOutput, aws_smithy_http::result::SdkError<crate::operation::disable_application_layer_automatic_response::DisableApplicationLayerAutomaticResponseError>>
                     {
        let op = self
            .inner
            .build()
