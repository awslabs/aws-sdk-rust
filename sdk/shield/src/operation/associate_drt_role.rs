...
impl AssociateDrtRoleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_drt_role::ser_associate_drt_role_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDRTRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_drt_role::de_associate_drt_role_http_response_with_props(status, headers, body)
        }
    }
}
