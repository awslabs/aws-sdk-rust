...
impl AssociateDrtRoleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_drt_role::AssociateDRTRole::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDRTRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_drt_role::de_associate_drt_role_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_drt_role::AssociateDRTRoleError
{
