...
impl ListAttacksInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_attacks::ListAttacks,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_attacks::ListAttacks::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttacks {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_attacks::de_list_attacks_http_error(
                status, headers, body,
            )
        } else {
