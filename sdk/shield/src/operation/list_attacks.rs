...
impl ListAttacksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_attacks::ListAttacks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_attacks::ser_list_attacks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttacks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attacks::de_list_attacks_http_response_with_props(status, headers, body)
        }
    }
}
