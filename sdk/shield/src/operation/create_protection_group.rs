...
impl CreateProtectionGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateProtectionGroup`](crate::operation::create_protection_group::CreateProtectionGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_protection_group::CreateProtectionGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_protection_group::CreateProtectionGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_protection_group::ser_create_protection_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_protection_group::CreateProtectionGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateProtectionGroup {
                type Output = std::result::Result<crate::operation::create_protection_group::CreateProtectionGroupOutput, crate::operation::create_protection_group::CreateProtectionGroupError>;
