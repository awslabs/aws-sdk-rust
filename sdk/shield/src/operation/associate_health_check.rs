...
impl AssociateHealthCheckInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_health_check::AssociateHealthCheck,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateHealthCheck {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_health_check::de_associate_health_check_http_response_with_props(status, headers, body)
        }
    }
}
