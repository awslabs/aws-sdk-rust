...
impl DescribeDrtAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_drt_access::DescribeDRTAccess,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_drt_access::ser_describe_drt_access_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDRTAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_drt_access::de_describe_drt_access_http_response_with_props(status, headers, body)
        }
    }
}
