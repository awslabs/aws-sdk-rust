...
impl DescribeDrtAccessInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDRTAccess`](crate::operation::describe_drt_access::DescribeDRTAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_drt_access::DescribeDRTAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_drt_access::DescribeDrtAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_drt_access::ser_describe_drt_access_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_drt_access::DescribeDRTAccess::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDRTAccess {
                type Output = std::result::Result<crate::operation::describe_drt_access::DescribeDrtAccessOutput, crate::operation::describe_drt_access::DescribeDRTAccessError>;
