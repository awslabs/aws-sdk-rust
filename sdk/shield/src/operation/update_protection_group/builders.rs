...
impl UpdateProtectionGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_protection_group::UpdateProtectionGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_protection_group::UpdateProtectionGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_protection_group::UpdateProtectionGroupOutput, crate::operation::update_protection_group::UpdateProtectionGroupError, Self> {
