...
impl AssociateDRTLogBucketFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_drt_log_bucket::AssociateDrtLogBucketOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_drt_log_bucket::AssociateDRTLogBucketError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_drt_log_bucket::AssociateDrtLogBucketOutput, crate::operation::associate_drt_log_bucket::AssociateDRTLogBucketError, Self> {
