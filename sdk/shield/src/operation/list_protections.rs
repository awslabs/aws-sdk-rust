...
impl ListProtectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_protections::ListProtections, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_protections::ser_list_protections_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProtections {
    type Output =
        ::std::result::Result<crate::operation::list_protections::ListProtectionsOutput, crate::operation::list_protections::ListProtectionsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_protections::de_list_protections_http_response_with_props(status, headers, body)
        }
    }
}
