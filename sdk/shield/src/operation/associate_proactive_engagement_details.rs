...
impl AssociateProactiveEngagementDetailsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateProactiveEngagementDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_proactive_engagement_details::de_associate_proactive_engagement_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
