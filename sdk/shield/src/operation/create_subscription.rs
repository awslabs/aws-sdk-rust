...
impl CreateSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_subscription::CreateSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_subscription::de_create_subscription_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_subscription::CreateSubscriptionError
{
