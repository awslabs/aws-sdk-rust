...
impl CreateSubscriptionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_subscription::ser_create_subscription_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_subscription::de_create_subscription_http_response_with_props(status, headers, body)
        }
    }
}
