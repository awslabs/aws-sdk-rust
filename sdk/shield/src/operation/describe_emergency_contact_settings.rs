...
impl DescribeEmergencyContactSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEmergencyContactSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_emergency_contact_settings::de_describe_emergency_contact_settings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError
{
