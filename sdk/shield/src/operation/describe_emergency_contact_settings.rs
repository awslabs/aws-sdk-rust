...
impl DescribeEmergencyContactSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEmergencyContactSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_emergency_contact_settings::de_describe_emergency_contact_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
