...
impl UpdateApplicationLayerAutomaticResponseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseInput, ::aws_smithy_types::error::operation::BuildError> {
