...
impl UpdateApplicationLayerAutomaticResponseInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
