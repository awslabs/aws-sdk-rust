...
/// Orchestration and serialization glue logic for `DisableProactiveEngagement`.
...
impl DisableProactiveEngagement {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_proactive_engagement::DisableProactiveEngagementInput,
                    ) -> ::std::result::Result<crate::operation::disable_proactive_engagement::DisableProactiveEngagementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_proactive_engagement::DisableProactiveEngagementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableProactiveEngagement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableProactiveEngagement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableProactiveEngagementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableProactiveEngagementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableProactiveEngagement")
...
.with_interceptor(DisableProactiveEngagementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_proactive_engagement::de_disable_proactive_engagement_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_proactive_engagement::de_disable_proactive_engagement_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableProactiveEngagementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_proactive_engagement::DisableProactiveEngagementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_proactive_engagement::DisableProactiveEngagementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_proactive_engagement::ser_disable_proactive_engagement_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableProactiveEngagementEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableProactiveEngagementInput>()
                        .ok_or("failed to downcast to DisableProactiveEngagementInput")?;
...
pub enum DisableProactiveEngagementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableProactiveEngagementError) for what information is available for the error.")]
...
impl DisableProactiveEngagementError {
    /// Creates the `DisableProactiveEngagementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableProactiveEngagementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableProactiveEngagementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_proactive_engagement::DisableProactiveEngagementError {
...
mod _disable_proactive_engagement_output;
