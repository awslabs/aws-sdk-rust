...
impl DisableProactiveEngagementInput {
    /// Consumes the builder and constructs an Operation<[`DisableProactiveEngagement`](crate::operation::disable_proactive_engagement::DisableProactiveEngagement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_proactive_engagement::DisableProactiveEngagement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_proactive_engagement::DisableProactiveEngagementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_proactive_engagement::DisableProactiveEngagement::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisableProactiveEngagement {
                type Output = std::result::Result<crate::operation::disable_proactive_engagement::DisableProactiveEngagementOutput, crate::operation::disable_proactive_engagement::DisableProactiveEngagementError>;
