...
impl DescribeAttackStatistics {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_attack_statistics::DescribeAttackStatisticsInput,
                    ) -> ::std::result::Result<crate::operation::describe_attack_statistics::DescribeAttackStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAttackStatistics {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAttackStatistics");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAttackStatisticsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAttackStatisticsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAttackStatistics")
...
.with_interceptor(DescribeAttackStatisticsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError>::new());
...
#[derive(Debug)]
            struct DescribeAttackStatisticsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAttackStatisticsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_attack_statistics::de_describe_attack_statistics_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeAttackStatisticsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAttackStatisticsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_attack_statistics::DescribeAttackStatisticsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_attack_statistics::DescribeAttackStatisticsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_attack_statistics::ser_describe_attack_statistics_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct DescribeAttackStatisticsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAttackStatisticsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAttackStatisticsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAttackStatisticsInput>()
                        .ok_or("failed to downcast to DescribeAttackStatisticsInput")?;
...
pub enum DescribeAttackStatisticsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAttackStatisticsError) for what information is available for the error.")]
...
impl DescribeAttackStatisticsError {
    /// Creates the `DescribeAttackStatisticsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAttackStatisticsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAttackStatisticsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_attack_statistics::DescribeAttackStatisticsError {
...
mod _describe_attack_statistics_output;
