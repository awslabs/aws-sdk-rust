...
impl DescribeAttackStatisticsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_attack_statistics::DescribeAttackStatistics,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAttackStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_attack_statistics::de_describe_attack_statistics_http_response_with_props(status, headers, body)
        }
    }
}
