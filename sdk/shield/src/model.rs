...
pub struct EmergencyContact  {
    ...
    #[doc(hidden)]pub contact_notes: std::option::Option<std::string::String>,
}
...
pub struct ResponseAction  {
    ...
    #[doc(hidden)]pub block: std::option::Option<crate::model::BlockAction>,
    /// <p>Specifies that Shield Advanced should configure its WAF rules with the WAF <code>Count</code> action. </p> 
    /// <p>You must specify exactly one action, either <code>Block</code> or <code>Count</code>.</p>
    #[doc(hidden)]pub count: std::option::Option<crate::model::CountAction>,
}
impl ResponseAction {
    /// <p>Specifies that Shield Advanced should configure its WAF rules with the WAF <code>Block</code> action. </p> 
    /// <p>You must specify exactly one action, either <code>Block</code> or <code>Count</code>.</p>
...
pub struct Protection  {
    ...
    #[doc(hidden)]pub health_check_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The ARN (Amazon Resource Name) of the protection.</p>
    #[doc(hidden)]pub protection_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub application_layer_automatic_response_configuration: std::option::Option<crate::model::ApplicationLayerAutomaticResponseConfiguration>,
}
impl Protection {
    /// <p>The unique identifier (ID) of the protection.</p>
...
impl  std::fmt::Debug for Protection  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_layer_automatic_response_configuration", &self.application_layer_automatic_response_configuration);
        formatter.finish()
    }
}
...
pub struct ApplicationLayerAutomaticResponseConfiguration  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ApplicationLayerAutomaticResponseStatus>,
    /// <p>Specifies the action setting that Shield Advanced should use in the WAF rules that it creates on behalf of the protected resource in response to DDoS attacks. You specify this as part of the configuration for the automatic application layer DDoS mitigation feature, when you enable or update automatic mitigation. Shield Advanced creates the WAF rules in a Shield Advanced-managed rule group, inside the web ACL that you have associated with the resource. </p>
...
pub struct InclusionProtectionFilters  {
    ...
    #[doc(hidden)]pub protection_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The type of protected resource whose protections you want to retrieve. </p>
    #[doc(hidden)]pub resource_types: std::option::Option<std::vec::Vec<crate::model::ProtectedResourceType>>,
}
...
pub struct ProtectionGroup  {
    ...
    #[doc(hidden)]pub protection_group_arn: std::option::Option<std::string::String>,
}
...
pub struct InclusionProtectionGroupFilters  {
    ...
    #[doc(hidden)]pub protection_group_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The pattern specification of the protection groups that you want to retrieve. </p>
    #[doc(hidden)]pub patterns: std::option::Option<std::vec::Vec<crate::model::ProtectionGroupPattern>>,
    ...
    #[doc(hidden)]pub aggregations: std::option::Option<std::vec::Vec<crate::model::ProtectionGroupAggregation>>,
}
...
pub struct AttackSummary  {
    ...
    #[doc(hidden)]pub attack_vectors: std::option::Option<std::vec::Vec<crate::model::AttackVectorDescription>>,
}
impl AttackSummary {
    /// <p>The unique identifier (ID) of the attack.</p>
...
pub struct AttackVectorDescription  {
    ...
    /// </ul>
    #[doc(hidden)]pub vector_type: std::option::Option<std::string::String>,
}
...
pub struct TimeRange  {
    ...
    #[doc(hidden)]pub from_inclusive: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The end time, in Unix time in seconds. </p>
    #[doc(hidden)]pub to_exclusive: std::option::Option<aws_smithy_types::DateTime>,
}
impl TimeRange {
    /// <p>The start time, in Unix time in seconds. </p>
...
pub struct Subscription  {
    ...
    #[doc(hidden)]pub time_commitment_in_seconds: i64,
    ...
    #[doc(hidden)]pub limits: std::option::Option<std::vec::Vec<crate::model::Limit>>,
    ...
    #[doc(hidden)]pub proactive_engagement_status: std::option::Option<crate::model::ProactiveEngagementStatus>,
    /// <p>Limits settings for your subscription. </p>
    #[doc(hidden)]pub subscription_limits: std::option::Option<crate::model::SubscriptionLimits>,
...
impl  std::fmt::Debug for Subscription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("start_time", &self.start_time);
        formatter.field("end_time", &self.end_time);
        formatter.field("time_commitment_in_seconds", &self.time_commitment_in_seconds);
        formatter.field("auto_renew", &self.auto_renew);
        formatter.field("limits", &self.limits);
        formatter.field("proactive_engagement_status", &self.proactive_engagement_status);
...
pub struct SubscriptionLimits  {
    ...
    #[doc(hidden)]pub protection_limits: std::option::Option<crate::model::ProtectionLimits>,
    /// <p>Limits settings on protection groups for your subscription. </p>
    #[doc(hidden)]pub protection_group_limits: std::option::Option<crate::model::ProtectionGroupLimits>,
}
...
pub struct ProtectionGroupLimits  {
    ...
    #[doc(hidden)]pub max_protection_groups: i64,
    /// <p>Limits settings by pattern type in the protection groups for your subscription. </p>
    #[doc(hidden)]pub pattern_type_limits: std::option::Option<crate::model::ProtectionGroupPatternTypeLimits>,
}
...
pub struct ProtectionGroupPatternTypeLimits  {
    ...
    #[doc(hidden)]pub arbitrary_pattern_limits: std::option::Option<crate::model::ProtectionGroupArbitraryPatternLimits>,
}
...
pub struct ProtectionGroupArbitraryPatternLimits  {
    ...
    #[doc(hidden)]pub max_members: i64,
}
...
pub struct ProtectionLimits  {
    ...
    #[doc(hidden)]pub protected_resource_type_limits: std::option::Option<std::vec::Vec<crate::model::Limit>>,
}
...
impl  std::fmt::Debug for ProtectionLimits  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("protected_resource_type_limits", &self.protected_resource_type_limits);
        formatter.finish()
    }
}
...
pub struct AttackStatisticsDataItem  {
    ...
    #[doc(hidden)]pub attack_volume: std::option::Option<crate::model::AttackVolume>,
    /// <p>The number of attacks detected during the time period. This is always present, but might be zero. </p>
    #[doc(hidden)]pub attack_count: i64,
}
...
pub struct AttackVolume  {
    ...
    #[doc(hidden)]pub bits_per_second: std::option::Option<crate::model::AttackVolumeStatistics>,
    /// <p>A statistics object that uses packets per second as the unit. This is included for network level attacks. </p>
    #[doc(hidden)]pub packets_per_second: std::option::Option<crate::model::AttackVolumeStatistics>,
    ...
    #[doc(hidden)]pub requests_per_second: std::option::Option<crate::model::AttackVolumeStatistics>,
}
impl AttackVolume {
    /// <p>A statistics object that uses bits per second as the unit. This is included for network level attacks. </p>
...
pub struct AttackDetail  {
    ...
    #[doc(hidden)]pub sub_resources: std::option::Option<std::vec::Vec<crate::model::SubResourceSummary>>,
    ...
    #[doc(hidden)]pub attack_counters: std::option::Option<std::vec::Vec<crate::model::SummarizedCounter>>,
    ...
    #[doc(hidden)]pub attack_properties: std::option::Option<std::vec::Vec<crate::model::AttackProperty>>,
    /// <p>List of mitigation actions taken for the attack.</p>
    #[doc(hidden)]pub mitigations: std::option::Option<std::vec::Vec<crate::model::Mitigation>>,
}
impl AttackDetail {
    /// <p>The unique identifier (ID) of the attack.</p>
    pub fn attack_id(&self) -> std::option::Option<& str> {
...
pub struct Mitigation  {
    ...
    #[doc(hidden)]pub mitigation_name: std::option::Option<std::string::String>,
}
impl Mitigation {
    /// <p>The name of the mitigation taken for this attack.</p>
...
pub struct AttackProperty  {
    ...
    /// <p>For infrastructure layer events (L3 and L4 events), you can view metrics for top contributors in Amazon CloudWatch metrics. For more information, see <a href="https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#set-ddos-alarms">Shield metrics and alarms</a> in the <i>WAF Developer Guide</i>. </p>
    #[doc(hidden)]pub attack_layer: std::option::Option<crate::model::AttackLayer>,
    ...
    #[doc(hidden)]pub attack_property_identifier: std::option::Option<crate::model::AttackPropertyIdentifier>,
    ...
    #[doc(hidden)]pub top_contributors: std::option::Option<std::vec::Vec<crate::model::Contributor>>,
    /// <p>The unit used for the <code>Contributor</code> <code>Value</code> property. </p>
    #[doc(hidden)]pub unit: std::option::Option<crate::model::Unit>,
    /// <p>The total contributions made to this Shield event by all contributors.</p>
    #[doc(hidden)]pub total: i64,
}
impl AttackProperty {
    /// <p>The type of Shield event that was observed. <code>NETWORK</code> indicates layer 3 and layer 4 events and <code>APPLICATION</code> indicates layer 7 events.</p> 
    /// <p>For infrastructure layer events (L3 and L4 events), you can view metrics for top contributors in Amazon CloudWatch metrics. For more information, see <a href="https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#set-ddos-alarms">Shield metrics and alarms</a> in the <i>WAF Developer Guide</i>. </p>
...
impl  std::fmt::Debug for AttackProperty  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("attack_property_identifier", &self.attack_property_identifier);
...
pub struct SubResourceSummary  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::SubResourceType>,
    /// <p>The unique identifier (ID) of the <code>SubResource</code>.</p>
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// <p>The list of attack types and associated counters.</p>
    #[doc(hidden)]pub attack_vectors: std::option::Option<std::vec::Vec<crate::model::SummarizedAttackVector>>,
    /// <p>The counters that describe the details of the attack.</p>
    #[doc(hidden)]pub counters: std::option::Option<std::vec::Vec<crate::model::SummarizedCounter>>,
}
...
pub struct SummarizedAttackVector  {
    ...
    #[doc(hidden)]pub vector_counters: std::option::Option<std::vec::Vec<crate::model::SummarizedCounter>>,
}
