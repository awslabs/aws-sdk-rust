...
impl ::std::convert::From<&str> for SubscriptionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubscriptionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubscriptionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubscriptionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SubscriptionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
