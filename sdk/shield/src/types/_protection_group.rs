...
impl  ProtectionGroup  {
    ...
    pub fn protection_group_id(&self) -> & str {
        use std::ops::Deref; self.protection_group_id.deref()
    }
    /// <p>Defines how Shield combines resource data for the group in order to detect, mitigate, and report events.</p>
    /// <ul>
    /// <li>
    ...
    pub fn members(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.members.deref()
    }
    /// <p>The ARN (Amazon Resource Name) of the protection group.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::ProtectionGroup {
                protection_group_id: self.protection_group_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("protection_group_id", "protection_group_id was not specified but it is required when building ProtectionGroup")
                    )?
                ,
                aggregation: self.aggregation
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("aggregation", "aggregation was not specified but it is required when building ProtectionGroup")
                    )?
                ,
                pattern: self.pattern
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pattern", "pattern was not specified but it is required when building ProtectionGroup")
                    )?
                ,
                ...
                members: self.members
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("members", "members was not specified but it is required when building ProtectionGroup")
                    )?
                ,
