...
impl Client  {
    ...
    pub fn associate_proactive_engagement_details(&self) -> crate::client::fluent_builders::AssociateProactiveEngagementDetails {
                            crate::client::fluent_builders::AssociateProactiveEngagementDetails::new(self.handle.clone())
                        }
    ...
    pub fn describe_attack_statistics(&self) -> crate::client::fluent_builders::DescribeAttackStatistics {
