...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateEmergencyContactSettingsError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalErrorException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type UpdateApplicationLayerAutomaticResponseErrorKind = UpdateApplicationLayerAutomaticResponseError;
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApplicationLayerAutomaticResponseError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalErrorException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::UpdateApplicationLayerAutomaticResponseError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for ListResourcesInProtectionGroupError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalErrorException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::EnableApplicationLayerAutomaticResponseError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_http::request_id::RequestId for crate::error::DisableApplicationLayerAutomaticResponseError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateProactiveEngagementDetailsError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalErrorException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
