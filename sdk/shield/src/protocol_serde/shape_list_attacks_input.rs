...
pub fn ser_list_attacks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAttacksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
