...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError::unhandled)?;
    ...
    Err(match error_code {
        "InternalErrorException" => {
            crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError::InternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_emergency_contact_settings_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_emergency_contact_settings::de_describe_emergency_contact_settings(_response_body, output)
            .map_err(crate::operation::describe_emergency_contact_settings::DescribeEmergencyContactSettingsError::unhandled)?;
