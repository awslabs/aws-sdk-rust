...
pub fn ser_create_protection_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_protection_group::CreateProtectionGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
