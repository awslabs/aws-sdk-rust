...
pub fn ser_create_protection_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProtectionGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
