...
pub fn serialize_structure_associate_drt_log_bucket_input(
...
pub fn serialize_structure_associate_drt_role_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_associate_health_check_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_associate_proactive_engagement_details_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_emergency_contact(&mut object_8, item_7);
                object_8.finish();
            }
        }
        array_6.finish();
...
pub fn serialize_structure_create_protection_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_protection_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_protection_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_protection_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_attack_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_protection_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_protection_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_drt_log_bucket_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_health_check_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_attacks_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_38) = &input.start_time {
        ...
        crate::json_ser::serialize_structure_time_range(&mut object_39, var_38);
        object_39.finish();
    }
    if let Some(var_40) = &input.end_time {
        let mut object_41 = object.key("EndTime").start_object();
        crate::json_ser::serialize_structure_time_range(&mut object_41, var_40);
        object_41.finish();
    }
...
pub fn serialize_structure_list_protection_groups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_protections_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_resources_in_protection_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_emergency_contact_settings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_63 in var_61 {
            {
                ...
                crate::json_ser::serialize_structure_emergency_contact(&mut object_64, item_63);
                object_64.finish();
            }
        }
        array_62.finish();
...
pub fn serialize_structure_update_protection_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_subscription_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_emergency_contact(
    object: &mut smithy_json::serialize::JsonObjectWriter,
