...
impl super::Client  {
    ...
    pub fn enable_application_layer_automatic_response(&self) -> crate::client::fluent_builders::EnableApplicationLayerAutomaticResponse {
                                crate::client::fluent_builders::EnableApplicationLayerAutomaticResponse::new(self.handle.clone())
                            }
}
