...
impl super::Client  {
    ...
    pub fn update_application_layer_automatic_response(&self) -> crate::client::fluent_builders::UpdateApplicationLayerAutomaticResponse {
                                crate::client::fluent_builders::UpdateApplicationLayerAutomaticResponse::new(self.handle.clone())
                            }
}
