...
impl super::Client {
    ...
    pub fn delete_protection_group(
        &self,
    ) -> crate::operation::delete_protection_group::builders::DeleteProtectionGroupFluentBuilder
    {
        crate::operation::delete_protection_group::builders::DeleteProtectionGroupFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
