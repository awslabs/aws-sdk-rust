...
pub(crate) fn de_active_contexts_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub fn de_audio_stream_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, crate::operation::put_session::PutSessionError> {
...
pub(crate) fn de_dialog_state_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::DialogState>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-dialog-state");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_encoded_message_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-encoded-message");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_intent_name_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-intent-name");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_message_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-message");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_message_format_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::MessageFormatType>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-message-format");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_session_attributes_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_slot_to_elicit_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-lex-slot-to-elicit");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_slots_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
