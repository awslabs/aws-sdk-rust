...
pub fn ser_intent_summary(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IntentSummary) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
