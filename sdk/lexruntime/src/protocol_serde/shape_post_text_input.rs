...
pub fn ser_post_text_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PostTextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
