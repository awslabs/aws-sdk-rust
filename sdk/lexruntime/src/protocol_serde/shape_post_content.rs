...
pub fn de_post_content_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::post_content::PostContentOutput, crate::operation::post_content::PostContentError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_post_content_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::post_content::PostContentOutput, crate::operation::post_content::PostContentError> {
    #[allow(unused_mut)]
        ...
        let formatted_2 = ::aws_smithy_types::base64::encode(inner_1);
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("session_attributes", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.request_attributes {
        let formatted_4 = ::aws_smithy_types::base64::encode(inner_3);
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("request_attributes", format!(
                                "`{}` cannot be used as a header value: {}",
                                &"*** Sensitive Data Redacted ***",
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_9) = &input.active_contexts {
        let formatted_10 = ::aws_smithy_types::base64::encode(inner_9);
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("active_contexts", format!(
                                "`{}` cannot be used as a header value: {}",
                                &"*** Sensitive Data Redacted ***",
                                err
                            ))
