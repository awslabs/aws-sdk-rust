...
pub fn de_post_content_http_response(
    ...
    Ok({
        ...
        output = output.set_active_contexts(
            crate::protocol_serde::shape_post_content_output::de_active_contexts_header(
                response.headers(),
            )
            .map_err(|_| {
        ...
        output = output.set_alternative_intents(
            crate::protocol_serde::shape_post_content_output::de_alternative_intents_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_audio_stream(Some(
            crate::protocol_serde::shape_post_content_output::de_audio_stream_payload(
                response.body_mut(),
            )?,
        ));
        output = output.set_bot_version(
            crate::protocol_serde::shape_post_content_output::de_bot_version_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_content_type(
            crate::protocol_serde::shape_post_content_output::de_content_type_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_dialog_state(
            crate::protocol_serde::shape_post_content_output::de_dialog_state_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_encoded_message(
            crate::protocol_serde::shape_post_content_output::de_encoded_message_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_input_transcript(
            crate::protocol_serde::shape_post_content_output::de_input_transcript_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_intent_name(
            crate::protocol_serde::shape_post_content_output::de_intent_name_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_message_format(
            crate::protocol_serde::shape_post_content_output::de_message_format_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_sentiment_response(
            crate::protocol_serde::shape_post_content_output::de_sentiment_response_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_session_attributes(
            crate::protocol_serde::shape_post_content_output::de_session_attributes_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_session_id(
            crate::protocol_serde::shape_post_content_output::de_session_id_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
        ...
        output = output.set_slot_to_elicit(
            crate::protocol_serde::shape_post_content_output::de_slot_to_elicit_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::PostContentError::unhandled(
    ...
    Err(match error_code {
        "BadGatewayException" => crate::error::PostContentError::BadGatewayException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_bad_gateway_exception::de_bad_gateway_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
        ...
        "BadRequestException" => crate::error::PostContentError::BadRequestException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "ConflictException" => crate::error::PostContentError::ConflictException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "DependencyFailedException" => crate::error::PostContentError::DependencyFailedException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_dependency_failed_exception::de_dependency_failed_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "InternalFailureException" => crate::error::PostContentError::InternalFailureException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "LimitExceededException" => crate::error::PostContentError::LimitExceededException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
        ...
        "LoopDetectedException" => crate::error::PostContentError::LoopDetectedException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_loop_detected_exception::de_loop_detected_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "NotAcceptableException" => crate::error::PostContentError::NotAcceptableException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_not_acceptable_exception::de_not_acceptable_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "NotFoundException" => crate::error::PostContentError::NotFoundException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_not_found_exception::de_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "RequestTimeoutException" => crate::error::PostContentError::RequestTimeoutException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_request_timeout_exception::de_request_timeout_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
        ...
        "UnsupportedMediaTypeException" => {
            crate::error::PostContentError::UnsupportedMediaTypeException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_unsupported_media_type_exception::de_unsupported_media_type_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PostContentError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
