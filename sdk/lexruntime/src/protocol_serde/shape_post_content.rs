...
pub fn de_post_content_op_response(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::operation::post_content::PostContentOutput, crate::operation::post_content::PostContentError> {
    #[allow(unused_variables)]
    let (response, properties) = op_response.parts_mut();
    crate::protocol_serde::shape_post_content::de_post_content_http_response_with_props(response, &properties)
}
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_post_content_http_response_with_props(response: &mut http::Response<aws_smithy_http::body::SdkBody>, properties: &aws_smithy_http::property_bag::PropertyBag) -> std::result::Result<crate::operation::post_content::PostContentOutput, crate::operation::post_content::PostContentError> {
