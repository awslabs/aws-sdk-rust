...
pub fn serialize_structure_post_text_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_active_context(&mut object_4, item_3);
                object_4.finish();
            }
        }
        array_2.finish();
...
pub fn serialize_structure_put_session_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_16 in var_14 {
            {
                ...
                crate::json_ser::serialize_structure_active_context(&mut object_17, item_16);
                object_17.finish();
            }
        }
        array_15.finish();
    ...
    if let Some(var_18) = &input.dialog_action {
        ...
        crate::json_ser::serialize_structure_dialog_action(&mut object_19, var_18);
        object_19.finish();
    }
        ...
        for item_22 in var_20 {
            {
                ...
                crate::json_ser::serialize_structure_intent_summary(&mut object_23, item_22);
                object_23.finish();
            }
        }
        array_21.finish();
...
pub fn serialize_structure_active_context(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_29) = &input.time_to_live {
        ...
        crate::json_ser::serialize_structure_active_context_time_to_live(&mut object_30, var_29);
        object_30.finish();
    }
...
pub fn serialize_structure_dialog_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_intent_summary(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_active_context_time_to_live(
    object: &mut smithy_json::serialize::JsonObjectWriter,
