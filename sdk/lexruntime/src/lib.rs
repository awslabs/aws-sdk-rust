...
//! offered by Amazon Lex Runtime Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Lex Runtime Service.
...
/// Configuration for Amazon Lex Runtime Service.
pub mod config;
