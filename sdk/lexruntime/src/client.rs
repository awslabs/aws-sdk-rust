...
impl Client {
    ...
    pub fn post_content(&self) -> crate::client::fluent_builders::PostContent {
        crate::client::fluent_builders::PostContent::new(self.handle.clone())
    }
    ...
    pub fn post_text(&self) -> crate::client::fluent_builders::PostText {
        crate::client::fluent_builders::PostText::new(self.handle.clone())
    }
