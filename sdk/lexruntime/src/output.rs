...
#[non_exhaustive]pub struct PutSessionOutput  {
    ...
    #[deprecated(note = "The message field is deprecated, use the encodedMessage field instead. The message field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]#[doc(hidden)]pub message: std::option::Option<std::string::String>,
    /// <p>The next message that should be presented to the user.</p> 
    ...
    /// </ul>
    #[doc(hidden)]pub message_format: std::option::Option<crate::model::MessageFormatType>,
    /// <p></p> 
    /// <ul> 
    ...
    /// </ul>
    #[doc(hidden)]pub dialog_state: std::option::Option<crate::model::DialogState>,
...
impl PutSessionOutput {
    ...
    /// <p>The next message that should be presented to the user.</p> 
    /// <p>You can only use this field in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>message</code> field is null. You should use the <code>encodedMessage</code> field instead.</p>
    #[deprecated(note = "The message field is deprecated, use the encodedMessage field instead. The message field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn message(&self) -> std::option::Option<& str> {
...
pub mod put_session_output {
    ...
    impl Builder {
        ...
        /// <p>The next message that should be presented to the user.</p> 
        /// <p>You can only use this field in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>message</code> field is null. You should use the <code>encodedMessage</code> field instead.</p>
        #[deprecated(note = "The message field is deprecated, use the encodedMessage field instead. The message field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn message(mut self, input: impl Into<std::string::String>) -> Self {
            self.message = Some(input.into());
            self
        }
        /// <p>The next message that should be presented to the user.</p> 
        /// <p>You can only use this field in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>message</code> field is null. You should use the <code>encodedMessage</code> field instead.</p>
        #[deprecated(note = "The message field is deprecated, use the encodedMessage field instead. The message field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn set_message(mut self, input: std::option::Option<std::string::String>) -> Self {
        ...
        /// <li> <p> <code>ReadyForFulfillment</code> - Conveys that the client has to fulfill the intent.</p> </li> 
        /// </ul>
        pub fn set_dialog_state(mut self, input: std::option::Option<crate::model::DialogState>) -> Self {
...
pub struct PostTextOutput  {
    ...
    #[doc(hidden)]pub nlu_intent_confidence: std::option::Option<crate::model::IntentConfidence>,
    ...
    #[doc(hidden)]pub alternative_intents: std::option::Option<std::vec::Vec<crate::model::PredictedIntent>>,
    /// <p> The intent slots that Amazon Lex detected from the user input in the conversation. </p> 
    /// <p>Amazon Lex creates a resolution list containing likely values for a slot. The value that it returns is determined by the <code>valueSelectionStrategy</code> selected when the slot type was created or updated. If <code>valueSelectionStrategy</code> is set to <code>ORIGINAL_VALUE</code>, the value provided by the user is returned, if the user value is similar to the slot values. If <code>valueSelectionStrategy</code> is set to <code>TOP_RESOLUTION</code> Amazon Lex returns the first value in the resolution list or, if there is no resolution list, null. If you don't specify a <code>valueSelectionStrategy</code>, the default is <code>ORIGINAL_VALUE</code>.</p>
    #[doc(hidden)]pub slots: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub sentiment_response: std::option::Option<crate::model::SentimentResponse>,
    /// <p>The format of the response message. One of the following values:</p> 
    /// <ul> 
    /// <li> <p> <code>PlainText</code> - The message contains plain UTF-8 text.</p> </li> 
    ...
    #[doc(hidden)]pub response_card: std::option::Option<crate::model::ResponseCard>,
    /// <p>A unique identifier for the session.</p>
    #[doc(hidden)]pub session_id: std::option::Option<std::string::String>,
...
pub mod post_text_output {
    ...
    pub struct Builder {
        ...
        pub(crate) alternative_intents: std::option::Option<std::vec::Vec<crate::model::PredictedIntent>>,
    ...
    impl Builder {
        ...
        /// <p>One to four alternative intents that may be applicable to the user's intent.</p> 
        /// <p>Each alternative includes a score that indicates how confident Amazon Lex is that the intent matches the user's intent. The intents are sorted by the confidence score.</p>
        pub fn set_alternative_intents(mut self, input: std::option::Option<std::vec::Vec<crate::model::PredictedIntent>>) -> Self {
        ...
        /// <p>Represents the options that the user has to respond to the current prompt. Response Card can come from the bot configuration (in the Amazon Lex console, choose the settings button next to a slot) or from a code hook (Lambda function). </p>
        pub fn set_response_card(mut self, input: std::option::Option<crate::model::ResponseCard>) -> Self {
...
#[allow(missing_docs)] // documentation missing in model
#[non_exhaustive]pub struct PostContentOutput  {
    /// <p>Content type as specified in the <code>Accept</code> HTTP header in the request.</p>
    #[doc(hidden)]pub content_type: std::option::Option<std::string::String>,
    ...
    /// <p>The score is a relative score, not an absolute score. The score may change based on improvements to Amazon Lex. </p>
    #[doc(hidden)]pub nlu_intent_confidence: std::option::Option<std::string::String>,
    /// <p>One to four alternative intents that may be applicable to the user's intent.</p> 
    /// <p>Each alternative includes a score that indicates how confident Amazon Lex is that the intent matches the user's intent. The intents are sorted by the confidence score.</p>
    #[doc(hidden)]pub alternative_intents: std::option::Option<std::string::String>,
    ...
    /// <p>When the bot is configured to send utterances to Amazon Comprehend for sentiment analysis, this field contains the result of the analysis.</p>
    #[doc(hidden)]pub sentiment_response: std::option::Option<std::string::String>,
    /// <p>You can only use this field in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>message</code> field is null. You should use the <code>encodedMessage</code> field instead.</p> 
    /// <p>The message to convey to the user. The message can come from the bot's configuration or from a Lambda function.</p> 
    ...
    #[deprecated(note = "The inputTranscript field is deprecated, use the encodedInputTranscript field instead. The inputTranscript field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]#[doc(hidden)]pub input_transcript: std::option::Option<std::string::String>,
    /// <p>The text used to process the request.</p> 
    ...
    #[doc(hidden)]pub encoded_input_transcript: std::option::Option<std::string::String>,
...
impl PostContentOutput {
    ...
    /// <p>You can use this field only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>inputTranscript</code> field is null. You should use the <code>encodedInputTranscript</code> field instead.</p> 
    /// <p>If the input was an audio stream, the <code>inputTranscript</code> field contains the text extracted from the audio stream. This is the text that is actually processed to recognize intents and slot values. You can use this information to determine if Amazon Lex is correctly processing the audio that you send.</p>
    #[deprecated(note = "The inputTranscript field is deprecated, use the encodedInputTranscript field instead. The inputTranscript field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn input_transcript(&self) -> std::option::Option<& str> {
...
pub mod post_content_output {
    ...
    impl Builder {
        ...
        /// <p>You can use this field only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>inputTranscript</code> field is null. You should use the <code>encodedInputTranscript</code> field instead.</p> 
        /// <p>If the input was an audio stream, the <code>inputTranscript</code> field contains the text extracted from the audio stream. This is the text that is actually processed to recognize intents and slot values. You can use this information to determine if Amazon Lex is correctly processing the audio that you send.</p>
        #[deprecated(note = "The inputTranscript field is deprecated, use the encodedInputTranscript field instead. The inputTranscript field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn input_transcript(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>You can use this field only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR, and it-IT locales. In all other locales, the <code>inputTranscript</code> field is null. You should use the <code>encodedInputTranscript</code> field instead.</p> 
        /// <p>If the input was an audio stream, the <code>inputTranscript</code> field contains the text extracted from the audio stream. This is the text that is actually processed to recognize intents and slot values. You can use this information to determine if Amazon Lex is correctly processing the audio that you send.</p>
        #[deprecated(note = "The inputTranscript field is deprecated, use the encodedInputTranscript field instead. The inputTranscript field is available only in the de-DE, en-AU, en-GB, en-US, es-419, es-ES, es-US, fr-CA, fr-FR and it-IT locales.")]pub fn set_input_transcript(mut self, input: std::option::Option<std::string::String>) -> Self {
