...
impl super::Client {
    ...
    ///   - [`bot_name(impl Into<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::bot_name) / [`set_bot_name(Option<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::set_bot_name):<br>required: **true**<br><p>The name of the bot that contains the session data.</p><br>
    ///   - [`bot_alias(impl Into<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::bot_alias) / [`set_bot_alias(Option<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::set_bot_alias):<br>required: **true**<br><p>The alias in use for the bot that contains the session data.</p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::delete_session::builders::DeleteSessionFluentBuilder::set_user_id):<br>required: **true**<br><p>The identifier of the user associated with the session data.</p><br>
