...
impl PostTextInput {
    /// Consumes the builder and constructs an Operation<[`PostText`](crate::operation::post_text::PostText)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::post_text::PostText, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::post_text::PostTextInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/bot/{botName}/alias/{botAlias}/user/{userId}/text", botName = bot_name, botAlias = bot_alias, userId = user_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_post_text::ser_post_text_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::post_text::PostText::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PostText", "lexruntimeservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for PostText {
                type Output = std::result::Result<crate::operation::post_text::PostTextOutput, crate::operation::post_text::PostTextError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_post_text::de_post_text_http_error(response)
                     } else {
                        crate::protocol_serde::shape_post_text::de_post_text_http_response(response)
                     }
                }
            }
