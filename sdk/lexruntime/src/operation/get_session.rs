...
impl GetSessionInput {
    /// Consumes the builder and constructs an Operation<[`GetSession`](crate::operation::get_session::GetSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_session::GetSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_session::GetSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_session::GetSessionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_4) = &_input.checkpoint_label_filter {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_session::GetSession::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSession", "lexruntimeservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetSession {
                type Output = std::result::Result<crate::operation::get_session::GetSessionOutput, crate::operation::get_session::GetSessionError>;
