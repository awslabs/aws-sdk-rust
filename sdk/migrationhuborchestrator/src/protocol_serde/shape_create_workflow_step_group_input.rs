...
pub fn ser_create_workflow_step_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkflowStepGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
