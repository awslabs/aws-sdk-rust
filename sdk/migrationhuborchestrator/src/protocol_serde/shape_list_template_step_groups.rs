...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_template_step_groups::ListTemplateStepGroupsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_template_step_groups::de_list_template_step_groups(_response_body, output)
            .map_err(crate::operation::list_template_step_groups::ListTemplateStepGroupsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_template_step_groups_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_template_step_groups::ListTemplateStepGroupsError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "templateStepGroupSummary" => {
                    builder = builder.set_template_step_group_summary(
                        crate::protocol_serde::shape_template_step_group_summary_list::de_template_step_group_summary_list(tokens, _value)?,
                    );
                }
