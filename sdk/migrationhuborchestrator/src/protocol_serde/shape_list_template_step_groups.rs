...
pub fn de_list_template_step_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_template_step_groups::ListTemplateStepGroupsOutput, crate::operation::list_template_step_groups::ListTemplateStepGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_template_step_groups::ListTemplateStepGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_template_step_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_template_step_groups::ListTemplateStepGroupsOutput, crate::operation::list_template_step_groups::ListTemplateStepGroupsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_template_step_groups::builders::ListTemplateStepGroupsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_template_step_groups::de_list_template_step_groups(response.body().as_ref(), output).map_err(crate::operation::list_template_step_groups::ListTemplateStepGroupsError::unhandled)?;
