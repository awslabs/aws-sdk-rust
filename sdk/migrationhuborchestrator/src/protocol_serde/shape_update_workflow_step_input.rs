...
pub fn ser_update_workflow_step_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_workflow_step::UpdateWorkflowStepInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
