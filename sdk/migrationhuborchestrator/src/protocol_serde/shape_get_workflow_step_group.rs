...
pub fn de_get_workflow_step_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_workflow_step_group::GetWorkflowStepGroupOutput, crate::operation::get_workflow_step_group::GetWorkflowStepGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_workflow_step_group::GetWorkflowStepGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_workflow_step_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_workflow_step_group::GetWorkflowStepGroupOutput, crate::operation::get_workflow_step_group::GetWorkflowStepGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_workflow_step_group::builders::GetWorkflowStepGroupOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_workflow_step_group::de_get_workflow_step_group(response.body().as_ref(), output).map_err(crate::operation::get_workflow_step_group::GetWorkflowStepGroupError::unhandled)?;
