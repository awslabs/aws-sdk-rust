...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_workflow_step_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_workflow_step_group::de_get_workflow_step_group(_response_body, output)
            .map_err(crate::operation::get_workflow_step_group::GetWorkflowStepGroupError::unhandled)?;
