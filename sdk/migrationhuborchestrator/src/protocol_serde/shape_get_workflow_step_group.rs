...
pub fn de_get_workflow_step_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetWorkflowStepGroupOutput, crate::error::GetWorkflowStepGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetWorkflowStepGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_workflow_step_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetWorkflowStepGroupOutput, crate::error::GetWorkflowStepGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_workflow_step_group_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_workflow_step_group::de_get_workflow_step_group(response.body().as_ref(), output).map_err(crate::error::GetWorkflowStepGroupError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_workflow_step_group(value: &[u8], mut builder: crate::output::get_workflow_step_group_output::Builder) -> Result<crate::output::get_workflow_step_group_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
