...
pub fn ser_step_input(object_7: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::StepInput) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
                            ...
                            "integerValue" => {
                                Some(crate::types::StepInput::IntegerValue(
                                    ::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?
                                                        .map(i32::try_from)
                                                        .transpose()?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'integerValue' cannot be null"))?
                                ))
                            }
                            "stringValue" => {
