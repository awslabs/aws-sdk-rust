...
pub fn ser_step_input(
    ...
    match input {
        ...
        crate::types::StepInput::ListOfStringsValue(inner) => {
            let mut array_1 = object_5.key("listOfStringsValue").start_array();
            for item_2 in inner {
                {
        ...
        crate::types::StepInput::MapOfStringValue(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_5.key("mapOfStringValue").start_object();
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.to_unescaped()?.as_ref() {
                        ...
                        "stringValue" => Some(crate::types::StepInput::StringValue(
