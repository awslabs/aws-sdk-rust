...
pub(crate) fn de_workflow_step_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowStepSummary>, aws_smithy_json::deserialize::error::DeserializeError>
