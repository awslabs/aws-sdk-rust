...
pub(crate) fn de_template_step_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TemplateStepSummary>, aws_smithy_json::deserialize::error::DeserializeError>
