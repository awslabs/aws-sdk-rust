...
pub fn ser_workflow_step_output_union(object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::WorkflowStepOutputUnion) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::WorkflowStepOutputUnion::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("WorkflowStepOutputUnion"))
    }
    Ok(())
}
                        ...
                        variant = match key.as_ref() {
                            ...
                            "listOfStringValue" => {
                                Some(crate::types::WorkflowStepOutputUnion::ListOfStringValue(
                                    crate::protocol_serde::shape_max_string_list::de_max_string_list(tokens)?
