...
pub fn ser_workflow_step_output_union(object_5: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkflowStepOutputUnion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_workflow_step_output_union<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowStepOutputUnion>, aws_smithy_json::deserialize::error::DeserializeError>
