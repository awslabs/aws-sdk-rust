...
impl super::Client {
    ...
    ///   - [`next(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::next) / [`set_next(Option<Vec<String>>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_next): <p>The next step group.</p>
    ///   - [`previous(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::previous) / [`set_previous(Option<Vec<String>>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_previous): <p>The previous step group.</p>
