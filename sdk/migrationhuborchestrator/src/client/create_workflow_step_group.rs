...
impl super::Client {
    ...
    ///   - [`workflow_id(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::workflow_id) / [`set_workflow_id(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_workflow_id):<br>required: **true**<br><p>The ID of the migration workflow that will contain the step group.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_name):<br>required: **true**<br><p>The name of the step group.</p><br>
