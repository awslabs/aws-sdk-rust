...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_template_step_group::builders::GetTemplateStepGroupFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::get_template_step_group::builders::GetTemplateStepGroupFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the step group.</p><br>
