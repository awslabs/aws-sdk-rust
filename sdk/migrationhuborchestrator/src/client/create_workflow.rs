...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_workflow::builders::CreateWorkflowFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_workflow::builders::CreateWorkflowFluentBuilder::set_name):<br>required: **true**<br><p>The name of the migration workflow.</p><br>
    ...
    ///   - [`template_id(impl Into<String>)`](crate::operation::create_workflow::builders::CreateWorkflowFluentBuilder::template_id) / [`set_template_id(impl Into<String>)`](crate::operation::create_workflow::builders::CreateWorkflowFluentBuilder::set_template_id):<br>required: **true**<br><p>The ID of the template.</p><br>
