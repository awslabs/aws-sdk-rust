...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the template.</p><br>
