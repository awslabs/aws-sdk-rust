...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::set_id): <p>The ID of the migration workflow.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::set_name): <p>The name of the migration workflow.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_workflow::builders::UpdateWorkflowFluentBuilder::set_description): <p>The description of the migration workflow.</p>
