...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_template_step_groups::builders::ListTemplateStepGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_template_step_groups::builders::ListTemplateStepGroupsFluentBuilder::set_next_token): <p>The pagination token.</p>
    ///   - [`template_id(impl ::std::convert::Into<String>)`](crate::operation::list_template_step_groups::builders::ListTemplateStepGroupsFluentBuilder::template_id) / [`set_template_id(Option<String>)`](crate::operation::list_template_step_groups::builders::ListTemplateStepGroupsFluentBuilder::set_template_id): <p>The ID of the template.</p>
