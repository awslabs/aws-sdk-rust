...
impl GetTemplateStepGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_template_step_group::GetTemplateStepGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTemplateStepGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_template_step_group::de_get_template_step_group_http_response_with_props(status, headers, body)
        }
    }
}
