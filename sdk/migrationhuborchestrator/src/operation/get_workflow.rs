...
impl GetWorkflow {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_workflow::GetWorkflowError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_workflow::GetWorkflowOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "MigrationHubOrchestrator.GetWorkflow",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetWorkflow")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetWorkflowTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetWorkflowTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetWorkflowTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetWorkflowInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetWorkflowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_workflow::de_get_workflow_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_workflow::de_get_workflow_http_response(status, headers, body, _cfg)
        };
