...
impl GetWorkflowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_workflow::GetWorkflow,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_workflow::GetWorkflow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkflow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_workflow::de_get_workflow_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_workflow::de_get_workflow_http_response_with_props(
                status, headers, body,
            )
        }
    }
