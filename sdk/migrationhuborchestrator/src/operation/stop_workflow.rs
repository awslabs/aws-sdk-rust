...
impl StopWorkflow {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_workflow::StopWorkflowInput,
                    ) -> ::std::result::Result<crate::operation::stop_workflow::StopWorkflowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_workflow::StopWorkflowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_workflow::StopWorkflowError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_workflow::StopWorkflowOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopWorkflow {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopWorkflow");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopWorkflowRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopWorkflowResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopWorkflow")
...
.with_interceptor(StopWorkflowEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_workflow::StopWorkflowError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_workflow::StopWorkflowError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_workflow::StopWorkflowError>::new());
...
#[derive(Debug)]
            struct StopWorkflowResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopWorkflowResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_workflow::de_stop_workflow_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_workflow::de_stop_workflow_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopWorkflowRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopWorkflowRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_workflow::StopWorkflowInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_workflow::StopWorkflowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/migrationworkflow/{id}/stop", id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct StopWorkflowEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopWorkflowEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopWorkflowEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopWorkflowInput>()
                        .ok_or("failed to downcast to StopWorkflowInput")?;
...
pub enum StopWorkflowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopWorkflowError) for what information is available for the error.")]
...
impl StopWorkflowError {
    /// Creates the `StopWorkflowError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopWorkflowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopWorkflowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_workflow::StopWorkflowError {
