...
impl ListTemplateStepsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_template_steps::ListTemplateSteps::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTemplateSteps {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_template_steps::de_list_template_steps_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_template_steps::ListTemplateStepsError
{
