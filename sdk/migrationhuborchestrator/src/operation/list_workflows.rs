...
impl ListWorkflows {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "MigrationHubOrchestrator.ListWorkflows",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWorkflowsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("adsApplicationConfigurationName") {
            if let ::std::option::Option::Some(value) = input.ads_application_configuration_name.as_deref() {
                captured.insert("adsApplicationConfigurationName", value);
            }
        }
