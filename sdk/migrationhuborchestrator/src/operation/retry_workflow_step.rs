...
impl RetryWorkflowStepInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::retry_workflow_step::RetryWorkflowStep::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("RetryWorkflowStep", "migrationhuborchestrator"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetryWorkflowStep {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_retry_workflow_step::de_retry_workflow_step_http_response_with_props(status, headers, body)
        }
    }
}
