...
pub struct ListWorkflowStepGroupsOutput  {
    ...
    #[doc(hidden)]pub workflow_step_groups_summary: std::option::Option<std::vec::Vec<crate::model::WorkflowStepGroupSummary>>,
}
...
impl  std::fmt::Debug for ListWorkflowStepGroupsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListWorkflowStepGroupsOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("workflow_step_groups_summary", &self.workflow_step_groups_summary);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateWorkflowStepGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateWorkflowStepGroupOutput");
...
impl  std::fmt::Debug for DeleteWorkflowStepGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteWorkflowStepGroupOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for UpdateWorkflowStepGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateWorkflowStepGroupOutput");
        formatter.field("workflow_id", &self.workflow_id);
        formatter.field("name", &self.name);
        formatter.field("id", &self.id);
        formatter.field("description", &self.description);
...
impl  std::fmt::Debug for GetWorkflowStepGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetWorkflowStepGroupOutput");
        formatter.field("id", &self.id);
        formatter.field("workflow_id", &self.workflow_id);
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
...
impl  std::fmt::Debug for RetryWorkflowStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("RetryWorkflowStepOutput");
...
pub struct ListWorkflowStepsOutput  {
    ...
    #[doc(hidden)]pub workflow_steps_summary: std::option::Option<std::vec::Vec<crate::model::WorkflowStepSummary>>,
}
...
impl  std::fmt::Debug for ListWorkflowStepsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListWorkflowStepsOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("workflow_steps_summary", &self.workflow_steps_summary);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for CreateWorkflowStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateWorkflowStepOutput");
        formatter.field("id", &self.id);
        formatter.field("step_group_id", &self.step_group_id);
        formatter.field("workflow_id", &self.workflow_id);
        formatter.field("name", &self.name);
...
impl  std::fmt::Debug for DeleteWorkflowStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DeleteWorkflowStepOutput");
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for UpdateWorkflowStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateWorkflowStepOutput");
        formatter.field("id", &self.id);
        formatter.field("step_group_id", &self.step_group_id);
        formatter.field("workflow_id", &self.workflow_id);
        formatter.field("name", &self.name);
...
pub struct GetWorkflowStepOutput  {
    ...
    #[doc(hidden)]pub script_output_location: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for GetWorkflowStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetWorkflowStepOutput");
        formatter.field("name", &self.name);
        formatter.field("step_group_id", &self.step_group_id);
        formatter.field("workflow_id", &self.workflow_id);
        ...
        formatter.field("script_output_location", &self.script_output_location);
        formatter.field("creation_time", &self.creation_time);
...
pub struct ListTemplateStepGroupsOutput  {
    ...
    #[doc(hidden)]pub template_step_group_summary: std::option::Option<std::vec::Vec<crate::model::TemplateStepGroupSummary>>,
}
...
impl  std::fmt::Debug for ListTemplateStepGroupsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListTemplateStepGroupsOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("template_step_group_summary", &self.template_step_group_summary);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for GetTemplateStepGroupOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetTemplateStepGroupOutput");
...
pub struct ListTemplateStepsOutput  {
    ...
    #[doc(hidden)]pub template_step_summary_list: std::option::Option<std::vec::Vec<crate::model::TemplateStepSummary>>,
}
...
impl  std::fmt::Debug for ListTemplateStepsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListTemplateStepsOutput");
        formatter.field("next_token", &self.next_token);
        formatter.field("template_step_summary_list", &self.template_step_summary_list);
        formatter.finish()
    }
}
...
pub struct GetTemplateStepOutput  {
    ...
    #[doc(hidden)]pub next: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The outputs of the step.</p>
    #[doc(hidden)]pub outputs: std::option::Option<std::vec::Vec<crate::model::StepOutput>>,
    /// <p>The custom script to run tests on source or target environments.</p>
    #[doc(hidden)]pub step_automation_configuration: std::option::Option<crate::model::StepAutomationConfiguration>,
}
...
impl  std::fmt::Debug for GetTemplateStepOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetTemplateStepOutput");
        formatter.field("id", &self.id);
        formatter.field("step_group_id", &self.step_group_id);
        formatter.field("template_id", &self.template_id);
        formatter.field("name", &self.name);
        ...
        formatter.field("next", &self.next);
        formatter.field("outputs", &self.outputs);
        formatter.field("step_automation_configuration", &self.step_automation_configuration);
        formatter.finish()
    }
}
...
pub struct ListPluginsOutput  {
    ...
    #[doc(hidden)]pub plugins: std::option::Option<std::vec::Vec<crate::model::PluginSummary>>,
}
...
impl  std::fmt::Debug for ListPluginsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListPluginsOutput");
        formatter.field("next_token", &self.next_token);
...
pub struct ListTemplatesOutput  {
    ...
    #[doc(hidden)]pub template_summary: std::option::Option<std::vec::Vec<crate::model::TemplateSummary>>,
}
...
impl  std::fmt::Debug for ListTemplatesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("template_summary", &self.template_summary);
        formatter.finish()
    }
}
...
pub struct GetTemplateOutput  {
    ...
    #[doc(hidden)]pub inputs: std::option::Option<std::vec::Vec<crate::model::TemplateInput>>,
    /// <p>List of AWS services utilized in a migration workflow.</p>
    #[doc(hidden)]pub tools: std::option::Option<std::vec::Vec<crate::model::Tool>>,
...
impl  std::fmt::Debug for StopWorkflowOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("StopWorkflowOutput");
        formatter.field("id", &self.id);
...
impl  std::fmt::Debug for StartWorkflowOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("StartWorkflowOutput");
        formatter.field("id", &self.id);
        formatter.field("arn", &self.arn);
        formatter.field("status", &self.status);
        formatter.field("status_message", &self.status_message);
...
pub struct ListWorkflowsOutput  {
    ...
    #[doc(hidden)]pub migration_workflow_summary: std::option::Option<std::vec::Vec<crate::model::MigrationWorkflowSummary>>,
}
...
impl  std::fmt::Debug for ListWorkflowsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("migration_workflow_summary", &self.migration_workflow_summary);
        formatter.finish()
    }
}
...
pub struct CreateWorkflowOutput  {
    ...
    #[doc(hidden)]pub ads_application_configuration_id: std::option::Option<std::string::String>,
    /// <p>The inputs for creating a migration workflow.</p>
    #[doc(hidden)]pub workflow_inputs: std::option::Option<std::collections::HashMap<std::string::String, crate::model::StepInput>>,
    /// <p>The servers on which a step will be run.</p>
...
pub struct GetWorkflowOutput  {
    ...
    #[doc(hidden)]pub ads_application_name: std::option::Option<std::string::String>,
    /// <p>The status of the migration workflow.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::MigrationWorkflowStatusEnum>,
    /// <p>The status message of the migration workflow.</p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub workflow_bucket: std::option::Option<std::string::String>,
}
