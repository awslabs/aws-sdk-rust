...
pub(crate) fn batch_get_policy_output_output_correct_errors(
    mut builder: crate::operation::batch_get_policy::builders::BatchGetPolicyOutputBuilder,
) -> crate::operation::batch_get_policy::builders::BatchGetPolicyOutputBuilder {
...
pub(crate) fn batch_get_policy_error_item_correct_errors(
    mut builder: crate::types::builders::BatchGetPolicyErrorItemBuilder,
) -> crate::types::builders::BatchGetPolicyErrorItemBuilder {
    if builder.code.is_none() {
        builder.code = "no value was set".parse::<crate::types::BatchGetPolicyErrorCode>().ok()
    }
    if builder.policy_store_id.is_none() {
        builder.policy_store_id = Some(Default::default())
    }
...
pub(crate) fn batch_get_policy_output_item_correct_errors(
    mut builder: crate::types::builders::BatchGetPolicyOutputItemBuilder,
) -> crate::types::builders::BatchGetPolicyOutputItemBuilder {
    if builder.policy_store_id.is_none() {
        builder.policy_store_id = Some(Default::default())
    }
    if builder.policy_id.is_none() {
