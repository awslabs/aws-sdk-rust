...
/// Orchestration and serialization glue logic for `BatchIsAuthorized`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BatchIsAuthorized;
impl BatchIsAuthorized {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_is_authorized::BatchIsAuthorizedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_is_authorized::BatchIsAuthorizedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_is_authorized::BatchIsAuthorizedError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_is_authorized::BatchIsAuthorizedOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchIsAuthorized {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchIsAuthorized");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchIsAuthorizedRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchIsAuthorizedResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchIsAuthorized")
...
.with_interceptor(BatchIsAuthorizedEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_is_authorized::BatchIsAuthorizedError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_is_authorized::BatchIsAuthorizedError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_is_authorized::BatchIsAuthorizedError>::new());
...
#[derive(Debug)]
            struct BatchIsAuthorizedResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchIsAuthorizedResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_is_authorized::de_batch_is_authorized_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_is_authorized::de_batch_is_authorized_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchIsAuthorizedRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchIsAuthorizedRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_is_authorized::BatchIsAuthorizedInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_is_authorized::BatchIsAuthorizedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_is_authorized::ser_batch_is_authorized_input(&input)?);
...
#[derive(Debug)]
            struct BatchIsAuthorizedEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchIsAuthorizedEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchIsAuthorizedEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchIsAuthorizedInput>()
                        .ok_or("failed to downcast to BatchIsAuthorizedInput")?;
...
/// Error type for the `BatchIsAuthorizedError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum BatchIsAuthorizedError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchIsAuthorizedError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl BatchIsAuthorizedError {
    /// Creates the `BatchIsAuthorizedError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchIsAuthorizedError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `BatchIsAuthorizedError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `BatchIsAuthorizedError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `BatchIsAuthorizedError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `BatchIsAuthorizedError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `BatchIsAuthorizedError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for BatchIsAuthorizedError {
...
impl ::std::fmt::Display for BatchIsAuthorizedError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for BatchIsAuthorizedError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for BatchIsAuthorizedError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchIsAuthorizedError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_is_authorized::BatchIsAuthorizedError {
...
mod _batch_is_authorized_output;
