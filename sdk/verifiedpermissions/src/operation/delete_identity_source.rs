    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_identity_source::DeleteIdentitySourceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_identity_source::DeleteIdentitySourceOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteIdentitySource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteIdentitySource", "verifiedpermissions"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteIdentitySource")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteIdentitySourceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteIdentitySourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_identity_source::DeleteIdentitySourceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_identity_source::ser_delete_identity_source_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteIdentitySourceEndpointParamsInterceptor {
...
pub type DeleteIdentitySourceErrorKind = DeleteIdentitySourceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteIdentitySourceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_identity_source::DeleteIdentitySourceError {
...
impl DeleteIdentitySourceError {
    ...
    /// Creates the `DeleteIdentitySourceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
