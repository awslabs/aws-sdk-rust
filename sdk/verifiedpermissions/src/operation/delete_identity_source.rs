...
impl DeleteIdentitySourceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIdentitySource`](crate::operation::delete_identity_source::DeleteIdentitySource)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_identity_source::DeleteIdentitySource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteIdentitySource", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentitySource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_identity_source::de_delete_identity_source_http_response_with_props(status, headers, body)
        }
    }
}
