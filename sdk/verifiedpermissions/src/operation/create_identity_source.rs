...
pub type CreateIdentitySourceErrorKind = CreateIdentitySourceError;
...
impl CreateIdentitySourceError {
    ...
    /// Creates the `CreateIdentitySourceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
