...
impl CreateIdentitySourceInput {
    /// Consumes the builder and constructs an Operation<[`CreateIdentitySource`](crate::operation::create_identity_source::CreateIdentitySource)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_identity_source::CreateIdentitySource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateIdentitySource", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIdentitySource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_identity_source::de_create_identity_source_http_response_with_props(status, headers, body)
        }
    }
}
