...
impl DeletePolicyStoreInput {
    /// Consumes the builder and constructs an Operation<[`DeletePolicyStore`](crate::operation::delete_policy_store::DeletePolicyStore)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_policy_store::ser_delete_policy_store_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_policy_store::DeletePolicyStore::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePolicyStore", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePolicyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_policy_store::de_delete_policy_store_http_response_with_props(status, headers, body)
        }
    }
}
