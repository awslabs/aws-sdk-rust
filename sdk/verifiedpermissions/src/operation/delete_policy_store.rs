...
impl DeletePolicyStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_policy_store::ser_delete_policy_store_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_policy_store::DeletePolicyStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePolicyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_policy_store::de_delete_policy_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_policy_store::DeletePolicyStoreError
{
