...
impl UpdatePolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_policy::ser_update_policy_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_policy::UpdatePolicy::new(),
        )
...
/// `ParseStrictResponse` impl for `UpdatePolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_policy::de_update_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_policy::de_update_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
