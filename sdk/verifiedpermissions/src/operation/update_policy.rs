...
impl UpdatePolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePolicy`](crate::operation::update_policy::UpdatePolicy)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_policy::UpdatePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_policy::ser_update_policy_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_policy::UpdatePolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePolicy", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicy {
    type Output = ::std::result::Result<crate::operation::update_policy::UpdatePolicyOutput, crate::operation::update_policy::UpdatePolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_policy::de_update_policy_http_response_with_props(status, headers, body)
        }
    }
}
