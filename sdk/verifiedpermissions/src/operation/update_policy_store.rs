...
impl UpdatePolicyStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_policy_store::ser_update_policy_store_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_policy_store::UpdatePolicyStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_policy_store::de_update_policy_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_policy_store::UpdatePolicyStoreError
{
