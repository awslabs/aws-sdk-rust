...
impl UpdatePolicyStore {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_policy_store::UpdatePolicyStoreInput,
                    ) -> ::std::result::Result<crate::operation::update_policy_store::UpdatePolicyStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_policy_store::UpdatePolicyStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_policy_store::UpdatePolicyStoreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_policy_store::UpdatePolicyStoreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdatePolicyStore {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdatePolicyStore");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdatePolicyStoreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdatePolicyStoreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdatePolicyStore")
...
.with_interceptor(UpdatePolicyStoreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_policy_store::UpdatePolicyStoreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_policy_store::UpdatePolicyStoreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_policy_store::UpdatePolicyStoreError>::new());
...
#[derive(Debug)]
            struct UpdatePolicyStoreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePolicyStoreResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_policy_store::de_update_policy_store_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_policy_store::de_update_policy_store_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdatePolicyStoreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePolicyStoreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_policy_store::UpdatePolicyStoreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_policy_store::UpdatePolicyStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_policy_store::ser_update_policy_store_input(&input)?);
...
#[derive(Debug)]
            struct UpdatePolicyStoreEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdatePolicyStoreEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdatePolicyStoreEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdatePolicyStoreInput>()
                        .ok_or("failed to downcast to UpdatePolicyStoreInput")?;
...
/// Error type for the `UpdatePolicyStoreError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdatePolicyStoreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdatePolicyStoreError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdatePolicyStoreError {
    /// Creates the `UpdatePolicyStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdatePolicyStoreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `UpdatePolicyStoreError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for UpdatePolicyStoreError {
...
impl ::std::fmt::Display for UpdatePolicyStoreError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdatePolicyStoreError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdatePolicyStoreError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdatePolicyStoreError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_policy_store::UpdatePolicyStoreError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_policy_store::_update_policy_store_output::UpdatePolicyStoreOutput;

pub use crate::operation::update_policy_store::_update_policy_store_input::UpdatePolicyStoreInput;

mod _update_policy_store_input;

mod _update_policy_store_output;
