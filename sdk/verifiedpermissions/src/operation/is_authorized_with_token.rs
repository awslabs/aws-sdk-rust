...
/// Orchestration and serialization glue logic for `IsAuthorizedWithToken`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct IsAuthorizedWithToken;
impl IsAuthorizedWithToken {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IsAuthorizedWithToken {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("IsAuthorizedWithToken");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(IsAuthorizedWithTokenRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(IsAuthorizedWithTokenResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IsAuthorizedWithToken")
...
.with_interceptor(IsAuthorizedWithTokenEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>::new());
...
#[derive(Debug)]
            struct IsAuthorizedWithTokenResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IsAuthorizedWithTokenResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_is_authorized_with_token::de_is_authorized_with_token_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_is_authorized_with_token::de_is_authorized_with_token_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct IsAuthorizedWithTokenRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IsAuthorizedWithTokenRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::is_authorized_with_token::IsAuthorizedWithTokenInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_is_authorized_with_token::ser_is_authorized_with_token_input(&input)?);
...
#[derive(Debug)]
            struct IsAuthorizedWithTokenEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for IsAuthorizedWithTokenEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "IsAuthorizedWithTokenEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<IsAuthorizedWithTokenInput>()
                        .ok_or("failed to downcast to IsAuthorizedWithTokenInput")?;
...
/// Error type for the `IsAuthorizedWithTokenError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum IsAuthorizedWithTokenError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-IsAuthorizedWithTokenError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl IsAuthorizedWithTokenError {
    /// Creates the `IsAuthorizedWithTokenError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `IsAuthorizedWithTokenError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `IsAuthorizedWithTokenError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `IsAuthorizedWithTokenError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `IsAuthorizedWithTokenError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `IsAuthorizedWithTokenError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `IsAuthorizedWithTokenError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for IsAuthorizedWithTokenError {
...
impl ::std::fmt::Display for IsAuthorizedWithTokenError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for IsAuthorizedWithTokenError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for IsAuthorizedWithTokenError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for IsAuthorizedWithTokenError {
...
impl ::aws_types::request_id::RequestId for crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError {
...
mod _is_authorized_with_token_output;
