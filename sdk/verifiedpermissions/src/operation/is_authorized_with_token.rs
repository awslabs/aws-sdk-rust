...
impl IsAuthorizedWithTokenInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_is_authorized_with_token::ser_is_authorized_with_token_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::is_authorized_with_token::IsAuthorizedWithToken::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError
{
