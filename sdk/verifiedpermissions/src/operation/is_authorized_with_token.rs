...
impl IsAuthorizedWithTokenInput {
    /// Consumes the builder and constructs an Operation<[`IsAuthorizedWithToken`](crate::operation::is_authorized_with_token::IsAuthorizedWithToken)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::is_authorized_with_token::IsAuthorizedWithToken::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsAuthorizedWithToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_is_authorized_with_token::de_is_authorized_with_token_http_response_with_props(status, headers, body)
        }
    }
}
