    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IsAuthorizedWithToken {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IsAuthorizedWithToken")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for IsAuthorizedWithTokenResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for IsAuthorizedWithTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_is_authorized_with_token::ser_is_authorized_with_token_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for IsAuthorizedWithTokenEndpointParamsInterceptor {
...
pub type IsAuthorizedWithTokenErrorKind = IsAuthorizedWithTokenError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for IsAuthorizedWithTokenError {
...
impl ::aws_http::request_id::RequestId for crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError {
...
impl IsAuthorizedWithTokenError {
    ...
    /// Creates the `IsAuthorizedWithTokenError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
