...
impl CreatePolicyStoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_policy_store::CreatePolicyStore::new(),
        )
...
/// `ParseStrictResponse` impl for `CreatePolicyStore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePolicyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_policy_store::de_create_policy_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_policy_store::CreatePolicyStoreError
{
