...
impl PutSchemaInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_schema::ser_put_schema_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_schema::PutSchema::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSchema {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_schema::de_put_schema_http_response_with_props(
                status, headers, body,
            )
        }
    }
