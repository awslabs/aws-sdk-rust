...
impl PutSchemaInput {
    /// Consumes the builder and constructs an Operation<[`PutSchema`](crate::operation::put_schema::PutSchema)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_schema::PutSchema, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_schema::ser_put_schema_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_schema::PutSchema::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutSchema", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSchema {
    type Output = ::std::result::Result<crate::operation::put_schema::PutSchemaOutput, crate::operation::put_schema::PutSchemaError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_schema::de_put_schema_http_response_with_props(status, headers, body)
        }
    }
}
