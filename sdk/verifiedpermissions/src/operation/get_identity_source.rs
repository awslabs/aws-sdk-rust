...
impl GetIdentitySourceInput {
    /// Consumes the builder and constructs an Operation<[`GetIdentitySource`](crate::operation::get_identity_source::GetIdentitySource)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_identity_source::ser_get_identity_source_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_identity_source::GetIdentitySource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetIdentitySource", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentitySource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_identity_source::de_get_identity_source_http_response_with_props(status, headers, body)
        }
    }
}
