...
impl IsAuthorizedInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_is_authorized::ser_is_authorized_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::is_authorized::IsAuthorized::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsAuthorized {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_is_authorized::de_is_authorized_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_is_authorized::de_is_authorized_http_response_with_props(
                status, headers, body,
            )
        }
    }
