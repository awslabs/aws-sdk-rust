...
impl ListPolicyTemplatesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_policy_templates::ser_list_policy_templates_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_policy_templates::ListPolicyTemplates::new(),
        )
...
/// `ParseStrictResponse` impl for `ListPolicyTemplates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_policy_templates::de_list_policy_templates_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_policy_templates::ListPolicyTemplatesError
{
