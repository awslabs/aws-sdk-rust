...
impl ListPolicyTemplatesInput {
    /// Consumes the builder and constructs an Operation<[`ListPolicyTemplates`](crate::operation::list_policy_templates::ListPolicyTemplates)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policy_templates::ListPolicyTemplates::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicyTemplates", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_policy_templates::de_list_policy_templates_http_response_with_props(status, headers, body)
        }
    }
}
