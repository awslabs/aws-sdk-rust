...
impl GetPolicyStoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_policy_store::GetPolicyStore::new(),
        )
...
/// `ParseStrictResponse` impl for `GetPolicyStore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPolicyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_policy_store::de_get_policy_store_http_error(
                status, headers, body,
            )
        } else {
