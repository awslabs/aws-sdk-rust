    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_identity_source::UpdateIdentitySourceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_identity_source::UpdateIdentitySourceOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateIdentitySourceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateIdentitySourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_identity_source::UpdateIdentitySourceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_identity_source::ser_update_identity_source_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateIdentitySourceEndpointParamsInterceptor {
...
pub type UpdateIdentitySourceErrorKind = UpdateIdentitySourceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateIdentitySourceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_identity_source::UpdateIdentitySourceError {
...
impl UpdateIdentitySourceError {
    ...
    /// Creates the `UpdateIdentitySourceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
