...
impl UpdateIdentitySourceInput {
    /// Consumes the builder and constructs an Operation<[`UpdateIdentitySource`](crate::operation::update_identity_source::UpdateIdentitySource)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_identity_source::UpdateIdentitySource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateIdentitySource", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIdentitySource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_identity_source::de_update_identity_source_http_response_with_props(status, headers, body)
        }
    }
}
