...
impl crate::operation::get_schema::builders::GetSchemaInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_schema::GetSchemaOutput, crate::operation::get_schema::GetSchemaError>
    for GetSchemaFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_schema::GetSchemaOutput, crate::operation::get_schema::GetSchemaError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetSchemaFluentBuilder {
    /// Creates a new `GetSchemaFluentBuilder`.
