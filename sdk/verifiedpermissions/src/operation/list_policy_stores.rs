...
impl ListPolicyStoresInput {
    /// Consumes the builder and constructs an Operation<[`ListPolicyStores`](crate::operation::list_policy_stores::ListPolicyStores)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_policy_stores::ser_list_policy_stores_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policy_stores::ListPolicyStores::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicyStores", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_policy_stores::de_list_policy_stores_http_response_with_props(status, headers, body)
        }
    }
}
