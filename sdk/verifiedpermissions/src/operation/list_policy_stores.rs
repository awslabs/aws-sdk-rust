...
impl ListPolicyStoresInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_policy_stores::ser_list_policy_stores_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_policy_stores::ListPolicyStores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_policy_stores::de_list_policy_stores_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_policy_stores::ListPolicyStoresError
{
