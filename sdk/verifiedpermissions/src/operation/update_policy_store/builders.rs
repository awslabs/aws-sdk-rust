...
impl UpdatePolicyStoreFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_policy_store::UpdatePolicyStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_policy_store::UpdatePolicyStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_policy_store::UpdatePolicyStoreOutput, crate::operation::update_policy_store::UpdatePolicyStoreError, Self> {
