...
pub use crate::operation::delete_policy_template::_delete_policy_template_output::DeletePolicyTemplateOutputBuilder;
...
pub struct DeletePolicyTemplateFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_policy_template::builders::DeletePolicyTemplateInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_policy_template::DeletePolicyTemplateOutput,
                    crate::operation::delete_policy_template::DeletePolicyTemplateError,
                > for DeletePolicyTemplateFluentBuilder
            {
                fn send(
                    self,
...
impl DeletePolicyTemplateFluentBuilder {
    /// Creates a new `DeletePolicyTemplate`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_policy_template::DeletePolicyTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_policy_template::DeletePolicyTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_policy_template::DeletePolicyTemplate::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_policy_template::DeletePolicyTemplate::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_policy_template::DeletePolicyTemplateOutput, crate::operation::delete_policy_template::DeletePolicyTemplateError, Self> {
