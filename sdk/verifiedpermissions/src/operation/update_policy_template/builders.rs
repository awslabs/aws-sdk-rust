...
impl UpdatePolicyTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_policy_template::UpdatePolicyTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_policy_template::UpdatePolicyTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_policy_template::UpdatePolicyTemplateOutput, crate::operation::update_policy_template::UpdatePolicyTemplateError, Self> {
