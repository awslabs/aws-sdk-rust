...
impl crate::operation::update_identity_source::builders::UpdateIdentitySourceInputBuilder {
...
///
/// <p>Updates the specified identity source to use a new identity provider (IdP), or to change the mapping of identities from the IdP to a different principal entity type.</p><note>
