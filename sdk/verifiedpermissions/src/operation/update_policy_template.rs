...
impl UpdatePolicyTemplateInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePolicyTemplate`](crate::operation::update_policy_template::UpdatePolicyTemplate)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_policy_template::UpdatePolicyTemplate::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePolicyTemplate", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicyTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_policy_template::de_update_policy_template_http_response_with_props(status, headers, body)
        }
    }
}
