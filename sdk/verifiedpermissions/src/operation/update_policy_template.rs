    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_policy_template::UpdatePolicyTemplateError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_policy_template::UpdatePolicyTemplateOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdatePolicyTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdatePolicyTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_policy_template::UpdatePolicyTemplateInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_policy_template::ser_update_policy_template_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdatePolicyTemplateEndpointParamsInterceptor {
...
pub type UpdatePolicyTemplateErrorKind = UpdatePolicyTemplateError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdatePolicyTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_policy_template::UpdatePolicyTemplateError {
...
impl UpdatePolicyTemplateError {
    ...
    /// Creates the `UpdatePolicyTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
