...
impl GetPolicyTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_policy_template::GetPolicyTemplate::new(),
        )
...
/// `ParseStrictResponse` impl for `GetPolicyTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPolicyTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_policy_template::de_get_policy_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_policy_template::GetPolicyTemplateError
{
