...
impl ListIdentitySourcesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_identity_sources::ser_list_identity_sources_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_identity_sources::ListIdentitySources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentitySources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_identity_sources::de_list_identity_sources_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_identity_sources::ListIdentitySourcesError
{
