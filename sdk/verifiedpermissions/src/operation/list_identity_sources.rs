...
impl ListIdentitySourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListIdentitySources`](crate::operation::list_identity_sources::ListIdentitySources)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_identity_sources::ListIdentitySources,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_identity_sources::ListIdentitySources::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIdentitySources", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentitySources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_identity_sources::de_list_identity_sources_http_response_with_props(status, headers, body)
        }
    }
}
