...
pub(crate) fn de_policy_item<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PolicyItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "definition" => {
                            builder = builder.set_definition(crate::protocol_serde::shape_policy_definition_item::de_policy_definition_item(tokens)?);
                        }
                        "createdDate" => {
            ...
            Ok(Some(crate::serde_util::policy_item_correct_errors(builder).build().map_err(|err| {
