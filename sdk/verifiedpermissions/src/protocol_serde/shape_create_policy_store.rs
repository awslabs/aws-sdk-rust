...
pub fn de_create_policy_store_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_policy_store::CreatePolicyStoreOutput, crate::operation::create_policy_store::CreatePolicyStoreError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_policy_store_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_policy_store::CreatePolicyStoreOutput, crate::operation::create_policy_store::CreatePolicyStoreError>
{
    Ok({
        ...
        crate::serde_util::create_policy_store_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_policy_store::CreatePolicyStoreError::unhandled)?
    })
}
...
) -> Result<crate::operation::create_policy_store::builders::CreatePolicyStoreOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
