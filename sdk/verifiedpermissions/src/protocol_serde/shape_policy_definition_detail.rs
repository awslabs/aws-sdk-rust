...
) -> Result<Option<crate::types::PolicyDefinitionDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "static" => Some(crate::types::PolicyDefinitionDetail::Static(
                            crate::protocol_serde::shape_static_policy_definition_detail::de_static_policy_definition_detail(tokens)?.ok_or_else(
