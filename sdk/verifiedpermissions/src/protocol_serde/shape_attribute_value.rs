                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        "entityIdentifier" => Some(crate::types::AttributeValue::EntityIdentifier(
                            crate::protocol_serde::shape_entity_identifier::de_entity_identifier(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "set" => Some(crate::types::AttributeValue::Set(
                            crate::protocol_serde::shape_set_attribute::de_set_attribute(tokens, _value, depth + 1)?
                        ...
                        "record" => Some(crate::types::AttributeValue::Record(
                            crate::protocol_serde::shape_record_attribute::de_record_attribute(tokens, _value, depth + 1)?.ok_or_else(|| {
