...
pub fn ser_attribute_value(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AttributeValue) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::AttributeValue::Long(inner) => {
             {
                object_4.key("long").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*inner).into()));
            }
        },
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            "boolean" => {
                                Some(crate::types::AttributeValue::Boolean(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'boolean' cannot be null"))?
                                ))
                            }
                            "entityIdentifier" => {
                                Some(crate::types::AttributeValue::EntityIdentifier(
                                    crate::protocol_serde::shape_entity_identifier::de_entity_identifier(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'entityIdentifier' cannot be null"))?
                                ))
                            }
                            "long" => {
                                Some(crate::types::AttributeValue::Long(
                            ...
                            "string" => {
                                Some(crate::types::AttributeValue::String(
                            ...
                            "set" => {
                                Some(crate::types::AttributeValue::Set(
                            ...
                            "record" => {
                                Some(crate::types::AttributeValue::Record(
                                    crate::protocol_serde::shape_record_attribute::de_record_attribute(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'record' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
