...
impl super::Client {
    ...
    ///   - [`namespaces(Option<Vec<String>>)`](crate::operation::put_schema::PutSchemaOutput::namespaces): <p>Identifies the namespaces of the entities referenced by this schema.</p>
    ///   - [`created_date(Option<DateTime>)`](crate::operation::put_schema::PutSchemaOutput::created_date): <p>The date and time that the schema was originally created.</p>
    ///   - [`last_updated_date(Option<DateTime>)`](crate::operation::put_schema::PutSchemaOutput::last_updated_date): <p>The date and time that the schema was last updated.</p>
