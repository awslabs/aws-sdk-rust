...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::set_client_token): <p>Specifies a unique, case-sensitive ID that you provide to ensure the idempotency of the request. This lets you safely retry the request without accidentally performing the same operation a second time. Passing the same value to a later call to an operation requires that you also pass the same value for all other parameters. We recommend that you use a <a href="https://wikipedia.org/wiki/Universally_unique_identifier">UUID type of value.</a>.</p>  <p>If you don't provide this value, then Amazon Web Services generates a random one for you.</p>  <p>If you retry the operation with the same <code>ClientToken</code>, but with different parameters, the retry fails with an <code>IdempotentParameterMismatch</code> error.</p>
    ///   - [`policy_store_id(impl ::std::convert::Into<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::policy_store_id) / [`set_policy_store_id(Option<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::set_policy_store_id): <p>The ID of the policy store in which to create the policy template.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::set_description): <p>Specifies a description for the policy template.</p>
    ///   - [`statement(impl ::std::convert::Into<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::statement) / [`set_statement(Option<String>)`](crate::operation::create_policy_template::builders::CreatePolicyTemplateFluentBuilder::set_statement): <p>Specifies the content that you want to use for the new policy template, written in the Cedar policy language.</p>
    ...
    ///   - [`policy_store_id(Option<String>)`](crate::operation::create_policy_template::CreatePolicyTemplateOutput::policy_store_id): <p>The ID of the policy store that contains the policy template.</p>
    ///   - [`policy_template_id(Option<String>)`](crate::operation::create_policy_template::CreatePolicyTemplateOutput::policy_template_id): <p>The unique ID of the new policy template.</p>
