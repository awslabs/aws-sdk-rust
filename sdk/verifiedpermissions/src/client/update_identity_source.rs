...
impl super::Client {
    ...
    ///   - [`principal_entity_type(impl Into<String>)`](crate::operation::update_identity_source::builders::UpdateIdentitySourceFluentBuilder::principal_entity_type) / [`set_principal_entity_type(Option<String>)`](crate::operation::update_identity_source::builders::UpdateIdentitySourceFluentBuilder::set_principal_entity_type): <p>Specifies the data type of principals generated for identities authenticated by the identity source.</p>
