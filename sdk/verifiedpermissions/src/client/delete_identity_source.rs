...
impl super::Client {
    ...
    ///   - [`policy_store_id(impl ::std::convert::Into<String>)`](crate::operation::delete_identity_source::builders::DeleteIdentitySourceFluentBuilder::policy_store_id) / [`set_policy_store_id(Option<String>)`](crate::operation::delete_identity_source::builders::DeleteIdentitySourceFluentBuilder::set_policy_store_id): <p>Specifies the ID of the policy store that contains the identity source that you want to delete.</p>
