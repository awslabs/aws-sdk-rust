...
impl super::Client {
    ...
    ///   - [`created_date(Option<DateTime>)`](crate::operation::get_schema::GetSchemaOutput::created_date): <p>The date and time that the schema was originally created.</p>
    ///   - [`last_updated_date(Option<DateTime>)`](crate::operation::get_schema::GetSchemaOutput::last_updated_date): <p>The date and time that the schema was most recently updated.</p>
