...
impl super::Client {
    ...
    ///   - [`policy_store_id(impl ::std::convert::Into<String>)`](crate::operation::delete_policy::builders::DeletePolicyFluentBuilder::policy_store_id) / [`set_policy_store_id(Option<String>)`](crate::operation::delete_policy::builders::DeletePolicyFluentBuilder::set_policy_store_id): <p>Specifies the ID of the policy store that contains the policy that you want to delete.</p>
