...
impl super::Client {
    ...
    pub fn update_policy_store(
        &self,
    ) -> crate::operation::update_policy_store::builders::UpdatePolicyStoreFluentBuilder {
        crate::operation::update_policy_store::builders::UpdatePolicyStoreFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
