...
impl super::Client {
    ...
    ///   - [`entities(EntitiesDefinition)`](crate::operation::batch_is_authorized::builders::BatchIsAuthorizedFluentBuilder::entities) / [`set_entities(Option<EntitiesDefinition>)`](crate::operation::batch_is_authorized::builders::BatchIsAuthorizedFluentBuilder::set_entities):<br>required: **false**<br><p>(Optional) Specifies the list of resources and principals and their associated attributes that Verified Permissions can examine when evaluating the policies. These additional entities and their attributes can be referenced and checked by conditional elements in the policies in the specified policy store.</p><note>  <p>You can include only principal and resource entities in this parameter; you can't include actions. You must specify actions in the schema.</p> </note><br>
