...
impl CognitoUserPoolConfigurationItemBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CognitoUserPoolConfigurationItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CognitoUserPoolConfigurationItem {
                user_pool_arn: self.user_pool_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("user_pool_arn", "user_pool_arn was not specified but it is required when building CognitoUserPoolConfigurationItem")
                    )?
                ,
                client_ids: self.client_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("client_ids", "client_ids was not specified but it is required when building CognitoUserPoolConfigurationItem")
                    )?
                ,
                issuer: self.issuer
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("issuer", "issuer was not specified but it is required when building CognitoUserPoolConfigurationItem")
                    )?
                ,
            }
        )
