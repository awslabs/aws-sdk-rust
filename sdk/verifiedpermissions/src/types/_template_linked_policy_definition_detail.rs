...
impl TemplateLinkedPolicyDefinitionDetailBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TemplateLinkedPolicyDefinitionDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::TemplateLinkedPolicyDefinitionDetail {
                policy_template_id: self.policy_template_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("policy_template_id", "policy_template_id was not specified but it is required when building TemplateLinkedPolicyDefinitionDetail")
                    )?
                ,
