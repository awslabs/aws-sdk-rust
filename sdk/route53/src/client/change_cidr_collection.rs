...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::change_cidr_collection::builders::ChangeCidrCollectionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::change_cidr_collection::builders::ChangeCidrCollectionFluentBuilder::set_id): <p>The UUID of the CIDR collection to update.</p>
