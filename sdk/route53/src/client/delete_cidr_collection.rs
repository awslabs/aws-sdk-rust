...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_cidr_collection::builders::DeleteCidrCollectionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_cidr_collection::builders::DeleteCidrCollectionFluentBuilder::set_id):<br>required: **true**<br><p>The UUID of the collection to delete.</p><br>
