...
impl super::Client {
    ...
    ///   - [`location(String)`](crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetOutput::location): <p>The unique URL representing the new reusable delegation set.</p>
