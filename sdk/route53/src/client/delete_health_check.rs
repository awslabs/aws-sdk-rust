...
impl super::Client {
    ...
    ///   - [`health_check_id(impl Into<String>)`](crate::operation::delete_health_check::builders::DeleteHealthCheckFluentBuilder::health_check_id) / [`set_health_check_id(Option<String>)`](crate::operation::delete_health_check::builders::DeleteHealthCheckFluentBuilder::set_health_check_id):<br>required: **true**<br><p>The ID of the health check that you want to delete.</p><br>
