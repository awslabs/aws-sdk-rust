...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_traffic_policy::builders::GetTrafficPolicyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_traffic_policy::builders::GetTrafficPolicyFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the traffic policy that you want to get information about.</p><br>
    ///   - [`version(i32)`](crate::operation::get_traffic_policy::builders::GetTrafficPolicyFluentBuilder::version) / [`set_version(Option<i32>)`](crate::operation::get_traffic_policy::builders::GetTrafficPolicyFluentBuilder::set_version):<br>required: **true**<br><p>The version number of the traffic policy that you want to get information about.</p><br>
