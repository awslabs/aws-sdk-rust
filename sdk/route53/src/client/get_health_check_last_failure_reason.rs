...
impl super::Client {
    ...
    ///   - [`health_check_observations(Vec::<HealthCheckObservation>)`](crate::operation::get_health_check_last_failure_reason::GetHealthCheckLastFailureReasonOutput::health_check_observations): <p>A list that contains one <code>Observation</code> element for each Amazon Route 53 health checker that is reporting a last failure reason.</p>
