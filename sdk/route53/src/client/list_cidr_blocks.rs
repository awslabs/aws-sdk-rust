...
impl super::Client {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::set_collection_id): <p>The UUID of the CIDR collection.</p>
    ///   - [`location_name(impl ::std::convert::Into<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::location_name) / [`set_location_name(Option<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::set_location_name): <p>The name of the CIDR collection location.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cidr_blocks::builders::ListCidrBlocksFluentBuilder::set_next_token): <p>An opaque pagination token to indicate where the service is to begin enumerating results.</p>
