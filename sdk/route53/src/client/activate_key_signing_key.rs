...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::activate_key_signing_key::builders::ActivateKeySigningKeyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::activate_key_signing_key::builders::ActivateKeySigningKeyFluentBuilder::set_name):<br>required: **true**<br><p>A string used to identify a key-signing key (KSK). <code>Name</code> can include numbers, letters, and underscores (_). <code>Name</code> must be unique for each key-signing key in the same hosted zone.</p><br>
