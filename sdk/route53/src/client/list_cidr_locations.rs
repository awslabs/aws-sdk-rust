...
impl super::Client {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder::set_collection_id): <p>The CIDR collection ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder::set_next_token): <p>An opaque pagination token to indicate where the service is to begin enumerating results.</p>  <p>If no value is provided, the listing of results starts from the beginning.</p>
    ...
    pub fn list_cidr_locations(
        &self,
    ) -> crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder {
        crate::operation::list_cidr_locations::builders::ListCidrLocationsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
