...
impl super::Client {
    ...
    ///   - [`hosted_zone_id(impl ::std::convert::Into<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::hosted_zone_id) / [`set_hosted_zone_id(Option<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::set_hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::set_name): <p>A string used to identify a key-signing key (KSK).</p>
