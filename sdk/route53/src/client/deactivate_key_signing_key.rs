...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyFluentBuilder::set_name):<br>required: **true**<br><p>A string used to identify a key-signing key (KSK).</p><br>
