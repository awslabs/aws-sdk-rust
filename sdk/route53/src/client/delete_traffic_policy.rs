...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_traffic_policy::builders::DeleteTrafficPolicyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_traffic_policy::builders::DeleteTrafficPolicyFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the traffic policy that you want to delete.</p><br>
    ///   - [`version(i32)`](crate::operation::delete_traffic_policy::builders::DeleteTrafficPolicyFluentBuilder::version) / [`set_version(Option<i32>)`](crate::operation::delete_traffic_policy::builders::DeleteTrafficPolicyFluentBuilder::set_version):<br>required: **true**<br><p>The version number of the traffic policy that you want to delete.</p><br>
