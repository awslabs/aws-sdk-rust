...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_hosted_zone::builders::DeleteHostedZoneFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_hosted_zone::builders::DeleteHostedZoneFluentBuilder::set_id): <p>The ID of the hosted zone you want to delete.</p>
