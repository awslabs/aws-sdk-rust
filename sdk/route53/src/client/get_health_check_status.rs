...
impl super::Client {
    ...
    ///   - [`health_check_id(impl ::std::convert::Into<String>)`](crate::operation::get_health_check_status::builders::GetHealthCheckStatusFluentBuilder::health_check_id) / [`set_health_check_id(Option<String>)`](crate::operation::get_health_check_status::builders::GetHealthCheckStatusFluentBuilder::set_health_check_id): <p>The ID for the health check that you want the current status for. When you created the health check, <code>CreateHealthCheck</code> returned the ID in the response, in the <code>HealthCheckId</code> element.</p> <note>   <p>If you want to check the status of a calculated health check, you must use the Amazon Route 53 console or the CloudWatch console. You can't use <code>GetHealthCheckStatus</code> to get the status of a calculated health check.</p>  </note>
