...
impl super::Client {
    ...
    ///   - [`resource_ids(impl Into<String>)`](crate::operation::list_tags_for_resources::builders::ListTagsForResourcesFluentBuilder::resource_ids) / [`set_resource_ids(Option<Vec<String>>)`](crate::operation::list_tags_for_resources::builders::ListTagsForResourcesFluentBuilder::set_resource_ids): <p>A complex type that contains the ResourceId element for each resource for which you want to get a list of tags.</p>
