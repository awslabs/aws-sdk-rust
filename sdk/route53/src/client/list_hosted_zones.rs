...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::set_marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more hosted zones. To get more hosted zones, submit another <code>ListHostedZones</code> request. </p>  <p>For the value of <code>marker</code>, specify the value of <code>NextMarker</code> from the previous response, which is the ID of the first hosted zone that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more hosted zones to get.</p>
    ///   - [`max_items(i32)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::set_max_items): <p>(Optional) The maximum number of hosted zones that you want Amazon Route 53 to return. If you have more than <code>maxitems</code> hosted zones, the value of <code>IsTruncated</code> in the response is <code>true</code>, and the value of <code>NextMarker</code> is the hosted zone ID of the first hosted zone that Route 53 will return if you submit another request.</p>
    ///   - [`delegation_set_id(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::delegation_set_id) / [`set_delegation_set_id(Option<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::set_delegation_set_id): <p>If you're using reusable delegation sets and you want to list all of the hosted zones that are associated with a reusable delegation set, specify the ID of that reusable delegation set. </p>
    /// - On success, responds with [`ListHostedZonesOutput`](crate::operation::list_hosted_zones::ListHostedZonesOutput) with field(s):
    ///   - [`hosted_zones(Option<Vec<HostedZone>>)`](crate::operation::list_hosted_zones::ListHostedZonesOutput::hosted_zones): <p>A complex type that contains general information about the hosted zone.</p>
    ///   - [`marker(Option<String>)`](crate::operation::list_hosted_zones::ListHostedZonesOutput::marker): <p>For the second and subsequent calls to <code>ListHostedZones</code>, <code>Marker</code> is the value that you specified for the <code>marker</code> parameter in the request that produced the current response.</p>
