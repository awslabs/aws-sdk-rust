...
impl super::Client {
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_hosted_zones::builders::ListHostedZonesFluentBuilder::set_marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more hosted zones. To get more hosted zones, submit another <code>ListHostedZones</code> request. </p>  <p>For the value of <code>marker</code>, specify the value of <code>NextMarker</code> from the previous response, which is the ID of the first hosted zone that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more hosted zones to get.</p>
