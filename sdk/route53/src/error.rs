...
#[deprecated]#[non_exhaustive]#[derive(std::clone::Clone, std::cmp::PartialEq, )]
...
pub struct InvalidChangeBatch  {
    /// <p></p>
    #[doc(hidden)]pub messages: std::option::Option<std::vec::Vec<std::string::String>>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
}
...
pub enum DeleteHealthCheckErrorKind {
    /// <p>This error code is not in use.</p>
    #[deprecated]HealthCheckInUse(crate::error::HealthCheckInUse),
    /// <p>The input is not valid.</p>
    InvalidInput(crate::error::InvalidInput),
    /// <p>No health check exists with the specified ID.</p>
    NoSuchHealthCheck(crate::error::NoSuchHealthCheck),
