...
pub fn serialize_structure_associate_vpc_with_hosted_zone_input(
    ...
    if let Some(var_2) = &input.vpc {
        let inner_writer = scope
            .start_el("VPC")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_vpc(&var_2, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_change_resource_record_sets_input(
    ...
    if let Some(var_3) = &input.change_batch {
        let inner_writer = scope
            ...
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_change_batch(&var_3, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_change_tags_for_resource_input(
        ...
        for list_item_5 in var_4 {
            {
                let inner_writer = inner_writer
                    .start_el("Tag")
                    .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
                crate::xml_ser::serialize_structure_tag(&list_item_5, inner_writer)
            }
        }
    }
    if let Some(var_6) = &input.remove_tag_keys {
        let mut inner_writer = scope
            .start_el("RemoveTagKeys")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
...
pub fn serialize_structure_create_health_check_input(
    ...
    if let Some(var_9) = &input.health_check_config {
        let inner_writer = scope
            ...
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_health_check_config(&var_9, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_create_hosted_zone_input(
    ...
    if let Some(var_12) = &input.hosted_zone_config {
        let inner_writer = scope
            ...
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_hosted_zone_config(&var_12, inner_writer)
    }
    ...
    if let Some(var_14) = &input.vpc {
        let inner_writer = scope
            .start_el("VPC")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_vpc(&var_14, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_create_key_signing_key_input(
    ...
    if let Some(var_17) = &input.key_management_service_arn {
        let mut inner_writer = scope
            .start_el("KeyManagementServiceArn")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
...
pub fn serialize_structure_create_query_logging_config_input(
    ...
    if let Some(var_20) = &input.cloud_watch_logs_log_group_arn {
        let mut inner_writer = scope
            .start_el("CloudWatchLogsLogGroupArn")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
...
pub fn serialize_structure_create_reusable_delegation_set_input(
...
pub fn serialize_structure_create_traffic_policy_input(
...
pub fn serialize_structure_create_traffic_policy_instance_input(
...
pub fn serialize_structure_create_traffic_policy_version_input(
...
pub fn serialize_structure_create_vpc_association_authorization_input(
    ...
    if let Some(var_34) = &input.vpc {
        let inner_writer = scope
            .start_el("VPC")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_vpc(&var_34, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_delete_vpc_association_authorization_input(
    ...
    if let Some(var_35) = &input.vpc {
        let inner_writer = scope
            .start_el("VPC")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_vpc(&var_35, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_disassociate_vpc_from_hosted_zone_input(
    ...
    if let Some(var_37) = &input.vpc {
        let inner_writer = scope
            .start_el("VPC")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_vpc(&var_37, inner_writer)
    }
    scope.finish();
}

pub fn serialize_structure_list_tags_for_resources_input(
...
pub fn serialize_structure_update_health_check_input(
    ...
    if let Some(var_40) = &input.alarm_identifier {
        let inner_writer = scope
            ...
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_alarm_identifier(&var_40, inner_writer)
    }
    if let Some(var_41) = &input.child_health_checks {
        let mut inner_writer = scope
            .start_el("ChildHealthChecks")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
        for list_item_42 in var_41 {
            {
                let mut inner_writer = inner_writer
                    .start_el("ChildHealthCheck")
                    .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
                    .finish();
    ...
    if let Some(var_46) = &input.fully_qualified_domain_name {
        let mut inner_writer = scope
            .start_el("FullyQualifiedDomainName")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
    ...
    if let Some(var_50) = &input.insufficient_data_health_status {
        let mut inner_writer = scope
            .start_el("InsufficientDataHealthStatus")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
    ...
    if let Some(var_55) = &input.reset_elements {
        let mut inner_writer = scope
            .start_el("ResetElements")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
            .finish();
        for list_item_56 in var_55 {
            {
                let mut inner_writer = inner_writer
                    .start_el("ResettableElementName")
                    .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None)
                    .finish();
...
pub fn serialize_structure_update_hosted_zone_comment_input(
...
pub fn serialize_structure_update_traffic_policy_comment_input(
...
pub fn serialize_structure_update_traffic_policy_instance_input(
...
pub fn serialize_structure_vpc(input: &crate::model::Vpc, writer: smithy_xml::encode::ElWriter) {
    #[allow(unused_mut)]
    let mut scope = writer.finish();
...
pub fn serialize_structure_change_batch(
        ...
        for list_item_68 in var_67 {
            {
                let inner_writer = inner_writer
                    .start_el("Change")
                    .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
                crate::xml_ser::serialize_structure_change(&list_item_68, inner_writer)
            }
        }
    }
    scope.finish();
...
pub fn serialize_structure_health_check_config(
    ...
    if let Some(var_88) = &input.alarm_identifier {
        let inner_writer = scope
            .start_el("AlarmIdentifier")
            .write_ns("https://route53.amazonaws.com/doc/2013-04-01/", None);
        crate::xml_ser::serialize_structure_alarm_identifier(&var_88, inner_writer)
    }
...
pub fn serialize_structure_hosted_zone_config(
...
pub fn serialize_structure_alarm_identifier(
...
pub fn serialize_structure_resource_record_set(
...
pub fn serialize_structure_resource_record(
...
pub fn serialize_structure_alias_target(
