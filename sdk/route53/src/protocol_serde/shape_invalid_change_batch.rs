...
#[allow(unused_mut)]
pub fn de_invalid_change_batch_xml_err(inp: &[u8], mut builder: crate::error::invalid_change_batch::Builder) -> Result<crate::error::invalid_change_batch::Builder, aws_smithy_xml::decode::XmlDecodeError> {
