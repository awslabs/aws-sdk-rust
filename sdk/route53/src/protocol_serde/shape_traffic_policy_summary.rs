...
pub fn de_traffic_policy_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficPolicySummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
