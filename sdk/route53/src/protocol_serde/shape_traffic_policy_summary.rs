...
pub fn de_traffic_policy_summary(
...
) -> ::std::result::Result<crate::types::TrafficPolicySummary, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::traffic_policy_summary_correct_errors(builder)
        .build()
