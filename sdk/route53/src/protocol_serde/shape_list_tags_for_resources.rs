...
pub fn de_list_tags_for_resources(
...
) -> Result<crate::operation::list_tags_for_resources::builders::ListTagsForResourcesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("ListTagsForResourcesResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListTagsForResourcesResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
