...
pub fn de_get_change_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_change::GetChangeOutput, crate::operation::get_change::GetChangeError> {
    #[allow(unused_mut)]
...
pub fn de_get_change(
...
) -> std::result::Result<crate::operation::get_change::builders::GetChangeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("GetChangeResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetChangeResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
