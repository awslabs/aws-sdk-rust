...
pub fn de_list_cidr_locations_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_cidr_locations::ListCidrLocationsOutput, crate::operation::list_cidr_locations::ListCidrLocationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_cidr_locations_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_cidr_locations::ListCidrLocationsOutput, crate::operation::list_cidr_locations::ListCidrLocationsError> {
    Ok({
        #[allow(unused_mut)]
