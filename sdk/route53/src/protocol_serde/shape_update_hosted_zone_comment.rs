...
pub fn de_update_hosted_zone_comment_http_error(
...
> {
    ...
    .map_err(
        crate::operation::update_hosted_zone_comment::UpdateHostedZoneCommentError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_hosted_zone_comment_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
