...
pub fn de_get_account_limit_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_account_limit::GetAccountLimitOutput, crate::operation::get_account_limit::GetAccountLimitError> {
    #[allow(unused_mut)]
...
pub fn de_get_account_limit_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_account_limit::de_get_account_limit(_response_body, output)
            .map_err(crate::operation::get_account_limit::GetAccountLimitError::unhandled)?;
...
pub fn de_get_account_limit(
    ...
    if !start_el.matches("GetAccountLimitResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetAccountLimitResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Limit") /* Limit com.amazonaws.route53.synthetic#GetAccountLimitOutput$Limit */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_account_limit::de_account_limit(&mut tag, depth + 1)
                        ?
                    )
                ;
