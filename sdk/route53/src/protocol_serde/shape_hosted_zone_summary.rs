...
pub fn de_hosted_zone_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HostedZoneSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
