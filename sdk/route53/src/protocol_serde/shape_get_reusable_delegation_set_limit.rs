...
pub fn de_get_reusable_delegation_set_limit_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReusableDelegationSetLimitOutput, crate::error::GetReusableDelegationSetLimitError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetReusableDelegationSetLimitError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::GetReusableDelegationSetLimitError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reusable_delegation_set_limit_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReusableDelegationSetLimitOutput, crate::error::GetReusableDelegationSetLimitError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_get_reusable_delegation_set_limit(inp: &[u8], mut builder: crate::output::get_reusable_delegation_set_limit_output::Builder) -> Result<crate::output::get_reusable_delegation_set_limit_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
