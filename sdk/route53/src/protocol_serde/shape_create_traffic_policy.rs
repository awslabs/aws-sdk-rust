...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_traffic_policy::CreateTrafficPolicyError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_traffic_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_traffic_policy::de_create_traffic_policy(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_traffic_policy::CreateTrafficPolicyError::unhandled)?;
        output = output.set_location(
            crate::protocol_serde::shape_create_traffic_policy_output::de_location_header(
                _response_headers,
            )
            .map_err(|_| {
                crate::operation::create_traffic_policy::CreateTrafficPolicyError::unhandled(
