...
) -> std::result::Result<crate::operation::create_traffic_policy::builders::CreateTrafficPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !start_el.matches("CreateTrafficPolicyResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected CreateTrafficPolicyResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
