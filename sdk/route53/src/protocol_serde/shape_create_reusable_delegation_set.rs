...
pub fn ser_create_reusable_delegation_set_op_input(input: &crate::input::CreateReusableDelegationSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_create_reusable_delegation_set_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateReusableDelegationSetOutput, crate::error::CreateReusableDelegationSetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateReusableDelegationSetError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::error::CreateReusableDelegationSetError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "DelegationSetAlreadyCreated" => crate::error::CreateReusableDelegationSetError::DelegationSetAlreadyCreated({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::error::delegation_set_already_created::Builder::default();
                    let _ = response;
        ...
        "DelegationSetAlreadyReusable" => crate::error::CreateReusableDelegationSetError::DelegationSetAlreadyReusable({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::error::delegation_set_already_reusable::Builder::default();
                    let _ = response;
        ...
        "DelegationSetNotAvailable" => crate::error::CreateReusableDelegationSetError::DelegationSetNotAvailable({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "HostedZoneNotFound" => crate::error::CreateReusableDelegationSetError::HostedZoneNotFound({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_argument::de_invalid_argument_xml_err(response.body().as_ref(), output).map_err(crate::error::CreateReusableDelegationSetError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::CreateReusableDelegationSetError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_limits_exceeded::de_limits_exceeded_xml_err(response.body().as_ref(), output).map_err(crate::error::CreateReusableDelegationSetError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_reusable_delegation_set_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateReusableDelegationSetOutput, crate::error::CreateReusableDelegationSetError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_create_reusable_delegation_set(inp: &[u8], mut builder: crate::output::create_reusable_delegation_set_output::Builder) -> Result<crate::output::create_reusable_delegation_set_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
