...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_hosted_zone::CreateHostedZoneError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "ConflictingDomainExists" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::ConflictingDomainExists({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DelegationSetNotAvailable" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::DelegationSetNotAvailable(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "DelegationSetNotReusable" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::DelegationSetNotReusable({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "HostedZoneAlreadyExists" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::HostedZoneAlreadyExists({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDomainName" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::InvalidDomainName({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidInput" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::InvalidInput({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::create_hosted_zone::CreateHostedZoneError::unhandled,
                    )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InvalidVPCId" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::InvalidVpcId({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidVpcIdBuilder::default();
                    output =
                        crate::protocol_serde::shape_invalid_vpc_id::de_invalid_vpc_id_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(
        ...
        "NoSuchDelegationSet" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::NoSuchDelegationSet({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "TooManyHostedZones" => {
            crate::operation::create_hosted_zone::CreateHostedZoneError::TooManyHostedZones({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_hosted_zone_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
