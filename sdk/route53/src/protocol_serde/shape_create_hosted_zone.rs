...
pub fn de_create_hosted_zone_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_hosted_zone::CreateHostedZoneOutput, crate::operation::create_hosted_zone::CreateHostedZoneError> {
    #[allow(unused_mut)]
...
pub fn de_create_hosted_zone_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_hosted_zone::de_create_hosted_zone(_response_body, output)
            .map_err(crate::operation::create_hosted_zone::CreateHostedZoneError::unhandled)?;
        output = output.set_location(
            crate::protocol_serde::shape_create_hosted_zone_output::de_location_header(_response_headers).map_err(|_| {
                crate::operation::create_hosted_zone::CreateHostedZoneError::unhandled("Failed to parse Location from header `Location")
            })?,
        );
...
pub fn de_create_hosted_zone(
...
) -> Result<crate::operation::create_hosted_zone::builders::CreateHostedZoneOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("CreateHostedZoneResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected CreateHostedZoneResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
