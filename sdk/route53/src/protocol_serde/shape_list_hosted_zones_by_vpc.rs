...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_hosted_zones_by_vpc::de_list_hosted_zones_by_vpc(_response_body, output)
            .map_err(crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_hosted_zones_by_vpc_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError::unhandled)?
    })
}
...
pub fn de_list_hosted_zones_by_vpc(
...
) -> Result<crate::operation::list_hosted_zones_by_vpc::builders::ListHostedZonesByVpcOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("ListHostedZonesByVPCResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListHostedZonesByVPCResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
