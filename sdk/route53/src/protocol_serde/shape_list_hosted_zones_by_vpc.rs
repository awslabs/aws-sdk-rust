...
pub fn de_list_hosted_zones_by_vpc_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVpcOutput, crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_hosted_zones_by_vpc_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVpcOutput, crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_hosted_zones_by_vpc::builders::ListHostedZonesByVpcOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_hosted_zones_by_vpc::de_list_hosted_zones_by_vpc(response.body().as_ref(), output).map_err(crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError::unhandled)?;
