...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::change_resource_record_sets::ChangeResourceRecordSetsError::unhandled(
                generic,
            ))
        }
    };
...
) -> Result<crate::operation::change_resource_record_sets::builders::ChangeResourceRecordSetsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !start_el.matches("ChangeResourceRecordSetsResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ChangeResourceRecordSetsResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
