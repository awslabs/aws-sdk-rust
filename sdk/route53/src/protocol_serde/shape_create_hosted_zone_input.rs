...
pub fn ser_create_hosted_zone_input_input_input(input: &crate::operation::create_hosted_zone::CreateHostedZoneInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
