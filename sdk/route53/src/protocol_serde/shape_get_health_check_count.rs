...
> {
    Ok({
        ...
        crate::serde_util::get_health_check_count_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_health_check_count::GetHealthCheckCountError::unhandled)?
    })
}
...
pub fn de_get_health_check_count(
...
) -> Result<crate::operation::get_health_check_count::builders::GetHealthCheckCountOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("GetHealthCheckCountResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetHealthCheckCountResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
