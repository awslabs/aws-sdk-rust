...
pub fn de_geo_location_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GeoLocationDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
