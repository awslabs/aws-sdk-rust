...
pub fn de_create_traffic_policy_instance_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceOutput, crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceError> {
    #[allow(unused_mut)]
...
pub fn de_create_traffic_policy_instance_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceOutput, crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceError> {
    Ok({
        ...
        crate::serde_util::create_traffic_policy_instance_output_output_correct_errors(output).build().map_err(crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceError::unhandled)?
    })
}

pub fn ser_create_traffic_policy_instance_op_input(input: &crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
