...
pub fn de_traffic_policy_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficPolicyInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
