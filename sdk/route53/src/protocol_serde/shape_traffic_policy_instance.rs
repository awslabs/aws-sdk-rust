...
pub fn de_traffic_policy_instance(
...
) -> ::std::result::Result<crate::types::TrafficPolicyInstance, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::traffic_policy_instance_correct_errors(builder)
        .build()
