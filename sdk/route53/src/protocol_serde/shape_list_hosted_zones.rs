...
pub fn de_list_hosted_zones_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHostedZonesOutput, crate::error::ListHostedZonesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListHostedZonesError::unhandled)?;
    ...
    Err(match error_code {
        "DelegationSetNotReusable" => crate::error::ListHostedZonesError::DelegationSetNotReusable({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListHostedZonesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_hosted_zones_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHostedZonesOutput, crate::error::ListHostedZonesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_hosted_zones_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_hosted_zones::de_list_hosted_zones(response.body().as_ref(), output).map_err(crate::error::ListHostedZonesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_hosted_zones(inp: &[u8], mut builder: crate::output::list_hosted_zones_output::Builder) -> Result<crate::output::list_hosted_zones_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
