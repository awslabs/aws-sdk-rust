...
pub fn de_list_hosted_zones_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_hosted_zones::ListHostedZonesOutput, crate::operation::list_hosted_zones::ListHostedZonesError> {
    #[allow(unused_mut)]
...
pub fn de_list_hosted_zones_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_list_hosted_zones::de_list_hosted_zones(_response_body, output)
            .map_err(crate::operation::list_hosted_zones::ListHostedZonesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_hosted_zones_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_hosted_zones::ListHostedZonesError::unhandled)?
    })
}
...
pub fn de_list_hosted_zones(
    ...
    if !start_el.matches("ListHostedZonesResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListHostedZonesResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
