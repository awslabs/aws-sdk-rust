...
pub fn de_get_health_check_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetHealthCheckOutput, crate::error::GetHealthCheckError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetHealthCheckError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::GetHealthCheckError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_health_check_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetHealthCheckOutput, crate::error::GetHealthCheckError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_health_check_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_health_check::de_get_health_check(response.body().as_ref(), output).map_err(crate::error::GetHealthCheckError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_health_check(inp: &[u8], mut builder: crate::output::get_health_check_output::Builder) -> Result<crate::output::get_health_check_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
