...
pub fn de_get_health_check_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_health_check::GetHealthCheckOutput, crate::operation::get_health_check::GetHealthCheckError> {
    #[allow(unused_mut)]
...
pub fn de_get_health_check(
...
) -> std::result::Result<crate::operation::get_health_check::builders::GetHealthCheckOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("GetHealthCheckResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetHealthCheckResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
