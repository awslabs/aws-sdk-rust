...
pub fn de_geo_proximity_location(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::GeoProximityLocation, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_geo_proximity_location(input: &crate::types::GeoProximityLocation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
