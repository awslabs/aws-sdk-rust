...
pub fn de_cloud_watch_alarm_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudWatchAlarmConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
