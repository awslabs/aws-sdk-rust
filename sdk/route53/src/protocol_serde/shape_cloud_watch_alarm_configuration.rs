...
pub fn de_cloud_watch_alarm_configuration(
...
) -> Result<crate::types::CloudWatchAlarmConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::cloud_watch_alarm_configuration_correct_errors(builder)
        .build()
