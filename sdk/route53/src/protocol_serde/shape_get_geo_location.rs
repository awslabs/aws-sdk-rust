...
pub fn de_get_geo_location_http_error(
...
pub fn de_get_geo_location(
...
) -> std::result::Result<crate::operation::get_geo_location::builders::GetGeoLocationOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("GetGeoLocationResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetGeoLocationResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
