...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError::unhandled(
                generic,
            ))
        }
    };
...
pub fn de_list_query_logging_configs(
...
) -> Result<crate::operation::list_query_logging_configs::builders::ListQueryLoggingConfigsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("ListQueryLoggingConfigsResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListQueryLoggingConfigsResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
