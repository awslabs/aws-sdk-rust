...
pub fn de_get_traffic_policy_instance_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTrafficPolicyInstanceOutput, crate::error::GetTrafficPolicyInstanceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetTrafficPolicyInstanceError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::GetTrafficPolicyInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_traffic_policy_instance_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTrafficPolicyInstanceOutput, crate::error::GetTrafficPolicyInstanceError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_get_traffic_policy_instance(inp: &[u8], mut builder: crate::output::get_traffic_policy_instance_output::Builder) -> Result<crate::output::get_traffic_policy_instance_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
