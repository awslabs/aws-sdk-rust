...
pub fn ser_change_tags_for_resource_input_input_input(input: &crate::operation::change_tags_for_resource::ChangeTagsForResourceInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
