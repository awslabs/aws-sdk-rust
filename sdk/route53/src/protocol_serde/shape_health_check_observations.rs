...
pub fn de_health_check_observations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::HealthCheckObservation>, aws_smithy_xml::decode::XmlDecodeError> {
