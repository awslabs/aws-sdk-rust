...
pub fn de_delete_traffic_policy_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_traffic_policy::DeleteTrafficPolicyOutput, crate::operation::delete_traffic_policy::DeleteTrafficPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_traffic_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_traffic_policy::DeleteTrafficPolicyOutput, crate::operation::delete_traffic_policy::DeleteTrafficPolicyError> {
    Ok({
        #[allow(unused_mut)]
