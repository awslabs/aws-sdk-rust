...
pub fn de_list_reusable_delegation_sets_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsOutput, crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled(generic))
                            };
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_reusable_delegation_sets_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsOutput, crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_reusable_delegation_sets::builders::ListReusableDelegationSetsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_reusable_delegation_sets::de_list_reusable_delegation_sets(response.body().as_ref(), output).map_err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled)?;
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("IsTruncated") /* IsTruncated com.amazonaws.route53.synthetic#ListReusableDelegationSetsOutput$IsTruncated */ =>  {
                ...
                ;
                builder = builder.set_is_truncated(var_1);
            }
            ,
            ...
            s if s.matches("NextMarker") /* NextMarker com.amazonaws.route53.synthetic#ListReusableDelegationSetsOutput$NextMarker */ =>  {
                ...
                ;
                builder = builder.set_next_marker(var_4);
            }
            ,
            s if s.matches("DelegationSets") /* DelegationSets com.amazonaws.route53.synthetic#ListReusableDelegationSetsOutput$DelegationSets */ =>  {
                ...
                ;
                builder = builder.set_delegation_sets(var_5);
            }
            ,
            _ => {}
        }
