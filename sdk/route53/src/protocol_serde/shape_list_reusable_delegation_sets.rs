...
pub fn de_list_reusable_delegation_sets_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsOutput, crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_reusable_delegation_sets_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsOutput, crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError> {
    Ok({
        #[allow(unused_mut)]
