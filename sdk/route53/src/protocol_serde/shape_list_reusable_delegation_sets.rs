...
pub fn de_list_reusable_delegation_sets_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListReusableDelegationSetsOutput, crate::error::ListReusableDelegationSetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListReusableDelegationSetsError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::error::ListReusableDelegationSetsError::unhandled(generic))
                            };
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListReusableDelegationSetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_reusable_delegation_sets_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListReusableDelegationSetsOutput, crate::error::ListReusableDelegationSetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_reusable_delegation_sets_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_reusable_delegation_sets::de_list_reusable_delegation_sets(response.body().as_ref(), output).map_err(crate::error::ListReusableDelegationSetsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_reusable_delegation_sets(inp: &[u8], mut builder: crate::output::list_reusable_delegation_sets_output::Builder) -> Result<crate::output::list_reusable_delegation_sets_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
