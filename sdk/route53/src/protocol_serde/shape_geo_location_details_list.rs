...
pub fn de_geo_location_details_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::GeoLocationDetails>, aws_smithy_xml::decode::XmlDecodeError> {
