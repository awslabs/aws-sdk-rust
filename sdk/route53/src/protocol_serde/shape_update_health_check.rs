...
pub fn de_update_health_check_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_health_check::UpdateHealthCheckOutput, crate::operation::update_health_check::UpdateHealthCheckError>
{
    #[allow(unused_mut)]
...
pub fn de_update_health_check(
    ...
    if !start_el.matches("UpdateHealthCheckResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected UpdateHealthCheckResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
