...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_traffic_policy_comment_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !start_el.matches("UpdateTrafficPolicyCommentResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected UpdateTrafficPolicyCommentResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
