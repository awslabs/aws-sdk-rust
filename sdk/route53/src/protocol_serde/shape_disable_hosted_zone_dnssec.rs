...
pub fn de_disable_hosted_zone_dnssec_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError::unhandled(generic))
                            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_hosted_zone_dnssec_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_disable_hosted_zone_dnssec(inp: &[u8], mut builder: crate::operation::disable_hosted_zone_dnssec::builders::DisableHostedZoneDnssecOutputBuilder) -> Result<crate::operation::disable_hosted_zone_dnssec::builders::DisableHostedZoneDnssecOutputBuilder, aws_smithy_xml::decode::XmlDecodeError> {
