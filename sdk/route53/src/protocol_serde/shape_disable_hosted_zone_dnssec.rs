...
pub fn de_disable_hosted_zone_dnssec_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_hosted_zone_dnssec_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    Ok({
        #[allow(unused_mut)]
