...
pub fn de_disable_hosted_zone_dnssec_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_hosted_zone_dnssec_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput, crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError> {
    Ok({
        #[allow(unused_mut)]
