...
pub fn de_get_traffic_policy_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_traffic_policy_output_correct_errors(output).build()
    })
}
...
) -> Result<crate::operation::get_traffic_policy::builders::GetTrafficPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
