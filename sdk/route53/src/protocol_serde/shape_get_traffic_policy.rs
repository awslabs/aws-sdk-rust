...
pub fn de_get_traffic_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTrafficPolicyOutput, crate::error::GetTrafficPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetTrafficPolicyError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::GetTrafficPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_traffic_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTrafficPolicyOutput, crate::error::GetTrafficPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_traffic_policy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_traffic_policy::de_get_traffic_policy(response.body().as_ref(), output).map_err(crate::error::GetTrafficPolicyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_traffic_policy(inp: &[u8], mut builder: crate::output::get_traffic_policy_output::Builder) -> Result<crate::output::get_traffic_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
