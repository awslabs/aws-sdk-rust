...
pub fn de_list_traffic_policies_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTrafficPoliciesOutput, crate::error::ListTrafficPoliciesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListTrafficPoliciesError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListTrafficPoliciesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policies_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTrafficPoliciesOutput, crate::error::ListTrafficPoliciesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_traffic_policies_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_traffic_policies::de_list_traffic_policies(response.body().as_ref(), output).map_err(crate::error::ListTrafficPoliciesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_traffic_policies(inp: &[u8], mut builder: crate::output::list_traffic_policies_output::Builder) -> Result<crate::output::list_traffic_policies_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
