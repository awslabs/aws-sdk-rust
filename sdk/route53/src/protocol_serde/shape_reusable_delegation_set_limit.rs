...
pub fn de_reusable_delegation_set_limit(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReusableDelegationSetLimit, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
