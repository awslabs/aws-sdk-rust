...
pub fn ser_create_key_signing_key_input_input_input(input: &crate::operation::create_key_signing_key::CreateKeySigningKeyInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
