...
pub fn ser_create_key_signing_key_input_input(input: &crate::input::CreateKeySigningKeyInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
