...
pub fn ser_change_cidr_collection_input_input_input(input: &crate::operation::change_cidr_collection::ChangeCidrCollectionInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
