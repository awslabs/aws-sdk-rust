...
pub fn de_health_check_observation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HealthCheckObservation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
