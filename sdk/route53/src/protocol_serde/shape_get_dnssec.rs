...
pub fn de_get_dnssec_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_dnssec::GetDnssecOutput, crate::operation::get_dnssec::GetDNSSECError> {
    #[allow(unused_mut)]
...
pub fn de_get_dnssec_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_dnssec_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_dnssec::GetDNSSECError::unhandled)?
    })
}
...
) -> std::result::Result<crate::operation::get_dnssec::builders::GetDnssecOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
