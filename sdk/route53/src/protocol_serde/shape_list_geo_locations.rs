...
pub fn de_list_geo_locations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListGeoLocationsOutput, crate::error::ListGeoLocationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListGeoLocationsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListGeoLocationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_geo_locations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListGeoLocationsOutput, crate::error::ListGeoLocationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_geo_locations_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_geo_locations::de_list_geo_locations(response.body().as_ref(), output).map_err(crate::error::ListGeoLocationsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_geo_locations(inp: &[u8], mut builder: crate::output::list_geo_locations_output::Builder) -> Result<crate::output::list_geo_locations_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
