...
pub fn de_list_geo_locations_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_geo_locations_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::list_geo_locations_output_output_correct_errors(output).build().map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?
    })
}
