...
pub fn de_list_geo_locations_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_geo_locations_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?
    })
}
...
pub fn de_list_geo_locations(
...
) -> Result<crate::operation::list_geo_locations::builders::ListGeoLocationsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("ListGeoLocationsResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListGeoLocationsResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
