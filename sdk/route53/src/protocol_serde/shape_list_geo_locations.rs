...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_geo_locations_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError> {
    Ok({
        #[allow(unused_mut)]
