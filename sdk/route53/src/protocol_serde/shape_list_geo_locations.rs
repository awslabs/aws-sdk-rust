...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_geo_locations::ListGeoLocationsError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "InvalidInput" => {
            crate::operation::list_geo_locations::ListGeoLocationsError::InvalidInput({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    .map_err(
                        crate::operation::list_geo_locations::ListGeoLocationsError::unhandled,
                    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_geo_locations_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_geo_locations::de_list_geo_locations(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?;
