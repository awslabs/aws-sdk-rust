...
pub fn ser_delete_vpc_association_authorization_op_input(input: &crate::input::DeleteVpcAssociationAuthorizationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_delete_vpc_association_authorization_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteVpcAssociationAuthorizationOutput, crate::error::DeleteVPCAssociationAuthorizationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteVPCAssociationAuthorizationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_vpc_association_authorization_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteVpcAssociationAuthorizationOutput, crate::error::DeleteVPCAssociationAuthorizationError> {
    Ok({
        #[allow(unused_mut)]
