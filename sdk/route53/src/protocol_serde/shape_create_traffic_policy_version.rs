...
pub fn de_create_traffic_policy_version_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionOutput, crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_concurrent_modification::de_concurrent_modification_xml_err(_response_body, output).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_traffic_policy_document::de_invalid_traffic_policy_document_xml_err(_response_body, output).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_traffic_policy::de_no_such_traffic_policy_xml_err(_response_body, output).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_traffic_policy_version_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionOutput, crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_traffic_policy_version::builders::CreateTrafficPolicyVersionOutputBuilder::default();
        output = crate::protocol_serde::shape_create_traffic_policy_version::de_create_traffic_policy_version(_response_body, output).map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?;
        output = output.set_location(
            crate::protocol_serde::shape_create_traffic_policy_version_output::de_location_header(_response_headers)
        ...
        crate::serde_util::create_traffic_policy_version_output_output_correct_errors(output).build().map_err(crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionError::unhandled)?
    })
}

pub fn ser_create_traffic_policy_version_op_input(input: &crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
