...
pub fn de_enable_hosted_zone_dnssec(
...
) -> Result<crate::operation::enable_hosted_zone_dnssec::builders::EnableHostedZoneDnssecOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("EnableHostedZoneDNSSECResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected EnableHostedZoneDNSSECResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
