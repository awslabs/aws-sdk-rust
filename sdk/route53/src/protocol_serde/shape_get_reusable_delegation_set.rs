...
pub fn de_get_reusable_delegation_set_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput, crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reusable_delegation_set_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput, crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::get_reusable_delegation_set_output_output_correct_errors(output).build()
    })
}
