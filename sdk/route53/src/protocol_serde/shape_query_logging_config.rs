...
pub fn de_query_logging_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::QueryLoggingConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
