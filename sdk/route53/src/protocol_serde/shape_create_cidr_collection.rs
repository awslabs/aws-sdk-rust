...
> {
    ...
    Err(match error_code {
        "CidrCollectionAlreadyExistsException" => {
            crate::operation::create_cidr_collection::CreateCidrCollectionError::CidrCollectionAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_cidr_collection::de_create_cidr_collection(_response_body, output)
            .map_err(crate::operation::create_cidr_collection::CreateCidrCollectionError::unhandled)?;
        output = output.set_location(
            crate::protocol_serde::shape_create_cidr_collection_output::de_location_header(_response_headers).map_err(|_| {
                crate::operation::create_cidr_collection::CreateCidrCollectionError::unhandled("Failed to parse Location from header `Location")
            })?,
        );
...
pub fn de_create_cidr_collection(
...
) -> Result<crate::operation::create_cidr_collection::builders::CreateCidrCollectionOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("CreateCidrCollectionResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected CreateCidrCollectionResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
