...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_cidr_collection::CreateCidrCollectionError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cidr_collection_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn de_create_cidr_collection(
    inp: &[u8],
    mut builder: crate::operation::create_cidr_collection::builders::CreateCidrCollectionOutputBuilder,
) -> Result<
