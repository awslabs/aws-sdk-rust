...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_vpc_association_authorization::de_create_vpc_association_authorization(_response_body, output)
            .map_err(crate::operation::create_vpc_association_authorization::CreateVPCAssociationAuthorizationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::create_vpc_association_authorization_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_vpc_association_authorization::CreateVPCAssociationAuthorizationError::unhandled)?
    })
}
...
pub fn ser_create_vpc_association_authorization_op_input(
    ...
    let mut out = String::new();
    {
        ...
        crate::protocol_serde::shape_create_vpc_association_authorization_input::ser_create_vpc_association_authorization_input_input_input(
            input, root,
        )?
    }
...
> {
    ...
    if !start_el.matches("CreateVPCAssociationAuthorizationResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected CreateVPCAssociationAuthorizationResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
