...
pub fn de_query_logging_configs(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::QueryLoggingConfig>, aws_smithy_xml::decode::XmlDecodeError> {
