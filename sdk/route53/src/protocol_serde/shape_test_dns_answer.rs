...
pub fn de_test_dns_answer_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::TestDnsAnswerOutput, crate::error::TestDNSAnswerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::TestDNSAnswerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::TestDNSAnswerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_test_dns_answer_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::TestDnsAnswerOutput, crate::error::TestDNSAnswerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::test_dns_answer_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_test_dns_answer::de_test_dns_answer(response.body().as_ref(), output).map_err(crate::error::TestDNSAnswerError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_test_dns_answer(inp: &[u8], mut builder: crate::output::test_dns_answer_output::Builder) -> Result<crate::output::test_dns_answer_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
