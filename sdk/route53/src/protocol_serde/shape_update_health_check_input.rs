...
pub fn ser_update_health_check_input_input_input(input: &crate::operation::update_health_check::UpdateHealthCheckInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
