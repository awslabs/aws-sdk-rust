...
pub fn de_alias_target(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AliasTarget, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_alias_target(input: &crate::model::AliasTarget, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
