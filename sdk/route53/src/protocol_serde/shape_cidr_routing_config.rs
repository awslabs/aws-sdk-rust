...
pub fn de_cidr_routing_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CidrRoutingConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_cidr_routing_config(input: &crate::model::CidrRoutingConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
