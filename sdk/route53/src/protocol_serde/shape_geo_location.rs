...
pub fn de_geo_location(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GeoLocation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_geo_location(input: &crate::model::GeoLocation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
