...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_query_logging_config_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigOutput, crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigError> {
    Ok({
        #[allow(unused_mut)]
