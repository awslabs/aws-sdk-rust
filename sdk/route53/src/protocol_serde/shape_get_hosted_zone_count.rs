...
pub fn de_get_hosted_zone_count_http_error(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_hosted_zone_count::de_get_hosted_zone_count(_response_body, output)
            .map_err(crate::operation::get_hosted_zone_count::GetHostedZoneCountError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_hosted_zone_count_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_hosted_zone_count::GetHostedZoneCountError::unhandled)?
    })
}
...
#[allow(unused_mut)]
pub fn de_get_hosted_zone_count(
    inp: &[u8],
    mut builder: crate::operation::get_hosted_zone_count::builders::GetHostedZoneCountOutputBuilder,
) -> std::result::Result<crate::operation::get_hosted_zone_count::builders::GetHostedZoneCountOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !start_el.matches("GetHostedZoneCountResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetHostedZoneCountResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
