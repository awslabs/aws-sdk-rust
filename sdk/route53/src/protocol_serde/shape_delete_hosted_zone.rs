...
pub fn de_delete_hosted_zone_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_hosted_zone::DeleteHostedZoneOutput, crate::operation::delete_hosted_zone::DeleteHostedZoneError> {
    #[allow(unused_mut)]
...
pub fn de_delete_hosted_zone_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_hosted_zone::de_delete_hosted_zone(_response_body, output)
            .map_err(crate::operation::delete_hosted_zone::DeleteHostedZoneError::unhandled)?;
...
) -> std::result::Result<crate::operation::delete_hosted_zone::builders::DeleteHostedZoneOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
