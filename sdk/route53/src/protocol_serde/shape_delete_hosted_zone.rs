...
pub fn de_delete_hosted_zone_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteHostedZoneOutput, crate::error::DeleteHostedZoneError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteHostedZoneError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteHostedZoneError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_hosted_zone_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteHostedZoneOutput, crate::error::DeleteHostedZoneError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_hosted_zone_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_hosted_zone::de_delete_hosted_zone(response.body().as_ref(), output).map_err(crate::error::DeleteHostedZoneError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_hosted_zone(inp: &[u8], mut builder: crate::output::delete_hosted_zone_output::Builder) -> Result<crate::output::delete_hosted_zone_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
