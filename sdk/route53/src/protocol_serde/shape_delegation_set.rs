...
pub fn de_delegation_set(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::DelegationSet, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("NameServers") /* NameServers com.amazonaws.route53#DelegationSet$NameServers */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_delegation_set_name_servers::de_delegation_set_name_servers(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::delegation_set_correct_errors(builder)
        .build()
