...
pub fn de_traffic_policy_instances(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::TrafficPolicyInstance>, aws_smithy_xml::decode::XmlDecodeError> {
