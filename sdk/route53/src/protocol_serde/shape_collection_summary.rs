...
pub fn de_collection_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CollectionSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
