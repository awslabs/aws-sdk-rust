...
pub fn de_create_health_check_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_health_check_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_create_health_check::de_create_health_check(_response_body, output)
            .map_err(crate::operation::create_health_check::CreateHealthCheckError::unhandled)?;
        output = output.set_location(
            crate::protocol_serde::shape_create_health_check_output::de_location_header(_response_headers).map_err(|_| {
                crate::operation::create_health_check::CreateHealthCheckError::unhandled("Failed to parse Location from header `Location")
            })?,
        );
...
pub fn de_create_health_check(
...
) -> Result<crate::operation::create_health_check::builders::CreateHealthCheckOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("CreateHealthCheckResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected CreateHealthCheckResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
