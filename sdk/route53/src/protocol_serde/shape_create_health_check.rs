...
pub fn de_create_health_check_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_health_check_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::create_health_check_output_output_correct_errors(output).build().map_err(crate::operation::create_health_check::CreateHealthCheckError::unhandled)?
    })
}

pub fn ser_create_health_check_op_input(input: &crate::operation::create_health_check::CreateHealthCheckInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
