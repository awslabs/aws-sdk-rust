...
) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError>
{
    Ok({
        ...
        output = output.set_location(
            match crate::protocol_serde::shape_create_health_check_output::de_location_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::create_health_check::CreateHealthCheckError::unhandled(
