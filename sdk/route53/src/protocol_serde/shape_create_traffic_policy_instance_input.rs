...
pub fn ser_create_traffic_policy_instance_input_input(input: &crate::input::CreateTrafficPolicyInstanceInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
