...
pub fn ser_create_health_check_input_input_input(input: &crate::operation::create_health_check::CreateHealthCheckInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
