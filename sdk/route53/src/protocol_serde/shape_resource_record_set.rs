...
pub fn de_resource_record_set(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResourceRecordSet, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_resource_record_set(input: &crate::model::ResourceRecordSet, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
