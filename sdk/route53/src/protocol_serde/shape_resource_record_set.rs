...
pub fn de_resource_record_set(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ResourceRecordSet, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::resource_record_set_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_resource_record_set(input: &crate::types::ResourceRecordSet, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_21) = &input.multi_value_answer {
        ...
        inner_writer.data(
            ::aws_smithy_types::primitive::Encoder::from(*var_21).encode()
        );
    }
