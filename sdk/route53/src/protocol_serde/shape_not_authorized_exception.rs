...
#[allow(unused_mut)]
pub fn de_not_authorized_exception_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::NotAuthorizedExceptionBuilder,
) -> std::result::Result<crate::types::error::builders::NotAuthorizedExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
