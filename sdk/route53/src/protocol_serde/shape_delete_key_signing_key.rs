...
) -> std::result::Result<crate::operation::delete_key_signing_key::builders::DeleteKeySigningKeyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !start_el.matches("DeleteKeySigningKeyResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected DeleteKeySigningKeyResponse but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
