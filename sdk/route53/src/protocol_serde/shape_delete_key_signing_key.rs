...
pub fn de_delete_key_signing_key_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteKeySigningKeyOutput, crate::error::DeleteKeySigningKeyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteKeySigningKeyError::unhandled)?;
    ...
    Err(match error_code {
        "ConcurrentModification" => crate::error::DeleteKeySigningKeyError::ConcurrentModification({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteKeySigningKeyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "InvalidKeySigningKeyStatus" => crate::error::DeleteKeySigningKeyError::InvalidKeySigningKeyStatus({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_kms_arn::de_invalid_kms_arn_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteKeySigningKeyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_key_signing_key_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteKeySigningKeyOutput, crate::error::DeleteKeySigningKeyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_key_signing_key_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_key_signing_key::de_delete_key_signing_key(response.body().as_ref(), output).map_err(crate::error::DeleteKeySigningKeyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_key_signing_key(inp: &[u8], mut builder: crate::output::delete_key_signing_key_output::Builder) -> Result<crate::output::delete_key_signing_key_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
