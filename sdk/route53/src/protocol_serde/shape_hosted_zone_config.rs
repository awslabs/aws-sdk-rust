...
pub fn ser_hosted_zone_config(input: &crate::model::HostedZoneConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_hosted_zone_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HostedZoneConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
