...
pub fn ser_hosted_zone_config(
    input: &crate::types::HostedZoneConfig,
...
pub fn de_hosted_zone_config(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::HostedZoneConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
