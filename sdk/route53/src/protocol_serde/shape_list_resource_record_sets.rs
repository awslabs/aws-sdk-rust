...
pub fn de_list_resource_record_sets_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, crate::operation::list_resource_record_sets::ListResourceRecordSetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_resource_record_sets::ListResourceRecordSetsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::list_resource_record_sets::ListResourceRecordSetsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_hosted_zone::de_no_such_hosted_zone_xml_err(_response_body, output).map_err(crate::operation::list_resource_record_sets::ListResourceRecordSetsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_resource_record_sets_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, crate::operation::list_resource_record_sets::ListResourceRecordSetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_resource_record_sets::builders::ListResourceRecordSetsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_resource_record_sets::de_list_resource_record_sets(_response_body, output).map_err(crate::operation::list_resource_record_sets::ListResourceRecordSetsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_resource_record_sets_output_output_correct_errors(output).build().map_err(crate::operation::list_resource_record_sets::ListResourceRecordSetsError::unhandled)?
    })
}
