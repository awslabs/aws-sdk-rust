...
pub fn de_list_health_checks_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_health_checks::ListHealthChecksOutput, crate::operation::list_health_checks::ListHealthChecksError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_health_checks_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_health_checks::ListHealthChecksOutput, crate::operation::list_health_checks::ListHealthChecksError> {
    Ok({
        #[allow(unused_mut)]
