...
pub fn de_list_health_checks_http_error(
...
pub fn de_list_health_checks_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_health_checks_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_health_checks::ListHealthChecksError::unhandled)?
    })
}
...
) -> std::result::Result<crate::operation::list_health_checks::builders::ListHealthChecksOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
