...
pub fn de_list_health_checks_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHealthChecksOutput, crate::error::ListHealthChecksError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListHealthChecksError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_incompatible_version::de_incompatible_version_xml_err(response.body().as_ref(), output).map_err(crate::error::ListHealthChecksError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListHealthChecksError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_health_checks_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHealthChecksOutput, crate::error::ListHealthChecksError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_health_checks_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_health_checks::de_list_health_checks(response.body().as_ref(), output).map_err(crate::error::ListHealthChecksError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_health_checks(inp: &[u8], mut builder: crate::output::list_health_checks_output::Builder) -> Result<crate::output::list_health_checks_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
