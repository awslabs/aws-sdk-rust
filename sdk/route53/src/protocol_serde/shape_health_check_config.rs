...
pub fn ser_health_check_config(input: &crate::model::HealthCheckConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_health_check_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HealthCheckConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
