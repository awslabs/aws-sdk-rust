...
pub fn ser_health_check_config(input: &crate::types::HealthCheckConfig, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_health_check_config(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::HealthCheckConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::health_check_config_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
