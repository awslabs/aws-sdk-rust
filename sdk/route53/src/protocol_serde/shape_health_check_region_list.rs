...
pub fn de_health_check_region_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::HealthCheckRegion>, aws_smithy_xml::decode::XmlDecodeError> {
