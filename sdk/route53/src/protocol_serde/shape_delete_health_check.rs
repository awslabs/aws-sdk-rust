...
pub fn de_delete_health_check_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_health_check::DeleteHealthCheckOutput, crate::operation::delete_health_check::DeleteHealthCheckError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_health_check_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_health_check::DeleteHealthCheckOutput, crate::operation::delete_health_check::DeleteHealthCheckError> {
    Ok({
        #[allow(unused_mut)]
