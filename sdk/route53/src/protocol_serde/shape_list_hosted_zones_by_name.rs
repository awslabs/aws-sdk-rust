...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_hosted_zones_by_name::de_list_hosted_zones_by_name(_response_body, output)
            .map_err(crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_hosted_zones_by_name_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_hosted_zones_by_name::builders::ListHostedZonesByNameOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
