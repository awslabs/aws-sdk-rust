...
pub fn de_list_hosted_zones_by_name_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHostedZonesByNameOutput, crate::error::ListHostedZonesByNameError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListHostedZonesByNameError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListHostedZonesByNameError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_hosted_zones_by_name_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListHostedZonesByNameOutput, crate::error::ListHostedZonesByNameError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_hosted_zones_by_name_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_hosted_zones_by_name::de_list_hosted_zones_by_name(response.body().as_ref(), output).map_err(crate::error::ListHostedZonesByNameError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_hosted_zones_by_name(inp: &[u8], mut builder: crate::output::list_hosted_zones_by_name_output::Builder) -> Result<crate::output::list_hosted_zones_by_name_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
