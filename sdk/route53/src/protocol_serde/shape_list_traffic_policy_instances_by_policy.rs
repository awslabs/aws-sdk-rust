...
pub fn de_list_traffic_policy_instances_by_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTrafficPolicyInstancesByPolicyOutput, crate::error::ListTrafficPolicyInstancesByPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListTrafficPolicyInstancesByPolicyError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListTrafficPolicyInstancesByPolicyError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_traffic_policy::de_no_such_traffic_policy_xml_err(response.body().as_ref(), output).map_err(crate::error::ListTrafficPolicyInstancesByPolicyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_traffic_policy_instance::de_no_such_traffic_policy_instance_xml_err(response.body().as_ref(), output).map_err(crate::error::ListTrafficPolicyInstancesByPolicyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policy_instances_by_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTrafficPolicyInstancesByPolicyOutput, crate::error::ListTrafficPolicyInstancesByPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_traffic_policy_instances_by_policy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_traffic_policy_instances_by_policy::de_list_traffic_policy_instances_by_policy(response.body().as_ref(), output).map_err(crate::error::ListTrafficPolicyInstancesByPolicyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_traffic_policy_instances_by_policy(inp: &[u8], mut builder: crate::output::list_traffic_policy_instances_by_policy_output::Builder) -> Result<crate::output::list_traffic_policy_instances_by_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
