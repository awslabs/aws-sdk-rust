...
pub fn de_list_tags_for_resource_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTagsForResourceOutput, crate::error::ListTagsForResourceError> {
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(response.body().as_ref(), output).map_err(crate::error::ListTagsForResourceError::unhandled)?;
        ...
        "PriorRequestNotComplete" => crate::error::ListTagsForResourceError::PriorRequestNotComplete({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
