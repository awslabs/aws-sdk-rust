...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_traffic_policy_instances::de_list_traffic_policy_instances(_response_body, output)
            .map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_traffic_policy_instances_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?
    })
}
...
> {
    ...
    if !start_el.matches("ListTrafficPolicyInstancesResponse") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListTrafficPolicyInstancesResponse but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
