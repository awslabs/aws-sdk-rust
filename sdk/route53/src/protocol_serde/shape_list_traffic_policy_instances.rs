...
pub fn de_list_traffic_policy_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policy_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    Ok({
        #[allow(unused_mut)]
