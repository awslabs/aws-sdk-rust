...
pub fn de_list_traffic_policy_instances_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_traffic_policy_instance::de_no_such_traffic_policy_instance_xml_err(_response_body, output).map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policy_instances_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_traffic_policy_instances::builders::ListTrafficPolicyInstancesOutputBuilder::default();
        output = crate::protocol_serde::shape_list_traffic_policy_instances::de_list_traffic_policy_instances(_response_body, output).map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_traffic_policy_instances_output_output_correct_errors(output).build().map_err(crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError::unhandled)?
    })
}
