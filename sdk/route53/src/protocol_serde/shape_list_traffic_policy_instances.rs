...
pub fn de_list_traffic_policy_instances_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policy_instances_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    Ok({
        #[allow(unused_mut)]
