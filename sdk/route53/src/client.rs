    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`r#type(Option<ReusableDelegationSetLimitType>)`](crate::input::GetReusableDelegationSetLimitInput::r#type): <p>Specify <code>MAX_ZONES_BY_REUSABLE_DELEGATION_SET</code> to get the maximum number of hosted zones that you can associate with the specified reusable delegation set.</p>
