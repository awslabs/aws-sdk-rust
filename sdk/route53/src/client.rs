    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`ActivateKeySigningKeyInput`](crate::input::ActivateKeySigningKeyInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::ActivateKeySigningKeyInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ///   - [`name(Option<String>)`](crate::input::ActivateKeySigningKeyInput::name): <p>A string used to identify a key-signing key (KSK). <code>Name</code> can include numbers, letters, and underscores (_). <code>Name</code> must be unique for each key-signing key in the same hosted zone.</p>
    ...
    ///
    /// - Takes [`AssociateVpcWithHostedZoneInput`](crate::input::AssociateVpcWithHostedZoneInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::AssociateVpcWithHostedZoneInput::hosted_zone_id): <p>The ID of the private hosted zone that you want to associate an Amazon VPC with.</p>  <p>Note that you can't associate a VPC with a hosted zone that doesn't have an existing VPC association.</p>
    ///   - [`vpc(Option<Vpc>)`](crate::input::AssociateVpcWithHostedZoneInput::vpc): <p>A complex type that contains information about the VPC that you want to associate with a private hosted zone.</p>
    ///   - [`comment(Option<String>)`](crate::input::AssociateVpcWithHostedZoneInput::comment): <p> <i>Optional:</i> A comment about the association request.</p>
    ...
    ///
    /// - Takes [`ChangeResourceRecordSetsInput`](crate::input::ChangeResourceRecordSetsInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::ChangeResourceRecordSetsInput::hosted_zone_id): <p>The ID of the hosted zone that contains the resource record sets that you want to change.</p>
    ///   - [`change_batch(Option<ChangeBatch>)`](crate::input::ChangeResourceRecordSetsInput::change_batch): <p>A complex type that contains an optional comment and the <code>Changes</code> element.</p>
    ...
    ///
    /// - Takes [`ChangeTagsForResourceInput`](crate::input::ChangeTagsForResourceInput) with field(s):
    ///   - [`resource_type(Option<TagResourceType>)`](crate::input::ChangeTagsForResourceInput::resource_type): <p>The type of the resource.</p>  <ul>   <li> <p>The resource type for health checks is <code>healthcheck</code>.</p> </li>   <li> <p>The resource type for hosted zones is <code>hostedzone</code>.</p> </li>  </ul>
    ///   - [`resource_id(Option<String>)`](crate::input::ChangeTagsForResourceInput::resource_id): <p>The ID of the resource for which you want to add, change, or delete tags.</p>
    ///   - [`add_tags(Option<Vec<Tag>>)`](crate::input::ChangeTagsForResourceInput::add_tags): <p>A complex type that contains a list of the tags that you want to add to the specified health check or hosted zone and/or the tags that you want to edit <code>Value</code> for.</p>  <p>You can add a maximum of 10 tags to a health check or a hosted zone.</p>
    ///   - [`remove_tag_keys(Option<Vec<String>>)`](crate::input::ChangeTagsForResourceInput::remove_tag_keys): <p>A complex type that contains a list of the tags that you want to delete from the specified health check or hosted zone. You can specify up to 10 keys.</p>
    ...
    ///
    /// - Takes [`CreateHostedZoneInput`](crate::input::CreateHostedZoneInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::CreateHostedZoneInput::name): <p>The name of the domain. Specify a fully qualified domain name, for example, <i>www.example.com</i>. The trailing dot is optional; Amazon Route 53 assumes that the domain name is fully qualified. This means that Route 53 treats <i>www.example.com</i> (without a trailing dot) and <i>www.example.com.</i> (with a trailing dot) as identical.</p>  <p>If you're creating a public hosted zone, this is the name you have registered with your DNS registrar. If your domain name is registered with a registrar other than Route 53, change the name servers for your domain to the set of <code>NameServers</code> that <code>CreateHostedZone</code> returns in <code>DelegationSet</code>.</p>
    ///   - [`vpc(Option<Vpc>)`](crate::input::CreateHostedZoneInput::vpc): <p>(Private hosted zones only) A complex type that contains information about the Amazon VPC that you're associating with this hosted zone.</p>  <p>You can specify only one Amazon VPC when you create a private hosted zone. If you are associating a VPC with a hosted zone with this request, the paramaters <code>VPCId</code> and <code>VPCRegion</code> are also required.</p>  <p>To associate additional Amazon VPCs with the hosted zone, use <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_AssociateVPCWithHostedZone.html">AssociateVPCWithHostedZone</a> after you create a hosted zone.</p>
    ///   - [`caller_reference(Option<String>)`](crate::input::CreateHostedZoneInput::caller_reference): <p>A unique string that identifies the request and that allows failed <code>CreateHostedZone</code> requests to be retried without the risk of executing the operation twice. You must use a unique <code>CallerReference</code> string every time you submit a <code>CreateHostedZone</code> request. <code>CallerReference</code> can be any unique string, for example, a date/time stamp.</p>
    ///   - [`hosted_zone_config(Option<HostedZoneConfig>)`](crate::input::CreateHostedZoneInput::hosted_zone_config): <p>(Optional) A complex type that contains the following optional values:</p>  <ul>   <li> <p>For public and private hosted zones, an optional comment</p> </li>   <li> <p>For private hosted zones, an optional <code>PrivateZone</code> element</p> </li>  </ul>  <p>If you don't specify a comment or the <code>PrivateZone</code> element, omit <code>HostedZoneConfig</code> and the other elements.</p>
    ///   - [`delegation_set_id(Option<String>)`](crate::input::CreateHostedZoneInput::delegation_set_id): <p>If you want to associate a reusable delegation set with this hosted zone, the ID that Amazon Route 53 assigned to the reusable delegation set when you created it. For more information about reusable delegation sets, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateReusableDelegationSet.html">CreateReusableDelegationSet</a>.</p>
    ...
    ///
    /// - Takes [`CreateKeySigningKeyInput`](crate::input::CreateKeySigningKeyInput) with field(s):
    ///   - [`caller_reference(Option<String>)`](crate::input::CreateKeySigningKeyInput::caller_reference): <p>A unique string that identifies the request.</p>
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::CreateKeySigningKeyInput::hosted_zone_id): <p>The unique string (ID) used to identify a hosted zone.</p>
    ///   - [`key_management_service_arn(Option<String>)`](crate::input::CreateKeySigningKeyInput::key_management_service_arn): <p>The Amazon resource name (ARN) for a customer managed key in Key Management Service (KMS). The <code>KeyManagementServiceArn</code> must be unique for each key-signing key (KSK) in a single hosted zone. To see an example of <code>KeyManagementServiceArn</code> that grants the correct permissions for DNSSEC, scroll down to <b>Example</b>. </p>  <p>You must configure the customer managed customer managed key as follows:</p>  <dl>   <dt>   Status  </dt>   <dd>    <p>Enabled</p>   </dd>   <dt>   Key spec  </dt>   <dd>    <p>ECC_NIST_P256</p>   </dd>   <dt>   Key usage  </dt>   <dd>    <p>Sign and verify</p>   </dd>   <dt>   Key policy  </dt>   <dd>    <p>The key policy must give permission for the following actions:</p>    <ul>     <li> <p>DescribeKey</p> </li>     <li> <p>GetPublicKey</p> </li>     <li> <p>Sign</p> </li>    </ul>    <p>The key policy must also include the Amazon Route 53 service in the principal for your account. Specify the following:</p>    <ul>     <li> <p> <code>"Service": "dnssec-route53.amazonaws.com"</code> </p> </li>    </ul>   </dd>  </dl>  <p>For more information about working with a customer managed key in KMS, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html">Key Management Service concepts</a>.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateKeySigningKeyInput::name): <p>A string used to identify a key-signing key (KSK). <code>Name</code> can include numbers, letters, and underscores (_). <code>Name</code> must be unique for each key-signing key in the same hosted zone.</p>
    ///   - [`status(Option<String>)`](crate::input::CreateKeySigningKeyInput::status): <p>A string specifying the initial status of the key-signing key (KSK). You can set the value to <code>ACTIVE</code> or <code>INACTIVE</code>.</p>
    ...
    ///
    /// - Takes [`CreateTrafficPolicyInput`](crate::input::CreateTrafficPolicyInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::CreateTrafficPolicyInput::name): <p>The name of the traffic policy.</p>
    ///   - [`document(Option<String>)`](crate::input::CreateTrafficPolicyInput::document): <p>The definition of this traffic policy in JSON format. For more information, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/api-policies-traffic-policy-document-format.html">Traffic Policy Document Format</a>.</p>
    ///   - [`comment(Option<String>)`](crate::input::CreateTrafficPolicyInput::comment): <p>(Optional) Any comments that you want to include about the traffic policy.</p>
    ...
    ///
    /// - Takes [`CreateTrafficPolicyInstanceInput`](crate::input::CreateTrafficPolicyInstanceInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::CreateTrafficPolicyInstanceInput::hosted_zone_id): <p>The ID of the hosted zone that you want Amazon Route 53 to create resource record sets in by using the configuration in a traffic policy.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateTrafficPolicyInstanceInput::name): <p>The domain name (such as example.com) or subdomain name (such as www.example.com) for which Amazon Route 53 responds to DNS queries by using the resource record sets that Route 53 creates for this traffic policy instance.</p>
    ///   - [`ttl(Option<i64>)`](crate::input::CreateTrafficPolicyInstanceInput::ttl): <p>(Optional) The TTL that you want Amazon Route 53 to assign to all of the resource record sets that it creates in the specified hosted zone.</p>
    ///   - [`traffic_policy_id(Option<String>)`](crate::input::CreateTrafficPolicyInstanceInput::traffic_policy_id): <p>The ID of the traffic policy that you want to use to create resource record sets in the specified hosted zone.</p>
    ///   - [`traffic_policy_version(Option<i32>)`](crate::input::CreateTrafficPolicyInstanceInput::traffic_policy_version): <p>The version of the traffic policy that you want to use to create resource record sets in the specified hosted zone.</p>
    ...
    ///
    /// - Takes [`CreateTrafficPolicyVersionInput`](crate::input::CreateTrafficPolicyVersionInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::CreateTrafficPolicyVersionInput::id): <p>The ID of the traffic policy for which you want to create a new version.</p>
    ///   - [`document(Option<String>)`](crate::input::CreateTrafficPolicyVersionInput::document): <p>The definition of this version of the traffic policy, in JSON format. You specified the JSON in the <code>CreateTrafficPolicyVersion</code> request. For more information about the JSON format, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateTrafficPolicy.html">CreateTrafficPolicy</a>.</p>
    ///   - [`comment(Option<String>)`](crate::input::CreateTrafficPolicyVersionInput::comment): <p>The comment that you specified in the <code>CreateTrafficPolicyVersion</code> request, if any.</p>
    ...
    ///
    /// - Takes [`CreateVpcAssociationAuthorizationInput`](crate::input::CreateVpcAssociationAuthorizationInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::CreateVpcAssociationAuthorizationInput::hosted_zone_id): <p>The ID of the private hosted zone that you want to authorize associating a VPC with.</p>
    ///   - [`vpc(Option<Vpc>)`](crate::input::CreateVpcAssociationAuthorizationInput::vpc): <p>A complex type that contains the VPC ID and region for the VPC that you want to authorize associating with your hosted zone.</p>
    ...
    ///
    /// - Takes [`DeactivateKeySigningKeyInput`](crate::input::DeactivateKeySigningKeyInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::DeactivateKeySigningKeyInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ///   - [`name(Option<String>)`](crate::input::DeactivateKeySigningKeyInput::name): <p>A string used to identify a key-signing key (KSK).</p>
    ...
    ///
    /// - Takes [`DeleteHealthCheckInput`](crate::input::DeleteHealthCheckInput) with field(s):
    ///   - [`health_check_id(Option<String>)`](crate::input::DeleteHealthCheckInput::health_check_id): <p>The ID of the health check that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteHostedZoneInput`](crate::input::DeleteHostedZoneInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::DeleteHostedZoneInput::id): <p>The ID of the hosted zone you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteKeySigningKeyInput`](crate::input::DeleteKeySigningKeyInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::DeleteKeySigningKeyInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ///   - [`name(Option<String>)`](crate::input::DeleteKeySigningKeyInput::name): <p>A string used to identify a key-signing key (KSK).</p>
    ...
    ///
    /// - Takes [`DeleteQueryLoggingConfigInput`](crate::input::DeleteQueryLoggingConfigInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::DeleteQueryLoggingConfigInput::id): <p>The ID of the configuration that you want to delete. </p>
    ...
    ///
    /// - Takes [`DeleteReusableDelegationSetInput`](crate::input::DeleteReusableDelegationSetInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::DeleteReusableDelegationSetInput::id): <p>The ID of the reusable delegation set that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteTrafficPolicyInput`](crate::input::DeleteTrafficPolicyInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::DeleteTrafficPolicyInput::id): <p>The ID of the traffic policy that you want to delete.</p>
    ///   - [`version(Option<i32>)`](crate::input::DeleteTrafficPolicyInput::version): <p>The version number of the traffic policy that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteTrafficPolicyInstanceInput`](crate::input::DeleteTrafficPolicyInstanceInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::DeleteTrafficPolicyInstanceInput::id): <p>The ID of the traffic policy instance that you want to delete. </p> <important>   <p>When you delete a traffic policy instance, Amazon Route 53 also deletes all of the resource record sets that were created when you created the traffic policy instance.</p>  </important>
    ...
    ///
    /// - Takes [`DisableHostedZoneDnssecInput`](crate::input::DisableHostedZoneDnssecInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::DisableHostedZoneDnssecInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ...
    ///
    /// - Takes [`DisassociateVpcFromHostedZoneInput`](crate::input::DisassociateVpcFromHostedZoneInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::DisassociateVpcFromHostedZoneInput::hosted_zone_id): <p>The ID of the private hosted zone that you want to disassociate a VPC from.</p>
    ///   - [`vpc(Option<Vpc>)`](crate::input::DisassociateVpcFromHostedZoneInput::vpc): <p>A complex type that contains information about the VPC that you're disassociating from the specified hosted zone.</p>
    ///   - [`comment(Option<String>)`](crate::input::DisassociateVpcFromHostedZoneInput::comment): <p> <i>Optional:</i> A comment about the disassociation request.</p>
    ...
    ///
    /// - Takes [`EnableHostedZoneDnssecInput`](crate::input::EnableHostedZoneDnssecInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::EnableHostedZoneDnssecInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ...
    ///
    /// - Takes [`GetChangeInput`](crate::input::GetChangeInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetChangeInput::id): <p>The ID of the change batch request. The value that you specify here is the value that <code>ChangeResourceRecordSets</code> returned in the <code>Id</code> element when you submitted the request.</p>
    ...
    ///
    /// - Takes [`GetCheckerIpRangesInput`](crate::input::GetCheckerIpRangesInput)
    ...
    ///
    /// - Takes [`GetDnssecInput`](crate::input::GetDnssecInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::GetDnssecInput::hosted_zone_id): <p>A unique string used to identify a hosted zone.</p>
    ...
    ///
    /// - Takes [`GetGeoLocationInput`](crate::input::GetGeoLocationInput) with field(s):
    ///   - [`continent_code(Option<String>)`](crate::input::GetGeoLocationInput::continent_code): <p>For geolocation resource record sets, a two-letter abbreviation that identifies a continent. Amazon Route 53 supports the following continent codes:</p>  <ul>   <li> <p> <b>AF</b>: Africa</p> </li>   <li> <p> <b>AN</b>: Antarctica</p> </li>   <li> <p> <b>AS</b>: Asia</p> </li>   <li> <p> <b>EU</b>: Europe</p> </li>   <li> <p> <b>OC</b>: Oceania</p> </li>   <li> <p> <b>NA</b>: North America</p> </li>   <li> <p> <b>SA</b>: South America</p> </li>  </ul>
    ///   - [`country_code(Option<String>)`](crate::input::GetGeoLocationInput::country_code): <p>Amazon Route 53 uses the two-letter country codes that are specified in <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO standard 3166-1 alpha-2</a>.</p>
    ///   - [`subdivision_code(Option<String>)`](crate::input::GetGeoLocationInput::subdivision_code): <p>The code for the subdivision, such as a particular state within the United States. For a list of US state abbreviations, see <a href="https://pe.usps.com/text/pub28/28apb.htm">Appendix B: Two–Letter State and Possession Abbreviations</a> on the United States Postal Service website. For a list of all supported subdivision codes, use the <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_ListGeoLocations.html">ListGeoLocations</a> API.</p>
    ...
    ///
    /// - Takes [`GetHealthCheckInput`](crate::input::GetHealthCheckInput) with field(s):
    ///   - [`health_check_id(Option<String>)`](crate::input::GetHealthCheckInput::health_check_id): <p>The identifier that Amazon Route 53 assigned to the health check when you created it. When you add or update a resource record set, you use this value to specify which health check to use. The value can be up to 64 characters long.</p>
    ...
    ///
    /// - Takes [`GetHealthCheckCountInput`](crate::input::GetHealthCheckCountInput)
    ...
    ///
    /// - Takes [`GetHealthCheckLastFailureReasonInput`](crate::input::GetHealthCheckLastFailureReasonInput) with field(s):
    ///   - [`health_check_id(Option<String>)`](crate::input::GetHealthCheckLastFailureReasonInput::health_check_id): <p>The ID for the health check for which you want the last failure reason. When you created the health check, <code>CreateHealthCheck</code> returned the ID in the response, in the <code>HealthCheckId</code> element.</p> <note>   <p>If you want to get the last failure reason for a calculated health check, you must use the Amazon Route 53 console or the CloudWatch console. You can't use <code>GetHealthCheckLastFailureReason</code> for a calculated health check.</p>  </note>
    ...
    ///
    /// - Takes [`GetHealthCheckStatusInput`](crate::input::GetHealthCheckStatusInput) with field(s):
    ///   - [`health_check_id(Option<String>)`](crate::input::GetHealthCheckStatusInput::health_check_id): <p>The ID for the health check that you want the current status for. When you created the health check, <code>CreateHealthCheck</code> returned the ID in the response, in the <code>HealthCheckId</code> element.</p> <note>   <p>If you want to check the status of a calculated health check, you must use the Amazon Route 53 console or the CloudWatch console. You can't use <code>GetHealthCheckStatus</code> to get the status of a calculated health check.</p>  </note>
    ...
    ///
    /// - Takes [`GetHostedZoneInput`](crate::input::GetHostedZoneInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetHostedZoneInput::id): <p>The ID of the hosted zone that you want to get information about.</p>
    ...
    ///
    /// - Takes [`GetHostedZoneCountInput`](crate::input::GetHostedZoneCountInput)
    ...
    ///
    /// - Takes [`GetHostedZoneLimitInput`](crate::input::GetHostedZoneLimitInput) with field(s):
    ///   - [`r#type(Option<HostedZoneLimitType>)`](crate::input::GetHostedZoneLimitInput::type): <p>The limit that you want to get. Valid values include the following:</p>  <ul>   <li> <p> <b>MAX_RRSETS_BY_ZONE</b>: The maximum number of records that you can create in the specified hosted zone.</p> </li>   <li> <p> <b>MAX_VPCS_ASSOCIATED_BY_ZONE</b>: The maximum number of Amazon VPCs that you can associate with the specified private hosted zone.</p> </li>  </ul>
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::GetHostedZoneLimitInput::hosted_zone_id): <p>The ID of the hosted zone that you want to get a limit for.</p>
    ...
    ///
    /// - Takes [`GetQueryLoggingConfigInput`](crate::input::GetQueryLoggingConfigInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetQueryLoggingConfigInput::id): <p>The ID of the configuration for DNS query logging that you want to get information about.</p>
    ...
    ///
    /// - Takes [`GetReusableDelegationSetInput`](crate::input::GetReusableDelegationSetInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetReusableDelegationSetInput::id): <p>The ID of the reusable delegation set that you want to get a list of name servers for.</p>
    ...
    ///
    /// - Takes [`GetReusableDelegationSetLimitInput`](crate::input::GetReusableDelegationSetLimitInput) with field(s):
    ///   - [`r#type(Option<ReusableDelegationSetLimitType>)`](crate::input::GetReusableDelegationSetLimitInput::type): <p>Specify <code>MAX_ZONES_BY_REUSABLE_DELEGATION_SET</code> to get the maximum number of hosted zones that you can associate with the specified reusable delegation set.</p>
    ///   - [`delegation_set_id(Option<String>)`](crate::input::GetReusableDelegationSetLimitInput::delegation_set_id): <p>The ID of the delegation set that you want to get the limit for.</p>
    ...
    ///
    /// - Takes [`GetTrafficPolicyInput`](crate::input::GetTrafficPolicyInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetTrafficPolicyInput::id): <p>The ID of the traffic policy that you want to get information about.</p>
    ///   - [`version(Option<i32>)`](crate::input::GetTrafficPolicyInput::version): <p>The version number of the traffic policy that you want to get information about.</p>
    ...
    ///
    /// - Takes [`GetTrafficPolicyInstanceInput`](crate::input::GetTrafficPolicyInstanceInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetTrafficPolicyInstanceInput::id): <p>The ID of the traffic policy instance that you want to get information about.</p>
    ...
    ///
    /// - Takes [`GetTrafficPolicyInstanceCountInput`](crate::input::GetTrafficPolicyInstanceCountInput)
    ...
    ///
    /// - Takes [`ListGeoLocationsInput`](crate::input::ListGeoLocationsInput) with field(s):
    ///   - [`start_continent_code(Option<String>)`](crate::input::ListGeoLocationsInput::start_continent_code): <p>The code for the continent with which you want to start listing locations that Amazon Route 53 supports for geolocation. If Route 53 has already returned a page or more of results, if <code>IsTruncated</code> is true, and if <code>NextContinentCode</code> from the previous response has a value, enter that value in <code>startcontinentcode</code> to return the next page of results.</p>  <p>Include <code>startcontinentcode</code> only if you want to list continents. Don't include <code>startcontinentcode</code> when you're listing countries or countries with their subdivisions.</p>
    ///   - [`start_country_code(Option<String>)`](crate::input::ListGeoLocationsInput::start_country_code): <p>The code for the country with which you want to start listing locations that Amazon Route 53 supports for geolocation. If Route 53 has already returned a page or more of results, if <code>IsTruncated</code> is <code>true</code>, and if <code>NextCountryCode</code> from the previous response has a value, enter that value in <code>startcountrycode</code> to return the next page of results.</p>
    ///   - [`start_subdivision_code(Option<String>)`](crate::input::ListGeoLocationsInput::start_subdivision_code): <p>The code for the state of the United States with which you want to start listing locations that Amazon Route 53 supports for geolocation. If Route 53 has already returned a page or more of results, if <code>IsTruncated</code> is <code>true</code>, and if <code>NextSubdivisionCode</code> from the previous response has a value, enter that value in <code>startsubdivisioncode</code> to return the next page of results.</p>  <p>To list subdivisions (U.S. states), you must include both <code>startcountrycode</code> and <code>startsubdivisioncode</code>.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListGeoLocationsInput::max_items): <p>(Optional) The maximum number of geolocations to be included in the response body for this request. If more than <code>maxitems</code> geolocations remain to be listed, then the value of the <code>IsTruncated</code> element in the response is <code>true</code>.</p>
    ...
    ///
    /// - Takes [`ListHostedZonesByVpcInput`](crate::input::ListHostedZonesByVpcInput) with field(s):
    ///   - [`vpc_id(Option<String>)`](crate::input::ListHostedZonesByVpcInput::vpc_id): <p>The ID of the Amazon VPC that you want to list hosted zones for.</p>
    ///   - [`vpc_region(Option<VpcRegion>)`](crate::input::ListHostedZonesByVpcInput::vpc_region): <p>For the Amazon VPC that you specified for <code>VPCId</code>, the Amazon Web Services Region that you created the VPC in. </p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListHostedZonesByVpcInput::max_items): <p>(Optional) The maximum number of hosted zones that you want Amazon Route 53 to return. If the specified VPC is associated with more than <code>MaxItems</code> hosted zones, the response includes a <code>NextToken</code> element. <code>NextToken</code> contains an encrypted token that identifies the first hosted zone that Route 53 will return if you submit another request.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListHostedZonesByVpcInput::next_token): <p>If the previous response included a <code>NextToken</code> element, the specified VPC is associated with more hosted zones. To get more hosted zones, submit another <code>ListHostedZonesByVPC</code> request. </p>  <p>For the value of <code>NextToken</code>, specify the value of <code>NextToken</code> from the previous response.</p>  <p>If the previous response didn't include a <code>NextToken</code> element, there are no more hosted zones to get.</p>
    ...
    ///
    /// - Takes [`ListReusableDelegationSetsInput`](crate::input::ListReusableDelegationSetsInput) with field(s):
    ///   - [`marker(Option<String>)`](crate::input::ListReusableDelegationSetsInput::marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more reusable delegation sets. To get another group, submit another <code>ListReusableDelegationSets</code> request. </p>  <p>For the value of <code>marker</code>, specify the value of <code>NextMarker</code> from the previous response, which is the ID of the first reusable delegation set that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more reusable delegation sets to get.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListReusableDelegationSetsInput::max_items): <p>The number of reusable delegation sets that you want Amazon Route 53 to return in the response to this request. If you specify a value greater than 100, Route 53 returns only the first 100 reusable delegation sets.</p>
    ...
    ///   - [`resource_type(Option<TagResourceType>)`](crate::input::ListTagsForResourceInput::resource_type): <p>The type of the resource.</p>  <ul>   <li> <p>The resource type for health checks is <code>healthcheck</code>.</p> </li>   <li> <p>The resource type for hosted zones is <code>hostedzone</code>.</p> </li>  </ul>
    ///   - [`resource_id(Option<String>)`](crate::input::ListTagsForResourceInput::resource_id): <p>The ID of the resource for which you want to retrieve tags.</p>
    ...
    ///   - [`resource_type(Option<TagResourceType>)`](crate::input::ListTagsForResourcesInput::resource_type): <p>The type of the resources.</p>  <ul>   <li> <p>The resource type for health checks is <code>healthcheck</code>.</p> </li>   <li> <p>The resource type for hosted zones is <code>hostedzone</code>.</p> </li>  </ul>
    ///   - [`resource_ids(Option<Vec<String>>)`](crate::input::ListTagsForResourcesInput::resource_ids): <p>A complex type that contains the ResourceId element for each resource for which you want to get a list of tags.</p>
    ...
    ///
    /// - Takes [`ListTrafficPolicyInstancesByPolicyInput`](crate::input::ListTrafficPolicyInstancesByPolicyInput) with field(s):
    ///   - [`traffic_policy_id(Option<String>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::traffic_policy_id): <p>The ID of the traffic policy for which you want to list traffic policy instances.</p>
    ///   - [`traffic_policy_version(Option<i32>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::traffic_policy_version): <p>The version of the traffic policy for which you want to list traffic policy instances. The version must be associated with the traffic policy that is specified by <code>TrafficPolicyId</code>.</p>
    ///   - [`hosted_zone_id_marker(Option<String>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::hosted_zone_id_marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more traffic policy instances. To get more traffic policy instances, submit another <code>ListTrafficPolicyInstancesByPolicy</code> request. </p>  <p>For the value of <code>hostedzoneid</code>, specify the value of <code>HostedZoneIdMarker</code> from the previous response, which is the hosted zone ID of the first traffic policy instance that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more traffic policy instances to get.</p>
    ///   - [`traffic_policy_instance_name_marker(Option<String>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::traffic_policy_instance_name_marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more traffic policy instances. To get more traffic policy instances, submit another <code>ListTrafficPolicyInstancesByPolicy</code> request.</p>  <p>For the value of <code>trafficpolicyinstancename</code>, specify the value of <code>TrafficPolicyInstanceNameMarker</code> from the previous response, which is the name of the first traffic policy instance that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more traffic policy instances to get.</p>
    ///   - [`traffic_policy_instance_type_marker(Option<RrType>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::traffic_policy_instance_type_marker): <p>If the value of <code>IsTruncated</code> in the previous response was <code>true</code>, you have more traffic policy instances. To get more traffic policy instances, submit another <code>ListTrafficPolicyInstancesByPolicy</code> request.</p>  <p>For the value of <code>trafficpolicyinstancetype</code>, specify the value of <code>TrafficPolicyInstanceTypeMarker</code> from the previous response, which is the name of the first traffic policy instance that Amazon Route 53 will return if you submit another request.</p>  <p>If the value of <code>IsTruncated</code> in the previous response was <code>false</code>, there are no more traffic policy instances to get.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListTrafficPolicyInstancesByPolicyInput::max_items): <p>The maximum number of traffic policy instances to be included in the response body for this request. If you have more than <code>MaxItems</code> traffic policy instances, the value of the <code>IsTruncated</code> element in the response is <code>true</code>, and the values of <code>HostedZoneIdMarker</code>, <code>TrafficPolicyInstanceNameMarker</code>, and <code>TrafficPolicyInstanceTypeMarker</code> represent the first traffic policy instance that Amazon Route 53 will return if you submit another request.</p>
    ...
    ///
    /// - Takes [`ListTrafficPolicyVersionsInput`](crate::input::ListTrafficPolicyVersionsInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::ListTrafficPolicyVersionsInput::id): <p>Specify the value of <code>Id</code> of the traffic policy for which you want to list all versions.</p>
    ///   - [`traffic_policy_version_marker(Option<String>)`](crate::input::ListTrafficPolicyVersionsInput::traffic_policy_version_marker): <p>For your first request to <code>ListTrafficPolicyVersions</code>, don't include the <code>TrafficPolicyVersionMarker</code> parameter.</p>  <p>If you have more traffic policy versions than the value of <code>MaxItems</code>, <code>ListTrafficPolicyVersions</code> returns only the first group of <code>MaxItems</code> versions. To get more traffic policy versions, submit another <code>ListTrafficPolicyVersions</code> request. For the value of <code>TrafficPolicyVersionMarker</code>, specify the value of <code>TrafficPolicyVersionMarker</code> in the previous response.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListTrafficPolicyVersionsInput::max_items): <p>The maximum number of traffic policy versions that you want Amazon Route 53 to include in the response body for this request. If the specified traffic policy has more than <code>MaxItems</code> versions, the value of <code>IsTruncated</code> in the response is <code>true</code>, and the value of the <code>TrafficPolicyVersionMarker</code> element is the ID of the first version that Route 53 will return if you submit another request.</p>
    ...
    ///
    /// - Takes [`ListVpcAssociationAuthorizationsInput`](crate::input::ListVpcAssociationAuthorizationsInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::ListVpcAssociationAuthorizationsInput::hosted_zone_id): <p>The ID of the hosted zone for which you want a list of VPCs that can be associated with the hosted zone.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListVpcAssociationAuthorizationsInput::next_token): <p> <i>Optional</i>: If a response includes a <code>NextToken</code> element, there are more VPCs that can be associated with the specified hosted zone. To get the next page of results, submit another request, and include the value of <code>NextToken</code> from the response in the <code>nexttoken</code> parameter in another <code>ListVPCAssociationAuthorizations</code> request.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListVpcAssociationAuthorizationsInput::max_results): <p> <i>Optional</i>: An integer that specifies the maximum number of VPCs that you want Amazon Route 53 to return. If you don't specify a value for <code>MaxResults</code>, Route 53 returns up to 50 VPCs per page.</p>
    ...
    ///
    /// - Takes [`TestDnsAnswerInput`](crate::input::TestDnsAnswerInput) with field(s):
    ///   - [`hosted_zone_id(Option<String>)`](crate::input::TestDnsAnswerInput::hosted_zone_id): <p>The ID of the hosted zone that you want Amazon Route 53 to simulate a query for.</p>
    ///   - [`record_name(Option<String>)`](crate::input::TestDnsAnswerInput::record_name): <p>The name of the resource record set that you want Amazon Route 53 to simulate a query for.</p>
    ///   - [`record_type(Option<RrType>)`](crate::input::TestDnsAnswerInput::record_type): <p>The type of the resource record set.</p>
    ///   - [`resolver_ip(Option<String>)`](crate::input::TestDnsAnswerInput::resolver_ip): <p>If you want to simulate a request from a specific DNS resolver, specify the IP address for that resolver. If you omit this value, <code>TestDnsAnswer</code> uses the IP address of a DNS resolver in the Amazon Web Services US East (N. Virginia) Region (<code>us-east-1</code>).</p>
    ///   - [`edns0_client_subnet_ip(Option<String>)`](crate::input::TestDnsAnswerInput::edns0_client_subnet_ip): <p>If the resolver that you specified for resolverip supports EDNS0, specify the IPv4 or IPv6 address of a client in the applicable location, for example, <code>192.0.2.44</code> or <code>2001:db8:85a3::8a2e:370:7334</code>.</p>
    ///   - [`edns0_client_subnet_mask(Option<String>)`](crate::input::TestDnsAnswerInput::edns0_client_subnet_mask): <p>If you specify an IP address for <code>edns0clientsubnetip</code>, you can optionally specify the number of bits of the IP address that you want the checking tool to include in the DNS query. For example, if you specify <code>192.0.2.44</code> for <code>edns0clientsubnetip</code> and <code>24</code> for <code>edns0clientsubnetmask</code>, the checking tool will simulate a request from 192.0.2.0/24. The default value is 24 bits for IPv4 addresses and 64 bits for IPv6 addresses.</p>  <p>The range of valid values depends on whether <code>edns0clientsubnetip</code> is an IPv4 or an IPv6 address:</p>  <ul>   <li> <p> <b>IPv4</b>: Specify a value between 0 and 32</p> </li>   <li> <p> <b>IPv6</b>: Specify a value between 0 and 128</p> </li>  </ul>
    ...
    ///
    /// - Takes [`UpdateHostedZoneCommentInput`](crate::input::UpdateHostedZoneCommentInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::UpdateHostedZoneCommentInput::id): <p>The ID for the hosted zone that you want to update the comment for.</p>
    ///   - [`comment(Option<String>)`](crate::input::UpdateHostedZoneCommentInput::comment): <p>The new comment for the hosted zone. If you don't specify a value for <code>Comment</code>, Amazon Route 53 deletes the existing value of the <code>Comment</code> element, if any.</p>
    ...
    ///
    /// - Takes [`UpdateTrafficPolicyCommentInput`](crate::input::UpdateTrafficPolicyCommentInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::UpdateTrafficPolicyCommentInput::id): <p>The value of <code>Id</code> for the traffic policy that you want to update the comment for.</p>
    ///   - [`version(Option<i32>)`](crate::input::UpdateTrafficPolicyCommentInput::version): <p>The value of <code>Version</code> for the traffic policy that you want to update the comment for.</p>
    ///   - [`comment(Option<String>)`](crate::input::UpdateTrafficPolicyCommentInput::comment): <p>The new comment for the specified traffic policy and version.</p>
    ...
    ///
    /// - Takes [`UpdateTrafficPolicyInstanceInput`](crate::input::UpdateTrafficPolicyInstanceInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::UpdateTrafficPolicyInstanceInput::id): <p>The ID of the traffic policy instance that you want to update.</p>
    ///   - [`ttl(Option<i64>)`](crate::input::UpdateTrafficPolicyInstanceInput::ttl): <p>The TTL that you want Amazon Route 53 to assign to all of the updated resource record sets.</p>
    ///   - [`traffic_policy_id(Option<String>)`](crate::input::UpdateTrafficPolicyInstanceInput::traffic_policy_id): <p>The ID of the traffic policy that you want Amazon Route 53 to use to update resource record sets for the specified traffic policy instance.</p>
    ///   - [`traffic_policy_version(Option<i32>)`](crate::input::UpdateTrafficPolicyInstanceInput::traffic_policy_version): <p>The version of the traffic policy that you want Amazon Route 53 to use to update resource record sets for the specified traffic policy instance.</p>
