...
impl GetTrafficPolicyInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstanceOutput, crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstanceError, Self> {
