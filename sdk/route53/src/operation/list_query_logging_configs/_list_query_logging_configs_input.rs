...
impl ListQueryLoggingConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
