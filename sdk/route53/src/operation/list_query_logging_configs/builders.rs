...
impl ListQueryLoggingConfigsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsOutput, crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError, Self> {
