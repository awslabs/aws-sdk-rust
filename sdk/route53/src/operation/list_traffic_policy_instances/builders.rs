...
impl ListTrafficPolicyInstancesFluentBuilder  {
    /// Creates a new `ListTrafficPolicyInstances`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstances, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, aws_smithy_http::result::SdkError<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError>>
                     {
