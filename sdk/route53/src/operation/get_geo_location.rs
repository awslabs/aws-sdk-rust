...
impl GetGeoLocationInput {
    /// Consumes the builder and constructs an Operation<[`GetGeoLocation`](crate::operation::get_geo_location::GetGeoLocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_geo_location::GetGeoLocation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_geo_location::GetGeoLocationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2013-04-01/geolocation").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_geo_location::GetGeoLocationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_1) = &_input.continent_code {
                     {
                        query.push_kv("continentcode", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
                if let Some(inner_2) = &_input.country_code {
                     {
                        query.push_kv("countrycode", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.subdivision_code {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_geo_location::GetGeoLocation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetGeoLocation {
                type Output = std::result::Result<crate::operation::get_geo_location::GetGeoLocationOutput, crate::operation::get_geo_location::GetGeoLocationError>;
