    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/geolocation")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_geo_location::GetGeoLocation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGeoLocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_geo_location::de_get_geo_location_http_error(
                status, headers, body,
            )
        } else {
