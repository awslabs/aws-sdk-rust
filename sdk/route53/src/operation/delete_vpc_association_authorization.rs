...
impl DeleteVpcAssociationAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVPCAssociationAuthorization`](crate::operation::delete_vpc_association_authorization::DeleteVPCAssociationAuthorization)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_vpc_association_authorization::DeleteVPCAssociationAuthorization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vpc_association_authorization::DeleteVpcAssociationAuthorizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2013-04-01/hostedzone/{HostedZoneId}/deauthorizevpcassociation", HostedZoneId = hosted_zone_id).expect("formatting should succeed");
                Ok(())
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVPCAssociationAuthorization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_vpc_association_authorization::de_delete_vpc_association_authorization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_vpc_association_authorization::de_delete_vpc_association_authorization_http_response(response)
                     }
                }
            }
