...
impl ListTagsForResourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListTagsForResources`](crate::operation::list_tags_for_resources::ListTagsForResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_tags_for_resources::ListTagsForResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_tags_for_resources::ListTagsForResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.resource_type;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("resource_type", "cannot be empty or unset"))?;
                ...
                write!(output, "/2013-04-01/tags/{ResourceType}", ResourceType = resource_type).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_tags_for_resources::ser_list_tags_for_resources_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_tags_for_resources::ListTagsForResources::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTagsForResources", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTagsForResources {
                type Output = std::result::Result<crate::operation::list_tags_for_resources::ListTagsForResourcesOutput, crate::operation::list_tags_for_resources::ListTagsForResourcesError>;
