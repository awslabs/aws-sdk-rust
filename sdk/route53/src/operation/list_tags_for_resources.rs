...
impl ListTagsForResources {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_tags_for_resources::ListTagsForResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_tags_for_resources::ListTagsForResourcesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "ListTagsForResources", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.ListTagsForResources",
                "rpc.service" = "Route 53",
                "rpc.method" = "ListTagsForResources",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForResources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTagsForResourcesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListTagsForResources")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTagsForResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_tags_for_resources::ListTagsForResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_tags_for_resources::ListTagsForResourcesInput,
