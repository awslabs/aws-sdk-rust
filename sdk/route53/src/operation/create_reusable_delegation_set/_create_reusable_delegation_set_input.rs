...
impl CreateReusableDelegationSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetInput, ::aws_smithy_types::error::operation::BuildError> {
