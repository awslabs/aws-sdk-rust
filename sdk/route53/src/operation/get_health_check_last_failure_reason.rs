...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHealthCheckLastFailureReason {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_health_check_last_failure_reason::de_get_health_check_last_failure_reason_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_health_check_last_failure_reason::GetHealthCheckLastFailureReasonError
{
