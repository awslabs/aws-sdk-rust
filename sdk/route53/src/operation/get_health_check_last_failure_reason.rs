...
impl GetHealthCheckLastFailureReason {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_health_check_last_failure_reason::GetHealthCheckLastFailureReasonOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetHealthCheckLastFailureReasonResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetHealthCheckLastFailureReasonRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("health_check_id", "cannot be empty or unset"))?;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_health_check_last_failure_reason::GetHealthCheckLastFailureReasonError {
