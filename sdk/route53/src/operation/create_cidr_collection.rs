...
impl CreateCidrCollectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateCidrCollection`](crate::operation::create_cidr_collection::CreateCidrCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_cidr_collection::CreateCidrCollection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_cidr_collection::CreateCidrCollectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_cidr_collection::ser_create_cidr_collection_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_cidr_collection::CreateCidrCollection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateCidrCollection", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateCidrCollection {
                type Output = std::result::Result<crate::operation::create_cidr_collection::CreateCidrCollectionOutput, crate::operation::create_cidr_collection::CreateCidrCollectionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_cidr_collection::de_create_cidr_collection_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_cidr_collection::de_create_cidr_collection_http_response(response)
                     }
                }
            }
