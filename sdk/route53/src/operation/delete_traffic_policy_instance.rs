...
impl DeleteTrafficPolicyInstanceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_traffic_policy_instance::DeleteTrafficPolicyInstance::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteTrafficPolicyInstanceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_traffic_policy_instance::DeleteTrafficPolicyInstanceError
{
