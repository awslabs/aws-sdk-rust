...
impl CreateTrafficPolicyVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_traffic_policy_version::CreateTrafficPolicyVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficPolicyVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_traffic_policy_version::de_create_traffic_policy_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
