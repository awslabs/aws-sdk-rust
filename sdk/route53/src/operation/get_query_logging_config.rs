...
impl GetQueryLoggingConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetQueryLoggingConfig`](crate::operation::get_query_logging_config::GetQueryLoggingConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_query_logging_config::GetQueryLoggingConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_query_logging_config::GetQueryLoggingConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2013-04-01/queryloggingconfig/{Id}", Id = id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_query_logging_config::GetQueryLoggingConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetQueryLoggingConfig", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetQueryLoggingConfig {
                type Output = std::result::Result<crate::operation::get_query_logging_config::GetQueryLoggingConfigOutput, crate::operation::get_query_logging_config::GetQueryLoggingConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_query_logging_config::de_get_query_logging_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_query_logging_config::de_get_query_logging_config_http_response(response)
                     }
                }
            }
