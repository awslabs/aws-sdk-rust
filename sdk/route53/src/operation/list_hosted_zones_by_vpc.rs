...
impl ListHostedZonesByVpcInput {
    /// Consumes the builder and constructs an Operation<[`ListHostedZonesByVPC`](crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPC)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPC, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVpcInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2013-04-01/hostedzonesbyvpc").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVpcInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.vpc_id;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("vpc_id", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("vpc_id", "cannot be empty or unset"));
                }
                query.push_kv("vpcid", &aws_smithy_http::query::fmt_string(&inner_1));
                let inner_2 = &_input.vpc_region;
                let inner_2 = inner_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("vpc_region", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPC::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListHostedZonesByVPC", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListHostedZonesByVPC {
                type Output = std::result::Result<crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVpcOutput, crate::operation::list_hosted_zones_by_vpc::ListHostedZonesByVPCError>;
