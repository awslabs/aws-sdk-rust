...
impl DeleteVpcAssociationAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_vpc_association_authorization::DeleteVpcAssociationAuthorizationInput, ::aws_smithy_types::error::operation::BuildError> {
