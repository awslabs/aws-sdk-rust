...
impl CreateVpcAssociationAuthorizationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_vpc_association_authorization::CreateVPCAssociationAuthorization,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_vpc_association_authorization::CreateVPCAssociationAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVPCAssociationAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_association_authorization::de_create_vpc_association_authorization_http_response_with_props(
                status, headers, body,
            )
        }
    }
