...
impl GetTrafficPolicyInstanceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTrafficPolicyInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_traffic_policy_instance::de_get_traffic_policy_instance_http_response_with_props(status, headers, body)
        }
    }
}
