...
impl DisassociateVPCFromHostedZone {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZoneError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53.DisassociateVPCFromHostedZone",
            "rpc.service" = "Route 53",
            "rpc.method" = "DisassociateVPCFromHostedZone",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateVPCFromHostedZone {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateVPCFromHostedZoneResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateVPCFromHostedZone")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateVPCFromHostedZone")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisassociateVPCFromHostedZoneTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisassociateVPCFromHostedZoneTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateVPCFromHostedZoneTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociateVpcFromHostedZoneInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateVPCFromHostedZoneResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_vpc_from_hosted_zone::de_disassociate_vpc_from_hosted_zone_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_disassociate_vpc_from_hosted_zone::de_disassociate_vpc_from_hosted_zone_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateVPCFromHostedZoneRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_vpc_from_hosted_zone::ser_disassociate_vpc_from_hosted_zone_op_input(&input)?,
        );
...
impl ::std::error::Error for DisassociateVPCFromHostedZoneError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::LastVpcAssociation(_inner) => ::std::option::Option::Some(_inner),
            Self::NoSuchHostedZone(_inner) => ::std::option::Option::Some(_inner),
            Self::VpcAssociationNotFound(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateVPCFromHostedZoneError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::LastVpcAssociation(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::NoSuchHostedZone(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::VpcAssociationNotFound(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
