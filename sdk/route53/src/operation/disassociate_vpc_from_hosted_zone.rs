...
impl DisassociateVpcFromHostedZoneInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZone::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateVPCFromHostedZone {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_vpc_from_hosted_zone::de_disassociate_vpc_from_hosted_zone_http_response_with_props(
                status, headers, body,
            )
        }
    }
