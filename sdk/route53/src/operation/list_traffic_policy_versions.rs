...
impl ListTrafficPolicyVersionsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2013-04-01/trafficpolicies/{Id}/versions", Id = id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTrafficPolicyVersions", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyVersions {
                type Output = std::result::Result<crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersionsOutput, crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersionsError>;
