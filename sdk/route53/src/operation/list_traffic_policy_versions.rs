...
impl ListTrafficPolicyVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_traffic_policy_versions::ListTrafficPolicyVersions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_traffic_policy_versions::de_list_traffic_policy_versions_http_response_with_props(status, headers, body)
        }
    }
}
