    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/trafficpolicies")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_traffic_policies::ListTrafficPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_traffic_policies::de_list_traffic_policies_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_traffic_policies::ListTrafficPoliciesError
{
