...
impl DeleteReusableDelegationSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReusableDelegationSet`](crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteReusableDelegationSet {
                type Output = std::result::Result<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetOutput, crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetError>;
