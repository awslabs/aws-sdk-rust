    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/delegationset/{Id}", Id = id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReusableDelegationSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_reusable_delegation_set::de_delete_reusable_delegation_set_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteReusableDelegationSetError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetError
{
