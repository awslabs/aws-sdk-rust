...
impl DeleteReusableDelegationSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSet,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReusableDelegationSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_reusable_delegation_set::de_delete_reusable_delegation_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
