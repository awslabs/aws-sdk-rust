...
impl ListCidrCollectionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_cidr_collections::ListCidrCollectionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_cidr_collections::ListCidrCollectionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_cidr_collections::ListCidrCollectionsOutput, crate::operation::list_cidr_collections::ListCidrCollectionsError, Self> {
