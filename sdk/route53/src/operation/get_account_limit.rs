    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/accountlimit/{Type}", Type = r#type)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_account_limit::GetAccountLimit::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_account_limit::GetAccountLimitError
{
