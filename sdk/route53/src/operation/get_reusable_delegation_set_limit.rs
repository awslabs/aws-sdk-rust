...
impl GetReusableDelegationSetLimitInput {
    /// Consumes the builder and constructs an Operation<[`GetReusableDelegationSetLimit`](crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.delegation_set_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("delegation_set_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimit::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetReusableDelegationSetLimit {
                type Output = std::result::Result<crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitOutput, crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_reusable_delegation_set_limit::de_get_reusable_delegation_set_limit_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_reusable_delegation_set_limit::de_get_reusable_delegation_set_limit_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitError {
