...
impl GetReusableDelegationSetLimitInput {
    ...
    > {
        ...
        crate::route53_resource_id_preprocessor_middleware::trim_resource_id(&mut self.delegation_set_id);
        let mut request = {
            fn uri_base(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimit::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReusableDelegationSetLimit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reusable_delegation_set_limit::de_get_reusable_delegation_set_limit_http_response_with_props(
                status, headers, body,
            )
        }
    }
