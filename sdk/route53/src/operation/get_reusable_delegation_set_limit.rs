...
impl GetReusableDelegationSetLimit {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetReusableDelegationSetLimit",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetReusableDelegationSetLimit {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetReusableDelegationSetLimitRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetReusableDelegationSetLimitResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetReusableDelegationSetLimit")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetReusableDelegationSetLimit")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetReusableDelegationSetLimitTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetReusableDelegationSetLimitTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetReusableDelegationSetLimitTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetReusableDelegationSetLimitInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetReusableDelegationSetLimitResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_reusable_delegation_set_limit::de_get_reusable_delegation_set_limit_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_get_reusable_delegation_set_limit::de_get_reusable_delegation_set_limit_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReusableDelegationSetLimitRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_reusable_delegation_set_limit::GetReusableDelegationSetLimitInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                let r#type = ::aws_smithy_http::label::fmt_string(input_2.as_str(), ::aws_smithy_http::label::EncodingStrategy::Default);
                if r#type.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field(
                        "r#type",
                        "cannot be empty or unset",
