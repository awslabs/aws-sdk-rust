...
impl ChangeResourceRecordSetsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::change_resource_record_sets::ChangeResourceRecordSets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ChangeResourceRecordSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_change_resource_record_sets::de_change_resource_record_sets_http_response_with_props(status, headers, body)
        }
    }
}
