...
impl ChangeResourceRecordSetsInput {
    /// Consumes the builder and constructs an Operation<[`ChangeResourceRecordSets`](crate::operation::change_resource_record_sets::ChangeResourceRecordSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::change_resource_record_sets::ChangeResourceRecordSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::change_resource_record_sets::ChangeResourceRecordSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_change_resource_record_sets::ser_change_resource_record_sets_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::change_resource_record_sets::ChangeResourceRecordSets::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ChangeResourceRecordSets", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ChangeResourceRecordSets {
                type Output = std::result::Result<crate::operation::change_resource_record_sets::ChangeResourceRecordSetsOutput, crate::operation::change_resource_record_sets::ChangeResourceRecordSetsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_change_resource_record_sets::de_change_resource_record_sets_http_error(response)
                     } else {
                        crate::protocol_serde::shape_change_resource_record_sets::de_change_resource_record_sets_http_response(response)
                     }
                }
            }
