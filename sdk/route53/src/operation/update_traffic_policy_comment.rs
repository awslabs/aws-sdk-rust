...
impl UpdateTrafficPolicyComment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateTrafficPolicyComment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateTrafficPolicyComment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateTrafficPolicyCommentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateTrafficPolicyCommentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateTrafficPolicyComment")
...
.with_interceptor(UpdateTrafficPolicyCommentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateTrafficPolicyCommentResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateTrafficPolicyCommentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateTrafficPolicyCommentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_traffic_policy_comment::ser_update_traffic_policy_comment_op_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateTrafficPolicyCommentEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateTrafficPolicyCommentInput>()
                        .ok_or("failed to downcast to UpdateTrafficPolicyCommentInput")?;
...
pub enum UpdateTrafficPolicyCommentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateTrafficPolicyCommentError) for what information is available for the error.")]
...
impl UpdateTrafficPolicyCommentError {
    /// Creates the `UpdateTrafficPolicyCommentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateTrafficPolicyCommentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateTrafficPolicyCommentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_traffic_policy_comment::_update_traffic_policy_comment_output::UpdateTrafficPolicyCommentOutput;

pub use crate::operation::update_traffic_policy_comment::_update_traffic_policy_comment_input::UpdateTrafficPolicyCommentInput;

mod _update_traffic_policy_comment_input;

mod _update_traffic_policy_comment_output;
