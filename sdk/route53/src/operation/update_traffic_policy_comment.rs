...
impl UpdateTrafficPolicyCommentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTrafficPolicyComment`](crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyComment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyComment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_traffic_policy_comment::ser_update_traffic_policy_comment_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyComment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateTrafficPolicyComment", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTrafficPolicyComment {
                type Output = std::result::Result<crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentOutput, crate::operation::update_traffic_policy_comment::UpdateTrafficPolicyCommentError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_traffic_policy_comment::de_update_traffic_policy_comment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_traffic_policy_comment::de_update_traffic_policy_comment_http_response(response)
                     }
                }
            }
