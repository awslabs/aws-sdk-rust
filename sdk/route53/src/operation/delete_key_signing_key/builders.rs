...
impl DeleteKeySigningKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_key_signing_key::DeleteKeySigningKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_key_signing_key::DeleteKeySigningKeyOutput, crate::operation::delete_key_signing_key::DeleteKeySigningKeyError, Self> {
