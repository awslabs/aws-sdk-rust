...
impl CreateHostedZoneInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hosted_zone::ser_create_hosted_zone_op_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHostedZone {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_hosted_zone::de_create_hosted_zone_http_response_with_props(status, headers, body)
        }
    }
}
