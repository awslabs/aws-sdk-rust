...
impl CreateQueryLoggingConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_query_logging_config::CreateQueryLoggingConfigInput, ::aws_smithy_types::error::operation::BuildError> {
