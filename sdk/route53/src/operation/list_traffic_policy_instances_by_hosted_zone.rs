...
impl aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyInstancesByHostedZone {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_traffic_policy_instances_by_hosted_zone::de_list_traffic_policy_instances_by_hosted_zone_http_response_with_props(status, headers, body)
        }
    }
}
