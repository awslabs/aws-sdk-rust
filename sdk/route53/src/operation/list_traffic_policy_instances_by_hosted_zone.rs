...
impl ListTrafficPolicyInstancesByHostedZone {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_traffic_policy_instances_by_hosted_zone::ListTrafficPolicyInstancesByHostedZoneError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_traffic_policy_instances_by_hosted_zone::ListTrafficPolicyInstancesByHostedZoneOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListTrafficPolicyInstancesByHostedZone",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTrafficPolicyInstancesByHostedZone {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListTrafficPolicyInstancesByHostedZoneRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTrafficPolicyInstancesByHostedZoneResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListTrafficPolicyInstancesByHostedZone")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTrafficPolicyInstancesByHostedZone")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListTrafficPolicyInstancesByHostedZoneTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListTrafficPolicyInstancesByHostedZoneTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTrafficPolicyInstancesByHostedZoneTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTrafficPolicyInstancesByHostedZoneInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTrafficPolicyInstancesByHostedZoneResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_traffic_policy_instances_by_hosted_zone::de_list_traffic_policy_instances_by_hosted_zone_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_traffic_policy_instances_by_hosted_zone::de_list_traffic_policy_instances_by_hosted_zone_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTrafficPolicyInstancesByHostedZoneRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_traffic_policy_instances_by_hosted_zone::ListTrafficPolicyInstancesByHostedZoneInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_traffic_policy_instances_by_hosted_zone::ListTrafficPolicyInstancesByHostedZoneInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_traffic_policy_instances_by_hosted_zone::ListTrafficPolicyInstancesByHostedZoneError
{
