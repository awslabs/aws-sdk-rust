...
impl ListHealthChecksInput {
    /// Consumes the builder and constructs an Operation<[`ListHealthChecks`](crate::operation::list_health_checks::ListHealthChecks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_health_checks::ListHealthChecks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_health_checks::ListHealthChecksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2013-04-01/healthcheck").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_health_checks::ListHealthChecksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_health_checks::ListHealthChecks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListHealthChecks", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListHealthChecks {
                type Output = std::result::Result<crate::operation::list_health_checks::ListHealthChecksOutput, crate::operation::list_health_checks::ListHealthChecksError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_health_checks::de_list_health_checks_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_health_checks::de_list_health_checks_http_response(response)
                     }
                }
            }
