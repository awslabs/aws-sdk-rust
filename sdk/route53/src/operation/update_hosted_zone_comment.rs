...
impl UpdateHostedZoneCommentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_hosted_zone_comment::UpdateHostedZoneComment,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateHostedZoneComment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_hosted_zone_comment::de_update_hosted_zone_comment_http_response_with_props(status, headers, body)
        }
    }
}
