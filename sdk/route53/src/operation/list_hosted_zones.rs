...
impl ListHostedZonesInput {
    /// Consumes the builder and constructs an Operation<[`ListHostedZones`](crate::operation::list_hosted_zones::ListHostedZones)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_hosted_zones::ListHostedZones, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hosted_zones::ListHostedZonesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2013-04-01/hostedzone").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_hosted_zones::ListHostedZonesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.delegation_set_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_hosted_zones::ListHostedZones::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListHostedZones", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListHostedZones {
                type Output = std::result::Result<crate::operation::list_hosted_zones::ListHostedZonesOutput, crate::operation::list_hosted_zones::ListHostedZonesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_hosted_zones::de_list_hosted_zones_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_hosted_zones::de_list_hosted_zones_http_response(response)
                     }
                }
            }
