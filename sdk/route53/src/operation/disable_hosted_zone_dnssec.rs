...
impl DisableHostedZoneDNSSEC {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSECError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "DisableHostedZoneDNSSEC", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.DisableHostedZoneDNSSEC",
                "rpc.service" = "Route 53",
                "rpc.method" = "DisableHostedZoneDNSSEC",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableHostedZoneDNSSEC {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisableHostedZoneDNSSECRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisableHostedZoneDNSSECResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisableHostedZoneDNSSEC")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableHostedZoneDNSSEC")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisableHostedZoneDNSSECTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(
                    |input: &mut crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecInput| &mut input.hosted_zone_id,
                ),
            ))
...
#[derive(Debug)]
struct DisableHostedZoneDNSSECTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableHostedZoneDNSSECTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisableHostedZoneDnssecInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableHostedZoneDNSSECResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disable_hosted_zone_dnssec::de_disable_hosted_zone_dnssec_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disable_hosted_zone_dnssec::de_disable_hosted_zone_dnssec_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableHostedZoneDNSSECRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecInput>()
            .expect("correct type");
