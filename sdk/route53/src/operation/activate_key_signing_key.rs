...
impl ActivateKeySigningKeyInput {
    /// Consumes the builder and constructs an Operation<[`ActivateKeySigningKey`](crate::operation::activate_key_signing_key::ActivateKeySigningKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::activate_key_signing_key::ActivateKeySigningKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::activate_key_signing_key::ActivateKeySigningKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::activate_key_signing_key::ActivateKeySigningKey::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ActivateKeySigningKey {
                type Output = std::result::Result<crate::operation::activate_key_signing_key::ActivateKeySigningKeyOutput, crate::operation::activate_key_signing_key::ActivateKeySigningKeyError>;
