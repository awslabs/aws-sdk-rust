...
impl ActivateKeySigningKey {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::activate_key_signing_key::ActivateKeySigningKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::activate_key_signing_key::ActivateKeySigningKeyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "ActivateKeySigningKey", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.ActivateKeySigningKey",
                "rpc.service" = "Route 53",
                "rpc.method" = "ActivateKeySigningKey",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ActivateKeySigningKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ActivateKeySigningKeyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ActivateKeySigningKeyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ActivateKeySigningKey")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ActivateKeySigningKey")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ActivateKeySigningKeyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(
                    |input: &mut crate::operation::activate_key_signing_key::ActivateKeySigningKeyInput| &mut input.hosted_zone_id,
                ),
            ))
...
#[derive(Debug)]
struct ActivateKeySigningKeyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ActivateKeySigningKeyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ActivateKeySigningKeyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ActivateKeySigningKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_activate_key_signing_key::de_activate_key_signing_key_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_activate_key_signing_key::de_activate_key_signing_key_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ActivateKeySigningKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::activate_key_signing_key::ActivateKeySigningKeyInput>()
            .expect("correct type");
