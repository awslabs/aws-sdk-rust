...
impl ListHostedZonesByName {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListHostedZonesByName {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListHostedZonesByName");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListHostedZonesByNameRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListHostedZonesByNameResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListHostedZonesByName")
...
.with_interceptor(ListHostedZonesByNameEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListHostedZonesByNameResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_hosted_zones_by_name::de_list_hosted_zones_by_name_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_hosted_zones_by_name::de_list_hosted_zones_by_name_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListHostedZonesByNameRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListHostedZonesByNameRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2013-04-01/hostedzonesbyname").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.dns_name {
         {
            query.push_kv("dnsname", &::aws_smithy_http::query::fmt_string(inner_1));
        }
    }
    if let ::std::option::Option::Some(inner_2) = &_input.hosted_zone_id {
         {
            query.push_kv("hostedzoneid", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListHostedZonesByNameEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListHostedZonesByNameEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListHostedZonesByNameInput>()
                        .ok_or("failed to downcast to ListHostedZonesByNameInput")?;
...
pub enum ListHostedZonesByNameError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListHostedZonesByNameError) for what information is available for the error.")]
...
impl ListHostedZonesByNameError {
    /// Creates the `ListHostedZonesByNameError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListHostedZonesByNameError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListHostedZonesByNameError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_hosted_zones_by_name::_list_hosted_zones_by_name_output::ListHostedZonesByNameOutput;

pub use crate::operation::list_hosted_zones_by_name::_list_hosted_zones_by_name_input::ListHostedZonesByNameInput;

mod _list_hosted_zones_by_name_input;

mod _list_hosted_zones_by_name_output;
