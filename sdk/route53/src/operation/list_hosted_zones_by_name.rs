    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/hostedzonesbyname")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_hosted_zones_by_name::ListHostedZonesByName::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_hosted_zones_by_name::ListHostedZonesByNameError
{
