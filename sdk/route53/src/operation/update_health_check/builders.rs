...
impl UpdateHealthCheckFluentBuilder  {
    /// Creates a new `UpdateHealthCheck`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_health_check::UpdateHealthCheck, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_health_check::UpdateHealthCheckError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_health_check::UpdateHealthCheckOutput, aws_smithy_http::result::SdkError<crate::operation::update_health_check::UpdateHealthCheckError>>
                     {
