...
impl ChangeResourceRecordSetsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::change_resource_record_sets::ChangeResourceRecordSetsInput, ::aws_smithy_types::error::operation::BuildError> {
