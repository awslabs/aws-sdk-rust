...
impl GetDnssecInput {
    /// Consumes the builder and constructs an Operation<[`GetDNSSEC`](crate::operation::get_dnssec::GetDNSSEC)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_dnssec::GetDNSSEC, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_dnssec::GetDnssecInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2013-04-01/hostedzone/{HostedZoneId}/dnssec", HostedZoneId = hosted_zone_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_dnssec::GetDNSSEC::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDNSSEC", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDNSSEC {
                type Output = std::result::Result<crate::operation::get_dnssec::GetDnssecOutput, crate::operation::get_dnssec::GetDNSSECError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_dnssec::de_get_dnssec_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_dnssec::de_get_dnssec_http_response(response)
                     }
                }
            }
