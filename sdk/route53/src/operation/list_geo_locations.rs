...
impl ListGeoLocationsInput {
    /// Consumes the builder and constructs an Operation<[`ListGeoLocations`](crate::operation::list_geo_locations::ListGeoLocations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_geo_locations::ListGeoLocations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_geo_locations::ListGeoLocationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2013-04-01/geolocations").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_geo_locations::ListGeoLocationsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_1) = &_input.start_continent_code {
                     {
                        query.push_kv("startcontinentcode", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
                if let Some(inner_2) = &_input.start_country_code {
                     {
                        query.push_kv("startcountrycode", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.start_subdivision_code {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_geo_locations::ListGeoLocations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGeoLocations", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListGeoLocations {
                type Output = std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError>;
