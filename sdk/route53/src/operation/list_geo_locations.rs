...
impl ListGeoLocationsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_geo_locations::ListGeoLocations::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListGeoLocations {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_geo_locations::de_list_geo_locations_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_geo_locations::ListGeoLocationsError
{
