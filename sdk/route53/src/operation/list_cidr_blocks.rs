...
impl ListCidrBlocksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_cidr_blocks::ListCidrBlocks, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCidrBlocks {
    type Output =
        ::std::result::Result<crate::operation::list_cidr_blocks::ListCidrBlocksOutput, crate::operation::list_cidr_blocks::ListCidrBlocksError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_cidr_blocks::de_list_cidr_blocks_http_response_with_props(status, headers, body)
        }
    }
}
