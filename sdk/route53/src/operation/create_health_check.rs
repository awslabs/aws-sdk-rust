...
impl CreateHealthCheckInput {
    /// Consumes the builder and constructs an Operation<[`CreateHealthCheck`](crate::operation::create_health_check::CreateHealthCheck)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_health_check::CreateHealthCheck, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_health_check::CreateHealthCheckInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_health_check::CreateHealthCheck::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateHealthCheck {
                type Output = std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError>;
