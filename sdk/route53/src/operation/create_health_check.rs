...
impl CreateHealthCheckInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_health_check::CreateHealthCheck::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHealthCheck {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_health_check::de_create_health_check_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_health_check::CreateHealthCheckError
{
