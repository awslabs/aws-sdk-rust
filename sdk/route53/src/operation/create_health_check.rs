...
impl aws_smithy_http::response::ParseStrictResponse for CreateHealthCheck {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_health_check::de_create_health_check_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_health_check::de_create_health_check_http_response(response)
                     }
                }
            }
