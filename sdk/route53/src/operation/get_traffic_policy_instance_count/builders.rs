...
impl crate::operation::get_traffic_policy_instance_count::builders::GetTrafficPolicyInstanceCountInputBuilder {
...
impl GetTrafficPolicyInstanceCountFluentBuilder {
    /// Creates a new `GetTrafficPolicyInstanceCountFluentBuilder`.
