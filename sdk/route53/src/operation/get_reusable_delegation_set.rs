...
impl GetReusableDelegationSetInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_reusable_delegation_set::GetReusableDelegationSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
mod get_reusable_delegation_set_request_test {
    ...
    async fn get_reusable_delegation_set_trim_delegation_set_id_request() {
        ...
        let input =crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput::builder()
        .set_id(
            Some(
