...
impl GetReusableDelegationSet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "GetReusableDelegationSet", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.GetReusableDelegationSet",
                "rpc.service" = "Route 53",
                "rpc.method" = "GetReusableDelegationSet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetReusableDelegationSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetReusableDelegationSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetReusableDelegationSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetReusableDelegationSet")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetReusableDelegationSet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetReusableDelegationSetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(
                    |input: &mut crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput| &mut input.id,
                ),
            ))
...
#[derive(Debug)]
struct GetReusableDelegationSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetReusableDelegationSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetReusableDelegationSetInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetReusableDelegationSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_reusable_delegation_set::de_get_reusable_delegation_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_reusable_delegation_set::de_get_reusable_delegation_set_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReusableDelegationSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput>()
            .expect("correct type");
