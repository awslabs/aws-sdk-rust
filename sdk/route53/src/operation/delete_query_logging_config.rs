...
impl DeleteQueryLoggingConfigInput {
    /// Consumes the builder and constructs an Operation<[`DeleteQueryLoggingConfig`](crate::operation::delete_query_logging_config::DeleteQueryLoggingConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_query_logging_config::DeleteQueryLoggingConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteQueryLoggingConfig {
                type Output = std::result::Result<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigOutput, crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_query_logging_config::de_delete_query_logging_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_query_logging_config::de_delete_query_logging_config_http_response(response)
                     }
                }
            }
