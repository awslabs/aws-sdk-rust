...
impl DeleteQueryLoggingConfigInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_query_logging_config::DeleteQueryLoggingConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteQueryLoggingConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_query_logging_config::de_delete_query_logging_config_http_response_with_props(status, headers, body)
        }
    }
}
