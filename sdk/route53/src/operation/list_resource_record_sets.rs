...
impl ListResourceRecordSets {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_resource_record_sets::ListResourceRecordSetsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "ListResourceRecordSets", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.ListResourceRecordSets",
                "rpc.service" = "Route 53",
                "rpc.method" = "ListResourceRecordSets",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourceRecordSets {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListResourceRecordSetsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListResourceRecordSetsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListResourceRecordSets")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourceRecordSets")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListResourceRecordSetsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListResourceRecordSetsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListResourceRecordSetsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListResourceRecordSetsInput>() else {
        ...
        if requested.should_capture("StartRecordName") {
            if let ::std::option::Option::Some(value) = input.start_record_name.as_deref() {
                captured.insert("StartRecordName", value);
            }
        }
        if requested.should_capture("StartRecordIdentifier") {
            if let ::std::option::Option::Some(value) = input.start_record_identifier.as_deref() {
                captured.insert("StartRecordIdentifier", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceRecordSetsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_resource_record_sets::de_list_resource_record_sets_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_resource_record_sets::de_list_resource_record_sets_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceRecordSetsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_resource_record_sets::ListResourceRecordSetsInput>()
            .expect("correct type");
