...
impl DeleteReusableDelegationSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetOutput, crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetError, Self> {
