...
impl DeleteKeySigningKey {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_key_signing_key::DeleteKeySigningKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteKeySigningKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteKeySigningKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteKeySigningKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteKeySigningKeyResponseDeserializer));
...
.with_interceptor(crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(|input: &mut crate::operation::delete_key_signing_key::DeleteKeySigningKeyInput| {
                                &mut input.hosted_zone_id
                            }))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyError>::new());
...
#[derive(Debug)]
            struct DeleteKeySigningKeyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteKeySigningKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_key_signing_key::DeleteKeySigningKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_key_signing_key::DeleteKeySigningKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteKeySigningKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteKeySigningKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteKeySigningKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteKeySigningKeyInput>()
                        .ok_or("failed to downcast to DeleteKeySigningKeyInput")?;
...
pub enum DeleteKeySigningKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteKeySigningKeyError) for what information is available for the error.")]
...
impl DeleteKeySigningKeyError {
    /// Creates the `DeleteKeySigningKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteKeySigningKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteKeySigningKeyError {
