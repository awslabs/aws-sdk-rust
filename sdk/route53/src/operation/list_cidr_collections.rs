    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/cidrcollection")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_cidr_collections::ListCidrCollections::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCidrCollections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_cidr_collections::de_list_cidr_collections_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_cidr_collections::ListCidrCollectionsError
{
