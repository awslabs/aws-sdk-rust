...
impl GetHostedZoneCount {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_hosted_zone_count::GetHostedZoneCountError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_hosted_zone_count::GetHostedZoneCountOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "GetHostedZoneCount", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetHostedZoneCount {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetHostedZoneCountRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetHostedZoneCountResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetHostedZoneCount")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetHostedZoneCountResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_hosted_zone_count::de_get_hosted_zone_count_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_hosted_zone_count::de_get_hosted_zone_count_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetHostedZoneCountRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_hosted_zone_count::GetHostedZoneCountInput>()
            .expect("correct type");
