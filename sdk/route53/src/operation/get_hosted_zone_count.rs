    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/hostedzonecount")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_hosted_zone_count::GetHostedZoneCount::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_hosted_zone_count::GetHostedZoneCountError
{
