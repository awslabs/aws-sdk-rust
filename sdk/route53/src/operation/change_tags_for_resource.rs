...
impl ChangeTagsForResource {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::change_tags_for_resource::ChangeTagsForResourceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::change_tags_for_resource::ChangeTagsForResourceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "ChangeTagsForResource", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.ChangeTagsForResource",
                "rpc.service" = "Route 53",
                "rpc.method" = "ChangeTagsForResource",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ChangeTagsForResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ChangeTagsForResourceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ChangeTagsForResource")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ChangeTagsForResource")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ChangeTagsForResourceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ChangeTagsForResourceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ChangeTagsForResourceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ChangeTagsForResourceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChangeTagsForResourceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_change_tags_for_resource::de_change_tags_for_resource_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_change_tags_for_resource::de_change_tags_for_resource_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChangeTagsForResourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::change_tags_for_resource::ChangeTagsForResourceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::change_tags_for_resource::ChangeTagsForResourceInput,
