...
impl ChangeTagsForResourceInput {
    /// Consumes the builder and constructs an Operation<[`ChangeTagsForResource`](crate::operation::change_tags_for_resource::ChangeTagsForResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::change_tags_for_resource::ChangeTagsForResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::change_tags_for_resource::ChangeTagsForResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::change_tags_for_resource::ChangeTagsForResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ChangeTagsForResource {
                type Output = std::result::Result<crate::operation::change_tags_for_resource::ChangeTagsForResourceOutput, crate::operation::change_tags_for_resource::ChangeTagsForResourceError>;
