...
impl TestDNSAnswer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::test_dns_answer::TestDNSAnswerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::test_dns_answer::TestDnsAnswerOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "TestDNSAnswer", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.TestDNSAnswer",
                "rpc.service" = "Route 53",
                "rpc.method" = "TestDNSAnswer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TestDNSAnswer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            TestDNSAnswerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            TestDNSAnswerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("TestDNSAnswer")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("TestDNSAnswer", "Route 53"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TestDNSAnswerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_test_dns_answer::de_test_dns_answer_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_test_dns_answer::de_test_dns_answer_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TestDNSAnswerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::test_dns_answer::TestDnsAnswerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_2 = inner_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("record_name", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field(
                        "record_name",
                        "cannot be empty or unset",
                ...
                let inner_3 = inner_3
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("record_type", "cannot be empty or unset"))?;
                query.push_kv("recordtype", &::aws_smithy_http::query::fmt_string(inner_3.as_str()));
