...
impl ListTrafficPolicyInstancesInput {
    /// Consumes the builder and constructs an Operation<[`ListTrafficPolicyInstances`](crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2013-04-01/trafficpolicyinstances").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.hosted_zone_id_marker {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstances::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyInstances {
                type Output = std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError>;
