    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/trafficpolicyinstances")
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                if let ::std::option::Option::Some(inner_2) =
                    &_input.traffic_policy_instance_name_marker
                {
                    {
                        query.push_kv(
                ...
                if let ::std::option::Option::Some(inner_3) =
                    &_input.traffic_policy_instance_type_marker
                {
                    {
                        query.push_kv(
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_traffic_policy_instances::de_list_traffic_policy_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError
{
