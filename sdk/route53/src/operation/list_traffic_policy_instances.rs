...
impl ListTrafficPolicyInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrafficPolicyInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_traffic_policy_instances::de_list_traffic_policy_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
