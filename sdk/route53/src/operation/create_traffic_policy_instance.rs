...
impl CreateTrafficPolicyInstance {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateTrafficPolicyInstance",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTrafficPolicyInstance {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateTrafficPolicyInstanceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateTrafficPolicyInstance")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTrafficPolicyInstance")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateTrafficPolicyInstanceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateTrafficPolicyInstanceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTrafficPolicyInstanceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateTrafficPolicyInstanceInput>() else {
        ...
        if requested.should_capture("TrafficPolicyId") {
            if let ::std::option::Option::Some(value) = input.traffic_policy_id.as_deref() {
                captured.insert("TrafficPolicyId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTrafficPolicyInstanceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_traffic_policy_instance::de_create_traffic_policy_instance_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_traffic_policy_instance::de_create_traffic_policy_instance_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTrafficPolicyInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceInput>()
            .expect("correct type");
...
impl ::std::error::Error for CreateTrafficPolicyInstanceError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::NoSuchTrafficPolicy(_inner) => ::std::option::Option::Some(_inner),
            Self::TooManyTrafficPolicyInstances(_inner) => ::std::option::Option::Some(_inner),
            Self::TrafficPolicyInstanceAlreadyExists(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTrafficPolicyInstanceError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NoSuchTrafficPolicy(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::TooManyTrafficPolicyInstances(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::TrafficPolicyInstanceAlreadyExists(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
