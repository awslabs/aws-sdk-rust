...
impl CreateTrafficPolicyInstanceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficPolicyInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_traffic_policy_instance::de_create_traffic_policy_instance_http_response_with_props(
                status, headers, body,
            )
        }
    }
