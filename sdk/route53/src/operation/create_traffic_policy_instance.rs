    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/trafficpolicyinstance")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficPolicyInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_traffic_policy_instance::de_create_traffic_policy_instance_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateTrafficPolicyInstanceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceError
{
