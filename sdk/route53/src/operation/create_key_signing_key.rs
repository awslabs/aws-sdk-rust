    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateKeySigningKey")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateKeySigningKeyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateKeySigningKeyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateKeySigningKeyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateKeySigningKeyInput>() else {
        ...
        if requested.should_capture("KeyManagementServiceArn") {
            if let ::std::option::Option::Some(value) = input.key_management_service_arn.as_deref() {
                captured.insert("KeyManagementServiceArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateKeySigningKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_key_signing_key::de_create_key_signing_key_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_key_signing_key::de_create_key_signing_key_http_response(status, headers, body, _cfg)
        };
