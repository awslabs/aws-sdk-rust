...
impl ListReusableDelegationSetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_reusable_delegation_sets::ListReusableDelegationSets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReusableDelegationSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_reusable_delegation_sets::de_list_reusable_delegation_sets_http_response_with_props(
                status, headers, body,
            )
        }
    }
