...
impl CreateQueryLoggingConfig {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_query_logging_config::CreateQueryLoggingConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "CreateQueryLoggingConfig", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.CreateQueryLoggingConfig",
                "rpc.service" = "Route 53",
                "rpc.method" = "CreateQueryLoggingConfig",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateQueryLoggingConfig {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateQueryLoggingConfig");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateQueryLoggingConfigRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateQueryLoggingConfigResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateQueryLoggingConfig")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateQueryLoggingConfig")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateQueryLoggingConfigTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateQueryLoggingConfigTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateQueryLoggingConfigTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateQueryLoggingConfigInput>() else {
        ...
        if requested.should_capture("CloudWatchLogsLogGroupArn") {
            if let ::std::option::Option::Some(value) = input.cloud_watch_logs_log_group_arn.as_deref() {
                captured.insert("CloudWatchLogsLogGroupArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateQueryLoggingConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_query_logging_config::de_create_query_logging_config_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_query_logging_config::de_create_query_logging_config_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateQueryLoggingConfigRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateQueryLoggingConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_query_logging_config::CreateQueryLoggingConfigInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateQueryLoggingConfigEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateQueryLoggingConfigInput>()
            .ok_or("failed to downcast to CreateQueryLoggingConfigInput")?;
...
pub enum CreateQueryLoggingConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateQueryLoggingConfigError) for what information is available for the error.")]
...
impl CreateQueryLoggingConfigError {
    ...
    /// Creates the `CreateQueryLoggingConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InsufficientCloudWatchLogsResourcePolicy(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidInput(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::NoSuchCloudWatchLogsLogGroup(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::NoSuchHostedZone(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::QueryLoggingConfigAlreadyExists(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for CreateQueryLoggingConfigError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InsufficientCloudWatchLogsResourcePolicy(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidInput(_inner) => ::std::option::Option::Some(_inner),
            Self::NoSuchCloudWatchLogsLogGroup(_inner) => ::std::option::Option::Some(_inner),
            Self::NoSuchHostedZone(_inner) => ::std::option::Option::Some(_inner),
            Self::QueryLoggingConfigAlreadyExists(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateQueryLoggingConfigError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InsufficientCloudWatchLogsResourcePolicy(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidInput(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::NoSuchCloudWatchLogsLogGroup(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::NoSuchHostedZone(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::QueryLoggingConfigAlreadyExists(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateQueryLoggingConfigError {
