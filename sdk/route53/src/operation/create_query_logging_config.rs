...
impl CreateQueryLoggingConfigInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_query_logging_config::CreateQueryLoggingConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateQueryLoggingConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_query_logging_config::de_create_query_logging_config_http_response_with_props(status, headers, body)
        }
    }
}
