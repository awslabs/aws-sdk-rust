    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/queryloggingconfig")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_query_logging_config::CreateQueryLoggingConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_query_logging_config::CreateQueryLoggingConfigError
{
