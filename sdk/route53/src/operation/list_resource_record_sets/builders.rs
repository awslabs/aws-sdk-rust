...
impl ListResourceRecordSetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_record_sets::ListResourceRecordSetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, crate::operation::list_resource_record_sets::ListResourceRecordSetsError, Self> {
