...
impl ListVPCAssociationAuthorizations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53.ListVPCAssociationAuthorizations",
            "rpc.service" = "Route 53",
            "rpc.method" = "ListVPCAssociationAuthorizations",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVPCAssociationAuthorizations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListVPCAssociationAuthorizationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListVPCAssociationAuthorizationsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListVPCAssociationAuthorizations")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVPCAssociationAuthorizations")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListVPCAssociationAuthorizationsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListVPCAssociationAuthorizationsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVPCAssociationAuthorizationsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListVpcAssociationAuthorizationsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVPCAssociationAuthorizationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_vpc_association_authorizations::de_list_vpc_association_authorizations_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_list_vpc_association_authorizations::de_list_vpc_association_authorizations_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVPCAssociationAuthorizationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput,
