...
impl ListVpcAssociationAuthorizationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVPCAssociationAuthorizations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_vpc_association_authorizations::de_list_vpc_association_authorizations_http_response_with_props(
                status, headers, body,
            )
        }
    }
