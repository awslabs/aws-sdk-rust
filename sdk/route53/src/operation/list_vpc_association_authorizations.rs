...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVPCAssociationAuthorizations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListVPCAssociationAuthorizations", "route53"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListVPCAssociationAuthorizationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListVPCAssociationAuthorizationsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListVPCAssociationAuthorizationsEndpointParamsInterceptor {
