...
impl ListVPCAssociationAuthorizations {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListVPCAssociationAuthorizationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListVPCAssociationAuthorizationsRequestSerializer {
