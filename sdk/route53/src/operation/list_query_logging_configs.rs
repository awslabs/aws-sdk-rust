...
impl ListQueryLoggingConfigs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListQueryLoggingConfigs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListQueryLoggingConfigs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListQueryLoggingConfigsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListQueryLoggingConfigsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListQueryLoggingConfigs")
...
.with_interceptor(ListQueryLoggingConfigsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListQueryLoggingConfigsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_query_logging_configs::de_list_query_logging_configs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListQueryLoggingConfigsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListQueryLoggingConfigsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2013-04-01/queryloggingconfig").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.hosted_zone_id {
         {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListQueryLoggingConfigsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListQueryLoggingConfigsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListQueryLoggingConfigsInput>()
                        .ok_or("failed to downcast to ListQueryLoggingConfigsInput")?;
...
pub enum ListQueryLoggingConfigsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListQueryLoggingConfigsError) for what information is available for the error.")]
...
impl ListQueryLoggingConfigsError {
    /// Creates the `ListQueryLoggingConfigsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListQueryLoggingConfigsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListQueryLoggingConfigsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_query_logging_configs::_list_query_logging_configs_output::ListQueryLoggingConfigsOutput;

pub use crate::operation::list_query_logging_configs::_list_query_logging_configs_input::ListQueryLoggingConfigsInput;

mod _list_query_logging_configs_input;

mod _list_query_logging_configs_output;
