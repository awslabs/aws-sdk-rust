...
impl ListQueryLoggingConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListQueryLoggingConfigs`](crate::operation::list_query_logging_configs::ListQueryLoggingConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_query_logging_configs::ListQueryLoggingConfigs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2013-04-01/queryloggingconfig").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_query_logging_configs::ListQueryLoggingConfigsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_1) = &_input.hosted_zone_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_query_logging_configs::ListQueryLoggingConfigs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListQueryLoggingConfigs {
                type Output = std::result::Result<crate::operation::list_query_logging_configs::ListQueryLoggingConfigsOutput, crate::operation::list_query_logging_configs::ListQueryLoggingConfigsError>;
