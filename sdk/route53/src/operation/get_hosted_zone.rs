...
impl GetHostedZoneInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_hosted_zone::GetHostedZone::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetHostedZone {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_hosted_zone::de_get_hosted_zone_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_hosted_zone::de_get_hosted_zone_http_response(
                status, headers, body,
            )
        }
    }
