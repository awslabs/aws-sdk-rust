    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTrafficPolicyInstanceCount {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            GetTrafficPolicyInstanceCountRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            GetTrafficPolicyInstanceCountResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetTrafficPolicyInstanceCount", "route53"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetTrafficPolicyInstanceCountResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetTrafficPolicyInstanceCountRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetTrafficPolicyInstanceCountEndpointParamsInterceptor {
