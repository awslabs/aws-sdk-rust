...
impl UpdateTrafficPolicyInstanceInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTrafficPolicyInstance`](crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstance::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTrafficPolicyInstance {
                type Output = std::result::Result<crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstanceOutput, crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstanceError>;
