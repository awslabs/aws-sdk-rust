...
impl UpdateTrafficPolicyInstanceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_traffic_policy_instance::UpdateTrafficPolicyInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrafficPolicyInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_traffic_policy_instance::de_update_traffic_policy_instance_http_response_with_props(
                status, headers, body,
            )
        }
    }
