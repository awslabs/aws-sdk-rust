...
impl GetChangeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_change::GetChange,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/change/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_change::GetChange::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChange {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_change::de_get_change_http_response_with_props(
                status, headers, body,
            )
        }
    }
...
mod get_change_request_test {
    ...
    async fn get_change_trim_change_id_request() {
        ...
        ::pretty_assertions::assert_eq!(
            ...
            "/2013-04-01/change/SOMECHANGEID"
        );
    }
}
