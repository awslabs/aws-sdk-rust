...
impl DeleteCidrCollectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_cidr_collection::DeleteCidrCollection,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCidrCollection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cidr_collection::de_delete_cidr_collection_http_response_with_props(status, headers, body)
        }
    }
}
