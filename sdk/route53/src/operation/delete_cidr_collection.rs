    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/cidrcollection/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_cidr_collection::DeleteCidrCollection::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_cidr_collection::DeleteCidrCollectionError
{
