...
impl DeleteCidrCollectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCidrCollection`](crate::operation::delete_cidr_collection::DeleteCidrCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_cidr_collection::DeleteCidrCollection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cidr_collection::DeleteCidrCollectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2013-04-01/cidrcollection/{Id}", Id = id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cidr_collection::DeleteCidrCollection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteCidrCollection", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCidrCollection {
                type Output = std::result::Result<crate::operation::delete_cidr_collection::DeleteCidrCollectionOutput, crate::operation::delete_cidr_collection::DeleteCidrCollectionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_cidr_collection::de_delete_cidr_collection_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_cidr_collection::de_delete_cidr_collection_http_response(response)
                     }
                }
            }
