...
impl GetTrafficPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetTrafficPolicy`](crate::operation::get_traffic_policy::GetTrafficPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_traffic_policy::GetTrafficPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_traffic_policy::GetTrafficPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_traffic_policy::GetTrafficPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTrafficPolicy", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetTrafficPolicy {
                type Output = std::result::Result<crate::operation::get_traffic_policy::GetTrafficPolicyOutput, crate::operation::get_traffic_policy::GetTrafficPolicyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_traffic_policy::de_get_traffic_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_traffic_policy::de_get_traffic_policy_http_response(response)
                     }
                }
            }
