...
impl GetTrafficPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_traffic_policy::GetTrafficPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTrafficPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_traffic_policy::de_get_traffic_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_traffic_policy::GetTrafficPolicyError
{
