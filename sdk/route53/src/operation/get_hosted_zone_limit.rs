...
impl GetHostedZoneLimit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetHostedZoneLimit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetHostedZoneLimitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetHostedZoneLimitResponseDeserializer));
...
.with_interceptor(crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(|input: &mut crate::operation::get_hosted_zone_limit::GetHostedZoneLimitInput| {
                                &mut input.hosted_zone_id
                            }))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetHostedZoneLimitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_hosted_zone_limit::GetHostedZoneLimitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_hosted_zone_limit::GetHostedZoneLimitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2013-04-01/hostedzonelimit/{HostedZoneId}/{Type}", HostedZoneId = hosted_zone_id, Type = r#type).expect("formatting should succeed");
