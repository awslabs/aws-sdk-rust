...
impl CreateReusableDelegationSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateReusableDelegationSet`](crate::operation::create_reusable_delegation_set::CreateReusableDelegationSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_reusable_delegation_set::CreateReusableDelegationSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_reusable_delegation_set::ser_create_reusable_delegation_set_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_reusable_delegation_set::CreateReusableDelegationSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateReusableDelegationSet", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReusableDelegationSet {
                type Output = std::result::Result<crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetOutput, crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_reusable_delegation_set::de_create_reusable_delegation_set_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_reusable_delegation_set::de_create_reusable_delegation_set_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_reusable_delegation_set::CreateReusableDelegationSetError {
