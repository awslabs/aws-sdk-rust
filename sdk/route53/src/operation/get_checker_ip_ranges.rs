    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-04-01/checkeripranges")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_checker_ip_ranges::GetCheckerIpRanges::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCheckerIpRanges {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_checker_ip_ranges::de_get_checker_ip_ranges_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_checker_ip_ranges::GetCheckerIpRangesError
{
