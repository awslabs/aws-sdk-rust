...
impl DeleteTrafficPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTrafficPolicy`](crate::operation::delete_traffic_policy::DeleteTrafficPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_traffic_policy::DeleteTrafficPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_traffic_policy::DeleteTrafficPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("version", "cannot be empty or unset"))?;
                ...
                write!(output, "/2013-04-01/trafficpolicy/{Id}/{Version}", Id = id, Version = version).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_traffic_policy::DeleteTrafficPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteTrafficPolicy", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTrafficPolicy {
                type Output = std::result::Result<crate::operation::delete_traffic_policy::DeleteTrafficPolicyOutput, crate::operation::delete_traffic_policy::DeleteTrafficPolicyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_traffic_policy::de_delete_traffic_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_traffic_policy::de_delete_traffic_policy_http_response(response)
                     }
                }
            }
