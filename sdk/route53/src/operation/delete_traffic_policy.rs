...
impl DeleteTrafficPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_traffic_policy::DeleteTrafficPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrafficPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_traffic_policy::de_delete_traffic_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_traffic_policy::DeleteTrafficPolicyError
{
