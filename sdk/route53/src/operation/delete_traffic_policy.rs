...
impl DeleteTrafficPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_traffic_policy::DeleteTrafficPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrafficPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_traffic_policy::de_delete_traffic_policy_http_response_with_props(status, headers, body)
        }
    }
}
