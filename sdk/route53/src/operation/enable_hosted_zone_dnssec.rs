...
impl EnableHostedZoneDnssecInput {
    /// Consumes the builder and constructs an Operation<[`EnableHostedZoneDNSSEC`](crate::operation::enable_hosted_zone_dnssec::EnableHostedZoneDNSSEC)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::enable_hosted_zone_dnssec::EnableHostedZoneDNSSEC,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_hosted_zone_dnssec::EnableHostedZoneDNSSEC::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnableHostedZoneDNSSEC", "route53"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableHostedZoneDNSSEC {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_hosted_zone_dnssec::de_enable_hosted_zone_dnssec_http_response_with_props(status, headers, body)
        }
    }
}
