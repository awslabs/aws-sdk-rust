...
impl EnableHostedZoneDNSSEC {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Route 53", "EnableHostedZoneDNSSEC", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Route 53.EnableHostedZoneDNSSEC",
                "rpc.service" = "Route 53",
                "rpc.method" = "EnableHostedZoneDNSSEC",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnableHostedZoneDNSSEC")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableHostedZoneDNSSEC")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnableHostedZoneDNSSECTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct EnableHostedZoneDNSSECTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableHostedZoneDNSSECTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnableHostedZoneDnssecInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableHostedZoneDNSSECResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_hosted_zone_dnssec::de_enable_hosted_zone_dnssec_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_enable_hosted_zone_dnssec::de_enable_hosted_zone_dnssec_http_response(status, headers, body, _cfg)
        };
