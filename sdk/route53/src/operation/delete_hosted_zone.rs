...
impl DeleteHostedZoneInput {
    /// Consumes the builder and constructs an Operation<[`DeleteHostedZone`](crate::operation::delete_hosted_zone::DeleteHostedZone)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_hosted_zone::DeleteHostedZone, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_hosted_zone::DeleteHostedZoneInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_hosted_zone::DeleteHostedZone::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteHostedZone", "route53"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteHostedZone {
                type Output = std::result::Result<crate::operation::delete_hosted_zone::DeleteHostedZoneOutput, crate::operation::delete_hosted_zone::DeleteHostedZoneError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_hosted_zone::de_delete_hosted_zone_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_hosted_zone::de_delete_hosted_zone_http_response(response)
                     }
                }
            }
