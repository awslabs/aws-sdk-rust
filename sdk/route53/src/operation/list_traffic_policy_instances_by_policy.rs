...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListTrafficPolicyInstancesByPolicyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListTrafficPolicyInstancesByPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_1 = inner_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("traffic_policy_id", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                ...
                let inner_2 = inner_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("traffic_policy_version", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListTrafficPolicyInstancesByPolicyEndpointParamsInterceptor {
