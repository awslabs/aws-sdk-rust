...
impl GetHealthCheckStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_health_check_status::GetHealthCheckStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_health_check_status::GetHealthCheckStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_health_check_status::GetHealthCheckStatusOutput, crate::operation::get_health_check_status::GetHealthCheckStatusError, Self> {
