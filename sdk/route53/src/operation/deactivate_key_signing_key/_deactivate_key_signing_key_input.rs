...
impl DeactivateKeySigningKeyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deactivate_key_signing_key::DeactivateKeySigningKeyInput, ::aws_smithy_types::error::operation::BuildError> {
