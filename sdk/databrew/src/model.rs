...
pub struct Rule  {
    ...
    #[doc(hidden)]pub check_expression: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub substitution_map: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub column_selectors: std::option::Option<std::vec::Vec<crate::model::ColumnSelector>>,
}
impl Rule {
    /// <p>The name of the rule.</p>
...
pub struct Threshold  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ThresholdType>,
    /// <p>Unit of threshold value. Can be either a COUNT or PERCENTAGE of the full sample size used for validation.</p>
    #[doc(hidden)]pub unit: std::option::Option<crate::model::ThresholdUnit>,
}
impl Threshold {
    /// <p>The value of a threshold.</p>
...
pub struct DatabaseOutput  {
    ...
    #[doc(hidden)]pub glue_connection_name: std::option::Option<std::string::String>,
    /// <p>Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.</p>
    #[doc(hidden)]pub database_options: std::option::Option<crate::model::DatabaseTableOutputOptions>,
    /// <p>The output mode to write into the database. Currently supported option: NEW_TABLE.</p>
    #[doc(hidden)]pub database_output_mode: std::option::Option<crate::model::DatabaseOutputMode>,
}
impl DatabaseOutput {
    /// <p>The Glue connection that stores the connection information for the target database.</p>
...
pub struct DatabaseTableOutputOptions  {
    ...
    #[doc(hidden)]pub temp_directory: std::option::Option<crate::model::S3Location>,
...
pub struct DataCatalogOutput  {
    ...
    #[doc(hidden)]pub s3_options: std::option::Option<crate::model::S3TableOutputOptions>,
    /// <p>Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.</p>
    #[doc(hidden)]pub database_options: std::option::Option<crate::model::DatabaseTableOutputOptions>,
...
pub struct S3TableOutputOptions  {
    ...
    #[doc(hidden)]pub location: std::option::Option<crate::model::S3Location>,
}
...
pub struct Output  {
    ...
    #[doc(hidden)]pub format: std::option::Option<crate::model::OutputFormat>,
    ...
    #[doc(hidden)]pub format_options: std::option::Option<crate::model::OutputFormatOptions>,
    ...
    #[doc(hidden)]pub max_output_files: std::option::Option<i32>,
}
impl Output {
    /// <p>The compression algorithm used to compress the output text of the job.</p>
...
pub struct OutputFormatOptions  {
    ...
    #[doc(hidden)]pub csv: std::option::Option<crate::model::CsvOutputOptions>,
}
...
pub struct RecipeStep  {
    ...
    #[doc(hidden)]pub action: std::option::Option<crate::model::RecipeAction>,
    ...
    /// </note>
    #[doc(hidden)]pub condition_expressions: std::option::Option<std::vec::Vec<crate::model::ConditionExpression>>,
}
impl RecipeStep {
    /// <p>The particular action to be performed in the recipe step.</p>
...
pub struct ConditionExpression  {
    ...
    #[doc(hidden)]pub target_column: std::option::Option<std::string::String>,
}
...
pub struct JobSample  {
    ...
    /// </ul>
    #[doc(hidden)]pub mode: std::option::Option<crate::model::SampleMode>,
...
pub struct ValidationConfiguration  {
    ...
    #[doc(hidden)]pub ruleset_arn: std::option::Option<std::string::String>,
    /// <p>Mode of data quality validation. Default mode is “CHECK_ALL” which verifies all rules defined in the selected ruleset.</p>
    #[doc(hidden)]pub validation_mode: std::option::Option<crate::model::ValidationMode>,
}
...
pub struct ProfileConfiguration  {
    ...
    #[doc(hidden)]pub dataset_statistics_configuration: std::option::Option<crate::model::StatisticsConfiguration>,
    ...
    #[doc(hidden)]pub profile_columns: std::option::Option<std::vec::Vec<crate::model::ColumnSelector>>,
    ...
    #[doc(hidden)]pub column_statistics_configurations: std::option::Option<std::vec::Vec<crate::model::ColumnStatisticsConfiguration>>,
    /// <p>Configuration of entity detection for a profile job. When undefined, entity detection is disabled.</p>
    #[doc(hidden)]pub entity_detector_configuration: std::option::Option<crate::model::EntityDetectorConfiguration>,
}
...
impl  std::fmt::Debug for ProfileConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("dataset_statistics_configuration", &self.dataset_statistics_configuration);
        formatter.field("profile_columns", &self.profile_columns);
        formatter.field("column_statistics_configurations", &self.column_statistics_configurations);
        formatter.field("entity_detector_configuration", &self.entity_detector_configuration);
        formatter.finish()
    }
}
...
pub struct EntityDetectorConfiguration  {
    ...
    #[doc(hidden)]pub entity_types: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub allowed_statistics: std::option::Option<std::vec::Vec<crate::model::AllowedStatistics>>,
}
...
pub struct AllowedStatistics  {
    ...
    #[doc(hidden)]pub statistics: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct ColumnStatisticsConfiguration  {
    ...
    #[doc(hidden)]pub selectors: std::option::Option<std::vec::Vec<crate::model::ColumnSelector>>,
    /// <p>Configuration for evaluations. Statistics can be used to select evaluations and override parameters of evaluations. </p>
    #[doc(hidden)]pub statistics: std::option::Option<crate::model::StatisticsConfiguration>,
}
...
pub struct StatisticsConfiguration  {
    ...
    #[doc(hidden)]pub included_statistics: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>List of overrides for evaluations.</p>
    #[doc(hidden)]pub overrides: std::option::Option<std::vec::Vec<crate::model::StatisticOverride>>,
}
...
pub struct StatisticOverride  {
    ...
    #[doc(hidden)]pub statistic: std::option::Option<std::string::String>,
...
pub struct PathOptions  {
    ...
    #[doc(hidden)]pub last_modified_date_condition: std::option::Option<crate::model::FilterExpression>,
    /// <p>If provided, this structure imposes a limit on a number of files that should be selected.</p>
    #[doc(hidden)]pub files_limit: std::option::Option<crate::model::FilesLimit>,
    /// <p>A structure that maps names of parameters used in the Amazon S3 path of a dataset to their definitions.</p>
    #[doc(hidden)]pub parameters: std::option::Option<std::collections::HashMap<std::string::String, crate::model::DatasetParameter>>,
}
impl PathOptions {
    /// <p>If provided, this structure defines a date range for matching Amazon S3 objects based on their LastModifiedDate attribute in Amazon S3.</p>
...
impl  std::fmt::Debug for PathOptions  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_modified_date_condition", &self.last_modified_date_condition);
...
pub struct DatasetParameter  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ParameterType>,
    /// <p>Additional parameter options such as a format and a timezone. Required for datetime parameters.</p>
    #[doc(hidden)]pub datetime_options: std::option::Option<crate::model::DatetimeOptions>,
    ...
    #[doc(hidden)]pub create_column: bool,
    /// <p>The optional filter expression structure to apply additional matching criteria to the parameter.</p>
    #[doc(hidden)]pub filter: std::option::Option<crate::model::FilterExpression>,
}
...
pub struct FilterExpression  {
    ...
    #[doc(hidden)]pub values_map: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct DatetimeOptions  {
    ...
    #[doc(hidden)]pub timezone_offset: std::option::Option<std::string::String>,
    /// <p>Optional value for a non-US locale code, needed for correct interpretation of some date formats.</p>
    #[doc(hidden)]pub locale_code: std::option::Option<std::string::String>,
}
...
pub struct FilesLimit  {
    ...
    #[doc(hidden)]pub ordered_by: std::option::Option<crate::model::OrderedBy>,
...
pub struct Input  {
    ...
    #[doc(hidden)]pub s3_input_definition: std::option::Option<crate::model::S3Location>,
    /// <p>The Glue Data Catalog parameters for the data.</p>
    #[doc(hidden)]pub data_catalog_input_definition: std::option::Option<crate::model::DataCatalogInputDefinition>,
    /// <p>Connection information for dataset input files stored in a database.</p>
    #[doc(hidden)]pub database_input_definition: std::option::Option<crate::model::DatabaseInputDefinition>,
    /// <p>Contains additional resource information needed for specific datasets.</p>
    #[doc(hidden)]pub metadata: std::option::Option<crate::model::Metadata>,
}
impl Input {
    /// <p>The Amazon S3 location where the data is stored.</p>
...
impl  std::fmt::Debug for Input  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("data_catalog_input_definition", &self.data_catalog_input_definition);
...
pub struct DatabaseInputDefinition  {
    ...
    #[doc(hidden)]pub database_table_name: std::option::Option<std::string::String>,
    /// <p>Represents an Amazon S3 location (bucket name, bucket owner, and object key) where DataBrew can read input data, or write output from a job.</p>
    #[doc(hidden)]pub temp_directory: std::option::Option<crate::model::S3Location>,
...
pub struct FormatOptions  {
    ...
    #[doc(hidden)]pub json: std::option::Option<crate::model::JsonOptions>,
    /// <p>Options that define how Excel input is to be interpreted by DataBrew.</p>
    #[doc(hidden)]pub excel: std::option::Option<crate::model::ExcelOptions>,
...
pub struct CsvOptions  {
    ...
    #[doc(hidden)]pub header_row: std::option::Option<bool>,
}
impl CsvOptions {
    /// <p>A single character that specifies the delimiter being used in the CSV file.</p>
    pub fn delimiter(&self) -> std::option::Option<& str> {
...
pub struct ExcelOptions  {
    ...
    #[doc(hidden)]pub sheet_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>One or more sheet numbers in the Excel file that will be included in the dataset.</p>
    #[doc(hidden)]pub sheet_indexes: std::option::Option<std::vec::Vec<i32>>,
    /// <p>A variable that specifies whether the first row in the file is parsed as the header. If this value is false, column names are auto-generated.</p>
    #[doc(hidden)]pub header_row: std::option::Option<bool>,
}
impl ExcelOptions {
...
pub struct JsonOptions  {
    ...
    #[doc(hidden)]pub multi_line: bool,
}
impl JsonOptions {
    /// <p>A value that specifies whether JSON input contains embedded new line characters.</p>
...
pub struct ViewFrame  {
    ...
    #[doc(hidden)]pub start_column_index: std::option::Option<i32>,
