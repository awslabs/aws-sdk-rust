...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the dataset to be described.</p><br>
    ...
    ///   - [`name(String)`](crate::operation::describe_dataset::DescribeDatasetOutput::name): <p>The name of the dataset.</p>
