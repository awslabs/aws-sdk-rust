...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_recipe::builders::CreateRecipeFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_recipe::builders::CreateRecipeFluentBuilder::set_tags): <p>Metadata tags to apply to this recipe.</p>
