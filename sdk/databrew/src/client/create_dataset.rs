...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_dataset::builders::CreateDatasetFluentBuilder::set_tags): <p>Metadata tags to apply to this dataset.</p>
