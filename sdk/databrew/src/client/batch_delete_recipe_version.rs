...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_recipe_version::builders::BatchDeleteRecipeVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::batch_delete_recipe_version::builders::BatchDeleteRecipeVersionFluentBuilder::set_name): <p>The name of the recipe whose versions are to be deleted.</p>
