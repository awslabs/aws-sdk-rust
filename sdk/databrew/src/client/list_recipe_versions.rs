...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_recipe_versions::builders::ListRecipeVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_recipe_versions::builders::ListRecipeVersionsFluentBuilder::set_next_token): <p>The token returned by a previous call to retrieve the next set of results.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::list_recipe_versions::builders::ListRecipeVersionsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_recipe_versions::builders::ListRecipeVersionsFluentBuilder::set_name): <p>The name of the recipe for which to return version information.</p>
