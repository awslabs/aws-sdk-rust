...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_name):<br>required: **true**<br><p>The name of the project to be deleted.</p><br>
                            /// - On success, responds with [`DeleteProjectOutput`](crate::operation::delete_project::DeleteProjectOutput) with field(s):
    ///   - [`name(String)`](crate::operation::delete_project::DeleteProjectOutput::name): <p>The name of the project that you deleted.</p>
