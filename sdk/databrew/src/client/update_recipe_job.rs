...
impl super::Client {
    ...
    ///   - [`encryption_key_arn(impl ::std::convert::Into<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::encryption_key_arn) / [`set_encryption_key_arn(Option<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::set_encryption_key_arn): <p>The Amazon Resource Name (ARN) of an encryption key that is used to protect the job.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::set_name): <p>The name of the job to update.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_recipe_job::builders::UpdateRecipeJobFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) of the Identity and Access Management (IAM) role to be assumed when DataBrew runs the job.</p>
