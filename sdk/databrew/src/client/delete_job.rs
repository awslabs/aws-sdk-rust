...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_job::builders::DeleteJobFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_job::builders::DeleteJobFluentBuilder::set_name):<br>required: **true**<br><p>The name of the job to be deleted.</p><br>
                            /// - On success, responds with [`DeleteJobOutput`](crate::operation::delete_job::DeleteJobOutput) with field(s):
    ///   - [`name(String)`](crate::operation::delete_job::DeleteJobOutput::name): <p>The name of the job that you deleted.</p>
