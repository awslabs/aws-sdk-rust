...
mod test {
    ...
    fn test_30() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew-fips.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_31() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew-fips.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_32() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_33() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_35() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew-fips.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_37() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_39() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew-fips.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
    ...
    fn test_41() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://databrew.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
