...
mod test {
    ...
    fn test_23() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://databrew-fips.us-iso-east-1.c2s.ic.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_24() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://databrew.us-iso-east-1.c2s.ic.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_30() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://databrew-fips.us-isob-east-1.sc2s.sgov.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_31() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://databrew.us-isob-east-1.sc2s.sgov.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_34() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://databrew-fips.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_35() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://databrew-fips.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_36() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://databrew.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_37() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://databrew.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
