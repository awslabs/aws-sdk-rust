...
//! offered by AWS Glue DataBrew. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Glue DataBrew.
...
/// For example, the [`BatchDeleteRecipeVersion`](crate::operation::batch_delete_recipe_version) operation has
...
/// Configuration for AWS Glue DataBrew.
pub mod config;
