    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/jobs/{Name}/startJobRun", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_job_run::StartJobRun::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartJobRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_job_run::de_start_job_run_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_job_run::de_start_job_run_http_response_with_props(
                status, headers, body,
            )
        }
    }
