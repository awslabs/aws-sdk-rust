...
impl PublishRecipeInput {
    /// Consumes the builder and constructs an Operation<[`PublishRecipe`](crate::operation::publish_recipe::PublishRecipe)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::publish_recipe::PublishRecipe, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_publish_recipe::ser_publish_recipe_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::publish_recipe::PublishRecipe::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishRecipe {
    type Output = ::std::result::Result<crate::operation::publish_recipe::PublishRecipeOutput, crate::operation::publish_recipe::PublishRecipeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_publish_recipe::de_publish_recipe_http_response_with_props(status, headers, body)
        }
    }
}
