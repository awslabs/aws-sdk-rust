...
impl ListJobRunsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::JobRun, ::aws_smithy_http::result::SdkError<crate::operation::list_job_runs::ListJobRunsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_job_runs_output_job_runs(page).unwrap_or_default().into_iter())
    }
}
