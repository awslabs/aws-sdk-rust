    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/projects/{Name}/startProjectSession", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_project_session::StartProjectSession::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_project_session::StartProjectSessionError
{
