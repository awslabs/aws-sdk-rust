...
impl DeleteDatasetOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_dataset::DeleteDatasetOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_dataset::DeleteDatasetOutput {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building DeleteDatasetOutput")
                    )?
                ,
