...
impl CreateProject {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DataBrew", "CreateProject", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateProject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateProject", "DataBrew"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateProjectTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("RecipeName") {
            if let ::std::option::Option::Some(value) = input.recipe_name.as_deref() {
                captured.insert("RecipeName", value);
            }
        }
