...
impl DeleteRecipeVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_recipe_version::DeleteRecipeVersion,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRecipeVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_recipe_version::de_delete_recipe_version_http_response_with_props(status, headers, body)
        }
    }
}
