...
impl CreateRulesetInput {
    /// Consumes the builder and constructs an Operation<[`CreateRuleset`](crate::operation::create_ruleset::CreateRuleset)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_ruleset::CreateRuleset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ruleset::ser_create_ruleset_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_ruleset::CreateRuleset::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRuleset {
    type Output = ::std::result::Result<crate::operation::create_ruleset::CreateRulesetOutput, crate::operation::create_ruleset::CreateRulesetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ruleset::de_create_ruleset_http_response_with_props(status, headers, body)
        }
    }
}
