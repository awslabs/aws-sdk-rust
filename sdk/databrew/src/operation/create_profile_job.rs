...
impl CreateProfileJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_profile_job::ser_create_profile_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProfileJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_profile_job::de_create_profile_job_http_response_with_props(status, headers, body)
        }
    }
}
