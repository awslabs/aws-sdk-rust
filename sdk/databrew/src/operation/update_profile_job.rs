...
impl UpdateProfileJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_profile_job::ser_update_profile_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProfileJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_profile_job::de_update_profile_job_http_response_with_props(status, headers, body)
        }
    }
}
