...
impl UpdateRecipeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_recipe::UpdateRecipe, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_recipe::ser_update_recipe_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_recipe::de_update_recipe_http_response_with_props(status, headers, body)
        }
    }
}
