...
impl SendProjectSessionActionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_project_session_action::SendProjectSessionAction::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendProjectSessionAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_project_session_action::de_send_project_session_action_http_response_with_props(status, headers, body)
        }
    }
}
