...
pub(crate) fn de_recipe_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Recipe>>, aws_smithy_json::deserialize::error::DeserializeError>
