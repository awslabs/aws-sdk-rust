...
pub fn ser_database_input_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatabaseInputDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_database_input_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DatabaseInputDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
