                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "FormatOptions" => {
                                builder = builder.set_format_options(
                                    crate::protocol_serde::shape_format_options::de_format_options(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "Source" => {
                                builder = builder.set_source(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::Source::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            "PathOptions" => {
                                builder = builder.set_path_options(
                                    crate::protocol_serde::shape_path_options::de_path_options(
                                        tokens,
                                    )?,
                                );
                            }
