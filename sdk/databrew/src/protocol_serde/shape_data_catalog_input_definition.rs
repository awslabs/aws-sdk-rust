...
pub fn ser_data_catalog_input_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataCatalogInputDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_catalog_input_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataCatalogInputDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
