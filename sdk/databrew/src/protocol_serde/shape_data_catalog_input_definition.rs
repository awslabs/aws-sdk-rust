...
pub(crate) fn de_data_catalog_input_definition<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DataCatalogInputDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TempDirectory" => {
                            builder = builder.set_temp_directory(crate::protocol_serde::shape_s3_location::de_s3_location(tokens, _value)?);
                        }
