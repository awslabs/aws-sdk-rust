...
) -> Result<Option<crate::types::JobRun>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "State" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::JobRunState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LogSubscription" => {
                            builder = builder.set_log_subscription(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LogSubscription::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LogGroupName" => {
                        ...
                        "DatabaseOutputs" => {
                            builder =
                                builder.set_database_outputs(crate::protocol_serde::shape_database_output_list::de_database_output_list(tokens)?);
                        }
                        "RecipeReference" => {
