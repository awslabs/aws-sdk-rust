...
pub fn ser_send_project_session_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendProjectSessionActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
