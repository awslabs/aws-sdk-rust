...
pub fn ser_update_recipe_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRecipeJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
