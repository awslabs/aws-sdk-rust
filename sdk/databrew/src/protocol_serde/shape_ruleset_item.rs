...
pub(crate) fn de_ruleset_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RulesetItem>, aws_smithy_json::deserialize::error::DeserializeError>
