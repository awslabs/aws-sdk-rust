...
pub fn de_describe_job_run_http_response(
    ...
    Ok({
        ...
        crate::serde_util::describe_job_run_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_job_run::DescribeJobRunError::unhandled)?
    })
}
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ValidationConfigurations" => {
                        builder = builder.set_validation_configurations(
                            crate::protocol_serde::shape_validation_configuration_list::de_validation_configuration_list(tokens, _value, depth + 1)?,
                        );
                    }
