            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_validation_exception::de_validation_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteJobError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_delete_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteJobOutput, crate::error::DeleteJobError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_job::de_delete_job(response.body().as_ref(), output).map_err(crate::error::DeleteJobError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_job(value: &[u8], mut builder: crate::output::delete_job_output::Builder) -> Result<crate::output::delete_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
