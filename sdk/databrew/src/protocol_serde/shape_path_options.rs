...
pub fn ser_path_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PathOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_path_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PathOptions>, aws_smithy_json::deserialize::error::DeserializeError>
