...
pub fn ser_excel_options(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::ExcelOptions,
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "SheetNames" => {
                            builder = builder.set_sheet_names(crate::protocol_serde::shape_sheet_name_list::de_sheet_name_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "SheetIndexes" => {
                            builder = builder.set_sheet_indexes(crate::protocol_serde::shape_sheet_index_list::de_sheet_index_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
