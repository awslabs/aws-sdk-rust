...
pub fn ser_recipe_step(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RecipeStep) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_recipe_step<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RecipeStep>, aws_smithy_json::deserialize::error::DeserializeError>
