...
pub fn ser_column_statistics_configuration(
...
pub(crate) fn de_column_statistics_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ColumnStatisticsConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Selectors" => {
                            builder = builder.set_selectors(crate::protocol_serde::shape_column_selector_list::de_column_selector_list(
                                tokens, _value,
                            )?);
                        }
                        "Statistics" => {
            ...
            Ok(Some(crate::serde_util::column_statistics_configuration_correct_errors(builder).build()))
        }
