...
pub fn ser_column_statistics_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ColumnStatisticsConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_column_statistics_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ColumnStatisticsConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
