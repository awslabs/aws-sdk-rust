...
pub fn ser_create_profile_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProfileJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
