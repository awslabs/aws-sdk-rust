...
pub fn ser_create_recipe_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRecipeJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
