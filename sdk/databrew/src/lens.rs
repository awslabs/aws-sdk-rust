...
pub(crate) fn reflens_structure_crate_output_list_recipe_versions_output_next_token(
    input: &crate::output::ListRecipeVersionsOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn reflens_structure_crate_output_list_rulesets_output_next_token(
    input: &crate::output::ListRulesetsOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn lens_structure_crate_output_list_recipes_output_recipes(
    input: crate::output::ListRecipesOutput,
) -> std::option::Option<std::vec::Vec<crate::model::Recipe>> {
...
pub(crate) fn lens_structure_crate_output_list_recipe_versions_output_recipes(
    input: crate::output::ListRecipeVersionsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::Recipe>> {
    let input = match input.recipes {
        None => return None,
...
pub(crate) fn lens_structure_crate_output_list_rulesets_output_rulesets(
    input: crate::output::ListRulesetsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::RulesetItem>> {
...
pub(crate) fn lens_structure_crate_output_list_schedules_output_schedules(
    input: crate::output::ListSchedulesOutput,
) -> std::option::Option<std::vec::Vec<crate::model::Schedule>> {
