...
pub struct StopJobRunOutput  {
    ...
    #[doc(hidden)]pub run_id: std::option::Option<std::string::String>,
}
...
pub struct StartProjectSessionOutput  {
    ...
    #[doc(hidden)]pub client_session_id: std::option::Option<std::string::String>,
}
...
pub struct ListSchedulesOutput  {
    ...
    #[doc(hidden)]pub schedules: std::option::Option<std::vec::Vec<crate::model::Schedule>>,
...
pub struct ListRulesetsOutput  {
    ...
    #[doc(hidden)]pub rulesets: std::option::Option<std::vec::Vec<crate::model::RulesetItem>>,
    /// <p>A token that you can use in a subsequent call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_rulesets_output {
    ...
    impl Builder {
        ...
        /// <p>A list of RulesetItem. RulesetItem contains meta data of a ruleset.</p>
        pub fn set_rulesets(mut self, input: std::option::Option<std::vec::Vec<crate::model::RulesetItem>>) -> Self {
...
pub struct ListRecipeVersionsOutput  {
    ...
    #[doc(hidden)]pub recipes: std::option::Option<std::vec::Vec<crate::model::Recipe>>,
}
...
pub mod list_recipe_versions_output {
    ...
    impl Builder {
        ...
        /// <p>A list of versions for the specified recipe.</p>
        pub fn set_recipes(mut self, input: std::option::Option<std::vec::Vec<crate::model::Recipe>>) -> Self {
...
pub struct ListProjectsOutput  {
    ...
    #[doc(hidden)]pub projects: std::option::Option<std::vec::Vec<crate::model::Project>>,
    /// <p>A token that you can use in a subsequent call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListJobsOutput  {
    ...
    #[doc(hidden)]pub jobs: std::option::Option<std::vec::Vec<crate::model::Job>>,
    /// <p>A token that you can use in a subsequent call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListJobsOutput {
...
pub struct ListJobRunsOutput  {
    ...
    #[doc(hidden)]pub job_runs: std::option::Option<std::vec::Vec<crate::model::JobRun>>,
    /// <p>A token that you can use in a subsequent call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDatasetsOutput  {
    ...
    #[doc(hidden)]pub datasets: std::option::Option<std::vec::Vec<crate::model::Dataset>>,
    /// <p>A token that you can use in a subsequent call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_datasets_output {
    ...
    impl Builder {
        ...
        /// <p>A list of datasets that are defined.</p>
        pub fn set_datasets(mut self, input: std::option::Option<std::vec::Vec<crate::model::Dataset>>) -> Self {
...
pub struct DescribeScheduleOutput  {
    ...
    #[doc(hidden)]pub create_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub job_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The identifier (user name) of the user who last modified the schedule.</p>
    #[doc(hidden)]pub last_modified_by: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cron_expression: std::option::Option<std::string::String>,
...
pub struct DescribeRecipeOutput  {
    ...
    #[doc(hidden)]pub published_by: std::option::Option<std::string::String>,
    /// <p>The date and time when the recipe was last published.</p>
    #[doc(hidden)]pub published_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::RecipeStep>>,
    /// <p>Metadata tags associated with this project.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The ARN of the recipe.</p>
    #[doc(hidden)]pub resource_arn: std::option::Option<std::string::String>,
    /// <p>The recipe version identifier.</p>
    #[doc(hidden)]pub recipe_version: std::option::Option<std::string::String>,
}
...
pub struct DescribeProjectOutput  {
    ...
    #[doc(hidden)]pub recipe_name: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the project.</p>
    #[doc(hidden)]pub resource_arn: std::option::Option<std::string::String>,
    /// <p>Represents the sample size and sampling type for DataBrew to use for interactive data analysis.</p>
    #[doc(hidden)]pub sample: std::option::Option<crate::model::Sample>,
    ...
    /// </ul>
    #[doc(hidden)]pub session_status: std::option::Option<crate::model::SessionStatus>,
    /// <p>The identifier (user name) of the user that opened the project for use. </p>
    #[doc(hidden)]pub opened_by: std::option::Option<std::string::String>,
    /// <p>The date and time when the project was opened. </p>
    #[doc(hidden)]pub open_date: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub mod describe_project_output {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>ASSIGNED</code> - the session is ready for use.</p> </li> 
        /// </ul>
        pub fn set_session_status(mut self, input: std::option::Option<crate::model::SessionStatus>) -> Self {
...
pub struct DescribeJobRunOutput  {
    ...
    #[doc(hidden)]pub attempt: i32,
    /// <p>The date and time when the job completed processing.</p>
    #[doc(hidden)]pub completed_on: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub execution_time: i32,
    ...
    #[doc(hidden)]pub profile_configuration: std::option::Option<crate::model::ProfileConfiguration>,
    /// <p>List of validation configurations that are applied to the profile job.</p>
    #[doc(hidden)]pub validation_configurations: std::option::Option<std::vec::Vec<crate::model::ValidationConfiguration>>,
    /// <p>The unique identifier of the job run.</p>
    #[doc(hidden)]pub run_id: std::option::Option<std::string::String>,
    /// <p>The current state of the job run entity itself.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::JobRunState>,
    /// <p>The current status of Amazon CloudWatch logging for the job run.</p>
    #[doc(hidden)]pub log_subscription: std::option::Option<crate::model::LogSubscription>,
    ...
    #[doc(hidden)]pub data_catalog_outputs: std::option::Option<std::vec::Vec<crate::model::DataCatalogOutput>>,
    ...
    #[doc(hidden)]pub database_outputs: std::option::Option<std::vec::Vec<crate::model::DatabaseOutput>>,
    /// <p>Represents the name and version of a DataBrew recipe.</p>
    #[doc(hidden)]pub recipe_reference: std::option::Option<crate::model::RecipeReference>,
    ...
    #[doc(hidden)]pub started_on: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub job_sample: std::option::Option<crate::model::JobSample>,
}
impl DescribeJobRunOutput {
    ...
    /// <p>Configuration for profile jobs. Used to select columns, do evaluations, and override default parameters of evaluations. When configuration is null, the profile job will run with default settings.</p>
    pub fn profile_configuration(&self) -> std::option::Option<& crate::model::ProfileConfiguration> {
...
pub mod describe_job_run_output {
    ...
    impl Builder {
        ...
        /// <p>Configuration for profile jobs. Used to select columns, do evaluations, and override default parameters of evaluations. When configuration is null, the profile job will run with default settings.</p>
        pub fn set_profile_configuration(mut self, input: std::option::Option<crate::model::ProfileConfiguration>) -> Self {
...
pub struct DescribeJobOutput  {
    ...
    #[doc(hidden)]pub encryption_key_arn: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub encryption_mode: std::option::Option<crate::model::EncryptionMode>,
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::JobType>,
    ...
    #[doc(hidden)]pub max_capacity: i32,
    /// <p>The maximum number of times to retry the job after a job run fails.</p>
    #[doc(hidden)]pub max_retries: i32,
...
pub struct DescribeDatasetOutput  {
    ...
    #[doc(hidden)]pub format: std::option::Option<crate::model::InputFormat>,
    /// <p>Represents a set of options that define the structure of either comma-separated value (CSV), Excel, or JSON input.</p>
    #[doc(hidden)]pub format_options: std::option::Option<crate::model::FormatOptions>,
    ...
    #[doc(hidden)]pub path_options: std::option::Option<crate::model::PathOptions>,
...
pub struct BatchDeleteRecipeVersionOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::RecipeVersionErrorDetail>>,
}
...
pub mod batch_delete_recipe_version_output {
    ...
    pub struct Builder {
        pub(crate) name: std::option::Option<std::string::String>,
        pub(crate) errors: std::option::Option<std::vec::Vec<crate::model::RecipeVersionErrorDetail>>,
    }
    impl Builder {
        /// <p>The name of the recipe that was modified.</p>
        pub fn name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Errors, if any, that occurred while attempting to delete the recipe versions.</p>
        pub fn set_errors(mut self, input: std::option::Option<std::vec::Vec<crate::model::RecipeVersionErrorDetail>>) -> Self {
