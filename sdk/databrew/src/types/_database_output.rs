...
impl DatabaseOutput {
    ...
    pub fn database_options(
        &self,
    ) -> ::std::option::Option<&crate::types::DatabaseTableOutputOptions> {
...
impl DatabaseOutputBuilder {
    ...
    pub fn set_database_options(
        mut self,
        input: ::std::option::Option<crate::types::DatabaseTableOutputOptions>,
    ) -> Self {
        self.database_options = input;
        self
    }
    /// <p>Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.</p>
    pub fn get_database_options(
        &self,
    ) -> &::std::option::Option<crate::types::DatabaseTableOutputOptions> {
    ...
    pub fn set_database_output_mode(
        mut self,
        input: ::std::option::Option<crate::types::DatabaseOutputMode>,
    ) -> Self {
        self.database_output_mode = input;
        self
    }
    /// <p>The output mode to write into the database. Currently supported option: NEW_TABLE.</p>
    pub fn get_database_output_mode(
        &self,
    ) -> &::std::option::Option<crate::types::DatabaseOutputMode> {
