...
//! ```
use aws_sdk_ecr::{config, Client};
/// Smoke tests for the `describe_repositories` operation
#[::tokio::test]
async fn test_describe_repositories_success() {
...
/// Smoke tests for the `list_images` operation
#[::tokio::test]
async fn test_list_images_failure() {
    ...
    let res = client
        .list_images()
        .set_repository_name(::std::option::Option::Some("not-a-real-repository".to_owned()))
        .send()
        .await;
