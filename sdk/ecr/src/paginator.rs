...
/// Paginator for [`DescribeImageScanFindings`](crate::operation::DescribeImageScanFindings)
            ...
            impl DescribeImageScanFindingsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::describe_image_scan_findings_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::DescribeImageScanFindingsOutput, aws_smithy_http::result::SdkError<crate::error::DescribeImageScanFindingsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`DescribePullThroughCacheRules`](crate::operation::DescribePullThroughCacheRules)
            ...
            impl DescribePullThroughCacheRulesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::describe_pull_through_cache_rules_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::DescribePullThroughCacheRulesOutput, aws_smithy_http::result::SdkError<crate::error::DescribePullThroughCacheRulesError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`GetLifecyclePolicyPreview`](crate::operation::GetLifecyclePolicyPreview)
            ...
            impl GetLifecyclePolicyPreviewPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::get_lifecycle_policy_preview_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::GetLifecyclePolicyPreviewOutput, aws_smithy_http::result::SdkError<crate::error::GetLifecyclePolicyPreviewError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `GetLifecyclePolicyPreviewPaginator`
                ...
                impl  GetLifecyclePolicyPreviewPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::LifecyclePolicyPreviewResult, aws_smithy_http::result::SdkError<crate::error::GetLifecyclePolicyPreviewError>>> + Unpin
                     {
...
/// Flattened paginator for `ListImagesPaginator`
                ...
                impl  ListImagesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ImageIdentifier, aws_smithy_http::result::SdkError<crate::error::ListImagesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_images_output_image_ids(page).unwrap_or_default().into_iter())
                    }
                }
