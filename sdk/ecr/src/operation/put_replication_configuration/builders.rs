...
impl PutReplicationConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_replication_configuration::PutReplicationConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_replication_configuration::PutReplicationConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_replication_configuration::PutReplicationConfigurationOutput, crate::operation::put_replication_configuration::PutReplicationConfigurationError, Self> {
