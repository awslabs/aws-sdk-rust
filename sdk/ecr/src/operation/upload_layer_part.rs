...
impl UploadLayerPartInput {
    /// Consumes the builder and constructs an Operation<[`UploadLayerPart`](crate::operation::upload_layer_part::UploadLayerPart)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::upload_layer_part::UploadLayerPart, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_upload_layer_part::ser_upload_layer_part_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upload_layer_part::UploadLayerPart::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadLayerPart {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_upload_layer_part::de_upload_layer_part_http_response_with_props(status, headers, body)
        }
    }
}
