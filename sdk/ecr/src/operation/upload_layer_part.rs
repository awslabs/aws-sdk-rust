...
impl UploadLayerPartInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upload_layer_part::UploadLayerPart, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_layer_part::UploadLayerPartInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_layer_part::ser_upload_layer_part_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for UploadLayerPart {
                type Output = std::result::Result<crate::operation::upload_layer_part::UploadLayerPartOutput, crate::operation::upload_layer_part::UploadLayerPartError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_upload_layer_part::de_upload_layer_part_http_error(response)
                     } else {
                        crate::protocol_serde::shape_upload_layer_part::de_upload_layer_part_http_response(response)
                     }
                }
            }
