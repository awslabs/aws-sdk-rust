...
impl DeleteRegistryPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRegistryPolicy`](crate::operation::delete_registry_policy::DeleteRegistryPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_registry_policy::DeleteRegistryPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_registry_policy::DeleteRegistryPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_registry_policy::ser_delete_registry_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_registry_policy::DeleteRegistryPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRegistryPolicy {
                type Output = std::result::Result<crate::operation::delete_registry_policy::DeleteRegistryPolicyOutput, crate::operation::delete_registry_policy::DeleteRegistryPolicyError>;
