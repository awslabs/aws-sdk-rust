...
impl PutRegistryPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_registry_policy::PutRegistryPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_registry_policy::PutRegistryPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_registry_policy::PutRegistryPolicyOutput, crate::operation::put_registry_policy::PutRegistryPolicyError, Self> {
