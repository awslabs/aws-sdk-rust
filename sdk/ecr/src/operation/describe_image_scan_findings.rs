...
impl DescribeImageScanFindingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_image_scan_findings::DescribeImageScanFindings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImageScanFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_image_scan_findings::de_describe_image_scan_findings_http_response_with_props(status, headers, body)
        }
    }
}
