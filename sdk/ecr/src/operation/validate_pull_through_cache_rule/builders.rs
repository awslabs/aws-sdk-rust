...
impl ValidatePullThroughCacheRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleOutput, crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleError, Self> {
