...
impl GetRegistryPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetRegistryPolicy`](crate::operation::get_registry_policy::GetRegistryPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_registry_policy::GetRegistryPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_registry_policy::GetRegistryPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_registry_policy::ser_get_registry_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_registry_policy::GetRegistryPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRegistryPolicy {
                type Output = std::result::Result<crate::operation::get_registry_policy::GetRegistryPolicyOutput, crate::operation::get_registry_policy::GetRegistryPolicyError>;
