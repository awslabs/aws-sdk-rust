...
impl GetRegistryPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_registry_policy::ser_get_registry_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRegistryPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_registry_policy::de_get_registry_policy_http_response_with_props(status, headers, body)
        }
    }
}
