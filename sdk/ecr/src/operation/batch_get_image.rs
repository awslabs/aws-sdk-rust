...
impl BatchGetImageInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_image::BatchGetImage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetImage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_get_image::de_batch_get_image_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_get_image::de_batch_get_image_http_response(
                status, headers, body,
            )
        }
    }
