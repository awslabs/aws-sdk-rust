...
impl StartLifecyclePolicyPreview {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartLifecyclePolicyPreview {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartLifecyclePolicyPreview");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartLifecyclePolicyPreviewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartLifecyclePolicyPreviewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartLifecyclePolicyPreview")
...
.with_interceptor(StartLifecyclePolicyPreviewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError>::new());
...
#[derive(Debug)]
            struct StartLifecyclePolicyPreviewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartLifecyclePolicyPreviewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_lifecycle_policy_preview::de_start_lifecycle_policy_preview_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StartLifecyclePolicyPreviewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartLifecyclePolicyPreviewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_lifecycle_policy_preview::ser_start_lifecycle_policy_preview_input(&input)?);
...
#[derive(Debug)]
            struct StartLifecyclePolicyPreviewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartLifecyclePolicyPreviewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartLifecyclePolicyPreviewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartLifecyclePolicyPreviewInput>()
                        .ok_or("failed to downcast to StartLifecyclePolicyPreviewInput")?;
...
pub enum StartLifecyclePolicyPreviewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartLifecyclePolicyPreviewError) for what information is available for the error.")]
...
impl StartLifecyclePolicyPreviewError {
    /// Creates the `StartLifecyclePolicyPreviewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartLifecyclePolicyPreviewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::LifecyclePolicyNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::LifecyclePolicyPreviewInProgressException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `StartLifecyclePolicyPreviewError::ValidationException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartLifecyclePolicyPreviewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewError {
