...
impl SetRepositoryPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_repository_policy::SetRepositoryPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_repository_policy::SetRepositoryPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_repository_policy::SetRepositoryPolicyOutput, crate::operation::set_repository_policy::SetRepositoryPolicyError, Self> {
