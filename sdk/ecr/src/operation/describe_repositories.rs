...
impl DescribeRepositoriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_repositories::ser_describe_repositories_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_repositories::DescribeRepositories::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_repositories::DescribeRepositoriesError
{
