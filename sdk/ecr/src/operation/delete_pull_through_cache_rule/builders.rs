...
impl crate::operation::delete_pull_through_cache_rule::builders::DeletePullThroughCacheRuleInputBuilder {
...
impl DeletePullThroughCacheRuleFluentBuilder {
    /// Creates a new `DeletePullThroughCacheRuleFluentBuilder`.
