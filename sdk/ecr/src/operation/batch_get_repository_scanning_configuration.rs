...
impl BatchGetRepositoryScanningConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetRepositoryScanningConfiguration`](crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_repository_scanning_configuration::ser_batch_get_repository_scanning_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetRepositoryScanningConfiguration {
    type Output = ::std::result::Result<crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfigurationOutput, crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfigurationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_repository_scanning_configuration::de_batch_get_repository_scanning_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_repository_scanning_configuration::BatchGetRepositoryScanningConfigurationError {
