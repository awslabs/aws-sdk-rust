...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRegistryScanningConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_registry_scanning_configuration::de_put_registry_scanning_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfigurationError
{
