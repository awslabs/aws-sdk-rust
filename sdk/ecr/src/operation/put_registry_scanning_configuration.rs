...
impl PutRegistryScanningConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutRegistryScanningConfiguration`](crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_registry_scanning_configuration::ser_put_registry_scanning_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutRegistryScanningConfiguration {
                type Output = std::result::Result<crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfigurationOutput, crate::operation::put_registry_scanning_configuration::PutRegistryScanningConfigurationError>;
