...
impl PutReplicationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_replication_configuration::PutReplicationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutReplicationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_replication_configuration::de_put_replication_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PutReplicationConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_replication_configuration::PutReplicationConfigurationError
{
