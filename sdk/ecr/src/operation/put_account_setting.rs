...
impl PutAccountSetting {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ecr", "PutAccountSetting", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAccountSetting {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutAccountSetting", "ecr"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonEC2ContainerRegistry_V20150921.PutAccountSetting",
            );
            builder
        };
...
impl PutAccountSettingError {
    ...
    /// Returns `true` if the error kind is `PutAccountSettingError::LimitExceededException`.
    ...
    /// Returns `true` if the error kind is `PutAccountSettingError::ValidationException`.
