...
impl GetDownloadUrlForLayer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECR", "GetDownloadUrlForLayer", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECR.GetDownloadUrlForLayer",
                "rpc.service" = "ECR",
                "rpc.method" = "GetDownloadUrlForLayer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDownloadUrlForLayer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDownloadUrlForLayerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDownloadUrlForLayerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDownloadUrlForLayer")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDownloadUrlForLayer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetDownloadUrlForLayerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetDownloadUrlForLayerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDownloadUrlForLayerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetDownloadUrlForLayerInput>() else {
        ...
        if requested.should_capture("layerDigest") {
            if let ::std::option::Option::Some(value) = input.layer_digest.as_deref() {
                captured.insert("layerDigest", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDownloadUrlForLayerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_download_url_for_layer::de_get_download_url_for_layer_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_download_url_for_layer::de_get_download_url_for_layer_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDownloadUrlForLayerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_download_url_for_layer::ser_get_download_url_for_layer_input(&input)?,
        );
...
impl ::std::error::Error for GetDownloadUrlForLayerError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::LayerInaccessibleException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDownloadUrlForLayerError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::LayerInaccessibleException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
