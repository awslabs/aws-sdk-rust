...
/// Orchestration and serialization glue logic for `GetDownloadUrlForLayer`.
...
impl GetDownloadUrlForLayer {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDownloadUrlForLayer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDownloadUrlForLayer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDownloadUrlForLayerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDownloadUrlForLayerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDownloadUrlForLayer")
...
.with_interceptor(GetDownloadUrlForLayerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>::new());
...
#[derive(Debug)]
            struct GetDownloadUrlForLayerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDownloadUrlForLayerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_download_url_for_layer::de_get_download_url_for_layer_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDownloadUrlForLayerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDownloadUrlForLayerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_download_url_for_layer::ser_get_download_url_for_layer_input(&input)?);
...
#[derive(Debug)]
            struct GetDownloadUrlForLayerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDownloadUrlForLayerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDownloadUrlForLayerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDownloadUrlForLayerInput>()
                        .ok_or("failed to downcast to GetDownloadUrlForLayerInput")?;
...
pub enum GetDownloadUrlForLayerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDownloadUrlForLayerError) for what information is available for the error.")]
...
impl GetDownloadUrlForLayerError {
    /// Creates the `GetDownloadUrlForLayerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDownloadUrlForLayerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::LayerInaccessibleException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for GetDownloadUrlForLayerError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::UnableToGetUpstreamLayerException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDownloadUrlForLayerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_download_url_for_layer::_get_download_url_for_layer_output::GetDownloadUrlForLayerOutput;

pub use crate::operation::get_download_url_for_layer::_get_download_url_for_layer_input::GetDownloadUrlForLayerInput;

mod _get_download_url_for_layer_input;

mod _get_download_url_for_layer_output;
