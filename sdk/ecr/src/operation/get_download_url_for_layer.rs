...
impl GetDownloadUrlForLayerInput {
    /// Consumes the builder and constructs an Operation<[`GetDownloadUrlForLayer`](crate::operation::get_download_url_for_layer::GetDownloadUrlForLayer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_download_url_for_layer::ser_get_download_url_for_layer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_download_url_for_layer::GetDownloadUrlForLayer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDownloadUrlForLayer {
                type Output = std::result::Result<crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerOutput, crate::operation::get_download_url_for_layer::GetDownloadUrlForLayerError>;
