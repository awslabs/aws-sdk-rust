...
impl DescribeImageReplicationStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_image_replication_status::DescribeImageReplicationStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImageReplicationStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_image_replication_status::de_describe_image_replication_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
