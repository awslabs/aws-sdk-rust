...
impl crate::operation::describe_image_replication_status::builders::DescribeImageReplicationStatusInputBuilder {
...
impl DescribeImageReplicationStatusFluentBuilder {
    /// Creates a new `DescribeImageReplicationStatusFluentBuilder`.
