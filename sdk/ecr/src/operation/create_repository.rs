...
impl CreateRepositoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_repository::CreateRepository, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_repository::ser_create_repository_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_repository::de_create_repository_http_response_with_props(status, headers, body)
        }
    }
}
