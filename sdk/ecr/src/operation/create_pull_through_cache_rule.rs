...
impl CreatePullThroughCacheRuleInput {
    /// Consumes the builder and constructs an Operation<[`CreatePullThroughCacheRule`](crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_pull_through_cache_rule::ser_create_pull_through_cache_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePullThroughCacheRule {
                type Output = std::result::Result<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleOutput, crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError>;
