...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePullThroughCacheRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_pull_through_cache_rule::de_create_pull_through_cache_rule_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError
{
