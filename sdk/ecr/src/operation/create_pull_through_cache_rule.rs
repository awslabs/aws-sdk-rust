...
/// Orchestration and serialization glue logic for `CreatePullThroughCacheRule`.
...
impl CreatePullThroughCacheRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePullThroughCacheRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreatePullThroughCacheRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreatePullThroughCacheRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreatePullThroughCacheRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePullThroughCacheRule")
...
.with_interceptor(CreatePullThroughCacheRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError>::new());
...
#[derive(Debug)]
            struct CreatePullThroughCacheRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePullThroughCacheRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_pull_through_cache_rule::de_create_pull_through_cache_rule_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreatePullThroughCacheRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePullThroughCacheRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_pull_through_cache_rule::ser_create_pull_through_cache_rule_input(&input)?);
...
#[derive(Debug)]
            struct CreatePullThroughCacheRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePullThroughCacheRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreatePullThroughCacheRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreatePullThroughCacheRuleInput>()
                        .ok_or("failed to downcast to CreatePullThroughCacheRuleInput")?;
...
pub enum CreatePullThroughCacheRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreatePullThroughCacheRuleError) for what information is available for the error.")]
...
impl CreatePullThroughCacheRuleError {
    /// Creates the `CreatePullThroughCacheRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePullThroughCacheRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for CreatePullThroughCacheRuleError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::SecretNotFoundException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::ServerException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::UnableToAccessSecretException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::UnableToDecryptSecretValueException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreatePullThroughCacheRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleError {
...
mod _create_pull_through_cache_rule_output;
