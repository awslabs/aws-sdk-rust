...
impl DeletePullThroughCacheRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeletePullThroughCacheRule`](crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_pull_through_cache_rule::ser_delete_pull_through_cache_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePullThroughCacheRule {
                type Output = std::result::Result<crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRuleOutput, crate::operation::delete_pull_through_cache_rule::DeletePullThroughCacheRuleError>;
