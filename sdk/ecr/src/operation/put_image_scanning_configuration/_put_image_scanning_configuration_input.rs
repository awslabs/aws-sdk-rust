...
impl PutImageScanningConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_image_scanning_configuration::PutImageScanningConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
