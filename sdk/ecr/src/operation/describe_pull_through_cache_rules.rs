...
impl DescribePullThroughCacheRulesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePullThroughCacheRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_pull_through_cache_rules::de_describe_pull_through_cache_rules_http_response_with_props(
                status, headers, body,
            )
        }
    }
