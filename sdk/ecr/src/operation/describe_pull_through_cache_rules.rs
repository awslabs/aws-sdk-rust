...
impl DescribePullThroughCacheRulesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePullThroughCacheRules`](crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_pull_through_cache_rules::ser_describe_pull_through_cache_rules_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRules::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePullThroughCacheRules {
                type Output = std::result::Result<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesOutput, crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError>;
