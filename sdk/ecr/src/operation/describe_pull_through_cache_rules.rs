...
impl DescribePullThroughCacheRules {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePullThroughCacheRules {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribePullThroughCacheRules");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribePullThroughCacheRulesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribePullThroughCacheRulesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePullThroughCacheRules")
...
.with_interceptor(DescribePullThroughCacheRulesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError>::new());
...
#[derive(Debug)]
            struct DescribePullThroughCacheRulesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePullThroughCacheRulesResponseDeserializer {
...
#[derive(Debug)]
            struct DescribePullThroughCacheRulesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePullThroughCacheRulesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_pull_through_cache_rules::ser_describe_pull_through_cache_rules_input(&input)?);
...
#[derive(Debug)]
            struct DescribePullThroughCacheRulesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribePullThroughCacheRulesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribePullThroughCacheRulesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribePullThroughCacheRulesInput>()
                        .ok_or("failed to downcast to DescribePullThroughCacheRulesInput")?;
...
pub enum DescribePullThroughCacheRulesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribePullThroughCacheRulesError) for what information is available for the error.")]
...
impl DescribePullThroughCacheRulesError {
    /// Creates the `DescribePullThroughCacheRulesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribePullThroughCacheRulesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PullThroughCacheRuleNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribePullThroughCacheRulesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_pull_through_cache_rules::DescribePullThroughCacheRulesError {
...
mod _describe_pull_through_cache_rules_output;
