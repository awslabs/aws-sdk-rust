...
impl InitiateLayerUpload {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::initiate_layer_upload::InitiateLayerUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::initiate_layer_upload::InitiateLayerUploadOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECR", "InitiateLayerUpload", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECR.InitiateLayerUpload",
                "rpc.service" = "ECR",
                "rpc.method" = "InitiateLayerUpload",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InitiateLayerUpload {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InitiateLayerUploadRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            InitiateLayerUploadResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("InitiateLayerUpload")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InitiateLayerUpload")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                InitiateLayerUploadTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct InitiateLayerUploadTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InitiateLayerUploadTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<InitiateLayerUploadInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InitiateLayerUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_initiate_layer_upload::de_initiate_layer_upload_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_initiate_layer_upload::de_initiate_layer_upload_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InitiateLayerUploadRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::initiate_layer_upload::InitiateLayerUploadInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::initiate_layer_upload::InitiateLayerUploadInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_initiate_layer_upload::ser_initiate_layer_upload_input(
            &input,
        )?);
