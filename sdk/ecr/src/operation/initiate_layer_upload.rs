...
impl InitiateLayerUploadInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_initiate_layer_upload::ser_initiate_layer_upload_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::initiate_layer_upload::InitiateLayerUpload::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::initiate_layer_upload::InitiateLayerUploadError
{
