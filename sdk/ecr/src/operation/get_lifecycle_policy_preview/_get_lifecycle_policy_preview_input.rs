...
impl GetLifecyclePolicyPreviewInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput, ::aws_smithy_types::error::operation::BuildError> {
