...
impl BatchDeleteImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_delete_image::ser_batch_delete_image_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_image::de_batch_delete_image_http_response_with_props(status, headers, body)
        }
    }
}
