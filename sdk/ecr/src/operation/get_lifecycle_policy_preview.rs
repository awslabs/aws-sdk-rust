...
impl GetLifecyclePolicyPreviewInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreview::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLifecyclePolicyPreview {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lifecycle_policy_preview::de_get_lifecycle_policy_preview_http_response_with_props(status, headers, body)
        }
    }
}
