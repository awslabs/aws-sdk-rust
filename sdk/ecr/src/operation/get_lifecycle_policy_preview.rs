...
/// Orchestration and serialization glue logic for `GetLifecyclePolicyPreview`.
...
impl GetLifecyclePolicyPreview {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLifecyclePolicyPreview {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLifecyclePolicyPreview");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLifecyclePolicyPreviewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLifecyclePolicyPreviewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLifecyclePolicyPreview")
...
.with_interceptor(GetLifecyclePolicyPreviewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>::new());
...
#[derive(Debug)]
            struct GetLifecyclePolicyPreviewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLifecyclePolicyPreviewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_lifecycle_policy_preview::de_get_lifecycle_policy_preview_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_lifecycle_policy_preview::de_get_lifecycle_policy_preview_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetLifecyclePolicyPreviewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLifecyclePolicyPreviewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_lifecycle_policy_preview::ser_get_lifecycle_policy_preview_input(&input)?);
...
#[derive(Debug)]
            struct GetLifecyclePolicyPreviewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLifecyclePolicyPreviewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLifecyclePolicyPreviewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLifecyclePolicyPreviewInput>()
                        .ok_or("failed to downcast to GetLifecyclePolicyPreviewInput")?;
...
pub enum GetLifecyclePolicyPreviewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLifecyclePolicyPreviewError) for what information is available for the error.")]
...
impl GetLifecyclePolicyPreviewError {
    /// Creates the `GetLifecyclePolicyPreviewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLifecyclePolicyPreviewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::LifecyclePolicyPreviewNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLifecyclePolicyPreviewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError {
...
mod _get_lifecycle_policy_preview_output;
