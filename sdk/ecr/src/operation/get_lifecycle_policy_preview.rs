...
impl GetLifecyclePolicyPreviewInput {
    /// Consumes the builder and constructs an Operation<[`GetLifecyclePolicyPreview`](crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreview)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreview, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_lifecycle_policy_preview::ser_get_lifecycle_policy_preview_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreview::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLifecyclePolicyPreview {
                type Output = std::result::Result<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewOutput, crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>;
