...
impl GetLifecyclePolicyPreview {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECR", "GetLifecyclePolicyPreview", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECR.GetLifecyclePolicyPreview",
                "rpc.service" = "ECR",
                "rpc.method" = "GetLifecyclePolicyPreview",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLifecyclePolicyPreview {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetLifecyclePolicyPreviewRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetLifecyclePolicyPreviewResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetLifecyclePolicyPreview")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLifecyclePolicyPreview")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetLifecyclePolicyPreviewTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetLifecyclePolicyPreviewTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLifecyclePolicyPreviewTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetLifecyclePolicyPreviewInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLifecyclePolicyPreviewResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_lifecycle_policy_preview::de_get_lifecycle_policy_preview_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_lifecycle_policy_preview::de_get_lifecycle_policy_preview_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLifecyclePolicyPreviewRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_lifecycle_policy_preview::ser_get_lifecycle_policy_preview_input(&input)?,
        );
