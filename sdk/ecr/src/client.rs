    ...
    C: aws_hyper::SmithyConnector,
{
    ...
    pub fn batch_get_image(&self) -> fluent_builders::BatchGetImage<C> {
    ...
    pub fn delete_registry_policy(&self) -> fluent_builders::DeleteRegistryPolicy<C> {
    ...
    pub fn describe_image_scan_findings(&self) -> fluent_builders::DescribeImageScanFindings<C> {
    ...
    pub fn get_download_url_for_layer(&self) -> fluent_builders::GetDownloadUrlForLayer<C> {
    ...
    pub fn get_lifecycle_policy_preview(&self) -> fluent_builders::GetLifecyclePolicyPreview<C> {
        fluent_builders::GetLifecyclePolicyPreview::new(self.handle.clone())
    }
    pub fn get_registry_policy(&self) -> fluent_builders::GetRegistryPolicy<C> {
    ...
    pub fn put_image_scanning_configuration(
        &self,
    ) -> fluent_builders::PutImageScanningConfiguration<C> {
        fluent_builders::PutImageScanningConfiguration::new(self.handle.clone())
    }
    pub fn put_image_tag_mutability(&self) -> fluent_builders::PutImageTagMutability<C> {
    ...
    pub fn put_registry_policy(&self) -> fluent_builders::PutRegistryPolicy<C> {
        fluent_builders::PutRegistryPolicy::new(self.handle.clone())
    }
    pub fn put_replication_configuration(&self) -> fluent_builders::PutReplicationConfiguration<C> {
    ...
    pub fn start_image_scan(&self) -> fluent_builders::StartImageScan<C> {
        fluent_builders::StartImageScan::new(self.handle.clone())
    }
    pub fn start_lifecycle_policy_preview(
        &self,
    ) -> fluent_builders::StartLifecyclePolicyPreview<C> {
...
pub mod fluent_builders {
    ...
    #[derive(std::fmt::Debug)]
    pub struct BatchGetImage<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::batch_get_image_input::Builder,
    }
    impl<C> BatchGetImage<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DeleteRegistryPolicy<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::delete_registry_policy_input::Builder,
    }
    impl<C> DeleteRegistryPolicy<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeImageScanFindings<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_image_scan_findings_input::Builder,
    }
    impl<C> DescribeImageScanFindings<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetDownloadUrlForLayer<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_download_url_for_layer_input::Builder,
    }
    impl<C> GetDownloadUrlForLayer<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn layer_digest(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.layer_digest(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetLifecyclePolicyPreview<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_lifecycle_policy_preview_input::Builder,
    }
    impl<C> GetLifecyclePolicyPreview<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetRegistryPolicy<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_registry_policy_input::Builder,
    }
    impl<C> GetRegistryPolicy<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutImageScanningConfiguration<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_image_scanning_configuration_input::Builder,
    }
    impl<C> PutImageScanningConfiguration<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutImageTagMutability<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_image_tag_mutability_input::Builder,
    }
    impl<C> PutImageTagMutability<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    impl<C> PutLifecyclePolicy<C> {
        ...
        pub fn lifecycle_policy_text(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.lifecycle_policy_text(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutRegistryPolicy<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_registry_policy_input::Builder,
    }
    impl<C> PutRegistryPolicy<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutReplicationConfiguration<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_replication_configuration_input::Builder,
    }
    impl<C> PutReplicationConfiguration<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct StartImageScan<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::start_image_scan_input::Builder,
    }
    impl<C> StartImageScan<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct StartLifecyclePolicyPreview<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::start_lifecycle_policy_preview_input::Builder,
    }
    impl<C> StartLifecyclePolicyPreview<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
