...
///
/// <p>The image signing status. Possible values include <code>IN_PROGRESS</code>,
/// <code>COMPLETE</code>, and <code>FAILED</code>.</p>
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for SigningStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "IN_PROGRESS" => SigningStatus::InProgress,
...
impl SigningStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SigningStatus::Complete => "COMPLETE",
            SigningStatus::Failed => "FAILED",
            SigningStatus::InProgress => "IN_PROGRESS",
...
impl ::std::fmt::Display for SigningStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SigningStatus::Complete => write!(f, "COMPLETE"),
            SigningStatus::Failed => write!(f, "FAILED"),
            SigningStatus::InProgress => write!(f, "IN_PROGRESS"),
