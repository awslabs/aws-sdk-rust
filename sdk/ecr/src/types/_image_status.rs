...
impl ImageStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ImageStatus::Activating => "ACTIVATING",
            ImageStatus::Active => "ACTIVE",
            ImageStatus::Archived => "ARCHIVED",
            ImageStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ACTIVATING", "ACTIVE", "ARCHIVED"]
    }
}
...
impl ::std::fmt::Display for ImageStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ImageStatus::Activating => write!(f, "ACTIVATING"),
            ImageStatus::Active => write!(f, "ACTIVE"),
            ImageStatus::Archived => write!(f, "ARCHIVED"),
