...
pub fn ser_put_image_tag_mutability_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutImageTagMutabilityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
