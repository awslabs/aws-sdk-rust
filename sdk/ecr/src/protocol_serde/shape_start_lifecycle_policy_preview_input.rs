...
pub fn ser_start_lifecycle_policy_preview_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartLifecyclePolicyPreviewInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
