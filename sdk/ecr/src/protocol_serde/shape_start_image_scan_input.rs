...
pub fn ser_start_image_scan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartImageScanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
