...
pub fn ser_get_lifecycle_policy_preview_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_lifecycle_policy_preview::GetLifecyclePolicyPreviewInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
