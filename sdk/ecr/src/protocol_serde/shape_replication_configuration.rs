...
) -> Result<Option<crate::types::ReplicationConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "rules" => {
                            builder = builder.set_rules(crate::protocol_serde::shape_replication_rule_list::de_replication_rule_list(tokens)?);
                        }
