...
pub fn ser_batch_get_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
