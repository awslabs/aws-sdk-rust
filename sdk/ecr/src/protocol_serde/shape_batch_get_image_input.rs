...
pub fn ser_batch_get_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::batch_get_image::BatchGetImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_7) = &input.accepted_media_types {
        let mut array_8 = object.key("acceptedMediaTypes").start_array();
        for item_9 in var_7 {
             {
