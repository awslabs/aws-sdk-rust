...
) -> Result<Option<crate::types::EnhancedImageScanFinding>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "lastObservedAt" => {
                            builder = builder.set_last_observed_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        ...
                        "scoreDetails" => {
                            builder = builder.set_score_details(crate::protocol_serde::shape_score_details::de_score_details(tokens)?);
                        }
                        "severity" => {
