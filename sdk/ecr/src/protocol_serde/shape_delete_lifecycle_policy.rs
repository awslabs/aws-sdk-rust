...
pub fn ser_delete_lifecycle_policy_input(
    ...
    crate::protocol_serde::shape_delete_lifecycle_policy_input::ser_delete_lifecycle_policy_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_lifecycle_policy::de_delete_lifecycle_policy(
