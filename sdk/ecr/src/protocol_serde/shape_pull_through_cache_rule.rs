...
pub(crate) fn de_pull_through_cache_rule<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PullThroughCacheRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
