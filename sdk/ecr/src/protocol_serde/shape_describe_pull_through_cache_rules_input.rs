...
pub fn ser_describe_pull_through_cache_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePullThroughCacheRulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
