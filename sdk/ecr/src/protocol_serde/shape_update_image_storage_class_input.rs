...
pub fn ser_update_image_storage_class_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::update_image_storage_class::UpdateImageStorageClassInput,
    ...
    if let Some(var_5) = &input.target_storage_class {
        object.key("targetStorageClass").string(var_5.as_str());
    }
    Ok(())
}
