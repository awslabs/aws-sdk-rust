...
pub fn ser_list_images_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListImagesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
