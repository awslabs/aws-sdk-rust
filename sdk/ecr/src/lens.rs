...
pub(crate) fn reflens_structure_crate_output_describe_image_scan_findings_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_describe_pull_through_cache_rules_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_get_lifecycle_policy_preview_output_next_token(
...
pub(crate) fn lens_structure_crate_output_get_lifecycle_policy_preview_output_preview_results(
    input: crate::output::GetLifecyclePolicyPreviewOutput,
...
pub(crate) fn lens_structure_crate_output_list_images_output_image_ids(
    input: crate::output::ListImagesOutput,
