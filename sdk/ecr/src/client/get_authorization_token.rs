...
impl super::Client {
    ...
    ///   - [`registry_ids(impl Into<String>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::registry_ids) / [`set_registry_ids(Option<Vec::<String>>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::set_registry_ids):<br>required: **false**<br><p>A list of Amazon Web Services account IDs that are associated with the registries for which to get AuthorizationData objects. If you do not specify a registry, the default registry is assumed.</p><br>
