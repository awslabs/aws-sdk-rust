...
impl super::Client {
    ...
    ///   - [`registry_id(impl Into<String>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::set_registry_id):<br>required: **false**<br><p>The Amazon Web Services account ID associated with the registry that contains the images to describe. If you do not specify a registry, the default registry is assumed.</p><br>
    ///   - [`repository_name(impl Into<String>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::set_repository_name):<br>required: **true**<br><p>The repository that contains the images to describe.</p><br>
    ///   - [`image_ids(ImageIdentifier)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::image_ids) / [`set_image_ids(Option<Vec::<ImageIdentifier>>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::set_image_ids):<br>required: **true**<br><p>A list of image ID references that correspond to images to describe. The format of the <code>imageIds</code> reference is <code>imageTag=tag</code> or <code>imageDigest=digest</code>.</p><br>
    ///   - [`accepted_media_types(impl Into<String>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::accepted_media_types) / [`set_accepted_media_types(Option<Vec::<String>>)`](crate::operation::batch_get_image::builders::BatchGetImageFluentBuilder::set_accepted_media_types):<br>required: **false**<br><p>The accepted media types for the request.</p> <p>Valid values: <code>application/vnd.docker.distribution.manifest.v1+json</code> | <code>application/vnd.docker.distribution.manifest.v2+json</code> | <code>application/vnd.oci.image.manifest.v1+json</code></p><br>
