...
impl super::Client {
    ...
    ///   - [`policy_text(impl ::std::convert::Into<String>)`](crate::operation::put_registry_policy::builders::PutRegistryPolicyFluentBuilder::policy_text) / [`set_policy_text(Option<String>)`](crate::operation::put_registry_policy::builders::PutRegistryPolicyFluentBuilder::set_policy_text): <p>The JSON policy text to apply to your registry. The policy text follows the same format as IAM policy text. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html">Registry permissions</a> in the <i>Amazon Elastic Container Registry User Guide</i>.</p>
    ...
    pub fn put_registry_policy(
        &self,
    ) -> crate::operation::put_registry_policy::builders::PutRegistryPolicyFluentBuilder {
        crate::operation::put_registry_policy::builders::PutRegistryPolicyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
