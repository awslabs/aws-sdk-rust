...
impl super::Client {
    ...
    ///   - [`force(bool)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::force) / [`set_force(Option<bool>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::set_force):<br>required: **false**<br><p> If a repository contains images, forces the deletion.</p><br>
