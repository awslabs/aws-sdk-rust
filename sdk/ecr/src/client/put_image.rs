...
impl super::Client  {
    ...
    ///   - [`repository_name(impl Into<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::set_repository_name): <p>The name of the repository in which to put the image.</p>
    ///   - [`image_manifest(impl Into<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::image_manifest) / [`set_image_manifest(Option<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::set_image_manifest): <p>The image manifest corresponding to the image to be uploaded.</p>
    ...
    ///   - [`image_digest(impl Into<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::image_digest) / [`set_image_digest(Option<String>)`](crate::operation::put_image::builders::PutImageFluentBuilder::set_image_digest): <p>The image digest of the image manifest corresponding to the image.</p>
