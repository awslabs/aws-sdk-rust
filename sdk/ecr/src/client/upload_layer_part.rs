...
impl super::Client {
    ...
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID associated with the registry to which you are uploading layer parts. If you do not specify a registry, the default registry is assumed.</p>
