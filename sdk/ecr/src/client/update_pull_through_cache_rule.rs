...
impl super::Client {
    ...
    ///   - [`credential_arn(impl Into<String>)`](crate::operation::update_pull_through_cache_rule::builders::UpdatePullThroughCacheRuleFluentBuilder::credential_arn) / [`set_credential_arn(Option<String>)`](crate::operation::update_pull_through_cache_rule::builders::UpdatePullThroughCacheRuleFluentBuilder::set_credential_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the Amazon Web Services Secrets Manager secret that identifies the credentials to authenticate to the upstream registry.</p><br>
    ///   - [`custom_role_arn(impl Into<String>)`](crate::operation::update_pull_through_cache_rule::builders::UpdatePullThroughCacheRuleFluentBuilder::custom_role_arn) / [`set_custom_role_arn(Option<String>)`](crate::operation::update_pull_through_cache_rule::builders::UpdatePullThroughCacheRuleFluentBuilder::set_custom_role_arn):<br>required: **false**<br><p>Amazon Resource Name (ARN) of the IAM role to be assumed by Amazon ECR to authenticate to the ECR upstream registry. This role must be in the same account as the registry that you are configuring.</p><br>
    ...
    ///   - [`custom_role_arn(Option<String>)`](crate::operation::update_pull_through_cache_rule::UpdatePullThroughCacheRuleOutput::custom_role_arn): <p>The ARN of the IAM role associated with the pull through cache rule.</p>
    ///   - [`upstream_repository_prefix(Option<String>)`](crate::operation::update_pull_through_cache_rule::UpdatePullThroughCacheRuleOutput::upstream_repository_prefix): <p>The upstream repository prefix associated with the pull through cache rule.</p>
