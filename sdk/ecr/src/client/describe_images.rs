...
impl super::Client {
    ...
    ///   - [`repository_name(impl Into<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_repository_name): <p>The repository that contains the images to describe.</p>
    ///   - [`image_ids(Vec<ImageIdentifier>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::image_ids) / [`set_image_ids(Option<Vec<ImageIdentifier>>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_image_ids): <p>The list of image IDs for the requested repository.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>DescribeImages</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. This value is <code>null</code> when there are no more results to return. This option cannot be used when you specify images with <code>imageIds</code>.</p>
    ...
    ///   - [`filter(DescribeImagesFilter)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::filter) / [`set_filter(Option<DescribeImagesFilter>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_filter): <p>The filter key and value with which to filter your <code>DescribeImages</code> results.</p>
