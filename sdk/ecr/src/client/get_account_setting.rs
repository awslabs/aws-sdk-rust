...
impl super::Client {
    ...
    ///   - [`value(Option<String>)`](crate::operation::get_account_setting::GetAccountSettingOutput::value): <p>The setting value for the setting name. Valid value for basic scan type: <code>AWS_NATIVE</code>. Valid values for registry policy scope: <code>V2</code>. Valid values for blob mounting: <code>ENABLED</code> or <code>DISABLED</code>.</p>
