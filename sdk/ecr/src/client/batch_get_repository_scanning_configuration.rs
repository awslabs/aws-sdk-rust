...
impl super::Client {
    ...
    ///   - [`repository_names(impl Into<String>)`](crate::operation::batch_get_repository_scanning_configuration::builders::BatchGetRepositoryScanningConfigurationFluentBuilder::repository_names) / [`set_repository_names(Option<Vec::<String>>)`](crate::operation::batch_get_repository_scanning_configuration::builders::BatchGetRepositoryScanningConfigurationFluentBuilder::set_repository_names):<br>required: **true**<br><p>One or more repository names to get the scanning configuration for.</p><br>
