...
impl super::Client {
    ...
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID associated with the registry that contains the repository policy to delete. If you do not specify a registry, the default registry is assumed.</p>
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::set_repository_name): <p>The name of the repository that is associated with the repository policy to delete.</p>
