...
impl super::Client {
    ...
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::start_image_scan::builders::StartImageScanFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::start_image_scan::builders::StartImageScanFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID associated with the registry that contains the repository in which to start an image scan request. If you do not specify a registry, the default registry is assumed.</p>
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::start_image_scan::builders::StartImageScanFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::start_image_scan::builders::StartImageScanFluentBuilder::set_repository_name): <p>The name of the repository that contains the images to scan.</p>
