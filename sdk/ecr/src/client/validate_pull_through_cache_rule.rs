...
impl super::Client {
    ...
    ///   - [`custom_role_arn(Option<String>)`](crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleOutput::custom_role_arn): <p>The ARN of the IAM role associated with the pull through cache rule.</p>
    ///   - [`upstream_repository_prefix(Option<String>)`](crate::operation::validate_pull_through_cache_rule::ValidatePullThroughCacheRuleOutput::upstream_repository_prefix): <p>The upstream repository prefix associated with the pull through cache rule.</p>
