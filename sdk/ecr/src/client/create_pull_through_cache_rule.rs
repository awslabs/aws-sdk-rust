...
impl super::Client {
    ...
    ///   - [`ecr_repository_prefix(impl ::std::convert::Into<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::ecr_repository_prefix) / [`set_ecr_repository_prefix(Option<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::set_ecr_repository_prefix): <p>The repository name prefix to use when caching images from the source registry.</p>
    ///   - [`upstream_registry_url(impl ::std::convert::Into<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::upstream_registry_url) / [`set_upstream_registry_url(Option<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::set_upstream_registry_url): <p>The registry URL of the upstream public registry to use as the source for the pull through cache rule.</p>
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::create_pull_through_cache_rule::builders::CreatePullThroughCacheRuleFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID associated with the registry to create the pull through cache rule for. If you do not specify a registry, the default registry is assumed.</p>
