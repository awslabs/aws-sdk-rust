...
pub fn serialize_structure_batch_get_image_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_16 in var_14 {
            {
                ...
                crate::json_ser::serialize_structure_image_identifier(&mut object_17, item_16);
                object_17.finish();
            }
        }
        array_15.finish();
...
pub fn serialize_structure_create_repository_input(
    ...
    if let Some(var_33) = &input.image_scanning_configuration {
        ...
        crate::json_ser::serialize_structure_image_scanning_configuration(&mut object_34, var_33);
        object_34.finish();
    }
    if let Some(var_35) = &input.encryption_configuration {
        let mut object_36 = object.key("encryptionConfiguration").start_object();
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_36, var_35);
        object_36.finish();
    }
}
...
pub fn serialize_structure_describe_images_input(
        ...
        for item_47 in var_45 {
            {
                ...
                crate::json_ser::serialize_structure_image_identifier(&mut object_48, item_47);
                object_48.finish();
            }
        }
        array_46.finish();
    ...
    if let Some(var_51) = &input.filter {
        ...
        crate::json_ser::serialize_structure_describe_images_filter(&mut object_52, var_51);
        object_52.finish();
    }
}

pub fn serialize_structure_describe_image_scan_findings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_55) = &input.image_id {
        ...
        crate::json_ser::serialize_structure_image_identifier(&mut object_56, var_55);
        object_56.finish();
    }
...
pub fn serialize_structure_get_authorization_token_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_download_url_for_layer_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_lifecycle_policy_preview_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_77 in var_75 {
            {
                ...
                crate::json_ser::serialize_structure_image_identifier(&mut object_78, item_77);
                object_78.finish();
            }
        }
        array_76.finish();
    ...
    if let Some(var_81) = &input.filter {
        ...
        crate::json_ser::serialize_structure_lifecycle_policy_preview_filter(
            &mut object_82,
            var_81,
        );
        object_82.finish();
...
pub fn serialize_structure_list_images_input(
    ...
    if let Some(var_91) = &input.filter {
        ...
        crate::json_ser::serialize_structure_list_images_filter(&mut object_92, var_91);
        object_92.finish();
    }
}
...
pub fn serialize_structure_put_image_scanning_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_102) = &input.image_scanning_configuration {
        ...
        crate::json_ser::serialize_structure_image_scanning_configuration(&mut object_103, var_102);
        object_103.finish();
    }
}

pub fn serialize_structure_put_image_tag_mutability_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_registry_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_replication_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_111) = &input.replication_configuration {
        ...
        crate::json_ser::serialize_structure_replication_configuration(&mut object_112, var_111);
        object_112.finish();
    }
}
...
pub fn serialize_structure_start_image_scan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_118) = &input.image_id {
        ...
        crate::json_ser::serialize_structure_image_identifier(&mut object_119, var_118);
        object_119.finish();
    }
}

pub fn serialize_structure_start_lifecycle_policy_preview_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_image_scanning_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_lifecycle_policy_preview_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_images_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_149 in var_147 {
            {
                ...
                crate::json_ser::serialize_structure_replication_rule(&mut object_150, item_149);
                object_150.finish();
            }
        }
        array_148.finish();
        ...
        for item_153 in var_151 {
            {
                ...
                crate::json_ser::serialize_structure_replication_destination(
                    &mut object_154,
                    item_153,
                );
                object_154.finish();
...
pub fn serialize_structure_replication_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
