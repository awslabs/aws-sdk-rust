...
pub struct GetLifecyclePolicyOutput {
    ...
    pub last_evaluated_at: std::option::Option<smithy_types::Instant>,
}
...
pub mod get_lifecycle_policy_output {
    ...
    pub struct Builder {
        ...
        pub(crate) repository_name: std::option::Option<std::string::String>,
        pub(crate) lifecycle_policy_text: std::option::Option<std::string::String>,
        pub(crate) last_evaluated_at: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The registry ID associated with the request.</p>
        pub fn registry_id(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>The time stamp of the last time that the lifecycle policy was run.</p>
        pub fn last_evaluated_at(mut self, input: smithy_types::Instant) -> Self {
