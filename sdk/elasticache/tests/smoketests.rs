...
//! ```
use aws_sdk_elasticache::{config, Client};
/// Smoke tests for the `describe_events` operation
#[::tokio::test]
async fn test_describe_events_success() {
    ...
    let res = client.describe_events().send().await;
