...
#[allow(unused_mut)]
pub fn serialize_structure_log_delivery_configuration_request(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_10) = &input.destination_details {
        crate::query_ser::serialize_structure_destination_details(scope_9, var_10);
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_node_group_configuration(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_configure_shard(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_time_range_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_regional_configuration(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_64) = &input.resharding_configuration {
        ...
        for item_65 in var_64 {
            ...
            crate::query_ser::serialize_structure_resharding_configuration(entry_67, item_65);
        }
        list_66.finish();
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_resharding_configuration(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_customer_node_endpoint(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_destination_details(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_84) = &input.cloud_watch_logs_details {
        crate::query_ser::serialize_structure_cloud_watch_logs_destination_details(
            scope_83, var_84,
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_86) = &input.kinesis_firehose_details {
        crate::query_ser::serialize_structure_kinesis_firehose_destination_details(
            scope_85, var_86,
        );
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_cloud_watch_logs_destination_details(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_kinesis_firehose_destination_details(
    mut writer: smithy_query::QueryValueWriter,
