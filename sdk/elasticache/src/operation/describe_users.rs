...
impl DescribeUsersInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_users_input::ser_describe_users_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_users::DescribeUsers::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUsers", "elasticache"));
