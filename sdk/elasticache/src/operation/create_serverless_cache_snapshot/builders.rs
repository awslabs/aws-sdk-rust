...
impl CreateServerlessCacheSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_serverless_cache_snapshot::CreateServerlessCacheSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_serverless_cache_snapshot::CreateServerlessCacheSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_serverless_cache_snapshot::CreateServerlessCacheSnapshotOutput, crate::operation::create_serverless_cache_snapshot::CreateServerlessCacheSnapshotError, Self> {
