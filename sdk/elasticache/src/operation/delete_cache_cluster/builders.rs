...
impl DeleteCacheClusterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_cache_cluster::DeleteCacheClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cache_cluster::DeleteCacheClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_cache_cluster::DeleteCacheClusterOutput, crate::operation::delete_cache_cluster::DeleteCacheClusterError, Self> {
