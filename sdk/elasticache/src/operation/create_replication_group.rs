...
impl CreateReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateReplicationGroup`](crate::operation::create_replication_group::CreateReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_replication_group::CreateReplicationGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_replication_group::CreateReplicationGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReplicationGroup {
                type Output = std::result::Result<crate::operation::create_replication_group::CreateReplicationGroupOutput, crate::operation::create_replication_group::CreateReplicationGroupError>;
