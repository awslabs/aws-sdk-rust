...
impl DeleteUserGroupInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::delete_user_group::DeleteUserGroup,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_user_group::DeleteUserGroup::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserGroup {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_user_group::de_delete_user_group_http_error(
                status, headers, body,
            )
        } else {
