...
impl ModifyGlobalReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyGlobalReplicationGroup`](crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_global_replication_group_input::ser_modify_global_replication_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyGlobalReplicationGroup", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyGlobalReplicationGroup {
                type Output = std::result::Result<crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupOutput, crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupError>;
