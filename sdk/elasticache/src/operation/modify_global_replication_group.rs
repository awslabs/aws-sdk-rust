...
impl ModifyGlobalReplicationGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyGlobalReplicationGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_global_replication_group::de_modify_global_replication_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
