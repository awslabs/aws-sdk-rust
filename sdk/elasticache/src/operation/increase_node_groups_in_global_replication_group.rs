...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IncreaseNodeGroupsInGlobalReplicationGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_increase_node_groups_in_global_replication_group_input::ser_increase_node_groups_in_global_replication_group_input_input(&input)?);
