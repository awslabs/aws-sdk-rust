...
impl FailoverGlobalReplicationGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for FailoverGlobalReplicationGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("FailoverGlobalReplicationGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(FailoverGlobalReplicationGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(FailoverGlobalReplicationGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("FailoverGlobalReplicationGroup")
...
.with_interceptor(FailoverGlobalReplicationGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError>::new());
...
#[derive(Debug)]
            struct FailoverGlobalReplicationGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for FailoverGlobalReplicationGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_failover_global_replication_group::de_failover_global_replication_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct FailoverGlobalReplicationGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for FailoverGlobalReplicationGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_failover_global_replication_group_input::ser_failover_global_replication_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct FailoverGlobalReplicationGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for FailoverGlobalReplicationGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "FailoverGlobalReplicationGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<FailoverGlobalReplicationGroupInput>()
                        .ok_or("failed to downcast to FailoverGlobalReplicationGroupInput")?;
...
pub enum FailoverGlobalReplicationGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-FailoverGlobalReplicationGroupError) for what information is available for the error.")]
...
impl FailoverGlobalReplicationGroupError {
    /// Creates the `FailoverGlobalReplicationGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `FailoverGlobalReplicationGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for FailoverGlobalReplicationGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError {
