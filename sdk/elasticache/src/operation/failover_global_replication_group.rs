...
impl FailoverGlobalReplicationGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for FailoverGlobalReplicationGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_failover_global_replication_group::de_failover_global_replication_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::failover_global_replication_group::FailoverGlobalReplicationGroupError
{
