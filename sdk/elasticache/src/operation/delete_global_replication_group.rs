...
impl DeleteGlobalReplicationGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteGlobalReplicationGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteGlobalReplicationGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteGlobalReplicationGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteGlobalReplicationGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteGlobalReplicationGroup")
...
.with_interceptor(DeleteGlobalReplicationGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError>::new());
...
#[derive(Debug)]
            struct DeleteGlobalReplicationGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteGlobalReplicationGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_global_replication_group::de_delete_global_replication_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_global_replication_group::de_delete_global_replication_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteGlobalReplicationGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteGlobalReplicationGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_global_replication_group_input::ser_delete_global_replication_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteGlobalReplicationGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteGlobalReplicationGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteGlobalReplicationGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteGlobalReplicationGroupInput>()
                        .ok_or("failed to downcast to DeleteGlobalReplicationGroupInput")?;
...
pub enum DeleteGlobalReplicationGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteGlobalReplicationGroupError) for what information is available for the error.")]
...
impl DeleteGlobalReplicationGroupError {
    /// Creates the `DeleteGlobalReplicationGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteGlobalReplicationGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteGlobalReplicationGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError {
...
mod _delete_global_replication_group_output;
