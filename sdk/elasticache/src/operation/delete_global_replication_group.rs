...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGlobalReplicationGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_global_replication_group::de_delete_global_replication_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteGlobalReplicationGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroupError
{
