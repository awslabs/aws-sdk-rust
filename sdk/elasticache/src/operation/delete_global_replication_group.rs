...
impl DeleteGlobalReplicationGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_global_replication_group::DeleteGlobalReplicationGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGlobalReplicationGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_global_replication_group::de_delete_global_replication_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
