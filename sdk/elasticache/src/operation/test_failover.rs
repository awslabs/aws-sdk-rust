...
impl TestFailoverInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::test_failover::TestFailover::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestFailover {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_test_failover::de_test_failover_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_test_failover::de_test_failover_http_response_with_props(
                status, headers, body,
            )
        }
    }
