...
/// Orchestration and serialization glue logic for `DeleteServerlessCache`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteServerlessCache;
impl DeleteServerlessCache {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_serverless_cache::DeleteServerlessCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_serverless_cache::DeleteServerlessCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_serverless_cache::DeleteServerlessCacheError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_serverless_cache::DeleteServerlessCacheOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteServerlessCache {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteServerlessCache");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteServerlessCacheRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteServerlessCacheResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteServerlessCache")
...
.with_interceptor(DeleteServerlessCacheEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_serverless_cache::DeleteServerlessCacheError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_serverless_cache::DeleteServerlessCacheError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_serverless_cache::DeleteServerlessCacheError>::new());
...
#[derive(Debug)]
            struct DeleteServerlessCacheResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteServerlessCacheResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_serverless_cache::de_delete_serverless_cache_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_serverless_cache::de_delete_serverless_cache_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteServerlessCacheRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteServerlessCacheRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_serverless_cache::DeleteServerlessCacheInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_serverless_cache::DeleteServerlessCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_serverless_cache_input::ser_delete_serverless_cache_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteServerlessCacheEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteServerlessCacheEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteServerlessCacheEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteServerlessCacheInput>()
                        .ok_or("failed to downcast to DeleteServerlessCacheInput")?;
...
/// Error type for the `DeleteServerlessCacheError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteServerlessCacheError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteServerlessCacheError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteServerlessCacheError {
    /// Creates the `DeleteServerlessCacheError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteServerlessCacheError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ServerlessCacheSnapshotAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::ServiceLinkedRoleNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::Unhandled(e) => &e.meta,
        }
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::InvalidCredentialsException`.
    pub fn is_invalid_credentials_exception(&self) -> bool {
        matches!(self, Self::InvalidCredentialsException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::InvalidParameterCombinationException`.
    pub fn is_invalid_parameter_combination_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterCombinationException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::InvalidServerlessCacheStateFault`.
    pub fn is_invalid_serverless_cache_state_fault(&self) -> bool {
        matches!(self, Self::InvalidServerlessCacheStateFault(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::ServerlessCacheNotFoundFault`.
    pub fn is_serverless_cache_not_found_fault(&self) -> bool {
        matches!(self, Self::ServerlessCacheNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::ServerlessCacheSnapshotAlreadyExistsFault`.
    pub fn is_serverless_cache_snapshot_already_exists_fault(&self) -> bool {
        matches!(self, Self::ServerlessCacheSnapshotAlreadyExistsFault(_))
    }
    /// Returns `true` if the error kind is `DeleteServerlessCacheError::ServiceLinkedRoleNotFoundFault`.
    pub fn is_service_linked_role_not_found_fault(&self) -> bool {
        matches!(self, Self::ServiceLinkedRoleNotFoundFault(_))
    }
}
impl ::std::error::Error for DeleteServerlessCacheError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::ServerlessCacheSnapshotAlreadyExistsFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for DeleteServerlessCacheError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteServerlessCacheError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteServerlessCacheError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteServerlessCacheError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_serverless_cache::DeleteServerlessCacheError {
...
mod _delete_serverless_cache_output;
