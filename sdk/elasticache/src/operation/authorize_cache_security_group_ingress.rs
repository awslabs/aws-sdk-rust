    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeCacheSecurityGroupIngress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AuthorizeCacheSecurityGroupIngressRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AuthorizeCacheSecurityGroupIngressResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeCacheSecurityGroupIngress")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AuthorizeCacheSecurityGroupIngressResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AuthorizeCacheSecurityGroupIngressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_cache_security_group_ingress_input::ser_authorize_cache_security_group_ingress_input_input_input(
                &input,
            )?,
        );
