...
/// Orchestration and serialization glue logic for `AuthorizeCacheSecurityGroupIngress`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeCacheSecurityGroupIngress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AuthorizeCacheSecurityGroupIngress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AuthorizeCacheSecurityGroupIngressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AuthorizeCacheSecurityGroupIngressResponseDeserializer));
...
.with_interceptor(AuthorizeCacheSecurityGroupIngressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AuthorizeCacheSecurityGroupIngressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_authorize_cache_security_group_ingress_input::ser_authorize_cache_security_group_ingress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AuthorizeCacheSecurityGroupIngressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AuthorizeCacheSecurityGroupIngressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AuthorizeCacheSecurityGroupIngressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AuthorizeCacheSecurityGroupIngressInput>()
                        .ok_or("failed to downcast to AuthorizeCacheSecurityGroupIngressInput")?;
...
pub enum AuthorizeCacheSecurityGroupIngressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AuthorizeCacheSecurityGroupIngressError) for what information is available for the error.")]
...
impl AuthorizeCacheSecurityGroupIngressError {
    /// Creates the `AuthorizeCacheSecurityGroupIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AuthorizeCacheSecurityGroupIngressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AuthorizeCacheSecurityGroupIngressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError {
...
mod _authorize_cache_security_group_ingress_output;
