...
impl AuthorizeCacheSecurityGroupIngressInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeCacheSecurityGroupIngress`](crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_cache_security_group_ingress_input::ser_authorize_cache_security_group_ingress_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AuthorizeCacheSecurityGroupIngress", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeCacheSecurityGroupIngress {
    type Output = ::std::result::Result<crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressOutput, crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngressError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_response_with_props(status, headers, body)
        }
    }
}
