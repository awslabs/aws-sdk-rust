...
impl AuthorizeCacheSecurityGroupIngressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::authorize_cache_security_group_ingress::AuthorizeCacheSecurityGroupIngress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeCacheSecurityGroupIngress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_authorize_cache_security_group_ingress::de_authorize_cache_security_group_ingress_http_response_with_props(
                status, headers, body,
            )
        }
    }
