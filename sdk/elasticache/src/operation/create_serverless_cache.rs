...
impl CreateServerlessCache {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_serverless_cache::CreateServerlessCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_serverless_cache::CreateServerlessCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_serverless_cache::CreateServerlessCacheError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_serverless_cache::CreateServerlessCacheOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateServerlessCache {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateServerlessCacheRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateServerlessCacheResponseDeserializer));
...
.with_interceptor(CreateServerlessCacheEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_serverless_cache::CreateServerlessCacheError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_serverless_cache::CreateServerlessCacheError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_serverless_cache::CreateServerlessCacheError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateServerlessCacheRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_serverless_cache::CreateServerlessCacheInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_serverless_cache::CreateServerlessCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_serverless_cache_input::ser_create_serverless_cache_input_input_input(&input)?);
...
impl ::std::error::Error for CreateServerlessCacheError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::InvalidServerlessCacheStateFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::InvalidUserGroupStateFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::ServerlessCacheAlreadyExistsFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::ServerlessCacheNotFoundFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::ServerlessCacheQuotaForCustomerExceededFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
