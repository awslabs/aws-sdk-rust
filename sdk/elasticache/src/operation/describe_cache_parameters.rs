...
impl DescribeCacheParametersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_cache_parameters::DescribeCacheParameters,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCacheParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cache_parameters::de_describe_cache_parameters_http_response_with_props(status, headers, body)
        }
    }
}
