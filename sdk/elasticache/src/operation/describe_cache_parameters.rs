...
impl DescribeCacheParametersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCacheParameters`](crate::operation::describe_cache_parameters::DescribeCacheParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cache_parameters::DescribeCacheParameters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cache_parameters::DescribeCacheParametersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cache_parameters_input::ser_describe_cache_parameters_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cache_parameters::DescribeCacheParameters::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeCacheParameters", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCacheParameters {
                type Output = std::result::Result<crate::operation::describe_cache_parameters::DescribeCacheParametersOutput, crate::operation::describe_cache_parameters::DescribeCacheParametersError>;
