...
impl DescribeReservedCacheNodesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedCacheNodes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_cache_nodes::de_describe_reserved_cache_nodes_http_response_with_props(
                status, headers, body,
            )
        }
    }
