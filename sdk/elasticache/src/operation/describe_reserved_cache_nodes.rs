...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedCacheNodes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_cache_nodes::de_describe_reserved_cache_nodes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesError
{
