...
impl DescribeGlobalReplicationGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_global_replication_groups::DescribeGlobalReplicationGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGlobalReplicationGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_global_replication_groups::de_describe_global_replication_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
