...
/// Orchestration and serialization glue logic for `ResetCacheParameterGroup`.
...
impl ResetCacheParameterGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupInput,
                    ) -> ::std::result::Result<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetCacheParameterGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResetCacheParameterGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResetCacheParameterGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResetCacheParameterGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetCacheParameterGroup")
...
.with_interceptor(ResetCacheParameterGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResetCacheParameterGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reset_cache_parameter_group::de_reset_cache_parameter_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reset_cache_parameter_group::de_reset_cache_parameter_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetCacheParameterGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reset_cache_parameter_group_input::ser_reset_cache_parameter_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ResetCacheParameterGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetCacheParameterGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResetCacheParameterGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResetCacheParameterGroupInput>()
                        .ok_or("failed to downcast to ResetCacheParameterGroupInput")?;
...
pub enum ResetCacheParameterGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResetCacheParameterGroupError) for what information is available for the error.")]
...
impl ResetCacheParameterGroupError {
    /// Creates the `ResetCacheParameterGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetCacheParameterGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResetCacheParameterGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError {
...
mod _reset_cache_parameter_group_output;
