...
impl ResetCacheParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ResetCacheParameterGroup`](crate::operation::reset_cache_parameter_group::ResetCacheParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_cache_parameter_group_input::ser_reset_cache_parameter_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_cache_parameter_group::ResetCacheParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResetCacheParameterGroup", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResetCacheParameterGroup {
                type Output = std::result::Result<crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupOutput, crate::operation::reset_cache_parameter_group::ResetCacheParameterGroupError>;
