        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferings::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl DescribeReservedCacheNodesOfferingsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_reserved_cache_nodes_offerings_output_output_reserved_cache_nodes_offerings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
