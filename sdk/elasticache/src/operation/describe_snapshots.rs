...
impl DescribeSnapshots {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ElastiCache", "DescribeSnapshots", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSnapshotsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("SnapshotSource") {
            if let ::std::option::Option::Some(value) = input.snapshot_source.as_deref() {
                captured.insert("SnapshotSource", value);
            }
        }
