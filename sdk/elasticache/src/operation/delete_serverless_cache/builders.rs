...
pub use crate::operation::delete_serverless_cache::_delete_serverless_cache_output::DeleteServerlessCacheOutputBuilder;

pub use crate::operation::delete_serverless_cache::_delete_serverless_cache_input::DeleteServerlessCacheInputBuilder;
...
impl DeleteServerlessCacheInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_serverless_cache();
...
pub struct DeleteServerlessCacheFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_serverless_cache::builders::DeleteServerlessCacheInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_serverless_cache::DeleteServerlessCacheOutput,
                    crate::operation::delete_serverless_cache::DeleteServerlessCacheError,
                > for DeleteServerlessCacheFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteServerlessCacheFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_serverless_cache::builders::DeleteServerlessCacheInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_serverless_cache::DeleteServerlessCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_serverless_cache::DeleteServerlessCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_serverless_cache::DeleteServerlessCache::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_serverless_cache::DeleteServerlessCache::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_serverless_cache::DeleteServerlessCacheOutput, crate::operation::delete_serverless_cache::DeleteServerlessCacheError, Self> {
