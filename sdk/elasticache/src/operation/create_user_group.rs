...
impl CreateUserGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateUserGroup`](crate::operation::create_user_group::CreateUserGroup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_user_group::CreateUserGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_user_group::CreateUserGroup::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateUserGroup", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_user_group::de_create_user_group_http_response_with_props(status, headers, body)
        }
    }
}
