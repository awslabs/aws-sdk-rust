...
impl CreateUserGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_user_group::CreateUserGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_user_group::CreateUserGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_user_group_input::ser_create_user_group_input_input(&self)?
        );
...
/// `ParseStrictResponse` impl for `CreateUserGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateUserGroup {
                type Output = std::result::Result<crate::operation::create_user_group::CreateUserGroupOutput, crate::operation::create_user_group::CreateUserGroupError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_user_group::de_create_user_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_user_group::de_create_user_group_http_response(response)
                     }
                }
            }
