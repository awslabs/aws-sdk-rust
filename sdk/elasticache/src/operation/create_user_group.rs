...
impl CreateUserGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_user_group::CreateUserGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_user_group::de_create_user_group_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_user_group::CreateUserGroupError
{
