...
impl DescribeReplicationGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_replication_groups::DescribeReplicationGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
