...
/// Orchestration and serialization glue logic for `ModifyServerlessCache`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModifyServerlessCache;
impl ModifyServerlessCache {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_serverless_cache::ModifyServerlessCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_serverless_cache::ModifyServerlessCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_serverless_cache::ModifyServerlessCacheError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_serverless_cache::ModifyServerlessCacheOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyServerlessCache {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyServerlessCache");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyServerlessCacheRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyServerlessCacheResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyServerlessCache")
...
.with_interceptor(ModifyServerlessCacheEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_serverless_cache::ModifyServerlessCacheError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_serverless_cache::ModifyServerlessCacheError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_serverless_cache::ModifyServerlessCacheError>::new());
...
#[derive(Debug)]
            struct ModifyServerlessCacheResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyServerlessCacheResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_serverless_cache::de_modify_serverless_cache_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_serverless_cache::de_modify_serverless_cache_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyServerlessCacheRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyServerlessCacheRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_serverless_cache::ModifyServerlessCacheInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_serverless_cache::ModifyServerlessCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_serverless_cache_input::ser_modify_serverless_cache_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyServerlessCacheEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyServerlessCacheEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyServerlessCacheEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyServerlessCacheInput>()
                        .ok_or("failed to downcast to ModifyServerlessCacheInput")?;
...
/// Error type for the `ModifyServerlessCacheError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ModifyServerlessCacheError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyServerlessCacheError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ModifyServerlessCacheError {
    /// Creates the `ModifyServerlessCacheError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyServerlessCacheError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::InvalidCredentialsException`.
    pub fn is_invalid_credentials_exception(&self) -> bool {
        matches!(self, Self::InvalidCredentialsException(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::InvalidParameterCombinationException`.
    pub fn is_invalid_parameter_combination_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterCombinationException(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::InvalidServerlessCacheStateFault`.
    pub fn is_invalid_serverless_cache_state_fault(&self) -> bool {
        matches!(self, Self::InvalidServerlessCacheStateFault(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::InvalidUserGroupStateFault`.
    pub fn is_invalid_user_group_state_fault(&self) -> bool {
        matches!(self, Self::InvalidUserGroupStateFault(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::ServerlessCacheNotFoundFault`.
    pub fn is_serverless_cache_not_found_fault(&self) -> bool {
        matches!(self, Self::ServerlessCacheNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::ServiceLinkedRoleNotFoundFault`.
    pub fn is_service_linked_role_not_found_fault(&self) -> bool {
        matches!(self, Self::ServiceLinkedRoleNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `ModifyServerlessCacheError::UserGroupNotFoundFault`.
    pub fn is_user_group_not_found_fault(&self) -> bool {
        matches!(self, Self::UserGroupNotFoundFault(_))
    }
}
impl ::std::error::Error for ModifyServerlessCacheError {
...
impl ::std::fmt::Display for ModifyServerlessCacheError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ModifyServerlessCacheError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyServerlessCacheError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyServerlessCacheError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_serverless_cache::ModifyServerlessCacheError {
...
mod _modify_serverless_cache_output;
