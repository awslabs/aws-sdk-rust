...
impl BatchStopUpdateActionFluentBuilder  {
    /// Creates a new `BatchStopUpdateAction`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::batch_stop_update_action::BatchStopUpdateActionOutput, aws_smithy_http::result::SdkError<crate::operation::batch_stop_update_action::BatchStopUpdateActionError>>
                     {
