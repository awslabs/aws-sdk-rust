...
impl DescribeCacheParameterGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCacheParameterGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cache_parameter_groups::de_describe_cache_parameter_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
