...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCacheParameterGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cache_parameter_groups::de_describe_cache_parameter_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeCacheParameterGroupsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError
{
