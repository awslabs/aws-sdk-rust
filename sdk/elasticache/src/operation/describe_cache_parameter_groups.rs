...
impl DescribeCacheParameterGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCacheParameterGroups`](crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cache_parameter_groups_input::ser_describe_cache_parameter_groups_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeCacheParameterGroups", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCacheParameterGroups {
                type Output = std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError>;
