...
impl ListAllowedNodeTypeModificationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModifications::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAllowedNodeTypeModifications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_allowed_node_type_modifications::de_list_allowed_node_type_modifications_http_response_with_props(
                status, headers, body,
            )
        }
    }
