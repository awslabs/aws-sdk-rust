...
impl DecreaseReplicaCount {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::decrease_replica_count::DecreaseReplicaCountError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::decrease_replica_count::DecreaseReplicaCountOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ElastiCache", "DecreaseReplicaCount", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ElastiCache.DecreaseReplicaCount",
                "rpc.service" = "ElastiCache",
                "rpc.method" = "DecreaseReplicaCount",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DecreaseReplicaCount {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DecreaseReplicaCountRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DecreaseReplicaCountResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DecreaseReplicaCount")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DecreaseReplicaCount")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DecreaseReplicaCountTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DecreaseReplicaCountTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DecreaseReplicaCountTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DecreaseReplicaCountInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DecreaseReplicaCountResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_decrease_replica_count::de_decrease_replica_count_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_decrease_replica_count::de_decrease_replica_count_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DecreaseReplicaCountRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::decrease_replica_count::DecreaseReplicaCountInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_decrease_replica_count_input::ser_decrease_replica_count_input_input_input(&input)?,
        );
