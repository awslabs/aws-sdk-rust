...
impl ModifyUserInput {
    /// Consumes the builder and constructs an Operation<[`ModifyUser`](crate::operation::modify_user::ModifyUser)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_user::ModifyUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_user_input::ser_modify_user_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_user::ModifyUser::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyUser", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyUser {
    type Output = ::std::result::Result<crate::operation::modify_user::ModifyUserOutput, crate::operation::modify_user::ModifyUserError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_user::de_modify_user_http_response_with_props(status, headers, body)
        }
    }
}
