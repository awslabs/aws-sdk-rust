...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ModifyReplicationGroupShardConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ModifyReplicationGroupShardConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_replication_group_shard_configuration_input::ser_modify_replication_group_shard_configuration_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyReplicationGroupShardConfigurationEndpointParamsInterceptor {
