...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyReplicationGroupShardConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_replication_group_shard_configuration_input::ser_modify_replication_group_shard_configuration_input_input(&input)?);
