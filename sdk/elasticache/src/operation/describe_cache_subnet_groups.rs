...
/// Orchestration and serialization glue logic for `DescribeCacheSubnetGroups`.
...
impl DescribeCacheSubnetGroups {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCacheSubnetGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCacheSubnetGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCacheSubnetGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCacheSubnetGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCacheSubnetGroups")
...
.with_interceptor(DescribeCacheSubnetGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCacheSubnetGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_cache_subnet_groups::de_describe_cache_subnet_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_cache_subnet_groups::de_describe_cache_subnet_groups_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCacheSubnetGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_cache_subnet_groups_input::ser_describe_cache_subnet_groups_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCacheSubnetGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCacheSubnetGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCacheSubnetGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCacheSubnetGroupsInput>()
                        .ok_or("failed to downcast to DescribeCacheSubnetGroupsInput")?;
...
pub enum DescribeCacheSubnetGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCacheSubnetGroupsError) for what information is available for the error.")]
...
impl DescribeCacheSubnetGroupsError {
    /// Creates the `DescribeCacheSubnetGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCacheSubnetGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCacheSubnetGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError {
...
mod _describe_cache_subnet_groups_output;
