...
impl DescribeCacheSubnetGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCacheSubnetGroups`](crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cache_subnet_groups_input::ser_describe_cache_subnet_groups_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeCacheSubnetGroups", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCacheSubnetGroups {
                type Output = std::result::Result<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsOutput, crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError>;
