...
impl DescribeCacheSubnetGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroups,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCacheSubnetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cache_subnet_groups::de_describe_cache_subnet_groups_http_response_with_props(status, headers, body)
        }
    }
}
