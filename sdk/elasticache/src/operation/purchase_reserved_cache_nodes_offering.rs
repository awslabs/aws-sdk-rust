...
impl PurchaseReservedCacheNodesOffering {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::purchase_reserved_cache_nodes_offering::PurchaseReservedCacheNodesOfferingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::purchase_reserved_cache_nodes_offering::PurchaseReservedCacheNodesOfferingOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "PurchaseReservedCacheNodesOffering",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseReservedCacheNodesOffering {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PurchaseReservedCacheNodesOfferingRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PurchaseReservedCacheNodesOfferingResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PurchaseReservedCacheNodesOffering")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseReservedCacheNodesOffering")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PurchaseReservedCacheNodesOfferingTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PurchaseReservedCacheNodesOfferingTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseReservedCacheNodesOfferingTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PurchaseReservedCacheNodesOfferingInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("ReservedCacheNodesOfferingId") {
            if let ::std::option::Option::Some(value) = input.reserved_cache_nodes_offering_id.as_deref() {
                captured.insert("ReservedCacheNodesOfferingId", value);
            }
        }
        if requested.should_capture("ReservedCacheNodeId") {
            if let ::std::option::Option::Some(value) = input.reserved_cache_node_id.as_deref() {
                captured.insert("ReservedCacheNodeId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurchaseReservedCacheNodesOfferingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_purchase_reserved_cache_nodes_offering::de_purchase_reserved_cache_nodes_offering_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_purchase_reserved_cache_nodes_offering::de_purchase_reserved_cache_nodes_offering_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurchaseReservedCacheNodesOfferingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::purchase_reserved_cache_nodes_offering::PurchaseReservedCacheNodesOfferingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::purchase_reserved_cache_nodes_offering::PurchaseReservedCacheNodesOfferingInput,
...
impl ::std::error::Error for PurchaseReservedCacheNodesOfferingError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::ReservedCacheNodeAlreadyExistsFault(_inner) => ::std::option::Option::Some(_inner),
            Self::ReservedCacheNodeQuotaExceededFault(_inner) => ::std::option::Option::Some(_inner),
            Self::ReservedCacheNodesOfferingNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PurchaseReservedCacheNodesOfferingError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ReservedCacheNodeAlreadyExistsFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::ReservedCacheNodeQuotaExceededFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::ReservedCacheNodesOfferingNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
