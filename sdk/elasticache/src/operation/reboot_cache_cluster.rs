...
impl RebootCacheClusterInput {
    /// Consumes the builder and constructs an Operation<[`RebootCacheCluster`](crate::operation::reboot_cache_cluster::RebootCacheCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_cache_cluster::RebootCacheCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_cache_cluster::RebootCacheClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_cache_cluster_input::ser_reboot_cache_cluster_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_cache_cluster::RebootCacheCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RebootCacheCluster", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for RebootCacheCluster {
                type Output = std::result::Result<crate::operation::reboot_cache_cluster::RebootCacheClusterOutput, crate::operation::reboot_cache_cluster::RebootCacheClusterError>;
