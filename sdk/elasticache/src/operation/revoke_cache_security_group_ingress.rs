...
impl RevokeCacheSecurityGroupIngress {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RevokeCacheSecurityGroupIngressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RevokeCacheSecurityGroupIngressRequestSerializer {
