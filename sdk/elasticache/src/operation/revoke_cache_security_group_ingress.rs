...
impl RevokeCacheSecurityGroupIngress {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RevokeCacheSecurityGroupIngress",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeCacheSecurityGroupIngress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RevokeCacheSecurityGroupIngressRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RevokeCacheSecurityGroupIngressResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RevokeCacheSecurityGroupIngress")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeCacheSecurityGroupIngress")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RevokeCacheSecurityGroupIngressTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RevokeCacheSecurityGroupIngressTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeCacheSecurityGroupIngressTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RevokeCacheSecurityGroupIngressInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeCacheSecurityGroupIngressResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_revoke_cache_security_group_ingress::de_revoke_cache_security_group_ingress_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_revoke_cache_security_group_ingress::de_revoke_cache_security_group_ingress_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeCacheSecurityGroupIngressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_cache_security_group_ingress_input::ser_revoke_cache_security_group_ingress_input_input_input(
                &input,
            )?,
        );
