...
impl RevokeCacheSecurityGroupIngress {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeCacheSecurityGroupIngress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeCacheSecurityGroupIngress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeCacheSecurityGroupIngressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeCacheSecurityGroupIngressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeCacheSecurityGroupIngress")
...
.with_interceptor(RevokeCacheSecurityGroupIngressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeCacheSecurityGroupIngressResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_revoke_cache_security_group_ingress::de_revoke_cache_security_group_ingress_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeCacheSecurityGroupIngressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_revoke_cache_security_group_ingress_input::ser_revoke_cache_security_group_ingress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RevokeCacheSecurityGroupIngressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeCacheSecurityGroupIngressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeCacheSecurityGroupIngressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeCacheSecurityGroupIngressInput>()
                        .ok_or("failed to downcast to RevokeCacheSecurityGroupIngressInput")?;
...
pub enum RevokeCacheSecurityGroupIngressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeCacheSecurityGroupIngressError) for what information is available for the error.")]
...
impl RevokeCacheSecurityGroupIngressError {
    /// Creates the `RevokeCacheSecurityGroupIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeCacheSecurityGroupIngressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeCacheSecurityGroupIngressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError {
