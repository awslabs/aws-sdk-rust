...
impl CopySnapshot {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ElastiCache", "CopySnapshot", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopySnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("TargetBucket") {
            if let ::std::option::Option::Some(value) = input.target_bucket.as_deref() {
                captured.insert("TargetBucket", value);
            }
        }
