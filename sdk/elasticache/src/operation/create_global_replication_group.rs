...
impl CreateGlobalReplicationGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_global_replication_group::CreateGlobalReplicationGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGlobalReplicationGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_global_replication_group::de_create_global_replication_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
