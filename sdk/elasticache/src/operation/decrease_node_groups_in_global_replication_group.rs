...
impl DecreaseNodeGroupsInGlobalReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`DecreaseNodeGroupsInGlobalReplicationGroup`](crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_decrease_node_groups_in_global_replication_group_input::ser_decrease_node_groups_in_global_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DecreaseNodeGroupsInGlobalReplicationGroup", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse
    for DecreaseNodeGroupsInGlobalReplicationGroup
{
    type Output = ::std::result::Result<crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroupOutput, crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decrease_node_groups_in_global_replication_group::de_decrease_node_groups_in_global_replication_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::decrease_node_groups_in_global_replication_group::DecreaseNodeGroupsInGlobalReplicationGroupError {
