...
/// Orchestration and serialization glue logic for `DeleteCacheSubnetGroup`.
...
impl DeleteCacheSubnetGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCacheSubnetGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCacheSubnetGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCacheSubnetGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCacheSubnetGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCacheSubnetGroup")
...
.with_interceptor(DeleteCacheSubnetGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCacheSubnetGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_cache_subnet_group::de_delete_cache_subnet_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_cache_subnet_group::de_delete_cache_subnet_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCacheSubnetGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_cache_subnet_group_input::ser_delete_cache_subnet_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCacheSubnetGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCacheSubnetGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCacheSubnetGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCacheSubnetGroupInput>()
                        .ok_or("failed to downcast to DeleteCacheSubnetGroupInput")?;
...
pub enum DeleteCacheSubnetGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCacheSubnetGroupError) for what information is available for the error.")]
...
impl DeleteCacheSubnetGroupError {
    /// Creates the `DeleteCacheSubnetGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCacheSubnetGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CacheSubnetGroupInUse(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCacheSubnetGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_cache_subnet_group::DeleteCacheSubnetGroupError {
...
mod _delete_cache_subnet_group_output;
