...
impl DescribeReplicationGroupsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_replication_groups::DescribeReplicationGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_groups::de_describe_replication_groups_http_response_with_props(status, headers, body)
        }
    }
}
