...
impl ModifyUserGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_user_group::ModifyUserGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyUserGroup {
    type Output =
        ::std::result::Result<crate::operation::modify_user_group::ModifyUserGroupOutput, crate::operation::modify_user_group::ModifyUserGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_user_group::de_modify_user_group_http_response_with_props(status, headers, body)
        }
    }
}
