...
impl DeleteCacheSecurityGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cache_security_group::DeleteCacheSecurityGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCacheSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cache_security_group::de_delete_cache_security_group_http_response_with_props(status, headers, body)
        }
    }
}
