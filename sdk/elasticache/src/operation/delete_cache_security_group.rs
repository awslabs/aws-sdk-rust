...
impl DeleteCacheSecurityGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCacheSecurityGroup`](crate::operation::delete_cache_security_group::DeleteCacheSecurityGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_cache_security_group::DeleteCacheSecurityGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cache_security_group::DeleteCacheSecurityGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_cache_security_group_input::ser_delete_cache_security_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cache_security_group::DeleteCacheSecurityGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteCacheSecurityGroup", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCacheSecurityGroup {
                type Output = std::result::Result<crate::operation::delete_cache_security_group::DeleteCacheSecurityGroupOutput, crate::operation::delete_cache_security_group::DeleteCacheSecurityGroupError>;
