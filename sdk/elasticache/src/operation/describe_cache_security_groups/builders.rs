...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsOutput,
                    crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsError,
                > for DescribeCacheSecurityGroupsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeCacheSecurityGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroups::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsOutput, crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_cache_security_groups::paginator::DescribeCacheSecurityGroupsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
