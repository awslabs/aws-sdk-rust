...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_service_updates_input::ser_describe_service_updates_input_input_input(&input)?);
