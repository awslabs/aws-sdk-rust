...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeServiceUpdates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeServiceUpdates", "elasticache"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeServiceUpdatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_service_updates_input::ser_describe_service_updates_input_input_input(&input)?,
        );
