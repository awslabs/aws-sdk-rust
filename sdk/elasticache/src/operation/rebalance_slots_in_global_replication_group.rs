...
impl RebalanceSlotsInGlobalReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`RebalanceSlotsInGlobalReplicationGroup`](crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rebalance_slots_in_global_replication_group_input::ser_rebalance_slots_in_global_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RebalanceSlotsInGlobalReplicationGroup", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebalanceSlotsInGlobalReplicationGroup {
    type Output = ::std::result::Result<crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroupOutput, crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rebalance_slots_in_global_replication_group::de_rebalance_slots_in_global_replication_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroupError {
