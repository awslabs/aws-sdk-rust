...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesOutput,
                    crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesError,
                > for DescribeReservedCacheNodesFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeReservedCacheNodesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodes::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesOutput, crate::operation::describe_reserved_cache_nodes::DescribeReservedCacheNodesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_reserved_cache_nodes::paginator::DescribeReservedCacheNodesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
