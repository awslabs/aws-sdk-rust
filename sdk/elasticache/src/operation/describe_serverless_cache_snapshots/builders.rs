...
impl DescribeServerlessCacheSnapshotsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_serverless_cache_snapshots::DescribeServerlessCacheSnapshotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_serverless_cache_snapshots::DescribeServerlessCacheSnapshotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_serverless_cache_snapshots::DescribeServerlessCacheSnapshotsOutput, crate::operation::describe_serverless_cache_snapshots::DescribeServerlessCacheSnapshotsError, Self> {
