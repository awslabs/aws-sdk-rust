...
impl DescribeServerlessCacheSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_serverless_cache_snapshots::DescribeServerlessCacheSnapshotsInput, ::aws_smithy_types::error::operation::BuildError> {
