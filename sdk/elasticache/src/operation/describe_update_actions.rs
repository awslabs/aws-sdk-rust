...
impl DescribeUpdateActionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUpdateActions`](crate::operation::describe_update_actions::DescribeUpdateActions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_update_actions::DescribeUpdateActions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_update_actions::DescribeUpdateActionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_update_actions_input::ser_describe_update_actions_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_update_actions::DescribeUpdateActions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeUpdateActions", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeUpdateActions {
                type Output = std::result::Result<crate::operation::describe_update_actions::DescribeUpdateActionsOutput, crate::operation::describe_update_actions::DescribeUpdateActionsError>;
