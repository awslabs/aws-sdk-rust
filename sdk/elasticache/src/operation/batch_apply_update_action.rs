...
impl BatchApplyUpdateActionInput {
    /// Consumes the builder and constructs an Operation<[`BatchApplyUpdateAction`](crate::operation::batch_apply_update_action::BatchApplyUpdateAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_apply_update_action::BatchApplyUpdateAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_apply_update_action::BatchApplyUpdateActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_apply_update_action_input::ser_batch_apply_update_action_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_apply_update_action::BatchApplyUpdateAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchApplyUpdateAction", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchApplyUpdateAction {
                type Output = std::result::Result<crate::operation::batch_apply_update_action::BatchApplyUpdateActionOutput, crate::operation::batch_apply_update_action::BatchApplyUpdateActionError>;
