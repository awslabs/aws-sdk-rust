...
impl BatchApplyUpdateAction {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_apply_update_action::BatchApplyUpdateActionInput,
                    ) -> ::std::result::Result<crate::operation::batch_apply_update_action::BatchApplyUpdateActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_apply_update_action::BatchApplyUpdateActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchApplyUpdateAction {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchApplyUpdateAction");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchApplyUpdateActionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchApplyUpdateActionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchApplyUpdateAction")
...
.with_interceptor(BatchApplyUpdateActionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionError>::new());
...
#[derive(Debug)]
            struct BatchApplyUpdateActionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchApplyUpdateActionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_apply_update_action::de_batch_apply_update_action_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_apply_update_action::de_batch_apply_update_action_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchApplyUpdateActionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchApplyUpdateActionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_apply_update_action::BatchApplyUpdateActionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_apply_update_action::BatchApplyUpdateActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_apply_update_action_input::ser_batch_apply_update_action_input_input_input(&input)?);
...
#[derive(Debug)]
            struct BatchApplyUpdateActionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchApplyUpdateActionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchApplyUpdateActionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchApplyUpdateActionInput>()
                        .ok_or("failed to downcast to BatchApplyUpdateActionInput")?;
...
pub enum BatchApplyUpdateActionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchApplyUpdateActionError) for what information is available for the error.")]
...
impl BatchApplyUpdateActionError {
    /// Creates the `BatchApplyUpdateActionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchApplyUpdateActionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ServiceUpdateNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchApplyUpdateActionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_apply_update_action::BatchApplyUpdateActionError {
...
mod _batch_apply_update_action_output;
