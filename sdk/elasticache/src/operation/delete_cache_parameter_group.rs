...
/// Orchestration and serialization glue logic for `DeleteCacheParameterGroup`.
...
impl DeleteCacheParameterGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCacheParameterGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCacheParameterGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCacheParameterGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCacheParameterGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCacheParameterGroup")
...
.with_interceptor(DeleteCacheParameterGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCacheParameterGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_cache_parameter_group::de_delete_cache_parameter_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_cache_parameter_group::de_delete_cache_parameter_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCacheParameterGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_cache_parameter_group_input::ser_delete_cache_parameter_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCacheParameterGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCacheParameterGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCacheParameterGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCacheParameterGroupInput>()
                        .ok_or("failed to downcast to DeleteCacheParameterGroupInput")?;
...
pub enum DeleteCacheParameterGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCacheParameterGroupError) for what information is available for the error.")]
...
impl DeleteCacheParameterGroupError {
    /// Creates the `DeleteCacheParameterGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCacheParameterGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidCacheParameterGroupStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCacheParameterGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError {
...
mod _delete_cache_parameter_group_output;
