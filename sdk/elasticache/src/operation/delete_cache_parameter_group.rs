...
impl DeleteCacheParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCacheParameterGroup`](crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_cache_parameter_group_input::ser_delete_cache_parameter_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteCacheParameterGroup", "elasticache"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteCacheParameterGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCacheParameterGroup {
                type Output = std::result::Result<crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupOutput, crate::operation::delete_cache_parameter_group::DeleteCacheParameterGroupError>;
