...
impl StartMigrationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_migration_input::ser_start_migration_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_migration::StartMigration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMigration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_migration::de_start_migration_http_error(
                status, headers, body,
            )
        } else {
