...
impl StartMigrationInput {
    /// Consumes the builder and constructs an Operation<[`StartMigration`](crate::operation::start_migration::StartMigration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_migration::StartMigration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_migration::StartMigrationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_migration_input::ser_start_migration_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_migration::StartMigration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartMigration", "elasticache"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartMigration {
                type Output = std::result::Result<crate::operation::start_migration::StartMigrationOutput, crate::operation::start_migration::StartMigrationError>;
