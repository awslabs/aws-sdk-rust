...
/// Orchestration and serialization glue logic for `CreateCacheSecurityGroup`.
...
impl CreateCacheSecurityGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_cache_security_group::CreateCacheSecurityGroupInput,
                    ) -> ::std::result::Result<crate::operation::create_cache_security_group::CreateCacheSecurityGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cache_security_group::CreateCacheSecurityGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCacheSecurityGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCacheSecurityGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCacheSecurityGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCacheSecurityGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCacheSecurityGroup")
...
.with_interceptor(CreateCacheSecurityGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCacheSecurityGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_cache_security_group::de_create_cache_security_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_cache_security_group::de_create_cache_security_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCacheSecurityGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_cache_security_group::CreateCacheSecurityGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_cache_security_group::CreateCacheSecurityGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_cache_security_group_input::ser_create_cache_security_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateCacheSecurityGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCacheSecurityGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCacheSecurityGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCacheSecurityGroupInput>()
                        .ok_or("failed to downcast to CreateCacheSecurityGroupInput")?;
...
pub enum CreateCacheSecurityGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCacheSecurityGroupError) for what information is available for the error.")]
...
impl CreateCacheSecurityGroupError {
    /// Creates the `CreateCacheSecurityGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCacheSecurityGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CacheSecurityGroupAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::CacheSecurityGroupQuotaExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCacheSecurityGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_cache_security_group::CreateCacheSecurityGroupError {
...
mod _create_cache_security_group_output;
