...
impl CreateCacheSecurityGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cache_security_group::CreateCacheSecurityGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCacheSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cache_security_group::de_create_cache_security_group_http_response_with_props(status, headers, body)
        }
    }
}
