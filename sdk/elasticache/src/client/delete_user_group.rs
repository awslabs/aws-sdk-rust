...
impl super::Client {
    ...
    ///   - [`user_group_id(impl Into<String>)`](crate::operation::delete_user_group::builders::DeleteUserGroupFluentBuilder::user_group_id) / [`set_user_group_id(Option<String>)`](crate::operation::delete_user_group::builders::DeleteUserGroupFluentBuilder::set_user_group_id):<br>required: **true**<br><p>The ID of the user group.</p><br>
    ...
    ///   - [`serverless_caches(Option<Vec::<String>>)`](crate::operation::delete_user_group::DeleteUserGroupOutput::serverless_caches): <p>Indicates which serverless caches the specified user group is associated with. Available for Valkey, Redis OSS and Serverless Memcached only.</p>
