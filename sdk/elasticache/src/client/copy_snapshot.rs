...
impl super::Client {
    ...
    ///   - [`target_snapshot_name(impl Into<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::target_snapshot_name) / [`set_target_snapshot_name(Option<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::set_target_snapshot_name): <p>A name for the snapshot copy. ElastiCache does not permit overwriting a snapshot, therefore this name must be unique within its context - ElastiCache or an Amazon S3 bucket if exporting.</p>
