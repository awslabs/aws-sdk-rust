...
impl super::Client {
    ...
    ///   - [`replication_group_id(impl Into<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::replication_group_id) / [`set_replication_group_id(Option<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::set_replication_group_id):<br>required: **false**<br><p>The identifier of an existing replication group. The snapshot is created from this replication group.</p><br>
    ///   - [`cache_cluster_id(impl Into<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::cache_cluster_id) / [`set_cache_cluster_id(Option<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::set_cache_cluster_id):<br>required: **false**<br><p>The identifier of an existing cluster. The snapshot is created from this cluster.</p><br>
