...
impl super::Client {
    ...
    ///   - [`user_ids_to_add(impl Into<String>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::user_ids_to_add) / [`set_user_ids_to_add(Option<Vec<String>>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::set_user_ids_to_add): <p>The list of user IDs to add to the user group.</p>
    ///   - [`user_ids_to_remove(impl Into<String>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::user_ids_to_remove) / [`set_user_ids_to_remove(Option<Vec<String>>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::set_user_ids_to_remove): <p>The list of user IDs to remove from the user group.</p>
