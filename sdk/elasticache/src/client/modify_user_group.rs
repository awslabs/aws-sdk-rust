...
impl super::Client {
    ...
    ///   - [`user_group_id(impl ::std::convert::Into<String>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::user_group_id) / [`set_user_group_id(Option<String>)`](crate::operation::modify_user_group::builders::ModifyUserGroupFluentBuilder::set_user_group_id): <p>The ID of the user group.</p>
