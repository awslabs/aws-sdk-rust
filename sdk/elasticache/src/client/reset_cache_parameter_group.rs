...
impl super::Client {
    ...
    ///   - [`reset_all_parameters(bool)`](crate::operation::reset_cache_parameter_group::builders::ResetCacheParameterGroupFluentBuilder::reset_all_parameters) / [`set_reset_all_parameters(Option<bool>)`](crate::operation::reset_cache_parameter_group::builders::ResetCacheParameterGroupFluentBuilder::set_reset_all_parameters): <p>If <code>true</code>, all parameters in the cache parameter group are reset to their default values. If <code>false</code>, only the parameters listed by <code>ParameterNameValues</code> are reset to their default values.</p>  <p>Valid values: <code>true</code> | <code>false</code> </p>
