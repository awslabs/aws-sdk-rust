...
impl super::Client {
    ...
    ///   - [`snapshot(Option<Snapshot>)`](crate::operation::delete_snapshot::DeleteSnapshotOutput::snapshot): <p>Represents a copy of an entire Valkey or Redis OSS cluster as of the time when the snapshot was taken.</p>
