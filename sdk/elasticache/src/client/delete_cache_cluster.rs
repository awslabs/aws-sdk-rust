...
impl super::Client {
    ...
    ///   - [`cache_cluster_id(impl Into<String>)`](crate::operation::delete_cache_cluster::builders::DeleteCacheClusterFluentBuilder::cache_cluster_id) / [`set_cache_cluster_id(Option<String>)`](crate::operation::delete_cache_cluster::builders::DeleteCacheClusterFluentBuilder::set_cache_cluster_id):<br>required: **true**<br><p>The cluster identifier for the cluster to be deleted. This parameter is not case sensitive.</p><br>
    ///   - [`final_snapshot_identifier(impl Into<String>)`](crate::operation::delete_cache_cluster::builders::DeleteCacheClusterFluentBuilder::final_snapshot_identifier) / [`set_final_snapshot_identifier(Option<String>)`](crate::operation::delete_cache_cluster::builders::DeleteCacheClusterFluentBuilder::set_final_snapshot_identifier):<br>required: **false**<br><p>The user-supplied name of a final cluster snapshot. This is the unique name that identifies the snapshot. ElastiCache creates the snapshot, and then deletes the cluster immediately afterward.</p><br>
