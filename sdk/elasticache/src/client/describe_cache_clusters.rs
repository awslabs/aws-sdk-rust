...
impl super::Client {
    ...
    ///   - [`cache_cluster_id(impl ::std::convert::Into<String>)`](crate::operation::describe_cache_clusters::builders::DescribeCacheClustersFluentBuilder::cache_cluster_id) / [`set_cache_cluster_id(Option<String>)`](crate::operation::describe_cache_clusters::builders::DescribeCacheClustersFluentBuilder::set_cache_cluster_id): <p>The user-supplied cluster identifier. If this parameter is specified, only information about that specific cluster is returned. This parameter isn't case sensitive.</p>
