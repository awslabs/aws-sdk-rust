...
impl super::Client {
    ...
    ///   - [`replication_group(Option<ReplicationGroup>)`](crate::operation::test_failover::TestFailoverOutput::replication_group): <p>Contains all of the attributes of a specific Valkey or Redis OSS replication group.</p>
