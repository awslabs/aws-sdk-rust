...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_filters): <p>Filter to determine the list of User IDs to return.</p>
