...
impl super::Client {
    ...
    ///   - [`engine(impl Into<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::engine) / [`set_engine(Option<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_engine):<br>required: **false**<br><p>The Redis OSS engine.</p><br>
