    ...
    Err(match error_code {
        ...
        "InvalidUserState" => crate::operation::delete_user::DeleteUserError::InvalidUserStateFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_user_state_fault::de_invalid_user_state_fault_xml_err(_response_body, output)
                    .map_err(crate::operation::delete_user::DeleteUserError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
pub fn de_delete_user(
...
) -> std::result::Result<crate::operation::delete_user::builders::DeleteUserOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteUserResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteUserResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeleteUserResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeleteUserResult got {start_el:?}"
            )));
        }
