...
#[allow(unused_mut)]
pub fn ser_time_range_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TimeRangeFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
