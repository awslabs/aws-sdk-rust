...
pub fn de_copy_snapshot_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CopySnapshotOutput, crate::error::CopySnapshotError> {
    ...
    Err(match error_code {
        "InvalidParameterCombination" => crate::error::CopySnapshotError::InvalidParameterCombinationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValue" => crate::error::CopySnapshotError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_copy_snapshot(inp: &[u8], mut builder: crate::output::copy_snapshot_output::Builder) -> Result<crate::output::copy_snapshot_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
