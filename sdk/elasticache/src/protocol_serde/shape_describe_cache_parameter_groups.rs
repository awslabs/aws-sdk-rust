...
pub fn de_describe_cache_parameter_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeCacheParameterGroupsOutput, crate::error::DescribeCacheParameterGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeCacheParameterGroupsError::unhandled)?;
    ...
    Err(match error_code {
        "CacheParameterGroupNotFound" => crate::error::DescribeCacheParameterGroupsError::CacheParameterGroupNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterCombination" => crate::error::DescribeCacheParameterGroupsError::InvalidParameterCombinationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValue" => crate::error::DescribeCacheParameterGroupsError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cache_parameter_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeCacheParameterGroupsOutput, crate::error::DescribeCacheParameterGroupsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_describe_cache_parameter_groups(inp: &[u8], mut builder: crate::output::describe_cache_parameter_groups_output::Builder) -> Result<crate::output::describe_cache_parameter_groups_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
