...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::unhandled)?;
    ...
    Err(match error_code {
        "CacheParameterGroupNotFound" => {
            crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::CacheParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterCombination" => {
            crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValue" => {
            crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_cache_parameter_groups::de_describe_cache_parameter_groups(_response_body, output)
            .map_err(crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::unhandled)?;
...
pub fn de_describe_cache_parameter_groups(
    inp: &[u8],
    mut builder: crate::operation::describe_cache_parameter_groups::builders::DescribeCacheParameterGroupsOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_cache_parameter_groups::builders::DescribeCacheParameterGroupsOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeCacheParameterGroupsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeCacheParameterGroupsResult got {start_el:?}"
            )));
        }
