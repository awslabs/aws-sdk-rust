...
pub fn de_describe_cache_parameter_groups_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError> {
    #[allow(unused_mut)]
