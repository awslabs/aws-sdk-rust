...
pub fn de_describe_cache_parameter_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cache_parameter_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError> {
    Ok({
        #[allow(unused_mut)]
