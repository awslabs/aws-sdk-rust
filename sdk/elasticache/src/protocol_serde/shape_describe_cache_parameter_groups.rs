...
pub fn de_describe_cache_parameter_groups_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cache_parameter_group_not_found_fault::de_cache_parameter_group_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_xml_err(_response_body, output).map_err(crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_xml_err(_response_body, output).map_err(crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cache_parameter_groups_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsOutput, crate::operation::describe_cache_parameter_groups::DescribeCacheParameterGroupsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn de_describe_cache_parameter_groups(inp: &[u8], mut builder: crate::operation::describe_cache_parameter_groups::builders::DescribeCacheParameterGroupsOutputBuilder) -> Result<crate::operation::describe_cache_parameter_groups::builders::DescribeCacheParameterGroupsOutputBuilder, aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeCacheParameterGroupsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected DescribeCacheParameterGroupsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeCacheParameterGroupsResult")) {
                            return Err(aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected DescribeCacheParameterGroupsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("CacheParameterGroups") /* CacheParameterGroups com.amazonaws.elasticache.synthetic#DescribeCacheParameterGroupsOutput$CacheParameterGroups */ =>  {
                ...
                ;
                builder = builder.set_cache_parameter_groups(var_2);
            }
            ,
            _ => {}
        }
                        ...
                        return Err(aws_smithy_xml::decode::XmlDecodeError::custom("expected DescribeCacheParameterGroupsResult tag"))
                    };
    Ok(builder)
}
