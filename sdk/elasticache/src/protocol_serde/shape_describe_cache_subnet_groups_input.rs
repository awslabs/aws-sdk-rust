...
pub fn ser_describe_cache_subnet_groups_input_input_input(input: &crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
