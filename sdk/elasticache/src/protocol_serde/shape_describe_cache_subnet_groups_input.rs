...
pub fn ser_describe_cache_subnet_groups_input_input(input: &crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
