...
pub fn ser_delete_cache_security_group_input_input(input: &crate::input::DeleteCacheSecurityGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
