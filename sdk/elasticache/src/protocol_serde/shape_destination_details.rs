...
#[allow(unused_mut)]
pub fn ser_destination_details(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DestinationDetails) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
