...
#[allow(unused_mut)]
pub fn ser_destination_details(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DestinationDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_destination_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DestinationDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
