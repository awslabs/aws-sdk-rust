...
pub fn ser_modify_user_input_input_input(input: &crate::operation::modify_user::ModifyUserInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
