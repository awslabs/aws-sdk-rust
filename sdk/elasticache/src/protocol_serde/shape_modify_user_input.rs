...
pub fn ser_modify_user_input_input(input: &crate::input::ModifyUserInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
