...
pub fn ser_copy_snapshot_input_input_input(input: &crate::operation::copy_snapshot::CopySnapshotInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
