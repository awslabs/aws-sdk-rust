...
pub fn de_modify_global_replication_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupOutput, crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_global_replication_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupOutput, crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupError> {
    Ok({
        #[allow(unused_mut)]
