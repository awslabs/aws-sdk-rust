...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_apply_update_action::BatchApplyUpdateActionError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_apply_update_action::de_batch_apply_update_action(_response_body, output)
            .map_err(crate::operation::batch_apply_update_action::BatchApplyUpdateActionError::unhandled)?;
...
) -> Result<crate::operation::batch_apply_update_action::builders::BatchApplyUpdateActionOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
