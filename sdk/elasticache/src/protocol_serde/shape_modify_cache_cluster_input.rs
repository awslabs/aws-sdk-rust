...
pub fn ser_modify_cache_cluster_input_input(input: &crate::input::ModifyCacheClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
