...
pub fn de_create_cache_cluster_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_cache_cluster::CreateCacheClusterOutput, crate::operation::create_cache_cluster::CreateCacheClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_cache_cluster::CreateCacheClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cache_cluster_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_cache_cluster::CreateCacheClusterOutput, crate::operation::create_cache_cluster::CreateCacheClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_cache_cluster::builders::CreateCacheClusterOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_cache_cluster::de_create_cache_cluster(response.body().as_ref(), output).map_err(crate::operation::create_cache_cluster::CreateCacheClusterError::unhandled)?;
