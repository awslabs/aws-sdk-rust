...
pub fn de_delete_snapshot_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteSnapshotOutput, crate::error::DeleteSnapshotError> {
    ...
    Err(match error_code {
        "InvalidParameterCombination" => crate::error::DeleteSnapshotError::InvalidParameterCombinationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValue" => crate::error::DeleteSnapshotError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_delete_snapshot(inp: &[u8], mut builder: crate::output::delete_snapshot_output::Builder) -> Result<crate::output::delete_snapshot_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
