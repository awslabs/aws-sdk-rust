...
pub fn de_delete_snapshot(
...
) -> std::result::Result<crate::operation::delete_snapshot::builders::DeleteSnapshotOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeleteSnapshotResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeleteSnapshotResult got {start_el:?}"
            )));
        }
