...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_user_groups::de_describe_user_groups(_response_body, output)
            .map_err(crate::operation::describe_user_groups::DescribeUserGroupsError::unhandled)?;
...
) -> std::result::Result<crate::operation::describe_user_groups::builders::DescribeUserGroupsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeUserGroupsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeUserGroupsResult got {start_el:?}"
            )));
        }
