...
pub fn ser_modify_global_replication_group_input_input(input: &crate::input::ModifyGlobalReplicationGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
