...
pub fn de_processed_update_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ProcessedUpdateAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
