...
pub fn ser_describe_cache_security_groups_input_input_input(input: &crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
