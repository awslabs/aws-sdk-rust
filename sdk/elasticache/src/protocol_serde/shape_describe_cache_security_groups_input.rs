...
pub fn ser_describe_cache_security_groups_input_input(input: &crate::input::DescribeCacheSecurityGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
