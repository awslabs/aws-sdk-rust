...
pub fn de_cache_parameter_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheParameterGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
