...
pub fn ser_failover_global_replication_group_input_input(input: &crate::input::FailoverGlobalReplicationGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
