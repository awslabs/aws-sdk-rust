...
pub fn ser_delete_cache_parameter_group_input_input(input: &crate::input::DeleteCacheParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
