...
pub fn ser_decrease_replica_count_input_input_input(input: &crate::operation::decrease_replica_count::DecreaseReplicaCountInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
