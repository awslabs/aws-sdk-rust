...
pub fn ser_increase_node_groups_in_global_replication_group_input_input(
    input: &crate::operation::increase_node_groups_in_global_replication_group::IncreaseNodeGroupsInGlobalReplicationGroupInput,
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    if let Some(var_5) = &input.regional_configurations {
        ...
        for item_6 in var_5 {
            ...
            crate::protocol_serde::shape_regional_configuration::ser_regional_configuration(
                entry_8, item_6,
            )?;
        }
        list_7.finish();
