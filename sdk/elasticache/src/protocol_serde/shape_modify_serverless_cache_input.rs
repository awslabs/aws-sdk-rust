...
pub fn ser_modify_serverless_cache_input_input_input(input: &crate::operation::modify_serverless_cache::ModifyServerlessCacheInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
