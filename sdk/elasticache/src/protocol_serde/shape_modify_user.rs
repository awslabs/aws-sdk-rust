...
pub fn de_modify_user_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_user::ModifyUserOutput, crate::operation::modify_user::ModifyUserError> {
    #[allow(unused_mut)]
...
pub fn de_modify_user(
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyUserResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyUserResult got {start_el:?}"
            )));
        }
