...
pub fn de_delete_user_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteUserGroupOutput, crate::error::DeleteUserGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteUserGroupError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidParameterValue" => crate::error::DeleteUserGroupError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteUserGroupError::unhandled)?;
        ...
        "InvalidUserGroupState" => crate::error::DeleteUserGroupError::InvalidUserGroupStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_user_group_state_fault::de_invalid_user_group_state_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteUserGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "ServiceLinkedRoleNotFoundFault" => crate::error::DeleteUserGroupError::ServiceLinkedRoleNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_linked_role_not_found_fault::de_service_linked_role_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteUserGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_user_group_not_found_fault::de_user_group_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteUserGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_user_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteUserGroupOutput, crate::error::DeleteUserGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_user_group_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_user_group::de_delete_user_group(response.body().as_ref(), output).map_err(crate::error::DeleteUserGroupError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_user_group(inp: &[u8], mut builder: crate::output::delete_user_group_output::Builder) -> Result<crate::output::delete_user_group_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
