...
pub fn de_delete_user_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_user_group::DeleteUserGroupOutput, crate::operation::delete_user_group::DeleteUserGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_user_group::DeleteUserGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_user_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_user_group::DeleteUserGroupOutput, crate::operation::delete_user_group::DeleteUserGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_user_group::builders::DeleteUserGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_user_group::de_delete_user_group(_response_body, output).map_err(crate::operation::delete_user_group::DeleteUserGroupError::unhandled)?;
