...
pub fn ser_describe_user_groups_input_input(input: &crate::input::DescribeUserGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
