...
pub fn ser_describe_user_groups_input_input_input(input: &crate::operation::describe_user_groups::DescribeUserGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
