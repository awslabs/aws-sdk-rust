...
pub fn ser_describe_replication_groups_input_input_input(input: &crate::operation::describe_replication_groups::DescribeReplicationGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
