...
pub fn ser_describe_replication_groups_input_input(input: &crate::input::DescribeReplicationGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
