...
pub fn de_cache_subnet_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::CacheSubnetGroup>, aws_smithy_xml::decode::XmlDecodeError> {
