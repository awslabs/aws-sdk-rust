...
pub fn ser_describe_cache_parameter_groups_input_input(input: &crate::input::DescribeCacheParameterGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
