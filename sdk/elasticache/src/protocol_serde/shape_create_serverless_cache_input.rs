...
pub fn ser_create_serverless_cache_input_input_input(input: &crate::operation::create_serverless_cache::CreateServerlessCacheInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
