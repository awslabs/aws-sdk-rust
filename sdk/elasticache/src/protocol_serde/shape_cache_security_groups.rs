...
pub fn de_cache_security_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::CacheSecurityGroup>, aws_smithy_xml::decode::XmlDecodeError> {
