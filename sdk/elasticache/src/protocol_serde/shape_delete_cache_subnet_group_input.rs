...
pub fn ser_delete_cache_subnet_group_input_input(input: &crate::input::DeleteCacheSubnetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
