...
#[allow(unused_mut)]
pub fn ser_data_storage(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DataStorage) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_data_storage(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::DataStorage, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
