...
pub fn ser_describe_users_input_input(input: &crate::input::DescribeUsersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
