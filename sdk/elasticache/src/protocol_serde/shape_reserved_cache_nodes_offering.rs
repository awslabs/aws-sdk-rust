...
pub fn de_reserved_cache_nodes_offering(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedCacheNodesOffering, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
