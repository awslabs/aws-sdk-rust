...
pub fn de_reserved_cache_node_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::ReservedCacheNode>, aws_smithy_xml::decode::XmlDecodeError> {
