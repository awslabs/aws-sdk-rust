...
pub fn de_global_replication_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GlobalReplicationGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
