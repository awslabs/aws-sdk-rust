...
pub fn de_modify_user_group_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_user_group::de_modify_user_group(_response_body, output)
            .map_err(crate::operation::modify_user_group::ModifyUserGroupError::unhandled)?;
...
pub fn de_modify_user_group(
...
) -> std::result::Result<crate::operation::modify_user_group::builders::ModifyUserGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyUserGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyUserGroupResult got {start_el:?}"
            )));
        }
