...
pub fn de_serverless_cache_snapshot(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ServerlessCacheSnapshot, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
