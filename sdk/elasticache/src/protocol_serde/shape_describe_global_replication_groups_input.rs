...
pub fn ser_describe_global_replication_groups_input_input(input: &crate::input::DescribeGlobalReplicationGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
