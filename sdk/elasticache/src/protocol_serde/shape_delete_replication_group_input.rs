...
pub fn ser_delete_replication_group_input_input_input(input: &crate::operation::delete_replication_group::DeleteReplicationGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
