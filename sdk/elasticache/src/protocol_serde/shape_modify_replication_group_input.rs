...
pub fn ser_modify_replication_group_input_input(input: &crate::input::ModifyReplicationGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
