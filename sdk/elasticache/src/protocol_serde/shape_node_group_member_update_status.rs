...
pub fn de_node_group_member_update_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NodeGroupMemberUpdateStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
