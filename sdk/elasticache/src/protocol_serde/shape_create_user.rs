    ...
    Err(match error_code {
        ...
        "UserAlreadyExists" => crate::operation::create_user::CreateUserError::UserAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_user_already_exists_fault::de_user_already_exists_fault_xml_err(_response_body, output)
                    .map_err(crate::operation::create_user::CreateUserError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "UserQuotaExceeded" => crate::operation::create_user::CreateUserError::UserQuotaExceededFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_user_quota_exceeded_fault::de_user_quota_exceeded_fault_xml_err(_response_body, output)
                    .map_err(crate::operation::create_user::CreateUserError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
