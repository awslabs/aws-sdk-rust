...
pub fn de_replication_group_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ReplicationGroup>, aws_smithy_xml::decode::XmlDecodeError> {
