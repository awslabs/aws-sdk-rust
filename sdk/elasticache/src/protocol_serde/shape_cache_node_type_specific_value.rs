...
pub fn de_cache_node_type_specific_value(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheNodeTypeSpecificValue, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
