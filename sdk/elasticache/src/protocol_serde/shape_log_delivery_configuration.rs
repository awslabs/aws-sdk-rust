...
pub fn de_log_delivery_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LogDeliveryConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
