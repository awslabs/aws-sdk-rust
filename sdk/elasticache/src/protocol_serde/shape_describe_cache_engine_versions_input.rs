...
pub fn ser_describe_cache_engine_versions_input_input(input: &crate::input::DescribeCacheEngineVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
