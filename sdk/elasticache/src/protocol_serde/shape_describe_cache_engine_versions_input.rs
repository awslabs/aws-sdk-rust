...
pub fn ser_describe_cache_engine_versions_input_input_input(input: &crate::operation::describe_cache_engine_versions::DescribeCacheEngineVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
