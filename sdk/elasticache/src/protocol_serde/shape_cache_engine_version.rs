...
pub fn de_cache_engine_version(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheEngineVersion, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
