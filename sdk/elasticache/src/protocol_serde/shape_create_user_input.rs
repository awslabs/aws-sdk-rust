...
pub fn ser_create_user_input_input_input(input: &crate::operation::create_user::CreateUserInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
