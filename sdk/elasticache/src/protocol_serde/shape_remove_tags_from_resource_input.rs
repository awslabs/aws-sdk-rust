...
pub fn ser_remove_tags_from_resource_input_input_input(input: &crate::operation::remove_tags_from_resource::RemoveTagsFromResourceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
