...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::modify_replication_group::ModifyReplicationGroupError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InsufficientCacheClusterCapacity" => {
            crate::operation::modify_replication_group::ModifyReplicationGroupError::InsufficientCacheClusterCapacityFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidCacheSecurityGroupState" => {
            crate::operation::modify_replication_group::ModifyReplicationGroupError::InvalidCacheSecurityGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterCombination" => {
            crate::operation::modify_replication_group::ModifyReplicationGroupError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidReplicationGroupState" => {
            crate::operation::modify_replication_group::ModifyReplicationGroupError::InvalidReplicationGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NodeQuotaForCustomerExceeded" => {
            crate::operation::modify_replication_group::ModifyReplicationGroupError::NodeQuotaForCustomerExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_replication_group::de_modify_replication_group(_response_body, output)
            .map_err(crate::operation::modify_replication_group::ModifyReplicationGroupError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyReplicationGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyReplicationGroupResult got {start_el:?}"
            )));
        }
