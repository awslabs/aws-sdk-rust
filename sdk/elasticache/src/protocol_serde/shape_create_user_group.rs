...
pub fn de_create_user_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_user_group::CreateUserGroupOutput, crate::operation::create_user_group::CreateUserGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_user_group::CreateUserGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_user_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_user_group::CreateUserGroupOutput, crate::operation::create_user_group::CreateUserGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_user_group::builders::CreateUserGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_create_user_group::de_create_user_group(_response_body, output).map_err(crate::operation::create_user_group::CreateUserGroupError::unhandled)?;
...
pub fn de_create_user_group(inp: &[u8], mut builder: crate::operation::create_user_group::builders::CreateUserGroupOutputBuilder) -> Result<crate::operation::create_user_group::builders::CreateUserGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("ServerlessCaches") /* ServerlessCaches com.amazonaws.elasticache.synthetic#CreateUserGroupOutput$ServerlessCaches */ =>  {
                let var_8 =
                    Some(
