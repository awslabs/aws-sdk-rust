...
pub fn de_create_user_group_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_user_group::CreateUserGroupOutput, crate::operation::create_user_group::CreateUserGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_user_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_user_group::CreateUserGroupOutput, crate::operation::create_user_group::CreateUserGroupError> {
    Ok({
        #[allow(unused_mut)]
