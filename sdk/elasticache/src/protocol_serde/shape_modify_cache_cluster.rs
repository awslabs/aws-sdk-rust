...
pub fn de_modify_cache_cluster_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_cache_cluster::ModifyCacheClusterOutput, crate::operation::modify_cache_cluster::ModifyCacheClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_cache_cluster::ModifyCacheClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cache_cluster_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_cache_cluster::ModifyCacheClusterOutput, crate::operation::modify_cache_cluster::ModifyCacheClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_cache_cluster::builders::ModifyCacheClusterOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_cache_cluster::de_modify_cache_cluster(_response_body, output).map_err(crate::operation::modify_cache_cluster::ModifyCacheClusterError::unhandled)?;
