...
pub fn de_modify_cache_cluster_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_cache_cluster::ModifyCacheClusterOutput, crate::operation::modify_cache_cluster::ModifyCacheClusterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cache_cluster_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_cache_cluster::ModifyCacheClusterOutput, crate::operation::modify_cache_cluster::ModifyCacheClusterError> {
    Ok({
        #[allow(unused_mut)]
