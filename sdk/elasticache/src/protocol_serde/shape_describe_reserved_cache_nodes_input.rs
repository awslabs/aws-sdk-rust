...
pub fn ser_describe_reserved_cache_nodes_input_input(input: &crate::input::DescribeReservedCacheNodesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
