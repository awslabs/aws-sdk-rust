...
#[allow(unused_mut)]
pub fn ser_customer_node_endpoint(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CustomerNodeEndpoint) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
