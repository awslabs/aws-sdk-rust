...
pub fn de_global_replication_group_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GlobalReplicationGroupInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
