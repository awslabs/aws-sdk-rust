...
#[allow(unused_mut)]
pub fn ser_configure_shard(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ConfigureShard) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
