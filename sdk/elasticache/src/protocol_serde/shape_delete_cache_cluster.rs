...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_cache_cluster::DeleteCacheClusterError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_cache_cluster_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_cache_cluster::de_delete_cache_cluster(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_cache_cluster::DeleteCacheClusterError::unhandled)?;
...
pub fn de_delete_cache_cluster(
    ...
    crate::operation::delete_cache_cluster::builders::DeleteCacheClusterOutputBuilder,
