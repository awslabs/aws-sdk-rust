...
pub fn de_cache_node_type_specific_parameter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheNodeTypeSpecificParameter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
