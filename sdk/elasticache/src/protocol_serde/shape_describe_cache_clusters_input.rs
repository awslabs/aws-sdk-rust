...
pub fn ser_describe_cache_clusters_input_input(input: &crate::input::DescribeCacheClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
