...
pub fn ser_create_user_group_input_input(input: &crate::operation::create_user_group::CreateUserGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
