...
pub fn ser_create_cache_parameter_group_input_input(input: &crate::input::CreateCacheParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
