...
pub fn ser_create_cache_parameter_group_input_input_input(input: &crate::operation::create_cache_parameter_group::CreateCacheParameterGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
