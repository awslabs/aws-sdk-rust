...
pub fn de_cache_parameter_group_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheParameterGroupStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
