...
pub fn ser_describe_cache_parameters_input_input_input(input: &crate::operation::describe_cache_parameters::DescribeCacheParametersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
