...
pub fn ser_create_replication_group_input_input_input(input: &crate::operation::create_replication_group::CreateReplicationGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
