...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reboot_cache_cluster_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reboot_cache_cluster::RebootCacheClusterOutput, crate::operation::reboot_cache_cluster::RebootCacheClusterError> {
    Ok({
        #[allow(unused_mut)]
