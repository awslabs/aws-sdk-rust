...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_service_updates::DescribeServiceUpdatesError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_service_updates::DescribeServiceUpdatesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterCombination" => {
            crate::operation::describe_service_updates::DescribeServiceUpdatesError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_service_updates_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_service_updates::de_describe_service_updates(_response_body, output)
            .map_err(crate::operation::describe_service_updates::DescribeServiceUpdatesError::unhandled)?;
...
) -> Result<crate::operation::describe_service_updates::builders::DescribeServiceUpdatesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
