...
> {
    ...
    Err(match error_code {
        "InvalidParameterCombination" => {
            crate::operation::describe_update_actions::DescribeUpdateActionsError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_update_actions::de_describe_update_actions(_response_body, output)
            .map_err(crate::operation::describe_update_actions::DescribeUpdateActionsError::unhandled)?;
...
) -> Result<crate::operation::describe_update_actions::builders::DescribeUpdateActionsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
