...
pub fn de_create_cache_parameter_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cache_parameter_group::CreateCacheParameterGroupOutput, crate::operation::create_cache_parameter_group::CreateCacheParameterGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cache_parameter_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cache_parameter_group::CreateCacheParameterGroupOutput, crate::operation::create_cache_parameter_group::CreateCacheParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
