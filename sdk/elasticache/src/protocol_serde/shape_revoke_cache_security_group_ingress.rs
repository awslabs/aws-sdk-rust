...
pub fn de_revoke_cache_security_group_ingress_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput, crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError> {
    #[allow(unused_mut)]
