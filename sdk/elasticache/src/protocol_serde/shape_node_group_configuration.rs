...
#[allow(unused_mut)]
pub fn ser_node_group_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::NodeGroupConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_node_group_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NodeGroupConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
