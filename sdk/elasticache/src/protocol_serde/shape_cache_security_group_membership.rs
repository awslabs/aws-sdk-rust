...
pub fn de_cache_security_group_membership(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheSecurityGroupMembership, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
