...
pub fn ser_describe_update_actions_input_input(input: &crate::input::DescribeUpdateActionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
