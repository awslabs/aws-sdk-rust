...
pub fn ser_describe_update_actions_input_input_input(input: &crate::operation::describe_update_actions::DescribeUpdateActionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
