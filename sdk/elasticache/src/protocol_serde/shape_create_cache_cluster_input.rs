...
pub fn ser_create_cache_cluster_input_input_input(input: &crate::operation::create_cache_cluster::CreateCacheClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
