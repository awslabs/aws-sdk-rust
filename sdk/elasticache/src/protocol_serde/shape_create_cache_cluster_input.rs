...
pub fn ser_create_cache_cluster_input_input(input: &crate::input::CreateCacheClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
