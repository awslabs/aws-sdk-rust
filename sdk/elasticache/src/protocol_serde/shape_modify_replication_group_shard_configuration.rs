...
pub fn de_modify_replication_group_shard_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_replication_group_shard_configuration::ModifyReplicationGroupShardConfigurationError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::modify_replication_group_shard_configuration::ModifyReplicationGroupShardConfigurationError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_replication_group_shard_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_replication_group_shard_configuration::de_modify_replication_group_shard_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::modify_replication_group_shard_configuration::ModifyReplicationGroupShardConfigurationError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyReplicationGroupShardConfigurationResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyReplicationGroupShardConfigurationResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyReplicationGroupShardConfigurationResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyReplicationGroupShardConfigurationResult got {start_el:?}"
            )));
        }
