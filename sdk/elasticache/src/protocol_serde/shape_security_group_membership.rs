...
pub fn de_security_group_membership(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SecurityGroupMembership, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
