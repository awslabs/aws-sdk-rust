...
pub fn de_cache_security_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheSecurityGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
