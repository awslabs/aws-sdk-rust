...
pub fn de_global_replication_group_member(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GlobalReplicationGroupMember, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
