...
pub fn ser_create_global_replication_group_input_input(input: &crate::input::CreateGlobalReplicationGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
