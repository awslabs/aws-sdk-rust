...
pub fn ser_create_global_replication_group_input_input_input(input: &crate::operation::create_global_replication_group::CreateGlobalReplicationGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
