...
pub fn ser_rebalance_slots_in_global_replication_group_input_input_input(
    input: &crate::operation::rebalance_slots_in_global_replication_group::RebalanceSlotsInGlobalReplicationGroupInput,
