...
pub fn de_cache_node_update_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheNodeUpdateStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
