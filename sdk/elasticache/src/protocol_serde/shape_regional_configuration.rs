...
#[allow(unused_mut)]
pub fn ser_regional_configuration(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RegionalConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
