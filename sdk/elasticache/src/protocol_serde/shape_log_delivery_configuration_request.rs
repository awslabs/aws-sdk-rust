...
#[allow(unused_mut)]
pub fn ser_log_delivery_configuration_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LogDeliveryConfigurationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
