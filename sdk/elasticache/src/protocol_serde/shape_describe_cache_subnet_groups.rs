...
pub fn de_describe_cache_subnet_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsOutput, crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cache_subnet_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsOutput, crate::operation::describe_cache_subnet_groups::DescribeCacheSubnetGroupsError> {
    Ok({
        #[allow(unused_mut)]
