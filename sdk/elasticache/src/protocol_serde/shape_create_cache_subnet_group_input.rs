...
pub fn ser_create_cache_subnet_group_input_input_input(input: &crate::operation::create_cache_subnet_group::CreateCacheSubnetGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("CacheSubnetGroupDescription");
    if let Some(var_4) = &input.cache_subnet_group_description {
