...
pub fn ser_create_cache_subnet_group_input_input(input: &crate::input::CreateCacheSubnetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
