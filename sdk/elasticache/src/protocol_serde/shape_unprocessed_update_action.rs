...
pub fn de_unprocessed_update_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UnprocessedUpdateAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
