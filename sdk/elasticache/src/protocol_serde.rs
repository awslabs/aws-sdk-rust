...
pub fn parse_http_error_metadata(_response_status: u16, _response_headers: &http::HeaderMap, response_body: &[u8]) -> Result<aws_smithy_types::error::metadata::Builder, aws_smithy_xml::decode::XmlDecodeError> {
