...
///
/// Fluent builder for the `cache_cluster_deleted` waiter.
///
...
pub struct CacheClusterDeletedFluentBuilder {
...
impl CacheClusterDeletedFluentBuilder {
    /// Creates a new `CacheClusterDeletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::cache_cluster_deleted::CacheClusterDeletedFinalPoll,
        crate::waiters::cache_cluster_deleted::WaitUntilCacheClusterDeletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"CacheClusters[].CacheClusterStatus","expected":"deleted","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_cache_clusters_9b0db4ce0e1cae9d1(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"CacheClusterNotFound"}
            if crate::waiters::matchers::match_describe_cache_clusters_13fb1ec270a894d62(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"CacheClusters[].CacheClusterStatus","expected":"available","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_cache_clusters_ddb2abc814c08e34b(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"CacheClusters[].CacheClusterStatus","expected":"creating","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_cache_clusters_2041fc59b2bfcabbb(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            ...
            // Matches: {"output":{"path":"CacheClusters[].CacheClusterStatus","expected":"modifying","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_cache_clusters_5eb6db81edfe1118d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            ...
            // Matches: {"output":{"path":"CacheClusters[].CacheClusterStatus","expected":"snapshotting","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_cache_clusters_2126b8344a1788d4a(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `cache_cluster_deleted` waiter.
pub type CacheClusterDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_cache_clusters::DescribeCacheClustersOutput,
...
/// Error type for the `cache_cluster_deleted` waiter.
pub type WaitUntilCacheClusterDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_cache_clusters::DescribeCacheClustersOutput,
    crate::operation::describe_cache_clusters::DescribeCacheClustersError,
>;
