...
impl ::std::convert::From<&str> for ServiceUpdateSeverity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServiceUpdateSeverity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServiceUpdateSeverity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceUpdateSeverity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServiceUpdateSeverity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
