...
pub struct DescribeOrganizationOutput {
    ...
    /// time format.</p>
    pub completed_date: std::option::Option<smithy_types::Instant>,
...
pub mod describe_organization_output {
    ...
    pub struct Builder {
        ...
        pub(crate) completed_date: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date at which the organization became usable in the WorkMail context, in UNIX epoch
        /// time format.</p>
        pub fn completed_date(mut self, input: smithy_types::Instant) -> Self {
