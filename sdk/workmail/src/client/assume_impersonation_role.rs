...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::set_organization_id): <p>The WorkMail organization under which the impersonation role will be assumed.</p>
    ///   - [`impersonation_role_id(impl ::std::convert::Into<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::impersonation_role_id) / [`set_impersonation_role_id(Option<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::set_impersonation_role_id): <p>The impersonation role ID to assume.</p>
