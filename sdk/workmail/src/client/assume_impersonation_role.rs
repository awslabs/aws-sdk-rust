...
impl super::Client {
    ...
    ///   - [`organization_id(impl Into<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::set_organization_id):<br>required: **true**<br><p>The WorkMail organization under which the impersonation role will be assumed.</p><br>
    ///   - [`impersonation_role_id(impl Into<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::impersonation_role_id) / [`set_impersonation_role_id(Option<String>)`](crate::operation::assume_impersonation_role::builders::AssumeImpersonationRoleFluentBuilder::set_impersonation_role_id):<br>required: **true**<br><p>The impersonation role ID to assume.</p><br>
