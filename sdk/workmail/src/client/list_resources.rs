...
impl super::Client {
    ...
    ///   - [`filters(ListResourcesFilters)`](crate::operation::list_resources::builders::ListResourcesFluentBuilder::filters) / [`set_filters(Option<ListResourcesFilters>)`](crate::operation::list_resources::builders::ListResourcesFluentBuilder::set_filters): <p>Limit the resource search results based on the filter criteria. You can only use one filter per request.</p>
