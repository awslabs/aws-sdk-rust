...
impl super::Client {
    ...
    ///   - [`entity_id(impl Into<String>)`](crate::operation::deregister_from_work_mail::builders::DeregisterFromWorkMailFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::deregister_from_work_mail::builders::DeregisterFromWorkMailFluentBuilder::set_entity_id): <p>The identifier for the member to be updated.</p>  <p>The identifier can be <i>UserId, ResourceId, or Group Id</i>, <i>Username, Resourcename, or Groupname</i>, or <i>email</i>.</p>  <ul>   <li> <p>Entity ID: 12345678-1234-1234-1234-123456789012, r-0123456789a0123456789b0123456789, or S-1-1-12-1234567890-123456789-123456789-1234</p> </li>   <li> <p>Email address: entity@domain.tld</p> </li>   <li> <p>Entity name: entity</p> </li>  </ul>
