...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_from_work_mail::builders::DeregisterFromWorkMailFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::deregister_from_work_mail::builders::DeregisterFromWorkMailFluentBuilder::set_organization_id): <p>The identifier for the organization under which the WorkMail entity exists.</p>
