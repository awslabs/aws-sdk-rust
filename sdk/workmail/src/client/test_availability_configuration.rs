...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::test_availability_configuration::builders::TestAvailabilityConfigurationFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::test_availability_configuration::builders::TestAvailabilityConfigurationFluentBuilder::set_organization_id): <p>The WorkMail organization where the availability provider will be tested.</p>
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::test_availability_configuration::builders::TestAvailabilityConfigurationFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::test_availability_configuration::builders::TestAvailabilityConfigurationFluentBuilder::set_domain_name): <p>The domain to which the provider applies. If this field is provided, a stored availability provider associated to this domain name will be tested.</p>
