...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::delete_mailbox_permissions::builders::DeleteMailboxPermissionsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::delete_mailbox_permissions::builders::DeleteMailboxPermissionsFluentBuilder::set_organization_id): <p>The identifier of the organization under which the member (user or group) exists.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::delete_mailbox_permissions::builders::DeleteMailboxPermissionsFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::delete_mailbox_permissions::builders::DeleteMailboxPermissionsFluentBuilder::set_entity_id): <p>The identifier of the member (user or group) that owns the mailbox.</p>
