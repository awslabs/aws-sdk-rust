...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::get_mailbox_details::builders::GetMailboxDetailsFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::get_mailbox_details::builders::GetMailboxDetailsFluentBuilder::set_user_id): <p>The identifier for the user whose mailbox details are being requested.</p>  <p>The identifier can be the <i>UserId</i>, <i>Username</i>, or <i>email</i>. The following identity formats are available:</p>  <ul>   <li> <p>User ID: 12345678-1234-1234-1234-123456789012 or S-1-1-12-1234567890-123456789-123456789-1234</p> </li>   <li> <p>Email address: user@domain.tld</p> </li>   <li> <p>User name: user</p> </li>  </ul>
