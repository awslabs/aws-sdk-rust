...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::update_primary_email_address::builders::UpdatePrimaryEmailAddressFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::update_primary_email_address::builders::UpdatePrimaryEmailAddressFluentBuilder::set_organization_id): <p>The organization that contains the user, group, or resource to update.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::update_primary_email_address::builders::UpdatePrimaryEmailAddressFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::update_primary_email_address::builders::UpdatePrimaryEmailAddressFluentBuilder::set_entity_id): <p>The user, group, or resource to update.</p>
