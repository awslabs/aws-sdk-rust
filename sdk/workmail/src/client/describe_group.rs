...
impl super::Client {
    ...
    ///   - [`organization_id(impl Into<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::set_organization_id):<br>required: **true**<br><p>The identifier for the organization under which the group exists.</p><br>
    ///   - [`group_id(impl Into<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::set_group_id):<br>required: **true**<br><p>The identifier for the group to be described.</p> <p>The identifier can accept <i>GroupId</i>, <i>Groupname</i>, or <i>email</i>. The following identity formats are available:</p> <ul>  <li>   <p>Group ID: 12345678-1234-1234-1234-123456789012 or S-1-1-12-1234567890-123456789-123456789-1234</p></li>  <li>   <p>Email address: group@domain.tld</p></li>  <li>   <p>Group name: group</p></li> </ul><br>
