...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::list_mailbox_export_jobs::builders::ListMailboxExportJobsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::list_mailbox_export_jobs::builders::ListMailboxExportJobsFluentBuilder::set_organization_id): <p>The organization ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_mailbox_export_jobs::builders::ListMailboxExportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_mailbox_export_jobs::builders::ListMailboxExportJobsFluentBuilder::set_next_token): <p>The token to use to retrieve the next page of results.</p>
