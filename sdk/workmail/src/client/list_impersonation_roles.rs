...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::list_impersonation_roles::builders::ListImpersonationRolesFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::list_impersonation_roles::builders::ListImpersonationRolesFluentBuilder::set_organization_id): <p>The WorkMail organization to which the listed impersonation roles belong.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_impersonation_roles::builders::ListImpersonationRolesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_impersonation_roles::builders::ListImpersonationRolesFluentBuilder::set_next_token): <p>The token used to retrieve the next page of results. The first call doesn't require a token.</p>
