...
impl super::Client {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::get_mail_domain::builders::GetMailDomainFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::get_mail_domain::builders::GetMailDomainFluentBuilder::set_organization_id): <p>The WorkMail organization for which the domain is retrieved.</p>
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_mail_domain::builders::GetMailDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_mail_domain::builders::GetMailDomainFluentBuilder::set_domain_name): <p>The domain from which you want to retrieve details.</p>
