...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::put_access_control_rule::builders::PutAccessControlRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::put_access_control_rule::builders::PutAccessControlRuleFluentBuilder::set_name): <p>The rule name.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::put_access_control_rule::builders::PutAccessControlRuleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::put_access_control_rule::builders::PutAccessControlRuleFluentBuilder::set_description): <p>The rule description.</p>
