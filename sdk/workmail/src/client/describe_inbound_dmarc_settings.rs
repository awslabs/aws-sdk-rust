...
impl super::Client {
    ...
    ///   - [`organization_id(impl Into<String>)`](crate::operation::describe_inbound_dmarc_settings::builders::DescribeInboundDmarcSettingsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::describe_inbound_dmarc_settings::builders::DescribeInboundDmarcSettingsFluentBuilder::set_organization_id):<br>required: **true**<br><p>Lists the ID of the given organization.</p><br>
