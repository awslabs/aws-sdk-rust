...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_mailbox_export_job::builders::DescribeMailboxExportJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_mailbox_export_job::builders::DescribeMailboxExportJobFluentBuilder::set_job_id): <p>The mailbox export job ID.</p>
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::describe_mailbox_export_job::builders::DescribeMailboxExportJobFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::describe_mailbox_export_job::builders::DescribeMailboxExportJobFluentBuilder::set_organization_id): <p>The organization ID.</p>
