...
impl super::Client {
    ...
    ///   - [`delete_identity_center_application(bool)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::delete_identity_center_application) / [`set_delete_identity_center_application(Option<bool>)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::set_delete_identity_center_application):<br>required: **false**<br><p>Deletes IAM Identity Center application for WorkMail. This action does not affect authentication settings for any organization.</p><br>
