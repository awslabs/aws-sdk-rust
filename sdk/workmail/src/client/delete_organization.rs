...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::set_client_token): <p>The idempotency token associated with the request.</p>
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::delete_organization::builders::DeleteOrganizationFluentBuilder::set_organization_id): <p>The organization ID.</p>
