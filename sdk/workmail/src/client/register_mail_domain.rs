...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::register_mail_domain::builders::RegisterMailDomainFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::register_mail_domain::builders::RegisterMailDomainFluentBuilder::set_client_token): <p>Idempotency token used when retrying requests.</p>
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::register_mail_domain::builders::RegisterMailDomainFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::register_mail_domain::builders::RegisterMailDomainFluentBuilder::set_organization_id): <p>The WorkMail organization under which you're creating the domain.</p>
