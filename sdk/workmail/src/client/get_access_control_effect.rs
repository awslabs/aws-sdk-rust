...
impl super::Client {
    ...
    ///   - [`ip_address(impl Into<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::ip_address) / [`set_ip_address(Option<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::set_ip_address):<br>required: **true**<br><p>The IPv4 address.</p><br>
    ///   - [`action(impl Into<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::action) / [`set_action(Option<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::set_action):<br>required: **true**<br><p>The access protocol action. Valid values include <code>ActiveSync</code>, <code>AutoDiscover</code>, <code>EWS</code>, <code>IMAP</code>, <code>SMTP</code>, <code>WindowsOutlook</code>, and <code>WebMail</code>.</p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::get_access_control_effect::builders::GetAccessControlEffectFluentBuilder::set_user_id):<br>required: **false**<br><p>The user ID.</p><br>
