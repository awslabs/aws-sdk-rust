...
impl super::Client {
    ...
    ///   - [`domains(Domain)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::domains) / [`set_domains(Option<Vec<Domain>>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::set_domains): <p>The email domains to associate with the organization.</p>
