...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::set_directory_id): <p>The AWS Directory Service directory ID.</p>
    ///   - [`alias(impl ::std::convert::Into<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::alias) / [`set_alias(Option<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::set_alias): <p>The organization alias.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_organization::builders::CreateOrganizationFluentBuilder::set_client_token): <p>The idempotency token associated with the request.</p>
