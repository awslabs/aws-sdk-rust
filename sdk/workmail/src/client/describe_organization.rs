...
impl super::Client {
    ...
    ///   - [`organization_id(impl Into<String>)`](crate::operation::describe_organization::builders::DescribeOrganizationFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::describe_organization::builders::DescribeOrganizationFluentBuilder::set_organization_id):<br>required: **true**<br><p>The identifier for the organization to be described.</p><br>
