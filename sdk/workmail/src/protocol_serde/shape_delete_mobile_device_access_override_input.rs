...
pub fn ser_delete_mobile_device_access_override_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteMobileDeviceAccessOverrideInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
