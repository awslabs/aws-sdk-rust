...
pub(crate) fn de_mobile_device_access_override<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::MobileDeviceAccessOverride>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
