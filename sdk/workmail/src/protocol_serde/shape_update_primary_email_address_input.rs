...
pub fn ser_update_primary_email_address_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePrimaryEmailAddressInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
