...
pub fn ser_update_mobile_device_access_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_mobile_device_access_rule::UpdateMobileDeviceAccessRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
