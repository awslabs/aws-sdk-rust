...
pub fn ser_update_primary_email_address_input(input: &crate::input::UpdatePrimaryEmailAddressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_update_primary_email_address_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdatePrimaryEmailAddressOutput, crate::error::UpdatePrimaryEmailAddressError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdatePrimaryEmailAddressError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_primary_email_address_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdatePrimaryEmailAddressOutput, crate::error::UpdatePrimaryEmailAddressError> {
    Ok({
        #[allow(unused_mut)]
