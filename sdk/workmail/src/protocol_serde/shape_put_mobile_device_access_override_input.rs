...
pub fn ser_put_mobile_device_access_override_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutMobileDeviceAccessOverrideInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
