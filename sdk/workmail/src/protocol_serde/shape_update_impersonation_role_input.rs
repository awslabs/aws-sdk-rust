...
pub fn ser_update_impersonation_role_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateImpersonationRoleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
