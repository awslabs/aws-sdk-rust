...
pub fn ser_domain(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Domain) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
