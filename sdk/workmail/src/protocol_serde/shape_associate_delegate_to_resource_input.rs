...
pub fn ser_associate_delegate_to_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateDelegateToResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
