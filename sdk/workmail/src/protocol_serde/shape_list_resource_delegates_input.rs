...
pub fn ser_list_resource_delegates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListResourceDelegatesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
