...
pub fn ser_impersonation_rule(
    ...
    input: &crate::model::ImpersonationRule,
...
pub(crate) fn de_impersonation_rule<'a, I>(
    ...
    Option<crate::model::ImpersonationRule>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Effect" => {
                                builder = builder.set_effect(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::AccessEffect::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            "TargetUsers" => {
                                builder = builder.set_target_users(
                                    crate::protocol_serde::shape_target_users::de_target_users(
                                        tokens,
                                    )?,
                                );
                            }
