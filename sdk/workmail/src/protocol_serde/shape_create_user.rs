...
pub fn de_create_user_http_error(
    ...
    Err(match error_code {
        "DirectoryServiceAuthenticationFailedException" => {
            crate::operation::create_user::CreateUserError::DirectoryServiceAuthenticationFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReservedNameException" => crate::operation::create_user::CreateUserError::ReservedNameException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_reserved_name_exception::de_reserved_name_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_user::CreateUserError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
