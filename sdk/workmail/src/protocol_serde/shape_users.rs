...
pub(crate) fn de_users<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::User>>, aws_smithy_json::deserialize::error::DeserializeError>
