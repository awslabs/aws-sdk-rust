...
pub fn ser_disassociate_delegate_from_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateDelegateFromResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
