...
pub fn ser_ews_availability_provider(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EwsAvailabilityProvider) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
