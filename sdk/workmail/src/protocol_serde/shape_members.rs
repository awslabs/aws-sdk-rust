...
pub(crate) fn de_members<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Member>>, aws_smithy_json::deserialize::error::DeserializeError>
