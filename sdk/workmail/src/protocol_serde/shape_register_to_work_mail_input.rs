...
pub fn ser_register_to_work_mail_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterToWorkMailInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
