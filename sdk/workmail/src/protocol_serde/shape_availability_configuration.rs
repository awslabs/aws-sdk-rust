...
pub(crate) fn de_availability_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AvailabilityConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
