...
pub(crate) fn de_availability_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AvailabilityConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ProviderType" => {
                                builder = builder.set_provider_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AvailabilityProviderType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
