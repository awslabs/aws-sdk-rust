...
/// Orchestration and serialization glue logic for `GetAccessControlEffect`.
...
impl GetAccessControlEffect {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_access_control_effect::GetAccessControlEffectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_access_control_effect::GetAccessControlEffectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_access_control_effect::GetAccessControlEffectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_access_control_effect::GetAccessControlEffectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAccessControlEffect {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAccessControlEffect");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAccessControlEffectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAccessControlEffectResponseDeserializer));
...
.with_interceptor(GetAccessControlEffectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_access_control_effect::GetAccessControlEffectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_access_control_effect::GetAccessControlEffectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_access_control_effect::GetAccessControlEffectError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_access_control_effect::de_get_access_control_effect_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_access_control_effect::de_get_access_control_effect_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetAccessControlEffectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAccessControlEffectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_access_control_effect::GetAccessControlEffectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_access_control_effect::GetAccessControlEffectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_access_control_effect::ser_get_access_control_effect_input(&input)?);
...
#[derive(Debug)]
            struct GetAccessControlEffectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAccessControlEffectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAccessControlEffectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAccessControlEffectInput>()
                        .ok_or("failed to downcast to GetAccessControlEffectInput")?;
...
pub enum GetAccessControlEffectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAccessControlEffectError) for what information is available for the error.")]
...
impl GetAccessControlEffectError {
    /// Creates the `GetAccessControlEffectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAccessControlEffectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAccessControlEffectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_access_control_effect::GetAccessControlEffectError {
...
mod _get_access_control_effect_output;
