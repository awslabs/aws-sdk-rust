...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_access_control_rules::ListAccessControlRulesOutput,
                    crate::operation::list_access_control_rules::ListAccessControlRulesError,
                > for ListAccessControlRulesFluentBuilder
            {
                fn send(
                    self,
...
impl ListAccessControlRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_access_control_rules::ListAccessControlRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_access_control_rules::ListAccessControlRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_access_control_rules::ListAccessControlRulesOutput, crate::operation::list_access_control_rules::ListAccessControlRulesError, Self> {
