...
impl GetMobileDeviceAccessOverride {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMobileDeviceAccessOverride {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMobileDeviceAccessOverride");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMobileDeviceAccessOverrideRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMobileDeviceAccessOverrideResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMobileDeviceAccessOverride")
...
.with_interceptor(GetMobileDeviceAccessOverrideEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError>::new());
...
#[derive(Debug)]
            struct GetMobileDeviceAccessOverrideResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMobileDeviceAccessOverrideResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_mobile_device_access_override::de_get_mobile_device_access_override_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetMobileDeviceAccessOverrideRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMobileDeviceAccessOverrideRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_mobile_device_access_override::ser_get_mobile_device_access_override_input(&input)?);
...
#[derive(Debug)]
            struct GetMobileDeviceAccessOverrideEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMobileDeviceAccessOverrideEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMobileDeviceAccessOverrideEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMobileDeviceAccessOverrideInput>()
                        .ok_or("failed to downcast to GetMobileDeviceAccessOverrideInput")?;
...
pub enum GetMobileDeviceAccessOverrideError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMobileDeviceAccessOverrideError) for what information is available for the error.")]
...
impl GetMobileDeviceAccessOverrideError {
    /// Creates the `GetMobileDeviceAccessOverrideError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMobileDeviceAccessOverrideError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetMobileDeviceAccessOverrideError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMobileDeviceAccessOverrideError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_mobile_device_access_override::GetMobileDeviceAccessOverrideError {
...
mod _get_mobile_device_access_override_output;
