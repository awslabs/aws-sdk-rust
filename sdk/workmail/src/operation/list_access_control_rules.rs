...
impl ListAccessControlRulesInput {
    /// Consumes the builder and constructs an Operation<[`ListAccessControlRules`](crate::operation::list_access_control_rules::ListAccessControlRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_access_control_rules::ListAccessControlRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_access_control_rules::ListAccessControlRulesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_control_rules::ListAccessControlRules::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAccessControlRules", "workmail"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessControlRules {
                type Output = std::result::Result<crate::operation::list_access_control_rules::ListAccessControlRulesOutput, crate::operation::list_access_control_rules::ListAccessControlRulesError>;
