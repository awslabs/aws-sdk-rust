...
impl CreateImpersonationRoleInput {
    /// Consumes the builder and constructs an Operation<[`CreateImpersonationRole`](crate::operation::create_impersonation_role::CreateImpersonationRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_impersonation_role::CreateImpersonationRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_impersonation_role::CreateImpersonationRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_impersonation_role::CreateImpersonationRole::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateImpersonationRole {
                type Output = std::result::Result<crate::operation::create_impersonation_role::CreateImpersonationRoleOutput, crate::operation::create_impersonation_role::CreateImpersonationRoleError>;
