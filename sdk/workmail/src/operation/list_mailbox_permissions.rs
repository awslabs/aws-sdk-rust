...
impl ListMailboxPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`ListMailboxPermissions`](crate::operation::list_mailbox_permissions::ListMailboxPermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_mailbox_permissions::ListMailboxPermissions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_mailbox_permissions::ListMailboxPermissionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_mailbox_permissions::ListMailboxPermissions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListMailboxPermissions {
                type Output = std::result::Result<crate::operation::list_mailbox_permissions::ListMailboxPermissionsOutput, crate::operation::list_mailbox_permissions::ListMailboxPermissionsError>;
