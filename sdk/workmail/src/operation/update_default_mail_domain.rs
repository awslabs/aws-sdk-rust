...
/// Orchestration and serialization glue logic for `UpdateDefaultMailDomain`.
...
impl UpdateDefaultMailDomain {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_default_mail_domain::UpdateDefaultMailDomainInput,
                    ) -> ::std::result::Result<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDefaultMailDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDefaultMailDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDefaultMailDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDefaultMailDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDefaultMailDomain")
...
.with_interceptor(UpdateDefaultMailDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError>::new());
...
#[derive(Debug)]
            struct UpdateDefaultMailDomainResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDefaultMailDomainResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_default_mail_domain::de_update_default_mail_domain_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateDefaultMailDomainRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDefaultMailDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_default_mail_domain::UpdateDefaultMailDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_default_mail_domain::UpdateDefaultMailDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_default_mail_domain::ser_update_default_mail_domain_input(&input)?);
...
#[derive(Debug)]
            struct UpdateDefaultMailDomainEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDefaultMailDomainEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDefaultMailDomainEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDefaultMailDomainInput>()
                        .ok_or("failed to downcast to UpdateDefaultMailDomainInput")?;
...
pub enum UpdateDefaultMailDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDefaultMailDomainError) for what information is available for the error.")]
...
impl UpdateDefaultMailDomainError {
    /// Creates the `UpdateDefaultMailDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDefaultMailDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDefaultMailDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_default_mail_domain::UpdateDefaultMailDomainError {
...
mod _update_default_mail_domain_output;
