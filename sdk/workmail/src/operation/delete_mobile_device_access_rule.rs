...
/// Orchestration and serialization glue logic for `DeleteMobileDeviceAccessRule`.
...
impl DeleteMobileDeviceAccessRule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleInput,
                    ) -> ::std::result::Result<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteMobileDeviceAccessRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteMobileDeviceAccessRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteMobileDeviceAccessRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteMobileDeviceAccessRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteMobileDeviceAccessRule")
...
.with_interceptor(DeleteMobileDeviceAccessRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError>::new());
...
#[derive(Debug)]
            struct DeleteMobileDeviceAccessRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMobileDeviceAccessRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_mobile_device_access_rule::de_delete_mobile_device_access_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_mobile_device_access_rule::de_delete_mobile_device_access_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteMobileDeviceAccessRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMobileDeviceAccessRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_mobile_device_access_rule::ser_delete_mobile_device_access_rule_input(&input)?);
...
#[derive(Debug)]
            struct DeleteMobileDeviceAccessRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteMobileDeviceAccessRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteMobileDeviceAccessRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteMobileDeviceAccessRuleInput>()
                        .ok_or("failed to downcast to DeleteMobileDeviceAccessRuleInput")?;
...
pub enum DeleteMobileDeviceAccessRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteMobileDeviceAccessRuleError) for what information is available for the error.")]
...
impl DeleteMobileDeviceAccessRuleError {
    /// Creates the `DeleteMobileDeviceAccessRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteMobileDeviceAccessRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteMobileDeviceAccessRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_mobile_device_access_rule::DeleteMobileDeviceAccessRuleError {
...
mod _delete_mobile_device_access_rule_output;
