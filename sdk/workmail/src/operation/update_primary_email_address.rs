...
impl UpdatePrimaryEmailAddressInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_primary_email_address::UpdatePrimaryEmailAddress::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePrimaryEmailAddress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_primary_email_address::de_update_primary_email_address_http_response_with_props(status, headers, body)
        }
    }
}
