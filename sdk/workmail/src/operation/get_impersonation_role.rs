...
/// Orchestration and serialization glue logic for `GetImpersonationRole`.
...
impl GetImpersonationRole {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_impersonation_role::GetImpersonationRoleInput,
                    ) -> ::std::result::Result<crate::operation::get_impersonation_role::GetImpersonationRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_impersonation_role::GetImpersonationRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_impersonation_role::GetImpersonationRoleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_impersonation_role::GetImpersonationRoleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetImpersonationRole {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetImpersonationRole");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetImpersonationRoleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetImpersonationRoleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetImpersonationRole")
...
.with_interceptor(GetImpersonationRoleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_impersonation_role::GetImpersonationRoleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_impersonation_role::GetImpersonationRoleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_impersonation_role::GetImpersonationRoleError>::new());
...
#[derive(Debug)]
            struct GetImpersonationRoleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetImpersonationRoleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_impersonation_role::de_get_impersonation_role_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetImpersonationRoleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetImpersonationRoleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_impersonation_role::GetImpersonationRoleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_impersonation_role::GetImpersonationRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_impersonation_role::ser_get_impersonation_role_input(&input)?);
...
#[derive(Debug)]
            struct GetImpersonationRoleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetImpersonationRoleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetImpersonationRoleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetImpersonationRoleInput>()
                        .ok_or("failed to downcast to GetImpersonationRoleInput")?;
...
pub enum GetImpersonationRoleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetImpersonationRoleError) for what information is available for the error.")]
...
impl GetImpersonationRoleError {
    /// Creates the `GetImpersonationRoleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetImpersonationRoleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetImpersonationRoleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_impersonation_role::GetImpersonationRoleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_impersonation_role::_get_impersonation_role_output::GetImpersonationRoleOutput;

pub use crate::operation::get_impersonation_role::_get_impersonation_role_input::GetImpersonationRoleInput;

mod _get_impersonation_role_input;

mod _get_impersonation_role_output;
