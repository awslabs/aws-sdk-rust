...
impl RegisterMailDomainInput {
    /// Consumes the builder and constructs an Operation<[`RegisterMailDomain`](crate::operation::register_mail_domain::RegisterMailDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_mail_domain::RegisterMailDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_mail_domain::RegisterMailDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_mail_domain::RegisterMailDomain::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterMailDomain {
                type Output = std::result::Result<crate::operation::register_mail_domain::RegisterMailDomainOutput, crate::operation::register_mail_domain::RegisterMailDomainError>;
