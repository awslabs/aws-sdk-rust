...
impl RegisterMailDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::register_mail_domain::RegisterMailDomain,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_mail_domain::ser_register_mail_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterMailDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_mail_domain::de_register_mail_domain_http_response_with_props(status, headers, body)
        }
    }
}
