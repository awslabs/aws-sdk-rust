...
impl RegisterMailDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_mail_domain::RegisterMailDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterMailDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_mail_domain::de_register_mail_domain_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_mail_domain::RegisterMailDomainError
{
