...
impl DescribeMailboxExportJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMailboxExportJob`](crate::operation::describe_mailbox_export_job::DescribeMailboxExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_mailbox_export_job::DescribeMailboxExportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_mailbox_export_job::DescribeMailboxExportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_mailbox_export_job::DescribeMailboxExportJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMailboxExportJob {
                type Output = std::result::Result<crate::operation::describe_mailbox_export_job::DescribeMailboxExportJobOutput, crate::operation::describe_mailbox_export_job::DescribeMailboxExportJobError>;
