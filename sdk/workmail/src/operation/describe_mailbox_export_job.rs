...
impl DescribeMailboxExportJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_mailbox_export_job::DescribeMailboxExportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMailboxExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_mailbox_export_job::de_describe_mailbox_export_job_http_response_with_props(status, headers, body)
        }
    }
}
