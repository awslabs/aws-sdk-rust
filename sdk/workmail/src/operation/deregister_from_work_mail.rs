...
impl DeregisterFromWorkMail {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::deregister_from_work_mail::DeregisterFromWorkMailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::deregister_from_work_mail::DeregisterFromWorkMailOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WorkMail", "DeregisterFromWorkMail", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WorkMail.DeregisterFromWorkMail",
                "rpc.service" = "WorkMail",
                "rpc.method" = "DeregisterFromWorkMail",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterFromWorkMail {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeregisterFromWorkMailRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeregisterFromWorkMailResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeregisterFromWorkMail")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterFromWorkMail")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeregisterFromWorkMailTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeregisterFromWorkMailTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterFromWorkMailTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeregisterFromWorkMailInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterFromWorkMailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_deregister_from_work_mail::de_deregister_from_work_mail_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_deregister_from_work_mail::de_deregister_from_work_mail_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterFromWorkMailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::deregister_from_work_mail::DeregisterFromWorkMailInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::deregister_from_work_mail::DeregisterFromWorkMailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_from_work_mail::ser_deregister_from_work_mail_input(&input)?,
        );
