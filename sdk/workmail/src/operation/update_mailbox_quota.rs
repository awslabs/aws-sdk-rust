...
impl UpdateMailboxQuotaInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_mailbox_quota::UpdateMailboxQuota::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMailboxQuota {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_mailbox_quota::de_update_mailbox_quota_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_mailbox_quota::de_update_mailbox_quota_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::update_mailbox_quota::UpdateMailboxQuotaError
{
