...
impl CreateResourceInput {
    /// Consumes the builder and constructs an Operation<[`CreateResource`](crate::operation::create_resource::CreateResource)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_resource::CreateResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_resource::ser_create_resource_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource::CreateResource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateResource", "workmail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResource {
    type Output =
        ::std::result::Result<crate::operation::create_resource::CreateResourceOutput, crate::operation::create_resource::CreateResourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_resource::de_create_resource_http_response_with_props(status, headers, body)
        }
    }
}
