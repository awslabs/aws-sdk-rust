...
impl CreateResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_resource::CreateResource,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_resource::CreateResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_resource::de_create_resource_http_error(
                status, headers, body,
            )
        } else {
