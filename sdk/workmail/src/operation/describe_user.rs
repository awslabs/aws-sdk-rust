...
impl DescribeUser {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("workmail", "DescribeUser", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DescribeUser", "workmail"));
...
impl DescribeUserError {
    ...
    /// Returns `true` if the error kind is `DescribeUserError::DirectoryServiceAuthenticationFailedException`.
    ...
    /// Returns `true` if the error kind is `DescribeUserError::DirectoryUnavailableException`.
