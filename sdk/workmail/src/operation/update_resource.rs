...
impl UpdateResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_resource::UpdateResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_resource::ser_update_resource_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResource {
    type Output =
        ::std::result::Result<crate::operation::update_resource::UpdateResourceOutput, crate::operation::update_resource::UpdateResourceError>;
