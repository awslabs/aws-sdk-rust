...
impl TestAvailabilityConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::test_availability_configuration::TestAvailabilityConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
