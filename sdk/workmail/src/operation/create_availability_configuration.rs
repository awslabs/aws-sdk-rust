...
impl CreateAvailabilityConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_availability_configuration::CreateAvailabilityConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAvailabilityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_availability_configuration::de_create_availability_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
