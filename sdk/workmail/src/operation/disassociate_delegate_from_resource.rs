...
impl DisassociateDelegateFromResourceInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDelegateFromResource`](crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateDelegateFromResource {
                type Output = std::result::Result<crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceOutput, crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceError>;
