...
impl ListMailDomainsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_mail_domains::ListMailDomains,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_mail_domains::ListMailDomains::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListMailDomains {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_mail_domains::de_list_mail_domains_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_mail_domains::de_list_mail_domains_http_response(
                status, headers, body,
            )
        }
    }
