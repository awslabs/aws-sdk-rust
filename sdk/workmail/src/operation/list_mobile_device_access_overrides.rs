...
/// Orchestration and serialization glue logic for `ListMobileDeviceAccessOverrides`.
...
impl ListMobileDeviceAccessOverrides {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesInput,
                    ) -> ::std::result::Result<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMobileDeviceAccessOverrides {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMobileDeviceAccessOverrides");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMobileDeviceAccessOverridesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMobileDeviceAccessOverridesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMobileDeviceAccessOverrides")
...
.with_interceptor(ListMobileDeviceAccessOverridesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError>::new());
...
#[derive(Debug)]
            struct ListMobileDeviceAccessOverridesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMobileDeviceAccessOverridesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_mobile_device_access_overrides::de_list_mobile_device_access_overrides_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_mobile_device_access_overrides::de_list_mobile_device_access_overrides_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListMobileDeviceAccessOverridesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMobileDeviceAccessOverridesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_mobile_device_access_overrides::ser_list_mobile_device_access_overrides_input(&input)?);
...
#[derive(Debug)]
            struct ListMobileDeviceAccessOverridesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMobileDeviceAccessOverridesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListMobileDeviceAccessOverridesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMobileDeviceAccessOverridesInput>()
                        .ok_or("failed to downcast to ListMobileDeviceAccessOverridesInput")?;
...
pub enum ListMobileDeviceAccessOverridesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMobileDeviceAccessOverridesError) for what information is available for the error.")]
...
impl ListMobileDeviceAccessOverridesError {
    /// Creates the `ListMobileDeviceAccessOverridesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMobileDeviceAccessOverridesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListMobileDeviceAccessOverridesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMobileDeviceAccessOverridesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_mobile_device_access_overrides::_list_mobile_device_access_overrides_output::ListMobileDeviceAccessOverridesOutput;

pub use crate::operation::list_mobile_device_access_overrides::_list_mobile_device_access_overrides_input::ListMobileDeviceAccessOverridesInput;

mod _list_mobile_device_access_overrides_input;

mod _list_mobile_device_access_overrides_output;
