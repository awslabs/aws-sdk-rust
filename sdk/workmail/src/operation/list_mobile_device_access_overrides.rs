...
impl ListMobileDeviceAccessOverridesInput {
    /// Consumes the builder and constructs an Operation<[`ListMobileDeviceAccessOverrides`](crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverrides)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverrides, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverrides::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListMobileDeviceAccessOverrides", "workmail"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListMobileDeviceAccessOverrides {
                type Output = std::result::Result<crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesOutput, crate::operation::list_mobile_device_access_overrides::ListMobileDeviceAccessOverridesError>;
