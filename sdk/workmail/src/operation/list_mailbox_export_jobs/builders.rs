...
impl ListMailboxExportJobsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_mailbox_export_jobs::paginator::ListMailboxExportJobsPaginator {
        crate::operation::list_mailbox_export_jobs::paginator::ListMailboxExportJobsPaginator::new(
            self.handle,
            self.inner,
        )
    }
