...
impl CreateUser {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WorkMail", "CreateUser", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateUser", "WorkMail"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("IdentityProviderUserId") {
            if let ::std::option::Option::Some(value) = input.identity_provider_user_id.as_deref() {
                captured.insert("IdentityProviderUserId", value);
            }
        }
