...
/// Orchestration and serialization glue logic for `PutMobileDeviceAccessOverride`.
...
impl PutMobileDeviceAccessOverride {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMobileDeviceAccessOverride {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutMobileDeviceAccessOverride");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutMobileDeviceAccessOverrideRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutMobileDeviceAccessOverrideResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutMobileDeviceAccessOverride")
...
.with_interceptor(PutMobileDeviceAccessOverrideEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError>::new());
...
#[derive(Debug)]
            struct PutMobileDeviceAccessOverrideResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutMobileDeviceAccessOverrideResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_mobile_device_access_override::de_put_mobile_device_access_override_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_mobile_device_access_override::de_put_mobile_device_access_override_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutMobileDeviceAccessOverrideRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMobileDeviceAccessOverrideRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_mobile_device_access_override::ser_put_mobile_device_access_override_input(&input)?);
...
#[derive(Debug)]
            struct PutMobileDeviceAccessOverrideEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutMobileDeviceAccessOverrideEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutMobileDeviceAccessOverrideEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutMobileDeviceAccessOverrideInput>()
                        .ok_or("failed to downcast to PutMobileDeviceAccessOverrideInput")?;
...
pub enum PutMobileDeviceAccessOverrideError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutMobileDeviceAccessOverrideError) for what information is available for the error.")]
...
impl PutMobileDeviceAccessOverrideError {
    /// Creates the `PutMobileDeviceAccessOverrideError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutMobileDeviceAccessOverrideError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutMobileDeviceAccessOverrideError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutMobileDeviceAccessOverrideError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_mobile_device_access_override::PutMobileDeviceAccessOverrideError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_mobile_device_access_override::_put_mobile_device_access_override_output::PutMobileDeviceAccessOverrideOutput;

pub use crate::operation::put_mobile_device_access_override::_put_mobile_device_access_override_input::PutMobileDeviceAccessOverrideInput;

mod _put_mobile_device_access_override_input;

mod _put_mobile_device_access_override_output;
