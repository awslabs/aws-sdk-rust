...
impl PutMailboxPermissions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_mailbox_permissions::PutMailboxPermissionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_mailbox_permissions::PutMailboxPermissionsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WorkMail", "PutMailboxPermissions", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WorkMail.PutMailboxPermissions",
                "rpc.service" = "WorkMail",
                "rpc.method" = "PutMailboxPermissions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMailboxPermissions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutMailboxPermissionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutMailboxPermissionsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutMailboxPermissions")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutMailboxPermissions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutMailboxPermissionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutMailboxPermissionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutMailboxPermissionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutMailboxPermissionsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutMailboxPermissionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_mailbox_permissions::de_put_mailbox_permissions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_mailbox_permissions::de_put_mailbox_permissions_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMailboxPermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_mailbox_permissions::PutMailboxPermissionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_mailbox_permissions::PutMailboxPermissionsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_mailbox_permissions::ser_put_mailbox_permissions_input(
            &input,
        )?);
