...
impl DisassociateDelegateFromResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceOutput, crate::operation::disassociate_delegate_from_resource::DisassociateDelegateFromResourceError, Self> {
