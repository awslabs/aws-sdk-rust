...
impl GetDefaultRetentionPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDefaultRetentionPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDefaultRetentionPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDefaultRetentionPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDefaultRetentionPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDefaultRetentionPolicy")
...
.with_interceptor(GetDefaultRetentionPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError>::new());
...
#[derive(Debug)]
            struct GetDefaultRetentionPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDefaultRetentionPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_default_retention_policy::de_get_default_retention_policy_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDefaultRetentionPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDefaultRetentionPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_default_retention_policy::ser_get_default_retention_policy_input(&input)?);
...
#[derive(Debug)]
            struct GetDefaultRetentionPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDefaultRetentionPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDefaultRetentionPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDefaultRetentionPolicyInput>()
                        .ok_or("failed to downcast to GetDefaultRetentionPolicyInput")?;
...
pub enum GetDefaultRetentionPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDefaultRetentionPolicyError) for what information is available for the error.")]
...
impl GetDefaultRetentionPolicyError {
    /// Creates the `GetDefaultRetentionPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDefaultRetentionPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDefaultRetentionPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyError {
...
mod _get_default_retention_policy_output;
