...
impl GetDefaultRetentionPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_default_retention_policy::GetDefaultRetentionPolicy,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_default_retention_policy::GetDefaultRetentionPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDefaultRetentionPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_default_retention_policy::de_get_default_retention_policy_http_response_with_props(status, headers, body)
        }
    }
}
