...
/// Orchestration and serialization glue logic for `ListMobileDeviceAccessRules`.
...
impl ListMobileDeviceAccessRules {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesInput,
                    ) -> ::std::result::Result<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMobileDeviceAccessRules {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMobileDeviceAccessRules");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMobileDeviceAccessRulesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMobileDeviceAccessRulesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMobileDeviceAccessRules")
...
.with_interceptor(ListMobileDeviceAccessRulesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError>::new());
...
#[derive(Debug)]
            struct ListMobileDeviceAccessRulesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMobileDeviceAccessRulesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_mobile_device_access_rules::de_list_mobile_device_access_rules_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_mobile_device_access_rules::de_list_mobile_device_access_rules_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListMobileDeviceAccessRulesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMobileDeviceAccessRulesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_mobile_device_access_rules::ser_list_mobile_device_access_rules_input(&input)?);
...
#[derive(Debug)]
            struct ListMobileDeviceAccessRulesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMobileDeviceAccessRulesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListMobileDeviceAccessRulesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMobileDeviceAccessRulesInput>()
                        .ok_or("failed to downcast to ListMobileDeviceAccessRulesInput")?;
...
pub enum ListMobileDeviceAccessRulesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMobileDeviceAccessRulesError) for what information is available for the error.")]
...
impl ListMobileDeviceAccessRulesError {
    /// Creates the `ListMobileDeviceAccessRulesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMobileDeviceAccessRulesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMobileDeviceAccessRulesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_mobile_device_access_rules::ListMobileDeviceAccessRulesError {
...
mod _list_mobile_device_access_rules_output;
