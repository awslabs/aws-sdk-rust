...
impl UpdateGroup {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("workmail", "UpdateGroup", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateGroup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateGroup", "workmail"));
...
impl UpdateGroupError {
    ...
    /// Returns `true` if the error kind is `UpdateGroupError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateGroupError::EntityStateException`.
    ...
    /// Returns `true` if the error kind is `UpdateGroupError::OrganizationNotFoundException`.
    pub fn is_organization_not_found_exception(&self) -> bool {
        matches!(self, Self::OrganizationNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateGroupError::OrganizationStateException`.
    pub fn is_organization_state_exception(&self) -> bool {
        matches!(self, Self::OrganizationStateException(_))
    }
    /// Returns `true` if the error kind is `UpdateGroupError::UnsupportedOperationException`.
