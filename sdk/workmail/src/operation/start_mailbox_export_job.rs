...
impl StartMailboxExportJobInput {
    /// Consumes the builder and constructs an Operation<[`StartMailboxExportJob`](crate::operation::start_mailbox_export_job::StartMailboxExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_mailbox_export_job::StartMailboxExportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_mailbox_export_job::StartMailboxExportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_mailbox_export_job::StartMailboxExportJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartMailboxExportJob {
                type Output = std::result::Result<crate::operation::start_mailbox_export_job::StartMailboxExportJobOutput, crate::operation::start_mailbox_export_job::StartMailboxExportJobError>;
