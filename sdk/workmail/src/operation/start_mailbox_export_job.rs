        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::start_mailbox_export_job::StartMailboxExportJobInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMailboxExportJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartMailboxExportJob", "workmail"));
