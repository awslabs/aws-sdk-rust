...
impl DeleteEmailMonitoringConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_email_monitoring_configuration::DeleteEmailMonitoringConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEmailMonitoringConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_email_monitoring_configuration::de_delete_email_monitoring_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
