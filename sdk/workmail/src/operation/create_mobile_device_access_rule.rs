...
/// Orchestration and serialization glue logic for `CreateMobileDeviceAccessRule`.
...
impl CreateMobileDeviceAccessRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMobileDeviceAccessRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateMobileDeviceAccessRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateMobileDeviceAccessRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateMobileDeviceAccessRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMobileDeviceAccessRule")
...
.with_interceptor(CreateMobileDeviceAccessRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError>::new());
...
#[derive(Debug)]
            struct CreateMobileDeviceAccessRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMobileDeviceAccessRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_mobile_device_access_rule::de_create_mobile_device_access_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_mobile_device_access_rule::de_create_mobile_device_access_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateMobileDeviceAccessRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMobileDeviceAccessRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_mobile_device_access_rule::ser_create_mobile_device_access_rule_input(&input)?);
...
#[derive(Debug)]
            struct CreateMobileDeviceAccessRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMobileDeviceAccessRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateMobileDeviceAccessRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateMobileDeviceAccessRuleInput>()
                        .ok_or("failed to downcast to CreateMobileDeviceAccessRuleInput")?;
...
pub enum CreateMobileDeviceAccessRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateMobileDeviceAccessRuleError) for what information is available for the error.")]
...
impl CreateMobileDeviceAccessRuleError {
    /// Creates the `CreateMobileDeviceAccessRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateMobileDeviceAccessRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateMobileDeviceAccessRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleError {
...
mod _create_mobile_device_access_rule_output;
