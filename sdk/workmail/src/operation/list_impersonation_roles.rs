...
/// Orchestration and serialization glue logic for `ListImpersonationRoles`.
...
impl ListImpersonationRoles {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_impersonation_roles::ListImpersonationRolesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_impersonation_roles::ListImpersonationRolesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_impersonation_roles::ListImpersonationRolesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_impersonation_roles::ListImpersonationRolesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListImpersonationRoles {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListImpersonationRoles");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListImpersonationRolesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListImpersonationRolesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListImpersonationRoles")
...
.with_interceptor(ListImpersonationRolesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_impersonation_roles::ListImpersonationRolesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_impersonation_roles::ListImpersonationRolesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_impersonation_roles::ListImpersonationRolesError>::new());
...
#[derive(Debug)]
            struct ListImpersonationRolesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListImpersonationRolesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_impersonation_roles::de_list_impersonation_roles_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_impersonation_roles::de_list_impersonation_roles_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListImpersonationRolesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListImpersonationRolesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_impersonation_roles::ListImpersonationRolesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_impersonation_roles::ListImpersonationRolesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_impersonation_roles::ser_list_impersonation_roles_input(&input)?);
...
#[derive(Debug)]
            struct ListImpersonationRolesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListImpersonationRolesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListImpersonationRolesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListImpersonationRolesInput>()
                        .ok_or("failed to downcast to ListImpersonationRolesInput")?;
...
pub enum ListImpersonationRolesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListImpersonationRolesError) for what information is available for the error.")]
...
impl ListImpersonationRolesError {
    /// Creates the `ListImpersonationRolesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListImpersonationRolesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListImpersonationRolesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_impersonation_roles::ListImpersonationRolesError {
...
mod _list_impersonation_roles_output;
