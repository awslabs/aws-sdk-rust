...
impl ListImpersonationRolesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_impersonation_roles::ListImpersonationRoles,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImpersonationRoles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_impersonation_roles::de_list_impersonation_roles_http_response_with_props(status, headers, body)
        }
    }
}
