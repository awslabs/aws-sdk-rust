...
impl aws_smithy_http::response::ParseStrictResponse for TestAvailabilityConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_availability_configuration::de_test_availability_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::test_availability_configuration::TestAvailabilityConfigurationError
{
