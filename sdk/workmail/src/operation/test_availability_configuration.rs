...
impl TestAvailabilityConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`TestAvailabilityConfiguration`](crate::operation::test_availability_configuration::TestAvailabilityConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::test_availability_configuration::TestAvailabilityConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_availability_configuration::TestAvailabilityConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::test_availability_configuration::TestAvailabilityConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for TestAvailabilityConfiguration {
                type Output = std::result::Result<crate::operation::test_availability_configuration::TestAvailabilityConfigurationOutput, crate::operation::test_availability_configuration::TestAvailabilityConfigurationError>;
