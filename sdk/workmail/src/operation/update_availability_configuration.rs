...
impl UpdateAvailabilityConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_availability_configuration::UpdateAvailabilityConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAvailabilityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_availability_configuration::de_update_availability_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
