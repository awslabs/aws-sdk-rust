...
impl RegisterToWorkMail {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_to_work_mail::RegisterToWorkMailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_to_work_mail::RegisterToWorkMailOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WorkMail", "RegisterToWorkMail", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WorkMail.RegisterToWorkMail",
                "rpc.service" = "WorkMail",
                "rpc.method" = "RegisterToWorkMail",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterToWorkMail {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterToWorkMailRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterToWorkMailResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterToWorkMail")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterToWorkMail")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterToWorkMailTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegisterToWorkMailTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterToWorkMailTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterToWorkMailInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterToWorkMailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_to_work_mail::de_register_to_work_mail_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_register_to_work_mail::de_register_to_work_mail_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterToWorkMailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_to_work_mail::RegisterToWorkMailInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::register_to_work_mail::RegisterToWorkMailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_to_work_mail::ser_register_to_work_mail_input(
            &input,
        )?);
...
impl RegisterToWorkMailError {
    ...
    /// Returns `true` if the error kind is `RegisterToWorkMailError::UnsupportedOperationException`.
...
impl ::std::error::Error for RegisterToWorkMailError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::EntityAlreadyRegisteredException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterToWorkMailError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::EntityAlreadyRegisteredException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
