...
impl ListGroupMembersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_group_members::ListGroupMembers,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_group_members::ser_list_group_members_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_group_members::de_list_group_members_http_response_with_props(status, headers, body)
        }
    }
}
