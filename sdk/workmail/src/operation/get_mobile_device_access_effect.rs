...
impl GetMobileDeviceAccessEffectInput {
    /// Consumes the builder and constructs an Operation<[`GetMobileDeviceAccessEffect`](crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffect, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffect::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetMobileDeviceAccessEffect", "workmail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetMobileDeviceAccessEffect {
                type Output = std::result::Result<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectOutput, crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError>;
