...
/// Orchestration and serialization glue logic for `GetMobileDeviceAccessEffect`.
...
impl GetMobileDeviceAccessEffect {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectInput,
                    ) -> ::std::result::Result<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMobileDeviceAccessEffect {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMobileDeviceAccessEffect");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMobileDeviceAccessEffectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMobileDeviceAccessEffectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMobileDeviceAccessEffect")
...
.with_interceptor(GetMobileDeviceAccessEffectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError>::new());
...
#[derive(Debug)]
            struct GetMobileDeviceAccessEffectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMobileDeviceAccessEffectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_mobile_device_access_effect::de_get_mobile_device_access_effect_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_mobile_device_access_effect::de_get_mobile_device_access_effect_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetMobileDeviceAccessEffectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMobileDeviceAccessEffectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_mobile_device_access_effect::ser_get_mobile_device_access_effect_input(&input)?);
...
#[derive(Debug)]
            struct GetMobileDeviceAccessEffectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMobileDeviceAccessEffectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMobileDeviceAccessEffectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMobileDeviceAccessEffectInput>()
                        .ok_or("failed to downcast to GetMobileDeviceAccessEffectInput")?;
...
pub enum GetMobileDeviceAccessEffectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMobileDeviceAccessEffectError) for what information is available for the error.")]
...
impl GetMobileDeviceAccessEffectError {
    /// Creates the `GetMobileDeviceAccessEffectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMobileDeviceAccessEffectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMobileDeviceAccessEffectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectError {
...
mod _get_mobile_device_access_effect_output;
