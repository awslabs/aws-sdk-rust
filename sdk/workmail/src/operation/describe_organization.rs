...
impl DescribeOrganizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_organization::DescribeOrganization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_organization::de_describe_organization_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_organization::DescribeOrganizationError
{
