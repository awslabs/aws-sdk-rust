...
impl AssociateMemberToGroupInput {
    /// Consumes the builder and constructs an Operation<[`AssociateMemberToGroup`](crate::operation::associate_member_to_group::AssociateMemberToGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_member_to_group::AssociateMemberToGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_member_to_group::AssociateMemberToGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_member_to_group::AssociateMemberToGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateMemberToGroup {
                type Output = std::result::Result<crate::operation::associate_member_to_group::AssociateMemberToGroupOutput, crate::operation::associate_member_to_group::AssociateMemberToGroupError>;
