...
impl PutInboundDmarcSettingsInput {
    /// Consumes the builder and constructs an Operation<[`PutInboundDmarcSettings`](crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutInboundDmarcSettings {
                type Output = std::result::Result<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsOutput, crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError>;
