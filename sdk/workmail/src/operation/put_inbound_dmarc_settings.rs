...
/// Orchestration and serialization glue logic for `PutInboundDmarcSettings`.
...
impl PutInboundDmarcSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsInput,
                    ) -> ::std::result::Result<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutInboundDmarcSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutInboundDmarcSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutInboundDmarcSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutInboundDmarcSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutInboundDmarcSettings")
...
.with_interceptor(PutInboundDmarcSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError>::new());
...
#[derive(Debug)]
            struct PutInboundDmarcSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutInboundDmarcSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_inbound_dmarc_settings::de_put_inbound_dmarc_settings_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutInboundDmarcSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutInboundDmarcSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_inbound_dmarc_settings::ser_put_inbound_dmarc_settings_input(&input)?);
...
#[derive(Debug)]
            struct PutInboundDmarcSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutInboundDmarcSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutInboundDmarcSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutInboundDmarcSettingsInput>()
                        .ok_or("failed to downcast to PutInboundDmarcSettingsInput")?;
...
pub enum PutInboundDmarcSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutInboundDmarcSettingsError) for what information is available for the error.")]
...
impl PutInboundDmarcSettingsError {
    /// Creates the `PutInboundDmarcSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutInboundDmarcSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutInboundDmarcSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsError {
...
mod _put_inbound_dmarc_settings_output;
