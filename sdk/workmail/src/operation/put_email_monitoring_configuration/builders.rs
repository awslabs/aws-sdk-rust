...
impl crate::operation::put_email_monitoring_configuration::builders::PutEmailMonitoringConfigurationInputBuilder {
...
impl PutEmailMonitoringConfigurationFluentBuilder {
    /// Creates a new `PutEmailMonitoringConfigurationFluentBuilder`.
