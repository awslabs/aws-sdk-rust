...
impl ListResourceDelegatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resource_delegates::ListResourceDelegatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_delegates::ListResourceDelegatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resource_delegates::ListResourceDelegatesOutput, crate::operation::list_resource_delegates::ListResourceDelegatesError, Self> {
