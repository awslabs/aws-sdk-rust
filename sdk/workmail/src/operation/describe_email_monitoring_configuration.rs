...
impl DescribeEmailMonitoringConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEmailMonitoringConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_email_monitoring_configuration::de_describe_email_monitoring_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
