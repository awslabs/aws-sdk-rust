...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListResourceDelegatesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListResourceDelegatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_resource_delegates::ser_list_resource_delegates_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListResourceDelegatesEndpointParamsInterceptor {
