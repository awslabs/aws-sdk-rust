...
impl ListResourceDelegatesInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceDelegates`](crate::operation::list_resource_delegates::ListResourceDelegates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_resource_delegates::ListResourceDelegates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_delegates::ListResourceDelegatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_delegates::ListResourceDelegates::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListResourceDelegates {
                type Output = std::result::Result<crate::operation::list_resource_delegates::ListResourceDelegatesOutput, crate::operation::list_resource_delegates::ListResourceDelegatesError>;
