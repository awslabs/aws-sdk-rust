...
impl CancelMailboxExportJobInput {
    /// Consumes the builder and constructs an Operation<[`CancelMailboxExportJob`](crate::operation::cancel_mailbox_export_job::CancelMailboxExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_mailbox_export_job::CancelMailboxExportJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CancelMailboxExportJob {
                type Output = std::result::Result<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobOutput, crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError>;
