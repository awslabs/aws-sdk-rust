...
/// Orchestration and serialization glue logic for `CancelMailboxExportJob`.
...
impl CancelMailboxExportJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelMailboxExportJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelMailboxExportJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelMailboxExportJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelMailboxExportJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelMailboxExportJob")
...
.with_interceptor(CancelMailboxExportJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError>::new());
...
#[derive(Debug)]
            struct CancelMailboxExportJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelMailboxExportJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_mailbox_export_job::de_cancel_mailbox_export_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_cancel_mailbox_export_job::de_cancel_mailbox_export_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelMailboxExportJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelMailboxExportJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_mailbox_export_job::ser_cancel_mailbox_export_job_input(&input)?);
...
#[derive(Debug)]
            struct CancelMailboxExportJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelMailboxExportJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelMailboxExportJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelMailboxExportJobInput>()
                        .ok_or("failed to downcast to CancelMailboxExportJobInput")?;
...
pub enum CancelMailboxExportJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelMailboxExportJobError) for what information is available for the error.")]
...
impl CancelMailboxExportJobError {
    /// Creates the `CancelMailboxExportJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelMailboxExportJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelMailboxExportJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_mailbox_export_job::CancelMailboxExportJobError {
...
mod _cancel_mailbox_export_job_output;
