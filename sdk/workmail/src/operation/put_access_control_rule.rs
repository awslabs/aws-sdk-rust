...
impl PutAccessControlRuleInput {
    /// Consumes the builder and constructs an Operation<[`PutAccessControlRule`](crate::operation::put_access_control_rule::PutAccessControlRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_access_control_rule::PutAccessControlRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_access_control_rule::PutAccessControlRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_access_control_rule::PutAccessControlRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutAccessControlRule {
                type Output = std::result::Result<crate::operation::put_access_control_rule::PutAccessControlRuleOutput, crate::operation::put_access_control_rule::PutAccessControlRuleError>;
