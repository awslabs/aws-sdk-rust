...
impl AssociateDelegateToResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_delegate_to_resource::AssociateDelegateToResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDelegateToResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_delegate_to_resource::de_associate_delegate_to_resource_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AssociateDelegateToResourceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError
{
