...
/// Orchestration and serialization glue logic for `AssociateDelegateToResource`.
...
impl AssociateDelegateToResource {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDelegateToResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateDelegateToResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateDelegateToResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateDelegateToResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDelegateToResource")
...
.with_interceptor(AssociateDelegateToResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError>::new());
...
#[derive(Debug)]
            struct AssociateDelegateToResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateDelegateToResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_delegate_to_resource::de_associate_delegate_to_resource_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_delegate_to_resource::de_associate_delegate_to_resource_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateDelegateToResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateDelegateToResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_delegate_to_resource::ser_associate_delegate_to_resource_input(&input)?);
...
#[derive(Debug)]
            struct AssociateDelegateToResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateDelegateToResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateDelegateToResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateDelegateToResourceInput>()
                        .ok_or("failed to downcast to AssociateDelegateToResourceInput")?;
...
pub enum AssociateDelegateToResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateDelegateToResourceError) for what information is available for the error.")]
...
impl AssociateDelegateToResourceError {
    /// Creates the `AssociateDelegateToResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateDelegateToResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `AssociateDelegateToResourceError::UnsupportedOperationException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateDelegateToResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_delegate_to_resource::AssociateDelegateToResourceError {
...
mod _associate_delegate_to_resource_output;
