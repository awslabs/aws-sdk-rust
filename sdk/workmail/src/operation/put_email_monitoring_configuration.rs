...
impl PutEmailMonitoringConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_email_monitoring_configuration::PutEmailMonitoringConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEmailMonitoringConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_email_monitoring_configuration::de_put_email_monitoring_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
