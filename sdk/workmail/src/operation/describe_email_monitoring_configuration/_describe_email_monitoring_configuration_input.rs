...
impl DescribeEmailMonitoringConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfigurationInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
