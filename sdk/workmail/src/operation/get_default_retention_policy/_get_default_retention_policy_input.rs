...
impl GetDefaultRetentionPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_default_retention_policy::GetDefaultRetentionPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
