    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListGroupsForEntity")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListGroupsForEntityEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListGroupsForEntityResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListGroupsForEntityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_groups_for_entity::ser_list_groups_for_entity_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListGroupsForEntityEndpointParamsInterceptor {
...
pub type ListGroupsForEntityErrorKind = ListGroupsForEntityError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListGroupsForEntityError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_groups_for_entity::ListGroupsForEntityError {
...
impl ListGroupsForEntityError {
    ...
    /// Creates the `ListGroupsForEntityError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
