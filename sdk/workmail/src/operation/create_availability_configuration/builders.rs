...
impl crate::operation::create_availability_configuration::builders::CreateAvailabilityConfigurationInputBuilder {
...
impl CreateAvailabilityConfigurationFluentBuilder {
    /// Creates a new `CreateAvailabilityConfigurationFluentBuilder`.
