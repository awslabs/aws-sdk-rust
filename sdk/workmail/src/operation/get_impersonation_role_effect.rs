...
impl GetImpersonationRoleEffect {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetImpersonationRoleEffect",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetImpersonationRoleEffect {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetImpersonationRoleEffectRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetImpersonationRoleEffectResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetImpersonationRoleEffect")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetImpersonationRoleEffect")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetImpersonationRoleEffectTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetImpersonationRoleEffectTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetImpersonationRoleEffectTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetImpersonationRoleEffectInput>() else {
        ...
        if requested.should_capture("TargetUser") {
            if let ::std::option::Option::Some(value) = input.target_user.as_deref() {
                captured.insert("TargetUser", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetImpersonationRoleEffectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_impersonation_role_effect::de_get_impersonation_role_effect_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_impersonation_role_effect::de_get_impersonation_role_effect_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetImpersonationRoleEffectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_impersonation_role_effect::ser_get_impersonation_role_effect_input(&input)?,
        );
