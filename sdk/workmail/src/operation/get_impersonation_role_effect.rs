...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImpersonationRoleEffect {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_impersonation_role_effect::de_get_impersonation_role_effect_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError
{
