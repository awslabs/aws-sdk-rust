...
/// Orchestration and serialization glue logic for `GetImpersonationRoleEffect`.
...
impl GetImpersonationRoleEffect {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetImpersonationRoleEffect {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetImpersonationRoleEffect");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetImpersonationRoleEffectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetImpersonationRoleEffectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetImpersonationRoleEffect")
...
.with_interceptor(GetImpersonationRoleEffectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError>::new());
...
#[derive(Debug)]
            struct GetImpersonationRoleEffectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetImpersonationRoleEffectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_impersonation_role_effect::de_get_impersonation_role_effect_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_impersonation_role_effect::de_get_impersonation_role_effect_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetImpersonationRoleEffectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetImpersonationRoleEffectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_impersonation_role_effect::ser_get_impersonation_role_effect_input(&input)?);
...
#[derive(Debug)]
            struct GetImpersonationRoleEffectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetImpersonationRoleEffectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetImpersonationRoleEffectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetImpersonationRoleEffectInput>()
                        .ok_or("failed to downcast to GetImpersonationRoleEffectInput")?;
...
pub enum GetImpersonationRoleEffectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetImpersonationRoleEffectError) for what information is available for the error.")]
...
impl GetImpersonationRoleEffectError {
    /// Creates the `GetImpersonationRoleEffectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetImpersonationRoleEffectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetImpersonationRoleEffectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectError {
...
mod _get_impersonation_role_effect_output;
