...
impl GetMailDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_mail_domain::GetMailDomain,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_mail_domain::GetMailDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMailDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_mail_domain::de_get_mail_domain_http_error(
                status, headers, body,
            )
        } else {
