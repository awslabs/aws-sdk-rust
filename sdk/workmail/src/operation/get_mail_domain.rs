...
impl GetMailDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_mail_domain::GetMailDomain, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_mail_domain::ser_get_mail_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMailDomain {
    type Output =
        ::std::result::Result<crate::operation::get_mail_domain::GetMailDomainOutput, crate::operation::get_mail_domain::GetMailDomainError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_mail_domain::de_get_mail_domain_http_response_with_props(status, headers, body)
        }
    }
}
