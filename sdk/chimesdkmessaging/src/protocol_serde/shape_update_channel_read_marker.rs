...
pub fn ser_update_channel_read_marker_input(input: &crate::input::UpdateChannelReadMarkerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
