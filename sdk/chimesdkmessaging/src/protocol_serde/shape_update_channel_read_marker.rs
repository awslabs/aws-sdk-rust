...
pub fn ser_update_channel_read_marker_input(
    input: &crate::input::UpdateChannelReadMarkerInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_channel_read_marker_input::ser_update_channel_read_marker_input(&mut object, input)?;
    object.finish();
...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_update_channel_read_marker::de_update_channel_read_marker(
