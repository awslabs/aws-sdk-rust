...
) -> ::std::result::Result<Option<crate::types::PushNotificationPreferences>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "AllowNotifications" => {
                            builder = builder.set_allow_notifications(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AllowNotifications::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "FilterRule" => {
