...
pub(crate) fn de_channel_moderated_by_app_instance_user_summary_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ChannelModeratedByAppInstanceUserSummary>>, aws_smithy_json::deserialize::error::DeserializeError>
