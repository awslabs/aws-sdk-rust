...
pub fn ser_put_channel_membership_preferences_input(input: &crate::operation::put_channel_membership_preferences::PutChannelMembershipPreferencesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_put_channel_membership_preferences_input::ser_put_channel_membership_preferences_input_input(&mut object, input)?;
    object.finish();
