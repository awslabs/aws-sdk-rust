                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Mode" => {
                            builder = builder.set_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ChannelMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Privacy" => {
                            builder = builder.set_privacy(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ChannelPrivacy::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Metadata" => {
                        ...
                        "LastMessageTimestamp" => {
                            builder = builder.set_last_message_timestamp(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
