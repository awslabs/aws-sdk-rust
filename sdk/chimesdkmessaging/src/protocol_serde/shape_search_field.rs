...
pub fn ser_search_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SearchField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
