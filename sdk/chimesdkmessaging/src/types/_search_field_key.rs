...
impl ::std::convert::From<&str> for SearchFieldKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchFieldKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchFieldKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchFieldKey::from(s))
    }
}
impl SearchFieldKey {
...
impl ::std::convert::AsRef<str> for SearchFieldKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SearchFieldKey {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SearchFieldKey::Members => write!(f, "MEMBERS"),
            SearchFieldKey::Unknown(value) => write!(f, "{}", value),
        }
    }
}
