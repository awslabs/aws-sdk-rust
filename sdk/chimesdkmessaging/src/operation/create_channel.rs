...
impl CreateChannel {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("chimesdkmessaging", "CreateChannel", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateChannel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateChannel", "chimesdkmessaging"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_create_channel::ser_create_channel_headers(input, builder)?;
