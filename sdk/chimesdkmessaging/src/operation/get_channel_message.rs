...
impl GetChannelMessageInput {
    /// Consumes the builder and constructs an Operation<[`GetChannelMessage`](crate::operation::get_channel_message::GetChannelMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_channel_message::GetChannelMessage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_channel_message::GetChannelMessageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_channel_message::GetChannelMessageInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_3) = &_input.sub_channel_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_channel_message::GetChannelMessage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetChannelMessage {
                type Output = std::result::Result<crate::operation::get_channel_message::GetChannelMessageOutput, crate::operation::get_channel_message::GetChannelMessageError>;
