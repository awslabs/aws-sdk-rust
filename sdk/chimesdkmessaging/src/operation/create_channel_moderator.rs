...
impl CreateChannelModerator {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.CreateChannelModerator",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "CreateChannelModerator",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateChannelModerator")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateChannelModerator")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateChannelModeratorTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateChannelModeratorTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateChannelModeratorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateChannelModeratorInput>() else {
        ...
        if requested.should_capture("ChannelModeratorArn") {
            if let ::std::option::Option::Some(value) = input.channel_moderator_arn.as_deref() {
                captured.insert("ChannelModeratorArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateChannelModeratorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_channel_moderator::de_create_channel_moderator_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_channel_moderator::de_create_channel_moderator_http_response(status, headers, body, _cfg)
        };
