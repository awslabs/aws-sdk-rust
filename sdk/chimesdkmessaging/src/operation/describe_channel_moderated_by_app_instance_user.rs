...
impl DescribeChannelModeratedByAppInstanceUser {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.DescribeChannelModeratedByAppInstanceUser",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "DescribeChannelModeratedByAppInstanceUser",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeChannelModeratedByAppInstanceUser")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeChannelModeratedByAppInstanceUser")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DescribeChannelModeratedByAppInstanceUserTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeChannelModeratedByAppInstanceUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeChannelModeratedByAppInstanceUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeChannelModeratedByAppInstanceUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeChannelModeratedByAppInstanceUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_channel_moderated_by_app_instance_user::de_describe_channel_moderated_by_app_instance_user_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_channel_moderated_by_app_instance_user::de_describe_channel_moderated_by_app_instance_user_http_response(status, headers, body, _cfg)
        };
