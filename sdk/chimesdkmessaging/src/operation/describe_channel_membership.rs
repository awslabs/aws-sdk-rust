...
impl DescribeChannelMembershipInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_channel_membership::DescribeChannelMembership::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeChannelMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_channel_membership::de_describe_channel_membership_http_response_with_props(status, headers, body)
        }
    }
