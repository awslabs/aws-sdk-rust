...
impl DescribeChannelMembershipInput {
    /// Consumes the builder and constructs an Operation<[`DescribeChannelMembership`](crate::operation::describe_channel_membership::DescribeChannelMembership)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_channel_membership::DescribeChannelMembership, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_channel_membership::DescribeChannelMembershipInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_channel_membership::DescribeChannelMembershipInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_channel_membership::DescribeChannelMembership::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeChannelMembership {
                type Output = std::result::Result<crate::operation::describe_channel_membership::DescribeChannelMembershipOutput, crate::operation::describe_channel_membership::DescribeChannelMembershipError>;
