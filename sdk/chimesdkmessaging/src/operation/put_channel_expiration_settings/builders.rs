...
impl PutChannelExpirationSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsOutput, crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsError, Self> {
