...
impl ListChannelsAssociatedWithChannelFlow {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowInput,
                    ) -> ::std::result::Result<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelsAssociatedWithChannelFlow {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListChannelsAssociatedWithChannelFlow");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListChannelsAssociatedWithChannelFlowRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListChannelsAssociatedWithChannelFlowResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListChannelsAssociatedWithChannelFlow")
...
.with_interceptor(ListChannelsAssociatedWithChannelFlowEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_channels_associated_with_channel_flow::de_list_channels_associated_with_channel_flow_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_channels_associated_with_channel_flow::de_list_channels_associated_with_channel_flow_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelsAssociatedWithChannelFlowRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/channels").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_kv("scope", "channel-flow-associations");
    let inner_1 = &_input.channel_flow_arn;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("channel_flow_arn", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
    ...
    query.push_kv("channel-flow-arn", &::aws_smithy_http::query::fmt_string(inner_1));
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChannelsAssociatedWithChannelFlowEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListChannelsAssociatedWithChannelFlowInput>()
                        .ok_or("failed to downcast to ListChannelsAssociatedWithChannelFlowInput")?;
...
pub enum ListChannelsAssociatedWithChannelFlowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListChannelsAssociatedWithChannelFlowError) for what information is available for the error.")]
...
impl ListChannelsAssociatedWithChannelFlowError {
    /// Creates the `ListChannelsAssociatedWithChannelFlowError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListChannelsAssociatedWithChannelFlowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListChannelsAssociatedWithChannelFlowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_channels_associated_with_channel_flow::_list_channels_associated_with_channel_flow_output::ListChannelsAssociatedWithChannelFlowOutput;

pub use crate::operation::list_channels_associated_with_channel_flow::_list_channels_associated_with_channel_flow_input::ListChannelsAssociatedWithChannelFlowInput;

mod _list_channels_associated_with_channel_flow_input;

mod _list_channels_associated_with_channel_flow_output;
