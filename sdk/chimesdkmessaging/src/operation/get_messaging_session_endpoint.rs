...
impl GetMessagingSessionEndpointInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMessagingSessionEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_messaging_session_endpoint::de_get_messaging_session_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
