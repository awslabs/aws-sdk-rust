...
impl GetMessagingSessionEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpointOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetMessagingSessionEndpoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMessagingSessionEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetMessagingSessionEndpointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetMessagingSessionEndpointResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetMessagingSessionEndpoint")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMessagingSessionEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpointInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpointInput,
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.network_type {
                    {
                        query.push_kv("network-type", &::aws_smithy_http::query::fmt_string(inner_1));
                    }
                }
                ::std::result::Result::Ok(())
            }
