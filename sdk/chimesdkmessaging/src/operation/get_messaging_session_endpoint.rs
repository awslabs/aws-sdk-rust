    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/endpoints/messaging-session")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMessagingSessionEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_messaging_session_endpoint::de_get_messaging_session_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetMessagingSessionEndpointError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_messaging_session_endpoint::GetMessagingSessionEndpointError
{
