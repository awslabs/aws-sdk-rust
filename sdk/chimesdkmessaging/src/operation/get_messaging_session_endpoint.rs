...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMessagingSessionEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_messaging_session_endpoint::de_get_messaging_session_endpoint_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_messaging_session_endpoint::de_get_messaging_session_endpoint_http_response(status, headers, body, _cfg)
        };
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.network_type {
                    {
                        query.push_kv("network-type", &::aws_smithy_http::query::fmt_string(inner_1.as_str()));
                    }
                }
                ::std::result::Result::Ok(())
            }
