...
impl PutChannelMembershipPreferencesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_channel_membership_preferences::PutChannelMembershipPreferences::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutChannelMembershipPreferences {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_channel_membership_preferences::de_put_channel_membership_preferences_http_response_with_props(
                status, headers, body,
            )
        }
    }
