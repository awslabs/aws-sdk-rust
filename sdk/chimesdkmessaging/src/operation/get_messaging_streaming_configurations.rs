...
impl GetMessagingStreamingConfigurationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_messaging_streaming_configurations::GetMessagingStreamingConfigurations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_messaging_streaming_configurations::GetMessagingStreamingConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMessagingStreamingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_messaging_streaming_configurations::de_get_messaging_streaming_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
