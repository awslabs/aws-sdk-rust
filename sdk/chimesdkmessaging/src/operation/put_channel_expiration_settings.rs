    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutChannelExpirationSettings {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutChannelExpirationSettings")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutChannelExpirationSettingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutChannelExpirationSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutChannelExpirationSettingsEndpointParamsInterceptor {
...
pub type PutChannelExpirationSettingsErrorKind = PutChannelExpirationSettingsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for PutChannelExpirationSettingsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsError {
...
impl PutChannelExpirationSettingsError {
    ...
    /// Creates the `PutChannelExpirationSettingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
