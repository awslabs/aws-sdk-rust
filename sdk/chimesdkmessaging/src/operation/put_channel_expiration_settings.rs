...
impl PutChannelExpirationSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_channel_expiration_settings::PutChannelExpirationSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutChannelExpirationSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_channel_expiration_settings::de_put_channel_expiration_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
