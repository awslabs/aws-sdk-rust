...
impl GetChannelMembershipPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesInput, ::aws_smithy_types::error::operation::BuildError> {
