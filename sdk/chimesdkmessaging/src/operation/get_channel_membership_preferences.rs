...
impl GetChannelMembershipPreferencesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferences,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferences::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChannelMembershipPreferences {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_channel_membership_preferences::de_get_channel_membership_preferences_http_response_with_props(
                status, headers, body,
            )
        }
    }
