...
impl GetChannelMembershipPreferences {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetChannelMembershipPreferences {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetChannelMembershipPreferences");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetChannelMembershipPreferencesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetChannelMembershipPreferencesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetChannelMembershipPreferences")
...
.with_interceptor(GetChannelMembershipPreferencesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError>::new());
...
#[derive(Debug)]
            struct GetChannelMembershipPreferencesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetChannelMembershipPreferencesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_channel_membership_preferences::de_get_channel_membership_preferences_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetChannelMembershipPreferencesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetChannelMembershipPreferencesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetChannelMembershipPreferencesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetChannelMembershipPreferencesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetChannelMembershipPreferencesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetChannelMembershipPreferencesInput>()
                        .ok_or("failed to downcast to GetChannelMembershipPreferencesInput")?;
...
pub enum GetChannelMembershipPreferencesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetChannelMembershipPreferencesError) for what information is available for the error.")]
...
impl GetChannelMembershipPreferencesError {
    /// Creates the `GetChannelMembershipPreferencesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetChannelMembershipPreferencesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetChannelMembershipPreferencesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError {
