...
impl UpdateChannelFlowInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_channel_flow::ser_update_channel_flow_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateChannelFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_channel_flow::de_update_channel_flow_http_response_with_props(status, headers, body)
        }
    }
}
