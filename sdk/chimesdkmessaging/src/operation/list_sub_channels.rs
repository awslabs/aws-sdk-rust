...
impl ListSubChannelsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_sub_channels::ListSubChannels, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubChannels {
    type Output =
        ::std::result::Result<crate::operation::list_sub_channels::ListSubChannelsOutput, crate::operation::list_sub_channels::ListSubChannelsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sub_channels::de_list_sub_channels_http_response_with_props(status, headers, body)
        }
    }
