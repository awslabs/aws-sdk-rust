...
impl PutMessagingStreamingConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_messaging_streaming_configurations::PutMessagingStreamingConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMessagingStreamingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_messaging_streaming_configurations::de_put_messaging_streaming_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
