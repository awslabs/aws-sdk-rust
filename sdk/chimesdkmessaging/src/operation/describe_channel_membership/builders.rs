...
impl DescribeChannelMembershipFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_channel_membership::DescribeChannelMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_channel_membership::DescribeChannelMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_channel_membership::DescribeChannelMembershipOutput, crate::operation::describe_channel_membership::DescribeChannelMembershipError, Self> {
