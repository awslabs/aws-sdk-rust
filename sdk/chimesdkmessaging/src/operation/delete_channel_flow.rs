...
impl DeleteChannelFlowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_channel_flow::DeleteChannelFlow,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteChannelFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_channel_flow::de_delete_channel_flow_http_response_with_props(status, headers, body)
        }
    }
}
