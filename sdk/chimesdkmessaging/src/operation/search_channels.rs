...
impl SearchChannelsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_channels::SearchChannels::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SearchChannels {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_channels::de_search_channels_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_channels::de_search_channels_http_response(
                status, headers, body,
            )
        }
    }
