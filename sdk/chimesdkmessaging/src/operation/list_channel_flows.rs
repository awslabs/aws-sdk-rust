...
impl ListChannelFlowsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_channel_flows::ListChannelFlows,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListChannelFlows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_channel_flows::de_list_channel_flows_http_response_with_props(status, headers, body)
        }
    }
