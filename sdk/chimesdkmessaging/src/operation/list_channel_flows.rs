...
impl ListChannelFlowsInput {
    /// Consumes the builder and constructs an Operation<[`ListChannelFlows`](crate::operation::list_channel_flows::ListChannelFlows)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_channel_flows::ListChannelFlows, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_channel_flows::ListChannelFlowsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/channel-flows").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_channel_flows::ListChannelFlowsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_channel_flows::ListChannelFlows::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListChannelFlows {
                type Output = std::result::Result<crate::operation::list_channel_flows::ListChannelFlowsOutput, crate::operation::list_channel_flows::ListChannelFlowsError>;
