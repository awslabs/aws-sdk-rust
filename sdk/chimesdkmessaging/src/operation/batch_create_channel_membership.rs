...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchCreateChannelMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_create_channel_membership::de_batch_create_channel_membership_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchCreateChannelMembershipError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipError
{
