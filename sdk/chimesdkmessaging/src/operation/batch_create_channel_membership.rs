...
impl BatchCreateChannelMembershipInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_create_channel_membership::BatchCreateChannelMembership::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchCreateChannelMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_create_channel_membership::de_batch_create_channel_membership_http_response_with_props(
                status, headers, body,
            )
        }
    }
