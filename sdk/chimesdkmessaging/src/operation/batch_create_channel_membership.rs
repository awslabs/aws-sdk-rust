...
impl BatchCreateChannelMembership {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.BatchCreateChannelMembership",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "BatchCreateChannelMembership",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchCreateChannelMembership {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchCreateChannelMembershipRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchCreateChannelMembershipResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchCreateChannelMembership")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCreateChannelMembership")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BatchCreateChannelMembershipTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchCreateChannelMembershipTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCreateChannelMembershipTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchCreateChannelMembershipInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCreateChannelMembershipResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_create_channel_membership::de_batch_create_channel_membership_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_create_channel_membership::de_batch_create_channel_membership_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchCreateChannelMembershipRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipInput,
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_batch_create_channel_membership::ser_batch_create_channel_membership_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_batch_create_channel_membership::ser_batch_create_channel_membership_input(&input)?,
        );
