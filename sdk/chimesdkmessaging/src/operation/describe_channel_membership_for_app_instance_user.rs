...
impl DescribeChannelMembershipForAppInstanceUser {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.DescribeChannelMembershipForAppInstanceUser",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "DescribeChannelMembershipForAppInstanceUser",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeChannelMembershipForAppInstanceUser")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeChannelMembershipForAppInstanceUser")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DescribeChannelMembershipForAppInstanceUserTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeChannelMembershipForAppInstanceUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeChannelMembershipForAppInstanceUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeChannelMembershipForAppInstanceUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeChannelMembershipForAppInstanceUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_channel_membership_for_app_instance_user::de_describe_channel_membership_for_app_instance_user_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_channel_membership_for_app_instance_user::de_describe_channel_membership_for_app_instance_user_http_response(status, headers, body, _cfg)
        };
