...
impl ChannelFlowCallbackFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::channel_flow_callback::ChannelFlowCallbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::channel_flow_callback::ChannelFlowCallbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::channel_flow_callback::ChannelFlowCallbackOutput, crate::operation::channel_flow_callback::ChannelFlowCallbackError, Self> {
