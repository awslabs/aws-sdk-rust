...
impl DeleteChannelBan {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.DeleteChannelBan",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "DeleteChannelBan",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteChannelBan")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteChannelBan")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteChannelBanTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteChannelBanTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteChannelBanTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteChannelBanInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteChannelBanResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_channel_ban::de_delete_channel_ban_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_channel_ban::de_delete_channel_ban_http_response(status, headers, body, _cfg)
        };
