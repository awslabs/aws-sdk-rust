...
/// Orchestration and serialization glue logic for `ListChannelMemberships`.
...
impl ListChannelMemberships {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_channel_memberships::ListChannelMembershipsInput,
                    ) -> ::std::result::Result<crate::operation::list_channel_memberships::ListChannelMembershipsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_channel_memberships::ListChannelMembershipsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelMemberships {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListChannelMemberships");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListChannelMembershipsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListChannelMembershipsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListChannelMemberships")
...
.with_interceptor(ListChannelMembershipsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_channel_memberships::ListChannelMembershipsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_channel_memberships::ListChannelMembershipsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_channel_memberships::ListChannelMembershipsError>::new());
...
#[derive(Debug)]
            struct ListChannelMembershipsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChannelMembershipsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_channel_memberships::de_list_channel_memberships_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_channel_memberships::de_list_channel_memberships_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListChannelMembershipsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelMembershipsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_channel_memberships::ListChannelMembershipsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/channels/{ChannelArn}/memberships", ChannelArn = channel_arn).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_channel_memberships::ListChannelMembershipsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_5) = &_input.sub_channel_id {
         {
            query.push_kv("sub-channel-id", &::aws_smithy_http::query::fmt_string(inner_5));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListChannelMembershipsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChannelMembershipsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListChannelMembershipsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListChannelMembershipsInput>()
                        .ok_or("failed to downcast to ListChannelMembershipsInput")?;
...
pub enum ListChannelMembershipsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListChannelMembershipsError) for what information is available for the error.")]
...
impl ListChannelMembershipsError {
    /// Creates the `ListChannelMembershipsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListChannelMembershipsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListChannelMembershipsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_channel_memberships::ListChannelMembershipsError {
...
mod _list_channel_memberships_output;
