...
impl ListChannelMemberships {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Messaging.ListChannelMemberships",
            "rpc.service" = "Chime SDK Messaging",
            "rpc.method" = "ListChannelMemberships",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelMemberships {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListChannelMembershipsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListChannelMembershipsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListChannelMemberships")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListChannelMemberships")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListChannelMembershipsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListChannelMembershipsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChannelMembershipsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListChannelMembershipsInput>() else {
        ...
        if requested.should_capture("SubChannelId") {
            if let ::std::option::Option::Some(value) = input.sub_channel_id.as_deref() {
                captured.insert("SubChannelId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChannelMembershipsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_channel_memberships::de_list_channel_memberships_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_channel_memberships::de_list_channel_memberships_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelMembershipsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_channel_memberships::ListChannelMembershipsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_channel_memberships::ListChannelMembershipsInput,
