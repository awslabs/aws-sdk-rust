...
impl ChannelFlowCallbackInput {
    /// Consumes the builder and constructs an Operation<[`ChannelFlowCallback`](crate::operation::channel_flow_callback::ChannelFlowCallback)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::channel_flow_callback::ChannelFlowCallback, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::channel_flow_callback::ChannelFlowCallbackInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::channel_flow_callback::ChannelFlowCallbackInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_channel_flow_callback::ser_channel_flow_callback_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::channel_flow_callback::ChannelFlowCallback::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ChannelFlowCallback {
                type Output = std::result::Result<crate::operation::channel_flow_callback::ChannelFlowCallbackOutput, crate::operation::channel_flow_callback::ChannelFlowCallbackError>;
