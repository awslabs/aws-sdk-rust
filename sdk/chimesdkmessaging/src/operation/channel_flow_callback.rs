...
impl ChannelFlowCallbackInput {
    ...
    > {
        ...
        if self.callback_id.is_none() {
            self.callback_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
...
impl ::aws_smithy_http::response::ParseStrictResponse for ChannelFlowCallback {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_channel_flow_callback::de_channel_flow_callback_http_response_with_props(status, headers, body)
        }
    }
}
