...
impl ChannelFlowCallback {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::channel_flow_callback::ChannelFlowCallbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::channel_flow_callback::ChannelFlowCallbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::channel_flow_callback::ChannelFlowCallbackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::channel_flow_callback::ChannelFlowCallbackOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::channel_flow_callback::ChannelFlowCallbackInput = input.downcast_mut().expect("correct type");
                                    if input.callback_id.is_none() {
                                        input.callback_id = ::std::option::Option::Some(token_provider.make_idempotency_token());
                                    }
                                }))
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ChannelFlowCallback {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ChannelFlowCallback");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ChannelFlowCallbackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ChannelFlowCallbackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ChannelFlowCallback")
...
.with_interceptor(ChannelFlowCallbackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::channel_flow_callback::ChannelFlowCallbackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::channel_flow_callback::ChannelFlowCallbackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::channel_flow_callback::ChannelFlowCallbackError>::new());
...
#[derive(Debug)]
            struct ChannelFlowCallbackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChannelFlowCallbackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_channel_flow_callback::de_channel_flow_callback_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ChannelFlowCallbackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChannelFlowCallbackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::channel_flow_callback::ChannelFlowCallbackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::channel_flow_callback::ChannelFlowCallbackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::channel_flow_callback::ChannelFlowCallbackInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_channel_flow_callback::ser_channel_flow_callback_input(&input)?);
...
#[derive(Debug)]
            struct ChannelFlowCallbackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ChannelFlowCallbackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ChannelFlowCallbackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ChannelFlowCallbackInput>()
                        .ok_or("failed to downcast to ChannelFlowCallbackInput")?;
...
pub enum ChannelFlowCallbackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ChannelFlowCallbackError) for what information is available for the error.")]
...
impl ChannelFlowCallbackError {
    /// Creates the `ChannelFlowCallbackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ChannelFlowCallbackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ChannelFlowCallbackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::channel_flow_callback::ChannelFlowCallbackError {
...
mod _channel_flow_callback_output;
