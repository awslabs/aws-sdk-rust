...
impl ListChannels {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime SDK Messaging", "ListChannels", input, runtime_plugins, stop_point)
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.privacy {
                    {
                        query.push_kv("privacy", &::aws_smithy_http::query::fmt_string(inner_2.as_str()));
                    }
                }
