...
impl CreateChannelFlowInput {
    /// Consumes the builder and constructs an Operation<[`CreateChannelFlow`](crate::operation::create_channel_flow::CreateChannelFlow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_channel_flow::CreateChannelFlow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_channel_flow::CreateChannelFlowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_channel_flow::CreateChannelFlow::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateChannelFlow {
                type Output = std::result::Result<crate::operation::create_channel_flow::CreateChannelFlowOutput, crate::operation::create_channel_flow::CreateChannelFlowError>;
