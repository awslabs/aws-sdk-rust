...
impl GetChannelMessageStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_channel_message_status::GetChannelMessageStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_channel_message_status::GetChannelMessageStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_channel_message_status::GetChannelMessageStatusOutput, crate::operation::get_channel_message_status::GetChannelMessageStatusError, Self> {
