...
impl ListSubChannelsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_sub_channels::builders::ListSubChannelsInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_sub_channels::paginator::ListSubChannelsPaginator {
        crate::operation::list_sub_channels::paginator::ListSubChannelsPaginator::new(
            self.handle,
            self.inner,
        )
    }
