...
impl GetChannelMessageStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetChannelMessageStatus`](crate::operation::get_channel_message_status::GetChannelMessageStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_channel_message_status::GetChannelMessageStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_channel_message_status::GetChannelMessageStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_channel_message_status::GetChannelMessageStatusInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_channel_message_status::GetChannelMessageStatus::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetChannelMessageStatus {
                type Output = std::result::Result<crate::operation::get_channel_message_status::GetChannelMessageStatusOutput, crate::operation::get_channel_message_status::GetChannelMessageStatusError>;
