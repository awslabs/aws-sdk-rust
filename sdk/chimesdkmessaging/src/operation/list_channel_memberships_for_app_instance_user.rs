...
impl ListChannelMembershipsForAppInstanceUser {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_channel_memberships_for_app_instance_user::ListChannelMembershipsForAppInstanceUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_channel_memberships_for_app_instance_user::ListChannelMembershipsForAppInstanceUserOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListChannelMembershipsForAppInstanceUser",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelMembershipsForAppInstanceUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListChannelMembershipsForAppInstanceUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListChannelMembershipsForAppInstanceUserResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListChannelMembershipsForAppInstanceUser")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListChannelMembershipsForAppInstanceUser")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListChannelMembershipsForAppInstanceUserTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListChannelMembershipsForAppInstanceUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChannelMembershipsForAppInstanceUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListChannelMembershipsForAppInstanceUserInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("AppInstanceUserArn") {
            if let ::std::option::Option::Some(value) = input.app_instance_user_arn.as_deref() {
                captured.insert("AppInstanceUserArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChannelMembershipsForAppInstanceUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_channel_memberships_for_app_instance_user::de_list_channel_memberships_for_app_instance_user_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_list_channel_memberships_for_app_instance_user::de_list_channel_memberships_for_app_instance_user_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelMembershipsForAppInstanceUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_channel_memberships_for_app_instance_user::ListChannelMembershipsForAppInstanceUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_channel_memberships_for_app_instance_user::ListChannelMembershipsForAppInstanceUserInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_channel_memberships_for_app_instance_user::ListChannelMembershipsForAppInstanceUserError
{
