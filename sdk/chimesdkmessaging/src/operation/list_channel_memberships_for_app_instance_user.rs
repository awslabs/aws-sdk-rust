...
impl ::aws_smithy_http::response::ParseStrictResponse for ListChannelMembershipsForAppInstanceUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_channel_memberships_for_app_instance_user::de_list_channel_memberships_for_app_instance_user_http_response_with_props(status, headers, body)
        }
    }
