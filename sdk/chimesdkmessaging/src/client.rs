...
impl Client  {
    ...
    pub fn get_channel_message_status(&self) -> crate::client::fluent_builders::GetChannelMessageStatus {
    ...
    pub fn list_channels_associated_with_channel_flow(&self) -> crate::client::fluent_builders::ListChannelsAssociatedWithChannelFlow {
                            crate::client::fluent_builders::ListChannelsAssociatedWithChannelFlow::new(self.handle.clone())
                        }
    ...
    pub fn put_channel_membership_preferences(&self) -> crate::client::fluent_builders::PutChannelMembershipPreferences {
