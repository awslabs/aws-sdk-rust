...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_channel_flow::builders::AssociateChannelFlowFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::associate_channel_flow::builders::AssociateChannelFlowFluentBuilder::set_channel_arn): <p>The ARN of the channel.</p>
    ///   - [`channel_flow_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_channel_flow::builders::AssociateChannelFlowFluentBuilder::channel_flow_arn) / [`set_channel_flow_arn(Option<String>)`](crate::operation::associate_channel_flow::builders::AssociateChannelFlowFluentBuilder::set_channel_flow_arn): <p>The ARN of the channel flow.</p>
