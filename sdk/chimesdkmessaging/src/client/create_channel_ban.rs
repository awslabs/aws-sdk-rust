...
impl super::Client  {
    ...
    ///   - [`member_arn(impl Into<String>)`](crate::operation::create_channel_ban::builders::CreateChannelBanFluentBuilder::member_arn) / [`set_member_arn(Option<String>)`](crate::operation::create_channel_ban::builders::CreateChannelBanFluentBuilder::set_member_arn): <p>The <code>AppInstanceUserArn</code> of the member being banned.</p>
