...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::set_channel_arn): <p>The ARN of the channel containing the messages that you want to redact.</p>
    ///   - [`message_id(impl ::std::convert::Into<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::message_id) / [`set_message_id(Option<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::set_message_id): <p>The ID of the message being redacted.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::set_chime_bearer): <p>The ARN of the <code>AppInstanceUser</code> or <code>AppInstanceBot</code> that makes the API call.</p>
    ///   - [`sub_channel_id(impl ::std::convert::Into<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::sub_channel_id) / [`set_sub_channel_id(Option<String>)`](crate::operation::redact_channel_message::builders::RedactChannelMessageFluentBuilder::set_sub_channel_id): <p>The ID of the SubChannel in the request.</p>
