...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::list_channel_moderators::builders::ListChannelModeratorsFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::list_channel_moderators::builders::ListChannelModeratorsFluentBuilder::set_channel_arn): <p>The ARN of the channel.</p>
