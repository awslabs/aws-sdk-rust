...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_channel_arn): <p>The ARN of the channel to which you're adding users.</p>
    ///   - [`member_arn(impl ::std::convert::Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::member_arn) / [`set_member_arn(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_member_arn): <p>The <code>AppInstanceUserArn</code> of the member you want to add to the channel.</p>
    ...
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_chime_bearer): <p>The ARN of the <code>AppInstanceUser</code> or <code>AppInstanceBot</code> that makes the API call.</p>
    ///   - [`sub_channel_id(impl ::std::convert::Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::sub_channel_id) / [`set_sub_channel_id(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_sub_channel_id): <p>The ID of the SubChannel in the request.</p> <note>   <p>Only required when creating membership in a SubChannel for a moderator in an elastic channel.</p>  </note>
