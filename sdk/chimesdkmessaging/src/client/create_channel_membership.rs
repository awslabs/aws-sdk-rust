...
impl super::Client {
    ...
    ///   - [`chime_bearer(impl Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_chime_bearer): <p>The ARN of the <code>AppInstanceUser</code> or <code>AppInstanceBot</code> that makes the API call.</p>
