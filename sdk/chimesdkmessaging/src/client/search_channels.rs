...
impl super::Client {
    ...
    ///   - [`chime_bearer(impl Into<String>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::set_chime_bearer):<br>required: **false**<br><p>The <code>AppInstanceUserArn</code> of the user making the API call.</p><br>
    ///   - [`fields(SearchField)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::fields) / [`set_fields(Option<Vec::<SearchField>>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::set_fields):<br>required: **true**<br><p>A list of the <code>Field</code> objects in the channel being searched.</p><br>
    ///   - [`max_results(i32)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of channels that you want returned.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token returned from previous API requests until the number of channels is reached.</p><br>
