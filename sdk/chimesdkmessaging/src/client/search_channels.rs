...
impl super::Client {
    ...
    ///   - [`fields(SearchField)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::fields) / [`set_fields(Option<Vec<SearchField>>)`](crate::operation::search_channels::builders::SearchChannelsFluentBuilder::set_fields): <p>A list of the <code>Field</code> objects in the channel being searched.</p>
