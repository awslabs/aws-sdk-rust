...
impl super::Client {
    ...
    ///   - [`app_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::get_messaging_streaming_configurations::builders::GetMessagingStreamingConfigurationsFluentBuilder::app_instance_arn) / [`set_app_instance_arn(Option<String>)`](crate::operation::get_messaging_streaming_configurations::builders::GetMessagingStreamingConfigurationsFluentBuilder::set_app_instance_arn): <p>The ARN of the streaming configurations.</p>
