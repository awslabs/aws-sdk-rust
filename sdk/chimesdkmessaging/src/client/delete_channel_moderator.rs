...
impl super::Client {
    ...
    ///   - [`channel_moderator_arn(impl Into<String>)`](crate::operation::delete_channel_moderator::builders::DeleteChannelModeratorFluentBuilder::channel_moderator_arn) / [`set_channel_moderator_arn(Option<String>)`](crate::operation::delete_channel_moderator::builders::DeleteChannelModeratorFluentBuilder::set_channel_moderator_arn): <p>The <code>AppInstanceUserArn</code> of the moderator being deleted.</p>
    ///   - [`chime_bearer(impl Into<String>)`](crate::operation::delete_channel_moderator::builders::DeleteChannelModeratorFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::delete_channel_moderator::builders::DeleteChannelModeratorFluentBuilder::set_chime_bearer): <p>The ARN of the <code>AppInstanceUser</code> or <code>AppInstanceBot</code> that makes the API call.</p>
