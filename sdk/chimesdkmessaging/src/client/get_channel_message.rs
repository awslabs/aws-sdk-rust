...
impl super::Client {
    ...
    ///   - [`sub_channel_id(impl Into<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::sub_channel_id) / [`set_sub_channel_id(Option<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::set_sub_channel_id):<br>required: **false**<br><p>The ID of the SubChannel in the request.</p><note>  <p>Only required when getting messages in a SubChannel that the user belongs to.</p> </note><br>
