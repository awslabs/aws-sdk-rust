...
impl super::Client {
    ...
    ///   - [`sub_channel_id(impl Into<String>)`](crate::operation::list_channel_memberships::builders::ListChannelMembershipsFluentBuilder::sub_channel_id) / [`set_sub_channel_id(Option<String>)`](crate::operation::list_channel_memberships::builders::ListChannelMembershipsFluentBuilder::set_sub_channel_id): <p>The ID of the SubChannel in the request.</p> <note>   <p>Only required when listing a user's memberships in a particular sub-channel of an elastic channel.</p>  </note>
