...
impl super::Client {
    ...
    ///   - [`app_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::list_channel_flows::builders::ListChannelFlowsFluentBuilder::app_instance_arn) / [`set_app_instance_arn(Option<String>)`](crate::operation::list_channel_flows::builders::ListChannelFlowsFluentBuilder::set_app_instance_arn): <p>The ARN of the app instance.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_channel_flows::builders::ListChannelFlowsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_channel_flows::builders::ListChannelFlowsFluentBuilder::set_next_token): <p>The token passed by previous API calls until all requested channel flows are returned.</p>
