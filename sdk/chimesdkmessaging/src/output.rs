...
pub struct ListSubChannelsOutput  {
    ...
    #[doc(hidden)]pub sub_channels: std::option::Option<std::vec::Vec<crate::model::SubChannelSummary>>,
...
pub struct ListChannelsAssociatedWithChannelFlowOutput  {
    ...
    #[doc(hidden)]pub channels: std::option::Option<std::vec::Vec<crate::model::ChannelAssociatedWithFlowSummary>>,
...
pub struct ListChannelFlowsOutput  {
    ...
    #[doc(hidden)]pub channel_flows: std::option::Option<std::vec::Vec<crate::model::ChannelFlowSummary>>,
    /// <p>The token passed by previous API calls until all requested channels are returned.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeChannelFlowOutput  {
    ...
    #[doc(hidden)]pub channel_flow: std::option::Option<crate::model::ChannelFlow>,
}
