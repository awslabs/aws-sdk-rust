...
pub struct ChannelMessageStatusStructure  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::ChannelMessageStatus>,
...
pub struct Processor  {
    ...
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::ProcessorConfiguration>,
    ...
    #[doc(hidden)]pub execution_order: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub fallback_action: std::option::Option<crate::model::FallbackAction>,
}
impl Processor {
    /// <p>The name of the channel flow.</p>
...
pub struct ProcessorConfiguration  {
    ...
    #[doc(hidden)]pub lambda: std::option::Option<crate::model::LambdaConfiguration>,
}
...
pub struct PushNotificationConfiguration  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::PushNotificationType>,
}
...
pub struct ChannelSummary  {
    ...
    #[doc(hidden)]pub last_message_timestamp: std::option::Option<aws_smithy_types::DateTime>,
}
impl ChannelSummary {
    /// <p>The name of the channel.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct SearchField  {
    ...
    #[doc(hidden)]pub key: std::option::Option<crate::model::SearchFieldKey>,
    ...
    #[doc(hidden)]pub operator: std::option::Option<crate::model::SearchFieldOperator>,
}
impl SearchField {
    /// <p>An <code>enum</code> value that indicates the key to search the channel on. <code>MEMBERS</code> allows you to search channels based on memberships. You can use it with the <code>EQUALS</code> operator to get channels whose memberships are equal to the specified values, and with the <code>INCLUDES</code> operator to get channels whose memberships include the specified values.</p>
...
pub struct ChannelMembershipPreferences  {
    ...
    #[doc(hidden)]pub push_notifications: std::option::Option<crate::model::PushNotificationPreferences>,
}
...
pub struct PushNotificationPreferences  {
    ...
    #[doc(hidden)]pub allow_notifications: std::option::Option<crate::model::AllowNotifications>,
    /// <p>The simple JSON object used to send a subset of a push notification to the requested member.</p>
    #[doc(hidden)]pub filter_rule: std::option::Option<std::string::String>,
}
...
pub struct SubChannelSummary  {
    ...
    #[doc(hidden)]pub membership_count: std::option::Option<i32>,
}
...
pub struct ChannelModeratedByAppInstanceUserSummary  {
    /// <p>Summary of the details of a <code>Channel</code>.</p>
    #[doc(hidden)]pub channel_summary: std::option::Option<crate::model::ChannelSummary>,
}
...
pub struct ChannelModeratorSummary  {
    ...
    #[doc(hidden)]pub moderator: std::option::Option<crate::model::Identity>,
}
...
pub struct ChannelMessageSummary  {
    ...
    #[doc(hidden)]pub last_edited_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The message sender.</p>
    #[doc(hidden)]pub sender: std::option::Option<crate::model::Identity>,
    /// <p>Indicates whether a message was redacted.</p>
    #[doc(hidden)]pub redacted: bool,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ChannelMessageStatusStructure>,
...
pub struct ChannelMembershipForAppInstanceUserSummary  {
    ...
    #[doc(hidden)]pub app_instance_user_membership_summary: std::option::Option<crate::model::AppInstanceUserMembershipSummary>,
}
...
impl  std::fmt::Debug for ChannelMembershipForAppInstanceUserSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("channel_summary", &self.channel_summary);
        formatter.field("app_instance_user_membership_summary", &self.app_instance_user_membership_summary);
        formatter.finish()
    }
}
...
pub struct AppInstanceUserMembershipSummary  {
    ...
    #[doc(hidden)]pub read_marker_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ChannelMembershipSummary  {
    ...
    #[doc(hidden)]pub member: std::option::Option<crate::model::Identity>,
}
...
pub struct ChannelModerator  {
    ...
    #[doc(hidden)]pub created_by: std::option::Option<crate::model::Identity>,
}
...
pub struct ChannelMembership  {
    ...
    #[doc(hidden)]pub invited_by: std::option::Option<crate::model::Identity>,
...
pub struct ElasticChannelConfiguration  {
    ...
    #[doc(hidden)]pub maximum_sub_channels: std::option::Option<i32>,
    /// <p>The maximum number of members allowed in a SubChannel.</p>
    #[doc(hidden)]pub target_memberships_per_sub_channel: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub minimum_membership_percentage: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for ElasticChannelConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("target_memberships_per_sub_channel", &self.target_memberships_per_sub_channel);
        formatter.field("minimum_membership_percentage", &self.minimum_membership_percentage);
        formatter.finish()
    }
}
...
pub struct BatchChannelMemberships  {
    ...
    #[doc(hidden)]pub members: std::option::Option<std::vec::Vec<crate::model::Identity>>,
