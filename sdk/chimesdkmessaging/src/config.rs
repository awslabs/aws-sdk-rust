...
impl Builder {
    ...
    /// use aws_sdk_chimesdkmessaging::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_chimesdkmessaging::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
