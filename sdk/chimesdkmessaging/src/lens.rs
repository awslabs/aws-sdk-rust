...
pub(crate) fn reflens_list_channel_flows_output_output_next_token(
    input: &crate::operation::list_channel_flows::ListChannelFlowsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_channels_associated_with_channel_flow_output_output_next_token(
    input: &crate::operation::list_channels_associated_with_channel_flow::ListChannelsAssociatedWithChannelFlowOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_sub_channels_output_output_next_token(
    input: &crate::operation::list_sub_channels::ListSubChannelsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_search_channels_output_output_next_token(
    input: &crate::operation::search_channels::SearchChannelsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
