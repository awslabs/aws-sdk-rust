...
pub(crate) fn de_signing_profile<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SigningProfile>, aws_smithy_json::deserialize::error::DeserializeError>
