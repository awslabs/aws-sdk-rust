...
pub fn de_list_signing_platforms_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_signing_platforms::ListSigningPlatformsOutput, crate::operation::list_signing_platforms::ListSigningPlatformsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_signing_platforms::ListSigningPlatformsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_signing_platforms_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_signing_platforms::ListSigningPlatformsOutput, crate::operation::list_signing_platforms::ListSigningPlatformsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_signing_platforms::builders::ListSigningPlatformsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_signing_platforms::de_list_signing_platforms(response.body().as_ref(), output).map_err(crate::operation::list_signing_platforms::ListSigningPlatformsError::unhandled)?;
