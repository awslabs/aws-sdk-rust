...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_signing_profile_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "signingMaterial" => {
                        builder = builder.set_signing_material(
                            crate::protocol_serde::shape_signing_material::de_signing_material(
                                tokens,
                            )?,
                        );
                    }
                    "signingParameters" => {
                        builder = builder.set_signing_parameters(
                            crate::protocol_serde::shape_signing_parameters::de_signing_parameters(
                                tokens,
                            )?,
                        );
                    }
