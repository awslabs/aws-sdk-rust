...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_signing_profiles_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_signing_profiles::de_list_signing_profiles(_response_body, output)
            .map_err(crate::operation::list_signing_profiles::ListSigningProfilesError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "profiles" => {
                    builder = builder.set_profiles(crate::protocol_serde::shape_signing_profiles::de_signing_profiles(tokens)?);
                }
