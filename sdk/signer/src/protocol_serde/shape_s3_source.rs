...
pub(crate) fn de_s3_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3Source>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_s3_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3Source) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
