...
pub fn de_list_signing_jobs_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSigningJobsOutput, crate::error::ListSigningJobsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListSigningJobsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_signing_jobs_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSigningJobsOutput, crate::error::ListSigningJobsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_signing_jobs_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_signing_jobs::de_list_signing_jobs(response.body().as_ref(), output).map_err(crate::error::ListSigningJobsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_signing_jobs(value: &[u8], mut builder: crate::output::list_signing_jobs_output::Builder) -> Result<crate::output::list_signing_jobs_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
