...
pub fn ser_put_signing_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSigningProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
