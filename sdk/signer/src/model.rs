...
pub struct Source  {
    ...
    #[doc(hidden)]pub s3: std::option::Option<crate::model::S3Source>,
}
impl Source {
    /// <p>The <code>S3Source</code> object.</p>
...
pub struct SigningPlatformOverrides  {
    ...
    #[doc(hidden)]pub signing_configuration: std::option::Option<crate::model::SigningConfigurationOverrides>,
    ...
    #[doc(hidden)]pub signing_image_format: std::option::Option<crate::model::ImageFormat>,
}
...
pub struct SigningConfigurationOverrides  {
    ...
    #[doc(hidden)]pub encryption_algorithm: std::option::Option<crate::model::EncryptionAlgorithm>,
    /// <p>A specified override of the default hash algorithm that is used in a code signing job.</p>
    #[doc(hidden)]pub hash_algorithm: std::option::Option<crate::model::HashAlgorithm>,
}
...
pub struct SignatureValidityPeriod  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ValidityType>,
}
...
pub struct SigningImageFormat  {
    ...
    #[doc(hidden)]pub supported_formats: std::option::Option<std::vec::Vec<crate::model::ImageFormat>>,
    /// <p>The default format of a code signing image.</p>
    #[doc(hidden)]pub default_format: std::option::Option<crate::model::ImageFormat>,
}
...
pub struct SigningConfiguration  {
    ...
    #[doc(hidden)]pub encryption_algorithm_options: std::option::Option<crate::model::EncryptionAlgorithmOptions>,
    /// <p>The hash algorithm options that are available for a code signing job.</p>
    #[doc(hidden)]pub hash_algorithm_options: std::option::Option<crate::model::HashAlgorithmOptions>,
}
...
impl  std::fmt::Debug for SigningConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("encryption_algorithm_options", &self.encryption_algorithm_options);
...
pub struct HashAlgorithmOptions  {
    ...
    #[doc(hidden)]pub allowed_values: std::option::Option<std::vec::Vec<crate::model::HashAlgorithm>>,
    /// <p>The default hash algorithm that is used in a code signing job.</p>
    #[doc(hidden)]pub default_value: std::option::Option<crate::model::HashAlgorithm>,
}
...
pub struct EncryptionAlgorithmOptions  {
    ...
    #[doc(hidden)]pub allowed_values: std::option::Option<std::vec::Vec<crate::model::EncryptionAlgorithm>>,
    /// <p>The default encryption algorithm that is used by a code signing job.</p>
    #[doc(hidden)]pub default_value: std::option::Option<crate::model::EncryptionAlgorithm>,
}
...
pub struct SignedObject  {
    ...
    #[doc(hidden)]pub s3: std::option::Option<crate::model::S3SignedObject>,
}
impl SignedObject {
    /// <p>The <code>S3SignedObject</code>.</p>
...
pub struct SigningProfileRevocationRecord  {
    ...
    #[doc(hidden)]pub revocation_effective_from: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub revoked_by: std::option::Option<std::string::String>,
}
