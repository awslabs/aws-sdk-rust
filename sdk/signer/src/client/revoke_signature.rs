...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::revoke_signature::builders::RevokeSignatureFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::revoke_signature::builders::RevokeSignatureFluentBuilder::set_job_id): <p>ID of the signing job to be revoked.</p>
    ///   - [`job_owner(impl ::std::convert::Into<String>)`](crate::operation::revoke_signature::builders::RevokeSignatureFluentBuilder::job_owner) / [`set_job_owner(Option<String>)`](crate::operation::revoke_signature::builders::RevokeSignatureFluentBuilder::set_job_owner): <p>AWS account ID of the job owner.</p>
