...
impl super::Client {
    ...
    ///   - [`profile_name(impl Into<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::profile_name) / [`set_profile_name(Option<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::set_profile_name): <p>The name of the signing profile.</p>
    ///   - [`profile_owner(impl Into<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::profile_owner) / [`set_profile_owner(Option<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::set_profile_owner): <p>The AWS account ID of the profile owner.</p>
    ...
    ///   - [`payload_format(impl Into<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::payload_format) / [`set_payload_format(Option<String>)`](crate::operation::sign_payload::builders::SignPayloadFluentBuilder::set_payload_format): <p>Payload content type</p>
