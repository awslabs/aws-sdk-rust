    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/signing-jobs/{jobId}", jobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_signing_job::DescribeSigningJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_signing_job::DescribeSigningJobError
{
