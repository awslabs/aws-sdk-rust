...
impl ListSigningProfiles {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_signing_profiles::ListSigningProfilesInput,
                    ) -> ::std::result::Result<crate::operation::list_signing_profiles::ListSigningProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_signing_profiles::ListSigningProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_signing_profiles::ListSigningProfilesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_signing_profiles::ListSigningProfilesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSigningProfiles {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSigningProfiles");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSigningProfilesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSigningProfilesResponseDeserializer));
...
.with_interceptor(ListSigningProfilesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_signing_profiles::ListSigningProfilesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_signing_profiles::ListSigningProfilesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_signing_profiles::ListSigningProfilesError>::new());
...
#[derive(Debug)]
            struct ListSigningProfilesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSigningProfilesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_signing_profiles::de_list_signing_profiles_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_signing_profiles::de_list_signing_profiles_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListSigningProfilesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSigningProfilesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_signing_profiles::ListSigningProfilesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_signing_profiles::ListSigningProfilesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/signing-profiles").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_signing_profiles::ListSigningProfilesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.include_canceled {
         {
            query.push_kv("includeCanceled", ::aws_smithy_types::primitive::Encoder::from(*inner_1).encode());
        }
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSigningProfilesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListSigningProfilesInput>()
                        .ok_or("failed to downcast to ListSigningProfilesInput")?;
...
pub enum ListSigningProfilesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSigningProfilesError) for what information is available for the error.")]
...
impl ListSigningProfilesError {
    /// Creates the `ListSigningProfilesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListSigningProfilesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSigningProfilesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_signing_profiles::ListSigningProfilesError {
...
mod _list_signing_profiles_output;
