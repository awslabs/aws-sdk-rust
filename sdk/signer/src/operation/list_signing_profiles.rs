...
impl ListSigningProfilesInput {
    ...
    > {
                ...
                if let Some(inner_4) = &_input.statuses {
                    {
                        for inner_5 in inner_4 {
                            query
                                .push_kv("statuses", &aws_smithy_http::query::fmt_string(&inner_5));
                        }
                    }
                }
                Ok(())
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_signing_profiles::ListSigningProfiles::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListSigningProfiles {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_signing_profiles::de_list_signing_profiles_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_signing_profiles::ListSigningProfilesError
{
