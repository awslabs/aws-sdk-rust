...
impl RevokeSignatureInput {
    /// Consumes the builder and constructs an Operation<[`RevokeSignature`](crate::operation::revoke_signature::RevokeSignature)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::revoke_signature::RevokeSignature, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_revoke_signature::ser_revoke_signature_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_signature::RevokeSignature::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeSignature {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_signature::de_revoke_signature_http_response_with_props(status, headers, body)
        }
    }
}
