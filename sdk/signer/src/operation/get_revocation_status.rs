...
impl GetRevocationStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_revocation_status::GetRevocationStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRevocationStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_revocation_status::de_get_revocation_status_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_revocation_status::GetRevocationStatusError
{
