...
impl GetRevocationStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetRevocationStatus`](crate::operation::get_revocation_status::GetRevocationStatus)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let endpoint_prefix = ::aws_smithy_http::endpoint::EndpointPrefix::new("verification.")?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_revocation_status::GetRevocationStatus::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRevocationStatus", "signer"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRevocationStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_revocation_status::de_get_revocation_status_http_response_with_props(status, headers, body)
        }
    }
}
