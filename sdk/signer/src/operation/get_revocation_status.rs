...
impl GetRevocationStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_revocation_status::GetRevocationStatusError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_revocation_status::GetRevocationStatusOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("signer", "GetRevocationStatus", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRevocationStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetRevocationStatus", "signer"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRevocationStatus")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetRevocationStatusEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetRevocationStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetRevocationStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_revocation_status::GetRevocationStatusInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetRevocationStatusEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let endpoint_prefix = ::aws_smithy_http::endpoint::EndpointPrefix::new("verification.").map_err(|err| {
...
pub type GetRevocationStatusErrorKind = GetRevocationStatusError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetRevocationStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_revocation_status::GetRevocationStatusError {
...
impl GetRevocationStatusError {
    ...
    /// Creates the `GetRevocationStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
