...
impl PutSigningProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_signing_profile::PutSigningProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSigningProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_signing_profile::de_put_signing_profile_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_signing_profile::PutSigningProfileError
{
