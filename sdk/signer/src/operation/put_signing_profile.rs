...
impl PutSigningProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_signing_profile::ser_put_signing_profile_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSigningProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_signing_profile::de_put_signing_profile_http_response_with_props(status, headers, body)
        }
    }
}
