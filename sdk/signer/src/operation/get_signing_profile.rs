...
impl GetSigningProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_signing_profile::GetSigningProfile,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSigningProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_signing_profile::de_get_signing_profile_http_response_with_props(status, headers, body)
        }
    }
}
