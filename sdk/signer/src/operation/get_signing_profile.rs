...
impl GetSigningProfileInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_signing_profile::GetSigningProfile::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetSigningProfile {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_signing_profile::de_get_signing_profile_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_signing_profile::GetSigningProfileError
{
