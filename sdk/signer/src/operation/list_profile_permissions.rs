...
impl ListProfilePermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_profile_permissions::ListProfilePermissions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProfilePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_profile_permissions::de_list_profile_permissions_http_response_with_props(status, headers, body)
        }
    }
}
