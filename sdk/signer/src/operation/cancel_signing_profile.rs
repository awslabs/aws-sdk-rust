...
impl CancelSigningProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_signing_profile::CancelSigningProfile,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelSigningProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_signing_profile::de_cancel_signing_profile_http_response_with_props(status, headers, body)
        }
    }
}
