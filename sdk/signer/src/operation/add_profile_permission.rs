...
impl AddProfilePermissionInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_profile_permission::ser_add_profile_permission_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_profile_permission::AddProfilePermission::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::add_profile_permission::AddProfilePermissionError
{
