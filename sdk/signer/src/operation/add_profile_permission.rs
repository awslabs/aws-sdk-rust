...
impl AddProfilePermissionInput {
    /// Consumes the builder and constructs an Operation<[`AddProfilePermission`](crate::operation::add_profile_permission::AddProfilePermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_profile_permission::AddProfilePermission, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_profile_permission::AddProfilePermissionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_profile_permission::ser_add_profile_permission_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_profile_permission::AddProfilePermission::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddProfilePermission {
                type Output = std::result::Result<crate::operation::add_profile_permission::AddProfilePermissionOutput, crate::operation::add_profile_permission::AddProfilePermissionError>;
