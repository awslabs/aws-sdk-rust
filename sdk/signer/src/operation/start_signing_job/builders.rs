...
impl StartSigningJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_signing_job::StartSigningJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_signing_job::StartSigningJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_signing_job::StartSigningJobOutput, crate::operation::start_signing_job::StartSigningJobError, Self> {
