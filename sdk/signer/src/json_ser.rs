...
pub fn serialize_structure_add_profile_permission_input(
...
pub fn serialize_structure_put_signing_profile_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_6) = &input.overrides {
        ...
        crate::json_ser::serialize_structure_signing_platform_overrides(&mut object_7, var_6);
        object_7.finish();
    }
    ...
    if let Some(var_9) = &input.signature_validity_period {
        ...
        crate::json_ser::serialize_structure_signature_validity_period(&mut object_10, var_9);
        object_10.finish();
    }
    if let Some(var_11) = &input.signing_material {
        let mut object_12 = object.key("signingMaterial").start_object();
        crate::json_ser::serialize_structure_signing_material(&mut object_12, var_11);
        object_12.finish();
    }
...
pub fn serialize_structure_revoke_signature_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_revoke_signing_profile_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_signing_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_27) = &input.destination {
        ...
        crate::json_ser::serialize_structure_destination(&mut object_28, var_27);
        object_28.finish();
    }
    ...
    if let Some(var_31) = &input.source {
        ...
        crate::json_ser::serialize_structure_source(&mut object_32, var_31);
        object_32.finish();
    }
}
...
pub fn serialize_structure_signing_platform_overrides(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_37) = &input.signing_configuration {
        ...
        crate::json_ser::serialize_structure_signing_configuration_overrides(
            &mut object_38,
            var_37,
        );
        object_38.finish();
...
pub fn serialize_structure_signature_validity_period(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_signing_material(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_destination(
    ...
    if let Some(var_42) = &input.s3 {
        ...
        crate::json_ser::serialize_structure_s3_destination(&mut object_43, var_42);
        object_43.finish();
    }
}

pub fn serialize_structure_source(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::Source,
) {
    if let Some(var_44) = &input.s3 {
        let mut object_45 = object.key("s3").start_object();
        crate::json_ser::serialize_structure_s3_source(&mut object_45, var_44);
        object_45.finish();
    }
}

pub fn serialize_structure_signing_configuration_overrides(
    object: &mut smithy_json::serialize::JsonObjectWriter,
