...
impl ::std::convert::From<&str> for ActionCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionCode::from(s))
    }
}
impl ActionCode {
...
impl ::std::convert::AsRef<str> for ActionCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
