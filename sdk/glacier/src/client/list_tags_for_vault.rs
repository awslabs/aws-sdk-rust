...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_tags_for_vault::builders::ListTagsForVaultFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_tags_for_vault::builders::ListTagsForVaultFluentBuilder::set_account_id):<br>required: **true**<br><p>The <code>AccountId</code> value is the AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '<code>-</code>' (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, do not include any hyphens ('-') in the ID.</p><br>
    ///   - [`vault_name(impl Into<String>)`](crate::operation::list_tags_for_vault::builders::ListTagsForVaultFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::list_tags_for_vault::builders::ListTagsForVaultFluentBuilder::set_vault_name):<br>required: **true**<br><p>The name of the vault.</p><br>
