...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_provisioned_capacity::builders::ListProvisionedCapacityFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_provisioned_capacity::builders::ListProvisionedCapacityFluentBuilder::set_account_id):<br>required: **true**<br><p>The AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '-' (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, don't include any hyphens ('-') in the ID.</p><br>
