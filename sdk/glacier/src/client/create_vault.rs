...
impl super::Client {
    ...
    ///   - [`vault_name(impl Into<String>)`](crate::operation::create_vault::builders::CreateVaultFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::create_vault::builders::CreateVaultFluentBuilder::set_vault_name):<br>required: **true**<br><p>The name of the vault.</p><br>
