...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_vault::builders::DescribeVaultFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::describe_vault::builders::DescribeVaultFluentBuilder::set_account_id): <p>The <code>AccountId</code> value is the AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '<code>-</code>' (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, do not include any hyphens ('-') in the ID. </p>
    ///   - [`vault_name(impl ::std::convert::Into<String>)`](crate::operation::describe_vault::builders::DescribeVaultFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::describe_vault::builders::DescribeVaultFluentBuilder::set_vault_name): <p>The name of the vault.</p>
