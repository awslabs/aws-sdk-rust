...
impl super::Client {
    ...
    ///   - [`last_inventory_date(Option<String>)`](crate::operation::describe_vault::DescribeVaultOutput::last_inventory_date): <p>The Universal Coordinated Time (UTC) date when Amazon Glacier completed the last vault inventory. This value should be a string in the ISO 8601 date format, for example <code>2012-03-20T17:03:43.221Z</code>.</p>
