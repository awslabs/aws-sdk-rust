...
///
/// Fluent builder for the `vault_not_exists` waiter.
///
...
pub struct VaultNotExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_vault::builders::DescribeVaultInputBuilder,
}
impl VaultNotExistsFluentBuilder {
    /// Creates a new `VaultNotExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::vault_not_exists::VaultNotExistsFinalPoll,
        crate::waiters::vault_not_exists::WaitUntilVaultNotExistsError,
    > {
        let input = self
            .inner
            .build()
...
/// Successful return type for the `vault_not_exists` waiter.
pub type VaultNotExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_vault::DescribeVaultOutput,
...
/// Error type for the `vault_not_exists` waiter.
pub type WaitUntilVaultNotExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_vault::DescribeVaultOutput,
    crate::operation::describe_vault::DescribeVaultError,
>;
