                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListJobsOutput, aws_smithy_http::result::SdkError<crate::error::ListJobsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_structure_crate_output_list_jobs_output_marker(resp);
...
/// Paginator for [`ListMultipartUploads`](crate::operation::ListMultipartUploads)
            ...
            impl ListMultipartUploadsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_multipart_uploads_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListMultipartUploadsOutput, aws_smithy_http::result::SdkError<crate::error::ListMultipartUploadsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListVaults`](crate::operation::ListVaults)
            ...
            impl ListVaultsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_vaults_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListVaultsOutput, aws_smithy_http::result::SdkError<crate::error::ListVaultsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListJobsPaginator`
                ...
                impl  ListJobsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::GlacierJobDescription, aws_smithy_http::result::SdkError<crate::error::ListJobsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_jobs_output_job_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListMultipartUploadsPaginator`
                ...
                impl  ListMultipartUploadsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::UploadListElement, aws_smithy_http::result::SdkError<crate::error::ListMultipartUploadsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_multipart_uploads_output_uploads_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListPartsPaginator`
                ...
                impl  ListPartsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::PartListElement, aws_smithy_http::result::SdkError<crate::error::ListPartsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListVaultsPaginator`
                ...
                impl  ListVaultsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::DescribeVaultOutput, aws_smithy_http::result::SdkError<crate::error::ListVaultsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_vaults_output_vault_list(page).unwrap_or_default().into_iter())
                    }
                }
