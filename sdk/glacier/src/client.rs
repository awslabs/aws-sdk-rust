...
pub trait Waiters {
    ...
    fn wait_until_vault_exists(&self) -> crate::waiters::vault_exists::VaultExistsFluentBuilder;
    /// Wait for `vault_not_exists`
    fn wait_until_vault_not_exists(&self) -> crate::waiters::vault_not_exists::VaultNotExistsFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_vault_exists(&self) -> crate::waiters::vault_exists::VaultExistsFluentBuilder {
        crate::waiters::vault_exists::VaultExistsFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_vault_not_exists(&self) -> crate::waiters::vault_not_exists::VaultNotExistsFluentBuilder {
        crate::waiters::vault_not_exists::VaultNotExistsFluentBuilder::new(self.handle.clone())
    }
}
