...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod upload_archive_request_test {
    /// Glacier requires that a version header be set on all requests.
    /// Test ID: GlacierVersionHeader
    #[tokio::test]async fn glacier_version_header_request() {
    ...
    #[tokio::test]async fn glacier_checksums_request() {
        let config = crate::config::Config::builder().build();
        let input =crate::input::UploadArchiveInput::builder()
        .set_account_id(
            Some(
    ...
    #[tokio::test]async fn glacier_account_id_empty_request() {
        let config = crate::config::Config::builder().build();
        let input =crate::input::UploadArchiveInput::builder()
        .set_account_id(
            Some(
    ...
    #[tokio::test]async fn glacier_account_id_unset_request() {
        let config = crate::config::Config::builder().build();
        let input =crate::input::UploadArchiveInput::builder()
        .set_vault_name(
            Some(
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod upload_multipart_part_request_test {
    /// Glacier requires checksum headers that are cumbersome to provide.
    /// Test ID: GlacierMultipartChecksums
    #[tokio::test]async fn glacier_multipart_checksums_request() {
        let config = crate::config::Config::builder().build();
