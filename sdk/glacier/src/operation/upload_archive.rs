...
impl UploadArchiveInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::upload_archive::UploadArchive,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::upload_archive::UploadArchive::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadArchive {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_upload_archive::de_upload_archive_http_error(
                status, headers, body,
            )
        } else {
