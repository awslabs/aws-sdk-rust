...
impl UploadArchiveInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::upload_archive::UploadArchive, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body =
            ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_upload_archive_input::ser_body_http_payload(self.body)?.into_inner());
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadArchive {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_upload_archive::de_upload_archive_http_response_with_props(status, headers, body)
        }
    }
}
