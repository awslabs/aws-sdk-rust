...
impl UploadArchive {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::upload_archive::UploadArchiveOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upload_archive::UploadArchiveError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::upload_archive::UploadArchiveError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::upload_archive::UploadArchiveOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadArchive {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UploadArchive");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UploadArchiveRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UploadArchiveResponseDeserializer));
...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::upload_archive::UploadArchiveInput>::new())
.with_interceptor(crate::glacier_interceptors::GlacierTreeHashHeaderInterceptor::default())
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::upload_archive::UploadArchiveError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::upload_archive::UploadArchiveError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::upload_archive::UploadArchiveError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UploadArchiveRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::upload_archive::UploadArchiveInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::upload_archive::UploadArchiveInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/{accountId}/vaults/{vaultName}/archives", accountId = account_id, vaultName = vault_name).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UploadArchiveEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UploadArchiveInput>()
                        .ok_or("failed to downcast to UploadArchiveInput")?;
...
mod upload_archive_request_test {
    ...
    async fn glacier_version_header_request() {
        ...
        let result = client.upload_archive()
        .set_account_id(
    ...
    async fn glacier_checksums_request() {
        ...
        .set_body(
            ::std::option::Option::Some(
                ::aws_smithy_types::byte_stream::ByteStream::from_static(b"hello world")
            )
        )
        .send().await;
        let _ = dbg!(result);
...
pub enum UploadArchiveError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UploadArchiveError) for what information is available for the error.")]
...
impl UploadArchiveError {
    /// Creates the `UploadArchiveError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UploadArchiveError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UploadArchiveError {
...
impl ::aws_types::request_id::RequestId for crate::operation::upload_archive::UploadArchiveError {
