...
impl UploadArchiveInput {
    /// Consumes the builder and constructs an Operation<[`UploadArchive`](crate::operation::upload_archive::UploadArchive)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upload_archive::UploadArchive, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_archive::UploadArchiveInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        crate::glacier_checksums::add_checksum_treehash(
                                &mut request
                            ).await.map_err(aws_smithy_http::operation::error::BuildError::other)?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::upload_archive::UploadArchive::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UploadArchive {
                type Output = std::result::Result<crate::operation::upload_archive::UploadArchiveOutput, crate::operation::upload_archive::UploadArchiveError>;
