...
impl UploadArchive {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::upload_archive::UploadArchiveError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::upload_archive::UploadArchiveOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "UploadArchive", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.UploadArchive",
                "rpc.service" = "Glacier",
                "rpc.method" = "UploadArchive",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadArchive {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UploadArchiveRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UploadArchiveResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UploadArchive", "Glacier"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadArchive")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UploadArchiveTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UploadArchiveTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UploadArchiveTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UploadArchiveInput>() else {
        ...
        if requested.should_capture("archiveDescription") {
            if let ::std::option::Option::Some(value) = input.archive_description.as_deref() {
                captured.insert("archiveDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadArchiveResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_upload_archive::de_upload_archive_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_upload_archive::de_upload_archive_http_response(status, headers, body, _cfg)
        };
...
impl UploadArchiveError {
    ...
    /// Returns `true` if the error kind is `UploadArchiveError::NoLongerSupportedException`.
