...
impl CompleteVaultLockInput {
    /// Consumes the builder and constructs an Operation<[`CompleteVaultLock`](crate::operation::complete_vault_lock::CompleteVaultLock)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::complete_vault_lock::CompleteVaultLock, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::complete_vault_lock::CompleteVaultLockInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("lock_id", "cannot be empty or unset"))?;
                let lock_id = aws_smithy_http::label::fmt_string(input_3, aws_smithy_http::label::EncodingStrategy::Default);
                if lock_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("lock_id", "cannot be empty or unset"))
                            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::complete_vault_lock::CompleteVaultLock::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CompleteVaultLock {
                type Output = std::result::Result<crate::operation::complete_vault_lock::CompleteVaultLockOutput, crate::operation::complete_vault_lock::CompleteVaultLockError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_complete_vault_lock::de_complete_vault_lock_http_error(response)
                     } else {
                        crate::protocol_serde::shape_complete_vault_lock::de_complete_vault_lock_http_response(response)
                     }
                }
            }
