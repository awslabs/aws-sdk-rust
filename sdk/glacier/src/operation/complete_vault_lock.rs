...
impl CompleteVaultLock {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "CompleteVaultLock", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.CompleteVaultLock",
                "rpc.service" = "Glacier",
                "rpc.method" = "CompleteVaultLock",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CompleteVaultLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CompleteVaultLock")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CompleteVaultLock")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    CompleteVaultLockTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CompleteVaultLockTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CompleteVaultLockTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CompleteVaultLockInput>() else {
        ...
        if requested.should_capture("lockId") {
            if let ::std::option::Option::Some(value) = input.lock_id.as_deref() {
                captured.insert("lockId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CompleteVaultLockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_complete_vault_lock::de_complete_vault_lock_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_complete_vault_lock::de_complete_vault_lock_http_response(status, headers, body, _cfg)
        };
...
impl CompleteVaultLockError {
    ...
    /// Returns `true` if the error kind is `CompleteVaultLockError::NoLongerSupportedException`.
