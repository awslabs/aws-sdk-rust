...
impl DeleteVaultInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_vault::DeleteVault,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vault::DeleteVault::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_vault::de_delete_vault_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_vault::de_delete_vault_http_response_with_props(
                status, headers, body,
            )
        }
    }
