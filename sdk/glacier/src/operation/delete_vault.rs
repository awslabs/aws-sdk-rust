...
impl DeleteVaultInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVault`](crate::operation::delete_vault::DeleteVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_vault::DeleteVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vault::DeleteVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vault::DeleteVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVault {
                type Output = std::result::Result<crate::operation::delete_vault::DeleteVaultOutput, crate::operation::delete_vault::DeleteVaultError>;
