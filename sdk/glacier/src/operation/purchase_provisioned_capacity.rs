...
impl PurchaseProvisionedCapacity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Glacier",
            "rpc.method" = "PurchaseProvisionedCapacity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseProvisionedCapacity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PurchaseProvisionedCapacityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PurchaseProvisionedCapacityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PurchaseProvisionedCapacity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseProvisionedCapacity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PurchaseProvisionedCapacityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PurchaseProvisionedCapacityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseProvisionedCapacityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PurchaseProvisionedCapacityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurchaseProvisionedCapacityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_purchase_provisioned_capacity::de_purchase_provisioned_capacity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_purchase_provisioned_capacity::de_purchase_provisioned_capacity_http_response(status, headers, body, _cfg)
        };
...
impl PurchaseProvisionedCapacityError {
    ...
    /// Returns `true` if the error kind is `PurchaseProvisionedCapacityError::NoLongerSupportedException`.
