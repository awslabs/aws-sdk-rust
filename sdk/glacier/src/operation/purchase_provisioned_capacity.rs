...
impl PurchaseProvisionedCapacity {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseProvisionedCapacity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PurchaseProvisionedCapacity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PurchaseProvisionedCapacityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PurchaseProvisionedCapacityResponseDeserializer));
...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityInput>::new())
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurchaseProvisionedCapacityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseProvisionedCapacityEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PurchaseProvisionedCapacityInput>()
                        .ok_or("failed to downcast to PurchaseProvisionedCapacityInput")?;
...
pub enum PurchaseProvisionedCapacityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PurchaseProvisionedCapacityError) for what information is available for the error.")]
...
impl PurchaseProvisionedCapacityError {
    /// Creates the `PurchaseProvisionedCapacityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PurchaseProvisionedCapacityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PurchaseProvisionedCapacityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError {
...
mod _purchase_provisioned_capacity_output;
