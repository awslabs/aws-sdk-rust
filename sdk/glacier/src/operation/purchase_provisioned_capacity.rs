...
impl PurchaseProvisionedCapacityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseProvisionedCapacity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_purchase_provisioned_capacity::de_purchase_provisioned_capacity_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PurchaseProvisionedCapacityError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError
{
