...
impl PurchaseProvisionedCapacityInput {
    /// Consumes the builder and constructs an Operation<[`PurchaseProvisionedCapacity`](crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacity::new())
