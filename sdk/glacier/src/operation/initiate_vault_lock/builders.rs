...
impl InitiateVaultLockFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::initiate_vault_lock::InitiateVaultLockOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::initiate_vault_lock::InitiateVaultLockError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::initiate_vault_lock::InitiateVaultLockOutput, crate::operation::initiate_vault_lock::InitiateVaultLockError, Self> {
