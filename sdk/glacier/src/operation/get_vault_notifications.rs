...
impl GetVaultNotificationsInput {
    /// Consumes the builder and constructs an Operation<[`GetVaultNotifications`](crate::operation::get_vault_notifications::GetVaultNotifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_vault_notifications::GetVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_vault_notifications::GetVaultNotificationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_vault_notifications::GetVaultNotifications::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetVaultNotifications {
                type Output = std::result::Result<crate::operation::get_vault_notifications::GetVaultNotificationsOutput, crate::operation::get_vault_notifications::GetVaultNotificationsError>;
