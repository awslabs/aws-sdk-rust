...
impl RemoveTagsFromVaultInput {
    ...
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_tags_from_vault::RemoveTagsFromVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_tags_from_vault::RemoveTagsFromVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::remove_tags_from_vault::RemoveTagsFromVaultInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
