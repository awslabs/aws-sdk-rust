...
impl RemoveTagsFromVault {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::remove_tags_from_vault::RemoveTagsFromVaultError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::remove_tags_from_vault::RemoveTagsFromVaultOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "RemoveTagsFromVault", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.RemoveTagsFromVault",
                "rpc.service" = "Glacier",
                "rpc.method" = "RemoveTagsFromVault",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RemoveTagsFromVault")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveTagsFromVault")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    RemoveTagsFromVaultTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RemoveTagsFromVaultTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveTagsFromVaultTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveTagsFromVaultInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveTagsFromVaultResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_remove_tags_from_vault::de_remove_tags_from_vault_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_remove_tags_from_vault::de_remove_tags_from_vault_http_response(status, headers, body, _cfg)
        };
...
impl RemoveTagsFromVaultError {
    ...
    /// Returns `true` if the error kind is `RemoveTagsFromVaultError::NoLongerSupportedException`.
