...
impl crate::operation::delete_vault::builders::DeleteVaultInputBuilder {
...
impl DeleteVaultFluentBuilder {
    /// Creates a new `DeleteVaultFluentBuilder`.
