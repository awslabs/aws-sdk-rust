...
impl InitiateVaultLock {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::initiate_vault_lock::InitiateVaultLockError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::initiate_vault_lock::InitiateVaultLockOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "InitiateVaultLock", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.InitiateVaultLock",
                "rpc.service" = "Glacier",
                "rpc.method" = "InitiateVaultLock",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InitiateVaultLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InitiateVaultLockRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            InitiateVaultLockResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("InitiateVaultLock")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InitiateVaultLock")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    InitiateVaultLockTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct InitiateVaultLockTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InitiateVaultLockTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<InitiateVaultLockInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InitiateVaultLockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_initiate_vault_lock::de_initiate_vault_lock_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_initiate_vault_lock::de_initiate_vault_lock_http_response(status, headers, body, _cfg)
        };
...
impl InitiateVaultLockError {
    ...
    /// Returns `true` if the error kind is `InitiateVaultLockError::NoLongerSupportedException`.
