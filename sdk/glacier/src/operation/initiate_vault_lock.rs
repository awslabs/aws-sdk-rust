...
impl InitiateVaultLock {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::initiate_vault_lock::InitiateVaultLockError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::initiate_vault_lock::InitiateVaultLockOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("glacier", "InitiateVaultLock", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InitiateVaultLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("InitiateVaultLock", "glacier"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InitiateVaultLock")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(InitiateVaultLockEndpointParamsInterceptor) as _,
                )
                .with_interceptor(
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for InitiateVaultLockResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for InitiateVaultLockRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::initiate_vault_lock::InitiateVaultLockInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_initiate_vault_lock_input::ser_policy_http_payload(
            &input.policy,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for InitiateVaultLockEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::initiate_vault_lock::InitiateVaultLockError {
