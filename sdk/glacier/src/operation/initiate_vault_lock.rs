...
impl InitiateVaultLockInput {
    /// Consumes the builder and constructs an Operation<[`InitiateVaultLock`](crate::operation::initiate_vault_lock::InitiateVaultLock)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::initiate_vault_lock::InitiateVaultLock, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::initiate_vault_lock::InitiateVaultLockInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_initiate_vault_lock_input::ser_policy_http_payload(& self.policy)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::initiate_vault_lock::InitiateVaultLock::new())
...
impl aws_smithy_http::response::ParseStrictResponse for InitiateVaultLock {
                type Output = std::result::Result<crate::operation::initiate_vault_lock::InitiateVaultLockOutput, crate::operation::initiate_vault_lock::InitiateVaultLockError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_initiate_vault_lock::de_initiate_vault_lock_http_error(response)
                     } else {
                        crate::protocol_serde::shape_initiate_vault_lock::de_initiate_vault_lock_http_response(response)
                     }
                }
            }
