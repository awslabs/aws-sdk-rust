...
impl InitiateJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::initiate_job::InitiateJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InitiateJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_initiate_job::de_initiate_job_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_initiate_job::de_initiate_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
