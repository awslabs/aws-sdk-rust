...
impl CompleteMultipartUpload {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "CompleteMultipartUpload", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CompleteMultipartUploadTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("archiveSize") {
            if let ::std::option::Option::Some(value) = input.archive_size.as_deref() {
                captured.insert("archiveSize", value);
            }
        }
...
impl CompleteMultipartUploadError {
    ...
    /// Returns `true` if the error kind is `CompleteMultipartUploadError::NoLongerSupportedException`.
