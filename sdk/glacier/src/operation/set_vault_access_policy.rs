...
impl SetVaultAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`SetVaultAccessPolicy`](crate::operation::set_vault_access_policy::SetVaultAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_vault_access_policy::SetVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_vault_access_policy::SetVaultAccessPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_vault_access_policy_input::ser_policy_http_payload(& self.policy)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_vault_access_policy::SetVaultAccessPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetVaultAccessPolicy {
                type Output = std::result::Result<crate::operation::set_vault_access_policy::SetVaultAccessPolicyOutput, crate::operation::set_vault_access_policy::SetVaultAccessPolicyError>;
