...
impl CompleteVaultLockFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::complete_vault_lock::CompleteVaultLockOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::complete_vault_lock::CompleteVaultLockError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::complete_vault_lock::CompleteVaultLockOutput, crate::operation::complete_vault_lock::CompleteVaultLockError, Self> {
