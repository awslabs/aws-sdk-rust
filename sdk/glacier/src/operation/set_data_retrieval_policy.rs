...
impl SetDataRetrievalPolicyInput {
    /// Consumes the builder and constructs an Operation<[`SetDataRetrievalPolicy`](crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetDataRetrievalPolicy {
                type Output = std::result::Result<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyOutput, crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError>;
