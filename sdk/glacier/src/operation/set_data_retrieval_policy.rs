...
impl SetDataRetrievalPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetDataRetrievalPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_set_data_retrieval_policy::de_set_data_retrieval_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError
{
