...
impl SetDataRetrievalPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "SetDataRetrievalPolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.SetDataRetrievalPolicy",
                "rpc.service" = "Glacier",
                "rpc.method" = "SetDataRetrievalPolicy",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetDataRetrievalPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetDataRetrievalPolicyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetDataRetrievalPolicyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetDataRetrievalPolicy")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetDataRetrievalPolicy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetDataRetrievalPolicyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetDataRetrievalPolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetDataRetrievalPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetDataRetrievalPolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetDataRetrievalPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_set_data_retrieval_policy::de_set_data_retrieval_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_data_retrieval_policy::de_set_data_retrieval_policy_http_response(status, headers, body, _cfg)
        };
...
impl SetDataRetrievalPolicyError {
    ...
    /// Returns `true` if the error kind is `SetDataRetrievalPolicyError::NoLongerSupportedException`.
