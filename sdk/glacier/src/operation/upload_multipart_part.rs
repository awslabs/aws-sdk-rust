...
impl UploadMultipartPart {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "UploadMultipartPart", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.UploadMultipartPart",
                "rpc.service" = "Glacier",
                "rpc.method" = "UploadMultipartPart",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UploadMultipartPart")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UploadMultipartPartResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_upload_multipart_part::de_upload_multipart_part_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_upload_multipart_part::de_upload_multipart_part_http_response(status, headers, body, _cfg)
        };
...
impl UploadMultipartPartError {
    ...
    /// Returns `true` if the error kind is `UploadMultipartPartError::NoLongerSupportedException`.
