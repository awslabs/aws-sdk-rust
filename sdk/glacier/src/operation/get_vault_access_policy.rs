...
impl GetVaultAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetVaultAccessPolicy`](crate::operation::get_vault_access_policy::GetVaultAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_vault_access_policy::GetVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_vault_access_policy::GetVaultAccessPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_vault_access_policy::GetVaultAccessPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetVaultAccessPolicy {
                type Output = std::result::Result<crate::operation::get_vault_access_policy::GetVaultAccessPolicyOutput, crate::operation::get_vault_access_policy::GetVaultAccessPolicyError>;
