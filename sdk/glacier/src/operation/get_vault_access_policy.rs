...
impl GetVaultAccessPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_vault_access_policy::GetVaultAccessPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_vault_access_policy::GetVaultAccessPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "GetVaultAccessPolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.GetVaultAccessPolicy",
                "rpc.service" = "Glacier",
                "rpc.method" = "GetVaultAccessPolicy",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVaultAccessPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetVaultAccessPolicyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetVaultAccessPolicyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetVaultAccessPolicy")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVaultAccessPolicy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetVaultAccessPolicyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetVaultAccessPolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVaultAccessPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetVaultAccessPolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVaultAccessPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_vault_access_policy::de_get_vault_access_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_vault_access_policy::de_get_vault_access_policy_http_response(status, headers, body, _cfg)
        };
...
impl GetVaultAccessPolicyError {
    ...
    /// Returns `true` if the error kind is `GetVaultAccessPolicyError::NoLongerSupportedException`.
