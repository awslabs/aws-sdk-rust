...
impl InitiateMultipartUpload {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "InitiateMultipartUpload", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.InitiateMultipartUpload",
                "rpc.service" = "Glacier",
                "rpc.method" = "InitiateMultipartUpload",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InitiateMultipartUpload {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InitiateMultipartUploadRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            InitiateMultipartUploadResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("InitiateMultipartUpload")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InitiateMultipartUpload")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                InitiateMultipartUploadTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct InitiateMultipartUploadTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InitiateMultipartUploadTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<InitiateMultipartUploadInput>() else {
        ...
        if requested.should_capture("partSize") {
            if let ::std::option::Option::Some(value) = input.part_size.as_deref() {
                captured.insert("partSize", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InitiateMultipartUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_initiate_multipart_upload::de_initiate_multipart_upload_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_initiate_multipart_upload::de_initiate_multipart_upload_http_response(status, headers, body, _cfg)
        };
...
impl InitiateMultipartUploadError {
    ...
    /// Returns `true` if the error kind is `InitiateMultipartUploadError::NoLongerSupportedException`.
...
impl ::aws_types::request_id::RequestId for crate::operation::initiate_multipart_upload::InitiateMultipartUploadError {
