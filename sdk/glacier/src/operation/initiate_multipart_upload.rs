...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadInput>::new())
...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>::new());
