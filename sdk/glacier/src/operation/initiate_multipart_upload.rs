...
impl InitiateMultipartUploadInput {
    /// Consumes the builder and constructs an Operation<[`InitiateMultipartUpload`](crate::operation::initiate_multipart_upload::InitiateMultipartUpload)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::initiate_multipart_upload::InitiateMultipartUpload, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::initiate_multipart_upload::InitiateMultipartUploadInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::initiate_multipart_upload::InitiateMultipartUpload::new())
...
impl aws_smithy_http::response::ParseStrictResponse for InitiateMultipartUpload {
                type Output = std::result::Result<crate::operation::initiate_multipart_upload::InitiateMultipartUploadOutput, crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>;
