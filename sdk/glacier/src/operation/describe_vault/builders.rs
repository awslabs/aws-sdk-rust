...
impl crate::operation::describe_vault::builders::DescribeVaultInputBuilder {
...
impl DescribeVaultFluentBuilder {
    /// Creates a new `DescribeVaultFluentBuilder`.
