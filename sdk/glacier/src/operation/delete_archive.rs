...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::delete_archive::DeleteArchiveInput>::new())
...
#[derive(Debug)]
    ...
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("archive_id", "cannot be empty or unset"))?;
    let archive_id = ::aws_smithy_http::label::fmt_string(input_3, ::aws_smithy_http::label::EncodingStrategy::Default);
    if archive_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("archive_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/{accountId}/vaults/{vaultName}/archives/{archiveId}", accountId = account_id, vaultName = vault_name, archiveId = archive_id).expect("formatting should succeed");
