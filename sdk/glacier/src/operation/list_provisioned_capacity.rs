...
impl ListProvisionedCapacity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_provisioned_capacity::ListProvisionedCapacityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_provisioned_capacity::ListProvisionedCapacityOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "ListProvisionedCapacity", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.ListProvisionedCapacity",
                "rpc.service" = "Glacier",
                "rpc.method" = "ListProvisionedCapacity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListProvisionedCapacity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListProvisionedCapacityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListProvisionedCapacityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListProvisionedCapacity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListProvisionedCapacity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListProvisionedCapacityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListProvisionedCapacityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListProvisionedCapacityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListProvisionedCapacityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListProvisionedCapacityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_provisioned_capacity::de_list_provisioned_capacity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_provisioned_capacity::de_list_provisioned_capacity_http_response(status, headers, body, _cfg)
        };
...
impl ListProvisionedCapacityError {
    ...
    /// Returns `true` if the error kind is `ListProvisionedCapacityError::NoLongerSupportedException`.
