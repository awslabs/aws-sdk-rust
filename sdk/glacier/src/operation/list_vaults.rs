    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/{accountId}/vaults", accountId = account_id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVaults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_vaults::de_list_vaults_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_vaults::de_list_vaults_http_response_with_props(
                status, headers, body,
            )
        }
    }
