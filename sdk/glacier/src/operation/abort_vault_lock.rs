...
impl AbortVaultLock {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::abort_vault_lock::AbortVaultLockError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::abort_vault_lock::AbortVaultLockOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "AbortVaultLock", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.AbortVaultLock",
                "rpc.service" = "Glacier",
                "rpc.method" = "AbortVaultLock",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AbortVaultLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AbortVaultLockRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AbortVaultLockResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AbortVaultLock")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("AbortVaultLock", "Glacier"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AbortVaultLock")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AbortVaultLockTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::abort_vault_lock::AbortVaultLockInput>::new(),
            ))
...
#[derive(Debug)]
struct AbortVaultLockTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AbortVaultLockTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AbortVaultLockInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AbortVaultLockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_abort_vault_lock::de_abort_vault_lock_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_abort_vault_lock::de_abort_vault_lock_http_response(status, headers, body, _cfg)
        };
...
impl AbortVaultLockError {
    ...
    /// Returns `true` if the error kind is `AbortVaultLockError::NoLongerSupportedException`.
