...
impl GetJobOutputInput {
    /// Consumes the builder and constructs an Operation<[`GetJobOutput`](crate::operation::get_job_output::GetJobOutput)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_job_output::GetJobOutput, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_job_output::GetJobOutputInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_job_output::GetJobOutput::new())
...
impl aws_smithy_http::response::ParseHttpResponse for GetJobOutput {
                type Output = std::result::Result<crate::operation::get_job_output::GetJobOutputOutput, crate::operation::get_job_output::GetJobOutputError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    ...
                    Some(crate::protocol_serde::shape_get_job_output::de_get_job_output_http_response_(response))
                }
                fn parse_loaded(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_job_output::de_get_job_output_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
