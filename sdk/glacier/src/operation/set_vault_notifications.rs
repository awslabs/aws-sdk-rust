...
impl SetVaultNotificationsInput {
    /// Consumes the builder and constructs an Operation<[`SetVaultNotifications`](crate::operation::set_vault_notifications::SetVaultNotifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_vault_notifications::SetVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_vault_notifications::SetVaultNotificationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_vault_notifications::SetVaultNotifications::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetVaultNotifications {
                type Output = std::result::Result<crate::operation::set_vault_notifications::SetVaultNotificationsOutput, crate::operation::set_vault_notifications::SetVaultNotificationsError>;
