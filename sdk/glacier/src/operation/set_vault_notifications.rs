...
impl SetVaultNotifications {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_vault_notifications::SetVaultNotificationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_vault_notifications::SetVaultNotificationsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "SetVaultNotifications", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.SetVaultNotifications",
                "rpc.service" = "Glacier",
                "rpc.method" = "SetVaultNotifications",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetVaultNotifications {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetVaultNotificationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetVaultNotificationsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetVaultNotifications")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetVaultNotifications")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetVaultNotificationsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetVaultNotificationsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetVaultNotificationsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetVaultNotificationsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetVaultNotificationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_set_vault_notifications::de_set_vault_notifications_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_vault_notifications::de_set_vault_notifications_http_response(status, headers, body, _cfg)
        };
...
impl SetVaultNotificationsError {
    ...
    /// Returns `true` if the error kind is `SetVaultNotificationsError::NoLongerSupportedException`.
