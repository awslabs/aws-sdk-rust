...
impl SetVaultAccessPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_vault_access_policy::SetVaultAccessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_vault_access_policy::SetVaultAccessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_vault_access_policy::SetVaultAccessPolicyOutput, crate::operation::set_vault_access_policy::SetVaultAccessPolicyError, Self> {
