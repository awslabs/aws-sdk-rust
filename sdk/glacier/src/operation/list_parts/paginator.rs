...
/// Flattened paginator for `ListPartsPaginator`
                ...
                impl  ListPartsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::PartListElement, aws_smithy_http::result::SdkError<crate::operation::list_parts::ListPartsError>>> + Unpin
                     {
