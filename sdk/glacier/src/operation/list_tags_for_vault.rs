...
impl ListTagsForVaultInput {
    /// Consumes the builder and constructs an Operation<[`ListTagsForVault`](crate::operation::list_tags_for_vault::ListTagsForVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_tags_for_vault::ListTagsForVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_tags_for_vault::ListTagsForVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_tags_for_vault::ListTagsForVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTagsForVault {
                type Output = std::result::Result<crate::operation::list_tags_for_vault::ListTagsForVaultOutput, crate::operation::list_tags_for_vault::ListTagsForVaultError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_tags_for_vault::de_list_tags_for_vault_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_tags_for_vault::de_list_tags_for_vault_http_response(response)
                     }
                }
            }
