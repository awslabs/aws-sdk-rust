...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_vault::de_describe_vault_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_vault::de_describe_vault_http_response_with_props(
                status, headers, body,
            )
        }
    }
