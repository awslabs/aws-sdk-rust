...
impl GetVaultNotificationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_vault_notifications::GetVaultNotificationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_vault_notifications::GetVaultNotificationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_vault_notifications::GetVaultNotificationsOutput, crate::operation::get_vault_notifications::GetVaultNotificationsError, Self> {
