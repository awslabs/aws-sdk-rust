...
impl crate::operation::get_vault_notifications::builders::GetVaultNotificationsInputBuilder {
...
impl GetVaultNotificationsFluentBuilder {
    /// Creates a new `GetVaultNotificationsFluentBuilder`.
