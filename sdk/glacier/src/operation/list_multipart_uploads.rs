...
impl ListMultipartUploads {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_multipart_uploads::ListMultipartUploadsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_multipart_uploads::ListMultipartUploadsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_multipart_uploads::ListMultipartUploadsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_multipart_uploads::ListMultipartUploadsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMultipartUploads {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMultipartUploads");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMultipartUploadsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMultipartUploadsResponseDeserializer));
...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::list_multipart_uploads::ListMultipartUploadsInput>::new())
...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_multipart_uploads::ListMultipartUploadsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMultipartUploadsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_multipart_uploads::ListMultipartUploadsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_multipart_uploads::ListMultipartUploadsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/{accountId}/vaults/{vaultName}/multipart-uploads", accountId = account_id, vaultName = vault_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_multipart_uploads::ListMultipartUploadsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMultipartUploadsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMultipartUploadsInput>()
                        .ok_or("failed to downcast to ListMultipartUploadsInput")?;
...
pub enum ListMultipartUploadsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMultipartUploadsError) for what information is available for the error.")]
...
impl ListMultipartUploadsError {
    /// Creates the `ListMultipartUploadsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMultipartUploadsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMultipartUploadsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_multipart_uploads::ListMultipartUploadsError {
...
mod _list_multipart_uploads_output;
