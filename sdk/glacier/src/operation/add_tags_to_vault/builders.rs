...
impl AddTagsToVaultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_tags_to_vault::AddTagsToVaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_tags_to_vault::AddTagsToVaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_tags_to_vault::AddTagsToVaultOutput, crate::operation::add_tags_to_vault::AddTagsToVaultError, Self> {
