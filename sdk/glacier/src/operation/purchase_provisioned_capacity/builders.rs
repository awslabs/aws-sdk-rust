...
impl crate::operation::purchase_provisioned_capacity::builders::PurchaseProvisionedCapacityInputBuilder {
...
impl PurchaseProvisionedCapacityFluentBuilder {
    /// Creates a new `PurchaseProvisionedCapacityFluentBuilder`.
