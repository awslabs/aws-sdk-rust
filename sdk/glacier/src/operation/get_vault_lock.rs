...
impl GetVaultLockInput {
    /// Consumes the builder and constructs an Operation<[`GetVaultLock`](crate::operation::get_vault_lock::GetVaultLock)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_vault_lock::GetVaultLock, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_vault_lock::GetVaultLockInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_vault_lock::GetVaultLock::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetVaultLock {
                type Output = std::result::Result<crate::operation::get_vault_lock::GetVaultLockOutput, crate::operation::get_vault_lock::GetVaultLockError>;
