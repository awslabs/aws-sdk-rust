...
impl GetVaultLock {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_vault_lock::GetVaultLockError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_vault_lock::GetVaultLockOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "GetVaultLock", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.GetVaultLock",
                "rpc.service" = "Glacier",
                "rpc.method" = "GetVaultLock",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVaultLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetVaultLockRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetVaultLockResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetVaultLock")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetVaultLock", "Glacier"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVaultLock")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetVaultLockTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::get_vault_lock::GetVaultLockInput>::new(),
            ))
...
#[derive(Debug)]
struct GetVaultLockTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVaultLockTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetVaultLockInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVaultLockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_vault_lock::de_get_vault_lock_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_vault_lock::de_get_vault_lock_http_response(status, headers, body, _cfg)
        };
...
impl GetVaultLockError {
    ...
    /// Returns `true` if the error kind is `GetVaultLockError::NoLongerSupportedException`.
