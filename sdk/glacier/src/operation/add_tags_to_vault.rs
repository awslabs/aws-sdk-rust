...
impl AddTagsToVaultInput {
    /// Consumes the builder and constructs an Operation<[`AddTagsToVault`](crate::operation::add_tags_to_vault::AddTagsToVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_tags_to_vault::AddTagsToVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_tags_to_vault::AddTagsToVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::add_tags_to_vault::AddTagsToVaultInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_vault::AddTagsToVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddTagsToVault {
                type Output = std::result::Result<crate::operation::add_tags_to_vault::AddTagsToVaultOutput, crate::operation::add_tags_to_vault::AddTagsToVaultError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_add_tags_to_vault::de_add_tags_to_vault_http_error(response)
                     } else {
                        crate::protocol_serde::shape_add_tags_to_vault::de_add_tags_to_vault_http_response(response)
                     }
                }
            }
