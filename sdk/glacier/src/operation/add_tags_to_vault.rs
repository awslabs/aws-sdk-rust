...
impl AddTagsToVault {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_tags_to_vault::AddTagsToVaultError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_tags_to_vault::AddTagsToVaultOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "AddTagsToVault", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.AddTagsToVault",
                "rpc.service" = "Glacier",
                "rpc.method" = "AddTagsToVault",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddTagsToVault {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddTagsToVaultRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddTagsToVaultResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddTagsToVault")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("AddTagsToVault", "Glacier"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddTagsToVault")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AddTagsToVaultTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::add_tags_to_vault::AddTagsToVaultInput>::new(),
            ))
...
#[derive(Debug)]
struct AddTagsToVaultTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddTagsToVaultTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AddTagsToVaultInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddTagsToVaultResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_add_tags_to_vault::de_add_tags_to_vault_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_tags_to_vault::de_add_tags_to_vault_http_response(status, headers, body, _cfg)
        };
