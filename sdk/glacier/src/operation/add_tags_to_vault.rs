...
impl AddTagsToVaultInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_tags_to_vault::AddTagsToVault, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_tags_to_vault::ser_add_tags_to_vault_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddTagsToVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_add_tags_to_vault::de_add_tags_to_vault_http_response_with_props(status, headers, body)
        }
    }
}
