...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::list_jobs::ListJobsInput>::new())
...
#[derive(Debug)]
    ...
    ::std::write!(output, "/{accountId}/vaults/{vaultName}/jobs", accountId = account_id, vaultName = vault_name).expect("formatting should succeed");
