...
impl ListJobs {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "ListJobs", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListJobs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListJobs", "Glacier"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListJobs")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::list_jobs::ListJobsInput>::new(),
            ))
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListJobsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("statuscode") {
            if let ::std::option::Option::Some(value) = input.statuscode.as_deref() {
                captured.insert("statuscode", value);
            }
        }
        if requested.should_capture("completed") {
            if let ::std::option::Option::Some(value) = input.completed.as_deref() {
                captured.insert("completed", value);
            }
        }
...
impl ListJobsError {
    ...
    /// Returns `true` if the error kind is `ListJobsError::NoLongerSupportedException`.
