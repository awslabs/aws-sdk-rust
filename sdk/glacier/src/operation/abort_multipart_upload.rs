...
impl AbortMultipartUpload {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "AbortMultipartUpload", input, runtime_plugins, stop_point)
...
impl AbortMultipartUploadError {
    ...
    /// Returns `true` if the error kind is `AbortMultipartUploadError::NoLongerSupportedException`.
