...
impl DeleteVaultAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVaultAccessPolicy`](crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVaultAccessPolicy {
                type Output = std::result::Result<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput, crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>;
