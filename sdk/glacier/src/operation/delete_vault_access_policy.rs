...
impl DeleteVaultAccessPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glacier", "DeleteVaultAccessPolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glacier.DeleteVaultAccessPolicy",
                "rpc.service" = "Glacier",
                "rpc.method" = "DeleteVaultAccessPolicy",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVaultAccessPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteVaultAccessPolicyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteVaultAccessPolicyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteVaultAccessPolicy")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVaultAccessPolicy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteVaultAccessPolicyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteVaultAccessPolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVaultAccessPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteVaultAccessPolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVaultAccessPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_vault_access_policy::de_delete_vault_access_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_vault_access_policy::de_delete_vault_access_policy_http_response(status, headers, body, _cfg)
        };
...
impl DeleteVaultAccessPolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteVaultAccessPolicyError::NoLongerSupportedException`.
