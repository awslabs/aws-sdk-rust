...
impl DeleteVaultAccessPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVaultAccessPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVaultAccessPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVaultAccessPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVaultAccessPolicyResponseDeserializer));
...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyInput>::new())
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVaultAccessPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/{accountId}/vaults/{vaultName}/access-policy", accountId = account_id, vaultName = vault_name).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVaultAccessPolicyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVaultAccessPolicyInput>()
                        .ok_or("failed to downcast to DeleteVaultAccessPolicyInput")?;
...
pub enum DeleteVaultAccessPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVaultAccessPolicyError) for what information is available for the error.")]
...
impl DeleteVaultAccessPolicyError {
    /// Creates the `DeleteVaultAccessPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVaultAccessPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVaultAccessPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_vault_access_policy::_delete_vault_access_policy_output::DeleteVaultAccessPolicyOutput;

pub use crate::operation::delete_vault_access_policy::_delete_vault_access_policy_input::DeleteVaultAccessPolicyInput;

mod _delete_vault_access_policy_input;

mod _delete_vault_access_policy_output;
