...
impl GetDataRetrievalPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDataRetrievalPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDataRetrievalPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDataRetrievalPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDataRetrievalPolicyResponseDeserializer));
...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyInput>::new())
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDataRetrievalPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDataRetrievalPolicyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDataRetrievalPolicyInput>()
                        .ok_or("failed to downcast to GetDataRetrievalPolicyInput")?;
...
pub enum GetDataRetrievalPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDataRetrievalPolicyError) for what information is available for the error.")]
...
impl GetDataRetrievalPolicyError {
    /// Creates the `GetDataRetrievalPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDataRetrievalPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDataRetrievalPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError {
...
mod _get_data_retrieval_policy_output;
