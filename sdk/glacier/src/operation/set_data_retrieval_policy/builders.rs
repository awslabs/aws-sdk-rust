...
impl SetDataRetrievalPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyOutput, crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError, Self> {
