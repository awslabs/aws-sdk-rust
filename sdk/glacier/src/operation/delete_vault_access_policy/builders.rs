...
impl DeleteVaultAccessPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyOutput, crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError, Self> {
