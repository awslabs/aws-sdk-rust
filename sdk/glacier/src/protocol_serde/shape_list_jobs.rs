...
pub fn de_list_jobs_http_error(
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::list_jobs::ListJobsError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "JobList" => {
                    builder = builder.set_job_list(crate::protocol_serde::shape_job_list::de_job_list(tokens, _value, depth + 1)?);
                }
                "Marker" => {
