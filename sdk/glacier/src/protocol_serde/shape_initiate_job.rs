...
pub fn de_initiate_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InitiateJobOutput, crate::error::InitiateJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::InitiateJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_initiate_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InitiateJobOutput, crate::error::InitiateJobError> {
    Ok({
        #[allow(unused_mut)]
