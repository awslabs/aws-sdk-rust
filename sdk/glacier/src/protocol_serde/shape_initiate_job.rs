...
pub fn de_initiate_job_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::initiate_job::InitiateJobOutput, crate::operation::initiate_job::InitiateJobError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::initiate_job::InitiateJobError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_initiate_job_http_response(
    ...
    Ok({
        ...
        output = output.set_job_output_path(
            crate::protocol_serde::shape_initiate_job_output::de_job_output_path_header(_response_headers).map_err(|_| {
                crate::operation::initiate_job::InitiateJobError::unhandled("Failed to parse jobOutputPath from header `x-amz-job-output-path")
            })?,
        );
