...
pub(crate) fn de_vault_access_policy_payload(
    input: &[u8],
) -> Result<crate::types::VaultAccessPolicy, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_vault_access_policy::de_vault_access_policy(tokens)?
...
) -> Result<Option<crate::types::VaultAccessPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
