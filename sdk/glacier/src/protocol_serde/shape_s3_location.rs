            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Tagging" => {
                            builder = builder.set_tagging(crate::protocol_serde::shape_hashmap::de_hashmap(tokens)?);
                        }
                        "UserMetadata" => {
                            builder = builder.set_user_metadata(crate::protocol_serde::shape_hashmap::de_hashmap(tokens)?);
                        }
                        "StorageClass" => {
