...
pub fn de_upload_archive_http_response(
    ...
    Ok({
        ...
        output = output.set_archive_id(
            match crate::protocol_serde::shape_upload_archive_output::de_archive_id_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::upload_archive::UploadArchiveError::unhandled(
        ...
        output = output.set_checksum(
            match crate::protocol_serde::shape_upload_archive_output::de_checksum_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_location(
            match crate::protocol_serde::shape_upload_archive_output::de_location_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
