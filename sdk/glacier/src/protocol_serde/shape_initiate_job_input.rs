...
pub fn ser_job_parameters_http_payload(
    payload: &::std::option::Option<crate::types::JobParameters>,
    ...
    Ok(crate::protocol_serde::shape_initiate_job_input::ser_job_parameters_payload(payload)?)
}
