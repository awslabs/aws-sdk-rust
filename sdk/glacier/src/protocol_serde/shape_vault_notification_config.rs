...
pub(crate) fn de_vault_notification_config_payload(
    input: &[u8],
) -> Result<crate::types::VaultNotificationConfig, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_vault_notification_config::de_vault_notification_config(tokens)?
...
) -> Result<Option<crate::types::VaultNotificationConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Events" => {
                            builder = builder.set_events(crate::protocol_serde::shape_notification_event_list::de_notification_event_list(tokens)?);
                        }
