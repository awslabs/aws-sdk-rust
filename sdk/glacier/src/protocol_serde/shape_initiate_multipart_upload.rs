        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("archive_description", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.part_size {
        let formatted_4 = inner_3.as_str();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("part_size", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
