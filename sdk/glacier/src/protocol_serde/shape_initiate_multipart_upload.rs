...
> {
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::initiate_multipart_upload::InitiateMultipartUploadError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = output.set_location(
            match crate::protocol_serde::shape_initiate_multipart_upload_output::de_location_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::initiate_multipart_upload::InitiateMultipartUploadError::unhandled(
        ...
        output = output.set_upload_id(
            match crate::protocol_serde::shape_initiate_multipart_upload_output::de_upload_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("x-amz-multipart-upload-id")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
