...
pub fn de_get_vault_access_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_vault_access_policy::GetVaultAccessPolicyOutput, crate::operation::get_vault_access_policy::GetVaultAccessPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_vault_access_policy::GetVaultAccessPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_vault_access_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_vault_access_policy::GetVaultAccessPolicyOutput, crate::operation::get_vault_access_policy::GetVaultAccessPolicyError> {
    Ok({
        #[allow(unused_mut)]
