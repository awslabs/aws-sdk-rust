...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::set_data_retrieval_policy::SetDataRetrievalPolicyError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
