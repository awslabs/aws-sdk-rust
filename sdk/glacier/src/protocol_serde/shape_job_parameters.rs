...
pub fn ser_job_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
