...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_provisioned_capacity::ListProvisionedCapacityError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::list_provisioned_capacity::ListProvisionedCapacityError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_provisioned_capacity::de_list_provisioned_capacity(_response_body, output)
            .map_err(crate::operation::list_provisioned_capacity::ListProvisionedCapacityError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ProvisionedCapacityList" => {
                    builder = builder.set_provisioned_capacity_list(
                        crate::protocol_serde::shape_provisioned_capacity_list::de_provisioned_capacity_list(tokens, _value, depth + 1)?,
                    );
                }
