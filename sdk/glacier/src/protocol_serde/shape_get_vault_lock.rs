...
pub fn de_get_vault_lock_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_vault_lock::GetVaultLockOutput, crate::operation::get_vault_lock::GetVaultLockError> {
    #[allow(unused_mut)]
...
pub fn de_get_vault_lock_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_vault_lock::de_get_vault_lock(_response_body, output)
            .map_err(crate::operation::get_vault_lock::GetVaultLockError::unhandled)?;
...
) -> Result<crate::operation::get_vault_lock::builders::GetVaultLockOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
