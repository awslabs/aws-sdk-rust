...
pub(crate) fn de_glacier_job_description<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::GlacierJobDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SelectParameters" => {
                            builder =
                                builder.set_select_parameters(crate::protocol_serde::shape_select_parameters::de_select_parameters(tokens, _value)?);
                        }
                        "OutputLocation" => {
