...
pub(crate) fn de_glacier_job_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GlacierJobDescription>, aws_smithy_json::deserialize::error::DeserializeError>
