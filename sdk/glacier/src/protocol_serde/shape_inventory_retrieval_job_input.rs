...
pub fn ser_inventory_retrieval_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InventoryRetrievalJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
