...
pub fn de_delete_vault_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_vault::DeleteVaultOutput, crate::operation::delete_vault::DeleteVaultError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::delete_vault::DeleteVaultError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
