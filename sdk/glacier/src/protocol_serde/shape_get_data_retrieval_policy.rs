...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_data_retrieval_policy::de_get_data_retrieval_policy(_response_body, output)
            .map_err(crate::operation::get_data_retrieval_policy::GetDataRetrievalPolicyError::unhandled)?;
