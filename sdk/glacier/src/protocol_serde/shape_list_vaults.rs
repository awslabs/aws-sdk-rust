...
pub fn de_list_vaults_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVaultsOutput, crate::error::ListVaultsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListVaultsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_vaults_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVaultsOutput, crate::error::ListVaultsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_vaults_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_vaults::de_list_vaults(response.body().as_ref(), output).map_err(crate::error::ListVaultsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_vaults(value: &[u8], mut builder: crate::output::list_vaults_output::Builder) -> Result<crate::output::list_vaults_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
