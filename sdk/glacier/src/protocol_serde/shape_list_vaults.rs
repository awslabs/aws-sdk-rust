...
pub fn de_list_vaults_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_vaults::ListVaultsOutput, crate::operation::list_vaults::ListVaultsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_vaults::ListVaultsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_vaults_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_vaults::ListVaultsOutput, crate::operation::list_vaults::ListVaultsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_vaults::builders::ListVaultsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_vaults::de_list_vaults(response.body().as_ref(), output).map_err(crate::operation::list_vaults::ListVaultsError::unhandled)?;
