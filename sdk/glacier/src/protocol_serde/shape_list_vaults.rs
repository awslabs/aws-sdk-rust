...
pub fn de_list_vaults_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_vaults::ListVaultsOutput, crate::operation::list_vaults::ListVaultsError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::list_vaults::ListVaultsError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::list_vaults::builders::ListVaultsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "VaultList" => {
                    builder = builder.set_vault_list(crate::protocol_serde::shape_vault_list::de_vault_list(tokens, _value, depth + 1)?);
                }
