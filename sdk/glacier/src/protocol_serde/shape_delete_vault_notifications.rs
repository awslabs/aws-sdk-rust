...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_vault_notifications::DeleteVaultNotificationsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::delete_vault_notifications::DeleteVaultNotificationsError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
