...
pub fn de_list_parts_http_error(
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::list_parts::ListPartsError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::list_parts::builders::ListPartsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Parts" => {
                    builder = builder.set_parts(crate::protocol_serde::shape_part_list::de_part_list(tokens, _value, depth + 1)?);
                }
                "VaultARN" => {
