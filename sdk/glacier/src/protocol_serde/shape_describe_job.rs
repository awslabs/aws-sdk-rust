...
pub fn de_describe_job_http_error(
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::describe_job::DescribeJobError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Action" => {
                    builder = builder.set_action(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ActionCode::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "ArchiveId" => {
                ...
                "Completed" => {
                    builder = builder.set_completed(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "CompletionDate" => {
                ...
                "SelectParameters" => {
                    builder = builder.set_select_parameters(crate::protocol_serde::shape_select_parameters::de_select_parameters(tokens)?);
                }
                "StatusCode" => {
                    builder = builder.set_status_code(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StatusCode::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "StatusMessage" => {
