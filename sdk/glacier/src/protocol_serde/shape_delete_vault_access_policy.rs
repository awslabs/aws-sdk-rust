...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::delete_vault_access_policy::DeleteVaultAccessPolicyError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
