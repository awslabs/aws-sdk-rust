...
pub fn de_initiate_vault_lock_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InitiateVaultLockOutput, crate::error::InitiateVaultLockError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::InitiateVaultLockError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_initiate_vault_lock_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InitiateVaultLockOutput, crate::error::InitiateVaultLockError> {
    Ok({
        #[allow(unused_mut)]
