...
pub fn de_list_tags_for_vault_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_tags_for_vault::ListTagsForVaultOutput, crate::operation::list_tags_for_vault::ListTagsForVaultError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::list_tags_for_vault::ListTagsForVaultOutput, crate::operation::list_tags_for_vault::ListTagsForVaultError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_list_tags_for_vault::de_list_tags_for_vault(_response_body, output)
            .map_err(crate::operation::list_tags_for_vault::ListTagsForVaultError::unhandled)?;
...
) -> Result<crate::operation::list_tags_for_vault::builders::ListTagsForVaultOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
