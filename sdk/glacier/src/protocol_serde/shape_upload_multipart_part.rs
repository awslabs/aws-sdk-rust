...
> {
    ...
    Err(match error_code {
        ...
        "NoLongerSupportedException" => crate::operation::upload_multipart_part::UploadMultipartPartError::NoLongerSupportedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = output.set_checksum(
            match crate::protocol_serde::shape_upload_multipart_part_output::de_checksum_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::upload_multipart_part::UploadMultipartPartError::unhandled(
