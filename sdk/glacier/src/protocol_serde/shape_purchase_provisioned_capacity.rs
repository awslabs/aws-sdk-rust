...
#[allow(clippy::unnecessary_wraps)]
pub fn de_purchase_provisioned_capacity_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityOutput, crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityError> {
    Ok({
        #[allow(unused_mut)]
