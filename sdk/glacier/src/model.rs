...
pub struct VaultNotificationConfig  {
    ...
    #[doc(hidden)]pub sns_topic: std::option::Option<std::string::String>,
    /// <p>A list of one or more events for which Amazon S3 Glacier will send a notification to the specified Amazon SNS topic.</p>
    #[doc(hidden)]pub events: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct DataRetrievalPolicy  {
    ...
    #[doc(hidden)]pub rules: std::option::Option<std::vec::Vec<crate::model::DataRetrievalRule>>,
}
...
pub struct DataRetrievalRule  {
    ...
    #[doc(hidden)]pub strategy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub bytes_per_hour: std::option::Option<i64>,
}
...
pub struct DescribeVaultOutput  {
    ...
    #[doc(hidden)]pub vault_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub creation_date: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_inventory_date: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub number_of_archives: i64,
    ...
    #[doc(hidden)]pub size_in_bytes: i64,
}
...
pub struct ProvisionedCapacityDescription  {
    ...
    #[doc(hidden)]pub capacity_id: std::option::Option<std::string::String>,
    /// <p>The date that the provisioned capacity unit was purchased, in Universal Coordinated Time (UTC).</p>
    #[doc(hidden)]pub start_date: std::option::Option<std::string::String>,
    /// <p>The date that the provisioned capacity unit expires, in Universal Coordinated Time (UTC).</p>
    #[doc(hidden)]pub expiration_date: std::option::Option<std::string::String>,
}
...
pub struct PartListElement  {
    ...
    #[doc(hidden)]pub range_in_bytes: std::option::Option<std::string::String>,
    /// <p>The SHA256 tree hash value that Amazon S3 Glacier calculated for the part. This field is never <code>null</code>.</p>
    #[doc(hidden)]pub sha256_tree_hash: std::option::Option<std::string::String>,
}
...
pub struct UploadListElement  {
    ...
    #[doc(hidden)]pub multipart_upload_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub part_size_in_bytes: i64,
...
pub struct GlacierJobDescription  {
    ...
    #[doc(hidden)]pub job_description: std::option::Option<std::string::String>,
    /// <p>The job type. This value is either <code>ArchiveRetrieval</code>, <code>InventoryRetrieval</code>, or <code>Select</code>. </p>
    #[doc(hidden)]pub action: std::option::Option<crate::model::ActionCode>,
    ...
    #[doc(hidden)]pub status_code: std::option::Option<crate::model::StatusCode>,
    ...
    #[doc(hidden)]pub archive_size_in_bytes: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub inventory_size_in_bytes: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub completion_date: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub archive_sha256_tree_hash: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub retrieval_byte_range: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub tier: std::option::Option<std::string::String>,
    /// <p>Parameters used for range inventory retrieval.</p>
    #[doc(hidden)]pub inventory_retrieval_parameters: std::option::Option<crate::model::InventoryRetrievalJobDescription>,
    /// <p>Contains the job output location.</p>
    #[doc(hidden)]pub job_output_path: std::option::Option<std::string::String>,
    /// <p>Contains the parameters used for a select.</p>
    #[doc(hidden)]pub select_parameters: std::option::Option<crate::model::SelectParameters>,
    /// <p>Contains the location where the data from the select job is stored.</p>
    #[doc(hidden)]pub output_location: std::option::Option<crate::model::OutputLocation>,
}
...
impl  std::fmt::Debug for GlacierJobDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("inventory_retrieval_parameters", &self.inventory_retrieval_parameters);
...
pub struct OutputLocation  {
    ...
    #[doc(hidden)]pub s3: std::option::Option<crate::model::S3Location>,
}
impl OutputLocation {
    /// <p>Describes an S3 location that will receive the results of the job request.</p>
...
pub struct S3Location  {
    ...
    #[doc(hidden)]pub bucket_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::Encryption>,
    /// <p>The canned access control list (ACL) to apply to the job results.</p>
    #[doc(hidden)]pub canned_acl: std::option::Option<crate::model::CannedAcl>,
    /// <p>A list of grants that control access to the staged results.</p>
    #[doc(hidden)]pub access_control_list: std::option::Option<std::vec::Vec<crate::model::Grant>>,
    /// <p>The tag-set that is applied to the job results.</p>
    #[doc(hidden)]pub tagging: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub storage_class: std::option::Option<crate::model::StorageClass>,
}
impl S3Location {
    /// <p>The name of the Amazon S3 bucket where the job results are stored.</p>
...
pub struct Grant  {
    /// <p>The grantee.</p>
    #[doc(hidden)]pub grantee: std::option::Option<crate::model::Grantee>,
    /// <p>Specifies the permission given to the grantee. </p>
    #[doc(hidden)]pub permission: std::option::Option<crate::model::Permission>,
}
impl Grant {
    /// <p>The grantee.</p>
...
pub struct Grantee  {
    /// <p>Type of grantee</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::Type>,
...
pub struct Encryption  {
    ...
    #[doc(hidden)]pub kms_context: std::option::Option<std::string::String>,
}
impl Encryption {
    /// <p>The server-side encryption algorithm used when storing job results in Amazon S3, for example <code>AES256</code> or <code>aws:kms</code>.</p>
...
pub struct SelectParameters  {
    ...
    #[doc(hidden)]pub input_serialization: std::option::Option<crate::model::InputSerialization>,
    /// <p>The type of the provided expression, for example <code>SQL</code>.</p>
    #[doc(hidden)]pub expression_type: std::option::Option<crate::model::ExpressionType>,
    ...
    #[doc(hidden)]pub output_serialization: std::option::Option<crate::model::OutputSerialization>,
}
...
pub struct OutputSerialization  {
    ...
    #[doc(hidden)]pub csv: std::option::Option<crate::model::CsvOutput>,
}
...
pub struct CsvOutput  {
    ...
    #[doc(hidden)]pub quote_fields: std::option::Option<crate::model::QuoteFields>,
    /// <p>A single character used for escaping the quotation-mark character inside an already escaped value.</p>
    #[doc(hidden)]pub quote_escape_character: std::option::Option<std::string::String>,
    /// <p>A value used to separate individual records from each other.</p>
    #[doc(hidden)]pub record_delimiter: std::option::Option<std::string::String>,
    /// <p>A value used to separate individual fields from each other within a record.</p>
    #[doc(hidden)]pub field_delimiter: std::option::Option<std::string::String>,
    /// <p>A value used as an escape character where the field delimiter is part of the value.</p>
    #[doc(hidden)]pub quote_character: std::option::Option<std::string::String>,
}
impl CsvOutput {
    /// <p>A value that indicates whether all output fields should be contained within quotation marks.</p>
...
pub struct InputSerialization  {
    ...
    #[doc(hidden)]pub csv: std::option::Option<crate::model::CsvInput>,
}
...
pub struct CsvInput  {
    ...
    #[doc(hidden)]pub file_header_info: std::option::Option<crate::model::FileHeaderInfo>,
    ...
    #[doc(hidden)]pub comments: std::option::Option<std::string::String>,
    /// <p>A single character used for escaping the quotation-mark character inside an already escaped value.</p>
    #[doc(hidden)]pub quote_escape_character: std::option::Option<std::string::String>,
    /// <p>A value used to separate individual records from each other.</p>
    #[doc(hidden)]pub record_delimiter: std::option::Option<std::string::String>,
...
pub struct InventoryRetrievalJobDescription  {
    ...
    #[doc(hidden)]pub end_date: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub limit: std::option::Option<std::string::String>,
...
pub struct JobParameters  {
    ...
    #[doc(hidden)]pub inventory_retrieval_parameters: std::option::Option<crate::model::InventoryRetrievalJobInput>,
