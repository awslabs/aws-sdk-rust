...
pub fn ser_payload_initiate_job_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(aws_smithy_http::body::SdkBody::from(
        crate::operation_ser::serialize_member_com_amazonaws_glacier_synthetic_initiate_job_input_job_parameters(&payload).map_err(|err|aws_smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_initiate_vault_lock_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(aws_smithy_http::body::SdkBody::from(
        crate::operation_ser::serialize_member_com_amazonaws_glacier_synthetic_initiate_vault_lock_input_policy(&payload).map_err(|err|aws_smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_set_vault_access_policy_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(aws_smithy_http::body::SdkBody::from(
        crate::operation_ser::serialize_member_com_amazonaws_glacier_synthetic_set_vault_access_policy_input_policy(&payload).map_err(|err|aws_smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_set_vault_notifications_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(aws_smithy_http::body::SdkBody::from(
        crate::operation_ser::serialize_member_com_amazonaws_glacier_synthetic_set_vault_notifications_input_vault_notification_config(&payload).map_err(|err|aws_smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
