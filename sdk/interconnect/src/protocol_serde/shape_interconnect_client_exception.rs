...
pub(crate) fn de_interconnect_client_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InterconnectClientExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InterconnectClientExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
