...
pub(crate) fn de_connection_summary(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::ConnectionSummary, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        ...
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<crate::types::builders::ConnectionSummaryBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
        builder =
    ...
    {
        return Ok(crate::serde_util::connection_summary_correct_errors(builder)
            .build()
