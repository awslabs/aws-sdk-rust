...
pub(crate) fn de_interconnect_server_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InterconnectServerExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InterconnectServerExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
