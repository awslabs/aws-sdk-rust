...
pub(crate) fn de_access_denied_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::AccessDeniedExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::AccessDeniedExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
