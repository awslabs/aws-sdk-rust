...
pub(crate) fn de_interconnect_validation_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InterconnectValidationExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InterconnectValidationExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
