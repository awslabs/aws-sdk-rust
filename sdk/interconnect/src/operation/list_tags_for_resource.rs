...
impl ListTagsForResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Interconnect", "ListTagsForResource", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/Interconnect/operation/ListTagsForResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::InterconnectClientException`.
    pub fn is_interconnect_client_exception(&self) -> bool {
        matches!(self, Self::InterconnectClientException(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::InterconnectServerException`.
    pub fn is_interconnect_server_exception(&self) -> bool {
        matches!(self, Self::InterconnectServerException(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::InterconnectValidationException`.
