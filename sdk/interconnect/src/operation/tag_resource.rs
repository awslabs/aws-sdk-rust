...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Interconnect", "TagResource", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/Interconnect/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl TagResourceError {
    ...
    /// Returns `true` if the error kind is `TagResourceError::InterconnectClientException`.
    pub fn is_interconnect_client_exception(&self) -> bool {
        matches!(self, Self::InterconnectClientException(_))
    }
    /// Returns `true` if the error kind is `TagResourceError::InterconnectServerException`.
    pub fn is_interconnect_server_exception(&self) -> bool {
        matches!(self, Self::InterconnectServerException(_))
    }
    /// Returns `true` if the error kind is `TagResourceError::InterconnectValidationException`.
