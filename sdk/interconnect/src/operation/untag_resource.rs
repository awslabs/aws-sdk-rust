...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Interconnect", "UntagResource", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Interconnect.UntagResource",
                "rpc.service" = "Interconnect",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UntagResource")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UntagResourceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UntagResourceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UntagResourceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UntagResourceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagResourceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_untag_resource::de_untag_resource_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_untag_resource::de_untag_resource_http_response(status, headers, body, _cfg)
        };
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/Interconnect/operation/UntagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl UntagResourceError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InterconnectClientException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InterconnectServerException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InterconnectValidationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `UntagResourceError::InterconnectClientException`.
    pub fn is_interconnect_client_exception(&self) -> bool {
        matches!(self, Self::InterconnectClientException(_))
    }
    /// Returns `true` if the error kind is `UntagResourceError::InterconnectServerException`.
    pub fn is_interconnect_server_exception(&self) -> bool {
        matches!(self, Self::InterconnectServerException(_))
    }
    /// Returns `true` if the error kind is `UntagResourceError::InterconnectValidationException`.
    pub fn is_interconnect_validation_exception(&self) -> bool {
        matches!(self, Self::InterconnectValidationException(_))
    }
...
impl ::std::error::Error for UntagResourceError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InterconnectClientException(_inner) => ::std::option::Option::Some(_inner),
            Self::InterconnectServerException(_inner) => ::std::option::Option::Some(_inner),
            Self::InterconnectValidationException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for UntagResourceError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::InterconnectClientException(_inner) => _inner.fmt(f),
            Self::InterconnectServerException(_inner) => _inner.fmt(f),
            Self::InterconnectValidationException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UntagResourceError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InterconnectClientException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InterconnectServerException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InterconnectValidationException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
