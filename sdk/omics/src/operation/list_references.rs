...
impl ListReferencesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_references::ListReferences, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_references::ser_list_references_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReferences {
    type Output =
        ::std::result::Result<crate::operation::list_references::ListReferencesOutput, crate::operation::list_references::ListReferencesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_references::de_list_references_http_response_with_props(status, headers, body)
        }
    }
}
