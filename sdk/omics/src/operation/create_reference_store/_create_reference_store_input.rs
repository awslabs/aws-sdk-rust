...
impl CreateReferenceStoreInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_reference_store::CreateReferenceStoreInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_reference_store::CreateReferenceStoreInput {
                name: self.name
                ,
