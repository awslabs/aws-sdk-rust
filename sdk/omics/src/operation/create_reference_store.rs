...
impl CreateReferenceStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_reference_store::ser_create_reference_store_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_reference_store::CreateReferenceStore::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_reference_store::CreateReferenceStoreError
{
