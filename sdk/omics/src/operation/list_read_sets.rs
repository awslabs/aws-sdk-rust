...
impl ListReadSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListReadSets`](crate::operation::list_read_sets::ListReadSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_read_sets::ListReadSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_read_sets::ListReadSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_read_sets::ListReadSetsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_read_sets::ser_list_read_sets_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_read_sets::ListReadSets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListReadSets {
                type Output = std::result::Result<crate::operation::list_read_sets::ListReadSetsOutput, crate::operation::list_read_sets::ListReadSetsError>;
