...
impl ListReadSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_read_sets::ListReadSets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_read_sets::ser_list_read_sets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReadSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_read_sets::de_list_read_sets_http_response_with_props(status, headers, body)
        }
    }
}
