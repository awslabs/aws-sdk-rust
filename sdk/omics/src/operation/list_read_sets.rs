...
impl ListReadSetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_read_sets::ListReadSets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReadSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_read_sets::de_list_read_sets_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_read_sets::de_list_read_sets_http_response_with_props(
                status, headers, body,
            )
        }
    }
