...
impl DeleteRunGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_run_group::DeleteRunGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRunGroup {
    type Output =
        ::std::result::Result<crate::operation::delete_run_group::DeleteRunGroupOutput, crate::operation::delete_run_group::DeleteRunGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_run_group::de_delete_run_group_http_response_with_props(status, headers, body)
        }
    }
}
