...
impl GetReferenceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_reference::GetReference, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetReference {
    ...
    fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
        ...
        ::std::option::Option::Some(crate::protocol_serde::shape_get_reference::de_get_reference_op_response(response))
    }
    fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        // if streaming, we only hit this case if its an error
        crate::protocol_serde::shape_get_reference::de_get_reference_http_error(
