...
impl GetReferenceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_reference::GetReference,
    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_get_reference::ser_get_reference_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_reference::GetReference::new(),
        )
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetReference {
    ...
    fn parse_unloaded(
        ...
        ::std::option::Option::Some(
            crate::protocol_serde::shape_get_reference::de_get_reference_op_response(response),
        )
    }
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetReferenceError {
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            ...
            Self::RangeNotSatisfiableException(inner) => {
                ::std::option::Option::Some(inner.retryable_error_kind())
            }
