    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploadsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploadsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMultipartReadSetUploads {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListMultipartReadSetUploads", "omics"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMultipartReadSetUploads")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListMultipartReadSetUploadsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListMultipartReadSetUploadsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploadsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListMultipartReadSetUploadsEndpointParamsInterceptor {
...
pub type ListMultipartReadSetUploadsErrorKind = ListMultipartReadSetUploadsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListMultipartReadSetUploadsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploadsError {
...
impl ListMultipartReadSetUploadsError {
    ...
    /// Creates the `ListMultipartReadSetUploadsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
