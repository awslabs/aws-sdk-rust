...
impl ListMultipartReadSetUploadsInput {
    /// Consumes the builder and constructs an Operation<[`ListMultipartReadSetUploads`](crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploads)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_multipart_read_set_uploads::ListMultipartReadSetUploads::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("ListMultipartReadSetUploads", "omics"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMultipartReadSetUploads {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_multipart_read_set_uploads::de_list_multipart_read_set_uploads_http_response_with_props(
                status, headers, body,
            )
        }
    }
