...
impl ListRunGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_run_groups::ListRunGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRunGroups {
    type Output =
        ::std::result::Result<crate::operation::list_run_groups::ListRunGroupsOutput, crate::operation::list_run_groups::ListRunGroupsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_run_groups::de_list_run_groups_http_response_with_props(status, headers, body)
        }
    }
}
