...
impl UpdateWorkflowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_workflow::UpdateWorkflow, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_workflow::ser_update_workflow_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkflow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_workflow::de_update_workflow_http_response_with_props(status, headers, body)
        }
    }
}
