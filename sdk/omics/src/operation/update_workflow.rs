    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/workflow/{id}", id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workflow::UpdateWorkflow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkflow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_update_workflow::de_update_workflow_http_error(
                status, headers, body,
            )
        } else {
