...
impl CreateVariantStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_variant_store::ser_create_variant_store_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_variant_store::CreateVariantStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVariantStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_variant_store::de_create_variant_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_variant_store::CreateVariantStoreError
{
