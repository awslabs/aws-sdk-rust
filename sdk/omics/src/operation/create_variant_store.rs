...
impl CreateVariantStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_variant_store::ser_create_variant_store_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVariantStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_variant_store::de_create_variant_store_http_response_with_props(status, headers, body)
        }
    }
}
