...
impl GetRunGroupInput {
    /// Consumes the builder and constructs an Operation<[`GetRunGroup`](crate::operation::get_run_group::GetRunGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_run_group::GetRunGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_run_group::GetRunGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_run_group::GetRunGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRunGroup {
                type Output = std::result::Result<crate::operation::get_run_group::GetRunGroupOutput, crate::operation::get_run_group::GetRunGroupError>;
