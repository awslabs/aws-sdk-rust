...
impl CompleteMultipartReadSetUploadInput {
    /// Consumes the builder and constructs an Operation<[`CompleteMultipartReadSetUpload`](crate::operation::complete_multipart_read_set_upload::CompleteMultipartReadSetUpload)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_complete_multipart_read_set_upload::ser_complete_multipart_read_set_upload_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::complete_multipart_read_set_upload::CompleteMultipartReadSetUpload::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("CompleteMultipartReadSetUpload", "omics"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CompleteMultipartReadSetUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_complete_multipart_read_set_upload::de_complete_multipart_read_set_upload_http_response_with_props(
                status, headers, body,
            )
        }
    }
