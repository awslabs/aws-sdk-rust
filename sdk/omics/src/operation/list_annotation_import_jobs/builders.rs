...
pub use crate::operation::list_annotation_import_jobs::_list_annotation_import_jobs_output::ListAnnotationImportJobsOutputBuilder;

pub use crate::operation::list_annotation_import_jobs::_list_annotation_import_jobs_input::ListAnnotationImportJobsInputBuilder;
...
impl ListAnnotationImportJobsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_annotation_import_jobs();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsOutput,
                    crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsError,
                > for ListAnnotationImportJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListAnnotationImportJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_annotation_import_jobs::ListAnnotationImportJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsOutput, crate::operation::list_annotation_import_jobs::ListAnnotationImportJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_annotation_import_jobs::paginator::ListAnnotationImportJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
