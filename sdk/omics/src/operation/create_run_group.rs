...
impl CreateRunGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_run_group::CreateRunGroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_run_group::CreateRunGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRunGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_run_group::de_create_run_group_http_error(
                status, headers, body,
            )
        } else {
