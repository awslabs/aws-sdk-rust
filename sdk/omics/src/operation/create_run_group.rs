...
impl CreateRunGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_run_group::CreateRunGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_run_group::ser_create_run_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRunGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_run_group::de_create_run_group_http_response_with_props(status, headers, body)
        }
    }
}
