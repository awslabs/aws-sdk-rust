...
impl  ListReadSetsOutput  {
    ...
    pub fn read_sets(&self) -> & [crate::types::ReadSetListItem] {
        use std::ops::Deref; self.read_sets.deref()
    }
}
...
impl ListReadSetsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_read_sets::ListReadSetsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_read_sets::ListReadSetsOutput {
                ...
                read_sets: self.read_sets
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("read_sets", "read_sets was not specified but it is required when building ListReadSetsOutput")
                    )?
                ,
