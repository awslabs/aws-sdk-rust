...
impl GetSequenceStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_sequence_store::GetSequenceStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSequenceStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sequence_store::de_get_sequence_store_http_response_with_props(status, headers, body)
        }
    }
}
