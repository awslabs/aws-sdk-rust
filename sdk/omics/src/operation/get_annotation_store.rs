...
impl GetAnnotationStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_annotation_store::GetAnnotationStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAnnotationStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_annotation_store::de_get_annotation_store_http_response_with_props(status, headers, body)
        }
    }
}
