...
impl crate::operation::delete_reference::builders::DeleteReferenceInputBuilder {
...
///
/// <p>Deletes a reference genome and returns a response with no body if the operation is successful. The read set associated with the reference genome must first be deleted before deleting the reference genome. After the reference genome is deleted, you can delete the reference store using the <code>DeleteReferenceStore</code> API operation.</p>
/// <p>For more information, see <a href="https://docs.aws.amazon.com/omics/latest/dev/deleting-reference-and-sequence-stores.html">Deleting HealthOmics reference and sequence stores</a> in the <i>Amazon Web Services HealthOmics User Guide</i>.</p>
...
impl DeleteReferenceFluentBuilder {
    /// Creates a new `DeleteReferenceFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_reference::DeleteReference::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_reference::DeleteReference::orchestrate(&runtime_plugins, input).await
    }
