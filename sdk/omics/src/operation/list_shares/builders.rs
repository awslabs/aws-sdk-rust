...
pub use crate::operation::list_shares::_list_shares_output::ListSharesOutputBuilder;

pub use crate::operation::list_shares::_list_shares_input::ListSharesInputBuilder;
    ...
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        ::aws_smithy_runtime_api::client::result::SdkError<
                            crate::operation::list_shares::ListSharesError,
                            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse
                        >
                    > {
                        let mut fluent_builder = client.list_shares();
...
pub struct ListSharesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_shares::builders::ListSharesInputBuilder,
...
impl ListSharesFluentBuilder {
    /// Creates a new `ListShares`.
    ...
    pub fn as_input(&self) -> &crate::operation::list_shares::builders::ListSharesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_shares::ListSharesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_shares::ListSharesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_shares::ListShares::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_shares::ListShares::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_shares::ListSharesOutput, crate::operation::list_shares::ListSharesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_shares::paginator::ListSharesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
