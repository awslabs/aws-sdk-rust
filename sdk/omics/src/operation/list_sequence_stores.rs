...
impl ListSequenceStoresInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_sequence_stores::ListSequenceStores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSequenceStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_sequence_stores::de_list_sequence_stores_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_sequence_stores::ListSequenceStoresError
{
