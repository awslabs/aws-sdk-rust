...
impl ListSequenceStoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_sequence_stores::ListSequenceStores,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_sequence_stores::ser_list_sequence_stores_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSequenceStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sequence_stores::de_list_sequence_stores_http_response_with_props(status, headers, body)
        }
    }
}
