...
impl StartRunInput {
    /// Consumes the builder and constructs an Operation<[`StartRun`](crate::operation::start_run::StartRun)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_run::StartRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_run::ser_start_run_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_run::StartRun::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRun {
    type Output = ::std::result::Result<crate::operation::start_run::StartRunOutput, crate::operation::start_run::StartRunError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_start_run::de_start_run_http_response_with_props(status, headers, body)
        }
    }
}
