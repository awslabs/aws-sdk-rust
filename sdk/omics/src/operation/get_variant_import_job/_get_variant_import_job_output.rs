...
impl GetVariantImportJobOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_variant_import_job::GetVariantImportJobOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_variant_import_job::GetVariantImportJobOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                destination_name: self.destination_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("destination_name", "destination_name was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                status_message: self.status_message
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status_message", "status_message was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                update_time: self.update_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("update_time", "update_time was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
                ...
                items: self.items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("items", "items was not specified but it is required when building GetVariantImportJobOutput")
                    )?
                ,
