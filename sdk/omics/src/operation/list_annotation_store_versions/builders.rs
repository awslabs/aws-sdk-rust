...
impl ListAnnotationStoreVersionsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_annotation_store_versions::paginator::ListAnnotationStoreVersionsPaginator::send) which returns a `Stream`.
