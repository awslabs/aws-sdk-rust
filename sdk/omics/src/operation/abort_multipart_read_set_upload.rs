...
impl AbortMultipartReadSetUploadInput {
    ...
    > {
        ...
        .with_metadata(::aws_smithy_http::operation::Metadata::new("AbortMultipartReadSetUpload", "omics"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AbortMultipartReadSetUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_abort_multipart_read_set_upload::de_abort_multipart_read_set_upload_http_response_with_props(
                status, headers, body,
            )
        }
    }
