...
impl GetReferenceImportJobFluentBuilder  {
    /// Creates a new `GetReferenceImportJob`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_reference_import_job::GetReferenceImportJob, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_reference_import_job::GetReferenceImportJobError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_reference_import_job::GetReferenceImportJobOutput, aws_smithy_http::result::SdkError<crate::operation::get_reference_import_job::GetReferenceImportJobError>>
                     {
