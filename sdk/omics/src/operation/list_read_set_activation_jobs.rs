...
impl ListReadSetActivationJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_read_set_activation_jobs::ListReadSetActivationJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReadSetActivationJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_read_set_activation_jobs::de_list_read_set_activation_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_read_set_activation_jobs::ListReadSetActivationJobsError
{
