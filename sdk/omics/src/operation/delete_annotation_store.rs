...
impl DeleteAnnotationStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_annotation_store::DeleteAnnotationStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAnnotationStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_annotation_store::de_delete_annotation_store_http_response_with_props(status, headers, body)
        }
    }
}
