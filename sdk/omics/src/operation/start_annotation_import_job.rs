...
impl StartAnnotationImportJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_annotation_import_job::StartAnnotationImportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAnnotationImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_annotation_import_job::de_start_annotation_import_job_http_response_with_props(status, headers, body)
        }
    }
}
