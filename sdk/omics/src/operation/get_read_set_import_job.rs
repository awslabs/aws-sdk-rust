...
impl GetReadSetImportJobInput {
    /// Consumes the builder and constructs an Operation<[`GetReadSetImportJob`](crate::operation::get_read_set_import_job::GetReadSetImportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_read_set_import_job::GetReadSetImportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_read_set_import_job::GetReadSetImportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_read_set_import_job::GetReadSetImportJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetReadSetImportJob {
                type Output = std::result::Result<crate::operation::get_read_set_import_job::GetReadSetImportJobOutput, crate::operation::get_read_set_import_job::GetReadSetImportJobError>;
