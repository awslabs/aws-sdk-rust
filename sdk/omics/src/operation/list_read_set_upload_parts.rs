...
#[non_exhaustive]
pub struct ListReadSetUploadParts;
impl ListReadSetUploadParts {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListReadSetUploadParts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListReadSetUploadParts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListReadSetUploadPartsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListReadSetUploadPartsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListReadSetUploadParts")
...
.with_interceptor(ListReadSetUploadPartsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError>::new());
...
#[derive(Debug)]
            struct ListReadSetUploadPartsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListReadSetUploadPartsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_read_set_upload_parts::de_list_read_set_upload_parts_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListReadSetUploadPartsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListReadSetUploadPartsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_read_set_upload_parts::ser_list_read_set_upload_parts_input(&input)?);
...
#[derive(Debug)]
            struct ListReadSetUploadPartsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListReadSetUploadPartsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListReadSetUploadPartsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListReadSetUploadPartsInput>()
                        .ok_or("failed to downcast to ListReadSetUploadPartsInput")?;
...
pub enum ListReadSetUploadPartsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListReadSetUploadPartsError) for what information is available for the error.")]
...
impl ListReadSetUploadPartsError {
    /// Creates the `ListReadSetUploadPartsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListReadSetUploadPartsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::NotSupportedOperationException`.
    pub fn is_not_supported_operation_exception(&self) -> bool {
        matches!(self, Self::NotSupportedOperationException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::RequestTimeoutException`.
    pub fn is_request_timeout_exception(&self) -> bool {
        matches!(self, Self::RequestTimeoutException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ListReadSetUploadPartsError::ValidationException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListReadSetUploadPartsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_read_set_upload_parts::ListReadSetUploadPartsError {
...
mod _list_read_set_upload_parts_output;
