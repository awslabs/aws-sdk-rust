...
impl ListReferenceStoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_reference_stores::ListReferenceStores,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReferenceStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_reference_stores::de_list_reference_stores_http_response_with_props(status, headers, body)
        }
    }
}
