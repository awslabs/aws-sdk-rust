...
impl CancelVariantImportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_variant_import_job::CancelVariantImportJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelVariantImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_variant_import_job::de_cancel_variant_import_job_http_response_with_props(status, headers, body)
        }
    }
}
