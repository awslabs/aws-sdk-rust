...
impl UploadReadSetPartInput {
    /// Consumes the builder and constructs an Operation<[`UploadReadSetPart`](crate::operation::upload_read_set_part::UploadReadSetPart)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_read_set_part_input::ser_payload_http_payload(self.payload)?.into_inner(),
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upload_read_set_part::UploadReadSetPart::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UploadReadSetPart", "omics"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadReadSetPart {
