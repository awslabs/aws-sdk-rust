...
impl UploadReadSetPartInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_read_set_part_input::ser_payload_http_payload(
                self.payload,
            )?
            .into_inner(),
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::upload_read_set_part::UploadReadSetPart::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadReadSetPart {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_upload_read_set_part::de_upload_read_set_part_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::upload_read_set_part::UploadReadSetPartError
{
