...
impl UploadReadSetPart {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upload_read_set_part::UploadReadSetPartError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upload_read_set_part::UploadReadSetPartOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("omics", "UploadReadSetPart", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UploadReadSetPart {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UploadReadSetPart")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(UploadReadSetPartEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UploadReadSetPartResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UploadReadSetPartRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upload_read_set_part::UploadReadSetPartInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UploadReadSetPartEndpointParamsInterceptor {
...
pub type UploadReadSetPartErrorKind = UploadReadSetPartError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UploadReadSetPartError {
...
impl ::aws_http::request_id::RequestId for crate::operation::upload_read_set_part::UploadReadSetPartError {
...
impl UploadReadSetPartError {
    ...
    /// Creates the `UploadReadSetPartError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
