...
impl DeleteReferenceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_reference::DeleteReference, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReference {
    type Output =
        ::std::result::Result<crate::operation::delete_reference::DeleteReferenceOutput, crate::operation::delete_reference::DeleteReferenceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_reference::de_delete_reference_http_response_with_props(status, headers, body)
        }
    }
}
