...
impl GetReferenceMetadataFluentBuilder  {
    /// Creates a new `GetReferenceMetadata`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_reference_metadata::GetReferenceMetadataOutput, aws_smithy_http::result::SdkError<crate::operation::get_reference_metadata::GetReferenceMetadataError>>
                     {
