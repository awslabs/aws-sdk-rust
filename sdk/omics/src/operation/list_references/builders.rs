...
impl crate::operation::list_references::builders::ListReferencesInputBuilder {
...
///
/// <p>Retrieves the metadata of one or more reference genomes in a reference store.</p>
...
impl ListReferencesFluentBuilder {
    /// Creates a new `ListReferencesFluentBuilder`.
