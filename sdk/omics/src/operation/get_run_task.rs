    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/run/{id}/task/{taskId}", id = id, taskId = task_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_run_task::GetRunTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRunTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_run_task::de_get_run_task_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_run_task::de_get_run_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
