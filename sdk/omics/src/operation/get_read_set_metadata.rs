...
impl GetReadSetMetadataInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_read_set_metadata::GetReadSetMetadata::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetReadSetMetadata {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_read_set_metadata::de_get_read_set_metadata_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_read_set_metadata::GetReadSetMetadataError
{
