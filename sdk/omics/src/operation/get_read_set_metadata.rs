...
impl GetReadSetMetadata {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_read_set_metadata::GetReadSetMetadataInput,
                    ) -> ::std::result::Result<crate::operation::get_read_set_metadata::GetReadSetMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_read_set_metadata::GetReadSetMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_read_set_metadata::GetReadSetMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_read_set_metadata::GetReadSetMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetReadSetMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetReadSetMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetReadSetMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetReadSetMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetReadSetMetadata")
...
.with_interceptor(GetReadSetMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_read_set_metadata::GetReadSetMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_read_set_metadata::GetReadSetMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_read_set_metadata::GetReadSetMetadataError>::new());
...
#[derive(Debug)]
            struct GetReadSetMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetReadSetMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_read_set_metadata::de_get_read_set_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_read_set_metadata::de_get_read_set_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetReadSetMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReadSetMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_read_set_metadata::GetReadSetMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_read_set_metadata::GetReadSetMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/sequencestore/{sequenceStoreId}/readset/{id}/metadata", sequenceStoreId = sequence_store_id, id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetReadSetMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetReadSetMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetReadSetMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetReadSetMetadataInput>()
                        .ok_or("failed to downcast to GetReadSetMetadataInput")?;
...
pub enum GetReadSetMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetReadSetMetadataError) for what information is available for the error.")]
...
impl GetReadSetMetadataError {
    /// Creates the `GetReadSetMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetReadSetMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetReadSetMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_read_set_metadata::GetReadSetMetadataError {
...
mod _get_read_set_metadata_output;
