...
impl ListAnnotationImportJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_annotation_import_jobs::ListAnnotationImportJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAnnotationImportJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_annotation_import_jobs::de_list_annotation_import_jobs_http_response_with_props(status, headers, body)
        }
    }
}
