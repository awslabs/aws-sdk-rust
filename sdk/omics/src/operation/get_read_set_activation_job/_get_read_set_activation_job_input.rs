...
impl GetReadSetActivationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_read_set_activation_job::GetReadSetActivationJobInput, ::aws_smithy_types::error::operation::BuildError> {
