...
impl GetReferenceStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_reference_store::GetReferenceStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReferenceStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reference_store::de_get_reference_store_http_response_with_props(status, headers, body)
        }
    }
}
