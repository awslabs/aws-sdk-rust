...
impl CancelAnnotationImportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_annotation_import_job::CancelAnnotationImportJobInput, ::aws_smithy_types::error::operation::BuildError> {
