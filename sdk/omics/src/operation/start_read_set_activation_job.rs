...
impl StartReadSetActivationJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_read_set_activation_job::StartReadSetActivationJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReadSetActivationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_read_set_activation_job::de_start_read_set_activation_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_read_set_activation_job::StartReadSetActivationJobError
{
