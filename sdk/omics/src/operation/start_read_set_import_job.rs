...
impl StartReadSetImportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_read_set_import_job::StartReadSetImportJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReadSetImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_read_set_import_job::de_start_read_set_import_job_http_response_with_props(status, headers, body)
        }
    }
}
