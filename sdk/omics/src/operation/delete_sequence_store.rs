...
/// Orchestration and serialization glue logic for `DeleteSequenceStore`.
...
impl DeleteSequenceStore {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_sequence_store::DeleteSequenceStoreInput,
                    ) -> ::std::result::Result<crate::operation::delete_sequence_store::DeleteSequenceStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_sequence_store::DeleteSequenceStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_sequence_store::DeleteSequenceStoreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_sequence_store::DeleteSequenceStoreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSequenceStore {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSequenceStore");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSequenceStoreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSequenceStoreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSequenceStore")
...
.with_interceptor(DeleteSequenceStoreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_sequence_store::DeleteSequenceStoreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_sequence_store::DeleteSequenceStoreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_sequence_store::DeleteSequenceStoreError>::new());
...
#[derive(Debug)]
            struct DeleteSequenceStoreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSequenceStoreResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_sequence_store::de_delete_sequence_store_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_sequence_store::de_delete_sequence_store_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteSequenceStoreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSequenceStoreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_sequence_store::DeleteSequenceStoreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_sequence_store::DeleteSequenceStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/sequencestore/{id}", id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteSequenceStoreEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSequenceStoreEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSequenceStoreEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSequenceStoreInput>()
                        .ok_or("failed to downcast to DeleteSequenceStoreInput")?;
...
pub enum DeleteSequenceStoreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSequenceStoreError) for what information is available for the error.")]
...
impl DeleteSequenceStoreError {
    /// Creates the `DeleteSequenceStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSequenceStoreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSequenceStoreError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_sequence_store::DeleteSequenceStoreError {
...
mod _delete_sequence_store_output;
