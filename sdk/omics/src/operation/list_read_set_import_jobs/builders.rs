...
impl ListReadSetImportJobsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_read_set_import_jobs::paginator::ListReadSetImportJobsPaginator
    {
        crate::operation::list_read_set_import_jobs::paginator::ListReadSetImportJobsPaginator::new(
            self.handle,
            self.inner,
        )
    }
