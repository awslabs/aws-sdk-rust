...
impl  VariantImportJobItem  {
    ...
    pub fn destination_name(&self) -> & str {
        use std::ops::Deref; self.destination_name.deref()
    }
    /// <p>The job's service role ARN.</p>
...
impl VariantImportJobItemBuilder {
    ...
    ///
    /// <p>The annotation schema generated by the parsed annotation data.</p>
    pub fn annotation_fields(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    /// <p>The annotation schema generated by the parsed annotation data.</p>
    pub fn set_annotation_fields(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>>) -> Self {
        self.annotation_fields = input; self
    }
    /// <p>The annotation schema generated by the parsed annotation data.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::VariantImportJobItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::VariantImportJobItem {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
                destination_name: self.destination_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("destination_name", "destination_name was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
                update_time: self.update_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("update_time", "update_time was not specified but it is required when building VariantImportJobItem")
                    )?
                ,
