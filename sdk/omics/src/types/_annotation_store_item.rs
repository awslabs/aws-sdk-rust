    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AnnotationStoreItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AnnotationStoreItem {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                store_arn: self.store_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("store_arn", "store_arn was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                store_format: self.store_format
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("store_format", "store_format was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                description: self.description
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                ...
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                update_time: self.update_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("update_time", "update_time was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                status_message: self.status_message
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status_message", "status_message was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
                store_size_bytes: self.store_size_bytes
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("store_size_bytes", "store_size_bytes was not specified but it is required when building AnnotationStoreItem")
                    )?
                ,
            }
        )
