...
pub fn de_get_reference_store_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReferenceStoreOutput, crate::error::GetReferenceStoreError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetReferenceStoreError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::error::GetReferenceStoreError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "RequestTimeoutException" => crate::error::GetReferenceStoreError::RequestTimeoutException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetReferenceStoreError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reference_store_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReferenceStoreOutput, crate::error::GetReferenceStoreError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_reference_store_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_reference_store::de_get_reference_store(response.body().as_ref(), output).map_err(crate::error::GetReferenceStoreError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_reference_store(value: &[u8], mut builder: crate::output::get_reference_store_output::Builder) -> Result<crate::output::get_reference_store_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
