...
pub fn de_get_run_task_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_run_task::GetRunTaskOutput, crate::operation::get_run_task::GetRunTaskError> {
    #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::get_run_task::builders::GetRunTaskOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
