...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_reference_import_job::GetReferenceImportJobError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_reference_import_job::de_get_reference_import_job(_response_body, output)
            .map_err(crate::operation::get_reference_import_job::GetReferenceImportJobError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_reference_import_job_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_reference_import_job::GetReferenceImportJobError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "sources" => {
                    builder =
                        builder.set_sources(crate::protocol_serde::shape_import_reference_source_list::de_import_reference_source_list(tokens)?);
                }
                "status" => {
