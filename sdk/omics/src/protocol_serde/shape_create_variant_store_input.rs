...
pub fn ser_create_variant_store_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateVariantStoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
