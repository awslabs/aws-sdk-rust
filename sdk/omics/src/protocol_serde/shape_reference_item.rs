...
) -> ::std::result::Result<Option<crate::types::ReferenceItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    variant = match key.as_ref() {
                        "referenceArn" => Some(crate::types::ReferenceItem::ReferenceArn(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                ...
                                .transpose()?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'referenceArn' cannot be null")
                                })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
...
pub fn ser_reference_item(
    ...
    match input {
        ...
        crate::types::ReferenceItem::Unknown => {
            return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ReferenceItem"))
        }
    }
    Ok(())
}
