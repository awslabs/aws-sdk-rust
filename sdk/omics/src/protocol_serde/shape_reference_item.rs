...
pub(crate) fn de_reference_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReferenceItem>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_reference_item(object_4: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
