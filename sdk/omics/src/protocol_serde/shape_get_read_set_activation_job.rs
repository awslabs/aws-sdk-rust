...
pub fn de_get_read_set_activation_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_read_set_activation_job::GetReadSetActivationJobOutput, crate::operation::get_read_set_activation_job::GetReadSetActivationJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_read_set_activation_job::GetReadSetActivationJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_read_set_activation_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_read_set_activation_job::GetReadSetActivationJobOutput, crate::operation::get_read_set_activation_job::GetReadSetActivationJobError> {
    Ok({
        #[allow(unused_mut)]
