...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_read_set_activation_job::GetReadSetActivationJobError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_read_set_activation_job::GetReadSetActivationJobError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_read_set_activation_job::de_get_read_set_activation_job(_response_body, output)
            .map_err(crate::operation::get_read_set_activation_job::GetReadSetActivationJobError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_read_set_activation_job_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_read_set_activation_job::GetReadSetActivationJobError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "sources" => {
                    builder =
                        builder.set_sources(crate::protocol_serde::shape_activate_read_set_source_list::de_activate_read_set_source_list(tokens)?);
                }
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ReadSetActivationJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "statusMessage" => {
