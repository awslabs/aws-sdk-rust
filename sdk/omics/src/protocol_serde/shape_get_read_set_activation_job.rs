...
pub fn de_get_read_set_activation_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReadSetActivationJobOutput, crate::error::GetReadSetActivationJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetReadSetActivationJobError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::error::GetReadSetActivationJobError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::error::GetReadSetActivationJobError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "RequestTimeoutException" => crate::error::GetReadSetActivationJobError::RequestTimeoutException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetReadSetActivationJobError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_read_set_activation_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetReadSetActivationJobOutput, crate::error::GetReadSetActivationJobError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_read_set_activation_job(value: &[u8], mut builder: crate::output::get_read_set_activation_job_output::Builder) -> Result<crate::output::get_read_set_activation_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
