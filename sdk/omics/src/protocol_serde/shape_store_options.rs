...
pub(crate) fn de_store_options<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::StoreOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "tsvStoreOptions" => Some(crate::types::StoreOptions::TsvStoreOptions(
                            crate::protocol_serde::shape_tsv_store_options::de_tsv_store_options(tokens, _value, depth + 1)?.ok_or_else(|| {
