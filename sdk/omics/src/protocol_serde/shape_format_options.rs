...
) -> Result<Option<crate::types::FormatOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "tsvOptions" => Some(crate::types::FormatOptions::TsvOptions(
                            crate::protocol_serde::shape_tsv_options::de_tsv_options(tokens)?.ok_or_else(|| {
                                ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'tsvOptions' cannot be null")
                            })?,
                        )),
                        "vcfOptions" => Some(crate::types::FormatOptions::VcfOptions(
                            crate::protocol_serde::shape_vcf_options::de_vcf_options(tokens)?.ok_or_else(|| {
                                ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'vcfOptions' cannot be null")
                            })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
...
pub fn ser_format_options(
    ...
    match input {
        ...
        crate::types::FormatOptions::Unknown => {
            return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("FormatOptions"))
        }
    }
    Ok(())
}
