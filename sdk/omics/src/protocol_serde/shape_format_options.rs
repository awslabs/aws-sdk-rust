...
pub(crate) fn de_format_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FormatOptions>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_format_options(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormatOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
