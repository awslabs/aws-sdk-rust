...
pub fn ser_start_read_set_import_job_source_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StartReadSetImportJobSourceItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
