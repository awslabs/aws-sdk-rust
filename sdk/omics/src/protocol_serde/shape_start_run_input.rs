...
pub fn ser_start_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRunInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
