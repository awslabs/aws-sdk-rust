...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_reference_import_job::StartReferenceImportJobError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::start_reference_import_job::StartReferenceImportJobError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::start_reference_import_job_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_reference_import_job::StartReferenceImportJobError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ReferenceImportJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
