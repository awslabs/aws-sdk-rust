...
pub fn de_get_configuration_http_error(
    ...
    Err(match error_code {
        ...
        "RequestTimeoutException" => crate::operation::get_configuration::GetConfigurationError::RequestTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::get_configuration::GetConfigurationError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
