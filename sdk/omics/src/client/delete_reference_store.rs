...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_reference_store::builders::DeleteReferenceStoreFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_reference_store::builders::DeleteReferenceStoreFluentBuilder::set_id):<br>required: **true**<br><p>The store's ID.</p><br>
