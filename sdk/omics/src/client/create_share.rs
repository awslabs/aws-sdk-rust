...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::set_resource_arn): <p> The resource ARN for the analytics store to be shared. </p>
    ///   - [`principal_subscriber(impl Into<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::principal_subscriber) / [`set_principal_subscriber(Option<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::set_principal_subscriber): <p> The principal subscriber is the account being given access to the analytics store data through the share offer. </p>
    ///   - [`share_name(impl Into<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::share_name) / [`set_share_name(Option<String>)`](crate::operation::create_share::builders::CreateShareFluentBuilder::set_share_name): <p> A name given to the share. </p>
