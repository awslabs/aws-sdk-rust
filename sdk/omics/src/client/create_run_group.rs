...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_name): <p>A name for the group.</p>
    ...
    ///   - [`max_duration(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_duration) / [`set_max_duration(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_duration): <p>A maximum run time for the group in minutes.</p>
    ...
    ///   - [`request_id(impl ::std::convert::Into<String>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::request_id) / [`set_request_id(Option<String>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_request_id): <p>To ensure that requests don't run multiple times, specify a unique ID for each request.</p>
    ///   - [`max_gpus(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_gpus) / [`set_max_gpus(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_gpus): <p> The maximum GPUs that can be used by a run group. </p>
