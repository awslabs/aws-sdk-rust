...
impl super::Client {
    ...
    ///   - [`max_cpus(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_cpus) / [`set_max_cpus(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_cpus):<br>required: **false**<br><p>The maximum number of CPUs that can run concurrently across all active runs in the run group.</p><br>
    ///   - [`max_runs(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_runs) / [`set_max_runs(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_runs):<br>required: **false**<br><p>The maximum number of runs that can be running at the same time.</p><br>
    ///   - [`max_duration(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_duration) / [`set_max_duration(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_duration):<br>required: **false**<br><p>The maximum time for each run (in minutes). If a run exceeds the maximum run time, the run fails automatically.</p><br>
    ...
    ///   - [`max_gpus(i32)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::max_gpus) / [`set_max_gpus(Option<i32>)`](crate::operation::create_run_group::builders::CreateRunGroupFluentBuilder::set_max_gpus):<br>required: **false**<br><p>The maximum number of GPUs that can run concurrently across all active runs in the run group.</p><br>
