...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_run::builders::DeleteRunFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_run::builders::DeleteRunFluentBuilder::set_id):<br>required: **true**<br><p>The run's ID.</p><br>
