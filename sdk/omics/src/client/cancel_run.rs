...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::cancel_run::builders::CancelRunFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::cancel_run::builders::CancelRunFluentBuilder::set_id):<br>required: **true**<br><p>The run's ID.</p><br>
