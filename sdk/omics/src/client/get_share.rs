...
impl super::Client {
    ...
    ///   - [`share_id(impl Into<String>)`](crate::operation::get_share::builders::GetShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::get_share::builders::GetShareFluentBuilder::set_share_id): <p> The generated ID for a share. </p>
