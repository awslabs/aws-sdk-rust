...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::set_tags): <p>Tags for the store.</p>
    ///   - [`version_name(impl Into<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::version_name) / [`set_version_name(Option<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::set_version_name): <p> The name given to an annotation store version to distinguish it from other versions. </p>
    ...
    ///   - [`version_name(Option<String>)`](crate::operation::create_annotation_store::CreateAnnotationStoreOutput::version_name): <p> The name given to an annotation store version to distinguish it from other versions. </p>
