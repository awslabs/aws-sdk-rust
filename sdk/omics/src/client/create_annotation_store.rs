...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::set_name): <p>A name for the store.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_annotation_store::builders::CreateAnnotationStoreFluentBuilder::set_description): <p>A description for the store.</p>
