...
impl super::Client {
    ...
    ///   - [`sequence_store_id(impl Into<String>)`](crate::operation::complete_multipart_read_set_upload::builders::CompleteMultipartReadSetUploadFluentBuilder::sequence_store_id) / [`set_sequence_store_id(Option<String>)`](crate::operation::complete_multipart_read_set_upload::builders::CompleteMultipartReadSetUploadFluentBuilder::set_sequence_store_id): <p> The sequence store ID for the store involved in the multipart upload. </p>
