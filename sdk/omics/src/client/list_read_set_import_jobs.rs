...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of jobs to return in one page of results.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::set_next_token):<br>required: **false**<br><p>Specify the pagination token from a previous request to retrieve the next page of results.</p><br>
    ///   - [`sequence_store_id(impl Into<String>)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::sequence_store_id) / [`set_sequence_store_id(Option<String>)`](crate::operation::list_read_set_import_jobs::builders::ListReadSetImportJobsFluentBuilder::set_sequence_store_id):<br>required: **true**<br><p>The jobs' sequence store ID.</p><br>
