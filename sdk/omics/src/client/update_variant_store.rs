...
impl super::Client {
    ...
    pub fn update_variant_store(
        &self,
    ) -> crate::operation::update_variant_store::builders::UpdateVariantStoreFluentBuilder {
        crate::operation::update_variant_store::builders::UpdateVariantStoreFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
