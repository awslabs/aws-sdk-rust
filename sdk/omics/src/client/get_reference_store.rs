...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_reference_store::builders::GetReferenceStoreFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_reference_store::builders::GetReferenceStoreFluentBuilder::set_id):<br>required: **true**<br><p>The store's ID.</p><br>
    ...
    ///   - [`id(String)`](crate::operation::get_reference_store::GetReferenceStoreOutput::id): <p>The store's ID.</p>
    ///   - [`arn(String)`](crate::operation::get_reference_store::GetReferenceStoreOutput::arn): <p>The store's ARN.</p>
    ...
    ///   - [`creation_time(DateTime)`](crate::operation::get_reference_store::GetReferenceStoreOutput::creation_time): <p>When the store was created.</p>
