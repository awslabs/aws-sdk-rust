...
impl super::Client {
    ...
    ///   - [`share_id(impl Into<String>)`](crate::operation::delete_share::builders::DeleteShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::delete_share::builders::DeleteShareFluentBuilder::set_share_id): <p> The ID for the share request to be deleted. </p>
