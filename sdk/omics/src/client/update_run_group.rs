...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_run_group::builders::UpdateRunGroupFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_run_group::builders::UpdateRunGroupFluentBuilder::set_id): <p>The group's ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_run_group::builders::UpdateRunGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_run_group::builders::UpdateRunGroupFluentBuilder::set_name): <p>A name for the group.</p>
