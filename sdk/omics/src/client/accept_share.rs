...
impl super::Client {
    ...
    ///   - [`share_id(impl Into<String>)`](crate::operation::accept_share::builders::AcceptShareFluentBuilder::share_id) / [`set_share_id(Option<String>)`](crate::operation::accept_share::builders::AcceptShareFluentBuilder::set_share_id):<br>required: **true**<br><p>The ID of the resource share.</p><br>
    /// - On success, responds with [`AcceptShareOutput`](crate::operation::accept_share::AcceptShareOutput) with field(s):
    ///   - [`status(Option<ShareStatus>)`](crate::operation::accept_share::AcceptShareOutput::status): <p>The status of the resource share.</p>
