...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::list_annotation_stores::builders::ListAnnotationStoresFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::list_annotation_stores::builders::ListAnnotationStoresFluentBuilder::set_ids): <p>IDs of stores to list.</p>
