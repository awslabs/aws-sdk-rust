...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::list_variant_import_jobs::builders::ListVariantImportJobsFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::list_variant_import_jobs::builders::ListVariantImportJobsFluentBuilder::set_ids): <p>A list of job IDs.</p>
