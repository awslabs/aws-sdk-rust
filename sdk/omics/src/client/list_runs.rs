...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::set_name): <p>Filter the list by run name.</p>
    ///   - [`run_group_id(impl ::std::convert::Into<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::run_group_id) / [`set_run_group_id(Option<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::set_run_group_id): <p>Filter the list by run group ID.</p>
    ///   - [`starting_token(impl ::std::convert::Into<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::starting_token) / [`set_starting_token(Option<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::set_starting_token): <p>Specify the pagination token from a previous request to retrieve the next page of results.</p>
