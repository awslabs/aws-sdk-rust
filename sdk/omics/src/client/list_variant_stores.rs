...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::list_variant_stores::builders::ListVariantStoresFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::list_variant_stores::builders::ListVariantStoresFluentBuilder::set_ids): <p>A list of store IDs.</p>
