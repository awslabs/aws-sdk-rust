...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_reference_import_jobs::builders::ListReferenceImportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_reference_import_jobs::builders::ListReferenceImportJobsFluentBuilder::set_next_token): <p>Specify the pagination token from a previous request to retrieve the next page of results.</p>
    ///   - [`reference_store_id(impl ::std::convert::Into<String>)`](crate::operation::list_reference_import_jobs::builders::ListReferenceImportJobsFluentBuilder::reference_store_id) / [`set_reference_store_id(Option<String>)`](crate::operation::list_reference_import_jobs::builders::ListReferenceImportJobsFluentBuilder::set_reference_store_id): <p>The job's reference store ID.</p>
