...
pub fn de_invoke_model_http_response(
    ...
    Ok({
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_invoke_model_output::de_content_type_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::invoke_model::InvokeModelError::unhandled(
        ...
        output = output.set_performance_config_latency(
            match crate::protocol_serde::shape_invoke_model_output::de_performance_config_latency_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_service_tier(
            match crate::protocol_serde::shape_invoke_model_output::de_service_tier_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
