...
pub fn de_body_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<crate::event_receiver::EventReceiver<crate::types::ResponseStream, crate::types::error::ResponseStreamError>, crate::operation::invoke_model_with_response_stream::InvokeModelWithResponseStreamError> {
