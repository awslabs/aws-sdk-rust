...
pub(crate) fn de_content_type_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-Bedrock-Content-Type");
...
pub(crate) fn de_performance_config_latency_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-Bedrock-PerformanceConfig-Latency");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_service_tier_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-Bedrock-Service-Tier");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
