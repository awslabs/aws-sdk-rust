...
pub(crate) fn de_payload_part_payload(input: &[u8]) -> Result<crate::types::PayloadPart, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
                        let tokens = &mut tokens_owned;
    let result =
    crate::protocol_serde::shape_payload_part::de_payload_part(tokens)?
...
pub(crate) fn de_payload_part<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PayloadPart>, ::aws_smithy_json::deserialize::error::DeserializeError>
