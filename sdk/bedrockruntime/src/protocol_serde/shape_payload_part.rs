...
pub(crate) fn de_payload_part_payload(input: &[u8]) -> Result<crate::types::PayloadPart, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    let result = crate::protocol_serde::shape_payload_part::de_payload_part(tokens)?
...
) -> Result<Option<crate::types::PayloadPart>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
