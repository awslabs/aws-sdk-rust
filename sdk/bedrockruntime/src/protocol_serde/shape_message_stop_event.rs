...
pub(crate) fn de_message_stop_event_payload(
    input: &[u8],
) -> Result<crate::types::MessageStopEvent, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_message_stop_event::de_message_stop_event(tokens)?
...
) -> Result<Option<crate::types::MessageStopEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
