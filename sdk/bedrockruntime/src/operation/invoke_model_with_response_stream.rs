...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeModelWithResponseStream {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeModelWithResponseStream")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for InvokeModelWithResponseStreamResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for InvokeModelWithResponseStreamRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for InvokeModelWithResponseStreamEndpointParamsInterceptor {
...
pub type InvokeModelWithResponseStreamErrorKind = InvokeModelWithResponseStreamError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for InvokeModelWithResponseStreamError {
...
impl InvokeModelWithResponseStreamError {
    ...
    /// Creates the `InvokeModelWithResponseStreamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
