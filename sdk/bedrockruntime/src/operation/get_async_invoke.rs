...
impl GetAsyncInvoke {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("bedrockruntime", "GetAsyncInvoke", input, runtime_plugins, stop_point)
            .await
    }
