...
impl InvokeModel {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("bedrockruntime", "InvokeModel", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeModel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("InvokeModel", "bedrockruntime"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeModel")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(InvokeModelEndpointParamsInterceptor) as _),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for InvokeModelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for InvokeModelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_invoke_model_input::ser_body_http_payload(input.body)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for InvokeModelEndpointParamsInterceptor {
...
pub type InvokeModelErrorKind = InvokeModelError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for InvokeModelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::invoke_model::InvokeModelError {
...
impl InvokeModelError {
    ...
    /// Creates the `InvokeModelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::ModelErrorException(e) => e.meta(),
