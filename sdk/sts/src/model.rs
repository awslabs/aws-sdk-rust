...
pub struct Credentials  {
    ...
    #[doc(hidden)]pub access_key_id: std::option::Option<std::string::String>,
    /// <p>The secret access key that can be used to sign requests.</p>
    #[doc(hidden)]pub secret_access_key: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub expiration: std::option::Option<aws_smithy_types::DateTime>,
}
impl Credentials {
    /// <p>The access key ID that identifies the temporary security credentials.</p>
...
pub struct FederatedUser  {
    ...
    #[doc(hidden)]pub federated_user_id: std::option::Option<std::string::String>,
...
pub struct AssumedRoleUser  {
    ...
    #[doc(hidden)]pub assumed_role_id: std::option::Option<std::string::String>,
