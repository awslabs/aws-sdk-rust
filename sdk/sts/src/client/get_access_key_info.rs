...
impl super::Client {
    ...
    ///   - [`access_key_id(impl ::std::convert::Into<String>)`](crate::operation::get_access_key_info::builders::GetAccessKeyInfoFluentBuilder::access_key_id) / [`set_access_key_id(Option<String>)`](crate::operation::get_access_key_info::builders::GetAccessKeyInfoFluentBuilder::set_access_key_id): <p>The identifier of an access key.</p>  <p>This parameter allows (through its regex pattern) a string of characters that can consist of any upper- or lowercase letter or digit.</p>
