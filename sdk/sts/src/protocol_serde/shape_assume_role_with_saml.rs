...
pub fn de_assume_role_with_saml_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssumeRoleWithSamlOutput, crate::error::AssumeRoleWithSAMLError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AssumeRoleWithSAMLError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidIdentityToken" => crate::error::AssumeRoleWithSAMLError::InvalidIdentityTokenException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "MalformedPolicyDocument" => crate::error::AssumeRoleWithSAMLError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "PackedPolicyTooLarge" => crate::error::AssumeRoleWithSAMLError::PackedPolicyTooLargeException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "RegionDisabledException" => crate::error::AssumeRoleWithSAMLError::RegionDisabledException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_with_saml_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssumeRoleWithSamlOutput, crate::error::AssumeRoleWithSAMLError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::assume_role_with_saml_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_assume_role_with_saml::de_assume_role_with_saml(response.body().as_ref(), output).map_err(crate::error::AssumeRoleWithSAMLError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_assume_role_with_saml(inp: &[u8], mut builder: crate::output::assume_role_with_saml_output::Builder) -> Result<crate::output::assume_role_with_saml_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
