...
pub fn de_assume_role_with_saml_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::assume_role_with_saml::AssumeRoleWithSamlOutput, crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_expired_token_exception::de_expired_token_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_idp_rejected_claim_exception::de_idp_rejected_claim_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_identity_token_exception::de_invalid_identity_token_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_malformed_policy_document_exception::de_malformed_policy_document_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_packed_policy_too_large_exception::de_packed_policy_too_large_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_region_disabled_exception::de_region_disabled_exception_xml_err(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_with_saml_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::assume_role_with_saml::AssumeRoleWithSamlOutput, crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder::default();
        output = crate::protocol_serde::shape_assume_role_with_saml::de_assume_role_with_saml(_response_body, output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_assume_role_with_saml(inp: &[u8], mut builder: crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder) -> Result<crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
