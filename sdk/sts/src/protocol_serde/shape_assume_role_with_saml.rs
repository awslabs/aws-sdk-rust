...
pub fn de_assume_role_with_saml_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::assume_role_with_saml::AssumeRoleWithSamlOutput, crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_with_saml_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::assume_role_with_saml::AssumeRoleWithSamlOutput, crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_assume_role_with_saml::de_assume_role_with_saml(response.body().as_ref(), output).map_err(crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError::unhandled)?;
