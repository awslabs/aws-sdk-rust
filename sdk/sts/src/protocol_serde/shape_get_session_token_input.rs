...
pub fn ser_get_session_token_input_input(input: &crate::operation::get_session_token::GetSessionTokenInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
