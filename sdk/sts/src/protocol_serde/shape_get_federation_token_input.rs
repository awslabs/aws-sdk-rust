...
pub fn ser_get_federation_token_input_input_input(input: &crate::operation::get_federation_token::GetFederationTokenInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
