...
pub fn de_assume_role_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssumeRoleOutput, crate::error::AssumeRoleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AssumeRoleError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "MalformedPolicyDocument" => crate::error::AssumeRoleError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssumeRoleOutput, crate::error::AssumeRoleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::assume_role_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_assume_role::de_assume_role(response.body().as_ref(), output).map_err(crate::error::AssumeRoleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_assume_role(inp: &[u8], mut builder: crate::output::assume_role_output::Builder) -> Result<crate::output::assume_role_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
