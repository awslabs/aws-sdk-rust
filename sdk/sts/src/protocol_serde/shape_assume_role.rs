...
pub fn de_assume_role_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::assume_role::AssumeRoleOutput, crate::operation::assume_role::AssumeRoleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::assume_role::AssumeRoleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::assume_role::AssumeRoleOutput, crate::operation::assume_role::AssumeRoleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::assume_role::builders::AssumeRoleOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_assume_role::de_assume_role(response.body().as_ref(), output).map_err(crate::operation::assume_role::AssumeRoleError::unhandled)?;
