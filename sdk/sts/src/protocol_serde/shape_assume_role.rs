...
pub fn de_assume_role_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::assume_role::AssumeRoleOutput, crate::operation::assume_role::AssumeRoleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::assume_role::AssumeRoleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::assume_role::AssumeRoleOutput, crate::operation::assume_role::AssumeRoleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::assume_role::builders::AssumeRoleOutputBuilder::default();
        output = crate::protocol_serde::shape_assume_role::de_assume_role(_response_body, output).map_err(crate::operation::assume_role::AssumeRoleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_assume_role(inp: &[u8], mut builder: crate::operation::assume_role::builders::AssumeRoleOutputBuilder) -> Result<crate::operation::assume_role::builders::AssumeRoleOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
