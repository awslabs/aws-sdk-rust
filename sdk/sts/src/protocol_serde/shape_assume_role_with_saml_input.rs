...
pub fn ser_assume_role_with_saml_input_input(input: &crate::input::AssumeRoleWithSamlInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
