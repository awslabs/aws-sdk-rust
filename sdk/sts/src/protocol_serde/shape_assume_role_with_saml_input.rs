...
pub fn ser_assume_role_with_saml_input_input_input(input: &crate::operation::assume_role_with_saml::AssumeRoleWithSamlInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
