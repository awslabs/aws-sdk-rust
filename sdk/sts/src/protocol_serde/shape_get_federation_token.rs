...
pub fn de_get_federation_token_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_federation_token::GetFederationTokenOutput, crate::operation::get_federation_token::GetFederationTokenError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_federation_token_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_federation_token::GetFederationTokenOutput, crate::operation::get_federation_token::GetFederationTokenError> {
    Ok({
        #[allow(unused_mut)]
