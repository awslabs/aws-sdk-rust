...
pub fn de_get_federation_token_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_federation_token::GetFederationTokenOutput, crate::operation::get_federation_token::GetFederationTokenError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_federation_token::GetFederationTokenError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_malformed_policy_document_exception::de_malformed_policy_document_exception_xml_err(_response_body, output).map_err(crate::operation::get_federation_token::GetFederationTokenError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_packed_policy_too_large_exception::de_packed_policy_too_large_exception_xml_err(_response_body, output).map_err(crate::operation::get_federation_token::GetFederationTokenError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_region_disabled_exception::de_region_disabled_exception_xml_err(_response_body, output).map_err(crate::operation::get_federation_token::GetFederationTokenError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_federation_token_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_federation_token::GetFederationTokenOutput, crate::operation::get_federation_token::GetFederationTokenError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_federation_token::builders::GetFederationTokenOutputBuilder::default();
        output = crate::protocol_serde::shape_get_federation_token::de_get_federation_token(_response_body, output).map_err(crate::operation::get_federation_token::GetFederationTokenError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_federation_token(inp: &[u8], mut builder: crate::operation::get_federation_token::builders::GetFederationTokenOutputBuilder) -> Result<crate::operation::get_federation_token::builders::GetFederationTokenOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
