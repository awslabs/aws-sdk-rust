...
pub fn de_get_federation_token_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetFederationTokenOutput, crate::error::GetFederationTokenError> {
    ...
    Err(match error_code {
        "MalformedPolicyDocument" => crate::error::GetFederationTokenError::MalformedPolicyDocumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "PackedPolicyTooLarge" => crate::error::GetFederationTokenError::PackedPolicyTooLargeException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "RegionDisabledException" => crate::error::GetFederationTokenError::RegionDisabledException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_get_federation_token(inp: &[u8], mut builder: crate::output::get_federation_token_output::Builder) -> Result<crate::output::get_federation_token_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
