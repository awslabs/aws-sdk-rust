...
pub fn ser_assume_role_with_web_identity_input_input(input: &crate::input::AssumeRoleWithWebIdentityInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
