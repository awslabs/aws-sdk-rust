...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_caller_identity_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_caller_identity::GetCallerIdentityOutput, crate::operation::get_caller_identity::GetCallerIdentityError>
...
) -> Result<crate::operation::get_caller_identity::builders::GetCallerIdentityOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
