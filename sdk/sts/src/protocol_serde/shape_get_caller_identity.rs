...
pub fn de_get_caller_identity_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCallerIdentityOutput, crate::error::GetCallerIdentityError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetCallerIdentityError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_caller_identity_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCallerIdentityOutput, crate::error::GetCallerIdentityError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_caller_identity_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_caller_identity::de_get_caller_identity(response.body().as_ref(), output).map_err(crate::error::GetCallerIdentityError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_caller_identity(inp: &[u8], mut builder: crate::output::get_caller_identity_output::Builder) -> Result<crate::output::get_caller_identity_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
