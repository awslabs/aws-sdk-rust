...
pub fn de_get_session_token_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_session_token::GetSessionTokenOutput, crate::operation::get_session_token::GetSessionTokenError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_session_token::GetSessionTokenError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_session_token_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_session_token::GetSessionTokenOutput, crate::operation::get_session_token::GetSessionTokenError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_session_token::builders::GetSessionTokenOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_session_token::de_get_session_token(response.body().as_ref(), output).map_err(crate::operation::get_session_token::GetSessionTokenError::unhandled)?;
