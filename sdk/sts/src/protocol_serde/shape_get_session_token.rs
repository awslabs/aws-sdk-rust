...
pub fn de_get_session_token_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSessionTokenOutput, crate::error::GetSessionTokenError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetSessionTokenError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_session_token_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSessionTokenOutput, crate::error::GetSessionTokenError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_session_token_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_session_token::de_get_session_token(response.body().as_ref(), output).map_err(crate::error::GetSessionTokenError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_session_token(inp: &[u8], mut builder: crate::output::get_session_token_output::Builder) -> Result<crate::output::get_session_token_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
