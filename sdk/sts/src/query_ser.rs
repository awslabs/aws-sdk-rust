...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_policy_descriptor_type(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PolicyDescriptorType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
