...
impl GetAccessKeyInfoInput {
    /// Consumes the builder and constructs an Operation<[`GetAccessKeyInfo`](crate::operation::get_access_key_info::GetAccessKeyInfo)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_access_key_info::GetAccessKeyInfo, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_access_key_info::GetAccessKeyInfoInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_access_key_info_input::ser_get_access_key_info_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_access_key_info::GetAccessKeyInfo::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAccessKeyInfo", "sts"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccessKeyInfo {
                type Output = std::result::Result<crate::operation::get_access_key_info::GetAccessKeyInfoOutput, crate::operation::get_access_key_info::GetAccessKeyInfoError>;
