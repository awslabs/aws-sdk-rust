...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFederationToken {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetFederationToken", "sts"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetFederationTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_federation_token_input::ser_get_federation_token_input_input(&input)?,
        );
