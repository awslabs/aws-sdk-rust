...
impl DecodeAuthorizationMessageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::decode_authorization_message::DecodeAuthorizationMessage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DecodeAuthorizationMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decode_authorization_message::de_decode_authorization_message_http_response_with_props(status, headers, body)
        }
    }
}
