...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::get_caller_identity::GetCallerIdentityError>::new());
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCallerIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_caller_identity::de_get_caller_identity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_caller_identity::de_get_caller_identity_http_response(status, headers, body, _cfg)
        };
