...
impl AssumeRoleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::assume_role::AssumeRole, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_assume_role_input::ser_assume_role_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssumeRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_assume_role::de_assume_role_http_response_with_props(status, headers, body)
        }
    }
