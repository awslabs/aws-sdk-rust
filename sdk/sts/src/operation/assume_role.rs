...
impl AssumeRoleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::assume_role::AssumeRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::assume_role::AssumeRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::assume_role::AssumeRole::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssumeRole", "sts"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssumeRole {
                type Output = std::result::Result<crate::operation::assume_role::AssumeRoleOutput, crate::operation::assume_role::AssumeRoleError>;
