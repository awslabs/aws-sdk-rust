...
impl AssumeRoleWithWebIdentityInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentity::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssumeRoleWithWebIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_assume_role_with_web_identity::de_assume_role_with_web_identity_http_response_with_props(
                status, headers, body,
            )
        }
    }
