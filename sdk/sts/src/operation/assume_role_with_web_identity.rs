...
impl AssumeRoleWithWebIdentityInput {
    /// Consumes the builder and constructs an Operation<[`AssumeRoleWithWebIdentity`](crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_assume_role_with_web_identity_input::ser_assume_role_with_web_identity_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssumeRoleWithWebIdentity", "sts"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssumeRoleWithWebIdentity {
                type Output = std::result::Result<crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityOutput, crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_assume_role_with_web_identity::de_assume_role_with_web_identity_http_error(response)
                     } else {
                        crate::protocol_serde::shape_assume_role_with_web_identity::de_assume_role_with_web_identity_http_response(response)
                     }
                }
            }
