...
impl GetSessionTokenInput {
    /// Consumes the builder and constructs an Operation<[`GetSessionToken`](crate::operation::get_session_token::GetSessionToken)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_session_token::GetSessionToken, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_session_token::GetSessionTokenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_session_token_input::ser_get_session_token_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_session_token::GetSessionToken::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSessionToken", "sts"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetSessionToken {
                type Output = std::result::Result<crate::operation::get_session_token::GetSessionTokenOutput, crate::operation::get_session_token::GetSessionTokenError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_session_token::de_get_session_token_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_session_token::de_get_session_token_http_response(response)
                     }
                }
            }
