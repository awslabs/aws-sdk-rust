            ...
            ::aws_smithy_types::endpoint::Endpoint::builder()
                ...
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4", 2)
                        .put("signingName", "billingconductor".to_string())
...
/// Endpoint resolver trait specific to AWSBillingConductor
                ...
                ref_val if ref_val >= 100_000_000 => {
                    return match (ref_val - 100_000_000) as usize {
                        ...
                        4 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://billingconductor.us-east-1.amazonaws.com".to_string())
                                .auth_scheme(
                                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4".to_string(), 2)
                                        .put("signingName", "billingconductor")
