...
impl Builder {
    ...
    /// use aws_sdk_billingconductor::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_billingconductor::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
