...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_associate_resources_to_custom_line_item::BatchAssociateResourcesToCustomLineItemError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::batch_associate_resources_to_custom_line_item::BatchAssociateResourcesToCustomLineItemError::unhandled(generic),
            )
        }
    };
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::batch_associate_resources_to_custom_line_item::BatchAssociateResourcesToCustomLineItemError::unhandled("Failed to parse RetryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_associate_resources_to_custom_line_item::de_batch_associate_resources_to_custom_line_item(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_associate_resources_to_custom_line_item::BatchAssociateResourcesToCustomLineItemError::unhandled)?;
...
pub(crate) fn de_batch_associate_resources_to_custom_line_item(
    _value: &[u8],
    mut builder: crate::operation::batch_associate_resources_to_custom_line_item::builders::BatchAssociateResourcesToCustomLineItemOutputBuilder,
) -> ::std::result::Result<
    crate::operation::batch_associate_resources_to_custom_line_item::builders::BatchAssociateResourcesToCustomLineItemOutputBuilder,
