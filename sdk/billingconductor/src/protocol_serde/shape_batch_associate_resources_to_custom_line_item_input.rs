...
pub fn ser_batch_associate_resources_to_custom_line_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchAssociateResourcesToCustomLineItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
