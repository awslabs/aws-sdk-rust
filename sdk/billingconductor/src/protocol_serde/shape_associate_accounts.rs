            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::associate_accounts::AssociateAccountsError::unhandled(
...
) -> Result<crate::operation::associate_accounts::builders::AssociateAccountsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
