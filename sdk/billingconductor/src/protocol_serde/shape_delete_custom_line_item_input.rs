...
pub fn ser_delete_custom_line_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteCustomLineItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
