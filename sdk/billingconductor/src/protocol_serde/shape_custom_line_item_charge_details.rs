...
pub fn ser_custom_line_item_charge_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CustomLineItemChargeDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
