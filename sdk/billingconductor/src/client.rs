...
impl Client  {
    ...
    pub fn batch_disassociate_resources_from_custom_line_item(&self) -> crate::client::fluent_builders::BatchDisassociateResourcesFromCustomLineItem {
                            crate::client::fluent_builders::BatchDisassociateResourcesFromCustomLineItem::new(self.handle.clone())
                        }
    ...
    pub fn list_billing_group_cost_reports(&self) -> crate::client::fluent_builders::ListBillingGroupCostReports {
    ...
    pub fn list_custom_line_item_versions(&self) -> crate::client::fluent_builders::ListCustomLineItemVersions {
