...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::delete_pricing_rule::builders::DeletePricingRuleFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_pricing_rule::builders::DeletePricingRuleFluentBuilder::set_arn): <p> The Amazon Resource Name (ARN) of the pricing rule that you are deleting. </p>
