...
impl super::Client {
    /// Constructs a fluent builder for the [`CreateCustomLineItem`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_client_token): <p> The token that is needed to support idempotency. Idempotency isn't currently supported, but will be implemented in a future update. </p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_name): <p> The name of the custom line item. </p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_description): <p> The description of the custom line item. This is shown on the Bills page in association with the charge value. </p>
    ///   - [`billing_group_arn(impl ::std::convert::Into<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::billing_group_arn) / [`set_billing_group_arn(Option<String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_billing_group_arn): <p> The Amazon Resource Name (ARN) that references the billing group where the custom line item applies to. </p>
    ///   - [`billing_period_range(CustomLineItemBillingPeriodRange)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::billing_period_range) / [`set_billing_period_range(Option<CustomLineItemBillingPeriodRange>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_billing_period_range): <p> A time range for which the custom line item is effective. </p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_tags): <p> A map that contains tag keys and tag values that are attached to a custom line item. </p>
    ///   - [`charge_details(CustomLineItemChargeDetails)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::charge_details) / [`set_charge_details(Option<CustomLineItemChargeDetails>)`](crate::operation::create_custom_line_item::builders::CreateCustomLineItemFluentBuilder::set_charge_details): <p> A <code>CustomLineItemChargeDetails</code> that describes the charge details for a custom line item. </p>
