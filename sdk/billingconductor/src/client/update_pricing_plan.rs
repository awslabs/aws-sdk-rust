...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the pricing plan that you're updating. </p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::set_name): <p>The name of the pricing plan. The name must be unique to each pricing plan. </p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::set_description): <p>The description of the pricing plan. </p>
