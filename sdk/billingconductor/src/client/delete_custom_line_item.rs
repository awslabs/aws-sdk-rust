...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_custom_line_item::builders::DeleteCustomLineItemFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::delete_custom_line_item::builders::DeleteCustomLineItemFluentBuilder::set_arn):<br>required: **true**<br><p> The ARN of the custom line item to be deleted. </p><br>
