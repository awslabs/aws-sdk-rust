...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::associate_accounts::builders::AssociateAccountsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::associate_accounts::builders::AssociateAccountsFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the billing group that associates the array of account IDs.</p><br>
    ///   - [`account_ids(impl Into<String>)`](crate::operation::associate_accounts::builders::AssociateAccountsFluentBuilder::account_ids) / [`set_account_ids(Option<Vec::<String>>)`](crate::operation::associate_accounts::builders::AssociateAccountsFluentBuilder::set_account_ids):<br>required: **true**<br><p>The associating array of account IDs.</p><br>
