...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_billing_group::builders::DeleteBillingGroupFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_billing_group::builders::DeleteBillingGroupFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the billing group that you're deleting.</p><br>
