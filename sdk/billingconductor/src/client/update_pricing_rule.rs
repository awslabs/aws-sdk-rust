...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::set_arn): <p> The Amazon Resource Name (ARN) of the pricing rule to update. </p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::set_name): <p> The new name of the pricing rule. The name must be unique to each pricing rule. </p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_pricing_rule::builders::UpdatePricingRuleFluentBuilder::set_description): <p> The new description for the pricing rule. </p>
