...
impl super::Client {
    ...
    ///   - [`billing_period(impl ::std::convert::Into<String>)`](crate::operation::list_billing_group_cost_reports::builders::ListBillingGroupCostReportsFluentBuilder::billing_period) / [`set_billing_period(Option<String>)`](crate::operation::list_billing_group_cost_reports::builders::ListBillingGroupCostReportsFluentBuilder::set_billing_period): <p>The preferred billing period for your report. </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_billing_group_cost_reports::builders::ListBillingGroupCostReportsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_billing_group_cost_reports::builders::ListBillingGroupCostReportsFluentBuilder::set_next_token): <p>The pagination token that's used on subsequent calls to get reports. </p>
