...
impl BatchAssociateResourcesToCustomLineItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_associate_resources_to_custom_line_item::BatchAssociateResourcesToCustomLineItemInput, ::aws_smithy_types::error::operation::BuildError> {
