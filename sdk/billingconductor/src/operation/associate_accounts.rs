...
impl AssociateAccountsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_accounts::AssociateAccounts,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_accounts::ser_associate_accounts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAccounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_accounts::de_associate_accounts_http_response_with_props(status, headers, body)
        }
    }
}
