...
impl CreatePricingRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_pricing_rule::CreatePricingRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_pricing_rule::CreatePricingRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_pricing_rule::CreatePricingRuleOutput, crate::operation::create_pricing_rule::CreatePricingRuleError, Self> {
