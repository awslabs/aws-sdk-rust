...
impl GetBillingGroupCostReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_billing_group_cost_report::GetBillingGroupCostReportInput, ::aws_smithy_types::error::operation::BuildError> {
