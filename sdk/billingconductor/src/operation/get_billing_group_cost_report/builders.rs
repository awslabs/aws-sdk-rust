...
impl GetBillingGroupCostReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_billing_group_cost_report::GetBillingGroupCostReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_billing_group_cost_report::GetBillingGroupCostReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_billing_group_cost_report::GetBillingGroupCostReportOutput, crate::operation::get_billing_group_cost_report::GetBillingGroupCostReportError, Self> {
