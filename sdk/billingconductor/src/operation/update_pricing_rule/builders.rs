...
impl UpdatePricingRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_pricing_rule::UpdatePricingRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_pricing_rule::UpdatePricingRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_pricing_rule::UpdatePricingRuleOutput, crate::operation::update_pricing_rule::UpdatePricingRuleError, Self> {
