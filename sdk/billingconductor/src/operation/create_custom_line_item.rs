    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/create-custom-line-item")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_custom_line_item::CreateCustomLineItem::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_custom_line_item::CreateCustomLineItemError
{
