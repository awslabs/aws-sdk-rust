...
impl CreateCustomLineItemInput {
    /// Consumes the builder and constructs an Operation<[`CreateCustomLineItem`](crate::operation::create_custom_line_item::CreateCustomLineItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_custom_line_item::CreateCustomLineItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_custom_line_item::CreateCustomLineItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_custom_line_item::CreateCustomLineItem::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateCustomLineItem {
                type Output = std::result::Result<crate::operation::create_custom_line_item::CreateCustomLineItemOutput, crate::operation::create_custom_line_item::CreateCustomLineItemError>;
