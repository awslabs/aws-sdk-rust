...
impl Builder {
    ...
    /// use aws_sdk_alexaforbusiness::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_alexaforbusiness::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
