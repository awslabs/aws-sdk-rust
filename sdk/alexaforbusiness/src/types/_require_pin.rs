...
impl ::std::convert::From<&str> for RequirePin {
    fn from(s: &str) -> Self {
        match s {
            ...
            "YES" => RequirePin::Yes,
            other => RequirePin::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RequirePin {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RequirePin::from(s))
    }
}
impl RequirePin {
...
impl ::std::convert::AsRef<str> for RequirePin {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
