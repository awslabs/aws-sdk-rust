...
impl ::std::convert::From<&str> for BusinessReportFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BusinessReportFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BusinessReportFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BusinessReportFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BusinessReportFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
