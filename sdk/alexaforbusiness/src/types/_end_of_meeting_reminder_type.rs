...
impl ::std::convert::From<&str> for EndOfMeetingReminderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndOfMeetingReminderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndOfMeetingReminderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndOfMeetingReminderType::from(s))
    }
}
