...
impl ::std::convert::From<&str> for DeviceUsageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceUsageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceUsageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceUsageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceUsageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DeviceUsageType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DeviceUsageType::Voice => write!(f, "VOICE"),
            DeviceUsageType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
