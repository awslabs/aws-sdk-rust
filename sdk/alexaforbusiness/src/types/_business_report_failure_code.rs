...
impl ::std::convert::From<&str> for BusinessReportFailureCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BusinessReportFailureCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BusinessReportFailureCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BusinessReportFailureCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BusinessReportFailureCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
