...
impl ::std::convert::From<&str> for EnablementTypeFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnablementTypeFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnablementTypeFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnablementTypeFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EnablementTypeFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EnablementTypeFilter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EnablementTypeFilter::Enabled => write!(f, "ENABLED"),
            EnablementTypeFilter::Pending => write!(f, "PENDING"),
            EnablementTypeFilter::Unknown(value) => write!(f, "{}", value),
        }
    }
}
