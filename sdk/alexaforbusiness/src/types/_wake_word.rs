...
impl ::std::convert::From<&str> for WakeWord {
    fn from(s: &str) -> Self {
        match s {
            ...
            "ECHO" => WakeWord::Echo,
            other => WakeWord::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WakeWord {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WakeWord::from(s))
    }
}
impl WakeWord {
...
impl ::std::convert::AsRef<str> for WakeWord {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
