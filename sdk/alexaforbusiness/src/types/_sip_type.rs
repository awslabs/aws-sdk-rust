...
impl ::std::convert::From<&str> for SipType {
    fn from(s: &str) -> Self {
        match s {
            "WORK" => SipType::Work,
            other => SipType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SipType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SipType::from(s))
    }
}
impl SipType {
...
impl ::std::convert::AsRef<str> for SipType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SipType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SipType::Work => write!(f, "WORK"),
            SipType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
