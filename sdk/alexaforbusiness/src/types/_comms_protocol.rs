...
impl ::std::convert::From<&str> for CommsProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommsProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CommsProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CommsProtocol::from(s))
    }
}
impl CommsProtocol {
...
impl ::std::convert::AsRef<str> for CommsProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
