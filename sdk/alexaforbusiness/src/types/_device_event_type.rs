...
impl ::std::convert::From<&str> for DeviceEventType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceEventType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceEventType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceEventType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceEventType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
