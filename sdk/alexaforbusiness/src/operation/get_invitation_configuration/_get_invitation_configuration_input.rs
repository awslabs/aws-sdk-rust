...
impl GetInvitationConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_invitation_configuration::GetInvitationConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
