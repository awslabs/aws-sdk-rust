...
impl DeleteGatewayGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_gateway_group::DeleteGatewayGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_gateway_group::DeleteGatewayGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_gateway_group::DeleteGatewayGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_gateway_group::DeleteGatewayGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_gateway_group::DeleteGatewayGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteGatewayGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteGatewayGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteGatewayGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteGatewayGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteGatewayGroup")
...
.with_interceptor(DeleteGatewayGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_gateway_group::DeleteGatewayGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_gateway_group::DeleteGatewayGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_gateway_group::DeleteGatewayGroupError>::new());
...
#[derive(Debug)]
            struct DeleteGatewayGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteGatewayGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_gateway_group::de_delete_gateway_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_gateway_group::de_delete_gateway_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteGatewayGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteGatewayGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_gateway_group::DeleteGatewayGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_gateway_group::DeleteGatewayGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_gateway_group::ser_delete_gateway_group_input(&input)?);
...
#[derive(Debug)]
            struct DeleteGatewayGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteGatewayGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteGatewayGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteGatewayGroupInput>()
                        .ok_or("failed to downcast to DeleteGatewayGroupInput")?;
...
pub enum DeleteGatewayGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteGatewayGroupError) for what information is available for the error.")]
...
impl DeleteGatewayGroupError {
    /// Creates the `DeleteGatewayGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteGatewayGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteGatewayGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_gateway_group::DeleteGatewayGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_gateway_group::_delete_gateway_group_output::DeleteGatewayGroupOutput;

pub use crate::operation::delete_gateway_group::_delete_gateway_group_input::DeleteGatewayGroupInput;

mod _delete_gateway_group_input;

mod _delete_gateway_group_output;
