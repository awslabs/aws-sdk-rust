...
impl DeleteGatewayGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGatewayGroup`](crate::operation::delete_gateway_group::DeleteGatewayGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_gateway_group::DeleteGatewayGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_gateway_group::DeleteGatewayGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_gateway_group::ser_delete_gateway_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_gateway_group::DeleteGatewayGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGatewayGroup", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGatewayGroup {
                type Output = std::result::Result<crate::operation::delete_gateway_group::DeleteGatewayGroupOutput, crate::operation::delete_gateway_group::DeleteGatewayGroupError>;
