...
impl DeleteGatewayGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_gateway_group::ser_delete_gateway_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGatewayGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_gateway_group::de_delete_gateway_group_http_response_with_props(status, headers, body)
        }
    }
}
