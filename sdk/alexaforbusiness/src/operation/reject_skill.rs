...
impl RejectSkillInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reject_skill::RejectSkill, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reject_skill::ser_reject_skill_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectSkill {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_skill::de_reject_skill_http_response_with_props(status, headers, body)
        }
    }
}
