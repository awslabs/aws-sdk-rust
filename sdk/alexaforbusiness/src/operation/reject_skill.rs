...
impl RejectSkillInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reject_skill::RejectSkill::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectSkill {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reject_skill::de_reject_skill_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_reject_skill::de_reject_skill_http_response_with_props(
                status, headers, body,
            )
        }
    }
