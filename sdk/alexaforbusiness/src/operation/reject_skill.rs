...
impl RejectSkillInput {
    /// Consumes the builder and constructs an Operation<[`RejectSkill`](crate::operation::reject_skill::RejectSkill)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reject_skill::RejectSkill, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reject_skill::RejectSkillInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reject_skill::ser_reject_skill_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reject_skill::RejectSkill::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RejectSkill", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for RejectSkill {
                type Output = std::result::Result<crate::operation::reject_skill::RejectSkillOutput, crate::operation::reject_skill::RejectSkillError>;
