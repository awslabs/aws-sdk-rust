...
impl DisassociateDeviceFromRoomInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoom::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDeviceFromRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_device_from_room::de_disassociate_device_from_room_http_response_with_props(
                status, headers, body,
            )
        }
    }
