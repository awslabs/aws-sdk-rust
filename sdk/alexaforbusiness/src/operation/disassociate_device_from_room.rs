...
/// Orchestration and serialization glue logic for `DisassociateDeviceFromRoom`.
...
impl DisassociateDeviceFromRoom {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateDeviceFromRoom {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateDeviceFromRoom");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateDeviceFromRoomRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateDeviceFromRoomResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateDeviceFromRoom")
...
.with_interceptor(DisassociateDeviceFromRoomEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError>::new());
...
#[derive(Debug)]
            struct DisassociateDeviceFromRoomResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateDeviceFromRoomResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_device_from_room::de_disassociate_device_from_room_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_device_from_room::de_disassociate_device_from_room_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateDeviceFromRoomRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateDeviceFromRoomRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_device_from_room::ser_disassociate_device_from_room_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateDeviceFromRoomEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateDeviceFromRoomEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateDeviceFromRoomEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateDeviceFromRoomInput>()
                        .ok_or("failed to downcast to DisassociateDeviceFromRoomInput")?;
...
pub enum DisassociateDeviceFromRoomError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateDeviceFromRoomError) for what information is available for the error.")]
...
impl DisassociateDeviceFromRoomError {
    /// Creates the `DisassociateDeviceFromRoomError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateDeviceFromRoomError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DeviceNotRegisteredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateDeviceFromRoomError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::disassociate_device_from_room::_disassociate_device_from_room_output::DisassociateDeviceFromRoomOutput;

pub use crate::operation::disassociate_device_from_room::_disassociate_device_from_room_input::DisassociateDeviceFromRoomInput;

mod _disassociate_device_from_room_input;

mod _disassociate_device_from_room_output;
