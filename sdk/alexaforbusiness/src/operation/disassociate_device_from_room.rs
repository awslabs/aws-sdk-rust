...
impl DisassociateDeviceFromRoomInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDeviceFromRoom`](crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoom)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoom, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_device_from_room::ser_disassociate_device_from_room_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoom::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisassociateDeviceFromRoom", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateDeviceFromRoom {
                type Output = std::result::Result<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomOutput, crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomError>;
