...
impl GetConferenceProviderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_conference_provider::GetConferenceProvider,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConferenceProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_conference_provider::de_get_conference_provider_http_response_with_props(status, headers, body)
        }
    }
}
