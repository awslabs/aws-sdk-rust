...
impl ListSkillsStoreCategoriesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_skills_store_categories::ListSkillsStoreCategories,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_skills_store_categories::ListSkillsStoreCategories::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSkillsStoreCategories {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_skills_store_categories::de_list_skills_store_categories_http_response_with_props(status, headers, body)
        }
    }
}
