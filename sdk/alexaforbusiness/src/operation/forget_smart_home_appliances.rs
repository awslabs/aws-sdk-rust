    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ForgetSmartHomeAppliances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            ForgetSmartHomeAppliancesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            ForgetSmartHomeAppliancesResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ForgetSmartHomeAppliancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ForgetSmartHomeAppliancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_forget_smart_home_appliances::ser_forget_smart_home_appliances_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ForgetSmartHomeAppliancesEndpointParamsInterceptor {
