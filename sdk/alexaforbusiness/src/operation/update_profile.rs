...
impl UpdateProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_profile::UpdateProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_profile::de_update_profile_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_profile::de_update_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
