...
impl UpdateProfileInput {
    /// Consumes the builder and constructs an Operation<[`UpdateProfile`](crate::operation::update_profile::UpdateProfile)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_profile::UpdateProfile, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_profile::ser_update_profile_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_profile::UpdateProfile::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateProfile", "alexaforbusiness"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProfile {
    type Output = ::std::result::Result<crate::operation::update_profile::UpdateProfileOutput, crate::operation::update_profile::UpdateProfileError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_profile::de_update_profile_http_response_with_props(status, headers, body)
        }
    }
}
