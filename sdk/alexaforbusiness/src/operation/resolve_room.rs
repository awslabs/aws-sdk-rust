...
impl ResolveRoomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::resolve_room::ResolveRoom,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resolve_room::ResolveRoom::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resolve_room::de_resolve_room_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_resolve_room::de_resolve_room_http_response_with_props(
                status, headers, body,
            )
        }
    }
