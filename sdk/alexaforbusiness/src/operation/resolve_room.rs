...
impl ResolveRoomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::resolve_room::ResolveRoom, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resolve_room::ser_resolve_room_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resolve_room::de_resolve_room_http_response_with_props(status, headers, body)
        }
    }
}
