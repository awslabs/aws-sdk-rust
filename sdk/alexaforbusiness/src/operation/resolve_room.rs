...
impl ResolveRoomInput {
    /// Consumes the builder and constructs an Operation<[`ResolveRoom`](crate::operation::resolve_room::ResolveRoom)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::resolve_room::ResolveRoom, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resolve_room::ResolveRoomInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resolve_room::ser_resolve_room_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::resolve_room::ResolveRoom::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResolveRoom", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResolveRoom {
                type Output = std::result::Result<crate::operation::resolve_room::ResolveRoomOutput, crate::operation::resolve_room::ResolveRoomError>;
