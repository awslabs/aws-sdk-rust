...
impl GetGatewayGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_gateway_group::GetGatewayGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_gateway_group::ser_get_gateway_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGatewayGroup {
    type Output =
        ::std::result::Result<crate::operation::get_gateway_group::GetGatewayGroupOutput, crate::operation::get_gateway_group::GetGatewayGroupError>;
