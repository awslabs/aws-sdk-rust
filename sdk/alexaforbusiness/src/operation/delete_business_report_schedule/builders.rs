...
pub use crate::operation::delete_business_report_schedule::_delete_business_report_schedule_output::DeleteBusinessReportScheduleOutputBuilder;
...
pub struct DeleteBusinessReportScheduleFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_business_report_schedule::builders::DeleteBusinessReportScheduleInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput,
                    crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError,
                > for DeleteBusinessReportScheduleFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteBusinessReportScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_business_report_schedule::DeleteBusinessReportSchedule::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_business_report_schedule::DeleteBusinessReportSchedule::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput, crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError, Self> {
