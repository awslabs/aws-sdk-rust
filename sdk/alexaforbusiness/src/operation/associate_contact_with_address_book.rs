...
impl AssociateContactWithAddressBookInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_contact_with_address_book::AssociateContactWithAddressBook::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateContactWithAddressBook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_contact_with_address_book::de_associate_contact_with_address_book_http_response_with_props(
                status, headers, body,
            )
        }
    }
