...
impl DeleteRoomSkillParameterInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_room_skill_parameter::DeleteRoomSkillParameter::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRoomSkillParameter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_room_skill_parameter::de_delete_room_skill_parameter_http_response_with_props(status, headers, body)
        }
    }
}
