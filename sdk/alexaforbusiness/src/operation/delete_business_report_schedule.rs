...
/// Orchestration and serialization glue logic for `DeleteBusinessReportSchedule`.
...
impl DeleteBusinessReportSchedule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBusinessReportSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBusinessReportSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBusinessReportScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBusinessReportScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBusinessReportSchedule")
...
.with_interceptor(DeleteBusinessReportScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError>::new());
...
#[derive(Debug)]
            struct DeleteBusinessReportScheduleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBusinessReportScheduleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_business_report_schedule::de_delete_business_report_schedule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_business_report_schedule::de_delete_business_report_schedule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteBusinessReportScheduleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBusinessReportScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_business_report_schedule::ser_delete_business_report_schedule_input(&input)?);
...
#[derive(Debug)]
            struct DeleteBusinessReportScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBusinessReportScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBusinessReportScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBusinessReportScheduleInput>()
                        .ok_or("failed to downcast to DeleteBusinessReportScheduleInput")?;
...
pub enum DeleteBusinessReportScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBusinessReportScheduleError) for what information is available for the error.")]
...
impl DeleteBusinessReportScheduleError {
    /// Creates the `DeleteBusinessReportScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBusinessReportScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBusinessReportScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_business_report_schedule::_delete_business_report_schedule_output::DeleteBusinessReportScheduleOutput;

pub use crate::operation::delete_business_report_schedule::_delete_business_report_schedule_input::DeleteBusinessReportScheduleInput;

mod _delete_business_report_schedule_input;

mod _delete_business_report_schedule_output;
