...
impl DeleteBusinessReportScheduleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBusinessReportSchedule`](crate::operation::delete_business_report_schedule::DeleteBusinessReportSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_business_report_schedule::DeleteBusinessReportSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_business_report_schedule::ser_delete_business_report_schedule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_business_report_schedule::DeleteBusinessReportSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBusinessReportSchedule", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBusinessReportSchedule {
                type Output = std::result::Result<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleOutput, crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleError>;
