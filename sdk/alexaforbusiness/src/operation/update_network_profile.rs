...
impl UpdateNetworkProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_network_profile::ser_update_network_profile_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_network_profile::UpdateNetworkProfile::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_network_profile::UpdateNetworkProfileError
{
