...
impl DeleteAddressBookInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAddressBook`](crate::operation::delete_address_book::DeleteAddressBook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_address_book::DeleteAddressBook, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_address_book::DeleteAddressBookInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_address_book::ser_delete_address_book_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_address_book::DeleteAddressBook::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAddressBook", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAddressBook {
                type Output = std::result::Result<crate::operation::delete_address_book::DeleteAddressBookOutput, crate::operation::delete_address_book::DeleteAddressBookError>;
