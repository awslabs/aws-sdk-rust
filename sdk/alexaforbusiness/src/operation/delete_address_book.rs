...
impl DeleteAddressBookInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_address_book::ser_delete_address_book_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAddressBook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_address_book::de_delete_address_book_http_response_with_props(status, headers, body)
        }
    }
}
