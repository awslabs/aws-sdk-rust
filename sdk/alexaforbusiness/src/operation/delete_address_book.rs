...
/// Orchestration and serialization glue logic for `DeleteAddressBook`.
...
impl DeleteAddressBook {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_address_book::DeleteAddressBookInput,
                    ) -> ::std::result::Result<crate::operation::delete_address_book::DeleteAddressBookOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_address_book::DeleteAddressBookError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_address_book::DeleteAddressBookError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_address_book::DeleteAddressBookOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAddressBook {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAddressBook");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAddressBookRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAddressBookResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAddressBook")
...
.with_interceptor(DeleteAddressBookEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_address_book::DeleteAddressBookError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_address_book::DeleteAddressBookError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_address_book::DeleteAddressBookError>::new());
...
#[derive(Debug)]
            struct DeleteAddressBookResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAddressBookResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_address_book::de_delete_address_book_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_address_book::de_delete_address_book_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteAddressBookRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAddressBookRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_address_book::DeleteAddressBookInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_address_book::DeleteAddressBookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_address_book::ser_delete_address_book_input(&input)?);
...
#[derive(Debug)]
            struct DeleteAddressBookEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAddressBookEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAddressBookEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAddressBookInput>()
                        .ok_or("failed to downcast to DeleteAddressBookInput")?;
...
pub enum DeleteAddressBookError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAddressBookError) for what information is available for the error.")]
...
impl DeleteAddressBookError {
    /// Creates the `DeleteAddressBookError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAddressBookError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAddressBookError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_address_book::DeleteAddressBookError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_address_book::_delete_address_book_output::DeleteAddressBookOutput;

pub use crate::operation::delete_address_book::_delete_address_book_input::DeleteAddressBookInput;

mod _delete_address_book_input;

mod _delete_address_book_output;
