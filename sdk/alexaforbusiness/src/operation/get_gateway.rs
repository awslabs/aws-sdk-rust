...
impl GetGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_gateway::GetGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_gateway::ser_get_gateway_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_gateway::de_get_gateway_http_response_with_props(status, headers, body)
        }
    }
}
