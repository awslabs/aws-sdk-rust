...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::revoke_invitation::RevokeInvitationOutput,
                    crate::operation::revoke_invitation::RevokeInvitationError,
                > for RevokeInvitationFluentBuilder
            {
                fn send(
                    self,
...
impl RevokeInvitationFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::revoke_invitation::builders::RevokeInvitationInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::revoke_invitation::RevokeInvitationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_invitation::RevokeInvitationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::revoke_invitation::RevokeInvitation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::revoke_invitation::RevokeInvitation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::revoke_invitation::RevokeInvitationOutput, crate::operation::revoke_invitation::RevokeInvitationError, Self> {
