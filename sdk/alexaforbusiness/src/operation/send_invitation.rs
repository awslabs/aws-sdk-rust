...
impl SendInvitationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_invitation::SendInvitation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_invitation::SendInvitationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_invitation::ser_send_invitation_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for SendInvitation {
                type Output = std::result::Result<crate::operation::send_invitation::SendInvitationOutput, crate::operation::send_invitation::SendInvitationError>;
