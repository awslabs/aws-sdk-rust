...
impl SendInvitationInput {
    /// Consumes the builder and constructs an Operation<[`SendInvitation`](crate::operation::send_invitation::SendInvitation)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_invitation::SendInvitation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_invitation::ser_send_invitation_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_invitation::SendInvitation::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendInvitation", "alexaforbusiness"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendInvitation {
    type Output =
        ::std::result::Result<crate::operation::send_invitation::SendInvitationOutput, crate::operation::send_invitation::SendInvitationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_invitation::de_send_invitation_http_response_with_props(status, headers, body)
        }
    }
}
