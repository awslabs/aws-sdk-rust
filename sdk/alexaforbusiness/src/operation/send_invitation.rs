...
impl SendInvitationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::send_invitation::SendInvitation,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_invitation::SendInvitation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendInvitation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_send_invitation::de_send_invitation_http_error(
                status, headers, body,
            )
        } else {
