...
impl ListBusinessReportSchedulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_business_report_schedules::ListBusinessReportSchedulesInput, ::aws_smithy_types::error::operation::BuildError> {
