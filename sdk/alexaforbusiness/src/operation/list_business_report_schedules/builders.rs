...
impl crate::operation::list_business_report_schedules::builders::ListBusinessReportSchedulesInputBuilder {
...
impl ListBusinessReportSchedulesFluentBuilder {
    /// Creates a new `ListBusinessReportSchedulesFluentBuilder`.
