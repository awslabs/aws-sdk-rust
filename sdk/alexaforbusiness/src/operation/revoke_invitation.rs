    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::revoke_invitation::RevokeInvitationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::revoke_invitation::RevokeInvitationOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for RevokeInvitationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::revoke_invitation::RevokeInvitationInput>()
            .expect("correct type");
