...
impl UpdateSkillGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_skill_group::UpdateSkillGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_skill_group::UpdateSkillGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_skill_group::UpdateSkillGroupOutput, crate::operation::update_skill_group::UpdateSkillGroupError, Self> {
