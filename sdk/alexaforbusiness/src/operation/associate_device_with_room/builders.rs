...
impl AssociateDeviceWithRoomFluentBuilder  {
    /// Creates a new `AssociateDeviceWithRoom`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::associate_device_with_room::AssociateDeviceWithRoom, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput, aws_smithy_http::result::SdkError<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>>
                     {
