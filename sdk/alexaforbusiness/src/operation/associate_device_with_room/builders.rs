...
impl AssociateDeviceWithRoomFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput, crate::operation::associate_device_with_room::AssociateDeviceWithRoomError, Self> {
