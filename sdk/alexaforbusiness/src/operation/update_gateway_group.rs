...
impl UpdateGatewayGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGatewayGroup`](crate::operation::update_gateway_group::UpdateGatewayGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_gateway_group::UpdateGatewayGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_gateway_group::UpdateGatewayGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_gateway_group::ser_update_gateway_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_gateway_group::UpdateGatewayGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGatewayGroup", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGatewayGroup {
                type Output = std::result::Result<crate::operation::update_gateway_group::UpdateGatewayGroupOutput, crate::operation::update_gateway_group::UpdateGatewayGroupError>;
