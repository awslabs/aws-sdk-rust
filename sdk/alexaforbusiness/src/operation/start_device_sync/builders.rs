...
impl StartDeviceSyncFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_device_sync::StartDeviceSyncOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_device_sync::StartDeviceSyncError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_device_sync::StartDeviceSyncOutput, crate::operation::start_device_sync::StartDeviceSyncError, Self> {
