...
impl PutSkillAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`PutSkillAuthorization`](crate::operation::put_skill_authorization::PutSkillAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_skill_authorization::PutSkillAuthorization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_skill_authorization::PutSkillAuthorizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_skill_authorization::ser_put_skill_authorization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_skill_authorization::PutSkillAuthorization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutSkillAuthorization", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutSkillAuthorization {
                type Output = std::result::Result<crate::operation::put_skill_authorization::PutSkillAuthorizationOutput, crate::operation::put_skill_authorization::PutSkillAuthorizationError>;
