...
/// Orchestration and serialization glue logic for `PutSkillAuthorization`.
...
impl PutSkillAuthorization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_skill_authorization::PutSkillAuthorizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_skill_authorization::PutSkillAuthorizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_skill_authorization::PutSkillAuthorizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_skill_authorization::PutSkillAuthorizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutSkillAuthorization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutSkillAuthorization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutSkillAuthorizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutSkillAuthorizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutSkillAuthorization")
...
.with_interceptor(PutSkillAuthorizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_skill_authorization::PutSkillAuthorizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_skill_authorization::PutSkillAuthorizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_skill_authorization::PutSkillAuthorizationError>::new());
...
#[derive(Debug)]
            struct PutSkillAuthorizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutSkillAuthorizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_skill_authorization::de_put_skill_authorization_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_skill_authorization::de_put_skill_authorization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutSkillAuthorizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutSkillAuthorizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_skill_authorization::PutSkillAuthorizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_skill_authorization::PutSkillAuthorizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_skill_authorization::ser_put_skill_authorization_input(&input)?);
...
#[derive(Debug)]
            struct PutSkillAuthorizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutSkillAuthorizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutSkillAuthorizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutSkillAuthorizationInput>()
                        .ok_or("failed to downcast to PutSkillAuthorizationInput")?;
...
pub enum PutSkillAuthorizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutSkillAuthorizationError) for what information is available for the error.")]
...
impl PutSkillAuthorizationError {
    /// Creates the `PutSkillAuthorizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutSkillAuthorizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutSkillAuthorizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_skill_authorization::PutSkillAuthorizationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_skill_authorization::_put_skill_authorization_output::PutSkillAuthorizationOutput;

pub use crate::operation::put_skill_authorization::_put_skill_authorization_input::PutSkillAuthorizationInput;

mod _put_skill_authorization_input;

mod _put_skill_authorization_output;
