...
impl StartSmartHomeApplianceDiscoveryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_smart_home_appliance_discovery::StartSmartHomeApplianceDiscovery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_smart_home_appliance_discovery::StartSmartHomeApplianceDiscovery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSmartHomeApplianceDiscovery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_smart_home_appliance_discovery::de_start_smart_home_appliance_discovery_http_response_with_props(
                status, headers, body,
            )
        }
    }
