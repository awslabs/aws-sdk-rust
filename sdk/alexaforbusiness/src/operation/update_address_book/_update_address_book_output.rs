...
impl ::aws_types::request_id::RequestId for UpdateAddressBookOutput {
...
impl UpdateAddressBookOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateAddressBookOutput`](crate::operation::update_address_book::UpdateAddressBookOutput).
    pub fn build(self) -> crate::operation::update_address_book::UpdateAddressBookOutput {
