...
impl ListGatewayGroupsInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_gateway_groups::ListGatewayGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_gateway_groups::ListGatewayGroupsInput {
