...
impl CreateSkillGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateSkillGroup`](crate::operation::create_skill_group::CreateSkillGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_skill_group::CreateSkillGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_skill_group::CreateSkillGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_skill_group::ser_create_skill_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_skill_group::CreateSkillGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSkillGroup", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSkillGroup {
                type Output = std::result::Result<crate::operation::create_skill_group::CreateSkillGroupOutput, crate::operation::create_skill_group::CreateSkillGroupError>;
