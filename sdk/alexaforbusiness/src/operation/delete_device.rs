...
impl DeleteDeviceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_device::ser_delete_device_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_device::DeleteDevice::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDevice", "alexaforbusiness"));
