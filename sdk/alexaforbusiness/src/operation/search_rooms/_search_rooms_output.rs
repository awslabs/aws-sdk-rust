...
impl SearchRoomsOutput {
    ...
    pub fn rooms(&self) -> &[crate::types::RoomData] {
...
impl ::aws_types::request_id::RequestId for SearchRoomsOutput {
...
impl SearchRoomsOutputBuilder {
    ...
    /// <p>The rooms that meet the specified set of filter criteria, in sort order.</p>
    pub fn get_rooms(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::RoomData>> {
        &self.rooms
    }
    /// <p>The token returned to indicate that there is more data available.</p>
