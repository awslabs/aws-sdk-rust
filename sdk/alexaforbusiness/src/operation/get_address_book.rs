...
impl GetAddressBookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_address_book::GetAddressBook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_address_book::ser_get_address_book_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAddressBook {
    type Output =
        ::std::result::Result<crate::operation::get_address_book::GetAddressBookOutput, crate::operation::get_address_book::GetAddressBookError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_address_book::de_get_address_book_http_response_with_props(status, headers, body)
        }
    }
}
