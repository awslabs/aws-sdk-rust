...
impl GetAddressBookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_address_book::GetAddressBook,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_address_book::GetAddressBook::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAddressBook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_address_book::de_get_address_book_http_error(
                status, headers, body,
            )
        } else {
