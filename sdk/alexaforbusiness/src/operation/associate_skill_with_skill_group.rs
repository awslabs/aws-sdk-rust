...
impl AssociateSkillWithSkillGroupInput {
    /// Consumes the builder and constructs an Operation<[`AssociateSkillWithSkillGroup`](crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_skill_with_skill_group::ser_associate_skill_with_skill_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateSkillWithSkillGroup", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateSkillWithSkillGroup {
                type Output = std::result::Result<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupOutput, crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError>;
