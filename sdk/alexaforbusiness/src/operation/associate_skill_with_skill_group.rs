...
impl AssociateSkillWithSkillGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupInput,
                    ) -> ::std::result::Result<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateSkillWithSkillGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateSkillWithSkillGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateSkillWithSkillGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateSkillWithSkillGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateSkillWithSkillGroup")
...
.with_interceptor(AssociateSkillWithSkillGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError>::new());
...
#[derive(Debug)]
            struct AssociateSkillWithSkillGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateSkillWithSkillGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_skill_with_skill_group::de_associate_skill_with_skill_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AssociateSkillWithSkillGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateSkillWithSkillGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_skill_with_skill_group::ser_associate_skill_with_skill_group_input(&input)?);
...
#[derive(Debug)]
            struct AssociateSkillWithSkillGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateSkillWithSkillGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateSkillWithSkillGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateSkillWithSkillGroupInput>()
                        .ok_or("failed to downcast to AssociateSkillWithSkillGroupInput")?;
...
pub enum AssociateSkillWithSkillGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateSkillWithSkillGroupError) for what information is available for the error.")]
...
impl AssociateSkillWithSkillGroupError {
    /// Creates the `AssociateSkillWithSkillGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateSkillWithSkillGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SkillNotLinkedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateSkillWithSkillGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_skill_with_skill_group::AssociateSkillWithSkillGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::associate_skill_with_skill_group::_associate_skill_with_skill_group_output::AssociateSkillWithSkillGroupOutput;

pub use crate::operation::associate_skill_with_skill_group::_associate_skill_with_skill_group_input::AssociateSkillWithSkillGroupInput;

mod _associate_skill_with_skill_group_input;

mod _associate_skill_with_skill_group_output;
