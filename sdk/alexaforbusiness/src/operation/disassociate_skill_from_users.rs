...
/// Orchestration and serialization glue logic for `DisassociateSkillFromUsers`.
...
impl DisassociateSkillFromUsers {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateSkillFromUsers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateSkillFromUsers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateSkillFromUsersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateSkillFromUsersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateSkillFromUsers")
...
.with_interceptor(DisassociateSkillFromUsersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError>::new());
...
#[derive(Debug)]
            struct DisassociateSkillFromUsersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateSkillFromUsersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_skill_from_users::de_disassociate_skill_from_users_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DisassociateSkillFromUsersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateSkillFromUsersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_skill_from_users::ser_disassociate_skill_from_users_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateSkillFromUsersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateSkillFromUsersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateSkillFromUsersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateSkillFromUsersInput>()
                        .ok_or("failed to downcast to DisassociateSkillFromUsersInput")?;
...
pub enum DisassociateSkillFromUsersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateSkillFromUsersError) for what information is available for the error.")]
...
impl DisassociateSkillFromUsersError {
    /// Creates the `DisassociateSkillFromUsersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateSkillFromUsersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateSkillFromUsersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_skill_from_users::DisassociateSkillFromUsersError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::disassociate_skill_from_users::_disassociate_skill_from_users_output::DisassociateSkillFromUsersOutput;

pub use crate::operation::disassociate_skill_from_users::_disassociate_skill_from_users_input::DisassociateSkillFromUsersInput;

mod _disassociate_skill_from_users_input;

mod _disassociate_skill_from_users_output;
