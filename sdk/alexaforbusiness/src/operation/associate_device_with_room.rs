...
impl AssociateDeviceWithRoomInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDeviceWithRoom`](crate::operation::associate_device_with_room::AssociateDeviceWithRoom)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_device_with_room::AssociateDeviceWithRoom, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_device_with_room::AssociateDeviceWithRoomInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_device_with_room::ser_associate_device_with_room_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_device_with_room::AssociateDeviceWithRoom::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateDeviceWithRoom", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateDeviceWithRoom {
                type Output = std::result::Result<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput, crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>;
