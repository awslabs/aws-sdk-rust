...
impl AssociateDeviceWithRoomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_device_with_room::AssociateDeviceWithRoom,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDeviceWithRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_device_with_room::de_associate_device_with_room_http_response_with_props(status, headers, body)
        }
    }
}
