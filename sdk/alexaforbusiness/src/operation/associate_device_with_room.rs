...
/// Orchestration and serialization glue logic for `AssociateDeviceWithRoom`.
...
impl AssociateDeviceWithRoom {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_device_with_room::AssociateDeviceWithRoomInput,
                    ) -> ::std::result::Result<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDeviceWithRoom {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateDeviceWithRoom");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateDeviceWithRoomRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateDeviceWithRoomResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDeviceWithRoom")
...
.with_interceptor(AssociateDeviceWithRoomEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomError>::new());
...
#[derive(Debug)]
            struct AssociateDeviceWithRoomResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateDeviceWithRoomResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_device_with_room::de_associate_device_with_room_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_device_with_room::de_associate_device_with_room_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateDeviceWithRoomRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateDeviceWithRoomRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_device_with_room::AssociateDeviceWithRoomInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_device_with_room::AssociateDeviceWithRoomInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_device_with_room::ser_associate_device_with_room_input(&input)?);
...
#[derive(Debug)]
            struct AssociateDeviceWithRoomEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateDeviceWithRoomEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateDeviceWithRoomEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateDeviceWithRoomInput>()
                        .ok_or("failed to downcast to AssociateDeviceWithRoomInput")?;
...
pub enum AssociateDeviceWithRoomError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateDeviceWithRoomError) for what information is available for the error.")]
...
impl AssociateDeviceWithRoomError {
    /// Creates the `AssociateDeviceWithRoomError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateDeviceWithRoomError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateDeviceWithRoomError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_device_with_room::AssociateDeviceWithRoomError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::associate_device_with_room::_associate_device_with_room_output::AssociateDeviceWithRoomOutput;

pub use crate::operation::associate_device_with_room::_associate_device_with_room_input::AssociateDeviceWithRoomInput;

mod _associate_device_with_room_input;

mod _associate_device_with_room_output;
