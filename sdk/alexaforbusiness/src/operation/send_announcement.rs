...
impl SendAnnouncementInput {
    /// Consumes the builder and constructs an Operation<[`SendAnnouncement`](crate::operation::send_announcement::SendAnnouncement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_announcement::SendAnnouncement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_announcement::SendAnnouncementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_announcement::ser_send_announcement_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_announcement::SendAnnouncement::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendAnnouncement", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for SendAnnouncement {
                type Output = std::result::Result<crate::operation::send_announcement::SendAnnouncementOutput, crate::operation::send_announcement::SendAnnouncementError>;
