...
impl SendAnnouncementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_announcement::SendAnnouncement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_announcement::ser_send_announcement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendAnnouncement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_announcement::de_send_announcement_http_response_with_props(status, headers, body)
        }
    }
}
