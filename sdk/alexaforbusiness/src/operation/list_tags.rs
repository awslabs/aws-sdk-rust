...
impl ListTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_tags::ListTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tags::ser_list_tags_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_tags::ListTags::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTags", "alexaforbusiness"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tags::de_list_tags_http_response_with_props(status, headers, body)
        }
    }
}
