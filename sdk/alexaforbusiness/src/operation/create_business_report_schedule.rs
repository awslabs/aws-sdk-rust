...
impl CreateBusinessReportScheduleInput {
    /// Consumes the builder and constructs an Operation<[`CreateBusinessReportSchedule`](crate::operation::create_business_report_schedule::CreateBusinessReportSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_business_report_schedule::CreateBusinessReportSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_business_report_schedule::CreateBusinessReportScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_business_report_schedule::ser_create_business_report_schedule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_business_report_schedule::CreateBusinessReportSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateBusinessReportSchedule", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBusinessReportSchedule {
                type Output = std::result::Result<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleOutput, crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError>;
