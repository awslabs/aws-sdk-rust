...
impl CreateBusinessReportSchedule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_business_report_schedule::CreateBusinessReportScheduleInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateBusinessReportSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateBusinessReportSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateBusinessReportScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateBusinessReportScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateBusinessReportSchedule")
...
.with_interceptor(CreateBusinessReportScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError>::new());
...
#[derive(Debug)]
            struct CreateBusinessReportScheduleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBusinessReportScheduleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_business_report_schedule::de_create_business_report_schedule_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateBusinessReportScheduleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBusinessReportScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_business_report_schedule::CreateBusinessReportScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_business_report_schedule::CreateBusinessReportScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_business_report_schedule::ser_create_business_report_schedule_input(&input)?);
...
#[derive(Debug)]
            struct CreateBusinessReportScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBusinessReportScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateBusinessReportScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateBusinessReportScheduleInput>()
                        .ok_or("failed to downcast to CreateBusinessReportScheduleInput")?;
...
pub enum CreateBusinessReportScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateBusinessReportScheduleError) for what information is available for the error.")]
...
impl CreateBusinessReportScheduleError {
    /// Creates the `CreateBusinessReportScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateBusinessReportScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateBusinessReportScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_business_report_schedule::CreateBusinessReportScheduleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_business_report_schedule::_create_business_report_schedule_output::CreateBusinessReportScheduleOutput;

pub use crate::operation::create_business_report_schedule::_create_business_report_schedule_input::CreateBusinessReportScheduleInput;

mod _create_business_report_schedule_input;

mod _create_business_report_schedule_output;
