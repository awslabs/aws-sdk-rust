...
impl SearchAddressBooks {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::search_address_books::SearchAddressBooksInput,
                    ) -> ::std::result::Result<crate::operation::search_address_books::SearchAddressBooksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_address_books::SearchAddressBooksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_address_books::SearchAddressBooksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_address_books::SearchAddressBooksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchAddressBooks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchAddressBooks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchAddressBooksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchAddressBooksResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchAddressBooks")
...
.with_interceptor(SearchAddressBooksEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_address_books::SearchAddressBooksError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_address_books::SearchAddressBooksError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_address_books::SearchAddressBooksError>::new());
...
#[derive(Debug)]
            struct SearchAddressBooksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchAddressBooksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_address_books::de_search_address_books_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SearchAddressBooksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchAddressBooksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_address_books::SearchAddressBooksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_address_books::SearchAddressBooksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_address_books::ser_search_address_books_input(&input)?);
...
#[derive(Debug)]
            struct SearchAddressBooksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchAddressBooksEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchAddressBooksEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchAddressBooksInput>()
                        .ok_or("failed to downcast to SearchAddressBooksInput")?;
...
pub enum SearchAddressBooksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchAddressBooksError) for what information is available for the error.")]
...
impl SearchAddressBooksError {
    /// Creates the `SearchAddressBooksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchAddressBooksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchAddressBooksError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_address_books::SearchAddressBooksError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::search_address_books::_search_address_books_output::SearchAddressBooksOutput;

pub use crate::operation::search_address_books::_search_address_books_input::SearchAddressBooksInput;

mod _search_address_books_input;

mod _search_address_books_output;
