...
impl SearchAddressBooksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_address_books::ser_search_address_books_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchAddressBooks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_address_books::de_search_address_books_http_response_with_props(status, headers, body)
        }
    }
}
