...
impl SearchAddressBooksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_address_books::ser_search_address_books_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_address_books::SearchAddressBooks::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_address_books::SearchAddressBooksError
{
