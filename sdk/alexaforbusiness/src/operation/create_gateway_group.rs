...
impl CreateGatewayGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_gateway_group::ser_create_gateway_group_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_gateway_group::CreateGatewayGroup::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_gateway_group::CreateGatewayGroupError
{
