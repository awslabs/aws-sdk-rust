    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_invitation_configuration::PutInvitationConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_invitation_configuration::PutInvitationConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutInvitationConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            PutInvitationConfigurationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            PutInvitationConfigurationResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutInvitationConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutInvitationConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_invitation_configuration::PutInvitationConfigurationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::put_invitation_configuration::PutInvitationConfigurationInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_invitation_configuration::ser_put_invitation_configuration_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutInvitationConfigurationEndpointParamsInterceptor {
