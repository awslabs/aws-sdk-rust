...
/// Orchestration and serialization glue logic for `ApproveSkill`.
...
impl ApproveSkill {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::approve_skill::ApproveSkillOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::approve_skill::ApproveSkillError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::approve_skill::ApproveSkillError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::approve_skill::ApproveSkillOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ApproveSkill {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ApproveSkill");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ApproveSkillRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ApproveSkillResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ApproveSkill")
...
.with_interceptor(ApproveSkillEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::approve_skill::ApproveSkillError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::approve_skill::ApproveSkillError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::approve_skill::ApproveSkillError>::new());
...
#[derive(Debug)]
            struct ApproveSkillResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ApproveSkillResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_approve_skill::de_approve_skill_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_approve_skill::de_approve_skill_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ApproveSkillRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ApproveSkillRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::approve_skill::ApproveSkillInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::approve_skill::ApproveSkillInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_approve_skill::ser_approve_skill_input(&input)?);
...
#[derive(Debug)]
            struct ApproveSkillEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ApproveSkillEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ApproveSkillEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ApproveSkillInput>()
                        .ok_or("failed to downcast to ApproveSkillInput")?;
...
pub enum ApproveSkillError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ApproveSkillError) for what information is available for the error.")]
...
impl ApproveSkillError {
    /// Creates the `ApproveSkillError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ApproveSkillError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ApproveSkillError {
...
impl ::aws_types::request_id::RequestId for crate::operation::approve_skill::ApproveSkillError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::approve_skill::_approve_skill_output::ApproveSkillOutput;

pub use crate::operation::approve_skill::_approve_skill_input::ApproveSkillInput;

mod _approve_skill_input;

mod _approve_skill_output;
