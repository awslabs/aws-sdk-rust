...
impl ApproveSkillInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::approve_skill::ApproveSkill, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_approve_skill::ser_approve_skill_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApproveSkill {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_approve_skill::de_approve_skill_http_response_with_props(status, headers, body)
        }
    }
}
