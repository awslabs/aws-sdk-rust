...
impl ApproveSkillInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::approve_skill::ApproveSkill::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApproveSkill {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_approve_skill::de_approve_skill_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_approve_skill::de_approve_skill_http_response_with_props(
                status, headers, body,
            )
        }
    }
