...
/// Orchestration and serialization glue logic for `PutConferencePreference`.
...
impl PutConferencePreference {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_conference_preference::PutConferencePreferenceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_conference_preference::PutConferencePreferenceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_conference_preference::PutConferencePreferenceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_conference_preference::PutConferencePreferenceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutConferencePreference {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutConferencePreference");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutConferencePreferenceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutConferencePreferenceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutConferencePreference")
...
.with_interceptor(PutConferencePreferenceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_conference_preference::PutConferencePreferenceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_conference_preference::PutConferencePreferenceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_conference_preference::PutConferencePreferenceError>::new());
...
#[derive(Debug)]
            struct PutConferencePreferenceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutConferencePreferenceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_conference_preference::de_put_conference_preference_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutConferencePreferenceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutConferencePreferenceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_conference_preference::PutConferencePreferenceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_conference_preference::PutConferencePreferenceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_conference_preference::ser_put_conference_preference_input(&input)?);
...
#[derive(Debug)]
            struct PutConferencePreferenceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutConferencePreferenceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutConferencePreferenceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutConferencePreferenceInput>()
                        .ok_or("failed to downcast to PutConferencePreferenceInput")?;
...
pub enum PutConferencePreferenceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutConferencePreferenceError) for what information is available for the error.")]
...
impl PutConferencePreferenceError {
    /// Creates the `PutConferencePreferenceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutConferencePreferenceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutConferencePreferenceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_conference_preference::PutConferencePreferenceError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_conference_preference::_put_conference_preference_output::PutConferencePreferenceOutput;

pub use crate::operation::put_conference_preference::_put_conference_preference_input::PutConferencePreferenceInput;

mod _put_conference_preference_input;

mod _put_conference_preference_output;
