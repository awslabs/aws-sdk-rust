...
impl SearchContactsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_contacts::SearchContacts::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SearchContacts {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_contacts::de_search_contacts_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_contacts::de_search_contacts_http_response(
                status, headers, body,
            )
        }
    }
