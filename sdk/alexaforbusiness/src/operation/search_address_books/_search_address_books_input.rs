...
impl SearchAddressBooksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_address_books::SearchAddressBooksInput, ::aws_smithy_types::error::operation::BuildError> {
