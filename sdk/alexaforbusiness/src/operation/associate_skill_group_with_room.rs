...
impl AssociateSkillGroupWithRoomInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_skill_group_with_room::AssociateSkillGroupWithRoom::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSkillGroupWithRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_skill_group_with_room::de_associate_skill_group_with_room_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AssociateSkillGroupWithRoomError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_skill_group_with_room::AssociateSkillGroupWithRoomError
{
