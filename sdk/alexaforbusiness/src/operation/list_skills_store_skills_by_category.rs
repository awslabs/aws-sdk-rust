...
impl ListSkillsStoreSkillsByCategoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_skills_store_skills_by_category::ListSkillsStoreSkillsByCategory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSkillsStoreSkillsByCategory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_skills_store_skills_by_category::de_list_skills_store_skills_by_category_http_response_with_props(
                status, headers, body,
            )
        }
    }
