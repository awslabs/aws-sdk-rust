...
impl ListSkillsStoreSkillsByCategory {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_skills_store_skills_by_category::ListSkillsStoreSkillsByCategoryOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListSkillsStoreSkillsByCategoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListSkillsStoreSkillsByCategoryRequestSerializer {
