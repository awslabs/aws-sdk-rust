...
impl DeleteSkillAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSkillAuthorization`](crate::operation::delete_skill_authorization::DeleteSkillAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_skill_authorization::DeleteSkillAuthorization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_skill_authorization::DeleteSkillAuthorizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_skill_authorization::ser_delete_skill_authorization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_skill_authorization::DeleteSkillAuthorization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteSkillAuthorization", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSkillAuthorization {
                type Output = std::result::Result<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationOutput, crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError>;
