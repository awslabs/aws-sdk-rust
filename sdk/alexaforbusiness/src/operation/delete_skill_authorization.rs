...
/// Orchestration and serialization glue logic for `DeleteSkillAuthorization`.
...
impl DeleteSkillAuthorization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSkillAuthorization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSkillAuthorization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSkillAuthorizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSkillAuthorizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSkillAuthorization")
...
.with_interceptor(DeleteSkillAuthorizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError>::new());
...
#[derive(Debug)]
            struct DeleteSkillAuthorizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSkillAuthorizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_skill_authorization::de_delete_skill_authorization_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_skill_authorization::de_delete_skill_authorization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteSkillAuthorizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSkillAuthorizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_skill_authorization::DeleteSkillAuthorizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_skill_authorization::ser_delete_skill_authorization_input(&input)?);
...
#[derive(Debug)]
            struct DeleteSkillAuthorizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSkillAuthorizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSkillAuthorizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSkillAuthorizationInput>()
                        .ok_or("failed to downcast to DeleteSkillAuthorizationInput")?;
...
pub enum DeleteSkillAuthorizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSkillAuthorizationError) for what information is available for the error.")]
...
impl DeleteSkillAuthorizationError {
    /// Creates the `DeleteSkillAuthorizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSkillAuthorizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSkillAuthorizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_skill_authorization::DeleteSkillAuthorizationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_skill_authorization::_delete_skill_authorization_output::DeleteSkillAuthorizationOutput;

pub use crate::operation::delete_skill_authorization::_delete_skill_authorization_input::DeleteSkillAuthorizationInput;

mod _delete_skill_authorization_input;

mod _delete_skill_authorization_output;
