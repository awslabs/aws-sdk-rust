...
impl DeleteSkillGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_skill_group::DeleteSkillGroup,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_skill_group::ser_delete_skill_group_input(&self)?);
