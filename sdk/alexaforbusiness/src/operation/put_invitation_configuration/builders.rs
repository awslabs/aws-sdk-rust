...
impl crate::operation::put_invitation_configuration::builders::PutInvitationConfigurationInputBuilder {
...
impl PutInvitationConfigurationFluentBuilder {
    /// Creates a new `PutInvitationConfigurationFluentBuilder`.
