...
impl AssociateDeviceWithNetworkProfileInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDeviceWithNetworkProfile`](crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_device_with_network_profile::ser_associate_device_with_network_profile_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateDeviceWithNetworkProfile", "alexaforbusiness"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDeviceWithNetworkProfile {
    type Output = ::std::result::Result<crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfileOutput, crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfileError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_device_with_network_profile::de_associate_device_with_network_profile_http_response_with_props(status, headers, body)
        }
    }
}
