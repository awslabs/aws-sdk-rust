...
impl AssociateDeviceWithNetworkProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfile,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_device_with_network_profile::AssociateDeviceWithNetworkProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDeviceWithNetworkProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_device_with_network_profile::de_associate_device_with_network_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
