...
impl UpdateSkillGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSkillGroup`](crate::operation::update_skill_group::UpdateSkillGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_skill_group::UpdateSkillGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_skill_group::UpdateSkillGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_skill_group::ser_update_skill_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_skill_group::UpdateSkillGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSkillGroup", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSkillGroup {
                type Output = std::result::Result<crate::operation::update_skill_group::UpdateSkillGroupOutput, crate::operation::update_skill_group::UpdateSkillGroupError>;
