...
impl GetContactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_contact::GetContact,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_contact::GetContact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_contact::de_get_contact_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_contact::de_get_contact_http_response_with_props(
                status, headers, body,
            )
        }
    }
