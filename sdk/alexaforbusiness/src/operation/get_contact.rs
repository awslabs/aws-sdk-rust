...
impl GetContactInput {
    /// Consumes the builder and constructs an Operation<[`GetContact`](crate::operation::get_contact::GetContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_contact::GetContact, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_contact::GetContactInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_contact::ser_get_contact_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_contact::GetContact::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContact", "alexaforbusiness"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetContact {
                type Output = std::result::Result<crate::operation::get_contact::GetContactOutput, crate::operation::get_contact::GetContactError>;
