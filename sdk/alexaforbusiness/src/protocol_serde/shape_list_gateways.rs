...
> {
    ...
    Err(crate::operation::list_gateways::ListGatewaysError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_gateways::de_list_gateways(_response_body, output)
                .map_err(crate::operation::list_gateways::ListGatewaysError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "Gateways" => {
                        builder = builder.set_gateways(
                            crate::protocol_serde::shape_gateway_summaries::de_gateway_summaries(
                                tokens,
                            )?,
                        );
                    }
