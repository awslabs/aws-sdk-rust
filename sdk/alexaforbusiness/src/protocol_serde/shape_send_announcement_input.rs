...
pub fn ser_send_announcement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendAnnouncementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
