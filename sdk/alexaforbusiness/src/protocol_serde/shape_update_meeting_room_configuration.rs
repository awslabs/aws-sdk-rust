...
pub fn ser_update_meeting_room_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateMeetingRoomConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2) = &input.end_of_meeting_reminder {
        ...
        crate::protocol_serde::shape_update_end_of_meeting_reminder::ser_update_end_of_meeting_reminder(&mut object_3, var_2)?;
        object_3.finish();
    }
