            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PhoneNumbers" => {
                            builder = builder.set_phone_numbers(crate::protocol_serde::shape_phone_number_list::de_phone_number_list(tokens)?);
                        }
                        "SipAddresses" => {
                            builder = builder.set_sip_addresses(crate::protocol_serde::shape_sip_address_list::de_sip_address_list(tokens)?);
                        }
