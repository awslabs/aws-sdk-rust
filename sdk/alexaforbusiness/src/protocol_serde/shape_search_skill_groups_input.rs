...
pub fn ser_search_skill_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::search_skill_groups::SearchSkillGroupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
