...
pub fn ser_create_conference_provider_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConferenceProviderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
