...
pub fn ser_register_avs_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterAvsDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
