...
pub fn ser_start_device_sync_input(
    ...
    crate::protocol_serde::shape_start_device_sync_input::ser_start_device_sync_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::start_device_sync::StartDeviceSyncError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "DeviceNotRegisteredException" => {
            crate::operation::start_device_sync::StartDeviceSyncError::DeviceNotRegisteredException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
