...
pub fn ser_list_device_events_input(input: &crate::operation::list_device_events::ListDeviceEventsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
