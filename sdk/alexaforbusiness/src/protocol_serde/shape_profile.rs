                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TemperatureUnit" => {
                            builder = builder.set_temperature_unit(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TemperatureUnit::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "WakeWord" => {
                            builder = builder.set_wake_word(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::WakeWord::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Locale" => {
                        ...
                        "SetupModeDisabled" => {
                            builder = builder.set_setup_mode_disabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "MaxVolumeLimit" => {
                        ...
                        "PSTNEnabled" => {
                            builder = builder.set_pstn_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "DataRetentionOptIn" => {
                            builder = builder.set_data_retention_opt_in(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "AddressBookArn" => {
