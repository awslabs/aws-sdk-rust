...
pub fn ser_create_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
