...
pub(crate) fn de_conference_preference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ConferencePreference>, aws_smithy_json::deserialize::error::DeserializeError>
