...
pub fn ser_search_rooms_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchRoomsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
