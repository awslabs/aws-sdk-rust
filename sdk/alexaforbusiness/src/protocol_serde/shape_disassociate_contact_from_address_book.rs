...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBookError::unhandled)?;
...
pub fn ser_disassociate_contact_from_address_book_input(
    ...
    crate::protocol_serde::shape_disassociate_contact_from_address_book_input::ser_disassociate_contact_from_address_book_input_input(
        &mut object,
        input,
    )?;
    object.finish();
