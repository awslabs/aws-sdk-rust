...
pub fn ser_update_conference_provider_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateConferenceProviderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
