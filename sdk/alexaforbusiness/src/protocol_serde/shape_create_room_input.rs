...
pub fn ser_create_room_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRoomInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
