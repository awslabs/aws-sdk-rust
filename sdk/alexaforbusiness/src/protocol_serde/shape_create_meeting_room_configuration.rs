...
pub fn ser_create_meeting_room_configuration(
    ...
    if let Some(var_4) = &input.instant_booking {
        ...
        crate::protocol_serde::shape_create_instant_booking::ser_create_instant_booking(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
    ...
    if let Some(var_6) = &input.require_check_in {
        ...
        crate::protocol_serde::shape_create_require_check_in::ser_create_require_check_in(
            &mut object_7,
            var_6,
        )?;
        object_7.finish();
    ...
    if let Some(var_8) = &input.proactive_join {
        ...
        crate::protocol_serde::shape_create_proactive_join::ser_create_proactive_join(
            &mut object_9,
            var_8,
        )?;
        object_9.finish();
