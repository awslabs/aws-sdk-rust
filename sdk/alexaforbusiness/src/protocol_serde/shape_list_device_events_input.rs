...
pub fn ser_list_device_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListDeviceEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
