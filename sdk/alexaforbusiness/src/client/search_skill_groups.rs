...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::search_skill_groups::builders::SearchSkillGroupsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::search_skill_groups::builders::SearchSkillGroupsFluentBuilder::set_filters): <p>The filters to use to list a specified set of skill groups. The supported filter key is SkillGroupName. </p>
    ///   - [`sort_criteria(Sort)`](crate::operation::search_skill_groups::builders::SearchSkillGroupsFluentBuilder::sort_criteria) / [`set_sort_criteria(Option<Vec<Sort>>)`](crate::operation::search_skill_groups::builders::SearchSkillGroupsFluentBuilder::set_sort_criteria): <p>The sort order to use in listing the specified set of skill groups. The supported sort key is SkillGroupName. </p>
