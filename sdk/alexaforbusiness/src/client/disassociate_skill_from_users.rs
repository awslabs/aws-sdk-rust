...
impl super::Client {
    ...
    ///   - [`skill_id(impl Into<String>)`](crate::operation::disassociate_skill_from_users::builders::DisassociateSkillFromUsersFluentBuilder::skill_id) / [`set_skill_id(Option<String>)`](crate::operation::disassociate_skill_from_users::builders::DisassociateSkillFromUsersFluentBuilder::set_skill_id):<br>required: **true**<br><p>The private skill ID you want to make unavailable for enrolled users.</p><br>
