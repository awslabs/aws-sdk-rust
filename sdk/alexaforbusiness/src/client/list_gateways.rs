...
impl super::Client {
    ...
    ///   - [`gateway_group_arn(impl ::std::convert::Into<String>)`](crate::operation::list_gateways::builders::ListGatewaysFluentBuilder::gateway_group_arn) / [`set_gateway_group_arn(Option<String>)`](crate::operation::list_gateways::builders::ListGatewaysFluentBuilder::set_gateway_group_arn): <p>The gateway group ARN for which to list gateways.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_gateways::builders::ListGatewaysFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_gateways::builders::ListGatewaysFluentBuilder::set_next_token): <p>The token used to paginate though multiple pages of gateway summaries.</p>
