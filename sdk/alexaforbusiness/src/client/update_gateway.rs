...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::set_gateway_arn): <p>The ARN of the gateway to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::set_name): <p>The updated name of the gateway.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::set_description): <p>The updated description of the gateway.</p>
