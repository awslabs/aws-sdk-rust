...
impl super::Client {
    ...
    ///   - [`gateway_group_arn(impl Into<String>)`](crate::operation::get_gateway_group::builders::GetGatewayGroupFluentBuilder::gateway_group_arn) / [`set_gateway_group_arn(Option<String>)`](crate::operation::get_gateway_group::builders::GetGatewayGroupFluentBuilder::set_gateway_group_arn):<br>required: **true**<br><p>The ARN of the gateway group to get.</p><br>
