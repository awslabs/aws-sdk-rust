...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_user::builders::CreateUserFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_tags): <p>The tags for the user.</p>
