...
impl super::Client {
    ...
    ///   - [`skill_id(impl ::std::convert::Into<String>)`](crate::operation::put_skill_authorization::builders::PutSkillAuthorizationFluentBuilder::skill_id) / [`set_skill_id(Option<String>)`](crate::operation::put_skill_authorization::builders::PutSkillAuthorizationFluentBuilder::set_skill_id): <p>The unique identifier of a skill.</p>
