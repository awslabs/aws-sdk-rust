...
impl super::Client {
    ...
    ///   - [`skill_group_arn(impl ::std::convert::Into<String>)`](crate::operation::update_skill_group::builders::UpdateSkillGroupFluentBuilder::skill_group_arn) / [`set_skill_group_arn(Option<String>)`](crate::operation::update_skill_group::builders::UpdateSkillGroupFluentBuilder::set_skill_group_arn): <p>The ARN of the skill group to update. </p>
    ///   - [`skill_group_name(impl ::std::convert::Into<String>)`](crate::operation::update_skill_group::builders::UpdateSkillGroupFluentBuilder::skill_group_name) / [`set_skill_group_name(Option<String>)`](crate::operation::update_skill_group::builders::UpdateSkillGroupFluentBuilder::set_skill_group_name): <p>The updated name for the skill group.</p>
