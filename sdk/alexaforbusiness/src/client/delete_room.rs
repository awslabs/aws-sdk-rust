...
impl super::Client {
    ...
    ///   - [`room_arn(impl Into<String>)`](crate::operation::delete_room::builders::DeleteRoomFluentBuilder::room_arn) / [`set_room_arn(Option<String>)`](crate::operation::delete_room::builders::DeleteRoomFluentBuilder::set_room_arn):<br>required: **false**<br><p>The ARN of the room to delete. Required.</p><br>
