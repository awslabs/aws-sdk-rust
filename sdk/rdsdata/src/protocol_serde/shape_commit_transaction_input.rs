...
pub fn ser_commit_transaction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CommitTransactionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
