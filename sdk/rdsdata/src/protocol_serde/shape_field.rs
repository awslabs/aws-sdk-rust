...
pub fn ser_field(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Field) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
