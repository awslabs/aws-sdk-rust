...
pub fn ser_array_value(object_1: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ArrayValue) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
