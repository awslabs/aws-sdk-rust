...
pub(crate) fn de_array_value<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ArrayValue>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_array_value(object_1: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArrayValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
