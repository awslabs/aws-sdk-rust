...
pub fn de_begin_transaction_http_error(
    ...
    Err(match error_code {
        ...
        "DatabaseResumingException" => crate::operation::begin_transaction::BeginTransactionError::DatabaseResumingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidResourceStateException" => crate::operation::begin_transaction::BeginTransactionError::InvalidResourceStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
