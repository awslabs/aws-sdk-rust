                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        "arrayValues" => Some(crate::types::Value::ArrayValues(
                            crate::protocol_serde::shape_array_value_list::de_array_value_list(tokens)?.ok_or_else(|| {
                        ...
                        "structValue" => Some(crate::types::Value::StructValue(
                            crate::protocol_serde::shape_struct_value::de_struct_value(tokens)?.ok_or_else(|| {
