...
pub fn ser_execute_sql_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteSqlInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
