...
pub fn ser_begin_transaction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BeginTransactionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
