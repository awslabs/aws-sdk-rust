...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the Aurora Serverless DB cluster.</p><br>
    ///   - [`secret_arn(impl Into<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::secret_arn) / [`set_secret_arn(Option<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::set_secret_arn):<br>required: **true**<br><p>The name or ARN of the secret that enables access to the DB cluster.</p><br>
    ///   - [`transaction_id(impl Into<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::transaction_id) / [`set_transaction_id(Option<String>)`](crate::operation::rollback_transaction::builders::RollbackTransactionFluentBuilder::set_transaction_id):<br>required: **true**<br><p>The identifier of the transaction to roll back.</p><br>
