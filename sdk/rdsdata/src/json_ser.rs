...
pub fn serialize_structure_batch_execute_statement_input(
                ...
                for item_6 in item_4 {
                    {
                        ...
                        crate::json_ser::serialize_structure_sql_parameter(&mut object_7, item_6);
                        object_7.finish();
                    }
                }
                array_5.finish();
...
pub fn serialize_structure_begin_transaction_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_commit_transaction_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_execute_sql_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_execute_statement_input(
        ...
        for item_28 in var_26 {
            {
                ...
                crate::json_ser::serialize_structure_sql_parameter(&mut object_29, item_28);
                object_29.finish();
            }
        }
        array_27.finish();
    ...
    if let Some(var_31) = &input.result_set_options {
        ...
        crate::json_ser::serialize_structure_result_set_options(&mut object_32, var_31);
        object_32.finish();
    }
...
pub fn serialize_structure_rollback_transaction_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sql_parameter(
    ...
    if let Some(var_41) = &input.value {
        ...
        crate::json_ser::serialize_union_field(&mut object_42, var_41);
        object_42.finish();
    }
...
pub fn serialize_structure_result_set_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_field(
    object_42: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    match input {
        ...
        crate::model::Field::ArrayValue(inner) => {
            ...
            crate::json_ser::serialize_union_array_value(&mut object_45, inner);
            object_45.finish();
        }
    }
}

pub fn serialize_union_array_value(
            ...
            for item_49 in inner {
                {
                    array_48.value().number(
                        #[allow(clippy::useless_conversion)]
                        smithy_types::Number::NegInt((*item_49).into()),
                    );
                }
            }
            array_48.finish();
            ...
            for item_55 in inner {
                {
                    ...
                    crate::json_ser::serialize_union_array_value(&mut object_56, item_55);
                    object_56.finish();
                }
            }
            array_54.finish();
