...
pub fn serialize_structure_crate_input_batch_execute_statement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchExecuteStatementInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
                ...
                for item_6 in item_4 {
                     {
                        ...
                        crate::json_ser::serialize_structure_crate_model_sql_parameter(&mut object_7, item_6)?;
                        object_7.finish();
                    }
                }
                array_5.finish();
...
pub fn serialize_structure_crate_input_begin_transaction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BeginTransactionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_execute_sql_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteSqlInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_execute_statement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteStatementInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_29 in var_27 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_sql_parameter(&mut object_30, item_29)?;
                object_30.finish();
            }
        }
        array_28.finish();
    ...
    if let Some(var_32) = &input.result_set_options {
        ...
        crate::json_ser::serialize_structure_crate_model_result_set_options(&mut object_33, var_32)?;
        object_33.finish();
    }
...
pub fn serialize_structure_crate_input_rollback_transaction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RollbackTransactionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sql_parameter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SqlParameter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_result_set_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResultSetOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_union_crate_model_field(object_43: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Field) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::Field::LongValue(inner) => {
             {
                object_43.key("longValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*inner).into()));
            }
        },
        crate::model::Field::DoubleValue(inner) => {
             {
                object_43.key("doubleValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*inner).into()));
            }
        },
        ...
        crate::model::Field::BlobValue(inner) => {
             {
                object_43.key("blobValue").string_unchecked(&aws_smithy_types::base64::encode(inner));
            }
        },
        ...
        crate::model::Field::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("Field"))
    }
    Ok(())
}

pub fn serialize_union_crate_model_array_value(object_47: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArrayValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::ArrayValue::LongValues(inner) => {
             {
                ...
                for item_51 in inner {
                     {
                        array_50.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*item_51).into()));
                    }
                }
                array_50.finish();
            }
        ...
        crate::model::ArrayValue::DoubleValues(inner) => {
             {
                ...
                for item_53 in inner {
                     {
                        array_52.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*item_53).into()));
                    }
                }
                array_52.finish();
            }
                ...
                for item_57 in inner {
                     {
                        ...
                        crate::json_ser::serialize_union_crate_model_array_value(&mut object_58, item_57)?;
                        object_58.finish();
                    }
                }
                array_56.finish();
        ...
        crate::model::ArrayValue::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("ArrayValue"))
    }
    Ok(())
}
