...
impl crate::operation::begin_transaction::builders::BeginTransactionInputBuilder {
...
/// <p>For Aurora MySQL, DDL statements inside a transaction cause an implicit commit. We recommend that you run each MySQL DDL statement in a separate <code>ExecuteStatement</code> call with <code>continueAfterTimeout</code> enabled.</p>
/// </note>
