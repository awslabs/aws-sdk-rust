...
impl BeginTransactionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::begin_transaction::BeginTransactionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::begin_transaction::BeginTransactionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::begin_transaction::BeginTransactionOutput, crate::operation::begin_transaction::BeginTransactionError, Self> {
