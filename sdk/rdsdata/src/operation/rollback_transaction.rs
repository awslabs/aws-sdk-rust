...
impl RollbackTransaction {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS Data", "RollbackTransaction", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS Data.RollbackTransaction",
                "rpc.service" = "RDS Data",
                "rpc.method" = "RollbackTransaction",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RollbackTransaction")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RollbackTransaction")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RollbackTransactionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RollbackTransactionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RollbackTransactionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RollbackTransactionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RollbackTransactionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rollback_transaction::de_rollback_transaction_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_rollback_transaction::de_rollback_transaction_http_response(status, headers, body, _cfg)
        };
...
impl RollbackTransactionError {
    ...
    /// Returns `true` if the error kind is `RollbackTransactionError::InvalidResourceStateException`.
