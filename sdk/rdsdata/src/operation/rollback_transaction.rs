...
impl RollbackTransactionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rollback_transaction::ser_rollback_transaction_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rollback_transaction::RollbackTransaction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::rollback_transaction::RollbackTransactionError
{
