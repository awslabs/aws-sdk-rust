...
impl RollbackTransactionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::rollback_transaction::RollbackTransaction,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_rollback_transaction::ser_rollback_transaction_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RollbackTransaction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rollback_transaction::de_rollback_transaction_http_response_with_props(status, headers, body)
        }
    }
}
