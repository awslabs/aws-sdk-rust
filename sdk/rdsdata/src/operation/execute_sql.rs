...
impl ExecuteSqlInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::execute_sql::ExecuteSql, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_sql::ser_execute_sql_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteSql {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_execute_sql::de_execute_sql_http_response_with_props(status, headers, body)
        }
    }
}
