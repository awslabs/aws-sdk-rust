...
impl CommitTransaction {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("rdsdata", "CommitTransaction", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CommitTransaction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CommitTransaction", "rdsdata"));
...
impl CommitTransactionError {
    ...
    /// Returns `true` if the error kind is `CommitTransactionError::DatabaseErrorException`.
    pub fn is_database_error_exception(&self) -> bool {
        matches!(self, Self::DatabaseErrorException(_))
    }
    /// Returns `true` if the error kind is `CommitTransactionError::DatabaseNotFoundException`.
    pub fn is_database_not_found_exception(&self) -> bool {
        matches!(self, Self::DatabaseNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CommitTransactionError::DatabaseUnavailableException`.
    ...
    /// Returns `true` if the error kind is `CommitTransactionError::HttpEndpointNotEnabledException`.
    ...
    /// Returns `true` if the error kind is `CommitTransactionError::SecretsErrorException`.
    ...
    /// Returns `true` if the error kind is `CommitTransactionError::TransactionNotFoundException`.
