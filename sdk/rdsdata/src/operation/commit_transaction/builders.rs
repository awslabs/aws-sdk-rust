...
impl CommitTransactionFluentBuilder  {
    /// Creates a new `CommitTransaction`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::commit_transaction::CommitTransactionOutput, aws_smithy_http::result::SdkError<crate::operation::commit_transaction::CommitTransactionError>>
                     {
