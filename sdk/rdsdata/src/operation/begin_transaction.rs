...
impl BeginTransaction {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::begin_transaction::BeginTransactionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::begin_transaction::BeginTransactionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::begin_transaction::BeginTransactionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::begin_transaction::BeginTransactionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BeginTransaction {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BeginTransaction");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BeginTransactionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BeginTransactionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BeginTransaction")
...
.with_interceptor(BeginTransactionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::begin_transaction::BeginTransactionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::begin_transaction::BeginTransactionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::begin_transaction::BeginTransactionError>::new());
...
#[derive(Debug)]
            struct BeginTransactionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BeginTransactionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_begin_transaction::de_begin_transaction_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_begin_transaction::de_begin_transaction_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BeginTransactionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BeginTransactionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::begin_transaction::BeginTransactionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::begin_transaction::BeginTransactionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/BeginTransaction").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_begin_transaction::ser_begin_transaction_input(&input)?);
...
#[derive(Debug)]
            struct BeginTransactionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BeginTransactionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BeginTransactionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BeginTransactionInput>()
                        .ok_or("failed to downcast to BeginTransactionInput")?;
...
pub enum BeginTransactionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BeginTransactionError) for what information is available for the error.")]
...
impl BeginTransactionError {
    /// Creates the `BeginTransactionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BeginTransactionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for BeginTransactionError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::DatabaseErrorException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::DatabaseNotFoundException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::DatabaseUnavailableException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::ForbiddenException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::HttpEndpointNotEnabledException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::InternalServerErrorException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::InvalidSecretException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::SecretsErrorException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::TransactionNotFoundException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BeginTransactionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::begin_transaction::BeginTransactionError {
