...
impl BeginTransactionInput {
    /// Consumes the builder and constructs an Operation<[`BeginTransaction`](crate::operation::begin_transaction::BeginTransaction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::begin_transaction::BeginTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::begin_transaction::BeginTransactionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_begin_transaction::ser_begin_transaction_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::begin_transaction::BeginTransaction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BeginTransaction", "rdsdata"));
...
impl aws_smithy_http::response::ParseStrictResponse for BeginTransaction {
                type Output = std::result::Result<crate::operation::begin_transaction::BeginTransactionOutput, crate::operation::begin_transaction::BeginTransactionError>;
