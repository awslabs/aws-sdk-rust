...
impl BeginTransaction {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::begin_transaction::BeginTransactionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::begin_transaction::BeginTransactionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS Data", "BeginTransaction", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS Data.BeginTransaction",
                "rpc.service" = "RDS Data",
                "rpc.method" = "BeginTransaction",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BeginTransaction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BeginTransactionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BeginTransactionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BeginTransaction")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BeginTransaction")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BeginTransactionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BeginTransactionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BeginTransactionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BeginTransactionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BeginTransactionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_begin_transaction::de_begin_transaction_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_begin_transaction::de_begin_transaction_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BeginTransactionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::begin_transaction::BeginTransactionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::begin_transaction::BeginTransactionInput,
...
impl BeginTransactionError {
    ...
    /// Returns `true` if the error kind is `BeginTransactionError::DatabaseResumingException`.
    ...
    /// Returns `true` if the error kind is `BeginTransactionError::InvalidResourceStateException`.
