...
impl BeginTransactionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::begin_transaction::BeginTransaction, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_begin_transaction::ser_begin_transaction_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BeginTransaction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_begin_transaction::de_begin_transaction_http_response_with_props(status, headers, body)
        }
    }
}
