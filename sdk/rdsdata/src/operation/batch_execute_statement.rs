...
impl BatchExecuteStatement {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS Data", "BatchExecuteStatement", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/BatchExecute").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl BatchExecuteStatementError {
    ...
    /// Returns `true` if the error kind is `BatchExecuteStatementError::DatabaseResumingException`.
