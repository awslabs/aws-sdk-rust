...
pub struct RollbackTransactionOutput  {
    ...
    #[doc(hidden)]pub transaction_status: std::option::Option<std::string::String>,
}
...
pub struct ExecuteStatementOutput  {
    ...
    #[doc(hidden)]pub records: std::option::Option<std::vec::Vec<std::vec::Vec<crate::model::Field>>>,
    ...
    #[doc(hidden)]pub column_metadata: std::option::Option<std::vec::Vec<crate::model::ColumnMetadata>>,
    /// <p>The number of records updated by the request.</p>
    #[doc(hidden)]pub number_of_records_updated: i64,
    ...
    /// </note>
    #[doc(hidden)]pub generated_fields: std::option::Option<std::vec::Vec<crate::model::Field>>,
    ...
    #[doc(hidden)]pub formatted_records: std::option::Option<std::string::String>,
}
...
pub struct ExecuteSqlOutput  {
    ...
    #[doc(hidden)]pub sql_statement_results: std::option::Option<std::vec::Vec<crate::model::SqlStatementResult>>,
}
impl ExecuteSqlOutput {
    /// <p>The results of the SQL statement or statements.</p>
    pub fn sql_statement_results(&self) -> std::option::Option<& [crate::model::SqlStatementResult]> {
...
pub mod execute_sql_output {
    ...
    impl Builder {
        ...
        /// <p>The results of the SQL statement or statements.</p>
        pub fn set_sql_statement_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::SqlStatementResult>>) -> Self {
...
pub struct BeginTransactionOutput  {
    ...
    #[doc(hidden)]pub transaction_id: std::option::Option<std::string::String>,
}
...
pub struct BatchExecuteStatementOutput  {
    ...
    #[doc(hidden)]pub update_results: std::option::Option<std::vec::Vec<crate::model::UpdateResult>>,
}
...
pub mod batch_execute_statement_output {
    ...
    impl Builder {
        ...
        /// <p>The execution results of each batch entry.</p>
        pub fn set_update_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::UpdateResult>>) -> Self {
