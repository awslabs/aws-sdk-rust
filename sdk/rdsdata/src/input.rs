...
pub mod begin_transaction_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::BeginTransactionInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl BeginTransactionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::BeginTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::BeginTransactionInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod execute_sql_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ExecuteSqlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ExecuteSqlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ExecuteSql, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ExecuteSqlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod rollback_transaction_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RollbackTransactionInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RollbackTransactionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RollbackTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RollbackTransactionInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
