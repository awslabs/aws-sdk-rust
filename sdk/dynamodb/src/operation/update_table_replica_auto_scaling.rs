...
impl UpdateTableReplicaAutoScalingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_table_replica_auto_scaling::UpdateTableReplicaAutoScaling::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTableReplicaAutoScaling {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_table_replica_auto_scaling::de_update_table_replica_auto_scaling_http_response_with_props(
                status, headers, body,
            )
        }
    }
