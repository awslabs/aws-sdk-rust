...
impl DescribeGlobalTableSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_global_table_settings::DescribeGlobalTableSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGlobalTableSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_global_table_settings::de_describe_global_table_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
