...
impl DescribeExportInput {
    /// Consumes the builder and constructs an Operation<[`DescribeExport`](crate::operation::describe_export::DescribeExport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_export::DescribeExport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_export::DescribeExportInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_export::ser_describe_export_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_export::DescribeExport::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeExport", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeExport {
                type Output = std::result::Result<crate::operation::describe_export::DescribeExportOutput, crate::operation::describe_export::DescribeExportError>;
