...
impl DescribeExportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_export::DescribeExport, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_export::ser_describe_export_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_export::de_describe_export_http_response_with_props(status, headers, body)
        }
    }
}
