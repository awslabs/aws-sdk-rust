...
impl ListBackupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_backups::ListBackups, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_backups::ser_list_backups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBackups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_backups::de_list_backups_http_response_with_props(status, headers, body)
        }
    }
}
