...
/// Paginator for [`Query`](crate::operation::query::Query)
            ...
            impl QueryPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::query::QueryOutput, aws_smithy_http::result::SdkError<crate::operation::query::QueryError>>> + Unpin
                 {
...
/// Flattened paginator for `QueryPaginator`
                ...
                impl  QueryPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<std::collections::HashMap<std::string::String, crate::types::AttributeValue>, aws_smithy_http::result::SdkError<crate::operation::query::QueryError>>> + Unpin
                     {
