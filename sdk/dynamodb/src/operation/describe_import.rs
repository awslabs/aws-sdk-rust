...
impl DescribeImportInput {
    /// Consumes the builder and constructs an Operation<[`DescribeImport`](crate::operation::describe_import::DescribeImport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_import::DescribeImport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_import::DescribeImportInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_import::ser_describe_import_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_import::DescribeImport::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeImport", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeImport {
                type Output = std::result::Result<crate::operation::describe_import::DescribeImportOutput, crate::operation::describe_import::DescribeImportError>;
