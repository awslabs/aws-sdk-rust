...
impl DescribeImportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_import::DescribeImport, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_import::ser_describe_import_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_import::de_describe_import_http_response_with_props(status, headers, body)
        }
    }
}
