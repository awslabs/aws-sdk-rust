...
impl DescribeImportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_import::DescribeImport,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_import::DescribeImport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_import::de_describe_import_http_error(
                status, headers, body,
            )
        } else {
