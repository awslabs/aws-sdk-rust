...
impl ExecuteTransactionInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::execute_transaction::ExecuteTransaction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_transaction::ExecuteTransactionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::execute_transaction::ExecuteTransaction::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExecuteTransaction {
                type Output = std::result::Result<crate::operation::execute_transaction::ExecuteTransactionOutput, crate::operation::execute_transaction::ExecuteTransactionError>;
