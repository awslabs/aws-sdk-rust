...
impl ExecuteTransactionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_transaction::ser_execute_transaction_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteTransaction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_execute_transaction::de_execute_transaction_http_response_with_props(status, headers, body)
        }
    }
}
