...
impl BatchGetItemInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetItem`](crate::operation::batch_get_item::BatchGetItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_item::BatchGetItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_item::BatchGetItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_item::ser_batch_get_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_item::BatchGetItem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchGetItem", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetItem {
                type Output = std::result::Result<crate::operation::batch_get_item::BatchGetItemOutput, crate::operation::batch_get_item::BatchGetItemError>;
