...
impl BatchGetItemInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_item::BatchGetItem::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetItem {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_get_item::de_batch_get_item_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_get_item::de_batch_get_item_http_response_with_props(
                status, headers, body,
            )
        }
    }
