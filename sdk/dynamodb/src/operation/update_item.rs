...
impl UpdateItemInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_item::UpdateItem, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_item::ser_update_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_item::de_update_item_http_response_with_props(status, headers, body)
        }
    }
}
