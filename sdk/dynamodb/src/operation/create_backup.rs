...
impl CreateBackupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_backup::CreateBackup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_backup::ser_create_backup_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_backup::de_create_backup_http_response_with_props(status, headers, body)
        }
    }
}
