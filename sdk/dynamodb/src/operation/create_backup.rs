...
impl CreateBackupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_backup::CreateBackup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_backup::de_create_backup_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_backup::de_create_backup_http_response_with_props(
                status, headers, body,
            )
        }
    }
