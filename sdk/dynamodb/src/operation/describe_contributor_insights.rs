...
impl DescribeContributorInsightsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_contributor_insights::DescribeContributorInsights::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContributorInsights {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_contributor_insights::de_describe_contributor_insights_http_response_with_props(
                status, headers, body,
            )
        }
    }
