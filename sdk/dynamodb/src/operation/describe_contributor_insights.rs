...
impl DescribeContributorInsightsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeContributorInsights`](crate::operation::describe_contributor_insights::DescribeContributorInsights)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_contributor_insights::DescribeContributorInsights, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_contributor_insights::DescribeContributorInsightsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_contributor_insights::ser_describe_contributor_insights_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_contributor_insights::DescribeContributorInsights::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeContributorInsights", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeContributorInsights {
                type Output = std::result::Result<crate::operation::describe_contributor_insights::DescribeContributorInsightsOutput, crate::operation::describe_contributor_insights::DescribeContributorInsightsError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_contributor_insights::DescribeContributorInsightsError {
