...
impl ListTablesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<::std::string::String, ::aws_smithy_http::result::SdkError<crate::operation::list_tables::ListTablesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_tables_output_table_names(page).unwrap_or_default().into_iter())
    }
}
