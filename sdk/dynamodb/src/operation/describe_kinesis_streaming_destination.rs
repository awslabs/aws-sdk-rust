...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeKinesisStreamingDestination {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeKinesisStreamingDestination")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeKinesisStreamingDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeKinesisStreamingDestinationRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeKinesisStreamingDestinationEndpointParamsInterceptor {
