...
impl BatchWriteItemFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_write_item::BatchWriteItemOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_write_item::BatchWriteItemError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_write_item::BatchWriteItemOutput, crate::operation::batch_write_item::BatchWriteItemError, Self> {
    ...
    /// </ul></li>
    /// </ul>
    pub fn get_request_items(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::vec::Vec::<crate::types::WriteRequest>>> {
