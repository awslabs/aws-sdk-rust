...
impl UpdateGlobalTableInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGlobalTable`](crate::operation::update_global_table::UpdateGlobalTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_global_table::UpdateGlobalTable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_global_table::UpdateGlobalTableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_global_table::UpdateGlobalTable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGlobalTable {
                type Output = std::result::Result<crate::operation::update_global_table::UpdateGlobalTableOutput, crate::operation::update_global_table::UpdateGlobalTableError>;
