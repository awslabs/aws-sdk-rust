...
impl UpdateContributorInsightsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_contributor_insights::UpdateContributorInsights::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContributorInsights {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_contributor_insights::de_update_contributor_insights_http_response_with_props(status, headers, body)
        }
    }
}
