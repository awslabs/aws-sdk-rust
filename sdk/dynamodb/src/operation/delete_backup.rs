...
impl DeleteBackupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_backup::DeleteBackup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_backup::ser_delete_backup_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_backup::de_delete_backup_http_response_with_props(status, headers, body)
        }
    }
}
