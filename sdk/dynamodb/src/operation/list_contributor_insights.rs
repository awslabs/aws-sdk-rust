...
impl ListContributorInsightsInput {
    /// Consumes the builder and constructs an Operation<[`ListContributorInsights`](crate::operation::list_contributor_insights::ListContributorInsights)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_contributor_insights::ListContributorInsights, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_contributor_insights::ListContributorInsightsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_contributor_insights::ser_list_contributor_insights_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_contributor_insights::ListContributorInsights::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListContributorInsights", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListContributorInsights {
                type Output = std::result::Result<crate::operation::list_contributor_insights::ListContributorInsightsOutput, crate::operation::list_contributor_insights::ListContributorInsightsError>;
...
impl aws_http::request_id::RequestId for crate::operation::list_contributor_insights::ListContributorInsightsError {
