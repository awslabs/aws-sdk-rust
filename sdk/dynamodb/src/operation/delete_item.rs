...
impl DeleteItemInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_item::DeleteItem::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_item::de_delete_item_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_item::de_delete_item_http_response_with_props(
                status, headers, body,
            )
        }
    }
