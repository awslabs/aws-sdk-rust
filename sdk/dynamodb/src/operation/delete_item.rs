...
impl DeleteItemInput {
    /// Consumes the builder and constructs an Operation<[`DeleteItem`](crate::operation::delete_item::DeleteItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_item::DeleteItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_item::DeleteItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_item::ser_delete_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_item::DeleteItem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteItem", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteItem {
                type Output = std::result::Result<crate::operation::delete_item::DeleteItemOutput, crate::operation::delete_item::DeleteItemError>;
