...
/// Paginator for [`Scan`](crate::operation::scan::Scan)
            ...
            impl ScanPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::scan::ScanOutput, aws_smithy_http::result::SdkError<crate::operation::scan::ScanError>>> + Unpin
                 {
...
/// Flattened paginator for `ScanPaginator`
                ...
                impl  ScanPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<std::collections::HashMap<std::string::String, crate::types::AttributeValue>, aws_smithy_http::result::SdkError<crate::operation::scan::ScanError>>> + Unpin
                     {
