...
/// Paginator for [`Scan`](crate::operation::scan::Scan)
                ...
                impl ScanPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::scan::ScanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::scan::ScanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
...
/// Flattened paginator for `ScanPaginator`
                    ...
                    impl ScanPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<::std::collections::HashMap::<::std::string::String, crate::types::AttributeValue>, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::scan::ScanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_scan_output_output_items(page).unwrap_or_default().into_iter())
                        }
                    }
