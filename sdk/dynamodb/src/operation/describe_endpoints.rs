...
impl DescribeEndpointsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_endpoints::ser_describe_endpoints_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_endpoints::de_describe_endpoints_http_response_with_props(status, headers, body)
        }
    }
}
