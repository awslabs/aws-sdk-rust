...
impl DescribeTableReplicaAutoScalingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScaling::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTableReplicaAutoScaling {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_table_replica_auto_scaling::de_describe_table_replica_auto_scaling_http_response_with_props(
                status, headers, body,
            )
        }
    }
