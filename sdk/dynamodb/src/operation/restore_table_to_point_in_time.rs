...
impl RestoreTableToPointInTimeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_table_to_point_in_time::RestoreTableToPointInTime::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreTableToPointInTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_table_to_point_in_time::de_restore_table_to_point_in_time_http_response_with_props(
                status, headers, body,
            )
        }
    }
