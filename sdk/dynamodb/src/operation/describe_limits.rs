...
impl DescribeLimitsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_limits::DescribeLimits, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_limits::ser_describe_limits_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLimits {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_limits::de_describe_limits_http_response_with_props(status, headers, body)
        }
    }
}
