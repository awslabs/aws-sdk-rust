...
impl CreateGlobalTableInput {
    /// Consumes the builder and constructs an Operation<[`CreateGlobalTable`](crate::operation::create_global_table::CreateGlobalTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_global_table::CreateGlobalTable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_global_table::CreateGlobalTableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_global_table::CreateGlobalTable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGlobalTable {
                type Output = std::result::Result<crate::operation::create_global_table::CreateGlobalTableOutput, crate::operation::create_global_table::CreateGlobalTableError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_global_table::CreateGlobalTableError {
