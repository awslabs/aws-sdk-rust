...
impl TransactWriteItemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_transact_write_items::ser_transact_write_items_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransactWriteItems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_transact_write_items::de_transact_write_items_http_response_with_props(status, headers, body)
        }
    }
}
