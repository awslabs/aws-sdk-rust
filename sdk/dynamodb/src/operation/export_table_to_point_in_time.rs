...
impl ExportTableToPointInTimeInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::export_table_to_point_in_time::ExportTableToPointInTime::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportTableToPointInTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_table_to_point_in_time::de_export_table_to_point_in_time_http_response_with_props(
                status, headers, body,
            )
        }
    }
