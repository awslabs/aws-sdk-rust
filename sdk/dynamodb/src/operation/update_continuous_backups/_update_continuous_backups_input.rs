...
impl UpdateContinuousBackupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_continuous_backups::UpdateContinuousBackupsInput, ::aws_smithy_types::error::operation::BuildError> {
