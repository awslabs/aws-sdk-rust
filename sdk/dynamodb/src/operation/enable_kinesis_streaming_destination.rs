...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableKinesisStreamingDestination {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableKinesisStreamingDestination")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnableKinesisStreamingDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnableKinesisStreamingDestinationRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnableKinesisStreamingDestinationEndpointParamsInterceptor {
