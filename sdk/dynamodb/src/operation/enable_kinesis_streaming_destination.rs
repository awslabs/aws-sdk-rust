...
impl EnableKinesisStreamingDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableKinesisStreamingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_kinesis_streaming_destination::de_enable_kinesis_streaming_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
