...
impl ListGlobalTablesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_global_tables::ser_list_global_tables_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGlobalTables {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_global_tables::de_list_global_tables_http_response_with_props(status, headers, body)
        }
    }
}
