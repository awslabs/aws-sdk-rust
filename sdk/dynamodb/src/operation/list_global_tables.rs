...
impl ListGlobalTablesInput {
    /// Consumes the builder and constructs an Operation<[`ListGlobalTables`](crate::operation::list_global_tables::ListGlobalTables)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_global_tables::ListGlobalTables, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_global_tables::ListGlobalTablesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_global_tables::ser_list_global_tables_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_global_tables::ListGlobalTables::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGlobalTables", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListGlobalTables {
                type Output = std::result::Result<crate::operation::list_global_tables::ListGlobalTablesOutput, crate::operation::list_global_tables::ListGlobalTablesError>;
