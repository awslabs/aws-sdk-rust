...
impl PutItemInput {
    /// Consumes the builder and constructs an Operation<[`PutItem`](crate::operation::put_item::PutItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_item::PutItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_item::PutItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_item::ser_put_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_item::PutItem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutItem", "dynamodb"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutItem {
                type Output = std::result::Result<crate::operation::put_item::PutItemOutput, crate::operation::put_item::PutItemError>;
