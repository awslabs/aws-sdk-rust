...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExecuteStatementTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("Statement") {
            if let ::std::option::Option::Some(value) = input.statement.as_deref() {
                captured.insert("Statement", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteStatementResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_execute_statement::de_execute_statement_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_execute_statement::de_execute_statement_http_response(status, headers, body, _cfg)
        };
