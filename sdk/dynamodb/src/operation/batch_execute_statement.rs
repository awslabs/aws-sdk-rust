...
impl BatchExecuteStatementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_execute_statement::BatchExecuteStatement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchExecuteStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_execute_statement::de_batch_execute_statement_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_execute_statement::BatchExecuteStatementError
{
