...
impl BatchWriteItemInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_write_item::BatchWriteItem, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_write_item::ser_batch_write_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchWriteItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_write_item::de_batch_write_item_http_response_with_props(status, headers, body)
        }
    }
}
