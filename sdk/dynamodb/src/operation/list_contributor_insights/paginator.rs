...
/// Paginator for [`ListContributorInsights`](crate::operation::list_contributor_insights::ListContributorInsights)
            ...
            impl ListContributorInsightsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_contributor_insights::ListContributorInsightsOutput, aws_smithy_http::result::SdkError<crate::operation::list_contributor_insights::ListContributorInsightsError>>> + Unpin
                 {
