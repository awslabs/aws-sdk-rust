...
impl<C, M, R> ListContributorInsightsPaginator<C, M, R>
where
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_token = crate::lens::reflens_structure_crate_output_list_contributor_insights_output_next_token(resp).cloned();
...
impl<C, M, R> QueryPaginator<C, M, R>
where
    C: aws_smithy_client::bounds::SmithyConnector,
    M: aws_smithy_client::bounds::SmithyMiddleware<C>,
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    /// are dispatched lazily.
    pub fn items(self) -> crate::paginator::QueryPaginatorItems<C, M, R> {
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.exclusive_start_key = crate::lens::reflens_structure_crate_output_query_output_last_evaluated_key(resp).cloned();
                            input.exclusive_start_key.is_none()
                        }
                        Err(_) => true,
                    };
                    if tx.send(resp).await.is_err() {
...
impl<C, M, R> ScanPaginator<C, M, R>
where
    C: aws_smithy_client::bounds::SmithyConnector,
    M: aws_smithy_client::bounds::SmithyMiddleware<C>,
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    /// This paginator automatically flattens results using `items`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::paginator::ScanPaginatorItems<C, M, R> {
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.exclusive_start_key = crate::lens::reflens_structure_crate_output_scan_output_last_evaluated_key(resp).cloned();
                            input.exclusive_start_key.is_none()
                        }
                        Err(_) => true,
                    };
...
pub struct QueryPaginatorItems<
    C = aws_smithy_client::erase::DynConnector,
    M = crate::middleware::DefaultMiddleware,
    R = aws_smithy_client::retry::Standard,
>(QueryPaginator<C, M, R>);

impl<C, M, R> QueryPaginatorItems<C, M, R>
where
    C: aws_smithy_client::bounds::SmithyConnector,
    M: aws_smithy_client::bounds::SmithyMiddleware<C>,
    R: aws_smithy_client::retry::NewRequestPolicy,
...
pub struct ScanPaginatorItems<
    C = aws_smithy_client::erase::DynConnector,
    M = crate::middleware::DefaultMiddleware,
    R = aws_smithy_client::retry::Standard,
>(ScanPaginator<C, M, R>);

impl<C, M, R> ScanPaginatorItems<C, M, R>
where
    C: aws_smithy_client::bounds::SmithyConnector,
    M: aws_smithy_client::bounds::SmithyMiddleware<C>,
    R: aws_smithy_client::retry::NewRequestPolicy,
