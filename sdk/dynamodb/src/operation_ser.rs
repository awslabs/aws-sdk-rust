...
pub fn serialize_operation_crate_operation_describe_import(
...
pub fn serialize_operation_crate_operation_import_table(
...
pub fn serialize_operation_crate_operation_transact_write_items(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_transact_write_items_input(
        &mut object,
        input,
    )?;
    object.finish();
