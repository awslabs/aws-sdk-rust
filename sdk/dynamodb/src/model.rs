...
pub struct TableAutoScalingDescription  {
    ...
    /// </ul>
    #[doc(hidden)]pub table_status: std::option::Option<crate::model::TableStatus>,
    /// <p>Represents replicas of the global table.</p>
    #[doc(hidden)]pub replicas: std::option::Option<std::vec::Vec<crate::model::ReplicaAutoScalingDescription>>,
}
...
pub mod table_auto_scaling_description {
    ...
    pub struct Builder {
        ...
        pub(crate) replicas: std::option::Option<std::vec::Vec<crate::model::ReplicaAutoScalingDescription>>,
    }
    impl Builder {
        /// <p>The name of the table.</p>
        ...
        /// <li> <p> <code>ACTIVE</code> - The table is ready for use.</p> </li> 
        /// </ul>
        pub fn set_table_status(mut self, input: std::option::Option<crate::model::TableStatus>) -> Self {
        ...
        /// <p>Represents replicas of the global table.</p>
        pub fn set_replicas(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaAutoScalingDescription>>) -> Self {
...
pub struct ReplicaAutoScalingDescription  {
    ...
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingDescription>>,
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    #[doc(hidden)]pub replica_provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    #[doc(hidden)]pub replica_provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    ...
    /// </ul>
    #[doc(hidden)]pub replica_status: std::option::Option<crate::model::ReplicaStatus>,
}
impl ReplicaAutoScalingDescription {
    ...
    /// <p>Replica-specific global secondary index auto scaling settings.</p>
    pub fn global_secondary_indexes(&self) -> std::option::Option<& [crate::model::ReplicaGlobalSecondaryIndexAutoScalingDescription]> {
        self.global_secondary_indexes.as_deref()
    }
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings(&self) -> std::option::Option<& crate::model::AutoScalingSettingsDescription> {
        self.replica_provisioned_read_capacity_auto_scaling_settings.as_ref()
    }
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn replica_provisioned_write_capacity_auto_scaling_settings(&self) -> std::option::Option<& crate::model::AutoScalingSettingsDescription> {
...
impl  std::fmt::Debug for ReplicaAutoScalingDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replica_provisioned_read_capacity_auto_scaling_settings", &self.replica_provisioned_read_capacity_auto_scaling_settings);
        formatter.field("replica_provisioned_write_capacity_auto_scaling_settings", &self.replica_provisioned_write_capacity_auto_scaling_settings);
...
pub mod replica_auto_scaling_description {
    ...
    pub struct Builder {
        ...
        pub(crate) global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingDescription>>,
        pub(crate) replica_provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
        pub(crate) replica_provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    ...
    impl Builder {
        ...
        ///
        /// <p>Replica-specific global secondary index auto scaling settings.</p>
        pub fn global_secondary_indexes(mut self, input: crate::model::ReplicaGlobalSecondaryIndexAutoScalingDescription) -> Self {
        ...
        /// <p>Replica-specific global secondary index auto scaling settings.</p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingDescription>>) -> Self {
            self.global_secondary_indexes = input; self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn replica_provisioned_read_capacity_auto_scaling_settings(mut self, input: crate::model::AutoScalingSettingsDescription) -> Self {
            self.replica_provisioned_read_capacity_auto_scaling_settings = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn set_replica_provisioned_read_capacity_auto_scaling_settings(mut self, input: std::option::Option<crate::model::AutoScalingSettingsDescription>) -> Self {
            self.replica_provisioned_read_capacity_auto_scaling_settings = input; self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn replica_provisioned_write_capacity_auto_scaling_settings(mut self, input: crate::model::AutoScalingSettingsDescription) -> Self {
            self.replica_provisioned_write_capacity_auto_scaling_settings = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn set_replica_provisioned_write_capacity_auto_scaling_settings(mut self, input: std::option::Option<crate::model::AutoScalingSettingsDescription>) -> Self {
        ...
        /// <li> <p> <code>ACTIVE</code> - The replica is ready for use.</p> </li> 
        /// </ul>
        pub fn set_replica_status(mut self, input: std::option::Option<crate::model::ReplicaStatus>) -> Self {
...
pub struct AutoScalingSettingsDescription  {
    ...
    #[doc(hidden)]pub minimum_units: std::option::Option<i64>,
    /// <p>The maximum capacity units that a global table or global secondary index should be scaled up to.</p>
    #[doc(hidden)]pub maximum_units: std::option::Option<i64>,
    /// <p>Disabled auto scaling for this global table or global secondary index.</p>
    #[doc(hidden)]pub auto_scaling_disabled: std::option::Option<bool>,
    /// <p>Role ARN used for configuring the auto scaling policy.</p>
    #[doc(hidden)]pub auto_scaling_role_arn: std::option::Option<std::string::String>,
    /// <p>Information about the scaling policies.</p>
    #[doc(hidden)]pub scaling_policies: std::option::Option<std::vec::Vec<crate::model::AutoScalingPolicyDescription>>,
}
impl AutoScalingSettingsDescription {
    ...
    /// <p>Information about the scaling policies.</p>
    pub fn scaling_policies(&self) -> std::option::Option<& [crate::model::AutoScalingPolicyDescription]> {
...
pub mod auto_scaling_settings_description {
    ...
    pub struct Builder {
        ...
        pub(crate) scaling_policies: std::option::Option<std::vec::Vec<crate::model::AutoScalingPolicyDescription>>,
    }
    impl Builder {
        /// <p>The minimum capacity units that a global table or global secondary index should be scaled down to.</p>
        ...
        ///
        /// <p>Information about the scaling policies.</p>
        pub fn scaling_policies(mut self, input: crate::model::AutoScalingPolicyDescription) -> Self {
        ...
        /// <p>Information about the scaling policies.</p>
        pub fn set_scaling_policies(mut self, input: std::option::Option<std::vec::Vec<crate::model::AutoScalingPolicyDescription>>) -> Self {
...
pub struct AutoScalingPolicyDescription  {
    ...
    #[doc(hidden)]pub target_tracking_scaling_policy_configuration: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription>,
}
impl AutoScalingPolicyDescription {
    ...
    /// <p>Represents a target tracking scaling policy configuration.</p>
    pub fn target_tracking_scaling_policy_configuration(&self) -> std::option::Option<& crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription> {
...
pub mod auto_scaling_policy_description {
    ...
    pub struct Builder {
        ...
        pub(crate) target_tracking_scaling_policy_configuration: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription>,
    }
    impl Builder {
        /// <p>The name of the scaling policy.</p>
        ...
        /// <p>Represents a target tracking scaling policy configuration.</p>
        pub fn target_tracking_scaling_policy_configuration(mut self, input: crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription) -> Self {
            self.target_tracking_scaling_policy_configuration = Some(input);
            self
        }
        /// <p>Represents a target tracking scaling policy configuration.</p>
        pub fn set_target_tracking_scaling_policy_configuration(mut self, input: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription>) -> Self {
...
pub struct AutoScalingTargetTrackingScalingPolicyConfigurationDescription  {
    ...
    #[doc(hidden)]pub scale_in_cooldown: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub scale_out_cooldown: std::option::Option<i32>,
...
impl  std::fmt::Debug for AutoScalingTargetTrackingScalingPolicyConfigurationDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AutoScalingTargetTrackingScalingPolicyConfigurationDescription");
...
pub mod auto_scaling_target_tracking_scaling_policy_configuration_description {
    ...
    impl Builder {
        ...
        pub fn build(self) -> crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationDescription {
...
pub struct ReplicaGlobalSecondaryIndexAutoScalingDescription  {
    ...
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    #[doc(hidden)]pub provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    #[doc(hidden)]pub provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingDescription {
    ...
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings(&self) -> std::option::Option<& crate::model::AutoScalingSettingsDescription> {
        self.provisioned_read_capacity_auto_scaling_settings.as_ref()
    }
    /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings(&self) -> std::option::Option<& crate::model::AutoScalingSettingsDescription> {
...
impl  std::fmt::Debug for ReplicaGlobalSecondaryIndexAutoScalingDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("provisioned_read_capacity_auto_scaling_settings", &self.provisioned_read_capacity_auto_scaling_settings);
        formatter.field("provisioned_write_capacity_auto_scaling_settings", &self.provisioned_write_capacity_auto_scaling_settings);
        formatter.finish()
    }
}
...
pub mod replica_global_secondary_index_auto_scaling_description {
    ...
    pub struct Builder {
        ...
        pub(crate) provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
        pub(crate) provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    }
    impl Builder {
        /// <p>The name of the global secondary index.</p>
        ...
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn provisioned_read_capacity_auto_scaling_settings(mut self, input: crate::model::AutoScalingSettingsDescription) -> Self {
            self.provisioned_read_capacity_auto_scaling_settings = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn set_provisioned_read_capacity_auto_scaling_settings(mut self, input: std::option::Option<crate::model::AutoScalingSettingsDescription>) -> Self {
            self.provisioned_read_capacity_auto_scaling_settings = input; self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn provisioned_write_capacity_auto_scaling_settings(mut self, input: crate::model::AutoScalingSettingsDescription) -> Self {
            self.provisioned_write_capacity_auto_scaling_settings = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings for a global table or global secondary index.</p>
        pub fn set_provisioned_write_capacity_auto_scaling_settings(mut self, input: std::option::Option<crate::model::AutoScalingSettingsDescription>) -> Self {
...
pub struct ReplicaAutoScalingUpdate  {
    ...
    #[doc(hidden)]pub replica_global_secondary_index_updates: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>,
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    #[doc(hidden)]pub replica_provisioned_read_capacity_auto_scaling_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
}
impl ReplicaAutoScalingUpdate {
    ...
    /// <p>Represents the auto scaling settings of global secondary indexes that will be modified.</p>
    pub fn replica_global_secondary_index_updates(&self) -> std::option::Option<& [crate::model::ReplicaGlobalSecondaryIndexAutoScalingUpdate]> {
        self.replica_global_secondary_index_updates.as_deref()
    }
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_update(&self) -> std::option::Option<& crate::model::AutoScalingSettingsUpdate> {
...
impl  std::fmt::Debug for ReplicaAutoScalingUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("region_name", &self.region_name);
        formatter.field("replica_global_secondary_index_updates", &self.replica_global_secondary_index_updates);
        formatter.field("replica_provisioned_read_capacity_auto_scaling_update", &self.replica_provisioned_read_capacity_auto_scaling_update);
        formatter.finish()
    }
}
...
pub mod replica_auto_scaling_update {
    ...
    pub struct Builder {
        pub(crate) region_name: std::option::Option<std::string::String>,
        pub(crate) replica_global_secondary_index_updates: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>,
        pub(crate) replica_provisioned_read_capacity_auto_scaling_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
    }
    impl Builder {
        /// <p>The Region where the replica exists.</p>
        pub fn region_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        ///
        /// <p>Represents the auto scaling settings of global secondary indexes that will be modified.</p>
        pub fn replica_global_secondary_index_updates(mut self, input: crate::model::ReplicaGlobalSecondaryIndexAutoScalingUpdate) -> Self {
        ...
        /// <p>Represents the auto scaling settings of global secondary indexes that will be modified.</p>
        pub fn set_replica_global_secondary_index_updates(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexAutoScalingUpdate>>) -> Self {
            self.replica_global_secondary_index_updates = input; self
        }
        /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
        pub fn replica_provisioned_read_capacity_auto_scaling_update(mut self, input: crate::model::AutoScalingSettingsUpdate) -> Self {
            self.replica_provisioned_read_capacity_auto_scaling_update = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
        pub fn set_replica_provisioned_read_capacity_auto_scaling_update(mut self, input: std::option::Option<crate::model::AutoScalingSettingsUpdate>) -> Self {
...
pub struct AutoScalingSettingsUpdate  {
    ...
    #[doc(hidden)]pub scaling_policy_update: std::option::Option<crate::model::AutoScalingPolicyUpdate>,
}
impl AutoScalingSettingsUpdate {
    ...
    /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
    pub fn scaling_policy_update(&self) -> std::option::Option<& crate::model::AutoScalingPolicyUpdate> {
...
pub mod auto_scaling_settings_update {
    ...
    pub struct Builder {
        ...
        pub(crate) auto_scaling_disabled: std::option::Option<bool>,
        pub(crate) auto_scaling_role_arn: std::option::Option<std::string::String>,
        pub(crate) scaling_policy_update: std::option::Option<crate::model::AutoScalingPolicyUpdate>,
    }
    impl Builder {
        /// <p>The minimum capacity units that a global table or global secondary index should be scaled down to.</p>
        pub fn minimum_units(mut self, input: i64) -> Self {
        ...
        /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
        pub fn scaling_policy_update(mut self, input: crate::model::AutoScalingPolicyUpdate) -> Self {
            self.scaling_policy_update = Some(input);
            self
        }
        /// <p>The scaling policy to apply for scaling target global table or global secondary index capacity units.</p>
        pub fn set_scaling_policy_update(mut self, input: std::option::Option<crate::model::AutoScalingPolicyUpdate>) -> Self {
...
pub struct AutoScalingPolicyUpdate  {
    ...
    #[doc(hidden)]pub policy_name: std::option::Option<std::string::String>,
    /// <p>Represents a target tracking scaling policy configuration.</p>
    #[doc(hidden)]pub target_tracking_scaling_policy_configuration: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate>,
}
impl AutoScalingPolicyUpdate {
    ...
    /// <p>Represents a target tracking scaling policy configuration.</p>
    pub fn target_tracking_scaling_policy_configuration(&self) -> std::option::Option<& crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate> {
        self.target_tracking_scaling_policy_configuration.as_ref()
    }
}
...
pub mod auto_scaling_policy_update {
    ...
    pub struct Builder {
        pub(crate) policy_name: std::option::Option<std::string::String>,
        pub(crate) target_tracking_scaling_policy_configuration: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate>,
    }
    impl Builder {
        /// <p>The name of the scaling policy.</p>
        pub fn policy_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Represents a target tracking scaling policy configuration.</p>
        pub fn target_tracking_scaling_policy_configuration(mut self, input: crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate) -> Self {
            self.target_tracking_scaling_policy_configuration = Some(input);
            self
        }
        /// <p>Represents a target tracking scaling policy configuration.</p>
        pub fn set_target_tracking_scaling_policy_configuration(mut self, input: std::option::Option<crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate>) -> Self {
            self.target_tracking_scaling_policy_configuration = input; self
        }
...
impl  std::fmt::Debug for AutoScalingTargetTrackingScalingPolicyConfigurationUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("AutoScalingTargetTrackingScalingPolicyConfigurationUpdate");
        formatter.field("disable_scale_in", &self.disable_scale_in);
        formatter.field("scale_in_cooldown", &self.scale_in_cooldown);
        formatter.field("scale_out_cooldown", &self.scale_out_cooldown);
        formatter.field("target_value", &self.target_value);
...
pub mod auto_scaling_target_tracking_scaling_policy_configuration_update {
    ...
    impl Builder {
        ...
        pub fn build(self) -> crate::model::AutoScalingTargetTrackingScalingPolicyConfigurationUpdate {
...
pub struct ReplicaGlobalSecondaryIndexAutoScalingUpdate  {
    ...
    #[doc(hidden)]pub index_name: std::option::Option<std::string::String>,
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    #[doc(hidden)]pub provisioned_read_capacity_auto_scaling_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexAutoScalingUpdate {
    ...
    /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
    pub fn provisioned_read_capacity_auto_scaling_update(&self) -> std::option::Option<& crate::model::AutoScalingSettingsUpdate> {
...
impl  std::fmt::Debug for ReplicaGlobalSecondaryIndexAutoScalingUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("index_name", &self.index_name);
        formatter.field("provisioned_read_capacity_auto_scaling_update", &self.provisioned_read_capacity_auto_scaling_update);
        formatter.finish()
    }
}
...
pub mod replica_global_secondary_index_auto_scaling_update {
    ...
    pub struct Builder {
        pub(crate) index_name: std::option::Option<std::string::String>,
        pub(crate) provisioned_read_capacity_auto_scaling_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
    }
    impl Builder {
        /// <p>The name of the global secondary index.</p>
        pub fn index_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
        pub fn provisioned_read_capacity_auto_scaling_update(mut self, input: crate::model::AutoScalingSettingsUpdate) -> Self {
            self.provisioned_read_capacity_auto_scaling_update = Some(input);
            self
        }
        /// <p>Represents the auto scaling settings to be modified for a global table or global secondary index.</p>
        pub fn set_provisioned_read_capacity_auto_scaling_update(mut self, input: std::option::Option<crate::model::AutoScalingSettingsUpdate>) -> Self {
...
pub struct TableDescription  {
    ...
    #[doc(hidden)]pub provisioned_throughput: std::option::Option<crate::model::ProvisionedThroughputDescription>,
    ...
    #[doc(hidden)]pub table_size_bytes: i64,
    ...
    #[doc(hidden)]pub billing_mode_summary: std::option::Option<crate::model::BillingModeSummary>,
    ...
    #[doc(hidden)]pub local_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::LocalSecondaryIndexDescription>>,
    ...
    /// </ul> 
    /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::GlobalSecondaryIndexDescription>>,
    ...
    /// </ul>
    #[doc(hidden)]pub latest_stream_label: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) that uniquely identifies the latest stream for this table.</p>
    #[doc(hidden)]pub latest_stream_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub global_table_version: std::option::Option<std::string::String>,
    /// <p>Represents replicas of the table.</p>
    #[doc(hidden)]pub replicas: std::option::Option<std::vec::Vec<crate::model::ReplicaDescription>>,
    /// <p>Contains details for the restore.</p>
    #[doc(hidden)]pub restore_summary: std::option::Option<crate::model::RestoreSummary>,
    /// <p>The description of the server-side encryption status on the specified table.</p>
    #[doc(hidden)]pub sse_description: std::option::Option<crate::model::SseDescription>,
    /// <p>Contains information about the table archive.</p>
    #[doc(hidden)]pub archival_summary: std::option::Option<crate::model::ArchivalSummary>,
    /// <p>Contains details of the table class.</p>
    #[doc(hidden)]pub table_class_summary: std::option::Option<crate::model::TableClassSummary>,
}
...
pub mod table_description {
    ...
    impl Builder {
        ...
        /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
        pub fn provisioned_throughput(mut self, input: crate::model::ProvisionedThroughputDescription) -> Self {
            self.provisioned_throughput = Some(input);
            self
        }
        /// <p>The provisioned throughput settings for the table, consisting of read and write capacity units, along with data about increases and decreases.</p>
        pub fn set_provisioned_throughput(mut self, input: std::option::Option<crate::model::ProvisionedThroughputDescription>) -> Self {
        ...
        /// <p>Contains the details for the read/write capacity mode.</p>
        pub fn set_billing_mode_summary(mut self, input: std::option::Option<crate::model::BillingModeSummary>) -> Self {
        ...
        /// </ul> 
        /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
        pub fn local_secondary_indexes(mut self, input: crate::model::LocalSecondaryIndexDescription) -> Self {
        ...
        /// </ul> 
        /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
        pub fn set_local_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::LocalSecondaryIndexDescription>>) -> Self {
        ...
        /// </ul> 
        /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
        pub fn global_secondary_indexes(mut self, input: crate::model::GlobalSecondaryIndexDescription) -> Self {
            let mut v = self.global_secondary_indexes.unwrap_or_default();
                            v.push(input);
                            self.global_secondary_indexes = Some(v);
                            self
        ...
        /// </ul> 
        /// <p>If the table is in the <code>DELETING</code> state, no information about indexes will be returned.</p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::GlobalSecondaryIndexDescription>>) -> Self {
            self.global_secondary_indexes = input; self
        }
        /// <p>The current DynamoDB Streams configuration for the table.</p>
        ...
        /// <p>Represents replicas of the table.</p>
        pub fn set_replicas(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaDescription>>) -> Self {
            self.replicas = input; self
        }
        /// <p>Contains details for the restore.</p>
        ...
        /// <p>Contains details for the restore.</p>
        pub fn set_restore_summary(mut self, input: std::option::Option<crate::model::RestoreSummary>) -> Self {
        ...
        /// <p>Contains information about the table archive.</p>
        pub fn set_archival_summary(mut self, input: std::option::Option<crate::model::ArchivalSummary>) -> Self {
        ...
        /// <p>Contains details of the table class.</p>
        pub fn set_table_class_summary(mut self, input: std::option::Option<crate::model::TableClassSummary>) -> Self {
...
pub struct TableClassSummary  {
    ...
    #[doc(hidden)]pub last_update_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct ArchivalSummary  {
    ...
    #[doc(hidden)]pub archival_date_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </ul>
    #[doc(hidden)]pub archival_reason: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub archival_backup_arn: std::option::Option<std::string::String>,
}
...
pub struct SseDescription  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::SseStatus>,
    ...
    /// </ul>
    #[doc(hidden)]pub sse_type: std::option::Option<crate::model::SseType>,
    ...
    #[doc(hidden)]pub inaccessible_encryption_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl SseDescription {
    /// <p>Represents the current state of server-side encryption. The only supported values are:</p> 
    /// <ul> 
...
impl  std::fmt::Debug for SseDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("inaccessible_encryption_date_time", &self.inaccessible_encryption_date_time);
        formatter.finish()
    }
}
...
pub struct RestoreSummary  {
    ...
    #[doc(hidden)]pub source_backup_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub restore_in_progress: std::option::Option<bool>,
}
impl RestoreSummary {
    /// <p>The Amazon Resource Name (ARN) of the backup from which the table was restored.</p>
...
pub struct ReplicaDescription  {
    ...
    #[doc(hidden)]pub replica_status_description: std::option::Option<std::string::String>,
    /// <p>Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.</p>
    #[doc(hidden)]pub replica_status_percent_progress: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub provisioned_throughput_override: std::option::Option<crate::model::ProvisionedThroughputOverride>,
    /// <p>Replica-specific global secondary index settings.</p>
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexDescription>>,
    ...
    #[doc(hidden)]pub replica_inaccessible_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Contains details of the table class.</p>
    #[doc(hidden)]pub replica_table_class_summary: std::option::Option<crate::model::TableClassSummary>,
}
impl ReplicaDescription {
    ...
    /// <p>Contains details of the table class.</p>
    pub fn replica_table_class_summary(&self) -> std::option::Option<& crate::model::TableClassSummary> {
...
impl  std::fmt::Debug for ReplicaDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("region_name", &self.region_name);
        formatter.field("replica_status", &self.replica_status);
        formatter.field("replica_status_description", &self.replica_status_description);
        formatter.field("replica_status_percent_progress", &self.replica_status_percent_progress);
        ...
        formatter.field("global_secondary_indexes", &self.global_secondary_indexes);
        formatter.field("replica_inaccessible_date_time", &self.replica_inaccessible_date_time);
        formatter.field("replica_table_class_summary", &self.replica_table_class_summary);
        formatter.finish()
    }
}
...
pub mod replica_description {
    ...
    pub struct Builder {
        ...
        pub(crate) replica_table_class_summary: std::option::Option<crate::model::TableClassSummary>,
    }
    impl Builder {
        /// <p>The name of the Region.</p>
        pub fn region_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
        pub fn provisioned_throughput_override(mut self, input: crate::model::ProvisionedThroughputOverride) -> Self {
            self.provisioned_throughput_override = Some(input);
            self
        }
        /// <p>Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.</p>
        pub fn set_provisioned_throughput_override(mut self, input: std::option::Option<crate::model::ProvisionedThroughputOverride>) -> Self {
        ...
        ///
        /// <p>Replica-specific global secondary index settings.</p>
        pub fn global_secondary_indexes(mut self, input: crate::model::ReplicaGlobalSecondaryIndexDescription) -> Self {
            let mut v = self.global_secondary_indexes.unwrap_or_default();
                            v.push(input);
                            self.global_secondary_indexes = Some(v);
                            self
        ...
        /// <p>Replica-specific global secondary index settings.</p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexDescription>>) -> Self {
            self.global_secondary_indexes = input; self
        }
        /// <p>The time at which the replica was first detected as inaccessible. To determine cause of inaccessibility check the <code>ReplicaStatus</code> property.</p>
        ...
        /// <p>Contains details of the table class.</p>
        pub fn replica_table_class_summary(mut self, input: crate::model::TableClassSummary) -> Self {
            self.replica_table_class_summary = Some(input);
            self
        }
        /// <p>Contains details of the table class.</p>
        pub fn set_replica_table_class_summary(mut self, input: std::option::Option<crate::model::TableClassSummary>) -> Self {
...
pub struct StreamSpecification  {
    ...
    #[doc(hidden)]pub stream_enabled: std::option::Option<bool>,
    ...
    /// </ul>
    #[doc(hidden)]pub stream_view_type: std::option::Option<crate::model::StreamViewType>,
}
...
pub mod stream_specification {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>NEW_AND_OLD_IMAGES</code> - Both the new and the old item images of the item are written to the stream.</p> </li> 
        /// </ul>
        pub fn set_stream_view_type(mut self, input: std::option::Option<crate::model::StreamViewType>) -> Self {
...
pub struct GlobalSecondaryIndexDescription  {
    ...
    #[doc(hidden)]pub projection: std::option::Option<crate::model::Projection>,
    ...
    /// </note>
    #[doc(hidden)]pub backfilling: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub index_size_bytes: i64,
    ...
    #[doc(hidden)]pub index_arn: std::option::Option<std::string::String>,
}
...
pub mod global_secondary_index_description {
    ...
    impl Builder {
        ...
        /// <p>Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected. </p>
        pub fn set_projection(mut self, input: std::option::Option<crate::model::Projection>) -> Self {
...
pub struct ProvisionedThroughputDescription  {
    ...
    #[doc(hidden)]pub last_increase_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time of the last provisioned throughput decrease for this table.</p>
    #[doc(hidden)]pub last_decrease_date_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub number_of_decreases_today: std::option::Option<i64>,
...
pub struct Projection  {
    ...
    /// <li> <p> <code>ALL</code> - All of the table attributes are projected into the index.</p> </li> 
    /// </ul>
    #[doc(hidden)]pub projection_type: std::option::Option<crate::model::ProjectionType>,
    ...
    #[doc(hidden)]pub non_key_attributes: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Projection {
    /// <p>The set of attributes that are projected into the index:</p> 
    /// <ul> 
...
pub mod projection {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>ALL</code> - All of the table attributes are projected into the index.</p> </li> 
        /// </ul>
        pub fn set_projection_type(mut self, input: std::option::Option<crate::model::ProjectionType>) -> Self {
...
pub struct KeySchemaElement  {
    ...
    /// <p>The sort key of an item is also known as its <i>range attribute</i>. The term "range attribute" derives from the way DynamoDB stores items with the same partition key physically close together, in sorted order by the sort key value.</p> 
    /// </note>
    #[doc(hidden)]pub key_type: std::option::Option<crate::model::KeyType>,
}
...
pub struct BillingModeSummary  {
    ...
    #[doc(hidden)]pub last_update_to_pay_per_request_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
impl  std::fmt::Debug for BillingModeSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_update_to_pay_per_request_date_time", &self.last_update_to_pay_per_request_date_time);
        formatter.finish()
    }
}
...
pub struct AttributeDefinition  {
    ...
    /// </ul>
    #[doc(hidden)]pub attribute_type: std::option::Option<crate::model::ScalarAttributeType>,
}
...
pub mod attribute_definition {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>B</code> - the attribute is of type Binary</p> </li> 
        /// </ul>
        pub fn set_attribute_type(mut self, input: std::option::Option<crate::model::ScalarAttributeType>) -> Self {
...
pub struct ReplicationGroupUpdate  {
    ...
    #[doc(hidden)]pub create: std::option::Option<crate::model::CreateReplicationGroupMemberAction>,
    /// <p>The parameters required for updating a replica for the table.</p>
    #[doc(hidden)]pub update: std::option::Option<crate::model::UpdateReplicationGroupMemberAction>,
    /// <p>The parameters required for deleting a replica for the table.</p>
    #[doc(hidden)]pub delete: std::option::Option<crate::model::DeleteReplicationGroupMemberAction>,
}
...
pub mod replication_group_update {
    ...
    impl Builder {
        ...
        /// <p>The parameters required for creating a replica for the table.</p>
        pub fn set_create(mut self, input: std::option::Option<crate::model::CreateReplicationGroupMemberAction>) -> Self {
        ...
        /// <p>The parameters required for updating a replica for the table.</p>
        pub fn set_update(mut self, input: std::option::Option<crate::model::UpdateReplicationGroupMemberAction>) -> Self {
        ...
        /// <p>The parameters required for deleting a replica for the table.</p>
        pub fn set_delete(mut self, input: std::option::Option<crate::model::DeleteReplicationGroupMemberAction>) -> Self {
...
pub struct UpdateReplicationGroupMemberAction  {
    ...
    #[doc(hidden)]pub provisioned_throughput_override: std::option::Option<crate::model::ProvisionedThroughputOverride>,
    /// <p>Replica-specific global secondary index settings.</p>
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndex>>,
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    #[doc(hidden)]pub table_class_override: std::option::Option<crate::model::TableClass>,
}
impl UpdateReplicationGroupMemberAction {
    ...
    /// <p>Replica-specific global secondary index settings.</p>
    pub fn global_secondary_indexes(&self) -> std::option::Option<& [crate::model::ReplicaGlobalSecondaryIndex]> {
        self.global_secondary_indexes.as_deref()
    }
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
...
pub mod update_replication_group_member_action {
    ...
    pub struct Builder {
        ...
        pub(crate) kms_master_key_id: std::option::Option<std::string::String>,
        pub(crate) provisioned_throughput_override: std::option::Option<crate::model::ProvisionedThroughputOverride>,
        pub(crate) global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndex>>,
    ...
    impl Builder {
        ...
        ///
        /// <p>Replica-specific global secondary index settings.</p>
        pub fn global_secondary_indexes(mut self, input: crate::model::ReplicaGlobalSecondaryIndex) -> Self {
            let mut v = self.global_secondary_indexes.unwrap_or_default();
                            v.push(input);
                            self.global_secondary_indexes = Some(v);
                            self
        ...
        /// <p>Replica-specific global secondary index settings.</p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndex>>) -> Self {
            self.global_secondary_indexes = input; self
        }
        /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
        ...
        /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
        pub fn set_table_class_override(mut self, input: std::option::Option<crate::model::TableClass>) -> Self {
...
pub struct GlobalSecondaryIndexUpdate  {
    ...
    #[doc(hidden)]pub update: std::option::Option<crate::model::UpdateGlobalSecondaryIndexAction>,
    ...
    /// </ul>
    #[doc(hidden)]pub create: std::option::Option<crate::model::CreateGlobalSecondaryIndexAction>,
    /// <p>The name of an existing global secondary index to be removed.</p>
    #[doc(hidden)]pub delete: std::option::Option<crate::model::DeleteGlobalSecondaryIndexAction>,
}
...
pub mod global_secondary_index_update {
    ...
    impl Builder {
        ...
        /// <p>The name of an existing global secondary index, along with new provisioned throughput settings to be applied to that index.</p>
        pub fn set_update(mut self, input: std::option::Option<crate::model::UpdateGlobalSecondaryIndexAction>) -> Self {
            self.update = input; self
        }
        /// <p>The parameters required for creating a global secondary index on an existing table:</p> 
        /// <ul> 
        ...
        /// <li> <p> <code>ProvisionedThroughput </code> </p> </li> 
        /// </ul>
        pub fn set_create(mut self, input: std::option::Option<crate::model::CreateGlobalSecondaryIndexAction>) -> Self {
            self.create = input; self
        }
        /// <p>The name of an existing global secondary index to be removed.</p>
        ...
        /// <p>The name of an existing global secondary index to be removed.</p>
        pub fn set_delete(mut self, input: std::option::Option<crate::model::DeleteGlobalSecondaryIndexAction>) -> Self {
            self.delete = input; self
        }
...
pub struct ItemCollectionMetrics  {
    ...
    #[doc(hidden)]pub item_collection_key: std::option::Option<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>,
    ...
    #[doc(hidden)]pub size_estimate_range_gb: std::option::Option<std::vec::Vec<f64>>,
}
...
pub mod item_collection_metrics {
    ...
    impl Builder {
        ...
        ///
        /// <p>The partition key value of the item collection. This value is the same as the partition key value of the item.</p>
        pub fn item_collection_key(mut self, k: impl Into<std::string::String>, v: crate::model::AttributeValue) -> Self {
        ...
        /// <p>The partition key value of the item collection. This value is the same as the partition key value of the item.</p>
        pub fn set_item_collection_key(mut self, input: std::option::Option<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>) -> Self {
...
pub struct ConsumedCapacity  {
    ...
    #[doc(hidden)]pub capacity_units: std::option::Option<f64>,
    /// <p>The total number of read capacity units consumed by the operation.</p>
    #[doc(hidden)]pub read_capacity_units: std::option::Option<f64>,
    /// <p>The total number of write capacity units consumed by the operation.</p>
    #[doc(hidden)]pub write_capacity_units: std::option::Option<f64>,
    /// <p>The amount of throughput consumed on the table affected by the operation.</p>
    #[doc(hidden)]pub table: std::option::Option<crate::model::Capacity>,
    /// <p>The amount of throughput consumed on each local index affected by the operation.</p>
    #[doc(hidden)]pub local_secondary_indexes: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Capacity>>,
    /// <p>The amount of throughput consumed on each global index affected by the operation.</p>
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Capacity>>,
}
...
pub mod consumed_capacity {
    ...
    impl Builder {
        ...
        ///
        /// <p>The amount of throughput consumed on each local index affected by the operation.</p>
        pub fn local_secondary_indexes(mut self, k: impl Into<std::string::String>, v: crate::model::Capacity) -> Self {
        ...
        /// <p>The amount of throughput consumed on each local index affected by the operation.</p>
        pub fn set_local_secondary_indexes(mut self, input: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Capacity>>) -> Self {
            self.local_secondary_indexes = input; self
        }
        ...
        ///
        /// <p>The amount of throughput consumed on each global index affected by the operation.</p>
        pub fn global_secondary_indexes(mut self, k: impl Into<std::string::String>, v: crate::model::Capacity) -> Self {
        ...
        /// <p>The amount of throughput consumed on each global index affected by the operation.</p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Capacity>>) -> Self {
            self.global_secondary_indexes = input; self
        }
...
pub struct ExpectedAttributeValue  {
    ...
    /// </ul>
    #[doc(hidden)]pub exists: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub attribute_value_list: std::option::Option<std::vec::Vec<crate::model::AttributeValue>>,
}
...
pub mod expected_attribute_value {
    ...
    impl Builder {
        ...
        /// <p>For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.</p> 
        /// <p>For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
        pub fn set_attribute_value_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::AttributeValue>>) -> Self {
...
pub struct AttributeValueUpdate  {
    ...
    /// </ul>
    #[doc(hidden)]pub action: std::option::Option<crate::model::AttributeAction>,
}
...
pub mod attribute_value_update {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>ADD</code> - DynamoDB creates a new item with the supplied primary key and number (or set) for the attribute value. The only data types allowed are number, number set, string set or binary set.</p> </li> 
        /// </ul>
        pub fn set_action(mut self, input: std::option::Option<crate::model::AttributeAction>) -> Self {
...
pub struct ReplicaSettingsDescription  {
    ...
    #[doc(hidden)]pub replica_billing_mode_summary: std::option::Option<crate::model::BillingModeSummary>,
    /// <p>The maximum number of strongly consistent reads consumed per second before DynamoDB returns a <code>ThrottlingException</code>. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#ProvisionedThroughput">Specifying Read and Write Requirements</a> in the <i>Amazon DynamoDB Developer Guide</i>. </p>
    #[doc(hidden)]pub replica_provisioned_read_capacity_units: std::option::Option<i64>,
    /// <p>Auto scaling settings for a global table replica's read capacity units.</p>
    #[doc(hidden)]pub replica_provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    /// <p>The maximum number of writes consumed per second before DynamoDB returns a <code>ThrottlingException</code>. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#ProvisionedThroughput">Specifying Read and Write Requirements</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
    #[doc(hidden)]pub replica_provisioned_write_capacity_units: std::option::Option<i64>,
    /// <p>Auto scaling settings for a global table replica's write capacity units.</p>
    #[doc(hidden)]pub replica_provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    /// <p>Replica global secondary index settings for the global table.</p>
    #[doc(hidden)]pub replica_global_secondary_index_settings: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsDescription>>,
    /// <p>Contains details of the table class.</p>
    #[doc(hidden)]pub replica_table_class_summary: std::option::Option<crate::model::TableClassSummary>,
}
impl ReplicaSettingsDescription {
    ...
    /// <p>The read/write capacity mode of the replica.</p>
    pub fn replica_billing_mode_summary(&self) -> std::option::Option<& crate::model::BillingModeSummary> {
    ...
    /// <p>Replica global secondary index settings for the global table.</p>
    pub fn replica_global_secondary_index_settings(&self) -> std::option::Option<& [crate::model::ReplicaGlobalSecondaryIndexSettingsDescription]> {
...
impl  std::fmt::Debug for ReplicaSettingsDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("region_name", &self.region_name);
        formatter.field("replica_status", &self.replica_status);
        formatter.field("replica_billing_mode_summary", &self.replica_billing_mode_summary);
        formatter.field("replica_provisioned_read_capacity_units", &self.replica_provisioned_read_capacity_units);
        formatter.field("replica_provisioned_read_capacity_auto_scaling_settings", &self.replica_provisioned_read_capacity_auto_scaling_settings);
        formatter.field("replica_provisioned_write_capacity_units", &self.replica_provisioned_write_capacity_units);
        formatter.field("replica_provisioned_write_capacity_auto_scaling_settings", &self.replica_provisioned_write_capacity_auto_scaling_settings);
        formatter.field("replica_global_secondary_index_settings", &self.replica_global_secondary_index_settings);
        formatter.field("replica_table_class_summary", &self.replica_table_class_summary);
        formatter.finish()
    }
}
...
pub mod replica_settings_description {
    ...
    pub struct Builder {
        pub(crate) region_name: std::option::Option<std::string::String>,
        pub(crate) replica_status: std::option::Option<crate::model::ReplicaStatus>,
        pub(crate) replica_billing_mode_summary: std::option::Option<crate::model::BillingModeSummary>,
        ...
        pub(crate) replica_provisioned_write_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
        pub(crate) replica_global_secondary_index_settings: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsDescription>>,
        pub(crate) replica_table_class_summary: std::option::Option<crate::model::TableClassSummary>,
    }
    impl Builder {
        /// <p>The Region name of the replica.</p>
        ...
        /// <p>The read/write capacity mode of the replica.</p>
        pub fn replica_billing_mode_summary(mut self, input: crate::model::BillingModeSummary) -> Self {
            self.replica_billing_mode_summary = Some(input);
            self
        }
        /// <p>The read/write capacity mode of the replica.</p>
        pub fn set_replica_billing_mode_summary(mut self, input: std::option::Option<crate::model::BillingModeSummary>) -> Self {
        ...
        ///
        /// <p>Replica global secondary index settings for the global table.</p>
        pub fn replica_global_secondary_index_settings(mut self, input: crate::model::ReplicaGlobalSecondaryIndexSettingsDescription) -> Self {
        ...
        /// <p>Replica global secondary index settings for the global table.</p>
        pub fn set_replica_global_secondary_index_settings(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsDescription>>) -> Self {
...
pub struct ReplicaGlobalSecondaryIndexSettingsDescription  {
    ...
    #[doc(hidden)]pub provisioned_read_capacity_units: std::option::Option<i64>,
    /// <p>Auto scaling settings for a global secondary index replica's read capacity units.</p>
    #[doc(hidden)]pub provisioned_read_capacity_auto_scaling_settings: std::option::Option<crate::model::AutoScalingSettingsDescription>,
    /// <p>The maximum number of writes consumed per second before DynamoDB returns a <code>ThrottlingException</code>.</p>
    #[doc(hidden)]pub provisioned_write_capacity_units: std::option::Option<i64>,
...
impl  std::fmt::Debug for ReplicaGlobalSecondaryIndexSettingsDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("index_name", &self.index_name);
        formatter.field("index_status", &self.index_status);
        formatter.field("provisioned_read_capacity_units", &self.provisioned_read_capacity_units);
        formatter.field("provisioned_read_capacity_auto_scaling_settings", &self.provisioned_read_capacity_auto_scaling_settings);
        formatter.field("provisioned_write_capacity_units", &self.provisioned_write_capacity_units);
        formatter.field("provisioned_write_capacity_auto_scaling_settings", &self.provisioned_write_capacity_auto_scaling_settings);
        formatter.finish()
    }
}
...
pub struct ReplicaSettingsUpdate  {
    ...
    #[doc(hidden)]pub replica_provisioned_read_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    #[doc(hidden)]pub replica_global_secondary_index_settings_update: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsUpdate>>,
    /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
    #[doc(hidden)]pub replica_table_class: std::option::Option<crate::model::TableClass>,
}
impl ReplicaSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global table replica's read capacity units.</p>
    pub fn replica_provisioned_read_capacity_auto_scaling_settings_update(&self) -> std::option::Option<& crate::model::AutoScalingSettingsUpdate> {
        self.replica_provisioned_read_capacity_auto_scaling_settings_update.as_ref()
    }
    /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
    pub fn replica_global_secondary_index_settings_update(&self) -> std::option::Option<& [crate::model::ReplicaGlobalSecondaryIndexSettingsUpdate]> {
...
impl  std::fmt::Debug for ReplicaSettingsUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("region_name", &self.region_name);
        formatter.field("replica_provisioned_read_capacity_units", &self.replica_provisioned_read_capacity_units);
        formatter.field("replica_provisioned_read_capacity_auto_scaling_settings_update", &self.replica_provisioned_read_capacity_auto_scaling_settings_update);
        formatter.field("replica_global_secondary_index_settings_update", &self.replica_global_secondary_index_settings_update);
...
pub mod replica_settings_update {
    ...
    pub struct Builder {
        pub(crate) region_name: std::option::Option<std::string::String>,
        pub(crate) replica_provisioned_read_capacity_units: std::option::Option<i64>,
        pub(crate) replica_provisioned_read_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
        pub(crate) replica_global_secondary_index_settings_update: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsUpdate>>,
    ...
    impl Builder {
        ...
        /// <p>Auto scaling settings for managing a global table replica's read capacity units.</p>
        pub fn replica_provisioned_read_capacity_auto_scaling_settings_update(mut self, input: crate::model::AutoScalingSettingsUpdate) -> Self {
            self.replica_provisioned_read_capacity_auto_scaling_settings_update = Some(input);
            self
        }
        /// <p>Auto scaling settings for managing a global table replica's read capacity units.</p>
        pub fn set_replica_provisioned_read_capacity_auto_scaling_settings_update(mut self, input: std::option::Option<crate::model::AutoScalingSettingsUpdate>) -> Self {
        ...
        ///
        /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
        pub fn replica_global_secondary_index_settings_update(mut self, input: crate::model::ReplicaGlobalSecondaryIndexSettingsUpdate) -> Self {
        ...
        /// <p>Represents the settings of a global secondary index for a global table that will be modified.</p>
        pub fn set_replica_global_secondary_index_settings_update(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexSettingsUpdate>>) -> Self {
        ...
        /// <p>Replica-specific table class. If not specified, uses the source table's table class.</p>
        pub fn set_replica_table_class(mut self, input: std::option::Option<crate::model::TableClass>) -> Self {
...
pub struct ReplicaGlobalSecondaryIndexSettingsUpdate  {
    ...
    #[doc(hidden)]pub provisioned_read_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
}
impl ReplicaGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
    pub fn provisioned_read_capacity_auto_scaling_settings_update(&self) -> std::option::Option<& crate::model::AutoScalingSettingsUpdate> {
...
impl  std::fmt::Debug for ReplicaGlobalSecondaryIndexSettingsUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("index_name", &self.index_name);
        formatter.field("provisioned_read_capacity_units", &self.provisioned_read_capacity_units);
        formatter.field("provisioned_read_capacity_auto_scaling_settings_update", &self.provisioned_read_capacity_auto_scaling_settings_update);
        formatter.finish()
    }
}
...
pub mod replica_global_secondary_index_settings_update {
    ...
    pub struct Builder {
        pub(crate) index_name: std::option::Option<std::string::String>,
        pub(crate) provisioned_read_capacity_units: std::option::Option<i64>,
        pub(crate) provisioned_read_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
    }
    impl Builder {
        /// <p>The name of the global secondary index. The name must be unique among all other indexes on this table.</p>
        pub fn index_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
        pub fn provisioned_read_capacity_auto_scaling_settings_update(mut self, input: crate::model::AutoScalingSettingsUpdate) -> Self {
            self.provisioned_read_capacity_auto_scaling_settings_update = Some(input);
            self
        }
        /// <p>Auto scaling settings for managing a global secondary index replica's read capacity units.</p>
        pub fn set_provisioned_read_capacity_auto_scaling_settings_update(mut self, input: std::option::Option<crate::model::AutoScalingSettingsUpdate>) -> Self {
...
pub struct GlobalTableGlobalSecondaryIndexSettingsUpdate  {
    ...
    #[doc(hidden)]pub provisioned_write_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
}
impl GlobalTableGlobalSecondaryIndexSettingsUpdate {
    ...
    /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
    pub fn provisioned_write_capacity_auto_scaling_settings_update(&self) -> std::option::Option<& crate::model::AutoScalingSettingsUpdate> {
...
impl  std::fmt::Debug for GlobalTableGlobalSecondaryIndexSettingsUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("index_name", &self.index_name);
        formatter.field("provisioned_write_capacity_units", &self.provisioned_write_capacity_units);
        formatter.field("provisioned_write_capacity_auto_scaling_settings_update", &self.provisioned_write_capacity_auto_scaling_settings_update);
        formatter.finish()
    }
}
...
pub mod global_table_global_secondary_index_settings_update {
    ...
    pub struct Builder {
        pub(crate) index_name: std::option::Option<std::string::String>,
        pub(crate) provisioned_write_capacity_units: std::option::Option<i64>,
        pub(crate) provisioned_write_capacity_auto_scaling_settings_update: std::option::Option<crate::model::AutoScalingSettingsUpdate>,
    }
    impl Builder {
        /// <p>The name of the global secondary index. The name must be unique among all other indexes on this table.</p>
        pub fn index_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
        pub fn provisioned_write_capacity_auto_scaling_settings_update(mut self, input: crate::model::AutoScalingSettingsUpdate) -> Self {
            self.provisioned_write_capacity_auto_scaling_settings_update = Some(input);
            self
        }
        /// <p>Auto scaling settings for managing a global secondary index's write capacity units.</p>
        pub fn set_provisioned_write_capacity_auto_scaling_settings_update(mut self, input: std::option::Option<crate::model::AutoScalingSettingsUpdate>) -> Self {
...
pub struct GlobalTableDescription  {
    ...
    #[doc(hidden)]pub replication_group: std::option::Option<std::vec::Vec<crate::model::ReplicaDescription>>,
    /// <p>The unique identifier of the global table.</p>
    #[doc(hidden)]pub global_table_arn: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub global_table_status: std::option::Option<crate::model::GlobalTableStatus>,
...
pub mod global_table_description {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) replication_group: std::option::Option<std::vec::Vec<crate::model::ReplicaDescription>>,
    ...
    impl Builder {
        ...
        /// <p>The Regions where the global table has replicas.</p>
        pub fn set_replication_group(mut self, input: std::option::Option<std::vec::Vec<crate::model::ReplicaDescription>>) -> Self {
        ...
        /// <li> <p> <code>ACTIVE</code> - The global table is ready for use.</p> </li> 
        /// </ul>
        pub fn set_global_table_status(mut self, input: std::option::Option<crate::model::GlobalTableStatus>) -> Self {
...
pub struct ReplicaUpdate  {
    ...
    #[doc(hidden)]pub create: std::option::Option<crate::model::CreateReplicaAction>,
    /// <p>The name of the existing replica to be removed.</p>
    #[doc(hidden)]pub delete: std::option::Option<crate::model::DeleteReplicaAction>,
}
impl ReplicaUpdate {
    /// <p>The parameters required for creating a replica on an existing global table.</p>
...
pub mod replica_update {
    ...
    impl Builder {
        ...
        /// <p>The parameters required for creating a replica on an existing global table.</p>
        pub fn set_create(mut self, input: std::option::Option<crate::model::CreateReplicaAction>) -> Self {
            self.create = input; self
        }
        /// <p>The name of the existing replica to be removed.</p>
        ...
        /// <p>The name of the existing replica to be removed.</p>
        pub fn set_delete(mut self, input: std::option::Option<crate::model::DeleteReplicaAction>) -> Self {
            self.delete = input; self
        }
...
pub struct ContinuousBackupsDescription  {
    ...
    #[doc(hidden)]pub continuous_backups_status: std::option::Option<crate::model::ContinuousBackupsStatus>,
    /// <p>The description of the point in time recovery settings applied to the table.</p>
    #[doc(hidden)]pub point_in_time_recovery_description: std::option::Option<crate::model::PointInTimeRecoveryDescription>,
}
impl ContinuousBackupsDescription {
    /// <p> <code>ContinuousBackupsStatus</code> can be one of the following states: ENABLED, DISABLED</p>
    pub fn continuous_backups_status(&self) -> std::option::Option<& crate::model::ContinuousBackupsStatus> {
        self.continuous_backups_status.as_ref()
    }
    /// <p>The description of the point in time recovery settings applied to the table.</p>
    pub fn point_in_time_recovery_description(&self) -> std::option::Option<& crate::model::PointInTimeRecoveryDescription> {
...
impl  std::fmt::Debug for ContinuousBackupsDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("point_in_time_recovery_description", &self.point_in_time_recovery_description);
        formatter.finish()
    }
}
...
pub mod continuous_backups_description {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) continuous_backups_status: std::option::Option<crate::model::ContinuousBackupsStatus>,
        pub(crate) point_in_time_recovery_description: std::option::Option<crate::model::PointInTimeRecoveryDescription>,
    }
    impl Builder {
        /// <p> <code>ContinuousBackupsStatus</code> can be one of the following states: ENABLED, DISABLED</p>
        pub fn continuous_backups_status(mut self, input: crate::model::ContinuousBackupsStatus) -> Self {
            self.continuous_backups_status = Some(input);
            self
        }
        /// <p> <code>ContinuousBackupsStatus</code> can be one of the following states: ENABLED, DISABLED</p>
        pub fn set_continuous_backups_status(mut self, input: std::option::Option<crate::model::ContinuousBackupsStatus>) -> Self {
            self.continuous_backups_status = input; self
        }
        /// <p>The description of the point in time recovery settings applied to the table.</p>
        pub fn point_in_time_recovery_description(mut self, input: crate::model::PointInTimeRecoveryDescription) -> Self {
            self.point_in_time_recovery_description = Some(input);
            self
        }
        /// <p>The description of the point in time recovery settings applied to the table.</p>
        pub fn set_point_in_time_recovery_description(mut self, input: std::option::Option<crate::model::PointInTimeRecoveryDescription>) -> Self {
...
pub struct PointInTimeRecoveryDescription  {
    ...
    /// </ul>
    #[doc(hidden)]pub point_in_time_recovery_status: std::option::Option<crate::model::PointInTimeRecoveryStatus>,
    ...
    #[doc(hidden)]pub earliest_restorable_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p> <code>LatestRestorableDateTime</code> is typically 5 minutes before the current time. </p>
    #[doc(hidden)]pub latest_restorable_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl PointInTimeRecoveryDescription {
    ...
    /// <li> <p> <code>DISABLED</code> - Point in time recovery is disabled.</p> </li> 
    /// </ul>
    pub fn point_in_time_recovery_status(&self) -> std::option::Option<& crate::model::PointInTimeRecoveryStatus> {
...
impl  std::fmt::Debug for PointInTimeRecoveryDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("point_in_time_recovery_status", &self.point_in_time_recovery_status);
        formatter.field("earliest_restorable_date_time", &self.earliest_restorable_date_time);
        formatter.field("latest_restorable_date_time", &self.latest_restorable_date_time);
        formatter.finish()
    }
}
...
pub mod point_in_time_recovery_description {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) point_in_time_recovery_status: std::option::Option<crate::model::PointInTimeRecoveryStatus>,
    ...
    impl Builder {
        ...
        /// <li> <p> <code>DISABLED</code> - Point in time recovery is disabled.</p> </li> 
        /// </ul>
        pub fn point_in_time_recovery_status(mut self, input: crate::model::PointInTimeRecoveryStatus) -> Self {
        ...
        /// <li> <p> <code>DISABLED</code> - Point in time recovery is disabled.</p> </li> 
        /// </ul>
        pub fn set_point_in_time_recovery_status(mut self, input: std::option::Option<crate::model::PointInTimeRecoveryStatus>) -> Self {
...
pub struct PointInTimeRecoverySpecification  {
    ...
    #[doc(hidden)]pub point_in_time_recovery_enabled: std::option::Option<bool>,
}
...
impl  std::fmt::Debug for PointInTimeRecoverySpecification  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("point_in_time_recovery_enabled", &self.point_in_time_recovery_enabled);
        formatter.finish()
    }
}
...
pub struct TransactWriteItem  {
    ...
    #[doc(hidden)]pub condition_check: std::option::Option<crate::model::ConditionCheck>,
    /// <p>A request to perform a <code>PutItem</code> operation.</p>
    #[doc(hidden)]pub put: std::option::Option<crate::model::Put>,
    /// <p>A request to perform a <code>DeleteItem</code> operation.</p>
    #[doc(hidden)]pub delete: std::option::Option<crate::model::Delete>,
...
pub mod transact_write_item {
    ...
    impl Builder {
        ...
        /// <p>A request to perform a check item operation.</p>
        pub fn set_condition_check(mut self, input: std::option::Option<crate::model::ConditionCheck>) -> Self {
...
pub struct Update  {
    ...
    #[doc(hidden)]pub return_values_on_condition_check_failure: std::option::Option<crate::model::ReturnValuesOnConditionCheckFailure>,
}
impl Update {
    /// <p>The primary key of the item to be updated. Each element consists of an attribute name and a value for that attribute.</p>
    ...
    /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>Update</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW.</p>
    pub fn return_values_on_condition_check_failure(&self) -> std::option::Option<& crate::model::ReturnValuesOnConditionCheckFailure> {
...
impl  std::fmt::Debug for Update  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("return_values_on_condition_check_failure", &self.return_values_on_condition_check_failure);
        formatter.finish()
    }
}
...
pub mod update {
    ...
    pub struct Builder {
        ...
        pub(crate) return_values_on_condition_check_failure: std::option::Option<crate::model::ReturnValuesOnConditionCheckFailure>,
    }
    impl Builder {
        ...
        /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>Update</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW.</p>
        pub fn return_values_on_condition_check_failure(mut self, input: crate::model::ReturnValuesOnConditionCheckFailure) -> Self {
            self.return_values_on_condition_check_failure = Some(input);
            self
        }
        /// <p>Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>Update</code> condition fails. For <code>ReturnValuesOnConditionCheckFailure</code>, the valid values are: NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW.</p>
        pub fn set_return_values_on_condition_check_failure(mut self, input: std::option::Option<crate::model::ReturnValuesOnConditionCheckFailure>) -> Self {
...
pub struct TransactGetItem  {
    ...
    #[doc(hidden)]pub get: std::option::Option<crate::model::Get>,
}
...
pub struct ExportSummary  {
    ...
    #[doc(hidden)]pub export_status: std::option::Option<crate::model::ExportStatus>,
}
impl ExportSummary {
    /// <p>The Amazon Resource Name (ARN) of the export.</p>
...
pub struct ContributorInsightsSummary  {
    ...
    #[doc(hidden)]pub contributor_insights_status: std::option::Option<crate::model::ContributorInsightsStatus>,
}
impl ContributorInsightsSummary {
    ...
    /// <p>Describes the current status for contributor insights for the given table and index, if applicable.</p>
    pub fn contributor_insights_status(&self) -> std::option::Option<& crate::model::ContributorInsightsStatus> {
...
impl  std::fmt::Debug for ContributorInsightsSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("table_name", &self.table_name);
        formatter.field("index_name", &self.index_name);
        formatter.field("contributor_insights_status", &self.contributor_insights_status);
        formatter.finish()
    }
}
...
pub mod contributor_insights_summary {
    ...
    pub struct Builder {
        pub(crate) table_name: std::option::Option<std::string::String>,
        pub(crate) index_name: std::option::Option<std::string::String>,
        pub(crate) contributor_insights_status: std::option::Option<crate::model::ContributorInsightsStatus>,
    }
    impl Builder {
        /// <p>Name of the table associated with the summary.</p>
        pub fn table_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Describes the current status for contributor insights for the given table and index, if applicable.</p>
        pub fn contributor_insights_status(mut self, input: crate::model::ContributorInsightsStatus) -> Self {
            self.contributor_insights_status = Some(input);
            self
        }
        /// <p>Describes the current status for contributor insights for the given table and index, if applicable.</p>
        pub fn set_contributor_insights_status(mut self, input: std::option::Option<crate::model::ContributorInsightsStatus>) -> Self {
...
pub struct BackupSummary  {
    ...
    #[doc(hidden)]pub backup_creation_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Time at which the automatic on-demand backup created by DynamoDB will expire. This <code>SYSTEM</code> on-demand backup expires automatically 35 days after its creation.</p>
    #[doc(hidden)]pub backup_expiry_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
    #[doc(hidden)]pub backup_status: std::option::Option<crate::model::BackupStatus>,
    /// <p>BackupType:</p> 
    /// <ul> 
    ...
    /// </ul>
    #[doc(hidden)]pub backup_type: std::option::Option<crate::model::BackupType>,
    /// <p>Size of the backup in bytes.</p>
    #[doc(hidden)]pub backup_size_bytes: std::option::Option<i64>,
}
impl BackupSummary {
    /// <p>Name of the table.</p>
    pub fn table_name(&self) -> std::option::Option<& str> {
...
pub mod backup_summary {
    ...
    impl Builder {
        ...
        /// <p>Backup can be in one of the following states: CREATING, ACTIVE, DELETED.</p>
        pub fn set_backup_status(mut self, input: std::option::Option<crate::model::BackupStatus>) -> Self {
        ...
        /// <li> <p> <code>AWS_BACKUP</code> - On-demand backup created by you from Backup service.</p> </li> 
        /// </ul>
        pub fn set_backup_type(mut self, input: std::option::Option<crate::model::BackupType>) -> Self {
...
pub struct ImportTableDescription  {
    ...
    #[doc(hidden)]pub error_count: i64,
...
pub struct InputFormatOptions  {
    ...
    #[doc(hidden)]pub csv: std::option::Option<crate::model::CsvOptions>,
}
...
pub mod input_format_options {
    ...
    impl Builder {
        ...
        pub fn build(self) -> crate::model::InputFormatOptions {
            crate::model::InputFormatOptions {
                csv: self.csv
                ,
            }
        }
...
pub struct ExportDescription  {
    ...
    #[doc(hidden)]pub export_manifest: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub billed_size_bytes: std::option::Option<i64>,
    /// <p>The number of items exported.</p>
    #[doc(hidden)]pub item_count: std::option::Option<i64>,
}
...
pub struct TimeToLiveDescription  {
    ...
    #[doc(hidden)]pub time_to_live_status: std::option::Option<crate::model::TimeToLiveStatus>,
...
pub mod time_to_live_description {
    ...
    impl Builder {
        ...
        /// <p> The TTL status for the table.</p>
        pub fn set_time_to_live_status(mut self, input: std::option::Option<crate::model::TimeToLiveStatus>) -> Self {
...
pub struct KinesisDataStreamDestination  {
    ...
    #[doc(hidden)]pub destination_status: std::option::Option<crate::model::DestinationStatus>,
    /// <p>The human-readable string that corresponds to the replica status.</p>
    #[doc(hidden)]pub destination_status_description: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for KinesisDataStreamDestination  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("destination_status_description", &self.destination_status_description);
        formatter.finish()
    }
}
...
pub mod kinesis_data_stream_destination {
    ...
    impl Builder {
        ...
        /// <p>The current status of replication.</p>
        pub fn set_destination_status(mut self, input: std::option::Option<crate::model::DestinationStatus>) -> Self {
...
pub struct Endpoint  {
    ...
    #[doc(hidden)]pub cache_period_in_minutes: i64,
}
impl Endpoint {
    /// <p>IP address of the endpoint.</p>
...
pub struct FailureException  {
    /// <p>Exception name.</p>
    #[doc(hidden)]pub exception_name: std::option::Option<std::string::String>,
    /// <p>Description of the failure.</p>
    #[doc(hidden)]pub exception_description: std::option::Option<std::string::String>,
}
...
pub struct BackupDescription  {
    ...
    #[doc(hidden)]pub backup_details: std::option::Option<crate::model::BackupDetails>,
    /// <p>Contains the details of the table when the backup was created. </p>
    #[doc(hidden)]pub source_table_details: std::option::Option<crate::model::SourceTableDetails>,
    /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
    #[doc(hidden)]pub source_table_feature_details: std::option::Option<crate::model::SourceTableFeatureDetails>,
}
impl BackupDescription {
    ...
    /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
    pub fn source_table_feature_details(&self) -> std::option::Option<& crate::model::SourceTableFeatureDetails> {
...
impl  std::fmt::Debug for BackupDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("source_table_feature_details", &self.source_table_feature_details);
        formatter.finish()
    }
}
...
pub mod backup_description {
    ...
    pub struct Builder {
        ...
        pub(crate) source_table_feature_details: std::option::Option<crate::model::SourceTableFeatureDetails>,
    }
    impl Builder {
        /// <p>Contains the details of the backup created for the table. </p>
        ...
        /// <p>Contains the details of the backup created for the table. </p>
        pub fn set_backup_details(mut self, input: std::option::Option<crate::model::BackupDetails>) -> Self {
        ...
        /// <p>Contains the details of the table when the backup was created. </p>
        pub fn set_source_table_details(mut self, input: std::option::Option<crate::model::SourceTableDetails>) -> Self {
            self.source_table_details = input; self
        }
        /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
        pub fn source_table_feature_details(mut self, input: crate::model::SourceTableFeatureDetails) -> Self {
            self.source_table_feature_details = Some(input);
            self
        }
        /// <p>Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.</p>
        pub fn set_source_table_feature_details(mut self, input: std::option::Option<crate::model::SourceTableFeatureDetails>) -> Self {
...
pub struct SourceTableFeatureDetails  {
    ...
    #[doc(hidden)]pub local_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::LocalSecondaryIndexInfo>>,
    ...
    #[doc(hidden)]pub global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::GlobalSecondaryIndexInfo>>,
    /// <p>Stream settings on the table when the backup was created.</p>
    #[doc(hidden)]pub stream_description: std::option::Option<crate::model::StreamSpecification>,
    /// <p>Time to Live settings on the table when the backup was created.</p>
    #[doc(hidden)]pub time_to_live_description: std::option::Option<crate::model::TimeToLiveDescription>,
...
impl SourceTableFeatureDetails {
    /// <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. </p>
    pub fn local_secondary_indexes(&self) -> std::option::Option<& [crate::model::LocalSecondaryIndexInfo]> {
        self.local_secondary_indexes.as_deref()
    }
    /// <p>Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at the time of backup. </p>
    pub fn global_secondary_indexes(&self) -> std::option::Option<& [crate::model::GlobalSecondaryIndexInfo]> {
        self.global_secondary_indexes.as_deref()
    }
    /// <p>Stream settings on the table when the backup was created.</p>
    ...
    /// <p>Time to Live settings on the table when the backup was created.</p>
    pub fn time_to_live_description(&self) -> std::option::Option<& crate::model::TimeToLiveDescription> {
...
pub mod source_table_feature_details {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) local_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::LocalSecondaryIndexInfo>>,
        pub(crate) global_secondary_indexes: std::option::Option<std::vec::Vec<crate::model::GlobalSecondaryIndexInfo>>,
        pub(crate) stream_description: std::option::Option<crate::model::StreamSpecification>,
        pub(crate) time_to_live_description: std::option::Option<crate::model::TimeToLiveDescription>,
        pub(crate) sse_description: std::option::Option<crate::model::SseDescription>,
    }
    impl Builder {
        /// Appends an item to `local_secondary_indexes`.
        ...
        ///
        /// <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. </p>
        pub fn local_secondary_indexes(mut self, input: crate::model::LocalSecondaryIndexInfo) -> Self {
            let mut v = self.local_secondary_indexes.unwrap_or_default();
                            v.push(input);
                            self.local_secondary_indexes = Some(v);
                            self
        ...
        /// <p>Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. </p>
        pub fn set_local_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::LocalSecondaryIndexInfo>>) -> Self {
            self.local_secondary_indexes = input; self
        }
        /// Appends an item to `global_secondary_indexes`.
        ///
        ...
        ///
        /// <p>Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at the time of backup. </p>
        pub fn global_secondary_indexes(mut self, input: crate::model::GlobalSecondaryIndexInfo) -> Self {
            let mut v = self.global_secondary_indexes.unwrap_or_default();
                            v.push(input);
                            self.global_secondary_indexes = Some(v);
                            self
        ...
        /// <p>Represents the GSI properties for the table when the backup was created. It includes the IndexName, KeySchema, Projection, and ProvisionedThroughput for the GSIs on the table at the time of backup. </p>
        pub fn set_global_secondary_indexes(mut self, input: std::option::Option<std::vec::Vec<crate::model::GlobalSecondaryIndexInfo>>) -> Self {
            self.global_secondary_indexes = input; self
        }
        /// <p>Stream settings on the table when the backup was created.</p>
        ...
        /// <p>Stream settings on the table when the backup was created.</p>
        pub fn set_stream_description(mut self, input: std::option::Option<crate::model::StreamSpecification>) -> Self {
            self.stream_description = input; self
        }
        /// <p>Time to Live settings on the table when the backup was created.</p>
        pub fn time_to_live_description(mut self, input: crate::model::TimeToLiveDescription) -> Self {
            self.time_to_live_description = Some(input);
            self
        }
        /// <p>Time to Live settings on the table when the backup was created.</p>
        pub fn set_time_to_live_description(mut self, input: std::option::Option<crate::model::TimeToLiveDescription>) -> Self {
...
pub struct SourceTableDetails  {
    ...
    #[doc(hidden)]pub table_creation_date_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct WriteRequest  {
    /// <p>A request to perform a <code>PutItem</code> operation.</p>
    #[doc(hidden)]pub put_request: std::option::Option<crate::model::PutRequest>,
    /// <p>A request to perform a <code>DeleteItem</code> operation.</p>
    #[doc(hidden)]pub delete_request: std::option::Option<crate::model::DeleteRequest>,
}
impl WriteRequest {
    /// <p>A request to perform a <code>PutItem</code> operation.</p>
...
pub mod write_request {
    ...
    impl Builder {
        ...
        /// <p>A request to perform a <code>PutItem</code> operation.</p>
        pub fn set_put_request(mut self, input: std::option::Option<crate::model::PutRequest>) -> Self {
        ...
        /// <p>A request to perform a <code>DeleteItem</code> operation.</p>
        pub fn set_delete_request(mut self, input: std::option::Option<crate::model::DeleteRequest>) -> Self {
...
pub struct KeysAndAttributes  {
    ...
    #[doc(hidden)]pub keys: std::option::Option<std::vec::Vec<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>>,
...
impl KeysAndAttributes {
    /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
    pub fn keys(&self) -> std::option::Option<& [std::collections::HashMap<std::string::String, crate::model::AttributeValue>]> {
        self.keys.as_deref()
    }
    /// <p>This is a legacy parameter. Use <code>ProjectionExpression</code> instead. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.html">Legacy Conditional Parameters</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
...
pub mod keys_and_attributes {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) keys: std::option::Option<std::vec::Vec<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>>,
    ...
    impl Builder {
        ...
        ///
        /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
        pub fn keys(mut self, input: std::collections::HashMap<std::string::String, crate::model::AttributeValue>) -> Self {
        ...
        /// <p>The primary key attribute values that define the items and the attributes associated with the items.</p>
        pub fn set_keys(mut self, input: std::option::Option<std::vec::Vec<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>>) -> Self {
...
pub struct BatchStatementResponse  {
    ...
    #[doc(hidden)]pub error: std::option::Option<crate::model::BatchStatementError>,
...
pub mod batch_statement_response {
    ...
    impl Builder {
        ...
        /// <p> The error associated with a failed PartiQL batch statement. </p>
        pub fn set_error(mut self, input: std::option::Option<crate::model::BatchStatementError>) -> Self {
...
pub struct BatchStatementError  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::BatchStatementErrorCodeEnum>,
...
pub mod batch_statement_error {
    ...
    impl Builder {
        ...
        /// <p> The error code associated with the failed PartiQL batch statement. </p>
        pub fn set_code(mut self, input: std::option::Option<crate::model::BatchStatementErrorCodeEnum>) -> Self {
            self.code = input; self
        }
        /// <p> The error message associated with the PartiQL batch response. </p>
        pub fn message(mut self, input: impl Into<std::string::String>) -> Self {
