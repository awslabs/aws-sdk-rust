...
impl  Update  {
    ...
    pub fn update_expression(&self) -> & str {
        use std::ops::Deref; self.update_expression.deref()
    }
    /// <p>Name of the table for the <code>UpdateItem</code> request.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::Update, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::Update {
                key: self.key
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("key", "key was not specified but it is required when building Update")
                    )?
                ,
                update_expression: self.update_expression
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("update_expression", "update_expression was not specified but it is required when building Update")
                    )?
                ,
                table_name: self.table_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("table_name", "table_name was not specified but it is required when building Update")
                    )?
                ,
