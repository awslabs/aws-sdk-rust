...
pub fn serialize_structure_batch_get_item_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_write_item_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_global_table_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_table_input(
    ...
    if let Some(var_45) = &input.provisioned_throughput {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_46, var_45);
        object_46.finish();
    }
    if let Some(var_47) = &input.stream_specification {
        let mut object_48 = object.key("StreamSpecification").start_object();
        crate::json_ser::serialize_structure_stream_specification(&mut object_48, var_47);
        object_48.finish();
    }
    if let Some(var_49) = &input.sse_specification {
        let mut object_50 = object.key("SSESpecification").start_object();
        crate::json_ser::serialize_structure_sse_specification(&mut object_50, var_49);
        object_50.finish();
    }
...
pub fn serialize_structure_delete_item_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_backup_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_continuous_backups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_contributor_insights_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_export_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_global_table_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_global_table_settings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_kinesis_streaming_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_table_replica_auto_scaling_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_time_to_live_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disable_kinesis_streaming_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_enable_kinesis_streaming_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_execute_transaction_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_export_table_to_point_in_time_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_110) = &input.export_time {
        object
            .key("ExportTime")
            .instant(var_110, smithy_types::instant::Format::EpochSeconds);
    }
...
pub fn serialize_structure_get_item_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_backups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_contributor_insights_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_global_tables_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_tags_of_resource_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_restore_table_from_backup_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_226) = &input.provisioned_throughput_override {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_227, var_226);
        object_227.finish();
    }
    if let Some(var_228) = &input.sse_specification_override {
        let mut object_229 = object.key("SSESpecificationOverride").start_object();
        crate::json_ser::serialize_structure_sse_specification(&mut object_229, var_228);
        object_229.finish();
    }
}

pub fn serialize_structure_restore_table_to_point_in_time_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_234) = &input.restore_date_time {
        object
            .key("RestoreDateTime")
            .instant(var_234, smithy_types::instant::Format::EpochSeconds);
    }
    ...
    if let Some(var_244) = &input.provisioned_throughput_override {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_245, var_244);
        object_245.finish();
    }
    if let Some(var_246) = &input.sse_specification_override {
        let mut object_247 = object.key("SSESpecificationOverride").start_object();
        crate::json_ser::serialize_structure_sse_specification(&mut object_247, var_246);
        object_247.finish();
    }
}

pub fn serialize_structure_scan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_transact_get_items_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_transact_write_items_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_continuous_backups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_303) = &input.point_in_time_recovery_specification {
        let mut object_304 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_point_in_time_recovery_specification(
            &mut object_304,
            var_303,
        );
        object_304.finish();
...
pub fn serialize_structure_update_contributor_insights_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_global_table_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_global_table_settings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        &input.global_table_provisioned_write_capacity_auto_scaling_settings_update
    {
        let mut object_317 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_317, var_316);
        object_317.finish();
    }
...
pub fn serialize_structure_update_item_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_table_input(
    ...
    if let Some(var_363) = &input.provisioned_throughput {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_364, var_363);
        object_364.finish();
    }
    ...
    if let Some(var_369) = &input.stream_specification {
        ...
        crate::json_ser::serialize_structure_stream_specification(&mut object_370, var_369);
        object_370.finish();
    }
    if let Some(var_371) = &input.sse_specification {
        let mut object_372 = object.key("SSESpecification").start_object();
        crate::json_ser::serialize_structure_sse_specification(&mut object_372, var_371);
        object_372.finish();
    }
...
pub fn serialize_structure_update_table_replica_auto_scaling_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_382) = &input.provisioned_write_capacity_auto_scaling_update {
        let mut object_383 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_383, var_382);
        object_383.finish();
    }
...
pub fn serialize_structure_update_time_to_live_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_389) = &input.time_to_live_specification {
        ...
        crate::json_ser::serialize_structure_time_to_live_specification(&mut object_390, var_389);
        object_390.finish();
    }
}

pub fn serialize_structure_batch_statement_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_keys_and_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_attribute_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_key_schema_element(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_local_secondary_index(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_427) = &input.projection {
        ...
        crate::json_ser::serialize_structure_projection(&mut object_428, var_427);
        object_428.finish();
    }
}

pub fn serialize_structure_global_secondary_index(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_434) = &input.projection {
        ...
        crate::json_ser::serialize_structure_projection(&mut object_435, var_434);
        object_435.finish();
    }
    if let Some(var_436) = &input.provisioned_throughput {
        let mut object_437 = object.key("ProvisionedThroughput").start_object();
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_437, var_436);
        object_437.finish();
    }
}

pub fn serialize_structure_provisioned_throughput(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stream_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_attribute_value(
    object_61: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_expected_attribute_value(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ExpectedAttributeValue,
) {
    if let Some(var_460) = &input.value {
        let mut object_461 = object.key("Value").start_object();
        crate::json_ser::serialize_union_attribute_value(&mut object_461, var_460);
        object_461.finish();
    }
...
pub fn serialize_structure_parameterized_statement(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_transact_get_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::TransactGetItem,
) {
    if let Some(var_478) = &input.get {
        let mut object_479 = object.key("Get").start_object();
        crate::json_ser::serialize_structure_get(&mut object_479, var_478);
        object_479.finish();
    }
}

pub fn serialize_structure_transact_write_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_480) = &input.condition_check {
        ...
        crate::json_ser::serialize_structure_condition_check(&mut object_481, var_480);
        object_481.finish();
    }
    if let Some(var_482) = &input.put {
        let mut object_483 = object.key("Put").start_object();
        crate::json_ser::serialize_structure_put(&mut object_483, var_482);
        object_483.finish();
    }
    if let Some(var_484) = &input.delete {
        let mut object_485 = object.key("Delete").start_object();
        crate::json_ser::serialize_structure_delete(&mut object_485, var_484);
        object_485.finish();
    }
    if let Some(var_486) = &input.update {
        let mut object_487 = object.key("Update").start_object();
        crate::json_ser::serialize_structure_update(&mut object_487, var_486);
        object_487.finish();
    }
}

pub fn serialize_structure_point_in_time_recovery_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replica_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ReplicaUpdate,
) {
    if let Some(var_489) = &input.create {
        let mut object_490 = object.key("Create").start_object();
        crate::json_ser::serialize_structure_create_replica_action(&mut object_490, var_489);
        object_490.finish();
    }
    if let Some(var_491) = &input.delete {
        let mut object_492 = object.key("Delete").start_object();
        crate::json_ser::serialize_structure_delete_replica_action(&mut object_492, var_491);
        object_492.finish();
    }
}

pub fn serialize_structure_auto_scaling_settings_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_497) = &input.scaling_policy_update {
        ...
        crate::json_ser::serialize_structure_auto_scaling_policy_update(&mut object_498, var_497);
        object_498.finish();
    }
}

pub fn serialize_structure_global_table_global_secondary_index_settings_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_501) = &input.provisioned_write_capacity_auto_scaling_settings_update {
        let mut object_502 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_502, var_501);
        object_502.finish();
    }
}

pub fn serialize_structure_replica_settings_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_505) = &input.replica_provisioned_read_capacity_auto_scaling_settings_update {
        let mut object_506 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_506, var_505);
        object_506.finish();
    }
...
pub fn serialize_structure_attribute_value_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::AttributeValueUpdate,
) {
    if let Some(var_511) = &input.value {
        let mut object_512 = object.key("Value").start_object();
        crate::json_ser::serialize_union_attribute_value(&mut object_512, var_511);
        object_512.finish();
    }
...
pub fn serialize_structure_global_secondary_index_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_514) = &input.update {
        ...
        crate::json_ser::serialize_structure_update_global_secondary_index_action(
            &mut object_515,
            var_514,
        );
        object_515.finish();
    ...
    if let Some(var_516) = &input.create {
        ...
        crate::json_ser::serialize_structure_create_global_secondary_index_action(
            &mut object_517,
            var_516,
        );
        object_517.finish();
    ...
    if let Some(var_518) = &input.delete {
        ...
        crate::json_ser::serialize_structure_delete_global_secondary_index_action(
            &mut object_519,
            var_518,
        );
        object_519.finish();
...
pub fn serialize_structure_replication_group_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_520) = &input.create {
        ...
        crate::json_ser::serialize_structure_create_replication_group_member_action(
            &mut object_521,
            var_520,
        );
        object_521.finish();
    ...
    if let Some(var_522) = &input.update {
        ...
        crate::json_ser::serialize_structure_update_replication_group_member_action(
            &mut object_523,
            var_522,
        );
        object_523.finish();
    ...
    if let Some(var_524) = &input.delete {
        ...
        crate::json_ser::serialize_structure_delete_replication_group_member_action(
            &mut object_525,
            var_524,
        );
        object_525.finish();
...
pub fn serialize_structure_global_secondary_index_auto_scaling_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_527) = &input.provisioned_write_capacity_auto_scaling_update {
        let mut object_528 = object
            .key("ProvisionedWriteCapacityAutoScalingUpdate")
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_528, var_527);
        object_528.finish();
    }
}

pub fn serialize_structure_replica_auto_scaling_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_534) = &input.replica_provisioned_read_capacity_auto_scaling_update {
        let mut object_535 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_535, var_534);
        object_535.finish();
    }
}

pub fn serialize_structure_time_to_live_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_projection(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_condition_check(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_replica_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_replica_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_auto_scaling_policy_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_635) = &input.target_tracking_scaling_policy_configuration {
        let mut object_636 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_target_tracking_scaling_policy_configuration_update(&mut object_636, var_635);
        object_636.finish();
    }
}

pub fn serialize_structure_replica_global_secondary_index_settings_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_639) = &input.provisioned_read_capacity_auto_scaling_settings_update {
        let mut object_640 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_640, var_639);
        object_640.finish();
    }
}

pub fn serialize_structure_update_global_secondary_index_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_642) = &input.provisioned_throughput {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_643, var_642);
        object_643.finish();
    }
}

pub fn serialize_structure_create_global_secondary_index_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_649) = &input.projection {
        ...
        crate::json_ser::serialize_structure_projection(&mut object_650, var_649);
        object_650.finish();
    }
    if let Some(var_651) = &input.provisioned_throughput {
        let mut object_652 = object.key("ProvisionedThroughput").start_object();
        crate::json_ser::serialize_structure_provisioned_throughput(&mut object_652, var_651);
        object_652.finish();
    }
}

pub fn serialize_structure_delete_global_secondary_index_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_replication_group_member_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_656) = &input.provisioned_throughput_override {
        ...
        crate::json_ser::serialize_structure_provisioned_throughput_override(
            &mut object_657,
            var_656,
        );
        object_657.finish();
...
pub fn serialize_structure_delete_replication_group_member_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replica_global_secondary_index_auto_scaling_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_672) = &input.provisioned_read_capacity_auto_scaling_update {
        let mut object_673 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_auto_scaling_settings_update(&mut object_673, var_672);
        object_673.finish();
    }
}

pub fn serialize_structure_auto_scaling_target_tracking_scaling_policy_configuration_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_676) = &input.scale_out_cooldown {
        object.key("ScaleOutCooldown").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((*var_676).into()),
        );
    }
    if let Some(var_677) = &input.target_value {
        object.key("TargetValue").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_677).into()),
        );
    }
}

pub fn serialize_structure_provisioned_throughput_override(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replica_global_secondary_index(
    object: &mut smithy_json::serialize::JsonObjectWriter,
