...
pub fn ser_replica_settings_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplicaSettingsUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
