...
pub fn ser_replica_settings_update(
    ...
    if let Some(var_1) = &input.replica_provisioned_read_capacity_units {
        object.key("ReplicaProvisionedReadCapacityUnits").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
        ...
        for item_6 in var_4 {
             {
                ...
                crate::protocol_serde::shape_replica_global_secondary_index_settings_update::ser_replica_global_secondary_index_settings_update(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
