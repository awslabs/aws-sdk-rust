...
pub(crate) fn de_replica_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicaDescription>, aws_smithy_json::deserialize::error::DeserializeError>
