...
pub fn ser_import_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
