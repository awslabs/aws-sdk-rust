...
pub(crate) fn de_item_collection_metrics<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ItemCollectionMetrics>, aws_smithy_json::deserialize::error::DeserializeError>
