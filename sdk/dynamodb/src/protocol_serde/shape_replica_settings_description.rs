...
pub(crate) fn de_replica_settings_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicaSettingsDescription>, aws_smithy_json::deserialize::error::DeserializeError>
