...
pub fn ser_list_global_tables_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListGlobalTablesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
