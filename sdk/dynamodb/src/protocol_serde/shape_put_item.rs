...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_item_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_item::PutItemOutput, crate::operation::put_item::PutItemError> {
...
) -> Result<crate::operation::put_item::builders::PutItemOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
