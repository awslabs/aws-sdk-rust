...
pub fn ser_create_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
