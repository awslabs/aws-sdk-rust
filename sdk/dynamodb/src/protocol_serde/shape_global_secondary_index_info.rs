...
pub(crate) fn de_global_secondary_index_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::GlobalSecondaryIndexInfo>, aws_smithy_json::deserialize::error::DeserializeError>
