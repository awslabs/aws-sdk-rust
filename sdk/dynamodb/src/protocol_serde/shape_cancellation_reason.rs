...
pub(crate) fn de_cancellation_reason<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::CancellationReason>, aws_smithy_json::deserialize::error::DeserializeError>
