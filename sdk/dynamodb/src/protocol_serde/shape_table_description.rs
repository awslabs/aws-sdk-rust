...
pub(crate) fn de_table_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TableDescription>, aws_smithy_json::deserialize::error::DeserializeError>
