...
pub(crate) fn de_archival_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ArchivalSummary>, aws_smithy_json::deserialize::error::DeserializeError>
