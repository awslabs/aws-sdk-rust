...
pub fn ser_update_table_replica_auto_scaling_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTableReplicaAutoScalingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
