...
pub(crate) fn de_replica_global_secondary_index_settings_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicaGlobalSecondaryIndexSettingsDescription>, aws_smithy_json::deserialize::error::DeserializeError>
