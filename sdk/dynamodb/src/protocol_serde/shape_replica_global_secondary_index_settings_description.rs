...
pub(crate) fn de_replica_global_secondary_index_settings_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ReplicaGlobalSecondaryIndexSettingsDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::replica_global_secondary_index_settings_description_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
