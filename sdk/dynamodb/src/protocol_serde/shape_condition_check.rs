...
pub fn ser_condition_check(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ConditionCheck) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
