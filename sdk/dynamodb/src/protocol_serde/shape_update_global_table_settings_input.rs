...
pub fn ser_update_global_table_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGlobalTableSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
