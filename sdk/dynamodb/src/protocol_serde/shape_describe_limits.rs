...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_limits_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_limits::DescribeLimitsOutput, crate::operation::describe_limits::DescribeLimitsError> {
...
) -> Result<crate::operation::describe_limits::builders::DescribeLimitsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
