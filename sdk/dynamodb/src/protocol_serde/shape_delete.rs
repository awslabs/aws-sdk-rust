...
pub fn ser_delete(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Delete) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
