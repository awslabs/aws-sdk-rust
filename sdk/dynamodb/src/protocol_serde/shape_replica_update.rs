...
pub fn ser_replica_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplicaUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
