...
pub fn ser_replica_global_secondary_index_auto_scaling_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ReplicaGlobalSecondaryIndexAutoScalingUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
