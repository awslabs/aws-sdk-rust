...
pub(crate) fn de_source_table_feature_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SourceTableFeatureDetails>, aws_smithy_json::deserialize::error::DeserializeError>
