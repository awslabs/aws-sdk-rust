...
pub fn ser_delete_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_item::DeleteItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
