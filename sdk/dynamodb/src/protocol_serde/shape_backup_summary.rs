...
pub(crate) fn de_backup_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BackupSummary>, aws_smithy_json::deserialize::error::DeserializeError>
