...
pub(crate) fn de_global_secondary_index_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GlobalSecondaryIndexDescription>, aws_smithy_json::deserialize::error::DeserializeError>
