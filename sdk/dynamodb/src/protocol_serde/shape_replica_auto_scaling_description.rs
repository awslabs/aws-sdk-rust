...
pub(crate) fn de_replica_auto_scaling_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicaAutoScalingDescription>, aws_smithy_json::deserialize::error::DeserializeError>
