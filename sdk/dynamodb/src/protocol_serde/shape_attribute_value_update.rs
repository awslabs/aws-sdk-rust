...
pub fn ser_attribute_value_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AttributeValueUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
