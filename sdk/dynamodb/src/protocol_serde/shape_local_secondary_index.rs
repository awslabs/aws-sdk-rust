...
pub fn ser_local_secondary_index(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::LocalSecondaryIndex) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
