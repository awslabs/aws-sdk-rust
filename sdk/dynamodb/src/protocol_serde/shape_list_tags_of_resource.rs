...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_tags_of_resource_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::list_tags_of_resource::builders::ListTagsOfResourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
