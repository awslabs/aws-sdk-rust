...
pub fn ser_update_global_secondary_index_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateGlobalSecondaryIndexAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
