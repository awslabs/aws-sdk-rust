...
pub fn de_describe_continuous_backups_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_continuous_backups::DescribeContinuousBackupsOutput, crate::operation::describe_continuous_backups::DescribeContinuousBackupsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_continuous_backups_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_continuous_backups::DescribeContinuousBackupsOutput, crate::operation::describe_continuous_backups::DescribeContinuousBackupsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_describe_continuous_backups_input(input: &crate::operation::describe_continuous_backups::DescribeContinuousBackupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
