            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Table" => {
                            builder = builder.set_table(crate::protocol_serde::shape_capacity::de_capacity(tokens, _value)?);
                        }
                        "LocalSecondaryIndexes" => {
                            builder = builder.set_local_secondary_indexes(
                                crate::protocol_serde::shape_secondary_indexes_capacity_map::de_secondary_indexes_capacity_map(tokens, _value)?,
                            );
                        }
