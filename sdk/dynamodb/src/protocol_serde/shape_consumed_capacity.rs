...
pub(crate) fn de_consumed_capacity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConsumedCapacity>, aws_smithy_json::deserialize::error::DeserializeError>
