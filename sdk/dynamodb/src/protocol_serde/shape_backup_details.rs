...
pub(crate) fn de_backup_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BackupDetails>, aws_smithy_json::deserialize::error::DeserializeError>
