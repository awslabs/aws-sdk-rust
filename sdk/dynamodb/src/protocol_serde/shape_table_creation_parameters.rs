...
pub fn ser_table_creation_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableCreationParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_table_creation_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TableCreationParameters>, aws_smithy_json::deserialize::error::DeserializeError>
