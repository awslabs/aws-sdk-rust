...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_write_item_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::batch_write_item::BatchWriteItemOutput, crate::operation::batch_write_item::BatchWriteItemError> {
...
) -> Result<crate::operation::batch_write_item::builders::BatchWriteItemOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
