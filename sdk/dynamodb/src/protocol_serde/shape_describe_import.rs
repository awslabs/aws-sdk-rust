...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_import_input::ser_describe_import_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_import::DescribeImportError::unhandled(generic))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_import_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_import::de_describe_import(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_import::DescribeImportError::unhandled)?;
