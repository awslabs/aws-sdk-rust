...
pub fn de_describe_import_http_response(
    ...
    Ok({
        ...
        crate::serde_util::describe_import_output_correct_errors(output).build()
    })
}
...
) -> Result<crate::operation::describe_import::builders::DescribeImportOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
