...
pub fn ser_update_global_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGlobalTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
