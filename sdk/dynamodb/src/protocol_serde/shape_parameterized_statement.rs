...
pub fn ser_parameterized_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParameterizedStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
