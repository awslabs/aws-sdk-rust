...
pub fn ser_list_backups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListBackupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
