...
pub fn de_create_global_table_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_global_table::CreateGlobalTableOutput, crate::operation::create_global_table::CreateGlobalTableError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_global_table::CreateGlobalTableError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_global_table_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_global_table::CreateGlobalTableOutput, crate::operation::create_global_table::CreateGlobalTableError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_global_table::builders::CreateGlobalTableOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_global_table::de_create_global_table(response.body().as_ref(), output).map_err(crate::operation::create_global_table::CreateGlobalTableError::unhandled)?;
