...
pub fn ser_auto_scaling_policy_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoScalingPolicyUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
