...
pub(crate) fn de_enable_kinesis_streaming_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EnableKinesisStreamingConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
