...
pub fn ser_batch_statement_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchStatementRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
