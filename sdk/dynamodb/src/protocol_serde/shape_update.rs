...
pub fn ser_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Update) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
