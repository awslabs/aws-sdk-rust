...
pub(crate) fn de_auto_scaling_policy_description_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::AutoScalingPolicyDescription>>, aws_smithy_json::deserialize::error::DeserializeError>
