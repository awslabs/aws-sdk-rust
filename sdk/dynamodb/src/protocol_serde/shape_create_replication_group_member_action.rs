...
pub fn ser_create_replication_group_member_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CreateReplicationGroupMemberAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
