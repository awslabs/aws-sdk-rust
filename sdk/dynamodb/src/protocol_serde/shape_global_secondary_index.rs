...
pub fn ser_global_secondary_index(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GlobalSecondaryIndex) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_global_secondary_index<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GlobalSecondaryIndex>, aws_smithy_json::deserialize::error::DeserializeError>
