...
pub(crate) fn de_source_table_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SourceTableDetails>, aws_smithy_json::deserialize::error::DeserializeError>
