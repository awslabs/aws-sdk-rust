...
pub fn ser_put_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
