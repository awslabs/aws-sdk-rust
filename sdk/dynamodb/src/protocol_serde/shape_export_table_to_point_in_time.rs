...
pub fn de_export_table_to_point_in_time_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeOutput, crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_table_to_point_in_time_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeOutput, crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_export_table_to_point_in_time_input(input: &crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
