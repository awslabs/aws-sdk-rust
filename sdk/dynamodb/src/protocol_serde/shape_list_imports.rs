...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_imports::ListImportsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "LimitExceededException" => {
            crate::operation::list_imports::ListImportsError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_imports::ListImportsError::unhandled)?;
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_list_imports::de_list_imports(
