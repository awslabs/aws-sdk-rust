...
) -> Result<crate::operation::list_imports::builders::ListImportsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ImportSummaryList" => {
                    builder = builder.set_import_summary_list(crate::protocol_serde::shape_import_summary_list::de_import_summary_list(tokens)?);
                }
                "NextToken" => {
