...
pub fn ser_list_imports_input(input: &crate::input::ListImportsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::error::ListImportsError::unhandled)?;
...
pub(crate) fn de_list_imports(value: &[u8], mut builder: crate::output::list_imports_output::Builder) -> Result<crate::output::list_imports_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
