...
pub fn ser_replica_auto_scaling_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplicaAutoScalingUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
