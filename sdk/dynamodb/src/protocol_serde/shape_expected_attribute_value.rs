...
pub fn ser_expected_attribute_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExpectedAttributeValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
