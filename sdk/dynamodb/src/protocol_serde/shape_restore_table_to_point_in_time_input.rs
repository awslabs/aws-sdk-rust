...
pub fn ser_restore_table_to_point_in_time_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RestoreTableToPointInTimeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
