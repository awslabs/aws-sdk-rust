...
pub fn ser_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
