...
pub(crate) fn de_auto_scaling_settings_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoScalingSettingsDescription>, aws_smithy_json::deserialize::error::DeserializeError>
