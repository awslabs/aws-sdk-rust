...
pub fn ser_update_continuous_backups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateContinuousBackupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
