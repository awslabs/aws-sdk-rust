...
pub(crate) fn de_import_table_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ImportTableDescription>, aws_smithy_json::deserialize::error::DeserializeError>
