...
pub fn ser_update_replication_group_member_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateReplicationGroupMemberAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
