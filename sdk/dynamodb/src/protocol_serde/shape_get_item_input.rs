...
pub fn ser_get_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
