...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_backups_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_backups::ListBackupsOutput, crate::operation::list_backups::ListBackupsError> {
...
) -> Result<crate::operation::list_backups::builders::ListBackupsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BackupSummaries" => {
                    builder = builder.set_backup_summaries(crate::protocol_serde::shape_backup_summaries::de_backup_summaries(tokens)?);
                }
