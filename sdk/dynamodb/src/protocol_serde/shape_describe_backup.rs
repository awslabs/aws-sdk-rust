...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_backup_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_backup::DescribeBackupOutput, crate::operation::describe_backup::DescribeBackupError> {
...
) -> Result<crate::operation::describe_backup::builders::DescribeBackupOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
