...
pub(crate) fn de_continuous_backups_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContinuousBackupsDescription>, aws_smithy_json::deserialize::error::DeserializeError>
