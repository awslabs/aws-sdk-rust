...
pub fn ser_replication_group_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplicationGroupUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
