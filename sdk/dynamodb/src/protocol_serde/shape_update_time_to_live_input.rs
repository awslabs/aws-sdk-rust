...
pub fn ser_update_time_to_live_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTimeToLiveInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
