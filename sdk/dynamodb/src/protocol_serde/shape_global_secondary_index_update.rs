...
pub fn ser_global_secondary_index_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GlobalSecondaryIndexUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
