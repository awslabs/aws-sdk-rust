...
pub fn ser_transact_write_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TransactWriteItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
