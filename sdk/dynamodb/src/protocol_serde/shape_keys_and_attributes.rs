...
pub fn ser_keys_and_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KeysAndAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_keys_and_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KeysAndAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
