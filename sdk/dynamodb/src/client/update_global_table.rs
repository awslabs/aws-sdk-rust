...
impl super::Client {
    ...
    ///   - [`replica_updates(ReplicaUpdate)`](crate::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::replica_updates) / [`set_replica_updates(Option<Vec<ReplicaUpdate>>)`](crate::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::set_replica_updates): <p>A list of Regions that should be added or removed from the global table.</p>
