...
impl super::Client {
    ...
    ///   - [`global_table_name(impl ::std::convert::Into<String>)`](crate::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::global_table_name) / [`set_global_table_name(Option<String>)`](crate::operation::update_global_table::builders::UpdateGlobalTableFluentBuilder::set_global_table_name): <p>The global table name.</p>
