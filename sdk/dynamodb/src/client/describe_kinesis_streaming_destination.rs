...
impl super::Client  {
    ...
    pub fn describe_kinesis_streaming_destination(&self) -> crate::client::fluent_builders::DescribeKinesisStreamingDestination {
                                crate::client::fluent_builders::DescribeKinesisStreamingDestination::new(self.handle.clone())
                            }
}
