...
impl super::Client {
    ...
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::set_table_name): <p>The name of the table.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::set_next_token): <p>A token to for the desired page, if there is one.</p>
    ///   - [`max_results(i32)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_contributor_insights::builders::ListContributorInsightsFluentBuilder::set_max_results): <p>Maximum number of results to return per page.</p>
