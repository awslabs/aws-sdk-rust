...
impl super::Client {
    ...
    pub fn update_kinesis_streaming_destination(&self) -> crate::operation::update_kinesis_streaming_destination::builders::UpdateKinesisStreamingDestinationFluentBuilder {
