...
impl super::Client {
    ...
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::update_continuous_backups::builders::UpdateContinuousBackupsFluentBuilder::set_table_name): <p>The name of the table.</p>
