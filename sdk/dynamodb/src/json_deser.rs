...
) -> std::result::Result<crate::output::batch_get_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::BatchGetItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::batch_write_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::BatchWriteItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::create_backup_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateBackupOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::create_global_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateGlobalTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::create_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::delete_backup_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DeleteBackupOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::delete_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DeleteItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::delete_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DeleteTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::describe_backup_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeBackupOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn describe_continuous_backups_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::DescribeContinuousBackupsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn describe_contributor_insights_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::DescribeContributorInsightsOutputBody = if input.is_empty()
    {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
...
) -> std::result::Result<crate::output::describe_endpoints_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeEndpointsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::describe_export_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeExportOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::describe_global_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeGlobalTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn describe_global_table_settings_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::DescribeGlobalTableSettingsOutputBody = if input.is_empty()
    {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
...
) -> std::result::Result<crate::output::describe_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::describe_time_to_live_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeTimeToLiveOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::execute_transaction_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ExecuteTransactionOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn export_table_to_point_in_time_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::ExportTableToPointInTimeOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::get_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_backups_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListBackupsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_contributor_insights_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::ListContributorInsightsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_exports_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListExportsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_global_tables_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListGlobalTablesOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_tables_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListTablesOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_tags_of_resource_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListTagsOfResourceOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::put_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::PutItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn query_deser_operation(
...
) -> std::result::Result<crate::output::query_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::QueryOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
    ...
    builder = builder.set_scanned_count(Some(parsed_body.scanned_count));
...
) -> std::result::Result<crate::output::restore_table_from_backup_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::RestoreTableFromBackupOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn restore_table_to_point_in_time_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::RestoreTableToPointInTimeOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::scan_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ScanOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::transact_get_items_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::TransactGetItemsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::transact_write_items_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::TransactWriteItemsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::update_continuous_backups_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::UpdateContinuousBackupsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn update_contributor_insights_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::UpdateContributorInsightsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::update_global_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateGlobalTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn update_global_table_settings_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::UpdateGlobalTableSettingsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::update_item_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateItemOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::update_table_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateTableOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn update_table_replica_auto_scaling_deser_operation(
    ...
    serde_json::Error,
> {
    let parsed_body: crate::serializer::UpdateTableReplicaAutoScalingOutputBody =
        if input.is_empty() {
            // To enable JSON parsing to succeed, replace an empty body
            // with an empty JSON body. If a member was required, it will fail slightly later
            // during the operation construction phase when a required field was missing.
...
) -> std::result::Result<crate::output::update_time_to_live_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateTimeToLiveOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
