...
pub fn ser_create_notification_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNotificationRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
