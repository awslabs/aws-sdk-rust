...
pub fn ser_subscribe_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SubscribeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
