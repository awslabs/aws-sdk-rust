...
impl From<crate::error::CreateNotificationRuleError> for Error {
    fn from(err: crate::error::CreateNotificationRuleError) -> Self {
        match err {
            crate::error::CreateNotificationRuleError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::error::CreateNotificationRuleError::ConcurrentModificationException(inner) => Error::ConcurrentModificationException(inner),
            crate::error::CreateNotificationRuleError::ConfigurationException(inner) => Error::ConfigurationException(inner),
            crate::error::CreateNotificationRuleError::LimitExceededException(inner) => Error::LimitExceededException(inner),
            crate::error::CreateNotificationRuleError::ResourceAlreadyExistsException(inner) => Error::ResourceAlreadyExistsException(inner),
            crate::error::CreateNotificationRuleError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::DeleteNotificationRuleError> for Error {
    fn from(err: crate::error::DeleteNotificationRuleError) -> Self {
        match err {
            crate::error::DeleteNotificationRuleError::ConcurrentModificationException(inner) => Error::ConcurrentModificationException(inner),
            crate::error::DeleteNotificationRuleError::LimitExceededException(inner) => Error::LimitExceededException(inner),
            crate::error::DeleteNotificationRuleError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::DeleteTargetError> for Error {
    fn from(err: crate::error::DeleteTargetError) -> Self {
        match err {
            crate::error::DeleteTargetError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::DescribeNotificationRuleError> for Error {
    fn from(err: crate::error::DescribeNotificationRuleError) -> Self {
        match err {
            crate::error::DescribeNotificationRuleError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::error::DescribeNotificationRuleError::ValidationException(inner) => Error::ValidationException(inner),
            crate::error::DescribeNotificationRuleError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
...
impl From<crate::error::ListEventTypesError> for Error {
    fn from(err: crate::error::ListEventTypesError) -> Self {
        match err {
            crate::error::ListEventTypesError::InvalidNextTokenException(inner) => Error::InvalidNextTokenException(inner),
            crate::error::ListEventTypesError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::ListNotificationRulesError> for Error {
    fn from(err: crate::error::ListNotificationRulesError) -> Self {
        match err {
            crate::error::ListNotificationRulesError::InvalidNextTokenException(inner) => Error::InvalidNextTokenException(inner),
            crate::error::ListNotificationRulesError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::ListTargetsError> for Error {
    fn from(err: crate::error::ListTargetsError) -> Self {
        match err {
            crate::error::ListTargetsError::InvalidNextTokenException(inner) => Error::InvalidNextTokenException(inner),
            crate::error::ListTargetsError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::SubscribeError> for Error {
    fn from(err: crate::error::SubscribeError) -> Self {
        match err {
            crate::error::SubscribeError::ConfigurationException(inner) => Error::ConfigurationException(inner),
            crate::error::SubscribeError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::error::SubscribeError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::UnsubscribeError> for Error {
    fn from(err: crate::error::UnsubscribeError) -> Self {
        match err {
            crate::error::UnsubscribeError::ValidationException(inner) => Error::ValidationException(inner),
...
impl From<crate::error::UpdateNotificationRuleError> for Error {
    fn from(err: crate::error::UpdateNotificationRuleError) -> Self {
        match err {
            crate::error::UpdateNotificationRuleError::ConfigurationException(inner) => Error::ConfigurationException(inner),
            crate::error::UpdateNotificationRuleError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::error::UpdateNotificationRuleError::ValidationException(inner) => Error::ValidationException(inner),
