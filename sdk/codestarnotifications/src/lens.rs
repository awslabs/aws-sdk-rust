...
pub(crate) fn reflens_list_event_types_output_next_token(
...
pub(crate) fn reflens_list_notification_rules_output_next_token(
...
pub(crate) fn lens_list_event_types_output_event_types(
    input: crate::operation::list_event_types::ListEventTypesOutput,
...
pub(crate) fn lens_list_notification_rules_output_notification_rules(
    input: crate::operation::list_notification_rules::ListNotificationRulesOutput,
...
pub(crate) fn lens_list_targets_output_targets(
    input: crate::operation::list_targets::ListTargetsOutput,
