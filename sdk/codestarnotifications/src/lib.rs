...
//! aws-sdk-codestarnotifications = "0.58.0"
...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("codestarnotifications", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS CodeStar Notifications.
pub mod client;
