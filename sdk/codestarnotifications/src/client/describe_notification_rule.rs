...
impl super::Client {
    ...
    ///   - [`arn(String)`](crate::operation::describe_notification_rule::DescribeNotificationRuleOutput::arn): <p>The Amazon Resource Name (ARN) of the notification rule.</p>
    ...
    ///   - [`targets(Option<Vec::<TargetSummary>>)`](crate::operation::describe_notification_rule::DescribeNotificationRuleOutput::targets): <p>A list of the Amazon Q Developer in chat applications topics and Amazon Q Developer in chat applications clients associated with the notification rule.</p>
