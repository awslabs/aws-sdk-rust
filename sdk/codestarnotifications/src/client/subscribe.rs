...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::subscribe::builders::SubscribeFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::subscribe::builders::SubscribeFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the notification rule for which you want to create the association.</p><br>
    ///   - [`target(Target)`](crate::operation::subscribe::builders::SubscribeFluentBuilder::target) / [`set_target(Option<Target>)`](crate::operation::subscribe::builders::SubscribeFluentBuilder::set_target):<br>required: **true**<br><p>Information about the Amazon Q Developer in chat applications topics or Amazon Q Developer in chat applications clients associated with a notification rule.</p><br>
