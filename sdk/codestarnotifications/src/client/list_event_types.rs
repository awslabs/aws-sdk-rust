...
impl super::Client {
    ...
    ///   - [`filters(ListEventTypesFilter)`](crate::operation::list_event_types::builders::ListEventTypesFluentBuilder::filters) / [`set_filters(Option<Vec<ListEventTypesFilter>>)`](crate::operation::list_event_types::builders::ListEventTypesFluentBuilder::set_filters): <p>The filters to use to return information by service or resource type.</p>
