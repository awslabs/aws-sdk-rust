...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the notification rule to tag.</p>
