...
pub struct ListTargetsOutput  {
    ...
    #[doc(hidden)]pub targets: std::option::Option<std::vec::Vec<crate::model::TargetSummary>>,
...
pub struct ListNotificationRulesOutput  {
    ...
    #[doc(hidden)]pub notification_rules: std::option::Option<std::vec::Vec<crate::model::NotificationRuleSummary>>,
}
...
pub struct ListEventTypesOutput  {
    ...
    #[doc(hidden)]pub event_types: std::option::Option<std::vec::Vec<crate::model::EventTypeSummary>>,
    /// <p>An enumeration token that can be used in a request to return the next batch of the results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeNotificationRuleOutput  {
    ...
    #[doc(hidden)]pub detail_type: std::option::Option<crate::model::DetailType>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::NotificationRuleStatus>,
