...
impl Builder {
    ...
    /// use aws_sdk_codestarnotifications::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_codestarnotifications::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
