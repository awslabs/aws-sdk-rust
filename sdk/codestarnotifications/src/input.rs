...
pub mod create_notification_rule_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateNotificationRuleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateNotificationRuleInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateNotificationRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_request_token.is_none() {
                                self.client_request_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::CreateNotificationRuleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod delete_notification_rule_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteNotificationRuleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteNotificationRuleInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteNotificationRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeleteNotificationRuleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod delete_target_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteTargetInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteTargetInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteTarget, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeleteTargetInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod describe_notification_rule_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeNotificationRuleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeNotificationRuleInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeNotificationRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeNotificationRuleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod list_event_types_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListEventTypesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListEventTypesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListEventTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListEventTypesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod list_notification_rules_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListNotificationRulesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListNotificationRulesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListNotificationRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListNotificationRulesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod list_targets_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListTargetsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListTargetsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListTargets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListTargetsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UntagResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::UntagResourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                if let Some(inner_2) = &_input.tag_keys {
...
pub mod update_notification_rule_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateNotificationRuleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateNotificationRuleInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateNotificationRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateNotificationRuleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub struct UpdateNotificationRuleInput  {
    ...
    /// <p>A list of event types associated with this notification rule. For a complete list of event types and IDs, see <a href="https://docs.aws.amazon.com/codestar-notifications/latest/userguide/concepts.html#concepts-api">Notification concepts</a> in the <i>Developer Tools Console User Guide</i>.</p>
    #[doc(hidden)]pub event_type_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The address and type of the targets to receive notifications from this notification rule.</p>
...
pub struct ListTargetsInput  {
    ...
    /// <p>A filter with the same name can appear more than once when used with OR statements. Filters with different names should be applied with AND statements.</p> 
    /// </note>
    #[doc(hidden)]pub filters: std::option::Option<std::vec::Vec<crate::model::ListTargetsFilter>>,
    /// <p>An enumeration token that, when provided in a request, returns the next batch of the results.</p>
...
pub struct ListNotificationRulesInput  {
    ...
    /// <p>A filter with the same name can appear more than once when used with OR statements. Filters with different names should be applied with AND statements.</p> 
    /// </note>
    #[doc(hidden)]pub filters: std::option::Option<std::vec::Vec<crate::model::ListNotificationRulesFilter>>,
    /// <p>An enumeration token that, when provided in a request, returns the next batch of the results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>A non-negative integer used to limit the number of returned results. The maximum number of results that can be returned is 100.</p>
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
...
pub struct ListEventTypesInput  {
    /// <p>The filters to use to return information by service or resource type.</p>
    #[doc(hidden)]pub filters: std::option::Option<std::vec::Vec<crate::model::ListEventTypesFilter>>,
    /// <p>An enumeration token that, when provided in a request, returns the next batch of the results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>A non-negative integer used to limit the number of returned results. The default number is 50. The maximum number of results that can be returned is 100.</p>
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
...
pub struct DeleteTargetInput  {
    ...
    #[doc(hidden)]pub target_address: std::option::Option<std::string::String>,
    /// <p>A Boolean value that can be used to delete all associations with this Chatbot topic. The default value is FALSE. If set to TRUE, all associations between that target and every notification rule in your Amazon Web Services account are deleted.</p>
    #[doc(hidden)]pub force_unsubscribe_all: bool,
}
impl DeleteTargetInput {
    /// <p>The Amazon Resource Name (ARN) of the Chatbot topic or Chatbot client to delete.</p>
    pub fn target_address(&self) -> std::option::Option<& str> {
