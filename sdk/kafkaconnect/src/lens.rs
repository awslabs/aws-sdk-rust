...
pub(crate) fn reflens_list_custom_plugins_output_next_token(
...
pub(crate) fn reflens_list_worker_configurations_output_next_token(
...
pub(crate) fn lens_list_custom_plugins_output_custom_plugins(
    input: crate::operation::list_custom_plugins::ListCustomPluginsOutput,
...
pub(crate) fn lens_list_worker_configurations_output_worker_configurations(
    input: crate::operation::list_worker_configurations::ListWorkerConfigurationsOutput,
