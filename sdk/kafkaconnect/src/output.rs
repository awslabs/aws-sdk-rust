...
pub struct ListWorkerConfigurationsOutput  {
    ...
    #[doc(hidden)]pub worker_configurations: std::option::Option<std::vec::Vec<crate::model::WorkerConfigurationSummary>>,
}
...
pub struct ListCustomPluginsOutput  {
    ...
    #[doc(hidden)]pub custom_plugins: std::option::Option<std::vec::Vec<crate::model::CustomPluginSummary>>,
...
pub struct ListConnectorsOutput  {
    ...
    #[doc(hidden)]pub connectors: std::option::Option<std::vec::Vec<crate::model::ConnectorSummary>>,
...
pub struct DescribeWorkerConfigurationOutput  {
    ...
    #[doc(hidden)]pub latest_revision: std::option::Option<crate::model::WorkerConfigurationRevisionDescription>,
...
pub struct DescribeCustomPluginOutput  {
    ...
    #[doc(hidden)]pub state_description: std::option::Option<crate::model::StateDescription>,
}
