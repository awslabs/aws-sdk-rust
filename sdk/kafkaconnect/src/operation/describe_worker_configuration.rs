    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeWorkerConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeWorkerConfiguration", "kafkaconnect"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeWorkerConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeWorkerConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("worker_configuration_arn", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeWorkerConfigurationEndpointParamsInterceptor {
