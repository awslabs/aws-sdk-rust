...
impl DescribeWorkerConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_worker_configuration::DescribeWorkerConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkerConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_worker_configuration::de_describe_worker_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
