...
pub use crate::operation::describe_worker_configuration::_describe_worker_configuration_output::DescribeWorkerConfigurationOutputBuilder;

pub use crate::operation::describe_worker_configuration::_describe_worker_configuration_input::DescribeWorkerConfigurationInputBuilder;
...
impl DescribeWorkerConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_worker_configuration();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_worker_configuration::DescribeWorkerConfigurationOutput,
                    crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError,
                > for DescribeWorkerConfigurationFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeWorkerConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_worker_configuration::DescribeWorkerConfiguration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_worker_configuration::DescribeWorkerConfiguration::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationOutput, crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError, Self> {
    ...
    pub fn get_worker_configuration_arn(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_worker_configuration_arn()
    }
}
