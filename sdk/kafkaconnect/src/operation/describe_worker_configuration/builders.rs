...
impl crate::operation::describe_worker_configuration::builders::DescribeWorkerConfigurationInputBuilder {
...
impl DescribeWorkerConfigurationFluentBuilder {
    /// Creates a new `DescribeWorkerConfigurationFluentBuilder`.
