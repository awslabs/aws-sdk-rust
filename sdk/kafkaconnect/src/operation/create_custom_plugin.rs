...
impl CreateCustomPluginInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_custom_plugin::ser_create_custom_plugin_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomPlugin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_custom_plugin::de_create_custom_plugin_http_response_with_props(status, headers, body)
        }
    }
}
