...
impl CreateCustomPluginInput {
    /// Consumes the builder and constructs an Operation<[`CreateCustomPlugin`](crate::operation::create_custom_plugin::CreateCustomPlugin)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_custom_plugin::CreateCustomPlugin, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_custom_plugin::CreateCustomPluginInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_custom_plugin::ser_create_custom_plugin_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_custom_plugin::CreateCustomPlugin::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateCustomPlugin {
                type Output = std::result::Result<crate::operation::create_custom_plugin::CreateCustomPluginOutput, crate::operation::create_custom_plugin::CreateCustomPluginError>;
