...
impl ListWorkerConfigurationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_worker_configurations::ListWorkerConfigurations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkerConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_worker_configurations::de_list_worker_configurations_http_response_with_props(status, headers, body)
        }
    }
}
