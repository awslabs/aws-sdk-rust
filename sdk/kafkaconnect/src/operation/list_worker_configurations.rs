    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/worker-configurations")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_worker_configurations::ListWorkerConfigurations::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_worker_configurations::ListWorkerConfigurationsError
{
