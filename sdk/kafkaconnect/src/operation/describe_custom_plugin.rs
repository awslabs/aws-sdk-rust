...
/// Orchestration and serialization glue logic for `DescribeCustomPlugin`.
...
impl DescribeCustomPlugin {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_custom_plugin::DescribeCustomPluginInput,
                    ) -> ::std::result::Result<crate::operation::describe_custom_plugin::DescribeCustomPluginOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_custom_plugin::DescribeCustomPluginError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_custom_plugin::DescribeCustomPluginError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_custom_plugin::DescribeCustomPluginOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCustomPlugin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCustomPlugin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCustomPluginRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCustomPluginResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCustomPlugin")
...
.with_interceptor(DescribeCustomPluginEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_custom_plugin::DescribeCustomPluginError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_custom_plugin::DescribeCustomPluginError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_custom_plugin::DescribeCustomPluginError>::new());
...
#[derive(Debug)]
            struct DescribeCustomPluginResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCustomPluginResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_custom_plugin::de_describe_custom_plugin_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_custom_plugin::de_describe_custom_plugin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeCustomPluginRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCustomPluginRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_custom_plugin::DescribeCustomPluginInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_custom_plugin::DescribeCustomPluginInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.custom_plugin_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("custom_plugin_arn", "cannot be empty or unset"))?;
    let custom_plugin_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if custom_plugin_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("custom_plugin_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v1/custom-plugins/{customPluginArn}", customPluginArn = custom_plugin_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeCustomPluginEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCustomPluginEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCustomPluginEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCustomPluginInput>()
                        .ok_or("failed to downcast to DescribeCustomPluginInput")?;
...
pub enum DescribeCustomPluginError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCustomPluginError) for what information is available for the error.")]
...
impl DescribeCustomPluginError {
    /// Creates the `DescribeCustomPluginError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCustomPluginError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCustomPluginError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_custom_plugin::DescribeCustomPluginError {
...
mod _describe_custom_plugin_output;
