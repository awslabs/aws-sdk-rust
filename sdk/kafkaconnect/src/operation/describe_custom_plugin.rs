...
impl DescribeCustomPluginInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_custom_plugin::DescribeCustomPlugin,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCustomPlugin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_custom_plugin::de_describe_custom_plugin_http_response_with_props(status, headers, body)
        }
    }
}
