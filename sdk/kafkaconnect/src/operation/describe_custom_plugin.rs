...
impl DescribeCustomPluginInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCustomPlugin`](crate::operation::describe_custom_plugin::DescribeCustomPlugin)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_custom_plugin::DescribeCustomPlugin, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_custom_plugin::DescribeCustomPluginInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.custom_plugin_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("custom_plugin_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_custom_plugin::DescribeCustomPlugin::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCustomPlugin {
                type Output = std::result::Result<crate::operation::describe_custom_plugin::DescribeCustomPluginOutput, crate::operation::describe_custom_plugin::DescribeCustomPluginError>;
