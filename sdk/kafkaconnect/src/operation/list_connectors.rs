...
impl ListConnectors {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KafkaConnect", "ListConnectors", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListConnectorsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("connectorNamePrefix") {
            if let ::std::option::Option::Some(value) = input.connector_name_prefix.as_deref() {
                captured.insert("connectorNamePrefix", value);
            }
        }
