...
impl DeleteCustomPluginInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCustomPlugin`](crate::operation::delete_custom_plugin::DeleteCustomPlugin)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_custom_plugin::DeleteCustomPlugin, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_custom_plugin::DeleteCustomPluginInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_custom_plugin::DeleteCustomPlugin::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCustomPlugin {
                type Output = std::result::Result<crate::operation::delete_custom_plugin::DeleteCustomPluginOutput, crate::operation::delete_custom_plugin::DeleteCustomPluginError>;
