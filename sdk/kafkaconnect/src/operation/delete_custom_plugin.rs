...
impl DeleteCustomPluginInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_custom_plugin::DeleteCustomPlugin,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomPlugin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_plugin::de_delete_custom_plugin_http_response_with_props(status, headers, body)
        }
    }
}
