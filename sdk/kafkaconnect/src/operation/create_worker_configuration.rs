...
impl CreateWorkerConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_worker_configuration::CreateWorkerConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkerConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_worker_configuration::de_create_worker_configuration_http_response_with_props(status, headers, body)
        }
    }
}
