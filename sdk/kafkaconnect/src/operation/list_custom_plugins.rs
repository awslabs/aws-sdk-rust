...
impl ListCustomPluginsInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomPlugins`](crate::operation::list_custom_plugins::ListCustomPlugins)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_custom_plugins::ListCustomPlugins, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_plugins::ListCustomPluginsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/custom-plugins").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_custom_plugins::ListCustomPluginsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_plugins::ListCustomPlugins::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListCustomPlugins {
                type Output = std::result::Result<crate::operation::list_custom_plugins::ListCustomPluginsOutput, crate::operation::list_custom_plugins::ListCustomPluginsError>;
