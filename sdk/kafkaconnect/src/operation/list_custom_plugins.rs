...
impl ListCustomPluginsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_custom_plugins::ListCustomPlugins,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomPlugins {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_plugins::de_list_custom_plugins_http_response_with_props(status, headers, body)
        }
    }
}
