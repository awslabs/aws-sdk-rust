        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_worker_configurations::ListWorkerConfigurations::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListWorkerConfigurationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_worker_configurations_output_output_worker_configurations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
