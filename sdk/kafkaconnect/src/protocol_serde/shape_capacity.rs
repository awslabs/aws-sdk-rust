...
pub fn ser_capacity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Capacity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
