...
pub fn ser_create_custom_plugin_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCustomPluginInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
