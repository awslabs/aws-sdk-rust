...
impl super::Client {
    ...
    ///   - [`connector_arn(impl Into<String>)`](crate::operation::describe_connector::builders::DescribeConnectorFluentBuilder::connector_arn) / [`set_connector_arn(impl Into<String>)`](crate::operation::describe_connector::builders::DescribeConnectorFluentBuilder::set_connector_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the connector that you want to describe.</p><br>
