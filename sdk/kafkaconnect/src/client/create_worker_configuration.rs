...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_worker_configuration::builders::CreateWorkerConfigurationFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_worker_configuration::builders::CreateWorkerConfigurationFluentBuilder::set_tags):<br>required: **false**<br><p>The tags you want to attach to the worker configuration.</p><br>
    ...
    ///   - [`worker_configuration_state(Option<WorkerConfigurationState>)`](crate::operation::create_worker_configuration::CreateWorkerConfigurationOutput::worker_configuration_state): <p>The state of the worker configuration.</p>
