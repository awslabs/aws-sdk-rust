...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::set_tags):<br>required: **false**<br><p>The tags you want to attach to the custom plugin.</p><br>
