...
impl super::Client {
    ...
    ///   - [`content_type(CustomPluginContentType)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::content_type) / [`set_content_type(CustomPluginContentType)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::set_content_type):<br>required: **true**<br><p>The type of the plugin file.</p><br>
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::set_name):<br>required: **true**<br><p>The name of the custom plugin.</p><br>
