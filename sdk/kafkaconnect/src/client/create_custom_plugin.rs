...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::set_description): <p>A summary description of the custom plugin.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_custom_plugin::builders::CreateCustomPluginFluentBuilder::set_name): <p>The name of the custom plugin.</p>
