...
impl super::Client {
    ...
    ///   - [`connector_arn(impl Into<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::connector_arn) / [`set_connector_arn(impl Into<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::set_connector_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the connector that you want to delete.</p><br>
    ///   - [`current_version(impl Into<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::set_current_version):<br>required: **false**<br><p>The current version of the connector that you want to delete.</p><br>
