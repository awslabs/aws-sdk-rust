...
impl super::Client {
    ...
    pub fn describe_worker_configuration(
        &self,
    ) -> crate::operation::describe_worker_configuration::builders::DescribeWorkerConfigurationFluentBuilder {
