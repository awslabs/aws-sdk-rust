...
impl super::Client {
    ...
    ///   - [`custom_plugin_arn(impl Into<String>)`](crate::operation::describe_custom_plugin::builders::DescribeCustomPluginFluentBuilder::custom_plugin_arn) / [`set_custom_plugin_arn(Option<String>)`](crate::operation::describe_custom_plugin::builders::DescribeCustomPluginFluentBuilder::set_custom_plugin_arn):<br>required: **true**<br><p>Returns information about a custom plugin.</p><br>
