...
impl super::Client {
    ...
    ///   - [`names(Vec<String>)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::set_names): <p>The names of the app block builders.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::set_next_token): <p>The pagination token used to retrieve the next page of results for this operation.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_app_block_builders::builders::DescribeAppBlockBuildersFluentBuilder::set_max_results): <p>The maximum size of each page of results. The maximum value is 25.</p>
