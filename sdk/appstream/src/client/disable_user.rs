...
impl super::Client {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::set_user_name): <p>The email address of the user.</p> <note>   <p>Users' email addresses are case-sensitive.</p>  </note>
