...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::stop_app_block_builder::builders::StopAppBlockBuilderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::stop_app_block_builder::builders::StopAppBlockBuilderFluentBuilder::set_name): <p>The name of the app block builder.</p>
