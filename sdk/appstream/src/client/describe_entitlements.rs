...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::describe_entitlements::builders::DescribeEntitlementsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_entitlements::builders::DescribeEntitlementsFluentBuilder::set_name):<br>required: **false**<br><p>The name of the entitlement.</p><br>
