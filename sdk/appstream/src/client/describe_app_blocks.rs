...
impl super::Client {
    ...
    ///   - [`arns(impl Into<String>)`](crate::operation::describe_app_blocks::builders::DescribeAppBlocksFluentBuilder::arns) / [`set_arns(Option<Vec<String>>)`](crate::operation::describe_app_blocks::builders::DescribeAppBlocksFluentBuilder::set_arns): <p>The ARNs of the app blocks.</p>
