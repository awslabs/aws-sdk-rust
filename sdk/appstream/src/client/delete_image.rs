...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_image::builders::DeleteImageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_image::builders::DeleteImageFluentBuilder::set_name):<br>required: **true**<br><p>The name of the image.</p><br>
