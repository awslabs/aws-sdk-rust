...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_image::builders::DeleteImageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_image::builders::DeleteImageFluentBuilder::set_name): <p>The name of the image.</p>
