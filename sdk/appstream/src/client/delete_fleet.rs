...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the fleet.</p><br>
