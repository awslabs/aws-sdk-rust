...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_app_block::builders::CreateAppBlockFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_app_block::builders::CreateAppBlockFluentBuilder::set_tags): <p>The tags assigned to the app block.</p>
