...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::stop_image_builder::builders::StopImageBuilderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::stop_image_builder::builders::StopImageBuilderFluentBuilder::set_name):<br>required: **true**<br><p>The name of the image builder.</p><br>
