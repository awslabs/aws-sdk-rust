...
impl super::Client {
    ...
    ///   - [`arns(impl Into<String>)`](crate::operation::describe_applications::builders::DescribeApplicationsFluentBuilder::arns) / [`set_arns(Option<Vec<String>>)`](crate::operation::describe_applications::builders::DescribeApplicationsFluentBuilder::set_arns): <p>The ARNs for the applications.</p>
