...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::set_name): <p>The name of the application. This name is visible to users when display name is not specified.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::set_display_name): <p>The display name of the application. This name is visible to users in the application catalog.</p>
    ...
    ///   - [`launch_path(impl ::std::convert::Into<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::launch_path) / [`set_launch_path(Option<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::set_launch_path): <p>The launch path of the application.</p>
    ///   - [`working_directory(impl ::std::convert::Into<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::working_directory) / [`set_working_directory(Option<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::set_working_directory): <p>The working directory of the application.</p>
    ///   - [`launch_parameters(impl ::std::convert::Into<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::launch_parameters) / [`set_launch_parameters(Option<String>)`](crate::operation::create_application::builders::CreateApplicationFluentBuilder::set_launch_parameters): <p>The launch parameters of the application.</p>
