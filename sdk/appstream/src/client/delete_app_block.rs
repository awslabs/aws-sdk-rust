...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_app_block::builders::DeleteAppBlockFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_app_block::builders::DeleteAppBlockFluentBuilder::set_name):<br>required: **true**<br><p>The name of the app block.</p><br>
