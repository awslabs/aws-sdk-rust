...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_image_permissions::builders::DeleteImagePermissionsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_image_permissions::builders::DeleteImagePermissionsFluentBuilder::set_name):<br>required: **true**<br><p>The name of the private image.</p><br>
    ///   - [`shared_account_id(impl Into<String>)`](crate::operation::delete_image_permissions::builders::DeleteImagePermissionsFluentBuilder::shared_account_id) / [`set_shared_account_id(Option<String>)`](crate::operation::delete_image_permissions::builders::DeleteImagePermissionsFluentBuilder::set_shared_account_id):<br>required: **true**<br><p>The 12-digit identifier of the AWS account for which to delete image permissions.</p><br>
