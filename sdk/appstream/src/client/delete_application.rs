...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_application::builders::DeleteApplicationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_application::builders::DeleteApplicationFluentBuilder::set_name):<br>required: **true**<br><p>The name of the application.</p><br>
