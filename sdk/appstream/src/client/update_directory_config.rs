...
impl super::Client {
    ...
    ///   - [`directory_name(impl ::std::convert::Into<String>)`](crate::operation::update_directory_config::builders::UpdateDirectoryConfigFluentBuilder::directory_name) / [`set_directory_name(Option<String>)`](crate::operation::update_directory_config::builders::UpdateDirectoryConfigFluentBuilder::set_directory_name): <p>The name of the Directory Config object.</p>
