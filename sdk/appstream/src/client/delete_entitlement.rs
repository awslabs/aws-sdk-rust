...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_entitlement::builders::DeleteEntitlementFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_entitlement::builders::DeleteEntitlementFluentBuilder::set_name): <p>The name of the entitlement.</p>
