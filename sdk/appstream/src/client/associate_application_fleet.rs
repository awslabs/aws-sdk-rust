...
impl super::Client {
    ...
    ///   - [`fleet_name(impl Into<String>)`](crate::operation::associate_application_fleet::builders::AssociateApplicationFleetFluentBuilder::fleet_name) / [`set_fleet_name(Option<String>)`](crate::operation::associate_application_fleet::builders::AssociateApplicationFleetFluentBuilder::set_fleet_name):<br>required: **true**<br><p>The name of the fleet.</p><br>
