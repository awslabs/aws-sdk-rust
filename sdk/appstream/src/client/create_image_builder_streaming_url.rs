...
impl super::Client {
    ...
    ///   - [`streaming_url(Option<String>)`](crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingUrlOutput::streaming_url): <p>The URL to start the WorkSpaces Applications streaming session.</p>
