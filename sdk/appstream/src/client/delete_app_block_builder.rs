...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_app_block_builder::builders::DeleteAppBlockBuilderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_app_block_builder::builders::DeleteAppBlockBuilderFluentBuilder::set_name): <p>The name of the app block builder.</p>
