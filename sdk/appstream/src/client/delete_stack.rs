...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_stack::builders::DeleteStackFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_stack::builders::DeleteStackFluentBuilder::set_name):<br>required: **true**<br><p>The name of the stack.</p><br>
