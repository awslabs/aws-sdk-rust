...
impl super::Client {
    ...
    ///   - [`app_block_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_app_block_builder_app_block::builders::AssociateAppBlockBuilderAppBlockFluentBuilder::app_block_arn) / [`set_app_block_arn(Option<String>)`](crate::operation::associate_app_block_builder_app_block::builders::AssociateAppBlockBuilderAppBlockFluentBuilder::set_app_block_arn): <p>The ARN of the app block.</p>
    ///   - [`app_block_builder_name(impl ::std::convert::Into<String>)`](crate::operation::associate_app_block_builder_app_block::builders::AssociateAppBlockBuilderAppBlockFluentBuilder::app_block_builder_name) / [`set_app_block_builder_name(Option<String>)`](crate::operation::associate_app_block_builder_app_block::builders::AssociateAppBlockBuilderAppBlockFluentBuilder::set_app_block_builder_name): <p>The name of the app block builder.</p>
