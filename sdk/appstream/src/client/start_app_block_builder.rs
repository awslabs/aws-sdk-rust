...
impl super::Client {
    ...
    pub fn start_app_block_builder(
        &self,
    ) -> crate::operation::start_app_block_builder::builders::StartAppBlockBuilderFluentBuilder
    {
        crate::operation::start_app_block_builder::builders::StartAppBlockBuilderFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
