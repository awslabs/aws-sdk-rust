...
impl super::Client {
    ...
    ///   - [`message_action(MessageAction)`](crate::operation::create_user::builders::CreateUserFluentBuilder::message_action) / [`set_message_action(Option<MessageAction>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_message_action):<br>required: **false**<br><p>The action to take for the welcome email that is sent to a user after the user is created in the user pool. If you specify SUPPRESS, no email is sent. If you specify RESEND, do not specify the first name or last name of the user. If the value is null, the email is sent.</p><note>  <p>The temporary password in the welcome email is valid for only 7 days. If users don’t set their passwords within 7 days, you must send them a new welcome email.</p> </note><br>
    ///   - [`first_name(impl Into<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::first_name) / [`set_first_name(Option<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_first_name):<br>required: **false**<br><p>The first name, or given name, of the user.</p><br>
    ///   - [`last_name(impl Into<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::last_name) / [`set_last_name(Option<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_last_name):<br>required: **false**<br><p>The last name, or surname, of the user.</p><br>
