...
impl super::Client {
    ...
    ///   - [`authentication_type(AuthenticationType)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::authentication_type) / [`set_authentication_type(Option<AuthenticationType>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_authentication_type):<br>required: **true**<br><p>The authentication type for the users in the user pool to describe. You must specify USERPOOL.</p><br>
