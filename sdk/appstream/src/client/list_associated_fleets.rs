...
impl super::Client {
    ...
    ///   - [`stack_name(impl ::std::convert::Into<String>)`](crate::operation::list_associated_fleets::builders::ListAssociatedFleetsFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::list_associated_fleets::builders::ListAssociatedFleetsFluentBuilder::set_stack_name): <p>The name of the stack.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_associated_fleets::builders::ListAssociatedFleetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_associated_fleets::builders::ListAssociatedFleetsFluentBuilder::set_next_token): <p>The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.</p>
