...
pub fn ser_update_stack_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStackInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
