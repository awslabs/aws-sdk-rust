...
pub fn ser_create_stack_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_create_stack_input::ser_create_stack_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::create_stack::builders::CreateStackOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
