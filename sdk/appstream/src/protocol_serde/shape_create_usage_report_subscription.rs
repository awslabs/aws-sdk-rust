...
> {
    ...
    Err(match error_code {
        "InvalidAccountStatusException" => {
            crate::operation::create_usage_report_subscription::CreateUsageReportSubscriptionError::InvalidAccountStatusException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_usage_report_subscription::de_create_usage_report_subscription(_response_body, output)
            .map_err(crate::operation::create_usage_report_subscription::CreateUsageReportSubscriptionError::unhandled)?;
