...
pub fn ser_create_app_block_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAppBlockInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
