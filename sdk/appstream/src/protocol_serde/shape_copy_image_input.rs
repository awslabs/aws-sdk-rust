...
pub fn ser_copy_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CopyImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
