...
pub(crate) fn de_directory_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DirectoryConfig>, aws_smithy_json::deserialize::error::DeserializeError>
