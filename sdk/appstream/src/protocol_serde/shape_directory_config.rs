...
pub(crate) fn de_directory_config<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::DirectoryConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "OrganizationalUnitDistinguishedNames" => {
                            builder = builder.set_organizational_unit_distinguished_names(
                                    crate::protocol_serde::shape_organizational_unit_distinguished_names_list::de_organizational_unit_distinguished_names_list(tokens, _value, depth + 1)?
                                );
                        }
                        "ServiceAccountCredentials" => {
                            builder = builder.set_service_account_credentials(
                                crate::protocol_serde::shape_service_account_credentials::de_service_account_credentials(tokens, _value, depth + 1)?,
                            );
                        }
                        "CreatedTime" => {
            ...
            Ok(Some(crate::serde_util::directory_config_correct_errors(builder).build()))
        }
