...
pub fn ser_create_image_builder_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateImageBuilderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
