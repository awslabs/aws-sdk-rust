                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "State" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ImageBuilderState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StateChangeReason" => {
                        ...
                        "DomainJoinInfo" => {
                            builder = builder.set_domain_join_info(crate::protocol_serde::shape_domain_join_info::de_domain_join_info(tokens)?);
                        }
                        ...
                        "ImageBuilderErrors" => {
                            builder = builder.set_image_builder_errors(crate::protocol_serde::shape_resource_errors::de_resource_errors(tokens)?);
                        }
