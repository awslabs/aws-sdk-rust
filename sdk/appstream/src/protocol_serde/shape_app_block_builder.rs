...
pub(crate) fn de_app_block_builder<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AppBlockBuilder>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Platform" => {
                                builder = builder.set_platform(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AppBlockBuilderPlatformType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "State" => {
                                builder = builder.set_state(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AppBlockBuilderState::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "AppBlockBuilderErrors" => {
                                builder = builder.set_app_block_builder_errors(
