...
pub fn ser_create_entitlement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_entitlement::CreateEntitlementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
