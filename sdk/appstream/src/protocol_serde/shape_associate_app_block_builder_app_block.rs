...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "AppBlockBuilderAppBlockAssociation" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_app_block_builder_app_block_association(Some(
