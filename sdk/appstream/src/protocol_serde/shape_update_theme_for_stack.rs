...
pub fn de_update_theme_for_stack_http_error(
...
> {
    ...
    let mut generic_builder = crate::cbor_errors::parse_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_theme_for_stack::UpdateThemeForStackError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::update_theme_for_stack::UpdateThemeForStackError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ConcurrentModificationException" => crate::operation::update_theme_for_stack::UpdateThemeForStackError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidAccountStatusException" => crate::operation::update_theme_for_stack::UpdateThemeForStackError::InvalidAccountStatusException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterCombinationException" => {
            crate::operation::update_theme_for_stack::UpdateThemeForStackError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => crate::operation::update_theme_for_stack::UpdateThemeForStackError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationNotPermittedException" => crate::operation::update_theme_for_stack::UpdateThemeForStackError::OperationNotPermittedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::update_theme_for_stack::UpdateThemeForStackError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::update_theme_for_stack::UpdateThemeForStackError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_update_theme_for_stack_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_theme_for_stack::builders::UpdateThemeForStackOutputBuilder::default();
        output = crate::protocol_serde::shape_update_theme_for_stack::de_update_theme_for_stack(_response_body, output)
            .map_err(crate::operation::update_theme_for_stack::UpdateThemeForStackError::unhandled)?;
...
pub fn ser_update_theme_for_stack_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_update_theme_for_stack_input::ser_update_theme_for_stack_input_input(encoder, input)?;
    }
