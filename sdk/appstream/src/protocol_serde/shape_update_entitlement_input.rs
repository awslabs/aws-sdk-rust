...
pub fn ser_update_entitlement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_entitlement::UpdateEntitlementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
