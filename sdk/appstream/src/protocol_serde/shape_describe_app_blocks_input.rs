...
pub fn ser_describe_app_blocks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAppBlocksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
