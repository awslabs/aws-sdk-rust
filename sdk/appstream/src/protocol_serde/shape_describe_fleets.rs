...
pub fn ser_describe_fleets_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_describe_fleets_input::ser_describe_fleets_input_input(encoder, input)?;
    }
    Ok(::aws_smithy_types::body::SdkBody::from(encoder.into_writer()))
}

pub(crate) fn de_describe_fleets(
    value: &[u8],
    mut builder: crate::operation::describe_fleets::builders::DescribeFleetsOutputBuilder,
) -> ::std::result::Result<crate::operation::describe_fleets::builders::DescribeFleetsOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    ) -> ::std::result::Result<crate::operation::describe_fleets::builders::DescribeFleetsOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
    {
        builder = match decoder.str()?.as_ref() {
            "Fleets" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_fleets(Some(crate::protocol_serde::shape_fleet_list::de_fleet_list(decoder, depth + 1)?)))
            })?,
            "NextToken" => {
