...
pub fn ser_user_stack_association(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserStackAssociation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_user_stack_association<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UserStackAssociation>, aws_smithy_json::deserialize::error::DeserializeError>
