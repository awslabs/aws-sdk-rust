...
impl ::std::convert::From<&str> for FleetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetType::from(s))
    }
}
impl FleetType {
...
impl ::std::convert::AsRef<str> for FleetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
