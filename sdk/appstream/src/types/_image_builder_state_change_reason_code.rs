...
other => ImageBuilderStateChangeReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ImageBuilderStateChangeReasonCode {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ImageBuilderStateChangeReasonCode::from(s))
                    }
                }
...
impl ::std::convert::AsRef<str> for ImageBuilderStateChangeReasonCode {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
...
impl ::std::fmt::Display for ImageBuilderStateChangeReasonCode {
