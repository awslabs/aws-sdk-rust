...
impl ::std::convert::From<&str> for FleetState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetState::from(s))
    }
}
impl FleetState {
...
impl ::std::convert::AsRef<str> for FleetState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
