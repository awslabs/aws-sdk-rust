...
impl ::std::convert::From<&str> for ThemeAttribute {
    fn from(s: &str) -> Self {
        match s {
            "FOOTER_LINKS" => ThemeAttribute::FooterLinks,
            other => ThemeAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThemeAttribute {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThemeAttribute::from(s))
    }
}
impl ThemeAttribute {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ThemeAttribute::FooterLinks => "FOOTER_LINKS",
            ThemeAttribute::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ThemeAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ThemeAttribute {
