...
impl DeleteAppBlockBuilderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAppBlockBuilder`](crate::operation::delete_app_block_builder::DeleteAppBlockBuilder)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app_block_builder::DeleteAppBlockBuilder::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAppBlockBuilder", "appstream"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAppBlockBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_app_block_builder::de_delete_app_block_builder_http_response_with_props(status, headers, body)
        }
    }
}
