...
impl DescribeFleetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_fleets::DescribeFleets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_fleets::ser_describe_fleets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleets::de_describe_fleets_http_response_with_props(status, headers, body)
        }
    }
}
