...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_image_permissions::DeleteImagePermissionsOutput,
                    crate::operation::delete_image_permissions::DeleteImagePermissionsError,
                > for DeleteImagePermissionsFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteImagePermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_image_permissions::DeleteImagePermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_image_permissions::DeleteImagePermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_image_permissions::DeleteImagePermissions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_image_permissions::DeleteImagePermissions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_image_permissions::DeleteImagePermissionsOutput, crate::operation::delete_image_permissions::DeleteImagePermissionsError, Self> {
