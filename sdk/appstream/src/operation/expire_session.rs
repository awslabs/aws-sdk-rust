...
impl ExpireSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::expire_session::ExpireSession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_expire_session::ser_expire_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExpireSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_expire_session::de_expire_session_http_response_with_props(status, headers, body)
        }
    }
}
