...
/// Orchestration and serialization glue logic for `ListAssociatedStacks`.
...
impl ListAssociatedStacks {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_associated_stacks::ListAssociatedStacksInput,
                    ) -> ::std::result::Result<crate::operation::list_associated_stacks::ListAssociatedStacksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_associated_stacks::ListAssociatedStacksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_associated_stacks::ListAssociatedStacksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_associated_stacks::ListAssociatedStacksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociatedStacks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssociatedStacks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssociatedStacksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssociatedStacksResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociatedStacks")
...
.with_interceptor(ListAssociatedStacksEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_associated_stacks::ListAssociatedStacksError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_associated_stacks::ListAssociatedStacksError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_associated_stacks::ListAssociatedStacksError>::new());
...
#[derive(Debug)]
            struct ListAssociatedStacksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociatedStacksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_associated_stacks::de_list_associated_stacks_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAssociatedStacksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociatedStacksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_associated_stacks::ListAssociatedStacksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_associated_stacks::ListAssociatedStacksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_associated_stacks::ser_list_associated_stacks_input(&input)?);
...
#[derive(Debug)]
            struct ListAssociatedStacksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociatedStacksEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAssociatedStacksEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssociatedStacksInput>()
                        .ok_or("failed to downcast to ListAssociatedStacksInput")?;
...
pub enum ListAssociatedStacksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssociatedStacksError) for what information is available for the error.")]
...
impl ListAssociatedStacksError {
    /// Creates the `ListAssociatedStacksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssociatedStacksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssociatedStacksError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_associated_stacks::ListAssociatedStacksError {
...
mod _list_associated_stacks_output;
