...
impl ListAssociatedStacksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_associated_stacks::ser_list_associated_stacks_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_associated_stacks::ListAssociatedStacks::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_associated_stacks::ListAssociatedStacksError
{
