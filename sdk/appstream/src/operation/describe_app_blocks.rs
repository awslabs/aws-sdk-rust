...
impl DescribeAppBlocksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_app_blocks::ser_describe_app_blocks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAppBlocks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_app_blocks::de_describe_app_blocks_http_response_with_props(status, headers, body)
        }
    }
}
