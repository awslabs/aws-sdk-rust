...
impl DeleteImageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_image::DeleteImage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_image::de_delete_image_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_image::de_delete_image_http_response_with_props(
                status, headers, body,
            )
        }
    }
