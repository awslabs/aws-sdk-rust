...
impl DeleteImageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_image::DeleteImage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_image::ser_delete_image_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_image::de_delete_image_http_response_with_props(status, headers, body)
        }
    }
}
