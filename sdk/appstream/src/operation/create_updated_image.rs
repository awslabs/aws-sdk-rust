...
impl CreateUpdatedImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_updated_image::ser_create_updated_image_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUpdatedImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_updated_image::de_create_updated_image_http_response_with_props(status, headers, body)
        }
    }
}
