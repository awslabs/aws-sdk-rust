...
impl CreateUpdatedImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_updated_image::ser_create_updated_image_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_updated_image::CreateUpdatedImage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUpdatedImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_updated_image::de_create_updated_image_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_updated_image::CreateUpdatedImageError
{
