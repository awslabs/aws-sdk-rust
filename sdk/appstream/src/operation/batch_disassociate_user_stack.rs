...
impl BatchDisassociateUserStackInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStack,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStack::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateUserStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_disassociate_user_stack::de_batch_disassociate_user_stack_http_response_with_props(
                status, headers, body,
            )
        }
    }
