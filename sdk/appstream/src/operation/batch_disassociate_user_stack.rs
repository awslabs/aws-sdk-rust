...
/// Orchestration and serialization glue logic for `BatchDisassociateUserStack`.
...
impl BatchDisassociateUserStack {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackInput,
                    ) -> ::std::result::Result<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDisassociateUserStack {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDisassociateUserStack");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDisassociateUserStackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDisassociateUserStackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDisassociateUserStack")
...
.with_interceptor(BatchDisassociateUserStackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError>::new());
...
#[derive(Debug)]
            struct BatchDisassociateUserStackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDisassociateUserStackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_disassociate_user_stack::de_batch_disassociate_user_stack_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_disassociate_user_stack::de_batch_disassociate_user_stack_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchDisassociateUserStackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDisassociateUserStackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_disassociate_user_stack::ser_batch_disassociate_user_stack_input(&input)?);
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDisassociateUserStackEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDisassociateUserStackInput>()
                        .ok_or("failed to downcast to BatchDisassociateUserStackInput")?;
...
pub enum BatchDisassociateUserStackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDisassociateUserStackError) for what information is available for the error.")]
...
impl BatchDisassociateUserStackError {
    /// Creates the `BatchDisassociateUserStackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDisassociateUserStackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDisassociateUserStackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError {
...
mod _batch_disassociate_user_stack_output;
