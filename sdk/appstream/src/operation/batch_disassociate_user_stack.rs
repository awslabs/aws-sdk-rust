...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateUserStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_disassociate_user_stack::de_batch_disassociate_user_stack_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_disassociate_user_stack::BatchDisassociateUserStackError
{
