...
impl AssociateAppBlockBuilderAppBlockInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_app_block_builder_app_block::AssociateAppBlockBuilderAppBlock,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_app_block_builder_app_block::AssociateAppBlockBuilderAppBlock::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAppBlockBuilderAppBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_app_block_builder_app_block::de_associate_app_block_builder_app_block_http_response_with_props(
                status, headers, body,
            )
        }
    }
