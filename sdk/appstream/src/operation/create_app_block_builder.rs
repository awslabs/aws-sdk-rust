...
impl CreateAppBlockBuilderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_app_block_builder::CreateAppBlockBuilder::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAppBlockBuilder", "appstream"));
