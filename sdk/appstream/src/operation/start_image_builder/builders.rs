...
impl StartImageBuilderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_image_builder::StartImageBuilderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_image_builder::StartImageBuilderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_image_builder::StartImageBuilderOutput, crate::operation::start_image_builder::StartImageBuilderError, Self> {
