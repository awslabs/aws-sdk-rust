...
impl AssociateFleetInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_fleet::AssociateFleet::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateFleet {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_fleet::de_associate_fleet_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_fleet::de_associate_fleet_http_response(
                status, headers, body,
            )
        }
    }
