...
impl ListAssociatedFleetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_associated_fleets::ListAssociatedFleets,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssociatedFleets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_associated_fleets::de_list_associated_fleets_http_response_with_props(status, headers, body)
        }
    }
}
