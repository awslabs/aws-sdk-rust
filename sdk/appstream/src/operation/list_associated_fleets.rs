...
impl ListAssociatedFleets {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_associated_fleets::ListAssociatedFleetsInput,
                    ) -> ::std::result::Result<crate::operation::list_associated_fleets::ListAssociatedFleetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_associated_fleets::ListAssociatedFleetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_associated_fleets::ListAssociatedFleetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_associated_fleets::ListAssociatedFleetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociatedFleets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssociatedFleets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssociatedFleetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssociatedFleetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociatedFleets")
...
.with_interceptor(ListAssociatedFleetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_associated_fleets::ListAssociatedFleetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_associated_fleets::ListAssociatedFleetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_associated_fleets::ListAssociatedFleetsError>::new());
...
#[derive(Debug)]
            struct ListAssociatedFleetsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociatedFleetsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_associated_fleets::de_list_associated_fleets_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_associated_fleets::de_list_associated_fleets_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAssociatedFleetsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociatedFleetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_associated_fleets::ListAssociatedFleetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_associated_fleets::ListAssociatedFleetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_associated_fleets::ser_list_associated_fleets_input(&input)?);
...
#[derive(Debug)]
            struct ListAssociatedFleetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociatedFleetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAssociatedFleetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssociatedFleetsInput>()
                        .ok_or("failed to downcast to ListAssociatedFleetsInput")?;
...
pub enum ListAssociatedFleetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssociatedFleetsError) for what information is available for the error.")]
...
impl ListAssociatedFleetsError {
    /// Creates the `ListAssociatedFleetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssociatedFleetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssociatedFleetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_associated_fleets::ListAssociatedFleetsError {
...
mod _list_associated_fleets_output;
