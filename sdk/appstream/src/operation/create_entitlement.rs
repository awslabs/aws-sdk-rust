...
impl CreateEntitlementInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_entitlement::ser_create_entitlement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEntitlement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_entitlement::de_create_entitlement_http_response_with_props(status, headers, body)
        }
    }
}
