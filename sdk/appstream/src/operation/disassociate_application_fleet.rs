...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateApplicationFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_application_fleet::de_disassociate_application_fleet_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisassociateApplicationFleetError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_application_fleet::DisassociateApplicationFleetError
{
