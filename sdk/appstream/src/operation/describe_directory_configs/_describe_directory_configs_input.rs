...
impl DescribeDirectoryConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_directory_configs::DescribeDirectoryConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
