...
impl CreateAppBlockInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_app_block::CreateAppBlock, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_app_block::ser_create_app_block_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAppBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_app_block::de_create_app_block_http_response_with_props(status, headers, body)
        }
    }
}
