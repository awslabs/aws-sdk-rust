...
impl crate::operation::describe_usage_report_subscriptions::builders::DescribeUsageReportSubscriptionsInputBuilder {
...
impl DescribeUsageReportSubscriptionsFluentBuilder {
    /// Creates a new `DescribeUsageReportSubscriptionsFluentBuilder`.
