...
impl DescribeUsageReportSubscriptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_usage_report_subscriptions::DescribeUsageReportSubscriptionsInput, ::aws_smithy_types::error::operation::BuildError> {
