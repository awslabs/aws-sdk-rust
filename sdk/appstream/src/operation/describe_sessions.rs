...
impl DescribeSessionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_sessions::DescribeSessions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_sessions::ser_describe_sessions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSessions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_sessions::de_describe_sessions_http_response_with_props(status, headers, body)
        }
    }
}
