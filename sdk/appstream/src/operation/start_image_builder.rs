...
impl StartImageBuilderInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_image_builder::ser_start_image_builder_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImageBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_image_builder::de_start_image_builder_http_response_with_props(status, headers, body)
        }
    }
}
