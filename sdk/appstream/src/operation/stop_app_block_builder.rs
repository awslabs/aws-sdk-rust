...
impl StopAppBlockBuilderInput {
    /// Consumes the builder and constructs an Operation<[`StopAppBlockBuilder`](crate::operation::stop_app_block_builder::StopAppBlockBuilder)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_app_block_builder::StopAppBlockBuilder::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopAppBlockBuilder", "appstream"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAppBlockBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_app_block_builder::de_stop_app_block_builder_http_response_with_props(status, headers, body)
        }
    }
}
