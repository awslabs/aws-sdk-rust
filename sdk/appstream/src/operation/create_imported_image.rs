...
/// Orchestration and serialization glue logic for `CreateImportedImage`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateImportedImage;
impl CreateImportedImage {
    /// Creates a new `CreateImportedImage`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_imported_image::CreateImportedImageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_imported_image::CreateImportedImageOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppStream", "CreateImportedImage", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "AppStream.CreateImportedImage",
                "rpc.service" = "AppStream",
                "rpc.method" = "CreateImportedImage",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateImportedImage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateImportedImage");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateImportedImageRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateImportedImageResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateImportedImage")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateImportedImage")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateImportedImageTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateImportedImageEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateImportedImageTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateImportedImageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateImportedImageInput>() else {
        ...
        if requested.should_capture("SourceAmiId") {
            if let ::std::option::Option::Some(value) = input.source_ami_id.as_deref() {
                captured.insert("SourceAmiId", value);
            }
        }
        if requested.should_capture("WorkspaceImageId") {
            if let ::std::option::Option::Some(value) = input.workspace_image_id.as_deref() {
                captured.insert("WorkspaceImageId", value);
            }
        }
...
#[derive(Debug)]
struct CreateImportedImageResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateImportedImageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_imported_image::de_create_imported_image_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_imported_image::de_create_imported_image_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateImportedImageRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateImportedImageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_imported_image::CreateImportedImageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_imported_image::CreateImportedImageInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/PhotonAdminProxyService/operation/CreateImportedImage").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_imported_image::ser_create_imported_image_input(
            &input,
        )?);
...
#[derive(Debug)]
struct CreateImportedImageEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateImportedImageEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateImportedImageEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateImportedImageInput>()
            .ok_or("failed to downcast to CreateImportedImageInput")?;
...
/// Error type for the `CreateImportedImageError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateImportedImageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateImportedImageError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateImportedImageError {
    /// Creates the `CreateImportedImageError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateImportedImageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateImportedImageError::DryRunOperationException`.
    pub fn is_dry_run_operation_exception(&self) -> bool {
        matches!(self, Self::DryRunOperationException(_))
    }
    /// Returns `true` if the error kind is `CreateImportedImageError::IncompatibleImageException`.
    ...
    /// Returns `true` if the error kind is `CreateImportedImageError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateImportedImageError::OperationNotPermittedException`.
    pub fn is_operation_not_permitted_exception(&self) -> bool {
        matches!(self, Self::OperationNotPermittedException(_))
    }
    /// Returns `true` if the error kind is `CreateImportedImageError::ResourceAlreadyExistsException`.
    pub fn is_resource_already_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateImportedImageError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
}
impl ::std::error::Error for CreateImportedImageError {
...
impl ::std::fmt::Display for CreateImportedImageError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateImportedImageError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateImportedImageError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateImportedImageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_imported_image::CreateImportedImageError {
...
mod _create_imported_image_output;
