...
impl DescribeApplicationFleetAssociationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_application_fleet_associations::DescribeApplicationFleetAssociations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_application_fleet_associations::DescribeApplicationFleetAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplicationFleetAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_application_fleet_associations::de_describe_application_fleet_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
