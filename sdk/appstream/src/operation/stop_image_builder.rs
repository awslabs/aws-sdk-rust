...
impl StopImageBuilderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_image_builder::StopImageBuilder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopImageBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_image_builder::de_stop_image_builder_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_image_builder::StopImageBuilderError
{
