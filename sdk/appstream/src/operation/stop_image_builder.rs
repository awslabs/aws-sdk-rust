...
impl StopImageBuilderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_image_builder::StopImageBuilder,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_image_builder::ser_stop_image_builder_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopImageBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_image_builder::de_stop_image_builder_http_response_with_props(status, headers, body)
        }
    }
}
