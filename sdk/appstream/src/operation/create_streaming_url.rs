...
impl CreateStreamingUrlInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_streaming_url::ser_create_streaming_url_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_streaming_url::CreateStreamingURL::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_streaming_url::CreateStreamingURLError
{
