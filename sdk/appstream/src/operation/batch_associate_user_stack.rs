...
/// Orchestration and serialization glue logic for `BatchAssociateUserStack`.
...
impl BatchAssociateUserStack {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_associate_user_stack::BatchAssociateUserStackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_associate_user_stack::BatchAssociateUserStackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchAssociateUserStack {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchAssociateUserStack");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchAssociateUserStackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchAssociateUserStackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchAssociateUserStack")
...
.with_interceptor(BatchAssociateUserStackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackError>::new());
...
#[derive(Debug)]
            struct BatchAssociateUserStackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchAssociateUserStackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_associate_user_stack::de_batch_associate_user_stack_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct BatchAssociateUserStackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchAssociateUserStackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_associate_user_stack::BatchAssociateUserStackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_associate_user_stack::BatchAssociateUserStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_associate_user_stack::ser_batch_associate_user_stack_input(&input)?);
...
#[derive(Debug)]
            struct BatchAssociateUserStackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchAssociateUserStackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchAssociateUserStackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchAssociateUserStackInput>()
                        .ok_or("failed to downcast to BatchAssociateUserStackInput")?;
...
pub enum BatchAssociateUserStackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchAssociateUserStackError) for what information is available for the error.")]
...
impl BatchAssociateUserStackError {
    /// Creates the `BatchAssociateUserStackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchAssociateUserStackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchAssociateUserStackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_associate_user_stack::BatchAssociateUserStackError {
...
mod _batch_associate_user_stack_output;
