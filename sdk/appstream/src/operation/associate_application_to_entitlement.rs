...
impl AssociateApplicationToEntitlementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_application_to_entitlement::AssociateApplicationToEntitlement,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_application_to_entitlement::AssociateApplicationToEntitlement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateApplicationToEntitlement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_application_to_entitlement::de_associate_application_to_entitlement_http_response_with_props(
                status, headers, body,
            )
        }
    }
