...
impl StartFleetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_fleet::StartFleet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_fleet::de_start_fleet_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_fleet::de_start_fleet_http_response_with_props(
                status, headers, body,
            )
        }
    }
