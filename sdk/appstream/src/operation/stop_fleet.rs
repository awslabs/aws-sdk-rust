...
impl StopFleetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_fleet::StopFleet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_fleet::ser_stop_fleet_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_fleet::de_stop_fleet_http_response_with_props(status, headers, body)
        }
    }
}
