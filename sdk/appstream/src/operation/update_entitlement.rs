...
impl UpdateEntitlementInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_entitlement::ser_update_entitlement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEntitlement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_entitlement::de_update_entitlement_http_response_with_props(status, headers, body)
        }
    }
}
