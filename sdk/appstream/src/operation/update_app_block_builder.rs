    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_block_builder::UpdateAppBlockBuilderError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_block_builder::UpdateAppBlockBuilderOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAppBlockBuilder {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateAppBlockBuilder", "appstream"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAppBlockBuilder")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateAppBlockBuilderResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateAppBlockBuilderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_block_builder::UpdateAppBlockBuilderInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_app_block_builder::ser_update_app_block_builder_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateAppBlockBuilderEndpointParamsInterceptor {
...
pub type UpdateAppBlockBuilderErrorKind = UpdateAppBlockBuilderError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateAppBlockBuilderError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_app_block_builder::UpdateAppBlockBuilderError {
...
impl UpdateAppBlockBuilderError {
    ...
    /// Creates the `UpdateAppBlockBuilderError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
