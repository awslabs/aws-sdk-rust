...
impl UpdateAppBlockBuilderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAppBlockBuilder`](crate::operation::update_app_block_builder::UpdateAppBlockBuilder)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_app_block_builder::UpdateAppBlockBuilder::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAppBlockBuilder", "appstream"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAppBlockBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_app_block_builder::de_update_app_block_builder_http_response_with_props(status, headers, body)
        }
    }
}
