...
impl DescribeImagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_images::DescribeImages, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_images::ser_describe_images_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_images::DescribeImages::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeImages", "appstream"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_images::de_describe_images_http_response_with_props(status, headers, body)
        }
    }
}
