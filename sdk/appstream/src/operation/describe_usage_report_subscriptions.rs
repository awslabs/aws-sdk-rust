...
impl DescribeUsageReportSubscriptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_usage_report_subscriptions::DescribeUsageReportSubscriptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUsageReportSubscriptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_usage_report_subscriptions::de_describe_usage_report_subscriptions_http_response_with_props(
                status, headers, body,
            )
        }
    }
