...
impl DescribeEntitlementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_entitlements::DescribeEntitlements,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEntitlements {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_entitlements::de_describe_entitlements_http_response_with_props(status, headers, body)
        }
    }
}
