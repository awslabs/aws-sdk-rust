...
impl DescribeEntitlementsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_entitlements::ser_describe_entitlements_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_entitlements::DescribeEntitlements::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEntitlements {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_entitlements::de_describe_entitlements_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_entitlements::DescribeEntitlementsError
{
