...
impl DescribeAppBlockBuilderAppBlockAssociationsOutputBuilder {
    ...
    /// <p>This list of app block builders associated with app blocks.</p>
    pub fn set_app_block_builder_app_block_associations(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::AppBlockBuilderAppBlockAssociation>>) -> Self {
        self.app_block_builder_app_block_associations = input; self
    }
    /// <p>This list of app block builders associated with app blocks.</p>
    pub fn get_app_block_builder_app_block_associations(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::AppBlockBuilderAppBlockAssociation>> {
