...
impl CreateImageBuilderStreamingUrlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURL::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateImageBuilderStreamingURL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_image_builder_streaming_url::de_create_image_builder_streaming_url_http_response_with_props(
                status, headers, body,
            )
        }
    }
