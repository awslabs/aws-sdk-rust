...
impl AssociateApplicationToEntitlementFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::associate_application_to_entitlement::AssociateApplicationToEntitlementOutput, ::aws_smithy_http::result::SdkError<crate::operation::associate_application_to_entitlement::AssociateApplicationToEntitlementError>>
                         {
        let op = self
            .inner
            .build()
