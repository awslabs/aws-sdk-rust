...
impl DeleteImageBuilderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_image_builder::DeleteImageBuilder,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_image_builder::ser_delete_image_builder_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImageBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_image_builder::de_delete_image_builder_http_response_with_props(status, headers, body)
        }
    }
}
