...
impl DeleteImageBuilderInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_image_builder::ser_delete_image_builder_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_image_builder::DeleteImageBuilder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImageBuilder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_image_builder::de_delete_image_builder_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_image_builder::DeleteImageBuilderError
{
