...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUsageReportSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_usage_report_subscription::de_delete_usage_report_subscription_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_usage_report_subscription::DeleteUsageReportSubscriptionError
{
