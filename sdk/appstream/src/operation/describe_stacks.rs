...
impl DescribeStacksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_stacks::DescribeStacks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_stacks::ser_describe_stacks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStacks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_stacks::de_describe_stacks_http_response_with_props(status, headers, body)
        }
    }
}
