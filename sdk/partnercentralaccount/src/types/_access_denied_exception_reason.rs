...
///     AccessDeniedExceptionReason::AccessDenied => { /* ... */ },
///     AccessDeniedExceptionReason::IncompatibleBenefitAwsPartnerState => { /* ... */ },
...
impl ::std::convert::From<&str> for AccessDeniedExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "ACCESS_DENIED" => AccessDeniedExceptionReason::AccessDenied,
            "INCOMPATIBLE_BENEFIT_AWS_PARTNER_STATE" => AccessDeniedExceptionReason::IncompatibleBenefitAwsPartnerState,
...
impl AccessDeniedExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AccessDeniedExceptionReason::AccessDenied => "ACCESS_DENIED",
            AccessDeniedExceptionReason::IncompatibleBenefitAwsPartnerState => "INCOMPATIBLE_BENEFIT_AWS_PARTNER_STATE",
            AccessDeniedExceptionReason::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ACCESS_DENIED", "INCOMPATIBLE_BENEFIT_AWS_PARTNER_STATE"]
    }
}
...
impl ::std::fmt::Display for AccessDeniedExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccessDeniedExceptionReason::AccessDenied => write!(f, "ACCESS_DENIED"),
            AccessDeniedExceptionReason::IncompatibleBenefitAwsPartnerState => write!(f, "INCOMPATIBLE_BENEFIT_AWS_PARTNER_STATE"),
