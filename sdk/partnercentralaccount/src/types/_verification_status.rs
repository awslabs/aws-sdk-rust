...
///     VerificationStatus::PendingCustomerAction => { /* ... */ },
...
impl ::std::convert::From<&str> for VerificationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING_CUSTOMER_ACTION" => VerificationStatus::PendingCustomerAction,
            "REJECTED" => VerificationStatus::Rejected,
            "SUCCEEDED" => VerificationStatus::Succeeded,
...
impl VerificationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VerificationStatus::PendingCustomerAction => "PENDING_CUSTOMER_ACTION",
...
impl ::std::fmt::Display for VerificationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            VerificationStatus::InProgress => write!(f, "IN_PROGRESS"),
            VerificationStatus::PendingCustomerAction => write!(f, "PENDING_CUSTOMER_ACTION"),
