...
impl ::std::convert::From<&str> for ConnectionType {
    fn from(s: &str) -> Self {
        match s {
            "OPPORTUNITY_COLLABORATION" => ConnectionType::OpportunityCollaboration,
            "SUBSIDIARY" => ConnectionType::Subsidiary,
...
impl ConnectionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectionType::OpportunityCollaboration => "OPPORTUNITY_COLLABORATION",
            ConnectionType::Subsidiary => "SUBSIDIARY",
            ConnectionType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["OPPORTUNITY_COLLABORATION", "SUBSIDIARY"]
    }
}
...
impl ::std::fmt::Display for ConnectionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConnectionType::OpportunityCollaboration => write!(f, "OPPORTUNITY_COLLABORATION"),
            ConnectionType::Subsidiary => write!(f, "SUBSIDIARY"),
