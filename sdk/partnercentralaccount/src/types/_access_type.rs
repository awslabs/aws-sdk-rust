...
/// match accesstype {
///     AccessType::AllowAll => { /* ... */ },
///     AccessType::AllowByDefaultDenySome => { /* ... */ },
///     AccessType::DenyAll => { /* ... */ },
...
impl ::std::convert::From<&str> for AccessType {
    fn from(s: &str) -> Self {
        match s {
            "ALLOW_ALL" => AccessType::AllowAll,
            "ALLOW_BY_DEFAULT_DENY_SOME" => AccessType::AllowByDefaultDenySome,
            "DENY_ALL" => AccessType::DenyAll,
...
impl AccessType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AccessType::AllowAll => "ALLOW_ALL",
            AccessType::AllowByDefaultDenySome => "ALLOW_BY_DEFAULT_DENY_SOME",
            AccessType::DenyAll => "DENY_ALL",
            AccessType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ALLOW_ALL", "ALLOW_BY_DEFAULT_DENY_SOME", "DENY_ALL"]
    }
}
...
impl ::std::fmt::Display for AccessType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccessType::AllowAll => write!(f, "ALLOW_ALL"),
            AccessType::AllowByDefaultDenySome => write!(f, "ALLOW_BY_DEFAULT_DENY_SOME"),
            AccessType::DenyAll => write!(f, "DENY_ALL"),
