...
mod test {
    ...
    fn test_3() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account-fips.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account-fips.us-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_4() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account.us-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_5() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account-fips.cn-northwest-1.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account-fips.cn-northwest-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_6() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account.cn-northwest-1.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account.cn-northwest-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_7() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account-fips.us-gov-west-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account-fips.us-gov-west-1.api.aws")
                .build()
        );
    }
    ...
    fn test_8() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-account.us-gov-west-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-account.us-gov-west-1.api.aws")
                .build()
        );
    }
...
/// Endpoint resolver trait specific to Partner Central Account API
