...
pub(crate) fn reflens_list_directory_registrations_output_next_token(
...
pub(crate) fn reflens_list_service_principal_names_output_next_token(
...
pub(crate) fn reflens_list_template_group_access_control_entries_output_next_token(
...
pub(crate) fn lens_list_directory_registrations_output_directory_registrations(
    input: crate::operation::list_directory_registrations::ListDirectoryRegistrationsOutput,
...
pub(crate) fn lens_list_service_principal_names_output_service_principal_names(
    input: crate::operation::list_service_principal_names::ListServicePrincipalNamesOutput,
...
pub(crate) fn lens_list_template_group_access_control_entries_output_access_control_entries(
    input: crate::operation::list_template_group_access_control_entries::ListTemplateGroupAccessControlEntriesOutput,
...
pub(crate) fn lens_list_templates_output_templates(
    input: crate::operation::list_templates::ListTemplatesOutput,
