...
pub fn de_delete_template_group_access_control_entry_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::unhandled,
                        )?;
        ...
        "ConflictException" => {
            crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::delete_template_group_access_control_entry::DeleteTemplateGroupAccessControlEntryError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_template_group_access_control_entry_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output =
            crate::operation::delete_template_group_access_control_entry::builders::DeleteTemplateGroupAccessControlEntryOutputBuilder::default();
