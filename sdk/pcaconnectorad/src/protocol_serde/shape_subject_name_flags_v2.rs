...
pub fn ser_subject_name_flags_v2(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::SubjectNameFlagsV2,
...
pub(crate) fn de_subject_name_flags_v2<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SubjectNameFlagsV2>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::SubjectNameFlagsV2Builder::default();
            loop {
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "SanRequireDomainDns" => {
                                builder = builder.set_san_require_domain_dns(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "SanRequireSpn" => {
                                builder = builder.set_san_require_spn(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "SanRequireDirectoryGuid" => {
                                builder = builder.set_san_require_directory_guid(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "SanRequireUpn" => {
                                builder = builder.set_san_require_upn(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "SanRequireEmail" => {
                                builder = builder.set_san_require_email(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "SanRequireDns" => {
                                builder = builder.set_san_require_dns(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "RequireDnsAsCn" => {
                                builder = builder.set_require_dns_as_cn(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "RequireEmail" => {
                                builder = builder.set_require_email(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "RequireCommonName" => {
                                builder = builder.set_require_common_name(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "RequireDirectoryPath" => {
                                builder = builder.set_require_directory_path(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
