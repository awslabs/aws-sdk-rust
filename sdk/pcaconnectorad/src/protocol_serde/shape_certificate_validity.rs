            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ValidityPeriod" => {
                            builder = builder.set_validity_period(crate::protocol_serde::shape_validity_period::de_validity_period(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "RenewalPeriod" => {
                            builder = builder.set_renewal_period(crate::protocol_serde::shape_validity_period::de_validity_period(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
