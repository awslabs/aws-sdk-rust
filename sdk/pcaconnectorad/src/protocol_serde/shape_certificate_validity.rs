...
pub(crate) fn de_certificate_validity<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CertificateValidity>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "ValidityPeriod" => {
                                builder = builder.set_validity_period(
                                    crate::protocol_serde::shape_validity_period::de_validity_period(tokens)?
                                );
                            }
                            "RenewalPeriod" => {
                                builder = builder.set_renewal_period(
                                    crate::protocol_serde::shape_validity_period::de_validity_period(tokens)?
                                );
                            }
