...
pub(crate) fn de_template_v2<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TemplateV2>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "PrivateKeyFlags" => {
                                builder = builder.set_private_key_flags(
                                    crate::protocol_serde::shape_private_key_flags_v2::de_private_key_flags_v2(tokens)?
                                );
                            }
                            "EnrollmentFlags" => {
                                builder = builder.set_enrollment_flags(
                                    crate::protocol_serde::shape_enrollment_flags_v2::de_enrollment_flags_v2(tokens)?
                                );
                            }
                            "SubjectNameFlags" => {
                                builder = builder.set_subject_name_flags(
                                    crate::protocol_serde::shape_subject_name_flags_v2::de_subject_name_flags_v2(tokens)?
                                );
                            }
                            "GeneralFlags" => {
                                builder = builder.set_general_flags(
                                    crate::protocol_serde::shape_general_flags_v2::de_general_flags_v2(tokens)?
                                );
                            }
                            "Extensions" => {
                                builder = builder.set_extensions(
                                    crate::protocol_serde::shape_extensions_v2::de_extensions_v2(tokens)?
                                );
                            }
