                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "TemplateV2" => Some(crate::types::TemplateDefinition::TemplateV2(
                            crate::protocol_serde::shape_template_v2::de_template_v2(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "TemplateV3" => Some(crate::types::TemplateDefinition::TemplateV3(
                            crate::protocol_serde::shape_template_v3::de_template_v3(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "TemplateV4" => Some(crate::types::TemplateDefinition::TemplateV4(
                            crate::protocol_serde::shape_template_v4::de_template_v4(tokens, _value, depth + 1)?.ok_or_else(|| {
