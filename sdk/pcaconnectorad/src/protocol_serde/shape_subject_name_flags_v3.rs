...
pub(crate) fn de_subject_name_flags_v3<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SubjectNameFlagsV3>, ::aws_smithy_json::deserialize::error::DeserializeError>
