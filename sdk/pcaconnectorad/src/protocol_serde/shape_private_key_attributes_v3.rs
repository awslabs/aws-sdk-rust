...
pub(crate) fn de_private_key_attributes_v3<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::PrivateKeyAttributesV3>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "KeyUsageProperty" => {
                            builder = builder.set_key_usage_property(crate::protocol_serde::shape_key_usage_property::de_key_usage_property(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
