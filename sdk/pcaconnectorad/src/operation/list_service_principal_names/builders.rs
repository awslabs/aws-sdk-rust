...
impl ListServicePrincipalNamesFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_service_principal_names::ListServicePrincipalNamesError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_service_principal_names::paginator::ListServicePrincipalNamesPaginator::send) which returns a `Stream`.
