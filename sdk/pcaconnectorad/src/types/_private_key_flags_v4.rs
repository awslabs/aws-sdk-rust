...
pub struct PrivateKeyFlagsV4 {
    ...
    pub client_version: ::std::option::Option<crate::types::ClientCompatibilityV4>,
}
impl PrivateKeyFlagsV4 {
    ...
    /// <p>Defines the minimum client compatibility.</p>
    pub fn client_version(&self) -> ::std::option::Option<&crate::types::ClientCompatibilityV4> {
...
impl PrivateKeyFlagsV4Builder {
    ...
    pub fn build(self) -> crate::types::PrivateKeyFlagsV4 {
