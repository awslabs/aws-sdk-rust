...
impl Builder {
    ...
    /// use aws_sdk_pcaconnectorad::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_pcaconnectorad::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
