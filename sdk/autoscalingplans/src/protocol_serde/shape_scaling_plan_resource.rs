...
pub(crate) fn de_scaling_plan_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ScalingPlanResource>, aws_smithy_json::deserialize::error::DeserializeError>
