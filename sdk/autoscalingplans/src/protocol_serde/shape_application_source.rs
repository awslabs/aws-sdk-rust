...
pub fn ser_application_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ApplicationSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_application_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ApplicationSource>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TagFilters" => {
                                builder = builder.set_tag_filters(
                                    crate::protocol_serde::shape_tag_filters::de_tag_filters(tokens)?
                                );
                            }
