...
pub(crate) fn de_predefined_load_metric_specification<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PredefinedLoadMetricSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "PredefinedLoadMetricType" => {
                            builder = builder.set_predefined_load_metric_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LoadMetricType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ResourceLabel" => {
