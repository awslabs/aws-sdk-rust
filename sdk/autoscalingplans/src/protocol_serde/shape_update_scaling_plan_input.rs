...
pub fn ser_update_scaling_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateScalingPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
