...
pub fn ser_customized_load_metric_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomizedLoadMetricSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_customized_load_metric_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CustomizedLoadMetricSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
