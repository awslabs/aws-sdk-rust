...
pub fn de_get_scaling_plan_resource_forecast_data_http_error(
...
> {
    ...
    Err(match error_code {
        "InternalServiceException" => {
            crate::operation::get_scaling_plan_resource_forecast_data::GetScalingPlanResourceForecastDataError::InternalServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::get_scaling_plan_resource_forecast_data::GetScalingPlanResourceForecastDataError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_scaling_plan_resource_forecast_data_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::get_scaling_plan_resource_forecast_data_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_scaling_plan_resource_forecast_data::GetScalingPlanResourceForecastDataError::unhandled)?
    })
}
...
pub fn ser_get_scaling_plan_resource_forecast_data_input(
    ...
    crate::protocol_serde::shape_get_scaling_plan_resource_forecast_data_input::ser_get_scaling_plan_resource_forecast_data_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Datapoints" => {
                    builder = builder.set_datapoints(crate::protocol_serde::shape_datapoints::de_datapoints(tokens, _value, depth + 1)?);
                }
