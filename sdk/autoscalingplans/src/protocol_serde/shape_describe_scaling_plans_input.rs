...
pub fn ser_describe_scaling_plans_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScalingPlansInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
