...
pub fn ser_customized_scaling_metric_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomizedScalingMetricSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_customized_scaling_metric_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CustomizedScalingMetricSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
