...
pub fn ser_scaling_instruction(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScalingInstruction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_scaling_instruction<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ScalingInstruction>, aws_smithy_json::deserialize::error::DeserializeError>
