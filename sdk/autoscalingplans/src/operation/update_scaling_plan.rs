...
impl UpdateScalingPlanInput {
    /// Consumes the builder and constructs an Operation<[`UpdateScalingPlan`](crate::operation::update_scaling_plan::UpdateScalingPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_scaling_plan::UpdateScalingPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_scaling_plan::UpdateScalingPlanInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_scaling_plan::ser_update_scaling_plan_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_scaling_plan::UpdateScalingPlan::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateScalingPlan {
                type Output = std::result::Result<crate::operation::update_scaling_plan::UpdateScalingPlanOutput, crate::operation::update_scaling_plan::UpdateScalingPlanError>;
