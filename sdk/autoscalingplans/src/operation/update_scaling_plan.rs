...
impl UpdateScalingPlanInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_scaling_plan::ser_update_scaling_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateScalingPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_scaling_plan::de_update_scaling_plan_http_response_with_props(status, headers, body)
        }
    }
}
