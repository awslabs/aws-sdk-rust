...
impl GetScalingPlanResourceForecastDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_scaling_plan_resource_forecast_data::GetScalingPlanResourceForecastData,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_scaling_plan_resource_forecast_data::GetScalingPlanResourceForecastData::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetScalingPlanResourceForecastData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_scaling_plan_resource_forecast_data::de_get_scaling_plan_resource_forecast_data_http_response_with_props(
                status, headers, body,
            )
        }
    }
