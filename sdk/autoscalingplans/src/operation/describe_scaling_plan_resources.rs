...
impl DescribeScalingPlanResourcesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScalingPlanResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_scaling_plan_resources::de_describe_scaling_plan_resources_http_response_with_props(
                status, headers, body,
            )
        }
    }
