...
impl crate::operation::get_scaling_plan_resource_forecast_data::builders::GetScalingPlanResourceForecastDataInputBuilder {
...
impl GetScalingPlanResourceForecastDataFluentBuilder {
    /// Creates a new `GetScalingPlanResourceForecastDataFluentBuilder`.
