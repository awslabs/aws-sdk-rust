...
impl DescribeScalingPlansInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_scaling_plans::ser_describe_scaling_plans_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_scaling_plans::DescribeScalingPlans::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_scaling_plans::DescribeScalingPlansError
{
