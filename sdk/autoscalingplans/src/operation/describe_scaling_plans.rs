...
impl DescribeScalingPlansInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScalingPlans`](crate::operation::describe_scaling_plans::DescribeScalingPlans)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_scaling_plans::DescribeScalingPlans, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_scaling_plans::DescribeScalingPlansInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_scaling_plans::ser_describe_scaling_plans_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_plans::DescribeScalingPlans::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeScalingPlans {
                type Output = std::result::Result<crate::operation::describe_scaling_plans::DescribeScalingPlansOutput, crate::operation::describe_scaling_plans::DescribeScalingPlansError>;
