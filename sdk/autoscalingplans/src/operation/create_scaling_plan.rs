...
impl CreateScalingPlanInput {
    /// Consumes the builder and constructs an Operation<[`CreateScalingPlan`](crate::operation::create_scaling_plan::CreateScalingPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_scaling_plan::CreateScalingPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_scaling_plan::CreateScalingPlanInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_scaling_plan::ser_create_scaling_plan_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_scaling_plan::CreateScalingPlan::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateScalingPlan {
                type Output = std::result::Result<crate::operation::create_scaling_plan::CreateScalingPlanOutput, crate::operation::create_scaling_plan::CreateScalingPlanError>;
