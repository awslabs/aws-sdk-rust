...
/// Orchestration and serialization glue logic for `CreateScalingPlan`.
...
impl CreateScalingPlan {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_scaling_plan::CreateScalingPlanInput,
                    ) -> ::std::result::Result<crate::operation::create_scaling_plan::CreateScalingPlanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_scaling_plan::CreateScalingPlanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_scaling_plan::CreateScalingPlanError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_scaling_plan::CreateScalingPlanOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateScalingPlan {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateScalingPlan");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateScalingPlanRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateScalingPlanResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateScalingPlan")
...
.with_interceptor(CreateScalingPlanEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_scaling_plan::CreateScalingPlanError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_scaling_plan::CreateScalingPlanError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_scaling_plan::CreateScalingPlanError>::new());
...
#[derive(Debug)]
            struct CreateScalingPlanResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateScalingPlanResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_scaling_plan::de_create_scaling_plan_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_scaling_plan::de_create_scaling_plan_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateScalingPlanRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateScalingPlanRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_scaling_plan::CreateScalingPlanInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_scaling_plan::CreateScalingPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_scaling_plan::ser_create_scaling_plan_input(&input)?);
...
#[derive(Debug)]
            struct CreateScalingPlanEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateScalingPlanEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateScalingPlanEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateScalingPlanInput>()
                        .ok_or("failed to downcast to CreateScalingPlanInput")?;
...
pub enum CreateScalingPlanError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateScalingPlanError) for what information is available for the error.")]
...
impl CreateScalingPlanError {
    /// Creates the `CreateScalingPlanError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateScalingPlanError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateScalingPlanError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_scaling_plan::CreateScalingPlanError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_scaling_plan::_create_scaling_plan_output::CreateScalingPlanOutput;

pub use crate::operation::create_scaling_plan::_create_scaling_plan_input::CreateScalingPlanInput;

mod _create_scaling_plan_input;

mod _create_scaling_plan_output;
