...
impl CreateScalingPlanInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_scaling_plan::ser_create_scaling_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateScalingPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_scaling_plan::de_create_scaling_plan_http_response_with_props(status, headers, body)
        }
    }
}
