...
impl super::Client {
    ...
    ///   - [`scaling_plan_name(impl Into<String>)`](crate::operation::create_scaling_plan::builders::CreateScalingPlanFluentBuilder::scaling_plan_name) / [`set_scaling_plan_name(Option<String>)`](crate::operation::create_scaling_plan::builders::CreateScalingPlanFluentBuilder::set_scaling_plan_name):<br>required: **true**<br><p>The name of the scaling plan. Names cannot contain vertical bars, colons, or forward slashes.</p><br>
    ///   - [`application_source(ApplicationSource)`](crate::operation::create_scaling_plan::builders::CreateScalingPlanFluentBuilder::application_source) / [`set_application_source(Option<ApplicationSource>)`](crate::operation::create_scaling_plan::builders::CreateScalingPlanFluentBuilder::set_application_source):<br>required: **true**<br><p>A CloudFormation stack or set of tags. You can create one scaling plan per application source.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/plans/APIReference/API_ApplicationSource.html">ApplicationSource</a> in the <i>AWS Auto Scaling API Reference</i>.</p><br>
    ...
    ///   - [`scaling_plan_version(i64)`](crate::operation::create_scaling_plan::CreateScalingPlanOutput::scaling_plan_version): <p>The version number of the scaling plan. This value is always <code>1</code>. Currently, you cannot have multiple scaling plan versions.</p>
