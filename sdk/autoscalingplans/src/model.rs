...
pub struct ScalingInstruction  {
    ...
    #[doc(hidden)]pub target_tracking_configurations: std::option::Option<std::vec::Vec<crate::model::TargetTrackingConfiguration>>,
    ...
    #[doc(hidden)]pub predefined_load_metric_specification: std::option::Option<crate::model::PredefinedLoadMetricSpecification>,
    ...
    #[doc(hidden)]pub customized_load_metric_specification: std::option::Option<crate::model::CustomizedLoadMetricSpecification>,
    ...
    #[doc(hidden)]pub scheduled_action_buffer_time: std::option::Option<i32>,
    ...
    /// </ul> 
    /// <p>Only valid when configuring predictive scaling.</p>
    #[doc(hidden)]pub predictive_scaling_max_capacity_behavior: std::option::Option<crate::model::PredictiveScalingMaxCapacityBehavior>,
    ...
    #[doc(hidden)]pub predictive_scaling_max_capacity_buffer: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub predictive_scaling_mode: std::option::Option<crate::model::PredictiveScalingMode>,
    ...
    #[doc(hidden)]pub scaling_policy_update_behavior: std::option::Option<crate::model::ScalingPolicyUpdateBehavior>,
    ...
    #[doc(hidden)]pub disable_dynamic_scaling: std::option::Option<bool>,
}
impl ScalingInstruction {
    ...
    /// <p>The target tracking configurations (up to 10). Each of these structures must specify a unique scaling metric and a target value for the metric. </p>
    pub fn target_tracking_configurations(&self) -> std::option::Option<& [crate::model::TargetTrackingConfiguration]> {
        self.target_tracking_configurations.as_deref()
    }
    /// <p>The predefined load metric to use for predictive scaling. This parameter or a <b>CustomizedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
    pub fn predefined_load_metric_specification(&self) -> std::option::Option<& crate::model::PredefinedLoadMetricSpecification> {
        self.predefined_load_metric_specification.as_ref()
    }
    /// <p>The customized load metric to use for predictive scaling. This parameter or a <b>PredefinedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
    pub fn customized_load_metric_specification(&self) -> std::option::Option<& crate::model::CustomizedLoadMetricSpecification> {
    ...
    /// </ul> 
    /// <p>Only valid when configuring predictive scaling.</p>
    pub fn predictive_scaling_max_capacity_behavior(&self) -> std::option::Option<& crate::model::PredictiveScalingMaxCapacityBehavior> {
    ...
    /// <p>The predictive scaling mode. The default value is <code>ForecastAndScale</code>. Otherwise, AWS Auto Scaling forecasts capacity but does not create any scheduled scaling actions based on the capacity forecast. </p>
    pub fn predictive_scaling_mode(&self) -> std::option::Option<& crate::model::PredictiveScalingMode> {
    ...
    /// <p>Only valid when configuring dynamic scaling. </p> 
    /// <p>Condition: The number of existing policies to be replaced must be less than or equal to 50. If there are more than 50 policies to be replaced, AWS Auto Scaling keeps all existing policies and does not create new ones.</p>
    pub fn scaling_policy_update_behavior(&self) -> std::option::Option<& crate::model::ScalingPolicyUpdateBehavior> {
...
impl  std::fmt::Debug for ScalingInstruction  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("target_tracking_configurations", &self.target_tracking_configurations);
        ...
        formatter.field("scheduled_action_buffer_time", &self.scheduled_action_buffer_time);
        formatter.field("predictive_scaling_max_capacity_behavior", &self.predictive_scaling_max_capacity_behavior);
        formatter.field("predictive_scaling_max_capacity_buffer", &self.predictive_scaling_max_capacity_buffer);
        formatter.field("predictive_scaling_mode", &self.predictive_scaling_mode);
        formatter.field("scaling_policy_update_behavior", &self.scaling_policy_update_behavior);
...
pub mod scaling_instruction {
    ...
    pub struct Builder {
        ...
        pub(crate) target_tracking_configurations: std::option::Option<std::vec::Vec<crate::model::TargetTrackingConfiguration>>,
        pub(crate) predefined_load_metric_specification: std::option::Option<crate::model::PredefinedLoadMetricSpecification>,
        pub(crate) customized_load_metric_specification: std::option::Option<crate::model::CustomizedLoadMetricSpecification>,
        pub(crate) scheduled_action_buffer_time: std::option::Option<i32>,
        pub(crate) predictive_scaling_max_capacity_behavior: std::option::Option<crate::model::PredictiveScalingMaxCapacityBehavior>,
        pub(crate) predictive_scaling_max_capacity_buffer: std::option::Option<i32>,
        pub(crate) predictive_scaling_mode: std::option::Option<crate::model::PredictiveScalingMode>,
        pub(crate) scaling_policy_update_behavior: std::option::Option<crate::model::ScalingPolicyUpdateBehavior>,
    ...
    impl Builder {
        ...
        ///
        /// <p>The target tracking configurations (up to 10). Each of these structures must specify a unique scaling metric and a target value for the metric. </p>
        pub fn target_tracking_configurations(mut self, input: crate::model::TargetTrackingConfiguration) -> Self {
        ...
        /// <p>The target tracking configurations (up to 10). Each of these structures must specify a unique scaling metric and a target value for the metric. </p>
        pub fn set_target_tracking_configurations(mut self, input: std::option::Option<std::vec::Vec<crate::model::TargetTrackingConfiguration>>) -> Self {
            self.target_tracking_configurations = input; self
        }
        /// <p>The predefined load metric to use for predictive scaling. This parameter or a <b>CustomizedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
        pub fn predefined_load_metric_specification(mut self, input: crate::model::PredefinedLoadMetricSpecification) -> Self {
            self.predefined_load_metric_specification = Some(input);
            self
        }
        /// <p>The predefined load metric to use for predictive scaling. This parameter or a <b>CustomizedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
        pub fn set_predefined_load_metric_specification(mut self, input: std::option::Option<crate::model::PredefinedLoadMetricSpecification>) -> Self {
            self.predefined_load_metric_specification = input; self
        }
        /// <p>The customized load metric to use for predictive scaling. This parameter or a <b>PredefinedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
        pub fn customized_load_metric_specification(mut self, input: crate::model::CustomizedLoadMetricSpecification) -> Self {
            self.customized_load_metric_specification = Some(input);
            self
        }
        /// <p>The customized load metric to use for predictive scaling. This parameter or a <b>PredefinedLoadMetricSpecification</b> is required when configuring predictive scaling, and cannot be used otherwise. </p>
        pub fn set_customized_load_metric_specification(mut self, input: std::option::Option<crate::model::CustomizedLoadMetricSpecification>) -> Self {
        ...
        /// </ul> 
        /// <p>Only valid when configuring predictive scaling.</p>
        pub fn predictive_scaling_max_capacity_behavior(mut self, input: crate::model::PredictiveScalingMaxCapacityBehavior) -> Self {
        ...
        /// </ul> 
        /// <p>Only valid when configuring predictive scaling.</p>
        pub fn set_predictive_scaling_max_capacity_behavior(mut self, input: std::option::Option<crate::model::PredictiveScalingMaxCapacityBehavior>) -> Self {
        ...
        /// <p>The predictive scaling mode. The default value is <code>ForecastAndScale</code>. Otherwise, AWS Auto Scaling forecasts capacity but does not create any scheduled scaling actions based on the capacity forecast. </p>
        pub fn predictive_scaling_mode(mut self, input: crate::model::PredictiveScalingMode) -> Self {
            self.predictive_scaling_mode = Some(input);
            self
        }
        /// <p>The predictive scaling mode. The default value is <code>ForecastAndScale</code>. Otherwise, AWS Auto Scaling forecasts capacity but does not create any scheduled scaling actions based on the capacity forecast. </p>
        pub fn set_predictive_scaling_mode(mut self, input: std::option::Option<crate::model::PredictiveScalingMode>) -> Self {
        ...
        /// <p>Only valid when configuring dynamic scaling. </p> 
        /// <p>Condition: The number of existing policies to be replaced must be less than or equal to 50. If there are more than 50 policies to be replaced, AWS Auto Scaling keeps all existing policies and does not create new ones.</p>
        pub fn scaling_policy_update_behavior(mut self, input: crate::model::ScalingPolicyUpdateBehavior) -> Self {
        ...
        /// <p>Only valid when configuring dynamic scaling. </p> 
        /// <p>Condition: The number of existing policies to be replaced must be less than or equal to 50. If there are more than 50 policies to be replaced, AWS Auto Scaling keeps all existing policies and does not create new ones.</p>
        pub fn set_scaling_policy_update_behavior(mut self, input: std::option::Option<crate::model::ScalingPolicyUpdateBehavior>) -> Self {
...
pub struct PredefinedLoadMetricSpecification  {
    /// <p>The metric type.</p>
    #[doc(hidden)]pub predefined_load_metric_type: std::option::Option<crate::model::LoadMetricType>,
...
impl PredefinedLoadMetricSpecification {
    /// <p>The metric type.</p>
    pub fn predefined_load_metric_type(&self) -> std::option::Option<& crate::model::LoadMetricType> {
...
impl  std::fmt::Debug for PredefinedLoadMetricSpecification  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predefined_load_metric_type", &self.predefined_load_metric_type);
...
pub mod predefined_load_metric_specification {
    ...
    impl Builder {
        ...
        /// <p>The metric type.</p>
        pub fn set_predefined_load_metric_type(mut self, input: std::option::Option<crate::model::LoadMetricType>) -> Self {
...
pub struct TargetTrackingConfiguration  {
    ...
    #[doc(hidden)]pub predefined_scaling_metric_specification: std::option::Option<crate::model::PredefinedScalingMetricSpecification>,
    /// <p>A customized metric. You can specify either a predefined metric or a customized metric. </p>
    #[doc(hidden)]pub customized_scaling_metric_specification: std::option::Option<crate::model::CustomizedScalingMetricSpecification>,
...
impl TargetTrackingConfiguration {
    /// <p>A predefined metric. You can specify either a predefined metric or a customized metric.</p>
    pub fn predefined_scaling_metric_specification(&self) -> std::option::Option<& crate::model::PredefinedScalingMetricSpecification> {
        self.predefined_scaling_metric_specification.as_ref()
    }
    /// <p>A customized metric. You can specify either a predefined metric or a customized metric. </p>
    pub fn customized_scaling_metric_specification(&self) -> std::option::Option<& crate::model::CustomizedScalingMetricSpecification> {
...
pub mod target_tracking_configuration {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) predefined_scaling_metric_specification: std::option::Option<crate::model::PredefinedScalingMetricSpecification>,
        pub(crate) customized_scaling_metric_specification: std::option::Option<crate::model::CustomizedScalingMetricSpecification>,
    ...
    impl Builder {
        /// <p>A predefined metric. You can specify either a predefined metric or a customized metric.</p>
        pub fn predefined_scaling_metric_specification(mut self, input: crate::model::PredefinedScalingMetricSpecification) -> Self {
            self.predefined_scaling_metric_specification = Some(input);
            self
        }
        /// <p>A predefined metric. You can specify either a predefined metric or a customized metric.</p>
        pub fn set_predefined_scaling_metric_specification(mut self, input: std::option::Option<crate::model::PredefinedScalingMetricSpecification>) -> Self {
            self.predefined_scaling_metric_specification = input; self
        }
        /// <p>A customized metric. You can specify either a predefined metric or a customized metric. </p>
        pub fn customized_scaling_metric_specification(mut self, input: crate::model::CustomizedScalingMetricSpecification) -> Self {
            self.customized_scaling_metric_specification = Some(input);
            self
        }
        /// <p>A customized metric. You can specify either a predefined metric or a customized metric. </p>
        pub fn set_customized_scaling_metric_specification(mut self, input: std::option::Option<crate::model::CustomizedScalingMetricSpecification>) -> Self {
...
pub struct PredefinedScalingMetricSpecification  {
    ...
    #[doc(hidden)]pub predefined_scaling_metric_type: std::option::Option<crate::model::ScalingMetricType>,
...
impl PredefinedScalingMetricSpecification {
    /// <p>The metric type. The <code>ALBRequestCountPerTarget</code> metric type applies only to Auto Scaling groups, Spot Fleet requests, and ECS services.</p>
    pub fn predefined_scaling_metric_type(&self) -> std::option::Option<& crate::model::ScalingMetricType> {
...
impl  std::fmt::Debug for PredefinedScalingMetricSpecification  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predefined_scaling_metric_type", &self.predefined_scaling_metric_type);
        formatter.field("resource_label", &self.resource_label);
        formatter.finish()
    }
}
...
pub mod predefined_scaling_metric_specification {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) predefined_scaling_metric_type: std::option::Option<crate::model::ScalingMetricType>,
        pub(crate) resource_label: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p>The metric type. The <code>ALBRequestCountPerTarget</code> metric type applies only to Auto Scaling groups, Spot Fleet requests, and ECS services.</p>
        pub fn predefined_scaling_metric_type(mut self, input: crate::model::ScalingMetricType) -> Self {
            self.predefined_scaling_metric_type = Some(input);
            self
        }
        /// <p>The metric type. The <code>ALBRequestCountPerTarget</code> metric type applies only to Auto Scaling groups, Spot Fleet requests, and ECS services.</p>
        pub fn set_predefined_scaling_metric_type(mut self, input: std::option::Option<crate::model::ScalingMetricType>) -> Self {
...
pub struct ScalingPlan  {
    ...
    #[doc(hidden)]pub scaling_plan_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub application_source: std::option::Option<crate::model::ApplicationSource>,
    /// <p>The scaling instructions.</p>
    #[doc(hidden)]pub scaling_instructions: std::option::Option<std::vec::Vec<crate::model::ScalingInstruction>>,
    ...
    /// </ul>
    #[doc(hidden)]pub status_code: std::option::Option<crate::model::ScalingPlanStatusCode>,
    ...
    #[doc(hidden)]pub status_start_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub mod scaling_plan {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>UpdateFailed</code> - The scaling plan could not be updated.</p> </li> 
        /// </ul>
        pub fn set_status_code(mut self, input: std::option::Option<crate::model::ScalingPlanStatusCode>) -> Self {
...
pub struct ScalingPlanResource  {
    ...
    /// </ul>
    #[doc(hidden)]pub scaling_status_code: std::option::Option<crate::model::ScalingStatusCode>,
    /// <p>A simple message about the current scaling status of the resource.</p>
    #[doc(hidden)]pub scaling_status_message: std::option::Option<std::string::String>,
}
...
pub mod scaling_plan_resource {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>PartiallyActive</code> - The scaling configuration is partially active because the scaling plan is being created or deleted or the scaling configuration could not be fully applied. Check the status message for more information.</p> </li> 
        /// </ul>
        pub fn set_scaling_status_code(mut self, input: std::option::Option<crate::model::ScalingStatusCode>) -> Self {
