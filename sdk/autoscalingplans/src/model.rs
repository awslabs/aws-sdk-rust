...
pub struct ScalingInstruction  {
    ...
    #[doc(hidden)]
    pub target_tracking_configurations: std::option::Option<std::vec::Vec<crate::model::TargetTrackingConfiguration>>,
    ...
    #[doc(hidden)]
    pub predefined_load_metric_specification: std::option::Option<crate::model::PredefinedLoadMetricSpecification>,
    ...
    #[doc(hidden)]
    pub customized_load_metric_specification: std::option::Option<crate::model::CustomizedLoadMetricSpecification>,
    ...
    /// <p>Only valid when configuring predictive scaling.</p>
    #[doc(hidden)]
    pub predictive_scaling_max_capacity_behavior: std::option::Option<crate::model::PredictiveScalingMaxCapacityBehavior>,
    ...
    #[doc(hidden)]
    pub scaling_policy_update_behavior: std::option::Option<crate::model::ScalingPolicyUpdateBehavior>,
...
pub struct TargetTrackingConfiguration  {
    ...
    #[doc(hidden)]
    pub predefined_scaling_metric_specification: std::option::Option<crate::model::PredefinedScalingMetricSpecification>,
    /// <p>A customized metric. You can specify either a predefined metric or a customized metric. </p>
    #[doc(hidden)]
    pub customized_scaling_metric_specification: std::option::Option<crate::model::CustomizedScalingMetricSpecification>,
