...
pub struct GetScalingPlanResourceForecastDataOutput  {
    ...
    #[doc(hidden)]pub datapoints: std::option::Option<std::vec::Vec<crate::model::Datapoint>>,
}
...
pub struct DescribeScalingPlansOutput  {
    ...
    #[doc(hidden)]pub scaling_plans: std::option::Option<std::vec::Vec<crate::model::ScalingPlan>>,
...
pub struct DescribeScalingPlanResourcesOutput  {
    ...
    #[doc(hidden)]pub scaling_plan_resources: std::option::Option<std::vec::Vec<crate::model::ScalingPlanResource>>,
    /// <p>The token required to get the next set of results. This value is <code>null</code> if there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct CreateScalingPlanOutput  {
    ...
    #[doc(hidden)]pub scaling_plan_version: std::option::Option<i64>,
}
