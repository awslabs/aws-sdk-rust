...
pub fn serialize_structure_create_scaling_plan_input(
    ...
    if let Some(var_2) = &input.application_source {
        ...
        crate::json_ser::serialize_structure_application_source(&mut object_3, var_2);
        object_3.finish();
    }
        ...
        for item_6 in var_4 {
            {
                ...
                crate::json_ser::serialize_structure_scaling_instruction(&mut object_7, item_6);
                object_7.finish();
            }
        }
        array_5.finish();
...
pub fn serialize_structure_delete_scaling_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scaling_plan_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scaling_plans_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_20 in var_18 {
            {
                ...
                crate::json_ser::serialize_structure_application_source(&mut object_21, item_20);
                object_21.finish();
            }
        }
        array_19.finish();
...
pub fn serialize_structure_get_scaling_plan_resource_forecast_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_scaling_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_34) = &input.application_source {
        ...
        crate::json_ser::serialize_structure_application_source(&mut object_35, var_34);
        object_35.finish();
    }
        ...
        for item_38 in var_36 {
            {
                ...
                crate::json_ser::serialize_structure_scaling_instruction(&mut object_39, item_38);
                object_39.finish();
            }
        }
        array_37.finish();
...
pub fn serialize_structure_application_source(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_43 in var_41 {
            {
                ...
                crate::json_ser::serialize_structure_tag_filter(&mut object_44, item_43);
                object_44.finish();
            }
        }
        array_42.finish();
...
pub fn serialize_structure_scaling_instruction(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_52 in var_50 {
            {
                ...
                crate::json_ser::serialize_structure_target_tracking_configuration(
                    &mut object_53,
                    item_52,
                );
                object_53.finish();
    ...
    if let Some(var_54) = &input.predefined_load_metric_specification {
        let mut object_55 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_predefined_load_metric_specification(
            &mut object_55,
            var_54,
        );
        object_55.finish();
    ...
    if let Some(var_56) = &input.customized_load_metric_specification {
        let mut object_57 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_customized_load_metric_specification(
            &mut object_57,
            var_56,
        );
        object_57.finish();
...
pub fn serialize_structure_target_tracking_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_68) = &input.predefined_scaling_metric_specification {
        let mut object_69 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_predefined_scaling_metric_specification(
            &mut object_69,
            var_68,
        );
        object_69.finish();
    ...
    if let Some(var_70) = &input.customized_scaling_metric_specification {
        let mut object_71 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_customized_scaling_metric_specification(
            &mut object_71,
            var_70,
        );
        object_71.finish();
...
pub fn serialize_structure_predefined_load_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_customized_load_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_83 in var_81 {
            {
                ...
                crate::json_ser::serialize_structure_metric_dimension(&mut object_84, item_83);
                object_84.finish();
            }
        }
        array_82.finish();
...
pub fn serialize_structure_predefined_scaling_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_customized_scaling_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_93 in var_91 {
            {
                ...
                crate::json_ser::serialize_structure_metric_dimension(&mut object_94, item_93);
                object_94.finish();
            }
        }
        array_92.finish();
