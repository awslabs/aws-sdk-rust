            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "dnsTargetResource" => {
                            builder = builder.set_dns_target_resource(crate::protocol_serde::shape_dns_target_resource::de_dns_target_resource(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "readinessScopes" => {
                            builder = builder.set_readiness_scopes(crate::protocol_serde::shape_list_of_string::de_list_of_string(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
