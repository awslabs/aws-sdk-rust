...
pub(crate) fn de_list_of_message<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Message>>, ::aws_smithy_json::deserialize::error::DeserializeError>
