...
pub fn de_get_architecture_recommendations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsOutput, crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_architecture_recommendations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsOutput, crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError> {
    Ok({
        #[allow(unused_mut)]
