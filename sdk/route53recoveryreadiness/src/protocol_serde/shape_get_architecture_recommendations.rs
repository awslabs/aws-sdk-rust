...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_architecture_recommendations::de_get_architecture_recommendations(_response_body, output)
            .map_err(crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "lastAuditTimestamp" => {
                    builder = builder.set_last_audit_timestamp(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                        tokens.next(),
                ...
                "recommendations" => {
                    builder = builder.set_recommendations(crate::protocol_serde::shape_list_of_recommendation::de_list_of_recommendation(
                        tokens, _value,
                    )?);
                }
