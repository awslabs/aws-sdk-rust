...
pub fn de_get_cell_readiness_summary_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryOutput, crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cell_readiness_summary_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryOutput, crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryError> {
    Ok({
        #[allow(unused_mut)]
