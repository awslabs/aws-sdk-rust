...
pub fn de_get_cell_readiness_summary_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCellReadinessSummaryOutput, crate::error::GetCellReadinessSummaryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetCellReadinessSummaryError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::error::GetCellReadinessSummaryError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::error::GetCellReadinessSummaryError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetCellReadinessSummaryError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cell_readiness_summary_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCellReadinessSummaryOutput, crate::error::GetCellReadinessSummaryError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_cell_readiness_summary_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_cell_readiness_summary::de_get_cell_readiness_summary(response.body().as_ref(), output).map_err(crate::error::GetCellReadinessSummaryError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_cell_readiness_summary(value: &[u8], mut builder: crate::output::get_cell_readiness_summary_output::Builder) -> Result<crate::output::get_cell_readiness_summary_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
