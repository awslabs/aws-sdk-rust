...
pub fn de_get_recovery_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRecoveryGroupOutput, crate::error::GetRecoveryGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetRecoveryGroupError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::error::GetRecoveryGroupError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetRecoveryGroupError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_recovery_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRecoveryGroupOutput, crate::error::GetRecoveryGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_recovery_group_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_recovery_group::de_get_recovery_group(response.body().as_ref(), output).map_err(crate::error::GetRecoveryGroupError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_recovery_group(value: &[u8], mut builder: crate::output::get_recovery_group_output::Builder) -> Result<crate::output::get_recovery_group_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
