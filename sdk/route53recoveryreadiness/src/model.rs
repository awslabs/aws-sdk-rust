...
pub struct Resource  {
    ...
    #[doc(hidden)]pub component_id: std::option::Option<std::string::String>,
    /// <p>The DNS target resource.</p>
    #[doc(hidden)]pub dns_target_resource: std::option::Option<crate::model::DnsTargetResource>,
    /// <p>A list of recovery group Amazon Resource Names (ARNs) and cell ARNs that this resource is contained within.</p>
    #[doc(hidden)]pub readiness_scopes: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct DnsTargetResource  {
    ...
    #[doc(hidden)]pub hosted_zone_arn: std::option::Option<std::string::String>,
    /// <p>The Route 53 record set ID that uniquely identifies a DNS record, given a name and a type.</p>
    #[doc(hidden)]pub record_set_id: std::option::Option<std::string::String>,
    /// <p>The type of DNS record of the target resource.</p>
    #[doc(hidden)]pub record_type: std::option::Option<std::string::String>,
    /// <p>The target resource of the DNS target resource.</p>
    #[doc(hidden)]pub target_resource: std::option::Option<crate::model::TargetResource>,
}
...
pub struct TargetResource  {
    ...
    #[doc(hidden)]pub nlb_resource: std::option::Option<crate::model::NlbResource>,
    /// <p>The Route 53 resource.</p>
    #[doc(hidden)]pub r53_resource: std::option::Option<crate::model::R53ResourceRecord>,
}
impl TargetResource {
    /// <p>The Network Load Balancer Resource.</p>
...
pub struct ListRulesOutput  {
    ...
    #[doc(hidden)]pub rule_description: std::option::Option<std::string::String>,
...
pub struct ResourceResult  {
    ...
    #[doc(hidden)]pub last_checked_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct Recommendation  {
    ...
    #[doc(hidden)]pub recommendation_text: std::option::Option<std::string::String>,
}
impl Recommendation {
    /// <p>Text of the recommendations that are provided to make an application more recovery resilient.</p>
