...
pub fn serialize_structure_create_cell_input(
...
pub fn serialize_structure_create_cross_account_authorization_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_readiness_check_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_recovery_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_resource_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_28 in var_26 {
            {
                ...
                crate::json_ser::serialize_structure_resource(&mut object_29, item_28);
                object_29.finish();
            }
        }
        array_27.finish();
...
pub fn serialize_structure_update_cell_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_readiness_check_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_recovery_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_resource_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_48 in var_46 {
            {
                ...
                crate::json_ser::serialize_structure_resource(&mut object_49, item_48);
                object_49.finish();
            }
        }
        array_47.finish();
...
pub fn serialize_structure_resource(
    ...
    if let Some(var_51) = &input.dns_target_resource {
        ...
        crate::json_ser::serialize_structure_dns_target_resource(&mut object_52, var_51);
        object_52.finish();
    }
...
pub fn serialize_structure_dns_target_resource(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_61) = &input.target_resource {
        ...
        crate::json_ser::serialize_structure_target_resource(&mut object_62, var_61);
        object_62.finish();
    }
}

pub fn serialize_structure_target_resource(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_63) = &input.nlb_resource {
        ...
        crate::json_ser::serialize_structure_nlb_resource(&mut object_64, var_63);
        object_64.finish();
    }
    if let Some(var_65) = &input.r53_resource {
        let mut object_66 = object.key("r53Resource").start_object();
        crate::json_ser::serialize_structure_r53_resource_record(&mut object_66, var_65);
        object_66.finish();
    }
}

pub fn serialize_structure_nlb_resource(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_r53_resource_record(
    object: &mut smithy_json::serialize::JsonObjectWriter,
