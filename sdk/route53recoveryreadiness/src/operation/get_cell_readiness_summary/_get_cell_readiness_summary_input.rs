...
impl GetCellReadinessSummaryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cell_readiness_summary::GetCellReadinessSummaryInput, ::aws_smithy_types::error::operation::BuildError> {
