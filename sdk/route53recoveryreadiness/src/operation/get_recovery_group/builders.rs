...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_recovery_group::GetRecoveryGroupOutput,
                    crate::operation::get_recovery_group::GetRecoveryGroupError,
                > for GetRecoveryGroupFluentBuilder
            {
                fn send(
                    self,
...
impl GetRecoveryGroupFluentBuilder {
    ...
    /// Access the GetRecoveryGroup as a reference.
    pub fn as_input(&self) -> &crate::operation::get_recovery_group::builders::GetRecoveryGroupInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_recovery_group::GetRecoveryGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_recovery_group::GetRecoveryGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_recovery_group::GetRecoveryGroup::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_recovery_group::GetRecoveryGroup::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_recovery_group::GetRecoveryGroupOutput, crate::operation::get_recovery_group::GetRecoveryGroupError, Self> {
