...
/// Orchestration and serialization glue logic for `DeleteRecoveryGroup`.
...
impl DeleteRecoveryGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_recovery_group::DeleteRecoveryGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_recovery_group::DeleteRecoveryGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_recovery_group::DeleteRecoveryGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_recovery_group::DeleteRecoveryGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_recovery_group::DeleteRecoveryGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRecoveryGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteRecoveryGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteRecoveryGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteRecoveryGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRecoveryGroup")
...
.with_interceptor(DeleteRecoveryGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_recovery_group::DeleteRecoveryGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_recovery_group::DeleteRecoveryGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_recovery_group::DeleteRecoveryGroupError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_recovery_group::de_delete_recovery_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_recovery_group::de_delete_recovery_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRecoveryGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_recovery_group::DeleteRecoveryGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_recovery_group::DeleteRecoveryGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRecoveryGroupEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteRecoveryGroupInput>()
                        .ok_or("failed to downcast to DeleteRecoveryGroupInput")?;
...
pub enum DeleteRecoveryGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteRecoveryGroupError) for what information is available for the error.")]
...
impl DeleteRecoveryGroupError {
    /// Creates the `DeleteRecoveryGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteRecoveryGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteRecoveryGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_recovery_group::DeleteRecoveryGroupError {
...
mod _delete_recovery_group_output;
