...
impl ListCrossAccountAuthorizationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_cross_account_authorizations::ListCrossAccountAuthorizations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCrossAccountAuthorizations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_cross_account_authorizations::de_list_cross_account_authorizations_http_response_with_props(
                status, headers, body,
            )
        }
    }
