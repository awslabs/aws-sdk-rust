...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_readiness_check::GetReadinessCheckOutput,
                    crate::operation::get_readiness_check::GetReadinessCheckError,
                > for GetReadinessCheckFluentBuilder
            {
                fn send(
                    self,
...
impl GetReadinessCheckFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_readiness_check::GetReadinessCheckOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_readiness_check::GetReadinessCheckError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_readiness_check::GetReadinessCheck::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_readiness_check::GetReadinessCheck::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_readiness_check::GetReadinessCheckOutput, crate::operation::get_readiness_check::GetReadinessCheckError, Self> {
