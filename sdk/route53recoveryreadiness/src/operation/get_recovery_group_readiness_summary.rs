...
impl GetRecoveryGroupReadinessSummaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_recovery_group_readiness_summary::GetRecoveryGroupReadinessSummary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRecoveryGroupReadinessSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_recovery_group_readiness_summary::de_get_recovery_group_readiness_summary_http_response_with_props(
                status, headers, body,
            )
        }
    }
