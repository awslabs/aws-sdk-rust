...
impl crate::operation::get_recovery_group_readiness_summary::builders::GetRecoveryGroupReadinessSummaryInputBuilder {
...
impl GetRecoveryGroupReadinessSummaryFluentBuilder {
    /// Creates a new `GetRecoveryGroupReadinessSummaryFluentBuilder`.
