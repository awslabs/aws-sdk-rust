...
impl crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusInputBuilder {
...
impl GetReadinessCheckResourceStatusFluentBuilder {
    /// Creates a new `GetReadinessCheckResourceStatusFluentBuilder`.
