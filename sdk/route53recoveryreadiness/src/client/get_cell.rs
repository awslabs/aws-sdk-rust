...
impl super::Client {
    ...
    ///   - [`cell_name(impl ::std::convert::Into<String>)`](crate::operation::get_cell::builders::GetCellFluentBuilder::cell_name) / [`set_cell_name(Option<String>)`](crate::operation::get_cell::builders::GetCellFluentBuilder::set_cell_name): <p>The name of the cell.</p>
