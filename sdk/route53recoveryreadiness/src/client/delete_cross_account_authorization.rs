...
impl super::Client {
    ...
    ///   - [`cross_account_authorization(impl Into<String>)`](crate::operation::delete_cross_account_authorization::builders::DeleteCrossAccountAuthorizationFluentBuilder::cross_account_authorization) / [`set_cross_account_authorization(Option<String>)`](crate::operation::delete_cross_account_authorization::builders::DeleteCrossAccountAuthorizationFluentBuilder::set_cross_account_authorization):<br>required: **true**<br><p>The cross-account authorization.</p><br>
