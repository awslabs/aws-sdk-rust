...
impl super::Client {
    ...
    ///   - [`readiness_check_name(impl Into<String>)`](crate::operation::get_readiness_check::builders::GetReadinessCheckFluentBuilder::readiness_check_name) / [`set_readiness_check_name(Option<String>)`](crate::operation::get_readiness_check::builders::GetReadinessCheckFluentBuilder::set_readiness_check_name):<br>required: **true**<br><p>Name of a readiness check.</p><br>
