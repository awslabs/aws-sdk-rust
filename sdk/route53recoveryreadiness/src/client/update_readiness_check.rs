...
impl super::Client {
    ...
    ///   - [`readiness_check_name(impl Into<String>)`](crate::operation::update_readiness_check::builders::UpdateReadinessCheckFluentBuilder::readiness_check_name) / [`set_readiness_check_name(Option<String>)`](crate::operation::update_readiness_check::builders::UpdateReadinessCheckFluentBuilder::set_readiness_check_name):<br>required: **true**<br><p>Name of a readiness check.</p><br>
    ///   - [`resource_set_name(impl Into<String>)`](crate::operation::update_readiness_check::builders::UpdateReadinessCheckFluentBuilder::resource_set_name) / [`set_resource_set_name(Option<String>)`](crate::operation::update_readiness_check::builders::UpdateReadinessCheckFluentBuilder::set_resource_set_name):<br>required: **true**<br><p>The name of the resource set to be checked.</p><br>
