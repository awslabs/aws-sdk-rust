...
impl super::Client {
    ...
    pub fn list_readiness_checks(
        &self,
    ) -> crate::operation::list_readiness_checks::builders::ListReadinessChecksFluentBuilder {
        crate::operation::list_readiness_checks::builders::ListReadinessChecksFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
