...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::set_max_results): <p>The number of objects that you want to return with this call.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::set_next_token): <p>The token that identifies which batch of results you want to see.</p>
    ///   - [`readiness_check_name(impl ::std::convert::Into<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::readiness_check_name) / [`set_readiness_check_name(Option<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::set_readiness_check_name): <p>Name of a readiness check.</p>
    ///   - [`resource_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::get_readiness_check_resource_status::builders::GetReadinessCheckResourceStatusFluentBuilder::set_resource_identifier): <p>The resource identifier, which is the Amazon Resource Name (ARN) or the identifier generated for the resource by Application Recovery Controller (for example, for a DNS target resource).</p>
