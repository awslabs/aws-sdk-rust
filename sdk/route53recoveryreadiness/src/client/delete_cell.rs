...
impl super::Client {
    ...
    ///   - [`cell_name(impl Into<String>)`](crate::operation::delete_cell::builders::DeleteCellFluentBuilder::cell_name) / [`set_cell_name(Option<String>)`](crate::operation::delete_cell::builders::DeleteCellFluentBuilder::set_cell_name):<br>required: **true**<br><p>The name of the cell.</p><br>
