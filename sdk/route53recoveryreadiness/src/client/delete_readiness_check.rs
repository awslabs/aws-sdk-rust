...
impl super::Client {
    ...
    ///   - [`readiness_check_name(impl Into<String>)`](crate::operation::delete_readiness_check::builders::DeleteReadinessCheckFluentBuilder::readiness_check_name) / [`set_readiness_check_name(Option<String>)`](crate::operation::delete_readiness_check::builders::DeleteReadinessCheckFluentBuilder::set_readiness_check_name):<br>required: **true**<br><p>Name of a readiness check.</p><br>
