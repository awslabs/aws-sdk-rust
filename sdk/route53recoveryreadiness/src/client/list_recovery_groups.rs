...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_recovery_groups::builders::ListRecoveryGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_recovery_groups::builders::ListRecoveryGroupsFluentBuilder::set_max_results):<br>required: **false**<br><p>The number of objects that you want to return with this call.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_recovery_groups::builders::ListRecoveryGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_recovery_groups::builders::ListRecoveryGroupsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token that identifies which batch of results you want to see.</p><br>
