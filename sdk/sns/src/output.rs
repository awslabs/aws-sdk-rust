...
pub struct PublishBatchOutput  {
    ...
    #[doc(hidden)]pub successful: std::option::Option<std::vec::Vec<crate::model::PublishBatchResultEntry>>,
...
pub struct ListSmsSandboxPhoneNumbersOutput  {
    ...
    #[doc(hidden)]pub phone_numbers: std::option::Option<std::vec::Vec<crate::model::SmsSandboxPhoneNumber>>,
...
pub struct ListPlatformApplicationsOutput  {
    ...
    #[doc(hidden)]pub platform_applications: std::option::Option<std::vec::Vec<crate::model::PlatformApplication>>,
...
pub struct ListPhoneNumbersOptedOutOutput  {
    ...
    #[doc(hidden)]pub phone_numbers: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct GetSmsSandboxAccountStatusOutput  {
    ...
    #[doc(hidden)]pub is_in_sandbox: bool,
}
...
pub struct CheckIfPhoneNumberIsOptedOutOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub is_opted_out: bool,
}
