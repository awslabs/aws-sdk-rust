...
pub struct SmsSandboxPhoneNumber  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::SmsSandboxPhoneNumberVerificationStatus>,
}
...
pub struct PhoneNumberInformation  {
    ...
    #[doc(hidden)]pub iso2_country_code: std::option::Option<std::string::String>,
