    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`topic_arn(Option<String>)`](crate::input::AddPermissionInput::topic_arn): <p>The ARN of the topic whose access control policy you wish to modify.</p>
    ///   - [`label(Option<String>)`](crate::input::AddPermissionInput::label): <p>A unique identifier for the new policy statement.</p>
    ///   - [`aws_account_id(Option<Vec<String>>)`](crate::input::AddPermissionInput::aws_account_id): <p>The Amazon Web Services account IDs of the users (principals) who will be given access to the specified actions. The users must have Amazon Web Services account, but do not need to be signed up for this service.</p>
    ///   - [`action_name(Option<Vec<String>>)`](crate::input::AddPermissionInput::action_name): <p>The action you want to allow for the specified principal(s).</p>  <p>Valid values: Any Amazon SNS action name, for example <code>Publish</code>.</p>
    ...
    ///
    /// - Takes [`CheckIfPhoneNumberIsOptedOutInput`](crate::input::CheckIfPhoneNumberIsOptedOutInput) with field(s):
    ///   - [`phone_number(Option<String>)`](crate::input::CheckIfPhoneNumberIsOptedOutInput::phone_number): <p>The phone number for which you want to check the opt out status.</p>
    ...
    ///
    /// - Takes [`ConfirmSubscriptionInput`](crate::input::ConfirmSubscriptionInput) with field(s):
    ///   - [`topic_arn(Option<String>)`](crate::input::ConfirmSubscriptionInput::topic_arn): <p>The ARN of the topic for which you wish to confirm a subscription.</p>
    ///   - [`token(Option<String>)`](crate::input::ConfirmSubscriptionInput::token): <p>Short-lived token sent to an endpoint during the <code>Subscribe</code> action.</p>
    ///   - [`authenticate_on_unsubscribe(Option<String>)`](crate::input::ConfirmSubscriptionInput::authenticate_on_unsubscribe): <p>Disallows unauthenticated unsubscribes of the subscription. If the value of this parameter is <code>true</code> and the request has an Amazon Web Services signature, then only the topic owner and the subscription owner can unsubscribe the endpoint. The unsubscribe action requires Amazon Web Services authentication. </p>
    ...
    ///
    /// - Takes [`CreatePlatformApplicationInput`](crate::input::CreatePlatformApplicationInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::CreatePlatformApplicationInput::name): <p>Application names must be made up of only uppercase and lowercase ASCII letters, numbers, underscores, hyphens, and periods, and must be between 1 and 256 characters long.</p>
    ///   - [`platform(Option<String>)`](crate::input::CreatePlatformApplicationInput::platform): <p>The following platforms are supported: ADM (Amazon Device Messaging), APNS (Apple Push Notification Service), APNS_SANDBOX, and GCM (Firebase Cloud Messaging).</p>
    ///   - [`attributes(Option<HashMap<String, String>>)`](crate::input::CreatePlatformApplicationInput::attributes): <p>For a list of attributes, see <a href="https://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes.html">SetPlatformApplicationAttributes</a>.</p>
    ...
    ///
    /// - Takes [`CreatePlatformEndpointInput`](crate::input::CreatePlatformEndpointInput) with field(s):
    ///   - [`platform_application_arn(Option<String>)`](crate::input::CreatePlatformEndpointInput::platform_application_arn): <p>PlatformApplicationArn returned from CreatePlatformApplication is used to create a an endpoint.</p>
    ///   - [`token(Option<String>)`](crate::input::CreatePlatformEndpointInput::token): <p>Unique identifier created by the notification service for an app on a device. The specific name for Token will vary, depending on which notification service is being used. For example, when using APNS as the notification service, you need the device token. Alternatively, when using GCM (Firebase Cloud Messaging) or ADM, the device token equivalent is called the registration ID.</p>
    ///   - [`custom_user_data(Option<String>)`](crate::input::CreatePlatformEndpointInput::custom_user_data): <p>Arbitrary user data to associate with the endpoint. Amazon SNS does not use this data. The data must be in UTF-8 format and less than 2KB.</p>
    ///   - [`attributes(Option<HashMap<String, String>>)`](crate::input::CreatePlatformEndpointInput::attributes): <p>For a list of attributes, see <a href="https://docs.aws.amazon.com/sns/latest/api/API_SetEndpointAttributes.html">SetEndpointAttributes</a>.</p>
    ...
    ///
    /// - Takes [`CreateSmsSandboxPhoneNumberInput`](crate::input::CreateSmsSandboxPhoneNumberInput) with field(s):
    ///   - [`phone_number(Option<String>)`](crate::input::CreateSmsSandboxPhoneNumberInput::phone_number): <p>The destination phone number to verify. On verification, Amazon SNS adds this phone number to the list of verified phone numbers that you can send SMS messages to.</p>
    ///   - [`language_code(Option<LanguageCodeString>)`](crate::input::CreateSmsSandboxPhoneNumberInput::language_code): <p>The language to use for sending the OTP. The default value is <code>en-US</code>.</p>
    ...
    ///   - [`endpoint_arn(Option<String>)`](crate::input::DeleteEndpointInput::endpoint_arn): <p>EndpointArn of endpoint to delete.</p>
    ...
    ///
    /// - Takes [`DeletePlatformApplicationInput`](crate::input::DeletePlatformApplicationInput) with field(s):
    ///   - [`platform_application_arn(Option<String>)`](crate::input::DeletePlatformApplicationInput::platform_application_arn): <p>PlatformApplicationArn of platform application object to delete.</p>
    ...
    ///
    /// - Takes [`DeleteSmsSandboxPhoneNumberInput`](crate::input::DeleteSmsSandboxPhoneNumberInput) with field(s):
    ///   - [`phone_number(Option<String>)`](crate::input::DeleteSmsSandboxPhoneNumberInput::phone_number): <p>The destination phone number to delete.</p>
    ...
    ///
    /// - Takes [`DeleteTopicInput`](crate::input::DeleteTopicInput) with field(s):
    ///   - [`topic_arn(Option<String>)`](crate::input::DeleteTopicInput::topic_arn): <p>The ARN of the topic you want to delete.</p>
    ...
    ///
    /// - Takes [`GetEndpointAttributesInput`](crate::input::GetEndpointAttributesInput) with field(s):
    ///   - [`endpoint_arn(Option<String>)`](crate::input::GetEndpointAttributesInput::endpoint_arn): <p>EndpointArn for GetEndpointAttributes input.</p>
    ...
    ///
    /// - Takes [`GetPlatformApplicationAttributesInput`](crate::input::GetPlatformApplicationAttributesInput) with field(s):
    ///   - [`platform_application_arn(Option<String>)`](crate::input::GetPlatformApplicationAttributesInput::platform_application_arn): <p>PlatformApplicationArn for GetPlatformApplicationAttributesInput.</p>
    ...
    ///
    /// - Takes [`GetSmsSandboxAccountStatusInput`](crate::input::GetSmsSandboxAccountStatusInput)
    ...
    ///
    /// - Takes [`GetSubscriptionAttributesInput`](crate::input::GetSubscriptionAttributesInput) with field(s):
    ///   - [`subscription_arn(Option<String>)`](crate::input::GetSubscriptionAttributesInput::subscription_arn): <p>The ARN of the subscription whose properties you want to get.</p>
    ...
    ///
    /// - Takes [`GetTopicAttributesInput`](crate::input::GetTopicAttributesInput) with field(s):
    ///   - [`topic_arn(Option<String>)`](crate::input::GetTopicAttributesInput::topic_arn): <p>The ARN of the topic whose properties you want to get.</p>
    ...
    ///
    /// - Takes [`ListEndpointsByPlatformApplicationInput`](crate::input::ListEndpointsByPlatformApplicationInput) with field(s):
    ///   - [`platform_application_arn(Option<String>)`](crate::input::ListEndpointsByPlatformApplicationInput::platform_application_arn): <p>PlatformApplicationArn for ListEndpointsByPlatformApplicationInput action.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListEndpointsByPlatformApplicationInput::next_token): <p>NextToken string is used when calling ListEndpointsByPlatformApplication action to retrieve additional records that are available after the first page results.</p>
    ...
    ///
    /// - Takes [`ListOriginationNumbersInput`](crate::input::ListOriginationNumbersInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListOriginationNumbersInput::next_token): <p>Token that the previous <code>ListOriginationNumbers</code> request returns.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListOriginationNumbersInput::max_results): <p>The maximum number of origination numbers to return.</p>
    ...
    ///
    /// - Takes [`ListPhoneNumbersOptedOutInput`](crate::input::ListPhoneNumbersOptedOutInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListPhoneNumbersOptedOutInput::next_token): <p>A <code>NextToken</code> string is used when you call the <code>ListPhoneNumbersOptedOut</code> action to retrieve additional records that are available after the first page of results.</p>
    ...
    ///
    /// - Takes [`ListPlatformApplicationsInput`](crate::input::ListPlatformApplicationsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListPlatformApplicationsInput::next_token): <p>NextToken string is used when calling ListPlatformApplications action to retrieve additional records that are available after the first page results.</p>
    ...
    ///
    /// - Takes [`ListSmsSandboxPhoneNumbersInput`](crate::input::ListSmsSandboxPhoneNumbersInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListSmsSandboxPhoneNumbersInput::next_token): <p>Token that the previous <code>ListSMSSandboxPhoneNumbersInput</code> request returns.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListSmsSandboxPhoneNumbersInput::max_results): <p>The maximum number of phone numbers to return.</p>
    ...
    ///
    /// - Takes [`ListSubscriptionsInput`](crate::input::ListSubscriptionsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListSubscriptionsInput::next_token): <p>Token returned by the previous <code>ListSubscriptions</code> request.</p>
    ...
    ///
    /// - Takes [`ListSubscriptionsByTopicInput`](crate::input::ListSubscriptionsByTopicInput) with field(s):
    ///   - [`topic_arn(Option<String>)`](crate::input::ListSubscriptionsByTopicInput::topic_arn): <p>The ARN of the topic for which you wish to find subscriptions.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListSubscriptionsByTopicInput::next_token): <p>Token returned by the previous <code>ListSubscriptionsByTopic</code> request.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The ARN of the topic for which to list tags.</p>
    ...
    ///
    /// - Takes [`ListTopicsInput`](crate::input::ListTopicsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListTopicsInput::next_token): <p>Token returned by the previous <code>ListTopics</code> request.</p>
    ...
    ///
    /// - Takes [`OptInPhoneNumberInput`](crate::input::OptInPhoneNumberInput) with field(s):
    ///   - [`phone_number(Option<String>)`](crate::input::OptInPhoneNumberInput::phone_number): <p>The phone number to opt in. Use E.164 format.</p>
    ...
    ///
    /// - Takes [`PublishBatchInput`](crate::input::PublishBatchInput) with field(s):
    ///   - [`topic_arn(Option<String>)`](crate::input::PublishBatchInput::topic_arn): <p>The Amazon resource name (ARN) of the topic you want to batch publish to.</p>
    ///   - [`publish_batch_request_entries(Option<Vec<PublishBatchRequestEntry>>)`](crate::input::PublishBatchInput::publish_batch_request_entries): <p>A list of <code>PublishBatch</code> request entries to be sent to the SNS topic.</p>
    ...
    ///   - [`topic_arn(Option<String>)`](crate::input::RemovePermissionInput::topic_arn): <p>The ARN of the topic whose access control policy you wish to modify.</p>
    ///   - [`label(Option<String>)`](crate::input::RemovePermissionInput::label): <p>The unique label of the statement you want to remove.</p>
    ...
    ///
    /// - Takes [`SetEndpointAttributesInput`](crate::input::SetEndpointAttributesInput) with field(s):
    ///   - [`endpoint_arn(Option<String>)`](crate::input::SetEndpointAttributesInput::endpoint_arn): <p>EndpointArn used for SetEndpointAttributes action.</p>
    ///   - [`attributes(Option<HashMap<String, String>>)`](crate::input::SetEndpointAttributesInput::attributes): <p>A map of the endpoint attributes. Attributes in this map include the following:</p>  <ul>   <li> <p> <code>CustomUserData</code> – arbitrary user data to associate with the endpoint. Amazon SNS does not use this data. The data must be in UTF-8 format and less than 2KB.</p> </li>   <li> <p> <code>Enabled</code> – flag that enables/disables delivery to the endpoint. Amazon SNS will set this to false when a notification service indicates to Amazon SNS that the endpoint is invalid. Users can set it back to true, typically after updating Token.</p> </li>   <li> <p> <code>Token</code> – device token, also referred to as a registration id, for an app and mobile device. This is returned from the notification service when an app and mobile device are registered with the notification service.</p> </li>  </ul>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The ARN of the topic to which to add tags.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>The tags to be added to the specified topic. A tag consists of a required key and an optional value.</p>
    ...
    ///   - [`subscription_arn(Option<String>)`](crate::input::UnsubscribeInput::subscription_arn): <p>The ARN of the subscription to be deleted.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The ARN of the topic from which to remove tags.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>The list of tag keys to remove from the specified topic.</p>
    ...
    ///
    /// - Takes [`VerifySmsSandboxPhoneNumberInput`](crate::input::VerifySmsSandboxPhoneNumberInput) with field(s):
    ///   - [`phone_number(Option<String>)`](crate::input::VerifySmsSandboxPhoneNumberInput::phone_number): <p>The destination phone number to verify.</p>
    ///   - [`one_time_password(Option<String>)`](crate::input::VerifySmsSandboxPhoneNumberInput::one_time_password): <p>The OTP sent to the destination number from the <code>CreateSMSSandBoxPhoneNumber</code> call.</p>
