...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_publish_batch_request_entry(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PublishBatchRequestEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
