...
impl super::Client {
    ...
    ///   - [`topic_arn(impl ::std::convert::Into<String>)`](crate::operation::publish_batch::builders::PublishBatchFluentBuilder::topic_arn) / [`set_topic_arn(Option<String>)`](crate::operation::publish_batch::builders::PublishBatchFluentBuilder::set_topic_arn): <p>The Amazon resource name (ARN) of the topic you want to batch publish to.</p>
