...
impl super::Client {
    ...
    ///   - [`phone_number(impl ::std::convert::Into<String>)`](crate::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder::phone_number) / [`set_phone_number(Option<String>)`](crate::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder::set_phone_number): <p>The destination phone number to verify.</p>
    ///   - [`one_time_password(impl ::std::convert::Into<String>)`](crate::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder::one_time_password) / [`set_one_time_password(Option<String>)`](crate::operation::verify_sms_sandbox_phone_number::builders::VerifySMSSandboxPhoneNumberFluentBuilder::set_one_time_password): <p>The OTP sent to the destination number from the <code>CreateSMSSandBoxPhoneNumber</code> call.</p>
