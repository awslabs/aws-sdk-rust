...
impl super::Client {
    /// Constructs a fluent builder for the [`GetPlatformApplicationAttributes`](crate::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`platform_application_arn(impl Into<String>)`](crate::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesFluentBuilder::platform_application_arn) / [`set_platform_application_arn(Option<String>)`](crate::operation::get_platform_application_attributes::builders::GetPlatformApplicationAttributesFluentBuilder::set_platform_application_arn):<br>required: **true**<br><p>PlatformApplicationArn for GetPlatformApplicationAttributesInput.</p><br>
