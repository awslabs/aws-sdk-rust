...
impl super::Client {
    ...
    ///   - [`topic_arn(impl ::std::convert::Into<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::topic_arn) / [`set_topic_arn(Option<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::set_topic_arn): <p>The ARN of the topic whose access control policy you wish to modify.</p>
    ///   - [`label(impl ::std::convert::Into<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::label) / [`set_label(Option<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::set_label): <p>A unique identifier for the new policy statement.</p>
