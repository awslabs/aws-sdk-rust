...
pub(crate) fn reflens_list_endpoints_by_platform_application_output_next_token(
...
pub(crate) fn reflens_list_origination_numbers_output_next_token(
...
pub(crate) fn reflens_list_phone_numbers_opted_out_output_next_token(
...
pub(crate) fn reflens_list_platform_applications_output_next_token(
...
pub(crate) fn reflens_list_sms_sandbox_phone_numbers_output_next_token(
...
pub(crate) fn reflens_list_subscriptions_by_topic_output_next_token(
...
pub(crate) fn lens_list_endpoints_by_platform_application_output_endpoints(
    input: crate::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplicationOutput,
...
pub(crate) fn lens_list_origination_numbers_output_phone_numbers(
    input: crate::operation::list_origination_numbers::ListOriginationNumbersOutput,
...
pub(crate) fn lens_list_phone_numbers_opted_out_output_phone_numbers(
    input: crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput,
...
pub(crate) fn lens_list_platform_applications_output_platform_applications(
    input: crate::operation::list_platform_applications::ListPlatformApplicationsOutput,
...
pub(crate) fn lens_list_subscriptions_output_subscriptions(
    input: crate::operation::list_subscriptions::ListSubscriptionsOutput,
...
pub(crate) fn lens_list_subscriptions_by_topic_output_subscriptions(
    input: crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::Subscription>> {
    let input = match input.subscriptions {
        ::std::option::Option::None => return ::std::option::Option::None,
...
pub(crate) fn lens_list_topics_output_topics(
    input: crate::operation::list_topics::ListTopicsOutput,
