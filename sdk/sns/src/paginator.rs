...
/// Paginator for [`ListEndpointsByPlatformApplication`](crate::operation::ListEndpointsByPlatformApplication)
            ...
            impl ListEndpointsByPlatformApplicationPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_endpoints_by_platform_application_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListEndpointsByPlatformApplicationOutput, aws_smithy_http::result::SdkError<crate::error::ListEndpointsByPlatformApplicationError>>> + Unpin
                 {
...
/// Paginator for [`ListOriginationNumbers`](crate::operation::ListOriginationNumbers)
            ...
            impl ListOriginationNumbersPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_origination_numbers_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListOriginationNumbersOutput, aws_smithy_http::result::SdkError<crate::error::ListOriginationNumbersError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListPhoneNumbersOptedOut`](crate::operation::ListPhoneNumbersOptedOut)
            ...
            impl ListPhoneNumbersOptedOutPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_phone_numbers_opted_out_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListPhoneNumbersOptedOutOutput, aws_smithy_http::result::SdkError<crate::error::ListPhoneNumbersOptedOutError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListPlatformApplications`](crate::operation::ListPlatformApplications)
            ...
            impl ListPlatformApplicationsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_platform_applications_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListPlatformApplicationsOutput, aws_smithy_http::result::SdkError<crate::error::ListPlatformApplicationsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListSMSSandboxPhoneNumbers`](crate::operation::ListSMSSandboxPhoneNumbers)
            ...
            impl ListSmsSandboxPhoneNumbersPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_sms_sandbox_phone_numbers_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListSmsSandboxPhoneNumbersOutput, aws_smithy_http::result::SdkError<crate::error::ListSMSSandboxPhoneNumbersError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListSubscriptions`](crate::operation::ListSubscriptions)
            ...
            impl ListSubscriptionsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_subscriptions_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListSubscriptionsOutput, aws_smithy_http::result::SdkError<crate::error::ListSubscriptionsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListSubscriptionsByTopic`](crate::operation::ListSubscriptionsByTopic)
            ...
            impl ListSubscriptionsByTopicPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_subscriptions_by_topic_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListSubscriptionsByTopicOutput, aws_smithy_http::result::SdkError<crate::error::ListSubscriptionsByTopicError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListTopics`](crate::operation::ListTopics)
            ...
            impl ListTopicsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_topics_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListTopicsOutput, aws_smithy_http::result::SdkError<crate::error::ListTopicsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListEndpointsByPlatformApplicationPaginator`
                ...
                impl  ListEndpointsByPlatformApplicationPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Endpoint, aws_smithy_http::result::SdkError<crate::error::ListEndpointsByPlatformApplicationError>>> + Unpin
                     {
...
/// Flattened paginator for `ListOriginationNumbersPaginator`
                ...
                impl  ListOriginationNumbersPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::PhoneNumberInformation, aws_smithy_http::result::SdkError<crate::error::ListOriginationNumbersError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_origination_numbers_output_phone_numbers(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListPhoneNumbersOptedOutPaginator`
                ...
                impl  ListPhoneNumbersOptedOutPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<std::string::String, aws_smithy_http::result::SdkError<crate::error::ListPhoneNumbersOptedOutError>>> + Unpin
                     {
...
/// Flattened paginator for `ListPlatformApplicationsPaginator`
                ...
                impl  ListPlatformApplicationsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::PlatformApplication, aws_smithy_http::result::SdkError<crate::error::ListPlatformApplicationsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListSmsSandboxPhoneNumbersPaginator`
                ...
                impl  ListSmsSandboxPhoneNumbersPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::SmsSandboxPhoneNumber, aws_smithy_http::result::SdkError<crate::error::ListSMSSandboxPhoneNumbersError>>> + Unpin
                     {
...
/// Flattened paginator for `ListSubscriptionsPaginator`
                ...
                impl  ListSubscriptionsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Subscription, aws_smithy_http::result::SdkError<crate::error::ListSubscriptionsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_subscriptions_output_subscriptions(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListSubscriptionsByTopicPaginator`
                ...
                impl  ListSubscriptionsByTopicPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Subscription, aws_smithy_http::result::SdkError<crate::error::ListSubscriptionsByTopicError>>> + Unpin
                     {
...
/// Flattened paginator for `ListTopicsPaginator`
                ...
                impl  ListTopicsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Topic, aws_smithy_http::result::SdkError<crate::error::ListTopicsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_topics_output_topics(page).unwrap_or_default().into_iter())
                    }
                }
