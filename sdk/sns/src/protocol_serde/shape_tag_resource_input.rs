...
pub fn ser_tag_resource_input_input_input(input: &crate::operation::tag_resource::TagResourceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
