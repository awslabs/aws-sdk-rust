...
pub fn de_list_subscriptions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSubscriptionsOutput, crate::error::ListSubscriptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListSubscriptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_subscriptions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSubscriptionsOutput, crate::error::ListSubscriptionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_subscriptions_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_subscriptions::de_list_subscriptions(response.body().as_ref(), output).map_err(crate::error::ListSubscriptionsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_subscriptions(inp: &[u8], mut builder: crate::output::list_subscriptions_output::Builder) -> Result<crate::output::list_subscriptions_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
