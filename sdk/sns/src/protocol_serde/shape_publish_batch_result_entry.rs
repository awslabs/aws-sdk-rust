...
pub fn de_publish_batch_result_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PublishBatchResultEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
