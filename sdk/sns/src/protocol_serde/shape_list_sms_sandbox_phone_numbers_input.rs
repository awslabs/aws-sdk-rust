...
pub fn ser_list_sms_sandbox_phone_numbers_input_input(input: &crate::input::ListSmsSandboxPhoneNumbersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
