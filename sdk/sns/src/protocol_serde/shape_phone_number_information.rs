...
pub fn de_phone_number_information(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PhoneNumberInformation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
