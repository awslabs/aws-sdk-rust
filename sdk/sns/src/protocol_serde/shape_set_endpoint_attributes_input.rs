...
pub fn ser_set_endpoint_attributes_input_input_input(input: &crate::operation::set_endpoint_attributes::SetEndpointAttributesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
