...
pub fn ser_set_endpoint_attributes_input_input(input: &crate::input::SetEndpointAttributesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
