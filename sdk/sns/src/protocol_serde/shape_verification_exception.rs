...
#[allow(unused_mut)]
pub fn de_verification_exception_xml_err(inp: &[u8], mut builder: crate::error::verification_exception::Builder) -> Result<crate::error::verification_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
