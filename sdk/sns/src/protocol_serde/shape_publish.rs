...
pub fn de_publish_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishOutput, crate::error::PublishError> {
    ...
    Err(match error_code {
        ...
        "PlatformApplicationDisabled" => crate::error::PublishError::PlatformApplicationDisabledException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub fn de_publish_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishOutput, crate::error::PublishError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_publish::de_publish(response.body().as_ref(), output).map_err(crate::error::PublishError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_publish(inp: &[u8], mut builder: crate::output::publish_output::Builder) -> Result<crate::output::publish_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
