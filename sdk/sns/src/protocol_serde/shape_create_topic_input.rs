...
pub fn ser_create_topic_input_input_input(input: &crate::operation::create_topic::CreateTopicInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
