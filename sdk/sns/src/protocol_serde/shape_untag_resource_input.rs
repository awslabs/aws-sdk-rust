...
pub fn ser_untag_resource_input_input(input: &crate::input::UntagResourceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
