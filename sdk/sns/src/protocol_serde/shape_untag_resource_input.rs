...
pub fn ser_untag_resource_input_input_input(input: &crate::operation::untag_resource::UntagResourceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
