...
pub fn de_delete_topic_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_topic::DeleteTopicOutput, crate::operation::delete_topic::DeleteTopicError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_topic_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_topic::DeleteTopicOutput, crate::operation::delete_topic::DeleteTopicError> {
    Ok({
        #[allow(unused_mut)]
