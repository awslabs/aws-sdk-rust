...
pub fn de_delete_topic_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteTopicOutput, crate::error::DeleteTopicError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteTopicError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_topic_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteTopicOutput, crate::error::DeleteTopicError> {
    Ok({
        #[allow(unused_mut)]
