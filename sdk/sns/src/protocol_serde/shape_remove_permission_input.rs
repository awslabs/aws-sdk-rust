...
pub fn ser_remove_permission_input_input_input(input: &crate::operation::remove_permission::RemovePermissionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
