...
pub fn ser_unsubscribe_input_input(input: &crate::input::UnsubscribeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
