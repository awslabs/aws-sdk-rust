...
pub fn ser_create_sms_sandbox_phone_number_input_input(input: &crate::input::CreateSmsSandboxPhoneNumberInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
