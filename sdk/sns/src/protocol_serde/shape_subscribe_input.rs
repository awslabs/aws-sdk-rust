...
pub fn ser_subscribe_input_input_input(input: &crate::operation::subscribe::SubscribeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
