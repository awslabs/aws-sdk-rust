...
pub fn ser_subscribe_input_input(input: &crate::input::SubscribeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
