...
pub fn ser_get_sms_attributes_input_input_input(input: &crate::operation::get_sms_attributes::GetSmsAttributesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
