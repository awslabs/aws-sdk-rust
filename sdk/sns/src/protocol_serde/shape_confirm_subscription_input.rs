...
pub fn ser_confirm_subscription_input_input_input(input: &crate::operation::confirm_subscription::ConfirmSubscriptionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
