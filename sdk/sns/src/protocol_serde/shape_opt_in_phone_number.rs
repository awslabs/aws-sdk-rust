...
#[allow(clippy::unnecessary_wraps)]
pub fn de_opt_in_phone_number_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::opt_in_phone_number::OptInPhoneNumberOutput, crate::operation::opt_in_phone_number::OptInPhoneNumberError> {
    Ok({
        #[allow(unused_mut)]
