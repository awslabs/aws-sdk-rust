...
pub fn de_number_capability_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::NumberCapability>, aws_smithy_xml::decode::XmlDecodeError> {
