...
pub fn ser_put_data_protection_policy_input_input(input: &crate::input::PutDataProtectionPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
