...
pub fn ser_set_platform_application_attributes_input_input(input: &crate::input::SetPlatformApplicationAttributesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
