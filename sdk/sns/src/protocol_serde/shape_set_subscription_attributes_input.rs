...
pub fn ser_set_subscription_attributes_input_input_input(input: &crate::operation::set_subscription_attributes::SetSubscriptionAttributesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
