...
pub fn de_batch_result_error_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BatchResultErrorEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
