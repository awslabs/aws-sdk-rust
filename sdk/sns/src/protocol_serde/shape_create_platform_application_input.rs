...
pub fn ser_create_platform_application_input_input_input(input: &crate::operation::create_platform_application::CreatePlatformApplicationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
