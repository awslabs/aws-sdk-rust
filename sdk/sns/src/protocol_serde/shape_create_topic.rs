...
pub fn de_create_topic_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateTopicOutput, crate::error::CreateTopicError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateTopicError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_topic_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateTopicOutput, crate::error::CreateTopicError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_topic_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_topic::de_create_topic(response.body().as_ref(), output).map_err(crate::error::CreateTopicError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_topic(inp: &[u8], mut builder: crate::output::create_topic_output::Builder) -> Result<crate::output::create_topic_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
