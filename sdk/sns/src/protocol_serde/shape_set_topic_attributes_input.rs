...
pub fn ser_set_topic_attributes_input_input_input(input: &crate::operation::set_topic_attributes::SetTopicAttributesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
