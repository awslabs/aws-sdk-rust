...
pub fn ser_publish_batch_input_input_input(input: &crate::operation::publish_batch::PublishBatchInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
