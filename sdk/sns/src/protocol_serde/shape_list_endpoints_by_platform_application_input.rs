...
pub fn ser_list_endpoints_by_platform_application_input_input(input: &crate::input::ListEndpointsByPlatformApplicationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
