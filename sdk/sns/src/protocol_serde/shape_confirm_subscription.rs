...
pub fn de_confirm_subscription_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::confirm_subscription::ConfirmSubscriptionOutput, crate::operation::confirm_subscription::ConfirmSubscriptionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::confirm_subscription::ConfirmSubscriptionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_replay_limit_exceeded_exception::de_replay_limit_exceeded_exception_xml_err(_response_body, output).map_err(crate::operation::confirm_subscription::ConfirmSubscriptionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_confirm_subscription_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::confirm_subscription::ConfirmSubscriptionOutput, crate::operation::confirm_subscription::ConfirmSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::confirm_subscription::builders::ConfirmSubscriptionOutputBuilder::default();
        output = crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription(_response_body, output).map_err(crate::operation::confirm_subscription::ConfirmSubscriptionError::unhandled)?;
