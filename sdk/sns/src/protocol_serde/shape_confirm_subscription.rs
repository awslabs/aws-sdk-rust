...
pub fn de_confirm_subscription_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::confirm_subscription::ConfirmSubscriptionOutput, crate::operation::confirm_subscription::ConfirmSubscriptionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_confirm_subscription_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::confirm_subscription::ConfirmSubscriptionOutput, crate::operation::confirm_subscription::ConfirmSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
