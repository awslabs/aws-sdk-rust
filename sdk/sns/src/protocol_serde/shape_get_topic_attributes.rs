...
pub fn de_get_topic_attributes_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_topic_attributes::GetTopicAttributesOutput, crate::operation::get_topic_attributes::GetTopicAttributesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_topic_attributes_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_topic_attributes::GetTopicAttributesOutput, crate::operation::get_topic_attributes::GetTopicAttributesError> {
    Ok({
        #[allow(unused_mut)]
