...
pub fn ser_add_permission_input_input_input(input: &crate::operation::add_permission::AddPermissionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
