...
pub fn de_get_endpoint_attributes_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_endpoint_attributes::GetEndpointAttributesOutput, crate::operation::get_endpoint_attributes::GetEndpointAttributesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_endpoint_attributes::GetEndpointAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_endpoint_attributes_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_endpoint_attributes::GetEndpointAttributesOutput, crate::operation::get_endpoint_attributes::GetEndpointAttributesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_endpoint_attributes::builders::GetEndpointAttributesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_endpoint_attributes::de_get_endpoint_attributes(response.body().as_ref(), output).map_err(crate::operation::get_endpoint_attributes::GetEndpointAttributesError::unhandled)?;
