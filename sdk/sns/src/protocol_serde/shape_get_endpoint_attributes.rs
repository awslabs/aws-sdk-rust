...
pub fn de_get_endpoint_attributes_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEndpointAttributesOutput, crate::error::GetEndpointAttributesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetEndpointAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_endpoint_attributes_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEndpointAttributesOutput, crate::error::GetEndpointAttributesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_endpoint_attributes_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_endpoint_attributes::de_get_endpoint_attributes(response.body().as_ref(), output).map_err(crate::error::GetEndpointAttributesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_endpoint_attributes(inp: &[u8], mut builder: crate::output::get_endpoint_attributes_output::Builder) -> Result<crate::output::get_endpoint_attributes_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
