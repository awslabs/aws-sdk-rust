...
pub fn ser_create_platform_endpoint_input_input_input(input: &crate::operation::create_platform_endpoint::CreatePlatformEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
