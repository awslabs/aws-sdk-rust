...
pub fn ser_list_origination_numbers_input_input(input: &crate::operation::list_origination_numbers::ListOriginationNumbersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
