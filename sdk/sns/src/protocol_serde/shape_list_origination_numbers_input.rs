...
pub fn ser_list_origination_numbers_input_input_input(input: &crate::operation::list_origination_numbers::ListOriginationNumbersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
