...
impl SetSmsAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_sms_attributes::SetSMSAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSMSAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_sms_attributes::de_set_sms_attributes_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_sms_attributes::SetSMSAttributesError
{
