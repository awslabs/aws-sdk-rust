    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_sms_attributes::SetSMSAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_sms_attributes::SetSmsAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for SetSMSAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_sms_attributes::SetSmsAttributesInput>()
            .expect("correct type");
