...
impl SetSubscriptionAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_subscription_attributes::SetSubscriptionAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_subscription_attributes::SetSubscriptionAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_subscription_attributes::SetSubscriptionAttributesOutput, crate::operation::set_subscription_attributes::SetSubscriptionAttributesError, Self> {
