...
impl SetSubscriptionAttributesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_subscription_attributes::SetSubscriptionAttributes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSubscriptionAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_subscription_attributes::de_set_subscription_attributes_http_response_with_props(status, headers, body)
        }
    }
}
