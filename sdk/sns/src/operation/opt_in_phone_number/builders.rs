...
impl OptInPhoneNumberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::opt_in_phone_number::OptInPhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::opt_in_phone_number::OptInPhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::opt_in_phone_number::OptInPhoneNumberOutput, crate::operation::opt_in_phone_number::OptInPhoneNumberError, Self> {
