...
impl DeletePlatformApplicationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_platform_application::DeletePlatformApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_platform_application::DeletePlatformApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_platform_application::DeletePlatformApplicationOutput, crate::operation::delete_platform_application::DeletePlatformApplicationError, Self> {
