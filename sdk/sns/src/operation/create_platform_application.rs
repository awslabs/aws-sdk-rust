...
impl CreatePlatformApplicationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_platform_application::CreatePlatformApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePlatformApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_platform_application::de_create_platform_application_http_response_with_props(status, headers, body)
        }
    }
}
