...
impl CreatePlatformApplicationInput {
    /// Consumes the builder and constructs an Operation<[`CreatePlatformApplication`](crate::operation::create_platform_application::CreatePlatformApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_platform_application::CreatePlatformApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_platform_application::CreatePlatformApplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_platform_application_input::ser_create_platform_application_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_platform_application::CreatePlatformApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePlatformApplication", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreatePlatformApplication`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePlatformApplication {
                type Output = std::result::Result<crate::operation::create_platform_application::CreatePlatformApplicationOutput, crate::operation::create_platform_application::CreatePlatformApplicationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_platform_application::de_create_platform_application_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_platform_application::de_create_platform_application_http_response(response)
                     }
                }
            }
