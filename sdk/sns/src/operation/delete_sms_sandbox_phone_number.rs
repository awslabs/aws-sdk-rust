...
impl DeleteSmsSandboxPhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSMSSandboxPhoneNumber`](crate::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_sms_sandbox_phone_number_input::ser_delete_sms_sandbox_phone_number_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumber::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteSMSSandboxPhoneNumber", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteSMSSandboxPhoneNumber`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSMSSandboxPhoneNumber {
                type Output = std::result::Result<crate::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberOutput, crate::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumberError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_sms_sandbox_phone_number::de_delete_sms_sandbox_phone_number_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_sms_sandbox_phone_number::de_delete_sms_sandbox_phone_number_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::delete_sms_sandbox_phone_number::DeleteSMSSandboxPhoneNumberError {
