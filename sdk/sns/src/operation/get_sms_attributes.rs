...
impl GetSmsAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetSMSAttributes`](crate::operation::get_sms_attributes::GetSMSAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sms_attributes::GetSMSAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sms_attributes::GetSmsAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_sms_attributes_input::ser_get_sms_attributes_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sms_attributes::GetSMSAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSMSAttributes", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetSMSAttributes`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetSMSAttributes {
                type Output = std::result::Result<crate::operation::get_sms_attributes::GetSmsAttributesOutput, crate::operation::get_sms_attributes::GetSMSAttributesError>;
