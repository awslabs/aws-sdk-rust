...
impl VerifySmsSandboxPhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`VerifySMSSandboxPhoneNumber`](crate::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_verify_sms_sandbox_phone_number_input::ser_verify_sms_sandbox_phone_number_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumber::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifySMSSandboxPhoneNumber", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `VerifySMSSandboxPhoneNumber`.
...
impl aws_smithy_http::response::ParseStrictResponse for VerifySMSSandboxPhoneNumber {
                type Output = std::result::Result<crate::operation::verify_sms_sandbox_phone_number::VerifySmsSandboxPhoneNumberOutput, crate::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumberError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_verify_sms_sandbox_phone_number::de_verify_sms_sandbox_phone_number_http_error(response)
                     } else {
                        crate::protocol_serde::shape_verify_sms_sandbox_phone_number::de_verify_sms_sandbox_phone_number_http_response(response)
                     }
                }
            }
