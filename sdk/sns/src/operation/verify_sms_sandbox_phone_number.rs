...
impl VerifySmsSandboxPhoneNumberInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::verify_sms_sandbox_phone_number::VerifySMSSandboxPhoneNumber::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifySMSSandboxPhoneNumber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_verify_sms_sandbox_phone_number::de_verify_sms_sandbox_phone_number_http_response_with_props(
                status, headers, body,
            )
        }
    }
