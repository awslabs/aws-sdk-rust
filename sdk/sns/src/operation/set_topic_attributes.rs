...
impl SetTopicAttributesInput {
    /// Consumes the builder and constructs an Operation<[`SetTopicAttributes`](crate::operation::set_topic_attributes::SetTopicAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_topic_attributes::SetTopicAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_topic_attributes::SetTopicAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_topic_attributes_input::ser_set_topic_attributes_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_topic_attributes::SetTopicAttributes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetTopicAttributes {
                type Output = std::result::Result<crate::operation::set_topic_attributes::SetTopicAttributesOutput, crate::operation::set_topic_attributes::SetTopicAttributesError>;
