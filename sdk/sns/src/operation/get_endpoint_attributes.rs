...
impl GetEndpointAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetEndpointAttributes`](crate::operation::get_endpoint_attributes::GetEndpointAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_endpoint_attributes::GetEndpointAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_endpoint_attributes::GetEndpointAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_endpoint_attributes_input::ser_get_endpoint_attributes_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_endpoint_attributes::GetEndpointAttributes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetEndpointAttributes {
                type Output = std::result::Result<crate::operation::get_endpoint_attributes::GetEndpointAttributesOutput, crate::operation::get_endpoint_attributes::GetEndpointAttributesError>;
