...
impl GetEndpointAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_endpoint_attributes::GetEndpointAttributes,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEndpointAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_endpoint_attributes::de_get_endpoint_attributes_http_response_with_props(status, headers, body)
        }
    }
}
