...
impl ListPhoneNumbersOptedOutInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPhoneNumbersOptedOut {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_phone_numbers_opted_out::de_list_phone_numbers_opted_out_http_response_with_props(status, headers, body)
        }
    }
}
