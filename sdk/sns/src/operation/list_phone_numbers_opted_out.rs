...
impl ListPhoneNumbersOptedOutInput {
    /// Consumes the builder and constructs an Operation<[`ListPhoneNumbersOptedOut`](crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_phone_numbers_opted_out_input::ser_list_phone_numbers_opted_out_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOut::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListPhoneNumbersOptedOut {
                type Output = std::result::Result<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput, crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_phone_numbers_opted_out::de_list_phone_numbers_opted_out_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_phone_numbers_opted_out::de_list_phone_numbers_opted_out_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError {
