...
impl ListEndpointsByPlatformApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_endpoints_by_platform_application::ListEndpointsByPlatformApplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEndpointsByPlatformApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_endpoints_by_platform_application::de_list_endpoints_by_platform_application_http_response_with_props(
                status, headers, body,
            )
        }
    }
