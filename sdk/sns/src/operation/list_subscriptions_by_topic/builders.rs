...
impl ListSubscriptionsByTopicFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicOutput, crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicError, Self> {
