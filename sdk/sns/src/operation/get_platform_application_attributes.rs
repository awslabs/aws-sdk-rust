...
impl GetPlatformApplicationAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_platform_application_attributes::GetPlatformApplicationAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPlatformApplicationAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_platform_application_attributes::de_get_platform_application_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
