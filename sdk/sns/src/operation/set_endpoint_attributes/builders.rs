...
impl SetEndpointAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_endpoint_attributes::SetEndpointAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_endpoint_attributes::SetEndpointAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_endpoint_attributes::SetEndpointAttributesOutput, crate::operation::set_endpoint_attributes::SetEndpointAttributesError, Self> {
