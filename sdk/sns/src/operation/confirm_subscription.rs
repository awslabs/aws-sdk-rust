...
impl ConfirmSubscription {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::confirm_subscription::ConfirmSubscriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::confirm_subscription::ConfirmSubscriptionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "ConfirmSubscription", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SNS.ConfirmSubscription",
                "rpc.service" = "SNS",
                "rpc.method" = "ConfirmSubscription",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ConfirmSubscription {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ConfirmSubscriptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ConfirmSubscriptionResponseDeserializer,
        ));
...
#[derive(Debug)]
struct ConfirmSubscriptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ConfirmSubscriptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ConfirmSubscriptionInput>() else {
        ...
        if requested.should_capture("AuthenticateOnUnsubscribe") {
            if let ::std::option::Option::Some(value) = input.authenticate_on_unsubscribe.as_deref() {
                captured.insert("AuthenticateOnUnsubscribe", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmSubscriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmSubscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::confirm_subscription::ConfirmSubscriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::confirm_subscription::ConfirmSubscriptionInput,
