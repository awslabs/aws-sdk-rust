...
impl ConfirmSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmSubscription`](crate::operation::confirm_subscription::ConfirmSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::confirm_subscription::ConfirmSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_subscription::ConfirmSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_subscription_input::ser_confirm_subscription_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_subscription::ConfirmSubscription::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ConfirmSubscription", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ConfirmSubscription`.
...
impl aws_smithy_http::response::ParseStrictResponse for ConfirmSubscription {
                type Output = std::result::Result<crate::operation::confirm_subscription::ConfirmSubscriptionOutput, crate::operation::confirm_subscription::ConfirmSubscriptionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription_http_error(response)
                     } else {
                        crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription_http_response(response)
                     }
                }
            }
