...
impl ConfirmSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::confirm_subscription::ConfirmSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_confirm_subscription::de_confirm_subscription_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::confirm_subscription::ConfirmSubscriptionError
{
