...
impl ListSmsSandboxPhoneNumbersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sms_sandbox_phone_numbers::ListSmsSandboxPhoneNumbersInput, ::aws_smithy_types::error::operation::BuildError> {
