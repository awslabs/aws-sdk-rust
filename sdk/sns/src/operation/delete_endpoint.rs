...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_endpoint::DeleteEndpointError>::new());
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_endpoint_input::ser_delete_endpoint_input_input_input(&input)?);
