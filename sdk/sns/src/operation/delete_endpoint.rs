...
impl DeleteEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_endpoint_input::ser_delete_endpoint_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_endpoint::DeleteEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_endpoint::de_delete_endpoint_http_error(
                status, headers, body,
            )
        } else {
