...
impl RemovePermissionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_remove_permission_input::ser_remove_permission_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_permission::RemovePermission::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_permission::RemovePermissionError
{
