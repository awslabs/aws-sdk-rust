...
impl ListTopicsInput {
    /// Consumes the builder and constructs an Operation<[`ListTopics`](crate::operation::list_topics::ListTopics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_topics::ListTopics, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_topics::ListTopicsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_topics_input::ser_list_topics_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_topics::ListTopics::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTopics", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListTopics`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListTopics {
                type Output = std::result::Result<crate::operation::list_topics::ListTopicsOutput, crate::operation::list_topics::ListTopicsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_topics::de_list_topics_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_topics::de_list_topics_http_response(response)
                     }
                }
            }
