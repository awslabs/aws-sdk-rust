...
impl SetPlatformApplicationAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_platform_application_attributes::SetPlatformApplicationAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetPlatformApplicationAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_platform_application_attributes::de_set_platform_application_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
