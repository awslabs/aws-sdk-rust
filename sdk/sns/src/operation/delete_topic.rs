...
impl DeleteTopicInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_topic::DeleteTopic, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_topic_input::ser_delete_topic_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTopic {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_topic::de_delete_topic_http_response_with_props(status, headers, body)
        }
    }
}
