...
impl GetSMSSandboxAccountStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput, crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError, Self> {
