    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SNS", "CreateSMSSandboxPhoneNumber", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "SNS",
                "rpc.method" = "CreateSMSSandboxPhoneNumber",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateSMSSandboxPhoneNumber")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSMSSandboxPhoneNumberResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_sms_sandbox_phone_number::de_create_sms_sandbox_phone_number_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_sms_sandbox_phone_number::de_create_sms_sandbox_phone_number_http_response(
