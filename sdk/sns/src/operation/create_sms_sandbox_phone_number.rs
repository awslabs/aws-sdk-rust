...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSMSSandboxPhoneNumber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_sms_sandbox_phone_number::de_create_sms_sandbox_phone_number_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateSMSSandboxPhoneNumberError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_sms_sandbox_phone_number::CreateSMSSandboxPhoneNumberError
{
