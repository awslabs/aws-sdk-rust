...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for SubscribeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for SubscribeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_subscribe_input::ser_subscribe_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SubscribeEndpointParamsInterceptor {
