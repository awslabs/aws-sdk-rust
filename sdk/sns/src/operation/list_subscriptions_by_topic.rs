...
impl ListSubscriptionsByTopicInput {
    /// Consumes the builder and constructs an Operation<[`ListSubscriptionsByTopic`](crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopic, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopicInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_subscriptions_by_topic_input::ser_list_subscriptions_by_topic_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopic::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSubscriptionsByTopic", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListSubscriptionsByTopic`.
