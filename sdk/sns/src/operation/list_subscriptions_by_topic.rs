...
impl ListSubscriptionsByTopicInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_subscriptions_by_topic::ListSubscriptionsByTopic::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscriptionsByTopic {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_subscriptions_by_topic::de_list_subscriptions_by_topic_http_response_with_props(status, headers, body)
        }
    }
}
