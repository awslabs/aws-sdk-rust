...
impl DeletePlatformApplicationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_platform_application::DeletePlatformApplication,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_platform_application::DeletePlatformApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePlatformApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_platform_application::de_delete_platform_application_http_response_with_props(status, headers, body)
        }
    }
}
