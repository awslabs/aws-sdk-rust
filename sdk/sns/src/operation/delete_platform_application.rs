...
impl DeletePlatformApplicationInput {
    /// Consumes the builder and constructs an Operation<[`DeletePlatformApplication`](crate::operation::delete_platform_application::DeletePlatformApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_platform_application::DeletePlatformApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_platform_application::DeletePlatformApplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_platform_application_input::ser_delete_platform_application_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_platform_application::DeletePlatformApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePlatformApplication", "sns"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeletePlatformApplication`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePlatformApplication {
                type Output = std::result::Result<crate::operation::delete_platform_application::DeletePlatformApplicationOutput, crate::operation::delete_platform_application::DeletePlatformApplicationError>;
