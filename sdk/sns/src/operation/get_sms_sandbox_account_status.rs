...
impl GetSmsSandboxAccountStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetSMSSandboxAccountStatus`](crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_sms_sandbox_account_status_input::ser_get_sms_sandbox_account_status_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatus::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetSMSSandboxAccountStatus {
                type Output = std::result::Result<crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput, crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_sms_sandbox_account_status::de_get_sms_sandbox_account_status_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_sms_sandbox_account_status::de_get_sms_sandbox_account_status_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError {
