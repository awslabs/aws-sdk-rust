...
impl DeleteRouteCalculatorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_route_calculator::DeleteRouteCalculatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_route_calculator::DeleteRouteCalculatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_route_calculator::DeleteRouteCalculatorOutput, crate::operation::delete_route_calculator::DeleteRouteCalculatorError, Self> {
