...
impl SearchPlaceIndexForSuggestionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_place_index_for_suggestions::SearchPlaceIndexForSuggestions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchPlaceIndexForSuggestions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_place_index_for_suggestions::de_search_place_index_for_suggestions_http_response_with_props(
                status, headers, body,
            )
        }
    }
