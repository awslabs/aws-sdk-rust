...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMapStyleDescriptor {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetMapStyleDescriptor", "location"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetMapStyleDescriptorResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetMapStyleDescriptorRequestSerializer {
