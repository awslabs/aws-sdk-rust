...
impl crate::operation::describe_geofence_collection::builders::DescribeGeofenceCollectionInputBuilder {
...
impl DescribeGeofenceCollectionFluentBuilder {
    /// Creates a new `DescribeGeofenceCollectionFluentBuilder`.
