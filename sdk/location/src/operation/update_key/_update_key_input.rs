...
impl ::std::fmt::Debug for UpdateKeyInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateKeyInput");
...
impl ::std::fmt::Debug for UpdateKeyInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateKeyInputBuilder");
        formatter.field("key_name", &self.key_name);
        formatter.field("description", &self.description);
        formatter.field("expire_time", &"*** Sensitive Data Redacted ***");
        formatter.field("no_expiry", &self.no_expiry);
