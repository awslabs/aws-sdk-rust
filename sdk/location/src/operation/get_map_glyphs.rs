...
impl GetMapGlyphsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_map_glyphs::GetMapGlyphs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMapGlyphs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_map_glyphs::de_get_map_glyphs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_map_glyphs::de_get_map_glyphs_http_response_with_props(
                status, headers, body,
            )
        }
    }
