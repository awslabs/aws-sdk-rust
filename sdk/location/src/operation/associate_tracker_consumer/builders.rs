...
impl AssociateTrackerConsumerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_tracker_consumer::AssociateTrackerConsumerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_tracker_consumer::AssociateTrackerConsumerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_tracker_consumer::AssociateTrackerConsumerOutput, crate::operation::associate_tracker_consumer::AssociateTrackerConsumerError, Self> {
