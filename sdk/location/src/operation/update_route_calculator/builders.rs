...
impl crate::operation::update_route_calculator::builders::UpdateRouteCalculatorInputBuilder {
...
/// <ul>
/// <li>
/// <p><code>UpdateRouteCalculator</code> is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl UpdateRouteCalculatorFluentBuilder {
    /// Creates a new `UpdateRouteCalculatorFluentBuilder`.
