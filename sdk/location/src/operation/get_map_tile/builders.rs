...
///
/// <important>
/// <p>This operation is no longer current and may be deprecated in the future. We recommend upgrading to <a href="https://docs.aws.amazon.com/location/latest/APIReference/API_geomaps_GetTile.html"> <code>GetTile</code> </a> unless you require <code>Grab</code> data.</p>
/// <ul>
/// <li>
/// <p><code>GetMapTile</code> is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
/// <p>The version 2 <code>GetTile</code> operation gives a better user experience and is compatible with the remainder of the V2 Maps API.</p></li>
/// <li>
...
impl GetMapTileFluentBuilder {
    /// Creates a new `GetMapTileFluentBuilder`.
