...
impl CalculateRouteMatrixInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::calculate_route_matrix::CalculateRouteMatrix,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CalculateRouteMatrix {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_calculate_route_matrix::de_calculate_route_matrix_http_response_with_props(status, headers, body)
        }
    }
