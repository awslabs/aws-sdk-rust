...
impl DescribeTrackerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_tracker::DescribeTracker,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_tracker::DescribeTracker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_tracker::de_describe_tracker_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_tracker::DescribeTrackerError
{
