...
impl GetMapStyleDescriptorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_map_style_descriptor::GetMapStyleDescriptorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_map_style_descriptor::GetMapStyleDescriptorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_map_style_descriptor::GetMapStyleDescriptorOutput, crate::operation::get_map_style_descriptor::GetMapStyleDescriptorError, Self> {
