...
impl ListKeysInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_keys::ListKeys, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_keys::ser_list_keys_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_keys::ListKeys::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListKeys", "location"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_keys::de_list_keys_http_response_with_props(status, headers, body)
        }
    }
}
