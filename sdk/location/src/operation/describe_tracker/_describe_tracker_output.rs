...
impl ::std::fmt::Debug for DescribeTrackerOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("event_bridge_enabled", &self.event_bridge_enabled);
        formatter.field("kms_key_enable_geospatial_queries", &self.kms_key_enable_geospatial_queries);
...
impl ::std::fmt::Debug for DescribeTrackerOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeTrackerOutputBuilder");
        formatter.field("tracker_name", &self.tracker_name);
        formatter.field("tracker_arn", &self.tracker_arn);
        formatter.field("description", &self.description);
        formatter.field("pricing_plan", &self.pricing_plan);
