...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchPlaceIndexForPosition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_place_index_for_position::de_search_place_index_for_position_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for SearchPlaceIndexForPositionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_place_index_for_position::SearchPlaceIndexForPositionError
{
