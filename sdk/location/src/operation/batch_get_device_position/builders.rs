...
impl BatchGetDevicePositionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_device_position::BatchGetDevicePositionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_device_position::BatchGetDevicePositionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_device_position::BatchGetDevicePositionOutput, crate::operation::batch_get_device_position::BatchGetDevicePositionError, Self> {
