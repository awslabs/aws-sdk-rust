...
impl ListPlaceIndexesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_place_indexes::ListPlaceIndexes,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_place_indexes::ser_list_place_indexes_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPlaceIndexes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_place_indexes::de_list_place_indexes_http_response_with_props(status, headers, body)
        }
    }
}
