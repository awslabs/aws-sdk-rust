...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateTrackerConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_tracker_consumer::de_disassociate_tracker_consumer_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisassociateTrackerConsumerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_tracker_consumer::DisassociateTrackerConsumerError
{
