...
impl GetDevicePositionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_device_position::GetDevicePositionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_device_position::GetDevicePositionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_device_position::GetDevicePositionOutput, crate::operation::get_device_position::GetDevicePositionError, Self> {
