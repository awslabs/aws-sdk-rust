    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/geofencing/v0/collections")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_geofence_collection::CreateGeofenceCollection::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_geofence_collection::CreateGeofenceCollectionError
{
