...
impl CreateGeofenceCollectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_geofence_collection::CreateGeofenceCollectionInput, ::aws_smithy_types::error::operation::BuildError> {
