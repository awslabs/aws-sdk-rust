...
impl SearchPlaceIndexForTextInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_place_index_for_text::SearchPlaceIndexForTextInput, ::aws_smithy_types::error::operation::BuildError> {
