...
impl DeletePlaceIndexFluentBuilder  {
    /// Creates a new `DeletePlaceIndex`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_place_index::DeletePlaceIndexOutput, aws_smithy_http::result::SdkError<crate::operation::delete_place_index::DeletePlaceIndexError>>
                     {
