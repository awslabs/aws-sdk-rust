...
impl crate::operation::describe_map::builders::DescribeMapInputBuilder {
...
/// <ul>
/// <li>
/// <p><code>DescribeMap</code> is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl DescribeMapFluentBuilder {
    /// Creates a new `DescribeMapFluentBuilder`.
