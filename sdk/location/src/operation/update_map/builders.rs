...
impl crate::operation::update_map::builders::UpdateMapInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::update_map::UpdateMapOutput, crate::operation::update_map::UpdateMapError>
    for UpdateMapFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::update_map::UpdateMapOutput, crate::operation::update_map::UpdateMapError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl UpdateMapFluentBuilder {
    /// Creates a new `UpdateMapFluentBuilder`.
