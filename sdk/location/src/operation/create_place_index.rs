...
impl CreatePlaceIndexInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_place_index::ser_create_place_index_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePlaceIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_place_index::de_create_place_index_http_response_with_props(status, headers, body)
        }
    }
}
