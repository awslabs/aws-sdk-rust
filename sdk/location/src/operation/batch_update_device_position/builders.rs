...
impl BatchUpdateDevicePositionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_update_device_position::BatchUpdateDevicePositionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_update_device_position::BatchUpdateDevicePositionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_update_device_position::BatchUpdateDevicePositionOutput, crate::operation::batch_update_device_position::BatchUpdateDevicePositionError, Self> {
