...
impl crate::operation::create_place_index::builders::CreatePlaceIndexInputBuilder {
...
/// <ul>
/// <li>
/// <p><code>CreatePlaceIndex</code> is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl CreatePlaceIndexFluentBuilder {
    /// Creates a new `CreatePlaceIndexFluentBuilder`.
    ...
    /// <ul>
    /// <li>
    /// <p><code>Esri</code> – For additional information about <a href="https://docs.aws.amazon.com/location/previous/developerguide/esri.html">Esri</a>'s coverage in your region of interest, see <a href="https://developers.arcgis.com/rest/geocode/api-reference/geocode-coverage.htm">Esri details on geocoding coverage</a>.</p></li>
    /// <li>
