...
impl  ListTrackerConsumersOutput  {
    ...
    pub fn consumer_arns(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.consumer_arns.deref()
    }
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.</p>
...
impl ListTrackerConsumersOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_tracker_consumers::ListTrackerConsumersOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_tracker_consumers::ListTrackerConsumersOutput {
                consumer_arns: self.consumer_arns
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("consumer_arns", "consumer_arns was not specified but it is required when building ListTrackerConsumersOutput")
                    )?
                ,
