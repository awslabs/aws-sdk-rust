...
impl CreateTrackerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_tracker::CreateTracker, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_tracker::ser_create_tracker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_tracker::de_create_tracker_http_response_with_props(status, headers, body)
        }
    }
}
