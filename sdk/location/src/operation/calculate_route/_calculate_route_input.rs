...
impl CalculateRouteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::calculate_route::CalculateRouteInput, ::aws_smithy_types::error::operation::BuildError> {
