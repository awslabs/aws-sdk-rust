...
impl ListDevicePositionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_device_positions::ListDevicePositionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_device_positions::ListDevicePositionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_device_positions::ListDevicePositionsOutput, crate::operation::list_device_positions::ListDevicePositionsError, Self> {
