...
/// <ul>
/// <li>
/// <p><code>CreateRouteCalculator</code> is part of a previous Amazon Location Service Routes API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl CreateRouteCalculatorFluentBuilder {
    /// Creates a new `CreateRouteCalculatorFluentBuilder`.
