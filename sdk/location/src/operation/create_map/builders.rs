...
impl crate::operation::create_map::builders::CreateMapInputBuilder {
...
/// <ul>
/// <li>
/// <p><code>CreateMap</code> is part of a previous Amazon Location Service Maps API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl CreateMapFluentBuilder {
    /// Creates a new `CreateMapFluentBuilder`.
