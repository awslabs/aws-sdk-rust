...
impl ListTrackerConsumersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_tracker_consumers::ListTrackerConsumers,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrackerConsumers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tracker_consumers::de_list_tracker_consumers_http_response_with_props(status, headers, body)
        }
    }
}
