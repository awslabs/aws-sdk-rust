...
impl ::std::fmt::Debug for VerifyDevicePositionOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("VerifyDevicePositionOutput");
        formatter.field("inferred_state", &self.inferred_state);
...
impl ::std::fmt::Debug for VerifyDevicePositionOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("VerifyDevicePositionOutputBuilder");
        formatter.field("inferred_state", &self.inferred_state);
        formatter.field("device_id", &self.device_id);
        formatter.field("sample_time", &"*** Sensitive Data Redacted ***");
        formatter.field("received_time", &"*** Sensitive Data Redacted ***");
