...
impl BatchDeleteDevicePositionHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_delete_device_position_history::BatchDeleteDevicePositionHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteDevicePositionHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_device_position_history::de_batch_delete_device_position_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
