...
impl  BatchPutGeofenceOutput  {
    ...
    pub fn successes(&self) -> & [crate::types::BatchPutGeofenceSuccess] {
        use std::ops::Deref; self.successes.deref()
    }
    /// <p>Contains additional error details for each geofence that failed to be stored in a geofence collection.</p>
...
impl BatchPutGeofenceOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_put_geofence::BatchPutGeofenceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::batch_put_geofence::BatchPutGeofenceOutput {
                successes: self.successes
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("successes", "successes was not specified but it is required when building BatchPutGeofenceOutput")
                    )?
                ,
                errors: self.errors
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("errors", "errors was not specified but it is required when building BatchPutGeofenceOutput")
                    )?
                ,
