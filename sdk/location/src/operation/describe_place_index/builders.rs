...
impl crate::operation::describe_place_index::builders::DescribePlaceIndexInputBuilder {
...
/// <ul>
/// <li>
/// <p><code>DescribePlaceIndex</code> is part of a previous Amazon Location Service Places API (version 1) which has been superseded by a more intuitive, powerful, and complete API (version 2).</p></li>
/// <li>
...
impl DescribePlaceIndexFluentBuilder {
    /// Creates a new `DescribePlaceIndexFluentBuilder`.
