...
impl ::std::fmt::Debug for GetDevicePositionHistoryInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("start_time_inclusive", &"*** Sensitive Data Redacted ***");
        formatter.field("end_time_exclusive", &"*** Sensitive Data Redacted ***");
...
impl ::std::fmt::Debug for GetDevicePositionHistoryInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetDevicePositionHistoryInputBuilder");
        formatter.field("tracker_name", &self.tracker_name);
        formatter.field("device_id", &self.device_id);
        formatter.field("next_token", &self.next_token);
        formatter.field("start_time_inclusive", &"*** Sensitive Data Redacted ***");
