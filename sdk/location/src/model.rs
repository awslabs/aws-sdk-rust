...
pub struct ListDevicePositionsResponseEntry  {
    ...
    #[doc(hidden)]pub sample_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The last known device position. Empty if no positions currently stored.</p>
    #[doc(hidden)]pub position: std::option::Option<std::vec::Vec<f64>>,
    /// <p>The accuracy of the device position.</p>
    #[doc(hidden)]pub accuracy: std::option::Option<crate::model::PositionalAccuracy>,
    /// <p>The properties associated with the position.</p>
    #[doc(hidden)]pub position_properties: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct PositionalAccuracy  {
    ...
    #[doc(hidden)]pub horizontal: std::option::Option<f64>,
}
...
pub struct DevicePosition  {
    ...
    #[doc(hidden)]pub received_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct BatchUpdateDevicePositionError  {
    ...
    #[doc(hidden)]pub error: std::option::Option<crate::model::BatchItemError>,
}
...
pub struct BatchItemError  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::BatchItemErrorCode>,
...
pub struct ListTrackersResponseEntry  {
    ...
    #[doc(hidden)]pub tracker_name: std::option::Option<std::string::String>,
    /// <p>The description for the tracker resource.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>Always returns <code>RequestBasedUsage</code>.</p>
    #[deprecated(note = "Deprecated. Always returns RequestBasedUsage.", since = "2022-02-01")]#[doc(hidden)]pub pricing_plan: std::option::Option<crate::model::PricingPlan>,
    /// <p>No longer used. Always returns an empty string.</p>
    #[deprecated(note = "Deprecated. Unused.", since = "2022-02-01")]#[doc(hidden)]pub pricing_plan_data_source: std::option::Option<std::string::String>,
    ...
    /// <p>The timestamp at which the device's position was determined. Uses <a href="https://www.iso.org/iso-8601-date-and-time-format.html"> ISO 8601</a> format: <code>YYYY-MM-DDThh:mm:ss.sssZ</code>. </p>
    #[doc(hidden)]pub update_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl ListTrackersResponseEntry {
    ...
    /// <p>Always returns <code>RequestBasedUsage</code>.</p>
    #[deprecated(note = "Deprecated. Always returns RequestBasedUsage.", since = "2022-02-01")]pub fn pricing_plan(&self) -> std::option::Option<& crate::model::PricingPlan> {
        self.pricing_plan.as_ref()
    }
    /// <p>No longer used. Always returns an empty string.</p>
    #[deprecated(note = "Deprecated. Unused.", since = "2022-02-01")]pub fn pricing_plan_data_source(&self) -> std::option::Option<& str> {
...
pub mod list_trackers_response_entry {
    ...
    impl Builder {
        ...
        /// <p>Always returns <code>RequestBasedUsage</code>.</p>
        #[deprecated(note = "Deprecated. Always returns RequestBasedUsage.", since = "2022-02-01")]pub fn pricing_plan(mut self, input: crate::model::PricingPlan) -> Self {
            self.pricing_plan = Some(input);
            self
        }
        /// <p>Always returns <code>RequestBasedUsage</code>.</p>
        #[deprecated(note = "Deprecated. Always returns RequestBasedUsage.", since = "2022-02-01")]pub fn set_pricing_plan(mut self, input: std::option::Option<crate::model::PricingPlan>) -> Self {
            self.pricing_plan = input; self
        }
        /// <p>No longer used. Always returns an empty string.</p>
        #[deprecated(note = "Deprecated. Unused.", since = "2022-02-01")]pub fn pricing_plan_data_source(mut self, input: impl Into<std::string::String>) -> Self {
            self.pricing_plan_data_source = Some(input.into());
            self
        }
        /// <p>No longer used. Always returns an empty string.</p>
        #[deprecated(note = "Deprecated. Unused.", since = "2022-02-01")]pub fn set_pricing_plan_data_source(mut self, input: std::option::Option<std::string::String>) -> Self {
...
pub struct CalculateRouteMatrixSummary  {
    ...
    #[doc(hidden)]pub data_source: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub route_count: std::option::Option<i32>,
    /// <p>The count of error results in the route matrix. If this number is 0, all routes were calculated successfully.</p>
    #[doc(hidden)]pub error_count: std::option::Option<i32>,
    /// <p>The unit of measurement for route distances.</p>
    #[doc(hidden)]pub distance_unit: std::option::Option<crate::model::DistanceUnit>,
}
...
pub struct RouteMatrixEntry  {
    ...
    #[doc(hidden)]pub distance: std::option::Option<f64>,
    /// <p>The expected duration of travel for the route.</p>
    #[doc(hidden)]pub duration_seconds: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub error: std::option::Option<crate::model::RouteMatrixEntryError>,
}
...
pub struct RouteMatrixEntryError  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::RouteMatrixErrorCode>,
...
pub struct CalculateRouteTruckModeOptions  {
    ...
    #[doc(hidden)]pub avoid_ferries: std::option::Option<bool>,
    /// <p>Avoids tolls when calculating routes.</p> 
    /// <p>Default Value: <code>false</code> </p> 
    /// <p>Valid Values: <code>false</code> | <code>true</code> </p>
    #[doc(hidden)]pub avoid_tolls: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub dimensions: std::option::Option<crate::model::TruckDimensions>,
    ...
    #[doc(hidden)]pub weight: std::option::Option<crate::model::TruckWeight>,
}
...
pub struct TruckWeight  {
    ...
    #[doc(hidden)]pub unit: std::option::Option<crate::model::VehicleWeightUnit>,
}
impl TruckWeight {
    /// <p>The total weight of the truck. </p> 
    /// <ul> 
...
pub struct TruckDimensions  {
    ...
    /// </note>
    #[doc(hidden)]pub length: std::option::Option<f64>,
    ...
    /// </note>
    #[doc(hidden)]pub height: std::option::Option<f64>,
    ...
    /// <p> For routes calculated with a HERE resource, this value must be between 0 and 50 meters. </p> 
    /// </note>
    #[doc(hidden)]pub width: std::option::Option<f64>,
    /// <p> Specifies the unit of measurement for the truck dimensions.</p> 
    /// <p>Default Value: <code>Meters</code> </p>
    #[doc(hidden)]pub unit: std::option::Option<crate::model::DimensionUnit>,
}
...
pub struct CalculateRouteSummary  {
    ...
    /// </ul>
    #[doc(hidden)]pub route_b_box: std::option::Option<std::vec::Vec<f64>>,
...
pub struct Leg  {
    ...
    /// </note>
    #[doc(hidden)]pub start_position: std::option::Option<std::vec::Vec<f64>>,
    ...
    /// </note>
    #[doc(hidden)]pub end_position: std::option::Option<std::vec::Vec<f64>>,
    ...
    #[doc(hidden)]pub geometry: std::option::Option<crate::model::LegGeometry>,
    ...
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::Step>>,
}
impl Leg {
    /// <p>The starting position of the leg. Follows the format <code>[longitude,latitude]</code>.</p> <note> 
    /// <p>If the <code>StartPosition</code> isn't located on a road, it's <a href="https://docs.aws.amazon.com/location/latest/developerguide/snap-to-nearby-road.html">snapped to a nearby road</a>. </p> 
...
pub struct Step  {
    ...
    #[doc(hidden)]pub geometry_offset: std::option::Option<i32>,
}
impl Step {
    /// <p>The starting position of a step. If the position is the first step in the leg, this position is the same as the start position of the leg.</p>
    pub fn start_position(&self) -> std::option::Option<& [f64]> {
...
pub struct LegGeometry  {
    ...
    /// </ul>
    #[doc(hidden)]pub line_string: std::option::Option<std::vec::Vec<std::vec::Vec<f64>>>,
}
impl LegGeometry {
    /// <p>An ordered list of positions used to plot a route on a map. </p> 
    /// <p>The first position is closest to the start position for the leg, and the last position is the closest to the end position for the leg.</p> 
...
pub struct ListRouteCalculatorsResponseEntry  {
    ...
    #[doc(hidden)]pub calculator_name: std::option::Option<std::string::String>,
...
pub struct SearchForTextResult  {
    ...
    #[doc(hidden)]pub place: std::option::Option<crate::model::Place>,
    ...
    #[doc(hidden)]pub relevance: std::option::Option<f64>,
    ...
    /// </note>
    #[doc(hidden)]pub place_id: std::option::Option<std::string::String>,
}
...
pub struct Place  {
    ...
    /// </note>
    #[doc(hidden)]pub unit_number: std::option::Option<std::string::String>,
}
impl Place {
    /// <p>The full name and address of the point of interest such as a city, region, or country. For example, <code>123 Any Street, Any Town, USA</code>.</p>
...
pub struct TimeZone  {
    ...
    #[doc(hidden)]pub offset: std::option::Option<i32>,
}
impl TimeZone {
    /// <p>The name of the time zone, following the <a href="https://www.iana.org/time-zones"> IANA time zone standard</a>. For example, <code>America/Los_Angeles</code>.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct PlaceGeometry  {
    ...
    /// </ul>
    #[doc(hidden)]pub point: std::option::Option<std::vec::Vec<f64>>,
}
impl PlaceGeometry {
    /// <p>A single point geometry specifies a location for a Place using <a href="https://gisgeography.com/wgs84-world-geodetic-system/">WGS 84</a> coordinates:</p> 
    /// <ul> 
...
pub struct SearchPlaceIndexForTextSummary  {
    ...
    #[doc(hidden)]pub bias_position: std::option::Option<std::vec::Vec<f64>>,
    /// <p>Contains the coordinates for the optional bounding box specified in the request.</p>
    #[doc(hidden)]pub filter_b_box: std::option::Option<std::vec::Vec<f64>>,
    /// <p>Contains the optional country filter specified in the request.</p>
    #[doc(hidden)]pub filter_countries: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    /// </note>
    #[doc(hidden)]pub result_b_box: std::option::Option<std::vec::Vec<f64>>,
...
pub struct DataSourceConfiguration  {
    ...
    #[doc(hidden)]pub intended_use: std::option::Option<crate::model::IntendedUse>,
}
...
pub struct ListMapsResponseEntry  {
    ...
    #[doc(hidden)]pub map_name: std::option::Option<std::string::String>,
...
pub struct MapConfiguration  {
    ...
    /// </note>
    #[doc(hidden)]pub style: std::option::Option<std::string::String>,
}
...
pub struct GeofenceGeometry  {
    ...
    #[doc(hidden)]pub polygon: std::option::Option<std::vec::Vec<std::vec::Vec<std::vec::Vec<f64>>>>,
    /// <p>A circle on the earth, as defined by a center point and a radius.</p>
    #[doc(hidden)]pub circle: std::option::Option<crate::model::Circle>,
}
...
pub struct ListGeofenceResponseEntry  {
    ...
    #[doc(hidden)]pub geofence_id: std::option::Option<std::string::String>,
    /// <p>Contains the geofence geometry details describing a polygon or a circle.</p>
    #[doc(hidden)]pub geometry: std::option::Option<crate::model::GeofenceGeometry>,
...
pub struct ListGeofenceCollectionsResponseEntry  {
    ...
    #[doc(hidden)]pub collection_name: std::option::Option<std::string::String>,
