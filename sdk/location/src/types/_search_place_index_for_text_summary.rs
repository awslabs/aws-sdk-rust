    ...
    pub fn build(self) -> ::std::result::Result<crate::types::SearchPlaceIndexForTextSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::SearchPlaceIndexForTextSummary {
                text: self.text
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("text", "text was not specified but it is required when building SearchPlaceIndexForTextSummary")
                    )?
                ,
                ...
                data_source: self.data_source
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_source", "data_source was not specified but it is required when building SearchPlaceIndexForTextSummary")
                    )?
                ,
