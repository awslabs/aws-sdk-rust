...
/// match joberrorcode {
///     JobErrorCode::InternalServerError => { /* ... */ },
...
impl ::std::convert::From<&str> for JobErrorCode {
    fn from(s: &str) -> Self {
        match s {
            "InternalServerError" => JobErrorCode::InternalServerError,
            "ValidationError" => JobErrorCode::ValidationError,
...
impl JobErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            JobErrorCode::InternalServerError => "InternalServerError",
            JobErrorCode::ValidationError => "ValidationError",
...
impl ::std::fmt::Display for JobErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            JobErrorCode::InternalServerError => write!(f, "InternalServerError"),
            JobErrorCode::ValidationError => write!(f, "ValidationError"),
