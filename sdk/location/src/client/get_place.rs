...
impl super::Client {
    ...
    ///   - [`key(impl Into<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::key) / [`set_key(Option<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::set_key): <p>The optional <a href="https://docs.aws.amazon.com/location/latest/developerguide/using-apikeys.html">API key</a> to authorize the request.</p>
