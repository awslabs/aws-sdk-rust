...
impl super::Client {
    ...
    ///   - [`index_name(impl Into<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::index_name) / [`set_index_name(impl Into<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::set_index_name):<br>required: **true**<br><p>The name of the place index resource that you want to use for the search.</p><br>
    ///   - [`place_id(impl Into<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::place_id) / [`set_place_id(impl Into<String>)`](crate::operation::get_place::builders::GetPlaceFluentBuilder::set_place_id):<br>required: **true**<br><p>The identifier of the place to find.</p><br>
