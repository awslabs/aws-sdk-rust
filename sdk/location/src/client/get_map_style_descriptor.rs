...
impl super::Client {
    ...
    ///   - [`key(impl Into<String>)`](crate::operation::get_map_style_descriptor::builders::GetMapStyleDescriptorFluentBuilder::key) / [`set_key(Option<String>)`](crate::operation::get_map_style_descriptor::builders::GetMapStyleDescriptorFluentBuilder::set_key): <p>The optional <a href="https://docs.aws.amazon.com/location/latest/developerguide/using-apikeys.html">API key</a> to authorize the request.</p>
