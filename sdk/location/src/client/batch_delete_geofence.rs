...
impl super::Client {
    ...
    ///   - [`collection_name(impl Into<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::collection_name) / [`set_collection_name(impl Into<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::set_collection_name):<br>required: **true**<br><p>The geofence collection storing the geofences to be deleted.</p><br>
    ///   - [`geofence_ids(impl Into<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::geofence_ids) / [`set_geofence_ids(Vec<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::set_geofence_ids):<br>required: **true**<br><p>The batch of geofences to be deleted.</p><br>
