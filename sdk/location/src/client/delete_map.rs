...
impl super::Client {
    ...
    ///   - [`map_name(impl Into<String>)`](crate::operation::delete_map::builders::DeleteMapFluentBuilder::map_name) / [`set_map_name(impl Into<String>)`](crate::operation::delete_map::builders::DeleteMapFluentBuilder::set_map_name):<br>required: **true**<br><p>The name of the map resource to be deleted.</p><br>
