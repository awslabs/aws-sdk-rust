...
impl super::Client {
    ...
    ///   - [`map_name(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::map_name) / [`set_map_name(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::set_map_name):<br>required: **true**<br><p>The map resource to retrieve the map tiles from.</p><br>
    ///   - [`z(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::z) / [`set_z(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::set_z):<br>required: **true**<br><p>The zoom value for the map tile.</p><br>
    ///   - [`x(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::x) / [`set_x(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::set_x):<br>required: **true**<br><p>The X axis value for the map tile.</p><br>
    ///   - [`y(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::y) / [`set_y(impl Into<String>)`](crate::operation::get_map_tile::builders::GetMapTileFluentBuilder::set_y):<br>required: **true**<br><p>The Y axis value for the map tile. </p><br>
