...
impl super::Client {
    ...
    ///   - [`map_name(impl Into<String>)`](crate::operation::describe_map::builders::DescribeMapFluentBuilder::map_name) / [`set_map_name(Option<String>)`](crate::operation::describe_map::builders::DescribeMapFluentBuilder::set_map_name):<br>required: **true**<br><p>The name of the map resource.</p><br>
