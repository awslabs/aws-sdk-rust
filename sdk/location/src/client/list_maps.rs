...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_maps::builders::ListMapsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_maps::builders::ListMapsFluentBuilder::set_next_token): <p>The pagination token specifying which page of results to return in the response. If no token is provided, the default page is the first page.</p>  <p>Default value: <code>null</code> </p>
    /// - On success, responds with [`ListMapsOutput`](crate::operation::list_maps::ListMapsOutput) with field(s):
    ///   - [`entries(Option<Vec<ListMapsResponseEntry>>)`](crate::operation::list_maps::ListMapsOutput::entries): <p>Contains a list of maps in your Amazon Web Services account</p>
