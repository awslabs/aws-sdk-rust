...
impl super::Client {
    ...
    ///   - [`map_name(impl Into<String>)`](crate::operation::get_map_sprites::builders::GetMapSpritesFluentBuilder::map_name) / [`set_map_name(Option<String>)`](crate::operation::get_map_sprites::builders::GetMapSpritesFluentBuilder::set_map_name):<br>required: **true**<br><p>The map resource associated with the sprite ﬁle.</p><br>
