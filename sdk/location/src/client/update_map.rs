...
impl super::Client {
    ...
    ///   - [`configuration_update(MapConfigurationUpdate)`](crate::operation::update_map::builders::UpdateMapFluentBuilder::configuration_update) / [`set_configuration_update(Option<MapConfigurationUpdate>)`](crate::operation::update_map::builders::UpdateMapFluentBuilder::set_configuration_update): <p>Updates the parts of the map configuration that can be updated, including the political view.</p>
