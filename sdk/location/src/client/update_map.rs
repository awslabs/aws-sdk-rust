...
impl super::Client {
    ...
    ///   - [`map_name(impl Into<String>)`](crate::operation::update_map::builders::UpdateMapFluentBuilder::map_name) / [`set_map_name(impl Into<String>)`](crate::operation::update_map::builders::UpdateMapFluentBuilder::set_map_name):<br>required: **true**<br><p>The name of the map resource to update.</p><br>
