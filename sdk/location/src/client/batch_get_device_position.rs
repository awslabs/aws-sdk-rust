...
impl super::Client {
    ...
    ///   - [`device_ids(impl Into<String>)`](crate::operation::batch_get_device_position::builders::BatchGetDevicePositionFluentBuilder::device_ids) / [`set_device_ids(Option<Vec<String>>)`](crate::operation::batch_get_device_position::builders::BatchGetDevicePositionFluentBuilder::set_device_ids): <p>Devices whose position you want to retrieve.</p>  <ul>   <li> <p>For example, for two devices: <code>device-ids=DeviceId1&amp;device-ids=DeviceId2</code> </p> </li>  </ul>
