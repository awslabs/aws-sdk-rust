...
impl super::Client {
    ...
    ///   - [`geometry(Option<GeofenceGeometry>)`](crate::operation::get_geofence::GetGeofenceOutput::geometry): <p>Contains the geofence geometry details describing the position of the geofence. Can be a circle, a polygon, or a multipolygon.</p>
