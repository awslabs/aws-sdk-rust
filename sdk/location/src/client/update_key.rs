...
impl super::Client {
    ...
    ///   - [`key_name(impl Into<String>)`](crate::operation::update_key::builders::UpdateKeyFluentBuilder::key_name) / [`set_key_name(impl Into<String>)`](crate::operation::update_key::builders::UpdateKeyFluentBuilder::set_key_name):<br>required: **true**<br><p>The name of the API key resource to update.</p><br>
