...
impl super::Client {
    ...
    ///   - [`entries(Option<Vec<ListDevicePositionsResponseEntry>>)`](crate::operation::list_device_positions::ListDevicePositionsOutput::entries): <p>Contains details about each device's last known position.</p>
