...
impl super::Client {
    ...
    ///   - [`key_name(impl ::std::convert::Into<String>)`](crate::operation::delete_key::builders::DeleteKeyFluentBuilder::key_name) / [`set_key_name(Option<String>)`](crate::operation::delete_key::builders::DeleteKeyFluentBuilder::set_key_name): <p>The name of the API key to delete.</p>
