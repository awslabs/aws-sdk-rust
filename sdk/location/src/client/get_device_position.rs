...
impl super::Client {
    ...
    ///   - [`tracker_name(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::tracker_name) / [`set_tracker_name(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::set_tracker_name):<br>required: **true**<br><p>The tracker resource receiving the position update.</p><br>
    ///   - [`device_id(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::device_id) / [`set_device_id(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::set_device_id):<br>required: **true**<br><p>The device whose position you want to retrieve.</p><br>
