...
impl super::Client {
    ...
    ///   - [`tracker_name(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::tracker_name) / [`set_tracker_name(Option<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::set_tracker_name):<br>required: **true**<br><p>The tracker resource receiving the position update.</p><br>
    ///   - [`device_id(impl Into<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::get_device_position::builders::GetDevicePositionFluentBuilder::set_device_id):<br>required: **true**<br><p>The device whose position you want to retrieve.</p><br>
    ...
    ///   - [`received_time(DateTime)`](crate::operation::get_device_position::GetDevicePositionOutput::received_time): <p>The timestamp for when the tracker resource received the device position. Uses <a href="https://www.iso.org/iso-8601-date-and-time-format.html"> ISO 8601 </a> format: <code>YYYY-MM-DDThh:mm:ss.sssZ</code>.</p>
