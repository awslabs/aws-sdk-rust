...
impl super::Client {
    ...
    ///   - [`collection_name(impl Into<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::collection_name) / [`set_collection_name(impl Into<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::set_collection_name):<br>required: **true**<br><p>The name of the geofence collection storing the list of geofences.</p><br>
