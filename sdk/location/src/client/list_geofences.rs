...
impl super::Client {
    ...
    ///   - [`collection_name(impl ::std::convert::Into<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::collection_name) / [`set_collection_name(Option<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::set_collection_name): <p>The name of the geofence collection storing the list of geofences.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_geofences::builders::ListGeofencesFluentBuilder::set_next_token): <p>The pagination token specifying which page of results to return in the response. If no token is provided, the default page is the first page. </p>  <p>Default value: <code>null</code> </p>
