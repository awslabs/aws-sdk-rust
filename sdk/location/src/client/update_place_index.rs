...
impl super::Client {
    ...
    ///   - [`index_name(impl ::std::convert::Into<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::index_name) / [`set_index_name(Option<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::set_index_name): <p>The name of the place index resource to update.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::set_description): <p>Updates the description for the place index resource.</p>
