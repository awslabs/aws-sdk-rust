...
impl super::Client {
    ...
    ///   - [`index_name(impl Into<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::index_name) / [`set_index_name(impl Into<String>)`](crate::operation::update_place_index::builders::UpdatePlaceIndexFluentBuilder::set_index_name):<br>required: **true**<br><p>The name of the place index resource to update.</p><br>
