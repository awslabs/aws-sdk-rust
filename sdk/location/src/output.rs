...
pub struct ListTrackerConsumersOutput  {
    ...
    #[doc(hidden)]pub consumer_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ListDevicePositionsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListDevicePositionsResponseEntry>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetDevicePositionHistoryOutput  {
    ...
    #[doc(hidden)]pub device_positions: std::option::Option<std::vec::Vec<crate::model::DevicePosition>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct BatchUpdateDevicePositionOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchUpdateDevicePositionError>>,
}
...
pub struct BatchGetDevicePositionOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchGetDevicePositionError>>,
...
pub struct BatchDeleteDevicePositionHistoryOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchDeleteDevicePositionHistoryError>>,
}
...
pub struct ListTrackersOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListTrackersResponseEntry>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct CreateTrackerOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub tracker_arn: std::option::Option<std::string::String>,
...
pub struct CalculateRouteMatrixOutput  {
    ...
    #[doc(hidden)]pub route_matrix: std::option::Option<std::vec::Vec<std::vec::Vec<crate::model::RouteMatrixEntry>>>,
    ...
    #[doc(hidden)]pub snapped_departure_positions: std::option::Option<std::vec::Vec<std::vec::Vec<f64>>>,
    /// <p>The list of destination positions for the route matrix used for calculation of the <code>RouteMatrix</code>.</p>
    #[doc(hidden)]pub snapped_destination_positions: std::option::Option<std::vec::Vec<std::vec::Vec<f64>>>,
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::CalculateRouteMatrixSummary>,
}
...
impl  std::fmt::Debug for CalculateRouteMatrixOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("snapped_departure_positions", &self.snapped_departure_positions);
        formatter.field("snapped_destination_positions", &self.snapped_destination_positions);
...
pub struct CalculateRouteOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub legs: std::option::Option<std::vec::Vec<crate::model::Leg>>,
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::CalculateRouteSummary>,
}
...
pub struct ListRouteCalculatorsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListRouteCalculatorsResponseEntry>>,
...
pub struct CreateRouteCalculatorOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub calculator_arn: std::option::Option<std::string::String>,
...
pub struct SearchPlaceIndexForTextOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::SearchPlaceIndexForTextSummary>,
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::SearchForTextResult>>,
}
...
pub struct SearchPlaceIndexForSuggestionsOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::SearchPlaceIndexForSuggestionsSummary>,
    /// <p>A list of place suggestions that best match the search text.</p>
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::SearchForSuggestionsResult>>,
}
...
pub struct SearchPlaceIndexForPositionOutput  {
    ...
    #[doc(hidden)]pub summary: std::option::Option<crate::model::SearchPlaceIndexForPositionSummary>,
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::SearchForPositionResult>>,
}
...
pub struct ListPlaceIndexesOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListPlaceIndexesResponseEntry>>,
...
pub struct GetMapTileOutput  {
    ...
    #[doc(hidden)]pub blob: std::option::Option<aws_smithy_types::Blob>,
...
pub struct ListMapsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListMapsResponseEntry>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListMapsOutput {
...
pub struct CreateMapOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub map_arn: std::option::Option<std::string::String>,
...
pub struct ListGeofencesOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListGeofenceResponseEntry>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct BatchPutGeofenceOutput  {
    ...
    #[doc(hidden)]pub successes: std::option::Option<std::vec::Vec<crate::model::BatchPutGeofenceSuccess>>,
    /// <p>Contains additional error details for each geofence that failed to be stored in a geofence collection.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchPutGeofenceError>>,
}
...
pub struct BatchEvaluateGeofencesOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchEvaluateGeofencesError>>,
}
...
pub struct BatchDeleteGeofenceOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchDeleteGeofenceError>>,
}
...
pub struct ListGeofenceCollectionsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::ListGeofenceCollectionsResponseEntry>>,
    /// <p>A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
