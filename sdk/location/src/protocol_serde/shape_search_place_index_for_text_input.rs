...
pub fn ser_search_place_index_for_text_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchPlaceIndexForTextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
