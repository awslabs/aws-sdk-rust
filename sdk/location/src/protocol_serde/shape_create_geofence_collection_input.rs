...
pub fn ser_create_geofence_collection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_geofence_collection::CreateGeofenceCollectionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
