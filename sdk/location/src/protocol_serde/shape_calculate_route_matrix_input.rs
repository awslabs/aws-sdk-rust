...
pub fn ser_calculate_route_matrix_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CalculateRouteMatrixInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
