...
pub fn de_get_map_tile_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_map_tile::GetMapTileOutput, crate::operation::get_map_tile::GetMapTileError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_map_tile_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_map_tile::GetMapTileOutput, crate::operation::get_map_tile::GetMapTileError> {
    Ok({
        #[allow(unused_mut)]
