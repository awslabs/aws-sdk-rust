...
pub fn de_get_map_tile_http_response(
    ...
    Ok({
        ...
        output = output.set_cache_control(
            match crate::protocol_serde::shape_get_map_tile_output::de_cache_control_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::get_map_tile::GetMapTileError::unhandled(
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_get_map_tile_output::de_content_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
