...
pub fn ser_search_place_index_for_suggestions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchPlaceIndexForSuggestionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
