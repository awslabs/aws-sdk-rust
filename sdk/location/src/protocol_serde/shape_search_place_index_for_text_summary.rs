...
pub(crate) fn de_search_place_index_for_text_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SearchPlaceIndexForTextSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ResultBBox" => {
                            builder = builder.set_result_b_box(crate::protocol_serde::shape_bounding_box::de_bounding_box(tokens, _value)?);
                        }
                        "DataSource" => {
