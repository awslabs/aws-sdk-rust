...
pub fn ser_create_route_calculator_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRouteCalculatorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
