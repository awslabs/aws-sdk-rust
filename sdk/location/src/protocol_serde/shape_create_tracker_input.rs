...
pub fn ser_create_tracker_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTrackerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
