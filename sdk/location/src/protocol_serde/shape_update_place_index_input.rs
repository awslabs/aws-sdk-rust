...
pub fn ser_update_place_index_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePlaceIndexInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
