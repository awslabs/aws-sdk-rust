...
pub(crate) fn de_list_device_positions_response_entry<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ListDevicePositionsResponseEntry>, aws_smithy_json::deserialize::error::DeserializeError>
