...
pub fn ser_update_tracker_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTrackerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
