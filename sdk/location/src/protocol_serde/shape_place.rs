...
) -> Result<Option<crate::types::Place>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Geometry" => {
                            builder = builder.set_geometry(crate::protocol_serde::shape_place_geometry::de_place_geometry(tokens)?);
                        }
                        "AddressNumber" => {
