...
pub(crate) fn de_search_place_index_for_suggestions_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SearchPlaceIndexForSuggestionsSummary>, aws_smithy_json::deserialize::error::DeserializeError>
