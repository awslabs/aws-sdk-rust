...
pub fn ser_create_place_index_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePlaceIndexInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
