...
pub fn ser_calculate_route_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CalculateRouteInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
