...
pub fn ser_calculate_route_input_input(
    ...
    if let Some(var_1) = &input.arrival_time {
        object.key("ArrivalTime").date_time(var_1, ::aws_smithy_types::date_time::Format::DateTime)?;
    }
    ...
    if let Some(var_8) = &input.departure_time {
        object.key("DepartureTime").date_time(var_8, ::aws_smithy_types::date_time::Format::DateTime)?;
    }
        ...
        for item_20 in var_18 {
             {
                ...
                for item_22 in item_20 {
                     {
                        array_21.value().number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*item_22).into()));
                    }
                }
                array_21.finish();
            }
