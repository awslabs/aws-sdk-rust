...
pub trait Waiters {
    ...
    fn wait_until_deployment_complete(&self) -> crate::waiters::deployment_complete::DeploymentCompleteFluentBuilder;
    /// Wait for `environment_ready_for_deployment`
    fn wait_until_environment_ready_for_deployment(
        &self,
    ) -> crate::waiters::environment_ready_for_deployment::EnvironmentReadyForDeploymentFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_deployment_complete(&self) -> crate::waiters::deployment_complete::DeploymentCompleteFluentBuilder {
        crate::waiters::deployment_complete::DeploymentCompleteFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_environment_ready_for_deployment(
        &self,
    ) -> crate::waiters::environment_ready_for_deployment::EnvironmentReadyForDeploymentFluentBuilder {
        crate::waiters::environment_ready_for_deployment::EnvironmentReadyForDeploymentFluentBuilder::new(self.handle.clone())
    }
}
