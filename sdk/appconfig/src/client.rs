...
impl Client  {
    ...
    pub fn create_hosted_configuration_version(&self) -> fluent_builders::CreateHostedConfigurationVersion {
    ...
    pub fn delete_hosted_configuration_version(&self) -> fluent_builders::DeleteHostedConfigurationVersion {
    ...
    pub fn get_hosted_configuration_version(&self) -> fluent_builders::GetHostedConfigurationVersion {
    ...
    pub fn list_hosted_configuration_versions(&self) -> fluent_builders::ListHostedConfigurationVersions {
...
pub mod fluent_builders {
    ...
    /// </ul> 
    /// </important>
    #[deprecated(note = "This API has been deprecated in favor of the GetLatestConfiguration API used in conjunction with StartConfigurationSession.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
