...
impl CreateHostedConfigurationVersion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateHostedConfigurationVersion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateHostedConfigurationVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateHostedConfigurationVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateHostedConfigurationVersionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateHostedConfigurationVersion")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateHostedConfigurationVersion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateHostedConfigurationVersionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateHostedConfigurationVersionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateHostedConfigurationVersionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateHostedConfigurationVersionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateHostedConfigurationVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_hosted_configuration_version::de_create_hosted_configuration_version_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_create_hosted_configuration_version::de_create_hosted_configuration_version_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateHostedConfigurationVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionInput,
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_create_hosted_configuration_version::ser_create_hosted_configuration_version_headers(
                    input, builder,
                )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_hosted_configuration_version_input::ser_content_http_payload(input.content)?,
        );
