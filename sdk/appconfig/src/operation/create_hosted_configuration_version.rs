...
impl CreateHostedConfigurationVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHostedConfigurationVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_hosted_configuration_version::de_create_hosted_configuration_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
