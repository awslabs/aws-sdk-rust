...
impl GetExtensionAssociationInput {
    /// Consumes the builder and constructs an Operation<[`GetExtensionAssociation`](crate::operation::get_extension_association::GetExtensionAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_extension_association::GetExtensionAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_extension_association::GetExtensionAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.extension_association_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("extension_association_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_extension_association::GetExtensionAssociation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetExtensionAssociation {
                type Output = std::result::Result<crate::operation::get_extension_association::GetExtensionAssociationOutput, crate::operation::get_extension_association::GetExtensionAssociationError>;
