...
pub struct StartExperimentRunOutput {
...
impl ::aws_types::request_id::RequestId for StartExperimentRunOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartExperimentRunOutput {
    /// Creates a new builder-style object to manufacture [`StartExperimentRunOutput`](crate::operation::start_experiment_run::StartExperimentRunOutput).
    pub fn builder() -> crate::operation::start_experiment_run::builders::StartExperimentRunOutputBuilder {
        crate::operation::start_experiment_run::builders::StartExperimentRunOutputBuilder::default()
    }
}

/// A builder for [`StartExperimentRunOutput`](crate::operation::start_experiment_run::StartExperimentRunOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartExperimentRunOutputBuilder {
...
impl StartExperimentRunOutputBuilder {
    /// <p>The application ID.</p>
    ...
    /// Consumes the builder and constructs a [`StartExperimentRunOutput`](crate::operation::start_experiment_run::StartExperimentRunOutput).
    pub fn build(self) -> crate::operation::start_experiment_run::StartExperimentRunOutput {
