...
impl DeleteConfigurationProfileInput {
    /// Consumes the builder and constructs an Operation<[`DeleteConfigurationProfile`](crate::operation::delete_configuration_profile::DeleteConfigurationProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_configuration_profile::DeleteConfigurationProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_configuration_profile::DeleteConfigurationProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_configuration_profile::DeleteConfigurationProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteConfigurationProfile {
                type Output = std::result::Result<crate::operation::delete_configuration_profile::DeleteConfigurationProfileOutput, crate::operation::delete_configuration_profile::DeleteConfigurationProfileError>;
