...
impl DeleteConfigurationProfileInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_configuration_profile::DeleteConfigurationProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConfigurationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_configuration_profile::de_delete_configuration_profile_http_response_with_props(status, headers, body)
        }
    }
}
