...
pub struct StopExperimentRunOutput {
...
impl ::aws_types::request_id::RequestId for StopExperimentRunOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StopExperimentRunOutput {
    /// Creates a new builder-style object to manufacture [`StopExperimentRunOutput`](crate::operation::stop_experiment_run::StopExperimentRunOutput).
    pub fn builder() -> crate::operation::stop_experiment_run::builders::StopExperimentRunOutputBuilder {
        crate::operation::stop_experiment_run::builders::StopExperimentRunOutputBuilder::default()
    }
}

/// A builder for [`StopExperimentRunOutput`](crate::operation::stop_experiment_run::StopExperimentRunOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StopExperimentRunOutputBuilder {
...
impl StopExperimentRunOutputBuilder {
    /// <p>The application ID.</p>
    ...
    /// Consumes the builder and constructs a [`StopExperimentRunOutput`](crate::operation::stop_experiment_run::StopExperimentRunOutput).
    pub fn build(self) -> crate::operation::stop_experiment_run::StopExperimentRunOutput {
