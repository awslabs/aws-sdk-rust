...
impl CreateExtensionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_extension::CreateExtension, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_extension::ser_create_extension_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateExtension {
    type Output =
        ::std::result::Result<crate::operation::create_extension::CreateExtensionOutput, crate::operation::create_extension::CreateExtensionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_extension::de_create_extension_http_response_with_props(status, headers, body)
        }
    }
}
