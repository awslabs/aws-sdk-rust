...
impl aws_smithy_http::response::ParseStrictResponse for CreateExtension {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_extension::de_create_extension_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_extension::de_create_extension_http_response(response)
                     }
                }
            }
