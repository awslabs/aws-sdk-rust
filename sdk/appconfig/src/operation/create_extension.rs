...
impl CreateExtensionInput {
    /// Consumes the builder and constructs an Operation<[`CreateExtension`](crate::operation::create_extension::CreateExtension)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_extension::CreateExtension, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_extension::CreateExtensionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_extension::CreateExtension::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateExtension", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateExtension`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateExtension {
                type Output = std::result::Result<crate::operation::create_extension::CreateExtensionOutput, crate::operation::create_extension::CreateExtensionError>;
