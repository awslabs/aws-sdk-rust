...
impl CreateExtensionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_extension::CreateExtension::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateExtension {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_extension::de_create_extension_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_extension::CreateExtensionError
{
