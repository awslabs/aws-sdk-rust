...
impl CreateExtensionAssociationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_extension_association::CreateExtensionAssociation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateExtensionAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_extension_association::de_create_extension_association_http_response_with_props(status, headers, body)
        }
    }
}
