...
impl ListExtensionAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`ListExtensionAssociations`](crate::operation::list_extension_associations::ListExtensionAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_extension_associations::ListExtensionAssociations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::list_extension_associations::ListExtensionAssociationsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.resource_identifier {
                     {
                        query.push_kv("resource_identifier", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
                if let Some(inner_2) = &_input.extension_identifier {
                     {
                        query.push_kv("extension_identifier", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.extension_version_number {
                    if *inner_3 != 0 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_extension_associations::ListExtensionAssociations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListExtensionAssociations", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListExtensionAssociations`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListExtensionAssociations {
                type Output = std::result::Result<crate::operation::list_extension_associations::ListExtensionAssociationsOutput, crate::operation::list_extension_associations::ListExtensionAssociationsError>;
