...
impl ListExtensionAssociationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_extension_associations::ListExtensionAssociations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListExtensionAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_extension_associations::de_list_extension_associations_http_response_with_props(status, headers, body)
        }
    }
}
