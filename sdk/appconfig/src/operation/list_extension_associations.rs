...
/// Orchestration and serialization glue logic for `ListExtensionAssociations`.
...
impl ListExtensionAssociations {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_extension_associations::ListExtensionAssociationsInput,
                    ) -> ::std::result::Result<crate::operation::list_extension_associations::ListExtensionAssociationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_extension_associations::ListExtensionAssociationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_extension_associations::ListExtensionAssociationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_extension_associations::ListExtensionAssociationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListExtensionAssociations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListExtensionAssociations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListExtensionAssociationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListExtensionAssociationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListExtensionAssociations")
...
.with_interceptor(ListExtensionAssociationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_extension_associations::ListExtensionAssociationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_extension_associations::ListExtensionAssociationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_extension_associations::ListExtensionAssociationsError>::new());
...
#[derive(Debug)]
            struct ListExtensionAssociationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListExtensionAssociationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_extension_associations::de_list_extension_associations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_extension_associations::de_list_extension_associations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListExtensionAssociationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListExtensionAssociationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_extension_associations::ListExtensionAssociationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_extension_associations::ListExtensionAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/extensionassociations").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_extension_associations::ListExtensionAssociationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_3) = &_input.extension_version_number {
         {
            query.push_kv("extension_version_number", ::aws_smithy_types::primitive::Encoder::from(*inner_3).encode());
        }
    }
...
#[derive(Debug)]
            struct ListExtensionAssociationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListExtensionAssociationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListExtensionAssociationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListExtensionAssociationsInput>()
                        .ok_or("failed to downcast to ListExtensionAssociationsInput")?;
...
pub enum ListExtensionAssociationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListExtensionAssociationsError) for what information is available for the error.")]
...
impl ListExtensionAssociationsError {
    /// Creates the `ListExtensionAssociationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListExtensionAssociationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListExtensionAssociationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_extension_associations::ListExtensionAssociationsError {
...
mod _list_extension_associations_output;
