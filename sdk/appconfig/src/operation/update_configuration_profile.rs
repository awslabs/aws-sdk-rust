...
impl UpdateConfigurationProfileInput {
    /// Consumes the builder and constructs an Operation<[`UpdateConfigurationProfile`](crate::operation::update_configuration_profile::UpdateConfigurationProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_configuration_profile::UpdateConfigurationProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_configuration_profile::UpdateConfigurationProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_configuration_profile::UpdateConfigurationProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationProfile {
                type Output = std::result::Result<crate::operation::update_configuration_profile::UpdateConfigurationProfileOutput, crate::operation::update_configuration_profile::UpdateConfigurationProfileError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_configuration_profile::de_update_configuration_profile_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_configuration_profile::de_update_configuration_profile_http_response(response)
                     }
                }
            }
