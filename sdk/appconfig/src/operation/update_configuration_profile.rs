...
impl UpdateConfigurationProfileInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_configuration_profile::UpdateConfigurationProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_configuration_profile::de_update_configuration_profile_http_response_with_props(status, headers, body)
        }
    }
