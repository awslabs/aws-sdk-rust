...
pub struct CreateExperimentDefinitionOutput {
...
impl CreateExperimentDefinitionOutput {
    /// <p>The application ID.</p>
...
impl ::aws_types::request_id::RequestId for CreateExperimentDefinitionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateExperimentDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`CreateExperimentDefinitionOutput`](crate::operation::create_experiment_definition::CreateExperimentDefinitionOutput).
    pub fn builder() -> crate::operation::create_experiment_definition::builders::CreateExperimentDefinitionOutputBuilder {
        crate::operation::create_experiment_definition::builders::CreateExperimentDefinitionOutputBuilder::default()
    }
}

/// A builder for [`CreateExperimentDefinitionOutput`](crate::operation::create_experiment_definition::CreateExperimentDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateExperimentDefinitionOutputBuilder {
...
impl CreateExperimentDefinitionOutputBuilder {
    /// <p>The application ID.</p>
    ...
    /// Consumes the builder and constructs a [`CreateExperimentDefinitionOutput`](crate::operation::create_experiment_definition::CreateExperimentDefinitionOutput).
    pub fn build(self) -> crate::operation::create_experiment_definition::CreateExperimentDefinitionOutput {
