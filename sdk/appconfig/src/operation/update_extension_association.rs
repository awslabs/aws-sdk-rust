...
impl UpdateExtensionAssociationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateExtensionAssociation`](crate::operation::update_extension_association::UpdateExtensionAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_extension_association::UpdateExtensionAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_extension_association::UpdateExtensionAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_extension_association::UpdateExtensionAssociation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateExtensionAssociation", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateExtensionAssociation`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateExtensionAssociation {
                type Output = std::result::Result<crate::operation::update_extension_association::UpdateExtensionAssociationOutput, crate::operation::update_extension_association::UpdateExtensionAssociationError>;
