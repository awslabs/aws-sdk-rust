...
impl UpdateExtensionAssociationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_extension_association::UpdateExtensionAssociation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateExtensionAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_extension_association::de_update_extension_association_http_response_with_props(status, headers, body)
        }
    }
}
