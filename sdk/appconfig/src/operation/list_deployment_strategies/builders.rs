...
impl ListDeploymentStrategiesFluentBuilder  {
    /// Creates a new `ListDeploymentStrategies`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_deployment_strategies::ListDeploymentStrategiesOutput, aws_smithy_http::result::SdkError<crate::operation::list_deployment_strategies::ListDeploymentStrategiesError>>
                     {
