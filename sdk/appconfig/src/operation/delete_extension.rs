...
impl DeleteExtensionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteExtension`](crate::operation::delete_extension::DeleteExtension)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_extension::DeleteExtension, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_extension::DeleteExtensionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.extension_identifier;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("extension_identifier", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::delete_extension::DeleteExtensionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_2) = &_input.version_number {
                    if *inner_2 != 0 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_extension::DeleteExtension::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteExtension {
                type Output = std::result::Result<crate::operation::delete_extension::DeleteExtensionOutput, crate::operation::delete_extension::DeleteExtensionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_delete_extension::de_delete_extension_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_extension::de_delete_extension_http_response(response)
                     }
                }
            }
