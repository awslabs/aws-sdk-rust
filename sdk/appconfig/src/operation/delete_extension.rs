...
impl DeleteExtensionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_extension::DeleteExtension, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteExtension {
    type Output =
        ::std::result::Result<crate::operation::delete_extension::DeleteExtensionOutput, crate::operation::delete_extension::DeleteExtensionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_extension::de_delete_extension_http_response_with_props(status, headers, body)
        }
    }
}
