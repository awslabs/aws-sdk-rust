...
pub struct GetExperimentRunOutput {
...
impl ::aws_types::request_id::RequestId for GetExperimentRunOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetExperimentRunOutput {
    /// Creates a new builder-style object to manufacture [`GetExperimentRunOutput`](crate::operation::get_experiment_run::GetExperimentRunOutput).
    pub fn builder() -> crate::operation::get_experiment_run::builders::GetExperimentRunOutputBuilder {
        crate::operation::get_experiment_run::builders::GetExperimentRunOutputBuilder::default()
    }
}

/// A builder for [`GetExperimentRunOutput`](crate::operation::get_experiment_run::GetExperimentRunOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetExperimentRunOutputBuilder {
...
impl GetExperimentRunOutputBuilder {
    /// <p>The application ID.</p>
    ...
    /// Consumes the builder and constructs a [`GetExperimentRunOutput`](crate::operation::get_experiment_run::GetExperimentRunOutput).
    pub fn build(self) -> crate::operation::get_experiment_run::GetExperimentRunOutput {
