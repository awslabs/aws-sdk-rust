...
impl CreateConfigurationProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_configuration_profile::CreateConfigurationProfileInput, ::aws_smithy_types::error::operation::BuildError> {
