...
impl crate::operation::create_configuration_profile::builders::CreateConfigurationProfileInputBuilder {
...
impl CreateConfigurationProfileFluentBuilder {
    /// Creates a new `CreateConfigurationProfileFluentBuilder`.
