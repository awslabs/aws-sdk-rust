...
impl ValidateConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`ValidateConfiguration`](crate::operation::validate_configuration::ValidateConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_configuration::ValidateConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_configuration::ValidateConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::validate_configuration::ValidateConfigurationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_3 = &_input.configuration_version;
                let inner_3 = inner_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("configuration_version", "cannot be empty or unset"))?;
                if inner_3.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_configuration::ValidateConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ValidateConfiguration", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ValidateConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for ValidateConfiguration {
                type Output = std::result::Result<crate::operation::validate_configuration::ValidateConfigurationOutput, crate::operation::validate_configuration::ValidateConfigurationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_validate_configuration::de_validate_configuration_http_error(response)
                     } else {
                        crate::protocol_serde::shape_validate_configuration::de_validate_configuration_http_response(response)
                     }
                }
            }
