...
impl DeleteConfigurationProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_configuration_profile::DeleteConfigurationProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_configuration_profile::DeleteConfigurationProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_configuration_profile::DeleteConfigurationProfileOutput, crate::operation::delete_configuration_profile::DeleteConfigurationProfileError, Self> {
