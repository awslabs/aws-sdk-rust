...
impl UpdateAccountSettings {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppConfig", "UpdateAccountSettings", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAccountSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_account_settings::de_update_account_settings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_account_settings::de_update_account_settings_http_response(status, headers, body, _cfg)
        };
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/settings").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
