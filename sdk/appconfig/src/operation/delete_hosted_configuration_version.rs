...
impl DeleteHostedConfigurationVersionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteHostedConfigurationVersion`](crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("version_number", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteHostedConfigurationVersion", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteHostedConfigurationVersion`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteHostedConfigurationVersion {
                type Output = std::result::Result<crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionOutput, crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionError>;
