...
impl DeleteHostedConfigurationVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersion,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHostedConfigurationVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_hosted_configuration_version::de_delete_hosted_configuration_version_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionError
{
