...
impl ListConfigurationProfilesInput {
    /// Consumes the builder and constructs an Operation<[`ListConfigurationProfiles`](crate::operation::list_configuration_profiles::ListConfigurationProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_configuration_profiles::ListConfigurationProfiles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_configuration_profiles::ListConfigurationProfilesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_configuration_profiles::ListConfigurationProfilesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_4) = &_input.r#type {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_configuration_profiles::ListConfigurationProfiles::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListConfigurationProfiles {
                type Output = std::result::Result<crate::operation::list_configuration_profiles::ListConfigurationProfilesOutput, crate::operation::list_configuration_profiles::ListConfigurationProfilesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_configuration_profiles::de_list_configuration_profiles_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_configuration_profiles::de_list_configuration_profiles_http_response(response)
                     }
                }
            }
