...
impl ListConfigurationProfilesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_configuration_profiles::ListConfigurationProfiles::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConfigurationProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_configuration_profiles::de_list_configuration_profiles_http_response_with_props(status, headers, body)
        }
    }
}
