...
impl CreateDeploymentStrategy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_deployment_strategy::CreateDeploymentStrategyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_deployment_strategy::CreateDeploymentStrategyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDeploymentStrategy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDeploymentStrategy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDeploymentStrategyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDeploymentStrategyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDeploymentStrategy")
...
.with_interceptor(CreateDeploymentStrategyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyError>::new());
...
#[derive(Debug)]
            struct CreateDeploymentStrategyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDeploymentStrategyResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                ...
                crate::protocol_serde::shape_create_deployment_strategy::de_create_deployment_strategy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateDeploymentStrategyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDeploymentStrategyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_deployment_strategy::CreateDeploymentStrategyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_deployment_strategy::CreateDeploymentStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_deployment_strategy::ser_create_deployment_strategy_input(&input)?);
...
#[derive(Debug)]
            struct CreateDeploymentStrategyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDeploymentStrategyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDeploymentStrategyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDeploymentStrategyInput>()
                        .ok_or("failed to downcast to CreateDeploymentStrategyInput")?;
...
pub enum CreateDeploymentStrategyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDeploymentStrategyError) for what information is available for the error.")]
...
impl CreateDeploymentStrategyError {
    /// Creates the `CreateDeploymentStrategyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDeploymentStrategyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateDeploymentStrategyError::ServiceQuotaExceededException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDeploymentStrategyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_deployment_strategy::CreateDeploymentStrategyError {
