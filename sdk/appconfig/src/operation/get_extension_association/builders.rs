...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_extension_association::GetExtensionAssociationOutput,
                    crate::operation::get_extension_association::GetExtensionAssociationError,
                > for GetExtensionAssociationFluentBuilder
            {
                fn send(
                    self,
...
impl GetExtensionAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_extension_association::GetExtensionAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_extension_association::GetExtensionAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_extension_association::GetExtensionAssociation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_extension_association::GetExtensionAssociation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_extension_association::GetExtensionAssociationOutput, crate::operation::get_extension_association::GetExtensionAssociationError, Self> {
