...
impl DeleteExtensionAssociationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_extension_association::DeleteExtensionAssociation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteExtensionAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_extension_association::de_delete_extension_association_http_response_with_props(status, headers, body)
        }
    }
}
