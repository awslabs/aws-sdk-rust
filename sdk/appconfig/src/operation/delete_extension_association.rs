...
impl DeleteExtensionAssociationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteExtensionAssociation`](crate::operation::delete_extension_association::DeleteExtensionAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_extension_association::DeleteExtensionAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_extension_association::DeleteExtensionAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_extension_association::DeleteExtensionAssociation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteExtensionAssociation", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteExtensionAssociation`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteExtensionAssociation {
                type Output = std::result::Result<crate::operation::delete_extension_association::DeleteExtensionAssociationOutput, crate::operation::delete_extension_association::DeleteExtensionAssociationError>;
