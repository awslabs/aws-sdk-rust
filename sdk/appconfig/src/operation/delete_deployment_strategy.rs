...
/// Orchestration and serialization glue logic for `DeleteDeploymentStrategy`.
...
impl DeleteDeploymentStrategy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyInput,
                    ) -> ::std::result::Result<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDeploymentStrategy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDeploymentStrategy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDeploymentStrategyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDeploymentStrategyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDeploymentStrategy")
...
.with_interceptor(DeleteDeploymentStrategyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError>::new());
...
#[derive(Debug)]
            struct DeleteDeploymentStrategyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDeploymentStrategyResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_deployment_strategy::de_delete_deployment_strategy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_deployment_strategy::de_delete_deployment_strategy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteDeploymentStrategyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDeploymentStrategyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/deployementstrategies/{DeploymentStrategyId}", DeploymentStrategyId = deployment_strategy_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteDeploymentStrategyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDeploymentStrategyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDeploymentStrategyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDeploymentStrategyInput>()
                        .ok_or("failed to downcast to DeleteDeploymentStrategyInput")?;
...
pub enum DeleteDeploymentStrategyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDeploymentStrategyError) for what information is available for the error.")]
...
impl DeleteDeploymentStrategyError {
    /// Creates the `DeleteDeploymentStrategyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDeploymentStrategyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDeploymentStrategyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_deployment_strategy::DeleteDeploymentStrategyError {
...
mod _delete_deployment_strategy_output;
