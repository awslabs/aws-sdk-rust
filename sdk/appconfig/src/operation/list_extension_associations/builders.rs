...
impl ListExtensionAssociationsFluentBuilder  {
    /// Creates a new `ListExtensionAssociations`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_extension_associations::ListExtensionAssociations, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_extension_associations::ListExtensionAssociationsOutput, aws_smithy_http::result::SdkError<crate::operation::list_extension_associations::ListExtensionAssociationsError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_extension_associations::paginator::ListExtensionAssociationsPaginator::send) which returns a `Stream`.
