...
pub use crate::operation::list_extension_associations::_list_extension_associations_output::ListExtensionAssociationsOutputBuilder;
...
pub struct ListExtensionAssociationsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_extension_associations::builders::ListExtensionAssociationsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_extension_associations::ListExtensionAssociationsOutput,
                    crate::operation::list_extension_associations::ListExtensionAssociationsError,
                > for ListExtensionAssociationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListExtensionAssociationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_extension_associations::ListExtensionAssociationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_extension_associations::ListExtensionAssociationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_extension_associations::ListExtensionAssociations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_extension_associations::ListExtensionAssociationsOutput, crate::operation::list_extension_associations::ListExtensionAssociationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_extension_associations::paginator::ListExtensionAssociationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_extension_associations::paginator::ListExtensionAssociationsPaginator {
                                crate::operation::list_extension_associations::paginator::ListExtensionAssociationsPaginator::new(self.handle, self.inner)
                            }
