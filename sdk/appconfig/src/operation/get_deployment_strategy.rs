...
/// Orchestration and serialization glue logic for `GetDeploymentStrategy`.
...
impl GetDeploymentStrategy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_deployment_strategy::GetDeploymentStrategyInput,
                    ) -> ::std::result::Result<crate::operation::get_deployment_strategy::GetDeploymentStrategyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_deployment_strategy::GetDeploymentStrategyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_deployment_strategy::GetDeploymentStrategyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_deployment_strategy::GetDeploymentStrategyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDeploymentStrategy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDeploymentStrategy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDeploymentStrategyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDeploymentStrategyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDeploymentStrategy")
...
.with_interceptor(GetDeploymentStrategyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_deployment_strategy::GetDeploymentStrategyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_deployment_strategy::GetDeploymentStrategyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_deployment_strategy::GetDeploymentStrategyError>::new());
...
#[derive(Debug)]
            struct GetDeploymentStrategyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDeploymentStrategyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_deployment_strategy::de_get_deployment_strategy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_deployment_strategy::de_get_deployment_strategy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDeploymentStrategyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDeploymentStrategyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_deployment_strategy::GetDeploymentStrategyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_deployment_strategy::GetDeploymentStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.deployment_strategy_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("deployment_strategy_id", "cannot be empty or unset"))?;
    let deployment_strategy_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if deployment_strategy_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("deployment_strategy_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/deploymentstrategies/{DeploymentStrategyId}", DeploymentStrategyId = deployment_strategy_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetDeploymentStrategyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDeploymentStrategyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDeploymentStrategyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDeploymentStrategyInput>()
                        .ok_or("failed to downcast to GetDeploymentStrategyInput")?;
...
pub enum GetDeploymentStrategyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDeploymentStrategyError) for what information is available for the error.")]
...
impl GetDeploymentStrategyError {
    /// Creates the `GetDeploymentStrategyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDeploymentStrategyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDeploymentStrategyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_deployment_strategy::GetDeploymentStrategyError {
...
mod _get_deployment_strategy_output;
