...
impl GetDeploymentStrategyInput {
    /// Consumes the builder and constructs an Operation<[`GetDeploymentStrategy`](crate::operation::get_deployment_strategy::GetDeploymentStrategy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_deployment_strategy::GetDeploymentStrategy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_deployment_strategy::GetDeploymentStrategyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.deployment_strategy_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("deployment_strategy_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_deployment_strategy::GetDeploymentStrategy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDeploymentStrategy", "appconfig"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDeploymentStrategy`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDeploymentStrategy {
                type Output = std::result::Result<crate::operation::get_deployment_strategy::GetDeploymentStrategyOutput, crate::operation::get_deployment_strategy::GetDeploymentStrategyError>;
