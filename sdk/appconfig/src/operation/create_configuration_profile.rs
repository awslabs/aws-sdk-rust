...
impl CreateConfigurationProfileInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_configuration_profile::CreateConfigurationProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConfigurationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_configuration_profile::de_create_configuration_profile_http_response_with_props(status, headers, body)
        }
    }
