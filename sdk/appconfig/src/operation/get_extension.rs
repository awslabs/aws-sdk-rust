...
impl GetExtensionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_extension::GetExtension::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExtension {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_extension::de_get_extension_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_extension::de_get_extension_http_response_with_props(
                status, headers, body,
            )
        }
    }
