...
pub fn de_create_hosted_configuration_version_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput, crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_hosted_configuration_version_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput, crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_kms_key_arn(
            crate::protocol_serde::shape_create_hosted_configuration_version_output::de_kms_key_arn_header(_response_headers)
                                        .map_err(|_|crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError::unhandled("Failed to parse KmsKeyArn from header `KmsKeyArn"))?
        );
        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("description", format!(
    ...
    if let ::std::option::Option::Some(inner_7) = &input.version_label {
        let formatted_8 = inner_7.as_str();
                        if !formatted_8.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("version_label", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
