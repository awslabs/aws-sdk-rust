        ...
        "BadRequestException" => {
            crate::operation::update_application::UpdateApplicationError::BadRequestException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output).map_err(crate::operation::update_application::UpdateApplicationError::unhandled)?;
