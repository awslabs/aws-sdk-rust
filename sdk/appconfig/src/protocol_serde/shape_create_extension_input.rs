...
pub fn ser_create_extension_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateExtensionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
