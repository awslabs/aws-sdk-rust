...
pub fn ser_update_configuration_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateConfigurationProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
