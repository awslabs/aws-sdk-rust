...
> {
    Ok({
        ...
        output = output.set_application_id(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_application_id_header(_response_headers) {
        ...
        output = output.set_configuration_profile_id(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_configuration_profile_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_content_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_description(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_description_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_kms_key_arn(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_kms_key_arn_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_version_label(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_version_label_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_version_number(
            match crate::protocol_serde::shape_get_hosted_configuration_version_output::de_version_number_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
