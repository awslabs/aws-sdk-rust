...
pub(crate) fn de_deployment_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeploymentSummary>, aws_smithy_json::deserialize::error::DeserializeError>
