...
pub fn ser_update_extension_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateExtensionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
