...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_deployment::GetDeploymentError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "AppliedExtensions" => {
                        builder = builder.set_applied_extensions(
                            crate::protocol_serde::shape_applied_extensions::de_applied_extensions(
                                tokens,
                            )?,
                        );
                    }
                    ...
                    "EventLog" => {
                        builder = builder.set_event_log(
                            crate::protocol_serde::shape_deployment_events::de_deployment_events(
                                tokens,
                            )?,
                        );
                    }
                    ...
                    "State" => {
                        builder = builder.set_state(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::DeploymentState::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
