...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_application_id): <p>The application ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_name): <p>A name for the environment.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_description): <p>A description of the environment.</p>
