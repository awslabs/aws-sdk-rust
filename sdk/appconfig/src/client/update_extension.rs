...
impl super::Client {
    ...
    ///   - [`extension_identifier(impl ::std::convert::Into<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::extension_identifier) / [`set_extension_identifier(Option<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_extension_identifier): <p>The name, the ID, or the Amazon Resource Name (ARN) of the extension.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_description): <p>Information about the extension.</p>
