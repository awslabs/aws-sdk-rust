...
impl super::Client {
    ...
    ///   - [`extension_identifier(impl Into<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::extension_identifier) / [`set_extension_identifier(Option<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_extension_identifier):<br>required: **true**<br><p>The name, the ID, or the Amazon Resource Name (ARN) of the extension.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_description):<br>required: **false**<br><p>Information about the extension.</p><br>
    ///   - [`actions(ActionPoint, Vec::<Action>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::actions) / [`set_actions(Option<HashMap::<ActionPoint, Vec::<Action>>>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_actions):<br>required: **false**<br><p>The actions defined in the extension.</p><br>
    ///   - [`parameters(impl Into<String>, Parameter)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::parameters) / [`set_parameters(Option<HashMap::<String, Parameter>>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_parameters):<br>required: **false**<br><p>One or more parameters for the actions called by the extension.</p><br>
    ///   - [`version_number(i32)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::version_number) / [`set_version_number(Option<i32>)`](crate::operation::update_extension::builders::UpdateExtensionFluentBuilder::set_version_number):<br>required: **false**<br><p>The extension version number.</p><br>
