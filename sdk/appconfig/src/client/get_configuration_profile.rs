...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::set_application_id): <p>The ID of the application that includes the configuration profile you want to get.</p>
    ///   - [`configuration_profile_id(impl ::std::convert::Into<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::configuration_profile_id) / [`set_configuration_profile_id(Option<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::set_configuration_profile_id): <p>The ID of the configuration profile that you want to get.</p>
