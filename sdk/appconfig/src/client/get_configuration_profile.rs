...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::set_application_id):<br>required: **true**<br><p>The ID of the application that includes the configuration profile you want to get.</p><br>
    ///   - [`configuration_profile_id(impl Into<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::configuration_profile_id) / [`set_configuration_profile_id(Option<String>)`](crate::operation::get_configuration_profile::builders::GetConfigurationProfileFluentBuilder::set_configuration_profile_id):<br>required: **true**<br><p>The ID of the configuration profile that you want to get.</p><br>
    ...
    ///   - [`kms_key_arn(Option<String>)`](crate::operation::get_configuration_profile::GetConfigurationProfileOutput::kms_key_arn): <p>The Amazon Resource Name of the Key Management Service key to encrypt new configuration data versions in the AppConfig hosted configuration store. This attribute is only used for <code>hosted</code> configuration types. To encrypt data managed in other configuration stores, see the documentation for how to specify an KMS key for that particular service.</p>
    ///   - [`kms_key_identifier(Option<String>)`](crate::operation::get_configuration_profile::GetConfigurationProfileOutput::kms_key_identifier): <p>The Key Management Service key identifier (key ID, key alias, or key ARN) provided when the resource was created or updated.</p>
