...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::delete_hosted_configuration_version::builders::DeleteHostedConfigurationVersionFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::delete_hosted_configuration_version::builders::DeleteHostedConfigurationVersionFluentBuilder::set_application_id): <p>The application ID.</p>
    ///   - [`configuration_profile_id(impl ::std::convert::Into<String>)`](crate::operation::delete_hosted_configuration_version::builders::DeleteHostedConfigurationVersionFluentBuilder::configuration_profile_id) / [`set_configuration_profile_id(Option<String>)`](crate::operation::delete_hosted_configuration_version::builders::DeleteHostedConfigurationVersionFluentBuilder::set_configuration_profile_id): <p>The configuration profile ID.</p>
