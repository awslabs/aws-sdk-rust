...
impl super::Client {
    ...
    ///   - [`allow_revert(bool)`](crate::operation::stop_deployment::builders::StopDeploymentFluentBuilder::allow_revert) / [`set_allow_revert(Option<bool>)`](crate::operation::stop_deployment::builders::StopDeploymentFluentBuilder::set_allow_revert):<br>required: **false**<br><p>A Boolean that enables AppConfig to rollback a <code>COMPLETED</code> deployment to the previous configuration version. This action moves the deployment to a status of <code>REVERTED</code>.</p><br>
