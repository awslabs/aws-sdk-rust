...
impl super::Client {
    ...
    ///   - [`version_label(impl Into<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::version_label) / [`set_version_label(Option<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::set_version_label): <p>An optional filter that can be used to specify the version label of an AppConfig hosted configuration version. This parameter supports filtering by prefix using a wildcard, for example "v2*". If you don't specify an asterisk at the end of the value, only an exact match is returned.</p>
