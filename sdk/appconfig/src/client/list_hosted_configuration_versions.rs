...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::set_application_id): <p>The application ID.</p>
    ///   - [`configuration_profile_id(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::configuration_profile_id) / [`set_configuration_profile_id(Option<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::set_configuration_profile_id): <p>The configuration profile ID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results. </p>
    ///   - [`version_label(impl ::std::convert::Into<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::version_label) / [`set_version_label(Option<String>)`](crate::operation::list_hosted_configuration_versions::builders::ListHostedConfigurationVersionsFluentBuilder::set_version_label): <p>An optional filter that can be used to specify the version label of an AppConfig hosted configuration version. This parameter supports filtering by prefix using a wildcard, for example "v2*". If you don't specify an asterisk at the end of the value, only an exact match is returned.</p>
