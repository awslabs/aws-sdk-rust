...
pub struct BadRequestException  {
    ...
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub reason: std::option::Option<crate::model::BadRequestReason>,
    /// <p>Detailed information about the input that failed to satisfy the constraints specified by a call.</p>
    #[doc(hidden)]pub details: std::option::Option<crate::model::BadRequestDetails>,
}
...
pub struct PayloadTooLargeException  {
    ...
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub measure: std::option::Option<crate::model::BytesMeasure>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub limit: f32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub size: f32,
}
