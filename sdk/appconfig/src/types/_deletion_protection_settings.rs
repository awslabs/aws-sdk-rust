...
/// <ul>
/// <li>
/// <p>Deletion protection is disabled by default.</p></li>
/// <li>
/// <p>The default interval specified by <code>ProtectionPeriodInMinutes</code> is 60.</p></li>
/// <li>
/// <p><code>DeletionProtectionCheck</code> skips configuration profiles and environments that were created in the past hour.</p></li>
/// </ul>
#[non_exhaustive]
