...
impl BadRequestDetails {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`InvalidConfiguration`](crate::model::BadRequestDetails::InvalidConfiguration), extracting the inner [`Vec`](std::vec::Vec).
...
pub struct InvalidConfigurationDetail  {
    ...
    #[doc(hidden)]pub constraint: std::option::Option<std::string::String>,
...
pub struct Monitor  {
    ...
    #[doc(hidden)]pub alarm_role_arn: std::option::Option<std::string::String>,
}
impl Monitor {
    /// <p>Amazon Resource Name (ARN) of the Amazon CloudWatch alarm.</p>
...
pub struct Validator  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ValidatorType>,
...
pub struct AppliedExtension  {
    ...
    #[doc(hidden)]pub extension_id: std::option::Option<std::string::String>,
    /// <p>The system-generated ID for the association.</p>
    #[doc(hidden)]pub extension_association_id: std::option::Option<std::string::String>,
...
pub struct DeploymentEvent  {
    ...
    #[doc(hidden)]pub event_type: std::option::Option<crate::model::DeploymentEventType>,
    ...
    #[doc(hidden)]pub triggered_by: std::option::Option<crate::model::TriggeredBy>,
    ...
    #[doc(hidden)]pub action_invocations: std::option::Option<std::vec::Vec<crate::model::ActionInvocation>>,
    /// <p>The date and time the event occurred.</p>
    #[doc(hidden)]pub occurred_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct ActionInvocation  {
    ...
    #[doc(hidden)]pub extension_identifier: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub invocation_id: std::option::Option<std::string::String>,
}
...
pub struct ConfigurationProfileSummary  {
    ...
    #[doc(hidden)]pub validator_types: std::option::Option<std::vec::Vec<crate::model::ValidatorType>>,
