...
impl super::Client {
    ...
    ///   - [`aggregation_period(Option<i64>)`](crate::operation::create_monitor::CreateMonitorOutput::aggregation_period): <p>The number of seconds that metrics are aggregated by and sent to Amazon CloudWatch. This must be either <code>30</code> or <code>60</code>.</p>
