...
pub fn ser_update_probe_input_input(
    ...
    if let Some(var_2) = &input.destination_port {
        object.key("destinationPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.packet_size {
        object.key("packetSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
