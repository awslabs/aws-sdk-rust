...
impl super::Client {
    ...
    ///   - [`app_instance_user_arn(impl Into<String>)`](crate::operation::describe_app_instance_user::builders::DescribeAppInstanceUserFluentBuilder::app_instance_user_arn) / [`set_app_instance_user_arn(Option<String>)`](crate::operation::describe_app_instance_user::builders::DescribeAppInstanceUserFluentBuilder::set_app_instance_user_arn):<br>required: **true**<br><p>The ARN of the <code>AppInstanceUser</code>.</p><br>
