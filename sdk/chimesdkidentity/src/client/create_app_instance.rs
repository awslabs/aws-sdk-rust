...
impl super::Client {
    ...
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::create_app_instance::builders::CreateAppInstanceFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_app_instance::builders::CreateAppInstanceFluentBuilder::set_client_request_token): <p>The unique ID of the request. Use different tokens to create different <code>AppInstances</code>.</p>
    ///   - [`tags(Tag)`](crate::operation::create_app_instance::builders::CreateAppInstanceFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_app_instance::builders::CreateAppInstanceFluentBuilder::set_tags): <p>Tags assigned to the <code>AppInstance</code>.</p>
