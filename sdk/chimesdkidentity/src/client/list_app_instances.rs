...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of <code>AppInstance</code>s that you want to return.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::set_next_token):<br>required: **false**<br><p>The token passed by previous API requests until you reach the maximum number of <code>AppInstances</code>.</p><br>
