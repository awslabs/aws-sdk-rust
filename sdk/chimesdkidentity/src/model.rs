...
pub struct EndpointAttributes  {
    ...
    #[doc(hidden)]pub device_token: std::option::Option<std::string::String>,
    /// <p>The VOIP device token for the APNS and APNS_SANDBOX endpoint types.</p>
    #[doc(hidden)]pub voip_device_token: std::option::Option<std::string::String>,
}
...
pub struct AppInstanceRetentionSettings  {
    ...
    #[doc(hidden)]pub channel_retention_settings: std::option::Option<crate::model::ChannelRetentionSettings>,
}
...
impl  std::fmt::Debug for AppInstanceRetentionSettings  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("channel_retention_settings", &self.channel_retention_settings);
        formatter.finish()
    }
}
...
pub struct ChannelRetentionSettings  {
    ...
    #[doc(hidden)]pub retention_days: std::option::Option<i32>,
}
...
pub struct AppInstanceUserEndpointSummary  {
    ...
    #[doc(hidden)]pub endpoint_state: std::option::Option<crate::model::EndpointState>,
}
...
pub struct EndpointState  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::EndpointStatus>,
    /// <p>The reason for the <code>EndpointStatus</code>.</p>
    #[doc(hidden)]pub status_reason: std::option::Option<crate::model::EndpointStatusReason>,
}
impl EndpointState {
    /// <p>Enum that indicates the Status of an <code>AppInstanceUserEndpoint</code>.</p>
...
pub struct AppInstanceAdminSummary  {
    ...
    #[doc(hidden)]pub admin: std::option::Option<crate::model::Identity>,
}
