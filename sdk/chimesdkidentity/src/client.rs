...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_chimesdkidentity::Error> {
/// # let client: aws_sdk_chimesdkidentity::Client = unimplemented!();
...
mod update_app_instance_user_endpoint;
