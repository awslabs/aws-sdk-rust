...
pub struct PutAppInstanceRetentionSettingsOutput {
    ...
    pub initiate_deletion_timestamp: std::option::Option<smithy_types::Instant>,
}
...
pub mod put_app_instance_retention_settings_output {
    ...
    pub struct Builder {
        pub(crate) app_instance_retention_settings:
            std::option::Option<crate::model::AppInstanceRetentionSettings>,
        pub(crate) initiate_deletion_timestamp: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The time in days to retain data. Data type: number.</p>
        ...
        /// <p>The time at which the API deletes data.</p>
        pub fn initiate_deletion_timestamp(mut self, input: smithy_types::Instant) -> Self {
