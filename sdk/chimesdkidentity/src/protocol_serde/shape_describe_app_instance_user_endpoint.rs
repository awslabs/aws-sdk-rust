...
pub fn de_describe_app_instance_user_endpoint_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAppInstanceUserEndpointOutput, crate::error::DescribeAppInstanceUserEndpointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeAppInstanceUserEndpointError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_app_instance_user_endpoint_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAppInstanceUserEndpointOutput, crate::error::DescribeAppInstanceUserEndpointError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_app_instance_user_endpoint(value: &[u8], mut builder: crate::output::describe_app_instance_user_endpoint_output::Builder) -> Result<crate::output::describe_app_instance_user_endpoint_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
