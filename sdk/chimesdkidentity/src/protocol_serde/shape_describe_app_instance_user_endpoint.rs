...
pub fn de_describe_app_instance_user_endpoint_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointOutput, crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_app_instance_user_endpoint_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointOutput, crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError> {
    Ok({
        #[allow(unused_mut)]
