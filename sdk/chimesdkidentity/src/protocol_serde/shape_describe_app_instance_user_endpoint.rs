...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ServiceFailureException" => {
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottledClientException" => {
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::ThrottledClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedClientException" => {
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::UnauthorizedClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_app_instance_user_endpoint::de_describe_app_instance_user_endpoint(_response_body, output)
            .map_err(crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError::unhandled)?;
...
pub(crate) fn de_describe_app_instance_user_endpoint(
    _value: &[u8],
    mut builder: crate::operation::describe_app_instance_user_endpoint::builders::DescribeAppInstanceUserEndpointOutputBuilder,
) -> ::std::result::Result<
    crate::operation::describe_app_instance_user_endpoint::builders::DescribeAppInstanceUserEndpointOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AppInstanceUserEndpoint" => {
                    builder = builder.set_app_instance_user_endpoint(
                        crate::protocol_serde::shape_app_instance_user_endpoint::de_app_instance_user_endpoint(tokens, _value, depth + 1)?,
                    );
                }
