...
pub fn ser_create_app_instance_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_app_instance_user::CreateAppInstanceUserInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
