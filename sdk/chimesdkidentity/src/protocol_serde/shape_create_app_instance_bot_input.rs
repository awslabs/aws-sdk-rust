...
pub fn ser_create_app_instance_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_app_instance_bot::CreateAppInstanceBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
