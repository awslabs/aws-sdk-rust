...
impl Builder {
    ...
    /// use aws_sdk_chimesdkidentity::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_chimesdkidentity::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
