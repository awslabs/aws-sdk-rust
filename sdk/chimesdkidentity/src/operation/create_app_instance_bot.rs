    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_instance_bot::CreateAppInstanceBotError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_instance_bot::CreateAppInstanceBotOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAppInstanceBot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateAppInstanceBot", "chimesdkidentity"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAppInstanceBot")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateAppInstanceBotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateAppInstanceBotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_instance_bot::CreateAppInstanceBotInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_app_instance_bot::ser_create_app_instance_bot_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateAppInstanceBotEndpointParamsInterceptor {
...
pub type CreateAppInstanceBotErrorKind = CreateAppInstanceBotError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateAppInstanceBotError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_app_instance_bot::CreateAppInstanceBotError {
...
impl CreateAppInstanceBotError {
    ...
    /// Creates the `CreateAppInstanceBotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
