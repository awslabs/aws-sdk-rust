    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_instance_bot::UpdateAppInstanceBotError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_instance_bot::UpdateAppInstanceBotOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateAppInstanceBotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateAppInstanceBotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_app_instance_bot::UpdateAppInstanceBotInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_app_instance_bot::ser_update_app_instance_bot_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateAppInstanceBotEndpointParamsInterceptor {
...
pub type UpdateAppInstanceBotErrorKind = UpdateAppInstanceBotError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateAppInstanceBotError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_app_instance_bot::UpdateAppInstanceBotError {
...
impl UpdateAppInstanceBotError {
    ...
    /// Creates the `UpdateAppInstanceBotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
