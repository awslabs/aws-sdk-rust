...
impl DescribeAppInstanceUserEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpoint,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAppInstanceUserEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_app_instance_user_endpoint::de_describe_app_instance_user_endpoint_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointError
{
