...
impl DescribeAppInstanceUserEndpointInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAppInstanceUserEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_app_instance_user_endpoint::de_describe_app_instance_user_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
