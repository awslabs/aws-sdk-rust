...
impl DeregisterAppInstanceUserEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpoint,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterAppInstanceUserEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_deregister_app_instance_user_endpoint::de_deregister_app_instance_user_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
