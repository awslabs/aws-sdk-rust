...
/// Orchestration and serialization glue logic for `DeregisterAppInstanceUserEndpoint`.
...
impl DeregisterAppInstanceUserEndpoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointInput,
                    ) -> ::std::result::Result<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterAppInstanceUserEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeregisterAppInstanceUserEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeregisterAppInstanceUserEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeregisterAppInstanceUserEndpointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterAppInstanceUserEndpoint")
...
.with_interceptor(DeregisterAppInstanceUserEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError>::new());
...
#[derive(Debug)]
            struct DeregisterAppInstanceUserEndpointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterAppInstanceUserEndpointResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_deregister_app_instance_user_endpoint::de_deregister_app_instance_user_endpoint_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_deregister_app_instance_user_endpoint::de_deregister_app_instance_user_endpoint_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeregisterAppInstanceUserEndpointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterAppInstanceUserEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_id", "cannot be empty or unset"))?;
    let endpoint_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if endpoint_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/app-instance-users/{AppInstanceUserArn}/endpoints/{EndpointId}", AppInstanceUserArn = app_instance_user_arn, EndpointId = endpoint_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeregisterAppInstanceUserEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterAppInstanceUserEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeregisterAppInstanceUserEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeregisterAppInstanceUserEndpointInput>()
                        .ok_or("failed to downcast to DeregisterAppInstanceUserEndpointInput")?;
...
pub enum DeregisterAppInstanceUserEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeregisterAppInstanceUserEndpointError) for what information is available for the error.")]
...
impl DeregisterAppInstanceUserEndpointError {
    /// Creates the `DeregisterAppInstanceUserEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeregisterAppInstanceUserEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeregisterAppInstanceUserEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError {
...
mod _deregister_app_instance_user_endpoint_output;
