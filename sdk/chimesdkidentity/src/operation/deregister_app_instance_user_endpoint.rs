...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeregisterAppInstanceUserEndpointResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeregisterAppInstanceUserEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("endpoint_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeregisterAppInstanceUserEndpointEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_app_instance_user_endpoint::DeregisterAppInstanceUserEndpointError {
