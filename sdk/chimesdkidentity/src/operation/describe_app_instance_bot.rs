    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let app_instance_bot_arn = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_app_instance_bot::DescribeAppInstanceBot::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_app_instance_bot::DescribeAppInstanceBotError
{
