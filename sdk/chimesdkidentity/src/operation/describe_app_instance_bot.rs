    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeAppInstanceBotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeAppInstanceBotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("app_instance_bot_arn", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAppInstanceBotEndpointParamsInterceptor {
...
pub type DescribeAppInstanceBotErrorKind = DescribeAppInstanceBotError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeAppInstanceBotError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_app_instance_bot::DescribeAppInstanceBotError {
...
impl DescribeAppInstanceBotError {
    ...
    /// Creates the `DescribeAppInstanceBotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
