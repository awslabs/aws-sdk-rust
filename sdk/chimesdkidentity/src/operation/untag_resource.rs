...
impl UntagResource {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "Chime SDK Identity.UntagResource",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime SDK Identity", "UntagResource", input, runtime_plugins, stop_point)
            .await
    }
