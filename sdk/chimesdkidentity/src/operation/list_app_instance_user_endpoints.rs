...
impl ListAppInstanceUserEndpoints {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsInput,
                    ) -> ::std::result::Result<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAppInstanceUserEndpoints {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAppInstanceUserEndpoints");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAppInstanceUserEndpointsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAppInstanceUserEndpointsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAppInstanceUserEndpoints")
...
.with_interceptor(ListAppInstanceUserEndpointsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError>::new());
...
#[derive(Debug)]
            struct ListAppInstanceUserEndpointsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAppInstanceUserEndpointsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_app_instance_user_endpoints::de_list_app_instance_user_endpoints_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_app_instance_user_endpoints::de_list_app_instance_user_endpoints_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAppInstanceUserEndpointsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAppInstanceUserEndpointsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListAppInstanceUserEndpointsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAppInstanceUserEndpointsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAppInstanceUserEndpointsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAppInstanceUserEndpointsInput>()
                        .ok_or("failed to downcast to ListAppInstanceUserEndpointsInput")?;
...
pub enum ListAppInstanceUserEndpointsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAppInstanceUserEndpointsError) for what information is available for the error.")]
...
impl ListAppInstanceUserEndpointsError {
    /// Creates the `ListAppInstanceUserEndpointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAppInstanceUserEndpointsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAppInstanceUserEndpointsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_app_instance_user_endpoints::_list_app_instance_user_endpoints_output::ListAppInstanceUserEndpointsOutput;

pub use crate::operation::list_app_instance_user_endpoints::_list_app_instance_user_endpoints_input::ListAppInstanceUserEndpointsInput;

mod _list_app_instance_user_endpoints_input;

mod _list_app_instance_user_endpoints_output;
