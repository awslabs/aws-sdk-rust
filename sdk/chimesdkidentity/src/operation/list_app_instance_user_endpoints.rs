...
impl ListAppInstanceUserEndpointsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpoints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAppInstanceUserEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_app_instance_user_endpoints::de_list_app_instance_user_endpoints_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListAppInstanceUserEndpointsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_app_instance_user_endpoints::ListAppInstanceUserEndpointsError
{
