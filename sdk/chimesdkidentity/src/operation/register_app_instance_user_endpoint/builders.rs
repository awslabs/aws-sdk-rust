...
impl crate::operation::register_app_instance_user_endpoint::builders::RegisterAppInstanceUserEndpointInputBuilder {
...
impl RegisterAppInstanceUserEndpointFluentBuilder {
    /// Creates a new `RegisterAppInstanceUserEndpointFluentBuilder`.
