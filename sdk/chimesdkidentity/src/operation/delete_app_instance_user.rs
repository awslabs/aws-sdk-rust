...
/// Orchestration and serialization glue logic for `DeleteAppInstanceUser`.
...
impl DeleteAppInstanceUser {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_app_instance_user::DeleteAppInstanceUserInput,
                    ) -> ::std::result::Result<crate::operation::delete_app_instance_user::DeleteAppInstanceUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_app_instance_user::DeleteAppInstanceUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAppInstanceUser {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAppInstanceUser");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAppInstanceUserRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAppInstanceUserResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAppInstanceUser")
...
.with_interceptor(DeleteAppInstanceUserEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserError>::new());
...
#[derive(Debug)]
            struct DeleteAppInstanceUserResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAppInstanceUserResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_app_instance_user::de_delete_app_instance_user_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_app_instance_user::de_delete_app_instance_user_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteAppInstanceUserRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAppInstanceUserRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_app_instance_user::DeleteAppInstanceUserInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_app_instance_user::DeleteAppInstanceUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteAppInstanceUserEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAppInstanceUserEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAppInstanceUserEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAppInstanceUserInput>()
                        .ok_or("failed to downcast to DeleteAppInstanceUserInput")?;
...
pub enum DeleteAppInstanceUserError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAppInstanceUserError) for what information is available for the error.")]
...
impl DeleteAppInstanceUserError {
    /// Creates the `DeleteAppInstanceUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAppInstanceUserError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAppInstanceUserError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_app_instance_user::DeleteAppInstanceUserError {
...
mod _delete_app_instance_user_output;
