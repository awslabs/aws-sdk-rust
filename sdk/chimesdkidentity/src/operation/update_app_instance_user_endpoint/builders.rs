...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointOutput,
                    crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointError,
                > for UpdateAppInstanceUserEndpointFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateAppInstanceUserEndpointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpoint::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpoint::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointOutput, crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointError, Self> {
