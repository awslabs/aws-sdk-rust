...
impl UpdateAppInstanceUserEndpointInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAppInstanceUserEndpoint`](crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAppInstanceUserEndpoint {
                type Output = std::result::Result<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointOutput, crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointError>;
