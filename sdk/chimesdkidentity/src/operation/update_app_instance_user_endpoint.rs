...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAppInstanceUserEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_app_instance_user_endpoint::de_update_app_instance_user_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointError
{
