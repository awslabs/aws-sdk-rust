...
impl RegisterAppInstanceUserEndpointInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_app_instance_user_endpoint::RegisterAppInstanceUserEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterAppInstanceUserEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_register_app_instance_user_endpoint::de_register_app_instance_user_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
