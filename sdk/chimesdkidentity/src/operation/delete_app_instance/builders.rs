...
impl DeleteAppInstanceFluentBuilder  {
    /// Creates a new `DeleteAppInstance`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_app_instance::DeleteAppInstanceOutput, aws_smithy_http::result::SdkError<crate::operation::delete_app_instance::DeleteAppInstanceError>>
                     {
