...
impl PutAppInstanceRetentionSettings {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutAppInstanceRetentionSettingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutAppInstanceRetentionSettingsRequestSerializer {
