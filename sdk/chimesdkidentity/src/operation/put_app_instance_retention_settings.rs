...
/// Orchestration and serialization glue logic for `PutAppInstanceRetentionSettings`.
...
impl PutAppInstanceRetentionSettings {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAppInstanceRetentionSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutAppInstanceRetentionSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutAppInstanceRetentionSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutAppInstanceRetentionSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutAppInstanceRetentionSettings")
...
.with_interceptor(PutAppInstanceRetentionSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError>::new());
...
#[derive(Debug)]
            struct PutAppInstanceRetentionSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutAppInstanceRetentionSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_app_instance_retention_settings::de_put_app_instance_retention_settings_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutAppInstanceRetentionSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutAppInstanceRetentionSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/app-instances/{AppInstanceArn}/retention-settings", AppInstanceArn = app_instance_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_app_instance_retention_settings::ser_put_app_instance_retention_settings_input(&input)?);
...
#[derive(Debug)]
            struct PutAppInstanceRetentionSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutAppInstanceRetentionSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutAppInstanceRetentionSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutAppInstanceRetentionSettingsInput>()
                        .ok_or("failed to downcast to PutAppInstanceRetentionSettingsInput")?;
...
pub enum PutAppInstanceRetentionSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutAppInstanceRetentionSettingsError) for what information is available for the error.")]
...
impl PutAppInstanceRetentionSettingsError {
    /// Creates the `PutAppInstanceRetentionSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutAppInstanceRetentionSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutAppInstanceRetentionSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_app_instance_retention_settings::_put_app_instance_retention_settings_output::PutAppInstanceRetentionSettingsOutput;

pub use crate::operation::put_app_instance_retention_settings::_put_app_instance_retention_settings_input::PutAppInstanceRetentionSettingsInput;

mod _put_app_instance_retention_settings_input;

mod _put_app_instance_retention_settings_output;
