...
impl PutAppInstanceRetentionSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppInstanceRetentionSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_app_instance_retention_settings::de_put_app_instance_retention_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
