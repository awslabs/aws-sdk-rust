...
impl PutAppInstanceRetentionSettingsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.put_app_instance_retention_settings();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput,
                    crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError,
                > for PutAppInstanceRetentionSettingsFluentBuilder
            {
                fn send(
                    self,
...
impl PutAppInstanceRetentionSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettings::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettings::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsOutput, crate::operation::put_app_instance_retention_settings::PutAppInstanceRetentionSettingsError, Self> {
