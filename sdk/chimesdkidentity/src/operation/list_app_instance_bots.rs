    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_app_instance_bots::ListAppInstanceBotsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_app_instance_bots::ListAppInstanceBotsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAppInstanceBots {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListAppInstanceBots", "chimesdkidentity"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAppInstanceBots")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListAppInstanceBotsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListAppInstanceBotsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListAppInstanceBotsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_app_instance_bots::ListAppInstanceBotsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListAppInstanceBotsEndpointParamsInterceptor {
...
pub type ListAppInstanceBotsErrorKind = ListAppInstanceBotsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListAppInstanceBotsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_app_instance_bots::ListAppInstanceBotsError {
...
impl ListAppInstanceBotsError {
    ...
    /// Creates the `ListAppInstanceBotsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
