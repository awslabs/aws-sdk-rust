...
/// Orchestration and serialization glue logic for `DescribeAppInstanceAdmin`.
...
impl DescribeAppInstanceAdmin {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminInput,
                    ) -> ::std::result::Result<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAppInstanceAdmin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAppInstanceAdmin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAppInstanceAdminRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAppInstanceAdminResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAppInstanceAdmin")
...
.with_interceptor(DescribeAppInstanceAdminEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError>::new());
...
#[derive(Debug)]
            struct DescribeAppInstanceAdminResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAppInstanceAdminResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_app_instance_admin::de_describe_app_instance_admin_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_app_instance_admin::de_describe_app_instance_admin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeAppInstanceAdminRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAppInstanceAdminRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.app_instance_admin_arn;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("app_instance_admin_arn", "cannot be empty or unset"))?;
    let app_instance_admin_arn = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if app_instance_admin_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("app_instance_admin_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/app-instances/{AppInstanceArn}/admins/{AppInstanceAdminArn}", AppInstanceArn = app_instance_arn, AppInstanceAdminArn = app_instance_admin_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeAppInstanceAdminEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAppInstanceAdminEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAppInstanceAdminEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAppInstanceAdminInput>()
                        .ok_or("failed to downcast to DescribeAppInstanceAdminInput")?;
...
pub enum DescribeAppInstanceAdminError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAppInstanceAdminError) for what information is available for the error.")]
...
impl DescribeAppInstanceAdminError {
    /// Creates the `DescribeAppInstanceAdminError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAppInstanceAdminError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAppInstanceAdminError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminError {
...
mod _describe_app_instance_admin_output;
