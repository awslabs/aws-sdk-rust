...
impl DescribeAppInstanceAdminInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_app_instance_admin::DescribeAppInstanceAdmin::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAppInstanceAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_app_instance_admin::de_describe_app_instance_admin_http_response_with_props(status, headers, body)
        }
    }
