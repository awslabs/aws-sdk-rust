    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_app_instance_bot::DeleteAppInstanceBotError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_app_instance_bot::DeleteAppInstanceBotOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteAppInstanceBotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteAppInstanceBotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_app_instance_bot::DeleteAppInstanceBotInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteAppInstanceBotEndpointParamsInterceptor {
...
pub type DeleteAppInstanceBotErrorKind = DeleteAppInstanceBotError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteAppInstanceBotError {
...
impl DeleteAppInstanceBotError {
    ...
    /// Creates the `DeleteAppInstanceBotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
