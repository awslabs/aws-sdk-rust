...
impl DescribeAppInstanceFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_app_instance::DescribeAppInstanceOutput, aws_smithy_http::result::SdkError<crate::operation::describe_app_instance::DescribeAppInstanceError>>
                     {
