...
/// Orchestration and serialization glue logic for `CreateAppInstanceUser`.
...
impl CreateAppInstanceUser {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_app_instance_user::CreateAppInstanceUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_app_instance_user::CreateAppInstanceUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_app_instance_user::CreateAppInstanceUserError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_app_instance_user::CreateAppInstanceUserOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_app_instance_user::CreateAppInstanceUserInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAppInstanceUser {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAppInstanceUser");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateAppInstanceUserRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateAppInstanceUserResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAppInstanceUser")
...
.with_interceptor(CreateAppInstanceUserEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_app_instance_user::CreateAppInstanceUserError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_app_instance_user::CreateAppInstanceUserError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_app_instance_user::CreateAppInstanceUserError>::new());
...
#[derive(Debug)]
            struct CreateAppInstanceUserResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAppInstanceUserResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_app_instance_user::de_create_app_instance_user_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_app_instance_user::de_create_app_instance_user_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateAppInstanceUserRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAppInstanceUserRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_app_instance_user::CreateAppInstanceUserInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_app_instance_user::CreateAppInstanceUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_app_instance_user::ser_create_app_instance_user_input(&input)?);
...
#[derive(Debug)]
            struct CreateAppInstanceUserEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAppInstanceUserEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateAppInstanceUserEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateAppInstanceUserInput>()
                        .ok_or("failed to downcast to CreateAppInstanceUserInput")?;
...
pub enum CreateAppInstanceUserError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAppInstanceUserError) for what information is available for the error.")]
...
impl CreateAppInstanceUserError {
    /// Creates the `CreateAppInstanceUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAppInstanceUserError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAppInstanceUserError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_app_instance_user::CreateAppInstanceUserError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_app_instance_user::_create_app_instance_user_output::CreateAppInstanceUserOutput;

pub use crate::operation::create_app_instance_user::_create_app_instance_user_input::CreateAppInstanceUserInput;

mod _create_app_instance_user_input;

mod _create_app_instance_user_output;
