...
/// Orchestration and serialization glue logic for `DeleteAppInstanceAdmin`.
...
impl DeleteAppInstanceAdmin {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminInput,
                    ) -> ::std::result::Result<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAppInstanceAdmin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAppInstanceAdmin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAppInstanceAdminRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAppInstanceAdminResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAppInstanceAdmin")
...
.with_interceptor(DeleteAppInstanceAdminEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError>::new());
...
#[derive(Debug)]
            struct DeleteAppInstanceAdminResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAppInstanceAdminResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_app_instance_admin::de_delete_app_instance_admin_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_app_instance_admin::de_delete_app_instance_admin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteAppInstanceAdminRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAppInstanceAdminRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteAppInstanceAdminEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAppInstanceAdminEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAppInstanceAdminEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAppInstanceAdminInput>()
                        .ok_or("failed to downcast to DeleteAppInstanceAdminInput")?;
...
pub enum DeleteAppInstanceAdminError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAppInstanceAdminError) for what information is available for the error.")]
...
impl DeleteAppInstanceAdminError {
    /// Creates the `DeleteAppInstanceAdminError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAppInstanceAdminError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAppInstanceAdminError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_app_instance_admin::_delete_app_instance_admin_output::DeleteAppInstanceAdminOutput;

pub use crate::operation::delete_app_instance_admin::_delete_app_instance_admin_input::DeleteAppInstanceAdminInput;

mod _delete_app_instance_admin_input;

mod _delete_app_instance_admin_output;
