...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminOutput,
                    crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError,
                > for DeleteAppInstanceAdminFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteAppInstanceAdminFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_app_instance_admin::builders::DeleteAppInstanceAdminInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_app_instance_admin::DeleteAppInstanceAdmin::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_app_instance_admin::DeleteAppInstanceAdmin::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminOutput, crate::operation::delete_app_instance_admin::DeleteAppInstanceAdminError, Self> {
