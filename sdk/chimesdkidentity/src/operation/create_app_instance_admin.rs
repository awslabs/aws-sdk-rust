...
/// Orchestration and serialization glue logic for `CreateAppInstanceAdmin`.
...
impl CreateAppInstanceAdmin {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_app_instance_admin::CreateAppInstanceAdminOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAppInstanceAdmin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAppInstanceAdmin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateAppInstanceAdminRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateAppInstanceAdminResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAppInstanceAdmin")
...
.with_interceptor(CreateAppInstanceAdminEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError>::new());
...
#[derive(Debug)]
            struct CreateAppInstanceAdminResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAppInstanceAdminResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_app_instance_admin::de_create_app_instance_admin_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_app_instance_admin::de_create_app_instance_admin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateAppInstanceAdminRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAppInstanceAdminRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_app_instance_admin::CreateAppInstanceAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_app_instance_admin::ser_create_app_instance_admin_input(&input)?);
...
#[derive(Debug)]
            struct CreateAppInstanceAdminEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAppInstanceAdminEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateAppInstanceAdminEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateAppInstanceAdminInput>()
                        .ok_or("failed to downcast to CreateAppInstanceAdminInput")?;
...
pub enum CreateAppInstanceAdminError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAppInstanceAdminError) for what information is available for the error.")]
...
impl CreateAppInstanceAdminError {
    /// Creates the `CreateAppInstanceAdminError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAppInstanceAdminError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAppInstanceAdminError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_app_instance_admin::CreateAppInstanceAdminError {
...
mod _create_app_instance_admin_output;
