...
impl CreateAppInstanceAdmin {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Identity.CreateAppInstanceAdmin",
            "rpc.service" = "Chime SDK Identity",
            "rpc.method" = "CreateAppInstanceAdmin",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAppInstanceAdmin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateAppInstanceAdminRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateAppInstanceAdminResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateAppInstanceAdmin")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAppInstanceAdmin")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateAppInstanceAdminTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateAppInstanceAdminTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAppInstanceAdminTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateAppInstanceAdminInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAppInstanceAdminResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_app_instance_admin::de_create_app_instance_admin_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_app_instance_admin::de_create_app_instance_admin_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAppInstanceAdminRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_app_instance_admin::CreateAppInstanceAdminInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_app_instance_admin::CreateAppInstanceAdminInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_app_instance_admin::ser_create_app_instance_admin_input(&input)?,
        );
