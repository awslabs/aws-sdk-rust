...
/// Orchestration and serialization glue logic for `ListAppInstanceAdmins`.
...
impl ListAppInstanceAdmins {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput,
                    ) -> ::std::result::Result<crate::operation::list_app_instance_admins::ListAppInstanceAdminsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_app_instance_admins::ListAppInstanceAdminsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAppInstanceAdmins {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAppInstanceAdmins");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAppInstanceAdminsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAppInstanceAdminsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAppInstanceAdmins")
...
.with_interceptor(ListAppInstanceAdminsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsError>::new());
...
#[derive(Debug)]
            struct ListAppInstanceAdminsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAppInstanceAdminsResponseDeserializer {
...
#[derive(Debug)]
            struct ListAppInstanceAdminsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAppInstanceAdminsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.app_instance_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("app_instance_arn", "cannot be empty or unset"))?;
    ...
    if app_instance_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("app_instance_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/app-instances/{AppInstanceArn}/admins", AppInstanceArn = app_instance_arn).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListAppInstanceAdminsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAppInstanceAdminsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAppInstanceAdminsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAppInstanceAdminsInput>()
                        .ok_or("failed to downcast to ListAppInstanceAdminsInput")?;
...
pub enum ListAppInstanceAdminsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAppInstanceAdminsError) for what information is available for the error.")]
...
impl ListAppInstanceAdminsError {
    /// Creates the `ListAppInstanceAdminsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAppInstanceAdminsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAppInstanceAdminsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_app_instance_admins::ListAppInstanceAdminsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_app_instance_admins::_list_app_instance_admins_output::ListAppInstanceAdminsOutput;

pub use crate::operation::list_app_instance_admins::_list_app_instance_admins_input::ListAppInstanceAdminsInput;

mod _list_app_instance_admins_input;

mod _list_app_instance_admins_output;
