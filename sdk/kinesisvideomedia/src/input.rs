...
pub mod get_media_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetMediaInput, aws_smithy_http::operation::BuildError> {
            Ok(
                crate::input::GetMediaInput {
...
impl GetMediaInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetMedia, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetMediaInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetMedia::new())
...
pub struct GetMediaInput  {
    ...
    /// <p>Identifies the starting chunk to get from the specified stream. </p>
    #[doc(hidden)]pub start_selector: std::option::Option<crate::model::StartSelector>,
}
impl GetMediaInput {
    /// <p>The Kinesis video stream name from where you want to get the media content. If you don't specify the <code>streamName</code>, you must specify the <code>streamARN</code>.</p>
