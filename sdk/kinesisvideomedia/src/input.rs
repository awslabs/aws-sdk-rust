...
pub mod get_media_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetMediaInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl GetMediaInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetMedia, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::GetMediaInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
