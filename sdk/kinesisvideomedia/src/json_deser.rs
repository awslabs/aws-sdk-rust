...
pub(crate) fn deser_structure_crate_error_connection_limit_exceeded_exception_json_err(
    value: &[u8],
...
pub(crate) fn deser_structure_crate_error_invalid_endpoint_exception_json_err(
    value: &[u8],
