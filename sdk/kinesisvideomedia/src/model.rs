...
pub struct StartSelector  {
    ...
    /// </note>
    #[doc(hidden)]pub start_selector_type: std::option::Option<crate::model::StartSelectorType>,
    /// <p>Specifies the fragment number from where you want the <code>GetMedia</code> API to start returning the fragments. </p>
    #[doc(hidden)]pub after_fragment_number: std::option::Option<std::string::String>,
