...
impl Builder {
    ...
    /// use aws_sdk_kinesisvideomedia::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_kinesisvideomedia::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
