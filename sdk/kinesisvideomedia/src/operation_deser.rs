...
#[allow(clippy::unnecessary_wraps)]pub fn parse_get_media(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::output::GetMediaOutput, crate::error::GetMediaError> {
    #[allow(unused_variables)]let (response, properties) = op_response.parts_mut();
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::get_media_output::Builder::default();
        let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_get_media_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetMediaOutput, crate::error::GetMediaError> {
    ...
    Err(match error_code {
        ...
        "ConnectionLimitExceededException" => crate::error::GetMediaError { meta: generic, kind: crate::error::GetMediaErrorKind::ConnectionLimitExceededException({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::connection_limit_exceeded_exception::Builder::default();
                    let _ = response;
