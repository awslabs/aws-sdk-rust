...
pub struct ListStreamsOutput  {
    ...
    #[doc(hidden)]pub stream_info_list: std::option::Option<std::vec::Vec<crate::model::StreamInfo>>,
...
pub struct ListSignalingChannelsOutput  {
    ...
    #[doc(hidden)]pub channel_info_list: std::option::Option<std::vec::Vec<crate::model::ChannelInfo>>,
    /// <p>If the response is truncated, the call returns this element with a token. To get the next batch of streams, use this token in your next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetSignalingChannelEndpointOutput  {
    ...
    #[doc(hidden)]pub resource_endpoint_list: std::option::Option<std::vec::Vec<crate::model::ResourceEndpointListItem>>,
}
...
pub struct GetDataEndpointOutput  {
    ...
    #[doc(hidden)]pub data_endpoint: std::option::Option<std::string::String>,
}
...
pub struct DescribeSignalingChannelOutput  {
    ...
    #[doc(hidden)]pub channel_info: std::option::Option<crate::model::ChannelInfo>,
}
...
pub struct DescribeImageGenerationConfigurationOutput  {
    ...
    #[doc(hidden)]pub image_generation_configuration: std::option::Option<crate::model::ImageGenerationConfiguration>,
}
...
impl  std::fmt::Debug for DescribeImageGenerationConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("image_generation_configuration", &self.image_generation_configuration);
        formatter.finish()
    }
}
