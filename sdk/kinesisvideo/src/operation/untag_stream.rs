...
impl UntagStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::untag_stream::UntagStream,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_stream::UntagStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_untag_stream::de_untag_stream_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_untag_stream::de_untag_stream_http_response_with_props(
                status, headers, body,
            )
        }
    }
