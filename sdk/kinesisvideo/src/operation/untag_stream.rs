...
impl UntagStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag_stream::UntagStream, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_untag_stream::ser_untag_stream_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_stream::de_untag_stream_http_response_with_props(status, headers, body)
        }
    }
}
