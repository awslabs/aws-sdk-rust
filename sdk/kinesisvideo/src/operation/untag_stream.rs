...
impl UntagStreamInput {
    /// Consumes the builder and constructs an Operation<[`UntagStream`](crate::operation::untag_stream::UntagStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_stream::UntagStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_stream::UntagStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_stream::ser_untag_stream_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_stream::UntagStream::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UntagStream {
                type Output = std::result::Result<crate::operation::untag_stream::UntagStreamOutput, crate::operation::untag_stream::UntagStreamError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_untag_stream::de_untag_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_untag_stream::de_untag_stream_http_response(response)
                     }
                }
            }
