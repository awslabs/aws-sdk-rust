...
impl UpdateDataRetentionInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_data_retention::ser_update_data_retention_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_retention::UpdateDataRetention::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDataRetention {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_data_retention::de_update_data_retention_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::update_data_retention::UpdateDataRetentionError
{
