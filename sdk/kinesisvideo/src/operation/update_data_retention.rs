...
impl UpdateDataRetentionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDataRetention`](crate::operation::update_data_retention::UpdateDataRetention)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_data_retention::UpdateDataRetention, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_data_retention::UpdateDataRetentionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_data_retention::ser_update_data_retention_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_data_retention::UpdateDataRetention::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDataRetention {
                type Output = std::result::Result<crate::operation::update_data_retention::UpdateDataRetentionOutput, crate::operation::update_data_retention::UpdateDataRetentionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_data_retention::de_update_data_retention_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_data_retention::de_update_data_retention_http_response(response)
                     }
                }
            }
