    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteEdgeConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteEdgeConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteEdgeConfigurationEndpointParamsInterceptor {
...
pub type DeleteEdgeConfigurationErrorKind = DeleteEdgeConfigurationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteEdgeConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_edge_configuration::DeleteEdgeConfigurationError {
...
impl DeleteEdgeConfigurationError {
    ...
    /// Creates the `DeleteEdgeConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
