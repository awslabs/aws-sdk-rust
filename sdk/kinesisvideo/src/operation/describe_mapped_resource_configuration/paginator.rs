...
impl DescribeMappedResourceConfigurationPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::describe_mapped_resource_configuration::DescribeMappedResourceConfiguration::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_mapped_resource_configuration::DescribeMappedResourceConfiguration::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl DescribeMappedResourceConfigurationPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_mapped_resource_configuration_output_output_mapped_resource_configuration_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
