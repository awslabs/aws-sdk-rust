...
impl DescribeStreamOutputBuilder {
    ...
    pub fn stream_info(mut self, input: crate::types::StreamInfo) -> Self {
        self.stream_info = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object that describes the stream.</p>
    pub fn set_stream_info(
        mut self,
        input: ::std::option::Option<crate::types::StreamInfo>,
    ) -> Self {
        self.stream_info = input;
        self
    }
    /// <p>An object that describes the stream.</p>
    pub fn get_stream_info(&self) -> &::std::option::Option<crate::types::StreamInfo> {
        &self.stream_info
    }
