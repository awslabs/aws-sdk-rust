...
impl DescribeNotificationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_notification_configuration::DescribeNotificationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_notification_configuration::de_describe_notification_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
