...
impl DeleteStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_stream::DeleteStream, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_stream::ser_delete_stream_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_stream::de_delete_stream_http_response_with_props(status, headers, body)
        }
    }
}
