...
impl GetSignalingChannelEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Kinesis Video.GetSignalingChannelEndpoint",
            "rpc.service" = "Kinesis Video",
            "rpc.method" = "GetSignalingChannelEndpoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSignalingChannelEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetSignalingChannelEndpointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetSignalingChannelEndpointResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetSignalingChannelEndpoint")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSignalingChannelEndpoint")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetSignalingChannelEndpointTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetSignalingChannelEndpointTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSignalingChannelEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetSignalingChannelEndpointInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSignalingChannelEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_signaling_channel_endpoint::de_get_signaling_channel_endpoint_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_signaling_channel_endpoint::de_get_signaling_channel_endpoint_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSignalingChannelEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_signaling_channel_endpoint::ser_get_signaling_channel_endpoint_input(&input)?,
        );
