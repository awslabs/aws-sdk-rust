...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kinesis Video", "TagResource", input, runtime_plugins, stop_point).await
    }
