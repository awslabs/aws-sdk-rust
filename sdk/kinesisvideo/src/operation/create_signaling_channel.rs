    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/createSignalingChannel")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_signaling_channel::CreateSignalingChannel::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_signaling_channel::CreateSignalingChannelError
{
