...
impl DescribeEdgeConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_edge_configuration::DescribeEdgeConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_edge_configuration::DescribeEdgeConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_edge_configuration::DescribeEdgeConfigurationOutput, crate::operation::describe_edge_configuration::DescribeEdgeConfigurationError, Self> {
