...
impl StartEdgeConfigurationUpdateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEdgeConfigurationUpdate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_edge_configuration_update::de_start_edge_configuration_update_http_response_with_props(
                status, headers, body,
            )
        }
    }
