...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartEdgeConfigurationUpdateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_edge_configuration_update::de_start_edge_configuration_update_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_edge_configuration_update::de_start_edge_configuration_update_http_response(
