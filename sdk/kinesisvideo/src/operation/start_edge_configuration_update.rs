    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/startEdgeConfigurationUpdate")
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEdgeConfigurationUpdate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_edge_configuration_update::de_start_edge_configuration_update_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StartEdgeConfigurationUpdateError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdateError
{
