...
impl StartEdgeConfigurationUpdateInput {
    /// Consumes the builder and constructs an Operation<[`StartEdgeConfigurationUpdate`](crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_edge_configuration_update::ser_start_edge_configuration_update_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartEdgeConfigurationUpdate {
                type Output = std::result::Result<crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdateOutput, crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdateError>;
