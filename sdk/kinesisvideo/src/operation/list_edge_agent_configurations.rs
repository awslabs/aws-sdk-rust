...
impl ListEdgeAgentConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`ListEdgeAgentConfigurations`](crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurations)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_edge_agent_configurations::ser_list_edge_agent_configurations_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurations::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("ListEdgeAgentConfigurations", "kinesisvideo"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEdgeAgentConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_edge_agent_configurations::de_list_edge_agent_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
