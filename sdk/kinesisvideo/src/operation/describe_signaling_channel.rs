...
impl DescribeSignalingChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_signaling_channel::DescribeSignalingChannel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSignalingChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_signaling_channel::de_describe_signaling_channel_http_response_with_props(status, headers, body)
        }
    }
}
