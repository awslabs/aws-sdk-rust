...
impl DescribeSignalingChannelInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSignalingChannel`](crate::operation::describe_signaling_channel::DescribeSignalingChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_signaling_channel::DescribeSignalingChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_signaling_channel::DescribeSignalingChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_signaling_channel::ser_describe_signaling_channel_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_signaling_channel::DescribeSignalingChannel::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSignalingChannel {
                type Output = std::result::Result<crate::operation::describe_signaling_channel::DescribeSignalingChannelOutput, crate::operation::describe_signaling_channel::DescribeSignalingChannelError>;
