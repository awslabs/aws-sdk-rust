...
impl DescribeImageGenerationConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImageGenerationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_image_generation_configuration::de_describe_image_generation_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
