...
impl GetDataEndpointInput {
    /// Consumes the builder and constructs an Operation<[`GetDataEndpoint`](crate::operation::get_data_endpoint::GetDataEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_data_endpoint::GetDataEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_data_endpoint::GetDataEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_data_endpoint::ser_get_data_endpoint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_data_endpoint::GetDataEndpoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDataEndpoint {
                type Output = std::result::Result<crate::operation::get_data_endpoint::GetDataEndpointOutput, crate::operation::get_data_endpoint::GetDataEndpointError>;
