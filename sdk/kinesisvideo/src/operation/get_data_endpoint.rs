...
impl GetDataEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_data_endpoint::GetDataEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_data_endpoint::ser_get_data_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataEndpoint {
    type Output =
        ::std::result::Result<crate::operation::get_data_endpoint::GetDataEndpointOutput, crate::operation::get_data_endpoint::GetDataEndpointError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_data_endpoint::de_get_data_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
