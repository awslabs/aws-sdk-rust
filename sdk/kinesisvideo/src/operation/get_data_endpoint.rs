...
impl GetDataEndpointInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_data_endpoint::GetDataEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_data_endpoint::de_get_data_endpoint_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_data_endpoint::GetDataEndpointError
{
