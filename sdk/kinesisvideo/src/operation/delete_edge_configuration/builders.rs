...
impl DeleteEdgeConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_edge_configuration::DeleteEdgeConfigurationOutput, crate::operation::delete_edge_configuration::DeleteEdgeConfigurationError, Self> {
