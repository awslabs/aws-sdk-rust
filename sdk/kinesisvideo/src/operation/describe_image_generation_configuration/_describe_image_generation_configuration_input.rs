...
impl DescribeImageGenerationConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
