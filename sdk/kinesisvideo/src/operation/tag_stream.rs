...
impl TagStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_stream::TagStream, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_stream::ser_tag_stream_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_tag_stream::de_tag_stream_http_response_with_props(status, headers, body)
        }
    }
}
