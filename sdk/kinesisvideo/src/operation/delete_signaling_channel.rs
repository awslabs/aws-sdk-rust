...
/// Orchestration and serialization glue logic for `DeleteSignalingChannel`.
...
impl DeleteSignalingChannel {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_signaling_channel::DeleteSignalingChannelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_signaling_channel::DeleteSignalingChannelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_signaling_channel::DeleteSignalingChannelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_signaling_channel::DeleteSignalingChannelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSignalingChannel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSignalingChannel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSignalingChannelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSignalingChannelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSignalingChannel")
...
.with_interceptor(DeleteSignalingChannelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_signaling_channel::DeleteSignalingChannelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_signaling_channel::DeleteSignalingChannelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_signaling_channel::DeleteSignalingChannelError>::new());
...
#[derive(Debug)]
            struct DeleteSignalingChannelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSignalingChannelResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_signaling_channel::de_delete_signaling_channel_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_signaling_channel::de_delete_signaling_channel_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteSignalingChannelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSignalingChannelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_signaling_channel::DeleteSignalingChannelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_signaling_channel::DeleteSignalingChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/deleteSignalingChannel").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_signaling_channel::ser_delete_signaling_channel_input(&input)?);
...
#[derive(Debug)]
            struct DeleteSignalingChannelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSignalingChannelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSignalingChannelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSignalingChannelInput>()
                        .ok_or("failed to downcast to DeleteSignalingChannelInput")?;
...
pub enum DeleteSignalingChannelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSignalingChannelError) for what information is available for the error.")]
...
impl DeleteSignalingChannelError {
    /// Creates the `DeleteSignalingChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSignalingChannelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSignalingChannelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_signaling_channel::DeleteSignalingChannelError {
...
mod _delete_signaling_channel_output;
