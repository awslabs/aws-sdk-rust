    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/deleteSignalingChannel")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_signaling_channel::DeleteSignalingChannel::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_signaling_channel::DeleteSignalingChannelError
{
