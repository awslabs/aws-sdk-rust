    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/updateSignalingChannel")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_signaling_channel::UpdateSignalingChannel::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_signaling_channel::UpdateSignalingChannelError
{
