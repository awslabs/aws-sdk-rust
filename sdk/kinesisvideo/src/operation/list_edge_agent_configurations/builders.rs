...
impl ListEdgeAgentConfigurationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurationsOutput, crate::operation::list_edge_agent_configurations::ListEdgeAgentConfigurationsError, Self> {
