...
/// Orchestration and serialization glue logic for `DescribeMediaStorageConfiguration`.
...
impl DescribeMediaStorageConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeMediaStorageConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeMediaStorageConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeMediaStorageConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeMediaStorageConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeMediaStorageConfiguration")
...
.with_interceptor(DescribeMediaStorageConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError>::new());
...
#[derive(Debug)]
            struct DescribeMediaStorageConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeMediaStorageConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_media_storage_configuration::de_describe_media_storage_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_media_storage_configuration::de_describe_media_storage_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeMediaStorageConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeMediaStorageConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/describeMediaStorageConfiguration").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_media_storage_configuration::ser_describe_media_storage_configuration_input(&input)?);
...
#[derive(Debug)]
            struct DescribeMediaStorageConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeMediaStorageConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeMediaStorageConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeMediaStorageConfigurationInput>()
                        .ok_or("failed to downcast to DescribeMediaStorageConfigurationInput")?;
...
pub enum DescribeMediaStorageConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeMediaStorageConfigurationError) for what information is available for the error.")]
...
impl DescribeMediaStorageConfigurationError {
    /// Creates the `DescribeMediaStorageConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeMediaStorageConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMediaStorageConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeMediaStorageConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError {
...
mod _describe_media_storage_configuration_output;
