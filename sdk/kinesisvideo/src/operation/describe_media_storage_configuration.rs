...
impl DescribeMediaStorageConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMediaStorageConfiguration`](crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_media_storage_configuration::ser_describe_media_storage_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMediaStorageConfiguration {
                type Output = std::result::Result<crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationOutput, crate::operation::describe_media_storage_configuration::DescribeMediaStorageConfigurationError>;
