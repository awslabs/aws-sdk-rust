...
impl UpdateNotificationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_notification_configuration::UpdateNotificationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNotificationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_notification_configuration::de_update_notification_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
