...
impl super::Client {
    ...
    ///   - [`tag_key_list(impl Into<String>)`](crate::operation::untag_stream::builders::UntagStreamFluentBuilder::tag_key_list) / [`set_tag_key_list(Option<Vec<String>>)`](crate::operation::untag_stream::builders::UntagStreamFluentBuilder::set_tag_key_list): <p>A list of the keys of the tags that you want to remove.</p>
