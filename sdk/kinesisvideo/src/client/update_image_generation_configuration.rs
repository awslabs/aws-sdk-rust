...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::update_image_generation_configuration::builders::UpdateImageGenerationConfigurationFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::update_image_generation_configuration::builders::UpdateImageGenerationConfigurationFluentBuilder::set_stream_name): <p>The name of the stream from which to update the image generation configuration. You must specify either the <code>StreamName</code> or the <code>StreamARN</code>.</p>
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::update_image_generation_configuration::builders::UpdateImageGenerationConfigurationFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::update_image_generation_configuration::builders::UpdateImageGenerationConfigurationFluentBuilder::set_stream_arn): <p>The Amazon Resource Name (ARN) of the Kinesis video stream from where you want to update the image generation configuration. You must specify either the <code>StreamName</code> or the <code>StreamARN</code>.</p>
