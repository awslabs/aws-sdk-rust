...
impl super::Client {
    ...
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_stream::builders::DeleteStreamFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::delete_stream::builders::DeleteStreamFluentBuilder::set_stream_arn): <p>The Amazon Resource Name (ARN) of the stream that you want to delete. </p>
