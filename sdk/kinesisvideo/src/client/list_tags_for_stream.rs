...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_tags_for_stream::builders::ListTagsForStreamFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_tags_for_stream::builders::ListTagsForStreamFluentBuilder::set_next_token):<br>required: **false**<br><p>If you specify this parameter and the result of a <code>ListTagsForStream</code> call is truncated, the response includes a token that you can use in the next request to fetch the next batch of tags.</p><br>
    ///   - [`stream_arn(impl Into<String>)`](crate::operation::list_tags_for_stream::builders::ListTagsForStreamFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::list_tags_for_stream::builders::ListTagsForStreamFluentBuilder::set_stream_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the stream that you want to list tags for.</p><br>
