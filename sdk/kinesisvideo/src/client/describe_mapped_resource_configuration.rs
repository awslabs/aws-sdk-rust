...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::set_stream_name): <p>The name of the stream.</p>
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::set_stream_arn): <p>The Amazon Resource Name (ARN) of the stream.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_mapped_resource_configuration::builders::DescribeMappedResourceConfigurationFluentBuilder::set_next_token): <p>The token to provide in your next request, to get another batch of results.</p>
