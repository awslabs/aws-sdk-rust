...
impl super::Client  {
    ...
    pub fn describe_mapped_resource_configuration(&self) -> crate::client::fluent_builders::DescribeMappedResourceConfiguration {
                                crate::client::fluent_builders::DescribeMappedResourceConfiguration::new(self.handle.clone())
                            }
}
