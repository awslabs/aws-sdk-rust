...
impl super::Client {
    ...
    ///   - [`hub_device_arn(impl ::std::convert::Into<String>)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::hub_device_arn) / [`set_hub_device_arn(Option<String>)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::set_hub_device_arn): <p>The "Internet of Things (IoT) Thing" Arn of the edge agent.</p>
    ///   - [`max_results(i32)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::set_max_results): <p>The maximum number of edge configurations to return in the response. The default is 5.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_edge_agent_configurations::builders::ListEdgeAgentConfigurationsFluentBuilder::set_next_token): <p>If you specify this parameter, when the result of a <code>ListEdgeAgentConfigurations</code> operation is truncated, the call returns the <code>NextToken</code> in the response. To get another batch of edge configurations, provide this token in your next request. </p>
