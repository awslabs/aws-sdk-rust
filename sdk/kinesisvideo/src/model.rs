...
pub struct SingleMasterConfiguration  {
    ...
    #[doc(hidden)]pub message_ttl_seconds: std::option::Option<i32>,
}
...
pub struct NotificationConfiguration  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ConfigurationStatus>,
    /// <p>The destination information required to deliver a notification to a customer.</p>
    #[doc(hidden)]pub destination_config: std::option::Option<crate::model::NotificationDestinationConfig>,
}
...
pub struct ImageGenerationConfiguration  {
    ...
    #[doc(hidden)]pub image_selector_type: std::option::Option<crate::model::ImageSelectorType>,
    /// <p>The structure that contains the information required to deliver images to a customer.</p>
    #[doc(hidden)]pub destination_config: std::option::Option<crate::model::ImageGenerationDestinationConfig>,
    ...
    #[doc(hidden)]pub sampling_interval: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub format_config: std::option::Option<std::collections::HashMap<crate::model::FormatConfigKey, std::string::String>>,
    ...
    #[doc(hidden)]pub width_pixels: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub height_pixels: std::option::Option<i32>,
}
...
pub struct StreamInfo  {
    ...
    #[doc(hidden)]pub media_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub data_retention_in_hours: std::option::Option<i32>,
}
impl StreamInfo {
    /// <p>The name of the device that is associated with the stream.</p>
...
pub struct StreamNameCondition  {
    ...
    #[doc(hidden)]pub comparison_value: std::option::Option<std::string::String>,
}
...
pub struct ChannelInfo  {
    ...
    #[doc(hidden)]pub channel_type: std::option::Option<crate::model::ChannelType>,
    /// <p>Current status of the signaling channel.</p>
    #[doc(hidden)]pub channel_status: std::option::Option<crate::model::Status>,
    /// <p>The time at which the signaling channel was created.</p>
    #[doc(hidden)]pub creation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A structure that contains the configuration for the <code>SINGLE_MASTER</code> channel type.</p>
    #[doc(hidden)]pub single_master_configuration: std::option::Option<crate::model::SingleMasterConfiguration>,
...
impl  std::fmt::Debug for ChannelInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("creation_time", &self.creation_time);
        formatter.field("single_master_configuration", &self.single_master_configuration);
        formatter.field("version", &self.version);
        formatter.finish()
    }
}
...
pub struct ResourceEndpointListItem  {
    ...
    #[doc(hidden)]pub protocol: std::option::Option<crate::model::ChannelProtocol>,
    /// <p>The endpoint of the signaling channel returned by the <code>GetSignalingChannelEndpoint</code> API.</p>
    #[doc(hidden)]pub resource_endpoint: std::option::Option<std::string::String>,
}
...
pub struct SingleMasterChannelEndpointConfiguration  {
    ...
    #[doc(hidden)]pub protocols: std::option::Option<std::vec::Vec<crate::model::ChannelProtocol>>,
    ...
    #[doc(hidden)]pub role: std::option::Option<crate::model::ChannelRole>,
}
