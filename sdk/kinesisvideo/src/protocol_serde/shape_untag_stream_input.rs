...
pub fn ser_untag_stream_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UntagStreamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
