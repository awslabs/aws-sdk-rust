...
pub(crate) fn de_image_generation_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ImageGenerationConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_image_generation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ImageGenerationConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
