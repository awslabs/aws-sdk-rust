...
pub fn ser_create_stream_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStreamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
