...
pub fn ser_list_signaling_channels_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSignalingChannelsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
