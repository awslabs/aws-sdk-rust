...
pub(crate) fn de_notification_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::NotificationConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DestinationConfig" => {
                                builder = builder.set_destination_config(
                                    crate::protocol_serde::shape_notification_destination_config::de_notification_destination_config(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::notification_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
