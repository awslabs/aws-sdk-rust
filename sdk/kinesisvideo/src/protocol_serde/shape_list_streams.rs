        ...
        "ClientLimitExceededException" => {
            crate::operation::list_streams::ListStreamsError::ClientLimitExceededException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_client_limit_exceeded_exception::de_client_limit_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_streams::ListStreamsError::unhandled)?;
