...
pub fn ser_describe_image_generation_configuration_input(
    ...
    crate::protocol_serde::shape_describe_image_generation_configuration_input::ser_describe_image_generation_configuration_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfigurationError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfigurationError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidArgumentException" => {
            crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfigurationError::InvalidArgumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_image_generation_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_image_generation_configuration::de_describe_image_generation_configuration(_response_body, output)
                .map_err(crate::operation::describe_image_generation_configuration::DescribeImageGenerationConfigurationError::unhandled)?;
