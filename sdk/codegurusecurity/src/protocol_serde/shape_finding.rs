                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "vulnerability" => {
                                builder = builder.set_vulnerability(
                                    crate::protocol_serde::shape_vulnerability::de_vulnerability(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "detectorTags" => {
                                builder = builder.set_detector_tags(
                                    crate::protocol_serde::shape_detector_tags::de_detector_tags(
                                        tokens,
                                    )?,
                                );
                            }
