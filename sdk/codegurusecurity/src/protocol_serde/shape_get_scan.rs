...
pub fn de_get_scan_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_scan::GetScanOutput, crate::operation::get_scan::GetScanError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_scan_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_scan::GetScanOutput, crate::operation::get_scan::GetScanError> {
    Ok({
        ...
        crate::serde_util::get_scan_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_scan::GetScanError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::get_scan::builders::GetScanOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
