...
impl Builder {
    ...
    /// use aws_sdk_codegurusecurity::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_codegurusecurity::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
