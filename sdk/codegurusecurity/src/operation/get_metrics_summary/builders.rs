...
impl GetMetricsSummaryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_metrics_summary::GetMetricsSummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_metrics_summary::GetMetricsSummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_metrics_summary::GetMetricsSummaryOutput, crate::operation::get_metrics_summary::GetMetricsSummaryError, Self> {
