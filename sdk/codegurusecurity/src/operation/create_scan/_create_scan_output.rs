        ...
        ::std::result::Result::Ok(
            crate::operation::create_scan::CreateScanOutput {
                scan_name: self.scan_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("scan_name", "scan_name was not specified but it is required when building CreateScanOutput")
                    )?
                ,
                run_id: self.run_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("run_id", "run_id was not specified but it is required when building CreateScanOutput")
                    )?
                ,
                ...
                scan_state: self.scan_state
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("scan_state", "scan_state was not specified but it is required when building CreateScanOutput")
                    )?
                ,
