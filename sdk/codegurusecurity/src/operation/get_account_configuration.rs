...
impl GetAccountConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountConfiguration`](crate::operation::get_account_configuration::GetAccountConfiguration)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_account_configuration::GetAccountConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_configuration::GetAccountConfiguration::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAccountConfiguration", "codegurusecurity"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_configuration::de_get_account_configuration_http_response_with_props(status, headers, body)
        }
    }
}
