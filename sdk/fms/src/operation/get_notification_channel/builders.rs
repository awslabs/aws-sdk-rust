...
impl GetNotificationChannelFluentBuilder  {
    /// Creates a new `GetNotificationChannel`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_notification_channel::GetNotificationChannelOutput, aws_smithy_http::result::SdkError<crate::operation::get_notification_channel::GetNotificationChannelError>>
                     {
