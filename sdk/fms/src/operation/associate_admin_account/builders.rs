...
impl AssociateAdminAccountFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_admin_account::AssociateAdminAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_admin_account::AssociateAdminAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_admin_account::AssociateAdminAccountOutput, crate::operation::associate_admin_account::AssociateAdminAccountError, Self> {
