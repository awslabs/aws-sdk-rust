...
impl BatchAssociateResourceInput {
    /// Consumes the builder and constructs an Operation<[`BatchAssociateResource`](crate::operation::batch_associate_resource::BatchAssociateResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_associate_resource::BatchAssociateResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_associate_resource::BatchAssociateResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_associate_resource::ser_batch_associate_resource_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_associate_resource::BatchAssociateResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchAssociateResource", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchAssociateResource {
                type Output = std::result::Result<crate::operation::batch_associate_resource::BatchAssociateResourceOutput, crate::operation::batch_associate_resource::BatchAssociateResourceError>;
