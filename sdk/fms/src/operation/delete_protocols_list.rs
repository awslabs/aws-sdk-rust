...
/// Orchestration and serialization glue logic for `DeleteProtocolsList`.
...
impl DeleteProtocolsList {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_protocols_list::DeleteProtocolsListInput,
                    ) -> ::std::result::Result<crate::operation::delete_protocols_list::DeleteProtocolsListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_protocols_list::DeleteProtocolsListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_protocols_list::DeleteProtocolsListError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_protocols_list::DeleteProtocolsListOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteProtocolsList {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteProtocolsList");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteProtocolsListRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteProtocolsListResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteProtocolsList")
...
.with_interceptor(DeleteProtocolsListEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_protocols_list::DeleteProtocolsListError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_protocols_list::DeleteProtocolsListError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_protocols_list::DeleteProtocolsListError>::new());
...
#[derive(Debug)]
            struct DeleteProtocolsListResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteProtocolsListResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_protocols_list::de_delete_protocols_list_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_protocols_list::de_delete_protocols_list_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteProtocolsListRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteProtocolsListRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_protocols_list::DeleteProtocolsListInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_protocols_list::DeleteProtocolsListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_protocols_list::ser_delete_protocols_list_input(&input)?);
...
#[derive(Debug)]
            struct DeleteProtocolsListEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteProtocolsListEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteProtocolsListEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteProtocolsListInput>()
                        .ok_or("failed to downcast to DeleteProtocolsListInput")?;
...
pub enum DeleteProtocolsListError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteProtocolsListError) for what information is available for the error.")]
...
impl DeleteProtocolsListError {
    /// Creates the `DeleteProtocolsListError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteProtocolsListError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteProtocolsListError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_protocols_list::DeleteProtocolsListError {
...
mod _delete_protocols_list_output;
