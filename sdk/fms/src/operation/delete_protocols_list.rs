...
impl DeleteProtocolsListInput {
    /// Consumes the builder and constructs an Operation<[`DeleteProtocolsList`](crate::operation::delete_protocols_list::DeleteProtocolsList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_protocols_list::DeleteProtocolsList, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_protocols_list::DeleteProtocolsListInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_protocols_list::ser_delete_protocols_list_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_protocols_list::DeleteProtocolsList::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteProtocolsList", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteProtocolsList {
                type Output = std::result::Result<crate::operation::delete_protocols_list::DeleteProtocolsListOutput, crate::operation::delete_protocols_list::DeleteProtocolsListError>;
