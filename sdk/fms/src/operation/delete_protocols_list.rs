...
impl DeleteProtocolsListInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_protocols_list::DeleteProtocolsList,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProtocolsList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_protocols_list::de_delete_protocols_list_http_response_with_props(status, headers, body)
        }
    }
}
