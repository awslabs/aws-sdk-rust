...
impl GetAppsListInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_apps_list::GetAppsList, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_apps_list::ser_get_apps_list_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppsList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_apps_list::de_get_apps_list_http_response_with_props(status, headers, body)
        }
    }
}
