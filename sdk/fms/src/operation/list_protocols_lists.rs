...
impl ListProtocolsLists {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_protocols_lists::ListProtocolsListsInput,
                    ) -> ::std::result::Result<crate::operation::list_protocols_lists::ListProtocolsListsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_protocols_lists::ListProtocolsListsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_protocols_lists::ListProtocolsListsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_protocols_lists::ListProtocolsListsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListProtocolsLists {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListProtocolsLists");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListProtocolsListsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListProtocolsListsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListProtocolsLists")
...
.with_interceptor(ListProtocolsListsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_protocols_lists::ListProtocolsListsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_protocols_lists::ListProtocolsListsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_protocols_lists::ListProtocolsListsError>::new());
...
#[derive(Debug)]
            struct ListProtocolsListsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListProtocolsListsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_protocols_lists::de_list_protocols_lists_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_protocols_lists::de_list_protocols_lists_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListProtocolsListsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListProtocolsListsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_protocols_lists::ListProtocolsListsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_protocols_lists::ListProtocolsListsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_protocols_lists::ser_list_protocols_lists_input(&input)?);
...
#[derive(Debug)]
            struct ListProtocolsListsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListProtocolsListsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListProtocolsListsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListProtocolsListsInput>()
                        .ok_or("failed to downcast to ListProtocolsListsInput")?;
...
pub enum ListProtocolsListsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListProtocolsListsError) for what information is available for the error.")]
...
impl ListProtocolsListsError {
    /// Creates the `ListProtocolsListsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListProtocolsListsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListProtocolsListsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_protocols_lists::ListProtocolsListsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_protocols_lists::_list_protocols_lists_output::ListProtocolsListsOutput;

pub use crate::operation::list_protocols_lists::_list_protocols_lists_input::ListProtocolsListsInput;

mod _list_protocols_lists_input;

mod _list_protocols_lists_output;
