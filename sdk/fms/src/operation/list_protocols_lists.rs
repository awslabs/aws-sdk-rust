...
impl ListProtocolsListsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_protocols_lists::ser_list_protocols_lists_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_protocols_lists::ListProtocolsLists::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_protocols_lists::ListProtocolsListsError
{
