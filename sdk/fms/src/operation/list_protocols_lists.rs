...
impl ListProtocolsListsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_protocols_lists::ListProtocolsLists,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_protocols_lists::ser_list_protocols_lists_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProtocolsLists {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_protocols_lists::de_list_protocols_lists_http_response_with_props(status, headers, body)
        }
    }
}
