...
impl PutProtocolsListInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_protocols_list::ser_put_protocols_list_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutProtocolsList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_protocols_list::de_put_protocols_list_http_response_with_props(status, headers, body)
        }
    }
}
