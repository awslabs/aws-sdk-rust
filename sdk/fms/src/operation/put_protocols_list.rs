...
impl PutProtocolsListInput {
    /// Consumes the builder and constructs an Operation<[`PutProtocolsList`](crate::operation::put_protocols_list::PutProtocolsList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_protocols_list::PutProtocolsList, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_protocols_list::PutProtocolsListInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_protocols_list::ser_put_protocols_list_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_protocols_list::PutProtocolsList::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutProtocolsList", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutProtocolsList {
                type Output = std::result::Result<crate::operation::put_protocols_list::PutProtocolsListOutput, crate::operation::put_protocols_list::PutProtocolsListError>;
