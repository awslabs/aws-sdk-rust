...
/// Orchestration and serialization glue logic for `PutProtocolsList`.
...
impl PutProtocolsList {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_protocols_list::PutProtocolsListInput,
                    ) -> ::std::result::Result<crate::operation::put_protocols_list::PutProtocolsListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_protocols_list::PutProtocolsListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_protocols_list::PutProtocolsListError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_protocols_list::PutProtocolsListOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutProtocolsList {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutProtocolsList");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutProtocolsListRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutProtocolsListResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutProtocolsList")
...
.with_interceptor(PutProtocolsListEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_protocols_list::PutProtocolsListError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_protocols_list::PutProtocolsListError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_protocols_list::PutProtocolsListError>::new());
...
#[derive(Debug)]
            struct PutProtocolsListResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutProtocolsListResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_protocols_list::de_put_protocols_list_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_protocols_list::de_put_protocols_list_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutProtocolsListRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutProtocolsListRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_protocols_list::PutProtocolsListInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_protocols_list::PutProtocolsListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_protocols_list::ser_put_protocols_list_input(&input)?);
...
#[derive(Debug)]
            struct PutProtocolsListEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutProtocolsListEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutProtocolsListEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutProtocolsListInput>()
                        .ok_or("failed to downcast to PutProtocolsListInput")?;
...
pub enum PutProtocolsListError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutProtocolsListError) for what information is available for the error.")]
...
impl PutProtocolsListError {
    /// Creates the `PutProtocolsListError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutProtocolsListError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutProtocolsListError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_protocols_list::PutProtocolsListError {
...
mod _put_protocols_list_output;
