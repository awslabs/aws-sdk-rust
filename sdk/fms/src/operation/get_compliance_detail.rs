...
/// Orchestration and serialization glue logic for `GetComplianceDetail`.
...
impl GetComplianceDetail {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_compliance_detail::GetComplianceDetailInput,
                    ) -> ::std::result::Result<crate::operation::get_compliance_detail::GetComplianceDetailOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_compliance_detail::GetComplianceDetailError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_compliance_detail::GetComplianceDetailError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_compliance_detail::GetComplianceDetailOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetComplianceDetail {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetComplianceDetail");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetComplianceDetailRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetComplianceDetailResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetComplianceDetail")
...
.with_interceptor(GetComplianceDetailEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_compliance_detail::GetComplianceDetailError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_compliance_detail::GetComplianceDetailError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_compliance_detail::GetComplianceDetailError>::new());
...
#[derive(Debug)]
            struct GetComplianceDetailResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetComplianceDetailResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_compliance_detail::de_get_compliance_detail_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_compliance_detail::de_get_compliance_detail_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetComplianceDetailRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetComplianceDetailRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_compliance_detail::GetComplianceDetailInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_compliance_detail::GetComplianceDetailInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_compliance_detail::ser_get_compliance_detail_input(&input)?);
...
#[derive(Debug)]
            struct GetComplianceDetailEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetComplianceDetailEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetComplianceDetailEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetComplianceDetailInput>()
                        .ok_or("failed to downcast to GetComplianceDetailInput")?;
...
pub enum GetComplianceDetailError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetComplianceDetailError) for what information is available for the error.")]
...
impl GetComplianceDetailError {
    /// Creates the `GetComplianceDetailError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetComplianceDetailError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetComplianceDetailError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_compliance_detail::GetComplianceDetailError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_compliance_detail::_get_compliance_detail_output::GetComplianceDetailOutput;

pub use crate::operation::get_compliance_detail::_get_compliance_detail_input::GetComplianceDetailInput;

mod _get_compliance_detail_input;

mod _get_compliance_detail_output;
