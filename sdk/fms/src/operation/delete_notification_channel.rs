...
impl DeleteNotificationChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_notification_channel::DeleteNotificationChannel,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_notification_channel::DeleteNotificationChannel::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotificationChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_notification_channel::de_delete_notification_channel_http_response_with_props(status, headers, body)
        }
    }
}
