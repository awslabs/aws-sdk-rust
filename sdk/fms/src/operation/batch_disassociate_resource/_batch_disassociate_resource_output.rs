...
impl BatchDisassociateResourceOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_disassociate_resource::BatchDisassociateResourceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::batch_disassociate_resource::BatchDisassociateResourceOutput {
                resource_set_identifier: self.resource_set_identifier
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_set_identifier", "resource_set_identifier was not specified but it is required when building BatchDisassociateResourceOutput")
                    )?
                ,
                failed_items: self.failed_items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("failed_items", "failed_items was not specified but it is required when building BatchDisassociateResourceOutput")
                    )?
                ,
