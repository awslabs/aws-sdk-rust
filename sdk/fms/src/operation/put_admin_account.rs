...
impl PutAdminAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_admin_account::PutAdminAccount, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_admin_account::ser_put_admin_account_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAdminAccount {
    type Output =
        ::std::result::Result<crate::operation::put_admin_account::PutAdminAccountOutput, crate::operation::put_admin_account::PutAdminAccountError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_admin_account::de_put_admin_account_http_response_with_props(status, headers, body)
        }
    }
}
