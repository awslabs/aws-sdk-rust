    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPolicies::orchestrate(
                        &runtime_plugins,
                        input.clone(),
                    )
                    .await;
...
impl ListThirdPartyFirewallFirewallPoliciesPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_third_party_firewall_firewall_policies_output_third_party_firewall_firewall_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
