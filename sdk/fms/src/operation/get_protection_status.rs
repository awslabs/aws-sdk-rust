...
impl GetProtectionStatusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_protection_status::ser_get_protection_status_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_protection_status::GetProtectionStatus::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_protection_status::GetProtectionStatusError
{
