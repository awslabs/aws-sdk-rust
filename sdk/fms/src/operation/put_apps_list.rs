...
impl PutAppsListInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_apps_list::PutAppsList::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppsList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_apps_list::de_put_apps_list_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_apps_list::de_put_apps_list_http_response_with_props(
                status, headers, body,
            )
        }
    }
