...
impl GetAdminScopeInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_admin_scope::GetAdminScope::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetAdminScope {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_admin_scope::de_get_admin_scope_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_admin_scope::de_get_admin_scope_http_response(
                status, headers, body,
            )
        }
    }
