...
impl GetAdminScopeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_admin_scope::GetAdminScope, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_admin_scope::GetAdminScopeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
/// `ParseStrictResponse` impl for `GetAdminScope`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetAdminScope {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_admin_scope::de_get_admin_scope_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_admin_scope::de_get_admin_scope_http_response(response)
                     }
                }
            }
