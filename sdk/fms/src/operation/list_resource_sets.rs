...
impl ListResourceSetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_resource_sets::ser_list_resource_sets_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_sets::ListResourceSets::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResourceSets", "fms"));
