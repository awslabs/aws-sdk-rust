...
impl GetViolationDetailsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_violation_details::ser_get_violation_details_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_violation_details::GetViolationDetails::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_violation_details::GetViolationDetailsError
{
