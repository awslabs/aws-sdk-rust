...
impl PutResourceSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_resource_set::PutResourceSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_resource_set::ser_put_resource_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutResourceSet {
    type Output =
        ::std::result::Result<crate::operation::put_resource_set::PutResourceSetOutput, crate::operation::put_resource_set::PutResourceSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_resource_set::de_put_resource_set_http_response_with_props(status, headers, body)
        }
    }
}
