...
impl PutResourceSetInput {
    /// Consumes the builder and constructs an Operation<[`PutResourceSet`](crate::operation::put_resource_set::PutResourceSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_resource_set::PutResourceSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_resource_set::PutResourceSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_resource_set::ser_put_resource_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_resource_set::PutResourceSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutResourceSet", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutResourceSet {
                type Output = std::result::Result<crate::operation::put_resource_set::PutResourceSetOutput, crate::operation::put_resource_set::PutResourceSetError>;
