...
impl DeleteAppsListInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAppsList`](crate::operation::delete_apps_list::DeleteAppsList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_apps_list::DeleteAppsList, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_apps_list::DeleteAppsListInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_apps_list::ser_delete_apps_list_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_apps_list::DeleteAppsList::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAppsList", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAppsList {
                type Output = std::result::Result<crate::operation::delete_apps_list::DeleteAppsListOutput, crate::operation::delete_apps_list::DeleteAppsListError>;
