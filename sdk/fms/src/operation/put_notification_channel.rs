...
impl PutNotificationChannelInput {
    /// Consumes the builder and constructs an Operation<[`PutNotificationChannel`](crate::operation::put_notification_channel::PutNotificationChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_notification_channel::PutNotificationChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_notification_channel::ser_put_notification_channel_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_notification_channel::PutNotificationChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutNotificationChannel", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutNotificationChannel {
                type Output = std::result::Result<crate::operation::put_notification_channel::PutNotificationChannelOutput, crate::operation::put_notification_channel::PutNotificationChannelError>;
