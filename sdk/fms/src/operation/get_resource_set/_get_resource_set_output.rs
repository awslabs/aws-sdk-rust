...
impl GetResourceSetOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resource_set::GetResourceSetOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_resource_set::GetResourceSetOutput {
                ...
                resource_set_arn: self.resource_set_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_set_arn", "resource_set_arn was not specified but it is required when building GetResourceSetOutput")
                    )?
                ,
