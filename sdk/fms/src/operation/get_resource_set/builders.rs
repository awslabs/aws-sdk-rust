...
impl GetResourceSetFluentBuilder  {
    /// Creates a new `GetResourceSet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_resource_set::GetResourceSetOutput, aws_smithy_http::result::SdkError<crate::operation::get_resource_set::GetResourceSetError>>
                     {
