...
impl ListMemberAccountsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_member_accounts::ser_list_member_accounts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMemberAccounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_member_accounts::de_list_member_accounts_http_response_with_props(status, headers, body)
        }
    }
}
