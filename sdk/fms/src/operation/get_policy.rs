...
impl GetPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_policy::ser_get_policy_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_policy::GetPolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPolicy", "fms"));
