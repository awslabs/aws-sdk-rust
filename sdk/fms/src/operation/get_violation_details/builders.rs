...
impl GetViolationDetailsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_violation_details::GetViolationDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_violation_details::GetViolationDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_violation_details::GetViolationDetailsOutput, crate::operation::get_violation_details::GetViolationDetailsError, Self> {
