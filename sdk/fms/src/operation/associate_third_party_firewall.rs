...
impl AssociateThirdPartyFirewallInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewall::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateThirdPartyFirewall {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_third_party_firewall::de_associate_third_party_firewall_http_response_with_props(
                status, headers, body,
            )
        }
    }
