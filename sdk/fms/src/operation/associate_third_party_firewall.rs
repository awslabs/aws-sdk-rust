...
/// Orchestration and serialization glue logic for `AssociateThirdPartyFirewall`.
...
impl AssociateThirdPartyFirewall {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateThirdPartyFirewall {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateThirdPartyFirewall");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateThirdPartyFirewallRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateThirdPartyFirewallResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateThirdPartyFirewall")
...
.with_interceptor(AssociateThirdPartyFirewallEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError>::new());
...
#[derive(Debug)]
            struct AssociateThirdPartyFirewallResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateThirdPartyFirewallResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_third_party_firewall::de_associate_third_party_firewall_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_third_party_firewall::de_associate_third_party_firewall_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateThirdPartyFirewallRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateThirdPartyFirewallRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_third_party_firewall::ser_associate_third_party_firewall_input(&input)?);
...
#[derive(Debug)]
            struct AssociateThirdPartyFirewallEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateThirdPartyFirewallEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateThirdPartyFirewallEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateThirdPartyFirewallInput>()
                        .ok_or("failed to downcast to AssociateThirdPartyFirewallInput")?;
...
pub enum AssociateThirdPartyFirewallError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateThirdPartyFirewallError) for what information is available for the error.")]
...
impl AssociateThirdPartyFirewallError {
    /// Creates the `AssociateThirdPartyFirewallError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateThirdPartyFirewallError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateThirdPartyFirewallError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallError {
...
mod _associate_third_party_firewall_output;
