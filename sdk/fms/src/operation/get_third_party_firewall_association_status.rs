...
impl GetThirdPartyFirewallAssociationStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetThirdPartyFirewallAssociationStatus`](crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_third_party_firewall_association_status::ser_get_third_party_firewall_association_status_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetThirdPartyFirewallAssociationStatus", "fms"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetThirdPartyFirewallAssociationStatus {
    type Output = ::std::result::Result<crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusOutput, crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_third_party_firewall_association_status::de_get_third_party_firewall_association_status_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type GetThirdPartyFirewallAssociationStatusErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for GetThirdPartyFirewallAssociationStatusError
{
...
impl ::aws_http::request_id::RequestId for crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError {
