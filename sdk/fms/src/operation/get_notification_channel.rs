...
impl GetNotificationChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetNotificationChannel`](crate::operation::get_notification_channel::GetNotificationChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_notification_channel::GetNotificationChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_notification_channel::GetNotificationChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_notification_channel::ser_get_notification_channel_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_notification_channel::GetNotificationChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetNotificationChannel", "fms"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetNotificationChannel {
                type Output = std::result::Result<crate::operation::get_notification_channel::GetNotificationChannelOutput, crate::operation::get_notification_channel::GetNotificationChannelError>;
