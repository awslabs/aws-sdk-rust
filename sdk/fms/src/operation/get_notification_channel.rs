...
impl GetNotificationChannel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_notification_channel::GetNotificationChannelInput,
                    ) -> ::std::result::Result<crate::operation::get_notification_channel::GetNotificationChannelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_notification_channel::GetNotificationChannelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_notification_channel::GetNotificationChannelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_notification_channel::GetNotificationChannelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetNotificationChannel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetNotificationChannel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetNotificationChannelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetNotificationChannelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetNotificationChannel")
...
.with_interceptor(GetNotificationChannelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_notification_channel::GetNotificationChannelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_notification_channel::GetNotificationChannelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_notification_channel::GetNotificationChannelError>::new());
...
#[derive(Debug)]
            struct GetNotificationChannelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetNotificationChannelResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_notification_channel::de_get_notification_channel_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_notification_channel::de_get_notification_channel_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetNotificationChannelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetNotificationChannelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_notification_channel::GetNotificationChannelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_notification_channel::GetNotificationChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_notification_channel::ser_get_notification_channel_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct GetNotificationChannelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetNotificationChannelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetNotificationChannelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetNotificationChannelInput>()
                        .ok_or("failed to downcast to GetNotificationChannelInput")?;
...
pub enum GetNotificationChannelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetNotificationChannelError) for what information is available for the error.")]
...
impl GetNotificationChannelError {
    /// Creates the `GetNotificationChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetNotificationChannelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetNotificationChannelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_notification_channel::GetNotificationChannelError {
...
mod _get_notification_channel_output;
