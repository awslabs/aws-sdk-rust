...
impl GetNotificationChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_notification_channel::GetNotificationChannel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNotificationChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_notification_channel::de_get_notification_channel_http_response_with_props(status, headers, body)
        }
    }
}
