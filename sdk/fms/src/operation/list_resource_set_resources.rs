...
impl ListResourceSetResources {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_resource_set_resources::ListResourceSetResourcesInput,
                    ) -> ::std::result::Result<crate::operation::list_resource_set_resources::ListResourceSetResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_set_resources::ListResourceSetResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_resource_set_resources::ListResourceSetResourcesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_resource_set_resources::ListResourceSetResourcesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourceSetResources {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListResourceSetResources");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListResourceSetResourcesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListResourceSetResourcesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourceSetResources")
...
.with_interceptor(ListResourceSetResourcesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_resource_set_resources::ListResourceSetResourcesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_resource_set_resources::ListResourceSetResourcesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_resource_set_resources::ListResourceSetResourcesError>::new());
...
#[derive(Debug)]
            struct ListResourceSetResourcesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceSetResourcesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_resource_set_resources::de_list_resource_set_resources_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_resource_set_resources::de_list_resource_set_resources_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListResourceSetResourcesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceSetResourcesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_resource_set_resources::ListResourceSetResourcesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_resource_set_resources::ListResourceSetResourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_resource_set_resources::ser_list_resource_set_resources_input(&input)?);
...
#[derive(Debug)]
            struct ListResourceSetResourcesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListResourceSetResourcesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListResourceSetResourcesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListResourceSetResourcesInput>()
                        .ok_or("failed to downcast to ListResourceSetResourcesInput")?;
...
pub enum ListResourceSetResourcesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListResourceSetResourcesError) for what information is available for the error.")]
...
impl ListResourceSetResourcesError {
    /// Creates the `ListResourceSetResourcesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListResourceSetResourcesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListResourceSetResourcesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_resource_set_resources::ListResourceSetResourcesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_resource_set_resources::_list_resource_set_resources_output::ListResourceSetResourcesOutput;

pub use crate::operation::list_resource_set_resources::_list_resource_set_resources_input::ListResourceSetResourcesInput;

mod _list_resource_set_resources_input;

mod _list_resource_set_resources_output;
