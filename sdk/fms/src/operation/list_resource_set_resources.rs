...
impl ListResourceSetResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_resource_set_resources::ListResourceSetResources,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_set_resources::ListResourceSetResources::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceSetResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resource_set_resources::de_list_resource_set_resources_http_response_with_props(status, headers, body)
        }
    }
}
