...
impl BatchAssociateResourceFluentBuilder  {
    /// Creates a new `BatchAssociateResource`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::batch_associate_resource::BatchAssociateResourceOutput, aws_smithy_http::result::SdkError<crate::operation::batch_associate_resource::BatchAssociateResourceError>>
                     {
