...
impl ListProtocolsListsFluentBuilder {
    ...
    /// Access the ListProtocolsLists as a reference.
    pub fn as_input(&self) -> &crate::operation::list_protocols_lists::builders::ListProtocolsListsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_protocols_lists::ListProtocolsListsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_protocols_lists::ListProtocolsListsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_protocols_lists::ListProtocolsLists::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_protocols_lists::ListProtocolsListsOutput, crate::operation::list_protocols_lists::ListProtocolsListsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_protocols_lists::paginator::ListProtocolsListsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
