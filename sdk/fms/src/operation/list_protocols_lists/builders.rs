...
impl ListProtocolsListsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_protocols_lists::paginator::ListProtocolsListsPaginator {
        crate::operation::list_protocols_lists::paginator::ListProtocolsListsPaginator::new(
            self.handle,
            self.inner,
        )
    }
