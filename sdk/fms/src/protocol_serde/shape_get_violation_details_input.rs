...
pub fn ser_get_violation_details_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetViolationDetailsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
