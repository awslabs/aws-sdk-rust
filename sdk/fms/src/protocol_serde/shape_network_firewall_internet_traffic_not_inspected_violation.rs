...
pub(crate) fn de_network_firewall_internet_traffic_not_inspected_violation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NetworkFirewallInternetTrafficNotInspectedViolation>, aws_smithy_json::deserialize::error::DeserializeError>
