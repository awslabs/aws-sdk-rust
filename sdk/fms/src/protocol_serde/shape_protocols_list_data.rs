...
pub(crate) fn de_protocols_list_data<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ProtocolsListData>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PreviousProtocolsList" => {
                            builder = builder.set_previous_protocols_list(
                                crate::protocol_serde::shape_previous_protocols_list::de_previous_protocols_list(tokens, _value, depth + 1)?,
                            );
                        }
