...
pub(crate) fn de_protocols_list_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProtocolsListData>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_protocols_list_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProtocolsListData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
