...
pub(crate) fn de_resource_set<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResourceSet>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::resource_set_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_resource_set(
    ...
    if let Some(var_6) = &input.last_update_time {
        object.key("LastUpdateTime").date_time(var_6, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
