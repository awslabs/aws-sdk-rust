...
pub(crate) fn de_resource_violation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResourceViolation>, aws_smithy_json::deserialize::error::DeserializeError>
