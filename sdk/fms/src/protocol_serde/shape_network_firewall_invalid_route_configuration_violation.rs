...
pub(crate) fn de_network_firewall_invalid_route_configuration_violation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NetworkFirewallInvalidRouteConfigurationViolation>, aws_smithy_json::deserialize::error::DeserializeError>
