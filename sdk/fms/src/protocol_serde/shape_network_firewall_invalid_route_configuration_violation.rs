...
) -> Result<Option<crate::types::NetworkFirewallInvalidRouteConfigurationViolation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AffectedSubnets" => {
                            builder = builder.set_affected_subnets(crate::protocol_serde::shape_resource_id_list::de_resource_id_list(tokens)?);
                        }
                        "RouteTableId" => {
                        ...
                        "ViolatingRoute" => {
                            builder = builder.set_violating_route(crate::protocol_serde::shape_route::de_route(tokens)?);
                        }
                        ...
                        "ExpectedFirewallSubnetRoutes" => {
                            builder = builder
                                .set_expected_firewall_subnet_routes(crate::protocol_serde::shape_expected_routes::de_expected_routes(tokens)?);
                        }
                        "ActualFirewallSubnetRoutes" => {
                            builder = builder.set_actual_firewall_subnet_routes(crate::protocol_serde::shape_routes::de_routes(tokens)?);
                        }
                        "InternetGatewayId" => {
                        ...
                        "ExpectedInternetGatewayRoutes" => {
                            builder = builder
                                .set_expected_internet_gateway_routes(crate::protocol_serde::shape_expected_routes::de_expected_routes(tokens)?);
                        }
                        "ActualInternetGatewayRoutes" => {
                            builder = builder.set_actual_internet_gateway_routes(crate::protocol_serde::shape_routes::de_routes(tokens)?);
                        }
                        "VpcId" => {
