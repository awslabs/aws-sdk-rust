...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_third_party_firewall_association_status_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusOutput, crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError>{
    Ok({
        #[allow(unused_mut)]
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "MarketplaceOnboardingStatus" => {
                        builder = builder.set_marketplace_onboarding_status(
                            ...
                            .map(|s| {
                                s.to_unescaped().map(|u| {
                                    crate::types::MarketplaceSubscriptionOnboardingStatus::from(
                                        u.as_ref(),
                                    )
                                })
                            })
