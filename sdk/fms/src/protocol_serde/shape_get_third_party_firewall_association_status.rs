...
pub fn ser_get_third_party_firewall_association_status_input(
    ...
    crate::protocol_serde::shape_get_third_party_firewall_association_status_input::ser_get_third_party_firewall_association_status_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError::InternalErrorException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_internal_error_exception::de_internal_error_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_third_party_firewall_association_status_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_third_party_firewall_association_status::de_get_third_party_firewall_association_status(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_third_party_firewall_association_status::GetThirdPartyFirewallAssociationStatusError::unhandled)?;
                ...
                "MarketplaceOnboardingStatus" => {
                    builder = builder.set_marketplace_onboarding_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::MarketplaceSubscriptionOnboardingStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                    );
                }
