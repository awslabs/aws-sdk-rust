...
pub fn ser_list_third_party_firewall_firewall_policies_input(
    ...
    crate::protocol_serde::shape_list_third_party_firewall_firewall_policies_input::ser_list_third_party_firewall_firewall_policies_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPoliciesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPoliciesError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPoliciesError::InternalErrorException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_internal_error_exception::de_internal_error_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPoliciesError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_third_party_firewall_firewall_policies_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_third_party_firewall_firewall_policies::de_list_third_party_firewall_firewall_policies(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_third_party_firewall_firewall_policies::ListThirdPartyFirewallFirewallPoliciesError::unhandled)?;
