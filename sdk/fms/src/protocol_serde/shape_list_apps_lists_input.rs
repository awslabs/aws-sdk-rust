...
pub fn ser_list_apps_lists_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_apps_lists::ListAppsListsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
