...
pub fn ser_list_protocols_lists_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListProtocolsListsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
