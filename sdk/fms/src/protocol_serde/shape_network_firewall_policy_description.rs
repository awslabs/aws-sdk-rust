...
pub(crate) fn de_network_firewall_policy_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NetworkFirewallPolicyDescription>, aws_smithy_json::deserialize::error::DeserializeError>
