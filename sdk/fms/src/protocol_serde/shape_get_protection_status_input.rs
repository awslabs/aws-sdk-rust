...
pub fn ser_get_protection_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetProtectionStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
