...
pub fn ser_put_resource_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::put_resource_set::PutResourceSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
