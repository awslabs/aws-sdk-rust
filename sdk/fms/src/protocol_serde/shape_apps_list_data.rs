...
pub(crate) fn de_apps_list_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AppsListData>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_apps_list_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AppsListData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
