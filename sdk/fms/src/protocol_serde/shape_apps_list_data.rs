...
pub(crate) fn de_apps_list_data<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AppsListData>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::apps_list_data_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_apps_list_data(
    ...
    if let Some(var_3) = &input.create_time {
        object.key("CreateTime").date_time(var_3, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_4) = &input.last_update_time {
        object.key("LastUpdateTime").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
     {
