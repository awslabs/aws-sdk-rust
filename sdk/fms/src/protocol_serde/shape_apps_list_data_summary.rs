...
pub(crate) fn de_apps_list_data_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AppsListDataSummary>, aws_smithy_json::deserialize::error::DeserializeError>
