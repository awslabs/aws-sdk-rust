...
impl super::Client {
    ...
    ///   - [`policy_id(impl Into<String>)`](crate::operation::get_violation_details::builders::GetViolationDetailsFluentBuilder::policy_id) / [`set_policy_id(Option<String>)`](crate::operation::get_violation_details::builders::GetViolationDetailsFluentBuilder::set_policy_id):<br>required: **true**<br><p>The ID of the Firewall Manager policy that you want the details for. This currently only supports security group content audit policies.</p><br>
