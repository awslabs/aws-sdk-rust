...
impl super::Client {
    ...
    ///   - [`policy_id(impl ::std::convert::Into<String>)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::policy_id) / [`set_policy_id(Option<String>)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::set_policy_id): <p>The ID of the Firewall Manager policy that you want the details for.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::set_next_token): <p>If you specify a value for <code>MaxResults</code> and you have more <code>PolicyComplianceStatus</code> objects than the number that you specify for <code>MaxResults</code>, Firewall Manager returns a <code>NextToken</code> value in the response that allows you to list another group of <code>PolicyComplianceStatus</code> objects. For the second and subsequent <code>ListComplianceStatus</code> requests, specify the value of <code>NextToken</code> from the previous response to get information about another batch of <code>PolicyComplianceStatus</code> objects.</p>
    ///   - [`max_results(i32)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_compliance_status::builders::ListComplianceStatusFluentBuilder::set_max_results): <p>Specifies the number of <code>PolicyComplianceStatus</code> objects that you want Firewall Manager to return for this request. If you have more <code>PolicyComplianceStatus</code> objects than the number that you specify for <code>MaxResults</code>, the response includes a <code>NextToken</code> value that you can use to get another batch of <code>PolicyComplianceStatus</code> objects.</p>
