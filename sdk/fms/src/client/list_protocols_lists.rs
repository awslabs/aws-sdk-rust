...
impl super::Client {
    ...
    ///   - [`default_lists(bool)`](crate::operation::list_protocols_lists::builders::ListProtocolsListsFluentBuilder::default_lists) / [`set_default_lists(Option<bool>)`](crate::operation::list_protocols_lists::builders::ListProtocolsListsFluentBuilder::set_default_lists): <p>Specifies whether the lists to retrieve are default lists owned by Firewall Manager.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_protocols_lists::builders::ListProtocolsListsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_protocols_lists::builders::ListProtocolsListsFluentBuilder::set_next_token): <p>If you specify a value for <code>MaxResults</code> in your list request, and you have more objects than the maximum, Firewall Manager returns this token in the response. For all but the first request, you provide the token returned by the prior request in the request parameters, to retrieve the next batch of objects.</p>
