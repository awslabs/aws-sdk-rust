...
impl super::Client {
    ...
    ///   - [`list_id(impl ::std::convert::Into<String>)`](crate::operation::delete_protocols_list::builders::DeleteProtocolsListFluentBuilder::list_id) / [`set_list_id(Option<String>)`](crate::operation::delete_protocols_list::builders::DeleteProtocolsListFluentBuilder::set_list_id): <p>The ID of the protocols list that you want to delete. You can retrieve this ID from <code>PutProtocolsList</code>, <code>ListProtocolsLists</code>, and <code>GetProtocolsLost</code>.</p>
    ...
    pub fn delete_protocols_list(
        &self,
    ) -> crate::operation::delete_protocols_list::builders::DeleteProtocolsListFluentBuilder {
        crate::operation::delete_protocols_list::builders::DeleteProtocolsListFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
