...
impl super::Client {
    ...
    ///   - [`tag_list(Tag)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::tag_list) / [`set_tag_list(Option<Vec<Tag>>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::set_tag_list): <p>The tags to add to the resource.</p>
