...
impl super::Client {
    ...
    ///   - [`resource_set(ResourceSet)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::resource_set) / [`set_resource_set(Option<ResourceSet>)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::set_resource_set):<br>required: **true**<br><p>Details about the resource set to be created or updated.&gt;</p><br>
    ///   - [`tag_list(Tag)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::tag_list) / [`set_tag_list(Option<Vec::<Tag>>)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::set_tag_list):<br>required: **false**<br><p>Retrieves the tags associated with the specified resource set. Tags are key:value pairs that you can use to categorize and manage your resources, for purposes like billing. For example, you might set the tag key to "customer" and the value to the customer name or ID. You can specify one or more tags to add to each Amazon Web Services resource, up to 50 tags for a resource.</p><br>
    ...
    ///   - [`resource_set_arn(String)`](crate::operation::put_resource_set::PutResourceSetOutput::resource_set_arn): <p>The Amazon Resource Name (ARN) of the resource set.</p>
