...
impl super::Client {
    ...
    ///   - [`tag_list(Tag)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::tag_list) / [`set_tag_list(Option<Vec<Tag>>)`](crate::operation::put_resource_set::builders::PutResourceSetFluentBuilder::set_tag_list): <p>Retrieves the tags associated with the specified resource set. Tags are key:value pairs that you can use to categorize and manage your resources, for purposes like billing. For example, you might set the tag key to "customer" and the value to the customer name or ID. You can specify one or more tags to add to each Amazon Web Services resource, up to 50 tags for a resource.</p>
