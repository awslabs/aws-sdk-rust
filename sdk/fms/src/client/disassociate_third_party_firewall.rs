...
impl super::Client {
    ...
    ///   - [`third_party_firewall(ThirdPartyFirewall)`](crate::operation::disassociate_third_party_firewall::builders::DisassociateThirdPartyFirewallFluentBuilder::third_party_firewall) / [`set_third_party_firewall(Option<ThirdPartyFirewall>)`](crate::operation::disassociate_third_party_firewall::builders::DisassociateThirdPartyFirewallFluentBuilder::set_third_party_firewall):<br>required: **true**<br><p>The name of the third-party firewall vendor.</p><br>
