...
impl super::Client {
    ...
    ///   - [`list_id(impl ::std::convert::Into<String>)`](crate::operation::get_protocols_list::builders::GetProtocolsListFluentBuilder::list_id) / [`set_list_id(Option<String>)`](crate::operation::get_protocols_list::builders::GetProtocolsListFluentBuilder::set_list_id): <p>The ID of the Firewall Manager protocols list that you want the details for.</p>
