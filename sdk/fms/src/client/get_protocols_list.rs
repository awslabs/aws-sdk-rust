...
impl super::Client {
    ...
    pub fn get_protocols_list(
        &self,
    ) -> crate::operation::get_protocols_list::builders::GetProtocolsListFluentBuilder {
        crate::operation::get_protocols_list::builders::GetProtocolsListFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
