...
impl super::Client  {
    ...
    ///   - [`admin_account(impl Into<String>)`](crate::operation::get_admin_scope::builders::GetAdminScopeFluentBuilder::admin_account) / [`set_admin_account(Option<String>)`](crate::operation::get_admin_scope::builders::GetAdminScopeFluentBuilder::set_admin_account): <p>The administator account that you want to get the details for.</p>
