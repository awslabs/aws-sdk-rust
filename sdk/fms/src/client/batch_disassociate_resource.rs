...
impl super::Client {
    ...
    ///   - [`resource_set_identifier(impl ::std::convert::Into<String>)`](crate::operation::batch_disassociate_resource::builders::BatchDisassociateResourceFluentBuilder::resource_set_identifier) / [`set_resource_set_identifier(Option<String>)`](crate::operation::batch_disassociate_resource::builders::BatchDisassociateResourceFluentBuilder::set_resource_set_identifier): <p>A unique identifier for the resource set, used in a request to refer to the resource set.</p>
