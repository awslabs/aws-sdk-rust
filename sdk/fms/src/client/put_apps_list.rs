...
impl super::Client {
    ...
    ///   - [`tag_list(Tag)`](crate::operation::put_apps_list::builders::PutAppsListFluentBuilder::tag_list) / [`set_tag_list(Option<Vec<Tag>>)`](crate::operation::put_apps_list::builders::PutAppsListFluentBuilder::set_tag_list): <p>The tags associated with the resource.</p>
