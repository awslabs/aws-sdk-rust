...
pub(crate) fn reflens_structure_crate_output_list_apps_lists_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_list_compliance_status_output_next_token(
    input: &crate::output::ListComplianceStatusOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn reflens_structure_crate_output_list_protocols_lists_output_next_token(
...
pub(crate) fn lens_structure_crate_output_list_compliance_status_output_policy_compliance_status_list(
    input: crate::output::ListComplianceStatusOutput,
...
pub(crate) fn lens_structure_crate_output_list_member_accounts_output_member_accounts(
    input: crate::output::ListMemberAccountsOutput,
...
pub(crate) fn lens_structure_crate_output_list_policies_output_policy_list(
    input: crate::output::ListPoliciesOutput,
) -> std::option::Option<std::vec::Vec<crate::model::PolicySummary>> {
...
pub(crate) fn lens_structure_crate_output_list_protocols_lists_output_protocols_lists(
    input: crate::output::ListProtocolsListsOutput,
