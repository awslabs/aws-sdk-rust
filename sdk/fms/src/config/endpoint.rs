...
mod test {
    ...
    fn test_55() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://fms-fips.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_57() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://fms.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_59() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://fms-fips.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
    ...
    fn test_61() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://fms.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
...
/// Endpoint resolver trait specific to Firewall Management Service
