...
pub fn de_describe_schema_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeSchemaOutput, crate::error::DescribeSchemaError> {
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => crate::error::DescribeSchemaError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::DescribeSchemaError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
