...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions(_response_body, output)
            .map_err(crate::operation::list_schema_versions::ListSchemaVersionsError::unhandled)?;
...
) -> Result<crate::operation::list_schema_versions::builders::ListSchemaVersionsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
