...
pub fn ser_create_discoverer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDiscovererInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
