...
pub fn de_put_code_binding_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_put_code_binding::de_put_code_binding(_response_body, output)
            .map_err(crate::operation::put_code_binding::PutCodeBindingError::unhandled)?;
...
) -> Result<crate::operation::put_code_binding::builders::PutCodeBindingOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
