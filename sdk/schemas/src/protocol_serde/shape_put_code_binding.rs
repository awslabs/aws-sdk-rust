...
pub fn de_put_code_binding_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutCodeBindingOutput, crate::error::PutCodeBindingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutCodeBindingError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_gone_exception::de_gone_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PutCodeBindingError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "InternalServerErrorException" => crate::error::PutCodeBindingError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::error::PutCodeBindingError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_code_binding_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutCodeBindingOutput, crate::error::PutCodeBindingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::put_code_binding_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_put_code_binding::de_put_code_binding(response.body().as_ref(), output).map_err(crate::error::PutCodeBindingError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_put_code_binding(value: &[u8], mut builder: crate::output::put_code_binding_output::Builder) -> Result<crate::output::put_code_binding_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
