...
pub fn de_search_schemas_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SearchSchemasOutput, crate::error::SearchSchemasError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::SearchSchemasError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_search_schemas_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SearchSchemasOutput, crate::error::SearchSchemasError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::search_schemas_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_search_schemas::de_search_schemas(response.body().as_ref(), output).map_err(crate::error::SearchSchemasError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_search_schemas(value: &[u8], mut builder: crate::output::search_schemas_output::Builder) -> Result<crate::output::search_schemas_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
