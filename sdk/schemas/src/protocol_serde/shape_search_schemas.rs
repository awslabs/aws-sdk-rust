...
pub fn de_search_schemas_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::search_schemas::SearchSchemasOutput, crate::operation::search_schemas::SearchSchemasError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_search_schemas_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::search_schemas::SearchSchemasOutput, crate::operation::search_schemas::SearchSchemasError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_search_schemas::de_search_schemas(_response_body, output)
            .map_err(crate::operation::search_schemas::SearchSchemasError::unhandled)?;
...
) -> Result<crate::operation::search_schemas::builders::SearchSchemasOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Schemas" => {
                    builder = builder
                        .set_schemas(crate::protocol_serde::shape___list_of_search_schema_summary::de___list_of_search_schema_summary(tokens)?);
                }
