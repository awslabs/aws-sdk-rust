...
pub fn de_list_schemas_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSchemasOutput, crate::error::ListSchemasError> {
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => crate::error::ListSchemasError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::ListSchemasError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
