...
pub fn de_update_schema_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_schema::UpdateSchemaOutput, crate::operation::update_schema::UpdateSchemaError> {
    #[allow(unused_mut)]
...
pub fn de_update_schema_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_schema::de_update_schema(_response_body, output)
            .map_err(crate::operation::update_schema::UpdateSchemaError::unhandled)?;
...
) -> Result<crate::operation::update_schema::builders::UpdateSchemaOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
