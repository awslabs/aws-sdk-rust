...
pub struct UpdateSchemaOutput {
    ...
    pub version_created_date: std::option::Option<smithy_types::Instant>,
}
...
pub mod update_schema_output {
    ...
    pub struct Builder {
        ...
        pub(crate) version_created_date: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The description of the schema.</p>
        ...
        /// <p>The date the schema version was created.</p>
        pub fn version_created_date(mut self, input: smithy_types::Instant) -> Self {
