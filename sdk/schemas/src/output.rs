...
pub struct UpdateSchemaOutput  {
    ...
    #[doc(hidden)]pub version_created_date: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct SearchSchemasOutput  {
    ...
    #[doc(hidden)]pub schemas: std::option::Option<std::vec::Vec<crate::model::SearchSchemaSummary>>,
}
...
pub struct PutCodeBindingOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CodeGenerationStatus>,
}
...
pub struct ListSchemaVersionsOutput  {
    ...
    #[doc(hidden)]pub schema_versions: std::option::Option<std::vec::Vec<crate::model::SchemaVersionSummary>>,
}
...
pub struct ListSchemasOutput  {
    ...
    #[doc(hidden)]pub schemas: std::option::Option<std::vec::Vec<crate::model::SchemaSummary>>,
}
...
pub struct ListRegistriesOutput  {
    ...
    #[doc(hidden)]pub registries: std::option::Option<std::vec::Vec<crate::model::RegistrySummary>>,
}
...
pub struct ListDiscoverersOutput  {
    ...
    #[doc(hidden)]pub discoverers: std::option::Option<std::vec::Vec<crate::model::DiscovererSummary>>,
    /// <p>The token that specifies the next page of results to return. To request the first page, leave NextToken empty. The token will expire in 24 hours, and cannot be shared with other accounts.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
