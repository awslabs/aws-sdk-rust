...
impl StartDiscovererFluentBuilder  {
    /// Creates a new `StartDiscoverer`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::start_discoverer::StartDiscovererOutput, aws_smithy_http::result::SdkError<crate::operation::start_discoverer::StartDiscovererError>>
                     {
