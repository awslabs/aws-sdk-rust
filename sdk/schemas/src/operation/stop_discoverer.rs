...
impl StopDiscovererInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_discoverer::StopDiscoverer, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDiscoverer {
    type Output =
        ::std::result::Result<crate::operation::stop_discoverer::StopDiscovererOutput, crate::operation::stop_discoverer::StopDiscovererError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_discoverer::de_stop_discoverer_http_response_with_props(status, headers, body)
        }
    }
}
