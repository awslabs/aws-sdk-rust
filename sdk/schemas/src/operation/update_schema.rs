...
impl UpdateSchemaInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_schema::UpdateSchema, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        if self.client_token_id.is_none() {
            self.client_token_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_schema::ser_update_schema_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSchema {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_schema::de_update_schema_http_response_with_props(status, headers, body)
        }
    }
}
