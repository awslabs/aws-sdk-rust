...
impl UpdateSchemaInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_schema::UpdateSchema::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSchema {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_schema::de_update_schema_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_schema::de_update_schema_http_response_with_props(
                status, headers, body,
            )
        }
    }
