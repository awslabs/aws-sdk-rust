...
impl UpdateRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_registry::UpdateRegistry, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_registry::ser_update_registry_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_registry::de_update_registry_http_response_with_props(status, headers, body)
        }
    }
}
