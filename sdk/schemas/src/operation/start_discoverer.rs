...
impl StartDiscovererInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_discoverer::StartDiscoverer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDiscoverer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_discoverer::de_start_discoverer_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_discoverer::StartDiscovererError
{
