...
impl DeleteDiscovererInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_discoverer::DeleteDiscoverer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDiscoverer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_discoverer::de_delete_discoverer_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_discoverer::DeleteDiscovererError
{
