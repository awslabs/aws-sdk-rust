...
impl CreateRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_registry::CreateRegistry,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_registry::CreateRegistry::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_registry::de_create_registry_http_error(
                status, headers, body,
            )
        } else {
