...
impl CreateRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_registry::CreateRegistry, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_registry::ser_create_registry_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_registry::de_create_registry_http_response_with_props(status, headers, body)
        }
    }
}
