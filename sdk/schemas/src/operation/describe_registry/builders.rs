...
impl DescribeRegistryFluentBuilder  {
    /// Creates a new `DescribeRegistry`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_registry::DescribeRegistryOutput, aws_smithy_http::result::SdkError<crate::operation::describe_registry::DescribeRegistryError>>
                     {
