    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_schema_versions::ListSchemaVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_schema_versions::ListSchemaVersionsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/registries/name/{RegistryName}/schemas/name/{SchemaName}/versions", RegistryName = registry_name, SchemaName = schema_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_schema_versions::ListSchemaVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_schema_versions::ListSchemaVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSchemaVersions", "schemas"));
