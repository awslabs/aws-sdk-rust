...
impl ListDiscoverersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_discoverers::ListDiscoverers, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDiscoverers {
    type Output =
        ::std::result::Result<crate::operation::list_discoverers::ListDiscoverersOutput, crate::operation::list_discoverers::ListDiscoverersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_discoverers::de_list_discoverers_http_response_with_props(status, headers, body)
        }
    }
}
