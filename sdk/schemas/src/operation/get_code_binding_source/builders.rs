...
pub use crate::operation::get_code_binding_source::_get_code_binding_source_output::GetCodeBindingSourceOutputBuilder;
...
pub struct GetCodeBindingSourceFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_code_binding_source::builders::GetCodeBindingSourceInputBuilder,
...
impl GetCodeBindingSourceFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_code_binding_source::builders::GetCodeBindingSourceInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_code_binding_source::GetCodeBindingSourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_code_binding_source::GetCodeBindingSourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_code_binding_source::GetCodeBindingSource::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_code_binding_source::GetCodeBindingSource::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_code_binding_source::GetCodeBindingSourceOutput, crate::operation::get_code_binding_source::GetCodeBindingSourceError, Self> {
