...
impl GetCodeBindingSourceFluentBuilder  {
    /// Creates a new `GetCodeBindingSource`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_code_binding_source::GetCodeBindingSource, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_code_binding_source::GetCodeBindingSourceError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_code_binding_source::GetCodeBindingSourceOutput, aws_smithy_http::result::SdkError<crate::operation::get_code_binding_source::GetCodeBindingSourceError>>
                     {
