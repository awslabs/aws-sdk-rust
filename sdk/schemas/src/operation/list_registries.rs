...
impl ListRegistries {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("schemas", "ListRegistries", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRegistries {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListRegistries", "schemas"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRegistriesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("RegistryNamePrefix") {
            if let ::std::option::Option::Some(value) = input.registry_name_prefix.as_deref() {
                captured.insert("RegistryNamePrefix", value);
            }
        }
