...
impl ListRegistriesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_registries::ListRegistries, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::list_registries::ListRegistriesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_2) = &_input.registry_name_prefix {
                     {
                        query.push_kv("registryNamePrefix", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
