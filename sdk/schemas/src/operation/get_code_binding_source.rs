...
impl GetCodeBindingSourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_code_binding_source::GetCodeBindingSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCodeBindingSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_code_binding_source::de_get_code_binding_source_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_code_binding_source::GetCodeBindingSourceError
{
