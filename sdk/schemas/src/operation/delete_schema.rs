...
impl DeleteSchemaInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_schema::DeleteSchema::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSchema {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_schema::de_delete_schema_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_schema::de_delete_schema_http_response_with_props(
                status, headers, body,
            )
        }
    }
