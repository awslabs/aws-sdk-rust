    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_schemas::ListSchemas, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_schemas::ListSchemasInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/registries/name/{RegistryName}/schemas", RegistryName = registry_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_schemas::ListSchemasInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.schema_name_prefix {
                     {
                        query.push_kv("schemaNamePrefix", &aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_schemas::ListSchemas::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSchemas", "schemas"));
