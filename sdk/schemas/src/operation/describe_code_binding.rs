...
impl DescribeCodeBindingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_code_binding::DescribeCodeBinding::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCodeBinding {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_code_binding::de_describe_code_binding_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_code_binding::DescribeCodeBindingError
{
