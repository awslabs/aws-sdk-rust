...
impl CreateDiscovererInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_discoverer::CreateDiscoverer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDiscoverer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_discoverer::de_create_discoverer_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_discoverer::CreateDiscovererError
{
