...
impl CreateDiscovererInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_discoverer::CreateDiscoverer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_discoverer::ser_create_discoverer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDiscoverer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_discoverer::de_create_discoverer_http_response_with_props(status, headers, body)
        }
    }
}
