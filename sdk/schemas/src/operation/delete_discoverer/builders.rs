...
impl DeleteDiscovererFluentBuilder  {
    /// Creates a new `DeleteDiscoverer`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_discoverer::DeleteDiscoverer, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_discoverer::DeleteDiscovererOutput, aws_smithy_http::result::SdkError<crate::operation::delete_discoverer::DeleteDiscovererError>>
                     {
