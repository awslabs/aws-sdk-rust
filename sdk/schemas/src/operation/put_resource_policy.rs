...
fn uri_query(_input: &crate::operation::put_resource_policy::PutResourcePolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
