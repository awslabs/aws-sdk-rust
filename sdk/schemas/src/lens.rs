...
pub(crate) fn reflens_list_discoverers_output_next_token(
...
pub(crate) fn reflens_search_schemas_output_next_token(
...
pub(crate) fn lens_list_discoverers_output_discoverers(
    input: crate::operation::list_discoverers::ListDiscoverersOutput,
...
pub(crate) fn lens_list_schema_versions_output_schema_versions(
    input: crate::operation::list_schema_versions::ListSchemaVersionsOutput,
...
pub(crate) fn lens_search_schemas_output_schemas(
    input: crate::operation::search_schemas::SearchSchemasOutput,
