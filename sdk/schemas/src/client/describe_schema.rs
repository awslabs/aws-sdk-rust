...
impl super::Client {
    ...
    ///   - [`registry_name(impl Into<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::set_registry_name):<br>required: **true**<br><p>The name of the registry.</p><br>
    ///   - [`schema_name(impl Into<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::schema_name) / [`set_schema_name(Option<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::set_schema_name):<br>required: **true**<br><p>The name of the schema.</p><br>
