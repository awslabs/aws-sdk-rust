...
impl super::Client {
    ...
    ///   - [`registry_name(impl Into<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::set_registry_name):<br>required: **false**<br><p>The name of the registry.</p><br>
