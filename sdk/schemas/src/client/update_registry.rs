...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_registry::builders::UpdateRegistryFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_registry::builders::UpdateRegistryFluentBuilder::set_description): <p>The description of the registry to update.</p>
    ///   - [`registry_name(impl ::std::convert::Into<String>)`](crate::operation::update_registry::builders::UpdateRegistryFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::update_registry::builders::UpdateRegistryFluentBuilder::set_registry_name): <p>The name of the registry.</p>
