...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder::set_description): <p>The description of the discoverer to update.</p>
    ///   - [`discoverer_id(impl ::std::convert::Into<String>)`](crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder::discoverer_id) / [`set_discoverer_id(Option<String>)`](crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder::set_discoverer_id): <p>The ID of the discoverer.</p>
    ...
    pub fn update_discoverer(
        &self,
    ) -> crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder {
        crate::operation::update_discoverer::builders::UpdateDiscovererFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
