...
impl super::Client {
    ...
    ///   - [`registry_name(impl Into<String>)`](crate::operation::delete_resource_policy::builders::DeleteResourcePolicyFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::delete_resource_policy::builders::DeleteResourcePolicyFluentBuilder::set_registry_name):<br>required: **false**<br><p>The name of the registry.</p><br>
