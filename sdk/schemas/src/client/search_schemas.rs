...
impl super::Client {
    ...
    ///   - [`keywords(impl ::std::convert::Into<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::keywords) / [`set_keywords(Option<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::set_keywords): <p>Specifying this limits the results to only schemas that include the provided keywords.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::set_next_token): <p>The token that specifies the next page of results to return. To request the first page, leave NextToken empty. The token will expire in 24 hours, and cannot be shared with other accounts.</p>
    ///   - [`registry_name(impl ::std::convert::Into<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::search_schemas::builders::SearchSchemasFluentBuilder::set_registry_name): <p>The name of the registry.</p>
