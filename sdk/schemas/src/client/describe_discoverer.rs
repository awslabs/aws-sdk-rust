...
impl super::Client {
    ...
    pub fn describe_discoverer(
        &self,
    ) -> crate::operation::describe_discoverer::builders::DescribeDiscovererFluentBuilder {
        crate::operation::describe_discoverer::builders::DescribeDiscovererFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
