...
pub fn deser_structure_crate_error_request_in_progress_exceptionjson_err(
    input: &[u8],
...
pub fn deser_structure_crate_error_invalid_domain_validation_options_exceptionjson_err(
    input: &[u8],
