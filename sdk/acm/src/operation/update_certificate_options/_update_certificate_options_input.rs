...
impl UpdateCertificateOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_certificate_options::UpdateCertificateOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
