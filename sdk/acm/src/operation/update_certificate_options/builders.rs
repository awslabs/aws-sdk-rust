...
impl UpdateCertificateOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_certificate_options::UpdateCertificateOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_certificate_options::UpdateCertificateOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_certificate_options::UpdateCertificateOptionsOutput, crate::operation::update_certificate_options::UpdateCertificateOptionsError, Self> {
