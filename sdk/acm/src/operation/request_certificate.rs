...
impl RequestCertificateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::request_certificate::RequestCertificate,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_request_certificate::ser_request_certificate_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_request_certificate::de_request_certificate_http_response_with_props(status, headers, body)
        }
    }
}
