...
impl RequestCertificateInput {
    /// Consumes the builder and constructs an Operation<[`RequestCertificate`](crate::operation::request_certificate::RequestCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::request_certificate::RequestCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_certificate::RequestCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::request_certificate::RequestCertificate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RequestCertificate {
                type Output = std::result::Result<crate::operation::request_certificate::RequestCertificateOutput, crate::operation::request_certificate::RequestCertificateError>;
