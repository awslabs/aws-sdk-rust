...
impl ExportCertificateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_export_certificate::ser_export_certificate_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_certificate::de_export_certificate_http_response_with_props(status, headers, body)
        }
    }
