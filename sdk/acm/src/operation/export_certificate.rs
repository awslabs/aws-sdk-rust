...
impl ExportCertificateInput {
    /// Consumes the builder and constructs an Operation<[`ExportCertificate`](crate::operation::export_certificate::ExportCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::export_certificate::ExportCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_certificate::ExportCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::export_certificate::ExportCertificate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExportCertificate {
                type Output = std::result::Result<crate::operation::export_certificate::ExportCertificateOutput, crate::operation::export_certificate::ExportCertificateError>;
