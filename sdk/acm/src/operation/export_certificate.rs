...
impl ExportCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_certificate::ExportCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_export_certificate::de_export_certificate_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::export_certificate::ExportCertificateError
{
