...
///
/// <p>Adds one or more tags to an ACM resource. Tags are labels that you can use to identify and organize your Amazon Web Services resources. Each tag consists of a <code>key</code> and an optional <code>value</code>.</p><note>
/// <p>Use this action for all ACM resource types except the <code>certificate</code> resource type. For certificate resources, use <code>AddTagsToCertificate</code> instead.</p>
/// </note>
/// <p>To remove one or more tags, use the <code>UntagResource</code> action. To view all of the tags that have been applied to a resource, use the <code>ListTagsForResource</code> action.</p>
