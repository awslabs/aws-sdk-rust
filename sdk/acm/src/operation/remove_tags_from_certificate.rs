...
impl RemoveTagsFromCertificateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTagsFromCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_tags_from_certificate::de_remove_tags_from_certificate_http_response_with_props(status, headers, body)
        }
    }
}
