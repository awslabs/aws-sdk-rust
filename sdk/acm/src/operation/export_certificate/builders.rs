...
impl ExportCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::export_certificate::ExportCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_certificate::ExportCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::export_certificate::ExportCertificateOutput, crate::operation::export_certificate::ExportCertificateError, Self> {
