...
///
/// <p>Lists the tags associated with an ACM resource.</p><note>
/// <p>Use this action for all ACM resource types except the <code>certificate</code> resource type. For certificate resources, use <code>ListTagsForCertificate</code> instead.</p>
/// </note>
/// <p>To add one or more tags, use the <code>TagResource</code> action. To remove one or more tags, use the <code>UntagResource</code> action.</p>
