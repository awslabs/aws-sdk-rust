...
impl AddTagsToCertificateInput {
    /// Consumes the builder and constructs an Operation<[`AddTagsToCertificate`](crate::operation::add_tags_to_certificate::AddTagsToCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_tags_to_certificate::AddTagsToCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_tags_to_certificate::AddTagsToCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_certificate::AddTagsToCertificate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddTagsToCertificate {
                type Output = std::result::Result<crate::operation::add_tags_to_certificate::AddTagsToCertificateOutput, crate::operation::add_tags_to_certificate::AddTagsToCertificateError>;
