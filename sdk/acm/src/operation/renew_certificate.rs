...
impl RenewCertificateInput {
    /// Consumes the builder and constructs an Operation<[`RenewCertificate`](crate::operation::renew_certificate::RenewCertificate)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::renew_certificate::RenewCertificate, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_renew_certificate::ser_renew_certificate_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::renew_certificate::RenewCertificate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RenewCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_renew_certificate::de_renew_certificate_http_response_with_props(status, headers, body)
        }
    }
}
