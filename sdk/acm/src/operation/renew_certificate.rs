...
impl RenewCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::renew_certificate::RenewCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RenewCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_renew_certificate::de_renew_certificate_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::renew_certificate::RenewCertificateError
{
