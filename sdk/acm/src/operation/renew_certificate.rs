...
impl RenewCertificate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::renew_certificate::RenewCertificateInput,
                    ) -> ::std::result::Result<crate::operation::renew_certificate::RenewCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::renew_certificate::RenewCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::renew_certificate::RenewCertificateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::renew_certificate::RenewCertificateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RenewCertificate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RenewCertificate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RenewCertificateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RenewCertificateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RenewCertificate")
...
.with_interceptor(RenewCertificateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::renew_certificate::RenewCertificateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::renew_certificate::RenewCertificateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::renew_certificate::RenewCertificateError>::new());
...
#[derive(Debug)]
            struct RenewCertificateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RenewCertificateResponseDeserializer {
...
#[derive(Debug)]
            struct RenewCertificateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RenewCertificateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::renew_certificate::RenewCertificateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::renew_certificate::RenewCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_renew_certificate::ser_renew_certificate_input(&input)?);
...
#[derive(Debug)]
            struct RenewCertificateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RenewCertificateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RenewCertificateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RenewCertificateInput>()
                        .ok_or("failed to downcast to RenewCertificateInput")?;
...
pub enum RenewCertificateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RenewCertificateError) for what information is available for the error.")]
...
impl RenewCertificateError {
    /// Creates the `RenewCertificateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RenewCertificateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RenewCertificateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::renew_certificate::RenewCertificateError {
