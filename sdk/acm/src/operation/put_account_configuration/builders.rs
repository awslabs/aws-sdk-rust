...
impl PutAccountConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_account_configuration::PutAccountConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_account_configuration::PutAccountConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_account_configuration::PutAccountConfigurationOutput, crate::operation::put_account_configuration::PutAccountConfigurationError, Self> {
