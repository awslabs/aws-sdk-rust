...
/// Orchestration and serialization glue logic for `ResendValidationEmail`.
...
impl ResendValidationEmail {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::resend_validation_email::ResendValidationEmailOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resend_validation_email::ResendValidationEmailError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::resend_validation_email::ResendValidationEmailError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::resend_validation_email::ResendValidationEmailOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResendValidationEmail {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResendValidationEmail");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResendValidationEmailRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResendValidationEmailResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResendValidationEmail")
...
.with_interceptor(ResendValidationEmailEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::resend_validation_email::ResendValidationEmailError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::resend_validation_email::ResendValidationEmailError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::resend_validation_email::ResendValidationEmailError>::new());
...
#[derive(Debug)]
            struct ResendValidationEmailResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResendValidationEmailResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_resend_validation_email::de_resend_validation_email_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ResendValidationEmailRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResendValidationEmailRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::resend_validation_email::ResendValidationEmailInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::resend_validation_email::ResendValidationEmailInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_resend_validation_email::ser_resend_validation_email_input(&input)?);
...
#[derive(Debug)]
            struct ResendValidationEmailEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResendValidationEmailEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResendValidationEmailEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResendValidationEmailInput>()
                        .ok_or("failed to downcast to ResendValidationEmailInput")?;
...
pub enum ResendValidationEmailError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResendValidationEmailError) for what information is available for the error.")]
...
impl ResendValidationEmailError {
    /// Creates the `ResendValidationEmailError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResendValidationEmailError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResendValidationEmailError {
...
impl ::aws_types::request_id::RequestId for crate::operation::resend_validation_email::ResendValidationEmailError {
