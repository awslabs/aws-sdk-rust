...
impl ResendValidationEmailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::resend_validation_email::ResendValidationEmail,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResendValidationEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resend_validation_email::de_resend_validation_email_http_response_with_props(status, headers, body)
        }
    }
}
