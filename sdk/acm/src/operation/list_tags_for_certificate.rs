...
/// Orchestration and serialization glue logic for `ListTagsForCertificate`.
...
impl ListTagsForCertificate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_tags_for_certificate::ListTagsForCertificateInput,
                    ) -> ::std::result::Result<crate::operation::list_tags_for_certificate::ListTagsForCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_tags_for_certificate::ListTagsForCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_tags_for_certificate::ListTagsForCertificateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_tags_for_certificate::ListTagsForCertificateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForCertificate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListTagsForCertificate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListTagsForCertificateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTagsForCertificateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTagsForCertificate")
...
.with_interceptor(ListTagsForCertificateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_tags_for_certificate::ListTagsForCertificateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_tags_for_certificate::ListTagsForCertificateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_tags_for_certificate::ListTagsForCertificateError>::new());
...
#[derive(Debug)]
            struct ListTagsForCertificateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTagsForCertificateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_tags_for_certificate::ListTagsForCertificateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_tags_for_certificate::ListTagsForCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_tags_for_certificate::ser_list_tags_for_certificate_input(&input)?);
...
#[derive(Debug)]
            struct ListTagsForCertificateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTagsForCertificateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListTagsForCertificateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListTagsForCertificateInput>()
                        .ok_or("failed to downcast to ListTagsForCertificateInput")?;
...
pub enum ListTagsForCertificateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListTagsForCertificateError) for what information is available for the error.")]
...
impl ListTagsForCertificateError {
    /// Creates the `ListTagsForCertificateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListTagsForCertificateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListTagsForCertificateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_tags_for_certificate::ListTagsForCertificateError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_tags_for_certificate::_list_tags_for_certificate_output::ListTagsForCertificateOutput;

pub use crate::operation::list_tags_for_certificate::_list_tags_for_certificate_input::ListTagsForCertificateInput;

mod _list_tags_for_certificate_input;

mod _list_tags_for_certificate_output;
