...
impl RemoveTagsFromCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificateOutput, crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificateError, Self> {
