...
impl RemoveTagsFromCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_tags_from_certificate::RemoveTagsFromCertificateInput, ::aws_smithy_types::error::operation::BuildError> {
