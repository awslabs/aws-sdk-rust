...
impl super::Client {
    ...
    ///   - [`idempotency_token(impl Into<String>)`](crate::operation::put_account_configuration::builders::PutAccountConfigurationFluentBuilder::idempotency_token) / [`set_idempotency_token(Option<String>)`](crate::operation::put_account_configuration::builders::PutAccountConfigurationFluentBuilder::set_idempotency_token):<br>required: **true**<br><p>Customer-chosen string used to distinguish between calls to <code>PutAccountConfiguration</code>. Idempotency tokens time out after one hour. If you call <code>PutAccountConfiguration</code> multiple times with the same unexpired idempotency token, ACM treats it as the same request and returns the original result. If you change the idempotency token for each call, ACM treats each call as a new request.</p><br>
