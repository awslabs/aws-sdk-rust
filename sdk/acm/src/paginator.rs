...
/// Flattened paginator for `ListCertificatesPaginator`
                ...
                impl  ListCertificatesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::CertificateSummary, aws_smithy_http::result::SdkError<crate::error::ListCertificatesError>>> + Unpin
                     {
