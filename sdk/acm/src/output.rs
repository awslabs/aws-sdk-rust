...
pub struct ListCertificatesOutput  {
    ...
    #[doc(hidden)]pub certificate_summary_list: std::option::Option<std::vec::Vec<crate::model::CertificateSummary>>,
}
...
pub struct DescribeCertificateOutput  {
    ...
    #[doc(hidden)]pub certificate: std::option::Option<crate::model::CertificateDetail>,
}
