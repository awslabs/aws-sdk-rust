...
pub struct AcmeEndpointSummary {
...
impl AcmeEndpointSummary {
    /// Creates a new builder-style object to manufacture [`AcmeEndpointSummary`](crate::types::AcmeEndpointSummary).
    pub fn builder() -> crate::types::builders::AcmeEndpointSummaryBuilder {
        crate::types::builders::AcmeEndpointSummaryBuilder::default()
    }
}

/// A builder for [`AcmeEndpointSummary`](crate::types::AcmeEndpointSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AcmeEndpointSummaryBuilder {
...
impl AcmeEndpointSummaryBuilder {
    /// <p>The Amazon Resource Name (ARN) of the ACME endpoint.</p>
    ...
    /// Consumes the builder and constructs a [`AcmeEndpointSummary`](crate::types::AcmeEndpointSummary).
    pub fn build(self) -> crate::types::AcmeEndpointSummary {
        crate::types::AcmeEndpointSummary {
