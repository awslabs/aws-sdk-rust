...
/// match updatestatus {
///     UpdateStatus::Failed => { /* ... */ },
///     UpdateStatus::PendingDomainValidation => { /* ... */ },
...
impl ::std::convert::From<&str> for UpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING_DOMAIN_VALIDATION" => UpdateStatus::PendingDomainValidation,
...
impl UpdateStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            UpdateStatus::PendingDomainValidation => "PENDING_DOMAIN_VALIDATION",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["FAILED", "PENDING_DOMAIN_VALIDATION", "SUCCESS"]
    }
}
...
impl ::std::fmt::Display for UpdateStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            UpdateStatus::PendingDomainValidation => write!(f, "PENDING_DOMAIN_VALIDATION"),
