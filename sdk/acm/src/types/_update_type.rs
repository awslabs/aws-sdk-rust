...
/// match updatetype {
///     UpdateType::DomainValidationMethod => { /* ... */ },
...
impl ::std::convert::From<&str> for UpdateType {
    fn from(s: &str) -> Self {
        match s {
            "DOMAIN_VALIDATION_METHOD" => UpdateType::DomainValidationMethod,
...
impl UpdateType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UpdateType::DomainValidationMethod => "DOMAIN_VALIDATION_METHOD",
...
impl ::std::fmt::Display for UpdateType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            UpdateType::DomainValidationMethod => write!(f, "DOMAIN_VALIDATION_METHOD"),
