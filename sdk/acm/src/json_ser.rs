...
pub fn serialize_structure_add_tags_to_certificate_input(
...
pub fn serialize_structure_export_certificate_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_import_certificate_input(
    ...
    if let Some(var_12) = &input.certificate {
        object
            .key("Certificate")
            .string_unchecked(&smithy_types::base64::encode(var_12));
    }
    if let Some(var_13) = &input.private_key {
        object
            .key("PrivateKey")
            .string_unchecked(&smithy_types::base64::encode(var_13));
    }
    if let Some(var_14) = &input.certificate_chain {
        object
            .key("CertificateChain")
            .string_unchecked(&smithy_types::base64::encode(var_14));
    }
...
pub fn serialize_structure_list_certificates_input(
    ...
    if let Some(var_22) = &input.includes {
        ...
        crate::json_ser::serialize_structure_filters(&mut object_23, var_22);
        object_23.finish();
    }
...
pub fn serialize_structure_list_tags_for_certificate_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_account_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_27) = &input.expiry_events {
        ...
        crate::json_ser::serialize_structure_expiry_events_configuration(&mut object_28, var_27);
        object_28.finish();
    }
...
pub fn serialize_structure_remove_tags_from_certificate_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_renew_certificate_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_request_certificate_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_44 in var_42 {
            {
                ...
                crate::json_ser::serialize_structure_domain_validation_option(
                    &mut object_45,
                    item_44,
                );
                object_45.finish();
    ...
    if let Some(var_46) = &input.options {
        ...
        crate::json_ser::serialize_structure_certificate_options(&mut object_47, var_46);
        object_47.finish();
    }
...
pub fn serialize_structure_resend_validation_email_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_certificate_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_57) = &input.options {
        ...
        crate::json_ser::serialize_structure_certificate_options(&mut object_58, var_57);
        object_58.finish();
    }
}
...
pub fn serialize_structure_expiry_events_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_domain_validation_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_certificate_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
