...
pub(crate) fn create_acme_domain_validation_output_output_correct_errors(
    ...
    if builder.acme_domain_validation_arn.is_none() {
        builder.acme_domain_validation_arn = Some(Default::default())
    }
    builder
}
