    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AddTagsToCertificateInput`](crate::input::AddTagsToCertificateInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::AddTagsToCertificateInput::certificate_arn): <p>String that contains the ARN of the ACM certificate to which the tag is to be applied. This must be of the form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::AddTagsToCertificateInput::tags): <p>The key-value pair that defines the tag. The tag value is optional.</p>
    ...
    ///   - [`certificate_arn(Option<String>)`](crate::input::DeleteCertificateInput::certificate_arn): <p>String that contains the ARN of the ACM certificate to be deleted. This must be of the form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ...
    ///   - [`certificate_arn(Option<String>)`](crate::input::DescribeCertificateInput::certificate_arn): <p>The Amazon Resource Name (ARN) of the ACM certificate. The ARN must have the following form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ...
    ///
    /// - Takes [`ExportCertificateInput`](crate::input::ExportCertificateInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::ExportCertificateInput::certificate_arn): <p>An Amazon Resource Name (ARN) of the issued certificate. This must be of the form:</p>  <p> <code>arn:aws:acm:region:account:certificate/12345678-1234-1234-1234-123456789012</code> </p>
    ///   - [`passphrase(Option<Blob>)`](crate::input::ExportCertificateInput::passphrase): <p>Passphrase to associate with the encrypted exported private key. If you want to later decrypt the private key, you must have the passphrase. You can use the following OpenSSL command to decrypt a private key: </p>  <p> <code>openssl rsa -in encrypted_key.pem -out decrypted_key.pem</code> </p>
    ...
    ///
    /// - Takes [`GetAccountConfigurationInput`](crate::input::GetAccountConfigurationInput)
    ...
    ///   - [`certificate_arn(Option<String>)`](crate::input::ImportCertificateInput::certificate_arn): <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN)</a> of an imported certificate to replace. To import a new certificate, omit this field. </p>
    ///   - [`certificate(Option<Blob>)`](crate::input::ImportCertificateInput::certificate): <p>The certificate to import.</p>
    ///   - [`private_key(Option<Blob>)`](crate::input::ImportCertificateInput::private_key): <p>The private key that matches the public key in the certificate.</p>
    ///   - [`certificate_chain(Option<Blob>)`](crate::input::ImportCertificateInput::certificate_chain): <p>The PEM encoded certificate chain.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::ImportCertificateInput::tags): <p>One or more resource tags to associate with the imported certificate. </p>  <p>Note: You cannot apply tags when reimporting a certificate.</p>
    ...
    ///   - [`certificate_statuses(Option<Vec<CertificateStatus>>)`](crate::input::ListCertificatesInput::certificate_statuses): <p>Filter the certificate list by status value.</p>
    ///   - [`includes(Option<Filters>)`](crate::input::ListCertificatesInput::includes): <p>Filter the certificate list. For more information, see the <code>Filters</code> structure.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListCertificatesInput::next_token): <p>Use this parameter only when paginating results and only in a subsequent request after you receive a response with truncated results. Set it to the value of <code>NextToken</code> from the response you just received.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListCertificatesInput::max_items): <p>Use this parameter when paginating results to specify the maximum number of items to return in the response. If additional items exist beyond the number you specify, the <code>NextToken</code> element is sent in the response. Use this <code>NextToken</code> value in a subsequent request to retrieve additional items.</p>
    ...
    ///
    /// - Takes [`ListTagsForCertificateInput`](crate::input::ListTagsForCertificateInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::ListTagsForCertificateInput::certificate_arn): <p>String that contains the ARN of the ACM certificate for which you want to list the tags. This must have the following form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ...
    ///
    /// - Takes [`PutAccountConfigurationInput`](crate::input::PutAccountConfigurationInput) with field(s):
    ///   - [`expiry_events(Option<ExpiryEventsConfiguration>)`](crate::input::PutAccountConfigurationInput::expiry_events): <p>Specifies expiration events associated with an account.</p>
    ///   - [`idempotency_token(Option<String>)`](crate::input::PutAccountConfigurationInput::idempotency_token): <p>Customer-chosen string used to distinguish between calls to <code>PutAccountConfiguration</code>. Idempotency tokens time out after one hour. If you call <code>PutAccountConfiguration</code> multiple times with the same unexpired idempotency token, ACM treats it as the same request and returns the original result. If you change the idempotency token for each call, ACM treats each call as a new request.</p>
    ...
    ///
    /// - Takes [`RemoveTagsFromCertificateInput`](crate::input::RemoveTagsFromCertificateInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::RemoveTagsFromCertificateInput::certificate_arn): <p>String that contains the ARN of the ACM Certificate with one or more tags that you want to remove. This must be of the form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::RemoveTagsFromCertificateInput::tags): <p>The key-value pair that defines the tag to remove.</p>
    ...
    ///
    /// - Takes [`RenewCertificateInput`](crate::input::RenewCertificateInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::RenewCertificateInput::certificate_arn): <p>String that contains the ARN of the ACM certificate to be renewed. This must be of the form:</p>  <p> <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a>.</p>
    ...
    ///
    /// - Takes [`ResendValidationEmailInput`](crate::input::ResendValidationEmailInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::ResendValidationEmailInput::certificate_arn): <p>String that contains the ARN of the requested certificate. The certificate ARN is generated and returned by the <code>RequestCertificate</code> action as soon as the request is made. By default, using this parameter causes email to be sent to all top-level domains you specified in the certificate request. The ARN must be of the form: </p>  <p> <code>arn:aws:acm:us-east-1:123456789012:certificate/12345678-1234-1234-1234-123456789012</code> </p>
    ///   - [`domain(Option<String>)`](crate::input::ResendValidationEmailInput::domain): <p>The fully qualified domain name (FQDN) of the certificate that needs to be validated.</p>
    ///   - [`validation_domain(Option<String>)`](crate::input::ResendValidationEmailInput::validation_domain): <p>The base validation domain that will act as the suffix of the email addresses that are used to send the emails. This must be the same as the <code>Domain</code> value or a superdomain of the <code>Domain</code> value. For example, if you requested a certificate for <code>site.subdomain.example.com</code> and specify a <b>ValidationDomain</b> of <code>subdomain.example.com</code>, ACM sends email to the domain registrant, technical contact, and administrative contact in WHOIS and the following five addresses:</p>  <ul>   <li> <p>admin@subdomain.example.com</p> </li>   <li> <p>administrator@subdomain.example.com</p> </li>   <li> <p>hostmaster@subdomain.example.com</p> </li>   <li> <p>postmaster@subdomain.example.com</p> </li>   <li> <p>webmaster@subdomain.example.com</p> </li>  </ul>
    ...
    ///
    /// - Takes [`UpdateCertificateOptionsInput`](crate::input::UpdateCertificateOptionsInput) with field(s):
    ///   - [`certificate_arn(Option<String>)`](crate::input::UpdateCertificateOptionsInput::certificate_arn): <p>ARN of the requested certificate to update. This must be of the form:</p>  <p> <code>arn:aws:acm:us-east-1:<i>account</i>:certificate/<i>12345678-1234-1234-1234-123456789012</i> </code> </p>
    ///   - [`options(Option<CertificateOptions>)`](crate::input::UpdateCertificateOptionsInput::options): <p>Use to update the options for your certificate. Currently, you can specify whether to add your certificate to a transparency log. Certificate transparency makes it possible to detect SSL/TLS certificates that have been mistakenly or maliciously issued. Certificates that have not been logged typically produce an error message in a browser. </p>
