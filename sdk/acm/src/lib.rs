...
//! offered by AWS Certificate Manager. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Certificate Manager.
...
/// For example, the [`AddTagsToCertificate`](crate::operation::add_tags_to_certificate) operation has
...
/// Configuration for AWS Certificate Manager.
pub mod config;
