...
pub(crate) fn de_certificate_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CertificateDetail>, aws_smithy_json::deserialize::error::DeserializeError>
