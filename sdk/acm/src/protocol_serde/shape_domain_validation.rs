...
) -> Result<Option<crate::types::DomainValidation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ValidationEmails" => {
                            builder =
                                builder.set_validation_emails(crate::protocol_serde::shape_validation_email_list::de_validation_email_list(tokens)?);
                        }
                        "ValidationDomain" => {
            ...
            Ok(Some(crate::serde_util::domain_validation_correct_errors(builder).build().map_err(
