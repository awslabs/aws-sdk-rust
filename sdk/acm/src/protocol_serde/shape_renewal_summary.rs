...
pub(crate) fn de_renewal_summary<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RenewalSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RenewalStatusReason" => {
                            builder = builder.set_renewal_status_reason(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::FailureReason::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "UpdatedAt" => {
            ...
            Ok(Some(crate::serde_util::renewal_summary_correct_errors(builder).build().map_err(
