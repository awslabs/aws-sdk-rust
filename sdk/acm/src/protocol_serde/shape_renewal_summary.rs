...
pub(crate) fn de_renewal_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RenewalSummary>, aws_smithy_json::deserialize::error::DeserializeError>
