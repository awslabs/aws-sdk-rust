...
pub struct HttpPackageConfiguration  {
    ...
    #[doc(hidden)]pub source_group: std::option::Option<std::string::String>,
...
pub struct SegmentDeliveryConfiguration  {
    /// <p>The base URL of the host or path of the segment delivery server that you're using to serve segments. This is typically a content delivery network (CDN). The URL can be absolute or relative. To use an absolute URL include the protocol, such as https://example.com/some/path. To use a relative URL specify the relative path, such as /some/path*.</p>
    #[doc(hidden)]pub base_url: std::option::Option<std::string::String>,
...
pub struct AccessConfiguration  {
    ...
    #[doc(hidden)]pub access_type: std::option::Option<crate::model::AccessType>,
    /// <p>AWS Secrets Manager access token configuration parameters.</p>
    #[doc(hidden)]pub secrets_manager_access_token_configuration: std::option::Option<crate::model::SecretsManagerAccessTokenConfiguration>,
}
...
impl  std::fmt::Debug for AccessConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("secrets_manager_access_token_configuration", &self.secrets_manager_access_token_configuration);
        formatter.finish()
    }
}
...
pub struct SecretsManagerAccessTokenConfiguration  {
    ...
    #[doc(hidden)]pub secret_string_key: std::option::Option<std::string::String>,
}
...
pub struct ResponseOutputItem  {
    ...
    #[doc(hidden)]pub dash_playlist_settings: std::option::Option<crate::model::DashPlaylistSettings>,
    /// <p>HLS manifest configuration settings.</p>
    #[doc(hidden)]pub hls_playlist_settings: std::option::Option<crate::model::HlsPlaylistSettings>,
    ...
    #[doc(hidden)]pub playback_url: std::option::Option<std::string::String>,
...
pub struct HlsPlaylistSettings  {
    ...
    #[doc(hidden)]pub manifest_window_seconds: i32,
}
...
pub struct DashPlaylistSettings  {
    ...
    #[doc(hidden)]pub min_buffer_time_seconds: i32,
    ...
    #[doc(hidden)]pub min_update_period_seconds: i32,
    ...
    #[doc(hidden)]pub suggested_presentation_delay_seconds: i32,
}
...
impl  std::fmt::Debug for DashPlaylistSettings  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("suggested_presentation_delay_seconds", &self.suggested_presentation_delay_seconds);
        formatter.finish()
    }
}
...
pub struct ManifestProcessingRules  {
    ...
    #[doc(hidden)]pub ad_marker_passthrough: std::option::Option<crate::model::AdMarkerPassthrough>,
}
...
pub struct LivePreRollConfiguration  {
    ...
    #[doc(hidden)]pub max_duration_seconds: i32,
}
...
pub struct HlsConfiguration  {
    ...
    #[doc(hidden)]pub manifest_endpoint_prefix: std::option::Option<std::string::String>,
}
...
pub struct DashConfiguration  {
    ...
    #[doc(hidden)]pub mpd_location: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub origin_manifest_type: std::option::Option<crate::model::OriginManifestType>,
}
...
pub struct CdnConfiguration  {
    ...
    #[doc(hidden)]pub ad_segment_url_prefix: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub content_segment_url_prefix: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for CdnConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("content_segment_url_prefix", &self.content_segment_url_prefix);
        formatter.finish()
    }
}
...
pub struct Bumper  {
    ...
    #[doc(hidden)]pub end_url: std::option::Option<std::string::String>,
...
pub struct PrefetchRetrieval  {
    ...
    #[doc(hidden)]pub dynamic_variables: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
...
pub struct PrefetchConsumption  {
    ...
    #[doc(hidden)]pub avail_matching_criteria: std::option::Option<std::vec::Vec<crate::model::AvailMatchingCriteria>>,
...
pub struct AvailMatchingCriteria  {
    ...
    #[doc(hidden)]pub dynamic_variable: std::option::Option<std::string::String>,
...
pub struct PlaybackConfiguration  {
    ...
    #[doc(hidden)]pub dash_configuration: std::option::Option<crate::model::DashConfiguration>,
    /// <p>The configuration for HLS content.</p>
    #[doc(hidden)]pub hls_configuration: std::option::Option<crate::model::HlsConfiguration>,
    /// <p>The configuration for pre-roll ad insertion.</p>
    ...
    #[doc(hidden)]pub log_configuration: std::option::Option<crate::model::LogConfiguration>,
    /// <p>The configuration for manifest processing rules. Manifest processing rules enable customization of the personalized manifests created by MediaTailor.</p>
    ...
    #[doc(hidden)]pub playback_configuration_arn: std::option::Option<std::string::String>,
    /// <p>The URL that the player accesses to get a manifest from AWS Elemental MediaTailor.</p>
    #[doc(hidden)]pub playback_endpoint_prefix: std::option::Option<std::string::String>,
    /// <p>The URL that the player uses to initialize a session that uses client-side reporting.</p>
    #[doc(hidden)]pub session_initialization_endpoint_prefix: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for PlaybackConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("playback_configuration_arn", &self.playback_configuration_arn);
        formatter.field("playback_endpoint_prefix", &self.playback_endpoint_prefix);
        formatter.field("session_initialization_endpoint_prefix", &self.session_initialization_endpoint_prefix);
...
pub struct Channel  {
    ...
    #[doc(hidden)]pub channel_state: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub outputs: std::option::Option<std::vec::Vec<crate::model::ResponseOutputItem>>,
    ...
    #[doc(hidden)]pub playback_mode: std::option::Option<std::string::String>,
...
pub struct Alert  {
    ...
    #[doc(hidden)]pub alert_code: std::option::Option<std::string::String>,
    /// <p>If an alert is generated for a resource, an explanation of the reason for the alert.</p>
    #[doc(hidden)]pub alert_message: std::option::Option<std::string::String>,
    /// <p>The timestamp when the alert was last modified.</p>
    #[doc(hidden)]pub last_modified_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The Amazon Resource Names (ARNs) related to this alert.</p>
    #[doc(hidden)]pub related_resource_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ScheduleEntry  {
    ...
    #[doc(hidden)]pub approximate_duration_seconds: i64,
    /// <p>The approximate time that the program will start playing.</p>
    #[doc(hidden)]pub approximate_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub schedule_ad_breaks: std::option::Option<std::vec::Vec<crate::model::ScheduleAdBreak>>,
    /// <p>The type of schedule entry.</p> 
    /// <p>Valid values: PROGRAM or FILLER_SLATE.</p>
    #[doc(hidden)]pub schedule_entry_type: std::option::Option<crate::model::ScheduleEntryType>,
    /// <p>The name of the source location.</p>
    #[doc(hidden)]pub source_location_name: std::option::Option<std::string::String>,
    /// <p>The name of the VOD source.</p>
    #[doc(hidden)]pub vod_source_name: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for ScheduleEntry  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("approximate_duration_seconds", &self.approximate_duration_seconds);
...
pub struct AdBreak  {
    ...
    #[doc(hidden)]pub offset_millis: i64,
    /// <p>Ad break slate configuration.</p>
    #[doc(hidden)]pub slate: std::option::Option<crate::model::SlateSource>,
    ...
    #[doc(hidden)]pub splice_insert_message: std::option::Option<crate::model::SpliceInsertMessage>,
}
impl AdBreak {
    /// <p>The SCTE-35 ad insertion type. Accepted value: SPLICE_INSERT.</p>
...
pub struct SpliceInsertMessage  {
    ...
    #[doc(hidden)]pub avails_expected: i32,
    ...
    #[doc(hidden)]pub splice_event_id: i32,
    ...
    #[doc(hidden)]pub unique_program_id: i32,
}
...
pub struct ScheduleConfiguration  {
    ...
    #[doc(hidden)]pub transition: std::option::Option<crate::model::Transition>,
}
...
impl  std::fmt::Debug for Transition  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("scheduled_start_time_millis", &self.scheduled_start_time_millis);
        formatter.field("r#type", &self.r#type);
        formatter.finish()
    }
}
