...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_playback_configuration::builders::DeletePlaybackConfigurationFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_playback_configuration::builders::DeletePlaybackConfigurationFluentBuilder::set_name):<br>required: **true**<br><p>The name of the playback configuration.</p><br>
