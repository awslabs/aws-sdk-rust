...
impl super::Client {
    ...
    ///   - [`http_package_configurations(HttpPackageConfiguration)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::http_package_configurations) / [`set_http_package_configurations(Vec<HttpPackageConfiguration>)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::set_http_package_configurations):<br>required: **true**<br><p>A list of HTTP package configurations for the VOD source on this account.</p><br>
    ///   - [`source_location_name(impl Into<String>)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::source_location_name) / [`set_source_location_name(impl Into<String>)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::set_source_location_name):<br>required: **true**<br><p>The name of the source location associated with this VOD Source.</p><br>
    ///   - [`vod_source_name(impl Into<String>)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::vod_source_name) / [`set_vod_source_name(impl Into<String>)`](crate::operation::update_vod_source::builders::UpdateVodSourceFluentBuilder::set_vod_source_name):<br>required: **true**<br><p>The name of the VOD source.</p><br>
