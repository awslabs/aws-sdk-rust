...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::list_alerts::builders::ListAlertsFluentBuilder::resource_arn) / [`set_resource_arn(impl Into<String>)`](crate::operation::list_alerts::builders::ListAlertsFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the resource.</p><br>
