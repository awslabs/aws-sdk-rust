...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::delete_channel::builders::DeleteChannelFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::delete_channel::builders::DeleteChannelFluentBuilder::set_channel_name):<br>required: **true**<br><p>The name of the channel.</p><br>
