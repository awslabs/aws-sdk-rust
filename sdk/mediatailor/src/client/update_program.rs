...
impl super::Client {
    ...
    ///   - [`ad_breaks(AdBreak)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::ad_breaks) / [`set_ad_breaks(Option<Vec<AdBreak>>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::set_ad_breaks): <p>The ad break configuration settings.</p>
