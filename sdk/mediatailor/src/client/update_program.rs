...
impl super::Client {
    ...
    ///   - [`ad_breaks(Vec<AdBreak>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::ad_breaks) / [`set_ad_breaks(Option<Vec<AdBreak>>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::set_ad_breaks): <p>The ad break configuration settings.</p>
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::set_channel_name): <p>The name of the channel for this Program.</p>
    ///   - [`program_name(impl ::std::convert::Into<String>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::program_name) / [`set_program_name(Option<String>)`](crate::operation::update_program::builders::UpdateProgramFluentBuilder::set_program_name): <p>The name of the Program.</p>
