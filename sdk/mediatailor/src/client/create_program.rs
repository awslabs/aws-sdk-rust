...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::create_program::builders::CreateProgramFluentBuilder::channel_name) / [`set_channel_name(impl Into<String>)`](crate::operation::create_program::builders::CreateProgramFluentBuilder::set_channel_name):<br>required: **true**<br><p>The name of the channel for this Program.</p><br>
    ...
    ///   - [`program_name(impl Into<String>)`](crate::operation::create_program::builders::CreateProgramFluentBuilder::program_name) / [`set_program_name(impl Into<String>)`](crate::operation::create_program::builders::CreateProgramFluentBuilder::set_program_name):<br>required: **true**<br><p>The name of the Program.</p><br>
