...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::channel_name) / [`set_channel_name(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_channel_name):<br>required: **true**<br><p>The name of the channel.</p><br>
    ...
    ///   - [`outputs(RequestOutputItem)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::outputs) / [`set_outputs(Vec<RequestOutputItem>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_outputs):<br>required: **true**<br><p>The channel's output properties.</p><br>
