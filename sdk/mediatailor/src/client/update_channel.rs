...
impl super::Client {
    ...
    ///   - [`outputs(RequestOutputItem)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::outputs) / [`set_outputs(Option<Vec<RequestOutputItem>>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_outputs): <p>The channel's output properties.</p>
