...
impl super::Client {
    ...
    ///   - [`source_location_name(impl Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::source_location_name) / [`set_source_location_name(impl Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::set_source_location_name):<br>required: **true**<br><p>The name of the source location associated with this VOD Source.</p><br>
    ///   - [`vod_source_name(impl Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::vod_source_name) / [`set_vod_source_name(impl Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::set_vod_source_name):<br>required: **true**<br><p>The name of the VOD Source.</p><br>
