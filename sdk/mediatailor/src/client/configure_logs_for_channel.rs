...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::configure_logs_for_channel::builders::ConfigureLogsForChannelFluentBuilder::channel_name) / [`set_channel_name(impl Into<String>)`](crate::operation::configure_logs_for_channel::builders::ConfigureLogsForChannelFluentBuilder::set_channel_name):<br>required: **true**<br><p>The name of the channel.</p><br>
    ///   - [`log_types(LogType)`](crate::operation::configure_logs_for_channel::builders::ConfigureLogsForChannelFluentBuilder::log_types) / [`set_log_types(Vec<LogType>)`](crate::operation::configure_logs_for_channel::builders::ConfigureLogsForChannelFluentBuilder::set_log_types):<br>required: **true**<br><p>The types of logs to collect.</p><br>
