...
impl super::Client {
    ...
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::delete_program::builders::DeleteProgramFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::delete_program::builders::DeleteProgramFluentBuilder::set_channel_name): <p>The name of the channel.</p>
