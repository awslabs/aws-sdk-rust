...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::set_max_results): <p>The maximum number of prefetch schedules that you want MediaTailor to return in response to the current request. If there are more than <code>MaxResults</code> prefetch schedules, use the value of <code>NextToken</code> in the response to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::set_next_token): <p>(Optional) If the playback configuration has more than <code>MaxResults</code> prefetch schedules, use <code>NextToken</code> to get the second and subsequent pages of results.</p>  <p> For the first <code>ListPrefetchSchedulesRequest</code> request, omit this value.</p>  <p> For the second and subsequent requests, get the value of <code>NextToken</code> from the previous response and specify that value for <code>NextToken</code> in the request.</p>  <p> If the previous response didn't include a <code>NextToken</code> element, there are no more prefetch schedules to get.</p>
    ///   - [`playback_configuration_name(impl ::std::convert::Into<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::playback_configuration_name) / [`set_playback_configuration_name(Option<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::set_playback_configuration_name): <p>Retrieves the prefetch schedule(s) for a specific playback configuration.</p>
    ///   - [`stream_id(impl ::std::convert::Into<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::stream_id) / [`set_stream_id(Option<String>)`](crate::operation::list_prefetch_schedules::builders::ListPrefetchSchedulesFluentBuilder::set_stream_id): <p>An optional filtering parameter whereby MediaTailor filters the prefetch schedules to include only specific streams.</p>
