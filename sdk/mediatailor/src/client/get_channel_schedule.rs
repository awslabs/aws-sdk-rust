...
impl super::Client {
    ...
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::get_channel_schedule::builders::GetChannelScheduleFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::get_channel_schedule::builders::GetChannelScheduleFluentBuilder::set_channel_name): <p>The name of the channel associated with this Channel Schedule.</p>
    ///   - [`duration_minutes(impl ::std::convert::Into<String>)`](crate::operation::get_channel_schedule::builders::GetChannelScheduleFluentBuilder::duration_minutes) / [`set_duration_minutes(Option<String>)`](crate::operation::get_channel_schedule::builders::GetChannelScheduleFluentBuilder::set_duration_minutes): <p>The duration in minutes of the channel schedule.</p>
