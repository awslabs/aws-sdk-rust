...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_vod_sources::ListVodSourcesOutput,
                    crate::operation::list_vod_sources::ListVodSourcesError,
                > for ListVodSourcesFluentBuilder
            {
                fn send(
                    self,
...
impl ListVodSourcesFluentBuilder {
    ...
    /// Access the ListVodSources as a reference.
    pub fn as_input(&self) -> &crate::operation::list_vod_sources::builders::ListVodSourcesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_vod_sources::ListVodSourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_vod_sources::ListVodSourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_vod_sources::ListVodSources::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_vod_sources::ListVodSourcesOutput, crate::operation::list_vod_sources::ListVodSourcesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_vod_sources::paginator::ListVodSourcesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
