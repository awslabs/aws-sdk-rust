...
impl DeletePlaybackConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_playback_configuration::DeletePlaybackConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePlaybackConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_playback_configuration::de_delete_playback_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeletePlaybackConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_playback_configuration::DeletePlaybackConfigurationError
{
