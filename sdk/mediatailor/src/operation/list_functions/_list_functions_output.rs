...
pub struct ListFunctionsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::Function>>,
...
impl ListFunctionsOutput {
    ...
    pub fn items(&self) -> &[crate::types::Function] {
...
pub struct ListFunctionsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::Function>>,
...
impl ListFunctionsOutputBuilder {
    ...
    ///
    /// <p>A list of functions associated with your account in the current Region.</p>
    pub fn items(mut self, input: crate::types::Function) -> Self {
    ...
    /// <p>A list of functions associated with your account in the current Region.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Function>>) -> Self {
        self.items = input;
        self
    }
    /// <p>A list of functions associated with your account in the current Region.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Function>> {
        &self.items
    }
    /// <p>Pagination token returned by the list request when results exceed the maximum allowed. Use the token to fetch the next page of results.</p>
    /// <p>For the first <code>ListFunctions</code> request, omit this value. For subsequent requests, get the value of <code>NextToken</code> from the previous response and specify that value for <code>NextToken</code> in the request. Continue making requests until the response no longer includes a <code>NextToken</code> value, which indicates that all results have been retrieved.</p>
