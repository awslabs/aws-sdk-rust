...
impl UpdateSourceLocationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_source_location::UpdateSourceLocation,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSourceLocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_source_location::de_update_source_location_http_response_with_props(status, headers, body)
        }
    }
}
