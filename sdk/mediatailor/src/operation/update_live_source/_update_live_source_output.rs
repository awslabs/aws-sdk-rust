...
impl UpdateLiveSourceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateLiveSourceOutput`](crate::operation::update_live_source::UpdateLiveSourceOutput).
    pub fn build(self) -> crate::operation::update_live_source::UpdateLiveSourceOutput {
