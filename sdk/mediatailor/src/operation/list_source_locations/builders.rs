...
pub use crate::operation::list_source_locations::_list_source_locations_output::ListSourceLocationsOutputBuilder;
...
pub struct ListSourceLocationsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_source_locations::builders::ListSourceLocationsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_source_locations::ListSourceLocationsOutput,
                    crate::operation::list_source_locations::ListSourceLocationsError,
                > for ListSourceLocationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListSourceLocationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_source_locations::ListSourceLocationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_source_locations::ListSourceLocationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_source_locations::ListSourceLocations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_source_locations::ListSourceLocations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_source_locations::ListSourceLocationsOutput, crate::operation::list_source_locations::ListSourceLocationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_source_locations::paginator::ListSourceLocationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
