...
impl StartChannelInputBuilder {
    ...
    /// - [`channel_name`](crate::operation::start_channel::builders::StartChannelInputBuilder::channel_name)
        ...
        ::std::result::Result::Ok(crate::operation::start_channel::StartChannelInput {
            channel_name: self.channel_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "channel_name",
                    "channel_name was not specified but it is required when building StartChannelInput",
                )
            })?,
        })
    }
