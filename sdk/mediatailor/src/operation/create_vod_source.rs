...
impl CreateVodSourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_vod_source::CreateVodSource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_vod_source::ser_create_vod_source_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVodSource {
    type Output =
        ::std::result::Result<crate::operation::create_vod_source::CreateVodSourceOutput, crate::operation::create_vod_source::CreateVodSourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vod_source::de_create_vod_source_http_response_with_props(status, headers, body)
        }
    }
}
