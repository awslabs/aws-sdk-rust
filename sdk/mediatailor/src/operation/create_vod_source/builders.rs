...
pub use crate::operation::create_vod_source::_create_vod_source_output::CreateVodSourceOutputBuilder;

pub use crate::operation::create_vod_source::_create_vod_source_input::CreateVodSourceInputBuilder;
    ...
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        ::aws_smithy_runtime_api::client::result::SdkError<
                            crate::operation::create_vod_source::CreateVodSourceError,
                            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse
                        >
                    > {
                        let mut fluent_builder = client.create_vod_source();
...
pub struct CreateVodSourceFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_vod_source::builders::CreateVodSourceInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_vod_source::CreateVodSourceOutput,
                    crate::operation::create_vod_source::CreateVodSourceError,
                > for CreateVodSourceFluentBuilder
            {
                fn send(
                    self,
...
impl CreateVodSourceFluentBuilder {
    ...
    /// Access the CreateVodSource as a reference.
    pub fn as_input(&self) -> &crate::operation::create_vod_source::builders::CreateVodSourceInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_vod_source::CreateVodSourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_vod_source::CreateVodSourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_vod_source::CreateVodSource::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_vod_source::CreateVodSource::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_vod_source::CreateVodSourceOutput, crate::operation::create_vod_source::CreateVodSourceError, Self> {
