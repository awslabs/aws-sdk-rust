...
impl UpdateVodSourceInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::update_vod_source::UpdateVodSource,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_vod_source::UpdateVodSource::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVodSource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_vod_source::de_update_vod_source_http_error(
                status, headers, body,
            )
        } else {
