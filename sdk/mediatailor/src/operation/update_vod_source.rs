...
impl UpdateVodSourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_vod_source::UpdateVodSource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_vod_source::ser_update_vod_source_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVodSource {
    type Output =
        ::std::result::Result<crate::operation::update_vod_source::UpdateVodSourceOutput, crate::operation::update_vod_source::UpdateVodSourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_vod_source::de_update_vod_source_http_response_with_props(status, headers, body)
        }
    }
}
