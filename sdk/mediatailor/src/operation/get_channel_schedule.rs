...
impl GetChannelScheduleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_channel_schedule::GetChannelSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChannelSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_channel_schedule::de_get_channel_schedule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_channel_schedule::GetChannelScheduleError
{
