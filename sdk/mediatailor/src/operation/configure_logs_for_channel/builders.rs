...
impl ConfigureLogsForChannelFluentBuilder  {
    /// Creates a new `ConfigureLogsForChannel`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::configure_logs_for_channel::ConfigureLogsForChannel, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::configure_logs_for_channel::ConfigureLogsForChannelError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::configure_logs_for_channel::ConfigureLogsForChannelOutput, aws_smithy_http::result::SdkError<crate::operation::configure_logs_for_channel::ConfigureLogsForChannelError>>
                     {
