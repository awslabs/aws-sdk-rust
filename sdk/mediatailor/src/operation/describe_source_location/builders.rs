...
pub use crate::operation::describe_source_location::_describe_source_location_output::DescribeSourceLocationOutputBuilder;
...
pub struct DescribeSourceLocationFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_source_location::builders::DescribeSourceLocationInputBuilder,
...
impl DescribeSourceLocationFluentBuilder {
    ...
    /// Access the DescribeSourceLocation as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_source_location::builders::DescribeSourceLocationInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_source_location::DescribeSourceLocationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_source_location::DescribeSourceLocationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_source_location::DescribeSourceLocation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_source_location::DescribeSourceLocation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_source_location::DescribeSourceLocationOutput, crate::operation::describe_source_location::DescribeSourceLocationError, Self> {
