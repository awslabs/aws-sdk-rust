...
impl GetPrefetchScheduleInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_prefetch_schedule();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_prefetch_schedule::GetPrefetchScheduleOutput,
                    crate::operation::get_prefetch_schedule::GetPrefetchScheduleError,
                > for GetPrefetchScheduleFluentBuilder
            {
                fn send(
                    self,
...
impl GetPrefetchScheduleFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_prefetch_schedule::builders::GetPrefetchScheduleInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_prefetch_schedule::GetPrefetchScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_prefetch_schedule::GetPrefetchScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_prefetch_schedule::GetPrefetchSchedule::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_prefetch_schedule::GetPrefetchSchedule::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_prefetch_schedule::GetPrefetchScheduleOutput, crate::operation::get_prefetch_schedule::GetPrefetchScheduleError, Self> {
