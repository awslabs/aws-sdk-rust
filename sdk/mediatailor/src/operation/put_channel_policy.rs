...
impl PutChannelPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_channel_policy::PutChannelPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutChannelPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_channel_policy::de_put_channel_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_channel_policy::PutChannelPolicyError
{
