...
impl PutChannelPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_channel_policy::ser_put_channel_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutChannelPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_channel_policy::de_put_channel_policy_http_response_with_props(status, headers, body)
        }
    }
}
