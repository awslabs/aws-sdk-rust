...
impl ListPlaybackConfigurationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_playback_configurations::ListPlaybackConfigurations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPlaybackConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_playback_configurations::de_list_playback_configurations_http_response_with_props(status, headers, body)
        }
    }
}
