...
impl GetChannelScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_channel_schedule::GetChannelScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_channel_schedule::GetChannelScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_channel_schedule::GetChannelScheduleOutput, crate::operation::get_channel_schedule::GetChannelScheduleError, Self> {
