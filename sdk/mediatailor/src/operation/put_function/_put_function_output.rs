...
impl ::aws_types::request_id::RequestId for PutFunctionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutFunctionOutput {
    /// Creates a new builder-style object to manufacture [`PutFunctionOutput`](crate::operation::put_function::PutFunctionOutput).
    pub fn builder() -> crate::operation::put_function::builders::PutFunctionOutputBuilder {
        crate::operation::put_function::builders::PutFunctionOutputBuilder::default()
    }
}

/// A builder for [`PutFunctionOutput`](crate::operation::put_function::PutFunctionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutFunctionOutputBuilder {
...
impl PutFunctionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutFunctionOutput`](crate::operation::put_function::PutFunctionOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`function_id`](crate::operation::put_function::builders::PutFunctionOutputBuilder::function_id)
    /// - [`function_type`](crate::operation::put_function::builders::PutFunctionOutputBuilder::function_type)
    pub fn build(self) -> ::std::result::Result<crate::operation::put_function::PutFunctionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::put_function::PutFunctionOutput {
            function_id: self.function_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "function_id",
                    "function_id was not specified but it is required when building PutFunctionOutput",
                )
            })?,
            function_type: self.function_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "function_type",
                    "function_type was not specified but it is required when building PutFunctionOutput",
                )
            })?,
