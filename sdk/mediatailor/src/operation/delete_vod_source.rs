...
impl DeleteVodSourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_vod_source::DeleteVodSource, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVodSource {
    type Output =
        ::std::result::Result<crate::operation::delete_vod_source::DeleteVodSourceOutput, crate::operation::delete_vod_source::DeleteVodSourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vod_source::de_delete_vod_source_http_response_with_props(status, headers, body)
        }
    }
}
