...
impl UpdateVodSourceFluentBuilder  {
    /// Creates a new `UpdateVodSource`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_vod_source::UpdateVodSourceOutput, aws_smithy_http::result::SdkError<crate::operation::update_vod_source::UpdateVodSourceError>>
                     {
