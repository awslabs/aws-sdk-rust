...
impl Builder {
    ...
    /// use aws_sdk_mediatailor::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_mediatailor::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("mediatailor"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("mediatailor"));
        layer
