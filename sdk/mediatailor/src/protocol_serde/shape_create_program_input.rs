...
pub fn ser_create_program_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProgramInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
