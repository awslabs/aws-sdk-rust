...
pub(crate) fn de_source_location<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SourceLocation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AccessConfiguration" => {
                            builder =
                                builder.set_access_configuration(crate::protocol_serde::shape_access_configuration::de_access_configuration(tokens)?);
                        }
                        "Arn" => {
            ...
            Ok(Some(crate::serde_util::source_location_correct_errors(builder).build().map_err(
