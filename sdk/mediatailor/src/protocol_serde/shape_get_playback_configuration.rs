...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_playback_configuration_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_playback_configuration::GetPlaybackConfigurationOutput, crate::operation::get_playback_configuration::GetPlaybackConfigurationError> {
    Ok({
        #[allow(unused_mut)]
