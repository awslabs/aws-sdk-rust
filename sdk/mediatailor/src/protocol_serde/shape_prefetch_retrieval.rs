            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DynamicVariables" => {
                            builder = builder.set_dynamic_variables(crate::protocol_serde::shape_map_of_string::de_map_of_string(tokens, _value)?);
                        }
                        "EndTime" => {
                        ...
                        "TrafficShapingRetrievalWindow" => {
                            builder = builder.set_traffic_shaping_retrieval_window(
                                crate::protocol_serde::shape_traffic_shaping_retrieval_window::de_traffic_shaping_retrieval_window(tokens, _value)?,
                            );
                        }
                        "TrafficShapingTpsConfiguration" => {
                            builder = builder.set_traffic_shaping_tps_configuration(
                                crate::protocol_serde::shape_traffic_shaping_tps_configuration::de_traffic_shaping_tps_configuration(tokens, _value)?,
                            );
                        }
