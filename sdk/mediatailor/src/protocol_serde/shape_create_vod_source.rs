...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_create_vod_source_input::ser_create_vod_source_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_vod_source::de_create_vod_source(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_vod_source::CreateVodSourceError::unhandled)?;
