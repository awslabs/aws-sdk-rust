...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_live_source_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_live_source::de_describe_live_source(_response_body, output)
            .map_err(crate::operation::describe_live_source::DescribeLiveSourceError::unhandled)?;
...
pub(crate) fn de_describe_live_source(
    value: &[u8],
    mut builder: crate::operation::describe_live_source::builders::DescribeLiveSourceOutputBuilder,
) -> Result<crate::operation::describe_live_source::builders::DescribeLiveSourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
