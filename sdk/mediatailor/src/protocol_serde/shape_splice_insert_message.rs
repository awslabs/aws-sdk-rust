...
pub fn ser_splice_insert_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SpliceInsertMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_splice_insert_message<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SpliceInsertMessage>, aws_smithy_json::deserialize::error::DeserializeError>
