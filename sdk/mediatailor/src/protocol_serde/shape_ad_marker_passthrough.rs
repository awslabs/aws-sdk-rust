...
pub(crate) fn de_ad_marker_passthrough<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AdMarkerPassthrough>, aws_smithy_json::deserialize::error::DeserializeError>
