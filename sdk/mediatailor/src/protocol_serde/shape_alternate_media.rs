...
pub fn ser_alternate_media(
    ...
    if let Some(var_6) = &input.scheduled_start_time_millis {
        object.key("ScheduledStartTimeMillis").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    ...
    if let Some(var_11) = &input.duration_millis {
        object.key("DurationMillis").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    Ok(())
}

pub(crate) fn de_alternate_media<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AlternateMedia>, ::aws_smithy_json::deserialize::error::DeserializeError>
