...
pub fn ser_create_program_input(
    ...
    crate::protocol_serde::shape_create_program_input::ser_create_program_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_create_program::de_create_program(_response_body, output)
                .map_err(crate::operation::create_program::CreateProgramError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "AdBreaks" => {
                        builder = builder.set_ad_breaks(
                            crate::protocol_serde::shape___list_of_ad_break::de___list_of_ad_break(
                                tokens,
                            )?,
                        );
                    }
