...
pub fn ser_create_source_location_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSourceLocationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
