...
pub(crate) fn de_playback_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PlaybackConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
