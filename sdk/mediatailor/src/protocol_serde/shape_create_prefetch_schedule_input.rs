...
pub fn ser_create_prefetch_schedule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePrefetchScheduleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
