...
pub(crate) fn de_http_package_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::HttpPackageConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
