...
pub(crate) fn de_live_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LiveSource>, aws_smithy_json::deserialize::error::DeserializeError>
