...
pub(crate) fn de_ad_break_metadata_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::KeyValuePair>>, ::aws_smithy_json::deserialize::error::DeserializeError>
