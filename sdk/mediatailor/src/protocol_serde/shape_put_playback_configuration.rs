...
pub fn de_put_playback_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::put_playback_configuration::PutPlaybackConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::put_playback_configuration::PutPlaybackConfigurationError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_put_playback_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_playback_configuration::de_put_playback_configuration(_response_body, output)
            .map_err(crate::operation::put_playback_configuration::PutPlaybackConfigurationError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AdConditioningConfiguration" => {
                    builder = builder.set_ad_conditioning_configuration(
                        crate::protocol_serde::shape_ad_conditioning_configuration::de_ad_conditioning_configuration(tokens, _value, depth + 1)?,
                    );
                }
                ...
                "ConfigurationAliases" => {
                    builder = builder.set_configuration_aliases(
                        crate::protocol_serde::shape_configuration_aliases_response::de_configuration_aliases_response(tokens, _value, depth + 1)?,
                    );
                }
                "DashConfiguration" => {
