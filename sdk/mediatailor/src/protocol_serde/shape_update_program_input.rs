...
pub fn ser_update_program_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_program::UpdateProgramInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
