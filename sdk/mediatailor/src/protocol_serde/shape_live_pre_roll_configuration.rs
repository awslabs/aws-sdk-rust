...
pub(crate) fn de_live_pre_roll_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LivePreRollConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_live_pre_roll_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LivePreRollConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
