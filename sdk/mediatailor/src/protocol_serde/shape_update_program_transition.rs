...
pub fn ser_update_program_transition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateProgramTransition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
