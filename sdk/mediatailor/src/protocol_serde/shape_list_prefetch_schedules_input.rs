...
pub fn ser_list_prefetch_schedules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_prefetch_schedules::ListPrefetchSchedulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
