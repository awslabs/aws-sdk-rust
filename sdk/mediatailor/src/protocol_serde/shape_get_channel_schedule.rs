...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_channel_schedule_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_channel_schedule::de_get_channel_schedule(_response_body, output)
            .map_err(crate::operation::get_channel_schedule::GetChannelScheduleError::unhandled)?;
...
) -> Result<crate::operation::get_channel_schedule::builders::GetChannelScheduleOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Items" => {
                    builder = builder.set_items(crate::protocol_serde::shape___list_of_schedule_entry::de___list_of_schedule_entry(
                        tokens,
                    )?);
                }
                "NextToken" => {
