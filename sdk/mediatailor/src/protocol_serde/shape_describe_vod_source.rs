...
pub fn de_describe_vod_source_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_vod_source::DescribeVodSourceOutput, crate::operation::describe_vod_source::DescribeVodSourceError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_vod_source_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_vod_source::DescribeVodSourceOutput, crate::operation::describe_vod_source::DescribeVodSourceError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_vod_source::de_describe_vod_source(_response_body, output)
            .map_err(crate::operation::describe_vod_source::DescribeVodSourceError::unhandled)?;
...
) -> Result<crate::operation::describe_vod_source::builders::DescribeVodSourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
