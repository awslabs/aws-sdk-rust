...
pub fn ser_dash_playlist_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashPlaylistSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_dash_playlist_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DashPlaylistSettings>, aws_smithy_json::deserialize::error::DeserializeError>
