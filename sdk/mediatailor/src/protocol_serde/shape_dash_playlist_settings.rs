...
pub(crate) fn de_dash_playlist_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DashPlaylistSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
