...
pub fn serialize_structure_crate_input_batch_put_property_values_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchPutPropertyValuesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_component_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateComponentTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_11, value_12) in var_9 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_function_request(&mut object_13, value_12)?;
                object_13.finish();
            }
        }
        object_10.finish();
        ...
        for (key_17, value_18) in var_15 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_definition_request(&mut object_19, value_18)?;
                object_19.finish();
            }
        }
        object_16.finish();
...
pub fn serialize_structure_crate_input_create_entity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEntityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_26, value_27) in var_24 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_component_request(&mut object_28, value_27)?;
                object_28.finish();
            }
        }
        object_25.finish();
...
pub fn serialize_structure_crate_input_create_scene_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSceneInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_property_value_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPropertyValueInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_property_value_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPropertyValueHistoryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_62) = &input.end_date_time {
        object.key("endDateTime").date_time(var_62, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_65) = &input.interpolation {
        ...
        crate::json_ser::serialize_structure_crate_model_interpolation_parameters(&mut object_66, var_65)?;
        object_66.finish();
    }
        ...
        for item_72 in var_70 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_filter(&mut object_73, item_72)?;
                object_73.finish();
            }
        }
        array_71.finish();
    ...
    if let Some(var_77) = &input.start_date_time {
        object.key("startDateTime").date_time(var_77, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_list_component_types_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListComponentTypesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_81 in var_79 {
             {
                ...
                crate::json_ser::serialize_union_crate_model_list_component_types_filter(&mut object_82, item_81)?;
                object_82.finish();
            }
        }
        array_80.finish();
        ...
        for item_87 in var_85 {
             {
                ...
                crate::json_ser::serialize_union_crate_model_list_entities_filter(&mut object_88, item_87)?;
                object_88.finish();
            }
        }
        array_86.finish();
...
pub fn serialize_structure_crate_input_list_scenes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListScenesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_workspaces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListWorkspacesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_component_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateComponentTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_109, value_110) in var_107 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_function_request(&mut object_111, value_110)?;
                object_111.finish();
            }
        }
        object_108.finish();
        ...
        for (key_115, value_116) in var_113 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_definition_request(&mut object_117, value_116)?;
                object_117.finish();
            }
        }
        object_114.finish();
...
pub fn serialize_structure_crate_input_update_entity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEntityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_120, value_121) in var_118 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_component_update_request(&mut object_122, value_121)?;
                object_122.finish();
            }
        }
        object_119.finish();
    ...
    if let Some(var_125) = &input.parent_entity_update {
        ...
        crate::json_ser::serialize_structure_crate_model_parent_entity_update_request(&mut object_126, var_125)?;
        object_126.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_input_update_scene_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSceneInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_workspace_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkspaceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_property_value_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyValueEntry) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_134) = &input.entity_property_reference {
        let mut object_135 = object.key("entityPropertyReference").start_object();
        crate::json_ser::serialize_structure_crate_model_entity_property_reference(&mut object_135, var_134)?;
        object_135.finish();
    }
        ...
        for item_138 in var_136 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_value(&mut object_139, item_138)?;
                object_139.finish();
            }
        }
        array_137.finish();
...
pub fn serialize_structure_crate_model_function_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunctionRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_property_definition_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyDefinitionRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_162, value_163) in var_160 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_request(&mut object_164, value_163)?;
                object_164.finish();
            }
        }
        object_161.finish();
...
pub fn serialize_structure_crate_model_interpolation_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InterpolationParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_166) = &input.interval_in_seconds {
        object.key("intervalInSeconds").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_166).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_property_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_union_crate_model_list_component_types_filter(object_82: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListComponentTypesFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::ListComponentTypesFilter::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("ListComponentTypesFilter"))
    }
    Ok(())
}

pub fn serialize_union_crate_model_list_entities_filter(object_88: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListEntitiesFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::ListEntitiesFilter::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("ListEntitiesFilter"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_component_update_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentUpdateRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_176, value_177) in var_174 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_property_request(&mut object_178, value_177)?;
                object_178.finish();
            }
        }
        object_175.finish();
...
pub fn serialize_structure_crate_model_parent_entity_update_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParentEntityUpdateRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_entity_property_reference(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EntityPropertyReference) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_property_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_188) = &input.timestamp {
        object.key("timestamp").date_time(var_188, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_model_data_connector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataConnector) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_data_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataType) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_200 in var_198 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_value(&mut object_201, item_200)?;
                object_201.finish();
            }
        }
        array_199.finish();
...
pub fn serialize_structure_crate_model_data_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_205) = &input.boolean_value {
        object.key("booleanValue").boolean(*var_205);
    }
    if let Some(var_206) = &input.double_value {
        object.key("doubleValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_206).into()));
    }
    if let Some(var_207) = &input.integer_value {
        object.key("integerValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_207).into()));
    }
    if let Some(var_208) = &input.long_value {
        object.key("longValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_208).into()));
    }
        ...
        for item_212 in var_210 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_value(&mut object_213, item_212)?;
                object_213.finish();
            }
        }
        array_211.finish();
        ...
        for (key_216, value_217) in var_214 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_value(&mut object_218, value_217)?;
                object_218.finish();
            }
        }
        object_215.finish();
    ...
    if let Some(var_219) = &input.relationship_value {
        ...
        crate::json_ser::serialize_structure_crate_model_relationship_value(&mut object_220, var_219)?;
        object_220.finish();
    }
...
pub fn serialize_structure_crate_model_property_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_222) = &input.definition {
        let mut object_223 = object.key("definition").start_object();
        crate::json_ser::serialize_structure_crate_model_property_definition_request(&mut object_223, var_222)?;
        object_223.finish();
    }
...
pub fn serialize_structure_crate_model_lambda_function(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaFunction) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_relationship(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Relationship) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_relationship_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RelationshipValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
