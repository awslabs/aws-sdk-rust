...
pub fn ser_data_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataType>, aws_smithy_json::deserialize::error::DeserializeError>
