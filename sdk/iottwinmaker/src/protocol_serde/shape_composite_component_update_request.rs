...
pub fn ser_composite_component_update_request(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CompositeComponentUpdateRequest,
    ...
    if let Some(var_3) = &input.property_updates {
        #[allow(unused_mut)]
        let mut object_4 = object.key("propertyUpdates").start_object();
    ...
    if let Some(var_8) = &input.property_group_updates {
        #[allow(unused_mut)]
        let mut object_9 = object.key("propertyGroupUpdates").start_object();
