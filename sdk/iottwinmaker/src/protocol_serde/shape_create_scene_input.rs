...
pub fn ser_create_scene_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSceneInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
