...
pub fn ser_update_entity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEntityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
