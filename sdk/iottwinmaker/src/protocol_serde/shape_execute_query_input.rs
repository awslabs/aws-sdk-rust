...
pub fn ser_execute_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExecuteQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
