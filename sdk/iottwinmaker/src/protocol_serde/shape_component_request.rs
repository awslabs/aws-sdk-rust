...
pub fn ser_component_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
