...
pub fn ser_property_definition_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PropertyDefinitionRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
