...
pub fn ser_create_component_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_component_type::CreateComponentTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
