...
pub(crate) fn de_row_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<aws_smithy_types::Document>>, aws_smithy_json::deserialize::error::DeserializeError>
