...
pub fn ser_get_property_value_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPropertyValueHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
