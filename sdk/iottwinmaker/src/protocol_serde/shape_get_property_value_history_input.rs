...
pub fn ser_get_property_value_history_input_input(
    ...
    if let Some(var_4) = &input.end_date_time {
        object.key("endDateTime").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_19) = &input.start_date_time {
        object.key("startDateTime").date_time(var_19, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
