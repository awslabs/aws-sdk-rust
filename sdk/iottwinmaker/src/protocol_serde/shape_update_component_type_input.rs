...
pub fn ser_update_component_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateComponentTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
