...
pub fn ser_property_value_entry(
    ...
    if let Some(var_1) = &input.entity_property_reference {
        ...
        crate::protocol_serde::shape_entity_property_reference::ser_entity_property_reference(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
        ...
        for item_5 in var_3 {
            {
                ...
                crate::protocol_serde::shape_property_value::ser_property_value(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
...
pub(crate) fn de_property_value_entry<'a, I>(
    ...
    Option<crate::types::PropertyValueEntry>,
