...
pub(crate) fn de_source_configurations<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::SourceConfiguration>>, ::aws_smithy_json::deserialize::error::DeserializeError>
