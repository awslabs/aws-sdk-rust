...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace that contains the scene.</p><br>
    ///   - [`scene_id(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::scene_id) / [`set_scene_id(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::set_scene_id):<br>required: **true**<br><p>The ID of the scene.</p><br>
    ///   - [`content_location(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::content_location) / [`set_content_location(impl Into<String>)`](crate::operation::create_scene::builders::CreateSceneFluentBuilder::set_content_location):<br>required: **true**<br><p>The relative path that specifies the location of the content definition file.</p><br>
