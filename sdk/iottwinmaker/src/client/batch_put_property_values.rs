...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::batch_put_property_values::builders::BatchPutPropertyValuesFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::batch_put_property_values::builders::BatchPutPropertyValuesFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace that contains the properties to set.</p><br>
    ///   - [`entries(PropertyValueEntry)`](crate::operation::batch_put_property_values::builders::BatchPutPropertyValuesFluentBuilder::entries) / [`set_entries(Vec<PropertyValueEntry>)`](crate::operation::batch_put_property_values::builders::BatchPutPropertyValuesFluentBuilder::set_entries):<br>required: **true**<br><p>An object that maps strings to the property value entries to set. Each string in the mapping must be unique to this object.</p><br>
