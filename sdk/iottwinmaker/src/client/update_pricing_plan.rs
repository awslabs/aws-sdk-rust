...
impl super::Client {
    ...
    ///   - [`pricing_mode(PricingMode)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::pricing_mode) / [`set_pricing_mode(PricingMode)`](crate::operation::update_pricing_plan::builders::UpdatePricingPlanFluentBuilder::set_pricing_mode):<br>required: **true**<br><p>The pricing mode.</p><br>
