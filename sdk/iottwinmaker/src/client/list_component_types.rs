...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::list_component_types::builders::ListComponentTypesFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::list_component_types::builders::ListComponentTypesFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace.</p><br>
