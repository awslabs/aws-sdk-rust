...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::list_sync_jobs::builders::ListSyncJobsFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::list_sync_jobs::builders::ListSyncJobsFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace that contains the sync job.</p><br>
