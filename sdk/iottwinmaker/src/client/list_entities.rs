...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::list_entities::builders::ListEntitiesFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::list_entities::builders::ListEntitiesFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace.</p><br>
