...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::set_workspace_id): <p>The ID of the workspace that contains the entity.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::set_entity_id): <p>The ID of the entity.</p>
    ///   - [`entity_name(impl ::std::convert::Into<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::entity_name) / [`set_entity_name(Option<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::set_entity_name): <p>The name of the entity.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_entity::builders::UpdateEntityFluentBuilder::set_description): <p>The description of the entity.</p>
