...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_tags): <p>Metadata that you can use to manage the entity.</p>
