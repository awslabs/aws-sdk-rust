...
impl super::Client {
    ...
    ///   - [`capabilities(impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::capabilities) / [`set_capabilities(Option<Vec<String>>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_capabilities): <p>A list of capabilities that the scene uses to render.</p>
    ///   - [`scene_metadata(impl Into<String>, impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::scene_metadata) / [`set_scene_metadata(Option<HashMap<String, String>>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_scene_metadata): <p>The scene metadata.</p>
