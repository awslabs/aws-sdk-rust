...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_workspace_id): <p>The ID of the workspace that contains the scene.</p>
    ///   - [`scene_id(impl ::std::convert::Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::scene_id) / [`set_scene_id(Option<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_scene_id): <p>The ID of the scene.</p>
    ///   - [`content_location(impl ::std::convert::Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::content_location) / [`set_content_location(Option<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_content_location): <p>The relative path that specifies the location of the content definition file.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_description): <p>The description of this scene.</p>
