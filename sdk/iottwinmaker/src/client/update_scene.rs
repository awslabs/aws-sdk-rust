...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace that contains the scene.</p><br>
    ///   - [`scene_id(impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::scene_id) / [`set_scene_id(impl Into<String>)`](crate::operation::update_scene::builders::UpdateSceneFluentBuilder::set_scene_id):<br>required: **true**<br><p>The ID of the scene.</p><br>
