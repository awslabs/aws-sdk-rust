...
impl super::Client {
    ...
    ///   - [`message(Option<String>)`](crate::operation::delete_workspace::DeleteWorkspaceOutput::message): <p>The string that specifies the delete result for the workspace.</p>
