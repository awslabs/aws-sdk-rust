...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::delete_sync_job::builders::DeleteSyncJobFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::delete_sync_job::builders::DeleteSyncJobFluentBuilder::set_workspace_id): <p>The workspace ID.</p>
    ///   - [`sync_source(impl ::std::convert::Into<String>)`](crate::operation::delete_sync_job::builders::DeleteSyncJobFluentBuilder::sync_source) / [`set_sync_source(Option<String>)`](crate::operation::delete_sync_job::builders::DeleteSyncJobFluentBuilder::set_sync_source): <p>The sync source.</p> <note>   <p>Currently the only supported syncSource is <code>SITEWISE </code>.</p>  </note>
