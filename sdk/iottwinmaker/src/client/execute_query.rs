...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return at one time. The default is 50.</p><br>
