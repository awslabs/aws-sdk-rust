...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The ID of the workspace.</p><br>
    ///   - [`query_statement(impl Into<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::query_statement) / [`set_query_statement(impl Into<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_query_statement):<br>required: **true**<br><p>The query statement.</p><br>
