...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::list_scenes::builders::ListScenesFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::list_scenes::builders::ListScenesFluentBuilder::set_workspace_id): <p>The ID of the workspace that contains the scenes.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_scenes::builders::ListScenesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_scenes::builders::ListScenesFluentBuilder::set_next_token): <p>The string that specifies the next page of results.</p>
