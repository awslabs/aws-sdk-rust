...
impl super::Client {
    ...
    ///   - [`component_type_id(impl ::std::convert::Into<String>)`](crate::operation::create_component_type::builders::CreateComponentTypeFluentBuilder::component_type_id) / [`set_component_type_id(Option<String>)`](crate::operation::create_component_type::builders::CreateComponentTypeFluentBuilder::set_component_type_id): <p>The ID of the component type.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_component_type::builders::CreateComponentTypeFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_component_type::builders::CreateComponentTypeFluentBuilder::set_description): <p>The description of the component type.</p>
