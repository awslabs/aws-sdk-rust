...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::set_workspace_id): <p>The ID of the workspace that contains the entity to delete.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::set_entity_id): <p>The ID of the entity to delete.</p>
