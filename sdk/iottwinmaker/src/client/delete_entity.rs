...
impl super::Client {
    ...
    ///   - [`entity_id(impl Into<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::delete_entity::builders::DeleteEntityFluentBuilder::set_entity_id):<br>required: **true**<br><p>The ID of the entity to delete.</p><br>
