        ...
        ::std::result::Result::Ok(
            crate::types::ComponentSummary {
                component_name: self.component_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("component_name", "component_name was not specified but it is required when building ComponentSummary")
                    )?
                ,
                component_type_id: self.component_type_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("component_type_id", "component_type_id was not specified but it is required when building ComponentSummary")
                    )?
                ,
