...
impl Builder {
    ...
    /// use aws_sdk_iottwinmaker::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_iottwinmaker::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
