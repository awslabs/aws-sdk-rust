...
pub(crate) fn reflens_get_property_value_output_output_next_token(
...
pub(crate) fn reflens_get_property_value_history_output_output_next_token(
...
pub(crate) fn reflens_list_component_types_output_output_next_token(
...
pub(crate) fn reflens_list_metadata_transfer_jobs_output_output_next_token(
    input: &crate::operation::list_metadata_transfer_jobs::ListMetadataTransferJobsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_properties_output_output_next_token(
    input: &crate::operation::list_properties::ListPropertiesOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_scenes_output_output_next_token(
...
pub(crate) fn reflens_list_sync_jobs_output_output_next_token(
...
pub(crate) fn reflens_list_sync_resources_output_output_next_token(
