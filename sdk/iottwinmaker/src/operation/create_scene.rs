...
impl CreateSceneInput {
    /// Consumes the builder and constructs an Operation<[`CreateScene`](crate::operation::create_scene::CreateScene)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_scene::CreateScene, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_scene::ser_create_scene_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_scene::CreateScene::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateScene {
    type Output = ::std::result::Result<crate::operation::create_scene::CreateSceneOutput, crate::operation::create_scene::CreateSceneError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_scene::de_create_scene_http_response_with_props(status, headers, body)
        }
    }
}
