...
impl ExecuteQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::execute_query::ExecuteQuery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::execute_query::ExecuteQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_execute_query::de_execute_query_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_execute_query::de_execute_query_http_response_with_props(
                status, headers, body,
            )
        }
    }
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ExecuteQueryError {
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            Self::QueryTimeoutException(inner) => {
