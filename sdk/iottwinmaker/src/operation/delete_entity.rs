...
impl DeleteEntityInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_entity::DeleteEntity::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEntity {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_entity::de_delete_entity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_entity::de_delete_entity_http_response_with_props(
                status, headers, body,
            )
        }
    }
