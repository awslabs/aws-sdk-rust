...
impl CreateWorkspace {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTTwinMaker", "CreateWorkspace", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateWorkspaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("s3Location") {
            if let ::std::option::Option::Some(value) = input.s3_location.as_deref() {
                captured.insert("s3Location", value);
            }
        }
