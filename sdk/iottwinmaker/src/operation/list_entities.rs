...
impl ListEntitiesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_entities::ListEntities::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListEntities {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_entities::de_list_entities_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_entities::de_list_entities_http_response_with_props(
                status, headers, body,
            )
        }
    }
