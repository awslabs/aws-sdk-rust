...
impl GetPropertyValueHistoryOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_property_value_history::GetPropertyValueHistoryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_property_value_history::GetPropertyValueHistoryOutput {
                property_values: self.property_values
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("property_values", "property_values was not specified but it is required when building GetPropertyValueHistoryOutput")
                    )?
                ,
