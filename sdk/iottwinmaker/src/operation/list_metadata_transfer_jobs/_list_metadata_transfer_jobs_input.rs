...
impl ListMetadataTransferJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_metadata_transfer_jobs::ListMetadataTransferJobsInput, ::aws_smithy_types::error::operation::BuildError> {
