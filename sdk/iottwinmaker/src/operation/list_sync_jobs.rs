...
impl ListSyncJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListSyncJobs`](crate::operation::list_sync_jobs::ListSyncJobs)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_sync_jobs::ListSyncJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_sync_jobs::ser_list_sync_jobs_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_sync_jobs::ListSyncJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSyncJobs {
    type Output = ::std::result::Result<crate::operation::list_sync_jobs::ListSyncJobsOutput, crate::operation::list_sync_jobs::ListSyncJobsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sync_jobs::de_list_sync_jobs_http_response_with_props(status, headers, body)
        }
    }
}
