...
impl ListSyncJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_sync_jobs::ListSyncJobs,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_sync_jobs::ListSyncJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSyncJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_sync_jobs::de_list_sync_jobs_http_error(
                status, headers, body,
            )
        } else {
