...
impl ListSyncResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_sync_resources::ListSyncResources,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_sync_resources::ser_list_sync_resources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSyncResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sync_resources::de_list_sync_resources_http_response_with_props(status, headers, body)
        }
    }
}
