...
impl CreateSyncJobInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_sync_job::CreateSyncJob::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSyncJob {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_sync_job::de_create_sync_job_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_sync_job::de_create_sync_job_http_response(
                status, headers, body,
            )
        }
    }
