...
impl BatchPutPropertyValuesInput {
    /// Consumes the builder and constructs an Operation<[`BatchPutPropertyValues`](crate::operation::batch_put_property_values::BatchPutPropertyValues)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_put_property_values::BatchPutPropertyValues, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_put_property_values::BatchPutPropertyValuesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_put_property_values::ser_batch_put_property_values_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_put_property_values::BatchPutPropertyValues::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchPutPropertyValues {
                type Output = std::result::Result<crate::operation::batch_put_property_values::BatchPutPropertyValuesOutput, crate::operation::batch_put_property_values::BatchPutPropertyValuesError>;
