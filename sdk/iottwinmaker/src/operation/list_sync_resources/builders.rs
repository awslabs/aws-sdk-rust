...
impl ListSyncResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_sync_resources::ListSyncResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_sync_resources::ListSyncResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_sync_resources::ListSyncResourcesOutput, crate::operation::list_sync_resources::ListSyncResourcesError, Self> {
