...
impl CreateComponentTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_component_type::CreateComponentTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_component_type::CreateComponentTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_component_type::CreateComponentTypeOutput, crate::operation::create_component_type::CreateComponentTypeError, Self> {
