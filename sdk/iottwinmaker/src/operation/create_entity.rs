...
impl CreateEntityInput {
    /// Consumes the builder and constructs an Operation<[`CreateEntity`](crate::operation::create_entity::CreateEntity)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_entity::CreateEntity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_entity::ser_create_entity_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_entity::CreateEntity::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEntity {
    type Output = ::std::result::Result<crate::operation::create_entity::CreateEntityOutput, crate::operation::create_entity::CreateEntityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_entity::de_create_entity_http_response_with_props(status, headers, body)
        }
    }
}
