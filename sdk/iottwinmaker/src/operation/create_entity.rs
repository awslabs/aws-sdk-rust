...
impl CreateEntityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_entity::CreateEntity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_entity::CreateEntity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEntity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_entity::de_create_entity_http_error(
                status, headers, body,
            )
        } else {
