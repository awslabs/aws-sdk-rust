...
pub struct ParentEntityUpdateRequest  {
    ...
    #[doc(hidden)]pub update_type: std::option::Option<crate::model::ParentEntityUpdateType>,
...
pub struct ComponentUpdateRequest  {
    ...
    #[doc(hidden)]pub update_type: std::option::Option<crate::model::ComponentUpdateType>,
    ...
    #[doc(hidden)]pub property_updates: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PropertyRequest>>,
}
...
pub struct PropertyRequest  {
    ...
    #[doc(hidden)]pub definition: std::option::Option<crate::model::PropertyDefinitionRequest>,
    /// <p>The value of the property.</p>
    #[doc(hidden)]pub value: std::option::Option<crate::model::DataValue>,
    /// <p>The update type of the update property request.</p>
    #[doc(hidden)]pub update_type: std::option::Option<crate::model::PropertyUpdateType>,
}
...
pub struct DataValue  {
    ...
    /// <p>A long value.</p>
    #[doc(hidden)]pub long_value: std::option::Option<i64>,
    /// <p>A string value.</p>
    #[doc(hidden)]pub string_value: std::option::Option<std::string::String>,
    /// <p>A list of multiple values.</p>
    #[doc(hidden)]pub list_value: std::option::Option<std::vec::Vec<crate::model::DataValue>>,
    /// <p>An object that maps strings to multiple <code>DataValue</code> objects.</p>
    #[doc(hidden)]pub map_value: std::option::Option<std::collections::HashMap<std::string::String, crate::model::DataValue>>,
    /// <p>A value that relates a component to another component.</p>
    #[doc(hidden)]pub relationship_value: std::option::Option<crate::model::RelationshipValue>,
...
pub struct RelationshipValue  {
    ...
    #[doc(hidden)]pub target_entity_id: std::option::Option<std::string::String>,
    /// <p>The name of the target component associated with the relationship value.</p>
    #[doc(hidden)]pub target_component_name: std::option::Option<std::string::String>,
}
...
pub struct DataType  {
    ...
    #[doc(hidden)]pub nested_type: std::option::Option<std::boxed::Box<crate::model::DataType>>,
    /// <p>The allowed values for this data type.</p>
    #[doc(hidden)]pub allowed_values: std::option::Option<std::vec::Vec<crate::model::DataValue>>,
    /// <p>The unit of measure used in this data type.</p>
    #[doc(hidden)]pub unit_of_measure: std::option::Option<std::string::String>,
    /// <p>A relationship that associates a component with another component.</p>
    #[doc(hidden)]pub relationship: std::option::Option<crate::model::Relationship>,
}
impl DataType {
    /// <p>The underlying type of the data type.</p>
...
pub struct Relationship  {
    ...
    #[doc(hidden)]pub target_component_type_id: std::option::Option<std::string::String>,
    /// <p>The type of the relationship.</p>
    #[doc(hidden)]pub relationship_type: std::option::Option<std::string::String>,
}
impl Relationship {
    /// <p>The ID of the target component type associated with this relationship.</p>
...
pub struct FunctionRequest  {
    ...
    #[doc(hidden)]pub required_properties: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The scope of the function.</p>
    #[doc(hidden)]pub scope: std::option::Option<crate::model::Scope>,
    /// <p>The data connector.</p>
    #[doc(hidden)]pub implemented_by: std::option::Option<crate::model::DataConnector>,
}
...
pub struct DataConnector  {
    ...
    #[doc(hidden)]pub lambda: std::option::Option<crate::model::LambdaFunction>,
    /// <p>A Boolean value that specifies whether the data connector is native to IoT TwinMaker.</p>
    #[doc(hidden)]pub is_native: std::option::Option<bool>,
}
impl DataConnector {
    /// <p>The Lambda function associated with this data connector.</p>
...
pub struct WorkspaceSummary  {
    ...
    #[doc(hidden)]pub update_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct EntitySummary  {
    ...
    #[doc(hidden)]pub has_child_entities: std::option::Option<bool>,
...
pub struct PropertyValueHistory  {
    ...
    #[doc(hidden)]pub entity_property_reference: std::option::Option<crate::model::EntityPropertyReference>,
    /// <p>A list of objects that contain information about the values in the history of a time series property.</p>
    #[doc(hidden)]pub values: std::option::Option<std::vec::Vec<crate::model::PropertyValue>>,
}
...
pub struct PropertyValue  {
    ...
    #[deprecated(note = "This field is deprecated and will throw an error in the future. Use time instead.")]#[doc(hidden)]pub timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub time: std::option::Option<std::string::String>,
}
impl PropertyValue {
    /// <p>The timestamp of a value for a time series property.</p>
    #[deprecated(note = "This field is deprecated and will throw an error in the future. Use time instead.")]pub fn timestamp(&self) -> std::option::Option<& aws_smithy_types::DateTime> {
...
pub mod property_value {
    ...
    impl Builder {
        /// <p>The timestamp of a value for a time series property.</p>
        #[deprecated(note = "This field is deprecated and will throw an error in the future. Use time instead.")]pub fn timestamp(mut self, input: aws_smithy_types::DateTime) -> Self {
            self.timestamp = Some(input);
            self
        }
        /// <p>The timestamp of a value for a time series property.</p>
        #[deprecated(note = "This field is deprecated and will throw an error in the future. Use time instead.")]pub fn set_timestamp(mut self, input: std::option::Option<aws_smithy_types::DateTime>) -> Self {
...
pub struct EntityPropertyReference  {
    ...
    #[doc(hidden)]pub external_id_property: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The ID of the entity.</p>
    #[doc(hidden)]pub entity_id: std::option::Option<std::string::String>,
    /// <p>The name of the property.</p>
    #[doc(hidden)]pub property_name: std::option::Option<std::string::String>,
}
...
pub struct InterpolationParameters  {
    ...
    #[doc(hidden)]pub interpolation_type: std::option::Option<crate::model::InterpolationType>,
...
pub struct PropertyFilter  {
    ...
    #[doc(hidden)]pub operator: std::option::Option<std::string::String>,
...
pub struct PropertyLatestValue  {
    /// <p>An object that specifies information about a property.&gt;</p>
    #[doc(hidden)]pub property_reference: std::option::Option<crate::model::EntityPropertyReference>,
    /// <p>The value of the property.</p>
    #[doc(hidden)]pub property_value: std::option::Option<crate::model::DataValue>,
}
...
pub struct ComponentResponse  {
    ...
    #[doc(hidden)]pub defined_in: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub properties: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PropertyResponse>>,
}
...
pub struct PropertyResponse  {
    /// <p>An object that specifies information about a property.</p>
    #[doc(hidden)]pub definition: std::option::Option<crate::model::PropertyDefinitionResponse>,
    /// <p>The value of the property.</p>
    #[doc(hidden)]pub value: std::option::Option<crate::model::DataValue>,
}
...
pub struct ComponentRequest  {
    ...
    #[doc(hidden)]pub component_type_id: std::option::Option<std::string::String>,
    /// <p>An object that maps strings to the properties to set in the component type. Each string in the mapping must be unique to this object.</p>
    #[doc(hidden)]pub properties: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PropertyRequest>>,
}
...
pub struct BatchPutPropertyErrorEntry  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchPutPropertyError>>,
}
...
pub struct BatchPutPropertyError  {
    ...
    /// <p>An object that contains information about errors returned by the <code>BatchPutProperty</code> action.</p>
    #[doc(hidden)]pub entry: std::option::Option<crate::model::PropertyValueEntry>,
}
...
pub struct PropertyValueEntry  {
    ...
    #[doc(hidden)]pub property_values: std::option::Option<std::vec::Vec<crate::model::PropertyValue>>,
}
