...
//! aws-sdk-marketplacedeployment = "0.0.0-local"
...
//! offered by AWS Marketplace Deployment Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Marketplace Deployment Service.
...
/// let config = aws_sdk_marketplacedeployment::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AWS Marketplace Deployment Service.
pub mod config;
