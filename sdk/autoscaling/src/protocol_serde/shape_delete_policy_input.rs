...
pub fn ser_delete_policy_input_input(input: &crate::operation::delete_policy::DeletePolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
