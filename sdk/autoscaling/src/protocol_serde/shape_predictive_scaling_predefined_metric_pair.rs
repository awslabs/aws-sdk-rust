...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_metric_pair(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingPredefinedMetricPair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
