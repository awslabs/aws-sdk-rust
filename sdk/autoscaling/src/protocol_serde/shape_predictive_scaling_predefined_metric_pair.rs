...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_metric_pair(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PredictiveScalingPredefinedMetricPair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_predefined_metric_pair(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PredictiveScalingPredefinedMetricPair, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
