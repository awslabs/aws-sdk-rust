...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_metric_pair(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingPredefinedMetricPair) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_predefined_metric_pair(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PredictiveScalingPredefinedMetricPair, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
