...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_lifecycle_hook_types::de_describe_lifecycle_hook_types(_response_body, output)
            .map_err(crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeLifecycleHookTypesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeLifecycleHookTypesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeLifecycleHookTypesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeLifecycleHookTypesResult got {start_el:?}"
            )));
        }
