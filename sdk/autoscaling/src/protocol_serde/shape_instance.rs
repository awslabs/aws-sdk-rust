...
pub fn de_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Instance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("LifecycleState") /* LifecycleState com.amazonaws.autoscaling#Instance$LifecycleState */ =>  {
                let var_4 =
                    Some(
                        Result::<crate::model::LifecycleState, aws_smithy_xml::decode::XmlDecodeError>::Ok(
