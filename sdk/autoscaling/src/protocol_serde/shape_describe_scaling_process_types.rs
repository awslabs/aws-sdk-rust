...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_scaling_process_types::de_describe_scaling_process_types(_response_body, output)
            .map_err(crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeScalingProcessTypesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeScalingProcessTypesResult got {start_el:?}"
            )));
        }
