...
pub fn de_create_or_update_tags_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_or_update_tags::CreateOrUpdateTagsOutput, crate::operation::create_or_update_tags::CreateOrUpdateTagsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_or_update_tags_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_or_update_tags::CreateOrUpdateTagsOutput, crate::operation::create_or_update_tags::CreateOrUpdateTagsError> {
    Ok({
        #[allow(unused_mut)]
