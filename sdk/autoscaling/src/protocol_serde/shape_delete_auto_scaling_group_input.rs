...
pub fn ser_delete_auto_scaling_group_input_input_input(input: &crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
