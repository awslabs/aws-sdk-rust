...
#[allow(unused_mut)]
pub fn ser_accelerator_count_request(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AcceleratorCountRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_accelerator_count_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AcceleratorCountRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
