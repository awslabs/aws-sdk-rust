...
#[allow(unused_mut)]
pub fn ser_accelerator_count_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AcceleratorCountRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
