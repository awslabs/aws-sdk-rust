...
pub fn ser_create_auto_scaling_group_input_input(input: &crate::input::CreateAutoScalingGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
