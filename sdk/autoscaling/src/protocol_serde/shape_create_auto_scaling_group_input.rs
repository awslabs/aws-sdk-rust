...
pub fn ser_create_auto_scaling_group_input_input_input(input: &crate::operation::create_auto_scaling_group::CreateAutoScalingGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
