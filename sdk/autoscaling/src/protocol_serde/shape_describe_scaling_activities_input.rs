...
pub fn ser_describe_scaling_activities_input_input_input(input: &crate::operation::describe_scaling_activities::DescribeScalingActivitiesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
