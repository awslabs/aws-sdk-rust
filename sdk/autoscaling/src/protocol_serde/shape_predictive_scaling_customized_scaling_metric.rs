...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_customized_scaling_metric(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingCustomizedScalingMetric) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
