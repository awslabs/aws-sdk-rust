...
pub fn de_set_instance_protection_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::set_instance_protection::SetInstanceProtectionOutput, crate::operation::set_instance_protection::SetInstanceProtectionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::set_instance_protection::SetInstanceProtectionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_instance_protection_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::set_instance_protection::SetInstanceProtectionOutput, crate::operation::set_instance_protection::SetInstanceProtectionError> {
    Ok({
        #[allow(unused_mut)]
