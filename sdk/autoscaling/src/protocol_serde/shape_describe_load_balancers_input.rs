...
pub fn ser_describe_load_balancers_input_input_input(input: &crate::operation::describe_load_balancers::DescribeLoadBalancersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
