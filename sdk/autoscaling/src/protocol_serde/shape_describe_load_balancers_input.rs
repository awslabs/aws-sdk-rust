...
pub fn ser_describe_load_balancers_input_input(input: &crate::input::DescribeLoadBalancersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
