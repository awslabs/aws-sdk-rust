...
pub fn de_terminate_instance_in_auto_scaling_group_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupError::unhandled)?;
    ...
    Err(match error_code {
        "ResourceContention" => {
            crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupError::ResourceContentionFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ScalingActivityInProgress" => {
            crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupError::ScalingActivityInProgressFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_terminate_instance_in_auto_scaling_group_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_terminate_instance_in_auto_scaling_group::de_terminate_instance_in_auto_scaling_group(
            _response_body,
            output,
        )
        .map_err(crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("TerminateInstanceInAutoScalingGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected TerminateInstanceInAutoScalingGroupResult got {start_el:?}"
            )));
        }
