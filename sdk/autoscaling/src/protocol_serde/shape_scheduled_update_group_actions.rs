...
pub fn de_scheduled_update_group_actions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ScheduledUpdateGroupAction>, aws_smithy_xml::decode::XmlDecodeError> {
