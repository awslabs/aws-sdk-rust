...
#[allow(unused_mut)]
pub fn ser_target_tracking_metric_stat(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetTrackingMetricStat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_tracking_metric_stat(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetTrackingMetricStat, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
