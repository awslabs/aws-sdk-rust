...
#[allow(unused_mut)]
pub fn ser_target_tracking_metric_stat(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetTrackingMetricStat) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
