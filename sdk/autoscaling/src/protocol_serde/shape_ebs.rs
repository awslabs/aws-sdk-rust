...
#[allow(unused_mut)]
pub fn ser_ebs(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Ebs) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ebs(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Ebs, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
