...
pub fn ser_put_notification_configuration_input_input_input(input: &crate::operation::put_notification_configuration::PutNotificationConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
