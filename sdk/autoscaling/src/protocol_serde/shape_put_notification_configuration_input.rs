...
pub fn ser_put_notification_configuration_input_input(input: &crate::input::PutNotificationConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
