...
#[allow(unused_mut)]
pub fn ser_predefined_metric_specification(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredefinedMetricSpecification) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predefined_metric_specification(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PredefinedMetricSpecification, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::predefined_metric_specification_correct_errors(builder).build())
}
