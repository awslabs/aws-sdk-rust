...
#[allow(unused_mut)]
pub fn ser_instance_monitoring(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::InstanceMonitoring) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_instance_monitoring(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceMonitoring, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
