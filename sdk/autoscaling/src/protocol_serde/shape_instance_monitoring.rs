...
#[allow(unused_mut)]
pub fn ser_instance_monitoring(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::InstanceMonitoring) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
