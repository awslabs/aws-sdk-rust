...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_customized_capacity_metric(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingCustomizedCapacityMetric) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
