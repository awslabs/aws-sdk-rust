...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_customized_capacity_metric(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingCustomizedCapacityMetric) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_customized_capacity_metric(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PredictiveScalingCustomizedCapacityMetric, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::predictive_scaling_customized_capacity_metric_correct_errors(builder).build())
}
