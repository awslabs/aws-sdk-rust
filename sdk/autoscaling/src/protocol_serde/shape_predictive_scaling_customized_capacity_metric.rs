...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_customized_capacity_metric(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PredictiveScalingCustomizedCapacityMetric) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_customized_capacity_metric(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PredictiveScalingCustomizedCapacityMetric, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
