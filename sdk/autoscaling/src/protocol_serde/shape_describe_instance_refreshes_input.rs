...
pub fn ser_describe_instance_refreshes_input_input_input(input: &crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("InstanceRefreshIds");
    if let Some(var_4) = &input.instance_refresh_ids {
