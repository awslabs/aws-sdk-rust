...
pub fn ser_describe_instance_refreshes_input_input(input: &crate::input::DescribeInstanceRefreshesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
