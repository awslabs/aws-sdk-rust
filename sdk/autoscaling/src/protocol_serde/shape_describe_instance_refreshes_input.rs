...
pub fn ser_describe_instance_refreshes_input_input(input: &crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
