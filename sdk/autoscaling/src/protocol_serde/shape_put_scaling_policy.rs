...
#[allow(unused_mut)]
pub fn de_put_scaling_policy(inp: &[u8], mut builder: crate::output::put_scaling_policy_output::Builder) -> Result<crate::output::put_scaling_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
