...
pub fn ser_attach_instances_input_input_input(input: &crate::operation::attach_instances::AttachInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
