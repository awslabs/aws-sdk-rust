...
pub fn ser_attach_instances_input_input(input: &crate::operation::attach_instances::AttachInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
