...
pub fn ser_put_lifecycle_hook_input_input_input(input: &crate::operation::put_lifecycle_hook::PutLifecycleHookInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
