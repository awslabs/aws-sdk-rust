...
pub fn ser_put_lifecycle_hook_input_input(input: &crate::input::PutLifecycleHookInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
