...
#[allow(unused_mut)]
pub fn ser_network_interface_count_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::NetworkInterfaceCountRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_network_interface_count_request(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::NetworkInterfaceCountRequest, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::NetworkInterfaceCountRequest::builder();
