...
pub fn ser_batch_delete_scheduled_action_input_input(input: &crate::input::BatchDeleteScheduledActionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
