...
pub fn ser_batch_delete_scheduled_action_input_input_input(input: &crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
