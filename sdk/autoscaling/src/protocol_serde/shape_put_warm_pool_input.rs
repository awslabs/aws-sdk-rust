...
pub fn ser_put_warm_pool_input_input_input(input: &crate::operation::put_warm_pool::PutWarmPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
