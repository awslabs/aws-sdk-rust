...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_scaling_metric(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingPredefinedScalingMetric) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
