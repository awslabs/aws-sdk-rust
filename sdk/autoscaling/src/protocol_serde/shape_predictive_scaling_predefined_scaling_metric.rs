...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_scaling_metric(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PredictiveScalingPredefinedScalingMetric) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_predefined_scaling_metric(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PredictiveScalingPredefinedScalingMetric, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
