...
pub fn ser_detach_load_balancer_target_groups_input_input(input: &crate::input::DetachLoadBalancerTargetGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
