...
pub fn de_instance_refresh_warm_pool_progress(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceRefreshWarmPoolProgress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
