...
pub fn de_load_balancer_target_group_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LoadBalancerTargetGroupState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("LoadBalancerTargetGroupARN") /* LoadBalancerTargetGroupARN com.amazonaws.autoscaling#LoadBalancerTargetGroupState$LoadBalancerTargetGroupARN */ =>  {
                ...
                ;
                builder = builder.set_load_balancer_target_group_arn(var_1);
            }
            ,
