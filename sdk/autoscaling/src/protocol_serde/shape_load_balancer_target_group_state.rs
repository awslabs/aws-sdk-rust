...
pub fn de_load_balancer_target_group_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerTargetGroupState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
