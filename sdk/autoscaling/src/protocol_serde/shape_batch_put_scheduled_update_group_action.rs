...
pub fn de_batch_put_scheduled_update_group_action_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceContention" => {
            crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionError::ResourceContentionFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_put_scheduled_update_group_action_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action(_response_body, output)
                .map_err(crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("BatchPutScheduledUpdateGroupActionResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected BatchPutScheduledUpdateGroupActionResult got {start_el:?}"
            )));
        }
