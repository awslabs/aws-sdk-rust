...
pub fn ser_exit_standby_input_input_input(input: &crate::operation::exit_standby::ExitStandbyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
