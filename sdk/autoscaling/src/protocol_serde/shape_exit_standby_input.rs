...
pub fn ser_exit_standby_input_input(input: &crate::input::ExitStandbyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
