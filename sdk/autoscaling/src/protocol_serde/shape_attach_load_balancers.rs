...
pub fn de_attach_load_balancers_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_load_balancers::AttachLoadBalancersOutput, crate::operation::attach_load_balancers::AttachLoadBalancersError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_load_balancers_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_load_balancers::AttachLoadBalancersOutput, crate::operation::attach_load_balancers::AttachLoadBalancersError> {
    Ok({
        #[allow(unused_mut)]
