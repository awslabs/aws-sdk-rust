...
#[allow(unused_mut)]
pub fn ser_mixed_instances_policy(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MixedInstancesPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_mixed_instances_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MixedInstancesPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
