...
#[allow(unused_mut)]
pub fn ser_mixed_instances_policy(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MixedInstancesPolicy) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
