...
pub fn ser_put_scheduled_update_group_action_input_input(input: &crate::input::PutScheduledUpdateGroupActionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
