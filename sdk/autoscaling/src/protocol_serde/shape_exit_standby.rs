...
#[allow(clippy::unnecessary_wraps)]
pub fn de_exit_standby_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::exit_standby::ExitStandbyOutput, crate::operation::exit_standby::ExitStandbyError> {
...
) -> Result<crate::operation::exit_standby::builders::ExitStandbyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
