...
pub fn ser_get_predictive_scaling_forecast_input_input_input(input: &crate::operation::get_predictive_scaling_forecast::GetPredictiveScalingForecastInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
