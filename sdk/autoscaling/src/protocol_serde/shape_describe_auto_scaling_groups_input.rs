...
pub fn ser_describe_auto_scaling_groups_input_input_input(input: &crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
