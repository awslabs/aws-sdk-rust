...
pub fn ser_describe_auto_scaling_groups_input_input(input: &crate::input::DescribeAutoScalingGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
