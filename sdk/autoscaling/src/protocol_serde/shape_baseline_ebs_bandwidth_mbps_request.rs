...
#[allow(unused_mut)]
pub fn ser_baseline_ebs_bandwidth_mbps_request(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::BaselineEbsBandwidthMbpsRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_baseline_ebs_bandwidth_mbps_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BaselineEbsBandwidthMbpsRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
