...
#[allow(unused_mut)]
pub fn ser_baseline_ebs_bandwidth_mbps_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::BaselineEbsBandwidthMbpsRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
