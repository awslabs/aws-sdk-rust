...
pub fn de_start_instance_refresh_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StartInstanceRefreshOutput, crate::error::StartInstanceRefreshError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::StartInstanceRefreshError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_instance_refresh_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StartInstanceRefreshOutput, crate::error::StartInstanceRefreshError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::start_instance_refresh_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_start_instance_refresh::de_start_instance_refresh(response.body().as_ref(), output).map_err(crate::error::StartInstanceRefreshError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_start_instance_refresh(inp: &[u8], mut builder: crate::output::start_instance_refresh_output::Builder) -> Result<crate::output::start_instance_refresh_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
