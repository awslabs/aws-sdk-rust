...
pub fn de_predictive_scaling_forecast_values(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<f64>, aws_smithy_xml::decode::XmlDecodeError> {
