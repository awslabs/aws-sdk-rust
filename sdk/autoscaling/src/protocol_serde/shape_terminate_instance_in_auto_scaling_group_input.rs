...
pub fn ser_terminate_instance_in_auto_scaling_group_input_input(input: &crate::input::TerminateInstanceInAutoScalingGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
