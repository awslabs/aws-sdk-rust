...
pub fn ser_terminate_instance_in_auto_scaling_group_input_input_input(input: &crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
