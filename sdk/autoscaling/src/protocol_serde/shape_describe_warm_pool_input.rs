...
pub fn ser_describe_warm_pool_input_input(input: &crate::input::DescribeWarmPoolInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
