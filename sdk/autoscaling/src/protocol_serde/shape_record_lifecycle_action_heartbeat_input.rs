...
pub fn ser_record_lifecycle_action_heartbeat_input_input_input(
    input: &crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeatInput,
