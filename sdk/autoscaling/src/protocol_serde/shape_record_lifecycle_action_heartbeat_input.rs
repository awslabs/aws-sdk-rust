...
pub fn ser_record_lifecycle_action_heartbeat_input_input(input: &crate::input::RecordLifecycleActionHeartbeatInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
