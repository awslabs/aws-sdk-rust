...
pub fn de_accelerator_total_memory_mib_request(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AcceleratorTotalMemoryMiBRequest, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
