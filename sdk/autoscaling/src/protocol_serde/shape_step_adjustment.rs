...
#[allow(unused_mut)]
pub fn ser_step_adjustment(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::StepAdjustment) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
