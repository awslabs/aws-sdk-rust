...
#[allow(unused_mut)]
pub fn ser_step_adjustment(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::StepAdjustment) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_step_adjustment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StepAdjustment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
