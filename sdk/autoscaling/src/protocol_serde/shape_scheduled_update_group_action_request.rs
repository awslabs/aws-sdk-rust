...
#[allow(unused_mut)]
pub fn ser_scheduled_update_group_action_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledUpdateGroupActionRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
