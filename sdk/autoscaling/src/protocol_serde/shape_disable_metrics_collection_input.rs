...
pub fn ser_disable_metrics_collection_input_input(input: &crate::input::DisableMetricsCollectionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
