...
pub fn ser_disable_metrics_collection_input_input_input(input: &crate::operation::disable_metrics_collection::DisableMetricsCollectionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
