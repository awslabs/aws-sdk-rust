...
pub fn ser_describe_policies_input_input_input(input: &crate::operation::describe_policies::DescribePoliciesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
