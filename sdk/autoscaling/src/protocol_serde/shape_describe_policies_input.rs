...
pub fn ser_describe_policies_input_input(input: &crate::input::DescribePoliciesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
