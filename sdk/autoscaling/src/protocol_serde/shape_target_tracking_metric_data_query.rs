...
#[allow(unused_mut)]
pub fn ser_target_tracking_metric_data_query(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetTrackingMetricDataQuery) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_tracking_metric_data_query(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TargetTrackingMetricDataQuery, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::target_tracking_metric_data_query_correct_errors(builder).build())
}
