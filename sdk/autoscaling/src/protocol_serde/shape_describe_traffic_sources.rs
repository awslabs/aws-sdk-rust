...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_traffic_sources::DescribeTrafficSourcesError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_traffic_sources::de_describe_traffic_sources(_response_body, output)
            .map_err(crate::operation::describe_traffic_sources::DescribeTrafficSourcesError::unhandled)?;
