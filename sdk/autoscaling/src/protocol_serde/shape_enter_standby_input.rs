...
pub fn ser_enter_standby_input_input_input(input: &crate::operation::enter_standby::EnterStandbyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
