...
#[allow(unused_mut)]
pub fn ser_refresh_preferences(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RefreshPreferences) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
