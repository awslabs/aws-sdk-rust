...
#[allow(unused_mut)]
pub fn ser_refresh_preferences(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::RefreshPreferences) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_refresh_preferences(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RefreshPreferences, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
