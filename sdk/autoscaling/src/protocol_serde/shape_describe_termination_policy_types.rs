...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_termination_policy_types::DescribeTerminationPolicyTypesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_termination_policy_types::de_describe_termination_policy_types(_response_body, output)
            .map_err(crate::operation::describe_termination_policy_types::DescribeTerminationPolicyTypesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeTerminationPolicyTypesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeTerminationPolicyTypesResult got {start_el:?}"
            )));
        }
