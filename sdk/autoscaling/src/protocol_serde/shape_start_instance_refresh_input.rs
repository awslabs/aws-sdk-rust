...
pub fn ser_start_instance_refresh_input_input_input(input: &crate::operation::start_instance_refresh::StartInstanceRefreshInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
