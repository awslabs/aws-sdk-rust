...
pub fn ser_start_instance_refresh_input_input(input: &crate::input::StartInstanceRefreshInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
