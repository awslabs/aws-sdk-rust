...
pub fn ser_delete_lifecycle_hook_input_input_input(input: &crate::operation::delete_lifecycle_hook::DeleteLifecycleHookInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
