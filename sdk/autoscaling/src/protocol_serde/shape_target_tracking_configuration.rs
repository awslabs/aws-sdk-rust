...
#[allow(unused_mut)]
pub fn ser_target_tracking_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetTrackingConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_tracking_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetTrackingConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
