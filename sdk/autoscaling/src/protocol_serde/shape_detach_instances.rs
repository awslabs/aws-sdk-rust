...
pub fn de_detach_instances_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_detach_instances::de_detach_instances(_response_body, output)
            .map_err(crate::operation::detach_instances::DetachInstancesError::unhandled)?;
...
pub fn de_detach_instances(
...
) -> std::result::Result<crate::operation::detach_instances::builders::DetachInstancesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DetachInstancesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DetachInstancesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DetachInstancesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DetachInstancesResult got {start_el:?}"
            )));
        }
