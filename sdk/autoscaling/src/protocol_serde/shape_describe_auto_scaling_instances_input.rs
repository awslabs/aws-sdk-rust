...
pub fn ser_describe_auto_scaling_instances_input_input(input: &crate::input::DescribeAutoScalingInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
