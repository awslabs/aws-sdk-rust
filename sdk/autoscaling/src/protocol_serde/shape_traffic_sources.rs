...
pub fn de_traffic_sources(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TrafficSourceIdentifier>, aws_smithy_xml::decode::XmlDecodeError> {
