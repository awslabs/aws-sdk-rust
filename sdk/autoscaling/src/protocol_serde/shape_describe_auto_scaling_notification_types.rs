...
pub fn de_describe_auto_scaling_notification_types_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ResourceContention" => {
            crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesError::ResourceContentionFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_auto_scaling_notification_types_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_auto_scaling_notification_types::de_describe_auto_scaling_notification_types(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeAutoScalingNotificationTypesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeAutoScalingNotificationTypesResult got {start_el:?}"
            )));
        }
