...
pub fn ser_describe_notification_configurations_input_input_input(input: &crate::operation::describe_notification_configurations::DescribeNotificationConfigurationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
