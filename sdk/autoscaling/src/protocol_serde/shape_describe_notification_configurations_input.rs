...
pub fn ser_describe_notification_configurations_input_input(input: &crate::input::DescribeNotificationConfigurationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
