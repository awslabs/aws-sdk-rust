...
pub fn ser_describe_traffic_sources_input_input_input(input: &crate::operation::describe_traffic_sources::DescribeTrafficSourcesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
