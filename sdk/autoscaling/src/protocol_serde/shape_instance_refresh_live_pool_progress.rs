...
pub fn de_instance_refresh_live_pool_progress(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::InstanceRefreshLivePoolProgress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::InstanceRefreshLivePoolProgress::builder();
