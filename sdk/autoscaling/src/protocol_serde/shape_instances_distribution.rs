...
#[allow(unused_mut)]
pub fn ser_instances_distribution(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::InstancesDistribution) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_instances_distribution(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstancesDistribution, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
