...
pub fn ser_describe_launch_configurations_input_input_input(input: &crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeLaunchConfigurations", "2011-01-01");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("LaunchConfigurationNames");
    if let Some(var_2) = &input.launch_configuration_names {
