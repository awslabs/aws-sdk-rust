...
pub fn ser_describe_launch_configurations_input_input(input: &crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
