...
pub fn ser_describe_launch_configurations_input_input(input: &crate::input::DescribeLaunchConfigurationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
