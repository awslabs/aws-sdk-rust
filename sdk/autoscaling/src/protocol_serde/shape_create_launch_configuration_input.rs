...
pub fn ser_create_launch_configuration_input_input_input(input: &crate::operation::create_launch_configuration::CreateLaunchConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
