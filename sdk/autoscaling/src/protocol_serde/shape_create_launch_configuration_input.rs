...
pub fn ser_create_launch_configuration_input_input(input: &crate::input::CreateLaunchConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
