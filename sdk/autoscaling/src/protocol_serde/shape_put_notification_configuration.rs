...
pub fn de_put_notification_configuration_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_notification_configuration::PutNotificationConfigurationOutput, crate::operation::put_notification_configuration::PutNotificationConfigurationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_notification_configuration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_notification_configuration::PutNotificationConfigurationOutput, crate::operation::put_notification_configuration::PutNotificationConfigurationError> {
    Ok({
        #[allow(unused_mut)]
