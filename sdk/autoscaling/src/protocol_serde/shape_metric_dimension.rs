...
#[allow(unused_mut)]
pub fn ser_metric_dimension(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MetricDimension) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metric_dimension(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricDimension, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
