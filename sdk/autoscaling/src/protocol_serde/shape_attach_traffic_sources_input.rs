...
pub fn ser_attach_traffic_sources_input_input(
    input: &crate::operation::attach_traffic_sources::AttachTrafficSourcesInput,
    ...
    if let Some(var_4) = &input.traffic_sources {
        ...
        for item_5 in var_4 {
            ...
            crate::protocol_serde::shape_traffic_source_identifier::ser_traffic_source_identifier(
                entry_7, item_5,
            )?;
        }
        list_6.finish();
