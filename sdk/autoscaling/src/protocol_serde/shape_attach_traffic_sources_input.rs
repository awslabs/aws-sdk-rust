...
pub fn ser_attach_traffic_sources_input_input_input(input: &crate::operation::attach_traffic_sources::AttachTrafficSourcesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
