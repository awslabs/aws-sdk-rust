...
#[allow(unused_mut)]
pub fn ser_memory_mi_b_request(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MemoryMiBRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_memory_mi_b_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MemoryMiBRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
