...
pub fn de_memory_mib_request(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MemoryMiBRequest, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::memory_mib_request_correct_errors(builder).build())
}
