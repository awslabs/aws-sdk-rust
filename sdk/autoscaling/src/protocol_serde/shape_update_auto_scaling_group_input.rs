...
pub fn ser_update_auto_scaling_group_input_input(input: &crate::input::UpdateAutoScalingGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
