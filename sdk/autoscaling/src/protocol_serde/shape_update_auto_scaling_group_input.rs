...
pub fn ser_update_auto_scaling_group_input_input_input(input: &crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
