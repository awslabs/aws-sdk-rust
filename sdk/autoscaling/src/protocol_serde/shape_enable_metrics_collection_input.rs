...
pub fn ser_enable_metrics_collection_input_input_input(input: &crate::operation::enable_metrics_collection::EnableMetricsCollectionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
