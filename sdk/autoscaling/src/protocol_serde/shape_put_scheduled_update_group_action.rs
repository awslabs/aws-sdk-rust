...
pub fn de_put_scheduled_update_group_action_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutScheduledUpdateGroupActionOutput, crate::error::PutScheduledUpdateGroupActionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutScheduledUpdateGroupActionError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceContention" => crate::error::PutScheduledUpdateGroupActionError::ResourceContentionFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_scheduled_update_group_action_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutScheduledUpdateGroupActionOutput, crate::error::PutScheduledUpdateGroupActionError> {
    Ok({
        #[allow(unused_mut)]
