...
pub fn de_auto_scaling_instance_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AutoScalingInstanceDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
