...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_load_metric(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PredictiveScalingPredefinedLoadMetric) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_predefined_load_metric(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PredictiveScalingPredefinedLoadMetric, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
