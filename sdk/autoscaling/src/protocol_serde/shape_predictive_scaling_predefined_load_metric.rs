...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_predefined_load_metric(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PredictiveScalingPredefinedLoadMetric) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
