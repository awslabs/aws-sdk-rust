...
#[allow(unused_mut)]
pub fn ser_instance_metadata_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::InstanceMetadataOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
