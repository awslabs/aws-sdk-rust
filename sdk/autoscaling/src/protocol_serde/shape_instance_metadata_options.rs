...
#[allow(unused_mut)]
pub fn ser_instance_metadata_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::InstanceMetadataOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_instance_metadata_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceMetadataOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
