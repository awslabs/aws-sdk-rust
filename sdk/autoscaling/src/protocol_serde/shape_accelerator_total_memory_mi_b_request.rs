...
pub fn de_accelerator_total_memory_mi_b_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AcceleratorTotalMemoryMiBRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
