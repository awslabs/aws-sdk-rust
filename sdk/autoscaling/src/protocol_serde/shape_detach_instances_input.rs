...
pub fn ser_detach_instances_input_input_input(input: &crate::operation::detach_instances::DetachInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
