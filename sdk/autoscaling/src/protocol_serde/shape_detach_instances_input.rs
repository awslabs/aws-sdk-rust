...
pub fn ser_detach_instances_input_input(input: &crate::input::DetachInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
