...
pub fn ser_set_instance_protection_input_input(input: &crate::input::SetInstanceProtectionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
