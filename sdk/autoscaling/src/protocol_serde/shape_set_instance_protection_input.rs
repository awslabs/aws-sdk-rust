...
pub fn ser_set_instance_protection_input_input_input(input: &crate::operation::set_instance_protection::SetInstanceProtectionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
