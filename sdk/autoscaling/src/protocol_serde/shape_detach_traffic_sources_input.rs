...
pub fn ser_detach_traffic_sources_input_input(input: &crate::input::DetachTrafficSourcesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
