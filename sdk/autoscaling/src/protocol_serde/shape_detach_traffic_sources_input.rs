...
pub fn ser_detach_traffic_sources_input_input_input(input: &crate::operation::detach_traffic_sources::DetachTrafficSourcesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
