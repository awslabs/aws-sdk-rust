...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_instance_refresh_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, crate::operation::cancel_instance_refresh::CancelInstanceRefreshError> {
    Ok({
        #[allow(unused_mut)]
