...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(unused_mut)]
pub fn de_describe_auto_scaling_groups(
    inp: &[u8],
    mut builder: crate::operation::describe_auto_scaling_groups::builders::DescribeAutoScalingGroupsOutputBuilder,
) -> Result<crate::operation::describe_auto_scaling_groups::builders::DescribeAutoScalingGroupsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
