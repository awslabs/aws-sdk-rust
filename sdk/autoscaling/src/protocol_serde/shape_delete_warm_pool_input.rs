...
pub fn ser_delete_warm_pool_input_input(input: &crate::input::DeleteWarmPoolInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
