...
pub fn ser_delete_warm_pool_input_input_input(input: &crate::operation::delete_warm_pool::DeleteWarmPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
