...
#[allow(unused_mut)]
pub fn ser_v_cpu_count_request(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::VCpuCountRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
