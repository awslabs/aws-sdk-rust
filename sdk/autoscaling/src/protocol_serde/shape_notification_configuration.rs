...
pub fn de_notification_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NotificationConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
