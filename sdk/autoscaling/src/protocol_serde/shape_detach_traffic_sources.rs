...
pub fn de_detach_traffic_sources_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DetachTrafficSourcesOutput, crate::error::DetachTrafficSourcesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DetachTrafficSourcesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_detach_traffic_sources_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DetachTrafficSourcesOutput, crate::error::DetachTrafficSourcesError> {
    Ok({
        #[allow(unused_mut)]
