...
pub fn ser_delete_notification_configuration_input_input_input(input: &crate::operation::delete_notification_configuration::DeleteNotificationConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
