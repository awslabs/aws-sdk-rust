...
pub fn ser_delete_notification_configuration_input_input(input: &crate::input::DeleteNotificationConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
