...
#[allow(unused_mut)]
pub fn ser_predictive_scaling_metric_specification(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PredictiveScalingMetricSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_predictive_scaling_metric_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PredictiveScalingMetricSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
