...
pub fn de_describe_warm_pool_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeWarmPoolOutput, crate::error::DescribeWarmPoolError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeWarmPoolError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_warm_pool_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeWarmPoolOutput, crate::error::DescribeWarmPoolError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_warm_pool_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_warm_pool::de_describe_warm_pool(response.body().as_ref(), output).map_err(crate::error::DescribeWarmPoolError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_warm_pool(inp: &[u8], mut builder: crate::output::describe_warm_pool_output::Builder) -> Result<crate::output::describe_warm_pool_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
