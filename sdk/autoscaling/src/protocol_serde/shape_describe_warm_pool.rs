...
pub fn de_describe_warm_pool_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_warm_pool::DescribeWarmPoolOutput, crate::operation::describe_warm_pool::DescribeWarmPoolError> {
    #[allow(unused_mut)]
...
pub fn de_describe_warm_pool_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_warm_pool::de_describe_warm_pool(_response_body, output)
            .map_err(crate::operation::describe_warm_pool::DescribeWarmPoolError::unhandled)?;
...
pub fn de_describe_warm_pool(
...
) -> std::result::Result<crate::operation::describe_warm_pool::builders::DescribeWarmPoolOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeWarmPoolResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeWarmPoolResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeWarmPoolResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeWarmPoolResult got {start_el:?}"
            )));
        }
