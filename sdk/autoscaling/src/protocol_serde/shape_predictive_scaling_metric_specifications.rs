...
pub fn de_predictive_scaling_metric_specifications(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PredictiveScalingMetricSpecification>, aws_smithy_xml::decode::XmlDecodeError> {
