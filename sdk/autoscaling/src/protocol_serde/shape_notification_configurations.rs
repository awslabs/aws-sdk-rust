...
pub fn de_notification_configurations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::NotificationConfiguration>, aws_smithy_xml::decode::XmlDecodeError> {
