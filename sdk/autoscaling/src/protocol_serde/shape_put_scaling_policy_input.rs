...
pub fn ser_put_scaling_policy_input_input(input: &crate::input::PutScalingPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
