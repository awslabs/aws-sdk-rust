...
pub fn ser_put_scaling_policy_input_input_input(input: &crate::operation::put_scaling_policy::PutScalingPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
