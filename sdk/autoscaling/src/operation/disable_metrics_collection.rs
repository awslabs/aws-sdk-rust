...
impl DisableMetricsCollectionInput {
    /// Consumes the builder and constructs an Operation<[`DisableMetricsCollection`](crate::operation::disable_metrics_collection::DisableMetricsCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_metrics_collection::DisableMetricsCollection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_metrics_collection::DisableMetricsCollectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_metrics_collection::DisableMetricsCollection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableMetricsCollection", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DisableMetricsCollection`.
...
impl aws_smithy_http::response::ParseStrictResponse for DisableMetricsCollection {
                type Output = std::result::Result<crate::operation::disable_metrics_collection::DisableMetricsCollectionOutput, crate::operation::disable_metrics_collection::DisableMetricsCollectionError>;
