...
/// Orchestration and serialization glue logic for `DisableMetricsCollection`.
...
impl DisableMetricsCollection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_metrics_collection::DisableMetricsCollectionInput,
                    ) -> ::std::result::Result<crate::operation::disable_metrics_collection::DisableMetricsCollectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_metrics_collection::DisableMetricsCollectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_metrics_collection::DisableMetricsCollectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_metrics_collection::DisableMetricsCollectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableMetricsCollection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableMetricsCollection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableMetricsCollectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableMetricsCollectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableMetricsCollection")
...
.with_interceptor(DisableMetricsCollectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_metrics_collection::DisableMetricsCollectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_metrics_collection::DisableMetricsCollectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_metrics_collection::DisableMetricsCollectionError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableMetricsCollectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_metrics_collection::de_disable_metrics_collection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_metrics_collection::de_disable_metrics_collection_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableMetricsCollectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_metrics_collection::DisableMetricsCollectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_metrics_collection::DisableMetricsCollectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_metrics_collection_input::ser_disable_metrics_collection_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableMetricsCollectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableMetricsCollectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableMetricsCollectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableMetricsCollectionInput>()
                        .ok_or("failed to downcast to DisableMetricsCollectionInput")?;
...
pub enum DisableMetricsCollectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableMetricsCollectionError) for what information is available for the error.")]
...
impl DisableMetricsCollectionError {
    /// Creates the `DisableMetricsCollectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableMetricsCollectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableMetricsCollectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_metrics_collection::DisableMetricsCollectionError {
...
mod _disable_metrics_collection_output;
