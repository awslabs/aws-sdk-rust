...
impl DescribeTrafficSources {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_traffic_sources::DescribeTrafficSourcesInput,
                    ) -> ::std::result::Result<crate::operation::describe_traffic_sources::DescribeTrafficSourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_traffic_sources::DescribeTrafficSourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTrafficSources {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeTrafficSources");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeTrafficSourcesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeTrafficSourcesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTrafficSources")
...
.with_interceptor(DescribeTrafficSourcesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesError>::new());
...
#[derive(Debug)]
            struct DescribeTrafficSourcesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTrafficSourcesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_traffic_sources::de_describe_traffic_sources_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_traffic_sources::de_describe_traffic_sources_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeTrafficSourcesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTrafficSourcesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_traffic_sources::DescribeTrafficSourcesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_traffic_sources::DescribeTrafficSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_traffic_sources_input::ser_describe_traffic_sources_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeTrafficSourcesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeTrafficSourcesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeTrafficSourcesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeTrafficSourcesInput>()
                        .ok_or("failed to downcast to DescribeTrafficSourcesInput")?;
...
pub enum DescribeTrafficSourcesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeTrafficSourcesError) for what information is available for the error.")]
...
impl DescribeTrafficSourcesError {
    /// Creates the `DescribeTrafficSourcesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeTrafficSourcesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeTrafficSourcesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_traffic_sources::DescribeTrafficSourcesError {
...
mod _describe_traffic_sources_output;
