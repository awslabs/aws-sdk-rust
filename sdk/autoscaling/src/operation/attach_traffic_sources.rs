...
impl AttachTrafficSourcesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_traffic_sources::AttachTrafficSources::new(),
        )
...
/// `ParseStrictResponse` impl for `AttachTrafficSources`.
...
impl aws_smithy_http::response::ParseStrictResponse for AttachTrafficSources {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_error(response)
        } else {
            crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::attach_traffic_sources::AttachTrafficSourcesError
{
