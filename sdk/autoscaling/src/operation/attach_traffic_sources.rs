...
impl AttachTrafficSources {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::attach_traffic_sources::AttachTrafficSourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::attach_traffic_sources::AttachTrafficSourcesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Auto Scaling", "AttachTrafficSources", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Auto Scaling.AttachTrafficSources",
                "rpc.service" = "Auto Scaling",
                "rpc.method" = "AttachTrafficSources",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachTrafficSources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AttachTrafficSourcesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AttachTrafficSourcesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AttachTrafficSources")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachTrafficSources")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AttachTrafficSourcesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AttachTrafficSourcesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachTrafficSourcesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AttachTrafficSourcesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachTrafficSourcesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachTrafficSourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::attach_traffic_sources::AttachTrafficSourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::attach_traffic_sources::AttachTrafficSourcesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_attach_traffic_sources_input::ser_attach_traffic_sources_input_input_input(&input)?,
        );
...
impl AttachTrafficSourcesError {
    ...
    /// Returns `true` if the error kind is `AttachTrafficSourcesError::InstanceRefreshInProgressFault`.
