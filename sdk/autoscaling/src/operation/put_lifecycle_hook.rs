...
impl PutLifecycleHook {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Auto Scaling", "PutLifecycleHook", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Auto Scaling.PutLifecycleHook",
                "rpc.service" = "Auto Scaling",
                "rpc.method" = "PutLifecycleHook",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutLifecycleHook")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutLifecycleHookResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_response(status, headers, body, _cfg)
        };
