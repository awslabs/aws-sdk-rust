...
impl PutLifecycleHook {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_lifecycle_hook::PutLifecycleHookError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_lifecycle_hook::PutLifecycleHookOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("autoscaling", "PutLifecycleHook", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutLifecycleHook {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutLifecycleHookRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutLifecycleHookResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutLifecycleHook", "autoscaling"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutLifecycleHook")
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutLifecycleHookRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_lifecycle_hook::PutLifecycleHookInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::put_lifecycle_hook::PutLifecycleHookInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_lifecycle_hook_input::ser_put_lifecycle_hook_input_input_input(&input)?,
        );
