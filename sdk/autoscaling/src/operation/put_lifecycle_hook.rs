...
impl PutLifecycleHookInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_lifecycle_hook::PutLifecycleHook::new(),
        )
...
/// `ParseStrictResponse` impl for `PutLifecycleHook`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutLifecycleHook {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::put_lifecycle_hook::PutLifecycleHookError
{
