...
impl DescribeAutoScalingGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroups,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAutoScalingGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_auto_scaling_groups::de_describe_auto_scaling_groups_http_response_with_props(status, headers, body)
        }
    }
}
