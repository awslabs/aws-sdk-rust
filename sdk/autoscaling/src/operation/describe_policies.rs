...
impl DescribePoliciesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePolicies`](crate::operation::describe_policies::DescribePolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_policies::DescribePolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_policies::DescribePoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_policies::DescribePolicies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePolicies", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribePolicies`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePolicies {
                type Output = std::result::Result<crate::operation::describe_policies::DescribePoliciesOutput, crate::operation::describe_policies::DescribePoliciesError>;
