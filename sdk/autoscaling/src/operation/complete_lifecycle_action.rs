...
impl CompleteLifecycleActionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::complete_lifecycle_action::CompleteLifecycleAction::new(),
        )
...
/// `ParseStrictResponse` impl for `CompleteLifecycleAction`.
...
impl aws_smithy_http::response::ParseStrictResponse for CompleteLifecycleAction {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_complete_lifecycle_action::de_complete_lifecycle_action_http_error(response)
        } else {
            crate::protocol_serde::shape_complete_lifecycle_action::de_complete_lifecycle_action_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::complete_lifecycle_action::CompleteLifecycleActionError
{
