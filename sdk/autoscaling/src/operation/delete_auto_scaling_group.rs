...
impl DeleteAutoScalingGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAutoScalingGroup`](crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAutoScalingGroup", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteAutoScalingGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAutoScalingGroup {
                type Output = std::result::Result<crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupOutput, crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupError>;
