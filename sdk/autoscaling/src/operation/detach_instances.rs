...
impl DetachInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DetachInstances`](crate::operation::detach_instances::DetachInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_instances::DetachInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_instances::DetachInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_instances::DetachInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachInstances", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DetachInstances`.
...
impl aws_smithy_http::response::ParseStrictResponse for DetachInstances {
                type Output = std::result::Result<crate::operation::detach_instances::DetachInstancesOutput, crate::operation::detach_instances::DetachInstancesError>;
