...
impl ResumeProcessesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resume_processes::ResumeProcesses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeProcesses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resume_processes::de_resume_processes_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::resume_processes::ResumeProcessesError
{
