...
impl crate::operation::set_desired_capacity::builders::SetDesiredCapacityInputBuilder {
...
/// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-scaling-manually.html">Manual scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
...
impl SetDesiredCapacityFluentBuilder {
    /// Creates a new `SetDesiredCapacityFluentBuilder`.
