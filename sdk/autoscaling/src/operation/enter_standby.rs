...
impl EnterStandbyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::enter_standby::EnterStandby, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enter_standby_input::ser_enter_standby_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnterStandby {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enter_standby::de_enter_standby_http_response_with_props(status, headers, body)
        }
    }
}
