...
impl EnterStandbyInput {
    /// Consumes the builder and constructs an Operation<[`EnterStandby`](crate::operation::enter_standby::EnterStandby)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enter_standby::EnterStandby, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enter_standby::EnterStandbyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enter_standby::EnterStandby::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnterStandby", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `EnterStandby`.
...
impl aws_smithy_http::response::ParseStrictResponse for EnterStandby {
                type Output = std::result::Result<crate::operation::enter_standby::EnterStandbyOutput, crate::operation::enter_standby::EnterStandbyError>;
