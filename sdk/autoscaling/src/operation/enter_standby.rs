...
impl EnterStandbyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enter_standby::EnterStandby::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnterStandby {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enter_standby::de_enter_standby_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enter_standby::de_enter_standby_http_response_with_props(
                status, headers, body,
            )
        }
    }
