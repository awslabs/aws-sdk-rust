...
impl SetInstanceProtectionInput {
    /// Consumes the builder and constructs an Operation<[`SetInstanceProtection`](crate::operation::set_instance_protection::SetInstanceProtection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_instance_protection::SetInstanceProtection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_instance_protection::SetInstanceProtectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_instance_protection::SetInstanceProtection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetInstanceProtection", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SetInstanceProtection`.
...
impl aws_smithy_http::response::ParseStrictResponse for SetInstanceProtection {
                type Output = std::result::Result<crate::operation::set_instance_protection::SetInstanceProtectionOutput, crate::operation::set_instance_protection::SetInstanceProtectionError>;
