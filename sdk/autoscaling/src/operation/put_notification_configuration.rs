...
impl PutNotificationConfigurationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_notification_configuration::PutNotificationConfiguration::new(),
        )
...
/// `ParseStrictResponse` impl for `PutNotificationConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutNotificationConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_put_notification_configuration::de_put_notification_configuration_http_error(response)
        } else {
            crate::protocol_serde::shape_put_notification_configuration::de_put_notification_configuration_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::put_notification_configuration::PutNotificationConfigurationError
{
