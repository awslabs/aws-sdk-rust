...
impl StartInstanceRefresh {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Auto Scaling", "StartInstanceRefresh", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Auto Scaling.StartInstanceRefresh",
                "rpc.service" = "Auto Scaling",
                "rpc.method" = "StartInstanceRefresh",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartInstanceRefresh {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartInstanceRefreshRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartInstanceRefreshResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartInstanceRefresh")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartInstanceRefresh")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartInstanceRefreshTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartInstanceRefreshTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartInstanceRefreshTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartInstanceRefreshInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartInstanceRefreshResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_instance_refresh::de_start_instance_refresh_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_instance_refresh::de_start_instance_refresh_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartInstanceRefreshRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_instance_refresh::StartInstanceRefreshInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_instance_refresh_input::ser_start_instance_refresh_input_input_input(&input)?,
        );
