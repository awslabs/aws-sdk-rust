...
impl StartInstanceRefresh {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_instance_refresh::StartInstanceRefreshOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_instance_refresh::StartInstanceRefreshError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartInstanceRefresh {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartInstanceRefresh");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartInstanceRefreshRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartInstanceRefreshResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartInstanceRefresh")
...
.with_interceptor(StartInstanceRefreshEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_instance_refresh::StartInstanceRefreshError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_instance_refresh::StartInstanceRefreshError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_instance_refresh::StartInstanceRefreshError>::new());
...
#[derive(Debug)]
            struct StartInstanceRefreshResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartInstanceRefreshResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_instance_refresh::de_start_instance_refresh_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_instance_refresh::de_start_instance_refresh_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartInstanceRefreshRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartInstanceRefreshRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_instance_refresh::StartInstanceRefreshInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_instance_refresh::StartInstanceRefreshInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_instance_refresh_input::ser_start_instance_refresh_input_input_input(&input)?);
...
#[derive(Debug)]
            struct StartInstanceRefreshEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartInstanceRefreshEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartInstanceRefreshEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartInstanceRefreshInput>()
                        .ok_or("failed to downcast to StartInstanceRefreshInput")?;
...
pub enum StartInstanceRefreshError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartInstanceRefreshError) for what information is available for the error.")]
...
impl StartInstanceRefreshError {
    /// Creates the `StartInstanceRefreshError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartInstanceRefreshError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartInstanceRefreshError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_instance_refresh::StartInstanceRefreshError {
...
mod _start_instance_refresh_output;
