...
impl StartInstanceRefreshInput {
    /// Consumes the builder and constructs an Operation<[`StartInstanceRefresh`](crate::operation::start_instance_refresh::StartInstanceRefresh)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_instance_refresh::StartInstanceRefresh, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_instance_refresh::StartInstanceRefreshInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_instance_refresh::StartInstanceRefresh::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartInstanceRefresh {
                type Output = std::result::Result<crate::operation::start_instance_refresh::StartInstanceRefreshOutput, crate::operation::start_instance_refresh::StartInstanceRefreshError>;
