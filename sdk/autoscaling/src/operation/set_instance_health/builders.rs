...
impl SetInstanceHealthFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_instance_health::SetInstanceHealthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_instance_health::SetInstanceHealthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_instance_health::SetInstanceHealthOutput, crate::operation::set_instance_health::SetInstanceHealthError, Self> {
