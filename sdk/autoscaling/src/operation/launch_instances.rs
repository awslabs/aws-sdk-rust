...
/// Orchestration and serialization glue logic for `LaunchInstances`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LaunchInstances;
impl LaunchInstances {
    /// Creates a new `LaunchInstances`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::launch_instances::LaunchInstancesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::launch_instances::LaunchInstancesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Auto Scaling", "LaunchInstances", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Auto Scaling.LaunchInstances",
                "rpc.service" = "Auto Scaling",
                "rpc.method" = "LaunchInstances",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::launch_instances::LaunchInstancesInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LaunchInstances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("LaunchInstances");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            LaunchInstancesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            LaunchInstancesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("LaunchInstances")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("LaunchInstances")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                LaunchInstancesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                LaunchInstancesEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct LaunchInstancesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for LaunchInstancesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<LaunchInstancesInput>() else {
...
#[derive(Debug)]
struct LaunchInstancesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LaunchInstancesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_launch_instances::de_launch_instances_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_launch_instances::de_launch_instances_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct LaunchInstancesRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for LaunchInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::launch_instances::LaunchInstancesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::launch_instances::LaunchInstancesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_launch_instances_input::ser_launch_instances_input_input_input(&input)?,
        );
...
#[derive(Debug)]
struct LaunchInstancesEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for LaunchInstancesEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "LaunchInstancesEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<LaunchInstancesInput>()
            .ok_or("failed to downcast to LaunchInstancesInput")?;
...
/// Error type for the `LaunchInstancesError` operation.
#[non_exhaustive]
...
pub enum LaunchInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-LaunchInstancesError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl LaunchInstancesError {
    /// Creates the `LaunchInstancesError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `LaunchInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `LaunchInstancesError::ResourceContentionFault`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for LaunchInstancesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for LaunchInstancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::launch_instances::LaunchInstancesError {
