...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LaunchInstancesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_launch_instances::de_launch_instances_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_launch_instances::de_launch_instances_http_response(status, headers, body)
        };
