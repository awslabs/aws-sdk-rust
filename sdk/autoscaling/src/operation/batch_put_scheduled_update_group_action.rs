...
impl BatchPutScheduledUpdateGroupAction {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Auto Scaling.BatchPutScheduledUpdateGroupAction",
            "rpc.service" = "Auto Scaling",
            "rpc.method" = "BatchPutScheduledUpdateGroupAction",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchPutScheduledUpdateGroupAction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchPutScheduledUpdateGroupActionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchPutScheduledUpdateGroupActionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchPutScheduledUpdateGroupAction")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchPutScheduledUpdateGroupAction")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BatchPutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchPutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchPutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchPutScheduledUpdateGroupActionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchPutScheduledUpdateGroupActionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchPutScheduledUpdateGroupActionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionInput,
