...
impl BatchPutScheduledUpdateGroupActionInput {
    /// Consumes the builder and constructs an Operation<[`BatchPutScheduledUpdateGroupAction`](crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchPutScheduledUpdateGroupAction", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `BatchPutScheduledUpdateGroupAction`.
...
impl aws_smithy_http::response::ParseStrictResponse for BatchPutScheduledUpdateGroupAction {
                type Output = std::result::Result<crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionOutput, crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupActionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action_http_error(response)
                     } else {
                        crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action_http_response(response)
                     }
                }
            }
