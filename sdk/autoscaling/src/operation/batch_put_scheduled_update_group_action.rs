...
impl BatchPutScheduledUpdateGroupActionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupAction,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_put_scheduled_update_group_action::BatchPutScheduledUpdateGroupAction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchPutScheduledUpdateGroupAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_put_scheduled_update_group_action::de_batch_put_scheduled_update_group_action_http_response_with_props(
                status, headers, body,
            )
        }
    }
