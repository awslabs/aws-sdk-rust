...
impl AttachLoadBalancerTargetGroups {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::attach_load_balancer_target_groups::AttachLoadBalancerTargetGroupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::attach_load_balancer_target_groups::AttachLoadBalancerTargetGroupsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Auto Scaling",
            "rpc.method" = "AttachLoadBalancerTargetGroups",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachLoadBalancerTargetGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AttachLoadBalancerTargetGroupsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AttachLoadBalancerTargetGroupsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AttachLoadBalancerTargetGroups")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachLoadBalancerTargetGroups")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AttachLoadBalancerTargetGroupsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AttachLoadBalancerTargetGroupsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachLoadBalancerTargetGroupsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AttachLoadBalancerTargetGroupsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachLoadBalancerTargetGroupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_attach_load_balancer_target_groups::de_attach_load_balancer_target_groups_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachLoadBalancerTargetGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::attach_load_balancer_target_groups::AttachLoadBalancerTargetGroupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::attach_load_balancer_target_groups::AttachLoadBalancerTargetGroupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_attach_load_balancer_target_groups_input::ser_attach_load_balancer_target_groups_input_input_input(&input)?,
        );
...
impl AttachLoadBalancerTargetGroupsError {
    ...
    /// Returns `true` if the error kind is `AttachLoadBalancerTargetGroupsError::InstanceRefreshInProgressFault`.
