...
impl PutWarmPoolInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_warm_pool::PutWarmPool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutWarmPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_warm_pool::de_put_warm_pool_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_warm_pool::de_put_warm_pool_http_response_with_props(
                status, headers, body,
            )
        }
    }
