...
impl PutWarmPoolInput {
    /// Consumes the builder and constructs an Operation<[`PutWarmPool`](crate::operation::put_warm_pool::PutWarmPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_warm_pool::PutWarmPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_warm_pool::PutWarmPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_warm_pool_input::ser_put_warm_pool_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_warm_pool::PutWarmPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutWarmPool", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutWarmPool`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutWarmPool {
                type Output = std::result::Result<crate::operation::put_warm_pool::PutWarmPoolOutput, crate::operation::put_warm_pool::PutWarmPoolError>;
