...
impl PutWarmPoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_warm_pool::PutWarmPool, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_warm_pool_input::ser_put_warm_pool_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutWarmPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_warm_pool::de_put_warm_pool_http_response_with_props(status, headers, body)
        }
    }
}
