...
impl DescribeNotificationConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_notification_configurations::DescribeNotificationConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_notification_configurations::de_describe_notification_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
