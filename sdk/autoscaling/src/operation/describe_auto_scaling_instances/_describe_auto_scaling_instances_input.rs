...
impl DescribeAutoScalingInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_auto_scaling_instances::DescribeAutoScalingInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
