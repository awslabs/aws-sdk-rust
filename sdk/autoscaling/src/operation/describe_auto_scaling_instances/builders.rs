...
impl DescribeAutoScalingInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_auto_scaling_instances::DescribeAutoScalingInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_auto_scaling_instances::DescribeAutoScalingInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_auto_scaling_instances::DescribeAutoScalingInstancesOutput, crate::operation::describe_auto_scaling_instances::DescribeAutoScalingInstancesError, Self> {
