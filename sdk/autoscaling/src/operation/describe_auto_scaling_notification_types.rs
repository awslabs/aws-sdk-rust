...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAutoScalingNotificationTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_auto_scaling_notification_types::de_describe_auto_scaling_notification_types_http_response_with_props(status, headers, body)
        }
    }
}
