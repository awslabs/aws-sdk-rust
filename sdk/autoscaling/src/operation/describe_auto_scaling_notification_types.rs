...
impl DescribeAutoScalingNotificationTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAutoScalingNotificationTypes`](crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAutoScalingNotificationTypes {
                type Output = std::result::Result<crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesOutput, crate::operation::describe_auto_scaling_notification_types::DescribeAutoScalingNotificationTypesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_auto_scaling_notification_types::de_describe_auto_scaling_notification_types_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_auto_scaling_notification_types::de_describe_auto_scaling_notification_types_http_response(response)
                     }
                }
            }
