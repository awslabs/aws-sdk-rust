...
impl PutScalingPolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Auto Scaling", "PutScalingPolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Auto Scaling.PutScalingPolicy",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutScalingPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("PolicyType") {
            if let ::std::option::Option::Some(value) = input.policy_type.as_deref() {
                captured.insert("PolicyType", value);
            }
        }
        if requested.should_capture("AdjustmentType") {
            if let ::std::option::Option::Some(value) = input.adjustment_type.as_deref() {
                captured.insert("AdjustmentType", value);
            }
        }
        if requested.should_capture("MetricAggregationType") {
            if let ::std::option::Option::Some(value) = input.metric_aggregation_type.as_deref() {
                captured.insert("MetricAggregationType", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutScalingPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_scaling_policy_input::ser_put_scaling_policy_input_input_input(&input)?,
        );
