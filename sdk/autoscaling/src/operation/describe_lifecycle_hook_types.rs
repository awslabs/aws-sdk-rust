...
impl DescribeLifecycleHookTypesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypes::new(),
        )
...
/// `ParseStrictResponse` impl for `DescribeLifecycleHookTypes`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLifecycleHookTypes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_lifecycle_hook_types::de_describe_lifecycle_hook_types_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_lifecycle_hook_types::de_describe_lifecycle_hook_types_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesError
{
