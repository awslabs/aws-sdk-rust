...
impl DescribeTerminationPolicyTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_termination_policy_types::DescribeTerminationPolicyTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTerminationPolicyTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_termination_policy_types::de_describe_termination_policy_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
