...
impl RollbackInstanceRefreshInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rollback_instance_refresh::RollbackInstanceRefresh::new(),
        )
...
/// `ParseStrictResponse` impl for `RollbackInstanceRefresh`.
...
impl aws_smithy_http::response::ParseStrictResponse for RollbackInstanceRefresh {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_rollback_instance_refresh::de_rollback_instance_refresh_http_error(response)
        } else {
            crate::protocol_serde::shape_rollback_instance_refresh::de_rollback_instance_refresh_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::rollback_instance_refresh::RollbackInstanceRefreshError
{
...
impl std::error::Error for RollbackInstanceRefreshError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::IrreversibleInstanceRefreshFault(_inner) => Some(_inner),
