...
impl PutScheduledUpdateGroupAction {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Auto Scaling.PutScheduledUpdateGroupAction",
            "rpc.service" = "Auto Scaling",
            "rpc.method" = "PutScheduledUpdateGroupAction",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutScheduledUpdateGroupAction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutScheduledUpdateGroupActionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutScheduledUpdateGroupActionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutScheduledUpdateGroupAction")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutScheduledUpdateGroupAction")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutScheduledUpdateGroupActionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutScheduledUpdateGroupActionInput>() else {
        ...
        if requested.should_capture("Recurrence") {
            if let ::std::option::Option::Some(value) = input.recurrence.as_deref() {
                captured.insert("Recurrence", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutScheduledUpdateGroupActionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutScheduledUpdateGroupActionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_scheduled_update_group_action_input::ser_put_scheduled_update_group_action_input_input_input(&input)?,
        );
