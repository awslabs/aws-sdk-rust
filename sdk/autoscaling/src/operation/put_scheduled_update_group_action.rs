...
impl PutScheduledUpdateGroupActionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupAction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutScheduledUpdateGroupAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_response_with_props(
                status, headers, body,
            )
        }
    }
