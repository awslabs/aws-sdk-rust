...
impl CreateLaunchConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_launch_configuration::CreateLaunchConfiguration,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_launch_configuration::CreateLaunchConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLaunchConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_launch_configuration::de_create_launch_configuration_http_response_with_props(status, headers, body)
        }
    }
}
