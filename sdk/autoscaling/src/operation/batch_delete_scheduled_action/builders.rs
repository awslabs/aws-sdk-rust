...
impl crate::operation::batch_delete_scheduled_action::builders::BatchDeleteScheduledActionInputBuilder {
...
impl BatchDeleteScheduledActionFluentBuilder {
    /// Creates a new `BatchDeleteScheduledActionFluentBuilder`.
