...
impl BatchDeleteScheduledActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionOutput, crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionError, Self> {
