...
impl DescribeLoadBalancerTargetGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_load_balancer_target_groups::DescribeLoadBalancerTargetGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoadBalancerTargetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_load_balancer_target_groups::de_describe_load_balancer_target_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
