...
impl ExecutePolicyInput {
    /// Consumes the builder and constructs an Operation<[`ExecutePolicy`](crate::operation::execute_policy::ExecutePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::execute_policy::ExecutePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_policy::ExecutePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::execute_policy::ExecutePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ExecutePolicy", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ExecutePolicy`.
...
impl aws_smithy_http::response::ParseStrictResponse for ExecutePolicy {
                type Output = std::result::Result<crate::operation::execute_policy::ExecutePolicyOutput, crate::operation::execute_policy::ExecutePolicyError>;
