...
impl ExecutePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::execute_policy::ExecutePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_policy_input::ser_execute_policy_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecutePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_execute_policy::de_execute_policy_http_response_with_props(status, headers, body)
        }
    }
}
