...
impl ExecutePolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::execute_policy::ExecutePolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecutePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_execute_policy::de_execute_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_execute_policy::de_execute_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
