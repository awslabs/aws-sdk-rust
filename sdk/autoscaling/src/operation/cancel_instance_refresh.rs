...
impl CancelInstanceRefresh {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Auto Scaling.CancelInstanceRefresh",
            "rpc.service" = "Auto Scaling",
            "rpc.method" = "CancelInstanceRefresh",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelInstanceRefresh {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CancelInstanceRefreshRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CancelInstanceRefreshResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CancelInstanceRefresh")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelInstanceRefresh")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CancelInstanceRefreshTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CancelInstanceRefreshTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelInstanceRefreshTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CancelInstanceRefreshInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelInstanceRefreshResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelInstanceRefreshRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_instance_refresh_input::ser_cancel_instance_refresh_input_input_input(&input)?,
        );
...
impl ::std::error::Error for CancelInstanceRefreshError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::ActiveInstanceRefreshNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelInstanceRefreshError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ActiveInstanceRefreshNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
