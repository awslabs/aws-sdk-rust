...
/// Orchestration and serialization glue logic for `CancelInstanceRefresh`.
...
impl CancelInstanceRefresh {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput,
                    ) -> ::std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelInstanceRefresh {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelInstanceRefresh");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelInstanceRefreshRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelInstanceRefreshResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelInstanceRefresh")
...
.with_interceptor(CancelInstanceRefreshEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>::new());
...
#[derive(Debug)]
            struct CancelInstanceRefreshResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelInstanceRefreshResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CancelInstanceRefreshRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelInstanceRefreshRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_instance_refresh_input::ser_cancel_instance_refresh_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CancelInstanceRefreshEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelInstanceRefreshEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelInstanceRefreshEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelInstanceRefreshInput>()
                        .ok_or("failed to downcast to CancelInstanceRefreshInput")?;
...
pub enum CancelInstanceRefreshError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelInstanceRefreshError) for what information is available for the error.")]
...
impl CancelInstanceRefreshError {
    /// Creates the `CancelInstanceRefreshError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelInstanceRefreshError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ActiveInstanceRefreshNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelInstanceRefreshError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_instance_refresh::CancelInstanceRefreshError {
...
mod _cancel_instance_refresh_output;
