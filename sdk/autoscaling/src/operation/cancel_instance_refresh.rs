...
impl CancelInstanceRefreshInput {
    /// Consumes the builder and constructs an Operation<[`CancelInstanceRefresh`](crate::operation::cancel_instance_refresh::CancelInstanceRefresh)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_instance_refresh::CancelInstanceRefresh, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_instance_refresh::CancelInstanceRefreshInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_instance_refresh::CancelInstanceRefresh::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelInstanceRefresh", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CancelInstanceRefresh`.
...
impl aws_smithy_http::response::ParseStrictResponse for CancelInstanceRefresh {
                type Output = std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, crate::operation::cancel_instance_refresh::CancelInstanceRefreshError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh_http_response(response)
                     }
                }
            }
