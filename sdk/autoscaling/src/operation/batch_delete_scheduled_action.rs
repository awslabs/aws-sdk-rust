...
impl BatchDeleteScheduledActionInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteScheduledAction`](crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchDeleteScheduledAction", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `BatchDeleteScheduledAction`.
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeleteScheduledAction {
                type Output = std::result::Result<crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionOutput, crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionError>;
