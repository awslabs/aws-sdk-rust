...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteScheduledAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_scheduled_action::de_batch_delete_scheduled_action_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_delete_scheduled_action::BatchDeleteScheduledActionError
{
