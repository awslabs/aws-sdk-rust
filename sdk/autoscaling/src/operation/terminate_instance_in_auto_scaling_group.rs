...
impl TerminateInstanceInAutoScalingGroupInput {
    /// Consumes the builder and constructs an Operation<[`TerminateInstanceInAutoScalingGroup`](crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateInstanceInAutoScalingGroup {
    type Output = ::std::result::Result<crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupOutput, crate::operation::terminate_instance_in_auto_scaling_group::TerminateInstanceInAutoScalingGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_terminate_instance_in_auto_scaling_group::de_terminate_instance_in_auto_scaling_group_http_response_with_props(status, headers, body)
        }
    }
}
