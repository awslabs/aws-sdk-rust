...
impl DescribeWarmPoolInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_warm_pool::DescribeWarmPool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWarmPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_warm_pool::de_describe_warm_pool_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_warm_pool::DescribeWarmPoolError
{
