...
impl ExitStandbyInput {
    /// Consumes the builder and constructs an Operation<[`ExitStandby`](crate::operation::exit_standby::ExitStandby)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::exit_standby::ExitStandby, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::exit_standby::ExitStandbyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::exit_standby::ExitStandby::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ExitStandby", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ExitStandby`.
...
impl aws_smithy_http::response::ParseStrictResponse for ExitStandby {
                type Output = std::result::Result<crate::operation::exit_standby::ExitStandbyOutput, crate::operation::exit_standby::ExitStandbyError>;
