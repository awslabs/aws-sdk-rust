...
impl ExitStandbyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::exit_standby::ExitStandby, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_exit_standby_input::ser_exit_standby_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExitStandby {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_exit_standby::de_exit_standby_http_response_with_props(status, headers, body)
        }
    }
}
