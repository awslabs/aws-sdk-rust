...
impl ExitStandbyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::exit_standby::ExitStandby::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExitStandby {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_exit_standby::de_exit_standby_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_exit_standby::de_exit_standby_http_response_with_props(
                status, headers, body,
            )
        }
    }
