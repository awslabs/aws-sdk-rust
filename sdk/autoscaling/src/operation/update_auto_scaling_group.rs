...
impl UpdateAutoScalingGroup {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateAutoScalingGroup",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateAutoScalingGroup")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAutoScalingGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAutoScalingGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_auto_scaling_group_input::ser_update_auto_scaling_group_input_input_input(&input)?,
        );
