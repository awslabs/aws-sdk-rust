...
impl UpdateAutoScalingGroupInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_auto_scaling_group::UpdateAutoScalingGroup::new(),
        )
...
/// `ParseStrictResponse` impl for `UpdateAutoScalingGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAutoScalingGroup {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_error(response)
        } else {
            crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupError
{
