...
impl CompleteLifecycleActionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::complete_lifecycle_action::CompleteLifecycleActionInput, ::aws_smithy_types::error::operation::BuildError> {
