...
impl DescribeScalingActivitiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_activities::DescribeScalingActivities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScalingActivities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_scaling_activities::de_describe_scaling_activities_http_response_with_props(status, headers, body)
        }
    }
}
