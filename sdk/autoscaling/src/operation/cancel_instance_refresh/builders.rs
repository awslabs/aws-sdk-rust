...
impl CancelInstanceRefreshFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_instance_refresh::CancelInstanceRefreshError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, crate::operation::cancel_instance_refresh::CancelInstanceRefreshError, Self> {
