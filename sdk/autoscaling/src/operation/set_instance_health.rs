...
impl SetInstanceHealthInput {
    /// Consumes the builder and constructs an Operation<[`SetInstanceHealth`](crate::operation::set_instance_health::SetInstanceHealth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_instance_health::SetInstanceHealth, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_instance_health::SetInstanceHealthInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_instance_health::SetInstanceHealth::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetInstanceHealth", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SetInstanceHealth`.
...
impl aws_smithy_http::response::ParseStrictResponse for SetInstanceHealth {
                type Output = std::result::Result<crate::operation::set_instance_health::SetInstanceHealthOutput, crate::operation::set_instance_health::SetInstanceHealthError>;
