...
impl SetInstanceHealthInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_instance_health::SetInstanceHealth::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetInstanceHealth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_instance_health::de_set_instance_health_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_instance_health::SetInstanceHealthError
{
