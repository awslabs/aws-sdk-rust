...
/// Orchestration and serialization glue logic for `SetInstanceHealth`.
...
impl SetInstanceHealth {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_instance_health::SetInstanceHealthInput,
                    ) -> ::std::result::Result<crate::operation::set_instance_health::SetInstanceHealthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_instance_health::SetInstanceHealthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_instance_health::SetInstanceHealthError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_instance_health::SetInstanceHealthOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetInstanceHealth {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetInstanceHealth");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetInstanceHealthRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetInstanceHealthResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetInstanceHealth")
...
.with_interceptor(SetInstanceHealthEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_instance_health::SetInstanceHealthError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_instance_health::SetInstanceHealthError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_instance_health::SetInstanceHealthError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetInstanceHealthResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_instance_health::de_set_instance_health_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_instance_health::de_set_instance_health_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetInstanceHealthRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_instance_health::SetInstanceHealthInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_instance_health::SetInstanceHealthInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_instance_health_input::ser_set_instance_health_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SetInstanceHealthEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetInstanceHealthEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetInstanceHealthEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetInstanceHealthInput>()
                        .ok_or("failed to downcast to SetInstanceHealthInput")?;
...
pub enum SetInstanceHealthError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetInstanceHealthError) for what information is available for the error.")]
...
impl SetInstanceHealthError {
    /// Creates the `SetInstanceHealthError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetInstanceHealthError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetInstanceHealthError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_instance_health::SetInstanceHealthError {
...
mod _set_instance_health_output;
