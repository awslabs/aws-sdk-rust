...
impl DescribeInstanceRefreshesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_instance_refreshes::DescribeInstanceRefreshes::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesError
{
