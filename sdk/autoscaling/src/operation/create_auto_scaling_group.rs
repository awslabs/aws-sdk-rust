...
impl CreateAutoScalingGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateAutoScalingGroup`](crate::operation::create_auto_scaling_group::CreateAutoScalingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_auto_scaling_group::CreateAutoScalingGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_auto_scaling_group::CreateAutoScalingGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_auto_scaling_group::CreateAutoScalingGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateAutoScalingGroup", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateAutoScalingGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAutoScalingGroup {
                type Output = std::result::Result<crate::operation::create_auto_scaling_group::CreateAutoScalingGroupOutput, crate::operation::create_auto_scaling_group::CreateAutoScalingGroupError>;
