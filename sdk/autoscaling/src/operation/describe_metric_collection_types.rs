...
impl DescribeMetricCollectionTypesInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypes,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypes::new(
            ),
        )
...
/// `ParseStrictResponse` impl for `DescribeMetricCollectionTypes`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMetricCollectionTypes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_metric_collection_types::de_describe_metric_collection_types_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_metric_collection_types::de_describe_metric_collection_types_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypesError
{
