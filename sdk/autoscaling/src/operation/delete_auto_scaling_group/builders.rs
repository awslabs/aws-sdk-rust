...
impl DeleteAutoScalingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupOutput, crate::operation::delete_auto_scaling_group::DeleteAutoScalingGroupError, Self> {
