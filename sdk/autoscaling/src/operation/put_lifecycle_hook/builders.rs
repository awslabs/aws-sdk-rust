...
impl PutLifecycleHookFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_lifecycle_hook::PutLifecycleHookOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_lifecycle_hook::PutLifecycleHookError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_lifecycle_hook::PutLifecycleHookOutput, crate::operation::put_lifecycle_hook::PutLifecycleHookError, Self> {
