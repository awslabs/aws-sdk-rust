...
impl RollbackInstanceRefreshFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::rollback_instance_refresh::RollbackInstanceRefreshOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rollback_instance_refresh::RollbackInstanceRefreshError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::rollback_instance_refresh::RollbackInstanceRefreshOutput, crate::operation::rollback_instance_refresh::RollbackInstanceRefreshError, Self> {
