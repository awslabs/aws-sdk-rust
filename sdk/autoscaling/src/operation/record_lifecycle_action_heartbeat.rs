    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeatError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeatOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RecordLifecycleActionHeartbeatResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RecordLifecycleActionHeartbeatRequestSerializer {
