...
impl RecordLifecycleActionHeartbeatInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeat::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RecordLifecycleActionHeartbeat {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_record_lifecycle_action_heartbeat::de_record_lifecycle_action_heartbeat_http_response_with_props(
                status, headers, body,
            )
        }
    }
