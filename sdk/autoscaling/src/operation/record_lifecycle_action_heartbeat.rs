...
impl RecordLifecycleActionHeartbeatInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeat, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeatInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
