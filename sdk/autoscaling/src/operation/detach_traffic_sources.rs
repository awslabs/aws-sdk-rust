...
impl DetachTrafficSourcesInput {
    /// Consumes the builder and constructs an Operation<[`DetachTrafficSources`](crate::operation::detach_traffic_sources::DetachTrafficSources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_traffic_sources::DetachTrafficSources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_traffic_sources::DetachTrafficSourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_traffic_sources_input::ser_detach_traffic_sources_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_traffic_sources::DetachTrafficSources::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachTrafficSources", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DetachTrafficSources`.
...
impl aws_smithy_http::response::ParseStrictResponse for DetachTrafficSources {
                type Output = std::result::Result<crate::operation::detach_traffic_sources::DetachTrafficSourcesOutput, crate::operation::detach_traffic_sources::DetachTrafficSourcesError>;
