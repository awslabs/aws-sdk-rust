...
/// Orchestration and serialization glue logic for `DetachTrafficSources`.
...
impl DetachTrafficSources {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::detach_traffic_sources::DetachTrafficSourcesInput,
                    ) -> ::std::result::Result<crate::operation::detach_traffic_sources::DetachTrafficSourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_traffic_sources::DetachTrafficSourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detach_traffic_sources::DetachTrafficSourcesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detach_traffic_sources::DetachTrafficSourcesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachTrafficSources {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetachTrafficSources");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetachTrafficSourcesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetachTrafficSourcesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachTrafficSources")
...
.with_interceptor(DetachTrafficSourcesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detach_traffic_sources::DetachTrafficSourcesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detach_traffic_sources::DetachTrafficSourcesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detach_traffic_sources::DetachTrafficSourcesError>::new());
...
#[derive(Debug)]
            struct DetachTrafficSourcesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachTrafficSourcesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detach_traffic_sources::de_detach_traffic_sources_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detach_traffic_sources::de_detach_traffic_sources_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DetachTrafficSourcesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachTrafficSourcesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detach_traffic_sources::DetachTrafficSourcesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detach_traffic_sources::DetachTrafficSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detach_traffic_sources_input::ser_detach_traffic_sources_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DetachTrafficSourcesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachTrafficSourcesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetachTrafficSourcesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetachTrafficSourcesInput>()
                        .ok_or("failed to downcast to DetachTrafficSourcesInput")?;
...
pub enum DetachTrafficSourcesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetachTrafficSourcesError) for what information is available for the error.")]
...
impl DetachTrafficSourcesError {
    /// Creates the `DetachTrafficSourcesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetachTrafficSourcesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetachTrafficSourcesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detach_traffic_sources::DetachTrafficSourcesError {
...
mod _detach_traffic_sources_output;
