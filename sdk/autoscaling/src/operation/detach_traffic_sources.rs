...
impl DetachTrafficSourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::detach_traffic_sources::DetachTrafficSources,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachTrafficSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_traffic_sources::de_detach_traffic_sources_http_response_with_props(status, headers, body)
        }
    }
}
