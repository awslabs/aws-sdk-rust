...
impl CreateOrUpdateTagsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_or_update_tags::CreateOrUpdateTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOrUpdateTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_or_update_tags::de_create_or_update_tags_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_or_update_tags::CreateOrUpdateTagsError
{
