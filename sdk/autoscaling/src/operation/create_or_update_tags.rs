...
impl CreateOrUpdateTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_or_update_tags::CreateOrUpdateTags,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOrUpdateTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_or_update_tags::de_create_or_update_tags_http_response_with_props(status, headers, body)
        }
    }
}
