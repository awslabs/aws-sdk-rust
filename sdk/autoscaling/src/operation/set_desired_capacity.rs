...
impl SetDesiredCapacityInput {
    /// Consumes the builder and constructs an Operation<[`SetDesiredCapacity`](crate::operation::set_desired_capacity::SetDesiredCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_desired_capacity::SetDesiredCapacity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_desired_capacity::SetDesiredCapacityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_desired_capacity::SetDesiredCapacity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetDesiredCapacity", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SetDesiredCapacity`.
...
impl aws_smithy_http::response::ParseStrictResponse for SetDesiredCapacity {
                type Output = std::result::Result<crate::operation::set_desired_capacity::SetDesiredCapacityOutput, crate::operation::set_desired_capacity::SetDesiredCapacityError>;
