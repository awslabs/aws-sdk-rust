...
impl SetDesiredCapacityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_desired_capacity::SetDesiredCapacity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetDesiredCapacity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_desired_capacity::de_set_desired_capacity_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_desired_capacity::SetDesiredCapacityError
{
