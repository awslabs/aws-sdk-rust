...
impl AttachInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_instances::AttachInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_attach_instances::de_attach_instances_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::attach_instances::AttachInstancesError
{
