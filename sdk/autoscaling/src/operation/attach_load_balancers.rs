...
impl AttachLoadBalancersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_load_balancers::AttachLoadBalancers::new(),
        )
...
/// `ParseStrictResponse` impl for `AttachLoadBalancers`.
...
impl aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_attach_load_balancers::de_attach_load_balancers_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::attach_load_balancers::AttachLoadBalancersError
{
