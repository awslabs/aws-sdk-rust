...
impl DeleteLaunchConfigurationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_launch_configuration::DeleteLaunchConfiguration::new(),
        )
...
/// `ParseStrictResponse` impl for `DeleteLaunchConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLaunchConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_launch_configuration::de_delete_launch_configuration_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_launch_configuration::de_delete_launch_configuration_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_launch_configuration::DeleteLaunchConfigurationError
{
