...
impl EnableMetricsCollectionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_metrics_collection::EnableMetricsCollection::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for EnableMetricsCollection {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_enable_metrics_collection::de_enable_metrics_collection_http_error(response)
        } else {
            crate::protocol_serde::shape_enable_metrics_collection::de_enable_metrics_collection_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::enable_metrics_collection::EnableMetricsCollectionError
{
