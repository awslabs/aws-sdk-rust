...
impl DescribeScalingProcessTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_scaling_process_types::DescribeScalingProcessTypes::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeScalingProcessTypesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesError
{
