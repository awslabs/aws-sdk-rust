...
impl DescribeAdjustmentTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_adjustment_types::DescribeAdjustmentTypesInput, ::aws_smithy_types::error::operation::BuildError> {
