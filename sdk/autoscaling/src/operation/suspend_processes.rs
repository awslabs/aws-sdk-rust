...
impl SuspendProcessesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::suspend_processes::SuspendProcesses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SuspendProcesses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_suspend_processes::de_suspend_processes_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::suspend_processes::SuspendProcessesError
{
