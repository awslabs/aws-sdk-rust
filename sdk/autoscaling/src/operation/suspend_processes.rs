...
impl SuspendProcessesInput {
    /// Consumes the builder and constructs an Operation<[`SuspendProcesses`](crate::operation::suspend_processes::SuspendProcesses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::suspend_processes::SuspendProcesses, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::suspend_processes::SuspendProcessesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::suspend_processes::SuspendProcesses::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SuspendProcesses", "autoscaling"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SuspendProcesses`.
...
impl aws_smithy_http::response::ParseStrictResponse for SuspendProcesses {
                type Output = std::result::Result<crate::operation::suspend_processes::SuspendProcessesOutput, crate::operation::suspend_processes::SuspendProcessesError>;
