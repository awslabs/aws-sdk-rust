...
/// Orchestration and serialization glue logic for `SuspendProcesses`.
...
impl SuspendProcesses {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::suspend_processes::SuspendProcessesInput,
                    ) -> ::std::result::Result<crate::operation::suspend_processes::SuspendProcessesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::suspend_processes::SuspendProcessesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::suspend_processes::SuspendProcessesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::suspend_processes::SuspendProcessesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SuspendProcesses {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SuspendProcesses");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SuspendProcessesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SuspendProcessesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SuspendProcesses")
...
.with_interceptor(SuspendProcessesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::suspend_processes::SuspendProcessesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::suspend_processes::SuspendProcessesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::suspend_processes::SuspendProcessesError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SuspendProcessesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_suspend_processes::de_suspend_processes_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_suspend_processes::de_suspend_processes_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SuspendProcessesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::suspend_processes::SuspendProcessesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::suspend_processes::SuspendProcessesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_suspend_processes_input::ser_suspend_processes_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SuspendProcessesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SuspendProcessesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SuspendProcessesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SuspendProcessesInput>()
                        .ok_or("failed to downcast to SuspendProcessesInput")?;
...
pub enum SuspendProcessesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SuspendProcessesError) for what information is available for the error.")]
...
impl SuspendProcessesError {
    /// Creates the `SuspendProcessesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SuspendProcessesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SuspendProcessesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::suspend_processes::SuspendProcessesError {
