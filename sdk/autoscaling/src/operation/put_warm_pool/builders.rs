...
impl crate::operation::put_warm_pool::builders::PutWarmPoolInputBuilder {
...
impl PutWarmPoolFluentBuilder {
    /// Creates a new `PutWarmPoolFluentBuilder`.
