    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AttachInstancesInput`](crate::input::AttachInstancesInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::AttachInstancesInput::instance_ids): <p>The IDs of the instances. You can specify up to 20 instances.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::AttachInstancesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ...
    ///
    /// - Takes [`AttachLoadBalancersInput`](crate::input::AttachLoadBalancersInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::AttachLoadBalancersInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`load_balancer_names(Option<Vec<String>>)`](crate::input::AttachLoadBalancersInput::load_balancer_names): <p>The names of the load balancers. You can specify up to 10 load balancers.</p>
    ...
    ///
    /// - Takes [`AttachLoadBalancerTargetGroupsInput`](crate::input::AttachLoadBalancerTargetGroupsInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::AttachLoadBalancerTargetGroupsInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`target_group_ar_ns(Option<Vec<String>>)`](crate::input::AttachLoadBalancerTargetGroupsInput::target_group_ar_ns): <p>The Amazon Resource Names (ARN) of the target groups. You can specify up to 10 target groups. To get the ARN of a target group, use the Elastic Load Balancing <a href="https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeTargetGroups.html">DescribeTargetGroups</a> API operation.</p>
    ...
    ///
    /// - Takes [`BatchDeleteScheduledActionInput`](crate::input::BatchDeleteScheduledActionInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::BatchDeleteScheduledActionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scheduled_action_names(Option<Vec<String>>)`](crate::input::BatchDeleteScheduledActionInput::scheduled_action_names): <p>The names of the scheduled actions to delete. The maximum number allowed is 50. </p>
    ...
    ///
    /// - Takes [`BatchPutScheduledUpdateGroupActionInput`](crate::input::BatchPutScheduledUpdateGroupActionInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::BatchPutScheduledUpdateGroupActionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scheduled_update_group_actions(Option<Vec<ScheduledUpdateGroupActionRequest>>)`](crate::input::BatchPutScheduledUpdateGroupActionInput::scheduled_update_group_actions): <p>One or more scheduled actions. The maximum number allowed is 50.</p>
    ...
    ///
    /// - Takes [`CancelInstanceRefreshInput`](crate::input::CancelInstanceRefreshInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::CancelInstanceRefreshInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ...
    ///
    /// - Takes [`CompleteLifecycleActionInput`](crate::input::CompleteLifecycleActionInput) with field(s):
    ///   - [`lifecycle_hook_name(Option<String>)`](crate::input::CompleteLifecycleActionInput::lifecycle_hook_name): <p>The name of the lifecycle hook.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::CompleteLifecycleActionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`lifecycle_action_token(Option<String>)`](crate::input::CompleteLifecycleActionInput::lifecycle_action_token): <p>A universally unique identifier (UUID) that identifies a specific lifecycle action associated with an instance. Amazon EC2 Auto Scaling sends this token to the notification target you specified when you created the lifecycle hook.</p>
    ///   - [`lifecycle_action_result(Option<String>)`](crate::input::CompleteLifecycleActionInput::lifecycle_action_result): <p>The action for the group to take. This parameter can be either <code>CONTINUE</code> or <code>ABANDON</code>.</p>
    ///   - [`instance_id(Option<String>)`](crate::input::CompleteLifecycleActionInput::instance_id): <p>The ID of the instance.</p>
    ...
    ///
    /// - Takes [`CreateOrUpdateTagsInput`](crate::input::CreateOrUpdateTagsInput) with field(s):
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateOrUpdateTagsInput::tags): <p>One or more tags.</p>
    ...
    ///
    /// - Takes [`DeleteAutoScalingGroupInput`](crate::input::DeleteAutoScalingGroupInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeleteAutoScalingGroupInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`force_delete(Option<bool>)`](crate::input::DeleteAutoScalingGroupInput::force_delete): <p>Specifies that the group is to be deleted along with all instances associated with the group, without waiting for all instances to be terminated. This parameter also deletes any outstanding lifecycle actions associated with the group.</p>
    ...
    ///
    /// - Takes [`DeleteLaunchConfigurationInput`](crate::input::DeleteLaunchConfigurationInput) with field(s):
    ///   - [`launch_configuration_name(Option<String>)`](crate::input::DeleteLaunchConfigurationInput::launch_configuration_name): <p>The name of the launch configuration.</p>
    ...
    ///
    /// - Takes [`DeleteLifecycleHookInput`](crate::input::DeleteLifecycleHookInput) with field(s):
    ///   - [`lifecycle_hook_name(Option<String>)`](crate::input::DeleteLifecycleHookInput::lifecycle_hook_name): <p>The name of the lifecycle hook.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeleteLifecycleHookInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ...
    ///
    /// - Takes [`DeleteNotificationConfigurationInput`](crate::input::DeleteNotificationConfigurationInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeleteNotificationConfigurationInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`topic_arn(Option<String>)`](crate::input::DeleteNotificationConfigurationInput::topic_arn): <p>The Amazon Resource Name (ARN) of the Amazon SNS topic.</p>
    ...
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeletePolicyInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`policy_name(Option<String>)`](crate::input::DeletePolicyInput::policy_name): <p>The name or Amazon Resource Name (ARN) of the policy.</p>
    ...
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeleteScheduledActionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scheduled_action_name(Option<String>)`](crate::input::DeleteScheduledActionInput::scheduled_action_name): <p>The name of the action to delete.</p>
    ...
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::DeleteTagsInput::tags): <p>One or more tags.</p>
    ...
    ///
    /// - Takes [`DeleteWarmPoolInput`](crate::input::DeleteWarmPoolInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DeleteWarmPoolInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`force_delete(Option<bool>)`](crate::input::DeleteWarmPoolInput::force_delete): <p>Specifies that the warm pool is to be deleted along with all of its associated instances, without waiting for all instances to be terminated. This parameter also deletes any outstanding lifecycle actions associated with the warm pool instances.</p>
    ...
    ///
    /// - Takes [`DescribeAccountLimitsInput`](crate::input::DescribeAccountLimitsInput)
    ...
    ///
    /// - Takes [`DescribeAdjustmentTypesInput`](crate::input::DescribeAdjustmentTypesInput)
    ...
    ///
    /// - Takes [`DescribeAutoScalingGroupsInput`](crate::input::DescribeAutoScalingGroupsInput) with field(s):
    ///   - [`auto_scaling_group_names(Option<Vec<String>>)`](crate::input::DescribeAutoScalingGroupsInput::auto_scaling_group_names): <p>The names of the Auto Scaling groups. By default, you can only specify up to 50 names. You can optionally increase this limit using the <code>MaxRecords</code> parameter.</p>  <p>If you omit this parameter, all Auto Scaling groups are described.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeAutoScalingGroupsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeAutoScalingGroupsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::DescribeAutoScalingGroupsInput::filters): <p>One or more filters to limit the results based on specific tags. </p>
    ...
    ///
    /// - Takes [`DescribeAutoScalingInstancesInput`](crate::input::DescribeAutoScalingInstancesInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::DescribeAutoScalingInstancesInput::instance_ids): <p>The IDs of the instances. If you omit this parameter, all Auto Scaling instances are described. If you specify an ID that does not exist, it is ignored with no error.</p>  <p>Array Members: Maximum number of 50 items.</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeAutoScalingInstancesInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>50</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeAutoScalingInstancesInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ...
    ///
    /// - Takes [`DescribeAutoScalingNotificationTypesInput`](crate::input::DescribeAutoScalingNotificationTypesInput)
    ...
    ///
    /// - Takes [`DescribeInstanceRefreshesInput`](crate::input::DescribeInstanceRefreshesInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeInstanceRefreshesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`instance_refresh_ids(Option<Vec<String>>)`](crate::input::DescribeInstanceRefreshesInput::instance_refresh_ids): <p>One or more instance refresh IDs.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeInstanceRefreshesInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeInstanceRefreshesInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribeLaunchConfigurationsInput`](crate::input::DescribeLaunchConfigurationsInput) with field(s):
    ///   - [`launch_configuration_names(Option<Vec<String>>)`](crate::input::DescribeLaunchConfigurationsInput::launch_configuration_names): <p>The launch configuration names. If you omit this parameter, all launch configurations are described.</p>  <p>Array Members: Maximum number of 50 items.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeLaunchConfigurationsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeLaunchConfigurationsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribeLifecycleHooksInput`](crate::input::DescribeLifecycleHooksInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeLifecycleHooksInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`lifecycle_hook_names(Option<Vec<String>>)`](crate::input::DescribeLifecycleHooksInput::lifecycle_hook_names): <p>The names of one or more lifecycle hooks. If you omit this parameter, all lifecycle hooks are described.</p>
    ...
    ///
    /// - Takes [`DescribeLifecycleHookTypesInput`](crate::input::DescribeLifecycleHookTypesInput)
    ...
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeLoadBalancersInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeLoadBalancersInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeLoadBalancersInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>100</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribeLoadBalancerTargetGroupsInput`](crate::input::DescribeLoadBalancerTargetGroupsInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeLoadBalancerTargetGroupsInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeLoadBalancerTargetGroupsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeLoadBalancerTargetGroupsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>100</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribeMetricCollectionTypesInput`](crate::input::DescribeMetricCollectionTypesInput)
    ...
    ///
    /// - Takes [`DescribeNotificationConfigurationsInput`](crate::input::DescribeNotificationConfigurationsInput) with field(s):
    ///   - [`auto_scaling_group_names(Option<Vec<String>>)`](crate::input::DescribeNotificationConfigurationsInput::auto_scaling_group_names): <p>The name of the Auto Scaling group.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeNotificationConfigurationsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeNotificationConfigurationsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribePoliciesInput`](crate::input::DescribePoliciesInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribePoliciesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`policy_names(Option<Vec<String>>)`](crate::input::DescribePoliciesInput::policy_names): <p>The names of one or more policies. If you omit this parameter, all policies are described. If a group name is provided, the results are limited to that group. If you specify an unknown policy name, it is ignored with no error.</p>  <p>Array Members: Maximum number of 50 items.</p>
    ///   - [`policy_types(Option<Vec<String>>)`](crate::input::DescribePoliciesInput::policy_types): <p>One or more policy types. The valid values are <code>SimpleScaling</code>, <code>StepScaling</code>, <code>TargetTrackingScaling</code>, and <code>PredictiveScaling</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribePoliciesInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribePoliciesInput::max_records): <p>The maximum number of items to be returned with each call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///   - [`activity_ids(Option<Vec<String>>)`](crate::input::DescribeScalingActivitiesInput::activity_ids): <p>The activity IDs of the desired scaling activities. If you omit this parameter, all activities for the past six weeks are described. If unknown activities are requested, they are ignored with no error. If you specify an Auto Scaling group, the results are limited to that group.</p>  <p>Array Members: Maximum number of 50 IDs.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeScalingActivitiesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`include_deleted_groups(Option<bool>)`](crate::input::DescribeScalingActivitiesInput::include_deleted_groups): <p>Indicates whether to include scaling activity from deleted Auto Scaling groups.</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeScalingActivitiesInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>100</code> and the maximum value is <code>100</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeScalingActivitiesInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ...
    ///
    /// - Takes [`DescribeScalingProcessTypesInput`](crate::input::DescribeScalingProcessTypesInput)
    ...
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeScheduledActionsInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scheduled_action_names(Option<Vec<String>>)`](crate::input::DescribeScheduledActionsInput::scheduled_action_names): <p>The names of one or more scheduled actions. If you omit this parameter, all scheduled actions are described. If you specify an unknown scheduled action, it is ignored with no error.</p>  <p>Array Members: Maximum number of 50 actions.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::DescribeScheduledActionsInput::start_time): <p>The earliest scheduled start time to return. If scheduled action names are provided, this parameter is ignored.</p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::DescribeScheduledActionsInput::end_time): <p>The latest scheduled start time to return. If scheduled action names are provided, this parameter is ignored.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeScheduledActionsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeScheduledActionsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::DescribeTagsInput::filters): <p>One or more filters to scope the tags to return. The maximum number of filters per filter type (for example, <code>auto-scaling-group</code>) is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeTagsInput::next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeTagsInput::max_records): <p>The maximum number of items to return with this call. The default value is <code>50</code> and the maximum value is <code>100</code>.</p>
    ...
    ///
    /// - Takes [`DescribeTerminationPolicyTypesInput`](crate::input::DescribeTerminationPolicyTypesInput)
    ...
    ///
    /// - Takes [`DescribeWarmPoolInput`](crate::input::DescribeWarmPoolInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DescribeWarmPoolInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`max_records(Option<i32>)`](crate::input::DescribeWarmPoolInput::max_records): <p>The maximum number of instances to return with this call. The maximum value is <code>50</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeWarmPoolInput::next_token): <p>The token for the next set of instances to return. (You received this token from a previous call.)</p>
    ...
    ///
    /// - Takes [`DetachInstancesInput`](crate::input::DetachInstancesInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::DetachInstancesInput::instance_ids): <p>The IDs of the instances. You can specify up to 20 instances.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DetachInstancesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`should_decrement_desired_capacity(Option<bool>)`](crate::input::DetachInstancesInput::should_decrement_desired_capacity): <p>Indicates whether the Auto Scaling group decrements the desired capacity value by the number of instances detached.</p>
    ...
    ///
    /// - Takes [`DetachLoadBalancersInput`](crate::input::DetachLoadBalancersInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DetachLoadBalancersInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`load_balancer_names(Option<Vec<String>>)`](crate::input::DetachLoadBalancersInput::load_balancer_names): <p>The names of the load balancers. You can specify up to 10 load balancers.</p>
    ...
    ///
    /// - Takes [`DetachLoadBalancerTargetGroupsInput`](crate::input::DetachLoadBalancerTargetGroupsInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::DetachLoadBalancerTargetGroupsInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`target_group_ar_ns(Option<Vec<String>>)`](crate::input::DetachLoadBalancerTargetGroupsInput::target_group_ar_ns): <p>The Amazon Resource Names (ARN) of the target groups. You can specify up to 10 target groups.</p>
    ...
    ///
    /// - Takes [`EnterStandbyInput`](crate::input::EnterStandbyInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::EnterStandbyInput::instance_ids): <p>The IDs of the instances. You can specify up to 20 instances.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::EnterStandbyInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`should_decrement_desired_capacity(Option<bool>)`](crate::input::EnterStandbyInput::should_decrement_desired_capacity): <p>Indicates whether to decrement the desired capacity of the Auto Scaling group by the number of instances moved to <code>Standby</code> mode.</p>
    ...
    ///
    /// - Takes [`ExecutePolicyInput`](crate::input::ExecutePolicyInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::ExecutePolicyInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`policy_name(Option<String>)`](crate::input::ExecutePolicyInput::policy_name): <p>The name or ARN of the policy.</p>
    ///   - [`honor_cooldown(Option<bool>)`](crate::input::ExecutePolicyInput::honor_cooldown): <p>Indicates whether Amazon EC2 Auto Scaling waits for the cooldown period to complete before executing the policy.</p>  <p>Valid only if the policy type is <code>SimpleScaling</code>. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html">Scaling cooldowns for Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`metric_value(Option<f64>)`](crate::input::ExecutePolicyInput::metric_value): <p>The metric value to compare to <code>BreachThreshold</code>. This enables you to execute a policy of type <code>StepScaling</code> and determine which step adjustment to use. For example, if the breach threshold is 50 and you want to use a step adjustment with a lower bound of 0 and an upper bound of 10, you can set the metric value to 59.</p>  <p>If you specify a metric value that doesn't correspond to a step adjustment for the policy, the call returns an error.</p>  <p>Required if the policy type is <code>StepScaling</code> and not supported otherwise.</p>
    ///   - [`breach_threshold(Option<f64>)`](crate::input::ExecutePolicyInput::breach_threshold): <p>The breach threshold for the alarm.</p>  <p>Required if the policy type is <code>StepScaling</code> and not supported otherwise.</p>
    ...
    ///
    /// - Takes [`ExitStandbyInput`](crate::input::ExitStandbyInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::ExitStandbyInput::instance_ids): <p>The IDs of the instances. You can specify up to 20 instances.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::ExitStandbyInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ...
    ///
    /// - Takes [`GetPredictiveScalingForecastInput`](crate::input::GetPredictiveScalingForecastInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::GetPredictiveScalingForecastInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`policy_name(Option<String>)`](crate::input::GetPredictiveScalingForecastInput::policy_name): <p>The name of the policy.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::GetPredictiveScalingForecastInput::start_time): <p>The inclusive start time of the time range for the forecast data to get. At most, the date and time can be one year before the current date and time.</p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::GetPredictiveScalingForecastInput::end_time): <p>The exclusive end time of the time range for the forecast data to get. The maximum time duration between the start and end time is 30 days. </p>  <p>Although this parameter can accept a date and time that is more than two days in the future, the availability of forecast data has limits. Amazon EC2 Auto Scaling only issues forecasts for periods of two days in advance.</p>
    ...
    ///
    /// - Takes [`PutLifecycleHookInput`](crate::input::PutLifecycleHookInput) with field(s):
    ///   - [`lifecycle_hook_name(Option<String>)`](crate::input::PutLifecycleHookInput::lifecycle_hook_name): <p>The name of the lifecycle hook.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::PutLifecycleHookInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`lifecycle_transition(Option<String>)`](crate::input::PutLifecycleHookInput::lifecycle_transition): <p>The instance state to which you want to attach the lifecycle hook. The valid values are:</p>  <ul>   <li> <p>autoscaling:EC2_INSTANCE_LAUNCHING</p> </li>   <li> <p>autoscaling:EC2_INSTANCE_TERMINATING</p> </li>  </ul>  <p>Required for new lifecycle hooks, but optional when updating existing hooks.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::PutLifecycleHookInput::role_arn): <p>The ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target, for example, an Amazon SNS topic or an Amazon SQS queue.</p>  <p>Required for new lifecycle hooks, but optional when updating existing hooks.</p>
    ///   - [`notification_target_arn(Option<String>)`](crate::input::PutLifecycleHookInput::notification_target_arn): <p>The ARN of the notification target that Amazon EC2 Auto Scaling uses to notify you when an instance is in the transition state for the lifecycle hook. This target can be either an SQS queue or an SNS topic.</p>  <p>If you specify an empty string, this overrides the current ARN.</p>  <p>This operation uses the JSON format when sending notifications to an Amazon SQS queue, and an email key-value pair format when sending notifications to an Amazon SNS topic.</p>  <p>When you specify a notification target, Amazon EC2 Auto Scaling sends it a test message. Test messages contain the following additional key-value pair: <code>"Event": "autoscaling:TEST_NOTIFICATION"</code>.</p>
    ///   - [`notification_metadata(Option<String>)`](crate::input::PutLifecycleHookInput::notification_metadata): <p>Additional information that you want to include any time Amazon EC2 Auto Scaling sends a message to the notification target.</p>
    ///   - [`heartbeat_timeout(Option<i32>)`](crate::input::PutLifecycleHookInput::heartbeat_timeout): <p>The maximum time, in seconds, that can elapse before the lifecycle hook times out. The range is from <code>30</code> to <code>7200</code> seconds. The default value is <code>3600</code> seconds (1 hour).</p>  <p>If the lifecycle hook times out, Amazon EC2 Auto Scaling performs the action that you specified in the <code>DefaultResult</code> parameter. You can prevent the lifecycle hook from timing out by calling the <code>RecordLifecycleActionHeartbeat</code> API.</p>
    ///   - [`default_result(Option<String>)`](crate::input::PutLifecycleHookInput::default_result): <p>Defines the action the Auto Scaling group should take when the lifecycle hook timeout elapses or if an unexpected failure occurs. This parameter can be either <code>CONTINUE</code> or <code>ABANDON</code>. The default value is <code>ABANDON</code>.</p>
    ...
    ///
    /// - Takes [`PutNotificationConfigurationInput`](crate::input::PutNotificationConfigurationInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::PutNotificationConfigurationInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`topic_arn(Option<String>)`](crate::input::PutNotificationConfigurationInput::topic_arn): <p>The Amazon Resource Name (ARN) of the Amazon SNS topic.</p>
    ///   - [`notification_types(Option<Vec<String>>)`](crate::input::PutNotificationConfigurationInput::notification_types): <p>The type of event that causes the notification to be sent. To query the notification types supported by Amazon EC2 Auto Scaling, call the <code>DescribeAutoScalingNotificationTypes</code> API.</p>
    ...
    ///
    /// - Takes [`PutScheduledUpdateGroupActionInput`](crate::input::PutScheduledUpdateGroupActionInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::PutScheduledUpdateGroupActionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scheduled_action_name(Option<String>)`](crate::input::PutScheduledUpdateGroupActionInput::scheduled_action_name): <p>The name of this scaling action.</p>
    ///   - [`time(Option<DateTime>)`](crate::input::PutScheduledUpdateGroupActionInput::time): <p>This parameter is no longer used.</p>
    ...
    ///
    /// - Takes [`RecordLifecycleActionHeartbeatInput`](crate::input::RecordLifecycleActionHeartbeatInput) with field(s):
    ///   - [`lifecycle_hook_name(Option<String>)`](crate::input::RecordLifecycleActionHeartbeatInput::lifecycle_hook_name): <p>The name of the lifecycle hook.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::RecordLifecycleActionHeartbeatInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`lifecycle_action_token(Option<String>)`](crate::input::RecordLifecycleActionHeartbeatInput::lifecycle_action_token): <p>A token that uniquely identifies a specific lifecycle action associated with an instance. Amazon EC2 Auto Scaling sends this token to the notification target that you specified when you created the lifecycle hook.</p>
    ///   - [`instance_id(Option<String>)`](crate::input::RecordLifecycleActionHeartbeatInput::instance_id): <p>The ID of the instance.</p>
    ...
    ///
    /// - Takes [`SetDesiredCapacityInput`](crate::input::SetDesiredCapacityInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::SetDesiredCapacityInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`desired_capacity(Option<i32>)`](crate::input::SetDesiredCapacityInput::desired_capacity): <p>The desired capacity is the initial capacity of the Auto Scaling group after this operation completes and the capacity it attempts to maintain.</p>
    ///   - [`honor_cooldown(Option<bool>)`](crate::input::SetDesiredCapacityInput::honor_cooldown): <p>Indicates whether Amazon EC2 Auto Scaling waits for the cooldown period to complete before initiating a scaling activity to set your Auto Scaling group to its new capacity. By default, Amazon EC2 Auto Scaling does not honor the cooldown period during manual scaling activities.</p>
    ...
    ///
    /// - Takes [`SetInstanceHealthInput`](crate::input::SetInstanceHealthInput) with field(s):
    ///   - [`instance_id(Option<String>)`](crate::input::SetInstanceHealthInput::instance_id): <p>The ID of the instance.</p>
    ///   - [`health_status(Option<String>)`](crate::input::SetInstanceHealthInput::health_status): <p>The health status of the instance. Set to <code>Healthy</code> to have the instance remain in service. Set to <code>Unhealthy</code> to have the instance be out of service. Amazon EC2 Auto Scaling terminates and replaces the unhealthy instance.</p>
    ///   - [`should_respect_grace_period(Option<bool>)`](crate::input::SetInstanceHealthInput::should_respect_grace_period): <p>If the Auto Scaling group of the specified instance has a <code>HealthCheckGracePeriod</code> specified for the group, by default, this call respects the grace period. Set this to <code>False</code>, to have the call not respect the grace period associated with the group.</p>  <p>For more information about the health check grace period, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CreateAutoScalingGroup.html">CreateAutoScalingGroup</a> in the <i>Amazon EC2 Auto Scaling API Reference</i>.</p>
    ...
    ///
    /// - Takes [`SetInstanceProtectionInput`](crate::input::SetInstanceProtectionInput) with field(s):
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::SetInstanceProtectionInput::instance_ids): <p>One or more instance IDs. You can specify up to 50 instances.</p>
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::SetInstanceProtectionInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`protected_from_scale_in(Option<bool>)`](crate::input::SetInstanceProtectionInput::protected_from_scale_in): <p>Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.</p>
    ...
    ///
    /// - Takes [`StartInstanceRefreshInput`](crate::input::StartInstanceRefreshInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::StartInstanceRefreshInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`strategy(Option<RefreshStrategy>)`](crate::input::StartInstanceRefreshInput::strategy): <p>The strategy to use for the instance refresh. The only valid value is <code>Rolling</code>.</p>  <p>A rolling update helps you update your instances gradually. A rolling update can fail due to failed health checks or if instances are on standby or are protected from scale in. If the rolling update process fails, any instances that are replaced are not rolled back to their previous configuration. </p>
    ///   - [`desired_configuration(Option<DesiredConfiguration>)`](crate::input::StartInstanceRefreshInput::desired_configuration): <p>The desired configuration. For example, the desired configuration can specify a new launch template or a new version of the current launch template.</p>  <p>Once the instance refresh succeeds, Amazon EC2 Auto Scaling updates the settings of the Auto Scaling group to reflect the new desired configuration. </p> <note>   <p>When you specify a new launch template or a new version of the current launch template for your desired configuration, consider enabling the <code>SkipMatching</code> property in preferences. If it's enabled, Amazon EC2 Auto Scaling skips replacing instances that already use the specified launch template and version. This can help you reduce the number of replacements that are required to apply updates. </p>  </note>
    ///   - [`preferences(Option<RefreshPreferences>)`](crate::input::StartInstanceRefreshInput::preferences): <p>Set of preferences associated with the instance refresh request. If not provided, the default values are used.</p>
    ...
    ///
    /// - Takes [`SuspendProcessesInput`](crate::input::SuspendProcessesInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::SuspendProcessesInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`scaling_processes(Option<Vec<String>>)`](crate::input::SuspendProcessesInput::scaling_processes): <p>One or more of the following processes:</p>  <ul>   <li> <p> <code>Launch</code> </p> </li>   <li> <p> <code>Terminate</code> </p> </li>   <li> <p> <code>AddToLoadBalancer</code> </p> </li>   <li> <p> <code>AlarmNotification</code> </p> </li>   <li> <p> <code>AZRebalance</code> </p> </li>   <li> <p> <code>HealthCheck</code> </p> </li>   <li> <p> <code>InstanceRefresh</code> </p> </li>   <li> <p> <code>ReplaceUnhealthy</code> </p> </li>   <li> <p> <code>ScheduledActions</code> </p> </li>  </ul>  <p>If you omit this parameter, all processes are specified.</p>
    ...
    ///
    /// - Takes [`TerminateInstanceInAutoScalingGroupInput`](crate::input::TerminateInstanceInAutoScalingGroupInput) with field(s):
    ///   - [`instance_id(Option<String>)`](crate::input::TerminateInstanceInAutoScalingGroupInput::instance_id): <p>The ID of the instance.</p>
    ///   - [`should_decrement_desired_capacity(Option<bool>)`](crate::input::TerminateInstanceInAutoScalingGroupInput::should_decrement_desired_capacity): <p>Indicates whether terminating the instance also decrements the size of the Auto Scaling group.</p>
    ...
    ///
    /// - Takes [`UpdateAutoScalingGroupInput`](crate::input::UpdateAutoScalingGroupInput) with field(s):
    ///   - [`auto_scaling_group_name(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`launch_configuration_name(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::launch_configuration_name): <p>The name of the launch configuration. If you specify <code>LaunchConfigurationName</code> in your update request, you can't specify <code>LaunchTemplate</code> or <code>MixedInstancesPolicy</code>.</p>
    ///   - [`launch_template(Option<LaunchTemplateSpecification>)`](crate::input::UpdateAutoScalingGroupInput::launch_template): <p>The launch template and version to use to specify the updates. If you specify <code>LaunchTemplate</code> in your update request, you can't specify <code>LaunchConfigurationName</code> or <code>MixedInstancesPolicy</code>.</p>
    ///   - [`mixed_instances_policy(Option<MixedInstancesPolicy>)`](crate::input::UpdateAutoScalingGroupInput::mixed_instances_policy): <p>An embedded object that specifies a mixed instances policy. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups.html">Auto Scaling groups with multiple instance types and purchase options</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`min_size(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::min_size): <p>The minimum size of the Auto Scaling group.</p>
    ///   - [`max_size(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::max_size): <p>The maximum size of the Auto Scaling group.</p> <note>   <p>With a mixed instances policy that uses instance weighting, Amazon EC2 Auto Scaling may need to go above <code>MaxSize</code> to meet your capacity requirements. In this event, Amazon EC2 Auto Scaling will never go above <code>MaxSize</code> by more than your largest instance weight (weights that define how many units each instance contributes to the desired capacity of the group).</p>  </note>
    ///   - [`desired_capacity(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::desired_capacity): <p>The desired capacity is the initial capacity of the Auto Scaling group after this operation completes and the capacity it attempts to maintain. This number must be greater than or equal to the minimum size of the group and less than or equal to the maximum size of the group.</p>
    ///   - [`default_cooldown(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::default_cooldown): <p>The amount of time, in seconds, after a scaling activity completes before another scaling activity can start. The default value is <code>300</code>. This setting applies when using simple scaling policies, but not when using other scaling policies or scheduled scaling. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html">Scaling cooldowns for Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`availability_zones(Option<Vec<String>>)`](crate::input::UpdateAutoScalingGroupInput::availability_zones): <p>One or more Availability Zones for the group.</p>
    ///   - [`health_check_type(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::health_check_type): <p>The service to use for the health checks. The valid values are <code>EC2</code> and <code>ELB</code>. If you configure an Auto Scaling group to use <code>ELB</code> health checks, it considers the instance unhealthy if it fails either the EC2 status checks or the load balancer health checks.</p>
    ///   - [`health_check_grace_period(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::health_check_grace_period): <p>The amount of time, in seconds, that Amazon EC2 Auto Scaling waits before checking the health status of an EC2 instance that has come into service and marking it unhealthy due to a failed health check. The default value is <code>0</code>. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/healthcheck.html#health-check-grace-period">Health check grace period</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>  <p>Conditional: Required if you are adding an <code>ELB</code> health check.</p>
    ///   - [`placement_group(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::placement_group): <p>The name of an existing placement group into which to launch your instances, if any. A placement group is a logical grouping of instances within a single Availability Zone. You cannot specify multiple Availability Zones and a placement group. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html">Placement Groups</a> in the <i>Amazon EC2 User Guide for Linux Instances</i>.</p>
    ///   - [`vpc_zone_identifier(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::vpc_zone_identifier): <p>A comma-separated list of subnet IDs for a virtual private cloud (VPC). If you specify <code>VPCZoneIdentifier</code> with <code>AvailabilityZones</code>, the subnets that you specify for this parameter must reside in those Availability Zones.</p>
    ///   - [`termination_policies(Option<Vec<String>>)`](crate::input::UpdateAutoScalingGroupInput::termination_policies): <p>A policy or a list of policies that are used to select the instances to terminate. The policies are executed in the order that you list them. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-termination.html">Controlling which Auto Scaling instances terminate during scale in</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`new_instances_protected_from_scale_in(Option<bool>)`](crate::input::UpdateAutoScalingGroupInput::new_instances_protected_from_scale_in): <p>Indicates whether newly launched instances are protected from termination by Amazon EC2 Auto Scaling when scaling in. For more information about preventing instances from terminating on scale in, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-protection.html">Using instance scale-in protection</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`service_linked_role_arn(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::service_linked_role_arn): <p>The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other Amazon Web Services on your behalf. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html">Service-linked roles</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`max_instance_lifetime(Option<i32>)`](crate::input::UpdateAutoScalingGroupInput::max_instance_lifetime): <p>The maximum amount of time, in seconds, that an instance can be in service. The default is null. If specified, the value must be either 0 or a number equal to or greater than 86,400 seconds (1 day). To clear a previously set value, specify a new value of 0. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-max-instance-lifetime.html">Replacing Auto Scaling instances based on maximum instance lifetime</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`capacity_rebalance(Option<bool>)`](crate::input::UpdateAutoScalingGroupInput::capacity_rebalance): <p>Enables or disables Capacity Rebalancing. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-capacity-rebalancing.html">Amazon EC2 Auto Scaling Capacity Rebalancing</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///   - [`context(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::context): <p>Reserved.</p>
    ///   - [`desired_capacity_type(Option<String>)`](crate::input::UpdateAutoScalingGroupInput::desired_capacity_type): <p>The unit of measurement for the value specified for desired capacity. Amazon EC2 Auto Scaling supports <code>DesiredCapacityType</code> for attribute-based instance type selection only. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-instance-type-requirements.html">Creating an Auto Scaling group using attribute-based instance type selection</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>  <p>By default, Amazon EC2 Auto Scaling specifies <code>units</code>, which translates into number of instances.</p>  <p>Valid values: <code>units</code> | <code>vcpu</code> | <code>memory-mib</code> </p>
