...
pub fn serialize_operation_attach_instances(
...
pub fn serialize_operation_attach_load_balancers(
...
pub fn serialize_operation_attach_load_balancer_target_groups(
...
pub fn serialize_operation_batch_delete_scheduled_action(
...
pub fn serialize_operation_batch_put_scheduled_update_group_action(
    ...
    if let Some(var_32) = &input.scheduled_update_group_actions {
        ...
        for item_33 in var_32 {
            ...
            crate::query_ser::serialize_structure_scheduled_update_group_action_request(
                entry_35, item_33,
            );
        }
        list_34.finish();
...
pub fn serialize_operation_cancel_instance_refresh(
...
pub fn serialize_operation_complete_lifecycle_action(
...
pub fn serialize_operation_create_auto_scaling_group(
    ...
    if let Some(var_53) = &input.launch_template {
        crate::query_ser::serialize_structure_launch_template_specification(scope_52, var_53);
    }
    #[allow(unused_mut)]
    let mut scope_54 = writer.prefix("MixedInstancesPolicy");
    if let Some(var_55) = &input.mixed_instances_policy {
        crate::query_ser::serialize_structure_mixed_instances_policy(scope_54, var_55);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_99) = &input.lifecycle_hook_specification_list {
        ...
        for item_100 in var_99 {
            ...
            crate::query_ser::serialize_structure_lifecycle_hook_specification(entry_102, item_100);
        }
        list_101.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_104) = &input.tags {
        ...
        for item_105 in var_104 {
            ...
            crate::query_ser::serialize_structure_tag(entry_107, item_105);
        }
        list_106.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_create_launch_configuration(
    ...
    if let Some(var_143) = &input.block_device_mappings {
        ...
        for item_144 in var_143 {
            ...
            crate::query_ser::serialize_structure_block_device_mapping(entry_146, item_144);
        }
        list_145.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_148) = &input.instance_monitoring {
        crate::query_ser::serialize_structure_instance_monitoring(scope_147, var_148);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_160) = &input.metadata_options {
        crate::query_ser::serialize_structure_instance_metadata_options(scope_159, var_160);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_create_or_update_tags(
...
pub fn serialize_operation_delete_auto_scaling_group(
...
pub fn serialize_operation_delete_launch_configuration(
...
pub fn serialize_operation_delete_lifecycle_hook(
...
pub fn serialize_operation_delete_notification_configuration(
...
pub fn serialize_operation_delete_tags(
    ...
    if let Some(var_189) = &input.tags {
        ...
        for item_190 in var_189 {
            ...
            crate::query_ser::serialize_structure_tag(entry_192, item_190);
        }
        list_191.finish();
    }
    writer.finish();
...
pub fn serialize_operation_delete_warm_pool(
...
pub fn serialize_operation_describe_adjustment_types(
...
pub fn serialize_operation_describe_auto_scaling_groups(
...
pub fn serialize_operation_describe_auto_scaling_instances(
...
pub fn serialize_operation_describe_auto_scaling_notification_types(
...
pub fn serialize_operation_describe_instance_refreshes(
...
pub fn serialize_operation_describe_launch_configurations(
...
pub fn serialize_operation_describe_lifecycle_hooks(
...
pub fn serialize_operation_describe_lifecycle_hook_types(
...
pub fn serialize_operation_describe_load_balancer_target_groups(
...
pub fn serialize_operation_describe_metric_collection_types(
...
pub fn serialize_operation_describe_notification_configurations(
...
pub fn serialize_operation_describe_policies(
...
pub fn serialize_operation_describe_scaling_process_types(
...
pub fn serialize_operation_describe_tags(
    ...
    if let Some(var_308) = &input.filters {
        ...
        for item_309 in var_308 {
            ...
            crate::query_ser::serialize_structure_filter(entry_311, item_309);
        }
        list_310.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_termination_policy_types(
...
pub fn serialize_operation_describe_warm_pool(
...
pub fn serialize_operation_detach_instances(
...
pub fn serialize_operation_detach_load_balancers(
...
pub fn serialize_operation_detach_load_balancer_target_groups(
...
pub fn serialize_operation_disable_metrics_collection(
...
pub fn serialize_operation_enable_metrics_collection(
...
pub fn serialize_operation_enter_standby(
...
pub fn serialize_operation_execute_policy(
...
pub fn serialize_operation_exit_standby(
...
pub fn serialize_operation_get_predictive_scaling_forecast(
...
pub fn serialize_operation_put_lifecycle_hook(
...
pub fn serialize_operation_put_notification_configuration(
...
pub fn serialize_operation_put_scaling_policy(
    ...
    if let Some(var_439) = &input.step_adjustments {
        ...
        for item_440 in var_439 {
            ...
            crate::query_ser::serialize_structure_step_adjustment(entry_442, item_440);
        }
        list_441.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_446) = &input.target_tracking_configuration {
        crate::query_ser::serialize_structure_target_tracking_configuration(scope_445, var_446);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_450) = &input.predictive_scaling_configuration {
        crate::query_ser::serialize_structure_predictive_scaling_configuration(scope_449, var_450);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_put_scheduled_update_group_action(
...
pub fn serialize_operation_put_warm_pool(
...
pub fn serialize_operation_record_lifecycle_action_heartbeat(
...
pub fn serialize_operation_resume_processes(
...
pub fn serialize_operation_set_desired_capacity(
...
pub fn serialize_operation_set_instance_health(
...
pub fn serialize_operation_set_instance_protection(
...
pub fn serialize_operation_start_instance_refresh(
...
pub fn serialize_operation_suspend_processes(
...
pub fn serialize_operation_terminate_instance_in_auto_scaling_group(
...
pub fn serialize_operation_update_auto_scaling_group(
