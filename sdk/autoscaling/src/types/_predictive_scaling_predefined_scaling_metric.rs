...
pub struct PredictiveScalingPredefinedScalingMetric {
    /// <p>The metric type.</p>
    pub predefined_metric_type: ::std::option::Option<crate::types::PredefinedScalingMetricType>,
...
impl PredictiveScalingPredefinedScalingMetric {
    /// <p>The metric type.</p>
    pub fn predefined_metric_type(&self) -> ::std::option::Option<&crate::types::PredefinedScalingMetricType> {
...
impl PredictiveScalingPredefinedScalingMetric {
    /// Creates a new builder-style object to manufacture [`PredictiveScalingPredefinedScalingMetric`](crate::types::PredictiveScalingPredefinedScalingMetric).
    pub fn builder() -> crate::types::builders::PredictiveScalingPredefinedScalingMetricBuilder {
        crate::types::builders::PredictiveScalingPredefinedScalingMetricBuilder::default()
    }
}

/// A builder for [`PredictiveScalingPredefinedScalingMetric`](crate::types::PredictiveScalingPredefinedScalingMetric).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct PredictiveScalingPredefinedScalingMetricBuilder {
    pub(crate) predefined_metric_type: ::std::option::Option<crate::types::PredefinedScalingMetricType>,
    pub(crate) resource_label: ::std::option::Option<::std::string::String>,
}
impl PredictiveScalingPredefinedScalingMetricBuilder {
    /// <p>The metric type.</p>
    /// This field is required.
    pub fn predefined_metric_type(mut self, input: crate::types::PredefinedScalingMetricType) -> Self {
        self.predefined_metric_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The metric type.</p>
    pub fn set_predefined_metric_type(mut self, input: ::std::option::Option<crate::types::PredefinedScalingMetricType>) -> Self {
        self.predefined_metric_type = input;
        self
    }
    /// <p>The metric type.</p>
    pub fn get_predefined_metric_type(&self) -> &::std::option::Option<crate::types::PredefinedScalingMetricType> {
    ...
    /// Consumes the builder and constructs a [`PredictiveScalingPredefinedScalingMetric`](crate::types::PredictiveScalingPredefinedScalingMetric).
    pub fn build(self) -> crate::types::PredictiveScalingPredefinedScalingMetric {
