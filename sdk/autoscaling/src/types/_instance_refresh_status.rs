...
other => InstanceRefreshStatus::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
...
impl InstanceRefreshStatus {
    ...
    InstanceRefreshStatus::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["Cancelled", "Cancelling", "Failed", "InProgress", "Pending", "RollbackFailed", "RollbackInProgress", "RollbackSuccessful", "Successful"]
                }
            }
