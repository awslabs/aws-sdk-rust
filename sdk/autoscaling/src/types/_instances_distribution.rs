...
/// <p>Use this structure to specify how a mixed instances policy distributes capacity across On-Demand, Spot, and supported Capacity Reservation types, and to specify the allocation strategies that are used to fulfill the capacity.</p>
#[non_exhaustive]
...
pub struct InstancesDistribution {
    ...
    /// <p>The Distribution Segments configuration. Each segment contains an ordered list of capacity types to prioritize.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/use-distribution-segments.html">Use Distribution Segments to target multiple capacity types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    pub distribution_segments: ::std::option::Option<::std::vec::Vec<crate::types::DistributionSegment>>,
}
impl InstancesDistribution {
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/use-distribution-segments.html">Use Distribution Segments to target multiple capacity types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.distribution_segments.is_none()`.
    pub fn distribution_segments(&self) -> &[crate::types::DistributionSegment] {
        self.distribution_segments.as_deref().unwrap_or_default()
    }
}
impl InstancesDistribution {
...
pub struct InstancesDistributionBuilder {
    ...
    pub(crate) distribution_segments: ::std::option::Option<::std::vec::Vec<crate::types::DistributionSegment>>,
}
impl InstancesDistributionBuilder {
    ...
    /// Appends an item to `distribution_segments`.
    ///
    /// To override the contents of this collection use [`set_distribution_segments`](Self::set_distribution_segments).
    ///
    /// <p>The Distribution Segments configuration. Each segment contains an ordered list of capacity types to prioritize.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/use-distribution-segments.html">Use Distribution Segments to target multiple capacity types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    pub fn distribution_segments(mut self, input: crate::types::DistributionSegment) -> Self {
        let mut v = self.distribution_segments.unwrap_or_default();
        v.push(input);
        self.distribution_segments = ::std::option::Option::Some(v);
        self
    }
    /// <p>The Distribution Segments configuration. Each segment contains an ordered list of capacity types to prioritize.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/use-distribution-segments.html">Use Distribution Segments to target multiple capacity types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    pub fn set_distribution_segments(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::DistributionSegment>>) -> Self {
        self.distribution_segments = input;
        self
    }
    /// <p>The Distribution Segments configuration. Each segment contains an ordered list of capacity types to prioritize.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/use-distribution-segments.html">Use Distribution Segments to target multiple capacity types</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    pub fn get_distribution_segments(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::DistributionSegment>> {
        &self.distribution_segments
    }
    ...
    pub fn build(self) -> crate::types::InstancesDistribution {
        crate::types::InstancesDistribution {
            ...
            distribution_segments: self.distribution_segments,
        }
    }
}
