...
#[allow(unused_mut)]
pub fn serialize_structure_scheduled_update_group_action_request(
    ...
    if let Some(var_4) = &input.start_time {
        scope_3.instant(var_4, smithy_types::instant::Format::DateTime);
    }
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("EndTime");
    if let Some(var_6) = &input.end_time {
        scope_5.instant(var_6, smithy_types::instant::Format::DateTime);
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_mixed_instances_policy(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_24) = &input.launch_template {
        crate::query_ser::serialize_structure_launch_template(scope_23, var_24);
    }
    #[allow(unused_mut)]
    let mut scope_25 = writer.prefix("InstancesDistribution");
    if let Some(var_26) = &input.instances_distribution {
        crate::query_ser::serialize_structure_instances_distribution(scope_25, var_26);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_lifecycle_hook_specification(
    mut writer: smithy_query::QueryValueWriter,
...
pub fn serialize_structure_block_device_mapping(
    ...
    if let Some(var_56) = &input.ebs {
        crate::query_ser::serialize_structure_ebs(scope_55, var_56);
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_instance_monitoring(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_instance_metadata_options(
    mut writer: smithy_query::QueryValueWriter,
...
pub fn serialize_structure_step_adjustment(
    ...
    if let Some(var_77) = &input.metric_interval_upper_bound {
        scope_76.number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_77).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_target_tracking_configuration(
    ...
    if let Some(var_81) = &input.predefined_metric_specification {
        crate::query_ser::serialize_structure_predefined_metric_specification(scope_80, var_81);
    }
    #[allow(unused_mut)]
    let mut scope_82 = writer.prefix("CustomizedMetricSpecification");
    if let Some(var_83) = &input.customized_metric_specification {
        crate::query_ser::serialize_structure_customized_metric_specification(scope_82, var_83);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_85) = &input.target_value {
        scope_84.number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_85).into()),
        );
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_predictive_scaling_configuration(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_89) = &input.metric_specifications {
        ...
        for item_90 in var_89 {
            ...
            crate::query_ser::serialize_structure_predictive_scaling_metric_specification(
                entry_92, item_90,
            );
        }
        list_91.finish();
...
#[allow(unused_mut)]
pub fn serialize_structure_launch_template(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_instances_distribution(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_ebs(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_predictive_scaling_metric_specification(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_predictive_scaling_predefined_metric_pair(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_predictive_scaling_predefined_scaling_metric(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_predictive_scaling_predefined_load_metric(
    mut writer: smithy_query::QueryValueWriter,
