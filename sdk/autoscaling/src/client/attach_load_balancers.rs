...
impl super::Client {
    ...
    pub fn attach_load_balancers(
        &self,
    ) -> crate::operation::attach_load_balancers::builders::AttachLoadBalancersFluentBuilder {
        crate::operation::attach_load_balancers::builders::AttachLoadBalancersFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
