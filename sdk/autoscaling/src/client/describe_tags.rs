...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_filters): <p>One or more filters to scope the tags to return. The maximum number of filters per filter type (for example, <code>auto-scaling-group</code>) is 1000.</p>
