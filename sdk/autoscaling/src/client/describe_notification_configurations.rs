...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_notification_configurations::builders::DescribeNotificationConfigurationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_notification_configurations::builders::DescribeNotificationConfigurationsFluentBuilder::set_next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
