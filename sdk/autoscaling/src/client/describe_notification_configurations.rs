...
impl super::Client {
    ...
    ///   - [`auto_scaling_group_names(impl Into<String>)`](crate::operation::describe_notification_configurations::builders::DescribeNotificationConfigurationsFluentBuilder::auto_scaling_group_names) / [`set_auto_scaling_group_names(Option<Vec<String>>)`](crate::operation::describe_notification_configurations::builders::DescribeNotificationConfigurationsFluentBuilder::set_auto_scaling_group_names): <p>The name of the Auto Scaling group.</p>
