...
impl super::Client {
    ...
    ///   - [`instance_refresh_id(Option<String>)`](crate::operation::start_instance_refresh::StartInstanceRefreshOutput::instance_refresh_id): <p>A unique ID for tracking the progress of the request.</p>
