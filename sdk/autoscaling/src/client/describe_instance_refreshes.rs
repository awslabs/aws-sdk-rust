...
impl super::Client {
    ...
    ///   - [`instance_refresh_ids(impl Into<String>)`](crate::operation::describe_instance_refreshes::builders::DescribeInstanceRefreshesFluentBuilder::instance_refresh_ids) / [`set_instance_refresh_ids(Option<Vec<String>>)`](crate::operation::describe_instance_refreshes::builders::DescribeInstanceRefreshesFluentBuilder::set_instance_refresh_ids): <p>One or more instance refresh IDs.</p>
