...
impl super::Client {
    ...
    ///   - [`wait_for_transitioning_instances(bool)`](crate::operation::cancel_instance_refresh::builders::CancelInstanceRefreshFluentBuilder::wait_for_transitioning_instances) / [`set_wait_for_transitioning_instances(Option<bool>)`](crate::operation::cancel_instance_refresh::builders::CancelInstanceRefreshFluentBuilder::set_wait_for_transitioning_instances):<br>required: **false**<br><p>When cancelling an instance refresh, this indicates whether to wait for in-flight launches and terminations to complete. The default is true.</p> <p>When set to false, Amazon EC2 Auto Scaling cancels the instance refresh without waiting for any pending launches or terminations to complete.</p><br>
