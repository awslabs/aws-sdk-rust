...
impl super::Client  {
    ...
    pub fn describe_auto_scaling_notification_types(&self) -> crate::client::fluent_builders::DescribeAutoScalingNotificationTypes {
                                crate::client::fluent_builders::DescribeAutoScalingNotificationTypes::new(self.handle.clone())
                            }
}
