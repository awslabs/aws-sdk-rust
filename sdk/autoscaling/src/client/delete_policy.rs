...
impl super::Client {
    ...
    ///   - [`auto_scaling_group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_policy::builders::DeletePolicyFluentBuilder::auto_scaling_group_name) / [`set_auto_scaling_group_name(Option<String>)`](crate::operation::delete_policy::builders::DeletePolicyFluentBuilder::set_auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
