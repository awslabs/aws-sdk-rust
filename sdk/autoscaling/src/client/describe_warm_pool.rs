...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_warm_pool::builders::DescribeWarmPoolFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_warm_pool::builders::DescribeWarmPoolFluentBuilder::set_next_token): <p>The token for the next set of instances to return. (You received this token from a previous call.)</p>
