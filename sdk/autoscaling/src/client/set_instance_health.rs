...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::set_instance_health::builders::SetInstanceHealthFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::set_instance_health::builders::SetInstanceHealthFluentBuilder::set_instance_id): <p>The ID of the instance.</p>
    ///   - [`health_status(impl ::std::convert::Into<String>)`](crate::operation::set_instance_health::builders::SetInstanceHealthFluentBuilder::health_status) / [`set_health_status(Option<String>)`](crate::operation::set_instance_health::builders::SetInstanceHealthFluentBuilder::set_health_status): <p>The health status of the instance. Set to <code>Healthy</code> to have the instance remain in service. Set to <code>Unhealthy</code> to have the instance be out of service. Amazon EC2 Auto Scaling terminates and replaces the unhealthy instance.</p>
