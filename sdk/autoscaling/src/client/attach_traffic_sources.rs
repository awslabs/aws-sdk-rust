...
impl super::Client {
    ...
    ///   - [`traffic_sources(TrafficSourceIdentifier)`](crate::operation::attach_traffic_sources::builders::AttachTrafficSourcesFluentBuilder::traffic_sources) / [`set_traffic_sources(Option<Vec<TrafficSourceIdentifier>>)`](crate::operation::attach_traffic_sources::builders::AttachTrafficSourcesFluentBuilder::set_traffic_sources): <p>The unique identifiers of one or more traffic sources. You can specify up to 10 traffic sources.</p>
