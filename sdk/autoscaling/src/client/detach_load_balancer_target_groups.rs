...
impl super::Client {
    ...
    ///   - [`target_group_ar_ns(impl Into<String>)`](crate::operation::detach_load_balancer_target_groups::builders::DetachLoadBalancerTargetGroupsFluentBuilder::target_group_ar_ns) / [`set_target_group_ar_ns(Option<Vec<String>>)`](crate::operation::detach_load_balancer_target_groups::builders::DetachLoadBalancerTargetGroupsFluentBuilder::set_target_group_ar_ns):<br>required: **true**<br><p>The Amazon Resource Names (ARN) of the target groups. You can specify up to 10 target groups.</p><br>
