...
///
/// Fluent builder for the `group_in_service` waiter.
///
...
pub struct GroupInServiceFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_auto_scaling_groups::builders::DescribeAutoScalingGroupsInputBuilder,
}
impl GroupInServiceFluentBuilder {
    /// Creates a new `GroupInServiceFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::group_in_service::GroupInServiceFinalPoll,
        crate::waiters::group_in_service::WaitUntilGroupInServiceError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"contains(AutoScalingGroups[].[length(Instances[?LifecycleState=='InService']) >= MinSize][], `false`)","expected":"false","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_auto_scaling_groups_2b8809e69e59ad32a(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"contains(AutoScalingGroups[].[length(Instances[?LifecycleState=='InService']) >= MinSize][], `false`)","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_auto_scaling_groups_ab0cd1b1c8e0267b1(result) {
...
/// Successful return type for the `group_in_service` waiter.
pub type GroupInServiceFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsOutput,
...
/// Error type for the `group_in_service` waiter.
pub type WaitUntilGroupInServiceError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsOutput,
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsError,
>;
