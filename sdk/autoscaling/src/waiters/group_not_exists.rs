...
///
/// Fluent builder for the `group_not_exists` waiter.
///
...
pub struct GroupNotExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_auto_scaling_groups::builders::DescribeAutoScalingGroupsInputBuilder,
}
impl GroupNotExistsFluentBuilder {
    /// Creates a new `GroupNotExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::group_not_exists::GroupNotExistsFinalPoll,
        crate::waiters::group_not_exists::WaitUntilGroupNotExistsError,
    > {
        let input = self
            .inner
            .build()
...
/// Successful return type for the `group_not_exists` waiter.
pub type GroupNotExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsOutput,
...
/// Error type for the `group_not_exists` waiter.
pub type WaitUntilGroupNotExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsOutput,
    crate::operation::describe_auto_scaling_groups::DescribeAutoScalingGroupsError,
>;
