...
/// Flattened paginator for `DescribePoliciesPaginator`
                ...
                impl  DescribePoliciesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ScalingPolicy, aws_smithy_http::result::SdkError<crate::error::DescribePoliciesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_describe_policies_output_scaling_policies(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `DescribeScalingActivitiesPaginator`
                ...
                impl  DescribeScalingActivitiesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Activity, aws_smithy_http::result::SdkError<crate::error::DescribeScalingActivitiesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_describe_scaling_activities_output_activities(page).unwrap_or_default().into_iter())
                    }
                }
