...
pub struct MixedInstancesPolicy  {
    ...
    #[doc(hidden)]pub launch_template: std::option::Option<crate::model::LaunchTemplate>,
    /// <p>The instances distribution.</p>
    #[doc(hidden)]pub instances_distribution: std::option::Option<crate::model::InstancesDistribution>,
}
...
pub struct InstancesDistribution  {
    ...
    #[doc(hidden)]pub on_demand_allocation_strategy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub on_demand_base_capacity: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub on_demand_percentage_above_base_capacity: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub spot_allocation_strategy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub spot_instance_pools: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub spot_max_price: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for InstancesDistribution  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("on_demand_allocation_strategy", &self.on_demand_allocation_strategy);
        formatter.field("on_demand_base_capacity", &self.on_demand_base_capacity);
        formatter.field("on_demand_percentage_above_base_capacity", &self.on_demand_percentage_above_base_capacity);
...
pub struct LaunchTemplate  {
    ...
    #[doc(hidden)]pub launch_template_specification: std::option::Option<crate::model::LaunchTemplateSpecification>,
    ...
    #[doc(hidden)]pub overrides: std::option::Option<std::vec::Vec<crate::model::LaunchTemplateOverrides>>,
}
impl LaunchTemplate {
    /// <p>The launch template to use.</p>
...
impl  std::fmt::Debug for LaunchTemplate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("launch_template_specification", &self.launch_template_specification);
...
pub struct LaunchTemplateOverrides  {
    ...
    #[doc(hidden)]pub weighted_capacity: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub instance_requirements: std::option::Option<crate::model::InstanceRequirements>,
}
...
pub struct InstanceRequirements  {
    ...
    #[doc(hidden)]pub v_cpu_count: std::option::Option<crate::model::VCpuCountRequest>,
    /// <p>The minimum and maximum instance memory size for an instance type, in MiB.</p>
    #[doc(hidden)]pub memory_mi_b: std::option::Option<crate::model::MemoryMiBRequest>,
    ...
    #[doc(hidden)]pub cpu_manufacturers: std::option::Option<std::vec::Vec<crate::model::CpuManufacturer>>,
    /// <p>The minimum and maximum amount of memory per vCPU for an instance type, in GiB.</p> 
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub memory_gi_b_per_v_cpu: std::option::Option<crate::model::MemoryGiBPerVCpuRequest>,
    ...
    #[doc(hidden)]pub excluded_instance_types: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub instance_generations: std::option::Option<std::vec::Vec<crate::model::InstanceGeneration>>,
    ...
    /// <p>Default: <code>100</code> </p>
    #[doc(hidden)]pub spot_max_price_percentage_over_lowest_price: std::option::Option<i32>,
    /// <p>The price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the least expensive current generation M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as <code>999999</code>. </p> 
    /// <p>If you set <code>DesiredCapacityType</code> to <code>vcpu</code> or <code>memory-mib</code>, the price protection threshold is applied based on the per vCPU or per memory price instead of the per instance price. </p> 
    /// <p>Default: <code>20</code> </p>
    #[doc(hidden)]pub on_demand_max_price_percentage_over_lowest_price: std::option::Option<i32>,
    /// <p>Indicates whether bare metal instance types are included, excluded, or required.</p> 
    /// <p>Default: <code>excluded</code> </p>
    #[doc(hidden)]pub bare_metal: std::option::Option<crate::model::BareMetal>,
    ...
    /// <p>Default: <code>excluded</code> </p>
    #[doc(hidden)]pub burstable_performance: std::option::Option<crate::model::BurstablePerformance>,
    /// <p>Indicates whether instance types must provide On-Demand Instance hibernation support.</p> 
    /// <p>Default: <code>false</code> </p>
    #[doc(hidden)]pub require_hibernate_support: std::option::Option<bool>,
    /// <p>The minimum and maximum number of network interfaces for an instance type.</p> 
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub network_interface_count: std::option::Option<crate::model::NetworkInterfaceCountRequest>,
    ...
    #[doc(hidden)]pub local_storage: std::option::Option<crate::model::LocalStorage>,
    ...
    #[doc(hidden)]pub local_storage_types: std::option::Option<std::vec::Vec<crate::model::LocalStorageType>>,
    /// <p>The minimum and maximum total local storage size for an instance type, in GB.</p> 
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub total_local_storage_gb: std::option::Option<crate::model::TotalLocalStorageGbRequest>,
    ...
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub baseline_ebs_bandwidth_mbps: std::option::Option<crate::model::BaselineEbsBandwidthMbpsRequest>,
    ...
    #[doc(hidden)]pub accelerator_types: std::option::Option<std::vec::Vec<crate::model::AcceleratorType>>,
    ...
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub accelerator_count: std::option::Option<crate::model::AcceleratorCountRequest>,
    ...
    /// </ul> 
    /// <p>Default: Any manufacturer</p>
    #[doc(hidden)]pub accelerator_manufacturers: std::option::Option<std::vec::Vec<crate::model::AcceleratorManufacturer>>,
    ...
    #[doc(hidden)]pub accelerator_names: std::option::Option<std::vec::Vec<crate::model::AcceleratorName>>,
    /// <p>The minimum and maximum total memory size for the accelerators on an instance type, in MiB.</p> 
    /// <p>Default: No minimum or maximum</p>
    #[doc(hidden)]pub accelerator_total_memory_mi_b: std::option::Option<crate::model::AcceleratorTotalMemoryMiBRequest>,
}
...
impl  std::fmt::Debug for InstanceRequirements  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("spot_max_price_percentage_over_lowest_price", &self.spot_max_price_percentage_over_lowest_price);
        formatter.field("on_demand_max_price_percentage_over_lowest_price", &self.on_demand_max_price_percentage_over_lowest_price);
        ...
        formatter.field("baseline_ebs_bandwidth_mbps", &self.baseline_ebs_bandwidth_mbps);
        ...
        formatter.field("accelerator_total_memory_mi_b", &self.accelerator_total_memory_mi_b);
        formatter.finish()
    }
}
...
pub struct AcceleratorTotalMemoryMiBRequest  {
    ...
    #[doc(hidden)]pub min: std::option::Option<i32>,
    /// <p>The memory maximum in MiB.</p>
    #[doc(hidden)]pub max: std::option::Option<i32>,
}
...
pub struct TotalLocalStorageGbRequest  {
    ...
    #[doc(hidden)]pub min: std::option::Option<f64>,
    /// <p>The storage maximum in GB.</p>
    #[doc(hidden)]pub max: std::option::Option<f64>,
}
...
pub struct LaunchTemplateSpecification  {
    ...
    #[doc(hidden)]pub launch_template_id: std::option::Option<std::string::String>,
    /// <p>The name of the launch template. To get the template name, use the Amazon EC2 <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeLaunchTemplates.html">DescribeLaunchTemplates</a> API operation. New launch templates can be created using the Amazon EC2 <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateLaunchTemplate.html">CreateLaunchTemplate</a> API. </p> 
    /// <p>Conditional: You must specify either a <code>LaunchTemplateId</code> or a <code>LaunchTemplateName</code>.</p>
    #[doc(hidden)]pub launch_template_name: std::option::Option<std::string::String>,
...
pub struct Activity  {
    ...
    #[doc(hidden)]pub activity_id: std::option::Option<std::string::String>,
    /// <p>The name of the Auto Scaling group.</p>
    #[doc(hidden)]pub auto_scaling_group_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cause: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status_code: std::option::Option<crate::model::ScalingActivityStatusCode>,
    ...
    #[doc(hidden)]pub progress: i32,
    /// <p>The details about the activity.</p>
    #[doc(hidden)]pub details: std::option::Option<std::string::String>,
    /// <p>The state of the Auto Scaling group, which is either <code>InService</code> or <code>Deleted</code>.</p>
    #[doc(hidden)]pub auto_scaling_group_state: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the Auto Scaling group.</p>
    #[doc(hidden)]pub auto_scaling_group_arn: std::option::Option<std::string::String>,
}
impl Activity {
    /// <p>The ID of the activity.</p>
...
pub struct RefreshPreferences  {
    ...
    #[doc(hidden)]pub min_healthy_percentage: std::option::Option<i32>,
    ...
    /// </note>
    #[doc(hidden)]pub instance_warmup: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub checkpoint_percentages: std::option::Option<std::vec::Vec<i32>>,
    ...
    #[doc(hidden)]pub checkpoint_delay: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub skip_matching: std::option::Option<bool>,
}
...
pub struct DesiredConfiguration  {
    /// <p>Describes the launch template and the version of the launch template that Amazon EC2 Auto Scaling uses to launch Amazon EC2 instances. For more information about launch templates, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/LaunchTemplates.html">Launch templates</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    #[doc(hidden)]pub launch_template: std::option::Option<crate::model::LaunchTemplateSpecification>,
    /// <p>Describes a mixed instances policy. A mixed instances policy contains the instance types that Amazon EC2 Auto Scaling can launch and other information that Amazon EC2 Auto Scaling can use to launch instances and help optimize your costs. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups.html">Auto Scaling groups with multiple instance types and purchase options</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    #[doc(hidden)]pub mixed_instances_policy: std::option::Option<crate::model::MixedInstancesPolicy>,
}
...
pub struct InstanceReusePolicy  {
    ...
    #[doc(hidden)]pub reuse_on_scale_in: std::option::Option<bool>,
}
...
pub struct Alarm  {
    ...
    #[doc(hidden)]pub alarm_name: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the alarm.</p>
    #[doc(hidden)]pub alarm_arn: std::option::Option<std::string::String>,
}
impl Alarm {
    /// <p>The name of the alarm.</p>
...
pub struct PredictiveScalingConfiguration  {
    ...
    #[doc(hidden)]pub metric_specifications: std::option::Option<std::vec::Vec<crate::model::PredictiveScalingMetricSpecification>>,
    /// <p>The predictive scaling mode. Defaults to <code>ForecastOnly</code> if not specified.</p>
    #[doc(hidden)]pub mode: std::option::Option<crate::model::PredictiveScalingMode>,
    ...
    #[doc(hidden)]pub scheduling_buffer_time: std::option::Option<i32>,
    ...
    /// </ul>
    #[doc(hidden)]pub max_capacity_breach_behavior: std::option::Option<crate::model::PredictiveScalingMaxCapacityBreachBehavior>,
    ...
    #[doc(hidden)]pub max_capacity_buffer: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for PredictiveScalingConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("max_capacity_breach_behavior", &self.max_capacity_breach_behavior);
...
pub struct PredictiveScalingMetricSpecification  {
    ...
    /// </note>
    #[doc(hidden)]pub target_value: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub predefined_metric_pair_specification: std::option::Option<crate::model::PredictiveScalingPredefinedMetricPair>,
    /// <p>The predefined scaling metric specification.</p>
    #[doc(hidden)]pub predefined_scaling_metric_specification: std::option::Option<crate::model::PredictiveScalingPredefinedScalingMetric>,
    /// <p>The predefined load metric specification.</p>
    #[doc(hidden)]pub predefined_load_metric_specification: std::option::Option<crate::model::PredictiveScalingPredefinedLoadMetric>,
    /// <p>The customized scaling metric specification.</p>
    #[doc(hidden)]pub customized_scaling_metric_specification: std::option::Option<crate::model::PredictiveScalingCustomizedScalingMetric>,
    /// <p>The customized load metric specification.</p>
    #[doc(hidden)]pub customized_load_metric_specification: std::option::Option<crate::model::PredictiveScalingCustomizedLoadMetric>,
    /// <p>The customized capacity metric specification.</p>
    #[doc(hidden)]pub customized_capacity_metric_specification: std::option::Option<crate::model::PredictiveScalingCustomizedCapacityMetric>,
}
...
impl  std::fmt::Debug for PredictiveScalingMetricSpecification  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predefined_metric_pair_specification", &self.predefined_metric_pair_specification);
        formatter.field("predefined_scaling_metric_specification", &self.predefined_scaling_metric_specification);
        formatter.field("predefined_load_metric_specification", &self.predefined_load_metric_specification);
        formatter.field("customized_scaling_metric_specification", &self.customized_scaling_metric_specification);
        formatter.field("customized_load_metric_specification", &self.customized_load_metric_specification);
        formatter.field("customized_capacity_metric_specification", &self.customized_capacity_metric_specification);
        formatter.finish()
    }
}
...
pub struct PredictiveScalingCustomizedCapacityMetric  {
    ...
    #[doc(hidden)]pub metric_data_queries: std::option::Option<std::vec::Vec<crate::model::MetricDataQuery>>,
}
...
pub struct MetricDataQuery  {
    ...
    #[doc(hidden)]pub expression: std::option::Option<std::string::String>,
    /// <p>Information about the metric data to return.</p> 
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    #[doc(hidden)]pub metric_stat: std::option::Option<crate::model::MetricStat>,
    ...
    #[doc(hidden)]pub return_data: std::option::Option<bool>,
}
...
pub struct MetricStat  {
    ...
    #[doc(hidden)]pub metric: std::option::Option<crate::model::Metric>,
    ...
    #[doc(hidden)]pub stat: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub unit: std::option::Option<std::string::String>,
}
impl MetricStat {
    /// <p>The CloudWatch metric to return, including the metric name, namespace, and dimensions. To get the exact metric name, namespace, and dimensions, inspect the <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Metric.html">Metric</a> object that is returned by a call to <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html">ListMetrics</a>.</p>
...
pub struct Metric  {
    ...
    #[doc(hidden)]pub metric_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub dimensions: std::option::Option<std::vec::Vec<crate::model::MetricDimension>>,
}
impl Metric {
    /// <p>The namespace of the metric. For more information, see the table in <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html">Amazon Web Services services that publish CloudWatch metrics </a> in the <i>Amazon CloudWatch User Guide</i>.</p>
...
pub struct PredictiveScalingPredefinedLoadMetric  {
    /// <p>The metric type.</p>
    #[doc(hidden)]pub predefined_metric_type: std::option::Option<crate::model::PredefinedLoadMetricType>,
    ...
    #[doc(hidden)]pub resource_label: std::option::Option<std::string::String>,
}
...
pub struct PredictiveScalingPredefinedScalingMetric  {
    /// <p>The metric type.</p>
    #[doc(hidden)]pub predefined_metric_type: std::option::Option<crate::model::PredefinedScalingMetricType>,
...
pub struct PredictiveScalingPredefinedMetricPair  {
    ...
    #[doc(hidden)]pub predefined_metric_type: std::option::Option<crate::model::PredefinedMetricPairType>,
...
pub struct TargetTrackingConfiguration  {
    ...
    #[doc(hidden)]pub predefined_metric_specification: std::option::Option<crate::model::PredefinedMetricSpecification>,
    /// <p>A customized metric. You must specify either a predefined metric or a customized metric.</p>
    #[doc(hidden)]pub customized_metric_specification: std::option::Option<crate::model::CustomizedMetricSpecification>,
    ...
    #[doc(hidden)]pub disable_scale_in: std::option::Option<bool>,
}
...
impl  std::fmt::Debug for TargetTrackingConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predefined_metric_specification", &self.predefined_metric_specification);
        formatter.field("customized_metric_specification", &self.customized_metric_specification);
        formatter.field("target_value", &self.target_value);
...
pub struct CustomizedMetricSpecification  {
    ...
    #[doc(hidden)]pub statistic: std::option::Option<crate::model::MetricStatistic>,
...
pub struct PredefinedMetricSpecification  {
    ...
    /// </ul>
    #[doc(hidden)]pub predefined_metric_type: std::option::Option<crate::model::MetricType>,
    /// <p>A label that uniquely identifies a specific Application Load Balancer target group from which to determine the average request count served by your Auto Scaling group. You can't specify a resource label unless the target group is attached to the Auto Scaling group.</p> 
    /// <p>You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). The format of the resource label is:</p> 
    /// <p> <code>app/my-alb/778d41231b141a0f/targetgroup/my-alb-target-group/943f017f100becff</code>.</p> 
    /// <p>Where:</p> 
...
pub struct StepAdjustment  {
    ...
    #[doc(hidden)]pub metric_interval_lower_bound: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub metric_interval_upper_bound: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub scaling_adjustment: std::option::Option<i32>,
}
impl StepAdjustment {
    /// <p>The lower bound for the difference between the alarm threshold and the CloudWatch metric. If the metric value is above the breach threshold, the lower bound is inclusive (the metric must be greater than or equal to the threshold plus the lower bound). Otherwise, it is exclusive (the metric must be greater than the threshold plus the lower bound). A null value indicates negative infinity.</p>
...
impl  std::fmt::Debug for StepAdjustment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("metric_interval_lower_bound", &self.metric_interval_lower_bound);
        formatter.field("metric_interval_upper_bound", &self.metric_interval_upper_bound);
...
pub struct CapacityForecast  {
    ...
    #[doc(hidden)]pub timestamps: std::option::Option<std::vec::Vec<aws_smithy_types::DateTime>>,
    /// <p>The values of the data points.</p>
    #[doc(hidden)]pub values: std::option::Option<std::vec::Vec<f64>>,
}
...
pub struct LoadForecast  {
    ...
    #[doc(hidden)]pub metric_specification: std::option::Option<crate::model::PredictiveScalingMetricSpecification>,
}
impl LoadForecast {
    /// <p>The timestamps for the data points, in UTC format.</p>
    pub fn timestamps(&self) -> std::option::Option<& [aws_smithy_types::DateTime]> {
...
pub struct Instance  {
    ...
    #[doc(hidden)]pub lifecycle_state: std::option::Option<crate::model::LifecycleState>,
    ...
    #[doc(hidden)]pub health_status: std::option::Option<std::string::String>,
    /// <p>The launch configuration associated with the instance.</p>
    #[doc(hidden)]pub launch_configuration_name: std::option::Option<std::string::String>,
    /// <p>The launch template for the instance.</p>
    #[doc(hidden)]pub launch_template: std::option::Option<crate::model::LaunchTemplateSpecification>,
    /// <p>Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.</p>
    #[doc(hidden)]pub protected_from_scale_in: std::option::Option<bool>,
...
pub struct WarmPoolConfiguration  {
    ...
    #[doc(hidden)]pub max_group_prepared_capacity: std::option::Option<i32>,
    /// <p>The minimum number of instances to maintain in the warm pool.</p>
    #[doc(hidden)]pub min_size: std::option::Option<i32>,
    /// <p>The instance state to transition to after the lifecycle actions are complete.</p>
    #[doc(hidden)]pub pool_state: std::option::Option<crate::model::WarmPoolState>,
    /// <p>The status of a warm pool that is marked for deletion.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::WarmPoolStatus>,
    /// <p>The instance reuse policy.</p>
    #[doc(hidden)]pub instance_reuse_policy: std::option::Option<crate::model::InstanceReusePolicy>,
}
...
impl  std::fmt::Debug for WarmPoolConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("max_group_prepared_capacity", &self.max_group_prepared_capacity);
...
pub struct TagDescription  {
    ...
    #[doc(hidden)]pub propagate_at_launch: std::option::Option<bool>,
}
impl TagDescription {
    /// <p>The name of the group.</p>
...
pub struct ScheduledUpdateGroupAction  {
    ...
    #[doc(hidden)]pub scheduled_action_name: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the scheduled action.</p>
    #[doc(hidden)]pub scheduled_action_arn: std::option::Option<std::string::String>,
    /// <p>This property is no longer used.</p>
    #[doc(hidden)]pub time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub recurrence: std::option::Option<std::string::String>,
    /// <p>The minimum size of the Auto Scaling group.</p>
    #[doc(hidden)]pub min_size: std::option::Option<i32>,
    /// <p>The maximum size of the Auto Scaling group.</p>
    #[doc(hidden)]pub max_size: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub desired_capacity: std::option::Option<i32>,
    /// <p>The time zone for the cron expression.</p>
    #[doc(hidden)]pub time_zone: std::option::Option<std::string::String>,
}
...
pub struct ProcessType  {
    ...
    /// </ul>
    #[doc(hidden)]pub process_name: std::option::Option<std::string::String>,
}
impl ProcessType {
    /// <p>One of the following processes:</p> 
    /// <ul> 
...
pub struct ScalingPolicy  {
    ...
    #[doc(hidden)]pub policy_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub policy_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub metric_aggregation_type: std::option::Option<std::string::String>,
    /// <p>The estimated time, in seconds, until a newly launched instance can contribute to the CloudWatch metrics.</p>
    #[doc(hidden)]pub estimated_instance_warmup: std::option::Option<i32>,
    /// <p>The CloudWatch alarms related to the policy.</p>
    #[doc(hidden)]pub alarms: std::option::Option<std::vec::Vec<crate::model::Alarm>>,
    /// <p>A target tracking scaling policy.</p>
    #[doc(hidden)]pub target_tracking_configuration: std::option::Option<crate::model::TargetTrackingConfiguration>,
    /// <p>Indicates whether the policy is enabled (<code>true</code>) or disabled (<code>false</code>).</p>
    #[doc(hidden)]pub enabled: std::option::Option<bool>,
    /// <p>A predictive scaling policy.</p>
    #[doc(hidden)]pub predictive_scaling_configuration: std::option::Option<crate::model::PredictiveScalingConfiguration>,
}
impl ScalingPolicy {
    /// <p>The name of the Auto Scaling group.</p>
    pub fn auto_scaling_group_name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for ScalingPolicy  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("target_tracking_configuration", &self.target_tracking_configuration);
        formatter.field("enabled", &self.enabled);
        formatter.field("predictive_scaling_configuration", &self.predictive_scaling_configuration);
        formatter.finish()
    }
}
...
pub struct NotificationConfiguration  {
    ...
    /// </ul>
    #[doc(hidden)]pub notification_type: std::option::Option<std::string::String>,
}
...
pub struct MetricGranularityType  {
    ...
    #[doc(hidden)]pub granularity: std::option::Option<std::string::String>,
}
...
pub struct MetricCollectionType  {
    ...
    /// </ul>
    #[doc(hidden)]pub metric: std::option::Option<std::string::String>,
}
...
pub struct LoadBalancerTargetGroupState  {
    ...
    #[doc(hidden)]pub load_balancer_target_group_arn: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for LoadBalancerTargetGroupState  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("load_balancer_target_group_arn", &self.load_balancer_target_group_arn);
...
pub struct LifecycleHook  {
    ...
    #[doc(hidden)]pub lifecycle_hook_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub lifecycle_transition: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub notification_target_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub notification_metadata: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub heartbeat_timeout: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub global_timeout: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub default_result: std::option::Option<std::string::String>,
}
impl LifecycleHook {
    /// <p>The name of the lifecycle hook.</p>
...
pub struct LaunchConfiguration  {
    ...
    #[doc(hidden)]pub launch_configuration_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub key_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub classic_link_vpc_id: std::option::Option<std::string::String>,
    /// <p> <i>EC2-Classic retires on August 15, 2022. This property is not supported after that date.</i> </p> 
    /// <p>The IDs of one or more security groups for the VPC specified in <code>ClassicLinkVPCId</code>.</p>
    #[doc(hidden)]pub classic_link_vpc_security_groups: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub user_data: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub kernel_id: std::option::Option<std::string::String>,
    /// <p>The ID of the RAM disk associated with the AMI.</p>
    #[doc(hidden)]pub ramdisk_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub block_device_mappings: std::option::Option<std::vec::Vec<crate::model::BlockDeviceMapping>>,
    ...
    #[doc(hidden)]pub instance_monitoring: std::option::Option<crate::model::InstanceMonitoring>,
    ...
    #[doc(hidden)]pub spot_price: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub iam_instance_profile: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ebs_optimized: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub associate_public_ip_address: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub placement_tenancy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub metadata_options: std::option::Option<crate::model::InstanceMetadataOptions>,
}
...
impl  std::fmt::Debug for LaunchConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("classic_link_vpc_security_groups", &self.classic_link_vpc_security_groups);
...
pub struct InstanceMetadataOptions  {
    ...
    #[doc(hidden)]pub http_tokens: std::option::Option<crate::model::InstanceMetadataHttpTokensState>,
    ...
    /// <p>Default: 1</p>
    #[doc(hidden)]pub http_put_response_hop_limit: std::option::Option<i32>,
    ...
    /// </note>
    #[doc(hidden)]pub http_endpoint: std::option::Option<crate::model::InstanceMetadataEndpointState>,
}
...
pub struct BlockDeviceMapping  {
    ...
    #[doc(hidden)]pub virtual_name: std::option::Option<std::string::String>,
    ...
    /// </note>
    #[doc(hidden)]pub device_name: std::option::Option<std::string::String>,
    /// <p>Information to attach an EBS volume to an instance at launch.</p>
    #[doc(hidden)]pub ebs: std::option::Option<crate::model::Ebs>,
    ...
    #[doc(hidden)]pub no_device: std::option::Option<bool>,
}
...
pub struct Ebs  {
    ...
    #[doc(hidden)]pub volume_size: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub volume_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub delete_on_termination: std::option::Option<bool>,
    ...
    /// </note>
    #[doc(hidden)]pub encrypted: std::option::Option<bool>,
    /// <p>The throughput (MiBps) to provision for a <code>gp3</code> volume.</p>
    #[doc(hidden)]pub throughput: std::option::Option<i32>,
}
impl Ebs {
    /// <p>The snapshot ID of the volume to use.</p> 
    /// <p>You must specify either a <code>VolumeSize</code> or a <code>SnapshotId</code>.</p>
...
pub struct InstanceRefresh  {
    ...
    #[doc(hidden)]pub instance_refresh_id: std::option::Option<std::string::String>,
    /// <p>The name of the Auto Scaling group.</p>
    #[doc(hidden)]pub auto_scaling_group_name: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::InstanceRefreshStatus>,
    /// <p>Provides more details about the current status of the instance refresh. </p>
    #[doc(hidden)]pub status_reason: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub percentage_complete: std::option::Option<i32>,
    /// <p>The number of instances remaining to update before the instance refresh is complete.</p>
    #[doc(hidden)]pub instances_to_update: std::option::Option<i32>,
    /// <p>Additional progress details for an Auto Scaling group that has a warm pool.</p>
    #[doc(hidden)]pub progress_details: std::option::Option<crate::model::InstanceRefreshProgressDetails>,
    /// <p>Describes the preferences for an instance refresh.</p>
    #[doc(hidden)]pub preferences: std::option::Option<crate::model::RefreshPreferences>,
    /// <p>Describes the specific update you want to deploy.</p>
    #[doc(hidden)]pub desired_configuration: std::option::Option<crate::model::DesiredConfiguration>,
}
...
pub struct InstanceRefreshProgressDetails  {
    ...
    #[doc(hidden)]pub live_pool_progress: std::option::Option<crate::model::InstanceRefreshLivePoolProgress>,
    /// <p>Indicates the progress of an instance refresh on instances that are in the warm pool.</p>
    #[doc(hidden)]pub warm_pool_progress: std::option::Option<crate::model::InstanceRefreshWarmPoolProgress>,
}
...
pub struct AutoScalingInstanceDetails  {
    ...
    #[doc(hidden)]pub lifecycle_state: std::option::Option<std::string::String>,
...
pub struct AutoScalingGroup  {
    ...
    #[doc(hidden)]pub predicted_capacity: std::option::Option<i32>,
    /// <p>The duration of the default cooldown period, in seconds.</p>
    #[doc(hidden)]pub default_cooldown: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub target_group_ar_ns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub health_check_type: std::option::Option<std::string::String>,
    /// <p>The duration of the health check grace period, in seconds.</p>
    #[doc(hidden)]pub health_check_grace_period: std::option::Option<i32>,
    /// <p>The EC2 instances associated with the group.</p>
    #[doc(hidden)]pub instances: std::option::Option<std::vec::Vec<crate::model::Instance>>,
    /// <p>The date and time the group was created.</p>
    #[doc(hidden)]pub created_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The suspended processes associated with the group.</p>
    #[doc(hidden)]pub suspended_processes: std::option::Option<std::vec::Vec<crate::model::SuspendedProcess>>,
    /// <p>The name of the placement group into which to launch your instances, if any.</p>
    #[doc(hidden)]pub placement_group: std::option::Option<std::string::String>,
    /// <p>One or more subnet IDs, if applicable, separated by commas.</p>
    #[doc(hidden)]pub vpc_zone_identifier: std::option::Option<std::string::String>,
    /// <p>The metrics enabled for the group.</p>
    #[doc(hidden)]pub enabled_metrics: std::option::Option<std::vec::Vec<crate::model::EnabledMetric>>,
    ...
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<crate::model::TagDescription>>,
    /// <p>The termination policies for the group.</p>
    #[doc(hidden)]pub termination_policies: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Indicates whether newly launched instances are protected from termination by Amazon EC2 Auto Scaling when scaling in.</p>
    #[doc(hidden)]pub new_instances_protected_from_scale_in: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub service_linked_role_arn: std::option::Option<std::string::String>,
    /// <p>The maximum amount of time, in seconds, that an instance can be in service.</p> 
    /// <p>Valid Range: Minimum value of 0.</p>
    #[doc(hidden)]pub max_instance_lifetime: std::option::Option<i32>,
    /// <p>Indicates whether Capacity Rebalancing is enabled.</p>
    #[doc(hidden)]pub capacity_rebalance: std::option::Option<bool>,
    /// <p>The warm pool for the group.</p>
    #[doc(hidden)]pub warm_pool_configuration: std::option::Option<crate::model::WarmPoolConfiguration>,
    /// <p>The current size of the warm pool.</p>
    #[doc(hidden)]pub warm_pool_size: std::option::Option<i32>,
    /// <p>Reserved.</p>
    #[doc(hidden)]pub context: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub desired_capacity_type: std::option::Option<std::string::String>,
    /// <p>The duration of the default instance warmup, in seconds.</p>
    #[doc(hidden)]pub default_instance_warmup: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for AutoScalingGroup  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("new_instances_protected_from_scale_in", &self.new_instances_protected_from_scale_in);
...
pub struct SuspendedProcess  {
    ...
    #[doc(hidden)]pub suspension_reason: std::option::Option<std::string::String>,
}
...
pub struct FailedScheduledUpdateGroupActionRequest  {
    ...
    #[doc(hidden)]pub scheduled_action_name: std::option::Option<std::string::String>,
    /// <p>The error code.</p>
    #[doc(hidden)]pub error_code: std::option::Option<std::string::String>,
