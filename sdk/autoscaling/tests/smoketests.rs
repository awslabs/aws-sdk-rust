...
/// Smoke tests for the `describe_scaling_process_types` operation
#[::tokio::test]
async fn test_describe_scaling_process_types_success() {
    ...
    let res = client.describe_scaling_process_types().send().await;
