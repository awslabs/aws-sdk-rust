    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CancelJournalKinesisStreamInput`](crate::input::CancelJournalKinesisStreamInput) with field(s):
    ///   - [`ledger_name(Option<String>)`](crate::input::CancelJournalKinesisStreamInput::ledger_name): <p>The name of the ledger.</p>
    ///   - [`stream_id(Option<String>)`](crate::input::CancelJournalKinesisStreamInput::stream_id): <p>The UUID (represented in Base62-encoded text) of the QLDB journal stream to be canceled.</p>
    ...
    ///
    /// - Takes [`DeleteLedgerInput`](crate::input::DeleteLedgerInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::DeleteLedgerInput::name): <p>The name of the ledger that you want to delete.</p>
    ...
    ///
    /// - Takes [`DescribeJournalKinesisStreamInput`](crate::input::DescribeJournalKinesisStreamInput) with field(s):
    ///   - [`ledger_name(Option<String>)`](crate::input::DescribeJournalKinesisStreamInput::ledger_name): <p>The name of the ledger.</p>
    ///   - [`stream_id(Option<String>)`](crate::input::DescribeJournalKinesisStreamInput::stream_id): <p>The UUID (represented in Base62-encoded text) of the QLDB journal stream to describe.</p>
    ...
    ///
    /// - Takes [`DescribeJournalS3ExportInput`](crate::input::DescribeJournalS3ExportInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::DescribeJournalS3ExportInput::name): <p>The name of the ledger.</p>
    ///   - [`export_id(Option<String>)`](crate::input::DescribeJournalS3ExportInput::export_id): <p>The UUID (represented in Base62-encoded text) of the journal export job to describe.</p>
    ...
    ///
    /// - Takes [`DescribeLedgerInput`](crate::input::DescribeLedgerInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::DescribeLedgerInput::name): <p>The name of the ledger that you want to describe.</p>
    ...
    ///
    /// - Takes [`GetBlockInput`](crate::input::GetBlockInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::GetBlockInput::name): <p>The name of the ledger.</p>
    ///   - [`block_address(Option<ValueHolder>)`](crate::input::GetBlockInput::block_address): <p>The location of the block that you want to request. An address is an Amazon Ion structure that has two fields: <code>strandId</code> and <code>sequenceNo</code>.</p>  <p>For example: <code>{strandId:"BlFTjlSXze9BIh1KOszcE3",sequenceNo:14}</code>.</p>
    ///   - [`digest_tip_address(Option<ValueHolder>)`](crate::input::GetBlockInput::digest_tip_address): <p>The latest block location covered by the digest for which to request a proof. An address is an Amazon Ion structure that has two fields: <code>strandId</code> and <code>sequenceNo</code>.</p>  <p>For example: <code>{strandId:"BlFTjlSXze9BIh1KOszcE3",sequenceNo:49}</code>.</p>
    ...
    ///
    /// - Takes [`GetDigestInput`](crate::input::GetDigestInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::GetDigestInput::name): <p>The name of the ledger.</p>
    ...
    ///   - [`name(Option<String>)`](crate::input::GetRevisionInput::name): <p>The name of the ledger.</p>
    ///   - [`block_address(Option<ValueHolder>)`](crate::input::GetRevisionInput::block_address): <p>The block location of the document revision to be verified. An address is an Amazon Ion structure that has two fields: <code>strandId</code> and <code>sequenceNo</code>.</p>  <p>For example: <code>{strandId:"BlFTjlSXze9BIh1KOszcE3",sequenceNo:14}</code>.</p>
    ///   - [`document_id(Option<String>)`](crate::input::GetRevisionInput::document_id): <p>The UUID (represented in Base62-encoded text) of the document to be verified.</p>
    ///   - [`digest_tip_address(Option<ValueHolder>)`](crate::input::GetRevisionInput::digest_tip_address): <p>The latest block location covered by the digest for which to request a proof. An address is an Amazon Ion structure that has two fields: <code>strandId</code> and <code>sequenceNo</code>.</p>  <p>For example: <code>{strandId:"BlFTjlSXze9BIh1KOszcE3",sequenceNo:49}</code>.</p>
    ...
    ///
    /// - Takes [`ListJournalKinesisStreamsForLedgerInput`](crate::input::ListJournalKinesisStreamsForLedgerInput) with field(s):
    ///   - [`ledger_name(Option<String>)`](crate::input::ListJournalKinesisStreamsForLedgerInput::ledger_name): <p>The name of the ledger.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListJournalKinesisStreamsForLedgerInput::max_results): <p>The maximum number of results to return in a single <code>ListJournalKinesisStreamsForLedger</code> request. (The actual number of results returned might be fewer.)</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListJournalKinesisStreamsForLedgerInput::next_token): <p>A pagination token, indicating that you want to retrieve the next page of results. If you received a value for <code>NextToken</code> in the response from a previous <code>ListJournalKinesisStreamsForLedger</code> call, you should use that value as input here.</p>
    ...
    ///
    /// - Takes [`ListJournalS3ExportsInput`](crate::input::ListJournalS3ExportsInput) with field(s):
    ///   - [`max_results(Option<i32>)`](crate::input::ListJournalS3ExportsInput::max_results): <p>The maximum number of results to return in a single <code>ListJournalS3Exports</code> request. (The actual number of results returned might be fewer.)</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListJournalS3ExportsInput::next_token): <p>A pagination token, indicating that you want to retrieve the next page of results. If you received a value for <code>NextToken</code> in the response from a previous <code>ListJournalS3Exports</code> call, then you should use that value as input here.</p>
    ...
    ///
    /// - Takes [`ListJournalS3ExportsForLedgerInput`](crate::input::ListJournalS3ExportsForLedgerInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::ListJournalS3ExportsForLedgerInput::name): <p>The name of the ledger.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListJournalS3ExportsForLedgerInput::max_results): <p>The maximum number of results to return in a single <code>ListJournalS3ExportsForLedger</code> request. (The actual number of results returned might be fewer.)</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListJournalS3ExportsForLedgerInput::next_token): <p>A pagination token, indicating that you want to retrieve the next page of results. If you received a value for <code>NextToken</code> in the response from a previous <code>ListJournalS3ExportsForLedger</code> call, then you should use that value as input here.</p>
    ...
    ///
    /// - Takes [`ListLedgersInput`](crate::input::ListLedgersInput) with field(s):
    ///   - [`max_results(Option<i32>)`](crate::input::ListLedgersInput::max_results): <p>The maximum number of results to return in a single <code>ListLedgers</code> request. (The actual number of results returned might be fewer.)</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListLedgersInput::next_token): <p>A pagination token, indicating that you want to retrieve the next page of results. If you received a value for <code>NextToken</code> in the response from a previous <code>ListLedgers</code> call, then you should use that value as input here.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) for which to list the tags. For example:</p>  <p> <code>arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger</code> </p>
    ...
    ///
    /// - Takes [`StreamJournalToKinesisInput`](crate::input::StreamJournalToKinesisInput) with field(s):
    ///   - [`ledger_name(Option<String>)`](crate::input::StreamJournalToKinesisInput::ledger_name): <p>The name of the ledger.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::StreamJournalToKinesisInput::role_arn): <p>The Amazon Resource Name (ARN) of the IAM role that grants QLDB permissions for a journal stream to write data records to a Kinesis Data Streams resource.</p>  <p>To pass a role to QLDB when requesting a journal stream, you must have permissions to perform the <code>iam:PassRole</code> action on the IAM role resource. This is required for all journal stream requests.</p>
    ///   - [`tags(Option<HashMap<String, Option<String>>>)`](crate::input::StreamJournalToKinesisInput::tags): <p>The key-value pairs to add as tags to the stream that you want to create. Tag keys are case sensitive. Tag values are case sensitive and can be null.</p>
    ///   - [`inclusive_start_time(Option<DateTime>)`](crate::input::StreamJournalToKinesisInput::inclusive_start_time): <p>The inclusive start date and time from which to start streaming journal data. This parameter must be in <code>ISO 8601</code> date and time format and in Universal Coordinated Time (UTC). For example: <code>2019-06-13T21:36:34Z</code>.</p>  <p>The <code>InclusiveStartTime</code> cannot be in the future and must be before <code>ExclusiveEndTime</code>.</p>  <p>If you provide an <code>InclusiveStartTime</code> that is before the ledger's <code>CreationDateTime</code>, QLDB effectively defaults it to the ledger's <code>CreationDateTime</code>.</p>
    ///   - [`exclusive_end_time(Option<DateTime>)`](crate::input::StreamJournalToKinesisInput::exclusive_end_time): <p>The exclusive date and time that specifies when the stream ends. If you don't define this parameter, the stream runs indefinitely until you cancel it.</p>  <p>The <code>ExclusiveEndTime</code> must be in <code>ISO 8601</code> date and time format and in Universal Coordinated Time (UTC). For example: <code>2019-06-13T21:36:34Z</code>.</p>
    ///   - [`kinesis_configuration(Option<KinesisConfiguration>)`](crate::input::StreamJournalToKinesisInput::kinesis_configuration): <p>The configuration settings of the Kinesis Data Streams destination for your stream request.</p>
    ///   - [`stream_name(Option<String>)`](crate::input::StreamJournalToKinesisInput::stream_name): <p>The name that you want to assign to the QLDB journal stream. User-defined names can help identify and indicate the purpose of a stream.</p>  <p>Your stream name must be unique among other <i>active</i> streams for a given ledger. Stream names have the same naming constraints as ledger names, as defined in <a href="https://docs.aws.amazon.com/qldb/latest/developerguide/limits.html#limits.naming">Quotas in Amazon QLDB</a> in the <i>Amazon QLDB Developer Guide</i>.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) to which you want to add the tags. For example:</p>  <p> <code>arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger</code> </p>
    ///   - [`tags(Option<HashMap<String, Option<String>>>)`](crate::input::TagResourceInput::tags): <p>The key-value pairs to add as tags to the specified QLDB resource. Tag keys are case sensitive. If you specify a key that already exists for the resource, your request fails and returns an error. Tag values are case sensitive and can be null.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) from which to remove the tags. For example:</p>  <p> <code>arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger</code> </p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>The list of tag keys to remove.</p>
    ...
    ///
    /// - Takes [`UpdateLedgerInput`](crate::input::UpdateLedgerInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::UpdateLedgerInput::name): <p>The name of the ledger.</p>
    ///   - [`deletion_protection(Option<bool>)`](crate::input::UpdateLedgerInput::deletion_protection): <p>The flag that prevents a ledger from being deleted by any user. If not provided on ledger creation, this feature is enabled (<code>true</code>) by default.</p>  <p>If deletion protection is enabled, you must first disable it before you can delete the ledger. You can disable it by calling the <code>UpdateLedger</code> operation to set the flag to <code>false</code>.</p>
    ///   - [`kms_key(Option<String>)`](crate::input::UpdateLedgerInput::kms_key): <p>The key in Key Management Service (KMS) to use for encryption of data at rest in the ledger. For more information, see <a href="https://docs.aws.amazon.com/qldb/latest/developerguide/encryption-at-rest.html">Encryption at rest</a> in the <i>Amazon QLDB Developer Guide</i>.</p>  <p>Use one of the following options to specify this parameter:</p>  <ul>   <li> <p> <code>AWS_OWNED_KMS_KEY</code>: Use an KMS key that is owned and managed by Amazon Web Services on your behalf.</p> </li>   <li> <p> <b>Undefined</b>: Make no changes to the KMS key of the ledger.</p> </li>   <li> <p> <b>A valid symmetric customer managed KMS key</b>: Use the specified KMS key in your account that you create, own, and manage.</p> <p>Amazon QLDB does not support asymmetric keys. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/symmetric-asymmetric.html">Using symmetric and asymmetric keys</a> in the <i>Key Management Service Developer Guide</i>.</p> </li>  </ul>  <p>To specify a customer managed KMS key, you can use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. When using an alias name, prefix it with <code>"alias/"</code>. To specify a key in a different Amazon Web Services account, you must use the key ARN or alias ARN.</p>  <p>For example:</p>  <ul>   <li> <p>Key ID: <code>1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>   <li> <p>Key ARN: <code>arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>   <li> <p>Alias name: <code>alias/ExampleAlias</code> </p> </li>   <li> <p>Alias ARN: <code>arn:aws:kms:us-east-2:111122223333:alias/ExampleAlias</code> </p> </li>  </ul>  <p>For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id">Key identifiers (KeyId)</a> in the <i>Key Management Service Developer Guide</i>.</p>
    ...
    ///
    /// - Takes [`UpdateLedgerPermissionsModeInput`](crate::input::UpdateLedgerPermissionsModeInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::UpdateLedgerPermissionsModeInput::name): <p>The name of the ledger.</p>
    ///   - [`permissions_mode(Option<PermissionsMode>)`](crate::input::UpdateLedgerPermissionsModeInput::permissions_mode): <p>The permissions mode to assign to the ledger. This parameter can have one of the following values:</p>  <ul>   <li> <p> <code>ALLOW_ALL</code>: A legacy permissions mode that enables access control with API-level granularity for ledgers.</p> <p>This mode allows users who have the <code>SendCommand</code> API permission for this ledger to run all PartiQL commands (hence, <code>ALLOW_ALL</code>) on any tables in the specified ledger. This mode disregards any table-level or command-level IAM permissions policies that you create for the ledger.</p> </li>   <li> <p> <code>STANDARD</code>: (<i>Recommended</i>) A permissions mode that enables access control with finer granularity for ledgers, tables, and PartiQL commands.</p> <p>By default, this mode denies all user requests to run any PartiQL commands on any tables in this ledger. To allow PartiQL commands to run, you must create IAM permissions policies for specific table resources and PartiQL actions, in addition to the <code>SendCommand</code> API permission for the ledger. For information, see <a href="https://docs.aws.amazon.com/qldb/latest/developerguide/getting-started-standard-mode.html">Getting started with the standard permissions mode</a> in the <i>Amazon QLDB Developer Guide</i>.</p> </li>  </ul> <note>   <p>We strongly recommend using the <code>STANDARD</code> permissions mode to maximize the security of your ledger data.</p>  </note>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::ListJournalKinesisStreamsForLedgerPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListJournalS3ExportsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::ListJournalS3ExportsForLedgerPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListLedgersPaginator<C, M, R> {
