...
pub struct LedgerEncryptionDescription  {
    ...
    #[doc(hidden)]pub kms_key_arn: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub encryption_status: std::option::Option<crate::model::EncryptionStatus>,
    ...
    #[doc(hidden)]pub inaccessible_kms_key_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
impl  std::fmt::Debug for LedgerEncryptionDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("inaccessible_kms_key_date_time", &self.inaccessible_kms_key_date_time);
        formatter.finish()
    }
}
...
pub struct KinesisConfiguration  {
    ...
    #[doc(hidden)]pub aggregation_enabled: std::option::Option<bool>,
}
...
pub struct LedgerSummary  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::LedgerState>,
    ...
    #[doc(hidden)]pub creation_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl LedgerSummary {
    /// <p>The name of the ledger.</p>
...
pub struct JournalS3ExportDescription  {
    /// <p>The name of the ledger.</p>
    #[doc(hidden)]pub ledger_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub export_creation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The current state of the journal export job.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ExportStatus>,
    ...
    #[doc(hidden)]pub inclusive_start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The exclusive end date and time for the range of journal contents that was specified in the original export request.</p>
    #[doc(hidden)]pub exclusive_end_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub s3_export_configuration: std::option::Option<crate::model::S3ExportConfiguration>,
...
pub struct S3ExportConfiguration  {
    ...
    #[doc(hidden)]pub bucket: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub encryption_configuration: std::option::Option<crate::model::S3EncryptionConfiguration>,
}
...
pub struct S3EncryptionConfiguration  {
    ...
    #[doc(hidden)]pub object_encryption_type: std::option::Option<crate::model::S3ObjectEncryptionType>,
...
pub struct JournalKinesisStreamDescription  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::StreamStatus>,
    /// <p>The configuration settings of the Amazon Kinesis Data Streams destination for a QLDB journal stream.</p>
    #[doc(hidden)]pub kinesis_configuration: std::option::Option<crate::model::KinesisConfiguration>,
    ...
    #[doc(hidden)]pub error_cause: std::option::Option<crate::model::ErrorCause>,
...
pub struct ValueHolder  {
    ...
    #[doc(hidden)]pub ion_text: std::option::Option<std::string::String>,
}
impl ValueHolder {
    /// <p>An Amazon Ion plaintext value contained in a <code>ValueHolder</code> structure.</p>
