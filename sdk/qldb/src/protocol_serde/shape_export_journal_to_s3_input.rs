...
pub fn ser_export_journal_to_s3_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ExportJournalToS3Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
