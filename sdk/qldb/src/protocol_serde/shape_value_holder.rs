...
pub(crate) fn de_value_holder<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ValueHolder>, aws_smithy_json::deserialize::error::DeserializeError>
