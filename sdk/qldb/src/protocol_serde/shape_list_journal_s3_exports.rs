...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_journal_s3_exports_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_journal_s3_exports::de_list_journal_s3_exports(_response_body, output)
            .map_err(crate::operation::list_journal_s3_exports::ListJournalS3ExportsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "JournalS3Exports" => {
                    builder = builder.set_journal_s3_exports(crate::protocol_serde::shape_journal_s3_export_list::de_journal_s3_export_list(tokens)?);
                }
                "NextToken" => {
