...
pub fn serialize_structure_export_journal_to_s3_input(
    ...
    if let Some(var_13) = &input.s3_export_configuration {
        ...
        crate::json_ser::serialize_structure_s3_export_configuration(&mut object_14, var_13);
        object_14.finish();
    }
}
...
pub fn serialize_structure_get_block_input(
    ...
    if let Some(var_15) = &input.block_address {
        ...
        crate::json_ser::serialize_structure_value_holder(&mut object_16, var_15);
        object_16.finish();
    }
    if let Some(var_17) = &input.digest_tip_address {
        let mut object_18 = object.key("DigestTipAddress").start_object();
        crate::json_ser::serialize_structure_value_holder(&mut object_18, var_17);
        object_18.finish();
    }
}
...
pub fn serialize_structure_get_revision_input(
    ...
    if let Some(var_19) = &input.block_address {
        ...
        crate::json_ser::serialize_structure_value_holder(&mut object_20, var_19);
        object_20.finish();
    }
...
pub fn serialize_structure_stream_journal_to_kinesis_input(
    ...
    if let Some(var_26) = &input.kinesis_configuration {
        ...
        crate::json_ser::serialize_structure_kinesis_configuration(&mut object_27, var_26);
        object_27.finish();
    }
...
pub fn serialize_structure_s3_export_configuration(
    ...
    if let Some(var_45) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_s3_encryption_configuration(&mut object_46, var_45);
        object_46.finish();
    }
}
