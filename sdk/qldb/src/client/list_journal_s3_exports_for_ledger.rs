...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::set_name): <p>The name of the ledger.</p>
