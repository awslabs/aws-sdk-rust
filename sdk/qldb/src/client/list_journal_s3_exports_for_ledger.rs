...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::set_name): <p>The name of the ledger.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_journal_s3_exports_for_ledger::builders::ListJournalS3ExportsForLedgerFluentBuilder::set_next_token): <p>A pagination token, indicating that you want to retrieve the next page of results. If you received a value for <code>NextToken</code> in the response from a previous <code>ListJournalS3ExportsForLedger</code> call, then you should use that value as input here.</p>
