...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_digest::builders::GetDigestFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_digest::builders::GetDigestFluentBuilder::set_name):<br>required: **true**<br><p>The name of the ledger.</p><br>
                            /// - On success, responds with [`GetDigestOutput`](crate::operation::get_digest::GetDigestOutput) with field(s):
    ///   - [`digest(Blob)`](crate::operation::get_digest::GetDigestOutput::digest): <p>The 256-bit hash value representing the digest returned by a <code>GetDigest</code> request.</p>
