...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_block::builders::GetBlockFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_block::builders::GetBlockFluentBuilder::set_name): <p>The name of the ledger.</p>
