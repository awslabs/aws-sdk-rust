...
impl DeleteLedgerFluentBuilder  {
    /// Creates a new `DeleteLedger`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_ledger::DeleteLedgerOutput, aws_smithy_http::result::SdkError<crate::operation::delete_ledger::DeleteLedgerError>>
                     {
