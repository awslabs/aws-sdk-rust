...
impl CreateLedgerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_ledger::CreateLedger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ledger::ser_create_ledger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLedger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ledger::de_create_ledger_http_response_with_props(status, headers, body)
        }
    }
}
