...
impl ListJournalS3ExportsForLedgerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_journal_s3_exports_for_ledger::ListJournalS3ExportsForLedger::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListJournalS3ExportsForLedger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_journal_s3_exports_for_ledger::de_list_journal_s3_exports_for_ledger_http_response_with_props(
                status, headers, body,
            )
        }
    }
