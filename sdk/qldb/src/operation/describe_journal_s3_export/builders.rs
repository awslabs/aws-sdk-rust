...
impl DescribeJournalS3ExportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_journal_s3_export::DescribeJournalS3ExportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_journal_s3_export::DescribeJournalS3ExportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_journal_s3_export::DescribeJournalS3ExportOutput, crate::operation::describe_journal_s3_export::DescribeJournalS3ExportError, Self> {
