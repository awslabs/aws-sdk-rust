...
impl UpdateLedgerPermissionsModeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsModeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsModeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsModeOutput, crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsModeError, Self> {
