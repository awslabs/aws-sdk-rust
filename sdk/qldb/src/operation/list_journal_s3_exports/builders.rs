...
impl ListJournalS3ExportsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_journal_s3_exports::ListJournalS3ExportsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_journal_s3_exports::ListJournalS3ExportsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_journal_s3_exports::ListJournalS3ExportsOutput, crate::operation::list_journal_s3_exports::ListJournalS3ExportsError, Self> {
