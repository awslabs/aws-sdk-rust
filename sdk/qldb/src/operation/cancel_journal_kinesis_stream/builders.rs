...
impl CancelJournalKinesisStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_journal_kinesis_stream::CancelJournalKinesisStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_journal_kinesis_stream::CancelJournalKinesisStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_journal_kinesis_stream::CancelJournalKinesisStreamOutput, crate::operation::cancel_journal_kinesis_stream::CancelJournalKinesisStreamError, Self> {
