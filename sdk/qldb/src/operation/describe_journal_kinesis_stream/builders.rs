...
impl crate::operation::describe_journal_kinesis_stream::builders::DescribeJournalKinesisStreamInputBuilder {
...
impl DescribeJournalKinesisStreamFluentBuilder {
    /// Creates a new `DescribeJournalKinesisStreamFluentBuilder`.
