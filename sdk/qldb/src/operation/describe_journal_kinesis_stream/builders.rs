...
impl DescribeJournalKinesisStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_journal_kinesis_stream::DescribeJournalKinesisStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_journal_kinesis_stream::DescribeJournalKinesisStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_journal_kinesis_stream::DescribeJournalKinesisStreamOutput, crate::operation::describe_journal_kinesis_stream::DescribeJournalKinesisStreamError, Self> {
