...
impl UpdateLedgerPermissionsModeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsMode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLedgerPermissionsMode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_ledger_permissions_mode::de_update_ledger_permissions_mode_http_response_with_props(
                status, headers, body,
            )
        }
    }
