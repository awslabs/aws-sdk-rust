...
impl crate::operation::list_journal_kinesis_streams_for_ledger::builders::ListJournalKinesisStreamsForLedgerInputBuilder {
...
impl ListJournalKinesisStreamsForLedgerFluentBuilder {
    /// Creates a new `ListJournalKinesisStreamsForLedgerFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_journal_kinesis_streams_for_ledger::ListJournalKinesisStreamsForLedger::operation_runtime_plugins(
    ...
    pub fn into_paginator(self) -> crate::operation::list_journal_kinesis_streams_for_ledger::paginator::ListJournalKinesisStreamsForLedgerPaginator {
        crate::operation::list_journal_kinesis_streams_for_ledger::paginator::ListJournalKinesisStreamsForLedgerPaginator::new(
            self.handle,
            self.inner,
        )
    }
