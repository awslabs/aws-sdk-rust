                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "text" => Some(crate::types::PromptTemplateConfiguration::Text(
                            crate::protocol_serde::shape_text_prompt_template_configuration::de_text_prompt_template_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                        ...
                        "chat" => Some(crate::types::PromptTemplateConfiguration::Chat(
                            crate::protocol_serde::shape_chat_prompt_template_configuration::de_chat_prompt_template_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
