...
pub fn ser_list_ingestion_jobs_input_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_ingestion_job_filter::ser_ingestion_job_filter(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_7) = &input.sort_by {
        ...
        crate::protocol_serde::shape_ingestion_job_sort_by::ser_ingestion_job_sort_by(&mut object_8, var_7)?;
        object_8.finish();
    }
    Ok(())
}
