...
pub fn ser_mongo_db_atlas_configuration(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::MongoDbAtlasConfiguration,
    ...
    if let Some(var_1) = &input.field_mapping {
        ...
        crate::protocol_serde::shape_mongo_db_atlas_field_mapping::ser_mongo_db_atlas_field_mapping(&mut object_2, var_1)?;
        object_2.finish();
    }
...
) -> Result<Option<crate::types::MongoDbAtlasConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::MongoDbAtlasConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::mongo_db_atlas_configuration_correct_errors(builder)
                    .build()
