                    ...
                    variant = match key.as_ref() {
                            "cyclicConnection" => {
                                Some(crate::types::FlowValidationDetails::CyclicConnection(
                                    crate::protocol_serde::shape_cyclic_connection_flow_validation_details::de_cyclic_connection_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "duplicateConnections" => {
                                Some(crate::types::FlowValidationDetails::DuplicateConnections(
                                    crate::protocol_serde::shape_duplicate_connections_flow_validation_details::de_duplicate_connections_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "duplicateConditionExpression" => {
                                Some(crate::types::FlowValidationDetails::DuplicateConditionExpression(
                                    crate::protocol_serde::shape_duplicate_condition_expression_flow_validation_details::de_duplicate_condition_expression_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unreachableNode" => {
                                Some(crate::types::FlowValidationDetails::UnreachableNode(
                                    crate::protocol_serde::shape_unreachable_node_flow_validation_details::de_unreachable_node_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownConnectionSource" => {
                                Some(crate::types::FlowValidationDetails::UnknownConnectionSource(
                                    crate::protocol_serde::shape_unknown_connection_source_flow_validation_details::de_unknown_connection_source_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownConnectionSourceOutput" => {
                                Some(crate::types::FlowValidationDetails::UnknownConnectionSourceOutput(
                                    crate::protocol_serde::shape_unknown_connection_source_output_flow_validation_details::de_unknown_connection_source_output_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownConnectionTarget" => {
                                Some(crate::types::FlowValidationDetails::UnknownConnectionTarget(
                                    crate::protocol_serde::shape_unknown_connection_target_flow_validation_details::de_unknown_connection_target_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownConnectionTargetInput" => {
                                Some(crate::types::FlowValidationDetails::UnknownConnectionTargetInput(
                                    crate::protocol_serde::shape_unknown_connection_target_input_flow_validation_details::de_unknown_connection_target_input_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownConnectionCondition" => {
                                Some(crate::types::FlowValidationDetails::UnknownConnectionCondition(
                                    crate::protocol_serde::shape_unknown_connection_condition_flow_validation_details::de_unknown_connection_condition_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "malformedConditionExpression" => {
                                Some(crate::types::FlowValidationDetails::MalformedConditionExpression(
                                    crate::protocol_serde::shape_malformed_condition_expression_flow_validation_details::de_malformed_condition_expression_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "malformedNodeInputExpression" => {
                                Some(crate::types::FlowValidationDetails::MalformedNodeInputExpression(
                                    crate::protocol_serde::shape_malformed_node_input_expression_flow_validation_details::de_malformed_node_input_expression_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "mismatchedNodeInputType" => {
                                Some(crate::types::FlowValidationDetails::MismatchedNodeInputType(
                                    crate::protocol_serde::shape_mismatched_node_input_type_flow_validation_details::de_mismatched_node_input_type_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "mismatchedNodeOutputType" => {
                                Some(crate::types::FlowValidationDetails::MismatchedNodeOutputType(
                                    crate::protocol_serde::shape_mismatched_node_output_type_flow_validation_details::de_mismatched_node_output_type_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "incompatibleConnectionDataType" => {
                                Some(crate::types::FlowValidationDetails::IncompatibleConnectionDataType(
                                    crate::protocol_serde::shape_incompatible_connection_data_type_flow_validation_details::de_incompatible_connection_data_type_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingConnectionConfiguration" => {
                                Some(crate::types::FlowValidationDetails::MissingConnectionConfiguration(
                                    crate::protocol_serde::shape_missing_connection_configuration_flow_validation_details::de_missing_connection_configuration_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingDefaultCondition" => {
                                Some(crate::types::FlowValidationDetails::MissingDefaultCondition(
                                    crate::protocol_serde::shape_missing_default_condition_flow_validation_details::de_missing_default_condition_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingEndingNodes" => {
                                Some(crate::types::FlowValidationDetails::MissingEndingNodes(
                                    crate::protocol_serde::shape_missing_ending_nodes_flow_validation_details::de_missing_ending_nodes_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingNodeConfiguration" => {
                                Some(crate::types::FlowValidationDetails::MissingNodeConfiguration(
                                    crate::protocol_serde::shape_missing_node_configuration_flow_validation_details::de_missing_node_configuration_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingNodeInput" => {
                                Some(crate::types::FlowValidationDetails::MissingNodeInput(
                                    crate::protocol_serde::shape_missing_node_input_flow_validation_details::de_missing_node_input_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingNodeOutput" => {
                                Some(crate::types::FlowValidationDetails::MissingNodeOutput(
                                    crate::protocol_serde::shape_missing_node_output_flow_validation_details::de_missing_node_output_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingStartingNodes" => {
                                Some(crate::types::FlowValidationDetails::MissingStartingNodes(
                                    crate::protocol_serde::shape_missing_starting_nodes_flow_validation_details::de_missing_starting_nodes_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "multipleNodeInputConnections" => {
                                Some(crate::types::FlowValidationDetails::MultipleNodeInputConnections(
                                    crate::protocol_serde::shape_multiple_node_input_connections_flow_validation_details::de_multiple_node_input_connections_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unfulfilledNodeInput" => {
                                Some(crate::types::FlowValidationDetails::UnfulfilledNodeInput(
                                    crate::protocol_serde::shape_unfulfilled_node_input_flow_validation_details::de_unfulfilled_node_input_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unsatisfiedConnectionConditions" => {
                                Some(crate::types::FlowValidationDetails::UnsatisfiedConnectionConditions(
                                    crate::protocol_serde::shape_unsatisfied_connection_conditions_flow_validation_details::de_unsatisfied_connection_conditions_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unspecified" => {
                                Some(crate::types::FlowValidationDetails::Unspecified(
                                    crate::protocol_serde::shape_unspecified_flow_validation_details::de_unspecified_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownNodeInput" => {
                                Some(crate::types::FlowValidationDetails::UnknownNodeInput(
                                    crate::protocol_serde::shape_unknown_node_input_flow_validation_details::de_unknown_node_input_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "unknownNodeOutput" => {
                                Some(crate::types::FlowValidationDetails::UnknownNodeOutput(
                                    crate::protocol_serde::shape_unknown_node_output_flow_validation_details::de_unknown_node_output_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingLoopInputNode" => {
                                Some(crate::types::FlowValidationDetails::MissingLoopInputNode(
                                    crate::protocol_serde::shape_missing_loop_input_node_flow_validation_details::de_missing_loop_input_node_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "missingLoopControllerNode" => {
                                Some(crate::types::FlowValidationDetails::MissingLoopControllerNode(
                                    crate::protocol_serde::shape_missing_loop_controller_node_flow_validation_details::de_missing_loop_controller_node_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "multipleLoopInputNodes" => {
                                Some(crate::types::FlowValidationDetails::MultipleLoopInputNodes(
                                    crate::protocol_serde::shape_multiple_loop_input_nodes_flow_validation_details::de_multiple_loop_input_nodes_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "multipleLoopControllerNodes" => {
                                Some(crate::types::FlowValidationDetails::MultipleLoopControllerNodes(
                                    crate::protocol_serde::shape_multiple_loop_controller_nodes_flow_validation_details::de_multiple_loop_controller_nodes_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "loopIncompatibleNodeType" => {
                                Some(crate::types::FlowValidationDetails::LoopIncompatibleNodeType(
                                    crate::protocol_serde::shape_loop_incompatible_node_type_flow_validation_details::de_loop_incompatible_node_type_flow_validation_details(tokens, _value, depth + 1)?
                            ...
                            "invalidLoopBoundary" => {
                                Some(crate::types::FlowValidationDetails::InvalidLoopBoundary(
                                    crate::protocol_serde::shape_invalid_loop_boundary_flow_validation_details::de_invalid_loop_boundary_flow_validation_details(tokens, _value, depth + 1)?
