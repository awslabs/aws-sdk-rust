...
pub(crate) fn de_prompt_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PromptConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "promptState" => {
                                builder = builder.set_prompt_state(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::PromptState::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
