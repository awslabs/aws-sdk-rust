...
pub fn ser_flow_connection(
    ...
    if let Some(var_1) = &input.configuration {
        ...
        crate::protocol_serde::shape_flow_connection_configuration::ser_flow_connection_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::FlowConnectionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::FlowConnectionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "name" => {
                        ...
                        "configuration" => {
                            builder = builder.set_configuration(
                                crate::protocol_serde::shape_flow_connection_configuration::de_flow_connection_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(crate::serde_util::flow_connection_correct_errors(builder).build().map_err(
