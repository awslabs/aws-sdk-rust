...
) -> Result<Option<crate::types::FlowAliasSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::FlowAliasSummaryBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(crate::serde_util::flow_alias_summary_correct_errors(builder).build().map_err(
