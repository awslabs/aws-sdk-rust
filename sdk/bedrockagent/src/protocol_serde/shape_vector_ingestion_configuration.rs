...
pub(crate) fn de_vector_ingestion_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VectorIngestionConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "chunkingConfiguration" => {
                                builder = builder.set_chunking_configuration(
                                    crate::protocol_serde::shape_chunking_configuration::de_chunking_configuration(tokens)?
                                );
                            }
