                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "input" => Some(crate::types::FlowNodeConfiguration::Input(
                            crate::protocol_serde::shape_input_flow_node_configuration::de_input_flow_node_configuration(tokens, _value, depth + 1)?
                        ...
                        "output" => Some(crate::types::FlowNodeConfiguration::Output(
                            crate::protocol_serde::shape_output_flow_node_configuration::de_output_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'output' cannot be null"))?,
                        )),
                        ...
                        "condition" => Some(crate::types::FlowNodeConfiguration::Condition(
                            crate::protocol_serde::shape_condition_flow_node_configuration::de_condition_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                        ...
                        "lex" => Some(crate::types::FlowNodeConfiguration::Lex(
                            crate::protocol_serde::shape_lex_flow_node_configuration::de_lex_flow_node_configuration(tokens, _value, depth + 1)?
                        ...
                        "prompt" => Some(crate::types::FlowNodeConfiguration::Prompt(
                            crate::protocol_serde::shape_prompt_flow_node_configuration::de_prompt_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'prompt' cannot be null"))?,
                        )),
                        ...
                        "storage" => Some(crate::types::FlowNodeConfiguration::Storage(
                            crate::protocol_serde::shape_storage_flow_node_configuration::de_storage_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'storage' cannot be null"))?,
                        )),
                        "agent" => Some(crate::types::FlowNodeConfiguration::Agent(
                            crate::protocol_serde::shape_agent_flow_node_configuration::de_agent_flow_node_configuration(tokens, _value, depth + 1)?
                        ...
                        "retrieval" => Some(crate::types::FlowNodeConfiguration::Retrieval(
                            crate::protocol_serde::shape_retrieval_flow_node_configuration::de_retrieval_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'retrieval' cannot be null"))?,
                        )),
                        "iterator" => Some(crate::types::FlowNodeConfiguration::Iterator(
                            crate::protocol_serde::shape_iterator_flow_node_configuration::de_iterator_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'iterator' cannot be null"))?,
                        )),
                        "collector" => Some(crate::types::FlowNodeConfiguration::Collector(
                            crate::protocol_serde::shape_collector_flow_node_configuration::de_collector_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'collector' cannot be null"))?,
                        )),
                        "inlineCode" => Some(crate::types::FlowNodeConfiguration::InlineCode(
                            crate::protocol_serde::shape_inline_code_flow_node_configuration::de_inline_code_flow_node_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?
                        ...
                        "loop" => Some(crate::types::FlowNodeConfiguration::Loop(
                            crate::protocol_serde::shape_loop_flow_node_configuration::de_loop_flow_node_configuration(tokens, _value, depth + 1)?
                        ...
                        "loopInput" => Some(crate::types::FlowNodeConfiguration::LoopInput(
                            ...
                            .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'loopInput' cannot be null"))?,
                        )),
