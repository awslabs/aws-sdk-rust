                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::KnowledgeBaseStorageType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "pineconeConfiguration" => {
                                builder = builder.set_pinecone_configuration(
                                    crate::protocol_serde::shape_pinecone_configuration::de_pinecone_configuration(tokens)?
                                );
                            }
                            ...
                            "rdsConfiguration" => {
                                builder = builder.set_rds_configuration(
