...
pub(crate) fn de_vector_knowledge_base_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::VectorKnowledgeBaseConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "embeddingModelConfiguration" => {
                            builder = builder.set_embedding_model_configuration(
                                crate::protocol_serde::shape_embedding_model_configuration::de_embedding_model_configuration(tokens, _value)?,
                            );
                        }
