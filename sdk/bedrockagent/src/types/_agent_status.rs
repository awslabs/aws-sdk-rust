...
impl ::std::convert::From<&str> for AgentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NOT_PREPARED" => AgentStatus::NotPrepared,
            "PREPARED" => AgentStatus::Prepared,
            "PREPARING" => AgentStatus::Preparing,
            "UPDATING" => AgentStatus::Updating,
            "VERSIONING" => AgentStatus::Versioning,
            other => AgentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AgentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AgentStatus::from(s))
    }
}
impl AgentStatus {
...
impl ::std::convert::AsRef<str> for AgentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
