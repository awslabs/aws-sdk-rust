...
impl IngestionJobBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::IngestionJob, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::IngestionJob {
                knowledge_base_id: self.knowledge_base_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("knowledge_base_id", "knowledge_base_id was not specified but it is required when building IngestionJob")
                    )?
                ,
                data_source_id: self.data_source_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_source_id", "data_source_id was not specified but it is required when building IngestionJob")
                    )?
                ,
                ingestion_job_id: self.ingestion_job_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("ingestion_job_id", "ingestion_job_id was not specified but it is required when building IngestionJob")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building IngestionJob")
                    )?
                ,
                ...
                started_at: self.started_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("started_at", "started_at was not specified but it is required when building IngestionJob")
                    )?
                ,
                updated_at: self.updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("updated_at", "updated_at was not specified but it is required when building IngestionJob")
                    )?
                ,
            }
        )
