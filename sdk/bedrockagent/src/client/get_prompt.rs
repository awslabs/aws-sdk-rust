...
impl super::Client {
    ...
    ///   - [`included_data(IncludedData)`](crate::operation::get_prompt::builders::GetPromptFluentBuilder::included_data) / [`set_included_data(Option<IncludedData>)`](crate::operation::get_prompt::builders::GetPromptFluentBuilder::set_included_data):<br>required: **false**<br><p>Controls the scope of data returned. Set to <code>METADATA_ONLY</code> to return only resource metadata. Set to <code>ALL_DATA</code> or omit this field to return the full response.</p><br>
