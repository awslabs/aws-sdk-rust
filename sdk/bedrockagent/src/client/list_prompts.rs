...
impl super::Client {
    ...
    ///   - [`prompt_identifier(impl Into<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::prompt_identifier) / [`set_prompt_identifier(Option<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::set_prompt_identifier):<br>required: **false**<br><p>The unique identifier of the prompt for whose versions you want to return information. Omit this field to list information about all prompts in an account.</p><br>
