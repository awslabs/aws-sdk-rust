...
impl super::Client {
    ...
    ///   - [`flow_alias_summaries(Vec::<FlowAliasSummary>)`](crate::operation::list_flow_aliases::ListFlowAliasesOutput::flow_alias_summaries): <p>A list, each member of which contains information about a flow alias.</p>
