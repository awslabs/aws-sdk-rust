...
impl super::Client {
    ...
    ///   - [`name(String)`](crate::operation::get_flow_alias::GetFlowAliasOutput::name): <p>The name of the flow alias.</p>
    ...
    ///   - [`updated_at(DateTime)`](crate::operation::get_flow_alias::GetFlowAliasOutput::updated_at): <p>The time at which the flow alias was last updated.</p>
