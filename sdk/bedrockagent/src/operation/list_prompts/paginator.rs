...
impl ListPromptsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `prompt_summaries`. Queries to the underlying service
...
impl ListPromptsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_prompts_output_output_prompt_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
