...
impl DeleteAgentActionGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_agent_action_group::DeleteAgentActionGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_agent_action_group::DeleteAgentActionGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_agent_action_group::DeleteAgentActionGroupOutput, crate::operation::delete_agent_action_group::DeleteAgentActionGroupError, Self> {
