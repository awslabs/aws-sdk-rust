...
impl UpdateKnowledgeBaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_knowledge_base::UpdateKnowledgeBaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_knowledge_base::UpdateKnowledgeBaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_knowledge_base::UpdateKnowledgeBaseOutput, crate::operation::update_knowledge_base::UpdateKnowledgeBaseError, Self> {
