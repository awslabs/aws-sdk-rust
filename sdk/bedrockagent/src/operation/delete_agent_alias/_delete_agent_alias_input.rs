...
impl DeleteAgentAliasInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_agent_alias::DeleteAgentAliasInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_agent_alias::DeleteAgentAliasInput {
