...
impl  ListAgentVersionsOutput  {
    ...
    pub fn agent_version_summaries(&self) -> & [crate::types::AgentVersionSummary] {
        use std::ops::Deref; self.agent_version_summaries.deref()
    }
    /// Opaque continuation token of previous paginated response.
...
impl ListAgentVersionsOutputBuilder {
    ...
    pub fn set_agent_version_summaries(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::AgentVersionSummary>>) -> Self {
        self.agent_version_summaries = input; self
    }
    /// List of AgentVersionSummary.
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_agent_versions::ListAgentVersionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_agent_versions::ListAgentVersionsOutput {
                agent_version_summaries: self.agent_version_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("agent_version_summaries", "agent_version_summaries was not specified but it is required when building ListAgentVersionsOutput")
                    )?
                ,
