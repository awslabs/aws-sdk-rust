...
pub use crate::operation::delete_flow_version::_delete_flow_version_input::DeleteFlowVersionInputBuilder;

pub use crate::operation::delete_flow_version::_delete_flow_version_output::DeleteFlowVersionOutputBuilder;

impl crate::operation::delete_flow_version::builders::DeleteFlowVersionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::delete_flow_version::DeleteFlowVersionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::delete_flow_version::DeleteFlowVersionError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.delete_flow_version();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `DeleteFlowVersion`.
///
/// <p>Deletes a version of a flow.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct DeleteFlowVersionFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::delete_flow_version::builders::DeleteFlowVersionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::delete_flow_version::DeleteFlowVersionOutput,
        crate::operation::delete_flow_version::DeleteFlowVersionError,
    > for DeleteFlowVersionFluentBuilder
{
    fn send(
        self,
...
impl DeleteFlowVersionFluentBuilder {
    /// Creates a new `DeleteFlowVersionFluentBuilder`.
    ...
    /// Access the DeleteFlowVersion as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_flow_version::builders::DeleteFlowVersionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_flow_version::DeleteFlowVersion::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_flow_version::DeleteFlowVersion::orchestrate(&runtime_plugins, input).await
    }
