...
impl ::std::fmt::Debug for CreatePromptOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreatePromptOutput");
...
impl CreatePromptOutputBuilder {
    ...
    /// - [`name`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::name)
    /// - [`id`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::id)
    /// - [`arn`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::arn)
    /// - [`version`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::version)
    /// - [`created_at`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::create_prompt::builders::CreatePromptOutputBuilder::updated_at)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_prompt::CreatePromptOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_prompt::CreatePromptOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreatePromptOutput",
                )
            })?,
            ...
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreatePromptOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building CreatePromptOutput",
                )
            })?,
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building CreatePromptOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building CreatePromptOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building CreatePromptOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreatePromptOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreatePromptOutputBuilder");
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
        formatter.field("customer_encryption_key_arn", &self.customer_encryption_key_arn);
        formatter.field("default_variant", &self.default_variant);
