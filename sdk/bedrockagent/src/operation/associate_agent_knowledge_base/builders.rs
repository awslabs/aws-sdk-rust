...
impl crate::operation::associate_agent_knowledge_base::builders::AssociateAgentKnowledgeBaseInputBuilder {
...
impl AssociateAgentKnowledgeBaseFluentBuilder {
    /// Creates a new `AssociateAgentKnowledgeBaseFluentBuilder`.
