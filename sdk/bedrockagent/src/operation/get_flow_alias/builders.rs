...
pub use crate::operation::get_flow_alias::_get_flow_alias_input::GetFlowAliasInputBuilder;

pub use crate::operation::get_flow_alias::_get_flow_alias_output::GetFlowAliasOutputBuilder;

impl crate::operation::get_flow_alias::builders::GetFlowAliasInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_flow_alias();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `GetFlowAlias`.
///
...
pub struct GetFlowAliasFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_flow_alias::builders::GetFlowAliasInputBuilder,
...
impl GetFlowAliasFluentBuilder {
    /// Creates a new `GetFlowAliasFluentBuilder`.
    ...
    /// Access the GetFlowAlias as a reference.
    pub fn as_input(&self) -> &crate::operation::get_flow_alias::builders::GetFlowAliasInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_flow_alias::GetFlowAlias::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_flow_alias::GetFlowAlias::orchestrate(&runtime_plugins, input).await
    }
