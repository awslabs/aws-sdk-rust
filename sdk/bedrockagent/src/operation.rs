...
/// Types for the `AssociateAgentCollaborator` operation.
pub mod associate_agent_collaborator;
...
/// Types for the `GetAgentCollaborator` operation.
pub mod get_agent_collaborator;
...
/// Types for the `ListAgentCollaborators` operation.
pub mod list_agent_collaborators;
...
/// Types for the `UpdateAgentCollaborator` operation.
pub mod update_agent_collaborator;
