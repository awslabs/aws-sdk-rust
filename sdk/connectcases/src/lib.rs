...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("connectcases", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Connect Cases.
pub mod client;
