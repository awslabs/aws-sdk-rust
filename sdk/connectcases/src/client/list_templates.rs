...
impl super::Client {
    ...
    ///   - [`status(TemplateStatus)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::status) / [`set_status(Option<Vec<TemplateStatus>>)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::set_status): <p>A list of status values to filter on.</p>
