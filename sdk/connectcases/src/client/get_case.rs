...
impl super::Client {
    ...
    ///   - [`case_id(impl Into<String>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::case_id) / [`set_case_id(impl Into<String>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::set_case_id):<br>required: **true**<br><p>A unique identifier of the case.</p><br>
    ///   - [`domain_id(impl Into<String>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`fields(FieldIdentifier)`](crate::operation::get_case::builders::GetCaseFluentBuilder::fields) / [`set_fields(Vec<FieldIdentifier>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::set_fields):<br>required: **true**<br><p>A list of unique field identifiers. </p><br>
