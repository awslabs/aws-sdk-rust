...
impl super::Client {
    ...
    ///   - [`fields(FieldIdentifier)`](crate::operation::get_case::builders::GetCaseFluentBuilder::fields) / [`set_fields(Option<Vec<FieldIdentifier>>)`](crate::operation::get_case::builders::GetCaseFluentBuilder::set_fields): <p>A list of unique field identifiers. </p>
