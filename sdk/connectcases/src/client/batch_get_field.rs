...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`fields(FieldIdentifier)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::fields) / [`set_fields(Vec<FieldIdentifier>)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::set_fields):<br>required: **true**<br><p>A list of unique field identifiers. </p><br>
