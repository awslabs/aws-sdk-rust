...
impl super::Client {
    ...
    ///   - [`fields(FieldIdentifier)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::fields) / [`set_fields(Option<Vec<FieldIdentifier>>)`](crate::operation::batch_get_field::builders::BatchGetFieldFluentBuilder::set_fields): <p>A list of unique field identifiers. </p>
