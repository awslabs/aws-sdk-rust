...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`case_id(impl Into<String>)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::case_id) / [`set_case_id(impl Into<String>)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::set_case_id):<br>required: **true**<br><p>A unique identifier of the case.</p><br>
