...
impl super::Client {
    ...
    ///   - [`filters(RelatedItemTypeFilter)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::filters) / [`set_filters(Option<Vec<RelatedItemTypeFilter>>)`](crate::operation::search_related_items::builders::SearchRelatedItemsFluentBuilder::set_filters): <p>The list of types of related items and their parameters to use for filtering.</p>
