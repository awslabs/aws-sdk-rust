...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::search_cases::builders::SearchCasesFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::search_cases::builders::SearchCasesFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
