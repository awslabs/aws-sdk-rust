...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`template_id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::template_id) / [`set_template_id(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::set_template_id):<br>required: **true**<br><p>A unique identifier of a template.</p><br>
