...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::create_layout::builders::CreateLayoutFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::create_layout::builders::CreateLayoutFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_layout::builders::CreateLayoutFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_layout::builders::CreateLayoutFluentBuilder::set_name):<br>required: **true**<br><p>The name of the layout. It must be unique for the Cases domain.</p><br>
