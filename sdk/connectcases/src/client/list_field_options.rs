...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`field_id(impl Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::field_id) / [`set_field_id(impl Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::set_field_id):<br>required: **true**<br><p>The unique identifier of a field.</p><br>
