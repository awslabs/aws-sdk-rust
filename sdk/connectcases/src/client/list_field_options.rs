...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::set_domain_id): <p>The unique identifier of the Cases domain. </p>
    ///   - [`field_id(impl ::std::convert::Into<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::field_id) / [`set_field_id(Option<String>)`](crate::operation::list_field_options::builders::ListFieldOptionsFluentBuilder::set_field_id): <p>The unique identifier of a field.</p>
