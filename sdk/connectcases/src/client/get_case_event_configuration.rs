...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::get_case_event_configuration::builders::GetCaseEventConfigurationFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::get_case_event_configuration::builders::GetCaseEventConfigurationFluentBuilder::set_domain_id): <p>The unique identifier of the Cases domain. </p>
