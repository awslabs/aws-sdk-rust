...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::set_domain_id):<br>required: **true**<br><p>The unique identifier of the Cases domain. </p><br>
    ///   - [`layout_id(impl Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::layout_id) / [`set_layout_id(impl Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::set_layout_id):<br>required: **true**<br><p>The unique identifier of the layout.</p><br>
