...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::set_domain_id): <p>The unique identifier of the Cases domain. </p>
    ///   - [`layout_id(impl ::std::convert::Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::layout_id) / [`set_layout_id(Option<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::set_layout_id): <p>The unique identifier of the layout.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_layout::builders::UpdateLayoutFluentBuilder::set_name): <p>The name of the layout. It must be unique per domain.</p>
