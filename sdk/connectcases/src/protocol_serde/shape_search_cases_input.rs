...
pub fn ser_search_cases_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchCasesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
