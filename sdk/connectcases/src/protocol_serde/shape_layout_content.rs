...
pub fn ser_layout_content(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LayoutContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_layout_content<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LayoutContent>, aws_smithy_json::deserialize::error::DeserializeError>
