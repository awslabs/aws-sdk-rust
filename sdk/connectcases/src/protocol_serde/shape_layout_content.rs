...
pub fn ser_layout_content(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::LayoutContent) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::LayoutContent::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("LayoutContent"))
    }
    Ok(())
}
