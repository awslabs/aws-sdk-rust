...
pub fn ser_layout_content(
    ...
    match input {
        ...
        crate::types::LayoutContent::Unknown => {
            return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("LayoutContent"))
        }
    }
    Ok(())
}
...
) -> Result<Option<crate::types::LayoutContent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
