...
) -> Result<Option<crate::types::RelatedItemContent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "contact" => Some(crate::types::RelatedItemContent::Contact(
                            crate::protocol_serde::shape_contact_content::de_contact_content(tokens)?.ok_or_else(|| {
                        ...
                        "comment" => Some(crate::types::RelatedItemContent::Comment(
                            crate::protocol_serde::shape_comment_content::de_comment_content(tokens)?.ok_or_else(|| {
