...
pub(crate) fn de_event_included_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EventIncludedData>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_event_included_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventIncludedData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
