...
pub fn ser_field_value_union(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldValueUnion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_field_value_union<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FieldValueUnion>, aws_smithy_json::deserialize::error::DeserializeError>
