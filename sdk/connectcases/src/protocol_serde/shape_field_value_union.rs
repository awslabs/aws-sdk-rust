...
pub(crate) fn de_field_value_union<'a, I>(
    ...
    Option<crate::model::FieldValueUnion>,
            ...
            match tokens.next().transpose()? {
                ...
                Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.to_unescaped()?.as_ref() {
                        "stringValue" => Some(crate::model::FieldValueUnion::StringValue(
                        ...
                        "doubleValue" => Some(crate::model::FieldValueUnion::DoubleValue(
                        ...
                        "booleanValue" => Some(crate::model::FieldValueUnion::BooleanValue(
