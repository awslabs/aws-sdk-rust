...
pub fn ser_case_filter(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CaseFilter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
