...
pub fn ser_case_filter(object_6: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CaseFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
