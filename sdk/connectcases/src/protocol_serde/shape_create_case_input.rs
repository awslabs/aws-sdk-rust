...
pub fn ser_create_case_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCaseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
