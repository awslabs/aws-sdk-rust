...
pub fn ser_related_item_input_content(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RelatedItemInputContent) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::RelatedItemInputContent::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("RelatedItemInputContent"))
    }
    Ok(())
}
