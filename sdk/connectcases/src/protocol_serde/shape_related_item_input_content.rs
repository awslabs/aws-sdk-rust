...
pub fn ser_related_item_input_content(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RelatedItemInputContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
