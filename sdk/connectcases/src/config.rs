...
impl Builder {
    ...
    /// use aws_sdk_connectcases::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_connectcases::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
