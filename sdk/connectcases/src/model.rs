...
pub struct LayoutConfiguration  {
    ...
    #[doc(hidden)]pub default_layout: std::option::Option<std::string::String>,
}
...
impl LayoutContent {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`Basic`](crate::model::LayoutContent::Basic), extracting the inner [`BasicLayout`](crate::model::BasicLayout).
...
pub struct BasicLayout  {
    ...
    #[doc(hidden)]pub top_panel: std::option::Option<crate::model::LayoutSections>,
    /// <p>This represents sections in a tab of the page layout.</p>
    #[doc(hidden)]pub more_info: std::option::Option<crate::model::LayoutSections>,
}
impl BasicLayout {
    /// <p>This represents sections in a panel of the page layout.</p>
...
pub struct LayoutSections  {
    ...
    #[doc(hidden)]pub sections: std::option::Option<std::vec::Vec<crate::model::Section>>,
}
impl LayoutSections {
    /// <p>Ordered list containing different kinds of sections that can be added.</p>
...
impl Section {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`FieldGroup`](crate::model::Section::FieldGroup), extracting the inner [`FieldGroup`](crate::model::FieldGroup).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct FieldGroup  {
    ...
    #[doc(hidden)]pub fields: std::option::Option<std::vec::Vec<crate::model::FieldItem>>,
}
impl FieldGroup {
    /// <p>Name of the field group.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct GetFieldResponse  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::FieldType>,
    /// <p>Namespace of the field.</p>
    #[doc(hidden)]pub namespace: std::option::Option<crate::model::FieldNamespace>,
...
impl std::convert::From<&str> for FieldNamespace {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FieldNamespace::Unknown(other.to_owned())
        }
    }
}
...
impl FieldNamespace {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FieldNamespace::Unknown(s) => s.as_ref()
        }
    }
...
pub struct EventBridgeConfiguration  {
    ...
    #[doc(hidden)]pub included_data: std::option::Option<crate::model::EventIncludedData>,
}
...
pub struct EventIncludedData  {
    ...
    #[doc(hidden)]pub case_data: std::option::Option<crate::model::CaseEventIncludedData>,
    /// <p>Details of what related item data is published through the case event stream.</p>
    #[doc(hidden)]pub related_item_data: std::option::Option<crate::model::RelatedItemEventIncludedData>,
}
...
pub struct RelatedItemEventIncludedData  {
    /// <p>Details of what related item data is published through the case event stream.</p>
    #[doc(hidden)]pub include_content: std::option::Option<bool>,
}
...
pub struct CaseEventIncludedData  {
    ...
    #[doc(hidden)]pub fields: std::option::Option<std::vec::Vec<crate::model::FieldIdentifier>>,
}
...
pub struct FieldValue  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::FieldValueUnion>,
}
impl FieldValue {
    /// <p>Unique identifier of a field.</p>
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct Sort  {
    ...
    #[doc(hidden)]pub field_id: std::option::Option<std::string::String>,
    /// <p>A structured set of sort terms</p>
    #[doc(hidden)]pub sort_order: std::option::Option<crate::model::Order>,
}
impl Sort {
    /// <p>Unique identifier of a field.</p>
    pub fn field_id(&self) -> std::option::Option<& str> {
...
pub struct SearchRelatedItemsResponseItem  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::RelatedItemType>,
    ...
    #[doc(hidden)]pub content: std::option::Option<crate::model::RelatedItemContent>,
    /// <p>A map of of key-value pairs that represent tags on a resource. Tags are used to organize, track, or control access for this resource.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::option::Option<std::string::String>>>,
}
...
pub struct CommentContent  {
    ...
    #[doc(hidden)]pub content_type: std::option::Option<crate::model::CommentBodyTextType>,
}
impl CommentContent {
    /// <p>Text in the body of a <code>Comment</code> on a case.</p>
...
impl std::convert::From<&str> for CommentBodyTextType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommentBodyTextType::Unknown(other.to_owned())
        }
    }
}
...
impl CommentBodyTextType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CommentBodyTextType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct ContactContent  {
    ...
    #[doc(hidden)]pub channel: std::option::Option<std::string::String>,
    /// <p>The difference between the <code>InitiationTimestamp</code> and the <code>DisconnectTimestamp</code> of the contact.</p>
    #[doc(hidden)]pub connected_to_system_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl ContactContent {
    /// <p>A unique identifier of a contact in Amazon Connect.</p>
...
impl std::convert::From<&str> for RelatedItemType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelatedItemType::Unknown(other.to_owned())
        }
    }
}
...
impl RelatedItemType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RelatedItemType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct ContactFilter  {
    /// <p>A list of channels to filter on for related items of type <code>Contact</code>.</p>
    #[doc(hidden)]pub channel: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A unique identifier of a contact in Amazon Connect.</p>
    #[doc(hidden)]pub contact_arn: std::option::Option<std::string::String>,
}
impl ContactFilter {
