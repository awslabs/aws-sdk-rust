...
pub struct SearchAllRelatedItemsInput {
    ...
    pub sorts: ::std::option::Option<::std::vec::Vec<crate::types::SearchAllRelatedItemsSort>>,
}
impl SearchAllRelatedItemsInput {
    /// <p>The unique identifier of the Cases domain.</p>
    ...
    pub fn sorts(&self) -> &[crate::types::SearchAllRelatedItemsSort] {
        self.sorts.as_deref().unwrap_or_default()
    }
}
impl SearchAllRelatedItemsInput {
    /// Creates a new builder-style object to manufacture [`SearchAllRelatedItemsInput`](crate::operation::search_all_related_items::SearchAllRelatedItemsInput).
    pub fn builder() -> crate::operation::search_all_related_items::builders::SearchAllRelatedItemsInputBuilder {
        crate::operation::search_all_related_items::builders::SearchAllRelatedItemsInputBuilder::default()
    }
}

/// A builder for [`SearchAllRelatedItemsInput`](crate::operation::search_all_related_items::SearchAllRelatedItemsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SearchAllRelatedItemsInputBuilder {
    pub(crate) domain_id: ::std::option::Option<::std::string::String>,
    pub(crate) max_results: ::std::option::Option<i32>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::RelatedItemTypeFilter>>,
    pub(crate) sorts: ::std::option::Option<::std::vec::Vec<crate::types::SearchAllRelatedItemsSort>>,
}
impl SearchAllRelatedItemsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`SearchAllRelatedItemsInput`](crate::operation::search_all_related_items::SearchAllRelatedItemsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::search_all_related_items::SearchAllRelatedItemsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::search_all_related_items::SearchAllRelatedItemsInput {
