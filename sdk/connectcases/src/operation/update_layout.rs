...
impl UpdateLayoutInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_layout::UpdateLayout, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_layout::ser_update_layout_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLayout {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_layout::de_update_layout_http_response_with_props(status, headers, body)
        }
    }
}
