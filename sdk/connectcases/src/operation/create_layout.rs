...
impl CreateLayoutInput {
    /// Consumes the builder and constructs an Operation<[`CreateLayout`](crate::operation::create_layout::CreateLayout)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_layout::CreateLayout, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_layout::ser_create_layout_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_layout::CreateLayout::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLayout {
    type Output = ::std::result::Result<crate::operation::create_layout::CreateLayoutOutput, crate::operation::create_layout::CreateLayoutError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_layout::de_create_layout_http_response_with_props(status, headers, body)
        }
    }
}
