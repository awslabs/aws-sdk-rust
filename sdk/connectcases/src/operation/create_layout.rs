...
impl CreateLayoutInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_layout::CreateLayout,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/domains/{domainId}/layouts", domainId = domain_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_layout::CreateLayout::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLayout {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_layout::de_create_layout_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_layout::de_create_layout_http_response_with_props(
                status, headers, body,
            )
        }
    }
