...
impl BatchGetFieldInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_field::BatchGetField::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetField {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_get_field::de_batch_get_field_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_get_field::de_batch_get_field_http_response(
                status, headers, body,
            )
        }
    }
