...
impl SearchRelatedItemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_related_items::ser_search_related_items_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_related_items::SearchRelatedItems::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_related_items::SearchRelatedItemsError
{
