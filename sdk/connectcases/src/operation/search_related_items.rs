...
impl SearchRelatedItemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_related_items::ser_search_related_items_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchRelatedItems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_related_items::de_search_related_items_http_response_with_props(status, headers, body)
        }
    }
}
