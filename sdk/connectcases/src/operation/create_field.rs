    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/domains/{domainId}/fields", domainId = domain_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_field::CreateField::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateField {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_field::de_create_field_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_field::de_create_field_http_response_with_props(
                status, headers, body,
            )
        }
    }
