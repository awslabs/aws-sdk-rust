...
impl CreateFieldInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_field::CreateField, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_field::ser_create_field_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateField {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_field::de_create_field_http_response_with_props(status, headers, body)
        }
    }
}
