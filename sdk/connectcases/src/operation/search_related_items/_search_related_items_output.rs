...
impl  SearchRelatedItemsOutput  {
    ...
    pub fn related_items(&self) -> & [::std::option::Option<crate::types::SearchRelatedItemsResponseItem>] {
        use std::ops::Deref; self.related_items.deref()
    }
}
...
impl SearchRelatedItemsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_related_items::SearchRelatedItemsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::search_related_items::SearchRelatedItemsOutput {
                ...
                related_items: self.related_items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("related_items", "related_items was not specified but it is required when building SearchRelatedItemsOutput")
                    )?
                ,
