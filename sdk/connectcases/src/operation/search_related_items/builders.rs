...
impl SearchRelatedItemsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_related_items::SearchRelatedItemsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_related_items::SearchRelatedItemsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_related_items::SearchRelatedItemsOutput, crate::operation::search_related_items::SearchRelatedItemsError, Self> {
