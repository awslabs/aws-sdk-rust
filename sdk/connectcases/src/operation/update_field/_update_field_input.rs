...
impl UpdateFieldInputBuilder {
    ...
    /// - [`domain_id`](crate::operation::update_field::builders::UpdateFieldInputBuilder::domain_id)
    /// - [`field_id`](crate::operation::update_field::builders::UpdateFieldInputBuilder::field_id)
        ...
        ::std::result::Result::Ok(crate::operation::update_field::UpdateFieldInput {
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building UpdateFieldInput",
                )
            })?,
            field_id: self.field_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "field_id",
                    "field_id was not specified but it is required when building UpdateFieldInput",
                )
            })?,
            name: self.name,
