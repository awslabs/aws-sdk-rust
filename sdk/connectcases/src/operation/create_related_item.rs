...
impl CreateRelatedItemInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_related_item::ser_create_related_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRelatedItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_related_item::de_create_related_item_http_response_with_props(status, headers, body)
        }
    }
}
