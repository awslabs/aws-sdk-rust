...
impl CreateRelatedItemInput {
    /// Consumes the builder and constructs an Operation<[`CreateRelatedItem`](crate::operation::create_related_item::CreateRelatedItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_related_item::CreateRelatedItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_related_item::CreateRelatedItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_related_item::ser_create_related_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_related_item::CreateRelatedItem::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRelatedItem {
                type Output = std::result::Result<crate::operation::create_related_item::CreateRelatedItemOutput, crate::operation::create_related_item::CreateRelatedItemError>;
