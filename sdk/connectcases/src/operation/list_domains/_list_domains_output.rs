...
impl  ListDomainsOutput  {
    ...
    pub fn domains(&self) -> & [crate::types::DomainSummary] {
        use std::ops::Deref; self.domains.deref()
    }
    /// <p>The token for the next set of results. This is null if there are no more results to return.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::list_domains::ListDomainsOutput {
                domains: self.domains
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domains", "domains was not specified but it is required when building ListDomainsOutput")
                    )?
                ,
