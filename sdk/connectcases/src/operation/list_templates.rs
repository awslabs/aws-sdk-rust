...
impl ListTemplatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_templates::ListTemplates,
    ...
    > {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.status {
                    {
                        for inner_5 in inner_4 {
                            query
                                .push_kv("status", &::aws_smithy_http::query::fmt_string(&inner_5));
                        }
                    }
                }
                ::std::result::Result::Ok(())
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_templates::ListTemplates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_templates::de_list_templates_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_templates::de_list_templates_http_response_with_props(
                status, headers, body,
            )
        }
    }
