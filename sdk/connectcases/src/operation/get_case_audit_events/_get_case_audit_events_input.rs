...
impl GetCaseAuditEventsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_case_audit_events::GetCaseAuditEventsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_case_audit_events::GetCaseAuditEventsInput {
