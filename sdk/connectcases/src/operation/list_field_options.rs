...
impl ListFieldOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_field_options::ListFieldOptions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFieldOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_field_options::de_list_field_options_http_response_with_props(status, headers, body)
        }
    }
}
