...
impl ListFieldOptionsInput {
    ...
    > {
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.values {
                    {
                        for inner_6 in inner_5 {
                            query
                                .push_kv("values", &::aws_smithy_http::query::fmt_string(&inner_6));
                        }
                    }
                }
                ::std::result::Result::Ok(())
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_field_options::ListFieldOptions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_field_options::ListFieldOptionsError
{
