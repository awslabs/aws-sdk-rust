...
impl UpdateFieldInput {
    /// Consumes the builder and constructs an Operation<[`UpdateField`](crate::operation::update_field::UpdateField)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_field::UpdateField, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_field::ser_update_field_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_field::UpdateField::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateField {
    type Output = ::std::result::Result<crate::operation::update_field::UpdateFieldOutput, crate::operation::update_field::UpdateFieldError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_field::de_update_field_http_response_with_props(status, headers, body)
        }
    }
}
