...
impl super::Client {
    ...
    ///   - [`queue_url(impl ::std::convert::Into<String>)`](crate::operation::list_queue_tags::builders::ListQueueTagsFluentBuilder::queue_url) / [`set_queue_url(Option<String>)`](crate::operation::list_queue_tags::builders::ListQueueTagsFluentBuilder::set_queue_url): <p>The URL of the queue.</p>
