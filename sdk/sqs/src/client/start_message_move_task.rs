...
impl super::Client {
    ...
    ///   - [`source_arn(impl Into<String>)`](crate::operation::start_message_move_task::builders::StartMessageMoveTaskFluentBuilder::source_arn) / [`set_source_arn(Option<String>)`](crate::operation::start_message_move_task::builders::StartMessageMoveTaskFluentBuilder::set_source_arn): <p>The ARN of the queue that contains the messages to be moved to another queue. Currently, only dead-letter queue (DLQ) ARNs are accepted.</p>
    ///   - [`destination_arn(impl Into<String>)`](crate::operation::start_message_move_task::builders::StartMessageMoveTaskFluentBuilder::destination_arn) / [`set_destination_arn(Option<String>)`](crate::operation::start_message_move_task::builders::StartMessageMoveTaskFluentBuilder::set_destination_arn): <p>The ARN of the queue that receives the moved messages. You can use this field to specify the destination queue where you would like to redrive messages. If this field is left blank, the messages will be redriven back to their respective original source queues.</p>
