...
impl super::Client {
    ...
    ///   - [`queue_url(impl ::std::convert::Into<String>)`](crate::operation::delete_message_batch::builders::DeleteMessageBatchFluentBuilder::queue_url) / [`set_queue_url(Option<String>)`](crate::operation::delete_message_batch::builders::DeleteMessageBatchFluentBuilder::set_queue_url): <p>The URL of the Amazon SQS queue from which messages are deleted.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`entries(Vec<DeleteMessageBatchRequestEntry>)`](crate::operation::delete_message_batch::builders::DeleteMessageBatchFluentBuilder::entries) / [`set_entries(Option<Vec<DeleteMessageBatchRequestEntry>>)`](crate::operation::delete_message_batch::builders::DeleteMessageBatchFluentBuilder::set_entries): <p>Lists the receipt handles for the messages to be deleted.</p>
