...
impl super::Client {
    ...
    ///   - [`queue_url(impl ::std::convert::Into<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::queue_url) / [`set_queue_url(Option<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::set_queue_url): <p>The URL of the Amazon SQS queue to which permissions are added.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`label(impl ::std::convert::Into<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::label) / [`set_label(Option<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::set_label): <p>The unique identification of the permission you're setting (for example, <code>AliceSendMessage</code>). Maximum 80 characters. Allowed characters include alphanumeric characters, hyphens (<code>-</code>), and underscores (<code>_</code>).</p>
    ///   - [`aws_account_ids(Vec<String>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::aws_account_ids) / [`set_aws_account_ids(Option<Vec<String>>)`](crate::operation::add_permission::builders::AddPermissionFluentBuilder::set_aws_account_ids): <p>The Amazon Web Services account numbers of the <a href="https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P">principals</a> who are to receive permission. For information about locating the Amazon Web Services account identification, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-making-api-requests.html#sqs-api-request-authentication">Your Amazon Web Services Identifiers</a> in the <i>Amazon SQS Developer Guide</i>.</p>
