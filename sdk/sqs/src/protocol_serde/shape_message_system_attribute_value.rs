...
#[allow(unused_mut)]
pub fn ser_message_system_attribute_value(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MessageSystemAttributeValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
