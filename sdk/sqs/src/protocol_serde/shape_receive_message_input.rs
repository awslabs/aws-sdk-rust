...
pub fn ser_receive_message_input_input(input: &crate::input::ReceiveMessageInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
