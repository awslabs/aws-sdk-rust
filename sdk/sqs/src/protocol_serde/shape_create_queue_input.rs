...
pub fn ser_create_queue_input_input(input: &crate::input::CreateQueueInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
