...
#[allow(clippy::unnecessary_wraps)]
pub fn de_change_message_visibility_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::change_message_visibility::ChangeMessageVisibilityOutput, crate::operation::change_message_visibility::ChangeMessageVisibilityError> {
    Ok({
        #[allow(unused_mut)]
