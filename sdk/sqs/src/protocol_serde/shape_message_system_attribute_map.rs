...
pub fn de_message_system_attribute_map_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder, out: &mut std::collections::HashMap<crate::model::MessageSystemAttributeName, std::string::String>) -> Result<(), aws_smithy_xml::decode::XmlDecodeError> {
