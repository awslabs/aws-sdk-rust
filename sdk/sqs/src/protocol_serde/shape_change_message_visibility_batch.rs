...
pub fn de_change_message_visibility_batch_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ChangeMessageVisibilityBatchOutput, crate::error::ChangeMessageVisibilityBatchError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ChangeMessageVisibilityBatchError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_change_message_visibility_batch_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ChangeMessageVisibilityBatchOutput, crate::error::ChangeMessageVisibilityBatchError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_change_message_visibility_batch(inp: &[u8], mut builder: crate::output::change_message_visibility_batch_output::Builder) -> Result<crate::output::change_message_visibility_batch_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
