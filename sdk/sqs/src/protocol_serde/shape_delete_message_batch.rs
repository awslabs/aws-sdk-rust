...
pub fn de_delete_message_batch_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_message_batch::DeleteMessageBatchOutput, crate::operation::delete_message_batch::DeleteMessageBatchError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_message_batch_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_message_batch::DeleteMessageBatchOutput, crate::operation::delete_message_batch::DeleteMessageBatchError> {
    Ok({
        #[allow(unused_mut)]
