...
pub fn de_purge_queue_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::purge_queue::PurgeQueueOutput, crate::operation::purge_queue::PurgeQueueError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_purge_queue_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::purge_queue::PurgeQueueOutput, crate::operation::purge_queue::PurgeQueueError> {
    Ok({
        #[allow(unused_mut)]
