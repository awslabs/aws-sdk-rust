...
pub fn ser_untag_queue_input_input(input: &crate::operation::untag_queue::UntagQueueInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("TagKey");
