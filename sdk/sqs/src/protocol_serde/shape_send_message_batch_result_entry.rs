...
pub fn de_send_message_batch_result_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SendMessageBatchResultEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
