...
pub fn ser_list_queue_tags_input(
    ...
    crate::protocol_serde::shape_list_queue_tags_input::ser_list_queue_tags_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::list_queue_tags::builders::ListQueueTagsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
