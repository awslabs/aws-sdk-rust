...
pub fn de_message_attribute_value(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MessageAttributeValue, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
