...
pub fn de_send_message_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendMessageOutput, crate::error::SendMessageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::SendMessageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_message_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendMessageOutput, crate::error::SendMessageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::send_message_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_send_message::de_send_message(response.body().as_ref(), output).map_err(crate::error::SendMessageError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_send_message(inp: &[u8], mut builder: crate::output::send_message_output::Builder) -> Result<crate::output::send_message_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
