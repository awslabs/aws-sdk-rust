...
pub struct SendMessageBatchOutput  {
    ...
    #[doc(hidden)]pub successful: std::option::Option<std::vec::Vec<crate::model::SendMessageBatchResultEntry>>,
    ...
    #[doc(hidden)]pub failed: std::option::Option<std::vec::Vec<crate::model::BatchResultErrorEntry>>,
}
...
pub struct ListQueuesOutput  {
    ...
    #[doc(hidden)]pub queue_urls: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct GetQueueUrlOutput  {
    ...
    #[doc(hidden)]pub queue_url: std::option::Option<std::string::String>,
}
...
pub struct GetQueueAttributesOutput  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::collections::HashMap<crate::model::QueueAttributeName, std::string::String>>,
}
...
pub struct DeleteMessageBatchOutput  {
    ...
    #[doc(hidden)]pub successful: std::option::Option<std::vec::Vec<crate::model::DeleteMessageBatchResultEntry>>,
...
pub struct ChangeMessageVisibilityBatchOutput  {
    ...
    #[doc(hidden)]pub successful: std::option::Option<std::vec::Vec<crate::model::ChangeMessageVisibilityBatchResultEntry>>,
    /// <p>A list of <code> <code>BatchResultErrorEntry</code> </code> items.</p>
    #[doc(hidden)]pub failed: std::option::Option<std::vec::Vec<crate::model::BatchResultErrorEntry>>,
}
