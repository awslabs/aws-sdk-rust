...
/// Orchestration and serialization glue logic for `GetQueueAttributes`.
...
impl GetQueueAttributes {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_queue_attributes::GetQueueAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_queue_attributes::GetQueueAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_queue_attributes::GetQueueAttributesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_queue_attributes::GetQueueAttributesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetQueueAttributes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetQueueAttributes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetQueueAttributesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetQueueAttributesResponseDeserializer));
...
.with_interceptor(GetQueueAttributesEndpointParamsInterceptor)
...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_queue_attributes::GetQueueAttributesError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetQueueAttributesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_queue_attributes::de_get_queue_attributes_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_queue_attributes::de_get_queue_attributes_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetQueueAttributesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_queue_attributes::GetQueueAttributesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_queue_attributes::GetQueueAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_queue_attributes::ser_get_queue_attributes_input(&input)?);
...
#[derive(Debug)]
            struct GetQueueAttributesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetQueueAttributesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        ...
                        .ok_or("failed to downcast to GetQueueAttributesInput")?;
...
pub enum GetQueueAttributesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetQueueAttributesError) for what information is available for the error.")]
...
impl GetQueueAttributesError {
    /// Creates the `GetQueueAttributesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetQueueAttributesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidAttributeName(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `GetQueueAttributesError::InvalidAddress`.
    ...
    /// Returns `true` if the error kind is `GetQueueAttributesError::InvalidSecurity`.
    pub fn is_invalid_security(&self) -> bool {
        matches!(self, Self::InvalidSecurity(_))
    }
    /// Returns `true` if the error kind is `GetQueueAttributesError::QueueDoesNotExist`.
    pub fn is_queue_does_not_exist(&self) -> bool {
        matches!(self, Self::QueueDoesNotExist(_))
    }
    /// Returns `true` if the error kind is `GetQueueAttributesError::RequestThrottled`.
    pub fn is_request_throttled(&self) -> bool {
        matches!(self, Self::RequestThrottled(_))
    }
    /// Returns `true` if the error kind is `GetQueueAttributesError::UnsupportedOperation`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetQueueAttributesError {
...
mod _get_queue_attributes_output;
