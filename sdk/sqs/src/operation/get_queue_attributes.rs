...
impl GetQueueAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetQueueAttributes`](crate::operation::get_queue_attributes::GetQueueAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_queue_attributes::GetQueueAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_queue_attributes::GetQueueAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_queue_attributes_input::ser_get_queue_attributes_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_queue_attributes::GetQueueAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetQueueAttributes", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetQueueAttributes {
                type Output = std::result::Result<crate::operation::get_queue_attributes::GetQueueAttributesOutput, crate::operation::get_queue_attributes::GetQueueAttributesError>;
