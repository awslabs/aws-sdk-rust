...
impl UntagQueueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::untag_queue::UntagQueue,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_queue::UntagQueue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagQueue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_queue::de_untag_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
