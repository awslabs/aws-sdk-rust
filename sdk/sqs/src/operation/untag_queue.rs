...
impl UntagQueueInput {
    /// Consumes the builder and constructs an Operation<[`UntagQueue`](crate::operation::untag_queue::UntagQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_queue::UntagQueue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_queue::UntagQueueInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_queue_input::ser_untag_queue_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_queue::UntagQueue::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagQueue", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for UntagQueue {
                type Output = std::result::Result<crate::operation::untag_queue::UntagQueueOutput, crate::operation::untag_queue::UntagQueueError>;
