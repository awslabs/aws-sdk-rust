...
impl TagQueueInput {
    /// Consumes the builder and constructs an Operation<[`TagQueue`](crate::operation::tag_queue::TagQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_queue::TagQueue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_queue::TagQueueInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_queue_input::ser_tag_queue_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_queue::TagQueue::new())
...
impl aws_smithy_http::response::ParseStrictResponse for TagQueue {
                type Output = std::result::Result<crate::operation::tag_queue::TagQueueOutput, crate::operation::tag_queue::TagQueueError>;
