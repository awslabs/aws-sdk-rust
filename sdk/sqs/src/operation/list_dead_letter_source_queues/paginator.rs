    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp =
                        crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueues::orchestrate(&runtime_plugins, input.clone())
                            .await;
...
impl ListDeadLetterSourceQueuesPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_dead_letter_source_queues_output_queue_urls(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
