...
/// Paginator for [`ListQueues`](crate::operation::list_queues::ListQueues)
            ...
            impl ListQueuesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_queues::ListQueuesOutput, aws_smithy_http::result::SdkError<crate::operation::list_queues::ListQueuesError>>> + Unpin
                 {
...
/// Flattened paginator for `ListQueuesPaginator`
                ...
                impl  ListQueuesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<std::string::String, aws_smithy_http::result::SdkError<crate::operation::list_queues::ListQueuesError>>> + Unpin
                     {
