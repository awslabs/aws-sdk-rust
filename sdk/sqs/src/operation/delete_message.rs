...
impl DeleteMessageInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMessage`](crate::operation::delete_message::DeleteMessage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_message::DeleteMessage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_message_input::ser_delete_message_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_message::DeleteMessage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteMessage", "sqs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMessage {
    type Output = ::std::result::Result<crate::operation::delete_message::DeleteMessageOutput, crate::operation::delete_message::DeleteMessageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_message::de_delete_message_http_response_with_props(status, headers, body)
        }
    }
}
