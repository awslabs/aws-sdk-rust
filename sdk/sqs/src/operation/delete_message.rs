...
impl DeleteMessageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_message_input::ser_delete_message_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_message::DeleteMessage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_message::de_delete_message_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_message::de_delete_message_http_response_with_props(
                status, headers, body,
            )
        }
    }
