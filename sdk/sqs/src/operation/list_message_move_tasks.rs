...
/// Orchestration and serialization glue logic for `ListMessageMoveTasks`.
...
impl ListMessageMoveTasks {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_message_move_tasks::ListMessageMoveTasksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_message_move_tasks::ListMessageMoveTasksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_message_move_tasks::ListMessageMoveTasksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_message_move_tasks::ListMessageMoveTasksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMessageMoveTasks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMessageMoveTasks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMessageMoveTasksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMessageMoveTasksResponseDeserializer));
...
.with_interceptor(ListMessageMoveTasksEndpointParamsInterceptor)
...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_message_move_tasks::ListMessageMoveTasksError>::new());
...
#[derive(Debug)]
            struct ListMessageMoveTasksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMessageMoveTasksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_message_move_tasks::de_list_message_move_tasks_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_message_move_tasks::de_list_message_move_tasks_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListMessageMoveTasksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMessageMoveTasksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_message_move_tasks::ListMessageMoveTasksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_message_move_tasks::ListMessageMoveTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_message_move_tasks::ser_list_message_move_tasks_input(&input)?);
...
#[derive(Debug)]
            struct ListMessageMoveTasksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMessageMoveTasksEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMessageMoveTasksInput>()
                        .ok_or("failed to downcast to ListMessageMoveTasksInput")?;
...
/// Error type for the `ListMessageMoveTasksError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListMessageMoveTasksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMessageMoveTasksError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListMessageMoveTasksError {
    /// Creates the `ListMessageMoveTasksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMessageMoveTasksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListMessageMoveTasksError::InvalidAddress`.
    pub fn is_invalid_address(&self) -> bool {
        matches!(self, Self::InvalidAddress(_))
    }
    /// Returns `true` if the error kind is `ListMessageMoveTasksError::InvalidSecurity`.
    pub fn is_invalid_security(&self) -> bool {
        matches!(self, Self::InvalidSecurity(_))
    }
    /// Returns `true` if the error kind is `ListMessageMoveTasksError::RequestThrottled`.
    pub fn is_request_throttled(&self) -> bool {
        matches!(self, Self::RequestThrottled(_))
    }
    /// Returns `true` if the error kind is `ListMessageMoveTasksError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListMessageMoveTasksError::UnsupportedOperation`.
    pub fn is_unsupported_operation(&self) -> bool {
        matches!(self, Self::UnsupportedOperation(_))
    }
}
impl ::std::error::Error for ListMessageMoveTasksError {
...
impl ::std::fmt::Display for ListMessageMoveTasksError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListMessageMoveTasksError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListMessageMoveTasksError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMessageMoveTasksError {
...
mod _list_message_move_tasks_output;
