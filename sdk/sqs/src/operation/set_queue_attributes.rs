...
impl SetQueueAttributesInput {
    /// Consumes the builder and constructs an Operation<[`SetQueueAttributes`](crate::operation::set_queue_attributes::SetQueueAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_queue_attributes::SetQueueAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_queue_attributes::SetQueueAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_queue_attributes_input::ser_set_queue_attributes_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_queue_attributes::SetQueueAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetQueueAttributes", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetQueueAttributes {
                type Output = std::result::Result<crate::operation::set_queue_attributes::SetQueueAttributesOutput, crate::operation::set_queue_attributes::SetQueueAttributesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_set_queue_attributes::de_set_queue_attributes_http_error(response)
                     } else {
                        crate::protocol_serde::shape_set_queue_attributes::de_set_queue_attributes_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::set_queue_attributes::SetQueueAttributesError {
