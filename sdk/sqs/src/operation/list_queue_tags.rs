...
impl ListQueueTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_queue_tags::ListQueueTags, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQueueTags {
    type Output =
        ::std::result::Result<crate::operation::list_queue_tags::ListQueueTagsOutput, crate::operation::list_queue_tags::ListQueueTagsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_queue_tags::de_list_queue_tags_http_response_with_props(status, headers, body)
        }
    }
}
