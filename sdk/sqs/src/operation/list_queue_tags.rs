...
impl ListQueueTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_queue_tags::ListQueueTags,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_queue_tags_input::ser_list_queue_tags_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_queue_tags::ListQueueTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQueueTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_queue_tags::de_list_queue_tags_http_error(
                status, headers, body,
            )
        } else {
