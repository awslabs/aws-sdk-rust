...
impl ListQueueTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListQueueTags`](crate::operation::list_queue_tags::ListQueueTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_queue_tags::ListQueueTags, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_queue_tags::ListQueueTagsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_queue_tags_input::ser_list_queue_tags_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_queue_tags::ListQueueTags::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListQueueTags", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListQueueTags {
                type Output = std::result::Result<crate::operation::list_queue_tags::ListQueueTagsOutput, crate::operation::list_queue_tags::ListQueueTagsError>;
