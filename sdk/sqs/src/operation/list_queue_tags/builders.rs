...
impl ListQueueTagsFluentBuilder  {
    /// Creates a new `ListQueueTags`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_queue_tags::ListQueueTags, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_queue_tags::ListQueueTagsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_queue_tags::ListQueueTagsOutput, aws_smithy_http::result::SdkError<crate::operation::list_queue_tags::ListQueueTagsError>>
                     {
