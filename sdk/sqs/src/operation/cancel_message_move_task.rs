...
impl CancelMessageMoveTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_message_move_task::CancelMessageMoveTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_message_move_task::CancelMessageMoveTaskOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("sqs", "CancelMessageMoveTask", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelMessageMoveTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelMessageMoveTask", "sqs"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelMessageMoveTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelMessageMoveTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_message_move_task::CancelMessageMoveTaskInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_message_move_task_input::ser_cancel_message_move_task_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelMessageMoveTaskEndpointParamsInterceptor {
...
pub type CancelMessageMoveTaskErrorKind = CancelMessageMoveTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelMessageMoveTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_message_move_task::CancelMessageMoveTaskError {
...
impl CancelMessageMoveTaskError {
    ...
    /// Creates the `CancelMessageMoveTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
