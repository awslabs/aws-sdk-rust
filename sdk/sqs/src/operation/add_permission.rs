...
impl AddPermissionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_permission::AddPermission, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_permission_input::ser_add_permission_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddPermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_permission::de_add_permission_http_response_with_props(status, headers, body)
        }
    }
}
