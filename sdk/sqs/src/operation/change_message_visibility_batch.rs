...
impl ChangeMessageVisibilityBatchInput {
    /// Consumes the builder and constructs an Operation<[`ChangeMessageVisibilityBatch`](crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatch, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_change_message_visibility_batch_input::ser_change_message_visibility_batch_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatch::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ChangeMessageVisibilityBatch", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for ChangeMessageVisibilityBatch {
                type Output = std::result::Result<crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchOutput, crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError>;
...
impl aws_http::request_id::RequestId for crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchError {
