...
impl ChangeMessageVisibilityBatchInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatch::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ChangeMessageVisibilityBatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_change_message_visibility_batch::de_change_message_visibility_batch_http_response_with_props(
                status, headers, body,
            )
        }
    }
