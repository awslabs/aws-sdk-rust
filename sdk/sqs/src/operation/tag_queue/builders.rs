...
impl TagQueueFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::tag_queue::TagQueueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_queue::TagQueueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
