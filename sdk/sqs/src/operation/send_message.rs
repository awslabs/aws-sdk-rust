...
impl SendMessage {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::send_message::SendMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_message::SendMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::send_message::SendMessageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::send_message::SendMessageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendMessage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SendMessageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SendMessageResponseDeserializer));
...
.with_interceptor(SendMessageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::send_message::SendMessageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::send_message::SendMessageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::send_message::SendMessageError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_send_message::de_send_message_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_send_message::de_send_message_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendMessageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::send_message::SendMessageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::send_message::SendMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl SendMessageError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidMessageContents(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `SendMessageError::InvalidAddress`.
    ...
    /// Returns `true` if the error kind is `SendMessageError::InvalidSecurity`.
    pub fn is_invalid_security(&self) -> bool {
        matches!(self, Self::InvalidSecurity(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsAccessDenied`.
    pub fn is_kms_access_denied(&self) -> bool {
        matches!(self, Self::KmsAccessDenied(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsDisabled`.
    pub fn is_kms_disabled(&self) -> bool {
        matches!(self, Self::KmsDisabled(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsInvalidKeyUsage`.
    pub fn is_kms_invalid_key_usage(&self) -> bool {
        matches!(self, Self::KmsInvalidKeyUsage(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsInvalidState`.
    pub fn is_kms_invalid_state(&self) -> bool {
        matches!(self, Self::KmsInvalidState(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsNotFound`.
    pub fn is_kms_not_found(&self) -> bool {
        matches!(self, Self::KmsNotFound(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsOptInRequired`.
    pub fn is_kms_opt_in_required(&self) -> bool {
        matches!(self, Self::KmsOptInRequired(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::KmsThrottled`.
    pub fn is_kms_throttled(&self) -> bool {
        matches!(self, Self::KmsThrottled(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::QueueDoesNotExist`.
    pub fn is_queue_does_not_exist(&self) -> bool {
        matches!(self, Self::QueueDoesNotExist(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::RequestThrottled`.
...
impl ::std::error::Error for SendMessageError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsAccessDenied(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsDisabled(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsInvalidKeyUsage(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsInvalidState(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsNotFound(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsOptInRequired(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::KmsThrottled(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
