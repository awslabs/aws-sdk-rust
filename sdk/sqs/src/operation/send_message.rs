...
impl SendMessageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_message::SendMessage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_send_message::de_send_message_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_send_message::de_send_message_http_response_with_props(
                status, headers, body,
            )
        }
    }
