...
impl SendMessage {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SQS", "SendMessage", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendMessageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("MessageDeduplicationId") {
            if let ::std::option::Option::Some(value) = input.message_deduplication_id.as_deref() {
                captured.insert("MessageDeduplicationId", value);
            }
        }
        if requested.should_capture("MessageGroupId") {
            if let ::std::option::Option::Some(value) = input.message_group_id.as_deref() {
                captured.insert("MessageGroupId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendMessageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_send_message::de_send_message_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_send_message::de_send_message_http_response(status, headers, body, _cfg)
        };
...
impl ::std::error::Error for SendMessageError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidMessageContents(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SendMessageError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidMessageContents(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
