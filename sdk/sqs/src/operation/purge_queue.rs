...
impl PurgeQueueInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::purge_queue::PurgeQueue,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::purge_queue::PurgeQueue::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for PurgeQueue {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purge_queue::de_purge_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
