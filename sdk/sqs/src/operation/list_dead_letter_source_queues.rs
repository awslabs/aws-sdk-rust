...
impl ListDeadLetterSourceQueuesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueues::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeadLetterSourceQueues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_dead_letter_source_queues::de_list_dead_letter_source_queues_http_response_with_props(
                status, headers, body,
            )
        }
    }
