...
impl ListDeadLetterSourceQueuesInput {
    /// Consumes the builder and constructs an Operation<[`ListDeadLetterSourceQueues`](crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueues)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueues, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_dead_letter_source_queues_input::ser_list_dead_letter_source_queues_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueues::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDeadLetterSourceQueues", "sqs"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListDeadLetterSourceQueues {
                type Output = std::result::Result<crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesOutput, crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError>;
