...
/// Paginator for [`ListDeadLetterSourceQueues`](crate::operation::ListDeadLetterSourceQueues)
            ...
            impl ListDeadLetterSourceQueuesPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_dead_letter_source_queues_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                /// Create a flattened paginator
                    ...
                    pub fn items(self) -> crate::paginator::ListDeadLetterSourceQueuesPaginatorItems {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListDeadLetterSourceQueuesOutput, aws_smithy_http::result::SdkError<crate::error::ListDeadLetterSourceQueuesError>>> + Unpin
                 {
