...
impl From<crate::error::ChangeMessageVisibilityError> for Error {
    fn from(err: crate::error::ChangeMessageVisibilityError) -> Self {
        match err.kind {
            crate::error::ChangeMessageVisibilityErrorKind::MessageNotInflight(inner) => Error::MessageNotInflight(inner),
            crate::error::ChangeMessageVisibilityErrorKind::ReceiptHandleIsInvalid(inner) => Error::ReceiptHandleIsInvalid(inner),
            crate::error::ChangeMessageVisibilityErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::ChangeMessageVisibilityBatchError> for Error {
    fn from(err: crate::error::ChangeMessageVisibilityBatchError) -> Self {
        match err.kind {
            ...
            crate::error::ChangeMessageVisibilityBatchErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::CreateQueueError> for Error {
    fn from(err: crate::error::CreateQueueError) -> Self {
        match err.kind {
            crate::error::CreateQueueErrorKind::QueueDeletedRecently(inner) => Error::QueueDeletedRecently(inner),
            crate::error::CreateQueueErrorKind::QueueNameExists(inner) => Error::QueueNameExists(inner),
...
impl From<crate::error::DeleteMessageError> for Error {
    fn from(err: crate::error::DeleteMessageError) -> Self {
        match err.kind {
            crate::error::DeleteMessageErrorKind::InvalidIdFormat(inner) => Error::InvalidIdFormat(inner),
            crate::error::DeleteMessageErrorKind::ReceiptHandleIsInvalid(inner) => Error::ReceiptHandleIsInvalid(inner),
...
impl From<crate::error::DeleteMessageBatchError> for Error {
    fn from(err: crate::error::DeleteMessageBatchError) -> Self {
        match err.kind {
            crate::error::DeleteMessageBatchErrorKind::BatchEntryIdsNotDistinct(inner) => Error::BatchEntryIdsNotDistinct(inner),
            crate::error::DeleteMessageBatchErrorKind::EmptyBatchRequest(inner) => Error::EmptyBatchRequest(inner),
            crate::error::DeleteMessageBatchErrorKind::InvalidBatchEntryId(inner) => Error::InvalidBatchEntryId(inner),
            crate::error::DeleteMessageBatchErrorKind::TooManyEntriesInBatchRequest(inner) => Error::TooManyEntriesInBatchRequest(inner),
            crate::error::DeleteMessageBatchErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::GetQueueAttributesError> for Error {
    fn from(err: crate::error::GetQueueAttributesError) -> Self {
        match err.kind {
            crate::error::GetQueueAttributesErrorKind::InvalidAttributeName(inner) => Error::InvalidAttributeName(inner),
            crate::error::GetQueueAttributesErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::GetQueueUrlError> for Error {
    fn from(err: crate::error::GetQueueUrlError) -> Self {
        match err.kind {
            crate::error::GetQueueUrlErrorKind::QueueDoesNotExist(inner) => Error::QueueDoesNotExist(inner),
            crate::error::GetQueueUrlErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::ListDeadLetterSourceQueuesError> for Error {
    fn from(err: crate::error::ListDeadLetterSourceQueuesError) -> Self {
        match err.kind {
            crate::error::ListDeadLetterSourceQueuesErrorKind::QueueDoesNotExist(inner) => Error::QueueDoesNotExist(inner),
            crate::error::ListDeadLetterSourceQueuesErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::ListQueueTagsError> for Error {
    fn from(err: crate::error::ListQueueTagsError) -> Self {
        match err.kind {
            crate::error::ListQueueTagsErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::PurgeQueueError> for Error {
    fn from(err: crate::error::PurgeQueueError) -> Self {
        match err.kind {
            crate::error::PurgeQueueErrorKind::PurgeQueueInProgress(inner) => Error::PurgeQueueInProgress(inner),
            crate::error::PurgeQueueErrorKind::QueueDoesNotExist(inner) => Error::QueueDoesNotExist(inner),
            crate::error::PurgeQueueErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::ReceiveMessageError> for Error {
    fn from(err: crate::error::ReceiveMessageError) -> Self {
        match err.kind {
            ...
            crate::error::ReceiveMessageErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::SendMessageError> for Error {
    fn from(err: crate::error::SendMessageError) -> Self {
        match err.kind {
            crate::error::SendMessageErrorKind::InvalidMessageContents(inner) => Error::InvalidMessageContents(inner),
            crate::error::SendMessageErrorKind::UnsupportedOperation(inner) => Error::UnsupportedOperation(inner),
...
impl From<crate::error::SendMessageBatchError> for Error {
    fn from(err: crate::error::SendMessageBatchError) -> Self {
        match err.kind {
            crate::error::SendMessageBatchErrorKind::BatchEntryIdsNotDistinct(inner) => Error::BatchEntryIdsNotDistinct(inner),
            crate::error::SendMessageBatchErrorKind::BatchRequestTooLong(inner) => Error::BatchRequestTooLong(inner),
            crate::error::SendMessageBatchErrorKind::EmptyBatchRequest(inner) => Error::EmptyBatchRequest(inner),
            crate::error::SendMessageBatchErrorKind::InvalidBatchEntryId(inner) => Error::InvalidBatchEntryId(inner),
            crate::error::SendMessageBatchErrorKind::TooManyEntriesInBatchRequest(inner) => Error::TooManyEntriesInBatchRequest(inner),
            crate::error::SendMessageBatchErrorKind::UnsupportedOperation(inner) => Error::UnsupportedOperation(inner),
            crate::error::SendMessageBatchErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::SetQueueAttributesError> for Error {
    fn from(err: crate::error::SetQueueAttributesError) -> Self {
        match err.kind {
            crate::error::SetQueueAttributesErrorKind::InvalidAttributeName(inner) => Error::InvalidAttributeName(inner),
            crate::error::SetQueueAttributesErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::TagQueueError> for Error {
    fn from(err: crate::error::TagQueueError) -> Self {
        match err.kind {
            crate::error::TagQueueErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
...
impl From<crate::error::UntagQueueError> for Error {
    fn from(err: crate::error::UntagQueueError) -> Self {
        match err.kind {
            crate::error::UntagQueueErrorKind::Unhandled(inner) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
        }
    }
}
