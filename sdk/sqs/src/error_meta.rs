        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::ChangeMessageVisibilityErrorKind::ReceiptHandleIsInvalid(
                        inner,
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::DeleteMessageBatchErrorKind::TooManyEntriesInBatchRequest(
                        inner,
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::SendMessageBatchErrorKind::TooManyEntriesInBatchRequest(
                        inner,
                    ) => Error::TooManyEntriesInBatchRequest(inner),
