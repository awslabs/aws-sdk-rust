    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`queue_url(Option<String>)`](crate::input::AddPermissionInput::queue_url): <p>The URL of the Amazon SQS queue to which permissions are added.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`label(Option<String>)`](crate::input::AddPermissionInput::label): <p>The unique identification of the permission you're setting (for example, <code>AliceSendMessage</code>). Maximum 80 characters. Allowed characters include alphanumeric characters, hyphens (<code>-</code>), and underscores (<code>_</code>).</p>
    ///   - [`aws_account_ids(Option<Vec<String>>)`](crate::input::AddPermissionInput::aws_account_ids): <p>The Amazon Web Services account numbers of the <a href="https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P">principals</a> who are to receive permission. For information about locating the Amazon Web Services account identification, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-making-api-requests.html#sqs-api-request-authentication">Your Amazon Web Services Identifiers</a> in the <i>Amazon SQS Developer Guide</i>.</p>
    ///   - [`actions(Option<Vec<String>>)`](crate::input::AddPermissionInput::actions): <p>The action the client wants to allow for the specified principal. Valid values: the name of any action or <code>*</code>.</p>  <p>For more information about these actions, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-overview-of-managing-access.html">Overview of Managing Access Permissions to Your Amazon Simple Queue Service Resource</a> in the <i>Amazon SQS Developer Guide</i>.</p>  <p>Specifying <code>SendMessage</code>, <code>DeleteMessage</code>, or <code>ChangeMessageVisibility</code> for <code>ActionName.n</code> also grants permissions for the corresponding batch versions of those actions: <code>SendMessageBatch</code>, <code>DeleteMessageBatch</code>, and <code>ChangeMessageVisibilityBatch</code>.</p>
    ...
    ///
    /// - Takes [`ChangeMessageVisibilityInput`](crate::input::ChangeMessageVisibilityInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::ChangeMessageVisibilityInput::queue_url): <p>The URL of the Amazon SQS queue whose message's visibility is changed.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`receipt_handle(Option<String>)`](crate::input::ChangeMessageVisibilityInput::receipt_handle): <p>The receipt handle associated with the message whose visibility timeout is changed. This parameter is returned by the <code> <code>ReceiveMessage</code> </code> action.</p>
    ///   - [`visibility_timeout(i32)`](crate::input::ChangeMessageVisibilityInput::visibility_timeout): <p>The new value for the message's visibility timeout (in seconds). Values range: <code>0</code> to <code>43200</code>. Maximum: 12 hours.</p>
    ...
    ///
    /// - Takes [`ChangeMessageVisibilityBatchInput`](crate::input::ChangeMessageVisibilityBatchInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::ChangeMessageVisibilityBatchInput::queue_url): <p>The URL of the Amazon SQS queue whose messages' visibility is changed.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`entries(Option<Vec<ChangeMessageVisibilityBatchRequestEntry>>)`](crate::input::ChangeMessageVisibilityBatchInput::entries): <p>A list of receipt handles of the messages for which the visibility timeout must be changed.</p>
    ...
    ///
    /// - Takes [`DeleteMessageInput`](crate::input::DeleteMessageInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::DeleteMessageInput::queue_url): <p>The URL of the Amazon SQS queue from which messages are deleted.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`receipt_handle(Option<String>)`](crate::input::DeleteMessageInput::receipt_handle): <p>The receipt handle associated with the message to delete.</p>
    ...
    ///
    /// - Takes [`DeleteMessageBatchInput`](crate::input::DeleteMessageBatchInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::DeleteMessageBatchInput::queue_url): <p>The URL of the Amazon SQS queue from which messages are deleted.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`entries(Option<Vec<DeleteMessageBatchRequestEntry>>)`](crate::input::DeleteMessageBatchInput::entries): <p>A list of receipt handles for the messages to be deleted.</p>
    ...
    ///   - [`queue_url(Option<String>)`](crate::input::DeleteQueueInput::queue_url): <p>The URL of the Amazon SQS queue to delete.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ...
    ///
    /// - Takes [`GetQueueUrlInput`](crate::input::GetQueueUrlInput) with field(s):
    ///   - [`queue_name(Option<String>)`](crate::input::GetQueueUrlInput::queue_name): <p>The name of the queue whose URL must be fetched. Maximum 80 characters. Valid values: alphanumeric characters, hyphens (<code>-</code>), and underscores (<code>_</code>).</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`queue_owner_aws_account_id(Option<String>)`](crate::input::GetQueueUrlInput::queue_owner_aws_account_id): <p>The Amazon Web Services account ID of the account that created the queue.</p>
    ...
    ///
    /// - Takes [`ListDeadLetterSourceQueuesInput`](crate::input::ListDeadLetterSourceQueuesInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::ListDeadLetterSourceQueuesInput::queue_url): <p>The URL of a dead-letter queue.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDeadLetterSourceQueuesInput::next_token): <p>Pagination token to request the next set of results.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListDeadLetterSourceQueuesInput::max_results): <p>Maximum number of results to include in the response. Value range is 1 to 1000. You must set <code>MaxResults</code> to receive a value for <code>NextToken</code> in the response.</p>
    ...
    ///   - [`queue_name_prefix(Option<String>)`](crate::input::ListQueuesInput::queue_name_prefix): <p>A string to use for filtering the list results. Only those queues whose name begins with the specified string are returned.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListQueuesInput::next_token): <p>Pagination token to request the next set of results.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListQueuesInput::max_results): <p>Maximum number of results to include in the response. Value range is 1 to 1000. You must set <code>MaxResults</code> to receive a value for <code>NextToken</code> in the response.</p>
    ...
    ///
    /// - Takes [`ListQueueTagsInput`](crate::input::ListQueueTagsInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::ListQueueTagsInput::queue_url): <p>The URL of the queue.</p>
    ...
    ///
    /// - Takes [`PurgeQueueInput`](crate::input::PurgeQueueInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::PurgeQueueInput::queue_url): <p>The URL of the queue from which the <code>PurgeQueue</code> action deletes messages.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ...
    ///   - [`queue_url(Option<String>)`](crate::input::RemovePermissionInput::queue_url): <p>The URL of the Amazon SQS queue from which permissions are removed.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`label(Option<String>)`](crate::input::RemovePermissionInput::label): <p>The identification of the permission to remove. This is the label added using the <code> <code>AddPermission</code> </code> action.</p>
    ...
    ///
    /// - Takes [`SendMessageBatchInput`](crate::input::SendMessageBatchInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::SendMessageBatchInput::queue_url): <p>The URL of the Amazon SQS queue to which batched messages are sent.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`entries(Option<Vec<SendMessageBatchRequestEntry>>)`](crate::input::SendMessageBatchInput::entries): <p>A list of <code> <code>SendMessageBatchRequestEntry</code> </code> items.</p>
    ...
    ///
    /// - Takes [`TagQueueInput`](crate::input::TagQueueInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::TagQueueInput::queue_url): <p>The URL of the queue.</p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::TagQueueInput::tags): <p>The list of tags to be added to the specified queue.</p>
    ...
    ///
    /// - Takes [`UntagQueueInput`](crate::input::UntagQueueInput) with field(s):
    ///   - [`queue_url(Option<String>)`](crate::input::UntagQueueInput::queue_url): <p>The URL of the queue.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagQueueInput::tag_keys): <p>The list of tags to be removed from the specified queue.</p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::ListDeadLetterSourceQueuesPaginator<C, M, R> {
