...
pub(crate) fn reflens_describe_ac_ls_output_next_token(
    input: &crate::operation::describe_ac_ls::DescribeAcLsOutput,
...
pub(crate) fn lens_describe_ac_ls_output_ac_ls(
    input: crate::operation::describe_ac_ls::DescribeAcLsOutput,
