...
pub struct User  {
    ...
    #[doc(hidden)]pub access_string: std::option::Option<std::string::String>,
    /// <p>The names of the Access Control Lists to which the user belongs</p>
    #[doc(hidden)]pub acl_names: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub authentication: std::option::Option<crate::model::Authentication>,
...
pub struct Authentication  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::AuthenticationType>,
    /// <p>The number of passwords belonging to the user. The maximum is two.</p>
    #[doc(hidden)]pub password_count: std::option::Option<i32>,
}
impl Authentication {
    /// <p>Indicates whether the user requires a password to authenticate.</p>
...
pub struct AuthenticationMode  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::InputAuthenticationType>,
    /// <p>The password(s) used for authentication</p>
    #[doc(hidden)]pub passwords: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct Subnet  {
    ...
    #[doc(hidden)]pub availability_zone: std::option::Option<crate::model::AvailabilityZone>,
}
impl Subnet {
    /// <p>The unique identifier for the subnet.</p>
...
pub struct Cluster  {
    ...
    #[doc(hidden)]pub pending_updates: std::option::Option<crate::model::ClusterPendingUpdates>,
    /// <p>The number of shards in the cluster</p>
    #[doc(hidden)]pub number_of_shards: std::option::Option<i32>,
    ...
    /// <p>Indicates if the cluster has a Multi-AZ configuration (multiaz) or not (singleaz).</p>
    #[doc(hidden)]pub availability_mode: std::option::Option<crate::model::AzStatus>,
    /// <p>The cluster's configuration endpoint</p>
    #[doc(hidden)]pub cluster_endpoint: std::option::Option<crate::model::Endpoint>,
    ...
    #[doc(hidden)]pub engine_patch_version: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub tls_enabled: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub sns_topic_status: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub snapshot_retention_limit: std::option::Option<i32>,
    /// <p>Specifies the weekly time range during which maintenance on the cluster is performed. It is specified as a range in the format ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period. </p>
    #[doc(hidden)]pub maintenance_window: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub snapshot_window: std::option::Option<std::string::String>,
    /// <p>The name of the Access Control List associated with this cluster.</p>
    #[doc(hidden)]pub acl_name: std::option::Option<std::string::String>,
...
pub struct Shard  {
    ...
    #[doc(hidden)]pub slots: std::option::Option<std::string::String>,
...
pub struct ClusterPendingUpdates  {
    ...
    #[doc(hidden)]pub resharding: std::option::Option<crate::model::ReshardingStatus>,
    /// <p>A list of ACLs associated with the cluster that are being updated</p>
    #[doc(hidden)]pub ac_ls: std::option::Option<crate::model::AcLsUpdateStatus>,
    /// <p>A list of service updates being applied to the cluster</p>
    #[doc(hidden)]pub service_updates: std::option::Option<std::vec::Vec<crate::model::PendingModifiedServiceUpdate>>,
}
...
pub struct PendingModifiedServiceUpdate  {
    ...
    #[doc(hidden)]pub service_update_name: std::option::Option<std::string::String>,
    /// <p>The status of the service update</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ServiceUpdateStatus>,
}
...
pub struct AcLsUpdateStatus  {
    ...
    #[doc(hidden)]pub acl_to_apply: std::option::Option<std::string::String>,
}
...
pub struct ReshardingStatus  {
    ...
    #[doc(hidden)]pub slot_migration: std::option::Option<crate::model::SlotMigration>,
}
...
pub struct SlotMigration  {
    ...
    #[doc(hidden)]pub progress_percentage: f64,
}
impl SlotMigration {
    /// <p>The percentage of the slot migration that is complete.</p>
...
pub struct ShardConfigurationRequest  {
    /// <p>The number of shards in the cluster</p>
    #[doc(hidden)]pub shard_count: i32,
}
...
pub struct ReplicaConfigurationRequest  {
    ...
    #[doc(hidden)]pub replica_count: i32,
}
...
pub struct Acl  {
    ...
    #[doc(hidden)]pub user_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The minimum engine version supported for the ACL</p>
    #[doc(hidden)]pub minimum_engine_version: std::option::Option<std::string::String>,
    /// <p>A list of updates being applied to the ACL.</p>
    #[doc(hidden)]pub pending_changes: std::option::Option<crate::model::AclPendingChanges>,
...
pub struct AclPendingChanges  {
    ...
    #[doc(hidden)]pub user_names_to_remove: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of users being added to the ACL</p>
    #[doc(hidden)]pub user_names_to_add: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct Snapshot  {
    ...
    #[doc(hidden)]pub cluster_configuration: std::option::Option<crate::model::ClusterConfiguration>,
}
impl Snapshot {
    /// <p>The name of the snapshot</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ClusterConfiguration  {
    ...
    #[doc(hidden)]pub snapshot_window: std::option::Option<std::string::String>,
    /// <p>The number of shards in the cluster</p>
    #[doc(hidden)]pub num_shards: std::option::Option<i32>,
    /// <p>The list of shards in the cluster</p>
    #[doc(hidden)]pub shards: std::option::Option<std::vec::Vec<crate::model::ShardDetail>>,
}
...
pub struct ShardDetail  {
    ...
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::ShardConfiguration>,
    /// <p>The size of the shard's snapshot</p>
    #[doc(hidden)]pub size: std::option::Option<std::string::String>,
    /// <p>The date and time that the shard's snapshot was created</p>
    #[doc(hidden)]pub snapshot_creation_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl ShardDetail {
    /// <p>The name of the shard</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ShardConfiguration  {
    ...
    #[doc(hidden)]pub replica_count: std::option::Option<i32>,
}
...
pub struct ServiceUpdate  {
    ...
    #[doc(hidden)]pub release_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Provides details of the service update</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>The status of the service update</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ServiceUpdateStatus>,
    /// <p>Reflects the nature of the service update</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ServiceUpdateType>,
    /// <p>A list of nodes updated by the service update</p>
    #[doc(hidden)]pub nodes_updated: std::option::Option<std::string::String>,
    /// <p>The date at which the service update will be automatically applied</p>
    #[doc(hidden)]pub auto_update_start_date: std::option::Option<aws_smithy_types::DateTime>,
}
impl ServiceUpdate {
    /// <p>The name of the cluster to which the service update applies</p>
...
pub struct ServiceUpdateRequest  {
    /// <p>The unique ID of the service update</p>
    #[doc(hidden)]pub service_update_name_to_apply: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ServiceUpdateRequest  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("service_update_name_to_apply", &self.service_update_name_to_apply);
        formatter.finish()
    }
}
