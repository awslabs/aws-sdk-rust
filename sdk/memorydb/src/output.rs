...
pub struct UpdateAclOutput  {
    ...
    #[doc(hidden)]pub acl: std::option::Option<crate::model::Acl>,
}
...
pub struct ListAllowedNodeTypeUpdatesOutput  {
    ...
    #[doc(hidden)]pub scale_up_node_types: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list node types which you can use to scale down your cluster.</p>
    #[doc(hidden)]pub scale_down_node_types: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct DescribeServiceUpdatesOutput  {
    ...
    #[doc(hidden)]pub service_updates: std::option::Option<std::vec::Vec<crate::model::ServiceUpdate>>,
}
...
pub struct DescribeEngineVersionsOutput  {
    ...
    #[doc(hidden)]pub engine_versions: std::option::Option<std::vec::Vec<crate::model::EngineVersionInfo>>,
}
...
pub struct DescribeAcLsOutput  {
    ...
    #[doc(hidden)]pub ac_ls: std::option::Option<std::vec::Vec<crate::model::Acl>>,
...
pub struct BatchUpdateClusterOutput  {
    ...
    #[doc(hidden)]pub processed_clusters: std::option::Option<std::vec::Vec<crate::model::Cluster>>,
    /// <p>The list of clusters where updates have not been applied.</p>
    #[doc(hidden)]pub unprocessed_clusters: std::option::Option<std::vec::Vec<crate::model::UnprocessedCluster>>,
}
