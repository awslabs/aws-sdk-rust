...
impl DescribeServiceUpdatesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeServiceUpdates`](crate::operation::describe_service_updates::DescribeServiceUpdates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_service_updates::DescribeServiceUpdates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_service_updates::DescribeServiceUpdatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_service_updates::ser_describe_service_updates_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_service_updates::DescribeServiceUpdates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeServiceUpdates", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeServiceUpdates {
                type Output = std::result::Result<crate::operation::describe_service_updates::DescribeServiceUpdatesOutput, crate::operation::describe_service_updates::DescribeServiceUpdatesError>;
