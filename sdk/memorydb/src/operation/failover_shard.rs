...
impl FailoverShardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::failover_shard::FailoverShard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for FailoverShard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_failover_shard::de_failover_shard_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_failover_shard::de_failover_shard_http_response_with_props(
                status, headers, body,
            )
        }
    }
