...
impl UpdateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MemoryDB", "UpdateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateCluster", "MemoryDB"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("SnsTopicStatus") {
            if let ::std::option::Option::Some(value) = input.sns_topic_status.as_deref() {
                captured.insert("SnsTopicStatus", value);
            }
        }
...
impl UpdateClusterError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidNodeStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
