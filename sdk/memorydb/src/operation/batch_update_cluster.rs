...
impl BatchUpdateClusterInput {
    /// Consumes the builder and constructs an Operation<[`BatchUpdateCluster`](crate::operation::batch_update_cluster::BatchUpdateCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_update_cluster::BatchUpdateCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_update_cluster::BatchUpdateClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_cluster::ser_batch_update_cluster_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_update_cluster::BatchUpdateCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchUpdateCluster", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchUpdateCluster {
                type Output = std::result::Result<crate::operation::batch_update_cluster::BatchUpdateClusterOutput, crate::operation::batch_update_cluster::BatchUpdateClusterError>;
