...
impl BatchUpdateClusterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_update_cluster::ser_batch_update_cluster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpdateCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_update_cluster::de_batch_update_cluster_http_response_with_props(status, headers, body)
        }
    }
}
