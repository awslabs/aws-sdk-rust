...
/// Orchestration and serialization glue logic for `BatchUpdateCluster`.
...
impl BatchUpdateCluster {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_update_cluster::BatchUpdateClusterInput,
                    ) -> ::std::result::Result<crate::operation::batch_update_cluster::BatchUpdateClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_update_cluster::BatchUpdateClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_update_cluster::BatchUpdateClusterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_update_cluster::BatchUpdateClusterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchUpdateCluster {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchUpdateCluster");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchUpdateClusterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchUpdateClusterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchUpdateCluster")
...
.with_interceptor(BatchUpdateClusterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_update_cluster::BatchUpdateClusterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_update_cluster::BatchUpdateClusterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_update_cluster::BatchUpdateClusterError>::new());
...
#[derive(Debug)]
            struct BatchUpdateClusterResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchUpdateClusterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_update_cluster::de_batch_update_cluster_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_update_cluster::de_batch_update_cluster_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchUpdateClusterRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchUpdateClusterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_update_cluster::BatchUpdateClusterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_update_cluster::BatchUpdateClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_update_cluster::ser_batch_update_cluster_input(&input)?);
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchUpdateClusterEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchUpdateClusterInput>()
                        .ok_or("failed to downcast to BatchUpdateClusterInput")?;
...
pub enum BatchUpdateClusterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchUpdateClusterError) for what information is available for the error.")]
...
impl BatchUpdateClusterError {
    /// Creates the `BatchUpdateClusterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchUpdateClusterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchUpdateClusterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_update_cluster::BatchUpdateClusterError {
...
mod _batch_update_cluster_output;
