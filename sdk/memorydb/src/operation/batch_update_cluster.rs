...
impl BatchUpdateClusterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_cluster::ser_batch_update_cluster_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_update_cluster::BatchUpdateCluster::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_update_cluster::BatchUpdateClusterError
{
