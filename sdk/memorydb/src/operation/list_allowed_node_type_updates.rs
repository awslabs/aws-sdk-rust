...
impl ListAllowedNodeTypeUpdatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAllowedNodeTypeUpdates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_allowed_node_type_updates::de_list_allowed_node_type_updates_http_response_with_props(
                status, headers, body,
            )
        }
    }
