...
impl ListAllowedNodeTypeUpdates {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListAllowedNodeTypeUpdates",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAllowedNodeTypeUpdates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAllowedNodeTypeUpdatesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAllowedNodeTypeUpdatesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAllowedNodeTypeUpdates")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAllowedNodeTypeUpdates")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListAllowedNodeTypeUpdatesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListAllowedNodeTypeUpdatesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAllowedNodeTypeUpdatesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAllowedNodeTypeUpdatesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAllowedNodeTypeUpdatesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_allowed_node_type_updates::de_list_allowed_node_type_updates_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_allowed_node_type_updates::de_list_allowed_node_type_updates_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAllowedNodeTypeUpdatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_allowed_node_type_updates::ser_list_allowed_node_type_updates_input(&input)?,
        );
