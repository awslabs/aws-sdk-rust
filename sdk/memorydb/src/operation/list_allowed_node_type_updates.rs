...
impl ListAllowedNodeTypeUpdatesInput {
    /// Consumes the builder and constructs an Operation<[`ListAllowedNodeTypeUpdates`](crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_allowed_node_type_updates::ser_list_allowed_node_type_updates_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAllowedNodeTypeUpdates", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAllowedNodeTypeUpdates {
                type Output = std::result::Result<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesOutput, crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>;
