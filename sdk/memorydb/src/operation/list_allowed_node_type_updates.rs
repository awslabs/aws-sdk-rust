...
/// Orchestration and serialization glue logic for `ListAllowedNodeTypeUpdates`.
...
impl ListAllowedNodeTypeUpdates {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput,
                    ) -> ::std::result::Result<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAllowedNodeTypeUpdates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAllowedNodeTypeUpdates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAllowedNodeTypeUpdatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAllowedNodeTypeUpdatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAllowedNodeTypeUpdates")
...
.with_interceptor(ListAllowedNodeTypeUpdatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError>::new());
...
#[derive(Debug)]
            struct ListAllowedNodeTypeUpdatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAllowedNodeTypeUpdatesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_allowed_node_type_updates::de_list_allowed_node_type_updates_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAllowedNodeTypeUpdatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAllowedNodeTypeUpdatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_allowed_node_type_updates::ser_list_allowed_node_type_updates_input(&input)?);
...
#[derive(Debug)]
            struct ListAllowedNodeTypeUpdatesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAllowedNodeTypeUpdatesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAllowedNodeTypeUpdatesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAllowedNodeTypeUpdatesInput>()
                        .ok_or("failed to downcast to ListAllowedNodeTypeUpdatesInput")?;
...
pub enum ListAllowedNodeTypeUpdatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAllowedNodeTypeUpdatesError) for what information is available for the error.")]
...
impl ListAllowedNodeTypeUpdatesError {
    /// Creates the `ListAllowedNodeTypeUpdatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAllowedNodeTypeUpdatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAllowedNodeTypeUpdatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_allowed_node_type_updates::ListAllowedNodeTypeUpdatesError {
...
mod _list_allowed_node_type_updates_output;
