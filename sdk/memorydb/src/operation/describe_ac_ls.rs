...
impl DescribeAcLsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_ac_ls::DescribeACLs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_ac_ls::ser_describe_ac_ls_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeACLs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_ac_ls::de_describe_ac_ls_http_response_with_props(status, headers, body)
        }
    }
}
