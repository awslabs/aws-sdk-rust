...
/// Orchestration and serialization glue logic for `DescribeACLs`.
...
impl DescribeACLs {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::describe_ac_ls::DescribeAcLsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_ac_ls::DescribeACLsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_ac_ls::DescribeAcLsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("memorydb", "DescribeACLs", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeACLs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeACLs");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeACLs", "memorydb"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeACLs")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DescribeACLsEndpointParamsInterceptor) as _),
        )
    }
}

#[derive(Debug)]
struct DescribeACLsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeACLsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_describe_ac_ls::de_describe_ac_ls_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_describe_ac_ls::de_describe_ac_ls_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DescribeACLsRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeACLsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_ac_ls::DescribeAcLsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_ac_ls::DescribeAcLsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_ac_ls::ser_describe_ac_ls_input(&input)?);
...
#[derive(Debug)]
struct DescribeACLsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeACLsEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DescribeAcLsInput>()
            .ok_or("failed to downcast to DescribeAcLsInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_ac_ls::DescribeACLsError {
...
pub use crate::operation::describe_ac_ls::_describe_ac_ls_output::DescribeAcLsOutput;

pub use crate::operation::describe_ac_ls::_describe_ac_ls_input::DescribeAcLsInput;

mod _describe_ac_ls_input;

mod _describe_ac_ls_output;
