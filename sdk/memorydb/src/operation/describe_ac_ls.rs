...
impl DescribeAcLsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeACLs`](crate::operation::describe_ac_ls::DescribeACLs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_ac_ls::DescribeACLs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_ac_ls::DescribeAcLsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_ac_ls::ser_describe_ac_ls_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ac_ls::DescribeACLs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeACLs", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeACLs {
                type Output = std::result::Result<crate::operation::describe_ac_ls::DescribeAcLsOutput, crate::operation::describe_ac_ls::DescribeACLsError>;
