    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_ac_ls::DescribeACLsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_ac_ls::DescribeAcLsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeACLsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_ac_ls::DescribeAcLsInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeACLsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DescribeACLsEndpointParamsInterceptor"
    }
