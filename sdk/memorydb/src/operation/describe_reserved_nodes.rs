...
impl DescribeReservedNodesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReservedNodes`](crate::operation::describe_reserved_nodes::DescribeReservedNodes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_reserved_nodes::DescribeReservedNodes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_reserved_nodes::DescribeReservedNodesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_reserved_nodes::ser_describe_reserved_nodes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_nodes::DescribeReservedNodes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReservedNodes", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReservedNodes {
                type Output = std::result::Result<crate::operation::describe_reserved_nodes::DescribeReservedNodesOutput, crate::operation::describe_reserved_nodes::DescribeReservedNodesError>;
