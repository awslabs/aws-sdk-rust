...
impl DeleteAclInput {
    /// Consumes the builder and constructs an Operation<[`DeleteACL`](crate::operation::delete_acl::DeleteACL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_acl::DeleteACL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_acl::DeleteAclInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_acl::ser_delete_acl_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_acl::DeleteACL::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteACL", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteACL {
                type Output = std::result::Result<crate::operation::delete_acl::DeleteAclOutput, crate::operation::delete_acl::DeleteACLError>;
