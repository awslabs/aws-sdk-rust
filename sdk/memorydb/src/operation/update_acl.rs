...
impl UpdateAclInput {
    /// Consumes the builder and constructs an Operation<[`UpdateACL`](crate::operation::update_acl::UpdateACL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_acl::UpdateACL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_acl::UpdateAclInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_acl::ser_update_acl_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_acl::UpdateACL::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateACL", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateACL {
                type Output = std::result::Result<crate::operation::update_acl::UpdateAclOutput, crate::operation::update_acl::UpdateACLError>;
