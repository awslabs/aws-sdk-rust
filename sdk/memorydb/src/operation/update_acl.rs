...
impl UpdateAclInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_acl::UpdateACL, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_acl::ser_update_acl_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateACL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_acl::de_update_acl_http_response_with_props(status, headers, body)
        }
    }
}
