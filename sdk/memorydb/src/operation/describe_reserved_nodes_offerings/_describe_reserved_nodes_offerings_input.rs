...
impl DescribeReservedNodesOfferingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_reserved_nodes_offerings::DescribeReservedNodesOfferingsInput, ::aws_smithy_types::error::operation::BuildError> {
