...
impl CreateAclInput {
    /// Consumes the builder and constructs an Operation<[`CreateACL`](crate::operation::create_acl::CreateACL)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_acl::CreateACL, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_acl::ser_create_acl_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_acl::CreateACL::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateACL", "memorydb"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateACL {
    type Output = ::std::result::Result<crate::operation::create_acl::CreateAclOutput, crate::operation::create_acl::CreateACLError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_acl::de_create_acl_http_response_with_props(status, headers, body)
        }
    }
}
