...
impl ResetParameterGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_parameter_group::ser_reset_parameter_group_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_parameter_group::ResetParameterGroup::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::reset_parameter_group::ResetParameterGroupError
{
