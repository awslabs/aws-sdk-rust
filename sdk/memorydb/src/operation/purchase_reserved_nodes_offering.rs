...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseReservedNodesOffering {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purchase_reserved_nodes_offering::de_purchase_reserved_nodes_offering_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::purchase_reserved_nodes_offering::PurchaseReservedNodesOfferingError
{
