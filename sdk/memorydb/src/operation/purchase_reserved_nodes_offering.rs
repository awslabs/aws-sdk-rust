    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::purchase_reserved_nodes_offering::PurchaseReservedNodesOfferingError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::purchase_reserved_nodes_offering::PurchaseReservedNodesOfferingOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PurchaseReservedNodesOfferingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PurchaseReservedNodesOfferingRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PurchaseReservedNodesOfferingEndpointParamsInterceptor {
