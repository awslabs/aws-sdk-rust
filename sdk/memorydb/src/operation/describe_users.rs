...
impl DescribeUsersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_users::DescribeUsers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_users::ser_describe_users_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUsers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_users::de_describe_users_http_response_with_props(status, headers, body)
        }
    }
}
