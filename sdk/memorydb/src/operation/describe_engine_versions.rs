...
impl DescribeEngineVersionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEngineVersions`](crate::operation::describe_engine_versions::DescribeEngineVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_engine_versions::DescribeEngineVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_engine_versions::DescribeEngineVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_engine_versions::ser_describe_engine_versions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_engine_versions::DescribeEngineVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeEngineVersions", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEngineVersions {
                type Output = std::result::Result<crate::operation::describe_engine_versions::DescribeEngineVersionsOutput, crate::operation::describe_engine_versions::DescribeEngineVersionsError>;
