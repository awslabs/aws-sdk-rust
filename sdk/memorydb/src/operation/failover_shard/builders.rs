...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::failover_shard::FailoverShardOutput,
                    crate::operation::failover_shard::FailoverShardError,
                > for FailoverShardFluentBuilder
            {
                fn send(
                    self,
...
impl FailoverShardFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::failover_shard::FailoverShardOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::failover_shard::FailoverShardError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::failover_shard::FailoverShard::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::failover_shard::FailoverShard::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::failover_shard::FailoverShardOutput, crate::operation::failover_shard::FailoverShardError, Self> {
