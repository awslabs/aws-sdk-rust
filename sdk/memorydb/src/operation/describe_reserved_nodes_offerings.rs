...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedNodesOfferings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_nodes_offerings::de_describe_reserved_nodes_offerings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_reserved_nodes_offerings::DescribeReservedNodesOfferingsError
{
