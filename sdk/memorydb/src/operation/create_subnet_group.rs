...
impl CreateSubnetGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_subnet_group::CreateSubnetGroup,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_subnet_group::ser_create_subnet_group_input(&self)?);
