...
impl CreateSubnetGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateSubnetGroup`](crate::operation::create_subnet_group::CreateSubnetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_subnet_group::CreateSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_subnet_group::CreateSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_subnet_group::CreateSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSubnetGroup", "memorydb"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSubnetGroup {
                type Output = std::result::Result<crate::operation::create_subnet_group::CreateSubnetGroupOutput, crate::operation::create_subnet_group::CreateSubnetGroupError>;
