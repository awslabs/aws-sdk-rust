...
impl Client  {
    ...
    pub fn describe_reserved_nodes_offerings(&self) -> fluent_builders::DescribeReservedNodesOfferings {
    ...
    pub fn purchase_reserved_nodes_offering(&self) -> fluent_builders::PurchaseReservedNodesOffering {
