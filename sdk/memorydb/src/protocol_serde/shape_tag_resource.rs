...
> {
    ...
    Err(match error_code {
        ...
        "SnapshotNotFoundFault" => {
            crate::operation::tag_resource::TagResourceError::SnapshotNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "SubnetGroupNotFoundFault" => {
            crate::operation::tag_resource::TagResourceError::SubnetGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UserNotFoundFault" => {
            crate::operation::tag_resource::TagResourceError::UserNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
