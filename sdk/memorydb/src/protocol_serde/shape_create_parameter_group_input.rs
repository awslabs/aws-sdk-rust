...
pub fn ser_create_parameter_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateParameterGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
