...
pub fn de_update_acl_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_acl::UpdateAclOutput, crate::operation::update_acl::UpdateACLError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_acl_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_acl::UpdateAclOutput, crate::operation::update_acl::UpdateACLError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_acl_input(input: &crate::operation::update_acl::UpdateAclInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
