...
pub fn ser_describe_reserved_nodes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReservedNodesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
