...
pub fn ser_describe_users_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeUsersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
