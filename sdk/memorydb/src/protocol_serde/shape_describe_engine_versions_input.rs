...
pub fn ser_describe_engine_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEngineVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
