...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::failover_shard::FailoverShardError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_failover_shard::de_failover_shard(_response_body, output)
                .map_err(crate::operation::failover_shard::FailoverShardError::unhandled)?;
