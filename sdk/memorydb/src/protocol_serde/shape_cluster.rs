                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AvailabilityMode" => {
                            builder = builder.set_availability_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AzStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ClusterEndpoint" => {
                            builder = builder.set_cluster_endpoint(crate::protocol_serde::shape_endpoint::de_endpoint(tokens)?);
                        }
                        "NodeType" => {
                        ...
                        "IpDiscovery" => {
                            builder = builder.set_ip_discovery(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::IpDiscovery::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
