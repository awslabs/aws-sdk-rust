...
impl super::Client {
    ...
    ///   - [`cluster_name(impl ::std::convert::Into<String>)`](crate::operation::describe_clusters::builders::DescribeClustersFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::describe_clusters::builders::DescribeClustersFluentBuilder::set_cluster_name): <p>The name of the cluster</p>
