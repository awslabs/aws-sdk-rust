...
impl super::Client {
    ...
    pub fn purchase_reserved_nodes_offering(
        &self,
    ) -> crate::operation::purchase_reserved_nodes_offering::builders::PurchaseReservedNodesOfferingFluentBuilder {
