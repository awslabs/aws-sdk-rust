...
impl super::Client {
    ...
    ///   - [`source_snapshot_name(impl Into<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::source_snapshot_name) / [`set_source_snapshot_name(Option<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::set_source_snapshot_name):<br>required: **true**<br><p>The name of an existing snapshot from which to make a copy.</p><br>
    ///   - [`target_snapshot_name(impl Into<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::target_snapshot_name) / [`set_target_snapshot_name(Option<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::set_target_snapshot_name):<br>required: **true**<br><p>A name for the snapshot copy. MemoryDB does not permit overwriting a snapshot, therefore this name must be unique within its context - MemoryDB or an Amazon S3 bucket if exporting.</p><br>
    ///   - [`target_bucket(impl Into<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::target_bucket) / [`set_target_bucket(Option<String>)`](crate::operation::copy_snapshot::builders::CopySnapshotFluentBuilder::set_target_bucket):<br>required: **false**<br><p>The Amazon S3 bucket to which the snapshot is exported. This parameter is used only when exporting a snapshot for external access. When using this parameter to export a snapshot, be sure MemoryDB has the needed permissions to this S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/MemoryDB/latest/devguide/snapshots-exporting.html">Step 2: Grant MemoryDB Access to Your Amazon S3 Bucket</a>.</p><br>
