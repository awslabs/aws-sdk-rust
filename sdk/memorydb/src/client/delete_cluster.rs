...
impl super::Client {
    ...
    ///   - [`final_snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::final_snapshot_name) / [`set_final_snapshot_name(Option<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::set_final_snapshot_name): <p>The user-supplied name of a final cluster snapshot. This is the unique name that identifies the snapshot. MemoryDB creates the snapshot, and then deletes the cluster immediately afterward.</p>
