...
impl super::Client {
    ...
    ///   - [`snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::set_snapshot_name): <p>The name of the snapshot to delete</p>
