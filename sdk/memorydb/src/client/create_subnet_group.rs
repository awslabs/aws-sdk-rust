...
impl super::Client {
    ...
    ///   - [`subnet_group_name(impl Into<String>)`](crate::operation::create_subnet_group::builders::CreateSubnetGroupFluentBuilder::subnet_group_name) / [`set_subnet_group_name(Option<String>)`](crate::operation::create_subnet_group::builders::CreateSubnetGroupFluentBuilder::set_subnet_group_name):<br>required: **true**<br><p>The name of the subnet group.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::create_subnet_group::builders::CreateSubnetGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_subnet_group::builders::CreateSubnetGroupFluentBuilder::set_description):<br>required: **false**<br><p>A description for the subnet group.</p><br>
