...
impl super::Client {
    ...
    ///   - [`subnet_group_name(impl ::std::convert::Into<String>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::subnet_group_name) / [`set_subnet_group_name(Option<String>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::set_subnet_group_name): <p>The name of the subnet group</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::set_description): <p>A description of the subnet group</p>
