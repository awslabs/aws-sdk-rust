...
impl smithy_types::retry::ProvideErrorKind for AssociateAliasError {
...
impl AssociateAliasError {
    pub fn new(kind: AssociateAliasErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for ListConflictingAliasesError {
    fn code(&self) -> Option<&str> {
...
impl ListConflictingAliasesError {
    pub fn new(kind: ListConflictingAliasesErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
