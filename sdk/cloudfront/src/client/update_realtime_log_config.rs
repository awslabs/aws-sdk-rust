...
impl super::Client {
    ...
    ///   - [`end_points(EndPoint)`](crate::operation::update_realtime_log_config::builders::UpdateRealtimeLogConfigFluentBuilder::end_points) / [`set_end_points(Option<Vec<EndPoint>>)`](crate::operation::update_realtime_log_config::builders::UpdateRealtimeLogConfigFluentBuilder::set_end_points): <p>Contains information about the Amazon Kinesis data stream where you are sending real-time log data.</p>
    ///   - [`fields(impl Into<String>)`](crate::operation::update_realtime_log_config::builders::UpdateRealtimeLogConfigFluentBuilder::fields) / [`set_fields(Option<Vec<String>>)`](crate::operation::update_realtime_log_config::builders::UpdateRealtimeLogConfigFluentBuilder::set_fields): <p>A list of fields to include in each real-time log record.</p>  <p>For more information about fields, see <a href="https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/real-time-logs.html#understand-real-time-log-config-fields">Real-time log configuration fields</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>
