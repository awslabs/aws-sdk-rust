...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_streaming_distribution_config::builders::GetStreamingDistributionConfigFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_streaming_distribution_config::builders::GetStreamingDistributionConfigFluentBuilder::set_id): <p>The streaming distribution's ID.</p>
