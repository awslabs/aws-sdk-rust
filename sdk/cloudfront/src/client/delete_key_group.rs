...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_key_group::builders::DeleteKeyGroupFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_key_group::builders::DeleteKeyGroupFluentBuilder::set_id): <p>The identifier of the key group that you are deleting. To get the identifier, use <code>ListKeyGroups</code>.</p>
