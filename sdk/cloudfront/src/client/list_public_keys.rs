...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_public_keys::builders::ListPublicKeysFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_public_keys::builders::ListPublicKeysFluentBuilder::set_marker): <p>Use this when paginating results to indicate where to begin in your list of public keys. The results include public keys in the list that occur after the marker. To get the next page of results, set the <code>Marker</code> to the value of the <code>NextMarker</code> from the current page's response (which is also the ID of the last public key on that page).</p>
