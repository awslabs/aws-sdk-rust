...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::set_id): <p>The identifier of the public key that you are updating.</p>
    ///   - [`if_match(impl ::std::convert::Into<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::if_match) / [`set_if_match(Option<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::set_if_match): <p>The value of the <code>ETag</code> header that you received when retrieving the public key to update. For example: <code>E2QWRUHAPOMQZL</code>.</p>
