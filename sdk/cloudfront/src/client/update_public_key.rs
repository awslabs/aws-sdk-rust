...
impl super::Client {
    ...
    ///   - [`public_key_config(PublicKeyConfig)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::public_key_config) / [`set_public_key_config(Option<PublicKeyConfig>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::set_public_key_config):<br>required: **true**<br><p>A public key configuration.</p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the public key that you are updating.</p><br>
    ///   - [`if_match(impl Into<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::if_match) / [`set_if_match(Option<String>)`](crate::operation::update_public_key::builders::UpdatePublicKeyFluentBuilder::set_if_match):<br>required: **false**<br><p>The value of the <code>ETag</code> header that you received when retrieving the public key to update. For example: <code>E2QWRUHAPOMQZL</code>.</p><br>
