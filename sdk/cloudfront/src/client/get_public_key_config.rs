...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_public_key_config::builders::GetPublicKeyConfigFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_public_key_config::builders::GetPublicKeyConfigFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the public key whose configuration you are getting.</p><br>
