...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_streaming_distribution::builders::GetStreamingDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_streaming_distribution::builders::GetStreamingDistributionFluentBuilder::set_id):<br>required: **true**<br><p>The streaming distribution's ID.</p><br>
