...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_distribution::builders::GetDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_distribution::builders::GetDistributionFluentBuilder::set_id):<br>required: **true**<br><p>The distribution's ID. If the ID is empty, an empty distribution configuration is returned.</p><br>
