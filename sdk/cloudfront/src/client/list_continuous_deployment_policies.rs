...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_continuous_deployment_policies::builders::ListContinuousDeploymentPoliciesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_continuous_deployment_policies::builders::ListContinuousDeploymentPoliciesFluentBuilder::set_marker): <p>Use this field when paginating results to indicate where to begin in your list of continuous deployment policies. The response includes policies in the list that occur after the marker. To get the next page of the list, set this field's value to the value of <code>NextMarker</code> from the current page's response.</p>
