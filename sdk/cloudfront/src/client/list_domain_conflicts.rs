...
impl super::Client {
    ...
    ///   - [`domain_control_validation_resource(DistributionResourceId)`](crate::operation::list_domain_conflicts::builders::ListDomainConflictsFluentBuilder::domain_control_validation_resource) / [`set_domain_control_validation_resource(Option<DistributionResourceId>)`](crate::operation::list_domain_conflicts::builders::ListDomainConflictsFluentBuilder::set_domain_control_validation_resource):<br>required: **true**<br><p>The distribution resource identifier. This can be the distribution or distribution tenant that has a valid certificate, which covers the domain that you specify.</p><br>
