...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_public_key::builders::GetPublicKeyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_public_key::builders::GetPublicKeyFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the public key you are getting.</p><br>
