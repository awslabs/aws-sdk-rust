...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_response_headers_policy::builders::GetResponseHeadersPolicyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_response_headers_policy::builders::GetResponseHeadersPolicyFluentBuilder::set_id): <p>The identifier for the response headers policy.</p>  <p>If the response headers policy is attached to a distribution's cache behavior, you can get the policy's identifier using <code>ListDistributions</code> or <code>GetDistribution</code>. If the response headers policy is not attached to a cache behavior, you can get the identifier using <code>ListResponseHeadersPolicies</code>.</p>
