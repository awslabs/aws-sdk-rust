...
impl super::Client {
    ...
    ///   - [`use_client_certificate_ocsp_endpoint(bool)`](crate::operation::create_trust_store::builders::CreateTrustStoreFluentBuilder::use_client_certificate_ocsp_endpoint) / [`set_use_client_certificate_ocsp_endpoint(Option<bool>)`](crate::operation::create_trust_store::builders::CreateTrustStoreFluentBuilder::set_use_client_certificate_ocsp_endpoint):<br>required: **false**<br><p>A Boolean that determines whether to use the CA certificate's OCSP endpoint to check certificate revocation status.</p><br>
