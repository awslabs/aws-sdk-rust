...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_cloud_front_origin_access_identity::builders::GetCloudFrontOriginAccessIdentityFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_cloud_front_origin_access_identity::builders::GetCloudFrontOriginAccessIdentityFluentBuilder::set_id): <p>The identity's ID.</p>
