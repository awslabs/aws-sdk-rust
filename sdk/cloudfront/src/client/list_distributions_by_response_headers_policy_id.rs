...
impl super::Client {
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::set_marker):<br>required: **false**<br><p>Use this field when paginating results to indicate where to begin in your list of distribution IDs. The response includes distribution IDs in the list that occur after the marker. To get the next page of the list, set this field's value to the value of <code>NextMarker</code> from the current page's response.</p><br>
    ///   - [`max_items(i32)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::set_max_items):<br>required: **false**<br><p>The maximum number of distribution IDs that you want to get in the response.</p><br>
    ///   - [`response_headers_policy_id(impl Into<String>)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::response_headers_policy_id) / [`set_response_headers_policy_id(Option<String>)`](crate::operation::list_distributions_by_response_headers_policy_id::builders::ListDistributionsByResponseHeadersPolicyIdFluentBuilder::set_response_headers_policy_id):<br>required: **true**<br><p>The ID of the response headers policy whose associated distribution IDs you want to list.</p><br>
