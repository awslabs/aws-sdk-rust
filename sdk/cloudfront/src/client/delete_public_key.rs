...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_public_key::builders::DeletePublicKeyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_public_key::builders::DeletePublicKeyFluentBuilder::set_id): <p>The ID of the public key you want to remove from CloudFront.</p>
