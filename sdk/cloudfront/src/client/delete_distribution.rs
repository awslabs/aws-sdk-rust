...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_distribution::builders::DeleteDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_distribution::builders::DeleteDistributionFluentBuilder::set_id):<br>required: **true**<br><p>The distribution ID.</p><br>
    ///   - [`if_match(impl Into<String>)`](crate::operation::delete_distribution::builders::DeleteDistributionFluentBuilder::if_match) / [`set_if_match(Option<String>)`](crate::operation::delete_distribution::builders::DeleteDistributionFluentBuilder::set_if_match):<br>required: **false**<br><p>The value of the <code>ETag</code> header that you received when you disabled the distribution. For example: <code>E2QWRUHAPOMQZL</code>.</p><br>
