...
impl super::Client {
    ...
    ///   - [`tags(Tags)`](crate::operation::create_key_value_store::builders::CreateKeyValueStoreFluentBuilder::tags) / [`set_tags(Option<Tags>)`](crate::operation::create_key_value_store::builders::CreateKeyValueStoreFluentBuilder::set_tags):<br>required: **false**<br><p>A complex type that contains zero or more <code>Tag</code> elements.</p><br>
