...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_distributions::builders::ListDistributionsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_distributions::builders::ListDistributionsFluentBuilder::set_marker): <p>Use this when paginating results to indicate where to begin in your list of distributions. The results include distributions in the list that occur after the marker. To get the next page of results, set the <code>Marker</code> to the value of the <code>NextMarker</code> from the current page's response (which is also the ID of the last distribution on that page).</p>
