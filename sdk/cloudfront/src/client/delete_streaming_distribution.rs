...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_streaming_distribution::builders::DeleteStreamingDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_streaming_distribution::builders::DeleteStreamingDistributionFluentBuilder::set_id): <p>The distribution ID.</p>
