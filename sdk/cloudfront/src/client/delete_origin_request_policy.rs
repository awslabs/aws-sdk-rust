...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_origin_request_policy::builders::DeleteOriginRequestPolicyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_origin_request_policy::builders::DeleteOriginRequestPolicyFluentBuilder::set_id): <p>The unique identifier for the origin request policy that you are deleting. To get the identifier, you can use <code>ListOriginRequestPolicies</code>.</p>
