...
impl super::Client {
    ...
    ///   - [`distribution_id(impl Into<String>)`](crate::operation::get_monitoring_subscription::builders::GetMonitoringSubscriptionFluentBuilder::distribution_id) / [`set_distribution_id(Option<String>)`](crate::operation::get_monitoring_subscription::builders::GetMonitoringSubscriptionFluentBuilder::set_distribution_id):<br>required: **true**<br><p>The ID of the distribution that you are getting metrics information for.</p><br>
