...
impl super::Client {
    ...
    ///   - [`target_distribution_id(impl Into<String>)`](crate::operation::associate_alias::builders::AssociateAliasFluentBuilder::target_distribution_id) / [`set_target_distribution_id(Option<String>)`](crate::operation::associate_alias::builders::AssociateAliasFluentBuilder::set_target_distribution_id):<br>required: **true**<br><p>The ID of the standard distribution that you're associating the alias with.</p><br>
    ///   - [`alias(impl Into<String>)`](crate::operation::associate_alias::builders::AssociateAliasFluentBuilder::alias) / [`set_alias(Option<String>)`](crate::operation::associate_alias::builders::AssociateAliasFluentBuilder::set_alias):<br>required: **true**<br><p>The alias (also known as a CNAME) to add to the target standard distribution.</p><br>
