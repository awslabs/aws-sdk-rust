...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_response_headers_policy::builders::DeleteResponseHeadersPolicyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_response_headers_policy::builders::DeleteResponseHeadersPolicyFluentBuilder::set_id): <p>The identifier for the response headers policy that you are deleting.</p>  <p>To get the identifier, you can use <code>ListResponseHeadersPolicies</code>.</p>
