...
pub fn ser_tags(input: &crate::model::Tags, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_tags(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Tags, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
