...
pub fn ser_headers(input: &crate::model::Headers, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_headers(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Headers, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
