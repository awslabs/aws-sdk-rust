...
pub fn de_origin_request_policy(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::OriginRequestPolicy, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("OriginRequestPolicyConfig") /* OriginRequestPolicyConfig com.amazonaws.cloudfront#OriginRequestPolicy$OriginRequestPolicyConfig */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_origin_request_policy_config::de_origin_request_policy_config(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::origin_request_policy_correct_errors(builder)
        .build()
