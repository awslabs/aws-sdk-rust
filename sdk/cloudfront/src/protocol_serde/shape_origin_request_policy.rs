...
pub fn de_origin_request_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginRequestPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
