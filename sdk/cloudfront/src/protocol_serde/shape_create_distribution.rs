            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_distribution_cnames::de_too_many_distribution_cnames_xml_err(_response_body, output).map_err(crate::operation::create_distribution::CreateDistributionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
