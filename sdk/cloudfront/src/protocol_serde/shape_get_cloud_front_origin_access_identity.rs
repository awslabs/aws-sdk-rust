...
> {
    ...
    Err(match error_code {
        ...
        "NoSuchCloudFrontOriginAccessIdentity" => {
            crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityError::NoSuchCloudFrontOriginAccessIdentity({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cloud_front_origin_access_identity_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_cloud_front_origin_access_identity(
            crate::protocol_serde::shape_get_cloud_front_origin_access_identity_output::de_cloud_front_origin_access_identity_payload(
                _response_body,
            )?,
        );
        output = output.set_e_tag(
            crate::protocol_serde::shape_get_cloud_front_origin_access_identity_output::de_e_tag_header(_response_headers).map_err(|_| {
                crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityError::unhandled(
