...
pub fn de_get_field_level_encryption_profile_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetFieldLevelEncryptionProfileOutput, crate::error::GetFieldLevelEncryptionProfileError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetFieldLevelEncryptionProfileError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_access_denied::de_access_denied_xml_err(response.body().as_ref(), output).map_err(crate::error::GetFieldLevelEncryptionProfileError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_field_level_encryption_profile_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetFieldLevelEncryptionProfileOutput, crate::error::GetFieldLevelEncryptionProfileError> {
    Ok({
        #[allow(unused_mut)]
