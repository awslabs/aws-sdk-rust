...
pub fn ser_function_associations(input: &crate::model::FunctionAssociations, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_function_associations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FunctionAssociations, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
