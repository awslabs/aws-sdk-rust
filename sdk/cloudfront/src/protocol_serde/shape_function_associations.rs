...
pub fn ser_function_associations(input: &crate::types::FunctionAssociations, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
        ...
        for list_item_3 in var_2 {
             {
                ...
                crate::protocol_serde::shape_function_association::ser_function_association(list_item_3, inner_writer)?
            }
        }
    }
    scope.finish();
