...
pub fn ser_function_associations(
    input: &crate::types::FunctionAssociations,
...
pub fn de_function_associations(
...
) -> Result<crate::types::FunctionAssociations, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::function_associations_correct_errors(builder)
        .build()
