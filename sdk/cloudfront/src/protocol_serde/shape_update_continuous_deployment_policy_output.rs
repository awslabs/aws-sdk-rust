...
pub fn de_continuous_deployment_policy_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::ContinuousDeploymentPolicy>, crate::error::UpdateContinuousDeploymentPolicyError> {
    (!body.is_empty()).then(||{
...
pub fn de_continuous_deployment_policy(inp: &[u8]) -> Result<crate::model::ContinuousDeploymentPolicy, aws_smithy_xml::decode::XmlDecodeError> {
