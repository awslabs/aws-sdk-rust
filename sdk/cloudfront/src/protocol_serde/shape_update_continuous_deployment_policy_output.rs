...
pub(crate) fn de_continuous_deployment_policy_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ContinuousDeploymentPolicy>, crate::operation::update_continuous_deployment_policy::UpdateContinuousDeploymentPolicyError> {
    (!body.is_empty()).then(||{
