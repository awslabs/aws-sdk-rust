...
pub fn ser_origin_shield(input: &crate::model::OriginShield, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_shield(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginShield, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
