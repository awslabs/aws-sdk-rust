...
pub fn de_update_streaming_distribution_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_streaming_distribution::UpdateStreamingDistributionOutput, crate::operation::update_streaming_distribution::UpdateStreamingDistributionError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_streaming_distribution_cnames::de_too_many_streaming_distribution_cnames_xml_err(_response_body, output).map_err(crate::operation::update_streaming_distribution::UpdateStreamingDistributionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
