...
pub fn ser_origin_group_members(input: &crate::model::OriginGroupMembers, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_group_members(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginGroupMembers, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
