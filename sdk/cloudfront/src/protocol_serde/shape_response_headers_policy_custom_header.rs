...
pub fn ser_response_headers_policy_custom_header(
    input: &crate::types::ResponseHeadersPolicyCustomHeader,
...
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyCustomHeader, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
