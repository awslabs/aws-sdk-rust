...
pub fn ser_field_patterns(input: &crate::model::FieldPatterns, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_field_patterns(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FieldPatterns, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
