...
> {
    Ok({
        ...
        output = output.set_e_tag(
            match crate::protocol_serde::shape_update_key_value_store_output::de_e_tag_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::update_key_value_store::UpdateKeyValueStoreError::unhandled(
