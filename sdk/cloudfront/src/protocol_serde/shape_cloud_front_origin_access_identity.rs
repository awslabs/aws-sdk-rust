...
pub fn de_cloud_front_origin_access_identity(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudFrontOriginAccessIdentity, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
