...
pub fn de_cloud_front_origin_access_identity(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CloudFrontOriginAccessIdentity, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::cloud_front_origin_access_identity_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
