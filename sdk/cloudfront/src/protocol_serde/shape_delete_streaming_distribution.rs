...
pub fn de_delete_streaming_distribution_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_streaming_distribution::DeleteStreamingDistributionOutput, crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_streaming_distribution_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_streaming_distribution::DeleteStreamingDistributionOutput, crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError> {
    Ok({
        #[allow(unused_mut)]
