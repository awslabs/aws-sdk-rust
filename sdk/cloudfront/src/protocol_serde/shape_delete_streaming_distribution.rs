...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "NoSuchStreamingDistribution" => {
            crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError::NoSuchStreamingDistribution({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "StreamingDistributionNotDisabled" => {
            crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError::StreamingDistributionNotDisabled({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::StreamingDistributionNotDisabledBuilder::default();
                    output = crate::protocol_serde::shape_streaming_distribution_not_disabled::de_streaming_distribution_not_disabled_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError::unhandled)?;
