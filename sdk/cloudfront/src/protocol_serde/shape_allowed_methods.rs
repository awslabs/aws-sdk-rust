...
pub fn ser_allowed_methods(input: &crate::model::AllowedMethods, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_allowed_methods(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AllowedMethods, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
