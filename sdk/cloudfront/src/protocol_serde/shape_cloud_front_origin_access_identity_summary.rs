...
pub fn de_cloud_front_origin_access_identity_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudFrontOriginAccessIdentitySummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
