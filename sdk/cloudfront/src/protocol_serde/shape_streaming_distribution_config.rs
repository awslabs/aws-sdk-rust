...
pub fn ser_streaming_distribution_config(input: &crate::model::StreamingDistributionConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_streaming_distribution_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StreamingDistributionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
