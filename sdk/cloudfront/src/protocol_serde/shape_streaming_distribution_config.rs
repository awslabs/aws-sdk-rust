...
pub fn ser_streaming_distribution_config(input: &crate::types::StreamingDistributionConfig, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_streaming_distribution_config(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StreamingDistributionConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::streaming_distribution_config_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
