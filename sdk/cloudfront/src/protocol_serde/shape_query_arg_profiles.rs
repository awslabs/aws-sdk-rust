...
pub fn ser_query_arg_profiles(input: &crate::model::QueryArgProfiles, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_query_arg_profiles(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::QueryArgProfiles, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
