...
pub fn ser_query_arg_profiles(input: &crate::types::QueryArgProfiles, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
        ...
        for list_item_3 in var_2 {
             {
                ...
                crate::protocol_serde::shape_query_arg_profile::ser_query_arg_profile(list_item_3, inner_writer)?
            }
        }
    }
    scope.finish();
