...
> {
    Ok({
        ...
        output = output.set_e_tag(
            match crate::protocol_serde::shape_get_distribution_tenant_output::de_e_tag_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::get_distribution_tenant::GetDistributionTenantError::unhandled(
