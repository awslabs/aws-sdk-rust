...
pub fn de_field_level_encryption_profile_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::FieldLevelEncryptionProfile>, crate::operation::get_field_level_encryption_profile::GetFieldLevelEncryptionProfileError> {
    (!body.is_empty()).then(||{
