...
pub fn de_list_response_headers_policies_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesOutput, crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesError> {
    #[allow(unused_mut)]
