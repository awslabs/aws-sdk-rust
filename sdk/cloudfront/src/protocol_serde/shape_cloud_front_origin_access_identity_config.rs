...
pub fn ser_cloud_front_origin_access_identity_config(input: &crate::model::CloudFrontOriginAccessIdentityConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cloud_front_origin_access_identity_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudFrontOriginAccessIdentityConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
