...
pub fn ser_origin_request_policy_headers_config(
    input: &crate::types::OriginRequestPolicyHeadersConfig,
...
pub fn de_origin_request_policy_headers_config(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::OriginRequestPolicyHeadersConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::origin_request_policy_headers_config_correct_errors(builder)
        .build()
