...
pub fn ser_origin_request_policy_headers_config(input: &crate::model::OriginRequestPolicyHeadersConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_request_policy_headers_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginRequestPolicyHeadersConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
