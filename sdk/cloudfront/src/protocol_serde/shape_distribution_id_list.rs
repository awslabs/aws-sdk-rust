...
pub fn de_distribution_id_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DistributionIdList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
