...
pub fn ser_origin_access_control_config(input: &crate::model::OriginAccessControlConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_access_control_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginAccessControlConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
