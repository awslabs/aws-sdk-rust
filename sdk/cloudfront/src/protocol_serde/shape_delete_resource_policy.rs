...
> {
    ...
    Err(match error_code {
        "AccessDenied" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::AccessDenied({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "EntityNotFound" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::EntityNotFound({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "IllegalDelete" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::IllegalDelete({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidArgument" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::InvalidArgument({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "PreconditionFailed" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::PreconditionFailed({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedOperation" => crate::operation::delete_resource_policy::DeleteResourcePolicyError::UnsupportedOperation({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_resource_policy_op_input(
    ...
    let mut out = String::new();
    {
        ...
        #[allow(unused_mut)]
        let mut root = writer
            .start_el("DeleteResourcePolicyRequest")
            .write_ns("http://cloudfront.amazonaws.com/doc/2020-05-31/", None);
        crate::protocol_serde::shape_delete_resource_policy_input::ser_delete_resource_policy_input_input_input(input, root)?
    }
