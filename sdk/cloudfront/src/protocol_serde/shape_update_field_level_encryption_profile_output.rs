...
pub fn de_field_level_encryption_profile_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::FieldLevelEncryptionProfile>, crate::error::UpdateFieldLevelEncryptionProfileError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_update_field_level_encryption_profile_output::de_field_level_encryption_profile(body).map_err(crate::error::UpdateFieldLevelEncryptionProfileError::unhandled)
    }).transpose()
}
