...
pub fn ser_content_type_profiles(input: &crate::model::ContentTypeProfiles, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_content_type_profiles(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ContentTypeProfiles, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
