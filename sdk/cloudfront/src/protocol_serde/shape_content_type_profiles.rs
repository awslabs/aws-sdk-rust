...
pub fn ser_content_type_profiles(
    input: &crate::types::ContentTypeProfiles,
        ...
        for list_item_2 in var_1 {
            {
                ...
                crate::protocol_serde::shape_content_type_profile::ser_content_type_profile(list_item_2, inner_writer)?
            }
        }
    }
    scope.finish();
...
pub fn de_content_type_profiles(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::ContentTypeProfiles, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#ContentTypeProfiles$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_content_type_profile_list::de_content_type_profile_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::content_type_profiles_correct_errors(builder)
        .build()
