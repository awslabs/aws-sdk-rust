...
pub fn de_function_summary_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::FunctionSummary>, crate::error::UpdateFunctionError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_update_function_output::de_function_summary(body).map_err(crate::error::UpdateFunctionError::unhandled)
    }).transpose()
}
