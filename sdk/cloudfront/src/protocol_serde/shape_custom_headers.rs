...
pub fn ser_custom_headers(
    input: &crate::types::CustomHeaders,
        ...
        for list_item_2 in var_1 {
            {
                ...
                crate::protocol_serde::shape_origin_custom_header::ser_origin_custom_header(list_item_2, inner_writer)?
            }
        }
    }
    scope.finish();
...
pub fn de_custom_headers(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::CustomHeaders, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#CustomHeaders$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_origin_custom_headers_list::de_origin_custom_headers_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::custom_headers_correct_errors(builder)
        .build()
