...
pub fn ser_custom_headers(input: &crate::model::CustomHeaders, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_custom_headers(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CustomHeaders, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
