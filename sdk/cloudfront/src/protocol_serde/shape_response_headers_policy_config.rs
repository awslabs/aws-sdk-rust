...
pub fn ser_response_headers_policy_config(input: &crate::model::ResponseHeadersPolicyConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
