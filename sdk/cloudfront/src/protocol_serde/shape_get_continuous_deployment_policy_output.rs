...
pub(crate) fn de_continuous_deployment_policy_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ContinuousDeploymentPolicy>, crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError> {
    (!body.is_empty()).then(||{
