...
pub fn ser_paths(input: &crate::model::Paths, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_paths(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Paths, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
