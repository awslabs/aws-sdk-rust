...
pub fn ser_response_headers_policy_strict_transport_security(input: &crate::model::ResponseHeadersPolicyStrictTransportSecurity, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_strict_transport_security(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyStrictTransportSecurity, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
