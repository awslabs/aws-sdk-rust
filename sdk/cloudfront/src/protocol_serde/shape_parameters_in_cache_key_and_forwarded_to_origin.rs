...
pub fn ser_parameters_in_cache_key_and_forwarded_to_origin(input: &crate::model::ParametersInCacheKeyAndForwardedToOrigin, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_parameters_in_cache_key_and_forwarded_to_origin(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ParametersInCacheKeyAndForwardedToOrigin, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
