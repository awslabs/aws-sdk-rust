...
pub(crate) fn de_key_group_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::KeyGroup>, crate::operation::update_key_group::UpdateKeyGroupError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_update_key_group_output::de_key_group(body).map_err(crate::operation::update_key_group::UpdateKeyGroupError::unhandled)
    }).transpose()
}
