...
pub fn de_key_group_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::KeyGroup>, crate::error::UpdateKeyGroupError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_update_key_group_output::de_key_group(body).map_err(crate::error::UpdateKeyGroupError::unhandled)
    }).transpose()
}
