...
pub fn de_streaming_distribution_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StreamingDistributionList, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::streaming_distribution_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
