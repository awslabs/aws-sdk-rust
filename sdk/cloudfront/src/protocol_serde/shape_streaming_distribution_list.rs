...
pub fn de_streaming_distribution_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StreamingDistributionList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
