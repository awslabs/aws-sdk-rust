...
pub(crate) fn de_streaming_distribution_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::StreamingDistribution>, crate::operation::create_streaming_distribution_with_tags::CreateStreamingDistributionWithTagsError> {
    (!body.is_empty()).then(||{
