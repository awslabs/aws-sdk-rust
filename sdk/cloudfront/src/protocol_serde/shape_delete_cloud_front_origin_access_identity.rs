...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_cloud_front_origin_access_identity_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityOutput, crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError> {
    Ok({
        #[allow(unused_mut)]
