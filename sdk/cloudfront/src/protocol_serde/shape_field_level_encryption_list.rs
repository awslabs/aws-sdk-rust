...
pub fn de_field_level_encryption_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FieldLevelEncryptionList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
