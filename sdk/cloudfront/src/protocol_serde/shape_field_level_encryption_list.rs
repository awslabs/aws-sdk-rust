...
pub fn de_field_level_encryption_list(
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#FieldLevelEncryptionList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_field_level_encryption_summary_list::de_field_level_encryption_summary_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::field_level_encryption_list_correct_errors(builder)
        .build()
