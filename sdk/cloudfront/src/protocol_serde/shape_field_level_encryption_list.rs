...
pub fn de_field_level_encryption_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::FieldLevelEncryptionList, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::FieldLevelEncryptionList::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#FieldLevelEncryptionList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_field_level_encryption_summary_list::de_field_level_encryption_summary_list(&mut tag)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::field_level_encryption_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
