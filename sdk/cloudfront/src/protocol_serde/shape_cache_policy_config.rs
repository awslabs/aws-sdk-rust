...
pub fn ser_cache_policy_config(input: &crate::model::CachePolicyConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cache_policy_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CachePolicyConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
