...
pub(crate) fn de_function_summary_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::FunctionSummary>, crate::operation::create_function::CreateFunctionError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_function_output::de_function_summary(body)
