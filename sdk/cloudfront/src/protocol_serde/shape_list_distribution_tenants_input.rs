...
pub fn ser_list_distribution_tenants_input_input_input(
    ...
    if let Some(var_1) = &input.association_filter {
        ...
        crate::protocol_serde::shape_distribution_tenant_association_filter::ser_distribution_tenant_association_filter(var_1, inner_writer)?
    }
