...
pub fn de_origin_access_control(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginAccessControl, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
