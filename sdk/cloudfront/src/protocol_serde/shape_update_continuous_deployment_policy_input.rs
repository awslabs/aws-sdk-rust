...
pub fn ser_continuous_deployment_policy_config_http_payload(payload: &::std::option::Option<crate::types::ContinuousDeploymentPolicyConfig>) -> Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
...
pub fn ser_continuous_deployment_policy_config_payload(input: &crate::types::ContinuousDeploymentPolicyConfig) -> std::result::Result<std::vec::Vec<u8>, ::aws_smithy_types::error::operation::SerializationError> {
