...
pub fn ser_continuous_deployment_policy_config_http_payload(
    payload: &::std::option::Option<crate::types::ContinuousDeploymentPolicyConfig>,
...
pub fn ser_continuous_deployment_policy_config_payload(
