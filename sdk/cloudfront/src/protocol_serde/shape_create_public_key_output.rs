...
pub(crate) fn de_public_key_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::PublicKey>, crate::operation::create_public_key::CreatePublicKeyError> {
    (!body.is_empty())
        .then(|| {
...
pub fn de_public_key(inp: &[u8]) -> std::result::Result<crate::types::PublicKey, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    let depth = 0u32;
    crate::protocol_serde::shape_public_key::de_public_key(&mut decoder, depth + 1)
}
