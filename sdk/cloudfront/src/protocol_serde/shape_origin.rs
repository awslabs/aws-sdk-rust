...
pub fn ser_origin(input: &crate::model::Origin, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Origin, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
