...
pub(crate) fn de_tags_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::Tags>, crate::operation::list_tags_for_resource::ListTagsForResourceError> {
    (!body.is_empty())
        .then(|| {
...
pub fn de_tags(inp: &[u8]) -> std::result::Result<crate::types::Tags, ::aws_smithy_xml::decode::XmlDecodeError> {
