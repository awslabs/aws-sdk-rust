...
pub(crate) fn de_response_headers_policy_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ResponseHeadersPolicyConfig>, crate::operation::get_response_headers_policy_config::GetResponseHeadersPolicyConfigError> {
    (!body.is_empty()).then(||{
