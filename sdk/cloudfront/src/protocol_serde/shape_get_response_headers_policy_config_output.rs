...
pub(crate) fn de_response_headers_policy_config_payload(
    body: &[u8],
) -> std::result::Result<
...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_response_headers_policy_config_output::de_response_headers_policy_config(body)
                .map_err(crate::operation::get_response_headers_policy_config::GetResponseHeadersPolicyConfigError::unhandled)
        })
        .transpose()
}
