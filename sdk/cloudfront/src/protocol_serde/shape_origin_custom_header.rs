...
pub fn ser_origin_custom_header(input: &crate::model::OriginCustomHeader, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_custom_header(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginCustomHeader, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
