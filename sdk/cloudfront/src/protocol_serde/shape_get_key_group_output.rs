...
pub(crate) fn de_key_group_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::KeyGroup>, crate::operation::get_key_group::GetKeyGroupError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_get_key_group_output::de_key_group(body).map_err(crate::operation::get_key_group::GetKeyGroupError::unhandled)
    }).transpose()
}
