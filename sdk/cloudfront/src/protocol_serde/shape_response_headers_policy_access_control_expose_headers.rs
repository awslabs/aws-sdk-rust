...
pub fn ser_response_headers_policy_access_control_expose_headers(
    input: &crate::types::ResponseHeadersPolicyAccessControlExposeHeaders,
...
pub fn de_response_headers_policy_access_control_expose_headers(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyAccessControlExposeHeaders, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#ResponseHeadersPolicyAccessControlExposeHeaders$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_access_control_expose_headers_list::de_access_control_expose_headers_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(
        crate::serde_util::response_headers_policy_access_control_expose_headers_correct_errors(builder)
            .build()
