...
pub fn ser_response_headers_policy_access_control_expose_headers(input: &crate::types::ResponseHeadersPolicyAccessControlExposeHeaders, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
