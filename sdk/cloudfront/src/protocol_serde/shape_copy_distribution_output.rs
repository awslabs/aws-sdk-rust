...
pub fn de_distribution_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::Distribution>, crate::error::CopyDistributionError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_copy_distribution_output::de_distribution(body).map_err(crate::error::CopyDistributionError::unhandled)
    }).transpose()
}
