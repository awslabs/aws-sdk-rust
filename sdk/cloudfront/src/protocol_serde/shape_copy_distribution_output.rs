...
pub(crate) fn de_distribution_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::Distribution>, crate::operation::copy_distribution::CopyDistributionError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_copy_distribution_output::de_distribution(body)
