...
pub fn ser_response_headers_policy_security_headers_config(input: &crate::model::ResponseHeadersPolicySecurityHeadersConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_security_headers_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicySecurityHeadersConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
