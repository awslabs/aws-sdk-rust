...
pub fn ser_response_headers_policy_security_headers_config(input: &crate::types::ResponseHeadersPolicySecurityHeadersConfig, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
