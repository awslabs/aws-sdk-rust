...
pub fn ser_origin_groups(input: &crate::model::OriginGroups, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginGroups, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
