...
pub fn ser_origin_groups(
    input: &crate::types::OriginGroups,
...
pub fn de_origin_groups(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::OriginGroups, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#OriginGroups$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_origin_group_list::de_origin_group_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::origin_groups_correct_errors(builder)
        .build()
