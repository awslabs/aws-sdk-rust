...
pub fn de_conflicting_aliases_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConflictingAliasesList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
