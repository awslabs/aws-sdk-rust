...
pub fn ser_trusted_key_groups(input: &crate::model::TrustedKeyGroups, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_trusted_key_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrustedKeyGroups, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
