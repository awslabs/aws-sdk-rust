...
pub fn ser_trusted_key_groups(input: &crate::types::TrustedKeyGroups, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_trusted_key_groups(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TrustedKeyGroups, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::trusted_key_groups_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
