...
pub fn de_get_origin_access_control_config_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigOutput, crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_origin_access_control_config_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigOutput, crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError> {
    Ok({
        #[allow(unused_mut)]
