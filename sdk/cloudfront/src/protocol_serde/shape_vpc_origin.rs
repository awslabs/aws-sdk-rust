...
pub fn de_vpc_origin(
...
) -> Result<crate::types::VpcOrigin, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::VpcOrigin::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Id") /* Id com.amazonaws.cloudfront#VpcOrigin$Id */ =>  {
                let var_1 =
                    Some(
            ...
            ,
            s if s.matches("Arn") /* Arn com.amazonaws.cloudfront#VpcOrigin$Arn */ =>  {
                let var_2 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
    ...
    Ok(crate::serde_util::vpc_origin_correct_errors(builder)
        .build()
