...
pub fn de_origin_access_control_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::OriginAccessControl>, crate::error::CreateOriginAccessControlError> {
    (!body.is_empty()).then(||{
