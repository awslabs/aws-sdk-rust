...
pub fn ser_continuous_deployment_policy_config(input: &crate::model::ContinuousDeploymentPolicyConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_continuous_deployment_policy_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ContinuousDeploymentPolicyConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
