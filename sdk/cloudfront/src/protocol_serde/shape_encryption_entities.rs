...
pub fn ser_encryption_entities(input: &crate::model::EncryptionEntities, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_encryption_entities(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EncryptionEntities, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
