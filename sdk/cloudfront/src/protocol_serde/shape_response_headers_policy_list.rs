...
pub fn de_response_headers_policy_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
