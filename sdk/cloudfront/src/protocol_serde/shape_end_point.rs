...
pub fn ser_end_point(input: &crate::model::EndPoint, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_end_point(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EndPoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
