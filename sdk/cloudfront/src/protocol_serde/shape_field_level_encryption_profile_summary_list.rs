...
pub fn de_field_level_encryption_profile_summary_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::FieldLevelEncryptionProfileSummary>, aws_smithy_xml::decode::XmlDecodeError> {
