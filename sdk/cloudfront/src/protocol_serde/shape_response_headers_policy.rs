...
pub fn de_response_headers_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
