...
pub fn de_realtime_log_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RealtimeLogConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
