...
pub fn de_list_realtime_log_configs_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsOutput, crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_realtime_log_configs_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsOutput, crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError> {
    Ok({
        #[allow(unused_mut)]
