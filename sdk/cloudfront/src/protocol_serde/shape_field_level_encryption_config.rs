...
pub fn ser_field_level_encryption_config(input: &crate::types::FieldLevelEncryptionConfig, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_field_level_encryption_config(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::FieldLevelEncryptionConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::field_level_encryption_config_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
