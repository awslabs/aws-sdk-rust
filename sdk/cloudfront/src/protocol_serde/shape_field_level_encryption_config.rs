...
pub fn ser_field_level_encryption_config(input: &crate::model::FieldLevelEncryptionConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_field_level_encryption_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FieldLevelEncryptionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
