...
pub fn de_field_level_encryption_profile_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::FieldLevelEncryptionProfileList, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::field_level_encryption_profile_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
