...
pub(crate) fn de_connection_group_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::ConnectionGroup>, crate::operation::get_connection_group::GetConnectionGroupError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_connection_group_output::de_connection_group(body)
