...
pub fn ser_public_key_config(input: &crate::model::PublicKeyConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_public_key_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PublicKeyConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
