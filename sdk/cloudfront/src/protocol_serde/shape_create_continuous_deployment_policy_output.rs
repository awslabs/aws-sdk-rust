...
pub fn de_continuous_deployment_policy_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::ContinuousDeploymentPolicy>, crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError> {
    (!body.is_empty()).then(||{
