...
pub fn de_continuous_deployment_policy_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::ContinuousDeploymentPolicy>, crate::error::CreateContinuousDeploymentPolicyError> {
    (!body.is_empty()).then(||{
