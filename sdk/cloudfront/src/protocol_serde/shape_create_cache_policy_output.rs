...
pub fn de_cache_policy_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::CachePolicy>, crate::error::CreateCachePolicyError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_create_cache_policy_output::de_cache_policy(body).map_err(crate::error::CreateCachePolicyError::unhandled)
    }).transpose()
}
...
pub fn de_cache_policy(inp: &[u8]) -> Result<crate::model::CachePolicy, aws_smithy_xml::decode::XmlDecodeError> {
