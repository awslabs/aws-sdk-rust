...
pub fn de_cloud_front_origin_access_identity_list(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::CloudFrontOriginAccessIdentityList, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#CloudFrontOriginAccessIdentityList$Items */ =>  {
                let var_6 =
                    Some(
                        crate::protocol_serde::shape_cloud_front_origin_access_identity_summary_list::de_cloud_front_origin_access_identity_summary_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::cloud_front_origin_access_identity_list_correct_errors(builder)
        .build()
