...
pub fn de_cloud_front_origin_access_identity_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CloudFrontOriginAccessIdentityList, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::cloud_front_origin_access_identity_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
