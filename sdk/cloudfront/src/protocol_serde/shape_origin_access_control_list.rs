...
pub fn de_origin_access_control_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginAccessControlList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
