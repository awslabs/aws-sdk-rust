...
pub(crate) fn de_connection_group_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::ConnectionGroup>, crate::operation::update_connection_group::UpdateConnectionGroupError>
{
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_update_connection_group_output::de_connection_group(body)
                .map_err(crate::operation::update_connection_group::UpdateConnectionGroupError::unhandled)
        })
        .transpose()
}
