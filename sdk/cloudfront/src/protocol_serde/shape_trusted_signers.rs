...
pub fn ser_trusted_signers(input: &crate::model::TrustedSigners, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_trusted_signers(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrustedSigners, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
