...
pub(crate) fn de_cloud_front_origin_access_identity_payload(
    body: &[u8],
) -> std::result::Result<
...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_cloud_front_origin_access_identity_output::de_cloud_front_origin_access_identity(body)
...
pub fn de_cloud_front_origin_access_identity(
    ...
    let depth = 0u32;
    crate::protocol_serde::shape_cloud_front_origin_access_identity::de_cloud_front_origin_access_identity(&mut decoder, depth + 1)
}
