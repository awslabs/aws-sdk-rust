...
pub fn ser_content_type_profile_config(input: &crate::model::ContentTypeProfileConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_content_type_profile_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ContentTypeProfileConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
