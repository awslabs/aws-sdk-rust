...
pub fn de_associate_alias_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::associate_alias::AssociateAliasOutput, crate::operation::associate_alias::AssociateAliasError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_alias_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::associate_alias::AssociateAliasOutput, crate::operation::associate_alias::AssociateAliasError> {
