...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_origin_request_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyOutput, crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyError> {
    Ok({
        #[allow(unused_mut)]
