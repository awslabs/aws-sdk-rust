...
pub fn de_delete_origin_request_policy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyOutput, crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_origin_request_policy_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyOutput, crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyError> {
    Ok({
        #[allow(unused_mut)]
