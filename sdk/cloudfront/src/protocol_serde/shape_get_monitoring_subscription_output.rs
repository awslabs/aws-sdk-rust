...
pub(crate) fn de_monitoring_subscription_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::MonitoringSubscription>, crate::operation::get_monitoring_subscription::GetMonitoringSubscriptionError> {
    (!body.is_empty()).then(||{
