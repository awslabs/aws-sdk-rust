...
pub fn de_realtime_log_configs(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RealtimeLogConfigs, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
