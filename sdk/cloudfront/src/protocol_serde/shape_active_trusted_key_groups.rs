...
pub fn de_active_trusted_key_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ActiveTrustedKeyGroups, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
