...
pub fn de_active_trusted_key_groups(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::ActiveTrustedKeyGroups, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#ActiveTrustedKeyGroups$Items */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_kg_key_pair_ids_list::de_kg_key_pair_ids_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::active_trusted_key_groups_correct_errors(builder)
        .build()
