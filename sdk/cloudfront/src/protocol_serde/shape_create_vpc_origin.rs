...
pub fn de_create_vpc_origin_http_response(
    ...
    Ok({
        ...
        output = output.set_e_tag(
            match crate::protocol_serde::shape_create_vpc_origin_output::de_e_tag_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::create_vpc_origin::CreateVpcOriginError::unhandled(
        ...
        output = output.set_location(
            match crate::protocol_serde::shape_create_vpc_origin_output::de_location_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
