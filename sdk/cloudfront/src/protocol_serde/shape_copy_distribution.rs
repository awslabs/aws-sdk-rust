...
pub fn de_copy_distribution_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_distribution::CopyDistributionOutput, crate::operation::copy_distribution::CopyDistributionError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_distribution_cnames::de_too_many_distribution_cnames_xml_err(_response_body, output).map_err(crate::operation::copy_distribution::CopyDistributionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "TooManyDistributionsAssociatedToOriginAccessControl" => crate::operation::copy_distribution::CopyDistributionError::TooManyDistributionsAssociatedToOriginAccessControl({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::TooManyDistributionsAssociatedToOriginAccessControlBuilder::default();
                    output = crate::protocol_serde::shape_too_many_distributions_associated_to_origin_access_control::de_too_many_distributions_associated_to_origin_access_control_xml_err(_response_body, output).map_err(crate::operation::copy_distribution::CopyDistributionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_distribution_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_distribution::CopyDistributionOutput, crate::operation::copy_distribution::CopyDistributionError> {
    Ok({
        #[allow(unused_mut)]
        ...
        let formatted_2 = encoder.encode();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("staging", format!(
...
pub fn ser_copy_distribution_op_input(input: &crate::operation::copy_distribution::CopyDistributionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
