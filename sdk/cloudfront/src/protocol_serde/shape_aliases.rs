...
pub fn ser_aliases(input: &crate::types::Aliases, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_aliases(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::Aliases, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::aliases_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
