...
pub fn ser_aliases(input: &crate::model::Aliases, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_aliases(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Aliases, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#Aliases$Items */ =>  {
                let var_5 =
                    Some(
                        crate::protocol_serde::shape_alias_list::de_alias_list(&mut tag)
                        ?
                    )
                ;
