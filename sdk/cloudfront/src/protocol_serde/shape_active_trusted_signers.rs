...
pub fn de_active_trusted_signers(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ActiveTrustedSigners, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
