...
pub fn ser_response_headers_policy_frame_options(input: &crate::model::ResponseHeadersPolicyFrameOptions, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_frame_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyFrameOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
