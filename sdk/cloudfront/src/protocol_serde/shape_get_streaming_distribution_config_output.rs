...
pub fn de_streaming_distribution_config_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::StreamingDistributionConfig>, crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigError> {
    (!body.is_empty()).then(||{
