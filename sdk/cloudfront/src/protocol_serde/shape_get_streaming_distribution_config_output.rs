...
pub(crate) fn de_streaming_distribution_config_payload(
    body: &[u8],
) -> std::result::Result<
...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_streaming_distribution_config_output::de_streaming_distribution_config(body)
                .map_err(crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigError::unhandled)
        })
        .transpose()
}

pub fn de_streaming_distribution_config(inp: &[u8]) -> Result<crate::types::StreamingDistributionConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
