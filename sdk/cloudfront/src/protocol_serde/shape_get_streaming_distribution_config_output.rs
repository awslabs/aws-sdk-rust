...
pub fn de_streaming_distribution_config_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::StreamingDistributionConfig>, crate::error::GetStreamingDistributionConfigError> {
    (!body.is_empty()).then(||{
...
pub fn de_streaming_distribution_config(inp: &[u8]) -> Result<crate::model::StreamingDistributionConfig, aws_smithy_xml::decode::XmlDecodeError> {
