...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_realtime_log_config::de_get_realtime_log_config(_response_body, output)
            .map_err(crate::operation::get_realtime_log_config::GetRealtimeLogConfigError::unhandled)?;
...
pub fn de_get_realtime_log_config(
    ...
    if !start_el.matches("GetRealtimeLogConfigResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetRealtimeLogConfigResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
