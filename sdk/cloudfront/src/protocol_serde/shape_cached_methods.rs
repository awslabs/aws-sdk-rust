...
pub fn ser_cached_methods(input: &crate::types::CachedMethods, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cached_methods(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CachedMethods, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::cached_methods_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
