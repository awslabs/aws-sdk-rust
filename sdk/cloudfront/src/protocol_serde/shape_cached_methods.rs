...
pub fn ser_cached_methods(input: &crate::model::CachedMethods, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cached_methods(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CachedMethods, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
