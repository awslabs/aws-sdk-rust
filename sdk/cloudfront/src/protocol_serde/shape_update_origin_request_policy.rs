...
pub fn de_update_origin_request_policy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_origin_request_policy::UpdateOriginRequestPolicyOutput, crate::operation::update_origin_request_policy::UpdateOriginRequestPolicyError> {
    #[allow(unused_mut)]
