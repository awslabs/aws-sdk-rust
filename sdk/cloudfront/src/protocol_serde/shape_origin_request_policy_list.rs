...
pub fn de_origin_request_policy_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::OriginRequestPolicyList, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::OriginRequestPolicyList::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#OriginRequestPolicyList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_origin_request_policy_summary_list::de_origin_request_policy_summary_list(&mut tag)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::origin_request_policy_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
