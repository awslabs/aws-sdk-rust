...
pub fn de_origin_request_policy_list(
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#OriginRequestPolicyList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_origin_request_policy_summary_list::de_origin_request_policy_summary_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::origin_request_policy_list_correct_errors(builder)
        .build()
