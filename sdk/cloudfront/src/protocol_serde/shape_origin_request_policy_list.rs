...
pub fn de_origin_request_policy_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginRequestPolicyList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
