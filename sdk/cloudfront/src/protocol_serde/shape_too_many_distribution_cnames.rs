...
#[allow(unused_mut)]
pub fn de_too_many_distribution_cnames_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::TooManyDistributionCnamEsBuilder,
) -> std::result::Result<crate::types::error::builders::TooManyDistributionCnamEsBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
