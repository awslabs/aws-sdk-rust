...
pub fn ser_kinesis_stream_config(input: &crate::model::KinesisStreamConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_kinesis_stream_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::KinesisStreamConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
