...
pub fn de_list_distributions_by_key_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupOutput, crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_distributions_by_key_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupOutput, crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError> {
    Ok({
        #[allow(unused_mut)]
