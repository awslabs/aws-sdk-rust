...
pub(crate) fn de_distribution_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::Distribution>, crate::operation::create_distribution::CreateDistributionError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_distribution_output::de_distribution(body)
