...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_monitoring_subscription_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionOutput, crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
