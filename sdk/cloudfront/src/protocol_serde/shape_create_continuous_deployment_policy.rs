...
pub fn de_create_continuous_deployment_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateContinuousDeploymentPolicyOutput, crate::error::CreateContinuousDeploymentPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateContinuousDeploymentPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_continuous_deployment_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateContinuousDeploymentPolicyOutput, crate::error::CreateContinuousDeploymentPolicyError> {
    Ok({
        #[allow(unused_mut)]
