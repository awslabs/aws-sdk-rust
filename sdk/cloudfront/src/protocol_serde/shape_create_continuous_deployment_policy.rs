...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InconsistentQuantities" => {
            crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::InconsistentQuantities({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "StagingDistributionInUse" => {
            crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::StagingDistributionInUse({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyContinuousDeploymentPolicies" => {
            crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::TooManyContinuousDeploymentPolicies({
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_too_many_continuous_deployment_policies::de_too_many_continuous_deployment_policies_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_continuous_deployment_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_e_tag(
            crate::protocol_serde::shape_create_continuous_deployment_policy_output::de_e_tag_header(_response_headers).map_err(|_| {
                crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::unhandled(
                    "Failed to parse ETag from header `ETag",
                )
            })?,
        );
        output = output.set_location(
            crate::protocol_serde::shape_create_continuous_deployment_policy_output::de_location_header(_response_headers).map_err(|_| {
                crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError::unhandled(
