...
> {
    ...
    Err(match error_code {
        ...
        "EntityNotFound" => crate::operation::create_distribution_with_tags::CreateDistributionWithTagsError::EntityNotFound({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::EntityNotFoundBuilder::default();
                    output = crate::protocol_serde::shape_entity_not_found::de_entity_not_found_xml_err(_response_body, output).map_err(crate::operation::create_distribution_with_tags::CreateDistributionWithTagsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
> {
    Ok({
        ...
        output = output.set_distribution(crate::protocol_serde::shape_create_distribution_with_tags_output::de_distribution_payload(_response_body)?);
        output = output.set_e_tag(
            crate::protocol_serde::shape_create_distribution_with_tags_output::de_e_tag_header(_response_headers).map_err(|_| {
                crate::operation::create_distribution_with_tags::CreateDistributionWithTagsError::unhandled("Failed to parse ETag from header `ETag")
            })?,
        );
        output = output.set_location(
            crate::protocol_serde::shape_create_distribution_with_tags_output::de_location_header(_response_headers).map_err(|_| {
