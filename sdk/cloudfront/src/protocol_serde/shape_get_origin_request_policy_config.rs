...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "NoSuchOriginRequestPolicy" => {
            crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError::NoSuchOriginRequestPolicy({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::NoSuchOriginRequestPolicyBuilder::default();
                    output =
                        crate::protocol_serde::shape_no_such_origin_request_policy::de_no_such_origin_request_policy_xml_err(_response_body, output)
                            .map_err(crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_origin_request_policy_config_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_e_tag(
            crate::protocol_serde::shape_get_origin_request_policy_config_output::de_e_tag_header(_response_headers).map_err(|_| {
                crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError::unhandled(
