...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_origin_access_control_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_origin_access_control::DeleteOriginAccessControlOutput, crate::operation::delete_origin_access_control::DeleteOriginAccessControlError> {
    Ok({
        #[allow(unused_mut)]
