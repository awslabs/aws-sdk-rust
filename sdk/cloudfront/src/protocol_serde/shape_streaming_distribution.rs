...
pub fn de_streaming_distribution(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StreamingDistribution, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
