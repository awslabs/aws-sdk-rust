...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_function_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_function::UpdateFunctionOutput, crate::operation::update_function::UpdateFunctionError> {
    Ok({
        #[allow(unused_mut)]
