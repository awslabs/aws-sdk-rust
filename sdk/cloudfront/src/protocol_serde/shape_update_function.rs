...
pub fn ser_update_function_op_input(input: &crate::operation::update_function::UpdateFunctionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
