...
pub fn de_field_level_encryption_profile_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FieldLevelEncryptionProfileSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
