...
pub fn de_field_level_encryption_profile_summary(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::FieldLevelEncryptionProfileSummary, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::field_level_encryption_profile_summary_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
