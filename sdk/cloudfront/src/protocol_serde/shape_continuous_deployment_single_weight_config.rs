...
pub fn ser_continuous_deployment_single_weight_config(input: &crate::model::ContinuousDeploymentSingleWeightConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_continuous_deployment_single_weight_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ContinuousDeploymentSingleWeightConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
