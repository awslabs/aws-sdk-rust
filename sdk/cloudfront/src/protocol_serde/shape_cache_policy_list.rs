...
pub fn de_cache_policy_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CachePolicyList, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::cache_policy_list_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
