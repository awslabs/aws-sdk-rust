...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_cloud_front_origin_access_identity_output::de_cloud_front_origin_access_identity(body)
                .map_err(crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityError::unhandled)
        })
        .transpose()
}
