...
pub fn ser_custom_error_responses(input: &crate::model::CustomErrorResponses, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_custom_error_responses(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CustomErrorResponses, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
