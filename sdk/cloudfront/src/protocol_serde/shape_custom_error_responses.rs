...
pub fn ser_custom_error_responses(input: &crate::types::CustomErrorResponses, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
        ...
        for list_item_3 in var_2 {
             {
                ...
                crate::protocol_serde::shape_custom_error_response::ser_custom_error_response(list_item_3, inner_writer)?
            }
        }
    }
    scope.finish();
