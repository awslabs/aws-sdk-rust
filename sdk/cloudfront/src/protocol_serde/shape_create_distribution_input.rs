...
pub fn ser_distribution_config_http_payload(
    payload: &::std::option::Option<crate::types::DistributionConfig>,
    ...
    Ok(
        crate::protocol_serde::shape_create_distribution_input::ser_distribution_config_payload(
            payload,
        )?,
    )
}

pub fn ser_distribution_config_payload(
