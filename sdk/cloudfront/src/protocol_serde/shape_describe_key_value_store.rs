...
pub fn de_describe_key_value_store_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "UnsupportedOperation" => crate::operation::describe_key_value_store::DescribeKeyValueStoreError::UnsupportedOperation({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_key_value_store_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_key_value_store(crate::protocol_serde::shape_describe_key_value_store_output::de_key_value_store_payload(
            _response_body,
        )?);
