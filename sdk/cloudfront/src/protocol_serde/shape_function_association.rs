...
pub fn ser_function_association(
    input: &crate::types::FunctionAssociation,
...
) -> ::std::result::Result<crate::types::FunctionAssociation, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
