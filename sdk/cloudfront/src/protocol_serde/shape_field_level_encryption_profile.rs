...
pub fn de_field_level_encryption_profile(
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("FieldLevelEncryptionProfileConfig") /* FieldLevelEncryptionProfileConfig com.amazonaws.cloudfront#FieldLevelEncryptionProfile$FieldLevelEncryptionProfileConfig */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_field_level_encryption_profile_config::de_field_level_encryption_profile_config(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::field_level_encryption_profile_correct_errors(builder)
        .build()
