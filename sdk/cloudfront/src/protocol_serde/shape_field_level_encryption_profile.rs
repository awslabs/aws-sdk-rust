...
pub fn de_field_level_encryption_profile(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FieldLevelEncryptionProfile, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
