...
pub fn ser_key_group_config_http_payload(
    payload: &::std::option::Option<crate::types::KeyGroupConfig>,
    ...
    Ok(crate::protocol_serde::shape_update_key_group_input::ser_key_group_config_payload(payload)?)
}
