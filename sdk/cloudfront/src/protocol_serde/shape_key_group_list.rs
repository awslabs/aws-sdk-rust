...
pub fn de_key_group_list(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::KeyGroupList, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#KeyGroupList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_key_group_summary_list::de_key_group_summary_list(&mut tag, depth + 1)
                        ?
                    )
                ;
    ...
    Ok(crate::serde_util::key_group_list_correct_errors(builder)
        .build()
