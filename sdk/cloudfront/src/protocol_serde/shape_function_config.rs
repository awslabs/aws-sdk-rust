...
pub fn ser_function_config(input: &crate::model::FunctionConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_function_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FunctionConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
