...
pub(crate) fn de_origin_request_policy_payload(
    body: &[u8],
) -> std::result::Result<
...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_update_origin_request_policy_output::de_origin_request_policy(body)
                .map_err(crate::operation::update_origin_request_policy::UpdateOriginRequestPolicyError::unhandled)
        })
        .transpose()
}

pub fn de_origin_request_policy(inp: &[u8]) -> std::result::Result<crate::types::OriginRequestPolicy, ::aws_smithy_xml::decode::XmlDecodeError> {
