...
pub fn ser_cache_behaviors(input: &crate::model::CacheBehaviors, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cache_behaviors(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheBehaviors, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
