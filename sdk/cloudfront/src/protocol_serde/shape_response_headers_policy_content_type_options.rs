...
pub fn ser_response_headers_policy_content_type_options(input: &crate::model::ResponseHeadersPolicyContentTypeOptions, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_content_type_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyContentTypeOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
