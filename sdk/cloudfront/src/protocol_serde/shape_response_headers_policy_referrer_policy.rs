...
pub fn ser_response_headers_policy_referrer_policy(
...
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyReferrerPolicy, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
