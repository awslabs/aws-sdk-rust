...
pub fn ser_geo_restriction(input: &crate::model::GeoRestriction, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_geo_restriction(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GeoRestriction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
