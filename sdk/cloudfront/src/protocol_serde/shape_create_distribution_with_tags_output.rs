...
pub fn de_distribution_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::Distribution>, crate::operation::create_distribution_with_tags::CreateDistributionWithTagsError> {
    (!body.is_empty()).then(||{
