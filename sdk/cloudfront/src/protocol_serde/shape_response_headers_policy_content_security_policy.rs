...
pub fn ser_response_headers_policy_content_security_policy(
    ...
    }
    {
        ...
        inner_writer.data(input.content_security_policy.as_str());
    }
    scope.finish();
    Ok(())
}
...
pub fn de_response_headers_policy_content_security_policy(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyContentSecurityPolicy, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::response_headers_policy_content_security_policy_correct_errors(builder)
        .build()
