...
pub fn de_streaming_distribution_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StreamingDistributionSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
