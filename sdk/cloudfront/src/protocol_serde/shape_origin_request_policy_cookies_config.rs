...
pub fn ser_origin_request_policy_cookies_config(input: &crate::model::OriginRequestPolicyCookiesConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_request_policy_cookies_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginRequestPolicyCookiesConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
