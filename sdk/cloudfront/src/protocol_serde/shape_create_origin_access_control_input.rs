...
pub fn ser_origin_access_control_config_http_payload(payload: &::std::option::Option<crate::types::OriginAccessControlConfig>) -> Result<::std::vec::Vec<u8>, ::aws_smithy_types::error::operation::BuildError> {
...
pub fn ser_origin_access_control_config_payload(input: &crate::types::OriginAccessControlConfig) -> std::result::Result<std::vec::Vec<u8>, ::aws_smithy_types::error::operation::SerializationError> {
