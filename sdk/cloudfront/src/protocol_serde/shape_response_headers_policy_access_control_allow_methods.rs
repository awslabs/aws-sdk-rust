...
pub fn ser_response_headers_policy_access_control_allow_methods(input: &crate::types::ResponseHeadersPolicyAccessControlAllowMethods, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
