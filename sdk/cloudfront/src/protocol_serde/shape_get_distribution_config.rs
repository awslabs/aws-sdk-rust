...
pub fn de_get_distribution_config_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_distribution_config::GetDistributionConfigOutput, crate::operation::get_distribution_config::GetDistributionConfigError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_distribution_config_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_distribution_config::GetDistributionConfigOutput, crate::operation::get_distribution_config::GetDistributionConfigError> {
    Ok({
        #[allow(unused_mut)]
