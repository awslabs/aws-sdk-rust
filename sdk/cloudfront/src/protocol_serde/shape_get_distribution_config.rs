...
pub fn de_get_distribution_config_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_distribution_config::GetDistributionConfigOutput, crate::operation::get_distribution_config::GetDistributionConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_distribution_config::GetDistributionConfigError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_distribution_config_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_distribution_config::GetDistributionConfigOutput, crate::operation::get_distribution_config::GetDistributionConfigError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_e_tag(
            crate::protocol_serde::shape_get_distribution_config_output::de_e_tag_header(_response_headers)
