...
pub fn ser_custom_error_response(
    input: &crate::types::CustomErrorResponse,
...
) -> ::std::result::Result<crate::types::CustomErrorResponse, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
