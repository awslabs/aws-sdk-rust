...
pub fn ser_custom_error_response(input: &crate::model::CustomErrorResponse, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_custom_error_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CustomErrorResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
