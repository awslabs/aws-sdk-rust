...
pub fn ser_cookie_preference(input: &crate::model::CookiePreference, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cookie_preference(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CookiePreference, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
