...
pub(crate) fn de_test_result_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::TestResult>, crate::operation::test_function::TestFunctionError> {
    (!body.is_empty())
        .then(|| {
...
pub fn de_test_result(inp: &[u8]) -> std::result::Result<crate::types::TestResult, ::aws_smithy_xml::decode::XmlDecodeError> {
