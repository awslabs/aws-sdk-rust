...
pub fn ser_origin_request_policy_query_strings_config(input: &crate::model::OriginRequestPolicyQueryStringsConfig, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_request_policy_query_strings_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginRequestPolicyQueryStringsConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
