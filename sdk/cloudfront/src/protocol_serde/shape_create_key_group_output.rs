...
pub(crate) fn de_key_group_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::KeyGroup>, crate::operation::create_key_group::CreateKeyGroupError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_key_group_output::de_key_group(body)
...
pub(crate) fn de_location_header(
    ...
    let headers = header_map.get_all_bytes("Location");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}

pub fn de_key_group(inp: &[u8]) -> std::result::Result<crate::types::KeyGroup, ::aws_smithy_xml::decode::XmlDecodeError> {
