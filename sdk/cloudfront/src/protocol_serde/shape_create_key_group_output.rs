...
pub(crate) fn de_key_group_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::KeyGroup>, crate::operation::create_key_group::CreateKeyGroupError> {
    (!body.is_empty()).then(||{
...
pub(crate) fn de_location_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
