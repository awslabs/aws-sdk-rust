...
pub fn ser_query_string_names(input: &crate::types::QueryStringNames, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
