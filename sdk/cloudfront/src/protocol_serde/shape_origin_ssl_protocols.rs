...
pub fn ser_origin_ssl_protocols(input: &crate::model::OriginSslProtocols, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_ssl_protocols(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OriginSslProtocols, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
