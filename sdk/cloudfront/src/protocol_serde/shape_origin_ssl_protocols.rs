...
pub fn ser_origin_ssl_protocols(input: &crate::types::OriginSslProtocols, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
