...
pub fn ser_origin_ssl_protocols(input: &crate::types::OriginSslProtocols, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_origin_ssl_protocols(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::OriginSslProtocols, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::origin_ssl_protocols_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
