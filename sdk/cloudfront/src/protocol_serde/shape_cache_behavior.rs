...
pub fn ser_cache_behavior(input: &crate::model::CacheBehavior, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cache_behavior(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CacheBehavior, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
