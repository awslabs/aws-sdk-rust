...
pub fn de_streaming_distribution_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::StreamingDistribution>, crate::error::CreateStreamingDistributionError> {
    (!body.is_empty()).then(||{
