...
pub(crate) fn de_streaming_distribution_payload(
    body: &[u8],
) -> std::result::Result<
...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_streaming_distribution_output::de_streaming_distribution(body)
                .map_err(crate::operation::create_streaming_distribution::CreateStreamingDistributionError::unhandled)
        })
        .transpose()
}

pub fn de_streaming_distribution(inp: &[u8]) -> std::result::Result<crate::types::StreamingDistribution, ::aws_smithy_xml::decode::XmlDecodeError> {
