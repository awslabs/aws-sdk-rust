...
pub(crate) fn de_streaming_distribution_list_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::StreamingDistributionList>, crate::operation::list_streaming_distributions::ListStreamingDistributionsError> {
    (!body.is_empty()).then(||{
