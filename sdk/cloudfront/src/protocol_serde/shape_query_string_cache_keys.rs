...
pub fn ser_query_string_cache_keys(input: &crate::types::QueryStringCacheKeys, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_query_string_cache_keys(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::QueryStringCacheKeys, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::query_string_cache_keys_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
