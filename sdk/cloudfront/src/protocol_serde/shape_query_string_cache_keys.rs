...
pub fn ser_query_string_cache_keys(input: &crate::model::QueryStringCacheKeys, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_query_string_cache_keys(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::QueryStringCacheKeys, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
