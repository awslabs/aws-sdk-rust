...
pub fn ser_create_realtime_log_config_input_input(input: &crate::input::CreateRealtimeLogConfigInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
