...
pub fn de_get_cache_policy_http_response(
    ...
    Ok({
        ...
        output = output.set_cache_policy(crate::protocol_serde::shape_get_cache_policy_output::de_cache_policy_payload(
            _response_body,
        )?);
        output = output.set_e_tag(
            match crate::protocol_serde::shape_get_cache_policy_output::de_e_tag_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::get_cache_policy::GetCachePolicyError::unhandled(
