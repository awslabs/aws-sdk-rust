...
pub fn de_get_invalidation_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_invalidation::GetInvalidationOutput, crate::operation::get_invalidation::GetInvalidationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_invalidation_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_invalidation::GetInvalidationOutput, crate::operation::get_invalidation::GetInvalidationError> {
    Ok({
        #[allow(unused_mut)]
