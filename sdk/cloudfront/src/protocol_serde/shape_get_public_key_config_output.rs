...
pub(crate) fn de_public_key_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::PublicKeyConfig>, crate::operation::get_public_key_config::GetPublicKeyConfigError> {
    (!body.is_empty()).then(||{
