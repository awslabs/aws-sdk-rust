...
pub fn ser_viewer_certificate(input: &crate::model::ViewerCertificate, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_viewer_certificate(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ViewerCertificate, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
