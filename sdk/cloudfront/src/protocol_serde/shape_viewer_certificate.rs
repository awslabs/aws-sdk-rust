...
pub fn ser_viewer_certificate(input: &crate::types::ViewerCertificate, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
