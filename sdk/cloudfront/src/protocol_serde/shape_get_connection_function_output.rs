...
pub(crate) fn de_connection_function_code_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<::aws_smithy_types::Blob>, crate::operation::get_connection_function::GetConnectionFunctionError> {
