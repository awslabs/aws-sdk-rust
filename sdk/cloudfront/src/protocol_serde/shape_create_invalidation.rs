...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_invalidation_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_invalidation::CreateInvalidationOutput, crate::operation::create_invalidation::CreateInvalidationError> {
    Ok({
        #[allow(unused_mut)]
