...
pub fn ser_response_headers_policy_remove_header(
    input: &crate::types::ResponseHeadersPolicyRemoveHeader,
...
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyRemoveHeader, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
