...
> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_invalidation_for_distribution_tenant_output::de_invalidation(body)
                .map_err(crate::operation::get_invalidation_for_distribution_tenant::GetInvalidationForDistributionTenantError::unhandled)
        })
        .transpose()
}

pub fn de_invalidation(inp: &[u8]) -> std::result::Result<crate::types::Invalidation, ::aws_smithy_xml::decode::XmlDecodeError> {
