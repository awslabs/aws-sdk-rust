...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_monitoring_subscription::GetMonitoringSubscriptionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "NoSuchMonitoringSubscription" => {
            crate::operation::get_monitoring_subscription::GetMonitoringSubscriptionError::NoSuchMonitoringSubscription({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
