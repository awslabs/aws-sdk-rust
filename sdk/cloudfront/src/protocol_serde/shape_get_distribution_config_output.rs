...
pub(crate) fn de_distribution_config_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::DistributionConfig>, crate::operation::get_distribution_config::GetDistributionConfigError>
{
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_get_distribution_config_output::de_distribution_config(body)
