...
pub(crate) fn de_public_key_list_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::PublicKeyList>, crate::operation::list_public_keys::ListPublicKeysError> {
    (!body.is_empty())
        .then(|| {
...
pub fn de_public_key_list(inp: &[u8]) -> std::result::Result<crate::types::PublicKeyList, ::aws_smithy_xml::decode::XmlDecodeError> {
