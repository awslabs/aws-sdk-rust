...
pub fn ser_response_headers_policy_access_control_allow_headers(
    input: &crate::types::ResponseHeadersPolicyAccessControlAllowHeaders,
...
pub fn de_response_headers_policy_access_control_allow_headers(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::ResponseHeadersPolicyAccessControlAllowHeaders, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#ResponseHeadersPolicyAccessControlAllowHeaders$Items */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_access_control_allow_headers_list::de_access_control_allow_headers_list(&mut tag, depth + 1)
                        ?
                    )
                ;
