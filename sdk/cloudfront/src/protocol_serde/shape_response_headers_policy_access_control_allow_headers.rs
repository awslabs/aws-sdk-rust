...
pub fn ser_response_headers_policy_access_control_allow_headers(input: &crate::model::ResponseHeadersPolicyAccessControlAllowHeaders, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_response_headers_policy_access_control_allow_headers(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseHeadersPolicyAccessControlAllowHeaders, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
