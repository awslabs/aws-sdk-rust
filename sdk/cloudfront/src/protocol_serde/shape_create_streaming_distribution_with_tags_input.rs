...
pub fn ser_streaming_distribution_config_with_tags_http_payload(
    payload: &::std::option::Option<crate::types::StreamingDistributionConfigWithTags>,
...
pub fn ser_streaming_distribution_config_with_tags_payload(
