...
pub(crate) fn de_conflicting_aliases_list_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ConflictingAliasesList>, crate::operation::list_conflicting_aliases::ListConflictingAliasesError> {
    (!body.is_empty()).then(||{
