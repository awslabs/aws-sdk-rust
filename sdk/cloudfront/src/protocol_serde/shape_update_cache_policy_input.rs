...
pub fn ser_cache_policy_config_http_payload(
    payload: &std::option::Option<crate::types::CachePolicyConfig>,
    ...
    Ok(
        crate::protocol_serde::shape_update_cache_policy_input::ser_cache_policy_config_payload(
            payload,
        )?,
    )
}

pub fn ser_cache_policy_config_payload(
