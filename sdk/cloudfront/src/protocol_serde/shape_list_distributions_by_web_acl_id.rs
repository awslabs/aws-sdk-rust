...
pub fn de_list_distributions_by_web_acl_id_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdOutput, crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_distributions_by_web_acl_id_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdOutput, crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError> {
    Ok({
        #[allow(unused_mut)]
