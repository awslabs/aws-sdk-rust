...
pub fn ser_response_headers_policy_config_http_payload(
    payload: &::std::option::Option<crate::types::ResponseHeadersPolicyConfig>,
...
pub fn ser_response_headers_policy_config_payload(
