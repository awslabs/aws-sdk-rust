...
pub(crate) fn de_invalidation_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<crate::types::Invalidation>, crate::operation::create_invalidation::CreateInvalidationError> {
    (!body.is_empty())
        .then(|| {
            crate::protocol_serde::shape_create_invalidation_output::de_invalidation(body)
