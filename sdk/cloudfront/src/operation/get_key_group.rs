...
impl GetKeyGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_key_group::GetKeyGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKeyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_key_group::de_get_key_group_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_key_group::de_get_key_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
