...
impl CreateCloudFrontOriginAccessIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_cloud_front_origin_access_identity::CreateCloudFrontOriginAccessIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_cloud_front_origin_access_identity::CreateCloudFrontOriginAccessIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateCloudFrontOriginAccessIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCloudFrontOriginAccessIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateCloudFrontOriginAccessIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateCloudFrontOriginAccessIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateCloudFrontOriginAccessIdentity")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCloudFrontOriginAccessIdentityResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_cloud_front_origin_access_identity::de_create_cloud_front_origin_access_identity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_cloud_front_origin_access_identity::de_create_cloud_front_origin_access_identity_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCloudFrontOriginAccessIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_cloud_front_origin_access_identity::CreateCloudFrontOriginAccessIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_cloud_front_origin_access_identity::CreateCloudFrontOriginAccessIdentityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_cloud_front_origin_access_identity_input::ser_cloud_front_origin_access_identity_config_http_payload(
...
impl ::std::error::Error for CreateCloudFrontOriginAccessIdentityError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::CloudFrontOriginAccessIdentityAlreadyExists(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::TooManyCloudFrontOriginAccessIdentities(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateCloudFrontOriginAccessIdentityError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CloudFrontOriginAccessIdentityAlreadyExists(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::TooManyCloudFrontOriginAccessIdentities(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
