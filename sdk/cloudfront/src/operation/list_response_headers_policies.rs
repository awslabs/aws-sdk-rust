...
impl ListResponseHeadersPoliciesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_response_headers_policies::ListResponseHeadersPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResponseHeadersPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_response_headers_policies::de_list_response_headers_policies_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListResponseHeadersPoliciesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesError
{
