...
impl ListResponseHeadersPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListResponseHeadersPolicies`](crate::operation::list_response_headers_policies::ListResponseHeadersPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_response_headers_policies::ListResponseHeadersPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2020-05-31/response-headers-policy").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_response_headers_policies::ListResponseHeadersPolicies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListResponseHeadersPolicies {
                type Output = std::result::Result<crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesOutput, crate::operation::list_response_headers_policies::ListResponseHeadersPoliciesError>;
