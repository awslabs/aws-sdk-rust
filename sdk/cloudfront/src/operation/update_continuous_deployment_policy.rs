...
impl UpdateContinuousDeploymentPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_continuous_deployment_policy::UpdateContinuousDeploymentPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContinuousDeploymentPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_continuous_deployment_policy::de_update_continuous_deployment_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
