...
impl UpdateResponseHeadersPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_response_headers_policy::UpdateResponseHeadersPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResponseHeadersPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_response_headers_policy::de_update_response_headers_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
