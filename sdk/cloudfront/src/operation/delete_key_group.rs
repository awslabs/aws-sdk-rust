...
impl DeleteKeyGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_key_group::DeleteKeyGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteKeyGroup {
    type Output =
        ::std::result::Result<crate::operation::delete_key_group::DeleteKeyGroupOutput, crate::operation::delete_key_group::DeleteKeyGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_key_group::de_delete_key_group_http_response_with_props(status, headers, body)
        }
    }
}
