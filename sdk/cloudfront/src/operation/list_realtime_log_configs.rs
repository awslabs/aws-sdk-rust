...
impl ListRealtimeLogConfigs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput,
                    ) -> ::std::result::Result<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRealtimeLogConfigs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRealtimeLogConfigs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRealtimeLogConfigsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRealtimeLogConfigsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRealtimeLogConfigs")
...
.with_interceptor(ListRealtimeLogConfigsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError>::new());
...
#[derive(Debug)]
            struct ListRealtimeLogConfigsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRealtimeLogConfigsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_realtime_log_configs::de_list_realtime_log_configs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_realtime_log_configs::de_list_realtime_log_configs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRealtimeLogConfigsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRealtimeLogConfigsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2020-05-31/realtime-log-config").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListRealtimeLogConfigsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRealtimeLogConfigsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRealtimeLogConfigsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRealtimeLogConfigsInput>()
                        .ok_or("failed to downcast to ListRealtimeLogConfigsInput")?;
...
pub enum ListRealtimeLogConfigsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRealtimeLogConfigsError) for what information is available for the error.")]
...
impl ListRealtimeLogConfigsError {
    /// Creates the `ListRealtimeLogConfigsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRealtimeLogConfigsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRealtimeLogConfigsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError {
...
mod _list_realtime_log_configs_output;
