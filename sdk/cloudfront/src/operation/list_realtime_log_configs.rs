...
impl ListRealtimeLogConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListRealtimeLogConfigs`](crate::operation::list_realtime_log_configs::ListRealtimeLogConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2020-05-31/realtime-log-config").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_realtime_log_configs::ListRealtimeLogConfigs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRealtimeLogConfigs {
                type Output = std::result::Result<crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsOutput, crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsError>;
