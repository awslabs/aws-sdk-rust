...
impl CreateStreamingDistributionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_streaming_distribution::CreateStreamingDistribution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStreamingDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_streaming_distribution::de_create_streaming_distribution_http_response_with_props(
                status, headers, body,
            )
        }
    }
