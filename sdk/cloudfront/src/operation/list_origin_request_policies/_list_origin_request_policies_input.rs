...
impl ListOriginRequestPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_origin_request_policies::ListOriginRequestPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
