...
impl UpdateFieldLevelEncryptionProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_field_level_encryption_profile::UpdateFieldLevelEncryptionProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFieldLevelEncryptionProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_field_level_encryption_profile::de_update_field_level_encryption_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
