...
impl GetCachePolicyConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_cache_policy_config::GetCachePolicyConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cache_policy_config::GetCachePolicyConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_cache_policy_config::GetCachePolicyConfigOutput, crate::operation::get_cache_policy_config::GetCachePolicyConfigError, Self> {
