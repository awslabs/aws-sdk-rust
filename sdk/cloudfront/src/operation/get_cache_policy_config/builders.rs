...
impl GetCachePolicyConfigFluentBuilder  {
    /// Creates a new `GetCachePolicyConfig`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_cache_policy_config::GetCachePolicyConfig, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_cache_policy_config::GetCachePolicyConfigError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_cache_policy_config::GetCachePolicyConfigOutput, aws_smithy_http::result::SdkError<crate::operation::get_cache_policy_config::GetCachePolicyConfigError>>
                     {
