...
impl ListConflictingAliases {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_conflicting_aliases::ListConflictingAliasesInput,
                    ) -> ::std::result::Result<crate::operation::list_conflicting_aliases::ListConflictingAliasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_conflicting_aliases::ListConflictingAliasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_conflicting_aliases::ListConflictingAliasesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_conflicting_aliases::ListConflictingAliasesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListConflictingAliases {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListConflictingAliases");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListConflictingAliasesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListConflictingAliasesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListConflictingAliases")
...
.with_interceptor(ListConflictingAliasesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_conflicting_aliases::ListConflictingAliasesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_conflicting_aliases::ListConflictingAliasesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_conflicting_aliases::ListConflictingAliasesError>::new());
...
#[derive(Debug)]
            struct ListConflictingAliasesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListConflictingAliasesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_conflicting_aliases::de_list_conflicting_aliases_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_conflicting_aliases::de_list_conflicting_aliases_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListConflictingAliasesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListConflictingAliasesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_conflicting_aliases::ListConflictingAliasesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_conflicting_aliases::ListConflictingAliasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2020-05-31/conflicting-alias").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_conflicting_aliases::ListConflictingAliasesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.distribution_id;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("distribution_id", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
    ...
    query.push_kv("DistributionId", &::aws_smithy_http::query::fmt_string(inner_1));
    let inner_2 = &_input.alias;
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("alias", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("alias", "cannot be empty or unset"));
    }
...
#[derive(Debug)]
            struct ListConflictingAliasesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListConflictingAliasesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListConflictingAliasesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListConflictingAliasesInput>()
                        .ok_or("failed to downcast to ListConflictingAliasesInput")?;
...
pub enum ListConflictingAliasesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListConflictingAliasesError) for what information is available for the error.")]
...
impl ListConflictingAliasesError {
    /// Creates the `ListConflictingAliasesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListConflictingAliasesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListConflictingAliasesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_conflicting_aliases::ListConflictingAliasesError {
...
mod _list_conflicting_aliases_output;
