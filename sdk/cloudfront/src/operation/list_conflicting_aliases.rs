...
impl ListConflictingAliasesInput {
    /// Consumes the builder and constructs an Operation<[`ListConflictingAliases`](crate::operation::list_conflicting_aliases::ListConflictingAliases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_conflicting_aliases::ListConflictingAliases, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_conflicting_aliases::ListConflictingAliasesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2020-05-31/conflicting-alias").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_conflicting_aliases::ListConflictingAliasesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.distribution_id;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("distribution_id", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_conflicting_aliases::ListConflictingAliases::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListConflictingAliases {
                type Output = std::result::Result<crate::operation::list_conflicting_aliases::ListConflictingAliasesOutput, crate::operation::list_conflicting_aliases::ListConflictingAliasesError>;
