    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/conflicting-alias")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_conflicting_aliases::ListConflictingAliases::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_conflicting_aliases::ListConflictingAliasesError
{
