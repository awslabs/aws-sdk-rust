...
impl ListDistributionsByKeyGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributionsByKeyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_distributions_by_key_group::de_list_distributions_by_key_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
