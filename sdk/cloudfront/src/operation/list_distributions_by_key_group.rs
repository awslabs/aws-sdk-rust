...
impl ListDistributionsByKeyGroupInput {
    /// Consumes the builder and constructs an Operation<[`ListDistributionsByKeyGroup`](crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.key_group_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("key_group_id", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListDistributionsByKeyGroup {
                type Output = std::result::Result<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupOutput, crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError>;
