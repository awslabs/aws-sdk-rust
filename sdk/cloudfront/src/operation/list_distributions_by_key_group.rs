...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributionsByKeyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_distributions_by_key_group::de_list_distributions_by_key_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListDistributionsByKeyGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError
{
