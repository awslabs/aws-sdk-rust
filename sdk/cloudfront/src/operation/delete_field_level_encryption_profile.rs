...
impl DeleteFieldLevelEncryptionProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFieldLevelEncryptionProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_field_level_encryption_profile::de_delete_field_level_encryption_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
