...
impl GetTrustStore {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudFront", "GetTrustStore", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2020-05-31/trust-store/{Identifier}", Identifier = identifier).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl GetTrustStoreError {
    ...
    /// Returns `true` if the error kind is `GetTrustStoreError::AccessDenied`.
    pub fn is_access_denied(&self) -> bool {
        matches!(self, Self::AccessDenied(_))
    }
    /// Returns `true` if the error kind is `GetTrustStoreError::EntityNotFound`.
    pub fn is_entity_not_found(&self) -> bool {
        matches!(self, Self::EntityNotFound(_))
    }
    /// Returns `true` if the error kind is `GetTrustStoreError::InvalidArgument`.
