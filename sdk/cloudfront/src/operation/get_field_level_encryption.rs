...
/// Orchestration and serialization glue logic for `GetFieldLevelEncryption`.
...
impl GetFieldLevelEncryption {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_field_level_encryption::GetFieldLevelEncryptionInput,
                    ) -> ::std::result::Result<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFieldLevelEncryption {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetFieldLevelEncryption");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetFieldLevelEncryptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetFieldLevelEncryptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFieldLevelEncryption")
...
.with_interceptor(GetFieldLevelEncryptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError>::new());
...
#[derive(Debug)]
            struct GetFieldLevelEncryptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFieldLevelEncryptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_field_level_encryption::de_get_field_level_encryption_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_field_level_encryption::de_get_field_level_encryption_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetFieldLevelEncryptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFieldLevelEncryptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_field_level_encryption::GetFieldLevelEncryptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_field_level_encryption::GetFieldLevelEncryptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetFieldLevelEncryptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetFieldLevelEncryptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetFieldLevelEncryptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetFieldLevelEncryptionInput>()
                        .ok_or("failed to downcast to GetFieldLevelEncryptionInput")?;
...
pub enum GetFieldLevelEncryptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetFieldLevelEncryptionError) for what information is available for the error.")]
...
impl GetFieldLevelEncryptionError {
    /// Creates the `GetFieldLevelEncryptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFieldLevelEncryptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetFieldLevelEncryptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_field_level_encryption::GetFieldLevelEncryptionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_field_level_encryption::_get_field_level_encryption_output::GetFieldLevelEncryptionOutput;

pub use crate::operation::get_field_level_encryption::_get_field_level_encryption_input::GetFieldLevelEncryptionInput;

mod _get_field_level_encryption_input;

mod _get_field_level_encryption_output;
