...
impl GetFieldLevelEncryptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_field_level_encryption::GetFieldLevelEncryption,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFieldLevelEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_field_level_encryption::de_get_field_level_encryption_http_response_with_props(status, headers, body)
        }
    }
}
