...
impl ListContinuousDeploymentPolicies {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesInput,
                    ) -> ::std::result::Result<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListContinuousDeploymentPolicies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListContinuousDeploymentPolicies");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListContinuousDeploymentPoliciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListContinuousDeploymentPoliciesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListContinuousDeploymentPolicies")
...
.with_interceptor(ListContinuousDeploymentPoliciesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError>::new());
...
#[derive(Debug)]
            struct ListContinuousDeploymentPoliciesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListContinuousDeploymentPoliciesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_continuous_deployment_policies::de_list_continuous_deployment_policies_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListContinuousDeploymentPoliciesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListContinuousDeploymentPoliciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2020-05-31/continuous-deployment-policy").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListContinuousDeploymentPoliciesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListContinuousDeploymentPoliciesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListContinuousDeploymentPoliciesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListContinuousDeploymentPoliciesInput>()
                        .ok_or("failed to downcast to ListContinuousDeploymentPoliciesInput")?;
...
pub enum ListContinuousDeploymentPoliciesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListContinuousDeploymentPoliciesError) for what information is available for the error.")]
...
impl ListContinuousDeploymentPoliciesError {
    /// Creates the `ListContinuousDeploymentPoliciesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListContinuousDeploymentPoliciesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListContinuousDeploymentPoliciesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListContinuousDeploymentPoliciesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_continuous_deployment_policies::ListContinuousDeploymentPoliciesError {
...
mod _list_continuous_deployment_policies_output;
