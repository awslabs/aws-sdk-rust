...
impl UpdateOriginRequestPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_origin_request_policy::UpdateOriginRequestPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateOriginRequestPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_origin_request_policy::de_update_origin_request_policy_http_response_with_props(status, headers, body)
        }
    }
}
