    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/cache-policy/{Id}/config", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cache_policy_config::GetCachePolicyConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_cache_policy_config::GetCachePolicyConfigError
{
