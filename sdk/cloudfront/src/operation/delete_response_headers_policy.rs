...
impl DeleteResponseHeadersPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResponseHeadersPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_response_headers_policy::de_delete_response_headers_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
