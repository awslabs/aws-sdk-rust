...
impl DeleteResponseHeadersPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResponseHeadersPolicy`](crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteResponseHeadersPolicy {
                type Output = std::result::Result<crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicyOutput, crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicyError>;
