    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/response-headers-policy/{Id}", Id = id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResponseHeadersPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_response_headers_policy::de_delete_response_headers_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteResponseHeadersPolicyError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicyError
{
