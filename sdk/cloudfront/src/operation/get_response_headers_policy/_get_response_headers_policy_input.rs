...
impl GetResponseHeadersPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_response_headers_policy::GetResponseHeadersPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
