...
impl crate::operation::update_streaming_distribution::builders::UpdateStreamingDistributionInputBuilder {
...
impl UpdateStreamingDistributionFluentBuilder {
    /// Creates a new `UpdateStreamingDistributionFluentBuilder`.
