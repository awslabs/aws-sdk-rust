...
impl ListDistributionsByResponseHeadersPolicyIdInput {
    /// Consumes the builder and constructs an Operation<[`ListDistributionsByResponseHeadersPolicyId`](crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyId, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyIdInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.response_headers_policy_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("response_headers_policy_id", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyIdInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyId::new())
...
/// `ParseStrictResponse` impl for `ListDistributionsByResponseHeadersPolicyId`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListDistributionsByResponseHeadersPolicyId {
                type Output = std::result::Result<crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyIdOutput, crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyIdError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_distributions_by_response_headers_policy_id::de_list_distributions_by_response_headers_policy_id_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_distributions_by_response_headers_policy_id::de_list_distributions_by_response_headers_policy_id_http_response(response)
                     }
                }
            }
...
/// Do not use this.
            ...
            pub type ListDistributionsByResponseHeadersPolicyIdErrorKind = ListDistributionsByResponseHeadersPolicyIdError;
...
impl aws_http::request_id::RequestId for crate::operation::list_distributions_by_response_headers_policy_id::ListDistributionsByResponseHeadersPolicyIdError {
