...
impl GetOriginAccessControlInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_origin_access_control::GetOriginAccessControl,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOriginAccessControl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_origin_access_control::de_get_origin_access_control_http_response_with_props(status, headers, body)
        }
    }
}
