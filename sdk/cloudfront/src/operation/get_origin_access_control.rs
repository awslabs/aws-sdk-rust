    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/origin-access-control/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_origin_access_control::GetOriginAccessControl::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_origin_access_control::GetOriginAccessControlError
{
