...
impl GetOriginAccessControl {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_origin_access_control::GetOriginAccessControlInput,
                    ) -> ::std::result::Result<crate::operation::get_origin_access_control::GetOriginAccessControlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_access_control::GetOriginAccessControlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_origin_access_control::GetOriginAccessControlError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_origin_access_control::GetOriginAccessControlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOriginAccessControl {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOriginAccessControl");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetOriginAccessControlRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetOriginAccessControlResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOriginAccessControl")
...
.with_interceptor(GetOriginAccessControlEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_origin_access_control::GetOriginAccessControlError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_origin_access_control::GetOriginAccessControlError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_origin_access_control::GetOriginAccessControlError>::new());
...
#[derive(Debug)]
            struct GetOriginAccessControlResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOriginAccessControlResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_origin_access_control::de_get_origin_access_control_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_origin_access_control::de_get_origin_access_control_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetOriginAccessControlRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOriginAccessControlRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_origin_access_control::GetOriginAccessControlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_origin_access_control::GetOriginAccessControlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/origin-access-control/{Id}", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetOriginAccessControlEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOriginAccessControlEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetOriginAccessControlEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetOriginAccessControlInput>()
                        .ok_or("failed to downcast to GetOriginAccessControlInput")?;
...
pub enum GetOriginAccessControlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOriginAccessControlError) for what information is available for the error.")]
...
impl GetOriginAccessControlError {
    /// Creates the `GetOriginAccessControlError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetOriginAccessControlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOriginAccessControlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_origin_access_control::GetOriginAccessControlError {
...
mod _get_origin_access_control_output;
