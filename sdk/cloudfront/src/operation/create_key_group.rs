...
impl CreateKeyGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_key_group::CreateKeyGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_key_group::CreateKeyGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_key_group_input::ser_key_group_config_http_payload(& self.key_group_config)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for CreateKeyGroup {
                type Output = std::result::Result<crate::operation::create_key_group::CreateKeyGroupOutput, crate::operation::create_key_group::CreateKeyGroupError>;
