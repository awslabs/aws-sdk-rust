...
impl CreateKeyGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateKeyGroup`](crate::operation::create_key_group::CreateKeyGroup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_key_group::CreateKeyGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_key_group::CreateKeyGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKeyGroup {
    type Output =
        ::std::result::Result<crate::operation::create_key_group::CreateKeyGroupOutput, crate::operation::create_key_group::CreateKeyGroupError>;
