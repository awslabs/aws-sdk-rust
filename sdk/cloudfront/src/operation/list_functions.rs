...
impl ListFunctions {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudfront", "ListFunctions", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFunctions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListFunctions", "cloudfront"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/2020-05-31/function").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_functions::ListFunctionsInput,
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.stage {
                    {
                        query.push_kv("Stage", &::aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                ::std::result::Result::Ok(())
            }
