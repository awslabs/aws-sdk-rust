...
impl ListFunctions {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudFront", "ListFunctions", input, runtime_plugins, stop_point)
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.stage {
                    {
                        query.push_kv("Stage", &::aws_smithy_http::query::fmt_string(inner_3.as_str()));
                    }
                }
                ::std::result::Result::Ok(())
            }
