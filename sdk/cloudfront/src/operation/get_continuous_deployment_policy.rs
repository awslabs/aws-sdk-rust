...
/// Orchestration and serialization glue logic for `GetContinuousDeploymentPolicy`.
...
impl GetContinuousDeploymentPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyInput,
                    ) -> ::std::result::Result<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContinuousDeploymentPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContinuousDeploymentPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContinuousDeploymentPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContinuousDeploymentPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContinuousDeploymentPolicy")
...
.with_interceptor(GetContinuousDeploymentPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError>::new());
...
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContinuousDeploymentPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_continuous_deployment_policy::de_get_continuous_deployment_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_continuous_deployment_policy::de_get_continuous_deployment_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContinuousDeploymentPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/continuous-deployment-policy/{Id}", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContinuousDeploymentPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetContinuousDeploymentPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetContinuousDeploymentPolicyInput>()
                        .ok_or("failed to downcast to GetContinuousDeploymentPolicyInput")?;
...
pub enum GetContinuousDeploymentPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContinuousDeploymentPolicyError) for what information is available for the error.")]
...
impl GetContinuousDeploymentPolicyError {
    /// Creates the `GetContinuousDeploymentPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetContinuousDeploymentPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetContinuousDeploymentPolicyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContinuousDeploymentPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError {
...
mod _get_continuous_deployment_policy_output;
