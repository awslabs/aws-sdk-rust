...
impl GetContinuousDeploymentPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetContinuousDeploymentPolicy`](crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContinuousDeploymentPolicy", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetContinuousDeploymentPolicy`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetContinuousDeploymentPolicy {
                type Output = std::result::Result<crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyOutput, crate::operation::get_continuous_deployment_policy::GetContinuousDeploymentPolicyError>;
