...
impl GetResponseHeadersPolicyConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_response_headers_policy_config::GetResponseHeadersPolicyConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResponseHeadersPolicyConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_response_headers_policy_config::de_get_response_headers_policy_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
