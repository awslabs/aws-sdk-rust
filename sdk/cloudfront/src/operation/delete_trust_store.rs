...
impl DeleteTrustStore {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudFront", "DeleteTrustStore", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_delete_trust_store::ser_delete_trust_store_headers(input, builder)?;
...
impl DeleteTrustStoreError {
    ...
    /// Returns `true` if the error kind is `DeleteTrustStoreError::AccessDenied`.
    pub fn is_access_denied(&self) -> bool {
        matches!(self, Self::AccessDenied(_))
    }
    /// Returns `true` if the error kind is `DeleteTrustStoreError::CannotDeleteEntityWhileInUse`.
    pub fn is_cannot_delete_entity_while_in_use(&self) -> bool {
        matches!(self, Self::CannotDeleteEntityWhileInUse(_))
    }
    /// Returns `true` if the error kind is `DeleteTrustStoreError::EntityNotFound`.
    pub fn is_entity_not_found(&self) -> bool {
        matches!(self, Self::EntityNotFound(_))
    }
    /// Returns `true` if the error kind is `DeleteTrustStoreError::InvalidArgument`.
    pub fn is_invalid_argument(&self) -> bool {
        matches!(self, Self::InvalidArgument(_))
    }
    /// Returns `true` if the error kind is `DeleteTrustStoreError::InvalidIfMatchVersion`.
    pub fn is_invalid_if_match_version(&self) -> bool {
        matches!(self, Self::InvalidIfMatchVersion(_))
    }
    /// Returns `true` if the error kind is `DeleteTrustStoreError::PreconditionFailed`.
