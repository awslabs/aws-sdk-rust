...
impl ListDistributionsByOriginRequestPolicyIdInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyId,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyId::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributionsByOriginRequestPolicyId {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_distributions_by_origin_request_policy_id::de_list_distributions_by_origin_request_policy_id_http_response_with_props(status, headers, body)
        }
    }
}
