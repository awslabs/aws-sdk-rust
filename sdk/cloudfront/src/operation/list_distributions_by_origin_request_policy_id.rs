...
/// Orchestration and serialization glue logic for `ListDistributionsByOriginRequestPolicyId`.
...
impl ListDistributionsByOriginRequestPolicyId {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdInput,
                    ) -> ::std::result::Result<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDistributionsByOriginRequestPolicyId {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDistributionsByOriginRequestPolicyId");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDistributionsByOriginRequestPolicyIdRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDistributionsByOriginRequestPolicyIdResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDistributionsByOriginRequestPolicyId")
...
.with_interceptor(ListDistributionsByOriginRequestPolicyIdEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError>::new());
...
#[derive(Debug)]
            struct ListDistributionsByOriginRequestPolicyIdResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDistributionsByOriginRequestPolicyIdResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_distributions_by_origin_request_policy_id::de_list_distributions_by_origin_request_policy_id_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_distributions_by_origin_request_policy_id::de_list_distributions_by_origin_request_policy_id_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDistributionsByOriginRequestPolicyIdRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDistributionsByOriginRequestPolicyIdRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.origin_request_policy_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("origin_request_policy_id", "cannot be empty or unset"))?;
    let origin_request_policy_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if origin_request_policy_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("origin_request_policy_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2020-05-31/distributionsByOriginRequestPolicyId/{OriginRequestPolicyId}", OriginRequestPolicyId = origin_request_policy_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListDistributionsByOriginRequestPolicyIdEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDistributionsByOriginRequestPolicyIdEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDistributionsByOriginRequestPolicyIdEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDistributionsByOriginRequestPolicyIdInput>()
                        .ok_or("failed to downcast to ListDistributionsByOriginRequestPolicyIdInput")?;
...
pub enum ListDistributionsByOriginRequestPolicyIdError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDistributionsByOriginRequestPolicyIdError) for what information is available for the error.")]
...
impl ListDistributionsByOriginRequestPolicyIdError {
    /// Creates the `ListDistributionsByOriginRequestPolicyIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDistributionsByOriginRequestPolicyIdError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDistributionsByOriginRequestPolicyIdError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDistributionsByOriginRequestPolicyIdError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_distributions_by_origin_request_policy_id::ListDistributionsByOriginRequestPolicyIdError {
...
mod _list_distributions_by_origin_request_policy_id_output;
