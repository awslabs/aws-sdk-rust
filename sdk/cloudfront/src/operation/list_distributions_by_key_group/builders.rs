...
impl ListDistributionsByKeyGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupOutput, crate::operation::list_distributions_by_key_group::ListDistributionsByKeyGroupError, Self> {
