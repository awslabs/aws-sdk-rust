    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCloudFrontOriginAccessIdentities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCloudFrontOriginAccessIdentities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCloudFrontOriginAccessIdentitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCloudFrontOriginAccessIdentitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCloudFrontOriginAccessIdentities")
...
.with_interceptor(ListCloudFrontOriginAccessIdentitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCloudFrontOriginAccessIdentitiesResponseDeserializer {
...
#[derive(Debug)]
            struct ListCloudFrontOriginAccessIdentitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCloudFrontOriginAccessIdentitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2020-05-31/origin-access-identity/cloudfront").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListCloudFrontOriginAccessIdentitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCloudFrontOriginAccessIdentitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCloudFrontOriginAccessIdentitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCloudFrontOriginAccessIdentitiesInput>()
                        .ok_or("failed to downcast to ListCloudFrontOriginAccessIdentitiesInput")?;
...
pub enum ListCloudFrontOriginAccessIdentitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCloudFrontOriginAccessIdentitiesError) for what information is available for the error.")]
...
impl ListCloudFrontOriginAccessIdentitiesError {
    /// Creates the `ListCloudFrontOriginAccessIdentitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCloudFrontOriginAccessIdentitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCloudFrontOriginAccessIdentitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError {
