...
impl CreateOriginAccessControlInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_origin_access_control::CreateOriginAccessControl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOriginAccessControl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_origin_access_control::de_create_origin_access_control_http_response_with_props(status, headers, body)
        }
    }
}
