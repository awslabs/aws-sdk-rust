...
impl UpdateFieldLevelEncryptionConfig {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_field_level_encryption_config::UpdateFieldLevelEncryptionConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_field_level_encryption_config::UpdateFieldLevelEncryptionConfigOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateFieldLevelEncryptionConfig",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFieldLevelEncryptionConfig {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateFieldLevelEncryptionConfigRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateFieldLevelEncryptionConfigResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateFieldLevelEncryptionConfig")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFieldLevelEncryptionConfig")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateFieldLevelEncryptionConfigTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateFieldLevelEncryptionConfigTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFieldLevelEncryptionConfigTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateFieldLevelEncryptionConfigInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFieldLevelEncryptionConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_field_level_encryption_config::de_update_field_level_encryption_config_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_field_level_encryption_config::de_update_field_level_encryption_config_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFieldLevelEncryptionConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_field_level_encryption_config::UpdateFieldLevelEncryptionConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_field_level_encryption_config::UpdateFieldLevelEncryptionConfigInput,
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_update_field_level_encryption_config::ser_update_field_level_encryption_config_headers(
                    input, builder,
                )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_field_level_encryption_config_input::ser_field_level_encryption_config_http_payload(
...
impl ::std::error::Error for UpdateFieldLevelEncryptionConfigError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::QueryArgProfileEmpty(_inner) => ::std::option::Option::Some(_inner),
            Self::TooManyFieldLevelEncryptionContentTypeProfiles(_inner) => ::std::option::Option::Some(_inner),
            Self::TooManyFieldLevelEncryptionQueryArgProfiles(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateFieldLevelEncryptionConfigError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::QueryArgProfileEmpty(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::TooManyFieldLevelEncryptionContentTypeProfiles(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::TooManyFieldLevelEncryptionQueryArgProfiles(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
