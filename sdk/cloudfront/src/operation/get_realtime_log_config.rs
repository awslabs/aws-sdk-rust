...
impl GetRealtimeLogConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetRealtimeLogConfig`](crate::operation::get_realtime_log_config::GetRealtimeLogConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_realtime_log_config::GetRealtimeLogConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_realtime_log_config::GetRealtimeLogConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_realtime_log_config::GetRealtimeLogConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRealtimeLogConfig", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetRealtimeLogConfig`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetRealtimeLogConfig {
                type Output = std::result::Result<crate::operation::get_realtime_log_config::GetRealtimeLogConfigOutput, crate::operation::get_realtime_log_config::GetRealtimeLogConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_realtime_log_config::de_get_realtime_log_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_realtime_log_config::de_get_realtime_log_config_http_response(response)
                     }
                }
            }
