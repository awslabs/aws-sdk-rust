...
impl ListStreamingDistributionsInput {
    /// Consumes the builder and constructs an Operation<[`ListStreamingDistributions`](crate::operation::list_streaming_distributions::ListStreamingDistributions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_streaming_distributions::ListStreamingDistributions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_streaming_distributions::ListStreamingDistributionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2020-05-31/streaming-distribution").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_streaming_distributions::ListStreamingDistributionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_streaming_distributions::ListStreamingDistributions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListStreamingDistributions", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListStreamingDistributions`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListStreamingDistributions {
                type Output = std::result::Result<crate::operation::list_streaming_distributions::ListStreamingDistributionsOutput, crate::operation::list_streaming_distributions::ListStreamingDistributionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_streaming_distributions::de_list_streaming_distributions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_streaming_distributions::de_list_streaming_distributions_http_response(response)
                     }
                }
            }
