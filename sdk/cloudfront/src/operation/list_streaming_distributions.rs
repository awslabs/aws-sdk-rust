...
impl ListStreamingDistributionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_streaming_distributions::ListStreamingDistributions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStreamingDistributions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_streaming_distributions::de_list_streaming_distributions_http_response_with_props(status, headers, body)
        }
    }
}
