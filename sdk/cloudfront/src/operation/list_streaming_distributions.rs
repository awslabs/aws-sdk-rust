...
/// Orchestration and serialization glue logic for `ListStreamingDistributions`.
...
impl ListStreamingDistributions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_streaming_distributions::ListStreamingDistributionsInput,
                    ) -> ::std::result::Result<crate::operation::list_streaming_distributions::ListStreamingDistributionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_streaming_distributions::ListStreamingDistributionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_streaming_distributions::ListStreamingDistributionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_streaming_distributions::ListStreamingDistributionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListStreamingDistributions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListStreamingDistributions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListStreamingDistributionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListStreamingDistributionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListStreamingDistributions")
...
.with_interceptor(ListStreamingDistributionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_streaming_distributions::ListStreamingDistributionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_streaming_distributions::ListStreamingDistributionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_streaming_distributions::ListStreamingDistributionsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListStreamingDistributionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_streaming_distributions::de_list_streaming_distributions_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListStreamingDistributionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListStreamingDistributionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_streaming_distributions::ListStreamingDistributionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_streaming_distributions::ListStreamingDistributionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2020-05-31/streaming-distribution").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_streaming_distributions::ListStreamingDistributionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListStreamingDistributionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListStreamingDistributionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListStreamingDistributionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListStreamingDistributionsInput>()
                        .ok_or("failed to downcast to ListStreamingDistributionsInput")?;
...
pub enum ListStreamingDistributionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListStreamingDistributionsError) for what information is available for the error.")]
...
impl ListStreamingDistributionsError {
    /// Creates the `ListStreamingDistributionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListStreamingDistributionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListStreamingDistributionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_streaming_distributions::ListStreamingDistributionsError {
...
mod _list_streaming_distributions_output;
