    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/delete-realtime-log-config")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfigError
{
