    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2020-05-31/domain-association").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_update_domain_association::ser_update_domain_association_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_domain_association::ser_update_domain_association_op_input(&input)?,
        );
...
impl UpdateDomainAssociationError {
    ...
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::AccessDenied`.
    pub fn is_access_denied(&self) -> bool {
        matches!(self, Self::AccessDenied(_))
    }
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::EntityNotFound`.
    pub fn is_entity_not_found(&self) -> bool {
        matches!(self, Self::EntityNotFound(_))
    }
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::IllegalUpdate`.
    pub fn is_illegal_update(&self) -> bool {
        matches!(self, Self::IllegalUpdate(_))
    }
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::InvalidArgument`.
    pub fn is_invalid_argument(&self) -> bool {
        matches!(self, Self::InvalidArgument(_))
    }
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::InvalidIfMatchVersion`.
    pub fn is_invalid_if_match_version(&self) -> bool {
        matches!(self, Self::InvalidIfMatchVersion(_))
    }
    /// Returns `true` if the error kind is `UpdateDomainAssociationError::PreconditionFailed`.
