...
/// Orchestration and serialization glue logic for `CreateContinuousDeploymentPolicy`.
...
impl CreateContinuousDeploymentPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContinuousDeploymentPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateContinuousDeploymentPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateContinuousDeploymentPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateContinuousDeploymentPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateContinuousDeploymentPolicy")
...
.with_interceptor(CreateContinuousDeploymentPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError>::new());
...
#[derive(Debug)]
            struct CreateContinuousDeploymentPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContinuousDeploymentPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_continuous_deployment_policy::de_create_continuous_deployment_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_continuous_deployment_policy::de_create_continuous_deployment_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateContinuousDeploymentPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContinuousDeploymentPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_continuous_deployment_policy_input::ser_continuous_deployment_policy_config_http_payload(& input.continuous_deployment_policy_config)?);
...
#[derive(Debug)]
            struct CreateContinuousDeploymentPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContinuousDeploymentPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateContinuousDeploymentPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateContinuousDeploymentPolicyInput>()
                        .ok_or("failed to downcast to CreateContinuousDeploymentPolicyInput")?;
...
pub enum CreateContinuousDeploymentPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateContinuousDeploymentPolicyError) for what information is available for the error.")]
...
impl CreateContinuousDeploymentPolicyError {
    /// Creates the `CreateContinuousDeploymentPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateContinuousDeploymentPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ContinuousDeploymentPolicyAlreadyExists(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::TooManyContinuousDeploymentPolicies(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateContinuousDeploymentPolicyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateContinuousDeploymentPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_continuous_deployment_policy::_create_continuous_deployment_policy_output::CreateContinuousDeploymentPolicyOutput;

pub use crate::operation::create_continuous_deployment_policy::_create_continuous_deployment_policy_input::CreateContinuousDeploymentPolicyInput;

mod _create_continuous_deployment_policy_input;

mod _create_continuous_deployment_policy_output;
