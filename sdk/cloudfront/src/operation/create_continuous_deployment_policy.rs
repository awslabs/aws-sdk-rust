...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateContinuousDeploymentPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_continuous_deployment_policy::de_create_continuous_deployment_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_continuous_deployment_policy::CreateContinuousDeploymentPolicyError
{
