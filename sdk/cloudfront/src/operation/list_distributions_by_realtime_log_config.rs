...
/// Orchestration and serialization glue logic for `ListDistributionsByRealtimeLogConfig`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDistributionsByRealtimeLogConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDistributionsByRealtimeLogConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDistributionsByRealtimeLogConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDistributionsByRealtimeLogConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDistributionsByRealtimeLogConfig")
...
.with_interceptor(ListDistributionsByRealtimeLogConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigError>::new());
...
#[derive(Debug)]
            struct ListDistributionsByRealtimeLogConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDistributionsByRealtimeLogConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_distributions_by_realtime_log_config::de_list_distributions_by_realtime_log_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_distributions_by_realtime_log_config::de_list_distributions_by_realtime_log_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDistributionsByRealtimeLogConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDistributionsByRealtimeLogConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_distributions_by_realtime_log_config::ser_list_distributions_by_realtime_log_config_op_input(&input)?);
...
#[derive(Debug)]
            struct ListDistributionsByRealtimeLogConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDistributionsByRealtimeLogConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDistributionsByRealtimeLogConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDistributionsByRealtimeLogConfigInput>()
                        .ok_or("failed to downcast to ListDistributionsByRealtimeLogConfigInput")?;
...
pub enum ListDistributionsByRealtimeLogConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDistributionsByRealtimeLogConfigError) for what information is available for the error.")]
...
impl ListDistributionsByRealtimeLogConfigError {
    /// Creates the `ListDistributionsByRealtimeLogConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDistributionsByRealtimeLogConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDistributionsByRealtimeLogConfigError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDistributionsByRealtimeLogConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_distributions_by_realtime_log_config::ListDistributionsByRealtimeLogConfigError {
...
mod _list_distributions_by_realtime_log_config_output;
