...
impl UpdateCachePolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_cache_policy::UpdateCachePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_cache_policy::UpdateCachePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateCachePolicy {
                type Output = std::result::Result<crate::operation::update_cache_policy::UpdateCachePolicyOutput, crate::operation::update_cache_policy::UpdateCachePolicyError>;
