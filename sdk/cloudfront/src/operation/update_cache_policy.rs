...
impl UpdateCachePolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCachePolicy`](crate::operation::update_cache_policy::UpdateCachePolicy)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_cache_policy::UpdateCachePolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCachePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cache_policy::de_update_cache_policy_http_response_with_props(status, headers, body)
        }
    }
}
