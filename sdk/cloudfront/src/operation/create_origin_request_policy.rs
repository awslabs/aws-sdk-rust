...
impl CreateOriginRequestPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_origin_request_policy::CreateOriginRequestPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_origin_request_policy::CreateOriginRequestPolicyOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateOriginRequestPolicy",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateOriginRequestPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateOriginRequestPolicyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateOriginRequestPolicyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateOriginRequestPolicy")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOriginRequestPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_origin_request_policy::de_create_origin_request_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_origin_request_policy::de_create_origin_request_policy_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateOriginRequestPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_origin_request_policy::CreateOriginRequestPolicyInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_origin_request_policy_input::ser_origin_request_policy_config_http_payload(
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateOriginRequestPolicyError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TooManyOriginRequestPolicies(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
