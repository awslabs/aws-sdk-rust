...
impl ListFieldLevelEncryptionProfilesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_field_level_encryption_profiles::ListFieldLevelEncryptionProfiles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFieldLevelEncryptionProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_field_level_encryption_profiles::de_list_field_level_encryption_profiles_http_response_with_props(
                status, headers, body,
            )
        }
    }
