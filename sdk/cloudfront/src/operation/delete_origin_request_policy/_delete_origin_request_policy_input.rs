...
impl DeleteOriginRequestPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
