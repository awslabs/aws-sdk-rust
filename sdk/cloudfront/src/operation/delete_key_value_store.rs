...
/// Orchestration and serialization glue logic for `DeleteKeyValueStore`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteKeyValueStore;
impl DeleteKeyValueStore {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_key_value_store::DeleteKeyValueStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_key_value_store::DeleteKeyValueStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_key_value_store::DeleteKeyValueStoreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_key_value_store::DeleteKeyValueStoreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteKeyValueStore {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteKeyValueStore");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteKeyValueStoreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteKeyValueStoreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteKeyValueStore")
...
.with_interceptor(DeleteKeyValueStoreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_key_value_store::DeleteKeyValueStoreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_key_value_store::DeleteKeyValueStoreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_key_value_store::DeleteKeyValueStoreError>::new());
...
#[derive(Debug)]
            struct DeleteKeyValueStoreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteKeyValueStoreResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_key_value_store::de_delete_key_value_store_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_key_value_store::de_delete_key_value_store_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteKeyValueStoreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteKeyValueStoreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_key_value_store::DeleteKeyValueStoreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_key_value_store::DeleteKeyValueStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_delete_key_value_store::ser_delete_key_value_store_headers(input, builder)?;
...
#[derive(Debug)]
            struct DeleteKeyValueStoreEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteKeyValueStoreEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteKeyValueStoreEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteKeyValueStoreInput>()
                        .ok_or("failed to downcast to DeleteKeyValueStoreInput")?;
...
/// Error type for the `DeleteKeyValueStoreError` operation.
#[non_exhaustive]
...
pub enum DeleteKeyValueStoreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteKeyValueStoreError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteKeyValueStoreError {
    /// Creates the `DeleteKeyValueStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteKeyValueStoreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteKeyValueStoreError::AccessDenied`.
    pub fn is_access_denied(&self) -> bool {
        matches!(self, Self::AccessDenied(_))
    }
    /// Returns `true` if the error kind is `DeleteKeyValueStoreError::CannotDeleteEntityWhileInUse`.
    pub fn is_cannot_delete_entity_while_in_use(&self) -> bool {
        matches!(self, Self::CannotDeleteEntityWhileInUse(_))
    }
    /// Returns `true` if the error kind is `DeleteKeyValueStoreError::EntityNotFound`.
    pub fn is_entity_not_found(&self) -> bool {
        matches!(self, Self::EntityNotFound(_))
    }
    /// Returns `true` if the error kind is `DeleteKeyValueStoreError::InvalidIfMatchVersion`.
    pub fn is_invalid_if_match_version(&self) -> bool {
        matches!(self, Self::InvalidIfMatchVersion(_))
    }
    /// Returns `true` if the error kind is `DeleteKeyValueStoreError::PreconditionFailed`.
...
impl ::std::error::Error for DeleteKeyValueStoreError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ,
            Self::CannotDeleteEntityWhileInUse(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for DeleteKeyValueStoreError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteKeyValueStoreError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteKeyValueStoreError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteKeyValueStoreError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_key_value_store::DeleteKeyValueStoreError {
...
mod _delete_key_value_store_output;
