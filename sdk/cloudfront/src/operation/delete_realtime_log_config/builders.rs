...
impl DeleteRealtimeLogConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfigOutput, crate::operation::delete_realtime_log_config::DeleteRealtimeLogConfigError, Self> {
