    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_field_level_encryption_profile::CreateFieldLevelEncryptionProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/field-level-encryption-profile")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFieldLevelEncryptionProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_field_level_encryption_profile::de_create_field_level_encryption_profile_http_response_with_props(status, headers, body)
        }
    }
}
