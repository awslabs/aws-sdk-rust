    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/key-group/{Id}/config", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_key_group_config::GetKeyGroupConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_key_group_config::GetKeyGroupConfigError
{
