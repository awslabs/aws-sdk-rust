...
impl GetKeyGroupConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetKeyGroupConfig`](crate::operation::get_key_group_config::GetKeyGroupConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_key_group_config::GetKeyGroupConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_key_group_config::GetKeyGroupConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_key_group_config::GetKeyGroupConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetKeyGroupConfig {
                type Output = std::result::Result<crate::operation::get_key_group_config::GetKeyGroupConfigOutput, crate::operation::get_key_group_config::GetKeyGroupConfigError>;
