...
/// Orchestration and serialization glue logic for `GetKeyGroupConfig`.
...
impl GetKeyGroupConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_key_group_config::GetKeyGroupConfigInput,
                    ) -> ::std::result::Result<crate::operation::get_key_group_config::GetKeyGroupConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_key_group_config::GetKeyGroupConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_key_group_config::GetKeyGroupConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_key_group_config::GetKeyGroupConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetKeyGroupConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetKeyGroupConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetKeyGroupConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetKeyGroupConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetKeyGroupConfig")
...
.with_interceptor(GetKeyGroupConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_key_group_config::GetKeyGroupConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_key_group_config::GetKeyGroupConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_key_group_config::GetKeyGroupConfigError>::new());
...
#[derive(Debug)]
            struct GetKeyGroupConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetKeyGroupConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_key_group_config::de_get_key_group_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_key_group_config::de_get_key_group_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetKeyGroupConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetKeyGroupConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_key_group_config::GetKeyGroupConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_key_group_config::GetKeyGroupConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/key-group/{Id}/config", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetKeyGroupConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetKeyGroupConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetKeyGroupConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetKeyGroupConfigInput>()
                        .ok_or("failed to downcast to GetKeyGroupConfigInput")?;
...
pub enum GetKeyGroupConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetKeyGroupConfigError) for what information is available for the error.")]
...
impl GetKeyGroupConfigError {
    /// Creates the `GetKeyGroupConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetKeyGroupConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetKeyGroupConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_key_group_config::GetKeyGroupConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_key_group_config::_get_key_group_config_output::GetKeyGroupConfigOutput;

pub use crate::operation::get_key_group_config::_get_key_group_config_input::GetKeyGroupConfigInput;

mod _get_key_group_config_input;

mod _get_key_group_config_output;
