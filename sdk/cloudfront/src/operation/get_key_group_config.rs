...
impl GetKeyGroupConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_key_group_config::GetKeyGroupConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKeyGroupConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_key_group_config::de_get_key_group_config_http_response_with_props(status, headers, body)
        }
    }
}
