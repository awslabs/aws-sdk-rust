...
impl DeletePublicKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_public_key::DeletePublicKey,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_public_key::DeletePublicKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePublicKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_public_key::de_delete_public_key_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_public_key::DeletePublicKeyError
{
