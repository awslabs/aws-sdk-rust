...
impl DeletePublicKeyInput {
    /// Consumes the builder and constructs an Operation<[`DeletePublicKey`](crate::operation::delete_public_key::DeletePublicKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_public_key::DeletePublicKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_public_key::DeletePublicKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_public_key::DeletePublicKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePublicKey", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeletePublicKey`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePublicKey {
                type Output = std::result::Result<crate::operation::delete_public_key::DeletePublicKeyOutput, crate::operation::delete_public_key::DeletePublicKeyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_delete_public_key::de_delete_public_key_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_public_key::de_delete_public_key_http_response(response)
                     }
                }
            }
