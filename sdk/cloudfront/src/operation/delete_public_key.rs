...
impl DeletePublicKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_public_key::DeletePublicKey, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePublicKey {
    type Output =
        ::std::result::Result<crate::operation::delete_public_key::DeletePublicKeyOutput, crate::operation::delete_public_key::DeletePublicKeyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_public_key::de_delete_public_key_http_response_with_props(status, headers, body)
        }
    }
}
