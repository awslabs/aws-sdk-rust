...
impl ListOriginAccessControlsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_origin_access_controls::ListOriginAccessControls::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOriginAccessControls {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_origin_access_controls::de_list_origin_access_controls_http_response_with_props(status, headers, body)
        }
    }
}
