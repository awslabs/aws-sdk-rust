...
impl ListOriginAccessControlsInput {
    /// Consumes the builder and constructs an Operation<[`ListOriginAccessControls`](crate::operation::list_origin_access_controls::ListOriginAccessControls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_origin_access_controls::ListOriginAccessControls, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_origin_access_controls::ListOriginAccessControlsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2020-05-31/origin-access-control").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_origin_access_controls::ListOriginAccessControlsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_origin_access_controls::ListOriginAccessControls::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListOriginAccessControls {
                type Output = std::result::Result<crate::operation::list_origin_access_controls::ListOriginAccessControlsOutput, crate::operation::list_origin_access_controls::ListOriginAccessControlsError>;
