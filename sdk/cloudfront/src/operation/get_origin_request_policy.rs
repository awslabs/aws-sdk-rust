...
impl GetOriginRequestPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_origin_request_policy::GetOriginRequestPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOriginRequestPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_origin_request_policy::de_get_origin_request_policy_http_response_with_props(status, headers, body)
        }
    }
}
