    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/origin-request-policy/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_origin_request_policy::GetOriginRequestPolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_origin_request_policy::GetOriginRequestPolicyError
{
