...
/// Orchestration and serialization glue logic for `GetOriginRequestPolicy`.
...
impl GetOriginRequestPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_origin_request_policy::GetOriginRequestPolicyInput,
                    ) -> ::std::result::Result<crate::operation::get_origin_request_policy::GetOriginRequestPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_request_policy::GetOriginRequestPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOriginRequestPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOriginRequestPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetOriginRequestPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetOriginRequestPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOriginRequestPolicy")
...
.with_interceptor(GetOriginRequestPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyError>::new());
...
#[derive(Debug)]
            struct GetOriginRequestPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOriginRequestPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_origin_request_policy::de_get_origin_request_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_origin_request_policy::de_get_origin_request_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetOriginRequestPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOriginRequestPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_origin_request_policy::GetOriginRequestPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_origin_request_policy::GetOriginRequestPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/origin-request-policy/{Id}", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetOriginRequestPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOriginRequestPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetOriginRequestPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetOriginRequestPolicyInput>()
                        .ok_or("failed to downcast to GetOriginRequestPolicyInput")?;
...
pub enum GetOriginRequestPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOriginRequestPolicyError) for what information is available for the error.")]
...
impl GetOriginRequestPolicyError {
    /// Creates the `GetOriginRequestPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetOriginRequestPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOriginRequestPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_origin_request_policy::GetOriginRequestPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_origin_request_policy::_get_origin_request_policy_output::GetOriginRequestPolicyOutput;

pub use crate::operation::get_origin_request_policy::_get_origin_request_policy_input::GetOriginRequestPolicyInput;

mod _get_origin_request_policy_input;

mod _get_origin_request_policy_output;
