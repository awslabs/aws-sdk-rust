...
impl GetCloudFrontOriginAccessIdentityConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_cloud_front_origin_access_identity_config::GetCloudFrontOriginAccessIdentityConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cloud_front_origin_access_identity_config::GetCloudFrontOriginAccessIdentityConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCloudFrontOriginAccessIdentityConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cloud_front_origin_access_identity_config::de_get_cloud_front_origin_access_identity_config_http_response_with_props(status, headers, body)
        }
    }
}
