...
impl UpdateCloudFrontOriginAccessIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateCloudFrontOriginAccessIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCloudFrontOriginAccessIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateCloudFrontOriginAccessIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateCloudFrontOriginAccessIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateCloudFrontOriginAccessIdentity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateCloudFrontOriginAccessIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateCloudFrontOriginAccessIdentityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCloudFrontOriginAccessIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_cloud_front_origin_access_identity::de_update_cloud_front_origin_access_identity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_cloud_front_origin_access_identity::de_update_cloud_front_origin_access_identity_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCloudFrontOriginAccessIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_update_cloud_front_origin_access_identity::ser_update_cloud_front_origin_access_identity_headers(
                        input, builder,
                    )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_cloud_front_origin_access_identity_input::ser_cloud_front_origin_access_identity_config_http_payload(
