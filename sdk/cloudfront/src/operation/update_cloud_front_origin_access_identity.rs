...
impl UpdateCloudFrontOriginAccessIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCloudFrontOriginAccessIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cloud_front_origin_access_identity::de_update_cloud_front_origin_access_identity_http_response_with_props(status, headers, body)
        }
    }
}
