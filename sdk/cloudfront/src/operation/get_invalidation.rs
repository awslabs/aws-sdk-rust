...
impl GetInvalidationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_invalidation::GetInvalidation,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_invalidation::GetInvalidation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInvalidation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_invalidation::de_get_invalidation_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_invalidation::GetInvalidationError
{
