...
impl GetInvalidationInput {
    /// Consumes the builder and constructs an Operation<[`GetInvalidation`](crate::operation::get_invalidation::GetInvalidation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_invalidation::GetInvalidation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_invalidation::GetInvalidationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_invalidation::GetInvalidation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInvalidation", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetInvalidation`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetInvalidation {
                type Output = std::result::Result<crate::operation::get_invalidation::GetInvalidationOutput, crate::operation::get_invalidation::GetInvalidationError>;
