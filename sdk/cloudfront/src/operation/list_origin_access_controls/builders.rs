...
impl ListOriginAccessControlsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_origin_access_controls::ListOriginAccessControlsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_origin_access_controls::ListOriginAccessControlsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_origin_access_controls::ListOriginAccessControlsOutput, crate::operation::list_origin_access_controls::ListOriginAccessControlsError, Self> {
