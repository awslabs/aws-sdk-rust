...
impl TestFunctionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::test_function::TestFunction, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_test_function::ser_test_function_op_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestFunction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_function::de_test_function_http_response_with_props(status, headers, body)
        }
    }
