    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/key-group/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_key_group::UpdateKeyGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateKeyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_key_group::de_update_key_group_http_error(
                status, headers, body,
            )
        } else {
