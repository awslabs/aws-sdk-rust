...
impl UpdateKeyGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_key_group::UpdateKeyGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_key_group::UpdateKeyGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_key_group_input::ser_key_group_config_http_payload(& self.key_group_config)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateKeyGroup {
                type Output = std::result::Result<crate::operation::update_key_group::UpdateKeyGroupOutput, crate::operation::update_key_group::UpdateKeyGroupError>;
