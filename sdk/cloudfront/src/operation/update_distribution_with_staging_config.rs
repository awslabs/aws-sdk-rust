...
/// Orchestration and serialization glue logic for `UpdateDistributionWithStagingConfig`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDistributionWithStagingConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDistributionWithStagingConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDistributionWithStagingConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDistributionWithStagingConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDistributionWithStagingConfig")
...
.with_interceptor(UpdateDistributionWithStagingConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigError>::new());
...
#[derive(Debug)]
            struct UpdateDistributionWithStagingConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDistributionWithStagingConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_distribution_with_staging_config::de_update_distribution_with_staging_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_distribution_with_staging_config::de_update_distribution_with_staging_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateDistributionWithStagingConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDistributionWithStagingConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/distribution/{Id}/promote-staging-config", Id = id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::update_distribution_with_staging_config::UpdateDistributionWithStagingConfigInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.staging_distribution_id {
         {
            query.push_kv("StagingDistributionId", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct UpdateDistributionWithStagingConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDistributionWithStagingConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDistributionWithStagingConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDistributionWithStagingConfigInput>()
                        .ok_or("failed to downcast to UpdateDistributionWithStagingConfigInput")?;
...
pub enum UpdateDistributionWithStagingConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDistributionWithStagingConfigError) for what information is available for the error.")]
...
impl UpdateDistributionWithStagingConfigError {
    /// Creates the `UpdateDistributionWithStagingConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDistributionWithStagingConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateDistributionWithStagingConfigError::TooManyDistributionsAssociatedToOriginAccessControl`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateDistributionWithStagingConfigError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDistributionWithStagingConfigError {
...
mod _update_distribution_with_staging_config_output;
