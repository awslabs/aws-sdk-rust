...
impl GetOriginAccessControlConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_origin_access_control_config::GetOriginAccessControlConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_origin_access_control_config::GetOriginAccessControlConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOriginAccessControlConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_origin_access_control_config::de_get_origin_access_control_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
