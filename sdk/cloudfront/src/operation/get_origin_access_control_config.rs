...
/// Orchestration and serialization glue logic for `GetOriginAccessControlConfig`.
...
impl GetOriginAccessControlConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigInput,
                    ) -> ::std::result::Result<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOriginAccessControlConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOriginAccessControlConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetOriginAccessControlConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetOriginAccessControlConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOriginAccessControlConfig")
...
.with_interceptor(GetOriginAccessControlConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError>::new());
...
#[derive(Debug)]
            struct GetOriginAccessControlConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOriginAccessControlConfigResponseDeserializer {
...
#[derive(Debug)]
            struct GetOriginAccessControlConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOriginAccessControlConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/origin-access-control/{Id}/config", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetOriginAccessControlConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOriginAccessControlConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetOriginAccessControlConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetOriginAccessControlConfigInput>()
                        .ok_or("failed to downcast to GetOriginAccessControlConfigInput")?;
...
pub enum GetOriginAccessControlConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOriginAccessControlConfigError) for what information is available for the error.")]
...
impl GetOriginAccessControlConfigError {
    /// Creates the `GetOriginAccessControlConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetOriginAccessControlConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NoSuchOriginAccessControl(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOriginAccessControlConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_origin_access_control_config::_get_origin_access_control_config_output::GetOriginAccessControlConfigOutput;

pub use crate::operation::get_origin_access_control_config::_get_origin_access_control_config_input::GetOriginAccessControlConfigInput;

mod _get_origin_access_control_config_input;

mod _get_origin_access_control_config_output;
