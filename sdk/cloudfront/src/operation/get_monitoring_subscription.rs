...
impl GetMonitoringSubscriptionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_monitoring_subscription::GetMonitoringSubscription::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMonitoringSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_monitoring_subscription::de_get_monitoring_subscription_http_response_with_props(status, headers, body)
        }
    }
}
