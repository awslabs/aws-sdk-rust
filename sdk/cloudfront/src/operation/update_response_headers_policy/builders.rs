...
impl UpdateResponseHeadersPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_response_headers_policy::UpdateResponseHeadersPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_response_headers_policy::UpdateResponseHeadersPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_response_headers_policy::UpdateResponseHeadersPolicyOutput, crate::operation::update_response_headers_policy::UpdateResponseHeadersPolicyError, Self> {
