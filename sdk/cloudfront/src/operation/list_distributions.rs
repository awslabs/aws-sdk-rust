...
impl ListDistributionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_distributions::ListDistributions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_distributions::de_list_distributions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_distributions::ListDistributionsError
{
