    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/function/{Name}/describe", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_function::DescribeFunction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_function::DescribeFunctionError
{
