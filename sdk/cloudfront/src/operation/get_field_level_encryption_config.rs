...
impl GetFieldLevelEncryptionConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_field_level_encryption_config::GetFieldLevelEncryptionConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_field_level_encryption_config::GetFieldLevelEncryptionConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFieldLevelEncryptionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_field_level_encryption_config::de_get_field_level_encryption_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
