...
impl UpdateTrustStore {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudFront", "UpdateTrustStore", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2020-05-31/trust-store/{Id}", Id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_update_trust_store::ser_update_trust_store_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_trust_store_input::ser_ca_certificates_bundle_source_http_payload(
...
impl UpdateTrustStoreError {
    ...
    /// Returns `true` if the error kind is `UpdateTrustStoreError::AccessDenied`.
    pub fn is_access_denied(&self) -> bool {
        matches!(self, Self::AccessDenied(_))
    }
    /// Returns `true` if the error kind is `UpdateTrustStoreError::EntityNotFound`.
    pub fn is_entity_not_found(&self) -> bool {
        matches!(self, Self::EntityNotFound(_))
    }
    /// Returns `true` if the error kind is `UpdateTrustStoreError::InvalidArgument`.
    pub fn is_invalid_argument(&self) -> bool {
        matches!(self, Self::InvalidArgument(_))
    }
    /// Returns `true` if the error kind is `UpdateTrustStoreError::InvalidIfMatchVersion`.
    pub fn is_invalid_if_match_version(&self) -> bool {
        matches!(self, Self::InvalidIfMatchVersion(_))
    }
    /// Returns `true` if the error kind is `UpdateTrustStoreError::PreconditionFailed`.
