...
/// Orchestration and serialization glue logic for `GetFieldLevelEncryptionProfileConfig`.
...
impl GetFieldLevelEncryptionProfileConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigInput,
                    ) -> ::std::result::Result<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFieldLevelEncryptionProfileConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetFieldLevelEncryptionProfileConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetFieldLevelEncryptionProfileConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetFieldLevelEncryptionProfileConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFieldLevelEncryptionProfileConfig")
...
.with_interceptor(GetFieldLevelEncryptionProfileConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError>::new());
...
#[derive(Debug)]
            struct GetFieldLevelEncryptionProfileConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFieldLevelEncryptionProfileConfigResponseDeserializer {
...
#[derive(Debug)]
            struct GetFieldLevelEncryptionProfileConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFieldLevelEncryptionProfileConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetFieldLevelEncryptionProfileConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetFieldLevelEncryptionProfileConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetFieldLevelEncryptionProfileConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetFieldLevelEncryptionProfileConfigInput>()
                        .ok_or("failed to downcast to GetFieldLevelEncryptionProfileConfigInput")?;
...
pub enum GetFieldLevelEncryptionProfileConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetFieldLevelEncryptionProfileConfigError) for what information is available for the error.")]
...
impl GetFieldLevelEncryptionProfileConfigError {
    /// Creates the `GetFieldLevelEncryptionProfileConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFieldLevelEncryptionProfileConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetFieldLevelEncryptionProfileConfigError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetFieldLevelEncryptionProfileConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_field_level_encryption_profile_config::GetFieldLevelEncryptionProfileConfigError {
...
mod _get_field_level_encryption_profile_config_output;
