...
impl CreateFieldLevelEncryptionConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFieldLevelEncryptionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_field_level_encryption_config::de_create_field_level_encryption_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
