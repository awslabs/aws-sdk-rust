...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionOutput,
                    crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionError,
                > for DeleteMonitoringSubscriptionFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteMonitoringSubscriptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionOutput, crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionError, Self> {
