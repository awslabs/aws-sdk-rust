...
impl CopyDistributionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_distribution::CopyDistribution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_copy_distribution::de_copy_distribution_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::copy_distribution::CopyDistributionError
{
