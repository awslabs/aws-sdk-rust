...
impl CopyDistributionInput {
    /// Consumes the builder and constructs an Operation<[`CopyDistribution`](crate::operation::copy_distribution::CopyDistribution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_distribution::CopyDistribution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_distribution::CopyDistributionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.primary_distribution_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("primary_distribution_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::copy_distribution::CopyDistribution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CopyDistribution", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CopyDistribution`.
...
impl aws_smithy_http::response::ParseStrictResponse for CopyDistribution {
                type Output = std::result::Result<crate::operation::copy_distribution::CopyDistributionOutput, crate::operation::copy_distribution::CopyDistributionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_copy_distribution::de_copy_distribution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_copy_distribution::de_copy_distribution_http_response(response)
                     }
                }
            }
