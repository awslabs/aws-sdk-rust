...
impl CopyDistributionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_distribution::CopyDistribution, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_copy_distribution::ser_copy_distribution_op_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_copy_distribution::de_copy_distribution_http_response_with_props(status, headers, body)
        }
    }
