...
impl GetDistributionConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetDistributionConfig`](crate::operation::get_distribution_config::GetDistributionConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_distribution_config::GetDistributionConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_distribution_config::GetDistributionConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_distribution_config::GetDistributionConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDistributionConfig", "cloudfront"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDistributionConfig`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDistributionConfig {
                type Output = std::result::Result<crate::operation::get_distribution_config::GetDistributionConfigOutput, crate::operation::get_distribution_config::GetDistributionConfigError>;
