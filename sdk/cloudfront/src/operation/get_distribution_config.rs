...
impl GetDistributionConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_distribution_config::GetDistributionConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_distribution_config::de_get_distribution_config_http_response_with_props(status, headers, body)
        }
    }
