...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCloudFrontOriginAccessIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_cloud_front_origin_access_identity::de_delete_cloud_front_origin_access_identity_http_response_with_props(status, headers, body)
        }
    }
}
