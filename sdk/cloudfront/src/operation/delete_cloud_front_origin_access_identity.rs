...
impl DeleteCloudFrontOriginAccessIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DeleteCloudFrontOriginAccessIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCloudFrontOriginAccessIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteCloudFrontOriginAccessIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteCloudFrontOriginAccessIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteCloudFrontOriginAccessIdentity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCloudFrontOriginAccessIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCloudFrontOriginAccessIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteCloudFrontOriginAccessIdentityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCloudFrontOriginAccessIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_cloud_front_origin_access_identity::de_delete_cloud_front_origin_access_identity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_cloud_front_origin_access_identity::de_delete_cloud_front_origin_access_identity_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCloudFrontOriginAccessIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityInput,
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_delete_cloud_front_origin_access_identity::ser_delete_cloud_front_origin_access_identity_headers(
                        input, builder,
                    )?;
...
impl ::std::error::Error for DeleteCloudFrontOriginAccessIdentityError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::CloudFrontOriginAccessIdentityInUse(_inner) => ::std::option::Option::Some(_inner),
