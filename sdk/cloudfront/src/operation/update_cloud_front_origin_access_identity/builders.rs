...
impl crate::operation::update_cloud_front_origin_access_identity::builders::UpdateCloudFrontOriginAccessIdentityInputBuilder {
...
impl UpdateCloudFrontOriginAccessIdentityFluentBuilder {
    /// Creates a new `UpdateCloudFrontOriginAccessIdentityFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::update_cloud_front_origin_access_identity::builders::UpdateCloudFrontOriginAccessIdentityInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::update_cloud_front_origin_access_identity::UpdateCloudFrontOriginAccessIdentity::operation_runtime_plugins(
