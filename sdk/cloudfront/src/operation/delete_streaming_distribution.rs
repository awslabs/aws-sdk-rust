...
impl DeleteStreamingDistributionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_streaming_distribution::DeleteStreamingDistribution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStreamingDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_streaming_distribution::de_delete_streaming_distribution_http_response_with_props(
                status, headers, body,
            )
        }
    }
