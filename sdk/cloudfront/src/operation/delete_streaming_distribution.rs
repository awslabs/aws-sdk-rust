    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-05-31/streaming-distribution/{Id}", Id = id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStreamingDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_streaming_distribution::de_delete_streaming_distribution_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteStreamingDistributionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_streaming_distribution::DeleteStreamingDistributionError
{
