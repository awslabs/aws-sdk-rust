...
impl DeleteContinuousDeploymentPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_continuous_deployment_policy::DeleteContinuousDeploymentPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContinuousDeploymentPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_continuous_deployment_policy::de_delete_continuous_deployment_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
