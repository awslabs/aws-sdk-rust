...
impl GetCloudFrontOriginAccessIdentityConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cloud_front_origin_access_identity_config::GetCloudFrontOriginAccessIdentityConfigInput, ::aws_smithy_types::error::operation::BuildError> {
