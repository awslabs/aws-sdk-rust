...
/// Orchestration and serialization glue logic for `GetContinuousDeploymentPolicyConfig`.
...
impl GetContinuousDeploymentPolicyConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigInput,
                    ) -> ::std::result::Result<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContinuousDeploymentPolicyConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContinuousDeploymentPolicyConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContinuousDeploymentPolicyConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContinuousDeploymentPolicyConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContinuousDeploymentPolicyConfig")
...
.with_interceptor(GetContinuousDeploymentPolicyConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError>::new());
...
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContinuousDeploymentPolicyConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_continuous_deployment_policy_config::de_get_continuous_deployment_policy_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_continuous_deployment_policy_config::de_get_continuous_deployment_policy_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContinuousDeploymentPolicyConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/continuous-deployment-policy/{Id}/config", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetContinuousDeploymentPolicyConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContinuousDeploymentPolicyConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetContinuousDeploymentPolicyConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetContinuousDeploymentPolicyConfigInput>()
                        .ok_or("failed to downcast to GetContinuousDeploymentPolicyConfigInput")?;
...
pub enum GetContinuousDeploymentPolicyConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContinuousDeploymentPolicyConfigError) for what information is available for the error.")]
...
impl GetContinuousDeploymentPolicyConfigError {
    /// Creates the `GetContinuousDeploymentPolicyConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetContinuousDeploymentPolicyConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetContinuousDeploymentPolicyConfigError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContinuousDeploymentPolicyConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_continuous_deployment_policy_config::_get_continuous_deployment_policy_config_output::GetContinuousDeploymentPolicyConfigOutput;

pub use crate::operation::get_continuous_deployment_policy_config::_get_continuous_deployment_policy_config_input::GetContinuousDeploymentPolicyConfigInput;

mod _get_continuous_deployment_policy_config_input;

mod _get_continuous_deployment_policy_config_output;
