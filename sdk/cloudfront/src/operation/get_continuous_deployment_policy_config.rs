...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContinuousDeploymentPolicyConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_continuous_deployment_policy_config::de_get_continuous_deployment_policy_config_http_response_with_props(status, headers, body)
        }
    }
}
