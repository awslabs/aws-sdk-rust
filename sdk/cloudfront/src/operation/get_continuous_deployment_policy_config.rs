...
impl GetContinuousDeploymentPolicyConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetContinuousDeploymentPolicyConfig`](crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetContinuousDeploymentPolicyConfig {
                type Output = std::result::Result<crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigOutput, crate::operation::get_continuous_deployment_policy_config::GetContinuousDeploymentPolicyConfigError>;
