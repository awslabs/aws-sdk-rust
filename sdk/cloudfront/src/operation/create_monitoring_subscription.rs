...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMonitoringSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_monitoring_subscription::de_create_monitoring_subscription_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateMonitoringSubscriptionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError
{
