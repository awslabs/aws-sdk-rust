...
impl CreateMonitoringSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`CreateMonitoringSubscription`](crate::operation::create_monitoring_subscription::CreateMonitoringSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_monitoring_subscription::CreateMonitoringSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_monitoring_subscription::CreateMonitoringSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateMonitoringSubscription {
                type Output = std::result::Result<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionOutput, crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError>;
