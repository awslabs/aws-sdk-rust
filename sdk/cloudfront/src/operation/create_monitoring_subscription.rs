...
impl CreateMonitoringSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_monitoring_subscription::CreateMonitoringSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMonitoringSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_monitoring_subscription::de_create_monitoring_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
