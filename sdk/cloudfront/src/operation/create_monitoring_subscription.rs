...
impl CreateMonitoringSubscription {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionInput,
                    ) -> ::std::result::Result<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMonitoringSubscription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateMonitoringSubscription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateMonitoringSubscriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateMonitoringSubscriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMonitoringSubscription")
...
.with_interceptor(CreateMonitoringSubscriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError>::new());
...
#[derive(Debug)]
            struct CreateMonitoringSubscriptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMonitoringSubscriptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_monitoring_subscription::de_create_monitoring_subscription_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_monitoring_subscription::de_create_monitoring_subscription_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateMonitoringSubscriptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMonitoringSubscriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_monitoring_subscription_input::ser_monitoring_subscription_http_payload(& input.monitoring_subscription)?);
...
#[derive(Debug)]
            struct CreateMonitoringSubscriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMonitoringSubscriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateMonitoringSubscriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateMonitoringSubscriptionInput>()
                        .ok_or("failed to downcast to CreateMonitoringSubscriptionInput")?;
...
pub enum CreateMonitoringSubscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateMonitoringSubscriptionError) for what information is available for the error.")]
...
impl CreateMonitoringSubscriptionError {
    /// Creates the `CreateMonitoringSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateMonitoringSubscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::MonitoringSubscriptionAlreadyExists(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateMonitoringSubscriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError {
...
mod _create_monitoring_subscription_output;
