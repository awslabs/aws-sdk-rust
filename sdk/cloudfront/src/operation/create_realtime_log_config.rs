...
impl CreateRealtimeLogConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateRealtimeLogConfig`](crate::operation::create_realtime_log_config::CreateRealtimeLogConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_realtime_log_config::CreateRealtimeLogConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_realtime_log_config::CreateRealtimeLogConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_realtime_log_config::CreateRealtimeLogConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRealtimeLogConfig {
                type Output = std::result::Result<crate::operation::create_realtime_log_config::CreateRealtimeLogConfigOutput, crate::operation::create_realtime_log_config::CreateRealtimeLogConfigError>;
