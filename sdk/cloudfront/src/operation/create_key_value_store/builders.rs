...
impl CreateKeyValueStoreFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_key_value_store::CreateKeyValueStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_key_value_store::CreateKeyValueStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_key_value_store::CreateKeyValueStoreOutput, crate::operation::create_key_value_store::CreateKeyValueStoreError, Self> {
