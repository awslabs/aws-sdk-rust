...
impl CreateDistributionWithTags {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_distribution_with_tags::CreateDistributionWithTagsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_distribution_with_tags::CreateDistributionWithTagsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateDistributionWithTags",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDistributionWithTags {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateDistributionWithTagsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateDistributionWithTagsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDistributionWithTags")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDistributionWithTagsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_distribution_with_tags::de_create_distribution_with_tags_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_distribution_with_tags::de_create_distribution_with_tags_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDistributionWithTagsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_distribution_with_tags::CreateDistributionWithTagsInput>()
            .expect("correct type");
