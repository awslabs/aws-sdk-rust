...
impl GetCloudFrontOriginAccessIdentityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityInput, ::aws_smithy_types::error::operation::BuildError> {
