...
impl PublishFunctionInput {
    /// Consumes the builder and constructs an Operation<[`PublishFunction`](crate::operation::publish_function::PublishFunction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::publish_function::PublishFunction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::publish_function::PublishFunctionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::publish_function::PublishFunction::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PublishFunction {
                type Output = std::result::Result<crate::operation::publish_function::PublishFunctionOutput, crate::operation::publish_function::PublishFunctionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_publish_function::de_publish_function_http_error(response)
                     } else {
                        crate::protocol_serde::shape_publish_function::de_publish_function_http_response(response)
                     }
                }
            }
