...
/// Paginator for [`ListDomainConflicts`](crate::operation::list_domain_conflicts::ListDomainConflicts)
pub struct ListDomainConflictsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_domain_conflicts::builders::ListDomainConflictsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListDomainConflictsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `domain_conflicts`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_domain_conflicts::paginator::ListDomainConflictsPaginatorItems {
        crate::operation::list_domain_conflicts::paginator::ListDomainConflictsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_domain_conflicts::ListDomainConflicts::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_domain_conflicts_output_output_next_marker(resp);
...
/// Flattened paginator for `ListDomainConflictsPaginator`
///
/// This is created with [`.items()`](ListDomainConflictsPaginator::items)
pub struct ListDomainConflictsPaginatorItems(ListDomainConflictsPaginator);

impl ListDomainConflictsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_domain_conflicts_output_output_domain_conflicts(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
