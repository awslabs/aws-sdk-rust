...
impl AssociateAliasInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_alias::AssociateAlias::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateAlias {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_alias::de_associate_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_alias::de_associate_alias_http_response(
                status, headers, body,
            )
        }
    }
