...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFieldLevelEncryptionProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_field_level_encryption_profile::de_get_field_level_encryption_profile_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_field_level_encryption_profile::GetFieldLevelEncryptionProfileError
{
