...
impl GetFieldLevelEncryptionProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_field_level_encryption_profile::GetFieldLevelEncryptionProfile,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_field_level_encryption_profile::GetFieldLevelEncryptionProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFieldLevelEncryptionProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_field_level_encryption_profile::de_get_field_level_encryption_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
