...
impl ListCachePoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListCachePolicies`](crate::operation::list_cache_policies::ListCachePolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_cache_policies::ListCachePolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_cache_policies::ListCachePoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2020-05-31/cache-policy").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_cache_policies::ListCachePoliciesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.r#type {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_cache_policies::ListCachePolicies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListCachePolicies {
                type Output = std::result::Result<crate::operation::list_cache_policies::ListCachePoliciesOutput, crate::operation::list_cache_policies::ListCachePoliciesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_cache_policies::de_list_cache_policies_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_cache_policies::de_list_cache_policies_http_response(response)
                     }
                }
            }
