...
impl GetPublicKeyConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_public_key_config::GetPublicKeyConfigInput,
                    ) -> ::std::result::Result<crate::operation::get_public_key_config::GetPublicKeyConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_public_key_config::GetPublicKeyConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_public_key_config::GetPublicKeyConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_public_key_config::GetPublicKeyConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPublicKeyConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPublicKeyConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPublicKeyConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPublicKeyConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPublicKeyConfig")
...
.with_interceptor(GetPublicKeyConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_public_key_config::GetPublicKeyConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_public_key_config::GetPublicKeyConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_public_key_config::GetPublicKeyConfigError>::new());
...
#[derive(Debug)]
            struct GetPublicKeyConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPublicKeyConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_public_key_config::de_get_public_key_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_public_key_config::de_get_public_key_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetPublicKeyConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPublicKeyConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_public_key_config::GetPublicKeyConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_public_key_config::GetPublicKeyConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2020-05-31/public-key/{Id}/config", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetPublicKeyConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPublicKeyConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPublicKeyConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPublicKeyConfigInput>()
                        .ok_or("failed to downcast to GetPublicKeyConfigInput")?;
...
pub enum GetPublicKeyConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPublicKeyConfigError) for what information is available for the error.")]
...
impl GetPublicKeyConfigError {
    /// Creates the `GetPublicKeyConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPublicKeyConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPublicKeyConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_public_key_config::GetPublicKeyConfigError {
...
mod _get_public_key_config_output;
