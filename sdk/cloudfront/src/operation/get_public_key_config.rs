...
impl GetPublicKeyConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_public_key_config::GetPublicKeyConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPublicKeyConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_public_key_config::de_get_public_key_config_http_response_with_props(status, headers, body)
        }
    }
}
