...
impl GetStreamingDistributionConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStreamingDistributionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_streaming_distribution_config::de_get_streaming_distribution_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
