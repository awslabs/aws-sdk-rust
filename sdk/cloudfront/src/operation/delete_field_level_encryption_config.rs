...
impl DeleteFieldLevelEncryptionConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_field_level_encryption_config::DeleteFieldLevelEncryptionConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_field_level_encryption_config::DeleteFieldLevelEncryptionConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFieldLevelEncryptionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_field_level_encryption_config::de_delete_field_level_encryption_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
