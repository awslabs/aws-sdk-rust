...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMonitoringSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_monitoring_subscription::de_delete_monitoring_subscription_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteMonitoringSubscriptionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscriptionError
{
