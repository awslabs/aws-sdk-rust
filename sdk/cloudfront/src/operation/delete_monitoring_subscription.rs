...
impl DeleteMonitoringSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_monitoring_subscription::DeleteMonitoringSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMonitoringSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_monitoring_subscription::de_delete_monitoring_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
