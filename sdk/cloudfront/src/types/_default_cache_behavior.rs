        ...
        ::std::result::Result::Ok(
            crate::types::DefaultCacheBehavior {
                target_origin_id: self.target_origin_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("target_origin_id", "target_origin_id was not specified but it is required when building DefaultCacheBehavior")
                    )?
                ,
                ...
                viewer_protocol_policy: self.viewer_protocol_policy
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("viewer_protocol_policy", "viewer_protocol_policy was not specified but it is required when building DefaultCacheBehavior")
                    )?
                ,
