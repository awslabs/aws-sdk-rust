...
impl ResponseHeadersPolicyAccessControlAllowHeadersBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ResponseHeadersPolicyAccessControlAllowHeaders, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ResponseHeadersPolicyAccessControlAllowHeaders {
                quantity: self.quantity
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("quantity", "quantity was not specified but it is required when building ResponseHeadersPolicyAccessControlAllowHeaders")
                    )?
                ,
                items: self.items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("items", "items was not specified but it is required when building ResponseHeadersPolicyAccessControlAllowHeaders")
                    )?
                ,
            }
        )
