...
impl ResponseHeadersPolicyServerTimingHeadersConfigBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ResponseHeadersPolicyServerTimingHeadersConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ResponseHeadersPolicyServerTimingHeadersConfig {
                enabled: self.enabled
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("enabled", "enabled was not specified but it is required when building ResponseHeadersPolicyServerTimingHeadersConfig")
                    )?
                ,
