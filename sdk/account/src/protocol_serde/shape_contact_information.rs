...
pub(crate) fn de_contact_information<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContactInformation>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_contact_information(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContactInformation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
