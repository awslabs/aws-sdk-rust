...
pub fn ser_put_alternate_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAlternateContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
