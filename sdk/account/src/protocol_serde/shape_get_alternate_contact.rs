...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_get_alternate_contact_input::ser_get_alternate_contact_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_alternate_contact_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_alternate_contact::de_get_alternate_contact(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_alternate_contact::GetAlternateContactError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "AlternateContact" => {
                        builder = builder.set_alternate_contact(
                            crate::protocol_serde::shape_alternate_contact::de_alternate_contact(
                                tokens,
                            )?,
                        );
                    }
