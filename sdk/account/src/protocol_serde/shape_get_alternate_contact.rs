                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_error_type_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_alternate_contact::GetAlternateContactError::unhandled(
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AlternateContact" => {
                    builder = builder.set_alternate_contact(crate::protocol_serde::shape_alternate_contact::de_alternate_contact(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
