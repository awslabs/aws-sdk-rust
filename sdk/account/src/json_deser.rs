...
pub fn deser_operation_crate_operation_get_alternate_contact(value: &[u8], mut builder: crate::output::get_alternate_contact_output::Builder) -> Result<crate::output::get_alternate_contact_output::Builder, aws_smithy_json::deserialize::Error> {
    let mut tokens_owned = aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value)).peekable();
                        let tokens = &mut tokens_owned;
                        aws_smithy_json::deserialize::token::expect_start_object(tokens.next())?;
    loop {
...
pub fn deser_operation_crate_operation_get_contact_information(value: &[u8], mut builder: crate::output::get_contact_information_output::Builder) -> Result<crate::output::get_contact_information_output::Builder, aws_smithy_json::deserialize::Error> {
    let mut tokens_owned = aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value)).peekable();
                        let tokens = &mut tokens_owned;
                        aws_smithy_json::deserialize::token::expect_start_object(tokens.next())?;
    loop {
...
pub fn deser_structure_crate_model_alternate_contact<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AlternateContact>, aws_smithy_json::deserialize::Error>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::Error>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]let mut builder = crate::model::AlternateContact::builder();
            loop {
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                                            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
...
pub fn deser_structure_crate_model_contact_information<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContactInformation>, aws_smithy_json::deserialize::Error>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::Error>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]let mut builder = crate::model::ContactInformation::builder();
            loop {
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                                            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
