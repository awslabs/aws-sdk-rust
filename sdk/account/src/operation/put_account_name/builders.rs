...
pub use crate::operation::put_account_name::_put_account_name_output::PutAccountNameOutputBuilder;

pub use crate::operation::put_account_name::_put_account_name_input::PutAccountNameInputBuilder;

impl crate::operation::put_account_name::builders::PutAccountNameInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::put_account_name::PutAccountNameError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.put_account_name();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `PutAccountName`.
///
...
pub struct PutAccountNameFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::put_account_name::builders::PutAccountNameInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::put_account_name::PutAccountNameOutput,
        crate::operation::put_account_name::PutAccountNameError,
    > for PutAccountNameFluentBuilder
{
    fn send(
        self,
...
impl PutAccountNameFluentBuilder {
    /// Creates a new `PutAccountNameFluentBuilder`.
    ...
    /// Access the PutAccountName as a reference.
    pub fn as_input(&self) -> &crate::operation::put_account_name::builders::PutAccountNameInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::put_account_name::PutAccountName::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::put_account_name::PutAccountName::orchestrate(&runtime_plugins, input).await
    }
