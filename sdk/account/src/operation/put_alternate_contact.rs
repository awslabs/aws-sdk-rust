...
impl PutAlternateContactInput {
    /// Consumes the builder and constructs an Operation<[`PutAlternateContact`](crate::operation::put_alternate_contact::PutAlternateContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_alternate_contact::PutAlternateContact, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_alternate_contact::PutAlternateContactInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_alternate_contact::ser_put_alternate_contact_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_alternate_contact::PutAlternateContact::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutAlternateContact {
                type Output = std::result::Result<crate::operation::put_alternate_contact::PutAlternateContactOutput, crate::operation::put_alternate_contact::PutAlternateContactError>;
