...
impl DeleteAlternateContactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_alternate_contact::DeleteAlternateContactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_alternate_contact::DeleteAlternateContactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_alternate_contact::DeleteAlternateContactOutput, crate::operation::delete_alternate_contact::DeleteAlternateContactError, Self> {
