...
impl GetRegionOptStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_region_opt_status::GetRegionOptStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_region_opt_status::GetRegionOptStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_region_opt_status::GetRegionOptStatusOutput, crate::operation::get_region_opt_status::GetRegionOptStatusError, Self> {
