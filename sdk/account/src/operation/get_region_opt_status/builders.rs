...
impl GetRegionOptStatusFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_region_opt_status::GetRegionOptStatus, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_region_opt_status::GetRegionOptStatusError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_region_opt_status::GetRegionOptStatusOutput, aws_smithy_http::result::SdkError<crate::operation::get_region_opt_status::GetRegionOptStatusError>>
                     {
