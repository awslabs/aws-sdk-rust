...
impl GetAlternateContactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_alternate_contact::GetAlternateContactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_alternate_contact::GetAlternateContactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_alternate_contact::GetAlternateContactOutput, crate::operation::get_alternate_contact::GetAlternateContactError, Self> {
