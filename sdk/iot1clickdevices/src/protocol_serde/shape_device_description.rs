...
pub(crate) fn de_device_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeviceDescription>, aws_smithy_json::deserialize::error::DeserializeError>
