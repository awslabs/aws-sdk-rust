...
pub struct ListDevicesOutput  {
    ...
    #[doc(hidden)]pub devices: std::option::Option<std::vec::Vec<crate::model::DeviceDescription>>,
...
pub struct ListDeviceEventsOutput  {
    ...
    #[doc(hidden)]pub events: std::option::Option<std::vec::Vec<crate::model::DeviceEvent>>,
    /// <p>The token to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct InvokeDeviceMethodOutput  {
    ...
    #[doc(hidden)]pub device_method_response: std::option::Option<std::string::String>,
}
...
pub struct GetDeviceMethodsOutput  {
    ...
    #[doc(hidden)]pub device_methods: std::option::Option<std::vec::Vec<crate::model::DeviceMethod>>,
}
...
pub struct DescribeDeviceOutput  {
    /// <p>Device details.</p>
    #[doc(hidden)]pub device_description: std::option::Option<crate::model::DeviceDescription>,
}
