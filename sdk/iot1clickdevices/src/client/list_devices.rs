...
impl super::Client {
    ...
    ///   - [`device_type(impl ::std::convert::Into<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::device_type) / [`set_device_type(Option<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::set_device_type): <p>The type of the device, such as "button".</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::set_next_token): <p>The token to retrieve the next set of results.</p>
