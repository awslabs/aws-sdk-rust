...
impl super::Client {
    ...
    ///   - [`device_id(impl Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_device_id):<br>required: **true**<br><p>The unique identifier of the device.</p><br>
