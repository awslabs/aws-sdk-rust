...
impl super::Client {
    ...
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::invoke_device_method::builders::InvokeDeviceMethodFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::invoke_device_method::builders::InvokeDeviceMethodFluentBuilder::set_device_id): <p>The unique identifier of the device.</p>
