...
impl super::Client {
    ...
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::set_device_id): <p>The unique identifier of the device.</p>
