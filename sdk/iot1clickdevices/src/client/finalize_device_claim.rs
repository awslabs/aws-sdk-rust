...
impl super::Client {
    ...
    ///   - [`device_id(impl Into<String>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::set_device_id):<br>required: **true**<br><p>The unique identifier of the device.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::finalize_device_claim::builders::FinalizeDeviceClaimFluentBuilder::set_tags):<br>required: **false**<br><p>A collection of key/value pairs defining the resource tags. For example, { "tags": {"key1": "value1", "key2": "value2"} }. For more information, see <a href="https://aws.amazon.com/answers/account-management/aws-tagging-strategies/">AWS Tagging Strategies</a>.</p> <p></p><br>
