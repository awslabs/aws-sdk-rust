...
impl super::Client {
    ...
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::list_device_events::builders::ListDeviceEventsFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::list_device_events::builders::ListDeviceEventsFluentBuilder::set_device_id): <p>The unique identifier of the device.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_device_events::builders::ListDeviceEventsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_device_events::builders::ListDeviceEventsFluentBuilder::set_next_token): <p>The token to retrieve the next set of results.</p>
