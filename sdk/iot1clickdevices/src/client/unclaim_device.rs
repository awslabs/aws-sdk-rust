...
impl super::Client {
    ...
    ///   - [`device_id(impl Into<String>)`](crate::operation::unclaim_device::builders::UnclaimDeviceFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::unclaim_device::builders::UnclaimDeviceFluentBuilder::set_device_id):<br>required: **true**<br><p>The unique identifier of the device.</p><br>
