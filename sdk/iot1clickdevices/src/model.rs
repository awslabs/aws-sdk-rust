...
pub struct DeviceDescription  {
    ...
    #[doc(hidden)]pub remaining_life: f64,
...
pub struct DeviceEvent  {
    ...
    #[doc(hidden)]pub std_event: std::option::Option<std::string::String>,
}
impl DeviceEvent {
    /// <p>An object representing the device associated with the event.</p>
...
pub struct Device  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<crate::model::Attributes>,
    /// <p>The unique identifier of the device.</p>
    #[doc(hidden)]pub device_id: std::option::Option<std::string::String>,
...
pub struct DeviceMethod  {
    ...
    #[doc(hidden)]pub method_name: std::option::Option<std::string::String>,
}
impl DeviceMethod {
    /// <p>The type of the device, such as "button".</p>
