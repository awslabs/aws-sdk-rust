    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/devices/{DeviceId}/methods", DeviceId = device_id)
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_invoke_device_method::ser_invoke_device_method_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::invoke_device_method::InvokeDeviceMethod::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::invoke_device_method::InvokeDeviceMethodError
{
