...
impl InvokeDeviceMethodInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_invoke_device_method::ser_invoke_device_method_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::invoke_device_method::InvokeDeviceMethod::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("InvokeDeviceMethod", "iot1clickdevicesservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for InvokeDeviceMethod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_invoke_device_method::de_invoke_device_method_http_response_with_props(status, headers, body)
        }
    }
}
