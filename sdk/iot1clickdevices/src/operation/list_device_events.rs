    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/devices/{DeviceId}/events", DeviceId = device_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_device_events::ListDeviceEvents::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_device_events::ListDeviceEventsError
{
