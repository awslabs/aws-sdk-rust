...
impl FinalizeDeviceClaimInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::finalize_device_claim::FinalizeDeviceClaim::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("FinalizeDeviceClaim", "iot1clickdevicesservice"),
            );
