...
impl FinalizeDeviceClaimFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::finalize_device_claim::FinalizeDeviceClaimOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::finalize_device_claim::FinalizeDeviceClaimError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::finalize_device_claim::FinalizeDeviceClaimOutput, crate::operation::finalize_device_claim::FinalizeDeviceClaimError, Self> {
