...
impl UpdateDeviceStateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_device_state::UpdateDeviceState,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_device_state::ser_update_device_state_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_state::UpdateDeviceState::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("UpdateDeviceState", "iot1clickdevicesservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeviceState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_device_state::de_update_device_state_http_response_with_props(status, headers, body)
        }
    }
}
