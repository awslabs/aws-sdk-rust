...
impl InitiateDeviceClaimInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::initiate_device_claim::InitiateDeviceClaim::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("InitiateDeviceClaim", "iot1clickdevicesservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for InitiateDeviceClaim {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_initiate_device_claim::de_initiate_device_claim_http_response_with_props(status, headers, body)
        }
    }
}
