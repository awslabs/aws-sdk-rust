...
> {
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::list_applications::ListApplicationsError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
        ...
        "InvalidRequestException" => {
            crate::operation::list_applications::ListApplicationsError::InvalidRequestException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_request_exception::de_invalid_request_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
