...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_application::de_describe_application(_response_body, output)
            .map_err(crate::operation::describe_application::DescribeApplicationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_application_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_application::DescribeApplicationError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_application::builders::DescribeApplicationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
