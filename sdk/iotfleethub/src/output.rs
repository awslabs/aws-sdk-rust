...
pub struct ListApplicationsOutput  {
    ...
    #[doc(hidden)]pub application_summaries: std::option::Option<std::vec::Vec<crate::model::ApplicationSummary>>,
...
pub struct DescribeApplicationOutput  {
    ...
    #[doc(hidden)]pub application_url: std::option::Option<std::string::String>,
    /// <p>The current state of the web application.</p>
    #[doc(hidden)]pub application_state: std::option::Option<crate::model::ApplicationState>,
    /// <p>The date (in Unix epoch time) when the application was created.</p>
    #[doc(hidden)]pub application_creation_date: i64,
    /// <p>The date (in Unix epoch time) when the application was last updated.</p>
    #[doc(hidden)]pub application_last_update_date: i64,
...
impl  std::fmt::Debug for DescribeApplicationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("application_last_update_date", &self.application_last_update_date);
