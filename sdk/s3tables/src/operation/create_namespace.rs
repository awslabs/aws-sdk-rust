...
/// Orchestration and serialization glue logic for `CreateNamespace`.
...
impl CreateNamespace {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_namespace::CreateNamespaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_namespace::CreateNamespaceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3Tables", "CreateNamespace", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "S3Tables.CreateNamespace",
                "rpc.service" = "S3Tables",
                "rpc.method" = "CreateNamespace",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateNamespace {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateNamespace");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateNamespaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateNamespaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateNamespace")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateNamespace")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateNamespaceEndpointParamsInterceptor,
            ))
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateNamespaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_namespace::de_create_namespace_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_namespace::de_create_namespace_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateNamespaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateNamespaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_namespace::CreateNamespaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_namespace::CreateNamespaceInput,
                ...
                ::std::write!(output, "/namespaces/{tableBucketARN}", tableBucketARN = table_bucket_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_namespace::ser_create_namespace_input(&input)?);
...
#[derive(Debug)]
struct CreateNamespaceEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateNamespaceEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateNamespaceEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateNamespaceInput>()
            .ok_or("failed to downcast to CreateNamespaceInput")?;
...
pub enum CreateNamespaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateNamespaceError) for what information is available for the error.")]
...
impl CreateNamespaceError {
    ...
    /// Creates the `CreateNamespaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateNamespaceError::BadRequestException`.
    ...
    /// Returns `true` if the error kind is `CreateNamespaceError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateNamespaceError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateNamespaceError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateNamespaceError::TooManyRequestsException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateNamespaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_namespace::CreateNamespaceError {
