...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteNamespaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_namespace::de_delete_namespace_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_delete_namespace::de_delete_namespace_http_response(status, headers, body)
        };
