...
impl ListTablesPaginator {
    ...
    /// Set the page size
    ///
    /// _Note: this method will override any previously set value for `max_tables`_
    pub fn page_size(mut self, limit: i32) -> Self {
        self.builder.max_tables = ::std::option::Option::Some(limit);
        self
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_tables_output_output_continuation_token(resp);
