...
pub use crate::operation::put_table_policy::_put_table_policy_output::PutTablePolicyOutputBuilder;

pub use crate::operation::put_table_policy::_put_table_policy_input::PutTablePolicyInputBuilder;

impl crate::operation::put_table_policy::builders::PutTablePolicyInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::put_table_policy::PutTablePolicyError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.put_table_policy();
...
pub struct PutTablePolicyFluentBuilder {
    ...
    inner: crate::operation::put_table_policy::builders::PutTablePolicyInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::put_table_policy::PutTablePolicyOutput,
        crate::operation::put_table_policy::PutTablePolicyError,
    > for PutTablePolicyFluentBuilder
{
    fn send(
        self,
...
impl PutTablePolicyFluentBuilder {
    /// Creates a new `PutTablePolicyFluentBuilder`.
    ...
    /// Access the PutTablePolicy as a reference.
    pub fn as_input(&self) -> &crate::operation::put_table_policy::builders::PutTablePolicyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::put_table_policy::PutTablePolicy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::put_table_policy::PutTablePolicy::orchestrate(&runtime_plugins, input).await
    }
