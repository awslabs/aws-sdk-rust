...
impl ListNamespacesPaginator {
    ...
    /// Set the page size
    ///
    /// _Note: this method will override any previously set value for `max_namespaces`_
    pub fn page_size(mut self, limit: i32) -> Self {
        self.builder.max_namespaces = ::std::option::Option::Some(limit);
        self
    }
    ...
    pub fn items(self) -> crate::operation::list_namespaces::paginator::ListNamespacesPaginatorItems {
        crate::operation::list_namespaces::paginator::ListNamespacesPaginatorItems(self)
    }
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_namespaces_output_output_continuation_token(resp);
...
impl ListNamespacesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_namespaces_output_output_namespaces(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
