...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_namespace):<br>required: **false**<br><p>The name of the namespace the table is associated with.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_name):<br>required: **false**<br><p>The name of the table.</p><br>
    ///   - [`table_arn(impl Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::table_arn) / [`set_table_arn(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_table_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the table.</p><br>
