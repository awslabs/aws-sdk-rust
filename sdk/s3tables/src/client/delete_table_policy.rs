...
impl super::Client {
    ...
    ///   - [`table_bucket_arn(impl Into<String>)`](crate::operation::delete_table_policy::builders::DeleteTablePolicyFluentBuilder::table_bucket_arn) / [`set_table_bucket_arn(Option<String>)`](crate::operation::delete_table_policy::builders::DeleteTablePolicyFluentBuilder::set_table_bucket_arn):<br>required: **true**<br><p>The Amazon Resource Number (ARN) of the table bucket that contains the table.</p><br>
