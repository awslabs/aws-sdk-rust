...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the Device Farm device pool to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::set_name): <p>A string that represents the name of the device pool to update.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_device_pool::builders::UpdateDevicePoolFluentBuilder::set_description): <p>A description of the device pool to update.</p>
