...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::stop_run::builders::StopRunFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::stop_run::builders::StopRunFluentBuilder::set_arn):<br>required: **true**<br><p>Represents the Amazon Resource Name (ARN) of the Device Farm run to stop.</p><br>
