...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_device::builders::GetDeviceFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_device::builders::GetDeviceFluentBuilder::set_arn):<br>required: **true**<br><p>The device type's ARN.</p><br>
