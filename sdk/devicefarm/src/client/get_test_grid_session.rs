...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::set_project_arn): <p>The ARN for the project that this session belongs to. See <code>CreateTestGridProject</code> and <code>ListTestGridProjects</code>.</p>
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::set_session_id): <p>An ID associated with this session.</p>
    ///   - [`session_arn(impl ::std::convert::Into<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::session_arn) / [`set_session_arn(Option<String>)`](crate::operation::get_test_grid_session::builders::GetTestGridSessionFluentBuilder::set_session_arn): <p>An ARN that uniquely identifies a <code>TestGridSession</code>.</p>
