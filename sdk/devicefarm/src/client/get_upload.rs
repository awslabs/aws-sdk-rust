...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_upload::builders::GetUploadFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_upload::builders::GetUploadFluentBuilder::set_arn): <p>The upload's ARN.</p>
