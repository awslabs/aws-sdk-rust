...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_instance_profile::builders::GetInstanceProfileFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of an instance profile.</p><br>
