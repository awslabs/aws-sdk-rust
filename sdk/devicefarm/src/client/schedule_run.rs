...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::set_project_arn): <p>The ARN of the project for the run to be scheduled.</p>
    ///   - [`app_arn(impl ::std::convert::Into<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::app_arn) / [`set_app_arn(Option<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::set_app_arn): <p>The ARN of an application package to run tests against, created with <code>CreateUpload</code>. See <code>ListUploads</code>.</p>
    ///   - [`device_pool_arn(impl ::std::convert::Into<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::device_pool_arn) / [`set_device_pool_arn(Option<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::set_device_pool_arn): <p>The ARN of the device pool for the run to be scheduled.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::schedule_run::builders::ScheduleRunFluentBuilder::set_name): <p>The name for the run to be scheduled.</p>
