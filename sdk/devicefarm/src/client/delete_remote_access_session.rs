...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_remote_access_session::builders::DeleteRemoteAccessSessionFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_remote_access_session::builders::DeleteRemoteAccessSessionFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the session for which you want to delete remote access.</p><br>
