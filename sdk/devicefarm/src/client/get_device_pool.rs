...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_device_pool::builders::GetDevicePoolFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_device_pool::builders::GetDevicePoolFluentBuilder::set_arn): <p>The device pool's ARN.</p>
