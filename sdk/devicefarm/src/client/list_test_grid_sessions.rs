...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::list_test_grid_sessions::builders::ListTestGridSessionsFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::list_test_grid_sessions::builders::ListTestGridSessionsFluentBuilder::set_project_arn): <p>ARN of a <code>TestGridProject</code>.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_test_grid_sessions::builders::ListTestGridSessionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_test_grid_sessions::builders::ListTestGridSessionsFluentBuilder::set_next_token): <p>Pagination token.</p>
