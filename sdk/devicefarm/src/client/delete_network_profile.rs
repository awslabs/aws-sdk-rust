...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_network_profile::builders::DeleteNetworkProfileFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_network_profile::builders::DeleteNetworkProfileFluentBuilder::set_arn):<br>required: **true**<br><p>The ARN of the network profile to delete.</p><br>
