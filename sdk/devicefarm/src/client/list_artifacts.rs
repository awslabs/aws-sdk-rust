...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::set_arn): <p>The run, job, suite, or test ARN.</p>
