...
impl super::Client {
    ...
    ///   - [`rules(Rule)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::rules) / [`set_rules(Option<Vec<Rule>>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::set_rules): <p>The device pool's rules.</p>
