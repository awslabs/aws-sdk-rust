...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::set_project_arn): <p>The ARN of the project for the device pool.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::set_name): <p>The device pool's name.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_device_pool::builders::CreateDevicePoolFluentBuilder::set_description): <p>The device pool's description.</p>
