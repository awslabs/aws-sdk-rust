...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_vpce_configuration::builders::GetVPCEConfigurationFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_vpce_configuration::builders::GetVPCEConfigurationFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the VPC endpoint configuration you want to describe.</p><br>
