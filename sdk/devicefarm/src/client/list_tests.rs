...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_tests::builders::ListTestsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_tests::builders::ListTestsFluentBuilder::set_arn): <p>The test suite's Amazon Resource Name (ARN).</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_tests::builders::ListTestsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_tests::builders::ListTestsFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
