...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_arn):<br>required: **true**<br><p>Represents the Amazon Resource Name (ARN) of the Device Farm project to delete.</p><br>
