...
impl super::Client {
    ...
    ///   - [`offering_id(impl Into<String>)`](crate::operation::renew_offering::builders::RenewOfferingFluentBuilder::offering_id) / [`set_offering_id(Option<String>)`](crate::operation::renew_offering::builders::RenewOfferingFluentBuilder::set_offering_id):<br>required: **true**<br><p>The ID of a request to renew an offering.</p><br>
    ///   - [`quantity(i32)`](crate::operation::renew_offering::builders::RenewOfferingFluentBuilder::quantity) / [`set_quantity(Option<i32>)`](crate::operation::renew_offering::builders::RenewOfferingFluentBuilder::set_quantity):<br>required: **true**<br><p>The quantity requested in an offering renewal.</p><br>
