...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_offering_transactions::builders::ListOfferingTransactionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_offering_transactions::builders::ListOfferingTransactionsFluentBuilder::set_next_token):<br>required: **false**<br><p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p><br>
