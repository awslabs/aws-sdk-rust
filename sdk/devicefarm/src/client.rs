    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`r#type(Option<NetworkProfileType>)`](crate::input::CreateNetworkProfileInput::r#type): <p>The type of network profile to create. Valid values are listed here.</p>
    ...
    ///   - [`r#type(Option<ArtifactCategory>)`](crate::input::ListArtifactsInput::r#type): <p>The artifacts' type.</p>  <p>Allowed values include:</p>  <ul>   <li> <p>FILE</p> </li>   <li> <p>LOG</p> </li>   <li> <p>SCREENSHOT</p> </li>  </ul>
    ...
    ///   - [`r#type(Option<DevicePoolType>)`](crate::input::ListDevicePoolsInput::r#type): <p>The device pools' type.</p>  <p>Allowed values include:</p>  <ul>   <li> <p>CURATED: A device pool that is created and managed by AWS Device Farm.</p> </li>   <li> <p>PRIVATE: A device pool that is created and managed by the device pool developer.</p> </li>  </ul>
    ...
    ///   - [`r#type(Option<NetworkProfileType>)`](crate::input::ListNetworkProfilesInput::r#type): <p>The type of network profile to return information about. Valid values are listed here.</p>
    ...
    ///   - [`r#type(Option<TestGridSessionArtifactCategory>)`](crate::input::ListTestGridSessionArtifactsInput::r#type): <p>Limit results to a specified type of artifact.</p>
    ...
    ///   - [`r#type(Option<NetworkProfileType>)`](crate::input::UpdateNetworkProfileInput::r#type): <p>The type of network profile to return information about. Valid values are listed here.</p>
