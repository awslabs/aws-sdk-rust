...
impl Client  {
    ...
    pub fn install_to_remote_access_session(&self) -> fluent_builders::InstallToRemoteAccessSession {
    ...
    pub fn list_test_grid_session_artifacts(&self) -> fluent_builders::ListTestGridSessionArtifacts {
