            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "securityGroupIds" => {
                            builder = builder
                                .set_security_group_ids(crate::protocol_serde::shape_vpc_security_group_ids::de_vpc_security_group_ids(tokens)?);
                        }
                        "subnetIds" => {
                            builder = builder.set_subnet_ids(crate::protocol_serde::shape_vpc_subnet_ids::de_vpc_subnet_ids(tokens)?);
                        }
                        "vpcId" => {
