...
pub fn ser_create_upload_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUploadInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
