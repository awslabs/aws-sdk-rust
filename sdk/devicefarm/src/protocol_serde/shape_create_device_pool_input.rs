...
pub fn ser_create_device_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDevicePoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
