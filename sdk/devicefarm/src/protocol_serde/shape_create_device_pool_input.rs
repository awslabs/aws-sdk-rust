...
pub fn ser_create_device_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_device_pool::CreateDevicePoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
