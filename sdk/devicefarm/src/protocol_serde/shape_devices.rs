...
pub(crate) fn de_devices<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Device>>, aws_smithy_json::deserialize::error::DeserializeError>
