...
pub fn ser_update_device_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDevicePoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
