...
pub(crate) fn de_uploads<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Upload>>, aws_smithy_json::deserialize::error::DeserializeError>
