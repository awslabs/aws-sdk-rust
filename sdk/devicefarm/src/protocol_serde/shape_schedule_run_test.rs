...
pub fn ser_schedule_run_test(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduleRunTest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
