...
pub fn ser_test_grid_vpc_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TestGridVpcConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_test_grid_vpc_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TestGridVpcConfig>, aws_smithy_json::deserialize::error::DeserializeError>
