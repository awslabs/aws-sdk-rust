...
pub(crate) fn de_remote_access_session<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RemoteAccessSession>, aws_smithy_json::deserialize::error::DeserializeError>
