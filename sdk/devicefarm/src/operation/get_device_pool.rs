...
impl GetDevicePoolInput {
    /// Consumes the builder and constructs an Operation<[`GetDevicePool`](crate::operation::get_device_pool::GetDevicePool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_device_pool::GetDevicePool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_device_pool::GetDevicePoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_device_pool::ser_get_device_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_device_pool::GetDevicePool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDevicePool", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDevicePool`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDevicePool {
                type Output = std::result::Result<crate::operation::get_device_pool::GetDevicePoolOutput, crate::operation::get_device_pool::GetDevicePoolError>;
