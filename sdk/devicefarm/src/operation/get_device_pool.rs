...
impl GetDevicePoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_device_pool::GetDevicePool,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_device_pool::GetDevicePool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevicePool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_device_pool::de_get_device_pool_http_error(
                status, headers, body,
            )
        } else {
