...
impl GetDevicePoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_device_pool::GetDevicePool, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_device_pool::ser_get_device_pool_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevicePool {
    type Output =
        ::std::result::Result<crate::operation::get_device_pool::GetDevicePoolOutput, crate::operation::get_device_pool::GetDevicePoolError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_device_pool::de_get_device_pool_http_response_with_props(status, headers, body)
        }
    }
}
