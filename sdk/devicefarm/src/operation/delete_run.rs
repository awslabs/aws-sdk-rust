...
impl DeleteRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_run::DeleteRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_run::ser_delete_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_run::de_delete_run_http_response_with_props(status, headers, body)
        }
    }
}
