...
impl ListSamplesInput {
    /// Consumes the builder and constructs an Operation<[`ListSamples`](crate::operation::list_samples::ListSamples)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_samples::ListSamples, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_samples::ser_list_samples_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_samples::ListSamples::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSamples {
    type Output = ::std::result::Result<crate::operation::list_samples::ListSamplesOutput, crate::operation::list_samples::ListSamplesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_samples::de_list_samples_http_response_with_props(status, headers, body)
        }
    }
}
