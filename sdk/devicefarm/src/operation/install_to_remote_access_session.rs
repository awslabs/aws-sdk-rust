...
/// Orchestration and serialization glue logic for `InstallToRemoteAccessSession`.
...
impl InstallToRemoteAccessSession {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InstallToRemoteAccessSession {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InstallToRemoteAccessSession");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InstallToRemoteAccessSessionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InstallToRemoteAccessSessionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InstallToRemoteAccessSession")
...
.with_interceptor(InstallToRemoteAccessSessionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError>::new());
...
#[derive(Debug)]
            struct InstallToRemoteAccessSessionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InstallToRemoteAccessSessionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_install_to_remote_access_session::de_install_to_remote_access_session_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct InstallToRemoteAccessSessionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InstallToRemoteAccessSessionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_install_to_remote_access_session::ser_install_to_remote_access_session_input(&input)?);
...
#[derive(Debug)]
            struct InstallToRemoteAccessSessionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InstallToRemoteAccessSessionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "InstallToRemoteAccessSessionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InstallToRemoteAccessSessionInput>()
                        .ok_or("failed to downcast to InstallToRemoteAccessSessionInput")?;
...
pub enum InstallToRemoteAccessSessionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InstallToRemoteAccessSessionError) for what information is available for the error.")]
...
impl InstallToRemoteAccessSessionError {
    /// Creates the `InstallToRemoteAccessSessionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InstallToRemoteAccessSessionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InstallToRemoteAccessSessionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError {
...
mod _install_to_remote_access_session_output;
