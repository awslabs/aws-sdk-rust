...
impl InstallToRemoteAccessSessionInput {
    /// Consumes the builder and constructs an Operation<[`InstallToRemoteAccessSession`](crate::operation::install_to_remote_access_session::InstallToRemoteAccessSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_install_to_remote_access_session::ser_install_to_remote_access_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::install_to_remote_access_session::InstallToRemoteAccessSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for InstallToRemoteAccessSession {
                type Output = std::result::Result<crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionOutput, crate::operation::install_to_remote_access_session::InstallToRemoteAccessSessionError>;
