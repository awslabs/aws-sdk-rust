...
impl GetTestGridSessionInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_test_grid_session::ser_get_test_grid_session_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_test_grid_session::GetTestGridSession::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_test_grid_session::GetTestGridSessionError
{
