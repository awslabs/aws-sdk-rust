...
impl GetTestGridSessionInput {
    /// Consumes the builder and constructs an Operation<[`GetTestGridSession`](crate::operation::get_test_grid_session::GetTestGridSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_test_grid_session::GetTestGridSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_test_grid_session::GetTestGridSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_test_grid_session::ser_get_test_grid_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_test_grid_session::GetTestGridSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetTestGridSession {
                type Output = std::result::Result<crate::operation::get_test_grid_session::GetTestGridSessionOutput, crate::operation::get_test_grid_session::GetTestGridSessionError>;
