...
impl ListUniqueProblemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_unique_problems::ser_list_unique_problems_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUniqueProblems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_unique_problems::de_list_unique_problems_http_response_with_props(status, headers, body)
        }
    }
}
