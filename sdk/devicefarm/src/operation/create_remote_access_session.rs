...
impl CreateRemoteAccessSessionInput {
    /// Consumes the builder and constructs an Operation<[`CreateRemoteAccessSession`](crate::operation::create_remote_access_session::CreateRemoteAccessSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_remote_access_session::CreateRemoteAccessSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_remote_access_session::CreateRemoteAccessSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_remote_access_session::CreateRemoteAccessSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRemoteAccessSession {
                type Output = std::result::Result<crate::operation::create_remote_access_session::CreateRemoteAccessSessionOutput, crate::operation::create_remote_access_session::CreateRemoteAccessSessionError>;
