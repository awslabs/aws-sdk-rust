...
impl GetSuiteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_suite::GetSuite, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_suite::ser_get_suite_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSuite {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_suite::de_get_suite_http_response_with_props(status, headers, body)
        }
    }
}
