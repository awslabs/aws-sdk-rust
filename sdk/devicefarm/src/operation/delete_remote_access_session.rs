...
impl DeleteRemoteAccessSession {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRemoteAccessSession {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteRemoteAccessSession");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteRemoteAccessSessionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteRemoteAccessSessionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRemoteAccessSession")
...
.with_interceptor(DeleteRemoteAccessSessionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError>::new());
...
#[derive(Debug)]
            struct DeleteRemoteAccessSessionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRemoteAccessSessionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_remote_access_session::de_delete_remote_access_session_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_remote_access_session::de_delete_remote_access_session_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteRemoteAccessSessionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRemoteAccessSessionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_remote_access_session::ser_delete_remote_access_session_input(&input)?);
...
#[derive(Debug)]
            struct DeleteRemoteAccessSessionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRemoteAccessSessionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteRemoteAccessSessionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteRemoteAccessSessionInput>()
                        .ok_or("failed to downcast to DeleteRemoteAccessSessionInput")?;
...
pub enum DeleteRemoteAccessSessionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteRemoteAccessSessionError) for what information is available for the error.")]
...
impl DeleteRemoteAccessSessionError {
    /// Creates the `DeleteRemoteAccessSessionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteRemoteAccessSessionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteRemoteAccessSessionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_remote_access_session::DeleteRemoteAccessSessionError {
...
mod _delete_remote_access_session_output;
