...
impl ListDeviceInstancesInput {
    /// Consumes the builder and constructs an Operation<[`ListDeviceInstances`](crate::operation::list_device_instances::ListDeviceInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_device_instances::ListDeviceInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_device_instances::ListDeviceInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_device_instances::ser_list_device_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_device_instances::ListDeviceInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDeviceInstances", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListDeviceInstances`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListDeviceInstances {
                type Output = std::result::Result<crate::operation::list_device_instances::ListDeviceInstancesOutput, crate::operation::list_device_instances::ListDeviceInstancesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_device_instances::de_list_device_instances_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_device_instances::de_list_device_instances_http_response(response)
                     }
                }
            }
