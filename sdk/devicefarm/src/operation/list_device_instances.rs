...
impl ListDeviceInstancesInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_device_instances::ser_list_device_instances_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_device_instances::ListDeviceInstances::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDeviceInstances {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_device_instances::de_list_device_instances_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_device_instances::ListDeviceInstancesError
{
