...
impl GetOfferingStatusFluentBuilder  {
    /// Creates a new `GetOfferingStatus`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_offering_status::GetOfferingStatusOutput, aws_smithy_http::result::SdkError<crate::operation::get_offering_status::GetOfferingStatusError>>
                     {
