...
impl StopRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_run::StopRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_run::ser_stop_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_run::de_stop_run_http_response_with_props(status, headers, body)
        }
    }
}
