...
impl StopRunInput {
    /// Consumes the builder and constructs an Operation<[`StopRun`](crate::operation::stop_run::StopRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_run::StopRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_run::StopRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_run::ser_stop_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_run::StopRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopRun", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `StopRun`.
...
impl aws_smithy_http::response::ParseStrictResponse for StopRun {
                type Output = std::result::Result<crate::operation::stop_run::StopRunOutput, crate::operation::stop_run::StopRunError>;
