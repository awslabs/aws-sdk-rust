...
impl ListRemoteAccessSessionsInput {
    /// Consumes the builder and constructs an Operation<[`ListRemoteAccessSessions`](crate::operation::list_remote_access_sessions::ListRemoteAccessSessions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_remote_access_sessions::ListRemoteAccessSessions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_remote_access_sessions::ser_list_remote_access_sessions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_remote_access_sessions::ListRemoteAccessSessions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRemoteAccessSessions {
                type Output = std::result::Result<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsOutput, crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError>;
