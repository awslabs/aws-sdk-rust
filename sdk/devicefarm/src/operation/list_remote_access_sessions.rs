...
/// Orchestration and serialization glue logic for `ListRemoteAccessSessions`.
...
impl ListRemoteAccessSessions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsInput,
                    ) -> ::std::result::Result<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRemoteAccessSessions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRemoteAccessSessions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRemoteAccessSessionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRemoteAccessSessionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRemoteAccessSessions")
...
.with_interceptor(ListRemoteAccessSessionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError>::new());
...
#[derive(Debug)]
            struct ListRemoteAccessSessionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRemoteAccessSessionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_remote_access_sessions::de_list_remote_access_sessions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_remote_access_sessions::de_list_remote_access_sessions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRemoteAccessSessionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRemoteAccessSessionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_remote_access_sessions::ser_list_remote_access_sessions_input(&input)?);
...
#[derive(Debug)]
            struct ListRemoteAccessSessionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRemoteAccessSessionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRemoteAccessSessionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRemoteAccessSessionsInput>()
                        .ok_or("failed to downcast to ListRemoteAccessSessionsInput")?;
...
pub enum ListRemoteAccessSessionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRemoteAccessSessionsError) for what information is available for the error.")]
...
impl ListRemoteAccessSessionsError {
    /// Creates the `ListRemoteAccessSessionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRemoteAccessSessionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRemoteAccessSessionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_remote_access_sessions::ListRemoteAccessSessionsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_remote_access_sessions::_list_remote_access_sessions_output::ListRemoteAccessSessionsOutput;

pub use crate::operation::list_remote_access_sessions::_list_remote_access_sessions_input::ListRemoteAccessSessionsInput;

mod _list_remote_access_sessions_input;

mod _list_remote_access_sessions_output;
