...
impl GetTestGridProjectInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_test_grid_project::ser_get_test_grid_project_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_test_grid_project::GetTestGridProject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTestGridProject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_test_grid_project::de_get_test_grid_project_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_test_grid_project::GetTestGridProjectError
{
