...
impl GetTestGridProjectInput {
    /// Consumes the builder and constructs an Operation<[`GetTestGridProject`](crate::operation::get_test_grid_project::GetTestGridProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_test_grid_project::GetTestGridProject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_test_grid_project::GetTestGridProjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_test_grid_project::ser_get_test_grid_project_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_test_grid_project::GetTestGridProject::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTestGridProject", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetTestGridProject`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetTestGridProject {
                type Output = std::result::Result<crate::operation::get_test_grid_project::GetTestGridProjectOutput, crate::operation::get_test_grid_project::GetTestGridProjectError>;
