...
impl CreateTestGridUrlInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_test_grid_url::ser_create_test_grid_url_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTestGridUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_test_grid_url::de_create_test_grid_url_http_response_with_props(status, headers, body)
        }
    }
