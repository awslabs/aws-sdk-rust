...
/// Orchestration and serialization glue logic for `CreateTestGridUrl`.
...
impl CreateTestGridUrl {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_test_grid_url::CreateTestGridUrlInput,
                    ) -> ::std::result::Result<crate::operation::create_test_grid_url::CreateTestGridUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_test_grid_url::CreateTestGridUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_test_grid_url::CreateTestGridUrlError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_test_grid_url::CreateTestGridUrlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTestGridUrl {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTestGridUrl");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateTestGridUrlRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateTestGridUrlResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTestGridUrl")
...
.with_interceptor(CreateTestGridUrlEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_test_grid_url::CreateTestGridUrlError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_test_grid_url::CreateTestGridUrlError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_test_grid_url::CreateTestGridUrlError>::new());
...
#[derive(Debug)]
            struct CreateTestGridUrlResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTestGridUrlResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_test_grid_url::de_create_test_grid_url_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateTestGridUrlRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTestGridUrlRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_test_grid_url::CreateTestGridUrlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_test_grid_url::CreateTestGridUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_test_grid_url::ser_create_test_grid_url_input(&input)?);
...
#[derive(Debug)]
            struct CreateTestGridUrlEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTestGridUrlEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateTestGridUrlEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateTestGridUrlInput>()
                        .ok_or("failed to downcast to CreateTestGridUrlInput")?;
...
pub enum CreateTestGridUrlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTestGridUrlError) for what information is available for the error.")]
...
impl CreateTestGridUrlError {
    /// Creates the `CreateTestGridUrlError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTestGridUrlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTestGridUrlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_test_grid_url::CreateTestGridUrlError {
...
mod _create_test_grid_url_output;
