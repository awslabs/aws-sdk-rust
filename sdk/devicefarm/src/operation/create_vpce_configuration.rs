...
impl CreateVpceConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`CreateVPCEConfiguration`](crate::operation::create_vpce_configuration::CreateVPCEConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_vpce_configuration::CreateVPCEConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpce_configuration::CreateVpceConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpce_configuration::ser_create_vpce_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpce_configuration::CreateVPCEConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateVPCEConfiguration", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateVPCEConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVPCEConfiguration {
                type Output = std::result::Result<crate::operation::create_vpce_configuration::CreateVpceConfigurationOutput, crate::operation::create_vpce_configuration::CreateVPCEConfigurationError>;
