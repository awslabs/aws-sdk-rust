...
impl DeleteVPCEConfigurationFluentBuilder  {
    /// Creates a new `DeleteVPCEConfiguration`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_vpce_configuration::DeleteVpceConfigurationOutput, aws_smithy_http::result::SdkError<crate::operation::delete_vpce_configuration::DeleteVPCEConfigurationError>>
                     {
