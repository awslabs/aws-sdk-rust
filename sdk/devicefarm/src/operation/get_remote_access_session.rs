...
/// Orchestration and serialization glue logic for `GetRemoteAccessSession`.
...
impl GetRemoteAccessSession {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_remote_access_session::GetRemoteAccessSessionInput,
                    ) -> ::std::result::Result<crate::operation::get_remote_access_session::GetRemoteAccessSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_remote_access_session::GetRemoteAccessSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_remote_access_session::GetRemoteAccessSessionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_remote_access_session::GetRemoteAccessSessionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRemoteAccessSession {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRemoteAccessSession");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRemoteAccessSessionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRemoteAccessSessionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRemoteAccessSession")
...
.with_interceptor(GetRemoteAccessSessionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_remote_access_session::GetRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_remote_access_session::GetRemoteAccessSessionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_remote_access_session::GetRemoteAccessSessionError>::new());
...
#[derive(Debug)]
            struct GetRemoteAccessSessionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRemoteAccessSessionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_remote_access_session::de_get_remote_access_session_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_remote_access_session::de_get_remote_access_session_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRemoteAccessSessionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRemoteAccessSessionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_remote_access_session::GetRemoteAccessSessionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_remote_access_session::GetRemoteAccessSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_remote_access_session::ser_get_remote_access_session_input(&input)?);
...
#[derive(Debug)]
            struct GetRemoteAccessSessionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRemoteAccessSessionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRemoteAccessSessionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRemoteAccessSessionInput>()
                        .ok_or("failed to downcast to GetRemoteAccessSessionInput")?;
...
pub enum GetRemoteAccessSessionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRemoteAccessSessionError) for what information is available for the error.")]
...
impl GetRemoteAccessSessionError {
    /// Creates the `GetRemoteAccessSessionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRemoteAccessSessionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRemoteAccessSessionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_remote_access_session::GetRemoteAccessSessionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_remote_access_session::_get_remote_access_session_output::GetRemoteAccessSessionOutput;

pub use crate::operation::get_remote_access_session::_get_remote_access_session_input::GetRemoteAccessSessionInput;

mod _get_remote_access_session_input;

mod _get_remote_access_session_output;
