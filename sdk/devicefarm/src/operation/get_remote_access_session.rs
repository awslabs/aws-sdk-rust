...
impl GetRemoteAccessSessionInput {
    /// Consumes the builder and constructs an Operation<[`GetRemoteAccessSession`](crate::operation::get_remote_access_session::GetRemoteAccessSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_remote_access_session::GetRemoteAccessSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_remote_access_session::GetRemoteAccessSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_remote_access_session::ser_get_remote_access_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_remote_access_session::GetRemoteAccessSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRemoteAccessSession {
                type Output = std::result::Result<crate::operation::get_remote_access_session::GetRemoteAccessSessionOutput, crate::operation::get_remote_access_session::GetRemoteAccessSessionError>;
