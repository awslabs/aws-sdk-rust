...
impl GetNetworkProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_network_profile::ser_get_network_profile_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_network_profile::de_get_network_profile_http_response_with_props(status, headers, body)
        }
    }
}
