...
impl ScheduleRunInput {
    /// Consumes the builder and constructs an Operation<[`ScheduleRun`](crate::operation::schedule_run::ScheduleRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::schedule_run::ScheduleRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::schedule_run::ScheduleRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_schedule_run::ser_schedule_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::schedule_run::ScheduleRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ScheduleRun", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ScheduleRun`.
...
impl aws_smithy_http::response::ParseStrictResponse for ScheduleRun {
                type Output = std::result::Result<crate::operation::schedule_run::ScheduleRunOutput, crate::operation::schedule_run::ScheduleRunError>;
