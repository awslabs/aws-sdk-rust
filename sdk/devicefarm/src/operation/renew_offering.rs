...
impl RenewOfferingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::renew_offering::RenewOffering,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::renew_offering::RenewOffering::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RenewOffering {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_renew_offering::de_renew_offering_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_renew_offering::de_renew_offering_http_response_with_props(
                status, headers, body,
            )
        }
    }
