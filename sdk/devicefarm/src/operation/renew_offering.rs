...
impl RenewOfferingInput {
    /// Consumes the builder and constructs an Operation<[`RenewOffering`](crate::operation::renew_offering::RenewOffering)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::renew_offering::RenewOffering, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::renew_offering::RenewOfferingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::renew_offering::RenewOffering::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RenewOffering {
                type Output = std::result::Result<crate::operation::renew_offering::RenewOfferingOutput, crate::operation::renew_offering::RenewOfferingError>;
