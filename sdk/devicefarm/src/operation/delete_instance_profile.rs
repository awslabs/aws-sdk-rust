...
impl DeleteInstanceProfileInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInstanceProfile`](crate::operation::delete_instance_profile::DeleteInstanceProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_instance_profile::DeleteInstanceProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_instance_profile::DeleteInstanceProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_instance_profile::ser_delete_instance_profile_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_instance_profile::DeleteInstanceProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteInstanceProfile {
                type Output = std::result::Result<crate::operation::delete_instance_profile::DeleteInstanceProfileOutput, crate::operation::delete_instance_profile::DeleteInstanceProfileError>;
