...
/// <ul>
/// <li>
/// <p>The session ARN (<code>GetTestGridSessionRequest$sessionArn</code>).</p></li>
/// <li>
/// <p>The project ARN and a session ID (<code>GetTestGridSessionRequest$projectArn</code> and <code>GetTestGridSessionRequest$sessionId</code>).</p></li>
/// </ul>
/// <p></p>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_test_grid_session::GetTestGridSessionOutput,
                    crate::operation::get_test_grid_session::GetTestGridSessionError,
                > for GetTestGridSessionFluentBuilder
            {
                fn send(
                    self,
...
impl GetTestGridSessionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_test_grid_session::GetTestGridSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_test_grid_session::GetTestGridSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::get_test_grid_session::GetTestGridSession::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_test_grid_session::GetTestGridSessionOutput, crate::operation::get_test_grid_session::GetTestGridSessionError, Self> {
