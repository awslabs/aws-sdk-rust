...
impl ListArtifactsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_artifacts::ListArtifacts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_artifacts::ser_list_artifacts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListArtifacts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_artifacts::de_list_artifacts_http_response_with_props(status, headers, body)
        }
    }
}
