...
impl UpdateUploadInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_upload::UpdateUpload, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_upload::ser_update_upload_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_upload::de_update_upload_http_response_with_props(status, headers, body)
        }
    }
