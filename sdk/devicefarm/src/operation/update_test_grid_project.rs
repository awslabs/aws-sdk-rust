...
impl UpdateTestGridProjectInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTestGridProject`](crate::operation::update_test_grid_project::UpdateTestGridProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_test_grid_project::UpdateTestGridProject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_test_grid_project::UpdateTestGridProjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_test_grid_project::ser_update_test_grid_project_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_test_grid_project::UpdateTestGridProject::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTestGridProject {
                type Output = std::result::Result<crate::operation::update_test_grid_project::UpdateTestGridProjectOutput, crate::operation::update_test_grid_project::UpdateTestGridProjectError>;
