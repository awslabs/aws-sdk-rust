...
impl UpdateDevicePoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_device_pool::ser_update_device_pool_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDevicePool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_device_pool::de_update_device_pool_http_response_with_props(status, headers, body)
        }
    }
}
