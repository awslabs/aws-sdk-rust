...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTestGridSessionActions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_test_grid_session_actions::de_list_test_grid_session_actions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_test_grid_session_actions::ListTestGridSessionActionsError
{
