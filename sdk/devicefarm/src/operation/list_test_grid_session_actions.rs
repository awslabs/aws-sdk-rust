...
impl ListTestGridSessionActionsInput {
    /// Consumes the builder and constructs an Operation<[`ListTestGridSessionActions`](crate::operation::list_test_grid_session_actions::ListTestGridSessionActions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_test_grid_session_actions::ListTestGridSessionActions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_test_grid_session_actions::ListTestGridSessionActionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_test_grid_session_actions::ListTestGridSessionActions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTestGridSessionActions {
                type Output = std::result::Result<crate::operation::list_test_grid_session_actions::ListTestGridSessionActionsOutput, crate::operation::list_test_grid_session_actions::ListTestGridSessionActionsError>;
