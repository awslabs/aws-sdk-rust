...
impl UpdateInstanceProfileInput {
    /// Consumes the builder and constructs an Operation<[`UpdateInstanceProfile`](crate::operation::update_instance_profile::UpdateInstanceProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_instance_profile::UpdateInstanceProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_instance_profile::UpdateInstanceProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_instance_profile::ser_update_instance_profile_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_instance_profile::UpdateInstanceProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateInstanceProfile {
                type Output = std::result::Result<crate::operation::update_instance_profile::UpdateInstanceProfileOutput, crate::operation::update_instance_profile::UpdateInstanceProfileError>;
