...
impl UpdateVpceConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_vpce_configuration::UpdateVpceConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
