...
impl crate::operation::get_device_pool_compatibility::builders::GetDevicePoolCompatibilityInputBuilder {
...
impl GetDevicePoolCompatibilityFluentBuilder {
    /// Creates a new `GetDevicePoolCompatibilityFluentBuilder`.
