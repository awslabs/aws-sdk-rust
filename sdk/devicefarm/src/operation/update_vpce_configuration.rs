...
impl UpdateVpceConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVPCEConfiguration`](crate::operation::update_vpce_configuration::UpdateVPCEConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_vpce_configuration::UpdateVPCEConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_vpce_configuration::UpdateVpceConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_vpce_configuration::ser_update_vpce_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_vpce_configuration::UpdateVPCEConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVPCEConfiguration {
                type Output = std::result::Result<crate::operation::update_vpce_configuration::UpdateVpceConfigurationOutput, crate::operation::update_vpce_configuration::UpdateVPCEConfigurationError>;
