...
impl GetInstanceProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_profile::ser_get_instance_profile_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_instance_profile::GetInstanceProfile::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_instance_profile::GetInstanceProfileError
{
