...
impl GetInstanceProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_instance_profile::ser_get_instance_profile_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstanceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instance_profile::de_get_instance_profile_http_response_with_props(status, headers, body)
        }
    }
}
