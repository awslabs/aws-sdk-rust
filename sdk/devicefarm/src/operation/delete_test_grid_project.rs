...
impl DeleteTestGridProjectInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTestGridProject`](crate::operation::delete_test_grid_project::DeleteTestGridProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_test_grid_project::DeleteTestGridProject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_test_grid_project::DeleteTestGridProjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_test_grid_project::ser_delete_test_grid_project_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_test_grid_project::DeleteTestGridProject::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTestGridProject {
                type Output = std::result::Result<crate::operation::delete_test_grid_project::DeleteTestGridProjectOutput, crate::operation::delete_test_grid_project::DeleteTestGridProjectError>;
