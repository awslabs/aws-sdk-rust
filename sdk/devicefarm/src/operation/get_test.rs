...
impl GetTestInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_test::GetTest, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_test::ser_get_test_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_test::de_get_test_http_response_with_props(status, headers, body)
        }
    }
}
