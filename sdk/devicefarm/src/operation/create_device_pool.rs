...
impl CreateDevicePoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_device_pool::ser_create_device_pool_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDevicePool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_device_pool::de_create_device_pool_http_response_with_props(status, headers, body)
        }
    }
}
