...
impl GetDeviceInstanceInput {
    /// Consumes the builder and constructs an Operation<[`GetDeviceInstance`](crate::operation::get_device_instance::GetDeviceInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_device_instance::GetDeviceInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_device_instance::GetDeviceInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_device_instance::ser_get_device_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_device_instance::GetDeviceInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDeviceInstance", "devicefarm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDeviceInstance`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDeviceInstance {
                type Output = std::result::Result<crate::operation::get_device_instance::GetDeviceInstanceOutput, crate::operation::get_device_instance::GetDeviceInstanceError>;
