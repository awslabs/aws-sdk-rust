...
impl GetDeviceInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_device_instance::GetDeviceInstance,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_device_instance::ser_get_device_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeviceInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_device_instance::de_get_device_instance_http_response_with_props(status, headers, body)
        }
    }
}
