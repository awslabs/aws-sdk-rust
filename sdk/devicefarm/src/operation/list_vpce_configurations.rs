...
impl ListVpceConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`ListVPCEConfigurations`](crate::operation::list_vpce_configurations::ListVPCEConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_vpce_configurations::ListVPCEConfigurations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vpce_configurations::ListVpceConfigurationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpce_configurations::ListVPCEConfigurations::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListVPCEConfigurations {
                type Output = std::result::Result<crate::operation::list_vpce_configurations::ListVpceConfigurationsOutput, crate::operation::list_vpce_configurations::ListVPCEConfigurationsError>;
