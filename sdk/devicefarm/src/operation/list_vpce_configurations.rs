...
impl ListVpceConfigurationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_vpce_configurations::ListVPCEConfigurations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVPCEConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_vpce_configurations::de_list_vpce_configurations_http_response_with_props(status, headers, body)
        }
    }
}
