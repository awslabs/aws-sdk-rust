...
impl StopRemoteAccessSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_remote_access_session::StopRemoteAccessSession,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopRemoteAccessSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_remote_access_session::de_stop_remote_access_session_http_response_with_props(status, headers, body)
        }
    }
}
