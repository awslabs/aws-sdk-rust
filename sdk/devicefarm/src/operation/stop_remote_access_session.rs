...
impl StopRemoteAccessSessionInput {
    /// Consumes the builder and constructs an Operation<[`StopRemoteAccessSession`](crate::operation::stop_remote_access_session::StopRemoteAccessSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_remote_access_session::StopRemoteAccessSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_remote_access_session::StopRemoteAccessSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_remote_access_session::ser_stop_remote_access_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_remote_access_session::StopRemoteAccessSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopRemoteAccessSession {
                type Output = std::result::Result<crate::operation::stop_remote_access_session::StopRemoteAccessSessionOutput, crate::operation::stop_remote_access_session::StopRemoteAccessSessionError>;
