...
impl ListUploadsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_uploads::ListUploads, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_uploads::ser_list_uploads_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUploads {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_uploads::de_list_uploads_http_response_with_props(status, headers, body)
        }
    }
