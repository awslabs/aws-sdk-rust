...
impl CreateInstanceProfile {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Device Farm", "CreateInstanceProfile", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Device Farm.CreateInstanceProfile",
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateInstanceProfileResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_instance_profile::de_create_instance_profile_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_instance_profile::de_create_instance_profile_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_instance_profile::ser_create_instance_profile_input(
            &input,
        )?);
