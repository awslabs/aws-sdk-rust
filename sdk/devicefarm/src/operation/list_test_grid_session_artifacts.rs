...
impl ListTestGridSessionArtifacts {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTestGridSessionArtifacts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListTestGridSessionArtifacts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListTestGridSessionArtifactsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTestGridSessionArtifactsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTestGridSessionArtifacts")
...
.with_interceptor(ListTestGridSessionArtifactsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError>::new());
...
#[derive(Debug)]
            struct ListTestGridSessionArtifactsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTestGridSessionArtifactsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_test_grid_session_artifacts::de_list_test_grid_session_artifacts_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListTestGridSessionArtifactsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTestGridSessionArtifactsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_test_grid_session_artifacts::ser_list_test_grid_session_artifacts_input(&input)?);
...
#[derive(Debug)]
            struct ListTestGridSessionArtifactsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTestGridSessionArtifactsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListTestGridSessionArtifactsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListTestGridSessionArtifactsInput>()
                        .ok_or("failed to downcast to ListTestGridSessionArtifactsInput")?;
...
pub enum ListTestGridSessionArtifactsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListTestGridSessionArtifactsError) for what information is available for the error.")]
...
impl ListTestGridSessionArtifactsError {
    /// Creates the `ListTestGridSessionArtifactsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListTestGridSessionArtifactsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListTestGridSessionArtifactsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError {
