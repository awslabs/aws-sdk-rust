...
impl ListTestsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_tests::ListTests,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tests::ListTests::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tests::de_list_tests_http_response_with_props(
                status, headers, body,
            )
        }
    }
