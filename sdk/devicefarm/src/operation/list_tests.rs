...
impl ListTestsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_tests::ListTests, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tests::ser_list_tests_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tests::de_list_tests_http_response_with_props(status, headers, body)
        }
    }
}
