...
impl GetDevicePoolCompatibilityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibility::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevicePoolCompatibility {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_device_pool_compatibility::de_get_device_pool_compatibility_http_response_with_props(
                status, headers, body,
            )
        }
    }
