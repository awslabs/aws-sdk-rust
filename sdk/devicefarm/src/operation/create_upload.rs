...
impl CreateUploadInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_upload::CreateUpload, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_upload::ser_create_upload_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_upload::de_create_upload_http_response_with_props(status, headers, body)
        }
    }
