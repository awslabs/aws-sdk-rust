...
if (region) == ("aws-global") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://route53-recovery-control-config.us-west-2.amazonaws.com"
.to_string())
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("name".to_string(), "sigv4"
    .to_string().into());
    out.insert("signingName".to_string(), "route53-recovery-control-config"
    .to_string().into());
