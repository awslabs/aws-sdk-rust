...
impl DeleteSafetyRuleFluentBuilder  {
    /// Creates a new `DeleteSafetyRule`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_safety_rule::DeleteSafetyRuleOutput, aws_smithy_http::result::SdkError<crate::operation::delete_safety_rule::DeleteSafetyRuleError>>
                     {
