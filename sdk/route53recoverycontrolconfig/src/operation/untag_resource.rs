...
impl UntagResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_resource::UntagResource::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("UntagResource", "route53recoverycontrolconfig"),
        );
