...
impl ListControlPanelsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_control_panels::ListControlPanels::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListControlPanels", "route53recoverycontrolconfig"),
            );
