...
impl ListRoutingControlsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_routing_controls::ListRoutingControls::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListRoutingControls", "route53recoverycontrolconfig"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoutingControls {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_routing_controls::de_list_routing_controls_http_response_with_props(status, headers, body)
        }
    }
}
