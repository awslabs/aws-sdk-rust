...
impl DescribeClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cluster::DescribeCluster::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DescribeCluster", "route53recoverycontrolconfig"),
        );
