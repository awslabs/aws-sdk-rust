...
impl DeleteSafetyRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_safety_rule::DeleteSafetyRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSafetyRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_safety_rule::de_delete_safety_rule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_safety_rule::DeleteSafetyRuleError
{
