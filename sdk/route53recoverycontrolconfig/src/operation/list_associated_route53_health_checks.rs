...
impl ListAssociatedRoute53HealthChecksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_associated_route53_health_checks::ListAssociatedRoute53HealthChecks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssociatedRoute53HealthChecks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_associated_route53_health_checks::de_list_associated_route53_health_checks_http_response_with_props(
                status, headers, body,
            )
        }
    }
