...
impl DeleteClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_cluster::DeleteCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cluster::DeleteCluster::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DeleteCluster", "route53recoverycontrolconfig"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cluster::de_delete_cluster_http_response_with_props(status, headers, body)
        }
    }
}
