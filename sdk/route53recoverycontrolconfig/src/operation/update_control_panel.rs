...
impl UpdateControlPanelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_control_panel::ser_update_control_panel_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_control_panel::UpdateControlPanel::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("UpdateControlPanel", "route53recoverycontrolconfig"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateControlPanel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_control_panel::de_update_control_panel_http_response_with_props(status, headers, body)
        }
    }
}
