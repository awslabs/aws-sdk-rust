...
impl CreateClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster::CreateCluster::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("CreateCluster", "route53recoverycontrolconfig"),
        );
