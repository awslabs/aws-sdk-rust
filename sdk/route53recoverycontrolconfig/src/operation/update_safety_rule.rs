...
impl UpdateSafetyRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_safety_rule::ser_update_safety_rule_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_safety_rule::UpdateSafetyRule::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("UpdateSafetyRule", "route53recoverycontrolconfig"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSafetyRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_safety_rule::de_update_safety_rule_http_response_with_props(status, headers, body)
        }
    }
}
