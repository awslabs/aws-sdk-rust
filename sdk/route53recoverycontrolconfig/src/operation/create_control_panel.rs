...
impl CreateControlPanelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_control_panel::CreateControlPanel,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_control_panel::ser_create_control_panel_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_control_panel::CreateControlPanel::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("CreateControlPanel", "route53recoverycontrolconfig"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateControlPanel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_control_panel::de_create_control_panel_http_response_with_props(status, headers, body)
        }
    }
}
