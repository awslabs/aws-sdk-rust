...
impl CreateControlPanelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_control_panel::CreateControlPanel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateControlPanel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_control_panel::de_create_control_panel_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_control_panel::CreateControlPanelError
{
