...
impl CreateSafetyRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_safety_rule::ser_create_safety_rule_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_safety_rule::CreateSafetyRule::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("CreateSafetyRule", "route53recoverycontrolconfig"),
        );
