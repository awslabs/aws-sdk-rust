...
impl DeleteRoutingControlFluentBuilder  {
    /// Creates a new `DeleteRoutingControl`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_routing_control::DeleteRoutingControl, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_routing_control::DeleteRoutingControlOutput, aws_smithy_http::result::SdkError<crate::operation::delete_routing_control::DeleteRoutingControlError>>
                     {
