...
impl ::std::convert::From<&str> for NetworkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkType::from(s))
    }
}
impl NetworkType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            NetworkType::Dualstack => "DUALSTACK",
...
impl ::std::convert::AsRef<str> for NetworkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for NetworkType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NetworkType::Dualstack => write!(f, "DUALSTACK"),
