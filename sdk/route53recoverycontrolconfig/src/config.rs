...
impl Builder {
    ...
    /// use aws_sdk_route53recoverycontrolconfig::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_route53recoverycontrolconfig::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
