...
) -> Result<Option<crate::types::GatingRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RuleConfig" => {
                            builder = builder.set_rule_config(crate::protocol_serde::shape_rule_config::de_rule_config(tokens)?);
                        }
                        "SafetyRuleArn" => {
