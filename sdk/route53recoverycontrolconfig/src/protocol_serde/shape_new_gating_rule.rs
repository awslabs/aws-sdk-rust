...
pub fn ser_new_gating_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewGatingRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
