...
pub fn ser_new_assertion_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewAssertionRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
