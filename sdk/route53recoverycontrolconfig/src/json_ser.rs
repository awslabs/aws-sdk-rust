...
pub fn serialize_structure_create_control_panel_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_routing_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_safety_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_10) = &input.assertion_rule {
        ...
        crate::json_ser::serialize_structure_new_assertion_rule(&mut object_11, var_10);
        object_11.finish();
    }
    ...
    if let Some(var_13) = &input.gating_rule {
        ...
        crate::json_ser::serialize_structure_new_gating_rule(&mut object_14, var_13);
        object_14.finish();
    }
}

pub fn serialize_structure_update_control_panel_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_routing_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_safety_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_19) = &input.assertion_rule_update {
        ...
        crate::json_ser::serialize_structure_assertion_rule_update(&mut object_20, var_19);
        object_20.finish();
    }
    if let Some(var_21) = &input.gating_rule_update {
        let mut object_22 = object.key("GatingRuleUpdate").start_object();
        crate::json_ser::serialize_structure_gating_rule_update(&mut object_22, var_21);
        object_22.finish();
    }
}

pub fn serialize_structure_new_assertion_rule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_28) = &input.rule_config {
        ...
        crate::json_ser::serialize_structure_rule_config(&mut object_29, var_28);
        object_29.finish();
    }
    {
        object.key("WaitPeriodMs").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.wait_period_ms).into()),
        );
    }
}

pub fn serialize_structure_new_gating_rule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_35) = &input.rule_config {
        ...
        crate::json_ser::serialize_structure_rule_config(&mut object_36, var_35);
        object_36.finish();
    }
...
pub fn serialize_structure_assertion_rule_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_gating_rule_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_rule_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    }
    {
        object.key("Threshold").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.threshold).into()),
        );
    }
