...
pub struct UpdateSafetyRuleOutput  {
    ...
    #[doc(hidden)]pub assertion_rule: std::option::Option<crate::model::AssertionRule>,
    /// <p>The gating rule updated.</p>
    #[doc(hidden)]pub gating_rule: std::option::Option<crate::model::GatingRule>,
}
...
pub struct UpdateRoutingControlOutput  {
    ...
    #[doc(hidden)]pub routing_control: std::option::Option<crate::model::RoutingControl>,
}
...
pub struct UpdateControlPanelOutput  {
    ...
    #[doc(hidden)]pub control_panel: std::option::Option<crate::model::ControlPanel>,
}
...
pub struct ListSafetyRulesOutput  {
    ...
    #[doc(hidden)]pub safety_rules: std::option::Option<std::vec::Vec<crate::model::Rule>>,
}
...
pub struct ListRoutingControlsOutput  {
    ...
    #[doc(hidden)]pub routing_controls: std::option::Option<std::vec::Vec<crate::model::RoutingControl>>,
}
...
pub struct ListControlPanelsOutput  {
    ...
    #[doc(hidden)]pub control_panels: std::option::Option<std::vec::Vec<crate::model::ControlPanel>>,
    /// <p>The token that identifies which batch of results you want to see.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
