...
impl super::Client {
    ...
    ///   - [`control_panel_arn(impl ::std::convert::Into<String>)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::control_panel_arn) / [`set_control_panel_arn(Option<String>)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::set_control_panel_arn): <p>The Amazon Resource Name (ARN) of the control panel.</p>
    ///   - [`max_results(i32)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::set_max_results): <p>The number of objects that you want to return with this call.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_routing_controls::builders::ListRoutingControlsFluentBuilder::set_next_token): <p>The token that identifies which batch of results you want to see.</p>
