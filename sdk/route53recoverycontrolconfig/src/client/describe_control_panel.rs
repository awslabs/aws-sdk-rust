...
impl super::Client {
    ...
    ///   - [`control_panel_arn(impl Into<String>)`](crate::operation::describe_control_panel::builders::DescribeControlPanelFluentBuilder::control_panel_arn) / [`set_control_panel_arn(Option<String>)`](crate::operation::describe_control_panel::builders::DescribeControlPanelFluentBuilder::set_control_panel_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the control panel.</p><br>
