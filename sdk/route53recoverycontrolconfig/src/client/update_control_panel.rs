...
impl super::Client {
    ...
    ///   - [`control_panel_arn(impl Into<String>)`](crate::operation::update_control_panel::builders::UpdateControlPanelFluentBuilder::control_panel_arn) / [`set_control_panel_arn(Option<String>)`](crate::operation::update_control_panel::builders::UpdateControlPanelFluentBuilder::set_control_panel_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the control panel.</p><br>
    ///   - [`control_panel_name(impl Into<String>)`](crate::operation::update_control_panel::builders::UpdateControlPanelFluentBuilder::control_panel_name) / [`set_control_panel_name(Option<String>)`](crate::operation::update_control_panel::builders::UpdateControlPanelFluentBuilder::set_control_panel_name):<br>required: **true**<br><p>The name of the control panel.</p><br>
