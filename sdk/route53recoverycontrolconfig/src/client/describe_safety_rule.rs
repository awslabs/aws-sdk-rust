...
impl super::Client {
    ...
    ///   - [`safety_rule_arn(impl Into<String>)`](crate::operation::describe_safety_rule::builders::DescribeSafetyRuleFluentBuilder::safety_rule_arn) / [`set_safety_rule_arn(Option<String>)`](crate::operation::describe_safety_rule::builders::DescribeSafetyRuleFluentBuilder::set_safety_rule_arn):<br>required: **true**<br><p>The ARN of the safety rule.</p><br>
