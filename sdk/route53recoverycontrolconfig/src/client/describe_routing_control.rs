...
impl super::Client {
    ...
    ///   - [`routing_control_arn(impl Into<String>)`](crate::operation::describe_routing_control::builders::DescribeRoutingControlFluentBuilder::routing_control_arn) / [`set_routing_control_arn(Option<String>)`](crate::operation::describe_routing_control::builders::DescribeRoutingControlFluentBuilder::set_routing_control_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the routing control.</p><br>
