...
async fn operation_input_test_create_bucket_27() {
    ...
    let _result = dbg!(
        client
            .create_bucket()
            .set_bucket(Some("blah".to_owned()))
            .set_outpost_id(Some("123".to_owned()))
            .send()
            .await
    );
    let req = rcvr.expect_request();
...
async fn operation_input_test_list_regional_buckets_30() {
    ...
    let _result = dbg!(
        client
            ...
            .set_account_id(Some("123".to_owned()))
            .set_outpost_id(Some("op-123".to_owned()))
            .send()
            .await
    );
    let req = rcvr.expect_request();
...
async fn operation_input_test_get_access_point_35() {
    ...
    let _result = dbg!(
        client
            .get_access_point()
            .set_account_id(Some("123456789012".to_owned()))
            .set_name(Some("apname".to_owned()))
            .send()
            .await
    );
    let req = rcvr.expect_request();
...
async fn operation_input_test_list_regional_buckets_56() {
    ...
    let _result = dbg!(
        client
            .list_regional_buckets()
            .set_account_id(Some("1234567890-aBC".to_owned()))
            .send()
            .await
    );
    let req = rcvr.expect_request();
...
async fn operation_input_test_list_regional_buckets_57() {
    ...
    let _result = dbg!(
        client
            .list_regional_buckets()
            .set_account_id(Some("/?invalid&not-host*label".to_owned()))
            .send()
            .await
    );
    rcvr.expect_no_request();
...
async fn operation_input_test_list_regional_buckets_67() {
    ...
    let _result = dbg!(
        client
            .list_regional_buckets()
            .set_outpost_id(Some("op-123".to_owned()))
            .set_account_id(Some("0123456789012".to_owned()))
            .send()
            .await
    );
    rcvr.expect_no_request();
...
async fn operation_input_test_list_regional_buckets_68() {
    ...
    let _result = dbg!(
        client
            .list_regional_buckets()
            .set_outpost_id(Some("?outpost/invalid+".to_owned()))
            .set_account_id(Some("0123456789012".to_owned()))
            .send()
            .await
    );
