...
pub fn serialize_structure_crate_input_submit_multi_region_access_point_routes_input(
        ...
        for list_item_35 in var_34 {
            {
                ...
                crate::xml_ser::serialize_structure_crate_model_multi_region_access_point_route(
                    list_item_35,
                    inner_writer,
                )?
            }
        ...
        for list_item_39 in var_38 {
            {
                ...
                inner_writer.data(list_item_39.as_str());
            }
        }
    }
...
pub fn serialize_structure_crate_model_create_bucket_configuration(
    ...
    if let Some(var_42) = &input.location_constraint {
        ...
        inner_writer.data(var_42.as_str());
    }
    scope.finish();
    Ok(())
}
...
pub fn serialize_structure_crate_model_multi_region_access_point_route(
    ...
    if let Some(var_84) = &input.traffic_dial_percentage {
        ...
        inner_writer.data(aws_smithy_types::primitive::Encoder::from(*var_84).encode());
    }
    scope.finish();
    Ok(())
}
        ...
        for list_item_86 in var_85 {
            {
                ...
                inner_writer.data(list_item_86.as_str());
            }
        }
    }
        ...
        for list_item_90 in var_89 {
            {
                ...
                inner_writer.data(list_item_90.as_str());
            }
        }
    }
    scope.finish();
...
pub fn serialize_structure_crate_model_s3_copy_object_operation(
    ...
    if let Some(var_116) = &input.checksum_algorithm {
        ...
        inner_writer.data(var_116.as_str());
    }
    scope.finish();
    Ok(())
}
...
pub fn serialize_structure_crate_model_account_level(
    ...
    if let Some(var_138) = &input.advanced_cost_optimization_metrics {
        ...
        crate::xml_ser::serialize_structure_crate_model_advanced_cost_optimization_metrics(
            var_138,
            inner_writer,
        )?
    }
    if let Some(var_139) = &input.advanced_data_protection_metrics {
        ...
        crate::xml_ser::serialize_structure_crate_model_advanced_data_protection_metrics(
            var_139,
            inner_writer,
        )?
    }
    if let Some(var_140) = &input.detailed_status_codes_metrics {
        ...
        crate::xml_ser::serialize_structure_crate_model_detailed_status_codes_metrics(
            var_140,
            inner_writer,
        )?
    }
        ...
        for list_item_142 in var_141 {
            {
                ...
                inner_writer.data(list_item_142.as_str());
            }
        }
    }
        ...
        for list_item_144 in var_143 {
            {
                ...
                inner_writer.data(list_item_144.as_str());
            }
        }
    }
    scope.finish();
...
pub fn serialize_structure_crate_model_exclude(
    ...
    if let Some(var_145) = &input.buckets {
        ...
        for list_item_146 in var_145 {
            {
                let mut inner_writer = inner_writer.start_el("Arn").finish();
                inner_writer.data(list_item_146.as_str());
            }
        }
    }
    if let Some(var_147) = &input.regions {
        ...
        for list_item_148 in var_147 {
            {
                let mut inner_writer = inner_writer.start_el("Region").finish();
                inner_writer.data(list_item_148.as_str());
            }
        }
    }
    scope.finish();
...
pub fn serialize_structure_crate_model_job_manifest_generator_filter(
    ...
    if let Some(var_160) = &input.object_replication_statuses {
        ...
        for list_item_161 in var_160 {
            {
                let mut inner_writer = inner_writer.start_el("member").finish();
                inner_writer.data(list_item_161.as_str());
            }
        }
    }
    scope.finish();
    ...
    if let Some(var_168) = &input.user_metadata {
        ...
        for (key_169, value_170) in var_168 {
            let mut entry = inner_writer.start_el("entry").finish();
            {
                ...
                inner_writer.data(key_169.as_str());
            }
            {
                let mut inner_writer = entry.start_el("value").finish();
                inner_writer.data(value_170.as_str());
            }
        }
    }
...
pub fn serialize_structure_crate_model_advanced_cost_optimization_metrics(
...
pub fn serialize_structure_crate_model_advanced_data_protection_metrics(
...
pub fn serialize_structure_crate_model_detailed_status_codes_metrics(
...
pub fn serialize_structure_crate_model_lifecycle_rule_and_operator(
    ...
    if let Some(var_216) = &input.object_size_less_than {
        let mut inner_writer = scope.start_el("ObjectSizeLessThan").finish();
        inner_writer.data(aws_smithy_types::primitive::Encoder::from(*var_216).encode());
    }
    scope.finish();
    Ok(())
}
