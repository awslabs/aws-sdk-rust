...
pub fn de_route_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MultiRegionAccessPointRoute>, aws_smithy_xml::decode::XmlDecodeError> {
