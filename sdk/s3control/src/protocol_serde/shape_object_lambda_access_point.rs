...
pub fn de_object_lambda_access_point(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ObjectLambdaAccessPoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
