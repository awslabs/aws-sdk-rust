...
pub fn ser_storage_lens_group_filter(input: &crate::types::StorageLensGroupFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_group_filter(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StorageLensGroupFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
