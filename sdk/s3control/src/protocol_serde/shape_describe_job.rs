...
#[allow(unused_mut)]
pub fn de_describe_job(inp: &[u8], mut builder: crate::output::describe_job_output::Builder) -> Result<crate::output::describe_job_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
