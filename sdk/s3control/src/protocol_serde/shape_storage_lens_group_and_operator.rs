...
pub fn ser_storage_lens_group_and_operator(input: &crate::types::StorageLensGroupAndOperator, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_group_and_operator(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StorageLensGroupAndOperator, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
