...
pub fn ser_s3_manifest_output_location(input: &crate::types::S3ManifestOutputLocation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_manifest_output_location(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::S3ManifestOutputLocation, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::s3_manifest_output_location_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
