...
pub fn ser_s3_manifest_output_location(input: &crate::model::S3ManifestOutputLocation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_manifest_output_location(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3ManifestOutputLocation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
