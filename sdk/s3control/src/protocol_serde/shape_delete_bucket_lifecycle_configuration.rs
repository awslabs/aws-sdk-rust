...
pub fn de_delete_bucket_lifecycle_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_bucket_lifecycle_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
