...
pub fn de_established_multi_region_access_point_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EstablishedMultiRegionAccessPointPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
