...
pub fn ser_s3_initiate_restore_object_operation(input: &crate::types::S3InitiateRestoreObjectOperation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
