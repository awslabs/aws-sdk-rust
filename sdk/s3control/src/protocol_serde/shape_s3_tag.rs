...
pub fn ser_s3_tag(input: &crate::model::S3Tag, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_tag(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3Tag, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
