...
pub fn de_get_access_point_for_object_lambda_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetAccessPointForObjectLambdaOutput, crate::error::GetAccessPointForObjectLambdaError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetAccessPointForObjectLambdaError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_for_object_lambda_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetAccessPointForObjectLambdaOutput, crate::error::GetAccessPointForObjectLambdaError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_access_point_for_object_lambda_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_access_point_for_object_lambda::de_get_access_point_for_object_lambda(response.body().as_ref(), output).map_err(crate::error::GetAccessPointForObjectLambdaError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_access_point_for_object_lambda(inp: &[u8], mut builder: crate::output::get_access_point_for_object_lambda_output::Builder) -> Result<crate::output::get_access_point_for_object_lambda_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
