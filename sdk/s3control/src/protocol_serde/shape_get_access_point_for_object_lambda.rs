...
pub fn de_get_access_point_for_object_lambda_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaOutput, crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_for_object_lambda_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaOutput, crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_get_access_point_for_object_lambda::de_get_access_point_for_object_lambda(_response_body, output).map_err(crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError::unhandled)?;
