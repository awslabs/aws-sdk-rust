...
pub fn de_multi_region_access_point_policy_document(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MultiRegionAccessPointPolicyDocument, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
