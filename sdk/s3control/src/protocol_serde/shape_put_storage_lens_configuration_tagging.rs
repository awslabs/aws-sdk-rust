...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_storage_lens_configuration_tagging_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_storage_lens_configuration_tagging::PutStorageLensConfigurationTaggingOutput, crate::operation::put_storage_lens_configuration_tagging::PutStorageLensConfigurationTaggingError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_put_storage_lens_configuration_tagging_op_input(input: &crate::operation::put_storage_lens_configuration_tagging::PutStorageLensConfigurationTaggingInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
     {
        ...
        crate::protocol_serde::shape_put_storage_lens_configuration_tagging_input::ser_put_storage_lens_configuration_tagging_input_input_input(input, root)?
    }
