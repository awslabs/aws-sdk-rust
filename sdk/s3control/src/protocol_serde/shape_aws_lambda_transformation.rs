...
pub fn ser_aws_lambda_transformation(input: &crate::model::AwsLambdaTransformation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_aws_lambda_transformation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AwsLambdaTransformation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
