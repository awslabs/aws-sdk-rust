...
pub fn ser_put_multi_region_access_point_policy_input_input(input: &crate::input::PutMultiRegionAccessPointPolicyInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn ser_put_multi_region_access_point_policy_input(input: &crate::model::PutMultiRegionAccessPointPolicyInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    let mut scope = writer.finish();
...
pub fn de_put_multi_region_access_point_policy_input(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PutMultiRegionAccessPointPolicyInput, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
