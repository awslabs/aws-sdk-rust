...
pub fn ser_put_multi_region_access_point_policy_input_input_input(
...
) -> ::std::result::Result<crate::types::PutMultiRegionAccessPointPolicyInput, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
