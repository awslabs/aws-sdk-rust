...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_multi_region_access_point_policy_status_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_multi_region_access_point_policy_status::de_get_multi_region_access_point_policy_status(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusError::unhandled)?;
