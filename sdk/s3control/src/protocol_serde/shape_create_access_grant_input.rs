...
pub fn ser_create_access_grant_input_input_input(input: &crate::operation::create_access_grant::CreateAccessGrantInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
