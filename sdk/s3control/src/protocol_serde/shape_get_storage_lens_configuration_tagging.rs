...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_storage_lens_configuration_tagging_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !start_el.matches("GetStorageLensConfigurationTaggingResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetStorageLensConfigurationTaggingResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
