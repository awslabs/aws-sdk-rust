...
pub fn ser_s3_access_control_policy(input: &crate::model::S3AccessControlPolicy, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_access_control_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3AccessControlPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
