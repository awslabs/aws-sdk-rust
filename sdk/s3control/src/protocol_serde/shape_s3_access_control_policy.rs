...
pub fn ser_s3_access_control_policy(input: &crate::types::S3AccessControlPolicy, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
