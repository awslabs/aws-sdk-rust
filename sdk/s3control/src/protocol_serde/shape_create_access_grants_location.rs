...
pub fn de_create_access_grants_location_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_access_grants_location::CreateAccessGrantsLocationOutput, crate::operation::create_access_grants_location::CreateAccessGrantsLocationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_access_grants_location::CreateAccessGrantsLocationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::create_access_grants_location::CreateAccessGrantsLocationError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_access_grants_location_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_access_grants_location::CreateAccessGrantsLocationOutput, crate::operation::create_access_grants_location::CreateAccessGrantsLocationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_access_grants_location::builders::CreateAccessGrantsLocationOutputBuilder::default();
        output = crate::protocol_serde::shape_create_access_grants_location::de_create_access_grants_location(_response_body, output).map_err(crate::operation::create_access_grants_location::CreateAccessGrantsLocationError::unhandled)?;
...
pub fn ser_create_access_grants_location_op_input(input: &crate::operation::create_access_grants_location::CreateAccessGrantsLocationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
     {
        let mut writer = ::aws_smithy_xml::encode::XmlWriter::new(&mut out);
                                #[allow(unused_mut)]
                                let mut root = writer.start_el("CreateAccessGrantsLocationRequest").write_ns("http://awss3control.amazonaws.com/doc/2018-08-20/", None);
...
#[allow(unused_mut)]
pub fn de_create_access_grants_location(inp: &[u8], mut builder: crate::operation::create_access_grants_location::builders::CreateAccessGrantsLocationOutputBuilder) -> Result<crate::operation::create_access_grants_location::builders::CreateAccessGrantsLocationOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("CreateAccessGrantsLocationResult") {
                            return Err(
                                ::aws_smithy_xml::decode::XmlDecodeError::custom(
                                    format!("encountered invalid XML root: expected CreateAccessGrantsLocationResult but got {:?}. This is likely a bug in the SDK.", start_el)
                                )
                            )
                        }
