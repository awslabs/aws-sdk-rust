...
pub fn ser_multi_region_access_point_route(input: &crate::model::MultiRegionAccessPointRoute, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_multi_region_access_point_route(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MultiRegionAccessPointRoute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::MultiRegionAccessPointRoute::builder();
