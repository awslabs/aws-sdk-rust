...
pub fn ser_multi_region_access_point_route(input: &crate::types::MultiRegionAccessPointRoute, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_2) = &input.region {
    ...
    }
     {
        ...
        inner_writer.data(
            ::aws_smithy_types::primitive::Encoder::from(input.traffic_dial_percentage).encode()
        );
    }
    scope.finish();
    Ok(())
...
pub fn de_multi_region_access_point_route(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MultiRegionAccessPointRoute, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::multi_region_access_point_route_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
