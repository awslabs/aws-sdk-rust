...
pub fn ser_job_manifest_generator_filter(input: &crate::types::JobManifestGeneratorFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
