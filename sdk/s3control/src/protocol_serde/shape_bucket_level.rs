...
pub fn ser_bucket_level(input: &crate::model::BucketLevel, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_bucket_level(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BucketLevel, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
