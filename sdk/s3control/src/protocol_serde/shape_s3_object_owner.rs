...
pub fn ser_s3_object_owner(input: &crate::model::S3ObjectOwner, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_object_owner(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3ObjectOwner, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
