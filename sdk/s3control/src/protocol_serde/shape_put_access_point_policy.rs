...
pub fn de_put_access_point_policy_http_error(
...
> {
    ...
    .map_err(crate::operation::put_access_point_policy::PutAccessPointPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_access_point_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
