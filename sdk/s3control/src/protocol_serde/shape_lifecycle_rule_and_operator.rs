...
pub fn ser_lifecycle_rule_and_operator(input: &crate::model::LifecycleRuleAndOperator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lifecycle_rule_and_operator(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LifecycleRuleAndOperator, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
