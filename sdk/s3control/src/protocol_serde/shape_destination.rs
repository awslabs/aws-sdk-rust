...
pub fn ser_destination(input: &crate::types::Destination, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.replication_time {
        let inner_writer = scope.start_el("ReplicationTime");
        crate::protocol_serde::shape_replication_time::ser_replication_time(var_2, inner_writer)?
    }
    ...
    if let Some(var_5) = &input.metrics {
        ...
        crate::protocol_serde::shape_metrics::ser_metrics(var_5, inner_writer)?
    }
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Account") /* Account com.amazonaws.s3control#Destination$Account */ =>  {
                ...
                ;
                builder = builder.set_account(var_7);
            }
            ,
            ...
            s if s.matches("ReplicationTime") /* ReplicationTime com.amazonaws.s3control#Destination$ReplicationTime */ =>  {
                ...
                ;
                builder = builder.set_replication_time(var_9);
            }
            ,
            ...
            s if s.matches("Metrics") /* Metrics com.amazonaws.s3control#Destination$Metrics */ =>  {
                ...
                ;
                builder = builder.set_metrics(var_12);
            }
            ,
