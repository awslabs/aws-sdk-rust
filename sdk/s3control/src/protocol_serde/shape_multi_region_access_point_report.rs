...
pub fn de_multi_region_access_point_report(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MultiRegionAccessPointReport, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
