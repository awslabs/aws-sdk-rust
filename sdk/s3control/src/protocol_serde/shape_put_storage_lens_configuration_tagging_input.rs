...
pub fn ser_put_storage_lens_configuration_tagging_input_input(input: &crate::input::PutStorageLensConfigurationTaggingInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
