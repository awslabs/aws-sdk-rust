...
pub fn de_multi_region_access_points_async_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MultiRegionAccessPointsAsyncResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
