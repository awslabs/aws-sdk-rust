...
pub fn ser_lifecycle_configuration(input: &crate::types::LifecycleConfiguration, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
