...
pub fn ser_account_level(input: &crate::model::AccountLevel, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_account_level(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccountLevel, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
