...
pub fn ser_account_level(input: &crate::types::AccountLevel, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_2) = &input.bucket_level {
        let inner_writer = scope.start_el("BucketLevel");
        crate::protocol_serde::shape_bucket_level::ser_bucket_level(var_2, inner_writer)?
    }
...
pub fn de_account_level(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AccountLevel, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
