...
pub fn ser_job_manifest_spec(input: &crate::model::JobManifestSpec, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_job_manifest_spec(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobManifestSpec, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
