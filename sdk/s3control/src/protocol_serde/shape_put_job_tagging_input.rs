...
pub fn ser_put_job_tagging_input_input_input(input: &crate::operation::put_job_tagging::PutJobTaggingInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
