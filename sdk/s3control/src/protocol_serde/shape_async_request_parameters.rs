...
pub fn de_async_request_parameters(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AsyncRequestParameters, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
