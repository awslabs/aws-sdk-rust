...
pub fn ser_s3_object_metadata(input: &crate::types::S3ObjectMetadata, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_11) = &input.http_expires_date {
        ...
        inner_writer.data(
            var_11.fmt(::aws_smithy_types::date_time::Format::DateTimeWithOffset)?.as_ref()
        );
    }
