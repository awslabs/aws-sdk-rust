...
pub fn ser_storage_lens_group_or_operator(
    input: &crate::types::StorageLensGroupOrOperator,
...
pub fn de_storage_lens_group_or_operator(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::StorageLensGroupOrOperator, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
