...
pub fn de_multi_region_access_point_regional_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MultiRegionAccessPointRegionalResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
