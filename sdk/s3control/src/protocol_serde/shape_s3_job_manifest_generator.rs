...
pub fn ser_s3_job_manifest_generator(input: &crate::model::S3JobManifestGenerator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_job_manifest_generator(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3JobManifestGenerator, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
