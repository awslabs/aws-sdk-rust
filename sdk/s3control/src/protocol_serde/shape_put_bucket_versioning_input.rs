...
pub fn ser_versioning_configuration_http_payload(payload: &std::option::Option<crate::types::VersioningConfiguration>) -> Result<std::vec::Vec<u8>, aws_smithy_http::operation::error::BuildError> {
...
pub fn ser_versioning_configuration_payload(input: &crate::types::VersioningConfiguration) -> std::result::Result<std::vec::Vec<u8>, aws_smithy_http::operation::error::SerializationError> {
