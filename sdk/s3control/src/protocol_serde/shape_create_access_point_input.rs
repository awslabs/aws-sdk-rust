...
pub fn ser_create_access_point_input_input_input(input: &crate::operation::create_access_point::CreateAccessPointInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
