...
pub fn de_get_bucket_policy_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_bucket_policy::GetBucketPolicyOutput, crate::operation::get_bucket_policy::GetBucketPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_bucket_policy::GetBucketPolicyOutput, crate::operation::get_bucket_policy::GetBucketPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_bucket_policy::builders::GetBucketPolicyOutputBuilder::default();
        output = crate::protocol_serde::shape_get_bucket_policy::de_get_bucket_policy(_response_body, output).map_err(crate::operation::get_bucket_policy::GetBucketPolicyError::unhandled)?;
