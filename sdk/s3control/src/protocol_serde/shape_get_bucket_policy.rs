...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_bucket_policy::de_get_bucket_policy(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_bucket_policy::GetBucketPolicyError::unhandled)?;
...
pub fn de_get_bucket_policy(
    ...
    crate::operation::get_bucket_policy::builders::GetBucketPolicyOutputBuilder,
