...
pub fn de_put_access_point_scope_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::put_access_point_scope::PutAccessPointScopeError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::put_access_point_scope::PutAccessPointScopeError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_put_access_point_scope_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_put_access_point_scope_op_input(
    input: &crate::operation::put_access_point_scope::PutAccessPointScopeInput,
    ...
    let mut out = String::new();
    {
        ...
        #[allow(unused_mut)]
        let mut root = writer
            .start_el("PutAccessPointScopeRequest")
            .write_ns("http://awss3control.amazonaws.com/doc/2018-08-20/", None);
        crate::protocol_serde::shape_put_access_point_scope_input::ser_put_access_point_scope_input_input_input(input, root)?
    }
