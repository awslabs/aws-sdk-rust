...
pub fn ser_cloud_watch_metrics(input: &crate::model::CloudWatchMetrics, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cloud_watch_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudWatchMetrics, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
