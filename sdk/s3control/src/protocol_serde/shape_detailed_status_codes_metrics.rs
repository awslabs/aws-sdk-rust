...
pub fn ser_detailed_status_codes_metrics(input: &crate::types::DetailedStatusCodesMetrics, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_detailed_status_codes_metrics(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::DetailedStatusCodesMetrics, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
