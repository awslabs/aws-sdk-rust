...
pub fn de_list_access_grants_locations_http_error(
...
> {
    ...
    Err(crate::operation::list_access_grants_locations::ListAccessGrantsLocationsError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_access_grants_locations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn de_list_access_grants_locations(
    ...
    crate::operation::list_access_grants_locations::builders::ListAccessGrantsLocationsOutputBuilder,
...
> {
    ...
    if !start_el.matches("ListAccessGrantsLocationsResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListAccessGrantsLocationsResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
