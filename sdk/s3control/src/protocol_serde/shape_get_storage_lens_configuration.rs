...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_storage_lens_configuration_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationOutput, crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationError> {
    Ok({
        #[allow(unused_mut)]
