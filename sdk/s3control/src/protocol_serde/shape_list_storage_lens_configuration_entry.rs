...
pub fn de_list_storage_lens_configuration_entry(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ListStorageLensConfigurationEntry, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::list_storage_lens_configuration_entry_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
