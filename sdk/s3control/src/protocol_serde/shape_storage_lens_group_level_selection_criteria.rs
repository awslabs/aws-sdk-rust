...
pub fn ser_storage_lens_group_level_selection_criteria(input: &crate::types::StorageLensGroupLevelSelectionCriteria, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_group_level_selection_criteria(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StorageLensGroupLevelSelectionCriteria, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
