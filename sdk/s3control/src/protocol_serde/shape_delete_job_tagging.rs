...
pub fn de_delete_job_tagging_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_job_tagging::DeleteJobTaggingOutput, crate::operation::delete_job_tagging::DeleteJobTaggingError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_job_tagging_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_job_tagging::DeleteJobTaggingOutput, crate::operation::delete_job_tagging::DeleteJobTaggingError> {
    Ok({
        #[allow(unused_mut)]
