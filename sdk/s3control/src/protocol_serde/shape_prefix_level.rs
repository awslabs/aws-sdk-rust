...
pub fn ser_prefix_level(input: &crate::model::PrefixLevel, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_prefix_level(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrefixLevel, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
