...
pub fn ser_prefix_level(input: &crate::types::PrefixLevel, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_prefix_level(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PrefixLevel, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::prefix_level_correct_errors(builder).build())
}
