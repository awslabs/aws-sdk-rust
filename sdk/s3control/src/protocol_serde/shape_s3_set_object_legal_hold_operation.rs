...
pub fn ser_s3_set_object_legal_hold_operation(input: &crate::types::S3SetObjectLegalHoldOperation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_set_object_legal_hold_operation(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::S3SetObjectLegalHoldOperation, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::s3_set_object_legal_hold_operation_correct_errors(builder).build())
}
