...
pub fn ser_s3_set_object_legal_hold_operation(input: &crate::model::S3SetObjectLegalHoldOperation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_set_object_legal_hold_operation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3SetObjectLegalHoldOperation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
