...
pub fn ser_exclude(input: &crate::model::Exclude, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_exclude(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Exclude, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
