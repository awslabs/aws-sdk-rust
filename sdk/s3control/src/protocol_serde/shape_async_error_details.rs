...
pub fn de_async_error_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AsyncErrorDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
