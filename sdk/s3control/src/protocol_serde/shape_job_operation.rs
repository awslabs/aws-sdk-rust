...
pub fn ser_job_operation(input: &crate::model::JobOperation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_job_operation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobOperation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
