...
pub fn de_get_multi_region_access_point_http_error(
...
> {
    ...
    .map_err(
        crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError::unhandled,
    )?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_multi_region_access_point_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
