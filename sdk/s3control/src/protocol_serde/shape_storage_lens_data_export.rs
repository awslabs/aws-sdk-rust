...
pub fn ser_storage_lens_data_export(input: &crate::model::StorageLensDataExport, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_data_export(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StorageLensDataExport, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
