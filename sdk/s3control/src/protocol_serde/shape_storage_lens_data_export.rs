...
pub fn ser_storage_lens_data_export(input: &crate::types::StorageLensDataExport, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
