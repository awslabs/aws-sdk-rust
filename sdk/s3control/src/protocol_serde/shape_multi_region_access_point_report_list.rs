...
pub fn de_multi_region_access_point_report_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MultiRegionAccessPointReport>, aws_smithy_xml::decode::XmlDecodeError> {
