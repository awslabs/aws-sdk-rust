...
pub fn ser_lifecycle_expiration(input: &crate::model::LifecycleExpiration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lifecycle_expiration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LifecycleExpiration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
