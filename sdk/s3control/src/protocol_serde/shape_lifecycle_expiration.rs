...
pub fn ser_lifecycle_expiration(input: &crate::types::LifecycleExpiration, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
