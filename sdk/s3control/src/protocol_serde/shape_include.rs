...
pub fn ser_include(input: &crate::model::Include, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_include(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Include, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
