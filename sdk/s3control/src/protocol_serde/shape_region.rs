...
pub fn ser_region(input: &crate::types::Region, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_region(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::Region, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::region_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
