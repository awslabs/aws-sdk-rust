...
pub fn ser_activity_metrics(input: &crate::model::ActivityMetrics, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_activity_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ActivityMetrics, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
