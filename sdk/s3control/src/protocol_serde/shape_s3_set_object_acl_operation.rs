...
pub fn ser_s3_set_object_acl_operation(input: &crate::types::S3SetObjectAclOperation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
