...
pub fn ser_create_multi_region_access_point_input_input(input: &crate::input::CreateMultiRegionAccessPointInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn ser_create_multi_region_access_point_input(input: &crate::model::CreateMultiRegionAccessPointInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    let mut scope = writer.finish();
...
pub fn de_create_multi_region_access_point_input(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CreateMultiRegionAccessPointInput, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
