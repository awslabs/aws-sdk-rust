...
pub fn ser_create_multi_region_access_point_input_input_input(input: &crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn ser_create_multi_region_access_point_input(input: &crate::types::CreateMultiRegionAccessPointInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    let mut scope = writer.finish();
     {
...
pub fn de_create_multi_region_access_point_input(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CreateMultiRegionAccessPointInput, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::create_multi_region_access_point_input_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
