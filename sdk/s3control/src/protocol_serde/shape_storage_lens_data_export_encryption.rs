...
pub fn ser_storage_lens_data_export_encryption(input: &crate::types::StorageLensDataExportEncryption, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
