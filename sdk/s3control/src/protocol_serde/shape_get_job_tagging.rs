...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_job_tagging_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_job_tagging::GetJobTaggingOutput, crate::operation::get_job_tagging::GetJobTaggingError> {
    Ok({
        #[allow(unused_mut)]
