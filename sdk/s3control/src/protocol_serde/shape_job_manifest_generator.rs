...
pub fn ser_job_manifest_generator(input: &crate::types::JobManifestGenerator, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::JobManifestGenerator::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("JobManifestGenerator"))
    }
    Ok(())
}
