...
pub fn ser_job_manifest_generator(input: &crate::model::JobManifestGenerator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_job_manifest_generator(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobManifestGenerator, aws_smithy_xml::decode::XmlDecodeError> {
