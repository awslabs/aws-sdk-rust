...
pub fn ser_lifecycle_rule(input: &crate::types::LifecycleRule, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lifecycle_rule(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LifecycleRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::lifecycle_rule_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
