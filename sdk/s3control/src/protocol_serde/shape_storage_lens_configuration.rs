...
pub fn ser_storage_lens_configuration(input: &crate::types::StorageLensConfiguration, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_configuration(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StorageLensConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::storage_lens_configuration_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
