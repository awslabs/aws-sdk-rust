...
pub fn ser_generated_manifest_encryption(input: &crate::model::GeneratedManifestEncryption, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_generated_manifest_encryption(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GeneratedManifestEncryption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
