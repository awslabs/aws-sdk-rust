...
pub fn de_get_access_point_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_access_point::GetAccessPointOutput, crate::operation::get_access_point::GetAccessPointError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_access_point::GetAccessPointOutput, crate::operation::get_access_point::GetAccessPointError> {
    Ok({
        #[allow(unused_mut)]
