...
pub fn de_get_access_point_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetAccessPointOutput, crate::error::GetAccessPointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetAccessPointError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetAccessPointOutput, crate::error::GetAccessPointError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_access_point_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_access_point::de_get_access_point(response.body().as_ref(), output).map_err(crate::error::GetAccessPointError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_access_point(inp: &[u8], mut builder: crate::output::get_access_point_output::Builder) -> Result<crate::output::get_access_point_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
