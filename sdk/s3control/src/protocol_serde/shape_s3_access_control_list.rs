...
pub fn ser_s3_access_control_list(input: &crate::types::S3AccessControlList, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
