...
pub fn de_update_job_priority_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_job_priority::UpdateJobPriorityOutput, crate::operation::update_job_priority::UpdateJobPriorityError>
{
    #[allow(unused_mut)]
...
pub fn de_update_job_priority(
...
) -> std::result::Result<crate::operation::update_job_priority::builders::UpdateJobPriorityOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("UpdateJobPriorityResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected UpdateJobPriorityResult but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
