...
pub fn de_list_storage_lens_groups_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_storage_lens_groups_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn de_list_storage_lens_groups(
    ...
    crate::operation::list_storage_lens_groups::builders::ListStorageLensGroupsOutputBuilder,
...
> {
    ...
    if !start_el.matches("ListStorageLensGroupsResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListStorageLensGroupsResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
