...
pub fn ser_storage_lens_tag(input: &crate::model::StorageLensTag, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage_lens_tag(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StorageLensTag, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
