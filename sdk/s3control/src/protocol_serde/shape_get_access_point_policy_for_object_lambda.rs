...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_policy_for_object_lambda_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !start_el.matches("GetAccessPointPolicyForObjectLambdaResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetAccessPointPolicyForObjectLambdaResult but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
