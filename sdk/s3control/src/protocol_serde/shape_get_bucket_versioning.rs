...
pub fn de_get_bucket_versioning_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_bucket_versioning::GetBucketVersioningOutput, crate::operation::get_bucket_versioning::GetBucketVersioningError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_versioning_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_bucket_versioning::GetBucketVersioningOutput, crate::operation::get_bucket_versioning::GetBucketVersioningError> {
    Ok({
        #[allow(unused_mut)]
