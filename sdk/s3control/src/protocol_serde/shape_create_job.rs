...
pub fn ser_create_job_op_input(input: &crate::operation::create_job::CreateJobInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
