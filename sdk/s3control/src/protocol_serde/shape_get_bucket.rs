...
pub fn de_get_bucket_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_bucket::GetBucketOutput, crate::operation::get_bucket::GetBucketError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_bucket::GetBucketOutput, crate::operation::get_bucket::GetBucketError> {
...
pub fn de_get_bucket(
...
) -> std::result::Result<crate::operation::get_bucket::builders::GetBucketOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("GetBucketResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected GetBucketResult but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
