...
pub fn de_get_bucket_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketOutput, crate::error::GetBucketError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBucketError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketOutput, crate::error::GetBucketError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_bucket_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket::de_get_bucket(response.body().as_ref(), output).map_err(crate::error::GetBucketError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_bucket(inp: &[u8], mut builder: crate::output::get_bucket_output::Builder) -> Result<crate::output::get_bucket_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
