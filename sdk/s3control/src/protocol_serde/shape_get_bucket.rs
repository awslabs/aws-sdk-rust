...
> {
    ...
    Err(crate::operation::get_bucket::GetBucketError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket::de_get_bucket(
...
pub fn de_get_bucket(
    ...
    crate::operation::get_bucket::builders::GetBucketOutputBuilder,
