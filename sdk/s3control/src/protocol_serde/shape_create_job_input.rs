...
pub fn ser_create_job_input_input(input: &crate::input::CreateJobInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
