...
pub fn ser_create_job_input_input_input(input: &crate::operation::create_job::CreateJobInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
