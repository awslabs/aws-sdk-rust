...
pub fn de_delete_access_point_scope_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_access_point_scope::DeleteAccessPointScopeError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::delete_access_point_scope::DeleteAccessPointScopeError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_access_point_scope_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
