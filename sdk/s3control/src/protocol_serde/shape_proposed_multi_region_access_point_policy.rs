...
pub fn de_proposed_multi_region_access_point_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ProposedMultiRegionAccessPointPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
