...
pub fn ser_put_storage_lens_configuration_input_input_input(input: &crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationInput, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
