...
pub fn de_list_regional_buckets_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_regional_buckets_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> std::result::Result<crate::operation::list_regional_buckets::builders::ListRegionalBucketsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !start_el.matches("ListRegionalBucketsResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListRegionalBucketsResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
