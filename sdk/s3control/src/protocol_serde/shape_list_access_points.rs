...
pub fn de_list_access_points_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListAccessPointsOutput, crate::error::ListAccessPointsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListAccessPointsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_access_points_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListAccessPointsOutput, crate::error::ListAccessPointsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_access_points_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_access_points::de_list_access_points(response.body().as_ref(), output).map_err(crate::error::ListAccessPointsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_access_points(inp: &[u8], mut builder: crate::output::list_access_points_output::Builder) -> Result<crate::output::list_access_points_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
