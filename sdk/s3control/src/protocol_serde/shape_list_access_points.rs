...
pub fn de_list_access_points_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_access_points::ListAccessPointsOutput, crate::operation::list_access_points::ListAccessPointsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_access_points_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_access_points::ListAccessPointsOutput, crate::operation::list_access_points::ListAccessPointsError> {
...
pub fn de_list_access_points(
...
) -> std::result::Result<crate::operation::list_access_points::builders::ListAccessPointsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !start_el.matches("ListAccessPointsResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected ListAccessPointsResult but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
