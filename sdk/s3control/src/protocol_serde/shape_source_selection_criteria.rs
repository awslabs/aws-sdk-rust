...
pub fn ser_source_selection_criteria(input: &crate::types::SourceSelectionCriteria, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
