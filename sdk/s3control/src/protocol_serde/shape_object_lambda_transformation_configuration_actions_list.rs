...
pub fn de_object_lambda_transformation_configuration_actions_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ObjectLambdaTransformationConfigurationAction>, aws_smithy_xml::decode::XmlDecodeError> {
