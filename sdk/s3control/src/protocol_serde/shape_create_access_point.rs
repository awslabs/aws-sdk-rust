...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_access_point_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_access_point::CreateAccessPointOutput, crate::operation::create_access_point::CreateAccessPointError>
...
) -> Result<crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
