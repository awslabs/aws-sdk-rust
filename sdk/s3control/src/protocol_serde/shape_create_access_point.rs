...
pub fn ser_create_access_point_op_input(
    ...
    let mut out = String::new();
    {
        ...
        crate::protocol_serde::shape_create_access_point_input::ser_create_access_point_input_input(
            input, root,
        )?
    }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_access_point::de_create_access_point(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_access_point::CreateAccessPointError::unhandled)?;
