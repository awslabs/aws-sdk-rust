...
> {
    ...
    .map_err(
        crate::operation::delete_access_point_policy::DeleteAccessPointPolicyError::unhandled,
    )?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::delete_access_point_policy::DeleteAccessPointPolicyError::generic(
            generic,
        ),
    )
}
