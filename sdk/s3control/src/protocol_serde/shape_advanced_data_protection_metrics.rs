...
pub fn ser_advanced_data_protection_metrics(input: &crate::types::AdvancedDataProtectionMetrics, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
