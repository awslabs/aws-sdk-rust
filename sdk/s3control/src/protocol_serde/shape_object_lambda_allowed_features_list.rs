...
pub fn de_object_lambda_allowed_features_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::ObjectLambdaAllowedFeature>, aws_smithy_xml::decode::XmlDecodeError> {
