...
pub fn ser_submit_multi_region_access_point_routes_input_input(input: &crate::input::SubmitMultiRegionAccessPointRoutesInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
