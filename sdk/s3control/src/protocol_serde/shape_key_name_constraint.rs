...
pub fn ser_key_name_constraint(input: &crate::types::KeyNameConstraint, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_key_name_constraint(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::KeyNameConstraint, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
