...
pub fn de_create_bucket_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_bucket::CreateBucketOutput, crate::operation::create_bucket::CreateBucketError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_bucket_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_bucket::CreateBucketOutput, crate::operation::create_bucket::CreateBucketError> {
    Ok({
        #[allow(unused_mut)]
    ...
    if let ::std::option::Option::Some(inner_9) = &input.grant_write {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("grant_write", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_13) = &input.object_lock_enabled_for_bucket {
        ...
        let formatted_14 = encoder.encode();
                        if !formatted_14.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("object_lock_enabled_for_bucket", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
