...
pub fn ser_selection_criteria(input: &crate::model::SelectionCriteria, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_selection_criteria(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SelectionCriteria, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
