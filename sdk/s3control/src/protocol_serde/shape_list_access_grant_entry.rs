...
pub fn de_list_access_grant_entry(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ListAccessGrantEntry, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
