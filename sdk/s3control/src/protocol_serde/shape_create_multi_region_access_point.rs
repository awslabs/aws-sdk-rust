...
#[allow(unused_mut)]
pub fn de_create_multi_region_access_point(
    inp: &[u8],
    mut builder: crate::operation::create_multi_region_access_point::builders::CreateMultiRegionAccessPointOutputBuilder,
) -> Result<
    crate::operation::create_multi_region_access_point::builders::CreateMultiRegionAccessPointOutputBuilder,
