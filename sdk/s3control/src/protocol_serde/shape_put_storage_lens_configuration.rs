...
pub fn de_put_storage_lens_configuration_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationOutput, crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationError> {
    #[allow(unused_mut)]
...
pub fn ser_put_storage_lens_configuration_op_input(input: &crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
