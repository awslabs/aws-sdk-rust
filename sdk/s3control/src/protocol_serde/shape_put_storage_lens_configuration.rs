...
pub fn de_put_storage_lens_configuration_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationOutput, crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_storage_lens_configuration_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationOutput, crate::operation::put_storage_lens_configuration::PutStorageLensConfigurationError> {
    Ok({
        #[allow(unused_mut)]
