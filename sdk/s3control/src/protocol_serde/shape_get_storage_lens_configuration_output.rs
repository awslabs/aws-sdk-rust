...
pub(crate) fn de_storage_lens_configuration_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::StorageLensConfiguration>, crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationError> {
    (!body.is_empty()).then(||{
