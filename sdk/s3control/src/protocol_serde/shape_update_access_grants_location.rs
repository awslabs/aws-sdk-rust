...
pub fn de_update_access_grants_location_http_error(
...
> {
    ...
    Err(crate::operation::update_access_grants_location::UpdateAccessGrantsLocationError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_update_access_grants_location_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_update_access_grants_location_op_input(
    ...
    let mut out = String::new();
    {
        ...
        #[allow(unused_mut)]
        let mut root = writer
            .start_el("UpdateAccessGrantsLocationRequest")
...
> {
    ...
    if !start_el.matches("UpdateAccessGrantsLocationResult") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected UpdateAccessGrantsLocationResult but got {start_el:?}. This is likely a bug in the SDK."
        )));
    }
