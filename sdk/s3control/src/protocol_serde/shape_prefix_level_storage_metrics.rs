...
pub fn ser_prefix_level_storage_metrics(input: &crate::types::PrefixLevelStorageMetrics, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
