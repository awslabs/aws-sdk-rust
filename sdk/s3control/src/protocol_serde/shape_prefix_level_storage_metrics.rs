...
pub fn ser_prefix_level_storage_metrics(input: &crate::model::PrefixLevelStorageMetrics, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_prefix_level_storage_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrefixLevelStorageMetrics, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
