...
pub fn ser_job_manifest_location(input: &crate::model::JobManifestLocation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_job_manifest_location(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobManifestLocation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
