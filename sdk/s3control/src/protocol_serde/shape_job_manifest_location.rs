...
pub fn ser_job_manifest_location(
    ...
    let mut scope = writer.finish();
    {
        ...
        inner_writer.data(input.object_arn.as_str());
    }
    ...
    }
    {
        ...
        inner_writer.data(input.e_tag.as_str());
    }
    scope.finish();
    Ok(())
}
...
pub fn de_job_manifest_location(
...
) -> ::std::result::Result<crate::types::JobManifestLocation, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::job_manifest_location_correct_errors(builder)
        .build()
