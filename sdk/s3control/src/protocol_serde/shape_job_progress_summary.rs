...
pub fn de_job_progress_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobProgressSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
