...
pub fn de_job_list_descriptor(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::JobListDescriptor, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
