...
pub fn de_get_access_point_policy_status_for_object_lambda_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_policy_status_for_object_lambda_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_access_point_policy_status_for_object_lambda::de_get_access_point_policy_status_for_object_lambda(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_access_point_policy_status_for_object_lambda::GetAccessPointPolicyStatusForObjectLambdaError::unhandled)?;
