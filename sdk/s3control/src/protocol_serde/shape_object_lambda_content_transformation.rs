...
pub fn ser_object_lambda_content_transformation(input: &crate::types::ObjectLambdaContentTransformation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::ObjectLambdaContentTransformation::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ObjectLambdaContentTransformation"))
    }
    Ok(())
}
