...
pub fn ser_noncurrent_version_transition(input: &crate::types::NoncurrentVersionTransition, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
