...
pub fn ser_lambda_invoke_operation(input: &crate::types::LambdaInvokeOperation, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
