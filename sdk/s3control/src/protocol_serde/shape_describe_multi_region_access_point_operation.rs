...
pub fn de_describe_multi_region_access_point_operation_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_multi_region_access_point_operation_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_multi_region_access_point_operation::de_describe_multi_region_access_point_operation(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_multi_region_access_point_operation::DescribeMultiRegionAccessPointOperationError::unhandled)?;
    ...
    if !start_el.matches("DescribeMultiRegionAccessPointOperationResult") {
        return Err(
                                ::aws_smithy_xml::decode::XmlDecodeError::custom(
                                    format!("encountered invalid XML root: expected DescribeMultiRegionAccessPointOperationResult but got {start_el:?}. This is likely a bug in the SDK.")
                                )
                            );
    }
