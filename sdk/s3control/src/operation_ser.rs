...
pub fn ser_payload_create_bucket_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(smithy_http::body::SdkBody::from(
        crate::xml_ser::serialize_member_com_amazonaws_s3control_synthetic_create_bucket_input_create_bucket_configuration(&payload).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_put_bucket_lifecycle_configuration_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(smithy_http::body::SdkBody::from(
        crate::xml_ser::serialize_member_com_amazonaws_s3control_synthetic_put_bucket_lifecycle_configuration_input_lifecycle_configuration(&payload).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_put_bucket_tagging_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(smithy_http::body::SdkBody::from(
        crate::xml_ser::serialize_member_com_amazonaws_s3control_synthetic_put_bucket_tagging_input_tagging(&payload).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
...
pub fn ser_payload_put_public_access_block_input(
    ...
    #[allow(clippy::useless_conversion)]Ok(smithy_http::body::SdkBody::from(
        crate::xml_ser::serialize_member_com_amazonaws_s3control_synthetic_put_public_access_block_input_public_access_block_configuration(&payload).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
    ))
}
