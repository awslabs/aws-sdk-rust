...
impl S3CopyObjectOperation {
    ...
    /// <p></p>
    pub fn modified_since_constraint(
        &self,
    ...
    /// <p></p>
    pub fn un_modified_since_constraint(
        &self,
    ) -> ::std::option::Option<&::aws_smithy_types::DateTime> {
...
impl S3CopyObjectOperationBuilder {
    ...
    /// <p></p>
    pub fn get_access_control_grants(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<crate::types::S3Grant>> {
    ...
    pub fn get_metadata_directive(
        &self,
    ) -> &::std::option::Option<crate::types::S3MetadataDirective> {
    ...
    /// <p></p>
    pub fn get_modified_since_constraint(
        &self,
    ) -> &::std::option::Option<::aws_smithy_types::DateTime> {
    ...
    /// <p>If you don't provide this parameter, Amazon S3 copies all the metadata from the original objects. If you specify an empty set, the new objects will have no tags. Otherwise, Amazon S3 assigns the supplied tags to the new objects.</p>
    pub fn get_new_object_metadata(
        &self,
    ) -> &::std::option::Option<crate::types::S3ObjectMetadata> {
    ...
    /// <p></p>
    pub fn get_new_object_tagging(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<crate::types::S3Tag>> {
    ...
    /// <p></p>
    pub fn get_un_modified_since_constraint(
        &self,
    ) -> &::std::option::Option<::aws_smithy_types::DateTime> {
    ...
    pub fn get_checksum_algorithm(
        &self,
    ) -> &::std::option::Option<crate::types::S3ChecksumAlgorithm> {
