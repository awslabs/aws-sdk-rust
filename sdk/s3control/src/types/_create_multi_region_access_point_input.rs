    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CreateMultiRegionAccessPointInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CreateMultiRegionAccessPointInput {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building CreateMultiRegionAccessPointInput")
                    )?
                ,
                ...
                regions: self.regions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("regions", "regions was not specified but it is required when building CreateMultiRegionAccessPointInput")
                    )?
                ,
            }
        )
