...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::set_account_id): <p>The Amazon Web Services account ID associated with the S3 Batch Operations job.</p>
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::set_job_id): <p>The ID for the S3 Batch Operations job whose tags you want to retrieve.</p>
