...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::set_account_id):<br>required: **true**<br><p>The Amazon Web Services account ID associated with the S3 Batch Operations job.</p><br>
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_job_tagging::builders::GetJobTaggingFluentBuilder::set_job_id):<br>required: **true**<br><p>The ID for the S3 Batch Operations job whose tags you want to retrieve.</p><br>
