...
impl super::Client  {
    ...
    pub fn get_access_point_policy_status_for_object_lambda(&self) -> crate::client::fluent_builders::GetAccessPointPolicyStatusForObjectLambda {
                                crate::client::fluent_builders::GetAccessPointPolicyStatusForObjectLambda::new(self.handle.clone())
                            }
}
