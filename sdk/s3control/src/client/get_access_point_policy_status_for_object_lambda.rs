...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::set_account_id):<br>required: **true**<br><p>The account ID for the account that owns the specified Object Lambda Access Point.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::set_name):<br>required: **true**<br><p>The name of the Object Lambda Access Point.</p><br>
