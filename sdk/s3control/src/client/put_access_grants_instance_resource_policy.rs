...
impl super::Client {
    ...
    pub fn put_access_grants_instance_resource_policy(&self) -> crate::operation::put_access_grants_instance_resource_policy::builders::PutAccessGrantsInstanceResourcePolicyFluentBuilder {
                                crate::operation::put_access_grants_instance_resource_policy::builders::PutAccessGrantsInstanceResourcePolicyFluentBuilder::new(self.handle.clone())
                            }
}
