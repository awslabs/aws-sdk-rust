...
impl super::Client {
    ...
    pub fn get_access_grants_instance_resource_policy(&self) -> crate::operation::get_access_grants_instance_resource_policy::builders::GetAccessGrantsInstanceResourcePolicyFluentBuilder {
                                crate::operation::get_access_grants_instance_resource_policy::builders::GetAccessGrantsInstanceResourcePolicyFluentBuilder::new(self.handle.clone())
                            }
}
