...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_bucket_policy::builders::GetBucketPolicyFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_bucket_policy::builders::GetBucketPolicyFluentBuilder::set_account_id): <p>The Amazon Web Services account ID of the Outposts bucket.</p>
