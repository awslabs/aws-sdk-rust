...
impl super::Client {
    ...
    ///   - [`config_id(impl Into<String>)`](crate::operation::get_storage_lens_configuration::builders::GetStorageLensConfigurationFluentBuilder::config_id) / [`set_config_id(Option<String>)`](crate::operation::get_storage_lens_configuration::builders::GetStorageLensConfigurationFluentBuilder::set_config_id):<br>required: **true**<br><p>The ID of the Amazon S3 Storage Lens configuration.</p><br>
