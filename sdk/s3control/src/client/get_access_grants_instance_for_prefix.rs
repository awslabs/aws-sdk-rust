...
impl super::Client {
    ...
    pub fn get_access_grants_instance_for_prefix(&self) -> crate::operation::get_access_grants_instance_for_prefix::builders::GetAccessGrantsInstanceForPrefixFluentBuilder {
