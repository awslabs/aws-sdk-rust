...
impl super::Client {
    ...
    ///   - [`job_statuses(JobStatus)`](crate::operation::list_jobs::builders::ListJobsFluentBuilder::job_statuses) / [`set_job_statuses(Option<Vec<JobStatus>>)`](crate::operation::list_jobs::builders::ListJobsFluentBuilder::set_job_statuses): <p>The <code>List Jobs</code> request returns jobs that match the statuses listed in this element.</p>
