...
impl super::Client  {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::delete_bucket::builders::DeleteBucketFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::delete_bucket::builders::DeleteBucketFluentBuilder::set_account_id): <p>The account ID that owns the Outposts bucket.</p>
