...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_access_points::builders::ListAccessPointsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_access_points::builders::ListAccessPointsFluentBuilder::set_max_results): <p>The maximum number of access points that you want to include in the list. If the specified bucket has more than this number of access points, then the response will include a continuation token in the <code>NextToken</code> field that you can use to retrieve the next page of access points.</p>
