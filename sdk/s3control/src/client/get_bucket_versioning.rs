...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::set_account_id): <p>The Amazon Web Services account ID of the S3 on Outposts bucket.</p>
    ///   - [`bucket(impl ::std::convert::Into<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::bucket) / [`set_bucket(Option<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::set_bucket): <p>The S3 on Outposts bucket to return the versioning state for.</p>
