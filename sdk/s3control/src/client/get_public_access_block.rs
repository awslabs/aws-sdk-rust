...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_public_access_block::builders::GetPublicAccessBlockFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_public_access_block::builders::GetPublicAccessBlockFluentBuilder::set_account_id):<br>required: **true**<br><p>The account ID for the Amazon Web Services account whose <code>PublicAccessBlock</code> configuration you want to retrieve.</p><br>
