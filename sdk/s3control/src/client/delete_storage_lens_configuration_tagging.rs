...
impl super::Client {
    ...
    ///   - [`config_id(impl Into<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::config_id) / [`set_config_id(Option<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::set_config_id):<br>required: **true**<br><p>The ID of the S3 Storage Lens configuration.</p><br>
    ///   - [`account_id(impl Into<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::set_account_id):<br>required: **true**<br><p>The account ID of the requester.</p><br>
