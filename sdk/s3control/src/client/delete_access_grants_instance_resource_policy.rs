...
impl super::Client {
    ...
    pub fn delete_access_grants_instance_resource_policy(&self) -> crate::operation::delete_access_grants_instance_resource_policy::builders::DeleteAccessGrantsInstanceResourcePolicyFluentBuilder {
                                crate::operation::delete_access_grants_instance_resource_policy::builders::DeleteAccessGrantsInstanceResourcePolicyFluentBuilder::new(self.handle.clone())
                            }
}
