...
impl super::Client  {
    ...
    pub fn get_multi_region_access_point_policy_status(&self) -> crate::client::fluent_builders::GetMultiRegionAccessPointPolicyStatus {
                                crate::client::fluent_builders::GetMultiRegionAccessPointPolicyStatus::new(self.handle.clone())
                            }
}
