...
#[allow(clippy::needless_borrow)]out.push_str(&access_point_arn.region());
out.push_str("` does not match client region `");
#[allow(clippy::needless_borrow)]out.push_str(&region);
...
,false, _diagnostic_collector) {
                                #[allow(unused)]if let Some(account_id) = account_id { if !((account_id) == (access_point_arn.account_id())) {
                                return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
out.push_str("Invalid ARN: the accountId specified in the ARN (`");
#[allow(clippy::needless_borrow)]out.push_str(&access_point_arn.account_id());
out.push_str("`) does not match the parameter (`");
#[allow(clippy::needless_borrow)]out.push_str(&account_id);
out.push_str("`)");
out }));
                            } }
#[allow(unused)]if let Some(outpost_type) = access_point_arn.resource_id()
.get(2).cloned() { #[allow(unused)]if let Some(access_point_name) = access_point_arn.resource_id()
...
#[allow(clippy::needless_borrow)]out.push_str(&access_point_arn.region());
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&arn_partition.dns_suffix());
out })
...
#[allow(unused)]if let Some(endpoint) = endpoint { #[allow(unused)]if let Some(url) = crate::endpoint_lib::parse_url::parse_url(endpoint, _diagnostic_collector) { return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
#[allow(clippy::needless_borrow)]out.push_str(&url.scheme());
out.push_str("://");
#[allow(clippy::needless_borrow)]out.push_str(&url.authority());
#[allow(clippy::needless_borrow)]out.push_str(&url.path());
out })
.header("x-amz-account-id", access_point_arn.account_id()
.to_owned())
.header("x-amz-outpost-id", outpost_id.to_owned())
...
#[allow(clippy::needless_borrow)]out.push_str(&outpost_type);
out.push('`');
out })); }
...
#[allow(clippy::needless_borrow)]out.push_str(&partition_result.name());
out.push_str("` but ARN has `");
#[allow(clippy::needless_borrow)]out.push_str(&arn_partition.name());
out.push('`');
out }));
                                        }
                                        return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
                                    ...
                                    if let Some(use_arn_region) = use_arn_region {
                                        if (*use_arn_region) == (false) {
                                            if !((bucket_arn.region()) == (region)) {
                                                return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
out.push_str("Invalid configuration: region from ARN `");
#[allow(clippy::needless_borrow)]out.push_str(&bucket_arn.region());
out.push_str("` does not match client region `");
#[allow(clippy::needless_borrow)]out.push_str(&region);
out.push_str("` and UseArnRegion is `false`");
out }));
...
,false, _diagnostic_collector) {
                                #[allow(unused)]if let Some(account_id) = account_id { if !((account_id) == (bucket_arn.account_id())) {
                                return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
out.push_str("Invalid ARN: the accountId specified in the ARN (`");
#[allow(clippy::needless_borrow)]out.push_str(&bucket_arn.account_id());
out.push_str("`) does not match the parameter (`");
#[allow(clippy::needless_borrow)]out.push_str(&account_id);
out.push_str("`)");
out }));
                            } }
#[allow(unused)]if let Some(outpost_type) = bucket_arn.resource_id()
.get(2).cloned() { #[allow(unused)]if let Some(bucket_name) = bucket_arn.resource_id()
