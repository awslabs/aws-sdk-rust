...
impl crate::operation::get_storage_lens_configuration::builders::GetStorageLensConfigurationInputBuilder {
...
impl GetStorageLensConfigurationFluentBuilder {
    /// Creates a new `GetStorageLensConfigurationFluentBuilder`.
