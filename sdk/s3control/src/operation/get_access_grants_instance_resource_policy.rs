...
impl GetAccessGrantsInstanceResourcePolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAccessGrantsInstanceResourcePolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAccessGrantsInstanceResourcePolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAccessGrantsInstanceResourcePolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAccessGrantsInstanceResourcePolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAccessGrantsInstanceResourcePolicy")
...
.with_interceptor(GetAccessGrantsInstanceResourcePolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_access_grants_instance_resource_policy::de_get_access_grants_instance_resource_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_access_grants_instance_resource_policy::de_get_access_grants_instance_resource_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetAccessGrantsInstanceResourcePolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAccessGrantsInstanceResourcePolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_access_grants_instance_resource_policy::GetAccessGrantsInstanceResourcePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_get_access_grants_instance_resource_policy::ser_get_access_grants_instance_resource_policy_headers(input, builder)?;
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAccessGrantsInstanceResourcePolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAccessGrantsInstanceResourcePolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAccessGrantsInstanceResourcePolicyInput>()
                        .ok_or("failed to downcast to GetAccessGrantsInstanceResourcePolicyInput")?;
...
pub enum GetAccessGrantsInstanceResourcePolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAccessGrantsInstanceResourcePolicyError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetAccessGrantsInstanceResourcePolicyError {
    /// Creates the `GetAccessGrantsInstanceResourcePolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAccessGrantsInstanceResourcePolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for GetAccessGrantsInstanceResourcePolicyError {
...
impl ::std::fmt::Display for GetAccessGrantsInstanceResourcePolicyError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetAccessGrantsInstanceResourcePolicyError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetAccessGrantsInstanceResourcePolicyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAccessGrantsInstanceResourcePolicyError {
