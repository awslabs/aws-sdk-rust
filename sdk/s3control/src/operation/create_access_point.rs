...
impl CreateAccessPoint {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3 Control", "CreateAccessPoint", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAccessPointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("BucketAccountId") {
            if let ::std::option::Option::Some(value) = input.bucket_account_id.as_deref() {
                captured.insert("BucketAccountId", value);
            }
        }
