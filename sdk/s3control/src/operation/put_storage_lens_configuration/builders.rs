...
impl crate::operation::put_storage_lens_configuration::builders::PutStorageLensConfigurationInputBuilder {
...
impl PutStorageLensConfigurationFluentBuilder {
    /// Creates a new `PutStorageLensConfigurationFluentBuilder`.
