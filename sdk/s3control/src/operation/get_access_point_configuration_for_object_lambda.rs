...
impl GetAccessPointConfigurationForObjectLambdaInput {
    /// Consumes the builder and constructs an Operation<[`GetAccessPointConfigurationForObjectLambda`](crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v20180820/accesspointforobjectlambda/{Name}/configuration", Name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAccessPointConfigurationForObjectLambda", "s3control"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccessPointConfigurationForObjectLambda {
                type Output = std::result::Result<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaOutput, crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_access_point_configuration_for_object_lambda::de_get_access_point_configuration_for_object_lambda_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_access_point_configuration_for_object_lambda::de_get_access_point_configuration_for_object_lambda_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaError {
