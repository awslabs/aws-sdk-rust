    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/jobs/{JobId}", JobId = job_id)
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_describe_job::ser_describe_job_headers(
                    input, builder,
                )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_job::DescribeJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_job::de_describe_job_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_job::de_describe_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
