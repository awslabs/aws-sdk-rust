...
impl GetAccessPointConfigurationForObjectLambdaFluentBuilder {
    /// Creates a new `GetAccessPointConfigurationForObjectLambdaFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
