...
impl GetAccessPointConfigurationForObjectLambdaInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
    >{
        let mut fluent_builder = client.get_access_point_configuration_for_object_lambda();
...
impl GetAccessPointConfigurationForObjectLambdaFluentBuilder {
    ...
    /// Access the GetAccessPointConfigurationForObjectLambda as a reference.
    pub fn as_input(&self) -> &crate::operation::get_access_point_configuration_for_object_lambda::builders::GetAccessPointConfigurationForObjectLambdaInputBuilder{
        &self.inner
    }
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambda, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaError>
    >{
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaError>>
                         {
        let op = self
            .inner
            .build()
    ...
    /// set when configuring the client.
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_access_point_configuration_for_object_lambda::GetAccessPointConfigurationForObjectLambdaError>>
                             {
