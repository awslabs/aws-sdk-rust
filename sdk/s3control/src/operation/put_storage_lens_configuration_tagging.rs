...
impl PutStorageLensConfigurationTaggingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_storage_lens_configuration_tagging::PutStorageLensConfigurationTagging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutStorageLensConfigurationTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_storage_lens_configuration_tagging::de_put_storage_lens_configuration_tagging_http_response_with_props(
                status, headers, body,
            )
        }
    }
