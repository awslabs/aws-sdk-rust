...
impl ListTagsForResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("s3control", "ListTagsForResource", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListTagsForResource", "s3control"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_list_tags_for_resource::ser_list_tags_for_resource_headers(input, builder)?;
