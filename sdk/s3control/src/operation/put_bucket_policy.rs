    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/bucket/{Bucket}/policy", Bucket = bucket)
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_put_bucket_policy::ser_put_bucket_policy_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_policy::PutBucketPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_bucket_policy::de_put_bucket_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_bucket_policy::PutBucketPolicyError
{
