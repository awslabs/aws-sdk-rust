...
impl GetMultiRegionAccessPointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointOutput, crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError, Self> {
