...
impl crate::operation::list_access_points_for_object_lambda::builders::ListAccessPointsForObjectLambdaInputBuilder {
...
impl ListAccessPointsForObjectLambdaFluentBuilder {
    /// Creates a new `ListAccessPointsForObjectLambdaFluentBuilder`.
