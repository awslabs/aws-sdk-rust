...
impl ListAccessPointsForObjectLambdaInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_access_points_for_object_lambda::ListAccessPointsForObjectLambdaInput, ::aws_smithy_types::error::operation::BuildError> {
