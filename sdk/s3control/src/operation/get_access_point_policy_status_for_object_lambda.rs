...
impl ::aws_smithy_http::response::ParseStrictResponse
    for GetAccessPointPolicyStatusForObjectLambda
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_access_point_policy_status_for_object_lambda::de_get_access_point_policy_status_for_object_lambda_http_response_with_props(status, headers, body)
        }
    }
}
