...
pub struct UpdateAccessGrantsLocationOutput {
    ...
    /// <p>The S3 URI path of the location that you are updating. You cannot update the scope of the registered location. The location scope can be the default S3 location <code>s3://</code>, the S3 path to a bucket <code>s3://<bucket></bucket></code>, or the S3 path to a bucket and prefix <code>s3://<bucket>
    /// /
    /// <prefix></prefix>
    /// </bucket></code>.</p>
...
impl ::aws_types::request_id::RequestId for UpdateAccessGrantsLocationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateAccessGrantsLocationOutput {
    /// Creates a new builder-style object to manufacture [`UpdateAccessGrantsLocationOutput`](crate::operation::update_access_grants_location::UpdateAccessGrantsLocationOutput).
    pub fn builder() -> crate::operation::update_access_grants_location::builders::UpdateAccessGrantsLocationOutputBuilder {
        crate::operation::update_access_grants_location::builders::UpdateAccessGrantsLocationOutputBuilder::default()
    }
}
...
impl UpdateAccessGrantsLocationOutputBuilder {
    /// <p>The date and time when you registered the location.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateAccessGrantsLocationOutput`](crate::operation::update_access_grants_location::UpdateAccessGrantsLocationOutput).
    pub fn build(self) -> crate::operation::update_access_grants_location::UpdateAccessGrantsLocationOutput {
