    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/async-requests/mrap/create")
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateMultiRegionAccessPointError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointError
{
