...
impl DeleteAccessGrantFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_access_grant::DeleteAccessGrantOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_access_grant::DeleteAccessGrantError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_access_grant::DeleteAccessGrantOutput, crate::operation::delete_access_grant::DeleteAccessGrantError, Self> {
