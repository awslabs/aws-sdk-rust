...
impl DeleteAccessGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_access_grant::DeleteAccessGrantInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_access_grant::DeleteAccessGrantInput {
