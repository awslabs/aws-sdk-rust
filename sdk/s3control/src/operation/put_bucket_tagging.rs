...
impl PutBucketTaggingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bucket_tagging_input::ser_tagging_http_payload(
                &self.tagging,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_tagging::PutBucketTagging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_bucket_tagging::de_put_bucket_tagging_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_bucket_tagging::de_put_bucket_tagging_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_bucket_tagging::PutBucketTaggingError
{
