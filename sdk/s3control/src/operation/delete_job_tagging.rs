...
impl DeleteJobTaggingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_job_tagging::DeleteJobTagging,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteJobTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_job_tagging::de_delete_job_tagging_http_response_with_props(status, headers, body)
        }
    }
}
