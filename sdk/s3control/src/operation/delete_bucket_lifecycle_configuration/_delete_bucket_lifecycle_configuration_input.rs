...
impl DeleteBucketLifecycleConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
