...
impl DeleteBucketLifecycleConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationOutput, crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationError, Self> {
