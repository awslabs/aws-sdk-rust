...
impl UpdateJobPriorityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_job_priority::UpdateJobPriorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_job_priority::UpdateJobPriorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_job_priority::UpdateJobPriorityOutput, crate::operation::update_job_priority::UpdateJobPriorityError, Self> {
