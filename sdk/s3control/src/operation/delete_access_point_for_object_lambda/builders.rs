...
impl DeleteAccessPointForObjectLambdaFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> std::result::Result<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaOutput, aws_smithy_http::result::SdkError<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError>>
                     {
        let op = self
            .inner
            .build()
