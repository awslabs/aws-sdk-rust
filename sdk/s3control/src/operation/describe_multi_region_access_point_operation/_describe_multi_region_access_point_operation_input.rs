...
impl DescribeMultiRegionAccessPointOperationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_multi_region_access_point_operation::DescribeMultiRegionAccessPointOperationInput, ::aws_smithy_types::error::operation::BuildError> {
