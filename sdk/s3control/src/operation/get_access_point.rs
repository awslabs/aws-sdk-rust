...
impl GetAccessPoint {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3 Control", "GetAccessPoint", input, runtime_plugins, stop_point).await
    }
