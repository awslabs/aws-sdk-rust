...
impl ListStorageLensConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_storage_lens_configurations::ListStorageLensConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStorageLensConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_storage_lens_configurations::de_list_storage_lens_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
