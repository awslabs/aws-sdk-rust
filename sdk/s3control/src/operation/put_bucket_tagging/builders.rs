...
/// <ul>
/// <li>
/// <p>Error code: <code>InvalidTagError</code></p>
/// <ul>
/// <li>
...
/// </ul></li>
/// <li>
/// <p>Error code: <code>MalformedXMLError</code></p>
/// <ul>
/// <li>
/// <p>Description: The XML provided does not match the schema.</p></li>
/// </ul></li>
/// <li>
/// <p>Error code: <code>OperationAbortedError </code></p>
/// <ul>
/// <li>
/// <p>Description: A conflicting conditional action is currently in progress against this resource. Try again.</p></li>
/// </ul></li>
/// <li>
/// <p>Error code: <code>InternalError</code></p>
/// <ul>
/// <li>
/// <p>Description: The service was unable to apply the provided tag to the bucket.</p></li>
/// </ul></li>
/// </ul>
