...
impl GetStorageLensConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_storage_lens_configuration::GetStorageLensConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStorageLensConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_storage_lens_configuration::de_get_storage_lens_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
