    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetStorageLensConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetStorageLensConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("config_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetStorageLensConfigurationEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let params = crate::config::endpoint::Params::builder()
            ...
            .set_account_id(_input.account_id.clone())
            .build()
            .map_err(|err| {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_storage_lens_configuration::GetStorageLensConfigurationError {
