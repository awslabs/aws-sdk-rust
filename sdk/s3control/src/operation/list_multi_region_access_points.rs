...
impl ListMultiRegionAccessPointsInput {
    ...
    > {
        ...
        request = request.augment(|mut req, _| {
            let data = req.body().bytes().expect("checksum can only be computed for non-streaming operations");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_multi_region_access_points::ListMultiRegionAccessPoints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMultiRegionAccessPoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_multi_region_access_points::de_list_multi_region_access_points_http_response_with_props(
                status, headers, body,
            )
        }
    }
