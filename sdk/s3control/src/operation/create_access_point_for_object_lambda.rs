...
impl CreateAccessPointForObjectLambdaInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambda,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambda::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccessPointForObjectLambda {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_access_point_for_object_lambda::de_create_access_point_for_object_lambda_http_response_with_props(
                status, headers, body,
            )
        }
    }
