...
impl CreateAccessPointForObjectLambda {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambdaError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambdaOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateAccessPointForObjectLambda",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAccessPointForObjectLambda {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateAccessPointForObjectLambdaRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateAccessPointForObjectLambdaResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateAccessPointForObjectLambda")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAccessPointForObjectLambda")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateAccessPointForObjectLambdaTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateAccessPointForObjectLambdaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAccessPointForObjectLambdaTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateAccessPointForObjectLambdaInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccessPointForObjectLambdaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_access_point_for_object_lambda::de_create_access_point_for_object_lambda_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_access_point_for_object_lambda::de_create_access_point_for_object_lambda_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccessPointForObjectLambdaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambdaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_access_point_for_object_lambda::CreateAccessPointForObjectLambdaInput,
