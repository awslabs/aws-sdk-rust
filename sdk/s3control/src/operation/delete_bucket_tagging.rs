...
impl DeleteBucketTagging {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3 Control", "DeleteBucketTagging", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketTaggingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_bucket_tagging::de_delete_bucket_tagging_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_bucket_tagging::de_delete_bucket_tagging_http_response(status, headers, body, _cfg)
        };
