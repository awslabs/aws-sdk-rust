...
impl DeleteBucketTaggingInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_bucket_tagging::DeleteBucketTagging::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBucketTagging {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_bucket_tagging::de_delete_bucket_tagging_http_response_with_props(status, headers, body)
        }
    }
}
