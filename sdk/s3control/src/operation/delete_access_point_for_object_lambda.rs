...
impl DeleteAccessPointForObjectLambda {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAccessPointForObjectLambda {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAccessPointForObjectLambda");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAccessPointForObjectLambdaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAccessPointForObjectLambdaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAccessPointForObjectLambda")
...
.with_interceptor(DeleteAccessPointForObjectLambdaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_access_point_for_object_lambda::de_delete_access_point_for_object_lambda_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteAccessPointForObjectLambdaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAccessPointForObjectLambdaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambdaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteAccessPointForObjectLambdaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAccessPointForObjectLambdaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAccessPointForObjectLambdaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAccessPointForObjectLambdaInput>()
                        .ok_or("failed to downcast to DeleteAccessPointForObjectLambdaInput")?;
...
pub enum DeleteAccessPointForObjectLambdaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAccessPointForObjectLambdaError) for what information is available for the error.")]
...
impl DeleteAccessPointForObjectLambdaError {
    /// Creates the `DeleteAccessPointForObjectLambdaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAccessPointForObjectLambdaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAccessPointForObjectLambdaError {
