...
impl DeleteAccessPointForObjectLambdaInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_access_point_for_object_lambda::DeleteAccessPointForObjectLambda::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessPointForObjectLambda {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_access_point_for_object_lambda::de_delete_access_point_for_object_lambda_http_response_with_props(
                status, headers, body,
            )
        }
    }
