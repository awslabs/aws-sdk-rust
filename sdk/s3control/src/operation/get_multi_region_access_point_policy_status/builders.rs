...
pub use crate::operation::get_multi_region_access_point_policy_status::_get_multi_region_access_point_policy_status_output::GetMultiRegionAccessPointPolicyStatusOutputBuilder;
...
impl GetMultiRegionAccessPointPolicyStatusFluentBuilder {
    ...
    /// Access the GetMultiRegionAccessPointPolicyStatus as a reference.
    pub fn as_input(&self) -> &crate::operation::get_multi_region_access_point_policy_status::builders::GetMultiRegionAccessPointPolicyStatusInputBuilder{
        &self.inner
    }
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatus, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusError>
    >{
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusError>>
                         {
        let op = self
            .inner
            .build()
    ...
    /// set when configuring the client.
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatusError>>
                             {
