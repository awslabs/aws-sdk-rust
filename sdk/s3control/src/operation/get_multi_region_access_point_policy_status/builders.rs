...
impl crate::operation::get_multi_region_access_point_policy_status::builders::GetMultiRegionAccessPointPolicyStatusInputBuilder {
...
impl GetMultiRegionAccessPointPolicyStatusFluentBuilder {
    /// Creates a new `GetMultiRegionAccessPointPolicyStatusFluentBuilder`.
    ...
    > {
        ...
        crate::operation::get_multi_region_access_point_policy_status::GetMultiRegionAccessPointPolicyStatus::orchestrate(&runtime_plugins, input)
            .await
    }
