...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccessPointForObjectLambda {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_access_point_for_object_lambda::de_get_access_point_for_object_lambda_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError
{
