...
impl GetStorageLensConfigurationTaggingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTaggingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTaggingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTaggingOutput, crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTaggingError, Self> {
