...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutAccessPointConfigurationForObjectLambdaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_access_point_configuration_for_object_lambda::ser_put_access_point_configuration_for_object_lambda_op_input(&input)?);
