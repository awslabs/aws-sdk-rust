...
impl PutAccessPointConfigurationForObjectLambda {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambdaError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambdaOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "PutAccessPointConfigurationForObjectLambda",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAccessPointConfigurationForObjectLambda {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutAccessPointConfigurationForObjectLambdaRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutAccessPointConfigurationForObjectLambdaResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutAccessPointConfigurationForObjectLambda")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutAccessPointConfigurationForObjectLambda")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    PutAccessPointConfigurationForObjectLambdaTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutAccessPointConfigurationForObjectLambdaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutAccessPointConfigurationForObjectLambdaTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutAccessPointConfigurationForObjectLambdaInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutAccessPointConfigurationForObjectLambdaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_access_point_configuration_for_object_lambda::de_put_access_point_configuration_for_object_lambda_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_access_point_configuration_for_object_lambda::de_put_access_point_configuration_for_object_lambda_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutAccessPointConfigurationForObjectLambdaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambdaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambdaInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambdaError
{
