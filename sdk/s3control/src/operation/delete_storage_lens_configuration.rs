...
impl DeleteStorageLensConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_storage_lens_configuration::DeleteStorageLensConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_storage_lens_configuration::DeleteStorageLensConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStorageLensConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_storage_lens_configuration::de_delete_storage_lens_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
