...
impl GetMultiRegionAccessPointRoutesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_multi_region_access_point_routes::GetMultiRegionAccessPointRoutesInput, ::aws_smithy_types::error::operation::BuildError> {
