...
impl PutMultiRegionAccessPointPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMultiRegionAccessPointPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutMultiRegionAccessPointPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutMultiRegionAccessPointPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutMultiRegionAccessPointPolicyResponseDeserializer));
...
.with_interceptor(PutMultiRegionAccessPointPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError>::new());
...
#[derive(Debug)]
            struct PutMultiRegionAccessPointPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMultiRegionAccessPointPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_multi_region_access_point_policy::ser_put_multi_region_access_point_policy_op_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutMultiRegionAccessPointPolicyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutMultiRegionAccessPointPolicyInput>()
                        .ok_or("failed to downcast to PutMultiRegionAccessPointPolicyInput")?;
...
pub enum PutMultiRegionAccessPointPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutMultiRegionAccessPointPolicyError) for what information is available for the error.")]
...
impl PutMultiRegionAccessPointPolicyError {
    /// Creates the `PutMultiRegionAccessPointPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutMultiRegionAccessPointPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutMultiRegionAccessPointPolicyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutMultiRegionAccessPointPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicyError {
