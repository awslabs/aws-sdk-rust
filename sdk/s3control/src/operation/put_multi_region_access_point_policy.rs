...
impl PutMultiRegionAccessPointPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_multi_region_access_point_policy::PutMultiRegionAccessPointPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMultiRegionAccessPointPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_multi_region_access_point_policy::de_put_multi_region_access_point_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
