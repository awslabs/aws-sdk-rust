...
impl ListAccessPointsForObjectLambdaInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_access_points_for_object_lambda::ListAccessPointsForObjectLambda::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccessPointsForObjectLambda {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_access_points_for_object_lambda::de_list_access_points_for_object_lambda_http_response_with_props(
                status, headers, body,
            )
        }
    }
