...
impl PutJobTaggingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_job_tagging::PutJobTagging, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_job_tagging::ser_put_job_tagging_op_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutJobTagging {
    type Output =
        ::std::result::Result<crate::operation::put_job_tagging::PutJobTaggingOutput, crate::operation::put_job_tagging::PutJobTaggingError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_job_tagging::de_put_job_tagging_http_response_with_props(status, headers, body)
        }
    }
}
