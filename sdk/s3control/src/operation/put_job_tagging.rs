    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/jobs/{JobId}/tagging", JobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_job_tagging::PutJobTagging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutJobTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_job_tagging::de_put_job_tagging_http_error(
                status, headers, body,
            )
        } else {
