...
impl UpdateJobStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_job_status::UpdateJobStatus, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobStatus {
    type Output =
        ::std::result::Result<crate::operation::update_job_status::UpdateJobStatusOutput, crate::operation::update_job_status::UpdateJobStatusError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_job_status::de_update_job_status_http_response_with_props(status, headers, body)
        }
    }
}
