    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/jobs/{JobId}/status", JobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_job_status::UpdateJobStatus::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_job_status::UpdateJobStatusError
{
