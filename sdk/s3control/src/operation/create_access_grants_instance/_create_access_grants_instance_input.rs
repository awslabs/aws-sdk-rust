...
impl CreateAccessGrantsInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_access_grants_instance::CreateAccessGrantsInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
