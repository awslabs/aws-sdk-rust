...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMultiRegionAccessPointOperation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_multi_region_access_point_operation::de_describe_multi_region_access_point_operation_http_response_with_props(status, headers, body)
        }
    }
}
