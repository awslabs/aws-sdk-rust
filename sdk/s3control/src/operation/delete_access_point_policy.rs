...
impl DeleteAccessPointPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccessPointPolicy`](crate::operation::delete_access_point_policy::DeleteAccessPointPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_access_point_policy::DeleteAccessPointPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_access_point_policy::DeleteAccessPointPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v20180820/accesspoint/{Name}/policy", Name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_access_point_policy::DeleteAccessPointPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAccessPointPolicy", "s3control"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAccessPointPolicy {
                type Output = std::result::Result<crate::operation::delete_access_point_policy::DeleteAccessPointPolicyOutput, crate::operation::delete_access_point_policy::DeleteAccessPointPolicyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_access_point_policy::de_delete_access_point_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_access_point_policy::de_delete_access_point_policy_http_response(response)
                     }
                }
            }
