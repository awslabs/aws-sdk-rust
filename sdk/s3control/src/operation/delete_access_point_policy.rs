    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/accesspoint/{Name}/policy", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_access_point_policy::DeleteAccessPointPolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_access_point_policy::DeleteAccessPointPolicyError
{
