...
impl GetMultiRegionAccessPointRoutesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_multi_region_access_point_routes::GetMultiRegionAccessPointRoutes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMultiRegionAccessPointRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_multi_region_access_point_routes::de_get_multi_region_access_point_routes_http_response_with_props(
                status, headers, body,
            )
        }
    }
