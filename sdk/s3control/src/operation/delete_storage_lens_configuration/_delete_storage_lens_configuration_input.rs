...
impl DeleteStorageLensConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_storage_lens_configuration::DeleteStorageLensConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
