...
impl AssociateAccessGrantsIdentityCenter {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateAccessGrantsIdentityCenter {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateAccessGrantsIdentityCenter");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateAccessGrantsIdentityCenterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateAccessGrantsIdentityCenterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateAccessGrantsIdentityCenter")
...
.with_interceptor(AssociateAccessGrantsIdentityCenterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_access_grants_identity_center::de_associate_access_grants_identity_center_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_access_grants_identity_center::de_associate_access_grants_identity_center_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateAccessGrantsIdentityCenterRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateAccessGrantsIdentityCenterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_access_grants_identity_center::AssociateAccessGrantsIdentityCenterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_associate_access_grants_identity_center::ser_associate_access_grants_identity_center_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_access_grants_identity_center::ser_associate_access_grants_identity_center_op_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateAccessGrantsIdentityCenterEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateAccessGrantsIdentityCenterInput>()
                        .ok_or("failed to downcast to AssociateAccessGrantsIdentityCenterInput")?;
...
pub enum AssociateAccessGrantsIdentityCenterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateAccessGrantsIdentityCenterError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl AssociateAccessGrantsIdentityCenterError {
    /// Creates the `AssociateAccessGrantsIdentityCenterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateAccessGrantsIdentityCenterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for AssociateAccessGrantsIdentityCenterError {
...
impl ::std::fmt::Display for AssociateAccessGrantsIdentityCenterError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for AssociateAccessGrantsIdentityCenterError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateAccessGrantsIdentityCenterError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateAccessGrantsIdentityCenterError {
