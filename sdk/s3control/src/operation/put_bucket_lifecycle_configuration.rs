...
impl PutBucketLifecycleConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketLifecycleConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bucket_lifecycle_configuration::de_put_bucket_lifecycle_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
