...
impl GetAccessGrantsLocationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_access_grants_location::GetAccessGrantsLocationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput, crate::operation::get_access_grants_location::GetAccessGrantsLocationError, Self> {
