...
/// Orchestration and serialization glue logic for `UpdateStorageLensGroup`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateStorageLensGroup;
impl UpdateStorageLensGroup {
    /// Creates a new `UpdateStorageLensGroup`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_storage_lens_group::UpdateStorageLensGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_storage_lens_group::UpdateStorageLensGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateStorageLensGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateStorageLensGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateStorageLensGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateStorageLensGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateStorageLensGroup")
...
.with_interceptor(UpdateStorageLensGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupError>::new());
...
#[derive(Debug)]
            struct UpdateStorageLensGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateStorageLensGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_update_storage_lens_group::de_update_storage_lens_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_storage_lens_group::de_update_storage_lens_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateStorageLensGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateStorageLensGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_storage_lens_group::UpdateStorageLensGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_storage_lens_group::UpdateStorageLensGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_storage_lens_group::ser_update_storage_lens_group_op_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateStorageLensGroupEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateStorageLensGroupInput>()
                        .ok_or("failed to downcast to UpdateStorageLensGroupInput")?;
...
pub enum UpdateStorageLensGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateStorageLensGroupError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateStorageLensGroupError {
    /// Creates the `UpdateStorageLensGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateStorageLensGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for UpdateStorageLensGroupError {
...
impl ::std::fmt::Display for UpdateStorageLensGroupError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateStorageLensGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateStorageLensGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateStorageLensGroupError {
