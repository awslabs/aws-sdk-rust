...
impl GetAccessPointPolicyStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccessPointPolicyStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_access_point_policy_status::de_get_access_point_policy_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
