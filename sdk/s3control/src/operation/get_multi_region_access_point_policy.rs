...
impl GetMultiRegionAccessPointPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_multi_region_access_point_policy::GetMultiRegionAccessPointPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_multi_region_access_point_policy::GetMultiRegionAccessPointPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMultiRegionAccessPointPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_multi_region_access_point_policy::de_get_multi_region_access_point_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
