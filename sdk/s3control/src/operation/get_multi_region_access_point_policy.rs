...
impl GetMultiRegionAccessPointPolicy {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_multi_region_access_point_policy::GetMultiRegionAccessPointPolicyOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetMultiRegionAccessPointPolicyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetMultiRegionAccessPointPolicyRequestSerializer {
