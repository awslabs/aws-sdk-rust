...
impl GetStorageLensConfigurationTaggingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTagging,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_storage_lens_configuration_tagging::GetStorageLensConfigurationTagging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStorageLensConfigurationTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_storage_lens_configuration_tagging::de_get_storage_lens_configuration_tagging_http_response_with_props(
                status, headers, body,
            )
        }
    }
