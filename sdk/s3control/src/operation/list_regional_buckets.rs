...
impl ListRegionalBucketsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_regional_buckets::ListRegionalBuckets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRegionalBuckets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_regional_buckets::de_list_regional_buckets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_regional_buckets::ListRegionalBucketsError
{
