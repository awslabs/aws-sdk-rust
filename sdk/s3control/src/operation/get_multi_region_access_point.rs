    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/mrap/instances/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_multi_region_access_point::GetMultiRegionAccessPoint::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError
{
