    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/configuration/publicAccessBlock")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_public_access_block::PutPublicAccessBlock::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutPublicAccessBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_public_access_block::de_put_public_access_block_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_public_access_block::PutPublicAccessBlockError
{
