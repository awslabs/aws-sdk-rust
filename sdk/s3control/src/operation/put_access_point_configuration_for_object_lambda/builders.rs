...
impl PutAccessPointConfigurationForObjectLambdaFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambda::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::put_access_point_configuration_for_object_lambda::PutAccessPointConfigurationForObjectLambda::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
