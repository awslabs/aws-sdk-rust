...
impl CreateStorageLensGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_storage_lens_group::CreateStorageLensGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_storage_lens_group::CreateStorageLensGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_storage_lens_group::CreateStorageLensGroupOutput, crate::operation::create_storage_lens_group::CreateStorageLensGroupError, Self> {
