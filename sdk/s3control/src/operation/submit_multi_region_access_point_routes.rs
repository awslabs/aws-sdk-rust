...
impl SubmitMultiRegionAccessPointRoutesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::submit_multi_region_access_point_routes::SubmitMultiRegionAccessPointRoutes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubmitMultiRegionAccessPointRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_submit_multi_region_access_point_routes::de_submit_multi_region_access_point_routes_http_response_with_props(
                status, headers, body,
            )
        }
    }
