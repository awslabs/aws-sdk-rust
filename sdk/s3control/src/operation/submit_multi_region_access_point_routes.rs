...
impl SubmitMultiRegionAccessPointRoutes {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::submit_multi_region_access_point_routes::SubmitMultiRegionAccessPointRoutesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::submit_multi_region_access_point_routes::SubmitMultiRegionAccessPointRoutesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "SubmitMultiRegionAccessPointRoutes",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SubmitMultiRegionAccessPointRoutes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SubmitMultiRegionAccessPointRoutesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SubmitMultiRegionAccessPointRoutesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SubmitMultiRegionAccessPointRoutes")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SubmitMultiRegionAccessPointRoutes")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SubmitMultiRegionAccessPointRoutesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SubmitMultiRegionAccessPointRoutesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SubmitMultiRegionAccessPointRoutesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SubmitMultiRegionAccessPointRoutesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubmitMultiRegionAccessPointRoutesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_submit_multi_region_access_point_routes::de_submit_multi_region_access_point_routes_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SubmitMultiRegionAccessPointRoutesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::submit_multi_region_access_point_routes::SubmitMultiRegionAccessPointRoutesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::submit_multi_region_access_point_routes::SubmitMultiRegionAccessPointRoutesInput,
