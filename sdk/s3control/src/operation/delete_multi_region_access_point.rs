...
impl DeleteMultiRegionAccessPointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMultiRegionAccessPoint`](crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteMultiRegionAccessPoint {
                type Output = std::result::Result<crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPointOutput, crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPointError>;
