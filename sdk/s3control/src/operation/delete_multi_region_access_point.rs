...
impl DeleteMultiRegionAccessPointInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_multi_region_access_point::DeleteMultiRegionAccessPoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMultiRegionAccessPoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_multi_region_access_point::de_delete_multi_region_access_point_http_response_with_props(
                status, headers, body,
            )
        }
    }
