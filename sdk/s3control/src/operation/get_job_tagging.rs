...
impl GetJobTaggingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_job_tagging::GetJobTagging,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_job_tagging::GetJobTagging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobTagging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_job_tagging::de_get_job_tagging_http_error(
                status, headers, body,
            )
        } else {
