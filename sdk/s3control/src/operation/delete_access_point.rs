    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20180820/accesspoint/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_access_point::DeleteAccessPoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessPoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_access_point::de_delete_access_point_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_access_point::de_delete_access_point_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_access_point::DeleteAccessPointError
{
