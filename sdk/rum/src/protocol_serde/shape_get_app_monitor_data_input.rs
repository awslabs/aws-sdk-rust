...
pub fn ser_get_app_monitor_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppMonitorDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
