...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
