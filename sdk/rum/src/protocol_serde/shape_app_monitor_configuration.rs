...
pub fn ser_app_monitor_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AppMonitorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_app_monitor_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AppMonitorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
