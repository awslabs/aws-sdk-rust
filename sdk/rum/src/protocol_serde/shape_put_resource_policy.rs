...
) -> std::result::Result<crate::operation::put_resource_policy::PutResourcePolicyOutput, crate::operation::put_resource_policy::PutResourcePolicyError>
{
    ...
    Err(match error_code {
        ...
        "InvalidPolicyRevisionIdException" => crate::operation::put_resource_policy::PutResourcePolicyError::InvalidPolicyRevisionIdException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "MalformedPolicyDocumentException" => crate::operation::put_resource_policy::PutResourcePolicyError::MalformedPolicyDocumentException({
            ...
            let mut tmp = {
                ...
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
                let output = output.meta(generic);
                crate::serde_util::malformed_policy_document_exception_correct_errors(output)
                    .build()
                    .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?
            };
            tmp
        }),
        "PolicySizeLimitExceededException" => crate::operation::put_resource_policy::PutResourcePolicyError::PolicySizeLimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = crate::types::error::builders::PolicySizeLimitExceededExceptionBuilder::default();
                output = crate::protocol_serde::shape_policy_size_limit_exceeded_exception::de_policy_size_limit_exceeded_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
                let output = output.meta(generic);
                crate::serde_util::policy_size_limit_exceeded_exception_correct_errors(output)
                    .build()
                    .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?
            };
            tmp
