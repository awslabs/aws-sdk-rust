...
pub fn ser_create_app_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAppMonitorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
