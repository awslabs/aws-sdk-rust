...
pub fn ser_update_app_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAppMonitorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
