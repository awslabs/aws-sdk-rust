...
pub fn ser_put_rum_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutRumEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
