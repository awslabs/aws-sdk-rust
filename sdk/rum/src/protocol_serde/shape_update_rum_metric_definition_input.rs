...
pub fn ser_update_rum_metric_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRumMetricDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
