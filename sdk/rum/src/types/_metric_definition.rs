        ...
        ::std::result::Result::Ok(
            crate::types::MetricDefinition {
                metric_definition_id: self.metric_definition_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("metric_definition_id", "metric_definition_id was not specified but it is required when building MetricDefinition")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building MetricDefinition")
                    )?
                ,
