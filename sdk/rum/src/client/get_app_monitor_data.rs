...
impl super::Client {
    ...
    ///   - [`filters(QueryFilter)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::filters) / [`set_filters(Option<Vec<QueryFilter>>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_filters): <p>An array of structures that you can use to filter the results to those that match one or more sets of key-value pairs that you specify.</p>
