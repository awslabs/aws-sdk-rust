...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_name):<br>required: **true**<br><p>The name of the app monitor that collected the data that you want to retrieve.</p><br>
    ...
    ///   - [`filters(QueryFilter)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::filters) / [`set_filters(Option<Vec::<QueryFilter>>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_filters):<br>required: **false**<br><p>An array of structures that you can use to filter the results to those that match one or more sets of key-value pairs that you specify.</p><br>
    ///   - [`max_results(i32)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in one operation.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_next_token):<br>required: **false**<br><p>Use the token returned by the previous operation to request the next page of results.</p><br>
