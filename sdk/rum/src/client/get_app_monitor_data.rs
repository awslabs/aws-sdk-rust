...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_name):<br>required: **true**<br><p>The name of the app monitor that collected the data that you want to retrieve.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in one operation. </p><br>
