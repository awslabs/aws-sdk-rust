...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_name): <p>The name of the app monitor that collected the data that you want to retrieve.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_app_monitor_data::builders::GetAppMonitorDataFluentBuilder::set_next_token): <p>Use the token returned by the previous operation to request the next page of results.</p>
