...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_app_monitors::builders::ListAppMonitorsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_app_monitors::builders::ListAppMonitorsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in one operation. The default is 50. The maximum that you can specify is 100.</p><br>
