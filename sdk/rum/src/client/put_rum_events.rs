...
impl super::Client {
    ...
    ///   - [`rum_events(RumEvent)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::rum_events) / [`set_rum_events(Option<Vec<RumEvent>>)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::set_rum_events): <p>An array of structures that contain the telemetry event data.</p>
