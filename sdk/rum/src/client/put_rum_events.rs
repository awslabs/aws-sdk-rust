...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::set_id): <p>The ID of the app monitor that is sending this data.</p>
    ///   - [`batch_id(impl ::std::convert::Into<String>)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::batch_id) / [`set_batch_id(Option<String>)`](crate::operation::put_rum_events::builders::PutRumEventsFluentBuilder::set_batch_id): <p>A unique identifier for this batch of RUM event data.</p>
