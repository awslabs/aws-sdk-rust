...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_app_monitor::builders::GetAppMonitorFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::get_app_monitor::builders::GetAppMonitorFluentBuilder::set_name):<br>required: **true**<br><p>The app monitor to retrieve information for.</p><br>
