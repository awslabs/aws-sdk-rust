...
impl super::Client {
    ...
    ///   - [`app_monitor_name(impl Into<String>)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::app_monitor_name) / [`set_app_monitor_name(impl Into<String>)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::set_app_monitor_name):<br>required: **true**<br><p>The name of the app monitor that is sending metrics to the destination that you want to delete.</p><br>
    ///   - [`destination(MetricDestination)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::destination) / [`set_destination(MetricDestination)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::set_destination):<br>required: **true**<br><p>The type of destination to delete. Valid values are <code>CloudWatch</code> and <code>Evidently</code>.</p><br>
    ///   - [`destination_arn(impl Into<String>)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::destination_arn) / [`set_destination_arn(Option<String>)`](crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationFluentBuilder::set_destination_arn):<br>required: **false**<br><p>This parameter is required if <code>Destination</code> is <code>Evidently</code>. If <code>Destination</code> is <code>CloudWatch</code>, do not use this parameter. This parameter specifies the ARN of the Evidently experiment that corresponds to the destination to delete.</p><br>
