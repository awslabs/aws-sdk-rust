...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_name): <p>The name of the app monitor to update.</p>
    ///   - [`domain(impl Into<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_domain): <p>The top-level internet domain name for which your application has administrative authority.</p>
