...
impl super::Client {
    /// Constructs a fluent builder for the [`UpdateAppMonitor`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_name): <p>The name of the app monitor to update.</p>
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_domain): <p>The top-level internet domain name for which your application has administrative authority.</p>
    ///   - [`app_monitor_configuration(AppMonitorConfiguration)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::app_monitor_configuration) / [`set_app_monitor_configuration(Option<AppMonitorConfiguration>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_app_monitor_configuration): <p>A structure that contains much of the configuration data for the app monitor. If you are using Amazon Cognito for authorization, you must include this structure in your request, and it must include the ID of the Amazon Cognito identity pool to use for authorization. If you don't include <code>AppMonitorConfiguration</code>, you must set up your own authorization method. For more information, see <a href="https://docs.aws.amazon.com/monitoring/CloudWatch-RUM-get-started-authorization.html">Authorize your application to send data to Amazon Web Services</a>.</p>
    ///   - [`cw_log_enabled(bool)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::cw_log_enabled) / [`set_cw_log_enabled(Option<bool>)`](crate::operation::update_app_monitor::builders::UpdateAppMonitorFluentBuilder::set_cw_log_enabled): <p>Data collected by RUM is kept by RUM for 30 days and then deleted. This parameter specifies whether RUM sends a copy of this telemetry data to Amazon CloudWatch Logs in your account. This enables you to keep the telemetry data for more than 30 days, but it does incur Amazon CloudWatch Logs charges.</p>
