...
pub fn serialize_structure_crate_input_create_app_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAppMonitorInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_1) = &input.app_monitor_configuration {
        let mut object_2 = object.key("AppMonitorConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_app_monitor_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
...
pub fn serialize_structure_crate_input_get_app_monitor_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppMonitorDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_10) = &input.filters {
        let mut array_11 = object.key("Filters").start_array();
        for item_12 in var_10 {
             {
                let mut object_13 = array_11.value().start_object();
                crate::json_ser::serialize_structure_crate_model_query_filter(&mut object_13, item_12)?;
                object_13.finish();
            }
        }
        array_11.finish();
...
pub fn serialize_structure_crate_input_put_rum_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutRumEventsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_17) = &input.app_monitor_details {
        let mut object_18 = object.key("AppMonitorDetails").start_object();
        crate::json_ser::serialize_structure_crate_model_app_monitor_details(&mut object_18, var_17)?;
        object_18.finish();
    }
        ...
        for item_22 in var_20 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_rum_event(&mut object_23, item_22)?;
                object_23.finish();
            }
        }
        array_21.finish();
...
pub fn serialize_structure_crate_input_update_app_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAppMonitorInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_30) = &input.app_monitor_configuration {
        let mut object_31 = object.key("AppMonitorConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_app_monitor_configuration(&mut object_31, var_30)?;
        object_31.finish();
    }
...
pub fn serialize_structure_crate_model_app_monitor_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AppMonitorConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_query_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QueryFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_time_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimeRange) -> Result<(), aws_smithy_http::operation::SerializationError> {
     {
...
pub fn serialize_structure_crate_model_app_monitor_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AppMonitorDetails) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_rum_event(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RumEvent) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_57) = &input.id {
        object.key("id").string(var_57.as_str());
    }
    if let Some(var_58) = &input.timestamp {
        object.key("timestamp").date_time(var_58, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_model_user_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserDetails) -> Result<(), aws_smithy_http::operation::SerializationError> {
