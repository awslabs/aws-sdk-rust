...
pub fn serialize_structure_crate_input_batch_create_rum_metric_definitions_input(
        ...
        for item_5 in var_3 {
            {
                ...
                crate::json_ser::serialize_structure_crate_model_metric_definition_request(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
...
pub fn serialize_structure_crate_input_put_rum_metrics_destination_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_update_rum_metric_definition_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_metric_definition_request(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::MetricDefinitionRequest,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_custom_events(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::CustomEvents,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
