...
impl BatchCreateRumMetricDefinitionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_create_rum_metric_definitions::BatchCreateRumMetricDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchCreateRumMetricDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_create_rum_metric_definitions::de_batch_create_rum_metric_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
