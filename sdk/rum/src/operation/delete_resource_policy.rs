...
impl DeleteResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RUM", "DeleteResourcePolicy", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/appmonitor/{Name}/policy", Name = name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::delete_resource_policy::DeleteResourcePolicyInput,
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.policy_revision_id {
                    {
                        query.push_kv("policyRevisionId", &::aws_smithy_http::query::fmt_string(inner_2));
                    }
                }
                ::std::result::Result::Ok(())
            }
