...
impl crate::operation::delete_rum_metrics_destination::builders::DeleteRumMetricsDestinationInputBuilder {
...
impl DeleteRumMetricsDestinationFluentBuilder {
    /// Creates a new `DeleteRumMetricsDestinationFluentBuilder`.
