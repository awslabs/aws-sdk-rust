...
impl ListRumMetricsDestinationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRumMetricsDestinations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_rum_metrics_destinations::de_list_rum_metrics_destinations_http_response_with_props(
                status, headers, body,
            )
        }
    }
