...
impl DeleteRumMetricsDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestination::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteRumMetricsDestinationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationError
{
