...
impl ListAppMonitorsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_app_monitors::builders::ListAppMonitorsInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_app_monitors::paginator::ListAppMonitorsPaginator {
        crate::operation::list_app_monitors::paginator::ListAppMonitorsPaginator::new(
            self.handle,
            self.inner,
        )
    }
