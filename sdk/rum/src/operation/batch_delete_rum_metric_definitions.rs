...
impl BatchDeleteRumMetricDefinitions {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_delete_rum_metric_definitions::BatchDeleteRumMetricDefinitionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchDeleteRumMetricDefinitionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchDeleteRumMetricDefinitionsRequestSerializer {
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_4 = inner_4.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("metric_definition_ids", "cannot be empty or unset")
                })?;
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_delete_rum_metric_definitions::BatchDeleteRumMetricDefinitionsError {
