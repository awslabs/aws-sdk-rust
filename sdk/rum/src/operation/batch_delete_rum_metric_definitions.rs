...
impl BatchDeleteRumMetricDefinitionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_delete_rum_metric_definitions::BatchDeleteRumMetricDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteRumMetricDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_rum_metric_definitions::de_batch_delete_rum_metric_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
