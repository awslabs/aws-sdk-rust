...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetRumMetricDefinitions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_rum_metric_definitions::de_batch_get_rum_metric_definitions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::batch_get_rum_metric_definitions::BatchGetRumMetricDefinitionsError
{
