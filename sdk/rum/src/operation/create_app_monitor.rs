...
impl CreateAppMonitorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_app_monitor::ser_create_app_monitor_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAppMonitor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_app_monitor::de_create_app_monitor_http_response_with_props(status, headers, body)
        }
    }
}
