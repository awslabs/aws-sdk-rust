...
impl BatchCreateRumMetricDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_create_rum_metric_definitions::BatchCreateRumMetricDefinitionsInput, ::aws_smithy_types::error::operation::BuildError> {
