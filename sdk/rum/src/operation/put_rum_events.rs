    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/appmonitors/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_rum_events::PutRumEvents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRumEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_rum_events::de_put_rum_events_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_rum_events::de_put_rum_events_http_response_with_props(
                status, headers, body,
            )
        }
    }
