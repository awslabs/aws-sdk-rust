...
impl GetAppMonitorFluentBuilder  {
    /// Creates a new `GetAppMonitor`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_app_monitor::GetAppMonitorOutput, aws_smithy_http::result::SdkError<crate::operation::get_app_monitor::GetAppMonitorError>>
                     {
