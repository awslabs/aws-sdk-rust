...
impl ListRumMetricsDestinationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinationsOutput, crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinationsError, Self> {
