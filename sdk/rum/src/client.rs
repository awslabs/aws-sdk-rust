...
/// For example, the [`BatchCreateRumMetricDefinitions`](crate::operation::batch_create_rum_metric_definitions) operation has
/// a [`Client::batch_create_rum_metric_definitions`], function which returns a builder for that operation.
...
mod batch_create_rum_metric_definitions;

mod batch_delete_rum_metric_definitions;

mod batch_get_rum_metric_definitions;

mod create_app_monitor;
...
mod put_rum_metrics_destination;

mod tag_resource;

mod untag_resource;

mod update_app_monitor;

mod update_rum_metric_definition;
