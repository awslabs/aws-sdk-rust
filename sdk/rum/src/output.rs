...
pub struct ListAppMonitorsOutput  {
    ...
    #[doc(hidden)]pub app_monitor_summaries: std::option::Option<std::vec::Vec<crate::model::AppMonitorSummary>>,
}
...
pub struct GetAppMonitorOutput  {
    ...
    #[doc(hidden)]pub app_monitor: std::option::Option<crate::model::AppMonitor>,
}
