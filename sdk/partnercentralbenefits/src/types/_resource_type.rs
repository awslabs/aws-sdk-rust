...
/// match resourcetype {
///     ResourceType::BenefitAllocation => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            "BENEFIT_ALLOCATION" => ResourceType::BenefitAllocation,
            "OPPORTUNITY" => ResourceType::Opportunity,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceType::BenefitAllocation => "BENEFIT_ALLOCATION",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["BENEFIT_ALLOCATION", "OPPORTUNITY"]
    }
}
...
impl ::std::fmt::Display for ResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceType::BenefitAllocation => write!(f, "BENEFIT_ALLOCATION"),
            ResourceType::Opportunity => write!(f, "OPPORTUNITY"),
