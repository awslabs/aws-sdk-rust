...
///     ValidationExceptionErrorCode::NotEnoughValues => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NOT_ENOUGH_VALUES" => ValidationExceptionErrorCode::NotEnoughValues,
...
impl ValidationExceptionErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidationExceptionErrorCode::NotEnoughValues => "NOT_ENOUGH_VALUES",
...
impl ::std::fmt::Display for ValidationExceptionErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ValidationExceptionErrorCode::NotEnoughValues => write!(f, "NOT_ENOUGH_VALUES"),
