...
impl super::Client {
    ...
    ///   - [`tags(Option<Vec::<Tag>>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>A list of key-value pairs representing the tags associated with the resource.</p>
