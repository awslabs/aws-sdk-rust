...
impl aws_http::request_id::RequestId for crate::error::PutUsersError {
...
pub type PutItemsErrorKind = PutItemsError;
/// Error type for the `PutItemsError` operation.
#[non_exhaustive]
#[derive(std::fmt::Debug)]
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for PutItemsError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InvalidInputException(_inner) => {
                aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::PutItemsError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}
...
impl PutItemsError {
    ...
    /// Creates the `PutItemsError::Unhandled` variant from a `aws_smithy_types::error::ErrorMetadata`.
    pub fn generic(err: aws_smithy_types::error::ErrorMetadata) -> Self {
        Self::Unhandled(
            aws_smithy_types::error::Unhandled::builder()
                .source(err.clone())
    ...
    /// Returns `true` if the error kind is `PutItemsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutItemsError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `PutItemsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
}
...
impl PutEventsError {
    ...
    /// Returns `true` if the error kind is `PutEventsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
}
