        ...
        ::std::result::Result::Ok(
            crate::types::Event {
                ...
                event_type: self.event_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("event_type", "event_type was not specified but it is required when building Event")
                    )?
                ,
                ...
                sent_at: self.sent_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("sent_at", "sent_at was not specified but it is required when building Event")
                    )?
                ,
