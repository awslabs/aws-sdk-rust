...
pub mod put_events_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutEventsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutEventsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::PutEventsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::PutEvents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutEvents", "personalizeevents"));
...
pub mod put_items_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutItemsInput, aws_smithy_http::operation::BuildError> {
            Ok(
                crate::input::PutItemsInput {
...
impl PutItemsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutItems, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::PutItemsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::PutItems::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutItems", "personalizeevents"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod put_users_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutUsersInput, aws_smithy_http::operation::BuildError> {
            Ok(
                crate::input::PutUsersInput {
                    dataset_arn: self.dataset_arn
                    ,
                    users: self.users
                    ,
...
impl PutUsersInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutUsers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::PutUsersInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::PutUsers::new())
...
pub struct PutItemsInput  {
    ...
    #[doc(hidden)]pub dataset_arn: std::option::Option<std::string::String>,
    /// <p>A list of item data.</p>
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::Item>>,
}
impl PutItemsInput {
    /// <p>The Amazon Resource Name (ARN) of the Items dataset you are adding the item or items to.</p>
    pub fn dataset_arn(&self) -> std::option::Option<& str> {
...
pub struct PutEventsInput  {
    ...
    /// <p>The session ID associated with the user's visit. Your application generates the sessionId when a user first visits your website or uses your application. Amazon Personalize uses the sessionId to associate events with the user before they log in. For more information, see <a href="https://docs.aws.amazon.com/personalize/latest/dg/recording-events.html">Recording Events</a>.</p>
    #[doc(hidden)]pub session_id: std::option::Option<std::string::String>,
    /// <p>A list of event data from the session.</p>
    #[doc(hidden)]pub event_list: std::option::Option<std::vec::Vec<crate::model::Event>>,
}
impl PutEventsInput {
    /// <p>The tracking ID for the event. The ID is generated by a call to the <a href="https://docs.aws.amazon.com/personalize/latest/dg/API_CreateEventTracker.html">CreateEventTracker</a> API.</p>
