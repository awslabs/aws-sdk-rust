...
impl PutEventsInput {
    ...
    > {
        Ok({
            ...
            let body =
                crate::operation_ser::serialize_operation_put_events(&self).map_err(|err| {
...
pub mod put_items_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::PutItemsInput, smithy_http::operation::BuildError>
        {
...
impl PutItemsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_put_items(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::PutItems::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "PutItems",
                        "personalizeevents",
                    ));
...
pub mod put_users_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::PutUsersInput, smithy_http::operation::BuildError>
        {
...
impl PutUsersInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_put_users(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::PutUsers::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "PutUsers",
                        "personalizeevents",
                    ));
