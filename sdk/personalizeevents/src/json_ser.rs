...
pub fn serialize_structure_put_events_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_event(&mut object_4, item_3);
                object_4.finish();
            }
        }
        array_2.finish();
...
pub fn serialize_structure_put_items_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_item(&mut object_12, item_11);
                object_12.finish();
            }
        }
        array_10.finish();
...
pub fn serialize_structure_put_users_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_16 in var_14 {
            {
                ...
                crate::json_ser::serialize_structure_user(&mut object_17, item_16);
                object_17.finish();
            }
        }
        array_15.finish();
...
pub fn serialize_structure_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
