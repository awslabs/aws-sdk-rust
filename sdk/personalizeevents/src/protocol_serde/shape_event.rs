...
pub fn ser_event(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Event) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
