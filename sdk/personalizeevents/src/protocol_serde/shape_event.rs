...
pub fn ser_event(
    ...
    if let Some(var_2) = &input.event_value {
        object.key("eventValue").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_2).into()));
    }
    ...
    if let Some(var_4) = &input.properties {
     ...
     {
        object.key("sentAt").date_time(&input.sent_at, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
