...
pub fn ser_put_users_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutUsersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
