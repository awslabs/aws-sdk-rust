...
pub fn ser_create_storedi_scsi_volume_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStorediScsiVolumeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
