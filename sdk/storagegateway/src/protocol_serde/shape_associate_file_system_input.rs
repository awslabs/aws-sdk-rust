...
pub fn ser_associate_file_system_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateFileSystemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
