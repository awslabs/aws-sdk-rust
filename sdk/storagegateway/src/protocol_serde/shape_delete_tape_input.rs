...
pub fn ser_delete_tape_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteTapeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
