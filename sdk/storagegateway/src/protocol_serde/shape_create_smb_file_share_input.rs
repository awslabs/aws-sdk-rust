...
pub fn ser_create_smb_file_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSmbFileShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
