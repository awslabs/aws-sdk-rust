...
pub fn ser_update_nfs_file_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNfsFileShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
