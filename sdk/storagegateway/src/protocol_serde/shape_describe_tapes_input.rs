...
pub fn ser_describe_tapes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTapesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
