...
pub fn ser_create_tape_with_barcode_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTapeWithBarcodeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
