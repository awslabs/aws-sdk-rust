...
pub fn ser_create_nfs_file_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNfsFileShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
