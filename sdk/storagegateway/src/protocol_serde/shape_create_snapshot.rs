...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::create_snapshot::CreateSnapshotError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(response.body().as_ref(), output).map_err(crate::operation::create_snapshot::CreateSnapshotError::unhandled)?;
        ...
        "InvalidGatewayRequestException" => {
            crate::operation::create_snapshot::CreateSnapshotError::InvalidGatewayRequestException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidGatewayRequestExceptionBuilder::default();
                        let _ = response;
                        output = crate::protocol_serde::shape_invalid_gateway_request_exception::de_invalid_gateway_request_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::create_snapshot::CreateSnapshotError::unhandled)?;
                        let output = output.meta(generic);
                        output.build()
                    };
                    if tmp.message.is_none() {
        ...
        "ServiceUnavailableError" => {
            crate::operation::create_snapshot::CreateSnapshotError::ServiceUnavailableError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_unavailable_error::de_service_unavailable_error_json_err(response.body().as_ref(), output).map_err(crate::operation::create_snapshot::CreateSnapshotError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
