...
pub fn ser_list_volumes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_volumes::ListVolumesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
