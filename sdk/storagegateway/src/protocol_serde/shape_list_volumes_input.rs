...
pub fn ser_list_volumes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListVolumesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
