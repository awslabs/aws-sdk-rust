        ...
        "InvalidGatewayRequestException" => {
            crate::error::ListTagsForResourceError::InvalidGatewayRequestException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_gateway_request_exception::de_invalid_gateway_request_exception_json_err(response.body().as_ref(), output).map_err(crate::error::ListTagsForResourceError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
