...
pub fn ser_describe_tape_recovery_points_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTapeRecoveryPointsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
