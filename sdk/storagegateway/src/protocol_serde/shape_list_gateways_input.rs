...
pub fn ser_list_gateways_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListGatewaysInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
