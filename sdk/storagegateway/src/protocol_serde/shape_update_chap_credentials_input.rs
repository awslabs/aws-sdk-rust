...
pub fn ser_update_chap_credentials_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateChapCredentialsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
