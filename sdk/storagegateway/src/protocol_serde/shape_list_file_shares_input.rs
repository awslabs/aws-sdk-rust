...
pub fn ser_list_file_shares_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_file_shares::ListFileSharesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
