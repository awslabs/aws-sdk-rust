...
impl super::Client {
    ...
    ///   - [`vtl_device_ar_ns(impl Into<String>)`](crate::operation::describe_vtl_devices::builders::DescribeVTLDevicesFluentBuilder::vtl_device_ar_ns) / [`set_vtl_device_ar_ns(Option<Vec<String>>)`](crate::operation::describe_vtl_devices::builders::DescribeVTLDevicesFluentBuilder::set_vtl_device_ar_ns): <p>An array of strings, where each string represents the Amazon Resource Name (ARN) of a VTL device.</p> <note>   <p>All of the specified VTL devices must be from the same gateway. If no VTL devices are specified, the result will contain all devices on the specified gateway.</p>  </note>
