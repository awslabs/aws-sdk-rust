...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_vtl_devices::builders::DescribeVTLDevicesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_vtl_devices::builders::DescribeVTLDevicesFluentBuilder::set_marker): <p>An opaque string that indicates the position at which to begin describing the VTL devices.</p>
