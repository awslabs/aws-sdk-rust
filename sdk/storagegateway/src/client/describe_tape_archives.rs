...
impl super::Client {
    ...
    ///   - [`tape_ar_ns(impl Into<String>)`](crate::operation::describe_tape_archives::builders::DescribeTapeArchivesFluentBuilder::tape_ar_ns) / [`set_tape_ar_ns(Option<Vec<String>>)`](crate::operation::describe_tape_archives::builders::DescribeTapeArchivesFluentBuilder::set_tape_ar_ns): <p>Specifies one or more unique Amazon Resource Names (ARNs) that represent the virtual tapes you want to describe.</p>
