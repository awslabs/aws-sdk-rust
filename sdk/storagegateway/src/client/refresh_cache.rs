...
impl super::Client {
    ...
    ///   - [`file_share_arn(impl ::std::convert::Into<String>)`](crate::operation::refresh_cache::builders::RefreshCacheFluentBuilder::file_share_arn) / [`set_file_share_arn(Option<String>)`](crate::operation::refresh_cache::builders::RefreshCacheFluentBuilder::set_file_share_arn): <p>The Amazon Resource Name (ARN) of the file share you want to refresh.</p>
