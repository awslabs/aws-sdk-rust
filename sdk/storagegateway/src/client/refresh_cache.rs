...
impl super::Client {
    ...
    ///   - [`folder_list(impl Into<String>)`](crate::operation::refresh_cache::builders::RefreshCacheFluentBuilder::folder_list) / [`set_folder_list(Option<Vec::<String>>)`](crate::operation::refresh_cache::builders::RefreshCacheFluentBuilder::set_folder_list):<br>required: **false**<br><p>A comma-separated list of the paths of folders to refresh in the cache. The default is \["/"\]. The default refreshes objects and folders at the root of the Amazon S3 bucket. If Recursive is set to true, the entire S3 bucket that the file share has access to is refreshed.</p> <p>Do not include <code>/</code> when specifying folder names. For example, you would specify <code>samplefolder</code> rather than <code>samplefolder/</code>.</p><br>
