...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_tape_recovery_points::builders::DescribeTapeRecoveryPointsFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::describe_tape_recovery_points::builders::DescribeTapeRecoveryPointsFluentBuilder::set_gateway_arn): <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_tape_recovery_points::builders::DescribeTapeRecoveryPointsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_tape_recovery_points::builders::DescribeTapeRecoveryPointsFluentBuilder::set_marker): <p>An opaque string that indicates the position at which to begin describing the virtual tape recovery points.</p>
