...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::start_availability_monitor_test::builders::StartAvailabilityMonitorTestFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::start_availability_monitor_test::builders::StartAvailabilityMonitorTestFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p><br>
