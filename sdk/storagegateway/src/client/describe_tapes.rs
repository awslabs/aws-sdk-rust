...
impl super::Client {
    ...
    ///   - [`tape_ar_ns(impl Into<String>)`](crate::operation::describe_tapes::builders::DescribeTapesFluentBuilder::tape_ar_ns) / [`set_tape_ar_ns(Option<Vec<String>>)`](crate::operation::describe_tapes::builders::DescribeTapesFluentBuilder::set_tape_ar_ns): <p>Specifies one or more unique Amazon Resource Names (ARNs) that represent the virtual tapes you want to describe. If this parameter is not specified, Tape gateway returns a description of all virtual tapes associated with the specified gateway.</p>
