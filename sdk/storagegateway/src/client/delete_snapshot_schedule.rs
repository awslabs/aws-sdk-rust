...
impl super::Client {
    ...
    ///   - [`volume_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_snapshot_schedule::builders::DeleteSnapshotScheduleFluentBuilder::volume_arn) / [`set_volume_arn(Option<String>)`](crate::operation::delete_snapshot_schedule::builders::DeleteSnapshotScheduleFluentBuilder::set_volume_arn): <p>The volume which snapshot schedule to delete.</p>
