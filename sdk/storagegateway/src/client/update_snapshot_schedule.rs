...
impl super::Client {
    ...
    ///   - [`volume_arn(impl ::std::convert::Into<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::volume_arn) / [`set_volume_arn(Option<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_volume_arn): <p>The Amazon Resource Name (ARN) of the volume. Use the <code>ListVolumes</code> operation to return a list of gateway volumes.</p>
    ///   - [`start_at(i32)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::start_at) / [`set_start_at(Option<i32>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_start_at): <p>The hour of the day at which the snapshot schedule begins represented as <i>hh</i>, where <i>hh</i> is the hour (0 to 23). The hour of the day is in the time zone of the gateway.</p>
    ///   - [`recurrence_in_hours(i32)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::recurrence_in_hours) / [`set_recurrence_in_hours(Option<i32>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_recurrence_in_hours): <p>Frequency of snapshots. Specify the number of hours between snapshots.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_description): <p>Optional description of the snapshot that overwrites the existing description.</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_tags): <p>A list of up to 50 tags that can be assigned to a snapshot. Each tag is a key-value pair.</p> <note>   <p>Valid characters for key and value are letters, spaces, and numbers representable in UTF-8 format, and the following special characters: + - = . _ : / @. The maximum length of a tag's key is 128 characters, and the maximum length for a tag's value is 256.</p>  </note>
