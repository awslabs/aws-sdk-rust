...
impl super::Client {
    ...
    ///   - [`volume_arn(impl Into<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::volume_arn) / [`set_volume_arn(Option<String>)`](crate::operation::update_snapshot_schedule::builders::UpdateSnapshotScheduleFluentBuilder::set_volume_arn): <p>The Amazon Resource Name (ARN) of the volume. Use the <code>ListVolumes</code> operation to return a list of gateway volumes.</p>
