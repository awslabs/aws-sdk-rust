...
impl super::Client {
    ...
    ///   - [`file_share_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_file_share::builders::DeleteFileShareFluentBuilder::file_share_arn) / [`set_file_share_arn(Option<String>)`](crate::operation::delete_file_share::builders::DeleteFileShareFluentBuilder::set_file_share_arn): <p>The Amazon Resource Name (ARN) of the file share to be deleted.</p>
