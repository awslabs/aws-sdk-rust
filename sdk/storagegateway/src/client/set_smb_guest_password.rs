...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::set_smb_guest_password::builders::SetSMBGuestPasswordFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::set_smb_guest_password::builders::SetSMBGuestPasswordFluentBuilder::set_gateway_arn): <p>The Amazon Resource Name (ARN) of the S3 File Gateway the SMB file share is associated with.</p>
    ///   - [`password(impl ::std::convert::Into<String>)`](crate::operation::set_smb_guest_password::builders::SetSMBGuestPasswordFluentBuilder::password) / [`set_password(Option<String>)`](crate::operation::set_smb_guest_password::builders::SetSMBGuestPasswordFluentBuilder::set_password): <p>The password that you want to set for your SMB server.</p>
