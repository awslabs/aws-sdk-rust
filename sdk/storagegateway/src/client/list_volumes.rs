...
impl super::Client {
    ...
    ///   - [`volume_infos(Option<Vec::<VolumeInfo>>)`](crate::operation::list_volumes::ListVolumesOutput::volume_infos): <p>An array of VolumeInfo objects, where each object describes an iSCSI volume. If no volumes are defined for the gateway, then VolumeInfos is an empty array "\[\]".</p>
