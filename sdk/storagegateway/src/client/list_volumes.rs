...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::list_volumes::builders::ListVolumesFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::list_volumes::builders::ListVolumesFluentBuilder::set_gateway_arn): <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_volumes::builders::ListVolumesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_volumes::builders::ListVolumesFluentBuilder::set_marker): <p>A string that indicates the position at which to begin the returned list of volumes. Obtain the marker from the response of a previous List iSCSI Volumes request.</p>
