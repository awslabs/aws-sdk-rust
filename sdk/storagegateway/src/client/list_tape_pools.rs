...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_tape_pools::builders::ListTapePoolsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_tape_pools::builders::ListTapePoolsFluentBuilder::set_marker): <p>A string that indicates the position at which to begin the returned list of tape pools.</p>
