...
impl super::Client {
    ...
    ///   - [`pool_ar_ns(impl Into<String>)`](crate::operation::list_tape_pools::builders::ListTapePoolsFluentBuilder::pool_ar_ns) / [`set_pool_ar_ns(Option<Vec<String>>)`](crate::operation::list_tape_pools::builders::ListTapePoolsFluentBuilder::set_pool_ar_ns):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of each of the custom tape pools you want to list. If you don't specify a custom tape pool ARN, the response lists all custom tape pools. </p><br>
