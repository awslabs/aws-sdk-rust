...
impl super::Client  {
    ...
    pub fn create_snapshot_from_volume_recovery_point(&self) -> crate::client::fluent_builders::CreateSnapshotFromVolumeRecoveryPoint {
                                crate::client::fluent_builders::CreateSnapshotFromVolumeRecoveryPoint::new(self.handle.clone())
                            }
}
