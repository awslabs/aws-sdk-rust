...
impl super::Client {
    ...
    ///   - [`target_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_chap_credentials::builders::DescribeChapCredentialsFluentBuilder::target_arn) / [`set_target_arn(Option<String>)`](crate::operation::describe_chap_credentials::builders::DescribeChapCredentialsFluentBuilder::set_target_arn): <p>The Amazon Resource Name (ARN) of the iSCSI volume target. Use the <code>DescribeStorediSCSIVolumes</code> operation to return to retrieve the TargetARN for specified VolumeARN.</p>
    ...
    pub fn describe_chap_credentials(
        &self,
    ) -> crate::operation::describe_chap_credentials::builders::DescribeChapCredentialsFluentBuilder
    {
