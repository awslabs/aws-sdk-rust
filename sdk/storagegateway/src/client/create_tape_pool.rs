...
impl super::Client {
    ...
    ///   - [`pool_name(impl ::std::convert::Into<String>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::set_pool_name): <p>The name of the new custom tape pool.</p>
    ///   - [`storage_class(TapeStorageClass)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::storage_class) / [`set_storage_class(Option<TapeStorageClass>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::set_storage_class): <p>The storage class that is associated with the new custom pool. When you use your backup application to eject the tape, the tape is archived directly into the storage class (S3 Glacier or S3 Glacier Deep Archive) that corresponds to the pool.</p>
    ///   - [`retention_lock_type(RetentionLockType)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::retention_lock_type) / [`set_retention_lock_type(Option<RetentionLockType>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::set_retention_lock_type): <p>Tape retention lock can be configured in two modes. When configured in governance mode, Amazon Web Services accounts with specific IAM permissions are authorized to remove the tape retention lock from archived virtual tapes. When configured in compliance mode, the tape retention lock cannot be removed by any user, including the root Amazon Web Services account.</p>
