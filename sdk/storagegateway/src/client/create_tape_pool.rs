...
impl super::Client {
    ...
    ///   - [`pool_name(impl Into<String>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::create_tape_pool::builders::CreateTapePoolFluentBuilder::set_pool_name): <p>The name of the new custom tape pool.</p>
