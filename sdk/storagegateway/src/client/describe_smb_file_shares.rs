...
impl super::Client {
    ...
    ///   - [`file_share_arn_list(impl Into<String>)`](crate::operation::describe_smb_file_shares::builders::DescribeSMBFileSharesFluentBuilder::file_share_arn_list) / [`set_file_share_arn_list(Option<Vec::<String>>)`](crate::operation::describe_smb_file_shares::builders::DescribeSMBFileSharesFluentBuilder::set_file_share_arn_list):<br>required: **true**<br><p>An array containing the Amazon Resource Name (ARN) of each file share to be described.</p><br>
