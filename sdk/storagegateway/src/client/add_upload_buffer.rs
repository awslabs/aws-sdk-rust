...
impl super::Client {
    ...
    ///   - [`disk_ids(impl Into<String>)`](crate::operation::add_upload_buffer::builders::AddUploadBufferFluentBuilder::disk_ids) / [`set_disk_ids(Option<Vec<String>>)`](crate::operation::add_upload_buffer::builders::AddUploadBufferFluentBuilder::set_disk_ids): <p>An array of strings that identify disks that are to be configured as working storage. Each string has a minimum length of 1 and maximum length of 300. You can get the disk IDs from the <code>ListLocalDisks</code> API.</p>
