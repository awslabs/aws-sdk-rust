...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::set_gateway_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the gateway whose file shares you want to list. If this field is not present, all file shares under your account are listed.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of file shares to return in the response. The value must be an integer with a value greater than zero. Optional.</p><br>
    ///   - [`marker(impl Into<String>)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_file_shares::builders::ListFileSharesFluentBuilder::set_marker):<br>required: **false**<br><p>Opaque pagination token returned from a previous ListFileShares operation. If present, <code>Marker</code> specifies where to continue the list from after a previous call to ListFileShares. Optional.</p><br>
