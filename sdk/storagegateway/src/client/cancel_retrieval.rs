...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::cancel_retrieval::builders::CancelRetrievalFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::cancel_retrieval::builders::CancelRetrievalFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p><br>
    ///   - [`tape_arn(impl Into<String>)`](crate::operation::cancel_retrieval::builders::CancelRetrievalFluentBuilder::tape_arn) / [`set_tape_arn(Option<String>)`](crate::operation::cancel_retrieval::builders::CancelRetrievalFluentBuilder::set_tape_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the virtual tape you want to cancel retrieval for.</p><br>
