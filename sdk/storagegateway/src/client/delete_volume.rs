...
impl super::Client {
    ...
    ///   - [`volume_arn(impl Into<String>)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::volume_arn) / [`set_volume_arn(Option<String>)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::set_volume_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the volume. Use the <code>ListVolumes</code> operation to return a list of gateway volumes.</p><br>
