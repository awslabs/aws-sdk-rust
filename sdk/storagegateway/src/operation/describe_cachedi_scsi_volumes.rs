...
impl DescribeCachediScsiVolumesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCachediSCSIVolumes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cachedi_scsi_volumes::de_describe_cachedi_scsi_volumes_http_response_with_props(
                status, headers, body,
            )
        }
    }
