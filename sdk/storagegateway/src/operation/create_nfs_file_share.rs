...
impl CreateNfsFileShareInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_nfs_file_share::ser_create_nfs_file_share_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_nfs_file_share::CreateNFSFileShare::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_nfs_file_share::CreateNFSFileShareError
{
