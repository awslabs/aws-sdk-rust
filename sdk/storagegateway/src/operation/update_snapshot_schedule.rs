...
impl UpdateSnapshotScheduleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSnapshotSchedule`](crate::operation::update_snapshot_schedule::UpdateSnapshotSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_snapshot_schedule::UpdateSnapshotSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_snapshot_schedule::ser_update_snapshot_schedule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_snapshot_schedule::UpdateSnapshotSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSnapshotSchedule", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSnapshotSchedule {
                type Output = std::result::Result<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleOutput, crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError>;
