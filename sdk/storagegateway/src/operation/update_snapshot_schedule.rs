...
impl UpdateSnapshotSchedule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSnapshotSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSnapshotSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSnapshotScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSnapshotScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSnapshotSchedule")
...
.with_interceptor(UpdateSnapshotScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError>::new());
...
#[derive(Debug)]
            struct UpdateSnapshotScheduleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSnapshotScheduleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_snapshot_schedule::de_update_snapshot_schedule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_snapshot_schedule::de_update_snapshot_schedule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateSnapshotScheduleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSnapshotScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_snapshot_schedule::ser_update_snapshot_schedule_input(&input)?);
...
#[derive(Debug)]
            struct UpdateSnapshotScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSnapshotScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateSnapshotScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateSnapshotScheduleInput>()
                        .ok_or("failed to downcast to UpdateSnapshotScheduleInput")?;
...
pub enum UpdateSnapshotScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSnapshotScheduleError) for what information is available for the error.")]
...
impl UpdateSnapshotScheduleError {
    /// Creates the `UpdateSnapshotScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSnapshotScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSnapshotScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_snapshot_schedule::UpdateSnapshotScheduleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_snapshot_schedule::_update_snapshot_schedule_output::UpdateSnapshotScheduleOutput;

pub use crate::operation::update_snapshot_schedule::_update_snapshot_schedule_input::UpdateSnapshotScheduleInput;

mod _update_snapshot_schedule_input;

mod _update_snapshot_schedule_output;
