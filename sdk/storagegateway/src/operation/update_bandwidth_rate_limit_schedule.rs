...
impl UpdateBandwidthRateLimitScheduleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_bandwidth_rate_limit_schedule::UpdateBandwidthRateLimitSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBandwidthRateLimitSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_bandwidth_rate_limit_schedule::de_update_bandwidth_rate_limit_schedule_http_response_with_props(
                status, headers, body,
            )
        }
    }
