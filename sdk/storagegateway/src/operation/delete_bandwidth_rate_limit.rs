...
impl DeleteBandwidthRateLimitInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBandwidthRateLimit`](crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_bandwidth_rate_limit::ser_delete_bandwidth_rate_limit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBandwidthRateLimit", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBandwidthRateLimit {
                type Output = std::result::Result<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitOutput, crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError>;
