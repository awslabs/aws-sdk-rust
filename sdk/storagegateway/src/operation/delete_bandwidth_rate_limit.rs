...
impl DeleteBandwidthRateLimitInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimit::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBandwidthRateLimit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_bandwidth_rate_limit::de_delete_bandwidth_rate_limit_http_response_with_props(status, headers, body)
        }
    }
}
