...
/// Orchestration and serialization glue logic for `DeleteBandwidthRateLimit`.
...
impl DeleteBandwidthRateLimit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBandwidthRateLimit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBandwidthRateLimit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBandwidthRateLimitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBandwidthRateLimitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBandwidthRateLimit")
...
.with_interceptor(DeleteBandwidthRateLimitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError>::new());
...
#[derive(Debug)]
            struct DeleteBandwidthRateLimitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBandwidthRateLimitResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_bandwidth_rate_limit::de_delete_bandwidth_rate_limit_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_bandwidth_rate_limit::de_delete_bandwidth_rate_limit_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteBandwidthRateLimitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBandwidthRateLimitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_bandwidth_rate_limit::ser_delete_bandwidth_rate_limit_input(&input)?);
...
#[derive(Debug)]
            struct DeleteBandwidthRateLimitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBandwidthRateLimitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBandwidthRateLimitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBandwidthRateLimitInput>()
                        .ok_or("failed to downcast to DeleteBandwidthRateLimitInput")?;
...
pub enum DeleteBandwidthRateLimitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBandwidthRateLimitError) for what information is available for the error.")]
...
impl DeleteBandwidthRateLimitError {
    /// Creates the `DeleteBandwidthRateLimitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBandwidthRateLimitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBandwidthRateLimitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError {
...
mod _delete_bandwidth_rate_limit_output;
