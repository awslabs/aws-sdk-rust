...
impl DescribeTapeRecoveryPointsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput, crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError, Self> {
