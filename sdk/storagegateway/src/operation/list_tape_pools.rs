...
impl ListTapePoolsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tape_pools::ListTapePools::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListTapePools {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_tape_pools::de_list_tape_pools_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_tape_pools::de_list_tape_pools_http_response(
                status, headers, body,
            )
        }
    }
