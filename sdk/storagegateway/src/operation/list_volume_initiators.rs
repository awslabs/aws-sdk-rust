...
impl ListVolumeInitiatorsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_volume_initiators::ListVolumeInitiators,
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_volume_initiators::ser_list_volume_initiators_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_volume_initiators::ListVolumeInitiators::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_volume_initiators::ListVolumeInitiatorsError
{
