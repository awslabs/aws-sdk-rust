...
impl CreateStorediScsiVolumeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeInput, ::aws_smithy_types::error::operation::BuildError> {
