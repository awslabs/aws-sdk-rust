...
impl CancelArchivalFluentBuilder  {
    /// Creates a new `CancelArchival`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::cancel_archival::CancelArchivalOutput, aws_smithy_http::result::SdkError<crate::operation::cancel_archival::CancelArchivalError>>
                     {
