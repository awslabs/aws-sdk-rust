...
impl DescribeSnapshotScheduleInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSnapshotSchedule`](crate::operation::describe_snapshot_schedule::DescribeSnapshotSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_snapshot_schedule::DescribeSnapshotSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_snapshot_schedule::DescribeSnapshotScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_snapshot_schedule::ser_describe_snapshot_schedule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_snapshot_schedule::DescribeSnapshotSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeSnapshotSchedule", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSnapshotSchedule {
                type Output = std::result::Result<crate::operation::describe_snapshot_schedule::DescribeSnapshotScheduleOutput, crate::operation::describe_snapshot_schedule::DescribeSnapshotScheduleError>;
