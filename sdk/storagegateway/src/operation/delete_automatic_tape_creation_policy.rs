...
impl DeleteAutomaticTapeCreationPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAutomaticTapeCreationPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_automatic_tape_creation_policy::de_delete_automatic_tape_creation_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
