...
/// Orchestration and serialization glue logic for `CancelRetrieval`.
...
impl CancelRetrieval {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::cancel_retrieval::CancelRetrievalInput,
                    ) -> ::std::result::Result<crate::operation::cancel_retrieval::CancelRetrievalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_retrieval::CancelRetrievalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_retrieval::CancelRetrievalError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_retrieval::CancelRetrievalOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelRetrieval {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelRetrieval");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelRetrievalRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelRetrievalResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelRetrieval")
...
.with_interceptor(CancelRetrievalEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_retrieval::CancelRetrievalError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_retrieval::CancelRetrievalError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_retrieval::CancelRetrievalError>::new());
...
#[derive(Debug)]
            struct CancelRetrievalResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelRetrievalResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_retrieval::de_cancel_retrieval_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CancelRetrievalRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelRetrievalRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_retrieval::CancelRetrievalInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_retrieval::CancelRetrievalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_retrieval::ser_cancel_retrieval_input(&input)?);
...
#[derive(Debug)]
            struct CancelRetrievalEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelRetrievalEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelRetrievalEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelRetrievalInput>()
                        .ok_or("failed to downcast to CancelRetrievalInput")?;
...
pub enum CancelRetrievalError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelRetrievalError) for what information is available for the error.")]
...
impl CancelRetrievalError {
    /// Creates the `CancelRetrievalError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelRetrievalError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelRetrievalError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_retrieval::CancelRetrievalError {
