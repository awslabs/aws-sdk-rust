...
impl CancelRetrievalInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_retrieval::CancelRetrieval,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_retrieval::CancelRetrieval::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelRetrieval {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_retrieval::de_cancel_retrieval_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_retrieval::CancelRetrievalError
{
