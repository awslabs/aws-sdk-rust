...
impl CancelRetrievalInput {
    /// Consumes the builder and constructs an Operation<[`CancelRetrieval`](crate::operation::cancel_retrieval::CancelRetrieval)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_retrieval::CancelRetrieval, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_retrieval::CancelRetrievalInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_retrieval::ser_cancel_retrieval_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_retrieval::CancelRetrieval::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelRetrieval", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for CancelRetrieval {
                type Output = std::result::Result<crate::operation::cancel_retrieval::CancelRetrievalOutput, crate::operation::cancel_retrieval::CancelRetrievalError>;
