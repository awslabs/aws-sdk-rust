...
impl CancelRetrievalInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_retrieval::CancelRetrieval, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_retrieval::ser_cancel_retrieval_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelRetrieval {
    type Output =
        ::std::result::Result<crate::operation::cancel_retrieval::CancelRetrievalOutput, crate::operation::cancel_retrieval::CancelRetrievalError>;
