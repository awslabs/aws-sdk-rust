...
impl DescribeUploadBufferInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_upload_buffer::ser_describe_upload_buffer_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_upload_buffer::DescribeUploadBuffer::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_upload_buffer::DescribeUploadBufferError
{
