...
impl UpdateSmbLocalGroupsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSMBLocalGroups`](crate::operation::update_smb_local_groups::UpdateSMBLocalGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_smb_local_groups::UpdateSMBLocalGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_smb_local_groups::ser_update_smb_local_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_smb_local_groups::UpdateSMBLocalGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSMBLocalGroups", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSMBLocalGroups {
                type Output = std::result::Result<crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsOutput, crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError>;
