...
/// Orchestration and serialization glue logic for `UpdateSMBLocalGroups`.
...
impl UpdateSMBLocalGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsInput,
                    ) -> ::std::result::Result<crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSMBLocalGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSMBLocalGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSMBLocalGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSMBLocalGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSMBLocalGroups")
...
.with_interceptor(UpdateSMBLocalGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError>::new());
...
#[derive(Debug)]
            struct UpdateSMBLocalGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSMBLocalGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_smb_local_groups::de_update_smb_local_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_smb_local_groups::de_update_smb_local_groups_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateSMBLocalGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSMBLocalGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_smb_local_groups::ser_update_smb_local_groups_input(&input)?);
...
#[derive(Debug)]
            struct UpdateSMBLocalGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSMBLocalGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateSMBLocalGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateSmbLocalGroupsInput>()
                        .ok_or("failed to downcast to UpdateSmbLocalGroupsInput")?;
...
pub enum UpdateSMBLocalGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSMBLocalGroupsError) for what information is available for the error.")]
...
impl UpdateSMBLocalGroupsError {
    /// Creates the `UpdateSMBLocalGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSMBLocalGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSMBLocalGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_smb_local_groups::UpdateSMBLocalGroupsError {
...
mod _update_smb_local_groups_output;
