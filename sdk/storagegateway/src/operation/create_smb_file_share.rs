...
impl CreateSmbFileShareInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_smb_file_share::CreateSMBFileShare,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSMBFileShare {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_smb_file_share::de_create_smb_file_share_http_response_with_props(status, headers, body)
        }
    }
}
