...
impl CreateSmbFileShareInput {
    /// Consumes the builder and constructs an Operation<[`CreateSMBFileShare`](crate::operation::create_smb_file_share::CreateSMBFileShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_smb_file_share::CreateSMBFileShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_smb_file_share::CreateSmbFileShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_smb_file_share::ser_create_smb_file_share_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_smb_file_share::CreateSMBFileShare::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSMBFileShare", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSMBFileShare {
                type Output = std::result::Result<crate::operation::create_smb_file_share::CreateSmbFileShareOutput, crate::operation::create_smb_file_share::CreateSMBFileShareError>;
