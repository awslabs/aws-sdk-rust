...
impl CreateSmbFileShareInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_smb_file_share::ser_create_smb_file_share_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_smb_file_share::CreateSMBFileShare::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_smb_file_share::CreateSMBFileShareError
{
