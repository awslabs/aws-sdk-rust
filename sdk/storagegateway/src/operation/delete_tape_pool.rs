...
impl DeleteTapePoolInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTapePool`](crate::operation::delete_tape_pool::DeleteTapePool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_tape_pool::DeleteTapePool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_tape_pool::DeleteTapePoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_tape_pool::ser_delete_tape_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_tape_pool::DeleteTapePool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteTapePool", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTapePool {
                type Output = std::result::Result<crate::operation::delete_tape_pool::DeleteTapePoolOutput, crate::operation::delete_tape_pool::DeleteTapePoolError>;
