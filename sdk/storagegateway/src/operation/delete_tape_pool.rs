...
impl DeleteTapePoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_tape_pool::DeleteTapePool,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_tape_pool::DeleteTapePool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTapePool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_tape_pool::de_delete_tape_pool_http_error(
                status, headers, body,
            )
        } else {
