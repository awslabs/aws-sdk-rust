...
impl ListLocalDisksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_local_disks::ListLocalDisks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_local_disks::ser_list_local_disks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLocalDisks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_local_disks::de_list_local_disks_http_response_with_props(status, headers, body)
        }
    }
}
