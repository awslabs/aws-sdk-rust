...
impl ListLocalDisksInput {
    /// Consumes the builder and constructs an Operation<[`ListLocalDisks`](crate::operation::list_local_disks::ListLocalDisks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_local_disks::ListLocalDisks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_local_disks::ListLocalDisksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_local_disks::ser_list_local_disks_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_local_disks::ListLocalDisks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListLocalDisks", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListLocalDisks {
                type Output = std::result::Result<crate::operation::list_local_disks::ListLocalDisksOutput, crate::operation::list_local_disks::ListLocalDisksError>;
