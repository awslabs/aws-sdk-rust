...
impl ShutdownGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::shutdown_gateway::ShutdownGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ShutdownGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_shutdown_gateway::de_shutdown_gateway_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::shutdown_gateway::ShutdownGatewayError
{
