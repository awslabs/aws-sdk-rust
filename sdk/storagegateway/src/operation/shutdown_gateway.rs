...
impl ShutdownGatewayInput {
    /// Consumes the builder and constructs an Operation<[`ShutdownGateway`](crate::operation::shutdown_gateway::ShutdownGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::shutdown_gateway::ShutdownGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::shutdown_gateway::ShutdownGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_shutdown_gateway::ser_shutdown_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::shutdown_gateway::ShutdownGateway::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ShutdownGateway", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for ShutdownGateway {
                type Output = std::result::Result<crate::operation::shutdown_gateway::ShutdownGatewayOutput, crate::operation::shutdown_gateway::ShutdownGatewayError>;
