...
impl ShutdownGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::shutdown_gateway::ShutdownGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_shutdown_gateway::ser_shutdown_gateway_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ShutdownGateway {
    type Output =
        ::std::result::Result<crate::operation::shutdown_gateway::ShutdownGatewayOutput, crate::operation::shutdown_gateway::ShutdownGatewayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_shutdown_gateway::de_shutdown_gateway_http_response_with_props(status, headers, body)
        }
    }
}
