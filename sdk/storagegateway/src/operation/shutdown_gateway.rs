...
/// Orchestration and serialization glue logic for `ShutdownGateway`.
...
impl ShutdownGateway {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::shutdown_gateway::ShutdownGatewayInput,
                    ) -> ::std::result::Result<crate::operation::shutdown_gateway::ShutdownGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::shutdown_gateway::ShutdownGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::shutdown_gateway::ShutdownGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::shutdown_gateway::ShutdownGatewayOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ShutdownGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ShutdownGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ShutdownGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ShutdownGatewayResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ShutdownGateway")
...
.with_interceptor(ShutdownGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::shutdown_gateway::ShutdownGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::shutdown_gateway::ShutdownGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::shutdown_gateway::ShutdownGatewayError>::new());
...
#[derive(Debug)]
            struct ShutdownGatewayResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ShutdownGatewayResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_shutdown_gateway::de_shutdown_gateway_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_shutdown_gateway::de_shutdown_gateway_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ShutdownGatewayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ShutdownGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::shutdown_gateway::ShutdownGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::shutdown_gateway::ShutdownGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_shutdown_gateway::ser_shutdown_gateway_input(&input)?);
...
#[derive(Debug)]
            struct ShutdownGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ShutdownGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ShutdownGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ShutdownGatewayInput>()
                        .ok_or("failed to downcast to ShutdownGatewayInput")?;
...
pub enum ShutdownGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ShutdownGatewayError) for what information is available for the error.")]
...
impl ShutdownGatewayError {
    /// Creates the `ShutdownGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ShutdownGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ShutdownGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::shutdown_gateway::ShutdownGatewayError {
