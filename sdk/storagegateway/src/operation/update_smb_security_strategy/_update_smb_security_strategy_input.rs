...
impl UpdateSmbSecurityStrategyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyInput, ::aws_smithy_types::error::operation::BuildError> {
