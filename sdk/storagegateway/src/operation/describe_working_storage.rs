...
impl DescribeWorkingStorageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_working_storage::DescribeWorkingStorage,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkingStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_working_storage::de_describe_working_storage_http_response_with_props(status, headers, body)
        }
    }
}
