...
impl DescribeWorkingStorageInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkingStorage`](crate::operation::describe_working_storage::DescribeWorkingStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_working_storage::DescribeWorkingStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_working_storage::DescribeWorkingStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_working_storage::ser_describe_working_storage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_working_storage::DescribeWorkingStorage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeWorkingStorage", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeWorkingStorage {
                type Output = std::result::Result<crate::operation::describe_working_storage::DescribeWorkingStorageOutput, crate::operation::describe_working_storage::DescribeWorkingStorageError>;
