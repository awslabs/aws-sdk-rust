...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::set_local_console_password::SetLocalConsolePasswordOutput,
                    crate::operation::set_local_console_password::SetLocalConsolePasswordError,
                > for SetLocalConsolePasswordFluentBuilder
            {
                fn send(
                    self,
...
impl SetLocalConsolePasswordFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_local_console_password::SetLocalConsolePasswordOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_local_console_password::SetLocalConsolePasswordError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::set_local_console_password::SetLocalConsolePassword::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::set_local_console_password::SetLocalConsolePassword::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_local_console_password::SetLocalConsolePasswordOutput, crate::operation::set_local_console_password::SetLocalConsolePasswordError, Self> {
    ...
    pub fn get_local_console_password(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_local_console_password()
    }
}
