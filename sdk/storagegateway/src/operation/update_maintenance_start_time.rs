...
impl UpdateMaintenanceStartTimeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMaintenanceStartTime`](crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTime)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTime, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTimeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_maintenance_start_time::ser_update_maintenance_start_time_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTime::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMaintenanceStartTime", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceStartTime {
                type Output = std::result::Result<crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTimeOutput, crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTimeError>;
