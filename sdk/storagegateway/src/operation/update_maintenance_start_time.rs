...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceStartTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_maintenance_start_time::de_update_maintenance_start_time_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTimeError
{
