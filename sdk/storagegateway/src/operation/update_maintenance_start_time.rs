...
impl UpdateMaintenanceStartTimeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTime::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceStartTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_maintenance_start_time::de_update_maintenance_start_time_http_response_with_props(
                status, headers, body,
            )
        }
    }
