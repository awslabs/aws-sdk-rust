...
impl UpdateVTLDeviceTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_vtl_device_type::UpdateVtlDeviceTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_vtl_device_type::UpdateVTLDeviceTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_vtl_device_type::UpdateVtlDeviceTypeOutput, crate::operation::update_vtl_device_type::UpdateVTLDeviceTypeError, Self> {
