...
impl DeleteChapCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteChapCredentials`](crate::operation::delete_chap_credentials::DeleteChapCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_chap_credentials::DeleteChapCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_chap_credentials::DeleteChapCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_chap_credentials::ser_delete_chap_credentials_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_chap_credentials::DeleteChapCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteChapCredentials", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteChapCredentials {
                type Output = std::result::Result<crate::operation::delete_chap_credentials::DeleteChapCredentialsOutput, crate::operation::delete_chap_credentials::DeleteChapCredentialsError>;
