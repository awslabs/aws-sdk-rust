...
impl JoinDomainInput {
    /// Consumes the builder and constructs an Operation<[`JoinDomain`](crate::operation::join_domain::JoinDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::join_domain::JoinDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::join_domain::JoinDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_join_domain::ser_join_domain_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::join_domain::JoinDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("JoinDomain", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for JoinDomain {
                type Output = std::result::Result<crate::operation::join_domain::JoinDomainOutput, crate::operation::join_domain::JoinDomainError>;
