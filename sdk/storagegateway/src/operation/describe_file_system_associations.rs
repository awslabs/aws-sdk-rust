...
impl DescribeFileSystemAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFileSystemAssociations`](crate::operation::describe_file_system_associations::DescribeFileSystemAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_file_system_associations::DescribeFileSystemAssociations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_file_system_associations::DescribeFileSystemAssociationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_file_system_associations::ser_describe_file_system_associations_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_file_system_associations::DescribeFileSystemAssociations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeFileSystemAssociations", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFileSystemAssociations {
                type Output = std::result::Result<crate::operation::describe_file_system_associations::DescribeFileSystemAssociationsOutput, crate::operation::describe_file_system_associations::DescribeFileSystemAssociationsError>;
