...
impl DescribeFileSystemAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_file_system_associations::DescribeFileSystemAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFileSystemAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_file_system_associations::de_describe_file_system_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
