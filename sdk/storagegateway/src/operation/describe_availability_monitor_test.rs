...
impl DescribeAvailabilityMonitorTestInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTest,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAvailabilityMonitorTest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_availability_monitor_test::de_describe_availability_monitor_test_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTestError
{
