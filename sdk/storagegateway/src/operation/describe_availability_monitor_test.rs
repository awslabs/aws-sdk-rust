...
impl DescribeAvailabilityMonitorTestInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAvailabilityMonitorTest`](crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTestInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_availability_monitor_test::ser_describe_availability_monitor_test_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTest::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeAvailabilityMonitorTest", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAvailabilityMonitorTest {
                type Output = std::result::Result<crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTestOutput, crate::operation::describe_availability_monitor_test::DescribeAvailabilityMonitorTestError>;
