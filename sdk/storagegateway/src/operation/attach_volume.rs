...
impl AttachVolumeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_volume::AttachVolume::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachVolume {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_attach_volume::de_attach_volume_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_attach_volume::de_attach_volume_http_response_with_props(
                status, headers, body,
            )
        }
    }
