...
impl DescribeBandwidthRateLimitScheduleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_bandwidth_rate_limit_schedule::DescribeBandwidthRateLimitSchedule,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_bandwidth_rate_limit_schedule::DescribeBandwidthRateLimitSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBandwidthRateLimitSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_bandwidth_rate_limit_schedule::de_describe_bandwidth_rate_limit_schedule_http_response_with_props(
                status, headers, body,
            )
        }
    }
