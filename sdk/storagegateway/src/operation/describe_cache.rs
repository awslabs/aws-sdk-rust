...
impl DescribeCacheInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cache::DescribeCache::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCache {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_cache::de_describe_cache_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_cache::de_describe_cache_http_response_with_props(
                status, headers, body,
            )
        }
    }
