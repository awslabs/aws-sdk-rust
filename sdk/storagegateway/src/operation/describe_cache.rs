...
impl DescribeCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_cache::DescribeCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_cache::ser_describe_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCache {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cache::de_describe_cache_http_response_with_props(status, headers, body)
        }
    }
}
