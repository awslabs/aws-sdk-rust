...
/// Orchestration and serialization glue logic for `ListAutomaticTapeCreationPolicies`.
...
impl ListAutomaticTapeCreationPolicies {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesInput,
                    ) -> ::std::result::Result<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAutomaticTapeCreationPolicies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAutomaticTapeCreationPolicies");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAutomaticTapeCreationPoliciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAutomaticTapeCreationPoliciesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAutomaticTapeCreationPolicies")
...
.with_interceptor(ListAutomaticTapeCreationPoliciesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError>::new());
...
#[derive(Debug)]
            struct ListAutomaticTapeCreationPoliciesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAutomaticTapeCreationPoliciesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_automatic_tape_creation_policies::de_list_automatic_tape_creation_policies_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAutomaticTapeCreationPoliciesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAutomaticTapeCreationPoliciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_automatic_tape_creation_policies::ser_list_automatic_tape_creation_policies_input(&input)?);
...
#[derive(Debug)]
            struct ListAutomaticTapeCreationPoliciesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAutomaticTapeCreationPoliciesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAutomaticTapeCreationPoliciesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAutomaticTapeCreationPoliciesInput>()
                        .ok_or("failed to downcast to ListAutomaticTapeCreationPoliciesInput")?;
...
pub enum ListAutomaticTapeCreationPoliciesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAutomaticTapeCreationPoliciesError) for what information is available for the error.")]
...
impl ListAutomaticTapeCreationPoliciesError {
    /// Creates the `ListAutomaticTapeCreationPoliciesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAutomaticTapeCreationPoliciesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAutomaticTapeCreationPoliciesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesError {
...
mod _list_automatic_tape_creation_policies_output;
