...
impl ListAutomaticTapeCreationPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPolicies,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAutomaticTapeCreationPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_automatic_tape_creation_policies::de_list_automatic_tape_creation_policies_http_response_with_props(
                status, headers, body,
            )
        }
    }
