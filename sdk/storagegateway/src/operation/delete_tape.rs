...
impl DeleteTapeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_tape::DeleteTape,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_tape::DeleteTape::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTape {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_tape::de_delete_tape_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_tape::de_delete_tape_http_response_with_props(
                status, headers, body,
            )
        }
    }
