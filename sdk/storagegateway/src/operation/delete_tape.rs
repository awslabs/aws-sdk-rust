...
impl DeleteTapeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_tape::DeleteTape, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_tape::ser_delete_tape_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTape {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_tape::de_delete_tape_http_response_with_props(status, headers, body)
        }
    }
}
