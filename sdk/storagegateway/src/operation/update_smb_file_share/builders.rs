...
impl UpdateSMBFileShareFluentBuilder  {
    /// Creates a new `UpdateSMBFileShare`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_smb_file_share::UpdateSmbFileShareOutput, aws_smithy_http::result::SdkError<crate::operation::update_smb_file_share::UpdateSMBFileShareError>>
                     {
