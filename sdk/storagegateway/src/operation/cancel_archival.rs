...
impl CancelArchivalInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_archival::CancelArchival::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CancelArchival {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_archival::de_cancel_archival_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_cancel_archival::de_cancel_archival_http_response(
                status, headers, body,
            )
        }
    }
