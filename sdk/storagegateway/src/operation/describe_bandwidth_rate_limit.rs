...
impl DescribeBandwidthRateLimitInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_bandwidth_rate_limit::DescribeBandwidthRateLimit::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_bandwidth_rate_limit::DescribeBandwidthRateLimitError
{
