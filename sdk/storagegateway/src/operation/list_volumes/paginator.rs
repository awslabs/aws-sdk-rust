...
impl ListVolumesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::VolumeInfo, ::aws_smithy_http::result::SdkError<crate::operation::list_volumes::ListVolumesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_volumes_output_volume_infos(page).unwrap_or_default().into_iter())
    }
}
