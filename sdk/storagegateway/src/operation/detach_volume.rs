...
impl DetachVolumeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_volume::ser_detach_volume_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_volume::DetachVolume::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachVolume", "storagegateway"));
