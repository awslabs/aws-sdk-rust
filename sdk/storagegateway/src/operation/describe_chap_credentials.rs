...
impl DescribeChapCredentialsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_chap_credentials::DescribeChapCredentials,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeChapCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_chap_credentials::de_describe_chap_credentials_http_response_with_props(status, headers, body)
        }
    }
