...
impl DescribeChapCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeChapCredentials`](crate::operation::describe_chap_credentials::DescribeChapCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_chap_credentials::DescribeChapCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_chap_credentials::DescribeChapCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_chap_credentials::ser_describe_chap_credentials_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_chap_credentials::DescribeChapCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeChapCredentials", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeChapCredentials {
                type Output = std::result::Result<crate::operation::describe_chap_credentials::DescribeChapCredentialsOutput, crate::operation::describe_chap_credentials::DescribeChapCredentialsError>;
