...
impl RetrieveTapeArchiveFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveOutput, crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError, Self> {
