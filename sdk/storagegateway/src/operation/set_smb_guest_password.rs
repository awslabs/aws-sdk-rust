...
impl SetSMBGuestPassword {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_smb_guest_password::SetSmbGuestPasswordInput,
                    ) -> ::std::result::Result<crate::operation::set_smb_guest_password::SetSmbGuestPasswordOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_smb_guest_password::SetSMBGuestPasswordError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_smb_guest_password::SetSMBGuestPasswordError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_smb_guest_password::SetSmbGuestPasswordOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetSMBGuestPassword {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetSMBGuestPassword");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetSMBGuestPasswordRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetSMBGuestPasswordResponseDeserializer));
...
.with_interceptor(SetSMBGuestPasswordEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_smb_guest_password::SetSMBGuestPasswordError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_smb_guest_password::SetSMBGuestPasswordError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_smb_guest_password::SetSMBGuestPasswordError>::new());
...
#[derive(Debug)]
            struct SetSMBGuestPasswordResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetSMBGuestPasswordResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_smb_guest_password::de_set_smb_guest_password_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_smb_guest_password::de_set_smb_guest_password_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetSMBGuestPasswordRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetSMBGuestPasswordRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_smb_guest_password::SetSmbGuestPasswordInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_smb_guest_password::SetSmbGuestPasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_smb_guest_password::ser_set_smb_guest_password_input(&input)?);
...
#[derive(Debug)]
            struct SetSMBGuestPasswordEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetSMBGuestPasswordEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetSMBGuestPasswordEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetSmbGuestPasswordInput>()
                        .ok_or("failed to downcast to SetSmbGuestPasswordInput")?;
...
pub enum SetSMBGuestPasswordError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetSMBGuestPasswordError) for what information is available for the error.")]
...
impl SetSMBGuestPasswordError {
    /// Creates the `SetSMBGuestPasswordError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetSMBGuestPasswordError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetSMBGuestPasswordError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_smb_guest_password::SetSMBGuestPasswordError {
...
mod _set_smb_guest_password_output;
