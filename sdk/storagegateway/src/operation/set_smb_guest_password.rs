...
impl SetSmbGuestPasswordInput {
    /// Consumes the builder and constructs an Operation<[`SetSMBGuestPassword`](crate::operation::set_smb_guest_password::SetSMBGuestPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_smb_guest_password::SetSMBGuestPassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_smb_guest_password::SetSmbGuestPasswordInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_smb_guest_password::ser_set_smb_guest_password_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_smb_guest_password::SetSMBGuestPassword::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetSMBGuestPassword", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetSMBGuestPassword {
                type Output = std::result::Result<crate::operation::set_smb_guest_password::SetSmbGuestPasswordOutput, crate::operation::set_smb_guest_password::SetSMBGuestPasswordError>;
