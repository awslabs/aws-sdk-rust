...
impl SetSmbGuestPasswordInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_smb_guest_password::ser_set_smb_guest_password_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_smb_guest_password::SetSMBGuestPassword::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_smb_guest_password::SetSMBGuestPasswordError
{
