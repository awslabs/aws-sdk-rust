...
impl ListVolumeRecoveryPointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_volume_recovery_points::ListVolumeRecoveryPointsInput, ::aws_smithy_types::error::operation::BuildError> {
