...
impl crate::operation::describe_gateway_information::builders::DescribeGatewayInformationInputBuilder {
...
impl DescribeGatewayInformationFluentBuilder {
    /// Creates a new `DescribeGatewayInformationFluentBuilder`.
