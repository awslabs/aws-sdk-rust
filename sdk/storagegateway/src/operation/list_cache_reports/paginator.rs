...
/// Paginator for [`ListCacheReports`](crate::operation::list_cache_reports::ListCacheReports)
pub struct ListCacheReportsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_cache_reports::builders::ListCacheReportsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListCacheReportsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `cache_report_list`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_cache_reports::paginator::ListCacheReportsPaginatorItems {
        crate::operation::list_cache_reports::paginator::ListCacheReportsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_cache_reports::ListCacheReports::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_cache_reports_output_output_marker(resp);
...
/// Flattened paginator for `ListCacheReportsPaginator`
///
/// This is created with [`.items()`](ListCacheReportsPaginator::items)
pub struct ListCacheReportsPaginatorItems(ListCacheReportsPaginator);

impl ListCacheReportsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_cache_reports_output_output_cache_report_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
