...
impl ListTapesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::TapeInfo, ::aws_smithy_http::result::SdkError<crate::operation::list_tapes::ListTapesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_tapes_output_tape_infos(page).unwrap_or_default().into_iter())
    }
}
