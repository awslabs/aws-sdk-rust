...
impl UpdateNfsFileShareInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_nfs_file_share::ser_update_nfs_file_share_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_nfs_file_share::UpdateNFSFileShare::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_nfs_file_share::UpdateNFSFileShareError
{
