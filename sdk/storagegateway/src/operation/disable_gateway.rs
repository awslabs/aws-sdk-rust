...
impl DisableGatewayInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::disable_gateway::DisableGateway,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_gateway::DisableGateway::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DisableGateway {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disable_gateway::de_disable_gateway_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disable_gateway::de_disable_gateway_http_response(
                status, headers, body,
            )
        }
    }
