...
impl UpdateBandwidthRateLimitInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBandwidthRateLimit`](crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_bandwidth_rate_limit::ser_update_bandwidth_rate_limit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateBandwidthRateLimit", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBandwidthRateLimit {
                type Output = std::result::Result<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitOutput, crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError>;
