...
impl UpdateBandwidthRateLimitInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimit::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBandwidthRateLimit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_bandwidth_rate_limit::de_update_bandwidth_rate_limit_http_response_with_props(status, headers, body)
        }
    }
}
