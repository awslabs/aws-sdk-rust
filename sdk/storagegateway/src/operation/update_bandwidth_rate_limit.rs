...
/// Orchestration and serialization glue logic for `UpdateBandwidthRateLimit`.
...
impl UpdateBandwidthRateLimit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateBandwidthRateLimit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateBandwidthRateLimit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateBandwidthRateLimitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateBandwidthRateLimitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateBandwidthRateLimit")
...
.with_interceptor(UpdateBandwidthRateLimitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError>::new());
...
#[derive(Debug)]
            struct UpdateBandwidthRateLimitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateBandwidthRateLimitResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_bandwidth_rate_limit::de_update_bandwidth_rate_limit_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_bandwidth_rate_limit::de_update_bandwidth_rate_limit_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateBandwidthRateLimitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateBandwidthRateLimitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_bandwidth_rate_limit::ser_update_bandwidth_rate_limit_input(&input)?);
...
#[derive(Debug)]
            struct UpdateBandwidthRateLimitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateBandwidthRateLimitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateBandwidthRateLimitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateBandwidthRateLimitInput>()
                        .ok_or("failed to downcast to UpdateBandwidthRateLimitInput")?;
...
pub enum UpdateBandwidthRateLimitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateBandwidthRateLimitError) for what information is available for the error.")]
...
impl UpdateBandwidthRateLimitError {
    /// Creates the `UpdateBandwidthRateLimitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateBandwidthRateLimitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateBandwidthRateLimitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_bandwidth_rate_limit::_update_bandwidth_rate_limit_output::UpdateBandwidthRateLimitOutput;

pub use crate::operation::update_bandwidth_rate_limit::_update_bandwidth_rate_limit_input::UpdateBandwidthRateLimitInput;

mod _update_bandwidth_rate_limit_input;

mod _update_bandwidth_rate_limit_output;
