...
impl DisassociateFileSystemInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateFileSystem`](crate::operation::disassociate_file_system::DisassociateFileSystem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_file_system::DisassociateFileSystem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_file_system::DisassociateFileSystemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_file_system::ser_disassociate_file_system_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_file_system::DisassociateFileSystem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisassociateFileSystem", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateFileSystem {
                type Output = std::result::Result<crate::operation::disassociate_file_system::DisassociateFileSystemOutput, crate::operation::disassociate_file_system::DisassociateFileSystemError>;
