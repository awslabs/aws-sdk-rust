...
impl DescribeTapesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_tapes::DescribeTapes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_tapes::DescribeTapes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTapes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_tapes::de_describe_tapes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_tapes::de_describe_tapes_http_response_with_props(
                status, headers, body,
            )
        }
    }
