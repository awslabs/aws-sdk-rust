...
impl DescribeTapesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTapes`](crate::operation::describe_tapes::DescribeTapes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_tapes::DescribeTapes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_tapes::DescribeTapesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_tapes::ser_describe_tapes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_tapes::DescribeTapes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeTapes", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTapes {
                type Output = std::result::Result<crate::operation::describe_tapes::DescribeTapesOutput, crate::operation::describe_tapes::DescribeTapesError>;
