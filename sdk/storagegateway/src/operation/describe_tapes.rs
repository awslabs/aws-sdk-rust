...
impl DescribeTapesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_tapes::DescribeTapes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_tapes::ser_describe_tapes_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTapes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_tapes::de_describe_tapes_http_response_with_props(status, headers, body)
        }
    }
}
