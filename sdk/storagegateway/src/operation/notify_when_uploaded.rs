...
impl NotifyWhenUploadedInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_notify_when_uploaded::ser_notify_when_uploaded_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::notify_when_uploaded::NotifyWhenUploaded::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::notify_when_uploaded::NotifyWhenUploadedError
{
