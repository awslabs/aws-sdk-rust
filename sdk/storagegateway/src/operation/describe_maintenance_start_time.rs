...
impl DescribeMaintenanceStartTimeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTime::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceStartTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_maintenance_start_time::de_describe_maintenance_start_time_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeMaintenanceStartTimeError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTimeError
{
