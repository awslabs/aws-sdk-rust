...
impl DescribeMaintenanceStartTimeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceStartTime`](crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTime)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTime, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTimeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_start_time::ser_describe_maintenance_start_time_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTime::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeMaintenanceStartTime", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceStartTime {
                type Output = std::result::Result<crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTimeOutput, crate::operation::describe_maintenance_start_time::DescribeMaintenanceStartTimeError>;
