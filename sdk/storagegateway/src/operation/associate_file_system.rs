...
impl AssociateFileSystemInput {
    /// Consumes the builder and constructs an Operation<[`AssociateFileSystem`](crate::operation::associate_file_system::AssociateFileSystem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_file_system::AssociateFileSystem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_file_system::AssociateFileSystemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_file_system::ser_associate_file_system_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_file_system::AssociateFileSystem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateFileSystem", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateFileSystem {
                type Output = std::result::Result<crate::operation::associate_file_system::AssociateFileSystemOutput, crate::operation::associate_file_system::AssociateFileSystemError>;
