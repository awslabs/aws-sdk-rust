...
impl AssociateFileSystemInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_file_system::ser_associate_file_system_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_file_system::AssociateFileSystem::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_file_system::AssociateFileSystemError
{
