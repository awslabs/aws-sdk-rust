...
impl CreateTapesInput {
    /// Consumes the builder and constructs an Operation<[`CreateTapes`](crate::operation::create_tapes::CreateTapes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_tapes::CreateTapes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_tapes::CreateTapesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_tapes::ser_create_tapes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_tapes::CreateTapes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateTapes", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTapes {
                type Output = std::result::Result<crate::operation::create_tapes::CreateTapesOutput, crate::operation::create_tapes::CreateTapesError>;
