...
/// Orchestration and serialization glue logic for `ActivateGateway`.
...
impl ActivateGateway {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::activate_gateway::ActivateGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::activate_gateway::ActivateGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::activate_gateway::ActivateGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::activate_gateway::ActivateGatewayOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ActivateGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ActivateGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ActivateGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ActivateGatewayResponseDeserializer));
...
.with_interceptor(ActivateGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::activate_gateway::ActivateGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::activate_gateway::ActivateGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::activate_gateway::ActivateGatewayError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_activate_gateway::de_activate_gateway_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ActivateGatewayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ActivateGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::activate_gateway::ActivateGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::activate_gateway::ActivateGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_activate_gateway::ser_activate_gateway_input(&input)?);
...
#[derive(Debug)]
            struct ActivateGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ActivateGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ActivateGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ActivateGatewayInput>()
                        .ok_or("failed to downcast to ActivateGatewayInput")?;
...
pub enum ActivateGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ActivateGatewayError) for what information is available for the error.")]
...
impl ActivateGatewayError {
    /// Creates the `ActivateGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ActivateGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ActivateGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::activate_gateway::ActivateGatewayError {
