...
impl ActivateGatewayInput {
    /// Consumes the builder and constructs an Operation<[`ActivateGateway`](crate::operation::activate_gateway::ActivateGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::activate_gateway::ActivateGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::activate_gateway::ActivateGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_activate_gateway::ser_activate_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::activate_gateway::ActivateGateway::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ActivateGateway", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for ActivateGateway {
                type Output = std::result::Result<crate::operation::activate_gateway::ActivateGatewayOutput, crate::operation::activate_gateway::ActivateGatewayError>;
