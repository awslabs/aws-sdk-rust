...
impl ActivateGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::activate_gateway::ActivateGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ActivateGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_activate_gateway::de_activate_gateway_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::activate_gateway::ActivateGatewayError
{
