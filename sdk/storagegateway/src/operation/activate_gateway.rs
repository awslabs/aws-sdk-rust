...
impl ActivateGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::activate_gateway::ActivateGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_activate_gateway::ser_activate_gateway_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ActivateGateway {
    type Output =
        ::std::result::Result<crate::operation::activate_gateway::ActivateGatewayOutput, crate::operation::activate_gateway::ActivateGatewayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_activate_gateway::de_activate_gateway_http_response_with_props(status, headers, body)
        }
    }
}
