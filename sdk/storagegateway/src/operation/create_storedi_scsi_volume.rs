...
impl CreateStorediSCSIVolume {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateStorediSCSIVolume {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateStorediSCSIVolume");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateStorediSCSIVolumeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateStorediSCSIVolumeResponseDeserializer));
...
.with_interceptor(CreateStorediSCSIVolumeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_storedi_scsi_volume::de_create_storedi_scsi_volume_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateStorediSCSIVolumeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateStorediSCSIVolumeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_storedi_scsi_volume::ser_create_storedi_scsi_volume_input(&input)?);
...
#[derive(Debug)]
            struct CreateStorediSCSIVolumeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateStorediSCSIVolumeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateStorediSCSIVolumeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateStorediScsiVolumeInput>()
                        .ok_or("failed to downcast to CreateStorediScsiVolumeInput")?;
...
pub enum CreateStorediSCSIVolumeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateStorediSCSIVolumeError) for what information is available for the error.")]
...
impl CreateStorediSCSIVolumeError {
    /// Creates the `CreateStorediSCSIVolumeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateStorediSCSIVolumeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateStorediSCSIVolumeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_storedi_scsi_volume::CreateStorediSCSIVolumeError {
