...
impl CreateStorediSCSIVolume {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Storage Gateway.CreateStorediSCSIVolume",
            "rpc.service" = "Storage Gateway",
            "rpc.method" = "CreateStorediSCSIVolume",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateStorediSCSIVolume")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateStorediSCSIVolumeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_storedi_scsi_volume::de_create_storedi_scsi_volume_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_storedi_scsi_volume::de_create_storedi_scsi_volume_http_response(status, headers, body, _cfg)
        };
