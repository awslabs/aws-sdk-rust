...
impl DeleteAutomaticTapeCreationPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
