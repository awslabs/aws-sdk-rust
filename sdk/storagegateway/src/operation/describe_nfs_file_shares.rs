...
impl DescribeNfsFileSharesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_nfs_file_shares::DescribeNFSFileShares,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNFSFileShares {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_nfs_file_shares::de_describe_nfs_file_shares_http_response_with_props(status, headers, body)
        }
    }
}
