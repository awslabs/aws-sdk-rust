...
/// Orchestration and serialization glue logic for `DescribeNFSFileShares`.
...
impl DescribeNFSFileShares {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeNFSFileShares {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeNFSFileShares");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeNFSFileSharesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeNFSFileSharesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeNFSFileShares")
...
.with_interceptor(DescribeNFSFileSharesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError>::new());
...
#[derive(Debug)]
            struct DescribeNFSFileSharesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeNFSFileSharesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_nfs_file_shares::de_describe_nfs_file_shares_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_nfs_file_shares::de_describe_nfs_file_shares_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeNFSFileSharesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeNFSFileSharesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_nfs_file_shares::ser_describe_nfs_file_shares_input(&input)?);
...
#[derive(Debug)]
            struct DescribeNFSFileSharesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeNFSFileSharesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeNFSFileSharesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeNfsFileSharesInput>()
                        .ok_or("failed to downcast to DescribeNfsFileSharesInput")?;
...
pub enum DescribeNFSFileSharesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeNFSFileSharesError) for what information is available for the error.")]
...
impl DescribeNFSFileSharesError {
    /// Creates the `DescribeNFSFileSharesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNFSFileSharesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeNFSFileSharesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError {
...
mod _describe_nfs_file_shares_output;
