...
impl DescribeNfsFileSharesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNFSFileShares`](crate::operation::describe_nfs_file_shares::DescribeNFSFileShares)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_nfs_file_shares::DescribeNFSFileShares, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_nfs_file_shares::ser_describe_nfs_file_shares_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_nfs_file_shares::DescribeNFSFileShares::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeNFSFileShares", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeNFSFileShares {
                type Output = std::result::Result<crate::operation::describe_nfs_file_shares::DescribeNfsFileSharesOutput, crate::operation::describe_nfs_file_shares::DescribeNFSFileSharesError>;
