...
impl UpdateAutomaticTapeCreationPolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAutomaticTapeCreationPolicy`](crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_automatic_tape_creation_policy::ser_update_automatic_tape_creation_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateAutomaticTapeCreationPolicy", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAutomaticTapeCreationPolicy {
                type Output = std::result::Result<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyOutput, crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError>;
...
impl aws_http::request_id::RequestId for crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError {
