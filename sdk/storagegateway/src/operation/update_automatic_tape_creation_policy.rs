...
impl UpdateAutomaticTapeCreationPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyInput,
                    ) -> ::std::result::Result<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAutomaticTapeCreationPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateAutomaticTapeCreationPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateAutomaticTapeCreationPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateAutomaticTapeCreationPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAutomaticTapeCreationPolicy")
...
.with_interceptor(UpdateAutomaticTapeCreationPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_automatic_tape_creation_policy::de_update_automatic_tape_creation_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_automatic_tape_creation_policy::de_update_automatic_tape_creation_policy_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAutomaticTapeCreationPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_automatic_tape_creation_policy::ser_update_automatic_tape_creation_policy_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAutomaticTapeCreationPolicyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateAutomaticTapeCreationPolicyInput>()
                        .ok_or("failed to downcast to UpdateAutomaticTapeCreationPolicyInput")?;
...
pub enum UpdateAutomaticTapeCreationPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateAutomaticTapeCreationPolicyError) for what information is available for the error.")]
...
impl UpdateAutomaticTapeCreationPolicyError {
    /// Creates the `UpdateAutomaticTapeCreationPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateAutomaticTapeCreationPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateAutomaticTapeCreationPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicyError {
...
mod _update_automatic_tape_creation_policy_output;
