...
impl UpdateAutomaticTapeCreationPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_automatic_tape_creation_policy::UpdateAutomaticTapeCreationPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAutomaticTapeCreationPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_automatic_tape_creation_policy::de_update_automatic_tape_creation_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
