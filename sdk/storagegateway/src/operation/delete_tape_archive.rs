...
impl DeleteTapeArchiveInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTapeArchive`](crate::operation::delete_tape_archive::DeleteTapeArchive)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_tape_archive::DeleteTapeArchive, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_tape_archive::DeleteTapeArchiveInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_tape_archive::ser_delete_tape_archive_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_tape_archive::DeleteTapeArchive::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteTapeArchive", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTapeArchive {
                type Output = std::result::Result<crate::operation::delete_tape_archive::DeleteTapeArchiveOutput, crate::operation::delete_tape_archive::DeleteTapeArchiveError>;
