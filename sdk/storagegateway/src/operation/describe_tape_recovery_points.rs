...
impl DescribeTapeRecoveryPoints {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTapeRecoveryPoints {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeTapeRecoveryPoints");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeTapeRecoveryPointsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeTapeRecoveryPointsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTapeRecoveryPoints")
...
.with_interceptor(DescribeTapeRecoveryPointsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError>::new());
...
#[derive(Debug)]
            struct DescribeTapeRecoveryPointsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTapeRecoveryPointsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_tape_recovery_points::de_describe_tape_recovery_points_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_tape_recovery_points::de_describe_tape_recovery_points_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeTapeRecoveryPointsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTapeRecoveryPointsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_tape_recovery_points::ser_describe_tape_recovery_points_input(&input)?);
...
#[derive(Debug)]
            struct DescribeTapeRecoveryPointsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeTapeRecoveryPointsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeTapeRecoveryPointsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeTapeRecoveryPointsInput>()
                        .ok_or("failed to downcast to DescribeTapeRecoveryPointsInput")?;
...
pub enum DescribeTapeRecoveryPointsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeTapeRecoveryPointsError) for what information is available for the error.")]
...
impl DescribeTapeRecoveryPointsError {
    /// Creates the `DescribeTapeRecoveryPointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeTapeRecoveryPointsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeTapeRecoveryPointsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_tape_recovery_points::_describe_tape_recovery_points_output::DescribeTapeRecoveryPointsOutput;

pub use crate::operation::describe_tape_recovery_points::_describe_tape_recovery_points_input::DescribeTapeRecoveryPointsInput;

mod _describe_tape_recovery_points_input;

mod _describe_tape_recovery_points_output;
