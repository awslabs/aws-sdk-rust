...
impl DescribeTapeRecoveryPointsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTapeRecoveryPoints`](crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_tape_recovery_points::ser_describe_tape_recovery_points_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeTapeRecoveryPoints", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTapeRecoveryPoints {
                type Output = std::result::Result<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput, crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsError>;
