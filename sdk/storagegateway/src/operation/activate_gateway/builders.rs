...
impl ActivateGatewayFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::activate_gateway::ActivateGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::activate_gateway::ActivateGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::activate_gateway::ActivateGatewayOutput, crate::operation::activate_gateway::ActivateGatewayError, Self> {
