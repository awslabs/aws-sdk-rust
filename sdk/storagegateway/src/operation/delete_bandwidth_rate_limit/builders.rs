...
impl DeleteBandwidthRateLimitFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitOutput, crate::operation::delete_bandwidth_rate_limit::DeleteBandwidthRateLimitError, Self> {
