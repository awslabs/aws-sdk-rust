...
impl DeleteSnapshotScheduleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSnapshotSchedule`](crate::operation::delete_snapshot_schedule::DeleteSnapshotSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_snapshot_schedule::DeleteSnapshotSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_snapshot_schedule::DeleteSnapshotScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_snapshot_schedule::ser_delete_snapshot_schedule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_snapshot_schedule::DeleteSnapshotSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteSnapshotSchedule", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSnapshotSchedule {
                type Output = std::result::Result<crate::operation::delete_snapshot_schedule::DeleteSnapshotScheduleOutput, crate::operation::delete_snapshot_schedule::DeleteSnapshotScheduleError>;
