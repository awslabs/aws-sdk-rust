...
impl DeleteSnapshotScheduleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_snapshot_schedule::DeleteSnapshotSchedule,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSnapshotSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_snapshot_schedule::de_delete_snapshot_schedule_http_response_with_props(status, headers, body)
        }
    }
}
