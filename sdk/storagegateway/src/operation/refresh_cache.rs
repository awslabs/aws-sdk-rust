...
impl RefreshCacheInput {
    /// Consumes the builder and constructs an Operation<[`RefreshCache`](crate::operation::refresh_cache::RefreshCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::refresh_cache::RefreshCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::refresh_cache::RefreshCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_refresh_cache::ser_refresh_cache_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::refresh_cache::RefreshCache::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RefreshCache", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for RefreshCache {
                type Output = std::result::Result<crate::operation::refresh_cache::RefreshCacheOutput, crate::operation::refresh_cache::RefreshCacheError>;
