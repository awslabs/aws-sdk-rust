...
impl RefreshCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::refresh_cache::RefreshCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_refresh_cache::ser_refresh_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RefreshCache {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_refresh_cache::de_refresh_cache_http_response_with_props(status, headers, body)
        }
    }
}
