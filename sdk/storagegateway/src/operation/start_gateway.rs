...
impl StartGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_gateway::StartGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_gateway::de_start_gateway_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_gateway::de_start_gateway_http_response_with_props(
                status, headers, body,
            )
        }
    }
