...
impl StartGatewayInput {
    /// Consumes the builder and constructs an Operation<[`StartGateway`](crate::operation::start_gateway::StartGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_gateway::StartGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_gateway::StartGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_gateway::ser_start_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_gateway::StartGateway::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartGateway", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartGateway {
                type Output = std::result::Result<crate::operation::start_gateway::StartGatewayOutput, crate::operation::start_gateway::StartGatewayError>;
