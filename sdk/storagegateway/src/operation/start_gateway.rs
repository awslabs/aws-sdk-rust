...
impl StartGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_gateway::StartGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_gateway::ser_start_gateway_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_gateway::de_start_gateway_http_response_with_props(status, headers, body)
        }
    }
}
