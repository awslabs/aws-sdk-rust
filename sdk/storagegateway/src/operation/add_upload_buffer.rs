...
impl AddUploadBufferInput {
    /// Consumes the builder and constructs an Operation<[`AddUploadBuffer`](crate::operation::add_upload_buffer::AddUploadBuffer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_upload_buffer::AddUploadBuffer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_upload_buffer::AddUploadBufferInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_upload_buffer::ser_add_upload_buffer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_upload_buffer::AddUploadBuffer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddUploadBuffer", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddUploadBuffer {
                type Output = std::result::Result<crate::operation::add_upload_buffer::AddUploadBufferOutput, crate::operation::add_upload_buffer::AddUploadBufferError>;
