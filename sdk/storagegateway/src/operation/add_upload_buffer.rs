...
impl AddUploadBufferInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_upload_buffer::AddUploadBuffer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_upload_buffer::ser_add_upload_buffer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddUploadBuffer {
    type Output =
        ::std::result::Result<crate::operation::add_upload_buffer::AddUploadBufferOutput, crate::operation::add_upload_buffer::AddUploadBufferError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_upload_buffer::de_add_upload_buffer_http_response_with_props(status, headers, body)
        }
    }
}
