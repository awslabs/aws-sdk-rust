...
/// Orchestration and serialization glue logic for `AddUploadBuffer`.
...
impl AddUploadBuffer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::add_upload_buffer::AddUploadBufferInput,
                    ) -> ::std::result::Result<crate::operation::add_upload_buffer::AddUploadBufferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_upload_buffer::AddUploadBufferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_upload_buffer::AddUploadBufferError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_upload_buffer::AddUploadBufferOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddUploadBuffer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddUploadBuffer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddUploadBufferRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddUploadBufferResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddUploadBuffer")
...
.with_interceptor(AddUploadBufferEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_upload_buffer::AddUploadBufferError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_upload_buffer::AddUploadBufferError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_upload_buffer::AddUploadBufferError>::new());
...
#[derive(Debug)]
            struct AddUploadBufferResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddUploadBufferResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_upload_buffer::de_add_upload_buffer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_add_upload_buffer::de_add_upload_buffer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AddUploadBufferRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddUploadBufferRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_upload_buffer::AddUploadBufferInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_upload_buffer::AddUploadBufferInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_upload_buffer::ser_add_upload_buffer_input(&input)?);
...
#[derive(Debug)]
            struct AddUploadBufferEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddUploadBufferEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddUploadBufferEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddUploadBufferInput>()
                        .ok_or("failed to downcast to AddUploadBufferInput")?;
...
pub enum AddUploadBufferError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddUploadBufferError) for what information is available for the error.")]
...
impl AddUploadBufferError {
    /// Creates the `AddUploadBufferError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddUploadBufferError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddUploadBufferError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_upload_buffer::AddUploadBufferError {
