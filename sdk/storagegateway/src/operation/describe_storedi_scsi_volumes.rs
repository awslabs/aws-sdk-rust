...
impl DescribeStorediScsiVolumesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStorediSCSIVolumes`](crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_storedi_scsi_volumes::ser_describe_storedi_scsi_volumes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeStorediSCSIVolumes", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeStorediSCSIVolumes {
                type Output = std::result::Result<crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesOutput, crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError>;
