...
impl DescribeStorediSCSIVolumes {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeStorediSCSIVolumes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeStorediSCSIVolumes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeStorediSCSIVolumesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeStorediSCSIVolumesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeStorediSCSIVolumes")
...
.with_interceptor(DescribeStorediSCSIVolumesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError>::new());
...
#[derive(Debug)]
            struct DescribeStorediSCSIVolumesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeStorediSCSIVolumesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_storedi_scsi_volumes::de_describe_storedi_scsi_volumes_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_storedi_scsi_volumes::de_describe_storedi_scsi_volumes_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeStorediSCSIVolumesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeStorediSCSIVolumesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_storedi_scsi_volumes::DescribeStorediScsiVolumesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_storedi_scsi_volumes::ser_describe_storedi_scsi_volumes_input(&input)?);
...
#[derive(Debug)]
            struct DescribeStorediSCSIVolumesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeStorediSCSIVolumesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeStorediSCSIVolumesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeStorediScsiVolumesInput>()
                        .ok_or("failed to downcast to DescribeStorediScsiVolumesInput")?;
...
pub enum DescribeStorediSCSIVolumesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeStorediSCSIVolumesError) for what information is available for the error.")]
...
impl DescribeStorediSCSIVolumesError {
    /// Creates the `DescribeStorediSCSIVolumesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeStorediSCSIVolumesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeStorediSCSIVolumesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_storedi_scsi_volumes::DescribeStorediSCSIVolumesError {
...
mod _describe_storedi_scsi_volumes_output;
