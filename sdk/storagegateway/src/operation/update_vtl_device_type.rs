...
impl UpdateVtlDeviceTypeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVTLDeviceType`](crate::operation::update_vtl_device_type::UpdateVTLDeviceType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_vtl_device_type::UpdateVTLDeviceType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_vtl_device_type::UpdateVtlDeviceTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_vtl_device_type::ser_update_vtl_device_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_vtl_device_type::UpdateVTLDeviceType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateVTLDeviceType", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVTLDeviceType {
                type Output = std::result::Result<crate::operation::update_vtl_device_type::UpdateVtlDeviceTypeOutput, crate::operation::update_vtl_device_type::UpdateVTLDeviceTypeError>;
