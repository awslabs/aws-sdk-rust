...
impl UpdateVtlDeviceTypeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_vtl_device_type::ser_update_vtl_device_type_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_vtl_device_type::UpdateVTLDeviceType::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_vtl_device_type::UpdateVTLDeviceTypeError
{
