...
impl RetrieveTapeArchive {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RetrieveTapeArchive {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RetrieveTapeArchive");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RetrieveTapeArchiveRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RetrieveTapeArchiveResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RetrieveTapeArchive")
...
.with_interceptor(RetrieveTapeArchiveEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError>::new());
...
#[derive(Debug)]
            struct RetrieveTapeArchiveResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetrieveTapeArchiveResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_retrieve_tape_archive::de_retrieve_tape_archive_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RetrieveTapeArchiveRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetrieveTapeArchiveRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::retrieve_tape_archive::RetrieveTapeArchiveInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_retrieve_tape_archive::ser_retrieve_tape_archive_input(&input)?);
...
#[derive(Debug)]
            struct RetrieveTapeArchiveEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RetrieveTapeArchiveEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RetrieveTapeArchiveEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RetrieveTapeArchiveInput>()
                        .ok_or("failed to downcast to RetrieveTapeArchiveInput")?;
...
pub enum RetrieveTapeArchiveError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RetrieveTapeArchiveError) for what information is available for the error.")]
...
impl RetrieveTapeArchiveError {
    /// Creates the `RetrieveTapeArchiveError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RetrieveTapeArchiveError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RetrieveTapeArchiveError {
...
impl ::aws_types::request_id::RequestId for crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError {
