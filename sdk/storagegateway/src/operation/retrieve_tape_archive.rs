...
impl RetrieveTapeArchiveInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_retrieve_tape_archive::ser_retrieve_tape_archive_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::retrieve_tape_archive::RetrieveTapeArchive::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError
{
