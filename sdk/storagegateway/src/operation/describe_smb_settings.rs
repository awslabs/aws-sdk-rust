...
impl DescribeSmbSettingsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_smb_settings::ser_describe_smb_settings_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_smb_settings::DescribeSMBSettings::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_smb_settings::DescribeSMBSettingsError
{
