...
impl DescribeSmbSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSMBSettings`](crate::operation::describe_smb_settings::DescribeSMBSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_smb_settings::DescribeSMBSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_smb_settings::DescribeSmbSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_smb_settings::ser_describe_smb_settings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_smb_settings::DescribeSMBSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeSMBSettings", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSMBSettings {
                type Output = std::result::Result<crate::operation::describe_smb_settings::DescribeSmbSettingsOutput, crate::operation::describe_smb_settings::DescribeSMBSettingsError>;
