...
impl DescribeVtlDevicesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_vtl_devices::ser_describe_vtl_devices_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVTLDevices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vtl_devices::de_describe_vtl_devices_http_response_with_props(status, headers, body)
        }
    }
}
