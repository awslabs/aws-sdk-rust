...
impl DescribeVtlDevicesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vtl_devices::ser_describe_vtl_devices_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_vtl_devices::DescribeVTLDevices::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_vtl_devices::DescribeVTLDevicesError
{
