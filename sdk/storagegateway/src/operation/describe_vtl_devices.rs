...
impl DescribeVtlDevicesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVTLDevices`](crate::operation::describe_vtl_devices::DescribeVTLDevices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_vtl_devices::DescribeVTLDevices, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_vtl_devices::DescribeVtlDevicesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vtl_devices::ser_describe_vtl_devices_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_vtl_devices::DescribeVTLDevices::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeVTLDevices", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeVTLDevices {
                type Output = std::result::Result<crate::operation::describe_vtl_devices::DescribeVtlDevicesOutput, crate::operation::describe_vtl_devices::DescribeVTLDevicesError>;
