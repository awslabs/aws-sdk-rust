...
impl DescribeTapeArchivesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_tape_archives::DescribeTapeArchivesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_tape_archives::DescribeTapeArchivesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_tape_archives::DescribeTapeArchivesOutput, crate::operation::describe_tape_archives::DescribeTapeArchivesError, Self> {
