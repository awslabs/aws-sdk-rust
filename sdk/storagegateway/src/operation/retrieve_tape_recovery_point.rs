...
impl RetrieveTapeRecoveryPointInput {
    /// Consumes the builder and constructs an Operation<[`RetrieveTapeRecoveryPoint`](crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_retrieve_tape_recovery_point::ser_retrieve_tape_recovery_point_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RetrieveTapeRecoveryPoint", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for RetrieveTapeRecoveryPoint {
                type Output = std::result::Result<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointOutput, crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError>;
