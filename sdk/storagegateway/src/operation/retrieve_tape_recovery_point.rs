...
impl RetrieveTapeRecoveryPointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPoint,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPoint::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetrieveTapeRecoveryPoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_retrieve_tape_recovery_point::de_retrieve_tape_recovery_point_http_response_with_props(status, headers, body)
        }
    }
}
