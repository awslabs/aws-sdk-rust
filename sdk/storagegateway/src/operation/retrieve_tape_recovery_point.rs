...
/// Orchestration and serialization glue logic for `RetrieveTapeRecoveryPoint`.
...
impl RetrieveTapeRecoveryPoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointInput,
                    ) -> ::std::result::Result<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RetrieveTapeRecoveryPoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RetrieveTapeRecoveryPoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RetrieveTapeRecoveryPointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RetrieveTapeRecoveryPointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RetrieveTapeRecoveryPoint")
...
.with_interceptor(RetrieveTapeRecoveryPointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError>::new());
...
#[derive(Debug)]
            struct RetrieveTapeRecoveryPointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetrieveTapeRecoveryPointResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_retrieve_tape_recovery_point::de_retrieve_tape_recovery_point_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_retrieve_tape_recovery_point::de_retrieve_tape_recovery_point_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RetrieveTapeRecoveryPointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetrieveTapeRecoveryPointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_retrieve_tape_recovery_point::ser_retrieve_tape_recovery_point_input(&input)?);
...
#[derive(Debug)]
            struct RetrieveTapeRecoveryPointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RetrieveTapeRecoveryPointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RetrieveTapeRecoveryPointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RetrieveTapeRecoveryPointInput>()
                        .ok_or("failed to downcast to RetrieveTapeRecoveryPointInput")?;
...
pub enum RetrieveTapeRecoveryPointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RetrieveTapeRecoveryPointError) for what information is available for the error.")]
...
impl RetrieveTapeRecoveryPointError {
    /// Creates the `RetrieveTapeRecoveryPointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RetrieveTapeRecoveryPointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RetrieveTapeRecoveryPointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointError {
...
mod _retrieve_tape_recovery_point_output;
