...
impl ListAutomaticTapeCreationPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_automatic_tape_creation_policies::ListAutomaticTapeCreationPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
