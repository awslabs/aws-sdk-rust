...
impl DescribeTapesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Tape, ::aws_smithy_http::result::SdkError<crate::operation::describe_tapes::DescribeTapesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_describe_tapes_output_tapes(page).unwrap_or_default().into_iter())
    }
}
