...
impl AddWorkingStorageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_working_storage::ser_add_working_storage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddWorkingStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_working_storage::de_add_working_storage_http_response_with_props(status, headers, body)
        }
    }
}
