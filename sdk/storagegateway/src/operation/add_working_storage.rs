...
impl AddWorkingStorageInput {
    /// Consumes the builder and constructs an Operation<[`AddWorkingStorage`](crate::operation::add_working_storage::AddWorkingStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_working_storage::AddWorkingStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_working_storage::AddWorkingStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_working_storage::ser_add_working_storage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_working_storage::AddWorkingStorage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddWorkingStorage", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddWorkingStorage {
                type Output = std::result::Result<crate::operation::add_working_storage::AddWorkingStorageOutput, crate::operation::add_working_storage::AddWorkingStorageError>;
