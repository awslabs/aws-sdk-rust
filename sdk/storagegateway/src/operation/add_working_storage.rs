...
impl AddWorkingStorageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_working_storage::AddWorkingStorage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddWorkingStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_add_working_storage::de_add_working_storage_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_working_storage::AddWorkingStorageError
{
