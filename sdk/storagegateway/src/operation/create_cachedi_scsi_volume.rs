...
impl CreateCachediScsiVolumeInput {
    /// Consumes the builder and constructs an Operation<[`CreateCachediSCSIVolume`](crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolume)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolume, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_cachedi_scsi_volume::ser_create_cachedi_scsi_volume_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolume::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateCachediSCSIVolume", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateCachediSCSIVolume {
                type Output = std::result::Result<crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeOutput, crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError>;
