...
/// Orchestration and serialization glue logic for `CreateCachediSCSIVolume`.
...
impl CreateCachediSCSIVolume {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCachediSCSIVolume {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCachediSCSIVolume");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCachediSCSIVolumeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCachediSCSIVolumeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCachediSCSIVolume")
...
.with_interceptor(CreateCachediSCSIVolumeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError>::new());
...
#[derive(Debug)]
            struct CreateCachediSCSIVolumeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCachediSCSIVolumeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_cachedi_scsi_volume::de_create_cachedi_scsi_volume_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_cachedi_scsi_volume::de_create_cachedi_scsi_volume_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateCachediSCSIVolumeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCachediSCSIVolumeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_cachedi_scsi_volume::CreateCachediScsiVolumeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_cachedi_scsi_volume::ser_create_cachedi_scsi_volume_input(&input)?);
...
#[derive(Debug)]
            struct CreateCachediSCSIVolumeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCachediSCSIVolumeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCachediSCSIVolumeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCachediScsiVolumeInput>()
                        .ok_or("failed to downcast to CreateCachediScsiVolumeInput")?;
...
pub enum CreateCachediSCSIVolumeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCachediSCSIVolumeError) for what information is available for the error.")]
...
impl CreateCachediSCSIVolumeError {
    /// Creates the `CreateCachediSCSIVolumeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCachediSCSIVolumeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCachediSCSIVolumeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_cachedi_scsi_volume::CreateCachediSCSIVolumeError {
...
mod _create_cachedi_scsi_volume_output;
