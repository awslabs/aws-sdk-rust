...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::cancel_retrieval::CancelRetrievalOutput,
                    crate::operation::cancel_retrieval::CancelRetrievalError,
                > for CancelRetrievalFluentBuilder
            {
                fn send(
                    self,
...
impl CancelRetrievalFluentBuilder {
    ...
    /// Access the CancelRetrieval as a reference.
    pub fn as_input(&self) -> &crate::operation::cancel_retrieval::builders::CancelRetrievalInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_retrieval::CancelRetrievalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_retrieval::CancelRetrievalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::cancel_retrieval::CancelRetrieval::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::cancel_retrieval::CancelRetrieval::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_retrieval::CancelRetrievalOutput, crate::operation::cancel_retrieval::CancelRetrievalError, Self> {
