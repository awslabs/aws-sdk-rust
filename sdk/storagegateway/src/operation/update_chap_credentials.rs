...
impl UpdateChapCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateChapCredentials`](crate::operation::update_chap_credentials::UpdateChapCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_chap_credentials::UpdateChapCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_chap_credentials::UpdateChapCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_chap_credentials::ser_update_chap_credentials_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_chap_credentials::UpdateChapCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateChapCredentials", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateChapCredentials {
                type Output = std::result::Result<crate::operation::update_chap_credentials::UpdateChapCredentialsOutput, crate::operation::update_chap_credentials::UpdateChapCredentialsError>;
