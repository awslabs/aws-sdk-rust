...
impl DescribeSmbFileSharesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSMBFileShares`](crate::operation::describe_smb_file_shares::DescribeSMBFileShares)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_smb_file_shares::DescribeSMBFileShares, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_smb_file_shares::DescribeSmbFileSharesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_smb_file_shares::ser_describe_smb_file_shares_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_smb_file_shares::DescribeSMBFileShares::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeSMBFileShares", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSMBFileShares {
                type Output = std::result::Result<crate::operation::describe_smb_file_shares::DescribeSmbFileSharesOutput, crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError>;
