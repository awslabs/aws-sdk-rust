...
/// Orchestration and serialization glue logic for `DescribeSMBFileShares`.
...
impl DescribeSMBFileShares {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_smb_file_shares::DescribeSmbFileSharesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_smb_file_shares::DescribeSmbFileSharesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSMBFileShares {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeSMBFileShares");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeSMBFileSharesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeSMBFileSharesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSMBFileShares")
...
.with_interceptor(DescribeSMBFileSharesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError>::new());
...
#[derive(Debug)]
            struct DescribeSMBFileSharesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeSMBFileSharesResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeSMBFileSharesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeSMBFileSharesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_smb_file_shares::DescribeSmbFileSharesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_smb_file_shares::DescribeSmbFileSharesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_smb_file_shares::ser_describe_smb_file_shares_input(&input)?);
...
#[derive(Debug)]
            struct DescribeSMBFileSharesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSMBFileSharesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeSMBFileSharesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeSmbFileSharesInput>()
                        .ok_or("failed to downcast to DescribeSmbFileSharesInput")?;
...
pub enum DescribeSMBFileSharesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeSMBFileSharesError) for what information is available for the error.")]
...
impl DescribeSMBFileSharesError {
    /// Creates the `DescribeSMBFileSharesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSMBFileSharesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeSMBFileSharesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_smb_file_shares::DescribeSMBFileSharesError {
...
mod _describe_smb_file_shares_output;
