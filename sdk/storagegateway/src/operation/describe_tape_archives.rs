...
impl DescribeTapeArchivesInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_tape_archives::ser_describe_tape_archives_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_tape_archives::DescribeTapeArchives::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_tape_archives::DescribeTapeArchivesError
{
