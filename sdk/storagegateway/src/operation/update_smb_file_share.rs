...
impl UpdateSmbFileShareInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_smb_file_share::ser_update_smb_file_share_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_smb_file_share::UpdateSMBFileShare::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_smb_file_share::UpdateSMBFileShareError
{
