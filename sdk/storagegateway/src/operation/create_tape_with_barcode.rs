...
impl CreateTapeWithBarcodeInput {
    /// Consumes the builder and constructs an Operation<[`CreateTapeWithBarcode`](crate::operation::create_tape_with_barcode::CreateTapeWithBarcode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_tape_with_barcode::CreateTapeWithBarcode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_tape_with_barcode::CreateTapeWithBarcodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_tape_with_barcode::ser_create_tape_with_barcode_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_tape_with_barcode::CreateTapeWithBarcode::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateTapeWithBarcode", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTapeWithBarcode {
                type Output = std::result::Result<crate::operation::create_tape_with_barcode::CreateTapeWithBarcodeOutput, crate::operation::create_tape_with_barcode::CreateTapeWithBarcodeError>;
