...
impl ListFileSharesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_file_shares::ListFileShares,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_file_shares::ListFileShares::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFileShares {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_file_shares::de_list_file_shares_http_error(
                status, headers, body,
            )
        } else {
