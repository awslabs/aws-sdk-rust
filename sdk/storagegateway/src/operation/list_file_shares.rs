...
impl ListFileSharesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_file_shares::ListFileShares, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_file_shares::ser_list_file_shares_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFileShares {
    type Output =
        ::std::result::Result<crate::operation::list_file_shares::ListFileSharesOutput, crate::operation::list_file_shares::ListFileSharesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_file_shares::de_list_file_shares_http_response_with_props(status, headers, body)
        }
    }
}
