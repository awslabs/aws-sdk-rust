...
impl ListFileSharesInput {
    /// Consumes the builder and constructs an Operation<[`ListFileShares`](crate::operation::list_file_shares::ListFileShares)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_file_shares::ListFileShares, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_file_shares::ListFileSharesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_file_shares::ser_list_file_shares_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_file_shares::ListFileShares::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListFileShares", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListFileShares {
                type Output = std::result::Result<crate::operation::list_file_shares::ListFileSharesOutput, crate::operation::list_file_shares::ListFileSharesError>;
