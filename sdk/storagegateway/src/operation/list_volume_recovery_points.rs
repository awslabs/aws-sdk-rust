...
impl ListVolumeRecoveryPointsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_volume_recovery_points::ListVolumeRecoveryPoints::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVolumeRecoveryPoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_volume_recovery_points::de_list_volume_recovery_points_http_response_with_props(status, headers, body)
        }
    }
}
