...
impl ListVolumeRecoveryPointsInput {
    /// Consumes the builder and constructs an Operation<[`ListVolumeRecoveryPoints`](crate::operation::list_volume_recovery_points::ListVolumeRecoveryPoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_volume_recovery_points::ListVolumeRecoveryPoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_volume_recovery_points::ListVolumeRecoveryPointsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_volume_recovery_points::ser_list_volume_recovery_points_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_volume_recovery_points::ListVolumeRecoveryPoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListVolumeRecoveryPoints", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListVolumeRecoveryPoints {
                type Output = std::result::Result<crate::operation::list_volume_recovery_points::ListVolumeRecoveryPointsOutput, crate::operation::list_volume_recovery_points::ListVolumeRecoveryPointsError>;
