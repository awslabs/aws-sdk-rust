...
impl UpdateSmbFileShareVisibilityInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSMBFileShareVisibility`](crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibility)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibility, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_smb_file_share_visibility::UpdateSmbFileShareVisibilityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_smb_file_share_visibility::ser_update_smb_file_share_visibility_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibility::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSMBFileShareVisibility", "storagegateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSMBFileShareVisibility {
                type Output = std::result::Result<crate::operation::update_smb_file_share_visibility::UpdateSmbFileShareVisibilityOutput, crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibilityError>;
