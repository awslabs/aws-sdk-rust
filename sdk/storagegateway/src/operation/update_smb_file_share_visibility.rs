...
impl UpdateSmbFileShareVisibilityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibility::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSMBFileShareVisibility {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_smb_file_share_visibility::de_update_smb_file_share_visibility_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateSMBFileShareVisibilityError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_smb_file_share_visibility::UpdateSMBFileShareVisibilityError
{
