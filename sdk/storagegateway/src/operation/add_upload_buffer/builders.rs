...
impl AddUploadBufferFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_upload_buffer::AddUploadBufferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_upload_buffer::AddUploadBufferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_upload_buffer::AddUploadBufferOutput, crate::operation::add_upload_buffer::AddUploadBufferError, Self> {
