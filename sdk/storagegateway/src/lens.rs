...
pub(crate) fn reflens_describe_tape_archives_output_marker(
...
pub(crate) fn reflens_describe_tape_recovery_points_output_marker(
...
pub(crate) fn reflens_describe_tapes_output_marker(
...
pub(crate) fn reflens_describe_vtl_devices_output_marker(
...
pub(crate) fn reflens_list_file_shares_output_next_marker(
...
pub(crate) fn reflens_list_file_system_associations_output_next_marker(
...
pub(crate) fn reflens_list_gateways_output_marker(
...
pub(crate) fn reflens_list_tags_for_resource_output_marker(
...
pub(crate) fn reflens_list_tape_pools_output_marker(
...
pub(crate) fn reflens_list_tapes_output_marker(
...
pub(crate) fn reflens_list_volumes_output_marker(
...
pub(crate) fn lens_describe_tape_archives_output_tape_archives(
    input: crate::operation::describe_tape_archives::DescribeTapeArchivesOutput,
...
pub(crate) fn lens_describe_tape_recovery_points_output_tape_recovery_point_infos(
    input: crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsOutput,
...
pub(crate) fn lens_describe_tapes_output_tapes(
    input: crate::operation::describe_tapes::DescribeTapesOutput,
...
pub(crate) fn lens_describe_vtl_devices_output_vtl_devices(
    input: crate::operation::describe_vtl_devices::DescribeVtlDevicesOutput,
...
pub(crate) fn lens_list_file_shares_output_file_share_info_list(
    input: crate::operation::list_file_shares::ListFileSharesOutput,
...
pub(crate) fn lens_list_file_system_associations_output_file_system_association_summary_list(
    input: crate::operation::list_file_system_associations::ListFileSystemAssociationsOutput,
...
pub(crate) fn lens_list_tape_pools_output_pool_infos(
    input: crate::operation::list_tape_pools::ListTapePoolsOutput,
...
pub(crate) fn lens_list_tapes_output_tape_infos(
    input: crate::operation::list_tapes::ListTapesOutput,
...
pub(crate) fn lens_list_volumes_output_volume_infos(
    input: crate::operation::list_volumes::ListVolumesOutput,
