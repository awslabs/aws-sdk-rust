...
pub(crate) fn reflens_get_clusters_for_image_output_output_next_token(
    input: &crate::operation::get_clusters_for_image::GetClustersForImageOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_get_clusters_for_image_output_output_cluster(
    input: crate::operation::get_clusters_for_image::GetClustersForImageOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ClusterInformation>> {
    let input = input.cluster;
    ::std::option::Option::Some(input)
}
