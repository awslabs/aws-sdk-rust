...
pub fn ser_enable_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EnableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
