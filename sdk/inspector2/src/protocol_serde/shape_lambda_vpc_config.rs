...
pub(crate) fn de_lambda_vpc_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LambdaVpcConfig>, aws_smithy_json::deserialize::error::DeserializeError>
