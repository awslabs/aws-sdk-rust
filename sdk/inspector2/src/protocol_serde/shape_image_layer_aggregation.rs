...
pub fn ser_image_layer_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ImageLayerAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
