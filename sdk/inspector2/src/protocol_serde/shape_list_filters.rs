...
pub fn de_list_filters_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_filters::ListFiltersOutput, crate::operation::list_filters::ListFiltersError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_filters::ListFiltersError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
...
pub fn de_list_filters_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_filters_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_filters::ListFiltersError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::list_filters::builders::ListFiltersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
