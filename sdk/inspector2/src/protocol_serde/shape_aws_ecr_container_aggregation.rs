...
pub fn ser_aws_ecr_container_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEcrContainerAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
