...
pub fn de_get_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetConfigurationOutput, crate::error::GetConfigurationError> {
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => crate::error::GetConfigurationError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(response.body().as_ref(), output).map_err(crate::error::GetConfigurationError::unhandled)?;
                    output = output.set_retry_after_seconds(
...
pub fn de_get_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetConfigurationOutput, crate::error::GetConfigurationError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_configuration::de_get_configuration(response.body().as_ref(), output).map_err(crate::error::GetConfigurationError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_configuration(value: &[u8], mut builder: crate::output::get_configuration_output::Builder) -> Result<crate::output::get_configuration_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
