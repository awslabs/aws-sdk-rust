...
pub fn ser_package_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PackageFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_package_filter<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PackageFilter>, aws_smithy_json::deserialize::error::DeserializeError>
