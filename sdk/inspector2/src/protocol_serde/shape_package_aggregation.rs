...
pub fn ser_package_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PackageAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
