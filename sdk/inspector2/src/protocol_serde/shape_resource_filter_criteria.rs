...
pub(crate) fn de_resource_filter_criteria<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResourceFilterCriteria>, ::aws_smithy_json::deserialize::error::DeserializeError>
