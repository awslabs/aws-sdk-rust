...
pub fn ser_coverage_map_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CoverageMapFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
