...
pub fn ser_list_usage_totals_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListUsageTotalsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
