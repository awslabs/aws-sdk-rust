...
pub fn ser_ami_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AmiAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
