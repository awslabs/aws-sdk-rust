...
pub fn de_associate_member_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::associate_member::AssociateMemberOutput, crate::operation::associate_member::AssociateMemberError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::associate_member::AssociateMemberError::unhandled(
        ...
        "ServiceQuotaExceededException" => crate::operation::associate_member::AssociateMemberError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_associate_member_http_response(
    ...
    Ok({
        ...
        crate::serde_util::associate_member_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::associate_member::AssociateMemberError::unhandled)?
    })
}
...
) -> Result<crate::operation::associate_member::builders::AssociateMemberOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
