                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::search_vulnerabilities::SearchVulnerabilitiesError::unhandled(
...
> {
    Ok({
        ...
        crate::serde_util::search_vulnerabilities_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::search_vulnerabilities::SearchVulnerabilitiesError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "vulnerabilities" => {
                    builder = builder.set_vulnerabilities(crate::protocol_serde::shape_vulnerabilities::de_vulnerabilities(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
