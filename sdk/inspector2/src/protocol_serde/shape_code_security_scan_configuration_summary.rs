                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "continuousIntegrationScanSupportedEvents" => {
                            builder = builder.set_continuous_integration_scan_supported_events(
                                    crate::protocol_serde::shape_continuous_integration_scan_supported_events::de_continuous_integration_scan_supported_events(tokens, _value, depth + 1)?
                                );
                        }
                        "ruleSetCategories" => {
                        ...
                        "scopeSettings" => {
                            builder = builder.set_scope_settings(crate::protocol_serde::shape_scope_settings::de_scope_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
