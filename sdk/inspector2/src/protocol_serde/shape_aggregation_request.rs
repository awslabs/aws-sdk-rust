...
pub fn ser_aggregation_request(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AggregationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::AggregationRequest::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("AggregationRequest"))
    }
    Ok(())
}
