...
pub fn ser_lambda_function_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaFunctionAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
