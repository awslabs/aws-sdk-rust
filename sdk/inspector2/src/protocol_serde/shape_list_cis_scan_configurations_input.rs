...
pub fn ser_list_cis_scan_configurations_input_input(
    ...
    if let Some(var_1) = &input.filter_criteria {
        ...
        crate::protocol_serde::shape_list_cis_scan_configurations_filter_criteria::ser_list_cis_scan_configurations_filter_criteria(&mut object_2, var_1)?;
        object_2.finish();
    }
