...
pub fn ser_create_findings_report_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFindingsReportInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
