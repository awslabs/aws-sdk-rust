...
> {
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::enable_delegated_admin_account_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError::unhandled)?
    })
}
