...
pub fn de_update_org_ec2_deep_inspection_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationError::unhandled,
                        )?;
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_org_ec2_deep_inspection_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
pub fn ser_update_org_ec2_deep_inspection_configuration_input(
    ...
    crate::protocol_serde::shape_update_org_ec2_deep_inspection_configuration_input::ser_update_org_ec2_deep_inspection_configuration_input_input(
        &mut object,
        input,
    )?;
    object.finish();
