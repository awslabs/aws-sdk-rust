...
pub(crate) fn de_account_aggregation_response<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AccountAggregationResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
