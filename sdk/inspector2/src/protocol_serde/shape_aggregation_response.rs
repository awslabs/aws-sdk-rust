...
pub(crate) fn de_aggregation_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AggregationResponse>, aws_smithy_json::deserialize::error::DeserializeError>
