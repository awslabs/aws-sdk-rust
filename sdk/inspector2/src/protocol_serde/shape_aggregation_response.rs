...
) -> Result<Option<crate::types::AggregationResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "accountAggregation" => Some(crate::types::AggregationResponse::AccountAggregation(
                            crate::protocol_serde::shape_account_aggregation_response::de_account_aggregation_response(tokens)?.ok_or_else(|| {
                        ...
                        "amiAggregation" => Some(crate::types::AggregationResponse::AmiAggregation(
                            crate::protocol_serde::shape_ami_aggregation_response::de_ami_aggregation_response(tokens)?.ok_or_else(|| {
                        ...
                        "imageLayerAggregation" => Some(crate::types::AggregationResponse::ImageLayerAggregation(
                            crate::protocol_serde::shape_image_layer_aggregation_response::de_image_layer_aggregation_response(tokens)?.ok_or_else(
                                || {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
                        ...
                        "packageAggregation" => Some(crate::types::AggregationResponse::PackageAggregation(
                            crate::protocol_serde::shape_package_aggregation_response::de_package_aggregation_response(tokens)?.ok_or_else(|| {
                        ...
                        "repositoryAggregation" => Some(crate::types::AggregationResponse::RepositoryAggregation(
                            crate::protocol_serde::shape_repository_aggregation_response::de_repository_aggregation_response(tokens)?.ok_or_else(
                                || {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
                        ...
                        "titleAggregation" => Some(crate::types::AggregationResponse::TitleAggregation(
                            crate::protocol_serde::shape_title_aggregation_response::de_title_aggregation_response(tokens)?.ok_or_else(|| {
