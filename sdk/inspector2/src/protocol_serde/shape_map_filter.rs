...
pub(crate) fn de_map_filter<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::MapFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "comparison" => {
                            builder = builder.set_comparison(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MapComparison::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "key" => {
