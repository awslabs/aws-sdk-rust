...
pub(crate) fn de_vulnerable_package<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VulnerablePackage>, aws_smithy_json::deserialize::error::DeserializeError>
