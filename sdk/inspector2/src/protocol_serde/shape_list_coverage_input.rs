...
pub fn ser_list_coverage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCoverageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
