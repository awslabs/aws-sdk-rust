...
pub fn ser_disable_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
