...
pub fn de_batch_get_member_ec2_deep_inspection_status_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        "ThrottlingException" => {
            crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_member_ec2_deep_inspection_status_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_member_ec2_deep_inspection_status::de_batch_get_member_ec2_deep_inspection_status(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_get_member_ec2_deep_inspection_status::BatchGetMemberEc2DeepInspectionStatusError::unhandled)?;
...
pub fn ser_batch_get_member_ec2_deep_inspection_status_input(
    ...
    crate::protocol_serde::shape_batch_get_member_ec2_deep_inspection_status_input::ser_batch_get_member_ec2_deep_inspection_status_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_batch_get_member_ec2_deep_inspection_status(
    _value: &[u8],
    mut builder: crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusOutputBuilder,
) -> ::std::result::Result<
    crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusOutputBuilder,
