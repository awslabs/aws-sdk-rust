...
pub fn de_batch_get_finding_details_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_finding_details::BatchGetFindingDetailsError::unhandled(
                generic,
            ))
        }
    };
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::batch_get_finding_details::BatchGetFindingDetailsError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_finding_details_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_finding_details::de_batch_get_finding_details(_response_body, output)
            .map_err(crate::operation::batch_get_finding_details::BatchGetFindingDetailsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "findingDetails" => {
                    builder = builder.set_finding_details(crate::protocol_serde::shape_finding_details::de_finding_details(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
