...
pub fn ser_lambda_layer_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::LambdaLayerAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_9) = &input.layer_arns {
        let mut array_10 = object.key("layerArns").start_array();
