...
pub fn ser_lambda_layer_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaLayerAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
