    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "layers" => {
                            builder = builder.set_layers(crate::protocol_serde::shape_layer_list::de_layer_list(tokens)?);
                        }
                        "vpcConfig" => {
                            builder = builder.set_vpc_config(crate::protocol_serde::shape_lambda_vpc_config::de_lambda_vpc_config(tokens)?);
                        }
                        "packageType" => {
                        ...
                        "architectures" => {
                            builder = builder.set_architectures(crate::protocol_serde::shape_architecture_list::de_architecture_list(tokens)?);
                        }
                        "lastModifiedAt" => {
            ...
            Ok(Some(
                crate::serde_util::aws_lambda_function_details_correct_errors(builder)
                    .build()
