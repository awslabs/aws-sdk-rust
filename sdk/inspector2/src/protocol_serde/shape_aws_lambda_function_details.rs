...
pub(crate) fn de_aws_lambda_function_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsLambdaFunctionDetails>, aws_smithy_json::deserialize::error::DeserializeError>
