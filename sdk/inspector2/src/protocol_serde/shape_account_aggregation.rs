...
pub fn ser_account_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AccountAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
