...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_findings_report_status::GetFindingsReportStatusError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_findings_report_status::de_get_findings_report_status(_response_body, output)
            .map_err(crate::operation::get_findings_report_status::GetFindingsReportStatusError::unhandled)?;
