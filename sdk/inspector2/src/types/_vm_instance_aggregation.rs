...
pub struct VmInstanceAggregation {
    ...
    pub vm_image_references: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
    ...
    pub sort_by: ::std::option::Option<crate::types::VmInstanceSortBy>,
}
impl VmInstanceAggregation {
    /// <p>The resource IDs to aggregate findings for.</p>
    ///
    ...
    /// <p>The VM image references to aggregate findings for.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.vm_image_references.is_none()`.
    pub fn vm_image_references(&self) -> &[crate::types::StringFilter] {
        self.vm_image_references.as_deref().unwrap_or_default()
    }
    /// <p>The cloud providers to aggregate findings for. Valid values:</p>
    /// <ul>
    /// <li>
    ...
    /// <p>The value to sort results by. Specify a field name from the aggregation response, such as <code>CRITICAL</code>, <code>HIGH</code>, <code>ALL</code>, or <code>NETWORK_FINDINGS</code>.</p>
    pub fn sort_by(&self) -> ::std::option::Option<&crate::types::VmInstanceSortBy> {
        self.sort_by.as_ref()
    }
}
impl VmInstanceAggregation {
    /// Creates a new builder-style object to manufacture [`VmInstanceAggregation`](crate::types::VmInstanceAggregation).
    pub fn builder() -> crate::types::builders::VmInstanceAggregationBuilder {
        crate::types::builders::VmInstanceAggregationBuilder::default()
    }
}

/// A builder for [`VmInstanceAggregation`](crate::types::VmInstanceAggregation).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct VmInstanceAggregationBuilder {
    ...
    pub(crate) vm_image_references: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
    ...
    pub(crate) sort_by: ::std::option::Option<crate::types::VmInstanceSortBy>,
}
impl VmInstanceAggregationBuilder {
    ...
    /// Appends an item to `vm_image_references`.
    ///
    /// To override the contents of this collection use [`set_vm_image_references`](Self::set_vm_image_references).
    ///
    /// <p>The VM image references to aggregate findings for.</p>
    pub fn vm_image_references(mut self, input: crate::types::StringFilter) -> Self {
        let mut v = self.vm_image_references.unwrap_or_default();
        v.push(input);
        self.vm_image_references = ::std::option::Option::Some(v);
        self
    }
    /// <p>The VM image references to aggregate findings for.</p>
    pub fn set_vm_image_references(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>) -> Self {
        self.vm_image_references = input;
        self
    }
    /// <p>The VM image references to aggregate findings for.</p>
    pub fn get_vm_image_references(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::StringFilter>> {
        &self.vm_image_references
    }
    ...
    /// <p>The value to sort results by. Specify a field name from the aggregation response, such as <code>CRITICAL</code>, <code>HIGH</code>, <code>ALL</code>, or <code>NETWORK_FINDINGS</code>.</p>
    pub fn sort_by(mut self, input: crate::types::VmInstanceSortBy) -> Self {
        self.sort_by = ::std::option::Option::Some(input);
        self
    }
    /// <p>The value to sort results by. Specify a field name from the aggregation response, such as <code>CRITICAL</code>, <code>HIGH</code>, <code>ALL</code>, or <code>NETWORK_FINDINGS</code>.</p>
    pub fn set_sort_by(mut self, input: ::std::option::Option<crate::types::VmInstanceSortBy>) -> Self {
        self.sort_by = input;
        self
    }
    /// <p>The value to sort results by. Specify a field name from the aggregation response, such as <code>CRITICAL</code>, <code>HIGH</code>, <code>ALL</code>, or <code>NETWORK_FINDINGS</code>.</p>
    pub fn get_sort_by(&self) -> &::std::option::Option<crate::types::VmInstanceSortBy> {
        &self.sort_by
    }
    /// Consumes the builder and constructs a [`VmInstanceAggregation`](crate::types::VmInstanceAggregation).
    pub fn build(self) -> crate::types::VmInstanceAggregation {
        crate::types::VmInstanceAggregation {
            resource_ids: self.resource_ids,
            operating_systems: self.operating_systems,
            instance_tags: self.instance_tags,
            vm_image_references: self.vm_image_references,
