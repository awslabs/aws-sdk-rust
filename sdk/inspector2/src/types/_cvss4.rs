...
impl Cvss4 {
    /// Creates a new builder-style object to manufacture [`Cvss4`](crate::types::Cvss4).
    pub fn builder() -> crate::types::builders::Cvss4Builder {
        crate::types::builders::Cvss4Builder::default()
    }
}

/// A builder for [`Cvss4`](crate::types::Cvss4).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct Cvss4Builder {
...
impl Cvss4Builder {
    ...
    /// Consumes the builder and constructs a [`Cvss4`](crate::types::Cvss4).
    pub fn build(self) -> crate::types::Cvss4 {
        crate::types::Cvss4 {
