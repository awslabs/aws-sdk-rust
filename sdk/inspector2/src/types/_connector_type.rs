...
/// match connectortype {
///     ConnectorType::CustomerManaged => { /* ... */ },
///     ConnectorType::ServiceLinked => { /* ... */ },
...
impl ::std::convert::From<&str> for ConnectorType {
    fn from(s: &str) -> Self {
        match s {
            "CUSTOMER_MANAGED" => ConnectorType::CustomerManaged,
            "SERVICE_LINKED" => ConnectorType::ServiceLinked,
...
impl ConnectorType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectorType::CustomerManaged => "CUSTOMER_MANAGED",
            ConnectorType::ServiceLinked => "SERVICE_LINKED",
            ConnectorType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CUSTOMER_MANAGED", "SERVICE_LINKED"]
    }
}
...
impl ::std::fmt::Display for ConnectorType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConnectorType::CustomerManaged => write!(f, "CUSTOMER_MANAGED"),
            ConnectorType::ServiceLinked => write!(f, "SERVICE_LINKED"),
