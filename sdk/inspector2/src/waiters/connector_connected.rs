...
///
/// Fluent builder for the `connector_connected` waiter.
///
...
pub struct ConnectorConnectedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_connectors::builders::ListConnectorsInputBuilder,
}
impl ConnectorConnectedFluentBuilder {
    /// Creates a new `ConnectorConnectedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::connector_connected::ConnectorConnectedFinalPoll,
        crate::waiters::connector_connected::WaitUntilConnectorConnectedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"items[].health.connectorStatus","expected":"CONNECTED","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_list_connectors_5179c73747f795c38(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"items[].health.connectorStatus","expected":"FAILED_TO_CONNECT","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_list_connectors_6934f11bdcd790383(result) {
...
/// Successful return type for the `connector_connected` waiter.
pub type ConnectorConnectedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::list_connectors::ListConnectorsOutput,
...
/// Error type for the `connector_connected` waiter.
pub type WaitUntilConnectorConnectedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::list_connectors::ListConnectorsOutput,
    crate::operation::list_connectors::ListConnectorsError,
>;
