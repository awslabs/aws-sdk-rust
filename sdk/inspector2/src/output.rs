...
pub struct ListUsageTotalsOutput  {
    ...
    #[doc(hidden)]pub totals: std::option::Option<std::vec::Vec<crate::model::UsageTotal>>,
}
...
pub struct ListFindingAggregationsOutput  {
    ...
    #[doc(hidden)]pub responses: std::option::Option<std::vec::Vec<crate::model::AggregationResponse>>,
    /// <p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDelegatedAdminAccountsOutput  {
    ...
    #[doc(hidden)]pub delegated_admin_accounts: std::option::Option<std::vec::Vec<crate::model::DelegatedAdminAccount>>,
    /// <p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCoverageStatisticsOutput  {
    ...
    #[doc(hidden)]pub counts_by_group: std::option::Option<std::vec::Vec<crate::model::Counts>>,
    /// <p>The total number for all groups.</p>
    #[doc(hidden)]pub total_counts: std::option::Option<i64>,
    /// <p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCoverageOutput  {
    ...
    #[doc(hidden)]pub covered_resources: std::option::Option<std::vec::Vec<crate::model::CoveredResource>>,
}
...
pub struct GetMemberOutput  {
    ...
    #[doc(hidden)]pub member: std::option::Option<crate::model::Member>,
}
...
pub struct GetFindingsReportStatusOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ExternalReportStatus>,
    /// <p>The error code of the report.</p>
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::ReportingErrorCode>,
...
pub struct GetDelegatedAdminAccountOutput  {
    ...
    #[doc(hidden)]pub delegated_admin: std::option::Option<crate::model::DelegatedAdmin>,
}
...
pub struct GetConfigurationOutput  {
    ...
    #[doc(hidden)]pub ecr_configuration: std::option::Option<crate::model::EcrConfigurationState>,
}
...
pub struct EnableOutput  {
    ...
    #[doc(hidden)]pub failed_accounts: std::option::Option<std::vec::Vec<crate::model::FailedAccount>>,
}
impl EnableOutput {
    /// <p>Information on the accounts that have had Amazon Inspector scans successfully enabled. Details are provided for each account.</p>
...
pub struct DescribeOrganizationConfigurationOutput  {
    ...
    #[doc(hidden)]pub max_account_limit_reached: std::option::Option<bool>,
}
...
pub struct BatchGetFreeTrialInfoOutput  {
    ...
    #[doc(hidden)]pub accounts: std::option::Option<std::vec::Vec<crate::model::FreeTrialAccountInfo>>,
    /// <p>An array of objects detailing any accounts that free trial data could not be returned for.</p>
    #[doc(hidden)]pub failed_accounts: std::option::Option<std::vec::Vec<crate::model::FreeTrialInfoError>>,
}
...
pub struct BatchGetAccountStatusOutput  {
    ...
    #[doc(hidden)]pub accounts: std::option::Option<std::vec::Vec<crate::model::AccountState>>,
