...
impl super::Client {
    ...
    ///   - [`filter_criteria(CoverageFilterCriteria)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::filter_criteria) / [`set_filter_criteria(Option<CoverageFilterCriteria>)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::set_filter_criteria):<br>required: **false**<br><p>An object that contains details on the filters to apply to the coverage data for your environment.</p><br>
    ///   - [`group_by(GroupKey)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::group_by) / [`set_group_by(Option<GroupKey>)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::set_group_by):<br>required: **false**<br><p>The value to group the results by.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_coverage_statistics::builders::ListCoverageStatisticsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p><br>
    ...
    ///   - [`total_counts(i64)`](crate::operation::list_coverage_statistics::ListCoverageStatisticsOutput::total_counts): <p>The total number for all groups.</p>
