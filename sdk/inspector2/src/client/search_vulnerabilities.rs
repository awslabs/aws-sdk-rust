...
impl super::Client {
    ...
    ///   - [`filter_criteria(SearchVulnerabilitiesFilterCriteria)`](crate::operation::search_vulnerabilities::builders::SearchVulnerabilitiesFluentBuilder::filter_criteria) / [`set_filter_criteria(Option<SearchVulnerabilitiesFilterCriteria>)`](crate::operation::search_vulnerabilities::builders::SearchVulnerabilitiesFluentBuilder::set_filter_criteria): <p>The criteria used to filter the results of a vulnerability search.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_vulnerabilities::builders::SearchVulnerabilitiesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_vulnerabilities::builders::SearchVulnerabilitiesFluentBuilder::set_next_token): <p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p>
