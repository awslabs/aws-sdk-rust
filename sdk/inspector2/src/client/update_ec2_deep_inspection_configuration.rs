...
impl super::Client {
    ...
    ///   - [`package_paths(impl Into<String>)`](crate::operation::update_ec2_deep_inspection_configuration::builders::UpdateEc2DeepInspectionConfigurationFluentBuilder::package_paths) / [`set_package_paths(Option<Vec::<String>>)`](crate::operation::update_ec2_deep_inspection_configuration::builders::UpdateEc2DeepInspectionConfigurationFluentBuilder::set_package_paths):<br>required: **false**<br><p>The Amazon Inspector deep inspection custom paths you are adding for your account.</p><br>
