...
impl super::Client {
    ...
    ///   - [`delegated_admin_account_id(String)`](crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountOutput::delegated_admin_account_id): <p>The Amazon Web Services account ID of the successfully Amazon Inspector delegated administrator.</p>
