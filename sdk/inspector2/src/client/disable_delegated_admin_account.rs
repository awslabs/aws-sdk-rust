...
impl super::Client {
    ...
    ///   - [`delegated_admin_account_id(String)`](crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccountOutput::delegated_admin_account_id): <p>The Amazon Web Services account ID of the successfully disabled delegated administrator.</p>
