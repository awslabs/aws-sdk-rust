...
impl super::Client {
    ...
    ///   - [`account_ids(Vec<String>)`](crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusFluentBuilder::account_ids) / [`set_account_ids(Option<Vec<String>>)`](crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusFluentBuilder::set_account_ids): <p>The unique identifiers for the Amazon Web Services accounts to retrieve Amazon Inspector deep inspection activation status for. </p>
    ...
    pub fn batch_get_member_ec2_deep_inspection_status(&self) -> crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusFluentBuilder{
        crate::operation::batch_get_member_ec2_deep_inspection_status::builders::BatchGetMemberEc2DeepInspectionStatusFluentBuilder::new(self.handle.clone())
    }
}
