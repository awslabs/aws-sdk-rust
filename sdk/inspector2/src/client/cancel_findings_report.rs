...
impl super::Client {
    ...
    ///   - [`report_id(impl Into<String>)`](crate::operation::cancel_findings_report::builders::CancelFindingsReportFluentBuilder::report_id) / [`set_report_id(impl Into<String>)`](crate::operation::cancel_findings_report::builders::CancelFindingsReportFluentBuilder::set_report_id):<br>required: **true**<br><p>The ID of the report to be canceled.</p><br>
    ...
    ///   - [`report_id(String)`](crate::operation::cancel_findings_report::CancelFindingsReportOutput::report_id): <p>The ID of the canceled report.</p>
