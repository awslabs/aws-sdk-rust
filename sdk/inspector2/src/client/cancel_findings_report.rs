...
impl super::Client {
    ...
    ///   - [`report_id(impl Into<String>)`](crate::operation::cancel_findings_report::builders::CancelFindingsReportFluentBuilder::report_id) / [`set_report_id(Option<String>)`](crate::operation::cancel_findings_report::builders::CancelFindingsReportFluentBuilder::set_report_id):<br>required: **true**<br><p>The ID of the report to be canceled.</p><br>
