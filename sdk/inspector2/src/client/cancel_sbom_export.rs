...
impl super::Client {
    ...
    ///   - [`report_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_sbom_export::builders::CancelSbomExportFluentBuilder::report_id) / [`set_report_id(Option<String>)`](crate::operation::cancel_sbom_export::builders::CancelSbomExportFluentBuilder::set_report_id): <p>The report ID of the SBOM export to cancel.</p>
