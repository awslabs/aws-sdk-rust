...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_filter::builders::CreateFilterFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_filter::builders::CreateFilterFluentBuilder::set_tags): <p>A list of tags for the filter.</p>
