...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::batch_get_free_trial_info::builders::BatchGetFreeTrialInfoFluentBuilder::account_ids) / [`set_account_ids(Vec<String>)`](crate::operation::batch_get_free_trial_info::builders::BatchGetFreeTrialInfoFluentBuilder::set_account_ids):<br>required: **true**<br><p>The account IDs to get free trial status for.</p><br>
