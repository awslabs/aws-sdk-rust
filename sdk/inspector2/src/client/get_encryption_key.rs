...
impl super::Client {
    ...
    ///   - [`scan_type(ScanType)`](crate::operation::get_encryption_key::builders::GetEncryptionKeyFluentBuilder::scan_type) / [`set_scan_type(Option<ScanType>)`](crate::operation::get_encryption_key::builders::GetEncryptionKeyFluentBuilder::set_scan_type): <p>The scan type the key encrypts.</p>
    ///   - [`resource_type(ResourceType)`](crate::operation::get_encryption_key::builders::GetEncryptionKeyFluentBuilder::resource_type) / [`set_resource_type(Option<ResourceType>)`](crate::operation::get_encryption_key::builders::GetEncryptionKeyFluentBuilder::set_resource_type): <p>The resource type the key encrypts.</p>
