...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::set_next_token): <p>A token to use for paginating results that are returned in the response. Set the value of this parameter to null for the first request to a list action. For subsequent calls, use the <code>NextToken</code> value returned from the previous request to continue listing results after the first page.</p>
    ///   - [`max_results(i32)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::set_max_results): <p>The maximum number of results to return in the response.</p>
    ///   - [`account_ids(Vec<StringFilter>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::account_ids) / [`set_account_ids(Option<Vec<StringFilter>>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::set_account_ids): <p>The Amazon Web Services account IDs to retrieve finding aggregation data for.</p>
    ///   - [`aggregation_request(AggregationRequest)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::aggregation_request) / [`set_aggregation_request(Option<AggregationRequest>)`](crate::operation::list_finding_aggregations::builders::ListFindingAggregationsFluentBuilder::set_aggregation_request): <p>Details of the aggregation request that is used to filter your aggregation results.</p>
    ...
    ///   - [`aggregation_type(Option<AggregationType>)`](crate::operation::list_finding_aggregations::ListFindingAggregationsOutput::aggregation_type): <p>The type of aggregation to perform.</p>
