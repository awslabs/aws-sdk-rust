...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::batch_get_account_status::builders::BatchGetAccountStatusFluentBuilder::account_ids) / [`set_account_ids(Option<Vec::<String>>)`](crate::operation::batch_get_account_status::builders::BatchGetAccountStatusFluentBuilder::set_account_ids):<br>required: **false**<br><p>The 12-digit Amazon Web Services account IDs of the accounts to retrieve Amazon Inspector status for.</p><br>
    ...
    ///   - [`accounts(Vec::<AccountState>)`](crate::operation::batch_get_account_status::BatchGetAccountStatusOutput::accounts): <p>An array of objects that provide details on the status of Amazon Inspector for each of the requested accounts.</p>
