...
impl DeleteFilterOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_filter::DeleteFilterOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_filter::DeleteFilterOutput {
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building DeleteFilterOutput")
                    )?
                ,
