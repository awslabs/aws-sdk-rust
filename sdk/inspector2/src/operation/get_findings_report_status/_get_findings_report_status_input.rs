...
impl GetFindingsReportStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_findings_report_status::GetFindingsReportStatusInput, ::aws_smithy_types::error::operation::BuildError> {
