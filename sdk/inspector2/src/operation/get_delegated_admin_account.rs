...
impl GetDelegatedAdminAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_delegated_admin_account::GetDelegatedAdminAccount,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_delegated_admin_account::GetDelegatedAdminAccount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDelegatedAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_delegated_admin_account::de_get_delegated_admin_account_http_response_with_props(status, headers, body)
        }
    }
}
