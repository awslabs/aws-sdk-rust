...
impl UpdateCisScanConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_cis_scan_configuration::UpdateCisScanConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_cis_scan_configuration::UpdateCisScanConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_cis_scan_configuration::UpdateCisScanConfigurationOutput, crate::operation::update_cis_scan_configuration::UpdateCisScanConfigurationError, Self> {
