...
impl GetEc2DeepInspectionConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_ec2_deep_inspection_configuration::GetEc2DeepInspectionConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
