...
impl UpdateEc2DeepInspectionConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_ec2_deep_inspection_configuration::UpdateEc2DeepInspectionConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
