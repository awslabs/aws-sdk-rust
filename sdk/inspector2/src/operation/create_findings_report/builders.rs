...
impl CreateFindingsReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_findings_report::CreateFindingsReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_findings_report::CreateFindingsReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_findings_report::CreateFindingsReportOutput, crate::operation::create_findings_report::CreateFindingsReportError, Self> {
