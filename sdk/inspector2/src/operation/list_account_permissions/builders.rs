...
impl ListAccountPermissionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_account_permissions::paginator::ListAccountPermissionsPaginator
    {
        crate::operation::list_account_permissions::paginator::ListAccountPermissionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
