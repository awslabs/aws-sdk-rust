...
impl ListAccountPermissionsFluentBuilder  {
    /// Creates a new `ListAccountPermissions`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_account_permissions::ListAccountPermissionsOutput, aws_smithy_http::result::SdkError<crate::operation::list_account_permissions::ListAccountPermissionsError>>
                     {
