...
impl SendCisSessionTelemetryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_cis_session_telemetry::SendCisSessionTelemetryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_cis_session_telemetry::SendCisSessionTelemetryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_cis_session_telemetry::SendCisSessionTelemetryOutput, crate::operation::send_cis_session_telemetry::SendCisSessionTelemetryError, Self> {
