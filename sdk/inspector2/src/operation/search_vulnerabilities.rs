...
impl SearchVulnerabilities {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::search_vulnerabilities::SearchVulnerabilitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchVulnerabilities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchVulnerabilities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchVulnerabilitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchVulnerabilitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchVulnerabilities")
...
.with_interceptor(SearchVulnerabilitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>::new());
...
#[derive(Debug)]
            struct SearchVulnerabilitiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchVulnerabilitiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_vulnerabilities::de_search_vulnerabilities_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_search_vulnerabilities::de_search_vulnerabilities_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SearchVulnerabilitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchVulnerabilitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_vulnerabilities::SearchVulnerabilitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/vulnerabilities/search").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_vulnerabilities::ser_search_vulnerabilities_input(&input)?);
...
#[derive(Debug)]
            struct SearchVulnerabilitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchVulnerabilitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchVulnerabilitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchVulnerabilitiesInput>()
                        .ok_or("failed to downcast to SearchVulnerabilitiesInput")?;
...
pub enum SearchVulnerabilitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchVulnerabilitiesError) for what information is available for the error.")]
...
impl SearchVulnerabilitiesError {
    /// Creates the `SearchVulnerabilitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchVulnerabilitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for SearchVulnerabilitiesError {
...
impl ::std::fmt::Display for SearchVulnerabilitiesError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for SearchVulnerabilitiesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SearchVulnerabilitiesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchVulnerabilitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_vulnerabilities::SearchVulnerabilitiesError {
...
mod _search_vulnerabilities_output;
