    ...
    > {
        ...
        let mut request = {
            ...
            ) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError>
            {
                ...
                write!(output, "/vulnerabilities/search").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_vulnerabilities::ser_search_vulnerabilities_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_vulnerabilities::SearchVulnerabilities::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::search_vulnerabilities::SearchVulnerabilitiesError
{
