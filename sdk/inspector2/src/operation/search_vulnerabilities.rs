...
impl SearchVulnerabilitiesInput {
    /// Consumes the builder and constructs an Operation<[`SearchVulnerabilities`](crate::operation::search_vulnerabilities::SearchVulnerabilities)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_vulnerabilities::SearchVulnerabilities::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchVulnerabilities", "inspector2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchVulnerabilities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_vulnerabilities::de_search_vulnerabilities_http_response_with_props(status, headers, body)
        }
    }
}
