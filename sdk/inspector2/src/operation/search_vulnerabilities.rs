    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SearchVulnerabilitiesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SearchVulnerabilitiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vulnerabilities::SearchVulnerabilitiesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_vulnerabilities::ser_search_vulnerabilities_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SearchVulnerabilitiesEndpointParamsInterceptor {
...
pub type SearchVulnerabilitiesErrorKind = SearchVulnerabilitiesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for SearchVulnerabilitiesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::search_vulnerabilities::SearchVulnerabilitiesError {
...
impl SearchVulnerabilitiesError {
    ...
    /// Creates the `SearchVulnerabilitiesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
