...
impl UpdateOrgEc2DeepInspectionConfigurationInputBuilder {
    ...
    ///
    /// <p>The Amazon Inspector deep inspection custom paths you are adding for your organization.</p>
    pub fn org_package_paths(mut self, input: impl Into<std::string::String>) -> Self {
        let mut v = self.org_package_paths.unwrap_or_default();
        v.push(input.into());
        self.org_package_paths = Some(v);
        self
    }
    /// <p>The Amazon Inspector deep inspection custom paths you are adding for your organization.</p>
    ...
    pub fn build(self) -> Result<crate::operation::update_org_ec2_deep_inspection_configuration::UpdateOrgEc2DeepInspectionConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
