...
impl DeleteCisScanConfigurationOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_cis_scan_configuration::DeleteCisScanConfigurationOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_cis_scan_configuration::DeleteCisScanConfigurationOutput {
                scan_configuration_arn: self.scan_configuration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("scan_configuration_arn", "scan_configuration_arn was not specified but it is required when building DeleteCisScanConfigurationOutput")
                    )?
                ,
