...
impl ListFindingsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Finding, ::aws_smithy_http::result::SdkError<crate::operation::list_findings::ListFindingsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_findings_output_findings(page).unwrap_or_default().into_iter())
    }
}
