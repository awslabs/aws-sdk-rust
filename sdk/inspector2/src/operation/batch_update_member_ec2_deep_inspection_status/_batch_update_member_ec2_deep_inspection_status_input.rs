...
impl BatchUpdateMemberEc2DeepInspectionStatusInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::batch_update_member_ec2_deep_inspection_status::BatchUpdateMemberEc2DeepInspectionStatusInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
