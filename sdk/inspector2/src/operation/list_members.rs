...
impl ListMembersInput {
    /// Consumes the builder and constructs an Operation<[`ListMembers`](crate::operation::list_members::ListMembers)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_members::ListMembers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_members::ser_list_members_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_members::ListMembers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMembers {
    type Output = ::std::result::Result<crate::operation::list_members::ListMembersOutput, crate::operation::list_members::ListMembersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_members::de_list_members_http_response_with_props(status, headers, body)
        }
    }
}
