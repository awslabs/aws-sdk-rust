...
impl ListDelegatedAdminAccountsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_delegated_admin_accounts::ListDelegatedAdminAccounts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDelegatedAdminAccounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_delegated_admin_accounts::de_list_delegated_admin_accounts_http_response_with_props(
                status, headers, body,
            )
        }
    }
