    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/delegatedadminaccounts/list")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDelegatedAdminAccounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_delegated_admin_accounts::de_list_delegated_admin_accounts_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_delegated_admin_accounts::ListDelegatedAdminAccountsError
{
