...
impl EnableDelegatedAdminAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableDelegatedAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_delegated_admin_account::de_enable_delegated_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
