...
/// Orchestration and serialization glue logic for `EnableDelegatedAdminAccount`.
...
impl EnableDelegatedAdminAccount {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableDelegatedAdminAccount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableDelegatedAdminAccount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableDelegatedAdminAccountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableDelegatedAdminAccountResponseDeserializer));
...
.with_interceptor(EnableDelegatedAdminAccountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError>::new());
...
#[derive(Debug)]
            struct EnableDelegatedAdminAccountResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableDelegatedAdminAccountResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_delegated_admin_account::de_enable_delegated_admin_account_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_delegated_admin_account::de_enable_delegated_admin_account_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableDelegatedAdminAccountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableDelegatedAdminAccountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/delegatedadminaccounts/enable").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_delegated_admin_account::ser_enable_delegated_admin_account_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableDelegatedAdminAccountEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableDelegatedAdminAccountInput>()
                        .ok_or("failed to downcast to EnableDelegatedAdminAccountInput")?;
...
pub enum EnableDelegatedAdminAccountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableDelegatedAdminAccountError) for what information is available for the error.")]
...
impl EnableDelegatedAdminAccountError {
    /// Creates the `EnableDelegatedAdminAccountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableDelegatedAdminAccountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableDelegatedAdminAccountError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountError {
...
mod _enable_delegated_admin_account_output;
