...
impl crate::operation::create_cis_scan_configuration::builders::CreateCisScanConfigurationInputBuilder {
...
impl CreateCisScanConfigurationFluentBuilder {
    /// Creates a new `CreateCisScanConfigurationFluentBuilder`.
