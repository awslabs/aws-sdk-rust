...
impl CreateCisScanConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_cis_scan_configuration::CreateCisScanConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cis_scan_configuration::CreateCisScanConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_cis_scan_configuration::CreateCisScanConfigurationOutput, crate::operation::create_cis_scan_configuration::CreateCisScanConfigurationError, Self> {
