...
pub struct ErrorDetail  {
    ...
    #[doc(hidden)]pub detailed_error_code: std::option::Option<std::string::String>,
    /// A detailed error message.
    #[doc(hidden)]pub detailed_error_message: std::option::Option<std::string::String>,
}
impl ErrorDetail {
    /// A detailed error code.
...
pub struct TelemetryConfigurationUpdate  {
    ...
    #[doc(hidden)]pub telemetry: std::option::Option<crate::model::Telemetry>,
}
...
pub struct ConnectivityInfo  {
    ...
    #[doc(hidden)]pub port_number: i32,
}
...
pub struct RuntimeConfiguration  {
    ...
    #[doc(hidden)]pub telemetry_configuration: std::option::Option<crate::model::TelemetryConfiguration>,
}
...
pub struct TelemetryConfiguration  {
    ...
    #[doc(hidden)]pub configuration_sync_status: std::option::Option<crate::model::ConfigurationSyncStatus>,
    /// Configure telemetry to be on or off.
    #[doc(hidden)]pub telemetry: std::option::Option<crate::model::Telemetry>,
}
...
pub struct Resource  {
    ...
    #[doc(hidden)]pub resource_data_container: std::option::Option<crate::model::ResourceDataContainer>,
}
impl Resource {
    /// The resource ID, used to refer to a resource in the Lambda function configuration. Max length is 128 characters with pattern ''[a-zA-Z0-9:_-]+''. This must be unique within a Greengrass group.
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct ResourceDataContainer  {
    ...
    #[doc(hidden)]pub local_device_resource_data: std::option::Option<crate::model::LocalDeviceResourceData>,
    /// Attributes that define the local volume resource.
    #[doc(hidden)]pub local_volume_resource_data: std::option::Option<crate::model::LocalVolumeResourceData>,
    /// Attributes that define an Amazon S3 machine learning resource.
    #[doc(hidden)]pub s3_machine_learning_model_resource_data: std::option::Option<crate::model::S3MachineLearningModelResourceData>,
    /// Attributes that define an Amazon SageMaker machine learning resource.
    #[doc(hidden)]pub sage_maker_machine_learning_model_resource_data: std::option::Option<crate::model::SageMakerMachineLearningModelResourceData>,
    /// Attributes that define a secret resource, which references a secret from AWS Secrets Manager.
    #[doc(hidden)]pub secrets_manager_secret_resource_data: std::option::Option<crate::model::SecretsManagerSecretResourceData>,
}
...
impl  std::fmt::Debug for ResourceDataContainer  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("local_device_resource_data", &self.local_device_resource_data);
        formatter.field("local_volume_resource_data", &self.local_volume_resource_data);
        formatter.field("s3_machine_learning_model_resource_data", &self.s3_machine_learning_model_resource_data);
        formatter.field("sage_maker_machine_learning_model_resource_data", &self.sage_maker_machine_learning_model_resource_data);
        formatter.field("secrets_manager_secret_resource_data", &self.secrets_manager_secret_resource_data);
        formatter.finish()
    }
}
...
pub struct SecretsManagerSecretResourceData  {
    ...
    #[doc(hidden)]pub additional_staging_labels_to_download: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for SecretsManagerSecretResourceData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("arn", &self.arn);
        formatter.field("additional_staging_labels_to_download", &self.additional_staging_labels_to_download);
        formatter.finish()
    }
}
...
pub struct SageMakerMachineLearningModelResourceData  {
    ...
    #[doc(hidden)]pub destination_path: std::option::Option<std::string::String>,
    /// The owner setting for downloaded machine learning resources.
    #[doc(hidden)]pub owner_setting: std::option::Option<crate::model::ResourceDownloadOwnerSetting>,
    /// The ARN of the Amazon SageMaker training job that represents the source model.
    #[doc(hidden)]pub sage_maker_job_arn: std::option::Option<std::string::String>,
}
...
pub struct ResourceDownloadOwnerSetting  {
    ...
    #[doc(hidden)]pub group_owner: std::option::Option<std::string::String>,
    /// The permissions that the group owner has to the resource. Valid values are ''rw'' (read/write) or ''ro'' (read-only).
    #[doc(hidden)]pub group_permission: std::option::Option<crate::model::Permission>,
}
...
pub struct LocalVolumeResourceData  {
    ...
    #[doc(hidden)]pub group_owner_setting: std::option::Option<crate::model::GroupOwnerSetting>,
...
pub struct GroupOwnerSetting  {
    ...
    #[doc(hidden)]pub auto_add_group_owner: bool,
...
pub struct Logger  {
    ...
    #[doc(hidden)]pub component: std::option::Option<crate::model::LoggerComponent>,
    /// A descriptive or arbitrary ID for the logger. This value must be unique within the logger definition version. Max length is 128 characters with pattern ''[a-zA-Z0-9:_-]+''.
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// The level of the logs.
    #[doc(hidden)]pub level: std::option::Option<crate::model::LoggerLevel>,
    /// The amount of file space, in KB, to use if the local file system is used for logging purposes.
    #[doc(hidden)]pub space: i32,
    /// The type of log output which will be used.
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::LoggerType>,
}
impl Logger {
    /// The component that will be subject to logging.
...
pub struct FunctionConfiguration  {
    ...
    #[doc(hidden)]pub environment: std::option::Option<crate::model::FunctionConfigurationEnvironment>,
    /// The execution arguments.
    #[doc(hidden)]pub exec_args: std::option::Option<std::string::String>,
    /// The name of the function executable.
    #[doc(hidden)]pub executable: std::option::Option<std::string::String>,
    /// The memory size, in KB, which the function requires. This setting is not applicable and should be cleared when you run the Lambda function without containerization.
    #[doc(hidden)]pub memory_size: i32,
    /// True if the function is pinned. Pinned means the function is long-lived and starts when the core starts.
    #[doc(hidden)]pub pinned: bool,
...
pub struct FunctionConfigurationEnvironment  {
    ...
    #[doc(hidden)]pub access_sysfs: bool,
    /// Configuration related to executing the Lambda function
    #[doc(hidden)]pub execution: std::option::Option<crate::model::FunctionExecutionConfig>,
    /// A list of the resources, with their permissions, to which the Lambda function will be granted access. A Lambda function can have at most 10 resources. ResourceAccessPolicies apply only when you run the Lambda function in a Greengrass container.
    #[doc(hidden)]pub resource_access_policies: std::option::Option<std::vec::Vec<crate::model::ResourceAccessPolicy>>,
    /// Environment variables for the Lambda function's configuration.
    #[doc(hidden)]pub variables: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct FunctionExecutionConfig  {
    ...
    #[doc(hidden)]pub isolation_mode: std::option::Option<crate::model::FunctionIsolationMode>,
    /// Specifies the user and group whose permissions are used when running the Lambda function. You can specify one or both values to override the default values. We recommend that you avoid running as root unless absolutely necessary to minimize the risk of unintended changes or malicious attacks. To run as root, you must set ''IsolationMode'' to ''NoContainer'' and update config.json in ''greengrass-root/config'' to set ''allowFunctionsToRunAsRoot'' to ''yes''.
    #[doc(hidden)]pub run_as: std::option::Option<crate::model::FunctionRunAsConfig>,
}
...
pub struct FunctionRunAsConfig  {
    ...
    #[doc(hidden)]pub gid: i32,
    /// The user ID whose permissions are used to run a Lambda function.
    #[doc(hidden)]pub uid: i32,
}
...
pub struct FunctionDefaultConfig  {
    /// Configuration information that specifies how a Lambda function runs.
    #[doc(hidden)]pub execution: std::option::Option<crate::model::FunctionDefaultExecutionConfig>,
}
...
pub struct Device  {
    ...
    #[doc(hidden)]pub sync_shadow: bool,
...
pub struct BulkDeploymentMetrics  {
    ...
    #[doc(hidden)]pub invalid_input_records: i32,
    /// The total number of group records from the input file that have been processed so far, or attempted.
    #[doc(hidden)]pub records_processed: i32,
    /// The total number of deployment attempts that returned a retryable error. For example, a retry is triggered if the attempt to deploy a group returns a throttling error. ''StartBulkDeployment'' retries a group deployment up to five times.
    #[doc(hidden)]pub retry_attempts: i32,
}
