...
impl super::Client {
    ...
    ///   - [`group_id(impl Into<String>)`](crate::operation::get_associated_role::builders::GetAssociatedRoleFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::get_associated_role::builders::GetAssociatedRoleFluentBuilder::set_group_id):<br>required: **true**<br>The ID of the Greengrass group.<br>
