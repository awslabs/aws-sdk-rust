...
impl super::Client {
    ...
    ///   - [`connector_definition_version_id(impl Into<String>)`](crate::operation::get_connector_definition_version::builders::GetConnectorDefinitionVersionFluentBuilder::connector_definition_version_id) / [`set_connector_definition_version_id(Option<String>)`](crate::operation::get_connector_definition_version::builders::GetConnectorDefinitionVersionFluentBuilder::set_connector_definition_version_id):<br>required: **true**<br>The ID of the connector definition version. This value maps to the ''Version'' property of the corresponding ''VersionInformation'' object, which is returned by ''ListConnectorDefinitionVersions'' requests. If the version is the last one that was associated with a connector definition, the value also maps to the ''LatestVersion'' property of the corresponding ''DefinitionInformation'' object.<br>
