...
impl super::Client {
    ...
    ///   - [`bulk_deployment_id(impl Into<String>)`](crate::operation::get_bulk_deployment_status::builders::GetBulkDeploymentStatusFluentBuilder::bulk_deployment_id) / [`set_bulk_deployment_id(Option<String>)`](crate::operation::get_bulk_deployment_status::builders::GetBulkDeploymentStatusFluentBuilder::set_bulk_deployment_id):<br>required: **true**<br>The ID of the bulk deployment.<br>
