...
impl super::Client {
    ...
    ///   - [`connector_definition_id(impl ::std::convert::Into<String>)`](crate::operation::update_connector_definition::builders::UpdateConnectorDefinitionFluentBuilder::connector_definition_id) / [`set_connector_definition_id(Option<String>)`](crate::operation::update_connector_definition::builders::UpdateConnectorDefinitionFluentBuilder::set_connector_definition_id): The ID of the connector definition.
