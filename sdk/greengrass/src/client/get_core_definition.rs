...
impl super::Client {
    ...
    pub fn get_core_definition(
        &self,
    ) -> crate::operation::get_core_definition::builders::GetCoreDefinitionFluentBuilder {
        crate::operation::get_core_definition::builders::GetCoreDefinitionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
