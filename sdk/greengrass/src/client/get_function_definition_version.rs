...
impl super::Client {
    ...
    ///   - [`function_definition_id(impl ::std::convert::Into<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::function_definition_id) / [`set_function_definition_id(Option<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::set_function_definition_id): The ID of the Lambda function definition.
    ///   - [`function_definition_version_id(impl ::std::convert::Into<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::function_definition_version_id) / [`set_function_definition_version_id(Option<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::set_function_definition_version_id): The ID of the function definition version. This value maps to the ''Version'' property of the corresponding ''VersionInformation'' object, which is returned by ''ListFunctionDefinitionVersions'' requests. If the version is the last one that was associated with a function definition, the value also maps to the ''LatestVersion'' property of the corresponding ''DefinitionInformation'' object.
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_function_definition_version::builders::GetFunctionDefinitionVersionFluentBuilder::set_next_token): The token for the next set of results, or ''null'' if there are no additional results.
