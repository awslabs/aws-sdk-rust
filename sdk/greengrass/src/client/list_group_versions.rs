...
impl super::Client {
    ...
    ///   - [`group_id(impl Into<String>)`](crate::operation::list_group_versions::builders::ListGroupVersionsFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::list_group_versions::builders::ListGroupVersionsFluentBuilder::set_group_id):<br>required: **true**<br>The ID of the Greengrass group.<br>
    ///   - [`max_results(impl Into<String>)`](crate::operation::list_group_versions::builders::ListGroupVersionsFluentBuilder::max_results) / [`set_max_results(Option<String>)`](crate::operation::list_group_versions::builders::ListGroupVersionsFluentBuilder::set_max_results):<br>required: **false**<br>The maximum number of results to be returned per request.<br>
