...
impl super::Client {
    ...
    ///   - [`connector_definition_id(impl Into<String>)`](crate::operation::get_connector_definition::builders::GetConnectorDefinitionFluentBuilder::connector_definition_id) / [`set_connector_definition_id(Option<String>)`](crate::operation::get_connector_definition::builders::GetConnectorDefinitionFluentBuilder::set_connector_definition_id):<br>required: **true**<br>The ID of the connector definition.<br>
