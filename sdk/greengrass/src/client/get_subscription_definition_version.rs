...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::set_next_token): The token for the next set of results, or ''null'' if there are no additional results.
    ///   - [`subscription_definition_id(impl ::std::convert::Into<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::subscription_definition_id) / [`set_subscription_definition_id(Option<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::set_subscription_definition_id): The ID of the subscription definition.
    ///   - [`subscription_definition_version_id(impl ::std::convert::Into<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::subscription_definition_version_id) / [`set_subscription_definition_version_id(Option<String>)`](crate::operation::get_subscription_definition_version::builders::GetSubscriptionDefinitionVersionFluentBuilder::set_subscription_definition_version_id): The ID of the subscription definition version. This value maps to the ''Version'' property of the corresponding ''VersionInformation'' object, which is returned by ''ListSubscriptionDefinitionVersions'' requests. If the version is the last one that was associated with a subscription definition, the value also maps to the ''LatestVersion'' property of the corresponding ''DefinitionInformation'' object.
