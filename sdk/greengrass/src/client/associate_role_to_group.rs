...
impl super::Client {
    ...
    ///   - [`group_id(impl Into<String>)`](crate::operation::associate_role_to_group::builders::AssociateRoleToGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::associate_role_to_group::builders::AssociateRoleToGroupFluentBuilder::set_group_id):<br>required: **true**<br>The ID of the Greengrass group.<br>
    ///   - [`role_arn(impl Into<String>)`](crate::operation::associate_role_to_group::builders::AssociateRoleToGroupFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::associate_role_to_group::builders::AssociateRoleToGroupFluentBuilder::set_role_arn):<br>required: **true**<br>The ARN of the role you wish to associate with this group. The existence of the role is not validated.<br>
