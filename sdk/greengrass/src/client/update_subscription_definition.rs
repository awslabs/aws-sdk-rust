...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_subscription_definition::builders::UpdateSubscriptionDefinitionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_subscription_definition::builders::UpdateSubscriptionDefinitionFluentBuilder::set_name): The name of the definition.
