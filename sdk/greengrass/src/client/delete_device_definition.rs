...
impl super::Client {
    ...
    ///   - [`device_definition_id(impl Into<String>)`](crate::operation::delete_device_definition::builders::DeleteDeviceDefinitionFluentBuilder::device_definition_id) / [`set_device_definition_id(Option<String>)`](crate::operation::delete_device_definition::builders::DeleteDeviceDefinitionFluentBuilder::set_device_definition_id):<br>required: **true**<br>The ID of the device definition.<br>
