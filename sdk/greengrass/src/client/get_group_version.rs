...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::get_group_version::builders::GetGroupVersionFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::get_group_version::builders::GetGroupVersionFluentBuilder::set_group_id): The ID of the Greengrass group.
    ///   - [`group_version_id(impl ::std::convert::Into<String>)`](crate::operation::get_group_version::builders::GetGroupVersionFluentBuilder::group_version_id) / [`set_group_version_id(Option<String>)`](crate::operation::get_group_version::builders::GetGroupVersionFluentBuilder::set_group_version_id): The ID of the group version. This value maps to the ''Version'' property of the corresponding ''VersionInformation'' object, which is returned by ''ListGroupVersions'' requests. If the version is the last one that was associated with a group, the value also maps to the ''LatestVersion'' property of the corresponding ''GroupInformation'' object.
