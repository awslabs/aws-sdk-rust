...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::list_group_certificate_authorities::builders::ListGroupCertificateAuthoritiesFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::list_group_certificate_authorities::builders::ListGroupCertificateAuthoritiesFluentBuilder::set_group_id): The ID of the Greengrass group.
