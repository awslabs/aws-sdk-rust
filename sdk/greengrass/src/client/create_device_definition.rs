...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::set_tags): Tag(s) to add to the new resource.
