...
impl super::Client {
    ...
    ///   - [`amzn_client_token(impl Into<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::amzn_client_token) / [`set_amzn_client_token(Option<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::set_amzn_client_token):<br>required: **false**<br>A client token used to correlate requests and responses.<br>
    ///   - [`initial_version(DeviceDefinitionVersion)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::initial_version) / [`set_initial_version(Option<DeviceDefinitionVersion>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::set_initial_version):<br>required: **false**<br>Information about the initial version of the device definition.<br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::set_name):<br>required: **false**<br>The name of the device definition.<br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_device_definition::builders::CreateDeviceDefinitionFluentBuilder::set_tags):<br>required: **false**<br>Tag(s) to add to the new resource.<br>
