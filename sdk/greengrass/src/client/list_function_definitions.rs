...
impl super::Client {
    ...
    ///   - [`max_results(impl Into<String>)`](crate::operation::list_function_definitions::builders::ListFunctionDefinitionsFluentBuilder::max_results) / [`set_max_results(Option<String>)`](crate::operation::list_function_definitions::builders::ListFunctionDefinitionsFluentBuilder::set_max_results):<br>required: **false**<br>The maximum number of results to be returned per request.<br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_function_definitions::builders::ListFunctionDefinitionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_function_definitions::builders::ListFunctionDefinitionsFluentBuilder::set_next_token):<br>required: **false**<br>The token for the next set of results, or ''null'' if there are no additional results.<br>
