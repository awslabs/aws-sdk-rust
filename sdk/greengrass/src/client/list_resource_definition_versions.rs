...
impl super::Client {
    ...
    ///   - [`max_results(impl ::std::convert::Into<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::max_results) / [`set_max_results(Option<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::set_max_results): The maximum number of results to be returned per request.
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::set_next_token): The token for the next set of results, or ''null'' if there are no additional results.
    ///   - [`resource_definition_id(impl ::std::convert::Into<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::resource_definition_id) / [`set_resource_definition_id(Option<String>)`](crate::operation::list_resource_definition_versions::builders::ListResourceDefinitionVersionsFluentBuilder::set_resource_definition_id): The ID of the resource definition.
