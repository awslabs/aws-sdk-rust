...
pub(crate) fn de_bulk_deployment_result<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BulkDeploymentResult>, aws_smithy_json::deserialize::error::DeserializeError>
