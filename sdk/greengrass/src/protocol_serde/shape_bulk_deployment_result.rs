...
pub(crate) fn de_bulk_deployment_result<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BulkDeploymentResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
