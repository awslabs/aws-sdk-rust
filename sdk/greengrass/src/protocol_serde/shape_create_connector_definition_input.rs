...
pub fn ser_create_connector_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_connector_definition::CreateConnectorDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
