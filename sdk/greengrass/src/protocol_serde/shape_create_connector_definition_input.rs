...
pub fn ser_create_connector_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConnectorDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
