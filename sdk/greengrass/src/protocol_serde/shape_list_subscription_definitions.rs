...
pub fn de_list_subscription_definitions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsOutput, crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_subscription_definitions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsOutput, crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsError> {
    Ok({
        #[allow(unused_mut)]
