...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_subscription_definitions::de_list_subscription_definitions(_response_body, output)
            .map_err(crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsError::unhandled)?;
