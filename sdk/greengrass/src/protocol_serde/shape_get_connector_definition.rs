...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_connector_definition::GetConnectorDefinitionError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_connector_definition::de_get_connector_definition(_response_body, output)
            .map_err(crate::operation::get_connector_definition::GetConnectorDefinitionError::unhandled)?;
