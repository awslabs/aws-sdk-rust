...
) -> Result<Option<crate::types::SubscriptionDefinitionVersion>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Subscriptions" => {
                            builder =
                                builder.set_subscriptions(crate::protocol_serde::shape___list_of_subscription::de___list_of_subscription(tokens)?);
                        }
