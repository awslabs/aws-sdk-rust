...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_resource_definition_version::GetResourceDefinitionVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_resource_definition_version_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_resource_definition_version::de_get_resource_definition_version(_response_body, output)
            .map_err(crate::operation::get_resource_definition_version::GetResourceDefinitionVersionError::unhandled)?;
...
pub(crate) fn de_get_resource_definition_version(
    value: &[u8],
    mut builder: crate::operation::get_resource_definition_version::builders::GetResourceDefinitionVersionOutputBuilder,
) -> Result<
    crate::operation::get_resource_definition_version::builders::GetResourceDefinitionVersionOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Definition" => {
                    builder = builder.set_definition(crate::protocol_serde::shape_resource_definition_version::de_resource_definition_version(
                        tokens,
                    )?);
                }
                "Id" => {
