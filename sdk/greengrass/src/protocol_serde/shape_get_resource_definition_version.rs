...
pub fn de_get_resource_definition_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_resource_definition_version::GetResourceDefinitionVersionOutput, crate::operation::get_resource_definition_version::GetResourceDefinitionVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_resource_definition_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_resource_definition_version::GetResourceDefinitionVersionOutput, crate::operation::get_resource_definition_version::GetResourceDefinitionVersionError> {
    Ok({
        #[allow(unused_mut)]
