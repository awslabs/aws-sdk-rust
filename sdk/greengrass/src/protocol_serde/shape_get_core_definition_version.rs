...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_core_definition_version::GetCoreDefinitionVersionError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_core_definition_version::GetCoreDefinitionVersionError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_core_definition_version::de_get_core_definition_version(_response_body, output)
            .map_err(crate::operation::get_core_definition_version::GetCoreDefinitionVersionError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Definition" => {
                    builder = builder.set_definition(crate::protocol_serde::shape_core_definition_version::de_core_definition_version(tokens)?);
                }
                "Id" => {
