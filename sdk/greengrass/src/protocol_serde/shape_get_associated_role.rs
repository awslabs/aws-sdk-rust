...
pub fn de_get_associated_role_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_associated_role::GetAssociatedRoleOutput, crate::operation::get_associated_role::GetAssociatedRoleError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_associated_role_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_associated_role::GetAssociatedRoleOutput, crate::operation::get_associated_role::GetAssociatedRoleError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_get_associated_role::de_get_associated_role(_response_body, output)
            .map_err(crate::operation::get_associated_role::GetAssociatedRoleError::unhandled)?;
...
) -> Result<crate::operation::get_associated_role::builders::GetAssociatedRoleOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
