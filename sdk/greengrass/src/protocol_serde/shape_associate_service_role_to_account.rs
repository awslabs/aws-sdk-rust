...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::associate_service_role_to_account::AssociateServiceRoleToAccountError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_service_role_to_account::de_associate_service_role_to_account(_response_body, output)
            .map_err(crate::operation::associate_service_role_to_account::AssociateServiceRoleToAccountError::unhandled)?;
