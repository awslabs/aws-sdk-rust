...
pub(crate) fn de___list_of_connectivity_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ConnectivityInfo>>, aws_smithy_json::deserialize::error::DeserializeError>
