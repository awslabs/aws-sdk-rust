                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Component" => {
                            builder = builder.set_component(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LoggerComponent::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Id" => {
                        ...
                        "Level" => {
                            builder = builder.set_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LoggerLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Space" => {
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::LoggerType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
