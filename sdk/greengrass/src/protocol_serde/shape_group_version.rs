...
pub fn ser_group_version(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GroupVersion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_group_version<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GroupVersion>, aws_smithy_json::deserialize::error::DeserializeError>
