...
pub fn de_list_groups_http_error(
    ...
    Err(crate::operation::list_groups::ListGroupsError::generic(generic))
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Groups" => {
                    builder = builder.set_groups(crate::protocol_serde::shape___list_of_group_information::de___list_of_group_information(
                        tokens,
                    )?);
                }
                "NextToken" => {
