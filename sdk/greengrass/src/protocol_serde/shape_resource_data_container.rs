...
pub fn ser_resource_data_container(
    ...
    if let Some(var_1) = &input.local_device_resource_data {
        ...
        crate::protocol_serde::shape_local_device_resource_data::ser_local_device_resource_data(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.local_volume_resource_data {
        ...
        crate::protocol_serde::shape_local_volume_resource_data::ser_local_volume_resource_data(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
pub(crate) fn de_resource_data_container<'a, I>(
    ...
    Option<crate::types::ResourceDataContainer>,
