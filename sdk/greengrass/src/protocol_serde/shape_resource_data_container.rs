...
pub fn ser_resource_data_container(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceDataContainer) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_resource_data_container<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResourceDataContainer>, aws_smithy_json::deserialize::error::DeserializeError>
