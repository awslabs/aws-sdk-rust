...
pub fn ser_create_function_definition_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFunctionDefinitionVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
