...
pub(crate) fn de_list_of_device<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Device>>, ::aws_smithy_json::deserialize::error::DeserializeError>
