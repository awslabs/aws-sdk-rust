                        ...
                        match key.to_unescaped()?.as_ref() {
                            "DefaultConfig" => {
                                builder = builder.set_default_config(
                                    crate::protocol_serde::shape_function_default_config::de_function_default_config(tokens, _value, depth + 1)?,
                                );
                            }
                            "Functions" => {
                                builder = builder.set_functions(crate::protocol_serde::shape_list_of_function::de_list_of_function(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
