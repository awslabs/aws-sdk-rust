...
pub(crate) fn de_error_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::ErrorDetail>>, ::aws_smithy_json::deserialize::error::DeserializeError>
