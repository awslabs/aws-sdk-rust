...
pub(crate) fn de_error_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ErrorDetail>>, aws_smithy_json::deserialize::error::DeserializeError>
