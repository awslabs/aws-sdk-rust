...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_connectivity_info::de_get_connectivity_info(_response_body, output)
            .map_err(crate::operation::get_connectivity_info::GetConnectivityInfoError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "ConnectivityInfo" => {
                        builder = builder.set_connectivity_info(
                            crate::protocol_serde::shape_list_of_connectivity_info::de_list_of_connectivity_info(tokens, _value, depth + 1)?,
                        );
                    }
                    "message" => {
