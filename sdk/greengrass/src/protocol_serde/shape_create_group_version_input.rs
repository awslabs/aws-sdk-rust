...
pub fn ser_create_group_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGroupVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
