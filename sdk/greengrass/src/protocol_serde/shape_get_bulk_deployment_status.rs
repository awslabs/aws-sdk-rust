...
pub fn de_get_bulk_deployment_status_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_bulk_deployment_status::GetBulkDeploymentStatusOutput, crate::operation::get_bulk_deployment_status::GetBulkDeploymentStatusError> {
    #[allow(unused_mut)]
