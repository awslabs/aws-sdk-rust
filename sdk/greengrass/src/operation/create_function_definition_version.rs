...
impl CreateFunctionDefinitionVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_function_definition_version::CreateFunctionDefinitionVersion,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_function_definition_version::CreateFunctionDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFunctionDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_function_definition_version::de_create_function_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
