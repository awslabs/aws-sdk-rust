...
impl crate::operation::get_connector_definition_version::builders::GetConnectorDefinitionVersionInputBuilder {
...
impl GetConnectorDefinitionVersionFluentBuilder {
    /// Creates a new `GetConnectorDefinitionVersionFluentBuilder`.
