...
impl ResetDeploymentsInput {
    /// Consumes the builder and constructs an Operation<[`ResetDeployments`](crate::operation::reset_deployments::ResetDeployments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_deployments::ResetDeployments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_deployments::ResetDeploymentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_deployments::ResetDeployments::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ResetDeployments {
                type Output = std::result::Result<crate::operation::reset_deployments::ResetDeploymentsOutput, crate::operation::reset_deployments::ResetDeploymentsError>;
