...
impl ResetDeploymentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reset_deployments::ResetDeployments, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reset_deployments::ser_reset_deployments_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetDeployments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_deployments::de_reset_deployments_http_response_with_props(status, headers, body)
        }
    }
}
