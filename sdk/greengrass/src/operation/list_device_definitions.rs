...
impl ListDeviceDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_device_definitions::ListDeviceDefinitions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeviceDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_device_definitions::de_list_device_definitions_http_response_with_props(status, headers, body)
        }
    }
}
