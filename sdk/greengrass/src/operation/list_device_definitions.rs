    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/greengrass/definition/devices")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_device_definitions::ListDeviceDefinitions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_device_definitions::ListDeviceDefinitionsError
{
