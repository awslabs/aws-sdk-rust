...
impl GetThingRuntimeConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_thing_runtime_configuration::GetThingRuntimeConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetThingRuntimeConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_thing_runtime_configuration::de_get_thing_runtime_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
