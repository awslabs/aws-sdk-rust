...
/// Orchestration and serialization glue logic for `UpdateConnectivityInfo`.
...
impl UpdateConnectivityInfo {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_connectivity_info::UpdateConnectivityInfoOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_connectivity_info::UpdateConnectivityInfoError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_connectivity_info::UpdateConnectivityInfoError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_connectivity_info::UpdateConnectivityInfoOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateConnectivityInfo {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateConnectivityInfo");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateConnectivityInfoRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateConnectivityInfoResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateConnectivityInfo")
...
.with_interceptor(UpdateConnectivityInfoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_connectivity_info::UpdateConnectivityInfoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_connectivity_info::UpdateConnectivityInfoError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_connectivity_info::UpdateConnectivityInfoError>::new());
...
#[derive(Debug)]
            struct UpdateConnectivityInfoResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateConnectivityInfoResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_connectivity_info::de_update_connectivity_info_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateConnectivityInfoRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateConnectivityInfoRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_connectivity_info::UpdateConnectivityInfoInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_connectivity_info::UpdateConnectivityInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/greengrass/things/{ThingName}/connectivityInfo", ThingName = thing_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_connectivity_info::ser_update_connectivity_info_input(&input)?);
...
#[derive(Debug)]
            struct UpdateConnectivityInfoEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateConnectivityInfoEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateConnectivityInfoEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateConnectivityInfoInput>()
                        .ok_or("failed to downcast to UpdateConnectivityInfoInput")?;
...
pub enum UpdateConnectivityInfoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateConnectivityInfoError) for what information is available for the error.")]
...
impl UpdateConnectivityInfoError {
    /// Creates the `UpdateConnectivityInfoError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateConnectivityInfoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateConnectivityInfoError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_connectivity_info::UpdateConnectivityInfoError {
...
mod _update_connectivity_info_output;
