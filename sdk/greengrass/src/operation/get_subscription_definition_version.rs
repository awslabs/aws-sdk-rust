...
impl GetSubscriptionDefinitionVersion {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_subscription_definition_version::GetSubscriptionDefinitionVersionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetSubscriptionDefinitionVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetSubscriptionDefinitionVersionRequestSerializer {
