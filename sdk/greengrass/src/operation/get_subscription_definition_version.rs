...
impl GetSubscriptionDefinitionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_subscription_definition_version::GetSubscriptionDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSubscriptionDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_subscription_definition_version::de_get_subscription_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
