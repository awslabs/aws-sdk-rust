...
impl ListConnectorDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_connector_definitions::ListConnectorDefinitionsInput, ::aws_smithy_types::error::operation::BuildError> {
