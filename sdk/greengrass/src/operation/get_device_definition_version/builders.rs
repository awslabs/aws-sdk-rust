...
impl crate::operation::get_device_definition_version::builders::GetDeviceDefinitionVersionInputBuilder {
...
impl GetDeviceDefinitionVersionFluentBuilder {
    /// Creates a new `GetDeviceDefinitionVersionFluentBuilder`.
