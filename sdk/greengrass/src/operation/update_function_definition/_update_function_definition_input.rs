...
impl UpdateFunctionDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_function_definition::UpdateFunctionDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
