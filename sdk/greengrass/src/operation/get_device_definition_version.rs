...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeviceDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_device_definition_version::de_get_device_definition_version_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_device_definition_version::GetDeviceDefinitionVersionError
{
