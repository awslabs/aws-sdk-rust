...
impl UpdateConnectorDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_connector_definition::UpdateConnectorDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectorDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connector_definition::de_update_connector_definition_http_response_with_props(status, headers, body)
        }
    }
}
