...
impl ListBulkDeploymentDetailedReportsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_bulk_deployment_detailed_reports::ListBulkDeploymentDetailedReports,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_bulk_deployment_detailed_reports::ListBulkDeploymentDetailedReports::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBulkDeploymentDetailedReports {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_bulk_deployment_detailed_reports::de_list_bulk_deployment_detailed_reports_http_response_with_props(
                status, headers, body,
            )
        }
    }
