...
impl CreateCoreDefinitionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_core_definition_version::CreateCoreDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCoreDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_core_definition_version::de_create_core_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
