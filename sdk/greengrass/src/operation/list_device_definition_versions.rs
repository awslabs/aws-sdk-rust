...
impl ListDeviceDefinitionVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_device_definition_versions::ListDeviceDefinitionVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeviceDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_device_definition_versions::de_list_device_definition_versions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListDeviceDefinitionVersionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_device_definition_versions::ListDeviceDefinitionVersionsError
{
