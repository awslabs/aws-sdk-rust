...
impl UpdateGroupCertificateConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_group_certificate_configuration::UpdateGroupCertificateConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGroupCertificateConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_group_certificate_configuration::de_update_group_certificate_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
