...
impl GetFunctionDefinitionVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_function_definition_version::GetFunctionDefinitionVersionInput, ::aws_smithy_types::error::operation::BuildError> {
