...
impl DeleteConnectorDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_connector_definition::DeleteConnectorDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConnectorDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_connector_definition::de_delete_connector_definition_http_response_with_props(status, headers, body)
        }
    }
}
