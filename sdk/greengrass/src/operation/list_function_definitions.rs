...
impl ListFunctionDefinitions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_function_definitions::ListFunctionDefinitionsInput,
                    ) -> ::std::result::Result<crate::operation::list_function_definitions::ListFunctionDefinitionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_function_definitions::ListFunctionDefinitionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_function_definitions::ListFunctionDefinitionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_function_definitions::ListFunctionDefinitionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFunctionDefinitions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListFunctionDefinitions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListFunctionDefinitionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListFunctionDefinitionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFunctionDefinitions")
...
.with_interceptor(ListFunctionDefinitionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_function_definitions::ListFunctionDefinitionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_function_definitions::ListFunctionDefinitionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_function_definitions::ListFunctionDefinitionsError>::new());
...
#[derive(Debug)]
            struct ListFunctionDefinitionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFunctionDefinitionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_function_definitions::de_list_function_definitions_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListFunctionDefinitionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFunctionDefinitionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_function_definitions::ListFunctionDefinitionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_function_definitions::ListFunctionDefinitionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/greengrass/definition/functions").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_function_definitions::ListFunctionDefinitionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListFunctionDefinitionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFunctionDefinitionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListFunctionDefinitionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListFunctionDefinitionsInput>()
                        .ok_or("failed to downcast to ListFunctionDefinitionsInput")?;
...
pub enum ListFunctionDefinitionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListFunctionDefinitionsError) for what information is available for the error.")]
...
impl ListFunctionDefinitionsError {
    /// Creates the `ListFunctionDefinitionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListFunctionDefinitionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListFunctionDefinitionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_function_definitions::ListFunctionDefinitionsError {
...
mod _list_function_definitions_output;
