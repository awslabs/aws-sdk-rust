...
impl ListFunctionDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_function_definitions::ListFunctionDefinitions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFunctionDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_function_definitions::de_list_function_definitions_http_response_with_props(status, headers, body)
        }
    }
}
