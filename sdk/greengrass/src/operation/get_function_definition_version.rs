...
impl GetFunctionDefinitionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_function_definition_version::GetFunctionDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFunctionDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_function_definition_version::de_get_function_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
