...
impl ListFunctionDefinitionVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_function_definition_versions::ListFunctionDefinitionVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFunctionDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_function_definition_versions::de_list_function_definition_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
