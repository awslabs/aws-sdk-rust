...
impl UpdateCoreDefinitionFluentBuilder  {
    /// Creates a new `UpdateCoreDefinition`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_core_definition::UpdateCoreDefinition, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_core_definition::UpdateCoreDefinitionError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_core_definition::UpdateCoreDefinitionOutput, aws_smithy_http::result::SdkError<crate::operation::update_core_definition::UpdateCoreDefinitionError>>
                     {
