...
impl ListSubscriptionDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_subscription_definitions::ListSubscriptionDefinitions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_subscription_definitions::ListSubscriptionDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscriptionDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_subscription_definitions::de_list_subscription_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
