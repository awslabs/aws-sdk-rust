...
impl ListSubscriptionDefinitionVersionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_subscription_definition_versions::ListSubscriptionDefinitionVersions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_subscription_definition_versions::ListSubscriptionDefinitionVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscriptionDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_subscription_definition_versions::de_list_subscription_definition_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
