...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscriptionDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_subscription_definition_versions::de_list_subscription_definition_versions_http_response_with_props(status, headers, body)
        }
    }
}
