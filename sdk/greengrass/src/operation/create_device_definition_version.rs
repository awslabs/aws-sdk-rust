...
impl CreateDeviceDefinitionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_device_definition_version::CreateDeviceDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDeviceDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_device_definition_version::de_create_device_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
