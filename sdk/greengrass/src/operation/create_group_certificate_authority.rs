...
impl CreateGroupCertificateAuthority {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateGroupCertificateAuthority {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateGroupCertificateAuthority");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateGroupCertificateAuthorityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateGroupCertificateAuthorityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateGroupCertificateAuthority")
...
.with_interceptor(CreateGroupCertificateAuthorityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError>::new());
...
#[derive(Debug)]
            struct CreateGroupCertificateAuthorityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateGroupCertificateAuthorityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_group_certificate_authority::de_create_group_certificate_authority_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_group_certificate_authority::de_create_group_certificate_authority_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateGroupCertificateAuthorityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateGroupCertificateAuthorityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/greengrass/groups/{GroupId}/certificateauthorities", GroupId = group_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct CreateGroupCertificateAuthorityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateGroupCertificateAuthorityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateGroupCertificateAuthorityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateGroupCertificateAuthorityInput>()
                        .ok_or("failed to downcast to CreateGroupCertificateAuthorityInput")?;
...
pub enum CreateGroupCertificateAuthorityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateGroupCertificateAuthorityError) for what information is available for the error.")]
...
impl CreateGroupCertificateAuthorityError {
    /// Creates the `CreateGroupCertificateAuthorityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateGroupCertificateAuthorityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateGroupCertificateAuthorityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_group_certificate_authority::CreateGroupCertificateAuthorityError {
...
mod _create_group_certificate_authority_output;
