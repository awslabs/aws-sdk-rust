...
impl ListConnectorDefinitionVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_connector_definition_versions::ListConnectorDefinitionVersionsInput, ::aws_smithy_types::error::operation::BuildError> {
