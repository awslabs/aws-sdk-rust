...
impl ListSubscriptionDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_subscription_definitions::ListSubscriptionDefinitionsInput, ::aws_smithy_types::error::operation::BuildError> {
