...
impl GetServiceRoleForAccountInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_service_role_for_account::GetServiceRoleForAccount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceRoleForAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_role_for_account::de_get_service_role_for_account_http_response_with_props(status, headers, body)
        }
    }
}
