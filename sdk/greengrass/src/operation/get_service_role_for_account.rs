...
impl GetServiceRoleForAccount {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_service_role_for_account::GetServiceRoleForAccountInput,
                    ) -> ::std::result::Result<crate::operation::get_service_role_for_account::GetServiceRoleForAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_service_role_for_account::GetServiceRoleForAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetServiceRoleForAccount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetServiceRoleForAccount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetServiceRoleForAccountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetServiceRoleForAccountResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetServiceRoleForAccount")
...
.with_interceptor(GetServiceRoleForAccountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountError>::new());
...
#[derive(Debug)]
            struct GetServiceRoleForAccountResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetServiceRoleForAccountResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_service_role_for_account::de_get_service_role_for_account_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_service_role_for_account::de_get_service_role_for_account_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetServiceRoleForAccountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetServiceRoleForAccountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_service_role_for_account::GetServiceRoleForAccountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_service_role_for_account::GetServiceRoleForAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetServiceRoleForAccountEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetServiceRoleForAccountEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetServiceRoleForAccountEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetServiceRoleForAccountInput>()
                        .ok_or("failed to downcast to GetServiceRoleForAccountInput")?;
...
pub enum GetServiceRoleForAccountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetServiceRoleForAccountError) for what information is available for the error.")]
...
impl GetServiceRoleForAccountError {
    /// Creates the `GetServiceRoleForAccountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetServiceRoleForAccountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetServiceRoleForAccountError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_service_role_for_account::GetServiceRoleForAccountError {
...
mod _get_service_role_for_account_output;
