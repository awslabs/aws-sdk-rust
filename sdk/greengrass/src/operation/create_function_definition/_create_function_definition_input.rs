...
impl CreateFunctionDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_function_definition::CreateFunctionDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
