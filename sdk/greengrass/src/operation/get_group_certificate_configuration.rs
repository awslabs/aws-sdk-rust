...
impl GetGroupCertificateConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_group_certificate_configuration::GetGroupCertificateConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupCertificateConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_group_certificate_configuration::de_get_group_certificate_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
