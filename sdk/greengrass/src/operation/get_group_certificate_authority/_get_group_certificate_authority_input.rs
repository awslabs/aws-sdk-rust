...
impl GetGroupCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_group_certificate_authority::GetGroupCertificateAuthorityInput, ::aws_smithy_types::error::operation::BuildError> {
