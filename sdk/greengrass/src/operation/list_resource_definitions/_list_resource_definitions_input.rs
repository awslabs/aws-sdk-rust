...
impl ListResourceDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resource_definitions::ListResourceDefinitionsInput, ::aws_smithy_types::error::operation::BuildError> {
