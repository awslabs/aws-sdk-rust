...
impl CreateLoggerDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_logger_definition::CreateLoggerDefinition,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLoggerDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_logger_definition::de_create_logger_definition_http_response_with_props(status, headers, body)
        }
    }
}
