...
impl StopBulkDeployment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_bulk_deployment::StopBulkDeploymentInput,
                    ) -> ::std::result::Result<crate::operation::stop_bulk_deployment::StopBulkDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_bulk_deployment::StopBulkDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_bulk_deployment::StopBulkDeploymentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_bulk_deployment::StopBulkDeploymentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopBulkDeployment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopBulkDeployment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopBulkDeploymentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopBulkDeploymentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopBulkDeployment")
...
.with_interceptor(StopBulkDeploymentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_bulk_deployment::StopBulkDeploymentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_bulk_deployment::StopBulkDeploymentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_bulk_deployment::StopBulkDeploymentError>::new());
...
#[derive(Debug)]
            struct StopBulkDeploymentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopBulkDeploymentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_bulk_deployment::de_stop_bulk_deployment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_bulk_deployment::de_stop_bulk_deployment_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopBulkDeploymentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopBulkDeploymentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_bulk_deployment::StopBulkDeploymentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_bulk_deployment::StopBulkDeploymentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/greengrass/bulk/deployments/{BulkDeploymentId}/$stop", BulkDeploymentId = bulk_deployment_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct StopBulkDeploymentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopBulkDeploymentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopBulkDeploymentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopBulkDeploymentInput>()
                        .ok_or("failed to downcast to StopBulkDeploymentInput")?;
...
pub enum StopBulkDeploymentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopBulkDeploymentError) for what information is available for the error.")]
...
impl StopBulkDeploymentError {
    /// Creates the `StopBulkDeploymentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopBulkDeploymentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopBulkDeploymentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_bulk_deployment::StopBulkDeploymentError {
...
mod _stop_bulk_deployment_output;
