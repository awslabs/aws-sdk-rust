...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_group_certificate_authority::de_get_group_certificate_authority_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetGroupCertificateAuthorityError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_group_certificate_authority::GetGroupCertificateAuthorityError
{
