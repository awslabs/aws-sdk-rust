...
impl GetResourceDefinitionVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_resource_definition_version::GetResourceDefinitionVersion,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_definition_version::GetResourceDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_definition_version::de_get_resource_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
