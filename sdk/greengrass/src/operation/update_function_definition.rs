    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_function_definition::UpdateFunctionDefinitionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_function_definition::UpdateFunctionDefinitionOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateFunctionDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateFunctionDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_function_definition::UpdateFunctionDefinitionInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("function_definition_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateFunctionDefinitionEndpointParamsInterceptor {
