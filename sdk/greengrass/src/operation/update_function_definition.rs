...
impl UpdateFunctionDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_function_definition::UpdateFunctionDefinition,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFunctionDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_function_definition::de_update_function_definition_http_response_with_props(status, headers, body)
        }
    }
}
