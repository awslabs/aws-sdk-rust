...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCoreDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_core_definition_versions::de_list_core_definition_versions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_core_definition_versions::ListCoreDefinitionVersionsError
{
