...
impl GetCoreDefinitionVersionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_core_definition_version::GetCoreDefinitionVersion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCoreDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_core_definition_version::de_get_core_definition_version_http_response_with_props(status, headers, body)
        }
    }
}
