...
impl DisassociateRoleFromGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateRoleFromGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateRoleFromGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateRoleFromGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateRoleFromGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateRoleFromGroup")
...
.with_interceptor(DisassociateRoleFromGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError>::new());
...
#[derive(Debug)]
            struct DisassociateRoleFromGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateRoleFromGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_role_from_group::de_disassociate_role_from_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_role_from_group::de_disassociate_role_from_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateRoleFromGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateRoleFromGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/greengrass/groups/{GroupId}/role", GroupId = group_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DisassociateRoleFromGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateRoleFromGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateRoleFromGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateRoleFromGroupInput>()
                        .ok_or("failed to downcast to DisassociateRoleFromGroupInput")?;
...
pub enum DisassociateRoleFromGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateRoleFromGroupError) for what information is available for the error.")]
...
impl DisassociateRoleFromGroupError {
    /// Creates the `DisassociateRoleFromGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateRoleFromGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateRoleFromGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError {
...
mod _disassociate_role_from_group_output;
