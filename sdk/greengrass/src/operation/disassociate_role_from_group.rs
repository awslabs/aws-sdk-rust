...
impl DisassociateRoleFromGroupInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateRoleFromGroup`](crate::operation::disassociate_role_from_group::DisassociateRoleFromGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_role_from_group::DisassociateRoleFromGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateRoleFromGroup {
                type Output = std::result::Result<crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupOutput, crate::operation::disassociate_role_from_group::DisassociateRoleFromGroupError>;
