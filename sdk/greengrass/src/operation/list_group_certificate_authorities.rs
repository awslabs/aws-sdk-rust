    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListGroupCertificateAuthoritiesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListGroupCertificateAuthoritiesRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListGroupCertificateAuthoritiesEndpointParamsInterceptor {
