...
impl ListGroupCertificateAuthoritiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthorities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupCertificateAuthorities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_group_certificate_authorities::de_list_group_certificate_authorities_http_response_with_props(
                status, headers, body,
            )
        }
    }
