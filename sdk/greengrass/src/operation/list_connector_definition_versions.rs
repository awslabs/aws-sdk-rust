...
impl ListConnectorDefinitionVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_connector_definition_versions::ListConnectorDefinitionVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConnectorDefinitionVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_connector_definition_versions::de_list_connector_definition_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
