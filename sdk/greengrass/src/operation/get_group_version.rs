...
impl GetGroupVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_group_version::GetGroupVersion, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupVersion {
    type Output =
        ::std::result::Result<crate::operation::get_group_version::GetGroupVersionOutput, crate::operation::get_group_version::GetGroupVersionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_group_version::de_get_group_version_http_response_with_props(status, headers, body)
        }
    }
}
