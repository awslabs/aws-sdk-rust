...
impl DeleteSubscriptionDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_subscription_definition::DeleteSubscriptionDefinition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_subscription_definition::DeleteSubscriptionDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSubscriptionDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_subscription_definition::de_delete_subscription_definition_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteSubscriptionDefinitionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_subscription_definition::DeleteSubscriptionDefinitionError
{
