...
impl CreateDeviceDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_device_definition::CreateDeviceDefinition,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDeviceDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_device_definition::de_create_device_definition_http_response_with_props(status, headers, body)
        }
    }
}
