...
impl crate::operation::update_thing_runtime_configuration::builders::UpdateThingRuntimeConfigurationInputBuilder {
...
impl UpdateThingRuntimeConfigurationFluentBuilder {
    /// Creates a new `UpdateThingRuntimeConfigurationFluentBuilder`.
