...
impl CreateSoftwareUpdateJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_software_update_job::CreateSoftwareUpdateJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_software_update_job::CreateSoftwareUpdateJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSoftwareUpdateJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSoftwareUpdateJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateSoftwareUpdateJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateSoftwareUpdateJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSoftwareUpdateJob")
...
.with_interceptor(CreateSoftwareUpdateJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobError>::new());
...
#[derive(Debug)]
            struct CreateSoftwareUpdateJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSoftwareUpdateJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_software_update_job::de_create_software_update_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateSoftwareUpdateJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSoftwareUpdateJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_software_update_job::CreateSoftwareUpdateJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_software_update_job::CreateSoftwareUpdateJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/greengrass/updates").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_software_update_job::ser_create_software_update_job_input(&input)?);
...
#[derive(Debug)]
            struct CreateSoftwareUpdateJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSoftwareUpdateJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateSoftwareUpdateJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateSoftwareUpdateJobInput>()
                        .ok_or("failed to downcast to CreateSoftwareUpdateJobInput")?;
...
pub enum CreateSoftwareUpdateJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateSoftwareUpdateJobError) for what information is available for the error.")]
...
impl CreateSoftwareUpdateJobError {
    /// Creates the `CreateSoftwareUpdateJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSoftwareUpdateJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateSoftwareUpdateJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_software_update_job::CreateSoftwareUpdateJobError {
...
mod _create_software_update_job_output;
