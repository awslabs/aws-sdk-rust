...
impl CreateConnectorDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_connector_definition::CreateConnectorDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConnectorDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_connector_definition::de_create_connector_definition_http_response_with_props(status, headers, body)
        }
    }
}
