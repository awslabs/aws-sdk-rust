...
impl DeleteFunctionDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_function_definition::DeleteFunctionDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
