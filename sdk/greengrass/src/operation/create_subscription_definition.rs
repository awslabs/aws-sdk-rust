...
impl CreateSubscriptionDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_subscription_definition::CreateSubscriptionDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubscriptionDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_subscription_definition::de_create_subscription_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
