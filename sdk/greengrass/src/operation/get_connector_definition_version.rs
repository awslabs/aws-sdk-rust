...
impl GetConnectorDefinitionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_connector_definition_version::GetConnectorDefinitionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConnectorDefinitionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_connector_definition_version::de_get_connector_definition_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
