    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/greengrass/bulk/deployments")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_bulk_deployments::ListBulkDeployments::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBulkDeployments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_bulk_deployments::de_list_bulk_deployments_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_bulk_deployments::ListBulkDeploymentsError
{
