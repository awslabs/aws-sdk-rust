...
impl ::std::convert::From<&str> for Telemetry {
    fn from(s: &str) -> Self {
        match s {
            "Off" => Telemetry::Off,
            "On" => Telemetry::On,
            other => Telemetry::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Telemetry {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Telemetry::from(s))
    }
}
impl Telemetry {
...
impl ::std::convert::AsRef<str> for Telemetry {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
