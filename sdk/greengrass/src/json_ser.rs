...
pub fn serialize_structure_associate_role_to_group_input(
...
pub fn serialize_structure_associate_service_role_to_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_connector_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_3) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_connector_definition_version(&mut object_4, var_3);
        object_4.finish();
    }
...
pub fn serialize_structure_create_connector_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_12 in var_10 {
            {
                ...
                crate::json_ser::serialize_structure_connector(&mut object_13, item_12);
                object_13.finish();
            }
        }
        array_11.finish();
...
pub fn serialize_structure_create_core_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_14) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_core_definition_version(&mut object_15, var_14);
        object_15.finish();
    }
...
pub fn serialize_structure_create_core_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_core(&mut object_24, item_23);
                object_24.finish();
            }
        }
        array_22.finish();
...
pub fn serialize_structure_create_deployment_input(
    ...
    if let Some(var_25) = &input.deployment_id {
        object.key("DeploymentId").string(var_25);
    }
    ...
    if let Some(var_27) = &input.group_version_id {
        object.key("GroupVersionId").string(var_27);
    }
}

pub fn serialize_structure_create_device_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_28) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_device_definition_version(&mut object_29, var_28);
        object_29.finish();
    }
...
pub fn serialize_structure_create_device_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_37 in var_35 {
            {
                ...
                crate::json_ser::serialize_structure_device(&mut object_38, item_37);
                object_38.finish();
            }
        }
        array_36.finish();
...
pub fn serialize_structure_create_function_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_39) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_function_definition_version(&mut object_40, var_39);
        object_40.finish();
    }
...
pub fn serialize_structure_create_function_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_46) = &input.default_config {
        ...
        crate::json_ser::serialize_structure_function_default_config(&mut object_47, var_46);
        object_47.finish();
    }
        ...
        for item_50 in var_48 {
            {
                ...
                crate::json_ser::serialize_structure_function(&mut object_51, item_50);
                object_51.finish();
            }
        }
        array_49.finish();
...
pub fn serialize_structure_create_group_input(
    ...
    if let Some(var_52) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_group_version(&mut object_53, var_52);
        object_53.finish();
    }
...
pub fn serialize_structure_create_logger_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_66) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_logger_definition_version(&mut object_67, var_66);
        object_67.finish();
    }
...
pub fn serialize_structure_create_logger_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_75 in var_73 {
            {
                ...
                crate::json_ser::serialize_structure_logger(&mut object_76, item_75);
                object_76.finish();
            }
        }
        array_74.finish();
...
pub fn serialize_structure_create_resource_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_77) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_resource_definition_version(&mut object_78, var_77);
        object_78.finish();
    }
...
pub fn serialize_structure_create_resource_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_86 in var_84 {
            {
                ...
                crate::json_ser::serialize_structure_resource(&mut object_87, item_86);
                object_87.finish();
            }
        }
        array_85.finish();
...
pub fn serialize_structure_create_software_update_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::CreateSoftwareUpdateJobInput,
) {
    if let Some(var_88) = &input.s3_url_signer_role {
        object.key("S3UrlSignerRole").string(var_88);
    }
...
pub fn serialize_structure_create_subscription_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_96) = &input.initial_version {
        ...
        crate::json_ser::serialize_structure_subscription_definition_version(
            &mut object_97,
            var_96,
        );
        object_97.finish();
...
pub fn serialize_structure_create_subscription_definition_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_105 in var_103 {
            {
                ...
                crate::json_ser::serialize_structure_subscription(&mut object_106, item_105);
                object_106.finish();
            }
        }
        array_104.finish();
...
pub fn serialize_structure_reset_deployments_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_bulk_deployment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::StartBulkDeploymentInput,
) {
    if let Some(var_107) = &input.execution_role_arn {
        object.key("ExecutionRoleArn").string(var_107);
    }
    if let Some(var_108) = &input.input_file_uri {
        object.key("InputFileUri").string(var_108);
    }
...
pub fn serialize_structure_update_connectivity_info_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_119 in var_117 {
            {
                ...
                crate::json_ser::serialize_structure_connectivity_info(&mut object_120, item_119);
                object_120.finish();
            }
        }
        array_118.finish();
...
pub fn serialize_structure_update_connector_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_core_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_device_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_function_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_group_certificate_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_logger_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_resource_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_subscription_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_thing_runtime_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_130) = &input.telemetry_configuration {
        ...
        crate::json_ser::serialize_structure_telemetry_configuration_update(
            &mut object_131,
            var_130,
        );
        object_131.finish();
...
pub fn serialize_structure_connector_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_134 in var_132 {
            {
                ...
                crate::json_ser::serialize_structure_connector(&mut object_135, item_134);
                object_135.finish();
            }
        }
        array_133.finish();
...
pub fn serialize_structure_connector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::Connector,
) {
    if let Some(var_136) = &input.connector_arn {
        object.key("ConnectorArn").string(var_136);
    }
...
pub fn serialize_structure_core_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_144 in var_142 {
            {
                ...
                crate::json_ser::serialize_structure_core(&mut object_145, item_144);
                object_145.finish();
            }
        }
        array_143.finish();
        ...
        for item_151 in var_149 {
            {
                ...
                crate::json_ser::serialize_structure_device(&mut object_152, item_151);
                object_152.finish();
            }
        }
        array_150.finish();
...
pub fn serialize_structure_device(
    ...
    if let Some(var_153) = &input.certificate_arn {
        object.key("CertificateArn").string(var_153);
    }
    ...
    if let Some(var_155) = &input.thing_arn {
        object.key("ThingArn").string(var_155);
    }
}

pub fn serialize_structure_function_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_156) = &input.default_config {
        ...
        crate::json_ser::serialize_structure_function_default_config(&mut object_157, var_156);
        object_157.finish();
    }
        ...
        for item_160 in var_158 {
            {
                ...
                crate::json_ser::serialize_structure_function(&mut object_161, item_160);
                object_161.finish();
            }
        }
        array_159.finish();
...
pub fn serialize_structure_function_default_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_162) = &input.execution {
        ...
        crate::json_ser::serialize_structure_function_default_execution_config(
            &mut object_163,
            var_162,
        );
        object_163.finish();
...
pub fn serialize_structure_logger_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_177 in var_175 {
            {
                ...
                crate::json_ser::serialize_structure_logger(&mut object_178, item_177);
                object_178.finish();
            }
        }
        array_176.finish();
...
pub fn serialize_structure_logger(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.space != 0 {
        object.key("Space").number(
            ...
            smithy_types::Number::NegInt((input.space).into()),
        );
    }
...
pub fn serialize_structure_resource_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_185 in var_183 {
            {
                ...
                crate::json_ser::serialize_structure_resource(&mut object_186, item_185);
                object_186.finish();
            }
        }
        array_184.finish();
...
pub fn serialize_structure_resource(
    ...
    if let Some(var_189) = &input.resource_data_container {
        ...
        crate::json_ser::serialize_structure_resource_data_container(&mut object_190, var_189);
        object_190.finish();
    }
}

pub fn serialize_structure_subscription_definition_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_193 in var_191 {
            {
                ...
                crate::json_ser::serialize_structure_subscription(&mut object_194, item_193);
                object_194.finish();
            }
        }
        array_192.finish();
...
pub fn serialize_structure_subscription(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_196) = &input.source {
        object.key("Source").string(var_196);
    }
    if let Some(var_197) = &input.subject {
        object.key("Subject").string(var_197);
    }
    if let Some(var_198) = &input.target {
        object.key("Target").string(var_198);
    }
}

pub fn serialize_structure_connectivity_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ConnectivityInfo,
) {
    if let Some(var_199) = &input.host_address {
        object.key("HostAddress").string(var_199);
    }
    if let Some(var_200) = &input.id {
        object.key("Id").string(var_200);
    }
    if let Some(var_201) = &input.metadata {
        object.key("Metadata").string(var_201);
    }
    if input.port_number != 0 {
        object.key("PortNumber").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.port_number).into()),
        );
    }
}

pub fn serialize_structure_telemetry_configuration_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_function_default_execution_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_204) = &input.run_as {
        ...
        crate::json_ser::serialize_structure_function_run_as_config(&mut object_205, var_204);
        object_205.finish();
    }
}

pub fn serialize_structure_function_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_207) = &input.environment {
        ...
        crate::json_ser::serialize_structure_function_configuration_environment(
            &mut object_208,
            var_207,
        );
        object_208.finish();
    ...
    if let Some(var_209) = &input.exec_args {
        object.key("ExecArgs").string(var_209);
    }
    if let Some(var_210) = &input.executable {
        object.key("Executable").string(var_210);
    }
...
pub fn serialize_structure_resource_data_container(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_211) = &input.local_device_resource_data {
        ...
        crate::json_ser::serialize_structure_local_device_resource_data(&mut object_212, var_211);
        object_212.finish();
    }
    if let Some(var_213) = &input.local_volume_resource_data {
        let mut object_214 = object.key("LocalVolumeResourceData").start_object();
        crate::json_ser::serialize_structure_local_volume_resource_data(&mut object_214, var_213);
        object_214.finish();
    }
    if let Some(var_215) = &input.s3_machine_learning_model_resource_data {
        let mut object_216 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_s3_machine_learning_model_resource_data(
            &mut object_216,
            var_215,
        );
        object_216.finish();
    ...
    if let Some(var_217) = &input.sage_maker_machine_learning_model_resource_data {
        let mut object_218 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_sage_maker_machine_learning_model_resource_data(
            &mut object_218,
            var_217,
        );
        object_218.finish();
    ...
    if let Some(var_219) = &input.secrets_manager_secret_resource_data {
        let mut object_220 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_secrets_manager_secret_resource_data(
            &mut object_220,
            var_219,
        );
        object_220.finish();
...
pub fn serialize_structure_function_run_as_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.gid != 0 {
        object.key("Gid").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.gid).into()),
        );
    }
    if input.uid != 0 {
        object.key("Uid").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.uid).into()),
        );
    }
}

pub fn serialize_structure_function_configuration_environment(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_221) = &input.execution {
        ...
        crate::json_ser::serialize_structure_function_execution_config(&mut object_222, var_221);
        object_222.finish();
    }
        ...
        for item_225 in var_223 {
            {
                ...
                crate::json_ser::serialize_structure_resource_access_policy(
                    &mut object_226,
                    item_225,
                );
                object_226.finish();
    ...
    if let Some(var_227) = &input.variables {
        ...
        for (key_229, value_230) in var_227 {
            {
                object_228.key(key_229).string(value_230);
            }
        }
        object_228.finish();
    }
...
pub fn serialize_structure_local_device_resource_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_231) = &input.group_owner_setting {
        ...
        crate::json_ser::serialize_structure_group_owner_setting(&mut object_232, var_231);
        object_232.finish();
    }
    if let Some(var_233) = &input.source_path {
        object.key("SourcePath").string(var_233);
    }
}

pub fn serialize_structure_local_volume_resource_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::LocalVolumeResourceData,
) {
    if let Some(var_234) = &input.destination_path {
        object.key("DestinationPath").string(var_234);
    }
    if let Some(var_235) = &input.group_owner_setting {
        let mut object_236 = object.key("GroupOwnerSetting").start_object();
        crate::json_ser::serialize_structure_group_owner_setting(&mut object_236, var_235);
        object_236.finish();
    }
    if let Some(var_237) = &input.source_path {
        object.key("SourcePath").string(var_237);
    }
}

pub fn serialize_structure_s3_machine_learning_model_resource_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::S3MachineLearningModelResourceData,
) {
    if let Some(var_238) = &input.destination_path {
        object.key("DestinationPath").string(var_238);
    }
    if let Some(var_239) = &input.owner_setting {
        let mut object_240 = object.key("OwnerSetting").start_object();
        crate::json_ser::serialize_structure_resource_download_owner_setting(
            &mut object_240,
            var_239,
        );
        object_240.finish();
    ...
    if let Some(var_241) = &input.s3_uri {
        object.key("S3Uri").string(var_241);
    }
}

pub fn serialize_structure_sage_maker_machine_learning_model_resource_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SageMakerMachineLearningModelResourceData,
) {
    if let Some(var_242) = &input.destination_path {
        object.key("DestinationPath").string(var_242);
    }
    ...
    if let Some(var_245) = &input.sage_maker_job_arn {
        object.key("SageMakerJobArn").string(var_245);
    }
}

pub fn serialize_structure_secrets_manager_secret_resource_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SecretsManagerSecretResourceData,
) {
    if let Some(var_246) = &input.arn {
        object.key("ARN").string(var_246);
    }
...
pub fn serialize_structure_function_execution_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_251) = &input.run_as {
        ...
        crate::json_ser::serialize_structure_function_run_as_config(&mut object_252, var_251);
        object_252.finish();
    }
}

pub fn serialize_structure_resource_access_policy(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_254) = &input.resource_id {
        object.key("ResourceId").string(var_254);
    }
}

pub fn serialize_structure_group_owner_setting(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_255) = &input.group_owner {
        object.key("GroupOwner").string(var_255);
    }
}

pub fn serialize_structure_resource_download_owner_setting(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ResourceDownloadOwnerSetting,
) {
    if let Some(var_256) = &input.group_owner {
        object.key("GroupOwner").string(var_256);
    }
