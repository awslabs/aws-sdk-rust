...
/// Configuration for a aws_sdk_timestreamquery service client.
///
...
impl Builder {
    ...
    /// impl aws_sdk_timestreamquery::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_timestreamquery::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_timestreamquery::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_timestreamquery::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_timestreamquery::Client::from_conf(config);
    /// ```
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `timestreamquery`
    /// (or `timestreamquery-<region>` if a region is configured).
    /// All Timestream Query clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamquery::config::Config;
    /// use aws_sdk_timestreamquery::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamquery::config::Config;
    /// use aws_sdk_timestreamquery::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamquery::config::IdentityCache;
    ///
    /// let config = aws_sdk_timestreamquery::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_timestreamquery::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_timestreamquery::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_timestreamquery::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
