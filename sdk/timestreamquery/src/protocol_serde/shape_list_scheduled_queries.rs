...
> {
    Ok({
        ...
        crate::serde_util::list_scheduled_queries_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_scheduled_queries::ListScheduledQueriesError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ScheduledQueries" => {
                    builder = builder.set_scheduled_queries(crate::protocol_serde::shape_scheduled_query_list::de_scheduled_query_list(tokens)?);
                }
                "NextToken" => {
