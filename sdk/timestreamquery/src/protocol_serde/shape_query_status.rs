...
pub(crate) fn de_query_status<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::QueryStatus>, ::aws_smithy_json::deserialize::error::DeserializeError>
