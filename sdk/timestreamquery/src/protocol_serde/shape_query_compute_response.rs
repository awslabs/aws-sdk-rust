...
) -> Result<Option<crate::types::QueryComputeResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ProvisionedCapacity" => {
                            builder = builder.set_provisioned_capacity(
                                crate::protocol_serde::shape_provisioned_capacity_response::de_provisioned_capacity_response(tokens)?,
                            );
                        }
