...
) -> Result<Option<crate::types::QuerySpatialCoverageMax>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PartitionKey" => {
                            builder = builder.set_partition_key(crate::protocol_serde::shape_partition_key_list::de_partition_key_list(tokens)?);
                        }
