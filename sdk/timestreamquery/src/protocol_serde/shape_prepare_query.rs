...
pub fn de_prepare_query_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::prepare_query::PrepareQueryOutput, crate::operation::prepare_query::PrepareQueryError> {
    #[allow(unused_mut)]
...
pub fn de_prepare_query_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_prepare_query::de_prepare_query(_response_body, output)
            .map_err(crate::operation::prepare_query::PrepareQueryError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::prepare_query_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::prepare_query::PrepareQueryError::unhandled)?
    })
}
...
) -> Result<crate::operation::prepare_query::builders::PrepareQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Columns" => {
                    builder = builder.set_columns(crate::protocol_serde::shape_select_column_list::de_select_column_list(tokens)?);
                }
                "Parameters" => {
                    builder = builder.set_parameters(crate::protocol_serde::shape_parameter_mapping_list::de_parameter_mapping_list(tokens)?);
                }
