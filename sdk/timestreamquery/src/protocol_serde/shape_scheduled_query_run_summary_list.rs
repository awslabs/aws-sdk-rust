...
pub(crate) fn de_scheduled_query_run_summary_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::ScheduledQueryRunSummary>>, ::aws_smithy_json::deserialize::error::DeserializeError>
