    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "MaxQueryTCU" => {
                    builder = builder.set_max_query_tcu(
                ...
                "QueryPricingModel" => {
                    builder = builder.set_query_pricing_model(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::QueryPricingModel::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "QueryCompute" => {
                    builder = builder.set_query_compute(crate::protocol_serde::shape_query_compute_response::de_query_compute_response(
                        tokens, _value,
                    )?);
                }
