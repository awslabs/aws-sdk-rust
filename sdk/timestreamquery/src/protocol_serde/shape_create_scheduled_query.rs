...
> {
    Ok({
        ...
        crate::serde_util::create_scheduled_query_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_scheduled_query::CreateScheduledQueryError::unhandled)?
    })
}
...
pub fn ser_create_scheduled_query_input(
    ...
    crate::protocol_serde::shape_create_scheduled_query_input::ser_create_scheduled_query_input(&mut object, input)?;
    object.finish();
