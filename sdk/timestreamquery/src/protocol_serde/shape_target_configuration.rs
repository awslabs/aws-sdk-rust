...
pub(crate) fn de_target_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TargetConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
