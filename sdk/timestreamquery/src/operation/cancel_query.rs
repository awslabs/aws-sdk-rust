...
impl CancelQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_query::CancelQuery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_query::CancelQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_query::de_cancel_query_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_cancel_query::de_cancel_query_http_response_with_props(
                status, headers, body,
            )
        }
    }
