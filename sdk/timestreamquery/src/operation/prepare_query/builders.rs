...
impl PrepareQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::prepare_query::PrepareQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::prepare_query::PrepareQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::prepare_query::PrepareQueryOutput, crate::operation::prepare_query::PrepareQueryError, Self> {
