    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_scheduled_query::DescribeScheduledQueryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_scheduled_query::DescribeScheduledQueryOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeScheduledQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeScheduledQuery", "timestreamquery"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeScheduledQuery")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeScheduledQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeScheduledQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_scheduled_query::DescribeScheduledQueryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_scheduled_query::ser_describe_scheduled_query_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeScheduledQueryEndpointParamsInterceptor {
...
pub type DescribeScheduledQueryErrorKind = DescribeScheduledQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeScheduledQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_scheduled_query::DescribeScheduledQueryError {
...
impl DescribeScheduledQueryError {
    ...
    /// Creates the `DescribeScheduledQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
