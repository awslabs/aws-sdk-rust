...
impl PrepareQueryInput {
    /// Consumes the builder and constructs an Operation<[`PrepareQuery`](crate::operation::prepare_query::PrepareQuery)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::prepare_query::PrepareQuery, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_prepare_query::ser_prepare_query_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::prepare_query::PrepareQuery::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("PrepareQuery", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PrepareQuery {
    type Output = ::std::result::Result<crate::operation::prepare_query::PrepareQueryOutput, crate::operation::prepare_query::PrepareQueryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_prepare_query::de_prepare_query_http_response_with_props(status, headers, body)
        }
    }
