...
impl DescribeAccountSettings {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Timestream Query.DescribeAccountSettings",
...
impl DescribeAccountSettingsError {
    ...
    /// Returns `true` if the error kind is `DescribeAccountSettingsError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSettingsError::InvalidEndpointException`.
