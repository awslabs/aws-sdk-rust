...
impl ExecuteScheduledQueryInput {
    /// Consumes the builder and constructs an Operation<[`ExecuteScheduledQuery`](crate::operation::execute_scheduled_query::ExecuteScheduledQuery)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::execute_scheduled_query::ExecuteScheduledQuery::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ExecuteScheduledQuery", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteScheduledQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_execute_scheduled_query::de_execute_scheduled_query_http_response_with_props(status, headers, body)
        }
    }
}
