    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::execute_scheduled_query::ExecuteScheduledQueryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::execute_scheduled_query::ExecuteScheduledQueryOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExecuteScheduledQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ExecuteScheduledQuery", "timestreamquery"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteScheduledQuery")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ExecuteScheduledQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ExecuteScheduledQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::execute_scheduled_query::ExecuteScheduledQueryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_scheduled_query::ser_execute_scheduled_query_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExecuteScheduledQueryEndpointParamsInterceptor {
...
pub type ExecuteScheduledQueryErrorKind = ExecuteScheduledQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ExecuteScheduledQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_scheduled_query::ExecuteScheduledQueryError {
...
impl ExecuteScheduledQueryError {
    ...
    /// Creates the `ExecuteScheduledQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
