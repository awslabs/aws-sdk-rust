...
impl UpdateScheduledQueryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateScheduledQuery`](crate::operation::update_scheduled_query::UpdateScheduledQuery)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_scheduled_query::UpdateScheduledQuery::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateScheduledQuery", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateScheduledQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_scheduled_query::de_update_scheduled_query_http_response_with_props(status, headers, body)
        }
    }
}
