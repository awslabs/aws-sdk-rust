    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_scheduled_query::UpdateScheduledQueryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_scheduled_query::UpdateScheduledQueryOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateScheduledQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateScheduledQuery", "timestreamquery"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateScheduledQuery")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateScheduledQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateScheduledQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_scheduled_query::UpdateScheduledQueryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_scheduled_query::ser_update_scheduled_query_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateScheduledQueryEndpointParamsInterceptor {
...
pub type UpdateScheduledQueryErrorKind = UpdateScheduledQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateScheduledQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_scheduled_query::UpdateScheduledQueryError {
...
impl UpdateScheduledQueryError {
    ...
    /// Creates the `UpdateScheduledQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
