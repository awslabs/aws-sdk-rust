...
impl ListScheduledQueries {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Timestream Query.ListScheduledQueries",
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListScheduledQueriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_scheduled_queries::de_list_scheduled_queries_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_scheduled_queries::de_list_scheduled_queries_http_response(status, headers, body, _cfg)
        };
