    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_scheduled_queries::ListScheduledQueriesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_scheduled_queries::ListScheduledQueriesOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListScheduledQueries {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListScheduledQueries", "timestreamquery"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListScheduledQueries")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListScheduledQueriesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListScheduledQueriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_scheduled_queries::ListScheduledQueriesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_scheduled_queries::ser_list_scheduled_queries_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListScheduledQueriesEndpointParamsInterceptor {
...
pub type ListScheduledQueriesErrorKind = ListScheduledQueriesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListScheduledQueriesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_scheduled_queries::ListScheduledQueriesError {
...
impl ListScheduledQueriesError {
    ...
    /// Creates the `ListScheduledQueriesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
