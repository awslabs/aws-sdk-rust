...
impl ListScheduledQueriesInput {
    /// Consumes the builder and constructs an Operation<[`ListScheduledQueries`](crate::operation::list_scheduled_queries::ListScheduledQueries)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_scheduled_queries::ListScheduledQueries::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListScheduledQueries", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListScheduledQueries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_scheduled_queries::de_list_scheduled_queries_http_response_with_props(status, headers, body)
        }
    }
}
