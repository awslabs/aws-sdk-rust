...
impl ExecuteScheduledQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::execute_scheduled_query::ExecuteScheduledQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_scheduled_query::ExecuteScheduledQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::execute_scheduled_query::ExecuteScheduledQueryOutput, crate::operation::execute_scheduled_query::ExecuteScheduledQueryError, Self> {
