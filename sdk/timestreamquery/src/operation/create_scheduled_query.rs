...
impl CreateScheduledQueryInput {
    /// Consumes the builder and constructs an Operation<[`CreateScheduledQuery`](crate::operation::create_scheduled_query::CreateScheduledQuery)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_scheduled_query::CreateScheduledQuery::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateScheduledQuery", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateScheduledQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_scheduled_query::de_create_scheduled_query_http_response_with_props(status, headers, body)
        }
    }
}
