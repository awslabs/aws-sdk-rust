...
impl DeleteScheduledQueryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScheduledQuery`](crate::operation::delete_scheduled_query::DeleteScheduledQuery)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_scheduled_query::DeleteScheduledQuery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_scheduled_query::DeleteScheduledQuery::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteScheduledQuery", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteScheduledQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_scheduled_query::de_delete_scheduled_query_http_response_with_props(status, headers, body)
        }
    }
}
