    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_scheduled_query::DeleteScheduledQueryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_scheduled_query::DeleteScheduledQueryOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteScheduledQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteScheduledQuery", "timestreamquery"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteScheduledQuery")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteScheduledQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteScheduledQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_scheduled_query::DeleteScheduledQueryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_scheduled_query::ser_delete_scheduled_query_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteScheduledQueryEndpointParamsInterceptor {
...
pub type DeleteScheduledQueryErrorKind = DeleteScheduledQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteScheduledQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_scheduled_query::DeleteScheduledQueryError {
...
impl DeleteScheduledQueryError {
    ...
    /// Creates the `DeleteScheduledQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
