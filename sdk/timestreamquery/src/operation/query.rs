...
impl QueryInput {
    /// Consumes the builder and constructs an Operation<[`Query`](crate::operation::query::Query)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::query::Query, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_query::ser_query_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::query::Query::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("Query", "timestreamquery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for Query {
    type Output = ::std::result::Result<crate::operation::query::QueryOutput, crate::operation::query::QueryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query::de_query_http_response_with_props(status, headers, body)
        }
    }
}
