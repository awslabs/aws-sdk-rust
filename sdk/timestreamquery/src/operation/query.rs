...
impl QueryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_query::ser_query_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::query::Query::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for Query {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query::de_query_http_response_with_props(
                status, headers, body,
            )
        }
    }
