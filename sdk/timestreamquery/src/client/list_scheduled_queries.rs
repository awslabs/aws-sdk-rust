...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_scheduled_queries::builders::ListScheduledQueriesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_scheduled_queries::builders::ListScheduledQueriesFluentBuilder::set_next_token): <p> A pagination token to resume pagination.</p>
