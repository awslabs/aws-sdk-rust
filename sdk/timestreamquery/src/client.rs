...
async fn resolve_endpoint(client: &crate::Client) -> Result<(::aws_smithy_types::endpoint::Endpoint, ::std::time::SystemTime), ::aws_smithy_runtime_api::box_error::BoxError> {
                ...
                impl Client {
                    ...
                    pub async fn with_endpoint_discovery_enabled(self) -> ::std::result::Result<(Self, crate::endpoint_discovery::ReloadEndpoint), ::aws_smithy_runtime_api::box_error::BoxError> {
