...
pub fn serialize_structure_crate_input_start_contact_recording_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartContactRecordingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_327) = &input.voice_recording_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_voice_recording_configuration(&mut object_328, var_327)?;
        object_328.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_start_contact_streaming_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartContactStreamingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_329) = &input.chat_streaming_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_chat_streaming_configuration(&mut object_330, var_329)?;
        object_330.finish();
    }
...
pub fn serialize_structure_crate_input_start_outbound_voice_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartOutboundVoiceContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_334) = &input.answer_machine_detection_config {
        ...
        crate::json_ser::serialize_structure_crate_model_answer_machine_detection_config(&mut object_335, var_334)?;
        object_335.finish();
    }
    ...
    if let Some(var_343) = &input.destination_phone_number {
        object.key("DestinationPhoneNumber").string(var_343.as_str());
    }
...
pub fn serialize_structure_crate_input_start_task_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTaskContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for (key_361, value_362) in var_359 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference(&mut object_363, value_362)?;
                object_363.finish();
            }
        }
        object_360.finish();
    ...
    if let Some(var_364) = &input.scheduled_time {
        object.key("ScheduledTime").date_time(var_364, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_update_agent_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAgentStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_388) = &input.display_order {
        object.key("DisplayOrder").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_388).into()));
    }
        ...
        for (key_395, value_396) in var_393 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference(&mut object_397, value_396)?;
                object_397.finish();
            }
        }
        object_394.finish();
...
pub fn serialize_structure_crate_input_update_contact_schedule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateContactScheduleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_416) = &input.scheduled_time {
        object.key("ScheduledTime").date_time(var_416, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
        ...
        for item_419 in var_417 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_hours_of_operation_config(&mut object_420, item_419)?;
                object_420.finish();
            }
        }
        array_418.finish();
...
pub fn serialize_structure_crate_input_update_instance_storage_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateInstanceStorageConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_425) = &input.storage_config {
        ...
        crate::json_ser::serialize_structure_crate_model_instance_storage_config(&mut object_426, var_425)?;
        object_426.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_participant_role_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateParticipantRoleConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_427) = &input.channel_configuration {
        ...
        crate::json_ser::serialize_union_crate_model_update_participant_role_config_channel_info(&mut object_428, var_427)?;
        object_428.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_queue_max_contacts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateQueueMaxContactsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_432) = &input.max_contacts {
        object.key("MaxContacts").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_432).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_queue_outbound_caller_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateQueueOutboundCallerConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_435) = &input.outbound_caller_config {
        ...
        crate::json_ser::serialize_structure_crate_model_outbound_caller_config(&mut object_436, var_435)?;
        object_436.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_quick_connect_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateQuickConnectConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_438) = &input.quick_connect_config {
        ...
        crate::json_ser::serialize_structure_crate_model_quick_connect_config(&mut object_439, var_438)?;
        object_439.finish();
    }
    Ok(())
}
        ...
        for item_444 in var_442 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_media_concurrency(&mut object_445, item_444)?;
                object_445.finish();
            }
        }
        array_443.finish();
...
pub fn serialize_structure_crate_input_update_routing_profile_default_outbound_queue_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRoutingProfileDefaultOutboundQueueInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_446) = &input.default_outbound_queue_id {
        object.key("DefaultOutboundQueueId").string(var_446.as_str());
    }
    Ok(())
}
        ...
        for item_451 in var_449 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_routing_profile_queue_config(&mut object_452, item_451)?;
                object_452.finish();
            }
        }
        array_450.finish();
        ...
        for item_455 in var_453 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_rule_action(&mut object_456, item_455)?;
                object_456.finish();
            }
        }
        array_454.finish();
...
pub fn serialize_structure_crate_input_update_task_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTaskTemplateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_471) = &input.constraints {
        ...
        crate::json_ser::serialize_structure_crate_model_task_template_constraints(&mut object_472, var_471)?;
        object_472.finish();
    }
    ...
    if let Some(var_474) = &input.defaults {
        ...
        crate::json_ser::serialize_structure_crate_model_task_template_defaults(&mut object_475, var_474)?;
        object_475.finish();
    }
        ...
        for item_479 in var_477 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_task_template_field(&mut object_480, item_479)?;
                object_480.finish();
            }
        }
        array_478.finish();
...
pub fn serialize_structure_crate_input_update_traffic_distribution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTrafficDistributionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_483) = &input.telephony_config {
        ...
        crate::json_ser::serialize_structure_crate_model_telephony_config(&mut object_484, var_483)?;
        object_484.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_user_hierarchy_structure_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserHierarchyStructureInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_487) = &input.hierarchy_structure {
        ...
        crate::json_ser::serialize_structure_crate_model_hierarchy_structure_update(&mut object_488, var_487)?;
        object_488.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_user_identity_info_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserIdentityInfoInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_489) = &input.identity_info {
        ...
        crate::json_ser::serialize_structure_crate_model_user_identity_info(&mut object_490, var_489)?;
        object_490.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_user_phone_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserPhoneConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_491) = &input.phone_config {
        ...
        crate::json_ser::serialize_structure_crate_model_user_phone_config(&mut object_492, var_491)?;
        object_492.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_instance_storage_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceStorageConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_504) = &input.kinesis_video_stream_config {
        ...
        crate::json_ser::serialize_structure_crate_model_kinesis_video_stream_config(&mut object_505, var_504)?;
        object_505.finish();
    }
    if let Some(var_506) = &input.kinesis_stream_config {
        #[allow(unused_mut)]
        let mut object_507 = object.key("KinesisStreamConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_kinesis_stream_config(&mut object_507, var_506)?;
        object_507.finish();
    }
    if let Some(var_508) = &input.kinesis_firehose_config {
        #[allow(unused_mut)]
        let mut object_509 = object.key("KinesisFirehoseConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_kinesis_firehose_config(&mut object_509, var_508)?;
        object_509.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_routing_profile_queue_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RoutingProfileQueueConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_510) = &input.queue_reference {
        ...
        crate::json_ser::serialize_structure_crate_model_routing_profile_queue_reference(&mut object_511, var_510)?;
        object_511.finish();
    }
    if let Some(var_512) = &input.priority {
        object.key("Priority").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_512).into()));
    }
    if let Some(var_513) = &input.delay {
        object.key("Delay").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_513).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_hours_of_operation_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HoursOfOperationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_517) = &input.end_time {
        ...
        crate::json_ser::serialize_structure_crate_model_hours_of_operation_time_slice(&mut object_518, var_517)?;
        object_518.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_outbound_caller_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutboundCallerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_520) = &input.outbound_caller_id_number_id {
        object.key("OutboundCallerIdNumberId").string(var_520.as_str());
    }
...
pub fn serialize_structure_crate_model_quick_connect_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QuickConnectConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_523) = &input.user_config {
        ...
        crate::json_ser::serialize_structure_crate_model_user_quick_connect_config(&mut object_524, var_523)?;
        object_524.finish();
    }
    if let Some(var_525) = &input.queue_config {
        #[allow(unused_mut)]
        let mut object_526 = object.key("QueueConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_queue_quick_connect_config(&mut object_526, var_525)?;
        object_526.finish();
    }
    if let Some(var_527) = &input.phone_config {
        #[allow(unused_mut)]
        let mut object_528 = object.key("PhoneConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_phone_number_quick_connect_config(&mut object_528, var_527)?;
        object_528.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_rule_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_531) = &input.task_action {
        ...
        crate::json_ser::serialize_structure_crate_model_task_action_definition(&mut object_532, var_531)?;
        object_532.finish();
    }
    if let Some(var_533) = &input.event_bridge_action {
        #[allow(unused_mut)]
        let mut object_534 = object.key("EventBridgeAction").start_object();
        crate::json_ser::serialize_structure_crate_model_event_bridge_action_definition(&mut object_534, var_533)?;
        object_534.finish();
    }
    if let Some(var_535) = &input.assign_contact_category_action {
        ...
        crate::json_ser::serialize_structure_crate_model_assign_contact_category_action_definition(&mut object_536, var_535)?;
        object_536.finish();
    }
    if let Some(var_537) = &input.send_notification_action {
        #[allow(unused_mut)]
        let mut object_538 = object.key("SendNotificationAction").start_object();
        crate::json_ser::serialize_structure_crate_model_send_notification_action_definition(&mut object_538, var_537)?;
        object_538.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_rule_trigger_event_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleTriggerEventSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_540) = &input.integration_association_id {
        object.key("IntegrationAssociationId").string(var_540.as_str());
    }
    Ok(())
}
        ...
        for item_543 in var_541 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_required_field_info(&mut object_544, item_543)?;
                object_544.finish();
            }
        }
        array_542.finish();
        ...
        for item_547 in var_545 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_read_only_field_info(&mut object_548, item_547)?;
                object_548.finish();
            }
        }
        array_546.finish();
        ...
        for item_551 in var_549 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_invisible_field_info(&mut object_552, item_551)?;
                object_552.finish();
            }
        }
        array_550.finish();
        ...
        for item_555 in var_553 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_task_template_default_field_value(&mut object_556, item_555)?;
                object_556.finish();
            }
        }
        array_554.finish();
...
pub fn serialize_structure_crate_model_task_template_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TaskTemplateField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_557) = &input.id {
        ...
        crate::json_ser::serialize_structure_crate_model_task_template_field_identifier(&mut object_558, var_557)?;
        object_558.finish();
    }
...
pub fn serialize_structure_crate_model_queue_search_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QueueSearchCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_607 in var_605 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_queue_search_criteria(&mut object_608, item_607)?;
                object_608.finish();
            }
        }
        array_606.finish();
        ...
        for item_611 in var_609 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_queue_search_criteria(&mut object_612, item_611)?;
                object_612.finish();
            }
        }
        array_610.finish();
    ...
    if let Some(var_613) = &input.string_condition {
        ...
        crate::json_ser::serialize_structure_crate_model_string_condition(&mut object_614, var_613)?;
        object_614.finish();
    }
...
pub fn serialize_structure_crate_model_queue_search_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QueueSearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_616) = &input.tag_filter {
        ...
        crate::json_ser::serialize_structure_crate_model_control_plane_tag_filter(&mut object_617, var_616)?;
        object_617.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_routing_profile_search_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RoutingProfileSearchCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_620 in var_618 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_routing_profile_search_criteria(&mut object_621, item_620)?;
                object_621.finish();
            }
        }
        array_619.finish();
        ...
        for item_624 in var_622 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_routing_profile_search_criteria(&mut object_625, item_624)?;
                object_625.finish();
            }
        }
        array_623.finish();
    ...
    if let Some(var_626) = &input.string_condition {
        ...
        crate::json_ser::serialize_structure_crate_model_string_condition(&mut object_627, var_626)?;
        object_627.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_routing_profile_search_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RoutingProfileSearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_628) = &input.tag_filter {
        ...
        crate::json_ser::serialize_structure_crate_model_control_plane_tag_filter(&mut object_629, var_628)?;
        object_629.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_security_profile_search_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SecurityProfileSearchCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_632 in var_630 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_security_profile_search_criteria(&mut object_633, item_632)?;
                object_633.finish();
            }
        }
        array_631.finish();
        ...
        for item_636 in var_634 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_security_profile_search_criteria(&mut object_637, item_636)?;
                object_637.finish();
            }
        }
        array_635.finish();
    ...
    if let Some(var_638) = &input.string_condition {
        ...
        crate::json_ser::serialize_structure_crate_model_string_condition(&mut object_639, var_638)?;
        object_639.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_security_profiles_search_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SecurityProfilesSearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_640) = &input.tag_filter {
        ...
        crate::json_ser::serialize_structure_crate_model_control_plane_tag_filter(&mut object_641, var_640)?;
        object_641.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_user_search_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserSearchCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_644 in var_642 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_user_search_criteria(&mut object_645, item_644)?;
                object_645.finish();
            }
        }
        array_643.finish();
        ...
        for item_648 in var_646 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_user_search_criteria(&mut object_649, item_648)?;
                object_649.finish();
            }
        }
        array_647.finish();
    ...
    if let Some(var_650) = &input.string_condition {
        ...
        crate::json_ser::serialize_structure_crate_model_string_condition(&mut object_651, var_650)?;
        object_651.finish();
    }
    if let Some(var_652) = &input.hierarchy_group_condition {
        #[allow(unused_mut)]
        let mut object_653 = object.key("HierarchyGroupCondition").start_object();
        crate::json_ser::serialize_structure_crate_model_hierarchy_group_condition(&mut object_653, var_652)?;
        object_653.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_user_search_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserSearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_654) = &input.tag_filter {
        ...
        crate::json_ser::serialize_structure_crate_model_control_plane_tag_filter(&mut object_655, var_654)?;
        object_655.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_persistent_chat(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PersistentChat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_union_crate_model_update_participant_role_config_channel_info(object_428: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateParticipantRoleConfigChannelInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
        crate::model::UpdateParticipantRoleConfigChannelInfo::Chat(inner) => {
             {
                #[allow(unused_mut)]
                let mut object_665 = object_428.key("Chat").start_object();
                crate::json_ser::serialize_structure_crate_model_chat_participant_role_config(&mut object_665, inner)?;
                object_665.finish();
            }
        },
        ...
        for item_668 in var_666 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_distribution(&mut object_669, item_668)?;
                object_669.finish();
            }
        }
        array_667.finish();
...
pub fn serialize_structure_crate_model_hierarchy_structure_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HierarchyStructureUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_676) = &input.level_four {
        ...
        crate::json_ser::serialize_structure_crate_model_hierarchy_level_update(&mut object_677, var_676)?;
        object_677.finish();
    }
    if let Some(var_678) = &input.level_five {
        #[allow(unused_mut)]
        let mut object_679 = object.key("LevelFive").start_object();
        crate::json_ser::serialize_structure_crate_model_hierarchy_level_update(&mut object_679, var_678)?;
        object_679.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_s3_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3Config) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_682) = &input.encryption_config {
        ...
        crate::json_ser::serialize_structure_crate_model_encryption_config(&mut object_683, var_682)?;
        object_683.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_kinesis_video_stream_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KinesisVideoStreamConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_685) = &input.encryption_config {
        ...
        crate::json_ser::serialize_structure_crate_model_encryption_config(&mut object_686, var_685)?;
        object_686.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_hours_of_operation_time_slice(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HoursOfOperationTimeSlice) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_689) = &input.hours {
        object.key("Hours").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_689).into()));
    }
    if let Some(var_690) = &input.minutes {
        object.key("Minutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_690).into()));
    }
    Ok(())
}
        ...
        for (key_701, value_702) in var_699 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference(&mut object_703, value_702)?;
                object_703.finish();
            }
        }
        object_700.finish();
...
pub fn serialize_structure_crate_model_send_notification_action_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SendNotificationActionDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_709) = &input.recipient {
        ...
        crate::json_ser::serialize_structure_crate_model_notification_recipient_type(&mut object_710, var_709)?;
        object_710.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_invisible_field_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InvisibleFieldInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_715) = &input.id {
        ...
        crate::json_ser::serialize_structure_crate_model_task_template_field_identifier(&mut object_716, var_715)?;
        object_716.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_task_template_default_field_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TaskTemplateDefaultFieldValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_717) = &input.id {
        ...
        crate::json_ser::serialize_structure_crate_model_task_template_field_identifier(&mut object_718, var_717)?;
        object_718.finish();
    }
...
pub fn serialize_structure_crate_model_threshold(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Threshold) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_725) = &input.threshold_value {
        object.key("ThresholdValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_725).into()));
    }
    Ok(())
}
        ...
        for item_737 in var_735 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_tag_condition(&mut object_738, item_737)?;
                object_738.finish();
            }
        }
        array_736.finish();
...
pub fn serialize_structure_crate_model_hierarchy_group_condition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HierarchyGroupCondition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_742) = &input.hierarchy_group_match_type {
        object.key("HierarchyGroupMatchType").string(var_742.as_str());
    }
    Ok(())
}
        ...
        for item_745 in var_743 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_participant_timer_configuration(&mut object_746, item_745)?;
                object_746.finish();
            }
        }
        array_744.finish();
...
pub fn serialize_structure_crate_model_participant_timer_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParticipantTimerConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_762) = &input.timer_value {
        ...
        crate::json_ser::serialize_union_crate_model_participant_timer_value(&mut object_763, var_762)?;
        object_763.finish();
    }
    Ok(())
}

pub fn serialize_union_crate_model_participant_timer_value(object_763: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParticipantTimerValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
        crate::model::ParticipantTimerValue::ParticipantTimerAction(inner) => {
             {
                object_763.key("ParticipantTimerAction").string(inner.as_str());
            }
        },
        crate::model::ParticipantTimerValue::ParticipantTimerDurationInMinutes(inner) => {
             {
                object_763.key("ParticipantTimerDurationInMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*inner).into()));
            }
        },
