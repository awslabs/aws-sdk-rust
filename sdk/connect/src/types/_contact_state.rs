...
other => ContactState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ContactState {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ContactState::from(s))
                    }
                }
impl ContactState {
...
impl ::std::convert::AsRef<str> for ContactState {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
