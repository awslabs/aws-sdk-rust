...
/// match metrictype {
///     MetricType::AwsManaged => { /* ... */ },
///     MetricType::CustomerManaged => { /* ... */ },
...
impl ::std::convert::From<&str> for MetricType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_MANAGED" => MetricType::AwsManaged,
            "CUSTOMER_MANAGED" => MetricType::CustomerManaged,
...
impl MetricType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MetricType::AwsManaged => "AWS_MANAGED",
            MetricType::CustomerManaged => "CUSTOMER_MANAGED",
...
impl ::std::fmt::Display for MetricType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MetricType::AwsManaged => write!(f, "AWS_MANAGED"),
            MetricType::CustomerManaged => write!(f, "CUSTOMER_MANAGED"),
