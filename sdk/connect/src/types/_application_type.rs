...
///     ApplicationType::Mcp => { /* ... */ },
///     ApplicationType::ThirdPartyApplication => { /* ... */ },
...
impl ::std::convert::From<&str> for ApplicationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "THIRD_PARTY_APPLICATION" => ApplicationType::ThirdPartyApplication,
...
impl ApplicationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ApplicationType::Mcp => "MCP",
            ApplicationType::ThirdPartyApplication => "THIRD_PARTY_APPLICATION",
...
impl ::std::fmt::Display for ApplicationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ApplicationType::Mcp => write!(f, "MCP"),
            ApplicationType::ThirdPartyApplication => write!(f, "THIRD_PARTY_APPLICATION"),
