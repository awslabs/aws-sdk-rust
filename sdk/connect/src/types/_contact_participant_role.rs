...
/// When writing a match expression against `ContactParticipantRole`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `contactparticipantrole` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ContactParticipantRole::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ContactParticipantRole::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ContactParticipantRole::NewFeature` is defined.
/// Specifically, when `contactparticipantrole` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ContactParticipantRole::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ContactParticipantRole {
    #[allow(missing_docs)] // documentation missing in model
    Agent,
    #[allow(missing_docs)] // documentation missing in model
    CustomBot,
...
impl ::std::convert::From<&str> for ContactParticipantRole {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ContactParticipantRole {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactParticipantRole::from(s))
    }
}
impl ContactParticipantRole {
...
impl ::std::fmt::Display for ContactParticipantRole {
