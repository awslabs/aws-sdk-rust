...
impl EvaluationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EvaluationType::Calibration => "CALIBRATION",
            EvaluationType::Standard => "STANDARD",
...
impl ::std::fmt::Display for EvaluationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EvaluationType::Calibration => write!(f, "CALIBRATION"),
            EvaluationType::Standard => write!(f, "STANDARD"),
