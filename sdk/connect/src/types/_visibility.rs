...
impl ::std::convert::From<&str> for Visibility {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Visibility::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Visibility {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Visibility::from(s))
    }
}
impl Visibility {
...
impl ::std::convert::AsRef<str> for Visibility {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Visibility {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Visibility::Assigned => write!(f, "ASSIGNED"),
