...
impl ReferenceSummary {
    ...
    pub fn as_attachment(&self) -> ::std::result::Result<&crate::types::AttachmentReference, &Self> {
        if let ReferenceSummary::Attachment(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_date(&self) -> ::std::result::Result<&crate::types::DateReference, &Self> {
        if let ReferenceSummary::Date(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_email(&self) -> ::std::result::Result<&crate::types::EmailReference, &Self> {
        if let ReferenceSummary::Email(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_number(&self) -> ::std::result::Result<&crate::types::NumberReference, &Self> {
        if let ReferenceSummary::Number(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_string(&self) -> ::std::result::Result<&crate::types::StringReference, &Self> {
        if let ReferenceSummary::String(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_url(&self) -> ::std::result::Result<&crate::types::UrlReference, &Self> {
        if let ReferenceSummary::Url(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
