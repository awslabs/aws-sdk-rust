...
impl PromptSearchCriteria {
    /// <p>A list of conditions which would be applied together with an OR condition.</p>
    pub fn or_conditions(&self) -> ::std::option::Option<&[crate::types::PromptSearchCriteria]> {
        self.or_conditions.as_deref()
    }
    /// <p>A list of conditions which would be applied together with an AND condition.</p>
    pub fn and_conditions(&self) -> ::std::option::Option<&[crate::types::PromptSearchCriteria]> {
...
impl PromptSearchCriteriaBuilder {
    ...
    pub fn set_or_conditions(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::PromptSearchCriteria>>,
    ) -> Self {
