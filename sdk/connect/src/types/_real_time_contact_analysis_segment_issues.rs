...
impl  RealTimeContactAnalysisSegmentIssues  {
    ...
    pub fn issues_detected(&self) -> & [crate::types::RealTimeContactAnalysisIssueDetected] {
        use std::ops::Deref; self.issues_detected.deref()
    }
}
impl RealTimeContactAnalysisSegmentIssues {
...
impl RealTimeContactAnalysisSegmentIssuesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RealTimeContactAnalysisSegmentIssues, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::RealTimeContactAnalysisSegmentIssues {
                issues_detected: self.issues_detected
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("issues_detected", "issues_detected was not specified but it is required when building RealTimeContactAnalysisSegmentIssues")
                    )?
                ,
            }
        )
