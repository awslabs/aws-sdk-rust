...
///     NotificationType::WidgetAction => { /* ... */ },
///     NotificationType::WidgetView => { /* ... */ },
...
impl ::std::convert::From<&str> for NotificationType {
    fn from(s: &str) -> Self {
        match s {
            "WIDGET_ACTION" => NotificationType::WidgetAction,
            "WIDGET_VIEW" => NotificationType::WidgetView,
...
impl NotificationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            NotificationType::WidgetAction => "WIDGET_ACTION",
            NotificationType::WidgetView => "WIDGET_VIEW",
            NotificationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["WIDGET_ACTION", "WIDGET_VIEW"]
    }
}
...
impl ::std::fmt::Display for NotificationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NotificationType::WidgetAction => write!(f, "WIDGET_ACTION"),
            NotificationType::WidgetView => write!(f, "WIDGET_VIEW"),
