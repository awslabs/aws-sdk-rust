...
impl EvaluationBuilder {
    ...
    ///
    /// <p>A map of question identifiers to answer value.</p>
    pub fn answers(mut self, k: impl Into<std::string::String>, v: crate::types::EvaluationAnswerOutput) -> Self {
        let mut hash_map = self.answers.unwrap_or_default();
                        hash_map.insert(k.into(), v);
                        self.answers = Some(hash_map);
                        self
    }
    /// <p>A map of question identifiers to answer value.</p>
    ...
    ///
    /// <p>A map of item (section or question) identifiers to score value.</p>
    pub fn scores(mut self, k: impl Into<std::string::String>, v: crate::types::EvaluationScore) -> Self {
