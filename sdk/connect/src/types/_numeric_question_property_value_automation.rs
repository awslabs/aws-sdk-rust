...
/// <li> <p>Percantages have a minimum value of 0 and maximum value of 100. </p> </li>
/// <li> <p> <code>NUMBER_OF_INTERRUPTIONS</code> has a minimum value of 0 and maximum value of 100.</p> </li>
/// </ul>
#[non_exhaustive]
