...
pub struct WorkspaceSearchCriteria {
    ...
    pub or_conditions: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>,
    /// <p>A list of conditions that must all be satisfied.</p>
    pub and_conditions: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>,
    /// <p>A leaf node condition which can be used to specify a string condition.</p>
    pub string_condition: ::std::option::Option<crate::types::StringCondition>,
}
impl WorkspaceSearchCriteria {
    /// <p>A list of conditions to be met, where at least one condition must be satisfied.</p>
    ///
    ...
    pub fn or_conditions(&self) -> &[crate::types::WorkspaceSearchCriteria] {
    ...
    pub fn and_conditions(&self) -> &[crate::types::WorkspaceSearchCriteria] {
...
impl WorkspaceSearchCriteria {
    /// Creates a new builder-style object to manufacture [`WorkspaceSearchCriteria`](crate::types::WorkspaceSearchCriteria).
    pub fn builder() -> crate::types::builders::WorkspaceSearchCriteriaBuilder {
        crate::types::builders::WorkspaceSearchCriteriaBuilder::default()
    }
}

/// A builder for [`WorkspaceSearchCriteria`](crate::types::WorkspaceSearchCriteria).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct WorkspaceSearchCriteriaBuilder {
    pub(crate) or_conditions: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>,
    pub(crate) and_conditions: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>,
    pub(crate) string_condition: ::std::option::Option<crate::types::StringCondition>,
}
impl WorkspaceSearchCriteriaBuilder {
    /// Appends an item to `or_conditions`.
    ///
    /// To override the contents of this collection use [`set_or_conditions`](Self::set_or_conditions).
    ///
    /// <p>A list of conditions to be met, where at least one condition must be satisfied.</p>
    pub fn or_conditions(mut self, input: crate::types::WorkspaceSearchCriteria) -> Self {
    ...
    /// <p>A list of conditions to be met, where at least one condition must be satisfied.</p>
    pub fn set_or_conditions(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>) -> Self {
        self.or_conditions = input;
        self
    }
    /// <p>A list of conditions to be met, where at least one condition must be satisfied.</p>
    pub fn get_or_conditions(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>> {
        &self.or_conditions
    }
    ...
    ///
    /// <p>A list of conditions that must all be satisfied.</p>
    pub fn and_conditions(mut self, input: crate::types::WorkspaceSearchCriteria) -> Self {
    ...
    /// <p>A list of conditions that must all be satisfied.</p>
    pub fn set_and_conditions(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>>) -> Self {
        self.and_conditions = input;
        self
    }
    /// <p>A list of conditions that must all be satisfied.</p>
    pub fn get_and_conditions(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::WorkspaceSearchCriteria>> {
        &self.and_conditions
    }
    /// <p>A leaf node condition which can be used to specify a string condition.</p>
    ...
    /// Consumes the builder and constructs a [`WorkspaceSearchCriteria`](crate::types::WorkspaceSearchCriteria).
    pub fn build(self) -> crate::types::WorkspaceSearchCriteria {
        crate::types::WorkspaceSearchCriteria {
