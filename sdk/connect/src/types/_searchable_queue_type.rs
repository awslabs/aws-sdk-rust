...
impl ::std::convert::From<&str> for SearchableQueueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchableQueueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchableQueueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchableQueueType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SearchableQueueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SearchableQueueType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SearchableQueueType::Standard => write!(f, "STANDARD"),
            SearchableQueueType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
