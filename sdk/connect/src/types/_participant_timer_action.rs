...
impl ::std::convert::From<&str> for ParticipantTimerAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParticipantTimerAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParticipantTimerAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParticipantTimerAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ParticipantTimerAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ParticipantTimerAction {
