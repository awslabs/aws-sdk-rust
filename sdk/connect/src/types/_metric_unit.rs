...
impl ::std::convert::From<&str> for MetricUnit {
    fn from(s: &str) -> Self {
        match s {
            "DOUBLE" => MetricUnit::Double,
            "INTEGER" => MetricUnit::Integer,
...
impl MetricUnit {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["DOUBLE", "INTEGER", "PERCENT", "SECONDS"]
    }
}
...
impl ::std::fmt::Display for MetricUnit {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MetricUnit::Double => write!(f, "DOUBLE"),
            MetricUnit::Integer => write!(f, "INTEGER"),
