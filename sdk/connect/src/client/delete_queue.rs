...
impl super::Client {
    ...
    ///   - [`queue_id(impl Into<String>)`](crate::operation::delete_queue::builders::DeleteQueueFluentBuilder::queue_id) / [`set_queue_id(Option<String>)`](crate::operation::delete_queue::builders::DeleteQueueFluentBuilder::set_queue_id): <p>The identifier for the queue.</p>
