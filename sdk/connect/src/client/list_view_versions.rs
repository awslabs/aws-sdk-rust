...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can find the instanceId in the ARN of the instance.</p>
    ///   - [`view_id(impl Into<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::view_id) / [`set_view_id(Option<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::set_view_id): <p>The identifier of the view. Both <code>ViewArn</code> and <code>ViewId</code> can be used.</p>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::set_max_results): <p>The maximum number of results to return per page. The default MaxResult size is 100.</p>
