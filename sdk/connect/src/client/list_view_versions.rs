...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_view_versions::builders::ListViewVersionsFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance. You can find the instanceId in the ARN of the instance.</p><br>
