...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_traffic_distribution::builders::GetTrafficDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_traffic_distribution::builders::GetTrafficDistributionFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the traffic distribution group.</p><br>
