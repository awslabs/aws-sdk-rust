...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_vocabularies::builders::SearchVocabulariesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_vocabularies::builders::SearchVocabulariesFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ...
    ///   - [`name_starts_with(impl ::std::convert::Into<String>)`](crate::operation::search_vocabularies::builders::SearchVocabulariesFluentBuilder::name_starts_with) / [`set_name_starts_with(Option<String>)`](crate::operation::search_vocabularies::builders::SearchVocabulariesFluentBuilder::set_name_starts_with): <p>The starting pattern of the name of the vocabulary.</p>
