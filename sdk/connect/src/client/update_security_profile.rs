...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_security_profile::builders::UpdateSecurityProfileFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_security_profile::builders::UpdateSecurityProfileFluentBuilder::set_description): <p>The description of the security profile.</p>
