...
impl super::Client {
    ...
    ///   - [`traffic_distribution_group_id(impl ::std::convert::Into<String>)`](crate::operation::describe_traffic_distribution_group::builders::DescribeTrafficDistributionGroupFluentBuilder::traffic_distribution_group_id) / [`set_traffic_distribution_group_id(Option<String>)`](crate::operation::describe_traffic_distribution_group::builders::DescribeTrafficDistributionGroupFluentBuilder::set_traffic_distribution_group_id): <p>The identifier of the traffic distribution group. This can be the ID or the ARN if the API is being called in the Region where the traffic distribution group was created. The ARN must be provided if the call is from the replicated Region.</p>
