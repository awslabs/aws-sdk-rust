...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance.</p><br>
