...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::set_max_results): <p>The maximum number of results to return per page.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_traffic_distribution_groups::builders::ListTrafficDistributionGroupsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
