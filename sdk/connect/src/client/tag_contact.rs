...
impl super::Client {
    ...
    ///   - [`contact_id(impl Into<String>)`](crate::operation::tag_contact::builders::TagContactFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::tag_contact::builders::TagContactFluentBuilder::set_contact_id):<br>required: **true**<br><p>The identifier of the contact in this instance of Connect Customer.</p><br>
    ///   - [`instance_id(impl Into<String>)`](crate::operation::tag_contact::builders::TagContactFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::tag_contact::builders::TagContactFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p><br>
