...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::pause_contact::builders::PauseContactFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::pause_contact::builders::PauseContactFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance. You can find the <code>instanceId</code> in the ARN of the instance.</p><br>
