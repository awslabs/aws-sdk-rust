...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact_flow_content::builders::UpdateContactFlowContentFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::update_contact_flow_content::builders::UpdateContactFlowContentFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance.</p>
    ///   - [`contact_flow_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact_flow_content::builders::UpdateContactFlowContentFluentBuilder::contact_flow_id) / [`set_contact_flow_id(Option<String>)`](crate::operation::update_contact_flow_content::builders::UpdateContactFlowContentFluentBuilder::set_contact_flow_id): <p>The identifier of the flow.</p>
