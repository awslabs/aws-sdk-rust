...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact_schedule::builders::UpdateContactScheduleFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::update_contact_schedule::builders::UpdateContactScheduleFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`contact_id(impl ::std::convert::Into<String>)`](crate::operation::update_contact_schedule::builders::UpdateContactScheduleFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::update_contact_schedule::builders::UpdateContactScheduleFluentBuilder::set_contact_id): <p>The identifier of the contact.</p>
