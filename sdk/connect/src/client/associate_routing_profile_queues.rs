...
impl super::Client {
    ...
    ///   - [`queue_configs(RoutingProfileQueueConfig)`](crate::operation::associate_routing_profile_queues::builders::AssociateRoutingProfileQueuesFluentBuilder::queue_configs) / [`set_queue_configs(Option<Vec::<RoutingProfileQueueConfig>>)`](crate::operation::associate_routing_profile_queues::builders::AssociateRoutingProfileQueuesFluentBuilder::set_queue_configs):<br>required: **false**<br><p>The queues to associate with this routing profile.</p><br>
    ///   - [`manual_assignment_queue_configs(RoutingProfileManualAssignmentQueueConfig)`](crate::operation::associate_routing_profile_queues::builders::AssociateRoutingProfileQueuesFluentBuilder::manual_assignment_queue_configs) / [`set_manual_assignment_queue_configs(Option<Vec::<RoutingProfileManualAssignmentQueueConfig>>)`](crate::operation::associate_routing_profile_queues::builders::AssociateRoutingProfileQueuesFluentBuilder::set_manual_assignment_queue_configs):<br>required: **false**<br><p>The manual assignment queues to associate with this routing profile.</p><note>  <p>For voice contacts, manual assignment supports only agent-first callback contacts. Chat, email, and task contacts are fully supported.</p> </note><br>
