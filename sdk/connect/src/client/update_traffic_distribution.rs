...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_traffic_distribution::builders::UpdateTrafficDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_traffic_distribution::builders::UpdateTrafficDistributionFluentBuilder::set_id): <p>The identifier of the traffic distribution group. This can be the ID or the ARN if the API is being called in the Region where the traffic distribution group was created. The ARN must be provided if the call is from the replicated Region.</p>
