...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can find the instanceId in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`resource_types(Vec<String>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::resource_types) / [`set_resource_types(Option<Vec<String>>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::set_resource_types): <p>The list of resource types to be used to search tags from. If not provided or if any empty list is provided, this API will search from all supported resource types.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::set_max_results): <p>The maximum number of results to return per page.</p>
    ///   - [`search_criteria(ResourceTagsSearchCriteria)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::search_criteria) / [`set_search_criteria(Option<ResourceTagsSearchCriteria>)`](crate::operation::search_resource_tags::builders::SearchResourceTagsFluentBuilder::set_search_criteria): <p>The search criteria to be used to return tags.</p>
