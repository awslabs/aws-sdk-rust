...
impl super::Client {
    ...
    ///   - [`contact_id(impl ::std::convert::Into<String>)`](crate::operation::stop_contact::builders::StopContactFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::stop_contact::builders::StopContactFluentBuilder::set_contact_id): <p>The ID of the contact.</p>
