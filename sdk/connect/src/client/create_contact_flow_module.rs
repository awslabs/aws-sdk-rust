...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::set_name): <p>The name of the flow module.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::set_description): <p>The description of the flow module. </p>
    ///   - [`content(impl ::std::convert::Into<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::create_contact_flow_module::builders::CreateContactFlowModuleFluentBuilder::set_content): <p>The content of the flow module.</p>
