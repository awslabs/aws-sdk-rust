...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_lex_bot::builders::DisassociateLexBotFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::disassociate_lex_bot::builders::DisassociateLexBotFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`bot_name(impl ::std::convert::Into<String>)`](crate::operation::disassociate_lex_bot::builders::DisassociateLexBotFluentBuilder::bot_name) / [`set_bot_name(Option<String>)`](crate::operation::disassociate_lex_bot::builders::DisassociateLexBotFluentBuilder::set_bot_name): <p>The name of the Amazon Lex bot. Maximum character limit of 50.</p>
