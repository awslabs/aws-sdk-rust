...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::describe_hours_of_operation_override::builders::DescribeHoursOfOperationOverrideFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::describe_hours_of_operation_override::builders::DescribeHoursOfOperationOverrideFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance.</p><br>
