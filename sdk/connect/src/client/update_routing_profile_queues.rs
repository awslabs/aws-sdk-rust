...
impl super::Client {
    ...
    ///   - [`queue_configs(RoutingProfileQueueConfig)`](crate::operation::update_routing_profile_queues::builders::UpdateRoutingProfileQueuesFluentBuilder::queue_configs) / [`set_queue_configs(Option<Vec<RoutingProfileQueueConfig>>)`](crate::operation::update_routing_profile_queues::builders::UpdateRoutingProfileQueuesFluentBuilder::set_queue_configs): <p>The queues to be updated for this routing profile. Queues must first be associated to the routing profile. You can do this using AssociateRoutingProfileQueues.</p>
