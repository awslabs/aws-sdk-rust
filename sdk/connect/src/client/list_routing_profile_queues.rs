...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`routing_profile_id(impl ::std::convert::Into<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::routing_profile_id) / [`set_routing_profile_id(Option<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::set_routing_profile_id): <p>The identifier of the routing profile.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_routing_profile_queues::builders::ListRoutingProfileQueuesFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
