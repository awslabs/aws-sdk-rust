...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::set_max_results): <p>The maximum number of results to return per page.</p>
    ///   - [`search_filter(PromptSearchFilter)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::search_filter) / [`set_search_filter(Option<PromptSearchFilter>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::set_search_filter): <p>Filters to be applied to search results.</p>
    ///   - [`search_criteria(PromptSearchCriteria)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::search_criteria) / [`set_search_criteria(Option<PromptSearchCriteria>)`](crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::set_search_criteria): <p>The search criteria to be used to return prompts.</p>
    ...
    pub fn search_prompts(
        &self,
    ) -> crate::operation::search_prompts::builders::SearchPromptsFluentBuilder {
        crate::operation::search_prompts::builders::SearchPromptsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
