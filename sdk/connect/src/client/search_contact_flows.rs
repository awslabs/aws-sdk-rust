...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::search_contact_flows::builders::SearchContactFlowsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::search_contact_flows::builders::SearchContactFlowsFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance. You can find the instance ID in the Amazon Resource Name (ARN) of the instance.</p><br>
