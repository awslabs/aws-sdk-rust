...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::search_routing_profiles::builders::SearchRoutingProfilesFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::search_routing_profiles::builders::SearchRoutingProfilesFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_routing_profiles::builders::SearchRoutingProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_routing_profiles::builders::SearchRoutingProfilesFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
