...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::stop_contact_recording::builders::StopContactRecordingFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::stop_contact_recording::builders::StopContactRecordingFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of the Connect Customer instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p><br>
    ...
    ///   - [`contact_recording_type(ContactRecordingType)`](crate::operation::stop_contact_recording::builders::StopContactRecordingFluentBuilder::contact_recording_type) / [`set_contact_recording_type(Option<ContactRecordingType>)`](crate::operation::stop_contact_recording::builders::StopContactRecordingFluentBuilder::set_contact_recording_type):<br>required: **false**<br><p>The type of recording being operated on.</p><br>
