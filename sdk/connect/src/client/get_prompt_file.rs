...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`prompt_id(impl ::std::convert::Into<String>)`](crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder::prompt_id) / [`set_prompt_id(Option<String>)`](crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder::set_prompt_id): <p>A unique identifier for the prompt.</p>
    ...
    pub fn get_prompt_file(
        &self,
    ) -> crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder {
        crate::operation::get_prompt_file::builders::GetPromptFileFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
