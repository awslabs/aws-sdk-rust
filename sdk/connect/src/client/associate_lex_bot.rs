...
impl super::Client {
    ...
    pub fn associate_lex_bot(
        &self,
    ) -> crate::operation::associate_lex_bot::builders::AssociateLexBotFluentBuilder {
        crate::operation::associate_lex_bot::builders::AssociateLexBotFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
