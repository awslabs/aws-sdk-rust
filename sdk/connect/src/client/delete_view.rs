...
impl super::Client {
    ...
    ///   - [`view_id(impl Into<String>)`](crate::operation::delete_view::builders::DeleteViewFluentBuilder::view_id) / [`set_view_id(Option<String>)`](crate::operation::delete_view::builders::DeleteViewFluentBuilder::set_view_id): <p>The identifier of the view. Both <code>ViewArn</code> and <code>ViewId</code> can be used.</p>
