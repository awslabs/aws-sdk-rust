...
impl super::Client {
    ...
    pub fn update_user_hierarchy_structure(
        &self,
    ) -> crate::operation::update_user_hierarchy_structure::builders::UpdateUserHierarchyStructureFluentBuilder {
