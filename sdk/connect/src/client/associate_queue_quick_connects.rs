...
impl super::Client {
    ...
    ///   - [`quick_connect_ids(impl Into<String>)`](crate::operation::associate_queue_quick_connects::builders::AssociateQueueQuickConnectsFluentBuilder::quick_connect_ids) / [`set_quick_connect_ids(Option<Vec<String>>)`](crate::operation::associate_queue_quick_connects::builders::AssociateQueueQuickConnectsFluentBuilder::set_quick_connect_ids): <p>The quick connects to associate with this queue.</p>
