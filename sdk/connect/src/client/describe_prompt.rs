...
impl super::Client {
    ...
    ///   - [`prompt_id(impl Into<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::prompt_id) / [`set_prompt_id(Option<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::set_prompt_id): <p>A unique identifier for the prompt.</p>
