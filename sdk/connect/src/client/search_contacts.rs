...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::search_contacts::builders::SearchContactsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::search_contacts::builders::SearchContactsFluentBuilder::set_instance_id):<br>required: **true**<br><p>The identifier of Connect Customer instance. You can find the instance ID in the Amazon Resource Name (ARN) of the instance.</p><br>
