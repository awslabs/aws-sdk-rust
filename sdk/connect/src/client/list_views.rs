...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can find the instanceId in the ARN of the instance.</p>
    ///   - [`r#type(ViewType)`](crate::operation::list_views::builders::ListViewsFluentBuilder::type) / [`set_type(Option<ViewType>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::set_type): <p>The type of the view.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_views::builders::ListViewsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_views::builders::ListViewsFluentBuilder::set_max_results): <p>The maximum number of results to return per page. The default MaxResult size is 100.</p>
