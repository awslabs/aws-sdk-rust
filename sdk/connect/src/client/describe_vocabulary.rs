...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::describe_vocabulary::builders::DescribeVocabularyFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::describe_vocabulary::builders::DescribeVocabularyFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`vocabulary_id(impl ::std::convert::Into<String>)`](crate::operation::describe_vocabulary::builders::DescribeVocabularyFluentBuilder::vocabulary_id) / [`set_vocabulary_id(Option<String>)`](crate::operation::describe_vocabulary::builders::DescribeVocabularyFluentBuilder::set_vocabulary_id): <p>The identifier of the custom vocabulary.</p>
