...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::associate_security_key::builders::AssociateSecurityKeyFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::associate_security_key::builders::AssociateSecurityKeyFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`key(impl ::std::convert::Into<String>)`](crate::operation::associate_security_key::builders::AssociateSecurityKeyFluentBuilder::key) / [`set_key(Option<String>)`](crate::operation::associate_security_key::builders::AssociateSecurityKeyFluentBuilder::set_key): <p>A valid security key in PEM format.</p>
