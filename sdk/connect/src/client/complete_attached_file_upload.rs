...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::complete_attached_file_upload::builders::CompleteAttachedFileUploadFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::complete_attached_file_upload::builders::CompleteAttachedFileUploadFluentBuilder::set_instance_id):<br>required: **true**<br><p>The unique identifier of the Connect instance.</p><br>
