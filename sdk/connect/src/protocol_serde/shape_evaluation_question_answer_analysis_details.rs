                    ...
                    variant = match key.as_ref() {
                            "GenAI" => {
                                Some(crate::types::EvaluationQuestionAnswerAnalysisDetails::GenAi(
                                    crate::protocol_serde::shape_evaluation_gen_ai_answer_analysis_details::de_evaluation_gen_ai_answer_analysis_details(tokens)?
                            ...
                            "ContactLens" => {
                                Some(crate::types::EvaluationQuestionAnswerAnalysisDetails::ContactLens(
                                    crate::protocol_serde::shape_evaluation_contact_lens_answer_analysis_details::de_evaluation_contact_lens_answer_analysis_details(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'ContactLens' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                                                                              Some(crate::types::EvaluationQuestionAnswerAnalysisDetails::Unknown)
                                                                            }
                        };
                }
                other => {
