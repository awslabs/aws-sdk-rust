...
pub fn ser_suspend_contact_recording_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::suspend_contact_recording::SuspendContactRecordingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
