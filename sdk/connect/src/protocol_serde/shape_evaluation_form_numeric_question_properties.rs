                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Options" => {
                            builder = builder.set_options(
                                    crate::protocol_serde::shape_evaluation_form_numeric_question_option_list::de_evaluation_form_numeric_question_option_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Automation" => {
                            builder = builder.set_automation(
                                    crate::protocol_serde::shape_evaluation_form_numeric_question_automation::de_evaluation_form_numeric_question_automation(tokens, _value, depth + 1)?
                                );
                        }
