...
pub fn ser_evaluation_form_numeric_question_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::EvaluationFormNumericQuestionProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_evaluation_form_numeric_question_option::ser_evaluation_form_numeric_question_option(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_5) = &input.automation {
        ...
        crate::protocol_serde::shape_evaluation_form_numeric_question_automation::ser_evaluation_form_numeric_question_automation(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}

pub(crate) fn de_evaluation_form_numeric_question_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::EvaluationFormNumericQuestionProperties>, aws_smithy_json::deserialize::error::DeserializeError>
