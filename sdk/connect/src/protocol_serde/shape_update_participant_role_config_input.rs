...
pub fn ser_update_participant_role_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateParticipantRoleConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
