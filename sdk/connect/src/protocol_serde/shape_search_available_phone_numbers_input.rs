...
pub fn ser_search_available_phone_numbers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchAvailablePhoneNumbersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
