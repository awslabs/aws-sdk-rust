...
pub fn ser_evaluation_form_section(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::EvaluationFormSection) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_evaluation_form_section<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::EvaluationFormSection>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Items" => {
                                builder = builder.set_items(
                                    crate::protocol_serde::shape_evaluation_form_items_list::de_evaluation_form_items_list(tokens)?
                                );
                            }
                            "Weight" => {
