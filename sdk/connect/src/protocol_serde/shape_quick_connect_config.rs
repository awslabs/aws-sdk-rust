                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "QueueConfig" => {
                            builder = builder.set_queue_config(
                                crate::protocol_serde::shape_queue_quick_connect_config::de_queue_quick_connect_config(tokens, _value, depth + 1)?,
                            );
                        }
                        "PhoneConfig" => {
                            builder = builder.set_phone_config(
                                crate::protocol_serde::shape_phone_number_quick_connect_config::de_phone_number_quick_connect_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
