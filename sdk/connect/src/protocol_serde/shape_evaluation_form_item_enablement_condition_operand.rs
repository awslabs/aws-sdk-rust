...
pub fn ser_evaluation_form_item_enablement_condition_operand(
    object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::EvaluationFormItemEnablementConditionOperand,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::EvaluationFormItemEnablementConditionOperand::Expression(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_3.key("Expression").start_object();
            crate::protocol_serde::shape_evaluation_form_item_enablement_expression::ser_evaluation_form_item_enablement_expression(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        }
        crate::types::EvaluationFormItemEnablementConditionOperand::Condition(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_3.key("Condition").start_object();
            crate::protocol_serde::shape_evaluation_form_item_enablement_condition::ser_evaluation_form_item_enablement_condition(
                &mut object_2,
                inner,
            )?;
            object_2.finish();
        }
        crate::types::EvaluationFormItemEnablementConditionOperand::Unknown => {
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        ...
                        variant = match key.as_ref() {
                            ...
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                                                                              Some(crate::types::EvaluationFormItemEnablementConditionOperand::Unknown)
                                                                            }
                        };
                    }
                    other => {
