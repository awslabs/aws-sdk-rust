...
pub fn ser_user_proficiency(
    ...
    }
    {
        object.key("Level").number(
            ...
            ::aws_smithy_types::Number::Float((input.level).into()),
        );
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Level" => {
                            builder = builder
                                .set_level(::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?.map(|v| v.to_f32_lossy()));
                        }
            ...
            Ok(Some(crate::serde_util::user_proficiency_correct_errors(builder).build().map_err(
