...
pub fn ser_list_phone_numbers_v2_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPhoneNumbersV2Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
