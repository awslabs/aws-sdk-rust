...
pub fn de_list_user_hierarchy_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsOutput, crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_user_hierarchy_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsOutput, crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError> {
    Ok({
        #[allow(unused_mut)]
