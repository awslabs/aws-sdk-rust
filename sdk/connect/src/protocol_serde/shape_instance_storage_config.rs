...
pub fn ser_instance_storage_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceStorageConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_instance_storage_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceStorageConfig>, aws_smithy_json::deserialize::error::DeserializeError>
