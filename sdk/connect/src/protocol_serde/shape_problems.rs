...
pub(crate) fn de_problems<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ProblemDetail>>, aws_smithy_json::deserialize::error::DeserializeError>
