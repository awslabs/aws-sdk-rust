...
pub(crate) fn de_user_data_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::UserData>>, aws_smithy_json::deserialize::error::DeserializeError>
