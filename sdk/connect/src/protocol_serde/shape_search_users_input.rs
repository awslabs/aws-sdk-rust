...
pub fn ser_search_users_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchUsersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
