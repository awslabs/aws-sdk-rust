...
pub(crate) fn de_task_template_default_field_value<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TaskTemplateDefaultFieldValue>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
