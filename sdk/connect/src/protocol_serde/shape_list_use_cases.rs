...
pub fn de_list_use_cases_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListUseCasesOutput, crate::error::ListUseCasesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListUseCasesError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => crate::error::ListUseCasesError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_use_cases_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListUseCasesOutput, crate::error::ListUseCasesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_use_cases_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_use_cases::de_list_use_cases(response.body().as_ref(), output).map_err(crate::error::ListUseCasesError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_use_cases(value: &[u8], mut builder: crate::output::list_use_cases_output::Builder) -> Result<crate::output::list_use_cases_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
