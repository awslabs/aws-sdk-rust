...
pub fn de_associate_traffic_distribution_group_user_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserError::unhandled,
                        )?;
        ...
        "ThrottlingException" => {
            crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_traffic_distribution_group_user_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_associate_traffic_distribution_group_user_input(
    ...
    crate::protocol_serde::shape_associate_traffic_distribution_group_user_input::ser_associate_traffic_distribution_group_user_input_input(
        &mut object,
        input,
    )?;
    object.finish();
