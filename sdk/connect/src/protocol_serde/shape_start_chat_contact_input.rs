...
pub fn ser_start_chat_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartChatContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
