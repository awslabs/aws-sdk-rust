                    ...
                    variant = match key.as_ref() {
                            "Numeric" => {
                                Some(crate::types::EvaluationFormQuestionTypeProperties::Numeric(
                                    crate::protocol_serde::shape_evaluation_form_numeric_question_properties::de_evaluation_form_numeric_question_properties(tokens, _value, depth + 1)?
                            ...
                            "SingleSelect" => {
                                Some(crate::types::EvaluationFormQuestionTypeProperties::SingleSelect(
                                    crate::protocol_serde::shape_evaluation_form_single_select_question_properties::de_evaluation_form_single_select_question_properties(tokens, _value, depth + 1)?
                            ...
                            "Text" => {
                                Some(crate::types::EvaluationFormQuestionTypeProperties::Text(
                                    crate::protocol_serde::shape_evaluation_form_text_question_properties::de_evaluation_form_text_question_properties(tokens, _value, depth + 1)?
                            ...
                            "MultiSelect" => {
                                Some(crate::types::EvaluationFormQuestionTypeProperties::MultiSelect(
                                    crate::protocol_serde::shape_evaluation_form_multi_select_question_properties::de_evaluation_form_multi_select_question_properties(tokens, _value, depth + 1)?
