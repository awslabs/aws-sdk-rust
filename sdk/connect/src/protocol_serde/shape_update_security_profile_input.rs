...
pub fn ser_update_security_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSecurityProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
