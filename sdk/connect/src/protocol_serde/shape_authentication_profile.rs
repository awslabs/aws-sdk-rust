            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AllowedIps" => {
                            builder = builder.set_allowed_ips(crate::protocol_serde::shape_ip_cidr_list::de_ip_cidr_list(tokens, _value, depth + 1)?);
                        }
                        "BlockedIps" => {
                            builder = builder.set_blocked_ips(crate::protocol_serde::shape_ip_cidr_list::de_ip_cidr_list(tokens, _value, depth + 1)?);
                        }
                        "IsDefault" => {
