...
pub fn ser_user_search_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UserSearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
