...
pub fn ser_associate_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::associate_bot::AssociateBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
