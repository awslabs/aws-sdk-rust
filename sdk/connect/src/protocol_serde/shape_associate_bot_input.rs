...
pub fn ser_associate_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
