...
pub(crate) fn de_hours_of_operation_time_slice<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::HoursOfOperationTimeSlice>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
