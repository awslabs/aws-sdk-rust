...
pub fn ser_update_evaluation_form_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_evaluation_form::UpdateEvaluationFormInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.evaluation_form_version {
        object.key("EvaluationFormVersion").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_4).into()));
    }
