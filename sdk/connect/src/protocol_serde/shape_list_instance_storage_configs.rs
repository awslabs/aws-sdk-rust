...
pub fn de_list_instance_storage_configs_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsOutput, crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_instance_storage_configs_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsOutput, crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError> {
    Ok({
        #[allow(unused_mut)]
