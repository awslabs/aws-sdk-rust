...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_instance_storage_configs::de_list_instance_storage_configs(_response_body, output)
            .map_err(crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError::unhandled)?;
...
pub(crate) fn de_list_instance_storage_configs(
    value: &[u8],
    mut builder: crate::operation::list_instance_storage_configs::builders::ListInstanceStorageConfigsOutputBuilder,
) -> Result<
    crate::operation::list_instance_storage_configs::builders::ListInstanceStorageConfigsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "StorageConfigs" => {
                    builder = builder.set_storage_configs(crate::protocol_serde::shape_instance_storage_configs::de_instance_storage_configs(
                        tokens,
                    )?);
                }
