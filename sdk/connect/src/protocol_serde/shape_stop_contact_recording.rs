...
pub fn ser_stop_contact_recording_input(
    ...
    crate::protocol_serde::shape_stop_contact_recording_input::ser_stop_contact_recording_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::stop_contact_recording::StopContactRecordingError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_contact_recording_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
