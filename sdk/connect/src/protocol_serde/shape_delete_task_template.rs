...
pub fn de_delete_task_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_task_template::DeleteTaskTemplateOutput, crate::operation::delete_task_template::DeleteTaskTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_task_template::DeleteTaskTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_task_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_task_template::DeleteTaskTemplateOutput, crate::operation::delete_task_template::DeleteTaskTemplateError> {
    Ok({
        #[allow(unused_mut)]
