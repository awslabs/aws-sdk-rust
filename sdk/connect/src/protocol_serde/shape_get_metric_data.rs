...
) -> Result<crate::operation::get_metric_data::builders::GetMetricDataOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "MetricResults" => {
                    builder = builder.set_metric_results(crate::protocol_serde::shape_historical_metric_results::de_historical_metric_results(
                        tokens,
                    )?);
                }
                "NextToken" => {
