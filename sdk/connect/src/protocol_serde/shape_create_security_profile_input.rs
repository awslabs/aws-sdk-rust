...
pub fn ser_create_security_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSecurityProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
