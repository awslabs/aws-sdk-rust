...
pub fn ser_evaluation_form_single_select_question_properties(
        ...
        for item_2 in &input.options {
             {
                ...
                crate::protocol_serde::shape_evaluation_form_single_select_question_option::ser_evaluation_form_single_select_question_option(&mut object_3, item_2)?;
                object_3.finish();
            }
        }
        array_1.finish();
    ...
    if let Some(var_5) = &input.automation {
        ...
        crate::protocol_serde::shape_evaluation_form_single_select_question_automation::ser_evaluation_form_single_select_question_automation(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}

pub(crate) fn de_evaluation_form_single_select_question_properties<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EvaluationFormSingleSelectQuestionProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::evaluation_form_single_select_question_properties_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
