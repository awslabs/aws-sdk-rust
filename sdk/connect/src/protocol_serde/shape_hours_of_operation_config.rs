...
pub fn ser_hours_of_operation_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HoursOfOperationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_hours_of_operation_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HoursOfOperationConfig>, aws_smithy_json::deserialize::error::DeserializeError>
