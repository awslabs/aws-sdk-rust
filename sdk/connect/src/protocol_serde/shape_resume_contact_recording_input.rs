...
pub fn ser_resume_contact_recording_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ResumeContactRecordingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
