...
pub(crate) fn de_task_template_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::TaskTemplateMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
