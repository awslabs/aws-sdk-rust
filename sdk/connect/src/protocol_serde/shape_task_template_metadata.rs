...
pub(crate) fn de_task_template_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TaskTemplateMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
