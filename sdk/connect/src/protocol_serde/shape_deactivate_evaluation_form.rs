...
pub fn de_deactivate_evaluation_form_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormOutput, crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deactivate_evaluation_form_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormOutput, crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::deactivate_evaluation_form_output_output_correct_errors(output).build().map_err(crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError::unhandled)?
    })
}

pub fn ser_deactivate_evaluation_form_input(input: &crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_deactivate_evaluation_form_input::ser_deactivate_evaluation_form_input_input(&mut object, input)?;
    object.finish();
