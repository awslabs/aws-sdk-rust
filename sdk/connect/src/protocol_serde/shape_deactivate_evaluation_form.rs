...
pub fn de_deactivate_evaluation_form_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormOutput, crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deactivate_evaluation_form_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormOutput, crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError> {
    Ok({
        #[allow(unused_mut)]
