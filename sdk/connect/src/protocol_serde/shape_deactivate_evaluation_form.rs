...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deactivate_evaluation_form_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::deactivate_evaluation_form_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::deactivate_evaluation_form::DeactivateEvaluationFormError::unhandled)?
    })
}
