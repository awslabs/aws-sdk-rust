...
pub fn ser_rule_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rule_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RuleAction>, aws_smithy_json::deserialize::error::DeserializeError>
