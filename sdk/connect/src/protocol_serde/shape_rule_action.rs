...
pub(crate) fn de_rule_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RuleAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "EndAssociatedTasksAction" => {
                                builder = builder.set_end_associated_tasks_action(
                                    crate::protocol_serde::shape_end_associated_tasks_action_definition::de_end_associated_tasks_action_definition(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::rule_action_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
