...
pub fn ser_search_queues_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchQueuesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
