...
pub(crate) fn de_hierarchy_path_reference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HierarchyPathReference>, aws_smithy_json::deserialize::error::DeserializeError>
