...
) -> Result<Option<crate::types::RoutingProfile>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MediaConcurrencies" => {
                            builder =
                                builder.set_media_concurrencies(crate::protocol_serde::shape_media_concurrencies::de_media_concurrencies(tokens)?);
                        }
