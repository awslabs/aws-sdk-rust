...
pub fn ser_get_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
