...
pub fn ser_start_outbound_voice_contact_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartOutboundVoiceContactInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
