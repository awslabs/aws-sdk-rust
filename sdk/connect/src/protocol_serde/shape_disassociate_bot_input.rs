...
pub fn ser_disassociate_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
