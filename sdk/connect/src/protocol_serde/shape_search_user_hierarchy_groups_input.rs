...
pub fn ser_search_user_hierarchy_groups_input_input(
    ...
    if let Some(var_4) = &input.search_criteria {
        ...
        crate::protocol_serde::shape_user_hierarchy_group_search_criteria::ser_user_hierarchy_group_search_criteria(&mut object_5, var_4)?;
        object_5.finish();
    }
    if let Some(var_6) = &input.search_filter {
        #[allow(unused_mut)]
        let mut object_7 = object.key("SearchFilter").start_object();
        crate::protocol_serde::shape_user_hierarchy_group_search_filter::ser_user_hierarchy_group_search_filter(&mut object_7, var_6)?;
        object_7.finish();
    }
    Ok(())
}
