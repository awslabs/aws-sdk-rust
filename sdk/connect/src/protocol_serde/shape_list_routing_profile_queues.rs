...
pub fn de_list_routing_profile_queues_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_routing_profile_queues::ListRoutingProfileQueuesOutput, crate::operation::list_routing_profile_queues::ListRoutingProfileQueuesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_routing_profile_queues::ListRoutingProfileQueuesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_routing_profile_queues_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_routing_profile_queues::ListRoutingProfileQueuesOutput, crate::operation::list_routing_profile_queues::ListRoutingProfileQueuesError> {
    Ok({
        #[allow(unused_mut)]
