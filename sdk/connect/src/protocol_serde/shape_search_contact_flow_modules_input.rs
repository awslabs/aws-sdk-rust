...
pub fn ser_search_contact_flow_modules_input_input(
    ...
    if let Some(var_4) = &input.search_criteria {
        ...
        crate::protocol_serde::shape_contact_flow_module_search_criteria::ser_contact_flow_module_search_criteria(&mut object_5, var_4)?;
        object_5.finish();
    }
    if let Some(var_6) = &input.search_filter {
        #[allow(unused_mut)]
        let mut object_7 = object.key("SearchFilter").start_object();
        crate::protocol_serde::shape_contact_flow_module_search_filter::ser_contact_flow_module_search_filter(&mut object_7, var_6)?;
        object_7.finish();
    }
    Ok(())
}
