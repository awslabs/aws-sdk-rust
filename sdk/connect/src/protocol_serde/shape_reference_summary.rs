...
pub(crate) fn de_reference_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReferenceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
