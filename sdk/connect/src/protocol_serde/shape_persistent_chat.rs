...
pub fn ser_persistent_chat(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PersistentChat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
