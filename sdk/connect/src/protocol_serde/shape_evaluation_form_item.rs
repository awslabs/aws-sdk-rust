...
pub fn ser_evaluation_form_item(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::EvaluationFormItem) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::EvaluationFormItem::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("EvaluationFormItem"))
    }
    Ok(())
}

pub(crate) fn de_evaluation_form_item<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EvaluationFormItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
