...
pub fn ser_evaluation_form_item(object_6: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::EvaluationFormItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::EvaluationFormItem::Unknown => return Err(aws_smithy_http::operation::error::SerializationError::unknown_variant("EvaluationFormItem"))
    }
    Ok(())
}
