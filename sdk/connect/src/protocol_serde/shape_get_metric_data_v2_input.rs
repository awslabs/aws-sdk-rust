...
pub fn ser_get_metric_data_v2_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_metric_data_v2::GetMetricDataV2Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_16) = &input.start_time {
        object.key("StartTime").date_time(var_16, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
