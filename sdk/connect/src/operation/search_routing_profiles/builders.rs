...
impl SearchRoutingProfilesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.search_routing_profiles();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::search_routing_profiles::SearchRoutingProfilesOutput,
                    crate::operation::search_routing_profiles::SearchRoutingProfilesError,
                > for SearchRoutingProfilesFluentBuilder
            {
                fn send(
                    self,
...
impl SearchRoutingProfilesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::search_routing_profiles::builders::SearchRoutingProfilesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_routing_profiles::SearchRoutingProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_routing_profiles::SearchRoutingProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::search_routing_profiles::SearchRoutingProfiles::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::search_routing_profiles::SearchRoutingProfiles::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_routing_profiles::SearchRoutingProfilesOutput, crate::operation::search_routing_profiles::SearchRoutingProfilesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::search_routing_profiles::paginator::SearchRoutingProfilesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
