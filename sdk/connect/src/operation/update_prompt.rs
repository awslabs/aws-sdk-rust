...
impl UpdatePromptInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePrompt`](crate::operation::update_prompt::UpdatePrompt)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_prompt::UpdatePrompt, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_prompt::ser_update_prompt_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_prompt::UpdatePrompt::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePrompt", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePrompt {
    type Output = ::std::result::Result<crate::operation::update_prompt::UpdatePromptOutput, crate::operation::update_prompt::UpdatePromptError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_prompt::de_update_prompt_http_response_with_props(status, headers, body)
        }
    }
}
