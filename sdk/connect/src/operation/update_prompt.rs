...
impl UpdatePromptInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_prompt::ser_update_prompt_input(&self)?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_prompt::UpdatePrompt::new(),
        )
...
/// `ParseStrictResponse` impl for `UpdatePrompt`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePrompt {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_prompt::de_update_prompt_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_prompt::de_update_prompt_http_response_with_props(
                status, headers, body,
            )
        }
    }
