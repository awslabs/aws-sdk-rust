    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_evaluation_form::CreateEvaluationFormError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_evaluation_form::CreateEvaluationFormOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateEvaluationFormResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateEvaluationFormRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_evaluation_form::CreateEvaluationFormInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_evaluation_form::ser_create_evaluation_form_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateEvaluationFormEndpointParamsInterceptor {
...
pub type CreateEvaluationFormErrorKind = CreateEvaluationFormError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateEvaluationFormError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_evaluation_form::CreateEvaluationFormError {
...
impl CreateEvaluationFormError {
    ...
    /// Creates the `CreateEvaluationFormError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
