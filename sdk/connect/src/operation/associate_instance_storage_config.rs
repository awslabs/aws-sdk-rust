...
impl AssociateInstanceStorageConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_instance_storage_config::AssociateInstanceStorageConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateInstanceStorageConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_instance_storage_config::de_associate_instance_storage_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
