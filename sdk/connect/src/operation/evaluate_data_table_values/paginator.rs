...
/// Paginator for [`EvaluateDataTableValues`](crate::operation::evaluate_data_table_values::EvaluateDataTableValues)
pub struct EvaluateDataTableValuesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::evaluate_data_table_values::builders::EvaluateDataTableValuesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl EvaluateDataTableValuesPaginator {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::evaluate_data_table_values::EvaluateDataTableValues::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_evaluate_data_table_values_output_output_next_token(resp);
