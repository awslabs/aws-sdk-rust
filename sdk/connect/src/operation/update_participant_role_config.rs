    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_participant_role_config::UpdateParticipantRoleConfigError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_participant_role_config::UpdateParticipantRoleConfigOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateParticipantRoleConfig {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateParticipantRoleConfig")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateParticipantRoleConfigResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateParticipantRoleConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_participant_role_config::UpdateParticipantRoleConfigInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateParticipantRoleConfigEndpointParamsInterceptor {
...
pub type UpdateParticipantRoleConfigErrorKind = UpdateParticipantRoleConfigError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_participant_role_config::UpdateParticipantRoleConfigError {
...
impl UpdateParticipantRoleConfigError {
    ...
    /// Creates the `UpdateParticipantRoleConfigError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
