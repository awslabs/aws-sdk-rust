...
impl aws_smithy_http::response::ParseStrictResponse for UpdateParticipantRoleConfig {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_participant_role_config::de_update_participant_role_config_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::update_participant_role_config::UpdateParticipantRoleConfigError
{
