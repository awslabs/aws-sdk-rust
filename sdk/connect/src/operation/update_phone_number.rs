...
impl UpdatePhoneNumberInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_phone_number::ser_update_phone_number_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePhoneNumber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_phone_number::de_update_phone_number_http_response_with_props(status, headers, body)
        }
    }
}
