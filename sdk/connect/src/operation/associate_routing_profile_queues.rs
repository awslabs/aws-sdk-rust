...
impl AssociateRoutingProfileQueuesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_routing_profile_queues::AssociateRoutingProfileQueues::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateRoutingProfileQueues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_routing_profile_queues::de_associate_routing_profile_queues_http_response_with_props(
                status, headers, body,
            )
        }
    }
