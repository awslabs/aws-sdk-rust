...
impl AssociateTrafficDistributionGroupUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_traffic_distribution_group_user::AssociateTrafficDistributionGroupUserInput, ::aws_smithy_types::error::operation::BuildError> {
