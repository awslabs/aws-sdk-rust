...
impl DeleteTaskTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_task_template::DeleteTaskTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTaskTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_task_template::de_delete_task_template_http_response_with_props(status, headers, body)
        }
    }
}
