...
impl crate::operation::start_contact_streaming::builders::StartContactStreamingInputBuilder {
...
/// <p>For more information about message streaming, see <a href="https://docs.aws.amazon.com/connect/latest/adminguide/chat-message-streaming.html">Enable real-time chat message streaming</a> in the <i>Connect Customer Administrator Guide</i>.</p>
...
impl StartContactStreamingFluentBuilder {
    /// Creates a new `StartContactStreamingFluentBuilder`.
