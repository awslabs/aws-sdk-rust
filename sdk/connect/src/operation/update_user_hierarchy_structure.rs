...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserHierarchyStructure {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_user_hierarchy_structure::de_update_user_hierarchy_structure_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateUserHierarchyStructureError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_user_hierarchy_structure::UpdateUserHierarchyStructureError
{
