    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_structure::UpdateUserHierarchyStructureError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_structure::UpdateUserHierarchyStructureOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserHierarchyStructure {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateUserHierarchyStructure")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateUserHierarchyStructureResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateUserHierarchyStructureRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_structure::UpdateUserHierarchyStructureInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateUserHierarchyStructureEndpointParamsInterceptor {
...
pub type UpdateUserHierarchyStructureErrorKind = UpdateUserHierarchyStructureError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_hierarchy_structure::UpdateUserHierarchyStructureError {
...
impl UpdateUserHierarchyStructureError {
    ...
    /// Creates the `UpdateUserHierarchyStructureError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
