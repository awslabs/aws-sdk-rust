    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserSecurityProfiles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateUserSecurityProfiles", "connect"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateUserSecurityProfiles")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateUserSecurityProfilesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateUserSecurityProfilesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateUserSecurityProfilesEndpointParamsInterceptor {
...
pub type UpdateUserSecurityProfilesErrorKind = UpdateUserSecurityProfilesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesError {
...
impl UpdateUserSecurityProfilesError {
    ...
    /// Creates the `UpdateUserSecurityProfilesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
