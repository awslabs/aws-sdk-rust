...
impl SearchUsersInput {
    /// Consumes the builder and constructs an Operation<[`SearchUsers`](crate::operation::search_users::SearchUsers)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_users::SearchUsers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_users::ser_search_users_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_users::SearchUsers::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchUsers", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchUsers {
    type Output = ::std::result::Result<crate::operation::search_users::SearchUsersOutput, crate::operation::search_users::SearchUsersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_users::de_search_users_http_response_with_props(status, headers, body)
        }
    }
}
