...
impl crate::operation::associate_bot::builders::AssociateBotInputBuilder {
...
/// <p>Allows the specified Connect Customer instance to access the specified Amazon Lex or Amazon Lex V2 bot.</p>
