...
impl DisassociateApprovedOriginInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_approved_origin::DisassociateApprovedOriginInput, ::aws_smithy_types::error::operation::BuildError> {
