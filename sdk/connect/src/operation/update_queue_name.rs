...
impl UpdateQueueNameInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_queue_name::UpdateQueueName, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_queue_name::ser_update_queue_name_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateQueueName {
    type Output =
        ::std::result::Result<crate::operation::update_queue_name::UpdateQueueNameOutput, crate::operation::update_queue_name::UpdateQueueNameError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_queue_name::de_update_queue_name_http_response_with_props(status, headers, body)
        }
    }
}
