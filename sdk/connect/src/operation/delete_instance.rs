    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/instance/{InstanceId}", InstanceId = instance_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_instance::DeleteInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_instance::de_delete_instance_http_error(
                status, headers, body,
            )
        } else {
