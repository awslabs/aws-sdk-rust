...
pub use crate::operation::delete_integration_association::_delete_integration_association_output::DeleteIntegrationAssociationOutputBuilder;
...
pub struct DeleteIntegrationAssociationFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_integration_association::builders::DeleteIntegrationAssociationInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_integration_association::DeleteIntegrationAssociationOutput,
                    crate::operation::delete_integration_association::DeleteIntegrationAssociationError,
                > for DeleteIntegrationAssociationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteIntegrationAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_integration_association::DeleteIntegrationAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_integration_association::DeleteIntegrationAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_integration_association::DeleteIntegrationAssociation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_integration_association::DeleteIntegrationAssociation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_integration_association::DeleteIntegrationAssociationOutput, crate::operation::delete_integration_association::DeleteIntegrationAssociationError, Self> {
