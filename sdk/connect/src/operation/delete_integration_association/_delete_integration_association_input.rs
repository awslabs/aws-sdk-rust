...
impl DeleteIntegrationAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_integration_association::DeleteIntegrationAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
