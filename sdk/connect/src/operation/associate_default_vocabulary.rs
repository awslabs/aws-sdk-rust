    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDefaultVocabulary {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDefaultVocabulary")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateDefaultVocabularyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateDefaultVocabularyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("language_code", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateDefaultVocabularyEndpointParamsInterceptor {
...
pub type AssociateDefaultVocabularyErrorKind = AssociateDefaultVocabularyError;
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyError {
...
impl AssociateDefaultVocabularyError {
    ...
    /// Creates the `AssociateDefaultVocabularyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
