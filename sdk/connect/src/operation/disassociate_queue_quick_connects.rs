...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateQueueQuickConnects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_queue_quick_connects::de_disassociate_queue_quick_connects_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisassociateQueueQuickConnectsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnectsError
{
