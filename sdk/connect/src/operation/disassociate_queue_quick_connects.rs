...
impl DisassociateQueueQuickConnectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnects,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnects::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateQueueQuickConnects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_queue_quick_connects::de_disassociate_queue_quick_connects_http_response_with_props(
                status, headers, body,
            )
        }
    }
