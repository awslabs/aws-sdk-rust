...
impl ListRoutingProfileQueuesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_routing_profile_queues::ListRoutingProfileQueues::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoutingProfileQueues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_routing_profile_queues::de_list_routing_profile_queues_http_response_with_props(status, headers, body)
        }
    }
}
