...
impl CreateTrafficDistributionGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroupOutput, crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroupError, Self> {
