...
impl aws_smithy_http::response::ParseStrictResponse for CreateIntegrationAssociation {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_integration_association::de_create_integration_association_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::create_integration_association::CreateIntegrationAssociationError
{
