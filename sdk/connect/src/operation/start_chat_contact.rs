...
impl StartChatContactInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_chat_contact::ser_start_chat_contact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartChatContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_chat_contact::de_start_chat_contact_http_response_with_props(status, headers, body)
        }
    }
}
