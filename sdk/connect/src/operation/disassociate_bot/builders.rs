...
impl DisassociateBotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_bot::DisassociateBotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_bot::DisassociateBotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_bot::DisassociateBotOutput, crate::operation::disassociate_bot::DisassociateBotError, Self> {
