...
impl CreateUseCaseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_use_case::CreateUseCase,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_use_case::CreateUseCase::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUseCase {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_use_case::de_create_use_case_http_error(
                status, headers, body,
            )
        } else {
