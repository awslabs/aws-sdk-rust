...
impl AssociateBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_bot::AssociateBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_bot::ser_associate_bot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_bot::de_associate_bot_http_response_with_props(status, headers, body)
        }
    }
}
