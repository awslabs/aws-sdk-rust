...
impl AssociateBotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_bot::AssociateBot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_bot::de_associate_bot_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_bot::de_associate_bot_http_response_with_props(
                status, headers, body,
            )
        }
    }
