...
pub use crate::operation::associate_approved_origin::_associate_approved_origin_output::AssociateApprovedOriginOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_approved_origin::AssociateApprovedOriginOutput,
                    crate::operation::associate_approved_origin::AssociateApprovedOriginError,
                > for AssociateApprovedOriginFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateApprovedOriginFluentBuilder {
    ...
    /// Access the AssociateApprovedOrigin as a reference.
    pub fn as_input(&self) -> &crate::operation::associate_approved_origin::builders::AssociateApprovedOriginInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_approved_origin::AssociateApprovedOriginOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_approved_origin::AssociateApprovedOriginError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_approved_origin::AssociateApprovedOrigin::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_approved_origin::AssociateApprovedOrigin::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_approved_origin::AssociateApprovedOriginOutput, crate::operation::associate_approved_origin::AssociateApprovedOriginError, Self> {
