    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_security_profiles::SearchSecurityProfilesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_security_profiles::SearchSecurityProfilesOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SearchSecurityProfilesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SearchSecurityProfilesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_security_profiles::SearchSecurityProfilesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_security_profiles::ser_search_security_profiles_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SearchSecurityProfilesEndpointParamsInterceptor {
...
pub type SearchSecurityProfilesErrorKind = SearchSecurityProfilesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::search_security_profiles::SearchSecurityProfilesError {
...
impl SearchSecurityProfilesError {
    ...
    /// Creates the `SearchSecurityProfilesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
