...
impl UpdateQueueOutboundCallerConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_queue_outbound_caller_config::UpdateQueueOutboundCallerConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateQueueOutboundCallerConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_queue_outbound_caller_config::de_update_queue_outbound_caller_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
