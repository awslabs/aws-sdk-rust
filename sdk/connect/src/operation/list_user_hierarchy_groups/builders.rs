...
pub use crate::operation::list_user_hierarchy_groups::_list_user_hierarchy_groups_output::ListUserHierarchyGroupsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsOutput,
                    crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError,
                > for ListUserHierarchyGroupsFluentBuilder
            {
                fn send(
                    self,
...
impl ListUserHierarchyGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroups::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsOutput, crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_user_hierarchy_groups::paginator::ListUserHierarchyGroupsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
