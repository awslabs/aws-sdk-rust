...
impl ListUserHierarchyGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_user_hierarchy_groups::ListUserHierarchyGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
