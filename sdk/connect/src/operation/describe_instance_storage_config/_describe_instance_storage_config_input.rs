...
impl DescribeInstanceStorageConfigInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_instance_storage_config::DescribeInstanceStorageConfigInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
