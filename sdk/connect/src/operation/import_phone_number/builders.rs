...
impl ImportPhoneNumberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::import_phone_number::ImportPhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_phone_number::ImportPhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::import_phone_number::ImportPhoneNumberOutput, crate::operation::import_phone_number::ImportPhoneNumberError, Self> {
