...
impl GetFederationTokenFluentBuilder  {
    /// Creates a new `GetFederationToken`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_federation_token::GetFederationTokenOutput, aws_smithy_http::result::SdkError<crate::operation::get_federation_token::GetFederationTokenError>>
                     {
