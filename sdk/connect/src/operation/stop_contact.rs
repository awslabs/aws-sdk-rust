...
impl StopContactInput {
    /// Consumes the builder and constructs an Operation<[`StopContact`](crate::operation::stop_contact::StopContact)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_contact::StopContact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_contact::ser_stop_contact_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_contact::StopContact::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopContact", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopContact {
    type Output = ::std::result::Result<crate::operation::stop_contact::StopContactOutput, crate::operation::stop_contact::StopContactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_contact::de_stop_contact_http_response_with_props(status, headers, body)
        }
    }
}
