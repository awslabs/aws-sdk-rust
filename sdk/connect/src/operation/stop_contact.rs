...
impl StopContactInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_contact::StopContact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_contact::de_stop_contact_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_contact::de_stop_contact_http_response_with_props(
                status, headers, body,
            )
        }
    }
