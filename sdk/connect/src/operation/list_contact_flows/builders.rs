...
impl ListContactFlowsFluentBuilder  {
    /// Creates a new `ListContactFlows`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_contact_flows::ListContactFlowsOutput, aws_smithy_http::result::SdkError<crate::operation::list_contact_flows::ListContactFlowsError>>
                     {
