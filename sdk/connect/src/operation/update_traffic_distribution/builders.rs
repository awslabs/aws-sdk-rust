...
impl UpdateTrafficDistributionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_traffic_distribution::UpdateTrafficDistributionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_traffic_distribution::UpdateTrafficDistributionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_traffic_distribution::UpdateTrafficDistributionOutput, crate::operation::update_traffic_distribution::UpdateTrafficDistributionError, Self> {
