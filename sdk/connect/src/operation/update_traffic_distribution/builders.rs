...
/// </note>
/// <p>For more information about updating a traffic distribution group, see <a href="https://docs.aws.amazon.com/connect/latest/adminguide/update-telephony-traffic-distribution.html">Update telephony traffic distribution across Amazon Web Services Regions </a> in the <i>Connect Customer Administrator Guide</i>.</p>
/// <p><b>Important things to know</b></p>
/// <ul>
/// <li>
/// <p>Invoke the UpdateTrafficDistribution API in the region that should handle traffic.</p></li>
/// </ul>
...
impl UpdateTrafficDistributionFluentBuilder {
    /// Creates a new `UpdateTrafficDistributionFluentBuilder`.
