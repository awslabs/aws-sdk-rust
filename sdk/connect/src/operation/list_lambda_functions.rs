    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lambda_functions::ListLambdaFunctionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lambda_functions::ListLambdaFunctionsOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListLambdaFunctions")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListLambdaFunctionsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListLambdaFunctionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListLambdaFunctionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lambda_functions::ListLambdaFunctionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListLambdaFunctionsEndpointParamsInterceptor {
...
pub type ListLambdaFunctionsErrorKind = ListLambdaFunctionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_lambda_functions::ListLambdaFunctionsError {
...
impl ListLambdaFunctionsError {
    ...
    /// Creates the `ListLambdaFunctionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
