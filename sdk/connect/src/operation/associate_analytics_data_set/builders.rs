...
impl AssociateAnalyticsDataSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_analytics_data_set::AssociateAnalyticsDataSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_analytics_data_set::AssociateAnalyticsDataSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_analytics_data_set::AssociateAnalyticsDataSetOutput, crate::operation::associate_analytics_data_set::AssociateAnalyticsDataSetError, Self> {
