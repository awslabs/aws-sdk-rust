    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_routing_profile_queues::UpdateRoutingProfileQueuesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_routing_profile_queues::UpdateRoutingProfileQueuesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRoutingProfileQueues {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRoutingProfileQueues")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateRoutingProfileQueuesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateRoutingProfileQueuesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_routing_profile_queues::UpdateRoutingProfileQueuesInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateRoutingProfileQueuesEndpointParamsInterceptor {
...
pub type UpdateRoutingProfileQueuesErrorKind = UpdateRoutingProfileQueuesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_routing_profile_queues::UpdateRoutingProfileQueuesError {
...
impl UpdateRoutingProfileQueuesError {
    ...
    /// Creates the `UpdateRoutingProfileQueuesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
