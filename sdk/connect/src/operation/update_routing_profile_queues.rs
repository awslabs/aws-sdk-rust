...
impl UpdateRoutingProfileQueuesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_routing_profile_queues::UpdateRoutingProfileQueues::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoutingProfileQueues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_routing_profile_queues::de_update_routing_profile_queues_http_response_with_props(
                status, headers, body,
            )
        }
    }
