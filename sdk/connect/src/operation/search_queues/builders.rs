...
impl SearchQueuesFluentBuilder {
    ...
    /// Access the SearchQueues as a reference.
    pub fn as_input(&self) -> &crate::operation::search_queues::builders::SearchQueuesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_queues::SearchQueuesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_queues::SearchQueuesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::search_queues::SearchQueues::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::search_queues::SearchQueues::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_queues::SearchQueuesOutput, crate::operation::search_queues::SearchQueuesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::search_queues::paginator::SearchQueuesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
