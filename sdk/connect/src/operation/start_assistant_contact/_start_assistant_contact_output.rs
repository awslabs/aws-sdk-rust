...
pub struct StartAssistantContactOutput {
...
impl StartAssistantContactOutput {
    /// <p>The identifier of the contact within the Connect Customer instance.</p>
...
impl ::aws_types::request_id::RequestId for StartAssistantContactOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartAssistantContactOutput {
    /// Creates a new builder-style object to manufacture [`StartAssistantContactOutput`](crate::operation::start_assistant_contact::StartAssistantContactOutput).
    pub fn builder() -> crate::operation::start_assistant_contact::builders::StartAssistantContactOutputBuilder {
        crate::operation::start_assistant_contact::builders::StartAssistantContactOutputBuilder::default()
    }
}

/// A builder for [`StartAssistantContactOutput`](crate::operation::start_assistant_contact::StartAssistantContactOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartAssistantContactOutputBuilder {
...
impl StartAssistantContactOutputBuilder {
    /// <p>The identifier of the contact within the Connect Customer instance.</p>
    ...
    /// Consumes the builder and constructs a [`StartAssistantContactOutput`](crate::operation::start_assistant_contact::StartAssistantContactOutput).
    pub fn build(self) -> crate::operation::start_assistant_contact::StartAssistantContactOutput {
