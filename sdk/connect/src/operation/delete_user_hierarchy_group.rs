...
impl DeleteUserHierarchyGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserHierarchyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user_hierarchy_group::de_delete_user_hierarchy_group_http_response_with_props(status, headers, body)
        }
    }
}
