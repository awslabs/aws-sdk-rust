...
impl AssociateLexBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_lex_bot::AssociateLexBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_lex_bot::ser_associate_lex_bot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateLexBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_lex_bot::de_associate_lex_bot_http_response_with_props(status, headers, body)
        }
    }
}
