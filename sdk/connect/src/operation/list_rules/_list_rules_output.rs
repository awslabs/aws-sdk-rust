...
impl  ListRulesOutput  {
    ...
    pub fn rule_summary_list(&self) -> & [crate::types::RuleSummary] {
        use std::ops::Deref; self.rule_summary_list.deref()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::list_rules::ListRulesOutput {
                rule_summary_list: self.rule_summary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("rule_summary_list", "rule_summary_list was not specified but it is required when building ListRulesOutput")
                    )?
                ,
