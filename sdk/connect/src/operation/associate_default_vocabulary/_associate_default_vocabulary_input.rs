...
impl AssociateDefaultVocabularyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyInput, ::aws_smithy_types::error::operation::BuildError> {
