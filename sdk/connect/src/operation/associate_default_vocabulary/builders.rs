...
impl AssociateDefaultVocabularyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyOutput, crate::operation::associate_default_vocabulary::AssociateDefaultVocabularyError, Self> {
