...
impl ReplicateInstanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_replicate_instance::ser_replicate_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplicateInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replicate_instance::de_replicate_instance_http_response_with_props(status, headers, body)
        }
    }
}
