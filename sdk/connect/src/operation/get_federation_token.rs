...
impl GetFederationToken {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Connect", "GetFederationToken", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFederationTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_federation_token::de_get_federation_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_federation_token::de_get_federation_token_http_response(status, headers, body, _cfg)
        };
...
impl GetFederationTokenError {
    ...
    /// Returns `true` if the error kind is `GetFederationTokenError::ThrottlingException`.
