...
pub struct DescribeWorkspaceOutput {
    ...
    pub workspace: ::std::option::Option<crate::types::Workspace>,
    _request_id: Option<String>,
}
impl DescribeWorkspaceOutput {
    /// <p>Information about the workspace.</p>
    pub fn workspace(&self) -> ::std::option::Option<&crate::types::Workspace> {
...
pub struct DescribeWorkspaceOutputBuilder {
    pub(crate) workspace: ::std::option::Option<crate::types::Workspace>,
    _request_id: Option<String>,
}
impl DescribeWorkspaceOutputBuilder {
    /// <p>Information about the workspace.</p>
    /// This field is required.
    pub fn workspace(mut self, input: crate::types::Workspace) -> Self {
        self.workspace = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the workspace.</p>
    pub fn set_workspace(mut self, input: ::std::option::Option<crate::types::Workspace>) -> Self {
        self.workspace = input;
        self
    }
    /// <p>Information about the workspace.</p>
    pub fn get_workspace(&self) -> &::std::option::Option<crate::types::Workspace> {
        &self.workspace
    }
