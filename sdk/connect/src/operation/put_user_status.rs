...
impl PutUserStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_user_status::PutUserStatus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_user_status::ser_put_user_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutUserStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_user_status::de_put_user_status_http_response_with_props(status, headers, body)
        }
    }
}
