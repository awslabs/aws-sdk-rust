    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_user_status::PutUserStatusError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_user_status::PutUserStatusOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutUserStatus {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutUserStatus")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(PutUserStatusEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutUserStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutUserStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_user_status::PutUserStatusInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_user_status::ser_put_user_status_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutUserStatusEndpointParamsInterceptor {
...
pub type PutUserStatusErrorKind = PutUserStatusError;
...
impl ::aws_http::request_id::RequestId for crate::operation::put_user_status::PutUserStatusError {
...
impl PutUserStatusError {
    ...
    /// Creates the `PutUserStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
