...
impl ListLexBotsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_lex_bots::ListLexBots,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_lex_bots::ListLexBots::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLexBots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_lex_bots::de_list_lex_bots_http_error(
                status, headers, body,
            )
        } else {
