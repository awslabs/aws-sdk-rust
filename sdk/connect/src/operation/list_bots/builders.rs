...
impl ListBotsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_bots::ListBotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_bots::ListBotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
