...
impl StartOutboundVoiceContactInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_outbound_voice_contact::StartOutboundVoiceContact::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::start_outbound_voice_contact::StartOutboundVoiceContactError
{
...
impl std::error::Error for StartOutboundVoiceContactError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::DestinationNotAllowedException(_inner) => Some(_inner),
            ...
            Self::OutboundContactNotPermittedException(_inner) => Some(_inner),
