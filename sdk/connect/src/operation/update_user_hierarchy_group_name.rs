    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_group_name::UpdateUserHierarchyGroupNameError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_group_name::UpdateUserHierarchyGroupNameOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserHierarchyGroupName {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateUserHierarchyGroupName")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateUserHierarchyGroupNameResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateUserHierarchyGroupNameRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_hierarchy_group_name::UpdateUserHierarchyGroupNameInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("hierarchy_group_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateUserHierarchyGroupNameEndpointParamsInterceptor {
...
pub type UpdateUserHierarchyGroupNameErrorKind = UpdateUserHierarchyGroupNameError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_hierarchy_group_name::UpdateUserHierarchyGroupNameError {
...
impl UpdateUserHierarchyGroupNameError {
    ...
    /// Creates the `UpdateUserHierarchyGroupNameError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
