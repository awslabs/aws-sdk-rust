...
impl aws_smithy_http::response::ParseStrictResponse for UpdateUserHierarchyGroupName {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_user_hierarchy_group_name::de_update_user_hierarchy_group_name_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::update_user_hierarchy_group_name::UpdateUserHierarchyGroupNameError
{
