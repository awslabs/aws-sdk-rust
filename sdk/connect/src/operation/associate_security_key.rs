...
impl AssociateSecurityKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_security_key::AssociateSecurityKey,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSecurityKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_security_key::de_associate_security_key_http_response_with_props(status, headers, body)
        }
    }
}
