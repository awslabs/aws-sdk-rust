...
impl SendChatIntegrationEventFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_chat_integration_event::SendChatIntegrationEventOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_chat_integration_event::SendChatIntegrationEventError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_chat_integration_event::SendChatIntegrationEventOutput, crate::operation::send_chat_integration_event::SendChatIntegrationEventError, Self> {
