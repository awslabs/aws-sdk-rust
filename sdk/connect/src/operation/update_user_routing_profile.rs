...
impl UpdateUserRoutingProfileInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_routing_profile::UpdateUserRoutingProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserRoutingProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_user_routing_profile::de_update_user_routing_profile_http_response_with_props(status, headers, body)
        }
    }
}
