...
impl DisassociateQueueQuickConnectsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnectsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnectsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnectsOutput, crate::operation::disassociate_queue_quick_connects::DisassociateQueueQuickConnectsError, Self> {
