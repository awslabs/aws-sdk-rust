    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListInstanceStorageConfigs {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListInstanceStorageConfigs")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListInstanceStorageConfigsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListInstanceStorageConfigsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListInstanceStorageConfigsEndpointParamsInterceptor {
...
pub type ListInstanceStorageConfigsErrorKind = ListInstanceStorageConfigsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError {
...
impl ListInstanceStorageConfigsError {
    ...
    /// Creates the `ListInstanceStorageConfigsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
