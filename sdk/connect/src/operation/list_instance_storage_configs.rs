...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstanceStorageConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_instance_storage_configs::de_list_instance_storage_configs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError
{
