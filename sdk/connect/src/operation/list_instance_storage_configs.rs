...
impl ListInstanceStorageConfigsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_instance_storage_configs::ListInstanceStorageConfigs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstanceStorageConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_instance_storage_configs::de_list_instance_storage_configs_http_response_with_props(
                status, headers, body,
            )
        }
    }
