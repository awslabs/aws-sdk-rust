...
impl CreatePredefinedAttributeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_predefined_attribute::CreatePredefinedAttributeInput, ::aws_smithy_types::error::operation::BuildError> {
