...
impl StopContactRecordingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_contact_recording::StopContactRecordingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_contact_recording::StopContactRecordingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_contact_recording::StopContactRecordingOutput, crate::operation::stop_contact_recording::StopContactRecordingError, Self> {
