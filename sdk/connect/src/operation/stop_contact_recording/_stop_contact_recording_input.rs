...
impl StopContactRecordingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_contact_recording::StopContactRecordingInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::stop_contact_recording::StopContactRecordingInput {
