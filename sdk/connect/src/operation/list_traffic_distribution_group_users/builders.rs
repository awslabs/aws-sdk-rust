...
impl ListTrafficDistributionGroupUsersFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_traffic_distribution_group_users::ListTrafficDistributionGroupUsersError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_traffic_distribution_group_users::paginator::ListTrafficDistributionGroupUsersPaginator::send) which returns a `Stream`.
