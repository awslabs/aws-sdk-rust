...
impl crate::operation::suspend_contact_recording::builders::SuspendContactRecordingInputBuilder {
...
impl SuspendContactRecordingFluentBuilder {
    /// Creates a new `SuspendContactRecordingFluentBuilder`.
