...
impl SuspendContactRecordingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::suspend_contact_recording::SuspendContactRecordingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::suspend_contact_recording::SuspendContactRecordingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::suspend_contact_recording::SuspendContactRecordingOutput, crate::operation::suspend_contact_recording::SuspendContactRecordingError, Self> {
