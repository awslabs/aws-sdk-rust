...
impl SuspendContactRecordingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::suspend_contact_recording::SuspendContactRecordingInput, ::aws_smithy_types::error::operation::BuildError> {
