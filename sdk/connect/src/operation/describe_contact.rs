...
impl DescribeContactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_contact::DescribeContact, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContact {
    type Output =
        ::std::result::Result<crate::operation::describe_contact::DescribeContactOutput, crate::operation::describe_contact::DescribeContactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_contact::de_describe_contact_http_response_with_props(status, headers, body)
        }
    }
}
