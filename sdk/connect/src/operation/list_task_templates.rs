...
impl ListTaskTemplatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_task_templates::ListTaskTemplates,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTaskTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_task_templates::de_list_task_templates_http_response_with_props(status, headers, body)
        }
    }
}
