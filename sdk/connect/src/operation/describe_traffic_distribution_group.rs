...
impl DescribeTrafficDistributionGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_traffic_distribution_group::DescribeTrafficDistributionGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrafficDistributionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_traffic_distribution_group::de_describe_traffic_distribution_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
