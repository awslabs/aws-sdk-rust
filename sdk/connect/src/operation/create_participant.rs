...
impl CreateParticipantInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_participant::ser_create_participant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateParticipant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_participant::de_create_participant_http_response_with_props(status, headers, body)
        }
    }
}
