    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vocabularies::SearchVocabulariesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vocabularies::SearchVocabulariesOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchVocabularies {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchVocabularies")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(SearchVocabulariesEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SearchVocabulariesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SearchVocabulariesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_vocabularies::SearchVocabulariesInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_vocabularies::ser_search_vocabularies_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SearchVocabulariesEndpointParamsInterceptor {
...
pub type SearchVocabulariesErrorKind = SearchVocabulariesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::search_vocabularies::SearchVocabulariesError {
...
impl SearchVocabulariesError {
    ...
    /// Creates the `SearchVocabulariesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
