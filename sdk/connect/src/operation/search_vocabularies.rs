...
impl SearchVocabulariesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_vocabularies::ser_search_vocabularies_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchVocabularies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_vocabularies::de_search_vocabularies_http_response_with_props(status, headers, body)
        }
    }
}
