...
impl ListQuickConnectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_quick_connects::ListQuickConnects,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQuickConnects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_quick_connects::de_list_quick_connects_http_response_with_props(status, headers, body)
        }
    }
}
