...
impl  ListDefaultVocabulariesOutput  {
    ...
    pub fn default_vocabulary_list(&self) -> & [crate::types::DefaultVocabulary] {
        use std::ops::Deref; self.default_vocabulary_list.deref()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl ListDefaultVocabulariesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_default_vocabularies::ListDefaultVocabulariesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_default_vocabularies::ListDefaultVocabulariesOutput {
                default_vocabulary_list: self.default_vocabulary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("default_vocabulary_list", "default_vocabulary_list was not specified but it is required when building ListDefaultVocabulariesOutput")
                    )?
                ,
