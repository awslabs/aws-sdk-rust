...
impl MonitorContactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::monitor_contact::MonitorContact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_monitor_contact::ser_monitor_contact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for MonitorContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_monitor_contact::de_monitor_contact_http_response_with_props(status, headers, body)
        }
    }
}
