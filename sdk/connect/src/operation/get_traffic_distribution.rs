    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_traffic_distribution::GetTrafficDistributionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_traffic_distribution::GetTrafficDistributionOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTrafficDistribution {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetTrafficDistribution", "connect"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTrafficDistribution")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetTrafficDistributionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetTrafficDistributionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_traffic_distribution::GetTrafficDistributionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
pub type GetTrafficDistributionErrorKind = GetTrafficDistributionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_traffic_distribution::GetTrafficDistributionError {
...
impl GetTrafficDistributionError {
    ...
    /// Creates the `GetTrafficDistributionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
