...
impl ClaimPhoneNumberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::claim_phone_number::ClaimPhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::claim_phone_number::ClaimPhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::claim_phone_number::ClaimPhoneNumberOutput, crate::operation::claim_phone_number::ClaimPhoneNumberError, Self> {
