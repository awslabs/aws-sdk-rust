...
impl ListTrafficDistributionGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_traffic_distribution_groups::ListTrafficDistributionGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
