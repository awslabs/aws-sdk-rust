...
impl UpdateQueueHoursOfOperationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperation,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateQueueHoursOfOperation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_queue_hours_of_operation::de_update_queue_hours_of_operation_http_response_with_props(
                status, headers, body,
            )
        }
    }
