    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateQueueHoursOfOperation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateQueueHoursOfOperation", "connect"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateQueueHoursOfOperationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateQueueHoursOfOperationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateQueueHoursOfOperationEndpointParamsInterceptor {
...
pub type UpdateQueueHoursOfOperationErrorKind = UpdateQueueHoursOfOperationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperationError {
...
impl UpdateQueueHoursOfOperationError {
    ...
    /// Creates the `UpdateQueueHoursOfOperationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
