    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/contact/start-streaming")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_contact_streaming::StartContactStreaming::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_contact_streaming::StartContactStreamingError
{
