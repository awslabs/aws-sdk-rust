    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_streaming::StartContactStreamingError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_streaming::StartContactStreamingOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartContactStreamingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartContactStreamingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_streaming::StartContactStreamingInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_contact_streaming::ser_start_contact_streaming_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartContactStreamingEndpointParamsInterceptor {
...
pub type StartContactStreamingErrorKind = StartContactStreamingError;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_contact_streaming::StartContactStreamingError {
...
impl StartContactStreamingError {
    ...
    /// Creates the `StartContactStreamingError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
