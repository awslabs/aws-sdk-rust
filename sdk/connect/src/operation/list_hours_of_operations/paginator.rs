        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_hours_of_operations::ListHoursOfOperations::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListHoursOfOperationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_hours_of_operations_output_output_hours_of_operation_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
