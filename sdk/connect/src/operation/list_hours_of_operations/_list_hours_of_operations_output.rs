...
impl  ListHoursOfOperationsOutput  {
    /// <p>Information about the hours of operation.</p>
    /// 
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.hours_of_operation_summary_list.is_none()`.
    pub fn hours_of_operation_summary_list(&self) -> & [crate::types::HoursOfOperationSummary] {
...
impl ::aws_types::request_id::RequestId for ListHoursOfOperationsOutput {
