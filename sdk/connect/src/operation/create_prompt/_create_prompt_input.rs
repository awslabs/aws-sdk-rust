...
impl CreatePromptInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_prompt::CreatePromptInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_prompt::CreatePromptInput {
