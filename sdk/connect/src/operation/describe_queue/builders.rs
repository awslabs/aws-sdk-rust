...
impl DescribeQueueFluentBuilder  {
    /// Creates a new `DescribeQueue`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_queue::DescribeQueueOutput, aws_smithy_http::result::SdkError<crate::operation::describe_queue::DescribeQueueError>>
                     {
