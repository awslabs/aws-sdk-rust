...
impl ListInstanceAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_instance_attributes::ListInstanceAttributes,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstanceAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_instance_attributes::de_list_instance_attributes_http_response_with_props(status, headers, body)
        }
    }
}
