...
impl BatchAssociateAnalyticsDataSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_associate_analytics_data_set::BatchAssociateAnalyticsDataSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_associate_analytics_data_set::BatchAssociateAnalyticsDataSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_associate_analytics_data_set::BatchAssociateAnalyticsDataSetOutput, crate::operation::batch_associate_analytics_data_set::BatchAssociateAnalyticsDataSetError, Self> {
