...
impl ListInstanceStorageConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
