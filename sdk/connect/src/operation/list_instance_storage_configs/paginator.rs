        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_instance_storage_configs::ListInstanceStorageConfigs::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListInstanceStorageConfigsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_instance_storage_configs_output_output_storage_configs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
