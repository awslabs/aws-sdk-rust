...
/// Paginator for [`ListInstanceStorageConfigs`](crate::operation::list_instance_storage_configs::ListInstanceStorageConfigs)
            ...
            impl ListInstanceStorageConfigsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsOutput, aws_smithy_http::result::SdkError<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListInstanceStorageConfigsPaginator`
                ...
                impl  ListInstanceStorageConfigsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::InstanceStorageConfig, aws_smithy_http::result::SdkError<crate::operation::list_instance_storage_configs::ListInstanceStorageConfigsError>>> + Unpin
                     {
