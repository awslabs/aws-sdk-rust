...
impl CreateUserHierarchyGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_user_hierarchy_group::CreateUserHierarchyGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserHierarchyGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_user_hierarchy_group::de_create_user_hierarchy_group_http_response_with_props(status, headers, body)
        }
    }
}
