...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInstanceStorageConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_instance_storage_config::de_update_instance_storage_config_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateInstanceStorageConfigError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigError
{
