    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateInstanceStorageConfig {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateInstanceStorageConfig", "connect"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateInstanceStorageConfig")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateInstanceStorageConfigResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateInstanceStorageConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateInstanceStorageConfigEndpointParamsInterceptor {
...
pub type UpdateInstanceStorageConfigErrorKind = UpdateInstanceStorageConfigError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigError {
...
impl UpdateInstanceStorageConfigError {
    ...
    /// Creates the `UpdateInstanceStorageConfigError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
