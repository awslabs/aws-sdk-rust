...
impl UpdateInstanceStorageConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_instance_storage_config::UpdateInstanceStorageConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInstanceStorageConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_instance_storage_config::de_update_instance_storage_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
