...
impl DisassociateInstanceStorageConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disassociate_instance_storage_config::DisassociateInstanceStorageConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_instance_storage_config::DisassociateInstanceStorageConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateInstanceStorageConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_instance_storage_config::de_disassociate_instance_storage_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
