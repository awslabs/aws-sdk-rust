...
impl AssociateQueueQuickConnectsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.associate_queue_quick_connects();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsOutput,
                    crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsError,
                > for AssociateQueueQuickConnectsFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateQueueQuickConnectsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnects::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnects::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsOutput, crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsError, Self> {
