...
impl DisassociateBotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_bot::DisassociateBot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disassociate_bot::de_disassociate_bot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_bot::DisassociateBotError
{
