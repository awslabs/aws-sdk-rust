...
impl DisassociateBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::disassociate_bot::DisassociateBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_bot::ser_disassociate_bot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_bot::de_disassociate_bot_http_response_with_props(status, headers, body)
        }
    }
}
