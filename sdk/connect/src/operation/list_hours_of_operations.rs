...
impl ListHoursOfOperationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_hours_of_operations::ListHoursOfOperations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHoursOfOperations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_hours_of_operations::de_list_hours_of_operations_http_response_with_props(status, headers, body)
        }
    }
}
