...
impl DeleteUserHierarchyGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroupOutput, crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroupError, Self> {
