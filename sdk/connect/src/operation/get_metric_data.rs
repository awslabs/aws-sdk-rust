...
impl GetMetricDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_metric_data::ser_get_metric_data_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_metric_data::GetMetricData::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMetricData", "connect"));
