...
impl DescribeQueueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_queue::DescribeQueue,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_queue::DescribeQueue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeQueue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_queue::de_describe_queue_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_queue::de_describe_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
