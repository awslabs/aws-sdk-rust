...
impl ResumeContactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::resume_contact::ResumeContactInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::resume_contact::ResumeContactInput {
