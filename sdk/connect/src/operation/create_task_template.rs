...
impl CreateTaskTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_task_template::CreateTaskTemplate::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_task_template::CreateTaskTemplateError
{
...
impl std::error::Error for CreateTaskTemplateError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::PropertyValidationException(_inner) => Some(_inner),
