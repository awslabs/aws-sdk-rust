...
impl UpdateContactScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_contact_schedule::UpdateContactScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_contact_schedule::UpdateContactScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_contact_schedule::UpdateContactScheduleOutput, crate::operation::update_contact_schedule::UpdateContactScheduleError, Self> {
