...
impl DescribeUserHierarchyGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_user_hierarchy_group::DescribeUserHierarchyGroupInput, ::aws_smithy_types::error::operation::BuildError> {
