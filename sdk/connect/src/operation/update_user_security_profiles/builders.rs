...
pub use crate::operation::update_user_security_profiles::_update_user_security_profiles_output::UpdateUserSecurityProfilesOutputBuilder;

pub use crate::operation::update_user_security_profiles::_update_user_security_profiles_input::UpdateUserSecurityProfilesInputBuilder;
...
impl UpdateUserSecurityProfilesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.update_user_security_profiles();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesOutput,
                    crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesError,
                > for UpdateUserSecurityProfilesFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateUserSecurityProfilesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_user_security_profiles::UpdateUserSecurityProfiles::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_user_security_profiles::UpdateUserSecurityProfiles::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesOutput, crate::operation::update_user_security_profiles::UpdateUserSecurityProfilesError, Self> {
