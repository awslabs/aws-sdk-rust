...
impl UpdateContactEvaluationOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_contact_evaluation::UpdateContactEvaluationOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_contact_evaluation::UpdateContactEvaluationOutput {
                evaluation_id: self.evaluation_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("evaluation_id", "evaluation_id was not specified but it is required when building UpdateContactEvaluationOutput")
                    )?
                ,
                evaluation_arn: self.evaluation_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("evaluation_arn", "evaluation_arn was not specified but it is required when building UpdateContactEvaluationOutput")
                    )?
                ,
