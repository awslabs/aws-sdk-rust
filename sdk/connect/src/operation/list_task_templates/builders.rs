...
impl ListTaskTemplatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_task_templates::ListTaskTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_task_templates::ListTaskTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_task_templates::ListTaskTemplatesOutput, crate::operation::list_task_templates::ListTaskTemplatesError, Self> {
