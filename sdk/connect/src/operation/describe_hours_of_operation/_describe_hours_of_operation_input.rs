...
impl DescribeHoursOfOperationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_hours_of_operation::DescribeHoursOfOperationInput, ::aws_smithy_types::error::operation::BuildError> {
