    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/traffic-distribution-group")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficDistributionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_traffic_distribution_group::de_create_traffic_distribution_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateTrafficDistributionGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroupError
{
