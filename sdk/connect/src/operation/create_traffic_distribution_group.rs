...
impl CreateTrafficDistributionGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_traffic_distribution_group::CreateTrafficDistributionGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficDistributionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_traffic_distribution_group::de_create_traffic_distribution_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
