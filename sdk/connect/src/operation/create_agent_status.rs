...
impl CreateAgentStatusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_agent_status::ser_create_agent_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAgentStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_agent_status::de_create_agent_status_http_response_with_props(status, headers, body)
        }
    }
}
