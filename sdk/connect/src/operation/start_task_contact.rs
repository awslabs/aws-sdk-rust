...
impl StartTaskContact {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Connect", "StartTaskContact", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Connect.StartTaskContact",
                "rpc.service" = "Connect",
                "rpc.method" = "StartTaskContact",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartTaskContact")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartTaskContactResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_task_contact::de_start_task_contact_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_task_contact::de_start_task_contact_http_response(status, headers, body, _cfg)
        };
