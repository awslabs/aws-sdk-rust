    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/contact/stop-recording")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_contact_recording::StopContactRecording::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_contact_recording::StopContactRecordingError
{
