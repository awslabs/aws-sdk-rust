...
impl UpdateUserHierarchyFluentBuilder  {
    /// Creates a new `UpdateUserHierarchy`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_user_hierarchy::UpdateUserHierarchyOutput, aws_smithy_http::result::SdkError<crate::operation::update_user_hierarchy::UpdateUserHierarchyError>>
                     {
