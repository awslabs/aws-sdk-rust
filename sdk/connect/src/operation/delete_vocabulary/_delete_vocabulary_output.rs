...
impl  DeleteVocabularyOutput  {
    ...
    pub fn vocabulary_arn(&self) -> & str {
        use std::ops::Deref; self.vocabulary_arn.deref()
    }
    /// <p>The identifier of the custom vocabulary.</p>
...
impl DeleteVocabularyOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_vocabulary::DeleteVocabularyOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_vocabulary::DeleteVocabularyOutput {
                vocabulary_arn: self.vocabulary_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vocabulary_arn", "vocabulary_arn was not specified but it is required when building DeleteVocabularyOutput")
                    )?
                ,
                vocabulary_id: self.vocabulary_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vocabulary_id", "vocabulary_id was not specified but it is required when building DeleteVocabularyOutput")
                    )?
                ,
                state: self.state
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("state", "state was not specified but it is required when building DeleteVocabularyOutput")
                    )?
                ,
