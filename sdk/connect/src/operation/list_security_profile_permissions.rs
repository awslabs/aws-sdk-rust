...
impl ListSecurityProfilePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_security_profile_permissions::ListSecurityProfilePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSecurityProfilePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_security_profile_permissions::de_list_security_profile_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
