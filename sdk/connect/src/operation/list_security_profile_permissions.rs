...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSecurityProfilePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_security_profile_permissions::de_list_security_profile_permissions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListSecurityProfilePermissionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_security_profile_permissions::ListSecurityProfilePermissionsError
{
