...
impl TransferContactInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::transfer_contact::TransferContact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransferContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_transfer_contact::de_transfer_contact_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::transfer_contact::TransferContactError
{
