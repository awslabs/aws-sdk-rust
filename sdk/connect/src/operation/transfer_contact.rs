...
impl TransferContactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::transfer_contact::TransferContact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_transfer_contact::ser_transfer_contact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransferContact {
    type Output =
        ::std::result::Result<crate::operation::transfer_contact::TransferContactOutput, crate::operation::transfer_contact::TransferContactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_transfer_contact::de_transfer_contact_http_response_with_props(status, headers, body)
        }
    }
}
