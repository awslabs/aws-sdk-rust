...
impl DescribeAgentStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_agent_status::DescribeAgentStatus,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgentStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_agent_status::de_describe_agent_status_http_response_with_props(status, headers, body)
        }
    }
}
