    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/traffic-distribution-groups")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrafficDistributionGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_traffic_distribution_groups::de_list_traffic_distribution_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListTrafficDistributionGroupsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_traffic_distribution_groups::ListTrafficDistributionGroupsError
{
