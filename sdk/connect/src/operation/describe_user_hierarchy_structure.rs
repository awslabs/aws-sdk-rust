...
impl DescribeUserHierarchyStructureInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_user_hierarchy_structure::DescribeUserHierarchyStructure::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUserHierarchyStructure {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_user_hierarchy_structure::de_describe_user_hierarchy_structure_http_response_with_props(
                status, headers, body,
            )
        }
    }
