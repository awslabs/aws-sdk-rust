...
impl DeleteUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_user::DeleteUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user::DeleteUser::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUser", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user::de_delete_user_http_response_with_props(status, headers, body)
        }
    }
}
