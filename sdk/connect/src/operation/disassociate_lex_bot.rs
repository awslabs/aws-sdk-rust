...
impl DisassociateLexBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disassociate_lex_bot::DisassociateLexBot,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateLexBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_lex_bot::de_disassociate_lex_bot_http_response_with_props(status, headers, body)
        }
    }
}
