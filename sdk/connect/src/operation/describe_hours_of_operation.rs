    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_hours_of_operation::DescribeHoursOfOperationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_hours_of_operation::DescribeHoursOfOperationOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHoursOfOperation {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHoursOfOperation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeHoursOfOperationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeHoursOfOperationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_hours_of_operation::DescribeHoursOfOperationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("hours_of_operation_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeHoursOfOperationEndpointParamsInterceptor {
...
pub type DescribeHoursOfOperationErrorKind = DescribeHoursOfOperationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_hours_of_operation::DescribeHoursOfOperationError {
...
impl DescribeHoursOfOperationError {
    ...
    /// Creates the `DescribeHoursOfOperationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
