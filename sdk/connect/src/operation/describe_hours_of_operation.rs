...
impl DescribeHoursOfOperationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_hours_of_operation::DescribeHoursOfOperation,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hours_of_operation::DescribeHoursOfOperation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHoursOfOperation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_hours_of_operation::de_describe_hours_of_operation_http_response_with_props(status, headers, body)
        }
    }
}
