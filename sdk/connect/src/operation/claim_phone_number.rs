...
impl ClaimPhoneNumberInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_claim_phone_number::ser_claim_phone_number_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClaimPhoneNumber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_claim_phone_number::de_claim_phone_number_http_response_with_props(status, headers, body)
        }
    }
}
