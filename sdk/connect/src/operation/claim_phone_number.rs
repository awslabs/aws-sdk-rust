...
impl ClaimPhoneNumber {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::claim_phone_number::ClaimPhoneNumberInput,
                    ) -> ::std::result::Result<crate::operation::claim_phone_number::ClaimPhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::claim_phone_number::ClaimPhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::claim_phone_number::ClaimPhoneNumberError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::claim_phone_number::ClaimPhoneNumberOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::claim_phone_number::ClaimPhoneNumberInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ClaimPhoneNumber {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ClaimPhoneNumber");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ClaimPhoneNumberRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ClaimPhoneNumberResponseDeserializer));
...
.with_interceptor(ClaimPhoneNumberEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::claim_phone_number::ClaimPhoneNumberError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::claim_phone_number::ClaimPhoneNumberError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::claim_phone_number::ClaimPhoneNumberError>::new());
...
#[derive(Debug)]
            struct ClaimPhoneNumberResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ClaimPhoneNumberResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_claim_phone_number::de_claim_phone_number_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_claim_phone_number::de_claim_phone_number_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ClaimPhoneNumberRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ClaimPhoneNumberRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::claim_phone_number::ClaimPhoneNumberInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::claim_phone_number::ClaimPhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/phone-number/claim").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_claim_phone_number::ser_claim_phone_number_input(&input)?);
...
#[derive(Debug)]
            struct ClaimPhoneNumberEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ClaimPhoneNumberEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ClaimPhoneNumberEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ClaimPhoneNumberInput>()
                        .ok_or("failed to downcast to ClaimPhoneNumberInput")?;
...
/// Error type for the `ClaimPhoneNumberError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ClaimPhoneNumberError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ClaimPhoneNumberError) for what information is available for the error.")]
...
impl ClaimPhoneNumberError {
    /// Creates the `ClaimPhoneNumberError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ClaimPhoneNumberError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::IdempotencyException`.
    pub fn is_idempotency_exception(&self) -> bool {
        matches!(self, Self::IdempotencyException(_))
    }
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ClaimPhoneNumberError::ThrottlingException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ClaimPhoneNumberError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ClaimPhoneNumberError {
...
impl ::aws_types::request_id::RequestId for crate::operation::claim_phone_number::ClaimPhoneNumberError {
...
mod _claim_phone_number_output;
