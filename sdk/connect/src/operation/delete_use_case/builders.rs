...
impl DeleteUseCaseFluentBuilder  {
    /// Creates a new `DeleteUseCase`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_use_case::DeleteUseCaseOutput, aws_smithy_http::result::SdkError<crate::operation::delete_use_case::DeleteUseCaseError>>
                     {
