...
impl DisassociateLambdaFunctionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionInput, ::aws_smithy_types::error::operation::BuildError> {
