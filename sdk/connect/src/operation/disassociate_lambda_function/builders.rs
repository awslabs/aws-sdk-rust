...
impl DisassociateLambdaFunctionInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.disassociate_lambda_function();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionOutput,
                    crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionError,
                > for DisassociateLambdaFunctionFluentBuilder
            {
                fn send(
                    self,
...
impl DisassociateLambdaFunctionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::disassociate_lambda_function::DisassociateLambdaFunction::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::disassociate_lambda_function::DisassociateLambdaFunction::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionOutput, crate::operation::disassociate_lambda_function::DisassociateLambdaFunctionError, Self> {
