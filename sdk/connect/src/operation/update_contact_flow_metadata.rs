...
impl UpdateContactFlowMetadataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_contact_flow_metadata::UpdateContactFlowMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContactFlowMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_contact_flow_metadata::de_update_contact_flow_metadata_http_response_with_props(status, headers, body)
        }
    }
}
