...
impl UpdateInstanceStorageConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigOutput, crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigError, Self> {
