    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateQueueQuickConnects {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateQueueQuickConnects")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateQueueQuickConnectsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateQueueQuickConnectsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateQueueQuickConnectsEndpointParamsInterceptor {
...
pub type AssociateQueueQuickConnectsErrorKind = AssociateQueueQuickConnectsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnectsError {
...
impl AssociateQueueQuickConnectsError {
    ...
    /// Creates the `AssociateQueueQuickConnectsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
