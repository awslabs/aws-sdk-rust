...
impl AssociateQueueQuickConnectsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_queue_quick_connects::AssociateQueueQuickConnects::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateQueueQuickConnects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_queue_quick_connects::de_associate_queue_quick_connects_http_response_with_props(
                status, headers, body,
            )
        }
    }
