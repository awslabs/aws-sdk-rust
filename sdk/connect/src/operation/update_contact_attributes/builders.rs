...
impl crate::operation::update_contact_attributes::builders::UpdateContactAttributesInputBuilder {
...
impl UpdateContactAttributesFluentBuilder {
    /// Creates a new `UpdateContactAttributesFluentBuilder`.
    ...
    /// <p>When the attributes for a contact exceed 32 KB, the contact is routed down the Error branch of the flow. As a mitigation, consider the following options:</p>
    /// <ul>
    /// <li>
