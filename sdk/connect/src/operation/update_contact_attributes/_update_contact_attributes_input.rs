...
impl UpdateContactAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_contact_attributes::UpdateContactAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
