...
impl  ListEvaluationFormsOutput  {
    ...
    pub fn evaluation_form_summary_list(&self) -> & [crate::types::EvaluationFormSummary] {
        use std::ops::Deref; self.evaluation_form_summary_list.deref()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl ListEvaluationFormsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_evaluation_forms::ListEvaluationFormsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_evaluation_forms::ListEvaluationFormsOutput {
                evaluation_form_summary_list: self.evaluation_form_summary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("evaluation_form_summary_list", "evaluation_form_summary_list was not specified but it is required when building ListEvaluationFormsOutput")
                    )?
                ,
