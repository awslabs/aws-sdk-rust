    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_evaluation::StartContactEvaluationError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_evaluation::StartContactEvaluationOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartContactEvaluation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartContactEvaluation", "connect"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartContactEvaluation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartContactEvaluationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartContactEvaluationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_contact_evaluation::StartContactEvaluationInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_contact_evaluation::ser_start_contact_evaluation_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartContactEvaluationEndpointParamsInterceptor {
...
pub type StartContactEvaluationErrorKind = StartContactEvaluationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartContactEvaluationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_contact_evaluation::StartContactEvaluationError {
...
impl StartContactEvaluationError {
    ...
    /// Creates the `StartContactEvaluationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
