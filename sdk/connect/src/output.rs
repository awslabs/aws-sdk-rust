...
pub struct GetCurrentMetricDataOutput {
    ...
    pub data_snapshot_time: std::option::Option<smithy_types::Instant>,
}
...
pub mod get_current_metric_data_output {
    ...
    pub struct Builder {
        ...
        pub(crate) data_snapshot_time: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>If there are additional results, this is the token for the next set of results.</p>
        /// <p>The token expires after 5 minutes from the time it is created. Subsequent requests that use
        ...
        /// <p>The time at which the metrics were retrieved and cached for pagination.</p>
        pub fn data_snapshot_time(mut self, input: smithy_types::Instant) -> Self {
