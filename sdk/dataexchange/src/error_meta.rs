...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::get_data_set::GetDataSetError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::send_api_asset::SendApiAssetError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::update_asset::UpdateAssetError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
