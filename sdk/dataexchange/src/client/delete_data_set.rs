...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::delete_data_set::builders::DeleteDataSetFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::delete_data_set::builders::DeleteDataSetFluentBuilder::set_data_set_id): <p>The unique identifier for a data set.</p>
