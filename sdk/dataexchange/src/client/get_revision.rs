...
impl super::Client {
    ...
    ///   - [`data_set_id(impl Into<String>)`](crate::operation::get_revision::builders::GetRevisionFluentBuilder::data_set_id) / [`set_data_set_id(impl Into<String>)`](crate::operation::get_revision::builders::GetRevisionFluentBuilder::set_data_set_id):<br>required: **true**<br><p>The unique identifier for a data set.</p><br>
    ///   - [`revision_id(impl Into<String>)`](crate::operation::get_revision::builders::GetRevisionFluentBuilder::revision_id) / [`set_revision_id(impl Into<String>)`](crate::operation::get_revision::builders::GetRevisionFluentBuilder::set_revision_id):<br>required: **true**<br><p>The unique identifier for a revision.</p><br>
