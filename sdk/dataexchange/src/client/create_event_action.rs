...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_event_action::builders::CreateEventActionFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_event_action::builders::CreateEventActionFluentBuilder::set_tags):<br>required: **false**<br><p>Key-value pairs that you can associate with the event action.</p><br>
    ...
    ///   - [`tags(Option<HashMap::<String, String>>)`](crate::operation::create_event_action::CreateEventActionOutput::tags): <p>The tags for the event action.</p>
