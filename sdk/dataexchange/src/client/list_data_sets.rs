...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_data_sets::builders::ListDataSetsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_data_sets::builders::ListDataSetsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results returned by a single call.</p><br>
