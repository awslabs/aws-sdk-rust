...
impl super::Client {
    ...
    ///   - [`event_action_id(impl ::std::convert::Into<String>)`](crate::operation::update_event_action::builders::UpdateEventActionFluentBuilder::event_action_id) / [`set_event_action_id(Option<String>)`](crate::operation::update_event_action::builders::UpdateEventActionFluentBuilder::set_event_action_id): <p>The unique identifier for the event action.</p>
    ...
    pub fn update_event_action(
        &self,
    ) -> crate::operation::update_event_action::builders::UpdateEventActionFluentBuilder {
        crate::operation::update_event_action::builders::UpdateEventActionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
