...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::get_data_set::builders::GetDataSetFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::get_data_set::builders::GetDataSetFluentBuilder::set_data_set_id): <p>The unique identifier for a data set.</p>
