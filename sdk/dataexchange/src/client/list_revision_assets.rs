...
impl super::Client {
    ...
    ///   - [`data_set_id(impl Into<String>)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::data_set_id) / [`set_data_set_id(impl Into<String>)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::set_data_set_id):<br>required: **true**<br><p>The unique identifier for a data set.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results returned by a single call.</p><br>
    ...
    ///   - [`revision_id(impl Into<String>)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::revision_id) / [`set_revision_id(impl Into<String>)`](crate::operation::list_revision_assets::builders::ListRevisionAssetsFluentBuilder::set_revision_id):<br>required: **true**<br><p>The unique identifier for a revision.</p><br>
