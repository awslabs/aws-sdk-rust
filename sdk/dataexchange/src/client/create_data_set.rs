...
impl super::Client {
    ...
    ///   - [`asset_type(AssetType)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::asset_type) / [`set_asset_type(Option<AssetType>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_asset_type):<br>required: **true**<br><p>The type of asset that is added to a data set.</p><br>
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the data set.</p><br>
