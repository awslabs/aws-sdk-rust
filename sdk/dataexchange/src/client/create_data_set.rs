...
impl super::Client {
    ...
    ///   - [`asset_type(AssetType)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::asset_type) / [`set_asset_type(AssetType)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_asset_type):<br>required: **true**<br><p>The type of asset that is added to a data set.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::description) / [`set_description(impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_description):<br>required: **true**<br><p>A description for the data set. This value can be up to 16,348 characters long.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the data set.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_data_set::builders::CreateDataSetFluentBuilder::set_tags):<br>required: **false**<br><p>A data set tag is an optional label that you can assign to a data set when you create it. Each tag consists of a key and an optional value, both of which you define. When you use tagging, you can also use tag-based access control in IAM policies to control access to these data sets and revisions.</p><br>
