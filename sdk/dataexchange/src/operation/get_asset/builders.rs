...
impl GetAssetFluentBuilder  {
    /// Creates a new `GetAsset`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_asset::GetAsset, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_asset::GetAssetError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_asset::GetAssetOutput, aws_smithy_http::result::SdkError<crate::operation::get_asset::GetAssetError>>
                     {
