...
impl RevokeRevisionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::revoke_revision::RevokeRevision, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_revoke_revision::ser_revoke_revision_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeRevision {
    type Output =
        ::std::result::Result<crate::operation::revoke_revision::RevokeRevisionOutput, crate::operation::revoke_revision::RevokeRevisionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_revision::de_revoke_revision_http_response_with_props(status, headers, body)
        }
    }
}
