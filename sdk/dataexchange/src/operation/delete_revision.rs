...
impl DeleteRevisionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_revision::DeleteRevision, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRevision {
    type Output =
        ::std::result::Result<crate::operation::delete_revision::DeleteRevisionOutput, crate::operation::delete_revision::DeleteRevisionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_revision::de_delete_revision_http_response_with_props(status, headers, body)
        }
    }
}
