...
impl CreateEventActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_event_action::ser_create_event_action_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEventAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_event_action::de_create_event_action_http_response_with_props(status, headers, body)
        }
    }
}
