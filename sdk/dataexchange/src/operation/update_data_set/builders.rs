...
impl UpdateDataSetFluentBuilder  {
    /// Creates a new `UpdateDataSet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_data_set::UpdateDataSetOutput, aws_smithy_http::result::SdkError<crate::operation::update_data_set::UpdateDataSetError>>
                     {
