...
pub use crate::operation::get_event_action::_get_event_action_output::GetEventActionOutputBuilder;
...
pub struct GetEventActionFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_event_action::builders::GetEventActionInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_event_action::GetEventActionOutput,
                    crate::operation::get_event_action::GetEventActionError,
                > for GetEventActionFluentBuilder
            {
                fn send(
                    self,
...
impl GetEventActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_event_action::GetEventActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_event_action::GetEventActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_event_action::GetEventAction::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_event_action::GetEventAction::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_event_action::GetEventActionOutput, crate::operation::get_event_action::GetEventActionError, Self> {
