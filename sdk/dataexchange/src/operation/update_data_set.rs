    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/data-sets/{DataSetId}", DataSetId = data_set_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_set::UpdateDataSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_data_set::de_update_data_set_http_error(
                status, headers, body,
            )
        } else {
