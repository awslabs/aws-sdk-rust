...
impl UpdateDataSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_data_set::UpdateDataSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_data_set::ser_update_data_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataSet {
    type Output =
        ::std::result::Result<crate::operation::update_data_set::UpdateDataSetOutput, crate::operation::update_data_set::UpdateDataSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_data_set::de_update_data_set_http_response_with_props(status, headers, body)
        }
    }
}
