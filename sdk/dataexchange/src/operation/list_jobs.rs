...
impl ListJobs {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("dataexchange", "ListJobs", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListJobs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListJobs", "dataexchange"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.data_set_id {
                    {
                        query.push_kv("dataSetId", &::aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
