...
impl UpdateAssetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_asset::UpdateAsset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_asset::ser_update_asset_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAsset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_asset::de_update_asset_http_response_with_props(status, headers, body)
        }
    }
}
