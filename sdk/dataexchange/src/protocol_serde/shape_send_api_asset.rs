...
pub fn de_send_api_asset_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::send_api_asset::SendApiAssetOutput, crate::operation::send_api_asset::SendApiAssetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::send_api_asset::SendApiAssetError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_api_asset_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::send_api_asset::SendApiAssetOutput, crate::operation::send_api_asset::SendApiAssetError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_response_headers(
            crate::protocol_serde::shape_send_api_asset_output::de_response_headers_prefix_header(_response_headers)
                                         .map_err(|_|
        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("asset_id", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.data_set_id {
        let formatted_4 = inner_3.as_str();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("data_set_id", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_5) = &input.method {
        let formatted_6 = inner_5.as_str();
                        if !formatted_6.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("method", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_7) = &input.path {
        let formatted_8 = inner_7.as_str();
                        if !formatted_8.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("path", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_9) = &input.revision_id {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("revision_id", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_11) = &input.request_headers {
         {
            for (k, v) in inner_11 {
                                ...
                                let header_name = http::header::HeaderName::from_str(&format!("{}{}", "x-amzn-dataexchange-header-", &k)).map_err(|err| {
                                    ::aws_smithy_types::error::operation::BuildError::invalid_field("request_headers", format!("`{k}` cannot be used as a header name: {err}"))
                                })?;
                                let header_value = v.as_str();
                                let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                    ::aws_smithy_types::error::operation::BuildError::invalid_field("request_headers", format!(
                                            "`{}` cannot be used as a header value: {}",
                                            v,
                                            err
                                        ))
