...
pub fn de_send_api_asset_http_response(
    ...
    Ok({
        ...
        output = output.set_response_headers(
            match crate::protocol_serde::shape_send_api_asset_output::de_response_headers_prefix_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::send_api_asset::SendApiAssetError::unhandled(
