...
pub(crate) fn de_data_set_entry<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataSetEntry>, aws_smithy_json::deserialize::error::DeserializeError>
