...
pub fn ser_create_event_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
