...
pub(crate) fn de_revision_entry<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RevisionEntry>, aws_smithy_json::deserialize::error::DeserializeError>
