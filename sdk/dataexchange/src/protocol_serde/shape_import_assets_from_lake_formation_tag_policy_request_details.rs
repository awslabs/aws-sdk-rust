...
pub fn ser_import_assets_from_lake_formation_tag_policy_request_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ImportAssetsFromLakeFormationTagPolicyRequestDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
