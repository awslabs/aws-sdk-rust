                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ExportRevisionToS3" => {
                            builder = builder.set_export_revision_to_s3(
                                    crate::protocol_serde::shape_auto_export_revision_to_s3_request_details::de_auto_export_revision_to_s3_request_details(tokens, _value, depth + 1)?
                                );
                        }
...
pub fn ser_action(
    ...
    if let Some(var_1) = &input.export_revision_to_s3 {
        ...
        crate::protocol_serde::shape_auto_export_revision_to_s3_request_details::ser_auto_export_revision_to_s3_request_details(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
