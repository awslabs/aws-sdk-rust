...
pub fn de_create_data_set_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_data_set::CreateDataSetOutput, crate::operation::create_data_set::CreateDataSetError> {
    #[allow(unused_mut)]
...
pub fn de_create_data_set_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_data_set::de_create_data_set(_response_body, output)
            .map_err(crate::operation::create_data_set::CreateDataSetError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "OriginDetails" => {
                    builder = builder.set_origin_details(crate::protocol_serde::shape_origin_details::de_origin_details(tokens, _value, depth + 1)?);
                }
                "SourceId" => {
