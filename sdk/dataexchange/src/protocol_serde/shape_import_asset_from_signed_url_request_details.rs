...
pub fn ser_import_asset_from_signed_url_request_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ImportAssetFromSignedUrlRequestDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
