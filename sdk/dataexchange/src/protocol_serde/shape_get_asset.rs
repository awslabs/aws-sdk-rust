...
pub fn de_get_asset_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_asset::GetAssetOutput, crate::operation::get_asset::GetAssetError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::get_asset::builders::GetAssetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "AssetType" => {
                    builder = builder.set_asset_type(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::AssetType::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "CreatedAt" => {
