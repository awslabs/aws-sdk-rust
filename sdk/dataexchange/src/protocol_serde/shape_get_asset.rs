...
pub fn de_get_asset_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_asset::GetAssetOutput, crate::operation::get_asset::GetAssetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_asset::GetAssetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_asset_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_asset::GetAssetOutput, crate::operation::get_asset::GetAssetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_asset::builders::GetAssetOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_asset::de_get_asset(response.body().as_ref(), output).map_err(crate::operation::get_asset::GetAssetError::unhandled)?;
