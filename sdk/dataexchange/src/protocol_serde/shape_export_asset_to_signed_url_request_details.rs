...
pub fn ser_export_asset_to_signed_url_request_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExportAssetToSignedUrlRequestDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
