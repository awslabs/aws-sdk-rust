...
pub fn ser_request_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RequestDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
