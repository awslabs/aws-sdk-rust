...
pub struct UpdateRevisionOutput  {
    ...
    #[doc(hidden)]pub data_set_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub source_id: std::option::Option<std::string::String>,
    /// <p>The date and time that the revision was last updated, in ISO 8601 format.</p>
    #[doc(hidden)]pub updated_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A required comment to inform subscribers of the reason their access to the revision was revoked.</p>
    #[doc(hidden)]pub revocation_comment: std::option::Option<std::string::String>,
    /// <p>A status indicating that subscribers' access to the revision was revoked.</p>
    #[doc(hidden)]pub revoked: bool,
    /// <p>The date and time that the revision was revoked, in ISO 8601 format.</p>
    #[doc(hidden)]pub revoked_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct UpdateEventActionOutput  {
    ...
    #[doc(hidden)]pub event: std::option::Option<crate::model::Event>,
...
pub struct UpdateDataSetOutput  {
    ...
    #[doc(hidden)]pub asset_type: std::option::Option<crate::model::AssetType>,
    ...
    #[doc(hidden)]pub origin: std::option::Option<crate::model::Origin>,
    /// <p>If the origin of this data set is ENTITLED, includes the details for the product on AWS Marketplace.</p>
    #[doc(hidden)]pub origin_details: std::option::Option<crate::model::OriginDetails>,
...
pub struct UpdateAssetOutput  {
    ...
    #[doc(hidden)]pub asset_details: std::option::Option<crate::model::AssetDetails>,
    /// <p>The type of asset that is added to a data set.</p>
    #[doc(hidden)]pub asset_type: std::option::Option<crate::model::AssetType>,
...
pub struct SendApiAssetOutput  {
    ...
    #[doc(hidden)]pub response_headers: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct ListRevisionAssetsOutput  {
    ...
    #[doc(hidden)]pub assets: std::option::Option<std::vec::Vec<crate::model::AssetEntry>>,
...
pub struct ListJobsOutput  {
    ...
    #[doc(hidden)]pub jobs: std::option::Option<std::vec::Vec<crate::model::JobEntry>>,
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListJobsOutput {
...
pub struct ListEventActionsOutput  {
    ...
    #[doc(hidden)]pub event_actions: std::option::Option<std::vec::Vec<crate::model::EventActionEntry>>,
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDataSetsOutput  {
    ...
    #[doc(hidden)]pub data_sets: std::option::Option<std::vec::Vec<crate::model::DataSetEntry>>,
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDataSetRevisionsOutput  {
    ...
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>The asset objects listed by the request.</p>
    #[doc(hidden)]pub revisions: std::option::Option<std::vec::Vec<crate::model::RevisionEntry>>,
}
...
pub struct GetJobOutput  {
    ...
    #[doc(hidden)]pub details: std::option::Option<crate::model::ResponseDetails>,
    /// <p>The errors associated with jobs.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::JobError>>,
