...
pub struct Event  {
    ...
    #[doc(hidden)]pub revision_published: std::option::Option<crate::model::RevisionPublished>,
}
impl Event {
    /// <p>What occurs to start the revision publish action.</p>
...
pub struct Action  {
    ...
    #[doc(hidden)]pub export_revision_to_s3: std::option::Option<crate::model::AutoExportRevisionToS3RequestDetails>,
}
impl Action {
    /// <p>Details for the export revision to Amazon S3 action.</p>
...
pub struct AutoExportRevisionToS3RequestDetails  {
    ...
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::ExportServerSideEncryption>,
    /// <p>A revision destination is the Amazon S3 bucket folder destination to where the export will be sent.</p>
    #[doc(hidden)]pub revision_destination: std::option::Option<crate::model::AutoExportRevisionDestinationEntry>,
}
...
pub struct ExportServerSideEncryption  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ServerSideEncryptionTypes>,
}
...
pub struct OriginDetails  {
    ...
    #[doc(hidden)]pub product_id: std::option::Option<std::string::String>,
}
impl OriginDetails {
    /// <p>The product ID of the origin of the data set.</p>
...
pub struct AssetDetails  {
    ...
    #[doc(hidden)]pub s3_snapshot_asset: std::option::Option<crate::model::S3SnapshotAsset>,
    /// <p>The Amazon Redshift datashare that is the asset.</p>
    #[doc(hidden)]pub redshift_data_share_asset: std::option::Option<crate::model::RedshiftDataShareAsset>,
    /// <p>Information about the API Gateway API asset.</p>
    #[doc(hidden)]pub api_gateway_api_asset: std::option::Option<crate::model::ApiGatewayApiAsset>,
}
impl AssetDetails {
    /// <p>The S3 object that is the asset.</p>
...
pub struct ApiGatewayApiAsset  {
    ...
    #[doc(hidden)]pub api_description: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub api_specification_download_url: std::option::Option<std::string::String>,
    /// <p>The date and time that the upload URL expires, in ISO 8601 format.</p>
    #[doc(hidden)]pub api_specification_download_url_expires_at: std::option::Option<aws_smithy_types::DateTime>,
...
impl  std::fmt::Debug for ApiGatewayApiAsset  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("api_specification_download_url", &self.api_specification_download_url);
        formatter.field("api_specification_download_url_expires_at", &self.api_specification_download_url_expires_at);
...
impl Type {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "EXPORT_ASSETS_TO_S3", "EXPORT_ASSET_TO_SIGNED_URL", "EXPORT_REVISIONS_TO_S3", "IMPORT_ASSETS_FROM_REDSHIFT_DATA_SHARES", "IMPORT_ASSETS_FROM_S3", "IMPORT_ASSET_FROM_API_GATEWAY_API", "IMPORT_ASSET_FROM_SIGNED_URL"
        ]
    }
}
...
pub struct JobError  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::Code>,
    /// <p>The details about the job error.</p>
    #[doc(hidden)]pub details: std::option::Option<crate::model::Details>,
    /// <p>The name of the limit that was reached.</p>
    #[doc(hidden)]pub limit_name: std::option::Option<crate::model::JobErrorLimitName>,
    ...
    #[doc(hidden)]pub resource_type: std::option::Option<crate::model::JobErrorResourceTypes>,
}
impl JobError {
    /// <p>The code for the job error.</p>
...
pub struct Details  {
    /// <p>Information about the job error.</p>
    #[doc(hidden)]pub import_asset_from_signed_url_job_error_details: std::option::Option<crate::model::ImportAssetFromSignedUrlJobErrorDetails>,
    /// <p>Information about the job error.</p>
    #[doc(hidden)]pub import_assets_from_s3_job_error_details: std::option::Option<std::vec::Vec<crate::model::AssetSourceEntry>>,
}
impl Details {
    /// <p>Information about the job error.</p>
...
impl  std::fmt::Debug for Details  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("import_asset_from_signed_url_job_error_details", &self.import_asset_from_signed_url_job_error_details);
        formatter.field("import_assets_from_s3_job_error_details", &self.import_assets_from_s3_job_error_details);
        formatter.finish()
    }
}
...
pub struct ResponseDetails  {
    ...
    #[doc(hidden)]pub export_asset_to_signed_url: std::option::Option<crate::model::ExportAssetToSignedUrlResponseDetails>,
    /// <p>Details for the export to Amazon S3 response.</p>
    #[doc(hidden)]pub export_assets_to_s3: std::option::Option<crate::model::ExportAssetsToS3ResponseDetails>,
    /// <p>Details for the export revisions to Amazon S3 response.</p>
    #[doc(hidden)]pub export_revisions_to_s3: std::option::Option<crate::model::ExportRevisionsToS3ResponseDetails>,
    /// <p>Details for the import from signed URL response.</p>
    #[doc(hidden)]pub import_asset_from_signed_url: std::option::Option<crate::model::ImportAssetFromSignedUrlResponseDetails>,
    /// <p>Details for the import from Amazon S3 response.</p>
    #[doc(hidden)]pub import_assets_from_s3: std::option::Option<crate::model::ImportAssetsFromS3ResponseDetails>,
    /// <p>Details from an import from Amazon Redshift datashare response.</p>
    #[doc(hidden)]pub import_assets_from_redshift_data_shares: std::option::Option<crate::model::ImportAssetsFromRedshiftDataSharesResponseDetails>,
    /// <p>The response details.</p>
    #[doc(hidden)]pub import_asset_from_api_gateway_api: std::option::Option<crate::model::ImportAssetFromApiGatewayApiResponseDetails>,
}
...
impl  std::fmt::Debug for ResponseDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("export_asset_to_signed_url", &self.export_asset_to_signed_url);
        ...
        formatter.field("import_asset_from_signed_url", &self.import_asset_from_signed_url);
        formatter.field("import_assets_from_s3", &self.import_assets_from_s3);
        formatter.field("import_assets_from_redshift_data_shares", &self.import_assets_from_redshift_data_shares);
        formatter.field("import_asset_from_api_gateway_api", &self.import_asset_from_api_gateway_api);
        formatter.finish()
    }
}
...
pub struct ImportAssetFromApiGatewayApiResponseDetails  {
    ...
    #[doc(hidden)]pub api_specification_md5_hash: std::option::Option<std::string::String>,
    /// <p>The upload URL of the API specification.</p>
    #[doc(hidden)]pub api_specification_upload_url: std::option::Option<std::string::String>,
    /// <p>The date and time that the upload URL expires, in ISO 8601 format.</p>
    #[doc(hidden)]pub api_specification_upload_url_expires_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The data set ID.</p>
    #[doc(hidden)]pub data_set_id: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for ImportAssetFromApiGatewayApiResponseDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("api_key", &self.api_key);
        formatter.field("api_name", &self.api_name);
        formatter.field("api_specification_md5_hash", &self.api_specification_md5_hash);
        formatter.field("api_specification_upload_url", &self.api_specification_upload_url);
        formatter.field("api_specification_upload_url_expires_at", &self.api_specification_upload_url_expires_at);
        formatter.field("data_set_id", &self.data_set_id);
        formatter.field("protocol_type", &self.protocol_type);
        formatter.field("revision_id", &self.revision_id);
        formatter.field("stage", &self.stage);
...
pub struct ImportAssetsFromRedshiftDataSharesResponseDetails  {
    ...
    #[doc(hidden)]pub asset_sources: std::option::Option<std::vec::Vec<crate::model::RedshiftDataShareAssetSourceEntry>>,
...
pub struct ImportAssetsFromS3ResponseDetails  {
    ...
    #[doc(hidden)]pub asset_sources: std::option::Option<std::vec::Vec<crate::model::AssetSourceEntry>>,
    /// <p>The unique identifier for the data set associated with this import job.</p>
    #[doc(hidden)]pub data_set_id: std::option::Option<std::string::String>,
...
pub struct ImportAssetFromSignedUrlResponseDetails  {
    ...
    #[doc(hidden)]pub md5_hash: std::option::Option<std::string::String>,
    /// <p>The unique identifier for the revision associated with this import response.</p>
    #[doc(hidden)]pub revision_id: std::option::Option<std::string::String>,
    /// <p>The signed URL.</p>
    #[doc(hidden)]pub signed_url: std::option::Option<std::string::String>,
    /// <p>The time and date at which the signed URL expires, in ISO 8601 format.</p>
    #[doc(hidden)]pub signed_url_expires_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct ExportRevisionsToS3ResponseDetails  {
    ...
    #[doc(hidden)]pub revision_destinations: std::option::Option<std::vec::Vec<crate::model::RevisionDestinationEntry>>,
    /// <p>The Amazon Resource Name (ARN) of the event action.</p>
    #[doc(hidden)]pub event_action_arn: std::option::Option<std::string::String>,
}
...
pub struct ExportAssetsToS3ResponseDetails  {
    ...
    #[doc(hidden)]pub asset_destinations: std::option::Option<std::vec::Vec<crate::model::AssetDestinationEntry>>,
    /// <p>The unique identifier for the data set associated with this export job.</p>
    #[doc(hidden)]pub data_set_id: std::option::Option<std::string::String>,
    /// <p>Encryption configuration of the export job.</p>
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::ExportServerSideEncryption>,
...
pub struct RequestDetails  {
    ...
    #[doc(hidden)]pub export_asset_to_signed_url: std::option::Option<crate::model::ExportAssetToSignedUrlRequestDetails>,
    /// <p>Details about the export to Amazon S3 request.</p>
    #[doc(hidden)]pub export_assets_to_s3: std::option::Option<crate::model::ExportAssetsToS3RequestDetails>,
    /// <p>Details about the export to Amazon S3 request.</p>
    #[doc(hidden)]pub export_revisions_to_s3: std::option::Option<crate::model::ExportRevisionsToS3RequestDetails>,
    /// <p>Details about the import from Amazon S3 request.</p>
    #[doc(hidden)]pub import_asset_from_signed_url: std::option::Option<crate::model::ImportAssetFromSignedUrlRequestDetails>,
    /// <p>Information about the import asset from API Gateway API request.</p>
    #[doc(hidden)]pub import_assets_from_s3: std::option::Option<crate::model::ImportAssetsFromS3RequestDetails>,
    /// <p>Details from an import from Amazon Redshift datashare request.</p>
    #[doc(hidden)]pub import_assets_from_redshift_data_shares: std::option::Option<crate::model::ImportAssetsFromRedshiftDataSharesRequestDetails>,
    /// <p>Details about the import from signed URL request.</p>
    #[doc(hidden)]pub import_asset_from_api_gateway_api: std::option::Option<crate::model::ImportAssetFromApiGatewayApiRequestDetails>,
}
impl RequestDetails {
    /// <p>Details about the export to signed URL request.</p>
...
impl LimitName {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "Amazon API Gateway API assets per revision", "Amazon Redshift datashare assets per import job from Redshift", "Amazon Redshift datashare assets per revision", "Asset per export job from Amazon S3", "Asset size in GB", "Assets per import job from Amazon S3", "Assets per revision", "Auto export event actions per data set", "Concurrent in progress jobs to export assets to Amazon S3", "Concurrent in progress jobs to export assets to a signed URL", "Concurrent in progress jobs to export revisions to Amazon S3", "Concurrent in progress jobs to import assets from Amazon Redshift datashares", "Concurrent in progress jobs to import assets from Amazon S3", "Concurrent in progress jobs to import assets from a signed URL", "Concurrent in progress jobs to import assets from an API Gateway API", "Data sets per account", "Data sets per product", "Event actions per account", "Products per account", "Revisions per Amazon API Gateway API data set", "Revisions per Amazon Redshift datashare data set", "Revisions per data set"
        ]
    }
}
