...
pub struct ValidationException  {
    ...
    #[doc(hidden)]pub exception_cause: std::option::Option<crate::model::ExceptionCause>,
}
...
pub struct ServiceLimitExceededException  {
    ...
    #[doc(hidden)]pub limit_name: std::option::Option<crate::model::LimitName>,
    /// <p>The value of the exceeded limit.</p>
    #[doc(hidden)]pub limit_value: f64,
    /// <p>The request has exceeded the quotas imposed by the service.</p>
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
}
