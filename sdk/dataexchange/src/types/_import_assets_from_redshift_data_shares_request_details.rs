...
impl ImportAssetsFromRedshiftDataSharesRequestDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ImportAssetsFromRedshiftDataSharesRequestDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ImportAssetsFromRedshiftDataSharesRequestDetails {
                asset_sources: self.asset_sources
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("asset_sources", "asset_sources was not specified but it is required when building ImportAssetsFromRedshiftDataSharesRequestDetails")
                    )?
                ,
                data_set_id: self.data_set_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_set_id", "data_set_id was not specified but it is required when building ImportAssetsFromRedshiftDataSharesRequestDetails")
                    )?
                ,
                revision_id: self.revision_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("revision_id", "revision_id was not specified but it is required when building ImportAssetsFromRedshiftDataSharesRequestDetails")
                    )?
                ,
            }
        )
