        ...
        ::std::result::Result::Ok(
            crate::types::ExportAssetsToS3ResponseDetails {
                asset_destinations: self.asset_destinations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("asset_destinations", "asset_destinations was not specified but it is required when building ExportAssetsToS3ResponseDetails")
                    )?
                ,
                data_set_id: self.data_set_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_set_id", "data_set_id was not specified but it is required when building ExportAssetsToS3ResponseDetails")
                    )?
                ,
                ...
                revision_id: self.revision_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("revision_id", "revision_id was not specified but it is required when building ExportAssetsToS3ResponseDetails")
                    )?
                ,
            }
        )
