...
impl CreateS3DataAccessFromS3BucketRequestDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CreateS3DataAccessFromS3BucketRequestDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CreateS3DataAccessFromS3BucketRequestDetails {
                ...
                data_set_id: self.data_set_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_set_id", "data_set_id was not specified but it is required when building CreateS3DataAccessFromS3BucketRequestDetails")
                    )?
                ,
                revision_id: self.revision_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("revision_id", "revision_id was not specified but it is required when building CreateS3DataAccessFromS3BucketRequestDetails")
                    )?
                ,
            }
        )
