...
impl ::std::convert::From<&str> for ServerSideEncryptionTypes {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerSideEncryptionTypes::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for ServerSideEncryptionTypes {
