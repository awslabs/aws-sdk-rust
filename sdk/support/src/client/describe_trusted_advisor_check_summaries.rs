...
impl super::Client {
    ...
    ///   - [`summaries(Vec::<TrustedAdvisorCheckSummary>)`](crate::operation::describe_trusted_advisor_check_summaries::DescribeTrustedAdvisorCheckSummariesOutput::summaries): <p>The summary information for the requested Trusted Advisor checks.</p>
