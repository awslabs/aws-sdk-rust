...
impl super::Client {
    ...
    ///   - [`issue_type(impl ::std::convert::Into<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::issue_type) / [`set_issue_type(Option<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::set_issue_type): <p>The type of issue for the case. You can specify <code>customer-service</code> or <code>technical</code>.</p>
    ///   - [`service_code(impl ::std::convert::Into<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::service_code) / [`set_service_code(Option<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::set_service_code): <p>The code for the Amazon Web Services service. You can use the <code>DescribeServices</code> operation to get the possible <code>serviceCode</code> values.</p>
    ///   - [`category_code(impl ::std::convert::Into<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::category_code) / [`set_category_code(Option<String>)`](crate::operation::describe_supported_languages::builders::DescribeSupportedLanguagesFluentBuilder::set_category_code): <p>The category of problem for the support case. You also use the <code>DescribeServices</code> operation to get the category code for a service. Each Amazon Web Services service defines its own set of category codes.</p>
