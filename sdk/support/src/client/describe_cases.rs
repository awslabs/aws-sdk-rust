...
impl super::Client {
    ...
    ///   - [`include_resolved_cases(bool)`](crate::operation::describe_cases::builders::DescribeCasesFluentBuilder::include_resolved_cases) / [`set_include_resolved_cases(bool)`](crate::operation::describe_cases::builders::DescribeCasesFluentBuilder::set_include_resolved_cases): <p>Specifies whether to include resolved support cases in the <code>DescribeCases</code> response. By default, resolved cases aren't included.</p>
