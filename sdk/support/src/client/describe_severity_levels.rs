...
impl super::Client {
    ...
    ///   - [`language(impl ::std::convert::Into<String>)`](crate::operation::describe_severity_levels::builders::DescribeSeverityLevelsFluentBuilder::language) / [`set_language(Option<String>)`](crate::operation::describe_severity_levels::builders::DescribeSeverityLevelsFluentBuilder::set_language): <p>The language in which Amazon Web Services Support handles the case. Amazon Web Services Support currently supports Chinese (“zh”), English ("en"), Japanese ("ja") and Korean (“ko”). You must specify the ISO 639-1 code for the <code>language</code> parameter if you want support in that language.</p>
