...
impl AddCommunicationToCase {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::add_communication_to_case::AddCommunicationToCaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_communication_to_case::AddCommunicationToCaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddCommunicationToCase {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddCommunicationToCase");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddCommunicationToCaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddCommunicationToCaseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddCommunicationToCase")
...
.with_interceptor(AddCommunicationToCaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_communication_to_case::AddCommunicationToCaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_communication_to_case::AddCommunicationToCaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_communication_to_case::AddCommunicationToCaseError>::new());
...
#[derive(Debug)]
            struct AddCommunicationToCaseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddCommunicationToCaseResponseDeserializer {
...
#[derive(Debug)]
            struct AddCommunicationToCaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddCommunicationToCaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_communication_to_case::AddCommunicationToCaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_communication_to_case::ser_add_communication_to_case_input(&input)?);
...
#[derive(Debug)]
            struct AddCommunicationToCaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddCommunicationToCaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddCommunicationToCaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddCommunicationToCaseInput>()
                        .ok_or("failed to downcast to AddCommunicationToCaseInput")?;
...
pub enum AddCommunicationToCaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddCommunicationToCaseError) for what information is available for the error.")]
...
impl AddCommunicationToCaseError {
    /// Creates the `AddCommunicationToCaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddCommunicationToCaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddCommunicationToCaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_communication_to_case::AddCommunicationToCaseError {
...
mod _add_communication_to_case_output;
