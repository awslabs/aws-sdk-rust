...
impl AddCommunicationToCaseInput {
    /// Consumes the builder and constructs an Operation<[`AddCommunicationToCase`](crate::operation::add_communication_to_case::AddCommunicationToCase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_communication_to_case::AddCommunicationToCase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_communication_to_case::AddCommunicationToCaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_communication_to_case::ser_add_communication_to_case_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_communication_to_case::AddCommunicationToCase::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddCommunicationToCase {
                type Output = std::result::Result<crate::operation::add_communication_to_case::AddCommunicationToCaseOutput, crate::operation::add_communication_to_case::AddCommunicationToCaseError>;
