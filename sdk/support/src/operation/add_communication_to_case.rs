...
impl AddCommunicationToCase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Support", "AddCommunicationToCase", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Support.AddCommunicationToCase",
                "rpc.service" = "Support",
                "rpc.method" = "AddCommunicationToCase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddCommunicationToCase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddCommunicationToCaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddCommunicationToCaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddCommunicationToCase")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddCommunicationToCase")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AddCommunicationToCaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AddCommunicationToCaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddCommunicationToCaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AddCommunicationToCaseInput>() else {
        ...
        if requested.should_capture("communicationBody") {
            if let ::std::option::Option::Some(value) = input.communication_body.as_deref() {
                captured.insert("communicationBody", value);
            }
        }
        if requested.should_capture("attachmentSetId") {
            if let ::std::option::Option::Some(value) = input.attachment_set_id.as_deref() {
                captured.insert("attachmentSetId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddCommunicationToCaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_add_communication_to_case::de_add_communication_to_case_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_communication_to_case::de_add_communication_to_case_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddCommunicationToCaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::add_communication_to_case::AddCommunicationToCaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::add_communication_to_case::AddCommunicationToCaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_add_communication_to_case::ser_add_communication_to_case_input(&input)?,
        );
...
impl AddCommunicationToCaseError {
    ...
    /// Returns `true` if the error kind is `AddCommunicationToCaseError::DryRunOperationException`.
