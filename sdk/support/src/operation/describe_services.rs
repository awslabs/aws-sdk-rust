...
impl DescribeServicesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_services::DescribeServices, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_services::ser_describe_services_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeServices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_services::de_describe_services_http_response_with_props(status, headers, body)
        }
    }
}
