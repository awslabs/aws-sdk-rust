...
impl DescribeTrustedAdvisorCheckResultInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_trusted_advisor_check_result::DescribeTrustedAdvisorCheckResult,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_trusted_advisor_check_result::DescribeTrustedAdvisorCheckResult::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrustedAdvisorCheckResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_trusted_advisor_check_result::de_describe_trusted_advisor_check_result_http_response_with_props(
                status, headers, body,
            )
        }
    }
