...
impl AddAttachmentsToSet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Support", "AddAttachmentsToSet", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Support.AddAttachmentsToSet",
                "rpc.service" = "Support",
                "rpc.method" = "AddAttachmentsToSet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddAttachmentsToSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddAttachmentsToSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddAttachmentsToSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddAttachmentsToSet")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddAttachmentsToSet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AddAttachmentsToSetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AddAttachmentsToSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddAttachmentsToSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AddAttachmentsToSetInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddAttachmentsToSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_add_attachments_to_set::de_add_attachments_to_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_attachments_to_set::de_add_attachments_to_set_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddAttachmentsToSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::add_attachments_to_set::AddAttachmentsToSetInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_attachments_to_set::ser_add_attachments_to_set_input(
            &input,
        )?);
...
impl AddAttachmentsToSetError {
    ...
    /// Returns `true` if the error kind is `AddAttachmentsToSetError::DryRunOperationException`.
...
impl ::std::error::Error for AddAttachmentsToSetError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::AttachmentLimitExceeded(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::AttachmentSetSizeLimitExceeded(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AddAttachmentsToSetError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AttachmentLimitExceeded(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::AttachmentSetSizeLimitExceeded(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
