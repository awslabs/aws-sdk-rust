...
impl AddAttachmentsToSetInput {
    /// Consumes the builder and constructs an Operation<[`AddAttachmentsToSet`](crate::operation::add_attachments_to_set::AddAttachmentsToSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_attachments_to_set::AddAttachmentsToSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_attachments_to_set::AddAttachmentsToSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_attachments_to_set::ser_add_attachments_to_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_attachments_to_set::AddAttachmentsToSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddAttachmentsToSet {
                type Output = std::result::Result<crate::operation::add_attachments_to_set::AddAttachmentsToSetOutput, crate::operation::add_attachments_to_set::AddAttachmentsToSetError>;
