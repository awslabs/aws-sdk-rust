...
/// Orchestration and serialization glue logic for `AddAttachmentsToSet`.
...
impl AddAttachmentsToSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::add_attachments_to_set::AddAttachmentsToSetInput,
                    ) -> ::std::result::Result<crate::operation::add_attachments_to_set::AddAttachmentsToSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_attachments_to_set::AddAttachmentsToSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddAttachmentsToSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddAttachmentsToSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddAttachmentsToSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddAttachmentsToSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddAttachmentsToSet")
...
.with_interceptor(AddAttachmentsToSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_attachments_to_set::AddAttachmentsToSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_attachments_to_set::AddAttachmentsToSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_attachments_to_set::AddAttachmentsToSetError>::new());
...
#[derive(Debug)]
            struct AddAttachmentsToSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddAttachmentsToSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_attachments_to_set::de_add_attachments_to_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_add_attachments_to_set::de_add_attachments_to_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AddAttachmentsToSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddAttachmentsToSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_attachments_to_set::AddAttachmentsToSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_attachments_to_set::AddAttachmentsToSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_attachments_to_set::ser_add_attachments_to_set_input(&input)?);
...
#[derive(Debug)]
            struct AddAttachmentsToSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddAttachmentsToSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddAttachmentsToSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddAttachmentsToSetInput>()
                        .ok_or("failed to downcast to AddAttachmentsToSetInput")?;
...
pub enum AddAttachmentsToSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddAttachmentsToSetError) for what information is available for the error.")]
...
impl AddAttachmentsToSetError {
    /// Creates the `AddAttachmentsToSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddAttachmentsToSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AttachmentLimitExceeded(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::AttachmentSetSizeLimitExceeded(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddAttachmentsToSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_attachments_to_set::AddAttachmentsToSetError {
...
mod _add_attachments_to_set_output;
