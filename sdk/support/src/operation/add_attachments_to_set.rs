...
impl AddAttachmentsToSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_attachments_to_set::ser_add_attachments_to_set_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_attachments_to_set::AddAttachmentsToSet::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_attachments_to_set::AddAttachmentsToSetError
{
