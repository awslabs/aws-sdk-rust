...
impl DescribeAttachmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_attachment::ser_describe_attachment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAttachment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_attachment::de_describe_attachment_http_response_with_props(status, headers, body)
        }
    }
}
