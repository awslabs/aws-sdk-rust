...
impl DescribeAttachmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_attachment::DescribeAttachment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAttachment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_attachment::de_describe_attachment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_attachment::DescribeAttachmentError
{
