...
impl DescribeCreateCaseOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_create_case_options::DescribeCreateCaseOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_create_case_options::DescribeCreateCaseOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_create_case_options::DescribeCreateCaseOptionsOutput, crate::operation::describe_create_case_options::DescribeCreateCaseOptionsError, Self> {
