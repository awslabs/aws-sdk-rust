...
impl DescribeSupportedLanguagesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSupportedLanguages`](crate::operation::describe_supported_languages::DescribeSupportedLanguages)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_supported_languages::ser_describe_supported_languages_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_supported_languages::DescribeSupportedLanguages::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeSupportedLanguages", "support"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSupportedLanguages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_supported_languages::de_describe_supported_languages_http_response_with_props(status, headers, body)
        }
    }
}
