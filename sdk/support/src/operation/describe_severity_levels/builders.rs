...
impl DescribeSeverityLevelsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_severity_levels::DescribeSeverityLevelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_severity_levels::DescribeSeverityLevelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_severity_levels::DescribeSeverityLevelsOutput, crate::operation::describe_severity_levels::DescribeSeverityLevelsError, Self> {
