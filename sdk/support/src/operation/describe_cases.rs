...
impl DescribeCasesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_cases::DescribeCases, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_cases::ser_describe_cases_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cases::de_describe_cases_http_response_with_props(status, headers, body)
        }
    }
}
