...
impl crate::operation::describe_trusted_advisor_checks::builders::DescribeTrustedAdvisorChecksInputBuilder {
...
/// <ul>
/// <li>
/// <p>You must have a Amazon Web Services Business Support+, Amazon Web Services Enterprise Support, or Amazon Web Services Unified Operations plan to use the Amazon Web Services Support API.</p></li>
/// <li>
/// <p>If you call the Amazon Web Services Support API from an account that doesn't have a Amazon Web Services Business Support+, Amazon Web Services Enterprise Support, or Amazon Web Services Unified Operations plan, the <code>SubscriptionRequiredException</code> error message appears. For information about changing your support plan, see <a href="http://aws.amazon.com/premiumsupport/">Amazon Web Services Support</a>.</p></li>
/// <li>
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksOutput,
        crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksError,
    > for DescribeTrustedAdvisorChecksFluentBuilder
{
    fn send(
        self,
...
impl DescribeTrustedAdvisorChecksFluentBuilder {
    /// Creates a new `DescribeTrustedAdvisorChecksFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecks::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecks::orchestrate(&runtime_plugins, input).await
    }
