...
pub fn ser_describe_cases_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeCasesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
