...
pub(crate) fn de_trusted_advisor_resource_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TrustedAdvisorResourceDetail>, aws_smithy_json::deserialize::error::DeserializeError>
