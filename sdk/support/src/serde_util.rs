...
pub(crate) fn complete_attachment_upload_output_output_correct_errors(
...
pub(crate) fn describe_attachment_upload_status_output_output_correct_errors(
    mut builder: crate::operation::describe_attachment_upload_status::builders::DescribeAttachmentUploadStatusOutputBuilder,
) -> crate::operation::describe_attachment_upload_status::builders::DescribeAttachmentUploadStatusOutputBuilder {
    if builder.upload_status.is_none() {
        builder.upload_status = "no value was set".parse::<crate::types::UploadStatus>().ok()
    }
...
pub(crate) fn get_attachment_download_link_output_output_correct_errors(
    mut builder: crate::operation::get_attachment_download_link::builders::GetAttachmentDownloadLinkOutputBuilder,
) -> crate::operation::get_attachment_download_link::builders::GetAttachmentDownloadLinkOutputBuilder {
    if builder.file_name.is_none() {
        builder.file_name = Some(Default::default())
    }
    if builder.download_url.is_none() {
        builder.download_url = {
            let builder = crate::types::builders::DownloadUrlBuilder::default();
            crate::serde_util::download_url_correct_errors(builder).build().ok()
        }
    }
    builder
}

pub(crate) fn get_attachment_upload_links_output_output_correct_errors(
    ...
    if builder.part_size_bytes.is_none() {
        builder.part_size_bytes = Some(Default::default())
    }
    if builder.total_parts.is_none() {
        builder.total_parts = Some(Default::default())
    }
    if builder.upload_urls.is_none() {
        builder.upload_urls = Some(Default::default())
    }
    builder
}
...
pub(crate) fn download_url_correct_errors(mut builder: crate::types::builders::DownloadUrlBuilder) -> crate::types::builders::DownloadUrlBuilder {
    if builder.url.is_none() {
        builder.url = Some(Default::default())
    }
    if builder.expiry_date.is_none() {
        builder.expiry_date = Some(Default::default())
    }
    builder
}
...
pub(crate) fn upload_url_correct_errors(mut builder: crate::types::builders::UploadUrlBuilder) -> crate::types::builders::UploadUrlBuilder {
    if builder.url.is_none() {
        builder.url = Some(Default::default())
    }
    if builder.part_index.is_none() {
        builder.part_index = Some(Default::default())
    }
    if builder.expiry_date.is_none() {
        builder.expiry_date = Some(Default::default())
    }
