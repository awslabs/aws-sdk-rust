...
{
    pub fn add_attachments_to_set(&self) -> fluent_builders::AddAttachmentsToSet<C> {
        fluent_builders::AddAttachmentsToSet::new(self.handle.clone())
    }
    pub fn add_communication_to_case(&self) -> fluent_builders::AddCommunicationToCase<C> {
        fluent_builders::AddCommunicationToCase::new(self.handle.clone())
    }
    pub fn create_case(&self) -> fluent_builders::CreateCase<C> {
        fluent_builders::CreateCase::new(self.handle.clone())
    }
    pub fn describe_attachment(&self) -> fluent_builders::DescribeAttachment<C> {
        fluent_builders::DescribeAttachment::new(self.handle.clone())
    }
    pub fn describe_cases(&self) -> fluent_builders::DescribeCases<C> {
        fluent_builders::DescribeCases::new(self.handle.clone())
    }
    pub fn describe_communications(&self) -> fluent_builders::DescribeCommunications<C> {
    ...
    pub fn describe_severity_levels(&self) -> fluent_builders::DescribeSeverityLevels<C> {
        fluent_builders::DescribeSeverityLevels::new(self.handle.clone())
    }
    pub fn describe_trusted_advisor_check_refresh_statuses(
        &self,
    ) -> fluent_builders::DescribeTrustedAdvisorCheckRefreshStatuses<C> {
...
pub mod fluent_builders {
    ...
    impl<C> AddAttachmentsToSet<C> {
        ...
        pub fn attachment_set_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.attachment_set_id(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct AddCommunicationToCase<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::add_communication_to_case_input::Builder,
    }
    impl<C> AddCommunicationToCase<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn case_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.case_id(input);
            self
        }
        ...
        pub fn communication_body(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.communication_body(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct CreateCase<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
    ...
    impl<C> CreateCase<C> {
        ...
        pub fn severity_code(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.severity_code(input);
            self
        }
        ...
        pub fn category_code(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.category_code(input);
            self
        }
        ...
        pub fn issue_type(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.issue_type(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeAttachment<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_attachment_input::Builder,
    }
    impl<C> DescribeAttachment<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeCases<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_cases_input::Builder,
    }
    impl<C> DescribeCases<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn display_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.display_id(input);
            self
        }
        ...
        pub fn after_time(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.after_time(input);
            self
        }
        ...
        pub fn before_time(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.before_time(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeCommunications<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_communications_input::Builder,
    }
    impl<C> DescribeCommunications<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeSeverityLevels<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_severity_levels_input::Builder,
    }
    impl<C> DescribeSeverityLevels<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeTrustedAdvisorCheckRefreshStatuses<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_trusted_advisor_check_refresh_statuses_input::Builder,
    }
    impl<C> DescribeTrustedAdvisorCheckRefreshStatuses<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeTrustedAdvisorCheckResult<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_trusted_advisor_check_result_input::Builder,
    }
    impl<C> DescribeTrustedAdvisorCheckResult<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn check_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.check_id(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeTrustedAdvisorChecks<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_trusted_advisor_checks_input::Builder,
    }
    impl<C> DescribeTrustedAdvisorChecks<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeTrustedAdvisorCheckSummaries<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_trusted_advisor_check_summaries_input::Builder,
    }
    impl<C> DescribeTrustedAdvisorCheckSummaries<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct RefreshTrustedAdvisorCheck<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::refresh_trusted_advisor_check_input::Builder,
    }
    impl<C> RefreshTrustedAdvisorCheck<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ResolveCase<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::resolve_case_input::Builder,
    }
    impl<C> ResolveCase<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
