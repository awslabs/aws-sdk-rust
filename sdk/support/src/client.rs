...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_support::Error> {
/// # let client: aws_sdk_support::Client = unimplemented!();
...
mod describe_trusted_advisor_check_result;
