...
/// match uploadstatus {
///     UploadStatus::AttachmentNotReady => { /* ... */ },
///     UploadStatus::AttachmentReady => { /* ... */ },
///     UploadStatus::Failed => { /* ... */ },
...
impl ::std::convert::From<&str> for UploadStatus {
    fn from(s: &str) -> Self {
        match s {
            "attachment-not-ready" => UploadStatus::AttachmentNotReady,
            "attachment-ready" => UploadStatus::AttachmentReady,
...
impl UploadStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UploadStatus::AttachmentNotReady => "attachment-not-ready",
            UploadStatus::AttachmentReady => "attachment-ready",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["attachment-not-ready", "attachment-ready", "failed"]
    }
}
...
impl ::std::fmt::Display for UploadStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            UploadStatus::AttachmentNotReady => write!(f, "attachment-not-ready"),
            UploadStatus::AttachmentReady => write!(f, "attachment-ready"),
