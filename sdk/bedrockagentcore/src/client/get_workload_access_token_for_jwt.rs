...
impl super::Client {
    ...
    ///   - [`workload_name(impl Into<String>)`](crate::operation::get_workload_access_token_for_jwt::builders::GetWorkloadAccessTokenForJWTFluentBuilder::workload_name) / [`set_workload_name(Option<String>)`](crate::operation::get_workload_access_token_for_jwt::builders::GetWorkloadAccessTokenForJWTFluentBuilder::set_workload_name):<br>required: **true**<br><p>Unique identifier for the registered agent</p><br>
    ///   - [`user_token(impl Into<String>)`](crate::operation::get_workload_access_token_for_jwt::builders::GetWorkloadAccessTokenForJWTFluentBuilder::user_token) / [`set_user_token(Option<String>)`](crate::operation::get_workload_access_token_for_jwt::builders::GetWorkloadAccessTokenForJWTFluentBuilder::set_user_token):<br>required: **true**<br><p>OAuth2 token issued by the user's identity provider</p><br>
    ...
    ///   - [`workload_access_token(String)`](crate::operation::get_workload_access_token_for_jwt::GetWorkloadAccessTokenForJwtOutput::workload_access_token): <p>Opaque token representing both agent and user identity</p>
