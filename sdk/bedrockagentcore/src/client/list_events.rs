...
impl super::Client {
    ...
    ///   - [`session_id(impl Into<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_session_id):<br>required: **true**<br><p>The identifier of the session for which to list events.</p><br>
    ///   - [`actor_id(impl Into<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::actor_id) / [`set_actor_id(Option<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_actor_id):<br>required: **true**<br><p>The identifier of the actor for which to list events.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_events::builders::ListEventsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in a single call. The default value is 20.</p><br>
