...
impl super::Client {
    ...
    ///   - [`memory_id(impl Into<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::memory_id) / [`set_memory_id(Option<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_memory_id):<br>required: **true**<br><p>The identifier of the memory store for which to list events.</p><br>
