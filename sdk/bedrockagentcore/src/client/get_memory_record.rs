...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::get_memory_record::builders::GetMemoryRecordFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::get_memory_record::builders::GetMemoryRecordFluentBuilder::set_namespace):<br>required: **false**<br><p>The namespace of the memory record to retrieve. This value is used for IAM condition key authorization.</p><br>
