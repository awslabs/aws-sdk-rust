...
impl super::Client {
    ...
    ///   - [`memory_id(impl Into<String>)`](crate::operation::delete_event::builders::DeleteEventFluentBuilder::memory_id) / [`set_memory_id(Option<String>)`](crate::operation::delete_event::builders::DeleteEventFluentBuilder::set_memory_id):<br>required: **true**<br><p>The identifier of the memory store from which to delete the event.</p><br>
