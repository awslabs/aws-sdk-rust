...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::delete_memory_record::builders::DeleteMemoryRecordFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::delete_memory_record::builders::DeleteMemoryRecordFluentBuilder::set_namespace):<br>required: **false**<br><p>The namespace of the memory record to delete. This value is used for IAM condition key authorization.</p><br>
