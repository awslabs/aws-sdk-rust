...
impl super::Client {
    ...
    ///   - [`memory_id(impl Into<String>)`](crate::operation::create_event::builders::CreateEventFluentBuilder::memory_id) / [`set_memory_id(Option<String>)`](crate::operation::create_event::builders::CreateEventFluentBuilder::set_memory_id):<br>required: **true**<br><p>The identifier of the memory store in which to create the event.</p><br>
