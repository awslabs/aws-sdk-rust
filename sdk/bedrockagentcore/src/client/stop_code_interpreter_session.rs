...
impl super::Client {
    ...
    ///   - [`trace_id(impl Into<String>)`](crate::operation::stop_code_interpreter_session::builders::StopCodeInterpreterSessionFluentBuilder::trace_id) / [`set_trace_id(Option<String>)`](crate::operation::stop_code_interpreter_session::builders::StopCodeInterpreterSessionFluentBuilder::set_trace_id):<br>required: **false**<br><p>The trace identifier for request tracking.</p><br>
    ///   - [`trace_parent(impl Into<String>)`](crate::operation::stop_code_interpreter_session::builders::StopCodeInterpreterSessionFluentBuilder::trace_parent) / [`set_trace_parent(Option<String>)`](crate::operation::stop_code_interpreter_session::builders::StopCodeInterpreterSessionFluentBuilder::set_trace_parent):<br>required: **false**<br><p>The parent trace information for distributed tracing.</p><br>
