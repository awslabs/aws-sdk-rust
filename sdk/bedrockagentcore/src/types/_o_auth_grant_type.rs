...
impl ::std::convert::From<&str> for OAuthGrantType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "TOKEN_EXCHANGE" => OAuthGrantType::TokenExchange,
...
impl OAuthGrantType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OAuthGrantType::TokenExchange => "TOKEN_EXCHANGE",
...
impl ::std::fmt::Display for OAuthGrantType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OAuthGrantType::AuthorizationCode => write!(f, "AUTHORIZATION_CODE"),
            OAuthGrantType::ClientCredentials => write!(f, "CLIENT_CREDENTIALS"),
            OAuthGrantType::TokenExchange => write!(f, "TOKEN_EXCHANGE"),
