...
///     RecommendationType::SystemPromptRecommendation => { /* ... */ },
///     RecommendationType::ToolDescriptionRecommendation => { /* ... */ },
...
impl ::std::convert::From<&str> for RecommendationType {
    fn from(s: &str) -> Self {
        match s {
            "SYSTEM_PROMPT_RECOMMENDATION" => RecommendationType::SystemPromptRecommendation,
            "TOOL_DESCRIPTION_RECOMMENDATION" => RecommendationType::ToolDescriptionRecommendation,
...
impl RecommendationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RecommendationType::SystemPromptRecommendation => "SYSTEM_PROMPT_RECOMMENDATION",
            RecommendationType::ToolDescriptionRecommendation => "TOOL_DESCRIPTION_RECOMMENDATION",
...
impl ::std::fmt::Display for RecommendationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RecommendationType::SystemPromptRecommendation => write!(f, "SYSTEM_PROMPT_RECOMMENDATION"),
            RecommendationType::ToolDescriptionRecommendation => write!(f, "TOOL_DESCRIPTION_RECOMMENDATION"),
