...
impl ::std::convert::From<&str> for RecommendationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "DELETING" => RecommendationStatus::Deleting,
...
impl RecommendationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RecommendationStatus::Deleting => "DELETING",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["COMPLETED", "DELETING", "FAILED", "IN_PROGRESS", "PENDING"]
    }
}
...
impl ::std::fmt::Display for RecommendationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            RecommendationStatus::Deleting => write!(f, "DELETING"),
