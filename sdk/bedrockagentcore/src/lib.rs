...
//! offered by Amazon Bedrock AgentCore. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Bedrock AgentCore.
...
/// Configuration for Amazon Bedrock AgentCore.
pub mod config;
