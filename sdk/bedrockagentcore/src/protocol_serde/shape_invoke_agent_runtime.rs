...
> {
    ...
    Ok({
        ...
        output = output.set_baggage(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_baggage_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::invoke_agent_runtime::InvokeAgentRuntimeError::unhandled(
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_content_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_mcp_protocol_version(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_mcp_protocol_version_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("Mcp-Protocol-Version")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
        ...
        output = output.set_mcp_session_id(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_mcp_session_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("Mcp-Session-Id")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::invoke_agent_runtime::InvokeAgentRuntimeError::unhandled(
                            "Failed to parse mcpSessionId from header `Mcp-Session-Id`",
                        ));
                    }
                }
            },
        ...
        output = output.set_runtime_session_id(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_runtime_session_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_trace_id(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_trace_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_trace_parent(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_trace_parent_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_trace_state(
            match crate::protocol_serde::shape_invoke_agent_runtime_output::de_trace_state_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
