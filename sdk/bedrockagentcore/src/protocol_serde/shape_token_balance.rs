                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "token" => {
                            builder = builder.set_token(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::InstrumentBalanceToken::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "network" => {
                        ...
                        "chain" => {
                            builder = builder.set_chain(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::BlockchainChainId::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
