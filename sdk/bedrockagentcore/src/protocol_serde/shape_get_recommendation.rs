...
) -> std::result::Result<crate::operation::get_recommendation::GetRecommendationOutput, crate::operation::get_recommendation::GetRecommendationError>
{
    Ok({
        ...
        crate::serde_util::get_recommendation_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_recommendation::GetRecommendationError::unhandled)?
    })
}
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "recommendationConfig" => {
                    builder = builder.set_recommendation_config(crate::protocol_serde::shape_recommendation_config::de_recommendation_config(
                        tokens, _value,
                    )?);
                }
                "recommendationId" => {
                ...
                "recommendationResult" => {
                    builder = builder.set_recommendation_result(crate::protocol_serde::shape_recommendation_result::de_recommendation_result(
                        tokens, _value,
                    )?);
                }
                "status" => {
