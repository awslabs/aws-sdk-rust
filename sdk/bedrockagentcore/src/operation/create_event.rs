...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEventResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_event::de_create_event_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_event::de_create_event_http_response(status, headers, body)
        };
