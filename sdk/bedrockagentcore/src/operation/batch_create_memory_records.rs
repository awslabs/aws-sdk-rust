    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCreateMemoryRecords")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BatchCreateMemoryRecordsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchCreateMemoryRecordsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCreateMemoryRecordsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchCreateMemoryRecordsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCreateMemoryRecordsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_batch_create_memory_records::de_batch_create_memory_records_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_create_memory_records::de_batch_create_memory_records_http_response(status, headers, body, _cfg)
        };
