...
pub use crate::operation::get_browser_session::_get_browser_session_input::GetBrowserSessionInputBuilder;

pub use crate::operation::get_browser_session::_get_browser_session_output::GetBrowserSessionOutputBuilder;

impl crate::operation::get_browser_session::builders::GetBrowserSessionInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::get_browser_session::GetBrowserSessionOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::get_browser_session::GetBrowserSessionError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.get_browser_session();
...
/// <li>
/// <p><a href="https://docs.aws.amazon.com/bedrock-agentcore/latest/APIReference/API_ListBrowserSessions.html">ListBrowserSessions</a></p></li>
/// <li>
...
pub struct GetBrowserSessionFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_browser_session::builders::GetBrowserSessionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_browser_session::GetBrowserSessionOutput,
        crate::operation::get_browser_session::GetBrowserSessionError,
    > for GetBrowserSessionFluentBuilder
{
    fn send(
        self,
...
impl GetBrowserSessionFluentBuilder {
    /// Creates a new `GetBrowserSessionFluentBuilder`.
    ...
    /// Access the GetBrowserSession as a reference.
    pub fn as_input(&self) -> &crate::operation::get_browser_session::builders::GetBrowserSessionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_browser_session::GetBrowserSession::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_browser_session::GetBrowserSession::orchestrate(&runtime_plugins, input).await
    }
