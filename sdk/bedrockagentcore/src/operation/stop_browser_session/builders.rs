...
pub use crate::operation::stop_browser_session::_stop_browser_session_output::StopBrowserSessionOutputBuilder;

pub use crate::operation::stop_browser_session::_stop_browser_session_input::StopBrowserSessionInputBuilder;

impl crate::operation::stop_browser_session::builders::StopBrowserSessionInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.stop_browser_session();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `StopBrowserSession`.
///
/// <p>Terminates an active browser session in Amazon Bedrock AgentCore. This operation stops the session, releases associated resources, and makes the session unavailable for further use.</p>
/// <p>To stop a browser session, you must specify both the browser identifier and the session ID. Once stopped, a session cannot be restarted; you must create a new session using <code>StartBrowserSession</code>.</p>
/// <p>The following operations are related to <code>StopBrowserSession</code>:</p>
/// <ul>
/// <li>
...
pub struct StopBrowserSessionFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::stop_browser_session::builders::StopBrowserSessionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::stop_browser_session::StopBrowserSessionOutput,
        crate::operation::stop_browser_session::StopBrowserSessionError,
    > for StopBrowserSessionFluentBuilder
{
    fn send(
        self,
...
impl StopBrowserSessionFluentBuilder {
    /// Creates a new `StopBrowserSessionFluentBuilder`.
    ...
    /// Access the StopBrowserSession as a reference.
    pub fn as_input(&self) -> &crate::operation::stop_browser_session::builders::StopBrowserSessionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::stop_browser_session::StopBrowserSession::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::stop_browser_session::StopBrowserSession::orchestrate(&runtime_plugins, input).await
    }
