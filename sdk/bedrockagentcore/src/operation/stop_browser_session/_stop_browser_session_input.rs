...
pub struct StopBrowserSessionInput {
...
impl StopBrowserSessionInput {
    /// Creates a new builder-style object to manufacture [`StopBrowserSessionInput`](crate::operation::stop_browser_session::StopBrowserSessionInput).
    pub fn builder() -> crate::operation::stop_browser_session::builders::StopBrowserSessionInputBuilder {
        crate::operation::stop_browser_session::builders::StopBrowserSessionInputBuilder::default()
    }
}

/// A builder for [`StopBrowserSessionInput`](crate::operation::stop_browser_session::StopBrowserSessionInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StopBrowserSessionInputBuilder {
...
impl StopBrowserSessionInputBuilder {
    /// <p>The trace identifier for request tracking.</p>
    ...
    /// Consumes the builder and constructs a [`StopBrowserSessionInput`](crate::operation::stop_browser_session::StopBrowserSessionInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::stop_browser_session::StopBrowserSessionInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::stop_browser_session::StopBrowserSessionInput {
