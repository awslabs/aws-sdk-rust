...
pub use crate::operation::retrieve_memory_records::_retrieve_memory_records_input::RetrieveMemoryRecordsInputBuilder;

pub use crate::operation::retrieve_memory_records::_retrieve_memory_records_output::RetrieveMemoryRecordsOutputBuilder;

impl crate::operation::retrieve_memory_records::builders::RetrieveMemoryRecordsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.retrieve_memory_records();
...
pub struct RetrieveMemoryRecordsFluentBuilder {
    ...
    inner: crate::operation::retrieve_memory_records::builders::RetrieveMemoryRecordsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::retrieve_memory_records::RetrieveMemoryRecordsOutput,
        crate::operation::retrieve_memory_records::RetrieveMemoryRecordsError,
    > for RetrieveMemoryRecordsFluentBuilder
{
    fn send(
        self,
...
impl RetrieveMemoryRecordsFluentBuilder {
    /// Creates a new `RetrieveMemoryRecordsFluentBuilder`.
    ...
    /// Access the RetrieveMemoryRecords as a reference.
    pub fn as_input(&self) -> &crate::operation::retrieve_memory_records::builders::RetrieveMemoryRecordsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::retrieve_memory_records::RetrieveMemoryRecords::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::retrieve_memory_records::paginator::RetrieveMemoryRecordsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
