...
pub use crate::operation::create_payment_session::_create_payment_session_input::CreatePaymentSessionInputBuilder;

pub use crate::operation::create_payment_session::_create_payment_session_output::CreatePaymentSessionOutputBuilder;

impl crate::operation::create_payment_session::builders::CreatePaymentSessionInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_payment_session::CreatePaymentSessionError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_payment_session();
...
pub struct CreatePaymentSessionFluentBuilder {
    ...
    inner: crate::operation::create_payment_session::builders::CreatePaymentSessionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_payment_session::CreatePaymentSessionOutput,
        crate::operation::create_payment_session::CreatePaymentSessionError,
    > for CreatePaymentSessionFluentBuilder
{
    fn send(
        self,
...
impl CreatePaymentSessionFluentBuilder {
    /// Creates a new `CreatePaymentSessionFluentBuilder`.
    ...
    /// Access the CreatePaymentSession as a reference.
    pub fn as_input(&self) -> &crate::operation::create_payment_session::builders::CreatePaymentSessionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_payment_session::CreatePaymentSession::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_payment_session::CreatePaymentSession::orchestrate(&runtime_plugins, input).await
    }
