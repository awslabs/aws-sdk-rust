...
pub use crate::operation::delete_payment_session::_delete_payment_session_input::DeletePaymentSessionInputBuilder;

pub use crate::operation::delete_payment_session::_delete_payment_session_output::DeletePaymentSessionOutputBuilder;

impl crate::operation::delete_payment_session::builders::DeletePaymentSessionInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.delete_payment_session();
...
pub struct DeletePaymentSessionFluentBuilder {
    ...
    inner: crate::operation::delete_payment_session::builders::DeletePaymentSessionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::delete_payment_session::DeletePaymentSessionOutput,
        crate::operation::delete_payment_session::DeletePaymentSessionError,
    > for DeletePaymentSessionFluentBuilder
{
    fn send(
        self,
...
impl DeletePaymentSessionFluentBuilder {
    /// Creates a new `DeletePaymentSessionFluentBuilder`.
    ...
    /// Access the DeletePaymentSession as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_payment_session::builders::DeletePaymentSessionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_payment_session::DeletePaymentSession::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_payment_session::DeletePaymentSession::orchestrate(&runtime_plugins, input).await
    }
