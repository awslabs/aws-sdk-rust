...
impl ListSessions {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Bedrock AgentCore", "ListSessions", input, runtime_plugins, stop_point)
...
impl ListSessionsError {
    ...
    /// Returns `true` if the error kind is `ListSessionsError::InvalidInputException`.
    ...
    /// Returns `true` if the error kind is `ListSessionsError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListSessionsError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `ListSessionsError::ThrottledException`.
