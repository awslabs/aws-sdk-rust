...
pub use crate::operation::get_memory_record::_get_memory_record_input::GetMemoryRecordInputBuilder;

pub use crate::operation::get_memory_record::_get_memory_record_output::GetMemoryRecordOutputBuilder;

impl crate::operation::get_memory_record::builders::GetMemoryRecordInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::get_memory_record::GetMemoryRecordError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.get_memory_record();
...
pub struct GetMemoryRecordFluentBuilder {
    ...
    inner: crate::operation::get_memory_record::builders::GetMemoryRecordInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_memory_record::GetMemoryRecordOutput,
        crate::operation::get_memory_record::GetMemoryRecordError,
    > for GetMemoryRecordFluentBuilder
{
    fn send(
        self,
...
impl GetMemoryRecordFluentBuilder {
    /// Creates a new `GetMemoryRecordFluentBuilder`.
    ...
    /// Access the GetMemoryRecord as a reference.
    pub fn as_input(&self) -> &crate::operation::get_memory_record::builders::GetMemoryRecordInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_memory_record::GetMemoryRecord::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_memory_record::GetMemoryRecord::orchestrate(&runtime_plugins, input).await
    }
