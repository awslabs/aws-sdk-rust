...
impl GetMicrosoftTeamsChannelConfigurationFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_microsoft_teams_channel_configuration::builders::GetMicrosoftTeamsChannelConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_microsoft_teams_channel_configuration::GetMicrosoftTeamsChannelConfiguration::operation_runtime_plugins(
