...
impl UpdateMicrosoftTeamsChannelConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_microsoft_teams_channel_configuration::UpdateMicrosoftTeamsChannelConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
