...
impl UpdateAccountPreferencesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_account_preferences::UpdateAccountPreferencesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_account_preferences::UpdateAccountPreferencesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_account_preferences::UpdateAccountPreferencesOutput, crate::operation::update_account_preferences::UpdateAccountPreferencesError, Self> {
