...
impl super::Client {
    ...
    pub fn delete_slack_workspace_authorization(&self) -> crate::operation::delete_slack_workspace_authorization::builders::DeleteSlackWorkspaceAuthorizationFluentBuilder {
