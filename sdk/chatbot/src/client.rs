...
mod create_slack_channel_configuration;
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_chatbot::Error> {
...
mod delete_microsoft_teams_configured_team;

mod delete_microsoft_teams_user_identity;

mod delete_slack_channel_configuration;

mod delete_slack_user_identity;

mod delete_slack_workspace_authorization;

mod describe_chime_webhook_configurations;

mod describe_slack_channel_configurations;

mod describe_slack_user_identities;
...
mod list_microsoft_teams_configured_teams;
...
mod update_slack_channel_configuration;
