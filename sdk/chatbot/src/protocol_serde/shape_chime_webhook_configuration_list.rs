...
pub(crate) fn de_chime_webhook_configuration_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::ChimeWebhookConfiguration>>, ::aws_smithy_json::deserialize::error::DeserializeError>
