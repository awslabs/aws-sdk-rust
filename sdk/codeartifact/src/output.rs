...
pub struct GetPackageVersionAssetOutput {
    ...
    pub asset: smithy_http::byte_stream::ByteStream,
    /// <p>
...
pub mod get_package_version_asset_output {
    ...
    pub struct Builder {
        pub(crate) asset: std::option::Option<smithy_http::byte_stream::ByteStream>,
    ...
    impl Builder {
        /// <p> The binary file, or asset, that is downloaded.</p>
        pub fn asset(mut self, input: smithy_http::byte_stream::ByteStream) -> Self {
