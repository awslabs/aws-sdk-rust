...
pub struct RepositoryDescription  {
    ...
    #[doc(hidden)]pub upstreams: std::option::Option<std::vec::Vec<crate::model::UpstreamRepositoryInfo>>,
    /// <p> An array of external connections associated with the repository. </p>
    #[doc(hidden)]pub external_connections: std::option::Option<std::vec::Vec<crate::model::RepositoryExternalConnectionInfo>>,
}
...
pub struct RepositoryExternalConnectionInfo  {
    ...
    #[doc(hidden)]pub external_connection_name: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub package_format: std::option::Option<crate::model::PackageFormat>,
    /// <p> The status of the external connection of a repository. There is one valid value, <code>Available</code>. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ExternalConnectionStatus>,
}
...
pub struct PackageVersionError  {
    ...
    /// </ul>
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::PackageVersionErrorCode>,
...
pub struct PackageVersionSummary  {
    ...
    #[doc(hidden)]pub origin: std::option::Option<crate::model::PackageVersionOrigin>,
}
...
pub struct PackageVersionOrigin  {
    ...
    #[doc(hidden)]pub domain_entry_point: std::option::Option<crate::model::DomainEntryPoint>,
...
pub struct PackageDependency  {
    ...
    #[doc(hidden)]pub dependency_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub version_requirement: std::option::Option<std::string::String>,
}
...
pub struct AssetSummary  {
    ...
    #[doc(hidden)]pub size: std::option::Option<i64>,
    /// <p> The hashes of the asset. </p>
    #[doc(hidden)]pub hashes: std::option::Option<std::collections::HashMap<crate::model::HashAlgorithm, std::string::String>>,
}
impl AssetSummary {
    /// <p> The name of the asset. </p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct PackageSummary  {
    ...
    #[doc(hidden)]pub origin_configuration: std::option::Option<crate::model::PackageOriginConfiguration>,
}
impl PackageSummary {
    /// <p> The format of the package. </p>
...
pub struct DomainSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::DomainStatus>,
...
pub struct PackageVersionDescription  {
    ...
    #[doc(hidden)]pub home_page: std::option::Option<std::string::String>,
    /// <p> The repository for the source code in the package version, or the source code used to build it. </p>
    #[doc(hidden)]pub source_code_repository: std::option::Option<std::string::String>,
    /// <p> A timestamp that contains the date and time the package version was published. </p>
    #[doc(hidden)]pub published_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p> Information about licenses associated with the package version. </p>
    #[doc(hidden)]pub licenses: std::option::Option<std::vec::Vec<crate::model::LicenseInfo>>,
...
pub struct DomainDescription  {
    ...
    #[doc(hidden)]pub repository_count: i32,
    /// <p> The total size of all assets in the domain. </p>
    #[doc(hidden)]pub asset_size_bytes: i64,
