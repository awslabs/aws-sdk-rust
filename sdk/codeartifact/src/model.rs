...
pub struct PackageVersionDescription {
    ...
    /// </p>
    pub published_time: std::option::Option<smithy_types::Instant>,
    /// <p>
...
pub mod package_version_description {
    ...
    pub struct Builder {
        ...
        pub(crate) published_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// A timestamp that contains the date and time the package version was published.
        /// </p>
        pub fn published_time(mut self, input: smithy_types::Instant) -> Self {
