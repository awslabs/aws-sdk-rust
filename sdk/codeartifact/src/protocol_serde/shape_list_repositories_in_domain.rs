...
pub fn de_list_repositories_in_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_repositories_in_domain::ListRepositoriesInDomainOutput, crate::operation::list_repositories_in_domain::ListRepositoriesInDomainError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_repositories_in_domain::ListRepositoriesInDomainError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_repositories_in_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_repositories_in_domain::ListRepositoriesInDomainOutput, crate::operation::list_repositories_in_domain::ListRepositoriesInDomainError> {
    Ok({
        #[allow(unused_mut)]
