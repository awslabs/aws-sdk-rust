...
pub fn de_list_repositories_in_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRepositoriesInDomainOutput, crate::error::ListRepositoriesInDomainError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListRepositoriesInDomainError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_repositories_in_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRepositoriesInDomainOutput, crate::error::ListRepositoriesInDomainError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_repositories_in_domain(value: &[u8], mut builder: crate::output::list_repositories_in_domain_output::Builder) -> Result<crate::output::list_repositories_in_domain_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
