...
pub fn ser_update_package_versions_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePackageVersionsStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
