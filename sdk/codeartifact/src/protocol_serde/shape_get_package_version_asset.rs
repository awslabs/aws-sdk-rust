...
pub fn de_get_package_version_asset_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_package_version_asset_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::conflict_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?
                }
            ;
            tmp
        }),
