...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::describe_domain::builders::DescribeDomainFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_domain::builders::DescribeDomainFluentBuilder::set_domain): <p> A string that specifies the name of the requested domain. </p>
    ///   - [`domain_owner(impl ::std::convert::Into<String>)`](crate::operation::describe_domain::builders::DescribeDomainFluentBuilder::domain_owner) / [`set_domain_owner(Option<String>)`](crate::operation::describe_domain::builders::DescribeDomainFluentBuilder::set_domain_owner): <p> The 12-digit account number of the Amazon Web Services account that owns the domain. It does not include dashes or spaces. </p>
