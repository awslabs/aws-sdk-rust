...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::set_domain): <p> The name of the domain that is in scope for the generated authorization token. </p>
    ///   - [`domain_owner(impl ::std::convert::Into<String>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::domain_owner) / [`set_domain_owner(Option<String>)`](crate::operation::get_authorization_token::builders::GetAuthorizationTokenFluentBuilder::set_domain_owner): <p> The 12-digit account number of the Amazon Web Services account that owns the domain. It does not include dashes or spaces. </p>
