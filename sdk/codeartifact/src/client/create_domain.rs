...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::create_domain::builders::CreateDomainFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::create_domain::builders::CreateDomainFluentBuilder::set_domain): <p> The name of the domain to create. All domain names in an Amazon Web Services Region that are in the same Amazon Web Services account must be unique. The domain name is used as the prefix in DNS hostnames. Do not use sensitive information in a domain name because it is publicly discoverable. </p>
