...
impl DeletePackageVersionsInput {
    /// Consumes the builder and constructs an Operation<[`DeletePackageVersions`](crate::operation::delete_package_versions::DeletePackageVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_package_versions::DeletePackageVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_package_versions::DeletePackageVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/package/versions/delete").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_package_versions::DeletePackageVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_package_versions::ser_delete_package_versions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_package_versions::DeletePackageVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePackageVersions {
                type Output = std::result::Result<crate::operation::delete_package_versions::DeletePackageVersionsOutput, crate::operation::delete_package_versions::DeletePackageVersionsError>;
