...
impl UpdatePackageVersionsStatusInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_package_versions_status::UpdatePackageVersionsStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_package_versions_status::UpdatePackageVersionsStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/package/versions/update_status").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::update_package_versions_status::UpdatePackageVersionsStatusInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
