...
impl DisassociateExternalConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_external_connection::DisassociateExternalConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateExternalConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_external_connection::de_disassociate_external_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
