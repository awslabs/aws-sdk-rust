...
impl GetRepositoryPermissionsPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_repository_permissions_policy::GetRepositoryPermissionsPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_repository_permissions_policy::GetRepositoryPermissionsPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRepositoryPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_repository_permissions_policy::de_get_repository_permissions_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
