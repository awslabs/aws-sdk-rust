...
impl DeleteDomainPermissionsPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDomainPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_domain_permissions_policy::de_delete_domain_permissions_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
