...
impl DeleteDomainPermissionsPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDomainPermissionsPolicy`](crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/domain/permissions/policy").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.policy_revision {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDomainPermissionsPolicy {
                type Output = std::result::Result<crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyOutput, crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_domain_permissions_policy::DeleteDomainPermissionsPolicyError {
