...
impl GetPackageVersionAssetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_package_version_asset::GetPackageVersionAssetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError, Self> {
