...
/// Orchestration and serialization glue logic for `GetDomainPermissionsPolicy`.
...
impl GetDomainPermissionsPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput,
                    ) -> ::std::result::Result<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDomainPermissionsPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDomainPermissionsPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDomainPermissionsPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDomainPermissionsPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDomainPermissionsPolicy")
...
.with_interceptor(GetDomainPermissionsPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError>::new());
...
#[derive(Debug)]
            struct GetDomainPermissionsPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDomainPermissionsPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_domain_permissions_policy::de_get_domain_permissions_policy_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDomainPermissionsPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDomainPermissionsPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/domain/permissions/policy").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetDomainPermissionsPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDomainPermissionsPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDomainPermissionsPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDomainPermissionsPolicyInput>()
                        .ok_or("failed to downcast to GetDomainPermissionsPolicyInput")?;
...
pub enum GetDomainPermissionsPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDomainPermissionsPolicyError) for what information is available for the error.")]
...
impl GetDomainPermissionsPolicyError {
    /// Creates the `GetDomainPermissionsPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDomainPermissionsPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDomainPermissionsPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError {
...
mod _get_domain_permissions_policy_output;
