    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/domain/permissions/policy")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domain_permissions_policy::de_get_domain_permissions_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError
{
