...
impl GetDomainPermissionsPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domain_permissions_policy::de_get_domain_permissions_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
