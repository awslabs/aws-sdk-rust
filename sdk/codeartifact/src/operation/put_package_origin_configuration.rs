...
impl PutPackageOriginConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_package_origin_configuration::PutPackageOriginConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutPackageOriginConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_package_origin_configuration::de_put_package_origin_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
