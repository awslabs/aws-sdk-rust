...
impl GetPackageVersionReadmeInput {
    /// Consumes the builder and constructs an Operation<[`GetPackageVersionReadme`](crate::operation::get_package_version_readme::GetPackageVersionReadme)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_package_version_readme::GetPackageVersionReadme, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_package_version_readme::GetPackageVersionReadmeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/package/version/readme").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_package_version_readme::GetPackageVersionReadmeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_package_version_readme::GetPackageVersionReadme::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetPackageVersionReadme {
                type Output = std::result::Result<crate::operation::get_package_version_readme::GetPackageVersionReadmeOutput, crate::operation::get_package_version_readme::GetPackageVersionReadmeError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_package_version_readme::GetPackageVersionReadmeError {
