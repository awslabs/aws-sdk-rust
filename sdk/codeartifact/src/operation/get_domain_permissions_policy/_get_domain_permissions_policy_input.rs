...
impl GetDomainPermissionsPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
