...
impl GetDomainPermissionsPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyOutput, crate::operation::get_domain_permissions_policy::GetDomainPermissionsPolicyError, Self> {
