...
impl AssociateExternalConnectionInput {
    /// Consumes the builder and constructs an Operation<[`AssociateExternalConnection`](crate::operation::associate_external_connection::AssociateExternalConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_external_connection::AssociateExternalConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_external_connection::AssociateExternalConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/repository/external-connection").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::associate_external_connection::AssociateExternalConnectionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_external_connection::AssociateExternalConnection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateExternalConnection {
                type Output = std::result::Result<crate::operation::associate_external_connection::AssociateExternalConnectionOutput, crate::operation::associate_external_connection::AssociateExternalConnectionError>;
