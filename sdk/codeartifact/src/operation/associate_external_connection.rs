...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateExternalConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_external_connection::de_associate_external_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AssociateExternalConnectionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_external_connection::AssociateExternalConnectionError
{
