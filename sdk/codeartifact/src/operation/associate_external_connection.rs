...
impl AssociateExternalConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_external_connection::AssociateExternalConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateExternalConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_external_connection::de_associate_external_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
