...
impl PutRepositoryPermissionsPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_repository_permissions_policy::PutRepositoryPermissionsPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRepositoryPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_repository_permissions_policy::de_put_repository_permissions_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
