...
impl PublishPackageVersionInput {
    /// Consumes the builder and constructs an Operation<[`PublishPackageVersion`](crate::operation::publish_package_version::PublishPackageVersion)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::publish_package_version::PublishPackageVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_publish_package_version_input::ser_asset_content_http_payload( self.asset_content)?
            .into_inner()
        );
...
/// `ParseStrictResponse` impl for `PublishPackageVersion`.
...
impl aws_smithy_http::response::ParseStrictResponse for PublishPackageVersion {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_publish_package_version::de_publish_package_version_http_error(response)
                     } else {
                        crate::protocol_serde::shape_publish_package_version::de_publish_package_version_http_response(response)
                     }
                }
            }
