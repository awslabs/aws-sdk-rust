...
impl PublishPackageVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_publish_package_version_input::ser_asset_content_http_payload(self.asset_content)?.into_inner(),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishPackageVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_publish_package_version::de_publish_package_version_http_response_with_props(status, headers, body)
        }
    }
}
