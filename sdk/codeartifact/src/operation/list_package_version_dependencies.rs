...
impl ListPackageVersionDependenciesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_package_version_dependencies::ListPackageVersionDependencies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackageVersionDependencies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_package_version_dependencies::de_list_package_version_dependencies_http_response_with_props(
                status, headers, body,
            )
        }
    }
