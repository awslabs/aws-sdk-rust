...
impl PutDomainPermissionsPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_domain_permissions_policy::PutDomainPermissionsPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDomainPermissionsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_domain_permissions_policy::de_put_domain_permissions_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
