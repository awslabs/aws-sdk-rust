...
impl GetRepositoryEndpointInput {
    /// Consumes the builder and constructs an Operation<[`GetRepositoryEndpoint`](crate::operation::get_repository_endpoint::GetRepositoryEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_repository_endpoint::GetRepositoryEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_repository_endpoint::GetRepositoryEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/repository/endpoint").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_repository_endpoint::GetRepositoryEndpointInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_repository_endpoint::GetRepositoryEndpoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRepositoryEndpoint {
                type Output = std::result::Result<crate::operation::get_repository_endpoint::GetRepositoryEndpointOutput, crate::operation::get_repository_endpoint::GetRepositoryEndpointError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_repository_endpoint::GetRepositoryEndpointError {
