...
impl DisassociateExternalConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_external_connection::DisassociateExternalConnectionInput, ::aws_smithy_types::error::operation::BuildError> {
