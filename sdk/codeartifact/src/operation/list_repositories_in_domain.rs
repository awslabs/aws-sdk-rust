...
impl ListRepositoriesInDomainInput {
    /// Consumes the builder and constructs an Operation<[`ListRepositoriesInDomain`](crate::operation::list_repositories_in_domain::ListRepositoriesInDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_repositories_in_domain::ListRepositoriesInDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_repositories_in_domain::ListRepositoriesInDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/domain/repositories").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_repositories_in_domain::ListRepositoriesInDomainInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.administrator_account {
                     {
                        query.push_kv("administrator-account", &aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                if let Some(inner_4) = &_input.repository_prefix {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_repositories_in_domain::ListRepositoriesInDomain::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRepositoriesInDomain {
                type Output = std::result::Result<crate::operation::list_repositories_in_domain::ListRepositoriesInDomainOutput, crate::operation::list_repositories_in_domain::ListRepositoriesInDomainError>;
...
impl aws_http::request_id::RequestId for crate::operation::list_repositories_in_domain::ListRepositoriesInDomainError {
