    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp =
                        crate::operation::list_repositories_in_domain::ListRepositoriesInDomain::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListRepositoriesInDomainPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_repositories_in_domain_output_repositories(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
