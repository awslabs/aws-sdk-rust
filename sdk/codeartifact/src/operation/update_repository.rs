...
impl UpdateRepositoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_repository::UpdateRepository, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_repository::ser_update_repository_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_repository::de_update_repository_http_response_with_props(status, headers, body)
        }
    }
}
