...
impl UpdateRepositoryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRepository`](crate::operation::update_repository::UpdateRepository)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_repository::UpdateRepository, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_repository::UpdateRepositoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/repository").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::update_repository::UpdateRepositoryInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_repository::ser_update_repository_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_repository::UpdateRepository::new())
