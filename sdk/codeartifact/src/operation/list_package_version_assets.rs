...
impl ListPackageVersionAssetsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_package_version_assets::ListPackageVersionAssets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackageVersionAssets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_package_version_assets::de_list_package_version_assets_http_response_with_props(status, headers, body)
        }
    }
}
