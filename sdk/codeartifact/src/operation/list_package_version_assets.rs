...
impl ListPackageVersionAssetsInput {
    /// Consumes the builder and constructs an Operation<[`ListPackageVersionAssets`](crate::operation::list_package_version_assets::ListPackageVersionAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_package_version_assets::ListPackageVersionAssets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_package_version_assets::ListPackageVersionAssetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/package/version/assets").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_package_version_assets::ListPackageVersionAssetsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_package_version_assets::ListPackageVersionAssets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListPackageVersionAssets {
                type Output = std::result::Result<crate::operation::list_package_version_assets::ListPackageVersionAssetsOutput, crate::operation::list_package_version_assets::ListPackageVersionAssetsError>;
...
impl aws_http::request_id::RequestId for crate::operation::list_package_version_assets::ListPackageVersionAssetsError {
