...
impl GetPackageVersionAssetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_package_version_asset::GetPackageVersionAsset,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/package/version/asset")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_package_version_asset::GetPackageVersionAsset::new(),
        )
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetPackageVersionAsset {
    ...
    fn parse_unloaded(
        ...
        ::std::option::Option::Some(crate::protocol_serde::shape_get_package_version_asset::de_get_package_version_asset_op_response(response))
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_package_version_asset::GetPackageVersionAssetError
{
