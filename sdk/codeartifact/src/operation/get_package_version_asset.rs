...
impl GetPackageVersionAssetInput {
    /// Consumes the builder and constructs an Operation<[`GetPackageVersionAsset`](crate::operation::get_package_version_asset::GetPackageVersionAsset)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_package_version_asset::GetPackageVersionAsset, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_package_version_asset::GetPackageVersionAssetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/v1/package/version/asset").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_package_version_asset::GetPackageVersionAssetInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let inner_8 = inner_8.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("asset", "cannot be empty or unset"))?;
                if inner_8.is_empty() {
                ...
                if let Some(inner_9) = &_input.package_version_revision {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_package_version_asset::GetPackageVersionAsset::new())
...
impl aws_smithy_http::response::ParseHttpResponse for GetPackageVersionAsset {
                type Output = std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    ...
                    Some(crate::protocol_serde::shape_get_package_version_asset::de_get_package_version_asset_http_response_(response))
                }
                fn parse_loaded(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_package_version_asset::de_get_package_version_asset_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_package_version_asset::GetPackageVersionAssetError {
...
pub use crate::operation::get_package_version_asset::_get_package_version_asset_input::GetPackageVersionAssetInput;

mod _get_package_version_asset_input;

mod _get_package_version_asset_output;
