...
impl DisposePackageVersionsInput {
    /// Consumes the builder and constructs an Operation<[`DisposePackageVersions`](crate::operation::dispose_package_versions::DisposePackageVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::dispose_package_versions::DisposePackageVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::dispose_package_versions::DisposePackageVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/package/versions/dispose").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::dispose_package_versions::DisposePackageVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_dispose_package_versions::ser_dispose_package_versions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::dispose_package_versions::DisposePackageVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisposePackageVersions {
                type Output = std::result::Result<crate::operation::dispose_package_versions::DisposePackageVersionsOutput, crate::operation::dispose_package_versions::DisposePackageVersionsError>;
...
impl aws_http::request_id::RequestId for crate::operation::dispose_package_versions::DisposePackageVersionsError {
