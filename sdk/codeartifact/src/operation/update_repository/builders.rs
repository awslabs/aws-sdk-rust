...
impl UpdateRepositoryFluentBuilder  {
    /// Creates a new `UpdateRepository`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_repository::UpdateRepository, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_repository::UpdateRepositoryError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_repository::UpdateRepositoryOutput, aws_smithy_http::result::SdkError<crate::operation::update_repository::UpdateRepositoryError>>
                     {
