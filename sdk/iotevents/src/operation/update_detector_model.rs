...
impl UpdateDetectorModelInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_detector_model::ser_update_detector_model_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_detector_model::UpdateDetectorModel::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_detector_model::UpdateDetectorModelError
{
