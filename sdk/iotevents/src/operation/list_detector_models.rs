...
impl ListDetectorModelsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_detector_models::ListDetectorModels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDetectorModels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_detector_models::de_list_detector_models_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_detector_models::de_list_detector_models_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_detector_models::ListDetectorModelsError
{
