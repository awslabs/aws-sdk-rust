...
impl PutLoggingOptions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_logging_options::PutLoggingOptionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_logging_options::PutLoggingOptionsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoT Events", "PutLoggingOptions", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "IoT Events.PutLoggingOptions",
                "rpc.service" = "IoT Events",
                "rpc.method" = "PutLoggingOptions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutLoggingOptions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutLoggingOptionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutLoggingOptionsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutLoggingOptions")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutLoggingOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_logging_options::PutLoggingOptionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_logging_options::PutLoggingOptionsInput,
