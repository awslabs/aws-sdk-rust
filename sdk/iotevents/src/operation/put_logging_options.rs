...
impl PutLoggingOptionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_logging_options::ser_put_logging_options_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutLoggingOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_logging_options::de_put_logging_options_http_response_with_props(status, headers, body)
        }
    }
}
