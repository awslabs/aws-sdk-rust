...
impl UpdateAlarmModelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_alarm_model::ser_update_alarm_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAlarmModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_alarm_model::de_update_alarm_model_http_response_with_props(status, headers, body)
        }
    }
}
