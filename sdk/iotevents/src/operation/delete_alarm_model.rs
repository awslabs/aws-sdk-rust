...
impl DeleteAlarmModelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_alarm_model::DeleteAlarmModel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlarmModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_alarm_model::de_delete_alarm_model_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_alarm_model::DeleteAlarmModelError
{
