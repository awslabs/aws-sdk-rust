...
impl DeleteAlarmModel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_alarm_model::DeleteAlarmModelInput,
                    ) -> ::std::result::Result<crate::operation::delete_alarm_model::DeleteAlarmModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_alarm_model::DeleteAlarmModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_alarm_model::DeleteAlarmModelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_alarm_model::DeleteAlarmModelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAlarmModel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAlarmModel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAlarmModelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAlarmModelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAlarmModel")
...
.with_interceptor(DeleteAlarmModelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_alarm_model::DeleteAlarmModelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_alarm_model::DeleteAlarmModelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_alarm_model::DeleteAlarmModelError>::new());
...
#[derive(Debug)]
            struct DeleteAlarmModelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAlarmModelResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_alarm_model::de_delete_alarm_model_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_alarm_model::de_delete_alarm_model_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteAlarmModelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAlarmModelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_alarm_model::DeleteAlarmModelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_alarm_model::DeleteAlarmModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteAlarmModelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAlarmModelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAlarmModelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAlarmModelInput>()
                        .ok_or("failed to downcast to DeleteAlarmModelInput")?;
...
pub enum DeleteAlarmModelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAlarmModelError) for what information is available for the error.")]
...
impl DeleteAlarmModelError {
    /// Creates the `DeleteAlarmModelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAlarmModelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAlarmModelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_alarm_model::DeleteAlarmModelError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_alarm_model::_delete_alarm_model_output::DeleteAlarmModelOutput;

pub use crate::operation::delete_alarm_model::_delete_alarm_model_input::DeleteAlarmModelInput;

mod _delete_alarm_model_input;

mod _delete_alarm_model_output;
