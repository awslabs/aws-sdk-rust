...
/// Orchestration and serialization glue logic for `DescribeAlarmModel`.
...
impl DescribeAlarmModel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_alarm_model::DescribeAlarmModelInput,
                    ) -> ::std::result::Result<crate::operation::describe_alarm_model::DescribeAlarmModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_alarm_model::DescribeAlarmModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_alarm_model::DescribeAlarmModelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_alarm_model::DescribeAlarmModelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAlarmModel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAlarmModel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAlarmModelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAlarmModelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAlarmModel")
...
.with_interceptor(DescribeAlarmModelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_alarm_model::DescribeAlarmModelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_alarm_model::DescribeAlarmModelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_alarm_model::DescribeAlarmModelError>::new());
...
#[derive(Debug)]
            struct DescribeAlarmModelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAlarmModelResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_alarm_model::de_describe_alarm_model_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeAlarmModelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAlarmModelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_alarm_model::DescribeAlarmModelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_alarm_model::DescribeAlarmModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.alarm_model_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("alarm_model_name", "cannot be empty or unset"))?;
    ...
    if alarm_model_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("alarm_model_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/alarm-models/{alarmModelName}", alarmModelName = alarm_model_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::describe_alarm_model::DescribeAlarmModelInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.alarm_model_version {
         {
...
#[derive(Debug)]
            struct DescribeAlarmModelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAlarmModelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAlarmModelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAlarmModelInput>()
                        .ok_or("failed to downcast to DescribeAlarmModelInput")?;
...
pub enum DescribeAlarmModelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAlarmModelError) for what information is available for the error.")]
...
impl DescribeAlarmModelError {
    /// Creates the `DescribeAlarmModelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAlarmModelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAlarmModelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_alarm_model::DescribeAlarmModelError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_alarm_model::_describe_alarm_model_output::DescribeAlarmModelOutput;

pub use crate::operation::describe_alarm_model::_describe_alarm_model_input::DescribeAlarmModelInput;

mod _describe_alarm_model_input;

mod _describe_alarm_model_output;
