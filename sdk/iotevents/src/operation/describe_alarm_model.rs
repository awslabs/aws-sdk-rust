...
impl DescribeAlarmModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_alarm_model::DescribeAlarmModel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAlarmModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_alarm_model::de_describe_alarm_model_http_response_with_props(status, headers, body)
        }
    }
}
