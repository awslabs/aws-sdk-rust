...
impl DescribeAlarmModelInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAlarmModel`](crate::operation::describe_alarm_model::DescribeAlarmModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_alarm_model::DescribeAlarmModel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_alarm_model::DescribeAlarmModelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_alarm_model::DescribeAlarmModelInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.alarm_model_version {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_alarm_model::DescribeAlarmModel::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAlarmModel {
                type Output = std::result::Result<crate::operation::describe_alarm_model::DescribeAlarmModelOutput, crate::operation::describe_alarm_model::DescribeAlarmModelError>;
