...
impl DescribeAlarmModelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_alarm_model::DescribeAlarmModel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAlarmModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_alarm_model::de_describe_alarm_model_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_alarm_model::DescribeAlarmModelError
{
