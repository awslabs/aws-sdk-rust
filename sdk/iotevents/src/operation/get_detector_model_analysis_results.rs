...
impl GetDetectorModelAnalysisResults {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDetectorModelAnalysisResultsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDetectorModelAnalysisResultsRequestSerializer {
