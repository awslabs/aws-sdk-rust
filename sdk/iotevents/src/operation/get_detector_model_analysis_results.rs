...
impl GetDetectorModelAnalysisResultsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResults,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDetectorModelAnalysisResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_detector_model_analysis_results::de_get_detector_model_analysis_results_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError
{
