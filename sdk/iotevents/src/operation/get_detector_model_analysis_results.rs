...
/// Orchestration and serialization glue logic for `GetDetectorModelAnalysisResults`.
...
impl GetDetectorModelAnalysisResults {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput,
                    ) -> ::std::result::Result<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDetectorModelAnalysisResults {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDetectorModelAnalysisResults");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDetectorModelAnalysisResultsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDetectorModelAnalysisResultsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDetectorModelAnalysisResults")
...
.with_interceptor(GetDetectorModelAnalysisResultsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError>::new());
...
#[derive(Debug)]
            struct GetDetectorModelAnalysisResultsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDetectorModelAnalysisResultsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_detector_model_analysis_results::de_get_detector_model_analysis_results_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_detector_model_analysis_results::de_get_detector_model_analysis_results_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDetectorModelAnalysisResultsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDetectorModelAnalysisResultsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.analysis_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("analysis_id", "cannot be empty or unset"))?;
    let analysis_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    ...
    ::std::write!(output, "/analysis/detector-models/{analysisId}/results", analysisId = analysis_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetDetectorModelAnalysisResultsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDetectorModelAnalysisResultsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDetectorModelAnalysisResultsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDetectorModelAnalysisResultsInput>()
                        .ok_or("failed to downcast to GetDetectorModelAnalysisResultsInput")?;
...
pub enum GetDetectorModelAnalysisResultsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDetectorModelAnalysisResultsError) for what information is available for the error.")]
...
impl GetDetectorModelAnalysisResultsError {
    /// Creates the `GetDetectorModelAnalysisResultsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDetectorModelAnalysisResultsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDetectorModelAnalysisResultsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError {
...
mod _get_detector_model_analysis_results_output;
