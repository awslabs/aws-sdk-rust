...
impl GetDetectorModelAnalysisResultsInput {
    /// Consumes the builder and constructs an Operation<[`GetDetectorModelAnalysisResults`](crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResults)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResults, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.analysis_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("analysis_id", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResults::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDetectorModelAnalysisResults {
                type Output = std::result::Result<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput, crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError>;
