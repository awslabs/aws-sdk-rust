...
impl GetDetectorModelAnalysisResultsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResults::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDetectorModelAnalysisResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_detector_model_analysis_results::de_get_detector_model_analysis_results_http_response_with_props(
                status, headers, body,
            )
        }
    }
