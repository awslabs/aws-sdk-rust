...
/// Orchestration and serialization glue logic for `StartDetectorModelAnalysis`.
...
impl StartDetectorModelAnalysis {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDetectorModelAnalysis {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartDetectorModelAnalysis");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartDetectorModelAnalysisRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartDetectorModelAnalysisResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDetectorModelAnalysis")
...
.with_interceptor(StartDetectorModelAnalysisEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError>::new());
...
#[derive(Debug)]
            struct StartDetectorModelAnalysisResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDetectorModelAnalysisResponseDeserializer {
...
#[derive(Debug)]
            struct StartDetectorModelAnalysisRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDetectorModelAnalysisRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/analysis/detector-models").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_detector_model_analysis::ser_start_detector_model_analysis_input(&input)?);
...
#[derive(Debug)]
            struct StartDetectorModelAnalysisEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDetectorModelAnalysisEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartDetectorModelAnalysisEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartDetectorModelAnalysisInput>()
                        .ok_or("failed to downcast to StartDetectorModelAnalysisInput")?;
...
pub enum StartDetectorModelAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartDetectorModelAnalysisError) for what information is available for the error.")]
...
impl StartDetectorModelAnalysisError {
    /// Creates the `StartDetectorModelAnalysisError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartDetectorModelAnalysisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartDetectorModelAnalysisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisError {
...
mod _start_detector_model_analysis_output;
