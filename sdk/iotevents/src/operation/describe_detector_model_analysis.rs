...
impl DescribeDetectorModelAnalysisInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDetectorModelAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_detector_model_analysis::de_describe_detector_model_analysis_http_response_with_props(
                status, headers, body,
            )
        }
    }
