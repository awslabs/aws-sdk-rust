...
impl GetDetectorModelAnalysisResultsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsOutput, crate::operation::get_detector_model_analysis_results::GetDetectorModelAnalysisResultsError, Self> {
