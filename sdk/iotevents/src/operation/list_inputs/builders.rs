...
impl ListInputsFluentBuilder  {
    /// Creates a new `ListInputs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_inputs::ListInputsOutput, aws_smithy_http::result::SdkError<crate::operation::list_inputs::ListInputsError>>
                     {
