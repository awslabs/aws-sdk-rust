...
impl ListDetectorModelVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_detector_model_versions::ListDetectorModelVersions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDetectorModelVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_detector_model_versions::de_list_detector_model_versions_http_response_with_props(status, headers, body)
        }
    }
}
