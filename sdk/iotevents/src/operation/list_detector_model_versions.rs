...
/// Orchestration and serialization glue logic for `ListDetectorModelVersions`.
...
impl ListDetectorModelVersions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_detector_model_versions::ListDetectorModelVersionsInput,
                    ) -> ::std::result::Result<crate::operation::list_detector_model_versions::ListDetectorModelVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_detector_model_versions::ListDetectorModelVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDetectorModelVersions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDetectorModelVersions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDetectorModelVersionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDetectorModelVersionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDetectorModelVersions")
...
.with_interceptor(ListDetectorModelVersionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsError>::new());
...
#[derive(Debug)]
            struct ListDetectorModelVersionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDetectorModelVersionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_detector_model_versions::de_list_detector_model_versions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_detector_model_versions::de_list_detector_model_versions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDetectorModelVersionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDetectorModelVersionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_detector_model_versions::ListDetectorModelVersionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_detector_model_versions::ListDetectorModelVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/detector-models/{detectorModelName}/versions", detectorModelName = detector_model_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_detector_model_versions::ListDetectorModelVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListDetectorModelVersionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDetectorModelVersionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDetectorModelVersionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDetectorModelVersionsInput>()
                        .ok_or("failed to downcast to ListDetectorModelVersionsInput")?;
...
pub enum ListDetectorModelVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDetectorModelVersionsError) for what information is available for the error.")]
...
impl ListDetectorModelVersionsError {
    /// Creates the `ListDetectorModelVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDetectorModelVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDetectorModelVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_detector_model_versions::ListDetectorModelVersionsError {
...
mod _list_detector_model_versions_output;
