...
impl DescribeDetectorModelInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDetectorModel`](crate::operation::describe_detector_model::DescribeDetectorModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_detector_model::DescribeDetectorModel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_detector_model::DescribeDetectorModelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.detector_model_name;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("detector_model_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::describe_detector_model::DescribeDetectorModelInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.detector_model_version {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_detector_model::DescribeDetectorModel::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDetectorModel {
                type Output = std::result::Result<crate::operation::describe_detector_model::DescribeDetectorModelOutput, crate::operation::describe_detector_model::DescribeDetectorModelError>;
