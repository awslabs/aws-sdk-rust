...
impl DescribeDetectorModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_detector_model::DescribeDetectorModel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDetectorModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_detector_model::de_describe_detector_model_http_response_with_props(status, headers, body)
        }
    }
}
