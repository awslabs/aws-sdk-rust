...
impl CreateDetectorModelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_detector_model::ser_create_detector_model_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_detector_model::CreateDetectorModel::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_detector_model::CreateDetectorModelError
{
