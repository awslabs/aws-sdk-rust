...
impl CreateDetectorModel {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_detector_model::CreateDetectorModelError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_detector_model::CreateDetectorModelOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoT Events", "CreateDetectorModel", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "IoT Events.CreateDetectorModel",
                "rpc.service" = "IoT Events",
                "rpc.method" = "CreateDetectorModel",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDetectorModel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateDetectorModelRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateDetectorModelResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDetectorModel")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDetectorModelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_detector_model::CreateDetectorModelInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_detector_model::CreateDetectorModelInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_detector_model::ser_create_detector_model_input(
            &input,
        )?);
