...
impl ListAlarmModelVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListAlarmModelVersions`](crate::operation::list_alarm_model_versions::ListAlarmModelVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_alarm_model_versions::ListAlarmModelVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_alarm_model_versions::ListAlarmModelVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_alarm_model_versions::ListAlarmModelVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_alarm_model_versions::ListAlarmModelVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAlarmModelVersions {
                type Output = std::result::Result<crate::operation::list_alarm_model_versions::ListAlarmModelVersionsOutput, crate::operation::list_alarm_model_versions::ListAlarmModelVersionsError>;
