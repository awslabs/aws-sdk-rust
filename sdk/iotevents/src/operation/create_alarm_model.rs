...
impl CreateAlarmModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_alarm_model::CreateAlarmModel,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_alarm_model::ser_create_alarm_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAlarmModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_alarm_model::de_create_alarm_model_http_response_with_props(status, headers, body)
        }
    }
}
