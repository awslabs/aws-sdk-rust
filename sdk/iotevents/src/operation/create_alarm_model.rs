...
impl CreateAlarmModel {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_alarm_model::CreateAlarmModelError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_alarm_model::CreateAlarmModelOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoT Events", "CreateAlarmModel", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "IoT Events.CreateAlarmModel",
                "rpc.service" = "IoT Events",
                "rpc.method" = "CreateAlarmModel",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAlarmModel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateAlarmModelRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateAlarmModelResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateAlarmModel")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAlarmModelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_alarm_model::CreateAlarmModelInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_alarm_model::CreateAlarmModelInput,
