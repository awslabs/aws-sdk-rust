...
/// Orchestration and serialization glue logic for `DeleteDetectorModel`.
...
impl DeleteDetectorModel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_detector_model::DeleteDetectorModelInput,
                    ) -> ::std::result::Result<crate::operation::delete_detector_model::DeleteDetectorModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_detector_model::DeleteDetectorModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_detector_model::DeleteDetectorModelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_detector_model::DeleteDetectorModelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDetectorModel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDetectorModel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDetectorModelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDetectorModelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDetectorModel")
...
.with_interceptor(DeleteDetectorModelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_detector_model::DeleteDetectorModelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_detector_model::DeleteDetectorModelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_detector_model::DeleteDetectorModelError>::new());
...
#[derive(Debug)]
            struct DeleteDetectorModelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDetectorModelResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_detector_model::de_delete_detector_model_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_detector_model::de_delete_detector_model_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteDetectorModelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDetectorModelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_detector_model::DeleteDetectorModelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_detector_model::DeleteDetectorModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteDetectorModelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDetectorModelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDetectorModelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDetectorModelInput>()
                        .ok_or("failed to downcast to DeleteDetectorModelInput")?;
...
pub enum DeleteDetectorModelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDetectorModelError) for what information is available for the error.")]
...
impl DeleteDetectorModelError {
    /// Creates the `DeleteDetectorModelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDetectorModelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDetectorModelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_detector_model::DeleteDetectorModelError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_detector_model::_delete_detector_model_output::DeleteDetectorModelOutput;

pub use crate::operation::delete_detector_model::_delete_detector_model_input::DeleteDetectorModelInput;

mod _delete_detector_model_input;

mod _delete_detector_model_output;
