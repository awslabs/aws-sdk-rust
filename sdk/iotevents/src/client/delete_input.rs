...
impl super::Client {
    ...
    ///   - [`input_name(impl Into<String>)`](crate::operation::delete_input::builders::DeleteInputFluentBuilder::input_name) / [`set_input_name(Option<String>)`](crate::operation::delete_input::builders::DeleteInputFluentBuilder::set_input_name):<br>required: **true**<br><p>The name of the input to delete.</p><br>
