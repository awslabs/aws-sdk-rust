...
impl super::Client {
    ...
    pub fn delete_detector_model(
        &self,
    ) -> crate::operation::delete_detector_model::builders::DeleteDetectorModelFluentBuilder {
        crate::operation::delete_detector_model::builders::DeleteDetectorModelFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
