...
impl super::Client  {
    ...
    ///   - [`logging_options(LoggingOptions)`](crate::operation::put_logging_options::builders::PutLoggingOptionsFluentBuilder::logging_options) / [`set_logging_options(Option<LoggingOptions>)`](crate::operation::put_logging_options::builders::PutLoggingOptionsFluentBuilder::set_logging_options): <p>The new values of the AWS IoT Events logging options.</p>
