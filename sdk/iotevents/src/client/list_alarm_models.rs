...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_alarm_models::builders::ListAlarmModelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_alarm_models::builders::ListAlarmModelsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token that you can use to return the next set of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_alarm_models::builders::ListAlarmModelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_alarm_models::builders::ListAlarmModelsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to be returned per request.</p><br>
