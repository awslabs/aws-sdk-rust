...
pub fn serialize_operation_crate_operation_create_alarm_model(
...
pub fn serialize_operation_crate_operation_create_detector_model(
    input: &crate::input::CreateDetectorModelInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_types::Error> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_create_detector_model_input(
        &mut object,
        input,
    );
    object.finish();
...
pub fn serialize_operation_crate_operation_list_input_routings(
...
pub fn serialize_operation_crate_operation_start_detector_model_analysis(
    input: &crate::input::StartDetectorModelAnalysisInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_types::Error> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_start_detector_model_analysis_input(
        &mut object,
        input,
    );
    object.finish();
...
pub fn serialize_operation_crate_operation_update_alarm_model(
...
pub fn serialize_operation_crate_operation_update_detector_model(
    input: &crate::input::UpdateDetectorModelInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_types::Error> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_update_detector_model_input(
        &mut object,
        input,
    );
    object.finish();
