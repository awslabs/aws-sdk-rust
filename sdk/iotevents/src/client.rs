...
impl Client {
    ...
    pub fn describe_detector_model_analysis(
        &self,
    ) -> crate::client::fluent_builders::DescribeDetectorModelAnalysis {
    ...
    pub fn list_alarm_model_versions(
        &self,
    ) -> crate::client::fluent_builders::ListAlarmModelVersions {
    ...
    pub fn start_detector_model_analysis(
        &self,
    ) -> crate::client::fluent_builders::StartDetectorModelAnalysis {
