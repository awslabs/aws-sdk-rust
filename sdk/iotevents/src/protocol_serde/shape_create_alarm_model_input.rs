...
pub fn ser_create_alarm_model_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAlarmModelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
