...
pub(crate) fn de_logging_options<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::LoggingOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "detectorDebugOptions" => {
                            builder = builder.set_detector_debug_options(
                                crate::protocol_serde::shape_detector_debug_options::de_detector_debug_options(tokens, _value)?,
                            );
                        }
