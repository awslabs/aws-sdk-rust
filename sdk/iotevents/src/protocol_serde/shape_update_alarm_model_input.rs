...
pub fn ser_update_alarm_model_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAlarmModelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
