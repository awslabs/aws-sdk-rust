...
pub(crate) fn de_detector_model_version_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DetectorModelVersionSummary>, aws_smithy_json::deserialize::error::DeserializeError>
