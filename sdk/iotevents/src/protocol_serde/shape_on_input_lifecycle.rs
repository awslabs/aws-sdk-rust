...
pub fn ser_on_input_lifecycle(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OnInputLifecycle) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_on_input_lifecycle<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::OnInputLifecycle>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::OnInputLifecycleBuilder::default();
            loop {
                match tokens.next().transpose()? {
