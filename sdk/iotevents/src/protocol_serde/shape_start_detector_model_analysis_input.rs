...
pub fn ser_start_detector_model_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartDetectorModelAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
