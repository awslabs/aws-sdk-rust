...
pub fn ser_iot_site_wise_input_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IotSiteWiseInputIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
