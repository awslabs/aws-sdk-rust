...
pub fn de_describe_detector_model_analysis_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisOutput, crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_detector_model_analysis_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisOutput, crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError> {
    Ok({
        #[allow(unused_mut)]
