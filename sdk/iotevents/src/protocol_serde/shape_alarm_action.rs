...
pub fn ser_alarm_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AlarmAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_alarm_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AlarmAction>, aws_smithy_json::deserialize::error::DeserializeError>
