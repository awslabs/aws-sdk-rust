...
pub fn ser_alarm_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AlarmAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
