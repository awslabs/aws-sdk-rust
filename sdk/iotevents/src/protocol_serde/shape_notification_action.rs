...
pub fn ser_notification_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NotificationAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_notification_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NotificationAction>, aws_smithy_json::deserialize::error::DeserializeError>
