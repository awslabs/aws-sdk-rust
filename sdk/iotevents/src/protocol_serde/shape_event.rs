...
pub(crate) fn de_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Event>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "actions" => {
                                builder = builder.set_actions(
                                    crate::protocol_serde::shape_actions::de_actions(tokens)?
                                );
                            }
