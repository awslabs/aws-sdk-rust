...
pub fn ser_update_detector_model_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDetectorModelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
