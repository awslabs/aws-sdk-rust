...
//! offered by AWS IoT Events. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Events.
...
/// For example, the [`CreateAlarmModel`](crate::operation::create_alarm_model) operation has
/// a [`Client::create_alarm_model`], function which returns a builder for that operation.
...
/// Configuration for AWS IoT Events.
pub mod config;
