...
impl super::Client {
    ...
    ///   - [`policy_version(Option<PolicyVersion>)`](crate::operation::get_policy_version::GetPolicyVersionOutput::policy_version): <p>A <code>PolicyVersion</code> object. Contains details for the version of the policy. Policies define the permissions for team resources.</p>
