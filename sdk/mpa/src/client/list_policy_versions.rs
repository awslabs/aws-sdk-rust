...
impl super::Client {
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::list_policy_versions::ListPolicyVersionsOutput::next_token): <p>If present, indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a next call to the operation to get more output. You can repeat this until the <code>NextToken</code> response element returns <code>null</code>.</p>
    ///   - [`policy_versions(Option<Vec::<PolicyVersionSummary>>)`](crate::operation::list_policy_versions::ListPolicyVersionsOutput::policy_versions): <p>An array of <code>PolicyVersionSummary</code> objects. Contains details for the version of the policies that define the permissions for team resources.</p>
