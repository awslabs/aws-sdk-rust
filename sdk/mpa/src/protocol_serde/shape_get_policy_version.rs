...
pub fn de_get_policy_version_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_policy_version::GetPolicyVersionError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::get_policy_version::GetPolicyVersionError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_policy_version::GetPolicyVersionError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_get_policy_version_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_policy_version_output_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "PolicyVersion" => {
                    builder = builder.set_policy_version(crate::protocol_serde::shape_policy_version::de_policy_version(tokens, _value, depth + 1)?);
                }
