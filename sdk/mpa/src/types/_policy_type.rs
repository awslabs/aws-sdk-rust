...
impl ::std::convert::From<&str> for PolicyType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_MANAGED" => PolicyType::AwsManaged,
            "AWS_RAM" => PolicyType::AwsRam,
...
impl ::std::str::FromStr for PolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyType::from(s))
    }
}
impl PolicyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PolicyType::AwsManaged => "AWS_MANAGED",
            PolicyType::AwsRam => "AWS_RAM",
