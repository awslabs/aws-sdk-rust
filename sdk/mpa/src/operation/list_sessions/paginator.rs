...
/// Paginator for [`ListSessions`](crate::operation::list_sessions::ListSessions)
pub struct ListSessionsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_sessions::builders::ListSessionsInputBuilder,
...
impl ListSessionsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_sessions::paginator::ListSessionsPaginatorItems {
        crate::operation::list_sessions::paginator::ListSessionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_sessions::ListSessions::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_sessions_output_output_next_token(resp);
...
/// Flattened paginator for `ListSessionsPaginator`
///
/// This is created with [`.items()`](ListSessionsPaginator::items)
pub struct ListSessionsPaginatorItems(ListSessionsPaginator);

impl ListSessionsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_sessions_output_output_sessions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
