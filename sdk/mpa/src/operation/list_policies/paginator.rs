...
impl ListPoliciesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_policies::paginator::ListPoliciesPaginatorItems {
        crate::operation::list_policies::paginator::ListPoliciesPaginatorItems(self)
    }
...
impl ListPoliciesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_policies_output_output_policies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
