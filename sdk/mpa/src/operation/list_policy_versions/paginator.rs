...
impl ListPolicyVersionsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `policy_versions`. Queries to the underlying service
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_policy_versions_output_output_next_token(resp);
...
impl ListPolicyVersionsPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            crate::types::PolicyVersionSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                crate::operation::list_policy_versions::ListPolicyVersionsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_policy_versions_output_output_policy_versions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
