...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_mpa::Error> {
/// # let client: aws_sdk_mpa::Client = unimplemented!();
...
mod delete_inactive_approval_team_version;

mod get_approval_team;
