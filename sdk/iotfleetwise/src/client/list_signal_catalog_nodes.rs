...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::set_name):<br>required: **true**<br><p>The name of the signal catalog to list information about.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::set_next_token):<br>required: **false**<br><p>A pagination token for the next set of results.</p> <p>If the results of a search are large, only a portion of the results are returned, and a <code>nextToken</code> pagination token is returned in the response. To retrieve the next set of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return, between 1 and 100, inclusive.</p><br>
    ///   - [`signal_node_type(SignalNodeType)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::signal_node_type) / [`set_signal_node_type(Option<SignalNodeType>)`](crate::operation::list_signal_catalog_nodes::builders::ListSignalCatalogNodesFluentBuilder::set_signal_node_type):<br>required: **false**<br><p>The type of node in the signal catalog.</p><br>
