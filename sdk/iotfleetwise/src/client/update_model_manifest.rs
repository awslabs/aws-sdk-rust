...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::set_name):<br>required: **true**<br><p> The name of the vehicle model to update. </p><br>
