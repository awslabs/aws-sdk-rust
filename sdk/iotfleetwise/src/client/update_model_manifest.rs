...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::set_name): <p> The name of the vehicle model to update. </p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_model_manifest::builders::UpdateModelManifestFluentBuilder::set_description): <p> A brief description of the vehicle model. </p>
