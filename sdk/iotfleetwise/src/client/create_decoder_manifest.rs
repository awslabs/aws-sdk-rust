...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_decoder_manifest::builders::CreateDecoderManifestFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_decoder_manifest::builders::CreateDecoderManifestFluentBuilder::set_name):<br>required: **true**<br><p> The unique name of the decoder manifest to create.</p><br>
    ...
    ///   - [`model_manifest_arn(impl Into<String>)`](crate::operation::create_decoder_manifest::builders::CreateDecoderManifestFluentBuilder::model_manifest_arn) / [`set_model_manifest_arn(impl Into<String>)`](crate::operation::create_decoder_manifest::builders::CreateDecoderManifestFluentBuilder::set_model_manifest_arn):<br>required: **true**<br><p> The Amazon Resource Name (ARN) of the vehicle model (model manifest). </p><br>
