...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_signal_catalog::builders::DeleteSignalCatalogFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_signal_catalog::builders::DeleteSignalCatalogFluentBuilder::set_name):<br>required: **true**<br><p>The name of the signal catalog to delete.</p><br>
