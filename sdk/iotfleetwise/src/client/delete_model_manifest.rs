...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_model_manifest::builders::DeleteModelManifestFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_model_manifest::builders::DeleteModelManifestFluentBuilder::set_name):<br>required: **true**<br><p> The name of the model manifest to delete. </p><br>
