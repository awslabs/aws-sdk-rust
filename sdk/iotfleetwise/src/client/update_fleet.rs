...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::fleet_id) / [`set_fleet_id(impl Into<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::set_fleet_id):<br>required: **true**<br><p> The ID of the fleet to update. </p><br>
