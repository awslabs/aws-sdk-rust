...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl ::std::convert::Into<String>)`](crate::operation::delete_vehicle::builders::DeleteVehicleFluentBuilder::vehicle_name) / [`set_vehicle_name(Option<String>)`](crate::operation::delete_vehicle::builders::DeleteVehicleFluentBuilder::set_vehicle_name): <p>The ID of the vehicle to delete. </p>
