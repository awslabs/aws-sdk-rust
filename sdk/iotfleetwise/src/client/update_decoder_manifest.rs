...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_decoder_manifest::builders::UpdateDecoderManifestFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_decoder_manifest::builders::UpdateDecoderManifestFluentBuilder::set_name): <p> The name of the decoder manifest to update.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_decoder_manifest::builders::UpdateDecoderManifestFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_decoder_manifest::builders::UpdateDecoderManifestFluentBuilder::set_description): <p> A brief description of the decoder manifest to update. </p>
