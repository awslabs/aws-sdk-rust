...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_signal_catalog::builders::CreateSignalCatalogFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_signal_catalog::builders::CreateSignalCatalogFluentBuilder::set_name):<br>required: **true**<br><p> The name of the signal catalog to create. </p><br>
