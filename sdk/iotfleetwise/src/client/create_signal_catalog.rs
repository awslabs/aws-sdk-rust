...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_signal_catalog::builders::CreateSignalCatalogFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_signal_catalog::builders::CreateSignalCatalogFluentBuilder::set_tags): <p>Metadata that can be used to manage the signal catalog.</p>
