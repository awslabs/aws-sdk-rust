...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_campaign::builders::GetCampaignFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_campaign::builders::GetCampaignFluentBuilder::set_name): <p> The name of the campaign to retrieve information about. </p>
