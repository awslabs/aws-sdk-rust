...
impl super::Client {
    ...
    ///   - [`status(impl Into<String>)`](crate::operation::list_campaigns::builders::ListCampaignsFluentBuilder::status) / [`set_status(Option<String>)`](crate::operation::list_campaigns::builders::ListCampaignsFluentBuilder::set_status):<br>required: **false**<br><p>An optional parameter to filter the results by the status of each created campaign in your account. The status can be one of: <code>CREATING</code>, <code>WAITING_FOR_APPROVAL</code>, <code>RUNNING</code>, or <code>SUSPENDED</code>.</p><br>
    ///   - [`list_response_scope(ListResponseScope)`](crate::operation::list_campaigns::builders::ListCampaignsFluentBuilder::list_response_scope) / [`set_list_response_scope(Option<ListResponseScope>)`](crate::operation::list_campaigns::builders::ListCampaignsFluentBuilder::set_list_response_scope):<br>required: **false**<br><p>When you set the <code>listResponseScope</code> parameter to <code>METADATA_ONLY</code>, the list response includes: campaign name, Amazon Resource Name (ARN), creation time, and last modification time.</p><br>
