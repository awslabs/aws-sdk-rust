...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::set_name): <p> The name of the campaign to delete. </p>
