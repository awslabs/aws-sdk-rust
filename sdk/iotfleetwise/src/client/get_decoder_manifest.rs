...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_decoder_manifest::builders::GetDecoderManifestFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::get_decoder_manifest::builders::GetDecoderManifestFluentBuilder::set_name):<br>required: **true**<br><p> The name of the decoder manifest to retrieve information about. </p><br>
