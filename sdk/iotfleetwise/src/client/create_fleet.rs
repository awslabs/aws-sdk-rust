...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::create_fleet::builders::CreateFleetFluentBuilder::fleet_id) / [`set_fleet_id(impl Into<String>)`](crate::operation::create_fleet::builders::CreateFleetFluentBuilder::set_fleet_id):<br>required: **true**<br><p> The unique ID of the fleet to create. </p><br>
    ...
    ///   - [`signal_catalog_arn(impl Into<String>)`](crate::operation::create_fleet::builders::CreateFleetFluentBuilder::signal_catalog_arn) / [`set_signal_catalog_arn(impl Into<String>)`](crate::operation::create_fleet::builders::CreateFleetFluentBuilder::set_signal_catalog_arn):<br>required: **true**<br><p> The Amazon Resource Name (ARN) of a signal catalog. </p><br>
