...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl Into<String>)`](crate::operation::update_vehicle::builders::UpdateVehicleFluentBuilder::vehicle_name) / [`set_vehicle_name(impl Into<String>)`](crate::operation::update_vehicle::builders::UpdateVehicleFluentBuilder::set_vehicle_name):<br>required: **true**<br><p>The unique ID of the vehicle to update.</p><br>
