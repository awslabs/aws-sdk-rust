...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl Into<String>)`](crate::operation::get_vehicle::builders::GetVehicleFluentBuilder::vehicle_name) / [`set_vehicle_name(impl Into<String>)`](crate::operation::get_vehicle::builders::GetVehicleFluentBuilder::set_vehicle_name):<br>required: **true**<br><p> The ID of the vehicle to retrieve information about. </p><br>
