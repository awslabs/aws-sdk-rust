...
impl super::Client {
    ...
    ///   - [`state_templates(Option<Vec::<StateTemplateAssociation>>)`](crate::operation::get_vehicle::GetVehicleOutput::state_templates): <p>State templates associated with the vehicle.</p>
