...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::vehicle_name) / [`set_vehicle_name(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::set_vehicle_name):<br>required: **true**<br><p> The unique ID of the vehicle to create. </p><br>
    ///   - [`model_manifest_arn(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::model_manifest_arn) / [`set_model_manifest_arn(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::set_model_manifest_arn):<br>required: **true**<br><p> The Amazon Resource Name ARN of a vehicle model. </p><br>
    ///   - [`decoder_manifest_arn(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::decoder_manifest_arn) / [`set_decoder_manifest_arn(impl Into<String>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::set_decoder_manifest_arn):<br>required: **true**<br><p> The ARN of a decoder manifest. </p><br>
