...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_vehicle::builders::CreateVehicleFluentBuilder::set_tags): <p>Metadata that can be used to manage the vehicle.</p>
