...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::set_next_token):<br>required: **false**<br><p>A pagination token for the next set of results.</p> <p>If the results of a search are large, only a portion of the results are returned, and a <code>nextToken</code> pagination token is returned in the response. To retrieve the next set of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value. This parameter is only supported for resources of type <code>CAMPAIGN</code>.</p><br>
    ///   - [`max_results(i32)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return, between 1 and 100, inclusive. This parameter is only supported for resources of type <code>CAMPAIGN</code>.</p><br>
