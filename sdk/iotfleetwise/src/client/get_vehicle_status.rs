...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl Into<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::vehicle_name) / [`set_vehicle_name(impl Into<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::set_vehicle_name):<br>required: **true**<br><p> The ID of the vehicle to retrieve information about. </p><br>
