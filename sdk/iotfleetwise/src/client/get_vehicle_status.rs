...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl ::std::convert::Into<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::vehicle_name) / [`set_vehicle_name(Option<String>)`](crate::operation::get_vehicle_status::builders::GetVehicleStatusFluentBuilder::set_vehicle_name): <p> The ID of the vehicle to retrieve information about. </p>
