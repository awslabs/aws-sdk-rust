...
impl super::Client {
    ...
    ///   - [`vehicle_name(impl Into<String>)`](crate::operation::associate_vehicle_fleet::builders::AssociateVehicleFleetFluentBuilder::vehicle_name) / [`set_vehicle_name(impl Into<String>)`](crate::operation::associate_vehicle_fleet::builders::AssociateVehicleFleetFluentBuilder::set_vehicle_name):<br>required: **true**<br><p> The unique ID of the vehicle to associate with the fleet. </p><br>
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::associate_vehicle_fleet::builders::AssociateVehicleFleetFluentBuilder::fleet_id) / [`set_fleet_id(impl Into<String>)`](crate::operation::associate_vehicle_fleet::builders::AssociateVehicleFleetFluentBuilder::set_fleet_id):<br>required: **true**<br><p> The ID of a fleet. </p><br>
