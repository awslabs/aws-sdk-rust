...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_decoder_manifest::builders::DeleteDecoderManifestFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_decoder_manifest::builders::DeleteDecoderManifestFluentBuilder::set_name):<br>required: **true**<br><p> The name of the decoder manifest to delete. </p><br>
