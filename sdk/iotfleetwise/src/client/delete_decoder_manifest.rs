...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_decoder_manifest::builders::DeleteDecoderManifestFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_decoder_manifest::builders::DeleteDecoderManifestFluentBuilder::set_name): <p> The name of the decoder manifest to delete. </p>
