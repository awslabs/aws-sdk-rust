...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_campaign::builders::UpdateCampaignFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_campaign::builders::UpdateCampaignFluentBuilder::set_name): <p> The name of the campaign to update. </p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_campaign::builders::UpdateCampaignFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_campaign::builders::UpdateCampaignFluentBuilder::set_description): <p>The description of the campaign.</p>
