...
impl std::convert::From<&str> for VehicleAssociationBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VehicleAssociationBehavior::Unknown(other.to_owned())
        }
    }
}
...
impl VehicleAssociationBehavior {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VehicleAssociationBehavior::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for UpdateMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateMode::Unknown(other.to_owned())
        }
    }
}
...
pub struct Attribute  {
    ...
    #[doc(hidden)]pub fully_qualified_name: std::option::Option<std::string::String>,
    /// <p>The specified data type of the attribute. </p>
    #[doc(hidden)]pub data_type: std::option::Option<crate::model::NodeDataType>,
    ...
    #[doc(hidden)]pub assigned_value: std::option::Option<std::string::String>,
...
impl std::convert::From<&str> for NodeDataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeDataType::Unknown(other.to_owned())
        }
    }
}
...
impl NodeDataType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NodeDataType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl FormattedVss {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`VssJson`](crate::model::FormattedVss::VssJson), extracting the inner [`String`](std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
...
impl std::convert::From<&str> for ManifestStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ManifestStatus::Unknown(other.to_owned())
        }
    }
}
...
impl ManifestStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ManifestStatus::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct SignalDecoder  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::SignalDecoderType>,
    /// <p>The ID of a network interface that specifies what network protocol a vehicle follows.</p>
    #[doc(hidden)]pub interface_id: std::option::Option<std::string::String>,
    /// <p>Information about signal decoder using the Controller Area Network (CAN) protocol.</p>
    #[doc(hidden)]pub can_signal: std::option::Option<crate::model::CanSignal>,
    /// <p>Information about signal decoder using the On-board diagnostic (OBD) II protocol.</p>
    #[doc(hidden)]pub obd_signal: std::option::Option<crate::model::ObdSignal>,
}
impl SignalDecoder {
    /// <p>The fully qualified name of a signal decoder as defined in a vehicle model.</p>
    pub fn fully_qualified_name(&self) -> std::option::Option<& str> {
...
pub struct CanSignal  {
    ...
    #[doc(hidden)]pub message_id: i32,
    /// <p>Whether the byte ordering of a CAN message is big-endian.</p>
    #[doc(hidden)]pub is_big_endian: bool,
...
impl std::convert::From<&str> for SignalDecoderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SignalDecoderType::Unknown(other.to_owned())
        }
    }
}
...
impl SignalDecoderType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SignalDecoderType::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct NetworkInterface  {
    ...
    #[doc(hidden)]pub interface_id: std::option::Option<std::string::String>,
    /// <p>The network protocol for the vehicle. For example, <code>CAN_SIGNAL</code> specifies a protocol that defines how data is communicated between electronic control units (ECUs). <code>OBD_SIGNAL</code> specifies a protocol that defines how self-diagnostic data is communicated between ECUs.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::NetworkInterfaceType>,
    /// <p>Information about a network interface specified by the Controller Area Network (CAN) protocol.</p>
    #[doc(hidden)]pub can_interface: std::option::Option<crate::model::CanInterface>,
    /// <p>Information about a network interface specified by the On-board diagnostic (OBD) II protocol.</p>
    #[doc(hidden)]pub obd_interface: std::option::Option<crate::model::ObdInterface>,
}
...
pub struct ObdInterface  {
    ...
    #[doc(hidden)]pub request_message_id: i32,
    /// <p>The standard OBD II PID.</p>
    #[doc(hidden)]pub obd_standard: std::option::Option<std::string::String>,
    /// <p>The maximum number message requests per second.</p>
    #[doc(hidden)]pub pid_request_interval_seconds: i32,
    /// <p>The maximum number message requests per diagnostic trouble code per second.</p>
    #[doc(hidden)]pub dtc_request_interval_seconds: i32,
    /// <p>Whether to use extended IDs in the message.</p>
    #[doc(hidden)]pub use_extended_ids: bool,
    /// <p>Whether the vehicle has a transmission control module (TCM).</p>
    #[doc(hidden)]pub has_transmission_ecu: bool,
}
impl ObdInterface {
    /// <p>The name of the interface.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for ObdInterface  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("pid_request_interval_seconds", &self.pid_request_interval_seconds);
        formatter.field("dtc_request_interval_seconds", &self.dtc_request_interval_seconds);
...
pub struct CanInterface  {
    ...
    #[doc(hidden)]pub protocol_name: std::option::Option<std::string::String>,
...
pub struct InvalidNetworkInterface  {
    ...
    #[doc(hidden)]pub reason: std::option::Option<crate::model::NetworkInterfaceFailureReason>,
}
...
impl std::convert::From<&str> for NetworkInterfaceFailureReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkInterfaceFailureReason::Unknown(other.to_owned())
        }
    }
}
...
impl NetworkInterfaceFailureReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkInterfaceFailureReason::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct InvalidSignalDecoder  {
    ...
    #[doc(hidden)]pub reason: std::option::Option<crate::model::SignalDecoderFailureReason>,
}
...
impl std::convert::From<&str> for SignalDecoderFailureReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SignalDecoderFailureReason::Unknown(other.to_owned())
        }
    }
}
...
impl SignalDecoderFailureReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SignalDecoderFailureReason::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl NetworkFileDefinition {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`CanDbc`](crate::model::NetworkFileDefinition::CanDbc), extracting the inner [`CanDbcDefinition`](crate::model::CanDbcDefinition).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct CanDbcDefinition  {
    ...
    #[doc(hidden)]pub network_interface: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub can_dbc_files: std::option::Option<std::vec::Vec<aws_smithy_types::Blob>>,
    /// <p>Pairs every signal specified in your vehicle model with a signal decoder.</p>
    #[doc(hidden)]pub signals_map: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct ConditionBasedCollectionScheme  {
    ...
    /// </note>
    #[doc(hidden)]pub minimum_trigger_interval_ms: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub trigger_mode: std::option::Option<crate::model::TriggerMode>,
    /// <p>Specifies the version of the conditional expression language.</p>
    #[doc(hidden)]pub condition_language_version: std::option::Option<i32>,
}
...
impl std::convert::From<&str> for TriggerMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TriggerMode::Unknown(other.to_owned())
        }
    }
}
...
impl TriggerMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TriggerMode::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct TimeBasedCollectionScheme  {
    ...
    #[doc(hidden)]pub period_ms: std::option::Option<i64>,
}
...
pub struct SignalInformation  {
    ...
    #[doc(hidden)]pub max_sample_count: std::option::Option<i64>,
    /// <p>The minimum duration of time (in milliseconds) between two triggering events to collect data.</p> <note> 
    /// <p>If a signal changes often, you might want to collect data at a slower rate.</p> 
    /// </note>
    #[doc(hidden)]pub minimum_sampling_interval_ms: std::option::Option<i64>,
}
...
impl  std::fmt::Debug for SignalInformation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("minimum_sampling_interval_ms", &self.minimum_sampling_interval_ms);
        formatter.finish()
    }
}
...
impl std::convert::From<&str> for Compression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Compression::Unknown(other.to_owned())
        }
    }
}
...
impl Compression {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Compression::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for SpoolingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpoolingMode::Unknown(other.to_owned())
        }
    }
}
...
impl SpoolingMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SpoolingMode::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for DiagnosticsMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DiagnosticsMode::Unknown(other.to_owned())
        }
    }
}
...
impl DiagnosticsMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DiagnosticsMode::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
impl std::convert::From<&str> for UpdateCampaignAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateCampaignAction::Unknown(other.to_owned())
        }
    }
}
...
impl UpdateCampaignAction {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            UpdateCampaignAction::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct TimestreamResources  {
    ...
    #[doc(hidden)]pub timestream_database_name: std::option::Option<std::string::String>,
    /// <p>The name of the registered Amazon Timestream database table.</p>
    #[doc(hidden)]pub timestream_table_name: std::option::Option<std::string::String>,
}
...
pub struct VehicleStatus  {
    /// <p>The name of a campaign.</p>
    #[doc(hidden)]pub campaign_name: std::option::Option<std::string::String>,
    /// <p>The unique ID of the vehicle.</p>
    #[doc(hidden)]pub vehicle_name: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::VehicleState>,
}
impl VehicleStatus {
    /// <p>The name of a campaign.</p>
...
impl std::convert::From<&str> for VehicleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VehicleState::Unknown(other.to_owned())
        }
    }
}
...
impl VehicleState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VehicleState::Unknown(s) => s.as_ref()
        }
    }
    /// Returns all the `&str` values of the enum members.
    pub fn values() -> &'static [&'static str] {
...
pub struct TimestreamRegistrationResponse  {
    ...
    #[doc(hidden)]pub timestream_database_arn: std::option::Option<std::string::String>,
    /// <p>The ARN of the Timestream database table.</p>
    #[doc(hidden)]pub timestream_table_arn: std::option::Option<std::string::String>,
