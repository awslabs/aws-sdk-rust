...
pub fn ser_collection_scheme(
    object_14: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CollectionScheme,
) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        crate::types::CollectionScheme::TimeBasedCollectionScheme(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_14.key("timeBasedCollectionScheme").start_object();
        ...
        crate::types::CollectionScheme::ConditionBasedCollectionScheme(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_14.key("conditionBasedCollectionScheme").start_object();
