...
pub fn ser_collection_scheme(object_17: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CollectionScheme) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::CollectionScheme::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("CollectionScheme"))
    }
    Ok(())
}
