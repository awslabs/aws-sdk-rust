...
pub fn ser_node(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Node) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "struct" => {
                                Some(crate::types::Node::Struct(
                                    crate::protocol_serde::shape_custom_struct::de_custom_struct(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'struct' cannot be null"))?
                                ))
                            }
                            "property" => {
                                Some(crate::types::Node::Property(
                                    crate::protocol_serde::shape_custom_property::de_custom_property(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'property' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
