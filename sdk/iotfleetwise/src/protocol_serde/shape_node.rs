...
pub fn ser_node(object_6: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Node) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
