                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "branch" => Some(crate::types::Node::Branch(
                            crate::protocol_serde::shape_branch::de_branch(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "sensor" => Some(crate::types::Node::Sensor(
                            crate::protocol_serde::shape_sensor::de_sensor(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "actuator" => Some(crate::types::Node::Actuator(
                            crate::protocol_serde::shape_actuator::de_actuator(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "attribute" => Some(crate::types::Node::Attribute(
                            crate::protocol_serde::shape_attribute::de_attribute(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "struct" => Some(crate::types::Node::Struct(
                            crate::protocol_serde::shape_custom_struct::de_custom_struct(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "property" => Some(crate::types::Node::Property(
                            crate::protocol_serde::shape_custom_property::de_custom_property(tokens, _value, depth + 1)?.ok_or_else(|| {
