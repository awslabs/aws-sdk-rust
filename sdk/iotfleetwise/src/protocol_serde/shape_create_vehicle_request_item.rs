...
pub fn ser_create_vehicle_request_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateVehicleRequestItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
