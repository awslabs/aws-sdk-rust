...
pub fn ser_sensor(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Sensor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_sensor<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Sensor>, aws_smithy_json::deserialize::error::DeserializeError>
