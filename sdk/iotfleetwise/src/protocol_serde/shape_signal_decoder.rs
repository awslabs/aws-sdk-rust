...
pub(crate) fn de_signal_decoder<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SignalDecoder>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "messageSignal" => {
                                builder = builder.set_message_signal(
                                    crate::protocol_serde::shape_message_signal::de_message_signal(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::signal_decoder_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
