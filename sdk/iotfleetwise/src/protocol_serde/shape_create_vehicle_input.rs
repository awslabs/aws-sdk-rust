...
pub fn ser_create_vehicle_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_vehicle::CreateVehicleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
