...
pub fn ser_can_signal(
    ...
    }
    {
        object.key("factor").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::Float((input.factor).into()),
        );
    }
    {
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "isBigEndian" => {
                            builder = builder.set_is_big_endian(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "isSigned" => {
                        ...
                        "factor" => {
                            builder = builder
                                .set_factor(::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?.map(|v| v.to_f64_lossy()));
                        }
                        "length" => {
            ...
            Ok(Some(crate::serde_util::can_signal_correct_errors(builder).build().map_err(|err| {
