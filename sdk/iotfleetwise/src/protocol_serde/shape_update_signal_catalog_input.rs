...
pub fn ser_update_signal_catalog_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSignalCatalogInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
