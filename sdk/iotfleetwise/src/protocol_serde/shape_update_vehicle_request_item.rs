...
pub fn ser_update_vehicle_request_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateVehicleRequestItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
