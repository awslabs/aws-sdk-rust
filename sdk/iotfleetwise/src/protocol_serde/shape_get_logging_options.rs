...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::get_logging_options::GetLoggingOptionsError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ThrottlingException" => {
            crate::operation::get_logging_options::GetLoggingOptionsError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServerException" => {
            crate::operation::get_logging_options::GetLoggingOptionsError::InternalServerException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
