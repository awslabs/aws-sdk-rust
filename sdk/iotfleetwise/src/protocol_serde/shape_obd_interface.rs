...
pub fn ser_obd_interface(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ObdInterface) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_obd_interface<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ObdInterface>, aws_smithy_json::deserialize::error::DeserializeError>
