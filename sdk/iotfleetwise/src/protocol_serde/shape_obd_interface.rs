...
pub(crate) fn de_obd_interface<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ObdInterface>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "useExtendedIds" => {
                            builder = builder.set_use_extended_ids(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "hasTransmissionEcu" => {
                            builder = builder.set_has_transmission_ecu(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
