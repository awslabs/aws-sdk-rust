...
pub fn ser_periodic_state_template_update_strategy(
    ...
    if let Some(var_1) = &input.state_template_update_rate {
        ...
        crate::protocol_serde::shape_time_period::ser_time_period(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PeriodicStateTemplateUpdateStrategyBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "stateTemplateUpdateRate" => {
                            builder = builder.set_state_template_update_rate(crate::protocol_serde::shape_time_period::de_time_period(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
            ...
            Ok(Some(
                crate::serde_util::periodic_state_template_update_strategy_correct_errors(builder).build(),
            ))
        }
