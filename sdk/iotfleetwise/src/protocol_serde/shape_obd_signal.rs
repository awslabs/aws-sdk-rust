...
pub fn ser_obd_signal(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ObdSignal) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
...
pub(crate) fn de_obd_signal<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ObdSignal>, aws_smithy_json::deserialize::error::DeserializeError>
