...
pub fn ser_obd_signal(
     ...
     {
        object.key("scaling").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((input.scaling).into()));
    }
     {
     ...
     {
        object.key("byteLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.byte_length).into()));
    }
    ...
    if let Some(var_1) = &input.bit_mask_length {
        object.key("bitMaskLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    Ok(())
}
...
pub(crate) fn de_obd_signal<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ObdSignal>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::obd_signal_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
