...
pub fn ser_actuator(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Actuator) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
