...
pub fn ser_actuator(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Actuator) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_actuator<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Actuator>, aws_smithy_json::deserialize::error::DeserializeError>
