...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_model_manifest_nodes::ListModelManifestNodesError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_model_manifest_nodes::de_list_model_manifest_nodes(_response_body, output)
            .map_err(crate::operation::list_model_manifest_nodes::ListModelManifestNodesError::unhandled)?;
