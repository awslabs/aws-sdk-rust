...
pub fn ser_can_dbc_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CanDbcDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
