...
pub fn ser_update_decoder_manifest_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDecoderManifestInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
