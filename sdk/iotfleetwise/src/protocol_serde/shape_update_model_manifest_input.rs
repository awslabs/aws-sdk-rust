...
pub fn ser_update_model_manifest_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateModelManifestInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
