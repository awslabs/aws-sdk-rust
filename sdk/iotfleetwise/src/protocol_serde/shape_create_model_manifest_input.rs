...
pub fn ser_create_model_manifest_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateModelManifestInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
