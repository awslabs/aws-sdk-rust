...
pub fn ser_update_vehicle_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateVehicleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
