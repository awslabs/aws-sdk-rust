...
pub fn ser_update_vehicle_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_vehicle::UpdateVehicleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
