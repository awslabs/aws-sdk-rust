...
pub fn ser_network_file_definition(object_5: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NetworkFileDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
