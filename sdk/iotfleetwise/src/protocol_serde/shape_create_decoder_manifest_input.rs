...
pub fn ser_create_decoder_manifest_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDecoderManifestInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
