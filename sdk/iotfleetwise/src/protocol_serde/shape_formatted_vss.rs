...
pub fn ser_formatted_vss(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FormattedVss) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
