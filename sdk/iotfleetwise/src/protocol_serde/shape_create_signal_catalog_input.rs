...
pub fn ser_create_signal_catalog_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSignalCatalogInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
