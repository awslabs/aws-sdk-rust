...
pub fn ser_branch(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Branch) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
