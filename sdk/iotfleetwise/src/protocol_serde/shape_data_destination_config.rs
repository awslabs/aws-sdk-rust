...
pub fn ser_data_destination_config(object_28: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DataDestinationConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::DataDestinationConfig::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("DataDestinationConfig"))
    }
    Ok(())
}

pub(crate) fn de_data_destination_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataDestinationConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
