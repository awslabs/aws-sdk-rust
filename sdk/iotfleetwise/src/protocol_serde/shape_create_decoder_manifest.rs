...
> {
    ...
    Err(match error_code {
        ...
        "DecoderManifestValidationException" => {
            crate::operation::create_decoder_manifest::CreateDecoderManifestError::DecoderManifestValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::DecoderManifestValidationExceptionBuilder::default();
                    output = crate::protocol_serde::shape_decoder_manifest_validation_exception::de_decoder_manifest_validation_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::create_decoder_manifest::CreateDecoderManifestError::unhandled)?;
...
> {
    Ok({
        ...
        crate::serde_util::create_decoder_manifest_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_decoder_manifest::CreateDecoderManifestError::unhandled)?
    })
}
