...
impl ListSignalCatalogsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_signal_catalogs::ser_list_signal_catalogs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSignalCatalogs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_signal_catalogs::de_list_signal_catalogs_http_response_with_props(status, headers, body)
        }
    }
}
