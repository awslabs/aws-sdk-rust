...
impl GetRegisterAccountStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_register_account_status::GetRegisterAccountStatusInput, ::aws_smithy_types::error::operation::BuildError> {
