...
impl GetRegisterAccountStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_register_account_status::GetRegisterAccountStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_register_account_status::GetRegisterAccountStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_register_account_status::GetRegisterAccountStatusOutput, crate::operation::get_register_account_status::GetRegisterAccountStatusError, Self> {
