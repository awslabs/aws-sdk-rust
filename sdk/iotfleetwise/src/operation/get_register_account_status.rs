...
impl GetRegisterAccountStatusInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_register_account_status::GetRegisterAccountStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRegisterAccountStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_register_account_status::de_get_register_account_status_http_response_with_props(status, headers, body)
        }
    }
}
