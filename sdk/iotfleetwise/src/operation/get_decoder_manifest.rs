...
impl GetDecoderManifestInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_decoder_manifest::ser_get_decoder_manifest_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDecoderManifest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_decoder_manifest::de_get_decoder_manifest_http_response_with_props(status, headers, body)
        }
    }
}
