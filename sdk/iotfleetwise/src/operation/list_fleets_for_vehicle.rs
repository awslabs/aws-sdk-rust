...
/// Orchestration and serialization glue logic for `ListFleetsForVehicle`.
...
impl ListFleetsForVehicle {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFleetsForVehicle {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListFleetsForVehicle");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListFleetsForVehicleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListFleetsForVehicleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFleetsForVehicle")
...
.with_interceptor(ListFleetsForVehicleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError>::new());
...
#[derive(Debug)]
            struct ListFleetsForVehicleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFleetsForVehicleResponseDeserializer {
...
#[derive(Debug)]
            struct ListFleetsForVehicleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFleetsForVehicleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_fleets_for_vehicle::ser_list_fleets_for_vehicle_input(&input)?);
...
#[derive(Debug)]
            struct ListFleetsForVehicleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFleetsForVehicleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListFleetsForVehicleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListFleetsForVehicleInput>()
                        .ok_or("failed to downcast to ListFleetsForVehicleInput")?;
...
pub enum ListFleetsForVehicleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListFleetsForVehicleError) for what information is available for the error.")]
...
impl ListFleetsForVehicleError {
    /// Creates the `ListFleetsForVehicleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListFleetsForVehicleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListFleetsForVehicleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_fleets_for_vehicle::ListFleetsForVehicleError {
...
mod _list_fleets_for_vehicle_output;
