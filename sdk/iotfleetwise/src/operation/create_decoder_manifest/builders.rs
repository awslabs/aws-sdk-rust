...
impl CreateDecoderManifestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_decoder_manifest::CreateDecoderManifestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_decoder_manifest::CreateDecoderManifestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_decoder_manifest::CreateDecoderManifestOutput, crate::operation::create_decoder_manifest::CreateDecoderManifestError, Self> {
