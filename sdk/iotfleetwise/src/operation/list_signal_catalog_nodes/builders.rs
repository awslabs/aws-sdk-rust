...
impl ListSignalCatalogNodesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_signal_catalog_nodes::ListSignalCatalogNodesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_signal_catalog_nodes::ListSignalCatalogNodesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_signal_catalog_nodes::ListSignalCatalogNodesOutput, crate::operation::list_signal_catalog_nodes::ListSignalCatalogNodesError, Self> {
