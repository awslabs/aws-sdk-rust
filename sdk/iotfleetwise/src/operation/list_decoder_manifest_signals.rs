...
impl ListDecoderManifestSignalsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_decoder_manifest_signals::ListDecoderManifestSignals,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_decoder_manifest_signals::ListDecoderManifestSignals::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDecoderManifestSignals {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_decoder_manifest_signals::de_list_decoder_manifest_signals_http_response_with_props(
                status, headers, body,
            )
        }
    }
