...
impl DeleteFleetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_fleet::DeleteFleet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_fleet::ser_delete_fleet_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_fleet::de_delete_fleet_http_response_with_props(status, headers, body)
        }
    }
}
