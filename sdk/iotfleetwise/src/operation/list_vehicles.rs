...
impl ListVehiclesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_vehicles::ListVehicles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVehicles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_vehicles::de_list_vehicles_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_vehicles::de_list_vehicles_http_response_with_props(
                status, headers, body,
            )
        }
    }
