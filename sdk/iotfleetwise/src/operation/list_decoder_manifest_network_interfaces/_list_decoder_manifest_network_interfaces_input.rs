...
impl ListDecoderManifestNetworkInterfacesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_decoder_manifest_network_interfaces::ListDecoderManifestNetworkInterfacesInput, ::aws_smithy_types::error::operation::BuildError> {
