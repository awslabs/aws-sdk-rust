...
impl ListDecoderManifestNetworkInterfacesInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_decoder_manifest_network_interfaces::ListDecoderManifestNetworkInterfacesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
