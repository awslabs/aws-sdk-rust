...
impl ListDecoderManifestSignalsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_decoder_manifest_signals::ListDecoderManifestSignalsInput, ::aws_smithy_types::error::operation::BuildError> {
