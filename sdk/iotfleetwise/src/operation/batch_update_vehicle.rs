...
impl BatchUpdateVehicleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_update_vehicle::ser_batch_update_vehicle_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpdateVehicle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_update_vehicle::de_batch_update_vehicle_http_response_with_props(status, headers, body)
        }
    }
}
