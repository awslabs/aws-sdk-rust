...
impl ListModelManifestsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_model_manifests::ListModelManifestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_model_manifests::ListModelManifestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_model_manifests::ListModelManifestsOutput, crate::operation::list_model_manifests::ListModelManifestsError, Self> {
