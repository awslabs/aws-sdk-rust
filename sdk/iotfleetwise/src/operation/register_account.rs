...
impl RegisterAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_account::RegisterAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_account::de_register_account_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_account::RegisterAccountError
{
