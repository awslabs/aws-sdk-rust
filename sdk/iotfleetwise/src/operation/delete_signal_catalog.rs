...
impl DeleteSignalCatalogInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_signal_catalog::DeleteSignalCatalog,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSignalCatalog {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_signal_catalog::de_delete_signal_catalog_http_response_with_props(status, headers, body)
        }
    }
}
