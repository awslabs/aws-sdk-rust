        ...
        ::std::result::Result::Ok(
            crate::types::error::LimitExceededException {
                ...
                resource_id: self.resource_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_id", "resource_id was not specified but it is required when building LimitExceededException")
                    )?
                ,
                resource_type: self.resource_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_type", "resource_type was not specified but it is required when building LimitExceededException")
                    )?
                ,
