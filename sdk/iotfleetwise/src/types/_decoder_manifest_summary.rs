        ...
        ::std::result::Result::Ok(
            crate::types::DecoderManifestSummary {
                ...
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building DecoderManifestSummary")
                    )?
                ,
                last_modification_time: self.last_modification_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modification_time", "last_modification_time was not specified but it is required when building DecoderManifestSummary")
                    )?
                ,
