...
impl NetworkInterfaceFailureReason {
    ...
    NetworkInterfaceFailureReason::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["CAN_NETWORK_INTERFACE_INFO_IS_NULL", "CONFLICTING_NETWORK_INTERFACE", "DUPLICATE_NETWORK_INTERFACE", "NETWORK_INTERFACE_TO_ADD_ALREADY_EXISTS", "NETWORK_INTERFACE_TO_REMOVE_ASSOCIATED_WITH_SIGNALS", "OBD_NETWORK_INTERFACE_INFO_IS_NULL", "VEHICLE_MIDDLEWARE_NETWORK_INTERFACE_INFO_IS_NULL"]
                }
            }
...
NetworkInterfaceFailureReason::NetworkInterfaceToRemoveAssociatedWithSignals => write!(f, "NETWORK_INTERFACE_TO_REMOVE_ASSOCIATED_WITH_SIGNALS"),
NetworkInterfaceFailureReason::ObdNetworkInterfaceInfoIsNull => write!(f, "OBD_NETWORK_INTERFACE_INFO_IS_NULL"),
NetworkInterfaceFailureReason::VehicleMiddlewareNetworkInterfaceInfoIsNull => write!(f, "VEHICLE_MIDDLEWARE_NETWORK_INTERFACE_INFO_IS_NULL"),
