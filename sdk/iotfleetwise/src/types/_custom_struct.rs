...
impl CustomStructBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CustomStruct, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CustomStruct {
                fully_qualified_name: self.fully_qualified_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("fully_qualified_name", "fully_qualified_name was not specified but it is required when building CustomStruct")
                    )?
                ,
