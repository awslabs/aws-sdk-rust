...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::deactivate_user::builders::DeactivateUserFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::deactivate_user::builders::DeactivateUserFluentBuilder::set_user_id):<br>required: **true**<br><p>The ID of the user.</p><br>
