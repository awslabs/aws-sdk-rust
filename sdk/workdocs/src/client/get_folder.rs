...
impl super::Client {
    ...
    ///   - [`authentication_token(impl Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_authentication_token):<br>required: **false**<br><p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p><br>
    ///   - [`folder_id(impl Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::folder_id) / [`set_folder_id(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_folder_id):<br>required: **true**<br><p>The ID of the folder.</p><br>
