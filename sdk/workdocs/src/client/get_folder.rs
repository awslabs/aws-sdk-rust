...
impl super::Client {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
    ///   - [`folder_id(impl ::std::convert::Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::folder_id) / [`set_folder_id(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_folder_id): <p>The ID of the folder.</p>
    ///   - [`include_custom_metadata(bool)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::include_custom_metadata) / [`set_include_custom_metadata(Option<bool>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_include_custom_metadata): <p>Set to TRUE to include custom metadata in the response.</p>
