...
impl super::Client {
    ...
    ///   - [`parent_folder_id(impl ::std::convert::Into<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::parent_folder_id) / [`set_parent_folder_id(Option<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::set_parent_folder_id): <p>The ID of the parent folder.</p>
