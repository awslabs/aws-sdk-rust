...
impl super::Client {
    ...
    ///   - [`subscription_id(impl ::std::convert::Into<String>)`](crate::operation::delete_notification_subscription::builders::DeleteNotificationSubscriptionFluentBuilder::subscription_id) / [`set_subscription_id(Option<String>)`](crate::operation::delete_notification_subscription::builders::DeleteNotificationSubscriptionFluentBuilder::set_subscription_id): <p>The ID of the subscription.</p>
