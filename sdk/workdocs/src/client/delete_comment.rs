...
impl super::Client {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
    ///   - [`document_id(impl ::std::convert::Into<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::document_id) / [`set_document_id(Option<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::set_document_id): <p>The ID of the document.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::delete_comment::builders::DeleteCommentFluentBuilder::set_version_id): <p>The ID of the document version.</p>
