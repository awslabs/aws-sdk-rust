...
impl super::Client {
    ...
    ///   - [`custom_metadata(impl Into<String>, impl Into<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::custom_metadata) / [`set_custom_metadata(Option<HashMap<String, String>>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::set_custom_metadata): <p>Custom metadata in the form of name-value pairs.</p>
