...
impl super::Client {
    ...
    ///   - [`labels(impl Into<String>)`](crate::operation::create_labels::builders::CreateLabelsFluentBuilder::labels) / [`set_labels(Option<Vec<String>>)`](crate::operation::create_labels::builders::CreateLabelsFluentBuilder::set_labels): <p>List of labels to add to the resource.</p>
