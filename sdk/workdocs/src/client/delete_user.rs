...
impl super::Client {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Do not set this field when using administrative API actions, as in accessing the API using Amazon Web Services credentials.</p>
