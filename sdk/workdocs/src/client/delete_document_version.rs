...
impl super::Client  {
    ...
    ///   - [`document_id(impl Into<String>)`](crate::operation::delete_document_version::builders::DeleteDocumentVersionFluentBuilder::document_id) / [`set_document_id(Option<String>)`](crate::operation::delete_document_version::builders::DeleteDocumentVersionFluentBuilder::set_document_id): <p>The ID of the document associated with the version being deleted.</p>
    ///   - [`version_id(impl Into<String>)`](crate::operation::delete_document_version::builders::DeleteDocumentVersionFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::delete_document_version::builders::DeleteDocumentVersionFluentBuilder::set_version_id): <p>The ID of the version being deleted.</p>
