...
impl super::Client {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::set_resource_id): <p>The ID of the resource.</p>
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
