...
impl super::Client {
    ...
    ///   - [`labels(impl Into<String>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::labels) / [`set_labels(Option<Vec<String>>)`](crate::operation::delete_labels::builders::DeleteLabelsFluentBuilder::set_labels): <p>List of labels to delete from the resource.</p>
