...
impl super::Client {
    ...
    ///   - [`keys(impl Into<String>)`](crate::operation::delete_custom_metadata::builders::DeleteCustomMetadataFluentBuilder::keys) / [`set_keys(Option<Vec<String>>)`](crate::operation::delete_custom_metadata::builders::DeleteCustomMetadataFluentBuilder::set_keys): <p>List of properties to remove.</p>
