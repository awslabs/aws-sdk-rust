...
impl super::Client {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::get_current_user::builders::GetCurrentUserFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::get_current_user::builders::GetCurrentUserFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token.</p>
