...
impl DescribeActivitiesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeActivities`](crate::operation::describe_activities::DescribeActivities)>
    #[allow(unused_mut)]
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeActivities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_activities::de_describe_activities_http_response_with_props(status, headers, body)
        }
    }
