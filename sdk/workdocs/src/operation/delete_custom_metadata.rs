...
impl DeleteCustomMetadataInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCustomMetadata`](crate::operation::delete_custom_metadata::DeleteCustomMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_custom_metadata::DeleteCustomMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_custom_metadata::DeleteCustomMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_custom_metadata::DeleteCustomMetadataInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_custom_metadata::DeleteCustomMetadata::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCustomMetadata {
                type Output = std::result::Result<crate::operation::delete_custom_metadata::DeleteCustomMetadataOutput, crate::operation::delete_custom_metadata::DeleteCustomMetadataError>;
