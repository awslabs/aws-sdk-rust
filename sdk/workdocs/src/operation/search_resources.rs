    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_search_resources::ser_search_resources_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_resources::SearchResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_resources::de_search_resources_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_resources::SearchResourcesError
{
