...
impl DeleteDocumentVersionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDocumentVersion`](crate::operation::delete_document_version::DeleteDocumentVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_document_version::DeleteDocumentVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_document_version::DeleteDocumentVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_document_version::DeleteDocumentVersionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_3 = &_input.delete_prior_versions;
                let inner_3 = inner_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("delete_prior_versions", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_document_version::DeleteDocumentVersion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDocumentVersion {
                type Output = std::result::Result<crate::operation::delete_document_version::DeleteDocumentVersionOutput, crate::operation::delete_document_version::DeleteDocumentVersionError>;
