...
impl GetDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_document::GetDocument,
    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_get_document::ser_get_document_headers(
                    input, builder,
                )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_document::GetDocument::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_document::de_get_document_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_document::de_get_document_http_response_with_props(
                status, headers, body,
            )
        }
    }
