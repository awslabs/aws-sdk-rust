...
impl DeactivateUserFluentBuilder  {
    /// Creates a new `DeactivateUser`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::deactivate_user::DeactivateUserOutput, aws_smithy_http::result::SdkError<crate::operation::deactivate_user::DeactivateUserError>>
                     {
