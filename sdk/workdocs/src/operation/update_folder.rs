...
impl UpdateFolderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFolder`](crate::operation::update_folder::UpdateFolder)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_folder::UpdateFolder, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_folder::ser_update_folder_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_folder::UpdateFolder::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFolder {
    type Output = ::std::result::Result<crate::operation::update_folder::UpdateFolderOutput, crate::operation::update_folder::UpdateFolderError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_folder::de_update_folder_http_response_with_props(status, headers, body)
        }
    }
}
