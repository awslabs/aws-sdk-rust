    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_update_folder::ser_update_folder_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_folder::UpdateFolder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFolder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_folder::de_update_folder_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_folder::de_update_folder_http_response_with_props(
                status, headers, body,
            )
        }
    }
