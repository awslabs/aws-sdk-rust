...
impl DescribeResourcePermissionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeResourcePermissions`](crate::operation::describe_resource_permissions::DescribeResourcePermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_resource_permissions::DescribeResourcePermissions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_resource_permissions::DescribeResourcePermissionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_resource_permissions::DescribeResourcePermissionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_2) = &_input.principal_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_resource_permissions::DescribeResourcePermissions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeResourcePermissions {
                type Output = std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsOutput, crate::operation::describe_resource_permissions::DescribeResourcePermissionsError>;
