...
impl ::aws_smithy_http::response::ParseStrictResponse for InitiateDocumentVersionUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_initiate_document_version_upload::de_initiate_document_version_upload_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::initiate_document_version_upload::InitiateDocumentVersionUploadError
{
