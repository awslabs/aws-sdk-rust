...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InitiateDocumentVersionUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_initiate_document_version_upload::de_initiate_document_version_upload_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_initiate_document_version_upload::de_initiate_document_version_upload_http_response(
