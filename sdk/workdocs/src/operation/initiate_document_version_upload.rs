    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::initiate_document_version_upload::InitiateDocumentVersionUploadError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::initiate_document_version_upload::InitiateDocumentVersionUploadOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for InitiateDocumentVersionUploadResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for InitiateDocumentVersionUploadRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for InitiateDocumentVersionUploadEndpointParamsInterceptor {
