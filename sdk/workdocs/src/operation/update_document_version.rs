...
impl UpdateDocumentVersionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDocumentVersion`](crate::operation::update_document_version::UpdateDocumentVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_document_version::UpdateDocumentVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_document_version::UpdateDocumentVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_document_version::UpdateDocumentVersion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDocumentVersion {
                type Output = std::result::Result<crate::operation::update_document_version::UpdateDocumentVersionOutput, crate::operation::update_document_version::UpdateDocumentVersionError>;
