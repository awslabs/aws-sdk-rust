...
impl GetCurrentUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_current_user::GetCurrentUser, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCurrentUser {
    type Output =
        ::std::result::Result<crate::operation::get_current_user::GetCurrentUserOutput, crate::operation::get_current_user::GetCurrentUserError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_current_user::de_get_current_user_http_response_with_props(status, headers, body)
        }
    }
