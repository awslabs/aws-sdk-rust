...
impl CreateNotificationSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_notification_subscription::CreateNotificationSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNotificationSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_notification_subscription::de_create_notification_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
