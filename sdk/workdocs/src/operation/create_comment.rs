...
impl CreateCommentInput {
    /// Consumes the builder and constructs an Operation<[`CreateComment`](crate::operation::create_comment::CreateComment)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_comment::CreateComment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_comment::ser_create_comment_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_comment::CreateComment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateComment {
    type Output = ::std::result::Result<crate::operation::create_comment::CreateCommentOutput, crate::operation::create_comment::CreateCommentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_comment::de_create_comment_http_response_with_props(status, headers, body)
        }
    }
