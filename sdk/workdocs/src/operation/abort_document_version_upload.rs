...
impl AbortDocumentVersionUploadInput {
    /// Consumes the builder and constructs an Operation<[`AbortDocumentVersionUpload`](crate::operation::abort_document_version_upload::AbortDocumentVersionUpload)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::abort_document_version_upload::AbortDocumentVersionUpload, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::abort_document_version_upload::AbortDocumentVersionUpload::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AbortDocumentVersionUpload {
                type Output = std::result::Result<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadOutput, crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>;
