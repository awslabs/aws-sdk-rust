...
impl AbortDocumentVersionUpload {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AbortDocumentVersionUpload",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AbortDocumentVersionUpload {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AbortDocumentVersionUploadRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AbortDocumentVersionUploadResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AbortDocumentVersionUpload")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AbortDocumentVersionUpload")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AbortDocumentVersionUploadTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AbortDocumentVersionUploadTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AbortDocumentVersionUploadTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AbortDocumentVersionUploadInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AbortDocumentVersionUploadResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_abort_document_version_upload::de_abort_document_version_upload_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_abort_document_version_upload::de_abort_document_version_upload_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AbortDocumentVersionUploadRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput,
