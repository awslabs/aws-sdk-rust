...
impl ::aws_smithy_http::response::ParseStrictResponse for AbortDocumentVersionUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_abort_document_version_upload::de_abort_document_version_upload_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError
{
