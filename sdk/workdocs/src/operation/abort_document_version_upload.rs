...
impl AbortDocumentVersionUpload {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput,
                    ) -> ::std::result::Result<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AbortDocumentVersionUpload {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AbortDocumentVersionUpload");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AbortDocumentVersionUploadRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AbortDocumentVersionUploadResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AbortDocumentVersionUpload")
...
.with_interceptor(AbortDocumentVersionUploadEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError>::new());
...
#[derive(Debug)]
            struct AbortDocumentVersionUploadResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AbortDocumentVersionUploadResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_abort_document_version_upload::de_abort_document_version_upload_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AbortDocumentVersionUploadRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AbortDocumentVersionUploadRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::abort_document_version_upload::AbortDocumentVersionUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/api/v1/documents/{DocumentId}/versions/{VersionId}", DocumentId = document_id, VersionId = version_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct AbortDocumentVersionUploadEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AbortDocumentVersionUploadEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AbortDocumentVersionUploadEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AbortDocumentVersionUploadInput>()
                        .ok_or("failed to downcast to AbortDocumentVersionUploadInput")?;
...
pub enum AbortDocumentVersionUploadError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AbortDocumentVersionUploadError) for what information is available for the error.")]
...
impl AbortDocumentVersionUploadError {
    /// Creates the `AbortDocumentVersionUploadError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AbortDocumentVersionUploadError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AbortDocumentVersionUploadError {
...
impl ::aws_types::request_id::RequestId for crate::operation::abort_document_version_upload::AbortDocumentVersionUploadError {
...
mod _abort_document_version_upload_output;
