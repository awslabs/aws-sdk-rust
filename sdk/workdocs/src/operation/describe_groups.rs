...
impl DescribeGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGroups`](crate::operation::describe_groups::DescribeGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_groups::DescribeGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_groups::DescribeGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/api/v1/groups").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_groups::DescribeGroupsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.search_query;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("search_query", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                ...
                if let Some(inner_2) = &_input.organization_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_groups::DescribeGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGroups {
                type Output = std::result::Result<crate::operation::describe_groups::DescribeGroupsOutput, crate::operation::describe_groups::DescribeGroupsError>;
