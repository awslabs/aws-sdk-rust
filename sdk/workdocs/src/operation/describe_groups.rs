...
impl DescribeGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_groups::DescribeGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGroups {
    type Output =
        ::std::result::Result<crate::operation::describe_groups::DescribeGroupsOutput, crate::operation::describe_groups::DescribeGroupsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_groups::de_describe_groups_http_response_with_props(status, headers, body)
        }
    }
}
