...
impl DescribeGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_groups::DescribeGroups,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_groups::DescribeGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_groups::de_describe_groups_http_error(
                status, headers, body,
            )
        } else {
