...
impl DeactivateUserInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deactivate_user::DeactivateUser::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeactivateUser {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_deactivate_user::de_deactivate_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_deactivate_user::de_deactivate_user_http_response(
                status, headers, body,
            )
        }
    }
