...
impl DeleteNotificationSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_notification_subscription::DeleteNotificationSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotificationSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_notification_subscription::de_delete_notification_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
