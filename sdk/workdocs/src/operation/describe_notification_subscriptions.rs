...
impl DescribeNotificationSubscriptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationSubscriptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_notification_subscriptions::de_describe_notification_subscriptions_http_response_with_props(
                status, headers, body,
            )
        }
    }
