...
impl RemoveResourcePermissionInput {
    /// Consumes the builder and constructs an Operation<[`RemoveResourcePermission`](crate::operation::remove_resource_permission::RemoveResourcePermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_resource_permission::RemoveResourcePermission, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_resource_permission::RemoveResourcePermissionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::remove_resource_permission::RemoveResourcePermissionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_3) = &_input.principal_type {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_resource_permission::RemoveResourcePermission::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveResourcePermission {
                type Output = std::result::Result<crate::operation::remove_resource_permission::RemoveResourcePermissionOutput, crate::operation::remove_resource_permission::RemoveResourcePermissionError>;
