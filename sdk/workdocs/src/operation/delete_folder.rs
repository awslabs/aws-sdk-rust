...
impl DeleteFolderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFolder`](crate::operation::delete_folder::DeleteFolder)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_folder::DeleteFolder, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_folder::DeleteFolder::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFolder {
    type Output = ::std::result::Result<crate::operation::delete_folder::DeleteFolderOutput, crate::operation::delete_folder::DeleteFolderError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_folder::de_delete_folder_http_response_with_props(status, headers, body)
        }
    }
}
