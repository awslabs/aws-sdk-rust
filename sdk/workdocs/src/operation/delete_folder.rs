...
impl DeleteFolderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_folder::DeleteFolder,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/api/v1/folders/{FolderId}", FolderId = folder_id)
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_delete_folder::ser_delete_folder_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_folder::DeleteFolder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFolder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_folder::de_delete_folder_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_folder::de_delete_folder_http_response_with_props(
                status, headers, body,
            )
        }
    }
