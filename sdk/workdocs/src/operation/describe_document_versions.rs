...
impl DescribeDocumentVersionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDocumentVersions`](crate::operation::describe_document_versions::DescribeDocumentVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_document_versions::DescribeDocumentVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::describe_document_versions::DescribeDocumentVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_5) = &_input.fields {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_document_versions::DescribeDocumentVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDocumentVersions {
                type Output = std::result::Result<crate::operation::describe_document_versions::DescribeDocumentVersionsOutput, crate::operation::describe_document_versions::DescribeDocumentVersionsError>;
