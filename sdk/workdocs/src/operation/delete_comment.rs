    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_delete_comment::ser_delete_comment_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_comment::DeleteComment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteComment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_comment::de_delete_comment_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_comment::de_delete_comment_http_response_with_props(
                status, headers, body,
            )
        }
    }
