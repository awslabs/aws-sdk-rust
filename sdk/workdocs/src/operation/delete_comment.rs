...
impl DeleteCommentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteComment`](crate::operation::delete_comment::DeleteComment)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_comment::DeleteComment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_comment::DeleteComment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteComment {
    type Output = ::std::result::Result<crate::operation::delete_comment::DeleteCommentOutput, crate::operation::delete_comment::DeleteCommentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_comment::de_delete_comment_http_response_with_props(status, headers, body)
        }
    }
}
