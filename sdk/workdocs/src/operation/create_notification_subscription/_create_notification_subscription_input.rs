...
impl CreateNotificationSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_notification_subscription::CreateNotificationSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
