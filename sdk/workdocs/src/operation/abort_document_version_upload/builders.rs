...
impl crate::operation::abort_document_version_upload::builders::AbortDocumentVersionUploadInputBuilder {
...
impl AbortDocumentVersionUploadFluentBuilder {
    /// Creates a new `AbortDocumentVersionUploadFluentBuilder`.
