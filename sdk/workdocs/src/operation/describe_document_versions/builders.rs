...
impl DescribeDocumentVersionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_document_versions::DescribeDocumentVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_document_versions::DescribeDocumentVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_document_versions::DescribeDocumentVersionsOutput, crate::operation::describe_document_versions::DescribeDocumentVersionsError, Self> {
