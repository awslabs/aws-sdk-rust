...
impl DescribeFolderContentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFolderContents`](crate::operation::describe_folder_contents::DescribeFolderContents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_folder_contents::DescribeFolderContents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_folder_contents::DescribeFolderContentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_folder_contents::DescribeFolderContentsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.sort {
                     {
                        query.push_kv("sort", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.order {
                     {
                        query.push_kv("order", &aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                if let Some(inner_4) = &_input.limit {
                    if *inner_4 != 0 {
                        query.push_kv("limit", aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
                    }
                }
                if let Some(inner_5) = &_input.marker {
                     {
                        query.push_kv("marker", &aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                if let Some(inner_6) = &_input.r#type {
                     {
                        query.push_kv("type", &aws_smithy_http::query::fmt_string(&inner_6));
                    }
                }
                if let Some(inner_7) = &_input.include {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_folder_contents::DescribeFolderContents::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFolderContents {
                type Output = std::result::Result<crate::operation::describe_folder_contents::DescribeFolderContentsOutput, crate::operation::describe_folder_contents::DescribeFolderContentsError>;
