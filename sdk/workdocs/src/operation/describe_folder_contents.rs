...
/// Orchestration and serialization glue logic for `DescribeFolderContents`.
...
impl DescribeFolderContents {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_folder_contents::DescribeFolderContentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_folder_contents::DescribeFolderContentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_folder_contents::DescribeFolderContentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_folder_contents::DescribeFolderContentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFolderContents {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFolderContents");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFolderContentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFolderContentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFolderContents")
...
.with_interceptor(DescribeFolderContentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_folder_contents::DescribeFolderContentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_folder_contents::DescribeFolderContentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_folder_contents::DescribeFolderContentsError>::new());
...
#[derive(Debug)]
            struct DescribeFolderContentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFolderContentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_folder_contents::de_describe_folder_contents_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeFolderContentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFolderContentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_folder_contents::DescribeFolderContentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_folder_contents::DescribeFolderContentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/api/v1/folders/{FolderId}/contents", FolderId = folder_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::describe_folder_contents::DescribeFolderContentsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.sort {
         {
            query.push_kv("sort", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
    if let ::std::option::Option::Some(inner_3) = &_input.order {
         {
            query.push_kv("order", &::aws_smithy_http::query::fmt_string(inner_3));
        }
    }
    ...
    if let ::std::option::Option::Some(inner_5) = &_input.marker {
         {
            query.push_kv("marker", &::aws_smithy_http::query::fmt_string(inner_5));
        }
    }
    if let ::std::option::Option::Some(inner_6) = &_input.r#type {
         {
            query.push_kv("type", &::aws_smithy_http::query::fmt_string(inner_6));
        }
    }
    if let ::std::option::Option::Some(inner_7) = &_input.include {
         {
            query.push_kv("include", &::aws_smithy_http::query::fmt_string(inner_7));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct DescribeFolderContentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFolderContentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFolderContentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFolderContentsInput>()
                        .ok_or("failed to downcast to DescribeFolderContentsInput")?;
...
pub enum DescribeFolderContentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFolderContentsError) for what information is available for the error.")]
...
impl DescribeFolderContentsError {
    /// Creates the `DescribeFolderContentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFolderContentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFolderContentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_folder_contents::DescribeFolderContentsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_folder_contents::_describe_folder_contents_output::DescribeFolderContentsOutput;

pub use crate::operation::describe_folder_contents::_describe_folder_contents_input::DescribeFolderContentsInput;

mod _describe_folder_contents_input;

mod _describe_folder_contents_output;
