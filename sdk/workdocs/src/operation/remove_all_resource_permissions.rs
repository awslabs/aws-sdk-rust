...
impl RemoveAllResourcePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_all_resource_permissions::RemoveAllResourcePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveAllResourcePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_remove_all_resource_permissions::de_remove_all_resource_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
