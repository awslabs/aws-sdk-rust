    ...
    > {
        ...
        let mut request = {
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.labels {
                    {
                        for inner_3 in inner_2 {
                            query
                                .push_kv("labels", &::aws_smithy_http::query::fmt_string(&inner_3));
                        }
                    }
                }
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_delete_labels::ser_delete_labels_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_labels::DeleteLabels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLabels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_labels::de_delete_labels_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_labels::de_delete_labels_http_response_with_props(
                status, headers, body,
            )
        }
    }
