...
impl DeleteLabelsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLabels`](crate::operation::delete_labels::DeleteLabels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_labels::DeleteLabels, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_labels::DeleteLabelsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_labels::DeleteLabelsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_2) = &_input.labels {
                     {
                ...
                if let Some(inner_4) = &_input.delete_all {
                    if *inner_4 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_labels::DeleteLabels::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLabels {
                type Output = std::result::Result<crate::operation::delete_labels::DeleteLabelsOutput, crate::operation::delete_labels::DeleteLabelsError>;
