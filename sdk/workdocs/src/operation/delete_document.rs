...
impl DeleteDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_document::DeleteDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDocument {
    type Output =
        ::std::result::Result<crate::operation::delete_document::DeleteDocumentOutput, crate::operation::delete_document::DeleteDocumentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_document::de_delete_document_http_response_with_props(status, headers, body)
        }
    }
}
