    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_delete_document::ser_delete_document_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_document::DeleteDocument::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_document::de_delete_document_http_error(
                status, headers, body,
            )
        } else {
