...
impl DescribeResourcePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
