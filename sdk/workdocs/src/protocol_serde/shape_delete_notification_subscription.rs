...
pub fn de_delete_notification_subscription_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionOutput, crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_notification_subscription_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionOutput, crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
