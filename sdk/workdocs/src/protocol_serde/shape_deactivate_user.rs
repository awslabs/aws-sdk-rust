...
pub fn de_deactivate_user_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deactivate_user::DeactivateUserOutput, crate::operation::deactivate_user::DeactivateUserError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::deactivate_user::DeactivateUserError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deactivate_user_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deactivate_user::DeactivateUserOutput, crate::operation::deactivate_user::DeactivateUserError> {
    Ok({
        #[allow(unused_mut)]
