...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(
        crate::operation::describe_folder_contents::DescribeFolderContentsError::unhandled,
    )?;
...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_describe_folder_contents::de_describe_folder_contents(
