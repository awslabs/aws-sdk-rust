...
pub(crate) fn de_comment_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Comment>>, aws_smithy_json::deserialize::error::DeserializeError>
