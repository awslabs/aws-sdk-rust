...
pub(crate) fn de_response_item<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResponseItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_resource_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ResponseItemType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "FolderMetadata" => {
                                builder = builder.set_folder_metadata(
