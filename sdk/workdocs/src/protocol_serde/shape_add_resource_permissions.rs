...
pub fn de_add_resource_permissions_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::add_resource_permissions::AddResourcePermissionsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::add_resource_permissions::AddResourcePermissionsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "UnauthorizedOperationException" => {
            crate::operation::add_resource_permissions::AddResourcePermissionsError::UnauthorizedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedResourceAccessException" => {
            crate::operation::add_resource_permissions::AddResourcePermissionsError::UnauthorizedResourceAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_resource_permissions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_add_resource_permissions::de_add_resource_permissions(_response_body, output)
            .map_err(crate::operation::add_resource_permissions::AddResourcePermissionsError::unhandled)?;
...
pub(crate) fn de_add_resource_permissions(
    _value: &[u8],
    mut builder: crate::operation::add_resource_permissions::builders::AddResourcePermissionsOutputBuilder,
) -> ::std::result::Result<
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ShareResults" => {
                    builder = builder.set_share_results(crate::protocol_serde::shape_share_results_list::de_share_results_list(tokens, _value)?);
                }
