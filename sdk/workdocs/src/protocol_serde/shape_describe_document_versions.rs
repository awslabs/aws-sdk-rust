...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_document_versions::DescribeDocumentVersionsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_document_versions::DescribeDocumentVersionsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "UnauthorizedOperationException" => {
            crate::operation::describe_document_versions::DescribeDocumentVersionsError::UnauthorizedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedResourceAccessException" => {
            crate::operation::describe_document_versions::DescribeDocumentVersionsError::UnauthorizedResourceAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_document_versions::de_describe_document_versions(_response_body, output)
            .map_err(crate::operation::describe_document_versions::DescribeDocumentVersionsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DocumentVersions" => {
                    builder = builder.set_document_versions(
                        crate::protocol_serde::shape_document_version_metadata_list::de_document_version_metadata_list(tokens, _value, depth + 1)?,
                    );
                }
                "Marker" => {
