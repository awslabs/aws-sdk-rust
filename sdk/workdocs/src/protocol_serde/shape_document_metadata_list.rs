...
pub(crate) fn de_document_metadata_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DocumentMetadata>>, aws_smithy_json::deserialize::error::DeserializeError>
