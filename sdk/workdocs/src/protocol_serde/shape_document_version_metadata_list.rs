...
pub(crate) fn de_document_version_metadata_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DocumentVersionMetadata>>, aws_smithy_json::deserialize::error::DeserializeError>
