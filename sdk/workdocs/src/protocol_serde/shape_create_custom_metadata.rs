...
> {
    ...
    Err(match error_code {
        "CustomMetadataLimitExceededException" => {
            crate::operation::create_custom_metadata::CreateCustomMetadataError::CustomMetadataLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::CustomMetadataLimitExceededExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_custom_metadata_limit_exceeded_exception::de_custom_metadata_limit_exceeded_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_custom_metadata::CreateCustomMetadataError::unhandled)?;
        ...
        "UnauthorizedResourceAccessException" => {
            crate::operation::create_custom_metadata::CreateCustomMetadataError::UnauthorizedResourceAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
