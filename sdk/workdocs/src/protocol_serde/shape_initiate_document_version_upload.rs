...
#[allow(clippy::unnecessary_wraps)]
pub fn de_initiate_document_version_upload_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::initiate_document_version_upload::InitiateDocumentVersionUploadOutput, crate::operation::initiate_document_version_upload::InitiateDocumentVersionUploadError> {
    Ok({
        #[allow(unused_mut)]
