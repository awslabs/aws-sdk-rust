...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError::unhandled)?;
    ...
    Err(match error_code {
        "EntityNotExistsException" => {
            crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError::EntityNotExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_notification_subscriptions_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_notification_subscriptions::de_describe_notification_subscriptions(_response_body, output)
            .map_err(crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError::unhandled)?;
