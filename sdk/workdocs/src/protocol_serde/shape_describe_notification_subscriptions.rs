...
pub fn de_describe_notification_subscriptions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsOutput, crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_notification_subscriptions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsOutput, crate::operation::describe_notification_subscriptions::DescribeNotificationSubscriptionsError> {
    Ok({
        #[allow(unused_mut)]
