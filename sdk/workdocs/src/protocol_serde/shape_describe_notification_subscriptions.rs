...
pub fn de_describe_notification_subscriptions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNotificationSubscriptionsOutput, crate::error::DescribeNotificationSubscriptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeNotificationSubscriptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_notification_subscriptions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNotificationSubscriptionsOutput, crate::error::DescribeNotificationSubscriptionsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_notification_subscriptions(value: &[u8], mut builder: crate::output::describe_notification_subscriptions_output::Builder) -> Result<crate::output::describe_notification_subscriptions_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
