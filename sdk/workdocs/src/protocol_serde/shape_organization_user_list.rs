...
pub(crate) fn de_organization_user_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::User>>, aws_smithy_json::deserialize::error::DeserializeError>
