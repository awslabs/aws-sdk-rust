...
pub fn de_describe_root_folders_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_root_folders::DescribeRootFoldersOutput, crate::operation::describe_root_folders::DescribeRootFoldersError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_root_folders_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_root_folders::DescribeRootFoldersOutput, crate::operation::describe_root_folders::DescribeRootFoldersError> {
    Ok({
        #[allow(unused_mut)]
