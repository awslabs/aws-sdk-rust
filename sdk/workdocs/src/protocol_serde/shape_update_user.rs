    ...
    Err(match error_code {
        "DeactivatingLastSystemUserException" => crate::operation::update_user::UpdateUserError::DeactivatingLastSystemUserException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_deactivating_last_system_user_exception::de_deactivating_last_system_user_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::update_user::UpdateUserError::unhandled)?;
        ...
        "IllegalUserStateException" => crate::operation::update_user::UpdateUserError::IllegalUserStateException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_illegal_user_state_exception::de_illegal_user_state_exception_json_err(_response_body, output)
                    .map_err(crate::operation::update_user::UpdateUserError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
