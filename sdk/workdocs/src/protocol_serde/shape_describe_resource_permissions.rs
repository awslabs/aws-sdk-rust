...
pub fn de_describe_resource_permissions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsOutput, crate::operation::describe_resource_permissions::DescribeResourcePermissionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_resource_permissions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsOutput, crate::operation::describe_resource_permissions::DescribeResourcePermissionsError> {
    Ok({
        #[allow(unused_mut)]
