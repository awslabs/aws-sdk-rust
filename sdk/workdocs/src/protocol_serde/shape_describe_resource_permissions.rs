...
pub fn de_describe_resource_permissions_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsOutput, crate::operation::describe_resource_permissions::DescribeResourcePermissionsError> {
    #[allow(unused_mut)]
