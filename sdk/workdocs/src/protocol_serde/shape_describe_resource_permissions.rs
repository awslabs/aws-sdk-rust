...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::unhandled)?;
    ...
    Err(match error_code {
        "FailedDependencyException" => {
            crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::FailedDependencyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedOperationException" => {
            crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::UnauthorizedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedResourceAccessException" => {
            crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::UnauthorizedResourceAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_resource_permissions::de_describe_resource_permissions(_response_body, output)
            .map_err(crate::operation::describe_resource_permissions::DescribeResourcePermissionsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Principals" => {
                    builder = builder.set_principals(crate::protocol_serde::shape_principal_list::de_principal_list(tokens, _value, depth + 1)?);
                }
