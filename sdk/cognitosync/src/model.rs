...
pub struct Record  {
    ...
    #[doc(hidden)]pub sync_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub device_last_modified_date: std::option::Option<aws_smithy_types::DateTime>,
}
impl Record {
    /// The key for the record.
...
pub struct RecordPatch  {
    ...
    #[doc(hidden)]pub op: std::option::Option<crate::model::Operation>,
...
pub struct CognitoStreams  {
    ...
    #[doc(hidden)]pub streaming_status: std::option::Option<crate::model::StreamingStatus>,
}
impl CognitoStreams {
    /// The name of the Cognito stream to receive updates. This stream must be in the developers account and in the same region as the identity pool.
...
pub struct PushSync  {
    ...
    #[doc(hidden)]pub application_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct IdentityPoolUsage  {
    ...
    #[doc(hidden)]pub sync_sessions_count: std::option::Option<i64>,
    /// Data storage information for the identity pool.
    #[doc(hidden)]pub data_storage: std::option::Option<i64>,
...
pub struct Dataset  {
    ...
    #[doc(hidden)]pub num_records: std::option::Option<i64>,
}
impl Dataset {
    /// A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique within a region.
...
pub struct IdentityUsage  {
    ...
    #[doc(hidden)]pub dataset_count: i32,
