...
impl RegisterDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_device::RegisterDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_device::ser_register_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDevice {
    type Output =
        ::std::result::Result<crate::operation::register_device::RegisterDeviceOutput, crate::operation::register_device::RegisterDeviceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_device::de_register_device_http_response_with_props(status, headers, body)
        }
    }
}
