...
impl RegisterDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::register_device::RegisterDevice,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_device::RegisterDevice::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_device::de_register_device_http_error(
                status, headers, body,
            )
        } else {
