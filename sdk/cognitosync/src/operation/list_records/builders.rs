...
impl ListRecordsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_records::ListRecordsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_records::ListRecordsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_records::ListRecordsOutput, crate::operation::list_records::ListRecordsError, Self> {
    ...
    pub fn get_last_sync_count(&self) -> &::std::option::Option<i64> {
        self.inner.get_last_sync_count()
    }
