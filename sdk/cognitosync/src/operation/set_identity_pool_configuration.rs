...
impl SetIdentityPoolConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_identity_pool_configuration::SetIdentityPoolConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityPoolConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_identity_pool_configuration::de_set_identity_pool_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
