...
impl DescribeIdentityUsageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_identity_usage::DescribeIdentityUsageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_identity_usage::DescribeIdentityUsageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_identity_usage::DescribeIdentityUsageOutput, crate::operation::describe_identity_usage::DescribeIdentityUsageError, Self> {
