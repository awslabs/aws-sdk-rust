...
impl SubscribeToDataset {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::subscribe_to_dataset::SubscribeToDatasetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::subscribe_to_dataset::SubscribeToDatasetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Cognito Sync", "SubscribeToDataset", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Cognito Sync.SubscribeToDataset",
                "rpc.service" = "Cognito Sync",
                "rpc.method" = "SubscribeToDataset",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SubscribeToDataset {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SubscribeToDatasetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SubscribeToDatasetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SubscribeToDataset")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SubscribeToDataset")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SubscribeToDatasetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SubscribeToDatasetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SubscribeToDatasetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SubscribeToDatasetInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubscribeToDatasetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_subscribe_to_dataset::de_subscribe_to_dataset_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_subscribe_to_dataset::de_subscribe_to_dataset_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SubscribeToDatasetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::subscribe_to_dataset::SubscribeToDatasetInput>()
            .expect("correct type");
