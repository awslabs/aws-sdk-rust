...
impl DescribeIdentityUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_identity_usage::DescribeIdentityUsage,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIdentityUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_identity_usage::de_describe_identity_usage_http_response_with_props(status, headers, body)
        }
    }
}
