...
impl GetIdentityPoolConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_identity_pool_configuration::GetIdentityPoolConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentityPoolConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_identity_pool_configuration::de_get_identity_pool_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetIdentityPoolConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_identity_pool_configuration::GetIdentityPoolConfigurationError
{
