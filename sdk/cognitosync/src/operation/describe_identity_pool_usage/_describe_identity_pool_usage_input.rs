...
impl DescribeIdentityPoolUsageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_identity_pool_usage::DescribeIdentityPoolUsageInput, ::aws_smithy_types::error::operation::BuildError> {
