...
impl DescribeIdentityPoolUsageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_identity_pool_usage::DescribeIdentityPoolUsage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIdentityPoolUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_identity_pool_usage::de_describe_identity_pool_usage_http_response_with_props(status, headers, body)
        }
    }
}
