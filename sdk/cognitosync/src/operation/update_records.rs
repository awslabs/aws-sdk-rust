...
impl UpdateRecordsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_records::UpdateRecords, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_records::ser_update_records_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_records::de_update_records_http_response_with_props(status, headers, body)
        }
    }
}
