...
impl UpdateRecordsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_records::UpdateRecords::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_records::de_update_records_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_records::de_update_records_http_response_with_props(
                status, headers, body,
            )
        }
    }
