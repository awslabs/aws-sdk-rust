...
#[derive(Debug)]
    ...
    ::std::write!(output, "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets", IdentityPoolId = identity_pool_id, IdentityId = identity_id).expect("formatting should succeed");
