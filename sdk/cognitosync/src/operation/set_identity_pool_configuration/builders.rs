...
impl crate::operation::set_identity_pool_configuration::builders::SetIdentityPoolConfigurationInputBuilder {
...
impl SetIdentityPoolConfigurationFluentBuilder {
    /// Creates a new `SetIdentityPoolConfigurationFluentBuilder`.
