...
impl ListIdentityPoolUsageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_identity_pool_usage::ListIdentityPoolUsageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_identity_pool_usage::ListIdentityPoolUsageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_identity_pool_usage::ListIdentityPoolUsageOutput, crate::operation::list_identity_pool_usage::ListIdentityPoolUsageError, Self> {
