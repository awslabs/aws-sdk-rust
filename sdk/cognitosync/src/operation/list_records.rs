...
impl ListRecordsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_records::ListRecords,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_records::ListRecords::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_records::de_list_records_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_records::de_list_records_http_response_with_props(
                status, headers, body,
            )
        }
    }
