...
/// Orchestration and serialization glue logic for `BulkPublish`.
...
impl BulkPublish {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::bulk_publish::BulkPublishInput,
                    ) -> ::std::result::Result<crate::operation::bulk_publish::BulkPublishOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::bulk_publish::BulkPublishError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::bulk_publish::BulkPublishError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::bulk_publish::BulkPublishOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BulkPublish {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BulkPublish");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BulkPublishRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BulkPublishResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BulkPublish")
...
.with_interceptor(BulkPublishEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::bulk_publish::BulkPublishError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::bulk_publish::BulkPublishError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::bulk_publish::BulkPublishError>::new());
...
#[derive(Debug)]
            struct BulkPublishResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BulkPublishResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_bulk_publish::de_bulk_publish_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_bulk_publish::de_bulk_publish_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BulkPublishRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BulkPublishRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::bulk_publish::BulkPublishInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::bulk_publish::BulkPublishInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/identitypools/{IdentityPoolId}/bulkpublish", IdentityPoolId = identity_pool_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct BulkPublishEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BulkPublishEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BulkPublishEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BulkPublishInput>()
                        .ok_or("failed to downcast to BulkPublishInput")?;
...
pub enum BulkPublishError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BulkPublishError) for what information is available for the error.")]
...
impl BulkPublishError {
    /// Creates the `BulkPublishError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BulkPublishError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AlreadyStreamedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BulkPublishError {
...
impl ::aws_types::request_id::RequestId for crate::operation::bulk_publish::BulkPublishError {
