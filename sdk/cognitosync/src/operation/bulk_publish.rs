...
impl BulkPublishInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::bulk_publish::BulkPublish,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::bulk_publish::BulkPublish::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BulkPublish {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_bulk_publish::de_bulk_publish_http_error(
                status, headers, body,
            )
        } else {
