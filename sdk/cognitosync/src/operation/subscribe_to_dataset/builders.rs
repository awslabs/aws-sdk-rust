...
impl SubscribeToDatasetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::subscribe_to_dataset::SubscribeToDatasetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::subscribe_to_dataset::SubscribeToDatasetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::subscribe_to_dataset::SubscribeToDatasetOutput, crate::operation::subscribe_to_dataset::SubscribeToDatasetError, Self> {
