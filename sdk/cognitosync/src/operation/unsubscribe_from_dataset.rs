...
impl UnsubscribeFromDatasetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unsubscribe_from_dataset::UnsubscribeFromDataset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnsubscribeFromDataset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_unsubscribe_from_dataset::de_unsubscribe_from_dataset_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::unsubscribe_from_dataset::UnsubscribeFromDatasetError
{
