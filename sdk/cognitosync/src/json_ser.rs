...
pub fn serialize_structure_register_device_input(
...
pub fn serialize_structure_set_cognito_events_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_set_identity_pool_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_7) = &input.cognito_streams {
        ...
        crate::json_ser::serialize_structure_cognito_streams(&mut object_8, var_7);
        object_8.finish();
    }
    if let Some(var_9) = &input.push_sync {
        let mut object_10 = object.key("PushSync").start_object();
        crate::json_ser::serialize_structure_push_sync(&mut object_10, var_9);
        object_10.finish();
    }
}

pub fn serialize_structure_update_records_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_14 in var_12 {
            {
                ...
                crate::json_ser::serialize_structure_record_patch(&mut object_15, item_14);
                object_15.finish();
            }
        }
        array_13.finish();
...
pub fn serialize_structure_cognito_streams(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_push_sync(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_record_patch(
    object: &mut smithy_json::serialize::JsonObjectWriter,
