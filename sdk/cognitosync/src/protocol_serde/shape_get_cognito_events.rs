...
pub fn de_get_cognito_events_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_cognito_events::GetCognitoEventsOutput, crate::operation::get_cognito_events::GetCognitoEventsError> {
    #[allow(unused_mut)]
...
pub fn de_get_cognito_events_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_cognito_events::de_get_cognito_events(_response_body, output)
            .map_err(crate::operation::get_cognito_events::GetCognitoEventsError::unhandled)?;
...
) -> Result<crate::operation::get_cognito_events::builders::GetCognitoEventsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
