...
pub fn de_bulk_publish_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::bulk_publish::BulkPublishOutput, crate::operation::bulk_publish::BulkPublishError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::bulk_publish::builders::BulkPublishOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
