...
pub fn de_bulk_publish_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BulkPublishOutput, crate::error::BulkPublishError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::BulkPublishError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_bulk_publish_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BulkPublishOutput, crate::error::BulkPublishError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::bulk_publish_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_bulk_publish::de_bulk_publish(response.body().as_ref(), output).map_err(crate::error::BulkPublishError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_bulk_publish(value: &[u8], mut builder: crate::output::bulk_publish_output::Builder) -> Result<crate::output::bulk_publish_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
