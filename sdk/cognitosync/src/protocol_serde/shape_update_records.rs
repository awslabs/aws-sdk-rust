...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_records::UpdateRecordsError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_update_records::de_update_records(_response_body, output)
                .map_err(crate::operation::update_records::UpdateRecordsError::unhandled)?;
