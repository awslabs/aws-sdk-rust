...
pub fn de_update_records_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_records::UpdateRecordsOutput, crate::operation::update_records::UpdateRecordsError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "InvalidLambdaFunctionOutputException" => crate::operation::update_records::UpdateRecordsError::InvalidLambdaFunctionOutputException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_lambda_function_output_exception::de_invalid_lambda_function_output_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::update_records::UpdateRecordsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_records_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_records::UpdateRecordsOutput, crate::operation::update_records::UpdateRecordsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_records::de_update_records(_response_body, output)
            .map_err(crate::operation::update_records::UpdateRecordsError::unhandled)?;
...
pub(crate) fn de_update_records(
    value: &[u8],
    mut builder: crate::operation::update_records::builders::UpdateRecordsOutputBuilder,
) -> Result<crate::operation::update_records::builders::UpdateRecordsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
