...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_identity_usage::de_describe_identity_usage(_response_body, output)
            .map_err(crate::operation::describe_identity_usage::DescribeIdentityUsageError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "IdentityUsage" => {
                    builder = builder.set_identity_usage(crate::protocol_serde::shape_identity_usage::de_identity_usage(tokens, _value, depth + 1)?);
                }
