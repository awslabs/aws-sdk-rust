...
pub fn de_register_device_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_register_device::de_register_device(_response_body, output)
            .map_err(crate::operation::register_device::RegisterDeviceError::unhandled)?;
...
) -> Result<crate::operation::register_device::builders::RegisterDeviceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
