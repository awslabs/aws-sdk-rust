...
pub fn ser_record_patch(
    ...
    if let Some(var_1) = &input.value {
     ...
     {
        object.key("SyncCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.sync_count).into()));
    }
    if let Some(var_2) = &input.device_last_modified_date {
        object.key("DeviceLastModifiedDate").date_time(var_2, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
