...
impl super::Client {
    ...
    ///   - [`identity_pool_id(impl ::std::convert::Into<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::identity_pool_id) / [`set_identity_pool_id(Option<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_identity_pool_id): <p>A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. Here, the ID of the pool that the identity belongs to.</p>
    ///   - [`identity_id(impl ::std::convert::Into<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::identity_id) / [`set_identity_id(Option<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_identity_id): <p>The unique ID for this identity.</p>
    ...
    ///   - [`token(impl ::std::convert::Into<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_token): <p>The push token.</p>
