...
impl super::Client {
    ...
    ///   - [`identity_id(impl Into<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::identity_id) / [`set_identity_id(Option<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_identity_id):<br>required: **true**<br><p>The unique ID for this identity.</p><br>
    ///   - [`platform(Platform)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::platform) / [`set_platform(Option<Platform>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_platform):<br>required: **true**<br><p>The SNS platform type (e.g. GCM, SDM, APNS, APNS_SANDBOX).</p><br>
    ///   - [`token(impl Into<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::register_device::builders::RegisterDeviceFluentBuilder::set_token):<br>required: **true**<br><p>The push token.</p><br>
