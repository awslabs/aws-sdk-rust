...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_records::builders::ListRecordsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_records::builders::ListRecordsFluentBuilder::set_max_results): The maximum number of results to be returned.
