...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("socialmessaging", "UntagResource", input, runtime_plugins, stop_point)
            .await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/v1/tags/untag-resource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl UntagResourceError {
    ...
    /// Returns `true` if the error kind is `UntagResourceError::InvalidParametersException`.
    pub fn is_invalid_parameters_exception(&self) -> bool {
        matches!(self, Self::InvalidParametersException(_))
    }
    /// Returns `true` if the error kind is `UntagResourceError::ThrottledRequestException`.
