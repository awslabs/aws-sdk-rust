...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SocialMessaging", "TagResource", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/v1/tags/tag-resource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl TagResourceError {
    ...
    /// Returns `true` if the error kind is `TagResourceError::InvalidParametersException`.
    pub fn is_invalid_parameters_exception(&self) -> bool {
        matches!(self, Self::InvalidParametersException(_))
    }
    /// Returns `true` if the error kind is `TagResourceError::ThrottledRequestException`.
