...
pub struct CreateWhatsAppFlowOutput {
...
impl ::aws_types::request_id::RequestId for CreateWhatsAppFlowOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateWhatsAppFlowOutput {
    /// Creates a new builder-style object to manufacture [`CreateWhatsAppFlowOutput`](crate::operation::create_whats_app_flow::CreateWhatsAppFlowOutput).
    pub fn builder() -> crate::operation::create_whats_app_flow::builders::CreateWhatsAppFlowOutputBuilder {
        crate::operation::create_whats_app_flow::builders::CreateWhatsAppFlowOutputBuilder::default()
    }
}

/// A builder for [`CreateWhatsAppFlowOutput`](crate::operation::create_whats_app_flow::CreateWhatsAppFlowOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateWhatsAppFlowOutputBuilder {
...
impl CreateWhatsAppFlowOutputBuilder {
    /// <p>The unique identifier assigned to the Flow by Meta.</p>
    ...
    /// Consumes the builder and constructs a [`CreateWhatsAppFlowOutput`](crate::operation::create_whats_app_flow::CreateWhatsAppFlowOutput).
    pub fn build(self) -> crate::operation::create_whats_app_flow::CreateWhatsAppFlowOutput {
