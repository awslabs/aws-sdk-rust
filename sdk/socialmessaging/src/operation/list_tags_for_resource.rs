...
impl ListTagsForResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "SocialMessaging.ListTagsForResource",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v1/tags/list").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_tags_for_resource::ListTagsForResourceInput,
...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::InvalidParametersException`.
    pub fn is_invalid_parameters_exception(&self) -> bool {
        matches!(self, Self::InvalidParametersException(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::ThrottledRequestException`.
