...
/// Types for the `CreateWhatsAppMessageTemplateFromLibrary` operation.
pub mod create_whats_app_message_template_from_library;
...
/// Types for the `GetWhatsAppMessageTemplate` operation.
pub mod get_whats_app_message_template;
...
/// Types for the `ListWhatsAppTemplateLibrary` operation.
pub mod list_whats_app_template_library;
