...
> {
    ...
    Err(match error_code {
        ...
        "InvalidParametersException" => crate::operation::list_tags_for_resource::ListTagsForResourceError::InvalidParametersException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottledRequestException" => crate::operation::list_tags_for_resource::ListTagsForResourceError::ThrottledRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
