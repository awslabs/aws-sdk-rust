...
pub fn de_untag_resource_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidParametersException" => crate::operation::untag_resource::UntagResourceError::InvalidParametersException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottledRequestException" => crate::operation::untag_resource::UntagResourceError::ThrottledRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
