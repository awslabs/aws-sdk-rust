...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the resource to retrieve the tags from.</p><br>
    ...
    ///   - [`status_code(Option<i32>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::status_code): <p>The status code of the response.</p>
