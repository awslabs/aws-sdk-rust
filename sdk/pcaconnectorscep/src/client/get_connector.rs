...
impl super::Client {
    ...
    ///   - [`connector_arn(impl Into<String>)`](crate::operation::get_connector::builders::GetConnectorFluentBuilder::connector_arn) / [`set_connector_arn(Option<String>)`](crate::operation::get_connector::builders::GetConnectorFluentBuilder::set_connector_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the connector.</p><br>
    /// - On success, responds with [`GetConnectorOutput`](crate::operation::get_connector::GetConnectorOutput) with field(s):
    ///   - [`connector(Option<Connector>)`](crate::operation::get_connector::GetConnectorOutput::connector): <p>The properties of the connector.</p>
