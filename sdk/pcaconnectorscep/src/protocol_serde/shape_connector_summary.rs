                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MobileDeviceManagement" => {
                            builder = builder.set_mobile_device_management(
                                crate::protocol_serde::shape_mobile_device_management::de_mobile_device_management(tokens)?,
                            );
                        }
                        "OpenIdConfiguration" => {
                            builder = builder
                                .set_open_id_configuration(crate::protocol_serde::shape_open_id_configuration::de_open_id_configuration(tokens)?);
                        }
                        "Status" => {
