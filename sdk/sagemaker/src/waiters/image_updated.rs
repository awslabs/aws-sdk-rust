...
///
/// Fluent builder for the `image_updated` waiter.
///
...
pub struct ImageUpdatedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_image::builders::DescribeImageInputBuilder,
}
impl ImageUpdatedFluentBuilder {
    /// Creates a new `ImageUpdatedFluentBuilder`.
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::image_updated::ImageUpdatedFinalPoll, crate::waiters::image_updated::WaitUntilImageUpdatedError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            // Matches: {"output":{"path":"ImageStatus","expected":"UPDATE_FAILED","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_describe_image_9b4d2d3be79e89bf6(result) {
...
/// Successful return type for the `image_updated` waiter.
pub type ImageUpdatedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_image::DescribeImageOutput,
...
/// Error type for the `image_updated` waiter.
pub type WaitUntilImageUpdatedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_image::DescribeImageOutput,
    crate::operation::describe_image::DescribeImageError,
>;
