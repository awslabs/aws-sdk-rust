...
impl EvaluationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EvaluationType::BenchmarkEvaluation => "BenchmarkEvaluation",
            EvaluationType::CustomScorerEvaluation => "CustomScorerEvaluation",
            EvaluationType::LlmajEvaluation => "LLMAJEvaluation",
            EvaluationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["BenchmarkEvaluation", "CustomScorerEvaluation", "LLMAJEvaluation"]
    }
}
...
impl ::std::fmt::Display for EvaluationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EvaluationType::BenchmarkEvaluation => write!(f, "BenchmarkEvaluation"),
            EvaluationType::CustomScorerEvaluation => write!(f, "CustomScorerEvaluation"),
            EvaluationType::LlmajEvaluation => write!(f, "LLMAJEvaluation"),
