...
impl OfflineStoreConfigBuilder {
    ...
    pub fn set_s3_storage_config(
        mut self,
        input: ::std::option::Option<crate::types::S3StorageConfig>,
    ) -> Self {
    ...
    pub fn set_data_catalog_config(
        mut self,
        input: ::std::option::Option<crate::types::DataCatalogConfig>,
    ) -> Self {
        self.data_catalog_config = input;
        self
    }
    /// <p>The meta data of the Glue table that is autogenerated when an <code>OfflineStore</code> is created. </p>
    pub fn get_data_catalog_config(
        &self,
    ) -> &::std::option::Option<crate::types::DataCatalogConfig> {
    ...
    pub fn set_table_format(
        mut self,
        input: ::std::option::Option<crate::types::TableFormat>,
    ) -> Self {
