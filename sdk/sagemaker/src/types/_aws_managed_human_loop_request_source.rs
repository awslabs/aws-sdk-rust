...
impl AwsManagedHumanLoopRequestSource {
    ...
    AwsManagedHumanLoopRequestSource::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AWS/Bedrock/ModelEvaluation", "AWS/Handshake/VerifyIdentity", "AWS/Rekognition/DetectModerationLabels/Image/V3", "AWS/Textract/AnalyzeDocument/Forms/V1", "AWS/Textract/AnalyzeExpense"]
                }
            }
...
AwsManagedHumanLoopRequestSource::RekognitionDetectModerationLabelsImageV3 => write!(f, "AWS/Rekognition/DetectModerationLabels/Image/V3"),
