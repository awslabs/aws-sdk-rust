...
impl HubContent {
    /// Creates a new builder-style object to manufacture [`HubContent`](crate::types::HubContent).
    pub fn builder() -> crate::types::builders::HubContentBuilder {
        crate::types::builders::HubContentBuilder::default()
    }
}

/// A builder for [`HubContent`](crate::types::HubContent).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct HubContentBuilder {
...
impl HubContentBuilder {
    ...
    /// Consumes the builder and constructs a [`HubContent`](crate::types::HubContent).
    pub fn build(self) -> crate::types::HubContent {
        crate::types::HubContent {
