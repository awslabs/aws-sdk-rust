...
impl ::std::convert::From<&str> for ModelCardVersionSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardVersionSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardVersionSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardVersionSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardVersionSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
