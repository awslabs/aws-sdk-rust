...
impl ResourceType {
    ...
    ResourceType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["Endpoint", "Experiment", "ExperimentTrial", "ExperimentTrialComponent", "FeatureGroup", "FeatureMetadata", "HyperParameterTuningJob", "Image", "ImageVersion", "Model", "ModelCard", "ModelPackage", "ModelPackageGroup", "Pipeline", "PipelineExecution", "Project", "TrainingJob"]
                }
            }
