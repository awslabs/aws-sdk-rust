...
impl ::std::convert::From<&str> for ProfilingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProfilingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProfilingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProfilingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProfilingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
