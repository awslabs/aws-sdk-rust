...
impl SecondaryStatus {
    ...
    SecondaryStatus::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["Completed", "Downloading", "DownloadingTrainingImage", "Failed", "Interrupted", "LaunchingMLInstances", "MaxRuntimeExceeded", "MaxWaitTimeExceeded", "Pending", "PreparingTrainingStack", "Restarting", "Starting", "Stopped", "Stopping", "Training", "Updating", "Uploading"]
                }
            }
