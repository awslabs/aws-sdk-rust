...
impl  ContainerConfig  {
    ...
    /// <p>The environment variables to set in the container</p>
    pub fn container_environment_variables(&self) -> ::std::option::Option<& ::std::collections::HashMap::<::std::string::String, ::std::string::String>> {
...
impl ContainerConfigBuilder {
    ...
    ///
    /// <p>The environment variables to set in the container</p>
    pub fn container_environment_variables(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    /// <p>The environment variables to set in the container</p>
    pub fn set_container_environment_variables(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>>) -> Self {
        self.container_environment_variables = input; self
    }
    /// <p>The environment variables to set in the container</p>
    pub fn get_container_environment_variables(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>> {
