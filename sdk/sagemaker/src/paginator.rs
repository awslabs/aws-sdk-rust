                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListAlgorithmsOutput, aws_smithy_http::result::SdkError<crate::error::ListAlgorithmsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_algorithms_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListAutoMlJobsOutput, aws_smithy_http::result::SdkError<crate::error::ListAutoMLJobsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_auto_ml_jobs_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListCodeRepositoriesOutput, aws_smithy_http::result::SdkError<crate::error::ListCodeRepositoriesError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_code_repositories_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListDeviceFleetsOutput, aws_smithy_http::result::SdkError<crate::error::ListDeviceFleetsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_device_fleets_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListInferenceExperimentsOutput, aws_smithy_http::result::SdkError<crate::error::ListInferenceExperimentsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_inference_experiments_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListModelCardExportJobsOutput, aws_smithy_http::result::SdkError<crate::error::ListModelCardExportJobsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_model_card_export_jobs_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListModelCardsOutput, aws_smithy_http::result::SdkError<crate::error::ListModelCardsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_model_cards_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListModelCardVersionsOutput, aws_smithy_http::result::SdkError<crate::error::ListModelCardVersionsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_model_card_versions_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListMonitoringAlertsOutput, aws_smithy_http::result::SdkError<crate::error::ListMonitoringAlertsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_monitoring_alerts_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListWorkforcesOutput, aws_smithy_http::result::SdkError<crate::error::ListWorkforcesError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_workforces_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::QueryLineageOutput, aws_smithy_http::result::SdkError<crate::error::QueryLineageError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_query_lineage_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
...
/// Flattened paginator for `ListActionsPaginator`
                ...
                impl  ListActionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ActionSummary, aws_smithy_http::result::SdkError<crate::error::ListActionsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_actions_output_action_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListAlgorithmsPaginator`
                ...
                impl  ListAlgorithmsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AlgorithmSummary, aws_smithy_http::result::SdkError<crate::error::ListAlgorithmsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_algorithms_output_algorithm_summary_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListAppsPaginator`
                ...
                impl  ListAppsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AppDetails, aws_smithy_http::result::SdkError<crate::error::ListAppsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_apps_output_apps(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListAssociationsPaginator`
                ...
                impl  ListAssociationsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AssociationSummary, aws_smithy_http::result::SdkError<crate::error::ListAssociationsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_associations_output_association_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListAutoMlJobsPaginator`
                ...
                impl  ListAutoMlJobsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AutoMlJobSummary, aws_smithy_http::result::SdkError<crate::error::ListAutoMLJobsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_auto_ml_jobs_output_auto_ml_job_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListCodeRepositoriesPaginator`
                ...
                impl  ListCodeRepositoriesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::CodeRepositorySummary, aws_smithy_http::result::SdkError<crate::error::ListCodeRepositoriesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_code_repositories_output_code_repository_summary_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListDeviceFleetsPaginator`
                ...
                impl  ListDeviceFleetsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::DeviceFleetSummary, aws_smithy_http::result::SdkError<crate::error::ListDeviceFleetsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_device_fleets_output_device_fleet_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListExperimentsPaginator`
                ...
                impl  ListExperimentsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ExperimentSummary, aws_smithy_http::result::SdkError<crate::error::ListExperimentsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_experiments_output_experiment_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListImagesPaginator`
                ...
                impl  ListImagesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Image, aws_smithy_http::result::SdkError<crate::error::ListImagesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_images_output_images(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListInferenceExperimentsPaginator`
                ...
                impl  ListInferenceExperimentsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::InferenceExperimentSummary, aws_smithy_http::result::SdkError<crate::error::ListInferenceExperimentsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_inference_experiments_output_inference_experiments(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListInferenceRecommendationsJobStepsPaginator`
                ...
                impl  ListInferenceRecommendationsJobStepsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::InferenceRecommendationsJobStep, aws_smithy_http::result::SdkError<crate::error::ListInferenceRecommendationsJobStepsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_inference_recommendations_job_steps_output_steps(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListModelBiasJobDefinitionsPaginator`
                ...
                impl  ListModelBiasJobDefinitionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::MonitoringJobDefinitionSummary, aws_smithy_http::result::SdkError<crate::error::ListModelBiasJobDefinitionsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_model_bias_job_definitions_output_job_definition_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListModelCardExportJobsPaginator`
                ...
                impl  ListModelCardExportJobsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ModelCardExportJobSummary, aws_smithy_http::result::SdkError<crate::error::ListModelCardExportJobsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_model_card_export_jobs_output_model_card_export_job_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListModelCardsPaginator`
                ...
                impl  ListModelCardsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ModelCardSummary, aws_smithy_http::result::SdkError<crate::error::ListModelCardsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_model_cards_output_model_card_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListModelCardVersionsPaginator`
                ...
                impl  ListModelCardVersionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ModelCardVersionSummary, aws_smithy_http::result::SdkError<crate::error::ListModelCardVersionsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_model_card_versions_output_model_card_version_summary_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListMonitoringAlertHistoryPaginator`
                ...
                impl  ListMonitoringAlertHistoryPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::MonitoringAlertHistorySummary, aws_smithy_http::result::SdkError<crate::error::ListMonitoringAlertHistoryError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_monitoring_alert_history_output_monitoring_alert_history(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListMonitoringAlertsPaginator`
                ...
                impl  ListMonitoringAlertsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::MonitoringAlertSummary, aws_smithy_http::result::SdkError<crate::error::ListMonitoringAlertsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_monitoring_alerts_output_monitoring_alert_summaries(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListPipelineExecutionStepsPaginator`
                ...
                impl  ListPipelineExecutionStepsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::PipelineExecutionStep, aws_smithy_http::result::SdkError<crate::error::ListPipelineExecutionStepsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_pipeline_execution_steps_output_pipeline_execution_steps(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListWorkforcesPaginator`
                ...
                impl  ListWorkforcesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Workforce, aws_smithy_http::result::SdkError<crate::error::ListWorkforcesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_workforces_output_workforces(page).unwrap_or_default().into_iter())
                    }
                }
