...
impl ListPipelineParametersForExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_pipeline_parameters_for_execution::ListPipelineParametersForExecution,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_pipeline_parameters_for_execution::ListPipelineParametersForExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPipelineParametersForExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pipeline_parameters_for_execution::de_list_pipeline_parameters_for_execution_http_response_with_props(
                status, headers, body,
            )
        }
    }
