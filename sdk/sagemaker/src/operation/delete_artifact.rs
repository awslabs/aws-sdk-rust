...
impl DeleteArtifactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_artifact::DeleteArtifact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_artifact::ser_delete_artifact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_artifact::de_delete_artifact_http_response_with_props(status, headers, body)
        }
    }
}
