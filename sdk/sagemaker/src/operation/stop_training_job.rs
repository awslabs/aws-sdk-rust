...
impl StopTrainingJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_training_job::StopTrainingJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_training_job::ser_stop_training_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrainingJob {
    type Output =
        ::std::result::Result<crate::operation::stop_training_job::StopTrainingJobOutput, crate::operation::stop_training_job::StopTrainingJobError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_training_job::de_stop_training_job_http_response_with_props(status, headers, body)
        }
    }
}
