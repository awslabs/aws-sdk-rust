    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_model_package_group::CreateModelPackageGroupError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_model_package_group::CreateModelPackageGroupOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateModelPackageGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateModelPackageGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_model_package_group::CreateModelPackageGroupInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateModelPackageGroupEndpointParamsInterceptor {
...
pub type CreateModelPackageGroupErrorKind = CreateModelPackageGroupError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateModelPackageGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_model_package_group::CreateModelPackageGroupError {
...
impl CreateModelPackageGroupError {
    ...
    /// Creates the `CreateModelPackageGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
