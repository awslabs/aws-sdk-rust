...
impl UpdateMonitoringScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_monitoring_schedule::UpdateMonitoringScheduleInput, ::aws_smithy_types::error::operation::BuildError> {
