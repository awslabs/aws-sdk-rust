...
pub use crate::operation::describe_transform_job::_describe_transform_job_output::DescribeTransformJobOutputBuilder;
...
pub struct DescribeTransformJobFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_transform_job::builders::DescribeTransformJobInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_transform_job::DescribeTransformJobOutput,
                    crate::operation::describe_transform_job::DescribeTransformJobError,
                > for DescribeTransformJobFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeTransformJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_transform_job::DescribeTransformJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_transform_job::DescribeTransformJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_transform_job::DescribeTransformJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_transform_job::DescribeTransformJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_transform_job::DescribeTransformJobOutput, crate::operation::describe_transform_job::DescribeTransformJobError, Self> {
