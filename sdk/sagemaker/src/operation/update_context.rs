...
impl UpdateContextInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_context::UpdateContext, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_context::ser_update_context_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContext {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_context::de_update_context_http_response_with_props(status, headers, body)
        }
    }
}
