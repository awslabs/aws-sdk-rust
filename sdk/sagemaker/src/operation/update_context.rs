...
impl UpdateContextInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_context::UpdateContext::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContext {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_context::de_update_context_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_context::de_update_context_http_response_with_props(
                status, headers, body,
            )
        }
    }
