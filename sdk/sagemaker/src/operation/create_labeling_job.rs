...
/// Orchestration and serialization glue logic for `CreateLabelingJob`.
...
impl CreateLabelingJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_labeling_job::CreateLabelingJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_labeling_job::CreateLabelingJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_labeling_job::CreateLabelingJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_labeling_job::CreateLabelingJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLabelingJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLabelingJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLabelingJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLabelingJobResponseDeserializer));
...
.with_interceptor(CreateLabelingJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_labeling_job::CreateLabelingJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_labeling_job::CreateLabelingJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_labeling_job::CreateLabelingJobError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_labeling_job::de_create_labeling_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_labeling_job::de_create_labeling_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLabelingJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLabelingJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_labeling_job::CreateLabelingJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_labeling_job::CreateLabelingJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_labeling_job::ser_create_labeling_job_input(&input)?);
...
#[derive(Debug)]
            struct CreateLabelingJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLabelingJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLabelingJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLabelingJobInput>()
                        .ok_or("failed to downcast to CreateLabelingJobInput")?;
...
/// Error type for the `CreateLabelingJobError` operation.
#[non_exhaustive]
...
pub enum CreateLabelingJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLabelingJobError) for what information is available for the error.")]
...
impl CreateLabelingJobError {
    /// Creates the `CreateLabelingJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLabelingJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateLabelingJobError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateLabelingJobError::ResourceLimitExceeded`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateLabelingJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLabelingJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_labeling_job::CreateLabelingJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_labeling_job::_create_labeling_job_output::CreateLabelingJobOutput;

pub use crate::operation::create_labeling_job::_create_labeling_job_input::CreateLabelingJobInput;

mod _create_labeling_job_input;

mod _create_labeling_job_output;
