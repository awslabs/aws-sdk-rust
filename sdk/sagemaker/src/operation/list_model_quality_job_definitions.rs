...
impl ListModelQualityJobDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListModelQualityJobDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_model_quality_job_definitions::de_list_model_quality_job_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
