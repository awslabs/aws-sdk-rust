...
impl DeleteEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_endpoint::DeleteEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_endpoint::ser_delete_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEndpoint {
    type Output =
        ::std::result::Result<crate::operation::delete_endpoint::DeleteEndpointOutput, crate::operation::delete_endpoint::DeleteEndpointError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_endpoint::de_delete_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
