...
impl ListEdgeDeploymentPlansInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_edge_deployment_plans::ListEdgeDeploymentPlansInput, ::aws_smithy_types::error::operation::BuildError> {
