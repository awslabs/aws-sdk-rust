...
impl SendPipelineExecutionStepSuccessInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendPipelineExecutionStepSuccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_pipeline_execution_step_success::de_send_pipeline_execution_step_success_http_response_with_props(
                status, headers, body,
            )
        }
    }
