...
impl SendPipelineExecutionStepSuccess {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendPipelineExecutionStepSuccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SendPipelineExecutionStepSuccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SendPipelineExecutionStepSuccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SendPipelineExecutionStepSuccessResponseDeserializer));
...
.with_interceptor(SendPipelineExecutionStepSuccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError>::new());
...
#[derive(Debug)]
            struct SendPipelineExecutionStepSuccessResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendPipelineExecutionStepSuccessResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_send_pipeline_execution_step_success::de_send_pipeline_execution_step_success_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_send_pipeline_execution_step_success::de_send_pipeline_execution_step_success_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SendPipelineExecutionStepSuccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendPipelineExecutionStepSuccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_send_pipeline_execution_step_success::ser_send_pipeline_execution_step_success_input(&input)?);
...
#[derive(Debug)]
            struct SendPipelineExecutionStepSuccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendPipelineExecutionStepSuccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SendPipelineExecutionStepSuccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SendPipelineExecutionStepSuccessInput>()
                        .ok_or("failed to downcast to SendPipelineExecutionStepSuccessInput")?;
...
/// Error type for the `SendPipelineExecutionStepSuccessError` operation.
#[non_exhaustive]
...
pub enum SendPipelineExecutionStepSuccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SendPipelineExecutionStepSuccessError) for what information is available for the error.")]
...
impl SendPipelineExecutionStepSuccessError {
    /// Creates the `SendPipelineExecutionStepSuccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendPipelineExecutionStepSuccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `SendPipelineExecutionStepSuccessError::ResourceNotFound`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SendPipelineExecutionStepSuccessError {
...
impl ::aws_types::request_id::RequestId for crate::operation::send_pipeline_execution_step_success::SendPipelineExecutionStepSuccessError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::send_pipeline_execution_step_success::_send_pipeline_execution_step_success_output::SendPipelineExecutionStepSuccessOutput;

pub use crate::operation::send_pipeline_execution_step_success::_send_pipeline_execution_step_success_input::SendPipelineExecutionStepSuccessInput;

mod _send_pipeline_execution_step_success_input;

mod _send_pipeline_execution_step_success_output;
