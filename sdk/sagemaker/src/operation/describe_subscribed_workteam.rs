...
impl DescribeSubscribedWorkteamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteam,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteam::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSubscribedWorkteam {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_subscribed_workteam::de_describe_subscribed_workteam_http_response_with_props(status, headers, body)
        }
    }
}
