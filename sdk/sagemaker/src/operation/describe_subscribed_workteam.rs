    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteamError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteamOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSubscribedWorkteam {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSubscribedWorkteam", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSubscribedWorkteam")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSubscribedWorkteamResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSubscribedWorkteamRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteamInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSubscribedWorkteamEndpointParamsInterceptor {
...
pub type DescribeSubscribedWorkteamErrorKind = DescribeSubscribedWorkteamError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSubscribedWorkteamError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteamError {
...
impl DescribeSubscribedWorkteamError {
    ...
    /// Creates the `DescribeSubscribedWorkteamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
