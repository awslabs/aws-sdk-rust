    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_bias_job_definitions::ListModelBiasJobDefinitionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_bias_job_definitions::ListModelBiasJobDefinitionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListModelBiasJobDefinitions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListModelBiasJobDefinitions", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListModelBiasJobDefinitions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListModelBiasJobDefinitionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListModelBiasJobDefinitionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_bias_job_definitions::ListModelBiasJobDefinitionsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListModelBiasJobDefinitionsEndpointParamsInterceptor {
...
pub type ListModelBiasJobDefinitionsErrorKind = ListModelBiasJobDefinitionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListModelBiasJobDefinitionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_model_bias_job_definitions::ListModelBiasJobDefinitionsError {
...
impl ListModelBiasJobDefinitionsError {
    ...
    /// Creates the `ListModelBiasJobDefinitionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
