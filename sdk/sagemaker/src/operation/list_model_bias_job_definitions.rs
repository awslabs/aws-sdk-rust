...
impl ListModelBiasJobDefinitionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_model_bias_job_definitions::ListModelBiasJobDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListModelBiasJobDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_model_bias_job_definitions::de_list_model_bias_job_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
