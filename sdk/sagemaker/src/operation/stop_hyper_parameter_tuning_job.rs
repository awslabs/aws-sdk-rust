    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJobError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJobOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopHyperParameterTuningJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StopHyperParameterTuningJob", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopHyperParameterTuningJob")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopHyperParameterTuningJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopHyperParameterTuningJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJobInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopHyperParameterTuningJobEndpointParamsInterceptor {
...
pub type StopHyperParameterTuningJobErrorKind = StopHyperParameterTuningJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopHyperParameterTuningJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJobError {
...
impl StopHyperParameterTuningJobError {
    ...
    /// Creates the `StopHyperParameterTuningJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
