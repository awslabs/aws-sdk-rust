...
impl ::aws_smithy_http::response::ParseStrictResponse for StopHyperParameterTuningJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_hyper_parameter_tuning_job::de_stop_hyper_parameter_tuning_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StopHyperParameterTuningJobError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJobError
{
