...
impl StopHyperParameterTuningJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_hyper_parameter_tuning_job::StopHyperParameterTuningJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopHyperParameterTuningJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_hyper_parameter_tuning_job::de_stop_hyper_parameter_tuning_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
