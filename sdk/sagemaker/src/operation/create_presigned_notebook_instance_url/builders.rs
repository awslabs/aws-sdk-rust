...
impl CreatePresignedNotebookInstanceUrlFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_presigned_notebook_instance_url::CreatePresignedNotebookInstanceUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_presigned_notebook_instance_url::CreatePresignedNotebookInstanceUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_presigned_notebook_instance_url::CreatePresignedNotebookInstanceUrlOutput, crate::operation::create_presigned_notebook_instance_url::CreatePresignedNotebookInstanceUrlError, Self> {
