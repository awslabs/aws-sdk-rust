    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteMonitoringScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteMonitoringScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteMonitoringScheduleEndpointParamsInterceptor {
...
pub type DeleteMonitoringScheduleErrorKind = DeleteMonitoringScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleError {
...
impl DeleteMonitoringScheduleError {
    ...
    /// Creates the `DeleteMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
