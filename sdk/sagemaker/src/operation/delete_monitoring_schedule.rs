...
impl DeleteMonitoringScheduleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_monitoring_schedule::DeleteMonitoringSchedule,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMonitoringSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_monitoring_schedule::de_delete_monitoring_schedule_http_response_with_props(status, headers, body)
        }
    }
}
