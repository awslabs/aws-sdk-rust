...
/// Paginator for [`ListSubscribedWorkteams`](crate::operation::list_subscribed_workteams::ListSubscribedWorkteams)
            ...
            impl ListSubscribedWorkteamsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsOutput, aws_smithy_http::result::SdkError<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListSubscribedWorkteamsPaginator`
                ...
                impl  ListSubscribedWorkteamsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::SubscribedWorkteam, aws_smithy_http::result::SdkError<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_subscribed_workteams_output_subscribed_workteams(page).unwrap_or_default().into_iter())
                    }
                }
