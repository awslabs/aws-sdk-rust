...
impl CreateAlgorithmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_algorithm::CreateAlgorithm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_algorithm::ser_create_algorithm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAlgorithm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_algorithm::de_create_algorithm_http_response_with_props(status, headers, body)
        }
    }
}
