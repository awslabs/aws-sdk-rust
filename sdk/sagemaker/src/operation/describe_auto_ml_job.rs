...
impl DescribeAutoMlJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_auto_ml_job::ser_describe_auto_ml_job_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_auto_ml_job::DescribeAutoMLJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_auto_ml_job::DescribeAutoMLJobError
{
