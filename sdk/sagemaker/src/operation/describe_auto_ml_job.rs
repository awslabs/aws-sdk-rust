...
impl DescribeAutoMlJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_auto_ml_job::ser_describe_auto_ml_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAutoMLJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_auto_ml_job::de_describe_auto_ml_job_http_response_with_props(status, headers, body)
        }
    }
}
