...
impl DeletePipelineInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_pipeline::DeletePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_pipeline::DeletePipeline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePipeline", "sagemaker"));
...
impl DeletePipelineError {
    ...
    /// Returns `true` if the error kind is `DeletePipelineError::ResourceNotFound`.
