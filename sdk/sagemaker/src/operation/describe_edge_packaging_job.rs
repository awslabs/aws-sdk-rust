...
impl DescribeEdgePackagingJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJob,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEdgePackagingJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_edge_packaging_job::de_describe_edge_packaging_job_http_response_with_props(status, headers, body)
        }
    }
}
