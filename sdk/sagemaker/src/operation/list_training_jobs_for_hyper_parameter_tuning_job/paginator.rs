...
impl ListTrainingJobsForHyperParameterTuningJobPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_training_jobs_for_hyper_parameter_tuning_job::paginator::ListTrainingJobsForHyperParameterTuningJobPaginatorItems
    {
...
impl ListTrainingJobsForHyperParameterTuningJobPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_training_jobs_for_hyper_parameter_tuning_job_output_output_training_job_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
