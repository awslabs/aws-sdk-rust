        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_model_card_export_jobs::ListModelCardExportJobs::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListModelCardExportJobsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_model_card_export_jobs_output_output_model_card_export_job_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
