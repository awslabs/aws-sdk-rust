...
impl EnableSagemakerServicecatalogPortfolioInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_sagemaker_servicecatalog_portfolio::EnableSagemakerServicecatalogPortfolioInput, ::aws_smithy_types::error::operation::BuildError> {
