...
impl DeleteAppInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_app::DeleteApp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app::DeleteApp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteApp", "sagemaker"));
...
impl DeleteAppError {
    ...
    /// Returns `true` if the error kind is `DeleteAppError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `DeleteAppError::ResourceNotFound`.
