...
impl UpdateFeatureGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_feature_group::ser_update_feature_group_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_feature_group::UpdateFeatureGroup::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_feature_group::UpdateFeatureGroupError
{
