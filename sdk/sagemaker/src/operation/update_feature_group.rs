...
/// Orchestration and serialization glue logic for `UpdateFeatureGroup`.
...
impl UpdateFeatureGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_feature_group::UpdateFeatureGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_feature_group::UpdateFeatureGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_feature_group::UpdateFeatureGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_feature_group::UpdateFeatureGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFeatureGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateFeatureGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateFeatureGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateFeatureGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFeatureGroup")
...
.with_interceptor(UpdateFeatureGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_feature_group::UpdateFeatureGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_feature_group::UpdateFeatureGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_feature_group::UpdateFeatureGroupError>::new());
...
#[derive(Debug)]
            struct UpdateFeatureGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFeatureGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_feature_group::de_update_feature_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_feature_group::de_update_feature_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateFeatureGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFeatureGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_feature_group::UpdateFeatureGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_feature_group::UpdateFeatureGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_feature_group::ser_update_feature_group_input(&input)?);
...
#[derive(Debug)]
            struct UpdateFeatureGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFeatureGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateFeatureGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateFeatureGroupInput>()
                        .ok_or("failed to downcast to UpdateFeatureGroupInput")?;
...
/// Error type for the `UpdateFeatureGroupError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateFeatureGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateFeatureGroupError) for what information is available for the error.")]
...
impl UpdateFeatureGroupError {
    /// Creates the `UpdateFeatureGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateFeatureGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateFeatureGroupError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `UpdateFeatureGroupError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateFeatureGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateFeatureGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_feature_group::UpdateFeatureGroupError {
...
mod _update_feature_group_output;
