...
impl DeleteCompilationJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_compilation_job::DeleteCompilationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_compilation_job::DeleteCompilationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_compilation_job::DeleteCompilationJobOutput, crate::operation::delete_compilation_job::DeleteCompilationJobError, Self> {
