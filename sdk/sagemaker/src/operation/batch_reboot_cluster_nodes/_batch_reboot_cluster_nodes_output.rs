...
pub struct BatchRebootClusterNodesOutput {
    ...
    pub failed: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodesError>>,
    ...
    pub failed_node_logical_ids: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodeLogicalIdsError>>,
...
impl BatchRebootClusterNodesOutput {
    /// <p>A list of EC2 instance IDs for which the reboot operation was successfully initiated.</p>
    ///
    ...
    pub fn failed(&self) -> &[crate::types::BatchRebootClusterNodesError] {
    ...
    pub fn failed_node_logical_ids(&self) -> &[crate::types::BatchRebootClusterNodeLogicalIdsError] {
...
impl ::aws_types::request_id::RequestId for BatchRebootClusterNodesOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl BatchRebootClusterNodesOutput {
    /// Creates a new builder-style object to manufacture [`BatchRebootClusterNodesOutput`](crate::operation::batch_reboot_cluster_nodes::BatchRebootClusterNodesOutput).
    pub fn builder() -> crate::operation::batch_reboot_cluster_nodes::builders::BatchRebootClusterNodesOutputBuilder {
        crate::operation::batch_reboot_cluster_nodes::builders::BatchRebootClusterNodesOutputBuilder::default()
    }
}

/// A builder for [`BatchRebootClusterNodesOutput`](crate::operation::batch_reboot_cluster_nodes::BatchRebootClusterNodesOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BatchRebootClusterNodesOutputBuilder {
    pub(crate) successful: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    pub(crate) failed: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodesError>>,
    pub(crate) failed_node_logical_ids: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodeLogicalIdsError>>,
    pub(crate) successful_node_logical_ids: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    _request_id: Option<String>,
}
impl BatchRebootClusterNodesOutputBuilder {
    ...
    ///
    /// <p>A list of errors encountered for EC2 instance IDs that could not be rebooted. Each error includes the instance ID, an error code, and a descriptive message.</p>
    pub fn failed(mut self, input: crate::types::BatchRebootClusterNodesError) -> Self {
    ...
    /// <p>A list of errors encountered for EC2 instance IDs that could not be rebooted. Each error includes the instance ID, an error code, and a descriptive message.</p>
    pub fn set_failed(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodesError>>) -> Self {
        self.failed = input;
        self
    }
    /// <p>A list of errors encountered for EC2 instance IDs that could not be rebooted. Each error includes the instance ID, an error code, and a descriptive message.</p>
    pub fn get_failed(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodesError>> {
        &self.failed
    }
    ...
    ///
    /// <p>A list of errors encountered for logical node IDs that could not be rebooted. Each error includes the logical node ID, an error code, and a descriptive message. This field is only present when <code>NodeLogicalIds</code> were provided in the request.</p>
    pub fn failed_node_logical_ids(mut self, input: crate::types::BatchRebootClusterNodeLogicalIdsError) -> Self {
    ...
    pub fn set_failed_node_logical_ids(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodeLogicalIdsError>>,
    ) -> Self {
        self.failed_node_logical_ids = input;
        self
    }
    /// <p>A list of errors encountered for logical node IDs that could not be rebooted. Each error includes the logical node ID, an error code, and a descriptive message. This field is only present when <code>NodeLogicalIds</code> were provided in the request.</p>
    pub fn get_failed_node_logical_ids(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::BatchRebootClusterNodeLogicalIdsError>> {
    ...
    /// Consumes the builder and constructs a [`BatchRebootClusterNodesOutput`](crate::operation::batch_reboot_cluster_nodes::BatchRebootClusterNodesOutput).
    pub fn build(self) -> crate::operation::batch_reboot_cluster_nodes::BatchRebootClusterNodesOutput {
