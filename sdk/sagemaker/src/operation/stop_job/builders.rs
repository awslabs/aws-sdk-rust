...
impl crate::operation::stop_job::builders::StopJobInputBuilder {
...
///
/// <p>Stops a running job. When you call <code>StopJob</code>, Amazon SageMaker sets the job status to <code>Stopping</code>. After the job stops, the status changes to <code>Stopped</code>. Partial results may be available in the output location if the job was in progress. To delete a stopped job, call <code>DeleteJob</code>.</p>
/// <p>The following operations are related to <code>StopJob</code>:</p>
/// <ul>
/// <li>
...
impl StopJobFluentBuilder {
    /// Creates a new `StopJobFluentBuilder`.
