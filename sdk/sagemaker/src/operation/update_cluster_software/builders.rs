...
impl UpdateClusterSoftwareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_cluster_software::UpdateClusterSoftwareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_cluster_software::UpdateClusterSoftwareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_cluster_software::UpdateClusterSoftwareOutput, crate::operation::update_cluster_software::UpdateClusterSoftwareError, Self> {
