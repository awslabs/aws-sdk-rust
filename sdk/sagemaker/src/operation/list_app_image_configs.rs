...
impl ListAppImageConfigs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_app_image_configs::ListAppImageConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_app_image_configs::ListAppImageConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_app_image_configs::ListAppImageConfigsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_app_image_configs::ListAppImageConfigsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAppImageConfigs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAppImageConfigs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAppImageConfigsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAppImageConfigsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAppImageConfigs")
...
.with_interceptor(ListAppImageConfigsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_app_image_configs::ListAppImageConfigsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_app_image_configs::ListAppImageConfigsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_app_image_configs::ListAppImageConfigsError>::new());
...
#[derive(Debug)]
            struct ListAppImageConfigsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAppImageConfigsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_app_image_configs::de_list_app_image_configs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAppImageConfigsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAppImageConfigsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_app_image_configs::ListAppImageConfigsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_app_image_configs::ListAppImageConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_app_image_configs::ser_list_app_image_configs_input(&input)?);
...
#[derive(Debug)]
            struct ListAppImageConfigsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAppImageConfigsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAppImageConfigsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAppImageConfigsInput>()
                        .ok_or("failed to downcast to ListAppImageConfigsInput")?;
...
/// Error type for the `ListAppImageConfigsError` operation.
#[non_exhaustive]
...
pub enum ListAppImageConfigsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAppImageConfigsError) for what information is available for the error.")]
...
impl ListAppImageConfigsError {
    /// Creates the `ListAppImageConfigsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAppImageConfigsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAppImageConfigsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAppImageConfigsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_app_image_configs::ListAppImageConfigsError {
...
mod _list_app_image_configs_output;
