...
impl GetModelPackageGroupPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_model_package_group_policy::GetModelPackageGroupPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetModelPackageGroupPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_model_package_group_policy::de_get_model_package_group_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
