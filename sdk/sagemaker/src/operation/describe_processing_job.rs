    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_processing_job::DescribeProcessingJobError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_processing_job::DescribeProcessingJobOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeProcessingJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeProcessingJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_processing_job::DescribeProcessingJobInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_processing_job::ser_describe_processing_job_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeProcessingJobEndpointParamsInterceptor {
...
pub type DescribeProcessingJobErrorKind = DescribeProcessingJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeProcessingJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_processing_job::DescribeProcessingJobError {
...
impl DescribeProcessingJobError {
    ...
    /// Creates the `DescribeProcessingJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
