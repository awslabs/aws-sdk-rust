    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_monitoring_schedule::CreateMonitoringScheduleError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_monitoring_schedule::CreateMonitoringScheduleOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateMonitoringScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateMonitoringScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_monitoring_schedule::CreateMonitoringScheduleInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateMonitoringScheduleEndpointParamsInterceptor {
...
pub type CreateMonitoringScheduleErrorKind = CreateMonitoringScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_monitoring_schedule::CreateMonitoringScheduleError {
...
impl CreateMonitoringScheduleError {
    ...
    /// Creates the `CreateMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
