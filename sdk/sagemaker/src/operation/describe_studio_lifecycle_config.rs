    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_studio_lifecycle_config::DescribeStudioLifecycleConfigError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_studio_lifecycle_config::DescribeStudioLifecycleConfigOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeStudioLifecycleConfigResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeStudioLifecycleConfigRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeStudioLifecycleConfigEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeStudioLifecycleConfigError {
