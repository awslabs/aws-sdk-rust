...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStudioLifecycleConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_studio_lifecycle_config::de_describe_studio_lifecycle_config_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeStudioLifecycleConfigError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_studio_lifecycle_config::DescribeStudioLifecycleConfigError
{
