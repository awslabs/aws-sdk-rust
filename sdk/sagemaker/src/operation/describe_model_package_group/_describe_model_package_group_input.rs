...
impl DescribeModelPackageGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_model_package_group::DescribeModelPackageGroupInput, ::aws_smithy_types::error::operation::BuildError> {
