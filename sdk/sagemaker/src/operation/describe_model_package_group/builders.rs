...
impl DescribeModelPackageGroupFluentBuilder  {
    /// Creates a new `DescribeModelPackageGroup`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_model_package_group::DescribeModelPackageGroupOutput, aws_smithy_http::result::SdkError<crate::operation::describe_model_package_group::DescribeModelPackageGroupError>>
                     {
