...
impl StopTransformJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_transform_job::StopTransformJob,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_transform_job::ser_stop_transform_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTransformJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_transform_job::de_stop_transform_job_http_response_with_props(status, headers, body)
        }
    }
}
