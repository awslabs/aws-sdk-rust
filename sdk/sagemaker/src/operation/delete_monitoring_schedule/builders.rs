...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleOutput,
                    crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleError,
                > for DeleteMonitoringScheduleFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteMonitoringScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::delete_monitoring_schedule::DeleteMonitoringSchedule::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleOutput, crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleError, Self> {
