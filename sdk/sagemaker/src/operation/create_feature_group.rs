...
impl CreateFeatureGroupInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_feature_group::ser_create_feature_group_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_feature_group::CreateFeatureGroup::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_feature_group::CreateFeatureGroupError
{
