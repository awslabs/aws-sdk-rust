...
impl ListFeatureGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_feature_groups::ser_list_feature_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFeatureGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_feature_groups::de_list_feature_groups_http_response_with_props(status, headers, body)
        }
    }
}
