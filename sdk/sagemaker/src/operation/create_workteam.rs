...
impl CreateWorkteamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_workteam::CreateWorkteam, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_workteam::ser_create_workteam_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkteam {
    type Output =
        ::std::result::Result<crate::operation::create_workteam::CreateWorkteamOutput, crate::operation::create_workteam::CreateWorkteamError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_workteam::de_create_workteam_http_response_with_props(status, headers, body)
        }
    }
}
