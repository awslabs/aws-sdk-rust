    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_describe_model_package::BatchDescribeModelPackageError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_describe_model_package::BatchDescribeModelPackageOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDescribeModelPackage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            BatchDescribeModelPackageRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            BatchDescribeModelPackageResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("BatchDescribeModelPackage", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDescribeModelPackage")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchDescribeModelPackageResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchDescribeModelPackageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_describe_model_package::BatchDescribeModelPackageInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::batch_describe_model_package::BatchDescribeModelPackageInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_describe_model_package::ser_batch_describe_model_package_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchDescribeModelPackageEndpointParamsInterceptor {
...
pub type BatchDescribeModelPackageErrorKind = BatchDescribeModelPackageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for BatchDescribeModelPackageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_describe_model_package::BatchDescribeModelPackageError {
...
impl BatchDescribeModelPackageError {
    ...
    /// Creates the `BatchDescribeModelPackageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
