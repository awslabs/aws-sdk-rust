...
impl BatchDescribeModelPackageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_describe_model_package::BatchDescribeModelPackage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDescribeModelPackage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_describe_model_package::de_batch_describe_model_package_http_response_with_props(status, headers, body)
        }
    }
}
