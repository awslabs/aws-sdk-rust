...
impl RegisterDevicesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_devices::RegisterDevices::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDevices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_devices::de_register_devices_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_devices::RegisterDevicesError
{
