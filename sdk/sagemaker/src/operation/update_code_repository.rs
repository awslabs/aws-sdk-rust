    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_code_repository::UpdateCodeRepositoryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_code_repository::UpdateCodeRepositoryOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateCodeRepositoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateCodeRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_code_repository::UpdateCodeRepositoryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_code_repository::ser_update_code_repository_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateCodeRepositoryEndpointParamsInterceptor {
...
pub type UpdateCodeRepositoryErrorKind = UpdateCodeRepositoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateCodeRepositoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_code_repository::UpdateCodeRepositoryError {
...
impl UpdateCodeRepositoryError {
    ...
    /// Creates the `UpdateCodeRepositoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
