...
impl StopProcessingJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_processing_job::StopProcessingJob,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_processing_job::ser_stop_processing_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopProcessingJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_processing_job::de_stop_processing_job_http_response_with_props(status, headers, body)
        }
    }
}
