...
/// Orchestration and serialization glue logic for `StopProcessingJob`.
...
impl StopProcessingJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_processing_job::StopProcessingJobInput,
                    ) -> ::std::result::Result<crate::operation::stop_processing_job::StopProcessingJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_processing_job::StopProcessingJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_processing_job::StopProcessingJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_processing_job::StopProcessingJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopProcessingJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopProcessingJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopProcessingJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopProcessingJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopProcessingJob")
...
.with_interceptor(StopProcessingJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_processing_job::StopProcessingJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_processing_job::StopProcessingJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_processing_job::StopProcessingJobError>::new());
...
#[derive(Debug)]
            struct StopProcessingJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopProcessingJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_processing_job::de_stop_processing_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_processing_job::de_stop_processing_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopProcessingJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopProcessingJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_processing_job::StopProcessingJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_processing_job::StopProcessingJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_processing_job::ser_stop_processing_job_input(&input)?);
...
#[derive(Debug)]
            struct StopProcessingJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopProcessingJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopProcessingJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopProcessingJobInput>()
                        .ok_or("failed to downcast to StopProcessingJobInput")?;
...
/// Error type for the `StopProcessingJobError` operation.
#[non_exhaustive]
...
pub enum StopProcessingJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopProcessingJobError) for what information is available for the error.")]
...
impl StopProcessingJobError {
    /// Creates the `StopProcessingJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopProcessingJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StopProcessingJobError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopProcessingJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopProcessingJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_processing_job::StopProcessingJobError {
...
mod _stop_processing_job_output;
