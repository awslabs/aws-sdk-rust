    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_feature_metadata::DescribeFeatureMetadataError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_feature_metadata::DescribeFeatureMetadataOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeFeatureMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeFeatureMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_feature_metadata::DescribeFeatureMetadataInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeFeatureMetadataEndpointParamsInterceptor {
...
pub type DescribeFeatureMetadataErrorKind = DescribeFeatureMetadataError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeFeatureMetadataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_feature_metadata::DescribeFeatureMetadataError {
...
impl DescribeFeatureMetadataError {
    ...
    /// Creates the `DescribeFeatureMetadataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
