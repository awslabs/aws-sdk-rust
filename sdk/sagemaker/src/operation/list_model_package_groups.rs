    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_package_groups::ListModelPackageGroupsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_package_groups::ListModelPackageGroupsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListModelPackageGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListModelPackageGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_model_package_groups::ListModelPackageGroupsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListModelPackageGroupsEndpointParamsInterceptor {
...
pub type ListModelPackageGroupsErrorKind = ListModelPackageGroupsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListModelPackageGroupsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_model_package_groups::ListModelPackageGroupsError {
...
impl ListModelPackageGroupsError {
    ...
    /// Creates the `ListModelPackageGroupsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
