...
impl UpdateEndpointWeightsAndCapacitiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_endpoint_weights_and_capacities::UpdateEndpointWeightsAndCapacities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEndpointWeightsAndCapacities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_endpoint_weights_and_capacities::de_update_endpoint_weights_and_capacities_http_response_with_props(
                status, headers, body,
            )
        }
    }
