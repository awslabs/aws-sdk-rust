...
impl ListInferenceComponentsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_inference_components::ListInferenceComponentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_inference_components::ListInferenceComponentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_inference_components::ListInferenceComponentsOutput, crate::operation::list_inference_components::ListInferenceComponentsError, Self> {
