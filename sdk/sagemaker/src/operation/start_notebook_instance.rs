    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_notebook_instance::StartNotebookInstanceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_notebook_instance::StartNotebookInstanceOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartNotebookInstanceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartNotebookInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_notebook_instance::StartNotebookInstanceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_notebook_instance::ser_start_notebook_instance_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartNotebookInstanceEndpointParamsInterceptor {
...
pub type StartNotebookInstanceErrorKind = StartNotebookInstanceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartNotebookInstanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_notebook_instance::StartNotebookInstanceError {
...
impl StartNotebookInstanceError {
    ...
    /// Creates the `StartNotebookInstanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
