...
/// Orchestration and serialization glue logic for `StartNotebookInstance`.
...
impl StartNotebookInstance {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_notebook_instance::StartNotebookInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_notebook_instance::StartNotebookInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_notebook_instance::StartNotebookInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_notebook_instance::StartNotebookInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartNotebookInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartNotebookInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartNotebookInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartNotebookInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartNotebookInstance")
...
.with_interceptor(StartNotebookInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_notebook_instance::StartNotebookInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_notebook_instance::StartNotebookInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_notebook_instance::StartNotebookInstanceError>::new());
...
#[derive(Debug)]
            struct StartNotebookInstanceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartNotebookInstanceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_notebook_instance::de_start_notebook_instance_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_notebook_instance::de_start_notebook_instance_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartNotebookInstanceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartNotebookInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_notebook_instance::StartNotebookInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_notebook_instance::StartNotebookInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_notebook_instance::ser_start_notebook_instance_input(&input)?);
...
#[derive(Debug)]
            struct StartNotebookInstanceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartNotebookInstanceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartNotebookInstanceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartNotebookInstanceInput>()
                        .ok_or("failed to downcast to StartNotebookInstanceInput")?;
...
/// Error type for the `StartNotebookInstanceError` operation.
#[non_exhaustive]
...
pub enum StartNotebookInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartNotebookInstanceError) for what information is available for the error.")]
...
impl StartNotebookInstanceError {
    /// Creates the `StartNotebookInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartNotebookInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartNotebookInstanceError::ResourceLimitExceeded`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartNotebookInstanceError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartNotebookInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_notebook_instance::StartNotebookInstanceError {
...
mod _start_notebook_instance_output;
