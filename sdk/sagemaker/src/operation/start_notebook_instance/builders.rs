...
impl StartNotebookInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_notebook_instance::StartNotebookInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_notebook_instance::StartNotebookInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_notebook_instance::StartNotebookInstanceOutput, crate::operation::start_notebook_instance::StartNotebookInstanceError, Self> {
