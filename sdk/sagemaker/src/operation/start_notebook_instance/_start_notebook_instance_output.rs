...
impl ::aws_types::request_id::RequestId for StartNotebookInstanceOutput {
...
impl StartNotebookInstanceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartNotebookInstanceOutput`](crate::operation::start_notebook_instance::StartNotebookInstanceOutput).
    pub fn build(self) -> crate::operation::start_notebook_instance::StartNotebookInstanceOutput {
