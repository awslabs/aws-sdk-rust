...
impl DeleteContextInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_context::DeleteContext, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_context::ser_delete_context_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContext {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_context::de_delete_context_http_response_with_props(status, headers, body)
        }
    }
}
