...
pub use crate::operation::describe_human_task_ui::_describe_human_task_ui_output::DescribeHumanTaskUiOutputBuilder;
...
pub struct DescribeHumanTaskUiFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_human_task_ui::builders::DescribeHumanTaskUiInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_human_task_ui::DescribeHumanTaskUiOutput,
                    crate::operation::describe_human_task_ui::DescribeHumanTaskUiError,
                > for DescribeHumanTaskUiFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeHumanTaskUiFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_human_task_ui::builders::DescribeHumanTaskUiInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_human_task_ui::DescribeHumanTaskUiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_human_task_ui::DescribeHumanTaskUiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_human_task_ui::DescribeHumanTaskUi::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_human_task_ui::DescribeHumanTaskUi::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_human_task_ui::DescribeHumanTaskUiOutput, crate::operation::describe_human_task_ui::DescribeHumanTaskUiError, Self> {
