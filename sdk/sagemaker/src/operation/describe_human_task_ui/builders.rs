...
impl DescribeHumanTaskUiFluentBuilder  {
    /// Creates a new `DescribeHumanTaskUi`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_human_task_ui::DescribeHumanTaskUi, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_human_task_ui::DescribeHumanTaskUiError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_human_task_ui::DescribeHumanTaskUiOutput, aws_smithy_http::result::SdkError<crate::operation::describe_human_task_ui::DescribeHumanTaskUiError>>
                     {
