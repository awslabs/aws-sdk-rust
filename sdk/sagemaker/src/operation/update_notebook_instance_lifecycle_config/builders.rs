...
impl crate::operation::update_notebook_instance_lifecycle_config::builders::UpdateNotebookInstanceLifecycleConfigInputBuilder {
...
impl UpdateNotebookInstanceLifecycleConfigFluentBuilder {
    /// Creates a new `UpdateNotebookInstanceLifecycleConfigFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::update_notebook_instance_lifecycle_config::builders::UpdateNotebookInstanceLifecycleConfigInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::update_notebook_instance_lifecycle_config::UpdateNotebookInstanceLifecycleConfig::operation_runtime_plugins(
