...
impl UpdateNotebookInstanceLifecycleConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_notebook_instance_lifecycle_config::UpdateNotebookInstanceLifecycleConfigInput, ::aws_smithy_types::error::operation::BuildError> {
