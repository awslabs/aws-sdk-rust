...
impl DescribeInferenceRecommendationsJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_inference_recommendations_job::DescribeInferenceRecommendationsJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_inference_recommendations_job::DescribeInferenceRecommendationsJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInferenceRecommendationsJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_inference_recommendations_job::de_describe_inference_recommendations_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
