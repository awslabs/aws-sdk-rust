...
impl ListDevicesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_devices::ser_list_devices_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_devices::ListDevices::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDevices", "sagemaker"));
