...
impl DeleteHumanTaskUiInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_human_task_ui::ser_delete_human_task_ui_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHumanTaskUi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_human_task_ui::de_delete_human_task_ui_http_response_with_props(status, headers, body)
        }
    }
}
