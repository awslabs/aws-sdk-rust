...
/// Orchestration and serialization glue logic for `DeleteHumanTaskUi`.
...
impl DeleteHumanTaskUi {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_human_task_ui::DeleteHumanTaskUiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_human_task_ui::DeleteHumanTaskUiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteHumanTaskUi {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteHumanTaskUi");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteHumanTaskUiRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteHumanTaskUiResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteHumanTaskUi")
...
.with_interceptor(DeleteHumanTaskUiEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiError>::new());
...
#[derive(Debug)]
            struct DeleteHumanTaskUiResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteHumanTaskUiResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_human_task_ui::de_delete_human_task_ui_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_human_task_ui::de_delete_human_task_ui_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteHumanTaskUiRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteHumanTaskUiRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_human_task_ui::DeleteHumanTaskUiInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_human_task_ui::DeleteHumanTaskUiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_human_task_ui::ser_delete_human_task_ui_input(&input)?);
...
#[derive(Debug)]
            struct DeleteHumanTaskUiEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteHumanTaskUiEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteHumanTaskUiEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteHumanTaskUiInput>()
                        .ok_or("failed to downcast to DeleteHumanTaskUiInput")?;
...
/// Error type for the `DeleteHumanTaskUiError` operation.
#[non_exhaustive]
...
pub enum DeleteHumanTaskUiError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteHumanTaskUiError) for what information is available for the error.")]
...
impl DeleteHumanTaskUiError {
    /// Creates the `DeleteHumanTaskUiError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteHumanTaskUiError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteHumanTaskUiError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteHumanTaskUiError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteHumanTaskUiError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_human_task_ui::DeleteHumanTaskUiError {
...
mod _delete_human_task_ui_output;
