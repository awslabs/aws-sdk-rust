    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_notebook_instance::UpdateNotebookInstanceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_notebook_instance::UpdateNotebookInstanceOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNotebookInstance {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateNotebookInstance", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateNotebookInstance")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateNotebookInstanceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateNotebookInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_notebook_instance::UpdateNotebookInstanceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_notebook_instance::ser_update_notebook_instance_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateNotebookInstanceEndpointParamsInterceptor {
...
pub type UpdateNotebookInstanceErrorKind = UpdateNotebookInstanceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateNotebookInstanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_notebook_instance::UpdateNotebookInstanceError {
...
impl UpdateNotebookInstanceError {
    ...
    /// Creates the `UpdateNotebookInstanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
