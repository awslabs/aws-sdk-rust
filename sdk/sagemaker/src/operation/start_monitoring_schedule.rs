    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_monitoring_schedule::StartMonitoringScheduleError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_monitoring_schedule::StartMonitoringScheduleOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartMonitoringScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartMonitoringScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_monitoring_schedule::StartMonitoringScheduleInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartMonitoringScheduleEndpointParamsInterceptor {
...
pub type StartMonitoringScheduleErrorKind = StartMonitoringScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_monitoring_schedule::StartMonitoringScheduleError {
...
impl StartMonitoringScheduleError {
    ...
    /// Creates the `StartMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
