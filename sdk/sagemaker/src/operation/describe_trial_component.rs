    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_trial_component::DescribeTrialComponentError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_trial_component::DescribeTrialComponentOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTrialComponent {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeTrialComponent", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTrialComponent")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeTrialComponentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeTrialComponentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_trial_component::DescribeTrialComponentInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_trial_component::ser_describe_trial_component_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeTrialComponentEndpointParamsInterceptor {
...
pub type DescribeTrialComponentErrorKind = DescribeTrialComponentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeTrialComponentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_trial_component::DescribeTrialComponentError {
...
impl DescribeTrialComponentError {
    ...
    /// Creates the `DescribeTrialComponentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
