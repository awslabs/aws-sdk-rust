...
impl DescribeTrialComponentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_trial_component::DescribeTrialComponent,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrialComponent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_trial_component::de_describe_trial_component_http_response_with_props(status, headers, body)
        }
    }
}
