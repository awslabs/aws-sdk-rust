...
impl UpdateTrainingJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_training_job::ser_update_training_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrainingJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_training_job::de_update_training_job_http_response_with_props(status, headers, body)
        }
    }
}
