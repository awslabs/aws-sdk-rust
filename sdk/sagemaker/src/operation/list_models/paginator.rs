...
impl ListModelsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::ModelSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_models::ListModelsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_models_output_models(page).unwrap_or_default().into_iter())
    }
}
