    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_trial_component::DeleteTrialComponentError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_trial_component::DeleteTrialComponentOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTrialComponentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTrialComponentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_trial_component::DeleteTrialComponentInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_trial_component::ser_delete_trial_component_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteTrialComponentEndpointParamsInterceptor {
...
pub type DeleteTrialComponentErrorKind = DeleteTrialComponentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteTrialComponentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_trial_component::DeleteTrialComponentError {
...
impl DeleteTrialComponentError {
    ...
    /// Creates the `DeleteTrialComponentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
