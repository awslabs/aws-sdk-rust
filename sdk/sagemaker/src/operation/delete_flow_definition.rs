...
impl DeleteFlowDefinition {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_flow_definition::DeleteFlowDefinitionInput,
                    ) -> ::std::result::Result<crate::operation::delete_flow_definition::DeleteFlowDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_flow_definition::DeleteFlowDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_flow_definition::DeleteFlowDefinitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_flow_definition::DeleteFlowDefinitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFlowDefinition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFlowDefinition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFlowDefinitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFlowDefinitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFlowDefinition")
...
.with_interceptor(DeleteFlowDefinitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_flow_definition::DeleteFlowDefinitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_flow_definition::DeleteFlowDefinitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_flow_definition::DeleteFlowDefinitionError>::new());
...
#[derive(Debug)]
            struct DeleteFlowDefinitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFlowDefinitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_flow_definition::de_delete_flow_definition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_flow_definition::de_delete_flow_definition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFlowDefinitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFlowDefinitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_flow_definition::DeleteFlowDefinitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_flow_definition::DeleteFlowDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_flow_definition::ser_delete_flow_definition_input(&input)?);
...
#[derive(Debug)]
            struct DeleteFlowDefinitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFlowDefinitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFlowDefinitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFlowDefinitionInput>()
                        .ok_or("failed to downcast to DeleteFlowDefinitionInput")?;
...
pub enum DeleteFlowDefinitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFlowDefinitionError) for what information is available for the error.")]
...
impl DeleteFlowDefinitionError {
    /// Creates the `DeleteFlowDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFlowDefinitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteFlowDefinitionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFlowDefinitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_flow_definition::DeleteFlowDefinitionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_flow_definition::_delete_flow_definition_output::DeleteFlowDefinitionOutput;

pub use crate::operation::delete_flow_definition::_delete_flow_definition_input::DeleteFlowDefinitionInput;

mod _delete_flow_definition_input;

mod _delete_flow_definition_output;
