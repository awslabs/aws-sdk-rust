    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_flow_definition::DeleteFlowDefinitionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_flow_definition::DeleteFlowDefinitionOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteFlowDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteFlowDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_flow_definition::DeleteFlowDefinitionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_flow_definition::ser_delete_flow_definition_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteFlowDefinitionEndpointParamsInterceptor {
...
pub type DeleteFlowDefinitionErrorKind = DeleteFlowDefinitionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteFlowDefinitionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_flow_definition::DeleteFlowDefinitionError {
