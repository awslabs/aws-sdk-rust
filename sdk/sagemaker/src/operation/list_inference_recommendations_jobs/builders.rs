...
impl ListInferenceRecommendationsJobsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::list_inference_recommendations_jobs::ListInferenceRecommendationsJobsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_inference_recommendations_jobs::ListInferenceRecommendationsJobsError, ::aws_smithy_http::operation::Response>>
