    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStageError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStageOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartEdgeDeploymentStageResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartEdgeDeploymentStageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStageInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartEdgeDeploymentStageEndpointParamsInterceptor {
...
pub type StartEdgeDeploymentStageErrorKind = StartEdgeDeploymentStageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartEdgeDeploymentStageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStageError {
...
impl StartEdgeDeploymentStageError {
    ...
    /// Creates the `StartEdgeDeploymentStageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
