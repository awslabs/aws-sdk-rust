...
impl StartEdgeDeploymentStageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEdgeDeploymentStage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_edge_deployment_stage::de_start_edge_deployment_stage_http_response_with_props(status, headers, body)
        }
    }
}
