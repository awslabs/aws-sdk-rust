...
/// Orchestration and serialization glue logic for `ListEdgePackagingJobs`.
...
impl ListEdgePackagingJobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEdgePackagingJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEdgePackagingJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEdgePackagingJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEdgePackagingJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEdgePackagingJobs")
...
.with_interceptor(ListEdgePackagingJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>::new());
...
#[derive(Debug)]
            struct ListEdgePackagingJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEdgePackagingJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_edge_packaging_jobs::de_list_edge_packaging_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListEdgePackagingJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEdgePackagingJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_edge_packaging_jobs::ser_list_edge_packaging_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListEdgePackagingJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEdgePackagingJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEdgePackagingJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEdgePackagingJobsInput>()
                        .ok_or("failed to downcast to ListEdgePackagingJobsInput")?;
...
/// Error type for the `ListEdgePackagingJobsError` operation.
#[non_exhaustive]
...
pub enum ListEdgePackagingJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEdgePackagingJobsError) for what information is available for the error.")]
...
impl ListEdgePackagingJobsError {
    /// Creates the `ListEdgePackagingJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEdgePackagingJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListEdgePackagingJobsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEdgePackagingJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError {
...
mod _list_edge_packaging_jobs_output;
