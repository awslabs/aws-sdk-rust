    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEdgePackagingJobs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListEdgePackagingJobs", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEdgePackagingJobs")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListEdgePackagingJobsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListEdgePackagingJobsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_edge_packaging_jobs::ser_list_edge_packaging_jobs_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListEdgePackagingJobsEndpointParamsInterceptor {
...
pub type ListEdgePackagingJobsErrorKind = ListEdgePackagingJobsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListEdgePackagingJobsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError {
...
impl ListEdgePackagingJobsError {
    ...
    /// Creates the `ListEdgePackagingJobsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
