...
impl CreateJob {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SageMaker", "CreateJob", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateJob", "SageMaker"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateJobTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("JobConfigDocument") {
            if let ::std::option::Option::Some(value) = input.job_config_document.as_deref() {
                captured.insert("JobConfigDocument", value);
            }
        }
...
impl CreateJobError {
    ...
    /// Returns `true` if the error kind is `CreateJobError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::ResourceNotFound`.
