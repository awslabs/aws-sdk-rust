...
impl CreateAppImageConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_app_image_config::CreateAppImageConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_app_image_config::CreateAppImageConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_app_image_config::CreateAppImageConfigOutput, crate::operation::create_app_image_config::CreateAppImageConfigError, Self> {
