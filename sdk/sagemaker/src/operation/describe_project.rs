...
impl DescribeProjectInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_project::DescribeProject, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_project::ser_describe_project_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_project::DescribeProject::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeProject", "sagemaker"));
