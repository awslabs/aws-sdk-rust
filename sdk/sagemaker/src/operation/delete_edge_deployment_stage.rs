    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_deployment_stage::DeleteEdgeDeploymentStageError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_deployment_stage::DeleteEdgeDeploymentStageOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteEdgeDeploymentStage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteEdgeDeploymentStage", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteEdgeDeploymentStage")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteEdgeDeploymentStageResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteEdgeDeploymentStageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_edge_deployment_stage::DeleteEdgeDeploymentStageInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteEdgeDeploymentStageEndpointParamsInterceptor {
...
pub type DeleteEdgeDeploymentStageErrorKind = DeleteEdgeDeploymentStageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteEdgeDeploymentStageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_edge_deployment_stage::DeleteEdgeDeploymentStageError {
...
impl DeleteEdgeDeploymentStageError {
    ...
    /// Creates the `DeleteEdgeDeploymentStageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
