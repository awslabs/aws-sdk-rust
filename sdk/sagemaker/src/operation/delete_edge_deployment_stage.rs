...
impl DeleteEdgeDeploymentStageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_edge_deployment_stage::DeleteEdgeDeploymentStage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEdgeDeploymentStage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_edge_deployment_stage::de_delete_edge_deployment_stage_http_response_with_props(status, headers, body)
        }
    }
}
