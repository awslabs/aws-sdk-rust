    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_notebook_instances::ListNotebookInstancesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_notebook_instances::ListNotebookInstancesOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListNotebookInstancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListNotebookInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_notebook_instances::ListNotebookInstancesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_notebook_instances::ser_list_notebook_instances_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListNotebookInstancesEndpointParamsInterceptor {
...
pub type ListNotebookInstancesErrorKind = ListNotebookInstancesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListNotebookInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_notebook_instances::ListNotebookInstancesError {
...
impl ListNotebookInstancesError {
    ...
    /// Creates the `ListNotebookInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
