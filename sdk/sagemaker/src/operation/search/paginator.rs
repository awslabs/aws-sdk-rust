...
impl SearchPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::SearchRecord, ::aws_smithy_http::result::SdkError<crate::operation::search::SearchError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_search_output_results(page).unwrap_or_default().into_iter())
    }
}
