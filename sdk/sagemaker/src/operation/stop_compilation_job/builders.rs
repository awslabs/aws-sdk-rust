...
impl StopCompilationJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_compilation_job::StopCompilationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_compilation_job::StopCompilationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_compilation_job::StopCompilationJobOutput, crate::operation::stop_compilation_job::StopCompilationJobError, Self> {
