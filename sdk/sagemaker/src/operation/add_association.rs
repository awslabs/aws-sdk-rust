...
impl AddAssociationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_association::AddAssociation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_association::ser_add_association_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_association::de_add_association_http_response_with_props(status, headers, body)
        }
    }
}
