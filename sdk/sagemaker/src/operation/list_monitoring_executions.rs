    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_monitoring_executions::ListMonitoringExecutionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_monitoring_executions::ListMonitoringExecutionsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListMonitoringExecutionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListMonitoringExecutionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_monitoring_executions::ListMonitoringExecutionsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListMonitoringExecutionsEndpointParamsInterceptor {
...
pub type ListMonitoringExecutionsErrorKind = ListMonitoringExecutionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListMonitoringExecutionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_monitoring_executions::ListMonitoringExecutionsError {
...
impl ListMonitoringExecutionsError {
    ...
    /// Creates the `ListMonitoringExecutionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
