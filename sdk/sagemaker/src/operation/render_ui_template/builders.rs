...
impl RenderUiTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::render_ui_template::RenderUiTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::render_ui_template::RenderUiTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::render_ui_template::RenderUiTemplateOutput, crate::operation::render_ui_template::RenderUiTemplateError, Self> {
