...
impl StartMonitoringScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_monitoring_schedule::StartMonitoringScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_monitoring_schedule::StartMonitoringScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_monitoring_schedule::StartMonitoringScheduleOutput, crate::operation::start_monitoring_schedule::StartMonitoringScheduleError, Self> {
