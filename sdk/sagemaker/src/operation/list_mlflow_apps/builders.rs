...
pub use crate::operation::list_mlflow_apps::_list_mlflow_apps_input::ListMlflowAppsInputBuilder;

pub use crate::operation::list_mlflow_apps::_list_mlflow_apps_output::ListMlflowAppsOutputBuilder;

impl crate::operation::list_mlflow_apps::builders::ListMlflowAppsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_mlflow_apps();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListMlflowApps`.
///
/// <p>Lists all MLflow Apps</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct ListMlflowAppsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_mlflow_apps::builders::ListMlflowAppsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_mlflow_apps::ListMlflowAppsOutput,
        crate::operation::list_mlflow_apps::ListMlflowAppsError,
    > for ListMlflowAppsFluentBuilder
{
    fn send(
        self,
...
impl ListMlflowAppsFluentBuilder {
    /// Creates a new `ListMlflowAppsFluentBuilder`.
    ...
    /// Access the ListMlflowApps as a reference.
    pub fn as_input(&self) -> &crate::operation::list_mlflow_apps::builders::ListMlflowAppsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_mlflow_apps::ListMlflowApps::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_mlflow_apps::paginator::ListMlflowAppsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_mlflow_apps::paginator::ListMlflowAppsPaginator {
        crate::operation::list_mlflow_apps::paginator::ListMlflowAppsPaginator::new(self.handle, self.inner)
    }
