...
/// Orchestration and serialization glue logic for `StopMonitoringSchedule`.
...
impl StopMonitoringSchedule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_monitoring_schedule::StopMonitoringScheduleInput,
                    ) -> ::std::result::Result<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopMonitoringSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopMonitoringSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopMonitoringScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopMonitoringScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopMonitoringSchedule")
...
.with_interceptor(StopMonitoringScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError>::new());
...
#[derive(Debug)]
            struct StopMonitoringScheduleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopMonitoringScheduleResponseDeserializer {
...
#[derive(Debug)]
            struct StopMonitoringScheduleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopMonitoringScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_monitoring_schedule::StopMonitoringScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_monitoring_schedule::ser_stop_monitoring_schedule_input(&input)?);
...
#[derive(Debug)]
            struct StopMonitoringScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopMonitoringScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopMonitoringScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopMonitoringScheduleInput>()
                        .ok_or("failed to downcast to StopMonitoringScheduleInput")?;
...
/// Error type for the `StopMonitoringScheduleError` operation.
#[non_exhaustive]
...
pub enum StopMonitoringScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopMonitoringScheduleError) for what information is available for the error.")]
...
impl StopMonitoringScheduleError {
    /// Creates the `StopMonitoringScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopMonitoringScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StopMonitoringScheduleError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopMonitoringScheduleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopMonitoringScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError {
...
mod _stop_monitoring_schedule_output;
