    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopMonitoringSchedule {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StopMonitoringSchedule", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopMonitoringSchedule")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopMonitoringScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopMonitoringScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_monitoring_schedule::ser_stop_monitoring_schedule_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopMonitoringScheduleEndpointParamsInterceptor {
...
pub type StopMonitoringScheduleErrorKind = StopMonitoringScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError {
...
impl StopMonitoringScheduleError {
    ...
    /// Creates the `StopMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
