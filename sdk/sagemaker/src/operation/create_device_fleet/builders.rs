...
impl CreateDeviceFleetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_device_fleet::CreateDeviceFleetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_device_fleet::CreateDeviceFleetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_device_fleet::CreateDeviceFleetOutput, crate::operation::create_device_fleet::CreateDeviceFleetError, Self> {
