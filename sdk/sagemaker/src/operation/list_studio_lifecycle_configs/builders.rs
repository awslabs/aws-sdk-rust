...
impl ListStudioLifecycleConfigsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_studio_lifecycle_configs::ListStudioLifecycleConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_studio_lifecycle_configs::ListStudioLifecycleConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_studio_lifecycle_configs::ListStudioLifecycleConfigsOutput, crate::operation::list_studio_lifecycle_configs::ListStudioLifecycleConfigsError, Self> {
