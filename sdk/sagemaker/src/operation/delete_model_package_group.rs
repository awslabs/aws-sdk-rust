    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_model_package_group::DeleteModelPackageGroupError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_model_package_group::DeleteModelPackageGroupOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteModelPackageGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteModelPackageGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_model_package_group::DeleteModelPackageGroupInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteModelPackageGroupEndpointParamsInterceptor {
...
pub type DeleteModelPackageGroupErrorKind = DeleteModelPackageGroupError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteModelPackageGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_model_package_group::DeleteModelPackageGroupError {
...
impl DeleteModelPackageGroupError {
    ...
    /// Creates the `DeleteModelPackageGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
