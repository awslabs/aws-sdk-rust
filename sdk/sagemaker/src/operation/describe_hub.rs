...
impl DescribeHubInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHub`](crate::operation::describe_hub::DescribeHub)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_hub::DescribeHub, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_hub::DescribeHubInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_hub::ser_describe_hub_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hub::DescribeHub::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeHub", "sagemaker"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeHub {
                type Output = std::result::Result<crate::operation::describe_hub::DescribeHubOutput, crate::operation::describe_hub::DescribeHubError>;
