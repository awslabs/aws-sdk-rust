...
impl DescribeHubInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_hub::DescribeHub, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_hub::ser_describe_hub_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHub {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_hub::de_describe_hub_http_response_with_props(status, headers, body)
        }
    }
}
