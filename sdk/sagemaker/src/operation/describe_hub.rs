...
impl DescribeHubInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_hub::DescribeHub::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeHub {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_hub::de_describe_hub_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_hub::de_describe_hub_http_response_with_props(
                status, headers, body,
            )
        }
    }
