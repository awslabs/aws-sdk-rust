...
impl CreateModelPackageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_model_package::ser_create_model_package_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateModelPackage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_model_package::de_create_model_package_http_response_with_props(status, headers, body)
        }
    }
}
