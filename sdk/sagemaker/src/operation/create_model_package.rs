...
impl CreateModelPackageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_model_package::ser_create_model_package_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_model_package::CreateModelPackage::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_model_package::CreateModelPackageError
{
