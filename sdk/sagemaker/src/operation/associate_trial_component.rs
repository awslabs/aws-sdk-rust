...
impl AssociateTrialComponent {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_trial_component::AssociateTrialComponentInput,
                    ) -> ::std::result::Result<crate::operation::associate_trial_component::AssociateTrialComponentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_trial_component::AssociateTrialComponentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_trial_component::AssociateTrialComponentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_trial_component::AssociateTrialComponentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateTrialComponent {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateTrialComponent");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateTrialComponentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateTrialComponentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateTrialComponent")
...
.with_interceptor(AssociateTrialComponentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_trial_component::AssociateTrialComponentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_trial_component::AssociateTrialComponentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_trial_component::AssociateTrialComponentError>::new());
...
#[derive(Debug)]
            struct AssociateTrialComponentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateTrialComponentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_trial_component::de_associate_trial_component_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_trial_component::de_associate_trial_component_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateTrialComponentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateTrialComponentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_trial_component::AssociateTrialComponentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_trial_component::AssociateTrialComponentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_trial_component::ser_associate_trial_component_input(&input)?);
...
#[derive(Debug)]
            struct AssociateTrialComponentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateTrialComponentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateTrialComponentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateTrialComponentInput>()
                        .ok_or("failed to downcast to AssociateTrialComponentInput")?;
...
/// Error type for the `AssociateTrialComponentError` operation.
#[non_exhaustive]
...
pub enum AssociateTrialComponentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateTrialComponentError) for what information is available for the error.")]
...
impl AssociateTrialComponentError {
    /// Creates the `AssociateTrialComponentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateTrialComponentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `AssociateTrialComponentError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `AssociateTrialComponentError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateTrialComponentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateTrialComponentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_trial_component::AssociateTrialComponentError {
...
mod _associate_trial_component_output;
