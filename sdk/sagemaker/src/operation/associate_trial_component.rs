    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_trial_component::AssociateTrialComponentError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_trial_component::AssociateTrialComponentOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateTrialComponentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateTrialComponentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_trial_component::AssociateTrialComponentInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateTrialComponentEndpointParamsInterceptor {
...
pub type AssociateTrialComponentErrorKind = AssociateTrialComponentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateTrialComponentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_trial_component::AssociateTrialComponentError {
...
impl AssociateTrialComponentError {
    ...
    /// Creates the `AssociateTrialComponentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
