...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_code_repository::DeleteCodeRepositoryOutput,
                    crate::operation::delete_code_repository::DeleteCodeRepositoryError,
                > for DeleteCodeRepositoryFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteCodeRepositoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_code_repository::DeleteCodeRepositoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_code_repository::DeleteCodeRepositoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_code_repository::DeleteCodeRepository::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_code_repository::DeleteCodeRepository::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_code_repository::DeleteCodeRepositoryOutput, crate::operation::delete_code_repository::DeleteCodeRepositoryError, Self> {
