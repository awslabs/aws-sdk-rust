...
impl UpdateSpace {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SageMaker", "UpdateSpace", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSpace {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateSpace", "SageMaker"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSpaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("SpaceDisplayName") {
            if let ::std::option::Option::Some(value) = input.space_display_name.as_deref() {
                captured.insert("SpaceDisplayName", value);
            }
        }
