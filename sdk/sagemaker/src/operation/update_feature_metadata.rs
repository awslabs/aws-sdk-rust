    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_feature_metadata::UpdateFeatureMetadataError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_feature_metadata::UpdateFeatureMetadataOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateFeatureMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateFeatureMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_feature_metadata::UpdateFeatureMetadataInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateFeatureMetadataEndpointParamsInterceptor {
...
pub type UpdateFeatureMetadataErrorKind = UpdateFeatureMetadataError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateFeatureMetadataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_feature_metadata::UpdateFeatureMetadataError {
...
impl UpdateFeatureMetadataError {
    ...
    /// Creates the `UpdateFeatureMetadataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
