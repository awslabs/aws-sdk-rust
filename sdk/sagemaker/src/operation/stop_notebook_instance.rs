    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_notebook_instance::StopNotebookInstanceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_notebook_instance::StopNotebookInstanceOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopNotebookInstanceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopNotebookInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_notebook_instance::StopNotebookInstanceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_notebook_instance::ser_stop_notebook_instance_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopNotebookInstanceEndpointParamsInterceptor {
...
pub type StopNotebookInstanceErrorKind = StopNotebookInstanceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopNotebookInstanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_notebook_instance::StopNotebookInstanceError {
...
impl StopNotebookInstanceError {
    ...
    /// Creates the `StopNotebookInstanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
