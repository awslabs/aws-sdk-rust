...
impl StopCompilationJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_compilation_job::ser_stop_compilation_job_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_compilation_job::StopCompilationJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_compilation_job::StopCompilationJobError
{
