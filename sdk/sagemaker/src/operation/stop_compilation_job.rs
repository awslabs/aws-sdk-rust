...
/// Orchestration and serialization glue logic for `StopCompilationJob`.
...
impl StopCompilationJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_compilation_job::StopCompilationJobInput,
                    ) -> ::std::result::Result<crate::operation::stop_compilation_job::StopCompilationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_compilation_job::StopCompilationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_compilation_job::StopCompilationJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_compilation_job::StopCompilationJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopCompilationJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopCompilationJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopCompilationJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopCompilationJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopCompilationJob")
...
.with_interceptor(StopCompilationJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_compilation_job::StopCompilationJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_compilation_job::StopCompilationJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_compilation_job::StopCompilationJobError>::new());
...
#[derive(Debug)]
            struct StopCompilationJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopCompilationJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_compilation_job::de_stop_compilation_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_compilation_job::de_stop_compilation_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopCompilationJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopCompilationJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_compilation_job::StopCompilationJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_compilation_job::StopCompilationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_compilation_job::ser_stop_compilation_job_input(&input)?);
...
#[derive(Debug)]
            struct StopCompilationJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopCompilationJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopCompilationJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopCompilationJobInput>()
                        .ok_or("failed to downcast to StopCompilationJobInput")?;
...
/// Error type for the `StopCompilationJobError` operation.
#[non_exhaustive]
...
pub enum StopCompilationJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopCompilationJobError) for what information is available for the error.")]
...
impl StopCompilationJobError {
    /// Creates the `StopCompilationJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopCompilationJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StopCompilationJobError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopCompilationJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopCompilationJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_compilation_job::StopCompilationJobError {
...
mod _stop_compilation_job_output;
