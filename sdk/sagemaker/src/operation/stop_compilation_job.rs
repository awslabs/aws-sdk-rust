...
impl StopCompilationJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_compilation_job::ser_stop_compilation_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopCompilationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_compilation_job::de_stop_compilation_job_http_response_with_props(status, headers, body)
        }
    }
}
