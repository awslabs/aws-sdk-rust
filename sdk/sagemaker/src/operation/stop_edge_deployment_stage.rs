    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopEdgeDeploymentStageResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopEdgeDeploymentStageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopEdgeDeploymentStageEndpointParamsInterceptor {
...
pub type StopEdgeDeploymentStageErrorKind = StopEdgeDeploymentStageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopEdgeDeploymentStageError {
...
impl StopEdgeDeploymentStageError {
    ...
    /// Creates the `StopEdgeDeploymentStageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
