...
/// Orchestration and serialization glue logic for `StopEdgeDeploymentStage`.
...
impl StopEdgeDeploymentStage {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopEdgeDeploymentStage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopEdgeDeploymentStage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopEdgeDeploymentStageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopEdgeDeploymentStageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopEdgeDeploymentStage")
...
.with_interceptor(StopEdgeDeploymentStageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageError>::new());
...
#[derive(Debug)]
            struct StopEdgeDeploymentStageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopEdgeDeploymentStageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_stop_edge_deployment_stage::de_stop_edge_deployment_stage_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopEdgeDeploymentStageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopEdgeDeploymentStageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_edge_deployment_stage::ser_stop_edge_deployment_stage_input(&input)?);
...
#[derive(Debug)]
            struct StopEdgeDeploymentStageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopEdgeDeploymentStageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopEdgeDeploymentStageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopEdgeDeploymentStageInput>()
                        .ok_or("failed to downcast to StopEdgeDeploymentStageInput")?;
...
/// Error type for the `StopEdgeDeploymentStageError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StopEdgeDeploymentStageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopEdgeDeploymentStageError) for what information is available for the error.")]
...
impl StopEdgeDeploymentStageError {
    /// Creates the `StopEdgeDeploymentStageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopEdgeDeploymentStageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopEdgeDeploymentStageError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopEdgeDeploymentStageError {
...
mod _stop_edge_deployment_stage_output;
