...
impl DescribeLabelingJobInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_labeling_job::ser_describe_labeling_job_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_labeling_job::DescribeLabelingJob::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_labeling_job::DescribeLabelingJobError
{
