...
impl DescribeEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_endpoint::ser_describe_endpoint_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_endpoint::DescribeEndpoint::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEndpoint", "sagemaker"));
