...
impl ListUserProfilesInput {
    /// Consumes the builder and constructs an Operation<[`ListUserProfiles`](crate::operation::list_user_profiles::ListUserProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_user_profiles::ListUserProfiles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_profiles::ListUserProfilesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_user_profiles::ser_list_user_profiles_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_profiles::ListUserProfiles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListUserProfiles", "sagemaker"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListUserProfiles {
                type Output = std::result::Result<crate::operation::list_user_profiles::ListUserProfilesOutput, crate::operation::list_user_profiles::ListUserProfilesError>;
