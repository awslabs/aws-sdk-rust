...
impl ListUserProfilesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_user_profiles::ser_list_user_profiles_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUserProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_user_profiles::de_list_user_profiles_http_response_with_props(status, headers, body)
        }
    }
}
