...
impl UpdateImageVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_image_version::ser_update_image_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateImageVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_image_version::de_update_image_version_http_response_with_props(status, headers, body)
        }
    }
}
