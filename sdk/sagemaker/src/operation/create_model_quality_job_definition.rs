...
impl CreateModelQualityJobDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_model_quality_job_definition::CreateModelQualityJobDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateModelQualityJobDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_model_quality_job_definition::de_create_model_quality_job_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
