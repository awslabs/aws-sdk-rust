...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput,
                    crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError,
                > for StopMonitoringScheduleFluentBuilder
            {
                fn send(
                    self,
...
impl StopMonitoringScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::stop_monitoring_schedule::StopMonitoringSchedule::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::stop_monitoring_schedule::StopMonitoringSchedule::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_monitoring_schedule::StopMonitoringScheduleOutput, crate::operation::stop_monitoring_schedule::StopMonitoringScheduleError, Self> {
