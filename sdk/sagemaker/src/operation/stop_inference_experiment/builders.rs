...
impl StopInferenceExperimentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_inference_experiment::StopInferenceExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_inference_experiment::StopInferenceExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_inference_experiment::StopInferenceExperimentOutput, crate::operation::stop_inference_experiment::StopInferenceExperimentError, Self> {
    ...
    /// <p><code>Retain</code> - Keep the variant as it is</p></li>
    /// </ul>
    pub fn get_model_variant_actions(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::ModelVariantAction>> {
