...
impl StopInferenceExperimentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_inference_experiment::StopInferenceExperimentInput, ::aws_smithy_types::error::operation::BuildError> {
