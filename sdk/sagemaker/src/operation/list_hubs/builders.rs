...
pub use crate::operation::list_hubs::_list_hubs_output::ListHubsOutputBuilder;

pub use crate::operation::list_hubs::_list_hubs_input::ListHubsInputBuilder;

impl crate::operation::list_hubs::builders::ListHubsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::list_hubs::ListHubsError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.list_hubs();
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::list_hubs::ListHubsOutput, crate::operation::list_hubs::ListHubsError>
    for ListHubsFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::list_hubs::ListHubsOutput, crate::operation::list_hubs::ListHubsError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl ListHubsFluentBuilder {
    /// Creates a new `ListHubsFluentBuilder`.
    ...
    /// Access the ListHubs as a reference.
    pub fn as_input(&self) -> &crate::operation::list_hubs::builders::ListHubsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_hubs::ListHubs::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_hubs::ListHubs::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_hubs::ListHubsOutput, crate::operation::list_hubs::ListHubsError, Self>
    {
