    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_compilation_job::CreateCompilationJobError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_compilation_job::CreateCompilationJobOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateCompilationJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateCompilationJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_compilation_job::CreateCompilationJobInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_compilation_job::ser_create_compilation_job_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateCompilationJobEndpointParamsInterceptor {
...
pub type CreateCompilationJobErrorKind = CreateCompilationJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateCompilationJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_compilation_job::CreateCompilationJobError {
...
impl CreateCompilationJobError {
    ...
    /// Creates the `CreateCompilationJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
