...
impl CreateCompilationJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_compilation_job::ser_create_compilation_job_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_compilation_job::CreateCompilationJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_compilation_job::CreateCompilationJobError
{
