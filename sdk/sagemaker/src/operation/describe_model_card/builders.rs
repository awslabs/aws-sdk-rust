...
impl crate::operation::describe_model_card::builders::DescribeModelCardInputBuilder {
...
///
/// <p>Describes the content, creation time, and security configuration of an Amazon SageMaker Model Card.</p><important>
...
impl DescribeModelCardFluentBuilder {
    /// Creates a new `DescribeModelCardFluentBuilder`.
