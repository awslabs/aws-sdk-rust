...
impl StopInferenceRecommendationsJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_inference_recommendations_job::StopInferenceRecommendationsJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopInferenceRecommendationsJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_inference_recommendations_job::de_stop_inference_recommendations_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
