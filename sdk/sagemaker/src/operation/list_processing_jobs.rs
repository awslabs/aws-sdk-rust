...
impl ListProcessingJobsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_processing_jobs::ser_list_processing_jobs_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_processing_jobs::ListProcessingJobs::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_processing_jobs::ListProcessingJobsError
{
