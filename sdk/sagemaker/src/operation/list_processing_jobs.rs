...
impl ListProcessingJobsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_processing_jobs::ser_list_processing_jobs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProcessingJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_processing_jobs::de_list_processing_jobs_http_response_with_props(status, headers, body)
        }
    }
}
