...
impl ListHumanTaskUisInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_human_task_uis::ser_list_human_task_uis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHumanTaskUis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_human_task_uis::de_list_human_task_uis_http_response_with_props(status, headers, body)
        }
    }
}
