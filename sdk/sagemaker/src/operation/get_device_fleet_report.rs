    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_device_fleet_report::GetDeviceFleetReportError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_device_fleet_report::GetDeviceFleetReportOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDeviceFleetReport {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetDeviceFleetReport", "sagemaker"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDeviceFleetReportResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDeviceFleetReportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_device_fleet_report::GetDeviceFleetReportInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_device_fleet_report::ser_get_device_fleet_report_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetDeviceFleetReportEndpointParamsInterceptor {
...
pub type GetDeviceFleetReportErrorKind = GetDeviceFleetReportError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetDeviceFleetReportError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_device_fleet_report::GetDeviceFleetReportError {
...
impl GetDeviceFleetReportError {
    ...
    /// Creates the `GetDeviceFleetReportError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
