...
impl GetDeviceFleetReport {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_device_fleet_report::GetDeviceFleetReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_device_fleet_report::GetDeviceFleetReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_device_fleet_report::GetDeviceFleetReportError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_device_fleet_report::GetDeviceFleetReportOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDeviceFleetReport {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDeviceFleetReport");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDeviceFleetReportRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDeviceFleetReportResponseDeserializer));
...
.with_interceptor(GetDeviceFleetReportEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_device_fleet_report::GetDeviceFleetReportError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_device_fleet_report::GetDeviceFleetReportError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_device_fleet_report::GetDeviceFleetReportError>::new());
...
#[derive(Debug)]
            struct GetDeviceFleetReportResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDeviceFleetReportResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_device_fleet_report::de_get_device_fleet_report_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_device_fleet_report::de_get_device_fleet_report_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDeviceFleetReportRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDeviceFleetReportRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_device_fleet_report::GetDeviceFleetReportInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_device_fleet_report::GetDeviceFleetReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_device_fleet_report::ser_get_device_fleet_report_input(&input)?);
...
#[derive(Debug)]
            struct GetDeviceFleetReportEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDeviceFleetReportEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDeviceFleetReportEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDeviceFleetReportInput>()
                        .ok_or("failed to downcast to GetDeviceFleetReportInput")?;
...
/// Error type for the `GetDeviceFleetReportError` operation.
#[non_exhaustive]
...
pub enum GetDeviceFleetReportError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDeviceFleetReportError) for what information is available for the error.")]
...
impl GetDeviceFleetReportError {
    /// Creates the `GetDeviceFleetReportError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDeviceFleetReportError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDeviceFleetReportError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDeviceFleetReportError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_device_fleet_report::GetDeviceFleetReportError {
...
mod _get_device_fleet_report_output;
