...
impl CreateHubInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_hub::CreateHub, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hub::ser_create_hub_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHub {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hub::de_create_hub_http_response_with_props(status, headers, body)
        }
    }
}
