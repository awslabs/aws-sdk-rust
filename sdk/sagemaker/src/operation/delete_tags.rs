...
impl DeleteTagsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_tags::ser_delete_tags_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_tags::DeleteTags::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteTags", "sagemaker"));
