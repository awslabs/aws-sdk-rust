...
impl DeleteActionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_action::DeleteAction,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_action::DeleteAction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_action::de_delete_action_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_action::de_delete_action_http_response_with_props(
                status, headers, body,
            )
        }
    }
