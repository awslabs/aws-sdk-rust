    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListLabelingJobsForWorkteam {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListLabelingJobsForWorkteam", "sagemaker"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListLabelingJobsForWorkteamResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListLabelingJobsForWorkteamRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListLabelingJobsForWorkteamEndpointParamsInterceptor {
