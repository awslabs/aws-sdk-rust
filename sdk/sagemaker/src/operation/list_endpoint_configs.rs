...
impl ListEndpointConfigs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_endpoint_configs::ListEndpointConfigsInput,
                    ) -> ::std::result::Result<crate::operation::list_endpoint_configs::ListEndpointConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_endpoint_configs::ListEndpointConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_endpoint_configs::ListEndpointConfigsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_endpoint_configs::ListEndpointConfigsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEndpointConfigs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEndpointConfigs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEndpointConfigsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEndpointConfigsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEndpointConfigs")
...
.with_interceptor(ListEndpointConfigsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_endpoint_configs::ListEndpointConfigsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_endpoint_configs::ListEndpointConfigsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_endpoint_configs::ListEndpointConfigsError>::new());
...
#[derive(Debug)]
            struct ListEndpointConfigsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEndpointConfigsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_endpoint_configs::de_list_endpoint_configs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_endpoint_configs::de_list_endpoint_configs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEndpointConfigsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEndpointConfigsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_endpoint_configs::ListEndpointConfigsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_endpoint_configs::ListEndpointConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_endpoint_configs::ser_list_endpoint_configs_input(&input)?);
...
#[derive(Debug)]
            struct ListEndpointConfigsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEndpointConfigsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEndpointConfigsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEndpointConfigsInput>()
                        .ok_or("failed to downcast to ListEndpointConfigsInput")?;
...
/// Error type for the `ListEndpointConfigsError` operation.
#[non_exhaustive]
...
pub enum ListEndpointConfigsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEndpointConfigsError) for what information is available for the error.")]
...
impl ListEndpointConfigsError {
    /// Creates the `ListEndpointConfigsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEndpointConfigsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListEndpointConfigsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEndpointConfigsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_endpoint_configs::ListEndpointConfigsError {
...
mod _list_endpoint_configs_output;
