    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_search_suggestions::GetSearchSuggestionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_search_suggestions::GetSearchSuggestionsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetSearchSuggestionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetSearchSuggestionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_search_suggestions::GetSearchSuggestionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_search_suggestions::ser_get_search_suggestions_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetSearchSuggestionsEndpointParamsInterceptor {
...
pub type GetSearchSuggestionsErrorKind = GetSearchSuggestionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetSearchSuggestionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_search_suggestions::GetSearchSuggestionsError {
...
impl GetSearchSuggestionsError {
    ...
    /// Creates the `GetSearchSuggestionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
