...
impl ListImagesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Image, ::aws_smithy_http::result::SdkError<crate::operation::list_images::ListImagesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_images_output_images(page).unwrap_or_default().into_iter())
    }
}
