...
impl ListPipelineExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListPipelineExecutions`](crate::operation::list_pipeline_executions::ListPipelineExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_pipeline_executions::ListPipelineExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_pipeline_executions::ListPipelineExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_pipeline_executions::ListPipelineExecutions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListPipelineExecutions", "sagemaker"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListPipelineExecutions {
                type Output = std::result::Result<crate::operation::list_pipeline_executions::ListPipelineExecutionsOutput, crate::operation::list_pipeline_executions::ListPipelineExecutionsError>;
