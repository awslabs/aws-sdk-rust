...
/// Paginator for [`ListEdgePackagingJobs`](crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobs)
            ...
            impl ListEdgePackagingJobsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsOutput, aws_smithy_http::result::SdkError<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListEdgePackagingJobsPaginator`
                ...
                impl  ListEdgePackagingJobsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::EdgePackagingJobSummary, aws_smithy_http::result::SdkError<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_edge_packaging_jobs_output_edge_packaging_job_summaries(page).unwrap_or_default().into_iter())
                    }
                }
