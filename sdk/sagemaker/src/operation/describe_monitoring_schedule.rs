...
impl DescribeMonitoringScheduleInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_monitoring_schedule::DescribeMonitoringSchedule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMonitoringSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_monitoring_schedule::de_describe_monitoring_schedule_http_response_with_props(status, headers, body)
        }
    }
}
