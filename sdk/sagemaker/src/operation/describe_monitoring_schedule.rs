    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_monitoring_schedule::DescribeMonitoringScheduleError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_monitoring_schedule::DescribeMonitoringScheduleOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeMonitoringSchedule {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeMonitoringSchedule", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeMonitoringSchedule")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeMonitoringScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeMonitoringScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_monitoring_schedule::DescribeMonitoringScheduleInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeMonitoringScheduleEndpointParamsInterceptor {
...
pub type DescribeMonitoringScheduleErrorKind = DescribeMonitoringScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_monitoring_schedule::DescribeMonitoringScheduleError {
...
impl DescribeMonitoringScheduleError {
    ...
    /// Creates the `DescribeMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
